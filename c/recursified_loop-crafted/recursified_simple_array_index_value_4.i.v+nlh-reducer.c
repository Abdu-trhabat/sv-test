...
//
// It was automatically generated from 'simple_array_index_value_4.i.v+nlh-reducer.c' with https://github.com/FlorianDyck/semtransforms
...
void reach_error()
{
  __assert_fail("0", "simple_array_index_value_4.i.v+nlh-reducer.c", 4, "reach_error");
}
...
int main();
void func_to_recursive_line_20_to_22_0(unsigned *i, unsigned int (*main__array)[100000])
{
  if ((*i) < 100000)
  {
    {
    ...
    func_to_recursive_line_20_to_22_0(i, main__array);
  }
  else
  {
  }
