...
void reach_error() { __assert_fail("0", "parport.i.cil-2.c", 3, "reach_error"); }
extern void abort(void);
...
NTSTATUS PoRequestPowerIrp(PDEVICE_OBJECT DeviceObject ,
	...
	assume_abort_if_not(rtr == 0x00000103 /* STATUS_PENDING */ ||
...
POWER_STATE PoSetPowerState(PDEVICE_OBJECT DeviceObject ,
   ...
   assume_abort_if_not(value >= 0 && value <= 7);
...
{ PIO_ERROR_LOG_PACKET ErrorLogEntry ;
  ...
  if (DumpToAllocate) {
    ...
    if ((unsigned int )DumpToAllocate > sizeof(PHYSICAL_ADDRESS )) {
      {
      memcpy_guard((UCHAR *)(ErrorLogEntry->DumpData) + sizeof(PHYSICAL_ADDRESS ), & P2,
