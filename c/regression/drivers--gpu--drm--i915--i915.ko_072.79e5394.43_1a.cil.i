...
void reach_error() { __assert_fail("0", "drivers--gpu--drm--i915--i915.ko_072.79e5394.43_1a.cil.i", 3, "reach_error"); }
...
{ 
  ...
  *preallocated_size = 1048576UL;
  ...
  goto ldv_26049;
  default: 
  *aperture_size = pdev->resource[2].start != 0ULL || pdev->resource[2].end != pdev->resource[2].start ? (unsigned long )((pdev->resource[2].end - pdev->resource[2].start) + 1ULL) : 0UL;
  goto ldv_26049;
  }
  ldv_26049: 
