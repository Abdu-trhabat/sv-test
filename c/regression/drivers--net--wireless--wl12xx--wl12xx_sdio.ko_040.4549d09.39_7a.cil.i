...
void reach_error() { __assert_fail("0", "drivers--net--wireless--wl12xx--wl12xx_sdio.ko_040.4549d09.39_7a.cil.i", 3, "reach_error"); }
...
union __anonunion_ldv_41149_257 {
   struct __anonstruct_sta_258 sta ;
   struct __anonstruct_ap_259 ap ;
};
struct __anonstruct_ldv_41180_260 {
   u8 persistent[0U] ;
   u64 tx_security_seq ;
...
struct wl12xx_vif {
   ...
   u8 dev_role_id ;
   u8 dev_hlid ;
   union __anonunion_ldv_41149_257 ldv_41149 ;
   int last_tx_hlid ;
   unsigned long links_map[1U] ;
   u8 ssid[33U] ;
   u8 ssid_len ;
   ...
   struct __anonstruct_ldv_41180_260 ldv_41180 ;
};
