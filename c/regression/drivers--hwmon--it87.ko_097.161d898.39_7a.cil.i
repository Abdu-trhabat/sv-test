...
void reach_error() { __assert_fail("0", "drivers--hwmon--it87.ko_097.161d898.39_7a.cil.i", 3, "reach_error"); }
...
{ 
  ...
  tmp___1 = has_temp_offset((struct it87_data  const  *)data);
  if (tmp___1 != 0) {
...
{ 
  ...
  if ((unsigned int )sio_data->beep_pin != 0U) {
    ...
    tmp___7 = sysfs_chmod_file(& dev->kobj, (struct attribute  const  *)it87_attributes_fan_beep[i],
                               420);
    if (tmp___7 != 0) {
      descriptor.modname = "it87";
...
{ 
  ...
  if (ldv_s_it87_driver_platform_driver == 0) {
    res_it87_probe_60 = it87_probe(var_group1);
    ldv_check_return_value(res_it87_probe_60);
    ldv_check_return_value_probe(res_it87_probe_60);
    if (res_it87_probe_60 != 0) {
