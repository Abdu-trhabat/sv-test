...
void reach_error() { __assert_fail("0", "drivers--usb--serial--spcp8x5.ko_006.c197a8d.32_1.cil.i", 3, "reach_error"); }
...
static char const   __mod_description1076[49]  __attribute__((__used__, __unused__,
__section__(".modinfo")))  = 
  {      'd',      'e',      's',      'c', 
        'r',      'i',      'p',      't', 
        'i',      'o',      'n',      '=', 
        ...
        'i',      'v',      'e',      'r', 
        '\000'};
static char const   __mod_version1077[14]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'v',      'e',      'r',      's', 
        'i',      'o',      'n',      '=', 
        'v',      '0',      '.',      '0', 
        '4',      '\000'};
static char const   __mod_license1078[12]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'l',      'i',      'c',      'e', 
        'n',      's',      'e',      '=', 
        'G',      'P',      'L',      '\000'};
...
__section__("__param"), __aligned__(sizeof(void *))))  =    {__param_str_debug, ((256 | 32) | 4) | 128, & param_set_bool, & param_get_bool,
    {& debug}};
static char const   __mod_debugtype1080[20]  __attribute__((__used__, __unused__,
__section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        't',      'y',      'p',      'e', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'b', 
        'o',      'o',      'l',      '\000'};
static char const   __mod_debug1081[32]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'D', 
        'e',      'b',      'u',      'g', 
