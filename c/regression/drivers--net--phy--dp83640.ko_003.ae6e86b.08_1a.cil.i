...
void reach_error() { __assert_fail("0", "drivers--net--phy--dp83640.ko_003.ae6e86b.08_1a.cil.i", 3, "reach_error"); }
...
union __anonunion_ldv_15517_145 {
...
struct file_lock;
struct cdev;
union __anonunion_ldv_15544_146 {
...
struct inode {
   ...
   union __anonunion_ldv_15517_145 ldv_15517 ;
   unsigned long i_ino ;
   atomic_t i_count ;
   ...
   union __anonunion_ldv_15544_146 ldv_15544 ;
   __u32 i_generation ;
...
struct __anonstruct_ldv_17637_151 {
   u16 inuse ;
   u16 objects ;
};
union __anonunion_ldv_17638_150 {
   atomic_t _mapcount ;
   struct __anonstruct_ldv_17637_151 ldv_17637 ;
};
struct __anonstruct_ldv_17643_153 {
   unsigned long private ;
   struct address_space *mapping ;
};
union __anonunion_ldv_17646_152 {
   struct __anonstruct_ldv_17643_153 ldv_17643 ;
   struct kmem_cache *slab ;
   struct page *first_page ;
};
union __anonunion_ldv_17650_154 {
   unsigned long index ;
   void *freelist ;
};
struct page {
   unsigned long flags ;
   atomic_t _count ;
   union __anonunion_ldv_17638_150 ldv_17638 ;
   union __anonunion_ldv_17646_152 ldv_17646 ;
   union __anonunion_ldv_17650_154 ldv_17650 ;
...
struct keyring_list;
struct key_user;
union __anonunion_ldv_18590_168 {
   time_t expiry ;
   time_t revoked_at ;
};
...
struct key {
   ...
   void *security ;
   union __anonunion_ldv_18590_168 ldv_18590 ;
   uid_t uid ;
   gid_t gid ;
   key_perm_t perm ;
...
struct sec_path;
struct __anonstruct_ldv_26328_180 {
   __u16 csum_start ;
   __u16 csum_offset ;
};
union __anonunion_ldv_26329_179 {
   __wsum csum ;
   struct __anonstruct_ldv_26328_180 ldv_26328 ;
};
union __anonunion_ldv_26359_181 {
   __u32 mark ;
   __u32 dropcount ;
};
struct sk_buff {
   ...
   __u16 mac_len ;
   __u16 hdr_len ;
   union __anonunion_ldv_26329_179 ldv_26329 ;
   __u32 priority ;
   ...
   __u32 secmark ;
   union __anonunion_ldv_26359_181 ldv_26359 ;
   __u16 vlan_tci ;
...
struct pcpu_tstats;
struct pcpu_dstats;
union __anonunion_ldv_30976_191 {
   void *ml_priv ;
...
struct net_device {
   ...
   struct net *nd_net ;
   union __anonunion_ldv_30976_191 ldv_30976 ;
...
typedef enum ldv_24561 phy_interface_t;
enum ldv_24575 {
    MDIOBUS_ALLOCATED = 1,
...
union __anonunion_ldv_34636_198 {
   struct ptp_extts_request extts ;
   struct ptp_perout_request perout ;
};
struct ptp_clock_request {
   enum ldv_24964 type ;
   union __anonunion_ldv_34636_198 ldv_34636 ;
};
...
{ 
  ...
  case 0U: ;
  if (rq->ldv_34636.extts.index != 0U) {
    return (-22);
  } else {
...
{ 
  ...
  __raw_spin_lock_init(& dp83640->rx_lock.ldv_6060.rlock, "&(&dp83640->rx_lock)->rlock",
                       & __key___0);
