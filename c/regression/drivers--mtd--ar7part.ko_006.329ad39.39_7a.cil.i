...
void reach_error() { __assert_fail("0", "drivers--mtd--ar7part.ko_006.329ad39.39_7a.cil.i", 3, "reach_error"); }
...
struct kparam_array;
union __anonunion_ldv_14700_134 {
   void *arg ;
...
struct kernel_param {
   ...
   u16 perm ;
   u16 flags ;
   union __anonunion_ldv_14700_134 ldv_14700 ;
};
struct kparam_string {
   unsigned int maxlen ;
   char *string ;
