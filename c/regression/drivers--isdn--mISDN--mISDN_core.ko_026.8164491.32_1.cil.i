...
void reach_error() { __assert_fail("0", "drivers--isdn--mISDN--mISDN_core.ko_026.8164491.32_1.cil.i", 3, "reach_error"); }
...
union __anonunion____missing_field_name_168 {
   __wsum csum ;
   struct __anonstruct____missing_field_name_169 __annonCompField23 ;
};
struct sk_buff {
   struct sk_buff *next ;
   struct sk_buff *prev ;
   ...
   __u16 mac_len ;
   __u16 hdr_len ;
   union __anonunion____missing_field_name_168 __annonCompField24 ;
   __u32 priority ;
   __u8 local_df : 1 ;
   __u8 cloned : 1 ;
   __u8 ip_summed : 2 ;
...
struct __anonstruct_sync_serial_settings_170 {
   unsigned int clock_rate ;
   unsigned int clock_type ;
   unsigned short loopback ;
};
typedef struct __anonstruct_sync_serial_settings_170 sync_serial_settings;
struct __anonstruct_te1_settings_171 {
   unsigned int clock_rate ;
   unsigned int clock_type ;
   unsigned short loopback ;
   unsigned int slot_map ;
};
typedef struct __anonstruct_te1_settings_171 te1_settings;
struct __anonstruct_raw_hdlc_proto_172 {
   unsigned short encoding ;
   unsigned short parity ;
};
typedef struct __anonstruct_raw_hdlc_proto_172 raw_hdlc_proto;
struct __anonstruct_fr_proto_173 {
   unsigned int t391 ;
   unsigned int t392 ;
   unsigned int n391 ;
   unsigned int n392 ;
...
typedef struct __anonstruct_fr_proto_173 fr_proto;
struct __anonstruct_fr_proto_pvc_174 {
   unsigned int dlci ;
};
typedef struct __anonstruct_fr_proto_pvc_174 fr_proto_pvc;
struct __anonstruct_fr_proto_pvc_info_175 {
   unsigned int dlci ;
   char master[16] ;
};
typedef struct __anonstruct_fr_proto_pvc_info_175 fr_proto_pvc_info;
struct __anonstruct_cisco_proto_176 {
   unsigned int interval ;
   unsigned int timeout ;
};
typedef struct __anonstruct_cisco_proto_176 cisco_proto;
struct ifmap {
...
struct net_device {
   ...
   enum __anonenum_reg_state_226 reg_state ;
...
struct dst_entry {
   ...
   union __anonunion____missing_field_name_267 __annonCompField26 ;
};
struct dst_ops {
...
struct sock_common {
   ...
   union __anonunion____missing_field_name_270 __annonCompField27 ;
...
struct __anonstruct_sk_backlog_271 {
   struct sk_buff *head ;
   struct sk_buff *tail ;
};
struct sock {
   ...
   struct __anonstruct_sk_backlog_271 sk_backlog ;
...
{ 
  ...
  {
  tmp = hlist_unhashed(& sk->__sk_common.__annonCompField27.skc_node);
  return (tmp);
}
}
...
{ 
  ...
  {
  __hlist_del(& sk->__sk_common.__annonCompField27.skc_node);
  return;
}
}
...
{ 
  ...
  if (tmp) {
    __sk_del_node(sk);
    sk_node_init(& sk->__sk_common.__annonCompField27.skc_node);
    return (1);
  } else {
...
{ 
  ...
  {
  hlist_add_head(& sk->__sk_common.__annonCompField27.skc_node, list);
  return;
}
}
  ...
  if ((int )sk->sk_protocol < 32) {
    ...
    while (1) {
      if (node) {
        ...
        __mptr = node;
        csk = (struct sock *)((char *)__mptr - (unsigned int )(& ((struct sock *)0)->__sk_common.__annonCompField27.skc_node));
      } else {
        break;
      }
...
{ 
  ...
  while (1) {
    if (node) {
      __builtin_prefetch(node->next);
      __mptr = node;
      sk = (struct sock *)((char *)__mptr - (unsigned int )(& ((struct sock *)0)->__sk_common.__annonCompField27.skc_node));
    } else {
      break;
    }
    if ((int volatile   )sk->__sk_common.skc_state != (int volatile   )2) {
