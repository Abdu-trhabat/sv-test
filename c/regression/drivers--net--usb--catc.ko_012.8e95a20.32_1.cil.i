...
void reach_error() { __assert_fail("0", "drivers--net--usb--catc.ko_012.8e95a20.32_1.cil.i", 3, "reach_error"); }
...
union __anonunion____missing_field_name_134 {
   atomic_t _mapcount ;
   struct __anonstruct____missing_field_name_135 __annonCompField19 ;
};
...
union __anonunion____missing_field_name_136 {
   struct __anonstruct____missing_field_name_137 __annonCompField21 ;
   spinlock_t ptl ;
...
struct page {
   unsigned long flags ;
   atomic_t _count ;
   union __anonunion____missing_field_name_134 __annonCompField20 ;
   union __anonunion____missing_field_name_136 __annonCompField22 ;
   union __anonunion____missing_field_name_138 __annonCompField23 ;
...
union __anonunion____missing_field_name_201 {
   __wsum csum ;
   struct __anonstruct____missing_field_name_202 __annonCompField25 ;
};
...
struct sk_buff {
   ...
   __u16 mac_len ;
   __u16 hdr_len ;
   union __anonunion____missing_field_name_201 __annonCompField26 ;
   __u32 priority ;
   int flags1_begin[0] ;
   __u8 local_df : 1 ;
   __u8 cloned : 1 ;
...
{ 
  ...
  catc->netdev = netdev;
  while (1) {
    __spin_lock_init(& catc->tx_lock, "&catc->tx_lock", & __key___8);
    break;
  }
  while (1) {
    __spin_lock_init(& catc->ctrl_lock, "&catc->ctrl_lock", & __key___9);
    break;
  }
