...
void reach_error() { __assert_fail("0", "drivers--usb--serial--cp210x.ko_009.8bf16ba.32_1.cil.i", 3, "reach_error"); }
...
static char const   __mod_description842[60]  __attribute__((__used__, __unused__,
__section__(".modinfo")))  = 
  {      'd',      'e',      's',      'c', 
        'r',      'i',      'p',      't', 
        'i',      'o',      'n',      '=', 
        ...
        ' ',      'd',      'r',      'i', 
        'v',      'e',      'r',      '\000'};
static char const   __mod_version843[14]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'v',      'e',      'r',      's', 
        'i',      'o',      'n',      '=', 
        'v',      '0',      '.',      '0', 
        '9',      '\000'};
static char const   __mod_license844[12]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'l',      'i',      'c',      'e', 
        'n',      's',      'e',      '=', 
        'G',      'P',      'L',      '\000'};
...
__section__("__param"), __aligned__(sizeof(void *))))  =    {__param_str_debug, ((256 | 32) | 4) | 128, 0, & param_set_bool, & param_get_bool,
    {& debug}};
static char const   __mod_debugtype846[20]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        't',      'y',      'p',      'e', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'b', 
        'o',      'o',      'l',      '\000'};
static char const   __mod_debug847[45]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'E', 
        'n',      'a',      'b',      'l', 
