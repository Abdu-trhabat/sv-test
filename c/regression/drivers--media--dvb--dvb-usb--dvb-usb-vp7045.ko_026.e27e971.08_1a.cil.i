...
void reach_error() { __assert_fail("0", "drivers--media--dvb--dvb-usb--dvb-usb-vp7045.ko_026.e27e971.08_1a.cil.i", 3, "reach_error"); }
...
struct file_lock;
struct cdev;
union __anonunion_ldv_13460_116 {
...
struct inode {
   ...
   union __anonunion_ldv_13460_116 ldv_13460 ;
   __u32 i_generation ;
...
struct __anonstruct_ldv_17219_123 {
   u16 inuse ;
   u16 objects ;
};
union __anonunion_ldv_17220_122 {
   atomic_t _mapcount ;
   struct __anonstruct_ldv_17219_123 ldv_17219 ;
};
struct __anonstruct_ldv_17225_125 {
   unsigned long private ;
   struct address_space *mapping ;
};
union __anonunion_ldv_17228_124 {
   struct __anonstruct_ldv_17225_125 ldv_17225 ;
   struct kmem_cache *slab ;
   struct page *first_page ;
};
union __anonunion_ldv_17232_126 {
   unsigned long index ;
   void *freelist ;
};
struct page {
   unsigned long flags ;
   atomic_t _count ;
   union __anonunion_ldv_17220_122 ldv_17220 ;
   union __anonunion_ldv_17228_124 ldv_17228 ;
   union __anonunion_ldv_17232_126 ldv_17232 ;
...
struct keyring_list;
struct key_user;
union __anonunion_ldv_18880_140 {
   time_t expiry ;
   time_t revoked_at ;
};
...
struct key {
   ...
   void *security ;
   union __anonunion_ldv_18880_140 ldv_18880 ;
   uid_t uid ;
   gid_t gid ;
   key_perm_t perm ;
...
typedef enum ldv_17611 dmx_output_t;
enum ldv_17613 {
    DMX_IN_FRONTEND = 0,
    DMX_IN_DVR = 1
} ;
typedef enum ldv_17613 dmx_input_t;
enum ldv_17615 {
    DMX_PES_AUDIO0 = 0,
    DMX_PES_VIDEO0 = 1,
    DMX_PES_TELETEXT0 = 2,
...
typedef enum ldv_17615 dmx_pes_type_t;
struct dmx_filter {
   __u8 filter[16U] ;
   __u8 mask[16U] ;
   __u8 mode[16U] ;
...
typedef enum ldv_17629 dmx_source_t;
enum dmx_success {
    DMX_OK = 0,
    DMX_LENGTH_ERROR = 1,
    DMX_OVERRUN_ERROR = 2,
...
struct sec_path;
struct __anonstruct_ldv_27168_165 {
   __u16 csum_start ;
   __u16 csum_offset ;
};
union __anonunion_ldv_27169_164 {
   __wsum csum ;
   struct __anonstruct_ldv_27168_165 ldv_27168 ;
};
union __anonunion_ldv_27197_166 {
   __u32 mark ;
   __u32 dropcount ;
};
struct sk_buff {
   ...
   __u16 mac_len ;
   __u16 hdr_len ;
   union __anonunion_ldv_27169_164 ldv_27169 ;
   __u32 priority ;
   ...
   __u32 secmark ;
   union __anonunion_ldv_27197_166 ldv_27197 ;
   __u16 vlan_tci ;
...
static struct dvb_usb_rc_key ir_codes_vp7045_table[50U]  = 
  {      {22U, 116U}, 
        {16U, 113U}, 
        {3U, 2U}, 
        {1U, 3U}, 
...
{ 
  ...
  goto ldv_32354;
  ldv_32353: 
  tmp = rc5_data((struct dvb_usb_rc_key *)(& ir_codes_vp7045_table) + (unsigned long )i);
  if ((int )tmp == (int )key) {
    *state = 1;
...
static struct dvb_usb_device_properties vp7045_properties  = 
    ...
    & vp7045_read_mac_addr, 0, (struct dvb_usb_rc_key *)(& ir_codes_vp7045_table),
