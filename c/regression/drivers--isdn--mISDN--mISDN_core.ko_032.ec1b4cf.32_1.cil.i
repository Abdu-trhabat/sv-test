...
void reach_error() { __assert_fail("0", "drivers--isdn--mISDN--mISDN_core.ko_032.ec1b4cf.32_1.cil.i", 3, "reach_error"); }
...
{ 
  ...
  {
  tmp = ldv__builtin_expect(! (! __tracepoint_module_get.state), 0);
  if (tmp) {
    while (1) {
      rcu_read_lock_sched_notrace();
