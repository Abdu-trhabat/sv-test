...
void reach_error() { __assert_fail("0", "drivers--regulator--wm831x-dcdc.ko_011.cda5310.39_7a.cil.i", 3, "reach_error"); }
...
struct keyring_list;
struct key_user;
union __anonunion_ldv_16132_150 {
   time_t expiry ;
   time_t revoked_at ;
};
...
struct key {
   ...
   void *security ;
   union __anonunion_ldv_16132_150 ldv_16132 ;
   uid_t uid ;
   gid_t gid ;
   key_perm_t perm ;
