...
void reach_error() { __assert_fail("0", "drivers--mtd--mtdoops.ko_013.43b5693.32_7a.cil.i", 3, "reach_error"); }
...
struct restart_block {
   ...
   union __anonunion_ldv_5173_23 ldv_5173 ;
};
struct thread_info {
   struct task_struct *task ;
...
struct __anonstruct_ldv_9684_89 {
   u16 inuse ;
   u16 objects ;
};
union __anonunion_ldv_9685_88 {
   atomic_t _mapcount ;
   struct __anonstruct_ldv_9684_89 ldv_9684 ;
};
struct __anonstruct_ldv_9690_91 {
   unsigned long private ;
   struct address_space *mapping ;
};
union __anonunion_ldv_9694_90 {
   struct __anonstruct_ldv_9690_91 ldv_9690 ;
   spinlock_t ptl ;
   struct kmem_cache *slab ;
   struct page *first_page ;
};
union __anonunion_ldv_9698_92 {
   unsigned long index ;
   void *freelist ;
};
struct page {
   unsigned long flags ;
   atomic_t _count ;
   union __anonunion_ldv_9685_88 ldv_9685 ;
   union __anonunion_ldv_9694_90 ldv_9694 ;
   union __anonunion_ldv_9698_92 ldv_9698 ;
...
union __anonunion_ldv_11083_107 {
   pid_t pgrp ;
   pid_t __pgrp ;
};
union __anonunion_ldv_11088_108 {
   pid_t session ;
   pid_t __session ;
};
struct taskstats;
...
struct signal_struct {
   ...
   union __anonunion_ldv_11083_107 ldv_11083 ;
   struct pid *tty_old_pgrp ;
   union __anonunion_ldv_11088_108 ldv_11088 ;
   int leader ;
...
typedef enum ldv_12926 mtd_oob_mode_t;
struct mtd_oob_ops {
   mtd_oob_mode_t mode ;
   size_t len ;
   size_t retlen ;
