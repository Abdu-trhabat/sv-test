...
void reach_error() { __assert_fail("0", "drivers--mtd--mtdoops.ko_009.f9f7dd2.08_1a.cil.i", 3, "reach_error"); }
...
union __anonunion_ldv_8715_86 {
   atomic_t _mapcount ;
   unsigned int inuse ;
};
struct __anonstruct_ldv_8720_88 {
   unsigned long private ;
   struct address_space *mapping ;
};
union __anonunion_ldv_8724_87 {
   struct __anonstruct_ldv_8720_88 ldv_8720 ;
   spinlock_t ptl ;
   struct kmem_cache *slab ;
   struct page *first_page ;
};
union __anonunion_ldv_8728_89 {
   unsigned long index ;
   void *freelist ;
};
struct page {
   unsigned long flags ;
   atomic_t _count ;
   union __anonunion_ldv_8715_86 ldv_8715 ;
   union __anonunion_ldv_8724_87 ldv_8724 ;
   union __anonunion_ldv_8728_89 ldv_8728 ;
...
union __anonunion_ldv_10143_104 {
   pid_t pgrp ;
   pid_t __pgrp ;
};
union __anonunion_ldv_10148_105 {
   pid_t session ;
   pid_t __session ;
};
struct taskstats;
...
struct signal_struct {
   ...
   union __anonunion_ldv_10143_104 ldv_10143 ;
   struct pid *tty_old_pgrp ;
   union __anonunion_ldv_10148_105 ldv_10148 ;
   int leader ;
...
typedef enum ldv_10782 mtd_oob_mode_t;
struct mtd_oob_ops {
   mtd_oob_mode_t mode ;
   size_t len ;
   size_t retlen ;
