...
void reach_error() { __assert_fail("0", "drivers--usb--serial--cp210x.ko_005.93ef1f1.08_1a.cil.i", 3, "reach_error"); }
...
{ 
  ...
  *baudp = baud;
  ...
  ldv_23593: 
  cp2101_get_config(port, 20, (unsigned int *)(& modem_ctl), 16);
