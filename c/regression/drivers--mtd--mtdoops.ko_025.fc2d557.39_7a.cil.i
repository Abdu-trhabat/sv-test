...
void reach_error() { __assert_fail("0", "drivers--mtd--mtdoops.ko_025.fc2d557.39_7a.cil.i", 3, "reach_error"); }
...
struct keyring_list;
struct key_user;
union __anonunion_ldv_14564_130 {
   time_t expiry ;
   time_t revoked_at ;
};
...
struct key {
   ...
   void *security ;
   union __anonunion_ldv_14564_130 ldv_14564 ;
   uid_t uid ;
   gid_t gid ;
   key_perm_t perm ;
...
typedef enum ldv_15588 mtd_oob_mode_t;
struct mtd_oob_ops {
   mtd_oob_mode_t mode ;
   size_t len ;
   size_t retlen ;
