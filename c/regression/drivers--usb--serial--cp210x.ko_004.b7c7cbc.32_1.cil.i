...
void reach_error() { __assert_fail("0", "drivers--usb--serial--cp210x.ko_004.b7c7cbc.32_1.cil.i", 3, "reach_error"); }
...
static char const   __mod_description823[67]  __attribute__((__used__, __unused__,
__section__(".modinfo")))  = 
  {      'd',      'e',      's',      'c', 
        'r',      'i',      'p',      't', 
        'i',      'o',      'n',      '=', 
        ...
        'd',      'r',      'i',      'v', 
        'e',      'r',      '\000'};
static char const   __mod_version824[14]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'v',      'e',      'r',      's', 
        'i',      'o',      'n',      '=', 
        'v',      '0',      '.',      '0', 
        '8',      '\000'};
static char const   __mod_license825[12]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'l',      'i',      'c',      'e', 
        'n',      's',      'e',      '=', 
        'G',      'P',      'L',      '\000'};
...
__section__("__param"), __aligned__(sizeof(void *))))  =    {__param_str_debug, ((256 | 32) | 4) | 128, & param_set_bool, & param_get_bool,
    {& debug}};
static char const   __mod_debugtype827[20]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        't',      'y',      'p',      'e', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'b', 
        'o',      'o',      'l',      '\000'};
static char const   __mod_debug828[45]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'E', 
        'n',      'a',      'b',      'l', 
