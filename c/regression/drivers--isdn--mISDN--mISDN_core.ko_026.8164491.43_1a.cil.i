...
void reach_error() { __assert_fail("0", "drivers--isdn--mISDN--mISDN_core.ko_026.8164491.43_1a.cil.i", 3, "reach_error"); }
...
struct sec_path;
struct __anonstruct_ldv_19095_102 {
   __u16 csum_start ;
   __u16 csum_offset ;
};
union __anonunion_ldv_19096_101 {
   __wsum csum ;
   struct __anonstruct_ldv_19095_102 ldv_19095 ;
};
struct sk_buff {
   struct sk_buff *next ;
   struct sk_buff *prev ;
   ...
   __u16 mac_len ;
   __u16 hdr_len ;
   union __anonunion_ldv_19096_101 ldv_19096 ;
   __u32 priority ;
...
struct file_lock;
struct cdev;
union __anonunion_ldv_22989_130 {
...
struct inode {
   ...
   union __anonunion_ldv_22989_130 ldv_22989 ;
   int i_cindex ;
   __u32 i_generation ;
...
struct dn_route;
union __anonunion_ldv_33262_153 {
...
struct dst_entry {
   ...
   union __anonunion_ldv_33262_153 ldv_33262 ;
};
struct dst_ops {
...
struct proto;
union __anonunion_ldv_33467_155 {
...
struct sock_common {
   ...
   union __anonunion_ldv_33467_155 ldv_33467 ;
...
{ 
  ...
  {
  tmp = hlist_unhashed(& sk->__sk_common.ldv_33467.skc_node);
  return (tmp);
}
}
...
{ 
  ...
  {
  __hlist_del(& sk->__sk_common.ldv_33467.skc_node);
  return;
}
}
...
{ 
  ...
  if (______r != 0) {
    __sk_del_node(sk);
    sk_node_init(& sk->__sk_common.ldv_33467.skc_node);
    return (1);
  } else {
...
{ 
  ...
  {
  hlist_add_head(& sk->__sk_common.ldv_33467.skc_node, list);
  return;
}
}
