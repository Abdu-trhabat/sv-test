...
void reach_error() { __assert_fail("0", "drivers--rtc--rtc-max6902.ko_006.c24b260.32_7a.cil.i", 3, "reach_error"); }
...
union __anonunion_ldv_7392_75 {
   atomic_t _mapcount ;
   unsigned int inuse ;
};
struct __anonstruct_ldv_7397_77 {
   unsigned long private ;
   struct address_space *mapping ;
};
union __anonunion_ldv_7401_76 {
   struct __anonstruct_ldv_7397_77 ldv_7397 ;
   spinlock_t ptl ;
   struct kmem_cache *slab ;
   struct page *first_page ;
};
union __anonunion_ldv_7405_78 {
   unsigned long index ;
   void *freelist ;
};
struct page {
   unsigned long flags ;
   atomic_t _count ;
   union __anonunion_ldv_7392_75 ldv_7392 ;
   union __anonunion_ldv_7401_76 ldv_7401 ;
   union __anonunion_ldv_7405_78 ldv_7405 ;
...
struct kiocb {
   ...
   union __anonunion_ki_obj_95 ki_obj ;
   __u64 ki_user_data ;
...
union __anonunion_ldv_8787_96 {
   pid_t pgrp ;
   pid_t __pgrp ;
};
union __anonunion_ldv_8792_97 {
   pid_t session ;
   pid_t __session ;
};
struct tty_struct;
...
struct signal_struct {
   ...
   union __anonunion_ldv_8787_96 ldv_8787 ;
   struct pid *tty_old_pgrp ;
   union __anonunion_ldv_8792_97 ldv_8792 ;
   int leader ;
...
struct nameidata {
   ...
   unsigned int depth ;
   char *saved_names[9U] ;
   union __anonunion_intent_99 intent ;
};
struct path {
   struct vfsmount *mnt ;
   struct dentry *dentry ;
...
struct file_lock;
union __anonunion_ldv_11262_101 {
...
struct inode {
   ...
   union __anonunion_ldv_11262_101 ldv_11262 ;
   int i_cindex ;
   __u32 i_generation ;
...
union __anonunion_f_u_102 {
   struct list_head fu_list ;
   struct rcu_head fu_rcuhead ;
};
struct file {
   union __anonunion_f_u_102 f_u ;
   struct path f_path ;
...
struct __anonstruct_afs_104 {
   struct list_head link ;
   int state ;
};
union __anonunion_fl_u_103 {
   struct nfs_lock_info nfs_fl ;
   struct nfs4_lock_info nfs4_fl ;
   struct __anonstruct_afs_104 afs ;
};
struct file_lock {
   ...
   union __anonunion_fl_u_103 fl_u ;
};
struct fasync_struct {
   int magic ;
   int fa_fd ;
