...
void reach_error() { __assert_fail("0", "drivers--staging--comedi--drivers--comedi_bond.ko_032.379585a.08_1a.cil.i", 3, "reach_error"); }
...
struct pci_driver;
union __anonunion_ldv_19717_148 {
...
struct pci_dev {
   ...
   struct pci_vpd *vpd ;
   union __anonunion_ldv_19717_148 ldv_19717 ;
   struct pci_ats *ats ;
};
struct pci_ops;
struct pci_bus {
