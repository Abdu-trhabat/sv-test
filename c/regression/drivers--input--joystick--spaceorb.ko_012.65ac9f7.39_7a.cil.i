...
void reach_error() { __assert_fail("0", "drivers--input--joystick--spaceorb.ko_012.65ac9f7.39_7a.cil.i", 3, "reach_error"); }
...
{ 
  ...
  goto ldv_21374;
  ldv_21373: 
  set_bit((unsigned int )spaceorb_buttons[i], (unsigned long volatile   *)(& input_dev->keybit));
  i = i + 1;
  ldv_21374: ;
  if (i <= 5) {
    goto ldv_21373;
  ...
  goto ldv_21377;
  ldv_21376: 
  input_set_abs_params(input_dev, (unsigned int )spaceorb_axes[i], -508, 508, 0, 0);
  i = i + 1;
  ldv_21377: ;
  if (i <= 5) {
    goto ldv_21376;
...
{ 
  ...
  ldv_21429: 
  tmp___0 = nondet_int();
  if (tmp___0 != 0 || ldv_s_spaceorb_drv_serio_driver != 0) {
    goto ldv_21428;
  } else {
