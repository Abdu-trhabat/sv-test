...
void reach_error() { __assert_fail("0", "drivers--scsi--pcmcia--sym53c500_cs.ko_040.37979e1.32_7a.cil.i", 3, "reach_error"); }
...
struct pci_ats;
struct pci_driver;
union __anonunion_ldv_28644_151 {
...
struct pci_dev {
   ...
   struct pci_vpd *vpd ;
   union __anonunion_ldv_28644_151 ldv_28644 ;
   struct pci_ats *ats ;
};
struct pci_ops;
struct pci_bus {
