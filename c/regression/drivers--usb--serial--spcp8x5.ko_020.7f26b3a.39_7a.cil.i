...
void reach_error() { __assert_fail("0", "drivers--usb--serial--spcp8x5.ko_020.7f26b3a.39_7a.cil.i", 3, "reach_error"); }
...
struct file_lock;
struct cdev;
union __anonunion_ldv_13271_110 {
...
struct inode {
   ...
   union __anonunion_ldv_13271_110 ldv_13271 ;
   __u32 i_generation ;
...
struct kparam_array;
union __anonunion_ldv_16614_118 {
   void *arg ;
...
struct kernel_param {
   ...
   union __anonunion_ldv_16614_118 ldv_16614 ;
};
struct kparam_string {
   unsigned int maxlen ;
   char *string ;
...
struct __anonstruct_ldv_19321_122 {
   u16 inuse ;
   u16 objects ;
};
union __anonunion_ldv_19322_121 {
   atomic_t _mapcount ;
   struct __anonstruct_ldv_19321_122 ldv_19321 ;
};
struct __anonstruct_ldv_19327_124 {
   unsigned long private ;
   struct address_space *mapping ;
};
union __anonunion_ldv_19330_123 {
   struct __anonstruct_ldv_19327_124 ldv_19327 ;
   struct kmem_cache *slab ;
   struct page *first_page ;
};
union __anonunion_ldv_19334_125 {
   unsigned long index ;
   void *freelist ;
};
struct page {
   unsigned long flags ;
   atomic_t _count ;
   union __anonunion_ldv_19322_121 ldv_19322 ;
   union __anonunion_ldv_19330_123 ldv_19330 ;
   union __anonunion_ldv_19334_125 ldv_19334 ;
...
struct keyring_list;
struct key_user;
union __anonunion_ldv_20943_139 {
   time_t expiry ;
   time_t revoked_at ;
};
...
struct key {
   ...
   void *security ;
   union __anonunion_ldv_20943_139 ldv_20943 ;
   uid_t uid ;
   gid_t gid ;
   key_perm_t perm ;
...
{ 
  ...
  descriptor.flags = 0U;
  __ret = 0;
  tmp___0 = ldv__builtin_expect((dynamic_debug_enabled & 128LL) != 0LL, 0L);
  if (tmp___0 != 0L) {
    tmp___1 = ldv__builtin_expect((dynamic_debug_enabled2 & 4611686018427387904LL) != 0LL,
                               0L);
    if (tmp___1 != 0L) {
  ...
  __raw_spin_lock_init(& priv->lock.ldv_5742.rlock, "&(&priv->lock)->rlock", & __key);
...
{ 
  ...
  if (retval != 0) {
    ...
    descriptor.flags = 0U;
    __ret = 0;
    tmp___1 = ldv__builtin_expect((dynamic_debug_enabled & 128LL) != 0LL, 0L);
    if (tmp___1 != 0L) {
      tmp___2 = ldv__builtin_expect((dynamic_debug_enabled2 & 4611686018427387904LL) != 0LL,
                                 0L);
      if (tmp___2 != 0L) {
        tmp___0 = ldv__builtin_expect((unsigned int )descriptor.flags != 0U, 0L);
        if (tmp___0 != 0L) {
          __ret = 1;
        } else {
...
{ 
  ...
  *status_buffer = *status;
  ...
  __ret___0 = 0;
  tmp___5 = ldv__builtin_expect((dynamic_debug_enabled & 128LL) != 0LL, 0L);
  if (tmp___5 != 0L) {
    tmp___6 = ldv__builtin_expect((dynamic_debug_enabled2 & 4611686018427387904LL) != 0LL,
                               0L);
    if (tmp___6 != 0L) {
      tmp___4 = ldv__builtin_expect((unsigned int )descriptor___0.flags != 0U, 0L);
      if (tmp___4 != 0L) {
        __ret___0 = 1;
      } else {
