...
void reach_error() { __assert_fail("0", "drivers--video--backlight--lms283gf05.ko_010.5a5a074.32_7a.cil.i", 3, "reach_error"); }
...
struct kparam_array;
union __anonunion_ldv_26965_178 {
   void *arg ;
...
struct kernel_param {
   ...
   u16 perm ;
   s16 level ;
   union __anonunion_ldv_26965_178 ldv_26965 ;
};
struct kparam_string {
   unsigned int maxlen ;
   char *string ;
