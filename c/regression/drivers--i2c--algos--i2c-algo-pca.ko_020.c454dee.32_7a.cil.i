...
void reach_error() { __assert_fail("0", "drivers--i2c--algos--i2c-algo-pca.ko_020.c454dee.32_7a.cil.i", 3, "reach_error"); }
...
struct kernel_param {
   ...
   union __anonunion_ldv_8977_93 ldv_8977 ;
};
struct kparam_string {
   unsigned int maxlen ;
   char *string ;
