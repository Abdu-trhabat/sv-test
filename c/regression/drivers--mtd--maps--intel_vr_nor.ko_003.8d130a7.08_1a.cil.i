...
void reach_error() { __assert_fail("0", "drivers--mtd--maps--intel_vr_nor.ko_003.8d130a7.08_1a.cil.i", 3, "reach_error"); }
...
struct keyring_list;
struct key_user;
union __anonunion_ldv_22937_159 {
   time_t expiry ;
   time_t revoked_at ;
};
...
struct key {
   ...
   void *security ;
   union __anonunion_ldv_22937_159 ldv_22937 ;
   uid_t uid ;
   gid_t gid ;
   key_perm_t perm ;
