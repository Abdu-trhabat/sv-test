...
void reach_error() { __assert_fail("0", "drivers--gpu--drm--i915--i915.ko_049.28dfe52.68_1.cil.i", 3, "reach_error"); }
    ...
    if (tmp) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "i" (788), "i" (sizeof(struct bug_entry )));
        while (1) {
      ...
      if (tmp) {
        while (1) {
          __asm__  volatile   ("1:\tud2\n"
                               ...
                               "\t.org 2b+%c2\n"
                               ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--68_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/68_1/drivers/gpu/drm/i915/i915_gem.c"),
                               "i" (915), "i" (sizeof(struct bug_entry )));
          while (1) {
        ...
        if (tmp) {
          while (1) {
            __asm__  volatile   ("1:\tud2\n"
                                 ...
                                 "\t.org 2b+%c2\n"
                                 ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--68_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/68_1/drivers/gpu/drm/i915/i915_gem.c"),
                                 "i" (1022), "i" (sizeof(struct bug_entry )));
            while (1) {
        ...
        if (tmp___0) {
          while (1) {
            __asm__  volatile   ("1:\tud2\n"
                                 ...
                                 "\t.org 2b+%c2\n"
                                 ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--68_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/68_1/drivers/gpu/drm/i915/i915_gem.c"),
                                 "i" (1026), "i" (sizeof(struct bug_entry )));
            while (1) {
    ...
    if (tmp) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--68_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/68_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (1108), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___1) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--68_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/68_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2551), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___4) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--68_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/68_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2552), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___7) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--68_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/68_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2553), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___10) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--68_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/68_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2554), "i" (sizeof(struct bug_entry )));
        while (1) {
