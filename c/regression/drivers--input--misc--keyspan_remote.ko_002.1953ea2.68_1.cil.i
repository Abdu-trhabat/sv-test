...
void reach_error() { __assert_fail("0", "drivers--input--misc--keyspan_remote.ko_002.1953ea2.68_1.cil.i", 3, "reach_error"); }
...
static char const   __mod_debugtype30[19]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        't',      'y',      'p',      'e', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'i', 
        'n',      't',      '\000'};
static char const   __mod_debug31[55]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'E', 
        'n',      'a',      'b',      'l', 
...
{ 
  ...
  while (1) {
    ...
    if ((remote->data.tester & 63U) == 60U) {
      ...
      printk("<3>%s: %s - Unknown sequence found in system data.\n\n", "/work/ldvuser/novikov/work/current--X--drivers/input/misc/keyspan_remote.ko--X--defaultlinux--X--68_1--X--cpachecker/linux/csd_deg_dscv/10/dscv_tempdir/dscv/ri/68_1/drivers/input/misc/keyspan_remote.c",
             "keyspan_check_data");
      remote->stage = 0;
      return;
    }
...
static char const   __mod_author607[42]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'a',      'u',      't',      'h', 
        'o',      'r',      '=',      'M', 
        'i',      'c',      'h',      'a', 
        'e',      'l',      ' ',      'D', 
        ...
        '.',      'c',      'o',      'm', 
        '>',      '\000'};
static char const   __mod_description608[55]  __attribute__((__used__, __unused__,
__section__(".modinfo")))  = 
  {      'd',      'e',      's',      'c', 
        'r',      'i',      'p',      't', 
        'i',      'o',      'n',      '=', 
        ...
        'n',      't',      'r',      'o', 
        'l',      '.',      '\000'};
static char const   __mod_license609[12]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'l',      'i',      'c',      'e', 
        'n',      's',      'e',      '=', 
        'G',      'P',      'L',      '\000'};
