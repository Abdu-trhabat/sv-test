...
void reach_error() { __assert_fail("0", "drivers--usb--serial--spcp8x5.ko_027.d860322.39_7a.cil.i", 3, "reach_error"); }
     ...
     {0, (struct usb_device_id  const  *)(& id_table), 1, {0, 0}, {"SPCP8x5", 0, & __this_module,
                                                                 ...
                                                                 0}, 0, {{{{{{0U}},
                                                                            ...
                                                                            0, {0,
                                                                                ...
                                                                                0UL}}}},
                                                                         {0, 0}},
    0UL, 0UL, 0, & spcp8x5_startup, 0, 0, & spcp8x5_release, 0, 0, 0, 0, & spcp8x5_open,
...
static struct usb_serial_driver * const  serial_drivers[2U]  = {      & spcp8x5_device,      0};
static int spcp8x5_init(void) 
{ 
  int retval ;

  {
  retval = usb_serial_register_drivers(& spcp8x5_driver, (struct usb_serial_driver * const  *)(& serial_drivers));
  if (retval == 0) {
...
{ 
  ...
  {
  usb_serial_deregister_drivers(& spcp8x5_driver, (struct usb_serial_driver * const  *)(& serial_drivers));
  return;
}
}
