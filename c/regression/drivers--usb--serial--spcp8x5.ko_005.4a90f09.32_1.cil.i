...
void reach_error() { __assert_fail("0", "drivers--usb--serial--spcp8x5.ko_005.4a90f09.32_1.cil.i", 3, "reach_error"); }
...
{ 
  ...
  while (1) {
    ...
    tmp___1 = kzalloc(sizeof(struct spcp8x5_private ), (16U | 64U) | 128U);
    priv = tmp___1;
    if (! priv) {
      goto cleanup;
    } else {
...
{ 
  ...
  tmp___2 = get_ringbuf(priv->buf, (port->write_urb)->transfer_buffer, port->bulk_out_size);
  count = tmp___2;
  if (count == 0) {
    while (1) {
      _spin_unlock_irqrestore(& priv->lock, flags);
...
{ 
  ...
  tmp___2 = put_ringbuf(priv->buf, buf, count);
  count = tmp___2;
  while (1) {
    _spin_unlock_irqrestore(& priv->lock, flags);
    break;
...
static struct usb_serial_driver spcp8x5_device  = 
    ...
    0, 0, & spcp8x5_tiocmget, & spcp8x5_tiocmset, 0, 0, & spcp8x5_read_bulk_callback,
    & spcp8x5_write_bulk_callback};
...
static char const   __mod_description1075[49]  __attribute__((__used__, __unused__,
__section__(".modinfo")))  = 
  {      'd',      'e',      's',      'c', 
        'r',      'i',      'p',      't', 
        'i',      'o',      'n',      '=', 
        ...
        'i',      'v',      'e',      'r', 
        '\000'};
static char const   __mod_version1076[14]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'v',      'e',      'r',      's', 
        'i',      'o',      'n',      '=', 
        'v',      '0',      '.',      '0', 
        '4',      '\000'};
static char const   __mod_license1077[12]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'l',      'i',      'c',      'e', 
        'n',      's',      'e',      '=', 
        'G',      'P',      'L',      '\000'};
...
__section__("__param"), __aligned__(sizeof(void *))))  =    {__param_str_debug, ((256 | 32) | 4) | 128, & param_set_bool, & param_get_bool,
    {& debug}};
static char const   __mod_debugtype1079[20]  __attribute__((__used__, __unused__,
__section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        't',      'y',      'p',      'e', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'b', 
        'o',      'o',      'l',      '\000'};
static char const   __mod_debug1080[32]  __attribute__((__used__, __unused__, __section__(".modinfo")))  = 
  {      'p',      'a',      'r',      'm', 
        '=',      'd',      'e',      'b', 
        'u',      'g',      ':',      'D', 
        'e',      'b',      'u',      'g', 
