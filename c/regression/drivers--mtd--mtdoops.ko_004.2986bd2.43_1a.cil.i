...
void reach_error() { __assert_fail("0", "drivers--mtd--mtdoops.ko_004.2986bd2.43_1a.cil.i", 3, "reach_error"); }
...
union __anonunion_ldv_6975_75 {
   atomic_t _mapcount ;
   unsigned int inuse ;
};
struct __anonstruct_ldv_6980_77 {
   unsigned long private ;
   struct address_space *mapping ;
};
union __anonunion_ldv_6984_76 {
   struct __anonstruct_ldv_6980_77 ldv_6980 ;
   spinlock_t ptl ;
   struct kmem_cache *slab ;
   struct page *first_page ;
};
union __anonunion_ldv_6988_78 {
   unsigned long index ;
   void *freelist ;
};
struct page {
   unsigned long flags ;
   atomic_t _count ;
   union __anonunion_ldv_6975_75 ldv_6975 ;
   union __anonunion_ldv_6984_76 ldv_6984 ;
   union __anonunion_ldv_6988_78 ldv_6988 ;
...
union __anonunion_ldv_8417_96 {
   pid_t pgrp ;
   pid_t __pgrp ;
};
union __anonunion_ldv_8422_97 {
   pid_t session ;
   pid_t __session ;
};
struct taskstats;
...
struct signal_struct {
   ...
   union __anonunion_ldv_8417_96 ldv_8417 ;
   struct pid *tty_old_pgrp ;
   union __anonunion_ldv_8422_97 ldv_8422 ;
   int leader ;
...
typedef enum ldv_5754 mtd_oob_mode_t;
struct mtd_oob_ops {
   mtd_oob_mode_t mode ;
   size_t len ;
   size_t retlen ;
