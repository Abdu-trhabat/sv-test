...
void reach_error() { __assert_fail("0", "drivers--gpu--drm--i915--i915.ko_038.5a125c3.32_1.cil.i", 3, "reach_error"); }
...
union __anonunion_arg_104 {
   char *buf ;
   void *data ;
};
struct __anonstruct_read_descriptor_t_103 {
   size_t written ;
   size_t count ;
   union __anonunion_arg_104 arg ;
   int error ;
};
typedef struct __anonstruct_read_descriptor_t_103 read_descriptor_t;
...
struct inode {
   ...
   union __anonunion____missing_field_name_105 __annonCompField12 ;
   int i_cindex ;
   __u32 i_generation ;
...
union __anonunion____missing_field_name_115 {
   struct __anonstruct____missing_field_name_116 __annonCompField15 ;
   spinlock_t ptl ;
...
struct page {
   ...
   union __anonunion____missing_field_name_115 __annonCompField16 ;
   union __anonunion____missing_field_name_117 __annonCompField17 ;
...
struct signal_struct {
   ...
   union __anonunion____missing_field_name_134 __annonCompField18 ;
   struct pid *tty_old_pgrp ;
   union __anonunion____missing_field_name_135 __annonCompField19 ;
   int leader ;
...
enum __anonenum_func_148 {
    I915_INIT_DMA = 1,
    I915_CLEANUP_DMA = 2,
    I915_RESUME_DMA = 3
} ;
struct _drm_i915_init {
   enum __anonenum_func_148 func ;
...
struct __anonstruct_mm_150 {
   uint32_t last_gem_seqno ;
   uint32_t last_gem_throttle_seqno ;
};
struct drm_i915_file_private {
   struct __anonstruct_mm_150 mm ;
};
enum hrtimer_restart;
    ...
    if (tmp) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "i" (789), "i" (sizeof(struct bug_entry )));
        while (1) {
      ...
      if (tmp) {
        while (1) {
          __asm__  volatile   ("1:\tud2\n"
                               ...
                               "\t.org 2b+%c2\n"
                               ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                               "i" (916), "i" (sizeof(struct bug_entry )));
          while (1) {
        ...
        if (tmp) {
          while (1) {
            __asm__  volatile   ("1:\tud2\n"
                                 ...
                                 "\t.org 2b+%c2\n"
                                 ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                                 "i" (1023), "i" (sizeof(struct bug_entry )));
            while (1) {
        ...
        if (tmp___0) {
          while (1) {
            __asm__  volatile   ("1:\tud2\n"
                                 ...
                                 "\t.org 2b+%c2\n"
                                 ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                                 "i" (1027), "i" (sizeof(struct bug_entry )));
            while (1) {
    ...
    if (tmp) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (1109), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___2) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (1217), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___3) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (1218), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___2) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (1963), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2052), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___0) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2053), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___1) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2217), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___3) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2327), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___6) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2328), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___9) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2333), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___12) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2342), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___15) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2343), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___18) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2344), "i" (sizeof(struct bug_entry )));
        while (1) {
    ...
    if (tmp___21) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/gpu/drm/i915/i915.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/21/dscv_tempdir/dscv/ri/32_1/drivers/gpu/drm/i915/i915_gem.c"),
                             "i" (2345), "i" (sizeof(struct bug_entry )));
        while (1) {
