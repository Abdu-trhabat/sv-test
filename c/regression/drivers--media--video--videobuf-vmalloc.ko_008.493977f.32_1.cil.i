...
void reach_error() { __assert_fail("0", "drivers--media--video--videobuf-vmalloc.ko_008.493977f.32_1.cil.i", 3, "reach_error"); }
    ...
    if (tmp) {
      while (1) {
        __asm__  volatile   ("1:\tud2\n"
                             ...
                             "\t.word %c1, 0\n"
                             "\t.org 2b+%c2\n"
                             ".popsection": : "i" ("/work/ldvuser/novikov/work/current--X--drivers/media/video/videobuf-vmalloc.ko--X--defaultlinux--X--32_1--X--cpachecker/linux/csd_deg_dscv/10/dscv_tempdir/dscv/ri/32_1/drivers/media/video/videobuf-vmalloc.c"),
