...
void reach_error() { __assert_fail("0", "function_nested_unsafe_unspecified_pointer1-1.c", 3, "reach_error"); }

int f1(int a, int * intStorage) {
...
int main() {
  ...
  *intStorage = 0;
  ...
  // *intStorage is either 3 or 4, (3 is more likely) depending on the order of execution
