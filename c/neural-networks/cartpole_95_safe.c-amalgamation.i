...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.47977435920908074f && tensor_input[0][0] <= 0.4886125207909192f)) abort();
 if(!(tensor_input[0][1] >= -0.4948293807909192f && tensor_input[0][1] <= -0.48599121920908084f)) abort();
 if(!(tensor_input[0][2] >= 0.007325059209080789f && tensor_input[0][2] <= 0.01616322079091921f)) abort();
 if(!(tensor_input[0][3] >= 0.5846283192090808f && tensor_input[0][3] <= 0.5934664807909192f)) abort();
