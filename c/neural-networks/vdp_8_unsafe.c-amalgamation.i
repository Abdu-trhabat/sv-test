...
int main()
{
 ...
 if(!(!((tensor_output[0][1] <= 0.48872420142346396) && (tensor_output[0][1] >= -0.48872420142346396) && (tensor_output[0][2] <= 0.48872420142346396) && (tensor_output[0][2] >= -0.48872420142346396) && (tensor_output[0][0] >= 0.17218106899686667)))) reach_error();
 return 0;
}
