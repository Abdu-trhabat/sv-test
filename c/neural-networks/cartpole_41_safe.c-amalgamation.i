...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.39008023207914894f && tensor_input[0][0] <= -0.37061230792085104f)) abort();
 if(!(tensor_input[0][1] >= 0.6816152379208511f && tensor_input[0][1] <= 0.7010831620791489f)) abort();
 if(!(tensor_input[0][2] >= -0.16651576207914892f && tensor_input[0][2] <= -0.14704783792085108f)) abort();
 if(!(tensor_input[0][3] >= -1.030734062079149f && tensor_input[0][3] <= -1.011266137920851f)) abort();
