...
int main()
{
 ...
 if(!(__builtin_isgreater(x[1][1], -1e18f) && __builtin_isless(x[1][1], 1e18f))) abort();;
 batchnorm(x, y, mean, std, gamma, beta, 4, 4);
 if(!(__builtin_islessequal(y[0][2] + y[0][3] + y[1][2] + y[1][3], y[0][0] + y[0][1] + y[1][0] + y[1][1]))) reach_error();
    return 0;
}
