...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2452663574144357f && tensor_input[0][0] <= -0.23518842258556433f)) abort();
 if(!(tensor_input[0][1] >= -0.05604914741443569f && tensor_input[0][1] <= -0.04597121258556432f)) abort();
 if(!(tensor_input[0][2] >= -0.09010839241443569f && tensor_input[0][2] <= -0.08003045758556432f)) abort();
 if(!(tensor_input[0][3] >= -0.38429068741443567f && tensor_input[0][3] <= -0.37421275258556436f)) abort();
