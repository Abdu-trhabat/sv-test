...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.05549104989941913f && tensor_input[0][0] <= -0.04762885010058087f)) abort();
 if(!(tensor_input[0][1] >= -0.43609394989941913f && tensor_input[0][1] <= -0.42823175010058084f)) abort();
 if(!(tensor_input[0][2] >= -0.03762770689941913f && tensor_input[0][2] <= -0.029765507100580874f)) abort();
 if(!(tensor_input[0][3] >= 0.4034858001005809f && tensor_input[0][3] <= 0.41134799989941917f)) abort();
