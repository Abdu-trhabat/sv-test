...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.038745839847399176f && tensor_input[0][0] <= -0.03325653415260082f)) abort();
 if(!(tensor_input[0][1] >= -0.43541509284739915f && tensor_input[0][1] <= -0.4299257871526008f)) abort();
 if(!(tensor_input[0][2] >= -0.05876692284739918f && tensor_input[0][2] <= -0.05327761715260082f)) abort();
 if(!(tensor_input[0][3] >= 0.4163375071526008f && tensor_input[0][3] <= 0.42182681284739915f)) abort();
