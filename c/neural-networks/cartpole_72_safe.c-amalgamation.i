...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.25418097836458226f && tensor_input[0][0] <= -0.24184008163541776f)) abort();
 if(!(tensor_input[0][1] >= -0.057172321364582245f && tensor_input[0][1] <= -0.04483142463541776f)) abort();
 if(!(tensor_input[0][2] >= -0.07998837836458224f && tensor_input[0][2] <= -0.06764748163541777f)) abort();
 if(!(tensor_input[0][3] >= -0.38528796836458223f && tensor_input[0][3] <= -0.37294707163541774f)) abort();
