...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2641275747886794f && tensor_input[0][0] <= -0.25463614521132066f)) abort();
 if(!(tensor_input[0][1] >= -0.44918643478867937f && tensor_input[0][1] <= -0.43969500521132066f)) abort();
 if(!(tensor_input[0][2] >= -0.028346132788679333f && tensor_input[0][2] <= -0.01885470321132067f)) abort();
 if(!(tensor_input[0][3] >= 0.27300718521132067f && tensor_input[0][3] <= 0.2824986147886794f)) abort();
