...
int main()
{
 ...
 if(!(tensor_input[0][2] >= -4.840989561921324f && tensor_input[0][2] <= 4.8488407390132595f)) abort();
 if(!(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f)) abort();
 if(!(tensor_input[0][4] >= -1.11235956837213f && tensor_input[0][4] <= 5.195179481948719f)) abort();
 if(!(tensor_input[0][5] >= -4.817845604474652f && tensor_input[0][5] <= 4.884347540772428f)) abort();
 if(!(tensor_input[0][6] >= -4.83996499496831f && tensor_input[0][6] <= 4.828460096771088f)) abort();
 if(!(tensor_input[0][7] >= -4.927353333386714f && tensor_input[0][7] <= 4.917236327274189f)) abort();
 if(!(tensor_input[0][8] >= -4.846618068198823f && tensor_input[0][8] <= 4.8148335930182f)) abort();
 if(!(tensor_input[0][9] >= -4.887436183882981f && tensor_input[0][9] <= 4.884807626621945f)) abort();
 if(!(tensor_input[0][10] >= -4.829182433397243f && tensor_input[0][10] <= 4.80258345922357f)) abort();
