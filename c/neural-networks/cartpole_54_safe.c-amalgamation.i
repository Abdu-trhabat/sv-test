...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.24461735253875527f && tensor_input[0][0] <= -0.24152554746124472f)) abort();
 if(!(tensor_input[0][1] >= -0.2483006225387553f && tensor_input[0][1] <= -0.24520881746124473f)) abort();
 if(!(tensor_input[0][2] >= -0.07401872253875526f && tensor_input[0][2] <= -0.07092691746124473f)) abort();
 if(!(tensor_input[0][3] >= -0.07330642253875526f && tensor_input[0][3] <= -0.07021461746124473f)) abort();
