...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.03699543815864681f && tensor_input[0][0] <= -0.02971209184135319f)) abort();
 if(!(tensor_input[0][1] >= 0.1465956168413532f && tensor_input[0][1] <= 0.1538789631586468f)) abort();
 if(!(tensor_input[0][2] >= -0.05188023015864681f && tensor_input[0][2] <= -0.04459688384135319f)) abort();
 if(!(tensor_input[0][3] >= -0.40956027315864685f && tensor_input[0][3] <= -0.4022769268413532f)) abort();
