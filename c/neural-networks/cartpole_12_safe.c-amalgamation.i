...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.028563969533472067f && tensor_input[0][0] <= 0.06525167846652793f)) abort();
 if(!(tensor_input[0][1] >= 0.37436870553347207f && tensor_input[0][1] <= 0.4110564144665279f)) abort();
 if(!(tensor_input[0][2] >= -0.09035249446652793f && tensor_input[0][2] <= -0.053664785533472065f)) abort();
 if(!(tensor_input[0][3] >= -0.659551354466528f && tensor_input[0][3] <= -0.6228636455334721f)) abort();
