...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2667300186138323f && tensor_input[0][0] <= -0.24496762138616765f)) abort();
 if(!(tensor_input[0][1] >= 0.32745327138616764f && tensor_input[0][1] <= 0.34921566861383235f)) abort();
 if(!(tensor_input[0][2] >= -0.07223724861383232f && tensor_input[0][2] <= -0.050474851386167675f)) abort();
 if(!(tensor_input[0][3] >= -0.9557112986138323f && tensor_input[0][3] <= -0.9339489013861677f)) abort();
