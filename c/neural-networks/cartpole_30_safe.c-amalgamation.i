...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4576699016464734f && tensor_input[0][0] <= 0.47526229835352657f)) abort();
 if(!(tensor_input[0][1] >= -0.3046722283535266f && tensor_input[0][1] <= -0.28707983164647344f)) abort();
 if(!(tensor_input[0][2] >= 0.020951855646473415f && tensor_input[0][2] <= 0.038544252353526584f)) abort();
 if(!(tensor_input[0][3] >= 0.30063120164647344f && tensor_input[0][3] <= 0.3182235983535266f)) abort();
