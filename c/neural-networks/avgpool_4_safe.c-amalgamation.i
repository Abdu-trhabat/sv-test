...
int main()
{
 ...
 if(!(__builtin_isgreater(x[0], -1e37f) && __builtin_isless(x[0], 1e37f))) abort();;
 if(!(__builtin_isgreater(x[1], -1e37f) && __builtin_isless(x[1], 1e37f))) abort();;
 if(!(__builtin_isgreater(x[2], -1e37f) && __builtin_isless(x[2], 1e37f))) abort();;
 if(!(__builtin_isgreater(x[4], -1e37f) && __builtin_isless(x[4], 1e37f))) abort();;
 if(!(__builtin_isgreater(x[5], -1e37f) && __builtin_isless(x[5], 1e37f))) abort();;
 if(!(__builtin_isgreater(x[7], -1e37f) && __builtin_isless(x[7], 1e37f))) abort();;
 avgpool(x, y, 8, 4, 1);
 if(!(__builtin_islessequal(y[3], fmaxf(fmaxf(x[4], x[5]), 3.14f)))) reach_error();
    return 0;
}
