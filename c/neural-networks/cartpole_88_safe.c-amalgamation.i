...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.04220074418040166f && tensor_input[0][0] <= -0.03410460781959835f)) abort();
 if(!(tensor_input[0][1] >= -0.04821575118040165f && tensor_input[0][1] <= -0.040119614819598345f)) abort();
 if(!(tensor_input[0][2] >= -0.04871203418040165f && tensor_input[0][2] <= -0.040615897819598346f)) abort();
 if(!(tensor_input[0][3] >= -0.13282032818040165f && tensor_input[0][3] <= -0.12472419181959835f)) abort();
