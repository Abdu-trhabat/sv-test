...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.26865617254964774f && tensor_input[0][0] <= -0.25857778745035226f)) abort();
 if(!(tensor_input[0][1] >= -0.05618565854964776f && tensor_input[0][1] <= -0.046107273450352246f)) abort();
 if(!(tensor_input[0][2] >= -0.05548061054964776f && tensor_input[0][2] <= -0.045402225450352246f)) abort();
 if(!(tensor_input[0][3] >= -0.38044623254964777f && tensor_input[0][3] <= -0.3703678474503523f)) abort();
