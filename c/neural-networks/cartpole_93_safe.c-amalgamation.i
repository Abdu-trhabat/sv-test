...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4877579574485677f && tensor_input[0][0] <= 0.4964371625514323f)) abort();
 if(!(tensor_input[0][1] >= -0.10433959255143228f && tensor_input[0][1] <= -0.09566038744856771f)) abort();
 if(!(tensor_input[0][2] >= 0.001514055948567709f && tensor_input[0][2] <= 0.010193261051432291f)) abort();
 if(!(tensor_input[0][3] >= -0.004339613454721291f && tensor_input[0][3] <= 0.004339591648143291f)) abort();
