...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.27171550616314905f && tensor_input[0][0] <= -0.261292693836851f)) abort();
 if(!(tensor_input[0][1] >= -0.6430285061631491f && tensor_input[0][1] <= -0.632605693836851f)) abort();
 if(!(tensor_input[0][2] >= -0.04212679616314903f && tensor_input[0][2] <= -0.03170398383685097f)) abort();
 if(!(tensor_input[0][3] >= 0.5271063938368509f && tensor_input[0][3] <= 0.537529206163149f)) abort();
