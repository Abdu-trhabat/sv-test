...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.04191635498813779f && tensor_input[0][0] <= 0.09872842501186221f)) abort();
 if(!(tensor_input[0][1] >= 0.7548525249881378f && tensor_input[0][1] <= 0.8116645950118623f)) abort();
 if(!(tensor_input[0][2] >= -0.1355923600118622f && tensor_input[0][2] <= -0.0787802899881378f)) abort();
 if(!(tensor_input[0][3] >= -1.2658573350118623f && tensor_input[0][3] <= -1.2090452649881378f)) abort();
