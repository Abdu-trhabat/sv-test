...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.4176180902258744f && tensor_input[0][0] <= -0.35869962977412556f)) abort();
 if(!(tensor_input[0][1] >= 1.0512665697741255f && tensor_input[0][1] <= 1.1101850302258744f)) abort();
 if(!(tensor_input[0][2] >= -0.1742811902258744f && tensor_input[0][2] <= -0.11536272977412558f)) abort();
 if(!(tensor_input[0][3] >= -1.6190694302258746f && tensor_input[0][3] <= -1.5601509697741256f)) abort();
