...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2515782510038075f && tensor_input[0][0] <= -0.23459800899619251f)) abort();
 if(!(tensor_input[0][1] >= 0.1345470489961925f && tensor_input[0][1] <= 0.1515272910038075f)) abort();
 if(!(tensor_input[0][2] >= -0.0805918110038075f && tensor_input[0][2] <= -0.0636115689961925f)) abort();
 if(!(tensor_input[0][3] >= -0.6568770810038075f && tensor_input[0][3] <= -0.6398968389961924f)) abort();
