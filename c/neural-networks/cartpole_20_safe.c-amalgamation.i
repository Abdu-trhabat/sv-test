...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.0379002045345187f && tensor_input[0][0] <= 0.0715301014654813f)) abort();
 if(!(tensor_input[0][1] >= 0.3762166815345187f && tensor_input[0][1] <= 0.40984657846548134f)) abort();
 if(!(tensor_input[0][2] >= -0.1006050084654813f && tensor_input[0][2] <= -0.0669751115345187f)) abort();
 if(!(tensor_input[0][3] >= -0.6656175484654813f && tensor_input[0][3] <= -0.6319876515345187f)) abort();
