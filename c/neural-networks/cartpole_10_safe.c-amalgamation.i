...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.1002256940590116f && tensor_input[0][0] <= -0.04054062594098839f)) abort();
 if(!(tensor_input[0][1] >= -0.6193572340590116f && tensor_input[0][1] <= -0.5596721659409883f)) abort();
 if(!(tensor_input[0][2] >= 0.07871927594098838f && tensor_input[0][2] <= 0.1384043440590116f)) abort();
 if(!(tensor_input[0][3] >= 0.9445111959409884f && tensor_input[0][3] <= 1.0041962640590116f)) abort();
