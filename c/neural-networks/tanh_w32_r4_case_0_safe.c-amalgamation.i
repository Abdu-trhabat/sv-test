...
int main()
{
 ...
 if(!(__builtin_isgreaterequal(output_array[126], 0.0f))) reach_error();
    return 0;
}
...
void hop_tanh_w32_r3(k2c_tensor* simple_rnn_42_input_input, k2c_tensor* simple_rnn_42_output) {
int simple_rnn_42_go_backwards = 0;
int simple_rnn_42_return_sequences = 1;
float simple_rnn_42_fwork[64] = {0};
float simple_rnn_42_state[32] = {0};
float simple_rnn_42_kernel_array[1024] = {
+1.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
...
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+1.00000000e+00f,};
k2c_tensor simple_rnn_42_kernel = {&simple_rnn_42_kernel_array[0],2,1024,{32,32, 1, 1, 1}};
float simple_rnn_42_recurrent_kernel_array[1024] = {
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
...
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,};
k2c_tensor simple_rnn_42_recurrent_kernel = {&simple_rnn_42_recurrent_kernel_array[0],2,1024,{32,32, 1, 1, 1}};
float simple_rnn_42_bias_array[32] = {0};
k2c_tensor simple_rnn_42_bias = {&simple_rnn_42_bias_array[0],1,32,{32, 1, 1, 1, 1}};
k2c_simpleRNN(simple_rnn_42_output,simple_rnn_42_input_input,simple_rnn_42_state,&simple_rnn_42_kernel,
 &simple_rnn_42_recurrent_kernel,&simple_rnn_42_bias,simple_rnn_42_fwork,
 simple_rnn_42_go_backwards,simple_rnn_42_return_sequences,k2c_tanh);
 }
void hop_tanh_w32_r3_initialize() {
}
void hop_tanh_w32_r3_terminate() {
}
void hop_tanh_w32_r4(k2c_tensor* simple_rnn_6_input_input, k2c_tensor* simple_rnn_6_output) {
