...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.04317455154793379f && tensor_input[0][0] <= -0.00367114845206621f)) abort();
 if(!(tensor_input[0][1] >= -0.6057662015479338f && tensor_input[0][1] <= -0.5662627984520662f)) abort();
 if(!(tensor_input[0][2] >= 0.015553962452066212f && tensor_input[0][2] <= 0.05505736554793379f)) abort();
 if(!(tensor_input[0][3] >= 0.8729270984520662f && tensor_input[0][3] <= 0.9124305015479338f)) abort();
