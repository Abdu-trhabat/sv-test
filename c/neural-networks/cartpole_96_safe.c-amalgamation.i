...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.27827620297728844f && tensor_input[0][0] <= -0.26469859702271153f)) abort();
 if(!(tensor_input[0][1] >= 0.33043815702271156f && tensor_input[0][1] <= 0.3440157629772885f)) abort();
 if(!(tensor_input[0][2] >= -0.044072897977288444f && tensor_input[0][2] <= -0.030495292022711562f)) abort();
 if(!(tensor_input[0][3] >= -0.9262667429772885f && tensor_input[0][3] <= -0.9126891370227116f)) abort();
