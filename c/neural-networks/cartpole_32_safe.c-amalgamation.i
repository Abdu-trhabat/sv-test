...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.026254261999269675f && tensor_input[0][0] <= 0.044078618000730325f)) abort();
 if(!(tensor_input[0][1] >= 0.18796220199926966f && tensor_input[0][1] <= 0.2057865580007303f)) abort();
 if(!(tensor_input[0][2] >= -0.06258983800073033f && tensor_input[0][2] <= -0.04476548199926968f)) abort();
 if(!(tensor_input[0][3] >= -0.3406716580007303f && tensor_input[0][3] <= -0.3228473019992697f)) abort();
