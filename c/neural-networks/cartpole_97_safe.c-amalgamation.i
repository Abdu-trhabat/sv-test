...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.25703597204782436f && tensor_input[0][0] <= -0.24828690795217567f)) abort();
 if(!(tensor_input[0][1] >= -0.25318974204782435f && tensor_input[0][1] <= -0.24444067795217567f)) abort();
 if(!(tensor_input[0][2] >= -0.045830142047824346f && tensor_input[0][2] <= -0.03708107795217565f)) abort();
 if(!(tensor_input[0][3] >= -0.03052923204782435f && tensor_input[0][3] <= -0.02178016795217565f)) abort();
