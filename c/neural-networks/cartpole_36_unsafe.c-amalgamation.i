...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4301837116958922f && tensor_input[0][0] <= 0.4398293483041078f)) abort();
 if(!(tensor_input[0][1] >= -0.3041501583041078f && tensor_input[0][1] <= -0.2945045216958922f)) abort();
 if(!(tensor_input[0][2] >= 0.0690852116958922f && tensor_input[0][2] <= 0.0787308483041078f)) abort();
 if(!(tensor_input[0][3] >= 0.3815771316958922f && tensor_input[0][3] <= 0.3912227683041078f)) abort();
