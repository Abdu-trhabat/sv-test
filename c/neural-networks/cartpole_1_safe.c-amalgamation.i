...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.46142588812490537f && tensor_input[0][0] <= 0.5184226718750946f)) abort();
 if(!(tensor_input[0][1] >= 0.06721501812490535f && tensor_input[0][1] <= 0.12421180187509465f)) abort();
 if(!(tensor_input[0][2] >= -0.03483366687509465f && tensor_input[0][2] <= 0.022163116875094646f)) abort();
 if(!(tensor_input[0][3] >= -0.33422889187509464f && tensor_input[0][3] <= -0.2772321081249054f)) abort();
