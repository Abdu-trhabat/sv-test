...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.0334391389803931f && tensor_input[0][0] <= -0.027728325019606898f)) abort();
 if(!(tensor_input[0][1] >= 0.33771292301960687f && tensor_input[0][1] <= 0.3434237369803931f)) abort();
 if(!(tensor_input[0][2] >= -0.0380141229803931f && tensor_input[0][2] <= -0.0323033090196069f)) abort();
 if(!(tensor_input[0][3] >= -0.5956316069803931f && tensor_input[0][3] <= -0.5899207930196069f)) abort();
