...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.26113676983871037f && tensor_input[0][0] <= -0.2562197501612896f)) abort();
 if(!(tensor_input[0][1] >= -0.24939507983871037f && tensor_input[0][1] <= -0.24447806016128962f)) abort();
 if(!(tensor_input[0][2] >= -0.05154693983871039f && tensor_input[0][2] <= -0.04662992016128961f)) abort();
 if(!(tensor_input[0][3] >= -0.07010796383871039f && tensor_input[0][3] <= -0.06519094416128961f)) abort();
