...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.25526912207249614f && tensor_input[0][0] <= -0.25131623792750385f)) abort();
 if(!(tensor_input[0][1] >= -0.05677200907249614f && tensor_input[0][1] <= -0.05281912492750387f)) abort();
 if(!(tensor_input[0][2] >= -0.019537418072496135f && tensor_input[0][2] <= -0.015584533927503863f)) abort();
 if(!(tensor_input[0][3] >= -0.2965090420724961f && tensor_input[0][3] <= -0.29255615792750383f)) abort();
