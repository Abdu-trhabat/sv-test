...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2806474490426547f && tensor_input[0][0] <= -0.27793675095734527f)) abort();
 if(!(tensor_input[0][1] >= -0.05435324904265475f && tensor_input[0][1] <= -0.051642550957345254f)) abort();
 if(!(tensor_input[0][2] >= -0.026934419042654745f && tensor_input[0][2] <= -0.024223720957345252f)) abort();
 if(!(tensor_input[0][3] >= -0.3355960490426547f && tensor_input[0][3] <= -0.3328853509573453f)) abort();
