...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4478853364225503f && tensor_input[0][0] <= 0.4537641435774497f)) abort();
 if(!(tensor_input[0][1] >= -0.6880860335774497f && tensor_input[0][1] <= -0.6822072264225503f)) abort();
 if(!(tensor_input[0][2] >= 0.04291683042255032f && tensor_input[0][2] <= 0.04879563757744969f)) abort();
 if(!(tensor_input[0][3] >= 0.8708827464225503f && tensor_input[0][3] <= 0.8767615535774497f)) abort();
