...
int main()
{
 ...
 if(!(tensor_input[0][2] >= -3.359414996589872f && tensor_input[0][2] <= 3.367266173681808f)) abort();
 if(!(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f)) abort();
 if(!(tensor_input[0][4] >= 1.4415085045840699f && tensor_input[0][4] <= 5.195179481948719f)) abort();
 if(!(tensor_input[0][5] >= -3.334380760870031f && tensor_input[0][5] <= 3.4008826971678072f)) abort();
 if(!(tensor_input[0][6] >= -3.3616632850454944f && tensor_input[0][6] <= 3.3501583868482725f)) abort();
 if(!(tensor_input[0][7] >= -3.4221160697420228f && tensor_input[0][7] <= 3.411999063629498f)) abort();
 if(!(tensor_input[0][8] >= -3.369382595451911f && tensor_input[0][8] <= 3.3375981202712888f)) abort();
 if(!(tensor_input[0][9] >= -3.39326059708603f && tensor_input[0][9] <= 3.3906320398249936f)) abort();
 if(!(tensor_input[0][10] >= -3.3564859131746307f && tensor_input[0][10] <= 3.329886939000958f)) abort();
