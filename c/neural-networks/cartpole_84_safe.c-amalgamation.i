...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4855698671426743f && tensor_input[0][0] <= 0.4946252328573257f)) abort();
 if(!(tensor_input[0][1] >= -0.2997330628573257f && tensor_input[0][1] <= -0.29067769714267433f)) abort();
 if(!(tensor_input[0][2] >= 0.0013259756426743123f && tensor_input[0][2] <= 0.010381341357325689f)) abort();
 if(!(tensor_input[0][3] >= 0.2899963571426743f && tensor_input[0][3] <= 0.2990517228573257f)) abort();
