...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.03472532739182417f && tensor_input[0][0] <= -0.027739452608175827f)) abort();
 if(!(tensor_input[0][1] >= -0.24193276739182415f && tensor_input[0][1] <= -0.23494689260817583f)) abort();
 if(!(tensor_input[0][2] >= -0.06242637739182417f && tensor_input[0][2] <= -0.055440502608175825f)) abort();
 if(!(tensor_input[0][3] >= 0.14206548260817584f && tensor_input[0][3] <= 0.14905135739182415f)) abort();
