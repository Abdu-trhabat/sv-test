...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2756855973456875f && tensor_input[0][0] <= -0.2608557426543125f)) abort();
 if(!(tensor_input[0][1] >= -0.2564051073456875f && tensor_input[0][1] <= -0.24157525265431254f)) abort();
 if(!(tensor_input[0][2] >= -0.025460287345687477f && tensor_input[0][2] <= -0.010630432654312521f)) abort();
 if(!(tensor_input[0][3] >= -0.029694082345687475f && tensor_input[0][3] <= -0.01486422765431252f)) abort();
