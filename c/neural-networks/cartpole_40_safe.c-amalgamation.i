...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.4092895047644313f && tensor_input[0][0] <= -0.38679693523556863f)) abort();
 if(!(tensor_input[0][1] >= 0.8730294152355687f && tensor_input[0][1] <= 0.8955219847644313f)) abort();
 if(!(tensor_input[0][2] >= -0.14249628476443132f && tensor_input[0][2] <= -0.12000371523556867f)) abort();
 if(!(tensor_input[0][3] >= -1.2744639847644312f && tensor_input[0][3] <= -1.2519714152355688f)) abort();
