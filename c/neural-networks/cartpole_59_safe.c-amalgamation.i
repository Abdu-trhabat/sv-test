...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.25071405742385394f && tensor_input[0][0] <= -0.23899242257614603f)) abort();
 if(!(tensor_input[0][1] >= -0.25432681742385393f && tensor_input[0][1] <= -0.24260518257614602f)) abort();
 if(!(tensor_input[0][2] >= -0.05910250242385396f && tensor_input[0][2] <= -0.047380867576146034f)) abort();
 if(!(tensor_input[0][3] >= -0.03973980342385396f && tensor_input[0][3] <= -0.028018168576146037f)) abort();
