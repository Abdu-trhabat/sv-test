...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.4163068504743891f && tensor_input[0][0] <= -0.3443856895256109f)) abort();
 if(!(tensor_input[0][1] >= 1.0451431195256107f && tensor_input[0][1] <= 1.117064280474389f)) abort();
 if(!(tensor_input[0][2] >= -0.19274238047438913f && tensor_input[0][2] <= -0.12082121952561088f)) abort();
 if(!(tensor_input[0][3] >= -1.6365536804743892f && tensor_input[0][3] <= -1.5646325195256108f)) abort();
