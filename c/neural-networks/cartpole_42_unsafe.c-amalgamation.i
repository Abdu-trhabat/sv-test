...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4237522201110955f && tensor_input[0][0] <= 0.43106183988890456f)) abort();
 if(!(tensor_input[0][1] >= -0.30155850988890454f && tensor_input[0][1] <= -0.29424889011109545f)) abort();
 if(!(tensor_input[0][2] >= 0.08545468511109545f && tensor_input[0][2] <= 0.09276430488890454f)) abort();
 if(!(tensor_input[0][3] >= 0.35167277011109543f && tensor_input[0][3] <= 0.3589823898889045f)) abort();
