...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2600140945577128f && tensor_input[0][0] <= -0.2516758654422872f)) abort();
 if(!(tensor_input[0][1] >= -0.4458208145577128f && tensor_input[0][1] <= -0.4374825854422872f)) abort();
 if(!(tensor_input[0][2] >= -0.06561146755771281f && tensor_input[0][2] <= -0.05727323844228718f)) abort();
 if(!(tensor_input[0][3] >= 0.21241613544228719f && tensor_input[0][3] <= 0.22075436455771283f)) abort();
