...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.26495380459304924f && tensor_input[0][0] <= -0.2623515954069508f)) abort();
 if(!(tensor_input[0][1] >= -0.05314113459304924f && tensor_input[0][1] <= -0.05053892540695076f)) abort();
 if(!(tensor_input[0][2] >= -0.05096166059304924f && tensor_input[0][2] <= -0.04835945140695076f)) abort();
 if(!(tensor_input[0][3] >= -0.36138510459304923f && tensor_input[0][3] <= -0.3587828954069508f)) abort();
