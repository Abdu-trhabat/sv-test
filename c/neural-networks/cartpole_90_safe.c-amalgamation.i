...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.26130052959386224f && tensor_input[0][0] <= -0.25032697040613777f)) abort();
 if(!(tensor_input[0][1] >= -0.05648612659386224f && tensor_input[0][1] <= -0.04551256740613776f)) abort();
 if(!(tensor_input[0][2] >= -0.06761689559386225f && tensor_input[0][2] <= -0.05664333640613776f)) abort();
 if(!(tensor_input[0][3] >= -0.38437800959386226f && tensor_input[0][3] <= -0.3734044504061378f)) abort();
