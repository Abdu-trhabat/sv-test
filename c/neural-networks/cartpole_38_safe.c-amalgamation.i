...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4653275650674913f && tensor_input[0][0] <= 0.48315743493250873f)) abort();
 if(!(tensor_input[0][1] >= -0.6935869349325087f && tensor_input[0][1] <= -0.6757570650674912f)) abort();
 if(!(tensor_input[0][2] >= 0.001748264067491262f && tensor_input[0][2] <= 0.019578133932508738f)) abort();
 if(!(tensor_input[0][3] >= 0.8538347650674912f && tensor_input[0][3] <= 0.8716646349325087f)) abort();
