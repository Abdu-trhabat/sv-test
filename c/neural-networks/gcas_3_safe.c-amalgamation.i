...
int main()
{
 ...
 if(!(tensor_input[0][2] >= -2.5917639217463746f && tensor_input[0][2] <= 2.5996150988383104f)) abort();
 if(!(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f)) abort();
 if(!(tensor_input[0][4] >= 1.067234227198703f && tensor_input[0][4] <= 5.195179481948719f)) abort();
 if(!(tensor_input[0][5] >= -2.565750272514649f && tensor_input[0][5] <= 2.6322522088124245f)) abort();
 if(!(tensor_input[0][6] >= -2.59570798106027f && tensor_input[0][6] <= 2.5842030828630485f)) abort();
 if(!(tensor_input[0][7] >= -2.642204595578164f && tensor_input[0][7] <= 2.632087589465639f)) abort();
 if(!(tensor_input[0][8] >= -2.6039797429823066f && tensor_input[0][8] <= 2.572195267801684f)) abort();
 if(!(tensor_input[0][9] >= -2.6190805307908254f && tensor_input[0][9] <= 2.6164519735297893f)) abort();
 if(!(tensor_input[0][10] >= -2.5934348368933287f && tensor_input[0][10] <= 2.566835862719657f)) abort();
