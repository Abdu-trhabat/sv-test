...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.02113823750667874f && tensor_input[0][0] <= -0.016611802493321257f)) abort();
 if(!(tensor_input[0][1] >= -0.04920080950667874f && tensor_input[0][1] <= -0.04467437449332126f)) abort();
 if(!(tensor_input[0][2] >= -0.06303995050667874f && tensor_input[0][2] <= -0.05851351549332126f)) abort();
 if(!(tensor_input[0][3] >= -0.06993232750667874f && tensor_input[0][3] <= -0.06540589249332127f)) abort();
