...
int main()
{
 ...
 if(!(tensor_input[0][2] >= -3.2508292688354636f && tensor_input[0][2] <= 3.2586804459273995f)) abort();
 if(!(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f)) abort();
 if(!(tensor_input[0][4] >= -1.503012008611706f && tensor_input[0][4] <= 5.195179481948719f)) abort();
 if(!(tensor_input[0][5] >= -3.225656493181992f && tensor_input[0][5] <= 3.292158429479768f)) abort();
 if(!(tensor_input[0][6] >= -3.253317427355474f && tensor_input[0][6] <= 3.2418125291582522f)) abort();
 if(!(tensor_input[0][7] >= -3.311796084814807f && tensor_input[0][7] <= 3.3016790787022816f)) abort();
 if(!(tensor_input[0][8] >= -3.2611148830961953f && tensor_input[0][8] <= 3.229330407915573f)) abort();
 if(!(tensor_input[0][9] >= -3.2837513308757806f && tensor_input[0][9] <= 3.281122773614744f)) abort();
 if(!(tensor_input[0][10] >= -3.248550864104737f && tensor_input[0][10] <= 3.221951889931064f)) abort();
