...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.43148256287790754f && tensor_input[0][0] <= 0.4385384771220925f)) abort();
 if(!(tensor_input[0][1] >= -0.3025261071220925f && tensor_input[0][1] <= -0.29547019287790754f)) abort();
 if(!(tensor_input[0][2] >= 0.07028997287790752f && tensor_input[0][2] <= 0.07734588712209249f)) abort();
 if(!(tensor_input[0][3] >= 0.3755895628779075f && tensor_input[0][3] <= 0.38264547712209246f)) abort();
