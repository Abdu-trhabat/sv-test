...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4353032663189951f && tensor_input[0][0] <= 0.46647019368100495f)) abort();
 if(!(tensor_input[0][1] >= -1.091545863681005f && tensor_input[0][1] <= -1.0603789363189953f)) abort();
 if(!(tensor_input[0][2] >= 0.03691213631899508f && tensor_input[0][2] <= 0.06807906368100493f)) abort();
 if(!(tensor_input[0][3] >= 1.456711936318995f && tensor_input[0][3] <= 1.4878788636810047f)) abort();
