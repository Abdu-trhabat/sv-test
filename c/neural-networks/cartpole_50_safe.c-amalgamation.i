...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.02351854246603059f && tensor_input[0][0] <= -0.020126593533969412f)) abort();
 if(!(tensor_input[0][1] >= 0.1456814855339694f && tensor_input[0][1] <= 0.14907343446603058f)) abort();
 if(!(tensor_input[0][2] >= -0.055615237466030594f && tensor_input[0][2] <= -0.05222328853396941f)) abort();
 if(!(tensor_input[0][3] >= -0.3445694744660306f && tensor_input[0][3] <= -0.3411775255339694f)) abort();
