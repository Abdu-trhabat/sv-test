...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.03787137814823809f && tensor_input[0][0] <= -0.028814441851761914f)) abort();
 if(!(tensor_input[0][1] >= -0.6341041381482381f && tensor_input[0][1] <= -0.625047201851762f)) abort();
 if(!(tensor_input[0][2] >= -0.05300003814823809f && tensor_input[0][2] <= -0.04394310185176191f)) abort();
 if(!(tensor_input[0][3] >= 0.7470074818517619f && tensor_input[0][3] <= 0.756064418148238f)) abort();
