...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.43408457524598104f && tensor_input[0][0] <= 0.4870935847540189f)) abort();
 if(!(tensor_input[0][1] >= -0.12717298475401895f && tensor_input[0][1] <= -0.07416397524598106f)) abort();
 if(!(tensor_input[0][2] >= 0.008539193245981055f && tensor_input[0][2] <= 0.06154820275401894f)) abort();
 if(!(tensor_input[0][3] >= -0.011750659754018943f && tensor_input[0][3] <= 0.041258349754018944f)) abort();
