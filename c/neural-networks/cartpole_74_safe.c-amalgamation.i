...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.27819048610839286f && tensor_input[0][0] <= -0.27045501389160714f)) abort();
 if(!(tensor_input[0][1] >= -0.25233568610839285f && tensor_input[0][1] <= -0.24460021389160713f)) abort();
 if(!(tensor_input[0][2] >= -0.028770691108392876f && tensor_input[0][2] <= -0.021035218891607126f)) abort();
 if(!(tensor_input[0][3] >= -0.03767356610839288f && tensor_input[0][3] <= -0.029938093891607127f)) abort();
 entry(tensor_input, tensor_output);
 if(!(!((tensor_output[0][1] <= tensor_output[0][0])))) reach_error();
 return 0;
}
