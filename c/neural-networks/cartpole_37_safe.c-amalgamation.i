...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.03551903493471637f && tensor_input[0][0] <= -0.02517900106528363f)) abort();
 if(!(tensor_input[0][1] >= -0.04933861193471637f && tensor_input[0][1] <= -0.038998578065283625f)) abort();
 if(!(tensor_input[0][2] >= -0.06152694693471637f && tensor_input[0][2] <= -0.051186913065283626f)) abort();
 if(!(tensor_input[0][3] >= -0.13399563693471636f && tensor_input[0][3] <= -0.12365560306528363f)) abort();
