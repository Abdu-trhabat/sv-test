...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.445772777469059f && tensor_input[0][0] <= 0.45556646253094096f)) abort();
 if(!(tensor_input[0][1] >= -0.302720872530941f && tensor_input[0][1] <= -0.29292718746905905f)) abort();
 if(!(tensor_input[0][2] >= 0.04438946346905903f && tensor_input[0][2] <= 0.05418314853094097f)) abort();
 if(!(tensor_input[0][3] >= 0.34776295746905905f && tensor_input[0][3] <= 0.357556642530941f)) abort();
