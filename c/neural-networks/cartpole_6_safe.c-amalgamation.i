...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.01610335529140806f && tensor_input[0][0] <= 0.07771229270859194f)) abort();
 if(!(tensor_input[0][1] >= 0.752069831291408f && tensor_input[0][1] <= 0.813678768708592f)) abort();
 if(!(tensor_input[0][2] >= -0.10281310870859194f && tensor_input[0][2] <= -0.04120417129140806f)) abort();
 if(!(tensor_input[0][3] >= -1.256411668708592f && tensor_input[0][3] <= -1.194802731291408f)) abort();
