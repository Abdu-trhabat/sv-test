...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4724894173747478f && tensor_input[0][0] <= 0.47628104262525217f)) abort();
 if(!(tensor_input[0][1] >= -0.6875905126252522f && tensor_input[0][1] <= -0.6837988873747478f)) abort();
 if(!(tensor_input[0][2] >= 0.021629274374747848f && tensor_input[0][2] <= 0.025420899625252152f)) abort();
 if(!(tensor_input[0][3] >= 0.8835106873747478f && tensor_input[0][3] <= 0.8873023126252522f)) abort();
