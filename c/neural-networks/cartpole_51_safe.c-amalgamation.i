...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.059562969356423155f && tensor_input[0][0] <= -0.04965867464357685f)) abort();
 if(!(tensor_input[0][1] >= -0.24319337735642316f && tensor_input[0][1] <= -0.23328908264357684f)) abort();
 if(!(tensor_input[0][2] >= -0.029512952356423153f && tensor_input[0][2] <= -0.01960865764357685f)) abort();
 if(!(tensor_input[0][3] >= 0.13601620264357683f && tensor_input[0][3] <= 0.14592049735642315f)) abort();
