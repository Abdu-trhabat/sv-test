...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.43428907418671936f && tensor_input[0][0] <= 0.4514085858132807f)) abort();
 if(!(tensor_input[0][1] >= -0.6968941558132806f && tensor_input[0][1] <= -0.6797746441867194f)) abort();
 if(!(tensor_input[0][2] >= 0.05279629418671936f && tensor_input[0][2] <= 0.06991580581328065f)) abort();
 if(!(tensor_input[0][3] >= 0.9362703441867194f && tensor_input[0][3] <= 0.9533898558132806f)) abort();
