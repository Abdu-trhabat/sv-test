...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.052039137813545085f && tensor_input[0][0] <= -0.04996086218645491f)) abort();
 if(!(tensor_input[0][1] >= 0.1440828121864549f && tensor_input[0][1] <= 0.1461610878135451f)) abort();
 if(!(tensor_input[0][2] >= -0.001039137813545087f && tensor_input[0][2] <= 0.001039137813545087f)) abort();
 if(!(tensor_input[0][3] >= -0.2937220578135451f && tensor_input[0][3] <= -0.2916437821864549f)) abort();
