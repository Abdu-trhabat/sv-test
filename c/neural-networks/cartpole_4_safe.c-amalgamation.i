...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.054600342471467354f && tensor_input[0][0] <= 0.11732423752853263f)) abort();
 if(!(tensor_input[0][1] >= 0.7532100024714674f && tensor_input[0][1] <= 0.8159338975285326f)) abort();
 if(!(tensor_input[0][2] >= -0.16274733752853263f && tensor_input[0][2] <= -0.10002344247146736f)) abort();
 if(!(tensor_input[0][3] >= -1.3011819475285327f && tensor_input[0][3] <= -1.2384580524714672f)) abort();
