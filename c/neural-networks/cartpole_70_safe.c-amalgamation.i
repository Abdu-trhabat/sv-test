...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2639445795143858f && tensor_input[0][0] <= -0.25345586048561414f)) abort();
 if(!(tensor_input[0][1] >= -0.25286843951438587f && tensor_input[0][1] <= -0.24237972048561415f)) abort();
 if(!(tensor_input[0][2] >= -0.05385553951438585f && tensor_input[0][2] <= -0.043366820485614146f)) abort();
 if(!(tensor_input[0][3] >= -0.05771314351438585f && tensor_input[0][3] <= -0.04722442448561415f)) abort();
