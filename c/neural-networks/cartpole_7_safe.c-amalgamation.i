...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.012958302295931534f && tensor_input[0][0] <= 0.07294352370406847f)) abort();
 if(!(tensor_input[0][1] >= 0.7518984392959316f && tensor_input[0][1] <= 0.8118836607040685f)) abort();
 if(!(tensor_input[0][2] >= -0.09493331670406846f && tensor_input[0][2] <= -0.034948095295931535f)) abort();
 if(!(tensor_input[0][3] >= -1.2333988107040685f && tensor_input[0][3] <= -1.1734135892959316f)) abort();
