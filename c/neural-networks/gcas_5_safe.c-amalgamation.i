...
int main()
{
 ...
 if(!(tensor_input[0][2] >= -3.3408077531430043f && tensor_input[0][2] <= 3.34865893023494f)) abort();
 if(!(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f)) abort();
 if(!(tensor_input[0][4] >= -0.006487167806718156f && tensor_input[0][4] <= 5.195179481948719f)) abort();
 if(!(tensor_input[0][5] >= -3.3157497772288904f && tensor_input[0][5] <= 3.3822517135266663f)) abort();
 if(!(tensor_input[0][6] >= -3.3430971457177034f && tensor_input[0][6] <= 3.331592247520482f)) abort();
 if(!(tensor_input[0][7] >= -3.403211644095604f && tensor_input[0][7] <= 3.3930946379830793f)) abort();
 if(!(tensor_input[0][8] >= -3.3508298471036695f && tensor_input[0][8] <= 3.319045371923047f)) abort();
 if(!(tensor_input[0][9] >= -3.3744950961477245f && tensor_input[0][9] <= 3.371866538886688f)) abort();
 if(!(tensor_input[0][10] >= -3.3379901699860275f && tensor_input[0][10] <= 3.3113911958123547f)) abort();
