...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.028859288384907273f && tensor_input[0][0] <= 0.08825992761509273f)) abort();
 if(!(tensor_input[0][1] >= 0.7523050803849073f && tensor_input[0][1] <= 0.8117057196150926f)) abort();
 if(!(tensor_input[0][2] >= -0.11805045961509272f && tensor_input[0][2] <= -0.058649820384907264f)) abort();
 if(!(tensor_input[0][3] >= -1.2374512196150926f && tensor_input[0][3] <= -1.1780505803849073f)) abort();
