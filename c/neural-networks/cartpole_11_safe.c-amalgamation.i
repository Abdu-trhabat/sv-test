...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.012293734129990103f && tensor_input[0][0] <= 0.06577092587000989f)) abort();
 if(!(tensor_input[0][1] >= 0.94962530412999f && tensor_input[0][1] <= 1.0031024958700099f)) abort();
 if(!(tensor_input[0][2] >= -0.08545808587000989f && tensor_input[0][2] <= -0.031980894129990105f)) abort();
 if(!(tensor_input[0][3] >= -1.50827119587001f && tensor_input[0][3] <= -1.45479400412999f)) abort();
