...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.44755975678036136f && tensor_input[0][0] <= 0.5052174432196386f)) abort();
 if(!(tensor_input[0][1] >= -0.12916599821963862f && tensor_input[0][1] <= -0.07150831178036138f)) abort();
 if(!(tensor_input[0][2] >= -0.005377215219638614f && tensor_input[0][2] <= 0.05228047121963861f)) abort();
 if(!(tensor_input[0][3] >= -0.021389378219638613f && tensor_input[0][3] <= 0.03626830821963861f)) abort();
