...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.027613534111327276f && tensor_input[0][0] <= 0.06624355988867273f)) abort();
 if(!(tensor_input[0][1] >= 0.3740514171113273f && tensor_input[0][1] <= 0.4126814428886727f)) abort();
 if(!(tensor_input[0][2] >= -0.09178783288867272f && tensor_input[0][2] <= -0.05315780711132727f)) abort();
 if(!(tensor_input[0][3] >= -0.6749981728886728f && tensor_input[0][3] <= -0.6363681471113273f)) abort();
