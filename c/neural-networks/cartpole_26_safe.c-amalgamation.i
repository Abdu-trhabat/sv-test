...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.04625587729278151f && tensor_input[0][0] <= 0.0790123627072185f)) abort();
 if(!(tensor_input[0][1] >= 0.1841359372927815f && tensor_input[0][1] <= 0.21689242270721848f)) abort();
 if(!(tensor_input[0][2] >= -0.11443468270721849f && tensor_input[0][2] <= -0.0816781972927815f)) abort();
 if(!(tensor_input[0][3] >= -0.4298197827072185f && tensor_input[0][3] <= -0.3970632972927815f)) abort();
