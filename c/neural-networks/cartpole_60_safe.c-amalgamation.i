...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.40749552775186315f && tensor_input[0][0] <= 0.4159786322481368f)) abort();
 if(!(tensor_input[0][1] >= -0.6917904522481368f && tensor_input[0][1] <= -0.6833073477518632f)) abort();
 if(!(tensor_input[0][2] >= 0.10162916375186318f && tensor_input[0][2] <= 0.11011226824813683f)) abort();
 if(!(tensor_input[0][3] >= 0.9263019877518631f && tensor_input[0][3] <= 0.9347850922481368f)) abort();
