...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.27622521707318864f && tensor_input[0][0] <= -0.2702757029268113f)) abort();
 if(!(tensor_input[0][1] >= -0.056588907073188664f && tensor_input[0][1] <= -0.050639392926811334f)) abort();
 if(!(tensor_input[0][2] >= -0.021465701073188664f && tensor_input[0][2] <= -0.015516186926811336f)) abort();
 if(!(tensor_input[0][3] >= -0.32357529707318866f && tensor_input[0][3] <= -0.3176257829268113f)) abort();
