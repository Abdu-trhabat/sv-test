...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2541871341497828f && tensor_input[0][0] <= -0.2454579858502172f)) abort();
 if(!(tensor_input[0][1] >= -0.4471501941497828f && tensor_input[0][1] <= -0.4384210458502172f)) abort();
 if(!(tensor_input[0][2] >= -0.0582838371497828f && tensor_input[0][2] <= -0.0495546888502172f)) abort();
 if(!(tensor_input[0][3] >= 0.2371771858502172f && tensor_input[0][3] <= 0.2459063341497828f)) abort();
