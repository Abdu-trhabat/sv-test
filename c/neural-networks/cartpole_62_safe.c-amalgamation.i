...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2513686195106128f && tensor_input[0][0] <= -0.24827650048938718f)) abort();
 if(!(tensor_input[0][1] >= -0.05416862751061282f && tensor_input[0][1] <= -0.05107650848938718f)) abort();
 if(!(tensor_input[0][2] >= -0.05546532251061282f && tensor_input[0][2] <= -0.052373203489387184f)) abort();
 if(!(tensor_input[0][3] >= -0.3444195595106128f && tensor_input[0][3] <= -0.3413274404893872f)) abort();
