...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.44694559359049696f && tensor_input[0][0] <= 0.45457566640950303f)) abort();
 if(!(tensor_input[0][1] >= -0.30059037640950304f && tensor_input[0][1] <= -0.29296030359049696f)) abort();
 if(!(tensor_input[0][2] >= 0.04346070759049698f && tensor_input[0][2] <= 0.051090780409503024f)) abort();
 if(!(tensor_input[0][3] >= 0.32565856359049694f && tensor_input[0][3] <= 0.333288636409503f)) abort();
