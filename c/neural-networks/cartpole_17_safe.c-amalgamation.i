...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.03818484817244882f && tensor_input[0][0] <= 0.07127877182755119f)) abort();
 if(!(tensor_input[0][1] >= 0.37681383817244885f && tensor_input[0][1] <= 0.4099077618275512f)) abort();
 if(!(tensor_input[0][2] >= -0.10070808682755118f && tensor_input[0][2] <= -0.06761416317244882f)) abort();
 if(!(tensor_input[0][3] >= -0.6726517018275512f && tensor_input[0][3] <= -0.6395577781724487f)) abort();
