...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.4713732568947219f && tensor_input[0][0] <= 0.4771885431052781f)) abort();
 if(!(tensor_input[0][1] >= -0.6885270431052781f && tensor_input[0][1] <= -0.6827117568947219f)) abort();
 if(!(tensor_input[0][2] >= 0.01491313389472192f && tensor_input[0][2] <= 0.02072842010527808f)) abort();
 if(!(tensor_input[0][3] >= 0.8807768568947218f && tensor_input[0][3] <= 0.8865921431052781f)) abort();
