...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.05494205647436299f && tensor_input[0][0] <= -0.045057943525637016f)) abort();
 if(!(tensor_input[0][1] >= -0.05494205647436299f && tensor_input[0][1] <= -0.045057943525637016f)) abort();
 if(!(tensor_input[0][2] >= -0.004942056474362985f && tensor_input[0][2] <= 0.004942056474362985f)) abort();
 if(!(tensor_input[0][3] >= -0.004942056474362985f && tensor_input[0][3] <= 0.004942056474362985f)) abort();
