...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.033461210797767704f && tensor_input[0][0] <= -0.008245289202232296f)) abort();
 if(!(tensor_input[0][1] >= 0.3291068992022323f && tensor_input[0][1] <= 0.3543228207977677f)) abort();
 if(!(tensor_input[0][2] >= -0.0658496457977677f && tensor_input[0][2] <= -0.040633724202232296f)) abort();
 if(!(tensor_input[0][3] >= -0.6311115607977678f && tensor_input[0][3] <= -0.6058956392022323f)) abort();
