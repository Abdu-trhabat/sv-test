...
int main()
{
 ...
 if(!(tensor_input[0][2] >= -4.70567364696052f && tensor_input[0][2] <= 4.713524824052456f)) abort();
 if(!(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f)) abort();
 if(!(tensor_input[0][4] >= -1.376651562650054f && tensor_input[0][4] <= 5.195179481948719f)) abort();
 if(!(tensor_input[0][5] >= -4.682357045665843f && tensor_input[0][5] <= 4.748858981963619f)) abort();
 if(!(tensor_input[0][6] >= -4.704947998087309f && tensor_input[0][6] <= 4.693443099890087f)) abort();
 if(!(tensor_input[0][7] >= -4.789876244936825f && tensor_input[0][7] <= 4.779759238824299f)) abort();
 if(!(tensor_input[0][8] >= -4.711698453428989f && tensor_input[0][8] <= 4.679913978248367f)) abort();
 if(!(tensor_input[0][9] >= -4.750969386078381f && tensor_input[0][9] <= 4.748340828817344f)) abort();
 if(!(tensor_input[0][10] >= -4.694677372527132f && tensor_input[0][10] <= 4.668078398353459f)) abort();
