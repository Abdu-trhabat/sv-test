...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.4257297624525585f && tensor_input[0][0] <= -0.4015650375474415f)) abort();
 if(!(tensor_input[0][1] >= 0.8721008075474415f && tensor_input[0][1] <= 0.8962655324525586f)) abort();
 if(!(tensor_input[0][2] >= -0.11996634245255852f && tensor_input[0][2] <= -0.09580161754744149f)) abort();
 if(!(tensor_input[0][3] >= -1.2701069624525585f && tensor_input[0][3] <= -1.2459422375474414f)) abort();
