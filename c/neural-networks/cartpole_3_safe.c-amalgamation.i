...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.44835436239802035f && tensor_input[0][0] <= 0.4845709176019796f)) abort();
 if(!(tensor_input[0][1] >= 0.07590218739802035f && tensor_input[0][1] <= 0.11211874260197965f)) abort();
 if(!(tensor_input[0][2] >= 0.011716852398020342f && tensor_input[0][2] <= 0.04793340760197966f)) abort();
 if(!(tensor_input[0][3] >= -0.2864156776019796f && tensor_input[0][3] <= -0.25019912239802033f)) abort();
