...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2877480488532523f && tensor_input[0][0] <= -0.2707728711467477f)) abort();
 if(!(tensor_input[0][1] >= -0.45068348885325227f && tensor_input[0][1] <= -0.4337083111467477f)) abort();
 if(!(tensor_input[0][2] >= -0.034756623853252316f && tensor_input[0][2] <= -0.017781446146747683f)) abort();
 if(!(tensor_input[0][3] >= 0.2197477011467477f && tensor_input[0][3] <= 0.23672287885325233f)) abort();
