...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.26052960901990324f && tensor_input[0][0] <= -0.25109789098009677f)) abort();
 if(!(tensor_input[0][1] >= -0.44585379901990324f && tensor_input[0][1] <= -0.43642208098009677f)) abort();
 if(!(tensor_input[0][2] >= -0.06684597501990325f && tensor_input[0][2] <= -0.057414256980096744f)) abort();
 if(!(tensor_input[0][3] >= 0.20052031098009673f && tensor_input[0][3] <= 0.20995202901990326f)) abort();
