...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.259417339789158f && tensor_input[0][0] <= -0.24935986021084208f)) abort();
 if(!(tensor_input[0][1] >= 0.13554356021084207f && tensor_input[0][1] <= 0.14560103978915795f)) abort();
 if(!(tensor_input[0][2] >= -0.028480367789157947f && tensor_input[0][2] <= -0.01842288821084205f)) abort();
 if(!(tensor_input[0][3] >= -0.5977305897891579f && tensor_input[0][3] <= -0.587673110210842f)) abort();
