...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.04489402450781046f && tensor_input[0][0] <= -0.03769133549218954f)) abort();
 if(!(tensor_input[0][1] >= 0.5318460154921896f && tensor_input[0][1] <= 0.5390487045078105f)) abort();
 if(!(tensor_input[0][2] >= -0.02116232050781046f && tensor_input[0][2] <= -0.013959631492189541f)) abort();
 if(!(tensor_input[0][3] >= -0.8834883445078104f && tensor_input[0][3] <= -0.8762856554921895f)) abort();
