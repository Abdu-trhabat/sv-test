...
int main()
{
 ...
 if(!(tensor_input[0][2] >= -1.9349721659028138f && tensor_input[0][2] <= 1.9428233429947497f)) abort();
 if(!(tensor_input[0][3] >= -1.7108058693099715f && tensor_input[0][3] <= 1.7638442067420586f)) abort();
 if(!(tensor_input[0][4] >= 0.855546939130923f && tensor_input[0][4] <= 5.195179481948719f)) abort();
 if(!(tensor_input[0][5] >= -1.9081205438716633f && tensor_input[0][5] <= 1.9746224801694388f)) abort();
 if(!(tensor_input[0][6] >= -1.9403671035597638f && tensor_input[0][6] <= 1.9288622053625426f)) abort();
 if(!(tensor_input[0][7] >= -1.974923009835511f && tensor_input[0][7] <= 1.9648060037229853f)) abort();
 if(!(tensor_input[0][8] >= -1.9491115354393542f && tensor_input[0][8] <= 1.9173270602587318f)) abort();
 if(!(tensor_input[0][9] >= -1.956702659197568f && tensor_input[0][9] <= 1.954074101936532f)) abort();
 if(!(tensor_input[0][10] >= -1.940578776877665f && tensor_input[0][10] <= 1.913979802703993f)) abort();
