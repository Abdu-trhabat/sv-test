...
void hop_softsign_w64_r2(k2c_tensor* simple_rnn_11_input_input, k2c_tensor* simple_rnn_11_output);
void hop_softsign_w64_r2_initialize();
void hop_softsign_w64_r2_terminate();
int main()
{
    float input_array[128] = {0.0f}, output_array[128] = {0.0f};
 k2c_tensor input_tensor = {&input_array[0],2,128,{2,64,1,1,1}};
 k2c_tensor output_tensor = {&output_array[0],2,128,{2,64,1,1,1}};
 ...
 if(!(__builtin_isgreaterequal(output_array[65], 0.51f))) reach_error();
    return 0;
}
...
k2c_simpleRNN(simple_rnn_5_output,simple_rnn_5_input_input,simple_rnn_5_state,&simple_rnn_5_kernel,
 ...
 simple_rnn_5_go_backwards,simple_rnn_5_return_sequences,k2c_softsign);
 }
...
void hop_softsign_w64_r2(k2c_tensor* simple_rnn_11_input_input, k2c_tensor* simple_rnn_11_output) {
int simple_rnn_11_go_backwards = 0;
int simple_rnn_11_return_sequences = 1;
float simple_rnn_11_fwork[128] = {0};
float simple_rnn_11_state[64] = {0};
float simple_rnn_11_kernel_array[4096] = {
+1.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
...
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+1.00000000e+00f,};
k2c_tensor simple_rnn_11_kernel = {&simple_rnn_11_kernel_array[0],2,4096,{64,64, 1, 1, 1}};
float simple_rnn_11_recurrent_kernel_array[4096] = {
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
...
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,};
k2c_tensor simple_rnn_11_recurrent_kernel = {&simple_rnn_11_recurrent_kernel_array[0],2,4096,{64,64, 1, 1, 1}};
float simple_rnn_11_bias_array[64] = {0};
k2c_tensor simple_rnn_11_bias = {&simple_rnn_11_bias_array[0],1,64,{64, 1, 1, 1, 1}};
k2c_simpleRNN(simple_rnn_11_output,simple_rnn_11_input_input,simple_rnn_11_state,&simple_rnn_11_kernel,
 &simple_rnn_11_recurrent_kernel,&simple_rnn_11_bias,simple_rnn_11_fwork,
 simple_rnn_11_go_backwards,simple_rnn_11_return_sequences,k2c_softsign);
 }
void hop_softsign_w64_r2_initialize() {
}
void hop_softsign_w64_r2_terminate() {
...
int simple_rnn_16_go_backwards = 0;
int simple_rnn_16_return_sequences = 1;
float simple_rnn_16_fwork[128] = {0};
float simple_rnn_16_state[64] = {0};
float simple_rnn_16_kernel_array[4096] = {
+1.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
...
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+1.00000000e+00f,};
k2c_tensor simple_rnn_16_kernel = {&simple_rnn_16_kernel_array[0],2,4096,{64,64, 1, 1, 1}};
float simple_rnn_16_recurrent_kernel_array[4096] = {
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
...
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,};
k2c_tensor simple_rnn_16_recurrent_kernel = {&simple_rnn_16_recurrent_kernel_array[0],2,4096,{64,64, 1, 1, 1}};
float simple_rnn_16_bias_array[64] = {0};
k2c_tensor simple_rnn_16_bias = {&simple_rnn_16_bias_array[0],1,64,{64, 1, 1, 1, 1}};
k2c_simpleRNN(simple_rnn_16_output,simple_rnn_16_input_input,simple_rnn_16_state,&simple_rnn_16_kernel,
 &simple_rnn_16_recurrent_kernel,&simple_rnn_16_bias,simple_rnn_16_fwork,
 simple_rnn_16_go_backwards,simple_rnn_16_return_sequences,k2c_softsign);
 }
void hop_softsign_w64_r3_initialize() {
}
void hop_softsign_w64_r3_terminate() {
}
void hop_softsign_w64_r4(k2c_tensor* simple_rnn_4_input_input, k2c_tensor* simple_rnn_4_output) {
int simple_rnn_4_go_backwards = 0;
int simple_rnn_4_return_sequences = 1;
float simple_rnn_4_fwork[128] = {0};
float simple_rnn_4_state[64] = {0};
float simple_rnn_4_kernel_array[4096] = {
+1.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
...
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+1.00000000e+00f,};
k2c_tensor simple_rnn_4_kernel = {&simple_rnn_4_kernel_array[0],2,4096,{64,64, 1, 1, 1}};
float simple_rnn_4_recurrent_kernel_array[4096] = {
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
...
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,};
k2c_tensor simple_rnn_4_recurrent_kernel = {&simple_rnn_4_recurrent_kernel_array[0],2,4096,{64,64, 1, 1, 1}};
float simple_rnn_4_bias_array[64] = {0};
k2c_tensor simple_rnn_4_bias = {&simple_rnn_4_bias_array[0],1,64,{64, 1, 1, 1, 1}};
...
void hop_softsign_w64_r4_initialize() {
}
void hop_softsign_w64_r4_terminate() {
}
