...
int main()
{
 ...
 if(!(tensor_input[0][0] >= 0.3996579959512434f && tensor_input[0][0] <= 0.4391904840487566f)) abort();
 if(!(tensor_input[0][1] >= -0.7089809440487566f && tensor_input[0][1] <= -0.6694484559512434f)) abort();
 if(!(tensor_input[0][2] >= 0.07699986595124342f && tensor_input[0][2] <= 0.11653235404875659f)) abort();
 if(!(tensor_input[0][3] >= 0.9468840059512434f && tensor_input[0][3] <= 0.9864164940487566f)) abort();
