...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2564032266073448f && tensor_input[0][0] <= -0.23960987339265516f)) abort();
 if(!(tensor_input[0][1] >= -0.05906930460734483f && tensor_input[0][1] <= -0.042275951392655164f)) abort();
 if(!(tensor_input[0][2] >= -0.08230470660734483f && tensor_input[0][2] <= -0.06551135339265517f)) abort();
 if(!(tensor_input[0][3] >= -0.3947966266073448f && tensor_input[0][3] <= -0.37800327339265516f)) abort();
