...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.4586914544908906f && tensor_input[0][0] <= -0.4001893055091094f)) abort();
 if(!(tensor_input[0][1] >= 1.2428999255091095f && tensor_input[0][1] <= 1.3014020744908905f)) abort();
 if(!(tensor_input[0][2] >= -0.11760121449089056f && tensor_input[0][2] <= -0.05909906550910943f)) abort();
 if(!(tensor_input[0][3] >= -1.8212117744908904f && tensor_input[0][3] <= -1.7627096255091095f)) abort();
