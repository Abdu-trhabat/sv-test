...
void hop_softsign_w32_r1_initialize();
void hop_softsign_w32_r1_terminate();
int main()
{
 ...
 if(!(__builtin_isgreaterequal(output_array[16], 0.0f))) reach_error();
    return 0;
}
...
float simple_rnn_4_kernel_array[1024] = {
...
float simple_rnn_4_recurrent_kernel_array[1024] = {
...
float simple_rnn_4_bias_array[32] = {0};
...
int simple_rnn_10_go_backwards = 0;
int simple_rnn_10_return_sequences = 1;
float simple_rnn_10_fwork[64] = {0};
float simple_rnn_10_state[32] = {0};
float simple_rnn_10_kernel_array[1024] = {
+1.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
...
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+1.00000000e+00f,};
k2c_tensor simple_rnn_10_kernel = {&simple_rnn_10_kernel_array[0],2,1024,{32,32, 1, 1, 1}};
float simple_rnn_10_recurrent_kernel_array[1024] = {
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
...
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,};
k2c_tensor simple_rnn_10_recurrent_kernel = {&simple_rnn_10_recurrent_kernel_array[0],2,1024,{32,32, 1, 1, 1}};
float simple_rnn_10_bias_array[32] = {0};
k2c_tensor simple_rnn_10_bias = {&simple_rnn_10_bias_array[0],1,32,{32, 1, 1, 1, 1}};
k2c_simpleRNN(simple_rnn_10_output,simple_rnn_10_input_input,simple_rnn_10_state,&simple_rnn_10_kernel,
 &simple_rnn_10_recurrent_kernel,&simple_rnn_10_bias,simple_rnn_10_fwork,
 simple_rnn_10_go_backwards,simple_rnn_10_return_sequences,k2c_softsign);
 }
void hop_softsign_w32_r2_initialize() {
}
void hop_softsign_w32_r2_terminate() {
}
...
void hop_softsign_w32_r4(k2c_tensor* simple_rnn_3_input_input, k2c_tensor* simple_rnn_3_output) {
int simple_rnn_3_go_backwards = 0;
int simple_rnn_3_return_sequences = 1;
float simple_rnn_3_fwork[64] = {0};
float simple_rnn_3_state[32] = {0};
float simple_rnn_3_kernel_array[1024] = {
+1.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
...
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,
+0.00000000e+00f,+0.00000000e+00f,+0.00000000e+00f,+1.00000000e+00f,};
k2c_tensor simple_rnn_3_kernel = {&simple_rnn_3_kernel_array[0],2,1024,{32,32, 1, 1, 1}};
float simple_rnn_3_recurrent_kernel_array[1024] = {
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
...
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,
+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,+1.00000000e+00f,};
k2c_tensor simple_rnn_3_recurrent_kernel = {&simple_rnn_3_recurrent_kernel_array[0],2,1024,{32,32, 1, 1, 1}};
float simple_rnn_3_bias_array[32] = {0};
k2c_tensor simple_rnn_3_bias = {&simple_rnn_3_bias_array[0],1,32,{32, 1, 1, 1, 1}};
...
void hop_softsign_w32_r4_initialize() {
}
void hop_softsign_w32_r4_terminate() {
}
