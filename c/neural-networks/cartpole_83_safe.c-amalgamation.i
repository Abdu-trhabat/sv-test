...
int main()
{
 ...
 if(!(tensor_input[0][0] >= -0.2601793836805143f && tensor_input[0][0] <= -0.2515105763194857f)) abort();
 if(!(tensor_input[0][1] >= -0.05584592568051429f && tensor_input[0][1] <= -0.047177118319485706f)) abort();
 if(!(tensor_input[0][2] >= -0.06577675668051429f && tensor_input[0][2] <= -0.05710794931948571f)) abort();
 if(!(tensor_input[0][3] >= -0.3718953536805143f && tensor_input[0][3] <= -0.3632265463194857f)) abort();
