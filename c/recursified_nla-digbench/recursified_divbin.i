...
void func_to_recursive_line_39_to_46_0(unsigned *b, unsigned *A, unsigned *B, unsigned *r, unsigned *q)
{
  if (1)
  {
    {
    ...
    func_to_recursive_line_39_to_46_0(b, A, B, r, q);
  }
  else
  {
  }
...
void func_to_recursive_line_35_to_37_0(unsigned *r, unsigned *b)
{
  if (1)
  {
    {
    ...
    func_to_recursive_line_35_to_37_0(r, b);
  }
  else
  {
  }
