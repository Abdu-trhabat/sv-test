...
void func_to_recursive_line_41_to_51_0(unsigned int *A, long long *p, unsigned int *B, long long *r, long long *d, long long *q)
{
  if (1)
  {
    {
    ...
    func_to_recursive_line_41_to_51_0(A, p, B, r, d, q);
  }
  else
  {
  }
...
void func_to_recursive_line_31_to_38_0(unsigned int *A, long long *p, unsigned int *B, long long *r, long long *d, long long *q)
{
  if (1)
  {
    {
    ...
    func_to_recursive_line_31_to_38_0(A, p, B, r, d, q);
  }
  else
  {
  }
