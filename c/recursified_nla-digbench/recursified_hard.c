...
void func_to_recursive_line_41_to_51_0(int *d, int *p, int *B, int *r, int *A, int *q)
{
  if (1)
  {
    {
    ...
    func_to_recursive_line_41_to_51_0(d, p, B, r, A, q);
  }
  else
  {
  }
...
void func_to_recursive_line_31_to_38_0(int *d, int *p, int *B, int *r, int *A, int *q)
{
  if (1)
  {
    {
    ...
    func_to_recursive_line_31_to_38_0(d, p, B, r, A, q);
  }
  else
  {
  }
