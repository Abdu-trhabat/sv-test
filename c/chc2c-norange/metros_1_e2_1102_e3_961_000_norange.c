...
// Original CHC file: vmt-chc-benchmarks/metros_1_e2_1102_e3_961_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "metros_1_e2_1102_e3_961_000_norange.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        (((B4_1 + H3_1 + (-1 * Z3_1)) == 0)
         ...
         && (I2_1 || (9 <= Y4_1)) && ((!L2_1) || ((K1_1 + (-1 * N2_1)) == 1))
