...
// Original CHC file: vmt-chc-benchmarks/SYNAPSE_2_e8_1118_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "SYNAPSE_2_e8_1118_000_norange.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        (((1 <= R_1) == V1_1) && ((1 <= R_1) == Y1_1)
         && (!(((Z2_1 && K1_1) || (Z2_1 && W2_1 && K1_1)) == L2_1))
         && (!(((H1_1 && C3_1) || (A1_1 && H1_1 && C3_1)) == M_1))
