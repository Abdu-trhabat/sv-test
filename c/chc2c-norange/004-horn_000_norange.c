...
// Original CHC file: eldarica-misc/004-horn_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "004-horn_000_norange.c", 13, "reach_error"); }
  ...
  INV1_1:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 0:
          ...
          J_1 = INV1_5;
          if (!
              (((H_1 + G_1) == C_1) && (K_1 == L_1) && (I_1 == (E_1 + -1))
               && (G_1 == (B_1 + -1)) && (A_1 >= G_1) && (D_1 >= I_1)
               && ((J_1 + I_1) == F_1)))
              abort ();
          INV1_0 = A_1;
          INV1_1 = B_1;
