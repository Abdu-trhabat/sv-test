...
// Original CHC file: vmt-chc-benchmarks/durationThm_1_e3_389_e7_358_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "durationThm_1_e3_389_e7_358_000_norange.c", 13, "reach_error"); }
    ...
    if (!
        ((X_1 == V_1) && (Y_1 == W_1) && (Z_1 == M1_1) && (G1_1 == C1_1)
         ...
         && ((!D1_1) || ((U_1 + (-1 * E1_1)) == 1)) && ((!D1_1)
                                                        ...
                                                        ((I_1 +
                                                          (-1 * C1_1)) == 1))
         && (D1_1 || (C1_1 == 0)) && (D1_1 || (E1_1 == 0)) && (S1_1 == W_1)))
        abort ();
    state_0 = M1_1;
    state_1 = Z_1;
    state_2 = L1_1;
