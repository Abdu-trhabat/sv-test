...
// Original CHC file: vmt-chc-benchmarks/vmt-hysteresis_1_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-hysteresis_1_000_norange.c", 13, "reach_error"); }
  ...
  main_init:
    if (!
        ((K_0 == J_0) && (L_0 == T_0) && (L_0 == K_0) && (M_0 == 0)
         ...
         && (R_0 == P_0) && (Q_0 == O_0) && (H_0 == Q_0) && ((1000 <= S_0)
                                                             || ((!G_0)
                                                                 && (!F_0))
                                                             || (S_0 <= -1000)
                                                             ||
                                                             ((T_0 +
                                                              ...
                                                              0)) && ((!G_0)
                                                                      || (B_0
                                                                          ...
                                                                          1)
                                                                      || F_0)
         && (G_0 || (A_0 == -1) || (!F_0)) && ((T_0 == S_0)
                                               || ((G_0 || F_0)
                                                   && (!(S_0 <= -1000))
                                                   && (!(1000 <= S_0))))
         && ((B_0 == A_0) || (G_0 && (!F_0))) && ((A_0 == 0)
                                                  || ((!G_0) && F_0))
         && (!I_0) && (!H_0) && (B_0 == D_0)))
        abort ();
    state_0 = M_0;
    ...
    if (!
        ((Z_1 == G1_1) && (C1_1 == E1_1) && (F1_1 == N_1) && (G1_1 == F1_1)
         ...
         && ((1000 <= Y_1) || ((Z_1 + (-1 * Y_1) + (-1 * C1_1)) == 0)
             || (Y_1 <= -1000) || ((!B1_1) && (!A1_1))) && ((1000 <= M1_1)
                                                            || (M1_1 <= -1000)
                                                            ||
                                                            ((N1_1 +
                                                              (-1 * M1_1) +
         ...
         && (A1_1 || (!B1_1) || (D1_1 == -1)) && (B1_1 || (!A1_1)
                                                  || (E1_1 == 1)) && (F_1
                                                                      ...
                                                                      || (B_1
                                                                          ==
                                                                          1))
         && (G_1 || (!F_1) || (A_1 == -1)) && ((Z_1 == Y_1)
                                               || ((B1_1 || A1_1)
                                                   && (!(Y_1 <= -1000))
                                                   && (!(1000 <= Y_1))))
         && ((N1_1 == M1_1)
             || ((F_1 || G_1) && (!(M1_1 <= -1000)) && (!(1000 <= M1_1))))
         && ((B1_1 && (!A1_1)) || (D1_1 == 0)) && (((!B1_1) && A1_1)
                                                   || (E1_1 == D1_1)) && ((F_1
                                                                          ...
                                                                          (A_1
                                                                           ==
                                                                           0))
         && (((!F_1) && G_1) || (B_1 == A_1)) && ((!L1_1)
                                                  || (!((N_1 <= 0) == P_1)))
         && (L1_1 || (P_1 == (10 <= N_1))) && ((!K1_1)
                                               || (!((0 <= N_1) == O_1)))
         && (K1_1 || (O_1 == (N_1 <= -10))) && (Y_1 == S_1)))
        abort ();
    state_0 = S_1;
    state_1 = R_1;
    state_2 = Q_1;
      ...
      case 1:
          ...
          if (!
              ((Z_1 == G1_1) && (C1_1 == E1_1) && (F1_1 == N_1)
               ...
               && (X_1 == V_1) && (I_1 == L1_1) && (H_1 == K1_1)
               && ((1000 <= Y_1) || ((Z_1 + (-1 * Y_1) + (-1 * C1_1)) == 0)
                   || (Y_1 <= -1000) || ((!B1_1) && (!A1_1)))
               && ((1000 <= M1_1) || (M1_1 <= -1000)
                   || ((N1_1 + (-1 * M1_1) + (-1 * D_1)) == 0) || ((!F_1)
                                                                   && (!G_1)))
               && (A1_1 || (!B1_1) || (D1_1 == -1)) && (B1_1 || (!A1_1)
                                                        || (E1_1 == 1))
               && (F_1 || (!G_1) || (B_1 == 1)) && (G_1 || (!F_1)
                                                    || (A_1 == -1))
               && ((Z_1 == Y_1)
                   || ((B1_1 || A1_1) && (!(Y_1 <= -1000))
                       && (!(1000 <= Y_1)))) && ((N1_1 == M1_1) || ((F_1
                                                                     || G_1)
                                                                    &&
                                                                    (!(M1_1 <=
                                                                       -1000))
