...
// Original CHC file: vmt-chc-benchmarks/vmt-durationThm_3_e7_334_e7_118_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-durationThm_3_e7_334_e7_118_000_norange.c", 13, "reach_error"); }
  ...
  main_init:
    if (!
        ((K_0 == N_0) && (F_0 == A_0) && (F_0 == S_0) && (H_0 == T_0)
         ...
         && (O_0 == M_0)
         && (E_0 ==
             ((Q_0 || (!(S_0 <= R_0))) && ((1 <= S_0) || (1 <= T_0))
              && (U_0 <= T_0))) && (E_0 == O_0) && (K_0 == 0)))
        abort ();
    state_0 = K_0;
    state_1 = N_0;
    state_2 = E_0;
    ...
    if (!
        ((N1_1 == S_1) && (Y_1 == U_1) && (Z_1 == X_1) && (B1_1 == Y_1)
         ...
         && (F1_1 ==
             (R_1
              || ((A1_1 || (!(C1_1 <= B1_1))) && ((1 <= D1_1) || (1 <= C1_1))
                  && (E1_1 <= D1_1)))) && (R_1 == P_1) && (H_1 == R_1)
