...
// Original CHC file: vmt-chc-benchmarks/vmt-PRODUCER_CONSUMER_vt_e2_1352_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-PRODUCER_CONSUMER_vt_e2_1352_000_norange.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        (((1 <= B1_1) == A2_1) && ((1 <= Z_1) == V1_1)
         ...
         && (((!N2_1) || (-1 <= (Q2_1 + (-1 * P2_1) + (-1 * O2_1)))) == M2_1)
         && (((!U_1) || (-1 <= (X_1 + (-1 * W_1) + (-1 * V_1)))) == T_1)
