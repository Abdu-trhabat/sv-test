...
// Original CHC file: vmt-chc-benchmarks/MESI_3_e3_2584_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "MESI_3_e3_2584_000_norange.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        (((1 <= B1_1) == E2_1) && ((1 <= Y_1) == C2_1) && ((1 <= V_1) == Y1_1)
         ...
         &&
         (!(((E_1 && E1_1) || (L4_1 && S4_1) || (E1_1 && L4_1)
             || (E_1 && S4_1) || (E_1 && L4_1) || (E1_1 && S4_1)) == O1_1))
         ...
         && ((!Y1_1) || (Y_1 == S2_1)) && (Y1_1 || (V_1 == P2_1)) && (Y1_1
                                                                      || (S_1
                                                                          ==
                                                                          X1_1))
         && ((!A2_1) || ((Y_1 + (-1 * V_1) + S_1 + (-1 * F2_1)) == 1))
         && ((!A2_1) || ((B1_1 + (-1 * U2_1)) == 1)) && ((!A2_1)
                                                         || (Z1_1 == 0))
         && ((!A2_1) || (Q2_1 == 0)) && (A2_1 || (B1_1 == U2_1)) && (A2_1
                                                                     || (Y_1
                                                                         ==
                                                                         F2_1))
         && (A2_1 || (V_1 == Q2_1)) && (A2_1 || (S_1 == Z1_1)) && ((!C2_1)
                                                                   ||
                                                                   ((B1_1 +
                                                                     Y_1 +
                                                                     V_1 +
