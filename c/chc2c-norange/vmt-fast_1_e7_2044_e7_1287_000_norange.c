...
// Original CHC file: vmt-chc-benchmarks/vmt-fast_1_e7_2044_e7_1287_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-fast_1_e7_2044_e7_1287_000_norange.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    N_1 = state_62;
    if (!
        (((((!C1_1) && (!L4_1) && M4_1) || ((!C1_1) && L4_1 && (!M4_1))
           || (C1_1 && (!L4_1) && (!M4_1))) == N4_1) && (((!D4_1) && C4_1
                                                          && A4_1 && (!Z3_1)
                                                          && Y3_1 && X3_1
                                                          && W3_1 && W2_1
                                                          && (B4_1 <= 200)
