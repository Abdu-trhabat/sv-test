...
// Original CHC file: hcai-bench/Addition03_true-unreach-call_true-no-overflow_true-termination_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "Addition03_true-unreach-call_true-no-overflow_true-termination_000_norange.c", 13, "reach_error"); }
  ...
  main_entry:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 0:
          ...
          if (!
              ((B_3 == E_3) && ((!C_3) || (D_3 == B_3) || (!M_3))
               && ((!C_3) || (I_3 == D_3) || (!M_3)) && ((!C_3) || A_3
                                                         || (!M_3)) && ((!M_3)
                                                                        ||
                                                                        (!((100 <= E_3) == G_3))) && ((!M_3) || (!((100 <= F_3) == H_3))) && ((!M_3) || (!((I_3 <= 199) == K_3))) && ((!M_3) || (J_3 == (H_3 || G_3))) && ((!M_3) || (L_3 == (K_3 || J_3))) && ((!M_3) || (C_3 && M_3)) && ((!M_3) || (!L_3)) && ((!N_3) || (N_3 && M_3)) && N_3 && (A_3 == (F_3 == 0))))
              abort ();
      ...
      case 1:
          ...
          if (!
              ((D_1 == I_1) && ((!G_1) || (!B_1) || (!A_1))
               && ((!G_1) || (!F_1) || (E_1 == C_1)) && ((!G_1) || (!F_1)
                                                         || (H_1 == D_1))
               && ((!G_1) || (!F_1) || (K_1 == E_1)) && ((!G_1) || (!F_1)
                                                         || (L_1 == H_1))
               && ((!F_1) || (G_1 && F_1)) && ((!G_1) || (C_1 == J_1))
               && ((!G_1) || (G_1 && A_1)) && F_1 && (B_1 == (J_1 == 0))))
              abort ();
          main__lr_ph_i_0 = I_1;
          main__lr_ph_i_1 = J_1;
          main__lr_ph_i_2 = K_1;
      ...
      case 0:
          ...
          if (!
              (((!J_4) || (!B_4) || (!A_4)) && (B_4 || (!M_4) || (!A_4))
               ...
               && ((!E1_4) || (!((100 <= W_4) == Y_4))) && ((!E1_4)
                                                            ||
                                                            (!((100 <= X_4) ==
                                                               Z_4)))
               && ((!E1_4) || (!((A1_4 <= 199) == C1_4))) && ((!E1_4)
                                                              || (B1_4 ==
                                                                  (Z_4
                                                                   || Y_4)))
               && ((!E1_4) || (D1_4 == (C1_4 || B1_4))) && ((!E1_4)
                                                            || (U_4 && E1_4))
               && ((!E1_4) || (!D1_4)) && ((!F1_4) || (F1_4 && E1_4))
               && ((!U_4) || (U_4 && R_4)) && F1_4 && (!((D_4 <= 0) == B_4))))
              abort ();
          CHC_COMP_UNUSED_5 = __VERIFIER_nondet__Bool ();
          if (!1)
              abort ();
