...
// Original CHC file: vmt-chc-benchmarks/vmt-ILLINOIS_2_e2_2367_e3_1601_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-ILLINOIS_2_e2_2367_e3_1601_000_norange.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        (((1 <= X_1) == Y3_1) && ((1 <= V_1) == Z3_1) && ((1 <= V_1) == C4_1)
         ...
         && (((1 <= R_1) && (1 <= T_1)) == O3_1)
         && (Z2_1 ==
             ((W_1 + U_1 + S_1 + Q_1 + (-1 * Y2_1) + X2_1 + (-1 * W2_1) +
               (-1 * V2_1)) == -1)) && (Q3_1 == ((1 <= R_1)
                                                 && (1 <= (X_1 + V_1))))
