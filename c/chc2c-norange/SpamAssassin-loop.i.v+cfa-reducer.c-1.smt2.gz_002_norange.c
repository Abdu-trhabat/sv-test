...
// Original CHC file: tricera-benchmarks/SpamAssassin-loop.i.v+cfa-reducer.c-1.smt2.gz_002.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "SpamAssassin-loop.i.v+cfa-reducer.c-1.smt2.gz_002_norange.c", 13, "reach_error"); }
  ...
  inv_main43:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 0:
          ...
          E_9 = inv_main43_11;
          if (!
              ((R_9 == P_9) && (O_9 == C_9) && (N_9 == D_9) && (M_9 == B_9)
               && (L_9 == H_9) && (K_9 == E_9) && (G_9 == Q_9) && (F_9 == V_9)
               && (Y_9 == X_9) && (W_9 == J_9) && (U_9 == I_9) && (T_9 == A_9)
               && (((!(1 <= (I_9 + (-1 * D_9)))) && (S_9 == 0))
                   || ((1 <= (I_9 + (-1 * D_9))) && (S_9 == 1))) && (S_9 == 0)
               && (v_25_9 == S_9)))
              abort ();
          inv_main50_0 = O_9;
          inv_main50_1 = R_9;
