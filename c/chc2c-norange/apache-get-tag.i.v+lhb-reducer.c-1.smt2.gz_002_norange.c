...
// Original CHC file: tricera-benchmarks/apache-get-tag.i.v+lhb-reducer.c-1.smt2.gz_002.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "apache-get-tag.i.v+lhb-reducer.c-1.smt2.gz_002_norange.c", 13, "reach_error"); }
  ...
  inv_main36:
    switch (__VERIFIER_nondet_int ())
      ...
      case 0:
          ...
          H_1 = inv_main36_11;
          if (!
              ((G1_1 == S_1) && (F1_1 == L_1) && (D1_1 == B_1)
               && (C1_1 == V_1) && (B1_1 == E_1) && (A1_1 == C1_1)
               && (Y_1 == K_1) && (W_1 == Z_1) && (U_1 == D_1) && (T_1 == R_1)
               && (R_1 == G_1) && (Q_1 == L1_1) && (P_1 == W_1)
               && (O_1 == M1_1) && (N_1 == D1_1) && (M_1 == K1_1)
               && (L_1 == H_1) && (!(K_1 == 0)) && (J_1 == B1_1)
               && (I_1 == U_1) && (F_1 == A_1) && (C_1 == K_1) && (A_1 == X_1)
               && (N1_1 == O_1) && (L1_1 == J1_1) && (K1_1 == E1_1)
               && (J1_1 == G_1) && (I1_1 == 0)
               && (((!(0 <= (R_1 + (-1 * L1_1)))) && (I1_1 == 0))
                   || ((0 <= (R_1 + (-1 * L1_1))) && (I1_1 == 1)))
               && (((0 <= J1_1) && (K_1 == 1))
                   || ((!(0 <= J1_1)) && (K_1 == 0))) && (H1_1 == G1_1)
               && (v_40_1 == I1_1)))
              abort ();
          inv_main51_0 = F_1;
          inv_main51_1 = I_1;
