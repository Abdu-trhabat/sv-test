...
// Original CHC file: eldarica-misc/015b-horn_001.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "015b-horn_001_norange.c", 13, "reach_error"); }
  ...
  REC_f_f_1:
    switch (__VERIFIER_nondet_int ())
      ...
      case 0:
          ...
          D_11 = REC_f_f_3;
          if (!
              ((A_11 == (E_11 + 1)) && (A_11 == C_11) && (C_11 == (F_11 + 1))
               && (D_11 >= 0) && (!(A_11 <= 1)) && (!(C_11 <= 1))
               && (!((A_11 + B_11) == (C_11 + D_11)))))
              abort ();
          goto main_error;
