...
// Original CHC file: hcai-bench/sum01_false-unreach-call_true-termination_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "sum01_false-unreach-call_true-termination_000_norange.c", 13, "reach_error"); }
  ...
  main_entry:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 1:
          ...
          C_2 = main__lr_ph_2;
          if (!
              ((!((L_2 <= D_2) == E_2)) && (B_2 == (C_2 + 2))
               && (F_2 == (A_2 ? B_2 : C_2)) && (G_2 == (D_2 + 1)) && ((!J_2)
                                                                       ||
                                                                       (!I_2)
                                                                       || (H_2
                                                                           ==
  ...
  main__lr_ph_0:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 0:
          ...
          C_4 = main__lr_ph_2;
          if (!
              ((!((M_4 <= E_4) == F_4)) && (B_4 == (C_4 + 2))
               && (D_4 == (E_4 + 1)) && (G_4 == (A_4 ? B_4 : C_4)) && ((!K_4)
                                                                       ||
                                                                       (!H_4)
                                                                       || (J_4
                                                                           ==
                                                                           I_4))
               && ((!K_4) || (!H_4) || (I_4 == G_4)) && ((!K_4) || (!H_4)
                                                         || (!F_4)) && ((!U_4)
                                                                        ||
                                                                        (!K_4)
                                                                        ||
               ...
               && ((!U_4) || (!(S_4 == T_4))) && ((!U_4)
                                                  || (Q_4 == (O_4 == 0)))
               && ((!U_4) || (N_4 == (2 * M_4))) && ((!U_4) || (U_4 && K_4))
               && ((!U_4) || T_4) && ((!V_4) || (V_4 && U_4)) && ((!R_4)
                                                                  || (!U_4))
               && V_4 && (!((10 <= E_4) == A_4))))
              abort ();
          CHC_COMP_UNUSED_5 = __VERIFIER_nondet__Bool ();
