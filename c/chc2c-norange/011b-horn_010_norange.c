...
// Original CHC file: eldarica-misc/011b-horn_010.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "011b-horn_010_norange.c", 13, "reach_error"); }
  ...
  REC_f__0:
    switch (__VERIFIER_nondet_int ())
      ...
      case 0:
          ...
          A_24 = REC_f__1;
          if (!
              ((B_24 == D_24) && (!(A_24 == -1)) && (B_24 >= 1)
               && (!(D_24 >= 2)) && (!(A_24 <= -2)) && (D_24 <= -1)
               && (B_24 == (C_24 + 1))))
              abort ();
          goto main_error;
