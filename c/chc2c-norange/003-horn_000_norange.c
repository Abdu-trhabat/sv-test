...
// Original CHC file: eldarica-misc/003-horn_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "003-horn_000_norange.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    J_2 = INV1_9;
    if (!
        ((((5 * K_2) + B_2) == D_2) && (P_2 == Q_2) && (N_2 == O_2)
         && (K_2 == (C_2 + -1)) && (!((F_2 + (-1 * H_2)) >= 1))
         && ((A_2 + (-1 * K_2)) >= 1) && ((L_2 + (5 * K_2) + B_2) == E_2)))
        abort ();
    INV1_0 = A_2;
    INV1_1 = B_2;
    INV1_2 = C_2;
  ...
  INV1_0:
    switch (__VERIFIER_nondet_int ())
      ...
      case 1:
          ...
          M_0 = INV1_9;
          if (!
              ((P_0 == Q_0) && (N_0 == O_0) && (L_0 == (I_0 + -5))
               && (K_0 == (H_0 + -1)) && ((F_0 + (-1 * K_0)) >= 1)
               && (!((A_0 + (-1 * C_0)) >= 1)) && ((M_0 + L_0) == J_0)))
              abort ();
          INV1_0 = A_0;
          INV1_1 = B_0;
          INV1_2 = C_0;
  ...
  INV1_1:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 0:
          ...
          O_1 = INV1_9;
          if (!
              ((((5 * K_1) + B_1) == D_1) && ((O_1 + N_1) == J_1)
               && (S_1 == T_1) && (Q_1 == R_1) && (N_1 == (I_1 + -5))
               && (M_1 == (H_1 + -1)) && (K_1 == (C_1 + -1))
               && ((A_1 + (-1 * K_1)) >= 1) && ((F_1 + (-1 * M_1)) >= 1)
               && ((L_1 + (5 * K_1) + B_1) == E_1)))
              abort ();
          INV1_0 = A_1;
          INV1_1 = B_1;
