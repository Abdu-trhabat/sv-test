...
// Original CHC file: vmt-chc-benchmarks/vmt-car_all_e3_1068_e3_163_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-car_all_e3_1068_e3_163_000_norange.c", 13, "reach_error"); }
    ...
    if (!
        (((I_1 == 10) == H_1) && ((3 <= C2_1) == W1_1) && ((3 <= M_1) == D_1)
         ...
         && ((N1_1 == 0) || ((!F1_1) && B1_1)) && ((X_1 == 0)
                                                   || (Q_1 && (!S_1)))
         && ((!F1_1) || ((K_1 + (-1 * E1_1)) == 1)) && (F1_1 || (K_1 == E1_1))
         && ((B2_1 == 10) == A2_1)))
        abort ();
    state_0 = R1_1;
    state_1 = I2_1;
