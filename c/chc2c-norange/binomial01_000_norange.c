...
// Original CHC file: hopv/binomial01_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "binomial01_000_norange.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    if (!((E_2 == 0) && (D_2 == 1) && (C_2 == 0) && (F_2 == 0)))
        abort ();
    main_1033_unknown_28_0 = A_2;
    main_1033_unknown_28_1 = B_2;
    main_1033_unknown_28_2 = D_2;
    main_1033_unknown_28_3 = C_2;
    main_1033_unknown_28_4 = F_2;
    main_1033_unknown_28_5 = E_2;
    ...
    if (!
        ((!((0 == Y_0) == (X_0 >= 0))) && ((0 == S_0) == (M_0 <= R_0))
         ...
         && (W_0 == (-1 * H_0)) && (V_0 == (T_0 + U_0)) && (U_0 == D_0)
         && (T_0 == 0) && (R_0 == (P_0 + Q_0)) && (Q_0 == (-1 * H_0))
         && (P_0 == (N_0 + O_0)) && (O_0 == D_0) && (N_0 == 0)
         && (M_0 == (K_0 + L_0)) && (L_0 == (-1 * G_0))
