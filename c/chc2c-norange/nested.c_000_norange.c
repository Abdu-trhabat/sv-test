...
// Original CHC file: vmt-chc-benchmarks/nested.c_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "nested.c_000_norange.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    N_1 = state_7;
    if (!
        ((A_1 || O_1 || P_1 || (!B_1) || (!(N_1 <= J_1))
          || (F_1 && (!E_1) && D_1 && (!C_1) && (H_1 == G_1) && (J_1 == I_1)
              && (L_1 == K_1) && (N_1 == M_1))) && (B_1 || P_1 || (!O_1)
                                                    || (!A_1) || (1 <= J_1)
                                                    || (F_1 && (!E_1)
                                                        && (!D_1) && C_1
                                                        && (H_1 == G_1)
              ...
              ((A_1 || O_1 || P_1 || (!B_1) || (!(N_1 <= J_1))
               ...
               && (P_1 || (!O_1) || (!B_1) || (!A_1)
                   || ((!F_1) && (!E_1) && (!D_1) && (!C_1) && (H_1 == G_1)
                       && (J_1 == I_1) && (L_1 == K_1) && (N_1 == M_1)))
               && (O_1 || P_1 || (!B_1) || (!A_1)
                   || ((!F_1) && (!E_1) && (!D_1) && C_1 && (G_1 == 1)
                       && (J_1 == I_1) && (L_1 == K_1) && (N_1 == M_1)))
               && (B_1 || O_1 || P_1 || (!A_1)
                   || ((!F_1) && E_1 && (!D_1) && (!C_1) && (I_1 == 1)
                       && (H_1 == G_1) && (L_1 == K_1) && (N_1 == M_1)))
               && (B_1 || P_1 || (!O_1) || (!A_1) || (!(1 <= J_1))
                   || (F_1 && E_1 && (!D_1) && (!C_1) && (H_1 == G_1)
                       && (J_1 == I_1) && (L_1 == K_1) && (N_1 == M_1)))))
              abort ();
          state_0 = E_1;
