...
// Original CHC file: vmt-chc-benchmarks/vmt-FIREFLY_4_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-FIREFLY_4_000_norange.c", 13, "reach_error"); }
      ...
      case 1:
          ...
          if (!
              (((((!J5_1) && (!G5_1) && (!E5_1) && (!A5_1) && (!W4_1)
               ...
               && ((!E3_1) || ((Q_1 + R5_1 + (-1 * T3_1)) == -1)) && ((!E3_1)
                                                                      ||
                                                                      ((N2_1 +
                                                                        (-1 *
                                                                         D3_1))
                                                                       == 1))
               && (E3_1 || (R5_1 == P3_1)) && ((!E3_1) || (P3_1 == 0))
               && (E3_1 || (N2_1 == D3_1)) && (E3_1 || (Q_1 == T3_1))
               && ((!G3_1) || ((N2_1 + (-1 * F3_1)) == 1)) && ((!G3_1)
                                                               || (N3_1 == 1))
               && (G3_1 || (O2_1 == N3_1)) && (G3_1 || (N2_1 == F3_1))
               && ((!I3_1) || ((O2_1 + (-1 * Y2_1)) == 1)) && ((!I3_1)
                                                               ||
                                                               ((N2_1 +
                                                                 (-1 *
                                                                  H3_1)) ==
                                                                1))
               && ((!I3_1) || ((Q_1 + (-1 * W3_1)) == -2)) && (I3_1
                                                               || (O2_1 ==
                                                                   Y2_1))
