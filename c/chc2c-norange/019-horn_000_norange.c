...
// Original CHC file: eldarica-misc/019-horn_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "019-horn_000_norange.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    J_1 = INV1_5;
    if (!
        ((J_1 == (F_1 + -2)) && (I_1 == (E_1 + -1)) && (H_1 == (C_1 + -1))
         && (G_1 == (B_1 + -1)) && (((2 * A_1) + (-1 * G_1)) >= 1)
         && ((D_1 + (-1 * I_1)) >= 1) && (K_1 == L_1)))
        abort ();
    INV1_0 = A_1;
    INV1_1 = B_1;
