...
// Original CHC file: vmt-chc-benchmarks/vmt-metros_2_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-metros_2_000_norange.c", 13, "reach_error"); }
      ...
      case 1:
          ...
          if (!
              ((J2_1 == I2_1) && (O2_1 == (N2_1 && M2_1))
               ...
               && (D3_1 || (K1_1 == Y2_1)) && ((!E3_1)
                                               || ((K_1 + (-1 * U2_1)) == -1))
               && (E3_1 || (K_1 == U2_1)) && ((!S1_1) || (!(E3_1 == R2_1)))
               && (S1_1 || R2_1) && ((!R1_1) || (!(E3_1 == M2_1))) && (R1_1
                                                                       ||
                                                                       M2_1)
               && (I1_1 || ((10 <= J3_1) == P4_1)) && ((!I1_1)
                                                       ||
                                                       (!((J3_1 <= 0) ==
                                                          P4_1))) && ((!H1_1)
                                                                      ||
