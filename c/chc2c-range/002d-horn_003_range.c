...
// Original CHC file: eldarica-misc/002d-horn_003.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "002d-horn_003_range.c", 13, "reach_error"); }
  ...
  REC_f__0:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 0:
          ...
          A_14 = REC_f__2;
          if (!
              ((G_14 == 1) && (E_14 == (F_14 + -1)) && (E_14 == B_14)
               && (!(C_14 == 0)) && (C_14 == (D_14 + 1)) && (C_14 == G_14)
               && (!(A_14 == (B_14 + 1))) && (!(G_14 == 0))))
              abort ();
          goto main_error;
