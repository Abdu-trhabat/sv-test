...
// Original CHC file: eldarica-misc/01.c_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "01.c_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((h11_0 <= -1000000000) || (h11_0 >= 1000000000))
  ...
  h8:
    switch (__VERIFIER_nondet_int ())
      ...
      case 1:
          ...
          J_11 = h11_9;
          if (!
              ((F_11 == (H_11 + I_11)) && (L_11 == I_11) && (K_11 == H_11)
               && (G_11 == (H_11 + I_11))))
              abort ();
          h10_0 = A_11;
          h10_1 = B_11;
      ...
      case 2:
          ...
          J_10 = h9_9;
          if (!
              ((F_10 == (H_10 + I_10)) && (L_10 == I_10) && (K_10 == H_10)
               && (G_10 == (H_10 + I_10))))
              abort ();
          h10_0 = A_10;
          h10_1 = B_10;
