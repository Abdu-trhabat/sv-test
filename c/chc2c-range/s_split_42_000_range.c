...
// Original CHC file: aeval-benchmarks/s_split_42_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "s_split_42_000_range.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    C_1 = inv_2;
    if (!
        ((E_1 == ((A_1 >= 1765) ? (B_1 + 2) : (B_1 + 1)))
         && (F_1 == ((B_1 >= 5765) ? (C_1 + 3) : (C_1 + 2)))
         && (D_1 == (A_1 + 1))))
        abort ();
    inv_0 = D_1;
    inv_1 = E_1;
