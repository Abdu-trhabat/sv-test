...
void reach_error() { __assert_fail("0", "024-horn_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((REC_g__0 <= -1000000000) || (REC_g__0 >= 1000000000))
        || ((REC_g__1 <= -1000000000) || (REC_g__1 >= 1000000000))
        || ((REC_g_g_0 <= -1000000000) || (REC_g_g_0 >= 1000000000))
        || ((REC_g_g_1 <= -1000000000) || (REC_g_g_1 >= 1000000000))
        || ((REC_g_g_2 <= -1000000000) || (REC_g_g_2 >= 1000000000))
        || ((REC_g_g_3 <= -1000000000) || (REC_g_g_3 >= 1000000000))
        || ((REC_g_g_4 <= -1000000000) || (REC_g_g_4 >= 1000000000))
        || ((REC__g_0 <= -1000000000) || (REC__g_0 >= 1000000000))
        || ((REC__g_1 <= -1000000000) || (REC__g_1 >= 1000000000))
        || ((REC__g_2 <= -1000000000) || (REC__g_2 >= 1000000000))
        ...
        || ((v_4_1 <= -1000000000) || (v_4_1 >= 1000000000))
