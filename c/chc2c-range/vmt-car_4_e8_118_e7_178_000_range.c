...
// Original CHC file: vmt-chc-benchmarks/vmt-car_4_e8_118_e7_178_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-car_4_e8_118_e7_178_000_range.c", 13, "reach_error"); }
         ...
         && (J_1 == K2_1) && (H_1 == G_1) && (F_1 == E_1) && ((!C1_1)
                                                              ...
                                                              ((B_1 +
                                                                (-1 *
                                                                 A1_1)) ==
                                                               -1))
         && ((!C1_1) || (!B1_1) || ((A_1 + (-1 * D1_1)) == -1)) && (B1_1
                                                                    || (!F1_1)
                                                                    || (N1_1
                                                                        == 0))
         && (F_1 || (S_1 == 0) || (!H_1)) && ((B_1 == A1_1) || (C1_1 && B1_1))
         && ((C1_1 && B1_1) || (A_1 == D1_1)) && ((N1_1 == A1_1)
                                                  || (F1_1 && (!B1_1)))
