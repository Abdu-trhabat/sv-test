...
// Original CHC file: vmt-chc-benchmarks/vmt-metros_1_e1_846_e2_1394_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-metros_1_e1_846_e2_1394_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        (((B4_1 + H3_1 + (-1 * Z3_1)) == 0)
         ...
         && (I2_1 || (9 <= Y4_1)) && ((!L2_1) || ((X4_1 + (-1 * K2_1)) == -2))
         && (L2_1 || (X4_1 == K2_1)) && (L2_1 || (K1_1 == N2_1)) && ((!L2_1)
                                                                     || (K1_1
                                                                         ==
                                                                         N2_1))
         && (M2_1 || (9 <= X4_1)) && ((!O2_1) || ((M1_1 + (-1 * R2_1)) == -1))
         && (O2_1 || (M1_1 == R2_1)) && ((!W4_1)
                                         || ((Y4_1 + (-1 * V4_1)) == -2))
