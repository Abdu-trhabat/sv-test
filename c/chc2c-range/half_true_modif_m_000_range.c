...
// Original CHC file: extra-small-lia/half_true_modif_m_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "half_true_modif_m_000_range.c", 13, "reach_error"); }
  ...
  inv1_0:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 0:
          ...
          C_3 = inv_3;
          if (!
              ((F_3 == ((C_3 == 0) ? (A_3 + 1) : A_3)) && (D_3 == (B_3 + 1))
               && (!((2 * E_3) <= B_3)) && (G_3 == ((C_3 == 0) ? 1 : 0))))
              abort ();
          inv_0 = D_3;
          inv_1 = E_3;
          inv_2 = F_3;
