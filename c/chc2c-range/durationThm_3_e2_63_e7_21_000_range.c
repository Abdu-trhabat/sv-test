...
// Original CHC file: vmt-chc-benchmarks/durationThm_3_e2_63_e7_21_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "durationThm_3_e2_63_e7_21_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        ((N1_1 == S_1) && (Y_1 == U_1) && (Z_1 == X_1) && (B1_1 == Y_1)
         ...
         && (F1_1 ==
             (R_1
              || ((A1_1 || (!(C1_1 <= B1_1))) && (E1_1 <= D1_1) && (1 <= D1_1)
                  && (1 <= C1_1)))) && (R_1 == P_1) && (H_1 == R_1)
         && (K1_1 == F1_1) && (K1_1 == I1_1) && ((!L1_1) || (P1_1 == X_1))
         && (L1_1 || (X_1 == 0)) && ((!V_1) || (M1_1 == U_1)) && (V_1
                                                                  || (U_1 ==
                                                                      0))
         && (V_1 || (W_1 == 0)) && ((!V_1) || (Q_1 == W_1)) && (O1_1 == T_1)))
        abort ();
    state_0 = G1_1;
    state_1 = J1_1;
    state_2 = F1_1;
      ...
      case 1:
          ...
          if (!
              ((N1_1 == S_1) && (Y_1 == U_1) && (Z_1 == X_1) && (B1_1 == Y_1)
               ...
               && (K1_1 == I1_1) && ((!L1_1) || (P1_1 == X_1)) && (L1_1
                                                                   || (X_1 ==
                                                                       0))
               && ((!V_1) || (M1_1 == U_1)) && (V_1 || (U_1 == 0)) && (V_1
                                                                       || (W_1
                                                                           ==
                                                                           0))
               && ((!V_1) || (Q_1 == W_1)) && (O1_1 == T_1)))
              abort ();
          state_0 = G1_1;
          state_1 = J1_1;
          state_2 = F1_1;
