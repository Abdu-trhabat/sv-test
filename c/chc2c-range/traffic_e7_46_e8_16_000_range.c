...
// Original CHC file: vmt-chc-benchmarks/traffic_e7_46_e8_16_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "traffic_e7_46_e8_16_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    if (!
        ((F_0 == E_0) && (A_0 == 0) && (A_0 == H_0)
         && (((!D_0) || ((E_0 <= 20) && (0 <= E_0))) == C_0)
         && ((B_0 && (I_0 <= 1) && (-1 <= I_0)) == D_0) && ((I_0 <= 0)
                                                            || (10 <= H_0)
                                                            ||
                                                            ((I_0 + H_0 +
                                                              (-1 * G_0)) ==
                                                             0))
         && ((0 <= I_0) || (H_0 <= 0) || ((I_0 + H_0 + (-1 * J_0)) == 0))
         && ((H_0 == G_0) || ((!(I_0 <= 0)) && (!(10 <= H_0))))
         && (((!(H_0 <= 0)) && (!(0 <= I_0))) || (J_0 == G_0)) && B_0
         && (J_0 == F_0)))
        abort ();
    state_0 = A_0;
    state_1 = B_0;
    ...
    if (!
        ((P_1 == O_1) && (P_1 == C_1) && (H_1 == G_1) && (H_1 == L_1)
         ...
         && ((0 <= S_1) || (R_1 <= 0) || ((S_1 + R_1 + (-1 * T_1)) == 0))
         && ((0 <= K_1) || (J_1 <= 0) || ((K_1 + J_1 + (-1 * L_1)) == 0))
