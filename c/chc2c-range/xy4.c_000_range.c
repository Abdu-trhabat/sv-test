...
// Original CHC file: vmt-chc-benchmarks/xy4.c_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "xy4.c_000_range.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    J_1 = state_5;
    if (!
        ((A_1 || M_1 || (!L_1) || (!B_1) || (J_1 <= -1)
          || (F_1 && (!E_1) && D_1 && C_1 && (H_1 == G_1) && (J_1 == I_1)))
         && (A_1 || L_1 || (!M_1) || (!B_1) || (!(H_1 <= 0))
             || (F_1 && (!E_1) && D_1 && (!C_1) && (H_1 == G_1)
                 && (J_1 == I_1))) && (A_1 || L_1 || (!M_1) || (!B_1)
                                       || (H_1 <= 0) || ((!F_1) && E_1 && D_1
                                                         && C_1
                                                         && (H_1 == G_1)
                                                         && (J_1 == I_1)))
         && (A_1 || L_1 || M_1 || (!B_1) || (K_1 == 0)
             || ((!F_1) && E_1 && D_1 && (!C_1) && (H_1 == G_1)
                 && (J_1 == I_1))) && (A_1 || L_1 || M_1 || (!B_1)
                                       || (!(K_1 == 0)) || ((!F_1) && (!E_1)
                                                            && D_1 && C_1
