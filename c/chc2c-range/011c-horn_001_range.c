...
// Original CHC file: eldarica-misc/011c-horn_001.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "011c-horn_001_range.c", 13, "reach_error"); }
  ...
  REC__f_0:
    switch (__VERIFIER_nondet_int ())
      ...
      case 0:
          ...
          A_24 = REC__f_1;
          if (!
              ((!(A_24 == -2)) && (D_24 == B_24) && (B_24 >= 2)
               && (!(D_24 >= 1)) && (!(A_24 <= -1)) && (D_24 <= -1)
               && (B_24 == (C_24 + 2))))
              abort ();
          goto main_error;
