...
// Original CHC file: vmt-chc-benchmarks/durationThm_2_e2_206_e7_33_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "durationThm_2_e2_206_e7_33_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        ((W_1 == Q_1) && (X_1 == V_1) && (Y_1 == X_1) && (Z_1 == U_1)
         ...
         && (D1_1 ==
             (P_1
              || ((C1_1 || (!(Z_1 <= B1_1))) && (A1_1 || (!(Z_1 <= Y_1)))
                  && (1 <= Z_1)))) && (P_1 == N_1) && (H_1 == P_1)
         && (I1_1 == D1_1) && (I1_1 == G1_1) && ((!R_1) || (O_1 == S_1)
                                                 || (!T_1)) && ((S_1 == 0)
                                                                || (R_1
                                                                    && T_1))
         && ((!T_1) || (J1_1 == V_1)) && (T_1 || (V_1 == 0)) && ((!R_1)
                                                                 || (M1_1 ==
                                                                     Q_1))
         && (R_1 || (Q_1 == 0)) && (K1_1 == U_1)))
        abort ();
      ...
      case 1:
          ...
          if (!
              ((W_1 == Q_1) && (X_1 == V_1) && (Y_1 == X_1) && (Z_1 == U_1)
               ...
               && (I1_1 == G1_1) && ((!R_1) || (O_1 == S_1) || (!T_1))
               && ((S_1 == 0) || (R_1 && T_1)) && ((!T_1) || (J1_1 == V_1))
               && (T_1 || (V_1 == 0)) && ((!R_1) || (M1_1 == Q_1)) && (R_1
                                                                       || (Q_1
                                                                           ==
                                                                           0))
               && (K1_1 == U_1)))
