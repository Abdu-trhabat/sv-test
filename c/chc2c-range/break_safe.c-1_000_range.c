...
void reach_error() { __assert_fail("0", "break_safe.c-1_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main3_0 <= -1000000000) || (inv_main3_0 >= 1000000000))
        ...
        || ((v_3_7 <= -1000000000) || (v_3_7 >= 1000000000))
        || ((v_4_7 <= -1000000000) || (v_4_7 >= 1000000000))
  ...
  inv_main7_0:
    switch (__VERIFIER_nondet_int ())
      ...
      case 2:
          ...
          if (((v_4_7 <= -1000000000) || (v_4_7 >= 1000000000)))
              abort ();
          v_3_7 = __VERIFIER_nondet_int ();
          if (((v_3_7 <= -1000000000) || (v_3_7 >= 1000000000)))
              abort ();
          A_7 = inv_main7_0;
          B_7 = inv_main7_1;
          C_7 = inv_main7_2;
