...
// Original CHC file: vmt-chc-benchmarks/vmt-metros_1_e7_1255_e7_12_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-metros_1_e7_1255_e7_12_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        (((B4_1 + H3_1 + (-1 * Z3_1)) == 0)
         ...
         && (B_1 == Y1_1) && (T1_1 || Z2_1 || (Y2_1 == 0)) && (R1_1 || X2_1
                                                               || (W2_1 == 0))
         && ((!(9 <= Y4_1)) || (!(W4_1 == I2_1))) && ((!(9 <= X4_1))
                                                      || (!(L2_1 == M2_1)))
         && ((Y2_1 == V4_1) || ((!T1_1) && (!Z2_1))) && ((W2_1 == K2_1)
                                                         || ((!R1_1)
                                                             && (!X2_1)))
