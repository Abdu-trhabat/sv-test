...
void reach_error() { __assert_fail("0", "apache-get-tag.i.p+lhb-reducer.c-1.smt2.gz_002_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main464_0 <= -1000000000) || (inv_main464_0 >= 1000000000))
        ...
        || ((v_29_40 <= -1000000000) || (v_29_40 >= 1000000000))
