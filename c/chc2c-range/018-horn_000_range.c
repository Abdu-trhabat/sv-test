...
// Original CHC file: eldarica-misc/018-horn_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "018-horn_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((INV3_0 <= -1000000000) || (INV3_0 >= 1000000000))
        || ((INV3_1 <= -1000000000) || (INV3_1 >= 1000000000))
        || ((INV3_2 <= -1000000000) || (INV3_2 >= 1000000000))
        || ((INV3_3 <= -1000000000) || (INV3_3 >= 1000000000))
        || ((INV3_4 <= -1000000000) || (INV3_4 >= 1000000000))
        || ((INV3_5 <= -1000000000) || (INV3_5 >= 1000000000))
