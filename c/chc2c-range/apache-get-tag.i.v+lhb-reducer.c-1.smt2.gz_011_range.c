...
void reach_error() { __assert_fail("0", "apache-get-tag.i.v+lhb-reducer.c-1.smt2.gz_011_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main4_0 <= -1000000000) || (inv_main4_0 >= 1000000000))
        ...
        || ((v_26_8 <= -1000000000) || (v_26_8 >= 1000000000))
  ...
  main_init:
    ...
    if (((v_26_8 <= -1000000000) || (v_26_8 >= 1000000000)))
        abort ();
    Y_8 = inv_main4_0;
    E_8 = inv_main4_1;
    N_8 = inv_main4_2;
