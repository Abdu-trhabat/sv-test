...
void reach_error() { __assert_fail("0", "nested-while_merged_safe.c-1_002_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main11_0 <= -1000000000) || (inv_main11_0 >= 1000000000))
        ...
        || ((inv_main16_0 <= -1000000000) || (inv_main16_0 >= 1000000000))
        || ((inv_main16_1 <= -1000000000) || (inv_main16_1 >= 1000000000))
        || ((inv_main16_2 <= -1000000000) || (inv_main16_2 >= 1000000000))
        || ((inv_main16_3 <= -1000000000) || (inv_main16_3 >= 1000000000))
        || ((inv_main16_4 <= -1000000000) || (inv_main16_4 >= 1000000000))
        || ((inv_main16_5 <= -1000000000) || (inv_main16_5 >= 1000000000))
        || ((inv_main16_6 <= -1000000000) || (inv_main16_6 >= 1000000000))
        || ((inv_main16_7 <= -1000000000) || (inv_main16_7 >= 1000000000))
        ...
        || ((inv_main10_4 <= -1000000000) || (inv_main10_4 >= 1000000000))
        || ((inv_main10_5 <= -1000000000) || (inv_main10_5 >= 1000000000))
        || ((inv_main10_6 <= -1000000000) || (inv_main10_6 >= 1000000000))
        || ((inv_main10_7 <= -1000000000) || (inv_main10_7 >= 1000000000))
        ...
        || ((inv_main6_6 <= -1000000000) || (inv_main6_6 >= 1000000000))
        || ((inv_main6_7 <= -1000000000) || (inv_main6_7 >= 1000000000))
        ...
        || ((inv_main19_5 <= -1000000000) || (inv_main19_5 >= 1000000000))
        || ((inv_main19_6 <= -1000000000) || (inv_main19_6 >= 1000000000))
        || ((inv_main19_7 <= -1000000000) || (inv_main19_7 >= 1000000000))
        ...
        || ((v_6_11 <= -1000000000) || (v_6_11 >= 1000000000))
        || ((v_7_11 <= -1000000000) || (v_7_11 >= 1000000000))
        ...
        || ((v_6_12 <= -1000000000) || (v_6_12 >= 1000000000))
        || ((v_7_12 <= -1000000000) || (v_7_12 >= 1000000000))
