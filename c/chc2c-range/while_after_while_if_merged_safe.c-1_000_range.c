...
void reach_error() { __assert_fail("0", "while_after_while_if_merged_safe.c-1_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main15_0 <= -1000000000) || (inv_main15_0 >= 1000000000))
        ...
        || ((inv_main15_7 <= -1000000000) || (inv_main15_7 >= 1000000000))
        || ((inv_main15_8 <= -1000000000) || (inv_main15_8 >= 1000000000))
        ...
        || ((inv_main12_6 <= -1000000000) || (inv_main12_6 >= 1000000000))
        || ((inv_main12_7 <= -1000000000) || (inv_main12_7 >= 1000000000))
        || ((inv_main12_8 <= -1000000000) || (inv_main12_8 >= 1000000000))
        ...
        || ((inv_main7_7 <= -1000000000) || (inv_main7_7 >= 1000000000))
        || ((inv_main7_8 <= -1000000000) || (inv_main7_8 >= 1000000000))
        ...
        || ((inv_main20_6 <= -1000000000) || (inv_main20_6 >= 1000000000))
        || ((inv_main20_7 <= -1000000000) || (inv_main20_7 >= 1000000000))
        || ((inv_main20_8 <= -1000000000) || (inv_main20_8 >= 1000000000))
        ...
        || ((inv_main8_6 <= -1000000000) || (inv_main8_6 >= 1000000000))
        || ((inv_main8_7 <= -1000000000) || (inv_main8_7 >= 1000000000))
        || ((inv_main8_8 <= -1000000000) || (inv_main8_8 >= 1000000000))
        ...
        || ((v_6_10 <= -1000000000) || (v_6_10 >= 1000000000))
        || ((v_7_10 <= -1000000000) || (v_7_10 >= 1000000000))
        || ((v_8_10 <= -1000000000) || (v_8_10 >= 1000000000))
