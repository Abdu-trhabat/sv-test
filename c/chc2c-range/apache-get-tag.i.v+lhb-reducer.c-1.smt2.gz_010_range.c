...
void reach_error() { __assert_fail("0", "apache-get-tag.i.v+lhb-reducer.c-1.smt2.gz_010_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main148_0 <= -1000000000) || (inv_main148_0 >= 1000000000))
        ...
        || ((v_46_26 <= -1000000000) || (v_46_26 >= 1000000000))
