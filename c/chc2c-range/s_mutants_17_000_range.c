...
// Original CHC file: extra-small-lia/s_mutants_17_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "s_mutants_17_000_range.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    B_1 = itp_1;
    E_1 = itp_2;
    if (!((C_1 == (A_1 + 1)) && (!(1000 <= A_1)) && (D_1 == (B_1 + 1))))
        abort ();
    itp_0 = C_1;
    itp_1 = D_1;
    itp_2 = E_1;
