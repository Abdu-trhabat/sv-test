...
// Original CHC file: extra-small-lia/bouncy_two_counters_merged_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "bouncy_two_counters_merged_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((itp1_0 <= -1000000000) || (itp1_0 >= 1000000000))
  ...
  main_init:
    ...
    C_1 = itp1_2;
    if (!
        (((D_1 == B_1) && (E_1 == (A_1 + 1)) && (F_1 == (C_1 + -1)))
         || ((D_1 == (B_1 + 1)) && (E_1 == A_1) && (F_1 == (C_1 + 1)))))
        abort ();
    itp1_0 = D_1;
    itp1_1 = E_1;
    itp1_2 = F_1;
