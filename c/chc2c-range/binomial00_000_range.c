...
void reach_error() { __assert_fail("0", "binomial00_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((main_1033_unknown_28_0 <= -1000000000)
         || (main_1033_unknown_28_0 >= 1000000000))
        || ((main_1033_unknown_28_1 <= -1000000000)
            || (main_1033_unknown_28_1 >= 1000000000))
        || ((main_1033_unknown_28_2 <= -1000000000)
            || (main_1033_unknown_28_2 >= 1000000000))
        || ((main_1033_unknown_28_3 <= -1000000000)
            || (main_1033_unknown_28_3 >= 1000000000))
        || ((main_1033_unknown_28_4 <= -1000000000)
            || (main_1033_unknown_28_4 >= 1000000000))
        || ((main_1033_unknown_28_5 <= -1000000000)
            || (main_1033_unknown_28_5 >= 1000000000))
        || ((fail_unknown_21_0 <= -1000000000)
            || (fail_unknown_21_0 >= 1000000000))
        || ((bin_1030_unknown_8_0 <= -1000000000)
            || (bin_1030_unknown_8_0 >= 1000000000))
        || ((bin_1030_unknown_8_1 <= -1000000000)
            || (bin_1030_unknown_8_1 >= 1000000000))
        || ((bin_1030_unknown_8_2 <= -1000000000)
            || (bin_1030_unknown_8_2 >= 1000000000))
        || ((bin_1030_unknown_8_3 <= -1000000000)
            || (bin_1030_unknown_8_3 >= 1000000000))
        || ((bin_1030_unknown_8_4 <= -1000000000)
            || (bin_1030_unknown_8_4 >= 1000000000))
        || ((bin_1030_unknown_8_5 <= -1000000000)
            || (bin_1030_unknown_8_5 >= 1000000000))
        || ((bin_1030_unknown_8_6 <= -1000000000)
            || (bin_1030_unknown_8_6 >= 1000000000))
        || ((bin_1030_unknown_8_7 <= -1000000000)
            || (bin_1030_unknown_8_7 >= 1000000000)) || ((A_0 <= -1000000000)
                                                         || (A_0 >=
                                                             1000000000))
        ...
        || ((v_11_1 <= -1000000000) || (v_11_1 >= 1000000000))
  ...
  main_init:
    ...
    if (((v_11_1 <= -1000000000) || (v_11_1 >= 1000000000)))
        abort ();
    v_10_1 = __VERIFIER_nondet_int ();
    if (((v_10_1 <= -1000000000) || (v_10_1 >= 1000000000)))
        abort ();
