...
void reach_error() { __assert_fail("0", "nested-while_merged_safe.c-1_003_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main11_0 <= -1000000000) || (inv_main11_0 >= 1000000000))
        ...
        || ((inv_main22_0 <= -1000000000) || (inv_main22_0 >= 1000000000))
        || ((inv_main22_1 <= -1000000000) || (inv_main22_1 >= 1000000000))
        || ((inv_main22_2 <= -1000000000) || (inv_main22_2 >= 1000000000))
        || ((inv_main22_3 <= -1000000000) || (inv_main22_3 >= 1000000000))
        || ((inv_main22_4 <= -1000000000) || (inv_main22_4 >= 1000000000))
        || ((inv_main22_5 <= -1000000000) || (inv_main22_5 >= 1000000000))
        || ((inv_main22_6 <= -1000000000) || (inv_main22_6 >= 1000000000))
        || ((inv_main22_7 <= -1000000000) || (inv_main22_7 >= 1000000000))
