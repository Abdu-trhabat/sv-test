...
// Original CHC file: vmt-chc-benchmarks/vmt-car_all_e7_188_e7_743_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-car_all_e7_188_e7_743_000_range.c", 13, "reach_error"); }
        ...
        (((I_1 == 10) == H_1) && ((3 <= C2_1) == W1_1) && ((3 <= M_1) == D_1)
         ...
         (((!T1_1)
           || ((0 <= U1_1) && (0 <= P1_1) && (!(11 <= P1_1))
               && (!(4 <= U1_1)))) == S1_1) && (!((Y_1 || Z_1) == Q2_1))
         &&
         (((!A_1)
           || ((0 <= B_1) && (0 <= P2_1) && (!(11 <= P2_1))
               && (!(4 <= B_1)))) == O_1) && (R2_1 == V_1) && (L2_1 == Q_1)
