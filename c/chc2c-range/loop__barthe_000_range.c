...
void reach_error() { __assert_fail("0", "loop__barthe_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((INV_MAIN_42_0 <= -1000000000) || (INV_MAIN_42_0 >= 1000000000))
        ...
        || ((INV_MAIN_42_6 <= -1000000000) || (INV_MAIN_42_6 >= 1000000000))
        || ((INV_MAIN_42_7 <= -1000000000) || (INV_MAIN_42_7 >= 1000000000))
