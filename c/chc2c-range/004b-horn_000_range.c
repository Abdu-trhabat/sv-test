...
// Original CHC file: eldarica-misc/004b-horn_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "004b-horn_000_range.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    if (!
        ((E_3 == 1) && (C_3 == 0) && (B_3 == 0) && (A_3 == D_3) && (F_3 == 0)
         && (v_6_3 == A_3) && (v_7_3 == D_3)))
        abort ();
    INV1_0 = A_3;
    INV1_1 = B_3;
  ...
  INV1_0:
    switch (__VERIFIER_nondet_int ())
      ...
      case 1:
          ...
          H_1 = INV1_7;
          if (!
              (((J_1 + I_1) == C_1) && (K_1 == (E_1 + -1))
               && (I_1 == (B_1 + -1)) && (G_1 == H_1) && (A_1 >= I_1)
               && (D_1 >= K_1) && ((L_1 + K_1) == F_1)))
              abort ();
          INV1_0 = A_1;
          INV1_1 = B_1;
