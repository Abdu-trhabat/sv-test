...
void reach_error() { __assert_fail("0", "trex04_true-unreach-call_false-termination_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((main__bb4_0 <= -1000000000) || (main__bb4_0 >= 1000000000))
        || ((main__bb4_1 <= -1000000000) || (main__bb4_1 >= 1000000000))
