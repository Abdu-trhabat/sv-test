...
void reach_error() { __assert_fail("0", "SpamAssassin-loop.i.v+cfa-reducer.c-1.smt2.gz_005_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main43_0 <= -1000000000) || (inv_main43_0 >= 1000000000))
        ...
        || ((inv_main71_19 <= -1000000000) || (inv_main71_19 >= 1000000000))
        ...
        || ((v_76_20 <= -1000000000) || (v_76_20 >= 1000000000))
  ...
  inv_main43:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 0:
          ...
          if (((M2_20 <= -1000000000) || (M2_20 >= 1000000000)))
              abort ();
          ...
          if (((S2_20 <= -1000000000) || (S2_20 >= 1000000000)))
              abort ();
          ...
          if (((v_76_20 <= -1000000000) || (v_76_20 >= 1000000000)))
              abort ();
          N_20 = inv_main43_0;
          V_20 = inv_main43_1;
          P_20 = inv_main43_2;
