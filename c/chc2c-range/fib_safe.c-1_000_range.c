...
void reach_error() { __assert_fail("0", "fib_safe.c-1_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main3_0 <= -1000000000) || (inv_main3_0 >= 1000000000))
        ...
        || ((inv_main23_5 <= -1000000000) || (inv_main23_5 >= 1000000000))
        || ((inv_main31_0 <= -1000000000) || (inv_main31_0 >= 1000000000))
        ...
        || ((v_4_4 <= -1000000000) || (v_4_4 >= 1000000000))
        ...
        || ((v_8_5 <= -1000000000) || (v_8_5 >= 1000000000))
        || ((v_9_5 <= -1000000000) || (v_9_5 >= 1000000000))
  ...
  main_init:
    ...
    if (((v_4_4 <= -1000000000) || (v_4_4 >= 1000000000)))
        abort ();
  ...
  inv_main9_1:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 0:
          ...
          if (((v_9_5 <= -1000000000) || (v_9_5 >= 1000000000)))
              abort ();
          ...
          if (((v_8_5 <= -1000000000) || (v_8_5 >= 1000000000)))
              abort ();
