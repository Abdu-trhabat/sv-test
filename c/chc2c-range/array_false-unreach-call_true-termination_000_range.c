...
// Original CHC file: hcai-bench/array_false-unreach-call_true-termination_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "array_false-unreach-call_true-termination_000_range.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    C_1 = main_entry_0;
    if (!
        ((!(G_1 == H_1)) && (A_1 == C_1) && (B_1 == C_1)
         && ((!J_1) || (J_1 && I_1)) && (!F_1) && H_1 && J_1
         && (!((D_1 <= E_1) == G_1))))
        abort ();
