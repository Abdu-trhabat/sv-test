...
void reach_error() { __assert_fail("0", "apache-get-tag.i.v+lhb-reducer.c-1.smt2.gz_007_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main148_0 <= -1000000000) || (inv_main148_0 >= 1000000000))
        ...
        || ((v_39_7 <= -1000000000) || (v_39_7 >= 1000000000))
  ...
  inv_main98:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 1:
          ...
          if (((v_39_7 <= -1000000000) || (v_39_7 >= 1000000000)))
              abort ();
          C_7 = inv_main98_0;
          B_7 = inv_main98_1;
          A_7 = inv_main98_2;
