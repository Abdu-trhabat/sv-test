...
void reach_error() { __assert_fail("0", "digits10_inl_merged_safe.c-1_001_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main9_0 <= -1000000000) || (inv_main9_0 >= 1000000000))
        ...
        || ((v_8_8 <= -1000000000) || (v_8_8 >= 1000000000))
        ...
        || ((v_8_9 <= -1000000000) || (v_8_9 >= 1000000000))
  ...
  inv_main10_0:
    switch (__VERIFIER_nondet_int ())
      ...
      case 1:
          ...
          if (((v_8_8 <= -1000000000) || (v_8_8 >= 1000000000)))
              abort ();
      ...
      case 2:
          ...
          if (((v_8_9 <= -1000000000) || (v_8_9 >= 1000000000)))
              abort ();
          E_9 = inv_main10_0;
          B_9 = inv_main10_1;
          C_9 = inv_main10_2;
