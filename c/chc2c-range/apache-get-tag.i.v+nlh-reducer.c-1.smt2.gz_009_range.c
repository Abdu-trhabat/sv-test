...
void reach_error() { __assert_fail("0", "apache-get-tag.i.v+nlh-reducer.c-1.smt2.gz_009_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main37_0 <= -1000000000) || (inv_main37_0 >= 1000000000))
        ...
        || ((v_61_7 <= -1000000000) || (v_61_7 >= 1000000000))
  ...
  inv_main99:
    switch (__VERIFIER_nondet__Bool ())
      ...
      case 1:
          ...
          if (((v_61_7 <= -1000000000) || (v_61_7 >= 1000000000)))
              abort ();
