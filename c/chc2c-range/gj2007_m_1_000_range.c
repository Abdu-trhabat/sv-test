...
void reach_error() { __assert_fail("0", "gj2007_m_1_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv5_0 <= -1000000000) || (inv5_0 >= 1000000000))
        || ((inv5_1 <= -1000000000) || (inv5_1 >= 1000000000))
        || ((inv5_2 <= -1000000000) || (inv5_2 >= 1000000000))
        || ((inv3_0 <= -1000000000) || (inv3_0 >= 1000000000))
        || ((inv3_1 <= -1000000000) || (inv3_1 >= 1000000000))
        || ((inv3_2 <= -1000000000) || (inv3_2 >= 1000000000))
        || ((inv_0 <= -1000000000) || (inv_0 >= 1000000000))
        || ((inv_1 <= -1000000000) || (inv_1 >= 1000000000))
        || ((inv_2 <= -1000000000) || (inv_2 >= 1000000000))
        || ((inv4_0 <= -1000000000) || (inv4_0 >= 1000000000))
