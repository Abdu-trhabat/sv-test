...
void reach_error() { __assert_fail("0", "id_build.i.v+lhb-reducer.c-1.smt2.gz_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main5_0 <= -1000000000) || (inv_main5_0 >= 1000000000))
        ...
        || ((v_14_4 <= -1000000000) || (v_14_4 >= 1000000000))
  ...
  main_init:
    ...
    if (((v_14_4 <= -1000000000) || (v_14_4 >= 1000000000)))
        abort ();
    H_4 = inv_main5_0;
    K_4 = inv_main5_1;
    A_4 = inv_main5_2;
