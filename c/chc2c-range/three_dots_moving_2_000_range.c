...
// Original CHC file: extra-small-lia/three_dots_moving_2_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "three_dots_moving_2_000_range.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    if (!
        ((D_0 >= (B_0 + (-1 * C_0))) && (D_0 >= (B_0 + (-1 * A_0)))
         && (!(B_0 <= A_0)) && (D_0 >= (C_0 + (-2 * A_0) + B_0))))
        abort ();
    inv_0 = A_0;
    inv_1 = B_0;
    inv_2 = C_0;
    ...
    if (!
        ((G_1 == (A_1 + -1))
         && (((D_1 == B_1) && (E_1 == (C_1 + -1)) && (!(B_1 == C_1)))
             || ((D_1 == ((B_1 <= F_1) ? (B_1 + 1) : (B_1 + -1)))
                 && (E_1 == D_1) && (B_1 == C_1))) && (!(C_1 == F_1))))
        abort ();
    inv_0 = D_1;
    inv_1 = E_1;
    inv_2 = F_1;
