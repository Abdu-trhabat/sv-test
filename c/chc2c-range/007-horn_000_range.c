...
// Original CHC file: eldarica-misc/007-horn_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "007-horn_000_range.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    H_1 = INV1_7;
    if (!
        (((2 * I_1) == (B_1 + -4)) && (M_1 == N_1) && (J_1 == (F_1 + -2))
         && (I_1 == (C_1 + -2)) && (J_1 <= 9) && (I_1 <= 9)
         && ((2 * J_1) == (G_1 + -4))))
        abort ();
    INV1_0 = A_1;
    INV1_1 = B_1;
