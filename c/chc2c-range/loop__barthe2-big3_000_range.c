...
void reach_error() { __assert_fail("0", "loop__barthe2-big3_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((INV_MAIN_2_0 <= -1000000000) || (INV_MAIN_2_0 >= 1000000000))
        ...
        || ((INV_MAIN_4_0 <= -1000000000) || (INV_MAIN_4_0 >= 1000000000))
        || ((INV_MAIN_4_1 <= -1000000000) || (INV_MAIN_4_1 >= 1000000000))
        || ((INV_MAIN_4_2 <= -1000000000) || (INV_MAIN_4_2 >= 1000000000))
        || ((INV_MAIN_4_3 <= -1000000000) || (INV_MAIN_4_3 >= 1000000000))
