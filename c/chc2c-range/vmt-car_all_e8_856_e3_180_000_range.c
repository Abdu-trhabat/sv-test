...
// Original CHC file: vmt-chc-benchmarks/vmt-car_all_e8_856_e3_180_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-car_all_e8_856_e3_180_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    if (!
        (((3 <= M_0) == D_0) && ((4 <= K_0) == F_0)
         ...
         && (E1_0 == M_0) && (D1_0 == 0) && (D1_0 == I_0) && (Q_0
                                                              || (X_0 == 0)
                                                              || (!S_0))
         && ((X_0 == W_0) || ((!Q_0) && S_0)) && C1_0 && (!B1_0) && (!A1_0)
         && ((I_0 == 10) == H_0)))
        abort ();
    state_0 = I1_0;
    state_1 = V_0;
                              ...
                              || ((M_1 + (-1 * A1_1)) == 1)) && ((!C1_1)
                                                                 ...
                                                                 ((I_1 +
                                                                   (-1 *
                                                                    D1_1)) ==
                                                                  -1))
         && (B1_1 || (!F1_1) || (N1_1 == 0)) && (Q_1 || (X_1 == 0) || (!S_1))
         && ((M_1 == A1_1) || (C1_1 && B1_1)) && ((C1_1 && B1_1)
                                                  || (I_1 == D1_1))
         && ((N1_1 == A1_1) || (F1_1 && (!B1_1))) && ((X_1 == W_1)
                                                      || ((!Q_1) && S_1))
                                                                ...
                                                                ((I_1 +
                                                                 ...
                                                                 -1)) && (B1_1
                                                                          ...
                                                                          (N1_1
                                                                           ==
                                                                           0))
               && (Q_1 || (X_1 == 0) || (!S_1)) && ((M_1 == A1_1)
                                                    || (C1_1 && B1_1))
               && ((C1_1 && B1_1) || (I_1 == D1_1)) && ((N1_1 == A1_1)
                                                        || (F1_1 && (!B1_1)))
               && ((X_1 == W_1) || ((!Q_1) && S_1)) && ((!F1_1)
                                                        ||
                                                        ((K_1 +
                                                          (-1 * E1_1)) == -1))
               && (F1_1 || (K_1 == E1_1)) && ((B2_1 == 10) == A2_1)))
              abort ();
          state_0 = R1_1;
          state_1 = I2_1;
          state_2 = G1_1;
