...
// Original CHC file: tricera-benchmarks/simple_3-2.c-1.smt2.gz_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "simple_3-2.c-1.smt2.gz_000_range.c", 13, "reach_error"); }
...
main ()
{
  ...
  main_init:
    ...
    C_2 = inv_main5_0;
    B_2 = inv_main5_1;
    if (!((1 <= (B_2 + (-1 * C_2))) && (0 <= C_2) && (A_2 == (C_2 + 2))))
        abort ();
    inv_main5_0 = A_2;
    inv_main5_1 = B_2;
    goto inv_main5_0;
