...
// Original CHC file: eldarica-misc/barthe_merged_safe.c-1_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "barthe_merged_safe.c-1_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main6_0 <= -1000000000) || (inv_main6_0 >= 1000000000))
        ...
        || ((inv_main13_5 <= -1000000000) || (inv_main13_5 >= 1000000000))
        || ((inv_main13_6 <= -1000000000) || (inv_main13_6 >= 1000000000))
  ...
  main_init:
    ...
    if (((v_7_3 <= -1000000000) || (v_7_3 >= 1000000000)))
        abort ();
    D_3 = inv_main6_0;
    B_3 = inv_main6_1;
    F_3 = inv_main6_2;
