...
// Original CHC file: vmt-chc-benchmarks/vmt-fast_1_e8_747_e7_692_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-fast_1_e8_747_e7_692_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((state_29 <= -1000000000) || (state_29 >= 1000000000))
  ...
  main_init:
    ...
    if (!
        (((((!C1_1) && (!L4_1) && M4_1) || ((!C1_1) && L4_1 && (!M4_1))
         ...
         && (E2_1 == K4_1) && (H2_1 == G2_1) && (M2_1 == ((!L2_1) || K2_1))
         && (N2_1 == ((!L2_1) || K2_1)) && (Q2_1 == (P2_1 && O2_1))
         && (U2_1 == (D_1 && T2_1))
