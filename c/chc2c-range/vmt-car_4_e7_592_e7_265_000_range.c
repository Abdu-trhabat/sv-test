...
// Original CHC file: vmt-chc-benchmarks/vmt-car_4_e7_592_e7_265_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "vmt-car_4_e7_592_e7_265_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        ((N1_1 == M1_1) && (O1_1 == E1_1) && (B2_1 == L1_1) && (B2_1 == A2_1)
         ...
         && (((!K2_1) || (0 <= L2_1)) == J2_1) && (!((H1_1 || G1_1) == P1_1))
         && (((!S1_1) || (0 <= T1_1)) == R1_1) && (!((W_1 || X_1) == Y_1))
