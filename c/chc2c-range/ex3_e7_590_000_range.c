...
// Original CHC file: vmt-chc-benchmarks/ex3_e7_590_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "ex3_e7_590_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        ((B1_1 == I1_1) && (E1_1 == G1_1) && (H1_1 == Q_1) && (I1_1 == H1_1)
         ...
         && (D1_1 || C1_1 || (B1_1 == A1_1)) && (C1_1 || (F1_1 == 2)
                                                 || (!D1_1)) && (C1_1
                                                                 || (!D1_1)
                                                                 || (G1_1 ==
                                                                     F1_1))
         && (F_1 || (!D_1) || (H_1 == B_1)) && (D_1 || F_1 || (G_1 == P1_1))
         && (F_1 || (B_1 == 2) || (!D_1)) && ((D1_1 && (!C1_1))
                                              || (F1_1 == 0)) && ((D1_1
                                                                   && (!C1_1))
                                                                  || (G1_1 ==
                                                                      1))
         && (((!D1_1) && (!C1_1))
             || ((B1_1 + (-1 * A1_1) + (-1 * E1_1)) == 0)) && ((D_1 && (!F_1))
                                                               || (H_1 == 1))
