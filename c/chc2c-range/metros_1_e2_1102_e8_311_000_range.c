...
// Original CHC file: vmt-chc-benchmarks/metros_1_e2_1102_e8_311_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "metros_1_e2_1102_e8_311_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        (((B4_1 + H3_1 + (-1 * Z3_1)) == 0)
         ...
         && (I_1 == Y4_1) && (G_1 == X4_1) && (((!Y3_1) || V2_1) == X3_1)
         && ((A_1 || (!J1_1)) == N_1)
         && (!((Q1_1 && U1_1 && T2_1 && S2_1) == U2_1))
