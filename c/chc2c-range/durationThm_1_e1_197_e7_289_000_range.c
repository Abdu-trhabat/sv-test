...
// Original CHC file: vmt-chc-benchmarks/durationThm_1_e1_197_e7_289_000.smt2
extern void abort ();
extern int __VERIFIER_nondet_int ();
extern _Bool __VERIFIER_nondet__Bool ();
extern void __assert_fail(const char *, const char *, unsigned int, const char *) __attribute__ ((__nothrow__ , __leaf__)) __attribute__ ((__noreturn__));
void reach_error() { __assert_fail("0", "durationThm_1_e1_197_e7_289_000_range.c", 13, "reach_error"); }
  ...
  main_init:
    ...
    if (!
        ((X_1 == V_1) && (Y_1 == W_1) && (Z_1 == M1_1) && (G1_1 == C1_1)
         ...
         && (L1_1 ==
             (T_1
              || ((J1_1 || (!(X_1 <= K1_1))) && (A1_1 || (!(Y_1 <= I1_1)))
                  && (1 <= Y_1) && (1 <= X_1)))) && (T_1 == S_1)
         && (P1_1 == L1_1) && (P1_1 == O1_1) && (B_1 == T_1) && ((!T1_1)
                                                                 ||
                                                                 ((R1_1 +
                                                                   (-1 *
                                                                    F1_1)) ==
                                                                  -2))
         && (T1_1 || (F1_1 == 0)) && ((!D1_1) || ((U_1 + (-1 * E1_1)) == -2))
         && ((!D1_1) || ((I_1 + (-1 * C1_1)) == -2)) && (D1_1 || (C1_1 == 0))
         && (D1_1 || (E1_1 == 0)) && (S1_1 == W_1)))
        abort ();
    state_0 = M1_1;
    state_1 = Z_1;
    state_2 = L1_1;
