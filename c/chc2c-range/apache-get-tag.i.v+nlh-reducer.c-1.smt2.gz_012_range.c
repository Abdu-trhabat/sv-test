...
void reach_error() { __assert_fail("0", "apache-get-tag.i.v+nlh-reducer.c-1.smt2.gz_012_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((inv_main4_0 <= -1000000000) || (inv_main4_0 >= 1000000000))
        ...
        || ((v_26_6 <= -1000000000) || (v_26_6 >= 1000000000))
  ...
  main_init:
    ...
    if (((v_26_6 <= -1000000000) || (v_26_6 >= 1000000000)))
        abort ();
    K_6 = inv_main4_0;
    Q_6 = inv_main4_1;
    S_6 = inv_main4_2;
