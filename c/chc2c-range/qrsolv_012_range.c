...
void reach_error() { __assert_fail("0", "qrsolv_012_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((h27_0 <= -1000000000) || (h27_0 >= 1000000000))
        ...
        || ((h69_30 <= -1000000000) || (h69_30 >= 1000000000))
        || ((h69_31 <= -1000000000) || (h69_31 >= 1000000000))
        || ((h69_32 <= -1000000000) || (h69_32 >= 1000000000))
        || ((h69_33 <= -1000000000) || (h69_33 >= 1000000000))
