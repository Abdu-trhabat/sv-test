...
void reach_error() { __assert_fail("0", "sum4_000_range.c", 13, "reach_error"); }
...
main ()
{
    ...
    if (((sum_unknown_2_0 <= -1000000000) || (sum_unknown_2_0 >= 1000000000))
        || ((sum_unknown_2_1 <= -1000000000)
            || (sum_unknown_2_1 >= 1000000000)) || ((A_0 <= -1000000000)
                                                    || (A_0 >= 1000000000))
