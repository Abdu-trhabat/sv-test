...
void reach_error() { __assert_fail("0", "abracadabraabracadabra.c", 3, "reach_error"); }
...
int main() {
	int state = 0;
	int i0, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10; // first iteration of abracadabra
	int j0, j1, j2, j3, j4, j5, j6, j7, j8, j9, j10; // second iteration of abracadabra
  while (1) {
    ...
    j4 = __VERIFIER_nondet_int();
    j5 = __VERIFIER_nondet_int();
    j6 = __VERIFIER_nondet_int();
    j7 = __VERIFIER_nondet_int();
    j8 = __VERIFIER_nondet_int();
    j9 = __VERIFIER_nondet_int();
    j10 = __VERIFIER_nondet_int();
    ...
    if (j4 == 99 && state == 15) state ++;
    if (j5 == 97 && state == 16) state ++;
    if (j6 == 100 && state == 17) state ++;
    if (j7 == 97 && state == 18) state ++;
    if (j8 == 98 && state == 19) state ++;
    if (j9 == 114 && state == 20) state ++;
    if (j10 == 97 && state == 21) state ++;
