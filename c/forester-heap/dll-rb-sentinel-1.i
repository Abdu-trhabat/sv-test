...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "dll-rb-sentinel-1.c", 14, __extension__ __PRETTY_FUNCTION__); })); }
...
int main()
{
 ...
 while (__VERIFIER_nondet_int())
 {
  ...
  do { if (!(null == end->next)) {reach_error();abort();}} while (0);
