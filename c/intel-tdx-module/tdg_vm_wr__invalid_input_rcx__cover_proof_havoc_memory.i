...
void tdg_vm_wr__invalid_input_rcx__postcond() {
    tdx_module_local_t* tdx_local_data_ptr = get_local_data();
    __VERIFIER_assert((tdx_local_data_ptr->vp_ctx.tdvps->guest_state.gpr_state.rax == api_error_with_operand_id(0xC000010000000000ULL, 1ULL)) || ((tdx_local_data_ptr->vp_ctx.tdvps->guest_state.gpr_state.rax >> 32) == (0x8000020000000000ULL >> 32)));
...
int main() {
    ...
    init_tdg_vm_xxx();
    tdg_vm_wr__invalid_input_rcx__precond();

    // Target method
    tdg_vm_wr__call();

    // after_target methods
    tdg_vm_wr__invalid_input_rcx__postcond();
