...
void tdh_phymem_page_reclaim__invalid_state_child_count(){
    ...
    assume_abort_if_not(reclaimed_page_pamt_entry_ptr->pt == PT_TDR); {
    ...
    __VERIFIER_assert(local_data->vmm_regs.rax == 0xC000040000000000ULL);
...
int main() {
    ...
    tdh_phymem_page_reclaim__invalid_state_child_count();
