...
void tdg_sys_rd__common_precond() {
    ...
    assume_abort_if_not(leaf_opcode.leaf == TDG_SYS_RD_LEAF);
}
...
api_error_type tdg_sys_rd(md_field_id_t field_id)
{
    ...
    md_context_ptrs_t md_ctx;
    api_error_type retval = 0x0000000000000000ULL;
    ...
    md_ctx.tdr_ptr = ((void*)0);
    md_ctx.tdcs_ptr = ((void*)0);
...
int main() {
    ...
    tdg_sys_rd__free_entry();
    tdg_sys_rd__post_cover_unsuccess();
    return 0;
}