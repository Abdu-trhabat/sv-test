...
void tdh_mng_create__invalid_entry() {
    ...
    assume_abort_if_not((((tdr_pa.full_pa & global_data->hkid_mask) >> global_data->hkid_start_bit) != 0) || (hkid_info.reserved != 0) || (hkid_info.hkid < global_data->private_hkid_min) || (hkid_info.hkid > global_data->private_hkid_max) || (global_data->kot.entries[hkid_info.hkid].state != 0) || (local_data->vp_ctx.tdr_pamt_entry->pt != PT_TDR));
