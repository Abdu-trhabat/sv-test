...
void tdh_sys_config__invalid_entry() {
    ...
    for (int idx = 0; idx < local_data->vmm_regs.rdx; idx++) {
        precond = precond && ((tdmr_array[idx]->tdmr_base % ((0x400ULL * 0x400ULL) * 0x400ULL)) == 0);
        precond = precond && ((tdmr_array[idx]->tdmr_size > 0) && ((tdmr_array[idx]->tdmr_size % ((0x400ULL * 0x400ULL) * 0x400ULL)) == 0));
        precond = precond && (tdmr_array[idx]->tdmr_base < (uint64_t)(1ULL<<(52ULL)));
        ...
        precond = precond && (tdmr_array[idx]->pamt_1g_base < (uint64_t)(1ULL<<(52ULL)));
        ...
        precond = precond && (tdmr_array[idx]->pamt_2m_base < (uint64_t)(1ULL<<(52ULL)));
        ...
        precond = precond && (tdmr_array[idx]->pamt_4k_base < (uint64_t)(1ULL<<(52ULL)));
