...
void tdh_vp_enter__invalid_state_pamt_metadata__postcond() {
    tdx_module_local_t* local_data = get_local_data();
    __VERIFIER_assert((local_data->vmm_regs.rax == 0xC000030000000000ULL) || ((local_data->vmm_regs.rax >> 32) == (0x8000020000000000ULL >> 32)) || (local_data->vmm_regs.rax == 0xC000090100000000ULL));
...
int main() {
    ...
    tdh_vp_enter__invalid_state_pamt_metadata__postcond();
