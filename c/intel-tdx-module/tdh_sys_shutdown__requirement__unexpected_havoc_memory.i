...
void tdh_sys_shutdown__invalid_entry() {
    ...
    assume_abort_if_not((local_data->vmm_regs.rcx < global_data->min_update_hv) || (local_data->vmm_regs.rcx > global_data->module_hv) || ((global_data->no_downgrade == 1) && (local_data->vmm_regs.rcx != global_data->module_hv)));
...
int main() {
    ...
    tdh_sys_shutdown__invalid_entry();
