...
typedef union __attribute__((__packed__)) td_report_type_s
{
    struct
    {
        uint8_t type;
...
typedef struct __attribute__((__packed__)) report_mac_struct_s
{
    td_report_type_t report_type;
    uint8_t reserved_0[12];
    uint8_t cpusvn[16];
    uint64_t tee_tcb_info_hash[6];
    uint64_t tee_info_hash[6];
    uint8_t report_data[64];
    uint8_t reserved_1[32];
    uint64_t mac[4];
} report_mac_struct_t;
typedef struct __attribute__((__packed__)) tee_tcb_info_s
{
    uint64_t valid;
    uint8_t tee_tcb_svn[16];
    measurement_t mr_seam;
    measurement_t mr_signer_seam;
    uint64_t attributes;
    uint8_t tee_tcb_svn2[16];
    uint8_t reserved[95];
} tee_tcb_info_t;
typedef struct __attribute__((__packed__)) td_info_s
{
    uint64_t attributes;
    uint64_t xfam;
    measurement_t mr_td;
...
typedef struct __attribute__((__packed__)) td_report_s
{
...
typedef struct __attribute__((__packed__)) td_report_data_s
{
    uint8_t data[64];
} td_report_data_t;
...
static inline uint64_t ia32_seamops_seamdb_report(void* report_struct_la,
                                                    void* report_data_la,
...
static inline bool_t is_interrupt_pending_guest_side(void)
{
    return (ia32_rdmsr(0x9A) != 0);
}
...
void tdg_mr_report__common_precond() {
    ...
    assume_abort_if_not(leaf_opcode.leaf == TDG_MR_REPORT_LEAF);
}
void tdg_mr_report__valid_entry() {
    tdx_module_local_t* tdx_local_data_ptr = get_local_data();
    bool_t interrupt_occurred = ((bool_t)0);
    assume_abort_if_not(tdx_local_data_ptr->vmm_regs.r8 == 0);
...
uint64_t tdxfv_abst_vcpu_read_cr2() { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { return fv_vcpu_cr2; } else { __VERIFIER_assert(((bool_t)0)); return 0; } };
void tdxfv_abst_vcpu_write_cr2(uint64_t value) { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { fv_vcpu_cr2 = value; } else { __VERIFIER_assert(((bool_t)0)); } };
uint64_t tdxfv_abst_vcpu_read_dr0() { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { return fv_vcpu_dr0; } else { __VERIFIER_assert(((bool_t)0)); return 0; } };
void tdxfv_abst_vcpu_write_dr0(uint64_t value) { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { fv_vcpu_dr0 = value; } else { __VERIFIER_assert(((bool_t)0)); } };
uint64_t tdxfv_abst_vcpu_read_dr1() { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { return fv_vcpu_dr1; } else { __VERIFIER_assert(((bool_t)0)); return 0; } };
void tdxfv_abst_vcpu_write_dr1(uint64_t value) { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { fv_vcpu_dr1 = value; } else { __VERIFIER_assert(((bool_t)0)); } };
uint64_t tdxfv_abst_vcpu_read_dr2() { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { return fv_vcpu_dr2; } else { __VERIFIER_assert(((bool_t)0)); return 0; } };
void tdxfv_abst_vcpu_write_dr2(uint64_t value) { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { fv_vcpu_dr2 = value; } else { __VERIFIER_assert(((bool_t)0)); } };
uint64_t tdxfv_abst_vcpu_read_dr3() { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { return fv_vcpu_dr3; } else { __VERIFIER_assert(((bool_t)0)); return 0; } };
void tdxfv_abst_vcpu_write_dr3(uint64_t value) { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { fv_vcpu_dr3 = value; } else { __VERIFIER_assert(((bool_t)0)); } };
uint64_t tdxfv_abst_vcpu_read_dr6() { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { return fv_vcpu_dr6; } else { __VERIFIER_assert(((bool_t)0)); return 0; } };
void tdxfv_abst_vcpu_write_dr6(uint64_t value) { if ((fv_is_called_by_host && ((bool_t)1)) || (fv_is_called_by_guest && ((bool_t)0))) { fv_vcpu_dr6 = value; } else { __VERIFIER_assert(((bool_t)0)); } };
...
void init_tdcall() {
    ...
    assume_abort_if_not((vm_id == tdx_local_data_ptr->current_td_vm_id) && (vm_id == 0));
    ...
    assume_abort_if_not((leaf_opcode.version == 0) || (leaf_opcode.leaf == TDG_VM_RD_LEAF));
...
static inline bool_t sept_state_is_any_pending_and_guest_acceptable(const ia32e_sept_t ept_entry)
{
        ...
        )
{
    ...
    if ( __builtin_expect((!shared_bit && (walk_result != EPT_WALK_SUCCESS)), 0) )
    {
    ...
    if ( __builtin_expect((walk_result == EPT_WALK_MISCONFIGURATION), 0) )
    {
        tdx_ept_misconfig_exit_to_vmm(gpa);
    }
    else if ( __builtin_expect((walk_result == EPT_WALK_VIOLATION), 0) )
    {
        tdx_ept_violation_exit_to_vmm(gpa, vm_exit_reason, exit_qual.raw, ext_exit_qual.raw);
    }
    else if ( __builtin_expect((walk_result == EPT_WALK_CONVERTIBLE_VIOLATION), 0) )
    {
        inject_ve_and_return_to_td(tdvps_p, gpa, exit_qual);
    }
    if (shared_bit)
                                            ...
                                            td_info_t* td_info, measurement_t* tee_info_hash, bool_t is_guest)
{
    ...
    bool_t rtmr_locked_flag = ((bool_t)1);
    if (td_info == ((void*)0))
    {
        td_info = &td_info_local;
    }
    basic_memset_to_zero(td_info, sizeof(td_info_t));
    if ((retval = acquire_sharex_lock_hp_sh(&tdcs_p->measurement_fields.rtmr_lock, is_guest)) != 0x0000000000000000ULL)
    {
                                                            ;
        return retval;
    }
    rtmr_locked_flag = ((bool_t)1);
    ...
    {
        if (!(ignore_tdinfo.rtmr & (uint64_t)(1ULL<<(i))))
        {
    ...
    else
    {
        ...
        if (ignore_tdinfo.raw == 0)
        {
            ...
            tdcs_p->measurement_fields.last_teeinfo_hash_valid = ((bool_t)1);
        }
    }
...
IppStatus ippsHashMessage_rmf (const Ipp8u* pMsg, int len, Ipp8u* pMD, const IppsHashMethod* pMethod);
...
void* map_pa_non_wb(void* pa, mapping_type_t mapping_type)
{
    return map_pa_with_memtype(pa, mapping_type, ((bool_t)0));
}
void* map_pa(void* pa, mapping_type_t mapping_type)
{
...
void bus_lock_exit(void)
{
    ...
    if (local_data_ptr->vp_ctx.bus_lock_preempted)
    {
        ...
        async_tdexit_to_vmm(0x0000000000000000ULL, vm_exit_reason, 0, 0, 0, 0);
    }
}
void check_pending_voe_on_debug_td_return(void)
{
        ...
        is_voe_in_exception_bitmap())
    {
        ...
        vm_vmexit_exit_reason_t vm_exit_reason;
        ia32_vmread(0x4016ULL, &vm_exit_inter_info.raw);
        vm_exit_reason.raw = VMEXIT_REASON_EXCEPTION_OR_NMI;
        async_tdexit_to_vmm(0x0000000000000000ULL, vm_exit_reason, 0, 0, 0, vm_exit_inter_info.raw);
    }
}
...
void tdx_ept_violation_exit_to_vmm(pa_t gpa, vm_vmexit_exit_reason_t vm_exit_reason, uint64_t exit_qual, uint64_t ext_exit_qual)
{
    ...
    gpa.low_12_bits = 0;
    async_tdexit_to_vmm(0x0000000000000000ULL, vm_exit_reason, exit_qualification.raw,
...
void tdx_ept_misconfig_exit_to_vmm(pa_t gpa)
{
    ...
    async_tdexit_to_vmm(0x0000000000000000ULL, vm_exit_reason, 0, 0, gpa.raw, 0);
}
void tdx_inject_ve(uint64_t vm_exit_reason, uint64_t exit_qualification, tdvps_t* tdvps_p,
        uint64_t gpa, uint64_t gla)
{
...
api_error_type tdg_mr_report(uint64_t report_struct_gpa, uint64_t additional_data_gpa, uint64_t sub_type, bool_t* interrupt_occurred)
{
    ...
    bool_t interrupt_pending = ((bool_t)0);
    if ( __builtin_expect((!(tdr_p != ((void*)0))), 0) ) { ; tdx_report_error_and_halt((0xA000 | ((TDG_MR_REPORT_LEAF) & 0xFF)), 0); };
    if ( __builtin_expect((!(tdcs_p != ((void*)0))), 0) ) { ; tdx_report_error_and_halt((0xA000 | ((TDG_MR_REPORT_LEAF) & 0xFF)), 1); };
    if ( __builtin_expect((!(tdvps_p != ((void*)0))), 0) ) { ; tdx_report_error_and_halt((0xA000 | ((TDG_MR_REPORT_LEAF) & 0xFF)), 2); };
    pa_t tdg_mr_report_gpa = {.raw = report_struct_gpa};
    pa_t report_data_gpa = {.raw = additional_data_gpa};
    uint8_t report_subtype = (uint8_t)sub_type;
    td_report_t * tdg_mr_report_ptr = ((void*)0);
    td_report_data_t * tdg_mr_report_data_ptr = ((void*)0);
    td_report_type_t tdg_mr_report_type = {.raw = 0};
    __attribute__ ((aligned(1024))) td_report_t temp_tdg_mr_report;
    __attribute__ ((aligned(64))) measurement_t tee_info_hash = { 0 };
    bool_t async_exit_needed = ((bool_t)0);
    basic_memset_to_zero(&temp_tdg_mr_report, sizeof(temp_tdg_mr_report));
    api_error_type return_val = 0xC000010000000000ULL;
    if (!is_addr_aligned_pwr_of_2(tdg_mr_report_gpa.raw, 1024))
    {
                                                    ;
        return_val = api_error_with_operand_id(0xC000010000000000ULL, 1ULL);
        goto EXIT;
    }
    if (!is_addr_aligned_pwr_of_2(report_data_gpa.raw, 64))
    {
                                                          ;
    ...
    {
                                                                      ;
        return_val = api_error_with_operand_id(0xC000010000000000ULL, 8ULL);
        goto EXIT;
    }
    tdg_mr_report_type.type = (uint8_t)0x81;
    tdg_mr_report_type.subtype = report_subtype;
    if (tdcs_p->service_td_fields.servtd_num > 0)
    {
        tdg_mr_report_type.version = (uint8_t)1;
    }
    else
    {
        tdg_mr_report_type.version = (uint8_t)0;
    }
    ...
    if ((return_val = get_tdinfo_and_teeinfohash(tdcs_p, ignore,
                          &temp_tdg_mr_report.td_info, &tee_info_hash, ((bool_t)1))) != 0x0000000000000000ULL)
    {
        return_val = api_error_with_operand_id(return_val, 168ULL);
        goto EXIT;
    }
    if (!is_cached_teeinfohash_used && is_interrupt_pending_guest_side())
    {
        interrupt_pending = ((bool_t)1);
        goto EXIT;
    }
    ...
    {
                                                                 ;
        async_exit_needed = ((bool_t)1);
        goto EXIT;
    }
    if (tdg_mr_report_data_ptr != ((void*)0))
    {
        free_la(tdg_mr_report_data_ptr);
        tdg_mr_report_data_ptr = ((void*)0);
    }
    return_val = check_walk_and_map_guest_side_gpa(tdcs_p,
                                                   tdvps_p,
                                                   tdg_mr_report_gpa,
    ...
    {
                                                                                                     ;
        return_val = api_error_with_operand_id(return_val, 1ULL);
        goto EXIT;
    }
    tdx_memcpy(tdg_mr_report_ptr, 1024, &temp_tdg_mr_report, 1024);
...
EXIT:
    *interrupt_occurred = interrupt_pending;
    ...
    if (tdg_mr_report_ptr != ((void*)0))
    {
        free_la(tdg_mr_report_ptr);
    }
    if (async_exit_needed)
    {
        async_tdexit_empty_reason(0x6000000A00000000ULL);
    }
    return return_val;
}
