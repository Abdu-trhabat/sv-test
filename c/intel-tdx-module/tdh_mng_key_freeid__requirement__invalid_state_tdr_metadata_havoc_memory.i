...
void tdh_mng_key_freeid__common_precond() {
    ...
    assume_abort_if_not(leaf_opcode.leaf == TDH_MNG_KEY_FREEID_LEAF);
}
void tdh_mng_key_freeid__invalid_state_tdr_metadata() {
    ...
    assume_abort_if_not(global_data->kot.entries[tdr_fv.key_management_fields.hkid].state == 2);
    assume_abort_if_not(global_data->kot.entries[tdr_fv.key_management_fields.hkid].wbinvd_bitmap == 0);
...
int main() {
    ...
    tdh_mng_key_freeid__invalid_state_tdr_metadata();
