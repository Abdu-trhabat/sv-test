...
void tdh_mng_init__invalid_state_no_tdcx__postcond() {
    tdx_module_local_t* local_data = get_local_data();
    __VERIFIER_assert((local_data->vmm_regs.rax == 0xC000060600000000ULL) || ((local_data->vmm_regs.rax >> 32) == (0x8000020000000000ULL >> 32)));
...
int main() {
    ...
    tdh_mng_init__invalid_state_no_tdcx__postcond();
