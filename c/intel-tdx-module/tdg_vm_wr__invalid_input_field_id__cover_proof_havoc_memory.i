...
void tdg_vm_wr__invalid_input_field_id__postcond() {
    tdx_module_local_t* tdx_local_data_ptr = get_local_data();
    __VERIFIER_assert((tdx_local_data_ptr->vp_ctx.tdvps->guest_state.gpr_state.rax == api_error_with_operand_id(0xC000010000000000ULL, 2ULL)) || ((tdx_local_data_ptr->vp_ctx.tdvps->guest_state.gpr_state.rax >> 32) == (0x8000020000000000ULL >> 32)));
...
int main() {
    ...
    tdg_vm_wr__invalid_input_field_id__postcond();
