...
void tdh_mng_key_config__unexpected__precond() {
    tdh_mng_key_config__common_precond();
    assume_exit_if_not(!all_conditions_valid());
}
void tdh_mng_key_config__unexpected__postcond() {
    tdx_module_local_t* local_data = get_local_data();
...
int main() {
    ...
    init_tdh_mng_xxx();
    tdh_mng_key_config__unexpected__precond();

    // Target method
    tdh_mng_key_config__call();

    // after_target methods
    tdh_mng_key_config__unexpected__postcond();
