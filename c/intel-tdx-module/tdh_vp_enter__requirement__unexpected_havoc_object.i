...
void tdh_vp_enter__invalid_entry() {
    ...
    precond = precond && (((local_data->vmm_regs.rcx & 0xFFF) == 0) &&
                          ((local_data->vmm_regs.rcx >> 54) == 0));
    ...
    __VERIFIER_assert((local_data->vmm_regs.rax >> 63) == 1);
    uint64_t class_and_details = (local_data->vmm_regs.rax >> 32) & 0xFFFF;
    __VERIFIER_assert((class_and_details != 0x0000000000000000ULL) && (class_and_details != 0x4000000100000000ULL) && (class_and_details != 0x6000000200000000ULL) && (class_and_details != 0x6000000500000000ULL) && (class_and_details != 0x0000114100000000ULL) && (class_and_details != 0x0000114200000000ULL) && (class_and_details != 0x9000020500000000ULL) && (class_and_details != 0x6000000A00000000ULL) && (class_and_details != 0x0000114000000000ULL) && (class_and_details != 0x8000000800000000ULL) && (class_and_details != 0x9000000900000000ULL));
}
