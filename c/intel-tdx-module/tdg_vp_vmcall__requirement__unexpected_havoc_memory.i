...
void tdg_vp_vmcall__common_precond() {
    ...
    assume_abort_if_not(leaf_opcode.leaf == TDG_VP_VMCALL_LEAF);
}
void tdg_vp_vmcall__invalid_entry() {
    tdx_module_local_t* tdx_local_data_ptr = get_local_data();
    assume_abort_if_not(((tdx_local_data_ptr->td_regs.rcx & 1) != 0) || (((tdx_local_data_ptr->td_regs.rcx >> 1) & 1) != 0) || (((tdx_local_data_ptr->td_regs.rcx >> 4) & 1) != 0) || (((tdx_local_data_ptr->td_regs.rcx >> 32) & 0xFFFFFFFF) != 0));
...
int main() {
    ...
    tdg_vp_vmcall__invalid_entry();
    tdg_vp_vmcall__common_postcond();
    return 0;
}