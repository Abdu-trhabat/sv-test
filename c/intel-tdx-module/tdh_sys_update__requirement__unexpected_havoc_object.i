...
void tdh_sys_update__invalid_entry(){
    ...
    assume_abort_if_not((global_data->global_state.sys_state != SYSINIT_DONE) || (global_data->num_of_init_lps != global_data_fv.num_of_lps) || (((handoff_data_header_t*) sysinfo_table->data_rgn_base)->valid != ((bool_t)1)) || (((handoff_data_header_t*) sysinfo_table->data_rgn_base)->hv < global_data_fv.min_update_hv) || (((handoff_data_header_t*) sysinfo_table->data_rgn_base)->hv > global_data_fv.module_hv));
