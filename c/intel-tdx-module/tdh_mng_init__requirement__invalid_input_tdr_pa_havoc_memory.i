...
void tdh_mng_init__common_precond() {
    ...
    assume_abort_if_not(leaf_opcode.leaf == TDH_MNG_INIT_LEAF);
}
void tdh_mng_init__invalid_input_tdr_pa() {
    ...
    assume_abort_if_not(tdr_fv.management_fields.num_tdcx != 0);
    assume_abort_if_not(tdcs_fv.management_fields.op_state == OP_STATE_UNINITIALIZED);
...
int main() {
    ...
    tdh_mng_init__invalid_input_tdr_pa();
