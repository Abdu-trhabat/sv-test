...
static inline void tdh_import_abort__common_precond() {
    ...
    assume_exit_if_not(leaf_opcode.leaf == TDH_IMPORT_ABORT_LEAF);
}
...
int main() {
    ...
    init_tdh_import_xxx();
    tdh_import_abort__expected__precond();

    // Target method
    tdh_import_abort__call();

    // after_target methods
    tdh_import_abort__expected__postcond();
    close_tdh_import_xxx_with_check();
    insert_cover_point();
