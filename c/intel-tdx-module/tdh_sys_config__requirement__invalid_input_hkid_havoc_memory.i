...
void tdh_sys_config__invalid_input_hkid() {
    ...
    assume_abort_if_not(!(global_private_hkid.reserved == 0) || !((global_private_hkid.hkid >= global_data->private_hkid_min) && (global_private_hkid.hkid <= global_data->private_hkid_max)));
    ...
    local_data->vmm_regs.rax = tdh_sys_config(local_data->vmm_regs.rcx,
                                              ...
                                              global_private_hkid);
    __VERIFIER_assert((local_data->vmm_regs.rax == api_error_with_operand_id(0xC000010000000000ULL, 8ULL)) || (local_data->vmm_regs.rax == 0x8000020200000000ULL));
}
