...
void tdh_mr_finalize__invalid_state_tdr_metadata__precond() {
...
void tdh_mr_finalize__invalid_state_tdr_metadata__postcond() {
    tdx_module_local_t* local_data = get_local_data();
...
int main() {
    ...
    init_tdh_mr_xxx();
    tdh_mr_finalize__invalid_state_tdr_metadata__precond();

    // Target method
    tdh_mr_finalize__call();

    // after_target methods
    tdh_mr_finalize__invalid_state_tdr_metadata__postcond();
