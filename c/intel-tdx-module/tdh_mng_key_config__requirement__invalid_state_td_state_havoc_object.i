...
void tdh_mng_key_config__invalid_state_td_state() {
    ...
    assume_abort_if_not(tdr_fv.management_fields.fatal == ((bool_t)1));
    ...
    __VERIFIER_assert(local_data->vmm_regs.rax == 0xE000060400000000ULL);
}
...
int main() {
    ...
    tdh_mng_key_config__invalid_state_td_state();
