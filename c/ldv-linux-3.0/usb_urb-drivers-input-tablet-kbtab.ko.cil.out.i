...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "usb_urb-drivers-input-tablet-kbtab.ko.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
