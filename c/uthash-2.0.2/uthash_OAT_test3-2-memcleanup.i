...
void reach_error() {
  ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "uthash_OAT_test3-2-memcleanup.c", 7, __extension__ __PRETTY_FUNCTION__); }));
}
