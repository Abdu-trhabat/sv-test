...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "205_9a_array_safes_linux-3.16-rc1.tar.xz-205_9a-drivers--net--ethernet--cadence--at91_ether.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
struct kparam_array;
union __anonunion_ldv_26634_189 {
   void *arg ;
...
struct kernel_param {
   ...
   u16 perm ;
   s16 level ;
   union __anonunion_ldv_26634_189 ldv_26634 ;
};
struct kparam_string {
   unsigned int maxlen ;
   char *string ;
...
struct __anonstruct_ldv_28968_205 {
   spinlock_t lock ;
   unsigned int count ;
};
union __anonunion_ldv_28969_204 {
   struct __anonstruct_ldv_28968_205 ldv_28968 ;
};
struct lockref {
   union __anonunion_ldv_28969_204 ldv_28969 ;
};
struct nameidata;
struct vfsmount;
struct __anonstruct_ldv_28992_207 {
   u32 hash ;
   u32 len ;
};
union __anonunion_ldv_28994_206 {
   struct __anonstruct_ldv_28992_207 ldv_28992 ;
   u64 hash_len ;
};
struct qstr {
   union __anonunion_ldv_28994_206 ldv_28994 ;
...
struct __anonstruct_ldv_29355_210 {
   struct radix_tree_node *parent ;
   void *private_data ;
};
union __anonunion_ldv_29357_209 {
   struct __anonstruct_ldv_29355_210 ldv_29355 ;
   struct callback_head callback_head ;
};
struct radix_tree_node {
   unsigned int path ;
   unsigned int count ;
   union __anonunion_ldv_29357_209 ldv_29357 ;
...
union __anonunion_ldv_29882_212 {
   kuid_t uid ;
   kgid_t gid ;
   kprojid_t projid ;
};
struct kqid {
   union __anonunion_ldv_29882_212 ldv_29882 ;
...
union __anonunion_ldv_30296_215 {
   unsigned int const i_nlink ;
   unsigned int __i_nlink ;
};
union __anonunion_ldv_30316_216 {
   struct hlist_head i_dentry ;
   struct callback_head i_rcu ;
};
struct file_lock;
struct cdev;
union __anonunion_ldv_30333_217 {
...
struct inode {
   ...
   void *i_security ;
   unsigned long i_ino ;
   union __anonunion_ldv_30296_215 ldv_30296 ;
   dev_t i_rdev ;
   loff_t i_size ;
   ...
   union __anonunion_ldv_30316_216 ldv_30316 ;
   u64 i_version ;
   atomic_t i_count ;
   ...
   union __anonunion_ldv_30333_217 ldv_30333 ;
   __u32 i_generation ;
...
struct pcpu_dstats;
struct pcpu_vstats;
union __anonunion_ldv_39962_248 {
   void *ml_priv ;
...
struct net_device {
   ...
   struct net *nd_net ;
   union __anonunion_ldv_39962_248 ldv_39962 ;
...
typedef enum ldv_30851 phy_interface_t;
enum ldv_30903 {
    MDIOBUS_ALLOCATED = 1,
...
union __anonunion_hw_stats_252 {
...
struct macb {
   ...
   struct net_device_stats stats ;
   union __anonunion_hw_stats_252 hw_stats ;
...
int ref_cnt ;
struct net_device *at91ether_netdev_ops_group1 ;
int ldv_state_variable_1 ;
struct platform_device *at91ether_driver_group0 ;
...
int ldv_register_netdev_14(struct net_device *dev ) ;
...
extern struct ethtool_ops const macb_ethtool_ops ;
extern int macb_mii_init(struct macb * ) ;
extern int macb_ioctl(struct net_device * , struct ifreq * , int ) ;
extern struct net_device_stats *macb_get_stats(struct net_device * ) ;
extern void macb_set_rx_mode(struct net_device * ) ;
extern void macb_set_hwaddr(struct macb * ) ;
extern void macb_get_hwaddr(struct macb * ) ;
static int at91ether_start(struct net_device *dev )
{
  ...
  lp = (struct macb *)tmp;
  tmp___0 = dma_alloc_attrs(& (lp->pdev)->dev, 72UL, & lp->rx_ring_dma, 208U, (struct dma_attrs *)0);
  lp->rx_ring = (struct macb_dma_desc *)tmp___0;
  if ((unsigned long )lp->rx_ring == (unsigned long )((struct macb_dma_desc *)0)) {
    return (-12);
  } else {
  }
  lp->rx_buffers = dma_alloc_attrs(& (lp->pdev)->dev, 13824UL, & lp->rx_buffers_dma,
                                   208U, (struct dma_attrs *)0);
  if ((unsigned long )lp->rx_buffers == (unsigned long )((void *)0)) {
    dma_free_attrs(& (lp->pdev)->dev, 72UL, (void *)lp->rx_ring, lp->rx_ring_dma,
                   (struct dma_attrs *)0);
  ...
  goto ldv_43133;
  ldv_43132:
  (lp->rx_ring + (unsigned long )i)->addr = (u32 )addr;
  (lp->rx_ring + (unsigned long )i)->ctrl = 0U;
  addr = addr + 1536ULL;
  i = i + 1;
  ldv_43133: ;
  if (i <= 8) {
  ...
  (lp->rx_ring + 8UL)->addr = (lp->rx_ring + 8UL)->addr | 2U;
  lp->rx_tail = 0U;
  __writel((unsigned int )lp->rx_ring_dma, (void volatile *)lp->regs + 24U);
  ctl = __readl((void const volatile *)lp->regs);
  __writel(ctl | 12U, (void volatile *)lp->regs);
  return (0);
}
}
static int at91ether_open(struct net_device *dev )
{
  ...
  lp = (struct macb *)tmp;
  ctl = __readl((void const volatile *)lp->regs);
  __writel(ctl | 32U, (void volatile *)lp->regs);
  macb_set_hwaddr(lp);
  ...
  __writel(3254U, (void volatile *)lp->regs + 40U);
...
static int at91ether_close(struct net_device *dev )
{
  ...
  lp = (struct macb *)tmp;
  ctl = __readl((void const volatile *)lp->regs);
  __writel(ctl & 4294967283U, (void volatile *)lp->regs);
  __writel(3254U, (void volatile *)lp->regs + 44U);
...
static int at91ether_start_xmit(struct sk_buff *skb , struct net_device *dev )
{
  ...
  tmp = netdev_priv((struct net_device const *)dev);
  lp = (struct macb *)tmp;
  tmp___0 = __readl((void const volatile *)lp->regs + 20U);
  if ((tmp___0 & 16U) != 0U) {
    netif_stop_queue(dev);
    lp->skb = skb;
    lp->skb_length = (int )skb->len;
    lp->skb_physaddr = dma_map_single_attrs((struct device *)0, (void *)skb->data,
                                            (size_t )skb->len, 1, (struct dma_attrs *)0);
    __writel((unsigned int )lp->skb_physaddr, (void volatile *)lp->regs + 12U);
    __writel(skb->len, (void volatile *)lp->regs + 16U);
  } else {
...
static void at91ether_rx(struct net_device *dev )
{
  ...
  goto ldv_43163;
  ldv_43162:
  p_recv = (unsigned char *)lp->rx_buffers + (unsigned long )(lp->rx_tail * 1536U);
  pktlen = (lp->rx_ring + (unsigned long )lp->rx_tail)->ctrl & 4095U;
  skb = ldv_netdev_alloc_skb_12(dev, pktlen + 2U);
  ...
  if (((lp->rx_ring + (unsigned long )lp->rx_tail)->ctrl & 1073741824U) != 0U) {
    lp->stats.multicast = lp->stats.multicast + 1UL;
  } else {
  }
  (lp->rx_ring + (unsigned long )lp->rx_tail)->addr = (lp->rx_ring + (unsigned long )lp->rx_tail)->addr & 4294967294U;
  if (lp->rx_tail == 8U) {
    lp->rx_tail = 0U;
  } else {
    lp->rx_tail = lp->rx_tail + 1U;
  }
  ldv_43163: ;
  if ((int )(lp->rx_ring + (unsigned long )lp->rx_tail)->addr & 1) {
    goto ldv_43162;
  } else {
  }
  return;
...
static irqreturn_t at91ether_interrupt(int irq , void *dev_id )
{
  ...
  tmp = netdev_priv((struct net_device const *)dev);
  lp = (struct macb *)tmp;
  intstatus = __readl((void const volatile *)lp->regs + 36U);
  if ((intstatus & 2U) != 0U) {
    at91ether_rx(dev);
  } else {
  }
  if ((intstatus & 128U) != 0U) {
    ...
    if ((unsigned long )lp->skb != (unsigned long )((struct sk_buff *)0)) {
      dev_kfree_skb_irq(lp->skb);
      lp->skb = (struct sk_buff *)0;
      dma_unmap_single_attrs((struct device *)0, lp->skb_physaddr, (size_t )lp->skb_length,
                             1, (struct dma_attrs *)0);
      lp->stats.tx_packets = lp->stats.tx_packets + 1UL;
      lp->stats.tx_bytes = lp->stats.tx_bytes + (unsigned long )lp->skb_length;
    } else {
    }
  ...
  if ((intstatus & 4U) != 0U) {
    ctl = __readl((void const volatile *)lp->regs);
    __writel(ctl & 4294967291U, (void volatile *)lp->regs);
    __writel(ctl | 4U, (void volatile *)lp->regs);
  } else {
  }
...
static struct net_device_ops const at91ether_netdev_ops =
     {0, 0, & at91ether_open, & at91ether_close, (netdev_tx_t (*)(struct sk_buff * ,
                                                                struct net_device * ))(& at91ether_start_xmit),
    0, 0, & macb_set_rx_mode, & eth_mac_addr, & eth_validate_addr, & macb_ioctl, 0,
    & eth_change_mtu, 0, 0, 0, & macb_get_stats, 0, 0, & at91ether_poll_controller,
...
static int at91ether_probe(struct platform_device *pdev )
{
  ...
  board_data = (struct macb_platform_data *)tmp;
  regs = platform_get_resource(pdev, 512U, 0U);
  if ((unsigned long )regs == (unsigned long )((struct resource *)0)) {
    return (-2);
  } else {
  }
  dev = alloc_etherdev_mqs(936, 1U, 1U);
  if ((unsigned long )dev == (unsigned long )((struct net_device *)0)) {
    return (-12);
  } else {
  }
  tmp___0 = netdev_priv((struct net_device const *)dev);
  lp = (struct macb *)tmp___0;
  lp->pdev = pdev;
  lp->dev = dev;
  spinlock_check(& lp->lock);
  __raw_spin_lock_init(& lp->lock.ldv_6338.rlock, "&(&lp->lock)->rlock", & __key);
  dev->base_addr = (unsigned long )regs->start;
  tmp___1 = resource_size((struct resource const *)regs);
  lp->regs = devm_ioremap(& pdev->dev, regs->start, (unsigned long )tmp___1);
  if ((unsigned long )lp->regs == (unsigned long )((void *)0)) {
    res = -12;
    goto err_free_dev;
  } else {
  }
  lp->pclk = devm_clk_get(& pdev->dev, "ether_clk");
  tmp___3 = IS_ERR((void const *)lp->pclk);
  if ((int )tmp___3) {
    tmp___2 = PTR_ERR((void const *)lp->pclk);
    res = (int )tmp___2;
    goto err_free_dev;
  } else {
  }
  clk_enable(lp->pclk);
  tmp___4 = ERR_PTR(-2L);
  lp->hclk = (struct clk *)tmp___4;
  tmp___5 = ERR_PTR(-2L);
  lp->tx_clk = (struct clk *)tmp___5;
  dev->irq = platform_get_irq(pdev, 0U);
  res = devm_request_irq(& pdev->dev, (unsigned int )dev->irq, & at91ether_interrupt,
  ...
  tmp___6 = of_get_mac_address(pdev->dev.of_node);
  mac = (char const *)tmp___6;
  ...
  if (res < 0) {
    if ((unsigned long )board_data != (unsigned long )((struct macb_platform_data *)0) && (unsigned int )board_data->is_rmii != 0U) {
      lp->phy_interface = 6;
    } else {
      lp->phy_interface = 1;
    }
  } else {
    lp->phy_interface = (phy_interface_t )res;
  }
  __writel(0U, (void volatile *)lp->regs);
  reg = 2304U;
  if ((unsigned int )lp->phy_interface == 6U) {
    reg = reg | 8192U;
  } else {
  }
  __writel(reg, (void volatile *)lp->regs + 4U);
  res = ldv_register_netdev_14(dev);
  if (res != 0) {
    goto err_disable_clock;
  } else {
  }
  ...
  phydev = lp->phy_dev;
  tmp___7 = dev_name((struct device const *)(& phydev->dev));
  netdev_info((struct net_device const *)dev, "attached PHY driver [%s] (mii_bus:phy_addr=%s, irq=%d)\n",
              (phydev->drv)->name, tmp___7, phydev->irq);
  netdev_info((struct net_device const *)dev, "AT91 ethernet at 0x%08lx int=%d (%pM)\n",
              dev->base_addr, dev->irq, dev->dev_addr);
  return (0);
  err_out_unregister_netdev:
  ldv_unregister_netdev_15(dev);
  err_disable_clock:
  clk_disable(lp->pclk);
  err_free_dev:
...
static int at91ether_remove(struct platform_device *pdev )
{
  ...
  tmp___0 = netdev_priv((struct net_device const *)dev);
  lp = (struct macb *)tmp___0;
  if ((unsigned long )lp->phy_dev != (unsigned long )((struct phy_device *)0)) {
    phy_disconnect(lp->phy_dev);
  } else {
  }
  mdiobus_unregister(lp->mii_bus);
  kfree((void const *)(lp->mii_bus)->irq);
...
static struct platform_driver at91ether_driver =
     {0, & at91ether_remove, 0, & at91ether_suspend, & at91ether_resume, {"at91_ether",
                                                                        0, & __this_module,
                                                                        0, (_Bool)0,
                                                                        ...
                                                                        0, 0, 0, 0,
                                                                        0}, 0, (_Bool)0};
static int at91ether_driver_init(void)
{
  int tmp ;
  {
  tmp = platform_driver_probe(& at91ether_driver, & at91ether_probe);
  return (tmp);
}
}
static void at91ether_driver_exit(void)
{
  {
...
void ldv_initialize_platform_driver_1(void)
{
  ...
  at91ether_driver_group0 = (struct platform_device *)tmp;
  return;
}
}
void ldv_net_device_ops_2(void)
{
  ...
  at91ether_netdev_ops_group1 = (struct net_device *)tmp;
  return;
}
}
int main(void)
{
  ...
  ldvarg5 = (struct ifreq *)tmp___2;
  tmp___3 = ldv_zalloc(232UL);
  ldvarg2 = (struct sk_buff *)tmp___3;
  ldv_initialize();
  ...
  if (ldv_state_variable_1 != 0) {
    ...
    if (ldv_state_variable_1 == 2) {
      ldv_retval_1 = at91ether_suspend(at91ether_driver_group0, ldvarg0);
      if (ldv_retval_1 == 0) {
    ...
    if (ldv_state_variable_1 == 3) {
      at91ether_remove(at91ether_driver_group0);
    ...
    case 2: ;
    if (ldv_state_variable_1 == 3) {
      ldv_retval_0 = at91ether_resume(at91ether_driver_group0);
      if (ldv_retval_0 == 0) {
  ...
  if (ldv_state_variable_0 != 0) {
    ...
    if (ldv_state_variable_0 == 1) {
      ldv_retval_2 = at91ether_driver_init();
      if (ldv_retval_2 != 0) {
        ldv_state_variable_0 = 3;
        goto ldv_final;
      } else {
  ...
  if (ldv_state_variable_2 != 0) {
    ...
    if (ldv_state_variable_2 == 1) {
      macb_set_rx_mode(at91ether_netdev_ops_group1);
    ...
    case 1: ;
    if (ldv_state_variable_2 == 3) {
      at91ether_close(at91ether_netdev_ops_group1);
      ldv_state_variable_2 = 2;
    } else {
    }
    goto ldv_43300;
    case 2: ;
    if (ldv_state_variable_2 == 1) {
      eth_validate_addr(at91ether_netdev_ops_group1);
      ldv_state_variable_2 = 1;
    } else {
    }
    if (ldv_state_variable_2 == 3) {
    ...
    case 3: ;
    if (ldv_state_variable_2 == 1) {
      macb_ioctl(at91ether_netdev_ops_group1, ldvarg5, ldvarg4);
      ldv_state_variable_2 = 1;
    } else {
    }
    if (ldv_state_variable_2 == 3) {
    ...
    case 4: ;
    if (ldv_state_variable_2 == 1) {
      macb_get_stats(at91ether_netdev_ops_group1);
      ldv_state_variable_2 = 1;
    } else {
    }
    if (ldv_state_variable_2 == 3) {
    ...
    case 5: ;
    if (ldv_state_variable_2 == 1) {
      at91ether_poll_controller(at91ether_netdev_ops_group1);
      ldv_state_variable_2 = 1;
    } else {
    }
    if (ldv_state_variable_2 == 3) {
    ...
    case 6: ;
    if (ldv_state_variable_2 == 3) {
      eth_change_mtu(at91ether_netdev_ops_group1, ldvarg3);
      ldv_state_variable_2 = 3;
    } else {
    }
    if (ldv_state_variable_2 == 2) {
    ...
    case 7: ;
    if (ldv_state_variable_2 == 2) {
      ldv_retval_4 = at91ether_open(at91ether_netdev_ops_group1);
      if (ldv_retval_4 == 0) {
        ldv_state_variable_2 = 3;
      } else {
      }
    ...
    case 8: ;
    if (ldv_state_variable_2 == 3) {
      at91ether_start_xmit(ldvarg2, at91ether_netdev_ops_group1);
      ldv_state_variable_2 = 3;
    } else {
    }
    goto ldv_43300;
    case 9: ;
    if (ldv_state_variable_2 == 1) {
      eth_mac_addr(at91ether_netdev_ops_group1, ldvarg1);
      ldv_state_variable_2 = 1;
    } else {
    }
    if (ldv_state_variable_2 == 3) {
