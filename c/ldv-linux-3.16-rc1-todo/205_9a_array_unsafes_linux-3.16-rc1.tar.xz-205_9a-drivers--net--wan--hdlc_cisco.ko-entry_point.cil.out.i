...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "205_9a_array_unsafes_linux-3.16-rc1.tar.xz-205_9a-drivers--net--wan--hdlc_cisco.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
struct __anonstruct_ldv_26732_198 {
   spinlock_t lock ;
   unsigned int count ;
};
union __anonunion_ldv_26733_197 {
   struct __anonstruct_ldv_26732_198 ldv_26732 ;
};
struct lockref {
   union __anonunion_ldv_26733_197 ldv_26733 ;
};
struct nameidata;
struct vfsmount;
struct __anonstruct_ldv_26756_200 {
   u32 hash ;
   u32 len ;
};
union __anonunion_ldv_26758_199 {
   struct __anonstruct_ldv_26756_200 ldv_26756 ;
   u64 hash_len ;
};
struct qstr {
   union __anonunion_ldv_26758_199 ldv_26758 ;
...
struct __anonstruct_ldv_27119_203 {
   struct radix_tree_node *parent ;
   void *private_data ;
};
union __anonunion_ldv_27121_202 {
   struct __anonstruct_ldv_27119_203 ldv_27119 ;
   struct callback_head callback_head ;
};
struct radix_tree_node {
   unsigned int path ;
   unsigned int count ;
   union __anonunion_ldv_27121_202 ldv_27121 ;
...
union __anonunion_ldv_27646_205 {
   kuid_t uid ;
   kgid_t gid ;
   kprojid_t projid ;
};
struct kqid {
   union __anonunion_ldv_27646_205 ldv_27646 ;
...
union __anonunion_ldv_28060_208 {
   unsigned int const i_nlink ;
   unsigned int __i_nlink ;
};
union __anonunion_ldv_28080_209 {
   struct hlist_head i_dentry ;
   struct callback_head i_rcu ;
};
struct file_lock;
struct cdev;
union __anonunion_ldv_28097_210 {
...
struct inode {
   ...
   void *i_security ;
   unsigned long i_ino ;
   union __anonunion_ldv_28060_208 ldv_28060 ;
   dev_t i_rdev ;
   loff_t i_size ;
   ...
   union __anonunion_ldv_28080_209 ldv_28080 ;
   u64 i_version ;
   atomic_t i_count ;
   ...
   union __anonunion_ldv_28097_210 ldv_28097 ;
   __u32 i_generation ;
...
struct pcpu_dstats;
struct pcpu_vstats;
union __anonunion_ldv_39214_243 {
   void *ml_priv ;
...
struct net_device {
   ...
   struct net *nd_net ;
   union __anonunion_ldv_39214_243 ldv_39214 ;
...
struct kparam_array;
union __anonunion_ldv_41626_251 {
   void *arg ;
...
struct kernel_param {
   ...
   u16 perm ;
   s16 level ;
   union __anonunion_ldv_41626_251 ldv_41626 ;
};
struct kparam_string {
   unsigned int maxlen ;
   char *string ;
...
void ldv_initialize_hdlc_proto_3(void) ;
...
__inline static struct cisco_state *state(hdlc_device *hdlc )
{
  {
  return ((struct cisco_state *)hdlc->state);
}
}
static int cisco_hard_header(struct sk_buff *skb , struct net_device *dev , u16 type ,
...
static void cisco_keepalive_send(struct net_device *dev , u32 type , __be32 par1 ,
                                 __be32 par2 )
{
  struct sk_buff *skb ;
  ...
  __u32 tmp___0 ;
  {
  skb = ldv_dev_alloc_skb_12(22U);
  if ((unsigned long )skb == (unsigned long )((struct sk_buff *)0)) {
    netdev_warn((struct net_device const *)dev, "Memory squeeze on cisco_keepalive_send()\n");
    return;
  } else {
  }
  skb_reserve(skb, 4);
  cisco_hard_header(skb, dev, 32821, (void const *)0, (void const *)0, 0U);
  data = (struct cisco_packet *)skb->data + 4U;
  tmp = __fswab32(type);
  data->type = tmp;
  data->par1 = par1;
  data->par2 = par2;
  data->rel = 65535U;
  tmp___0 = __fswab32(((__u32 )jiffies + 75000U) * 4U);
  data->time = tmp___0;
  skb_put(skb, 18U);
  skb->priority = 7U;
  skb->dev = dev;
...
static __be16 cisco_type_trans(struct sk_buff *skb , struct net_device *dev )
{
  ...
  if ((unsigned int )data->address != 143U && (unsigned int )data->address != 15U) {
    return (6400U);
  } else {
  }
  switch ((int )data->protocol) {
  case 8: ;
  case 14209: ;
  case 56710:
  skb_pull(skb, 4U);
...
static int cisco_rx(struct sk_buff *skb )
{
  ...
  tmp___1 = __fswab16((int )data->protocol);
  switch ((int )tmp___1) {
  case 8192:
  dev_kfree_skb_any(skb);
  return (0);
  case 32821: ;
  if (skb->len != 22U && skb->len != 24U) {
    netdev_info((struct net_device const *)dev, "Invalid length of Cisco control packet (%d bytes)\n",
                skb->len);
    goto rx_error;
  } else {
  }
  cisco_data = (struct cisco_packet *)skb->data + 4U;
  tmp___2 = __fswab32(cisco_data->type);
  switch (tmp___2) {
  case 0U:
  rcu_read_lock();
  in_dev = __in_dev_get_rcu((struct net_device const *)dev);
  addr = 0U;
  mask = 4294967295U;
  if ((unsigned long )in_dev != (unsigned long )((struct in_device *)0)) {
    ...
    goto ldv_42647;
    ldv_42646:
    tmp___3 = strcmp((char const *)(& dev->name), (char const *)(& (*ifap)->ifa_label));
    if (tmp___3 == 0) {
      addr = (*ifap)->ifa_local;
      mask = (*ifap)->ifa_mask;
      goto ldv_42645;
    ...
    ifap = & (*ifap)->ifa_next;
    ldv_42647: ;
    if ((unsigned long )*ifap != (unsigned long )((struct in_ifaddr *)0)) {
      goto ldv_42646;
    } else {
    }
    ldv_42645:
    cisco_keepalive_send(dev, 1U, addr, mask);
  } else {
  }
  rcu_read_unlock();
  dev_kfree_skb_any(skb);
  return (0);
  case 1U:
  netdev_info((struct net_device const *)dev, "Unexpected Cisco IP address reply\n");
  goto rx_error;
  case 2U:
  spin_lock(& st->lock);
  tmp___4 = __fswab32(cisco_data->par1);
  st->rxseq = tmp___4;
  tmp___5 = __fswab32(cisco_data->par2);
  ack = tmp___5;
  if (ack != 0U && (st->txseq == ack || st->txseq - 1U == ack)) {
    st->last_poll = jiffies;
    if (st->up == 0) {
      tmp___6 = __fswab32(cisco_data->time);
      sec = tmp___6 / 1000U;
      min = sec / 60U;
      sec = sec - min * 60U;
      hrs = min / 60U;
      ...
      days = hrs / 24U;
      hrs = hrs - days * 24U;
      netdev_info((struct net_device const *)dev, "Link up (peer uptime %ud%uh%um%us)\n",
                  days, hrs, min, sec);
  ...
  tmp___7 = __fswab16((int )data->protocol);
  netdev_info((struct net_device const *)dev, "Unsupported protocol %x\n", (int )tmp___7);
  dev_kfree_skb_any(skb);
  return (1);
  rx_error:
...
static void cisco_timer(unsigned long arg )
{
  ...
  st = tmp___0;
  spin_lock(& st->lock);
  if (st->up != 0 && (long )((st->last_poll + (unsigned long )(st->settings.timeout * 250U)) - (unsigned long )jiffies) < 0L) {
    st->up = 0;
    netdev_info((struct net_device const *)dev, "Link down\n");
    netif_dormant_on(dev);
  } else {
  }
  tmp___1 = __fswab32(st->rxseq);
  st->txseq = st->txseq + 1U;
  tmp___2 = __fswab32(st->txseq);
  cisco_keepalive_send(dev, 2U, tmp___2, tmp___1);
  spin_unlock(& st->lock);
  st->timer.expires = (unsigned long )(st->settings.interval * 250U) + (unsigned long )jiffies;
...
static void cisco_start(struct net_device *dev )
{
  ...
  tmp___0 = state(hdlc);
  st = tmp___0;
  tmp___1 = spinlock_check(& st->lock);
  ...
  reg_timer_1(& st->timer);
  st->timer.expires = (unsigned long )jiffies + 250UL;
  st->timer.function = & cisco_timer;
...
static void cisco_stop(struct net_device *dev )
{
  ...
  tmp___0 = state(hdlc);
  st = tmp___0;
  ldv_del_timer_sync_13(& st->timer);
  tmp___1 = spinlock_check(& st->lock);
  flags = _raw_spin_lock_irqsave(tmp___1);
  netif_dormant_on(dev);
  st->txseq = 0U;
...
static struct hdlc_proto proto =
    ...
    0, & __this_module, 0};
static struct header_ops const cisco_header_ops = {& cisco_hard_header, 0, 0, 0, 0};
static int cisco_ioctl(struct net_device *dev , struct ifreq *ifr )
{
  cisco_proto *cisco_s ;
  size_t size ;
  ...
  size_t __len ;
  void *__ret ;
  struct cisco_state *tmp___7 ;
  struct cisco_state *tmp___8 ;
  struct lock_class_key __key ;
  struct cisco_state *tmp___9 ;
  {
  cisco_s = ifr->ifr_ifru.ifru_settings.ifs_ifsu.cisco;
  size = 8UL;
  tmp = dev_to_hdlc(dev);
  hdlc = tmp;
  ...
  ifr->ifr_ifru.ifru_settings.type = 8194U;
  ...
  tmp___1 = state(hdlc);
  tmp___2 = copy_to_user((void *)cisco_s, (void const *)(& tmp___1->settings), size);
  if (tmp___2 != 0UL) {
    return (-14);
  } else {
  }
  ...
  tmp___5 = copy_from_user((void *)(& new_settings), (void const *)cisco_s, size);
  if (tmp___5 != 0UL) {
    return (-14);
  } else {
  }
  if (new_settings.interval == 0U || new_settings.timeout <= 1U) {
    return (-22);
  } else {
  }
  ...
  result = attach_hdlc_protocol(dev, & proto, 232UL);
  if (result != 0) {
    return (result);
  } else {
  }
  ...
  tmp___9 = state(hdlc);
  __raw_spin_lock_init(& tmp___9->lock.ldv_6338.rlock, "&(&state(hdlc)->lock)->rlock",
                       & __key);
...
void ldv_initialize_hdlc_proto_3(void)
{
  ...
  proto_group1 = (struct sk_buff *)tmp;
  tmp___0 = ldv_zalloc(3264UL);
  proto_group0 = (struct net_device *)tmp___0;
  return;
}
}
void choose_timer_1(struct timer_list *timer )
...
int main(void)
{
  ...
  ldvarg5 = (struct net_device *)tmp___3;
  ...
  if (ldv_state_variable_3 != 0) {
    ...
    case 1: ;
    if (ldv_state_variable_3 == 1) {
      cisco_ioctl(proto_group0, ldvarg0);
      ldv_state_variable_3 = 1;
    } else {
    }
    ...
    case 2: ;
    if (ldv_state_variable_3 == 1) {
      cisco_type_trans(proto_group1, proto_group0);
      ldv_state_variable_3 = 1;
    } else {
    }
    if (ldv_state_variable_3 == 2) {
  ...
  if (ldv_state_variable_2 != 0) {
    ...
    if (ldv_state_variable_2 == 1) {
      cisco_hard_header(ldvarg3, ldvarg5, (int )ldvarg4, (void const *)ldvarg2,
                        (void const *)ldvarg6, ldvarg1);
      ldv_state_variable_2 = 1;
    } else {
    }
    goto ldv_42778;
