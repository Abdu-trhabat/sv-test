...
struct kparam_array;
union __anonunion_ldv_26639_189 {
   void *arg ;
...
struct kernel_param {
   ...
   u16 perm ;
   s16 level ;
   union __anonunion_ldv_26639_189 ldv_26639 ;
};
struct kparam_string {
   unsigned int maxlen ;
   char *string ;
...
struct __anonstruct_ldv_27487_203 {
   spinlock_t lock ;
   unsigned int count ;
};
union __anonunion_ldv_27488_202 {
   struct __anonstruct_ldv_27487_203 ldv_27487 ;
};
struct lockref {
   union __anonunion_ldv_27488_202 ldv_27488 ;
};
struct nameidata;
struct vfsmount;
struct __anonstruct_ldv_27511_205 {
   u32 hash ;
   u32 len ;
};
union __anonunion_ldv_27513_204 {
   struct __anonstruct_ldv_27511_205 ldv_27511 ;
   u64 hash_len ;
};
struct qstr {
   union __anonunion_ldv_27513_204 ldv_27513 ;
...
struct __anonstruct_ldv_27874_208 {
   struct radix_tree_node *parent ;
   void *private_data ;
};
union __anonunion_ldv_27876_207 {
   struct __anonstruct_ldv_27874_208 ldv_27874 ;
   struct callback_head callback_head ;
};
struct radix_tree_node {
   unsigned int path ;
   unsigned int count ;
   union __anonunion_ldv_27876_207 ldv_27876 ;
...
union __anonunion_ldv_28401_210 {
   kuid_t uid ;
   kgid_t gid ;
   kprojid_t projid ;
};
struct kqid {
   union __anonunion_ldv_28401_210 ldv_28401 ;
...
union __anonunion_ldv_28815_213 {
   unsigned int const   i_nlink ;
   unsigned int __i_nlink ;
};
union __anonunion_ldv_28835_214 {
   struct hlist_head i_dentry ;
   struct callback_head i_rcu ;
};
struct file_lock;
struct cdev;
union __anonunion_ldv_28852_215 {
...
struct inode {
   ...
   void *i_security ;
   unsigned long i_ino ;
   union __anonunion_ldv_28815_213 ldv_28815 ;
   dev_t i_rdev ;
   loff_t i_size ;
   ...
   union __anonunion_ldv_28835_214 ldv_28835 ;
   u64 i_version ;
   atomic_t i_count ;
   ...
   union __anonunion_ldv_28852_215 ldv_28852 ;
   __u32 i_generation ;
...
struct pcpu_dstats;
struct pcpu_vstats;
union __anonunion_ldv_39967_248 {
   void *ml_priv ;
...
struct net_device {
   ...
   struct net *nd_net ;
   union __anonunion_ldv_39967_248 ldv_39967 ;
...
struct archdr *rfc1201_proto_group0  ;
int ref_cnt  ;
int ldv_state_variable_0  ;
struct net_device *rfc1201_proto_group1  ;
...
static struct ArcProto rfc1201_proto  = 
     {97, 1500, 1, & rx, & build_header, & prepare_tx, & continue_tx, (int (*)(struct net_device * ,
                                                                             int  ))0};
...
{ 
  ...
  arc_proto_map[236] = & rfc1201_proto;
  arc_proto_map[250] = arc_proto_map[236];
  arc_proto_map[214] = arc_proto_map[250];
  arc_proto_map[213] = arc_proto_map[214];
  arc_proto_map[196] = arc_proto_map[213];
  arc_proto_map[212] = arc_proto_map[196];
...
{ 
  ...
  skb_pull(skb, (unsigned int )hdr_size);
  if ((unsigned int )pkt->hard.dest == 0U) {
    skb->pkt_type = 1U;
  } else
  if ((dev->flags & 256U) != 0U) {
    if ((int )pkt->hard.dest != (int )*(dev->dev_addr)) {
      skb->pkt_type = 3U;
    } else {
...
{ 
  ...
  pkt = pkthdr;
  soft = & pkthdr->soft.rfc1201;
  saddr = (int )pkt->hard.source;
  in = (struct Incoming *)(& lp->rfc1201.incoming) + (unsigned long )saddr;
  if (length > 256) {
    ofs = 512 - length;
  } else {
    ofs = 256 - length;
  }
  if ((unsigned int )soft->split_flag == 255U) {
    if (length > 7) {

    } else {
      if ((arcnet_debug & 2) != 0) {
        printk("%s%6s: short RFC1201 exception packet from %02Xh", (char *)"\016",
               (char *)(& dev->name), saddr);
      } else {
    ...
    length = length + -4;
    ofs = ofs + 4;
    (*(lp->hw.copy_from_card))(dev, bufnum, 512 - length, (void *)soft, 16);
  } else {

  }
  if ((unsigned int )soft->split_flag == 0U) {
    if ((unsigned long )in->skb != (unsigned long )((struct sk_buff *)0)) {
      if ((arcnet_debug & 2) != 0) {
        printk("%s%6s: aborting assembly (seq=%d) for unsplit packet (splitflag=%d, seq=%d)\n",
               (char *)"\016", (char *)(& dev->name), (int )in->sequence, (int )soft->split_flag,
               (int )soft->sequence);
      } else {
      ...
      in->skb = (struct sk_buff *)0;
    } else {

    }
    in->sequence = soft->sequence;
    skb = ldv_alloc_skb_12((unsigned int )(length + 4), 32U);
    ...
    if ((unsigned int )soft->proto == 213U) {
      arp = (struct arphdr *)(& soft->payload);
      if ((unsigned int )arp->ar_hln == 1U && (unsigned int )arp->ar_pln == 4U) {
        cptr = (uint8_t *)arp + 8UL;
        if ((unsigned int )*cptr == 0U) {
          if ((arcnet_debug & 2) != 0) {
    ...
    if ((unsigned long )in->skb != (unsigned long )((struct sk_buff *)0) && (int )in->sequence != (int )soft->sequence) {
      if ((arcnet_debug & 2) != 0) {
        printk("%s%6s: wrong seq number (saddr=%d, expected=%d, seq=%d, splitflag=%d)\n",
               (char *)"\016", (char *)(& dev->name), saddr, (int )in->sequence, (int )soft->sequence,
               (int )soft->split_flag);
      } else {
      ...
      dev->stats.rx_missed_errors = dev->stats.rx_missed_errors + 1UL;
      tmp___0 = 0U;
      in->numpackets = tmp___0;
      in->lastpacket = tmp___0;
    } else {

    }
    if ((int )soft->split_flag & 1) {
      if ((unsigned long )in->skb != (unsigned long )((struct sk_buff *)0)) {
        if ((arcnet_debug & 2) != 0) {
      ...
      in->sequence = soft->sequence;
      in->numpackets = (unsigned int )((uint8_t )((int )soft->split_flag >> 1)) + 2U;
      in->lastpacket = 1U;
      if ((unsigned int )in->numpackets > 16U) {
        if ((arcnet_debug & 2) != 0) {
          printk("%s%6s: incoming packet more than 16 segments; dropping. (splitflag=%d)\n",
                 (char *)"\016", (char *)(& dev->name), (int )soft->split_flag);
        } else {
      ...
      skb = ldv_alloc_skb_12((unsigned int )((int )in->numpackets * 508 + 4), 32U);
      in->skb = skb;
      if ((unsigned long )skb == (unsigned long )((struct sk_buff *)0)) {
        if (arcnet_debug & 1) {
      ...
      packetnum = (int )((unsigned int )((int )soft->split_flag >> 1) + 1U);
      if ((unsigned long )in->skb == (unsigned long )((struct sk_buff *)0)) {
        if ((int )lp->rfc1201.aborted_seq != (int )soft->sequence) {
          if ((arcnet_debug & 2) != 0) {
            printk("%s%6s: can\'t continue split without starting first! (splitflag=%d, seq=%d, aborted=%d)\n",
                   (char *)"\016", (char *)(& dev->name), (int )soft->split_flag,
                   (int )soft->sequence, (int )lp->rfc1201.aborted_seq);
          } else {
      ...
      in->lastpacket = (uint8_t )((int )in->lastpacket + 1);
      if ((int )in->lastpacket != packetnum) {
        if ((int )in->lastpacket + -1 >= packetnum) {
          if ((arcnet_debug & 2) != 0) {
            printk("%s%6s: duplicate splitpacket ignored! (splitflag=%d)\n", (char *)"\016",
                   (char *)(& dev->name), (int )soft->split_flag);
          } else {
        ...
        dev->stats.rx_missed_errors = dev->stats.rx_missed_errors + 1UL;
        tmp___1 = 0U;
        in->numpackets = tmp___1;
        in->lastpacket = tmp___1;
        return;
      } else {
    ...
    skb = in->skb;
    (*(lp->hw.copy_from_card))(dev, bufnum, ofs + 4, (void *)skb->data + (unsigned long )skb->len,
                               length + -4);
    skb_put(skb, (unsigned int )(length + -4));
    if ((int )in->lastpacket == (int )in->numpackets) {
      in->skb = (struct sk_buff *)0;
      tmp___2 = 0U;
      in->numpackets = tmp___2;
      in->lastpacket = tmp___2;
      skb->protocol = type_trans(skb, dev);
      ldv_netif_rx_15(skb);
    } else {
...
{ 
  ...
  lp = (struct arcnet_local *)tmp;
  hdr_size = 8;
  tmp___0 = skb_push(skb, (unsigned int )hdr_size);
  ...
  if (arcnet_debug & 1) {
    printk("%s%6s: RFC1201: I don\'t understand protocol %d (%Xh)\n", (char *)"\f",
           (char *)(& dev->name), (int )type, (int )type);
  } else {
  ...
  tmp___1 = lp->rfc1201.sequence;
  lp->rfc1201.sequence = (uint16_t )((int )lp->rfc1201.sequence + 1);
  tmp___2 = __fswab16((int )tmp___1);
  soft->sequence = tmp___2;
  soft->split_flag = 0U;
...
{ 
  ...
  if (softlen > 253) {
    ...
    excsoft.split_flag = 255U;
    excsoft.sequence = 65535U;
    hard->offset[0] = 0U;
    ofs = 512 - softlen;
    hard->offset[1] = (unsigned int )((__u8 )ofs) + 252U;
    (*(lp->hw.copy_to_card))(dev, bufnum, ofs + -4, (void *)(& excsoft), 4);
  } else {
    ofs = 256 - softlen;
    hard->offset[0] = (__u8 )ofs;
  }
  (*(lp->hw.copy_to_card))(dev, bufnum, 0, (void *)hard, 4);
  (*(lp->hw.copy_to_card))(dev, bufnum, ofs, (void *)soft, softlen);
...
{ 
  ...
  maxsegsize = 504;
  length = length + -4;
  pkt->soft.rfc1201.split_flag = 0U;
  if (length > 508) {
    out = & lp->outgoing;
    out->length = (unsigned int )((uint16_t )length) + 65532U;
    out->dataleft = lp->outgoing.length;
    out->numsegs = (uint16_t )((((int )out->dataleft + maxsegsize) + -1) / maxsegsize);
    out->segnum = 0U;
    return (0);
  } else {
...
{ 
  ...
  out = & lp->outgoing;
  hard = & (out->pkt)->hard;
  soft = & (out->pkt)->soft.rfc1201;
  maxsegsize = 504;
  newsoft = (struct arc_rfc1201 *)(& (out->pkt)->soft.raw) + ((unsigned long )out->length - (unsigned long )out->dataleft);
  if ((unsigned int )out->segnum == 0U) {
    newsoft->split_flag = (__u8 )((int )((signed char )(((int )out->numsegs + -2) << 1)) | 1);
  } else {
    newsoft->split_flag = (int )((__u8 )out->segnum) << 1U;
    newsoft->proto = soft->proto;
    newsoft->sequence = soft->sequence;
  }
  seglen = maxsegsize;
  if ((int )out->dataleft < seglen) {
    seglen = (int )out->dataleft;
  } else {

  }
  out->dataleft = (int )out->dataleft - (int )((uint16_t )seglen);
  load_pkt(dev, hard, newsoft, seglen + 4, bufnum);
  out->segnum = (uint16_t )((int )out->segnum + 1);
  if ((int )out->segnum >= (int )out->numsegs) {
    return (1);
  } else {
    return (0);
  }
...
{ 
  ...
  {
  tmp = ldv_zalloc(20UL);
  rfc1201_proto_group0 = (struct archdr *)tmp;
  tmp___0 = ldv_zalloc(3264UL);
  rfc1201_proto_group1 = (struct net_device *)tmp___0;
  return;
}
}
int main(void) 
{ 
  ...
  if (ldv_state_variable_1 != 0) {
    ...
    if (ldv_state_variable_1 == 1) {
      continue_tx(rfc1201_proto_group1, ldvarg7);
    ...
    case 1: ;
    if (ldv_state_variable_1 == 1) {
      prepare_tx(rfc1201_proto_group1, rfc1201_proto_group0, ldvarg6, ldvarg5);
      ldv_state_variable_1 = 1;
    } else {
    ...
    case 2: ;
    if (ldv_state_variable_1 == 1) {
      build_header(ldvarg3, rfc1201_proto_group1, (int )ldvarg4, (int )ldvarg2);
      ldv_state_variable_1 = 1;
    } else {
    ...
    case 3: ;
    if (ldv_state_variable_1 == 1) {
      rx(rfc1201_proto_group1, ldvarg1, rfc1201_proto_group0, ldvarg0);
      ldv_state_variable_1 = 1;
    } else {
  ...
  if (ldv_state_variable_0 != 0) {
    ...
    if (ldv_state_variable_0 == 1) {
      ldv_retval_0 = arcnet_rfc1201_init();
      if (ldv_retval_0 == 0) {
...
#include "model/205_9a_array_unsafes_linux-3.16-rc1.tar.xz-205_9a-drivers--net--arcnet--rfc1201.ko-entry_point_false-unreach-call.cil.out.env.c"
