...
static int cw1200_spi_off(struct cw1200_platform_data_spi const *pdata )
{
  ...
  if ((unsigned long )pdata->power_ctrl != (unsigned long )((int (* )(struct cw1200_platform_data_spi const * ,
                                                                                 bool ))0)) {
    {
  ...
  if ((unsigned long )pdata->clk_ctrl != (unsigned long )((int (* )(struct cw1200_platform_data_spi const * ,
                                                                               bool ))0)) {
    {
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-kernel-locking-spinlock_drivers-net-wireless-cw1200-cw1200_wlan_spi.cil.c", 11785, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock(int expr )
{
  {
  if (! expr) {
...
int __VERIFIER_nondet_int(void);
int cw1200_can_suspend(struct cw1200_common *arg0) {
  return __VERIFIER_nondet_int();
}
int __VERIFIER_nondet_int(void);
int cw1200_core_probe(const struct hwbus_ops *arg0, struct hwbus_priv *arg1, struct device *arg2, struct cw1200_common **arg3, int arg4, const u8 *arg5, const char *arg6, bool arg7) {
  return __VERIFIER_nondet_int();
}
void cw1200_core_release(struct cw1200_common *arg0) {
  return;
}
void cw1200_irq_handler(struct cw1200_common *arg0) {
  return;
}
...
int __VERIFIER_nondet_int(void);
int gpiod_direction_output(struct gpio_desc *arg0, int arg1) {
  return __VERIFIER_nondet_int();
}
int __VERIFIER_nondet_int(void);
