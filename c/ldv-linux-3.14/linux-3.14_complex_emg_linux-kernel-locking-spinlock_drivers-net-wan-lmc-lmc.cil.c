...
struct net_device {
   ...
   enum ldv_28246 reg_state : 8 ;
   bool dismantle ;
   enum ldv_28247 rtnl_link_state : 16 ;
...
__inline static void ldv_spin_lock_93(spinlock_t *lock ) ;
...
static void ldv_unregister_hdlc_device_88(struct net_device *ldv_func_arg1 ) ;
...
{ 
  ...
  {
  ldv___ldv_spin_lock_63(& sc->lmc_lock);
  ...
  {
  ldv_spin_unlock_irqrestore_64(& sc->lmc_lock, flags);
  ret = 0;
  }
  goto ldv_43832;
  ...
  {
  ldv___ldv_spin_lock_65(& sc->lmc_lock);
  lmc_proto_close(sc);
  sc->if_type = new_type;
  lmc_proto_attach(sc);
  ...
  {
  ldv___ldv_spin_lock_67(& sc->lmc_lock);
  ...
  {
  ldv___ldv_spin_lock_69(& sc->lmc_lock);
  }
  ...
  {
  ldv___ldv_spin_lock_71(& sc->lmc_lock);
  ...
  {
  ldv___ldv_spin_lock_73(& sc->lmc_lock);
  ...
  {
  ldv___ldv_spin_lock_75(& sc->lmc_lock);
  ...
  case_1: /* CIL Label */ 
  {
  ldv___ldv_spin_lock_77(& sc->lmc_lock);
  ...
  {
  timeout = 500000;
  ldv___ldv_spin_lock_79(& sc->lmc_lock);
  ...
  printk("%s: Starting load of data Len: %d at 0x%p == 0x%p\n", (char *)(& dev->name),
         xc.len, xc.data, data);
  ldv___ldv_spin_lock_81(& sc->lmc_lock);
  lmc_gpio_mkinput(sc, 255U);
  sc->lmc_gpio = 0U;
...
{ 
  ...
  ldv___ldv_spin_lock_83(& sc->lmc_lock);
  }
...
{ 
  ...
  if ((unsigned long )dev != (unsigned long )((struct net_device *)0)) {
    ...
    ldv_unregister_hdlc_device_88(dev);
...
{ 
  ...
  {
  lmc_softreset(sc);
  tmp___0 = ldv_request_irq_90((unsigned int )dev->irq, & lmc_interrupt, 128UL, (char const   *)(& dev->name),
                               (void *)dev);
  }
  if (tmp___0 != 0) {
    {
...
{ 
  ...
  lmc_int_fail_out: 
  {
  ldv_spin_unlock_94(& sc->lmc_lock);
...
{ 
  ...
  ldv___ldv_spin_lock_95(& sc->lmc_lock);
...
{ 
  ...
  ldv___ldv_spin_lock_97(& sc->lmc_lock);
  tmp___0 = inl((int )sc->lmc_csrs.csr_missed_frames);
  (sc->lmc_device)->stats.rx_missed_errors = (sc->lmc_device)->stats.rx_missed_errors + ((unsigned long )tmp___0 & 65535UL);
  ldv_spin_unlock_irqrestore_64(& sc->lmc_lock, flags);
...
{ 
  ...
  {
  {
  tmp = ldv___pci_register_driver_99(& lmc_driver, & __this_module, "lmc");
  }
  return (tmp);
}
}
...
{ 
  ...
  {
  {
  ldv_pci_unregister_driver_100(& lmc_driver);
  }
  return;
}
}
...
{ 
  ...
  ldv___ldv_spin_lock_101(& sc->lmc_lock);
...
{ 
  ...
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock(ldv_spin_lmc_lock_of_lmc___softc == 1);
...
{ 
  ...
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_unlock(ldv_spin_lmc_lock_of_lmc___softc == 2);
...
{ 
  ...
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock_try(ldv_spin_lmc_lock_of_lmc___softc == 1);
  ldv_assume(ldv_spin_lmc_lock_of_lmc___softc == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
{ 
  ...
  ldv_assert_linux_kernel_locking_spinlock__one_thread_locked_at_exit(ldv_spin_lmc_lock_of_lmc___softc == 1);
...
#include "model/linux-3.14__complex_emg__linux-kernel-locking-spinlock__drivers-net-wan-lmc-lmc_true-unreach-call.cil.env.c"
