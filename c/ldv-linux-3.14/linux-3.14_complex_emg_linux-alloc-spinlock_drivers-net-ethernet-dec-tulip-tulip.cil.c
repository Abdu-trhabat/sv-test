...
{ 
  ...
  ldv_3_container_struct_work_struct_ptr = ldv_malloc(sizeof(struct work_struct));
  ldv_4_container_struct_work_struct_ptr = ldv_malloc(sizeof(struct work_struct));
  ldv_5_container_struct_work_struct_ptr = ldv_malloc(sizeof(struct work_struct));
  ldv_6_container_struct_work_struct_ptr = ldv_malloc(sizeof(struct work_struct));
  ldv_7_container_struct_work_struct_ptr = ldv_malloc(sizeof(struct work_struct));
...
#include "model/linux-3.14__complex_emg__linux-alloc-spinlock__drivers-net-ethernet-dec-tulip-tulip_true-unreach-call.cil.env.c"
