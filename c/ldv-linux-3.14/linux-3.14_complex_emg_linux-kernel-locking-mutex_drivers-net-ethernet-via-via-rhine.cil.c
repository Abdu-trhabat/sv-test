...
struct net_device {
   ...
   enum ldv_28003 reg_state : 8 ;
   bool dismantle ;
   enum ldv_28004 rtnl_link_state : 16 ;
...
void ldv_mutex_lock_task_lock_of_rhine_private(struct mutex *lock ) ;
void ldv_mutex_unlock_task_lock_of_rhine_private(struct mutex *lock ) ;
...
static int ldv___pci_register_driver_39(struct pci_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
                                        char const   *ldv_func_arg3 ) ;
extern void pci_unregister_driver(struct pci_driver * ) ;
static void ldv_pci_unregister_driver_40(struct pci_driver *ldv_func_arg1 ) ;
...
{ 
  ...
  pci_set_master(pdev);
  dev = ldv_alloc_etherdev_mqs_17(2720, 1U, 1U);
  }
...
{ 
  ...
  {
  {
  ldv_mutex_lock_20(& rp->task_lock);
  rp->task_enable = 0;
  ldv_mutex_unlock_21(& rp->task_lock);
...
{ 
  ...
  {
  {
  ldv_mutex_lock_22(& rp->task_lock);
  rp->task_enable = 1;
  ldv_mutex_unlock_23(& rp->task_lock);
  }
  return;
}
}
...
{ 
  ...
  rp = (struct rhine_private *)tmp;
  ioaddr = rp->base;
  rc = ldv_request_irq_24((rp->pdev)->irq, & rhine_interrupt, 128UL, (char const   *)(& dev->name),
                          (void *)dev);
  }
  if (rc != 0) {
    return (rc);
...
{ 
  ...
  dev = rp->dev;
  ldv_mutex_lock_26(& rp->task_lock);
  }
  if (! rp->task_enable) {
    goto out_unlock;
  } else {
  ...
  out_unlock: 
  {
  ldv_mutex_unlock_27(& rp->task_lock);
  }
  return;
}
}
...
{ 
  ...
  dev = rp->dev;
  ldv_mutex_lock_28(& rp->task_lock);
  }
  if (! rp->task_enable) {
    goto out_unlock;
  } else {
  ...
  out_unlock: 
  {
  ldv_mutex_unlock_29(& rp->task_lock);
  }
  return;
}
}
...
{ 
  ...
  tmp = netdev_priv((struct net_device  const  *)dev);
  rp = (struct rhine_private *)tmp;
  ldv_mutex_lock_30(& rp->task_lock);
  rc = mii_ethtool_gset(& rp->mii_if, cmd);
  ldv_mutex_unlock_31(& rp->task_lock);
  }
  return (rc);
}
}
...
{ 
  ...
  tmp = netdev_priv((struct net_device  const  *)dev);
  rp = (struct rhine_private *)tmp;
  ldv_mutex_lock_32(& rp->task_lock);
  rc = mii_ethtool_sset(& rp->mii_if, cmd);
  rhine_set_carrier(& rp->mii_if);
  ldv_mutex_unlock_33(& rp->task_lock);
  }
  return (rc);
}
}
...
{ 
  ...
  {
  ldv_mutex_lock_34(& rp->task_lock);
  tmp___2 = if_mii(rq);
  rc = generic_mii_ioctl(& rp->mii_if, tmp___2, cmd, (unsigned int *)0U);
  rhine_set_carrier(& rp->mii_if);
  ldv_mutex_unlock_35(& rp->task_lock);
  }
  return (rc);
}
}
...
{ 
  ...
  ldv_free_irq_36((rp->pdev)->irq, (void *)dev);
  free_rbufs(dev);
  free_tbufs(dev);
  free_ring(dev);
  }
...
{ 
  ...
  {
  tmp___0 = ldv___pci_register_driver_39(& rhine_driver, & __this_module, "via_rhine");
  }
  return (tmp___0);
}
}
...
{ 
  ...
  {
  {
  ldv_pci_unregister_driver_40(& rhine_driver);
  }
  return;
}
}
...
{ 
  ...
  {
  {
  ldv_mutex_lock_task_lock_of_rhine_private(ldv_func_arg1);
  }
  return;
}
}
...
{ 
  ...
  {
  {
  ldv_mutex_unlock_task_lock_of_rhine_private(ldv_func_arg1);
  }
  return;
}
}
...
ldv_set LDV_MUTEXES_task_lock_of_rhine_private  ;
void ldv_mutex_lock_task_lock_of_rhine_private(struct mutex *lock ) 
{ 
  ...
  {
  {
  ldv_assert_linux_kernel_locking_mutex__one_thread_double_lock(! LDV_MUTEXES_task_lock_of_rhine_private);
  LDV_MUTEXES_task_lock_of_rhine_private = 1;
  }
  return;
}
}
int ldv_mutex_lock_interruptible_or_killable_task_lock_of_rhine_private(struct mutex *lock ) 
{ 
  int tmp ;
...
int ldv_mutex_is_locked_task_lock_of_rhine_private(struct mutex *lock ) 
{ 
  int tmp ;

  {
  if ((int )LDV_MUTEXES_task_lock_of_rhine_private) {
    return (1);
  } else {
    {
    tmp = ldv_undef_int();
...
int ldv_mutex_trylock_task_lock_of_rhine_private(struct mutex *lock ) 
{ 
  int tmp ;

  {
  {
  ldv_assert_linux_kernel_locking_mutex__one_thread_double_lock_try(! LDV_MUTEXES_task_lock_of_rhine_private);
  tmp = ldv_mutex_is_locked_task_lock_of_rhine_private(lock);
  }
  if (tmp != 0) {
    return (0);
  } else {
...
int ldv_atomic_dec_and_mutex_lock_task_lock_of_rhine_private(atomic_t *cnt , struct mutex *lock ) 
{ 
  ...
  if (cnt->counter != 0) {
    ...
    {
    ldv_mutex_lock_task_lock_of_rhine_private(lock);
    }
    return (1);
  }
}
...
{ 
  ...
  {
  {
  ldv_assert_linux_kernel_locking_mutex__one_thread_double_unlock((int )LDV_MUTEXES_task_lock_of_rhine_private);
  LDV_MUTEXES_task_lock_of_rhine_private = 0;
  }
  return;
}
}
...
{ 
  ...
  ldv_assert_linux_kernel_locking_mutex__one_thread_locked_at_exit(! LDV_MUTEXES_task_lock_of_rhine_private);
  }
  return;
}
}
...
#include "model/linux-3.14__complex_emg__linux-kernel-locking-mutex__drivers-net-ethernet-via-via-rhine_true-unreach-call.cil.env.c"
