...
typedef enum ldv_26695 dmx_output_t;
enum ldv_26697 {
    DMX_IN_FRONTEND = 0,
    DMX_IN_DVR = 1
} ;
typedef enum ldv_26697 dmx_input_t;
enum dmx_ts_pes {
    DMX_PES_AUDIO0 = 0,
    DMX_PES_VIDEO0 = 1,
    DMX_PES_TELETEXT0 = 2,
...
typedef enum ldv_26713 dmx_source_t;
enum dmx_success {
    DMX_OK = 0,
    DMX_LENGTH_ERROR = 1,
    DMX_OVERRUN_ERROR = 2,
...
struct net_device {
   ...
   enum ldv_31188 reg_state : 8 ;
   bool dismantle ;
   enum ldv_31189 rtnl_link_state : 16 ;
...
static int ldv___pci_register_driver_72(struct pci_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
...
__inline static int ldv_request_irq_70(unsigned int irq , irqreturn_t (*handler)(int  ,
                                                                                 void * ) ,
...
{ 
  ...
  {
  err = ldv_request_irq_70(pci_dev->irq, & saa7164_irq, 128UL, (char const   *)(& dev->name),
                           (void *)dev);
  }
  if (err < 0) {
    {
...
{ 
  ...
  ldv_free_irq_71(pci_dev->irq, (void *)dev);
  mutex_lock_nested(& devlist, 0U);
...
{ 
  ...
  saa7164_proc_create();
  tmp = ldv___pci_register_driver_72(& saa7164_pci_driver, & __this_module, "saa7164");
  }
  return (tmp);
}
}
...
{ 
  ...
  ldv_pci_unregister_driver_73(& saa7164_pci_driver);
  }
  return;
}
}
...
static int ldv_dev_set_drvdata_65(struct device *dev , void *data ) ;
__inline static void *kzalloc(size_t size , gfp_t flags ) ;
...
{ 
  ...
  {
  {
  tmp = ldv_dev_get_drvdata_64((struct device  const  *)(& vdev->dev));
  }
  return (tmp);
}
}
...
{ 
  ...
  {
  {
  ldv_dev_set_drvdata_65(& vdev->dev, data);
  }
  return;
}
}
...
static void *ldv_dev_get_drvdata_64___0(struct device  const  *dev ) ;
static int ldv_dev_set_drvdata_65___0(struct device *dev , void *data ) ;
__inline static void *kzalloc(size_t size , gfp_t flags ) ;
...
{ 
  ...
  {
  {
  tmp = ldv_dev_get_drvdata_64___0((struct device  const  *)(& vdev->dev));
  }
  return (tmp);
}
}
...
{ 
  ...
  {
  {
  ldv_dev_set_drvdata_65___0(& vdev->dev, data);
  }
  return;
}
}
...
#include "model/linux-3.14__linux-kernel-locking-spinlock__drivers-media-pci-saa7164-saa7164_true-unreach-call.cil.env.c"
