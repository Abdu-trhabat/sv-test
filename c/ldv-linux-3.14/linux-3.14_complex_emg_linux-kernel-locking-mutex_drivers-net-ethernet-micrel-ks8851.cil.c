...
{ 
  ...
  ldv_2_ldv_param_7_2_default = ldv_malloc(sizeof(unsigned char));
...
#include "model/linux-3.14__complex_emg__linux-kernel-locking-mutex__drivers-net-ethernet-micrel-ks8851_true-unreach-call.cil.env.c"
