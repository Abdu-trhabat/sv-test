...
typedef enum ldv_21624 socket_state;
struct socket_wq {
   wait_queue_head_t wait ;
...
struct net_device {
   ...
   enum ldv_27982 reg_state : 8 ;
   bool dismantle ;
   enum ldv_27983 rtnl_link_state : 16 ;
...
static int ldv_register_netdevice_notifier_21(struct notifier_block *ldv_func_arg1 ) ;
extern int unregister_netdevice_notifier(struct notifier_block * ) ;
static int ldv_unregister_netdevice_notifier_22(struct notifier_block *ldv_func_arg1 ) ;
...
{ 
  ...
  {
  pdev = hw->pdev;
  err = ldv_request_irq_17(pdev->irq, & sky2_intr, (int )hw->flags & 1 ? 0UL : 128UL,
                           name, (void *)hw);
  }
  if (err != 0) {
    {
...
{ 
  ...
  if ((unsigned int )hw->ports == 1U) {
    ...
    ldv_free_irq_18((hw->pdev)->irq, (void *)hw);
...
{ 
  ...
  ldv_mod_timer_19(& hw->watchdog_timer, (unsigned long )jiffies + 1UL);
...
{ 
  ...
  ldv_mod_timer_20(& hw->watchdog_timer, tmp___3);
  }
  return;
}
}
...
{ 
  ...
  {
  sky2_debug = ent;
  ldv_register_netdevice_notifier_21(& sky2_notifier);
  }
  return;
}
}
...
{ 
  ...
  if ((unsigned long )sky2_debug != (unsigned long )((struct dentry *)0)) {
    {
    ldv_unregister_netdevice_notifier_22(& sky2_notifier);
...
{ 
  ...
  {
  {
  tmp = ldv_alloc_etherdev_mqs_23(320, 1U, 1U);
  dev = tmp;
  }
...
{ 
  ...
  err = ldv_request_irq_24(pdev->irq, & sky2_test_intr, 0UL, "sky2", (void *)hw);
  }
  if (err != 0) {
    {
    dev_err((struct device  const  *)(& pdev->dev), "cannot assign irq %d\n", pdev->irq);
  ...
  sky2_write32((struct sky2_hw  const  *)hw, 12U, 0U);
  sky2_read32((struct sky2_hw  const  *)hw, 12U);
  ldv_free_irq_25(pdev->irq, (void *)hw);
  }
  return (err);
}
}
...
{ 
  ...
  if ((unsigned int )hw->ports > 1U) {
    ...
    {
    err = ldv_register_netdev_27(dev1);
    }
    if (err != 0) {
      {
  ...
  {
  ldv_unregister_netdev_28(dev1);
  }
  err_out_free_dev1: 
  {
  ldv_free_netdev_29(dev1);
  }
  err_out_unregister: 
  {
  ldv_unregister_netdev_30(dev);
  }
  err_out_free_netdev: ;
  if ((int )hw->flags & 1) {
    {
...
{ 
  ...
  {
  ldv_del_timer_sync_32(& hw->watchdog_timer);
  ...
  ldv_53203: 
  {
  ldv_unregister_netdev_33(hw->dev[i]);
  i = i - 1;
  }
  ldv_53204: ;
  if (i >= 0) {
  ...
  if ((unsigned int )hw->ports > 1U) {
    {
    napi_disable(& hw->napi);
    ldv_free_irq_34(pdev->irq, (void *)hw);
    }
  } else {
...
{ 
  ...
  {
  ldv_del_timer_sync_36(& hw->watchdog_timer);
  cancel_work_sync(& hw->restart_work);
  rtnl_lock();
  sky2_all_down(hw);
  i = 0;
...
{ 
  ...
  sky2_debug_init();
  tmp = ldv___pci_register_driver_37(& sky2_driver, & __this_module, "sky2");
  }
  return (tmp);
}
}
...
{ 
  ...
  {
  {
  ldv_pci_unregister_driver_38(& sky2_driver);
  sky2_debug_cleanup();
  }
  return;
}
...
#include "model/linux-3.14__complex_emg__linux-kernel-locking-mutex__drivers-net-ethernet-marvell-sky2_true-unreach-call.cil.env.c"
