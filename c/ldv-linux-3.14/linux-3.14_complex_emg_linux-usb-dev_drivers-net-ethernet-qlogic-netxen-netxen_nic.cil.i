...
static int ldv_register_netdevice_notifier_32(struct notifier_block *ldv_func_arg1 ) ;
extern int unregister_netdevice_notifier(struct notifier_block * ) ;
static int ldv_unregister_netdevice_notifier_37(struct notifier_block *ldv_func_arg1 ) ;
...
static int ldv_register_inetaddr_notifier_33(struct notifier_block *ldv_func_arg1 ) ;
extern int unregister_inetaddr_notifier(struct notifier_block * ) ;
static int ldv_unregister_inetaddr_notifier_36(struct notifier_block *ldv_func_arg1 ) ;
...
static int netxen_nic_request_irq(struct netxen_adapter *adapter )
{
  ...
  err = ldv_request_irq_18((unsigned int )sds_ring->irq, handler, flags, (char const *)(& sds_ring->name),
                           (void *)sds_ring);
  }
  if (err != 0) {
    return (err);
...
static void netxen_nic_free_irq(struct netxen_adapter *adapter )
{
  ...
  {
  sds_ring = recv_ctx->sds_rings + (unsigned long )ring;
  ldv_free_irq_19((unsigned int )sds_ring->irq, (void *)sds_ring);
  ring = ring + 1;
  }
  ldv_50895: ;
  if (ring < (int )adapter->max_sds_rings) {
...
static int netxen_nic_probe(struct pci_dev *pdev , struct pci_device_id const *ent )
{
  ...
  {
  pci_set_master(pdev);
  netdev = ldv_alloc_etherdev_mqs_21(1168, 1U, 1U);
  }
                                      ...
                                      char *buf , loff_t offset , size_t size )
{
  ...
  __mptr = (struct kobject const *)kobj;
  dev = (struct device *)__mptr + 0xfffffffffffffff0UL;
  tmp = ldv_dev_get_drvdata_31((struct device const *)dev);
  adapter = (struct netxen_adapter *)tmp;
  netdev = adapter->netdev;
  }
  if (size != 8UL) {
...
static int netxen_init_module(void)
{
  ...
  ldv_register_netdevice_notifier_32(& netxen_netdev_cb);
  ldv_register_inetaddr_notifier_33(& netxen_inetaddr_cb);
  tmp = ldv___pci_register_driver_34(& netxen_driver, & __this_module, "netxen_nic");
  }
  return (tmp);
}
}
static void netxen_exit_module(void)
{
  {
  {
  ldv_pci_unregister_driver_35(& netxen_driver);
  ldv_unregister_inetaddr_notifier_36(& netxen_inetaddr_cb);
  ldv_unregister_netdevice_notifier_37(& netxen_netdev_cb);
  }
  return;
}
}
...
void ldv_allocate_external_0(void)
{
  ...
  ldv_1_container_struct_ethtool_dump_ptr = ldv_malloc(sizeof(struct ethtool_dump));
  ...
  ldv_1_ldv_param_10_2_default = ldv_malloc(sizeof(unsigned char));
  ldv_1_ldv_param_14_2_default = ldv_malloc(sizeof(unsigned long long));
  ldv_1_ldv_param_26_2_default = ldv_malloc(sizeof(unsigned char));
  ldv_1_ldv_param_46_2_default = ldv_malloc(sizeof(unsigned long long));
  ldv_2_resource_dev = ldv_malloc(sizeof(struct pci_dev));
  ldv_3_container_struct_device_ptr = ldv_malloc(sizeof(struct device));
  ldv_3_container_struct_file_ptr = ldv_malloc(sizeof(struct file));
  ldv_3_container_struct_kobject_ptr = ldv_malloc(sizeof(struct kobject));
  ldv_3_ldv_param_12_2_default = ldv_malloc(sizeof(char));
  ldv_3_ldv_param_15_3_default = ldv_malloc(sizeof(char));
  ldv_3_ldv_param_3_3_default = ldv_malloc(sizeof(char));
  ...
  ldv_4_callback_write = (long (*)(struct file * , struct kobject * , struct bin_attribute * ,
                                   char * , long long , unsigned long ))0;
  ...
  ldv_4_container_struct_kobject_ptr = ldv_malloc(sizeof(struct kobject));
  ldv_4_ldv_param_12_2_default = ldv_malloc(sizeof(char));
  ldv_4_ldv_param_15_3_default = ldv_malloc(sizeof(char));
  ldv_4_ldv_param_3_3_default = ldv_malloc(sizeof(char));
  ldv_4_ldv_param_9_2_default = ldv_malloc(sizeof(char));
  ldv_5_container_struct_device_ptr = ldv_malloc(sizeof(struct device));
  ldv_5_container_struct_file_ptr = ldv_malloc(sizeof(struct file));
  ldv_5_container_struct_kobject_ptr = ldv_malloc(sizeof(struct kobject));
  ldv_5_ldv_param_12_2_default = ldv_malloc(sizeof(char));
  ldv_5_ldv_param_15_3_default = ldv_malloc(sizeof(char));
  ldv_5_ldv_param_3_3_default = ldv_malloc(sizeof(char));
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-usb-dev_drivers-net-ethernet-qlogic-netxen-netxen_nic.cil.c", 30070, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_usb_dev__less_initial_decrement(int expr )
{
  {
  if (! expr) {
