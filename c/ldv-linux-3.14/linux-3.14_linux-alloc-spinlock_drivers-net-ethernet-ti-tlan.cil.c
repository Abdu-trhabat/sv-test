...
struct net_device {
   ...
   enum ldv_28407 reg_state : 8 ;
   bool dismantle ;
   enum ldv_28408 rtnl_link_state : 16 ;
...
static int ldv___pci_register_driver_92(struct pci_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
...
__inline static int ldv_request_irq_100(unsigned int irq , irqreturn_t (*handler)(int  ,
                                                                                  void * ) ,
...
{ 
  ...
  if (((unsigned long )tmp___0 & 983040UL) == 0UL) {
    {
    ldv___ldv_spin_lock_85(& priv->lock);
    }
  } else {
  ...
  if ((unsigned long )priv->timer.function != (unsigned long )((void (*)(unsigned long  ))0) && priv->timer_type != 2U) {
    ...
    if (((unsigned long )tmp___1 & 983040UL) == 0UL) {
      {
      ldv_spin_unlock_irqrestore_86(& priv->lock, flags);
      }
    } else {
  ...
  ldv_mod_timer_88(& priv->timer, (unsigned long )jiffies + (unsigned long )ticks);
  }
  return;
}
}
...
{ 
  ...
  if ((unsigned long )priv->timer.function != (unsigned long )((void (*)(unsigned long  ))0)) {
    {
    ldv_del_timer_sync_91(& priv->timer);
...
{ 
  ...
  {
  rc = ldv___pci_register_driver_92(& tlan_driver, & __this_module, "tlan");
  }
  if (rc != 0) {
    {
  ...
  err_out_pci_unreg: 
  {
  ldv_pci_unregister_driver_93(& tlan_driver);
  }
  err_out_pci_free: ;
  return (rc);
}
...
{ 
  ...
  {
  dev = ldv_alloc_etherdev_mqs_94(512, 1U, 1U);
  }
...
{ 
  ...
  {
  {
  ldv_pci_unregister_driver_99(& tlan_driver);
  }
  if (tlan_have_eisa != 0) {
    {
    tlan_eisa_cleanup();
...
{ 
  ...
  err = ldv_request_irq_100((unsigned int )dev->irq, & tlan_handle_interrupt, 128UL,
...
{ 
  ...
  tlan_stop(dev);
  ldv_free_irq_105((unsigned int )dev->irq, (void *)dev);
  tlan_free_lists(dev);
  }
  if (debug & 1) {
    {
...
{ 
  ...
  flags = 0UL;
  ret = 0;
  ldv___ldv_spin_lock_113(& priv->lock);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock", ldv_spin_lock_of_tlan_priv == 1);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double unlock", ldv_spin_lock_of_tlan_priv == 2);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock try", ldv_spin_lock_of_tlan_priv == 1);
  ldv_assume(ldv_spin_lock_of_tlan_priv == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
{ 
  ...
  ldv_assert("linux:kernel:locking:spinlock::one thread:locked at exit", ldv_spin_lock_of_tlan_priv == 1);
