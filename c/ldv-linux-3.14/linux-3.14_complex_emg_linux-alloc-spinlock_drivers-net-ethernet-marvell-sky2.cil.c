...
typedef enum ldv_22068 socket_state;
struct socket_wq {
   wait_queue_head_t wait ;
...
struct net_device {
   ...
   enum ldv_28518 reg_state : 8 ;
   bool dismantle ;
   enum ldv_28519 rtnl_link_state : 16 ;
...
static int ldv_del_timer_sync_135(struct timer_list *ldv_func_arg1 ) ;
static int ldv_del_timer_sync_139(struct timer_list *ldv_func_arg1 ) ;
...
static int ldv_register_netdevice_notifier_124(struct notifier_block *ldv_func_arg1 ) ;
extern int unregister_netdevice_notifier(struct notifier_block * ) ;
static int ldv_unregister_netdevice_notifier_125(struct notifier_block *ldv_func_arg1 ) ;
...
static int ldv_register_netdev_130(struct net_device *ldv_func_arg1 ) ;
...
static struct net_device *ldv_alloc_etherdev_mqs_126(int ldv_func_arg1 , unsigned int ldv_func_arg2 ,
...
{ 
  ...
  {
  {
  ldv_spin_lock_bh_103(& sky2->phy_lock);
  sky2_phy_init(sky2->hw, sky2->port);
  sky2_enable_rx_tx(sky2);
  ldv_spin_unlock_bh_104(& sky2->phy_lock);
  }
  return;
}
}
...
{ 
  ...
  skb = ldv___netdev_alloc_skb_113(sky2->netdev, (unsigned int )sky2->rx_data_size + tmp,
                                   gfp);
  }
...
{ 
  ...
  {
  pdev = hw->pdev;
  err = ldv_request_irq_114(pdev->irq, & sky2_intr, (int )hw->flags & 1 ? 0UL : 128UL,
                            name, (void *)hw);
  }
  if (err != 0) {
    {
...
{ 
  ...
  if ((unsigned int )hw->ports == 1U) {
    ...
    ldv_free_irq_117((hw->pdev)->irq, (void *)hw);
...
{ 
  ...
  ldv_mod_timer_118(& hw->watchdog_timer, (unsigned long )jiffies + 1UL);
...
{ 
  ...
  {
  ldv_spin_lock_119(& sky2->phy_lock);
  ...
  out: 
  {
  ldv_spin_unlock_120(& sky2->phy_lock);
  }
  return;
}
}
...
{ 
  ...
  ldv_mod_timer_121(& hw->watchdog_timer, tmp___3);
  }
  return;
}
}
...
{ 
  ...
  {
  sky2_debug = ent;
  ldv_register_netdevice_notifier_124(& sky2_notifier);
  }
  return;
}
}
...
{ 
  ...
  if ((unsigned long )sky2_debug != (unsigned long )((struct dentry *)0)) {
    {
    ldv_unregister_netdevice_notifier_125(& sky2_notifier);
...
{ 
  ...
  {
  {
  tmp = ldv_alloc_etherdev_mqs_126(320, 1U, 1U);
  dev = tmp;
  }
...
{ 
  ...
  err = ldv_request_irq_127(pdev->irq, & sky2_test_intr, 0UL, "sky2", (void *)hw);
  }
  if (err != 0) {
    {
    dev_err((struct device  const  *)(& pdev->dev), "cannot assign irq %d\n", pdev->irq);
  ...
  sky2_write32((struct sky2_hw  const  *)hw, 12U, 0U);
  sky2_read32((struct sky2_hw  const  *)hw, 12U);
  ldv_free_irq_128(pdev->irq, (void *)hw);
  }
  return (err);
}
}
...
{ 
  ...
  err = ldv_register_netdev_129(dev);
  }
  if (err != 0) {
    {
  ...
  if ((unsigned int )hw->ports > 1U) {
    ...
    {
    err = ldv_register_netdev_130(dev1);
    }
    if (err != 0) {
      {
  ...
  {
  ldv_unregister_netdev_131(dev1);
  }
  err_out_free_dev1: 
  {
  ldv_free_netdev_132(dev1);
  }
  err_out_unregister: 
  {
...
{ 
  ...
  {
  ldv_del_timer_sync_135(& hw->watchdog_timer);
  ...
  ldv_54007: 
  {
  ldv_unregister_netdev_136(hw->dev[i]);
  i = i - 1;
  }
  ldv_54008: ;
  if (i >= 0) {
  ...
  if ((unsigned int )hw->ports > 1U) {
    {
    napi_disable(& hw->napi);
    ldv_free_irq_137(pdev->irq, (void *)hw);
    }
  } else {
...
{ 
  ...
  {
  ldv_del_timer_sync_139(& hw->watchdog_timer);
  cancel_work_sync(& hw->restart_work);
  rtnl_lock();
  sky2_all_down(hw);
  i = 0;
...
{ 
  ...
  sky2_debug_init();
  tmp = ldv___pci_register_driver_140(& sky2_driver, & __this_module, "sky2");
  }
  return (tmp);
}
}
...
{ 
  ...
  {
  {
  ldv_pci_unregister_driver_141(& sky2_driver);
  sky2_debug_cleanup();
  }
  return;
}
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock", ldv_spin_phy_lock_of_sky2_port == 1);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double unlock", ldv_spin_phy_lock_of_sky2_port == 2);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock try", ldv_spin_phy_lock_of_sky2_port == 1);
  ldv_assume(ldv_spin_phy_lock_of_sky2_port == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
{ 
  ...
  ldv_assert("linux:kernel:locking:spinlock::one thread:locked at exit", ldv_spin_phy_lock_of_sky2_port == 1);
...
#include "model/linux-3.14__complex_emg__linux-alloc-spinlock__drivers-net-ethernet-marvell-sky2_true-unreach-call.cil.env.c"
