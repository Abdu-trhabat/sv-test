...
{ 
  ...
  ldv_1_ldv_param_5_1_default = ldv_malloc(sizeof(char));
  ldv_1_ldv_param_5_3_default = ldv_malloc(sizeof(long long));
  ...
  ldv_2_ldv_param_5_1_default = ldv_malloc(sizeof(char));
  ldv_2_ldv_param_5_3_default = ldv_malloc(sizeof(long long));
  ...
  ldv_3_ldv_param_5_1_default = ldv_malloc(sizeof(char));
  ldv_3_ldv_param_5_3_default = ldv_malloc(sizeof(long long));
...
#include "model/linux-3.14__complex_emg__linux-alloc-spinlock__drivers-net-ethernet-mellanox-mlx5-core-mlx5_core_true-unreach-call.cil.env.c"
