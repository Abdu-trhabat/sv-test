...
void ldv_allocate_external_0(void)
{
  ...
  ldv_0_container_struct_usb_data_stream_properties_ptr = ldv_malloc(sizeof(struct usb_data_stream_properties));
  ldv_0_ldv_param_8_1_default = ldv_malloc(sizeof(unsigned char));
  ...
  ldv_1_container_struct_usb_data_stream_properties_ptr = ldv_malloc(sizeof(struct usb_data_stream_properties));
  ldv_1_ldv_param_8_1_default = ldv_malloc(sizeof(unsigned char));
  ...
  ldv_2_container_struct_usb_data_stream_properties_ptr = ldv_malloc(sizeof(struct usb_data_stream_properties));
  ldv_2_ldv_param_8_1_default = ldv_malloc(sizeof(unsigned char));
  ldv_3_container_struct_dvb_frontend_ptr = ldv_malloc(sizeof(struct dvb_frontend));
  ...
  ldv_3_container_struct_usb_data_stream_properties_ptr = ldv_malloc(sizeof(struct usb_data_stream_properties));
  ldv_3_ldv_param_8_1_default = ldv_malloc(sizeof(unsigned char));
  ldv_4_container_struct_dvb_frontend_ptr = ldv_malloc(sizeof(struct dvb_frontend));
  ...
  ldv_4_container_struct_usb_data_stream_properties_ptr = ldv_malloc(sizeof(struct usb_data_stream_properties));
  ldv_4_ldv_param_8_1_default = ldv_malloc(sizeof(unsigned char));
  ...
  ldv_5_container_struct_usb_data_stream_properties_ptr = ldv_malloc(sizeof(struct usb_data_stream_properties));
  ldv_5_ldv_param_8_1_default = ldv_malloc(sizeof(unsigned char));
  ldv_6_container_struct_dvb_frontend_ptr = ldv_malloc(sizeof(struct dvb_frontend));
  ldv_6_container_struct_mxl111sf_reg_ctrl_info_ptr = ldv_malloc(sizeof(struct mxl111sf_reg_ctrl_info));
  ldv_6_container_struct_mxl111sf_state_ptr = ldv_malloc(sizeof(struct mxl111sf_state));
  ldv_6_ldv_param_8_2_default = ldv_malloc(sizeof(unsigned char));
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-drivers-clk1_drivers-media-usb-dvb-usb-v2-dvb-usb-mxl111sf.cil.c", 17294, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_drivers_clk1__more_at_exit(int expr )
{
  {
  if (! expr) {
