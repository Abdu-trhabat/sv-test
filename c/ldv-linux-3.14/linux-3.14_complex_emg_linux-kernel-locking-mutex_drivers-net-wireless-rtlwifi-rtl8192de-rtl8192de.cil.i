...
static int ldv___pci_register_driver_19(struct pci_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
                                        char const *ldv_func_arg3 ) ;
extern void pci_unregister_driver(struct pci_driver * ) ;
static void ldv_pci_unregister_driver_20(struct pci_driver *ldv_func_arg1 ) ;
...
static int rtl92de_module_init(void)
{
  ...
  ret = ldv___pci_register_driver_19(& rtl92de_driver, & __this_module, "rtl8192de");
  }
  if (ret != 0) {
    {
...
static void rtl92de_module_exit(void)
{
  {
  {
  ldv_pci_unregister_driver_20(& rtl92de_driver);
  }
  return;
}
}
...
void ldv_allocate_external_0(void)
{
  ...
  ldv_0_ldv_param_22_1_default = ldv_malloc(sizeof(unsigned char));
  ldv_0_ldv_param_25_2_default = ldv_malloc(sizeof(unsigned char));
  ldv_0_ldv_param_31_0_default = ldv_malloc(sizeof(unsigned char));
  ldv_0_ldv_param_34_2_default = ldv_malloc(sizeof(unsigned char));
  ldv_0_ldv_param_46_1_default = ldv_malloc(sizeof(unsigned int));
  ldv_0_ldv_param_46_2_default = ldv_malloc(sizeof(unsigned int));
  ldv_0_ldv_param_51_3_default = ldv_malloc(sizeof(unsigned char));
  ldv_0_ldv_param_54_1_default = ldv_malloc(sizeof(unsigned char));
  ldv_0_ldv_param_71_0_default = ldv_malloc(sizeof(unsigned char));
  ldv_0_ldv_param_71_3_default = ldv_malloc(sizeof(unsigned char));
  ldv_0_ldv_param_74_2_default = ldv_malloc(sizeof(unsigned char));
  ldv_0_ldv_param_77_2_default = ldv_malloc(sizeof(unsigned char));
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-kernel-locking-mutex_drivers-net-wireless-rtlwifi-rtl8192de-rtl8192de.cil.c", 37095, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_kernel_locking_mutex__one_thread_double_lock(int expr )
{
  {
  if (! expr) {
