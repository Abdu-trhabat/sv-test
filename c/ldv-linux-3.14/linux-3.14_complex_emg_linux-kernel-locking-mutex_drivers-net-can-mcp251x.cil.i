...
void ldv_mutex_lock_mcp_lock_of_mcp251x_priv(struct mutex *lock ) ;
void ldv_mutex_unlock_mcp_lock_of_mcp251x_priv(struct mutex *lock ) ;
...
extern int request_threaded_irq(unsigned int , irqreturn_t (*)(int , void * ) ,
                                ...
                                char const * , void * ) ;
static int ldv_request_threaded_irq_31(unsigned int ldv_func_arg1 , irqreturn_t (*ldv_func_arg2)(int ,
                                                                                                 void * ) ,
...
static int ldv_register_candev_33(struct net_device *ldv_func_arg1 ) ;
extern void unregister_candev(struct net_device * ) ;
static void ldv_unregister_candev_34(struct net_device *ldv_func_arg1 ) ;
...
static int ldv_spi_register_driver_35(struct spi_driver *ldv_func_arg1 ) ;
...
__inline static void ldv_spi_unregister_driver_36(struct spi_driver *sdrv ) ;
...
static void mcp251x_open_clean(struct net_device *net )
{
  ...
  priv = (struct mcp251x_priv *)tmp;
  spi = priv->spi;
  ldv_free_irq_20((unsigned int )spi->irq, (void *)priv);
...
static int mcp251x_stop(struct net_device *net )
{
  ...
  ldv_mutex_lock_22(& priv->mcp_lock);
  ...
  mcp251x_power_enable(priv->transceiver, 0);
  priv->can.state = 4;
  ldv_mutex_unlock_23(& priv->mcp_lock);
  can_led_event(net, 1);
  }
  return (0);
}
...
static void mcp251x_tx_work_handler(struct work_struct *ws )
{
  ...
  spi = priv->spi;
  net = priv->net;
  ldv_mutex_lock_24(& priv->mcp_lock);
  }
  if ((unsigned long )priv->tx_skb != (unsigned long )((struct sk_buff *)0)) {
  ...
  {
  ldv_mutex_unlock_25(& priv->mcp_lock);
  }
  return;
}
}
static void mcp251x_restart_work_handler(struct work_struct *ws )
{
  ...
  spi = priv->spi;
  net = priv->net;
  ldv_mutex_lock_26(& priv->mcp_lock);
  }
  ...
  {
  ldv_mutex_unlock_27(& priv->mcp_lock);
  }
  return;
}
}
static irqreturn_t mcp251x_can_ist(int irq , void *dev_id )
{
  ...
  spi = priv->spi;
  net = priv->net;
  ldv_mutex_lock_28(& priv->mcp_lock);
  }
  goto ldv_43244;
  ldv_43243:
  {
  ...
  ldv_43242:
  {
  ldv_mutex_unlock_29(& priv->mcp_lock);
  }
  return (1);
}
}
static int mcp251x_open(struct net_device *net )
{
  ...
  {
  ldv_mutex_lock_30(& priv->mcp_lock);
  mcp251x_power_enable(priv->transceiver, 1);
  priv->force_quit = 0;
  priv->tx_skb = (struct sk_buff *)0;
  priv->tx_len = 0;
  ret = ldv_request_threaded_irq_31((unsigned int )spi->irq, (irqreturn_t (*)(int ,
                                                                              void * ))0,
  ...
  open_unlock:
  {
  ldv_mutex_unlock_32(& priv->mcp_lock);
  }
  return (ret);
}
}
...
static int mcp251x_can_probe(struct spi_device *spi )
{
  ...
  {
  mcp251x_hw_sleep(spi);
  ret = ldv_register_candev_33(net);
  }
  if (ret != 0) {
    goto error_probe;
  } else {
...
static int mcp251x_can_driver_init(void)
{
  ...
  {
  {
  tmp = ldv_spi_register_driver_35(& mcp251x_can_driver);
  }
  return (tmp);
}
}
static void mcp251x_can_driver_exit(void)
{
  {
  {
  ldv_spi_unregister_driver_36(& mcp251x_can_driver);
  }
  return;
}
}
...
static void ldv_mutex_lock_22(struct mutex *ldv_func_arg1 )
{
  {
  {
  ldv_mutex_lock_mcp_lock_of_mcp251x_priv(ldv_func_arg1);
  }
  return;
}
}
static void ldv_mutex_unlock_23(struct mutex *ldv_func_arg1 )
{
  {
  {
  ldv_mutex_unlock_mcp_lock_of_mcp251x_priv(ldv_func_arg1);
  }
  return;
}
}
...
ldv_set LDV_MUTEXES_mcp_lock_of_mcp251x_priv ;
void ldv_mutex_lock_mcp_lock_of_mcp251x_priv(struct mutex *lock )
{
  {
  {
  ldv_assert_linux_kernel_locking_mutex__one_thread_double_lock(! LDV_MUTEXES_mcp_lock_of_mcp251x_priv);
  LDV_MUTEXES_mcp_lock_of_mcp251x_priv = 1;
  }
  return;
}
}
int ldv_mutex_lock_interruptible_or_killable_mcp_lock_of_mcp251x_priv(struct mutex *lock )
{
  int tmp ;
  {
  {
...
int ldv_mutex_is_locked_mcp_lock_of_mcp251x_priv(struct mutex *lock )
{
  int tmp ;
  {
  if ((int )LDV_MUTEXES_mcp_lock_of_mcp251x_priv) {
    return (1);
  } else {
    {
    tmp = ldv_undef_int();
...
int ldv_mutex_trylock_mcp_lock_of_mcp251x_priv(struct mutex *lock )
{
  int tmp ;
  {
  {
  ldv_assert_linux_kernel_locking_mutex__one_thread_double_lock_try(! LDV_MUTEXES_mcp_lock_of_mcp251x_priv);
  tmp = ldv_mutex_is_locked_mcp_lock_of_mcp251x_priv(lock);
  }
  if (tmp != 0) {
    return (0);
  } else {
...
int ldv_atomic_dec_and_mutex_lock_mcp_lock_of_mcp251x_priv(atomic_t *cnt , struct mutex *lock )
{
  {
  cnt->counter = cnt->counter - 1;
  if (cnt->counter != 0) {
    ...
    {
    ldv_mutex_lock_mcp_lock_of_mcp251x_priv(lock);
    }
    return (1);
  }
}
...
void ldv_mutex_unlock_mcp_lock_of_mcp251x_priv(struct mutex *lock )
{
  {
  {
  ldv_assert_linux_kernel_locking_mutex__one_thread_double_unlock((int )LDV_MUTEXES_mcp_lock_of_mcp251x_priv);
...
void ldv_check_final_state(void)
{
  ...
  ldv_assert_linux_kernel_locking_mutex__one_thread_locked_at_exit(! LDV_MUTEXES_mcp_lock_of_mcp251x_priv);
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-kernel-locking-mutex_drivers-net-can-mcp251x.cil.c", 11334, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_kernel_locking_mutex__one_thread_double_lock(int expr )
{
  {
  if (! expr) {
