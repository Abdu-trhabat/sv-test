...
typedef enum ldv_21649 socket_state;
struct socket_wq {
   wait_queue_head_t wait ;
...
struct net_device {
   ...
   enum ldv_28007 reg_state : 8 ;
   bool dismantle ;
   enum ldv_28008 rtnl_link_state : 16 ;
...
static int ldv_ldv_post_probe_42(int ldv_func_arg1 ) ;
...
static int ldv_register_netdevice_notifier_24(struct notifier_block *ldv_func_arg1 ) ;
extern int unregister_netdevice_notifier(struct notifier_block * ) ;
static int ldv_unregister_netdevice_notifier_25(struct notifier_block *ldv_func_arg1 ) ;
...
static int ldv___pci_register_driver_40(struct pci_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
                                        char const *ldv_func_arg3 ) ;
extern void pci_unregister_driver(struct pci_driver * ) ;
static void ldv_pci_unregister_driver_41(struct pci_driver *ldv_func_arg1 ) ;
...
static int sky2_setup_irq(struct sky2_hw *hw , char const *name )
{
  ...
  {
  pdev = hw->pdev;
  err = ldv_request_irq_20(pdev->irq, & sky2_intr, (int )hw->flags & 1 ? 0UL : 128UL,
                           name, (void *)hw);
  }
  if (err != 0) {
    {
...
static int sky2_close(struct net_device *dev )
{
  ...
  if ((unsigned int )hw->ports == 1U) {
    ...
    ldv_free_irq_21((hw->pdev)->irq, (void *)hw);
...
static void sky2_link_up(struct sky2_port *sky2 )
{
  ...
  ldv_mod_timer_22(& hw->watchdog_timer, (unsigned long )jiffies + 1UL);
...
static void sky2_watchdog(unsigned long arg )
{
  ...
  ldv_mod_timer_23(& hw->watchdog_timer, tmp___3);
  }
  return;
}
}
...
static void sky2_debug_init(void)
{
  ...
  {
  sky2_debug = ent;
  ldv_register_netdevice_notifier_24(& sky2_notifier);
  }
  return;
}
}
static void sky2_debug_cleanup(void)
{
  ...
  if ((unsigned long )sky2_debug != (unsigned long )((struct dentry *)0)) {
    {
    ldv_unregister_netdevice_notifier_25(& sky2_notifier);
                                           ...
                                           int highmem , int wol )
{
  ...
  {
  {
  tmp = ldv_alloc_etherdev_mqs_26(320, 1U, 1U);
  dev = tmp;
  }
...
static int sky2_test_msi(struct sky2_hw *hw )
{
  ...
  err = ldv_request_irq_27(pdev->irq, & sky2_test_intr, 0UL, "sky2", (void *)hw);
  }
  if (err != 0) {
    {
    dev_err((struct device const *)(& pdev->dev), "cannot assign irq %d\n", pdev->irq);
  ...
  sky2_write32((struct sky2_hw const *)hw, 12U, 0U);
  sky2_read32((struct sky2_hw const *)hw, 12U);
  ldv_free_irq_28(pdev->irq, (void *)hw);
  }
  return (err);
}
}
...
static int sky2_probe(struct pci_dev *pdev , struct pci_device_id const *ent )
{
  ...
  if ((unsigned int )hw->ports > 1U) {
    ...
    {
    err = ldv_register_netdev_30(dev1);
    }
    if (err != 0) {
      {
  ...
  {
  ldv_unregister_netdev_31(dev1);
  }
  err_out_free_dev1:
  {
  ldv_free_netdev_32(dev1);
  }
  err_out_unregister:
  {
...
static void sky2_remove(struct pci_dev *pdev )
{
  ...
  {
  ldv_del_timer_sync_35(& hw->watchdog_timer);
  ...
  ldv_53223:
  {
  ldv_unregister_netdev_36(hw->dev[i]);
  i = i - 1;
  }
  ldv_53224: ;
  if (i >= 0) {
  ...
  if ((unsigned int )hw->ports > 1U) {
    {
    napi_disable(& hw->napi);
    ldv_free_irq_37(pdev->irq, (void *)hw);
    }
  } else {
  }
  if ((int )hw->flags & 1) {
...
static int sky2_suspend(struct device *dev )
{
  ...
  {
  ldv_del_timer_sync_39(& hw->watchdog_timer);
  cancel_work_sync(& hw->restart_work);
  rtnl_lock();
  sky2_all_down(hw);
  i = 0;
...
static int sky2_init_module(void)
{
  ...
  sky2_debug_init();
  tmp = ldv___pci_register_driver_40(& sky2_driver, & __this_module, "sky2");
  }
  return (tmp);
}
}
static void sky2_cleanup_module(void)
{
  {
  {
  ldv_pci_unregister_driver_41(& sky2_driver);
  sky2_debug_cleanup();
  }
  return;
}
...
void ldv_allocate_external_0(void)
{
  ...
  ldv_3_ldv_param_50_2_default = ldv_malloc(sizeof(unsigned char));
  ...
  ldv_7_ldv_param_3_2_default = ldv_malloc(0UL);
...
void ldv_pci_pci_instance_4(void *arg0 )
{
  ...
  case_17:
  {
  ldv_assume(((((ldv_statevar_1 == 2 || ldv_statevar_1 == 6) || ldv_statevar_2 == 2) || ldv_statevar_2 == 6) || ldv_statevar_3 == 1) || ldv_statevar_3 == 5);
  ldv_pre_probe();
  ...
  ldv_4_ret_default = ldv_ldv_post_probe_42(ldv_4_ret_default);
  tmp___1 = ldv_undef_int();
  }
  if (tmp___1 != 0) {
    ldv_statevar_4 = 14;
...
void ldv_pm_platform_instance_6(void *arg0 )
{
  ...
  {
  ldv_6_probed_default = ldv_ldv_post_probe_43(ldv_6_probed_default);
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-usb-dev_drivers-net-ethernet-marvell-sky2.cil.c", 22901, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_usb_dev__less_initial_decrement(int expr )
{
  {
  if (! expr) {
