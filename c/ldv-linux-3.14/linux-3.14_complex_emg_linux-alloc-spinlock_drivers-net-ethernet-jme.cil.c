...
__inline static void ldv_spin_lock_bh_103(spinlock_t *lock ) ;
__inline static void ldv_spin_lock_bh_105(spinlock_t *lock ) ;
__inline static void ldv_spin_lock_bh_103(spinlock_t *lock ) ;
__inline static void ldv_spin_lock_bh_112(spinlock_t *lock ) ;
__inline static void ldv_spin_lock_bh_105(spinlock_t *lock ) ;
__inline static void ldv_spin_lock_bh_112(spinlock_t *lock ) ;
__inline static void ldv_spin_lock_bh_105(spinlock_t *lock ) ;
__inline static void ldv_spin_lock_bh_105(spinlock_t *lock ) ;
...
__inline static void ldv_spin_unlock_bh_106(spinlock_t *lock ) ;
__inline static void ldv_spin_unlock_bh_104(spinlock_t *lock ) ;
...
static int ldv_pskb_expand_head_109(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 ,
...
static void ldv_free_netdev_130(struct net_device *ldv_func_arg1 ) ;
...
static int ldv_register_netdev_129(struct net_device *ldv_func_arg1 ) ;
...
static int ldv___pci_register_driver_133(struct pci_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
...
static struct net_device *ldv_alloc_etherdev_mqs_128(int ldv_func_arg1 , unsigned int ldv_func_arg2 ,
...
{ 
  ...
  tmp = netdev_priv((struct net_device  const  *)netdev);
  jme = (struct jme_adapter *)tmp;
  ldv_spin_lock_bh_103(& jme->macaddr_lock);
  val = jread32(jme, 56U);
  ...
  ldv_spin_unlock_bh_104(& jme->macaddr_lock);
  }
  return;
}
}
...
{ 
  ...
  {
  {
  ldv_spin_lock_bh_105(& jme->phy_lock);
  tmp = jme_mdio_read(jme->dev, jme->mii_if.phy_id, 0);
  bmcr = (u32 )tmp;
  bmcr = bmcr | 4608U;
  jme_mdio_write(jme->dev, jme->mii_if.phy_id, 0, (int )bmcr);
  ldv_spin_unlock_bh_106(& jme->phy_lock);
  }
  return;
}
}
...
{ 
  ...
  {
  rc = ldv_request_irq_107((jme->pdev)->irq, handler, (unsigned long )irq_flags, (char const   *)(& netdev->name),
                           (void *)netdev);
  }
  if (rc != 0) {
    {
...
{ 
  ...
  {
  {
  ldv_free_irq_108((jme->pdev)->irq, (void *)jme->dev);
...
{ 
  ...
  mc_hash[0] = 0U;
  mc_hash[1] = 0U;
  ldv_spin_lock_bh_112(& jme->rxmcs_lock);
  ...
  ldv_spin_unlock_bh_113(& jme->rxmcs_lock);
  }
  return;
}
}
...
{ 
  ...
  {
  pci_set_master(pdev);
  netdev = ldv_alloc_etherdev_mqs_128(1536, 1U, 1U);
  }
  ...
  netif_carrier_off(netdev);
  rc = ldv_register_netdev_129(netdev);
  }
  if (rc != 0) {
    {
...
{ 
  ...
  ldv_unregister_netdev_131(netdev);
  iounmap((void volatile   *)jme->regs);
...
{ 
  ...
  tmp = ldv___pci_register_driver_133(& jme_driver, & __this_module, "jme");
  }
  return (tmp);
}
}
...
{ 
  ...
  {
  {
  ldv_pci_unregister_driver_134(& jme_driver);
  }
  return;
}
}
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock", ldv_spin_macaddr_lock_of_jme_adapter == 1);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double unlock", ldv_spin_macaddr_lock_of_jme_adapter == 2);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock try", ldv_spin_macaddr_lock_of_jme_adapter == 1);
  ldv_assume(ldv_spin_macaddr_lock_of_jme_adapter == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock", ldv_spin_phy_lock_of_jme_adapter == 1);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double unlock", ldv_spin_phy_lock_of_jme_adapter == 2);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock try", ldv_spin_phy_lock_of_jme_adapter == 1);
  ldv_assume(ldv_spin_phy_lock_of_jme_adapter == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock", ldv_spin_rxmcs_lock_of_jme_adapter == 1);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double unlock", ldv_spin_rxmcs_lock_of_jme_adapter == 2);
...
{ 
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock try", ldv_spin_rxmcs_lock_of_jme_adapter == 1);
  ldv_assume(ldv_spin_rxmcs_lock_of_jme_adapter == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
{ 
  ...
  ldv_assert("linux:kernel:locking:spinlock::one thread:locked at exit", ldv_spin_macaddr_lock_of_jme_adapter == 1);
  ldv_assert("linux:kernel:locking:spinlock::one thread:locked at exit", ldv_spin_node_size_lock_of_pglist_data == 1);
  ldv_assert("linux:kernel:locking:spinlock::one thread:locked at exit", ldv_spin_phy_lock_of_jme_adapter == 1);
  ldv_assert("linux:kernel:locking:spinlock::one thread:locked at exit", ldv_spin_ptl == 1);
  ldv_assert("linux:kernel:locking:spinlock::one thread:locked at exit", ldv_spin_rxmcs_lock_of_jme_adapter == 1);
...
#include "model/linux-3.14__complex_emg__linux-alloc-spinlock__drivers-net-ethernet-jme_true-unreach-call.cil.env.c"
