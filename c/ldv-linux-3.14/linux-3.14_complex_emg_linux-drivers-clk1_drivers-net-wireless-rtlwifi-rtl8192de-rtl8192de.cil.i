...
static int ldv___pci_register_driver_12(struct pci_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
                                        char const *ldv_func_arg3 ) ;
extern void pci_unregister_driver(struct pci_driver * ) ;
static void ldv_pci_unregister_driver_13(struct pci_driver *ldv_func_arg1 ) ;
...
static int rtl92de_module_init(void)
{
  ...
  ret = ldv___pci_register_driver_12(& rtl92de_driver, & __this_module, "rtl8192de");
  }
  if (ret != 0) {
    {
...
static void rtl92de_module_exit(void)
{
  {
  {
  ldv_pci_unregister_driver_13(& rtl92de_driver);
  }
  return;
}
}
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-drivers-clk1_drivers-net-wireless-rtlwifi-rtl8192de-rtl8192de.cil.c", 36824, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_drivers_clk1__more_at_exit(int expr )
{
  {
  if (! expr) {
