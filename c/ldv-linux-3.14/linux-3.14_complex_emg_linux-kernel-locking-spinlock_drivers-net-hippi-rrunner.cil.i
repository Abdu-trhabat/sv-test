...
struct __anonstruct_rraddr_264 {
   u64 addrlo ;
};
typedef struct __anonstruct_rraddr_264 rraddr;
struct tx_desc {
   rraddr addr ;
   u32 res ;
   u16 size ;
...
union __anonunion_s_265 {
   struct rr_stats stats ;
   u32 stati[128U] ;
};
struct rr_info {
   union __anonunion_s_265 s ;
...
void ldv_spin_lock_lock_of_rr_private(void) ;
void ldv_spin_unlock_lock_of_rr_private(void) ;
...
static int ldv___pci_register_driver_103(struct pci_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
...
static int rr_init_one(struct pci_dev *pdev , struct pci_device_id const *ent )
{
  ...
  __raw_spin_lock_init(& rrpriv->lock.__annonCompField19.rlock, "&(&rrpriv->lock)->rlock",
                       & __key);
  ...
  {
  rr_init(dev);
  ret = ldv_register_netdev_77(dev);
  }
  if (ret != 0) {
    goto out;
  } else {
...
static int rr_init1(struct net_device *dev )
{
  ...
  rrpriv = (struct rr_private *)tmp;
  regs = rrpriv->regs;
  ldv___ldv_spin_lock_81(& rrpriv->lock);
  ...
  if ((hostctrl & 1024U) != 0U) {
    ...
    ldv_spin_unlock_irqrestore_82(& rrpriv->lock, flags);
    ecode = -14;
    }
    goto error;
  } else {
...
static u32 rr_handle_event(struct net_device *dev , u32 prodidx , u32 eidx )
{
  ...
  ldv_47018: ;
  {
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 1) {
    goto case_1;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 7) {
    goto case_7;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 8) {
    goto case_8;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 51) {
    goto case_51;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 2) {
    goto case_2;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 9) {
    goto case_9;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 10) {
    goto case_10;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 19) {
    goto case_19;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 20) {
    goto case_20;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 22) {
    goto case_22;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 23) {
    goto case_23;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 24) {
    goto case_24;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 25) {
    goto case_25;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 26) {
    goto case_26;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 27) {
    goto case_27;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 28) {
    goto case_28;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 36) {
    goto case_36;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 43) {
    goto case_43;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 44) {
    goto case_44;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 52) {
    goto case_52;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 46) {
    goto case_46;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 47) {
    goto case_47;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 53) {
    goto case_53;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 60) {
    goto case_60;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 48) {
    goto case_48;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 50) {
    goto case_50;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 49) {
    goto case_49;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 54) {
    goto case_54;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 55) {
    goto case_55;
  } else {
  }
  if ((int )(rrpriv->evt_ring + (unsigned long )eidx)->code == 56) {
    goto case_56;
  } else {
  }
  goto switch_default;
...
static irqreturn_t rr_interrupt(int irq , void *dev_id )
{
  ...
  {
  eidx = eidx | ((txcsmr << 8) | (rxlimit << 16));
  writel(eidx, (void volatile *)(& regs->EvtCon));
  __asm__ volatile ("sfence": : : "memory");
  ldv_spin_unlock_85(& rrpriv->lock);
  }
  return (1);
}
}
...
static void rr_timer(unsigned long data )
{
  ...
  if ((tmp___2 & 256U) != 0U) {
    ...
    if (tmp___1 != 0) {
      {
      ldv___ldv_spin_lock_86(& rrpriv->lock);
      tmp___0 = readl((void const volatile *)(& regs->HostCtrl));
...
static int rr_open(struct net_device *dev )
{
  ...
  memset((void *)rrpriv->info, 0, 4096UL);
  __asm__ volatile ("sfence": : : "memory");
  ldv___ldv_spin_lock_88(& rrpriv->lock);
  tmp___2 = readl((void const volatile *)(& regs->HostCtrl));
  writel(tmp___2 | 18U, (void volatile *)(& regs->HostCtrl));
  readl((void const volatile *)(& regs->HostCtrl));
  ldv_spin_unlock_irqrestore_82(& rrpriv->lock, flags);
  tmp___3 = ldv_request_irq_90(pdev->irq, & rr_interrupt, 128UL, (char const *)(& dev->name),
                               (void *)dev);
  }
  if (tmp___3 != 0) {
    {
  ...
  {
  init_timer_key(& rrpriv->timer, 0U, "(&rrpriv->timer)", & __key);
  rrpriv->timer.expires = (unsigned long )jiffies + 1250UL;
  ...
  error:
  {
  ldv___ldv_spin_lock_91(& rrpriv->lock);
  tmp___4 = readl((void const volatile *)(& regs->HostCtrl));
  writel(tmp___4 | 18U, (void volatile *)(& regs->HostCtrl));
  ldv_spin_unlock_irqrestore_82(& rrpriv->lock, flags);
  }
...
static int rr_close(struct net_device *dev )
{
  ...
  pdev = rrpriv->pci_dev;
  netif_stop_queue(dev);
  ldv___ldv_spin_lock_93(& rrpriv->lock);
  tmp___0 = readl((void const volatile *)(& regs->HostCtrl));
  }
  if ((tmp___0 & 256U) != 0U) {
    {
  ...
  {
  rrpriv->fw_running = 0;
  ldv_del_timer_sync_94(& rrpriv->timer);
  writel(0U, (void volatile *)(& regs->TxPi));
  writel(0U, (void volatile *)(& regs->IpRxPi));
  writel(0U, (void volatile *)(& regs->EvtCon));
  writel(0U, (void volatile *)(& regs->EvtPrd));
  ...
  pci_free_consistent(pdev, 4096UL, (void *)rrpriv->info, rrpriv->info_dma);
  rrpriv->info = (struct rr_info *)0;
  ldv_free_irq_95(pdev->irq, (void *)dev);
  ldv_spin_unlock_irqrestore_82(& rrpriv->lock, flags);
  }
  return (0);
}
...
static netdev_tx_t rr_start_xmit(struct sk_buff *skb , struct net_device *dev )
{
  ...
  *(ifield + 1UL) = hcb->ifield;
  ldv___ldv_spin_lock_97(& rrpriv->lock);
...
static int rr_load_firmware(struct net_device *dev )
{
  ...
  if (eptr < (size_t )p2size || eptr > (size_t )(p2size + p2len)) {
    {
...
static int rr_ioctl(struct net_device *dev , struct ifreq *rq , int cmd )
{
  ...
  {
  ldv___ldv_spin_lock_99(& rrpriv->lock);
  ...
  ldv___ldv_spin_lock_101(& rrpriv->lock);
...
static int rr_driver_init(void)
{
  ...
  {
  {
  tmp = ldv___pci_register_driver_103(& rr_driver, & __this_module, "rrunner");
  }
  return (tmp);
}
}
static void rr_driver_exit(void)
{
  {
  {
  ldv_pci_unregister_driver_104(& rr_driver);
  }
  return;
}
}
void ldv_EMGentry_exit_rr_driver_exit_13_2(void (*arg0)(void) ) ;
int ldv_EMGentry_init_rr_driver_init_13_9(int (*arg0)(void) ) ;
...
void (*ldv_13_exit_rr_driver_exit_default)(void) ;
int (*ldv_13_init_rr_driver_init_default)(void) ;
...
int ldv_statevar_3 ;
int ldv_statevar_4 ;
enum irqreturn (*ldv_0_callback_handler)(int , void * ) = & rr_interrupt;
void (*ldv_13_exit_rr_driver_exit_default)(void) = & rr_driver_exit;
int (*ldv_13_init_rr_driver_init_default)(void) = & rr_driver_init;
int (*ldv_1_callback_ndo_change_mtu)(struct net_device * , int ) = & hippi_change_mtu;
int (*ldv_1_callback_ndo_do_ioctl)(struct net_device * , struct ifreq * , int ) = & rr_ioctl;
int (*ldv_1_callback_ndo_set_mac_address)(struct net_device * , void * ) = & hippi_mac_addr;
enum netdev_tx (*ldv_1_callback_ndo_start_xmit)(struct sk_buff * , struct net_device * ) = & rr_start_xmit;
void ldv_EMGentry_exit_rr_driver_exit_13_2(void (*arg0)(void) )
{
  {
  {
...
void ldv_entry_EMGentry_13(void *arg0 )
{
  ...
  ldv_EMGentry_exit_rr_driver_exit_13_2(ldv_13_exit_rr_driver_exit_default);
  ...
  {
  ldv_assume(ldv_statevar_2 == 20);
  ldv_13_ret_default = ldv_EMGentry_init_rr_driver_init_13_9(ldv_13_init_rr_driver_init_default);
                                ...
                                struct pci_dev *arg1 , struct pci_device_id *arg2 )
{
  ...
  {
  {
  tmp = rr_init_one(arg1, (struct pci_device_id const *)arg2);
  }
  return (tmp);
}
}
...
static void ldv___ldv_spin_lock_81(spinlock_t *ldv_func_arg1 )
{
  {
  {
  ldv_spin_lock_lock_of_rr_private();
...
__inline static void ldv_spin_unlock_irqrestore_82(spinlock_t *lock , unsigned long flags )
{
  {
  {
  ldv_spin_unlock_lock_of_rr_private();
...
static int ldv_spin_lock_of_rr_private = 1;
void ldv_spin_lock_lock_of_rr_private(void)
{
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock(ldv_spin_lock_of_rr_private == 1);
  ldv_assume(ldv_spin_lock_of_rr_private == 1);
  ldv_spin_lock_of_rr_private = 2;
  }
  return;
}
}
void ldv_spin_unlock_lock_of_rr_private(void)
{
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_unlock(ldv_spin_lock_of_rr_private == 2);
  ldv_assume(ldv_spin_lock_of_rr_private == 2);
  ldv_spin_lock_of_rr_private = 1;
  }
  return;
}
}
int ldv_spin_trylock_lock_of_rr_private(void)
{
  int is_spin_held_by_another_thread ;
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock_try(ldv_spin_lock_of_rr_private == 1);
  ldv_assume(ldv_spin_lock_of_rr_private == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
void ldv_spin_unlock_wait_lock_of_rr_private(void)
{
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock_try(ldv_spin_lock_of_rr_private == 1);
...
int ldv_spin_is_locked_lock_of_rr_private(void)
{
  int is_spin_held_by_another_thread ;
  {
  {
  ...
  if (ldv_spin_lock_of_rr_private == 1 && is_spin_held_by_another_thread == 0) {
    return (0);
  } else {
    return (1);
  }
...
int ldv_spin_can_lock_lock_of_rr_private(void)
{
  int tmp ;
  {
  {
  tmp = ldv_spin_is_locked_lock_of_rr_private();
  }
  return (tmp == 0);
}
}
int ldv_spin_is_contended_lock_of_rr_private(void)
{
  int is_spin_contended ;
  {
  {
...
int ldv_atomic_dec_and_lock_lock_of_rr_private(void)
{
  int atomic_value_after_dec ;
  {
  {
...
void ldv_check_final_state(void)
{
  ...
  ldv_assert_linux_kernel_locking_spinlock__one_thread_locked_at_exit(ldv_spin_lock_of_rr_private == 1);
...
int ldv_exclusive_spin_is_locked(void)
{
  ...
  if (ldv_spin_lock_of_rr_private == 2) {
    return (1);
  } else {
  }
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-kernel-locking-spinlock_drivers-net-hippi-rrunner.cil.c", 13482, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock(int expr )
{
  {
  if (! expr) {
