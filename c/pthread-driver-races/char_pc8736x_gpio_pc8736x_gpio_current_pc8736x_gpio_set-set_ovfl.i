...
void spin_lock(spinlock_t *lock)
{
  ...
  assume_abort_if_not(lock->lock == 0);
  lock->lock = 1;
...
{
  __VERIFIER_atomic_begin();
  assume_abort_if_not(lock->locked == 0);
  lock->locked = 1;
  __VERIFIER_atomic_end();
}
...
int main(void)
{
 ...
 whoop_inode_5 = (struct inode *) safe_malloc(sizeof(struct inode));
 whoop_file_5 = (struct file *) safe_malloc(sizeof(struct file));
 whoop_inode_6 = (struct inode *) safe_malloc(sizeof(struct inode));
 whoop_file_6 = (struct file *) safe_malloc(sizeof(struct file));
