...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--gpu--drm--ast--ast.ko.cil.c", 5, "reach_error"); }
...
{ 
  ...
  assume_abort_if_not((unsigned long )ldv_0_size_cnt_struct_drm_device_ptr <= (unsigned long )((struct drm_device *)2147479552));
  }
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_dirty_lock_of_ast_fbdev == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_dirty_lock_of_ast_fbdev == 2);
