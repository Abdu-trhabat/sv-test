...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--usb--gadget--udc--net2272.ko.cil.c", 5, "reach_error"); }
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_net2272 == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_net2272 == 2);
