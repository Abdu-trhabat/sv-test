...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--net--usb--kaweth.ko.cil.c", 5, "reach_error"); }
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_device_lock_of_kaweth_device == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_device_lock_of_kaweth_device == 2);
