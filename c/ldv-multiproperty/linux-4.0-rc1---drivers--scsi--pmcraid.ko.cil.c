...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--scsi--pmcraid.ko.cil.c", 5, "reach_error"); }
...
{ 
  ...
  if (tmp___0 != 0) {
    {
    assume_abort_if_not(ldv_21_ret_default != 0);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_free_pool_lock_of_pmcraid_instance == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_free_pool_lock_of_pmcraid_instance == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_host_lock_of_Scsi_Host == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_host_lock_of_Scsi_Host == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lockp == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lockp == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_pending_pool_lock_of_pmcraid_instance == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_pending_pool_lock_of_pmcraid_instance == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_resource_lock_of_pmcraid_instance == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_resource_lock_of_pmcraid_instance == 2);
