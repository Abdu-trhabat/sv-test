...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--block--xen-blkfront.ko.cil.c", 5, "reach_error"); }
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_io_lock_of_blkfront_info == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_io_lock_of_blkfront_info == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_minor_lock == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_minor_lock == 2);
