...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--media--usb--dvb-usb-v2--dvb-usb-mxl111sf.ko.cil.c.cil.c", 5, "reach_error"); }
...
{ 
  ...
  if (tmp___4 != 0) {
    {
    assume_abort_if_not(ldv_7_probe_retval_default == 0);
