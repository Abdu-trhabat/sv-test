...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--usb--host--u132-hcd.ko.cil.c.cil.c", 5, "reach_error"); }
...
{ 
  ...
  if (tmp___1 != 0) {
    ...
    if (tmp___0 != 0) {
      {
      assume_abort_if_not(ldv_0_probed_default == 0);
      }
      goto ldv_call_0;
    } else {
      {
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_slock_of_u132_spin == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_slock_of_u132_spin == 2);
