...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---fs--ncpfs--ncpfs.ko.cil.c", 5, "reach_error"); }
...
{ 
  ...
  assume_abort_if_not((unsigned long )ldv_1_size_cnt_struct_dir_context_ptr <= (unsigned long )((struct dir_context *)2147479552));
