...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--md--raid456.ko.cil.c", 5, "reach_error"); }
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_NOT_ARG_SIGN == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_NOT_ARG_SIGN == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_device_lock_of_r5conf == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_device_lock_of_r5conf == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_hash_locks_of_r5conf == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_hash_locks_of_r5conf == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_mddev == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_mddev == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_stripe_lock_of_stripe_head == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_stripe_lock_of_stripe_head == 2);
