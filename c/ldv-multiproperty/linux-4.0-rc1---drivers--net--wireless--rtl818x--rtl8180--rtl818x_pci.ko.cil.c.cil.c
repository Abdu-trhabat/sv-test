...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--net--wireless--rtl818x--rtl8180--rtl818x_pci.ko.cil.c.cil.c", 5, "reach_error"); }
...
{ 
  ...
  if (tmp___0 != 0) {
    {
    assume_abort_if_not(ldv_17_ret_default != 0);
...
{ 
  ...
  if (tmp___7 != 0) {
    ...
    {
    assume_abort_if_not((unsigned long )ldv_11_ieee80211_hw_ieee80211_hw == (unsigned long )((struct ieee80211_hw *)0));
    }
...
{ 
  ...
  if (tmp != 0) {
    {
    assume_abort_if_not((unsigned int )ldv_6_ret_val_default == 2U);
    }
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_rtl8180_priv == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_rtl8180_priv == 2);
