...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---net--rose--rose.ko.cil.c.cil.c", 5, "reach_error"); }
...
{ 
  ...
  if (tmp___3 != 0) {
    {
    assume_abort_if_not(ldv_11_started_default == 1);
    tmp = ldv_undef_int();
    }
    {
    if (tmp == 1) {
    ...
    {
    assume_abort_if_not(ldv_11_started_default == 0);
    tmp___2 = ldv_undef_int();
    }
    if (tmp___2 != 0) {
      {
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rose_list_lock == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rose_list_lock == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rose_neigh_list_lock == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rose_neigh_list_lock == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rose_node_list_lock == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rose_node_list_lock == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rose_route_list_lock == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_rose_route_list_lock == 2);
