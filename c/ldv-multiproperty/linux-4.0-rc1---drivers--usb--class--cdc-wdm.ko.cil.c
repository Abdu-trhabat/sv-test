...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--usb--class--cdc-wdm.ko.cil.c", 5, "reach_error"); }
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_iuspin_of_wdm_device == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_iuspin_of_wdm_device == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_wdm_device_list_lock == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_wdm_device_list_lock == 2);
