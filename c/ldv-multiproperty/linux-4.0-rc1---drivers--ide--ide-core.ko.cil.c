...
void reach_error() { __assert_fail("0", "linux-4.0-rc1---drivers--ide--ide-core.ko.cil.c", 5, "reach_error"); }
...
{ 
  ...
  if (tmp___0 != 0) {
    {
    assume_abort_if_not(ldv_41_ret_default != 0);
...
{ 
  ...
  if (tmp != 0) {
    {
    assume_abort_if_not((unsigned int )ldv_11_ret_val_default == 2U);
    }
...
{ 
  ...
  if (tmp___1 != 0) {
    ...
    if (tmp___0 != 0) {
      {
      assume_abort_if_not(ldv_13_probed_default == 0);
      }
      goto ldv_call_13;
    } else {
      {
...
{ 
  ...
  assume_abort_if_not(ldv_10_size_cnt_write_size <= 2147479552UL);
...
{ 
  ...
  assume_abort_if_not(ldv_3_size_cnt_write_size <= 2147479552UL);
...
{ 
  ...
  assume_abort_if_not(ldv_4_size_cnt_write_size <= 2147479552UL);
  }
...
{ 
  ...
  assume_abort_if_not(ldv_5_size_cnt_write_size <= 2147479552UL);
  }
...
{ 
  ...
  assume_abort_if_not(ldv_6_size_cnt_write_size <= 2147479552UL);
  }
...
{ 
  ...
  assume_abort_if_not(ldv_7_size_cnt_write_size <= 2147479552UL);
  }
...
{ 
  ...
  if (tmp___3 != 0) {
    ...
    if (tmp___2 != 0) {
      {
      assume_abort_if_not(ldv_8_ret_default == 0);
      }
      goto ldv_call_8;
    } else {
      {
  ...
  assume_abort_if_not(ldv_8_size_cnt_write_size <= 2147479552UL);
  }
...
{ 
  ...
  assume_abort_if_not(ldv_9_size_cnt_write_size <= 2147479552UL);
  }
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_hwif_s == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_lock_of_hwif_s == 2);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_queue_lock_of_request_queue == 1);
...
{ 
  ...
  assume_abort_if_not(ldv_linux_kernel_locking_spinlock_spin_queue_lock_of_request_queue == 2);
