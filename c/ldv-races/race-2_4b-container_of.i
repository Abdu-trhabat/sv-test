...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "../sv-benchmarks/c/ldv-races/race-2_4b-container_of.c", 13, __extension__ __PRETTY_FUNCTION__); })); }
