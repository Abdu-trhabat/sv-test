...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-32_7a-drivers--power--bq2415x_charger.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
struct power_supply *power_supply_get_by_name(const char *arg0) {
  return ldv_malloc(sizeof(struct power_supply));
}
