...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-08_1a-drivers--scsi--gdth.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
void ldv_pci_unregister_driver_15(struct pci_driver *ldv_func_arg1 ) ;
...
__inline static int ldv_request_irq_7(unsigned int irq___0 , irqreturn_t (*handler)(int ,
                                                                                    void * ) ,
                                      unsigned long flags , char const *name , void *dev ) ;
...
__inline static int ldv_register_chrdev_12(unsigned int major___0 , char const *name ,
                                           struct file_operations const *fops ) ;
...
__inline static void ldv_unregister_chrdev_13(unsigned int major___0 , char const *name ) ;
...
void ldv_scsi_remove_host_9(struct Scsi_Host *shost ) ;
...
static void gdth_put_cmndinfo(struct gdth_cmndinfo *priv )
{
  ...
  tmp = ldv__builtin_expect((unsigned long )priv == (unsigned long )((struct gdth_cmndinfo *)0),
                         0L);
  if (tmp != 0L) {
    __asm__ volatile ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/6304/dscv_tempdir/dscv/ri/08_1a/drivers/scsi/gdth.c"),
                         "i" (416), "i" (12UL));
    ldv_38754: ;
    goto ldv_38754;
  } else {
                                    ...
                                    u16 count )
{
  ...
  if ((unsigned int )count != 0U) {
    ...
    if (tmp___5 != 0L) {
      warn_slowpath_null("/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/6304/dscv_tempdir/dscv/ri/08_1a/drivers/scsi/gdth.c",
                         2316);
    } else {
    }
    ldv__builtin_expect(__ret_warn_on != 0, 0L);
...
static int gdth_ioctl(struct file *filep , unsigned int cmd , unsigned long arg )
{
  ...
  case 18949U:
  cnt = gdth_ctr_count;
  __might_fault("/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/6304/dscv_tempdir/dscv/ri/08_1a/drivers/scsi/gdth.c",
                4486);
  __pu_val = cnt;
  switch (4UL) {
  case 1UL:
...
static int gdth_pci_probe_one(gdth_pci_str *pcistr , gdth_ha_str **ha_out )
{
  ...
  *ha_out = (gdth_ha_str *)0;
  shp = ldv_scsi_host_alloc_6(& gdth_template, 21792);
  ...
  printk("Configuring GDT-PCI HA at %d/%d IRQ %u\n", (int )(pdev->bus)->number, (pdev->devfn >> 3) & 31U,
         (int )ha->irq);
  error = ldv_request_irq_7((unsigned int )ha->irq, & gdth_interrupt, 128UL, "gdth",
                            (void *)ha);
  if (error != 0) {
  ...
  *ha_out = ha;
  ...
  out_free_irq:
  ldv_free_irq_8((unsigned int )ha->irq, (void *)ha);
  gdth_ctr_count = gdth_ctr_count - 1;
  out_host_put:
  scsi_host_put(shp);
  return (error);
...
static void gdth_remove_one(gdth_ha_str *ha )
{
  ...
  if (shp->irq != 0U) {
    ldv_free_irq_10(shp->irq, (void *)ha);
  } else {
  }
  if ((unsigned long )ha->pscratch != (unsigned long )((char *)0)) {
    pci_free_consistent(ha->pdev, 4096UL, (void *)ha->pscratch, ha->scratch_phys);
...
static int gdth_init(void)
{
  ...
  tmp = ldv___pci_register_driver_11(& gdth_pci_driver, & __this_module, "gdth");
  if (tmp != 0) {
    __mptr = (struct list_head const *)gdth_instances.next;
    ha = (gdth_ha_str *)__mptr + 0xfffffffffffffff8UL;
    goto ldv_39657;
  ...
  major = ldv_register_chrdev_12(0U, "gdth", & gdth_fops);
...
static void gdth_exit(void)
{
  ...
  struct list_head const *__mptr___0 ;
  {
  ldv_unregister_chrdev_13((unsigned int )major, "gdth");
  unregister_reboot_notifier(& gdth_notifier);
  ldv_del_timer_sync_14(& gdth_timer);
  ldv_pci_unregister_driver_15(& gdth_pci_driver);
  __mptr = (struct list_head const *)gdth_instances.next;
  ha = (gdth_ha_str *)__mptr + 0xfffffffffffffff8UL;
  goto ldv_39668;
  ldv_39667:
