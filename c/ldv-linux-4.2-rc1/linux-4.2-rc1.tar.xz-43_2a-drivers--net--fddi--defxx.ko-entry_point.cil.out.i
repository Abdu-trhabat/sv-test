...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-43_2a-drivers--net--fddi--defxx.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
struct __anonstruct_PI_CNTR_324 {
   PI_UINT32 ms ;
   PI_UINT32 ls ;
};
typedef struct __anonstruct_PI_CNTR_324 PI_CNTR;
struct __anonstruct_PI_LAN_ADDR_325 {
   PI_UINT32 lwrd_0 ;
   PI_UINT32 lwrd_1 ;
};
typedef struct __anonstruct_PI_LAN_ADDR_325 PI_LAN_ADDR;
struct __anonstruct_PI_STATION_ID_326 {
   PI_UINT32 octet_7_4 ;
   PI_UINT32 octet_3_0 ;
};
typedef struct __anonstruct_PI_STATION_ID_326 PI_STATION_ID;
struct __anonstruct_PI_ITEM_LIST_327 {
   PI_UINT32 item_code ;
   PI_UINT32 value ;
};
typedef struct __anonstruct_PI_ITEM_LIST_327 PI_ITEM_LIST;
struct __anonstruct_PI_RSP_HEADER_328 {
   PI_UINT32 reserved ;
   PI_UINT32 cmd_type ;
   PI_UINT32 status ;
};
typedef struct __anonstruct_PI_RSP_HEADER_328 PI_RSP_HEADER;
struct __anonstruct_PI_CMD_START_REQ_329 {
   PI_UINT32 cmd_type ;
};
typedef struct __anonstruct_PI_CMD_START_REQ_329 PI_CMD_START_REQ;
struct __anonstruct_PI_CMD_START_RSP_330 {
   PI_RSP_HEADER header ;
};
typedef struct __anonstruct_PI_CMD_START_RSP_330 PI_CMD_START_RSP;
struct __anonstruct_PI_CMD_FILTERS_SET_REQ_331 {
   PI_UINT32 cmd_type ;
   PI_ITEM_LIST item[63U] ;
};
typedef struct __anonstruct_PI_CMD_FILTERS_SET_REQ_331 PI_CMD_FILTERS_SET_REQ;
struct __anonstruct_PI_CMD_FILTERS_SET_RSP_332 {
   PI_RSP_HEADER header ;
};
typedef struct __anonstruct_PI_CMD_FILTERS_SET_RSP_332 PI_CMD_FILTERS_SET_RSP;
struct __anonstruct_PI_CMD_FILTERS_GET_REQ_333 {
   PI_UINT32 cmd_type ;
};
typedef struct __anonstruct_PI_CMD_FILTERS_GET_REQ_333 PI_CMD_FILTERS_GET_REQ;
struct __anonstruct_PI_CMD_FILTERS_GET_RSP_334 {
   PI_RSP_HEADER header ;
...
typedef struct __anonstruct_PI_CMD_FILTERS_GET_RSP_334 PI_CMD_FILTERS_GET_RSP;
struct __anonstruct_item_336 {
   PI_UINT32 item_code ;
   PI_UINT32 value ;
   PI_UINT32 item_index ;
};
struct __anonstruct_PI_CMD_CHARS_SET_REQ_335 {
   PI_UINT32 cmd_type ;
   struct __anonstruct_item_336 item[42U] ;
};
typedef struct __anonstruct_PI_CMD_CHARS_SET_REQ_335 PI_CMD_CHARS_SET_REQ;
struct __anonstruct_PI_CMD_CHARS_SET_RSP_337 {
   PI_RSP_HEADER header ;
};
typedef struct __anonstruct_PI_CMD_CHARS_SET_RSP_337 PI_CMD_CHARS_SET_RSP;
struct __anonstruct_item_339 {
   PI_UINT32 item_code ;
   PI_UINT32 value ;
   PI_UINT32 item_index ;
};
struct __anonstruct_PI_CMD_SNMP_SET_REQ_338 {
   PI_UINT32 cmd_type ;
   struct __anonstruct_item_339 item[42U] ;
};
typedef struct __anonstruct_PI_CMD_SNMP_SET_REQ_338 PI_CMD_SNMP_SET_REQ;
struct __anonstruct_PI_CMD_SNMP_SET_RSP_340 {
   PI_RSP_HEADER header ;
};
typedef struct __anonstruct_PI_CMD_SNMP_SET_RSP_340 PI_CMD_SNMP_SET_RSP;
struct __anonstruct_item_342 {
   PI_UINT32 item_code ;
   PI_UINT32 value ;
   PI_UINT32 item_index ;
};
struct __anonstruct_PI_CMD_SMT_MIB_SET_REQ_341 {
   PI_UINT32 cmd_type ;
   struct __anonstruct_item_342 item[42U] ;
};
typedef struct __anonstruct_PI_CMD_SMT_MIB_SET_REQ_341 PI_CMD_SMT_MIB_SET_REQ;
struct __anonstruct_PI_CMD_SMT_MIB_SET_RSP_343 {
   PI_RSP_HEADER header ;
};
typedef struct __anonstruct_PI_CMD_SMT_MIB_SET_RSP_343 PI_CMD_SMT_MIB_SET_RSP;
struct __anonstruct_PI_CMD_SMT_MIB_GET_REQ_344 {
   PI_UINT32 cmd_type ;
};
typedef struct __anonstruct_PI_CMD_SMT_MIB_GET_REQ_344 PI_CMD_SMT_MIB_GET_REQ;
struct __anonstruct_PI_CMD_SMT_MIB_GET_RSP_345 {
   PI_RSP_HEADER header ;
...
typedef struct __anonstruct_PI_CMD_SMT_MIB_GET_RSP_345 PI_CMD_SMT_MIB_GET_RSP;
struct __anonstruct_PI_CMD_ADDR_FILTER_SET_REQ_346 {
   PI_UINT32 cmd_type ;
   PI_LAN_ADDR entry[62U] ;
};
typedef struct __anonstruct_PI_CMD_ADDR_FILTER_SET_REQ_346 PI_CMD_ADDR_FILTER_SET_REQ;
struct __anonstruct_PI_CMD_ADDR_FILTER_SET_RSP_347 {
   PI_RSP_HEADER header ;
};
typedef struct __anonstruct_PI_CMD_ADDR_FILTER_SET_RSP_347 PI_CMD_ADDR_FILTER_SET_RSP;
struct __anonstruct_PI_CMD_ADDR_FILTER_GET_REQ_348 {
   PI_UINT32 cmd_type ;
};
typedef struct __anonstruct_PI_CMD_ADDR_FILTER_GET_REQ_348 PI_CMD_ADDR_FILTER_GET_REQ;
struct __anonstruct_PI_CMD_ADDR_FILTER_GET_RSP_349 {
   PI_RSP_HEADER header ;
   PI_LAN_ADDR entry[62U] ;
};
typedef struct __anonstruct_PI_CMD_ADDR_FILTER_GET_RSP_349 PI_CMD_ADDR_FILTER_GET_RSP;
struct __anonstruct_PI_CMD_STATUS_CHARS_GET_REQ_350 {
   PI_UINT32 cmd_type ;
};
typedef struct __anonstruct_PI_CMD_STATUS_CHARS_GET_REQ_350 PI_CMD_STATUS_CHARS_GET_REQ;
struct __anonstruct_PI_CMD_STATUS_CHARS_GET_RSP_351 {
   PI_RSP_HEADER header ;
...
typedef struct __anonstruct_PI_CMD_STATUS_CHARS_GET_RSP_351 PI_CMD_STATUS_CHARS_GET_RSP;
struct __anonstruct_PI_CMD_FDDI_MIB_GET_REQ_352 {
   PI_UINT32 cmd_type ;
};
typedef struct __anonstruct_PI_CMD_FDDI_MIB_GET_REQ_352 PI_CMD_FDDI_MIB_GET_REQ;
struct __anonstruct_PI_CMD_FDDI_MIB_GET_RSP_353 {
   PI_RSP_HEADER header ;
   PI_STATION_ID smt_station_id ;
   PI_UINT32 smt_op_version_id ;
   PI_UINT32 smt_hi_version_id ;
...
typedef struct __anonstruct_PI_CMD_FDDI_MIB_GET_RSP_353 PI_CMD_FDDI_MIB_GET_RSP;
struct __anonstruct_PI_CMD_DEC_EXT_MIB_GET_REQ_354 {
   PI_UINT32 cmd_type ;
};
typedef struct __anonstruct_PI_CMD_DEC_EXT_MIB_GET_REQ_354 PI_CMD_DEC_EXT_MIB_GET_REQ;
...
typedef struct __anonstruct_PI_CMD_DEC_EXT_MIB_GET_RSP_355 PI_CMD_DEC_EXT_MIB_GET_RSP;
struct __anonstruct_PI_CNTR_BLK_356 {
   PI_CNTR traces_rcvd ;
   PI_CNTR frame_cnt ;
   PI_CNTR error_cnt ;
   PI_CNTR lost_cnt ;
...
typedef struct __anonstruct_PI_CNTR_BLK_356 PI_CNTR_BLK;
struct __anonstruct_PI_CMD_CNTRS_GET_REQ_357 {
   PI_UINT32 cmd_type ;
};
typedef struct __anonstruct_PI_CMD_CNTRS_GET_REQ_357 PI_CMD_CNTRS_GET_REQ;
struct __anonstruct_PI_CMD_CNTRS_GET_RSP_358 {
   PI_RSP_HEADER header ;
   PI_CNTR time_since_reset ;
   PI_CNTR_BLK cntrs ;
};
typedef struct __anonstruct_PI_CMD_CNTRS_GET_RSP_358 PI_CMD_CNTRS_GET_RSP;
struct __anonstruct_PI_CMD_CNTRS_SET_REQ_359 {
   PI_UINT32 cmd_type ;
   PI_CNTR_BLK cntrs ;
};
typedef struct __anonstruct_PI_CMD_CNTRS_SET_REQ_359 PI_CMD_CNTRS_SET_REQ;
struct __anonstruct_PI_CMD_CNTRS_SET_RSP_360 {
   PI_RSP_HEADER header ;
};
typedef struct __anonstruct_PI_CMD_CNTRS_SET_RSP_360 PI_CMD_CNTRS_SET_RSP;
struct __anonstruct_PI_CMD_ERROR_LOG_CLEAR_REQ_361 {
   PI_UINT32 cmd_type ;
};
typedef struct __anonstruct_PI_CMD_ERROR_LOG_CLEAR_REQ_361 PI_CMD_ERROR_LOG_CLEAR_REQ;
struct __anonstruct_PI_CMD_ERROR_LOG_CLEAR_RSP_362 {
   PI_RSP_HEADER header ;
};
typedef struct __anonstruct_PI_CMD_ERROR_LOG_CLEAR_RSP_362 PI_CMD_ERROR_LOG_CLEAR_RSP;
struct __anonstruct_PI_CMD_ERROR_LOG_GET_REQ_363 {
   PI_UINT32 cmd_type ;
   PI_UINT32 entry_index ;
};
typedef struct __anonstruct_PI_CMD_ERROR_LOG_GET_REQ_363 PI_CMD_ERROR_LOG_GET_REQ;
struct __anonstruct_diag_365 {
   PI_UINT32 fru_imp_mask ;
   PI_UINT32 test_id ;
   PI_UINT32 reserved[6U] ;
};
struct __anonstruct_PI_LOG_ENTRY_364 {
   struct __anonstruct_diag_365 diag ;
   PI_UINT32 fw[111U] ;
};
typedef struct __anonstruct_PI_LOG_ENTRY_364 PI_LOG_ENTRY;
struct __anonstruct_PI_CMD_ERROR_LOG_GET_RSP_366 {
   PI_RSP_HEADER header ;
...
typedef struct __anonstruct_PI_CMD_ERROR_LOG_GET_RSP_366 PI_CMD_ERROR_LOG_GET_RSP;
...
typedef union __anonunion_PI_DMA_CMD_REQ_367 PI_DMA_CMD_REQ;
...
typedef union __anonunion_PI_DMA_CMD_RSP_368 PI_DMA_CMD_RSP;
struct __anonstruct_PI_CONSUMER_BLOCK_370 {
...
typedef struct __anonstruct_PI_CONSUMER_BLOCK_370 PI_CONSUMER_BLOCK;
struct __anonstruct_PI_RCV_DESCR_371 {
   PI_UINT32 long_0 ;
   PI_UINT32 long_1 ;
};
typedef struct __anonstruct_PI_RCV_DESCR_371 PI_RCV_DESCR;
struct __anonstruct_PI_XMT_DESCR_372 {
   PI_UINT32 long_0 ;
   PI_UINT32 long_1 ;
};
typedef struct __anonstruct_PI_XMT_DESCR_372 PI_XMT_DESCR;
struct __anonstruct_PI_DESCR_BLOCK_373 {
...
typedef struct __anonstruct_PI_DESCR_BLOCK_373 PI_DESCR_BLOCK;
...
union __anonunion_PI_TYPE_1_PROD_REG_374 {
   PI_UINT32 lword ;
   struct __anonstruct_index_375 index ;
};
typedef union __anonunion_PI_TYPE_1_PROD_REG_374 PI_TYPE_1_PROD_REG;
struct __anonstruct_index_377 {
   PI_UINT8 rcv_prod ;
   PI_UINT8 xmt_prod ;
   PI_UINT8 rcv_comp ;
   PI_UINT8 xmt_comp ;
};
union __anonunion_PI_TYPE_2_PROD_REG_376 {
   PI_UINT32 lword ;
   struct __anonstruct_index_377 index ;
};
typedef union __anonunion_PI_TYPE_2_PROD_REG_376 PI_TYPE_2_PROD_REG;
struct __anonstruct_index_381 {
   PI_UINT8 rcv_cons ;
   PI_UINT8 res0 ;
   PI_UINT8 xmt_cons ;
   PI_UINT8 res1 ;
};
union __anonunion_PI_TYPE_2_CONSUMER_380 {
   PI_UINT32 lword ;
   struct __anonstruct_index_381 index ;
};
typedef union __anonunion_PI_TYPE_2_CONSUMER_380 PI_TYPE_2_CONSUMER;
struct __anonstruct_XMT_DRIVER_DESCR_382 {
   struct sk_buff *p_skb ;
};
typedef struct __anonstruct_XMT_DRIVER_DESCR_382 XMT_DRIVER_DESCR;
union __anonunion_base_383 {
   void *mem ;
   int port ;
};
struct DFX_board_tag {
   ...
   spinlock_t lock ;
   struct net_device *dev ;
   union __anonunion_base_383 base ;
...
int ldv_irq_1_3 = 0;
struct pci_dev *dfx_pci_driver_group1 ;
...
static void dfx_get_bars(struct device *bdev , resource_size_t *bar_start , resource_size_t *bar_len )
{
  ...
  if (dfx_bus_eisa != 0) {
    ...
    if (dfx_use_mmio != 0) {
      tmp___1 = inb((int )((unsigned int )base_addr + 3216U));
      bar_lo = (resource_size_t )tmp___1;
      bar_lo = bar_lo << 8;
      tmp___2 = inb((int )((unsigned int )base_addr + 3215U));
      bar_lo = (resource_size_t )tmp___2 | bar_lo;
      bar_lo = bar_lo << 8;
      tmp___3 = inb((int )((unsigned int )base_addr + 3214U));
      bar_lo = (resource_size_t )tmp___3 | bar_lo;
      bar_lo = bar_lo << 8;
      *bar_start = bar_lo;
      tmp___4 = inb((int )((unsigned int )base_addr + 3210U));
      bar_hi = (resource_size_t )tmp___4;
      bar_hi = bar_hi << 8;
      tmp___5 = inb((int )((unsigned int )base_addr + 3209U));
      bar_hi = (resource_size_t )tmp___5 | bar_hi;
      bar_hi = bar_hi << 8;
      tmp___6 = inb((int )((unsigned int )base_addr + 3208U));
      bar_hi = (resource_size_t )tmp___6 | bar_hi;
      bar_hi = bar_hi << 8;
      *bar_len = ((bar_hi - bar_lo) | 1023ULL) + 1ULL;
    } else {
      *bar_start = (resource_size_t )base_addr;
      *bar_len = 64ULL;
    }
    *(bar_start + 1UL) = (resource_size_t )(base_addr + 64UL);
    *(bar_len + 1UL) = 4ULL;
    *(bar_start + 2UL) = (resource_size_t )(base_addr + 3200UL);
    *(bar_len + 2UL) = 64ULL;
  } else {
  }
  if (dfx_bus_tc != 0) {
    ...
    *bar_len = 64ULL;
    tmp___7 = 0ULL;
    *(bar_start + 1UL) = tmp___7;
    *(bar_start + 2UL) = tmp___7;
    tmp___8 = 0ULL;
    *(bar_len + 1UL) = tmp___8;
    *(bar_len + 2UL) = tmp___8;
  } else {
...
static int dfx_register(struct device *bdev )
{
  ...
  struct net_device *dev ;
  DFX_board_t *bp ;
  resource_size_t bar_start[3U] ;
  resource_size_t bar_len[3U] ;
  int alloc_size ;
  ...
  if (dfx_bus_pci != 0) {
    __mptr = (struct device const *)bdev;
    err = pci_enable_device((struct pci_dev *)__mptr + 0xffffffffffffff68UL);
    if (err != 0) {
  ...
  dfx_get_bars(bdev, (resource_size_t *)(& bar_start), (resource_size_t *)(& bar_len));
  if ((dfx_bus_eisa != 0 && dfx_use_mmio != 0) && bar_start[0] == 0ULL) {
    printk("\v%s: Cannot use MMIO, no address set, aborting\n", print_name);
    printk("\v%s: Run ECU and set adapter\'s MMIO location\n", print_name);
    printk("\v%s: Or recompile driver with \"CONFIG_DEFXX_MMIO=n\"\n", print_name);
    err = -6;
    goto err_out;
  } else {
  }
  if (dfx_use_mmio != 0) {
    region = __request_region(& iomem_resource, bar_start[0], bar_len[0], print_name,
                              0);
  } else {
    region = __request_region(& ioport_resource, bar_start[0], bar_len[0], print_name,
                              0);
  }
  if ((unsigned long )region == (unsigned long )((struct resource *)0)) {
    printk("\v%s: Cannot reserve %s resource 0x%lx @ 0x%lx, aborting\n", dfx_use_mmio != 0 ? (char *)"MMIO" : (char *)"I/O",
           print_name, (long )bar_len[0], (long )bar_start[0]);
    err = -16;
    goto err_out_disable;
  } else {
  }
  if (bar_start[1] != 0ULL) {
    region = __request_region(& ioport_resource, bar_start[1], bar_len[1], print_name,
                              0);
    if ((unsigned long )region == (unsigned long )((struct resource *)0)) {
  ...
  if (bar_start[2] != 0ULL) {
    region = __request_region(& ioport_resource, bar_start[2], bar_len[2], print_name,
                              0);
    if ((unsigned long )region == (unsigned long )((struct resource *)0)) {
      printk("\v%s: Cannot reserve I/O resource 0x%lx @ 0x%lx, aborting\n", print_name,
  ...
  if (dfx_use_mmio != 0) {
    bp->base.mem = ioremap_nocache(bar_start[0], (unsigned long )bar_len[0]);
    ...
    bp->base.port = (int )bar_start[0];
    dev->base_addr = (unsigned long )bar_start[0];
  }
  ...
  tmp___1 = dfx_driver_init(dev, print_name, bar_start[0]);
  if (tmp___1 != 0) {
    err = -19;
    goto err_out_unmap;
  } else {
  ...
  err_out_esic_region: ;
  if (bar_start[2] != 0ULL) {
    __release_region(& ioport_resource, bar_start[2], bar_len[2]);
  } else {
  }
  err_out_bh_region: ;
  if (bar_start[1] != 0ULL) {
    __release_region(& ioport_resource, bar_start[1], bar_len[1]);
  } else {
  }
  err_out_csr_region: ;
  if (dfx_use_mmio != 0) {
    __release_region(& iomem_resource, bar_start[0], bar_len[0]);
  } else {
    __release_region(& ioport_resource, bar_start[0], bar_len[0]);
  }
  err_out_disable: ;
  if (dfx_bus_pci != 0) {
...
static void dfx_bus_init(struct net_device *dev )
{
  ...
  if (dfx_bus_eisa != 0) {
    ...
    outb(0, (int )((unsigned int )base_addr + 3204U));
    ...
    ldv_46313:
    val = 0U;
    outb((int )val, (int )((unsigned int )base_addr + 3218U));
    val = 0U;
    outb((int )val, (int )((unsigned int )base_addr + 3217U));
    val = 240U;
    outb((int )val, (int )((unsigned int )base_addr + 3226U));
    val = 60U;
    outb((int )val, (int )((unsigned int )base_addr + 3225U));
    val = 0U;
    outb((int )val, (int )((unsigned int )base_addr + 3220U));
    val = 64U;
    outb((int )val, (int )((unsigned int )base_addr + 3219U));
    val = 240U;
    outb((int )val, (int )((unsigned int )base_addr + 3228U));
    val = 0U;
    outb((int )val, (int )((unsigned int )base_addr + 3227U));
    val = 2U;
    if (dfx_use_mmio != 0) {
    ...
    outb((int )val, (int )((unsigned int )base_addr + 3246U));
    val = 1U;
    outb((int )val, (int )((unsigned int )base_addr + 3204U));
    ...
    outb((int )val, (int )((unsigned int )base_addr + 64U));
    val = inb((int )((unsigned int )base_addr + 3241U));
    val = (u8 )((unsigned int )val | 8U);
    outb((int )val, (int )((unsigned int )base_addr + 3241U));
  } else {
  }
  if (dfx_bus_pci != 0) {
    __mptr___1 = (struct device const *)bdev;
...
static void dfx_bus_uninit(struct net_device *dev )
{
  ...
  if (dfx_bus_eisa != 0) {
    ...
    outb((int )val, (int )((unsigned int )base_addr + 3241U));
    outb(0, (int )((unsigned int )base_addr + 3204U));
    outb(0, (int )((unsigned int )base_addr + 3246U));
  } else {
  }
  if (dfx_bus_pci != 0) {
...
static int dfx_driver_init(struct net_device *dev , char const *print_name , resource_size_t bar_start )
{
  ...
  printk("\016%s: %s at %s addr = 0x%llx, IRQ = %d, Hardware addr = %pMF\n", print_name,
         board_name, dfx_use_mmio != 0 ? (char *)"MMIO" : (char *)"I/O", (long long )bar_start,
...
static int dfx_open(struct net_device *dev )
{
  ...
  tmp = netdev_priv((struct net_device const *)dev);
  bp = (DFX_board_t *)tmp;
  ret = ldv_request_irq_39((unsigned int )dev->irq, & dfx_interrupt, 128UL, (char const *)(& dev->name),
                           (void *)dev);
  if (ret != 0) {
  ...
  __raw_spin_lock_init(& bp->lock.__annonCompField18.rlock, "&(&bp->lock)->rlock",
                       & __key);
  bp->reset_type = 4U;
...
static irqreturn_t dfx_interrupt(int irq , void *dev_id )
{
  ...
  if (dfx_bus_eisa != 0) {
    ...
    outb((int )status___0, (int )((unsigned int )base_addr + 3241U));
    dfx_int_common(dev);
    status___0 = inb((int )((unsigned int )base_addr + 3241U));
...
static struct net_device_stats *dfx_ctl_get_stats(struct net_device *dev )
{
  ...
  memcpy((void *)(& bp->stats.smt_station_id), (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.smt_station_id),
           8UL);
  bp->stats.smt_op_version_id = (bp->cmd_rsp_virt)->smt_mib_get.smt_op_version_id;
  bp->stats.smt_hi_version_id = (bp->cmd_rsp_virt)->smt_mib_get.smt_hi_version_id;
  bp->stats.smt_lo_version_id = (bp->cmd_rsp_virt)->smt_mib_get.smt_lo_version_id;
  memcpy((void *)(& bp->stats.smt_user_data), (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.smt_user_data),
           32UL);
  ...
  memcpy((void *)(& bp->stats.mac_upstream_nbr), (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.mac_upstream_nbr),
           6UL);
  memcpy((void *)(& bp->stats.mac_downstream_nbr), (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.mac_downstream_nbr),
           6UL);
  memcpy((void *)(& bp->stats.mac_old_upstream_nbr), (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.mac_old_upstream_nbr),
           6UL);
  memcpy((void *)(& bp->stats.mac_old_downstream_nbr), (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.mac_old_downstream_nbr),
           6UL);
  bp->stats.mac_dup_address_test = (bp->cmd_rsp_virt)->smt_mib_get.mac_dup_address_test;
  bp->stats.mac_requested_paths = (bp->cmd_rsp_virt)->smt_mib_get.mac_requested_paths;
  bp->stats.mac_downstream_port_type = (bp->cmd_rsp_virt)->smt_mib_get.mac_downstream_port_type;
  memcpy((void *)(& bp->stats.mac_smt_address), (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.mac_smt_address),
           6UL);
  ...
  memcpy((void *)(& bp->stats.path_configuration), (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.path_configuration),
           32UL);
  ...
  memcpy((void *)(& bp->stats.port_requested_paths), (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.port_requested_paths),
           3UL);
  memcpy((void *)(& bp->stats.port_requested_paths) + 3U, (void const *)(& (bp->cmd_rsp_virt)->smt_mib_get.port_requested_paths) + 1U,
           3UL);
...
static void dfx_ctl_set_multicast_list(struct net_device *dev )
{
  ...
  if ((dev->flags & 256U) != 0U) {
    ...
    tmp___0 = i;
    i = i + 1;
    memcpy((void *)(& bp->mc_table) + (unsigned long )(tmp___0 * 6), (void const *)(& ha->addr),
             6UL);
  ...
  tmp___2 = dfx_ctl_update_filters(bp);
  return;
}
}
static int dfx_ctl_set_mac_address(struct net_device *dev , void *addr )
{
  ...
  memcpy((void *)(& bp->uc_table), (void const *)(& p_sockaddr->sa_data), 6UL);
  bp->uc_count = 1U;
...
static int dfx_ctl_update_cam(DFX_board_t *bp )
{
  ...
  ldv_46447: ;
  if (i <= 61) {
    memcpy((void *)p_addr, (void const *)(& bp->uc_table) + (unsigned long )(i * 6),
             6UL);
    p_addr = p_addr + 1;
  } else {
  }
  ...
  if (bp->uc_count + (u32 )i <= 61U) {
    memcpy((void *)p_addr, (void const *)(& bp->mc_table) + (unsigned long )(i * 6),
             6UL);
    p_addr = p_addr + 1;
  } else {
  }
...
static int dfx_rcv_init(DFX_board_t *bp , int get_buffers )
{
  ...
  if (get_buffers != 0) {
    ...
    goto ldv_46511;
    ldv_46510:
    newskb = ldv___netdev_alloc_skb_42(bp->dev, 4736U, 16U);
    if ((unsigned long )newskb == (unsigned long )((struct sk_buff *)0)) {
      return (-12);
    } else {
    }
    my_skb_align(newskb, 128);
    dma_addr = dma_map_single_attrs(bp->bus_dev, (void *)newskb->data, 4608UL, 2,
                                    (struct dma_attrs *)0);
    tmp = dma_mapping_error(bp->bus_dev, dma_addr);
    if (tmp != 0) {
      consume_skb(newskb);
      return (-12);
    } else {
    ...
    (bp->descr_block_virt)->rcv_data[i + j].long_1 = (unsigned int )dma_addr;
...
static void dfx_rcv_queue_process(DFX_board_t *bp )
{
  ...
  dma_addr = (dma_addr_t )(bp->descr_block_virt)->rcv_data[entry].long_1;
  dma_sync_single_for_cpu(bp->bus_dev, dma_addr, 4UL, 2);
  memcpy((void *)(& descr), (void const *)p_buff, 4UL);
  if ((descr & 2097152U) != 0U) {
    ...
    if (pkt_len <= 12U || pkt_len > 4491U) {
      ...
      newskb = (struct sk_buff *)0;
      if (pkt_len > 200U) {
        newskb = netdev_alloc_skb(bp->dev, 4736U);
        if ((unsigned long )newskb != (unsigned long )((struct sk_buff *)0)) {
          my_skb_align(newskb, 128);
          new_dma_addr = dma_map_single_attrs(bp->bus_dev, (void *)newskb->data, 4608UL,
                                              2, (struct dma_attrs *)0);
          tmp = dma_mapping_error(bp->bus_dev, new_dma_addr);
          if (tmp != 0) {
            consume_skb(newskb);
            newskb = (struct sk_buff *)0;
          } else {
        ...
        if ((unsigned long )newskb != (unsigned long )((struct sk_buff *)0)) {
          ...
          dma_unmap_single_attrs(bp->bus_dev, dma_addr, 4608UL, 2, (struct dma_attrs *)0);
          skb_reserve(skb, 4);
      ...
      if ((unsigned long )newskb == (unsigned long )((struct sk_buff *)0)) {
        skb = netdev_alloc_skb(bp->dev, pkt_len + 3U);
      } else {
      }
      if ((unsigned long )skb == (unsigned long )((struct sk_buff *)0)) {
        ...
        if (rx_in_place == 0) {
          dma_sync_single_for_cpu(bp->bus_dev, dma_addr + 4ULL, (size_t )(pkt_len + 3U),
                                  2);
...
static netdev_tx_t dfx_xmt_queue_pkt(struct sk_buff *skb , struct net_device *dev )
{
  ...
  *(skb->data + 1UL) = 56U;
  *(skb->data + 2UL) = 0U;
  dma_addr = dma_map_single_attrs(bp->bus_dev, (void *)skb->data, (size_t )skb->len,
                                  1, (struct dma_attrs *)0);
  tmp___1 = dma_mapping_error(bp->bus_dev, dma_addr);
  if (tmp___1 != 0) {
    skb_pull(skb, 3U);
    return (16);
  } else {
  ...
  tmp___2 = prod;
  prod = (u8 )((int )prod + 1);
  p_xmt_drv_descr = (XMT_DRIVER_DESCR *)(& bp->xmt_drv_descr_blk) + (unsigned long )tmp___2;
  p_xmt_descr->long_0 = (skb->len << 16) | 3221225472U;
  p_xmt_descr->long_1 = (unsigned int )dma_addr;
...
static void dfx_rcv_flush(DFX_board_t *bp )
{
  ...
  if ((unsigned long )skb != (unsigned long )((struct sk_buff *)0)) {
    dma_unmap_single_attrs(bp->bus_dev, (dma_addr_t )(bp->descr_block_virt)->rcv_data[i + j].long_1,
                           4608UL, 2, (struct dma_attrs *)0);
    consume_skb(skb);
  } else {
  }
...
struct pci_device_id const __mod_pci__dfx_pci_table_device_table[2U] ;
static struct pci_driver dfx_pci_driver =
...
static int dfx_init(void)
{
  int status ;
  {
  status = ldv___pci_register_driver_45(& dfx_pci_driver, & __this_module, "defxx");
  if (status == 0) {
...
static void dfx_cleanup(void)
{
  ...
  ldv_pci_unregister_driver_46(& dfx_pci_driver);
  return;
}
}
...
void ldv_pci_driver_2(void)
{
  ...
  dfx_pci_driver_group1 = (struct pci_dev *)tmp;
  return;
}
}
void choose_interrupt_1(void)
...
int main(void)
{
  ...
  if (ldv_state_variable_2 != 0) {
    ...
    if (ldv_state_variable_2 == 1) {
      ldv_retval_3 = dfx_pci_register(dfx_pci_driver_group1, (struct pci_device_id const *)ldvarg2);
      if (ldv_retval_3 == 0) {
    ...
    if (ldv_state_variable_2 == 2) {
      dfx_pci_unregister(dfx_pci_driver_group1);
