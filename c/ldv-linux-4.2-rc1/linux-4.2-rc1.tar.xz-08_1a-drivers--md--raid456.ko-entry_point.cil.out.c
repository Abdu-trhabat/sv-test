...
bool ldv_queue_work_on_7(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                         struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_10(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                          struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_11(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                          struct work_struct *ldv_func_arg3 ) ;
...
void ldv_flush_workqueue_12(struct workqueue_struct *ldv_func_arg1 ) ;
...
int ldv_register_md_personality_13(struct md_personality *p ) ;
int ldv_register_md_personality_14(struct md_personality *p ) ;
int ldv_register_md_personality_15(struct md_personality *p ) ;
extern int unregister_md_personality(struct md_personality * ) ;
int ldv_unregister_md_personality_16(struct md_personality *p ) ;
int ldv_unregister_md_personality_17(struct md_personality *p ) ;
int ldv_unregister_md_personality_18(struct md_personality *p ) ;
...
{ 
  ...
  _raw_spin_lock_nest_lock(tmp, & ((spinlock_t *)(& conf->hash_locks))->__annonCompField18.__annonCompField17.dep_map);
  i = i + 1;
  ldv_39418: ;
  if (i <= 7) {
    goto ldv_39417;
...
{ 
  ...
  ldv_queue_work_on_10(sh->cpu, raid5_wq, & (group->workers)->work);
  ...
  if (! (group->workers + (unsigned long )i)->working) {
    ...
    ldv_queue_work_on_11(sh->cpu, raid5_wq, & (group->workers + (unsigned long )i)->work);
...
{ 
  ...
  tmp___0 = ldv__builtin_expect(tmp == 0, 0L);
  if (tmp___0 != 0L) {
    __asm__  volatile   ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/918/dscv_tempdir/dscv/ri/08_1a/drivers/md/raid5.c"),
                         "i" (296), "i" (12UL));
    ldv_39501: ;
    goto ldv_39501;
  } else {
...
{ 
  ...
  descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/918/dscv_tempdir/dscv/ri/08_1a/drivers/md/raid5.c";
...
{ 
  ...
  tmp = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp != 0L) {
    warn_slowpath_null("/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/918/dscv_tempdir/dscv/ri/08_1a/drivers/md/raid5.c",
                       498);
  } else {
...
{ 
  ...
  descriptor___0.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/918/dscv_tempdir/dscv/ri/08_1a/drivers/md/raid5.c";
...
{ 
  ...
  if (tmp != 0 && ! __warned) {
    ...
    if (tmp___0 == 0) {
      __warned = 1;
      lockdep_rcu_suspicious("/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/918/dscv_tempdir/dscv/ri/08_1a/drivers/md/raid5.c",
...
{ 
  ...
  disks = sh->disks;
  head_sh = sh;
  __might_sleep("/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/918/dscv_tempdir/dscv/ri/08_1a/drivers/md/raid5.c",
                900, 0);
  i = disks;
  goto ldv_39844;
  ldv_39883: 
  ...
  if ((unsigned long )rdev == (unsigned long )((struct md_rdev *)0) && (unsigned long )rrdev == (unsigned long )((struct md_rdev *)0)) {
    ...
    descriptor___1.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/918/dscv_tempdir/dscv/ri/08_1a/drivers/md/raid5.c";
          ...
          if (tmp___25 == 0) {
            ...
            if (tmp___20 != 0) {
              ...
              if (tmp___21 != 0) {
                ...
                descriptor___2.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/918/dscv_tempdir/dscv/ri/08_1a/drivers/md/raid5.c";
...
{ 
  ...
  ___might_sleep("/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/918/dscv_tempdir/dscv/ri/08_1a/drivers/md/raid5.c",
                 5750, 0);
  _cond_resched();
  spin_lock_irq(& conf->device_lock);
  i = 0;
...
{ 
  ...
  if ((unsigned long )conf->worker_cnt_per_group != new) {
    ...
    if ((unsigned long )old_groups != (unsigned long )((struct r5worker_group *)0)) {
      ldv_flush_workqueue_12(raid5_wq);
    } else {
...
{ 
  ...
  ldv_register_md_personality_13(& raid6_personality);
  ldv_register_md_personality_14(& raid5_personality);
  ldv_register_md_personality_15(& raid4_personality);
  return (0);
}
}
...
{ 
  ...
  {
  ldv_unregister_md_personality_16(& raid6_personality);
  ldv_unregister_md_personality_17(& raid5_personality);
  ldv_unregister_md_personality_18(& raid4_personality);
  ldv_destroy_workqueue_19(raid5_wq);
  return;
}
}
...
#include "model/linux-4.2-rc1.tar.xz-08_1a-drivers--md--raid456.ko-entry_point_true-unreach-call.cil.out.env.c"
