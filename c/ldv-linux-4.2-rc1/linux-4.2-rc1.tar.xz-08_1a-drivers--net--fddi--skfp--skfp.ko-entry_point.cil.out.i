...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-08_1a-drivers--net--fddi--skfp--skfp.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
typedef enum ldv_28452 phy_interface_t;
enum ldv_28506 {
    MDIOBUS_ALLOCATED = 1,
...
static int skfp_init_one(struct pci_dev *pdev , struct pci_device_id const *ent )
{
  ...
  descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
...
static int skfp_driver_init(struct net_device *dev )
{
  ...
  __raw_spin_lock_init(& bp->DriverLock.__annonCompField18.rlock, "&(&bp->DriverLock)->rlock",
                       & __key);
  ...
  descriptor___0.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  descriptor___1.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if (tmp___6 != 0) {
    ...
    descriptor___2.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  descriptor___3.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
...
static int skfp_open(struct net_device *dev )
{
  ...
  err = ldv_request_irq_9((unsigned int )dev->irq, & skfp_interrupt, 128UL, (char const *)(& dev->name),
                          (void *)dev);
  if (err != 0) {
    return (err);
  } else {
...
static int skfp_close(struct net_device *dev )
{
  ...
  ldv_free_irq_10((unsigned int )dev->irq, (void *)dev);
...
static void skfp_ctl_set_multicast_list_wo_lock(struct net_device *dev )
{
  ...
  if ((dev->flags & 256U) != 0U) {
    ...
    if (dev->mc.count != 0) {
      ...
      descriptor___4.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
...
void ring_status_indication(struct s_smc *smc , u_long status )
{
  ...
  if ((status & 1024UL) != 0UL) {
    ...
    descriptor___5.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((status & 512UL) != 0UL) {
    ...
    descriptor___6.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((status & 256UL) != 0UL) {
    ...
    descriptor___7.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((status & 128UL) != 0UL) {
    ...
    descriptor___8.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((status & 64UL) != 0UL) {
    ...
    descriptor___9.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((status & 32UL) != 0UL) {
    ...
    descriptor___10.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((status & 16UL) != 0UL) {
    ...
    descriptor___11.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((status & 8UL) != 0UL) {
    ...
    descriptor___12.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((status & 4UL) != 0UL) {
    ...
    descriptor___13.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((status & 2UL) != 0UL) {
    ...
    descriptor___14.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  if ((int )status & 1) {
    ...
    descriptor___15.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
  ...
  descriptor___16.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11728/dscv_tempdir/dscv/ri/08_1a/drivers/net/fddi/skfp/skfddi.c";
...
static int skfddi_pci_driver_init(void)
{
  int tmp ;
  {
  tmp = ldv___pci_register_driver_11(& skfddi_pci_driver, & __this_module, "skfp");
  return (tmp);
}
}
...
{
  {
  ldv_pci_unregister_driver_12(& skfddi_pci_driver);
  return;
}
}
