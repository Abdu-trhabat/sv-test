...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-43_2a-drivers--scsi--advansys.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
void ldv_initialize_scsi_host_template_6(void)
{
  ...
  advansys_template_group2 = ldv_malloc(sizeof(struct scsi_device));
  return;
}
}
void choose_interrupt_1(void)
