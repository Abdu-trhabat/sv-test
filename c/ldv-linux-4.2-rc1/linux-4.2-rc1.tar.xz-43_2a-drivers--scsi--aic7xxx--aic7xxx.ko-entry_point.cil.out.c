...
typedef enum ldv_27761 cam_status;
enum ldv_27763 {
...
typedef enum ldv_27763 ac_code;
struct scsi_sense {
   uint8_t opcode ;
   uint8_t byte2 ;
   uint8_t unused[2U] ;
...
typedef enum ldv_27790 bus_space_tag_t;
...
typedef enum ldv_27840 ahc_chip;
...
typedef enum ldv_27844 ahc_bug;
enum ldv_27846 {
    AHC_FNONE = 0,
...
typedef enum ldv_27846 ahc_flag;
struct status_pkt {
...
typedef enum ldv_27908 ahc_msg_type;
struct scb_tailq {
...
typedef enum ldv_27984 ahc_search_action;
enum ldv_28002 {
    AHC_NEG_TO_GOAL = 0,
    AHC_NEG_IF_NON_ASYNC = 1,
    AHC_NEG_ALWAYS = 2
} ;
typedef enum ldv_28002 ahc_neg_type;
enum ldv_28010 {
    AHC_QUEUE_NONE = 0,
    AHC_QUEUE_BASIC = 1,
    AHC_QUEUE_TAGGED = 2
} ;
typedef enum ldv_28010 ahc_queue_alg;
enum ldv_28025 {
...
typedef enum ldv_28025 ahc_linux_dev_flags;
...
typedef enum ldv_28437 ahc_msgtype;
...
typedef enum ldv_28193 seeprom_chip_t;
struct seeprom_descriptor {
...
void ldv_free_irq_126(unsigned int ldv_func_arg1 , void *ldv_func_arg2 ) ;
...
struct Scsi_Host *ldv_scsi_host_alloc_125(struct scsi_host_template *sht , int privsize ) ;
...
{ 
  ...
  {
  tmp = ldv_scsi_add_host_with_dma_124(host, dev, dev);
  return (tmp);
}
}
...
{ 
  ...
  tmp___1 = ldv__builtin_expect((unsigned long )*ahc_targp != (unsigned long )((struct scsi_target *)0),
                             0L);
  if (tmp___1 != 0L) {
    __asm__  volatile   ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/3246/dscv_tempdir/dscv/ri/43_2a/drivers/scsi/aic7xxx/aic7xxx_osm.c"),
                         "i" (582), "i" (12UL));
    ldv_38482: ;
    goto ldv_38482;
  } else {
...
{ 
  ...
  host = ldv_scsi_host_alloc_125(template, 8);
...
{ 
  ...
  if ((unsigned long )ahc->platform_data != (unsigned long )((struct ahc_platform_data *)0)) {
    ...
    if ((ahc->platform_data)->irq != 4294967295U) {
      ldv_free_irq_126((ahc->platform_data)->irq, (void *)ahc);
    } else {
...
{ 
  ...
  if (tmp___1 != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/3246/dscv_tempdir/dscv/ri/43_2a/drivers/scsi/aic7xxx/aic7xxx_osm.c",
                       1673);
  } else {
...
{ 
  ...
  {
  ldv_spin_unlock();
  ldv_spin_unlock_irqrestore_112(lock, flags);
  return;
}
}
int ldv_scsi_add_host_with_dma_124(struct Scsi_Host *shost , struct device *dev ,
...
int ldv_scsi_add_host_with_dma_153(struct Scsi_Host *shost , struct device *dev ,
                                   struct device *dma_dev ) ;
__inline static void ahc_unlock___0(struct ahc_softc *ahc , unsigned long *flags ) 
{ 
...
int ldv___pci_register_driver_180(struct pci_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
                                  char const   *ldv_func_arg3 ) ;
extern void pci_unregister_driver(struct pci_driver * ) ;
void ldv_pci_unregister_driver_181(struct pci_driver *ldv_func_arg1 ) ;
...
__inline static int ldv_request_irq_182(unsigned int irq , irqreturn_t (*handler)(int  ,
                                                                                  void * ) ,
...
void ldv_scsi_remove_host_179(struct Scsi_Host *shost ) ;
__inline static void ahc_unlock___1(struct ahc_softc *ahc , unsigned long *flags ) 
{ 
...
{ 
  ...
  if ((unsigned long )ahc->platform_data != (unsigned long )((struct ahc_platform_data *)0) && (unsigned long )(ahc->platform_data)->host != (unsigned long )((struct Scsi_Host *)0)) {
    ldv_scsi_remove_host_179((ahc->platform_data)->host);
  } else {

  }
  ahc_lock(ahc, & s);
  ahc_intr_enable(ahc, 0);
  ahc_unlock___1(ahc, & s);
  ahc_free(ahc);
  return;
}
}
...
{ 
  ...
  {
  tmp = ldv___pci_register_driver_180(& aic7xxx_pci_driver, & __this_module, "aic7xxx");
  return (tmp);
}
}
void ahc_linux_pci_exit(void) 
{ 
  ...
  {
  ldv_pci_unregister_driver_181(& aic7xxx_pci_driver);
  return;
}
}
...
{ 
  ...
  {
  error = ldv_request_irq_182((ahc->dev_softc)->irq, & ahc_linux_isr, 128UL, "aic7xxx",
                              (void *)ahc);
  if (error == 0) {
...
#include "model/linux-4.2-rc1.tar.xz-43_2a-drivers--scsi--aic7xxx--aic7xxx.ko-entry_point_true-unreach-call.cil.out.env.c"
