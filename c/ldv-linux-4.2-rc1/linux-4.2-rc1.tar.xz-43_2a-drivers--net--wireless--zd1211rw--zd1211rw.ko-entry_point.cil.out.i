...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-43_2a-drivers--net--wireless--zd1211rw--zd1211rw.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
typedef enum ldv_18311 socket_state;
...
union __anonunion____missing_field_name_291 {
   struct __anonstruct____missing_field_name_292 __annonCompField77 ;
   u64 hash_len ;
};
struct qstr {
   union __anonunion____missing_field_name_291 __annonCompField78 ;
   unsigned char const *name ;
};
struct dentry_operations;
union __anonunion_d_u_293 {
...
struct __anonstruct_kprojid_t_301 {
   projid_t val ;
};
typedef struct __anonstruct_kprojid_t_301 kprojid_t;
enum quota_type {
    USRQUOTA = 0,
    GRPQUOTA = 1,
    PRJQUOTA = 2
...
struct inode {
   ...
   void *i_security ;
   unsigned long i_ino ;
   union __anonunion____missing_field_name_305 __annonCompField83 ;
   dev_t i_rdev ;
   loff_t i_size ;
   ...
   union __anonunion____missing_field_name_306 __annonCompField84 ;
   u64 i_version ;
   atomic_t i_count ;
...
union __anonunion_f_u_308 {
   struct llist_node fu_llist ;
   struct callback_head fu_rcuhead ;
};
struct file {
   union __anonunion_f_u_308 f_u ;
   struct path f_path ;
...
struct __anonstruct_afs_310 {
   struct list_head link ;
   int state ;
};
union __anonunion_fl_u_309 {
   struct nfs_lock_info nfs_fl ;
   struct nfs4_lock_info nfs4_fl ;
   struct __anonstruct_afs_310 afs ;
};
struct file_lock {
   ...
   union __anonunion_fl_u_309 fl_u ;
};
struct file_lock_context {
   spinlock_t flc_lock ;
...
typedef enum ldv_28303 phy_interface_t;
enum ldv_28357 {
    MDIOBUS_ALLOCATED = 1,
...
bool ldv_cancel_work_sync_42(struct work_struct *ldv_func_arg1 ) ;
                                        ...
                                        unsigned int count )
{
  ...
  if (tmp___1 != 0L) {
    ...
    descriptor.filename = "/home/ldvuser/mutilin/launch/inst/current/envs/linux-4.2-rc1.tar.xz/linux-4.2-rc1/drivers/net/wireless/zd1211rw/zd_chip.h";
    descriptor.format = "%s:%d ASSERT %s VIOLATED!\n";
    descriptor.lineno = 812U;
    descriptor.flags = 1U;
    tmp = ldv__builtin_expect((long )descriptor.flags & 1L, 0L);
    if (tmp != 0L) {
      __dynamic_pr_debug(& descriptor, "%s:%d ASSERT %s VIOLATED!\n", (char *)"/home/ldvuser/mutilin/launch/inst/current/envs/linux-4.2-rc1.tar.xz/linux-4.2-rc1/drivers/net/wireless/zd1211rw/zd_chip.h",
...
void zd_chip_clear(struct zd_chip *chip )
{
  ...
  if (tmp___1 != 0L) {
    ...
    descriptor.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_chip.c";
    descriptor.format = "%s:%d ASSERT %s VIOLATED!\n";
    descriptor.lineno = 46U;
    descriptor.flags = 1U;
    tmp = ldv__builtin_expect((long )descriptor.flags & 1L, 0L);
    if (tmp != 0L) {
      __dynamic_pr_debug(& descriptor, "%s:%d ASSERT %s VIOLATED!\n", (char *)"/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_chip.c",
                        ...
                        unsigned int count )
{
  ...
  if (tmp != 0L) {
    __asm__ volatile ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_chip.c"),
                         "i" (119), "i" (12UL));
    ldv_51224: ;
    goto ldv_51224;
  } else {
...
void zd_chip_disable_int(struct zd_chip *chip )
{
  ...
  mutex_unlock(& chip->mutex);
  tmp = zd_chip_to_mac(chip);
  ldv_cancel_work_sync_42(& tmp->process_intr);
  return;
}
}
int zd_chip_enable_rxtx(struct zd_chip *chip )
...
__inline static void ldv_spin_unlock_irq_59(spinlock_t *lock )
{
  {
...
bool ldv_cancel_delayed_work_sync_93(struct delayed_work *ldv_func_arg1 ) ;
...
struct sk_buff *ldv_skb_clone_81(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_clone_89(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_copy_83(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
...
int ldv_pskb_expand_head_87(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                            gfp_t flags ) ;
int ldv_pskb_expand_head_88(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                            gfp_t flags ) ;
__inline static bool skb_queue_is_first(struct sk_buff_head const *list , struct sk_buff const *skb )
{
  {
  return ((unsigned long )((struct sk_buff const *)skb->__annonCompField68.__annonCompField67.prev) == (unsigned long )((struct sk_buff const *)list));
}
}
...
__inline static struct sk_buff *netdev_alloc_skb(struct net_device *dev , unsigned int length )
{
  struct sk_buff *tmp ;
  {
  tmp = ldv___netdev_alloc_skb_84(dev, length, 32U);
  return (tmp);
}
}
...
__inline static struct ieee80211_hw *ldv_ieee80211_alloc_hw_92(size_t priv_data_len ,
...
int zd_mac_init_hw(struct ieee80211_hw *hw )
{
  ...
  if (tmp___2 != 0L) {
    ...
    descriptor.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_mac.c";
    descriptor.format = "%s:%d ASSERT %s VIOLATED!\n";
    descriptor.lineno = 208U;
    descriptor.flags = 1U;
    tmp___0 = ldv__builtin_expect((long )descriptor.flags & 1L, 0L);
    if (tmp___0 != 0L) {
      __dynamic_pr_debug(& descriptor, "%s:%d ASSERT %s VIOLATED!\n", (char *)"/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_mac.c",
...
void zd_mac_clear(struct zd_mac *mac )
{
  ...
  long tmp___1 ;
  {
  ldv_flush_workqueue_90(zd_workqueue);
...
void zd_op_stop(struct ieee80211_hw *hw )
{
  ...
  ldv_flush_workqueue_91(zd_workqueue);
                             ...
                             struct tx_status *tx_status )
{
  ...
  first_idx = (int )info->__annonCompField99.status.rates[0].idx;
  ...
  if (tmp___3 != 0L) {
    ...
    descriptor___0.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_mac.c";
  ...
  info->__annonCompField99.status.rates[0].idx = (s8 )retries->rate[0];
  info->__annonCompField99.status.rates[0].count = 1U;
  i = 1;
  goto ldv_51535;
  ldv_51534:
  info->__annonCompField99.status.rates[i].idx = (s8 )retries->rate[i];
  info->__annonCompField99.status.rates[i].count = 1U;
  i = i + 1;
  ldv_51535: ;
  if (i <= 2 && i < retry) {
    goto ldv_51534;
  ...
  goto ldv_51538;
  ldv_51537:
  info->__annonCompField99.status.rates[i].idx = (s8 )retries->rate[retry + -1];
  info->__annonCompField99.status.rates[i].count = 1U;
  i = i + 1;
  ldv_51538: ;
  if (i <= 3 && i < retry) {
  ...
  if (i <= 3) {
    info->__annonCompField99.status.rates[i].idx = -1;
  } else {
  }
  info->__annonCompField99.status.ack_signal = zd_check_signal(hw, ackssi);
...
void zd_mac_tx_failed(struct urb *urb )
{
  ...
  first_idx = (int )info->__annonCompField99.status.rates[0].idx;
  tmp___6 = ldv__builtin_expect((long )(first_idx < 0 || (unsigned int )first_idx > 11U),
                             0L);
  if (tmp___6 != 0L) {
    descriptor.modname = "zd1211rw";
...
void zd_mac_tx_to_dev(struct sk_buff *skb , int error )
{
  ...
  tmp = IEEE80211_SKB_CB(skb);
  info = tmp;
  hw = (struct ieee80211_hw *)info->__annonCompField99.__annonCompField98.rate_driver_data[0];
  tmp___0 = zd_hw_mac(hw);
  mac = tmp___0;
  ieee80211_tx_info_clear_status(info);
  skb_pull(skb, 11U);
                           ...
                           struct ieee80211_tx_info *info )
{
  ...
  if ((int )info->__annonCompField99.control.__annonCompField97.__annonCompField96.rates[0].flags & 1) {
    cs->control = (u8 )((unsigned int )cs->control | 32U);
  } else {
  }
  if (((int )info->__annonCompField99.control.__annonCompField97.__annonCompField96.rates[0].flags & 2) != 0) {
                                ...
                                bool in_intr )
{
  ...
  if (tmp___5 != 0L) {
    __asm__ volatile ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_mac.c"),
                         "i" (794), "i" (12UL));
    ldv_51653: ;
    goto ldv_51653;
  } else {
...
static int fill_ctrlset(struct zd_mac *mac , struct sk_buff *skb )
{
  ...
  if (((int )info->__annonCompField99.control.__annonCompField97.__annonCompField96.rates[0].flags & 4) != 0) {
                     ...
                     struct sk_buff *skb )
{
  ...
  info->__annonCompField99.__annonCompField98.rate_driver_data[0] = (void *)hw;
...
struct ieee80211_hw *zd_mac_alloc_hw(struct usb_interface *intf )
{
  ...
  {
  hw = ldv_ieee80211_alloc_hw_92(13688UL, & zd_ops);
  ...
  __raw_spin_lock_init(& mac->lock.__annonCompField18.rlock, "&(&mac->lock)->rlock",
                       & __key);
  mac->hw = hw;
  mac->type = 0;
...
static void beacon_disable(struct zd_mac *mac )
{
  ...
  dev_printk("\017", (struct device const *)(& (mac->chip.usb.intf)->dev), "%s() \n",
             "beacon_disable");
  ldv_cancel_delayed_work_sync_93(& mac->beacon.watchdog_work);
  zd_mac_free_cur_beacon(mac);
  return;
}
}
...
static void housekeeping_disable(struct zd_mac *mac )
{
  ...
  ldv_cancel_delayed_work_sync_94(& mac->housekeeping.link_led_work);
...
__inline static void spin_unlock_irqrestore(spinlock_t *lock , unsigned long flags )
{
  {
  ldv_spin_unlock();
  ldv_spin_unlock_irqrestore_60(lock, flags);
  return;
}
}
bool ldv_queue_work_on_63(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
...
struct sk_buff *ldv_skb_clone_137(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_clone_145(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_copy_139(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
...
struct sk_buff *ldv_skb_clone_321(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_clone_329(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_copy_323(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
...
struct sk_buff *ldv___netdev_alloc_skb_325(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_326(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
...
int zd_rf_init_hw(struct zd_rf *rf , u8 type )
{
  ...
  if (tmp___2 != 0L) {
    ...
    descriptor.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_rf.c";
    descriptor.format = "%s:%d ASSERT %s VIOLATED!\n";
    descriptor.lineno = 76U;
    descriptor.flags = 1U;
    tmp___0 = ldv__builtin_expect((long )descriptor.flags & 1L, 0L);
    if (tmp___0 != 0L) {
      __dynamic_pr_debug(& descriptor, "%s:%d ASSERT %s VIOLATED!\n", (char *)"/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_rf.c",
...
__inline static void ldv_spin_lock_339(spinlock_t *lock )
{
  {
...
__inline static void spin_lock_irq(spinlock_t *lock ) ;
__inline static void ldv_spin_unlock_343(spinlock_t *lock )
{
  {
...
void ldv_destroy_workqueue_392(struct workqueue_struct *ldv_func_arg1 ) ;
void ldv_destroy_workqueue_394(struct workqueue_struct *ldv_func_arg1 ) ;
...
bool ldv_cancel_delayed_work_sync_384(struct delayed_work *ldv_func_arg1 ) ;
bool ldv_cancel_delayed_work_sync_388(struct delayed_work *ldv_func_arg1 ) ;
__inline static bool queue_work(struct workqueue_struct *wq , struct work_struct *work )
{
  bool tmp ;
  {
  tmp = ldv_queue_work_on_349(8192, wq, work);
  return (tmp);
}
}
                                            ...
                                            unsigned long delay )
{
  bool tmp ;
  {
  tmp = ldv_queue_delayed_work_on_350(8192, wq, dwork, delay);
  return (tmp);
}
}
...
struct sk_buff *ldv_skb_clone_367(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_clone_375(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_copy_369(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
...
int ldv_pskb_expand_head_373(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
int ldv_pskb_expand_head_374(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
...
int ldv_usb_register_driver_391(struct usb_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
                                char const *ldv_func_arg3 ) ;
extern void usb_deregister(struct usb_driver * ) ;
void ldv_usb_deregister_393(struct usb_driver *arg ) ;
...
struct urb *ldv_usb_alloc_urb_377(int ldv_func_arg1 , gfp_t flags ) ;
struct urb *ldv_usb_alloc_urb_381(int ldv_func_arg1 , gfp_t flags ) ;
struct urb *ldv_usb_alloc_urb_386(int ldv_func_arg1 , gfp_t flags ) ;
struct urb *ldv_usb_alloc_urb_396(int ldv_func_arg1 , gfp_t flags ) ;
extern void usb_free_urb(struct urb * ) ;
int ldv_usb_submit_urb_376(struct urb *ldv_func_arg1 , gfp_t flags ) ;
int ldv_usb_submit_urb_379(struct urb *ldv_func_arg1 , gfp_t flags ) ;
int ldv_usb_submit_urb_380(struct urb *ldv_func_arg1 , gfp_t flags ) ;
int ldv_usb_submit_urb_383(struct urb *ldv_func_arg1 , gfp_t flags ) ;
int ldv_usb_submit_urb_385(struct urb *ldv_func_arg1 , gfp_t flags ) ;
int ldv_usb_submit_urb_387(struct urb *ldv_func_arg1 , gfp_t flags ) ;
int ldv_usb_submit_urb_395(struct urb *ldv_func_arg1 , gfp_t flags ) ;
...
void *ldv_usb_alloc_coherent_378(struct usb_device *ldv_func_arg1 , size_t ldv_func_arg2 ,
                                 gfp_t flags , dma_addr_t *ldv_func_arg4 ) ;
void *ldv_usb_alloc_coherent_382(struct usb_device *ldv_func_arg1 , size_t ldv_func_arg2 ,
                                 gfp_t flags , dma_addr_t *ldv_func_arg4 ) ;
...
void ldv_ieee80211_free_hw_389(struct ieee80211_hw *ldv_func_arg1 ) ;
void ldv_ieee80211_free_hw_390(struct ieee80211_hw *ldv_func_arg1 ) ;
...
__inline static void handle_regs_int(struct urb *urb )
{
  ...
  if (tmp___1 != 0L) {
    ...
    descriptor.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_usb.c";
    descriptor.format = "%s:%d ASSERT %s VIOLATED!\n";
    descriptor.lineno = 391U;
    descriptor.flags = 1U;
    tmp = ldv__builtin_expect((long )descriptor.flags & 1L, 0L);
    if (tmp != 0L) {
      __dynamic_pr_debug(& descriptor, "%s:%d ASSERT %s VIOLATED!\n", (char *)"/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_usb.c",
...
static void int_urb_complete(struct urb *urb )
{
  ...
  ldv_51456: ;
  resubmit:
  r = ldv_usb_submit_urb_376(urb, 32U);
  if (r != 0) {
...
int zd_usb_enable_int(struct zd_usb *usb )
{
  ...
  urb = ldv_usb_alloc_urb_377(0, 208U);
  ...
  spin_unlock_irq(& intr->lock);
  r = -12;
  intr->buffer = ldv_usb_alloc_coherent_378(udev, 64UL, 208U, & intr->buffer_dma);
  ...
  r = ldv_usb_submit_urb_379(urb, 208U);
  if (r != 0) {
...
static void rx_urb_complete(struct urb *urb )
{
  ...
  if (rx->fragment_length != 0U) {
    ...
    if (tmp___2 != 0L) {
      ...
      descriptor___0.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_usb.c";
      descriptor___0.format = "%s:%d ASSERT %s VIOLATED!\n";
  ...
  resubmit:
  r = ldv_usb_submit_urb_380(urb, 32U);
  if (r != 0) {
...
static struct urb *alloc_rx_urb(struct zd_usb *usb )
{
  ...
  tmp = zd_usb_to_usbdev(usb);
  udev = tmp;
  urb = ldv_usb_alloc_urb_381(0, 208U);
  if ((unsigned long )urb == (unsigned long )((struct urb *)0)) {
    return ((struct urb *)0);
  } else {
  }
  buffer = ldv_usb_alloc_coherent_382(udev, 4800UL, 208U, & urb->transfer_dma);
  if ((unsigned long )buffer == (unsigned long )((void *)0)) {
    usb_free_urb(urb);
    return ((struct urb *)0);
  } else {
...
static int __zd_usb_enable_rx(struct zd_usb *usb )
{
  ...
  *(urbs + (unsigned long )i) = alloc_rx_urb(usb);
  ...
  goto ldv_51574;
  ldv_51573:
  r = ldv_usb_submit_urb_383(*(urbs + (unsigned long )i), 208U);
  if (r != 0) {
    goto error_submit;
  } else {
  }
...
void zd_usb_disable_rx(struct zd_usb *usb )
{
  ...
  ldv_cancel_delayed_work_sync_384(& rx->idle_work);
  return;
}
}
...
void zd_usb_disable_tx(struct zd_usb *usb )
{
  ...
  tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp___0 != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_usb.c",
                       903);
  } else {
  }
...
static void tx_urb_complete(struct urb *urb )
{
  ...
  info = IEEE80211_SKB_CB(skb);
  tmp = zd_hw_mac((struct ieee80211_hw *)info->__annonCompField99.__annonCompField98.rate_driver_data[0]);
  usb = & tmp->chip.usb;
  tx = & usb->tx;
  switch (urb->status) {
  case 0: ;
  ...
  r = ldv_usb_submit_urb_385(urb, 32U);
  if (r != 0) {
...
int zd_usb_tx(struct zd_usb *usb , struct sk_buff *skb )
{
  ...
  urb = ldv_usb_alloc_urb_386(0, 32U);
  if ((unsigned long )urb == (unsigned long )((struct urb *)0)) {
    r = -12;
    goto out;
  } else {
  ...
  info->__annonCompField99.__annonCompField98.rate_driver_data[1] = (void *)jiffies;
  skb_queue_tail(& tx->submitted_skbs, skb);
  usb_anchor_urb(urb, & tx->submitted);
  r = ldv_usb_submit_urb_387(urb, 32U);
  if (r != 0) {
...
static bool zd_tx_timeout(struct zd_usb *usb )
{
  ...
  ldv_spin_lock();
  skb = q->next;
  skbnext = skb->__annonCompField68.__annonCompField67.next;
  goto ldv_51683;
  ldv_51682:
  info = IEEE80211_SKB_CB(skb);
  trans_start = (unsigned long )info->__annonCompField99.__annonCompField98.rate_driver_data[1];
...
void zd_tx_watchdog_disable(struct zd_usb *usb )
{
  ...
  if ((unsigned int )*((unsigned char *)tx + 588UL) != 0U) {
    ...
    ldv_cancel_delayed_work_sync_388(& tx->watchdog_work);
  } else {
  }
  return;
}
...
__inline static void init_usb_interrupt(struct zd_usb *usb )
{
  ...
  __raw_spin_lock_init(& intr->lock.__annonCompField18.rlock, "&(&intr->lock)->rlock",
                       & __key);
  tmp = zd_usb_to_usbdev(usb);
...
__inline static void init_usb_rx(struct zd_usb *usb )
{
  ...
  __raw_spin_lock_init(& rx->lock.__annonCompField18.rlock, "&(&rx->lock)->rlock",
                       & __key);
...
static int usb_init(void)
{
  ...
  r = ldv_usb_register_driver_391(& driver, & __this_module, "zd1211rw");
  if (r != 0) {
    ldv_destroy_workqueue_392(zd_workqueue);
...
static void usb_exit(void)
{
  ...
  ldv_usb_deregister_393(& driver);
  ldv_destroy_workqueue_394(zd_workqueue);
  return;
}
}
                     ...
                     unsigned int count )
{
  ...
  if (tmp___5 != 0L) {
    __asm__ volatile ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_usb.c"),
                         "i" (1742), "i" (12UL));
    ldv_51935: ;
    goto ldv_51935;
  } else {
...
static int zd_submit_waiting_urb(struct zd_usb *usb , bool last )
{
  ...
  r = ldv_usb_submit_urb_395(urb, 208U);
  if (r != 0) {
    usb_unanchor_urb(urb);
...
void zd_usb_iowrite16v_async_start(struct zd_usb *usb )
{
  ...
  if (tmp___5 != 0L) {
    ...
    descriptor___1.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_usb.c";
  ...
  if (tmp___9 != 0L) {
    ...
    descriptor___2.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11171/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/zd1211rw/zd_usb.c";
                            ...
                            unsigned int count )
{
  ...
  urb = ldv_usb_alloc_urb_396(0, 208U);
  if ((unsigned long )urb == (unsigned long )((struct urb *)0)) {
    return (-12);
  } else {
  }
