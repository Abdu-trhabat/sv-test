...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-08_1a-drivers--net--ethernet--mellanox--mlx5--core--mlx5_core.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
typedef enum ldv_27764 phy_interface_t;
enum ldv_27818 {
    MDIOBUS_ALLOCATED = 1,
...
int mlx5_core_get_caps(struct mlx5_core_dev *dev , enum mlx5_cap_type cap_type , enum mlx5_cap_mode cap_mode )
{
  ...
  out = kzalloc((size_t )out_sz, 208U);
...
static int handle_hca_cap(struct mlx5_core_dev *dev )
{
  ...
  err = -12;
  set_sz = 4112;
  set_ctx = kzalloc((size_t )set_sz, 208U);
  ...
  descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/main.c";
...
void *mlx5_get_protocol_dev(struct mlx5_core_dev *mdev , int protocol )
{
  ...
  priv = & mdev->priv;
  result = (void *)0;
  tmp = spinlock_check(& priv->ctx_lock);
...
static int init(void)
{
  ...
  mlx5_health_init();
  err = ldv___pci_register_driver_10(& mlx5_core_driver, & __this_module, "mlx5_core");
  if (err != 0) {
    goto err_health;
  } else {
  }
  ...
  err_health:
  mlx5_health_cleanup();
  ldv_destroy_workqueue_11(mlx5_core_wq);
  err_debug:
...
static void cleanup(void)
{
  {
  mlx5e_cleanup();
  ldv_pci_unregister_driver_12(& mlx5_core_driver);
  mlx5_health_cleanup();
  ldv_destroy_workqueue_13(mlx5_core_wq);
  mlx5_unregister_debugfs();
  return;
}
}
...
void ldv_destroy_workqueue_34(struct workqueue_struct *ldv_func_arg1 ) ;
...
static int alloc_ent(struct mlx5_cmd *cmd )
{
  ...
  unsigned long tmp___0 ;
  {
  tmp = spinlock_check(& cmd->alloc_lock);
  flags = _raw_spin_lock_irqsave(tmp);
  tmp___0 = find_first_bit((unsigned long const *)(& cmd->bitmask), (unsigned long )cmd->max_reg_cmds);
  ret = (int )tmp___0;
...
static void dump_buf(void *buf , int size , int data_only , int offset )
{
  ...
  descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/cmd.c";
  ...
  if (data_only == 0) {
    ...
    descriptor___0.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/cmd.c";
                         ...
                         int input )
{
  ...
  if (data_only != 0) {
    ...
    descriptor___1.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/cmd.c";
  ...
  if (data_only != 0) {
    ...
    descriptor___2.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/cmd.c";
...
static void free_msg(struct mlx5_core_dev *dev , struct mlx5_cmd_msg *msg )
{
  ...
  if ((unsigned long )msg->cache != (unsigned long )((struct cache_ent *)0)) {
    tmp = spinlock_check(& (msg->cache)->lock);
    flags = _raw_spin_lock_irqsave(tmp);
  ...
  if (tmp___3 != 0) {
    ...
    if ((unsigned long )ent->callback != (unsigned long )((void (*)(int , void * ))0)) {
      ...
      if ((unsigned int )ent->op <= 2335U) {
        ...
        tmp___2 = spinlock_check(& stats->lock);
...
int mlx5_cmd_init(struct mlx5_core_dev *dev )
{
  ...
  return (0);
  err_wq:
  ldv_destroy_workqueue_34(cmd->wq);
  err_cache:
  destroy_msg_cache(dev);
  err_free_page:
...
void mlx5_cmd_cleanup(struct mlx5_core_dev *dev )
{
  ...
  cmd = & dev->cmd;
  clean_debug_files(dev);
  ldv_destroy_workqueue_35(cmd->wq);
  destroy_msg_cache(dev);
  free_cmd_page(dev, cmd);
  dma_pool_destroy(cmd->pool);
  return;
...
int mlx5_query_board_id(struct mlx5_core_dev *dev )
{
  ...
  {
  outlen = 272;
  tmp = kzalloc((size_t )outlen, 208U);
  out = (u32 *)tmp;
...
static int mlx5_eq_int(struct mlx5_core_dev *dev , struct mlx5_eq *eq )
{
  ...
  descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/eq.c";
  ...
  descriptor___0.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/eq.c";
  ...
  descriptor___1.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/eq.c";
  ...
  descriptor___2.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/eq.c";
                       ...
                       int nent , u64 mask , char const *name , struct mlx5_uar *uar )
{
  ...
  err = ldv_request_irq_82((priv->msix_arr + (unsigned long )vecidx)->vector, & mlx5_msix_handler,
  ...
  return (0);
  err_irq:
  ldv_free_irq_83((priv->msix_arr + (unsigned long )vecidx)->vector, (void *)eq);
  err_eq:
...
int mlx5_destroy_unmap_eq(struct mlx5_core_dev *dev , struct mlx5_eq *eq )
{
  ...
  ldv_free_irq_84((dev->priv.msix_arr + (unsigned long )eq->irqn)->vector, (void *)eq);
...
int mlx5_alloc_uuars(struct mlx5_core_dev *dev , struct mlx5_uuar_info *uuari )
{
  ...
  descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/uar.c";
...
static int give_pages(struct mlx5_core_dev *dev , u16 func_id , int npages , int notify_fail )
{
  ...
  descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/pagealloc.c";
...
static int reclaim_pages(struct mlx5_core_dev *dev , u32 func_id , int npages , int *nclaimed )
{
  ...
  tmp = mlx5_vzalloc((unsigned long )outlen);
...
{
  {
  ldv_destroy_workqueue_116(dev->priv.pg_wq);
  return;
}
}
void work_init_3(void)
...
int ldv_del_timer_sync_133(struct timer_list *ldv_func_arg1 ) ;
...
__inline static bool queue_work___1(struct workqueue_struct *wq , struct work_struct *work )
{
  bool tmp ;
  {
  tmp = ldv_queue_work_on_127(8192, wq, work);
  return (tmp);
}
}
...
static void poll_health(unsigned long data )
{
  ...
  if (health->miss_counter == 3) {
    ...
    ldv_mod_timer_132(& health->timer, next);
  }
  return;
}
}
...
void mlx5_stop_health_poll(struct mlx5_core_dev *dev )
{
  ...
  {
  health = & dev->priv.health;
  ldv_del_timer_sync_133(& health->timer);
  spin_lock_irq(& health_lock);
                        ...
                        int inlen )
{
  ...
  if (err != 0) {
    ...
    descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/cq.c";
                              ...
                              struct mlx5_create_srq_mbox_in *in , int srq_inlen )
{
  ...
  create_in = mlx5_vzalloc((unsigned long )inlen);
...
int mlx5_db_alloc(struct mlx5_core_dev *dev , struct mlx5_db *db )
{
  ...
  if (tmp___1 != 0L) {
    warn_slowpath_null("/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/alloc.c",
                       141);
  } else {
  }
...
void mlx5_eq_pagefault(struct mlx5_core_dev *dev , struct mlx5_eqe *eqe )
{
  ...
  descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/qp.c";
  ...
  descriptor___0.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/qp.c";
  ...
  descriptor___1.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/qp.c";
  ...
  descriptor___2.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/qp.c";
  ...
  descriptor___3.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/qp.c";
  ...
  descriptor___4.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/qp.c";
  ...
  descriptor___5.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/qp.c";
                          ...
                          struct mlx5_create_mkey_mbox_out *out )
{
  ...
  if (err != 0) {
    ...
    descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/mr.c";
  ...
  if ((unsigned int )lout.hdr.status != 0U) {
    ...
    descriptor___0.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/mr.c";
  ...
  descriptor___1.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/mr.c";
                             ...
                             u16 vf_num , u16 gid_index , union ib_gid *gid )
{
  ...
  descriptor.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
                                 ...
                                 u16 vf_num , struct mlx5_hca_vport_context *rep )
{
  ...
  *((__be32 *)(& in)) = tmp___1;
  ...
  descriptor___0.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___1.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___2.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___3.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___4.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___5.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___6.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___7.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___8.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___9.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___10.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___11.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___12.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___13.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___14.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___15.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___16.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___17.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___18.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___19.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___20.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___21.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
  ...
  descriptor___22.filename = "/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/vport.c";
...
__inline static bool queue_work___2(struct workqueue_struct *wq , struct work_struct *work )
{
  bool tmp ;
  {
  tmp = ldv_queue_work_on_327(8192, wq, work);
  return (tmp);
}
}
                                        ...
                                        unsigned long delay )
{
  bool tmp ;
  {
  tmp = ldv_queue_delayed_work_on_328(8192, wq, dwork, delay);
  return (tmp);
}
}
...
{
  {
  ldv_flush_workqueue_330(system_wq);
  return;
}
}
...
void ldv_free_netdev_333(struct net_device *dev ) ;
void ldv_free_netdev_335(struct net_device *dev ) ;
...
int ldv_register_netdev_332(struct net_device *dev ) ;
extern void unregister_netdev(struct net_device * ) ;
void ldv_unregister_netdev_334(struct net_device *dev ) ;
...
static int mlx5e_enable_rq(struct mlx5e_rq *rq , struct mlx5e_rq_param *param )
{
  ...
  in = mlx5_vzalloc((unsigned long )inlen);
  if ((unsigned long )in == (unsigned long )((void *)0)) {
    return (-12);
  } else {
  }
...
int mlx5e_update_priv_params(struct mlx5e_priv *priv , struct mlx5e_params *new_params )
{
  ...
  tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp___0 != 0L) {
    warn_slowpath_null("/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/en_main.c",
                       1529);
  } else {
  }
  ldv__builtin_expect(__ret_warn_on != 0, 0L);
...
static void *mlx5e_create_netdev(struct mlx5_core_dev *mdev )
{
  ...
  err = ldv_register_netdev_332(netdev);
  if (err != 0) {
...
static void mlx5e_destroy_netdev(struct mlx5_core_dev *mdev , void *vpriv )
{
  ...
  priv = (struct mlx5e_priv *)vpriv;
  netdev = priv->netdev;
  ldv_unregister_netdev_334(netdev);
                                   ...
                                   int type )
{
  ...
  void *tmp___0 ;
  {
  tmp = mlx5_vzalloc(776UL);
  flow_context = (u32 *)tmp;
  tmp___0 = mlx5_vzalloc(512UL);
...
void mlx5e_enable_vlan_filter(struct mlx5e_priv *priv )
{
  ...
  tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp___0 != 0L) {
    warn_slowpath_null("/work/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--08_1a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11488/dscv_tempdir/dscv/ri/08_1a/drivers/net/ethernet/mellanox/mlx5/core/en_flow_table.c",
                       501);
  } else {
  }
  ldv__builtin_expect(__ret_warn_on != 0, 0L);
...
bool ldv_queue_work_on_363(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_365(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_delayed_work_on_364(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
bool ldv_queue_delayed_work_on_367(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_366(struct workqueue_struct *ldv_func_arg1 ) ;
