...
{ 
  ...
  if ((unsigned long )pti->phy_prep == (unsigned long )((int (*/* const  */)(struct cphy * ,
                                                                             struct adapter * ,
                                                                             int  ,
...
{ 
  ...
  {
  t3c_tid = (unsigned int )t->ntids > tid ? t->tid_tab + (unsigned long )tid : (struct t3c_tid_entry */* const  */)0;
...
#include "model/linux-4.2-rc1.tar.xz-08_1a-drivers--net--ethernet--chelsio--cxgb3--cxgb3.ko-entry_point_true-unreach-call.cil.out.env.c"
