...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-32_7a-drivers--block--rsxx--rsxx.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{
  {
  rsxx_err_handler_group0 = ldv_malloc(sizeof(struct pci_dev));
  return;
}
}
void ldv_file_operations_13(void)
