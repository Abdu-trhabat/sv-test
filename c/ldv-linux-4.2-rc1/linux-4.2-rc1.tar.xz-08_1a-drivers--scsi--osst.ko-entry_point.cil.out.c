...
__inline static int ldv_register_chrdev_5(unsigned int major , char const   *name ,
...
__inline static void ldv_unregister_chrdev_6(unsigned int major , char const   *name ) ;
__inline static void ldv_unregister_chrdev_6(unsigned int major , char const   *name ) ;
...
{ 
  ...
  tmp = tape_name(STp);
  name = tmp;
  tmp___0 = mutex_lock_interruptible_nested(& STp->lock, 0U);
  if (tmp___0 != 0) {
    return (-512L);
  } else {
...
{ 
  ...
  {
  mutex_lock_nested(& osst_int_mutex, 0U);
...
{ 
  ...
  err = ldv_register_chrdev_5(206U, "osst", & osst_fops);
  if (err < 0) {
  ...
  err_out_chrdev: 
  ldv_unregister_chrdev_6(206U, "osst");
  err_out: 
  osst_sysfs_cleanup();
  return (err);
}
...
#include "model/linux-4.2-rc1.tar.xz-08_1a-drivers--scsi--osst.ko-entry_point_true-unreach-call.cil.out.env.c"
