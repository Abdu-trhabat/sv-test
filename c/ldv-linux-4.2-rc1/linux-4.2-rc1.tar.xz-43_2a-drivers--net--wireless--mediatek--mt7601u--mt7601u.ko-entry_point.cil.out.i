...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-43_2a-drivers--net--wireless--mediatek--mt7601u--mt7601u.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
typedef enum ldv_22194 socket_state;
struct socket_wq {
   wait_queue_head_t wait ;
...
typedef enum ldv_28737 phy_interface_t;
enum ldv_28791 {
    MDIOBUS_ALLOCATED = 1,
...
struct __anonstruct_tkip_372 {
   u32 iv32 ;
   u16 iv16 ;
};
struct __anonstruct_ccmp_373 {
   u8 pn[6U] ;
};
struct __anonstruct_aes_cmac_374 {
   u8 pn[6U] ;
};
struct __anonstruct_aes_gmac_375 {
   u8 pn[6U] ;
};
struct __anonstruct_gcmp_376 {
   u8 pn[6U] ;
};
struct __anonstruct_hw_377 {
   u8 seq[16U] ;
   u8 seq_len ;
};
union __anonunion____missing_field_name_371 {
   struct __anonstruct_tkip_372 tkip ;
   struct __anonstruct_ccmp_373 ccmp ;
   struct __anonstruct_aes_cmac_374 aes_cmac ;
   struct __anonstruct_aes_gmac_375 aes_gmac ;
   struct __anonstruct_gcmp_376 gcmp ;
   struct __anonstruct_hw_377 hw ;
};
struct ieee80211_key_seq {
   union __anonunion____missing_field_name_371 __annonCompField100 ;
};
enum set_key_cmd {
    SET_KEY = 0,
    DISABLE_KEY = 1
...
union __anonunion___u_389___0 {
   struct tracepoint_func *__val ;
   char __c[1U] ;
};
union __anonunion___u_391___0 {
   struct tracepoint_func *__val ;
   char __c[1U] ;
};
...
struct __anonstruct_msg_469 {
   __le32 id ;
   __le32 value ;
};
struct __anonstruct_msg_471 {
   __le32 id ;
   __le32 value ;
};
...
union __anonunion___u_389___1 {
   struct tracepoint_func *__val ;
   char __c[1U] ;
};
union __anonunion___u_391___1 {
   struct tracepoint_func *__val ;
   char __c[1U] ;
};
...
union __anonunion____missing_field_name_366 {
   struct __anonstruct____missing_field_name_367 __annonCompField96 ;
   unsigned long jiffies ;
};
struct __anonstruct_control_365 {
   union __anonunion____missing_field_name_366 __annonCompField97 ;
   struct ieee80211_vif *vif ;
   struct ieee80211_key_conf *hw_key ;
   u32 flags ;
};
struct __anonstruct_ack_368 {
   u64 cookie ;
};
struct __anonstruct_status_369 {
   struct ieee80211_tx_rate rates[4U] ;
   s32 ack_signal ;
   u8 ampdu_ack_len ;
   u8 ampdu_len ;
...
struct __anonstruct____missing_field_name_370 {
   struct ieee80211_tx_rate driver_rates[4U] ;
   u8 pad[4U] ;
   void *rate_driver_data[3U] ;
};
union __anonunion____missing_field_name_364 {
   struct __anonstruct_control_365 control ;
   struct __anonstruct_ack_368 ack ;
   struct __anonstruct_status_369 status ;
   struct __anonstruct____missing_field_name_370 __annonCompField98 ;
   void *driver_data[5U] ;
};
...
union __anonunion___u_465 {
   struct tracepoint_func *__val ;
   char __c[1U] ;
};
union __anonunion___u_467 {
   struct tracepoint_func *__val ;
   char __c[1U] ;
};
union __anonunion___u_474 {
   struct mt76_wcid *__val ;
   char __c[1U] ;
};
struct __anonstruct_spans_476 {
   u32 addr_base ;
   u32 span ;
   u64 *stat_base ;
};
union __anonunion___u_480 {
   struct mt76_wcid *__val ;
   char __c[1U] ;
};
enum hrtimer_restart;
...
struct __anonstruct_page_260 {
   struct page *p ;
};
struct skb_frag_struct {
   struct __anonstruct_page_260 page ;
   __u32 page_offset ;
   __u32 size ;
};
...
union __anonunion___u_449 {
   struct tracepoint_func *__val ;
   char __c[1U] ;
};
union __anonunion___u_451 {
   struct tracepoint_func *__val ;
   char __c[1U] ;
};
...
void ldv_ieee80211_free_hw_46(struct ieee80211_hw *ldv_func_arg1 ) ;
...
__inline static void trace_reg_read(struct mt7601u_dev *dev , u32 reg , u32 val )
{
  ...
  if ((int )tmp___1) {
    ...
    if (tmp != 0 && ! __warned) {
      ...
      if (tmp___0 == 0) {
        __warned = 1;
        lockdep_rcu_suspicious("/home/ldvuser/mutilin/launch/inst/current/envs/linux-4.2-rc1.tar.xz/linux-4.2-rc1/drivers/net/wireless/mediatek/mt7601u/trace.h",
...
bool mt7601u_usb_alloc_buf(struct mt7601u_dev *dev , size_t len , struct mt7601u_dma_buf *buf )
{
  ...
  usb_dev = tmp;
  buf->len = len;
  buf->urb = ldv_usb_alloc_urb_42(0, 208U);
  buf->buf = ldv_usb_alloc_coherent_43(usb_dev, buf->len, 208U, & buf->dma);
                           ...
                           gfp_t gfp , void (*complete_fn)(struct urb * ) , void *context )
{
  ...
  ret = ldv_usb_submit_urb_44(buf->urb, gfp);
  if (ret != 0) {
                           ...
                           u16 const val , u16 const offset , void *buf , size_t const buflen )
{
  int ret ;
  {
  mutex_lock_nested(& dev->vendor_req_mutex, 0U);
...
u32 mt7601u_rr(struct mt7601u_dev *dev , u32 offset )
{
  ...
  if (tmp___1 != 0L) {
    ...
    if (tmp != 0L) {
      warn_slowpath_fmt("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/usb.c",
...
static int mt7601u_probe(struct usb_interface *usb_intf , struct usb_device_id const *id )
{
  ...
  usb_put_dev(tmp___1);
  ldv_destroy_workqueue_45(dev->stat_wq);
  ldv_ieee80211_free_hw_46(dev->hw);
  return (ret);
}
}
static void mt7601u_disconnect(struct usb_interface *usb_intf )
{
  ...
  usb_put_dev(tmp___0);
  ldv_destroy_workqueue_47(dev->stat_wq);
  ldv_ieee80211_free_hw_48(dev->hw);
  return;
}
}
...
static int mt7601u_driver_init(void)
{
  int tmp ;
  {
  tmp = ldv_usb_register_driver_49(& mt7601u_driver, & __this_module, "mt7601u");
  return (tmp);
}
}
...
{
  {
  ldv_usb_deregister_50(& mt7601u_driver);
  return;
}
}
int ldv_retval_5 ;
...
bool ldv_queue_work_on_76(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                          struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_78(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                          struct work_struct *ldv_func_arg3 ) ;
...
bool ldv_queue_delayed_work_on_80(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                  struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_79(struct workqueue_struct *ldv_func_arg1 ) ;
extern bool flush_delayed_work(struct delayed_work * ) ;
bool ldv_flush_delayed_work_103(struct delayed_work *ldv_func_arg1 ) ;
...
struct sk_buff *ldv_skb_copy_96(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
...
struct sk_buff *ldv___netdev_alloc_skb_97(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                          gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_98(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                          gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_99(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                          gfp_t flags ) ;
...
__inline static struct ieee80211_hw *ldv_ieee80211_alloc_hw_105(size_t priv_data_len ,
                                                                struct ieee80211_ops const *ops ) ;
extern int ieee80211_register_hw(struct ieee80211_hw * ) ;
void ldv_ieee80211_free_hw_106(struct ieee80211_hw *ldv_func_arg1 ) ;
...
static void mt7601u_chip_onoff(struct mt7601u_dev *dev , bool enable , bool reset )
{
  u32 val ;
  {
  mutex_lock_nested(& dev->hw_atomic_mutex, 0U);
...
void mt7601u_mac_stop(struct mt7601u_dev *dev )
{
  ...
  ldv_flush_delayed_work_103(& dev->stat_work);
  ldv_cancel_delayed_work_sync_104(& dev->stat_work);
  return;
}
}
...
struct mt7601u_dev *mt7601u_alloc_device(struct device *pdev )
{
  ...
  {
  hw = ldv_ieee80211_alloc_hw_105(4072UL, & mt7601u_ops);
  ...
  __raw_spin_lock_init(& dev->rx_lock.__annonCompField18.rlock, "&(&dev->rx_lock)->rlock",
                       & __key___4);
  ...
  __raw_spin_lock_init(& dev->con_mon_lock.__annonCompField18.rlock, "&(&dev->con_mon_lock)->rlock",
                       & __key___6);
...
static int mt76_init_sband_2g(struct mt7601u_dev *dev )
{
  ...
  tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp___0 != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/init.c",
                       567);
  } else {
  }
...
bool ldv_cancel_delayed_work_sync_157(struct delayed_work *ldv_func_arg1 ) ;
bool ldv_cancel_delayed_work_sync_158(struct delayed_work *ldv_func_arg1 ) ;
...
static void mt7601u_stop(struct ieee80211_hw *hw )
{
  ...
  dev = (struct mt7601u_dev *)hw->priv;
  mutex_lock_nested(& dev->mutex, 0U);
  ldv_cancel_delayed_work_sync_157(& dev->cal_work);
  ldv_cancel_delayed_work_sync_158(& dev->mac_work);
                             ...
                             u16 tid , u16 *ssn , u8 buf_size )
{
  ...
  tmp = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/main.c",
                       343);
  } else {
  }
  ldv__builtin_expect(__ret_warn_on != 0, 0L);
                                     ...
                                     struct ieee80211_sta *sta )
{
  ...
  if (tmp != 0 && ! __warned) {
    ...
    if (tmp___0 == 0) {
      __warned = 1;
      lockdep_rcu_suspicious("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/main.c",
...
bool ldv_queue_work_on_180(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_182(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
...
bool ldv_queue_delayed_work_on_184(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_183(struct workqueue_struct *ldv_func_arg1 ) ;
...
__inline static void trace_mt_submit_urb___0(struct mt7601u_dev *dev , struct urb *u )
{
  ...
  struct tracepoint_func *________p1 ;
  struct tracepoint_func *_________p1 ;
  union __anonunion___u_389___0 __u ;
  bool __warned ;
  int tmp ;
  int tmp___0 ;
  bool tmp___1 ;
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_391___0 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
                                           ...
                                           u32 csum , bool resp )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_395 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void mt7601u_dma_skb_wrap_cmd(struct sk_buff *skb , u8 seq , enum mcu_cmd cmd )
{
  ...
  tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp___0 != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/mcu.c",
                       47);
  } else {
  }
  ldv__builtin_expect(__ret_warn_on != 0, 0L);
                                ...
                                bool wait_resp )
{
  ...
  mutex_lock_nested(& dev->mcu.mutex, 0U);
  if ((int )wait_resp) {
    goto ldv_52615;
    ldv_52614:
...
{
  struct sk_buff *skb ;
  struct __anonstruct_msg_469 msg ;
  int tmp ;
  {
...
{
  struct sk_buff *skb ;
  struct __anonstruct_msg_471 msg ;
  int tmp ;
  {
...
static int mt7601u_upload_firmware(struct mt7601u_dev *dev , struct mt76_fw const *fw )
{
  ...
  descriptor.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/mcu.c";
  ...
  descriptor___0.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/mcu.c";
  ...
  descriptor___1.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/mcu.c";
...
bool ldv_queue_work_on_226(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
...
bool ldv_queue_delayed_work_on_230(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_229(struct workqueue_struct *ldv_func_arg1 ) ;
...
__inline static void ldv_spin_unlock_irqrestore_269(spinlock_t *lock , unsigned long flags )
{
  {
...
bool ldv_queue_work_on_272(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_274(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
...
bool ldv_queue_delayed_work_on_276(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_275(struct workqueue_struct *ldv_func_arg1 ) ;
__inline static bool queue_delayed_work(struct workqueue_struct *wq , struct delayed_work *dwork ,
                                        unsigned long delay )
{
  bool tmp ;
  {
  tmp = ldv_queue_delayed_work_on_273(8192, wq, dwork, delay);
  return (tmp);
}
}
...
struct urb *ldv_usb_alloc_urb_301(int ldv_func_arg1 , gfp_t flags ) ;
struct urb *ldv_usb_alloc_urb_302(int ldv_func_arg1 , gfp_t flags ) ;
int ldv_usb_submit_urb_299(struct urb *ldv_func_arg1 , gfp_t flags ) ;
int ldv_usb_submit_urb_300(struct urb *ldv_func_arg1 , gfp_t flags ) ;
...
__inline static void trace_mt_submit_urb___1(struct mt7601u_dev *dev , struct urb *u )
{
  ...
  struct tracepoint_func *________p1 ;
  struct tracepoint_func *_________p1 ;
  union __anonunion___u_389___1 __u ;
  bool __warned ;
  int tmp ;
  int tmp___0 ;
  bool tmp___1 ;
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_391___1 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
                                 ...
                                 u32 f )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_439 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_mt_tx_dma_done(struct mt7601u_dev *dev , struct sk_buff *skb )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_447 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_mt_rx_dma_aggr(struct mt7601u_dev *dev , int cnt , bool paged )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_459 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
static u16 mt7601u_rx_next_seg_len(u8 *data , u32 data_len )
{
  ...
  if (data_len < min_seg_len) {
    ...
    tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
    if (tmp___0 != 0L) {
      warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/dma.c",
                         125);
    } else {
    }
...
static void mt7601u_complete_rx(struct urb *urb )
{
  ...
  if (tmp___2 != 0L) {
    ...
    tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
    if (tmp___0 != 0L) {
      warn_slowpath_fmt("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/dma.c",
                        198, "RX urb mismatch");
    } else {
    }
    tmp___1 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
...
static void mt7601u_complete_tx(struct urb *urb )
{
  ...
  if (q->used == q->entries - q->entries / 8U) {
    ...
    ieee80211_wake_queue(dev->hw, (int )tmp___4);
  } else {
  }
  q->start = (q->start + 1U) % q->entries;
  q->used = q->used - 1U;
  ...
  tmp___6 = test_and_set_bit(5L, (unsigned long volatile *)(& dev->state));
  if (tmp___6 == 0) {
    tmp___5 = msecs_to_jiffies(10U);
    queue_delayed_work(dev->stat_wq, & dev->stat_work, tmp___5);
  } else {
  }
  out:
...
static int mt7601u_dma_submit_tx(struct mt7601u_dev *dev , struct sk_buff *skb , u8 ep )
{
  ...
  ret = ldv_usb_submit_urb_299(e->urb, 32U);
  if (ret != 0) {
    if (ret == -19) {
      set_bit(1L, (unsigned long volatile *)(& dev->state));
    } else {
  ...
  if (q->used >= q->entries) {
    ...
    ieee80211_stop_queue(dev->hw, (int )tmp___3);
  } else {
  }
  out:
  spin_unlock_irqrestore(& dev->tx_lock, flags);
                                 ...
                                 gfp_t gfp )
{
  ...
  ret = ldv_usb_submit_urb_300(e->urb, gfp);
  if (ret != 0) {
...
static int mt7601u_alloc_rx(struct mt7601u_dev *dev )
{
  ...
  goto ldv_52669;
  ldv_52668:
  dev->rx_q.e[i].urb = ldv_usb_alloc_urb_301(0, 208U);
...
static int mt7601u_alloc_tx_queue(struct mt7601u_dev *dev , struct mt7601u_tx_queue *q )
{
  ...
  goto ldv_52693;
  ldv_52692:
  q->e[i].urb = ldv_usb_alloc_urb_302(0, 208U);
...
__inline static void spin_unlock_irqrestore(spinlock_t *lock , unsigned long flags )
{
  {
  ldv_spin_unlock();
  ldv_spin_unlock_irqrestore_269(lock, flags);
  return;
}
}
bool ldv_queue_work_on_272(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
...
bool ldv_queue_work_on_322(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
...
bool ldv_queue_delayed_work_on_323(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
bool ldv_queue_delayed_work_on_326(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_325(struct workqueue_struct *ldv_func_arg1 ) ;
...
__inline static long ldv__builtin_expect(long exp , long c ) ;
bool ldv_queue_work_on_368(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_370(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_delayed_work_on_369(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
bool ldv_queue_delayed_work_on_372(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_371(struct workqueue_struct *ldv_func_arg1 ) ;
__inline static void *kmalloc(size_t size , gfp_t flags ) ;
extern void get_random_bytes(void * , int ) ;
struct sk_buff *ldv_skb_clone_386(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_clone_394(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_copy_388(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
...
int ldv_pskb_expand_head_393(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_389(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_390(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
...
__inline static u32 s6_validate(u32 reg )
{
  ...
  tmp = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/inst/current/envs/linux-4.2-rc1.tar.xz/linux-4.2-rc1/drivers/net/wireless/mediatek/mt7601u/eeprom.h",
                       126);
  } else {
  }
  ldv__builtin_expect(__ret_warn_on != 0, 0L);
...
__inline static void ldv_spin_lock_bh_405(spinlock_t *lock )
{
  {
...
__inline static void ldv_spin_unlock_bh_409(spinlock_t *lock )
{
  {
...
bool ldv_cancel_delayed_work_sync_441(struct delayed_work *ldv_func_arg1 ) ;
bool ldv_cancel_delayed_work_sync_442(struct delayed_work *ldv_func_arg1 ) ;
bool ldv_cancel_delayed_work_sync_443(struct delayed_work *ldv_func_arg1 ) ;
...
struct sk_buff *ldv_skb_copy_434(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
...
int ldv_pskb_expand_head_438(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
int ldv_pskb_expand_head_439(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_435(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_436(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_437(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
...
__inline static void trace_rf_read(struct mt7601u_dev *dev , u8 bank , u8 reg , u8 val )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_407 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_rf_write(struct mt7601u_dev *dev , u8 bank , u8 reg , u8 val )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_411 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_bbp_read(struct mt7601u_dev *dev , u8 reg , u8 val )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_415 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_bbp_write(struct mt7601u_dev *dev , u8 reg , u8 val )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_419 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_temp_mode(struct mt7601u_dev *dev , u8 val )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_423 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_read_temp(struct mt7601u_dev *dev , u8 val )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_427 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_freq_cal_adjust(struct mt7601u_dev *dev , u8 val )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_431 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
                                           ...
                                           s8 freq_off )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_435 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
static int mt7601u_rf_wr(struct mt7601u_dev *dev , u8 bank , u8 offset , u8 value )
{
  ...
  tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp___0 != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/phy.c",
                       31);
  } else {
  }
  tmp___1 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  ...
  mutex_lock_nested(& dev->reg_atomic_mutex, 0U);
...
static int __mt7601u_phy_set_channel(struct mt7601u_dev *dev , struct cfg80211_chan_def *chandef )
{
  ...
  if ((int )dev->bw != (int )bw || (int )dev->chan_ext_below != (int )chan_ext_below) {
    ...
    descriptor.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/phy.c";
...
int mt7601u_phy_set_channel(struct mt7601u_dev *dev , struct cfg80211_chan_def *chandef )
{
  ...
  int tmp ;
  {
  ldv_cancel_delayed_work_sync_441(& dev->cal_work);
  ldv_cancel_delayed_work_sync_442(& dev->freq_cal.work);
  mutex_lock_nested(& dev->hw_atomic_mutex, 0U);
...
static int mt7601u_temp_comp(struct mt7601u_dev *dev , bool on )
{
  ...
  if (temp < -50 && ! dev->pll_lock_protect) {
    ...
    descriptor___0.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/phy.c";
  ...
  if (temp > 50 && (int )dev->pll_lock_protect) {
    ...
    descriptor___1.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/phy.c";
...
void mt7601u_phy_con_cal_onoff(struct mt7601u_dev *dev , struct ieee80211_bss_conf *info )
{
  {
  if (! info->assoc) {
    ldv_cancel_delayed_work_sync_443(& dev->freq_cal.work);
  } else {
  }
  spin_lock_bh(& dev->con_mon_lock);
...
bool ldv_queue_work_on_466(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_468(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_delayed_work_on_467(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
bool ldv_queue_delayed_work_on_470(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_469(struct workqueue_struct *ldv_func_arg1 ) ;
struct sk_buff *ldv_skb_clone_484(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_clone_492(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_copy_486(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
int ldv_pskb_expand_head_482(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
int ldv_pskb_expand_head_490(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
int ldv_pskb_expand_head_491(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_487(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_488(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
...
__inline static void trace_set_key(struct mt7601u_dev *dev , u8 val )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_463 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_set_shared_key(struct mt7601u_dev *dev , u8 vid , u8 key )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_467 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
static void mt76_mac_process_tx_rate(struct ieee80211_tx_rate *txrate , u16 rate )
{
  ...
  tmp = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/mac.c",
                       46);
  } else {
  }
  ldv__builtin_expect(__ret_warn_on != 0, 0L);
                                    ...
                                    struct mt76_tx_status *st )
{
  ...
  int __max2 ;
  {
  rate = (struct ieee80211_tx_rate *)(& info->__annonCompField99.status.rates);
  __min1 = (int )st->retry;
  __min2 = 3;
  ...
  info->__annonCompField99.status.ampdu_len = 1U;
  info->__annonCompField99.status.ampdu_ack_len = st->success;
...
void mt76_send_tx_status(struct mt7601u_dev *dev , struct mt76_tx_status *stat )
{
  ...
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[0].idx = (signed char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[0].count = (unsigned char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[0].flags = (unsigned short)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[1].idx = (signed char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[1].count = (unsigned char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[1].flags = (unsigned short)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[2].idx = (signed char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[2].count = (unsigned char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[2].flags = (unsigned short)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[3].idx = (signed char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[3].count = (unsigned char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rates[3].flags = (unsigned short)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.rts_cts_rate_idx = (signed char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.use_rts = (unsigned char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.use_cts_prot = (unsigned char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.short_preamble = (unsigned char)0;
  info.__annonCompField99.control.__annonCompField97.__annonCompField96.skip_table = (unsigned char)0;
  info.__annonCompField99.control.vif = 0;
  info.__annonCompField99.control.hw_key = 0;
  info.__annonCompField99.control.flags = 0U;
  ...
  if ((int )((signed char )stat->wcid) >= 0) {
    ...
    if (tmp != 0 && ! __warned) {
      ...
      if (tmp___0 == 0) {
        __warned = 1;
        lockdep_rcu_suspicious("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/mac.c",
...
void mt7601u_mac_work(struct work_struct *work )
{
  struct mt7601u_dev *dev ;
  struct work_struct const *__mptr ;
  struct __anonstruct_spans_476 spans[6U] ;
  u32 sum ;
  u32 n ;
  int i ;
  int j ;
...
bool ldv_queue_delayed_work_on_513(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
bool ldv_queue_delayed_work_on_516(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_515(struct workqueue_struct *ldv_func_arg1 ) ;
struct sk_buff *ldv_skb_clone_530(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_clone_538(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_copy_532(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
int ldv_pskb_expand_head_528(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
...
struct sk_buff *ldv___netdev_alloc_skb_533(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
...
__inline static int __skb_cow(struct sk_buff *skb , unsigned int headroom , int cloned )
{
  ...
  if (delta != 0 || cloned != 0) {
    ...
    _max1___0 = 32;
    _max2___0 = 64;
    tmp___1 = ldv_pskb_expand_head_536(skb, (((_max1 > _max2 ? _max1 : _max2) + -1) + delta) & - (_max1___0 > _max2___0 ? _max1___0 : _max2___0),
                                       0, 32U);
    return (tmp___1);
  } else {
  }
...
bool ldv_queue_work_on_558(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_560(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_delayed_work_on_559(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
bool ldv_queue_delayed_work_on_562(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_561(struct workqueue_struct *ldv_func_arg1 ) ;
...
extern struct dentry *debugfs_create_u32(char const * , umode_t , struct dentry * ,
                                         u32 * ) ;
struct sk_buff *ldv_skb_clone_576(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_clone_584(struct sk_buff *ldv_func_arg1 , gfp_t flags ) ;
struct sk_buff *ldv_skb_copy_578(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
int ldv_pskb_expand_head_574(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
int ldv_pskb_expand_head_582(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
int ldv_pskb_expand_head_583(struct sk_buff *ldv_func_arg1 , int ldv_func_arg2 , int ldv_func_arg3 ,
                             gfp_t flags ) ;
struct sk_buff *ldv___netdev_alloc_skb_579(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
...
__inline static long ldv__builtin_expect(long exp , long c ) ;
__inline static void spin_unlock_irqrestore(spinlock_t *lock , unsigned long flags ) ;
bool ldv_queue_work_on_604(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_work_on_606(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                           struct work_struct *ldv_func_arg3 ) ;
bool ldv_queue_delayed_work_on_605(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
bool ldv_queue_delayed_work_on_608(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_607(struct workqueue_struct *ldv_func_arg1 ) ;
__inline static bool queue_delayed_work___0(struct workqueue_struct *wq , struct delayed_work *dwork ,
                                            unsigned long delay )
{
  bool tmp ;
  {
  tmp = ldv_queue_delayed_work_on_605(8192, wq, dwork, delay);
  return (tmp);
}
}
...
struct sk_buff *ldv___netdev_alloc_skb_627(struct net_device *ldv_func_arg1 , unsigned int ldv_func_arg2 ,
                                           gfp_t flags ) ;
__inline static int __skb_cow___0(struct sk_buff *skb , unsigned int headroom , int cloned )
{
  int delta ;
  unsigned int tmp ;
  unsigned int tmp___0 ;
  ...
  if (delta != 0 || cloned != 0) {
    ...
    _max1___0 = 32;
    _max2___0 = 64;
    tmp___1 = ldv_pskb_expand_head_628(skb, (((_max1 > _max2 ? _max1 : _max2) + -1) + delta) & - (_max1___0 > _max2___0 ? _max1___0 : _max2___0),
                                       0, 32U);
    return (tmp___1);
  } else {
  }
...
__inline static int skb_cow___0(struct sk_buff *skb , unsigned int headroom )
{
  int tmp ;
  int tmp___0 ;
  {
  tmp = skb_cloned((struct sk_buff const *)skb);
  tmp___0 = __skb_cow___0(skb, headroom, tmp);
  return (tmp___0);
}
}
                                 ...
                                 struct mt76_txwi *h )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_443 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
__inline static void trace_mt_tx_status_cleaned(struct mt7601u_dev *dev , int cleaned )
{
  ...
  struct tracepoint_func *________p1___0 ;
  struct tracepoint_func *_________p1___0 ;
  union __anonunion___u_451 __u___0 ;
  bool __warned___0 ;
  int tmp___2 ;
  int tmp___3 ;
  {
...
static u8 skb2q(struct sk_buff *skb )
{
  ...
  tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp___0 != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/11727/dscv_tempdir/dscv/ri/43_2a/drivers/net/wireless/mediatek/mt7601u/tx.c",
                       39);
  } else {
  }
  tmp___1 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
...
static void mt7601u_tx_skb_remove_dma_overhead(struct sk_buff *skb , struct ieee80211_tx_info *info )
{
  ...
  unsigned int tmp ;
  {
  pkt_len = (int )((long )info->__annonCompField99.status.status_driver_data[0]);
  skb_pull(skb, 24U);
  tmp = ieee80211_get_hdrlen_from_skb((struct sk_buff const *)skb);
  if ((tmp & 3U) != 0U) {
...
void mt7601u_tx_status(struct mt7601u_dev *dev , struct sk_buff *skb )
{
  ...
  info->__annonCompField99.status.rates[0].idx = -1;
  info->flags = info->flags | 512U;
...
static int mt7601u_skb_rooms(struct mt7601u_dev *dev , struct sk_buff *skb )
{
  ...
  tmp___0 = skb_cow___0(skb, need_head);
  return (tmp___0);
}
}
                                           ...
                                           int pkt_len )
{
  ...
  tmp = IEEE80211_SKB_CB(skb);
  info = tmp;
  rate = (struct ieee80211_tx_rate *)(& info->__annonCompField99.control.__annonCompField97.__annonCompField96.rates);
  tmp___0 = skb_push(skb, 20U);
  txwi = (struct mt76_txwi *)tmp___0;
  memset((void *)txwi, 0, 20UL);
  if (! wcid->tx_rate_set) {
    ieee80211_get_tx_rates(info->__annonCompField99.control.vif, sta, skb, (struct ieee80211_tx_rate *)(& info->__annonCompField99.control.__annonCompField97.__annonCompField96.rates),
                           1);
  } else {
  }
  ldv_spin_lock();
  ...
  tmp___1 = mt7601u_tx_pktid_enc(dev, (int )((u8 )rate_ctl) & 7, (int )is_probe);
  pkt_id = (u32 )tmp___1;
...
void mt7601u_tx(struct ieee80211_hw *hw , struct ieee80211_tx_control *control , struct sk_buff *skb )
{
  ...
  info = tmp;
  dev = (struct mt7601u_dev *)hw->priv;
  vif = info->__annonCompField99.control.vif;
  sta = control->sta;
  ...
  tmp___0 = skb2q(skb);
  hw_q = (int )tmp___0;
  info->__annonCompField99.status.status_driver_data[0] = (void *)((unsigned long )pkt_len);
...
void mt7601u_tx_stat(struct work_struct *work )
{
  ...
  if (cleaned != 0) {
    ...
    queue_delayed_work___0(dev->stat_wq, & dev->stat_work, tmp___0);
  } else {
    tmp___2 = test_and_clear_bit(6L, (unsigned long volatile *)(& dev->state));
    if (tmp___2 != 0) {
