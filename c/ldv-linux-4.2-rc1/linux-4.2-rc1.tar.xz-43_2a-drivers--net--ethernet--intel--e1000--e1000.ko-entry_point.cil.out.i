...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-4.2-rc1.tar.xz-43_2a-drivers--net--ethernet--intel--e1000--e1000.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
typedef enum ldv_25010 socket_state;
struct socket_wq {
   wait_queue_head_t wait ;
...
typedef enum ldv_28651 phy_interface_t;
enum ldv_28705 {
    MDIOBUS_ALLOCATED = 1,
...
typedef enum ldv_35745 e1000_mac_type;
enum ldv_35747 {
...
typedef enum ldv_35747 e1000_eeprom_type;
enum ldv_35749 {
...
typedef enum ldv_35749 e1000_media_type;
enum ldv_35753 {
    E1000_FC_NONE = 0,
    E1000_FC_RX_PAUSE = 1,
    E1000_FC_TX_PAUSE = 2,
...
typedef enum ldv_35753 e1000_fc_type;
...
typedef enum ldv_35778 e1000_auto_x_mode;
...
bool ldv_cancel_delayed_work_sync_47(struct delayed_work *ldv_func_arg1 ) ;
...
void *ldv_vzalloc_56(unsigned long ldv_func_arg1 ) ;
...
static int e1000_init_module(void)
{
  ...
  ret = ldv___pci_register_driver_43(& e1000_driver, & __this_module, "e1000");
  if (copybreak != 256U) {
    if (copybreak == 0U) {
...
{
  {
  ldv_pci_unregister_driver_44(& e1000_driver);
  return;
}
}
static int e1000_request_irq(struct e1000_adapter *adapter )
{
  ...
  handler = & e1000_intr;
  irq_flags = 128;
  err = ldv_request_irq_45((adapter->pdev)->irq, handler, (unsigned long )irq_flags,
...
static void e1000_down_and_stop(struct e1000_adapter *adapter )
{
  ...
  ldv_cancel_delayed_work_sync_47(& adapter->watchdog_task);
  ldv_cancel_delayed_work_sync_48(& adapter->phy_info_task);
  ldv_cancel_delayed_work_sync_49(& adapter->fifo_stall_task);
  tmp = constant_test_bit(1L, (unsigned long const volatile *)(& adapter->flags));
  if (tmp == 0) {
    ldv_cancel_work_sync_50(& adapter->reset_task);
  } else {
  }
  return;
}
...
void e1000_reinit_locked(struct e1000_adapter *adapter )
{
  ...
  tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
  if (tmp___0 != 0L) {
    warn_slowpath_null("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_main.c",
                       561);
  } else {
  }
  ldv__builtin_expect(__ret_warn_on != 0, 0L);
...
static int e1000_probe(struct pci_dev *pdev , struct pci_device_id const *ent )
{
  ...
  err = ldv_register_netdev_51(netdev);
  if (err != 0) {
    goto err_register;
  } else {
  }
...
static void e1000_remove(struct pci_dev *pdev )
{
  ...
  e1000_down_and_stop(adapter);
  e1000_release_manageability(adapter);
  ldv_unregister_netdev_53(netdev);
  e1000_phy_hw_reset(hw);
  kfree((void const *)adapter->tx_ring);
  kfree((void const *)adapter->rx_ring);
  if ((unsigned int )hw->mac_type == 9U) {
...
static int e1000_setup_rx_resources(struct e1000_adapter *adapter , struct e1000_rx_ring *rxdr )
{
  ...
  tmp = ldv_vzalloc_56((unsigned long )size);
                               ...
                               int *work_done , int work_to_do )
{
  ...
  *work_done = *work_done + 1;
  ...
  if ((int )adapter->discarding) {
    ...
    descriptor.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_main.c";
...
s32 e1000_reset_hw(struct e1000_hw *hw )
{
  ...
  if ((unsigned int )hw->mac_type == 1U) {
    ...
    descriptor.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
  ...
  descriptor___0.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
  ...
  descriptor___1.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
  ...
  descriptor___2.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
    ...
    if ((tmp___13 & 524288U) == signal) {
      ...
      if (i == 50U) {
        ...
        if (ret_val != 0) {
          ...
          descriptor___3.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
        ...
        descriptor___4.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
      ...
      descriptor___5.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
...
s32 e1000_phy_setup_autoneg(struct e1000_hw *hw )
{
  ...
  descriptor___6.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
  ...
  descriptor___7.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
...
static s32 e1000_config_fc_after_link_up(struct e1000_hw *hw )
{
  ...
  if ((unsigned int )hw->media_type == 0U && (unsigned int )hw->autoneg != 0U) {
    ...
    if (((int )mii_status_reg & 32) != 0) {
      ...
      descriptor___8.filename = "/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_hw.c";
...
s32 e1000_read_phy_reg(struct e1000_hw *hw , u32 reg_addr , u16 *phy_data )
{
  ...
  if ((unsigned int )hw->phy_type == 1U && reg_addr > 15U) {
    tmp = e1000_write_phy_reg_ex(hw, 31U, (int )((unsigned short )reg_addr));
    ret_val = (u32 )tmp;
    if (ret_val != 0U) {
  ...
  tmp___0 = e1000_read_phy_reg_ex(hw, reg_addr & 31U, phy_data);
  ret_val = (u32 )tmp___0;
  spin_unlock_irqrestore(& e1000_phy_lock, flags);
  return ((s32 )ret_val);
}
...
s32 e1000_write_phy_reg(struct e1000_hw *hw , u32 reg_addr , u16 phy_data )
{
  ...
  tmp___0 = e1000_write_phy_reg_ex(hw, reg_addr & 31U, (int )phy_data);
  ret_val = (u32 )tmp___0;
  spin_unlock_irqrestore(& e1000_phy_lock, flags);
  return ((s32 )ret_val);
}
...
static s32 e1000_phy_igp_get_info(struct e1000_hw *hw , struct e1000_phy_info *phy_info )
{
  ...
  {
  phy_info->downshift = (enum ldv_35772 )hw->speed_downgraded;
  ...
  phy_info->mdix_mode = (enum ldv_35778 )(((int )phy_data & 2048) >> 11);
...
static s32 e1000_phy_m88_get_info(struct e1000_hw *hw , struct e1000_phy_info *phy_info )
{
  ...
  phy_info->mdix_mode = (enum ldv_35778 )(((int )phy_data & 64) >> 6);
  if (((int )phy_data & 49152) == 32768) {
...
struct sk_buff *ldv_skb_copy_155(struct sk_buff const *ldv_func_arg1 , gfp_t flags ) ;
...
__inline static int ldv_request_irq_163(unsigned int irq , irqreturn_t (*handler)(int ,
                                                                                  void * ) ,
                                        unsigned long flags , char const *name ,
                                        void *dev ) ;
__inline static int ldv_request_irq_45(unsigned int irq , irqreturn_t (*handler)(int ,
                                       ...
                                       unsigned long flags , char const *name ,
                                       void *dev ) ;
void ldv_free_irq_165(unsigned int ldv_func_arg1 , void *ldv_func_arg2 ) ;
...
static int e1000_intr_test(struct e1000_adapter *adapter , u64 *data )
{
  ...
  hw = & adapter->hw;
  *data = 0ULL;
  tmp___0 = ldv_request_irq_163(irq, & e1000_test_intr, 256UL, (char const *)(& netdev->name),
                                (void *)netdev);
  if (tmp___0 == 0) {
    shared_int = 0;
  } else {
    tmp = ldv_request_irq_45(irq, & e1000_test_intr, 128UL, (char const *)(& netdev->name),
                             (void *)netdev);
    if (tmp != 0) {
      *data = 1ULL;
      return (-1);
  ...
  readl((void const volatile *)hw->hw_addr + 8U);
  msleep(10U);
  ldv_free_irq_165(irq, (void *)netdev);
  return ((int )*data);
}
}
...
static int e1000_setup_desc_rings(struct e1000_adapter *adapter )
{
  ...
  _max1 = 32;
  _max2 = 64;
  tmp___4 = kmalloc((size_t )((_max1 > _max2 ? _max1 : _max2) + 2048), 208U);
  buf = (u8 *)tmp___4;
                                    ...
                                    u64 *data )
{
  ...
  if (tmp___2 != 0L) {
    ...
    tmp___0 = ldv__builtin_expect(__ret_warn_on != 0, 0L);
    if (tmp___0 != 0L) {
      warn_slowpath_fmt("/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_ethtool.c",
...
bool ldv_queue_delayed_work_on_192(int ldv_func_arg1 , struct workqueue_struct *ldv_func_arg2 ,
                                   struct delayed_work *ldv_func_arg3 , unsigned long ldv_func_arg4 ) ;
void ldv_flush_workqueue_191(struct workqueue_struct *ldv_func_arg1 ) ;
                                 ...
                                 struct e1000_adapter *adapter )
{
  ...
  goto ldv_54363;
  default:
  __asm__ volatile ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"/home/ldvuser/mutilin/launch/work/current--X--drivers/--X--defaultlinux-4.2-rc1.tar.xz--X--43_2a--X--cpachecker/linux-4.2-rc1.tar.xz/csd_deg_dscv/10403/dscv_tempdir/dscv/ri/43_2a/drivers/net/ethernet/intel/e1000/e1000_param.c"),
                       "i" (249), "i" (12UL));
  ldv_54372: ;
  goto ldv_54372;
  }
