...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch102Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 265L, 65L) */ if (/* 266L, 46L, 47L) */ ((var_1_33) >= (/* 268L, 45L, 49L) */ (max (/* 268L, 45L, 49L) */ (/* 269L, 43L, 50L) */ ((var_1_7) + (var_1_31))) , (var_1_29)))))) {
		/* 273L, 64L) */ var_1_35 = (
			var_1_4
		);
	}
	...
	// From: CodeObject4
	/* 282L, 113L) */ if (/* 283L, 89L, 90L) */ ((var_1_36) <= (/* 285L, 88L, 92L) */ ((-128) | (var_1_25))))) {
		/* 288L, 111L) */ if (var_1_15) {
			/* 290L, 110L) */ var_1_41 = (
				/* 293L, 109L) */ ((
					2u
				) + (
	...
	// From: CodeObject6
	/* 305L, 153L) */ if (/* 306L, 134L, 135L) */ ((var_1_10) >= (/* 308L, 133L, 137L) */ (min (/* 308L, 133L, 137L) */ (/* 309L, 131L, 138L) */ (- (var_1_2))) , (64.1)))))) {
		/* 312L, 152L) */ var_1_44 = (
			/* 315L, 151L) */ ((
				var_1_45
			) - (
	...
	// From: CodeObject7
	/* 319L, 203L) */ if (/* 320L, 166L, 167L) */ ((/* 321L, 164L, 168L) */ (min (/* 321L, 164L, 168L) */ (var_1_8) , (/* 323L, 163L, 170L) */ (min (/* 323L, 163L, 170L) */ (var_1_18) , (var_1_2))))))) >= (var_1_13))) {
		/* 327L, 196L) */ if (/* 328L, 183L, 184L) */ ((var_1_25) <= (var_1_46))) {
			/* 331L, 195L) */ var_1_47 = (
				/* 334L, 194L) */ (min (
					/* 334L, 194L) */ (
						var_1_49
