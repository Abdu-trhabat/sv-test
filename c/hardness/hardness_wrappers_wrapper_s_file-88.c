	...
	if (15.2f < WrapperStruct00.var_1_9) {
		...
		if (WrapperStruct00.var_1_10 > WrapperStruct00.var_1_4) {
			if (last_1_WrapperStruct00_var_1_8 == WrapperStruct00.var_1_10) {
				WrapperStruct00.var_1_8 = (max ((abs (WrapperStruct00.var_1_1)) , -16));
			} else {
