...
void step(void) {
	...
	// From: Req4Batch112stepLocals
	var_1_14 = (max ((var_1_5 + var_1_10) , var_1_4));


	// From: Req5Batch112stepLocals
	if ((var_1_16 - var_1_17) < (var_1_10 - var_1_5)) {
		var_1_15 = 1;
	}


	// From: Req6Batch112stepLocals
	...
	// From: Req7Batch112stepLocals
	var_1_24 = var_1_25;


	// From: Req8Batch112stepLocals
	var_1_26 = 10;
}
