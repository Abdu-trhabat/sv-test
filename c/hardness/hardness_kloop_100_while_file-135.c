...
void step(void) {
	...
	// From: Req11Batch135100_while
	if (var_1_18) {
		var_1_31 = (min (var_1_11 , (var_1_13 + 64.4)));
	}


	// From: Req10Batch135100_while
	...
	// From: Req5Batch135100_while
	if ((~ var_1_8) < var_1_25) {
		var_1_15 = (max (var_1_13 , var_1_11));
	}


	// From: Req4Batch135100_while
	var_1_14 = (abs (var_1_9));


	// From: Req13Batch135100_while
	var_1_36 = var_1_9;


	// From: Req6Batch135100_while
	if (((var_1_31 > var_1_15) && var_1_18) || var_1_18) {
		var_1_16 = (var_1_9 + var_1_8);
	}


	// From: Req3Batch135100_while
