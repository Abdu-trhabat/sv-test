...
void step(void) {
	...
	// From: Req6Batch35stepLocals
	if ((min ((var_1_16 * 200.7f) , (abs (var_1_10)))) <= ((- var_1_14) / var_1_18)) {
	...
	// From: Req7Batch35stepLocals
	signed long int stepLocal_3 = max (var_1_6 , var_1_8);
...
int property(void) {
	return (((((((var_1_2 ? (var_1_1 == ((unsigned char) ((! var_1_3) || var_1_4))) : (var_1_1 == ((unsigned char) (var_1_3 && var_1_5)))) && ((var_1_7 >= var_1_8) ? (((var_1_9 - 1.00000000000025E12) >= var_1_10) ? (var_1_6 == ((unsigned short int) 200)) : (var_1_6 == ((unsigned short int) var_1_11))) : (var_1_6 == ((unsigned short int) var_1_11)))) && ((var_1_11 > var_1_6) ? (var_1_12 == ((signed short int) 32)) : 1)) && ((var_1_12 == var_1_7) ? ((! var_1_3) ? (var_1_13 == ((signed long int) ((var_1_8 + var_1_12) + (var_1_11 - var_1_6)))) : 1) : 1)) && (((var_1_7 + var_1_6) < ((var_1_11 >> var_1_15) * var_1_12)) ? (var_1_14 == ((double) var_1_16)) : (var_1_14 == ((double) 8.954)))) && (((min ((var_1_16 * 200.7f) , (abs (var_1_10)))) <= ((- var_1_14) / var_1_18)) ? (var_1_17 == ((unsigned long int) (var_1_19 - var_1_15))) : (var_1_17 == ((unsigned long int) var_1_19)))) && (((max (var_1_6 , var_1_8)) <= (var_1_15 << var_1_17)) ? (var_1_1 ? (var_1_20 == ((float) (max (var_1_16 , 7.9f)))) : 1) : 1)) && (var_1_21 == ((signed char) var_1_15))
;
}
int main(void) {
	isInitial = 1;
