...
void step(void) {
	...
	if (stepLocal_13 || last_1_var_1_65) {
		if (stepLocal_12 > last_1_var_1_46) {
			var_1_43 = (var_1_45 - (max (var_1_36 , var_1_24)));
		}
	} else {
	...
	// From: Req2Batch182Amount250
	var_1_8 = ((var_1_9 + var_1_10) + 32);


	// From: Req3Batch182Amount250
	...
	// From: Req5Batch182Amount250
	if (var_1_6 > (var_1_7 * var_1_1)) {
		var_1_21 = var_1_14;
	}


	// From: Req7Batch182Amount250
	unsigned long int stepLocal_6 = var_1_3;
	signed long int stepLocal_5 = abs (-4);
	if (stepLocal_6 < var_1_2) {
		if (var_1_14 >= stepLocal_5) {
			var_1_23 = (max (var_1_20 , (256.25 + (var_1_25 + 2.7))));
		}
	} else {
	...
	// From: Req8Batch182Amount250
	signed long int stepLocal_8 = var_1_1;
	signed long int stepLocal_7 = (max (var_1_24 , 128)) - 256;
	if (stepLocal_8 <= ((max (var_1_6 , var_1_1)) / var_1_29)) {
		var_1_28 = ((var_1_30 - 128.375) - (var_1_31 - (min (var_1_32 , var_1_33))));
	} else {
	...
	// From: Req9Batch182Amount250
	if (var_1_65) {
		var_1_34 = (var_1_35 - var_1_36);
	}


	// From: Req13Batch182Amount250
	...
	// From: Req16Batch182Amount250
	signed long int stepLocal_16 = 100 / var_1_49;
	if (var_1_6 <= stepLocal_16) {
		var_1_52 = (var_1_36 + (min (var_1_24 , (64 - var_1_53))));
	}


	// From: Req17Batch182Amount250
	if (! var_1_65) {
		if (((min (var_1_8 , var_1_7)) / var_1_29) > var_1_5) {
			var_1_54 = var_1_17;
		}
	}


	// From: Req23Batch182Amount250
	var_1_63 = var_1_36;


	// From: Req24Batch182Amount250
	if (var_1_65) {
		var_1_64 = var_1_53;
	} else {
		var_1_64 = var_1_10;
	...
	if (var_1_65 || stepLocal_14) {
		...
		if (var_1_65) {
			if (var_1_65) {
				var_1_46 = (min ((var_1_42 - var_1_24) , var_1_43));
			} else {
				var_1_46 = (var_1_42 - ((min (var_1_48 , var_1_49)) - (var_1_50 - var_1_45)));
			}
		} else {
	...
	// From: Req4Batch182Amount250
	signed long int stepLocal_3 = var_1_6;
	signed long int stepLocal_2 = min (var_1_21 , var_1_7);
	...
	// From: Req10Batch182Amount250
	if (var_1_65) {
		var_1_37 = (max ((min (var_1_14 , 0)) , var_1_35));
	} else {
		var_1_37 = var_1_64;
	}


	// From: Req11Batch182Amount250
	unsigned char stepLocal_10 = var_1_2 > var_1_7;
	signed long int stepLocal_9 = max (var_1_29 , var_1_11);
	if (! ((var_1_37 | var_1_9) <= (var_1_35 - var_1_36))) {
		if ((var_1_35 - var_1_36) > stepLocal_9) {
			if (var_1_65 && stepLocal_10) {
				var_1_38 = (min (var_1_10 , (min (var_1_14 , var_1_36))));
			}
		} else {
			var_1_38 = var_1_9;
		}
	...
	// From: Req19Batch182Amount250
	if (var_1_6 < var_1_37) {
		var_1_59 = ((min (var_1_53 , var_1_24)) + var_1_36);
	} else {
		if (var_1_30 < (abs (var_1_19))) {
			var_1_59 = (min ((var_1_45 - var_1_36) , var_1_53));
		}
	}


	// From: Req20Batch182Amount250
	if (var_1_65) {
		if ((~ (var_1_68 + var_1_53)) >= (min (var_1_42 , var_1_48))) {
			if (var_1_5 > 8u) {
				var_1_60 = var_1_9;
			}
		} else {
			var_1_60 = (max (var_1_10 , (min (var_1_53 , var_1_35))));
		}
	} else {
	...
	// From: Req12Batch182Amount250
	if (var_1_65) {
		if (var_1_23 <= (max (var_1_25 , var_1_31))) {
			if (var_1_65) {
				var_1_40 = (min (var_1_9 , (var_1_15 + (max (var_1_59 , var_1_35)))));
			} else {
				var_1_40 = 32;
			}
		} else {
			var_1_40 = (min ((last_1_var_1_40 + (max (var_1_14 , var_1_62))) , 128));
		}
	}


	// From: Req18Batch182Amount250
	if ((~ var_1_48) >= (var_1_21 / var_1_42)) {
		if ((var_1_28 / (min (var_1_30 , var_1_31))) > var_1_33) {
			...
			var_1_55 = (var_1_27 - (abs (var_1_19 + var_1_33)));
		}
	} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((max (var_1_2 , var_1_3)) & var_1_4) <= var_1_5) ? (var_1_1 == ((signed long int) (var_1_6 - var_1_7))) : (var_1_1 == ((signed long int) (max ((max (var_1_6 , (10 - 128))) , var_1_7))))) && (var_1_8 == ((signed char) ((var_1_9 + var_1_10) + 32)))) && ((var_1_12 || var_1_13) ? (var_1_11 == ((signed char) var_1_9)) : (var_1_11 == ((signed char) (max (var_1_10 , (var_1_9 + (var_1_14 + var_1_15)))))))) && (((min (var_1_21 , var_1_7)) >= var_1_9) ? ((var_1_6 > var_1_5) ? (((var_1_9 ^ var_1_15) < (var_1_46 * -4)) ? (var_1_16 == ((double) (max (var_1_17 , var_1_18)))) : 1) : (var_1_16 == ((double) (var_1_19 + var_1_20)))) : (var_1_16 == ((double) var_1_20)))) && ((var_1_6 > (var_1_7 * var_1_1)) ? (var_1_21 == ((signed long int) var_1_14)) : 1)) && (var_1_65 ? ((var_1_5 != var_1_1) ? (var_1_22 == ((signed long int) ((var_1_9 + (var_1_14 + last_1_var_1_22)) + var_1_8))) : (var_1_22 == ((signed long int) (min (((var_1_15 + var_1_8) + var_1_10) , var_1_7))))) : (var_1_22 == ((signed long int) 8)))) && ((var_1_3 < var_1_2) ? ((var_1_14 >= (abs (-4))) ? (var_1_23 == ((double) (max (var_1_20 , (256.25 + (var_1_25 + 2.7)))))) : 1) : (var_1_23 == ((double) (var_1_26 - var_1_27))))) && ((var_1_1 <= ((max (var_1_6 , var_1_1)) / var_1_29)) ? (var_1_28 == ((double) ((var_1_30 - 128.375) - (var_1_31 - (min (var_1_32 , var_1_33)))))) : ((((max (var_1_24 , 128)) - 256) >= var_1_1) ? (var_1_28 == ((double) var_1_25)) : (var_1_28 == ((double) var_1_31))))) && (var_1_65 ? (var_1_34 == ((signed char) (var_1_35 - var_1_36))) : 1)) && (var_1_65 ? (var_1_37 == ((signed short int) (max ((min (var_1_14 , 0)) , var_1_35)))) : (var_1_37 == ((signed short int) var_1_64)))) && ((! ((var_1_37 | var_1_9) <= (var_1_35 - var_1_36))) ? (((var_1_35 - var_1_36) > (max (var_1_29 , var_1_11))) ? ((var_1_65 && (var_1_2 > var_1_7)) ? (var_1_38 == ((signed char) (min (var_1_10 , (min (var_1_14 , var_1_36)))))) : 1) : (var_1_38 == ((signed char) var_1_9))) : 1)) && (var_1_65 ? ((var_1_23 <= (max (var_1_25 , var_1_31))) ? (var_1_65 ? (var_1_40 == ((signed short int) (min (var_1_9 , (var_1_15 + (max (var_1_59 , var_1_35))))))) : (var_1_40 == ((signed short int) 32))) : (var_1_40 == ((signed short int) (min ((last_1_var_1_40 + (max (var_1_14 , var_1_62))) , 128))))) : 1)) && ((-4 <= var_1_24) ? (var_1_41 == ((unsigned short int) (var_1_42 - var_1_36))) : 1)) && (((var_1_7 >= last_1_var_1_1) || last_1_var_1_65) ? ((var_1_42 > last_1_var_1_46) ? (var_1_43 == ((unsigned char) (var_1_45 - (max (var_1_36 , var_1_24))))) : 1) : (var_1_43 == ((unsigned char) (var_1_45 - var_1_24))))) && ((var_1_65 || (var_1_1 >= (var_1_43 - var_1_7))) ? ((! var_1_65) ? (var_1_46 == ((unsigned short int) ((abs (var_1_24)) + var_1_43))) : (var_1_46 == ((unsigned short int) (var_1_42 - var_1_45)))) : (var_1_65 ? (var_1_65 ? (var_1_46 == ((unsigned short int) (min ((var_1_42 - var_1_24) , var_1_43)))) : (var_1_46 == ((unsigned short int) (var_1_42 - ((min (var_1_48 , var_1_49)) - (var_1_50 - var_1_45)))))) : ((var_1_41 <= var_1_4) ? (var_1_46 == ((unsigned short int) (var_1_41 + (var_1_24 + (var_1_45 + var_1_36))))) : 1)))) && ((var_1_6 <= (100 / var_1_49)) ? (var_1_52 == ((unsigned char) (var_1_36 + (min (var_1_24 , (64 - var_1_53)))))) : 1)) && ((! var_1_65) ? ((((min (var_1_8 , var_1_7)) / var_1_29) > var_1_5) ? (var_1_54 == ((float) var_1_17)) : 1) : 1)) && (((~ var_1_48) >= (var_1_21 / var_1_42)) ? (((var_1_28 / (min (var_1_30 , var_1_31))) > var_1_33) ? ((var_1_59 >= (25 * var_1_45)) ? (var_1_55 == ((double) (var_1_26 - 32.6))) : ((((var_1_42 - 128) + var_1_24) >= var_1_14) ? (var_1_55 == ((double) ((var_1_32 + (var_1_56 + var_1_57)) - var_1_33))) : (var_1_55 == ((double) (var_1_58 - var_1_26))))) : (var_1_55 == ((double) (var_1_27 - (abs (var_1_19 + var_1_33)))))) : ((var_1_28 >= var_1_18) ? (var_1_55 == ((double) var_1_30)) : (var_1_55 == ((double) var_1_19))))) && ((var_1_6 < var_1_37) ? (var_1_59 == ((unsigned char) ((min (var_1_53 , var_1_24)) + var_1_36))) : ((var_1_30 < (abs (var_1_19))) ? (var_1_59 == ((unsigned char) (min ((var_1_45 - var_1_36) , var_1_53)))) : 1))) && (var_1_65 ? (((~ (var_1_68 + var_1_53)) >= (min (var_1_42 , var_1_48))) ? ((var_1_5 > 8u) ? (var_1_60 == ((signed char) var_1_9)) : 1) : (var_1_60 == ((signed char) (max (var_1_10 , (min (var_1_53 , var_1_35))))))) : (var_1_60 == ((signed char) (var_1_35 - var_1_53))))) && (((var_1_3 * var_1_50) < var_1_62) ? (var_1_61 == ((double) (((var_1_56 + var_1_57) + var_1_32) - var_1_30))) : (var_1_61 == ((double) (abs (var_1_27)))))) && (var_1_65 ? (var_1_62 == ((unsigned short int) var_1_48)) : (var_1_62 == ((unsigned short int) var_1_36)))) && (var_1_63 == ((unsigned char) var_1_36))) && (var_1_65 ? (var_1_64 == ((signed char) var_1_53)) : (var_1_64 == ((signed char) var_1_10)))) && ((var_1_13 && var_1_47) ? (var_1_65 == ((unsigned char) (((last_1_var_1_22 > var_1_3) && (var_1_19 == last_1_var_1_61)) && var_1_66))) : 1)) && (var_1_67 == ((signed char) var_1_35))) && (var_1_68 == ((signed short int) last_1_var_1_68))
;
}
int main(void) {
	isInitial = 1;
