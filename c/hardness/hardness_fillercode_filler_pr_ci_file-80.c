...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch80Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	/* 408L, 270L) */ if (/* 409L, 230L, 231L) */ ((/* 410L, 227L, 232L) */ (min (/* 410L, 227L, 232L) */ (/* 411L, 225L, 233L) */ ((var_1_30) * (var_1_32))) , (var_1_24)))) >= (/* 415L, 229L, 237L) */ (- (var_1_23))))) {
	...
	/* 374L, 219L) */ if (/* 375L, 162L, 163L) */ ((/* 376L, 160L, 164L) */ ((var_1_33) | (var_1_38))) > (var_1_14))) {
		/* 380L, 217L) */ if (/* 381L, 176L, 177L) */ ((var_1_24) <= (/* 383L, 175L, 179L) */ (abs (var_1_20))))) {
			/* 385L, 193L) */ var_1_39 = (
				/* 388L, 192L) */ (min (
					/* 388L, 192L) */ (
						var_1_36
