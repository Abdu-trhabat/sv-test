...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch0no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch0no_floats
	var_1_1 = (var_1_2 + (min ((var_1_3 + -64) , var_1_4)));


	// From: Req2Batch0no_floats
	if (var_1_6) {
...
int property(void) {
	return ((var_1_1 == ((signed long int) (var_1_2 + (min ((var_1_3 + -64) , var_1_4))))) && (var_1_6 ? ((var_1_3 >= ((var_1_7 - var_1_8) + var_1_4)) ? ((var_1_7 >= var_1_4) ? (var_1_5 == ((unsigned char) (var_1_9 || var_1_10))) : (var_1_5 == ((unsigned char) var_1_11))) : (var_1_5 == ((unsigned char) var_1_10))) : 1)) && (((var_1_13 / var_1_14) >= (var_1_15 * var_1_16)) ? ((! var_1_5) ? (var_1_12 == ((unsigned char) (min ((abs (min (var_1_17 , var_1_18))) , var_1_19)))) : ((var_1_7 <= ((var_1_8 / var_1_20) / var_1_21)) ? (var_1_12 == ((unsigned char) var_1_17)) : 1)) : 1)
;
}
int main(void) {
	isInitial = 1;
