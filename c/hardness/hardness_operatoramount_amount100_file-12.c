...
void step(void) {
	...
	if (stepLocal_1 && ((max (last_1_var_1_13 , last_1_var_1_28)) < 32.6)) {
	...
	if (var_1_19 <= stepLocal_7) {
		if (var_1_22 > stepLocal_8) {
			var_1_33 = ((min ((var_1_35 - 2u) , (max (var_1_24 , var_1_36)))) - var_1_19);
		}
	} else {
		var_1_33 = ((var_1_37 + (max (var_1_38 , 1480291245u))) - (var_1_39 - last_1_var_1_16));
	}
	...
	// From: Req11Batch12Amount100
	var_1_40 = var_1_21;


	// From: Req12Batch12Amount100
	var_1_41 = var_1_26;
	...
	if (var_1_41) {
		if (var_1_41) {
			if ((var_1_33 / var_1_18) < stepLocal_4) {
				var_1_23 = (min (var_1_40 , var_1_16));
			} else {
	...
	if (var_1_12 > var_1_11) {
		var_1_13 = (31.4 - (min (var_1_14 , var_1_15)));
	} else {
	...
	if (stepLocal_6 <= ((var_1_16 * -1) & (var_1_23 & var_1_19))) {
		...
		var_1_28 = (max (var_1_11 , ((var_1_29 + var_1_30) - (var_1_31 - var_1_32))));
	}


	// From: Req8Batch12Amount100
	unsigned long int stepLocal_5 = var_1_24;
	if (((min (200.25 , var_1_6)) + var_1_12) < ((var_1_13 + var_1_28) + var_1_14)) {
	...
	if (var_1_33 != stepLocal_3) {
		var_1_17 = (((var_1_18 + var_1_19) - var_1_16) - (max (1 , var_1_20)));
	} else {
		var_1_17 = var_1_18;
	}
...
int property(void) {
	return ((((((((((((((var_1_17 * var_1_16) >= var_1_23) && (! var_1_41)) ? (var_1_1 == ((signed short int) var_1_17)) : (var_1_1 == ((signed short int) var_1_16))) && ((last_1_var_1_41 && ((max (last_1_var_1_13 , last_1_var_1_28)) < 32.6)) ? ((last_1_var_1_41 || last_1_var_1_25) ? (((16.9f * (last_1_var_1_28 / var_1_10)) < last_1_var_1_13) ? (var_1_6 == ((float) var_1_11)) : (var_1_6 == ((float) var_1_12))) : 1) : (var_1_6 == ((float) var_1_11)))) && ((var_1_12 > var_1_11) ? (var_1_13 == ((double) (31.4 - (min (var_1_14 , var_1_15))))) : ((var_1_12 < (var_1_15 - var_1_14)) ? (var_1_41 ? (var_1_13 == ((double) var_1_11)) : (var_1_13 == ((double) var_1_14))) : (var_1_13 == ((double) var_1_11))))) && (last_1_var_1_41 ? ((var_1_14 <= var_1_12) ? (var_1_16 == ((unsigned short int) (last_1_var_1_20 + last_1_var_1_23))) : (var_1_16 == ((unsigned short int) last_1_var_1_20))) : 1)) && ((var_1_33 != var_1_16) ? (var_1_17 == ((unsigned short int) (((var_1_18 + var_1_19) - var_1_16) - (max (1 , var_1_20))))) : (var_1_17 == ((unsigned short int) var_1_18)))) && (var_1_41 ? (var_1_20 == ((unsigned char) (var_1_21 + var_1_22))) : 1)) && (var_1_41 ? (var_1_41 ? (((var_1_33 / var_1_18) < var_1_16) ? (var_1_23 == ((unsigned long int) (min (var_1_40 , var_1_16)))) : (var_1_23 == ((unsigned long int) (var_1_24 - var_1_16)))) : 1) : 1)) && ((((min (200.25 , var_1_6)) + var_1_12) < ((var_1_13 + var_1_28) + var_1_14)) ? ((var_1_22 < var_1_24) ? (var_1_25 == ((unsigned char) var_1_26)) : (var_1_25 == ((unsigned char) var_1_27))) : (var_1_25 == ((unsigned char) var_1_27)))) && ((0 <= ((var_1_16 * -1) & (var_1_23 & var_1_19))) ? (var_1_28 == ((double) (min (var_1_14 , var_1_11)))) : (var_1_28 == ((double) (max (var_1_11 , ((var_1_29 + var_1_30) - (var_1_31 - var_1_32)))))))) && ((var_1_19 <= (- last_1_var_1_17)) ? ((var_1_22 > ((last_1_var_1_23 / var_1_34) * 8)) ? (var_1_33 == ((unsigned long int) ((min ((var_1_35 - 2u) , (max (var_1_24 , var_1_36)))) - var_1_19))) : 1) : (var_1_33 == ((unsigned long int) ((var_1_37 + (max (var_1_38 , 1480291245u))) - (var_1_39 - last_1_var_1_16)))))) && (var_1_40 == ((signed short int) var_1_21))) && (var_1_41 == ((unsigned char) var_1_26))
;
}
int main(void) {
	isInitial = 1;
