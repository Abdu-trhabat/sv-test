...
void step(void) {
	...
	if (last_1_var_1_35 && stepLocal_10) {
		if (stepLocal_11 && last_1_var_1_1) {
			var_1_46 = (max ((max (var_1_44 , var_1_33)) , (var_1_42 + var_1_40)));
		} else {
			if (! last_1_var_1_24) {
		...
		var_1_46 = (min (var_1_43 , (min (var_1_50 , (var_1_41 - var_1_49)))));
	}


	// From: Req13Batch193Amount250
	if ((min (last_1_var_1_62 , (var_1_33 + last_1_var_1_46))) >= (- last_1_var_1_63)) {
		var_1_35 = (var_1_4 || (var_1_5 && var_1_37));
	}


	// From: Req24Batch193Amount250
	if (last_1_var_1_28 <= last_1_var_1_56) {
		if ((- last_1_var_1_26) < var_1_16) {
			if (((abs (last_1_var_1_26)) * last_1_var_1_28) < var_1_10) {
				var_1_63 = var_1_41;
			} else {
				var_1_63 = var_1_42;
			}
	...
	// From: Req23Batch193Amount250
	if ((var_1_42 + var_1_63) != var_1_57) {
		var_1_62 = var_1_42;
	}


	// From: Req20Batch193Amount250
		...
		if (var_1_50 >= var_1_33) {
			if (! last_1_var_1_35) {
				if (stepLocal_13 && (-16 < var_1_8)) {
					var_1_53 = ((min (var_1_54 , var_1_55)) - var_1_10);
				}
			} else {
				var_1_53 = (var_1_54 - last_1_var_1_64);
			}
		} else {
			var_1_53 = (var_1_54 - (max (var_1_16 , (last_1_var_1_29 + var_1_23))));
		}
	} else {
		var_1_53 = (max (last_1_var_1_29 , last_1_var_1_45));
	}


	// From: Req19Batch193Amount250
	if (var_1_16 != var_1_53) {
		var_1_52 = (min (var_1_10 , var_1_16));
	} else {
		var_1_52 = (last_1_var_1_52 - 64);
	}


	// From: Req7Batch193Amount250
	signed long int stepLocal_8 = last_1_var_1_52;
	if (stepLocal_8 > 500) {
		var_1_26 = (min (var_1_8 , ((last_1_var_1_27 - last_1_var_1_26) + var_1_18)));
	} else {
		var_1_26 = (max (last_1_var_1_31 , var_1_11));
	}


	// From: Req8Batch193Amount250
	var_1_27 = 100u;


	// From: Req11Batch193Amount250
	var_1_31 = var_1_17;


	// From: Req15Batch193Amount250
	var_1_39 = (((4.039304764003796E18 - var_1_40) - (var_1_41 - var_1_42)) + (var_1_43 - (abs (var_1_44))));


	// From: Req16Batch193Amount250
	var_1_45 = var_1_23;


	// From: Req21Batch193Amount250
	if ((var_1_63 / (min (var_1_41 , var_1_57))) <= (var_1_46 * var_1_49)) {
		if ((min (last_1_var_1_56 , (var_1_11 - var_1_23))) > ((var_1_16 + var_1_15) - last_1_var_1_56)) {
			var_1_56 = ((var_1_58 - var_1_17) + var_1_59);
		} else {
			var_1_56 = ((var_1_17 + 32) + var_1_11);
		}
	} else {
		var_1_56 = (var_1_60 - (abs (var_1_10)));
	}


	// From: Req6Batch193Amount250
	unsigned long int stepLocal_7 = (min (var_1_53 , var_1_15)) + var_1_8;
	signed long int stepLocal_6 = max (var_1_26 , var_1_17);
	...
	// From: Req9Batch193Amount250
	unsigned long int stepLocal_9 = (var_1_53 + var_1_26) - var_1_11;
	if ((- (max (last_1_var_1_28 , 0))) == stepLocal_9) {
		var_1_28 = var_1_26;
	} else {
		var_1_28 = (min (var_1_23 , (var_1_52 + (var_1_18 + last_1_var_1_28))));
	}


	// From: Req10Batch193Amount250
	if (var_1_24) {
	...
	// From: Req18Batch193Amount250
	signed long int stepLocal_12 = var_1_56 * var_1_26;
	if ((min (256 , 32)) >= stepLocal_12) {
		var_1_51 = ((last_1_var_1_51 + var_1_14) + var_1_10);
	} else {
		var_1_51 = (min (var_1_56 , var_1_18));
	}


	// From: Req2Batch193Amount250
	if (-32 > var_1_28) {
	...
	if (stepLocal_2 <= var_1_28) {
		var_1_12 = (min (var_1_11 , (var_1_10 + var_1_14)));
	} else {
		if (var_1_14 < stepLocal_3) {
			if (stepLocal_4 >= var_1_27) {
				var_1_12 = var_1_14;
			} else {
				var_1_12 = (((var_1_15 - var_1_16) - var_1_11) - ((max (var_1_17 , var_1_18)) - var_1_10));
			}
		} else {
			var_1_12 = var_1_16;
		}
	...
	// From: Req4Batch193Amount250
	if (var_1_27 <= var_1_10) {
		if (var_1_10 > var_1_14) {
			var_1_19 = (min ((max (var_1_9 , var_1_8)) , (min (var_1_29 , last_1_var_1_19))));
		} else {
	...
	// From: Req12Batch193Amount250
	if (var_1_16 > (var_1_23 * var_1_19)) {
		var_1_32 = (abs (255.375));
	} else {
		if (var_1_53 < (256u * var_1_31)) {
			var_1_32 = var_1_33;
		} else {
			var_1_32 = (min (var_1_33 , var_1_34));
		}
	}


	// From: Req1Batch193Amount250
	...
	// From: Req25Batch193Amount250
	if (var_1_1 || (var_1_51 <= var_1_53)) {
		var_1_64 = ((var_1_18 + var_1_66) - (min (var_1_23 , var_1_10)));
	}


	// From: Req14Batch193Amount250
	if (var_1_63 < var_1_33) {
		var_1_38 = (max ((var_1_16 + var_1_23) , var_1_14));
	} else {
		if (var_1_1) {
			var_1_38 = var_1_14;
		} else {
...
int property(void) {
	return (((((((((((((((((((((((((var_1_28 == var_1_56) ? (var_1_1 == ((unsigned char) (! var_1_4))) : (((- var_1_56) < var_1_28) ? (var_1_1 == ((unsigned char) (var_1_4 || ((var_1_56 > var_1_28) || var_1_5)))) : 1)) && ((-32 > var_1_28) ? (var_1_6 == ((signed char) (min (var_1_7 , var_1_8)))) : (var_1_6 == ((signed char) (var_1_9 - (var_1_10 + var_1_11)))))) && ((var_1_27 <= var_1_28) ? (var_1_12 == ((unsigned char) (min (var_1_11 , (var_1_10 + var_1_14))))) : ((var_1_14 < (- (var_1_27 + var_1_28))) ? ((var_1_7 >= var_1_27) ? (var_1_12 == ((unsigned char) var_1_14)) : (var_1_12 == ((unsigned char) (((var_1_15 - var_1_16) - var_1_11) - ((max (var_1_17 , var_1_18)) - var_1_10))))) : (var_1_12 == ((unsigned char) var_1_16))))) && ((var_1_27 <= var_1_10) ? ((var_1_10 > var_1_14) ? (var_1_19 == ((signed long int) (min ((max (var_1_9 , var_1_8)) , (min (var_1_29 , last_1_var_1_19)))))) : (var_1_19 == ((signed long int) (var_1_31 - var_1_26)))) : 1)) && ((var_1_46 >= var_1_39) ? (var_1_21 == ((signed char) ((var_1_23 - var_1_16) - var_1_10))) : (((var_1_5 && (var_1_52 <= var_1_17)) && ((- var_1_11) >= var_1_8)) ? (var_1_21 == ((signed char) (var_1_16 - var_1_23))) : 1))) && ((var_1_16 != (max (var_1_26 , var_1_17))) ? ((((min (var_1_53 , var_1_15)) + var_1_8) > (var_1_11 / -4)) ? (var_1_24 == ((unsigned char) (var_1_5 && var_1_25))) : 1) : (var_1_24 == ((unsigned char) (var_1_35 && var_1_25))))) && ((last_1_var_1_52 > 500) ? (var_1_26 == ((signed long int) (min (var_1_8 , ((last_1_var_1_27 - last_1_var_1_26) + var_1_18))))) : (var_1_26 == ((signed long int) (max (last_1_var_1_31 , var_1_11)))))) && (var_1_27 == ((unsigned long int) 100u))) && (((- (max (last_1_var_1_28 , 0))) == ((var_1_53 + var_1_26) - var_1_11)) ? (var_1_28 == ((unsigned long int) var_1_26)) : (var_1_28 == ((unsigned long int) (min (var_1_23 , (var_1_52 + (var_1_18 + last_1_var_1_28)))))))) && (var_1_24 ? ((var_1_27 <= (- var_1_27)) ? (var_1_29 == ((signed long int) (var_1_16 - var_1_27))) : 1) : ((var_1_26 < var_1_17) ? (var_1_29 == ((signed long int) ((var_1_17 - var_1_26) + 8))) : (var_1_29 == ((signed long int) var_1_27))))) && (var_1_31 == ((unsigned long int) var_1_17))) && ((var_1_16 > (var_1_23 * var_1_19)) ? (var_1_32 == ((double) (abs (255.375)))) : ((var_1_53 < (256u * var_1_31)) ? (var_1_32 == ((double) var_1_33)) : (var_1_32 == ((double) (min (var_1_33 , var_1_34))))))) && (((min (last_1_var_1_62 , (var_1_33 + last_1_var_1_46))) >= (- last_1_var_1_63)) ? (var_1_35 == ((unsigned char) (var_1_4 || (var_1_5 && var_1_37)))) : 1)) && ((var_1_63 < var_1_33) ? (var_1_38 == ((unsigned char) (max ((var_1_16 + var_1_23) , var_1_14)))) : (var_1_1 ? (var_1_38 == ((unsigned char) var_1_14)) : (var_1_38 == ((unsigned char) var_1_16))))) && (var_1_39 == ((double) (((4.039304764003796E18 - var_1_40) - (var_1_41 - var_1_42)) + (var_1_43 - (abs (var_1_44))))))) && (var_1_45 == ((signed short int) var_1_23))) && ((last_1_var_1_35 && last_1_var_1_1) ? ((var_1_5 && last_1_var_1_1) ? (var_1_46 == ((double) (max ((max (var_1_44 , var_1_33)) , (var_1_42 + var_1_40))))) : ((! last_1_var_1_24) ? (var_1_46 == ((double) (var_1_41 + var_1_43))) : (var_1_46 == ((double) ((var_1_40 + (var_1_41 - var_1_42)) - ((3.7765249609076506E18 - var_1_49) + var_1_43)))))) : (var_1_46 == ((double) (min (var_1_43 , (min (var_1_50 , (var_1_41 - var_1_49))))))))) && (((min (256 , 32)) >= (var_1_56 * var_1_26)) ? (var_1_51 == ((signed short int) ((last_1_var_1_51 + var_1_14) + var_1_10))) : (var_1_51 == ((signed short int) (min (var_1_56 , var_1_18)))))) && ((var_1_16 != var_1_53) ? (var_1_52 == ((signed long int) (min (var_1_10 , var_1_16)))) : (var_1_52 == ((signed long int) (last_1_var_1_52 - 64))))) && ((var_1_23 < var_1_17) ? ((var_1_50 >= var_1_33) ? ((! last_1_var_1_35) ? ((var_1_5 && (-16 < var_1_8)) ? (var_1_53 == ((unsigned long int) ((min (var_1_54 , var_1_55)) - var_1_10))) : 1) : (var_1_53 == ((unsigned long int) (var_1_54 - last_1_var_1_64)))) : (var_1_53 == ((unsigned long int) (var_1_54 - (max (var_1_16 , (last_1_var_1_29 + var_1_23))))))) : (var_1_53 == ((unsigned long int) (max (last_1_var_1_29 , last_1_var_1_45)))))) && (((var_1_63 / (min (var_1_41 , var_1_57))) <= (var_1_46 * var_1_49)) ? (((min (last_1_var_1_56 , (var_1_11 - var_1_23))) > ((var_1_16 + var_1_15) - last_1_var_1_56)) ? (var_1_56 == ((unsigned short int) ((var_1_58 - var_1_17) + var_1_59))) : (var_1_56 == ((unsigned short int) ((var_1_17 + 32) + var_1_11)))) : (var_1_56 == ((unsigned short int) (var_1_60 - (abs (var_1_10))))))) && ((var_1_31 <= 2) ? ((var_1_1 && var_1_4) ? (var_1_61 == ((double) (max ((var_1_41 + var_1_43) , var_1_34)))) : 1) : (var_1_61 == ((double) (abs (var_1_40)))))) && (((var_1_42 + var_1_63) != var_1_57) ? (var_1_62 == ((double) var_1_42)) : 1)) && ((last_1_var_1_28 <= last_1_var_1_56) ? (((- last_1_var_1_26) < var_1_16) ? ((((abs (last_1_var_1_26)) * last_1_var_1_28) < var_1_10) ? (var_1_63 == ((double) var_1_41)) : (var_1_63 == ((double) var_1_42))) : (var_1_63 == ((double) var_1_44))) : (var_1_63 == ((double) var_1_44)))) && ((var_1_1 || (var_1_51 <= var_1_53)) ? (var_1_64 == ((unsigned char) ((var_1_18 + var_1_66) - (min (var_1_23 , var_1_10))))) : 1)
;
}
int main(void) {
	isInitial = 1;
