...
void step(void) {
	// From: Req3Batch191Amount250
	unsigned long int stepLocal_2 = min (last_1_var_1_70 , last_1_var_1_40);
	unsigned long int stepLocal_1 = var_1_7 + last_1_var_1_70;
	if (var_1_6 >= stepLocal_2) {
		if ((min ((min (last_1_var_1_40 , last_1_var_1_16)) , last_1_var_1_70)) >= stepLocal_1) {
	...
	// From: Req2Batch191Amount250
	if (last_1_var_1_57) {
		var_1_8 = ((max (1000u , var_1_7)) + var_1_6);
	}


	// From: Req23Batch191Amount250
	unsigned long int stepLocal_15 = var_1_8;
	if ((min (var_1_43 , 16)) >= stepLocal_15) {
		var_1_57 = var_1_58;
	} else {
		var_1_57 = (! var_1_59);
	}
	...
	// From: Req6Batch191Amount250
	if (var_1_57) {
		var_1_26 = (var_1_25 + (var_1_22 - var_1_23));
	} else {
		if (var_1_57) {
			if (var_1_14 < var_1_22) {
				var_1_26 = ((max (var_1_25 , 0)) - ((var_1_28 - 16) - 1));
			} else {
				var_1_26 = (max (10 , var_1_23));
			}
		} else {
			var_1_26 = (abs (var_1_25));
		}
	}


	// From: Req8Batch191Amount250
	var_1_30 = (var_1_25 - var_1_22);


	// From: Req11Batch191Amount250
	var_1_35 = (max (50.75f , var_1_33));


	// From: Req12Batch191Amount250
	var_1_36 = (var_1_37 - var_1_23);


	// From: Req14Batch191Amount250
	var_1_40 = (var_1_37 - (var_1_7 + (min (var_1_15 , var_1_25))));


	// From: Req15Batch191Amount250
	unsigned char stepLocal_11 = var_1_9;
	if (stepLocal_11 && var_1_27) {
		var_1_41 = (((max (var_1_14 , var_1_42)) + var_1_43) - var_1_24);
	} else {
		var_1_41 = var_1_14;
	}


	// From: Req16Batch191Amount250
	if (var_1_35 == var_1_33) {
		var_1_44 = var_1_22;
	}


	// From: Req17Batch191Amount250
	var_1_46 = (abs (var_1_18));


	// From: Req18Batch191Amount250
	var_1_47 = (var_1_25 + var_1_28);


	// From: Req19Batch191Amount250
	if (var_1_57) {
		if (var_1_57) {
			var_1_48 = (max ((var_1_49 - var_1_24) , (var_1_28 + (max (var_1_23 , var_1_22)))));
		}
	} else {
	...
	// From: Req27Batch191Amount250
	if (var_1_57) {
		var_1_72 = var_1_28;
	}


	// From: Req13Batch191Amount250
	...
	// From: Req4Batch191Amount250
	if ((min (var_1_12 , var_1_41)) > -100000) {
		var_1_16 = ((min (var_1_15 , var_1_17)) + ((var_1_18 - var_1_19) + 2));
	}


	// From: Req5Batch191Amount250
	...
	if (stepLocal_3 >= (var_1_44 + var_1_41)) {
		if (var_1_57) {
			if (stepLocal_4 >= (var_1_14 / (var_1_13 - var_1_21))) {
				var_1_20 = ((var_1_22 - var_1_23) + (var_1_24 - (max (0 , var_1_25))));
			} else {
				var_1_20 = var_1_24;
			}
		} else {
			var_1_20 = (min (var_1_25 , var_1_24));
		}
	} else {
		var_1_20 = var_1_24;
	}
	...
	// From: Req28Batch191Amount250
	if (16 >= var_1_44) {
		if (var_1_58 || var_1_59) {
			var_1_73 = (min ((var_1_13 - var_1_67) , ((var_1_42 - var_1_25) + var_1_51)));
		} else {
			var_1_73 = var_1_22;
		}
	} else {
	...
	// From: Req7Batch191Amount250
	signed long int stepLocal_5 = var_1_38;
	if (stepLocal_5 > ((var_1_24 ^ var_1_25) / (abs (var_1_28)))) {
	...
	if (var_1_61 <= (var_1_54 + var_1_62)) {
		if ((var_1_40 >= (- var_1_13)) || stepLocal_22) {
			...
			var_1_70 = (min (var_1_12 , var_1_73));
		}
	} else {
	...
	if (var_1_33 >= (64.25f + var_1_54)) {
		if (stepLocal_16 < ((var_1_12 - var_1_43) + var_1_22)) {
			if ((var_1_54 / var_1_61) >= (max (var_1_56 , (var_1_33 / var_1_62)))) {
				var_1_60 = (max ((var_1_55 - var_1_54) , 8.3));
			} else {
				var_1_60 = var_1_33;
			}
		} else {
		...
		if (var_1_24 < stepLocal_17) {
			...
			if ((var_1_24 ^ (var_1_70 + 128)) < stepLocal_18) {
				var_1_60 = (max (var_1_32 , var_1_55));
			} else {
				if (stepLocal_19 > (~ (-500 ^ var_1_25))) {
					var_1_60 = ((min (var_1_55 , var_1_56)) + (var_1_54 - var_1_63));
				} else {
	...
	// From: Req10Batch191Amount250
	unsigned short int stepLocal_7 = var_1_41;
	if ((min (var_1_50 , var_1_41)) > stepLocal_7) {
		if (var_1_57) {
			var_1_34 = (max (var_1_24 , var_1_28));
		} else {
			var_1_34 = (max ((var_1_22 + var_1_25) , (-10 + (min (var_1_23 , var_1_24)))));
		}
	}
}
...
int property(void) {
	return (((((((((((((((((((((((((((((max ((max (var_1_40 , var_1_16)) , var_1_40)) >= var_1_46) ? (var_1_1 == ((unsigned short int) (var_1_6 + (abs (abs (var_1_7)))))) : 1) && (last_1_var_1_57 ? (var_1_8 == ((unsigned long int) ((max (1000u , var_1_7)) + var_1_6))) : 1)) && ((var_1_6 >= (min (last_1_var_1_70 , last_1_var_1_40))) ? (((min ((min (last_1_var_1_40 , last_1_var_1_16)) , last_1_var_1_70)) >= (var_1_7 + last_1_var_1_70)) ? (var_1_10 == ((unsigned short int) (max ((var_1_6 + var_1_7) , var_1_12)))) : (var_1_10 == ((unsigned short int) (var_1_13 - (var_1_14 - var_1_15))))) : (var_1_10 == ((unsigned short int) var_1_6)))) && (((min (var_1_12 , var_1_41)) > -100000) ? (var_1_16 == ((signed short int) ((min (var_1_15 , var_1_17)) + ((var_1_18 - var_1_19) + 2)))) : 1)) && ((var_1_41 >= (var_1_44 + var_1_41)) ? (var_1_57 ? ((var_1_15 >= (var_1_14 / (var_1_13 - var_1_21))) ? (var_1_20 == ((signed char) ((var_1_22 - var_1_23) + (var_1_24 - (max (0 , var_1_25)))))) : (var_1_20 == ((signed char) var_1_24))) : (var_1_20 == ((signed char) (min (var_1_25 , var_1_24))))) : (var_1_20 == ((signed char) var_1_24)))) && (var_1_57 ? (var_1_26 == ((signed char) (var_1_25 + (var_1_22 - var_1_23)))) : (var_1_57 ? ((var_1_14 < var_1_22) ? (var_1_26 == ((signed char) ((max (var_1_25 , 0)) - ((var_1_28 - 16) - 1)))) : (var_1_26 == ((signed char) (max (10 , var_1_23))))) : (var_1_26 == ((signed char) (abs (var_1_25))))))) && ((var_1_38 > ((var_1_24 ^ var_1_25) / (abs (var_1_28)))) ? (var_1_29 == ((signed short int) (var_1_22 + (var_1_15 - 25)))) : (var_1_29 == ((signed short int) (var_1_18 + var_1_23))))) && (var_1_30 == ((signed char) (var_1_25 - var_1_22)))) && ((var_1_73 <= var_1_50) ? (var_1_31 == ((float) (var_1_32 - var_1_33))) : 1)) && (((min (var_1_50 , var_1_41)) > var_1_41) ? (var_1_57 ? (var_1_34 == ((signed char) (max (var_1_24 , var_1_28)))) : (var_1_34 == ((signed char) (max ((var_1_22 + var_1_25) , (-10 + (min (var_1_23 , var_1_24)))))))) : 1)) && (var_1_35 == ((float) (max (50.75f , var_1_33))))) && (var_1_36 == ((unsigned long int) (var_1_37 - var_1_23)))) && ((last_1_var_1_38 < var_1_6) ? (var_1_38 == ((signed long int) (min (var_1_10 , var_1_8)))) : ((var_1_57 && (var_1_19 > var_1_41)) ? (((var_1_39 - var_1_23) == var_1_8) ? (var_1_38 == ((signed long int) 25)) : (var_1_38 == ((signed long int) var_1_14))) : (var_1_38 == ((signed long int) var_1_41))))) && (var_1_40 == ((unsigned long int) (var_1_37 - (var_1_7 + (min (var_1_15 , var_1_25))))))) && ((var_1_9 && var_1_27) ? (var_1_41 == ((unsigned short int) (((max (var_1_14 , var_1_42)) + var_1_43) - var_1_24))) : (var_1_41 == ((unsigned short int) var_1_14)))) && ((var_1_35 == var_1_33) ? (var_1_44 == ((unsigned long int) var_1_22)) : 1)) && (var_1_46 == ((unsigned long int) (abs (var_1_18))))) && (var_1_47 == ((unsigned char) (var_1_25 + var_1_28)))) && (var_1_57 ? (var_1_57 ? (var_1_48 == ((unsigned char) (max ((var_1_49 - var_1_24) , (var_1_28 + (max (var_1_23 , var_1_22))))))) : 1) : (var_1_48 == ((unsigned char) (var_1_49 - var_1_22))))) && ((((- var_1_33) <= var_1_60) && var_1_57) ? (var_1_50 == ((signed short int) var_1_52)) : (var_1_50 == ((signed short int) ((var_1_51 - var_1_49) - var_1_39))))) && (((var_1_8 <= var_1_73) || var_1_57) ? (var_1_52 == ((signed char) (var_1_25 + var_1_23))) : (var_1_52 == ((signed char) (var_1_23 + (min (-32 , var_1_25))))))) && ((var_1_9 && var_1_27) ? (var_1_53 == ((double) ((var_1_54 - var_1_55) + var_1_56))) : 1)) && (((min (var_1_43 , 16)) >= var_1_8) ? (var_1_57 == ((unsigned char) var_1_58)) : (var_1_57 == ((unsigned char) (! var_1_59))))) && ((var_1_33 >= (64.25f + var_1_54)) ? ((var_1_70 < ((var_1_12 - var_1_43) + var_1_22)) ? (((var_1_54 / var_1_61) >= (max (var_1_56 , (var_1_33 / var_1_62)))) ? (var_1_60 == ((double) (max ((var_1_55 - var_1_54) , 8.3)))) : (var_1_60 == ((double) var_1_33))) : (var_1_60 == ((double) var_1_56))) : ((var_1_24 < var_1_19) ? (var_1_60 == ((double) var_1_55)) : (((var_1_24 ^ (var_1_70 + 128)) < (min ((var_1_46 * var_1_23) , var_1_46))) ? (var_1_60 == ((double) (max (var_1_32 , var_1_55)))) : ((1000000000 > (~ (-500 ^ var_1_25))) ? (var_1_60 == ((double) ((min (var_1_55 , var_1_56)) + (var_1_54 - var_1_63)))) : (((var_1_13 - var_1_15) <= var_1_44) ? (var_1_60 == ((double) ((var_1_55 - var_1_63) + ((var_1_64 + var_1_65) - var_1_54)))) : (var_1_60 == ((double) (var_1_65 + (var_1_64 + var_1_66)))))))))) && ((var_1_36 < var_1_8) ? (var_1_57 ? (var_1_67 == ((signed short int) var_1_68)) : (var_1_67 == ((signed short int) (var_1_69 - (var_1_49 + var_1_72))))) : 1)) && ((var_1_61 <= (var_1_54 + var_1_62)) ? (((var_1_40 >= (- var_1_13)) || ((var_1_25 - var_1_18) != (var_1_29 / var_1_39))) ? (var_1_70 == ((unsigned long int) ((var_1_71 + 1412059298u) - var_1_28))) : (var_1_70 == ((unsigned long int) (min (var_1_12 , var_1_73))))) : ((var_1_49 <= var_1_7) ? (var_1_70 == ((unsigned long int) var_1_49)) : (var_1_70 == ((unsigned long int) var_1_23))))) && (var_1_57 ? (var_1_72 == ((unsigned char) var_1_28)) : 1)) && ((16 >= var_1_44) ? ((var_1_58 || var_1_59) ? (var_1_73 == ((unsigned short int) (min ((var_1_13 - var_1_67) , ((var_1_42 - var_1_25) + var_1_51))))) : (var_1_73 == ((unsigned short int) var_1_22))) : (var_1_73 == ((unsigned short int) var_1_28)))
;
}
int main(void) {
	isInitial = 1;
