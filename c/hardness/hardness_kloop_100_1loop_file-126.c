...
void step(void) {
	// From: Req14Batch126100_1loop
	unsigned long int stepLocal_9 = last_1_var_1_23 & (var_1_22 * last_1_var_1_20);
	if ((var_1_25 >> (min (var_1_35 , var_1_36))) > stepLocal_9) {
	...
	// From: Req12Batch126100_1loop
	unsigned char stepLocal_7 = var_1_34;
	if (stepLocal_7 && var_1_9) {
		var_1_29 = (abs (var_1_11));
	} else {
		var_1_29 = var_1_30;
	}


	// From: Req7Batch126100_1loop
	unsigned long int stepLocal_4 = var_1_18;
	if (8u > stepLocal_4) {
		var_1_20 = (min (var_1_5 , var_1_4));
	} else {
		var_1_20 = (max (var_1_29 , (var_1_5 + var_1_4)));
	}


	// From: Req1Batch126100_1loop
	if (var_1_8 || var_1_34) {
		var_1_1 = (abs (min (var_1_4 , var_1_5)));
	}


	// From: Req2Batch126100_1loop
	signed char stepLocal_0 = var_1_5;
	if ((abs (var_1_4)) > stepLocal_0) {
		var_1_6 = var_1_7;
	}


	// From: Req5Batch126100_1loop
	if (var_1_9) {
		var_1_12 = ((127.4 + (min (0.19999999999999996 , var_1_13))) + var_1_14);
	}


	// From: Req6Batch126100_1loop
	var_1_15 = (var_1_16 + (min (var_1_17 , (max (var_1_18 , var_1_19)))));


	// From: Req8Batch126100_1loop
	...
	if (stepLocal_5 != var_1_22) {
		...
		var_1_21 = (min (var_1_14 , 128.8));
	}


	// From: Req9Batch126100_1loop
	...
	// From: Req10Batch126100_1loop
	var_1_26 = (min ((max (var_1_4 , var_1_1)) , var_1_27));


	// From: Req11Batch126100_1loop
	var_1_28 = var_1_13;


	// From: Req15Batch126100_1loop
	...
	// From: Req16Batch126100_1loop
	var_1_41 = var_1_7;


	// From: Req4Batch126100_1loop
	unsigned long int stepLocal_3 = var_1_15 * var_1_5;
	if (stepLocal_3 < var_1_4) {
		var_1_10 = (max (var_1_15 , (var_1_11 - 5)));
	} else {
		var_1_10 = var_1_11;
	}


	// From: Req13Batch126100_1loop
	unsigned long int stepLocal_8 = var_1_16;
	if (var_1_6 >= var_1_41) {
		var_1_31 = (abs (var_1_25 + (max (var_1_11 , var_1_30))));
	} else {
...
int property(void) {
	return ((((((((((((((((var_1_8 || var_1_34) ? (var_1_1 == ((signed char) (abs (min (var_1_4 , var_1_5))))) : 1) && (((abs (var_1_4)) > var_1_5) ? (var_1_6 == ((float) var_1_7)) : 1)) && (((! var_1_34) && var_1_34) ? (var_1_34 ? ((var_1_5 <= var_1_4) ? (var_1_8 == ((unsigned char) 0)) : 1) : 1) : (var_1_8 == ((unsigned char) var_1_9)))) && (((var_1_15 * var_1_5) < var_1_4) ? (var_1_10 == ((signed short int) (max (var_1_15 , (var_1_11 - 5))))) : (var_1_10 == ((signed short int) var_1_11)))) && (var_1_9 ? (var_1_12 == ((double) ((127.4 + (min (0.19999999999999996 , var_1_13))) + var_1_14))) : 1)) && (var_1_15 == ((unsigned long int) (var_1_16 + (min (var_1_17 , (max (var_1_18 , var_1_19)))))))) && ((8u > var_1_18) ? (var_1_20 == ((signed short int) (min (var_1_5 , var_1_4)))) : (var_1_20 == ((signed short int) (max (var_1_29 , (var_1_5 + var_1_4))))))) && ((var_1_15 != var_1_22) ? ((var_1_13 >= var_1_12) ? (var_1_21 == ((double) var_1_14)) : 1) : (var_1_21 == ((double) (min (var_1_14 , 128.8)))))) && (((36842 - var_1_24) > (var_1_16 - var_1_18)) ? ((var_1_14 < 31.8) ? (var_1_23 == ((unsigned char) var_1_25)) : 1) : (var_1_23 == ((unsigned char) var_1_25)))) && (var_1_26 == ((signed long int) (min ((max (var_1_4 , var_1_1)) , var_1_27))))) && (var_1_28 == ((float) var_1_13))) && ((var_1_34 && var_1_9) ? (var_1_29 == ((signed short int) (abs (var_1_11)))) : (var_1_29 == ((signed short int) var_1_30)))) && ((var_1_6 >= var_1_41) ? (var_1_31 == ((signed long int) (abs (var_1_25 + (max (var_1_11 , var_1_30)))))) : ((var_1_16 < (var_1_18 / var_1_33)) ? (var_1_31 == ((signed long int) -2)) : (var_1_31 == ((signed long int) var_1_29))))) && (((var_1_25 >> (min (var_1_35 , var_1_36))) > (last_1_var_1_23 & (var_1_22 * last_1_var_1_20))) ? (var_1_34 == ((unsigned char) ((! var_1_37) || (var_1_9 || var_1_38)))) : (var_1_34 == ((unsigned char) (last_1_var_1_8 || (! (last_1_var_1_8 && var_1_38))))))) && ((var_1_36 <= (- (var_1_17 & var_1_19))) ? ((-8 > (var_1_16 / var_1_40)) ? (var_1_39 == ((unsigned char) (var_1_35 + var_1_36))) : 1) : (var_1_39 == ((unsigned char) var_1_25)))) && (var_1_41 == ((double) var_1_7))
;
}
int main(void) {
	isInitial = 1;
