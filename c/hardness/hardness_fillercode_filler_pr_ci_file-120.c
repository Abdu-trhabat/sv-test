...
void step(void) {
	...
	// From: Req8Batch120Filler_PR_CI
	/* 962L, 255L, 773L, 779L) */ var_1_22 = (
		var_1_14
	);


	// From: Req4Batch120Filler_PR_CI
	...
	// From: CodeObject3
	/* 275L, 82L) */ if (/* 276L, 64L, 65L) */ ((/* 277L, 62L, 66L) */ (max (/* 277L, 62L, 66L) */ (var_1_12) , (var_1_18)))) <= (var_1_20))) {
		/* 281L, 81L) */ var_1_30 = (
			/* 284L, 80L) */ ((
				/* 285L, 78L) */ (abs (
					var_1_32
	...
	// From: CodeObject4
	/* 289L, 99L) */ if (/* 290L, 88L, 89L) */ ((var_1_16) > (var_1_21))) {
		/* 293L, 98L) */ var_1_34 = (
			var_1_32
		);
	}
	...
	// From: CodeObject2
	/* 266L, 56L) */ if (/* 267L, 44L, 45L) */ ((10) >= (var_1_18))) {
		/* 270L, 55L) */ var_1_28 = (
			/* 273L, 54L) */ (abs (
				var_1_21
			))
