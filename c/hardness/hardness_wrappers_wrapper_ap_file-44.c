...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch44Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	signed char stepLocal_1 = (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer));
	signed long int stepLocal_0 = (min ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) , (*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer)))) / (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer));
	if (stepLocal_1 > ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) - (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) {
	...
	if (((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) - (abs ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))))) >= (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))) {
	...
	signed char stepLocal_3 = (*(signed_char_Array_0_arraysigned_char_Array_0Var4_Pointer));
	signed long int stepLocal_2 = (*(signed_char_Array_0_arraysigned_char_Array_0Var4_Pointer)) * ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) * (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)));
