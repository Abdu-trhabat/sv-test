...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_22 || stepLocal_1) {
		var_1_14 = (max ((max (var_1_3 , var_1_4)) , var_1_13));
	} else {
		var_1_14 = 5;
	}
	...
	var_1_12 = (((min (var_1_23 , var_1_3)) + var_1_4) + (min (var_1_13 , 100)));
...
int property(void) {
	return (((((((((((var_1_22 ? (var_1_1 == ((unsigned char) ((var_1_3 + var_1_4) + 8))) : 1) && (var_1_22 ? ((((var_1_3 / 1) / var_1_6) == ((var_1_15 * var_1_4) % var_1_7)) ? (var_1_5 == ((double) (max ((var_1_8 - var_1_9) , var_1_10)))) : (var_1_5 == ((double) var_1_11))) : (var_1_5 == ((double) var_1_10)))) && (var_1_12 == ((signed long int) (((min (var_1_23 , var_1_3)) + var_1_4) + (min (var_1_13 , 100)))))) && ((var_1_22 || (var_1_4 <= (- var_1_6))) ? (var_1_14 == ((signed long int) (max ((max (var_1_3 , var_1_4)) , var_1_13)))) : (var_1_14 == ((signed long int) 5)))) && ((var_1_2 || var_1_16) ? (((var_1_14 * (var_1_14 % var_1_7)) < (var_1_6 / var_1_18)) ? (var_1_15 == ((signed short int) 10)) : (var_1_15 == ((signed short int) var_1_4))) : (var_1_15 == ((signed short int) 2)))) && ((var_1_9 > (var_1_5 * var_1_8)) ? (var_1_19 == ((signed char) var_1_4)) : (var_1_19 == ((signed char) (var_1_4 + var_1_20))))) && ((((5 | var_1_3) < (var_1_4 << var_1_18)) && (var_1_12 < var_1_14)) ? (var_1_21 == ((signed short int) var_1_3)) : ((var_1_18 > var_1_12) ? (var_1_21 == ((signed short int) var_1_20)) : (var_1_21 == ((signed short int) var_1_4))))) && (var_1_22 == ((unsigned char) 0))) && (((var_1_24 - (var_1_25 - var_1_3)) <= (max (var_1_15 , var_1_7))) ? (var_1_22 ? (var_1_23 == ((signed long int) (var_1_24 - var_1_25))) : (var_1_23 == ((signed long int) 50))) : (var_1_23 == ((signed long int) var_1_15)))) && ((var_1_13 < var_1_14) ? ((-1 >= var_1_23) ? ((var_1_23 <= (0 & var_1_25)) ? (var_1_26 == ((float) (var_1_9 - (var_1_27 + var_1_28)))) : 1) : (var_1_26 == ((float) ((max (var_1_9 , (var_1_29 - var_1_28))) - var_1_27)))) : 1)) && (((var_1_21 ^ var_1_23) <= var_1_12) ? ((var_1_16 && var_1_2) ? (var_1_22 ? (var_1_30 == ((float) (abs (var_1_27)))) : 1) : ((((var_1_3 + var_1_4) - var_1_31) <= var_1_23) ? ((var_1_20 < var_1_19) ? (var_1_30 == ((float) (var_1_9 - var_1_27))) : (var_1_30 == ((float) (max (var_1_10 , var_1_8))))) : 1)) : 1)) && (var_1_33 == ((float) var_1_10))
;
}
int main(void) {
	isInitial = 1;
