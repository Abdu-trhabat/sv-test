...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch88no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (-1 < ((var_1_9 + var_1_10) / (max (-8 , var_1_11)))) {
...
int property(void) {
	return (((((last_1_var_1_16 | last_1_var_1_8) > last_1_var_1_8) && var_1_5) ? ((var_1_5 && var_1_6) ? (var_1_1 == ((signed char) var_1_7)) : (var_1_1 == ((signed char) -25))) : (var_1_1 == ((signed char) var_1_7))) && ((-1 < ((var_1_9 + var_1_10) / (max (-8 , var_1_11)))) ? (var_1_8 == ((signed long int) (((1000000000 + var_1_12) - (var_1_13 - var_1_14)) - var_1_15))) : (var_1_8 == ((signed long int) (var_1_13 - var_1_15))))) && ((var_1_13 != 0) ? (var_1_16 == ((signed short int) (var_1_17 - (var_1_18 - 2)))) : ((var_1_11 <= (-128 + (- var_1_10))) ? (var_1_16 == ((signed short int) var_1_1)) : 1))
;
}
int main(void) {
	isInitial = 1;
