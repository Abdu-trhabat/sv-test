...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch180stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_0 >= var_1_1) {
		...
		if ((min (var_1_1 , var_1_2)) >= stepLocal_1) {
			var_1_6 = var_1_9;
		}
	}


	// From: Req3Batch180stepLocals
	if (var_1_7) {
		if (! var_1_11) {
	...
	// From: Req4Batch180stepLocals
	var_1_14 = (min ((var_1_4 - var_1_12) , var_1_15));


	// From: Req5Batch180stepLocals
	unsigned long int stepLocal_2 = var_1_12 + (var_1_1 / var_1_5);
	...
	// From: Req7Batch180stepLocals
	var_1_19 = (min (var_1_8 , var_1_9));


	// From: Req8Batch180stepLocals
	signed long int stepLocal_5 = var_1_15 * (var_1_21 | var_1_14);
	signed char stepLocal_4 = var_1_17;
	if (stepLocal_4 > (var_1_1 * var_1_4)) {
