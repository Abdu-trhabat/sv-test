...
void step(void) {
	...
	if (63.5 <= last_1_var_1_24) {
		var_1_87 = (abs (1 + last_1_var_1_107));
	} else {
		if (var_1_43 < (last_1_var_1_106 / var_1_27)) {
			var_1_87 = (max (5 , (min (-100 , var_1_46))));
		} else {
			var_1_87 = var_1_39;
		}
	}
	...
	if ((abs (var_1_13 - var_1_46)) <= stepLocal_31) {
		var_1_106 = (var_1_48 + var_1_44);
	} else {
		var_1_106 = (max (var_1_27 , var_1_49));
	}
		...
		if (stepLocal_12 > var_1_5) {
			if (((var_1_25 * var_1_47) < var_1_48) && stepLocal_13) {
				if (last_1_var_1_82 < stepLocal_11) {
					...
					var_1_57 = (max ((min (var_1_6 , var_1_5)) , var_1_20));
				}
			} else {
				var_1_57 = (abs ((abs (var_1_36)) + var_1_20));
			}
		}
	}
	...
	if (stepLocal_4 <= last_1_var_1_38) {
		...
		if ((var_1_28 + 32.3) < (- (max (var_1_25 , var_1_26)))) {
	...
	signed long int stepLocal_14 = (max (var_1_34 , var_1_59)) - var_1_13;
	if (stepLocal_14 <= (var_1_20 - (abs (var_1_6)))) {
	...
	if (var_1_7 >= stepLocal_7) {
		var_1_42 = (min (((var_1_43 + var_1_44) + (var_1_28 - var_1_45)) , 5.3f));
	} else {
	...
	if (stepLocal_20 > (var_1_7 / var_1_10)) {
		if (var_1_32) {
			if (var_1_69 > stepLocal_19) {
				...
				var_1_68 = (((max (var_1_48 , var_1_50)) + (var_1_47 + var_1_51)) - 15.4f);
			}
		} else {
	...
	if ((last_1_var_1_53 / var_1_34) == stepLocal_9) {
		var_1_53 = ((min (var_1_9 , var_1_8)) - (min (var_1_54 , var_1_36)));
	} else {
	...
	if (var_1_101) {
		var_1_60 = ((min (var_1_34 , 200)) - var_1_5);
	}
	...
	if (var_1_23 >= (var_1_13 - var_1_5)) {
		...
		var_1_86 = (max (var_1_59 , (max (var_1_53 , (2 - var_1_34)))));
	}
	...
	if (var_1_70 && var_1_65) {
		...
		if ((- (- var_1_9)) < (var_1_36 + 32u)) {
			if (! var_1_70) {
				var_1_85 = ((min (var_1_27 , var_1_48)) - (7.397802701382283E18 - (var_1_49 - var_1_47)));
			}
		}
	}
	...
	if (! var_1_29) {
		...
		var_1_81 = (abs (var_1_38));
	}


	// From: Req4Batch45Amount500
	if ((min (var_1_52 , var_1_73)) > (var_1_73 / (abs (var_1_19)))) {
	...
	if (var_1_32 && stepLocal_15) {
		var_1_61 = (min (var_1_34 , var_1_15));
	} else {
	...
	if ((var_1_88 + (var_1_68 + var_1_45)) == var_1_51) {
		if (var_1_70) {
			var_1_62 = (min ((max ((var_1_36 + 5) , var_1_5)) , (abs (var_1_46))));
		} else {
			if (((max (var_1_5 , var_1_36)) - (min (var_1_46 , 0))) > stepLocal_17) {
				if (! var_1_32) {
					var_1_62 = var_1_34;
				} else {
	...
	if ((var_1_13 <= var_1_7) && (var_1_81 > var_1_77)) {
		if (var_1_101) {
			var_1_83 = ((min (var_1_36 , var_1_39)) + var_1_46);
		} else {
			var_1_83 = ((var_1_46 + -16) + (min (var_1_5 , var_1_36)));
		}
	}
	...
	if (! var_1_63) {
		if (var_1_63 || stepLocal_10) {
			...
			var_1_55 = (min (((var_1_47 + 0.8f) + var_1_48) , (var_1_51 - var_1_28)));
		}
	} else {
	...
	signed long int stepLocal_28 = var_1_98 / (max (var_1_34 , var_1_5));
	if (var_1_29) {
		if (var_1_70) {
			var_1_78 = (((var_1_49 - var_1_50) + (min (var_1_51 , var_1_48))) - (max (var_1_47 , (min (var_1_26 , var_1_28)))));
		} else {
			if (var_1_63) {
				var_1_78 = ((var_1_27 - var_1_50) - ((abs (var_1_80)) - var_1_48));
			} else {
				if (stepLocal_28 <= var_1_10) {
					if (stepLocal_29 <= var_1_53) {
						var_1_78 = (var_1_50 + (min ((abs (9.375f)) , 3.5f)));
					} else {
						var_1_78 = (var_1_51 + (min (var_1_50 , var_1_47)));
					}
				}
			}
		}
		...
		if (var_1_49 > ((32.25f / var_1_19) / var_1_80)) {
			var_1_78 = (50.5f - (min (2.4f , 7.375f)));
		}
	}
	...
	if (var_1_106 > var_1_42) {
		var_1_82 = (min ((var_1_34 + (var_1_15 + var_1_36)) , -10));
	} else {
		if (var_1_81 <= stepLocal_30) {
			...
			if (var_1_24 != var_1_68) {
				var_1_82 = (max ((min (var_1_15 , var_1_34)) , var_1_72));
			} else {
				var_1_82 = var_1_11;
			}
		}
	...
	if (! var_1_63) {
		if (var_1_63) {
			var_1_14 = ((32 + last_1_var_1_14) + (abs (min (var_1_5 , -50))));
		} else {
			var_1_14 = var_1_13;
		}
	}
	...
	if (var_1_63) {
		var_1_37 = (min (var_1_5 , -5));
	} else {
		if ((var_1_13 * var_1_20) > (max ((var_1_6 * var_1_86) , 16u))) {
			var_1_37 = -1;
		}
	}
	...
	if (! var_1_63) {
		var_1_67 = ((var_1_27 - var_1_50) - (min (var_1_49 , var_1_51)));
	} else {
		var_1_67 = (max (9.25 , var_1_48));
	}


	// From: Req30Batch45Amount500
	signed char stepLocal_26 = var_1_13;
	unsigned long int stepLocal_25 = var_1_54 / (max (var_1_69 , var_1_34));
	if (((var_1_15 & var_1_82) / 100) <= stepLocal_25) {
		var_1_75 = var_1_5;
	} else {
		if (var_1_53 > stepLocal_26) {
			var_1_75 = (max (var_1_46 , var_1_36));
		}
	}
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((last_1_var_1_57 >= last_1_var_1_53) || last_1_var_1_101) ? ((((last_1_var_1_57 * last_1_var_1_53) >> var_1_5) >= 50u) ? (var_1_1 == ((unsigned long int) (var_1_5 + (var_1_6 + var_1_7)))) : (var_1_1 == ((unsigned long int) (var_1_5 + (min (var_1_7 , var_1_6)))))) : (last_1_var_1_101 ? (var_1_1 == ((unsigned long int) ((min (var_1_8 , var_1_9)) - (var_1_10 - (var_1_11 - var_1_5))))) : 1)) && ((var_1_15 == var_1_5) ? (var_1_12 == ((signed char) (var_1_5 - (var_1_13 - 8)))) : 1)) && ((! var_1_63) ? (var_1_63 ? (var_1_14 == ((signed short int) ((32 + last_1_var_1_14) + (abs (min (var_1_5 , -50)))))) : (var_1_14 == ((signed short int) var_1_13))) : 1)) && (((min (var_1_52 , var_1_73)) > (var_1_73 / (abs (var_1_19)))) ? (var_1_15 == ((unsigned long int) ((var_1_10 - var_1_7) + (5u + var_1_11)))) : (var_1_15 == ((unsigned long int) (var_1_7 + (var_1_20 + var_1_11)))))) && ((var_1_70 || var_1_101) ? ((! var_1_70) ? (var_1_21 == ((unsigned char) (var_1_5 + (abs (var_1_13))))) : 1) : 1)) && (var_1_23 == ((signed short int) var_1_5))) && (var_1_24 == ((double) ((max (var_1_25 , var_1_26)) - (var_1_27 - var_1_28))))) && (((var_1_5 << last_1_var_1_58) <= last_1_var_1_38) ? (var_1_29 == ((unsigned char) ((last_1_var_1_38 <= var_1_7) || var_1_30))) : (((var_1_28 + 32.3) < (- (max (var_1_25 , var_1_26)))) ? ((var_1_9 < var_1_20) ? (var_1_29 == ((unsigned char) ((1 >= var_1_13) && (! var_1_30)))) : (var_1_29 == ((unsigned char) (var_1_30 || var_1_32)))) : 1))) && ((var_1_72 <= (var_1_57 * 128)) ? (var_1_33 == ((unsigned char) var_1_13)) : (var_1_33 == ((unsigned char) ((var_1_34 - var_1_5) - var_1_13))))) && ((((var_1_5 + var_1_36) >> 1) > var_1_93) ? (var_1_35 == ((unsigned long int) var_1_6)) : 1)) && (var_1_63 ? (var_1_37 == ((signed char) (min (var_1_5 , -5)))) : (((var_1_13 * var_1_20) > (max ((var_1_6 * var_1_86) , 16u))) ? (var_1_37 == ((signed char) -1)) : 1))) && (((max (var_1_9 , (max (8 , var_1_11)))) > (var_1_13 >> var_1_39)) ? (var_1_38 == ((signed short int) (abs (var_1_39)))) : (((var_1_28 - 128.25f) == (0.625 / var_1_27)) ? ((((var_1_1 % var_1_5) + var_1_36) < (var_1_35 * var_1_33)) ? (var_1_38 == ((signed short int) (var_1_39 - (min (var_1_5 , var_1_34))))) : 1) : ((var_1_6 <= (~ var_1_7)) ? (var_1_38 == ((signed short int) var_1_5)) : (var_1_38 == ((signed short int) (var_1_39 + var_1_33))))))) && (var_1_41 == ((signed long int) (min (var_1_34 , var_1_5))))) && ((var_1_7 >= var_1_1) ? (var_1_42 == ((float) (min (((var_1_43 + var_1_44) + (var_1_28 - var_1_45)) , 5.3f)))) : (((var_1_36 >> var_1_46) > var_1_57) ? (var_1_42 == ((float) (((var_1_47 + var_1_48) + (var_1_49 - var_1_50)) - ((15.4f + var_1_51) + var_1_45)))) : 1))) && (var_1_52 == ((float) var_1_43))) && (((last_1_var_1_53 / var_1_34) == (var_1_95 | (var_1_58 + var_1_1))) ? (var_1_53 == ((unsigned long int) ((min (var_1_9 , var_1_8)) - (min (var_1_54 , var_1_36))))) : (var_1_53 == ((unsigned long int) (last_1_var_1_53 + var_1_36))))) && ((! var_1_63) ? ((var_1_63 || (var_1_15 > var_1_54)) ? (var_1_55 == ((float) var_1_47)) : (var_1_55 == ((float) (min (((var_1_47 + 0.8f) + var_1_48) , (var_1_51 - var_1_28)))))) : (var_1_55 == ((float) (abs (var_1_28)))))) && (((last_1_var_1_97 + 1.0000000000004E12) < var_1_50) ? ((0u > var_1_5) ? ((((var_1_25 * var_1_47) < var_1_48) && (last_1_var_1_55 > last_1_var_1_78)) ? ((last_1_var_1_82 < (- last_1_var_1_1)) ? (var_1_57 == ((unsigned long int) (var_1_8 - var_1_13))) : (var_1_57 == ((unsigned long int) (max ((min (var_1_6 , var_1_5)) , var_1_20))))) : (var_1_57 == ((unsigned long int) (abs ((abs (var_1_36)) + var_1_20))))) : 1) : 1)) && ((((max (var_1_34 , var_1_59)) - var_1_13) <= (var_1_20 - (abs (var_1_6)))) ? (var_1_58 == ((unsigned long int) (var_1_6 + (var_1_10 - var_1_39)))) : (var_1_58 == ((unsigned long int) var_1_10)))) && (var_1_101 ? (var_1_60 == ((unsigned char) ((min (var_1_34 , 200)) - var_1_5))) : 1)) && ((var_1_32 && (var_1_27 == var_1_43)) ? (var_1_61 == ((signed long int) (min (var_1_34 , var_1_15)))) : ((var_1_52 != (- (var_1_26 / 128.75f))) ? (var_1_61 == ((signed long int) var_1_5)) : 1))) && (((var_1_88 + (var_1_68 + var_1_45)) == var_1_51) ? (var_1_70 ? (var_1_62 == ((signed char) (min ((max ((var_1_36 + 5) , var_1_5)) , (abs (var_1_46)))))) : ((((max (var_1_5 , var_1_36)) - (min (var_1_46 , 0))) > var_1_81) ? ((! var_1_32) ? (var_1_62 == ((signed char) var_1_34)) : (var_1_62 == ((signed char) ((var_1_13 - var_1_39) - 1)))) : 1)) : ((var_1_1 <= var_1_46) ? (var_1_62 == ((signed char) -64)) : (var_1_32 ? (var_1_62 == ((signed char) ((var_1_39 + var_1_46) - 32))) : (var_1_62 == ((signed char) (var_1_46 + (var_1_5 + var_1_39)))))))) && (var_1_30 ? ((! (var_1_41 <= (var_1_81 + var_1_20))) ? (var_1_63 == ((unsigned char) (! (var_1_32 && var_1_65)))) : (var_1_63 == ((unsigned char) (last_1_var_1_63 && var_1_66)))) : 1)) && ((! var_1_63) ? (var_1_67 == ((double) ((var_1_27 - var_1_50) - (min (var_1_49 , var_1_51))))) : (var_1_67 == ((double) (max (9.25 , var_1_48)))))) && (((- (var_1_69 - var_1_59)) > (var_1_7 / var_1_10)) ? (var_1_32 ? ((var_1_69 > var_1_13) ? (var_1_68 == ((float) (var_1_48 + var_1_28))) : (var_1_68 == ((float) (((max (var_1_48 , var_1_50)) + (var_1_47 + var_1_51)) - 15.4f)))) : (var_1_68 == ((float) (var_1_47 + var_1_44)))) : ((var_1_29 && var_1_101) ? (var_1_68 == ((float) (var_1_26 - ((4.2620201975235154E18f + var_1_49) - 9.9999999925E8f)))) : 1))) && (((var_1_13 / (var_1_46 + var_1_5)) >= (var_1_20 << var_1_76)) ? (var_1_70 == ((unsigned char) ((var_1_30 && var_1_32) && (var_1_65 && var_1_71)))) : (((var_1_93 / var_1_59) <= ((var_1_7 * var_1_41) >> var_1_5)) ? (var_1_70 == ((unsigned char) var_1_30)) : (var_1_70 == ((unsigned char) (! (var_1_32 && var_1_71))))))) && (var_1_72 == ((signed short int) (var_1_39 + var_1_34)))) && ((var_1_93 < ((var_1_69 + var_1_35) * var_1_1)) ? (var_1_73 == ((float) (var_1_48 - var_1_25))) : (var_1_73 == ((float) var_1_25)))) && ((var_1_13 > var_1_57) ? (var_1_74 == ((signed char) (8 - var_1_46))) : (var_1_74 == ((signed char) (abs (var_1_36)))))) && ((((var_1_15 & var_1_82) / 100) <= (var_1_54 / (max (var_1_69 , var_1_34)))) ? (var_1_75 == ((unsigned char) var_1_5)) : ((var_1_53 > var_1_13) ? (var_1_75 == ((unsigned char) (max (var_1_46 , var_1_36)))) : 1))) && (((var_1_1 >= last_1_var_1_76) && ((var_1_8 - var_1_20) > var_1_59)) ? (var_1_76 == ((signed long int) (max (var_1_95 , var_1_5)))) : (var_1_76 == ((signed long int) (last_1_var_1_76 - ((var_1_11 - var_1_46) + (var_1_77 - var_1_5))))))) && (var_1_29 ? (var_1_70 ? (var_1_78 == ((float) (((var_1_49 - var_1_50) + (min (var_1_51 , var_1_48))) - (max (var_1_47 , (min (var_1_26 , var_1_28))))))) : (var_1_63 ? (var_1_78 == ((float) ((var_1_27 - var_1_50) - ((abs (var_1_80)) - var_1_48)))) : (((var_1_98 / (max (var_1_34 , var_1_5))) <= var_1_10) ? ((1 <= var_1_53) ? (var_1_78 == ((float) (var_1_50 + (min ((abs (9.375f)) , 3.5f))))) : (var_1_78 == ((float) (var_1_51 + (min (var_1_50 , var_1_47)))))) : 1))) : ((var_1_49 > ((32.25f / var_1_19) / var_1_80)) ? (var_1_78 == ((float) (50.5f - (min (2.4f , 7.375f))))) : 1))) && ((! var_1_29) ? (var_1_81 == ((unsigned long int) ((var_1_10 - var_1_13) + (var_1_77 + var_1_46)))) : (var_1_81 == ((unsigned long int) (abs (var_1_38)))))) && ((var_1_106 > var_1_42) ? (var_1_82 == ((signed long int) (min ((var_1_34 + (var_1_15 + var_1_36)) , -10)))) : ((var_1_81 <= (- 10u)) ? (var_1_30 ? (var_1_82 == ((signed long int) var_1_77)) : 1) : ((var_1_24 != var_1_68) ? (var_1_82 == ((signed long int) (max ((min (var_1_15 , var_1_34)) , var_1_72)))) : (var_1_82 == ((signed long int) var_1_11)))))) && (((var_1_13 <= var_1_7) && (var_1_81 > var_1_77)) ? (var_1_101 ? (var_1_83 == ((signed char) ((min (var_1_36 , var_1_39)) + var_1_46))) : (var_1_83 == ((signed char) ((var_1_46 + -16) + (min (var_1_5 , var_1_36)))))) : 1)) && ((var_1_70 && var_1_65) ? (var_1_85 == ((double) (var_1_26 - ((var_1_49 - var_1_47) + var_1_28)))) : (((- (- var_1_9)) < (var_1_36 + 32u)) ? ((! var_1_70) ? (var_1_85 == ((double) ((min (var_1_27 , var_1_48)) - (7.397802701382283E18 - (var_1_49 - var_1_47))))) : 1) : 1))) && ((var_1_23 >= (var_1_13 - var_1_5)) ? (var_1_29 ? (var_1_86 == ((signed short int) (var_1_59 - var_1_53))) : 1) : (var_1_86 == ((signed short int) (max (var_1_59 , (max (var_1_53 , (2 - var_1_34))))))))) && ((63.5 <= last_1_var_1_24) ? (var_1_87 == ((signed short int) (abs (1 + last_1_var_1_107)))) : ((var_1_43 < (last_1_var_1_106 / var_1_27)) ? (var_1_87 == ((signed short int) (max (5 , (min (-100 , var_1_46)))))) : (var_1_87 == ((signed short int) var_1_39))))) && ((99.4f < var_1_48) ? (var_1_88 == ((float) ((var_1_48 - (var_1_51 + var_1_50)) + var_1_47))) : 1)) && ((var_1_98 < var_1_36) ? (var_1_89 == ((signed short int) var_1_5)) : (var_1_89 == ((signed short int) 100)))) && (var_1_90 == ((double) var_1_51))) && (var_1_66 ? (var_1_91 == ((signed short int) var_1_36)) : 1)) && (var_1_92 == ((signed short int) -50))) && (var_1_32 ? (var_1_93 == ((unsigned long int) var_1_39)) : 1)) && (var_1_63 ? (var_1_94 == ((signed long int) var_1_36)) : (var_1_94 == ((signed long int) var_1_69)))) && (var_1_95 == ((signed long int) var_1_59))) && (var_1_96 == ((signed short int) var_1_81))) && (var_1_97 == ((double) var_1_50))) && (var_1_98 == ((signed long int) var_1_87))) && (var_1_71 ? (var_1_99 == ((float) var_1_44)) : (var_1_99 == ((float) var_1_25)))) && (var_1_100 == ((double) var_1_80))) && (var_1_66 ? (var_1_101 == ((unsigned char) var_1_65)) : (var_1_101 == ((unsigned char) 0)))) && (var_1_70 ? (var_1_102 == ((double) var_1_49)) : 1)) && (var_1_71 ? (var_1_103 == ((double) var_1_50)) : (var_1_103 == ((double) var_1_45)))) && (var_1_70 ? (var_1_104 == ((float) var_1_43)) : 1)) && (var_1_105 == ((double) var_1_25))) && (((abs (var_1_13 - var_1_46)) <= (var_1_87 - var_1_6)) ? (var_1_106 == ((double) (var_1_48 + var_1_44))) : (var_1_106 == ((double) (max (var_1_27 , var_1_49)))))) && (var_1_107 == ((signed long int) var_1_46))
;
}
int main(void) {
	isInitial = 1;
