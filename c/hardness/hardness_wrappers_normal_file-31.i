...
void step(void) {
 ...
 if (! (var_1_3 < (var_1_8 * var_1_7))) {
  if (((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13))) < var_1_13) {
   if (var_1_6) {
    var_1_9 = var_1_12;
   }
  }
...
int property(void) {
 return (((var_1_2 ? (var_1_1 == ((signed long int) ((var_1_3 - var_1_4) - var_1_5))) : ((var_1_6 && (var_1_3 < var_1_4)) ? (var_1_1 == ((signed long int) var_1_3)) : 1)) && ((var_1_5 < var_1_4) ? (var_1_7 == ((signed long int) (var_1_4 + var_1_8))) : (var_1_7 == ((signed long int) (var_1_4 - var_1_3))))) && ((! (var_1_3 < (var_1_8 * var_1_7))) ? ((((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13))) < var_1_13) ? (var_1_6 ? (var_1_9 == ((unsigned char) var_1_12)) : 1) : 1) : (var_1_9 == ((unsigned char) var_1_12)))) && (((var_1_7 + var_1_3) < var_1_4) ? ((var_1_2 && var_1_6) ? (var_1_6 ? (var_1_13 == ((double) 0.8)) : (var_1_13 == ((double) var_1_14))) : (var_1_13 == ((double) var_1_14))) : (var_1_13 == ((double) var_1_14)))
;
}
int main(void) {
 isInitial = 1;
