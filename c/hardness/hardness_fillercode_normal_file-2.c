...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch2normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch2normal
	if ((var_1_15 - (min (0 , var_1_16))) > var_1_6) {
		var_1_14 = var_1_12;
	}


	// From: Req5Batch2normal
