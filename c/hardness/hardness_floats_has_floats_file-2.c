...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch2has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_10 || (var_1_6 == var_1_8)) {
		if (var_1_6 <= ((min (0 , last_1_var_1_11)) << last_1_var_1_11)) {
