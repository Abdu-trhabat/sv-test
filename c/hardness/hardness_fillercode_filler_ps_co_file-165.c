...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch165Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	/* 241L, 24L) */ if (/* 242L, 7L, 8L) */ ((/* 243L, 4L, 9L) */ ((var_1_25) - (9.75))) <= (/* 246L, 6L, 12L) */ (- (var_1_26))))) {
		/* 248L, 23L) */ var_1_24 = (
			3.4f
		);
	}
	...
	// From: CodeObject2
	/* 252L, 47L) */ if (/* 253L, 32L, 33L) */ ((var_1_24) >= (var_1_25))) {
		/* 256L, 46L) */ var_1_27 = (
			/* 259L, 45L) */ (min (
				/* 259L, 45L) */ (
					/* 260L, 43L) */ (min (
	...
	// From: CodeObject4
	/* 276L, 80L) */ if (/* 277L, 69L, 70L) */ (! (var_1_14))) {
		/* 279L, 79L) */ var_1_33 = (
			/* 282L, 78L) */ ((
				var_1_35
			) + (
	...
	/* 286L, 150L) */ if (var_1_14) {
		...
		/* 298L, 148L) */ if (/* 299L, 110L, 111L) */ ((/* 300L, 104L, 112L) */ (abs (var_1_24))) > (/* 302L, 109L, 114L) */ ((/* 303L, 107L, 115L) */ ((var_1_42) - (var_1_43))) - (256.95f))))) {
	...
	// From: CodeObject6
	/* 321L, 230L) */ if (/* 322L, 167L, 168L) */ ((/* 323L, 161L, 169L) */ ((/* 324L, 158L, 170L) */ ((var_1_35) / (var_1_39))) * (/* 327L, 160L, 173L) */ (~ (var_1_29))))) <= (/* 329L, 166L, 175L) */ ((/* 330L, 164L, 176L) */ ((128) / (var_1_46))) | (var_1_1))))) {
		/* 334L, 228L) */ if (/* 335L, 200L, 201L) */ ((/* 336L, 198L, 202L) */ ((/* 337L, 194L, 203L) */ (min (/* 337L, 194L, 203L) */ (var_1_43) , (var_1_42)))) * (/* 340L, 197L, 206L) */ (min (/* 340L, 197L, 206L) */ (var_1_26) , (var_1_25)))))) < (var_1_24))) {
			/* 344L, 227L) */ var_1_45 = (
				/* 347L, 226L) */ ((
					/* 348L, 224L) */ ((
						/* 349L, 222L) */ (abs (
