...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch37100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_5 != stepLocal_3) {
		var_1_19 = (abs (var_1_5));
	} else {
		var_1_19 = ((min (var_1_5 , (abs (var_1_20)))) + var_1_21);
	}


	// From: Req13Batch37100_while
	if ((- (min (var_1_12 , var_1_7))) >= var_1_11) {
		var_1_36 = var_1_20;
	}
	...
	if (var_1_7 >= var_1_15) {
		...
		var_1_23 = ((var_1_24 - (var_1_25 - var_1_9)) - (min (var_1_10 , (min (var_1_5 , var_1_4)))));
	}


	// From: Req12Batch37100_while
	if ((var_1_7 + 32.7) != (abs (var_1_7))) {
		var_1_28 = var_1_4;
	} else {
		if (var_1_24 > (var_1_9 - (var_1_29 - var_1_1))) {
			var_1_28 = (min (((var_1_5 + var_1_30) + (var_1_4 - var_1_31)) , (min ((min (var_1_32 , var_1_33)) , (var_1_34 - var_1_35)))));
		}
	}
	...
	if (var_1_14 < var_1_12) {
		var_1_22 = (min (var_1_5 , var_1_26));
	}


	// From: Req7Batch37100_while
	if ((max (var_1_36 , (abs (var_1_5)))) > (var_1_26 + var_1_1)) {
		var_1_18 = var_1_5;
	}
}
...
int property(void) {
	return ((((((((((((var_1_2 ? (((var_1_3 - (var_1_4 - var_1_5)) >= (500 * var_1_6)) ? (var_1_1 == ((signed long int) var_1_4)) : 1) : (var_1_1 == ((signed long int) var_1_4))) && (((last_1_var_1_1 * (var_1_4 * var_1_5)) < last_1_var_1_1) ? ((last_1_var_1_22 != (var_1_5 | (last_1_var_1_1 ^ var_1_4))) ? (var_1_2 ? (var_1_7 == ((double) 8.5)) : 1) : 1) : 1)) && ((var_1_1 != 10) ? (var_1_9 == ((unsigned char) (max (var_1_4 , 2)))) : ((var_1_10 > (var_1_1 / 128)) ? (var_1_2 ? (var_1_9 == ((unsigned char) var_1_4)) : (var_1_9 == ((unsigned char) var_1_5))) : (var_1_9 == ((unsigned char) var_1_4))))) && (var_1_10 == ((unsigned short int) (min (var_1_5 , var_1_4))))) && (var_1_11 == ((float) (var_1_12 - (min (var_1_14 , var_1_13)))))) && (var_1_2 ? (var_1_15 == ((double) (min ((max (var_1_14 , var_1_12)) , (abs (var_1_13)))))) : ((var_1_1 < var_1_4) ? ((var_1_16 || var_1_17) ? (var_1_15 == ((double) var_1_14)) : (var_1_15 == ((double) var_1_13))) : (var_1_15 == ((double) var_1_14))))) && (((max (var_1_36 , (abs (var_1_5)))) > (var_1_26 + var_1_1)) ? (var_1_18 == ((unsigned char) var_1_5)) : 1)) && ((var_1_5 != var_1_3) ? (var_1_19 == ((signed char) (abs (var_1_5)))) : (var_1_19 == ((signed char) ((min (var_1_5 , (abs (var_1_20)))) + var_1_21))))) && ((var_1_14 < var_1_12) ? (var_1_22 == ((unsigned short int) (min (var_1_5 , var_1_26)))) : 1)) && ((var_1_7 >= var_1_15) ? (var_1_23 == ((signed short int) (var_1_10 - var_1_9))) : (var_1_23 == ((signed short int) ((var_1_24 - (var_1_25 - var_1_9)) - (min (var_1_10 , (min (var_1_5 , var_1_4))))))))) && (var_1_26 == ((unsigned short int) ((var_1_27 - (var_1_25 - var_1_28)) - var_1_23)))) && (((var_1_7 + 32.7) != (abs (var_1_7))) ? (var_1_28 == ((unsigned char) var_1_4)) : ((var_1_24 > (var_1_9 - (var_1_29 - var_1_1))) ? (var_1_28 == ((unsigned char) (min (((var_1_5 + var_1_30) + (var_1_4 - var_1_31)) , (min ((min (var_1_32 , var_1_33)) , (var_1_34 - var_1_35))))))) : 1))) && (((- (min (var_1_12 , var_1_7))) >= var_1_11) ? (var_1_36 == ((signed short int) var_1_20)) : 1)
;
}
int main(void) {
	isInitial = 1;
