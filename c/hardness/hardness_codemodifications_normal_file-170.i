...
void step(void) {
 ...
 if (-5 > var_1_5) {
  if (var_1_5 > 10) {
   var_1_4 = ((var_1_2 && var_1_6) || var_1_7);
  } else {
 ...
 if (var_1_10 == (var_1_5 + var_1_11)) {
  if (var_1_7) {
   if (var_1_3 == ((((var_1_1) < ((var_1_14 * var_1_15))) ? (var_1_1) : ((var_1_14 * var_1_15))))) {
    var_1_13 = (((((var_1_16 + 15.8f)) > (var_1_3)) ? ((var_1_16 + 15.8f)) : (var_1_3)));
   } else {
    var_1_13 = ((((99999.1f) < (var_1_16)) ? (99999.1f) : (var_1_16)));
   }
  } else {
   var_1_13 = var_1_3;
  }
 ...
 if (var_1_10 > (var_1_12 / ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))))) {
  var_1_17 = var_1_16;
 }
 if (var_1_15 < var_1_3) {
  if (var_1_1 < ((64.1f * var_1_16) / 256.95f)) {
   if (var_1_9) {
    var_1_19 = var_1_20;
   } else {
    var_1_19 = -1;
...
int property(void) {
 return ((((((var_1_2 ? (var_1_1 == ((float) var_1_3)) : 1) && ((-5 > var_1_5) ? ((var_1_5 > 10) ? (var_1_4 == ((unsigned char) ((var_1_2 && var_1_6) || var_1_7))) : (var_1_4 == ((unsigned char) (var_1_7 && (var_1_8 || var_1_6))))) : (var_1_4 == ((unsigned char) var_1_9)))) && (((var_1_5 + (var_1_11 + var_1_12)) >= -256) ? (var_1_4 ? (var_1_10 == ((signed long int) var_1_12)) : 1) : 1)) && ((var_1_10 == (var_1_5 + var_1_11)) ? (var_1_7 ? ((var_1_3 == ((((var_1_1) < ((var_1_14 * var_1_15))) ? (var_1_1) : ((var_1_14 * var_1_15))))) ? (var_1_13 == ((float) (((((var_1_16 + 15.8f)) > (var_1_3)) ? ((var_1_16 + 15.8f)) : (var_1_3))))) : (var_1_13 == ((float) ((((99999.1f) < (var_1_16)) ? (99999.1f) : (var_1_16)))))) : (var_1_13 == ((float) var_1_3))) : (var_1_13 == ((float) var_1_3)))) && ((var_1_10 > (var_1_12 / ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))))) ? (var_1_17 == ((float) var_1_16)) : 1)) && ((var_1_15 < var_1_3) ? ((var_1_1 < ((64.1f * var_1_16) / 256.95f)) ? (var_1_9 ? (var_1_19 == ((signed char) var_1_20)) : (var_1_19 == ((signed char) -1))) : 1) : (var_1_19 == ((signed char) var_1_20)))) && (var_1_21 == ((float) var_1_3))
;
}
int main(void) {
 isInitial = 1;
