...
void step(void) {
	// From: Req3Batch197100_1loop
	var_1_14 = (var_1_15 - var_1_16);


	// From: Req4Batch197100_1loop
	...
	// From: Req8Batch197100_1loop
	var_1_27 = var_1_28;


	// From: Req9Batch197100_1loop
	...
	// From: Req11Batch197100_1loop
	var_1_35 = (min ((max ((min (32 , var_1_22)) , var_1_36)) , (128 - var_1_37)));


	// From: Req13Batch197100_1loop
	var_1_43 = var_1_37;


	// From: Req14Batch197100_1loop
	var_1_44 = var_1_6;


	// From: Req1Batch197100_1loop
	if (var_1_2 != var_1_3) {
