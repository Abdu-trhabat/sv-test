...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch27100_1loop.c", 13, "reach_error"); }
...
unsigned short int last_1_var_1_25 = 4;
...
void step(void) {
	// From: Req5Batch27100_1loop
	signed long int stepLocal_1 = (last_1_var_1_25 * 128) / var_1_11;
	if (last_1_var_1_31) {
		if (stepLocal_1 != (max ((var_1_4 - var_1_3) , last_1_var_1_1))) {
	...
	// From: Req2Batch27100_1loop
	var_1_7 = (max (var_1_3 , var_1_4));


	// From: Req3Batch27100_1loop
	...
	// From: Req4Batch27100_1loop
	var_1_9 = var_1_6;


	// From: Req8Batch27100_1loop
	...
	// From: Req9Batch27100_1loop
	var_1_24 = (var_1_16 + var_1_3);


	// From: Req11Batch27100_1loop
	if (var_1_8 != (var_1_11 + var_1_5)) {
		var_1_27 = var_1_15;
	}


	// From: Req14Batch27100_1loop
	var_1_31 = 0;


	// From: Req15Batch27100_1loop
	var_1_32 = var_1_17;


	// From: Req1Batch27100_1loop
	if (! (! var_1_31)) {
	...
	// From: Req7Batch27100_1loop
	unsigned long int stepLocal_3 = var_1_10;
	if (var_1_31) {
		if (stepLocal_3 < (var_1_15 + (var_1_13 + var_1_10))) {
	...
	// From: Req13Batch27100_1loop
	if ((var_1_16 + var_1_3) < ((var_1_6 / var_1_11) | var_1_5)) {
		if ((3214144168u - (var_1_30 - var_1_23)) != (- var_1_10)) {
	...
	// From: Req10Batch27100_1loop
	if (-16 <= var_1_10) {
		if (var_1_5 == var_1_10) {
			var_1_25 = (max (var_1_4 , var_1_27));
		}
	} else {
...
int property(void) {
	return (((((((((((((((! (! var_1_31)) ? (var_1_1 == ((signed char) ((max ((var_1_3 - var_1_4) , var_1_5)) + var_1_6))) : (var_1_31 ? (var_1_1 == ((signed char) var_1_3)) : (var_1_1 == ((signed char) var_1_4)))) && (var_1_7 == ((signed short int) (max (var_1_3 , var_1_4))))) && (((var_1_4 * var_1_3) < (128 - 256)) ? (var_1_8 == ((signed char) (var_1_4 - 4))) : (var_1_8 == ((signed char) -16)))) && (var_1_9 == ((signed short int) var_1_6))) && (last_1_var_1_31 ? ((((last_1_var_1_25 * 128) / var_1_11) != (max ((var_1_4 - var_1_3) , last_1_var_1_1))) ? (var_1_10 == ((unsigned long int) ((min (var_1_12 , (var_1_13 - var_1_3))) - var_1_4))) : (var_1_10 == ((unsigned long int) var_1_11))) : (var_1_10 == ((unsigned long int) var_1_13)))) && ((((- var_1_11) / (var_1_15 + var_1_16)) <= var_1_3) ? (var_1_14 == ((double) (max ((abs (var_1_17)) , var_1_18)))) : (var_1_31 ? (var_1_14 == ((double) var_1_17)) : 1))) && (var_1_31 ? ((var_1_10 < (var_1_15 + (var_1_13 + var_1_10))) ? (var_1_19 == ((float) (var_1_21 - (var_1_22 + 8.25f)))) : (var_1_19 == ((float) var_1_18))) : (var_1_19 == ((float) var_1_22)))) && ((var_1_12 >= var_1_4) ? (var_1_23 == ((unsigned short int) var_1_16)) : 1)) && (var_1_24 == ((unsigned char) (var_1_16 + var_1_3)))) && ((-16 <= var_1_10) ? ((var_1_5 == var_1_10) ? (var_1_25 == ((unsigned short int) (max (var_1_4 , var_1_27)))) : 1) : (var_1_25 == ((unsigned short int) ((abs (var_1_26)) - var_1_4))))) && ((var_1_8 != (var_1_11 + var_1_5)) ? (var_1_27 == ((unsigned short int) var_1_15)) : 1)) && (((~ var_1_25) >= var_1_13) ? (var_1_28 == ((unsigned short int) (var_1_26 - var_1_4))) : 1)) && (((var_1_16 + var_1_3) < ((var_1_6 / var_1_11) | var_1_5)) ? (((3214144168u - (var_1_30 - var_1_23)) != (- var_1_10)) ? (var_1_29 == ((signed char) (max ((var_1_3 + var_1_5) , (abs (var_1_6)))))) : 1) : (((abs (var_1_19 + var_1_22)) < var_1_18) ? ((var_1_22 <= var_1_19) ? (var_1_29 == ((signed char) var_1_4)) : 1) : (var_1_29 == ((signed char) var_1_6))))) && (var_1_31 == ((unsigned char) 0))) && (var_1_32 == ((double) var_1_17))
;
}
int main(void) {
	isInitial = 1;
