...
int property(void) {
	return ((((max (var_1_2 , 1)) <= (256 + var_1_3)) ? (var_1_1 == ((signed long int) (((var_1_4 - 128) + var_1_5) + var_1_6))) : (var_1_1 == ((signed long int) (var_1_4 + var_1_5)))) && ((var_1_6 > (var_1_2 * (var_1_4 - var_1_8))) ? ((var_1_8 > var_1_2) ? (var_1_7 == ((signed char) ((var_1_9 + var_1_10) + var_1_11))) : (var_1_7 == ((signed char) var_1_10))) : (var_1_7 == ((signed char) var_1_11)))) && ((var_1_1 > (abs (var_1_4))) ? (var_1_12 == ((signed short int) (var_1_13 - var_1_14))) : ((var_1_15 || var_1_16) ? ((2 < var_1_5) ? (var_1_12 == ((signed short int) last_1_var_1_12)) : 1) : 1))
;
}
int main(void) {
	isInitial = 1;
