...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 316L, 108L) */ if (/* 317L, 75L, 76L) */ ((var_1_7) > (var_1_8))) {
		/* 320L, 106L) */ if (/* 321L, 85L, 86L) */ ((/* 322L, 83L, 87L) */ (~ (var_1_7))) <= (128))) {
			/* 325L, 97L) */ var_1_23 = (
				var_1_8
			);
		} else {
	...
	// From: CodeObject3
	/* 335L, 153L) */ if (/* 336L, 120L, 121L) */ ((var_1_11) <= (var_1_9))) {
		/* 339L, 135L) */ var_1_25 = (
			/* 342L, 134L) */ (min (
				/* 342L, 134L) */ (
					/* 343L, 131L) */ (max (
	...
	// From: CodeObject4
	/* 436L, 208L) */ if (/* 437L, 163L, 164L) */ ((var_1_16) <= (var_1_17))) {
		/* 440L, 199L) */ if (var_1_3) {
			/* 442L, 197L) */ if (/* 443L, 178L, 179L) */ ((var_1_17) <= (/* 445L, 177L, 181L) */ (abs (/* 446L, 176L, 182L) */ (min (/* 446L, 176L, 182L) */ (var_1_30) , (var_1_31)))))))) {
				/* 449L, 196L) */ var_1_29 = (
					/* 452L, 195L) */ (min (
						/* 452L, 195L) */ (
							var_1_32
	...
	// From: CodeObject5
	/* 463L, 281L) */ if (/* 464L, 216L, 217L) */ ((var_1_1) || (/* 466L, 215L, 219L) */ ((var_1_9) <= (var_1_11))))) {
		/* 469L, 275L) */ if (/* 470L, 232L, 233L) */ ((/* 471L, 230L, 234L) */ (abs (/* 472L, 229L, 235L) */ (max (/* 472L, 229L, 235L) */ (var_1_11) , (var_1_8)))))) <= (var_1_10))) {
