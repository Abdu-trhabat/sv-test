...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch73stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((var_1_8 + var_1_13) / 63.75f) < (min (var_1_5 , (var_1_3 - var_1_4)))) {
		var_1_15 = var_1_10;
	} else {
		var_1_15 = var_1_11;
	}
	...
	unsigned char stepLocal_2 = var_1_1 <= var_1_13;
