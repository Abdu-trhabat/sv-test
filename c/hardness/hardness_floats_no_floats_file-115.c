...
void step(void) {
	// From: Req2Batch115no_floats
	if (var_1_2) {
		var_1_7 = (! var_1_8);
	}


	// From: Req3Batch115no_floats
	if (! var_1_7) {
		var_1_9 = (2327469510u - var_1_10);
	}


	// From: Req4Batch115no_floats
...
int property(void) {
	return (((var_1_7 ? (var_1_1 == ((signed long int) (var_1_3 + (10 - var_1_4)))) : (((var_1_4 <= (var_1_3 / var_1_5)) || var_1_7) ? (var_1_1 == ((signed long int) var_1_3)) : (var_1_1 == ((signed long int) 50)))) && (var_1_2 ? (var_1_7 == ((unsigned char) (! var_1_8))) : 1)) && ((! var_1_7) ? (var_1_9 == ((unsigned long int) (2327469510u - var_1_10))) : 1)) && (((! (var_1_3 < var_1_5)) || var_1_7) ? (var_1_7 ? (var_1_11 == ((unsigned char) (max (var_1_12 , var_1_13)))) : 1) : (((max (8 , var_1_9)) >= var_1_13) ? ((var_1_9 < 25) ? (var_1_11 == ((unsigned char) var_1_13)) : (var_1_11 == ((unsigned char) var_1_12))) : (var_1_11 == ((unsigned char) var_1_13))))
;
}
int main(void) {
	isInitial = 1;
