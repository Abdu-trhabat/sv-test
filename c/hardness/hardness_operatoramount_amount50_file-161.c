...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch161Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch161Amount50
	var_1_11 = (64 + var_1_12);


	// From: Req4Batch161Amount50
	var_1_13 = (min (var_1_14 , var_1_15));


	// From: Req5Batch161Amount50
	...
	// From: Req6Batch161Amount50
	if (var_1_7 || var_1_23) {
		var_1_22 = (min (var_1_15 , var_1_14));
	}


	// From: Req7Batch161Amount50
	if (var_1_8 >= (- var_1_1)) {
