...
void step(void) {
	...
	if (stepLocal_0 >= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) {
		if ((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) + (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) - (min ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) , 1))) > stepLocal_1) {
