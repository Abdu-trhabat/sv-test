...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch128stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_5 || stepLocal_4) {
  if (var_1_11) {
   var_1_10 = ((((var_1_12) < (((((((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) < (var_1_15)) ? (((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) : (var_1_15))))) ? (var_1_12) : (((((((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) < (var_1_15)) ? (((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) : (var_1_15))))));
  } else {
   var_1_10 = (var_1_16 - ((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))));
  }
 } else {
