...
void step(void) {
	...
	if (var_1_12) {
		var_1_40 = (max ((var_1_16 + last_1_var_1_40) , var_1_35));
	} else {
	...
	if (var_1_31) {
		if (stepLocal_11 < var_1_37) {
			if ((var_1_27 + (abs (var_1_43))) <= stepLocal_12) {
				var_1_41 = var_1_14;
			} else {
				var_1_41 = 256;
			}
	...
	if (stepLocal_13 < var_1_27) {
		var_1_47 = (max ((min (var_1_41 , (var_1_35 - var_1_15))) , -100));
	}


	// From: Req28Batch28Amount250
	signed short int stepLocal_18 = var_1_40;
	if (! (! var_1_12)) {
		var_1_63 = (min (var_1_36 , (abs (var_1_56 - var_1_39))));
	} else {
	...
	if ((min ((abs (var_1_58)) , var_1_47)) > stepLocal_15) {
		var_1_54 = (max (var_1_63 , var_1_30));
	} else {
		var_1_54 = (max (((abs (var_1_36)) + var_1_55) , (var_1_56 - (max (var_1_37 , var_1_35)))));
	}
	...
	if (stepLocal_5 < (var_1_63 * var_1_15)) {
		var_1_18 = (max (2 , (min ((min (var_1_15 , var_1_16)) , var_1_43))));
	} else {
		var_1_18 = (min (var_1_15 , ((var_1_16 - var_1_14) + var_1_43)));
	}


	// From: Req8Batch28Amount250
	signed long int stepLocal_7 = var_1_21 % (min (var_1_7 , var_1_15));
	...
	if (var_1_10) {
		var_1_44 = ((var_1_45 - (min (var_1_62 , var_1_36))) - var_1_37);
	} else {
	...
	if (stepLocal_14 < var_1_44) {
		var_1_48 = (min ((1 - (max (var_1_35 , var_1_49))) , var_1_27));
	} else {
		...
		if (var_1_29) {
			...
			if (stepLocal_17 && (var_1_15 > (var_1_38 << var_1_47))) {
				...
				if (var_1_26 < var_1_5) {
					...
					var_1_60 = ((min (var_1_25 , (min (var_1_26 , var_1_24)))) - 2.5);
				}
			}
		}
	}
...
int property(void) {
	return ((((((((((((((((((((((((((((var_1_27 <= var_1_43) ? ((var_1_27 > var_1_43) ? (var_1_1 == ((float) (((var_1_4 + 25.2f) - var_1_5) + var_1_6))) : 1) : ((((var_1_43 * var_1_27) / var_1_7) >= (var_1_54 / var_1_9)) ? ((-32 > ((var_1_43 + var_1_7) | var_1_54)) ? (var_1_1 == ((float) var_1_4)) : (var_1_1 == ((float) var_1_5))) : (var_1_1 == ((float) 256.5f)))) && (var_1_10 == ((unsigned char) (var_1_57 && var_1_12)))) && ((var_1_43 <= var_1_54) ? (var_1_13 == ((unsigned char) (min (var_1_14 , 8)))) : (var_1_13 == ((unsigned char) ((var_1_15 - 32) + var_1_16))))) && ((var_1_6 > (- var_1_60)) ? (var_1_17 == ((float) (abs (var_1_5)))) : ((var_1_15 <= (var_1_43 + (16 + var_1_43))) ? (var_1_17 == ((float) var_1_5)) : 1))) && ((var_1_27 < (var_1_63 * var_1_15)) ? (var_1_18 == ((signed short int) (max (2 , (min ((min (var_1_15 , var_1_16)) , var_1_43)))))) : (var_1_18 == ((signed short int) (min (var_1_15 , ((var_1_16 - var_1_14) + var_1_43))))))) && (((- 25u) >= (var_1_7 & var_1_50)) ? (var_1_19 == ((signed char) var_1_20)) : 1)) && ((! ((min (var_1_16 , var_1_20)) < (var_1_14 - var_1_15))) ? (var_1_21 == ((signed short int) (min (var_1_16 , var_1_20)))) : 1)) && (((var_1_21 % (min (var_1_7 , var_1_15))) <= var_1_63) ? (var_1_22 == ((float) (var_1_5 - (min (var_1_4 , var_1_26))))) : ((! (var_1_46 || var_1_29)) ? ((var_1_25 > var_1_5) ? (var_1_22 == ((float) (var_1_25 - (min (var_1_5 , var_1_4))))) : 1) : ((var_1_21 <= var_1_63) ? (var_1_22 == ((float) ((10.2f + var_1_4) - 5.25f))) : 1)))) && (((last_1_var_1_43 / var_1_7) == last_1_var_1_63) ? (((var_1_5 * last_1_var_1_60) < var_1_6) ? (var_1_27 == ((unsigned long int) var_1_7)) : (var_1_27 == ((unsigned long int) var_1_14))) : (var_1_27 == ((unsigned long int) var_1_14)))) && (var_1_12 ? (var_1_28 == ((signed short int) (var_1_63 - var_1_15))) : (var_1_28 == ((signed short int) 4)))) && (((- (var_1_30 - var_1_15)) > var_1_27) ? (var_1_29 == ((unsigned char) (var_1_12 || var_1_31))) : (var_1_29 == ((unsigned char) var_1_12)))) && ((var_1_34 >= var_1_43) ? (var_1_32 == ((double) (var_1_6 + var_1_4))) : 1)) && (((var_1_43 / var_1_9) >= var_1_15) ? (var_1_34 == ((unsigned char) ((var_1_35 + (abs (5))) + var_1_16))) : (var_1_34 == ((unsigned char) (((232 - var_1_36) - var_1_37) - (min (var_1_15 , (var_1_38 - var_1_39)))))))) && (var_1_12 ? (var_1_40 == ((signed short int) (max ((var_1_16 + last_1_var_1_40) , var_1_35)))) : ((var_1_15 >= var_1_36) ? (var_1_40 == ((signed short int) (max (var_1_35 , var_1_36)))) : (var_1_40 == ((signed short int) var_1_36))))) && (var_1_31 ? (((10 + var_1_15) < var_1_37) ? (((var_1_27 + (abs (var_1_43))) <= var_1_50) ? (var_1_41 == ((signed short int) var_1_14)) : (var_1_41 == ((signed short int) 256))) : (var_1_41 == ((signed short int) var_1_15))) : 1)) && (var_1_31 ? (var_1_43 == ((unsigned long int) var_1_37)) : 1)) && (var_1_10 ? (var_1_44 == ((signed short int) ((var_1_45 - (min (var_1_62 , var_1_36))) - var_1_37))) : (var_1_44 == ((signed short int) (var_1_39 - var_1_16))))) && (((last_1_var_1_27 / var_1_30) < last_1_var_1_63) ? ((! var_1_31) ? ((var_1_35 >= (min ((var_1_30 - var_1_15) , var_1_14))) ? (var_1_46 == ((unsigned char) (! var_1_12))) : (var_1_46 == ((unsigned char) (last_1_var_1_57 && var_1_12)))) : ((100 < last_1_var_1_54) ? (var_1_46 == ((unsigned char) (! var_1_12))) : 1)) : 1)) && ((var_1_39 < var_1_27) ? (var_1_47 == ((signed short int) (max ((min (var_1_41 , (var_1_35 - var_1_15))) , -100)))) : 1)) && ((var_1_7 < var_1_44) ? (var_1_48 == ((signed short int) (min ((1 - (max (var_1_35 , var_1_49))) , var_1_27)))) : (var_1_48 == ((signed short int) ((var_1_45 - var_1_44) - var_1_30))))) && (((- var_1_26) <= var_1_25) ? (var_1_50 == ((signed long int) (var_1_39 - (var_1_51 - (var_1_38 + var_1_30))))) : (var_1_50 == ((signed long int) (256 - (var_1_51 - (var_1_52 - var_1_43))))))) && ((var_1_7 < (var_1_45 + var_1_21)) ? (var_1_53 == ((signed char) (var_1_39 - 64))) : (var_1_53 == ((signed char) (var_1_39 - var_1_36))))) && (((min ((abs (var_1_58)) , var_1_47)) > var_1_52) ? (var_1_54 == ((unsigned long int) (max (var_1_63 , var_1_30)))) : (var_1_54 == ((unsigned long int) (max (((abs (var_1_36)) + var_1_55) , (var_1_56 - (max (var_1_37 , var_1_35))))))))) && (var_1_46 ? (var_1_57 == ((unsigned char) var_1_31)) : 1)) && (var_1_58 == ((unsigned char) (var_1_59 - var_1_16)))) && (var_1_31 ? (var_1_29 ? (var_1_60 == ((double) var_1_24)) : ((((var_1_30 - var_1_39) < var_1_62) && (var_1_15 > (var_1_38 << var_1_47))) ? (var_1_60 == ((double) ((var_1_24 - var_1_5) - var_1_61))) : ((var_1_26 < var_1_5) ? (((var_1_55 * (- 4)) <= var_1_9) ? (var_1_60 == ((double) (var_1_25 - var_1_24))) : 1) : (var_1_60 == ((double) ((min (var_1_25 , (min (var_1_26 , var_1_24)))) - 2.5)))))) : 1)) && (var_1_29 ? (var_1_62 == ((signed short int) var_1_20)) : (var_1_62 == ((signed short int) var_1_54)))) && ((! (! var_1_12)) ? (var_1_63 == ((unsigned long int) (min (var_1_36 , (abs (var_1_56 - var_1_39)))))) : ((var_1_47 < var_1_40) ? (var_1_63 == ((unsigned long int) var_1_15)) : 1))
;
}
int main(void) {
	isInitial = 1;
