...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch74Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 268L, 96L) */ if (/* 269L, 83L, 84L) */ ((var_1_28) > (var_1_19))) {
		/* 272L, 95L) */ var_1_29 = (
			/* 275L, 94L) */ (min (
				/* 275L, 94L) */ (
					4.2f
	...
	// From: CodeObject3
	/* 279L, 135L) */ if (/* 280L, 105L, 106L) */ ((/* 281L, 103L, 107L) */ (~ (/* 282L, 102L, 108L) */ ((5) + (var_1_11))))) >= (-256))) {
		/* 286L, 126L) */ var_1_30 = (
			/* 289L, 125L) */ (max (
				/* 289L, 125L) */ (
					/* 290L, 122L) */ ((
