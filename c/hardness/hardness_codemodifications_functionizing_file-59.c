...
void functionized3(unsigned short int functionized3_localFunctionVar0, unsigned char functionized3_localFunctionVar1, unsigned char functionized3_localFunctionVar2) {
	if (! functionized3_localFunctionVar1) {
		var_1_5 = (max (functionized3_localFunctionVar2 , (functionized3_localFunctionVar0 + var_1_4)));
	}
}
signed long int functionized4(unsigned short int functionized4_localFunctionVar0) {
	return (max (var_1_1 , functionized4_localFunctionVar0));
}
...
void step(void) {
	...
	// From: Req6Batch59functionizing
	var_1_17 = var_1_4;


	// From: Req7Batch59functionizing
	var_1_18 = var_1_16;


	// From: Req8Batch59functionizing
	var_1_19 = var_1_4;
}
