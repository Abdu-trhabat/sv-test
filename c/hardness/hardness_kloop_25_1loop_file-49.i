...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4925_1loop.c", 13, "reach_error"); }
...
int property(void) {
 return (((((var_1_2 >= 64.5f) ? ((var_1_2 >= var_1_3) ? (var_1_1 == ((unsigned short int) (((((((var_1_4) > (((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6))))) ? (var_1_4) : (((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6)))))) < 0 ) ? -((((var_1_4) > (((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6))))) ? (var_1_4) : (((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6)))))) : ((((var_1_4) > (((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6))))) ? (var_1_4) : (((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6)))))))))) : (var_1_14 ? (var_1_1 == ((unsigned short int) var_1_5)) : (var_1_1 == ((unsigned short int) var_1_6)))) : (var_1_1 == ((unsigned short int) 50))) && (var_1_8 == ((signed short int) ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9)))))) && (((- 16) <= var_1_9) ? (var_1_10 == ((unsigned char) (! (! (! var_1_12))))) : (var_1_10 == ((unsigned char) (var_1_12 && var_1_13))))) && (var_1_14 == ((unsigned char) var_1_11))) && (var_1_15 == ((signed char) var_1_16))
;
}
int main(void) {
 isInitial = 1;
