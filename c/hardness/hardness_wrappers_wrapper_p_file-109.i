...
void step(void) {
 ...
 if (stepLocal_1 <= (*(var_1_5_Pointer))) {
  ...
  (*(var_1_6_Pointer)) = ((((last_1_var_1_8) > ((((*(var_1_5_Pointer)) + 16) - (*(var_1_7_Pointer))))) ? (last_1_var_1_8) : ((((*(var_1_5_Pointer)) + 16) - (*(var_1_7_Pointer))))));
 }
