...
void step(void) {
	...
	// From: CodeObject4
	/* 379L, 171L) */ if (/* 380L, 151L, 152L) */ ((var_1_20) >= (/* 382L, 150L, 154L) */ ((var_1_6) - (/* 384L, 149L, 156L) */ ((64) - (var_1_21))))))) {
		/* 387L, 170L) */ var_1_35 = (
			/* 390L, 169L) */ (abs (
				var_1_21
			))
	...
	// From: CodeObject5
	/* 392L, 245L) */ if (/* 393L, 180L, 181L) */ ((var_1_24) > (/* 395L, 179L, 183L) */ ((var_1_6) & (/* 397L, 178L, 185L) */ (~ (var_1_33))))))) {
	...
	// From: CodeObject6
	/* 428L, 281L) */ if (/* 429L, 256L, 257L) */ ((/* 430L, 251L, 258L) */ ((var_1_6) + (var_1_33))) > (/* 433L, 255L, 261L) */ ((var_1_10) ^ (/* 435L, 254L, 263L) */ (abs (var_1_21))))))) {
		/* 437L, 280L) */ var_1_44 = (
			/* 440L, 279L) */ ((
				2u
			) + (
	...
	// From: CodeObject3
	/* 367L, 138L) */ if (/* 368L, 119L, 120L) */ ((/* 369L, 117L, 121L) */ ((/* 370L, 115L, 122L) */ ((var_1_13) % (var_1_33))) != (var_1_14))) || (var_1_8))) {
		/* 375L, 137L) */ var_1_32 = (
			var_1_6
		);
	}
	...
	// From: CodeObject7
	/* 445L, 321L) */ if (/* 446L, 287L, 288L) */ ((var_1_14) <= (var_1_5))) {
		/* 449L, 319L) */ if (/* 450L, 300L, 301L) */ ((/* 451L, 296L, 302L) */ ((var_1_22) << (var_1_24))) < (/* 454L, 299L, 305L) */ ((var_1_5) - (var_1_14))))) {
			/* 457L, 318L) */ var_1_45 = (
				var_1_5
			);
		}
