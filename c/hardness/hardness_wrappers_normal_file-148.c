...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch148normal.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch148normal
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req4Batch148normal
	var_1_13 = ((var_1_14 + (max (var_1_15 , var_1_16))) - var_1_2);


	// From: Req5Batch148normal
	var_1_17 = 1.00000007E7f;


	// From: Req2Batch148normal
	if (var_1_5 && var_1_6) {
		var_1_4 = (! var_1_7);
	} else {
		var_1_4 = (! ((var_1_13 > var_1_3) || var_1_7));
	}


	// From: Req3Batch148normal
	...
	if (var_1_17 < var_1_3) {
		if (stepLocal_0 >= (var_1_11 / var_1_12)) {
			if (var_1_4) {
				...
				var_1_8 = ((var_1_9 < (~ var_1_11)) || var_1_7);
			}
		}
	} else {
		if (var_1_4) {
...
int property(void) {
	return ((((var_1_1 == ((float) (var_1_2 - var_1_3))) && ((var_1_5 && var_1_6) ? (var_1_4 == ((unsigned char) (! var_1_7))) : (var_1_4 == ((unsigned char) (! ((var_1_13 > var_1_3) || var_1_7)))))) && ((var_1_17 < var_1_3) ? (((var_1_9 - var_1_10) >= (var_1_11 / var_1_12)) ? (var_1_4 ? (var_1_8 == ((unsigned char) var_1_7)) : (var_1_8 == ((unsigned char) ((var_1_9 < (~ var_1_11)) || var_1_7)))) : 1) : (var_1_4 ? (var_1_8 == ((unsigned char) var_1_7)) : (var_1_8 == ((unsigned char) 0))))) && (var_1_13 == ((double) ((var_1_14 + (max (var_1_15 , var_1_16))) - var_1_2)))) && (var_1_17 == ((float) 1.00000007E7f))
;
}
int main(void) {
	isInitial = 1;
