...
void step(void) {
	...
	// From: Req2Batch122100_1loop
	if (var_1_4 != (- (var_1_6 / var_1_7))) {
		var_1_9 = 100;
	}


	// From: Req5Batch122100_1loop
	...
	// From: Req6Batch122100_1loop
	var_1_22 = (min (128 , var_1_19));


	// From: Req8Batch122100_1loop
	...
	// From: Req11Batch122100_1loop
	var_1_36 = (var_1_31 + (64 - (var_1_37 + 2)));


	// From: Req7Batch122100_1loop
