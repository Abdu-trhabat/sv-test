...
void step(void) {
	...
	// From: Req4Batch129Wrapper_P
	unsigned short int stepLocal_2 = (*(var_1_6_Pointer));
	if ((*(var_1_1_Pointer))) {
		if ((*(var_1_8_Pointer)) <= stepLocal_2) {
			if ((min (10.4 , (*(var_1_13_Pointer)))) < ((*(var_1_14_Pointer)) * (*(var_1_15_Pointer)))) {
...
int property(void) {
	return ((((! (*(var_1_2_Pointer))) ? (((*(var_1_3_Pointer)) > (*(var_1_4_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned char) ((*(var_1_2_Pointer)) || (*(var_1_5_Pointer))))) : ((! (*(var_1_5_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_5_Pointer)))) : 1)) : ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_5_Pointer))))) && ((*(var_1_1_Pointer)) ? (((max (5 , last_1_var_1_6)) < (*(var_1_9_Pointer))) ? ((! (*(var_1_5_Pointer))) ? ((*(var_1_6_Pointer)) == ((unsigned short int) (*(var_1_8_Pointer)))) : ((*(var_1_6_Pointer)) == ((unsigned short int) 1))) : 1) : ((*(var_1_6_Pointer)) == ((unsigned short int) (*(var_1_8_Pointer)))))) && ((last_1_var_1_9 > ((*(var_1_10_Pointer)) - (*(var_1_11_Pointer)))) ? ((*(var_1_9_Pointer)) == ((signed long int) (*(var_1_10_Pointer)))) : 1)) && ((*(var_1_1_Pointer)) ? (((*(var_1_8_Pointer)) <= (*(var_1_6_Pointer))) ? (((min (10.4 , (*(var_1_13_Pointer)))) < ((*(var_1_14_Pointer)) * (*(var_1_15_Pointer)))) ? ((*(var_1_12_Pointer)) == ((double) (*(var_1_16_Pointer)))) : ((*(var_1_12_Pointer)) == ((double) 64.6))) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
