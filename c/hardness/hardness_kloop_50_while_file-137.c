...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13750_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch13750_while
	var_1_14 = (min (var_1_6 , var_1_5));


	// From: Req7Batch13750_while
	var_1_22 = var_1_4;


	// From: Req8Batch13750_while
	var_1_23 = var_1_13;


	// From: Req9Batch13750_while
	var_1_24 = var_1_7;


	// From: Req3Batch13750_while
	if ((2.75f >= var_1_23) && ((var_1_6 - var_1_5) > (var_1_7 * var_1_4))) {
		var_1_11 = var_1_13;
	}


	// From: Req5Batch13750_while
	if (128.8f != (1.6f * var_1_11)) {
		var_1_15 = ((var_1_16 + (max (var_1_17 , 4))) + (min (var_1_5 , var_1_4)));
	}


	// From: Req6Batch13750_while
