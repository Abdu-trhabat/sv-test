...
void step(void) {
	...
	// From: Req5Batch114100_1loop
	if (var_1_6 != var_1_12) {
		var_1_13 = (max (16 , var_1_6));
	}


	// From: Req9Batch114100_1loop
	...
	// From: Req1Batch114100_1loop
	if (! var_1_14) {
		var_1_1 = (max ((var_1_3 + 4) , (var_1_4 + 10)));
	}


	// From: Req2Batch114100_1loop
	...
	// From: Req7Batch114100_1loop
	if ((var_1_13 + var_1_7) >= var_1_8) {
		var_1_17 = (var_1_18 - var_1_6);
	}


	// From: Req10Batch114100_1loop
