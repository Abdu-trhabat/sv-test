...
void step(void) {
	...
	signed long int stepLocal_28 = abs (var_1_41);
	...
	if (last_1_var_1_92) {
		...
		var_1_23 = (last_1_var_1_69 + (abs (var_1_17)));
	}


	// From: Req17Batch12Amount500
	if ((min (last_1_var_1_94 , last_1_var_1_105)) == var_1_29) {
	...
	if (var_1_6 >= stepLocal_24) {
		...
		var_1_79 = (var_1_15 - (min (var_1_19 , var_1_14)));
	}


	// From: Req13Batch12Amount500
	if ((var_1_18 * (max (var_1_13 , var_1_19))) <= var_1_14) {
		var_1_38 = ((var_1_48 - var_1_27) + ((min (var_1_35 , var_1_17)) + var_1_30));
	} else {
		var_1_38 = (((max (var_1_48 , var_1_17)) + var_1_36) - var_1_30);
	}


	// From: Req18Batch12Amount500
	var_1_50 = (((min (var_1_51 , var_1_52)) - var_1_44) - var_1_38);
	...
	if (stepLocal_12 > var_1_10) {
		var_1_34 = (var_1_35 - (max (var_1_26 , var_1_27)));
	} else {
		if (var_1_10 <= stepLocal_11) {
			var_1_34 = (min (var_1_36 , (min ((var_1_35 - var_1_27) , (abs (var_1_30))))));
		}
	}
	...
	if (var_1_19 <= var_1_13) {
		var_1_58 = (max (var_1_55 , (max ((var_1_19 - var_1_13) , var_1_56))));
	}


	// From: Req23Batch12Amount500
	if (((last_1_var_1_59 % var_1_51) % var_1_29) > (max ((var_1_42 + var_1_26) , var_1_36))) {
		var_1_59 = (abs (var_1_17));
	}


	// From: Req31Batch12Amount500
	var_1_82 = (var_1_83 - (var_1_27 + (max (32 , var_1_43))));
	...
	if (var_1_15 >= var_1_57) {
		if (var_1_17 == (var_1_29 - (min (var_1_27 , var_1_26)))) {
			var_1_28 = (min (-10 , (var_1_27 - var_1_30)));
		}
	}
	...
	if (var_1_42 == (var_1_10 * 50)) {
		...
		if (var_1_106) {
			...
			var_1_45 = ((max (var_1_13 , var_1_14)) + var_1_46);
		}
	}
	...
	if ((~ (var_1_108 * var_1_6)) == (var_1_42 - (var_1_43 + 10))) {
		var_1_54 = ((max ((min (var_1_13 , var_1_14)) , (var_1_55 + var_1_56))) + var_1_46);
	}
	...
	if (stepLocal_17 >= var_1_104) {
		var_1_60 = (min (var_1_19 , var_1_46));
	} else {
	...
	if (var_1_104 >= stepLocal_18) {
		if (var_1_56 <= (abs (var_1_60))) {
			if (! var_1_84) {
				var_1_62 = ((max ((min (var_1_42 , var_1_43)) , (var_1_27 + var_1_44))) - var_1_30);
			}
		}
	}
	...
	if (var_1_38 > stepLocal_22) {
		if (var_1_100) {
			if ((var_1_19 - (var_1_77 - var_1_14)) != 7.1f) {
				var_1_76 = (var_1_27 + (abs (var_1_42)));
			}
		} else {
			var_1_76 = ((var_1_65 - var_1_70) + (min ((var_1_78 - var_1_17) , last_1_var_1_76)));
		}
	} else {
		var_1_76 = var_1_17;
	}
	...
	if (var_1_92 || stepLocal_8) {
		var_1_21 = (min ((max (200u , var_1_34)) , (abs (var_1_103))));
	}
	...
	if (stepLocal_20 <= var_1_10) {
		if ((max ((min (var_1_60 , var_1_57)) , var_1_14)) != ((abs (4.8)) - var_1_15)) {
			var_1_63 = (min (((var_1_65 + var_1_66) - var_1_44) , var_1_42));
		} else {
			if (var_1_102 > stepLocal_21) {
				if (var_1_79 >= ((abs (var_1_14)) - var_1_13)) {
	...
	if (stepLocal_0 && (! var_1_100)) {
		var_1_1 = (var_1_96 - (max (var_1_76 , var_1_6)));
	} else {
		if (stepLocal_2 < var_1_59) {
			var_1_1 = ((min (var_1_76 , var_1_96)) - var_1_6);
		} else {
	...
	if (stepLocal_9 > (abs (var_1_23))) {
		if (var_1_18 > (min (var_1_47 , var_1_13))) {
			var_1_24 = (max (var_1_63 , (var_1_6 + var_1_59)));
		} else {
	...
	if ((min (var_1_24 , -5)) >= ((abs (var_1_50)) & var_1_63)) {
		if (var_1_106) {
			var_1_69 = ((var_1_70 - var_1_43) + var_1_30);
		} else {
			if (var_1_106) {
				var_1_69 = (var_1_35 - (max (var_1_26 , var_1_70)));
			} else {
		...
		if (var_1_48 >= -8) {
			if ((min ((var_1_36 - var_1_70) , var_1_65)) != ((var_1_105 / var_1_68) | (min (var_1_23 , var_1_21)))) {
				var_1_69 = (min ((128 - (max (var_1_27 , var_1_43))) , var_1_44));
			} else {
			...
			if (var_1_29 >= var_1_71) {
				...
				if (127.4f >= (var_1_79 / (max (var_1_74 , var_1_19)))) {
					var_1_69 = (min (((min (var_1_35 , var_1_75)) - var_1_72) , (min ((var_1_43 + var_1_44) , var_1_70))));
				} else {
					var_1_69 = (min (var_1_75 , ((var_1_70 - var_1_27) + (var_1_44 + var_1_43))));
				}
			}
		}
	}
	...
	signed long int stepLocal_14 = max (var_1_33 , (var_1_35 * 128));
	unsigned char stepLocal_13 = var_1_84;
	if (stepLocal_13 && (var_1_69 < var_1_99)) {
		if (var_1_100) {
			if (var_1_32 <= stepLocal_14) {
				if ((- var_1_79) < var_1_19) {
					var_1_39 = (max ((2 - (min (var_1_30 , var_1_27))) , var_1_41));
				} else {
					var_1_39 = ((max (var_1_30 , var_1_27)) - var_1_42);
				}
			} else {
				var_1_39 = (var_1_30 - var_1_27);
			}
		} else {
			var_1_39 = (((abs (var_1_27)) + (min (var_1_43 , var_1_44))) - (max (var_1_30 , var_1_42)));
		}
	}
	...
	if (var_1_88 && (var_1_9 >= var_1_26)) {
		if (var_1_88) {
			var_1_31 = (((min (var_1_32 , 26551)) - var_1_27) - (var_1_29 + (min (var_1_17 , var_1_26))));
		} else {
			var_1_31 = ((max (var_1_69 , var_1_76)) + ((min (128 , var_1_33)) + var_1_1));
		}
	}
	...
	if (var_1_74 > var_1_15) {
		if (stepLocal_27 <= var_1_71) {
			if (-5 < stepLocal_26) {
				...
				var_1_91 = (max (var_1_42 , var_1_31));
			}
		} else {
			var_1_91 = (var_1_30 - (var_1_75 + (var_1_17 + 5)));
		}
	} else {
		var_1_91 = ((max (0 , var_1_75)) - var_1_80);
	}


	// From: Req4Batch12Amount500
	var_1_20 = (max (last_1_var_1_20 , ((min (var_1_17 , var_1_31)) + var_1_50)));


	// From: Req30Batch12Amount500
	if ((var_1_57 <= 5.8f) || var_1_92) {
		var_1_81 = (max (var_1_65 , (var_1_17 + (var_1_32 - var_1_67))));
	} else {
		var_1_81 = ((var_1_101 - var_1_71) + (max (var_1_72 , (-5 + var_1_20))));
	}


	// From: Req19Batch12Amount500
	if (var_1_54 < var_1_18) {
		if ((var_1_57 + (min (var_1_25 , var_1_19))) == (max (var_1_18 , (abs (5.6f))))) {
			if (var_1_92 || var_1_100) {
				if (var_1_98 < -16) {
					var_1_53 = ((max (var_1_13 , var_1_14)) + var_1_46);
				} else {
					var_1_53 = var_1_46;
				}
			} else {
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_76 * var_1_96) >= var_1_59) && (! var_1_100)) ? (var_1_1 == ((signed short int) (var_1_96 - (max (var_1_76 , var_1_6))))) : (((65169 - var_1_76) < var_1_59) ? (var_1_1 == ((signed short int) ((min (var_1_76 , var_1_96)) - var_1_6))) : (((4 + var_1_76) != (16 * var_1_96)) ? ((var_1_96 != var_1_59) ? ((((var_1_102 / var_1_9) + var_1_6) >= var_1_96) ? (var_1_1 == ((signed short int) var_1_10)) : 1) : (var_1_1 == ((signed short int) var_1_76))) : 1))) && ((((var_1_99 * var_1_24) / var_1_9) > (var_1_38 + var_1_59)) ? ((-4 < var_1_59) ? (var_1_11 == ((signed long int) var_1_10)) : ((var_1_48 >= (var_1_76 | var_1_24)) ? (var_1_11 == ((signed long int) (var_1_24 + (var_1_6 - var_1_99)))) : 1)) : 1)) && ((var_1_59 <= var_1_76) ? (var_1_12 == ((float) ((var_1_13 + var_1_14) - var_1_15))) : (((16 + (var_1_82 % var_1_17)) <= var_1_24) ? (var_1_12 == ((float) (min ((var_1_13 - var_1_15) , (min (var_1_14 , var_1_18)))))) : ((! var_1_88) ? (var_1_12 == ((float) ((max (var_1_13 , 9999.375f)) - (var_1_19 - (abs (var_1_14)))))) : (var_1_12 == ((float) (min (var_1_19 , 256.1f)))))))) && (var_1_20 == ((signed short int) (max (last_1_var_1_20 , ((min (var_1_17 , var_1_31)) + var_1_50)))))) && ((var_1_92 || var_1_88) ? (var_1_21 == ((unsigned long int) (min ((max (200u , var_1_34)) , (abs (var_1_103)))))) : 1)) && (last_1_var_1_92 ? (var_1_23 == ((signed short int) ((-8 + -4) + last_1_var_1_94))) : (var_1_23 == ((signed short int) (last_1_var_1_69 + (abs (var_1_17))))))) && ((var_1_98 > (abs (var_1_23))) ? ((var_1_18 > (min (var_1_47 , var_1_13))) ? (var_1_24 == ((signed long int) (max (var_1_63 , (var_1_6 + var_1_59))))) : (var_1_24 == ((signed long int) (var_1_6 + var_1_63)))) : (var_1_24 == ((signed long int) var_1_10)))) && (((var_1_26 >> var_1_27) <= (var_1_17 + var_1_10)) ? (var_1_100 ? (var_1_25 == ((float) var_1_15)) : 1) : 1)) && ((var_1_15 >= var_1_57) ? ((var_1_17 == (var_1_29 - (min (var_1_27 , var_1_26)))) ? (var_1_28 == ((signed char) (min (-10 , (var_1_27 - var_1_30))))) : 1) : 1)) && ((var_1_88 && (var_1_9 >= var_1_26)) ? (var_1_88 ? (var_1_31 == ((signed short int) (((min (var_1_32 , 26551)) - var_1_27) - (var_1_29 + (min (var_1_17 , var_1_26)))))) : (var_1_31 == ((signed short int) ((max (var_1_69 , var_1_76)) + ((min (128 , var_1_33)) + var_1_1))))) : 1)) && ((var_1_29 > var_1_10) ? (var_1_34 == ((unsigned char) (var_1_35 - (max (var_1_26 , var_1_27))))) : ((var_1_10 <= var_1_6) ? (var_1_34 == ((unsigned char) (min (var_1_36 , (min ((var_1_35 - var_1_27) , (abs (var_1_30)))))))) : 1))) && (var_1_37 == ((float) (var_1_14 + var_1_13)))) && (((var_1_18 * (max (var_1_13 , var_1_19))) <= var_1_14) ? (var_1_38 == ((signed short int) ((var_1_48 - var_1_27) + ((min (var_1_35 , var_1_17)) + var_1_30)))) : (var_1_38 == ((signed short int) (((max (var_1_48 , var_1_17)) + var_1_36) - var_1_30))))) && ((var_1_84 && (var_1_69 < var_1_99)) ? (var_1_100 ? ((var_1_32 <= (max (var_1_33 , (var_1_35 * 128)))) ? (((- var_1_79) < var_1_19) ? (var_1_39 == ((signed char) (max ((2 - (min (var_1_30 , var_1_27))) , var_1_41)))) : (var_1_39 == ((signed char) ((max (var_1_30 , var_1_27)) - var_1_42)))) : (var_1_39 == ((signed char) (var_1_30 - var_1_27)))) : (var_1_39 == ((signed char) (((abs (var_1_27)) + (min (var_1_43 , var_1_44))) - (max (var_1_30 , var_1_42)))))) : 1)) && ((var_1_42 == (var_1_10 * 50)) ? (var_1_45 == ((float) (var_1_13 + 9.9f))) : (var_1_106 ? ((var_1_15 > var_1_95) ? (var_1_45 == ((float) var_1_18)) : 1) : (var_1_45 == ((float) ((max (var_1_13 , var_1_14)) + var_1_46)))))) && ((-4 >= var_1_27) ? (var_1_47 == ((double) (var_1_13 + var_1_14))) : ((50 == (var_1_29 + var_1_6)) ? (var_1_47 == ((double) ((var_1_14 + var_1_13) - var_1_19))) : 1))) && (((min (last_1_var_1_94 , last_1_var_1_105)) == var_1_29) ? ((last_1_var_1_57 <= last_1_var_1_37) ? (var_1_48 == ((signed long int) (last_1_var_1_39 + var_1_9))) : 1) : (var_1_48 == ((signed long int) (last_1_var_1_34 + (last_1_var_1_59 + var_1_29)))))) && (var_1_50 == ((unsigned long int) (((min (var_1_51 , var_1_52)) - var_1_44) - var_1_38)))) && ((var_1_54 < var_1_18) ? (((var_1_57 + (min (var_1_25 , var_1_19))) == (max (var_1_18 , (abs (5.6f))))) ? ((var_1_92 || var_1_100) ? ((var_1_98 < -16) ? (var_1_53 == ((float) ((max (var_1_13 , var_1_14)) + var_1_46))) : (var_1_53 == ((float) var_1_46))) : (var_1_53 == ((float) ((var_1_19 - var_1_13) - var_1_15)))) : 1) : ((var_1_32 < var_1_98) ? (((var_1_81 < var_1_105) && var_1_92) ? (var_1_53 == ((float) var_1_46)) : (var_1_53 == ((float) ((var_1_19 - 1.5f) - 1.00000000007E10f)))) : 1))) && (((~ (var_1_108 * var_1_6)) == (var_1_42 - (var_1_43 + 10))) ? (var_1_54 == ((float) ((max ((min (var_1_13 , var_1_14)) , (var_1_55 + var_1_56))) + var_1_46))) : 1)) && (var_1_88 ? (var_1_57 == ((double) (var_1_15 - (var_1_13 + var_1_14)))) : 1)) && ((var_1_19 <= var_1_13) ? (var_1_58 == ((double) (max (var_1_55 , (max ((var_1_19 - var_1_13) , var_1_56)))))) : 1)) && ((((last_1_var_1_59 % var_1_51) % var_1_29) > (max ((var_1_42 + var_1_26) , var_1_36))) ? (var_1_59 == ((unsigned long int) (abs (var_1_17)))) : 1)) && (((var_1_27 * var_1_44) >= var_1_104) ? (var_1_60 == ((double) (min (var_1_19 , var_1_46)))) : (var_1_60 == ((double) ((var_1_56 + var_1_55) + (var_1_61 + 5.8)))))) && ((var_1_104 >= var_1_44) ? ((var_1_56 <= (abs (var_1_60))) ? ((! var_1_84) ? (var_1_62 == ((signed char) ((max ((min (var_1_42 , var_1_43)) , (var_1_27 + var_1_44))) - var_1_30))) : 1) : 1) : 1)) && (((var_1_59 / var_1_35) <= var_1_10) ? (((max ((min (var_1_60 , var_1_57)) , var_1_14)) != ((abs (4.8)) - var_1_15)) ? (var_1_63 == ((unsigned short int) (min (((var_1_65 + var_1_66) - var_1_44) , var_1_42)))) : ((var_1_102 > var_1_65) ? ((var_1_79 >= ((abs (var_1_14)) - var_1_13)) ? (var_1_63 == ((unsigned short int) (var_1_105 + (var_1_67 - var_1_26)))) : (((var_1_52 / var_1_65) >= var_1_17) ? (var_1_63 == ((unsigned short int) (var_1_68 - (var_1_42 + (var_1_105 + var_1_27))))) : (var_1_63 == ((unsigned short int) (var_1_68 - 16))))) : (var_1_63 == ((unsigned short int) var_1_29)))) : 1)) && (((min (var_1_24 , -5)) >= ((abs (var_1_50)) & var_1_63)) ? (var_1_106 ? (var_1_69 == ((unsigned char) ((var_1_70 - var_1_43) + var_1_30))) : (var_1_106 ? (var_1_69 == ((unsigned char) (var_1_35 - (max (var_1_26 , var_1_70))))) : (var_1_69 == ((unsigned char) (((var_1_71 + var_1_72) - var_1_27) + var_1_44))))) : ((var_1_48 >= -8) ? (((min ((var_1_36 - var_1_70) , var_1_65)) != ((var_1_105 / var_1_68) | (min (var_1_23 , var_1_21)))) ? (var_1_69 == ((unsigned char) (min ((128 - (max (var_1_27 , var_1_43))) , var_1_44)))) : (var_1_69 == ((unsigned char) (var_1_70 + var_1_72)))) : ((var_1_29 >= var_1_71) ? (var_1_69 == ((unsigned char) (var_1_27 + (var_1_72 + var_1_44)))) : ((127.4f >= (var_1_79 / (max (var_1_74 , var_1_19)))) ? (var_1_69 == ((unsigned char) (min (((min (var_1_35 , var_1_75)) - var_1_72) , (min ((var_1_43 + var_1_44) , var_1_70)))))) : (var_1_69 == ((unsigned char) (min (var_1_75 , ((var_1_70 - var_1_27) + (var_1_44 + var_1_43))))))))))) && ((var_1_38 > var_1_48) ? (var_1_100 ? (((var_1_19 - (var_1_77 - var_1_14)) != 7.1f) ? (var_1_76 == ((unsigned short int) (var_1_27 + (abs (var_1_42))))) : 1) : (var_1_76 == ((unsigned short int) ((var_1_65 - var_1_70) + (min ((var_1_78 - var_1_17) , last_1_var_1_76)))))) : (var_1_76 == ((unsigned short int) var_1_17)))) && ((var_1_6 >= ((var_1_78 - var_1_42) >> (var_1_27 + var_1_80))) ? ((var_1_48 >= var_1_17) ? (var_1_79 == ((float) var_1_14)) : (var_1_79 == ((float) (var_1_55 + var_1_56)))) : (var_1_79 == ((float) (var_1_15 - (min (var_1_19 , var_1_14))))))) && (((var_1_57 <= 5.8f) || var_1_92) ? (var_1_81 == ((signed long int) (max (var_1_65 , (var_1_17 + (var_1_32 - var_1_67)))))) : (var_1_81 == ((signed long int) ((var_1_101 - var_1_71) + (max (var_1_72 , (-5 + var_1_20)))))))) && (var_1_82 == ((unsigned char) (var_1_83 - (var_1_27 + (max (32 , var_1_43))))))) && ((var_1_77 >= var_1_13) ? (var_1_84 == ((unsigned char) (var_1_85 || var_1_86))) : (var_1_84 == ((unsigned char) (! (! (! var_1_87))))))) && ((last_1_var_1_106 && var_1_86) ? (var_1_87 ? (var_1_88 == ((unsigned char) var_1_89)) : (var_1_88 == ((unsigned char) ((var_1_52 >= var_1_68) && var_1_86)))) : (var_1_88 == ((unsigned char) (last_1_var_1_92 || var_1_90))))) && ((var_1_74 > var_1_15) ? ((4 <= var_1_71) ? ((-5 < var_1_44) ? (var_1_91 == ((signed short int) (var_1_1 + -64))) : (var_1_91 == ((signed short int) (max (var_1_42 , var_1_31))))) : (var_1_91 == ((signed short int) (var_1_30 - (var_1_75 + (var_1_17 + 5)))))) : (var_1_91 == ((signed short int) ((max (0 , var_1_75)) - var_1_80))))) && ((last_1_var_1_21 > (abs (var_1_41))) ? (var_1_92 == ((unsigned char) (! (var_1_85 || var_1_89)))) : (var_1_92 == ((unsigned char) ((! last_1_var_1_84) || (var_1_87 || var_1_90)))))) && (var_1_93 == ((signed char) (var_1_27 - var_1_43)))) && (var_1_100 ? (var_1_94 == ((unsigned short int) var_1_102)) : (var_1_94 == ((unsigned short int) var_1_71)))) && (var_1_95 == ((double) 0.25))) && (var_1_96 == ((unsigned short int) 8))) && (var_1_92 ? (var_1_97 == ((signed char) var_1_41)) : (var_1_97 == ((signed char) var_1_27)))) && (var_1_92 ? (var_1_98 == ((signed short int) var_1_36)) : (var_1_98 == ((signed short int) var_1_43)))) && (var_1_86 ? (var_1_99 == ((unsigned char) var_1_30)) : (var_1_99 == ((unsigned char) var_1_72)))) && (var_1_92 ? (var_1_100 == ((unsigned char) var_1_90)) : (var_1_100 == ((unsigned char) var_1_86)))) && (var_1_106 ? (var_1_101 == ((signed short int) var_1_41)) : 1)) && (var_1_92 ? (var_1_102 == ((unsigned long int) last_1_var_1_102)) : (var_1_102 == ((unsigned long int) var_1_66)))) && (var_1_106 ? (var_1_103 == ((unsigned char) var_1_35)) : 1)) && (var_1_84 ? (var_1_104 == ((signed long int) var_1_96)) : 1)) && (var_1_87 ? (var_1_105 == ((unsigned long int) var_1_80)) : 1)) && ((var_1_34 >= var_1_70) ? (var_1_106 == ((unsigned char) (! (! var_1_89)))) : (var_1_106 == ((unsigned char) ((var_1_86 && var_1_88) || var_1_90))))) && (var_1_108 == ((signed short int) var_1_32))
;
}
int main(void) {
	isInitial = 1;
