...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch177Filler_PS_CN.c", 13, "reach_error"); }
    ...
    var_1_46
             ...
             if ( ((var_1_34) < ( ((var_1_46) | (var_1_30))))) {
              ...
              if (var_1_31) {
               if (var_1_42) {
                var_1_48 = (
                 ((((( ((((( var_1_44 )) < (( var_1_46 ))) ? (( var_1_44 )) : (( var_1_46 )))) )) < (( var_1_39 ))) ? (( ((((( var_1_44 )) < (( var_1_46 ))) ? (( var_1_44 )) : (( var_1_46 )))) )) : (( var_1_39 ))))
    );
   } else {
                var_1_48 = (
                 (((((( var_1_49 ) - ( var_1_39 ))) < 0 ) ? -((( var_1_49 ) - ( var_1_39 ))) : ((( var_1_49 ) - ( var_1_39 )))))
    );
   }
  } else {
               if (var_1_36) {
