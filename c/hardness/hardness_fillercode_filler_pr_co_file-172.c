...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch172Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 284L, 81L) */ if (/* 285L, 51L, 52L) */ ((var_1_30) != (var_1_31))) {
		/* 288L, 79L) */ if (/* 289L, 60L, 61L) */ ((var_1_28) <= (var_1_1))) {
			/* 292L, 71L) */ var_1_29 = (
				/* 295L, 70L) */ (abs (
					var_1_32
				))
	...
	// From: Req8Batch172Filler_PR_CO
	/* 969L, 254L, 772L, 778L) */ var_1_24 = (
		var_1_16
	);


	// From: Req4Batch172Filler_PR_CO
