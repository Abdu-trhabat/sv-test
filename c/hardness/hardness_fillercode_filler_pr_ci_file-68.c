...
void step(void) {
	...
	// From: CodeObject2
	/* 247L, 29L) */ if (/* 248L, 16L, 17L) */ (! (var_1_5))) {
		/* 250L, 28L) */ var_1_34 = (
			/* 253L, 27L) */ ((
				var_1_36
			) - (
	...
	// From: CodeObject4
	/* 263L, 137L) */ if (/* 264L, 45L, 46L) */ ((/* 265L, 43L, 47L) */ (max (/* 265L, 43L, 47L) */ (var_1_37) , (var_1_36)))) > (var_1_15))) {
		/* 269L, 135L) */ if (/* 270L, 58L, 59L) */ ((var_1_39) > (var_1_28))) {
			...
			/* 281L, 133L) */ if (/* 282L, 82L, 83L) */ ((/* 283L, 75L, 84L) */ (min (/* 283L, 75L, 84L) */ (var_1_39) , (var_1_28)))) > (/* 286L, 81L, 87L) */ ((var_1_41) - (/* 288L, 80L, 89L) */ (min (/* 288L, 80L, 89L) */ (var_1_42) , (10)))))))) {
				/* 291L, 127L) */ if (/* 292L, 106L, 107L) */ ((/* 293L, 104L, 108L) */ ((/* 294L, 102L, 109L) */ (abs (var_1_25))) - (var_1_26))) < (2))) {
					/* 298L, 126L) */ var_1_40 = (
						/* 301L, 125L) */ (max (
							/* 301L, 125L) */ (
								var_1_26
	...
	// From: CodeObject7
	/* 357L, 228L) */ if (/* 358L, 205L, 206L) */ ((/* 359L, 201L, 207L) */ ((var_1_26) ^ (/* 361L, 200L, 209L) */ ((var_1_11) | (var_1_29))))) < (/* 364L, 204L, 212L) */ ((var_1_42) ^ (var_1_41))))) {
		/* 367L, 227L) */ var_1_49 = (
			var_1_36
		);
	}
	...
	// From: CodeObject6
	/* 315L, 193L) */ if (/* 316L, 151L, 152L) */ ((var_1_27) >= (var_1_28))) {
		/* 319L, 181L) */ if (/* 320L, 162L, 163L) */ ((/* 321L, 160L, 164L) */ ((var_1_36) > (var_1_37))) || (var_1_5))) {
			/* 325L, 180L) */ var_1_46 = (
				/* 328L, 179L) */ ((
					/* 329L, 177L) */ ((
						var_1_23
...
int property(void) {
	if (/* 377L, 6L, 12L, 596L, 649L, 1174L) */ ((var_1_2) <= (/* 379L, 5L, 14L, 598L, 651L, 1176L) */ ((var_1_3) ^ (var_1_4))))) {
	} else {
		if (/* 388L, 32L, 39L, 607L, 660L, 1185L) */ ((/* 389L, 30L, 40L, 608L, 661L, 1186L) */ ((var_1_14) + (/* 391L, 29L, 42L, 610L, 663L, 1188L) */ (- (var_1_14))))) >= (var_1_14))) {
			if (/* 395L, 55L, 63L, 614L, 667L, 1192L) */ ((/* 396L, 53L, 64L, 615L, 668L, 1193L) */ ((var_1_3) / (/* 398L, 52L, 66L, 617L, 670L, 1195L) */ (min (/* 398L, 52L, 66L, 617L, 670L, 1195L) */ (var_1_10) , (var_1_11)))))) > (var_1_2))) {
			} else {
				if (/* 411L, 82L, 88L, 630L, 683L, 1208L) */ ((/* 412L, 80L, 89L, 631L, 684L, 1209L) */ ((var_1_24) * (var_1_4))) < (var_1_3))) {
				} else {
				}
			}
		} else {
	...
	if (/* 431L, 123L, 131L, 731L, 745L, 1228L) */ ((/* 432L, 119L, 132L, 732L, 746L, 1229L) */ ((var_1_15) - (var_1_16))) == (/* 435L, 122L, 135L, 735L, 749L, 1232L) */ ((var_1_17) - (var_1_18))))) {
	}
	if (/* 445L, 158L, 168L, 791L, 807L, 1242L) */ ((/* 446L, 156L, 169L, 792L, 808L, 1243L) */ ((/* 447L, 152L, 170L, 793L, 809L, 1244L) */ (min (/* 447L, 152L, 170L, 793L, 809L, 1244L) */ (var_1_17) , (var_1_16)))) - (/* 450L, 155L, 173L, 796L, 812L, 1247L) */ ((var_1_21) + (var_1_22))))) >= (63.6))) {
	}
	if (/* 460L, 192L, 197L, 870L, 882L, 1257L) */ (! (/* 461L, 191L, 198L, 871L, 883L, 1258L) */ ((var_1_7) > (var_1_14))))) {
		if (var_1_12) {
		}
	}
	if (/* 473L, 218L, 222L, 927L, 943L, 1270L) */ ((var_1_23) || (var_1_12))) {
		if (var_1_9) {
		}
	}
	if (/* 488L, 248L, 252L, 996L, 1015L, 1285L) */ ((var_1_14) > (var_1_22))) {
		if (/* 492L, 256L, 259L, 1000L, 1019L, 1289L) */ (! (var_1_23))) {
		} else {
		}
	}
	return /* 510L) */ ((
	/* 509L) */ ((
		/* 508L) */ ((
			/* 507L) */ ((
				/* 506L) */ ((
					/* 376L, 112L, 595L, 648L, 1173L) */ ((
						/* 377L, 6L, 12L, 596L, 649L, 1174L) */ ((
							var_1_2
						) <= (
							/* 379L, 5L, 14L, 598L, 651L, 1176L) */ ((
								var_1_3
							) ^ (
								var_1_4
							))
						...
						/* 382L, 21L, 601L, 654L, 1179L) */ ((
							var_1_1
						) == (
							/* 382L, 21L, 601L, 654L, 1179L) */ ((unsigned char) (
								/* 385L, 20L, 604L, 657L, 1182L) */ (! (
									var_1_5
								))
							))
						))
					) : (
						/* 387L, 110L, 606L, 659L, 1184L) */ ((
							/* 388L, 32L, 39L, 607L, 660L, 1185L) */ ((
								/* 389L, 30L, 40L, 608L, 661L, 1186L) */ ((
									var_1_14
								) + (
									/* 391L, 29L, 42L, 610L, 663L, 1188L) */ (- (
										var_1_14
									))
								))
							) >= (
							...
							/* 394L, 104L, 613L, 666L, 1191L) */ ((
								/* 395L, 55L, 63L, 614L, 667L, 1192L) */ ((
									/* 396L, 53L, 64L, 615L, 668L, 1193L) */ ((
										var_1_3
									) / (
										/* 398L, 52L, 66L, 617L, 670L, 1195L) */ (min (
											/* 398L, 52L, 66L, 617L, 670L, 1195L) */ (
												var_1_10
											) , (
												var_1_11
											)
								...
								/* 402L, 77L, 621L, 674L, 1199L) */ ((
									var_1_1
								) == (
									/* 402L, 77L, 621L, 674L, 1199L) */ ((unsigned char) (
										/* 405L, 76L, 624L, 677L, 1202L) */ ((
											var_1_9
										) || (
											/* 407L, 75L, 626L, 679L, 1204L) */ ((
												var_1_5
											) || (
												var_1_12
											))
								...
								/* 410L, 102L, 629L, 682L, 1207L) */ ((
									/* 411L, 82L, 88L, 630L, 683L, 1208L) */ ((
										/* 412L, 80L, 89L, 631L, 684L, 1209L) */ ((
											var_1_24
										) * (
											var_1_4
										))
									...
									/* 416L, 96L, 635L, 688L, 1213L) */ ((
										var_1_1
									) == (
										/* 416L, 96L, 635L, 688L, 1213L) */ ((unsigned char) (
											var_1_12
										))
									))
								) : (
									/* 420L, 100L, 639L, 692L, 1217L) */ ((
										var_1_1
									) == (
										/* 420L, 100L, 639L, 692L, 1217L) */ ((unsigned char) (
											var_1_9
										))
									))
								))
							...
							/* 424L, 108L, 643L, 696L, 1221L) */ ((
								var_1_1
							) == (
								/* 424L, 108L, 643L, 696L, 1221L) */ ((unsigned char) (
									var_1_12
								))
							))
						))
					...
					/* 430L, 143L, 730L, 744L, 1227L) */ ((
						/* 431L, 123L, 131L, 731L, 745L, 1228L) */ ((
							/* 432L, 119L, 132L, 732L, 746L, 1229L) */ ((
								var_1_15
							) - (
								var_1_16
							))
						) == (
							/* 435L, 122L, 135L, 735L, 749L, 1232L) */ ((
								var_1_17
							) - (
								var_1_18
							))
						...
						/* 438L, 141L, 738L, 752L, 1235L) */ ((
							var_1_14
						) == (
							/* 438L, 141L, 738L, 752L, 1235L) */ ((float) (
								var_1_19
							))
						))
					) : (
				...
				/* 444L, 182L, 790L, 806L, 1241L) */ ((
					/* 445L, 158L, 168L, 791L, 807L, 1242L) */ ((
						/* 446L, 156L, 169L, 792L, 808L, 1243L) */ ((
							/* 447L, 152L, 170L, 793L, 809L, 1244L) */ (min (
								/* 447L, 152L, 170L, 793L, 809L, 1244L) */ (
									var_1_17
								) , (
									var_1_16
								)
							...
							/* 450L, 155L, 173L, 796L, 812L, 1247L) */ ((
								var_1_21
							) + (
								var_1_22
							))
					...
					/* 454L, 180L, 800L, 816L, 1251L) */ ((
						var_1_20
					) == (
						/* 454L, 180L, 800L, 816L, 1251L) */ ((signed short int) (
							var_1_28
						))
					))
				) : (
			...
			/* 459L, 211L, 869L, 881L, 1256L) */ ((
				/* 460L, 192L, 197L, 870L, 882L, 1257L) */ (! (
					/* 461L, 191L, 198L, 871L, 883L, 1258L) */ ((
						var_1_7
					) > (
						var_1_14
					))
				...
				/* 464L, 209L, 874L, 886L, 1261L) */ ((
					var_1_12
				) ? (
					/* 466L, 207L, 876L, 888L, 1263L) */ ((
						var_1_23
					) == (
						/* 466L, 207L, 876L, 888L, 1263L) */ ((unsigned char) (
							var_1_5
						))
					))
				) : (
		...
		/* 472L, 239L, 926L, 942L, 1269L) */ ((
			/* 473L, 218L, 222L, 927L, 943L, 1270L) */ ((
				var_1_23
			) || (
				var_1_12
			))
		) ? (
			/* 476L, 237L, 930L, 946L, 1273L) */ ((
				var_1_9
			) ? (
				/* 478L, 235L, 932L, 948L, 1275L) */ ((
					var_1_24
				) == (
					/* 478L, 235L, 932L, 948L, 1275L) */ ((signed char) (
						/* 481L, 234L, 935L, 951L, 1278L) */ ((
							var_1_25
						) - (
							/* 483L, 233L, 937L, 953L, 1280L) */ ((
								var_1_26
							) + (
								var_1_27
							))
	...
	/* 487L, 274L, 995L, 1014L, 1284L) */ ((
		/* 488L, 248L, 252L, 996L, 1015L, 1285L) */ ((
			var_1_14
		) > (
			var_1_22
		))
	) ? (
		/* 491L, 272L, 999L, 1018L, 1288L) */ ((
			/* 492L, 256L, 259L, 1000L, 1019L, 1289L) */ (! (
				var_1_23
			))
		) ? (
			/* 494L, 266L, 1002L, 1021L, 1291L) */ ((
				var_1_28
			) == (
				/* 494L, 266L, 1002L, 1021L, 1291L) */ ((unsigned long int) (
					/* 497L, 265L, 1005L, 1024L, 1294L) */ ((
						var_1_27
					) + (
						last_1_var_1_28
					))
			...
			/* 501L, 270L, 1009L, 1028L, 1298L) */ ((
				var_1_28
			) == (
				/* 501L, 270L, 1009L, 1028L, 1298L) */ ((unsigned long int) (
					var_1_29
				))
			))
		))
