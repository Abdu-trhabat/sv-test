...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch172no_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (-8 > var_1_12) {
  var_1_14 = (var_1_15 - ((((1000000) < (var_1_16)) ? (1000000) : (var_1_16))));
 } else {
  if (var_1_6) {
   var_1_14 = var_1_16;
  } else {
