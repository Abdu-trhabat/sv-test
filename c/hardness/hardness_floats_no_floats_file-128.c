...
void step(void) {
	...
	// From: Req3Batch128no_floats
	if (var_1_2) {
		var_1_10 = ((var_1_3 + var_1_4) + var_1_11);
	}


	// From: Req2Batch128no_floats
