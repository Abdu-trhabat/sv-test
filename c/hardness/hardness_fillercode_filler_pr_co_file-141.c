...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch141Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 393L, 261L) */ if (/* 394L, 215L, 216L) */ ((/* 395L, 211L, 217L) */ ((var_1_31) < (var_1_35))) || (/* 398L, 214L, 220L) */ ((var_1_26) > (var_1_39))))) {
		/* 401L, 259L) */ if (/* 402L, 234L, 235L) */ ((/* 403L, 232L, 236L) */ (abs (/* 404L, 231L, 237L) */ (abs (var_1_8))))) > (var_1_35))) {
			/* 407L, 248L) */ var_1_46 = (
				var_1_32
			);
		} else {
