...
void step(void) {
 ...
 if (signed_long_int_Array_0[0] > stepLocal_0) {
  signed_char_Array_0[2] = (((((-4 + signed_char_Array_0[0])) < (signed_char_Array_0[1])) ? ((-4 + signed_char_Array_0[0])) : (signed_char_Array_0[1])));
 }
