...
void step(void) {
	...
	// From: Req8Batch187100_1loop
	if ((- last_1_var_1_1) <= ((var_1_30 - var_1_31) - var_1_10)) {
		var_1_29 = var_1_25;
	}


	// From: Req6Batch187100_1loop
	if ((var_1_21 < (var_1_27 - 16)) && var_1_29) {
		if (-32 > var_1_13) {
			var_1_26 = (max ((var_1_21 - var_1_22) , var_1_20));
		}
	}


	// From: Req7Batch187100_1loop
	if (var_1_23) {
		var_1_28 = 255.9f;
	}


	// From: Req9Batch187100_1loop
	if (var_1_24 && (var_1_25 && var_1_29)) {
		var_1_32 = (var_1_33 + (min (var_1_34 , var_1_35)));
	}


	// From: Req11Batch187100_1loop
	if ((var_1_29 && (var_1_24 && var_1_25)) || var_1_23) {
		var_1_39 = var_1_14;
	} else {
		var_1_39 = (max (last_1_var_1_39 , var_1_40));
	}


	// From: Req3Batch187100_1loop
	if (var_1_29) {
		if (var_1_23) {
			var_1_12 = var_1_13;
		} else {
	...
	// From: Req10Batch187100_1loop
	if ((min ((var_1_12 + var_1_20) , (var_1_37 - var_1_39))) != (var_1_39 + (var_1_26 % var_1_27))) {
		var_1_36 = ((var_1_38 - var_1_26) - (1834204314 - var_1_21));
	} else {
		var_1_36 = (max ((min (var_1_21 , var_1_13)) , var_1_16));
	}


	// From: Req1Batch187100_1loop
	...
	// From: Req2Batch187100_1loop
	if (((max (var_1_6 , var_1_1)) / (min (0.125 , 1.2))) <= (var_1_10 - var_1_11)) {
		var_1_9 = var_1_6;
	} else {
		var_1_9 = var_1_8;
	}
	...
	if (var_1_39 > stepLocal_4) {
		if (var_1_23) {
			if ((var_1_13 <= var_1_12) || stepLocal_3) {
				...
				var_1_17 = (min ((abs (var_1_19)) , var_1_20));
			}
		} else {
...
int property(void) {
	return ((((((((((((var_1_29 && var_1_23) ? ((var_1_39 >= (var_1_39 + 16u)) ? (var_1_1 == ((double) (max (var_1_6 , (max (var_1_7 , var_1_8)))))) : (var_1_1 == ((double) var_1_6))) : 1) && ((((max (var_1_6 , var_1_1)) / (min (0.125 , 1.2))) <= (var_1_10 - var_1_11)) ? (var_1_9 == ((double) var_1_6)) : (var_1_9 == ((double) var_1_8)))) && (var_1_29 ? (var_1_23 ? (var_1_12 == ((unsigned short int) var_1_13)) : (var_1_12 == ((unsigned short int) ((var_1_14 + (32135 - var_1_15)) - var_1_16)))) : 1)) && ((var_1_39 > (var_1_39 * var_1_15)) ? (var_1_23 ? (((var_1_13 <= var_1_12) || var_1_29) ? (var_1_17 == ((unsigned char) (min (var_1_19 , var_1_20)))) : (var_1_17 == ((unsigned char) (min ((abs (var_1_19)) , var_1_20))))) : (var_1_17 == ((unsigned char) (var_1_21 - var_1_22)))) : ((((100.5f - 1.5f) < var_1_10) && var_1_29) ? (var_1_17 == ((unsigned char) var_1_20)) : (var_1_17 == ((unsigned char) var_1_21))))) && ((((var_1_15 + var_1_21) - last_1_var_1_36) == ((var_1_22 * last_1_var_1_39) * last_1_var_1_39)) ? (var_1_23 == ((unsigned char) var_1_24)) : (var_1_23 == ((unsigned char) var_1_25)))) && (((var_1_21 < (var_1_27 - 16)) && var_1_29) ? ((-32 > var_1_13) ? (var_1_26 == ((unsigned char) (max ((var_1_21 - var_1_22) , var_1_20)))) : 1) : 1)) && (var_1_23 ? (var_1_28 == ((float) 255.9f)) : 1)) && (((- last_1_var_1_1) <= ((var_1_30 - var_1_31) - var_1_10)) ? (var_1_29 == ((unsigned char) var_1_25)) : 1)) && ((var_1_24 && (var_1_25 && var_1_29)) ? (var_1_32 == ((double) (var_1_33 + (min (var_1_34 , var_1_35))))) : 1)) && (((min ((var_1_12 + var_1_20) , (var_1_37 - var_1_39))) != (var_1_39 + (var_1_26 % var_1_27))) ? (var_1_36 == ((signed long int) ((var_1_38 - var_1_26) - (1834204314 - var_1_21)))) : (var_1_36 == ((signed long int) (max ((min (var_1_21 , var_1_13)) , var_1_16)))))) && (((var_1_29 && (var_1_24 && var_1_25)) || var_1_23) ? (var_1_39 == ((unsigned long int) var_1_14)) : (var_1_39 == ((unsigned long int) (max (last_1_var_1_39 , var_1_40)))))) && (((1 * var_1_13) < (var_1_39 + var_1_36)) ? (var_1_41 == ((float) var_1_34)) : 1)
;
}
int main(void) {
	isInitial = 1;
