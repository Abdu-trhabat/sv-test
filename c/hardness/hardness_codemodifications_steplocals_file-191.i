...
void step(void) {
 signed long int stepLocal_0 = (((((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4)))) > (var_1_5)) ? (((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4)))) : (var_1_5));
 ...
 unsigned char stepLocal_1 = var_1_6 >= ((((var_1_9) < (var_1_1)) ? (var_1_9) : (var_1_1)));
