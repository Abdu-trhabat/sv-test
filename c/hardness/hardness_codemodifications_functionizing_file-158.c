...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch158functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
void functionized0(signed long int, unsigned long int, signed long int);
unsigned char functionized1(unsigned char);
void functionized2(signed long int, signed char);
...
void functionized0(signed long int functionized0_localFunctionVar0, unsigned long int functionized0_localFunctionVar1, signed long int localFunctionVar2) {
	if (functionized0_localFunctionVar0 > localFunctionVar2) {
		var_1_21 = (max (8 , functionized0_localFunctionVar1));
	}
}
unsigned char functionized1(unsigned char functionized1_localFunctionVar0) {
	return (! functionized1_localFunctionVar0);
}
void functionized2(signed long int functionized2_localFunctionVar0, signed char functionized2_localFunctionVar1) {
	if ((var_1_19 * var_1_1) > ((max (functionized2_localFunctionVar0 , var_1_13)) - var_1_21)) {
		if ((var_1_13 / var_1_14) <= functionized2_localFunctionVar0) {
			var_1_25 = var_1_14;
		} else {
			var_1_25 = functionized2_localFunctionVar1;
		}
	}
}
unsigned char functionized3(signed short int functionized3_localFunctionVar0) {
	return (var_1_26 <= (-1 * functionized3_localFunctionVar0));
}
...
void step(void) {
	// From: Req1Batch158functionizing
	...
	// From: Req2Batch158functionizing
	...
	// From: Req3Batch158functionizing
	if (var_1_7 > var_1_9) {
		var_1_18 = var_1_20;
	}


	// From: Req4Batch158functionizing
	if (var_1_2) {
		functionized0(var_1_17, var_1_14, -256);
	}


	// From: Req5Batch158functionizing
	var_1_22 = ((var_1_2 && var_1_23) || functionized1(var_1_24));


	// From: Req6Batch158functionizing
	if (var_1_5 || (var_1_17 < var_1_21)) {
		var_1_25 = var_1_14;
	} else {
		functionized2(var_1_15, var_1_26);
	}


	// From: Req7Batch158functionizing
	if (functionized3(var_1_18)) {
		var_1_27 = var_1_21;
	}
}
