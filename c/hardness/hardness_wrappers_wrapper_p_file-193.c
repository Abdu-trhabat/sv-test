...
void step(void) {
	...
	if ((*(var_1_2_Pointer)) == stepLocal_0) {
		if (stepLocal_1 > (max ((- (*(var_1_3_Pointer))) , (*(var_1_4_Pointer))))) {
	...
	// From: Req4Batch193Wrapper_P
	(*(var_1_13_Pointer)) = 4;


	// From: Req5Batch193Wrapper_P
	(*(var_1_14_Pointer)) = (*(var_1_13_Pointer));


	// From: Req2Batch193Wrapper_P
	if ((*(var_1_6_Pointer))) {
		(*(var_1_5_Pointer)) = ((*(var_1_14_Pointer)) + (max ((min ((*(var_1_1_Pointer)) , (*(var_1_13_Pointer)))) , last_1_var_1_5)));
	}


	// From: Req3Batch193Wrapper_P
...
int property(void) {
	return ((((((*(var_1_2_Pointer)) == (*(var_1_3_Pointer))) ? (((*(var_1_2_Pointer)) > (max ((- (*(var_1_3_Pointer))) , (*(var_1_4_Pointer))))) ? ((((*(var_1_2_Pointer)) * ((*(var_1_4_Pointer)) * -5)) > (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed short int) (*(var_1_3_Pointer)))) : 1) : ((*(var_1_1_Pointer)) == ((signed short int) (*(var_1_2_Pointer))))) : ((*(var_1_1_Pointer)) == ((signed short int) (*(var_1_4_Pointer))))) && ((*(var_1_6_Pointer)) ? ((*(var_1_5_Pointer)) == ((signed long int) ((*(var_1_14_Pointer)) + (max ((min ((*(var_1_1_Pointer)) , (*(var_1_13_Pointer)))) , last_1_var_1_5))))) : 1)) && (((*(var_1_13_Pointer)) > 64) ? ((*(var_1_7_Pointer)) == ((double) ((*(var_1_8_Pointer)) - (*(var_1_9_Pointer))))) : ((16u == ((*(var_1_13_Pointer)) / (*(var_1_10_Pointer)))) ? ((*(var_1_7_Pointer)) == ((double) ((*(var_1_11_Pointer)) + (*(var_1_12_Pointer))))) : ((*(var_1_7_Pointer)) == ((double) (*(var_1_11_Pointer))))))) && ((*(var_1_13_Pointer)) == ((signed short int) 4))) && ((*(var_1_14_Pointer)) == ((signed short int) (*(var_1_13_Pointer))))
;
}
int main(void) {
	isInitial = 1;
