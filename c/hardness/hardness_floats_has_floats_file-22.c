...
void step(void) {
	...
	if (var_1_6 == var_1_1) {
		...
		var_1_7 = (((max (var_1_9 , var_1_10)) + 32.0f) - var_1_8);
	}
...
int property(void) {
	return (((((last_1_var_1_5 == last_1_var_1_1) ? (var_1_1 == ((signed short int) (last_1_var_1_5 + -16))) : (var_1_4 ? (var_1_1 == ((signed short int) last_1_var_1_1)) : 1)) && (var_1_4 ? (var_1_5 == ((unsigned short int) var_1_1)) : ((var_1_1 <= var_1_13) ? (var_1_5 == ((unsigned short int) (max (last_1_var_1_5 , (var_1_6 - 8))))) : 1))) && ((var_1_6 == var_1_1) ? (var_1_7 == ((float) (var_1_8 - 2.0f))) : (var_1_7 == ((float) (((max (var_1_9 , var_1_10)) + 32.0f) - var_1_8))))) && ((var_1_9 <= var_1_7) ? (var_1_11 == ((unsigned char) var_1_12)) : 1)) && (((- (var_1_11 / var_1_6)) >= last_1_var_1_13) ? (var_1_13 == ((signed long int) (var_1_11 - var_1_1))) : (var_1_13 == ((signed long int) var_1_1)))
;
}
int main(void) {
	isInitial = 1;
