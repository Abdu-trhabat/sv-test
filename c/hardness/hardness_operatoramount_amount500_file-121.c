...
void step(void) {
	...
	// From: Req18Batch121Amount500
	if (! var_1_56) {
		var_1_66 = var_1_16;
	}


	// From: Req34Batch121Amount500
	...
	// From: Req6Batch121Amount500
	if (var_1_89) {
		var_1_37 = (min ((var_1_31 + 1.0000000000000075E14) , (max (var_1_33 , var_1_30))));
	}


	// From: Req7Batch121Amount500
	if (-50 > var_1_15) {
		var_1_38 = (! var_1_39);
	} else {
	...
	// From: Req1Batch121Amount500
	if ((var_1_37 / (min (var_1_3 , var_1_4))) <= (var_1_37 / (min (var_1_6 , var_1_7)))) {
		if (var_1_38) {
	...
	// From: Req10Batch121Amount500
	if (var_1_30 > (min ((var_1_31 * var_1_32) , var_1_7))) {
		var_1_46 = var_1_44;
	}


	// From: Req12Batch121Amount500
	...
	// From: Req16Batch121Amount500
	if (var_1_38) {
		if (! var_1_38) {
			if (var_1_37 <= (- (abs (var_1_52)))) {
				var_1_59 = ((min (var_1_22 , var_1_43)) + (var_1_21 + var_1_60));
			} else {
				var_1_59 = ((var_1_44 + (var_1_61 + var_1_62)) - var_1_63);
			}
		} else {
			var_1_59 = ((var_1_21 + var_1_60) + (abs (var_1_64)));
		}
	} else {
		var_1_59 = (min ((16 + var_1_21) , (var_1_36 - var_1_62)));
	}


	// From: Req21Batch121Amount500
	if (var_1_57) {
		var_1_72 = (abs (var_1_60 + var_1_35));
	} else {
		var_1_72 = (max (((max (var_1_35 , var_1_21)) + var_1_20) , var_1_70));
	}


	// From: Req22Batch121Amount500
	var_1_73 = (var_1_62 + var_1_22);


	// From: Req23Batch121Amount500
	var_1_74 = ((min ((abs (var_1_13)) , var_1_44)) + var_1_68);


	// From: Req24Batch121Amount500
	if (var_1_32 < var_1_33) {
		var_1_75 = ((var_1_76 - (var_1_74 + var_1_77)) - var_1_15);
	}


	// From: Req25Batch121Amount500
	var_1_78 = ((max ((max (var_1_25 , 4109290628u)) , var_1_76)) - (min ((max (var_1_74 , var_1_46)) , var_1_13)));


	// From: Req27Batch121Amount500
	signed long int stepLocal_16 = (var_1_44 - var_1_22) - (max (5 , var_1_64));
	if (stepLocal_16 > var_1_36) {
		var_1_80 = (var_1_50 + var_1_53);
	} else {
		var_1_80 = (min (var_1_34 , var_1_33));
	}


	// From: Req31Batch121Amount500
	if (var_1_53 >= 7.4f) {
		var_1_85 = ((min (var_1_62 , var_1_43)) + (max (var_1_21 , var_1_22)));
	} else {
		var_1_85 = (var_1_62 + var_1_86);
	}


	// From: Req33Batch121Amount500
	unsigned long int stepLocal_21 = max (var_1_66 , var_1_77);
	...
	if ((var_1_25 - var_1_1) == stepLocal_21) {
		...
		var_1_88 = (max (var_1_61 , var_1_60));
	}


	// From: Req37Batch121Amount500
	var_1_94 = var_1_21;


	// From: Req38Batch121Amount500
	if (var_1_56) {
		var_1_95 = 64;
	}


	// From: Req39Batch121Amount500
	var_1_96 = var_1_63;


	// From: Req40Batch121Amount500
	if (var_1_54) {
		var_1_97 = 1000000000;
	} else {
		var_1_97 = var_1_71;
	...
	// From: Req41Batch121Amount500
	var_1_98 = var_1_22;


	// From: Req43Batch121Amount500
	if (var_1_41) {
		var_1_100 = var_1_61;
	} else {
		var_1_100 = var_1_70;
	...
	// From: Req45Batch121Amount500
	var_1_102 = var_1_49;


	// From: Req46Batch121Amount500
	if (var_1_37 >= (min (var_1_24 , (var_1_31 - var_1_52)))) {
		if (var_1_66 < 16) {
			var_1_103 = var_1_22;
		}
	} else {
	...
	// From: Req3Batch121Amount500
	if (var_1_38) {
		if ((var_1_37 + (var_1_7 * var_1_4)) >= var_1_37) {
			var_1_23 = (abs (min (var_1_21 , (abs (var_1_18)))));
		} else {
	...
	// From: Req29Batch121Amount500
	unsigned char stepLocal_19 = var_1_40;
	unsigned char stepLocal_18 = var_1_38;
	if (var_1_56) {
		var_1_82 = (max (var_1_70 , ((min (var_1_44 , var_1_64)) + 25u)));
	} else {
		if (((min (var_1_37 , var_1_3)) > var_1_52) || stepLocal_18) {
			if (stepLocal_19 || (last_1_var_1_82 != var_1_36)) {
				var_1_82 = (var_1_76 - (16u + var_1_44));
			}
		} else {
			var_1_82 = (min ((abs (var_1_15 + var_1_71)) , var_1_9));
		}
	}


	// From: Req4Batch121Amount500
	unsigned long int stepLocal_4 = var_1_23;
	if ((abs (var_1_27)) >= stepLocal_4) {
		var_1_26 = (max ((min ((max (var_1_28 , var_1_29)) , 32.5f)) , (var_1_30 + (var_1_31 - var_1_32))));
	} else {
		if (var_1_54) {
			var_1_26 = ((max (var_1_31 , (var_1_32 + 64.75f))) - (var_1_33 - var_1_34));
		} else {
			var_1_26 = (abs (min (var_1_34 , 128.5f)));
		}
	}


	// From: Req20Batch121Amount500
	if (var_1_14 > ((var_1_75 + var_1_10) % (max (var_1_36 , var_1_62)))) {
		if (var_1_16 <= var_1_23) {
			if (var_1_41) {
				var_1_69 = ((abs (var_1_70 + var_1_71)) - 128);
			}
		}
	}


	// From: Req42Batch121Amount500
	if (var_1_89) {
		var_1_99 = var_1_82;
	} else {
		var_1_99 = 256u;
	...
	// From: Req13Batch121Amount500
	if (var_1_40) {
		var_1_55 = (min (var_1_46 , var_1_100));
	} else {
		var_1_55 = (var_1_25 - var_1_10);
	}


	// From: Req15Batch121Amount500
	if (var_1_96 != (var_1_44 + 1)) {
		if (((min (var_1_31 , var_1_7)) != var_1_3) && (var_1_27 > var_1_9)) {
			var_1_58 = (var_1_22 + var_1_43);
		}
	}


	// From: Req17Batch121Amount500
	signed long int stepLocal_13 = var_1_14;
	signed long int stepLocal_12 = var_1_61 & var_1_16;
	if (var_1_27 >= stepLocal_13) {
		if (var_1_38) {
			if (stepLocal_12 >= (var_1_55 * (max (var_1_13 , var_1_10)))) {
				var_1_65 = (min (var_1_62 , var_1_63));
			} else {
			...
			var_1_65 = ((abs (var_1_63)) + var_1_44);
		}
	} else {
	...
	if (var_1_69 <= 500) {
		...
		if (var_1_38) {
			var_1_67 = (abs (var_1_15 - (var_1_68 - var_1_19)));
		}
	}


	// From: Req32Batch121Amount500
	if (var_1_32 >= var_1_33) {
	...
	// From: Req11Batch121Amount500
	if ((-64 * var_1_59) < (var_1_43 - var_1_48)) {
		if (50.2 > var_1_33) {
			if (var_1_89) {
				var_1_47 = (var_1_33 - (var_1_31 + (var_1_49 - var_1_50)));
			} else {
				var_1_47 = ((min (var_1_49 , var_1_32)) + var_1_31);
			}
		} else {
			if (var_1_28 <= var_1_37) {
				if (16 > (var_1_55 / (min (var_1_44 , var_1_13)))) {
					var_1_47 = (var_1_50 + 25.75f);
				} else {
					var_1_47 = (min (var_1_49 , (max (var_1_50 , (var_1_32 - var_1_34)))));
				}
			}
		}
	} else {
		if (var_1_41) {
			...
			var_1_47 = ((max (var_1_50 , var_1_31)) + var_1_53);
		}
	}


	// From: Req26Batch121Amount500
	unsigned long int stepLocal_15 = var_1_82;
	unsigned char stepLocal_14 = var_1_21;
	if (var_1_76 > stepLocal_14) {
		if ((min ((var_1_24 - var_1_49) , (- var_1_28))) >= (max (var_1_4 , var_1_26))) {
			var_1_79 = (min ((max (var_1_62 , var_1_22)) , var_1_15));
		} else {
			var_1_79 = (max (var_1_87 , var_1_19));
		}
	} else {
	...
	// From: Req28Batch121Amount500
	unsigned char stepLocal_17 = var_1_79 < 100;
	if (stepLocal_17 || (var_1_15 > (var_1_20 - last_1_var_1_81))) {
		var_1_81 = (max (var_1_36 , var_1_21));
	} else {
		if (((var_1_49 + var_1_91) + (var_1_102 / var_1_3)) <= var_1_31) {
			var_1_81 = ((1 + (max (var_1_61 , var_1_21))) + last_1_var_1_81);
		}
	}


	// From: Req30Batch121Amount500
	if ((min ((var_1_19 / var_1_70) , var_1_16)) <= (var_1_1 / var_1_68)) {
		if ((var_1_79 / (min (var_1_43 , var_1_22))) < (var_1_25 - (abs (var_1_77)))) {
			if (((- var_1_18) / var_1_62) >= var_1_82) {
				var_1_84 = (min (var_1_60 , 8));
			} else {
				if ((var_1_22 << var_1_70) <= (var_1_1 / var_1_62)) {
					var_1_84 = (max (var_1_61 , ((var_1_44 - 32) - var_1_21)));
				} else {
		...
		if ((var_1_11 % var_1_19) <= var_1_62) {
			var_1_84 = (min (var_1_62 , var_1_22));
		} else {
			if (! var_1_89) {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((var_1_37 / (min (var_1_3 , var_1_4))) <= (var_1_37 / (min (var_1_6 , var_1_7)))) ? (var_1_38 ? (var_1_1 == ((unsigned long int) (var_1_9 - (max (var_1_10 , var_1_11))))) : (var_1_1 == ((unsigned long int) (min (var_1_9 , var_1_11))))) : (var_1_1 == ((unsigned long int) (max (var_1_11 , var_1_9))))) && ((var_1_99 <= var_1_10) ? (var_1_12 == ((signed long int) ((var_1_13 - (var_1_14 - var_1_15)) - var_1_16))) : (var_1_54 ? ((! (var_1_38 || (var_1_99 <= var_1_13))) ? (((var_1_9 + var_1_99) > (var_1_16 ^ var_1_10)) ? ((var_1_38 || ((var_1_11 * var_1_10) > var_1_16)) ? (var_1_12 == ((signed long int) ((min (var_1_14 , var_1_13)) - (var_1_15 + var_1_18)))) : 1) : ((((var_1_19 - var_1_20) | (var_1_10 * var_1_11)) >= (var_1_15 >> (var_1_21 + var_1_22))) ? (var_1_12 == ((signed long int) ((var_1_22 + var_1_20) - var_1_19))) : 1)) : (var_1_12 == ((signed long int) var_1_21))) : (var_1_12 == ((signed long int) var_1_15))))) && (var_1_38 ? (((var_1_37 + (var_1_7 * var_1_4)) >= var_1_37) ? (var_1_23 == ((unsigned long int) (abs (min (var_1_21 , (abs (var_1_18))))))) : ((var_1_4 > (var_1_37 + (var_1_24 - 999.4))) ? (var_1_23 == ((unsigned long int) (5u + var_1_22))) : (var_1_23 == ((unsigned long int) (var_1_25 - var_1_19))))) : 1)) && (((abs (var_1_27)) >= var_1_23) ? (var_1_26 == ((float) (max ((min ((max (var_1_28 , var_1_29)) , 32.5f)) , (var_1_30 + (var_1_31 - var_1_32)))))) : (var_1_54 ? (var_1_26 == ((float) ((max (var_1_31 , (var_1_32 + 64.75f))) - (var_1_33 - var_1_34)))) : (var_1_26 == ((float) (abs (min (var_1_34 , 128.5f)))))))) && ((var_1_19 > (max (var_1_15 , var_1_16))) ? ((((var_1_16 % var_1_22) * (- 5)) != (var_1_15 + var_1_19)) ? (var_1_35 == ((unsigned char) (var_1_36 - var_1_21))) : 1) : (var_1_35 == ((unsigned char) (min (var_1_22 , (min (var_1_21 , var_1_36)))))))) && (var_1_89 ? (var_1_37 == ((double) (min ((var_1_31 + 1.0000000000000075E14) , (max (var_1_33 , var_1_30)))))) : 1)) && ((-50 > var_1_15) ? (var_1_38 == ((unsigned char) (! var_1_39))) : ((var_1_21 < var_1_25) ? ((var_1_39 || (last_1_var_1_80 > (var_1_32 / var_1_3))) ? ((var_1_15 >= var_1_36) ? (((var_1_25 - var_1_18) < var_1_36) ? (var_1_38 == ((unsigned char) (! (var_1_40 || (last_1_var_1_89 && var_1_41))))) : (var_1_38 == ((unsigned char) (! var_1_39)))) : (var_1_38 == ((unsigned char) (! ((var_1_20 > 10) && (var_1_41 && var_1_40)))))) : 1) : 1))) && ((4 < (var_1_18 / var_1_19)) ? (var_1_42 == ((signed char) (((32 + var_1_43) - var_1_21) - (var_1_44 - var_1_22)))) : 1)) && ((var_1_20 < var_1_22) ? (var_1_40 ? (var_1_45 == ((unsigned short int) var_1_21)) : 1) : (var_1_45 == ((unsigned short int) 8)))) && ((var_1_30 > (min ((var_1_31 * var_1_32) , var_1_7))) ? (var_1_46 == ((unsigned short int) var_1_44)) : 1)) && (((-64 * var_1_59) < (var_1_43 - var_1_48)) ? ((50.2 > var_1_33) ? (var_1_89 ? (var_1_47 == ((float) (var_1_33 - (var_1_31 + (var_1_49 - var_1_50))))) : (var_1_47 == ((float) ((min (var_1_49 , var_1_32)) + var_1_31)))) : ((var_1_28 <= var_1_37) ? ((16 > (var_1_55 / (min (var_1_44 , var_1_13)))) ? (var_1_47 == ((float) (var_1_50 + 25.75f))) : (var_1_47 == ((float) (min (var_1_49 , (max (var_1_50 , (var_1_32 - var_1_34)))))))) : 1)) : (var_1_41 ? (var_1_54 ? (var_1_47 == ((float) ((var_1_50 + (var_1_52 - var_1_53)) + var_1_30))) : 1) : (var_1_47 == ((float) ((max (var_1_50 , var_1_31)) + var_1_53)))))) && ((var_1_25 > var_1_10) ? (var_1_54 == ((unsigned char) (var_1_40 || var_1_41))) : ((((var_1_44 - var_1_21) * var_1_15) >= (var_1_48 | var_1_20)) ? (var_1_54 == ((unsigned char) var_1_40)) : (var_1_54 == ((unsigned char) var_1_39))))) && (var_1_40 ? (var_1_55 == ((unsigned long int) (min (var_1_46 , var_1_100)))) : (var_1_55 == ((unsigned long int) (var_1_25 - var_1_10))))) && (((last_1_var_1_55 / var_1_22) < (~ last_1_var_1_66)) ? (var_1_56 == ((unsigned char) (var_1_41 || (! var_1_39)))) : ((var_1_19 < last_1_var_1_67) ? (var_1_56 == ((unsigned char) (var_1_39 && var_1_57))) : 1))) && ((var_1_96 != (var_1_44 + 1)) ? ((((min (var_1_31 , var_1_7)) != var_1_3) && (var_1_27 > var_1_9)) ? (var_1_58 == ((signed char) (var_1_22 + var_1_43))) : 1) : 1)) && (var_1_38 ? ((! var_1_38) ? ((var_1_37 <= (- (abs (var_1_52)))) ? (var_1_59 == ((unsigned char) ((min (var_1_22 , var_1_43)) + (var_1_21 + var_1_60)))) : (var_1_59 == ((unsigned char) ((var_1_44 + (var_1_61 + var_1_62)) - var_1_63)))) : (var_1_59 == ((unsigned char) ((var_1_21 + var_1_60) + (abs (var_1_64)))))) : (var_1_59 == ((unsigned char) (min ((16 + var_1_21) , (var_1_36 - var_1_62))))))) && ((var_1_27 >= var_1_14) ? (var_1_38 ? (((var_1_61 & var_1_16) >= (var_1_55 * (max (var_1_13 , var_1_10)))) ? (var_1_65 == ((unsigned char) (min (var_1_62 , var_1_63)))) : ((var_1_31 <= var_1_37) ? (var_1_65 == ((unsigned char) (128 - var_1_60))) : (var_1_65 == ((unsigned char) (128 - var_1_43))))) : (var_1_65 == ((unsigned char) ((abs (var_1_63)) + var_1_44)))) : (var_1_65 == ((unsigned char) (var_1_36 - var_1_21))))) && ((! var_1_56) ? (var_1_66 == ((unsigned long int) var_1_16)) : 1)) && ((var_1_69 <= 500) ? ((var_1_41 || var_1_40) ? (var_1_67 == ((signed long int) (var_1_19 - last_1_var_1_67))) : 1) : (var_1_38 ? (var_1_67 == ((signed long int) (abs (var_1_15 - (var_1_68 - var_1_19))))) : 1))) && ((var_1_14 > ((var_1_75 + var_1_10) % (max (var_1_36 , var_1_62)))) ? ((var_1_16 <= var_1_23) ? (var_1_41 ? (var_1_69 == ((unsigned short int) ((abs (var_1_70 + var_1_71)) - 128))) : 1) : 1) : 1)) && (var_1_57 ? (var_1_72 == ((unsigned short int) (abs (var_1_60 + var_1_35)))) : (var_1_72 == ((unsigned short int) (max (((max (var_1_35 , var_1_21)) + var_1_20) , var_1_70)))))) && (var_1_73 == ((signed char) (var_1_62 + var_1_22)))) && (var_1_74 == ((unsigned long int) ((min ((abs (var_1_13)) , var_1_44)) + var_1_68)))) && ((var_1_32 < var_1_33) ? (var_1_75 == ((unsigned long int) ((var_1_76 - (var_1_74 + var_1_77)) - var_1_15))) : 1)) && (var_1_78 == ((unsigned long int) ((max ((max (var_1_25 , 4109290628u)) , var_1_76)) - (min ((max (var_1_74 , var_1_46)) , var_1_13)))))) && ((var_1_76 > var_1_21) ? (((min ((var_1_24 - var_1_49) , (- var_1_28))) >= (max (var_1_4 , var_1_26))) ? (var_1_79 == ((unsigned long int) (min ((max (var_1_62 , var_1_22)) , var_1_15)))) : (var_1_79 == ((unsigned long int) (max (var_1_87 , var_1_19))))) : (((var_1_75 * var_1_62) > var_1_82) ? (var_1_79 == ((unsigned long int) (var_1_76 - 10u))) : 1))) && ((((var_1_44 - var_1_22) - (max (5 , var_1_64))) > var_1_36) ? (var_1_80 == ((float) (var_1_50 + var_1_53))) : (var_1_80 == ((float) (min (var_1_34 , var_1_33)))))) && (((var_1_79 < 100) || (var_1_15 > (var_1_20 - last_1_var_1_81))) ? (var_1_81 == ((signed short int) (max (var_1_36 , var_1_21)))) : ((((var_1_49 + var_1_91) + (var_1_102 / var_1_3)) <= var_1_31) ? (var_1_81 == ((signed short int) ((1 + (max (var_1_61 , var_1_21))) + last_1_var_1_81))) : 1))) && (var_1_56 ? (var_1_82 == ((unsigned long int) (max (var_1_70 , ((min (var_1_44 , var_1_64)) + 25u))))) : ((((min (var_1_37 , var_1_3)) > var_1_52) || var_1_38) ? ((var_1_40 || (last_1_var_1_82 != var_1_36)) ? (var_1_82 == ((unsigned long int) (var_1_76 - (16u + var_1_44)))) : 1) : (var_1_82 == ((unsigned long int) (min ((abs (var_1_15 + var_1_71)) , var_1_9))))))) && (((min ((var_1_19 / var_1_70) , var_1_16)) <= (var_1_1 / var_1_68)) ? (((var_1_79 / (min (var_1_43 , var_1_22))) < (var_1_25 - (abs (var_1_77)))) ? ((((- var_1_18) / var_1_62) >= var_1_82) ? (var_1_84 == ((signed char) (min (var_1_60 , 8)))) : (((var_1_22 << var_1_70) <= (var_1_1 / var_1_62)) ? (var_1_84 == ((signed char) (max (var_1_61 , ((var_1_44 - 32) - var_1_21))))) : (var_1_84 == ((signed char) (var_1_22 - (var_1_43 + var_1_60)))))) : (var_1_84 == ((signed char) (var_1_22 + (var_1_43 - var_1_62))))) : (((var_1_11 % var_1_19) <= var_1_62) ? (var_1_84 == ((signed char) (min (var_1_62 , var_1_22)))) : ((! var_1_89) ? (var_1_84 == ((signed char) ((var_1_21 - var_1_62) + var_1_43))) : 1)))) && ((var_1_53 >= 7.4f) ? (var_1_85 == ((signed char) ((min (var_1_62 , var_1_43)) + (max (var_1_21 , var_1_22))))) : (var_1_85 == ((signed char) (var_1_62 + var_1_86))))) && ((var_1_32 >= var_1_33) ? (var_1_87 == ((signed short int) ((var_1_43 + var_1_61) - (var_1_60 + var_1_99)))) : (var_1_87 == ((signed short int) var_1_74)))) && (((var_1_25 - var_1_1) == (max (var_1_66 , var_1_77))) ? ((var_1_56 && var_1_41) ? (var_1_88 == ((unsigned char) (var_1_22 + (var_1_44 - var_1_21)))) : (var_1_88 == ((unsigned char) (10 + ((var_1_61 - var_1_21) + var_1_22))))) : (var_1_88 == ((unsigned char) (max (var_1_61 , var_1_60)))))) && ((! last_1_var_1_38) ? (var_1_39 ? ((var_1_20 >= last_1_var_1_79) ? (var_1_89 == ((unsigned char) ((! var_1_57) || var_1_40))) : (((var_1_10 ^ var_1_62) <= var_1_9) ? (var_1_89 == ((unsigned char) var_1_57)) : (var_1_89 == ((unsigned char) (last_1_var_1_38 && (var_1_41 || var_1_40)))))) : (var_1_89 == ((unsigned char) (var_1_40 && (var_1_41 || var_1_90))))) : 1)) && (((var_1_33 * var_1_52) != (var_1_26 * var_1_37)) ? (var_1_91 == ((float) var_1_53)) : (var_1_91 == ((float) var_1_33)))) && (var_1_90 ? (var_1_93 == ((signed long int) var_1_63)) : (var_1_93 == ((signed long int) var_1_58)))) && (var_1_94 == ((unsigned char) var_1_21))) && (var_1_56 ? (var_1_95 == ((unsigned short int) 64)) : 1)) && (var_1_96 == ((unsigned short int) var_1_63))) && (var_1_54 ? (var_1_97 == ((signed long int) 1000000000)) : (var_1_97 == ((signed long int) var_1_71)))) && (var_1_98 == ((signed char) var_1_22))) && (var_1_89 ? (var_1_99 == ((unsigned long int) var_1_82)) : (var_1_99 == ((unsigned long int) 256u)))) && (var_1_41 ? (var_1_100 == ((unsigned short int) var_1_61)) : (var_1_100 == ((unsigned short int) var_1_70)))) && (var_1_54 ? (var_1_101 == ((signed char) var_1_61)) : (var_1_101 == ((signed char) var_1_62)))) && (var_1_102 == ((float) var_1_49))) && ((var_1_37 >= (min (var_1_24 , (var_1_31 - var_1_52)))) ? ((var_1_66 < 16) ? (var_1_103 == ((unsigned short int) var_1_22)) : 1) : (var_1_103 == ((unsigned short int) 25)))
;
}
int main(void) {
	isInitial = 1;
