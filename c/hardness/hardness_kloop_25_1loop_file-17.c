...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1725_1loop.c", 13, "reach_error"); }
...
int property(void) {
	return (((var_1_18 ? (var_1_1 == ((double) (var_1_3 + (min (var_1_4 , (49.5 + var_1_5)))))) : 1) && ((((abs (var_1_7)) - var_1_8) < var_1_9) ? (var_1_6 == ((signed short int) var_1_10)) : 1)) && (((var_1_5 * (- var_1_3)) != ((var_1_4 / 255.25) / (min (var_1_12 , var_1_13)))) ? (var_1_11 == ((signed long int) (max ((var_1_14 - var_1_15) , (var_1_16 - var_1_17))))) : 1)) && ((((var_1_19 >> var_1_20) * var_1_11) <= var_1_10) ? (var_1_18 == ((unsigned char) var_1_21)) : 1)
;
}
int main(void) {
	isInitial = 1;
