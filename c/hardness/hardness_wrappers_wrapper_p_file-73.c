...
void step(void) {
	...
	if ((*(var_1_6_Pointer)) && stepLocal_2) {
		(*(var_1_8_Pointer)) = (min ((*(var_1_10_Pointer)) , ((min (64 , (*(var_1_11_Pointer)))) - ((*(var_1_12_Pointer)) + (*(var_1_13_Pointer))))));
	} else {
	...
	if (((*(var_1_13_Pointer)) <= (*(var_1_12_Pointer))) || stepLocal_3) {
		(*(var_1_14_Pointer)) = (min ((*(var_1_7_Pointer)) , (*(var_1_15_Pointer))));
	} else {
	...
	unsigned long int stepLocal_0 = max ((*(var_1_3_Pointer)) , ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer))));
