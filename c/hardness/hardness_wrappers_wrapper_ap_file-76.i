...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch76Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_0 = (- 5) + (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer));
 ...
 if (stepLocal_1 <= (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) {
