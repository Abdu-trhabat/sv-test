...
void step(void) {
 ...
 var_1_32 = ((((var_1_19) < (25u)) ? (var_1_19) : (25u)));
 ...
 if (var_1_16) {
  if ((4 + var_1_22) <= stepLocal_6) {
   var_1_35 = (((((var_1_30) > ((var_1_36 - var_1_37))) ? (var_1_30) : ((var_1_36 - var_1_37)))) - (var_1_38 - (var_1_39 - var_1_40)));
  } else {
   var_1_35 = var_1_30;
  }
 } else {
 ...
 if (! var_1_16) {
  if (var_1_35 < ((((var_1_28) < ((var_1_31 - var_1_30))) ? (var_1_28) : ((var_1_31 - var_1_30))))) {
   if (var_1_6) {
    var_1_34 = var_1_3;
   }
  } else {
 ...
 if (var_1_34 >= var_1_20) {
  if (var_1_16) {
   if (var_1_6) {
    ...
    var_1_27 = ((((var_1_30 - var_1_31) < 0 ) ? -(var_1_30 - var_1_31) : (var_1_30 - var_1_31)));
   }
  }
 }
 if ((var_1_24 / (var_1_3 + var_1_4)) == ((((8) < (var_1_34)) ? (8) : (var_1_34)))) {
 ...
 if (var_1_4 >= stepLocal_0) {
  if (var_1_35 > var_1_1) {
   var_1_11 = ((((var_1_23) > (var_1_3)) ? (var_1_23) : (var_1_3)));
  } else {
   var_1_11 = var_1_12;
  }
 } else {
 ...
 if (stepLocal_1 <= (var_1_14 - var_1_15)) {
  if (var_1_6 || stepLocal_2) {
   var_1_13 = ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)));
  }
 } else {
...
int property(void) {
 return (((((((((((var_1_24 / (var_1_3 + var_1_4)) == ((((8) < (var_1_34)) ? (8) : (var_1_34)))) ? (((var_1_34 > var_1_24) && var_1_6) ? (((var_1_35 + var_1_27) != var_1_35) ? (var_1_1 == ((float) 8.6f)) : 1) : (((var_1_24 & var_1_34) != var_1_4) ? (var_1_6 ? (var_1_1 == ((float) var_1_10)) : 1) : (var_1_1 == ((float) var_1_10)))) : 1) && ((var_1_4 >= (var_1_32 * var_1_23)) ? ((var_1_35 > var_1_1) ? (var_1_11 == ((signed short int) ((((var_1_23) > (var_1_3)) ? (var_1_23) : (var_1_3))))) : (var_1_11 == ((signed short int) var_1_12))) : (var_1_11 == ((signed short int) var_1_23)))) && ((var_1_4 <= (var_1_14 - var_1_15)) ? ((var_1_6 || var_1_16) ? (var_1_13 == ((unsigned char) ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))))) : 1) : (((var_1_17 - 64.25f) < (- (var_1_10 * var_1_27))) ? (var_1_13 == ((unsigned char) (((var_1_18 + var_1_19) - var_1_20) - (var_1_21 + var_1_22)))) : 1))) && (((var_1_18 * var_1_19) >= var_1_4) ? ((var_1_16 || (! var_1_6)) ? (var_1_23 == ((unsigned char) var_1_18)) : (var_1_23 == ((unsigned char) var_1_22))) : (var_1_23 == ((unsigned char) var_1_4)))) && (((var_1_32 / var_1_18) > last_1_var_1_24) ? ((var_1_16 || var_1_6) ? (var_1_24 == ((signed short int) ((var_1_15 - (var_1_26 - 1)) + var_1_19))) : (var_1_24 == ((signed short int) var_1_23))) : (var_1_24 == ((signed short int) var_1_26)))) && ((var_1_34 >= var_1_20) ? (var_1_16 ? (var_1_6 ? (var_1_27 == ((double) (var_1_28 + var_1_29))) : (var_1_27 == ((double) ((((var_1_30 - var_1_31) < 0 ) ? -(var_1_30 - var_1_31) : (var_1_30 - var_1_31)))))) : 1) : 1)) && (var_1_32 == ((unsigned long int) ((((var_1_19) < (25u)) ? (var_1_19) : (25u)))))) && ((var_1_20 > var_1_22) ? (var_1_33 == ((float) (var_1_30 - var_1_31))) : 1)) && ((! var_1_16) ? ((var_1_35 < ((((var_1_28) < ((var_1_31 - var_1_30))) ? (var_1_28) : ((var_1_31 - var_1_30))))) ? (var_1_6 ? (var_1_34 == ((unsigned long int) var_1_3)) : 1) : (var_1_34 == ((unsigned long int) 0u))) : 1)) && (var_1_16 ? (((4 + var_1_22) <= var_1_21) ? (var_1_35 == ((float) (((((var_1_30) > ((var_1_36 - var_1_37))) ? (var_1_30) : ((var_1_36 - var_1_37)))) - (var_1_38 - (var_1_39 - var_1_40))))) : (var_1_35 == ((float) var_1_30))) : (var_1_35 == ((float) var_1_36)))
;
}
int main(void) {
 isInitial = 1;
