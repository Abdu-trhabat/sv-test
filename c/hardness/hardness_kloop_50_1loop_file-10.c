...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1050_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch1050_1loop
	if (var_1_20) {
		var_1_14 = ((abs (var_1_4)) - (max (var_1_5 , (var_1_16 - var_1_11))));
	}


	// From: Req5Batch1050_1loop
	signed long int stepLocal_5 = max (var_1_13 , (~ var_1_5));
	unsigned short int stepLocal_4 = var_1_14;
	if (stepLocal_5 >= (min (var_1_18 , var_1_14))) {
...
int property(void) {
	return ((((((var_1_8 && var_1_20) ? (var_1_1 == ((unsigned short int) (((min (56892 , var_1_4)) - var_1_5) - (max (var_1_6 , var_1_7))))) : (((max (var_1_7 , var_1_5)) < var_1_6) ? (var_1_1 == ((unsigned short int) var_1_5)) : 1)) && (var_1_8 == ((unsigned char) (((var_1_7 >= var_1_5) && (var_1_4 >= last_1_var_1_1)) || var_1_9)))) && ((var_1_17 < var_1_6) ? (((var_1_6 != var_1_5) || var_1_9) ? (var_1_10 == ((signed short int) (((10000 - var_1_11) - var_1_5) + (abs (var_1_12))))) : (var_1_10 == ((signed short int) var_1_4))) : (var_1_10 == ((signed short int) var_1_13)))) && (var_1_20 ? (var_1_14 == ((unsigned short int) ((abs (var_1_4)) - (max (var_1_5 , (var_1_16 - var_1_11)))))) : 1)) && (((max (var_1_13 , (~ var_1_5))) >= (min (var_1_18 , var_1_14))) ? ((var_1_14 <= var_1_11) ? (var_1_17 == ((unsigned long int) var_1_5)) : (var_1_17 == ((unsigned long int) var_1_6))) : (var_1_17 == ((unsigned long int) var_1_19)))) && ((var_1_19 > var_1_18) ? (var_1_20 == ((unsigned char) (var_1_8 || (! var_1_21)))) : (var_1_20 == ((unsigned char) var_1_21)))
;
}
int main(void) {
	isInitial = 1;
