...
void functionized0(unsigned short int functionized0_localFunctionVar0, unsigned short int functionized0_localFunctionVar1, unsigned short int functionized0_localFunctionVar2) {
	var_1_8 = ((min (functionized0_localFunctionVar2 , functionized0_localFunctionVar1)) - functionized0_localFunctionVar0);
}
...
signed long int functionized3(signed short int functionized3_localFunctionVar0) {
	return (functionized3_localFunctionVar0 - (abs (var_1_21)));
}
...
void step(void) {
	// From: Req1Batch36functionizing
	if (var_1_2) {
		var_1_1 = (min ((max ((var_1_3 - var_1_4) , (min (var_1_5 , var_1_6)))) , var_1_7));
	}


	// From: Req2Batch36functionizing
	functionized0(var_1_11, var_1_10, var_1_9);


	// From: Req3Batch36functionizing
	if (var_1_2) {
		var_1_12 = (min ((var_1_3 - (var_1_13 - 128.68)) , var_1_7));
	}


	// From: Req4Batch36functionizing
	var_1_14 = var_1_6;


	// From: Req5Batch36functionizing
	functionized1(var_1_11, var_1_13);


	// From: Req6Batch36functionizing
	if (var_1_3 <= var_1_4) {
		var_1_16 = (min (var_1_6 , var_1_4));
	}


	// From: Req7Batch36functionizing
