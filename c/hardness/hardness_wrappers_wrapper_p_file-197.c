...
void step(void) {
	...
	// From: Req3Batch197Wrapper_P
	unsigned char stepLocal_1 = ((*(var_1_13_Pointer)) >> (*(var_1_14_Pointer))) > (*(var_1_3_Pointer));
	if (stepLocal_1 || (*(var_1_8_Pointer))) {
		(*(var_1_12_Pointer)) = ((abs (200 - (*(var_1_14_Pointer)))) - (*(var_1_15_Pointer)));
	}


	// From: Req1Batch197Wrapper_P
	if ((*(var_1_2_Pointer)) >= (*(var_1_3_Pointer))) {
		(*(var_1_1_Pointer)) = (min ((*(var_1_4_Pointer)) , (min ((*(var_1_5_Pointer)) , ((*(var_1_6_Pointer)) + (*(var_1_7_Pointer)))))));
	}


	// From: Req4Batch197Wrapper_P
	if ((*(var_1_14_Pointer)) > (max ((*(var_1_15_Pointer)) , (*(var_1_6_Pointer))))) {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) >= (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed short int) (min ((*(var_1_4_Pointer)) , (min ((*(var_1_5_Pointer)) , ((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))))))))) : 1) && ((! (*(var_1_9_Pointer))) ? (((*(var_1_4_Pointer)) < last_1_var_1_16) ? ((*(var_1_8_Pointer)) == ((unsigned char) (*(var_1_10_Pointer)))) : ((*(var_1_8_Pointer)) == ((unsigned char) ((*(var_1_10_Pointer)) && (*(var_1_11_Pointer)))))) : 1)) && (((((*(var_1_13_Pointer)) >> (*(var_1_14_Pointer))) > (*(var_1_3_Pointer))) || (*(var_1_8_Pointer))) ? ((*(var_1_12_Pointer)) == ((unsigned char) ((abs (200 - (*(var_1_14_Pointer)))) - (*(var_1_15_Pointer))))) : 1)) && (((*(var_1_14_Pointer)) > (max ((*(var_1_15_Pointer)) , (*(var_1_6_Pointer))))) ? ((*(var_1_16_Pointer)) == ((unsigned short int) (((*(var_1_17_Pointer)) - (*(var_1_14_Pointer))) - (*(var_1_15_Pointer))))) : (((*(var_1_15_Pointer)) < ((*(var_1_1_Pointer)) * (*(var_1_7_Pointer)))) ? ((*(var_1_16_Pointer)) == ((unsigned short int) (*(var_1_12_Pointer)))) : ((*(var_1_16_Pointer)) == ((unsigned short int) 8))))
;
}
int main(void) {
	isInitial = 1;
