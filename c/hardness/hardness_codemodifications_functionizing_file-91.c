...
double functionized0(double functionized0_localFunctionVar0, double functionized0_localFunctionVar1, double functionized0_localFunctionVar2) {
	return (max (functionized0_localFunctionVar0 , (functionized0_localFunctionVar2 + functionized0_localFunctionVar1)));
}
...
void step(void) {
	...
	// From: Req4Batch91functionizing
	var_1_16 = (max (var_1_6 , (var_1_8 - 8)));


	// From: Req5Batch91functionizing
	functionized2(var_1_18);


	// From: Req6Batch91functionizing
	if (var_1_4 < var_1_3) {
	...
	// From: Req7Batch91functionizing
	var_1_23 = var_1_3;


	// From: Req8Batch91functionizing
	functionized4(var_1_7);


	// From: Req9Batch91functionizing
	functionized5(var_1_6);


	// From: Req10Batch91functionizing
	functionized6();
}
