...
void step(void) {
	...
	// From: Req22Batch80Amount250
	if (last_1_var_1_13 <= ((var_1_40 + var_1_23) * var_1_39)) {
		var_1_57 = (var_1_18 - (min (var_1_26 , last_1_var_1_28)));
	} else {
	...
	if (! var_1_9) {
		if (last_1_var_1_53 < stepLocal_11) {
			var_1_45 = (min ((var_1_47 - var_1_24) , (abs (last_1_var_1_57))));
		}
	} else {
		if (! last_1_var_1_32) {
			var_1_45 = var_1_47;
	...
	if (var_1_11 <= -5) {
		var_1_52 = ((abs (min (var_1_24 , 25))) + var_1_50);
	}


	// From: Req23Batch80Amount250
	if (var_1_10) {
		var_1_58 = var_1_22;
	}


	// From: Req24Batch80Amount250
	if (last_1_var_1_59) {
		var_1_59 = var_1_33;
	} else {
		var_1_59 = var_1_9;
	...
	// From: Req25Batch80Amount250
	var_1_60 = (max (((var_1_22 + var_1_61) + var_1_62) , ((max (var_1_63 , var_1_64)) - 2)));


	// From: Req26Batch80Amount250
	var_1_65 = var_1_26;


	// From: Req27Batch80Amount250
	var_1_66 = var_1_27;
	...
	if (stepLocal_2 != (var_1_45 + (var_1_18 / 5u))) {
		if (var_1_13 < var_1_15) {
			if ((min ((var_1_14 / var_1_23) , (min (127.25f , var_1_7)))) <= var_1_20) {
				var_1_21 = (var_1_17 + var_1_22);
			} else {
				if ((var_1_24 - var_1_22) > stepLocal_3) {
					var_1_21 = ((max (var_1_25 , var_1_26)) - var_1_22);
				} else {
					var_1_21 = (max (var_1_24 , var_1_17));
				}
			}
		} else {
			var_1_21 = (max (var_1_18 , var_1_26));
		}
	} else {
	...
	unsigned long int stepLocal_6 = var_1_28 * (min (0 , -16));
	unsigned long int stepLocal_5 = var_1_28 + var_1_27;
	if (stepLocal_5 <= var_1_28) {
		var_1_29 = var_1_22;
	} else {
		if (1 != stepLocal_6) {
			var_1_29 = (min ((min ((min (var_1_25 , var_1_21)) , (min (var_1_12 , var_1_30)))) , (var_1_27 + var_1_24)));
		} else {
			var_1_29 = (min (var_1_21 , var_1_12));
		}
	}


	// From: Req13Batch80Amount250
	if ((var_1_18 * (var_1_11 + var_1_29)) > (min (-10 , var_1_35))) {
		var_1_43 = (abs (abs (var_1_16)));
	}
	...
	if (var_1_11 < var_1_45) {
		var_1_53 = (min (var_1_24 , var_1_22));
	} else {
		var_1_53 = (var_1_24 + (min (var_1_22 , (var_1_54 - var_1_55))));
	}
	...
	if (((max (8 , var_1_29)) / 16) > stepLocal_9) {
		if ((min (var_1_57 , (var_1_12 << var_1_57))) < stepLocal_10) {
			var_1_44 = (var_1_22 + var_1_24);
		} else {
			var_1_44 = (min (((var_1_24 + var_1_22) + 4) , -10000));
		}
	}


	// From: Req21Batch80Amount250
	unsigned long int stepLocal_15 = min (var_1_66 , var_1_11);
	if (stepLocal_15 <= (~ var_1_30)) {
		var_1_56 = (var_1_26 + (var_1_31 + var_1_54));
	} else {
		var_1_56 = (min (var_1_30 , (max ((abs (var_1_26)) , var_1_54))));
	}


	// From: Req2Batch80Amount250
	signed long int stepLocal_0 = var_1_57;
	if ((min (var_1_7 , var_1_43)) <= var_1_6) {
		if (1u < stepLocal_0) {
	...
	unsigned long int stepLocal_8 = max (8 , var_1_28);
	if (stepLocal_8 > var_1_57) {
		var_1_38 = (abs (min (var_1_7 , 16.4)));
	} else {
		if (var_1_16 > ((var_1_39 + var_1_40) - (var_1_41 + var_1_42))) {
			if (! (var_1_45 == var_1_56)) {
				var_1_38 = (min ((var_1_41 - (5.6 + var_1_16)) , var_1_39));
			}
		}
	}
	...
	if (((var_1_18 / 2) / var_1_22) < ((var_1_29 ^ var_1_56) / (min (var_1_35 , var_1_25)))) {
		if (var_1_30 == ((min (var_1_45 , var_1_28)) + var_1_18)) {
			var_1_34 = (abs (var_1_20));
		} else {
			var_1_34 = 0.64f;
		}
	}
...
int property(void) {
	return (((((((((((((((((((((((((((((~ var_1_56) + (var_1_56 + var_1_45)) <= var_1_45) ? (var_1_1 == ((float) (var_1_6 - var_1_7))) : 1) && (((min (var_1_7 , var_1_43)) <= var_1_6) ? ((1u < var_1_57) ? (var_1_8 == ((unsigned char) (var_1_9 && var_1_10))) : 1) : 1)) && (var_1_9 ? (var_1_11 == ((unsigned long int) 0u)) : (var_1_10 ? (var_1_11 == ((unsigned long int) (abs (8u + var_1_12)))) : ((var_1_6 < 127.5f) ? (var_1_11 == ((unsigned long int) var_1_12)) : 1)))) && ((var_1_7 != (last_1_var_1_38 * var_1_6)) ? (var_1_13 == ((double) (((min (var_1_14 , var_1_15)) - var_1_16) - var_1_7))) : (((var_1_14 - 100000.01f) > last_1_var_1_38) ? (var_1_9 ? (var_1_10 ? (((var_1_18 + last_1_var_1_11) >= (last_1_var_1_45 + (- 8u))) ? ((! last_1_var_1_8) ? (var_1_13 == ((double) var_1_14)) : (var_1_13 == ((double) (var_1_16 + var_1_20)))) : 1) : (var_1_13 == ((double) (var_1_14 - var_1_15)))) : 1) : (var_1_13 == ((double) (abs (0.775))))))) && (((var_1_45 * (var_1_17 >> var_1_22)) != (var_1_45 + (var_1_18 / 5u))) ? ((var_1_13 < var_1_15) ? (((min ((var_1_14 / var_1_23) , (min (127.25f , var_1_7)))) <= var_1_20) ? (var_1_21 == ((unsigned short int) (var_1_17 + var_1_22))) : (((var_1_24 - var_1_22) > var_1_12) ? (var_1_21 == ((unsigned short int) ((max (var_1_25 , var_1_26)) - var_1_22))) : (var_1_21 == ((unsigned short int) (max (var_1_24 , var_1_17)))))) : (var_1_21 == ((unsigned short int) (max (var_1_18 , var_1_26))))) : (var_1_21 == ((unsigned short int) (var_1_22 + (var_1_27 - var_1_24)))))) && ((var_1_10 || last_1_var_1_32) ? (var_1_28 == ((unsigned long int) 100000000u)) : 1)) && (((var_1_28 + var_1_27) <= var_1_28) ? (var_1_29 == ((unsigned long int) var_1_22)) : ((1 != (var_1_28 * (min (0 , -16)))) ? (var_1_29 == ((unsigned long int) (min ((min ((min (var_1_25 , var_1_21)) , (min (var_1_12 , var_1_30)))) , (var_1_27 + var_1_24))))) : (var_1_29 == ((unsigned long int) (min (var_1_21 , var_1_12))))))) && (var_1_31 == ((unsigned short int) ((var_1_24 + var_1_22) + var_1_27)))) && ((var_1_29 < var_1_25) ? (var_1_32 == ((unsigned char) var_1_33)) : 1)) && ((((var_1_18 / 2) / var_1_22) < ((var_1_29 ^ var_1_56) / (min (var_1_35 , var_1_25)))) ? ((var_1_30 == ((min (var_1_45 , var_1_28)) + var_1_18)) ? (var_1_34 == ((float) (abs (var_1_20)))) : (var_1_34 == ((float) 0.64f))) : 1)) && (((64.3f * var_1_43) >= var_1_14) ? (var_1_37 == ((signed short int) (abs (var_1_22)))) : (var_1_37 == ((signed short int) (var_1_22 - var_1_24))))) && (((max (8 , var_1_28)) > var_1_57) ? (var_1_38 == ((double) (abs (min (var_1_7 , 16.4))))) : ((var_1_16 > ((var_1_39 + var_1_40) - (var_1_41 + var_1_42))) ? ((! (var_1_45 == var_1_56)) ? (var_1_38 == ((double) (min ((var_1_41 - (5.6 + var_1_16)) , var_1_39)))) : 1) : 1))) && (((var_1_18 * (var_1_11 + var_1_29)) > (min (-10 , var_1_35))) ? (var_1_43 == ((double) (abs (abs (var_1_16))))) : 1)) && ((((max (8 , var_1_29)) / 16) > var_1_26) ? (((min (var_1_57 , (var_1_12 << var_1_57))) < ((var_1_18 >> 2u) * var_1_27)) ? (var_1_44 == ((signed short int) (var_1_22 + var_1_24))) : (var_1_44 == ((signed short int) (min (((var_1_24 + var_1_22) + 4) , -10000))))) : 1)) && ((! var_1_9) ? ((last_1_var_1_53 < last_1_var_1_56) ? (var_1_45 == ((unsigned long int) (min ((var_1_47 - var_1_24) , (abs (last_1_var_1_57)))))) : 1) : ((! last_1_var_1_32) ? (var_1_45 == ((unsigned long int) var_1_47)) : 1))) && ((var_1_20 > (var_1_39 * (var_1_6 - var_1_42))) ? (var_1_48 == ((signed short int) (-2 + (64 - var_1_24)))) : (var_1_48 == ((signed short int) (abs (abs (var_1_24))))))) && ((var_1_12 <= var_1_17) ? (var_1_49 == ((unsigned short int) (var_1_17 + var_1_27))) : (var_1_49 == ((unsigned short int) ((var_1_27 + var_1_50) - var_1_24))))) && ((var_1_11 == 2u) ? (var_1_51 == ((float) var_1_41)) : ((var_1_27 >= var_1_35) ? (var_1_51 == ((float) 63.4f)) : ((var_1_20 == var_1_6) ? (var_1_51 == ((float) (abs (var_1_42)))) : 1)))) && ((var_1_11 <= -5) ? (var_1_52 == ((unsigned short int) ((abs (min (var_1_24 , 25))) + var_1_50))) : 1)) && ((var_1_11 < var_1_45) ? (var_1_53 == ((signed short int) (min (var_1_24 , var_1_22)))) : (var_1_53 == ((signed short int) (var_1_24 + (min (var_1_22 , (var_1_54 - var_1_55)))))))) && (((min (var_1_66 , var_1_11)) <= (~ var_1_30)) ? (var_1_56 == ((unsigned long int) (var_1_26 + (var_1_31 + var_1_54)))) : (var_1_56 == ((unsigned long int) (min (var_1_30 , (max ((abs (var_1_26)) , var_1_54)))))))) && ((last_1_var_1_13 <= ((var_1_40 + var_1_23) * var_1_39)) ? (var_1_57 == ((signed long int) (var_1_18 - (min (var_1_26 , last_1_var_1_28))))) : (var_1_57 == ((signed long int) (last_1_var_1_66 + last_1_var_1_21))))) && (var_1_10 ? (var_1_58 == ((signed char) var_1_22)) : 1)) && (last_1_var_1_59 ? (var_1_59 == ((unsigned char) var_1_33)) : (var_1_59 == ((unsigned char) var_1_9)))) && (var_1_60 == ((signed char) (max (((var_1_22 + var_1_61) + var_1_62) , ((max (var_1_63 , var_1_64)) - 2)))))) && (var_1_65 == ((unsigned short int) var_1_26))) && (var_1_66 == ((unsigned short int) var_1_27))
;
}
int main(void) {
	isInitial = 1;
