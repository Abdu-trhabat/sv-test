...
void step(void) {
	// From: Req2Batch115normal
	if (var_1_7) {
		var_1_6 = (min (var_1_8 , (var_1_9 - var_1_10)));
	}


	// From: Req7Batch115normal
	...
	// From: Req5Batch115normal
	if ((- var_1_9) > var_1_27) {
		var_1_19 = (var_1_20 - var_1_21);
	}


	// From: Req6Batch115normal
