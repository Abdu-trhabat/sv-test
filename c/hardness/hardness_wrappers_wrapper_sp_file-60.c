...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch60Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_2_Pointer)) > (*(WrapperStruct00_var_1_1_Pointer))) {
		if ((*(WrapperStruct00_var_1_9_Pointer))) {
			if ((*(WrapperStruct00_var_1_3_Pointer)) <= (min ((*(WrapperStruct00_var_1_1_Pointer)) , (*(WrapperStruct00_var_1_11_Pointer))))) {
...
void updateVariables(void) {
	...
	assume_abort_if_not((WrapperStruct00.var_1_12 >= -230584.3009213691400e+13F && WrapperStruct00.var_1_12 <= -1.0e-20F) || (WrapperStruct00.var_1_12 <= 2305843.009213691400e+12F && WrapperStruct00.var_1_12 >= 1.0e-20F ));
