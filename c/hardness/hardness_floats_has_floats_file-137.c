...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch137has_floats.c", 13, "reach_error"); }
...
double var_1_12 = 256.0;
double var_1_13 = 25.0;
double var_1_14 = 256.0;
