...
int property(void) {
	return (((((var_1_2 >> var_1_3) >= var_1_4) ? (var_1_1 == ((unsigned char) (min (var_1_3 , (var_1_5 - (max (var_1_6 , var_1_7))))))) : (var_1_1 == ((unsigned char) ((min (var_1_6 , var_1_3)) + (min ((var_1_8 + 1) , var_1_7)))))) && (var_1_9 == ((signed long int) (min (var_1_10 , var_1_11))))) && (((var_1_8 / var_1_3) < -256) ? (var_1_12 == ((signed long int) (var_1_13 - var_1_14))) : 1)) && ((10 < ((var_1_8 + var_1_3) + (var_1_16 * var_1_17))) ? (var_1_15 == ((signed char) (min (((min (var_1_3 , var_1_18)) + (var_1_19 - var_1_20)) , var_1_8)))) : (var_1_15 == ((signed char) var_1_21)))
;
}
int main(void) {
	isInitial = 1;
