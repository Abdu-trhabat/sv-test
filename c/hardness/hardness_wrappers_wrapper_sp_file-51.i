...
void step(void) {
 if ((*(WrapperStruct00_var_1_4_Pointer)) <= last_1_WrapperStruct00_var_1_17) {
  if ((*(WrapperStruct00_var_1_2_Pointer)) && (last_1_WrapperStruct00_var_1_17 == (((((*(WrapperStruct00_var_1_16_Pointer))) > ((*(WrapperStruct00_var_1_12_Pointer)))) ? ((*(WrapperStruct00_var_1_16_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer))))))) {
 ...
 unsigned long int stepLocal_1 = (((((*(WrapperStruct00_var_1_11_Pointer))) > ((*(WrapperStruct00_var_1_12_Pointer)))) ? ((*(WrapperStruct00_var_1_11_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer))))) - (*(WrapperStruct00_var_1_13_Pointer));
