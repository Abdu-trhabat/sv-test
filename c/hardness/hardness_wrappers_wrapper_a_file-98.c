...
void step(void) {
	...
	if (double_Array_0[0][1][1] < double_Array_0[1][0][0]) {
		if (((- signed_long_int_Array_0[1]) <= signed_short_int_Array_0[0]) || (double_Array_0[0][0][1] < double_Array_0[0][1][0])) {
			unsigned_long_int_Array_0[0] = (min (signed_long_int_Array_0[1] , signed_short_int_Array_0[0]));
		} else {
	...
	if ((min (-128 , unsigned_long_int_Array_0[0])) < unsigned_long_int_Array_0[1]) {
...
int property(void) {
	return (((double_Array_0[1][1][1] == ((double) (double_Array_0[0][1][1] - double_Array_0[1][0][1]))) && ((8 < ((signed_long_int_Array_0[1] >> signed_short_int_Array_0[0]) / signed_long_int_Array_0[0])) ? (double_Array_0[0][0][1] == ((double) (((double_Array_0[1][0][0] + double_Array_0[0][0][0]) + (min (double_Array_0[0][1][0] , 1.9))) + (99.125 + double_Array_0[1][1][0])))) : 1)) && ((double_Array_0[0][1][1] < double_Array_0[1][0][0]) ? ((((- signed_long_int_Array_0[1]) <= signed_short_int_Array_0[0]) || (double_Array_0[0][0][1] < double_Array_0[0][1][0])) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) (min (signed_long_int_Array_0[1] , signed_short_int_Array_0[0])))) : (unsigned_long_int_Array_0[0] == ((unsigned long int) (unsigned_long_int_Array_0[1] - signed_long_int_Array_0[1])))) : 1)) && (((min (-128 , unsigned_long_int_Array_0[0])) < unsigned_long_int_Array_0[1]) ? ((double_Array_0[0][1][1] > double_Array_0[0][1][0]) ? (unsigned_long_int_Array_0[2] == ((unsigned long int) (signed_short_int_Array_0[0] + signed_long_int_Array_0[1]))) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[1]))) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[1])))
;
}
int main(void) {
	isInitial = 1;
