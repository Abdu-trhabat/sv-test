...
void step(void) {
	...
	// From: Req4Batch7no_floats
	if (var_1_6) {
		var_1_10 = 10;
	}


	// From: Req5Batch7no_floats
...
int property(void) {
	return (((((! (var_1_2 <= (var_1_3 / var_1_4))) ? ((var_1_5 && var_1_6) ? (var_1_1 == ((unsigned char) var_1_7)) : (var_1_1 == ((unsigned char) 16))) : (var_1_1 == ((unsigned char) var_1_7))) && ((var_1_3 < -1) ? (var_1_8 == ((unsigned long int) (abs (var_1_7)))) : (var_1_8 == ((unsigned long int) (var_1_7 + last_1_var_1_11))))) && (((var_1_1 - var_1_7) >= 128) ? (var_1_9 == ((signed short int) (var_1_1 - (abs (var_1_7))))) : (var_1_9 == ((signed short int) var_1_7)))) && (var_1_6 ? (var_1_10 == ((signed char) 10)) : 1)) && (((var_1_1 ^ (var_1_8 / var_1_12)) >= var_1_10) ? ((var_1_12 > var_1_10) ? (var_1_11 == ((unsigned short int) var_1_7)) : (var_1_11 == ((unsigned short int) var_1_1))) : (var_1_11 == ((unsigned short int) var_1_7)))
;
}
int main(void) {
	isInitial = 1;
