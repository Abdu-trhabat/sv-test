...
void step(void) {
	...
	// From: Req4Batch51normal
	if ((min ((~ var_1_1) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req5Batch51normal
	if (var_1_14 || ((max (var_1_4 , var_1_6)) > var_1_18)) {
