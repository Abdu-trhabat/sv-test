...
void step(void) {
	...
	// From: Req10Batch127100_1loop
	var_1_24 = ((var_1_17 + (min (var_1_13 , var_1_16))) - var_1_19);


	// From: Req8Batch127100_1loop
	...
	// From: Req9Batch127100_1loop
	var_1_23 = (var_1_8 || var_1_9);


	// From: Req13Batch127100_1loop
	var_1_29 = (var_1_13 - (var_1_30 + var_1_31));


	// From: Req2Batch127100_1loop
	...
	// From: Req4Batch127100_1loop
	if (! ((min (var_1_28 , var_1_24)) >= 16)) {
		var_1_14 = var_1_15;
	}


	// From: Req6Batch127100_1loop
