...
void step(void) {
	...
	// From: Req3Batch132Wrapper_SP
	if ((*(WrapperStruct00_var_1_4_Pointer)) || (*(WrapperStruct00_var_1_9_Pointer))) {
		(*(WrapperStruct00_var_1_8_Pointer)) = (abs (min ((*(WrapperStruct00_var_1_10_Pointer)) , (*(WrapperStruct00_var_1_11_Pointer)))));
	} else {
		(*(WrapperStruct00_var_1_8_Pointer)) = (*(WrapperStruct00_var_1_10_Pointer));
	}


	// From: Req4Batch132Wrapper_SP
	...
	if (7.2 < (*(WrapperStruct00_var_1_6_Pointer))) {
		if (((*(WrapperStruct00_var_1_13_Pointer)) - ((*(WrapperStruct00_var_1_14_Pointer)) + (*(WrapperStruct00_var_1_15_Pointer)))) >= stepLocal_0) {
			...
			(*(WrapperStruct00_var_1_12_Pointer)) = ((max ((*(WrapperStruct00_var_1_13_Pointer)) , (*(WrapperStruct00_var_1_14_Pointer)))) - ((*(WrapperStruct00_var_1_16_Pointer)) - (*(WrapperStruct00_var_1_15_Pointer))));
		}
	}


	// From: Req5Batch132Wrapper_SP
