...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch97dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch97dependencies
	if ((max (var_1_2 , var_1_1)) > (var_1_3 * 2u)) {
	...
	// From: Req5Batch97dependencies
	if (var_1_17 <= var_1_5) {
		var_1_16 = ((var_1_18 - var_1_3) + var_1_17);
	} else {
		var_1_16 = (min (var_1_17 , (var_1_3 + var_1_2)));
	}


	// From: Req6Batch97dependencies
	if (var_1_15) {
		if (var_1_16 < var_1_1) {
			var_1_19 = ((var_1_20 + var_1_21) - 9.125f);
		} else {
			var_1_19 = (0.19999999999999996f - var_1_20);
		}
	} else {
		var_1_19 = var_1_20;
	}
	...
	// From: Req4Batch97dependencies
	if ((var_1_16 / var_1_14) <= (var_1_6 * var_1_1)) {
		var_1_12 = var_1_15;
	}


	// From: Req3Batch97dependencies
...
int property(void) {
	return (((((((var_1_2 + var_1_3) < -200) ? (last_1_var_1_12 ? ((var_1_2 > (- var_1_3)) ? (var_1_1 == ((unsigned long int) var_1_2)) : (var_1_1 == ((unsigned long int) var_1_3))) : (var_1_1 == ((unsigned long int) 10u))) : (var_1_1 == ((unsigned long int) 0u))) && (((max (var_1_2 , var_1_1)) > (var_1_3 * 2u)) ? ((((32 * -25) | var_1_2) >= var_1_1) ? ((var_1_3 > var_1_1) ? (var_1_5 == ((signed char) var_1_6)) : 1) : 1) : (var_1_5 == ((signed char) var_1_6)))) && (((127.75 <= var_1_8) && var_1_12) ? (var_1_7 == ((float) (max ((var_1_9 + var_1_10) , var_1_11)))) : 1)) && (((var_1_16 / var_1_14) <= (var_1_6 * var_1_1)) ? (var_1_12 == ((unsigned char) var_1_15)) : 1)) && ((var_1_17 <= var_1_5) ? (var_1_16 == ((unsigned long int) ((var_1_18 - var_1_3) + var_1_17))) : (var_1_16 == ((unsigned long int) (min (var_1_17 , (var_1_3 + var_1_2))))))) && (var_1_15 ? ((var_1_16 < var_1_1) ? (var_1_19 == ((float) ((var_1_20 + var_1_21) - 9.125f))) : (var_1_19 == ((float) (0.19999999999999996f - var_1_20)))) : (var_1_19 == ((float) var_1_20)))
;
}
int main(void) {
	isInitial = 1;
