...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17550_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch17550_while
	var_1_5 = (! (var_1_6 && var_1_7));


	// From: Req5Batch17550_while
	...
	// From: Req6Batch17550_while
	var_1_20 = (var_1_18 + (max ((var_1_19 - 5.9f) , var_1_21)));


	// From: Req7Batch17550_while
	...
	// From: Req8Batch17550_while
	var_1_28 = var_1_2;


	// From: Req3Batch17550_while
	if ((var_1_20 * (var_1_15 + var_1_20)) > var_1_20) {
		var_1_8 = var_1_7;
	}


	// From: Req4Batch17550_while
