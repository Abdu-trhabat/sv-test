...
void step(void) {
 ...
 if (last_1_unsigned_long_int_Array_0_1_ > stepLocal_5) {
  if ((signed_short_int_Array_0[1][0] - signed_short_int_Array_0[0][1]) > stepLocal_4) {
   unsigned_long_int_Array_0[1] = (((((signed_short_int_Array_0[0][1]) < ((last_1_unsigned_long_int_Array_0_1_ + unsigned_long_int_Array_0[2]))) ? (signed_short_int_Array_0[0][1]) : ((last_1_unsigned_long_int_Array_0_1_ + unsigned_long_int_Array_0[2])))) + unsigned_long_int_Array_0[0]);
  }
 } else {
 ...
 if (stepLocal_2 == (((((unsigned_long_int_Array_0[1] | unsigned_long_int_Array_0[2])) < (unsigned_long_int_Array_0[2])) ? ((unsigned_long_int_Array_0[1] | unsigned_long_int_Array_0[2])) : (unsigned_long_int_Array_0[2])))) {
...
int property(void) {
 return ((BOOL_unsigned_char_Array_0[1] ? ((unsigned_short_int_Array_0[1] <= unsigned_short_int_Array_0[0]) ? ((BOOL_unsigned_char_Array_0[0] && ((unsigned_short_int_Array_0[0] / signed_long_int_Array_0[0]) < unsigned_short_int_Array_0[1])) ? (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_short_int_Array_0[0])) : 1) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_short_int_Array_0[1]))) : 1) && ((2 == (((((unsigned_long_int_Array_0[1] | unsigned_long_int_Array_0[2])) < (unsigned_long_int_Array_0[2])) ? ((unsigned_long_int_Array_0[1] | unsigned_long_int_Array_0[2])) : (unsigned_long_int_Array_0[2])))) ? ((unsigned_long_int_Array_0[1] < unsigned_long_int_Array_0[2]) ? (signed_short_int_Array_0[1][1] == ((signed short int) (signed_short_int_Array_0[1][0] - 8))) : (signed_short_int_Array_0[1][1] == ((signed short int) signed_short_int_Array_0[1][0]))) : (BOOL_unsigned_char_Array_0[1] ? (signed_short_int_Array_0[1][1] == ((signed short int) signed_short_int_Array_0[1][0])) : (signed_short_int_Array_0[1][1] == ((signed short int) signed_short_int_Array_0[0][0]))))) && ((last_1_unsigned_long_int_Array_0_1_ > signed_long_int_Array_0[0]) ? (((signed_short_int_Array_0[1][0] - signed_short_int_Array_0[0][1]) > unsigned_long_int_Array_0[2]) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) (((((signed_short_int_Array_0[0][1]) < ((last_1_unsigned_long_int_Array_0_1_ + unsigned_long_int_Array_0[2]))) ? (signed_short_int_Array_0[0][1]) : ((last_1_unsigned_long_int_Array_0_1_ + unsigned_long_int_Array_0[2])))) + unsigned_long_int_Array_0[0]))) : 1) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_long_int_Array_0[2])))
;
}
int main(void) {
 isInitial = 1;
