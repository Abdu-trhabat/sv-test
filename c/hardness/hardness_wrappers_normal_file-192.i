...
void step(void) {
 signed long int stepLocal_2 = (200 - var_1_12) - var_1_13;
 ...
 signed long int stepLocal_3 = 1 - var_1_13;
 if (((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))) >= var_1_7) {
  if ((-4 + (var_1_12 * var_1_11)) < stepLocal_3) {
   var_1_14 = var_1_12;
  } else {
   var_1_14 = -8;
  }
 ...
 signed long int stepLocal_0 = ((((var_1_4) < (-5)) ? (var_1_4) : (-5))) + ((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6)));
 if (var_1_2) {
  if (((((var_1_11) < (0)) ? (var_1_11) : (0))) <= stepLocal_0) {
...
int property(void) {
 return ((var_1_2 ? ((((((var_1_11) < (0)) ? (var_1_11) : (0))) <= (((((var_1_4) < (-5)) ? (var_1_4) : (-5))) + ((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6))))) ? (var_1_1 == ((double) ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))))) : (var_1_1 == ((double) ((var_1_8 + var_1_9) - var_1_10)))) : (var_1_1 == ((double) var_1_8))) && ((var_1_5 < var_1_3) ? ((((200 - var_1_12) - var_1_13) >= -100) ? (var_1_11 == ((unsigned short int) var_1_12)) : (var_1_11 == ((unsigned short int) var_1_13))) : 1)) && ((((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))) >= var_1_7) ? (((-4 + (var_1_12 * var_1_11)) < (1 - var_1_13)) ? (var_1_14 == ((signed char) var_1_12)) : (var_1_14 == ((signed char) -8))) : (var_1_14 == ((signed char) var_1_12)))
;
}
int main(void) {
 isInitial = 1;
