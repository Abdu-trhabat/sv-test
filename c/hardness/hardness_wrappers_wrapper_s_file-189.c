...
void step(void) {
	...
	if (WrapperStruct00.var_1_14 <= stepLocal_2) {
		if (! (WrapperStruct00.var_1_13 <= WrapperStruct00.var_1_12)) {
			WrapperStruct00.var_1_16 = (max ((max ((WrapperStruct00.var_1_14 + WrapperStruct00.var_1_15) , WrapperStruct00.var_1_12)) , WrapperStruct00.var_1_13));
		}
	} else {
	...
	// From: Req2Batch189Wrapper_S
	unsigned long int stepLocal_0 = min (WrapperStruct00.var_1_16 , WrapperStruct00.var_1_14);
	if (stepLocal_0 >= WrapperStruct00.var_1_16) {
		WrapperStruct00.var_1_5 = (abs (WrapperStruct00.var_1_9 - WrapperStruct00.var_1_10));
	} else {
		WrapperStruct00.var_1_5 = (abs (WrapperStruct00.var_1_10));
	}
}
