...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch182has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch182has_floats
	var_1_10 = (var_1_2 - var_1_5);


	// From: Req4Batch182has_floats
	if (! (var_1_17 || var_1_12)) {
		var_1_18 = (max (var_1_14 , var_1_19));
	}


	// From: Req5Batch182has_floats
