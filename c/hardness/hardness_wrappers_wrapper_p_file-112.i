...
void step(void) {
 if ((*(var_1_2_Pointer)) <= (*(var_1_3_Pointer))) {
  (*(var_1_1_Pointer)) = (((((*(var_1_4_Pointer))) < ((((((*(var_1_5_Pointer))) > ((*(var_1_6_Pointer)))) ? ((*(var_1_5_Pointer))) : ((*(var_1_6_Pointer))))))) ? ((*(var_1_4_Pointer))) : ((((((*(var_1_5_Pointer))) > ((*(var_1_6_Pointer)))) ? ((*(var_1_5_Pointer))) : ((*(var_1_6_Pointer))))))));
 }
 if ((*(var_1_8_Pointer))) {
  if (last_1_var_1_7 < (*(var_1_1_Pointer))) {
   (*(var_1_7_Pointer)) = ((((((*(var_1_9_Pointer))) > (32.75f)) ? ((*(var_1_9_Pointer))) : (32.75f))) + (*(var_1_10_Pointer)));
  }
 } else {
 ...
 if (stepLocal_0 <= ((*(var_1_12_Pointer)) >> (*(var_1_16_Pointer)))) {
  if (! ((*(var_1_1_Pointer)) != (*(var_1_2_Pointer)))) {
   if ((*(var_1_8_Pointer))) {
    (*(var_1_14_Pointer)) = (((((128) > ((*(var_1_17_Pointer)))) ? (128) : ((*(var_1_17_Pointer))))) - (*(var_1_16_Pointer)));
   } else {
