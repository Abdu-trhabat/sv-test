...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch93Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 if (((- WrapperStruct00.var_1_2) / WrapperStruct00.var_1_3) != (WrapperStruct00.var_1_4 / WrapperStruct00.var_1_5)) {
  if (WrapperStruct00.var_1_2 != (((((WrapperStruct00.var_1_6) > (WrapperStruct00.var_1_7)) ? (WrapperStruct00.var_1_6) : (WrapperStruct00.var_1_7))) - WrapperStruct00.var_1_8)) {
 ...
 signed long int stepLocal_0 = WrapperStruct00.var_1_11 * WrapperStruct00.var_1_12;
 if (stepLocal_0 < (100 + 128)) {
  if (WrapperStruct00.var_1_13) {
   WrapperStruct00.var_1_10 = WrapperStruct00.var_1_14;
  } else {
   WrapperStruct00.var_1_10 = 4;
  }
 } else {
  WrapperStruct00.var_1_10 = WrapperStruct00.var_1_14;
 }
 unsigned short int stepLocal_1 = WrapperStruct00.var_1_14;
 if (((WrapperStruct00.var_1_10 + 100u) << WrapperStruct00.var_1_11) <= stepLocal_1) {
  if (WrapperStruct00.var_1_4 <= ((- WrapperStruct00.var_1_2) + WrapperStruct00.var_1_7)) {
   WrapperStruct00.var_1_15 = WrapperStruct00.var_1_11;
  } else {
   WrapperStruct00.var_1_15 = WrapperStruct00.var_1_12;
  }
 } else {
  WrapperStruct00.var_1_15 = WrapperStruct00.var_1_12;
 }
...
int property(void) {
 return (((((- WrapperStruct00.var_1_2) / WrapperStruct00.var_1_3) != (WrapperStruct00.var_1_4 / WrapperStruct00.var_1_5)) ? ((WrapperStruct00.var_1_2 != (((((WrapperStruct00.var_1_6) > (WrapperStruct00.var_1_7)) ? (WrapperStruct00.var_1_6) : (WrapperStruct00.var_1_7))) - WrapperStruct00.var_1_8)) ? (WrapperStruct00.var_1_1 == ((float) WrapperStruct00.var_1_9)) : (WrapperStruct00.var_1_1 == ((float) 64.51f))) : (WrapperStruct00.var_1_1 == ((float) WrapperStruct00.var_1_9))) && (((WrapperStruct00.var_1_11 * WrapperStruct00.var_1_12) < (100 + 128)) ? (WrapperStruct00.var_1_13 ? (WrapperStruct00.var_1_10 == ((unsigned short int) WrapperStruct00.var_1_14)) : (WrapperStruct00.var_1_10 == ((unsigned short int) 4))) : (WrapperStruct00.var_1_10 == ((unsigned short int) WrapperStruct00.var_1_14)))) && ((((WrapperStruct00.var_1_10 + 100u) << WrapperStruct00.var_1_11) <= WrapperStruct00.var_1_14) ? ((WrapperStruct00.var_1_4 <= ((- WrapperStruct00.var_1_2) + WrapperStruct00.var_1_7)) ? (WrapperStruct00.var_1_15 == ((signed long int) WrapperStruct00.var_1_11)) : (WrapperStruct00.var_1_15 == ((signed long int) WrapperStruct00.var_1_12))) : (WrapperStruct00.var_1_15 == ((signed long int) WrapperStruct00.var_1_12)))
;
}
int main(void) {
 isInitial = 1;
