...
void step(void) {
 ...
 if (((((double_Array_0[0]) < 0 ) ? -(double_Array_0[0]) : (double_Array_0[0]))) >= double_Array_0[3]) {
 ...
 signed long int stepLocal_0 = ((((signed_long_int_Array_0[2]) < (-5)) ? (signed_long_int_Array_0[2]) : (-5))) + ((((signed_long_int_Array_0[1]) > (signed_long_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (signed_long_int_Array_0[0])));
 if (BOOL_unsigned_char_Array_0[0]) {
  if (((((unsigned_short_int_Array_0[0]) < (0)) ? (unsigned_short_int_Array_0[0]) : (0))) <= stepLocal_0) {
   double_Array_0[4] = ((((double_Array_0[3]) < 0 ) ? -(double_Array_0[3]) : (double_Array_0[3])));
  } else {
...
int property(void) {
 return ((BOOL_unsigned_char_Array_0[0] ? ((((((unsigned_short_int_Array_0[0]) < (0)) ? (unsigned_short_int_Array_0[0]) : (0))) <= (((((signed_long_int_Array_0[2]) < (-5)) ? (signed_long_int_Array_0[2]) : (-5))) + ((((signed_long_int_Array_0[1]) > (signed_long_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (signed_long_int_Array_0[0]))))) ? (double_Array_0[4] == ((double) ((((double_Array_0[3]) < 0 ) ? -(double_Array_0[3]) : (double_Array_0[3]))))) : (double_Array_0[4] == ((double) ((double_Array_0[1] + double_Array_0[0]) - double_Array_0[2])))) : (double_Array_0[4] == ((double) double_Array_0[1]))) && ((signed_long_int_Array_0[1] < unsigned_short_int_Array_0[1]) ? ((((200 - unsigned_char_Array_0[0]) - unsigned_char_Array_0[1]) >= -100) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_char_Array_0[0])) : (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_char_Array_0[1]))) : 1)) && ((((((double_Array_0[0]) < 0 ) ? -(double_Array_0[0]) : (double_Array_0[0]))) >= double_Array_0[3]) ? (((-4 + (unsigned_char_Array_0[0] * unsigned_short_int_Array_0[0])) < (1 - unsigned_char_Array_0[1])) ? (signed_char_Array_0[0] == ((signed char) unsigned_char_Array_0[0])) : (signed_char_Array_0[0] == ((signed char) -8))) : (signed_char_Array_0[0] == ((signed char) unsigned_char_Array_0[0])))
;
}
int main(void) {
 isInitial = 1;
