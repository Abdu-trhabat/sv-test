...
void step(void) {
 ...
 if (stepLocal_2 && (var_1_9 < var_1_2)) {
  if (var_1_3 == stepLocal_1) {
   var_1_12 = ((((var_1_14) < (8)) ? (var_1_14) : (8)));
  } else {
   var_1_12 = var_1_14;
  }
 } else {
