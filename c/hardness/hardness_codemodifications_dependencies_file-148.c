...
void step(void) {
	...
	// From: Req11Batch148dependencies
	var_1_30 = var_1_1;


	// From: Req2Batch148dependencies
	var_1_7 = (var_1_8 + (min ((abs (99.4)) , var_1_9)));


	// From: Req4Batch148dependencies
	var_1_14 = ((max (var_1_8 , var_1_9)) + (var_1_15 + (abs (var_1_16))));


	// From: Req5Batch148dependencies
	var_1_17 = (! var_1_13);


	// From: Req8Batch148dependencies
	if (var_1_20 == var_1_6) {
	...
	// From: Req9Batch148dependencies
	var_1_28 = var_1_4;


	// From: Req10Batch148dependencies
	var_1_29 = var_1_23;


	// From: Req7Batch148dependencies
	if (var_1_8 < var_1_14) {
