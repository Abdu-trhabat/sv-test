...
void step(void) {
	...
	// From: Req58Batch117Amount500
	if (last_1_var_1_57) {
		var_1_108 = var_1_34;
	}


	// From: Req45Batch117Amount500
	if (last_1_var_1_40) {
		var_1_93 = var_1_18;
	} else {
		var_1_93 = var_1_94;
	...
	// From: Req5Batch117Amount500
	var_1_19 = (var_1_17 + (abs (var_1_6)));


	// From: Req10Batch117Amount500
	...
	// From: Req12Batch117Amount500
	var_1_32 = ((var_1_33 || var_1_34) || var_1_35);


	// From: Req13Batch117Amount500
	var_1_36 = (! var_1_33);


	// From: Req15Batch117Amount500
	...
	// From: Req17Batch117Amount500
	var_1_41 = (max (var_1_14 , -0.25));


	// From: Req19Batch117Amount500
	...
	// From: Req21Batch117Amount500
	var_1_46 = (var_1_5 - var_1_10);


	// From: Req25Batch117Amount500
	...
	// From: Req34Batch117Amount500
	var_1_70 = ((var_1_71 - var_1_21) - (1431246933 - (var_1_10 + var_1_17)));


	// From: Req39Batch117Amount500
	var_1_79 = (((var_1_80 + var_1_81) + var_1_82) - (max ((var_1_83 + var_1_84) , (4.4f + 256.5f))));


	// From: Req41Batch117Amount500
	signed long int stepLocal_25 = 100000;
	if (stepLocal_25 <= var_1_17) {
		var_1_86 = ((var_1_10 + 1u) + (min (var_1_46 , 0u)));
	} else {
	...
	// From: Req43Batch117Amount500
	var_1_91 = var_1_56;


	// From: Req44Batch117Amount500
	var_1_92 = var_1_13;


	// From: Req46Batch117Amount500
	if (var_1_36) {
		var_1_95 = var_1_77;
	}


	// From: Req47Batch117Amount500
	var_1_96 = var_1_11;


	// From: Req48Batch117Amount500
	var_1_97 = var_1_98;


	// From: Req49Batch117Amount500
	var_1_99 = var_1_10;


	// From: Req50Batch117Amount500
	var_1_100 = -256;


	// From: Req51Batch117Amount500
	var_1_101 = var_1_10;


	// From: Req53Batch117Amount500
	var_1_103 = var_1_13;


	// From: Req54Batch117Amount500
	var_1_104 = var_1_21;


	// From: Req55Batch117Amount500
	var_1_105 = var_1_23;


	// From: Req56Batch117Amount500
	var_1_106 = var_1_23;


	// From: Req59Batch117Amount500
	if (var_1_91) {
		var_1_109 = var_1_69;
	} else {
	...
	// From: Req62Batch117Amount500
	var_1_112 = (max (((min (var_1_82 , var_1_84)) - var_1_81) , var_1_14));


	// From: Req27Batch117Amount500
	...
	if (var_1_22 <= stepLocal_12) {
		...
		if (var_1_25 >= stepLocal_10) {
			var_1_31 = (var_1_18 + (abs (var_1_86)));
		} else {
	...
	// From: Req28Batch117Amount500
	if ((var_1_103 / (max (var_1_59 , var_1_60))) <= (var_1_13 / var_1_61)) {
	...
	// From: Req31Batch117Amount500
	var_1_66 = (16 - var_1_96);


	// From: Req37Batch117Amount500
	unsigned long int stepLocal_24 = var_1_31;
	if (stepLocal_24 <= (var_1_11 - var_1_69)) {
		if (! (var_1_1 < var_1_10)) {
			var_1_76 = (max (((max (15.3 , var_1_50)) + var_1_77) , var_1_49));
		}
	}


	// From: Req52Batch117Amount500
	if (var_1_55) {
		var_1_102 = var_1_106;
	} else {
		var_1_102 = var_1_10;
	...
	// From: Req61Batch117Amount500
	if (var_1_57) {
		var_1_111 = var_1_14;
	}


	// From: Req16Batch117Amount500
	if (var_1_78) {
		var_1_40 = ((var_1_11 <= (var_1_23 - var_1_10)) && var_1_35);
	}


	// From: Req7Batch117Amount500
	...
	if (((var_1_22 * var_1_10) <= var_1_18) || stepLocal_6) {
		...
		if (var_1_58 == stepLocal_7) {
			...
			var_1_24 = (min (var_1_18 , var_1_102));
		}
	}


	// From: Req8Batch117Amount500
	if (var_1_8 == var_1_31) {
	...
	// From: Req20Batch117Amount500
	if ((var_1_29 <= var_1_6) || (var_1_27 < var_1_26)) {
		var_1_44 = (min ((var_1_22 + (min (var_1_70 , var_1_86))) , (var_1_10 + var_1_21)));
	} else {
		if (var_1_35) {
			var_1_44 = (var_1_29 - ((min (var_1_70 , var_1_86)) + (min (var_1_28 , var_1_5))));
		} else {
			var_1_44 = ((var_1_4 + var_1_45) - (max ((abs (var_1_22)) , var_1_26)));
		}
	}


	// From: Req35Batch117Amount500
	unsigned long int stepLocal_21 = 4 - (min (var_1_44 , 256));
	if ((abs (var_1_10)) < stepLocal_21) {
		var_1_72 = (var_1_78 || (! var_1_33));
	}


	// From: Req57Batch117Amount500
	if (var_1_72) {
		var_1_107 = var_1_22;
	}


	// From: Req2Batch117Amount500
	...
	// From: Req24Batch117Amount500
	unsigned char stepLocal_16 = var_1_48 < (var_1_14 - var_1_15);
	if (stepLocal_16 && (var_1_86 > var_1_107)) {
		var_1_52 = (max (var_1_28 , var_1_43));
	}


	// From: Req18Batch117Amount500
	unsigned long int stepLocal_15 = var_1_52 / (max (var_1_25 , var_1_17));
	if (var_1_13 >= (min (var_1_41 , var_1_14))) {
	...
	if (((var_1_23 - 100000) * (var_1_65 - var_1_52)) >= stepLocal_19) {
		if (stepLocal_20 <= var_1_102) {
			var_1_64 = (max ((var_1_29 - var_1_45) , var_1_28));
		} else {
			var_1_64 = (((max (var_1_4 , var_1_45)) - var_1_22) + var_1_17);
		}
	} else {
		var_1_64 = var_1_96;
	}
	...
	// From: Req40Batch117Amount500
	if (! (var_1_23 >= (var_1_42 / var_1_21))) {
		var_1_85 = (var_1_80 + ((31.5f + var_1_81) - var_1_82));
	} else {
		var_1_85 = (max (var_1_15 , ((var_1_81 + var_1_80) + var_1_49)));
	}


	// From: Req63Batch117Amount500
	if (25u <= (var_1_42 + var_1_94)) {
		var_1_113 = (min (var_1_38 , var_1_30));
	}


	// From: Req22Batch117Amount500
	if (var_1_19 != ((var_1_10 - var_1_18) % var_1_17)) {
		if (var_1_45 >= ((abs (var_1_64)) + 2u)) {
			var_1_47 = var_1_13;
		} else {
	...
	// From: Req32Batch117Amount500
	var_1_67 = (max (var_1_43 , var_1_51));


	// From: Req33Batch117Amount500
	if (var_1_49 <= (3.6 * var_1_62)) {
		var_1_68 = (max (var_1_17 , var_1_28));
	} else {
		if ((min (var_1_6 , var_1_23)) >= (- (max (var_1_97 , var_1_4)))) {
			if (! ((var_1_27 < var_1_97) && var_1_56)) {
				if ((var_1_76 * var_1_49) < (max ((var_1_59 * var_1_62) , (min (var_1_15 , var_1_14))))) {
			...
			if (var_1_21 < var_1_27) {
				var_1_68 = ((max (var_1_21 , var_1_23)) + var_1_28);
			}
		}
	}


	// From: Req26Batch117Amount500
	...
	if (stepLocal_4 > var_1_4) {
		...
		var_1_16 = (max ((var_1_17 - (var_1_18 - 1)) , var_1_1));
	}


	// From: Req36Batch117Amount500
	unsigned long int stepLocal_23 = max ((var_1_8 * var_1_31) , (~ var_1_1));
	unsigned short int stepLocal_22 = var_1_51;
	if (stepLocal_22 != var_1_16) {
		if (stepLocal_23 > var_1_31) {
			var_1_73 = ((max ((var_1_29 - var_1_5) , var_1_75)) - (16u + (var_1_109 + var_1_19)));
		}
	} else {
		var_1_73 = ((min (var_1_11 , var_1_19)) + var_1_18);
	}


	// From: Req42Batch117Amount500
	...
	if (var_1_86 < stepLocal_27) {
		if (stepLocal_29 != var_1_5) {
			if (stepLocal_31 > var_1_10) {
				var_1_87 = ((max (var_1_23 , var_1_88)) - (var_1_22 + var_1_21));
			} else {
			...
			if ((var_1_70 / var_1_69) <= stepLocal_30) {
				...
				if (64 <= stepLocal_32) {
					if (var_1_62 > 25.4) {
						var_1_87 = (max ((var_1_23 - (min (var_1_10 , var_1_89))) , var_1_28));
					} else {
						var_1_87 = ((min (var_1_88 , var_1_23)) - 50);
					}
				} else {
					var_1_87 = (abs (min (var_1_23 , var_1_11)));
				}
			}
		}
	} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_93 < 16u) ? ((var_1_93 >= 4u) ? (var_1_1 == ((unsigned long int) (max (((var_1_4 - var_1_5) + var_1_6) , (max (var_1_7 , var_1_8)))))) : (var_1_1 == ((unsigned long int) (max (var_1_4 , var_1_8))))) : (var_1_1 == ((unsigned long int) var_1_7))) && ((var_1_7 != var_1_44) ? (var_1_9 == ((unsigned char) ((min (var_1_10 , 0)) + var_1_11))) : 1)) && ((var_1_6 >= 64u) ? (var_1_12 == ((double) var_1_13)) : (var_1_12 == ((double) ((max (var_1_14 , 64.5)) - var_1_15))))) && ((4 > var_1_4) ? (var_1_54 ? (var_1_16 == ((unsigned short int) (((var_1_17 - 10) - var_1_1) - var_1_10))) : (var_1_16 == ((unsigned short int) var_1_17))) : (var_1_16 == ((unsigned short int) (max ((var_1_17 - (var_1_18 - 1)) , var_1_1)))))) && (var_1_19 == ((unsigned long int) (var_1_17 + (abs (var_1_6)))))) && ((var_1_46 == ((var_1_17 - var_1_43) >> (var_1_21 - var_1_22))) ? (var_1_20 == ((unsigned char) (var_1_23 - var_1_10))) : (var_1_20 == ((unsigned char) var_1_23)))) && ((((var_1_22 * var_1_10) <= var_1_18) || var_1_108) ? (var_1_24 == ((unsigned short int) (var_1_17 - var_1_21))) : ((var_1_58 == (var_1_25 - var_1_10)) ? (var_1_24 == ((unsigned short int) (max (10 , (var_1_17 - var_1_18))))) : (var_1_24 == ((unsigned short int) (min (var_1_18 , var_1_102))))))) && ((var_1_8 == var_1_31) ? (var_1_26 == ((signed short int) (max ((var_1_11 - (var_1_10 + var_1_23)) , (min (-16 , 5)))))) : (var_1_26 == ((signed short int) (min ((max (var_1_22 , var_1_10)) , var_1_21)))))) && ((var_1_5 <= (last_1_var_1_105 >> var_1_28)) ? (var_1_27 == ((unsigned long int) ((var_1_29 - var_1_5) - last_1_var_1_52))) : (var_1_27 == ((unsigned long int) var_1_17)))) && ((var_1_28 < (min ((var_1_10 - var_1_17) , -8))) ? (var_1_30 == ((signed short int) (max ((abs (abs (-64))) , (64 - (min (var_1_10 , var_1_28))))))) : 1)) && ((var_1_22 <= 10) ? ((var_1_28 >= (~ var_1_43)) ? (var_1_31 == ((unsigned long int) (var_1_22 + ((var_1_21 + var_1_10) + var_1_23)))) : 1) : ((var_1_25 >= var_1_17) ? (var_1_31 == ((unsigned long int) (var_1_18 + (abs (var_1_86))))) : (var_1_31 == ((unsigned long int) (abs (var_1_21))))))) && (var_1_32 == ((unsigned char) ((var_1_33 || var_1_34) || var_1_35)))) && (var_1_36 == ((unsigned char) (! var_1_33)))) && ((var_1_13 > var_1_103) ? (var_1_37 == ((signed char) (abs ((var_1_21 + var_1_28) + (max (var_1_22 , var_1_38)))))) : (((var_1_13 / 0.5) >= (abs (var_1_14 + var_1_15))) ? (((var_1_31 * var_1_73) > var_1_6) ? (var_1_37 == ((signed char) var_1_22)) : (var_1_37 == ((signed char) (var_1_28 + (var_1_22 + var_1_21))))) : (var_1_37 == ((signed char) var_1_21))))) && ((var_1_38 >= (var_1_19 & var_1_17)) ? ((var_1_28 < var_1_19) ? (var_1_39 == ((unsigned char) var_1_28)) : 1) : (((var_1_14 - 256.375) > var_1_13) ? (var_1_39 == ((unsigned char) (max ((var_1_11 + (var_1_21 + var_1_28)) , (var_1_22 + var_1_10))))) : 1))) && (var_1_78 ? (var_1_40 == ((unsigned char) ((var_1_11 <= (var_1_23 - var_1_10)) && var_1_35))) : 1)) && (var_1_41 == ((double) (max (var_1_14 , -0.25))))) && ((var_1_13 >= (min (var_1_41 , var_1_14))) ? ((var_1_58 < (var_1_52 / (max (var_1_25 , var_1_17)))) ? (var_1_42 == ((unsigned long int) (var_1_29 - var_1_10))) : 1) : 1)) && ((10000.8 >= (max (var_1_14 , (var_1_15 / 0.75)))) ? (var_1_43 == ((unsigned long int) (var_1_17 + var_1_5))) : (var_1_43 == ((unsigned long int) var_1_17)))) && (((var_1_29 <= var_1_6) || (var_1_27 < var_1_26)) ? (var_1_44 == ((unsigned long int) (min ((var_1_22 + (min (var_1_70 , var_1_86))) , (var_1_10 + var_1_21))))) : (var_1_35 ? (var_1_44 == ((unsigned long int) (var_1_29 - ((min (var_1_70 , var_1_86)) + (min (var_1_28 , var_1_5)))))) : (var_1_44 == ((unsigned long int) ((var_1_4 + var_1_45) - (max ((abs (var_1_22)) , var_1_26)))))))) && (var_1_46 == ((signed long int) (var_1_5 - var_1_10)))) && ((var_1_19 != ((var_1_10 - var_1_18) % var_1_17)) ? ((var_1_45 >= ((abs (var_1_64)) + 2u)) ? (var_1_47 == ((double) var_1_13)) : (var_1_47 == ((double) (var_1_48 + (min (256.2 , (min (var_1_49 , var_1_50)))))))) : 1)) && ((((var_1_14 - var_1_15) > (var_1_13 * var_1_76)) && ((100 << var_1_52) == var_1_4)) ? (var_1_51 == ((unsigned short int) (var_1_17 - 16))) : (var_1_51 == ((unsigned short int) (var_1_52 + (var_1_64 + var_1_11)))))) && (((var_1_48 < (var_1_14 - var_1_15)) && (var_1_86 > var_1_107)) ? (var_1_52 == ((signed long int) (max (var_1_28 , var_1_43)))) : 1)) && ((var_1_35 || var_1_34) ? (var_1_53 == ((double) var_1_13)) : 1)) && ((((var_1_64 ^ var_1_67) > var_1_52) && (! (var_1_21 <= var_1_58))) ? ((var_1_33 || (var_1_101 >= var_1_58)) ? ((var_1_93 >= var_1_67) ? (var_1_54 == ((unsigned char) (var_1_55 && var_1_56))) : (var_1_54 == ((unsigned char) ((var_1_4 >= var_1_67) && var_1_35)))) : (var_1_54 == ((unsigned char) (! var_1_35)))) : (var_1_72 ? (var_1_54 == ((unsigned char) var_1_56)) : 1))) && ((10 <= (var_1_93 / var_1_17)) ? (var_1_108 ? (var_1_57 == ((unsigned char) var_1_34)) : (var_1_57 == ((unsigned char) var_1_33))) : (var_1_57 == ((unsigned char) (var_1_56 && var_1_55))))) && (((var_1_103 / (max (var_1_59 , var_1_60))) <= (var_1_13 / var_1_61)) ? (var_1_58 == ((unsigned long int) (var_1_29 - var_1_5))) : (var_1_58 == ((unsigned long int) ((var_1_29 - var_1_93) - var_1_5))))) && ((-0.625f >= (var_1_60 + (var_1_47 + var_1_61))) ? (((var_1_29 - 2u) >= 8u) ? (var_1_62 == ((double) (var_1_14 - var_1_15))) : (var_1_62 == ((double) var_1_48))) : 1)) && ((((var_1_23 - 100000) * (var_1_65 - var_1_52)) >= (var_1_96 & -4)) ? ((var_1_24 <= var_1_102) ? (var_1_64 == ((unsigned long int) (max ((var_1_29 - var_1_45) , var_1_28)))) : (var_1_64 == ((unsigned long int) (((max (var_1_4 , var_1_45)) - var_1_22) + var_1_17)))) : (var_1_64 == ((unsigned long int) var_1_96)))) && (var_1_66 == ((signed short int) (16 - var_1_96)))) && (var_1_67 == ((signed long int) (max (var_1_43 , var_1_51))))) && ((var_1_49 <= (3.6 * var_1_62)) ? (var_1_68 == ((signed short int) (max (var_1_17 , var_1_28)))) : (((min (var_1_6 , var_1_23)) >= (- (max (var_1_97 , var_1_4)))) ? ((! ((var_1_27 < var_1_97) && var_1_56)) ? (((var_1_76 * var_1_49) < (max ((var_1_59 * var_1_62) , (min (var_1_15 , var_1_14))))) ? (var_1_68 == ((signed short int) (var_1_44 + (var_1_27 + (var_1_23 + var_1_22))))) : (var_1_68 == ((signed short int) (var_1_10 - (var_1_69 - 5))))) : 1) : ((var_1_21 < var_1_27) ? (var_1_68 == ((signed short int) ((max (var_1_21 , var_1_23)) + var_1_28))) : 1)))) && (var_1_70 == ((signed long int) ((var_1_71 - var_1_21) - (1431246933 - (var_1_10 + var_1_17)))))) && (((abs (var_1_10)) < (4 - (min (var_1_44 , 256)))) ? (var_1_72 == ((unsigned char) (var_1_78 || (! var_1_33)))) : 1)) && ((var_1_51 != var_1_16) ? (((max ((var_1_8 * var_1_31) , (~ var_1_1))) > var_1_31) ? (var_1_73 == ((unsigned long int) ((max ((var_1_29 - var_1_5) , var_1_75)) - (16u + (var_1_109 + var_1_19))))) : 1) : (var_1_73 == ((unsigned long int) ((min (var_1_11 , var_1_19)) + var_1_18))))) && ((var_1_31 <= (var_1_11 - var_1_69)) ? ((! (var_1_1 < var_1_10)) ? (var_1_76 == ((double) (max (((max (15.3 , var_1_50)) + var_1_77) , var_1_49)))) : 1) : 1)) && ((var_1_108 || (var_1_100 > var_1_25)) ? (var_1_108 ? (var_1_78 == ((unsigned char) (var_1_55 && var_1_56))) : 1) : ((var_1_17 <= var_1_93) ? (var_1_78 == ((unsigned char) (! 0))) : ((((var_1_103 * var_1_50) * (var_1_41 / var_1_59)) > var_1_49) ? (var_1_78 == ((unsigned char) (var_1_56 && var_1_34))) : 1)))) && (var_1_79 == ((float) (((var_1_80 + var_1_81) + var_1_82) - (max ((var_1_83 + var_1_84) , (4.4f + 256.5f))))))) && ((! (var_1_23 >= (var_1_42 / var_1_21))) ? (var_1_85 == ((float) (var_1_80 + ((31.5f + var_1_81) - var_1_82)))) : (var_1_85 == ((float) (max (var_1_15 , ((var_1_81 + var_1_80) + var_1_49))))))) && ((100000 <= var_1_17) ? (var_1_86 == ((unsigned long int) ((var_1_10 + 1u) + (min (var_1_46 , 0u))))) : ((var_1_81 < (8.5f - var_1_82)) ? (var_1_86 == ((unsigned long int) var_1_70)) : 1))) && ((var_1_86 < var_1_45) ? ((var_1_26 != var_1_5) ? ((var_1_65 > var_1_10) ? (var_1_87 == ((unsigned char) ((max (var_1_23 , var_1_88)) - (var_1_22 + var_1_21)))) : (var_1_87 == ((unsigned char) (16 + (var_1_89 - var_1_22))))) : (((var_1_70 / var_1_69) <= var_1_67) ? (((var_1_67 & var_1_21) <= (var_1_6 - var_1_106)) ? (var_1_87 == ((unsigned char) (min (var_1_89 , 64)))) : (var_1_87 == ((unsigned char) var_1_23))) : ((64 <= (var_1_19 + var_1_1)) ? ((var_1_62 > 25.4) ? (var_1_87 == ((unsigned char) (max ((var_1_23 - (min (var_1_10 , var_1_89))) , var_1_28)))) : (var_1_87 == ((unsigned char) ((min (var_1_88 , var_1_23)) - 50)))) : (var_1_87 == ((unsigned char) (abs (min (var_1_23 , var_1_11)))))))) : ((var_1_59 < (var_1_112 * (var_1_81 * var_1_14))) ? ((var_1_73 < var_1_93) ? (var_1_87 == ((unsigned char) ((200 - (var_1_28 + var_1_21)) - (25 + var_1_22)))) : (var_1_33 ? (var_1_87 == ((unsigned char) (var_1_11 + var_1_21))) : 1)) : (var_1_87 == ((unsigned char) var_1_23))))) && (var_1_91 == ((unsigned char) var_1_56))) && (var_1_92 == ((float) var_1_13))) && (last_1_var_1_40 ? (var_1_93 == ((unsigned long int) var_1_18)) : (var_1_93 == ((unsigned long int) var_1_94)))) && (var_1_36 ? (var_1_95 == ((float) var_1_77)) : 1)) && (var_1_96 == ((unsigned short int) var_1_11))) && (var_1_97 == ((signed long int) var_1_98))) && (var_1_99 == ((unsigned char) var_1_10))) && (var_1_100 == ((signed short int) -256))) && (var_1_101 == ((unsigned short int) var_1_10))) && (var_1_55 ? (var_1_102 == ((signed short int) var_1_106)) : (var_1_102 == ((signed short int) var_1_10)))) && (var_1_103 == ((double) var_1_13))) && (var_1_104 == ((signed short int) var_1_21))) && (var_1_105 == ((unsigned char) var_1_23))) && (var_1_106 == ((signed short int) var_1_23))) && (var_1_72 ? (var_1_107 == ((unsigned char) var_1_22)) : 1)) && (last_1_var_1_57 ? (var_1_108 == ((unsigned char) var_1_34)) : 1)) && (var_1_91 ? (var_1_109 == ((unsigned short int) var_1_69)) : (var_1_109 == ((unsigned short int) last_1_var_1_109)))) && (var_1_40 ? (var_1_110 == ((signed char) var_1_38)) : (var_1_110 == ((signed char) 10)))) && (var_1_57 ? (var_1_111 == ((float) var_1_14)) : 1)) && (var_1_112 == ((float) (max (((min (var_1_82 , var_1_84)) - var_1_81) , var_1_14))))) && ((25u <= (var_1_42 + var_1_94)) ? (var_1_113 == ((signed short int) (min (var_1_38 , var_1_30)))) : 1)
;
}
int main(void) {
	isInitial = 1;
