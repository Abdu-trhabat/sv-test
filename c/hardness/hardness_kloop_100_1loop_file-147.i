...
void step(void) {
 ...
 if (-1 > stepLocal_3) {
  var_1_14 = ((((var_1_15 - last_1_var_1_6) < 0 ) ? -(var_1_15 - last_1_var_1_6) : (var_1_15 - last_1_var_1_6)));
 }
 unsigned long int stepLocal_0 = var_1_14 >> var_1_3;
 if (stepLocal_0 < var_1_14) {
  var_1_1 = ((((((((var_1_3) < (256)) ? (var_1_3) : (256)))) > ((var_1_5 - var_1_14))) ? (((((var_1_3) < (256)) ? (var_1_3) : (256)))) : ((var_1_5 - var_1_14))));
 }
 ...
 if (var_1_1 < stepLocal_6) {
  ...
  if ((var_1_5 * var_1_14) < stepLocal_5) {
   if (stepLocal_4 && var_1_22) {
    ...
    var_1_20 = ((((var_1_12) > (var_1_19)) ? (var_1_12) : (var_1_19)));
   }
  }
 }
 var_1_30 = var_1_26;
 ...
 if (var_1_23 < var_1_12) {
  ...
  if ((var_1_1 + var_1_11) > (((((var_1_5 - var_1_1)) > (var_1_14)) ? ((var_1_5 - var_1_1)) : (var_1_14)))) {
   if (! (var_1_13 <= var_1_1)) {
 ...
 signed long int stepLocal_1 = (var_1_27 % var_1_5) + ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)));
 if ((var_1_3 << (var_1_9 + 1)) != stepLocal_1) {
  var_1_8 = (var_1_3 + var_1_9);
 }
 if (var_1_6 != var_1_4) {
  var_1_16 = (((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))) + var_1_19);
 } else {
...
int property(void) {
 return ((((((((((((var_1_14 >> var_1_3) < var_1_14) ? (var_1_1 == ((unsigned short int) ((((((((var_1_3) < (256)) ? (var_1_3) : (256)))) > ((var_1_5 - var_1_14))) ? (((((var_1_3) < (256)) ? (var_1_3) : (256)))) : ((var_1_5 - var_1_14)))))) : 1) && (var_1_30 ? (var_1_6 == ((unsigned char) ((((2) < 0 ) ? -(2) : (2))))) : ((! (var_1_3 < (var_1_14 * var_1_13))) ? ((var_1_1 > var_1_3) ? (var_1_6 == ((unsigned char) var_1_3)) : 1) : (var_1_6 == ((unsigned char) var_1_3))))) && (((var_1_3 << (var_1_9 + 1)) != ((var_1_27 % var_1_5) + ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13))))) ? (var_1_8 == ((signed char) (var_1_3 + var_1_9))) : 1)) && ((var_1_5 >= (var_1_11 - (128 + var_1_14))) ? (var_1_10 == ((double) var_1_12)) : (var_1_30 ? (var_1_10 == ((double) var_1_12)) : (var_1_10 == ((double) 128.5))))) && ((last_1_var_1_10 > var_1_12) ? (var_1_13 == ((signed short int) (((var_1_9 + last_1_var_1_27) + var_1_3) - last_1_var_1_6))) : (var_1_13 == ((signed short int) last_1_var_1_6)))) && ((-1 > var_1_3) ? (var_1_14 == ((unsigned long int) ((((var_1_15 - last_1_var_1_6) < 0 ) ? -(var_1_15 - last_1_var_1_6) : (var_1_15 - last_1_var_1_6))))) : 1)) && ((var_1_6 != var_1_4) ? (var_1_16 == ((float) (((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))) + var_1_19))) : (((var_1_14 < var_1_6) && var_1_30) ? (var_1_16 == ((float) var_1_12)) : (var_1_16 == ((float) var_1_19))))) && ((var_1_1 < var_1_3) ? (var_1_20 == ((float) (var_1_19 + var_1_17))) : (((var_1_5 * var_1_14) < var_1_1) ? ((var_1_7 && var_1_22) ? (var_1_20 == ((float) (var_1_23 - 0.8f))) : (var_1_20 == ((float) ((((var_1_12) > (var_1_19)) ? (var_1_12) : (var_1_19)))))) : 1))) && ((var_1_13 < var_1_14) ? (var_1_24 == ((unsigned char) ((var_1_12 >= var_1_10) && var_1_25))) : (var_1_30 ? ((var_1_17 >= var_1_12) ? ((var_1_14 >= var_1_5) ? (var_1_24 == ((unsigned char) var_1_25)) : 1) : (var_1_24 == ((unsigned char) var_1_26))) : (var_1_24 == ((unsigned char) var_1_25))))) && ((var_1_23 < var_1_12) ? ((5u >= var_1_5) ? (var_1_27 == ((unsigned short int) (4 + var_1_3))) : 1) : (((var_1_1 + var_1_11) > (((((var_1_5 - var_1_1)) > (var_1_14)) ? ((var_1_5 - var_1_1)) : (var_1_14)))) ? ((! (var_1_13 <= var_1_1)) ? (var_1_27 == ((unsigned short int) (var_1_1 + var_1_29))) : 1) : 1))) && (var_1_30 == ((unsigned char) var_1_26))
;
}
int main(void) {
 isInitial = 1;
