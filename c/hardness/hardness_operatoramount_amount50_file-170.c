...
void step(void) {
	...
	// From: Req1Batch170Amount50
	if (var_1_4) {
		var_1_1 = var_1_3;
	}


	// From: Req5Batch170Amount50
	if (var_1_10 > (var_1_10 / (abs (var_1_18)))) {
		var_1_17 = var_1_16;
	}


	// From: Req7Batch170Amount50
	var_1_21 = var_1_3;


	// From: Req4Batch170Amount50
