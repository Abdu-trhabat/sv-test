...
void step(void) {
	// From: Req16Batch113Amount250
	if (! (last_1_var_1_69 < var_1_35)) {
		var_1_53 = (var_1_54 - var_1_34);
	} else {
		if ((- var_1_25) >= var_1_44) {
			var_1_53 = (min (((var_1_33 + var_1_55) - (min (var_1_37 , var_1_36))) , var_1_11));
		} else {
			var_1_53 = (min ((abs (var_1_37)) , ((max (var_1_54 , var_1_56)) - var_1_34)));
		}
	}


	// From: Req5Batch113Amount250
	if (var_1_20 || last_1_var_1_61) {
		var_1_23 = (max (15.25 , var_1_24));
	} else {
		var_1_23 = (var_1_25 + var_1_26);
	}


	// From: Req2Batch113Amount250
	...
	// From: Req7Batch113Amount250
	if (var_1_4 > var_1_9) {
		var_1_28 = var_1_26;
	}


	// From: Req11Batch113Amount250
	...
	// From: Req3Batch113Amount250
	var_1_15 = 16;


	// From: Req12Batch113Amount250
	if (2 > (var_1_5 / (max (var_1_37 , var_1_36)))) {
		var_1_45 = (40684 - ((31497 - last_1_var_1_45) - var_1_11));
	}


	// From: Req13Batch113Amount250
	signed long int stepLocal_7 = var_1_8 * var_1_45;
	if (var_1_23 == var_1_41) {
		if (stepLocal_7 <= var_1_3) {
			var_1_46 = (((min (var_1_44 , var_1_43)) + var_1_47) + (var_1_48 - var_1_49));
		} else {
			var_1_46 = (var_1_48 - (abs (var_1_49)));
		}
	} else {
	...
	// From: Req15Batch113Amount250
	if (var_1_45 > var_1_37) {
		if (var_1_23 >= var_1_41) {
			var_1_52 = (abs (100 + var_1_40));
		}
	} else {
		var_1_52 = (min ((max (var_1_40 , var_1_33)) , ((var_1_36 - var_1_37) + var_1_34)));
	}


	// From: Req10Batch113Amount250
	if (var_1_30 && var_1_61) {
		var_1_38 = (var_1_35 + (abs (var_1_37 - var_1_40)));
	} else {
		var_1_38 = (var_1_37 + var_1_40);
	}


	// From: Req1Batch113Amount250
	if (var_1_61) {
	...
	// From: Req23Batch113Amount250
	if (var_1_46 > 0.8f) {
		if (var_1_21 >= 10.75) {
			if ((max ((var_1_7 / var_1_51) , var_1_53)) >= 2) {
	...
	// From: Req14Batch113Amount250
	var_1_50 = (((var_1_5 + var_1_51) - (max (var_1_6 , var_1_52))) - (var_1_37 + (10000 - var_1_34)));


	// From: Req21Batch113Amount250
	...
	if (var_1_8 >= stepLocal_12) {
		if ((var_1_54 - (var_1_37 + var_1_40)) >= stepLocal_13) {
			var_1_66 = (min (((1910134613u + var_1_67) - var_1_35) , last_1_var_1_66));
		}
	} else {
		var_1_66 = var_1_54;
	}
	...
	// From: Req4Batch113Amount250
	if ((min ((min (var_1_23 , var_1_41)) , var_1_28)) < (- var_1_46)) {
		if (var_1_5 < 50) {
	...
	// From: Req20Batch113Amount250
	if (var_1_16 && var_1_30) {
		if (last_1_var_1_64 > var_1_50) {
			var_1_64 = (max ((var_1_55 + var_1_56) , var_1_51));
		} else {
			var_1_64 = (max (-1 , (var_1_65 - var_1_55)));
		}
	} else {
		var_1_64 = var_1_55;
	}
...
int property(void) {
	return ((((((((((((((((((((((var_1_61 ? (var_1_1 == ((unsigned short int) (max (var_1_3 , var_1_4)))) : (var_1_1 == ((unsigned short int) (((var_1_5 - var_1_6) + var_1_7) - var_1_8)))) && (((var_1_10 - var_1_11) != var_1_8) ? (var_1_9 == ((unsigned long int) last_1_var_1_45)) : (((25.8f + last_1_var_1_27) >= last_1_var_1_41) ? (var_1_9 == ((unsigned long int) ((var_1_14 - var_1_5) + (abs (var_1_8))))) : 1))) && (var_1_15 == ((signed short int) 16))) && (((min ((min (var_1_23 , var_1_41)) , var_1_28)) < (- var_1_46)) ? ((var_1_5 < 50) ? ((((var_1_10 - var_1_5) * var_1_66) < (var_1_9 & var_1_4)) ? (var_1_16 == ((unsigned char) (! var_1_20))) : (((var_1_46 * (var_1_23 / var_1_21)) == (- var_1_28)) ? (var_1_16 == ((unsigned char) var_1_20)) : (var_1_16 == ((unsigned char) var_1_22)))) : (var_1_16 == ((unsigned char) var_1_22))) : (var_1_16 == ((unsigned char) 0)))) && ((var_1_20 || last_1_var_1_61) ? (var_1_23 == ((double) (max (15.25 , var_1_24)))) : (var_1_23 == ((double) (var_1_25 + var_1_26))))) && ((var_1_10 >= var_1_7) ? (var_1_27 == ((float) (abs (var_1_25)))) : ((var_1_57 && (var_1_5 <= var_1_64)) ? ((! ((var_1_8 % 128) != var_1_64)) ? ((var_1_10 >= var_1_45) ? (var_1_27 == ((float) var_1_26)) : (var_1_27 == ((float) var_1_24))) : (var_1_27 == ((float) var_1_25))) : 1))) && ((var_1_4 > var_1_9) ? (var_1_28 == ((double) var_1_26)) : 1)) && ((var_1_26 <= (var_1_41 + (- var_1_46))) ? (var_1_30 == ((unsigned char) (! (var_1_22 && var_1_20)))) : 1)) && ((var_1_10 >= (var_1_64 / var_1_32)) ? (var_1_31 == ((unsigned char) ((var_1_33 + (var_1_34 + var_1_35)) - (var_1_36 - (var_1_37 - 1))))) : 1)) && ((var_1_30 && var_1_61) ? (var_1_38 == ((signed char) (var_1_35 + (abs (var_1_37 - var_1_40))))) : (var_1_38 == ((signed char) (var_1_37 + var_1_40))))) && ((last_1_var_1_38 >= last_1_var_1_50) ? ((last_1_var_1_57 && last_1_var_1_61) ? (var_1_41 == ((double) ((var_1_43 + var_1_44) + var_1_26))) : 1) : 1)) && ((2 > (var_1_5 / (max (var_1_37 , var_1_36)))) ? (var_1_45 == ((unsigned short int) (40684 - ((31497 - last_1_var_1_45) - var_1_11)))) : 1)) && ((var_1_23 == var_1_41) ? (((var_1_8 * var_1_45) <= var_1_3) ? (var_1_46 == ((double) (((min (var_1_44 , var_1_43)) + var_1_47) + (var_1_48 - var_1_49)))) : (var_1_46 == ((double) (var_1_48 - (abs (var_1_49)))))) : (var_1_46 == ((double) (var_1_43 + var_1_47))))) && (var_1_50 == ((unsigned short int) (((var_1_5 + var_1_51) - (max (var_1_6 , var_1_52))) - (var_1_37 + (10000 - var_1_34)))))) && ((var_1_45 > var_1_37) ? ((var_1_23 >= var_1_41) ? (var_1_52 == ((unsigned char) (abs (100 + var_1_40)))) : 1) : (var_1_52 == ((unsigned char) (min ((max (var_1_40 , var_1_33)) , ((var_1_36 - var_1_37) + var_1_34))))))) && ((! (last_1_var_1_69 < var_1_35)) ? (var_1_53 == ((unsigned char) (var_1_54 - var_1_34))) : (((- var_1_25) >= var_1_44) ? (var_1_53 == ((unsigned char) (min (((var_1_33 + var_1_55) - (min (var_1_37 , var_1_36))) , var_1_11)))) : (var_1_53 == ((unsigned char) (min ((abs (var_1_37)) , ((max (var_1_54 , var_1_56)) - var_1_34)))))))) && (((var_1_6 / var_1_55) >= var_1_33) ? (((- var_1_6) < var_1_36) ? (var_1_20 ? (var_1_30 ? (var_1_57 == ((unsigned char) (var_1_30 && ((var_1_30 && var_1_58) || var_1_59)))) : (var_1_57 == ((unsigned char) var_1_22))) : ((var_1_22 || (var_1_26 > var_1_28)) ? (var_1_57 == ((unsigned char) (var_1_58 || var_1_59))) : (var_1_57 == ((unsigned char) (var_1_22 || var_1_60))))) : 1) : (var_1_57 == ((unsigned char) var_1_22)))) && ((var_1_46 < (var_1_21 / 99.5)) ? ((-4 < var_1_14) ? (var_1_61 == ((unsigned char) ((128 <= var_1_9) && (var_1_59 && var_1_20)))) : 1) : (var_1_61 == ((unsigned char) ((var_1_15 > (var_1_55 << var_1_32)) || (var_1_60 && (! var_1_59))))))) && ((var_1_1 != (var_1_9 / var_1_37)) ? ((var_1_34 >= (var_1_8 << var_1_6)) ? (var_1_62 == ((unsigned char) (max (var_1_33 , var_1_34)))) : (var_1_62 == ((unsigned char) (min (var_1_11 , 8))))) : (var_1_62 == ((unsigned char) ((var_1_33 - (32 - var_1_63)) + var_1_11))))) && ((var_1_16 && var_1_30) ? ((last_1_var_1_64 > var_1_50) ? (var_1_64 == ((signed long int) (max ((var_1_55 + var_1_56) , var_1_51)))) : (var_1_64 == ((signed long int) (max (-1 , (var_1_65 - var_1_55)))))) : (var_1_64 == ((signed long int) var_1_55)))) && ((var_1_8 >= var_1_55) ? (((var_1_54 - (var_1_37 + var_1_40)) >= (var_1_50 / var_1_33)) ? (var_1_66 == ((unsigned long int) (min (((1910134613u + var_1_67) - var_1_35) , last_1_var_1_66)))) : 1) : (var_1_66 == ((unsigned long int) var_1_54)))) && ((var_1_48 > ((var_1_46 + var_1_41) * (var_1_25 * var_1_46))) ? (var_1_68 == ((signed short int) var_1_54)) : (var_1_68 == ((signed short int) var_1_50)))) && ((var_1_46 > 0.8f) ? ((var_1_21 >= 10.75) ? (((max ((var_1_7 / var_1_51) , var_1_53)) >= 2) ? (var_1_69 == ((signed char) ((var_1_70 - var_1_37) - var_1_63))) : 1) : (var_1_69 == ((signed char) var_1_37))) : 1)
;
}
int main(void) {
	isInitial = 1;
