...
void step(void) {
	...
	// From: Req2Batch171Wrapper_AP
	if (((min ((*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) , 15.8f)) - ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) + (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)))) != (min ((max (-0.05f , (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)))) , (*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer))))) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) || stepLocal_0) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = (min ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var5_Pointer)) , (min ((max ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var4_Pointer))))));
	} else {
