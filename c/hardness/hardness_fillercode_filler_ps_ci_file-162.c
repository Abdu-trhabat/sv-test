...
void step(void) {
	...
	// From: CodeObject2
	/* 318L, 148L) */ if (var_1_9) {
		/* 320L, 146L) */ if (/* 321L, 116L, 117L) */ ((/* 322L, 110L, 118L) */ ((var_1_1) * (/* 324L, 109L, 120L) */ (abs (var_1_12))))) >= (/* 326L, 115L, 122L) */ (min (/* 326L, 115L, 122L) */ (var_1_6) , (/* 328L, 114L, 124L) */ ((var_1_1) * (var_1_13)))))))) {
			/* 331L, 141L) */ var_1_29 = (
				/* 334L, 140L) */ (abs (
					var_1_26
				))
	...
	// From: CodeObject3
	/* 354L, 178L) */ if (/* 355L, 156L, 157L) */ ((/* 356L, 154L, 158L) */ ((var_1_26) ^ (var_1_10))) >= (var_1_27))) {
		/* 360L, 176L) */ if (var_1_9) {
			/* 362L, 175L) */ var_1_35 = (
				/* 365L, 174L) */ (min (
					/* 365L, 174L) */ (
						var_1_36
	...
	// From: CodeObject6
	/* 405L, 247L) */ if (/* 406L, 211L, 212L) */ ((var_1_12) <= (/* 408L, 210L, 214L) */ ((/* 409L, 208L, 215L) */ (max (/* 409L, 208L, 215L) */ (var_1_12) , (32.4f)))) + (var_1_1))))) {
		/* 413L, 240L) */ if (/* 414L, 228L, 229L) */ ((var_1_12) > (var_1_37))) {
			/* 417L, 239L) */ var_1_43 = (
				/* 420L, 238L) */ (abs (
					256
				))
	...
	// From: CodeObject7
	/* 427L, 293L) */ if (/* 428L, 254L, 255L) */ ((var_1_3) <= (/* 430L, 253L, 257L) */ (abs (var_1_22))))) {
	...
	// From: Req6Batch162Filler_PS_CI
	/* 1152L, 308L, 904L, 910L) */ var_1_20 = (
		var_1_21
	);


	// From: Req7Batch162Filler_PS_CI
	/* 1158L, 318L, 928L, 934L) */ var_1_22 = (
		1
	);


	// From: Req2Batch162Filler_PS_CI
