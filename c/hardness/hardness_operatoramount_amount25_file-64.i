...
int property(void) {
 return (((((var_1_13 <= (var_1_3 - var_1_4)) ? ((var_1_3 < (var_1_4 * var_1_13)) ? (var_1_1 == ((double) var_1_5)) : (var_1_1 == ((double) 10.8))) : 1) && (var_1_6 == ((signed long int) ((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8)))))) && ((! (var_1_4 <= (var_1_3 - 32u))) ? ((var_1_1 < ((- var_1_5) + var_1_1)) ? ((var_1_4 > (var_1_13 >> var_1_11)) ? (var_1_9 == ((float) var_1_5)) : 1) : 1) : (var_1_9 == ((float) var_1_5)))) && (var_1_12 == ((unsigned char) var_1_11))) && (var_1_13 == ((unsigned long int) var_1_11))
;
}
int main(void) {
 isInitial = 1;
