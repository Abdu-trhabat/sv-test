...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch130Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
   ...
   var_1_35
                   ...
                   if ( (( (((((var_1_1)) > (( ((var_1_45) - (3.2f))))) ? ((var_1_1)) : (( ((var_1_45) - (3.2f))))))) <= (var_1_1))) {
