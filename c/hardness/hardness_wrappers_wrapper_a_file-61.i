...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch61Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 if (float_Array_0[1][1] < float_Array_0[0][1]) {
  ...
  if (float_Array_0[0][1] >= float_Array_0[1][1]) {
 ...
 if (double_Array_0[0] < ((((float_Array_0[0][0]) > (double_Array_0[0])) ? (float_Array_0[0][0]) : (double_Array_0[0])))) {
...
int property(void) {
 return (((((((float_Array_0[1][1] < float_Array_0[0][1]) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) (BOOL_unsigned_char_Array_0[0][1] || BOOL_unsigned_char_Array_0[1][0]))) : ((float_Array_0[0][1] >= float_Array_0[1][1]) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0])) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[0][0])))) && ((double_Array_0[0] < ((((float_Array_0[0][0]) > (double_Array_0[0])) ? (float_Array_0[0][0]) : (double_Array_0[0])))) ? (unsigned_char_Array_0[5] == ((unsigned char) (unsigned_char_Array_0[2] - unsigned_char_Array_0[3]))) : 1)) && (BOOL_unsigned_char_Array_0[0][0] ? (unsigned_char_Array_0[4] == ((unsigned char) (unsigned_char_Array_0[3] + ((((unsigned_char_Array_0[0]) > (unsigned_char_Array_0[1])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[1])))))) : (unsigned_char_Array_0[4] == ((unsigned char) (((64 + unsigned_char_Array_0[8]) + (unsigned_char_Array_0[9] + unsigned_char_Array_0[6])) - (unsigned_char_Array_0[7] + unsigned_char_Array_0[10])))))) && ((BOOL_unsigned_char_Array_0[1][0] || (BOOL_unsigned_char_Array_0[0][0] || BOOL_unsigned_char_Array_0[0][1])) ? (signed_char_Array_0[0] == ((signed char) unsigned_char_Array_0[9])) : 1)) && (float_Array_0[0][0] == ((float) float_Array_0[1][0]))) && (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_char_Array_0[10]))) && (double_Array_0[0] == ((double) 0.010000000000000009))
;
}
int main(void) {
 isInitial = 1;
