...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch101dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch101dependencies
	if (var_1_2) {
		var_1_1 = (((1000000000 - 64) + var_1_3) - var_1_4);
	}


	// From: Req2Batch101dependencies
	if (var_1_2 || var_1_6) {
		if ((- var_1_4) <= var_1_1) {
			var_1_5 = 5;
		}
	...
	// From: Req4Batch101dependencies
	if (((max (var_1_4 , var_1_13)) <= var_1_14) || var_1_6) {
		var_1_15 = var_1_13;
	}


	// From: Req5Batch101dependencies
	if (var_1_5 < 0) {
		if (var_1_2) {
			var_1_16 = var_1_17;
		}
	...
	// From: Req7Batch101dependencies
	if ((var_1_17 / var_1_10) <= var_1_16) {
		var_1_22 = (abs (min (var_1_12 , (var_1_13 + var_1_15))));
	}


	// From: Req8Batch101dependencies
	var_1_23 = var_1_13;


	// From: Req3Batch101dependencies
