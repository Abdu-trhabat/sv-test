...
void step(void) {
	...
	// From: Req2Batch193100_while
	if (var_1_4) {
		var_1_5 = (max (var_1_6 , (abs (var_1_7))));
	}


	// From: Req6Batch193100_while
	if (var_1_4) {
		var_1_16 = var_1_17;
	} else {
	...
	// From: Req7Batch193100_while
	if (var_1_13 >= var_1_11) {
		var_1_21 = (var_1_22 + 8);
	} else {
		var_1_21 = (min (var_1_22 , var_1_23));
	}


	// From: Req8Batch193100_while
	var_1_24 = (min (var_1_13 , var_1_11));


	// From: Req9Batch193100_while
	signed long int stepLocal_5 = max (var_1_5 , (var_1_15 / var_1_10));
	signed long int stepLocal_4 = (var_1_22 + var_1_23) - var_1_5;
	if (stepLocal_4 <= (var_1_8 / (min (var_1_15 , var_1_10)))) {
	...
	// From: Req10Batch193100_while
	signed long int stepLocal_6 = min (var_1_25 , var_1_21);
	if ((32 ^ var_1_5) > stepLocal_6) {
		var_1_26 = (var_1_17 || ((var_1_27 || var_1_28) || var_1_29));
	}


	// From: Req1Batch193100_while
	...
	// From: Req5Batch193100_while
	if (var_1_7 > (var_1_5 * var_1_8)) {
		var_1_14 = (abs (255.375));
	} else {
	...
	if (var_1_13 <= (- var_1_14)) {
		...
		if ((var_1_8 / var_1_10) == var_1_7) {
			var_1_30 = (max (((max (var_1_31 , var_1_32)) + var_1_13) , ((var_1_12 - var_1_33) - (5.645110326468543E18 - var_1_34))));
		}
	}


	// From: Req12Batch193100_while
...
int property(void) {
	return ((((((((((((var_1_5 == var_1_8) ? (var_1_1 == ((unsigned char) (! var_1_4))) : ((var_1_8 < var_1_5) ? (var_1_1 == ((unsigned char) var_1_4)) : 1)) && (var_1_4 ? (var_1_5 == ((unsigned short int) (max (var_1_6 , (abs (var_1_7)))))) : 1)) && ((last_1_var_1_35 >= var_1_7) ? (var_1_8 == ((signed long int) (var_1_7 + last_1_var_1_5))) : (var_1_8 == ((signed long int) (var_1_6 - last_1_var_1_5))))) && (((var_1_5 / var_1_10) <= var_1_35) ? (var_1_9 == ((float) (var_1_11 - (var_1_12 - var_1_13)))) : 1)) && ((var_1_7 > (var_1_5 * var_1_8)) ? (var_1_14 == ((double) (abs (255.375)))) : ((var_1_10 < (5 / var_1_15)) ? (var_1_14 == ((double) var_1_11)) : (var_1_14 == ((double) var_1_12))))) && (var_1_4 ? (var_1_16 == ((unsigned char) var_1_17)) : (var_1_16 == ((unsigned char) ((var_1_18 && var_1_19) && var_1_20))))) && ((var_1_13 >= var_1_11) ? (var_1_21 == ((unsigned char) (var_1_22 + 8))) : (var_1_21 == ((unsigned char) (min (var_1_22 , var_1_23)))))) && (var_1_24 == ((float) (min (var_1_13 , var_1_11))))) && ((((var_1_22 + var_1_23) - var_1_5) <= (var_1_8 / (min (var_1_15 , var_1_10)))) ? (((max (var_1_5 , (var_1_15 / var_1_10))) < var_1_8) ? (var_1_25 == ((unsigned char) var_1_23)) : (var_1_25 == ((unsigned char) 1))) : (var_1_25 == ((unsigned char) 16)))) && (((32 ^ var_1_5) > (min (var_1_25 , var_1_21))) ? (var_1_26 == ((unsigned char) (var_1_17 || ((var_1_27 || var_1_28) || var_1_29)))) : 1)) && ((var_1_13 <= (- var_1_14)) ? ((! var_1_18) ? (var_1_30 == ((double) ((var_1_13 - 255.6) + var_1_31))) : (var_1_30 == ((double) ((var_1_12 - 8.65) - (var_1_13 + var_1_32))))) : (((var_1_8 / var_1_10) == var_1_7) ? (var_1_30 == ((double) (max (((max (var_1_31 , var_1_32)) + var_1_13) , ((var_1_12 - var_1_33) - (5.645110326468543E18 - var_1_34)))))) : 1))) && (((var_1_6 <= (var_1_8 | var_1_22)) || ((- var_1_30) < var_1_34)) ? ((var_1_32 <= var_1_13) ? (var_1_35 == ((signed long int) var_1_10)) : (var_1_35 == ((signed long int) var_1_8))) : (var_1_35 == ((signed long int) var_1_8)))
;
}
int main(void) {
	isInitial = 1;
