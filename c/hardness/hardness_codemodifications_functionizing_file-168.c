...
signed long int functionized3(unsigned char functionized3_localFunctionVar0) {
	return (min ((var_1_16 + var_1_17) , (max (var_1_18 , functionized3_localFunctionVar0))));
}
...
void step(void) {
	// From: Req1Batch168functionizing
	if (var_1_2 > var_1_3) {
	...
	// From: Req2Batch168functionizing
	functionized1(var_1_8, var_1_7);


	// From: Req3Batch168functionizing
	functionized2(var_1_1, var_1_14);


	// From: Req4Batch168functionizing
	var_1_15 = functionized3(var_1_19);


	// From: Req5Batch168functionizing
	if (! var_1_21) {
		if (var_1_21) {
	...
	// From: Req6Batch168functionizing
	if (var_1_25) {
		if (-10 < var_1_18) {
	...
	// From: Req7Batch168functionizing
	functionized5();


	// From: Req8Batch168functionizing
	var_1_28 = var_1_22;
}
