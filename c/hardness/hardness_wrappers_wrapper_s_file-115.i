...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch115Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 if ((WrapperStruct00.var_1_2 * last_1_WrapperStruct00_var_1_1) >= ((((WrapperStruct00.var_1_4) > (WrapperStruct00.var_1_5)) ? (WrapperStruct00.var_1_4) : (WrapperStruct00.var_1_5)))) {
  WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7);
 } else {
  if (last_1_WrapperStruct00_var_1_1 <= WrapperStruct00.var_1_7) {
   WrapperStruct00.var_1_1 = WrapperStruct00.var_1_7;
  } else {
   WrapperStruct00.var_1_1 = 3.2;
  }
 }
 WrapperStruct00.var_1_12 = (((((WrapperStruct00.var_1_13 - ((((WrapperStruct00.var_1_14) < 0 ) ? -(WrapperStruct00.var_1_14) : (WrapperStruct00.var_1_14))))) < (WrapperStruct00.var_1_15)) ? ((WrapperStruct00.var_1_13 - ((((WrapperStruct00.var_1_14) < 0 ) ? -(WrapperStruct00.var_1_14) : (WrapperStruct00.var_1_14))))) : (WrapperStruct00.var_1_15)));
 if ((WrapperStruct00.var_1_12 ^ WrapperStruct00.var_1_11) < (- WrapperStruct00.var_1_9)) {
 ...
 if (WrapperStruct00.var_1_16 > (- WrapperStruct00.var_1_6)) {
  WrapperStruct00.var_1_8 = (WrapperStruct00.var_1_9 - (WrapperStruct00.var_1_10 - WrapperStruct00.var_1_11));
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((WrapperStruct00.var_1_2 * last_1_WrapperStruct00_var_1_1) >= ((((WrapperStruct00.var_1_4) > (WrapperStruct00.var_1_5)) ? (WrapperStruct00.var_1_4) : (WrapperStruct00.var_1_5)))) ? (WrapperStruct00.var_1_1 == ((double) (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7))) : ((last_1_WrapperStruct00_var_1_1 <= WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_1 == ((double) WrapperStruct00.var_1_7)) : (WrapperStruct00.var_1_1 == ((double) 3.2)))) && ((WrapperStruct00.var_1_16 > (- WrapperStruct00.var_1_6)) ? (WrapperStruct00.var_1_8 == ((unsigned long int) (WrapperStruct00.var_1_9 - (WrapperStruct00.var_1_10 - WrapperStruct00.var_1_11)))) : 1)) && (WrapperStruct00.var_1_12 == ((signed short int) (((((WrapperStruct00.var_1_13 - ((((WrapperStruct00.var_1_14) < 0 ) ? -(WrapperStruct00.var_1_14) : (WrapperStruct00.var_1_14))))) < (WrapperStruct00.var_1_15)) ? ((WrapperStruct00.var_1_13 - ((((WrapperStruct00.var_1_14) < 0 ) ? -(WrapperStruct00.var_1_14) : (WrapperStruct00.var_1_14))))) : (WrapperStruct00.var_1_15)))))) && (((WrapperStruct00.var_1_12 ^ WrapperStruct00.var_1_11) < (- WrapperStruct00.var_1_9)) ? ((WrapperStruct00.var_1_6 >= WrapperStruct00.var_1_7) ? ((WrapperStruct00.var_1_1 > (- WrapperStruct00.var_1_1)) ? (WrapperStruct00.var_1_16 == ((double) WrapperStruct00.var_1_6)) : 1) : (WrapperStruct00.var_1_16 == ((double) WrapperStruct00.var_1_7))) : (WrapperStruct00.var_1_16 == ((double) WrapperStruct00.var_1_6)))
;
}
int main(void) {
 isInitial = 1;
