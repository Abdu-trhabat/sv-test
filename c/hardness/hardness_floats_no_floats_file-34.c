...
int property(void) {
	return ((((-32 >= var_1_2) ? ((((var_1_3 - var_1_4) - var_1_5) <= var_1_2) ? (var_1_1 == ((signed long int) var_1_6)) : 1) : (var_1_1 == ((signed long int) var_1_6))) && (((var_1_3 * (var_1_8 - var_1_5)) > (var_1_2 ^ var_1_4)) ? (var_1_19 ? ((var_1_19 && last_1_var_1_7) ? (var_1_7 == ((unsigned char) 0)) : (var_1_7 == ((unsigned char) (var_1_12 && var_1_13)))) : (var_1_7 == ((unsigned char) var_1_14))) : 1)) && ((var_1_16 >= var_1_3) ? (var_1_15 == ((signed char) (var_1_17 + var_1_18))) : (var_1_19 ? (var_1_14 ? (var_1_15 == ((signed char) (max (var_1_3 , var_1_17)))) : 1) : (var_1_15 == ((signed char) var_1_18))))) && (var_1_19 == ((unsigned char) var_1_14))
;
}
int main(void) {
	isInitial = 1;
