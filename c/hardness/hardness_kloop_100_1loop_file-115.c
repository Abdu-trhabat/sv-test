...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch115100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch115100_1loop
	if (var_1_7) {
		var_1_6 = (min (var_1_19 , (var_1_8 - var_1_5)));
	}


	// From: Req7Batch115100_1loop
	...
	// From: Req9Batch115100_1loop
	if (var_1_10) {
		var_1_32 = (((var_1_13 - var_1_28) - var_1_30) + 5);
	}


	// From: Req10Batch115100_1loop
