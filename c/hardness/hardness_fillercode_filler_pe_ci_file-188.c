...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch188Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 270L, 69L) */ if (var_1_4) {
		/* 272L, 67L) */ if (/* 273L, 53L, 54L) */ ((var_1_19) > (var_1_9))) {
			/* 276L, 66L) */ var_1_20 = (
				/* 279L, 65L) */ (abs (
					/* 280L, 64L) */ (max (
						/* 280L, 64L) */ (
	...
	// From: CodeObject3
	/* 289L, 148L) */ if (var_1_16) {
		/* 291L, 115L) */ if (/* 292L, 94L, 95L) */ ((/* 293L, 90L, 96L) */ (max (/* 293L, 90L, 96L) */ (var_1_3) , (var_1_2)))) >= (/* 296L, 93L, 99L) */ ((var_1_19) + (var_1_2))))) {
			/* 299L, 114L) */ var_1_27 = (
				/* 302L, 113L) */ (min (
					/* 302L, 113L) */ (
						var_1_30
		...
		/* 305L, 146L) */ if (/* 306L, 119L, 120L) */ ((-0.8f) <= (var_1_2))) {
			/* 309L, 137L) */ var_1_27 = (
				/* 312L, 136L) */ ((
					/* 313L, 134L) */ ((
						/* 314L, 130L) */ ((
	...
	// From: CodeObject4
	/* 332L, 184L) */ if (/* 333L, 156L, 157L) */ ((var_1_18) <= (var_1_2))) {
		/* 336L, 176L) */ if (var_1_16) {
			/* 338L, 175L) */ var_1_35 = (
				/* 341L, 174L) */ ((
					var_1_4
				) && (
