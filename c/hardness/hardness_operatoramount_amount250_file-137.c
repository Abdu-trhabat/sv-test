...
void step(void) {
	// From: Req2Batch137Amount250
	signed short int stepLocal_4 = var_1_14;
	unsigned long int stepLocal_3 = abs (last_1_var_1_53);
	if (stepLocal_3 <= 8) {
		...
		if (var_1_19) {
			...
			if (! ((last_1_var_1_53 >= 4) && last_1_var_1_73)) {
				var_1_16 = (((8.5f - var_1_21) <= (max (199.16f , var_1_18))) || var_1_22);
			} else {
				if (var_1_20) {
					var_1_16 = var_1_22;
				}
	...
	// From: Req11Batch137Amount250
	if (var_1_16) {
		var_1_53 = (abs (var_1_14));
	} else {
		var_1_53 = var_1_41;
	}


	// From: Req3Batch137Amount250
	...
	// From: Req15Batch137Amount250
	unsigned long int stepLocal_12 = var_1_53;
	if (var_1_28 < stepLocal_12) {
		var_1_58 = (min (var_1_50 , var_1_37));
	} else {
		var_1_58 = (((var_1_59 - var_1_51) - var_1_36) + (max ((abs (var_1_49)) , (max (var_1_52 , var_1_37)))));
	}


	// From: Req18Batch137Amount250
	var_1_69 = (var_1_59 - (max (var_1_38 , var_1_51)));


	// From: Req20Batch137Amount250
	var_1_72 = (min (var_1_52 , var_1_65));


	// From: Req21Batch137Amount250
	if (var_1_5 != var_1_10) {
		var_1_73 = var_1_26;
	}


	// From: Req22Batch137Amount250
	...
	// From: Req5Batch137Amount250
	if (((min (var_1_21 , var_1_30)) - var_1_31) > ((var_1_69 * var_1_18) + (var_1_32 - var_1_33))) {
		if (var_1_16) {
			if ((var_1_24 - var_1_14) != var_1_13) {
				if (var_1_32 <= ((var_1_31 * var_1_30) / var_1_34)) {
					var_1_29 = ((var_1_53 - var_1_28) + ((max (4 , var_1_13)) + var_1_4));
				}
			} else {
				var_1_29 = var_1_8;
			}
	...
	// From: Req14Batch137Amount250
	if (var_1_53 != var_1_9) {
		var_1_56 = (var_1_57 - (max (var_1_29 , (var_1_14 + var_1_13))));
	}


	// From: Req16Batch137Amount250
	signed long int stepLocal_13 = var_1_28 >> var_1_61;
	if (stepLocal_13 > var_1_29) {
		var_1_60 = ((abs (var_1_61)) - (var_1_28 + (max (var_1_62 , var_1_63))));
	} else {
		var_1_60 = (min ((-10 + var_1_62) , -4));
	}


	// From: Req19Batch137Amount250
	signed long int stepLocal_16 = var_1_62 / (var_1_28 + var_1_48);
	signed long int stepLocal_15 = min (-256 , var_1_62);
	...
	if (var_1_53 >= stepLocal_15) {
		if (((var_1_14 * var_1_29) / var_1_28) <= stepLocal_14) {
			if (var_1_7 > stepLocal_16) {
				var_1_70 = (abs (var_1_28));
			} else {
				var_1_70 = var_1_61;
			}
		} else {
			var_1_70 = (var_1_62 - (max ((var_1_63 + var_1_61) , (var_1_71 - var_1_28))));
		}
	} else {
		var_1_70 = ((max (var_1_28 , var_1_62)) - (max ((var_1_61 + var_1_63) , (abs (var_1_71)))));
	}


	// From: Req1Batch137Amount250
	...
	if ((- var_1_33) < var_1_18) {
		...
		if (! var_1_22) {
			var_1_46 = (max (((max (9.4f , 1.666f)) + (var_1_51 + var_1_52)) , (var_1_49 + var_1_37)));
		} else {
	...
	// From: Req17Batch137Amount250
	if (var_1_1 >= var_1_56) {
		var_1_64 = ((var_1_52 + (max (var_1_51 , var_1_65))) + ((max (var_1_66 , var_1_67)) + var_1_68));
	} else {
...
int property(void) {
	return ((((((((((((((((((((((var_1_29 == var_1_53) ? ((var_1_53 <= var_1_29) ? (var_1_1 == ((signed short int) (max (var_1_4 , var_1_5)))) : (var_1_1 == ((signed short int) var_1_5))) : (var_1_73 ? ((((var_1_53 / 1u) % var_1_7) != var_1_29) ? (var_1_1 == ((signed short int) (max (var_1_5 , (var_1_8 + (min (-2 , var_1_9))))))) : (var_1_1 == ((signed short int) (var_1_10 - var_1_11)))) : (var_1_1 == ((signed short int) (max ((min (var_1_5 , var_1_11)) , ((var_1_12 - var_1_13) - (var_1_14 - var_1_15)))))))) && (((abs (last_1_var_1_53)) <= 8) ? (((last_1_var_1_72 / var_1_18) == (- (4.5 + 127.875))) ? ((-8 <= var_1_14) ? (var_1_16 == ((unsigned char) (last_1_var_1_73 && var_1_19))) : 1) : 1) : (var_1_19 ? (var_1_16 == ((unsigned char) ((! last_1_var_1_73) && var_1_20))) : ((! ((last_1_var_1_53 >= 4) && last_1_var_1_73)) ? (var_1_16 == ((unsigned char) (((8.5f - var_1_21) <= (max (199.16f , var_1_18))) || var_1_22))) : (var_1_20 ? (var_1_16 == ((unsigned char) var_1_22)) : 1))))) && (((var_1_24 - var_1_12) <= var_1_14) ? (var_1_23 == ((unsigned char) (var_1_22 && (var_1_25 && var_1_26)))) : 1)) && ((var_1_9 < (var_1_15 >> var_1_28)) ? ((((- var_1_11) > var_1_8) || var_1_20) ? (var_1_27 == ((unsigned short int) ((var_1_14 - var_1_15) + var_1_28))) : 1) : (var_1_27 == ((unsigned short int) var_1_28)))) && ((((min (var_1_21 , var_1_30)) - var_1_31) > ((var_1_69 * var_1_18) + (var_1_32 - var_1_33))) ? (var_1_16 ? (((var_1_24 - var_1_14) != var_1_13) ? ((var_1_32 <= ((var_1_31 * var_1_30) / var_1_34)) ? (var_1_29 == ((signed long int) ((var_1_53 - var_1_28) + ((max (4 , var_1_13)) + var_1_4)))) : 1) : (var_1_29 == ((signed long int) var_1_8))) : (var_1_29 == ((signed long int) var_1_12))) : (var_1_29 == ((signed long int) var_1_8)))) && (var_1_23 ? ((var_1_34 < 49.1) ? (var_1_35 == ((float) ((var_1_36 + var_1_37) - var_1_38))) : 1) : 1)) && ((var_1_33 > (var_1_36 - var_1_32)) ? (var_1_39 == ((unsigned char) ((var_1_34 >= (var_1_38 / var_1_18)) && var_1_20))) : 1)) && ((var_1_39 || (var_1_27 <= (var_1_41 - var_1_14))) ? (((var_1_24 - var_1_11) >= var_1_53) ? (var_1_40 == ((float) var_1_38)) : 1) : (var_1_40 == ((float) (var_1_37 + var_1_36))))) && (((var_1_38 / var_1_34) < var_1_36) ? ((((var_1_56 + var_1_15) + var_1_54) <= var_1_29) ? (var_1_42 == ((signed short int) (var_1_45 - var_1_13))) : (var_1_42 == ((signed short int) var_1_10))) : (var_1_42 == ((signed short int) var_1_9)))) && (((- var_1_33) < var_1_18) ? ((var_1_1 <= (var_1_53 % (var_1_28 + var_1_48))) ? (var_1_46 == ((float) ((var_1_36 - var_1_37) + var_1_49))) : (var_1_20 ? (var_1_46 == ((float) (max (7.2f , (32.4f - (var_1_36 + var_1_37)))))) : (var_1_46 == ((float) (var_1_36 - (var_1_50 - (var_1_51 + var_1_52))))))) : ((! var_1_22) ? (var_1_46 == ((float) (max (((max (9.4f , 1.666f)) + (var_1_51 + var_1_52)) , (var_1_49 + var_1_37))))) : (var_1_46 == ((float) (var_1_49 + var_1_36)))))) && (var_1_16 ? (var_1_53 == ((unsigned long int) (abs (var_1_14)))) : (var_1_53 == ((unsigned long int) var_1_41)))) && ((var_1_55 > (var_1_41 - (var_1_15 + var_1_29))) ? (var_1_54 == ((signed short int) var_1_8)) : 1)) && (((- var_1_21) <= ((- var_1_38) / var_1_18)) ? (var_1_55 == ((unsigned short int) (var_1_29 + var_1_11))) : (var_1_55 == ((unsigned short int) (var_1_14 + var_1_13))))) && ((var_1_53 != var_1_9) ? (var_1_56 == ((unsigned long int) (var_1_57 - (max (var_1_29 , (var_1_14 + var_1_13)))))) : 1)) && ((var_1_28 < var_1_53) ? (var_1_58 == ((double) (min (var_1_50 , var_1_37)))) : (var_1_58 == ((double) (((var_1_59 - var_1_51) - var_1_36) + (max ((abs (var_1_49)) , (max (var_1_52 , var_1_37))))))))) && (((var_1_28 >> var_1_61) > var_1_29) ? (var_1_60 == ((signed char) ((abs (var_1_61)) - (var_1_28 + (max (var_1_62 , var_1_63)))))) : (var_1_60 == ((signed char) (min ((-10 + var_1_62) , -4)))))) && ((var_1_1 >= var_1_56) ? (var_1_64 == ((float) ((var_1_52 + (max (var_1_51 , var_1_65))) + ((max (var_1_66 , var_1_67)) + var_1_68)))) : ((var_1_14 >= (var_1_24 * var_1_53)) ? (var_1_64 == ((float) var_1_52)) : (var_1_64 == ((float) var_1_67))))) && (var_1_69 == ((double) (var_1_59 - (max (var_1_38 , var_1_51)))))) && ((var_1_53 >= (min (-256 , var_1_62))) ? ((((var_1_14 * var_1_29) / var_1_28) <= var_1_27) ? ((var_1_7 > (var_1_62 / (var_1_28 + var_1_48))) ? (var_1_70 == ((signed char) (abs (var_1_28)))) : (var_1_70 == ((signed char) var_1_61))) : (var_1_70 == ((signed char) (var_1_62 - (max ((var_1_63 + var_1_61) , (var_1_71 - var_1_28))))))) : (var_1_70 == ((signed char) ((max (var_1_28 , var_1_62)) - (max ((var_1_61 + var_1_63) , (abs (var_1_71))))))))) && (var_1_72 == ((double) (min (var_1_52 , var_1_65))))) && ((var_1_5 != var_1_10) ? (var_1_73 == ((unsigned char) var_1_26)) : 1)) && ((var_1_51 >= var_1_58) ? ((var_1_26 || var_1_22) ? (var_1_74 == ((signed short int) var_1_8)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
