...
void step(void) {
 ...
 var_1_14 = ((((((-1.0f) < 0 ) ? -(-1.0f) : (-1.0f))) + (var_1_15 + var_1_16)) - ((((64.0f) < (var_1_17)) ? (64.0f) : (var_1_17))));
