...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch23normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch23normal
	var_1_23 = var_1_13;


	// From: Req8Batch23normal
	var_1_24 = var_1_7;


	// From: Req9Batch23normal
	var_1_25 = var_1_7;
	...
	if (((200 - var_1_13) - var_1_14) != stepLocal_1) {
		var_1_12 = (var_1_13 + (min (var_1_14 , var_1_16)));
	} else {
	...
	if ((var_1_16 / (min (var_1_17 , var_1_20))) > var_1_18) {
...
int property(void) {
	return ((((((((var_1_2 ? (var_1_1 == ((unsigned char) var_1_3)) : 1) && (((var_1_5 <= var_1_6) || var_1_1) ? (var_1_4 == ((float) (max (31.5f , (min (var_1_7 , var_1_8)))))) : (var_1_4 == ((float) ((var_1_9 - var_1_10) - var_1_11))))) && ((((200 - var_1_13) - var_1_14) != var_1_23) ? (var_1_12 == ((signed long int) (var_1_13 + (min (var_1_14 , var_1_16))))) : (((var_1_23 / (128 - var_1_17)) < var_1_13) ? ((var_1_13 >= var_1_23) ? (var_1_12 == ((signed long int) var_1_14)) : (var_1_12 == ((signed long int) var_1_17))) : (var_1_12 == ((signed long int) var_1_17))))) && (((- (var_1_13 / var_1_17)) > var_1_23) ? (var_1_18 == ((unsigned long int) var_1_13)) : 1)) && (((var_1_16 / (min (var_1_17 , var_1_20))) > var_1_18) ? (var_1_19 == ((signed char) (max (var_1_17 , var_1_13)))) : (var_1_19 == ((signed char) var_1_17)))) && ((5 <= var_1_17) ? (var_1_21 == ((unsigned short int) (var_1_22 - var_1_17))) : (var_1_1 ? (var_1_1 ? (var_1_21 == ((unsigned short int) var_1_17)) : (var_1_21 == ((unsigned short int) var_1_14))) : 1))) && (var_1_23 == ((signed long int) var_1_13))) && (var_1_24 == ((double) var_1_7))) && (var_1_25 == ((float) var_1_7))
;
}
int main(void) {
	isInitial = 1;
