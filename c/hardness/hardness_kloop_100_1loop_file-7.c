...
void step(void) {
	...
	if (last_1_var_1_33 && stepLocal_1) {
		var_1_17 = ((abs (var_1_19)) - (var_1_20 - var_1_21));
	} else {
	...
	if (var_1_18 && stepLocal_4) {
		...
		if (stepLocal_5 < 128) {
			if (! var_1_11) {
				var_1_38 = (max (((var_1_39 + var_1_40) + var_1_21) , var_1_20));
			} else {
				var_1_38 = (var_1_39 + var_1_40);
			}
		} else {
			var_1_38 = (max (var_1_20 , var_1_28));
		}
	}
	...
	var_1_30 = ((var_1_31 - var_1_14) - ((abs (var_1_32)) - var_1_15));
	...
	if (stepLocal_3 <= (~ var_1_15)) {
		...
		var_1_36 = ((max (var_1_32 , var_1_37)) - var_1_30);
	}
	...
	if (var_1_36 <= (var_1_24 - (var_1_25 - var_1_13))) {
		var_1_23 = (max ((var_1_21 - 10000.25) , (max (256.625 , var_1_20))));
	} else {
		if ((max (var_1_17 , (abs (var_1_38)))) >= (var_1_22 + var_1_17)) {
			var_1_23 = var_1_22;
		} else {
	...
	if (! var_1_26) {
		var_1_10 = (((var_1_12 - var_1_13) - (max (var_1_14 , var_1_15))) - var_1_16);
	} else {
		var_1_10 = ((max (var_1_16 , var_1_15)) + var_1_14);
	}
...
int property(void) {
	return ((((((((((((var_1_2 > var_1_3) ? (((abs (var_1_17)) < var_1_17) ? (var_1_1 == ((signed char) var_1_6)) : (var_1_1 == ((signed char) -1))) : (var_1_1 == ((signed char) var_1_6))) && (((var_1_6 / var_1_8) > var_1_36) ? (var_1_7 == ((signed long int) ((var_1_9 - 256) + var_1_6))) : (var_1_7 == ((signed long int) (min (var_1_8 , -500)))))) && ((! var_1_26) ? (var_1_10 == ((unsigned char) (((var_1_12 - var_1_13) - (max (var_1_14 , var_1_15))) - var_1_16))) : (var_1_10 == ((unsigned char) ((max (var_1_16 , var_1_15)) + var_1_14))))) && ((last_1_var_1_33 && last_1_var_1_26) ? (var_1_17 == ((float) ((abs (var_1_19)) - (var_1_20 - var_1_21)))) : (var_1_17 == ((float) ((var_1_20 - var_1_21) - var_1_22))))) && ((var_1_36 <= (var_1_24 - (var_1_25 - var_1_13))) ? (var_1_23 == ((double) (max ((var_1_21 - 10000.25) , (max (256.625 , var_1_20)))))) : (((max (var_1_17 , (abs (var_1_38)))) >= (var_1_22 + var_1_17)) ? (var_1_23 == ((double) var_1_22)) : (var_1_23 == ((double) (var_1_21 - var_1_22)))))) && (((var_1_21 - (var_1_27 - var_1_28)) >= var_1_17) ? (var_1_26 == ((unsigned char) var_1_29)) : (var_1_26 == ((unsigned char) (var_1_33 && var_1_29))))) && (var_1_30 == ((signed long int) ((var_1_31 - var_1_14) - ((abs (var_1_32)) - var_1_15))))) && (((var_1_13 * var_1_9) > var_1_31) ? (((last_1_var_1_17 * var_1_20) >= last_1_var_1_23) ? (var_1_33 == ((unsigned char) var_1_34)) : (var_1_33 == ((unsigned char) var_1_29))) : (var_1_33 == ((unsigned char) var_1_29)))) && (var_1_35 == ((signed char) (abs (abs (-1)))))) && ((-25 <= (~ var_1_15)) ? (var_1_36 == ((unsigned long int) ((var_1_25 - var_1_16) + var_1_12))) : (var_1_36 == ((unsigned long int) ((max (var_1_32 , var_1_37)) - var_1_30))))) && ((var_1_18 && var_1_33) ? (var_1_38 == ((float) var_1_20)) : ((var_1_15 < 128) ? ((! var_1_11) ? (var_1_38 == ((float) (max (((var_1_39 + var_1_40) + var_1_21) , var_1_20)))) : (var_1_38 == ((float) (var_1_39 + var_1_40)))) : (var_1_38 == ((float) (max (var_1_20 , var_1_28))))))) && (var_1_41 == ((unsigned short int) var_1_10))
;
}
int main(void) {
	isInitial = 1;
