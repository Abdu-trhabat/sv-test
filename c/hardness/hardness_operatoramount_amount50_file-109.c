...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch109Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch109Amount50
	var_1_6 = (max (var_1_7 , ((10 + var_1_8) + var_1_9)));


	// From: Req7Batch109Amount50
	...
	// From: Req8Batch109Amount50
	var_1_20 = var_1_19;


	// From: Req9Batch109Amount50
	var_1_21 = var_1_9;


	// From: Req6Batch109Amount50
	if (var_1_13) {
