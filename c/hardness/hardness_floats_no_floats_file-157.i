...
void step(void) {
 ...
 var_1_14 = ((((((-1) < 0 ) ? -(-1) : (-1))) + (var_1_15 + var_1_16)) - ((((64) < (var_1_17)) ? (64) : (var_1_17))));
 signed long int stepLocal_1 = 128;
 signed long int stepLocal_0 = var_1_3;
 if (stepLocal_1 <= (((((var_1_2 - var_1_3)) > (var_1_8)) ? ((var_1_2 - var_1_3)) : (var_1_8)))) {
...
int property(void) {
 return (((128 <= (((((var_1_2 - var_1_3)) > (var_1_8)) ? ((var_1_2 - var_1_3)) : (var_1_8)))) ? ((var_1_3 <= (var_1_2 / var_1_5)) ? (var_1_6 ? (var_1_1 == ((signed long int) 10)) : (var_1_1 == ((signed long int) var_1_7))) : (var_1_1 == ((signed long int) var_1_7))) : (var_1_1 == ((signed long int) var_1_7))) && (((var_1_9 + var_1_10) >= (var_1_11 * var_1_12)) ? (var_1_8 == ((signed long int) var_1_7)) : ((! var_1_6) ? ((var_1_7 == var_1_2) ? (var_1_8 == ((signed long int) var_1_7)) : (var_1_8 == ((signed long int) var_1_13))) : (var_1_8 == ((signed long int) var_1_13))))) && (var_1_14 == ((signed long int) ((((((-1) < 0 ) ? -(-1) : (-1))) + (var_1_15 + var_1_16)) - ((((64) < (var_1_17)) ? (64) : (var_1_17))))))
;
}
int main(void) {
 isInitial = 1;
