...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_3_Pointer)) < (*(WrapperStruct00_var_1_2_Pointer))) {
		...
		(*(WrapperStruct00_var_1_7_Pointer)) = (max (-4 , ((max (128 , (*(WrapperStruct00_var_1_2_Pointer)))) - (*(WrapperStruct00_var_1_9_Pointer)))));
	}


	// From: Req3Batch172Wrapper_SP
	(*(WrapperStruct00_var_1_11_Pointer)) = (min ((*(WrapperStruct00_var_1_12_Pointer)) , (*(WrapperStruct00_var_1_13_Pointer))));


	// From: Req4Batch172Wrapper_SP
	...
	if (stepLocal_0 && ((*(WrapperStruct00_var_1_7_Pointer)) != (*(WrapperStruct00_var_1_9_Pointer)))) {
		(*(WrapperStruct00_var_1_14_Pointer)) = ((*(WrapperStruct00_var_1_15_Pointer)) + (max (3.25f , (*(WrapperStruct00_var_1_16_Pointer)))));
	}


	// From: Req5Batch172Wrapper_SP
	(*(WrapperStruct00_var_1_17_Pointer)) = (*(WrapperStruct00_var_1_18_Pointer));


	// From: Req6Batch172Wrapper_SP
	(*(WrapperStruct00_var_1_19_Pointer)) = (*(WrapperStruct00_var_1_5_Pointer));


	// From: Req7Batch172Wrapper_SP
	(*(WrapperStruct00_var_1_20_Pointer)) = (*(WrapperStruct00_var_1_18_Pointer));


	// From: Req1Batch172Wrapper_SP
