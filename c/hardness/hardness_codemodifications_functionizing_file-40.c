...
void functionized3(unsigned short int functionized3_localFunctionVar0, signed long int localFunctionVar1) {
	var_1_16 = (min (((max (localFunctionVar1 , var_1_7)) + functionized3_localFunctionVar0) , var_1_15));
}
void functionized4(unsigned char functionized4_localFunctionVar0, unsigned char functionized4_localFunctionVar1) {
	if ((var_1_10 && var_1_11) && functionized4_localFunctionVar0) {
		var_1_21 = (var_1_12 + (functionized4_localFunctionVar1 + (max (var_1_22 , var_1_23))));
	} else {
...
void step(void) {
	...
	// From: Req2Batch40functionizing
	functionized1(var_1_5, var_1_10, var_1_4);


	// From: Req3Batch40functionizing
	functionized2(var_1_13, var_1_9, var_1_15, 50);


	// From: Req4Batch40functionizing
	functionized3(var_1_8, 256);


	// From: Req5Batch40functionizing
	if ((var_1_1 - (abs (var_1_12))) < (var_1_8 - var_1_19)) {
		var_1_17 = var_1_20;
	}


	// From: Req6Batch40functionizing
	functionized4(var_1_9, var_1_15);


	// From: Req7Batch40functionizing
	functionized5(var_1_20);


	// From: Req8Batch40functionizing
	var_1_25 = var_1_20;


	// From: Req9Batch40functionizing
	var_1_26 = var_1_6;
}
