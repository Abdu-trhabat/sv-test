...
void step(void) {
	...
	// From: Req3Batch128Wrapper_SP
	if ((~ (*(WrapperStruct00_var_1_6_Pointer))) < ((*(WrapperStruct00_var_1_3_Pointer)) ^ (*(WrapperStruct00_var_1_4_Pointer)))) {
		(*(WrapperStruct00_var_1_13_Pointer)) = (abs (((*(WrapperStruct00_var_1_14_Pointer)) - (*(WrapperStruct00_var_1_15_Pointer))) - (abs ((*(WrapperStruct00_var_1_8_Pointer))))));
	}


	// From: Req4Batch128Wrapper_SP
