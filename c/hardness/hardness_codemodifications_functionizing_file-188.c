...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch188functionizing.c", 13, "reach_error"); }
...
void functionized0(signed long int functionized0_localFunctionVar0, signed short int functionized0_localFunctionVar1) {
	if (var_1_5 >= functionized0_localFunctionVar0) {
		var_1_10 = (min (var_1_6 , functionized0_localFunctionVar1));
	}
}
void functionized1(signed short int functionized1_localFunctionVar0, unsigned long int localFunctionVar1) {
	if (var_1_10 >= var_1_7) {
		...
		if ((var_1_14 - localFunctionVar1) > var_1_5) {
...
signed long int functionized3(void) {
	return (max (var_1_7 , (var_1_10 * var_1_12)));
}
float functionized4(void) {
	return (min (var_1_9 , var_1_18));
}
...
void step(void) {
	// From: Req1Batch188functionizing
	if (var_1_2 < var_1_3) {
	...
	// From: Req2Batch188functionizing
	functionized0(var_1_8, var_1_11);


	// From: Req3Batch188functionizing
	if (var_1_2 >= (- var_1_1)) {
	...
	// From: Req4Batch188functionizing
	functionized1(var_1_11, 128u);


	// From: Req5Batch188functionizing
	functionized2();


	// From: Req6Batch188functionizing
	if ((-64 >= var_1_12) || (var_1_13 < var_1_7)) {
		if ((max (var_1_13 , -2)) > functionized3()) {
			var_1_17 = (functionized4() + var_1_19);
		} else {
			var_1_17 = 7.1f;
		}
	} else {
