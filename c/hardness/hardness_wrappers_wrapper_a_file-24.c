...
void step(void) {
	...
	if ((max ((float_Array_0[0] * 127.75) , (double_Array_0[1] / 3.4))) >= double_Array_0[0]) {
		unsigned_short_int_Array_0[1] = (min ((unsigned_short_int_Array_0[0] - (22925 - signed_char_Array_0[2])) , unsigned_short_int_Array_0[2]));
	}
}
