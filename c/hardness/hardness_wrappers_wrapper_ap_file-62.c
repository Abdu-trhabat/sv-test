...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch62Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (last_1_unsigned_char_Array_0_1_ <= stepLocal_1) {
		if (stepLocal_0 <= (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer))) {
			(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) - last_1_unsigned_char_Array_0_1_);
		} else {
