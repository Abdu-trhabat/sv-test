...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch12dependencies
	if (var_1_18 != (min (var_1_6 , var_1_5))) {
	...
	// From: Req4Batch12dependencies
	if ((var_1_12 / var_1_16) >= var_1_10) {
		var_1_15 = (var_1_17 + 255.5);
	}


	// From: Req6Batch12dependencies
	var_1_21 = (abs (var_1_7));


	// From: Req7Batch12dependencies
	if (var_1_21 == var_1_3) {
		if (! var_1_20) {
