...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch149stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch149stepLocals
	signed long int stepLocal_3 = min (var_1_3 , var_1_2);
	if (stepLocal_3 > (max (var_1_9 , (var_1_4 + var_1_1)))) {
		var_1_12 = var_1_5;
	} else {
		var_1_12 = var_1_9;
	}
