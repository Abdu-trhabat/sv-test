...
void step(void) {
	...
	if (WrapperStruct00.var_1_2) {
		if (WrapperStruct00.var_1_3) {
			...
			WrapperStruct00.var_1_1 = ((min (WrapperStruct00.var_1_6 , 3757035609u)) - WrapperStruct00.var_1_4);
		}
	} else {
	...
	if (stepLocal_0 == WrapperStruct00.var_1_4) {
		if (WrapperStruct00.var_1_8 < stepLocal_1) {
			WrapperStruct00.var_1_7 = (abs (WrapperStruct00.var_1_11 - WrapperStruct00.var_1_12));
		} else {
			if (WrapperStruct00.var_1_2) {
