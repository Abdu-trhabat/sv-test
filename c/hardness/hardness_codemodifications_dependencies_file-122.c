...
void step(void) {
	...
	// From: Req7Batch122dependencies
	var_1_18 = var_1_6;


	// From: Req4Batch122dependencies
	if (var_1_18 > var_1_12) {
		var_1_13 = var_1_6;
	}


	// From: Req1Batch122dependencies
	if ((- var_1_12) > 5) {
