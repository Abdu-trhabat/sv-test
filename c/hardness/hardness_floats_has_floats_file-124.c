...
void step(void) {
	...
	// From: Req4Batch124has_floats
	var_1_15 = var_1_14;


	// From: Req1Batch124has_floats
	if (var_1_11) {
		var_1_1 = ((abs (var_1_3 + var_1_4)) - var_1_5);
	} else {
		var_1_1 = (abs (abs (var_1_3 + 8.0)));
	}
}
...
int property(void) {
	return (((var_1_11 ? (var_1_1 == ((double) ((abs (var_1_3 + var_1_4)) - var_1_5))) : (var_1_1 == ((double) (abs (abs (var_1_3 + 8.0)))))) && ((var_1_5 > var_1_4) ? (var_1_6 == ((unsigned char) (min (var_1_7 , ((var_1_8 - var_1_9) - var_1_10))))) : (var_1_6 == ((unsigned char) 64)))) && ((var_1_2 || (var_1_6 == (var_1_8 + var_1_7))) ? ((var_1_8 >= (var_1_10 * (var_1_7 & var_1_9))) ? (var_1_11 == ((unsigned char) ((var_1_2 || var_1_12) && var_1_13))) : (var_1_11 == ((unsigned char) var_1_14))) : (var_1_11 == ((unsigned char) 0)))) && (var_1_15 == ((unsigned char) var_1_14))
;
}
int main(void) {
	isInitial = 1;
