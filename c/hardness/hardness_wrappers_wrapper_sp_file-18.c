...
void step(void) {
	...
	if (((*(WrapperStruct00_var_1_2_Pointer)) ^ (max ((*(WrapperStruct00_var_1_3_Pointer)) , (*(WrapperStruct00_var_1_4_Pointer))))) != stepLocal_0) {
