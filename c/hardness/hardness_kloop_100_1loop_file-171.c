...
void step(void) {
	...
	// From: Req1Batch171100_1loop
	var_1_1 = (var_1_2 + (4.5 - 128.8));


	// From: Req2Batch171100_1loop
	...
	// From: Req12Batch171100_1loop
	var_1_33 = var_1_29;


	// From: Req13Batch171100_1loop
	var_1_34 = var_1_30;


	// From: Req14Batch171100_1loop
	var_1_35 = var_1_36;


	// From: Req5Batch171100_1loop
	if (var_1_23) {
		var_1_18 = (max (((abs (var_1_19)) + 2) , var_1_17));
	}


	// From: Req6Batch171100_1loop
