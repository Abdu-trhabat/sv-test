...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch24Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req13Batch24Amount100
	var_1_34 = var_1_35;


	// From: Req9Batch24Amount100
	if (((1.5899999999999999 * var_1_5) * (var_1_27 / 9.5)) <= var_1_6) {
		var_1_26 = var_1_19;
	}


	// From: Req2Batch24Amount100
	...
	// From: Req3Batch24Amount100
	var_1_10 = var_1_8;


	// From: Req5Batch24Amount100
