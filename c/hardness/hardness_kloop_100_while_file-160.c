...
void step(void) {
	// From: Req8Batch160100_while
	if (3.5f <= var_1_14) {
		var_1_20 = (var_1_5 + (var_1_21 - last_1_var_1_22));
	}


	// From: Req9Batch160100_while
	if ((var_1_9 < var_1_21) && (var_1_12 == var_1_3)) {
		var_1_22 = var_1_6;
	} else {
		var_1_22 = ((min ((min (var_1_20 , var_1_12)) , 10)) + (var_1_21 - var_1_3));
	}


	// From: Req11Batch160100_while
	if (last_1_var_1_27) {
		var_1_24 = (min ((abs (var_1_6)) , var_1_12));
	} else {
		var_1_24 = (var_1_25 - 16);
	}


	// From: Req13Batch160100_while
	signed long int stepLocal_7 = (max (var_1_25 , var_1_28)) - (var_1_6 + var_1_12);
	...
	// From: Req1Batch160100_while
	if (! var_1_27) {
		var_1_1 = (var_1_3 + var_1_4);
	} else {
		var_1_1 = ((var_1_5 + (abs (var_1_6))) + var_1_4);
	}


	// From: Req2Batch160100_while
	...
	// From: Req4Batch160100_while
	var_1_10 = var_1_5;


	// From: Req5Batch160100_while
	signed long int stepLocal_2 = var_1_1 + (var_1_9 >> var_1_12);
	if (((~ var_1_5) * var_1_3) < stepLocal_2) {
		var_1_11 = (max (((3.875f + var_1_13) - var_1_14) , ((var_1_15 - var_1_16) + var_1_17)));
	}


	// From: Req6Batch160100_while
	if (var_1_27) {
		var_1_18 = var_1_16;
	}


	// From: Req7Batch160100_while
	signed char stepLocal_3 = var_1_12;
	if (var_1_6 <= stepLocal_3) {
		if (var_1_27) {
			var_1_19 = ((var_1_15 + var_1_16) - (min (var_1_14 , var_1_13)));
		} else {
			var_1_19 = var_1_16;
		}
	}
	...
	// From: Req12Batch160100_while
	if ((var_1_3 - var_1_21) < -4) {
		var_1_26 = (var_1_17 + (max (16.95 , var_1_16)));
	} else {
...
int property(void) {
	return (((((((((((((! var_1_27) ? (var_1_1 == ((unsigned char) (var_1_3 + var_1_4))) : (var_1_1 == ((unsigned char) ((var_1_5 + (abs (var_1_6))) + var_1_4)))) && (var_1_27 ? ((((5u << var_1_5) + var_1_6) > (var_1_24 * var_1_4)) ? (var_1_7 == ((signed char) (var_1_5 - (100 - var_1_6)))) : 1) : (var_1_7 == ((signed char) var_1_5)))) && ((((var_1_9 - var_1_4) << var_1_6) > var_1_5) ? (var_1_8 == ((unsigned short int) var_1_20)) : (var_1_8 == ((unsigned short int) var_1_6)))) && (var_1_10 == ((signed char) var_1_5))) && ((((~ var_1_5) * var_1_3) < (var_1_1 + (var_1_9 >> var_1_12))) ? (var_1_11 == ((float) (max (((3.875f + var_1_13) - var_1_14) , ((var_1_15 - var_1_16) + var_1_17))))) : 1)) && (var_1_27 ? (var_1_18 == ((double) var_1_16)) : 1)) && ((var_1_6 <= var_1_12) ? (var_1_27 ? (var_1_19 == ((float) ((var_1_15 + var_1_16) - (min (var_1_14 , var_1_13))))) : (var_1_19 == ((float) var_1_16))) : 1)) && ((3.5f <= var_1_14) ? (var_1_20 == ((unsigned short int) (var_1_5 + (var_1_21 - last_1_var_1_22)))) : 1)) && (((var_1_9 < var_1_21) && (var_1_12 == var_1_3)) ? (var_1_22 == ((unsigned short int) var_1_6)) : (var_1_22 == ((unsigned short int) ((min ((min (var_1_20 , var_1_12)) , 10)) + (var_1_21 - var_1_3)))))) && ((var_1_8 < (32 / var_1_21)) ? (var_1_23 == ((double) (var_1_13 - var_1_16))) : ((var_1_19 < (- var_1_15)) ? (var_1_23 == ((double) (min (var_1_17 , (max (var_1_14 , 4.6)))))) : (var_1_23 == ((double) var_1_14))))) && (last_1_var_1_27 ? (var_1_24 == ((unsigned char) (min ((abs (var_1_6)) , var_1_12)))) : (var_1_24 == ((unsigned char) (var_1_25 - 16))))) && (((var_1_3 - var_1_21) < -4) ? (var_1_26 == ((double) (var_1_17 + (max (16.95 , var_1_16))))) : (var_1_26 == ((double) (15.6 + (var_1_15 - var_1_16)))))) && ((((max (var_1_25 , var_1_28)) - (var_1_6 + var_1_12)) < -4) ? ((var_1_24 > -128) ? ((var_1_9 >= var_1_3) ? (var_1_27 == ((unsigned char) var_1_29)) : (var_1_27 == ((unsigned char) var_1_30))) : (var_1_27 == ((unsigned char) var_1_29))) : (var_1_27 == ((unsigned char) var_1_29)))
;
}
int main(void) {
	isInitial = 1;
