...
void step(void) {
	...
	signed long int stepLocal_1 = min (var_1_6 , (var_1_8 / 256));
...
int property(void) {
	return ((((((((var_1_2 && var_1_3) ? (var_1_1 == ((unsigned char) ((! var_1_4) || (! (var_1_2 || var_1_5))))) : 1) && (var_1_4 ? (var_1_6 == ((unsigned short int) (var_1_7 + (min (var_1_8 , var_1_9))))) : 1)) && ((var_1_7 >= (min (var_1_6 , (var_1_8 / 256)))) ? (var_1_10 == ((signed long int) var_1_11)) : (var_1_10 == ((signed long int) (max (var_1_6 , var_1_8)))))) && (var_1_12 == ((unsigned char) ((64 + var_1_13) - var_1_14)))) && (var_1_15 == ((unsigned char) ((var_1_16 - var_1_17) - 10)))) && (var_1_1 ? (var_1_18 == ((unsigned char) (var_1_16 - var_1_13))) : 1)) && (((- (var_1_10 / var_1_13)) <= (var_1_17 + var_1_10)) ? (var_1_19 == ((signed char) (min (var_1_16 , (abs (abs (var_1_17))))))) : (var_1_19 == ((signed char) (min (var_1_17 , ((var_1_20 + var_1_21) - var_1_22))))))) && ((var_1_22 >= var_1_12) ? (var_1_23 == ((signed char) (var_1_21 + var_1_17))) : ((! (var_1_6 >= var_1_22)) ? (var_1_23 == ((signed char) (min (var_1_20 , var_1_22)))) : (var_1_23 == ((signed char) var_1_17))))
;
}
int main(void) {
	isInitial = 1;
