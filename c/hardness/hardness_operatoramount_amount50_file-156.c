...
void step(void) {
	...
	// From: Req2Batch156Amount50
	if (var_1_5 > var_1_4) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch156Amount50
	if (var_1_7) {
		var_1_9 = (min ((last_1_var_1_9 + -8) , (max ((abs (var_1_3)) , var_1_10))));
	}


	// From: Req4Batch156Amount50
	...
	// From: Req8Batch156Amount50
	var_1_22 = var_1_3;


	// From: Req7Batch156Amount50
