...
void step(void) {
	...
	if ((max ((*(var_1_2_Pointer)) , 1)) <= (256 + (*(var_1_3_Pointer)))) {
	...
	if ((*(var_1_1_Pointer)) > (abs ((*(var_1_4_Pointer))))) {
