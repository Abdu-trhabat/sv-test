...
void step(void) {
 ...
 if (float_Array_0[1] < float_Array_0[0]) {
  double_Array_0[4] = ((((1.25) < (double_Array_0[3])) ? (1.25) : (double_Array_0[3])));
 } else {
  if (BOOL_unsigned_char_Array_0[1] || stepLocal_0) {
   double_Array_0[4] = (((((double_Array_0[1]) < 0 ) ? -(double_Array_0[1]) : (double_Array_0[1]))) + double_Array_0[0]);
  }
 }
 ...
 if (double_Array_0[1] != (((((double_Array_0[0] * double_Array_0[2])) > (double_Array_0[2])) ? ((double_Array_0[0] * double_Array_0[2])) : (double_Array_0[2])))) {
