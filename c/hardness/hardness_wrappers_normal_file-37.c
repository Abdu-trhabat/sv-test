...
void step(void) {
	...
	var_1_12 = (var_1_10 + (max (var_1_13 , var_1_14)));
	...
	if (63.8 > var_1_7) {
		if (stepLocal_2 <= var_1_2) {
			...
			var_1_15 = (min (((min (var_1_16 , var_1_17)) - var_1_4) , var_1_5));
		}
	}
...
int property(void) {
	return (((((((var_1_2 - var_1_3) ^ (var_1_4 * var_1_5)) <= -64) ? (var_1_1 == ((unsigned char) var_1_6)) : (var_1_1 == ((unsigned char) 16))) && ((var_1_6 >= 4) ? ((var_1_2 <= var_1_3) ? (var_1_7 == ((double) (min ((var_1_8 - (var_1_9 - var_1_10)) , var_1_11)))) : 1) : 1)) && (var_1_12 == ((double) (var_1_10 + (max (var_1_13 , var_1_14)))))) && ((63.8 > var_1_7) ? (((- var_1_6) <= var_1_2) ? (var_1_15 == ((unsigned long int) (var_1_16 - var_1_6))) : (var_1_15 == ((unsigned long int) (min (((min (var_1_16 , var_1_17)) - var_1_4) , var_1_5))))) : 1)) && (var_1_18 == ((unsigned char) var_1_6))
;
}
int main(void) {
	isInitial = 1;
