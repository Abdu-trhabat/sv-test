...
void step(void) {
	// From: Req54Batch131Amount500
	signed long int stepLocal_32 = min (last_1_var_1_68 , var_1_5);
	...
	// From: Req36Batch131Amount500
	if (last_1_var_1_108) {
		if (last_1_var_1_11) {
			var_1_90 = (min (var_1_9 , (min (var_1_49 , var_1_33))));
		} else {
			if (! var_1_13) {
				...
				var_1_90 = (min (var_1_57 , (max (4 , var_1_5))));
			}
		}
	}


	// From: Req6Batch131Amount500
	if (((max (var_1_2 , var_1_7)) + last_1_var_1_10) >= var_1_5) {
		var_1_16 = (var_1_17 - (min (last_1_var_1_90 , var_1_9)));
	} else {
		var_1_16 = var_1_6;
	}


	// From: Req22Batch131Amount500
	...
	// From: Req24Batch131Amount500
	signed char stepLocal_23 = var_1_72;
	if (((min (var_1_51 , var_1_6)) << var_1_16) != stepLocal_23) {
		var_1_74 = (min ((min (var_1_64 , var_1_65)) , var_1_36));
	} else {
		var_1_74 = (max ((abs (var_1_23)) , var_1_35));
	}


	// From: Req1Batch131Amount500
	var_1_1 = (abs (var_1_2));


	// From: Req3Batch131Amount500
	...
	// From: Req25Batch131Amount500
	if (var_1_65 >= (50.2 + 128.6)) {
		var_1_75 = (max ((max (var_1_45 , (var_1_48 - var_1_50))) , (max (5 , var_1_72))));
	}


	// From: Req32Batch131Amount500
	if (var_1_13) {
		var_1_84 = (var_1_9 - (var_1_85 - 2));
	} else {
		var_1_84 = (max (((var_1_33 + var_1_10) + var_1_52) , var_1_8));
	}


	// From: Req35Batch131Amount500
	if (var_1_67) {
		var_1_89 = (var_1_77 - var_1_5);
	}


	// From: Req39Batch131Amount500
	var_1_93 = var_1_50;


	// From: Req40Batch131Amount500
	if (var_1_67) {
		var_1_94 = var_1_22;
	} else {
		var_1_94 = var_1_36;
	...
	// From: Req42Batch131Amount500
	if (var_1_67) {
		var_1_96 = var_1_58;
	}


	// From: Req43Batch131Amount500
	var_1_97 = var_1_50;


	// From: Req44Batch131Amount500
	if (var_1_67) {
		var_1_98 = var_1_14;
	}


	// From: Req45Batch131Amount500
	if (var_1_14) {
		var_1_99 = var_1_64;
	}


	// From: Req46Batch131Amount500
	var_1_100 = var_1_22;


	// From: Req47Batch131Amount500
	var_1_101 = var_1_36;


	// From: Req49Batch131Amount500
	var_1_103 = var_1_47;


	// From: Req51Batch131Amount500
	var_1_105 = var_1_55;


	// From: Req52Batch131Amount500
	var_1_106 = var_1_14;


	// From: Req53Batch131Amount500
	if (var_1_13) {
		var_1_107 = var_1_23;
	} else {
		var_1_107 = var_1_36;
	...
	// From: Req17Batch131Amount500
	if (var_1_106) {
		var_1_60 = (var_1_49 - (var_1_52 + var_1_51));
	}


	// From: Req18Batch131Amount500
	signed long int stepLocal_17 = (var_1_50 - var_1_31) / var_1_55;
	if (! var_1_106) {
		var_1_61 = (var_1_5 + last_1_var_1_61);
	} else {
		if (var_1_49 <= stepLocal_17) {
			var_1_61 = (max (var_1_33 , var_1_50));
		}
	}


	// From: Req19Batch131Amount500
	signed long int stepLocal_18 = var_1_84;
	if (var_1_43 >= stepLocal_18) {
		var_1_62 = (max ((min (var_1_43 , var_1_44)) , var_1_49));
	} else {
		var_1_62 = (min (var_1_45 , var_1_48));
	}


	// From: Req27Batch131Amount500
	if (var_1_98) {
		var_1_78 = (min (25.25f , var_1_64));
	} else {
		var_1_78 = ((abs (var_1_29)) - (var_1_34 - var_1_64));
	}


	// From: Req29Batch131Amount500
	unsigned long int stepLocal_24 = (var_1_19 - var_1_7) - var_1_40;
	if ((max ((128 % var_1_58) , (var_1_52 << var_1_84))) < stepLocal_24) {
		var_1_80 = (max ((min (15.25f , (min (var_1_36 , var_1_47)))) , (max (var_1_65 , var_1_22))));
	} else {
		var_1_80 = ((var_1_65 + var_1_64) - var_1_47);
	}


	// From: Req30Batch131Amount500
	if (var_1_35 >= var_1_94) {
		if (var_1_67) {
			var_1_81 = (min (var_1_50 , ((var_1_55 + var_1_82) - var_1_52)));
		} else {
			var_1_81 = (min (var_1_50 , (min ((var_1_58 - var_1_52) , var_1_82))));
		}
	}


	// From: Req41Batch131Amount500
	if (var_1_11) {
		var_1_95 = var_1_50;
	}


	// From: Req50Batch131Amount500
	if (var_1_11) {
		var_1_104 = var_1_48;
	} else {
		var_1_104 = var_1_71;
	...
	if (stepLocal_2 < (100000 << var_1_9)) {
		...
		if (var_1_11) {
			var_1_15 = (3711943259u - (max (var_1_6 , var_1_9)));
		}
	}


	// From: Req2Batch131Amount500
	...
	// From: Req7Batch131Amount500
	if (var_1_2 <= var_1_6) {
		var_1_18 = (min (((var_1_19 + var_1_20) - (var_1_61 + var_1_6)) , (max ((4117883507u - var_1_7) , (min (var_1_2 , var_1_84))))));
	} else {
		var_1_18 = (min ((var_1_2 + 256u) , var_1_17));
	}


	// From: Req11Batch131Amount500
	unsigned short int stepLocal_12 = var_1_6;
	signed long int stepLocal_11 = (max (var_1_39 , var_1_40)) - var_1_5;
	unsigned short int stepLocal_10 = var_1_5;
	if (((max (var_1_17 , var_1_38)) - var_1_19) < stepLocal_10) {
		...
		if (var_1_8 <= stepLocal_12) {
			var_1_37 = (min (4 , (-1 - var_1_6)));
		}
	}


	// From: Req12Batch131Amount500
	if (! (var_1_30 >= var_1_34)) {
		var_1_42 = (abs (max ((var_1_43 + var_1_44) , var_1_45)));
	} else {
		if (var_1_9 < (var_1_7 * var_1_61)) {
			if (((var_1_29 + var_1_23) + 16.5) != ((var_1_46 - var_1_47) - var_1_34)) {
				var_1_42 = ((min (var_1_48 , var_1_49)) - var_1_50);
			} else {
	...
	if (stepLocal_21 || (var_1_22 >= var_1_30)) {
		var_1_66 = (min (var_1_43 , (var_1_51 + (abs (-8)))));
	} else {
			...
			if (var_1_26) {
				if ((- var_1_15) <= stepLocal_19) {
					...
					if ((var_1_33 % var_1_32) < stepLocal_20) {
						var_1_66 = (min (var_1_45 , (abs (var_1_51 + var_1_43))));
					} else {
				...
				if (var_1_33 == stepLocal_22) {
					var_1_66 = (min (0 , (var_1_50 - 10)));
				} else {
					var_1_66 = (var_1_51 + (min (var_1_44 , var_1_43)));
				}
			}
		} else {
			var_1_66 = (var_1_44 + 1);
	...
	// From: Req38Batch131Amount500
	if (var_1_99 >= var_1_107) {
		var_1_92 = (abs (var_1_56 - var_1_105));
	}


	// From: Req8Batch131Amount500
	...
	if (! var_1_14) {
		if (stepLocal_5 <= (var_1_15 * var_1_18)) {
			var_1_21 = ((min ((min (15.8 , var_1_22)) , 32.4)) + var_1_23);
		} else {
			if (stepLocal_6 >= (- (var_1_18 + var_1_15))) {
				var_1_21 = var_1_22;
			} else {
				if (32u == stepLocal_4) {
					var_1_21 = ((abs (max (var_1_23 , var_1_22))) - 15.4);
				} else {
	...
	// From: Req10Batch131Amount500
	unsigned long int stepLocal_9 = var_1_20;
	unsigned char stepLocal_8 = var_1_11;
	signed long int stepLocal_7 = max (var_1_32 , (var_1_10 | var_1_37));
	if (stepLocal_8 && var_1_26) {
		...
		if (stepLocal_7 > var_1_89) {
			...
			if ((var_1_9 / (min (var_1_32 , var_1_33))) <= stepLocal_9) {
				var_1_28 = (var_1_29 + var_1_30);
			} else {
				var_1_28 = (max (((var_1_34 - var_1_35) - var_1_36) , var_1_30));
			}
		}
	}


	// From: Req23Batch131Amount500
	if (var_1_108) {
		if ((var_1_22 * var_1_21) == (var_1_46 * (min (var_1_103 , var_1_47)))) {
			var_1_69 = ((var_1_52 + (32 - var_1_70)) - var_1_55);
		} else {
			var_1_69 = (min (((var_1_70 + var_1_71) + (var_1_72 + var_1_73)) , (min (var_1_43 , var_1_49))));
		}
	} else {
	...
	// From: Req26Batch131Amount500
	if (var_1_48 > var_1_7) {
		if (var_1_106) {
			var_1_76 = (var_1_92 + var_1_58);
		} else {
			if ((var_1_95 == var_1_52) || var_1_26) {
				if ((max ((var_1_72 / var_1_55) , -64)) >= var_1_45) {
					var_1_76 = (var_1_77 - var_1_50);
				} else {
					var_1_76 = (abs (var_1_52));
				}
			} else {
				var_1_76 = (var_1_77 - 8);
			}
		...
		var_1_76 = (min ((max (var_1_5 , var_1_6)) , var_1_92));
	}


	// From: Req31Batch131Amount500
	signed long int stepLocal_26 = min (var_1_72 , var_1_81);
	unsigned long int stepLocal_25 = var_1_16;
	if (stepLocal_25 < var_1_81) {
		if (stepLocal_26 == var_1_43) {
			var_1_83 = -16;
		} else {
			var_1_83 = (max ((var_1_76 - var_1_6) , var_1_40));
		}
	} else {
	...
	// From: Req14Batch131Amount500
	signed long int stepLocal_13 = var_1_41;
	if (stepLocal_13 <= var_1_83) {
		var_1_54 = (var_1_50 - (var_1_55 - (min (var_1_51 , var_1_52))));
	} else {
		var_1_54 = var_1_48;
	}


	// From: Req33Batch131Amount500
	unsigned short int stepLocal_27 = var_1_5;
	if (var_1_6 > stepLocal_27) {
		if ((- var_1_34) >= var_1_63) {
			var_1_86 = (max (var_1_44 , (var_1_71 + var_1_57)));
		} else {
			var_1_86 = (max ((var_1_88 + -32) , -5));
		}
	}
}
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_1 == ((unsigned short int) (abs (var_1_2)))) && (((var_1_90 == var_1_2) || var_1_11) ? (var_1_3 == ((unsigned short int) ((var_1_5 + var_1_6) + (max (var_1_7 , (var_1_8 - var_1_9)))))) : 1)) && (((var_1_9 * var_1_2) >= (var_1_6 << var_1_5)) ? (var_1_10 == ((signed long int) (min (var_1_2 , var_1_5)))) : 1)) && (var_1_98 ? (var_1_98 ? (var_1_11 == ((unsigned char) (! var_1_13))) : (var_1_11 == ((unsigned char) ((! var_1_13) && var_1_14)))) : (var_1_11 == ((unsigned char) var_1_13)))) && ((((var_1_6 + 25) / var_1_8) < (100000 << var_1_9)) ? (((var_1_6 * (var_1_5 * var_1_16)) > var_1_7) ? (var_1_15 == ((unsigned long int) (var_1_5 + (2022748956u - (var_1_8 + var_1_16))))) : (var_1_15 == ((unsigned long int) var_1_16))) : (var_1_11 ? (var_1_15 == ((unsigned long int) (3711943259u - (max (var_1_6 , var_1_9))))) : 1))) && ((((max (var_1_2 , var_1_7)) + last_1_var_1_10) >= var_1_5) ? (var_1_16 == ((unsigned long int) (var_1_17 - (min (last_1_var_1_90 , var_1_9))))) : (var_1_16 == ((unsigned long int) var_1_6)))) && ((var_1_2 <= var_1_6) ? (var_1_18 == ((unsigned long int) (min (((var_1_19 + var_1_20) - (var_1_61 + var_1_6)) , (max ((4117883507u - var_1_7) , (min (var_1_2 , var_1_84)))))))) : (var_1_18 == ((unsigned long int) (min ((var_1_2 + 256u) , var_1_17)))))) && ((! var_1_14) ? ((var_1_10 <= (var_1_15 * var_1_18)) ? (var_1_21 == ((double) ((min ((min (15.8 , var_1_22)) , 32.4)) + var_1_23))) : ((var_1_9 >= (- (var_1_18 + var_1_15))) ? (var_1_21 == ((double) var_1_22)) : ((32u == (50u + var_1_20)) ? (var_1_21 == ((double) ((abs (max (var_1_23 , var_1_22))) - 15.4))) : (var_1_21 == ((double) (var_1_22 + var_1_23)))))) : 1)) && ((var_1_108 && var_1_13) ? ((var_1_7 == var_1_15) ? (var_1_24 == ((unsigned char) (! var_1_14))) : (var_1_24 == ((unsigned char) (((var_1_15 > var_1_6) && var_1_13) || var_1_26)))) : (((var_1_5 - 8) >= (var_1_16 * var_1_19)) ? (var_1_24 == ((unsigned char) ((var_1_2 > var_1_1) || var_1_13))) : 1))) && ((var_1_11 && var_1_26) ? (var_1_28 == ((float) ((var_1_29 + var_1_30) + var_1_23))) : (((max (var_1_32 , (var_1_10 | var_1_37))) > var_1_89) ? (var_1_28 == ((float) var_1_23)) : (((var_1_9 / (min (var_1_32 , var_1_33))) <= var_1_20) ? (var_1_28 == ((float) (var_1_29 + var_1_30))) : (var_1_28 == ((float) (max (((var_1_34 - var_1_35) - var_1_36) , var_1_30)))))))) && ((((max (var_1_17 , var_1_38)) - var_1_19) < var_1_5) ? ((var_1_6 > ((max (var_1_39 , var_1_40)) - var_1_5)) ? ((! (var_1_15 > var_1_17)) ? (var_1_37 == ((signed long int) ((var_1_41 - var_1_5) - 4))) : (var_1_37 == ((signed long int) var_1_39))) : (var_1_37 == ((signed long int) ((10 - 128) + var_1_7)))) : ((var_1_8 <= var_1_6) ? (var_1_37 == ((signed long int) (min (4 , (-1 - var_1_6))))) : 1))) && ((! (var_1_30 >= var_1_34)) ? (var_1_42 == ((signed char) (abs (max ((var_1_43 + var_1_44) , var_1_45))))) : ((var_1_9 < (var_1_7 * var_1_61)) ? ((((var_1_29 + var_1_23) + 16.5) != ((var_1_46 - var_1_47) - var_1_34)) ? (var_1_42 == ((signed char) ((min (var_1_48 , var_1_49)) - var_1_50))) : (var_1_42 == ((signed char) (var_1_44 + var_1_43)))) : (var_1_42 == ((signed char) (var_1_48 - (var_1_51 + var_1_52))))))) && ((((var_1_22 / var_1_46) * (var_1_36 * var_1_47)) >= var_1_23) ? (((- (var_1_46 + var_1_35)) < var_1_36) ? (var_1_53 == ((unsigned char) (min (var_1_50 , (var_1_51 + var_1_31))))) : 1) : (var_1_53 == ((unsigned char) (128 - var_1_50))))) && ((var_1_41 <= var_1_83) ? (var_1_54 == ((signed char) (var_1_50 - (var_1_55 - (min (var_1_51 , var_1_52)))))) : (var_1_54 == ((signed char) var_1_48)))) && ((var_1_18 == (var_1_40 / var_1_17)) ? (var_1_56 == ((unsigned char) (var_1_55 + var_1_57))) : ((((var_1_8 & var_1_90) * var_1_52) == var_1_2) ? (var_1_56 == ((unsigned char) (var_1_58 - var_1_51))) : (var_1_56 == ((unsigned char) var_1_58))))) && ((var_1_11 || (! (var_1_32 <= var_1_33))) ? (var_1_59 == ((signed char) (abs (var_1_44)))) : 1)) && (var_1_106 ? (var_1_60 == ((signed char) (var_1_49 - (var_1_52 + var_1_51)))) : 1)) && ((! var_1_106) ? (var_1_61 == ((signed long int) (var_1_5 + last_1_var_1_61))) : ((var_1_49 <= ((var_1_50 - var_1_31) / var_1_55)) ? (var_1_61 == ((signed long int) (max (var_1_33 , var_1_50)))) : 1))) && ((var_1_43 >= var_1_84) ? (var_1_62 == ((signed char) (max ((min (var_1_43 , var_1_44)) , var_1_49)))) : (var_1_62 == ((signed char) (min (var_1_45 , var_1_48)))))) && ((((var_1_17 & var_1_76) * (var_1_6 + 128u)) >= var_1_39) ? (var_1_63 == ((double) ((var_1_35 + (var_1_64 + var_1_65)) - var_1_36))) : (((var_1_35 - var_1_47) != ((var_1_34 - var_1_46) + var_1_21)) ? (var_1_63 == ((double) (var_1_47 - var_1_65))) : 1))) && ((var_1_26 || (var_1_22 >= var_1_30)) ? (var_1_66 == ((signed char) (min (var_1_43 , (var_1_51 + (abs (-8))))))) : ((31.6f >= (var_1_47 - var_1_65)) ? (var_1_26 ? (((- var_1_15) <= 1000u) ? (var_1_66 == ((signed char) var_1_49)) : (((var_1_33 % var_1_32) < var_1_89) ? (var_1_66 == ((signed char) (min (var_1_45 , (abs (var_1_51 + var_1_43)))))) : (var_1_66 == ((signed char) (var_1_51 - (var_1_55 - var_1_52)))))) : ((var_1_33 == var_1_40) ? (var_1_66 == ((signed char) (min (0 , (var_1_50 - 10))))) : (var_1_66 == ((signed char) (var_1_51 + (min (var_1_44 , var_1_43))))))) : (var_1_66 == ((signed char) (var_1_44 + 1)))))) && (((64 << var_1_38) <= var_1_16) ? (var_1_68 == ((signed char) (var_1_44 + -1))) : (var_1_68 == ((signed char) (abs (8)))))) && (var_1_108 ? (((var_1_22 * var_1_21) == (var_1_46 * (min (var_1_103 , var_1_47)))) ? (var_1_69 == ((signed char) ((var_1_52 + (32 - var_1_70)) - var_1_55))) : (var_1_69 == ((signed char) (min (((var_1_70 + var_1_71) + (var_1_72 + var_1_73)) , (min (var_1_43 , var_1_49))))))) : (var_1_69 == ((signed char) (2 - (var_1_55 - var_1_52)))))) && ((((min (var_1_51 , var_1_6)) << var_1_16) != var_1_72) ? (var_1_74 == ((double) (min ((min (var_1_64 , var_1_65)) , var_1_36)))) : (var_1_74 == ((double) (max ((abs (var_1_23)) , var_1_35)))))) && ((var_1_65 >= (50.2 + 128.6)) ? (var_1_75 == ((signed char) (max ((max (var_1_45 , (var_1_48 - var_1_50))) , (max (5 , var_1_72)))))) : 1)) && ((var_1_48 > var_1_7) ? (var_1_106 ? (var_1_76 == ((unsigned short int) (var_1_92 + var_1_58))) : (((var_1_95 == var_1_52) || var_1_26) ? (((max ((var_1_72 / var_1_55) , -64)) >= var_1_45) ? (var_1_76 == ((unsigned short int) (var_1_77 - var_1_50))) : (var_1_76 == ((unsigned short int) (abs (var_1_52))))) : (var_1_76 == ((unsigned short int) (var_1_77 - 8))))) : (var_1_76 == ((unsigned short int) (min ((max (var_1_5 , var_1_6)) , var_1_92)))))) && (var_1_98 ? (var_1_78 == ((float) (min (25.25f , var_1_64)))) : (var_1_78 == ((float) ((abs (var_1_29)) - (var_1_34 - var_1_64)))))) && ((var_1_59 >= var_1_18) ? (var_1_67 ? (var_1_79 == ((float) var_1_64)) : 1) : 1)) && (((max ((128 % var_1_58) , (var_1_52 << var_1_84))) < ((var_1_19 - var_1_7) - var_1_40)) ? (var_1_80 == ((float) (max ((min (15.25f , (min (var_1_36 , var_1_47)))) , (max (var_1_65 , var_1_22)))))) : (var_1_80 == ((float) ((var_1_65 + var_1_64) - var_1_47))))) && ((var_1_35 >= var_1_94) ? (var_1_67 ? (var_1_81 == ((unsigned char) (min (var_1_50 , ((var_1_55 + var_1_82) - var_1_52))))) : (var_1_81 == ((unsigned char) (min (var_1_50 , (min ((var_1_58 - var_1_52) , var_1_82))))))) : 1)) && ((var_1_16 < var_1_81) ? (((min (var_1_72 , var_1_81)) == var_1_43) ? (var_1_83 == ((signed long int) -16)) : (var_1_83 == ((signed long int) (max ((var_1_76 - var_1_6) , var_1_40))))) : (var_1_83 == ((signed long int) (var_1_8 - var_1_82))))) && (var_1_13 ? (var_1_84 == ((signed long int) (var_1_9 - (var_1_85 - 2)))) : (var_1_84 == ((signed long int) (max (((var_1_33 + var_1_10) + var_1_52) , var_1_8)))))) && ((var_1_6 > var_1_5) ? (((- var_1_34) >= var_1_63) ? (var_1_86 == ((signed short int) (max (var_1_44 , (var_1_71 + var_1_57))))) : (var_1_86 == ((signed short int) (max ((var_1_88 + -32) , -5))))) : 1)) && ((var_1_90 < var_1_16) ? (var_1_88 == ((signed long int) ((var_1_85 - 25) - (min (var_1_41 , var_1_83))))) : (((var_1_6 - 8) > (var_1_19 - (var_1_70 + var_1_8))) ? (var_1_88 == ((signed long int) (min ((var_1_5 - (var_1_9 + var_1_52)) , (-256 + (min (var_1_6 , var_1_10))))))) : (var_1_88 == ((signed long int) var_1_90))))) && (var_1_67 ? (var_1_89 == ((unsigned short int) (var_1_77 - var_1_5))) : 1)) && (last_1_var_1_108 ? (last_1_var_1_11 ? (var_1_90 == ((signed long int) (min (var_1_9 , (min (var_1_49 , var_1_33)))))) : ((! var_1_13) ? ((var_1_34 < last_1_var_1_63) ? (var_1_90 == ((signed long int) (var_1_7 - last_1_var_1_10))) : 1) : (var_1_90 == ((signed long int) (min (var_1_57 , (max (4 , var_1_5)))))))) : 1)) && ((var_1_51 < var_1_88) ? ((var_1_26 && var_1_108) ? (var_1_91 == ((signed short int) (var_1_55 - var_1_58))) : (var_1_91 == ((signed short int) var_1_55))) : (var_1_91 == ((signed short int) (50 + var_1_92))))) && ((var_1_99 >= var_1_107) ? (var_1_92 == ((signed short int) (abs (var_1_56 - var_1_105)))) : 1)) && (var_1_93 == ((unsigned char) var_1_50))) && (var_1_67 ? (var_1_94 == ((float) var_1_22)) : (var_1_94 == ((float) var_1_36)))) && (var_1_11 ? (var_1_95 == ((unsigned char) var_1_50)) : 1)) && (var_1_67 ? (var_1_96 == ((unsigned char) var_1_58)) : 1)) && (var_1_97 == ((unsigned char) var_1_50))) && (var_1_67 ? (var_1_98 == ((unsigned char) var_1_14)) : 1)) && (var_1_14 ? (var_1_99 == ((double) var_1_64)) : 1)) && (var_1_100 == ((double) var_1_22))) && (var_1_101 == ((float) var_1_36))) && (var_1_24 ? (var_1_102 == ((signed short int) var_1_43)) : (var_1_102 == ((signed short int) var_1_32)))) && (var_1_103 == ((float) var_1_47))) && (var_1_11 ? (var_1_104 == ((signed char) var_1_48)) : (var_1_104 == ((signed char) var_1_71)))) && (var_1_105 == ((signed long int) var_1_55))) && (var_1_106 == ((unsigned char) var_1_14))) && (var_1_13 ? (var_1_107 == ((float) var_1_23)) : (var_1_107 == ((float) var_1_36)))) && ((10.25 <= (last_1_var_1_74 * var_1_30)) ? (((min (last_1_var_1_68 , var_1_5)) < -5) ? (var_1_108 == ((unsigned char) ((last_1_var_1_24 || (var_1_13 && var_1_67)) && var_1_26))) : 1) : (var_1_108 == ((unsigned char) var_1_14)))
;
}
int main(void) {
	isInitial = 1;
