...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch89stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch89stepLocals
	signed long int stepLocal_1 = var_1_5 / var_1_9;
	signed long int stepLocal_0 = var_1_2 * 256;
	...
	// From: Req5Batch89stepLocals
	var_1_22 = (var_1_23 && var_1_24);


	// From: Req6Batch89stepLocals
	if (var_1_24) {
