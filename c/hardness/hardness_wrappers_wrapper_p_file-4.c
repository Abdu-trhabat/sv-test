...
void step(void) {
	...
	if ((- ((*(var_1_13_Pointer)) / 0.6f)) > (((*(var_1_14_Pointer)) + 3.25f) / (min ((*(var_1_15_Pointer)) , (*(var_1_16_Pointer)))))) {
		(*(var_1_12_Pointer)) = (500u + (min ((*(var_1_10_Pointer)) , (*(var_1_7_Pointer)))));
	} else {
	...
	if ((last_1_var_1_1 / (*(var_1_3_Pointer))) >= stepLocal_0) {
		if (stepLocal_1 > last_1_var_1_1) {
			(*(var_1_1_Pointer)) = (min ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer))));
		}
	}
...
int property(void) {
	return ((((((last_1_var_1_1 / (*(var_1_3_Pointer))) >= (*(var_1_12_Pointer))) ? (((- (*(var_1_3_Pointer))) > last_1_var_1_1) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (min ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))))) : 1) : 1) && ((*(var_1_7_Pointer)) == ((unsigned short int) (*(var_1_5_Pointer))))) && ((((*(var_1_12_Pointer)) / (*(var_1_3_Pointer))) != ((*(var_1_5_Pointer)) - 64)) ? ((*(var_1_8_Pointer)) == ((unsigned char) (max ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer)))))) : ((*(var_1_8_Pointer)) == ((unsigned char) (min ((*(var_1_11_Pointer)) , (*(var_1_10_Pointer)))))))) && (((- ((*(var_1_13_Pointer)) / 0.6f)) > (((*(var_1_14_Pointer)) + 3.25f) / (min ((*(var_1_15_Pointer)) , (*(var_1_16_Pointer)))))) ? ((*(var_1_12_Pointer)) == ((unsigned long int) (500u + (min ((*(var_1_10_Pointer)) , (*(var_1_7_Pointer))))))) : ((*(var_1_12_Pointer)) == ((unsigned long int) ((*(var_1_17_Pointer)) - (*(var_1_10_Pointer))))))) && ((*(var_1_18_Pointer)) == ((unsigned char) (*(var_1_11_Pointer))))
;
}
int main(void) {
	isInitial = 1;
