...
void step(void) {
	...
	// From: Req13Batch191100_1loop
	var_1_39 = var_1_40;


	// From: Req14Batch191100_1loop
	var_1_41 = var_1_40;


	// From: Req3Batch191100_1loop
	...
	// From: Req4Batch191100_1loop
	if (var_1_9 != var_1_7) {
		var_1_12 = (((var_1_10 / var_1_13) > var_1_6) || var_1_14);
	}


	// From: Req5Batch191100_1loop
