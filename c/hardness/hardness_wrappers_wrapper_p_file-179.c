...
void step(void) {
	// From: Req1Batch179Wrapper_P
	unsigned char stepLocal_0 = (*(var_1_2_Pointer));
	if (stepLocal_0 && (! (*(var_1_3_Pointer)))) {
		(*(var_1_1_Pointer)) = ((min ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) + 7.5);
	}


	// From: Req2Batch179Wrapper_P
	if ((*(var_1_1_Pointer)) > ((*(var_1_4_Pointer)) * (*(var_1_5_Pointer)))) {
		if ((*(var_1_1_Pointer)) <= (*(var_1_5_Pointer))) {
			if ((*(var_1_5_Pointer)) > (*(var_1_4_Pointer))) {
				(*(var_1_6_Pointer)) = ((*(var_1_4_Pointer)) + ((max ((*(var_1_7_Pointer)) , (*(var_1_8_Pointer)))) - (*(var_1_9_Pointer))));
			} else {
				(*(var_1_6_Pointer)) = (abs ((*(var_1_7_Pointer))));
			}
		} else {
	...
	// From: Req3Batch179Wrapper_P
	if ((*(var_1_5_Pointer)) > (*(var_1_8_Pointer))) {
		(*(var_1_10_Pointer)) = (((29089 - (*(var_1_11_Pointer))) - 8) + 16);
	} else {
		(*(var_1_10_Pointer)) = (min ((*(var_1_11_Pointer)) , (*(var_1_12_Pointer))));
	}


	// From: Req4Batch179Wrapper_P
...
int property(void) {
	return (((((*(var_1_2_Pointer)) && (! (*(var_1_3_Pointer)))) ? ((*(var_1_1_Pointer)) == ((double) ((min ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) + 7.5))) : 1) && (((*(var_1_1_Pointer)) > ((*(var_1_4_Pointer)) * (*(var_1_5_Pointer)))) ? (((*(var_1_1_Pointer)) <= (*(var_1_5_Pointer))) ? (((*(var_1_5_Pointer)) > (*(var_1_4_Pointer))) ? ((*(var_1_6_Pointer)) == ((double) ((*(var_1_4_Pointer)) + ((max ((*(var_1_7_Pointer)) , (*(var_1_8_Pointer)))) - (*(var_1_9_Pointer)))))) : ((*(var_1_6_Pointer)) == ((double) (abs ((*(var_1_7_Pointer))))))) : ((*(var_1_6_Pointer)) == ((double) (*(var_1_8_Pointer))))) : ((*(var_1_6_Pointer)) == ((double) (*(var_1_4_Pointer)))))) && (((*(var_1_5_Pointer)) > (*(var_1_8_Pointer))) ? ((*(var_1_10_Pointer)) == ((unsigned short int) (((29089 - (*(var_1_11_Pointer))) - 8) + 16))) : ((*(var_1_10_Pointer)) == ((unsigned short int) (min ((*(var_1_11_Pointer)) , (*(var_1_12_Pointer)))))))) && ((*(var_1_13_Pointer)) == ((double) (*(var_1_7_Pointer))))
;
}
int main(void) {
	isInitial = 1;
