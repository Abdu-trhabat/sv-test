...
void step(void) {
	// From: Req2Batch180Wrapper_S
	if (! WrapperStruct00.var_1_6) {
		WrapperStruct00.var_1_5 = (min (WrapperStruct00.var_1_7 , (WrapperStruct00.var_1_8 - (WrapperStruct00.var_1_9 + WrapperStruct00.var_1_10))));
	} else {
		WrapperStruct00.var_1_5 = (128 - WrapperStruct00.var_1_9);
	}


	// From: Req1Batch180Wrapper_S
	...
	if (WrapperStruct00.var_1_6) {
		if (stepLocal_1 < WrapperStruct00.var_1_10) {
			if ((max ((WrapperStruct00.var_1_8 - WrapperStruct00.var_1_10) , WrapperStruct00.var_1_1)) >= stepLocal_2) {
