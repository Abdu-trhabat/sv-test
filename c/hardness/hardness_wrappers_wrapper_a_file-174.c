...
void step(void) {
	...
	// From: Req4Batch174Wrapper_A
	unsigned long int stepLocal_1 = unsigned_long_int_Array_0[0][2];
	if (unsigned_long_int_Array_0[0][0] >= stepLocal_1) {
		if (BOOL_unsigned_char_Array_0[0]) {
			signed_short_int_Array_0[0] = (min (signed_short_int_Array_0[3] , signed_short_int_Array_0[4]));
		}
	} else {
...
int property(void) {
	return (((unsigned_long_int_Array_0[1][2] == ((unsigned long int) (unsigned_long_int_Array_0[0][2] - (unsigned_long_int_Array_0[1][1] - unsigned_long_int_Array_0[0][1])))) && (((unsigned_long_int_Array_0[0][1] < unsigned_long_int_Array_0[0][2]) || BOOL_unsigned_char_Array_0[0]) ? (unsigned_long_int_Array_0[1][0] == ((unsigned long int) ((max ((abs (unsigned_long_int_Array_0[0][2])) , 3934615513u)) - unsigned_long_int_Array_0[0][1]))) : (unsigned_long_int_Array_0[1][0] == ((unsigned long int) unsigned_long_int_Array_0[0][0])))) && (((unsigned_long_int_Array_0[1][0] > 1000000000u) || ((- 4.4f) >= float_Array_0[0])) ? (signed_long_int_Array_0[1][0] == ((signed long int) (unsigned_long_int_Array_0[0][1] - (signed_long_int_Array_0[0][1] - (min (signed_long_int_Array_0[1][1] , signed_long_int_Array_0[0][0])))))) : (BOOL_unsigned_char_Array_0[0] ? (signed_long_int_Array_0[1][0] == ((signed long int) signed_long_int_Array_0[0][0])) : (signed_long_int_Array_0[1][0] == ((signed long int) signed_long_int_Array_0[1][1]))))) && ((unsigned_long_int_Array_0[0][0] >= unsigned_long_int_Array_0[0][2]) ? (BOOL_unsigned_char_Array_0[0] ? (signed_short_int_Array_0[0] == ((signed short int) (min (signed_short_int_Array_0[3] , signed_short_int_Array_0[4])))) : 1) : (signed_short_int_Array_0[0] == ((signed short int) (signed_short_int_Array_0[1] + signed_short_int_Array_0[2]))))
;
}
int main(void) {
	isInitial = 1;
