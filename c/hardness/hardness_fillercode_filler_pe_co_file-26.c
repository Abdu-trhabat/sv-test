...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch26Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 238L, 29L) */ if (/* 239L, 7L, 8L) */ ((var_1_1) < (/* 241L, 6L, 10L) */ ((var_1_31) - (/* 243L, 5L, 12L) */ (abs (var_1_32))))))) {
	...
	// From: CodeObject3
	/* 268L, 94L) */ if (/* 269L, 67L, 68L) */ ((var_1_28) <= (/* 271L, 66L, 70L) */ (min (/* 271L, 66L, 70L) */ (var_1_31) , (var_1_32)))))) {
		/* 274L, 83L) */ var_1_39 = (
			/* 277L, 82L) */ (min (
				/* 277L, 82L) */ (
					var_1_40
	...
	// From: CodeObject5
	/* 311L, 166L) */ if (/* 312L, 155L, 156L) */ ((var_1_40) < (var_1_1))) {
		/* 315L, 165L) */ var_1_46 = (
			var_1_41
		);
	}
