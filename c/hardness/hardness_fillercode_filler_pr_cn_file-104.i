...
void step(void) {
 signed long int stepLocal_2 = (( ((var_1_4) + (-10))) * (var_1_20));
   ...
   var_1_23
             ...
             if ( ((var_1_32) > ( ((var_1_38) ^ (var_1_35))))) {
              if ( ((1000) > (var_1_40))) {
               if ( (( (((((var_1_29)) < (( ((var_1_41) + (var_1_30))))) ? ((var_1_29)) : (( ((var_1_41) + (var_1_30))))))) >= (var_1_31))) {
                var_1_42 = (
     var_1_33
    );
   }
 ...
 signed long int stepLocal_4 = (((((var_1_5)) < ((var_1_25))) ? ((var_1_5)) : ((var_1_25))));
   ...
   var_1_33
             ...
             if ( (( ((128) * ( ((var_1_30) | (-10))))) <= (5))) {
              ...
              if ( (( ((((( ((var_1_29) ^ (-5)))) < ((var_1_32))) ? (( ((var_1_29) ^ (-5)))) : ((var_1_32))))) <= (var_1_30))) {
               if ( ((var_1_32) >= (-128))) {
                var_1_34 = (
     var_1_35
    );
    ...
    var_1_3
             ...
             if ( ((var_1_38) != (var_1_40))) {
              if ( ((var_1_38) < ( (( ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))) | (var_1_32))))) {
               var_1_41 = (
