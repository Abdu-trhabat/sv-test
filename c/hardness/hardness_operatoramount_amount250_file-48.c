...
void step(void) {
	...
	if (256 <= stepLocal_4) {
		if (var_1_3 || stepLocal_5) {
			var_1_11 = (max ((var_1_12 + 64u) , (min (var_1_13 , 16u))));
		}
	} else {
		var_1_11 = (var_1_12 + (min (32u , (1806311775u - var_1_14))));
	}
	...
	var_1_26 = (((min (var_1_24 , var_1_27)) - (var_1_28 + var_1_29)) + var_1_30);
	...
	if ((- (var_1_26 + 255.125f)) != var_1_28) {
		var_1_42 = (max (((max (var_1_27 , var_1_29)) + var_1_43) , ((var_1_23 - 4.05f) - var_1_25)));
	}
	...
	if (stepLocal_10 && var_1_36) {
		var_1_46 = (max (var_1_28 , var_1_22));
	} else {
		var_1_46 = (abs ((var_1_47 + var_1_28) + 31.25f));
	}


	// From: Req19Batch48Amount250
	if ((var_1_24 * var_1_30) <= var_1_22) {
		var_1_52 = (min ((var_1_16 + var_1_50) , var_1_20));
	} else {
		var_1_52 = var_1_20;
	}
	...
	if (-64 > stepLocal_15) {
		var_1_58 = (abs (var_1_13));
	}


	// From: Req26Batch48Amount250
	signed long int stepLocal_16 = abs (var_1_19);
	...
	if (var_1_2 || stepLocal_0) {
		...
		if (stepLocal_3 != (var_1_58 % (max (var_1_9 , var_1_10)))) {
			if (! var_1_3) {
	...
	if (var_1_61 != (abs (var_1_20))) {
		var_1_21 = (((max (var_1_22 , var_1_23)) - var_1_24) - var_1_25);
	}
	...
	if (var_1_25 > (var_1_27 / var_1_22)) {
		if (stepLocal_7 > ((max (var_1_20 , var_1_16)) - (var_1_38 - 4))) {
			var_1_37 = var_1_60;
		} else {
	...
	if (var_1_1 >= var_1_34) {
		var_1_39 = ((abs (var_1_30)) + var_1_28);
	} else {
	...
	if (var_1_23 < (abs (var_1_25 / 10000.6f))) {
		var_1_40 = (var_1_16 - var_1_19);
	} else {
		if (var_1_41) {
			var_1_40 = (abs (var_1_19));
		} else {
			if (var_1_41) {
				var_1_40 = var_1_20;
			}
	...
	if ((max (var_1_12 , -10)) == stepLocal_11) {
		var_1_51 = (max ((var_1_50 + var_1_1) , (min ((abs (var_1_11)) , var_1_16))));
	}
	...
	if (stepLocal_9 < (var_1_15 - var_1_12)) {
		if (var_1_37 <= stepLocal_8) {
			if ((var_1_24 / 9.75) != (var_1_27 - var_1_23)) {
				var_1_44 = (min (var_1_19 , ((min (var_1_17 , var_1_16)) - (abs (100)))));
			} else {
		...
		var_1_44 = (abs (var_1_53));
	}


	// From: Req17Batch48Amount250
	if ((! var_1_41) || var_1_41) {
		if ((min (var_1_9 , var_1_57)) > (max (var_1_45 , (var_1_31 + var_1_1)))) {
			var_1_48 = (min (var_1_20 , ((var_1_19 + var_1_16) - var_1_50)));
		} else {
			var_1_48 = (var_1_20 + var_1_19);
		}
	} else {
		var_1_48 = (abs (var_1_16));
	}
...
int property(void) {
	return ((((((((((((((((((((((((((((var_1_2 || var_1_3) ? ((last_1_var_1_1 >= var_1_58) ? (var_1_1 == ((signed short int) ((max (50 , var_1_6)) + (var_1_7 + var_1_8)))) : (var_1_1 == ((signed short int) (var_1_8 + var_1_6)))) : ((var_1_8 != (var_1_58 % (max (var_1_9 , var_1_10)))) ? ((! var_1_3) ? ((var_1_9 != last_1_var_1_1) ? (var_1_1 == ((signed short int) var_1_7)) : (var_1_1 == ((signed short int) var_1_8))) : (var_1_1 == ((signed short int) var_1_6))) : (var_1_1 == ((signed short int) var_1_7)))) && ((256 <= (var_1_10 + last_1_var_1_61)) ? ((var_1_3 || var_1_2) ? (var_1_11 == ((unsigned long int) (max ((var_1_12 + 64u) , (min (var_1_13 , 16u)))))) : 1) : (var_1_11 == ((unsigned long int) (var_1_12 + (min (32u , (1806311775u - var_1_14)))))))) && (((var_1_14 >> var_1_16) >= var_1_12) ? (var_1_15 == ((unsigned char) (var_1_17 - var_1_16))) : 1)) && (var_1_18 == ((unsigned char) (var_1_17 - (var_1_16 + (var_1_19 - var_1_20)))))) && ((var_1_61 != (abs (var_1_20))) ? (var_1_21 == ((float) (((max (var_1_22 , var_1_23)) - var_1_24) - var_1_25))) : 1)) && (var_1_26 == ((double) (((min (var_1_24 , var_1_27)) - (var_1_28 + var_1_29)) + var_1_30)))) && ((var_1_6 < (var_1_10 / var_1_9)) ? (var_1_31 == ((unsigned long int) (var_1_32 - (var_1_33 - (var_1_34 - var_1_20))))) : ((((var_1_29 + var_1_27) / var_1_23) != (var_1_25 + var_1_26)) ? ((var_1_7 > var_1_51) ? (var_1_31 == ((unsigned long int) (var_1_60 + var_1_34))) : (var_1_31 == ((unsigned long int) var_1_14))) : 1))) && ((((var_1_6 + var_1_17) != (var_1_19 << var_1_8)) && (var_1_41 || (! var_1_41))) ? (var_1_35 == ((unsigned char) (var_1_17 - var_1_19))) : 1)) && ((var_1_25 > (var_1_27 / var_1_22)) ? ((var_1_9 > ((max (var_1_20 , var_1_16)) - (var_1_38 - 4))) ? (var_1_37 == ((signed short int) var_1_60)) : (var_1_37 == ((signed short int) ((var_1_16 + var_1_15) - var_1_60)))) : (var_1_37 == ((signed short int) var_1_17)))) && ((var_1_1 >= var_1_34) ? (var_1_39 == ((float) ((abs (var_1_30)) + var_1_28))) : (var_1_39 == ((float) (var_1_25 - var_1_29))))) && ((var_1_23 < (abs (var_1_25 / 10000.6f))) ? (var_1_40 == ((signed char) (var_1_16 - var_1_19))) : (var_1_41 ? (var_1_40 == ((signed char) (abs (var_1_19)))) : (var_1_41 ? (var_1_40 == ((signed char) var_1_20)) : 1)))) && (var_1_41 == ((unsigned char) (! var_1_36)))) && (((- (var_1_26 + 255.125f)) != var_1_28) ? (var_1_42 == ((float) (max (((max (var_1_27 , var_1_29)) + var_1_43) , ((var_1_23 - 4.05f) - var_1_25))))) : 1)) && (((var_1_11 / var_1_10) < (var_1_15 - var_1_12)) ? ((var_1_37 <= var_1_11) ? (((var_1_24 / 9.75) != (var_1_27 - var_1_23)) ? (var_1_44 == ((signed short int) (min (var_1_19 , ((min (var_1_17 , var_1_16)) - (abs (100))))))) : (var_1_44 == ((signed short int) (var_1_53 + var_1_17)))) : (var_1_44 == ((signed short int) (5 - (var_1_17 + var_1_16))))) : (var_1_44 == ((signed short int) (abs (var_1_53)))))) && (var_1_45 == ((unsigned long int) (var_1_17 + var_1_38)))) && ((var_1_41 && var_1_36) ? (var_1_46 == ((float) (max (var_1_28 , var_1_22)))) : (var_1_46 == ((float) (abs ((var_1_47 + var_1_28) + 31.25f)))))) && (((! var_1_41) || var_1_41) ? (((min (var_1_9 , var_1_57)) > (max (var_1_45 , (var_1_31 + var_1_1)))) ? (var_1_48 == ((signed char) (min (var_1_20 , ((var_1_19 + var_1_16) - var_1_50))))) : (var_1_48 == ((signed char) (var_1_20 + var_1_19)))) : (var_1_48 == ((signed char) (abs (var_1_16)))))) && (((max (var_1_12 , -10)) == var_1_33) ? (var_1_51 == ((unsigned short int) (max ((var_1_50 + var_1_1) , (min ((abs (var_1_11)) , var_1_16)))))) : 1)) && (((var_1_24 * var_1_30) <= var_1_22) ? (var_1_52 == ((unsigned char) (min ((var_1_16 + var_1_50) , var_1_20)))) : (var_1_52 == ((unsigned char) var_1_20)))) && ((var_1_61 == (var_1_14 / var_1_34)) ? ((var_1_28 > var_1_43) ? (var_1_53 == ((unsigned char) var_1_20)) : 1) : (var_1_53 == ((unsigned char) ((abs (var_1_16)) + 32))))) && ((var_1_41 && var_1_36) ? (var_1_54 == ((float) (var_1_30 + (var_1_29 - var_1_24)))) : 1)) && (((var_1_31 | var_1_53) >= var_1_31) ? (var_1_55 == ((signed char) ((var_1_16 - 2) + var_1_19))) : ((64.5 <= var_1_21) ? (var_1_55 == ((signed char) ((abs (16)) + var_1_19))) : (var_1_55 == ((signed char) (var_1_19 - (var_1_16 + var_1_20))))))) && ((var_1_54 == var_1_29) ? (var_1_56 == ((float) (var_1_47 + var_1_43))) : (var_1_56 == ((float) (max (3.64f , var_1_24)))))) && ((var_1_22 > var_1_24) ? ((var_1_27 > (var_1_59 + (var_1_22 - var_1_25))) ? (var_1_57 == ((signed char) (var_1_19 - var_1_50))) : 1) : 1)) && ((-64 > var_1_14) ? (var_1_58 == ((unsigned long int) (abs (var_1_13)))) : 1)) && (((abs (var_1_19)) != var_1_10) ? (var_1_59 == ((double) var_1_30)) : (var_1_59 == ((double) var_1_24)))) && (var_1_41 ? (var_1_60 == ((unsigned char) var_1_17)) : (var_1_60 == ((unsigned char) var_1_20)))) && ((var_1_32 < var_1_11) ? (var_1_61 == ((unsigned long int) ((var_1_33 + (var_1_62 - var_1_19)) - (var_1_63 - var_1_64)))) : (var_1_61 == ((unsigned long int) var_1_58)))
;
}
int main(void) {
	isInitial = 1;
