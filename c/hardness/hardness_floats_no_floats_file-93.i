...
void step(void) {
 if (8 >= (((((last_1_var_1_12) < (var_1_5)) ? (last_1_var_1_12) : (var_1_5))) / var_1_9)) {
 ...
 if ((- var_1_8) < (var_1_11 * var_1_4)) {
  ...
  if (var_1_16) {
   var_1_12 = ((((100) > (var_1_5)) ? (100) : (var_1_5)));
  } else {
   var_1_12 = var_1_5;
  }
 }
 ...
 if ((var_1_2 < var_1_3) && stepLocal_0) {
  var_1_1 = (((((var_1_5 - ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))))) > (var_1_7)) ? ((var_1_5 - ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))))) : (var_1_7)));
 }
}
void updateVariables(void) {
...
int property(void) {
 return ((((var_1_2 < var_1_3) && (var_1_4 > 10)) ? (var_1_1 == ((signed long int) (((((var_1_5 - ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))))) > (var_1_7)) ? ((var_1_5 - ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))))) : (var_1_7))))) : 1) && ((8 >= (((((last_1_var_1_12) < (var_1_5)) ? (last_1_var_1_12) : (var_1_5))) / var_1_9)) ? (var_1_8 == ((unsigned char) (var_1_10 + var_1_11))) : (var_1_8 == ((unsigned char) var_1_10)))) && (((- var_1_8) < (var_1_11 * var_1_4)) ? ((var_1_8 > var_1_13) ? (var_1_12 == ((signed long int) (var_1_5 - var_1_14))) : ((var_1_15 && var_1_16) ? (var_1_12 == ((signed long int) var_1_7)) : 1)) : (var_1_16 ? (var_1_12 == ((signed long int) ((((100) > (var_1_5)) ? (100) : (var_1_5))))) : (var_1_12 == ((signed long int) var_1_5))))
;
}
int main(void) {
 isInitial = 1;
