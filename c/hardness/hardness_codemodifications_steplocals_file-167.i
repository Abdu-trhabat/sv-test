...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch167stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_0 == ((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5)))) {
  var_1_1 = (((var_1_6 + var_1_7) + ((((var_1_8) < (var_1_9)) ? (var_1_8) : (var_1_9)))) - var_1_10);
 } else {
  var_1_1 = 8.2f;
 }
 if (var_1_10 > (var_1_7 * (var_1_6 / var_1_12))) {
  var_1_11 = (var_1_7 - var_1_9);
 } else {
  var_1_11 = var_1_8;
 }
 ...
 unsigned long int stepLocal_2 = ((((var_1_3) > (var_1_18)) ? (var_1_3) : (var_1_18))) * var_1_4;
 if (stepLocal_2 == var_1_5) {
  var_1_17 = (-1 - var_1_19);
 } else {
  var_1_17 = var_1_13;
 }
 var_1_20 = ((var_1_21 + 16) + (var_1_22 + var_1_23));
...
int property(void) {
 return (((((((var_1_3 == ((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5)))) ? (var_1_1 == ((float) (((var_1_6 + var_1_7) + ((((var_1_8) < (var_1_9)) ? (var_1_8) : (var_1_9)))) - var_1_10))) : (var_1_1 == ((float) 8.2f))) && ((var_1_10 > (var_1_7 * (var_1_6 / var_1_12))) ? (var_1_11 == ((double) (var_1_7 - var_1_9))) : (var_1_11 == ((double) var_1_8)))) && (((var_1_2 && var_1_14) && var_1_15) ? (var_1_13 == ((signed char) var_1_16)) : 1)) && (((((((var_1_3) > (var_1_18)) ? (var_1_3) : (var_1_18))) * var_1_4) == var_1_5) ? (var_1_17 == ((signed short int) (-1 - var_1_19))) : (var_1_17 == ((signed short int) var_1_13)))) && (var_1_20 == ((unsigned short int) ((var_1_21 + 16) + (var_1_22 + var_1_23))))) && ((((((var_1_1) < ((- var_1_9))) ? (var_1_1) : ((- var_1_9)))) > var_1_8) ? (((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) / ((((var_1_12) > (var_1_25)) ? (var_1_12) : (var_1_25)))) < var_1_11) ? (var_1_24 == ((signed char) (var_1_26 + -2))) : (var_1_24 == ((signed char) var_1_16))) : (var_1_24 == ((signed char) var_1_26)))) && ((var_1_1 >= ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))) ? (var_1_27 == ((unsigned char) (var_1_28 || var_1_29))) : (var_1_27 == ((unsigned char) var_1_30)))
;
}
int main(void) {
 isInitial = 1;
