...
void step(void) {
	...
	// From: Req4Batch139has_floats
	var_1_17 = 1;


	// From: Req5Batch139has_floats
	var_1_18 = var_1_9;


	// From: Req1Batch139has_floats
	if ((min (var_1_12 , -10.0f)) <= var_1_12) {
		if (var_1_4) {
			var_1_1 = (min (1 , 16));
		}
	} else {
...
int property(void) {
	return ((((((min (var_1_12 , -10.0f)) <= var_1_12) ? (var_1_4 ? (var_1_1 == ((signed short int) (min (1 , 16)))) : 1) : (((min (64 , var_1_18)) == -16) ? (var_1_1 == ((signed short int) var_1_6)) : 1)) && (((max ((var_1_8 - var_1_9) , (~ var_1_18))) == (var_1_6 & var_1_18)) ? (var_1_7 == ((double) (var_1_10 - var_1_11))) : (var_1_7 == ((double) var_1_10)))) && ((var_1_8 < var_1_6) ? (var_1_4 ? ((var_1_13 || var_1_14) ? (var_1_12 == ((double) (var_1_10 - var_1_11))) : (var_1_12 == ((double) (var_1_15 + var_1_16)))) : 1) : 1)) && (var_1_17 == ((signed char) 1))) && (var_1_18 == ((unsigned long int) var_1_9))
;
}
int main(void) {
	isInitial = 1;
