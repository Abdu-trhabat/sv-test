...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch76has_floats.c", 13, "reach_error"); }
...
int property(void) {
 return ((((((- 5) + var_1_3) >= var_1_4) ? (var_1_1 == ((unsigned char) (! var_1_5))) : (var_1_1 == ((unsigned char) var_1_5))) && ((var_1_3 > (var_1_7 - var_1_8)) ? (var_1_6 == ((double) (((((var_1_9) < (var_1_10)) ? (var_1_9) : (var_1_10))) + var_1_11))) : ((var_1_11 >= ((((var_1_9) > (var_1_10)) ? (var_1_9) : (var_1_10)))) ? ((var_1_3 <= var_1_8) ? (var_1_1 ? (var_1_6 == ((double) var_1_9)) : (var_1_6 == ((double) var_1_12))) : 1) : (var_1_6 == ((double) var_1_9))))) && ((var_1_6 >= 100.0) ? (var_1_13 == ((float) var_1_9)) : 1)) && ((var_1_4 >= (var_1_8 - var_1_7)) ? ((var_1_11 >= var_1_10) ? (var_1_14 == ((double) var_1_15)) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
