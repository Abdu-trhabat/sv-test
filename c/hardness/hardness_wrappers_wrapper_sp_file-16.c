...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((*(WrapperStruct00_var_1_15_Pointer)) % (max ((*(WrapperStruct00_var_1_3_Pointer)) , (*(WrapperStruct00_var_1_4_Pointer))))) <= -1000000) {
