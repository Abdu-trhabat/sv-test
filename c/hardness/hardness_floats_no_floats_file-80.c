...
void step(void) {
	...
	if ((max ((var_1_2 - var_1_3) , var_1_4)) <= (min ((var_1_5 - var_1_6) , (var_1_7 % var_1_8)))) {
		var_1_1 = (min ((var_1_9 - var_1_10) , var_1_11));
	}
	...
	if (var_1_11 == (min (var_1_4 , -16))) {
		var_1_15 = (max ((abs (var_1_16)) , (var_1_17 + var_1_18)));
	} else {
		var_1_15 = 8;
	}
...
int property(void) {
	return (((((max ((var_1_2 - var_1_3) , var_1_4)) <= (min ((var_1_5 - var_1_6) , (var_1_7 % var_1_8)))) ? (var_1_1 == ((signed short int) (min ((var_1_9 - var_1_10) , var_1_11)))) : 1) && ((var_1_13 || (var_1_1 <= var_1_11)) ? (var_1_12 == ((signed char) (abs (1 - var_1_14)))) : (var_1_12 == ((signed char) var_1_14)))) && ((var_1_11 == (min (var_1_4 , -16))) ? (var_1_15 == ((signed long int) (max ((abs (var_1_16)) , (var_1_17 + var_1_18))))) : (var_1_15 == ((signed long int) 8)))) && ((var_1_2 >= (var_1_5 - var_1_6)) ? (var_1_13 ? (var_1_19 == ((signed char) var_1_14)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
