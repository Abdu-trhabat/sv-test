...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch74Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
 unsigned char stepLocal_0 = (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) > (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer));
