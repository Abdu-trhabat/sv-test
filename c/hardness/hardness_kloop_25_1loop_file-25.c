...
void step(void) {
	...
	if ((-2 / (abs (var_1_8))) != (min ((var_1_3 ^ var_1_7) , (var_1_4 | var_1_9)))) {
		if (var_1_4 > var_1_3) {
			var_1_6 = var_1_10;
		} else {
			var_1_6 = var_1_11;
...
int property(void) {
	return ((var_1_6 ? ((var_1_3 <= var_1_4) ? (var_1_1 == ((unsigned long int) ((max (var_1_3 , var_1_4)) + var_1_5))) : 1) : (var_1_1 == ((unsigned long int) var_1_5))) && (((-2 / (abs (var_1_8))) != (min ((var_1_3 ^ var_1_7) , (var_1_4 | var_1_9)))) ? ((var_1_4 > var_1_3) ? (var_1_6 == ((unsigned char) var_1_10)) : (var_1_6 == ((unsigned char) var_1_11))) : (var_1_6 == ((unsigned char) var_1_11)))) && ((var_1_7 > var_1_5) ? ((((var_1_8 + 10) <= var_1_1) && var_1_6) ? (var_1_12 == ((signed short int) var_1_13)) : 1) : (var_1_12 == ((signed short int) var_1_13)))
;
}
int main(void) {
	isInitial = 1;
