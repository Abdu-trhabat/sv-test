...
void step(void) {
	...
	// From: CodeObject5
	/* 409L, 251L) */ if (/* 410L, 235L, 236L) */ ((/* 411L, 233L, 237L) */ ((var_1_23) & (-100))) <= (var_1_5))) {
		/* 415L, 250L) */ var_1_38 = (
			/* 418L, 249L) */ (! (
				var_1_39
			))
	...
	/* 359L, 161L) */ if (var_1_8) {
		/* 361L, 159L) */ if (/* 362L, 139L, 140L) */ ((var_1_8) && (/* 364L, 138L, 142L) */ ((1) >= (var_1_20))))) {
	...
	// From: CodeObject3
	/* 374L, 208L) */ if (/* 375L, 173L, 174L) */ ((/* 376L, 171L, 175L) */ ((var_1_23) & (var_1_1))) >= (var_1_20))) {
		/* 380L, 189L) */ var_1_31 = (
			/* 383L, 188L) */ (abs (
				/* 384L, 187L) */ (abs (
					var_1_23
