...
void step(void) {
	// From: Req2Batch194Wrapper_S
	unsigned char stepLocal_2 = WrapperStruct00.var_1_2;
	signed long int stepLocal_1 = WrapperStruct00.var_1_5 / (min (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_11));
	...
	// From: Req3Batch194Wrapper_S
	if (WrapperStruct00.var_1_2) {
		if (WrapperStruct00.var_1_7 > (WrapperStruct00.var_1_8 | (max (WrapperStruct00.var_1_11 , WrapperStruct00.var_1_3)))) {
			if ((WrapperStruct00.var_1_13 - WrapperStruct00.var_1_14) < (WrapperStruct00.var_1_8 / (max (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_11)))) {
	...
	if (WrapperStruct00.var_1_2) {
		if ((WrapperStruct00.var_1_3 == WrapperStruct00.var_1_4) && stepLocal_0) {
			WrapperStruct00.var_1_1 = (abs (WrapperStruct00.var_1_8));
		}
	} else {
...
int property(void) {
	return ((WrapperStruct00.var_1_2 ? (((WrapperStruct00.var_1_3 == WrapperStruct00.var_1_4) && ((WrapperStruct00.var_1_9 % WrapperStruct00.var_1_7) >= WrapperStruct00.var_1_9)) ? (WrapperStruct00.var_1_1 == ((signed char) (abs (WrapperStruct00.var_1_8)))) : 1) : (WrapperStruct00.var_1_1 == ((signed char) WrapperStruct00.var_1_8))) && ((WrapperStruct00.var_1_2 && WrapperStruct00.var_1_10) ? (WrapperStruct00.var_1_9 == ((signed long int) WrapperStruct00.var_1_6)) : (WrapperStruct00.var_1_10 ? ((WrapperStruct00.var_1_6 >= (WrapperStruct00.var_1_5 / (min (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_11)))) ? (WrapperStruct00.var_1_9 == ((signed long int) WrapperStruct00.var_1_8)) : 1) : 1))) && (WrapperStruct00.var_1_2 ? ((WrapperStruct00.var_1_7 > (WrapperStruct00.var_1_8 | (max (WrapperStruct00.var_1_11 , WrapperStruct00.var_1_3)))) ? (((WrapperStruct00.var_1_13 - WrapperStruct00.var_1_14) < (WrapperStruct00.var_1_8 / (max (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_11)))) ? (WrapperStruct00.var_1_12 == ((signed char) WrapperStruct00.var_1_8)) : (WrapperStruct00.var_1_12 == ((signed char) 8))) : (WrapperStruct00.var_1_12 == ((signed char) WrapperStruct00.var_1_8))) : 1)
;
}
int main(void) {
	isInitial = 1;
