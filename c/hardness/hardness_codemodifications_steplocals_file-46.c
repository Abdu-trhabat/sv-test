...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch46stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	signed long int stepLocal_2 = (var_1_5 << var_1_11) + (var_1_4 + var_1_1);
	...
	if ((var_1_12 % (abs (var_1_4))) != stepLocal_3) {
