...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch53stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_3 = (((var_1_6) < (0)) ? (var_1_6) : (0));
 ...
 if (var_1_1) {
  var_1_14 = ((((var_1_2) > (var_1_3)) ? (var_1_2) : (var_1_3)));
 } else {
 ...
 if ((((((var_1_15) > (var_1_9)) ? (var_1_15) : (var_1_9))) / var_1_17) <= stepLocal_6) {
