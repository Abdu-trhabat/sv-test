...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16625_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch16625_1loop
	unsigned char stepLocal_1 = var_1_7;
	if (var_1_6 || stepLocal_1) {
		var_1_5 = (min (var_1_1 , (var_1_4 - (var_1_8 - 100000))));
	} else {
		var_1_5 = (min (var_1_4 , var_1_1));
	}


	// From: Req3Batch16625_1loop
	signed short int stepLocal_2 = var_1_3;
	if (! var_1_7) {
		var_1_9 = ((abs (var_1_10)) + (abs (var_1_11)));
	} else {
...
int property(void) {
	return ((((var_1_2 < var_1_3) ? (var_1_1 == ((unsigned short int) var_1_4)) : 1) && ((var_1_6 || var_1_7) ? (var_1_5 == ((signed long int) (min (var_1_1 , (var_1_4 - (var_1_8 - 100000)))))) : (var_1_5 == ((signed long int) (min (var_1_4 , var_1_1)))))) && ((! var_1_7) ? (var_1_9 == ((double) ((abs (var_1_10)) + (abs (var_1_11))))) : ((var_1_3 > var_1_2) ? (var_1_9 == ((double) 31.93)) : (var_1_9 == ((double) var_1_10))))) && ((var_1_3 > var_1_2) ? (var_1_12 == ((signed char) (var_1_13 - var_1_14))) : 1)
;
}
int main(void) {
	isInitial = 1;
