...
void step(void) {
	// From: Req4Batch140normal
	var_1_14 = (max (var_1_6 , (min (last_1_var_1_18 , last_1_var_1_1))));


	// From: Req5Batch140normal
	if (var_1_14 <= var_1_6) {
		var_1_15 = (var_1_12 - (min (var_1_13 , (5.410574086893798E18f - var_1_16))));
	} else {
		if (var_1_17) {
			var_1_15 = var_1_9;
		}
	...
	// From: Req2Batch140normal
	if (var_1_3) {
		var_1_8 = (var_1_9 + var_1_10);
	}


	// From: Req3Batch140normal
	if (var_1_10 >= var_1_8) {
		var_1_11 = (var_1_12 - var_1_13);
	}


	// From: Req7Batch140normal
	var_1_23 = (max ((max (var_1_7 , var_1_21)) , var_1_24));


	// From: Req8Batch140normal
	var_1_25 = -1;


	// From: Req6Batch140normal
	if (var_1_6 > var_1_14) {
...
int property(void) {
	return ((((((((var_1_2 && var_1_3) ? ((var_1_23 < var_1_18) ? (var_1_3 ? (var_1_1 == ((signed short int) (var_1_6 - var_1_7))) : (var_1_1 == ((signed short int) var_1_7))) : (var_1_1 == ((signed short int) var_1_7))) : (var_1_1 == ((signed short int) var_1_18))) && (var_1_3 ? (var_1_8 == ((double) (var_1_9 + var_1_10))) : 1)) && ((var_1_10 >= var_1_8) ? (var_1_11 == ((double) (var_1_12 - var_1_13))) : 1)) && (var_1_14 == ((signed short int) (max (var_1_6 , (min (last_1_var_1_18 , last_1_var_1_1))))))) && ((var_1_14 <= var_1_6) ? (var_1_15 == ((float) (var_1_12 - (min (var_1_13 , (5.410574086893798E18f - var_1_16)))))) : (var_1_17 ? (var_1_15 == ((float) var_1_9)) : 1))) && ((var_1_6 > var_1_14) ? ((((var_1_6 - var_1_7) | var_1_23) >= var_1_14) ? ((var_1_3 && (var_1_15 >= (var_1_13 - var_1_19))) ? (var_1_18 == ((signed char) (var_1_20 - var_1_21))) : (var_1_18 == ((signed char) (min ((min (var_1_20 , var_1_21)) , -16))))) : (var_1_18 == ((signed char) (-10 + (var_1_22 + 5))))) : 1)) && (var_1_23 == ((unsigned long int) (max ((max (var_1_7 , var_1_21)) , var_1_24))))) && (var_1_25 == ((signed char) -1))
;
}
int main(void) {
	isInitial = 1;
