...
void step(void) {
	// From: Req1Batch15050_1loop
	if (var_1_2 < (var_1_3 - var_1_4)) {
		var_1_1 = (var_1_5 + var_1_6);
	}


	// From: Req2Batch15050_1loop
	if (var_1_8) {
	...
	// From: Req4Batch15050_1loop
	if ((var_1_3 / var_1_17) >= ((var_1_1 / 16.69) * var_1_1)) {
		var_1_16 = var_1_28;
	}


	// From: Req5Batch15050_1loop
