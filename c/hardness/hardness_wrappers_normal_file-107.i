...
void step(void) {
 ...
 if (! (var_1_5 >= var_1_1)) {
  if (((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))) >= stepLocal_0) {
   var_1_6 = (var_1_1 + (var_1_10 + -2));
  } else {
   var_1_6 = (((((((((-8) < 0 ) ? -(-8) : (-8)))) < (var_1_11)) ? (((((-8) < 0 ) ? -(-8) : (-8)))) : (var_1_11))) - var_1_12);
  }
 }
 var_1_13 = var_1_5;
 if (var_1_7 <= var_1_9) {
  if (var_1_6 > ((var_1_15 - var_1_16) - var_1_17)) {
   var_1_14 = var_1_5;
  } else {
   var_1_14 = -100;
  }
...
int property(void) {
 return ((((var_1_2 > (var_1_3 - var_1_4)) ? (var_1_1 == ((signed char) var_1_5)) : ((var_1_4 > var_1_2) ? (var_1_1 == ((signed char) 10)) : (var_1_1 == ((signed char) var_1_5)))) && ((! (var_1_5 >= var_1_1)) ? ((((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))) >= (~ (- var_1_9))) ? (var_1_6 == ((signed short int) (var_1_1 + (var_1_10 + -2)))) : (var_1_6 == ((signed short int) (((((((((-8) < 0 ) ? -(-8) : (-8)))) < (var_1_11)) ? (((((-8) < 0 ) ? -(-8) : (-8)))) : (var_1_11))) - var_1_12)))) : 1)) && (var_1_13 == ((signed char) var_1_5))) && ((var_1_7 <= var_1_9) ? ((var_1_6 > ((var_1_15 - var_1_16) - var_1_17)) ? (var_1_14 == ((signed char) var_1_5)) : (var_1_14 == ((signed char) -100))) : 1)
;
}
int main(void) {
 isInitial = 1;
