...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_2_Pointer)) <= stepLocal_0) {
		...
		(*(WrapperStruct00_var_1_1_Pointer)) = (max ((max ((*(WrapperStruct00_var_1_4_Pointer)) , 100)) , (*(WrapperStruct00_var_1_5_Pointer))));
	}


	// From: Req3Batch184Wrapper_SP
	...
	if ((((*(WrapperStruct00_var_1_1_Pointer)) + (*(WrapperStruct00_var_1_8_Pointer))) + (*(WrapperStruct00_var_1_2_Pointer))) < stepLocal_2) {
		if ((*(WrapperStruct00_var_1_10_Pointer))) {
			(*(WrapperStruct00_var_1_9_Pointer)) = (abs ((*(WrapperStruct00_var_1_11_Pointer)) - 4.25f));
		} else {
	...
	// From: Req4Batch184Wrapper_SP
	(*(WrapperStruct00_var_1_13_Pointer)) = (*(WrapperStruct00_var_1_11_Pointer));


	// From: Req6Batch184Wrapper_SP
	(*(WrapperStruct00_var_1_15_Pointer)) = (*(WrapperStruct00_var_1_4_Pointer));


	// From: Req2Batch184Wrapper_SP
	unsigned long int stepLocal_1 = (max ((*(WrapperStruct00_var_1_15_Pointer)) , (*(WrapperStruct00_var_1_2_Pointer)))) / (max ((*(WrapperStruct00_var_1_7_Pointer)) , (*(WrapperStruct00_var_1_8_Pointer))));
	if (((*(WrapperStruct00_var_1_5_Pointer)) + (*(WrapperStruct00_var_1_4_Pointer))) > stepLocal_1) {
		(*(WrapperStruct00_var_1_6_Pointer)) = (max ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_15_Pointer))));
	}


	// From: Req5Batch184Wrapper_SP
...
int property(void) {
	return (((((((*(WrapperStruct00_var_1_2_Pointer)) <= (*(WrapperStruct00_var_1_3_Pointer))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned char) ((*(WrapperStruct00_var_1_4_Pointer)) - 32))) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned char) (max ((max ((*(WrapperStruct00_var_1_4_Pointer)) , 100)) , (*(WrapperStruct00_var_1_5_Pointer))))))) && ((((*(WrapperStruct00_var_1_5_Pointer)) + (*(WrapperStruct00_var_1_4_Pointer))) > ((max ((*(WrapperStruct00_var_1_15_Pointer)) , (*(WrapperStruct00_var_1_2_Pointer)))) / (max ((*(WrapperStruct00_var_1_7_Pointer)) , (*(WrapperStruct00_var_1_8_Pointer)))))) ? ((*(WrapperStruct00_var_1_6_Pointer)) == ((unsigned short int) (max ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_15_Pointer)))))) : 1)) && (((((*(WrapperStruct00_var_1_1_Pointer)) + (*(WrapperStruct00_var_1_8_Pointer))) + (*(WrapperStruct00_var_1_2_Pointer))) < (*(WrapperStruct00_var_1_5_Pointer))) ? ((*(WrapperStruct00_var_1_10_Pointer)) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((float) (abs ((*(WrapperStruct00_var_1_11_Pointer)) - 4.25f)))) : ((*(WrapperStruct00_var_1_9_Pointer)) == ((float) ((*(WrapperStruct00_var_1_11_Pointer)) - (8.966829933912052E18f - (*(WrapperStruct00_var_1_12_Pointer))))))) : ((*(WrapperStruct00_var_1_9_Pointer)) == ((float) (*(WrapperStruct00_var_1_12_Pointer)))))) && ((*(WrapperStruct00_var_1_13_Pointer)) == ((float) (*(WrapperStruct00_var_1_11_Pointer))))) && ((*(WrapperStruct00_var_1_14_Pointer)) == ((signed long int) (*(WrapperStruct00_var_1_15_Pointer))))) && ((*(WrapperStruct00_var_1_15_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_4_Pointer))))
;
}
int main(void) {
	isInitial = 1;
