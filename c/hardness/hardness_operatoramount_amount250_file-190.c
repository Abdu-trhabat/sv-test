...
void step(void) {
	...
	// From: Req18Batch190Amount250
	if (last_1_var_1_14 >= -5) {
		var_1_67 = var_1_69;
	} else {
		if (last_1_var_1_24 <= last_1_var_1_1) {
			if ((var_1_35 - (var_1_32 + var_1_55)) <= var_1_31) {
				var_1_67 = (((var_1_54 - var_1_55) - var_1_32) + (min ((max (var_1_31 , var_1_30)) , var_1_70)));
			} else {
				var_1_67 = (max ((var_1_55 + (max (var_1_30 , var_1_70))) , var_1_33));
			}
		}
	}


	// From: Req13Batch190Amount250
	unsigned char stepLocal_6 = var_1_45;
	signed long int stepLocal_5 = min (var_1_38 , (last_1_var_1_46 | var_1_12));
	...
	// From: Req3Batch190Amount250
	var_1_14 = (var_1_8 + var_1_12);


	// From: Req11Batch190Amount250
	if (var_1_12 >= 5) {
		var_1_43 = (var_1_12 - ((var_1_44 - var_1_42) + var_1_45));
	} else {
		if ((abs (var_1_10)) <= (min ((- var_1_44) , var_1_42))) {
			var_1_43 = var_1_12;
		}
	}


	// From: Req14Batch190Amount250
	if (var_1_51) {
		var_1_53 = (min ((var_1_31 - (abs (var_1_33))) , 9.9999999975E8f));
	} else {
		var_1_53 = ((var_1_31 - (var_1_54 - var_1_55)) + (0.8f - var_1_32));
	}


	// From: Req16Batch190Amount250
	var_1_61 = var_1_52;


	// From: Req20Batch190Amount250
	unsigned long int stepLocal_11 = (var_1_44 << var_1_25) | var_1_26;
	if (stepLocal_11 <= ((max (var_1_26 , var_1_23)) * var_1_57)) {
	...
	if ((var_1_67 * 1.42f) != var_1_67) {
		...
		if (stepLocal_2 >= (16u / var_1_18)) {
			...
			var_1_28 = (((min (var_1_33 , var_1_34)) - (min (var_1_31 , var_1_32))) - var_1_35);
		}
	}


	// From: Req1Batch190Amount250
	...
	// From: Req2Batch190Amount250
	if (var_1_28 < (max (var_1_53 , var_1_67))) {
		var_1_11 = ((max (128 , var_1_12)) - var_1_13);
	}


	// From: Req6Batch190Amount250
	if (((1 - var_1_11) / (max (var_1_12 , var_1_25))) == var_1_9) {
		var_1_24 = (max (var_1_13 , var_1_11));
	} else {
		var_1_24 = (min ((var_1_22 + var_1_8) , (var_1_7 + var_1_9)));
	}


	// From: Req5Batch190Amount250
	if (var_1_49 && var_1_62) {
		var_1_21 = (min ((max (var_1_8 , var_1_13)) , var_1_11));
	} else {
		var_1_21 = ((var_1_23 - (var_1_12 + var_1_13)) - (var_1_8 + (5 + var_1_11)));
	}


	// From: Req12Batch190Amount250
	if ((min ((var_1_11 + var_1_19) , var_1_22)) == (min ((var_1_18 / var_1_42) , var_1_44))) {
		if (var_1_73) {
			var_1_46 = var_1_12;
		} else {
			if (var_1_73 || var_1_49) {
				var_1_46 = (min ((min (var_1_40 , var_1_37)) , ((var_1_48 - var_1_44) - var_1_23)));
			} else {
	...
	if (var_1_24 != (2343164411u - var_1_22)) {
		...
		if (256 >= var_1_8) {
			...
			var_1_36 = (((abs (var_1_38)) + var_1_39) + var_1_40);
		}
	}


	// From: Req15Batch190Amount250
	if (var_1_24 >= var_1_15) {
		if ((! var_1_62) && var_1_50) {
			if (var_1_62 && var_1_52) {
				var_1_56 = ((max ((var_1_57 - var_1_45) , 2)) - (abs (max (var_1_44 , var_1_39))));
			} else {
...
int property(void) {
	return ((((((((((((((((((((var_1_67 > (var_1_53 * (var_1_67 * var_1_28))) ? (var_1_1 == ((unsigned long int) var_1_6)) : (var_1_1 == ((unsigned long int) ((var_1_7 - (var_1_8 + 32u)) + (min (var_1_9 , var_1_10)))))) && ((var_1_28 < (max (var_1_53 , var_1_67))) ? (var_1_11 == ((unsigned char) ((max (128 , var_1_12)) - var_1_13))) : 1)) && (var_1_14 == ((unsigned long int) (var_1_8 + var_1_12)))) && ((var_1_73 || var_1_61) ? (var_1_73 ? ((((min (var_1_18 , var_1_19)) - 10u) < var_1_7) ? (var_1_15 == ((unsigned long int) (max ((min (var_1_20 , 5u)) , var_1_8)))) : (var_1_15 == ((unsigned long int) (var_1_12 + (var_1_1 + var_1_13))))) : 1) : (var_1_15 == ((unsigned long int) (max ((max ((var_1_12 + var_1_10) , var_1_9)) , var_1_7)))))) && ((var_1_49 && var_1_62) ? (var_1_21 == ((signed long int) (min ((max (var_1_8 , var_1_13)) , var_1_11)))) : (var_1_21 == ((signed long int) ((var_1_23 - (var_1_12 + var_1_13)) - (var_1_8 + (5 + var_1_11))))))) && ((((1 - var_1_11) / (max (var_1_12 , var_1_25))) == var_1_9) ? (var_1_24 == ((unsigned long int) (max (var_1_13 , var_1_11)))) : (var_1_24 == ((unsigned long int) (min ((var_1_22 + var_1_8) , (var_1_7 + var_1_9))))))) && ((var_1_7 > (var_1_20 / var_1_12)) ? ((var_1_62 || (var_1_4 == var_1_5)) ? (var_1_26 == ((unsigned long int) ((var_1_7 + (abs (var_1_27))) - var_1_22))) : 1) : 1)) && (((var_1_67 * 1.42f) != var_1_67) ? (var_1_61 ? (var_1_28 == ((double) (abs (var_1_29)))) : 1) : (((var_1_19 - var_1_27) >= (16u / var_1_18)) ? (var_1_28 == ((double) (var_1_30 + (var_1_31 - var_1_32)))) : (var_1_28 == ((double) (((min (var_1_33 , var_1_34)) - (min (var_1_31 , var_1_32))) - var_1_35)))))) && ((var_1_24 != (2343164411u - var_1_22)) ? ((var_1_7 <= var_1_46) ? (var_1_36 == ((signed char) var_1_37)) : 1) : ((256 >= var_1_8) ? (var_1_36 == ((signed char) (abs (64)))) : (var_1_36 == ((signed char) (((abs (var_1_38)) + var_1_39) + var_1_40)))))) && ((! var_1_62) ? ((var_1_8 == ((var_1_71 >> var_1_42) % var_1_23)) ? (var_1_41 == ((signed char) (max (var_1_39 , var_1_40)))) : 1) : 1)) && ((var_1_12 >= 5) ? (var_1_43 == ((unsigned char) (var_1_12 - ((var_1_44 - var_1_42) + var_1_45)))) : (((abs (var_1_10)) <= (min ((- var_1_44) , var_1_42))) ? (var_1_43 == ((unsigned char) var_1_12)) : 1))) && (((min ((var_1_11 + var_1_19) , var_1_22)) == (min ((var_1_18 / var_1_42) , var_1_44))) ? (var_1_73 ? (var_1_46 == ((signed long int) var_1_12)) : ((var_1_73 || var_1_49) ? (var_1_46 == ((signed long int) (min ((min (var_1_40 , var_1_37)) , ((var_1_48 - var_1_44) - var_1_23))))) : ((var_1_24 > var_1_45) ? (var_1_46 == ((signed long int) (var_1_13 + var_1_37))) : 1))) : (var_1_46 == ((signed long int) var_1_11)))) && ((last_1_var_1_41 == var_1_45) ? ((256 < (var_1_45 - var_1_10)) ? (((var_1_48 * var_1_8) > var_1_9) ? (var_1_49 == ((unsigned char) (var_1_50 && var_1_51))) : 1) : (var_1_49 == ((unsigned char) (! 0)))) : (((min (var_1_38 , (last_1_var_1_46 | var_1_12))) < var_1_44) ? (var_1_49 == ((unsigned char) (var_1_50 && ((last_1_var_1_41 > var_1_25) || (var_1_51 && var_1_52))))) : (var_1_49 == ((unsigned char) 0))))) && (var_1_51 ? (var_1_53 == ((float) (min ((var_1_31 - (abs (var_1_33))) , 9.9999999975E8f)))) : (var_1_53 == ((float) ((var_1_31 - (var_1_54 - var_1_55)) + (0.8f - var_1_32)))))) && ((var_1_24 >= var_1_15) ? (((! var_1_62) && var_1_50) ? ((var_1_62 && var_1_52) ? (var_1_56 == ((signed char) ((max ((var_1_57 - var_1_45) , 2)) - (abs (max (var_1_44 , var_1_39)))))) : (var_1_56 == ((signed char) ((var_1_42 + (var_1_58 - var_1_59)) + (var_1_39 + var_1_60))))) : ((var_1_1 >= var_1_59) ? (var_1_56 == ((signed char) (var_1_44 - 32))) : 1)) : (var_1_56 == ((signed char) var_1_44)))) && (var_1_61 == ((unsigned char) var_1_52))) && ((var_1_18 <= 5u) ? (last_1_var_1_73 ? (var_1_62 == ((unsigned char) ((var_1_38 >= var_1_39) || (var_1_50 || var_1_52)))) : 1) : ((((var_1_59 >> var_1_63) * var_1_39) <= var_1_22) ? ((! last_1_var_1_49) ? (var_1_62 == ((unsigned char) (! var_1_52))) : (var_1_62 == ((unsigned char) ((var_1_64 || var_1_65) || var_1_66)))) : (var_1_62 == ((unsigned char) var_1_50))))) && ((last_1_var_1_14 >= -5) ? (var_1_67 == ((double) var_1_69)) : ((last_1_var_1_24 <= last_1_var_1_1) ? (((var_1_35 - (var_1_32 + var_1_55)) <= var_1_31) ? (var_1_67 == ((double) (((var_1_54 - var_1_55) - var_1_32) + (min ((max (var_1_31 , var_1_30)) , var_1_70))))) : (var_1_67 == ((double) (max ((var_1_55 + (max (var_1_30 , var_1_70))) , var_1_33))))) : 1))) && ((var_1_21 >= (min (var_1_58 , var_1_27))) ? ((var_1_7 > (- var_1_14)) ? (var_1_71 == ((unsigned long int) var_1_58)) : (var_1_71 == ((unsigned long int) var_1_57))) : 1)) && ((((var_1_44 << var_1_25) | var_1_26) <= ((max (var_1_26 , var_1_23)) * var_1_57)) ? (var_1_73 == ((unsigned char) ((var_1_49 && var_1_65) || var_1_66))) : (var_1_73 == ((unsigned char) var_1_50)))
;
}
int main(void) {
	isInitial = 1;
