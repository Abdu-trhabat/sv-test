...
void step(void) {
	...
	if ((max ((max (last_1_var_1_58 , var_1_26)) , var_1_63)) > var_1_21) {
		var_1_89 = var_1_51;
	} else {
	...
	if (last_1_var_1_101 && last_1_var_1_89) {
		if (((max (last_1_var_1_25 , last_1_var_1_72)) + last_1_var_1_64) >= 10) {
			var_1_25 = ((var_1_26 - var_1_21) - var_1_22);
		} else {
			var_1_25 = (min (((var_1_26 - var_1_21) - var_1_11) , last_1_var_1_28));
		}
	} else {
		if (last_1_var_1_98 == var_1_21) {
			...
			if (last_1_var_1_89) {
				var_1_25 = (last_1_var_1_98 + (abs (var_1_23 + var_1_20)));
			}
		}
	}
	...
	if (last_1_var_1_65) {
		if ((last_1_var_1_98 + (~ last_1_var_1_24)) >= (var_1_45 + last_1_var_1_95)) {
			if (last_1_var_1_12 > var_1_13) {
				var_1_58 = ((var_1_18 - (max (last_1_var_1_87 , var_1_22))) + last_1_var_1_95);
			}
		} else {
			if (last_1_var_1_16 >= (3091181110u - last_1_var_1_87)) {
				var_1_58 = (min ((abs (var_1_41 + last_1_var_1_87)) , (last_1_var_1_95 + var_1_18)));
			} else {
	...
	if ((var_1_74 - 100) < var_1_21) {
		...
		var_1_90 = (min (var_1_42 , (var_1_20 - var_1_21)));
	}
	...
	unsigned long int stepLocal_31 = (abs (var_1_8)) * var_1_58;
	...
	if (var_1_58 > (var_1_31 << var_1_22)) {
		if ((var_1_20 - var_1_31) < var_1_25) {
			...
			var_1_60 = ((min ((max (var_1_41 , var_1_22)) , var_1_63)) - var_1_10);
		}
	} else {
	...
	if (var_1_97) {
		...
		if ((min (var_1_6 , var_1_8)) <= stepLocal_0) {
			...
			var_1_16 = (min (var_1_4 , (var_1_6 + 10000u)));
		}
	}
	...
	if (var_1_101) {
		var_1_36 = (((8.360977757767614E18f - var_1_37) - (max (var_1_14 , var_1_13))) - var_1_38);
	}
	...
	if (stepLocal_9 <= var_1_1) {
		if ((var_1_13 - var_1_14) <= (- (var_1_40 - var_1_33))) {
			var_1_39 = (min ((var_1_31 + var_1_21) , (max (var_1_20 , (abs (var_1_22))))));
		}
	} else {
		var_1_39 = ((abs (var_1_22 - var_1_31)) - (max (var_1_21 , (min (var_1_41 , var_1_42)))));
	}
	...
	if (((var_1_21 - var_1_41) & var_1_9) < var_1_22) {
		if (var_1_23 == var_1_29) {
			if ((var_1_11 + (var_1_17 / var_1_22)) <= var_1_58) {
				...
				var_1_43 = (min (var_1_41 , (var_1_31 - var_1_21)));
			}
		} else {
			var_1_43 = (var_1_21 + (max ((var_1_44 + var_1_45) , var_1_31)));
		}
	} else {
		if (var_1_101) {
			var_1_43 = 1;
		...
		if (stepLocal_19 && ((var_1_60 <= var_1_20) || (var_1_65 && var_1_52))) {
			if (var_1_67) {
				...
				if (var_1_104 <= stepLocal_21) {
					...
					var_1_73 = ((max (var_1_31 , var_1_21)) + ((var_1_78 - var_1_76) - (min (var_1_75 , var_1_47))));
				}
			}
		}
	}
	...
	if (var_1_16 <= 25u) {
		var_1_85 = ((min (10 , var_1_102)) - (var_1_86 - var_1_4));
	} else {
		var_1_85 = (min ((min ((var_1_78 + var_1_11) , var_1_60)) , (var_1_31 + var_1_26)));
	}
	...
	if (! var_1_97) {
		if (var_1_98 >= (var_1_16 * 32)) {
			var_1_72 = (abs (var_1_5));
		} else {
			var_1_72 = (max (var_1_47 , var_1_104));
		}
	}
	...
	if (stepLocal_26 <= (~ (var_1_6 >> 5))) {
		var_1_87 = (min ((min (var_1_47 , var_1_6)) , (max (var_1_48 , var_1_72))));
	}


	// From: Req25Batch6Amount500
	if (var_1_29 >= ((50 + var_1_21) / (min (-64 , var_1_22)))) {
		var_1_68 = (((var_1_22 + var_1_21) + var_1_42) + var_1_26);
	} else {
		if (var_1_16 < var_1_102) {
			var_1_68 = (var_1_6 + 256);
		} else {
			var_1_68 = (max (var_1_6 , var_1_4));
		}
	}
	...
	if (var_1_53) {
		...
		if ((var_1_8 * var_1_29) > stepLocal_7) {
			if (stepLocal_8 > (var_1_21 << last_1_var_1_32)) {
				var_1_32 = (min (var_1_85 , ((max (var_1_5 , var_1_8)) - 1)));
			} else {
				var_1_32 = (var_1_21 + var_1_4);
			}
		} else {
			if ((min ((var_1_34 - var_1_33) , (var_1_79 * var_1_13))) <= var_1_12) {
	...
	if (var_1_79 != var_1_38) {
		var_1_88 = ((max ((var_1_22 + var_1_10) , var_1_60)) + var_1_68);
	} else {
		var_1_88 = ((max (var_1_9 , (var_1_47 + var_1_71))) - (min (var_1_75 , var_1_32)));
	}
	...
	if (stepLocal_10 >= var_1_32) {
		var_1_46 = (var_1_21 + (min (var_1_31 , (var_1_47 - var_1_48))));
	}
	...
	if (var_1_94) {
		if ((var_1_20 - var_1_32) >= var_1_42) {
			var_1_57 = (max (var_1_48 , var_1_42));
		} else {
			var_1_57 = (var_1_31 + var_1_42);
		}
	} else {
		var_1_57 = (abs (var_1_31));
	}


	// From: Req30Batch6Amount500
	signed long int stepLocal_25 = var_1_78 & (max (var_1_44 , var_1_20));
		...
		if (1 < stepLocal_23) {
			if (stepLocal_25 < (var_1_1 + var_1_60)) {
				...
				if (stepLocal_22 <= var_1_5) {
					var_1_81 = ((7.932485850494807E18f - (var_1_84 + var_1_83)) - (var_1_13 + (max (var_1_37 , var_1_14))));
				} else {
					var_1_81 = (max ((abs (var_1_83 - var_1_38)) , (min (49.4f , (abs (var_1_84))))));
				}
			}
		}
	}
	...
	signed long int stepLocal_4 = (var_1_5 + var_1_7) / (min (var_1_29 , var_1_20));
	signed long int stepLocal_3 = 8;
	unsigned long int stepLocal_2 = var_1_20 * (max (var_1_17 , var_1_22));
	if (128u == stepLocal_2) {
		if (var_1_88 <= stepLocal_5) {
			var_1_28 = (max (0 , var_1_22));
		} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((var_1_65 || var_1_94) ? (var_1_1 == ((unsigned short int) (abs (var_1_4)))) : (var_1_1 == ((unsigned short int) (min ((var_1_5 - var_1_6) , var_1_4))))) && ((var_1_6 <= (- 500)) ? (var_1_53 ? (var_1_7 == ((signed short int) (var_1_8 - 64))) : 1) : (var_1_7 == ((signed short int) var_1_8)))) && (var_1_9 == ((signed long int) ((abs (var_1_8)) - var_1_6)))) && (var_1_10 == ((unsigned short int) (var_1_5 - (var_1_11 + 1000))))) && ((! var_1_97) ? (var_1_12 == ((double) ((var_1_13 - (var_1_14 - 63.5)) + var_1_15))) : (var_1_12 == ((double) (var_1_14 - var_1_13))))) && (var_1_97 ? (var_1_16 == ((unsigned long int) (var_1_90 + 200u))) : (((min (var_1_6 , var_1_8)) <= var_1_11) ? (var_1_16 == ((unsigned long int) (var_1_17 - (var_1_18 - var_1_4)))) : (var_1_16 == ((unsigned long int) (min (var_1_4 , (var_1_6 + 10000u)))))))) && (var_1_19 == ((signed char) (((abs (var_1_20)) - var_1_21) - (var_1_22 - (abs (var_1_23))))))) && (((var_1_5 >= var_1_20) && var_1_101) ? (var_1_24 == ((signed char) (var_1_22 - var_1_21))) : 1)) && ((last_1_var_1_101 && last_1_var_1_89) ? ((((max (last_1_var_1_25 , last_1_var_1_72)) + last_1_var_1_64) >= 10) ? (var_1_25 == ((signed short int) ((var_1_26 - var_1_21) - var_1_22))) : (var_1_25 == ((signed short int) (min (((var_1_26 - var_1_21) - var_1_11) , last_1_var_1_28))))) : ((last_1_var_1_98 == var_1_21) ? (var_1_25 == ((signed short int) var_1_8)) : (last_1_var_1_89 ? (var_1_25 == ((signed short int) (last_1_var_1_98 + (abs (var_1_23 + var_1_20))))) : 1)))) && ((128u == (var_1_20 * (max (var_1_17 , var_1_22)))) ? ((var_1_88 <= var_1_22) ? (var_1_28 == ((signed char) (max (0 , var_1_22)))) : (((var_1_87 / var_1_20) != 8) ? ((var_1_21 >= ((var_1_5 + var_1_7) / (min (var_1_29 , var_1_20)))) ? (var_1_28 == ((signed char) (-1 - var_1_22))) : (var_1_28 == ((signed char) var_1_20))) : ((((- var_1_17) + 100) >= (abs (var_1_16))) ? (var_1_28 == ((signed char) ((var_1_21 + var_1_31) - var_1_22))) : 1))) : 1)) && (var_1_53 ? ((((var_1_33 - var_1_13) - var_1_14) >= var_1_15) ? (var_1_32 == ((signed long int) var_1_29)) : 1) : (((var_1_8 * var_1_29) > var_1_64) ? ((var_1_17 > (var_1_21 << last_1_var_1_32)) ? (var_1_32 == ((signed long int) (min (var_1_85 , ((max (var_1_5 , var_1_8)) - 1))))) : (var_1_32 == ((signed long int) (var_1_21 + var_1_4)))) : (((min ((var_1_34 - var_1_33) , (var_1_79 * var_1_13))) <= var_1_12) ? (var_1_32 == ((signed long int) (abs (var_1_25)))) : (var_1_32 == ((signed long int) (min (64 , -10)))))))) && (var_1_101 ? (var_1_36 == ((float) (((8.360977757767614E18f - var_1_37) - (max (var_1_14 , var_1_13))) - var_1_38))) : 1)) && ((var_1_18 <= var_1_1) ? (((var_1_13 - var_1_14) <= (- (var_1_40 - var_1_33))) ? (var_1_39 == ((signed char) (min ((var_1_31 + var_1_21) , (max (var_1_20 , (abs (var_1_22)))))))) : 1) : (var_1_39 == ((signed char) ((abs (var_1_22 - var_1_31)) - (max (var_1_21 , (min (var_1_41 , var_1_42))))))))) && ((((var_1_21 - var_1_41) & var_1_9) < var_1_22) ? ((var_1_23 == var_1_29) ? (((var_1_11 + (var_1_17 / var_1_22)) <= var_1_58) ? (var_1_43 == ((signed char) (var_1_22 - var_1_21))) : (var_1_43 == ((signed char) (min (var_1_41 , (var_1_31 - var_1_21)))))) : (var_1_43 == ((signed char) (var_1_21 + (max ((var_1_44 + var_1_45) , var_1_31)))))) : (var_1_101 ? (var_1_43 == ((signed char) 1)) : 1))) && ((var_1_5 >= var_1_32) ? (var_1_46 == ((signed char) (var_1_21 + (min (var_1_31 , (var_1_47 - var_1_48)))))) : 1)) && ((var_1_18 < var_1_6) ? (var_1_49 == ((unsigned char) (var_1_89 && (! var_1_50)))) : ((-16 >= var_1_41) ? (((var_1_29 * var_1_32) <= var_1_10) ? (var_1_50 ? (var_1_49 == ((unsigned char) (var_1_51 && (! (var_1_55 && var_1_52))))) : 1) : (var_1_49 == ((unsigned char) (var_1_89 || var_1_51)))) : 1))) && (var_1_53 == ((unsigned char) ((-128 == var_1_58) || var_1_51)))) && ((10 < var_1_58) ? ((var_1_8 <= -64) ? (var_1_52 ? (var_1_54 == ((signed char) ((var_1_44 + var_1_45) + var_1_48))) : 1) : 1) : (var_1_54 == ((signed char) var_1_47)))) && ((var_1_97 || var_1_89) ? (var_1_55 == ((unsigned char) var_1_50)) : (((var_1_18 * var_1_26) > var_1_5) ? (var_1_55 == ((unsigned char) (var_1_52 || (var_1_97 && var_1_56)))) : (var_1_55 == ((unsigned char) (! var_1_52)))))) && (var_1_94 ? (((var_1_20 - var_1_32) >= var_1_42) ? (var_1_57 == ((unsigned char) (max (var_1_48 , var_1_42)))) : (var_1_57 == ((unsigned char) (var_1_31 + var_1_42)))) : (var_1_57 == ((unsigned char) (abs (var_1_31)))))) && (last_1_var_1_65 ? (((last_1_var_1_98 + (~ last_1_var_1_24)) >= (var_1_45 + last_1_var_1_95)) ? ((last_1_var_1_12 > var_1_13) ? (var_1_58 == ((unsigned long int) ((var_1_18 - (max (last_1_var_1_87 , var_1_22))) + last_1_var_1_95))) : 1) : ((last_1_var_1_16 >= (3091181110u - last_1_var_1_87)) ? (var_1_58 == ((unsigned long int) (min ((abs (var_1_41 + last_1_var_1_87)) , (last_1_var_1_95 + var_1_18))))) : (var_1_58 == ((unsigned long int) (var_1_20 - (1541756006u - var_1_11)))))) : ((last_1_var_1_32 > last_1_var_1_85) ? (var_1_58 == ((unsigned long int) (var_1_21 + var_1_31))) : 1))) && ((var_1_58 > (var_1_31 << var_1_22)) ? (((var_1_20 - var_1_31) < var_1_25) ? (var_1_60 == ((signed long int) (var_1_26 + -1))) : (var_1_60 == ((signed long int) ((min ((max (var_1_41 , var_1_22)) , var_1_63)) - var_1_10)))) : (var_1_60 == ((signed long int) (var_1_8 - var_1_48))))) && ((((4 - var_1_48) ^ (var_1_31 - var_1_42)) < var_1_5) ? ((var_1_37 >= ((var_1_38 / var_1_33) + var_1_12)) ? ((! var_1_101) ? (var_1_64 == ((unsigned long int) var_1_21)) : (var_1_64 == ((unsigned long int) (var_1_100 + var_1_11)))) : 1) : 1)) && ((var_1_29 >= var_1_22) ? (var_1_65 == ((unsigned char) ((var_1_94 || (var_1_51 && var_1_50)) && (var_1_66 && var_1_67)))) : ((var_1_11 > (var_1_42 ^ var_1_47)) ? (var_1_65 == ((unsigned char) var_1_66)) : (var_1_65 == ((unsigned char) var_1_52))))) && ((var_1_29 >= ((50 + var_1_21) / (min (-64 , var_1_22)))) ? (var_1_68 == ((unsigned short int) (((var_1_22 + var_1_21) + var_1_42) + var_1_26))) : ((var_1_16 < var_1_102) ? (var_1_68 == ((unsigned short int) (var_1_6 + 256))) : (var_1_68 == ((unsigned short int) (max (var_1_6 , var_1_4))))))) && (var_1_69 == ((signed char) (var_1_70 - var_1_71)))) && ((! var_1_97) ? ((var_1_98 >= (var_1_16 * 32)) ? (var_1_72 == ((unsigned short int) (abs (var_1_5)))) : (var_1_72 == ((unsigned short int) (max (var_1_47 , var_1_104))))) : 1)) && ((last_1_var_1_73 >= var_1_16) ? (var_1_73 == ((unsigned char) ((var_1_74 - (var_1_75 + var_1_76)) - (var_1_31 + 1)))) : (((! var_1_56) && ((var_1_60 <= var_1_20) || (var_1_65 && var_1_52))) ? (var_1_67 ? (var_1_73 == ((unsigned char) var_1_22)) : ((var_1_104 <= ((var_1_48 + var_1_75) - var_1_71)) ? (var_1_73 == ((unsigned char) (var_1_74 - var_1_75))) : (var_1_73 == ((unsigned char) ((max (var_1_31 , var_1_21)) + ((var_1_78 - var_1_76) - (min (var_1_75 , var_1_47)))))))) : 1))) && ((var_1_103 > var_1_34) ? (var_1_79 == ((double) (var_1_14 - var_1_38))) : ((var_1_89 || (var_1_66 && (var_1_1 < var_1_16))) ? (var_1_50 ? (var_1_79 == ((double) (var_1_13 + (var_1_37 + var_1_80)))) : ((var_1_74 <= ((var_1_64 * var_1_104) & var_1_4)) ? (var_1_79 == ((double) (var_1_80 + var_1_15))) : 1)) : 1))) && ((var_1_9 > ((var_1_41 / var_1_78) / var_1_18)) ? (var_1_81 == ((float) 99.5f)) : ((1 < (var_1_32 - var_1_9)) ? (((var_1_78 & (max (var_1_44 , var_1_20))) < (var_1_1 + var_1_60)) ? (var_1_81 == ((float) (var_1_37 + ((var_1_83 - var_1_84) + var_1_80)))) : ((var_1_20 <= var_1_5) ? (var_1_81 == ((float) ((7.932485850494807E18f - (var_1_84 + var_1_83)) - (var_1_13 + (max (var_1_37 , var_1_14)))))) : (var_1_81 == ((float) (max ((abs (var_1_83 - var_1_38)) , (min (49.4f , (abs (var_1_84)))))))))) : 1))) && ((var_1_16 <= 25u) ? (var_1_85 == ((signed long int) ((min (10 , var_1_102)) - (var_1_86 - var_1_4)))) : (var_1_85 == ((signed long int) (min ((min ((var_1_78 + var_1_11) , var_1_60)) , (var_1_31 + var_1_26))))))) && ((var_1_58 <= (~ (var_1_6 >> 5))) ? (var_1_87 == ((unsigned short int) (min ((min (var_1_47 , var_1_6)) , (max (var_1_48 , var_1_72)))))) : 1)) && ((var_1_79 != var_1_38) ? (var_1_88 == ((signed long int) ((max ((var_1_22 + var_1_10) , var_1_60)) + var_1_68))) : (var_1_88 == ((signed long int) ((max (var_1_9 , (var_1_47 + var_1_71))) - (min (var_1_75 , var_1_32))))))) && (((max ((max (last_1_var_1_58 , var_1_26)) , var_1_63)) > var_1_21) ? (var_1_89 == ((unsigned char) var_1_51)) : (var_1_89 == ((unsigned char) (last_1_var_1_89 && (! (last_1_var_1_55 || var_1_50))))))) && (((var_1_74 - 100) < var_1_21) ? (var_1_90 == ((unsigned short int) var_1_20)) : (var_1_90 == ((unsigned short int) (min (var_1_42 , (var_1_20 - var_1_21))))))) && ((var_1_4 > 2) ? (var_1_91 == ((double) var_1_38)) : 1)) && (var_1_52 ? (var_1_92 == ((float) (var_1_83 - (var_1_93 - 127.2f)))) : ((((var_1_23 / var_1_78) <= var_1_87) && (var_1_13 <= (var_1_34 + var_1_103))) ? (var_1_92 == ((float) (var_1_13 - var_1_37))) : ((var_1_56 && (var_1_101 && (var_1_88 != var_1_99))) ? (var_1_55 ? (var_1_92 == ((float) (var_1_84 + (var_1_37 + var_1_80)))) : ((var_1_5 > var_1_74) ? (var_1_92 == ((float) var_1_80)) : (var_1_92 == ((float) var_1_14)))) : (var_1_92 == ((float) var_1_15)))))) && (var_1_53 ? (var_1_94 == ((unsigned char) 0)) : (var_1_94 == ((unsigned char) var_1_52)))) && (var_1_51 ? (var_1_95 == ((unsigned char) var_1_48)) : (var_1_95 == ((unsigned char) var_1_71)))) && (var_1_96 == ((signed short int) 16))) && (var_1_51 ? (var_1_97 == ((unsigned char) var_1_66)) : 1)) && (var_1_98 == ((unsigned short int) var_1_22))) && (var_1_99 == ((signed long int) var_1_78))) && (var_1_100 == ((signed short int) var_1_48))) && (var_1_101 == ((unsigned char) 0))) && (var_1_65 ? (var_1_102 == ((unsigned long int) var_1_17)) : (var_1_102 == ((unsigned long int) 0u)))) && (var_1_101 ? (var_1_103 == ((double) -0.25)) : 1)) && (var_1_94 ? (var_1_104 == ((unsigned char) var_1_78)) : (var_1_104 == ((unsigned char) var_1_48)))) && (var_1_66 ? (((- 2) < ((abs (var_1_8)) * var_1_58)) ? (((4u | var_1_4) > var_1_26) ? (var_1_105 == ((unsigned char) var_1_20)) : 1) : 1) : (var_1_105 == ((unsigned char) var_1_78)))
;
}
int main(void) {
	isInitial = 1;
