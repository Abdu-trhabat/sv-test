...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch148Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch148Filler_PR_CI
	...
	// From: CodeObject5
	/* 338L, 223L) */ if (/* 339L, 176L, 177L) */ ((var_1_6) > (var_1_33))) {
		/* 342L, 217L) */ if (/* 343L, 187L, 188L) */ ((/* 344L, 185L, 189L) */ (min (/* 344L, 185L, 189L) */ (8.5f) , (16.4f)))) > (var_1_27))) {
			/* 348L, 215L) */ if (/* 349L, 200L, 201L) */ ((var_1_23) <= (var_1_32))) {
				/* 352L, 214L) */ var_1_43 = (
					/* 355L, 213L) */ (abs (
						/* 356L, 212L) */ (max (
							/* 356L, 212L) */ (
	...
	/* 319L, 170L) */ if (/* 320L, 131L, 132L) */ ((var_1_39) >= (/* 322L, 130L, 134L) */ (max (/* 322L, 130L, 134L) */ (var_1_32) , (/* 324L, 129L, 136L) */ ((var_1_36) >> (16)))))))) {
		/* 327L, 168L) */ if (/* 328L, 151L, 152L) */ ((/* 329L, 147L, 153L) */ (- (var_1_20))) > (/* 331L, 150L, 155L) */ ((var_1_36) + (var_1_39))))) {
			/* 334L, 167L) */ var_1_41 = (
				var_1_23
			);
		}
	...
	// From: Req10Batch148Filler_PR_CI
	...
	// From: CodeObject3
	/* 301L, 120L) */ if (/* 302L, 91L, 92L) */ ((/* 303L, 89L, 93L) */ (abs (4.2))) <= (var_1_9))) {
