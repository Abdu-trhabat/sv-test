...
void step(void) {
	...
	// From: Req9Batch115Amount100
	if (var_1_10) {
		var_1_32 = (((var_1_13 - var_1_28) - var_1_30) + 5);
	}


	// From: Req2Batch115Amount100
	if (var_1_7) {
		var_1_6 = (min (var_1_19 , (var_1_8 - var_1_5)));
	}


	// From: Req7Batch115Amount100
