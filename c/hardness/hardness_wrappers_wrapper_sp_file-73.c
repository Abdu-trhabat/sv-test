...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_6_Pointer)) && stepLocal_2) {
		(*(WrapperStruct00_var_1_8_Pointer)) = (min ((*(WrapperStruct00_var_1_10_Pointer)) , ((min (64 , (*(WrapperStruct00_var_1_11_Pointer)))) - ((*(WrapperStruct00_var_1_12_Pointer)) + (*(WrapperStruct00_var_1_13_Pointer))))));
	} else {
	...
	if (((*(WrapperStruct00_var_1_13_Pointer)) <= (*(WrapperStruct00_var_1_12_Pointer))) || stepLocal_3) {
		(*(WrapperStruct00_var_1_14_Pointer)) = (min ((*(WrapperStruct00_var_1_7_Pointer)) , (*(WrapperStruct00_var_1_15_Pointer))));
	} else {
	...
	unsigned long int stepLocal_0 = max ((*(WrapperStruct00_var_1_3_Pointer)) , ((*(WrapperStruct00_var_1_4_Pointer)) + (*(WrapperStruct00_var_1_5_Pointer))));
