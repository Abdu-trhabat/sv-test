...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch134stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_0 = var_1_3 / ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)));
 if (var_1_2 == stepLocal_0) {
  var_1_1 = var_1_5;
 }
 if ((((((var_1_2) < (50)) ? (var_1_2) : (50))) + (var_1_4 + var_1_3)) != var_1_5) {
  if (var_1_1 > var_1_3) {
 ...
 if ((var_1_5 + (var_1_7 - var_1_8)) < (var_1_6 - var_1_12)) {
  if (16 >= var_1_13) {
   var_1_11 = var_1_14;
  } else {
   var_1_11 = 8;
 ...
 signed short int stepLocal_2 = var_1_2;
...
int property(void) {
 return ((((((((var_1_2 == (var_1_3 / ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))) ? (var_1_1 == ((signed short int) var_1_5)) : 1) && (((((((var_1_2) < (50)) ? (var_1_2) : (50))) + (var_1_4 + var_1_3)) != var_1_5) ? ((var_1_1 > var_1_3) ? (var_1_6 == ((unsigned short int) (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) + var_1_8))) : (var_1_6 == ((unsigned short int) (var_1_7 + var_1_8)))) : (var_1_6 == ((unsigned short int) var_1_8)))) && ((var_1_3 >= var_1_8) ? (var_1_10 ? (var_1_9 == ((unsigned long int) var_1_6)) : 1) : 1)) && (((var_1_5 + (var_1_7 - var_1_8)) < (var_1_6 - var_1_12)) ? ((16 >= var_1_13) ? (var_1_11 == ((unsigned char) var_1_14)) : (var_1_11 == ((unsigned char) 8))) : (var_1_11 == ((unsigned char) 0)))) && ((var_1_10 || (! 0)) ? (var_1_10 ? (var_1_15 == ((signed long int) var_1_6)) : 1) : 1)) && ((var_1_8 <= var_1_2) ? ((! var_1_10) ? (var_1_16 == ((float) ((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))))) : 1) : ((var_1_10 && var_1_19) ? (var_1_10 ? (var_1_16 == ((float) var_1_17)) : 1) : (var_1_16 == ((float) var_1_18))))) && (var_1_20 == ((unsigned long int) var_1_7))) && (var_1_21 == ((unsigned long int) var_1_7))
;
}
int main(void) {
 isInitial = 1;
