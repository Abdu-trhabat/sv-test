...
void step(void) {
	...
	if (stepLocal_1 >= 4) {
		if (unsigned_short_int_Array_0[1][1] <= stepLocal_0) {
			double_Array_0[1][0][1] = (min ((double_Array_0[1][1][0] - (double_Array_0[1][0][0] - double_Array_0[0][0][1])) , double_Array_0[0][1][1]));
		}
	}


	// From: Req3Batch37Wrapper_A
	double_Array_0[0][0][0] = (double_Array_0[0][0][1] + (max (double_Array_0[0][1][0] , double_Array_0[1][1][1])));
	...
	if (63.8 > double_Array_0[1][0][1]) {
		if (stepLocal_2 <= unsigned_short_int_Array_0[1][1]) {
			...
			unsigned_long_int_Array_0[2] = (min (((min (unsigned_long_int_Array_0[0] , unsigned_long_int_Array_0[1])) - unsigned_short_int_Array_0[1][0]) , unsigned_short_int_Array_0[0][0]));
		}
	}
...
int property(void) {
	return (((((((unsigned_short_int_Array_0[1][1] - unsigned_short_int_Array_0[0][1]) ^ (unsigned_short_int_Array_0[1][0] * unsigned_short_int_Array_0[0][0])) <= -64) ? (unsigned_char_Array_0[2] == ((unsigned char) unsigned_char_Array_0[1])) : (unsigned_char_Array_0[2] == ((unsigned char) 16))) && ((unsigned_char_Array_0[1] >= 4) ? ((unsigned_short_int_Array_0[1][1] <= unsigned_short_int_Array_0[0][1]) ? (double_Array_0[1][0][1] == ((double) (min ((double_Array_0[1][1][0] - (double_Array_0[1][0][0] - double_Array_0[0][0][1])) , double_Array_0[0][1][1])))) : 1) : 1)) && (double_Array_0[0][0][0] == ((double) (double_Array_0[0][0][1] + (max (double_Array_0[0][1][0] , double_Array_0[1][1][1])))))) && ((63.8 > double_Array_0[1][0][1]) ? (((- unsigned_char_Array_0[1]) <= unsigned_short_int_Array_0[1][1]) ? (unsigned_long_int_Array_0[2] == ((unsigned long int) (unsigned_long_int_Array_0[0] - unsigned_char_Array_0[1]))) : (unsigned_long_int_Array_0[2] == ((unsigned long int) (min (((min (unsigned_long_int_Array_0[0] , unsigned_long_int_Array_0[1])) - unsigned_short_int_Array_0[1][0]) , unsigned_short_int_Array_0[0][0]))))) : 1)) && (unsigned_char_Array_0[0] == ((unsigned char) unsigned_char_Array_0[1]))
;
}
int main(void) {
	isInitial = 1;
