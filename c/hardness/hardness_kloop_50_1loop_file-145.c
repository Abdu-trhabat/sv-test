...
void step(void) {
	...
	// From: Req4Batch14550_1loop
	var_1_16 = (min (var_1_17 , var_1_18));


	// From: Req5Batch14550_1loop
	if ((min ((var_1_18 >> var_1_20) , var_1_5)) < var_1_17) {
		var_1_19 = var_1_18;
	}


	// From: Req7Batch14550_1loop
	var_1_23 = (var_1_24 - var_1_7);


	// From: Req1Batch14550_1loop
	if (var_1_25) {
