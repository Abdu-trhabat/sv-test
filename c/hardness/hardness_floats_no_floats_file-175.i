...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch175no_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_9) {
  ...
  var_1_8 = ((((((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11)))) < (var_1_12)) ? (((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11)))) : (var_1_12)));
 }
 if (var_1_9) {
  var_1_13 = ((((var_1_6) > (var_1_5)) ? (var_1_6) : (var_1_5)));
 }
...
int property(void) {
 return ((((var_1_2 > var_1_3) ? (var_1_1 == ((unsigned char) var_1_4)) : (var_1_1 == ((unsigned char) (var_1_5 - ((((var_1_6 + var_1_7) < 0 ) ? -(var_1_6 + var_1_7) : (var_1_6 + var_1_7))))))) && (var_1_9 ? (var_1_8 == ((signed long int) (16 + var_1_10))) : (var_1_8 == ((signed long int) ((((((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11)))) < (var_1_12)) ? (((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11)))) : (var_1_12))))))) && (var_1_9 ? (var_1_13 == ((signed long int) ((((var_1_6) > (var_1_5)) ? (var_1_6) : (var_1_5))))) : 1)) && (((- var_1_4) != (var_1_2 + (var_1_3 - var_1_1))) ? ((var_1_9 && (! var_1_15)) ? ((var_1_10 <= var_1_12) ? (((- var_1_6) >= var_1_2) ? (var_1_14 == ((signed long int) 64)) : (var_1_14 == ((signed long int) var_1_11))) : (var_1_14 == ((signed long int) var_1_10))) : 1) : (var_1_14 == ((signed long int) var_1_11)))
;
}
int main(void) {
 isInitial = 1;
