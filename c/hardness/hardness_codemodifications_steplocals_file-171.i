...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch171stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_9 * 50.7) <= var_1_10) {
  if ((-64 * var_1_5) >= stepLocal_0) {
   var_1_8 = ((((var_1_6) > (100u)) ? (var_1_6) : (100u)));
  }
 }
 signed short int stepLocal_1 = var_1_5;
 if (var_1_6 >= stepLocal_1) {
  var_1_11 = (((((var_1_12 + ((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14))))) < (var_1_15)) ? ((var_1_12 + ((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14))))) : (var_1_15)));
 } else {
  var_1_11 = var_1_14;
 }
 if (var_1_8 <= var_1_7) {
 ...
 signed char stepLocal_4 = var_1_3;
 if (stepLocal_4 >= (var_1_17 + (var_1_8 * var_1_6))) {
  var_1_20 = var_1_21;
 } else {
