...
void step(void) {
	...
	if ((*(var_1_3_Pointer)) < ((min ((*(var_1_4_Pointer)) , (*(var_1_2_Pointer)))) * (*(var_1_5_Pointer)))) {
...
int property(void) {
	return ((((((((*(var_1_3_Pointer)) < ((min ((*(var_1_4_Pointer)) , (*(var_1_2_Pointer)))) * (*(var_1_5_Pointer)))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (last_1_var_1_1 && (((*(var_1_7_Pointer)) || last_1_var_1_1) && (*(var_1_9_Pointer)))))) : 1) && ((*(var_1_9_Pointer)) ? ((*(var_1_10_Pointer)) == ((unsigned long int) 2u)) : 1)) && ((*(var_1_11_Pointer)) == ((signed char) (min (((*(var_1_12_Pointer)) + (*(var_1_13_Pointer))) , (10 - (*(var_1_14_Pointer)))))))) && ((((*(var_1_2_Pointer)) + ((*(var_1_3_Pointer)) / (*(var_1_16_Pointer)))) == (*(var_1_5_Pointer))) ? (((*(var_1_3_Pointer)) >= (*(var_1_4_Pointer))) ? ((*(var_1_15_Pointer)) == ((double) ((*(var_1_17_Pointer)) - (min (((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))) , 9.9999999999995E12))))) : ((*(var_1_15_Pointer)) == ((double) (min ((*(var_1_17_Pointer)) , (5.75 + (*(var_1_19_Pointer)))))))) : 1)) && ((*(var_1_20_Pointer)) == ((double) (*(var_1_19_Pointer))))) && ((*(var_1_21_Pointer)) == ((signed char) 1))) && ((*(var_1_22_Pointer)) == ((unsigned short int) 10))
;
}
int main(void) {
	isInitial = 1;
