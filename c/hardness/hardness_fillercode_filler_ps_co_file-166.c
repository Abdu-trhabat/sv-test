...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch166Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	/* 381L, 168L) */ if (/* 382L, 135L, 136L) */ ((var_1_39) == (/* 384L, 134L, 138L) */ ((var_1_30) + (var_1_21))))) {
