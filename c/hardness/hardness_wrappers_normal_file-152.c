...
void step(void) {
	// From: Req2Batch152normal
	var_1_5 = (32 - var_1_6);


	// From: Req3Batch152normal
...
int property(void) {
	return ((((10 > (var_1_15 + 5)) ? ((127.625f != (- var_1_7)) ? (var_1_1 == ((signed short int) var_1_4)) : (var_1_1 == ((signed short int) -10))) : (var_1_1 == ((signed short int) var_1_4))) && (var_1_5 == ((signed long int) (32 - var_1_6)))) && ((var_1_2 >= var_1_5) ? (var_1_7 == ((double) (var_1_8 - var_1_9))) : ((((var_1_10 - var_1_11) * var_1_5) <= (var_1_6 / var_1_12)) ? (var_1_7 == ((double) var_1_8)) : (var_1_13 ? (var_1_7 == ((double) (5.2 + var_1_14))) : 1)))) && ((var_1_4 >= (var_1_11 << var_1_6)) ? (var_1_15 == ((signed long int) (abs (var_1_11)))) : (var_1_13 ? (var_1_15 == ((signed long int) -4)) : 1))
;
}
int main(void) {
	isInitial = 1;
