...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch71Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(var_1_7_Pointer))) {
		...
		(*(var_1_8_Pointer)) = ((*(var_1_15_Pointer)) + (*(var_1_3_Pointer)));
	}
