...
void step(void) {
	...
	if ((var_1_1 / (max (var_1_11 , var_1_12))) <= stepLocal_1) {
		...
		if (var_1_14 > (25.0f - (min (5.0f , var_1_15)))) {
			var_1_10 = (min (var_1_15 , 1.0f));
		}
	}


	// From: Req4Batch138has_floats
	var_1_17 = 100.0f;
}
...
int property(void) {
	return ((((var_1_2 >= var_1_3) ? (var_1_1 == ((unsigned short int) (max (var_1_4 , (var_1_5 - (max (100 , var_1_6))))))) : (var_1_1 == ((unsigned short int) var_1_4))) && ((var_1_8 && (-1.0f >= 5.0f)) ? ((var_1_4 >= var_1_1) ? (var_1_7 == ((signed char) var_1_9)) : (var_1_7 == ((signed char) 64))) : (var_1_7 == ((signed char) var_1_9)))) && (((var_1_1 / (max (var_1_11 , var_1_12))) <= 10) ? (var_1_10 == ((float) (((min (var_1_13 , var_1_14)) - var_1_15) + var_1_16))) : ((var_1_14 > (25.0f - (min (5.0f , var_1_15)))) ? (var_1_10 == ((float) (min (var_1_15 , 1.0f)))) : 1))) && (var_1_17 == ((float) 100.0f))
;
}
int main(void) {
	isInitial = 1;
