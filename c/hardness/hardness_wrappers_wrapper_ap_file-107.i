...
void step(void) {
 ...
 if (! ((*(signed_char_Array_0_arraysigned_char_Array_0Var5_Pointer)) >= (*(signed_char_Array_0_arraysigned_char_Array_0Var6_Pointer)))) {
  if ((((((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer))) < ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)))) ? ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer))) : ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer))))) >= stepLocal_0) {
   ...
   (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)) = (((((((((-8) < 0 ) ? -(-8) : (-8)))) < ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)))) ? (((((-8) < 0 ) ? -(-8) : (-8)))) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))))) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)));
  }
 }
