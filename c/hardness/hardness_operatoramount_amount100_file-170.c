...
void step(void) {
	...
	// From: Req6Batch170Amount100
	if (var_1_5 != ((var_1_9 - var_1_21) - var_1_25)) {
		var_1_27 = var_1_28;
	}


	// From: Req11Batch170Amount100
	var_1_34 = (min (var_1_13 , var_1_12));


	// From: Req4Batch170Amount100
	if (var_1_27) {
		var_1_20 = var_1_21;
	}


	// From: Req5Batch170Amount100
