...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch57Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	/* 319L, 187L) */ if (/* 320L, 118L, 119L) */ ((var_1_18) <= (/* 322L, 117L, 121L) */ ((var_1_8) ^ (/* 324L, 116L, 123L) */ (- (var_1_22))))))) {
		/* 326L, 181L) */ if (/* 327L, 141L, 142L) */ ((/* 328L, 137L, 143L) */ ((/* 329L, 133L, 144L) */ ((var_1_30) - (var_1_31))) > (/* 332L, 136L, 147L) */ ((var_1_18) + (var_1_8))))) && (/* 335L, 140L, 150L) */ ((var_1_21) >= (var_1_24))))) {
			/* 338L, 169L) */ var_1_29 = (
				/* 341L, 168L) */ ((
					var_1_32
				) + (
