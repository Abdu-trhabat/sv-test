...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch172Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch172Amount100
	var_1_7 = (var_1_8 + (var_1_9 - var_1_10));


	// From: Req4Batch172Amount100
	if (! var_1_12) {
	...
	// From: Req5Batch172Amount100
	var_1_17 = var_1_9;


	// From: Req6Batch172Amount100
	...
	// From: Req12Batch172Amount100
	var_1_30 = var_1_24;


	// From: Req14Batch172Amount100
	var_1_32 = var_1_13;


	// From: Req3Batch172Amount100
	if (var_1_12) {
