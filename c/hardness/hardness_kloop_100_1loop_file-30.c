...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch30100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req13Batch30100_1loop
	var_1_44 = (8 + var_1_40);


	// From: Req14Batch30100_1loop
	...
	// From: Req15Batch30100_1loop
	var_1_47 = 10;


	// From: Req16Batch30100_1loop
	var_1_48 = var_1_18;


	// From: Req17Batch30100_1loop
	var_1_49 = var_1_48;
