...
void step(void) {
 ...
 signed long int stepLocal_1 = (((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6));
 unsigned char stepLocal_0 = var_1_14;
 if (var_1_13 && stepLocal_0) {
  if (stepLocal_1 < ((((32) > ((var_1_15 - var_1_7))) ? (32) : ((var_1_15 - var_1_7))))) {
   var_1_12 = (var_1_7 + 5);
  }
 } else {
  var_1_12 = 64;
