...
void step(void) {
	...
	// From: CodeObject5
	/* 471L, 302L) */ if (/* 472L, 289L, 290L) */ ((var_1_27) >= (var_1_18))) {
		/* 475L, 301L) */ var_1_31 = (
			/* 478L, 300L) */ ((
				var_1_32
			) - (
	...
	// From: CodeObject6
	/* 481L, 400L) */ if (/* 482L, 315L, 316L) */ ((var_1_18) < (/* 484L, 314L, 318L) */ (min (/* 484L, 314L, 318L) */ (var_1_1) , (/* 486L, 313L, 320L) */ ((var_1_29) % (-5)))))))) {
		/* 489L, 335L) */ var_1_34 = (
			/* 492L, 334L) */ (max (
				/* 492L, 334L) */ (
					1.25f
		...
		/* 495L, 398L) */ if (var_1_11) {
			...
			/* 502L, 396L) */ if (/* 503L, 348L, 349L) */ ((var_1_29) < (/* 505L, 347L, 351L) */ ((var_1_23) & (var_1_27))))) {
				...
				/* 516L, 394L) */ if (/* 517L, 372L, 373L) */ ((/* 518L, 370L, 374L) */ (abs (/* 519L, 369L, 375L) */ (max (/* 519L, 369L, 375L) */ (var_1_18) , (var_1_27)))))) < (-4))) {
					/* 523L, 393L) */ var_1_34 = (
						/* 526L, 392L) */ (max (
							/* 526L, 392L) */ (
								var_1_36
