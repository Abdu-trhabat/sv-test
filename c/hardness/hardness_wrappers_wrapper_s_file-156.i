...
void step(void) {
 ...
 if (! (WrapperStruct00.var_1_1 <= WrapperStruct00.var_1_6)) {
  if ((WrapperStruct00.var_1_9 - ((((WrapperStruct00.var_1_4) > (WrapperStruct00.var_1_11)) ? (WrapperStruct00.var_1_4) : (WrapperStruct00.var_1_11)))) >= WrapperStruct00.var_1_5) {
   WrapperStruct00.var_1_8 = (((((WrapperStruct00.var_1_10) < 0 ) ? -(WrapperStruct00.var_1_10) : (WrapperStruct00.var_1_10))) - WrapperStruct00.var_1_5);
  } else {
   WrapperStruct00.var_1_8 = ((((32) > (WrapperStruct00.var_1_11)) ? (32) : (WrapperStruct00.var_1_11)));
  }
 }
}
void updateVariables(void) {
