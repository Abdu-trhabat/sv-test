...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch130normal.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_8 - ((((var_1_9) > (var_1_10)) ? (var_1_9) : (var_1_10)))) <= last_1_var_1_14) {
  var_1_7 = (((((var_1_12) > (var_1_13)) ? (var_1_12) : (var_1_13))) - 50);
 }
 signed long int stepLocal_3 = var_1_6 + var_1_7;
 signed long int stepLocal_2 = var_1_18 - (100 - var_1_19);
 if (var_1_15) {
 ...
 if (stepLocal_1 <= (var_1_4 / ((((-25) < (var_1_5)) ? (-25) : (var_1_5))))) {
  var_1_1 = var_1_6;
 } else {
...
int property(void) {
 return ((((var_1_2 & var_1_3) <= (var_1_4 / ((((-25) < (var_1_5)) ? (-25) : (var_1_5))))) ? (var_1_1 == ((signed char) var_1_6)) : ((var_1_5 != var_1_4) ? (var_1_1 == ((signed char) var_1_6)) : (var_1_1 == ((signed char) 5)))) && (((var_1_8 - ((((var_1_9) > (var_1_10)) ? (var_1_9) : (var_1_10)))) <= last_1_var_1_14) ? (var_1_7 == ((signed long int) (((((var_1_12) > (var_1_13)) ? (var_1_12) : (var_1_13))) - 50))) : 1)) && (var_1_15 ? ((var_1_12 <= (var_1_6 + var_1_7)) ? (var_1_16 ? (var_1_14 == ((double) var_1_17)) : (((var_1_18 - (100 - var_1_19)) <= var_1_7) ? (var_1_14 == ((double) (var_1_20 + var_1_21))) : (var_1_14 == ((double) var_1_17)))) : (var_1_14 == ((double) var_1_20))) : (var_1_14 == ((double) var_1_20)))
;
}
int main(void) {
 isInitial = 1;
