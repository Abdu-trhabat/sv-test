...
void step(void) {
	...
	// From: CodeObject3
	/* 414L, 196L) */ if (/* 415L, 134L, 135L) */ ((var_1_15) != (var_1_11))) {
		/* 418L, 165L) */ if (/* 419L, 145L, 146L) */ ((var_1_8) < (/* 421L, 144L, 148L) */ ((var_1_19) / (var_1_24))))) {
			/* 424L, 160L) */ var_1_23 = (
				/* 427L, 159L) */ (abs (
					4
				))
	...
	// From: CodeObject6
	/* 496L, 327L) */ if (/* 497L, 309L, 310L) */ ((var_1_31) < (var_1_11))) {
		/* 500L, 320L) */ var_1_36 = (
			/* 503L, 319L) */ (abs (
				var_1_32
			))
	...
	// From: CodeObject1
	/* 396L, 118L) */ if (/* 397L, 97L, 98L) */ ((/* 398L, 93L, 99L) */ ((/* 399L, 91L, 100L) */ (abs (var_1_18))) - (var_1_19))) == (/* 402L, 96L, 103L) */ ((var_1_20) * (var_1_21))))) {
		/* 405L, 117L) */ var_1_17 = (
			-4
		);
	}
	...
	// From: CodeObject5
	/* 449L, 301L) */ if (/* 450L, 214L, 215L) */ ((/* 451L, 212L, 216L) */ ((/* 452L, 210L, 217L) */ (max (/* 452L, 210L, 217L) */ (var_1_30) , (var_1_31)))) << (var_1_11))) <= (var_1_27))) {
		/* 457L, 237L) */ var_1_29 = (
			/* 460L, 236L) */ ((
				/* 461L, 233L) */ (min (
					/* 461L, 233L) */ (
		...
		/* 466L, 299L) */ if (/* 467L, 240L, 241L) */ ((var_1_30) >= (var_1_26))) {
			/* 470L, 297L) */ if (/* 471L, 253L, 254L) */ ((var_1_15) > (/* 473L, 252L, 256L) */ ((/* 474L, 250L, 257L) */ ((5) ^ (var_1_31))) ^ (var_1_26))))) {
				/* 478L, 287L) */ if (/* 479L, 272L, 273L) */ ((var_1_30) > (/* 481L, 271L, 275L) */ (abs (/* 482L, 270L, 276L) */ (abs (-10))))))) {
					/* 484L, 286L) */ var_1_29 = (
						31.1f
					);
				}
...
int property(void) {
	if (/* 527L, 7L, 14L, 328L, 340L, 984L, 1212L, 25L) */ ((/* 528L, 5L, 15L, 329L, 341L, 981L, 1213L, 22L) */ ((last_1_var_1_15) / (/* 531L, 4L, 17L, 331L, 343L, 980L, 1216L, 21L) */ (abs (-16))))) >= (last_1_var_1_15))) {
	}
	if (var_1_1) {
		if (/* 543L, 35L, 39L, 396L, 417L, 1228L) */ ((var_1_11) >= (var_1_15))) {
			if (/* 547L, 47L, 53L, 400L, 421L, 1232L) */ ((var_1_1) || (/* 549L, 46L, 55L, 402L, 423L, 1234L) */ ((var_1_11) < (var_1_15))))) {
			}
		} else {
		}
	}
	if (/* 565L, 78L, 82L, 503L, 535L, 1250L) */ ((10.55f) < (var_1_16))) {
		if (/* 569L, 89L, 95L, 507L, 539L, 1254L) */ ((var_1_16) > (/* 571L, 88L, 97L, 509L, 541L, 1256L) */ ((var_1_7) * (var_1_5))))) {
		}
	} else {
		if (/* 581L, 110L, 114L, 519L, 551L, 1266L) */ ((var_1_16) > (var_1_7))) {
		} else {
		}
	}
	if (last_1_var_1_1) {
		if (/* 597L, 146L, 152L, 612L, 635L, 1027L, 1282L, 68L) */ ((/* 598L, 144L, 153L, 613L, 636L, 1024L, 1283L, 65L) */ (max (/* 598L, 144L, 153L, 613L, 636L, 1024L, 1283L, 65L) */ (last_1_var_1_5) , (49.75)))) > (last_1_var_1_16))) {
		}
	} else {
	}
	if (/* 623L, 184L, 191L, 719L, 750L, 1308L) */ ((/* 624L, 180L, 192L, 720L, 751L, 1309L) */ (- (var_1_11))) > (/* 626L, 183L, 194L, 722L, 753L, 1311L) */ ((var_1_11) & (var_1_13))))) {
		if (/* 630L, 199L, 203L, 726L, 757L, 1315L) */ ((var_1_11) <= (128))) {
			if (var_1_1) {
			} else {
			}
		} else {
	...
	if (/* 653L, 251L, 259L, 918L, 941L, 1338L) */ ((var_1_14) >= (/* 655L, 250L, 261L, 920L, 943L, 1340L) */ ((/* 656L, 248L, 262L, 921L, 944L, 1341L) */ ((var_1_2) * (var_1_11))) * (32))))) {
		if (var_1_1) {
		} else {
		}
	} else {
	...
	/* 678L) */ ((
		/* 677L) */ ((
			/* 676L) */ ((
				/* 675L) */ ((
					/* 526L, 25L, 327L, 339L, 989L, 1211L, 30L) */ ((
						/* 527L, 7L, 14L, 328L, 340L, 984L, 1212L, 25L) */ ((
							/* 528L, 5L, 15L, 329L, 341L, 981L, 1213L, 22L) */ ((
								last_1_var_1_15
							) / (
								/* 531L, 4L, 17L, 331L, 343L, 980L, 1216L, 21L) */ (abs (
									-16
								))
							))
						) >= (
						...
						/* 535L, 23L, 334L, 346L, 988L, 1220L, 29L) */ ((
							var_1_1
						) == (
							/* 535L, 23L, 334L, 346L, 988L, 1220L, 29L) */ ((unsigned char) (
								var_1_4
							))
						))
					) : (
					...
					/* 540L, 71L, 393L, 414L, 1225L) */ ((
						var_1_1
					) ? (
						/* 542L, 69L, 395L, 416L, 1227L) */ ((
							/* 543L, 35L, 39L, 396L, 417L, 1228L) */ ((
								var_1_11
							) >= (
								var_1_15
							))
						) ? (
							/* 546L, 63L, 399L, 420L, 1231L) */ ((
								/* 547L, 47L, 53L, 400L, 421L, 1232L) */ ((
									var_1_1
								) || (
									/* 549L, 46L, 55L, 402L, 423L, 1234L) */ ((
										var_1_11
									) < (
										var_1_15
									))
								...
								/* 552L, 61L, 405L, 426L, 1237L) */ ((
									var_1_5
								) == (
									/* 552L, 61L, 405L, 426L, 1237L) */ ((double) (
										var_1_7
									))
								))
							) : (
							...
							/* 556L, 67L, 409L, 430L, 1241L) */ ((
								var_1_5
							) == (
								/* 556L, 67L, 409L, 430L, 1241L) */ ((double) (
									var_1_7
								))
							))
						))
				...
				/* 564L, 128L, 502L, 534L, 1249L) */ ((
					/* 565L, 78L, 82L, 503L, 535L, 1250L) */ ((
						10.55f
					) < (
						var_1_16
					))
				) ? (
					/* 568L, 107L, 506L, 538L, 1253L) */ ((
						/* 569L, 89L, 95L, 507L, 539L, 1254L) */ ((
							var_1_16
						) > (
							/* 571L, 88L, 97L, 509L, 541L, 1256L) */ ((
								var_1_7
							) * (
								var_1_5
							))
						...
						/* 574L, 105L, 512L, 544L, 1259L) */ ((
							var_1_8
						) == (
							/* 574L, 105L, 512L, 544L, 1259L) */ ((double) (
								/* 577L, 104L, 515L, 547L, 1262L) */ (max (
									/* 577L, 104L, 515L, 547L, 1262L) */ (
										var_1_7
									) , (
										var_1_10
									)
					...
					/* 580L, 126L, 518L, 550L, 1265L) */ ((
						/* 581L, 110L, 114L, 519L, 551L, 1266L) */ ((
							var_1_16
						) > (
							var_1_7
						))
					) ? (
						/* 584L, 120L, 522L, 554L, 1269L) */ ((
							var_1_8
						) == (
							/* 584L, 120L, 522L, 554L, 1269L) */ ((double) (
								var_1_10
							))
						))
					) : (
						/* 588L, 124L, 526L, 558L, 1273L) */ ((
							var_1_8
						) == (
							/* 588L, 124L, 526L, 558L, 1273L) */ ((double) (
								var_1_7
							))
						))
					))
			...
			/* 593L, 174L, 609L, 632L, 1045L, 1278L, 86L) */ ((
				last_1_var_1_1
			) ? (
				/* 596L, 168L, 611L, 634L, 1039L, 1281L, 80L) */ ((
					/* 597L, 146L, 152L, 612L, 635L, 1027L, 1282L, 68L) */ ((
						/* 598L, 144L, 153L, 613L, 636L, 1024L, 1283L, 65L) */ (max (
							/* 598L, 144L, 153L, 613L, 636L, 1024L, 1283L, 65L) */ (
								last_1_var_1_5
							) , (
								49.75
							)
					...
					/* 604L, 166L, 617L, 640L, 1038L, 1289L, 79L) */ ((
						var_1_11
					) == (
						/* 604L, 166L, 617L, 640L, 1038L, 1289L, 79L) */ ((signed long int) (
							/* 607L, 165L, 620L, 643L, 1037L, 1292L, 78L) */ (min (
								/* 607L, 165L, 620L, 643L, 1037L, 1292L, 78L) */ (
									last_1_var_1_15
								) , (
									/* 610L, 164L, 622L, 645L, 1036L, 1295L, 77L) */ (max (
										/* 610L, 164L, 622L, 645L, 1036L, 1295L, 77L) */ (
											/* 611L, 162L, 623L, 646L, 1034L, 1296L, 75L) */ ((
												var_1_13
											) - (
												5
											))
				...
				/* 615L, 172L, 627L, 650L, 1044L, 1300L, 85L) */ ((
					var_1_11
				) == (
					/* 615L, 172L, 627L, 650L, 1044L, 1300L, 85L) */ ((signed long int) (
						last_1_var_1_15
					))
				))
			))
		...
		/* 622L, 238L, 718L, 749L, 1307L) */ ((
			/* 623L, 184L, 191L, 719L, 750L, 1308L) */ ((
				/* 624L, 180L, 192L, 720L, 751L, 1309L) */ (- (
					var_1_11
				))
			) > (
				/* 626L, 183L, 194L, 722L, 753L, 1311L) */ ((
					var_1_11
				) & (
					var_1_13
				))
			...
			/* 629L, 232L, 725L, 756L, 1314L) */ ((
				/* 630L, 199L, 203L, 726L, 757L, 1315L) */ ((
					var_1_11
				) <= (
					128
				))
			) ? (
				/* 633L, 226L, 729L, 760L, 1318L) */ ((
					var_1_1
				) ? (
					/* 635L, 212L, 731L, 762L, 1320L) */ ((
						var_1_15
					) == (
						/* 635L, 212L, 731L, 762L, 1320L) */ ((signed long int) (
							var_1_14
						))
					))
				) : (
					/* 639L, 224L, 735L, 766L, 1324L) */ ((
						var_1_15
					) == (
						/* 639L, 224L, 735L, 766L, 1324L) */ ((signed long int) (
							var_1_13
						))
					))
				))
			) : (
				/* 643L, 230L, 739L, 770L, 1328L) */ ((
					var_1_15
				) == (
					/* 643L, 230L, 739L, 770L, 1328L) */ ((signed long int) (
						var_1_13
					))
				))
			))
		) : (
			/* 647L, 236L, 743L, 774L, 1332L) */ ((
				var_1_15
			) == (
				/* 647L, 236L, 743L, 774L, 1332L) */ ((signed long int) (
					var_1_13
				))
			))
		))
	...
	/* 652L, 300L, 917L, 940L, 1337L) */ ((
		/* 653L, 251L, 259L, 918L, 941L, 1338L) */ ((
			var_1_14
		) >= (
			/* 655L, 250L, 261L, 920L, 943L, 1340L) */ ((
				/* 656L, 248L, 262L, 921L, 944L, 1341L) */ ((
					var_1_2
				) * (
					var_1_11
				))
		...
		/* 660L, 294L, 925L, 948L, 1345L) */ ((
			var_1_1
		) ? (
			/* 662L, 272L, 927L, 950L, 1347L) */ ((
				var_1_16
			) == (
				/* 662L, 272L, 927L, 950L, 1347L) */ ((double) (
					var_1_10
				))
			))
		) : (
			/* 666L, 292L, 931L, 954L, 1351L) */ ((
				var_1_16
			) == (
				/* 666L, 292L, 931L, 954L, 1351L) */ ((double) (
					var_1_7
				))
			))
		))
	) : (
		/* 670L, 298L, 935L, 958L, 1355L) */ ((
			var_1_16
		) == (
			/* 670L, 298L, 935L, 958L, 1355L) */ ((double) (
				var_1_10
			))
		))
	))
