...
void step(void) {
	...
	// From: Req7Batch104stepLocals
	unsigned short int stepLocal_4 = var_1_4;
	if (stepLocal_4 > (min (var_1_5 , var_1_25))) {
		if (var_1_10 >= var_1_9) {
			var_1_26 = (! var_1_27);
		} else {
			var_1_26 = var_1_27;
