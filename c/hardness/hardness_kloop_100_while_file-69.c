...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch69100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch69100_while
	if (var_1_26 >= var_1_18) {
		var_1_36 = var_1_28;
	}


	// From: Req12Batch69100_while
