...
void step(void) {
	...
	if ((var_1_7 + var_1_6) > (var_1_1 * var_1_9)) {
	...
	// From: Req5Batch106normal
	var_1_15 = var_1_6;


	// From: Req6Batch106normal
	if (var_1_17 || var_1_2) {
	...
	// From: Req7Batch106normal
	if ((var_1_6 + var_1_15) <= var_1_12) {
		var_1_20 = var_1_10;
	} else {
	...
	// From: Req8Batch106normal
	var_1_23 = var_1_24;


	// From: Req9Batch106normal
	var_1_25 = var_1_16;


	// From: Req10Batch106normal
	var_1_26 = var_1_25;
}
