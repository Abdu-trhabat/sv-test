...
void step(void) {
	...
	if ((var_1_12 / 1.3) <= var_1_13) {
		if (((var_1_5 * var_1_17) >= var_1_6) && var_1_18) {
			var_1_11 = (! var_1_14);
		} else {
			var_1_11 = var_1_15;
		}
...
int property(void) {
	return (((((((var_1_2 + var_1_3) < var_1_4) ? ((var_1_2 <= var_1_4) ? (var_1_1 == ((unsigned char) (min (var_1_5 , var_1_6)))) : (var_1_1 == ((unsigned char) var_1_6))) : (var_1_18 ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_1 == ((unsigned char) var_1_6)))) && (var_1_11 ? (var_1_11 ? (var_1_8 == ((signed char) (abs (var_1_10)))) : (var_1_8 == ((signed char) (max (var_1_10 , 2))))) : 1)) && (((var_1_12 / 1.3) <= var_1_13) ? ((((var_1_5 * var_1_17) >= var_1_6) && var_1_18) ? (var_1_11 == ((unsigned char) (! var_1_14))) : (var_1_11 == ((unsigned char) var_1_15))) : 1)) && (var_1_16 == ((unsigned char) var_1_15))) && (var_1_17 == ((unsigned long int) 16u))) && (var_1_18 == ((unsigned char) var_1_14))
;
}
int main(void) {
	isInitial = 1;
