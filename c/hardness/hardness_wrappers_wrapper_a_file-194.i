...
void step(void) {
 ...
 signed long int stepLocal_1 = unsigned_short_int_Array_0[2] / ((((signed_long_int_Array_0[1]) < (unsigned_short_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (unsigned_short_int_Array_0[0])));
 ...
 if (BOOL_unsigned_char_Array_0[1]) {
  if (signed_long_int_Array_0[1] > (signed_char_Array_0[2] | ((((unsigned_short_int_Array_0[0]) > (unsigned_long_int_Array_0[1])) ? (unsigned_short_int_Array_0[0]) : (unsigned_long_int_Array_0[1]))))) {
   if ((signed_char_Array_0[1] - signed_char_Array_0[3]) < (signed_char_Array_0[2] / ((((signed_long_int_Array_0[1]) > (unsigned_short_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (unsigned_short_int_Array_0[0]))))) {
 ...
 if (BOOL_unsigned_char_Array_0[1]) {
  if ((unsigned_long_int_Array_0[1] == unsigned_long_int_Array_0[0]) && stepLocal_0) {
   signed_char_Array_0[4] = ((((signed_char_Array_0[2]) < 0 ) ? -(signed_char_Array_0[2]) : (signed_char_Array_0[2])));
  }
 } else {
...
int property(void) {
 return ((BOOL_unsigned_char_Array_0[1] ? (((unsigned_long_int_Array_0[1] == unsigned_long_int_Array_0[0]) && ((signed_long_int_Array_0[0] % signed_long_int_Array_0[1]) >= signed_long_int_Array_0[0])) ? (signed_char_Array_0[4] == ((signed char) ((((signed_char_Array_0[2]) < 0 ) ? -(signed_char_Array_0[2]) : (signed_char_Array_0[2]))))) : 1) : (signed_char_Array_0[4] == ((signed char) signed_char_Array_0[2]))) && ((BOOL_unsigned_char_Array_0[1] && BOOL_unsigned_char_Array_0[0]) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[1])) : (BOOL_unsigned_char_Array_0[0] ? ((unsigned_short_int_Array_0[1] >= (unsigned_short_int_Array_0[2] / ((((signed_long_int_Array_0[1]) < (unsigned_short_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (unsigned_short_int_Array_0[0]))))) ? (signed_long_int_Array_0[0] == ((signed long int) signed_char_Array_0[2])) : 1) : 1))) && (BOOL_unsigned_char_Array_0[1] ? ((signed_long_int_Array_0[1] > (signed_char_Array_0[2] | ((((unsigned_short_int_Array_0[0]) > (unsigned_long_int_Array_0[1])) ? (unsigned_short_int_Array_0[0]) : (unsigned_long_int_Array_0[1]))))) ? (((signed_char_Array_0[1] - signed_char_Array_0[3]) < (signed_char_Array_0[2] / ((((signed_long_int_Array_0[1]) > (unsigned_short_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (unsigned_short_int_Array_0[0]))))) ? (signed_char_Array_0[0] == ((signed char) signed_char_Array_0[2])) : (signed_char_Array_0[0] == ((signed char) 8))) : (signed_char_Array_0[0] == ((signed char) signed_char_Array_0[2]))) : 1)
;
}
int main(void) {
 isInitial = 1;
