...
int property(void) {
	return (((((((((var_1_2 < (max (63.875 , var_1_3))) ? ((! (var_1_3 > var_1_2)) ? (var_1_1 == ((unsigned long int) var_1_4)) : (var_1_1 == ((unsigned long int) 32u))) : (var_1_1 == ((unsigned long int) var_1_4))) && (var_1_24 ? (var_1_5 == ((signed long int) (max (var_1_7 , var_1_8)))) : ((var_1_3 != var_1_2) ? (var_1_5 == ((signed long int) var_1_8)) : (var_1_5 == ((signed long int) var_1_7))))) && ((-128 <= (var_1_10 - (var_1_11 + 50))) ? (var_1_9 == ((signed char) var_1_12)) : 1)) && (((max (var_1_7 , var_1_8)) >= (var_1_11 >> var_1_14)) ? (var_1_13 == ((unsigned long int) var_1_4)) : 1)) && (var_1_15 == ((unsigned long int) (10u + (var_1_14 + var_1_16))))) && ((-10 > var_1_12) ? (var_1_17 == ((unsigned long int) ((var_1_11 + (var_1_18 - var_1_14)) + (10000u + var_1_16)))) : (var_1_17 == ((unsigned long int) var_1_18)))) && (((var_1_15 >= (var_1_20 - 8u)) || (! var_1_24)) ? (var_1_19 == ((unsigned long int) (var_1_14 + (var_1_21 - var_1_16)))) : (var_1_19 == ((unsigned long int) (abs (max (var_1_18 , 0u))))))) && (var_1_22 == ((float) var_1_23))) && (var_1_24 == ((unsigned char) var_1_25))
;
}
int main(void) {
	isInitial = 1;
