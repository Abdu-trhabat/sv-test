...
void step(void) {
	...
	// From: CodeObject3
	/* 112L) */ if (/* 100L, 99L) */ ((var_1_24) > (var_1_23))) {
		/* 111L) */ var_1_29 = (
			/* 110L) */ (abs (
				/* 109L) */ (abs (
					var_1_27
	...
	// From: CodeObject6
	/* 239L) */ if (/* 195L, 194L) */ ((/* 196L, 192L) */ (max (/* 196L, 192L) */ (var_1_34) , (/* 198L, 191L) */ (abs (var_1_36)))))) == (32u))) {
		/* 210L) */ var_1_42 = (
			var_1_24
		);
	} else {
		/* 237L) */ if (/* 220L, 219L) */ ((var_1_29) < (/* 222L, 218L) */ (~ (var_1_43))))) {
			/* 236L) */ var_1_42 = (
				/* 235L) */ (abs (
					/* 234L) */ ((
						/* 232L) */ ((
	...
	// From: CodeObject2
	/* 91L) */ if (/* 73L, 72L) */ ((/* 74L, 70L) */ ((/* 75L, 68L) */ ((25) * (var_1_26))) ^ (var_1_27))) > (var_1_28))) {
		/* 90L) */ var_1_25 = (
			var_1_24
		);
	}
	...
	// From: CodeObject5
	/* 185L) */ if (/* 155L, 154L) */ ((/* 156L, 152L) */ ((/* 157L, 149L) */ (max (/* 157L, 149L) */ (var_1_36) , (var_1_37)))) >> (/* 160L, 151L) */ (abs (var_1_38))))) > (var_1_32))) {
		/* 178L) */ var_1_35 = (
			/* 177L) */ ((
				/* 175L) */ ((
					var_1_39
	...
	// From: CodeObject7
	/* 293L) */ if (/* 254L, 253L) */ ((/* 255L, 249L) */ ((var_1_48) - (var_1_37))) > (/* 258L, 252L) */ (min (/* 258L, 252L) */ (var_1_49) , (var_1_27)))))) {
		/* 291L) */ if (/* 271L, 270L) */ ((var_1_37) >= (5))) {
			/* 286L) */ var_1_47 = (
				var_1_37
			);
		} else {
	...
	// From: CodeObject4
	/* 141L) */ if (/* 120L, 119L) */ ((var_1_24) < (/* 122L, 118L) */ (abs (var_1_25))))) {
		/* 140L) */ var_1_30 = (
			/* 139L) */ ((
				/* 133L) */ ((
					/* 131L) */ (abs (
...
int property(void) {
	if (/* 298L, 5L, 10L, 310L, 330L, 1073L) */ (! (/* 299L, 4L, 11L, 311L, 331L, 1074L) */ ((100u) >= (var_1_15))))) {
	} else {
	}
	if (var_1_20) {
		if (/* 320L, 41L, 47L, 402L, 427L, 1095L) */ ((/* 321L, 39L, 48L, 403L, 428L, 1096L) */ ((var_1_15) / (var_1_11))) != (var_1_15))) {
		} else {
		}
	} else {
	}
	if (/* 345L, 78L, 82L, 512L, 542L, 1120L) */ ((var_1_13) > (2))) {
		if (var_1_20) {
		} else {
		}
	} else {
	}
	if (/* 374L, 123L, 127L, 599L, 613L, 1149L) */ ((var_1_11) <= (-128))) {
		if (/* 378L, 132L, 136L, 603L, 617L, 1153L) */ ((var_1_6) <= (var_1_7))) {
		}
	}
	if (/* 388L, 158L, 165L, 681L, 708L, 890L, 1163L, 33L) */ ((/* 389L, 155L, 166L, 682L, 709L, 887L, 1164L, 30L) */ ((var_1_18) - (var_1_12))) >= (/* 392L, 157L, 169L, 685L, 712L, 889L, 1167L, 32L) */ (~ (var_1_14))))) {
		if (last_1_var_1_20) {
		} else {
		}
	} else {
	}
	if (/* 415L, 206L, 214L, 796L, 827L, 1190L) */ ((/* 416L, 204L, 215L, 797L, 828L, 1191L) */ ((/* 417L, 202L, 216L, 798L, 829L, 1192L) */ (max (/* 417L, 202L, 216L, 798L, 829L, 1192L) */ (var_1_4) , (var_1_3)))) >= (var_1_5))) || (var_1_9))) {
		if (/* 423L, 223L, 227L, 804L, 835L, 1198L) */ ((var_1_17) > (var_1_13))) {
			if (var_1_9) {
			} else {
			}
		} else {
	...
	/* 448L) */ ((
		/* 447L) */ ((
			/* 446L) */ ((
				/* 445L) */ ((
					/* 297L, 29L, 309L, 329L, 1072L) */ ((
						/* 298L, 5L, 10L, 310L, 330L, 1073L) */ (! (
							/* 299L, 4L, 11L, 311L, 331L, 1074L) */ ((
								100u
							) >= (
								var_1_15
							))
						...
						/* 302L, 19L, 314L, 334L, 1077L) */ ((
							var_1_1
						) == (
							/* 302L, 19L, 314L, 334L, 1077L) */ ((float) (
								/* 305L, 18L, 317L, 337L, 1080L) */ (max (
									/* 305L, 18L, 317L, 337L, 1080L) */ (
										var_1_3
									) , (
										var_1_4
									)
						...
						/* 308L, 27L, 320L, 340L, 1083L) */ ((
							var_1_1
						) == (
							/* 308L, 27L, 320L, 340L, 1083L) */ ((float) (
								/* 311L, 26L, 323L, 343L, 1086L) */ ((
									/* 312L, 24L, 324L, 344L, 1087L) */ ((
										var_1_5
									) - (
										var_1_6
									))
					...
					/* 317L, 71L, 399L, 424L, 1092L) */ ((
						var_1_20
					) ? (
						/* 319L, 65L, 401L, 426L, 1094L) */ ((
							/* 320L, 41L, 47L, 402L, 427L, 1095L) */ ((
								/* 321L, 39L, 48L, 403L, 428L, 1096L) */ ((
									var_1_15
								) / (
									var_1_11
								))
							...
							/* 325L, 59L, 407L, 432L, 1100L) */ ((
								var_1_8
							) == (
								/* 325L, 59L, 407L, 432L, 1100L) */ ((unsigned char) (
									/* 328L, 58L, 410L, 435L, 1103L) */ ((
										/* 329L, 56L, 411L, 436L, 1104L) */ ((
											var_1_12
										) + (
											var_1_13
										))
							...
							/* 333L, 63L, 415L, 440L, 1108L) */ ((
								var_1_8
							) == (
								/* 333L, 63L, 415L, 440L, 1108L) */ ((unsigned char) (
									var_1_14
								))
							))
						))
					) : (
						/* 337L, 69L, 419L, 444L, 1112L) */ ((
							var_1_8
						) == (
							/* 337L, 69L, 419L, 444L, 1112L) */ ((unsigned char) (
								var_1_12
							))
						))
					))
				...
				/* 344L, 112L, 511L, 541L, 1119L) */ ((
					/* 345L, 78L, 82L, 512L, 542L, 1120L) */ ((
						var_1_13
					) > (
						2
					))
				) ? (
					/* 348L, 104L, 515L, 545L, 1123L) */ ((
						var_1_20
					) ? (
						/* 350L, 96L, 517L, 547L, 1125L) */ ((
							var_1_15
						) == (
							/* 350L, 96L, 517L, 547L, 1125L) */ ((unsigned long int) (
								/* 353L, 95L, 520L, 550L, 1128L) */ (max (
									/* 353L, 95L, 520L, 550L, 1128L) */ (
										/* 354L, 91L, 521L, 551L, 1129L) */ (abs (
											var_1_13
										))
									) , (
										/* 356L, 94L, 523L, 553L, 1131L) */ ((
											2813524572u
										) - (
											var_1_17
										))
						...
						/* 359L, 102L, 526L, 556L, 1134L) */ ((
							var_1_15
						) == (
							/* 359L, 102L, 526L, 556L, 1134L) */ ((unsigned long int) (
								/* 362L, 101L, 529L, 559L, 1137L) */ (min (
									/* 362L, 101L, 529L, 559L, 1137L) */ (
										var_1_17
									) , (
										var_1_14
									)
					...
					/* 365L, 110L, 532L, 562L, 1140L) */ ((
						var_1_15
					) == (
						/* 365L, 110L, 532L, 562L, 1140L) */ ((unsigned long int) (
							/* 368L, 109L, 535L, 565L, 1143L) */ ((
								var_1_17
							) + (
								100u
							))
			...
			/* 373L, 146L, 598L, 612L, 1148L) */ ((
				/* 374L, 123L, 127L, 599L, 613L, 1149L) */ ((
					var_1_11
				) <= (
					-128
				))
			) ? (
				/* 377L, 144L, 602L, 616L, 1152L) */ ((
					/* 378L, 132L, 136L, 603L, 617L, 1153L) */ ((
						var_1_6
					) <= (
						var_1_7
					))
				) ? (
					/* 381L, 142L, 606L, 620L, 1156L) */ ((
						var_1_16
					) == (
						/* 381L, 142L, 606L, 620L, 1156L) */ ((float) (
							var_1_5
						))
					))
				) : (
		...
		/* 387L, 193L, 680L, 707L, 910L, 1162L, 53L) */ ((
			/* 388L, 158L, 165L, 681L, 708L, 890L, 1163L, 33L) */ ((
				/* 389L, 155L, 166L, 682L, 709L, 887L, 1164L, 30L) */ ((
					var_1_18
				) - (
					var_1_12
				))
			) >= (
				/* 392L, 157L, 169L, 685L, 712L, 889L, 1167L, 32L) */ (~ (
					var_1_14
				))
			))
		) ? (
			/* 394L, 187L, 687L, 714L, 905L, 1169L, 48L) */ ((
				last_1_var_1_20
			) ? (
				/* 397L, 181L, 689L, 716L, 900L, 1172L, 43L) */ ((
					var_1_17
				) == (
					/* 397L, 181L, 689L, 716L, 900L, 1172L, 43L) */ ((unsigned char) (
						/* 400L, 180L, 692L, 719L, 899L, 1175L, 42L) */ (max (
							/* 400L, 180L, 692L, 719L, 899L, 1175L, 42L) */ (
								/* 401L, 178L, 693L, 720L, 897L, 1176L, 40L) */ ((
									var_1_19
								) - (
									var_1_14
								))
				...
				/* 405L, 185L, 697L, 724L, 904L, 1180L, 47L) */ ((
					var_1_17
				) == (
					/* 405L, 185L, 697L, 724L, 904L, 1180L, 47L) */ ((unsigned char) (
						var_1_12
					))
				))
			))
		) : (
			/* 409L, 191L, 701L, 728L, 909L, 1184L, 52L) */ ((
				var_1_17
			) == (
				/* 409L, 191L, 701L, 728L, 909L, 1184L, 52L) */ ((unsigned char) (
					var_1_14
				))
			))
		))
	...
	/* 414L, 266L, 795L, 826L, 1189L) */ ((
		/* 415L, 206L, 214L, 796L, 827L, 1190L) */ ((
			/* 416L, 204L, 215L, 797L, 828L, 1191L) */ ((
				/* 417L, 202L, 216L, 798L, 829L, 1192L) */ (max (
					/* 417L, 202L, 216L, 798L, 829L, 1192L) */ (
						var_1_4
					) , (
						var_1_3
					)
		...
		/* 422L, 260L, 803L, 834L, 1197L) */ ((
			/* 423L, 223L, 227L, 804L, 835L, 1198L) */ ((
				var_1_17
			) > (
				var_1_13
			))
		) ? (
			/* 426L, 254L, 807L, 838L, 1201L) */ ((
				var_1_9
			) ? (
				/* 428L, 236L, 809L, 840L, 1203L) */ ((
					var_1_20
				) == (
					/* 428L, 236L, 809L, 840L, 1203L) */ ((unsigned char) (
						var_1_21
					))
				))
			) : (
				/* 432L, 252L, 813L, 844L, 1207L) */ ((
					var_1_20
				) == (
					/* 432L, 252L, 813L, 844L, 1207L) */ ((unsigned char) (
						0
					))
				))
			))
		) : (
			/* 436L, 258L, 817L, 848L, 1211L) */ ((
				var_1_20
			) == (
				/* 436L, 258L, 817L, 848L, 1211L) */ ((unsigned char) (
					0
				))
			))
		))
	) : (
		/* 440L, 264L, 821L, 852L, 1215L) */ ((
			var_1_20
		) == (
			/* 440L, 264L, 821L, 852L, 1215L) */ ((unsigned char) (
				var_1_22
			))
		))
	))
