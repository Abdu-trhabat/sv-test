...
void step(void) {
	// From: Req1Batch198Wrapper_P
	signed long int stepLocal_0 = (*(var_1_2_Pointer));
	if (stepLocal_0 >= (*(var_1_4_Pointer))) {
		(*(var_1_1_Pointer)) = (((min ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))) + 10.55) + (*(var_1_7_Pointer)));
	}


	// From: Req2Batch198Wrapper_P
	if ((*(var_1_7_Pointer)) > 64.2) {
		(*(var_1_8_Pointer)) = (*(var_1_5_Pointer));
	}


	// From: Req3Batch198Wrapper_P
	unsigned char stepLocal_1 = (*(var_1_10_Pointer));
	if ((*(var_1_3_Pointer)) || stepLocal_1) {
		(*(var_1_9_Pointer)) = (min ((*(var_1_11_Pointer)) , ((*(var_1_12_Pointer)) - (*(var_1_13_Pointer)))));
	} else {
		if ((*(var_1_3_Pointer))) {
			(*(var_1_9_Pointer)) = ((*(var_1_14_Pointer)) + (max ((*(var_1_15_Pointer)) , (max ((*(var_1_16_Pointer)) , (*(var_1_17_Pointer)))))));
		} else {
	...
	// From: Req4Batch198Wrapper_P
	if ((*(var_1_1_Pointer)) > (abs (max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))))) {
		(*(var_1_18_Pointer)) = (25 - (max (4 , (*(var_1_13_Pointer)))));
	} else {
		(*(var_1_18_Pointer)) = 32;
	}
}
...
int property(void) {
	return (((((*(var_1_2_Pointer)) >= (*(var_1_4_Pointer))) ? ((*(var_1_1_Pointer)) == ((double) (((min ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))) + 10.55) + (*(var_1_7_Pointer))))) : 1) && (((*(var_1_7_Pointer)) > 64.2) ? ((*(var_1_8_Pointer)) == ((float) (*(var_1_5_Pointer)))) : 1)) && (((*(var_1_3_Pointer)) || (*(var_1_10_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed char) (min ((*(var_1_11_Pointer)) , ((*(var_1_12_Pointer)) - (*(var_1_13_Pointer))))))) : ((*(var_1_3_Pointer)) ? ((*(var_1_9_Pointer)) == ((signed char) ((*(var_1_14_Pointer)) + (max ((*(var_1_15_Pointer)) , (max ((*(var_1_16_Pointer)) , (*(var_1_17_Pointer))))))))) : (((*(var_1_7_Pointer)) >= (*(var_1_6_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed char) (*(var_1_17_Pointer)))) : ((*(var_1_9_Pointer)) == ((signed char) (*(var_1_16_Pointer)))))))) && (((*(var_1_1_Pointer)) > (abs (max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))))) ? ((*(var_1_18_Pointer)) == ((signed short int) (25 - (max (4 , (*(var_1_13_Pointer))))))) : ((*(var_1_18_Pointer)) == ((signed short int) 32)))
;
}
int main(void) {
	isInitial = 1;
