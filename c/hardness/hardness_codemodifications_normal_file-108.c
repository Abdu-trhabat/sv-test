...
void step(void) {
	...
	if ((var_1_2 * (max (var_1_3 , var_1_4))) != 4) {
	...
	// From: Req4Batch108normal
	if ((var_1_18 + var_1_13) >= (abs (var_1_7 + var_1_10))) {
	...
	// From: Req6Batch108normal
	if (var_1_15) {
		var_1_22 = ((max (var_1_23 , var_1_24)) - var_1_25);
	}


	// From: Req7Batch108normal
	if (var_1_15) {
		if (var_1_21 >= 2) {
			var_1_26 = var_1_10;
		} else {
