...
void step(void) {
 ...
 if (stepLocal_2 == ((((32) < ((*(WrapperStruct00_var_1_5_Pointer)))) ? (32) : ((*(WrapperStruct00_var_1_5_Pointer)))))) {
  if (! (*(WrapperStruct00_var_1_2_Pointer))) {
   (*(WrapperStruct00_var_1_7_Pointer)) = ((((((*(WrapperStruct00_var_1_8_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_8_Pointer))) : ((*(WrapperStruct00_var_1_8_Pointer))))) - (*(WrapperStruct00_var_1_9_Pointer)));
  } else {
 ...
 if (((((- (*(WrapperStruct00_var_1_10_Pointer))) < 0 ) ? -(- (*(WrapperStruct00_var_1_10_Pointer))) : (- (*(WrapperStruct00_var_1_10_Pointer))))) < (((*(WrapperStruct00_var_1_12_Pointer)) + (*(WrapperStruct00_var_1_5_Pointer))) - ((*(WrapperStruct00_var_1_14_Pointer)) - (*(WrapperStruct00_var_1_15_Pointer))))) {
