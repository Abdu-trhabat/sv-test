...
void step(void) {
	...
	if (stepLocal_0 > (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer)) = (min ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))));
	} else {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer)) = 32;
	}


	// From: Req2Batch114Wrapper_AP
	...
	if (((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) / 1u) != ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) + 10u)) {
		(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) = ((min ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) , 128)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)));
	}


	// From: Req4Batch114Wrapper_AP
	if (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) / (max ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) , -8))) >= (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) | (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer))) + (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)))) {
		(*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer));
	} else {
		if ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) != ((abs ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)))) - (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)))) {
			(*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer));
		}
	}
}
