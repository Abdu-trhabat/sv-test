...
void step(void) {
	...
	if ((var_1_17 / (var_1_28 + 10)) > last_1_var_1_23) {
		...
		if (var_1_24 <= last_1_var_1_34) {
			...
			var_1_38 = (((min (1985616304u , var_1_40)) - (var_1_41 - 25u)) + (var_1_42 - 100000000u));
		}
	}
	...
	signed long int stepLocal_9 = var_1_13 - (min (var_1_24 , var_1_18));
	if (stepLocal_11 < (last_1_var_1_25 | var_1_17)) {
		if (stepLocal_9 > ((max (last_1_var_1_44 , last_1_var_1_52)) ^ last_1_var_1_37)) {
			var_1_32 = var_1_20;
		} else {
			if (var_1_3 >= var_1_30) {
				if (3.625 >= (var_1_30 - var_1_29)) {
					if (stepLocal_12 <= (last_1_var_1_25 * var_1_16)) {
						var_1_32 = ((abs (var_1_10)) - last_1_var_1_44);
					} else {
						var_1_32 = var_1_20;
					}
				}
	...
	unsigned long int stepLocal_15 = var_1_32 + (abs (var_1_42));
	if (stepLocal_15 == var_1_38) {
		var_1_46 = (max (var_1_6 , var_1_28));
	} else {
		var_1_46 = (max ((max (var_1_41 , var_1_39)) , 256u));
	}
	...
	if ((8 < (min (last_1_var_1_4 , last_1_var_1_23))) || last_1_var_1_19) {
	...
	if (! (var_1_55 >= (var_1_7 >> var_1_28))) {
		var_1_27 = (max (var_1_28 , var_1_10));
	} else {
		if ((var_1_29 - var_1_30) < var_1_2) {
			if (var_1_21) {
				var_1_27 = (min (var_1_7 , -10));
			} else {
				var_1_27 = (min ((var_1_17 - (min (10 , var_1_28))) , var_1_10));
			}
		}
	}
	...
	if (var_1_30 >= 3.375f) {
		if (var_1_28 <= (128 - var_1_10)) {
			var_1_43 = ((max (var_1_13 , 58018)) - ((max (50 , var_1_6)) + var_1_7));
		}
	}
	...
	if ((var_1_4 / -5) >= (-8 + var_1_18)) {
		var_1_34 = ((min (1 , var_1_38)) + var_1_4);
	} else {
		if (var_1_55 != var_1_17) {
			var_1_34 = (abs (max (var_1_17 , -256)));
		} else {
	...
	if (stepLocal_7 < var_1_18) {
		...
		if (stepLocal_8 && var_1_15) {
			...
			if (! (var_1_5 > var_1_2)) {
				...
				var_1_23 = ((var_1_24 - var_1_17) - (min (var_1_44 , var_1_6)));
			}
		}
	}
	...
	if (var_1_21) {
		var_1_37 = (((abs (var_1_32)) + var_1_13) + var_1_46);
	} else {
		var_1_37 = (max (var_1_11 , var_1_27));
	}
	...
	signed long int stepLocal_1 = (max (var_1_9 , var_1_8)) * (min (var_1_10 , var_1_23));
	...
	if ((~ var_1_37) == (~ var_1_12)) {
		...
		var_1_31 = (max (var_1_7 , var_1_13));
	}


	// From: Req21Batch94Amount250
	if ((var_1_2 * var_1_5) > ((8.394412519810758E18 - var_1_48) - (var_1_49 + var_1_50))) {
		var_1_47 = ((max ((max (var_1_55 , var_1_54)) , (var_1_7 + var_1_17))) - ((var_1_51 - var_1_28) + var_1_34));
	}


	// From: Req15Batch94Amount250
	if (((max (var_1_34 , var_1_54)) / var_1_13) < (max (var_1_27 , (var_1_28 - var_1_7)))) {
	...
	if (stepLocal_4 || var_1_19) {
		if ((var_1_16 - (abs (var_1_6))) > stepLocal_2) {
...
int property(void) {
	return ((((((((((((((((((((((((var_1_1 == ((double) (min (9.999999999999925E13 , (var_1_2 + (abs (var_1_3))))))) && ((var_1_1 <= (25.75 / var_1_5)) ? (var_1_4 == ((unsigned char) (var_1_6 - var_1_7))) : 1)) && (var_1_8 == ((signed char) (var_1_9 - var_1_10)))) && (var_1_11 == ((unsigned char) (min (var_1_6 , var_1_7))))) && ((((max (var_1_9 , var_1_8)) * (min (var_1_10 , var_1_23))) > var_1_6) ? ((var_1_43 < (var_1_6 * var_1_10)) ? (var_1_12 == ((unsigned short int) ((var_1_13 - var_1_43) - 10))) : (var_1_12 == ((unsigned short int) 100))) : (var_1_12 == ((unsigned short int) var_1_10)))) && (((var_1_38 == var_1_10) || var_1_19) ? (((var_1_16 - (abs (var_1_6))) > var_1_31) ? (var_1_14 == ((signed char) (var_1_10 - (var_1_17 + var_1_18)))) : ((var_1_10 > ((var_1_16 * var_1_32) * var_1_31)) ? (var_1_14 == ((signed char) 4)) : (var_1_14 == ((signed char) (var_1_18 + var_1_17))))) : (var_1_14 == ((signed char) var_1_18)))) && (((var_1_17 <= (var_1_18 / var_1_20)) || last_1_var_1_35) ? ((last_1_var_1_35 || (last_1_var_1_55 < (~ var_1_10))) ? (var_1_19 == ((unsigned char) (! (! var_1_21)))) : (var_1_19 == ((unsigned char) ((! last_1_var_1_35) || var_1_21)))) : (var_1_19 == ((unsigned char) var_1_22)))) && ((var_1_13 < var_1_18) ? (var_1_23 == ((signed long int) (var_1_18 + var_1_17))) : ((var_1_19 && var_1_15) ? (var_1_23 == ((signed long int) (10 - var_1_38))) : ((! (var_1_5 > var_1_2)) ? (var_1_23 == ((signed long int) var_1_25)) : (var_1_23 == ((signed long int) ((var_1_24 - var_1_17) - (min (var_1_44 , var_1_6))))))))) && (var_1_25 == ((unsigned char) var_1_10))) && ((var_1_18 >= var_1_32) ? (var_1_26 == ((signed char) var_1_18)) : 1)) && ((! (var_1_55 >= (var_1_7 >> var_1_28))) ? (var_1_27 == ((signed short int) (max (var_1_28 , var_1_10)))) : (((var_1_29 - var_1_30) < var_1_2) ? (var_1_21 ? (var_1_27 == ((signed short int) (min (var_1_7 , -10)))) : (var_1_27 == ((signed short int) (min ((var_1_17 - (min (10 , var_1_28))) , var_1_10))))) : 1))) && (((~ var_1_37) == (~ var_1_12)) ? (var_1_31 == ((unsigned short int) var_1_28)) : (var_1_31 == ((unsigned short int) (max (var_1_7 , var_1_13)))))) && (((32 << var_1_9) < (last_1_var_1_25 | var_1_17)) ? (((var_1_13 - (min (var_1_24 , var_1_18))) > ((max (last_1_var_1_44 , last_1_var_1_52)) ^ last_1_var_1_37)) ? (var_1_32 == ((signed short int) var_1_20)) : ((var_1_3 >= var_1_30) ? ((3.625 >= (var_1_30 - var_1_29)) ? ((var_1_10 <= (last_1_var_1_25 * var_1_16)) ? (var_1_32 == ((signed short int) ((abs (var_1_10)) - last_1_var_1_44))) : (var_1_32 == ((signed short int) var_1_20))) : 1) : (var_1_32 == ((signed short int) ((var_1_28 + var_1_18) - (var_1_10 + last_1_var_1_47)))))) : ((((var_1_28 + var_1_16) >> 8) >= last_1_var_1_44) ? ((last_1_var_1_44 == var_1_6) ? (var_1_32 == ((signed short int) (min (var_1_17 , var_1_7)))) : (var_1_32 == ((signed short int) (last_1_var_1_47 - var_1_17)))) : ((var_1_9 > ((var_1_10 + var_1_24) + last_1_var_1_11)) ? (var_1_32 == ((signed short int) (min (var_1_6 , var_1_9)))) : (var_1_32 == ((signed short int) var_1_20)))))) && (((var_1_4 / -5) >= (-8 + var_1_18)) ? (var_1_34 == ((signed short int) ((min (1 , var_1_38)) + var_1_4))) : ((var_1_55 != var_1_17) ? (var_1_34 == ((signed short int) (abs (max (var_1_17 , -256))))) : (var_1_34 == ((signed short int) ((var_1_17 + 25) + var_1_9)))))) && ((((max (var_1_34 , var_1_54)) / var_1_13) < (max (var_1_27 , (var_1_28 - var_1_7)))) ? (var_1_35 == ((unsigned char) (var_1_21 || (! var_1_22)))) : (var_1_35 == ((unsigned char) (! (var_1_21 && (var_1_22 || var_1_36))))))) && (var_1_21 ? (var_1_37 == ((unsigned long int) (((abs (var_1_32)) + var_1_13) + var_1_46))) : (var_1_37 == ((unsigned long int) (max (var_1_11 , var_1_27)))))) && (((var_1_17 / (var_1_28 + 10)) > last_1_var_1_23) ? ((! var_1_21) ? (var_1_38 == ((unsigned long int) (var_1_39 - (var_1_6 + var_1_13)))) : 1) : ((var_1_24 <= last_1_var_1_34) ? (var_1_38 == ((unsigned long int) last_1_var_1_55)) : (var_1_38 == ((unsigned long int) (((min (1985616304u , var_1_40)) - (var_1_41 - 25u)) + (var_1_42 - 100000000u))))))) && ((var_1_30 >= 3.375f) ? ((var_1_28 <= (128 - var_1_10)) ? (var_1_43 == ((unsigned short int) ((max (var_1_13 , 58018)) - ((max (50 , var_1_6)) + var_1_7)))) : 1) : 1)) && (var_1_44 == ((unsigned long int) (var_1_45 - var_1_42)))) && (((var_1_32 + (abs (var_1_42))) == var_1_38) ? (var_1_46 == ((unsigned long int) (max (var_1_6 , var_1_28)))) : (var_1_46 == ((unsigned long int) (max ((max (var_1_41 , var_1_39)) , 256u)))))) && (((var_1_2 * var_1_5) > ((8.394412519810758E18 - var_1_48) - (var_1_49 + var_1_50))) ? (var_1_47 == ((signed short int) ((max ((max (var_1_55 , var_1_54)) , (var_1_7 + var_1_17))) - ((var_1_51 - var_1_28) + var_1_34)))) : 1)) && ((var_1_18 <= var_1_37) ? (var_1_52 == ((unsigned long int) var_1_39)) : (var_1_52 == ((unsigned long int) var_1_45)))) && (var_1_53 == ((signed char) var_1_17))) && (var_1_19 ? (var_1_54 == ((signed short int) var_1_11)) : 1)) && (((8 < (min (last_1_var_1_4 , last_1_var_1_23))) || last_1_var_1_19) ? ((last_1_var_1_19 || (last_1_var_1_34 <= 256)) ? (var_1_55 == ((unsigned short int) (var_1_28 + var_1_7))) : (var_1_55 == ((unsigned short int) var_1_10))) : 1)
;
}
int main(void) {
	isInitial = 1;
