...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch197dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch197dependencies
	if ((var_1_1 / var_1_19) <= 4) {
		var_1_18 = (var_1_5 + (max ((var_1_19 - var_1_20) , var_1_21)));
	} else {
		var_1_18 = (abs (var_1_21));
	}


	// From: Req7Batch197dependencies
	var_1_22 = var_1_13;


	// From: Req8Batch197dependencies
	var_1_23 = var_1_20;


	// From: Req3Batch197dependencies
	if (var_1_7 || var_1_10) {
		if (var_1_6 < (min (var_1_5 , var_1_6))) {
	...
	// From: Req5Batch197dependencies
	if (var_1_7 && var_1_10) {
		if (((max (var_1_4 , var_1_1)) + var_1_5) != var_1_23) {
			var_1_17 = 100.85f;
		} else {
			var_1_17 = var_1_13;
		}
...
int property(void) {
	return ((((((((last_1_var_1_17 != last_1_var_1_22) ? (var_1_1 == ((unsigned char) ((var_1_4 - var_1_5) - 10))) : (var_1_1 == ((unsigned char) var_1_5))) && ((last_1_var_1_22 > (last_1_var_1_9 / var_1_8)) ? ((! (last_1_var_1_22 >= last_1_var_1_9)) ? (var_1_6 == ((signed short int) var_1_4)) : (var_1_6 == ((signed short int) -2))) : 1)) && ((var_1_7 || var_1_10) ? ((var_1_6 < (min (var_1_5 , var_1_6))) ? ((var_1_22 < (var_1_11 - var_1_12)) ? (var_1_9 == ((float) var_1_13)) : (var_1_9 == ((float) 32.89f))) : (var_1_9 == ((float) var_1_13))) : 1)) && ((var_1_17 < (var_1_9 + var_1_11)) ? (var_1_14 == ((double) (var_1_15 - var_1_16))) : 1)) && ((var_1_7 && var_1_10) ? ((((max (var_1_4 , var_1_1)) + var_1_5) != var_1_23) ? (var_1_17 == ((float) 100.85f)) : (var_1_17 == ((float) var_1_13))) : (var_1_17 == ((float) var_1_13)))) && (((var_1_1 / var_1_19) <= 4) ? (var_1_18 == ((signed char) (var_1_5 + (max ((var_1_19 - var_1_20) , var_1_21))))) : (var_1_18 == ((signed char) (abs (var_1_21)))))) && (var_1_22 == ((double) var_1_13))) && (var_1_23 == ((unsigned long int) var_1_20))
;
}
int main(void) {
	isInitial = 1;
