...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch71Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer))) {
		(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var4_Pointer)) = (max ((max (((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)) + (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer))) , 50)) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))));
	} else {
	...
	// From: Req2Batch71Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) = (abs ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))));
	} else {
		(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) = ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) + (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)));
	}


	// From: Req3Batch71Wrapper_AP
	if ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) <= (max ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)) , ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)))))) {
