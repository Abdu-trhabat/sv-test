...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch155Amount10.c", 13, "reach_error"); }
...
// Signal variables
double var_1_1 = 8.5;
double var_1_2 = 255.8;
double var_1_3 = 256.6;
...
void step(void) {
	// From: Req1Batch155Amount10
	var_1_1 = (max (var_1_2 , var_1_3));


	// From: Req2Batch155Amount10
	if (var_1_3 == 15.6) {
		var_1_4 = (min (((var_1_5 + var_1_6) + var_1_7) , var_1_8));
	}


	// From: Req3Batch155Amount10
	var_1_9 = var_1_10;


	// From: Req4Batch155Amount10
	var_1_11 = var_1_12;
}
...
int property(void) {
	return (((var_1_1 == ((double) (max (var_1_2 , var_1_3)))) && ((var_1_3 == 15.6) ? (var_1_4 == ((unsigned short int) (min (((var_1_5 + var_1_6) + var_1_7) , var_1_8)))) : 1)) && (var_1_9 == ((unsigned char) var_1_10))) && (var_1_11 == ((unsigned char) var_1_12))
;
}
int main(void) {
	isInitial = 1;
