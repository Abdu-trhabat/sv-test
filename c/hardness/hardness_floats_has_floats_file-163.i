...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch163has_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_4 < var_1_4) {
  var_1_10 = (((((-128.0 + ((((var_1_13) > (-100.0)) ? (var_1_13) : (-100.0))))) < (var_1_14)) ? ((-128.0 + ((((var_1_13) > (-100.0)) ? (var_1_13) : (-100.0))))) : (var_1_14)));
 }
 ...
 signed long int stepLocal_3 = ((((var_1_4) > (var_1_15)) ? (var_1_4) : (var_1_15))) * var_1_1;
 unsigned char stepLocal_2 = var_1_7;
 unsigned short int stepLocal_1 = var_1_15;
 if (var_1_6 || stepLocal_2) {
  if (((((var_1_15) > (last_1_var_1_5)) ? (var_1_15) : (last_1_var_1_5))) < stepLocal_3) {
...
int property(void) {
 return ((((last_1_var_1_15 >= (last_1_var_1_5 / var_1_4)) ? (var_1_1 == ((signed long int) last_1_var_1_15)) : 1) && ((var_1_6 || var_1_7) ? ((((((var_1_15) > (last_1_var_1_5)) ? (var_1_15) : (last_1_var_1_5))) < (((((var_1_4) > (var_1_15)) ? (var_1_4) : (var_1_15))) * var_1_1)) ? ((var_1_15 >= var_1_1) ? (var_1_5 == ((unsigned long int) var_1_4)) : 1) : (var_1_5 == ((unsigned long int) var_1_15))) : (var_1_5 == ((unsigned long int) var_1_15)))) && ((((var_1_11 - var_1_12) - 32) < var_1_4) ? (var_1_10 == ((double) (((((-128.0 + ((((var_1_13) > (-100.0)) ? (var_1_13) : (-100.0))))) < (var_1_14)) ? ((-128.0 + ((((var_1_13) > (-100.0)) ? (var_1_13) : (-100.0))))) : (var_1_14))))) : 1)) && ((var_1_6 && var_1_7) ? (var_1_6 ? (var_1_7 ? ((8 > var_1_11) ? (var_1_15 == ((unsigned short int) var_1_11)) : 1) : (var_1_15 == ((unsigned short int) var_1_11))) : (var_1_15 == ((unsigned short int) var_1_11))) : (var_1_15 == ((unsigned short int) var_1_12)))
;
}
int main(void) {
 isInitial = 1;
