...
void step(void) {
 ...
 if ((*(var_1_3_Pointer)) < (((*(var_1_1_Pointer)) * (*(var_1_8_Pointer))) + (*(var_1_9_Pointer)))) {
  (*(var_1_11_Pointer)) = ((((last_1_var_1_11) < 0 ) ? -(last_1_var_1_11) : (last_1_var_1_11)));
 }
 if ((*(var_1_7_Pointer))) {
