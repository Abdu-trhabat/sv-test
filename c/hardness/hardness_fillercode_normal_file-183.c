...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch183normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_0 > var_1_3) {
		if (stepLocal_1 > last_1_var_1_20) {
			var_1_5 = last_1_var_1_20;
		}
	}


	// From: Req6Batch183normal
	...
	// From: Req1Batch183normal
	if (! var_1_2) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req3Batch183normal
...
int property(void) {
	return (((((((! var_1_2) ? (var_1_1 == ((signed char) (var_1_3 + var_1_4))) : 1) && ((last_1_var_1_20 > var_1_3) ? ((var_1_4 > last_1_var_1_20) ? (var_1_5 == ((signed long int) last_1_var_1_20)) : 1) : 1)) && (((max (var_1_7 , var_1_8)) <= var_1_9) ? (var_1_6 == ((signed short int) (min ((var_1_10 - var_1_11) , var_1_3)))) : (var_1_6 == ((signed short int) (((min (var_1_12 , var_1_13)) + (min (var_1_14 , var_1_15))) - 256))))) && (((var_1_8 * var_1_9) <= var_1_7) ? (var_1_16 == ((unsigned short int) (min ((var_1_15 + 1) , var_1_12)))) : 1)) && (var_1_2 ? (var_1_17 == ((unsigned char) (min (var_1_18 , var_1_19)))) : 1)) && ((var_1_5 <= ((var_1_14 - var_1_13) / var_1_21)) ? (var_1_20 == ((signed char) (max (((var_1_22 - var_1_23) + var_1_4) , var_1_3)))) : 1)) && (var_1_2 ? (((- var_1_7) <= (min ((var_1_25 - var_1_26) , var_1_9))) ? (var_1_24 == ((unsigned char) (min (var_1_19 , (max ((var_1_22 + var_1_23) , var_1_18)))))) : (var_1_24 == ((unsigned char) 0))) : (var_1_27 ? (var_1_24 == ((unsigned char) var_1_23)) : 1))
;
}
int main(void) {
	isInitial = 1;
