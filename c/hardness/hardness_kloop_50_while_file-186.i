...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch18650_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_4 || stepLocal_0) {
  var_1_3 = ((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6)));
 } else {
 ...
 if (var_1_4) {
  var_1_12 = ((((var_1_13) < (((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15))))) ? (var_1_13) : (((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15))))));
 } else {
...
int property(void) {
 return ((((((var_1_1 == ((signed short int) var_1_2)) && ((var_1_4 || (var_1_1 != ((((-10) < (var_1_2)) ? (-10) : (var_1_2))))) ? (var_1_3 == ((double) ((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6))))) : (var_1_3 == ((double) (var_1_7 + (128.6 + var_1_8)))))) && (((var_1_7 > ((((9.6) > (var_1_6)) ? (9.6) : (var_1_6)))) || (var_1_5 < var_1_3)) ? (var_1_9 == ((signed char) var_1_10)) : 1)) && (((var_1_17 & var_1_2) <= var_1_17) ? ((var_1_17 <= var_1_2) ? (var_1_11 == ((signed short int) var_1_2)) : 1) : 1)) && (var_1_4 ? (var_1_12 == ((unsigned char) ((((var_1_13) < (((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15))))) ? (var_1_13) : (((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15)))))))) : ((var_1_14 != var_1_2) ? (var_1_12 == ((unsigned char) (var_1_16 - 2))) : (var_1_12 == ((unsigned char) 4))))) && ((var_1_14 >= var_1_12) ? (var_1_17 == ((unsigned long int) var_1_13)) : 1)) && ((var_1_4 && ((var_1_10 > var_1_17) && var_1_19)) ? ((((var_1_20 - var_1_12) / (3761303906u - var_1_16)) == var_1_13) ? (((((((var_1_15 + var_1_17)) < (var_1_9)) ? ((var_1_15 + var_1_17)) : (var_1_9))) >= ((var_1_12 ^ var_1_17) * var_1_14)) ? (var_1_18 == ((signed short int) var_1_12)) : (var_1_18 == ((signed short int) var_1_2))) : (var_1_18 == ((signed short int) var_1_16))) : (var_1_18 == ((signed short int) var_1_2)))
;
}
int main(void) {
 isInitial = 1;
