...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch43functionizing.c", 13, "reach_error"); }
...
void functionized3(unsigned char, unsigned short int);
double functionized4(float, double);
void functionized5(signed long int, signed char);
unsigned long int functionized6(unsigned long int);
...
double functionized1(double functionized1_localFunctionVar0) {
 return ((((var_1_5) > (functionized1_localFunctionVar0)) ? (var_1_5) : (functionized1_localFunctionVar0)));
}
signed long int functionized2(void) {
 return (16 - 32);
}
void functionized3(unsigned char functionized3_localFunctionVar0, unsigned short int functionized3_localFunctionVar1) {
 if (functionized3_localFunctionVar0) {
  var_1_12 = (functionized3_localFunctionVar1 - var_1_15);
 }
}
double functionized4(float functionized4_localFunctionVar0, double functionized4_localFunctionVar1) {
 return (((((var_1_3) < (functionized4_localFunctionVar0)) ? (var_1_3) : (functionized4_localFunctionVar0))) + functionized4_localFunctionVar1);
}
void functionized5(signed long int functionized5_localFunctionVar0, signed char functionized5_localFunctionVar1) {
 if ((- (var_1_14 - var_1_24)) < functionized5_localFunctionVar0) {
  var_1_23 = (var_1_24 + (functionized5_localFunctionVar1 + 4u));
 } else {
  var_1_23 = ((((var_1_14) < (var_1_25)) ? (var_1_14) : (var_1_25)));
 }
}
unsigned long int functionized6(unsigned long int localFunctionVar0) {
 return ((((localFunctionVar0) < 0 ) ? -(localFunctionVar0) : (localFunctionVar0)));
}
void initially(void) {
}
void step(void) {
 if ((- 1000.5f) != (var_1_2 * (functionized0(var_1_4, var_1_3)))) {
  var_1_1 = functionized1(var_1_6);
 } else {
  var_1_1 = var_1_5;
 }
 ...
 if (var_1_1 > var_1_4) {
  ...
  var_1_11 = ((((var_1_7) < ((functionized2() + (64 + var_1_10)))) ? (var_1_7) : ((functionized2() + (64 + var_1_10)))));
 }
 functionized3(var_1_13, var_1_14);
 if (var_1_2 <= (functionized4(var_1_17, var_1_1))) {
 ...
 functionized5(var_1_8, var_1_22);
 if (var_1_6 != 49.125) {
  if (functionized6(64u) < var_1_9) {
   var_1_26 = var_1_15;
  }
 }
}
