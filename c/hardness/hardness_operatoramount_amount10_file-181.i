...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch181Amount10.c", 13, "reach_error"); }
...
unsigned short int var_1_5 = 31590;
...
int property(void) {
 return var_1_2 ? (var_1_3 ? (var_1_1 == ((unsigned short int) (var_1_4 + (var_1_5 - (var_1_6 + var_1_7))))) : ((var_1_7 > var_1_8) ? (var_1_1 == ((unsigned short int) var_1_4)) : (var_1_1 == ((unsigned short int) var_1_7)))) : 1
;
}
int main(void) {
 isInitial = 1;
