...
void step(void) {
	// From: Req1Batch150dependencies
	if (var_1_2 < (var_1_3 - var_1_4)) {
		var_1_1 = (var_1_5 + var_1_6);
	}


	// From: Req2Batch150dependencies
	if (var_1_8) {
	...
	// From: Req4Batch150dependencies
	if ((var_1_3 / var_1_17) >= ((var_1_1 / 16.69) * var_1_1)) {
		var_1_16 = var_1_28;
	}


	// From: Req5Batch150dependencies
	if ((- var_1_6) > var_1_3) {
	...
	// From: Req3Batch150dependencies
	if (((var_1_19 + 200) & var_1_24) != var_1_28) {
		var_1_12 = var_1_24;
	}


	// From: Req7Batch150dependencies
