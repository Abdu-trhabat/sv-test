...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch48Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	/* 358L, 241L) */ if (/* 359L, 212L, 213L) */ ((/* 360L, 206L, 214L) */ ((/* 361L, 204L, 215L) */ ((var_1_8) | (1))) % (var_1_33))) >= (/* 365L, 211L, 219L) */ ((var_1_34) << (/* 367L, 210L, 221L) */ (max (/* 367L, 210L, 221L) */ (var_1_40) , (var_1_41)))))))) {
		/* 370L, 240L) */ var_1_38 = (
			/* 373L, 239L) */ (abs (
				/* 374L, 238L) */ (abs (
					var_1_8
	...
	// From: CodeObject6
	/* 332L, 198L) */ if (/* 333L, 160L, 161L) */ ((/* 334L, 154L, 162L) */ ((var_1_34) & (var_1_13))) <= (/* 337L, 159L, 165L) */ ((/* 338L, 157L, 166L) */ ((var_1_33) - (var_1_21))) + (-16))))) {
		/* 342L, 182L) */ var_1_36 = (
			var_1_25
		);
	} else {
