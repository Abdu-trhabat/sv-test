...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch150Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch150Amount50
	if (var_1_2 < (var_1_3 - var_1_4)) {
		var_1_1 = (var_1_5 + var_1_6);
	}


	// From: Req2Batch150Amount50
	if (var_1_8) {
	...
	// From: Req4Batch150Amount50
	if ((var_1_3 / var_1_17) >= ((var_1_1 / 16.69) * var_1_1)) {
		var_1_16 = var_1_28;
	}


	// From: Req5Batch150Amount50
