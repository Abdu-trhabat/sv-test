...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch163Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_1 = var_1_1;
  ...
  var_1_32
            ...
            if ( ((var_1_29) < ( (((((var_1_30)) > ((var_1_32))) ? ((var_1_30)) : ((var_1_32))))))) {
             var_1_33 = (
   ...
   var_1_36
     ...
     64
             ...
             if ( (( ((var_1_31) / (var_1_38))) > ( (( ((var_1_42) - (var_1_40))) - (2))))) {
              var_1_41 = (
