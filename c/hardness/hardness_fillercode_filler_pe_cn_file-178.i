 ...
 signed long int stepLocal_1 = last_1_var_1_17;
                                              if ( ((stepLocal_1) <= (last_1_var_1_7))) {
                                               if ( ((stepLocal_2) < (last_1_var_1_7))) {
                                                var_1_13 = (
                                                 ((((( (( (( var_1_10 ) - ( var_1_16 )) ) + ( last_1_var_1_1 )) )) < (( var_1_14 ))) ? (( (( (( var_1_10 ) - ( var_1_16 )) ) + ( last_1_var_1_1 )) )) : (( var_1_14 ))))
   );
  }
 }
 ...
 signed long int stepLocal_0 = var_1_13;
   ...
   var_1_22
            ...
            if ( ((var_1_21) <= (-50))) {
             ...
             if ( (( ((var_1_23) & ( ((var_1_20) ^ (var_1_24))))) >= (var_1_21))) {
              if ( ((var_1_21) > (var_1_20))) {
               var_1_25 = (
                ((((( var_1_24 )) > (( (( var_1_26 ) + ( var_1_27 )) ))) ? (( var_1_24 )) : (( (( var_1_26 ) + ( var_1_27 )) ))))
   );
  }
 } else {
              var_1_25 = (
   var_1_24
     ...
     var_1_31
             ...
             if ( (( (( ((var_1_27) / (var_1_33))) | (var_1_20))) >= (var_1_21))) {
              var_1_32 = (
               ((
    var_1_34
   ) + (
     ...
     var_1_36
             ...
             if (var_1_19) {
              var_1_37 = (
               ((
                ((((( var_1_33 )) < (( var_1_26 ))) ? (( var_1_33 )) : (( var_1_26 ))))
   ) - (
                ((
     1994003362
    ) - (
    ...
    -16
             ...
             if ( ((var_1_30) || ( ((32) < ( ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))))))) {
...
int property(void) {
 ...
 if ( (( ((100) + ( ((var_1_1) / (var_1_10))))) != (var_1_13))) {
 } else {
 }
 if ( ((last_1_var_1_17) <= (last_1_var_1_7))) {
  if ( (( ((var_1_10) / ( (((((var_1_14)) < ((var_1_15))) ? ((var_1_14)) : ((var_1_15))))))) < (last_1_var_1_7))) {
  }
 }
 if ( ((var_1_10) <= ( (((((var_1_13)) > ((var_1_15))) ? ((var_1_13)) : ((var_1_15))))))) {
  if ( (( (((((var_1_13)) > ((last_1_var_1_17))) ? ((var_1_13)) : ((last_1_var_1_17))))) >= (var_1_11))) {
  } else {
  }
 } else {
 }
 return ((
    ...
    var_1_10
                                                 ...
                                                 ((((( var_1_13 )) > (( var_1_15 ))) ? (( var_1_13 )) : (( var_1_15 ))))
   ))
  ) ? (
                                          ((
                                                 ((
                                                  ((((( var_1_13 )) > (( last_1_var_1_17 ))) ? (( var_1_13 )) : (( last_1_var_1_17 ))))
    ) >= (
     var_1_11
    ))
   ) ? (
