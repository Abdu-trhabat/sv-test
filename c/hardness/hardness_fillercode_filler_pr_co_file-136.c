...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch136Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	/* 258L, 77L) */ if (/* 259L, 60L, 61L) */ ((var_1_12) <= (var_1_33))) {
		/* 262L, 76L) */ var_1_34 = (
			/* 265L, 75L) */ (min (
				/* 265L, 75L) */ (
					/* 266L, 73L) */ ((
	...
	// From: CodeObject6
	/* 299L, 158L) */ if (/* 300L, 121L, 122L) */ ((var_1_44) <= (var_1_8))) {
		/* 303L, 135L) */ var_1_46 = (
			/* 306L, 134L) */ (min (
				/* 306L, 134L) */ (
					/* 307L, 132L) */ (min (
		...
		/* 311L, 156L) */ if (/* 312L, 138L, 139L) */ ((var_1_45) >= (var_1_8))) {
			/* 315L, 150L) */ var_1_46 = (
				/* 318L, 149L) */ ((
					-5
				) + (
	...
	// From: CodeObject2
	/* 244L, 54L) */ if (/* 245L, 35L, 36L) */ ((/* 246L, 33L, 37L) */ ((var_1_20) >> (var_1_32))) < (var_1_12))) {
		/* 250L, 53L) */ var_1_31 = (
			/* 253L, 52L) */ (max (
				/* 253L, 52L) */ (
					/* 254L, 50L) */ (min (
