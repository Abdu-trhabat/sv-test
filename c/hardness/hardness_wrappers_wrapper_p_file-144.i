...
void step(void) {
 if (((((last_1_var_1_16) < 0 ) ? -(last_1_var_1_16) : (last_1_var_1_16))) <= ((*(var_1_14_Pointer)) / (((((*(var_1_17_Pointer))) > (-1)) ? ((*(var_1_17_Pointer))) : (-1))))) {
  if ((*(var_1_5_Pointer))) {
 ...
 if (((*(var_1_16_Pointer)) / 200) <= stepLocal_1) {
  if (((((((*(var_1_9_Pointer)) * (*(var_1_10_Pointer)))) < ((*(var_1_11_Pointer)))) ? (((*(var_1_9_Pointer)) * (*(var_1_10_Pointer)))) : ((*(var_1_11_Pointer))))) != 16.5f) {
   (*(var_1_8_Pointer)) = 4.4;
  }
 } else {
