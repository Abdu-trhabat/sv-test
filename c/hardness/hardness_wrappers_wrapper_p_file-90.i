...
void step(void) {
 ...
 if (! (*(var_1_2_Pointer))) {
  if (((((((*(var_1_12_Pointer))) > ((*(var_1_13_Pointer)))) ? ((*(var_1_12_Pointer))) : ((*(var_1_13_Pointer))))) - (*(var_1_14_Pointer))) >= (- (32.25 * (*(var_1_15_Pointer))))) {
   if ((*(var_1_2_Pointer))) {
 ...
 if (stepLocal_0 != (((((*(var_1_3_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_5_Pointer)))))) {
