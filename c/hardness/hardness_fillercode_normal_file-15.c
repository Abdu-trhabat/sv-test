...
void step(void) {
	...
	// From: Req2Batch15normal
	var_1_10 = var_1_11;


	// From: Req5Batch15normal
	if (! var_1_2) {
		var_1_19 = ((min (var_1_7 , var_1_9)) + var_1_20);
	}


	// From: Req6Batch15normal
	if (var_1_18) {
		var_1_21 = ((max (3346787891u , var_1_22)) - var_1_7);
	}


	// From: Req7Batch15normal
	if (-1 < var_1_6) {
