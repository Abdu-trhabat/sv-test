...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch176Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch176Amount100
	if (var_1_29) {
		var_1_9 = (var_1_8 + var_1_7);
	}


	// From: Req10Batch176Amount100
	...
	// From: Req2Batch176Amount100
	var_1_6 = ((64 - (var_1_7 - var_1_8)) + var_1_5);


	// From: Req4Batch176Amount100
	if (50 < var_1_9) {
		var_1_11 = var_1_8;
	}


	// From: Req5Batch176Amount100
	if (var_1_3 < var_1_2) {
		var_1_12 = var_1_8;
	}


	// From: Req11Batch176Amount100
	...
	// From: Req1Batch176Amount100
	if (! ((var_1_2 - var_1_3) < var_1_22)) {
		var_1_1 = (128 - var_1_5);
	}


	// From: Req8Batch176Amount100
