...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch157has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch157has_floats
	var_1_14 = (((abs (-1.0f)) + (var_1_15 + var_1_16)) - (min (64.0f , var_1_17)));


	// From: Req1Batch157has_floats
	signed long int stepLocal_1 = 128;
	signed long int stepLocal_0 = var_1_3;
	if (stepLocal_1 <= (max ((var_1_2 - var_1_3) , var_1_8))) {
...
int property(void) {
	return (((128 <= (max ((var_1_2 - var_1_3) , var_1_8))) ? ((var_1_3 <= (var_1_2 / var_1_5)) ? (var_1_6 ? (var_1_1 == ((signed long int) 10)) : (var_1_1 == ((signed long int) var_1_7))) : (var_1_1 == ((signed long int) var_1_7))) : (var_1_1 == ((signed long int) var_1_7))) && (((var_1_9 + var_1_10) >= (var_1_11 * var_1_12)) ? (var_1_8 == ((signed long int) var_1_7)) : ((! var_1_6) ? ((var_1_7 == var_1_2) ? (var_1_8 == ((signed long int) var_1_7)) : (var_1_8 == ((signed long int) var_1_13))) : (var_1_8 == ((signed long int) var_1_13))))) && (var_1_14 == ((float) (((abs (-1.0f)) + (var_1_15 + var_1_16)) - (min (64.0f , var_1_17)))))
;
}
int main(void) {
	isInitial = 1;
