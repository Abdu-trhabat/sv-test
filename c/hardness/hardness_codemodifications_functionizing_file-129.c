...
float functionized1(void) {
	return ((max (var_1_7 , var_1_8)) - 32.4f);
}
...
void functionized3(signed long int functionized3_localFunctionVar0, signed long int functionized3_localFunctionVar1, unsigned long int functionized3_localFunctionVar2, unsigned long int functionized3_localFunctionVar3, signed short int functionized3_localFunctionVar4) {
	if ((functionized3_localFunctionVar1 ^ functionized3_localFunctionVar2) >= (functionized3_localFunctionVar3 | var_1_12)) {
		if (functionized3_localFunctionVar1 != (~ functionized3_localFunctionVar0)) {
			var_1_13 = (var_1_14 + (max (functionized3_localFunctionVar4 , var_1_16)));
		} else {
			var_1_13 = var_1_14;
		}
	}
...
void step(void) {
	// From: Req1Batch129functionizing
	...
	// From: Req7Batch129functionizing
	if (-8 < var_1_13) {
...
int property(void) {
	return ((((((((var_1_2 ^ var_1_3) != var_1_4) ? (var_1_1 == ((float) (var_1_5 + var_1_6))) : (var_1_1 == ((float) ((max (var_1_7 , var_1_8)) - 32.4f)))) && ((((var_1_10 - var_1_11) - var_1_12) < var_1_2) ? (var_1_9 == ((float) var_1_8)) : 1)) && (((var_1_10 ^ var_1_2) >= (var_1_4 | var_1_12)) ? ((var_1_10 != (~ var_1_11)) ? (var_1_13 == ((signed short int) (var_1_14 + (max (var_1_15 , var_1_16))))) : (var_1_13 == ((signed short int) var_1_14))) : 1)) && ((! var_1_18) ? (var_1_17 == ((unsigned char) var_1_19)) : (var_1_17 == ((unsigned char) ((! var_1_19) && var_1_20))))) && (var_1_21 == ((double) (1.000000005E8 - (7.46417232161781E18 - var_1_22))))) && ((var_1_18 || var_1_19) ? (((var_1_24 - 16) >= var_1_14) ? ((var_1_2 < var_1_4) ? (var_1_23 == ((unsigned char) var_1_25)) : 1) : (var_1_23 == ((unsigned char) var_1_25))) : (var_1_23 == ((unsigned char) var_1_25)))) && ((-8 < var_1_13) ? (var_1_26 == ((double) (max (var_1_22 , (max (var_1_8 , (var_1_7 - var_1_27))))))) : (var_1_26 == ((double) var_1_8)))
;
}
int main(void) {
	isInitial = 1;
