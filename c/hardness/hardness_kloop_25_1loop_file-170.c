...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17025_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch17025_1loop
	if (var_1_4) {
		var_1_10 = (var_1_8 - var_1_7);
	}


	// From: Req1Batch17025_1loop
