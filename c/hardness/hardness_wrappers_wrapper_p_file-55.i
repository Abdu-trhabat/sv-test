...
void step(void) {
 ...
 if (stepLocal_3 <= (((((16 >> (*(var_1_13_Pointer)))) < (last_1_var_1_12)) ? ((16 >> (*(var_1_13_Pointer)))) : (last_1_var_1_12)))) {
 ...
 if ((*(var_1_2_Pointer))) {
  if (stepLocal_1 && (*(var_1_5_Pointer))) {
   if (stepLocal_0 >= (*(var_1_4_Pointer))) {
    ...
    (*(var_1_1_Pointer)) = ((((25) < ((*(var_1_6_Pointer)))) ? (25) : ((*(var_1_6_Pointer)))));
   }
  }
 } else {
...
int property(void) {
 return ((((((*(var_1_2_Pointer)) ? ((((*(var_1_3_Pointer)) >= (*(var_1_4_Pointer))) && (*(var_1_5_Pointer))) ? (((*(var_1_3_Pointer)) >= (*(var_1_4_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) 5)) : ((*(var_1_1_Pointer)) == ((unsigned short int) ((((25) < ((*(var_1_6_Pointer)))) ? (25) : ((*(var_1_6_Pointer)))))))) : 1) : ((*(var_1_1_Pointer)) == ((unsigned short int) (*(var_1_6_Pointer))))) && ((*(var_1_2_Pointer)) ? ((*(var_1_7_Pointer)) == ((double) ((((*(var_1_8_Pointer)) + (*(var_1_9_Pointer))) + (*(var_1_10_Pointer))) - (*(var_1_11_Pointer))))) : 1)) && (((~ (*(var_1_6_Pointer))) <= (((((16 >> (*(var_1_13_Pointer)))) < (last_1_var_1_12)) ? ((16 >> (*(var_1_13_Pointer)))) : (last_1_var_1_12)))) ? ((((*(var_1_15_Pointer)) - (*(var_1_13_Pointer))) < (last_1_var_1_1 / -8)) ? ((*(var_1_12_Pointer)) == ((signed long int) last_1_var_1_1)) : 1) : ((*(var_1_12_Pointer)) == ((signed long int) (last_1_var_1_17 - (*(var_1_13_Pointer))))))) && ((*(var_1_16_Pointer)) == ((float) (*(var_1_8_Pointer))))) && ((*(var_1_17_Pointer)) == ((unsigned long int) (*(var_1_12_Pointer))))) && ((*(var_1_18_Pointer)) == ((unsigned char) (*(var_1_13_Pointer))))
;
}
int main(void) {
 isInitial = 1;
