...
void step(void) {
	...
	// From: CodeObject8
	/* 351L, 225L) */ if (/* 352L, 198L, 199L) */ ((var_1_47) > (/* 354L, 197L, 201L) */ (min (/* 354L, 197L, 201L) */ (/* 355L, 193L, 202L) */ (max (/* 355L, 193L, 202L) */ (var_1_25) , (var_1_5)))) , (/* 358L, 196L, 205L) */ ((var_1_26) - (var_1_24)))))))) {
		/* 361L, 224L) */ var_1_49 = (
			/* 364L, 223L) */ (min (
				/* 364L, 223L) */ (
					/* 365L, 221L) */ (max (
	...
	// From: CodeObject7
	/* 332L, 184L) */ if (/* 333L, 159L, 160L) */ ((-128) <= (var_1_18))) {
		/* 336L, 173L) */ if (var_1_8) {
			/* 338L, 172L) */ var_1_45 = (
				var_1_5
			);
		}
	...
	// From: CodeObject3
	/* 270L, 88L) */ if (/* 271L, 42L, 43L) */ ((/* 272L, 36L, 44L) */ ((var_1_15) % (var_1_36))) < (/* 275L, 41L, 47L) */ ((/* 276L, 39L, 48L) */ (min (/* 276L, 39L, 48L) */ (var_1_12) , (var_1_11)))) - (var_1_18))))) {
		/* 280L, 86L) */ if (/* 281L, 63L, 64L) */ ((-10) > (var_1_15))) {
			/* 284L, 73L) */ var_1_35 = (
				var_1_9
			);
		} else {
	...
	// From: CodeObject4
	/* 292L, 122L) */ if (/* 293L, 98L, 99L) */ ((/* 294L, 96L, 100L) */ ((var_1_12) / (/* 296L, 95L, 102L) */ (max (/* 296L, 95L, 102L) */ (var_1_36) , (2)))))) > (var_1_9))) {
		/* 300L, 121L) */ var_1_39 = (
			/* 303L, 120L) */ ((
				/* 304L, 118L) */ ((
					4
	...
	// From: CodeObject1
	/* 252L, 20L) */ if (/* 253L, 4L, 5L) */ ((var_1_19) > (var_1_15))) {
		/* 256L, 14L) */ var_1_30 = (
			var_1_12
		);
	} else {
