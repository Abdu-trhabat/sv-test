...
void step(void) {
	...
	if (stepLocal_1 == (max (10 , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))) {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer))) {
			...
			if ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) >= (abs ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))))) {
