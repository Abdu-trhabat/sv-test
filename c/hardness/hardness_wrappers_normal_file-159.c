...
void step(void) {
	...
	if (((var_1_8 - var_1_9) / var_1_10) < var_1_11) {
		if ((min (var_1_3 , var_1_12)) < var_1_13) {
			if (var_1_4) {
				var_1_7 = (min (var_1_14 , 1));
			}
		}
	}
