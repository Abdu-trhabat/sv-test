...
void step(void) {
	// From: Req1Batch165Wrapper_A
	if (float_Array_0[0][1][1] >= (float_Array_0[1][0][1] + float_Array_0[0][0][1])) {
		float_Array_0[1][1][1] = (max (float_Array_0[1][1][0] , ((float_Array_0[0][1][0] - float_Array_0[1][0][0]) + (float_Array_0[0][0][0] - 200.2f))));
	} else {
		float_Array_0[1][1][1] = float_Array_0[1][0][0];
	}


	// From: Req2Batch165Wrapper_A
	if (BOOL_unsigned_char_Array_0[0] && BOOL_unsigned_char_Array_0[1]) {
		...
		signed_short_int_Array_0[1][0] = (min (signed_short_int_Array_0[2][0] , (signed_short_int_Array_0[0][0] + signed_short_int_Array_0[2][1])));
	}


	// From: Req3Batch165Wrapper_A
	if (BOOL_unsigned_char_Array_0[0]) {
		signed_short_int_Array_0[0][2] = ((max (signed_short_int_Array_0[0][1] , (signed_short_int_Array_0[1][1] - signed_short_int_Array_0[1][2]))) + (signed_short_int_Array_0[2][2] - 100));
	}


	// From: Req4Batch165Wrapper_A
	if (BOOL_unsigned_char_Array_0[0]) {
		unsigned_short_int_Array_0[0][0] = (unsigned_short_int_Array_0[0][1] - (unsigned_short_int_Array_0[1][1] - (max (signed_short_int_Array_0[2][2] , signed_short_int_Array_0[1][2]))));
	} else {
...
int property(void) {
	return ((((float_Array_0[0][1][1] >= (float_Array_0[1][0][1] + float_Array_0[0][0][1])) ? (float_Array_0[1][1][1] == ((float) (max (float_Array_0[1][1][0] , ((float_Array_0[0][1][0] - float_Array_0[1][0][0]) + (float_Array_0[0][0][0] - 200.2f)))))) : (float_Array_0[1][1][1] == ((float) float_Array_0[1][0][0]))) && ((BOOL_unsigned_char_Array_0[0] && BOOL_unsigned_char_Array_0[1]) ? (signed_short_int_Array_0[1][0] == ((signed short int) (signed_short_int_Array_0[0][0] + signed_short_int_Array_0[2][0]))) : (signed_short_int_Array_0[1][0] == ((signed short int) (min (signed_short_int_Array_0[2][0] , (signed_short_int_Array_0[0][0] + signed_short_int_Array_0[2][1]))))))) && (BOOL_unsigned_char_Array_0[0] ? (signed_short_int_Array_0[0][2] == ((signed short int) ((max (signed_short_int_Array_0[0][1] , (signed_short_int_Array_0[1][1] - signed_short_int_Array_0[1][2]))) + (signed_short_int_Array_0[2][2] - 100)))) : 1)) && (BOOL_unsigned_char_Array_0[0] ? (unsigned_short_int_Array_0[0][0] == ((unsigned short int) (unsigned_short_int_Array_0[0][1] - (unsigned_short_int_Array_0[1][1] - (max (signed_short_int_Array_0[2][2] , signed_short_int_Array_0[1][2])))))) : (unsigned_short_int_Array_0[0][0] == ((unsigned short int) ((unsigned_short_int_Array_0[1][0] - signed_short_int_Array_0[1][2]) - signed_short_int_Array_0[1][1]))))
;
}
int main(void) {
	isInitial = 1;
