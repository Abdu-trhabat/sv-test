...
void step(void) {
 ...
 if (var_1_7 && var_1_10) {
  if ((((((var_1_4) > (var_1_1)) ? (var_1_4) : (var_1_1))) + var_1_5) != var_1_6) {
   var_1_17 = 100.85f;
  } else {
   var_1_17 = var_1_13;
  }
...
int property(void) {
 return ((((((((var_1_2 != var_1_3) ? (var_1_1 == ((unsigned char) ((var_1_4 - var_1_5) - 10))) : (var_1_1 == ((unsigned char) var_1_5))) && ((var_1_2 > (var_1_3 / var_1_8)) ? ((! (var_1_2 >= var_1_3)) ? (var_1_6 == ((signed short int) var_1_4)) : (var_1_6 == ((signed short int) -2))) : 1)) && ((var_1_7 || var_1_10) ? ((var_1_6 < ((((var_1_5) < (var_1_1)) ? (var_1_5) : (var_1_1)))) ? ((var_1_3 < (var_1_11 - var_1_12)) ? (var_1_9 == ((float) var_1_13)) : (var_1_9 == ((float) 32.89f))) : (var_1_9 == ((float) var_1_13))) : 1)) && ((var_1_3 < (var_1_9 + var_1_11)) ? (var_1_14 == ((double) (var_1_15 - var_1_16))) : 1)) && ((var_1_7 && var_1_10) ? (((((((var_1_4) > (var_1_1)) ? (var_1_4) : (var_1_1))) + var_1_5) != var_1_6) ? (var_1_17 == ((float) 100.85f)) : (var_1_17 == ((float) var_1_13))) : (var_1_17 == ((float) var_1_13)))) && (((var_1_1 / var_1_19) <= 4) ? (var_1_18 == ((signed char) (var_1_5 + (((((var_1_19 - var_1_20)) > (var_1_21)) ? ((var_1_19 - var_1_20)) : (var_1_21)))))) : (var_1_18 == ((signed char) ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))))))) && (var_1_22 == ((double) var_1_13))) && (var_1_23 == ((unsigned long int) var_1_20))
;
}
int main(void) {
 isInitial = 1;
