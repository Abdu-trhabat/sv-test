...
void step(void) {
	...
	if (stepLocal_1 && var_1_3) {
		if ((max ((abs (var_1_4)) , var_1_9)) < stepLocal_0) {
			var_1_1 = (var_1_6 - var_1_7);
		} else {
			if (var_1_3) {
				var_1_1 = (max ((max ((var_1_4 + var_1_9) , var_1_7)) , (max (var_1_6 , var_1_8))));
			} else {
				var_1_1 = 4;
			}
		}
...
int property(void) {
	return (((var_1_2 && var_1_3) ? (((max ((abs (var_1_4)) , var_1_9)) < (-5 * -8)) ? (var_1_1 == ((signed long int) (var_1_6 - var_1_7))) : (var_1_3 ? (var_1_1 == ((signed long int) (max ((max ((var_1_4 + var_1_9) , var_1_7)) , (max (var_1_6 , var_1_8)))))) : (var_1_1 == ((signed long int) 4)))) : 1) && (((- 256.5f) > (var_1_10 - var_1_11)) ? ((var_1_11 >= var_1_10) ? (var_1_9 == ((signed char) var_1_12)) : 1) : (var_1_9 == ((signed char) var_1_12)))) && ((var_1_8 >= var_1_12) ? (var_1_13 == ((float) var_1_14)) : (var_1_13 == ((float) (var_1_15 + (var_1_16 - 2.6f)))))
;
}
int main(void) {
	isInitial = 1;
