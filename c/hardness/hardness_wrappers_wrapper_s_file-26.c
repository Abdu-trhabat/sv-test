...
void step(void) {
	...
	if (WrapperStruct00.var_1_2 > WrapperStruct00.var_1_3) {
		WrapperStruct00.var_1_1 = (max (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5));
	} else {
		WrapperStruct00.var_1_1 = (min ((WrapperStruct00.var_1_6 - (max (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_8))) , (WrapperStruct00.var_1_9 + (min (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_11)))));
	}
	...
	if ((- WrapperStruct00.var_1_8) >= (WrapperStruct00.var_1_4 / (abs (-4)))) {
	...
	if ((WrapperStruct00.var_1_5 + (WrapperStruct00.var_1_11 + WrapperStruct00.var_1_15)) != stepLocal_0) {
		WrapperStruct00.var_1_17 = ((min (10u , (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_8))) + WrapperStruct00.var_1_7);
	}
...
int property(void) {
	return (((((WrapperStruct00.var_1_2 > WrapperStruct00.var_1_3) ? (WrapperStruct00.var_1_1 == ((signed short int) (max (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5)))) : (WrapperStruct00.var_1_1 == ((signed short int) (min ((WrapperStruct00.var_1_6 - (max (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_8))) , (WrapperStruct00.var_1_9 + (min (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_11)))))))) && (WrapperStruct00.var_1_12 == ((float) ((0.85f - WrapperStruct00.var_1_13) + WrapperStruct00.var_1_14)))) && (((- WrapperStruct00.var_1_8) >= (WrapperStruct00.var_1_4 / (abs (-4)))) ? (WrapperStruct00.var_1_15 == ((unsigned char) WrapperStruct00.var_1_16)) : 1)) && (((WrapperStruct00.var_1_5 + (WrapperStruct00.var_1_11 + WrapperStruct00.var_1_15)) != (WrapperStruct00.var_1_7 * (WrapperStruct00.var_1_1 / WrapperStruct00.var_1_19))) ? (WrapperStruct00.var_1_17 == ((unsigned long int) ((min (10u , (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_8))) + WrapperStruct00.var_1_7))) : 1)) && (WrapperStruct00.var_1_20 == ((float) WrapperStruct00.var_1_13))
;
}
int main(void) {
	isInitial = 1;
