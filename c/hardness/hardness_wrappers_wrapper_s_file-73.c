...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch73Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned char stepLocal_1 = (~ WrapperStruct00.var_1_13) <= WrapperStruct00.var_1_11;
	if (WrapperStruct00.var_1_6 && stepLocal_2) {
		WrapperStruct00.var_1_8 = (min (WrapperStruct00.var_1_10 , ((min (64 , WrapperStruct00.var_1_11)) - (WrapperStruct00.var_1_12 + WrapperStruct00.var_1_13))));
	} else {
		if (stepLocal_1 && WrapperStruct00.var_1_6) {
			WrapperStruct00.var_1_8 = WrapperStruct00.var_1_11;
		} else {
			WrapperStruct00.var_1_8 = 32;
		}
	}


	// From: Req3Batch73Wrapper_S
	unsigned char stepLocal_3 = WrapperStruct00.var_1_11 >= WrapperStruct00.var_1_2;
	if ((WrapperStruct00.var_1_13 <= WrapperStruct00.var_1_12) || stepLocal_3) {
		WrapperStruct00.var_1_14 = (min (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_15));
	} else {
	...
	WrapperStruct00.var_1_18 = WrapperStruct00.var_1_7;


	// From: Req1Batch73Wrapper_S
	unsigned long int stepLocal_0 = max (WrapperStruct00.var_1_3 , (WrapperStruct00.var_1_4 + WrapperStruct00.var_1_5));
	if (WrapperStruct00.var_1_2 <= stepLocal_0) {
		if (! WrapperStruct00.var_1_16) {
			WrapperStruct00.var_1_1 = WrapperStruct00.var_1_7;
		} else {
			WrapperStruct00.var_1_1 = 255.375;
		}
	}
}
...
int property(void) {
	return (((((WrapperStruct00.var_1_2 <= (max (WrapperStruct00.var_1_3 , (WrapperStruct00.var_1_4 + WrapperStruct00.var_1_5)))) ? ((! WrapperStruct00.var_1_16) ? (WrapperStruct00.var_1_1 == ((double) WrapperStruct00.var_1_7)) : (WrapperStruct00.var_1_1 == ((double) 255.375))) : 1) && ((WrapperStruct00.var_1_6 && WrapperStruct00.var_1_9) ? (WrapperStruct00.var_1_8 == ((signed long int) (min (WrapperStruct00.var_1_10 , ((min (64 , WrapperStruct00.var_1_11)) - (WrapperStruct00.var_1_12 + WrapperStruct00.var_1_13)))))) : ((((~ WrapperStruct00.var_1_13) <= WrapperStruct00.var_1_11) && WrapperStruct00.var_1_6) ? (WrapperStruct00.var_1_8 == ((signed long int) WrapperStruct00.var_1_11)) : (WrapperStruct00.var_1_8 == ((signed long int) 32))))) && (((WrapperStruct00.var_1_13 <= WrapperStruct00.var_1_12) || (WrapperStruct00.var_1_11 >= WrapperStruct00.var_1_2)) ? (WrapperStruct00.var_1_14 == ((float) (min (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_15)))) : (WrapperStruct00.var_1_14 == ((float) WrapperStruct00.var_1_7)))) && (WrapperStruct00.var_1_16 == ((unsigned char) WrapperStruct00.var_1_17))) && (WrapperStruct00.var_1_18 == ((double) WrapperStruct00.var_1_7))
;
}
int main(void) {
	isInitial = 1;
