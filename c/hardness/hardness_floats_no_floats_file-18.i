...
void step(void) {
 signed long int stepLocal_2 = (((var_1_2) < (var_1_8)) ? (var_1_2) : (var_1_8));
...
int property(void) {
 return ((((var_1_11 < var_1_7) ? (var_1_1 == ((signed long int) var_1_4)) : (var_1_1 == ((signed long int) (var_1_5 + (var_1_6 - 5))))) && (((var_1_3 * var_1_2) != var_1_8) ? ((64 <= ((((var_1_2) < (var_1_8)) ? (var_1_2) : (var_1_8)))) ? (var_1_7 == ((unsigned short int) ((((var_1_9) > (var_1_10)) ? (var_1_9) : (var_1_10))))) : (var_1_7 == ((unsigned short int) var_1_9))) : (var_1_7 == ((unsigned short int) 200)))) && (var_1_12 ? (var_1_11 == ((unsigned long int) (var_1_10 + var_1_9))) : ((last_1_var_1_11 <= var_1_7) ? (var_1_11 == ((unsigned long int) var_1_9)) : (var_1_11 == ((unsigned long int) var_1_7))))) && ((var_1_10 >= var_1_11) ? ((var_1_10 <= (var_1_7 + var_1_8)) ? (var_1_13 == ((signed long int) (var_1_6 - var_1_14))) : 1) : (var_1_13 == ((signed long int) var_1_6)))
;
}
int main(void) {
 isInitial = 1;
