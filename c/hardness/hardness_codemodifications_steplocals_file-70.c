...
void step(void) {
	// From: Req1Batch70stepLocals
	unsigned char stepLocal_0 = var_1_3;
	if (stepLocal_0 >= (- (min (var_1_4 , var_1_5)))) {
	...
	// From: Req3Batch70stepLocals
	var_1_11 = (var_1_3 + ((min (var_1_9 , var_1_4)) + 2u));


	// From: Req4Batch70stepLocals
	if (var_1_2) {
		var_1_12 = var_1_13;
	}


	// From: Req5Batch70stepLocals
