...
void step(void) {
	...
	// From: Req3Batch176Amount250
	if (var_1_31) {
		var_1_9 = (var_1_8 + var_1_7);
	}


	// From: Req7Batch176Amount250
	unsigned long int stepLocal_0 = var_1_14 - last_1_var_1_46;
	if ((max (last_1_var_1_19 , last_1_var_1_46)) == stepLocal_0) {
	...
	if (last_1_var_1_40 > var_1_37) {
		if (var_1_36 < var_1_5) {
			...
			var_1_46 = (min ((min ((max (var_1_8 , last_1_var_1_12)) , var_1_48)) , 2u));
		}
	}


	// From: Req9Batch176Amount250
	...
	// From: Req4Batch176Amount250
	if (50 < var_1_19) {
		var_1_11 = var_1_8;
	}


	// From: Req26Batch176Amount250
	if (2u <= var_1_19) {
		var_1_55 = (max (var_1_23 , (max (var_1_30 , var_1_28))));
	} else {
	...
	// From: Req2Batch176Amount250
	var_1_6 = ((64 - (var_1_7 - var_1_8)) + var_1_5);


	// From: Req5Batch176Amount250
	if (var_1_3 < var_1_2) {
		var_1_12 = var_1_8;
	}


	// From: Req8Batch176Amount250
	if (9999999.4f >= (var_1_3 / var_1_18)) {
		if (var_1_15) {
			var_1_17 = (max (var_1_7 , var_1_8));
		}
	} else {
	...
	// From: Req18Batch176Amount250
	if (var_1_15 && var_1_32) {
		var_1_42 = (abs (var_1_27));
	}


	// From: Req22Batch176Amount250
	var_1_51 = var_1_38;


	// From: Req23Batch176Amount250
	if (var_1_33) {
		var_1_52 = var_1_36;
	} else {
		var_1_52 = 0;
	...
	// From: Req24Batch176Amount250
	var_1_53 = var_1_29;


	// From: Req25Batch176Amount250
	var_1_54 = var_1_48;


	// From: Req19Batch176Amount250
	signed long int stepLocal_20 = 50 / (max (var_1_36 , var_1_7));
	unsigned long int stepLocal_19 = var_1_19;
	if (! var_1_32) {
		if (var_1_14 < stepLocal_20) {
			if (var_1_15) {
				if (var_1_5 < stepLocal_19) {
					var_1_43 = (var_1_44 - (abs (var_1_45 - var_1_38)));
				}
			} else {
				var_1_43 = 32u;
			}
	...
	// From: Req1Batch176Amount250
	if (! ((var_1_2 - var_1_3) < var_1_55)) {
		var_1_1 = (128 - var_1_5);
	}


	// From: Req15Batch176Amount250
	...
	if (stepLocal_10 != var_1_46) {
		...
		if (4.6 > var_1_2) {
			if (stepLocal_13 || (var_1_8 < var_1_1)) {
				if (var_1_30 >= (max (var_1_24 , var_1_18))) {
				...
				if (stepLocal_12 > (var_1_6 / var_1_27)) {
					...
					var_1_35 = ((max (16 , (var_1_36 - var_1_8))) - ((var_1_7 - var_1_37) + var_1_38));
				}
			}
		} else {
			if (stepLocal_11 != var_1_36) {
				var_1_35 = (max (var_1_36 , var_1_7));
			} else {
				var_1_35 = (min ((max (100 , var_1_7)) , 0));
			}
		}
	}


	// From: Req21Batch176Amount250
	unsigned long int stepLocal_21 = var_1_54 + (max (var_1_43 , var_1_44));
	if ((var_1_19 % var_1_50) >= stepLocal_21) {
		var_1_49 = (50 - (max (var_1_5 , var_1_27)));
	} else {
		var_1_49 = var_1_1;
	}


	// From: Req11Batch176Amount250
	...
	// From: Req14Batch176Amount250
	unsigned long int stepLocal_9 = max ((128 * var_1_46) , -2);
	...
	// From: Req6Batch176Amount250
	if (var_1_5 <= var_1_34) {
		if (var_1_15) {
			var_1_13 = (var_1_14 - (max (var_1_8 , last_1_var_1_13)));
		} else {
			var_1_13 = (min ((var_1_14 - last_1_var_1_13) , ((max (var_1_7 , var_1_49)) + var_1_5)));
		}
	} else {
		var_1_13 = var_1_14;
	}
	...
	if ((min (var_1_6 , (last_1_var_1_40 + var_1_6))) <= stepLocal_18) {
		if (((var_1_27 - var_1_37) * 25) < stepLocal_17) {
			var_1_40 = (max (var_1_14 , (max (var_1_34 , var_1_46))));
		} else {
			if (stepLocal_16 && var_1_10) {
				...
				var_1_40 = (var_1_54 + (max (var_1_36 , (abs (var_1_19)))));
			}
		}
	}


	// From: Req12Batch176Amount250
	...
	if (stepLocal_7 != (var_1_27 - 8)) {
		if (stepLocal_6 && var_1_31) {
			...
			if (stepLocal_5 > var_1_5) {
				var_1_26 = (((min (var_1_28 , var_1_29)) + var_1_30) + var_1_24);
			}
		}
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((((! ((var_1_2 - var_1_3) < var_1_55)) ? (var_1_1 == ((unsigned char) (128 - var_1_5))) : 1) && (var_1_6 == ((unsigned char) ((64 - (var_1_7 - var_1_8)) + var_1_5)))) && (var_1_31 ? (var_1_9 == ((unsigned char) (var_1_8 + var_1_7))) : 1)) && ((50 < var_1_19) ? (var_1_11 == ((unsigned char) var_1_8)) : 1)) && ((var_1_3 < var_1_2) ? (var_1_12 == ((unsigned char) var_1_8)) : 1)) && ((var_1_5 <= var_1_34) ? (var_1_15 ? (var_1_13 == ((unsigned short int) (var_1_14 - (max (var_1_8 , last_1_var_1_13))))) : (var_1_13 == ((unsigned short int) (min ((var_1_14 - last_1_var_1_13) , ((max (var_1_7 , var_1_49)) + var_1_5)))))) : (var_1_13 == ((unsigned short int) var_1_14)))) && (((max (last_1_var_1_19 , last_1_var_1_46)) == (var_1_14 - last_1_var_1_46)) ? (var_1_15 == ((unsigned char) (last_1_var_1_31 && var_1_16))) : (var_1_15 == ((unsigned char) (! (! var_1_16)))))) && ((9999999.4f >= (var_1_3 / var_1_18)) ? (var_1_15 ? (var_1_17 == ((signed char) (max (var_1_7 , var_1_8)))) : 1) : (var_1_17 == ((signed char) (var_1_8 - var_1_7))))) && (((last_1_var_1_1 * var_1_8) <= (last_1_var_1_40 ^ (last_1_var_1_11 / var_1_14))) ? (var_1_19 == ((unsigned long int) (last_1_var_1_11 + last_1_var_1_1))) : (var_1_19 == ((unsigned long int) last_1_var_1_1)))) && (((- var_1_3) > var_1_18) ? (var_1_20 == ((signed long int) (var_1_21 + (min (var_1_49 , (var_1_34 - var_1_11)))))) : ((var_1_51 <= var_1_34) ? ((((var_1_11 * var_1_43) >= var_1_34) || ((-64 + var_1_49) > var_1_34)) ? (var_1_20 == ((signed long int) ((abs (var_1_42)) + var_1_7))) : 1) : 1))) && (((var_1_19 + var_1_49) <= var_1_43) ? (var_1_22 == ((double) 1.2)) : (var_1_22 == ((double) ((var_1_23 - var_1_24) + var_1_25))))) && ((var_1_8 != (var_1_27 - 8)) ? ((var_1_16 && var_1_31) ? (var_1_26 == ((float) (var_1_25 + var_1_23))) : (((var_1_40 - var_1_54) > var_1_5) ? (var_1_26 == ((float) (((min (var_1_28 , var_1_29)) + var_1_30) + var_1_24))) : 1)) : 1)) && ((last_1_var_1_19 > last_1_var_1_40) ? (var_1_31 == ((unsigned char) (! var_1_32))) : (var_1_31 == ((unsigned char) (var_1_32 && var_1_33))))) && (((var_1_7 - var_1_49) > (max ((128 * var_1_46) , -2))) ? (var_1_34 == ((signed long int) (var_1_9 - var_1_27))) : (var_1_34 == ((signed long int) (var_1_49 + (4 + (128 - var_1_5))))))) && ((var_1_12 != var_1_46) ? (var_1_35 == ((signed char) var_1_7)) : ((4.6 > var_1_2) ? ((var_1_33 || (var_1_8 < var_1_1)) ? ((var_1_30 >= (max (var_1_24 , var_1_18))) ? (var_1_35 == ((signed char) (abs (var_1_8)))) : (var_1_35 == ((signed char) (var_1_7 - var_1_8)))) : ((var_1_51 > (var_1_6 / var_1_27)) ? (var_1_35 == ((signed char) var_1_8)) : (var_1_35 == ((signed char) ((max (16 , (var_1_36 - var_1_8))) - ((var_1_7 - var_1_37) + var_1_38)))))) : ((var_1_27 != var_1_36) ? (var_1_35 == ((signed char) (max (var_1_36 , var_1_7)))) : (var_1_35 == ((signed char) (min ((max (100 , var_1_7)) , 0)))))))) && ((var_1_16 || var_1_31) ? ((var_1_53 >= var_1_25) ? (var_1_39 == ((signed char) (var_1_38 - (max (var_1_7 , (max (100 , var_1_8))))))) : (var_1_39 == ((signed char) (min (var_1_7 , var_1_38))))) : (((var_1_34 | (32u / var_1_7)) != var_1_5) ? (var_1_39 == ((signed char) (var_1_8 + var_1_38))) : (var_1_39 == ((signed char) (var_1_7 - ((max (2 , var_1_8)) + var_1_38))))))) && (((min (var_1_6 , (last_1_var_1_40 + var_1_6))) <= ((var_1_36 - var_1_1) / var_1_27)) ? ((((var_1_27 - var_1_37) * 25) < var_1_6) ? (var_1_40 == ((signed long int) (max (var_1_14 , (max (var_1_34 , var_1_46)))))) : ((var_1_15 && var_1_10) ? (var_1_16 ? (var_1_40 == ((signed long int) (var_1_21 + var_1_37))) : 1) : (var_1_40 == ((signed long int) (var_1_54 + (max (var_1_36 , (abs (var_1_19))))))))) : 1)) && ((var_1_15 && var_1_32) ? (var_1_42 == ((signed long int) (abs (var_1_27)))) : 1)) && ((! var_1_32) ? ((var_1_14 < (50 / (max (var_1_36 , var_1_7)))) ? (var_1_15 ? ((var_1_5 < var_1_19) ? (var_1_43 == ((unsigned long int) (var_1_44 - (abs (var_1_45 - var_1_38))))) : 1) : (var_1_43 == ((unsigned long int) 32u))) : 1) : (var_1_43 == ((unsigned long int) 0u)))) && ((last_1_var_1_40 > var_1_37) ? ((var_1_36 < var_1_5) ? ((((var_1_47 - 10) - (var_1_48 - var_1_38)) > last_1_var_1_43) ? (var_1_46 == ((unsigned long int) var_1_14)) : (var_1_46 == ((unsigned long int) (((last_1_var_1_40 + var_1_47) + var_1_7) + 10000u)))) : (var_1_46 == ((unsigned long int) (min ((min ((max (var_1_8 , last_1_var_1_12)) , var_1_48)) , 2u))))) : 1)) && (((var_1_19 % var_1_50) >= (var_1_54 + (max (var_1_43 , var_1_44)))) ? (var_1_49 == ((signed short int) (50 - (max (var_1_5 , var_1_27))))) : (var_1_49 == ((signed short int) var_1_1)))) && (var_1_51 == ((signed short int) var_1_38))) && (var_1_33 ? (var_1_52 == ((signed char) var_1_36)) : (var_1_52 == ((signed char) 0)))) && (var_1_53 == ((double) var_1_29))) && (var_1_54 == ((unsigned char) var_1_48))) && ((2u <= var_1_19) ? (var_1_55 == ((float) (max (var_1_23 , (max (var_1_30 , var_1_28)))))) : (((- (~ var_1_27)) == var_1_19) ? ((8.375 <= var_1_3) ? (var_1_55 == ((float) var_1_24)) : (var_1_55 == ((float) var_1_29))) : (var_1_55 == ((float) var_1_28))))
;
}
int main(void) {
	isInitial = 1;
