...
void step(void) {
	...
	if ((*(var_1_2_Pointer)) > (*(var_1_1_Pointer))) {
		if ((*(var_1_9_Pointer))) {
			if ((*(var_1_3_Pointer)) <= (min ((*(var_1_1_Pointer)) , (*(var_1_11_Pointer))))) {
