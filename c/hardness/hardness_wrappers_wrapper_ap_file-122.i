...
void step(void) {
 (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) = (((((((1) < ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) ? (1) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))))) < 0 ) ? -((((1) < ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) ? (1) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))))) : ((((1) < ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) ? (1) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))))));
 if ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) < (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))) {
  (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) = ((((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) < 0 ) ? -((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))))) + (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)));
 } else {
 ...
 if ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) >= (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))) {
  (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) = ((((7.8) < (((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))))) ? (7.8) : (((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))))));
 }
