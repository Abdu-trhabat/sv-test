...
void step(void) {
	// From: Req1Batch150Wrapper_P
	signed long int stepLocal_1 = (*(var_1_6_Pointer));
	signed long int stepLocal_0 = ((*(var_1_5_Pointer)) % (*(var_1_6_Pointer))) + (*(var_1_7_Pointer));
	if (((*(var_1_2_Pointer)) * (min ((*(var_1_4_Pointer)) , (*(var_1_3_Pointer))))) <= stepLocal_0) {
		if (stepLocal_1 >= (max ((*(var_1_8_Pointer)) , (*(var_1_2_Pointer))))) {
	...
	// From: Req2Batch150Wrapper_P
	unsigned char stepLocal_2 = (*(var_1_11_Pointer));
	if ((*(var_1_9_Pointer))) {
		if ((*(var_1_1_Pointer)) || stepLocal_2) {
			(*(var_1_10_Pointer)) = (min (((*(var_1_12_Pointer)) + (-5 + (*(var_1_13_Pointer)))) , -4));
		} else {
	...
	// From: Req3Batch150Wrapper_P
	(*(var_1_14_Pointer)) = (*(var_1_12_Pointer));


	// From: Req4Batch150Wrapper_P
...
int property(void) {
	return ((((((*(var_1_2_Pointer)) * (min ((*(var_1_4_Pointer)) , (*(var_1_3_Pointer))))) <= (((*(var_1_5_Pointer)) % (*(var_1_6_Pointer))) + (*(var_1_7_Pointer)))) ? (((*(var_1_6_Pointer)) >= (max ((*(var_1_8_Pointer)) , (*(var_1_2_Pointer))))) ? ((*(var_1_1_Pointer)) == ((unsigned char) ((((*(var_1_5_Pointer)) % (*(var_1_6_Pointer))) >= (-4 + (*(var_1_2_Pointer)))) && (*(var_1_9_Pointer))))) : ((*(var_1_1_Pointer)) == ((unsigned char) 1))) : ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_9_Pointer))))) && ((*(var_1_9_Pointer)) ? (((*(var_1_1_Pointer)) || (*(var_1_11_Pointer))) ? ((*(var_1_10_Pointer)) == ((signed char) (min (((*(var_1_12_Pointer)) + (-5 + (*(var_1_13_Pointer)))) , -4)))) : ((*(var_1_10_Pointer)) == ((signed char) (*(var_1_12_Pointer))))) : ((*(var_1_10_Pointer)) == ((signed char) (*(var_1_13_Pointer)))))) && ((*(var_1_14_Pointer)) == ((signed short int) (*(var_1_12_Pointer))))) && (((*(var_1_8_Pointer)) < ((*(var_1_4_Pointer)) * -8)) ? ((*(var_1_15_Pointer)) == ((signed short int) 2)) : 1)
;
}
int main(void) {
	isInitial = 1;
