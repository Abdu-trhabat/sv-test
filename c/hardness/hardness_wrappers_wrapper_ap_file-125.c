...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch125Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch125Wrapper_AP
	(*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer)) = ((*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) - ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) + 32.4f));


	// From: Req2Batch125Wrapper_AP
	...
	// From: Req3Batch125Wrapper_AP
	(*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) = (*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer));


	// From: Req4Batch125Wrapper_AP
	signed long int stepLocal_0 = (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer));
	if (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) - (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer))) < stepLocal_0) {
	...
	// From: Req5Batch125Wrapper_AP
	(*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) = ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) + (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)));


	// From: Req6Batch125Wrapper_AP
	if (((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) * (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer))) >= (*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer))) {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) = (((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) + (*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer))) - 32);
	}


	// From: Req7Batch125Wrapper_AP
	if ((*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) > (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
		if (! ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) < (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) {
			(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)) = (max ((min (8 , ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) - 8))) , (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer))));
		}
	} else {
		(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)) = 50;
	}


	// From: Req8Batch125Wrapper_AP
...
int property(void) {
	return ((((((((*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer)) == ((float) ((*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) - ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) + 32.4f)))) && ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var4_Pointer)) == ((unsigned char) ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer)) && (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer))))))) && ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) == ((double) (*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer))))) && ((((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) - (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer))) < (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) ? ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) == ((unsigned char) (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)))) : 1)) && ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) == ((float) ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) + (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)))))) && ((((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) * (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer))) >= (*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer))) ? ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) == ((signed char) (((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) + (*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer))) - 32))) : 1)) && (((*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) > (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) ? ((! ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) < (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) ? ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)) == ((unsigned short int) (max ((min (8 , ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) - 8))) , (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))))) : 1) : ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)) == ((unsigned short int) 50)))) && ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)) == ((unsigned short int) (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer))))
;
}
int main(void) {
	isInitial = 1;
