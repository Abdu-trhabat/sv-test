...
void step(void) {
	...
	// From: Req7Batch194Filler_PE_CO
	/* 1039L, 247L, 827L, 833L) */ var_1_22 = (
		var_1_23
	);


	// From: Req8Batch194Filler_PE_CO
	/* 1045L, 257L, 851L, 857L) */ var_1_24 = (
		10
	);


	// From: Req9Batch194Filler_PE_CO
	/* 1051L, 267L, 875L, 881L) */ var_1_25 = (
		var_1_6
	);


	// From: Req1Batch194Filler_PE_CO
	...
	// From: CodeObject1
	/* 227L, 16L) */ if (/* 228L, 4L, 5L) */ ((var_1_22) < (var_1_24))) {
		/* 231L, 15L) */ var_1_26 = (
			/* 234L, 14L) */ (abs (
				var_1_29
			))
	...
	// From: CodeObject6
	/* 309L, 134L) */ if (/* 310L, 122L, 123L) */ ((var_1_24) > (var_1_18))) {
		/* 313L, 133L) */ var_1_41 = (
			/* 316L, 132L) */ (abs (
				var_1_42
			))
	...
	// From: CodeObject7
	/* 318L, 157L) */ if (/* 319L, 143L, 144L) */ ((var_1_25) > (/* 321L, 142L, 146L) */ (- (var_1_39))))) {
		/* 323L, 156L) */ var_1_43 = (
			/* 326L, 155L) */ (abs (
				var_1_22
			))
	...
	// From: CodeObject8
	/* 328L, 209L) */ if (/* 329L, 167L, 168L) */ ((var_1_24) > (/* 331L, 166L, 170L) */ ((/* 332L, 164L, 171L) */ ((28414) + (var_1_45))) - (var_1_46))))) {
		/* 336L, 203L) */ if (/* 337L, 186L, 187L) */ ((var_1_18) >= (/* 339L, 185L, 189L) */ (max (/* 339L, 185L, 189L) */ (var_1_32) , (var_1_30)))))) {
			/* 342L, 202L) */ var_1_44 = (
				/* 345L, 201L) */ (min (
					/* 345L, 201L) */ (
						var_1_32
