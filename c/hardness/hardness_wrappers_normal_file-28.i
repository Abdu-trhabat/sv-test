...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch28normal.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_1 <= ((((var_1_5) > (var_1_7)) ? (var_1_5) : (var_1_7)))) {
  ...
  var_1_12 = (var_1_6 + (((((var_1_14) < (var_1_16)) ? (var_1_14) : (var_1_16))) - var_1_17));
 }
 var_1_18 = var_1_5;
 var_1_19 = var_1_6;
