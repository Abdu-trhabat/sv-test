...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch30functionizing.c", 13, "reach_error"); }
...
void functionized5(double, unsigned char, signed long int);
...
signed long int functionized0(void) {
	return (var_1_2 / (abs (-16)));
}
void functionized1(signed short int functionized1_localFunctionVar0) {
	if (var_1_6 || (functionized1_localFunctionVar0 < var_1_3)) {
		var_1_5 = var_1_7;
	}
}
double functionized2(double functionized2_localFunctionVar0) {
	return (var_1_7 * functionized2_localFunctionVar0);
}
signed long int functionized3(signed short int functionized3_localFunctionVar0, signed long int localFunctionVar1) {
	return (min (functionized3_localFunctionVar0 , (max ((var_1_13 - localFunctionVar1) , var_1_14))));
}
void functionized4(signed long int functionized4_localFunctionVar0) {
	if (var_1_1) {
		var_1_15 = var_1_14;
	} else {
		var_1_15 = functionized4_localFunctionVar0;
	}
}
void functionized5(double functionized5_localFunctionVar0, unsigned char functionized5_localFunctionVar1, signed long int functionized5_localFunctionVar2) {
	if (functionized5_localFunctionVar2 >= ((var_1_2 * var_1_11) * 32)) {
...
void step(void) {
	// From: Req1Batch30functionizing
	if (functionized0() >= var_1_3) {
		var_1_1 = var_1_4;
	}


	// From: Req2Batch30functionizing
	if (var_1_1) {
		if (var_1_2 >= var_1_3) {
			functionized1(var_1_2);
		} else {
			var_1_5 = var_1_7;
		}
	}
	...
	// From: Req3Batch30functionizing
	if (10.55f < var_1_5) {
		if (var_1_5 > functionized2(var_1_9)) {
	...
	// From: Req4Batch30functionizing
	if (var_1_1) {
		if ((max (var_1_9 , 49.75)) > var_1_12) {
			var_1_11 = (functionized3(var_1_2, 5));
		}
	} else {
		var_1_11 = var_1_2;
	}
	...
	// From: Req5Batch30functionizing
	if ((- var_1_2) > (var_1_3 & var_1_13)) {
		if (var_1_2 <= 128) {
			functionized4(var_1_13);
		} else {
			var_1_15 = var_1_13;
		}
	} else {
	...
	// From: Req6Batch30functionizing
	functionized5(var_1_7, var_1_1, var_1_14);
}
