...
void step(void) {
	// From: Req5Batch116normal
	var_1_18 = var_1_19;


	// From: Req6Batch116normal
	var_1_20 = var_1_21;


	// From: Req4Batch116normal
	signed long int stepLocal_2 = var_1_5;
	if (stepLocal_2 <= var_1_18) {
		var_1_11 = ((min ((max (var_1_18 , var_1_12)) , (min (var_1_13 , var_1_14)))) - ((var_1_15 - var_1_16) - var_1_17));
	}


	// From: Req3Batch116normal
	var_1_9 = ((var_1_11 >= (~ var_1_11)) && (! var_1_10));


	// From: Req1Batch116normal
	...
	// From: Req2Batch116normal
	signed long int stepLocal_1 = min (var_1_1 , var_1_11);
	if (var_1_9) {
...
int property(void) {
	return (((((((~ var_1_18) < ((var_1_4 * var_1_5) / var_1_6)) ? (var_1_9 ? (var_1_1 == ((signed short int) var_1_7)) : (var_1_1 == ((signed short int) 8))) : (var_1_1 == ((signed short int) 5))) && (var_1_9 ? (((min (var_1_1 , var_1_11)) >= var_1_11) ? (var_1_8 == ((float) 2.6f)) : 1) : 1)) && (var_1_9 == ((unsigned char) ((var_1_11 >= (~ var_1_11)) && (! var_1_10))))) && ((var_1_5 <= var_1_18) ? (var_1_11 == ((signed long int) ((min ((max (var_1_18 , var_1_12)) , (min (var_1_13 , var_1_14)))) - ((var_1_15 - var_1_16) - var_1_17)))) : 1)) && (var_1_18 == ((unsigned short int) var_1_19))) && (var_1_20 == ((signed char) var_1_21))
;
}
int main(void) {
	isInitial = 1;
