 ...
 if (15.2f < float_Array_0[0]) {
  ...
  if (unsigned_short_int_Array_0[0] > signed_long_int_Array_0[2]) {
   if (last_1_signed_long_int_Array_0_0_ == unsigned_short_int_Array_0[0]) {
    signed_long_int_Array_0[0] = ((((((((signed_char_Array_0[1][1]) < 0 ) ? -(signed_char_Array_0[1][1]) : (signed_char_Array_0[1][1])))) > (-16)) ? (((((signed_char_Array_0[1][1]) < 0 ) ? -(signed_char_Array_0[1][1]) : (signed_char_Array_0[1][1])))) : (-16)));
   } else {
