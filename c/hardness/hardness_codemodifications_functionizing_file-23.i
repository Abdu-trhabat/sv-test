...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch23functionizing.c", 13, "reach_error"); }
...
void functionized4(unsigned short int, unsigned char);
...
signed long int functionized1(unsigned char functionized1_localFunctionVar0) {
 return ((200 - var_1_13) - functionized1_localFunctionVar0);
}
void functionized2(unsigned char functionized2_localFunctionVar0, signed long int functionized2_localFunctionVar1) {
 if ((functionized2_localFunctionVar1 / (128 - functionized2_localFunctionVar0)) < var_1_13) {
  if (var_1_13 >= functionized2_localFunctionVar1) {
   var_1_12 = var_1_14;
  } else {
...
signed long int functionized3(void) {
 return (- (var_1_13 / var_1_17));
}
void functionized4(unsigned short int functionized4_localFunctionVar0, unsigned char functionized4_localFunctionVar1) {
 if (5 <= var_1_17) {
  var_1_21 = (functionized4_localFunctionVar0 - var_1_17);
 } else {
  if (var_1_1) {
...
void step(void) {
 ...
 if (functionized1(var_1_14) != var_1_15) {
  var_1_12 = (var_1_13 + ((((var_1_14) < (var_1_16)) ? (var_1_14) : (var_1_16))));
 } else {
  functionized2(var_1_17, var_1_15);
 }
 if (functionized3() > var_1_15) {
  var_1_18 = var_1_13;
 }
 ...
 functionized4(var_1_22, var_1_2);
 var_1_23 = var_1_13;
 functionized5();
 var_1_25 = var_1_7;
}
...
int property(void) {
 return ((((((((var_1_2 ? (var_1_1 == ((unsigned char) var_1_3)) : 1) && (((var_1_5 <= var_1_6) || var_1_2) ? (var_1_4 == ((float) ((((31.5f) > (((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))))) ? (31.5f) : (((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8)))))))) : (var_1_4 == ((float) ((var_1_9 - var_1_10) - var_1_11))))) && ((((200 - var_1_13) - var_1_14) != var_1_15) ? (var_1_12 == ((signed long int) (var_1_13 + ((((var_1_14) < (var_1_16)) ? (var_1_14) : (var_1_16)))))) : (((var_1_15 / (128 - var_1_17)) < var_1_13) ? ((var_1_13 >= var_1_15) ? (var_1_12 == ((signed long int) var_1_14)) : (var_1_12 == ((signed long int) var_1_17))) : (var_1_12 == ((signed long int) var_1_17))))) && (((- (var_1_13 / var_1_17)) > var_1_15) ? (var_1_18 == ((unsigned long int) var_1_13)) : 1)) && (((var_1_16 / ((((var_1_17) < (var_1_20)) ? (var_1_17) : (var_1_20)))) > var_1_18) ? (var_1_19 == ((signed char) ((((var_1_17) > (var_1_13)) ? (var_1_17) : (var_1_13))))) : (var_1_19 == ((signed char) var_1_17)))) && ((5 <= var_1_17) ? (var_1_21 == ((unsigned short int) (var_1_22 - var_1_17))) : (var_1_1 ? (var_1_2 ? (var_1_21 == ((unsigned short int) var_1_17)) : (var_1_21 == ((unsigned short int) var_1_14))) : 1))) && (var_1_23 == ((signed long int) var_1_13))) && (var_1_24 == ((double) var_1_7))) && (var_1_25 == ((float) var_1_7))
;
}
int main(void) {
 isInitial = 1;
