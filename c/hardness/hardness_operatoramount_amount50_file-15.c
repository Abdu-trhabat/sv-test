...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch15Amount50
	var_1_10 = var_1_11;


	// From: Req5Batch15Amount50
	if (! var_1_2) {
		var_1_19 = ((min (var_1_7 , var_1_9)) + var_1_20);
	}


	// From: Req6Batch15Amount50
	if (var_1_18) {
		var_1_21 = ((max (3346787891u , var_1_22)) - var_1_7);
	}


	// From: Req7Batch15Amount50
	if (-1 < var_1_6) {
