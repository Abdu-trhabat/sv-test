...
void step(void) {
	// From: Req1Batch155Amount25
	if (var_1_2 < var_1_3) {
		var_1_1 = (var_1_4 + (var_1_5 + 64));
	}


	// From: Req3Batch155Amount25
	var_1_8 = (! var_1_9);


	// From: Req4Batch155Amount25
	var_1_10 = (min (var_1_11 , var_1_12));


	// From: Req5Batch155Amount25
	var_1_13 = var_1_11;


	// From: Req6Batch155Amount25
	var_1_14 = var_1_1;


	// From: Req2Batch155Amount25
