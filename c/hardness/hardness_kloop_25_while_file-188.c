...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch18825_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch18825_while
	var_1_9 = (max ((var_1_10 - var_1_11) , var_1_8));


	// From: Req4Batch18825_while
	var_1_15 = var_1_16;


	// From: Req5Batch18825_while
	var_1_17 = var_1_10;


	// From: Req3Batch18825_while
