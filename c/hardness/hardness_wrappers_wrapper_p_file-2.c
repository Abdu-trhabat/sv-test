...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch2Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(var_1_10_Pointer)) || ((*(var_1_6_Pointer)) == (*(var_1_8_Pointer)))) {
		if ((*(var_1_6_Pointer)) <= ((min (0 , last_1_var_1_11)) << last_1_var_1_11)) {
			if ((*(var_1_10_Pointer)) && (last_1_var_1_11 == ((*(var_1_6_Pointer)) * (*(var_1_5_Pointer))))) {
	...
	unsigned long int stepLocal_1 = - ((*(var_1_5_Pointer)) ^ 128u);
...
int property(void) {
	return ((((*(var_1_2_Pointer)) <= ((*(var_1_3_Pointer)) * (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (max ((*(var_1_5_Pointer)) , (max (((*(var_1_6_Pointer)) - (*(var_1_7_Pointer))) , (*(var_1_8_Pointer)))))))) : 1) && (((*(var_1_10_Pointer)) || ((*(var_1_6_Pointer)) == (*(var_1_8_Pointer)))) ? (((*(var_1_6_Pointer)) <= ((min (0 , last_1_var_1_11)) << last_1_var_1_11)) ? (((*(var_1_10_Pointer)) && (last_1_var_1_11 == ((*(var_1_6_Pointer)) * (*(var_1_5_Pointer))))) ? ((*(var_1_9_Pointer)) == ((unsigned short int) (*(var_1_5_Pointer)))) : ((*(var_1_9_Pointer)) == ((unsigned short int) 2))) : ((*(var_1_9_Pointer)) == ((unsigned short int) (*(var_1_6_Pointer))))) : ((*(var_1_9_Pointer)) == ((unsigned short int) (*(var_1_6_Pointer)))))) && (((*(var_1_7_Pointer)) > (*(var_1_1_Pointer))) ? ((*(var_1_10_Pointer)) ? (((- ((*(var_1_5_Pointer)) ^ 128u)) < (*(var_1_9_Pointer))) ? ((*(var_1_11_Pointer)) == ((unsigned long int) (*(var_1_7_Pointer)))) : 1) : ((*(var_1_11_Pointer)) == ((unsigned long int) 1u))) : 1)
;
}
int main(void) {
	isInitial = 1;
