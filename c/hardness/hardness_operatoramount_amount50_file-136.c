...
void step(void) {
	...
	// From: Req4Batch136Amount50
	var_1_12 = ((65103 - 2) - (min (var_1_13 , var_1_14)));


	// From: Req5Batch136Amount50
	...
	// From: Req6Batch136Amount50
	signed long int stepLocal_1 = min (var_1_6 , var_1_14);
	if (stepLocal_1 == var_1_13) {
		var_1_20 = ((var_1_21 + var_1_22) - var_1_12);
	}


	// From: Req7Batch136Amount50
	if (128 < ((min (var_1_13 , var_1_14)) << var_1_20)) {
