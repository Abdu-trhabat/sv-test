...
void step(void) {
	...
	// From: CodeObject1
	/* 217L, 26L) */ if (/* 218L, 5L, 6L) */ (! (/* 219L, 4L, 7L) */ ((var_1_13) && (var_1_10))))) {
		/* 222L, 21L) */ var_1_26 = (
			/* 225L, 20L) */ ((
				/* 226L, 18L) */ (abs (
					/* 227L, 17L) */ (abs (
	...
	// From: CodeObject5
	/* 344L, 175L) */ if (/* 345L, 157L, 158L) */ ((var_1_30) < (var_1_15))) {
		/* 348L, 174L) */ var_1_40 = (
			/* 351L, 173L) */ ((
				/* 352L, 169L) */ (abs (
					/* 353L, 168L) */ ((
