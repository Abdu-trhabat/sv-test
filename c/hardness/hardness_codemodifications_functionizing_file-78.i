...
signed long int functionized0(unsigned char functionized0_localFunctionVar0) {
 return ((((var_1_4) > (functionized0_localFunctionVar0)) ? (var_1_4) : (functionized0_localFunctionVar0)));
}
...
signed long int functionized3(unsigned char functionized3_localFunctionVar0) {
 return (functionized3_localFunctionVar0 % ((((32) > (var_1_9)) ? (32) : (var_1_9))));
}
double functionized4(double functionized4_localFunctionVar0) {
 return ((((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11))) - functionized4_localFunctionVar0) + (var_1_13 - var_1_14));
}
...
void functionized6(unsigned char functionized6_localFunctionVar0) {
 if (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))) > var_1_1) {
  var_1_15 = ((((functionized6_localFunctionVar0) > ((var_1_5 + var_1_4))) ? (functionized6_localFunctionVar0) : ((var_1_5 + var_1_4))));
 }
}
void initially(void) {
}
void step(void) {
 ...
 if ((functionized1(var_1_2, var_1_1)) < -256) {
  var_1_6 = (((((((((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) > (functionized2(var_1_7))) ? (((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) : (functionized2(var_1_7)))) < 0 ) ? -((((((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) > (functionized2(var_1_7))) ? (((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) : (functionized2(var_1_7)))) : ((((((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) > (functionized2(var_1_7))) ? (((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4)))) : (functionized2(var_1_7))))));
 } else {
  if (var_1_5 <= 50) {
   var_1_6 = var_1_3;
  }
