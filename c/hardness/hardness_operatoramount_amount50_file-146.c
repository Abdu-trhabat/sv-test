...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch146Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch146Amount50
	if ((- var_1_8) > var_1_8) {
		var_1_14 = 5;
	}


	// From: Req1Batch146Amount50
	...
	// From: Req8Batch146Amount50
	var_1_25 = var_1_21;


	// From: Req6Batch146Amount50
	if (var_1_2) {
