...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch126functionizing.c", 13, "reach_error"); }
...
void functionized1(unsigned char, double);
unsigned char functionized2(signed char);
void functionized3(unsigned char, unsigned long int, signed long int, signed long int);
double functionized4(double, double, double);
...
void functionized1(unsigned char functionized1_localFunctionVar0, double functionized1_localFunctionVar1) {
	if (var_1_2) {
		if (functionized1_localFunctionVar1 <= var_1_5) {
			if (var_1_7 || functionized1_localFunctionVar0) {
				var_1_6 = var_1_9;
			}
		}
	}
}
unsigned char functionized2(signed char functionized2_localFunctionVar0) {
	return (var_1_8 || ((~ functionized2_localFunctionVar0) > var_1_9));
}
void functionized3(unsigned char functionized3_localFunctionVar0, unsigned long int functionized3_localFunctionVar1, signed long int functionized3_localFunctionVar2, signed long int localFunctionVar3) {
	if (functionized3_localFunctionVar2 != localFunctionVar3) {
		var_1_14 = ((var_1_16 - (var_1_17 - var_1_12)) - (max (functionized3_localFunctionVar0 , functionized3_localFunctionVar1)));
	} else {
...
double functionized4(double functionized4_localFunctionVar0, double functionized4_localFunctionVar1, double functionized4_localFunctionVar2) {
	return ((functionized4_localFunctionVar1 - (min (var_1_24 , functionized4_localFunctionVar2))) - (max (var_1_26 , (var_1_27 + functionized4_localFunctionVar0))));
}
...
void step(void) {
	// From: Req1Batch126functionizing
	if (var_1_2) {
		var_1_1 = var_1_3;
	}


	// From: Req2Batch126functionizing
	functionized0();


	// From: Req3Batch126functionizing
	functionized1(var_1_8, var_1_1);


	// From: Req4Batch126functionizing
	if (functionized2(var_1_6)) {
		var_1_10 = var_1_5;
	}


	// From: Req5Batch126functionizing
	if ((var_1_6 % (128 - var_1_12)) <= var_1_13) {
		var_1_11 = var_1_12;
	}


	// From: Req6Batch126functionizing
	functionized3(var_1_11, var_1_18, var_1_15, -10);


	// From: Req7Batch126functionizing
	if (var_1_7) {
		var_1_20 = (max (var_1_3 , var_1_5));
	} else {
		if (var_1_12 <= ((abs (var_1_21)) - var_1_22)) {
			var_1_20 = (functionized4(var_1_28, var_1_23, var_1_25));
		} else {
	...
	// From: Req8Batch126functionizing
	var_1_29 = var_1_22;
}
