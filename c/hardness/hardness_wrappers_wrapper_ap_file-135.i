...
void step(void) {
 ...
 if (stepLocal_0 < (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) * (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) * ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) * last_1_unsigned_short_int_Array_0_0_))) {
  (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) = ((((((((last_1_unsigned_short_int_Array_0_0_) < ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)))) ? (last_1_unsigned_short_int_Array_0_0_) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)))))) > ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) ? (((((last_1_unsigned_short_int_Array_0_0_) < ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)))) ? (last_1_unsigned_short_int_Array_0_0_) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)))))) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))));
 } else {
  (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) = ((((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) > (last_1_unsigned_short_int_Array_0_0_)) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) : (last_1_unsigned_short_int_Array_0_0_))) + (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)));
 }
 if (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) / (((((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))) < ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)))) ? ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))) : ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)))))) > (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) {
