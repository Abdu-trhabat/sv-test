...
void step(void) {
	...
	// From: CodeObject5
	/* 317L, 175L) */ if (/* 318L, 157L, 158L) */ ((var_1_30) < (var_1_21))) {
		/* 321L, 174L) */ var_1_40 = (
			/* 324L, 173L) */ ((
				/* 325L, 169L) */ (abs (
					/* 326L, 168L) */ ((
