...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch77Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (WrapperStruct00.var_1_6 > (WrapperStruct00.var_1_1 * (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_7)))) {
