...
void step(void) {
	...
	signed long int stepLocal_2 = var_1_12 * var_1_11;
	if (stepLocal_2 == var_1_9) {
		var_1_15 = (var_1_7 + var_1_11);
	} else {
		var_1_15 = (var_1_8 - ((min (var_1_16 , var_1_17)) - var_1_6));
	}


	// From: Req4Batch160normal
	signed long int stepLocal_3 = var_1_17 ^ var_1_9;
	if ((var_1_7 << var_1_16) != stepLocal_3) {
		if (var_1_19) {
			var_1_18 = var_1_14;
		}
	}
...
int property(void) {
	return ((((var_1_2 >= (var_1_3 + var_1_4)) ? (var_1_1 == ((signed char) (var_1_5 - ((var_1_6 + var_1_7) + (max (var_1_8 , var_1_9)))))) : (var_1_1 == ((signed char) var_1_8))) && ((var_1_6 >= (var_1_9 / (min (var_1_11 , var_1_12)))) ? (var_1_10 == ((double) (max (var_1_13 , 5.8)))) : (var_1_10 == ((double) var_1_14)))) && (((var_1_12 * var_1_11) == var_1_9) ? (var_1_15 == ((signed long int) (var_1_7 + var_1_11))) : (var_1_15 == ((signed long int) (var_1_8 - ((min (var_1_16 , var_1_17)) - var_1_6)))))) && (((var_1_7 << var_1_16) != (var_1_17 ^ var_1_9)) ? (var_1_19 ? (var_1_18 == ((float) var_1_14)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
