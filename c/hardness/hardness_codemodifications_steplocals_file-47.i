...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch47stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_0 = 32796 - ((((var_1_6) < (var_1_9)) ? (var_1_6) : (var_1_9)));
 ...
 if (var_1_10) {
  if ((var_1_8 * var_1_7) < var_1_11) {
   var_1_12 = ((((((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) > (var_1_15)) ? (((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) : (var_1_15)));
  }
 } else {
  var_1_12 = var_1_14;
 }
 if ((var_1_6 + var_1_8) > (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) + var_1_1)) {
  var_1_16 = (var_1_10 || var_1_17);
 } else {
  var_1_16 = var_1_18;
 }
 ...
 if (var_1_6 <= stepLocal_2) {
  if (var_1_16) {
   var_1_20 = (var_1_4 - ((((var_1_21 - var_1_8) < 0 ) ? -(var_1_21 - var_1_8) : (var_1_21 - var_1_8))));
  } else {
   var_1_20 = 16;
  }
 } else {
