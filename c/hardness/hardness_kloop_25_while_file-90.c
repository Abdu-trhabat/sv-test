...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch9025_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_1 != stepLocal_1) {
		if (stepLocal_0 >= var_1_9) {
			if ((max (var_1_3 , var_1_4)) < stepLocal_2) {
				var_1_6 = var_1_10;
			} else {
				var_1_6 = var_1_11;
			}
...
int property(void) {
	return ((((var_1_15 ? (var_1_1 == ((signed short int) (min ((var_1_3 + var_1_4) , var_1_5)))) : 1) && ((var_1_1 != (min (var_1_3 , var_1_5))) ? (((var_1_7 - var_1_8) >= var_1_9) ? (((max (var_1_3 , var_1_4)) < (var_1_8 >> var_1_10)) ? (var_1_6 == ((unsigned long int) var_1_10)) : (var_1_6 == ((unsigned long int) var_1_11))) : (var_1_6 == ((unsigned long int) var_1_10))) : (var_1_6 == ((unsigned long int) var_1_8)))) && (var_1_15 ? (var_1_12 == ((signed char) (((var_1_10 + var_1_13) + var_1_14) - 50))) : 1)) && (var_1_15 == ((unsigned char) var_1_16))) && (var_1_17 == ((double) var_1_18))
;
}
int main(void) {
	isInitial = 1;
