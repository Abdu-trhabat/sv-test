...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch77Wrapper_A.c", 13, "reach_error"); }
...
float float_Array_0[7] = {
	0.0, 49.5, 63.8, 31.875, 255.25, 32.4, 255.2
};
...
void step(void) {
	...
	if (float_Array_0[6] != float_Array_0[5]) {
	...
	if (unsigned_short_int_Array_0[0][1] > (unsigned_short_int_Array_0[1][2] * (max (unsigned_short_int_Array_0[1][1] , unsigned_short_int_Array_0[0][0])))) {
