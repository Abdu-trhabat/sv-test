...
void step(void) {
	// From: Req1Batch115Wrapper_SP
	if (((*(WrapperStruct00_var_1_2_Pointer)) * last_1_WrapperStruct00_var_1_1) >= (max ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer))))) {
	...
	// From: Req3Batch115Wrapper_SP
	(*(WrapperStruct00_var_1_12_Pointer)) = (min (((*(WrapperStruct00_var_1_13_Pointer)) - (abs ((*(WrapperStruct00_var_1_14_Pointer))))) , (*(WrapperStruct00_var_1_15_Pointer))));


	// From: Req4Batch115Wrapper_SP
