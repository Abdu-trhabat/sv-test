...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch141100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch141100_while
	unsigned long int stepLocal_2 = min ((var_1_4 / var_1_15) , (max (-10 , last_1_var_1_20)));
	...
	// From: Req5Batch141100_while
	if ((var_1_16 / -128) > (last_1_var_1_36 - (min (256 , last_1_var_1_25)))) {
		var_1_17 = ((last_1_var_1_36 <= last_1_var_1_25) || var_1_6);
	}


	// From: Req9Batch141100_while
	if (var_1_17) {
		var_1_22 = var_1_6;
	} else {
	...
	// From: Req12Batch141100_while
	if (var_1_17) {
		var_1_36 = (max (var_1_4 , (min (-8 , 1))));
	}


	// From: Req7Batch141100_while
	var_1_20 = (max (var_1_15 , last_1_var_1_25));


	// From: Req2Batch141100_while
	if (! (var_1_18 < var_1_20)) {
		var_1_7 = (min (var_1_9 , var_1_10));
	}


	// From: Req4Batch141100_while
	if (var_1_6) {
		var_1_14 = (min ((var_1_15 - (var_1_16 - 10)) , var_1_12));
	} else {
		var_1_14 = ((max (var_1_15 , var_1_12)) - var_1_16);
	}


	// From: Req11Batch141100_while
	if ((0.17500000000000004f - var_1_28) > ((abs (var_1_7)) / var_1_29)) {
		var_1_27 = (32.6 - ((var_1_30 + var_1_31) - var_1_32));
	} else {
		if ((max ((var_1_10 * var_1_29) , var_1_28)) <= (min (0.6 , var_1_31))) {
			var_1_27 = (var_1_30 + (var_1_33 + (var_1_34 + var_1_35)));
		} else {
			var_1_27 = (abs (max (var_1_34 , var_1_9)));
		}
	}


	// From: Req8Batch141100_while
	unsigned long int stepLocal_3 = (var_1_18 * var_1_12) | var_1_15;
	if (stepLocal_3 < (var_1_19 - (max (var_1_11 , last_1_var_1_21)))) {
		var_1_21 = (var_1_11 + (max (var_1_16 , (min (var_1_15 , var_1_20)))));
	} else {
		var_1_21 = var_1_36;
	}


	// From: Req10Batch141100_while
	unsigned long int stepLocal_4 = var_1_18;
	if (var_1_17) {
		if (stepLocal_4 < (min (var_1_12 , last_1_var_1_25))) {
			var_1_25 = var_1_20;
		} else {
			var_1_25 = (min ((var_1_14 - var_1_26) , -100));
		}
	} else {
		var_1_25 = ((max (var_1_4 , var_1_15)) - (abs (var_1_11)));
	}


	// From: Req1Batch141100_while
...
int property(void) {
	return ((((((((((((var_1_21 != (var_1_25 % var_1_4)) ? (var_1_1 == ((unsigned char) (var_1_22 || (! 0)))) : (var_1_1 == ((unsigned char) var_1_6))) && ((! (var_1_18 < var_1_20)) ? (var_1_7 == ((double) (min (var_1_9 , var_1_10)))) : 1)) && ((last_1_var_1_1 || ((last_1_var_1_20 % 32u) != 16u)) ? (var_1_11 == ((unsigned char) (var_1_12 - var_1_13))) : (var_1_6 ? (var_1_11 == ((unsigned char) var_1_12)) : (var_1_11 == ((unsigned char) var_1_13))))) && (var_1_6 ? (var_1_14 == ((unsigned char) (min ((var_1_15 - (var_1_16 - 10)) , var_1_12)))) : (var_1_14 == ((unsigned char) ((max (var_1_15 , var_1_12)) - var_1_16))))) && (((var_1_16 / -128) > (last_1_var_1_36 - (min (256 , last_1_var_1_25)))) ? (var_1_17 == ((unsigned char) ((last_1_var_1_36 <= last_1_var_1_25) || var_1_6))) : 1)) && (((min ((var_1_4 / var_1_15) , (max (-10 , last_1_var_1_20)))) > last_1_var_1_21) ? (var_1_18 == ((unsigned long int) (var_1_19 - var_1_12))) : (last_1_var_1_22 ? (var_1_18 == ((unsigned long int) var_1_15)) : 1))) && (var_1_20 == ((unsigned long int) (max (var_1_15 , last_1_var_1_25))))) && ((((var_1_18 * var_1_12) | var_1_15) < (var_1_19 - (max (var_1_11 , last_1_var_1_21)))) ? (var_1_21 == ((signed long int) (var_1_11 + (max (var_1_16 , (min (var_1_15 , var_1_20))))))) : (var_1_21 == ((signed long int) var_1_36)))) && (var_1_17 ? (var_1_22 == ((unsigned char) var_1_6)) : (var_1_22 == ((unsigned char) (var_1_23 || var_1_24))))) && (var_1_17 ? ((var_1_18 < (min (var_1_12 , last_1_var_1_25))) ? (var_1_25 == ((signed long int) var_1_20)) : (var_1_25 == ((signed long int) (min ((var_1_14 - var_1_26) , -100))))) : (var_1_25 == ((signed long int) ((max (var_1_4 , var_1_15)) - (abs (var_1_11))))))) && (((0.17500000000000004f - var_1_28) > ((abs (var_1_7)) / var_1_29)) ? (var_1_27 == ((double) (32.6 - ((var_1_30 + var_1_31) - var_1_32)))) : (((max ((var_1_10 * var_1_29) , var_1_28)) <= (min (0.6 , var_1_31))) ? (var_1_27 == ((double) (var_1_30 + (var_1_33 + (var_1_34 + var_1_35))))) : (var_1_27 == ((double) (abs (max (var_1_34 , var_1_9)))))))) && (var_1_17 ? (var_1_36 == ((signed long int) (max (var_1_4 , (min (-8 , 1)))))) : 1)
;
}
int main(void) {
	isInitial = 1;
