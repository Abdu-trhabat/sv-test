...
void step(void) {
 ...
 if (stepLocal_0 == (*(WrapperStruct00_var_1_3_Pointer))) {
  (*(WrapperStruct00_var_1_1_Pointer)) = ((((2) > (25)) ? (2) : (25)));
 } else {
 ...
 if (stepLocal_1 >= (*(WrapperStruct00_var_1_6_Pointer))) {
  if (stepLocal_2 < ((*(WrapperStruct00_var_1_2_Pointer)) - (*(WrapperStruct00_var_1_7_Pointer)))) {
   (*(WrapperStruct00_var_1_5_Pointer)) = ((((((*(WrapperStruct00_var_1_8_Pointer))) > (((*(WrapperStruct00_var_1_9_Pointer)) - (*(WrapperStruct00_var_1_10_Pointer))))) ? ((*(WrapperStruct00_var_1_8_Pointer))) : (((*(WrapperStruct00_var_1_9_Pointer)) - (*(WrapperStruct00_var_1_10_Pointer)))))) - (*(WrapperStruct00_var_1_11_Pointer)));
  }
 } else {
