...
void step(void) {
 ...
 if ((*(var_1_9_Pointer)) && ((*(var_1_3_Pointer)) > ((*(var_1_2_Pointer)) / (*(var_1_15_Pointer))))) {
  (*(var_1_14_Pointer)) = ((((((((((*(var_1_16_Pointer))) < 0 ) ? -((*(var_1_16_Pointer))) : ((*(var_1_16_Pointer))))) - (*(var_1_17_Pointer)))) > (((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))))) ? (((((((*(var_1_16_Pointer))) < 0 ) ? -((*(var_1_16_Pointer))) : ((*(var_1_16_Pointer))))) - (*(var_1_17_Pointer)))) : (((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))))));
 } else {
