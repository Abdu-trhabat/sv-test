...
void step(void) {
	...
	if (var_1_21) {
		...
		if (stepLocal_7 >= last_1_var_1_1) {
			...
			if (((- last_1_var_1_60) / (max (var_1_24 , var_1_43))) > 0.775) {
				if ((min ((var_1_6 - var_1_27) , last_1_var_1_53)) <= stepLocal_8) {
		...
		if (var_1_3 >= var_1_4) {
			if (var_1_3 < 7.5) {
				if (var_1_2 && stepLocal_0) {
					...
					var_1_1 = (max ((min (var_1_7 , var_1_6)) , (max (var_1_8 , var_1_9))));
				}
			} else {
				var_1_1 = var_1_6;
			}
	...
	if (var_1_8 > var_1_10) {
		...
		var_1_11 = (min (var_1_13 , (var_1_14 + -2)));
	}


	// From: Req3Batch54Amount250
	signed long int stepLocal_1 = (var_1_12 - var_1_7) / (max (var_1_16 , var_1_17));
	if (var_1_14 > stepLocal_1) {
		var_1_15 = (min ((min (var_1_8 , var_1_10)) , var_1_7));
	} else {
	...
	if (var_1_23) {
		if (((var_1_1 / var_1_26) / (min (var_1_45 , var_1_17))) <= ((~ var_1_6) * (max (var_1_14 , var_1_16)))) {
	...
	if (var_1_34 != (var_1_32 - var_1_27)) {
		...
		if (var_1_40 >= var_1_57) {
			if (var_1_2) {
				var_1_51 = (abs (min (var_1_13 , var_1_11)));
			} else {
	...
	if (stepLocal_2 && ((max (var_1_51 , var_1_6)) < var_1_14)) {
		if (var_1_2) {
			if (var_1_13 > stepLocal_3) {
				if (var_1_21) {
					if (var_1_5 >= var_1_4) {
						var_1_20 = (max ((max (var_1_1 , var_1_18)) , (var_1_8 + var_1_7)));
					}
				} else {
			...
			if (! var_1_23) {
				if ((var_1_4 / var_1_24) > var_1_3) {
					...
					var_1_20 = (var_1_10 + (max (var_1_1 , 1u)));
				}
			} else {
				var_1_20 = var_1_22;
			}
		...
		if (stepLocal_4 >= (~ var_1_14)) {
			...
			var_1_20 = (var_1_10 + (min (var_1_26 , var_1_1)));
		}
	}
	...
	if ((abs (var_1_10)) >= stepLocal_5) {
		var_1_37 = (min ((max (var_1_29 , var_1_30)) , var_1_38));
	}


	// From: Req14Batch54Amount250
	unsigned long int stepLocal_11 = max (var_1_20 , 8);
	unsigned long int stepLocal_10 = (max (var_1_22 , var_1_7)) / var_1_26;
...
int property(void) {
	return (((((((((((((((((! ((- 9.9999999999925E11) >= var_1_3)) ? ((var_1_3 >= var_1_4) ? ((var_1_3 < 7.5) ? ((var_1_2 && (! (var_1_5 >= var_1_4))) ? (var_1_1 == ((unsigned short int) (var_1_6 - var_1_7))) : (var_1_1 == ((unsigned short int) (max ((min (var_1_7 , var_1_6)) , (max (var_1_8 , var_1_9))))))) : (var_1_1 == ((unsigned short int) var_1_6))) : (var_1_1 == ((unsigned short int) var_1_9))) : (var_1_1 == ((unsigned short int) var_1_10))) && ((var_1_8 > var_1_10) ? (var_1_2 ? (var_1_11 == ((signed short int) (var_1_12 - (abs (var_1_13))))) : (var_1_11 == ((signed short int) var_1_12))) : (var_1_11 == ((signed short int) (min (var_1_13 , (var_1_14 + -2))))))) && ((var_1_14 > ((var_1_12 - var_1_7) / (max (var_1_16 , var_1_17)))) ? (var_1_15 == ((unsigned long int) (min ((min (var_1_8 , var_1_10)) , var_1_7)))) : (var_1_15 == ((unsigned long int) (((var_1_18 + var_1_19) - 5u) + 200u))))) && ((var_1_2 && ((max (var_1_51 , var_1_6)) < var_1_14)) ? (var_1_2 ? ((var_1_13 > var_1_18) ? (var_1_21 ? ((var_1_5 >= var_1_4) ? (var_1_20 == ((unsigned long int) (max ((max (var_1_1 , var_1_18)) , (var_1_8 + var_1_7))))) : 1) : (var_1_20 == ((unsigned long int) (var_1_22 - var_1_9)))) : 1) : ((! var_1_23) ? (((var_1_4 / var_1_24) > var_1_3) ? (var_1_20 == ((unsigned long int) ((var_1_25 - var_1_19) + var_1_18))) : (var_1_20 == ((unsigned long int) (var_1_10 + (max (var_1_1 , 1u)))))) : (var_1_20 == ((unsigned long int) var_1_22)))) : (((var_1_10 % (var_1_26 - var_1_27)) >= (~ var_1_14)) ? (var_1_20 == ((unsigned long int) var_1_7)) : (var_1_20 == ((unsigned long int) (var_1_10 + (min (var_1_26 , var_1_1)))))))) && (((var_1_57 ^ -64) < ((3595467207u - var_1_7) - (var_1_20 + var_1_27))) ? (var_1_28 == ((unsigned char) (var_1_27 + var_1_29))) : (var_1_28 == ((unsigned char) var_1_30)))) && (var_1_21 ? (var_1_31 == ((signed char) (min ((var_1_32 - var_1_27) , (min (var_1_33 , var_1_34)))))) : (var_1_31 == ((signed char) (max (((-4 + var_1_35) + var_1_36) , (max (var_1_32 , var_1_27)))))))) && (((abs (var_1_10)) >= ((var_1_20 % var_1_27) + var_1_29)) ? (var_1_37 == ((unsigned char) (min ((max (var_1_29 , var_1_30)) , var_1_38)))) : 1)) && (((var_1_18 / var_1_6) >= (abs (64u))) ? (var_1_23 ? (var_1_39 == ((unsigned short int) ((min ((var_1_40 - var_1_30) , 52932)) - var_1_38))) : 1) : (var_1_39 == ((unsigned short int) (var_1_7 + var_1_27))))) && (var_1_21 ? (((var_1_35 / var_1_17) > ((max (-10 , var_1_30)) / (max (var_1_27 , var_1_16)))) ? (var_1_41 == ((unsigned long int) (3724095905u - var_1_10))) : 1) : (var_1_41 == ((unsigned long int) (var_1_22 - 10u))))) && (var_1_21 ? (var_1_42 == ((unsigned long int) 128u)) : ((var_1_6 >= last_1_var_1_1) ? (var_1_42 == ((unsigned long int) 0u)) : ((((- last_1_var_1_60) / (max (var_1_24 , var_1_43))) > 0.775) ? (((min ((var_1_6 - var_1_27) , last_1_var_1_53)) <= (var_1_8 - last_1_var_1_52)) ? (var_1_42 == ((unsigned long int) (max (var_1_6 , var_1_25)))) : (var_1_23 ? (var_1_42 == ((unsigned long int) (var_1_22 - var_1_27))) : (var_1_42 == ((unsigned long int) last_1_var_1_42)))) : 1)))) && (var_1_23 ? ((((var_1_1 / var_1_26) / (min (var_1_45 , var_1_17))) <= ((~ var_1_6) * (max (var_1_14 , var_1_16)))) ? ((var_1_45 < var_1_57) ? ((1 <= var_1_8) ? (var_1_44 == ((float) ((var_1_46 - (63.625f + var_1_47)) + var_1_48))) : 1) : (var_1_44 == ((float) ((var_1_49 - (var_1_47 + var_1_50)) - var_1_46)))) : 1) : (var_1_2 ? (var_1_44 == ((float) ((var_1_47 - var_1_46) + (abs (var_1_48))))) : 1))) && ((var_1_34 != (var_1_32 - var_1_27)) ? (var_1_51 == ((signed short int) (var_1_35 + (var_1_30 - var_1_29)))) : ((var_1_40 >= var_1_57) ? (var_1_2 ? (var_1_51 == ((signed short int) (abs (min (var_1_13 , var_1_11))))) : (var_1_51 == ((signed short int) (var_1_45 + (var_1_38 - var_1_42))))) : (var_1_51 == ((signed short int) (var_1_45 + var_1_29)))))) && (var_1_21 ? (var_1_52 == ((unsigned long int) last_1_var_1_53)) : 1)) && ((var_1_1 > ((max (var_1_22 , var_1_7)) / var_1_26)) ? (((max (var_1_20 , 8)) < (var_1_34 + var_1_15)) ? (var_1_53 == ((unsigned char) (max ((min ((var_1_54 - var_1_29) , var_1_30)) , (var_1_55 - var_1_27))))) : (var_1_53 == ((unsigned char) var_1_55))) : ((var_1_15 >= var_1_30) ? (var_1_53 == ((unsigned char) (var_1_29 + (max (var_1_27 , var_1_56))))) : (var_1_23 ? (var_1_53 == ((unsigned char) (var_1_55 - var_1_29))) : (var_1_53 == ((unsigned char) (abs (var_1_56)))))))) && ((var_1_43 == (min ((var_1_50 + var_1_47) , (var_1_24 + var_1_48)))) ? (var_1_57 == ((unsigned long int) (abs (var_1_40)))) : ((var_1_6 < var_1_42) ? ((((var_1_50 + var_1_47) - (var_1_58 - 256.2f)) <= var_1_60) ? (var_1_57 == ((unsigned long int) (var_1_22 - ((var_1_18 + var_1_19) - var_1_6)))) : (var_1_57 == ((unsigned long int) ((var_1_59 - var_1_7) - var_1_52)))) : (var_1_57 == ((unsigned long int) 1u))))) && ((var_1_26 < (var_1_6 ^ var_1_10)) ? (var_1_60 == ((double) (var_1_47 - (var_1_50 + var_1_46)))) : (var_1_60 == ((double) (2.4 - 9.2))))) && (var_1_61 == ((signed char) 2))
;
}
int main(void) {
	isInitial = 1;
