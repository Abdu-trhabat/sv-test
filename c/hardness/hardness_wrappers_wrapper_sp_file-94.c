...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch94Wrapper_SP.c", 13, "reach_error"); }
...
void updateVariables(void) {
	...
	assume_abort_if_not((WrapperStruct00.var_1_4 >= 4611686.018427383000e+12F && WrapperStruct00.var_1_4 <= -1.0e-20F) || (WrapperStruct00.var_1_4 <= 9223372.036854766000e+12F && WrapperStruct00.var_1_4 >= 1.0e-20F ));
