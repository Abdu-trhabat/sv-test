...
void step(void) {
	...
	// From: Req1Batch198Amount100
	var_1_1 = ((max ((var_1_2 + var_1_3) , var_1_4)) - var_1_5);


	// From: Req2Batch198Amount100
	...
	// From: Req11Batch198Amount100
	var_1_32 = var_1_4;


	// From: Req14Batch198Amount100
	if (var_1_26 <= (var_1_2 ^ 0)) {
		var_1_36 = ((var_1_10 - var_1_37) + var_1_9);
	}


	// From: Req15Batch198Amount100
	var_1_38 = var_1_10;


	// From: Req5Batch198Amount100
	if (! var_1_12) {
		if (var_1_27) {
			if (var_1_11) {
