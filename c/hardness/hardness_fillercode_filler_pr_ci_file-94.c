...
void step(void) {
	...
	/* 375L, 193L) */ if (var_1_8) {
		...
		/* 383L, 191L) */ if (/* 384L, 157L, 158L) */ ((var_1_9) >= (/* 386L, 156L, 160L) */ ((/* 387L, 153L, 161L) */ (~ (var_1_9))) ^ (/* 389L, 155L, 163L) */ (abs (var_1_2))))))) {
			/* 391L, 185L) */ if (/* 392L, 174L, 175L) */ ((var_1_21) <= (var_1_13))) {
				/* 395L, 184L) */ var_1_31 = (
					var_1_9
				);
			}
	...
	// From: CodeObject6
	/* 475L, 301L) */ if (var_1_7) {
		/* 477L, 299L) */ if (/* 478L, 279L, 280L) */ ((/* 479L, 277L, 281L) */ ((var_1_17) + (var_1_5))) <= (var_1_16))) {
			/* 483L, 294L) */ var_1_37 = (
				/* 486L, 293L) */ (abs (
					var_1_13
				))
	...
	/* 409L, 234L) */ if (/* 410L, 207L, 208L) */ ((var_1_8) || (var_1_7))) {
		...
		/* 417L, 232L) */ if (/* 418L, 220L, 221L) */ ((var_1_11) > (var_1_15))) {
			/* 421L, 231L) */ var_1_33 = (
				/* 424L, 230L) */ (! (
					var_1_8
				))
	...
	// From: CodeObject5
	/* 458L, 268L) */ if (/* 459L, 242L, 243L) */ ((var_1_11) > (63.75f))) {
	...
	// From: CodeObject1
	/* 340L, 138L) */ if (/* 341L, 82L, 83L) */ ((/* 342L, 80L, 84L) */ ((var_1_3) * (var_1_17))) == (var_1_20))) {
		/* 346L, 114L) */ if (/* 347L, 95L, 96L) */ ((var_1_17) > (var_1_20))) {
			/* 350L, 113L) */ var_1_22 = (
				/* 353L, 112L) */ ((
					/* 354L, 110L) */ ((
						/* 355L, 106L) */ ((
		...
		/* 362L, 136L) */ if (/* 363L, 119L, 120L) */ ((5) <= (/* 365L, 118L, 122L) */ (abs (var_1_3))))) {
			/* 367L, 135L) */ var_1_22 = (
				/* 370L, 134L) */ ((
					/* 371L, 132L) */ ((
						var_1_20
