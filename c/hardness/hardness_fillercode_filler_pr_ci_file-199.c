...
void step(void) {
	...
	// From: CodeObject3
	/* 284L, 73L) */ if (/* 285L, 28L, 29L) */ ((var_1_15) < (var_1_14))) {
		/* 288L, 67L) */ if (/* 289L, 39L, 40L) */ ((var_1_29) == (/* 291L, 38L, 42L) */ ((var_1_15) ^ (32))))) {
			/* 294L, 55L) */ var_1_30 = (
				/* 297L, 54L) */ (abs (
					/* 298L, 53L) */ (abs (
						var_1_8
	...
	// From: CodeObject7
	/* 372L, 233L) */ if (/* 373L, 197L, 198L) */ ((/* 374L, 193L, 199L) */ ((/* 375L, 191L, 200L) */ (min (/* 375L, 191L, 200L) */ (var_1_32) , (var_1_8)))) <= (var_1_8))) && (/* 379L, 196L, 204L) */ ((var_1_33) < (var_1_34))))) {
	...
	// From: CodeObject4
	/* 315L, 114L) */ if (/* 316L, 83L, 84L) */ ((/* 317L, 81L, 85L) */ (max (/* 317L, 81L, 85L) */ (var_1_26) , (/* 319L, 80L, 87L) */ ((var_1_16) / (2)))))) <= (4))) {
		/* 323L, 101L) */ var_1_35 = (
			var_1_13
		);
	} else {
	...
	// From: CodeObject6
	/* 352L, 185L) */ if (/* 353L, 157L, 158L) */ ((var_1_27) != (/* 355L, 156L, 160L) */ ((var_1_26) * (var_1_17))))) {
		/* 358L, 183L) */ if (var_1_13) {
			/* 360L, 178L) */ var_1_40 = (
				/* 363L, 177L) */ (min (
					/* 363L, 177L) */ (
						/* 364L, 175L) */ (max (
