...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch109has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch109has_floats
	var_1_17 = var_1_6;


	// From: Req3Batch109has_floats
	var_1_8 = (var_1_5 - var_1_9);


	// From: Req1Batch109has_floats
	...
	// From: Req5Batch109has_floats
	var_1_15 = var_1_1;


	// From: Req6Batch109has_floats
	var_1_16 = var_1_1;


	// From: Req4Batch109has_floats
