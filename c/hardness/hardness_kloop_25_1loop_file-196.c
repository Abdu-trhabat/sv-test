...
void step(void) {
	// From: Req3Batch19625_1loop
	var_1_7 = (min (var_1_3 , (max ((var_1_5 + var_1_4) , (var_1_8 - var_1_9)))));


	// From: Req4Batch19625_1loop
	if ((var_1_9 * (var_1_11 - var_1_12)) == 64) {
		var_1_10 = (! var_1_13);
	}


	// From: Req1Batch19625_1loop
	if (var_1_10) {
...
int property(void) {
	return (((var_1_10 ? (var_1_1 == ((unsigned short int) (max (var_1_3 , 100)))) : (var_1_1 == ((unsigned short int) (((min (var_1_4 , var_1_5)) - 32) + 10)))) && ((var_1_7 <= var_1_3) ? ((var_1_7 >= var_1_3) ? (var_1_6 == ((unsigned short int) (min (var_1_3 , var_1_4)))) : 1) : (var_1_6 == ((unsigned short int) var_1_3)))) && (var_1_7 == ((unsigned short int) (min (var_1_3 , (max ((var_1_5 + var_1_4) , (var_1_8 - var_1_9)))))))) && (((var_1_9 * (var_1_11 - var_1_12)) == 64) ? (var_1_10 == ((unsigned char) (! var_1_13))) : 1)
;
}
int main(void) {
	isInitial = 1;
