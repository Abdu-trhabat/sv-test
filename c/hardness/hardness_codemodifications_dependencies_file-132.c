...
void step(void) {
	// From: Req1Batch132dependencies
	if ((last_1_var_1_10 + last_1_var_1_13) > (var_1_4 + (abs (256)))) {
		var_1_1 = -1;
	}


	// From: Req5Batch132dependencies
	...
	// From: Req2Batch132dependencies
	if (var_1_1 <= ((var_1_13 * var_1_1) * (min (var_1_1 , var_1_13)))) {
	...
	// From: Req3Batch132dependencies
	var_1_9 = (! 0);


	// From: Req6Batch132dependencies
	if (var_1_5 != var_1_13) {
		if (var_1_5 <= var_1_1) {
