...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch97stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_0 = -200;
 ...
 unsigned char stepLocal_2 = 127.75 <= var_1_8;
 if (stepLocal_2 && var_1_4) {
  var_1_7 = (((((var_1_9 + var_1_10)) > (var_1_11)) ? ((var_1_9 + var_1_10)) : (var_1_11)));
 }
 signed long int stepLocal_3 = var_1_6 * var_1_2;
 if ((var_1_13 / var_1_14) <= stepLocal_3) {
  var_1_12 = var_1_15;
 }
 if (var_1_17 <= var_1_5) {
