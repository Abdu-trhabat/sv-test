...
void step(void) {
 ...
 if (stepLocal_1 < ((*(var_1_8_Pointer)) + (((((*(var_1_11_Pointer))) < 0 ) ? -((*(var_1_11_Pointer))) : ((*(var_1_11_Pointer))))))) {
  (*(var_1_14_Pointer)) = (*(var_1_7_Pointer));
 } else {
  (*(var_1_14_Pointer)) = 5;
 }
 signed long int stepLocal_0 = (*(var_1_4_Pointer)) + (*(var_1_5_Pointer));
 if ((((((*(var_1_2_Pointer))) > ((*(var_1_3_Pointer)))) ? ((*(var_1_2_Pointer))) : ((*(var_1_3_Pointer))))) != stepLocal_0) {
  (*(var_1_1_Pointer)) = (((((*(var_1_6_Pointer))) < 0 ) ? -((*(var_1_6_Pointer))) : ((*(var_1_6_Pointer)))));
 } else {
  (*(var_1_1_Pointer)) = ((((((*(var_1_7_Pointer)) + (*(var_1_8_Pointer)))) < ((*(var_1_6_Pointer)))) ? (((*(var_1_7_Pointer)) + (*(var_1_8_Pointer)))) : ((*(var_1_6_Pointer)))));
 }
}
void updateVariables(void) {
...
int property(void) {
 return ((((((((*(var_1_2_Pointer))) > ((*(var_1_3_Pointer)))) ? ((*(var_1_2_Pointer))) : ((*(var_1_3_Pointer))))) != ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer)))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (((((*(var_1_6_Pointer))) < 0 ) ? -((*(var_1_6_Pointer))) : ((*(var_1_6_Pointer))))))) : ((*(var_1_1_Pointer)) == ((unsigned char) ((((((*(var_1_7_Pointer)) + (*(var_1_8_Pointer)))) < ((*(var_1_6_Pointer)))) ? (((*(var_1_7_Pointer)) + (*(var_1_8_Pointer)))) : ((*(var_1_6_Pointer)))))))) && ((last_1_var_1_9 < (*(var_1_3_Pointer))) ? ((last_1_var_1_14 <= (((*(var_1_10_Pointer)) - (*(var_1_11_Pointer))) - (*(var_1_7_Pointer)))) ? ((*(var_1_9_Pointer)) == ((unsigned long int) ((1211749435u + ((*(var_1_12_Pointer)) + (*(var_1_13_Pointer)))) - (*(var_1_8_Pointer))))) : (((*(var_1_10_Pointer)) < ((*(var_1_7_Pointer)) | (*(var_1_5_Pointer)))) ? ((*(var_1_9_Pointer)) == ((unsigned long int) (*(var_1_10_Pointer)))) : 1)) : ((*(var_1_9_Pointer)) == ((unsigned long int) (*(var_1_8_Pointer)))))) && (((((*(var_1_7_Pointer)) & (*(var_1_9_Pointer))) / (*(var_1_10_Pointer))) < ((*(var_1_8_Pointer)) + (((((*(var_1_11_Pointer))) < 0 ) ? -((*(var_1_11_Pointer))) : ((*(var_1_11_Pointer))))))) ? ((*(var_1_14_Pointer)) == ((unsigned char) (*(var_1_7_Pointer)))) : ((*(var_1_14_Pointer)) == ((unsigned char) 5)))
;
}
int main(void) {
 isInitial = 1;
