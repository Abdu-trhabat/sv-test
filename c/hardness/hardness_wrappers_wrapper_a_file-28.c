...
void step(void) {
	...
	if (stepLocal_1 <= (max (signed_char_Array_0[0][1] , signed_char_Array_0[0][0]))) {
		signed_long_int_Array_0[0][0] = ((min (signed_char_Array_0[1][0] , (signed_long_int_Array_0[1][0] - signed_long_int_Array_0[0][2]))) - (signed_long_int_Array_0[1][2] - (abs (signed_char_Array_0[0][1]))));
	} else {
		signed_long_int_Array_0[0][0] = (signed_char_Array_0[1][0] + ((min (signed_long_int_Array_0[0][2] , signed_long_int_Array_0[0][1])) - signed_long_int_Array_0[1][1]));
	}
