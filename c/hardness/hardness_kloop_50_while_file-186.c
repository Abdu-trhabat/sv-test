...
void step(void) {
	// From: Req1Batch18650_while
	var_1_1 = var_1_2;


	// From: Req2Batch18650_while
	...
	// From: Req3Batch18650_while
	if ((var_1_7 > (max (9.6 , var_1_6))) || (var_1_5 < var_1_3)) {
		var_1_9 = var_1_10;
	}


	// From: Req5Batch18650_while
