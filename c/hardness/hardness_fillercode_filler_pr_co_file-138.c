...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch138Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject9
	/* 359L, 242L) */ if (var_1_13) {
		/* 361L, 240L) */ if (/* 362L, 215L, 216L) */ ((var_1_17) > (/* 364L, 214L, 218L) */ ((var_1_32) / (/* 366L, 213L, 220L) */ (abs (var_1_43))))))) {
			/* 368L, 239L) */ var_1_42 = (
				/* 371L, 238L) */ ((
					/* 372L, 234L) */ ((
						var_1_28
	...
	// From: CodeObject5
	/* 305L, 145L) */ if (/* 306L, 112L, 113L) */ ((/* 307L, 108L, 114L) */ ((/* 308L, 104L, 115L) */ (min (/* 308L, 104L, 115L) */ (var_1_27) , (var_1_28)))) & (/* 311L, 107L, 118L) */ ((var_1_11) & (var_1_25))))) <= (/* 314L, 111L, 121L) */ ((var_1_11) * (var_1_29))))) {
		/* 317L, 144L) */ var_1_36 = (
			/* 320L, 143L) */ ((
				/* 321L, 139L) */ (max (
					/* 321L, 139L) */ (
	...
	// From: CodeObject2
	/* 274L, 61L) */ if (/* 275L, 44L, 45L) */ ((var_1_23) < (var_1_25))) {
		/* 278L, 60L) */ var_1_26 = (
			/* 281L, 59L) */ ((
				var_1_27
			) + (
