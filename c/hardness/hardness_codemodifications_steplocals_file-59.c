...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch59stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch59stepLocals
	unsigned short int stepLocal_2 = var_1_1;
	if (stepLocal_2 < var_1_3) {
		var_1_5 = (var_1_6 - (var_1_7 - var_1_3));
	} else {
		if (! var_1_2) {
			var_1_5 = (max (var_1_3 , (var_1_7 + var_1_4)));
		}
	}


	// From: Req3Batch59stepLocals
	unsigned char stepLocal_3 = var_1_5 < var_1_6;
	if (var_1_2) {
	...
	// From: Req4Batch59stepLocals
	unsigned short int stepLocal_5 = var_1_6;
	unsigned char stepLocal_4 = var_1_3;
	if (stepLocal_4 != ((var_1_6 / var_1_4) * (max (var_1_1 , var_1_5)))) {
	...
	// From: Req6Batch59stepLocals
	var_1_17 = var_1_4;


	// From: Req7Batch59stepLocals
	var_1_18 = var_1_16;


	// From: Req8Batch59stepLocals
	var_1_19 = var_1_4;
}
