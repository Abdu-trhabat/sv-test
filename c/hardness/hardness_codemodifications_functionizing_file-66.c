...
void functionized4(float functionized4_localFunctionVar0, unsigned short int functionized4_localFunctionVar1, signed char functionized4_localFunctionVar2, float functionized4_localFunctionVar3, signed char functionized4_localFunctionVar4, float localFunctionVar5) {
	if ((max (var_1_3 , functionized4_localFunctionVar4)) > (var_1_13 / functionized4_localFunctionVar1)) {
		if ((max ((functionized4_localFunctionVar0 + functionized4_localFunctionVar3) , 1.0000000000002E12f)) <= (var_1_5 / (min (localFunctionVar5 , var_1_15)))) {
			var_1_14 = var_1_3;
		} else {
...
unsigned char functionized5(double functionized5_localFunctionVar0, float functionized5_localFunctionVar1, float functionized5_localFunctionVar2) {
	return (functionized5_localFunctionVar2 != (min (var_1_12 , (functionized5_localFunctionVar0 * functionized5_localFunctionVar1))));
}
...
void step(void) {
	// From: Req1Batch66functionizing
	if (var_1_2) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req2Batch66functionizing
	functionized0(var_1_7, 8.25);


	// From: Req3Batch66functionizing
