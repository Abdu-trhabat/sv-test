...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch158Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (WrapperStruct00.var_1_7 || WrapperStruct00.var_1_9) {
		...
		if (-1000000000 < WrapperStruct00.var_1_4) {
			WrapperStruct00.var_1_8 = (128 - ((WrapperStruct00.var_1_12 + 50) - (32 - WrapperStruct00.var_1_13)));
		} else {
			WrapperStruct00.var_1_8 = ((WrapperStruct00.var_1_14 + (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16)) - WrapperStruct00.var_1_12);
		}
	}


	// From: Req4Batch158Wrapper_S
	signed long int stepLocal_1 = WrapperStruct00.var_1_6;
	signed long int stepLocal_0 = -5;
	if (WrapperStruct00.var_1_7) {
		if (WrapperStruct00.var_1_14 <= stepLocal_1) {
			WrapperStruct00.var_1_17 = (max (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_6));
		} else {
...
int property(void) {
	return ((((WrapperStruct00.var_1_2 >= WrapperStruct00.var_1_3) ? (WrapperStruct00.var_1_1 == ((unsigned char) (min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5)))) : (WrapperStruct00.var_1_1 == ((unsigned char) WrapperStruct00.var_1_5))) && ((! WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_6 == ((signed long int) WrapperStruct00.var_1_5)) : 1)) && ((WrapperStruct00.var_1_7 || WrapperStruct00.var_1_9) ? (WrapperStruct00.var_1_8 == ((unsigned char) (WrapperStruct00.var_1_10 - WrapperStruct00.var_1_11))) : ((-1000000000 < WrapperStruct00.var_1_4) ? (WrapperStruct00.var_1_8 == ((unsigned char) (128 - ((WrapperStruct00.var_1_12 + 50) - (32 - WrapperStruct00.var_1_13))))) : (WrapperStruct00.var_1_8 == ((unsigned char) ((WrapperStruct00.var_1_14 + (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16)) - WrapperStruct00.var_1_12)))))) && (WrapperStruct00.var_1_7 ? ((WrapperStruct00.var_1_14 <= WrapperStruct00.var_1_6) ? (WrapperStruct00.var_1_17 == ((unsigned short int) (max (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_6)))) : ((-5 > WrapperStruct00.var_1_13) ? (WrapperStruct00.var_1_17 == ((unsigned short int) WrapperStruct00.var_1_4)) : 1)) : 1)
;
}
int main(void) {
	isInitial = 1;
