...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch7750_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	var_1_8 = (min ((last_1_var_1_8 - var_1_7) , ((128 + var_1_9) - var_1_10)));
	...
	// From: Req7Batch7750_while
	signed long int stepLocal_1 = abs (min (var_1_16 , var_1_22));
	if (var_1_8 != stepLocal_1) {
		var_1_21 = (var_1_17 + (var_1_23 + var_1_24));
	}


	// From: Req8Batch7750_while
	if (! (var_1_20 > (abs (var_1_18)))) {
		if ((max (1 , (var_1_17 + var_1_8))) <= (var_1_22 * var_1_15)) {
...
int property(void) {
	return (((((((((abs (var_1_4)) <= var_1_8) ? (((- var_1_3) > (max (var_1_2 , var_1_6))) ? (var_1_1 == ((unsigned short int) var_1_7)) : (var_1_1 == ((unsigned short int) 50))) : (var_1_1 == ((unsigned short int) var_1_7))) && (var_1_8 == ((signed long int) (min ((last_1_var_1_8 - var_1_7) , ((128 + var_1_9) - var_1_10)))))) && (var_1_11 == ((float) var_1_12))) && ((var_1_9 >= var_1_7) ? (((var_1_18 >= var_1_11) || var_1_14) ? (var_1_13 == ((signed short int) 50)) : (var_1_13 == ((signed short int) var_1_4))) : (var_1_13 == ((signed short int) 256)))) && ((var_1_11 > var_1_2) ? (var_1_15 == ((unsigned short int) (var_1_16 + (10000 + var_1_17)))) : 1)) && (var_1_18 == ((double) (var_1_19 - var_1_20)))) && ((var_1_8 != (abs (min (var_1_16 , var_1_22)))) ? (var_1_21 == ((unsigned short int) (var_1_17 + (var_1_23 + var_1_24)))) : 1)) && ((! (var_1_20 > (abs (var_1_18)))) ? (((max (1 , (var_1_17 + var_1_8))) <= (var_1_22 * var_1_15)) ? (var_1_25 == ((signed short int) (var_1_23 - var_1_17))) : (var_1_25 == ((signed short int) var_1_24))) : (var_1_25 == ((signed short int) var_1_23)))
;
}
int main(void) {
	isInitial = 1;
