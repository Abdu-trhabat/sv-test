...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch9dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((max ((min (var_1_5 , 16)) , var_1_3)) != (min ((var_1_2 - var_1_15) , var_1_10))) {
		if (9999.5f >= var_1_1) {
			var_1_13 = var_1_9;
		}
	} else {
