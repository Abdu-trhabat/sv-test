...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1325_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch1325_1loop
	if (var_1_2) {
		var_1_1 = (max (var_1_3 , var_1_4));
	}


	// From: Req2Batch1325_1loop
	if ((var_1_1 == var_1_4) || var_1_2) {
		var_1_5 = -4;
	}


	// From: Req3Batch1325_1loop
	var_1_6 = (min (var_1_7 , ((var_1_8 - 25.587) - (abs (var_1_9)))));


	// From: Req4Batch1325_1loop
	unsigned short int stepLocal_0 = var_1_3;
	if (stepLocal_0 < (var_1_4 * var_1_1)) {
		if (((min (var_1_8 , var_1_6)) + var_1_7) <= 15.5) {
			var_1_10 = ((var_1_11 - var_1_12) - (max (var_1_13 , var_1_14)));
		} else {
			var_1_10 = var_1_13;
		}
	} else {
...
int property(void) {
	return (((var_1_2 ? (var_1_1 == ((unsigned short int) (max (var_1_3 , var_1_4)))) : 1) && (((var_1_1 == var_1_4) || var_1_2) ? (var_1_5 == ((signed char) -4)) : 1)) && (var_1_6 == ((double) (min (var_1_7 , ((var_1_8 - 25.587) - (abs (var_1_9)))))))) && ((var_1_3 < (var_1_4 * var_1_1)) ? ((((min (var_1_8 , var_1_6)) + var_1_7) <= 15.5) ? (var_1_10 == ((unsigned char) ((var_1_11 - var_1_12) - (max (var_1_13 , var_1_14))))) : (var_1_10 == ((unsigned char) var_1_13))) : (var_1_10 == ((unsigned char) var_1_12)))
;
}
int main(void) {
	isInitial = 1;
