...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch170Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch170Filler_PS_CO
	/* 1171L, 314L, 940L, 946L) */ var_1_21 = (
		var_1_3
	);


	// From: Req4Batch170Filler_PS_CO
