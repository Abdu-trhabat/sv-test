...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch53100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned char stepLocal_7 = (max (last_1_var_1_19 , last_1_var_1_1)) <= 0;
	...
	if (var_1_21 || stepLocal_6) {
		...
		var_1_20 = (var_1_4 - (abs (max (var_1_7 , var_1_3))));
	}
	...
	var_1_19 = (min ((min (var_1_3 , var_1_4)) , var_1_20));
	...
	if ((var_1_1 > var_1_18) || stepLocal_8) {
		var_1_23 = (min ((var_1_3 + (var_1_2 - var_1_1)) , var_1_4));
	} else {
...
int property(void) {
	return (((((((((((((var_1_2 - (var_1_3 - var_1_4)) == var_1_5) ? (((var_1_3 + var_1_5) >= (var_1_4 / var_1_2)) ? ((var_1_5 > var_1_4) ? (var_1_1 == ((signed long int) (var_1_4 + var_1_6))) : (var_1_1 == ((signed long int) var_1_2))) : 1) : (var_1_1 == ((signed long int) var_1_2))) && (((var_1_5 < (var_1_3 - var_1_4)) || (var_1_6 > (var_1_8 * var_1_1))) ? ((var_1_5 >= var_1_4) ? (var_1_7 == ((unsigned char) 2)) : (var_1_7 == ((unsigned char) var_1_4))) : (var_1_7 == ((unsigned char) var_1_3)))) && ((var_1_1 != (var_1_4 ^ var_1_1)) ? (var_1_14 ? (var_1_21 ? (var_1_9 == ((unsigned char) (var_1_12 || (! (! var_1_13))))) : 1) : (var_1_9 == ((unsigned char) var_1_13))) : 1)) && ((var_1_6 < (max (var_1_2 , var_1_4))) ? ((var_1_4 >= var_1_17) ? (var_1_14 == ((unsigned char) var_1_12)) : (var_1_14 == ((unsigned char) (var_1_15 && var_1_16)))) : (var_1_14 == ((unsigned char) var_1_15)))) && (((var_1_28 / (2571661009u - var_1_2)) != var_1_1) ? ((var_1_12 && var_1_21) ? (var_1_17 == ((unsigned short int) 2)) : 1) : (var_1_21 ? (var_1_17 == ((unsigned short int) var_1_18)) : (var_1_17 == ((unsigned short int) var_1_2))))) && (var_1_19 == ((signed short int) (min ((min (var_1_3 , var_1_4)) , var_1_20))))) && ((var_1_21 || (var_1_1 >= var_1_30)) ? (var_1_20 == ((signed short int) ((max (var_1_2 , var_1_3)) + var_1_4))) : (var_1_20 == ((signed short int) (var_1_4 - (abs (max (var_1_7 , var_1_3)))))))) && ((((max (last_1_var_1_19 , last_1_var_1_1)) <= 0) && var_1_13) ? (last_1_var_1_14 ? (var_1_21 == ((unsigned char) var_1_16)) : 1) : 1)) && (((var_1_1 > var_1_18) || var_1_14) ? (var_1_23 == ((signed short int) (min ((var_1_3 + (var_1_2 - var_1_1)) , var_1_4)))) : (var_1_23 == ((signed short int) (var_1_2 - var_1_1))))) && (var_1_24 == ((float) (var_1_25 + (min (var_1_26 , var_1_27)))))) && ((! var_1_12) ? (var_1_28 == ((unsigned char) (((abs (var_1_3)) + var_1_29) - var_1_4))) : (var_1_28 == ((unsigned char) (max ((min (var_1_29 , var_1_4)) , var_1_3)))))) && (((var_1_24 / var_1_31) > var_1_32) ? (var_1_30 == ((unsigned short int) ((max (var_1_33 , var_1_34)) - var_1_4))) : 1)
;
}
int main(void) {
	isInitial = 1;
