...
void step(void) {
	...
	signed long int stepLocal_0 = (min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_3)) / WrapperStruct00.var_1_7;
	...
	if ((WrapperStruct00.var_1_12 - (abs (WrapperStruct00.var_1_13))) >= WrapperStruct00.var_1_14) {
