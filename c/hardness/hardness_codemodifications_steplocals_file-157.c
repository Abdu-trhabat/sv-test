...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch157stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch157stepLocals
	if (((var_1_5 / var_1_10) < var_1_1) && var_1_7) {
		var_1_9 = 32;
	}


	// From: Req4Batch157stepLocals
	var_1_11 = 199.4;


	// From: Req5Batch157stepLocals
	unsigned char stepLocal_0 = (var_1_11 * var_1_3) > var_1_2;
	if (stepLocal_0 && (var_1_10 != var_1_1)) {
		var_1_12 = 32.75f;
	}


	// From: Req6Batch157stepLocals
	if ((- 16.75) <= var_1_12) {
		var_1_13 = (var_1_10 - var_1_14);
	} else {
		var_1_13 = (max (var_1_9 , var_1_10));
	}


	// From: Req7Batch157stepLocals
	...
	// From: Req8Batch157stepLocals
	var_1_21 = var_1_6;


	// From: Req9Batch157stepLocals
	var_1_22 = var_1_18;
}
...
int property(void) {
	return (((((((((var_1_2 < var_1_3) ? ((var_1_3 <= var_1_2) ? (var_1_1 == ((signed long int) ((max (1 , var_1_4)) - var_1_5))) : (var_1_1 == ((signed long int) var_1_4))) : (var_1_1 == ((signed long int) var_1_4))) && ((32.5 >= var_1_3) ? ((var_1_7 && var_1_8) ? (var_1_6 == ((signed char) -4)) : 1) : 1)) && ((((var_1_5 / var_1_10) < var_1_1) && var_1_7) ? (var_1_9 == ((signed char) 32)) : 1)) && (var_1_11 == ((double) 199.4))) && ((((var_1_11 * var_1_3) > var_1_2) && (var_1_10 != var_1_1)) ? (var_1_12 == ((float) 32.75f)) : 1)) && (((- 16.75) <= var_1_12) ? (var_1_13 == ((signed short int) (var_1_10 - var_1_14))) : (var_1_13 == ((signed short int) (max (var_1_9 , var_1_10)))))) && ((var_1_8 || ((var_1_5 * var_1_14) <= (~ 100000000))) ? ((var_1_14 >= (var_1_10 - 10)) ? ((! var_1_8) ? (var_1_15 == ((signed char) var_1_16)) : 1) : 1) : (var_1_15 == ((signed char) (var_1_17 - ((var_1_18 + var_1_19) - var_1_20)))))) && (var_1_21 == ((signed long int) var_1_6))) && (var_1_22 == ((unsigned long int) var_1_18))
;
}
int main(void) {
	isInitial = 1;
