...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch69functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
unsigned char functionized0(signed short int);
void functionized1(unsigned char, unsigned char, unsigned char, unsigned char, signed short int);
unsigned char functionized2(signed short int);
void functionized3(unsigned char, double, unsigned char);
...
unsigned char functionized0(signed short int functionized0_localFunctionVar0) {
 return (var_1_2 >= (var_1_3 - functionized0_localFunctionVar0));
}
void functionized1(unsigned char functionized1_localFunctionVar0, unsigned char functionized1_localFunctionVar1, unsigned char functionized1_localFunctionVar2, unsigned char functionized1_localFunctionVar3, signed short int functionized1_localFunctionVar4) {
 if ((functionized1_localFunctionVar1 - var_1_5) >= functionized1_localFunctionVar4) {
  if (functionized1_localFunctionVar2 || var_1_11) {
   var_1_9 = functionized1_localFunctionVar0;
  } else {
   var_1_9 = functionized1_localFunctionVar3;
  }
 } else {
  var_1_9 = var_1_5;
 }
}
unsigned char functionized2(signed short int functionized2_localFunctionVar0) {
 return ((var_1_9 + functionized2_localFunctionVar0) == var_1_3);
}
void functionized3(unsigned char functionized3_localFunctionVar0, double functionized3_localFunctionVar1, unsigned char functionized3_localFunctionVar2) {
 if (var_1_12 < functionized3_localFunctionVar1) {
  if (functionized3_localFunctionVar2 == var_1_5) {
...
void functionized4(unsigned char functionized4_localFunctionVar0, unsigned char functionized4_localFunctionVar1) {
 if (var_1_10) {
  if (var_1_20 >= (functionized4_localFunctionVar0 % functionized4_localFunctionVar1)) {
   var_1_19 = var_1_8;
  }
 } else {
  var_1_19 = 50;
...
void step(void) {
 ...
 functionized1(var_1_6, var_1_8, var_1_10, var_1_7, var_1_4);
 if (var_1_7 > var_1_4) {
  if (functionized2(var_1_2) && var_1_10) {
   if (! var_1_11) {
    var_1_12 = var_1_13;
   } else {
    var_1_12 = 1.4;
 ...
 functionized3(var_1_7, var_1_13, var_1_15);
