...
void step(void) {
	...
	// From: CodeObject6
	/* 433L, 215L) */ if (/* 434L, 176L, 177L) */ ((var_1_8) > (var_1_12))) {
		/* 437L, 213L) */ if (/* 438L, 189L, 190L) */ ((/* 439L, 187L, 191L) */ (min (/* 439L, 187L, 191L) */ (var_1_14) , (/* 441L, 186L, 193L) */ ((var_1_14) / (var_1_44)))))) <= (var_1_14))) {
			/* 445L, 212L) */ var_1_41 = (
				/* 448L, 211L) */ ((
					/* 449L, 207L) */ (abs (
						var_1_26
	...
	// From: CodeObject3
	/* 296L, 93L) */ if (/* 297L, 77L, 78L) */ ((var_1_35) && (var_1_36))) {
		/* 300L, 92L) */ var_1_34 = (
			/* 303L, 91L) */ ((
				var_1_37
			) - (
	...
	// From: CodeObject4
	/* 319L, 115L) */ if (var_1_22) {
		/* 321L, 113L) */ if (/* 322L, 102L, 103L) */ ((var_1_26) >= (var_1_8))) {
			/* 325L, 112L) */ var_1_39 = (
				var_1_33
			);
		}
	...
	// From: CodeObject1
	/* 251L, 21L) */ if (/* 252L, 6L, 7L) */ ((/* 253L, 4L, 8L) */ ((var_1_25) & (var_1_12))) >= (var_1_1))) {
		/* 257L, 20L) */ var_1_27 = (
			var_1_31
		);
	}
	...
	// From: CodeObject5
	/* 360L, 170L) */ if (/* 361L, 123L, 124L) */ ((var_1_36) && (var_1_35))) {
		/* 364L, 159L) */ if (/* 365L, 132L, 133L) */ ((var_1_1) < (var_1_37))) {
			/* 368L, 157L) */ if (var_1_36) {
				/* 370L, 147L) */ var_1_40 = (
					/* 373L, 146L) */ (abs (
						/* 374L, 145L) */ (abs (
							var_1_31
	...
	// From: CodeObject2
	/* 261L, 71L) */ if (/* 262L, 33L, 34L) */ ((/* 263L, 27L, 35L) */ (min (/* 263L, 27L, 35L) */ (var_1_25) , (25)))) > (/* 266L, 32L, 38L) */ ((var_1_31) >> (/* 268L, 31L, 40L) */ (min (/* 268L, 31L, 40L) */ (var_1_33) , (2)))))))) {
		/* 271L, 69L) */ if (/* 272L, 54L, 55L) */ ((var_1_8) >= (var_1_31))) {
			/* 275L, 64L) */ var_1_32 = (
				var_1_8
			);
		} else {
