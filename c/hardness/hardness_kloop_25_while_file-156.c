...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15625_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch15625_while
	var_1_14 = var_1_10;


	// From: Req6Batch15625_while
	var_1_15 = var_1_10;


	// From: Req7Batch15625_while
	var_1_16 = var_1_17;


	// From: Req3Batch15625_while
...
int property(void) {
	return (((((((last_1_var_1_16 <= last_1_var_1_6) ? (var_1_1 == ((unsigned char) (min (var_1_4 , var_1_5)))) : 1) && ((last_1_var_1_1 < last_1_var_1_11) ? (((var_1_5 + last_1_var_1_1) >= (var_1_4 % var_1_7)) ? (var_1_6 == ((unsigned short int) var_1_5)) : (var_1_6 == ((unsigned short int) 128))) : 1)) && ((var_1_16 <= (abs (var_1_9))) ? (var_1_8 == ((double) var_1_10)) : 1)) && ((var_1_7 <= ((var_1_9 * var_1_6) / var_1_13)) ? (var_1_11 == ((signed long int) (var_1_1 + var_1_5))) : 1)) && (var_1_14 == ((float) var_1_10))) && (var_1_15 == ((double) var_1_10))) && (var_1_16 == ((signed short int) var_1_17))
;
}
int main(void) {
	isInitial = 1;
