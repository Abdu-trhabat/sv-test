...
void step(void) {
	// From: Req1Batch112Amount10
	if (var_1_2 < var_1_3) {
		var_1_1 = (min (var_1_4 , var_1_5));
	}


	// From: Req2Batch112Amount10
	var_1_6 = ((max (var_1_7 , var_1_8)) - ((var_1_9 + var_1_10) - (var_1_11 + var_1_12)));
}
...
int property(void) {
	return ((var_1_2 < var_1_3) ? (var_1_1 == ((signed short int) (min (var_1_4 , var_1_5)))) : 1) && (var_1_6 == ((unsigned char) ((max (var_1_7 , var_1_8)) - ((var_1_9 + var_1_10) - (var_1_11 + var_1_12)))))
;
}
int main(void) {
	isInitial = 1;
