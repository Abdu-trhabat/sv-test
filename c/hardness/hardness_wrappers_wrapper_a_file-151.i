...
void step(void) {
 ...
 if (25 <= ((100000000 + signed_long_int_Array_0[0]) - signed_long_int_Array_0[1])) {
  if (1 >= signed_long_int_Array_0[0]) {
   if (((((unsigned_short_int_Array_0[0] - 8) < 0 ) ? -(unsigned_short_int_Array_0[0] - 8) : (unsigned_short_int_Array_0[0] - 8))) == signed_long_int_Array_0[1]) {
 ...
 if (! BOOL_unsigned_char_Array_0[1]) {
  unsigned_char_Array_0[0][1] = ((((((unsigned_char_Array_0[1][1] + unsigned_char_Array_0[0][0])) > (unsigned_char_Array_0[1][0])) ? ((unsigned_char_Array_0[1][1] + unsigned_char_Array_0[0][0])) : (unsigned_char_Array_0[1][0]))) + ((((unsigned_char_Array_0[0][2] + unsigned_char_Array_0[1][2]) < 0 ) ? -(unsigned_char_Array_0[0][2] + unsigned_char_Array_0[1][2]) : (unsigned_char_Array_0[0][2] + unsigned_char_Array_0[1][2]))));
 } else {
  if (BOOL_unsigned_char_Array_0[1]) {
...
int property(void) {
 return (((double_Array_0[1][1] == ((double) ((double_Array_0[0][1] - double_Array_0[1][0]) - double_Array_0[0][0]))) && (float_Array_0[2] == ((float) ((double_Array_0[1][0] - float_Array_0[1]) + float_Array_0[0])))) && ((25 <= ((100000000 + signed_long_int_Array_0[0]) - signed_long_int_Array_0[1])) ? ((1 >= signed_long_int_Array_0[0]) ? ((((((unsigned_short_int_Array_0[0] - 8) < 0 ) ? -(unsigned_short_int_Array_0[0] - 8) : (unsigned_short_int_Array_0[0] - 8))) == signed_long_int_Array_0[1]) ? (BOOL_unsigned_char_Array_0[2] == ((unsigned char) (BOOL_unsigned_char_Array_0[0] && (! 0)))) : (BOOL_unsigned_char_Array_0[2] == ((unsigned char) (BOOL_unsigned_char_Array_0[0] && BOOL_unsigned_char_Array_0[1])))) : 1) : 1)) && ((! BOOL_unsigned_char_Array_0[1]) ? (unsigned_char_Array_0[0][1] == ((unsigned char) ((((((unsigned_char_Array_0[1][1] + unsigned_char_Array_0[0][0])) > (unsigned_char_Array_0[1][0])) ? ((unsigned_char_Array_0[1][1] + unsigned_char_Array_0[0][0])) : (unsigned_char_Array_0[1][0]))) + ((((unsigned_char_Array_0[0][2] + unsigned_char_Array_0[1][2]) < 0 ) ? -(unsigned_char_Array_0[0][2] + unsigned_char_Array_0[1][2]) : (unsigned_char_Array_0[0][2] + unsigned_char_Array_0[1][2])))))) : (BOOL_unsigned_char_Array_0[1] ? (unsigned_char_Array_0[0][1] == ((unsigned char) unsigned_char_Array_0[1][2])) : 1))
;
}
int main(void) {
 isInitial = 1;
