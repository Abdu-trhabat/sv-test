...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch100Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 279L, 110L) */ if (/* 280L, 52L, 53L) */ ((var_1_21) > (/* 282L, 51L, 55L) */ ((var_1_29) / (/* 284L, 50L, 57L) */ (max (/* 284L, 50L, 57L) */ (var_1_31) , (var_1_32)))))))) {
		/* 287L, 108L) */ if (/* 288L, 71L, 72L) */ ((/* 289L, 69L, 73L) */ (abs (/* 290L, 68L, 74L) */ (abs (var_1_21))))) <= (var_1_32))) {
			...
			/* 298L, 106L) */ if (/* 299L, 91L, 92L) */ ((var_1_33) && (/* 301L, 90L, 94L) */ ((var_1_31) > (var_1_32))))) {
				/* 304L, 105L) */ var_1_30 = (
					var_1_31
				);
			}
