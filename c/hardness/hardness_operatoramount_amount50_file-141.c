...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch141Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch141Amount50
	if (var_1_5 <= var_1_7) {
		var_1_8 = (var_1_9 - var_1_10);
	}


	// From: Req7Batch141Amount50
