...
void step(void) {
 ...
 if ((~ unsigned_long_int_Array_0[1][0]) < (unsigned_long_int_Array_0[0][2] ^ unsigned_long_int_Array_0[1][1])) {
  float_Array_0[0] = (((((float_Array_0[1] - float_Array_0[2]) - ((((double_Array_0[0]) < 0 ) ? -(double_Array_0[0]) : (double_Array_0[0])))) < 0 ) ? -((float_Array_0[1] - float_Array_0[2]) - ((((double_Array_0[0]) < 0 ) ? -(double_Array_0[0]) : (double_Array_0[0])))) : ((float_Array_0[1] - float_Array_0[2]) - ((((double_Array_0[0]) < 0 ) ? -(double_Array_0[0]) : (double_Array_0[0]))))));
 }
...
int property(void) {
 return ((((unsigned_long_int_Array_0[1][2] > (unsigned_long_int_Array_0[0][2] + (unsigned_long_int_Array_0[1][1] + unsigned_long_int_Array_0[0][1]))) ? ((unsigned_long_int_Array_0[1][1] >= (unsigned_long_int_Array_0[1][0] - unsigned_long_int_Array_0[0][0])) ? (double_Array_0[2] == ((double) double_Array_0[0])) : 1) : 1) && (((unsigned_long_int_Array_0[1][1] < unsigned_long_int_Array_0[0][2]) || BOOL_unsigned_char_Array_0[1]) ? (BOOL_unsigned_char_Array_0[0] == ((unsigned char) BOOL_unsigned_char_Array_0[2])) : (((unsigned_long_int_Array_0[1][2] / unsigned_short_int_Array_0[0]) < unsigned_long_int_Array_0[0][1]) ? (BOOL_unsigned_char_Array_0[0] == ((unsigned char) BOOL_unsigned_char_Array_0[2])) : (BOOL_unsigned_char_Array_0[0] == ((unsigned char) 0))))) && (((~ unsigned_long_int_Array_0[1][0]) < (unsigned_long_int_Array_0[0][2] ^ unsigned_long_int_Array_0[1][1])) ? (float_Array_0[0] == ((float) (((((float_Array_0[1] - float_Array_0[2]) - ((((double_Array_0[0]) < 0 ) ? -(double_Array_0[0]) : (double_Array_0[0])))) < 0 ) ? -((float_Array_0[1] - float_Array_0[2]) - ((((double_Array_0[0]) < 0 ) ? -(double_Array_0[0]) : (double_Array_0[0])))) : ((float_Array_0[1] - float_Array_0[2]) - ((((double_Array_0[0]) < 0 ) ? -(double_Array_0[0]) : (double_Array_0[0])))))))) : 1)) && (((signed_char_Array_0[0] - signed_char_Array_0[1]) <= (unsigned_long_int_Array_0[0][0] << unsigned_long_int_Array_0[0][1])) ? (double_Array_0[1] == ((double) double_Array_0[0])) : 1)
;
}
int main(void) {
 isInitial = 1;
