...
void step(void) {
	...
	if (var_1_2 > var_1_3) {
		...
		var_1_1 = (min ((var_1_6 - (max (var_1_7 , var_1_8))) , (var_1_9 + (min (var_1_10 , var_1_11)))));
	}
	...
	if ((var_1_5 + (var_1_11 + var_1_15)) != stepLocal_0) {
		var_1_17 = ((min (10u , (var_1_15 + var_1_8))) + var_1_7);
	}
...
int property(void) {
	return (((((var_1_2 > var_1_3) ? (var_1_1 == ((signed short int) (max (var_1_4 , var_1_5)))) : (var_1_1 == ((signed short int) (min ((var_1_6 - (max (var_1_7 , var_1_8))) , (var_1_9 + (min (var_1_10 , var_1_11)))))))) && (var_1_12 == ((float) ((0.85f - var_1_13) + var_1_14)))) && (((- var_1_8) >= (var_1_4 / (abs (-4)))) ? (var_1_15 == ((unsigned char) var_1_16)) : 1)) && (((var_1_5 + (var_1_11 + var_1_15)) != (var_1_7 * (var_1_1 / var_1_19))) ? (var_1_17 == ((unsigned long int) ((min (10u , (var_1_15 + var_1_8))) + var_1_7))) : 1)) && (var_1_20 == ((float) var_1_13))
;
}
int main(void) {
	isInitial = 1;
