...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[0]) {
		...
		if (unsigned_char_Array_0[1] <= stepLocal_0) {
			unsigned_short_int_Array_0[1] = (max (unsigned_char_Array_0[0] , (unsigned_short_int_Array_0[0] - 8)));
		}
	}
	...
	if (stepLocal_1 >= (unsigned_char_Array_0[1] & unsigned_char_Array_0[0])) {
		unsigned_long_int_Array_0[1] = (min ((min ((min (50u , unsigned_char_Array_0[0])) , unsigned_short_int_Array_0[0])) , (unsigned_long_int_Array_0[0] - unsigned_short_int_Array_0[1])));
	} else {
...
int property(void) {
	return ((((unsigned_char_Array_0[1] == unsigned_char_Array_0[0]) ? (signed_short_int_Array_0[0] == ((signed short int) (unsigned_char_Array_0[1] + -16))) : (BOOL_unsigned_char_Array_0[0] ? (signed_short_int_Array_0[0] == ((signed short int) unsigned_char_Array_0[0])) : 1)) && (BOOL_unsigned_char_Array_0[0] ? (unsigned_short_int_Array_0[1] == ((unsigned short int) unsigned_char_Array_0[1])) : ((unsigned_char_Array_0[1] <= signed_short_int_Array_0[0]) ? (unsigned_short_int_Array_0[1] == ((unsigned short int) (max (unsigned_char_Array_0[0] , (unsigned_short_int_Array_0[0] - 8))))) : 1))) && ((unsigned_long_int_Array_0[1] < unsigned_short_int_Array_0[1]) ? (float_Array_0[1][1] == ((float) (((10.25f + float_Array_0[1][0]) + float_Array_0[0][0]) + float_Array_0[0][1]))) : 1)) && ((unsigned_short_int_Array_0[1] >= (unsigned_char_Array_0[1] & unsigned_char_Array_0[0])) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) (min ((min ((min (50u , unsigned_char_Array_0[0])) , unsigned_short_int_Array_0[0])) , (unsigned_long_int_Array_0[0] - unsigned_short_int_Array_0[1]))))) : ((5.7 < float_Array_0[0][0]) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_short_int_Array_0[1])) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_char_Array_0[0]))))
;
}
int main(void) {
	isInitial = 1;
