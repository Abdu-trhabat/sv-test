...
void step(void) {
	...
	// From: CodeObject5
	/* 276L, 106L) */ if (/* 277L, 88L, 89L) */ ((var_1_21) < (/* 279L, 87L, 91L) */ ((/* 280L, 85L, 92L) */ (abs (var_1_33))) | (var_1_21))))) {
		/* 283L, 105L) */ var_1_41 = (
			/* 286L, 104L) */ (abs (
				var_1_7
			))
	...
	// From: CodeObject7
	/* 304L, 210L) */ if (/* 305L, 150L, 151L) */ ((var_1_39) >= (var_1_1))) {
		/* 308L, 204L) */ if (/* 309L, 161L, 162L) */ ((/* 310L, 159L, 163L) */ ((var_1_44) >> (16))) < (var_1_46))) {
			/* 314L, 198L) */ if (/* 315L, 177L, 178L) */ (! (/* 316L, 176L, 179L) */ ((/* 317L, 174L, 180L) */ ((var_1_46) | (var_1_33))) >= (var_1_21))))) {
				/* 321L, 193L) */ var_1_48 = (
					var_1_32
				);
			} else {
	...
	// From: CodeObject2
	/* 234L, 39L) */ if (/* 235L, 14L, 15L) */ ((/* 236L, 12L, 16L) */ (abs (/* 237L, 11L, 17L) */ (abs (var_1_30))))) == (var_1_7))) {
		/* 240L, 31L) */ var_1_31 = (
			/* 243L, 30L) */ (min (
				/* 243L, 30L) */ (
					/* 244L, 28L) */ (abs (
