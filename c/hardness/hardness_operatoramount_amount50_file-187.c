...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch187Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch187Amount50
	if (var_1_2) {
		var_1_9 = (max ((max (var_1_10 , var_1_11)) , var_1_12));
	}


	// From: Req4Batch187Amount50
	...
	// From: Req7Batch187Amount50
	var_1_23 = var_1_18;


	// From: Req8Batch187Amount50
	var_1_24 = 32;


	// From: Req9Batch187Amount50
	var_1_25 = var_1_18;


	// From: Req2Batch187Amount50
