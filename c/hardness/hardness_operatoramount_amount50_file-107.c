...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch107Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req8Batch107Amount50
	var_1_28 = last_1_var_1_29;


	// From: Req9Batch107Amount50
	var_1_29 = var_1_28;


	// From: Req1Batch107Amount50
	if ((max (last_1_var_1_23 , last_1_var_1_27)) > (last_1_var_1_23 + (- last_1_var_1_23))) {
	...
	// From: Req4Batch107Amount50
	var_1_23 = (var_1_8 - var_1_6);


	// From: Req5Batch107Amount50
	...
	// From: Req7Batch107Amount50
	if ((max (var_1_23 , var_1_8)) < (var_1_7 + var_1_1)) {
		var_1_27 = (var_1_8 - var_1_6);
	}


	// From: Req3Batch107Amount50
	...
	// From: Req2Batch107Amount50
	signed long int stepLocal_1 = min (var_1_16 , var_1_28);
...
int property(void) {
	return ((((((((((max (last_1_var_1_23 , last_1_var_1_27)) > (last_1_var_1_23 + (- last_1_var_1_23))) ? (var_1_1 == ((double) (var_1_6 - ((var_1_7 - var_1_8) + var_1_9)))) : (var_1_1 == ((double) var_1_6))) && (((min (var_1_16 , var_1_28)) < var_1_28) ? (((var_1_28 + var_1_14) == 5u) ? (var_1_10 == ((unsigned long int) var_1_15)) : 1) : (var_1_10 == ((unsigned long int) var_1_15)))) && (var_1_24 ? (var_1_16 == ((unsigned char) ((var_1_18 + (var_1_19 + var_1_20)) - var_1_21))) : ((var_1_24 && (var_1_23 > 16.75f)) ? (var_1_16 == ((unsigned char) var_1_19)) : 1))) && (var_1_23 == ((double) (var_1_8 - var_1_6)))) && ((((var_1_15 ^ 16u) * 64u) > var_1_18) ? (var_1_24 == ((unsigned char) var_1_25)) : 1)) && ((var_1_6 < (var_1_1 * (var_1_8 - 9.99999998E7))) ? (var_1_26 == ((signed char) (abs (min (var_1_20 , var_1_19))))) : (var_1_26 == ((signed char) var_1_20)))) && (((max (var_1_23 , var_1_8)) < (var_1_7 + var_1_1)) ? (var_1_27 == ((double) (var_1_8 - var_1_6))) : 1)) && (var_1_28 == ((signed long int) last_1_var_1_29))) && (var_1_29 == ((signed short int) var_1_28))
;
}
int main(void) {
	isInitial = 1;
