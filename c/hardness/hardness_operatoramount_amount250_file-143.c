...
void step(void) {
	...
	// From: Req11Batch143Amount250
	var_1_42 = ((abs (var_1_41 + var_1_12)) - (abs (var_1_36)));


	// From: Req12Batch143Amount250
	if (var_1_19 < var_1_31) {
		var_1_43 = (min (var_1_14 , var_1_35));
	}


	// From: Req13Batch143Amount250
	if (var_1_30 == ((var_1_46 - var_1_39) - (min (var_1_29 , var_1_38)))) {
		var_1_44 = (var_1_30 + (abs (var_1_39)));
	} else {
		if (var_1_24) {
	...
	// From: Req14Batch143Amount250
	var_1_47 = var_1_36;


	// From: Req21Batch143Amount250
	...
	// From: Req22Batch143Amount250
	var_1_61 = ((abs (16u)) + 5u);


	// From: Req8Batch143Amount250
	if (var_1_60) {
		var_1_32 = var_1_6;
	} else {
		var_1_32 = var_1_12;
	...
	// From: Req19Batch143Amount250
	if (var_1_29 < var_1_37) {
		var_1_58 = (max (var_1_19 , var_1_32));
	} else {
		var_1_58 = (min (var_1_14 , var_1_36));
	}


	// From: Req5Batch143Amount250
	...
	// From: Req10Batch143Amount250
	unsigned char stepLocal_13 = (- var_1_30) >= var_1_29;
	signed long int stepLocal_12 = max ((var_1_10 << var_1_18) , var_1_58);
	...
	if ((var_1_35 - var_1_36) >= stepLocal_11) {
		if (var_1_20) {
			...
			if (stepLocal_12 < (1 << (var_1_40 + var_1_41))) {
				var_1_34 = (var_1_39 + (min (256.775f , var_1_38)));
			} else {
				var_1_34 = (min (16.75f , var_1_27));
			}
		}
	}


	// From: Req15Batch143Amount250
	if (var_1_42 > (min (var_1_58 , var_1_41))) {
		var_1_48 = (((var_1_49 + var_1_50) - var_1_41) - var_1_40);
	} else {
		var_1_48 = (max (-1 , ((16 - var_1_49) + var_1_41)));
	}


	// From: Req17Batch143Amount250
	unsigned char stepLocal_17 = var_1_40;
	if (var_1_58 < stepLocal_17) {
		var_1_53 = (var_1_37 - var_1_38);
	} else {
		var_1_53 = (max (var_1_39 , var_1_30));
	}


	// From: Req1Batch143Amount250
	signed long int stepLocal_3 = var_1_32 / var_1_7;
	unsigned long int stepLocal_2 = var_1_61;
	unsigned char stepLocal_1 = var_1_20;
	unsigned long int stepLocal_0 = min (var_1_61 , var_1_32);
	...
	if (var_1_1 != stepLocal_16) {
		if (stepLocal_14 <= var_1_47) {
			if ((- (var_1_36 ^ var_1_11)) != stepLocal_15) {
				var_1_51 = ((min (var_1_38 , var_1_39)) - var_1_37);
			} else {
				var_1_51 = (min (var_1_28 , var_1_38));
			}
		}
	} else {
		if (var_1_21) {
			var_1_51 = (abs (var_1_30 + var_1_39));
		} else {
			var_1_51 = (var_1_37 - (var_1_38 + (max (var_1_30 , var_1_39))));
		}
	}


	// From: Req20Batch143Amount250
	if ((var_1_10 / var_1_57) < var_1_35) {
		if (var_1_5 <= var_1_14) {
			if ((abs (var_1_29)) > var_1_46) {
				var_1_59 = (max (0 , (min (var_1_41 , var_1_40))));
			}
		} else {
			if (var_1_41 < ((max (var_1_36 , var_1_1)) / (min (var_1_50 , var_1_7)))) {
				var_1_59 = (var_1_41 + var_1_49);
			}
		}
	} else {
		var_1_59 = (min (var_1_41 , var_1_40));
	}


	// From: Req18Batch143Amount250
	...
	if (stepLocal_18 < last_1_var_1_54) {
		if (var_1_1 <= stepLocal_19) {
			var_1_54 = (((max (var_1_55 , 25062)) + (min (var_1_56 , var_1_57))) - 4);
		}
	}


	// From: Req9Batch143Amount250
...
int property(void) {
	return (((((((((((((((((((((((var_1_31 != (min (var_1_61 , var_1_32))) ? (((- var_1_5) >= (var_1_32 / var_1_7)) ? ((var_1_20 || var_1_62) ? (var_1_1 == ((unsigned short int) (max (var_1_6 , (var_1_10 + 5))))) : (var_1_1 == ((unsigned short int) (var_1_6 + (var_1_11 + var_1_12))))) : (var_1_1 == ((unsigned short int) (var_1_12 + (max (var_1_6 , var_1_10)))))) : ((var_1_7 >= var_1_61) ? (var_1_1 == ((unsigned short int) (var_1_13 - var_1_10))) : (var_1_1 == ((unsigned short int) (var_1_11 + ((var_1_14 + 64) + var_1_12)))))) && ((var_1_60 && (! var_1_33)) ? (((2 - (17647 - 256)) >= var_1_54) ? (var_1_15 == ((unsigned short int) (var_1_13 - var_1_10))) : (var_1_15 == ((unsigned short int) (min (var_1_6 , (abs (var_1_11))))))) : 1)) && (var_1_62 ? ((var_1_13 < var_1_7) ? ((last_1_var_1_16 > (5 + var_1_7)) ? (((last_1_var_1_16 / var_1_7) < (var_1_13 - last_1_var_1_16)) ? (var_1_16 == ((unsigned short int) (max (((max (var_1_13 , 53301)) - var_1_10) , 50)))) : 1) : (var_1_16 == ((unsigned short int) (min (var_1_10 , var_1_6))))) : (var_1_16 == ((unsigned short int) ((abs (5)) + 128)))) : (var_1_16 == ((unsigned short int) ((var_1_17 - var_1_14) - var_1_6))))) && ((var_1_11 > var_1_31) ? (var_1_18 == ((signed long int) (var_1_19 - var_1_12))) : 1)) && (((var_1_31 + var_1_32) < (var_1_5 + var_1_14)) ? (var_1_20 == ((unsigned char) ((var_1_21 && var_1_22) && var_1_23))) : (var_1_20 == ((unsigned char) (var_1_24 || var_1_25))))) && (var_1_33 ? (var_1_26 == ((double) (max (var_1_27 , 4.25)))) : (var_1_26 == ((double) (min (var_1_27 , (var_1_28 + (var_1_29 - var_1_30)))))))) && (var_1_25 ? (((var_1_6 < (var_1_5 ^ last_1_var_1_58)) || (500 < last_1_var_1_15)) ? (last_1_var_1_33 ? ((last_1_var_1_60 && var_1_24) ? (var_1_31 == ((signed long int) (abs (32)))) : (var_1_31 == ((signed long int) (abs (var_1_17))))) : 1) : (var_1_31 == ((signed long int) last_1_var_1_18))) : (var_1_31 == ((signed long int) last_1_var_1_61)))) && (var_1_60 ? (var_1_32 == ((unsigned short int) var_1_6)) : (var_1_32 == ((unsigned short int) var_1_12)))) && ((var_1_22 && (var_1_5 < var_1_54)) ? ((var_1_17 == (var_1_58 * (var_1_13 - var_1_11))) ? (var_1_33 == ((unsigned char) (((var_1_10 * var_1_7) <= var_1_54) && var_1_25))) : (var_1_23 ? (var_1_33 == ((unsigned char) var_1_25)) : 1)) : (var_1_33 == ((unsigned char) var_1_21)))) && (((var_1_35 - var_1_36) >= var_1_18) ? (var_1_20 ? ((((- var_1_30) >= var_1_29) || var_1_21) ? ((! var_1_25) ? (var_1_34 == ((float) (abs (var_1_29)))) : (var_1_34 == ((float) ((var_1_37 - var_1_29) - ((var_1_38 + var_1_39) - var_1_30))))) : 1) : (((max ((var_1_10 << var_1_18) , var_1_58)) < (1 << (var_1_40 + var_1_41))) ? (var_1_34 == ((float) (var_1_39 + (min (256.775f , var_1_38))))) : (var_1_34 == ((float) (min (16.75f , var_1_27)))))) : 1)) && (var_1_42 == ((signed short int) ((abs (var_1_41 + var_1_12)) - (abs (var_1_36)))))) && ((var_1_19 < var_1_31) ? (var_1_43 == ((signed short int) (min (var_1_14 , var_1_35)))) : 1)) && ((var_1_30 == ((var_1_46 - var_1_39) - (min (var_1_29 , var_1_38)))) ? (var_1_44 == ((float) (var_1_30 + (abs (var_1_39))))) : (var_1_24 ? (var_1_44 == ((float) (0.2f - var_1_29))) : 1))) && (var_1_47 == ((signed short int) var_1_36))) && ((var_1_42 > (min (var_1_58 , var_1_41))) ? (var_1_48 == ((signed char) (((var_1_49 + var_1_50) - var_1_41) - var_1_40))) : (var_1_48 == ((signed char) (max (-1 , ((16 - var_1_49) + var_1_41))))))) && ((var_1_1 != (~ var_1_6)) ? ((var_1_43 <= var_1_47) ? (((- (var_1_36 ^ var_1_11)) != (var_1_40 << 2)) ? (var_1_51 == ((double) ((min (var_1_38 , var_1_39)) - var_1_37))) : (var_1_51 == ((double) (min (var_1_28 , var_1_38))))) : 1) : (var_1_21 ? (var_1_51 == ((double) (abs (var_1_30 + var_1_39)))) : (var_1_51 == ((double) (var_1_37 - (var_1_38 + (max (var_1_30 , var_1_39))))))))) && ((var_1_58 < var_1_40) ? (var_1_53 == ((double) (var_1_37 - var_1_38))) : (var_1_53 == ((double) (max (var_1_39 , var_1_30)))))) && ((var_1_50 < last_1_var_1_54) ? ((var_1_1 <= var_1_17) ? (var_1_54 == ((unsigned short int) (((max (var_1_55 , 25062)) + (min (var_1_56 , var_1_57))) - 4))) : 1) : 1)) && ((var_1_29 < var_1_37) ? (var_1_58 == ((signed long int) (max (var_1_19 , var_1_32)))) : (var_1_58 == ((signed long int) (min (var_1_14 , var_1_36)))))) && (((var_1_10 / var_1_57) < var_1_35) ? ((var_1_5 <= var_1_14) ? (((abs (var_1_29)) > var_1_46) ? (var_1_59 == ((signed char) (max (0 , (min (var_1_41 , var_1_40)))))) : 1) : ((var_1_41 < ((max (var_1_36 , var_1_1)) / (min (var_1_50 , var_1_7)))) ? (var_1_59 == ((signed char) (var_1_41 + var_1_49))) : 1)) : (var_1_59 == ((signed char) (min (var_1_41 , var_1_40)))))) && ((var_1_13 == (var_1_55 / var_1_57)) ? (var_1_60 == ((unsigned char) var_1_21)) : 1)) && (var_1_61 == ((unsigned long int) ((abs (16u)) + 5u)))) && ((var_1_8 && var_1_9) ? ((var_1_31 <= var_1_40) ? (var_1_62 == ((unsigned char) (var_1_24 || var_1_25))) : (var_1_62 == ((unsigned char) var_1_24))) : (var_1_62 == ((unsigned char) var_1_23)))
;
}
int main(void) {
	isInitial = 1;
