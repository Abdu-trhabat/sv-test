...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch25Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 419L, 332L) */ if (var_1_12) {
		/* 421L, 309L) */ if (/* 422L, 281L, 282L) */ ((64) <= (var_1_1))) {
		...
		/* 437L, 330L) */ if (/* 438L, 313L, 314L) */ ((var_1_5) == (var_1_16))) {
			/* 441L, 325L) */ var_1_37 = (
				/* 444L, 324L) */ (abs (
					/* 445L, 323L) */ (abs (
						var_1_16
	...
	// From: CodeObject3
	/* 373L, 172L) */ if (/* 374L, 155L, 156L) */ ((var_1_10) || (var_1_12))) {
		/* 377L, 167L) */ var_1_31 = (
			/* 380L, 166L) */ ((
				var_1_28
			) + (
	...
	/* 343L, 149L) */ if (/* 344L, 91L, 92L) */ ((var_1_27) < (var_1_28))) {
		...
		/* 358L, 147L) */ if (/* 359L, 124L, 125L) */ ((var_1_12) || (/* 361L, 123L, 127L) */ ((var_1_25) <= (var_1_28))))) {
			/* 364L, 145L) */ if (var_1_12) {
				/* 366L, 144L) */ var_1_29 = (
					/* 369L, 143L) */ (abs (
						/* 370L, 142L) */ (max (
							/* 370L, 142L) */ (
