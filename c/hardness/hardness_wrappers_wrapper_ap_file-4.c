...
void step(void) {
	...
	if ((- ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) / 0.6f)) > (((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) + 3.25f) / (min ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)))))) {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) = (500u + (min ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)))));
	} else {
	...
	if ((last_1_unsigned_short_int_Array_0_1__1_ / (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) >= stepLocal_0) {
		if (stepLocal_1 > last_1_unsigned_short_int_Array_0_1__1_) {
			(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)) = (min ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer))));
		}
	}
	...
	if (stepLocal_2 != ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)) - 64)) {
		...
		(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) = (min ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))));
	}
}
