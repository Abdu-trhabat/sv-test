...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch89Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned short int stepLocal_0 = (*(var_1_15_Pointer));
	...
	if (((*(var_1_14_Pointer)) / (*(var_1_3_Pointer))) >= (*(var_1_13_Pointer))) {
	...
	if (((*(var_1_15_Pointer)) / (*(var_1_3_Pointer))) > (*(var_1_10_Pointer))) {
...
int property(void) {
	return ((((((((*(var_1_14_Pointer)) / (*(var_1_3_Pointer))) >= (*(var_1_13_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned char) ((*(var_1_5_Pointer)) && (*(var_1_6_Pointer))))) : ((*(var_1_1_Pointer)) == ((unsigned char) ((*(var_1_5_Pointer)) && (*(var_1_7_Pointer)))))) && (((*(var_1_13_Pointer)) > (*(var_1_15_Pointer))) ? ((*(var_1_8_Pointer)) == ((signed char) (min ((-4 + (*(var_1_9_Pointer))) , (*(var_1_10_Pointer)))))) : 1)) && ((((*(var_1_15_Pointer)) / (*(var_1_3_Pointer))) > (*(var_1_10_Pointer))) ? (((*(var_1_7_Pointer)) && (*(var_1_1_Pointer))) ? (((*(var_1_8_Pointer)) < (*(var_1_14_Pointer))) ? (((*(var_1_3_Pointer)) <= (8 ^ (*(var_1_8_Pointer)))) ? ((*(var_1_11_Pointer)) == ((unsigned char) (*(var_1_5_Pointer)))) : ((*(var_1_11_Pointer)) == ((unsigned char) ((*(var_1_5_Pointer)) && (! (*(var_1_7_Pointer))))))) : ((*(var_1_11_Pointer)) == ((unsigned char) (*(var_1_7_Pointer))))) : 1) : 1)) && ((*(var_1_13_Pointer)) == ((signed long int) (*(var_1_10_Pointer))))) && ((*(var_1_14_Pointer)) == ((unsigned short int) (*(var_1_15_Pointer))))) && ((*(var_1_15_Pointer)) == ((unsigned short int) (*(var_1_3_Pointer))))
;
}
int main(void) {
	isInitial = 1;
