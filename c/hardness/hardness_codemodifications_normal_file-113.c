...
void step(void) {
	...
	// From: Req4Batch113normal
	var_1_15 = var_1_6;


	// From: Req5Batch113normal
	if (var_1_5 != var_1_4) {
		var_1_16 = (min (10 , (max (var_1_17 , var_1_18))));
	}


	// From: Req6Batch113normal
	if (var_1_2 || var_1_8) {
		var_1_19 = var_1_20;
	} else {
	...
	// From: Req7Batch113normal
	var_1_22 = (var_1_23 - var_1_24);


	// From: Req8Batch113normal
	if (var_1_22 > 256.8) {
