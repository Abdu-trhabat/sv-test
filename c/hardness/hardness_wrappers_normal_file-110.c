...
void step(void) {
	...
	signed long int stepLocal_0 = (min (var_1_4 , var_1_5)) / var_1_6;
	...
	if (var_1_3 <= (var_1_6 * (max (var_1_4 , var_1_5)))) {
		if ((min ((var_1_6 * var_1_4) , (var_1_11 - var_1_12))) > (min (var_1_3 , var_1_5))) {
			var_1_10 = var_1_13;
		}
	}
	...
	if (stepLocal_1 <= (var_1_12 << (max (var_1_21 , var_1_22)))) {
		var_1_20 = -64;
	}
}
...
int property(void) {
	return ((((var_1_3 != ((min (var_1_4 , var_1_5)) / var_1_6)) ? (var_1_1 == ((unsigned char) (! var_1_7))) : (var_1_1 == ((unsigned char) ((var_1_7 && var_1_8) && var_1_9)))) && ((var_1_3 <= (var_1_6 * (max (var_1_4 , var_1_5)))) ? (((min ((var_1_6 * var_1_4) , (var_1_11 - var_1_12))) > (min (var_1_3 , var_1_5))) ? (var_1_10 == ((double) var_1_13)) : 1) : 1)) && (var_1_1 ? (var_1_14 == ((signed short int) ((min (var_1_15 , var_1_16)) + var_1_17))) : (var_1_14 == ((signed short int) (var_1_18 - var_1_19))))) && ((var_1_5 <= (var_1_12 << (max (var_1_21 , var_1_22)))) ? (var_1_20 == ((signed char) -64)) : 1)
;
}
int main(void) {
	isInitial = 1;
