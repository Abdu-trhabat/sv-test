...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19normal.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_7 < var_1_3) {
  ...
  if ((var_1_8 + ((((var_1_2) < 0 ) ? -(var_1_2) : (var_1_2)))) > var_1_7) {
   var_1_10 = var_1_8;
  }
 }
 var_1_13 = var_1_7;
...
int property(void) {
 return ((((((var_1_2 - var_1_3) << (var_1_4 + var_1_5)) <= var_1_11) ? (var_1_1 == ((signed char) ((((var_1_4) > (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))))) ? (var_1_4) : (((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))))))) : (var_1_9 ? (var_1_1 == ((signed char) var_1_5)) : 1)) && ((var_1_7 < var_1_3) ? ((last_1_var_1_11 > var_1_7) ? (var_1_10 == ((signed long int) (var_1_3 - var_1_8))) : 1) : (((var_1_8 + ((((var_1_2) < 0 ) ? -(var_1_2) : (var_1_2)))) > var_1_7) ? (var_1_10 == ((signed long int) var_1_8)) : 1))) && ((((var_1_10 * var_1_13) + var_1_8) > (var_1_2 / var_1_12)) ? (var_1_9 ? (var_1_11 == ((signed long int) var_1_2)) : 1) : (var_1_11 == ((signed long int) var_1_7)))) && (var_1_13 == ((signed long int) var_1_7))
;
}
int main(void) {
 isInitial = 1;
