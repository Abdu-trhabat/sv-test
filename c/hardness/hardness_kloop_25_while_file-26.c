...
void step(void) {
	...
	// From: Req2Batch2625_while
	var_1_6 = (var_1_7 - (var_1_8 + var_1_9));


	// From: Req3Batch2625_while
...
int property(void) {
	return (((var_1_2 > var_1_3) ? (var_1_1 == ((signed short int) (max (var_1_4 , var_1_5)))) : (var_1_1 == ((signed short int) (min (-4 , var_1_5))))) && (var_1_6 == ((double) (var_1_7 - (var_1_8 + var_1_9))))) && ((var_1_11 || (var_1_8 <= (var_1_7 + var_1_9))) ? ((((var_1_7 + var_1_6) / (max (var_1_12 , var_1_13))) <= var_1_9) ? ((var_1_6 > 2.5) ? ((100 > var_1_1) ? (var_1_10 == ((unsigned short int) var_1_14)) : (var_1_10 == ((unsigned short int) var_1_15))) : (var_1_10 == ((unsigned short int) var_1_14))) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
