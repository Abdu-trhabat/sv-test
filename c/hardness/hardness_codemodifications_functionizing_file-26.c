...
unsigned char functionized3(unsigned char functionized3_localFunctionVar0, float functionized3_localFunctionVar1, float functionized3_localFunctionVar2) {
	return (((var_1_13 - functionized3_localFunctionVar2) != (min (functionized3_localFunctionVar1 , var_1_16))) || functionized3_localFunctionVar0);
}
void functionized4(unsigned long int functionized4_localFunctionVar0) {
	if ((min (functionized4_localFunctionVar0 , var_1_19)) < var_1_2) {
		var_1_20 = var_1_22;
	}
}
signed long int functionized5(signed long int localFunctionVar0) {
	return (max (localFunctionVar0 , var_1_11));
}
signed long int functionized6(signed char functionized6_localFunctionVar0) {
	return (max (var_1_26 , functionized6_localFunctionVar0));
}
...
void step(void) {
	...
	// From: Req4Batch26functionizing
	functionized4(var_1_1);


	// From: Req5Batch26functionizing
	if (var_1_10) {
	...
	// From: Req6Batch26functionizing
	if ((min (var_1_17 , var_1_6)) > (var_1_7 | var_1_19)) {
