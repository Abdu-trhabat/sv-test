...
void functionized1(double functionized1_localFunctionVar0, unsigned char functionized1_localFunctionVar1, double functionized1_localFunctionVar2) {
	if (functionized1_localFunctionVar1) {
		var_1_10 = (min (var_1_12 , (min ((min (functionized1_localFunctionVar2 , var_1_14)) , var_1_15))));
	} else {
		var_1_10 = (var_1_16 - (max (functionized1_localFunctionVar0 , var_1_18)));
	}
}
...
void step(void) {
	// From: Req1Batch128functionizing
	if (var_1_2) {
	...
	// From: Req2Batch128functionizing
	if ((! 0) || var_1_2) {
		if (var_1_2) {
			if (var_1_3 > var_1_4) {
				var_1_7 = var_1_8;
	...
	// From: Req3Batch128functionizing
	...
	// From: Req4Batch128functionizing
	if ((var_1_8 + 200) > var_1_7) {
		var_1_19 = var_1_20;
	}


	// From: Req5Batch128functionizing
	if (var_1_13 == 0.8) {
		var_1_21 = (var_1_22 - (1281391062u - var_1_23));
	}


	// From: Req6Batch128functionizing
...
int property(void) {
	return (((((var_1_2 ? ((((~ var_1_3) >= var_1_4) && var_1_5) ? (var_1_5 ? (var_1_1 == ((unsigned long int) var_1_6)) : (var_1_1 == ((unsigned long int) 1u))) : (var_1_1 == ((unsigned long int) var_1_6))) : (var_1_1 == ((unsigned long int) var_1_6))) && (((! 0) || var_1_2) ? (var_1_2 ? ((var_1_3 > var_1_4) ? (var_1_7 == ((signed long int) var_1_8)) : (var_1_7 == ((signed long int) var_1_9))) : (var_1_7 == ((signed long int) var_1_9))) : 1)) && ((var_1_5 || (var_1_2 || var_1_11)) ? (var_1_11 ? (var_1_10 == ((double) (min (var_1_12 , (min ((min (var_1_13 , var_1_14)) , var_1_15)))))) : (var_1_10 == ((double) (var_1_16 - (max (var_1_17 , var_1_18)))))) : ((var_1_1 != var_1_6) ? (var_1_10 == ((double) (abs (15.5)))) : (var_1_10 == ((double) var_1_15))))) && (((var_1_8 + 200) > var_1_7) ? (var_1_19 == ((signed char) var_1_20)) : 1)) && ((var_1_13 == 0.8) ? (var_1_21 == ((unsigned long int) (var_1_22 - (1281391062u - var_1_23)))) : 1)) && (((var_1_26 - (var_1_27 + var_1_28)) == (var_1_23 << var_1_21)) ? (var_1_11 ? (var_1_24 == ((signed short int) var_1_20)) : (var_1_24 == ((signed short int) var_1_27))) : 1)
;
}
int main(void) {
	isInitial = 1;
