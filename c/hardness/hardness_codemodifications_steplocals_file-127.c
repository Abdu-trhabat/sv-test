...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch127stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch127stepLocals
	if (var_1_10) {
		var_1_11 = (var_1_2 && (var_1_8 && var_1_9));
	}


	// From: Req4Batch127stepLocals
	if (var_1_6) {
		var_1_12 = (! var_1_8);
	} else {
	...
	// From: Req5Batch127stepLocals
	var_1_13 = (var_1_14 - var_1_3);


	// From: Req6Batch127stepLocals
	if (var_1_12) {
		var_1_15 = (abs (var_1_16));
	}


	// From: Req7Batch127stepLocals
	signed long int stepLocal_0 = max (var_1_3 , (var_1_7 * var_1_14));
	if (var_1_12) {
		if (stepLocal_0 <= (max (var_1_13 , var_1_5))) {
	...
	// From: Req8Batch127stepLocals
	signed long int stepLocal_2 = max (var_1_3 , (var_1_4 * var_1_1));
