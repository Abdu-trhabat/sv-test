...
void step(void) {
	...
	// From: CodeObject1
	/* 234L, 31L) */ if (/* 235L, 5L, 6L) */ ((/* 236L, 3L, 7L) */ (~ (4))) > (var_1_10))) {
		/* 239L, 26L) */ var_1_28 = (
			/* 242L, 25L) */ (max (
				/* 242L, 25L) */ (
					/* 243L, 22L) */ (min (
	...
	/* 256L, 112L) */ if (/* 257L, 41L, 42L) */ ((/* 258L, 39L, 43L) */ ((var_1_7) >> (var_1_37))) < (var_1_31))) {
		/* 262L, 106L) */ if (/* 263L, 58L, 59L) */ ((/* 264L, 56L, 60L) */ (min (/* 264L, 56L, 60L) */ (var_1_4) , (/* 266L, 55L, 62L) */ (min (/* 266L, 55L, 62L) */ (var_1_8) , (9.999999999999956E13f))))))) <= (var_1_3))) {
			/* 270L, 78L) */ var_1_36 = (
				/* 273L, 77L) */ ((
					var_1_41
				) - (
			...
			/* 276L, 104L) */ if (/* 277L, 81L, 82L) */ ((var_1_10) <= (var_1_34))) {
				/* 280L, 91L) */ var_1_36 = (
					var_1_41
				);
			} else {
	...
	// From: CodeObject4
	/* 298L, 143L) */ if (/* 299L, 128L, 129L) */ ((/* 300L, 126L, 130L) */ ((var_1_31) * (var_1_10))) <= (var_1_37))) {
		/* 304L, 142L) */ var_1_44 = (
			var_1_43
		);
	}
	...
	// From: CodeObject5
	/* 309L, 171L) */ if (/* 310L, 153L, 154L) */ ((/* 311L, 151L, 155L) */ ((var_1_37) | (var_1_10))) <= (var_1_10))) {
		/* 315L, 170L) */ var_1_45 = (
			/* 318L, 169L) */ (abs (
				/* 319L, 168L) */ ((
					var_1_14
	...
	// From: CodeObject6
	/* 323L, 198L) */ if (/* 324L, 181L, 182L) */ ((/* 325L, 179L, 183L) */ (- (/* 326L, 178L, 184L) */ (abs (var_1_8))))) >= (10.25))) {
		/* 329L, 197L) */ var_1_47 = (
			/* 332L, 196L) */ ((
				var_1_43
			) || (
	...
	// From: CodeObject8
	/* 354L, 231L) */ if (/* 355L, 218L, 219L) */ ((var_1_3) >= (var_1_5))) {
		/* 358L, 230L) */ var_1_50 = (
			/* 361L, 229L) */ (abs (
				/* 362L, 228L) */ (abs (
					var_1_37
