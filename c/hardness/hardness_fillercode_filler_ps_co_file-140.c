...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch140Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch140Filler_PS_CO
	/* 1096L, 262L, 896L, 902L) */ var_1_25 = (
		-1
	);


	// From: Req6Batch140Filler_PS_CO
