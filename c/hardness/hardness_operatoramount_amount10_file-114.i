...
int property(void) {
 return ((var_1_3 <= var_1_4) && var_1_2) ? (var_1_1 == ((signed char) ((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6))))) : (((var_1_6 <= var_1_5) || (var_1_4 >= var_1_3)) ? (var_1_1 == ((signed char) var_1_5)) : (var_1_1 == ((signed char) var_1_6)))
;
}
int main(void) {
 isInitial = 1;
