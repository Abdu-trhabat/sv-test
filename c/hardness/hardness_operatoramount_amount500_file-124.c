...
void step(void) {
	// From: Req29Batch124Amount500
	if (-8 > var_1_19) {
		var_1_77 = (var_1_57 + last_1_var_1_68);
	}


	// From: Req13Batch124Amount500
	unsigned long int stepLocal_10 = min (var_1_15 , last_1_var_1_90);
	if (! last_1_var_1_7) {
		if (! var_1_11) {
			var_1_42 = (min (var_1_6 , 999999.5));
		}
	} else {
	...
	if (var_1_33 < stepLocal_17) {
		...
		if (var_1_47 >= (max (var_1_42 , (max (var_1_45 , var_1_43))))) {
			var_1_52 = (min ((max (var_1_35 , 0)) , var_1_33));
		} else {
			var_1_52 = var_1_16;
		}
	}
	...
	// From: Req3Batch124Amount500
	if (var_1_77 >= var_1_5) {
		var_1_12 = (min (var_1_14 , (var_1_15 - (var_1_16 - var_1_17))));
	} else {
		var_1_12 = (((abs (54291)) - var_1_17) - (abs (var_1_16)));
	}


	// From: Req16Batch124Amount500
	if (var_1_11) {
		var_1_53 = (128 - var_1_34);
	} else {
		var_1_53 = (var_1_32 - (max (var_1_35 , var_1_34)));
	}


	// From: Req18Batch124Amount500
	if (((var_1_56 - var_1_47) - var_1_45) != var_1_46) {
		var_1_55 = var_1_36;
	} else {
		var_1_55 = ((max ((var_1_34 + var_1_33) , (var_1_57 + 32))) + 4);
	}


	// From: Req26Batch124Amount500
	var_1_72 = (var_1_24 && var_1_23);


	// From: Req27Batch124Amount500
	if (var_1_56 >= var_1_47) {
		if (var_1_11) {
			var_1_73 = ((var_1_45 - (max (var_1_47 , var_1_46))) - var_1_6);
		} else {
			var_1_73 = (max (var_1_44 , (var_1_46 + (var_1_74 + var_1_75))));
		}
	} else {
		var_1_73 = (max (var_1_45 , var_1_6));
	}


	// From: Req31Batch124Amount500
	if (! var_1_66) {
	...
	// From: Req34Batch124Amount500
	var_1_84 = var_1_85;


	// From: Req35Batch124Amount500
	var_1_86 = var_1_33;


	// From: Req36Batch124Amount500
	if (var_1_72) {
		var_1_87 = var_1_33;
	} else {
		var_1_87 = 4;
	...
	// From: Req38Batch124Amount500
	if (var_1_23) {
		var_1_89 = var_1_24;
	}


	// From: Req39Batch124Amount500
	if (var_1_72) {
		var_1_90 = 0u;
	} else {
		var_1_90 = var_1_40;
	...
	// From: Req40Batch124Amount500
	if (var_1_24) {
		var_1_91 = var_1_33;
	}


	// From: Req41Batch124Amount500
	var_1_92 = var_1_57;


	// From: Req43Batch124Amount500
	var_1_94 = var_1_32;


	// From: Req44Batch124Amount500
	var_1_95 = var_1_33;


	// From: Req46Batch124Amount500
	if (var_1_65) {
		if ((var_1_84 / (min (var_1_56 , var_1_98))) == var_1_44) {
	...
	// From: Req19Batch124Amount500
	unsigned long int stepLocal_18 = var_1_77 * var_1_92;
	if (var_1_52 > stepLocal_18) {
		if (var_1_63) {
			var_1_58 = (min ((var_1_48 - (var_1_46 + var_1_47)) , var_1_45));
		} else {
	...
	// From: Req17Batch124Amount500
	if (var_1_83) {
		if (var_1_23 || var_1_72) {
			var_1_54 = (max (var_1_76 , 4));
		} else {
	...
	// From: Req45Batch124Amount500
	var_1_96 = var_1_54;


	// From: Req10Batch124Amount500
	if (var_1_27 > 128u) {
		if (! var_1_83) {
			var_1_38 = (var_1_3 + (max ((var_1_28 - var_1_93) , (var_1_36 + var_1_34))));
		} else {
			var_1_38 = (max ((min (var_1_36 , 0u)) , var_1_5));
		}
	} else {
		var_1_38 = (min (var_1_26 , 0u));
	}


	// From: Req37Batch124Amount500
	if (var_1_63) {
		var_1_88 = var_1_25;
	}


	// From: Req1Batch124Amount500
	if ((var_1_38 * (3669925837u - var_1_3)) > (2965407302u - (var_1_4 - var_1_5))) {
		var_1_1 = (var_1_6 - 32.25f);
	}


	// From: Req14Batch124Amount500
	unsigned long int stepLocal_16 = 32 * var_1_4;
	unsigned char stepLocal_15 = var_1_63;
	unsigned long int stepLocal_14 = max ((var_1_15 / var_1_4) , var_1_16);
	...
	if (var_1_44 < (var_1_48 + var_1_46)) {
		...
		if (stepLocal_13 <= (var_1_90 + (var_1_28 | var_1_27))) {
			if (stepLocal_12 != var_1_93) {
				...
				var_1_49 = (max (var_1_14 , var_1_93));
			}
		} else {
			if (stepLocal_14 <= var_1_88) {
				if (! (var_1_72 && var_1_24)) {
					var_1_49 = (max ((abs (min (var_1_19 , var_1_16))) , (min (var_1_34 , (64 + var_1_32)))));
				} else {
					var_1_49 = (59519 - 16);
				}
			} else {
				if (stepLocal_11 < var_1_17) {
					if (0 >= stepLocal_16) {
						var_1_49 = (max (var_1_34 , (var_1_21 + var_1_32)));
					} else {
						var_1_49 = (max (var_1_33 , var_1_16));
					}
				}
			}
		}
	...
	// From: Req21Batch124Amount500
	if ((abs (min (var_1_43 , 199.6))) >= (var_1_58 / 9.875)) {
		var_1_60 = (var_1_48 + var_1_46);
	}


	// From: Req30Batch124Amount500
	if (var_1_65) {
		var_1_78 = (var_1_32 - var_1_33);
	} else {
		if (var_1_73 < (min ((- var_1_1) , var_1_73))) {
			var_1_78 = ((max ((max (var_1_32 , var_1_79)) , var_1_80)) - var_1_57);
		}
	}


	// From: Req2Batch124Amount500
	...
	// From: Req5Batch124Amount500
	if ((var_1_17 != (var_1_5 / var_1_16)) && var_1_22) {
		if (var_1_22) {
			var_1_20 = (max ((10 + var_1_17) , var_1_14));
		} else {
			var_1_20 = (max ((var_1_17 + var_1_16) , var_1_15));
		}
	} else {
		if (var_1_22) {
			if (var_1_9 >= (var_1_6 - (abs (var_1_42)))) {
				var_1_20 = (var_1_16 + (max (var_1_17 , var_1_21)));
			}
		}
	}


	// From: Req22Batch124Amount500
	if ((var_1_32 - var_1_57) < var_1_38) {
		if (var_1_83 && (var_1_25 != var_1_36)) {
			var_1_61 = (min (var_1_81 , (var_1_40 + 1000)));
		}
	} else {
		var_1_61 = (var_1_88 - (max ((var_1_62 - var_1_93) , var_1_90)));
	}


	// From: Req11Batch124Amount500
	if (! var_1_7) {
		var_1_39 = (max (0 , var_1_19));
	} else {
		if (var_1_42 >= var_1_9) {
			var_1_39 = (500 + (var_1_16 - var_1_17));
		} else {
			var_1_39 = ((max ((var_1_40 - var_1_32) , var_1_19)) - var_1_35);
		}
	}


	// From: Req12Batch124Amount500
	if (! var_1_23) {
		if (var_1_23) {
			var_1_41 = (min ((abs (var_1_34 - var_1_35)) , var_1_40));
		}
	} else {
		if (var_1_52 < var_1_35) {
			var_1_41 = ((var_1_17 + var_1_20) - (min (var_1_32 , var_1_33)));
		} else {
			var_1_41 = (min (var_1_17 , var_1_35));
		}
	}


	// From: Req25Batch124Amount500
	if (((var_1_45 + var_1_58) + (var_1_48 - var_1_46)) <= var_1_42) {
		...
		if (var_1_66 || var_1_67) {
			if (! var_1_22) {
				if (var_1_22) {
					var_1_70 = ((max ((var_1_17 - var_1_33) , (min (var_1_61 , var_1_34)))) + var_1_35);
				} else {
					var_1_70 = (-256 + var_1_35);
				}
			} else {
				var_1_70 = (max (var_1_71 , (var_1_33 - var_1_57)));
			}
		} else {
			var_1_70 = (min (var_1_33 , (max ((var_1_86 - 2) , var_1_34))));
		}
	}


	// From: Req32Batch124Amount500
	if (var_1_23) {
		if (var_1_61 > ((var_1_88 * var_1_90) / var_1_62)) {
			if (var_1_88 > ((~ var_1_96) * var_1_76)) {
				if ((min (var_1_47 , var_1_9)) != var_1_56) {
		...
		var_1_82 = (abs (var_1_6 - var_1_45));
	}


	// From: Req4Batch124Amount500
	if (var_1_82 <= var_1_10) {
		var_1_18 = (min ((abs (max (var_1_14 , var_1_15))) , (var_1_19 - var_1_17)));
	} else {
		var_1_18 = (abs (var_1_15 - var_1_17));
	}


	// From: Req24Batch124Amount500
	unsigned long int stepLocal_20 = var_1_77 / (max (var_1_69 , var_1_40));
	if ((var_1_27 * var_1_35) <= stepLocal_20) {
		var_1_68 = ((min ((var_1_57 - var_1_33) , var_1_76)) + (min ((abs (var_1_18)) , var_1_32)));
	} else {
		var_1_68 = var_1_32;
	}


	// From: Req9Batch124Amount500
	...
	// From: Req20Batch124Amount500
	unsigned long int stepLocal_19 = var_1_5;
	if (var_1_33 < stepLocal_19) {
		var_1_59 = (max ((var_1_68 + var_1_34) , (var_1_36 - var_1_33)));
	}


	// From: Req8Batch124Amount500
	...
	if (var_1_15 < stepLocal_7) {
		if (var_1_18 > stepLocal_5) {
			...
			var_1_31 = (abs (abs (var_1_34)));
		}
	} else {
		if (stepLocal_8 && var_1_11) {
			var_1_31 = (max ((abs (2)) , 128));
		} else {
			if ((abs (var_1_27)) < stepLocal_4) {
				var_1_31 = ((min ((var_1_32 - 50) , (200 - 10))) - var_1_35);
			} else {
				if ((5 - var_1_35) < stepLocal_6) {
					var_1_31 = (var_1_32 - (max (var_1_33 , (var_1_36 - var_1_34))));
				} else {
					var_1_31 = (min (var_1_33 , var_1_36));
				}
			}
		}
	}
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((var_1_38 * (3669925837u - var_1_3)) > (2965407302u - (var_1_4 - var_1_5))) ? (var_1_1 == ((float) (var_1_6 - 32.25f))) : 1) && ((var_1_89 && (var_1_88 < var_1_3)) ? ((((var_1_58 + var_1_6) / var_1_9) < var_1_42) ? (var_1_7 == ((unsigned char) (! (! var_1_11)))) : 1) : (var_1_7 == ((unsigned char) ((var_1_5 == 32u) && var_1_11))))) && ((var_1_77 >= var_1_5) ? (var_1_12 == ((unsigned short int) (min (var_1_14 , (var_1_15 - (var_1_16 - var_1_17)))))) : (var_1_12 == ((unsigned short int) (((abs (54291)) - var_1_17) - (abs (var_1_16))))))) && ((var_1_82 <= var_1_10) ? (var_1_18 == ((unsigned short int) (min ((abs (max (var_1_14 , var_1_15))) , (var_1_19 - var_1_17))))) : (var_1_18 == ((unsigned short int) (abs (var_1_15 - var_1_17)))))) && (((var_1_17 != (var_1_5 / var_1_16)) && var_1_22) ? (var_1_22 ? (var_1_20 == ((unsigned short int) (max ((10 + var_1_17) , var_1_14)))) : (var_1_20 == ((unsigned short int) (max ((var_1_17 + var_1_16) , var_1_15))))) : (var_1_22 ? ((var_1_9 >= (var_1_6 - (abs (var_1_42)))) ? (var_1_20 == ((unsigned short int) (var_1_16 + (max (var_1_17 , var_1_21))))) : 1) : 1))) && ((! (var_1_25 <= var_1_19)) ? (var_1_22 == ((unsigned char) (var_1_7 || (! var_1_11)))) : ((var_1_14 == (- (max (var_1_25 , var_1_54)))) ? (var_1_22 == ((unsigned char) (var_1_23 && var_1_24))) : ((var_1_24 && (var_1_14 > (var_1_21 << var_1_15))) ? (var_1_22 == ((unsigned char) var_1_24)) : (var_1_22 == ((unsigned char) var_1_23)))))) && (var_1_11 ? (var_1_25 == ((unsigned long int) (((var_1_26 + var_1_27) + var_1_28) - var_1_21))) : ((var_1_6 > (- 7.75f)) ? (var_1_25 == ((unsigned long int) (abs (abs (var_1_15))))) : (((500 != last_1_var_1_96) && last_1_var_1_63) ? (var_1_25 == ((unsigned long int) (var_1_30 - var_1_16))) : (var_1_25 == ((unsigned long int) (var_1_5 + var_1_21))))))) && ((var_1_15 < (var_1_16 * var_1_38)) ? ((var_1_18 > var_1_37) ? (var_1_31 == ((unsigned char) (((var_1_32 - var_1_33) - var_1_34) - var_1_35))) : (var_1_31 == ((unsigned char) (abs (abs (var_1_34)))))) : ((var_1_7 && var_1_11) ? (var_1_31 == ((unsigned char) (max ((abs (2)) , 128)))) : (((abs (var_1_27)) < (50u & (var_1_30 - var_1_37))) ? (var_1_31 == ((unsigned char) ((min ((var_1_32 - 50) , (200 - 10))) - var_1_35))) : (((5 - var_1_35) < ((var_1_26 - var_1_3) | (var_1_34 * var_1_15))) ? (var_1_31 == ((unsigned char) (var_1_32 - (max (var_1_33 , (var_1_36 - var_1_34)))))) : (var_1_31 == ((unsigned char) (min (var_1_33 , var_1_36))))))))) && ((var_1_15 <= ((var_1_19 - var_1_68) / var_1_36)) ? (var_1_37 == ((signed long int) (abs (var_1_34)))) : 1)) && ((var_1_27 > 128u) ? ((! var_1_83) ? (var_1_38 == ((unsigned long int) (var_1_3 + (max ((var_1_28 - var_1_93) , (var_1_36 + var_1_34)))))) : (var_1_38 == ((unsigned long int) (max ((min (var_1_36 , 0u)) , var_1_5))))) : (var_1_38 == ((unsigned long int) (min (var_1_26 , 0u)))))) && ((! var_1_7) ? (var_1_39 == ((unsigned short int) (max (0 , var_1_19)))) : ((var_1_42 >= var_1_9) ? (var_1_39 == ((unsigned short int) (500 + (var_1_16 - var_1_17)))) : (var_1_39 == ((unsigned short int) ((max ((var_1_40 - var_1_32) , var_1_19)) - var_1_35)))))) && ((! var_1_23) ? (var_1_23 ? (var_1_41 == ((signed short int) (min ((abs (var_1_34 - var_1_35)) , var_1_40)))) : 1) : ((var_1_52 < var_1_35) ? (var_1_41 == ((signed short int) ((var_1_17 + var_1_20) - (min (var_1_32 , var_1_33))))) : (var_1_41 == ((signed short int) (min (var_1_17 , var_1_35))))))) && ((! last_1_var_1_7) ? ((! var_1_11) ? (var_1_42 == ((double) (min (var_1_6 , 999999.5)))) : 1) : (((min (var_1_15 , last_1_var_1_90)) > var_1_34) ? (var_1_42 == ((double) (var_1_43 + var_1_44))) : (var_1_42 == ((double) ((var_1_45 - var_1_46) - (var_1_47 + var_1_48))))))) && ((var_1_44 < (var_1_48 + var_1_46)) ? ((var_1_63 || var_1_11) ? (var_1_49 == ((unsigned short int) (var_1_33 + var_1_35))) : (var_1_49 == ((unsigned short int) (var_1_32 + var_1_36)))) : (((var_1_4 << var_1_36) <= (var_1_90 + (var_1_28 | var_1_27))) ? (((var_1_90 * var_1_5) != var_1_93) ? (var_1_49 == ((unsigned short int) (var_1_19 - var_1_93))) : (var_1_49 == ((unsigned short int) (max (var_1_14 , var_1_93))))) : (((max ((var_1_15 / var_1_4) , var_1_16)) <= var_1_88) ? ((! (var_1_72 && var_1_24)) ? (var_1_49 == ((unsigned short int) (max ((abs (min (var_1_19 , var_1_16))) , (min (var_1_34 , (64 + var_1_32))))))) : (var_1_49 == ((unsigned short int) (59519 - 16)))) : ((var_1_21 < var_1_17) ? ((0 >= (32 * var_1_4)) ? (var_1_49 == ((unsigned short int) (max (var_1_34 , (var_1_21 + var_1_32))))) : (var_1_49 == ((unsigned short int) (max (var_1_33 , var_1_16))))) : 1))))) && ((var_1_33 < var_1_15) ? ((49.875f <= var_1_43) ? (var_1_52 == ((signed long int) ((last_1_var_1_52 + -5) + (100 - var_1_33)))) : (var_1_24 ? (var_1_52 == ((signed long int) (var_1_27 - var_1_16))) : 1)) : ((var_1_47 >= (max (var_1_42 , (max (var_1_45 , var_1_43))))) ? (var_1_52 == ((signed long int) (min ((max (var_1_35 , 0)) , var_1_33)))) : (var_1_52 == ((signed long int) var_1_16))))) && (var_1_11 ? (var_1_53 == ((unsigned char) (128 - var_1_34))) : (var_1_53 == ((unsigned char) (var_1_32 - (max (var_1_35 , var_1_34))))))) && (var_1_83 ? ((var_1_23 || var_1_72) ? (var_1_54 == ((unsigned short int) (max (var_1_76 , 4)))) : (var_1_54 == ((unsigned short int) (var_1_40 - var_1_35)))) : (var_1_54 == ((unsigned short int) var_1_32)))) && ((((var_1_56 - var_1_47) - var_1_45) != var_1_46) ? (var_1_55 == ((unsigned char) var_1_36)) : (var_1_55 == ((unsigned char) ((max ((var_1_34 + var_1_33) , (var_1_57 + 32))) + 4))))) && ((var_1_52 > (var_1_77 * var_1_92)) ? (var_1_63 ? (var_1_58 == ((float) (min ((var_1_48 - (var_1_46 + var_1_47)) , var_1_45)))) : (var_1_58 == ((float) (var_1_47 + var_1_43)))) : (var_1_58 == ((float) var_1_46)))) && ((var_1_33 < var_1_5) ? (var_1_59 == ((signed short int) (max ((var_1_68 + var_1_34) , (var_1_36 - var_1_33))))) : 1)) && (((abs (min (var_1_43 , 199.6))) >= (var_1_58 / 9.875)) ? (var_1_60 == ((float) (var_1_48 + var_1_46))) : 1)) && (((var_1_32 - var_1_57) < var_1_38) ? ((var_1_83 && (var_1_25 != var_1_36)) ? (var_1_61 == ((signed long int) (min (var_1_81 , (var_1_40 + 1000))))) : 1) : (var_1_61 == ((signed long int) (var_1_88 - (max ((var_1_62 - var_1_93) , var_1_90))))))) && ((! last_1_var_1_83) ? ((! ((var_1_21 - var_1_57) >= (last_1_var_1_52 ^ var_1_34))) ? (var_1_23 ? (var_1_63 == ((unsigned char) (last_1_var_1_83 || (! (var_1_24 && var_1_11))))) : 1) : (var_1_63 == ((unsigned char) var_1_11))) : (var_1_63 == ((unsigned char) ((var_1_11 || var_1_64) || ((var_1_65 || var_1_66) || var_1_67)))))) && (((var_1_27 * var_1_35) <= (var_1_77 / (max (var_1_69 , var_1_40)))) ? (var_1_68 == ((signed short int) ((min ((var_1_57 - var_1_33) , var_1_76)) + (min ((abs (var_1_18)) , var_1_32))))) : (var_1_68 == ((signed short int) var_1_32)))) && ((((var_1_45 + var_1_58) + (var_1_48 - var_1_46)) <= var_1_42) ? (var_1_70 == ((signed short int) var_1_35)) : ((var_1_66 || var_1_67) ? ((! var_1_22) ? (var_1_22 ? (var_1_70 == ((signed short int) ((max ((var_1_17 - var_1_33) , (min (var_1_61 , var_1_34)))) + var_1_35))) : (var_1_70 == ((signed short int) (-256 + var_1_35)))) : (var_1_70 == ((signed short int) (max (var_1_71 , (var_1_33 - var_1_57)))))) : (var_1_70 == ((signed short int) (min (var_1_33 , (max ((var_1_86 - 2) , var_1_34))))))))) && (var_1_72 == ((unsigned char) (var_1_24 && var_1_23)))) && ((var_1_56 >= var_1_47) ? (var_1_11 ? (var_1_73 == ((float) ((var_1_45 - (max (var_1_47 , var_1_46))) - var_1_6))) : (var_1_73 == ((float) (max (var_1_44 , (var_1_46 + (var_1_74 + var_1_75))))))) : (var_1_73 == ((float) (max (var_1_45 , var_1_6)))))) && ((! last_1_var_1_72) ? (last_1_var_1_22 ? (((var_1_21 % -64) != last_1_var_1_25) ? (var_1_76 == ((signed long int) last_1_var_1_25)) : (var_1_76 == ((signed long int) var_1_40))) : (var_1_76 == ((signed long int) var_1_26))) : (var_1_76 == ((signed long int) var_1_16)))) && ((-8 > var_1_19) ? (var_1_77 == ((unsigned long int) (var_1_57 + last_1_var_1_68))) : 1)) && (var_1_65 ? (var_1_78 == ((unsigned char) (var_1_32 - var_1_33))) : ((var_1_73 < (min ((- var_1_1) , var_1_73))) ? (var_1_78 == ((unsigned char) ((max ((max (var_1_32 , var_1_79)) , var_1_80)) - var_1_57))) : 1))) && ((! var_1_66) ? (var_1_81 == ((unsigned short int) (100 + var_1_16))) : (var_1_81 == ((unsigned short int) (var_1_19 - var_1_34))))) && (var_1_23 ? ((var_1_61 > ((var_1_88 * var_1_90) / var_1_62)) ? ((var_1_88 > ((~ var_1_96) * var_1_76)) ? (((min (var_1_47 , var_1_9)) != var_1_56) ? (var_1_82 == ((float) (var_1_47 - var_1_46))) : (var_1_82 == ((float) var_1_75))) : (var_1_82 == ((float) 9.74f))) : 1) : (var_1_82 == ((float) (abs (var_1_6 - var_1_45)))))) && ((var_1_65 && last_1_var_1_63) ? ((var_1_79 <= var_1_33) ? (var_1_83 == ((unsigned char) (((var_1_69 == last_1_var_1_88) || var_1_23) && (last_1_var_1_7 || var_1_24)))) : ((last_1_var_1_20 > last_1_var_1_25) ? ((last_1_var_1_86 >= (var_1_17 / var_1_36)) ? (var_1_83 == ((unsigned char) (var_1_67 || (var_1_24 || var_1_23)))) : (var_1_83 == ((unsigned char) (! (var_1_67 && var_1_65))))) : (var_1_83 == ((unsigned char) ((last_1_var_1_7 || var_1_24) && var_1_23))))) : (var_1_83 == ((unsigned char) var_1_67)))) && (var_1_84 == ((float) var_1_85))) && (var_1_86 == ((unsigned char) var_1_33))) && (var_1_72 ? (var_1_87 == ((signed char) var_1_33)) : (var_1_87 == ((signed char) 4)))) && (var_1_63 ? (var_1_88 == ((unsigned long int) var_1_25)) : 1)) && (var_1_23 ? (var_1_89 == ((unsigned char) var_1_24)) : 1)) && (var_1_72 ? (var_1_90 == ((unsigned long int) 0u)) : (var_1_90 == ((unsigned long int) var_1_40)))) && (var_1_24 ? (var_1_91 == ((signed char) var_1_33)) : 1)) && (var_1_92 == ((unsigned short int) var_1_57))) && (var_1_63 ? (var_1_93 == ((unsigned short int) var_1_19)) : (var_1_93 == ((unsigned short int) var_1_16)))) && (var_1_94 == ((signed char) var_1_32))) && (var_1_95 == ((unsigned short int) var_1_33))) && (var_1_96 == ((signed long int) var_1_54))) && (var_1_65 ? (((var_1_84 / (min (var_1_56 , var_1_98))) == var_1_44) ? ((var_1_47 < var_1_74) ? (var_1_97 == ((signed long int) (var_1_17 - 100))) : (var_1_97 == ((signed long int) var_1_26))) : (var_1_97 == ((signed long int) -32))) : (var_1_97 == ((signed long int) var_1_33)))
;
}
int main(void) {
	isInitial = 1;
