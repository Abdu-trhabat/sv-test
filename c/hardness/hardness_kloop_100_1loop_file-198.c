...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch198100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch198100_1loop
	var_1_1 = ((max ((var_1_2 + var_1_3) , var_1_4)) - var_1_5);


	// From: Req2Batch198100_1loop
	...
	// From: Req11Batch198100_1loop
	var_1_32 = var_1_4;


	// From: Req14Batch198100_1loop
	if (var_1_26 <= (var_1_2 ^ 0)) {
		var_1_36 = ((var_1_10 - var_1_37) + var_1_9);
	}


	// From: Req15Batch198100_1loop
	var_1_38 = var_1_10;


	// From: Req5Batch198100_1loop
	if (! var_1_12) {
		if (var_1_27) {
			if (var_1_11) {
