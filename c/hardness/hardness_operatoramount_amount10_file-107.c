...
int property(void) {
	return (var_1_1 == ((signed long int) (var_1_2 + var_1_3))) && ((var_1_2 <= ((var_1_5 + var_1_6) - var_1_7)) ? ((((max (var_1_6 , var_1_5)) / var_1_8) <= var_1_3) ? (var_1_4 == ((unsigned char) var_1_9)) : (var_1_4 == ((unsigned char) 0))) : 1)
;
}
int main(void) {
	isInitial = 1;
