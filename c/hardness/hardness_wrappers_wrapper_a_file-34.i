...
void step(void) {
 ...
 if (stepLocal_0 >= signed_long_int_Array_0[0]) {
  if (((unsigned_char_Array_0[2] + unsigned_char_Array_0[0]) - ((((unsigned_char_Array_0[1]) < (1)) ? (unsigned_char_Array_0[1]) : (1)))) > stepLocal_1) {
