...
void step(void) {
	// From: Req2Batch157Wrapper_P
	if (((*(var_1_9_Pointer)) + (*(var_1_10_Pointer))) >= ((min ((*(var_1_11_Pointer)) , (*(var_1_12_Pointer)))) - (min ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))))) {
	...
	// From: Req3Batch157Wrapper_P
	if ((*(var_1_6_Pointer)) && ((*(var_1_19_Pointer)) && (*(var_1_20_Pointer)))) {
		(*(var_1_18_Pointer)) = -200;
	}


	// From: Req4Batch157Wrapper_P
	(*(var_1_21_Pointer)) = ((*(var_1_22_Pointer)) - ((32 - (*(var_1_23_Pointer))) + (min ((*(var_1_24_Pointer)) , (*(var_1_25_Pointer))))));


	// From: Req1Batch157Wrapper_P
	signed long int stepLocal_1 = max (((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) , (*(var_1_8_Pointer)));
