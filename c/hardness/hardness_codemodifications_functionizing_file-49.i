...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch49functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
void functionized0(unsigned long int, unsigned long int);
...
void functionized0(unsigned long int functionized0_localFunctionVar0, unsigned long int functionized0_localFunctionVar1) {
 if (! var_1_2) {
  if ((var_1_7 * ((((functionized0_localFunctionVar0) < (functionized0_localFunctionVar1)) ? (functionized0_localFunctionVar0) : (functionized0_localFunctionVar1)))) >= var_1_4) {
   var_1_12 = var_1_14;
  }
 } else {
  var_1_12 = 0;
...
float functionized1(float functionized1_localFunctionVar0) {
 return (((((- 9.5f)) > ((- functionized1_localFunctionVar0))) ? ((- 9.5f)) : ((- functionized1_localFunctionVar0))));
}
unsigned long int functionized2(void) {
 return (256u * var_1_11);
}
void initially(void) {
}
void step(void) {
 ...
 functionized0(var_1_5, var_1_1);
 if (functionized1(var_1_16) < var_1_17) {
  var_1_15 = ((((var_1_18) < (var_1_19)) ? (var_1_18) : (var_1_19)));
 }
 if (var_1_14 && var_1_2) {
  if (var_1_4 > functionized2()) {
