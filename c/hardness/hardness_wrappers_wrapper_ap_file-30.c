...
void step(void) {
	...
	if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var6_Pointer)) > stepLocal_4) {
		if (stepLocal_3 <= ((max ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)))) << ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))))) {
