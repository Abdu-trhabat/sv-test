...
void step(void) {
	// From: Req2Batch136Amount250
	signed long int stepLocal_1 = var_1_5 - var_1_7;
	unsigned char stepLocal_0 = var_1_6;
	if (stepLocal_0 >= last_1_var_1_36) {
		if ((last_1_var_1_36 * (max (last_1_var_1_62 , var_1_4))) <= stepLocal_1) {
			if (var_1_9 <= var_1_12) {
				var_1_15 = var_1_7;
			} else {
				var_1_15 = ((min ((max (last_1_var_1_62 , var_1_6)) , (min (last_1_var_1_36 , var_1_4)))) - (var_1_16 - last_1_var_1_59));
			}
		}
	} else {
		if (var_1_9 >= var_1_11) {
			var_1_15 = (min ((min (last_1_var_1_59 , (min (var_1_5 , var_1_4)))) , (var_1_7 + last_1_var_1_36)));
		} else {
	...
	// From: Req3Batch136Amount250
	if (128 < ((min (var_1_6 , last_1_var_1_43)) << last_1_var_1_15)) {
		var_1_17 = (4.75 + var_1_18);
	} else {
		var_1_17 = (var_1_18 + ((var_1_19 + var_1_20) - (min (var_1_21 , 128.4))));
	}


	// From: Req15Batch136Amount250
	if ((min (var_1_17 , 16.75f)) == (- var_1_17)) {
	...
	// From: Req17Batch136Amount250
	signed long int stepLocal_6 = -5;
	if (var_1_27) {
		if (stepLocal_6 == (var_1_52 / (min (var_1_4 , var_1_5)))) {
			var_1_58 = (var_1_25 || var_1_28);
		}
	}


	// From: Req18Batch136Amount250
	if (var_1_13 != (var_1_17 + var_1_51)) {
		var_1_59 = (var_1_60 - ((10000 + var_1_61) - var_1_40));
	}


	// From: Req19Batch136Amount250
	signed long int stepLocal_7 = var_1_61 << var_1_32;
	if (((var_1_41 | var_1_45) / (max (var_1_46 , var_1_4))) > stepLocal_7) {
		if (var_1_58) {
			var_1_62 = var_1_35;
		} else {
			var_1_62 = var_1_47;
	...
	// From: Req7Batch136Amount250
	if (var_1_18 >= (- (abs (var_1_17)))) {
		var_1_29 = (var_1_18 + var_1_30);
	}


	// From: Req8Batch136Amount250
	if (50.5f <= var_1_13) {
		var_1_31 = (var_1_32 + (max (var_1_33 , (var_1_34 - var_1_35))));
	} else {
		var_1_31 = var_1_33;
	}


	// From: Req10Batch136Amount250
	signed long int stepLocal_5 = 16;
	signed long int stepLocal_4 = min ((var_1_4 * var_1_16) , var_1_15);
	if (stepLocal_4 < var_1_59) {
		var_1_39 = (min ((var_1_35 + (var_1_34 - var_1_40)) , (abs (var_1_33))));
	} else {
		if (var_1_58) {
			var_1_39 = ((max ((var_1_41 + var_1_42) , var_1_34)) + var_1_33);
		} else {
			if (var_1_7 >= stepLocal_5) {
				var_1_39 = (min (var_1_40 , (var_1_32 + (var_1_35 - var_1_34))));
			} else {
				var_1_39 = var_1_41;
			}
		}
	...
	// From: Req11Batch136Amount250
	var_1_43 = (min ((var_1_5 - var_1_34) , var_1_40));


	// From: Req12Batch136Amount250
	if ((abs (var_1_6)) >= (32 >> var_1_45)) {
		var_1_44 = ((var_1_46 - var_1_45) - (min ((var_1_35 + var_1_34) , (var_1_40 + var_1_47))));
	}


	// From: Req14Batch136Amount250
	if (var_1_17 > var_1_9) {
		var_1_50 = 8.8f;
	} else {
		var_1_50 = ((max (var_1_20 , var_1_51)) - 100.5f);
	}


	// From: Req20Batch136Amount250
	unsigned long int stepLocal_8 = (var_1_5 / var_1_45) / (abs (var_1_49));
	if ((var_1_61 + (var_1_35 - 2)) != stepLocal_8) {
		var_1_63 = var_1_5;
	}


	// From: Req9Batch136Amount250
	if (((min (var_1_17 , var_1_20)) / (max (var_1_26 , 128.5))) > (var_1_30 / var_1_37)) {
		var_1_36 = (min (var_1_52 , (var_1_38 - (min (var_1_34 , var_1_6)))));
	} else {
		if ((var_1_35 % 25) < -128) {
			var_1_36 = var_1_35;
		} else {
	...
	// From: Req16Batch136Amount250
	if (var_1_50 >= var_1_30) {
		if ((var_1_20 * var_1_17) <= (min (var_1_19 , var_1_26))) {
			var_1_53 = (abs (var_1_30 + var_1_55));
		}
	} else {
			...
			if (var_1_16 < var_1_35) {
				...
				if (var_1_27) {
					if ((- var_1_63) <= (var_1_16 - var_1_6)) {
						var_1_53 = (max ((var_1_51 - var_1_21) , var_1_55));
					} else {
						var_1_53 = ((min (var_1_30 , (max (var_1_20 , var_1_19)))) + 63.8f);
					}
				} else {
					var_1_53 = ((var_1_57 - var_1_19) - (max ((abs (var_1_30)) , var_1_20)));
				}
			}
		}
	}
	...
	// From: Req1Batch136Amount250
	if (var_1_36 < var_1_48) {
		var_1_1 = ((min ((var_1_4 + 64) , (max (var_1_5 , var_1_6)))) - var_1_7);
	} else {
		if ((var_1_8 * (- var_1_9)) > (min (var_1_10 , (var_1_11 + var_1_12)))) {
	...
	// From: Req4Batch136Amount250
	if (var_1_24) {
		var_1_22 = (max (var_1_7 , (min ((abs (-10)) , (min (var_1_5 , var_1_63))))));
	}
}
...
int property(void) {
	return ((((((((((((((((((((var_1_36 < var_1_48) ? (var_1_1 == ((unsigned char) ((min ((var_1_4 + 64) , (max (var_1_5 , var_1_6)))) - var_1_7))) : (((var_1_8 * (- var_1_9)) > (min (var_1_10 , (var_1_11 + var_1_12)))) ? ((((256.75 - var_1_13) * var_1_9) <= var_1_10) ? (var_1_24 ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_1 == ((unsigned char) var_1_6))) : (var_1_1 == ((unsigned char) var_1_5))) : (var_1_1 == ((unsigned char) 5)))) && ((var_1_6 >= last_1_var_1_36) ? (((last_1_var_1_36 * (max (last_1_var_1_62 , var_1_4))) <= (var_1_5 - var_1_7)) ? ((var_1_9 <= var_1_12) ? (var_1_15 == ((signed long int) var_1_7)) : (var_1_15 == ((signed long int) ((min ((max (last_1_var_1_62 , var_1_6)) , (min (last_1_var_1_36 , var_1_4)))) - (var_1_16 - last_1_var_1_59))))) : 1) : ((var_1_9 >= var_1_11) ? (var_1_15 == ((signed long int) (min ((min (last_1_var_1_59 , (min (var_1_5 , var_1_4)))) , (var_1_7 + last_1_var_1_36))))) : (var_1_15 == ((signed long int) (abs (var_1_16))))))) && ((128 < ((min (var_1_6 , last_1_var_1_43)) << last_1_var_1_15)) ? (var_1_17 == ((double) (4.75 + var_1_18))) : (var_1_17 == ((double) (var_1_18 + ((var_1_19 + var_1_20) - (min (var_1_21 , 128.4)))))))) && (var_1_24 ? (var_1_22 == ((signed short int) (max (var_1_7 , (min ((abs (-10)) , (min (var_1_5 , var_1_63)))))))) : 1)) && (((- var_1_6) <= var_1_62) ? (var_1_23 == ((signed short int) var_1_6)) : (var_1_23 == ((signed short int) ((abs (var_1_48 + 2)) + var_1_7))))) && (((var_1_48 / var_1_4) < var_1_7) ? (var_1_24 == ((unsigned char) (var_1_58 && var_1_25))) : (var_1_58 ? ((((var_1_18 + var_1_17) / (abs (var_1_26))) >= var_1_17) ? (var_1_25 ? (var_1_24 == ((unsigned char) var_1_27)) : (var_1_24 == ((unsigned char) var_1_28))) : (var_1_24 == ((unsigned char) var_1_28))) : (var_1_24 == ((unsigned char) var_1_28))))) && ((var_1_18 >= (- (abs (var_1_17)))) ? (var_1_29 == ((float) (var_1_18 + var_1_30))) : 1)) && ((50.5f <= var_1_13) ? (var_1_31 == ((signed char) (var_1_32 + (max (var_1_33 , (var_1_34 - var_1_35)))))) : (var_1_31 == ((signed char) var_1_33)))) && ((((min (var_1_17 , var_1_20)) / (max (var_1_26 , 128.5))) > (var_1_30 / var_1_37)) ? (var_1_36 == ((unsigned long int) (min (var_1_52 , (var_1_38 - (min (var_1_34 , var_1_6))))))) : (((var_1_35 % 25) < -128) ? (var_1_36 == ((unsigned long int) var_1_35)) : (var_1_36 == ((unsigned long int) (var_1_38 - (var_1_15 + var_1_34))))))) && (((min ((var_1_4 * var_1_16) , var_1_15)) < var_1_59) ? (var_1_39 == ((signed char) (min ((var_1_35 + (var_1_34 - var_1_40)) , (abs (var_1_33)))))) : (var_1_58 ? (var_1_39 == ((signed char) ((max ((var_1_41 + var_1_42) , var_1_34)) + var_1_33))) : ((var_1_7 >= 16) ? (var_1_39 == ((signed char) (min (var_1_40 , (var_1_32 + (var_1_35 - var_1_34)))))) : (var_1_39 == ((signed char) var_1_41)))))) && (var_1_43 == ((unsigned char) (min ((var_1_5 - var_1_34) , var_1_40))))) && (((abs (var_1_6)) >= (32 >> var_1_45)) ? (var_1_44 == ((unsigned char) ((var_1_46 - var_1_45) - (min ((var_1_35 + var_1_34) , (var_1_40 + var_1_47)))))) : 1)) && ((var_1_38 < var_1_44) ? ((((var_1_59 * var_1_35) >= (last_1_var_1_48 / var_1_5)) && var_1_28) ? ((! (16 >= (var_1_36 * var_1_52))) ? (var_1_48 == ((unsigned long int) var_1_44)) : (var_1_48 == ((unsigned long int) ((var_1_49 - var_1_44) - var_1_52)))) : 1) : (var_1_48 == ((unsigned long int) (var_1_34 + var_1_46))))) && ((var_1_17 > var_1_9) ? (var_1_50 == ((float) 8.8f)) : (var_1_50 == ((float) ((max (var_1_20 , var_1_51)) - 100.5f))))) && (((min (var_1_17 , 16.75f)) == (- var_1_17)) ? (var_1_52 == ((unsigned long int) ((var_1_16 + 1136067118u) - var_1_35))) : (var_1_52 == ((unsigned long int) (var_1_38 - var_1_4))))) && ((var_1_50 >= var_1_30) ? (((var_1_20 * var_1_17) <= (min (var_1_19 , var_1_26))) ? (var_1_53 == ((float) (abs (var_1_30 + var_1_55)))) : 1) : ((var_1_49 < var_1_52) ? (var_1_53 == ((float) (var_1_21 + var_1_20))) : ((var_1_16 < var_1_35) ? (var_1_53 == ((float) (var_1_55 + var_1_20))) : (var_1_27 ? (((- var_1_63) <= (var_1_16 - var_1_6)) ? (var_1_53 == ((float) (max ((var_1_51 - var_1_21) , var_1_55)))) : (var_1_53 == ((float) ((min (var_1_30 , (max (var_1_20 , var_1_19)))) + 63.8f)))) : (var_1_53 == ((float) ((var_1_57 - var_1_19) - (max ((abs (var_1_30)) , var_1_20)))))))))) && (var_1_27 ? ((-5 == (var_1_52 / (min (var_1_4 , var_1_5)))) ? (var_1_58 == ((unsigned char) (var_1_25 || var_1_28))) : 1) : 1)) && ((var_1_13 != (var_1_17 + var_1_51)) ? (var_1_59 == ((unsigned short int) (var_1_60 - ((10000 + var_1_61) - var_1_40)))) : 1)) && ((((var_1_41 | var_1_45) / (max (var_1_46 , var_1_4))) > (var_1_61 << var_1_32)) ? (var_1_58 ? (var_1_62 == ((signed long int) var_1_35)) : (var_1_62 == ((signed long int) var_1_47))) : (var_1_62 == ((signed long int) -500)))) && (((var_1_61 + (var_1_35 - 2)) != ((var_1_5 / var_1_45) / (abs (var_1_49)))) ? (var_1_63 == ((unsigned char) var_1_5)) : 1)
;
}
int main(void) {
	isInitial = 1;
