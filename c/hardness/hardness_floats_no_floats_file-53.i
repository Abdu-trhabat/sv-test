...
void step(void) {
 ...
 if (stepLocal_0 != ((((var_1_4) < (var_1_3)) ? (var_1_4) : (var_1_3)))) {
  if (var_1_9 == ((((-50) < ((var_1_10 * var_1_11))) ? (-50) : ((var_1_10 * var_1_11))))) {
