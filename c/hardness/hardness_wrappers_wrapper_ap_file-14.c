...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var4_Pointer)) && stepLocal_0) {
	...
	if ((((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) >= (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer))) && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var4_Pointer))) && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer))) {
