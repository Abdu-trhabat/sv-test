...
void step(void) {
 signed long int stepLocal_0 = ((((32 * last_1_var_1_22)) > (last_1_var_1_12)) ? ((32 * last_1_var_1_22)) : (last_1_var_1_12));
 if (! last_1_var_1_26) {
  if (stepLocal_0 <= last_1_var_1_15) {
   var_1_4 = ((last_1_var_1_22 + (last_1_var_1_12 + var_1_8)) + ((((var_1_9) > (var_1_10)) ? (var_1_9) : (var_1_10))));
  } else {
   var_1_4 = var_1_11;
  }
 } else {
 ...
 if (var_1_18 < var_1_19) {
  var_1_38 = ((((((var_1_39 - last_1_var_1_37) - var_1_35)) > ((var_1_40 - ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))))) ? (((var_1_39 - last_1_var_1_37) - var_1_35)) : ((var_1_40 - ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))))));
 } else {
  if (var_1_29) {
   if (! last_1_var_1_26) {
    var_1_38 = var_1_11;
 ...
 if (var_1_8 < stepLocal_1) {
  ...
  var_1_15 = ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)));
 }
 signed long int stepLocal_2 = var_1_4 >> 2;
 if ((var_1_24 - var_1_25) > stepLocal_2) {
  var_1_23 = (((((var_1_25 - var_1_8)) > (var_1_41)) ? ((var_1_25 - var_1_8)) : (var_1_41)));
 }
...
int property(void) {
 return (((((((((((((var_1_26 ? (var_1_1 == ((double) (4.2 - ((((9.5) > (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))))) ? (9.5) : (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))))))))) : (var_1_1 == ((double) ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))))) && ((! last_1_var_1_26) ? (((((((32 * last_1_var_1_22)) > (last_1_var_1_12)) ? ((32 * last_1_var_1_22)) : (last_1_var_1_12))) <= last_1_var_1_15) ? (var_1_4 == ((unsigned short int) ((last_1_var_1_22 + (last_1_var_1_12 + var_1_8)) + ((((var_1_9) > (var_1_10)) ? (var_1_9) : (var_1_10)))))) : (var_1_4 == ((unsigned short int) var_1_11))) : (var_1_4 == ((unsigned short int) last_1_var_1_12)))) && ((var_1_8 >= var_1_37) ? (var_1_12 == ((signed short int) ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13))))) : 1)) && (var_1_26 ? (var_1_14 == ((float) var_1_3)) : 1)) && ((var_1_8 < var_1_41) ? (var_1_15 == ((signed long int) (var_1_41 + 1))) : (var_1_15 == ((signed long int) ((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))))))) && (((var_1_17 - var_1_18) > var_1_14) ? (var_1_16 == ((float) (var_1_19 + var_1_20))) : 1)) && (var_1_21 == ((double) ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))))) && ((0 <= (var_1_8 << var_1_4)) ? ((var_1_20 > var_1_14) ? (var_1_22 == ((unsigned short int) var_1_10)) : 1) : 1)) && (((var_1_24 - var_1_25) > (var_1_4 >> 2)) ? (var_1_23 == ((signed short int) (((((var_1_25 - var_1_8)) > (var_1_41)) ? ((var_1_25 - var_1_8)) : (var_1_41))))) : 1)) && ((((~ var_1_15) | (var_1_38 * var_1_9)) > 8) ? (var_1_27 ? (var_1_26 == ((unsigned char) (var_1_28 && var_1_29))) : 1) : 1)) && ((var_1_26 && (var_1_12 > var_1_13)) ? (var_1_30 == ((unsigned char) (((((var_1_31) < (((((var_1_32) > (var_1_33)) ? (var_1_32) : (var_1_33))))) ? (var_1_31) : (((((var_1_32) > (var_1_33)) ? (var_1_32) : (var_1_33)))))) - ((((var_1_25) > ((var_1_34 + var_1_35))) ? (var_1_25) : ((var_1_34 + var_1_35))))))) : (var_1_26 ? ((var_1_3 >= ((((- var_1_18) < 0 ) ? -(- var_1_18) : (- var_1_18)))) ? (var_1_30 == ((unsigned char) (var_1_31 - (var_1_36 - var_1_35)))) : (var_1_30 == ((unsigned char) (((((8) < 0 ) ? -(8) : (8))) + var_1_36)))) : 1))) && ((var_1_38 > ((var_1_24 + var_1_36) - var_1_10)) ? (var_1_37 == ((signed long int) var_1_24)) : 1)) && ((var_1_18 < var_1_19) ? (var_1_38 == ((unsigned short int) ((((((var_1_39 - last_1_var_1_37) - var_1_35)) > ((var_1_40 - ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))))) ? (((var_1_39 - last_1_var_1_37) - var_1_35)) : ((var_1_40 - ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))))))))) : (var_1_29 ? ((! last_1_var_1_26) ? (var_1_38 == ((unsigned short int) var_1_11)) : (var_1_38 == ((unsigned short int) last_1_var_1_37))) : (var_1_38 == ((unsigned short int) var_1_36))))) && (var_1_41 == ((unsigned short int) var_1_8))
;
}
int main(void) {
 isInitial = 1;
