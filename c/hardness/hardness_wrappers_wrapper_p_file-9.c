...
void step(void) {
	...
	if (last_1_var_1_11 > 9999999.5f) {
		...
		(*(var_1_9_Pointer)) = (max (((last_1_var_1_1 - (*(var_1_3_Pointer))) + (last_1_var_1_8 - last_1_var_1_9)) , (*(var_1_10_Pointer))));
	}
	...
	if (last_1_var_1_9 <= 16) {
		...
		if ((max ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) < (*(var_1_6_Pointer))) {
			if ((*(var_1_7_Pointer))) {
				(*(var_1_1_Pointer)) = (*(var_1_3_Pointer));
			} else {
				(*(var_1_1_Pointer)) = 64;
	...
	if ((*(var_1_7_Pointer))) {
		...
		(*(var_1_11_Pointer)) = (min ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer))));
	}


	// From: Req2Batch9Wrapper_P
	(*(var_1_8_Pointer)) = (max ((*(var_1_1_Pointer)) , (*(var_1_3_Pointer))));
}
...
int property(void) {
	return ((((last_1_var_1_9 <= 16) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_3_Pointer)))) : (((max ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) < (*(var_1_6_Pointer))) ? ((*(var_1_7_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_3_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned char) 64))) : ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_3_Pointer)))))) && ((*(var_1_8_Pointer)) == ((unsigned short int) (max ((*(var_1_1_Pointer)) , (*(var_1_3_Pointer))))))) && ((last_1_var_1_11 > 9999999.5f) ? ((*(var_1_9_Pointer)) == ((signed long int) (((*(var_1_10_Pointer)) - last_1_var_1_9) - (*(var_1_3_Pointer))))) : ((*(var_1_9_Pointer)) == ((signed long int) (max (((last_1_var_1_1 - (*(var_1_3_Pointer))) + (last_1_var_1_8 - last_1_var_1_9)) , (*(var_1_10_Pointer)))))))) && ((*(var_1_7_Pointer)) ? (((- (*(var_1_9_Pointer))) >= (*(var_1_9_Pointer))) ? ((*(var_1_11_Pointer)) == ((float) ((*(var_1_12_Pointer)) + (*(var_1_13_Pointer))))) : 1) : ((*(var_1_11_Pointer)) == ((float) (min ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))))))
;
}
int main(void) {
	isInitial = 1;
