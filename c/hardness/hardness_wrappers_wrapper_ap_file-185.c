...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch185Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch185Wrapper_AP
	signed long int stepLocal_1 = (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer));
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) && stepLocal_0) {
		if (stepLocal_1 <= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer))) {
			(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) = (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer));
		}
	}


	// From: Req2Batch185Wrapper_AP
	signed short int stepLocal_2 = (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer));
	if (stepLocal_2 == (min (32 , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer))))) {
		if (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
			(*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) = ((abs ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)));
		} else {
	...
	// From: Req3Batch185Wrapper_AP
	signed long int stepLocal_3 = (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer));
	if (-64 < stepLocal_3) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) = ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)));
	} else {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) = (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer));
	}


	// From: Req4Batch185Wrapper_AP
	if ((abs (- (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)))) < (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) + (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer))) - ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))))) {
		(*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) = (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer));
	}
}
...
int property(void) {
	return (((((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) ? ((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer))) <= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer))) ? ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) == ((signed long int) (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)))) : 1) : 1) && (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer)) == (min (32 , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer))))) ? ((! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) == ((double) ((abs ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))))) : ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) == ((double) (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))))) : ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) == ((double) (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))))) && ((-64 < ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)))) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) == ((signed short int) ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))))) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) == ((signed short int) (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)))))) && (((abs (- (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)))) < (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) + (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer))) - ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) == ((double) (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)))) : 1)
;
}
int main(void) {
	isInitial = 1;
