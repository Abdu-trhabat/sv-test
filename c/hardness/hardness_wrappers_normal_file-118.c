...
void step(void) {
	...
	if ((var_1_11 - var_1_12) < var_1_17) {
		if (var_1_14 || (var_1_15 >= (max (var_1_4 , var_1_3)))) {
			if (var_1_12 >= 127.25f) {
				var_1_10 = var_1_3;
			}
		}
...
int property(void) {
	return (((((var_1_15 < 4) ? (var_1_1 == ((signed short int) (var_1_3 + var_1_4))) : (var_1_1 == ((signed short int) (var_1_5 - 5)))) && ((var_1_4 == var_1_15) ? (var_1_6 == ((unsigned char) ((min (var_1_7 , var_1_8)) + (max ((64 + 8) , var_1_9))))) : (var_1_6 == ((unsigned char) (var_1_7 + 4))))) && (((var_1_11 - var_1_12) < var_1_17) ? ((var_1_14 || (var_1_15 >= (max (var_1_4 , var_1_3)))) ? ((var_1_12 >= 127.25f) ? (var_1_10 == ((signed short int) var_1_3)) : 1) : 1) : (var_1_10 == ((signed short int) 16)))) && ((var_1_14 && var_1_16) ? (var_1_15 == ((signed long int) var_1_8)) : 1)) && (var_1_17 == ((double) var_1_18))
;
}
int main(void) {
	isInitial = 1;
