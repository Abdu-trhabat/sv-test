...
void step(void) {
	...
	// From: Req5Batch189no_floats
	var_1_19 = var_1_10;


	// From: Req1Batch189no_floats
	if (var_1_11) {
		var_1_1 = var_1_3;
	} else {
		var_1_1 = (! var_1_4);
...
int property(void) {
	return ((((var_1_11 ? (var_1_1 == ((unsigned char) var_1_3)) : (var_1_1 == ((unsigned char) (! var_1_4)))) && ((! (var_1_11 || var_1_4)) ? (var_1_3 ? (var_1_5 == ((signed long int) (abs (max ((var_1_8 + var_1_9) , var_1_10))))) : 1) : (var_1_5 == ((signed long int) var_1_9)))) && ((var_1_2 && last_1_var_1_11) ? (var_1_11 == ((unsigned char) (! var_1_3))) : (var_1_11 == ((unsigned char) (var_1_2 || var_1_3))))) && (((- (var_1_13 - var_1_14)) > var_1_8) ? (var_1_12 == ((signed long int) (((var_1_15 + var_1_16) - var_1_17) + var_1_18))) : (var_1_12 == ((signed long int) (min (var_1_16 , 5)))))) && (var_1_19 == ((signed long int) var_1_10))
;
}
int main(void) {
	isInitial = 1;
