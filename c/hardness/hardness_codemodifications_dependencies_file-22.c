...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch22dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch22dependencies
	if ((- 3.75) < (min (var_1_20 , var_1_22))) {
		var_1_27 = 0;
	}


	// From: Req1Batch22dependencies
	if (var_1_2 < var_1_3) {
	...
	// From: Req3Batch22dependencies
	if ((var_1_4 <= var_1_9) || var_1_27) {
		var_1_13 = (max ((max (var_1_5 , var_1_8)) , var_1_15));
	} else {
		var_1_13 = var_1_16;
	}


	// From: Req6Batch22dependencies
	if (var_1_11 == var_1_8) {
		var_1_24 = (2332545940u - (1490203111u - var_1_7));
	} else {
		var_1_24 = (var_1_5 + (var_1_25 - var_1_11));
	}


	// From: Req7Batch22dependencies
	if (var_1_4 > (var_1_19 - var_1_7)) {
		var_1_26 = var_1_8;
	}


	// From: Req4Batch22dependencies
...
int property(void) {
	return ((((((((var_1_2 < var_1_3) ? (var_1_1 == ((unsigned short int) (min (var_1_4 , var_1_5)))) : (var_1_1 == ((unsigned short int) (((var_1_6 + var_1_7) - var_1_8) + var_1_9)))) && ((var_1_9 < (var_1_8 << var_1_4)) ? (var_1_10 == ((unsigned char) (var_1_11 + var_1_12))) : (var_1_10 == ((unsigned char) var_1_11)))) && (((var_1_4 <= var_1_9) || var_1_27) ? (var_1_13 == ((unsigned short int) (max ((max (var_1_5 , var_1_8)) , var_1_15)))) : (var_1_13 == ((unsigned short int) var_1_16)))) && (((var_1_20 / var_1_18) > var_1_20) ? (var_1_17 == ((unsigned short int) ((var_1_19 - (max (var_1_26 , var_1_12))) - var_1_7))) : 1)) && (last_1_var_1_27 ? (var_1_20 == ((double) ((max ((max (var_1_21 , var_1_22)) , 16.6)) - var_1_23))) : (var_1_20 == ((double) var_1_22)))) && ((var_1_11 == var_1_8) ? (var_1_24 == ((unsigned long int) (2332545940u - (1490203111u - var_1_7)))) : (var_1_24 == ((unsigned long int) (var_1_5 + (var_1_25 - var_1_11)))))) && ((var_1_4 > (var_1_19 - var_1_7)) ? (var_1_26 == ((unsigned long int) var_1_8)) : 1)) && (((- 3.75) < (min (var_1_20 , var_1_22))) ? (var_1_27 == ((unsigned char) 0)) : 1)
;
}
int main(void) {
	isInitial = 1;
