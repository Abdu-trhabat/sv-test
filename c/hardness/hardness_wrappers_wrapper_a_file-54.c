...
void step(void) {
	...
	if (stepLocal_1 == (max (10 , signed_long_int_Array_0[0]))) {
		if (BOOL_unsigned_char_Array_0[0][1]) {
			...
			if (double_Array_0[2] >= (abs (float_Array_0[0]))) {
...
int property(void) {
	return (((((-4 >= signed_long_int_Array_0[1]) ? (unsigned_char_Array_0[1] == ((unsigned char) (min (unsigned_char_Array_0[0] , (abs (1)))))) : 1) && (((8 * signed_long_int_Array_0[1]) == (max (10 , signed_long_int_Array_0[0]))) ? (BOOL_unsigned_char_Array_0[0][1] ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) ((float_Array_0[0] < double_Array_0[2]) && BOOL_unsigned_char_Array_0[0][0]))) : ((double_Array_0[2] >= (abs (float_Array_0[0]))) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) (! BOOL_unsigned_char_Array_0[0][0]))) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) 0)))) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0])))) && (BOOL_unsigned_char_Array_0[0][0] ? ((unsigned_char_Array_0[0] > signed_long_int_Array_0[0]) ? (double_Array_0[2] == ((double) (max ((max (double_Array_0[0] , 16.5)) , double_Array_0[1])))) : (BOOL_unsigned_char_Array_0[1][0] ? (double_Array_0[2] == ((double) double_Array_0[0])) : 1)) : 1)) && (float_Array_0[0] == ((float) double_Array_0[0]))) && (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0]))
;
}
int main(void) {
	isInitial = 1;
