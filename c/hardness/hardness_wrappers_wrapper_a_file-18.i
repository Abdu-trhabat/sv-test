...
void step(void) {
 ...
 if ((signed_short_int_Array_0[1][2] ^ ((((signed_short_int_Array_0[0][2]) > (signed_short_int_Array_0[1][1])) ? (signed_short_int_Array_0[0][2]) : (signed_short_int_Array_0[1][1])))) != stepLocal_0) {
...
int property(void) {
 return ((((signed_short_int_Array_0[1][2] ^ ((((signed_short_int_Array_0[0][2]) > (signed_short_int_Array_0[1][1])) ? (signed_short_int_Array_0[0][2]) : (signed_short_int_Array_0[1][1])))) != signed_long_int_Array_0[0]) ? ((signed_short_int_Array_0[1][2] == (signed_short_int_Array_0[0][1] - (signed_short_int_Array_0[1][0] - signed_short_int_Array_0[0][0]))) ? (float_Array_0[2] == ((float) ((((float_Array_0[0]) < (float_Array_0[1])) ? (float_Array_0[0]) : (float_Array_0[1]))))) : 1) : (float_Array_0[2] == ((float) 10.5f))) && ((last_1_unsigned_long_int_Array_0_0_ > signed_short_int_Array_0[0][0]) ? ((((signed_short_int_Array_0[0][1] - signed_short_int_Array_0[0][0]) + signed_short_int_Array_0[1][0]) > last_1_unsigned_long_int_Array_0_0_) ? (unsigned_char_Array_0[2] == ((unsigned char) ((((unsigned_char_Array_0[0]) < (unsigned_char_Array_0[1])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[1]))))) : (unsigned_char_Array_0[2] == ((unsigned char) unsigned_char_Array_0[0]))) : 1)) && (((signed_short_int_Array_0[1][1] & signed_short_int_Array_0[1][0]) > ((unsigned_char_Array_0[0] * signed_long_int_Array_0[0]) * (unsigned_char_Array_0[2] + signed_short_int_Array_0[0][2]))) ? ((BOOL_unsigned_char_Array_0[0] && (float_Array_0[0] > float_Array_0[1])) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) signed_short_int_Array_0[1][0])) : 1) : (unsigned_long_int_Array_0[0] == ((unsigned long int) signed_short_int_Array_0[1][0])))
;
}
int main(void) {
 isInitial = 1;
