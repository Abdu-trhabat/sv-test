...
void step(void) {
	...
	if ((*(double_Array_0_arraydouble_Array_0arrayVar7_Pointer)) < ((min ((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar8_Pointer)))) * (*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)))) {
