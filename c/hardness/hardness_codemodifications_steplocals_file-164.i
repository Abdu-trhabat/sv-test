...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch164stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_6) < (var_1_4)) ? (var_1_6) : (var_1_4))) == (var_1_2 + var_1_7)) {
 ...
 unsigned char stepLocal_1 = var_1_1 <= (var_1_22 - var_1_23);
 ...
 if (((((var_1_5) > (var_1_4)) ? (var_1_5) : (var_1_4))) >= stepLocal_2) {
  var_1_24 = (var_1_25 && (var_1_26 && (var_1_27 && var_1_28)));
 } else {
  var_1_24 = var_1_25;
 }
 if ((var_1_21 / ((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30)))) <= var_1_2) {
  var_1_29 = var_1_6;
 }
}
void updateVariables(void) {
