...
void step(void) {
	...
	if (double_Array_0[1][2] < ((min (double_Array_0[0][2] , double_Array_0[2][2])) * double_Array_0[2][1])) {
	...
	if ((double_Array_0[2][2] + (double_Array_0[1][2] / float_Array_0[0])) == double_Array_0[2][1]) {
		if (double_Array_0[1][2] >= double_Array_0[0][2]) {
			double_Array_0[2][0] = (double_Array_0[1][0] - (min ((double_Array_0[0][1] + double_Array_0[1][1]) , 9.9999999999995E12)));
		} else {
			double_Array_0[2][0] = (min (double_Array_0[1][0] , (5.75 + double_Array_0[1][1])));
		}
	}
...
int property(void) {
	return (((((((double_Array_0[1][2] < ((min (double_Array_0[0][2] , double_Array_0[2][2])) * double_Array_0[2][1])) ? (BOOL_unsigned_char_Array_0[2] == ((unsigned char) (last_1_BOOL_unsigned_char_Array_0_2_ && ((BOOL_unsigned_char_Array_0[1] || last_1_BOOL_unsigned_char_Array_0_2_) && BOOL_unsigned_char_Array_0[0])))) : 1) && (BOOL_unsigned_char_Array_0[0] ? (unsigned_long_int_Array_0[0] == ((unsigned long int) 2u)) : 1)) && (signed_char_Array_0[3] == ((signed char) (min ((signed_char_Array_0[0] + signed_char_Array_0[1]) , (10 - signed_char_Array_0[4])))))) && (((double_Array_0[2][2] + (double_Array_0[1][2] / float_Array_0[0])) == double_Array_0[2][1]) ? ((double_Array_0[1][2] >= double_Array_0[0][2]) ? (double_Array_0[2][0] == ((double) (double_Array_0[1][0] - (min ((double_Array_0[0][1] + double_Array_0[1][1]) , 9.9999999999995E12))))) : (double_Array_0[2][0] == ((double) (min (double_Array_0[1][0] , (5.75 + double_Array_0[1][1])))))) : 1)) && (double_Array_0[0][0] == ((double) double_Array_0[1][1]))) && (signed_char_Array_0[2] == ((signed char) 1))) && (unsigned_short_int_Array_0[0] == ((unsigned short int) 10))
;
}
int main(void) {
	isInitial = 1;
