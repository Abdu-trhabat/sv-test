...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch112dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch112dependencies
	if ((var_1_16 - var_1_17) < (var_1_10 - var_1_1)) {
		var_1_15 = 1;
	}


	// From: Req2Batch112dependencies
	...
	// From: Req7Batch112dependencies
	var_1_24 = var_1_25;


	// From: Req8Batch112dependencies
	var_1_26 = 10;


	// From: Req4Batch112dependencies
