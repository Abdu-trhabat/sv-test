...
void step(void) {
 ...
 if (var_1_4 >= ((((-200.0f) > (var_1_1)) ? (-200.0f) : (var_1_1)))) {
...
int property(void) {
 return ((((var_1_2 <= var_1_3) ? (var_1_1 == ((float) (var_1_4 - 1.0f))) : 1) && ((var_1_4 >= ((((-200.0f) > (var_1_1)) ? (-200.0f) : (var_1_1)))) ? (((var_1_2 + (40593 - var_1_6)) >= ((var_1_3 * var_1_7) + var_1_8)) ? (var_1_5 == ((unsigned char) var_1_9)) : (var_1_5 == ((unsigned char) 0))) : (var_1_5 == ((unsigned char) var_1_10)))) && ((var_1_1 >= -8.0f) ? (var_1_11 == ((unsigned char) ((var_1_12 - var_1_13) - (var_1_14 + (var_1_15 + 16))))) : 1)) && (var_1_10 ? ((last_1_var_1_16 || var_1_9) ? (var_1_16 == ((unsigned char) var_1_17)) : (var_1_16 == ((unsigned char) var_1_9))) : ((var_1_9 && var_1_17) ? (var_1_16 == ((unsigned char) var_1_9)) : (var_1_16 == ((unsigned char) 0))))
;
}
int main(void) {
 isInitial = 1;
