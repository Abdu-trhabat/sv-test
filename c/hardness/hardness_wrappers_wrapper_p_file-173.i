...
void step(void) {
 if ((*(var_1_2_Pointer)) < (*(var_1_3_Pointer))) {
  if (((((((*(var_1_4_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_5_Pointer))))) << (*(var_1_6_Pointer))) < ((~ (*(var_1_7_Pointer))) / (*(var_1_8_Pointer)))) {
   (*(var_1_1_Pointer)) = ((((((*(var_1_9_Pointer)) - (*(var_1_10_Pointer)))) < (((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))))) ? (((*(var_1_9_Pointer)) - (*(var_1_10_Pointer)))) : (((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))))));
  }
 }
 if ((*(var_1_14_Pointer))) {
