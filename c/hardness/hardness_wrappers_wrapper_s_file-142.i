...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch142Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 if (WrapperStruct00.var_1_2 <= WrapperStruct00.var_1_3) {
  if (WrapperStruct00.var_1_3 <= WrapperStruct00.var_1_2) {
   WrapperStruct00.var_1_1 = (1 - WrapperStruct00.var_1_4);
  } else {
   WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5);
  }
 }
 if ((WrapperStruct00.var_1_7 - WrapperStruct00.var_1_8) <= 0) {
  WrapperStruct00.var_1_6 = ((((WrapperStruct00.var_1_9) < 0 ) ? -(WrapperStruct00.var_1_9) : (WrapperStruct00.var_1_9)));
 }
 ...
 if (stepLocal_0 && WrapperStruct00.var_1_12) {
  ...
  WrapperStruct00.var_1_10 = ((((WrapperStruct00.var_1_13) < (WrapperStruct00.var_1_14)) ? (WrapperStruct00.var_1_13) : (WrapperStruct00.var_1_14)));
 }
 unsigned long int stepLocal_1 = WrapperStruct00.var_1_2;
 if (stepLocal_1 == ((((WrapperStruct00.var_1_7) > (WrapperStruct00.var_1_5)) ? (WrapperStruct00.var_1_7) : (WrapperStruct00.var_1_5)))) {
  WrapperStruct00.var_1_15 = (WrapperStruct00.var_1_16 + WrapperStruct00.var_1_17);
 } else {
  WrapperStruct00.var_1_15 = (WrapperStruct00.var_1_18 - WrapperStruct00.var_1_19);
 }
 unsigned long int stepLocal_2 = WrapperStruct00.var_1_3;
 if (WrapperStruct00.var_1_19 <= WrapperStruct00.var_1_17) {
  if (stepLocal_2 < WrapperStruct00.var_1_7) {
   WrapperStruct00.var_1_20 = 199.75;
  }
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((WrapperStruct00.var_1_2 <= WrapperStruct00.var_1_3) ? ((WrapperStruct00.var_1_3 <= WrapperStruct00.var_1_2) ? (WrapperStruct00.var_1_1 == ((signed long int) (1 - WrapperStruct00.var_1_4))) : (WrapperStruct00.var_1_1 == ((signed long int) (WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5)))) : 1) && (((WrapperStruct00.var_1_7 - WrapperStruct00.var_1_8) <= 0) ? (WrapperStruct00.var_1_6 == ((double) ((((WrapperStruct00.var_1_9) < 0 ) ? -(WrapperStruct00.var_1_9) : (WrapperStruct00.var_1_9))))) : 1)) && ((WrapperStruct00.var_1_11 && WrapperStruct00.var_1_12) ? (WrapperStruct00.var_1_10 == ((signed short int) WrapperStruct00.var_1_13)) : (WrapperStruct00.var_1_10 == ((signed short int) ((((WrapperStruct00.var_1_13) < (WrapperStruct00.var_1_14)) ? (WrapperStruct00.var_1_13) : (WrapperStruct00.var_1_14))))))) && ((WrapperStruct00.var_1_2 == ((((WrapperStruct00.var_1_7) > (WrapperStruct00.var_1_5)) ? (WrapperStruct00.var_1_7) : (WrapperStruct00.var_1_5)))) ? (WrapperStruct00.var_1_15 == ((double) (WrapperStruct00.var_1_16 + WrapperStruct00.var_1_17))) : (WrapperStruct00.var_1_15 == ((double) (WrapperStruct00.var_1_18 - WrapperStruct00.var_1_19))))) && ((WrapperStruct00.var_1_19 <= WrapperStruct00.var_1_17) ? ((WrapperStruct00.var_1_3 < WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_20 == ((double) 199.75)) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
