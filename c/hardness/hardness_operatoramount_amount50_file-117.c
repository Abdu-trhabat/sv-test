...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch117Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch117Amount50
	unsigned long int stepLocal_0 = (min (var_1_2 , var_1_3)) + 64u;
	if (stepLocal_0 != (var_1_4 * var_1_5)) {
		var_1_1 = ((var_1_6 - (32 + var_1_7)) - (var_1_8 - var_1_9));
	}


	// From: Req2Batch117Amount50
	if (var_1_7 < ((var_1_8 - var_1_9) >> var_1_11)) {
		var_1_10 = var_1_12;
	}


	// From: Req3Batch117Amount50
	if (var_1_8 > var_1_7) {
		var_1_13 = (max (var_1_11 , var_1_14));
	}


	// From: Req5Batch117Amount50
	...
	if (var_1_19) {
		...
		var_1_18 = ((max (var_1_20 , var_1_21)) - (max (var_1_22 , var_1_23)));
	}


	// From: Req6Batch117Amount50
	if (var_1_20 < var_1_16) {
		var_1_24 = ((var_1_25 - var_1_11) - 2);
	}


	// From: Req4Batch117Amount50
	if (((var_1_18 / var_1_16) + var_1_12) >= (abs (var_1_18))) {
		var_1_15 = (abs (var_1_11));
	} else {
	...
	// From: Req7Batch117Amount50
	signed long int stepLocal_2 = var_1_15 / (min (var_1_25 , var_1_8));
	if ((var_1_9 + var_1_14) < stepLocal_2) {
		var_1_26 = (min ((var_1_27 - var_1_8) , var_1_11));
	}
}
...
int property(void) {
	return (((((((((min (var_1_2 , var_1_3)) + 64u) != (var_1_4 * var_1_5)) ? (var_1_1 == ((signed short int) ((var_1_6 - (32 + var_1_7)) - (var_1_8 - var_1_9)))) : 1) && ((var_1_7 < ((var_1_8 - var_1_9) >> var_1_11)) ? (var_1_10 == ((float) var_1_12)) : 1)) && ((var_1_8 > var_1_7) ? (var_1_13 == ((signed char) (max (var_1_11 , var_1_14)))) : 1)) && ((((var_1_18 / var_1_16) + var_1_12) >= (abs (var_1_18))) ? (var_1_15 == ((signed char) (abs (var_1_11)))) : ((var_1_18 < var_1_16) ? (var_1_15 == ((signed char) var_1_11)) : 1))) && (var_1_19 ? ((4 > var_1_9) ? (var_1_18 == ((double) var_1_12)) : 1) : (var_1_18 == ((double) ((max (var_1_20 , var_1_21)) - (max (var_1_22 , var_1_23))))))) && ((var_1_20 < var_1_16) ? (var_1_24 == ((unsigned char) ((var_1_25 - var_1_11) - 2))) : 1)) && (((var_1_9 + var_1_14) < (var_1_15 / (min (var_1_25 , var_1_8)))) ? (var_1_26 == ((unsigned long int) (min ((var_1_27 - var_1_8) , var_1_11)))) : 1)
;
}
int main(void) {
	isInitial = 1;
