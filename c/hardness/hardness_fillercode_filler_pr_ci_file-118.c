...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch118Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch118Filler_PR_CI
	/* 1027L, 5L, 351L, 357L) */ var_1_1 = (
		-5
	);


	// From: Req2Batch118Filler_PR_CI
	...
	// From: CodeObject6
	/* 299L, 165L) */ if (/* 300L, 137L, 138L) */ ((var_1_12) != (/* 302L, 136L, 140L) */ (abs (var_1_16))))) {
		/* 304L, 149L) */ var_1_35 = (
			var_1_24
		);
	} else {
	...
	/* 336L, 221L) */ if (/* 337L, 202L, 203L) */ ((var_1_24) != (var_1_37))) {
		/* 340L, 219L) */ if (/* 341L, 210L, 211L) */ (! (var_1_8))) {
			/* 343L, 218L) */ var_1_41 = (
				var_1_40
			);
		}
