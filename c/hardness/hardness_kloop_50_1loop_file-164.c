...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16450_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch16450_1loop
	if ((var_1_21 / (abs (var_1_30))) <= var_1_19) {
		var_1_29 = var_1_6;
	}


	// From: Req2Batch16450_1loop
	if (var_1_24) {
		if ((- var_1_10) < 127.25f) {
