...
void step(void) {
 if (! (*(var_1_6_Pointer))) {
  (*(var_1_5_Pointer)) = (((((*(var_1_7_Pointer))) < (((*(var_1_8_Pointer)) - ((*(var_1_9_Pointer)) + (*(var_1_10_Pointer)))))) ? ((*(var_1_7_Pointer))) : (((*(var_1_8_Pointer)) - ((*(var_1_9_Pointer)) + (*(var_1_10_Pointer)))))));
 } else {
 ...
 if ((*(var_1_6_Pointer))) {
  if (stepLocal_1 < (*(var_1_10_Pointer))) {
   if (((((((*(var_1_8_Pointer)) - (*(var_1_10_Pointer)))) > ((*(var_1_1_Pointer)))) ? (((*(var_1_8_Pointer)) - (*(var_1_10_Pointer)))) : ((*(var_1_1_Pointer))))) >= stepLocal_2) {
...
int property(void) {
 return ((((~ (*(var_1_5_Pointer))) >= (((*(var_1_3_Pointer)) * -10) & (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed short int) (*(var_1_5_Pointer)))) : 1) && ((! (*(var_1_6_Pointer))) ? ((*(var_1_5_Pointer)) == ((unsigned char) (((((*(var_1_7_Pointer))) < (((*(var_1_8_Pointer)) - ((*(var_1_9_Pointer)) + (*(var_1_10_Pointer)))))) ? ((*(var_1_7_Pointer))) : (((*(var_1_8_Pointer)) - ((*(var_1_9_Pointer)) + (*(var_1_10_Pointer))))))))) : ((*(var_1_5_Pointer)) == ((unsigned char) (128 - (*(var_1_9_Pointer))))))) && ((*(var_1_6_Pointer)) ? (((*(var_1_1_Pointer)) < (*(var_1_10_Pointer))) ? ((((((((*(var_1_8_Pointer)) - (*(var_1_10_Pointer)))) > ((*(var_1_1_Pointer)))) ? (((*(var_1_8_Pointer)) - (*(var_1_10_Pointer)))) : ((*(var_1_1_Pointer))))) >= (*(var_1_9_Pointer))) ? ((*(var_1_11_Pointer)) == ((signed char) (*(var_1_10_Pointer)))) : ((((*(var_1_5_Pointer)) < (*(var_1_8_Pointer))) || (*(var_1_12_Pointer))) ? ((*(var_1_12_Pointer)) ? ((*(var_1_13_Pointer)) ? ((*(var_1_11_Pointer)) == ((signed char) (*(var_1_10_Pointer)))) : 1) : ((*(var_1_11_Pointer)) == ((signed char) (*(var_1_9_Pointer))))) : ((*(var_1_11_Pointer)) == ((signed char) (*(var_1_10_Pointer)))))) : ((*(var_1_11_Pointer)) == ((signed char) (*(var_1_10_Pointer))))) : ((*(var_1_11_Pointer)) == ((signed char) (*(var_1_9_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
