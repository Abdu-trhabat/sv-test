...
void step(void) {
	...
	// From: Req2Batch15825_while
	if (var_1_8) {
		var_1_6 = (var_1_5 + -128);
	}


	// From: Req5Batch15825_while
	var_1_14 = var_1_5;


	// From: Req6Batch15825_while
	var_1_15 = 32.5f;
}
