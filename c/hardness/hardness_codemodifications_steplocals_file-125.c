...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch125stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch125stepLocals
	var_1_11 = ((abs (var_1_12)) + var_1_13);


	// From: Req3Batch125stepLocals
	...
	// From: Req4Batch125stepLocals
	var_1_18 = (min ((var_1_19 - 100) , var_1_9));


	// From: Req5Batch125stepLocals
	if (var_1_2) {
		var_1_20 = var_1_11;
	} else {
		var_1_20 = ((var_1_9 - 64) + var_1_11);
	}


	// From: Req6Batch125stepLocals
	if (var_1_14 <= (var_1_17 / var_1_15)) {
