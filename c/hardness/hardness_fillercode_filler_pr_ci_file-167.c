...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch167Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 250L, 43L) */ if (/* 251L, 18L, 19L) */ ((/* 252L, 16L, 20L) */ ((var_1_33) > (var_1_11))) && (var_1_15))) {
		/* 256L, 36L) */ var_1_34 = (
			/* 259L, 35L) */ (min (
				/* 259L, 35L) */ (
					var_1_35
	...
	// From: CodeObject9
	/* 386L, 238L) */ if (/* 387L, 192L, 193L) */ ((/* 388L, 186L, 194L) */ ((/* 389L, 184L, 195L) */ ((var_1_22) - (var_1_50))) & (var_1_3))) >= (/* 393L, 191L, 199L) */ ((/* 394L, 189L, 200L) */ (max (/* 394L, 189L, 200L) */ (var_1_52) , (var_1_53)))) - (var_1_43))))) {
		/* 398L, 232L) */ if (/* 399L, 217L, 218L) */ ((var_1_49) > (var_1_23))) {
			/* 402L, 227L) */ var_1_51 = (
				var_1_49
			);
		} else {
	...
	// From: CodeObject8
	/* 347L, 178L) */ if (/* 348L, 121L, 122L) */ ((var_1_21) < (/* 350L, 120L, 124L) */ ((var_1_5) / (10))))) {
		...
		/* 370L, 176L) */ if (/* 371L, 158L, 159L) */ ((var_1_23) >= (var_1_5))) {
			/* 374L, 171L) */ var_1_46 = (
				/* 377L, 170L) */ (abs (
					/* 378L, 169L) */ (max (
						/* 378L, 169L) */ (
