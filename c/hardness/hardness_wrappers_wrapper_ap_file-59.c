...
void step(void) {
	...
	if ((max ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var5_Pointer)) , 1)) <= (256 + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)))) {
	...
	if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var6_Pointer)) > (abs ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer))))) {
