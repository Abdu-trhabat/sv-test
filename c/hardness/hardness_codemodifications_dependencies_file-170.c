...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch170dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch170dependencies
	if (var_1_4) {
		var_1_1 = var_1_3;
	}


	// From: Req5Batch170dependencies
	if (var_1_10 > (var_1_10 / (abs (var_1_18)))) {
		var_1_17 = var_1_16;
	}


	// From: Req7Batch170dependencies
	var_1_21 = var_1_3;


	// From: Req4Batch170dependencies
