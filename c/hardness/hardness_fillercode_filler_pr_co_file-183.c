...
void step(void) {
	...
	/* 373L, 225L) */ if (/* 374L, 159L, 160L) */ ((var_1_35) < (var_1_29))) {
		...
		/* 391L, 223L) */ if (/* 392L, 194L, 195L) */ (! (/* 393L, 193L, 196L) */ ((var_1_37) < (var_1_17))))) {
			/* 396L, 206L) */ var_1_43 = (
				10
			);
		} else {
	...
	/* 409L, 284L) */ if (/* 410L, 231L, 232L) */ ((var_1_5) <= (var_1_42))) {
		/* 413L, 278L) */ if (/* 414L, 240L, 241L) */ ((var_1_29) < (var_1_36))) {
			...
			/* 421L, 276L) */ if (/* 422L, 257L, 258L) */ ((/* 423L, 255L, 259L) */ ((var_1_5) % (/* 425L, 254L, 261L) */ ((var_1_47) - (var_1_48))))) >= (var_1_5))) {
				/* 429L, 275L) */ var_1_46 = (
					64
				);
			}
