...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch67no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	signed long int stepLocal_0 = 1 * last_1_var_1_9;
	...
	if (var_1_10) {
		...
		if (stepLocal_2 > (var_1_4 / var_1_8)) {
