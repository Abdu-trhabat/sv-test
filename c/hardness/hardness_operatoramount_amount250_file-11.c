...
void step(void) {
	...
	signed long int stepLocal_5 = last_1_var_1_62 * (abs (var_1_32));
	if (stepLocal_5 != last_1_var_1_67) {
		var_1_31 = ((min (var_1_14 , var_1_15)) - (var_1_33 + last_1_var_1_67));
	} else {
	...
	if (var_1_11 < 15.4) {
		var_1_67 = ((min (last_1_var_1_62 , var_1_56)) - (min (var_1_38 , var_1_33)));
	} else {
		if (last_1_var_1_47) {
			var_1_67 = var_1_68;
		} else {
	...
	if ((- var_1_67) <= var_1_9) {
		if (! (var_1_28 != (var_1_44 / var_1_18))) {
			var_1_47 = ((var_1_27 <= (max (var_1_45 , 5.6f))) && var_1_19);
		}
	} else {
	...
	if (var_1_20) {
		if ((max (var_1_42 , (abs (var_1_32)))) <= var_1_67) {
			var_1_43 = (var_1_26 - (abs (max (var_1_12 , var_1_11))));
		} else {
			var_1_43 = (var_1_26 - ((max (var_1_44 , var_1_45)) - var_1_46));
		}
	}
	...
	if (var_1_18 != var_1_43) {
		var_1_23 = (max (var_1_11 , ((max (var_1_24 , var_1_25)) - var_1_26)));
	} else {
		if (((max (var_1_26 , var_1_24)) - var_1_25) <= (var_1_10 + (255.25f + var_1_11))) {
			var_1_23 = 3.4f;
		} else {
			var_1_23 = ((min ((var_1_11 + 4.5f) , (var_1_10 + var_1_27))) + (max (var_1_12 , var_1_28)));
		}
	}


	// From: Req8Batch11Amount250
	if (((max (var_1_11 , var_1_28)) / 24.625) > var_1_12) {
		var_1_35 = 64;
	}
	...
	var_1_66 = (max ((min (var_1_67 , var_1_61)) , 32));
	...
	if (var_1_11 > (- var_1_1)) {
		var_1_62 = (min (((last_1_var_1_62 + var_1_56) + var_1_61) , (abs (last_1_var_1_62 + var_1_55))));
	}
	...
	if (var_1_21) {
		if (var_1_66 == (abs (var_1_38 - var_1_39))) {
			if ((128 - var_1_40) >= var_1_35) {
				var_1_36 = (((max (var_1_41 , var_1_42)) - var_1_66) - (var_1_38 + 32));
			} else {
				var_1_36 = var_1_62;
			}
		} else {
	...
	signed long int stepLocal_16 = (max (var_1_38 , var_1_36)) << 16;
	if (stepLocal_16 > (var_1_16 * (var_1_55 - var_1_65))) {
		if (stepLocal_17 < ((var_1_60 + var_1_61) - (var_1_38 + var_1_65))) {
			var_1_58 = ((var_1_45 - (min (var_1_46 , var_1_51))) - var_1_26);
		} else {
			var_1_58 = (var_1_52 - (var_1_45 - var_1_51));
		}
	} else {
		var_1_58 = (var_1_45 - (min (var_1_25 , var_1_24)));
	}
	...
	if (var_1_30) {
		...
		if (stepLocal_18 > (min ((var_1_42 + var_1_66) , var_1_62))) {
	...
	unsigned long int stepLocal_1 = abs (min (2u , var_1_8));
	if (var_1_63) {
		if (var_1_43 == var_1_11) {
			var_1_13 = (44770 - var_1_14);
		} else {
			if (stepLocal_1 <= (var_1_9 | var_1_14)) {
				var_1_13 = (min (var_1_14 , (var_1_15 - var_1_16)));
			}
		}
	} else {
		var_1_13 = var_1_14;
	...
	unsigned long int stepLocal_12 = max ((var_1_55 * var_1_22) , var_1_13);
	...
	if (stepLocal_14 < var_1_66) {
		...
		if (var_1_39 >= stepLocal_12) {
			var_1_53 = (max (var_1_62 , var_1_32));
		} else {
			if ((var_1_55 * (var_1_22 / var_1_42)) > stepLocal_13) {
				var_1_53 = (max ((var_1_56 - var_1_22) , (var_1_16 - var_1_14)));
			}
		}
	}
	...
	signed long int stepLocal_8 = abs (var_1_33);
	signed long int stepLocal_7 = var_1_9 + var_1_16;
	if (stepLocal_8 <= (max (var_1_22 , (var_1_53 * var_1_66)))) {
...
int property(void) {
	return (((((((((((((((((((((var_1_35 + var_1_31) | var_1_35) < ((var_1_7 - var_1_8) / (min (128 , var_1_9)))) ? (var_1_1 == ((double) ((var_1_10 + var_1_11) + var_1_12))) : (var_1_1 == ((double) var_1_10))) && (var_1_63 ? ((var_1_43 == var_1_11) ? (var_1_13 == ((unsigned short int) (44770 - var_1_14))) : (((abs (min (2u , var_1_8))) <= (var_1_9 | var_1_14)) ? (var_1_13 == ((unsigned short int) (min (var_1_14 , (var_1_15 - var_1_16))))) : 1)) : (var_1_13 == ((unsigned short int) var_1_14)))) && ((last_1_var_1_63 && (var_1_8 > last_1_var_1_65)) ? (var_1_17 == ((unsigned char) (last_1_var_1_63 && (! 1)))) : ((last_1_var_1_63 || (var_1_12 <= (last_1_var_1_1 / var_1_18))) ? ((! last_1_var_1_63) ? (var_1_17 == ((unsigned char) (var_1_19 || (! var_1_20)))) : (((255.5f / var_1_18) < (var_1_10 * var_1_11)) ? (var_1_17 == ((unsigned char) var_1_19)) : (var_1_17 == ((unsigned char) (! (! var_1_19)))))) : (var_1_17 == ((unsigned char) var_1_21))))) && (var_1_29 ? (var_1_22 == ((unsigned long int) var_1_31)) : 1)) && ((var_1_18 != var_1_43) ? (var_1_23 == ((float) (max (var_1_11 , ((max (var_1_24 , var_1_25)) - var_1_26))))) : ((((max (var_1_26 , var_1_24)) - var_1_25) <= (var_1_10 + (255.25f + var_1_11))) ? (var_1_23 == ((float) 3.4f)) : (var_1_23 == ((float) ((min ((var_1_11 + 4.5f) , (var_1_10 + var_1_27))) + (max (var_1_12 , var_1_28)))))))) && ((var_1_43 != var_1_27) ? (((-500 != -128) && (! var_1_47)) ? (var_1_29 == ((unsigned char) (var_1_20 && var_1_19))) : (var_1_29 == ((unsigned char) (var_1_19 || (var_1_47 && var_1_30))))) : 1)) && (((last_1_var_1_62 * (abs (var_1_32))) != last_1_var_1_67) ? (var_1_31 == ((signed long int) ((min (var_1_14 , var_1_15)) - (var_1_33 + last_1_var_1_67)))) : ((last_1_var_1_22 >= ((3147088468u - last_1_var_1_67) * last_1_var_1_22)) ? (var_1_31 == ((signed long int) last_1_var_1_35)) : 1))) && ((((max (var_1_11 , var_1_28)) / 24.625) > var_1_12) ? (var_1_35 == ((unsigned char) 64)) : 1)) && (var_1_21 ? ((var_1_66 == (abs (var_1_38 - var_1_39))) ? (((128 - var_1_40) >= var_1_35) ? (var_1_36 == ((signed short int) (((max (var_1_41 , var_1_42)) - var_1_66) - (var_1_38 + 32)))) : (var_1_36 == ((signed short int) var_1_62))) : (var_1_36 == ((signed short int) var_1_66))) : 1)) && (var_1_20 ? (((max (var_1_42 , (abs (var_1_32)))) <= var_1_67) ? (var_1_43 == ((double) (var_1_26 - (abs (max (var_1_12 , var_1_11)))))) : (var_1_43 == ((double) (var_1_26 - ((max (var_1_44 , var_1_45)) - var_1_46))))) : 1)) && (((- var_1_67) <= var_1_9) ? ((! (var_1_28 != (var_1_44 / var_1_18))) ? (var_1_47 == ((unsigned char) ((var_1_27 <= (max (var_1_45 , 5.6f))) && var_1_19))) : 1) : (var_1_47 == ((unsigned char) (var_1_19 && (var_1_30 || var_1_48)))))) && (((abs (var_1_33)) <= (max (var_1_22 , (var_1_53 * var_1_66)))) ? (((var_1_9 + var_1_16) <= var_1_31) ? (var_1_49 == ((float) (var_1_27 + var_1_12))) : (var_1_49 == ((float) ((var_1_46 - 5.25f) + (var_1_51 - var_1_52))))) : 1)) && ((var_1_7 < var_1_66) ? ((((38897 - var_1_13) + var_1_38) > -32) ? ((var_1_40 < 50) ? (var_1_53 == ((signed long int) (var_1_41 - var_1_42))) : ((-4 != var_1_9) ? (var_1_53 == ((signed long int) (var_1_54 - var_1_14))) : ((var_1_39 != ((5 >> var_1_55) >> var_1_56)) ? (var_1_53 == ((signed long int) (-256 + var_1_62))) : 1))) : (var_1_53 == ((signed long int) (var_1_42 - var_1_38)))) : ((var_1_39 >= (max ((var_1_55 * var_1_22) , var_1_13))) ? (var_1_53 == ((signed long int) (max (var_1_62 , var_1_32)))) : (((var_1_55 * (var_1_22 / var_1_42)) > (var_1_9 ^ var_1_67)) ? (var_1_53 == ((signed long int) (max ((var_1_56 - var_1_22) , (var_1_16 - var_1_14))))) : 1)))) && ((((max (var_1_38 , var_1_36)) << 16) > (var_1_16 * (var_1_55 - var_1_65))) ? ((var_1_16 < ((var_1_60 + var_1_61) - (var_1_38 + var_1_65))) ? (var_1_58 == ((float) ((var_1_45 - (min (var_1_46 , var_1_51))) - var_1_26))) : (var_1_58 == ((float) (var_1_52 - (var_1_45 - var_1_51))))) : (var_1_58 == ((float) (var_1_45 - (min (var_1_25 , var_1_24))))))) && ((var_1_11 > (- var_1_1)) ? (var_1_62 == ((unsigned short int) (min (((last_1_var_1_62 + var_1_56) + var_1_61) , (abs (last_1_var_1_62 + var_1_55)))))) : 1)) && (var_1_30 ? (var_1_17 ? (var_1_63 == ((unsigned char) (var_1_29 || var_1_20))) : 1) : ((var_1_62 > (min ((var_1_42 + var_1_66) , var_1_62))) ? (var_1_63 == ((unsigned char) ((! var_1_48) && var_1_21))) : (var_1_63 == ((unsigned char) (var_1_20 && var_1_19)))))) && ((var_1_33 <= last_1_var_1_65) ? (var_1_19 ? (var_1_65 == ((signed short int) var_1_55)) : 1) : (var_1_65 == ((signed short int) last_1_var_1_65)))) && (var_1_66 == ((signed long int) (max ((min (var_1_67 , var_1_61)) , 32))))) && ((var_1_11 < 15.4) ? (var_1_67 == ((signed long int) ((min (last_1_var_1_62 , var_1_56)) - (min (var_1_38 , var_1_33))))) : (last_1_var_1_47 ? (var_1_67 == ((signed long int) var_1_68)) : (var_1_67 == ((signed long int) var_1_33))))
;
}
int main(void) {
	isInitial = 1;
