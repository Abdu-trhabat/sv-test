...
void step(void) {
	...
	// From: CodeObject3
	/* 295L, 133L) */ if (/* 296L, 112L, 113L) */ ((var_1_32) && (var_1_12))) {
		/* 299L, 126L) */ var_1_37 = (
			/* 302L, 125L) */ ((
				/* 303L, 123L) */ ((
					var_1_18
	...
	// From: CodeObject5
	/* 349L, 195L) */ if (var_1_12) {
		/* 351L, 189L) */ if (/* 352L, 151L, 152L) */ ((var_1_26) > (/* 354L, 150L, 154L) */ (abs (var_1_36))))) {
			/* 356L, 164L) */ var_1_42 = (
				/* 359L, 163L) */ (abs (
					var_1_22
				))
			...
			/* 361L, 187L) */ if (/* 362L, 168L, 169L) */ ((/* 363L, 166L, 170L) */ (~ (var_1_27))) >= (var_1_36))) {
				/* 366L, 186L) */ var_1_42 = (
					/* 369L, 185L) */ ((
						/* 370L, 183L) */ ((
							/* 371L, 181L) */ (min (
	...
	// From: CodeObject6
	/* 412L, 256L) */ if (/* 413L, 201L, 202L) */ ((var_1_28) >= (var_1_35))) {
		/* 416L, 214L) */ var_1_43 = (
			/* 419L, 213L) */ (max (
				/* 419L, 213L) */ (
					9.99999999999996E13
		...
		/* 423L, 254L) */ if (/* 424L, 220L, 221L) */ ((/* 425L, 218L, 222L) */ ((/* 426L, 216L, 223L) */ (abs (var_1_44))) - (var_1_45))) <= (var_1_30))) {
			/* 430L, 248L) */ if (var_1_12) {
				/* 432L, 239L) */ var_1_43 = (
					var_1_18
				);
			} else {
...
int property(void) {
	if (var_1_11) {
		if (/* 448L, 9L, 15L, 345L, 369L, 1127L) */ ((/* 449L, 7L, 16L, 346L, 370L, 1128L) */ ((var_1_8) / (var_1_4))) <= (var_1_24))) {
		} else {
		}
	} else {
	}
	if (/* 471L, 47L, 52L, 428L, 446L, 948L, 1150L, 25L) */ ((/* 472L, 45L, 53L, 429L, 447L, 946L, 1151L, 23L) */ (- (last_1_var_1_24))) <= (var_1_4))) {
		if (/* 477L, 60L, 66L, 433L, 451L, 955L, 1156L, 32L) */ ((/* 478L, 58L, 67L, 434L, 452L, 952L, 1157L, 29L) */ ((last_1_var_1_24) <= (var_1_4))) || (last_1_var_1_11))) {
		}
	}
	if (/* 490L, 91L, 97L, 570L, 597L, 1169L) */ ((var_1_8) < (/* 492L, 90L, 99L, 572L, 599L, 1171L) */ ((var_1_20) + (var_1_15))))) {
		if (/* 496L, 108L, 116L, 576L, 603L, 1175L) */ ((/* 497L, 104L, 117L, 577L, 604L, 1176L) */ (min (/* 497L, 104L, 117L, 577L, 604L, 1176L) */ (var_1_7) , (var_1_1)))) > (/* 500L, 107L, 120L, 580L, 607L, 1179L) */ ((var_1_6) * (1))))) {
		} else {
		}
	} else {
	}
	if (/* 523L, 179L, 183L, 690L, 711L, 1202L) */ ((var_1_7) < (var_1_6))) {
		if (var_1_11) {
		} else {
			if (/* 535L, 197L, 201L, 702L, 723L, 1214L) */ ((var_1_12) || (var_1_11))) {
			}
		}
	}
	if (var_1_11) {
	...
	if (/* 579L, 265L, 269L, 897L, 911L, 1258L) */ ((var_1_8) == (var_1_19))) {
		if (/* 583L, 274L, 278L, 901L, 915L, 1262L) */ ((var_1_13) < (var_1_6))) {
		}
	}
	return /* 597L) */ ((
	/* 596L) */ ((
		/* 595L) */ ((
			/* 594L) */ ((
				/* 593L) */ ((
					/* 592L) */ ((
						/* 591L) */ ((
							/* 445L, 37L, 342L, 366L, 1124L) */ ((
								var_1_11
							) ? (
								/* 447L, 31L, 344L, 368L, 1126L) */ ((
									/* 448L, 9L, 15L, 345L, 369L, 1127L) */ ((
										/* 449L, 7L, 16L, 346L, 370L, 1128L) */ ((
											var_1_8
										) / (
											var_1_4
										))
									...
									/* 453L, 25L, 350L, 374L, 1132L) */ ((
										var_1_1
									) == (
										/* 453L, 25L, 350L, 374L, 1132L) */ ((signed short int) (
											/* 456L, 24L, 353L, 377L, 1135L) */ ((
												var_1_6
											) - (
												var_1_7
											))
									...
									/* 459L, 29L, 356L, 380L, 1138L) */ ((
										var_1_1
									) == (
										/* 459L, 29L, 356L, 380L, 1138L) */ ((signed short int) (
											var_1_6
										))
									))
								))
							) : (
								/* 463L, 35L, 360L, 384L, 1142L) */ ((
									var_1_1
								) == (
									/* 463L, 35L, 360L, 384L, 1142L) */ ((signed short int) (
										var_1_7
									))
								))
							))
						) && (
							/* 470L, 78L, 427L, 445L, 961L, 1149L, 38L) */ ((
								/* 471L, 47L, 52L, 428L, 446L, 948L, 1150L, 25L) */ ((
									/* 472L, 45L, 53L, 429L, 447L, 946L, 1151L, 23L) */ (- (
										last_1_var_1_24
									))
								) <= (
									var_1_4
								...
								/* 476L, 76L, 432L, 450L, 960L, 1155L, 37L) */ ((
									/* 477L, 60L, 66L, 433L, 451L, 955L, 1156L, 32L) */ ((
										/* 478L, 58L, 67L, 434L, 452L, 952L, 1157L, 29L) */ ((
											last_1_var_1_24
										) <= (
											var_1_4
										))
									...
									/* 484L, 74L, 438L, 456L, 959L, 1163L, 36L) */ ((
										var_1_8
									) == (
										/* 484L, 74L, 438L, 456L, 959L, 1163L, 36L) */ ((float) (
											3.3f
										))
									))
								) : (
						...
						/* 489L, 162L, 569L, 596L, 1168L) */ ((
							/* 490L, 91L, 97L, 570L, 597L, 1169L) */ ((
								var_1_8
							) < (
								/* 492L, 90L, 99L, 572L, 599L, 1171L) */ ((
									var_1_20
								) + (
									var_1_15
								))
							...
							/* 495L, 156L, 575L, 602L, 1174L) */ ((
								/* 496L, 108L, 116L, 576L, 603L, 1175L) */ ((
									/* 497L, 104L, 117L, 577L, 604L, 1176L) */ (min (
										/* 497L, 104L, 117L, 577L, 604L, 1176L) */ (
											var_1_7
										) , (
											var_1_1
										)
									...
									/* 500L, 107L, 120L, 580L, 607L, 1179L) */ ((
										var_1_6
									) * (
										1
									))
								...
								/* 503L, 126L, 583L, 610L, 1182L) */ ((
									var_1_9
								) == (
									/* 503L, 126L, 583L, 610L, 1182L) */ ((unsigned char) (
										var_1_10
									))
								))
							) : (
								/* 507L, 154L, 587L, 614L, 1186L) */ ((
									var_1_9
								) == (
									/* 507L, 154L, 587L, 614L, 1186L) */ ((unsigned char) (
										64
									))
								))
							))
						) : (
							/* 511L, 160L, 591L, 618L, 1190L) */ ((
								var_1_9
							) == (
								/* 511L, 160L, 591L, 618L, 1190L) */ ((unsigned char) (
									var_1_10
								))
							))
						))
					...
					/* 517L, 170L, 636L, 642L, 1196L) */ ((
						var_1_11
					) == (
						/* 517L, 170L, 636L, 642L, 1196L) */ ((unsigned char) (
							var_1_12
						))
					))
				))
			) && (
				/* 522L, 213L, 689L, 710L, 1201L) */ ((
					/* 523L, 179L, 183L, 690L, 711L, 1202L) */ ((
						var_1_7
					) < (
						var_1_6
					))
				) ? (
					/* 526L, 211L, 693L, 714L, 1205L) */ ((
						var_1_11
					) ? (
						/* 528L, 194L, 695L, 716L, 1207L) */ ((
							var_1_13
						) == (
							/* 528L, 194L, 695L, 716L, 1207L) */ ((unsigned char) (
								/* 531L, 193L, 698L, 719L, 1210L) */ (max (
									/* 531L, 193L, 698L, 719L, 1210L) */ (
										var_1_10
									) , (
										var_1_14
									)
						...
						/* 534L, 209L, 701L, 722L, 1213L) */ ((
							/* 535L, 197L, 201L, 702L, 723L, 1214L) */ ((
								var_1_12
							) || (
								var_1_11
							))
						) ? (
							/* 538L, 207L, 705L, 726L, 1217L) */ ((
								var_1_13
							) == (
								/* 538L, 207L, 705L, 726L, 1217L) */ ((unsigned char) (
									var_1_14
								))
							))
						) : (
			...
			/* 544L, 240L, 776L, 798L, 1223L) */ ((
				var_1_11
			) ? (
				/* 546L, 228L, 778L, 800L, 1225L) */ ((
					var_1_15
				) == (
					/* 546L, 228L, 778L, 800L, 1225L) */ ((float) (
						/* 549L, 227L, 781L, 803L, 1228L) */ ((
							var_1_16
						) + (
							/* 551L, 226L, 783L, 805L, 1230L) */ ((
								var_1_17
							) + (
								32.5f
							))
				...
				/* 554L, 238L, 786L, 808L, 1233L) */ ((
					var_1_15
				) == (
					/* 554L, 238L, 786L, 808L, 1233L) */ ((float) (
						/* 557L, 237L, 789L, 811L, 1236L) */ ((
							/* 558L, 235L, 790L, 812L, 1237L) */ ((
								5.064290308105643E18f
							) - (
								/* 560L, 234L, 792L, 814L, 1239L) */ ((
									4.4f
								) + (
									var_1_18
								))
		...
		/* 566L, 256L, 844L, 856L, 1245L) */ ((
			var_1_20
		) == (
			/* 566L, 256L, 844L, 856L, 1245L) */ ((double) (
				/* 569L, 255L, 847L, 859L, 1248L) */ ((
					var_1_18
				) - (
					/* 571L, 254L, 849L, 861L, 1250L) */ ((
						/* 572L, 252L, 850L, 862L, 1251L) */ (min (
							/* 572L, 252L, 850L, 862L, 1251L) */ (
								var_1_21
							) , (
								var_1_22
							)
	...
	/* 578L, 288L, 896L, 910L, 1257L) */ ((
		/* 579L, 265L, 269L, 897L, 911L, 1258L) */ ((
			var_1_8
		) == (
			var_1_19
		))
	) ? (
		/* 582L, 286L, 900L, 914L, 1261L) */ ((
			/* 583L, 274L, 278L, 901L, 915L, 1262L) */ ((
				var_1_13
			) < (
				var_1_6
			))
		) ? (
			/* 586L, 284L, 904L, 918L, 1265L) */ ((
				var_1_24
			) == (
				/* 586L, 284L, 904L, 918L, 1265L) */ ((float) (
					var_1_23
				))
			))
		) : (
