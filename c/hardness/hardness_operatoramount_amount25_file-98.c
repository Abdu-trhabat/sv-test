...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch98Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch98Amount25
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req2Batch98Amount25
	signed long int stepLocal_0 = 8;
	if (stepLocal_0 < ((var_1_5 >> var_1_6) / var_1_7)) {
		var_1_4 = ((15.475 + 256.75) + var_1_8);
	}


	// From: Req3Batch98Amount25
	if (((- var_1_2) * var_1_8) == var_1_1) {
		var_1_9 = ((var_1_10 || var_1_11) && (var_1_12 && (var_1_13 && var_1_14)));
	}


	// From: Req4Batch98Amount25
	if (var_1_14) {
		var_1_15 = var_1_6;
	} else {
		var_1_15 = (var_1_16 - (max (var_1_6 , (1251570750u - var_1_17))));
	}


	// From: Req5Batch98Amount25
	var_1_18 = var_1_16;
}
...
int property(void) {
	return ((((var_1_1 == ((double) (var_1_2 - var_1_3))) && ((8 < ((var_1_5 >> var_1_6) / var_1_7)) ? (var_1_4 == ((double) ((15.475 + 256.75) + var_1_8))) : 1)) && ((((- var_1_2) * var_1_8) == var_1_1) ? (var_1_9 == ((unsigned char) ((var_1_10 || var_1_11) && (var_1_12 && (var_1_13 && var_1_14))))) : 1)) && (var_1_14 ? (var_1_15 == ((unsigned long int) var_1_6)) : (var_1_15 == ((unsigned long int) (var_1_16 - (max (var_1_6 , (1251570750u - var_1_17)))))))) && (var_1_18 == ((unsigned long int) var_1_16))
;
}
int main(void) {
	isInitial = 1;
