...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13750_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_14 = ((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5)));
 var_1_22 = var_1_4;
 var_1_23 = var_1_13;
 var_1_24 = var_1_7;
 ...
 if (128.8f != (1.6f * var_1_11)) {
  var_1_15 = ((var_1_16 + ((((var_1_17) > (4)) ? (var_1_17) : (4)))) + ((((var_1_5) < (var_1_4)) ? (var_1_5) : (var_1_4))));
 }
 ...
 if (stepLocal_2 > ((((var_1_7) < (var_1_24)) ? (var_1_7) : (var_1_24)))) {
  if (stepLocal_1 < (var_1_5 << var_1_24)) {
   var_1_8 = ((((var_1_24) > ((var_1_9 + 1))) ? (var_1_24) : ((var_1_9 + 1))));
  } else {
...
int property(void) {
 return (((((((((var_1_2 >= var_1_3) ? (var_1_1 == ((signed char) (((((var_1_4 + (var_1_5 - var_1_6))) < (var_1_7)) ? ((var_1_4 + (var_1_5 - var_1_6))) : (var_1_7))))) : 1) && ((var_1_5 > ((((var_1_7) < (var_1_24)) ? (var_1_7) : (var_1_24)))) ? ((var_1_6 < (var_1_5 << var_1_24)) ? (var_1_8 == ((signed long int) ((((var_1_24) > ((var_1_9 + 1))) ? (var_1_24) : ((var_1_9 + 1)))))) : (var_1_8 == ((signed long int) ((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5)))))) : (var_1_18 ? (var_1_8 == ((signed long int) var_1_9)) : 1))) && (((2.75f >= var_1_23) && ((var_1_6 - var_1_5) > (var_1_7 * var_1_4))) ? (var_1_11 == ((float) var_1_13)) : 1)) && (var_1_14 == ((unsigned short int) ((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5)))))) && ((128.8f != (1.6f * var_1_11)) ? (var_1_15 == ((signed char) ((var_1_16 + ((((var_1_17) > (4)) ? (var_1_17) : (4)))) + ((((var_1_5) < (var_1_4)) ? (var_1_5) : (var_1_4)))))) : 1)) && (((((((24.875 - var_1_19)) < (var_1_11)) ? ((24.875 - var_1_19)) : (var_1_11))) >= 99.2) ? (var_1_18 == ((unsigned char) ((! var_1_20) || var_1_21))) : ((var_1_13 < var_1_11) ? (var_1_18 == ((unsigned char) var_1_20)) : (var_1_18 == ((unsigned char) var_1_21))))) && (var_1_22 == ((signed char) var_1_4))) && (var_1_23 == ((double) var_1_13))) && (var_1_24 == ((signed long int) var_1_7))
;
}
int main(void) {
 isInitial = 1;
