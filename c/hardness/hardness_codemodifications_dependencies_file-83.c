...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch83dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch83dependencies
	var_1_7 = ((var_1_8 - var_1_9) - (100 - (var_1_10 + var_1_11)));


	// From: Req3Batch83dependencies
	if ((max (var_1_13 , var_1_14)) <= (- (var_1_15 / 4.9f))) {
		var_1_12 = 31.5f;
	}


	// From: Req4Batch83dependencies
	var_1_16 = (var_1_17 + (abs (var_1_18)));


	// From: Req5Batch83dependencies
	if ((var_1_9 % (var_1_8 - var_1_20)) > (abs (var_1_5))) {
		if ((var_1_3 ^ var_1_5) <= (var_1_4 ^ var_1_10)) {
			var_1_19 = var_1_17;
		}
	}


	// From: Req6Batch83dependencies
	if ((var_1_11 % var_1_20) < var_1_1) {
		var_1_22 = (max (10 , var_1_10));
	}


	// From: Req7Batch83dependencies
