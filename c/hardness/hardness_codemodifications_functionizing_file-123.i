...
signed long int functionized3(unsigned short int functionized3_localFunctionVar0) {
 return ((((var_1_13) > (functionized3_localFunctionVar0)) ? (var_1_13) : (functionized3_localFunctionVar0)));
}
float functionized4(float functionized4_localFunctionVar0) {
 return (var_1_18 - (((((var_1_19 - functionized4_localFunctionVar0)) > (var_1_21)) ? ((var_1_19 - functionized4_localFunctionVar0)) : (var_1_21))));
}
void initially(void) {
}
void step(void) {
