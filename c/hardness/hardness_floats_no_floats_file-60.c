...
int property(void) {
	return (((((var_1_2 > -25) ? ((var_1_15 && (var_1_2 <= (var_1_4 * var_1_5))) ? (var_1_1 == ((signed long int) var_1_6)) : (var_1_1 == ((signed long int) -2))) : (var_1_1 == ((signed long int) var_1_6))) && ((var_1_1 < ((min (var_1_4 , var_1_2)) / var_1_8)) ? (var_1_7 == ((signed long int) var_1_6)) : 1)) && (((var_1_1 == var_1_6) || var_1_15) ? ((var_1_8 <= (var_1_1 / var_1_10)) ? (((var_1_11 - var_1_12) > -10) ? (var_1_9 == ((unsigned long int) (max (var_1_12 , var_1_13)))) : (var_1_9 == ((unsigned long int) var_1_12))) : (var_1_9 == ((unsigned long int) var_1_12))) : (var_1_9 == ((unsigned long int) var_1_12)))) && (var_1_14 == ((signed long int) var_1_6))) && (var_1_15 == ((unsigned char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
