...
void functionized0(unsigned char functionized0_localFunctionVar0, signed long int functionized0_localFunctionVar1) {
	if (functionized0_localFunctionVar0) {
		var_1_1 = (max (var_1_3 , ((functionized0_localFunctionVar1 - var_1_5) - var_1_6)));
	} else {
		if (var_1_5 > var_1_3) {
			var_1_1 = (abs (16));
		} else {
...
void functionized2(signed short int functionized2_localFunctionVar0, double functionized2_localFunctionVar1, signed short int functionized2_localFunctionVar2, signed short int functionized2_localFunctionVar3) {
	if (! var_1_8) {
		var_1_10 = (min (functionized2_localFunctionVar0 , (functionized2_localFunctionVar3 + functionized2_localFunctionVar2)));
	} else {
...
signed long int functionized4(void) {
	return (min (10 , (max (var_1_17 , var_1_18))));
}
...
signed long int functionized6(unsigned char functionized6_localFunctionVar0, unsigned char functionized6_localFunctionVar1, signed char functionized6_localFunctionVar2) {
	return (max (((functionized6_localFunctionVar2 - functionized6_localFunctionVar0) + var_1_12) , (functionized6_localFunctionVar1 - var_1_18)));
}
...
void step(void) {
	// From: Req1Batch113functionizing
	functionized0(var_1_2, var_1_4);


	// From: Req2Batch113functionizing
	functionized1(var_1_8, var_1_2);


	// From: Req3Batch113functionizing
	functionized2(var_1_11, var_1_7, var_1_13, var_1_12);


	// From: Req4Batch113functionizing
	functionized3();


	// From: Req5Batch113functionizing
	if (var_1_5 != var_1_4) {
		var_1_16 = functionized4();
	}


	// From: Req6Batch113functionizing
	if (var_1_2 || var_1_8) {
		var_1_19 = var_1_20;
	} else {
		var_1_19 = (min (functionized5(var_1_21) , var_1_20));
	}


	// From: Req7Batch113functionizing
	var_1_22 = (var_1_23 - var_1_24);


	// From: Req8Batch113functionizing
	if (var_1_22 > 256.8) {
