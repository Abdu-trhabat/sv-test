...
void step(void) {
	...
	if (WrapperStruct00.var_1_2 <= stepLocal_1) {
		WrapperStruct00.var_1_1 = (min ((abs (WrapperStruct00.var_1_2)) , (WrapperStruct00.var_1_3 + WrapperStruct00.var_1_4)));
	} else {
	...
	// From: Req2Batch167Wrapper_S
	signed short int stepLocal_2 = WrapperStruct00.var_1_1;
	if (stepLocal_2 == WrapperStruct00.var_1_5) {
		WrapperStruct00.var_1_6 = (WrapperStruct00.var_1_7 + (max (WrapperStruct00.var_1_8 , WrapperStruct00.var_1_9)));
	}


	// From: Req3Batch167Wrapper_S
	if (WrapperStruct00.var_1_6 > WrapperStruct00.var_1_4) {
		if ((~ 16u) > (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_4))) {
