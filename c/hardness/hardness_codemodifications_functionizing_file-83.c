...
void functionized0(signed long int functionized0_localFunctionVar0, signed long int functionized0_localFunctionVar1, unsigned char functionized0_localFunctionVar2, signed long int functionized0_localFunctionVar3) {
	if (functionized0_localFunctionVar2) {
		...
		var_1_1 = ((max (var_1_3 , (functionized0_localFunctionVar0 - functionized0_localFunctionVar3))) - functionized0_localFunctionVar1);
	}
}
...
float functionized2(float functionized2_localFunctionVar0) {
	return (max (var_1_13 , functionized2_localFunctionVar0));
}
...
float functionized4(float functionized4_localFunctionVar0, float functionized4_localFunctionVar1) {
	return (functionized4_localFunctionVar0 + (abs (functionized4_localFunctionVar1)));
}
void functionized5(unsigned char functionized5_localFunctionVar0, signed long int functionized5_localFunctionVar1, unsigned char functionized5_localFunctionVar2, unsigned char functionized5_localFunctionVar3, signed long int functionized5_localFunctionVar4, signed long int functionized5_localFunctionVar5) {
	if ((functionized5_localFunctionVar3 % (var_1_8 - functionized5_localFunctionVar0)) > (abs (functionized5_localFunctionVar1))) {
...
void functionized6(unsigned char functionized6_localFunctionVar0, unsigned char functionized6_localFunctionVar1, signed long int functionized6_localFunctionVar2, signed long int localFunctionVar3) {
	if ((var_1_11 % functionized6_localFunctionVar0) < functionized6_localFunctionVar2) {
		var_1_22 = (max (localFunctionVar3 , functionized6_localFunctionVar1));
	}
}
...
int property(void) {
	return ((((((var_1_2 ? (var_1_1 == ((signed long int) ((var_1_3 - var_1_4) - var_1_5))) : (var_1_1 == ((signed long int) ((max (var_1_3 , (var_1_6 - var_1_4))) - var_1_5)))) && (var_1_7 == ((unsigned char) ((var_1_8 - var_1_9) - (100 - (var_1_10 + var_1_11)))))) && (((max (var_1_13 , var_1_14)) <= (- (var_1_15 / 4.9f))) ? (var_1_12 == ((float) 31.5f)) : 1)) && (var_1_16 == ((float) (var_1_17 + (abs (var_1_18)))))) && (((var_1_9 % (var_1_8 - var_1_20)) > (abs (var_1_5))) ? (((var_1_3 ^ var_1_5) <= (var_1_4 ^ var_1_10)) ? (var_1_19 == ((float) var_1_17)) : 1) : 1)) && (((var_1_11 % var_1_20) < var_1_1) ? (var_1_22 == ((signed char) (max (10 , var_1_10)))) : 1)) && (((3886175339u - var_1_9) <= (var_1_20 / var_1_3)) ? ((var_1_10 > var_1_7) ? (var_1_23 == ((unsigned char) (min (var_1_20 , (var_1_8 - var_1_9))))) : (var_1_23 == ((unsigned char) ((max (var_1_20 , 64)) + var_1_11)))) : (var_1_23 == ((unsigned char) var_1_20)))
;
}
int main(void) {
	isInitial = 1;
