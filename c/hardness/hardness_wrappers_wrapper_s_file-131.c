...
void step(void) {
	// From: Req1Batch131Wrapper_S
	if ((~ (WrapperStruct00.var_1_2 * WrapperStruct00.var_1_3)) < (WrapperStruct00.var_1_4 / (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_6)))) {
		WrapperStruct00.var_1_1 = (! (WrapperStruct00.var_1_7 || WrapperStruct00.var_1_8));
	}


	// From: Req2Batch131Wrapper_S
	...
	// From: Req3Batch131Wrapper_S
	unsigned long int stepLocal_1 = WrapperStruct00.var_1_4;
	if (stepLocal_1 >= WrapperStruct00.var_1_5) {
		WrapperStruct00.var_1_12 = (min (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_14));
	} else {
		WrapperStruct00.var_1_12 = (max (WrapperStruct00.var_1_13 , (max (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_15))));
	}


	// From: Req4Batch131Wrapper_S
	...
	if (WrapperStruct00.var_1_14 <= stepLocal_2) {
		WrapperStruct00.var_1_16 = (WrapperStruct00.var_1_17 - (WrapperStruct00.var_1_18 + (abs (WrapperStruct00.var_1_19))));
	} else {
...
int property(void) {
	return (((((~ (WrapperStruct00.var_1_2 * WrapperStruct00.var_1_3)) < (WrapperStruct00.var_1_4 / (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_6)))) ? (WrapperStruct00.var_1_1 == ((unsigned char) (! (WrapperStruct00.var_1_7 || WrapperStruct00.var_1_8)))) : 1) && ((WrapperStruct00.var_1_5 == (- WrapperStruct00.var_1_3)) ? (WrapperStruct00.var_1_9 == ((signed short int) (WrapperStruct00.var_1_10 - WrapperStruct00.var_1_11))) : (WrapperStruct00.var_1_9 == ((signed short int) WrapperStruct00.var_1_10)))) && ((WrapperStruct00.var_1_4 >= WrapperStruct00.var_1_5) ? (WrapperStruct00.var_1_12 == ((signed char) (min (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_14)))) : (WrapperStruct00.var_1_12 == ((signed char) (max (WrapperStruct00.var_1_13 , (max (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_15)))))))) && ((WrapperStruct00.var_1_14 <= ((WrapperStruct00.var_1_2 / WrapperStruct00.var_1_6) + WrapperStruct00.var_1_5)) ? (WrapperStruct00.var_1_16 == ((unsigned short int) (WrapperStruct00.var_1_17 - (WrapperStruct00.var_1_18 + (abs (WrapperStruct00.var_1_19)))))) : (WrapperStruct00.var_1_16 == ((unsigned short int) WrapperStruct00.var_1_20)))
;
}
int main(void) {
	isInitial = 1;
