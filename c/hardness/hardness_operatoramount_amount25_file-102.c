...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch102Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch102Amount25
	if (var_1_1 < (var_1_1 & (var_1_9 - var_1_10))) {
		var_1_7 = var_1_11;
	}


	// From: Req4Batch102Amount25
	var_1_13 = 5;


	// From: Req5Batch102Amount25
	var_1_14 = var_1_11;


	// From: Req3Batch102Amount25
	if ((var_1_6 | var_1_9) <= var_1_14) {
		if (var_1_8 > (var_1_9 * (max (var_1_1 , var_1_14)))) {
			if (var_1_4 != var_1_2) {
				var_1_12 = var_1_11;
			}
		}
