...
void step(void) {
	...
	// From: Req2Batch185Wrapper_P
	signed short int stepLocal_2 = (*(var_1_4_Pointer));
	if (stepLocal_2 == (min (32 , (*(var_1_5_Pointer))))) {
		if (! (*(var_1_2_Pointer))) {
			(*(var_1_7_Pointer)) = ((abs ((*(var_1_8_Pointer)))) - (*(var_1_9_Pointer)));
		} else {
	...
	// From: Req4Batch185Wrapper_P
	if ((abs (- (*(var_1_10_Pointer)))) < (((*(var_1_12_Pointer)) + (*(var_1_5_Pointer))) - ((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))))) {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) && (*(var_1_3_Pointer))) ? ((((*(var_1_4_Pointer)) - (*(var_1_5_Pointer))) <= (*(var_1_6_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed long int) (*(var_1_5_Pointer)))) : 1) : 1) && (((*(var_1_4_Pointer)) == (min (32 , (*(var_1_5_Pointer))))) ? ((! (*(var_1_2_Pointer))) ? ((*(var_1_7_Pointer)) == ((double) ((abs ((*(var_1_8_Pointer)))) - (*(var_1_9_Pointer))))) : ((*(var_1_7_Pointer)) == ((double) (*(var_1_9_Pointer))))) : ((*(var_1_7_Pointer)) == ((double) (*(var_1_8_Pointer)))))) && ((-64 < ((*(var_1_6_Pointer)) + (*(var_1_1_Pointer)))) ? ((*(var_1_10_Pointer)) == ((signed short int) ((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))))) : ((*(var_1_10_Pointer)) == ((signed short int) (*(var_1_11_Pointer)))))) && (((abs (- (*(var_1_10_Pointer)))) < (((*(var_1_12_Pointer)) + (*(var_1_5_Pointer))) - ((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))))) ? ((*(var_1_13_Pointer)) == ((double) (*(var_1_16_Pointer)))) : 1)
;
}
int main(void) {
	isInitial = 1;
