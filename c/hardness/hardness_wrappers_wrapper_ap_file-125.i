...
void step(void) {
 ...
 if ((*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) > (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
  if (! ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) < (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) {
   (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)) = ((((((((8) < (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) - 8))) ? (8) : (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) - 8))))) > ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))) ? (((((8) < (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) - 8))) ? (8) : (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) - 8))))) : ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))));
  }
 } else {
