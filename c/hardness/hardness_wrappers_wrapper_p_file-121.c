...
void step(void) {
	...
	// From: Req2Batch121Wrapper_P
	unsigned long int stepLocal_2 = max (((*(var_1_4_Pointer)) / (*(var_1_8_Pointer))) , (*(var_1_6_Pointer)));
	...
	// From: Req4Batch121Wrapper_P
	(*(var_1_13_Pointer)) = (*(var_1_14_Pointer));


	// From: Req5Batch121Wrapper_P
	(*(var_1_15_Pointer)) = (*(var_1_16_Pointer));


	// From: Req3Batch121Wrapper_P
	if ((*(var_1_2_Pointer)) <= (*(var_1_5_Pointer))) {
		if (! (*(var_1_15_Pointer))) {
			(*(var_1_10_Pointer)) = (min ((*(var_1_11_Pointer)) , ((*(var_1_12_Pointer)) + 2)));
		} else {
			(*(var_1_10_Pointer)) = (min ((abs ((*(var_1_12_Pointer)))) , (*(var_1_11_Pointer))));
		}
	}
}
...
int property(void) {
	return ((((((((*(var_1_2_Pointer)) + (*(var_1_3_Pointer))) - ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer)))) == (- (- (*(var_1_6_Pointer))))) ? (((*(var_1_3_Pointer)) != (*(var_1_2_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed long int) (*(var_1_4_Pointer)))) : 1) : ((*(var_1_1_Pointer)) == ((signed long int) (*(var_1_5_Pointer))))) && (((*(var_1_3_Pointer)) <= (max (((*(var_1_4_Pointer)) / (*(var_1_8_Pointer))) , (*(var_1_6_Pointer))))) ? ((*(var_1_7_Pointer)) == ((unsigned char) (! (*(var_1_9_Pointer))))) : ((*(var_1_7_Pointer)) == ((unsigned char) 0)))) && (((*(var_1_2_Pointer)) <= (*(var_1_5_Pointer))) ? ((! (*(var_1_15_Pointer))) ? ((*(var_1_10_Pointer)) == ((signed short int) (min ((*(var_1_11_Pointer)) , ((*(var_1_12_Pointer)) + 2))))) : ((*(var_1_10_Pointer)) == ((signed short int) (min ((abs ((*(var_1_12_Pointer)))) , (*(var_1_11_Pointer))))))) : 1)) && ((*(var_1_13_Pointer)) == ((unsigned char) (*(var_1_14_Pointer))))) && ((*(var_1_15_Pointer)) == ((unsigned char) (*(var_1_16_Pointer))))
;
}
int main(void) {
	isInitial = 1;
