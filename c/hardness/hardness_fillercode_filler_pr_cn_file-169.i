...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch169Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
   ...
   var_1_14
            ...
            if ( (( (( (((((var_1_31)) < ((var_1_32))) ? ((var_1_31)) : ((var_1_32))))) - (var_1_33))) <= (var_1_34))) {
             var_1_30 = (
   var_1_31
  );
 }
             if ( (( (( ((var_1_46) - (var_1_48))) / (-2))) < (var_1_40))) {
              if (var_1_42) {
               if (var_1_36) {
                var_1_47 = (
     var_1_43
 ...
 signed long int stepLocal_0 = (( ((var_1_21) - (var_1_4))) << (var_1_16));
   ...
   var_1_16
    ...
    var_1_25
             ...
             if ( ((var_1_30) >= ( (((((var_1_31)) < ((var_1_33))) ? ((var_1_31)) : ((var_1_33))))))) {
              if ( (( (( ((var_1_33) ^ (var_1_30))) * (var_1_34))) >= (var_1_31))) {
               var_1_35 = (
                ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))
   );
  } else {
               var_1_35 = (
                (((((( ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))) ) - ( 1.0000000000000005E15f ))) < 0 ) ? -((( ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))) ) - ( 1.0000000000000005E15f ))) : ((( ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37))) ) - ( 1.0000000000000005E15f )))))
   );
  }
 }
             if ( ((var_1_35) >= (var_1_37))) {
              var_1_38 = (
               ((((( var_1_31 )) > (( ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) ))) ? (( var_1_31 )) : (( ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) ))))
  );
 }
             if ( (( (~ ( (~ (var_1_31))))) <= (128))) {
              var_1_40 = (
              ...
              if ( ((var_1_36) && (var_1_42))) {
               var_1_40 = (
                ((((((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) < 0 ) ? -(((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41)))) : (((((var_1_41) < 0 ) ? -(var_1_41) : (var_1_41))))))
   );
  } else {
               var_1_40 = (
    var_1_41
