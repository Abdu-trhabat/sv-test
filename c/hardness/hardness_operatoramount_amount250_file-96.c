...
void step(void) {
	...
	var_1_42 = (min (var_1_33 , ((64 - var_1_31) - (var_1_34 + var_1_27))));
	...
	signed long int stepLocal_14 = max (var_1_30 , var_1_15);
	...
	signed long int stepLocal_1 = min (-4 , var_1_66);
	...
	if (stepLocal_10 <= (var_1_33 / var_1_28)) {
		var_1_50 = (min (var_1_26 , var_1_33));
	} else {
		if ((! 0) && stepLocal_9) {
			var_1_50 = ((32 - (var_1_51 - var_1_34)) + var_1_33);
		} else {
			var_1_50 = (max ((min (-2 , (-4 + var_1_51))) , var_1_30));
		}
	}
	...
	if (stepLocal_11 > var_1_4) {
		if (! (var_1_48 < var_1_45)) {
			if (var_1_63) {
				var_1_52 = (max (256 , (var_1_28 + var_1_31)));
			}
		} else {
			var_1_52 = 0;
		}
	...
	signed long int stepLocal_8 = min (25 , (var_1_23 << var_1_66));
	signed long int stepLocal_7 = var_1_66;
	signed long int stepLocal_6 = var_1_5;
	if (var_1_5 != stepLocal_7) {
		var_1_43 = (min (var_1_9 , (var_1_17 - (var_1_45 + var_1_46))));
	} else {
		if (var_1_52 < stepLocal_6) {
			if (var_1_52 <= stepLocal_8) {
				var_1_43 = (max (256.55f , var_1_47));
			}
		} else {
			var_1_43 = (var_1_17 - ((min (var_1_45 , var_1_46)) + var_1_48));
		}
	}


	// From: Req7Batch96Amount250
	if ((max ((128.25f + var_1_16) , var_1_43)) < (max (var_1_18 , var_1_10))) {
	...
	if (! var_1_63) {
		if (var_1_15 != (max (var_1_31 , (max (-5 , var_1_20))))) {
			var_1_49 = (2u + 5u);
		} else {
	...
	if (2 <= var_1_52) {
		if (! var_1_54) {
			if (! var_1_36) {
				var_1_59 = ((max ((var_1_60 - var_1_49) , (var_1_26 + var_1_49))) - var_1_34);
			} else {
		...
		var_1_59 = (var_1_12 + (max ((var_1_31 + var_1_52) , var_1_26)));
	}
	...
	signed long int stepLocal_17 = abs (var_1_28 - var_1_23);
	...
	if ((var_1_49 * var_1_5) <= ((var_1_1 ^ var_1_22) + (var_1_3 ^ var_1_66))) {
		if (((max (32 , var_1_27)) << (var_1_33 + var_1_34)) <= (var_1_31 / (abs (var_1_28)))) {
			var_1_32 = var_1_10;
		} else {
			var_1_32 = 16.2f;
		}
	...
	if ((var_1_18 > var_1_16) && (var_1_20 < (var_1_3 * var_1_23))) {
		...
		if ((max ((max (var_1_66 , var_1_12)) , var_1_31)) > var_1_49) {
...
int property(void) {
	return ((((((((((((((((((((((((((((var_1_1 == ((signed long int) (min (var_1_2 , (var_1_3 - (min (var_1_4 , var_1_5))))))) && ((0 == (min (-4 , var_1_66))) ? (var_1_54 ? ((var_1_4 < var_1_5) ? (var_1_6 == ((float) (max (var_1_9 , var_1_10)))) : (var_1_6 == ((float) var_1_10))) : 1) : 1)) && (var_1_11 == ((signed short int) (min (var_1_12 , 2))))) && ((var_1_4 <= var_1_3) ? (var_1_13 == ((signed short int) (abs (max (var_1_14 , var_1_15))))) : 1)) && ((! (var_1_10 > var_1_9)) ? (var_1_16 == ((float) (max ((max (var_1_9 , (var_1_17 - var_1_18))) , var_1_10)))) : 1)) && ((var_1_18 <= (- var_1_10)) ? (var_1_19 == ((float) (min (var_1_9 , var_1_10)))) : 1)) && (((max ((128.25f + var_1_16) , var_1_43)) < (max (var_1_18 , var_1_10))) ? (var_1_20 == ((unsigned short int) (max (var_1_21 , (256 + (min (var_1_22 , var_1_23))))))) : 1)) && ((var_1_10 >= (var_1_18 - var_1_17)) ? (var_1_57 ? ((var_1_61 >= var_1_22) ? (var_1_24 == ((unsigned short int) var_1_22)) : 1) : 1) : (var_1_24 == ((unsigned short int) (32 + var_1_23))))) && ((! (var_1_1 <= (- var_1_3))) ? ((var_1_49 > var_1_14) ? (var_1_25 == ((unsigned char) ((min ((var_1_26 - var_1_27) , var_1_28)) - var_1_29))) : (var_1_25 == ((unsigned char) ((var_1_26 - (var_1_30 + var_1_31)) - var_1_27)))) : (var_1_25 == ((unsigned char) (var_1_27 + var_1_31))))) && (((var_1_49 * var_1_5) <= ((var_1_1 ^ var_1_22) + (var_1_3 ^ var_1_66))) ? ((((max (32 , var_1_27)) << (var_1_33 + var_1_34)) <= (var_1_31 / (abs (var_1_28)))) ? (var_1_32 == ((float) var_1_10)) : (var_1_32 == ((float) 16.2f))) : 1)) && (((var_1_18 > var_1_16) && (var_1_20 < (var_1_3 * var_1_23))) ? (var_1_35 == ((signed short int) var_1_66)) : (((max ((max (var_1_66 , var_1_12)) , var_1_31)) > var_1_49) ? (var_1_35 == ((signed short int) (var_1_34 - var_1_33))) : 1))) && ((var_1_8 || var_1_37) ? (var_1_36 == ((unsigned char) (! (var_1_37 && var_1_38)))) : ((var_1_39 || var_1_8) ? (var_1_36 == ((unsigned char) (! var_1_40))) : (var_1_36 == ((unsigned char) (var_1_38 || (! (var_1_39 || var_1_40)))))))) && ((var_1_22 <= (- 10)) ? (var_1_41 == ((signed short int) (abs (128)))) : 1)) && (var_1_42 == ((signed char) (min (var_1_33 , ((64 - var_1_31) - (var_1_34 + var_1_27))))))) && ((var_1_5 != var_1_66) ? (var_1_43 == ((float) (min (var_1_9 , (var_1_17 - (var_1_45 + var_1_46)))))) : ((var_1_52 < var_1_5) ? ((var_1_52 <= (min (25 , (var_1_23 << var_1_66)))) ? (var_1_43 == ((float) (max (256.55f , var_1_47)))) : 1) : (var_1_43 == ((float) (var_1_17 - ((min (var_1_45 , var_1_46)) + var_1_48))))))) && ((! var_1_63) ? ((var_1_15 != (max (var_1_31 , (max (-5 , var_1_20))))) ? (var_1_49 == ((unsigned long int) (2u + 5u))) : (var_1_49 == ((unsigned long int) (var_1_21 + var_1_27)))) : (var_1_49 == ((unsigned long int) ((var_1_34 + var_1_26) + (var_1_30 + var_1_1)))))) && ((((var_1_34 * var_1_29) + var_1_30) <= (var_1_33 / var_1_28)) ? (var_1_50 == ((signed char) (min (var_1_26 , var_1_33)))) : (((! 0) && var_1_63) ? (var_1_50 == ((signed char) ((32 - (var_1_51 - var_1_34)) + var_1_33))) : (var_1_50 == ((signed char) (max ((min (-2 , (-4 + var_1_51))) , var_1_30))))))) && (((var_1_30 - var_1_28) > var_1_4) ? ((! (var_1_48 < var_1_45)) ? (var_1_63 ? (var_1_52 == ((unsigned short int) (max (256 , (var_1_28 + var_1_31))))) : 1) : (var_1_52 == ((unsigned short int) 0))) : 1)) && (var_1_38 ? (var_1_53 == ((unsigned char) (min (var_1_34 , 2)))) : ((var_1_12 == var_1_61) ? (var_1_53 == ((unsigned char) (var_1_27 + (var_1_31 + var_1_30)))) : 1))) && ((! var_1_36) ? (var_1_54 == ((unsigned char) var_1_38)) : (var_1_54 == ((unsigned char) ((var_1_38 || var_1_55) || var_1_56))))) && ((var_1_66 >= var_1_13) ? (var_1_57 == ((unsigned char) var_1_40)) : (var_1_57 == ((unsigned char) (! (var_1_40 && (var_1_55 || var_1_58))))))) && ((2 <= var_1_52) ? ((! var_1_54) ? ((! var_1_36) ? (var_1_59 == ((signed long int) ((max ((var_1_60 - var_1_49) , (var_1_26 + var_1_49))) - var_1_34))) : (var_1_59 == ((signed long int) (var_1_29 + -128)))) : (var_1_59 == ((signed long int) var_1_3))) : (var_1_59 == ((signed long int) (var_1_12 + (max ((var_1_31 + var_1_52) , var_1_26))))))) && (var_1_38 ? (var_1_61 == ((unsigned long int) (var_1_59 + (var_1_22 + var_1_1)))) : (var_1_61 == ((unsigned long int) (((var_1_62 - var_1_49) + var_1_33) + var_1_29))))) && ((var_1_23 == var_1_3) ? (((max (var_1_30 , var_1_15)) <= ((var_1_64 - var_1_28) - (var_1_65 - var_1_22))) ? (var_1_63 == ((unsigned char) (last_1_var_1_63 && var_1_38))) : 1) : (var_1_63 == ((unsigned char) var_1_58)))) && (var_1_56 ? (var_1_66 == ((signed long int) var_1_4)) : 1)) && (var_1_67 == ((double) var_1_47))) && (var_1_68 == ((double) var_1_18))) && (var_1_69 == ((signed char) var_1_33))) && ((var_1_49 > var_1_66) ? (var_1_56 ? (var_1_36 ? (((abs (var_1_28 - var_1_23)) <= var_1_52) ? (var_1_70 == ((double) 1.00000000000005E13)) : (var_1_70 == ((double) var_1_18))) : (var_1_70 == ((double) var_1_45))) : (var_1_70 == ((double) var_1_9))) : (var_1_70 == ((double) var_1_18)))
;
}
int main(void) {
	isInitial = 1;
