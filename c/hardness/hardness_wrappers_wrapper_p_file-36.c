...
void step(void) {
	...
	if (((*(var_1_8_Pointer)) >> 16u) < (abs ((*(var_1_9_Pointer))))) {
	...
	if ((*(var_1_2_Pointer)) > (*(var_1_5_Pointer))) {
		...
		(*(var_1_11_Pointer)) = (max ((*(var_1_12_Pointer)) , (max ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer))))));
	}
	...
	if (stepLocal_0 && (*(var_1_7_Pointer))) {
		if ((max ((*(var_1_2_Pointer)) , (- (*(var_1_3_Pointer))))) != (*(var_1_5_Pointer))) {
			if ((*(var_1_7_Pointer))) {
				(*(var_1_1_Pointer)) = 10u;
			} else {
...
int property(void) {
	return ((((((*(var_1_2_Pointer)) > (*(var_1_3_Pointer))) && (*(var_1_7_Pointer))) ? (((max ((*(var_1_2_Pointer)) , (- (*(var_1_3_Pointer))))) != (*(var_1_5_Pointer))) ? ((*(var_1_7_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned long int) 10u)) : ((*(var_1_1_Pointer)) == ((unsigned long int) (*(var_1_6_Pointer))))) : ((*(var_1_1_Pointer)) == ((unsigned long int) (*(var_1_6_Pointer))))) : ((*(var_1_1_Pointer)) == ((unsigned long int) (*(var_1_6_Pointer))))) && ((((*(var_1_8_Pointer)) >> 16u) < (abs ((*(var_1_9_Pointer))))) ? ((*(var_1_7_Pointer)) == ((unsigned char) ((*(var_1_4_Pointer)) || (*(var_1_10_Pointer))))) : 1)) && (((*(var_1_2_Pointer)) > (*(var_1_5_Pointer))) ? ((*(var_1_11_Pointer)) == ((double) 4.6)) : ((*(var_1_11_Pointer)) == ((double) (max ((*(var_1_12_Pointer)) , (max ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))))))))) && (((*(var_1_13_Pointer)) == (- (*(var_1_12_Pointer)))) ? (((*(var_1_4_Pointer)) && (*(var_1_7_Pointer))) ? ((*(var_1_15_Pointer)) == ((unsigned char) (*(var_1_17_Pointer)))) : ((*(var_1_15_Pointer)) == ((unsigned char) 0))) : ((*(var_1_15_Pointer)) == ((unsigned char) (*(var_1_17_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
