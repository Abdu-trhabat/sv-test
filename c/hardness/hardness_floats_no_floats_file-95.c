...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch95no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (! var_1_4) {
		var_1_3 = (max ((max (var_1_5 , -5)) , -10));
	}


	// From: Req3Batch95no_floats
	signed long int stepLocal_1 = var_1_2;
	unsigned char stepLocal_0 = -64 <= (var_1_5 / var_1_13);
	if (stepLocal_1 <= last_1_var_1_6) {
		var_1_6 = ((var_1_8 - (var_1_9 - var_1_10)) + (var_1_11 - var_1_12));
	} else {
		if (stepLocal_0 || (-1000000000 <= (abs (var_1_8)))) {
			var_1_6 = (var_1_12 - (abs (5)));
		} else {
			var_1_6 = var_1_2;
		}
	}
	...
	if (var_1_5 <= ((var_1_3 * var_1_13) + var_1_3)) {
		if (var_1_4 && var_1_16) {
			var_1_14 = 2;
		} else {
			var_1_14 = var_1_17;
...
int property(void) {
	return (((var_1_1 == ((signed long int) (abs (var_1_2)))) && ((! var_1_4) ? (var_1_3 == ((signed long int) (max ((max (var_1_5 , -5)) , -10)))) : 1)) && ((var_1_2 <= last_1_var_1_6) ? (var_1_6 == ((signed long int) ((var_1_8 - (var_1_9 - var_1_10)) + (var_1_11 - var_1_12)))) : (((-64 <= (var_1_5 / var_1_13)) || (-1000000000 <= (abs (var_1_8)))) ? (var_1_6 == ((signed long int) (var_1_12 - (abs (5))))) : (var_1_6 == ((signed long int) var_1_2))))) && ((var_1_5 <= ((var_1_3 * var_1_13) + var_1_3)) ? ((var_1_4 && var_1_16) ? (var_1_14 == ((unsigned char) 2)) : (var_1_14 == ((unsigned char) var_1_17))) : (var_1_14 == ((unsigned char) var_1_17)))
;
}
int main(void) {
	isInitial = 1;
