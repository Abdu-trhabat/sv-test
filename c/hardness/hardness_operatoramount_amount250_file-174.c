...
void step(void) {
	...
	// From: Req13Batch174Amount250
	var_1_48 = (min (((var_1_49 - last_1_var_1_51) - var_1_17) , (last_1_var_1_37 + var_1_6)));


	// From: Req14Batch174Amount250
	if (((last_1_var_1_1 * last_1_var_1_63) == var_1_26) || last_1_var_1_55) {
		if (var_1_35 <= last_1_var_1_32) {
			if (last_1_var_1_12) {
				var_1_50 = (min (last_1_var_1_63 , last_1_var_1_59));
			}
		}
	} else {
	...
	// From: Req8Batch174Amount250
	if ((var_1_9 & 500) > var_1_26) {
		if (var_1_9 == (last_1_var_1_50 % (min (var_1_16 , var_1_6)))) {
			var_1_37 = var_1_18;
		} else {
	...
	// From: Req6Batch174Amount250
	if ((var_1_13 - (min (var_1_15 , var_1_14))) > (var_1_32 + (var_1_30 - var_1_31))) {
		if ((var_1_5 * var_1_27) > var_1_48) {
			var_1_28 = ((var_1_15 != (max (var_1_14 , var_1_32))) || var_1_11);
		} else {
			var_1_28 = (! (! var_1_11));
		}
	}
	...
	// From: Req21Batch174Amount250
	signed long int stepLocal_14 = - var_1_41;
	signed long int stepLocal_13 = abs (last_1_var_1_1);
	...
	// From: Req5Batch174Amount250
	if (var_1_21) {
		var_1_25 = ((max (var_1_26 , var_1_27)) - var_1_6);
	} else {
		var_1_25 = ((min (var_1_16 , var_1_17)) + var_1_6);
	}


	// From: Req9Batch174Amount250
	if ((min (var_1_30 , var_1_36)) <= (1.2 * var_1_34)) {
		var_1_38 = (max (var_1_7 , var_1_17));
	}


	// From: Req11Batch174Amount250
	if (var_1_21) {
		var_1_40 = ((var_1_17 + var_1_41) + (var_1_42 - var_1_43));
	}


	// From: Req12Batch174Amount250
	signed long int stepLocal_9 = var_1_16 / (max (var_1_7 , var_1_26));
	unsigned char stepLocal_8 = var_1_16;
	if (var_1_30 <= var_1_36) {
		if (stepLocal_9 <= (var_1_40 * (min (var_1_37 , var_1_43)))) {
			if (var_1_19) {
				var_1_44 = var_1_36;
			}
		} else {
			if (stepLocal_8 >= (~ 0)) {
				...
				var_1_44 = ((abs (var_1_36)) + (var_1_46 + var_1_47));
			}
		}
	}


	// From: Req16Batch174Amount250
	if (var_1_11) {
	...
	// From: Req19Batch174Amount250
	unsigned char stepLocal_11 = var_1_10;
	if ((var_1_36 <= var_1_45) && stepLocal_11) {
		var_1_56 = (max (var_1_34 , (max (var_1_46 , var_1_33))));
	} else {
		var_1_56 = (((var_1_57 - 1.5f) - var_1_36) - var_1_45);
	}


	// From: Req20Batch174Amount250
	unsigned char stepLocal_12 = var_1_43;
	if (stepLocal_12 > 16) {
		var_1_58 = var_1_52;
	} else {
		var_1_58 = (min ((var_1_5 + var_1_7) , 64));
	}


	// From: Req23Batch174Amount250
	var_1_63 = var_1_42;


	// From: Req18Batch174Amount250
	...
	// From: Req15Batch174Amount250
	if (var_1_7 < var_1_48) {
		if ((var_1_58 / var_1_16) > (var_1_41 >> var_1_52)) {
			var_1_51 = ((max (var_1_5 , var_1_16)) - var_1_7);
		} else {
	...
	// From: Req1Batch174Amount250
	signed long int stepLocal_2 = abs (-16);
	...
	if (stepLocal_0 != -8) {
		if (stepLocal_1 > var_1_63) {
			...
			var_1_1 = (var_1_50 - (max (10 , var_1_63)));
		}
	} else {
	...
	// From: Req4Batch174Amount250
	signed long int stepLocal_7 = (var_1_16 - var_1_17) - (max (var_1_7 , var_1_18));
	...
	// From: Req10Batch174Amount250
	if (var_1_55) {
		var_1_39 = (min (var_1_34 , var_1_35));
	}


	// From: Req17Batch174Amount250
	signed long int stepLocal_10 = (var_1_41 - var_1_7) | var_1_63;
	if (stepLocal_10 < var_1_43) {
		var_1_54 = (var_1_52 + (min (var_1_41 , 4)));
	} else {
		var_1_54 = (max (var_1_17 , (var_1_41 - var_1_7)));
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((var_1_63 + var_1_50) != -8) ? ((var_1_50 > var_1_63) ? (var_1_1 == ((signed long int) var_1_50)) : (var_1_1 == ((signed long int) (var_1_50 - (max (10 , var_1_63)))))) : (((abs (-16)) > var_1_63) ? (var_1_1 == ((signed long int) (var_1_63 - var_1_50))) : 1)) && ((((var_1_59 + 5) / (abs (var_1_5))) <= var_1_25) ? ((var_1_25 > var_1_48) ? (var_1_4 == ((signed short int) (max (var_1_59 , -4)))) : 1) : ((var_1_5 > ((- var_1_59) / (var_1_6 - var_1_7))) ? ((! var_1_53) ? (var_1_4 == ((signed short int) ((var_1_9 - var_1_5) - var_1_6))) : 1) : (var_1_4 == ((signed short int) var_1_5))))) && ((var_1_37 < 4) ? (var_1_10 == ((unsigned char) var_1_11)) : 1)) && (((var_1_13 - var_1_14) >= (var_1_15 - 4.6)) ? ((var_1_40 <= ((var_1_16 - var_1_17) - (max (var_1_7 , var_1_18)))) ? (var_1_12 == ((unsigned char) (((var_1_11 && var_1_19) && (var_1_10 || var_1_20)) && (var_1_28 || var_1_21)))) : (var_1_12 == ((unsigned char) ((var_1_40 > var_1_5) || (var_1_20 || var_1_21))))) : ((var_1_15 != var_1_13) ? (var_1_12 == ((unsigned char) (var_1_11 && (var_1_22 || (var_1_10 && var_1_24))))) : (var_1_12 == ((unsigned char) (var_1_22 && (! var_1_21))))))) && (var_1_21 ? (var_1_25 == ((unsigned short int) ((max (var_1_26 , var_1_27)) - var_1_6))) : (var_1_25 == ((unsigned short int) ((min (var_1_16 , var_1_17)) + var_1_6))))) && (((var_1_13 - (min (var_1_15 , var_1_14))) > (var_1_32 + (var_1_30 - var_1_31))) ? (((var_1_5 * var_1_27) > var_1_48) ? (var_1_28 == ((unsigned char) ((var_1_15 != (max (var_1_14 , var_1_32))) || var_1_11))) : (var_1_28 == ((unsigned char) (! (! var_1_11))))) : 1)) && (((var_1_9 * (var_1_16 + var_1_17)) < (var_1_27 - 25)) ? (var_1_32 == ((double) (var_1_33 + var_1_34))) : ((last_1_var_1_55 || (! var_1_21)) ? (var_1_32 == ((double) (max (var_1_35 , var_1_33)))) : (var_1_32 == ((double) ((256.5 - var_1_36) + var_1_33)))))) && (((var_1_9 & 500) > var_1_26) ? ((var_1_9 == (last_1_var_1_50 % (min (var_1_16 , var_1_6)))) ? (var_1_37 == ((unsigned char) var_1_18)) : ((last_1_var_1_25 > var_1_27) ? (var_1_37 == ((unsigned char) (var_1_7 + var_1_17))) : 1)) : (var_1_37 == ((unsigned char) var_1_7)))) && (((min (var_1_30 , var_1_36)) <= (1.2 * var_1_34)) ? (var_1_38 == ((unsigned char) (max (var_1_7 , var_1_17)))) : 1)) && (var_1_55 ? (var_1_39 == ((float) (min (var_1_34 , var_1_35)))) : 1)) && (var_1_21 ? (var_1_40 == ((unsigned char) ((var_1_17 + var_1_41) + (var_1_42 - var_1_43)))) : 1)) && ((var_1_30 <= var_1_36) ? (((var_1_16 / (max (var_1_7 , var_1_26))) <= (var_1_40 * (min (var_1_37 , var_1_43)))) ? (var_1_19 ? (var_1_44 == ((float) var_1_36)) : 1) : ((var_1_16 >= (~ 0)) ? (var_1_44 == ((float) (var_1_36 - var_1_45))) : (var_1_44 == ((float) ((abs (var_1_36)) + (var_1_46 + var_1_47)))))) : 1)) && (var_1_48 == ((unsigned long int) (min (((var_1_49 - last_1_var_1_51) - var_1_17) , (last_1_var_1_37 + var_1_6)))))) && ((((last_1_var_1_1 * last_1_var_1_63) == var_1_26) || last_1_var_1_55) ? ((var_1_35 <= last_1_var_1_32) ? (last_1_var_1_12 ? (var_1_50 == ((signed short int) (min (last_1_var_1_63 , last_1_var_1_59)))) : 1) : 1) : (var_1_50 == ((signed short int) (last_1_var_1_63 + last_1_var_1_25))))) && ((var_1_7 < var_1_48) ? (((var_1_58 / var_1_16) > (var_1_41 >> var_1_52)) ? (var_1_51 == ((signed long int) ((max (var_1_5 , var_1_16)) - var_1_7))) : (var_1_51 == ((signed long int) (var_1_42 + -32)))) : (var_1_51 == ((signed long int) (((var_1_59 - var_1_17) + (var_1_26 - var_1_43)) + var_1_52))))) && (var_1_11 ? (var_1_53 == ((unsigned char) ((var_1_10 || var_1_19) && (var_1_20 && var_1_21)))) : (var_1_53 == ((unsigned char) (! ((! var_1_20) || var_1_24)))))) && ((((var_1_41 - var_1_7) | var_1_63) < var_1_43) ? (var_1_54 == ((signed char) (var_1_52 + (min (var_1_41 , 4))))) : (var_1_54 == ((signed char) (max (var_1_17 , (var_1_41 - var_1_7))))))) && ((var_1_32 > (- (var_1_31 * var_1_14))) ? (var_1_55 == ((unsigned char) ((2 < var_1_59) || (var_1_20 && var_1_11)))) : (var_1_55 == ((unsigned char) (var_1_19 && var_1_20))))) && (((var_1_36 <= var_1_45) && var_1_10) ? (var_1_56 == ((float) (max (var_1_34 , (max (var_1_46 , var_1_33)))))) : (var_1_56 == ((float) (((var_1_57 - 1.5f) - var_1_36) - var_1_45))))) && ((var_1_43 > 16) ? (var_1_58 == ((signed short int) var_1_52)) : (var_1_58 == ((signed short int) (min ((var_1_5 + var_1_7) , 64)))))) && ((last_1_var_1_51 != (abs (last_1_var_1_1))) ? (((- var_1_41) == (-100 * var_1_26)) ? (var_1_59 == ((unsigned long int) (var_1_49 - var_1_5))) : (var_1_59 == ((unsigned long int) (((var_1_60 - last_1_var_1_37) - last_1_var_1_61) - last_1_var_1_50)))) : (var_1_59 == ((unsigned long int) var_1_43)))) && (((var_1_59 + (50 + var_1_42)) > (64u << last_1_var_1_61)) ? (var_1_61 == ((signed short int) (var_1_5 - ((var_1_62 - var_1_25) - var_1_40)))) : 1)) && (var_1_63 == ((unsigned short int) var_1_42))
;
}
int main(void) {
	isInitial = 1;
