...
void step(void) {
 ...
 if (last_1_var_1_10 > stepLocal_5) {
  if (((*(var_1_8_Pointer)) - (*(var_1_11_Pointer))) > stepLocal_4) {
   (*(var_1_10_Pointer)) = ((((((*(var_1_11_Pointer))) < ((last_1_var_1_10 + (*(var_1_1_Pointer))))) ? ((*(var_1_11_Pointer))) : ((last_1_var_1_10 + (*(var_1_1_Pointer)))))) + (*(var_1_12_Pointer)));
  }
 } else {
 ...
 if (stepLocal_2 == ((((((*(var_1_10_Pointer)) | (*(var_1_1_Pointer)))) < ((*(var_1_1_Pointer)))) ? (((*(var_1_10_Pointer)) | (*(var_1_1_Pointer)))) : ((*(var_1_1_Pointer)))))) {
