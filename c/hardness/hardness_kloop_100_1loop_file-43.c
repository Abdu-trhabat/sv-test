...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch43100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_18 <= (~ var_1_4)) {
		if (var_1_6) {
			var_1_24 = (min (256 , ((var_1_1 + var_1_18) + (min (var_1_1 , var_1_5)))));
		} else {
			var_1_24 = -5;
		}
	} else {
	...
	if ((var_1_30 | var_1_24) < stepLocal_6) {
		var_1_31 = (min (((min (var_1_30 , var_1_32)) - (var_1_33 + var_1_34)) , (var_1_29 - (max (var_1_35 , 0)))));
	} else {
		var_1_31 = var_1_33;
	}
	...
	if (last_1_var_1_14 || var_1_6) {
		if ((var_1_13 | (max (var_1_5 , 128))) < var_1_13) {
	...
	if (stepLocal_3 >= var_1_18) {
		if (var_1_26) {
			if (var_1_8 <= (max (var_1_10 , var_1_9))) {
...
int property(void) {
	return ((((((((((((var_1_2 && var_1_3) ? (var_1_1 == ((unsigned char) (var_1_4 + 5))) : (var_1_1 == ((unsigned char) (abs (var_1_5))))) && ((((var_1_7 + 100000.5f) - var_1_8) > (var_1_9 + var_1_10)) ? ((var_1_8 > var_1_9) ? (var_1_6 == ((unsigned char) (var_1_11 || var_1_12))) : (var_1_6 == ((unsigned char) var_1_11))) : (var_1_6 == ((unsigned char) 0)))) && ((var_1_7 > last_1_var_1_19) ? ((var_1_5 < last_1_var_1_25) ? (var_1_13 == ((signed long int) (var_1_4 - 1))) : (var_1_13 == ((signed long int) var_1_5))) : (var_1_13 == ((signed long int) var_1_4)))) && ((last_1_var_1_14 || var_1_6) ? (((var_1_13 | (max (var_1_5 , 128))) < var_1_13) ? (var_1_14 == ((unsigned char) (var_1_11 || var_1_12))) : 1) : 1)) && ((var_1_6 && var_1_14) ? (var_1_16 == ((signed char) (min ((var_1_17 + var_1_18) , -5)))) : (var_1_2 ? (var_1_16 == ((signed char) var_1_17)) : 1))) && (((var_1_24 ^ 1) >= var_1_18) ? (var_1_26 ? ((var_1_8 <= (max (var_1_10 , var_1_9))) ? (var_1_19 == ((double) (max (var_1_7 , ((var_1_20 + var_1_21) + (var_1_22 + var_1_23)))))) : (var_1_19 == ((double) var_1_21))) : 1) : 1)) && ((var_1_18 <= (~ var_1_4)) ? (var_1_6 ? (var_1_24 == ((signed long int) (min (256 , ((var_1_1 + var_1_18) + (min (var_1_1 , var_1_5))))))) : (var_1_24 == ((signed long int) -5))) : (var_1_24 == ((signed long int) var_1_18)))) && (((10000 / 64) >= (var_1_13 | var_1_16)) ? (var_1_25 == ((unsigned long int) (max (var_1_5 , var_1_4)))) : ((var_1_13 < (abs (var_1_4))) ? (var_1_25 == ((unsigned long int) var_1_1)) : (var_1_25 == ((unsigned long int) 8u))))) && (var_1_14 ? (var_1_26 == ((unsigned char) (! (! var_1_27)))) : (var_1_26 == ((unsigned char) (var_1_6 || ((-16 <= var_1_13) || (! var_1_11))))))) && (var_1_28 == ((signed char) (var_1_29 - var_1_30)))) && (((var_1_30 | var_1_24) < (var_1_5 + (var_1_18 / -2))) ? (var_1_31 == ((signed char) (min (((min (var_1_30 , var_1_32)) - (var_1_33 + var_1_34)) , (var_1_29 - (max (var_1_35 , 0))))))) : (var_1_31 == ((signed char) var_1_33)))) && (var_1_36 == ((double) var_1_7))
;
}
int main(void) {
	isInitial = 1;
