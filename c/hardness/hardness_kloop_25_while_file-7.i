...
void step(void) {
 if (var_1_4 > (((((var_1_3) < (var_1_2)) ? (var_1_3) : (var_1_2))) * (- 0.125f))) {
...
int property(void) {
 return (((! (var_1_6 <= (var_1_3 - var_1_4))) ? ((var_1_6 < var_1_3) ? ((! (var_1_3 > var_1_6)) ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_1 == ((unsigned char) 1))) : (var_1_1 == ((unsigned char) var_1_5))) : (var_1_1 == ((unsigned char) var_1_5))) && ((var_1_4 > (((((var_1_3) < (var_1_2)) ? (var_1_3) : (var_1_2))) * (- 0.125f))) ? (var_1_6 == ((float) ((((var_1_7) > ((var_1_8 + var_1_9))) ? (var_1_7) : ((var_1_8 + var_1_9)))))) : 1)) && ((var_1_6 <= var_1_4) ? ((var_1_8 > var_1_9) ? (var_1_10 == ((signed long int) var_1_1)) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
