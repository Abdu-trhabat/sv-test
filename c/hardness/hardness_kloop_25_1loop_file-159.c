...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15925_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch15925_1loop
	if (last_1_var_1_14) {
		var_1_10 = var_1_11;
	} else {
		var_1_10 = (min ((max (var_1_11 , (var_1_12 + 64.7))) , var_1_13));
	}


	// From: Req1Batch15925_1loop
	...
	// From: Req2Batch15925_1loop
	if (! var_1_5) {
		var_1_7 = (var_1_8 - var_1_9);
	}


	// From: Req4Batch15925_1loop
