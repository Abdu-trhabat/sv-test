...
void step(void) {
	...
	if (var_1_6 > (min (var_1_8 , last_1_var_1_1))) {
		if (! ((last_1_var_1_1 == var_1_7) && (var_1_2 || var_1_10))) {
			if (! (var_1_6 <= var_1_7)) {
				var_1_9 = (min (last_1_var_1_14 , last_1_var_1_18));
			}
		} else {
	...
	var_1_11 = (var_1_14 + ((min (var_1_18 , var_1_9)) + 2u));


	// From: Req1Batch70normal
	unsigned long int stepLocal_0 = var_1_11;
	if (stepLocal_0 >= (- (min (var_1_11 , var_1_14)))) {
	...
	if ((var_1_18 / var_1_19) <= (min (var_1_11 , var_1_18))) {
		var_1_20 = var_1_13;
	}
...
int property(void) {
	return (((((((var_1_11 >= (- (min (var_1_11 , var_1_14)))) ? (var_1_1 == ((double) (((var_1_6 - var_1_7) - (max (64.75 , 128.725))) + var_1_8))) : (var_1_1 == ((double) var_1_7))) && ((var_1_6 > (min (var_1_8 , last_1_var_1_1))) ? ((! ((last_1_var_1_1 == var_1_7) && (var_1_2 || var_1_10))) ? ((! (var_1_6 <= var_1_7)) ? (var_1_9 == ((unsigned short int) (min (last_1_var_1_14 , last_1_var_1_18)))) : 1) : (var_1_9 == ((unsigned short int) last_1_var_1_18))) : 1)) && (var_1_11 == ((unsigned long int) (var_1_14 + ((min (var_1_18 , var_1_9)) + 2u))))) && (var_1_20 ? (var_1_12 == ((unsigned char) var_1_13)) : 1)) && (((8 - 64) <= (last_1_var_1_9 - last_1_var_1_18)) ? (var_1_14 == ((unsigned char) (min ((var_1_15 + var_1_16) , var_1_17)))) : (var_1_14 == ((unsigned char) var_1_17)))) && (var_1_13 ? (var_1_18 == ((unsigned long int) ((var_1_19 - var_1_9) - var_1_14))) : (var_1_18 == ((unsigned long int) (max ((var_1_19 - var_1_17) , var_1_15)))))) && (((var_1_18 / var_1_19) <= (min (var_1_11 , var_1_18))) ? (var_1_20 == ((unsigned char) var_1_13)) : 1)
;
}
int main(void) {
	isInitial = 1;
