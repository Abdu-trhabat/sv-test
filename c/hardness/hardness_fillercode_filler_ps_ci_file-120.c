...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch120Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch120Filler_PS_CI
	/* 962L, 255L, 773L, 779L) */ var_1_22 = (
		var_1_14
	);


	// From: Req4Batch120Filler_PS_CI
