...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch19stepLocals
	signed long int stepLocal_0 = var_1_2 - var_1_3;
	if (stepLocal_0 <= (max (var_1_4 , var_1_5))) {
	...
	// From: Req3Batch19stepLocals
	if (var_1_11) {
		var_1_10 = (var_1_12 || var_1_13);
	}


	// From: Req4Batch19stepLocals
	if (var_1_11) {
		var_1_14 = (min ((abs (max (var_1_3 , var_1_2))) , var_1_9));
	}


	// From: Req5Batch19stepLocals
	if ((- var_1_16) == (var_1_17 + var_1_18)) {
		var_1_15 = var_1_12;
	}


	// From: Req6Batch19stepLocals
	if (var_1_18 == (max ((max (3.3 , var_1_16)) , (var_1_20 / var_1_21)))) {
		if (var_1_22) {
...
int property(void) {
	return (((((((((var_1_2 - var_1_3) <= (max (var_1_4 , var_1_5))) ? (var_1_1 == ((signed long int) (max (var_1_2 , var_1_3)))) : (var_1_1 == ((signed long int) var_1_2))) && (((var_1_7 - (var_1_8 - var_1_2)) >= var_1_4) ? (var_1_6 == ((signed short int) (var_1_3 - (var_1_9 - var_1_2)))) : 1)) && (var_1_11 ? (var_1_10 == ((unsigned char) (var_1_12 || var_1_13))) : 1)) && (var_1_11 ? (var_1_14 == ((signed short int) (min ((abs (max (var_1_3 , var_1_2))) , var_1_9)))) : 1)) && (((- var_1_16) == (var_1_17 + var_1_18)) ? (var_1_15 == ((unsigned char) var_1_12)) : 1)) && ((var_1_18 == (max ((max (3.3 , var_1_16)) , (var_1_20 / var_1_21)))) ? (var_1_22 ? (var_1_19 == ((signed short int) (var_1_3 + (min (var_1_2 , var_1_23))))) : (var_1_19 == ((signed short int) (var_1_3 - 8)))) : (var_1_19 == ((signed short int) var_1_2)))) && (var_1_15 ? (var_1_24 == ((float) (max (var_1_25 , (abs (var_1_26)))))) : (var_1_24 == ((float) (abs (var_1_27 - var_1_28)))))) && ((var_1_20 != var_1_16) ? (var_1_29 == ((unsigned short int) (max (var_1_2 , var_1_3)))) : 1)
;
}
int main(void) {
	isInitial = 1;
