...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch166Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	/* 409L, 308L) */ if (/* 410L, 211L, 212L) */ ((/* 411L, 205L, 213L) */ ((/* 412L, 203L, 214L) */ (abs (var_1_6))) % (var_1_45))) < (/* 415L, 210L, 217L) */ ((/* 416L, 208L, 218L) */ (min (/* 416L, 208L, 218L) */ (var_1_38) , (var_1_40)))) >> (var_1_46))))) {
		/* 420L, 235L) */ var_1_44 = (
			var_1_47
		);
	} else {
