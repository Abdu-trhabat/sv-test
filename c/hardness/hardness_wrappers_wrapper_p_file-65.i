...
void step(void) {
 ...
 if ((*(var_1_4_Pointer)) > (*(var_1_1_Pointer))) {
  (*(var_1_5_Pointer)) = ((((((*(var_1_6_Pointer))) > (-64)) ? ((*(var_1_6_Pointer))) : (-64))) + (((*(var_1_7_Pointer)) + -2) + (*(var_1_8_Pointer))));
 }
