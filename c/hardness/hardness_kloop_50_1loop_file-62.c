...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch6250_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	var_1_13 = ((min (var_1_7 , var_1_8)) + (var_1_14 + var_1_15));
	...
	var_1_20 = (max (var_1_7 , var_1_15));


	// From: Req8Batch6250_1loop
	signed long int stepLocal_3 = -5;
	if (var_1_13 < (max (var_1_7 , var_1_1))) {
		if (stepLocal_3 < (var_1_17 + var_1_4)) {
			var_1_21 = (max (var_1_15 , (var_1_7 - var_1_6)));
		} else {
			var_1_21 = var_1_14;
		}
	} else {
...
int property(void) {
	return ((((((((var_1_2 > ((var_1_3 % var_1_4) * var_1_5)) ? (var_1_1 == ((double) (var_1_6 - (var_1_7 + var_1_8)))) : ((var_1_8 > var_1_7) ? (var_1_1 == ((double) (var_1_7 + var_1_8))) : (var_1_1 == ((double) var_1_8)))) && ((var_1_6 > (- var_1_8)) ? (var_1_9 == ((signed char) (var_1_10 - var_1_11))) : (var_1_12 ? (var_1_9 == ((signed char) (min (var_1_10 , var_1_11)))) : 1))) && (var_1_13 == ((double) ((min (var_1_7 , var_1_8)) + (var_1_14 + var_1_15))))) && (((- var_1_3) <= -100000) ? (var_1_16 == ((float) ((var_1_7 - var_1_8) + var_1_15))) : (var_1_16 == ((float) var_1_15)))) && (((var_1_12 || (var_1_4 >= var_1_3)) && var_1_18) ? (var_1_17 == ((unsigned char) var_1_11)) : 1)) && (var_1_19 == ((unsigned char) var_1_11))) && (var_1_20 == ((double) (max (var_1_7 , var_1_15))))) && ((var_1_13 < (max (var_1_7 , var_1_1))) ? ((-5 < (var_1_17 + var_1_4)) ? (var_1_21 == ((double) (max (var_1_15 , (var_1_7 - var_1_6))))) : (var_1_21 == ((double) var_1_14))) : (var_1_21 == ((double) var_1_15)))
;
}
int main(void) {
	isInitial = 1;
