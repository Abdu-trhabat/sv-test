...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch175stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch175stepLocals
	signed long int stepLocal_1 = (var_1_2 - var_1_3) - var_1_4;
	...
	// From: Req2Batch175stepLocals
	var_1_5 = (! (var_1_6 && var_1_7));


	// From: Req3Batch175stepLocals
	if ((var_1_9 * (var_1_10 + var_1_11)) > var_1_12) {
		var_1_8 = var_1_7;
	}


	// From: Req4Batch175stepLocals
	var_1_13 = (((var_1_2 * var_1_4) > var_1_1) && (! var_1_6));


	// From: Req5Batch175stepLocals
	...
	// From: Req6Batch175stepLocals
	var_1_20 = (var_1_18 + (max ((var_1_19 - 5.9f) , var_1_21)));


	// From: Req7Batch175stepLocals
