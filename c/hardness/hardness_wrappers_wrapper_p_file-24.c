...
void step(void) {
	...
	if ((max (((*(var_1_17_Pointer)) * 127.75) , ((*(var_1_8_Pointer)) / 3.4))) >= (*(var_1_9_Pointer))) {
		(*(var_1_7_Pointer)) = (min (((*(var_1_10_Pointer)) - (22925 - (*(var_1_5_Pointer)))) , (*(var_1_11_Pointer))));
	}
}
