...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch132Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch132Amount100
	if (last_1_var_1_27) {
		var_1_26 = ((min (last_1_var_1_30 , last_1_var_1_19)) + var_1_10);
	}


	// From: Req11Batch132Amount100
	if (var_1_27) {
	...
	// From: Req4Batch132Amount100
	var_1_18 = var_1_17;


	// From: Req8Batch132Amount100
	var_1_24 = var_1_25;


	// From: Req12Batch132Amount100
	...
	// From: Req13Batch132Amount100
	var_1_40 = var_1_25;


	// From: Req7Batch132Amount100
	var_1_23 = ((var_1_39 + var_1_19) + var_1_10);


	// From: Req6Batch132Amount100
