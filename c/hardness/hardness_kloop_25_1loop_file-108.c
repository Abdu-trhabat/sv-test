...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10825_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch10825_1loop
	var_1_8 = (var_1_9 && var_1_10);


	// From: Req4Batch10825_1loop
	var_1_13 = (max (var_1_12 , ((min (var_1_14 , var_1_15)) + var_1_16)));


	// From: Req1Batch10825_1loop
...
int property(void) {
	return ((((((var_1_13 * -2) != var_1_3) || var_1_8) ? ((var_1_13 > var_1_3) ? ((! (var_1_3 > var_1_13)) ? (var_1_1 == ((float) ((max (var_1_5 , var_1_6)) + var_1_7))) : (var_1_1 == ((float) var_1_6))) : (var_1_1 == ((float) var_1_7))) : (var_1_1 == ((float) 99.75f))) && (var_1_8 == ((unsigned char) (var_1_9 && var_1_10)))) && ((var_1_5 <= var_1_1) ? (var_1_11 == ((signed char) (abs (var_1_12)))) : 1)) && (var_1_13 == ((signed char) (max (var_1_12 , ((min (var_1_14 , var_1_15)) + var_1_16)))))
;
}
int main(void) {
	isInitial = 1;
