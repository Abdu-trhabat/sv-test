...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch60Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (WrapperStruct00.var_1_2 > WrapperStruct00.var_1_1) {
  if (WrapperStruct00.var_1_9) {
   if (WrapperStruct00.var_1_3 <= ((((WrapperStruct00.var_1_1) < (WrapperStruct00.var_1_11)) ? (WrapperStruct00.var_1_1) : (WrapperStruct00.var_1_11)))) {
