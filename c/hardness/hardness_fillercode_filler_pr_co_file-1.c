...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	/* 281L, 120L) */ if (/* 282L, 102L, 103L) */ ((63.75f) <= (var_1_10))) {
		/* 285L, 119L) */ var_1_38 = (
			/* 288L, 118L) */ ((
				/* 289L, 115L) */ ((
					var_1_40
	...
	// From: CodeObject5
	/* 296L, 150L) */ if (/* 297L, 127L, 128L) */ ((var_1_6) < (/* 299L, 126L, 130L) */ (abs (var_1_12))))) {
		/* 301L, 141L) */ var_1_43 = (
			/* 304L, 140L) */ ((
				var_1_45
			) || (
	...
	// From: CodeObject7
	/* 321L, 236L) */ if (/* 322L, 171L, 172L) */ ((/* 323L, 169L, 173L) */ ((/* 324L, 165L, 174L) */ ((var_1_49) - (var_1_50))) - (/* 327L, 168L, 177L) */ (min (/* 327L, 168L, 177L) */ (var_1_51) , (var_1_52)))))) > (var_1_12))) {
		/* 331L, 230L) */ if (/* 332L, 202L, 203L) */ ((/* 333L, 197L, 204L) */ (min (/* 333L, 197L, 204L) */ (var_1_49) , (var_1_12)))) <= (/* 336L, 201L, 207L) */ (- (/* 337L, 200L, 208L) */ (min (/* 337L, 200L, 208L) */ (var_1_51) , (9.99999999999995E13f)))))))) {
			/* 340L, 225L) */ var_1_48 = (
				/* 343L, 224L) */ (abs (
					/* 344L, 223L) */ (max (
						/* 344L, 223L) */ (
