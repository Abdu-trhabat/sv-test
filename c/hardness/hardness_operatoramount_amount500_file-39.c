...
void step(void) {
	...
	if (stepLocal_29 == last_1_var_1_55) {
		...
		if (stepLocal_28 < last_1_var_1_19) {
			var_1_97 = (min ((var_1_22 - last_1_var_1_53) , var_1_83));
		} else {
			var_1_97 = 256u;
		}
	}
	...
	if (stepLocal_16 == (var_1_4 - var_1_11)) {
		if (stepLocal_17 <= last_1_var_1_24) {
			var_1_59 = (min (last_1_var_1_41 , var_1_22));
		} else {
			var_1_59 = var_1_26;
		}
	} else {
		var_1_59 = (min ((var_1_22 - var_1_10) , (var_1_60 + var_1_28)));
	}
	...
	var_1_55 = (abs ((max (var_1_56 , var_1_10)) - var_1_90));
	...
	if (var_1_16) {
		var_1_41 = (min (last_1_var_1_48 , 1000000000));
	} else {
		if (((31.4 - var_1_6) / var_1_8) >= (var_1_30 - (var_1_42 - var_1_32))) {
			if (last_1_var_1_69) {
				var_1_41 = (var_1_28 - (min ((var_1_26 - var_1_11) , var_1_2)));
			}
		} else {
	...
	if (var_1_6 >= (max (1.25f , var_1_7))) {
		var_1_12 = (min (var_1_2 , (var_1_3 - (var_1_10 + last_1_var_1_12))));
	} else {
		var_1_12 = var_1_3;
	}
	...
	if (var_1_15 || stepLocal_14) {
		if ((var_1_26 >> var_1_52) <= stepLocal_15) {
			var_1_51 = (abs (var_1_4));
		}
	}


	// From: Req29Batch39Amount500
	if ((199.7f / var_1_42) != ((var_1_6 + var_1_38) / (min (10.25 , var_1_35)))) {
	...
	if (var_1_97 < stepLocal_21) {
		var_1_70 = (max (var_1_62 , var_1_52));
	}
	...
	if (var_1_72 > var_1_7) {
		...
		var_1_76 = (max ((min (var_1_30 , 999.3f)) , var_1_32));
	}
	...
	if (stepLocal_18 || var_1_46) {
		var_1_61 = (max (var_1_4 , var_1_52));
	} else {
		var_1_61 = (max ((max ((var_1_4 - var_1_52) , var_1_3)) , var_1_62));
	}
	...
	unsigned long int stepLocal_8 = min (-16 , var_1_75);
	...
	if (stepLocal_26 && ((min (var_1_2 , last_1_var_1_80)) > var_1_12)) {
		var_1_80 = last_1_var_1_80;
	} else {
		if ((abs (var_1_73)) <= var_1_29) {
			var_1_80 = (var_1_3 - (var_1_81 - var_1_41));
		} else {
			var_1_80 = (max (var_1_52 , (var_1_66 - var_1_1)));
		}
	}
	...
	if (var_1_86) {
		if (var_1_75 > stepLocal_27) {
			var_1_82 = (abs (var_1_28));
		} else {
			var_1_82 = (max (var_1_83 , (var_1_40 + var_1_84)));
		}
	} else {
		var_1_82 = (max (100000000u , var_1_11));
	}
	...
	if (var_1_44 || var_1_58) {
		if (var_1_14) {
			var_1_47 = (min ((min (var_1_75 , var_1_41)) , (abs (var_1_3 + var_1_2))));
		}
	}
	...
	if (var_1_86) {
		if (var_1_14) {
			...
			if (((var_1_8 / var_1_31) / (max (var_1_34 , var_1_35))) <= var_1_29) {
				var_1_33 = var_1_10;
			} else {
				var_1_33 = (abs (var_1_3));
			}
		}
	} else {
		var_1_33 = (max (var_1_28 , var_1_3));
	}
	...
	if ((- var_1_20) == var_1_52) {
		if (var_1_16 && (var_1_91 != var_1_17)) {
			var_1_78 = (min ((var_1_52 + 32) , (var_1_4 - var_1_3)));
		}
	} else {
		var_1_78 = (min ((var_1_79 + var_1_3) , ((abs (var_1_4)) + 1)));
	}
	...
	if (var_1_16 && stepLocal_11) {
		if (stepLocal_10 < (var_1_59 * (var_1_10 - var_1_21))) {
			...
			var_1_39 = (min (var_1_54 , ((min (var_1_10 , var_1_4)) - var_1_2)));
		}
	}
	...
	if (stepLocal_4 || var_1_14) {
		if (var_1_15) {
			if (stepLocal_3 || (0 < (min (var_1_11 , var_1_82)))) {
				var_1_19 = (var_1_90 + var_1_10);
			} else {
				if (((abs (var_1_3)) + 8) <= stepLocal_2) {
					var_1_19 = var_1_3;
				} else {
					var_1_19 = var_1_11;
				}
	...
	signed long int stepLocal_5 = (min (var_1_10 , var_1_3)) << var_1_88;
	if (stepLocal_5 != last_1_var_1_24) {
		if (var_1_14) {
			var_1_24 = (max ((var_1_39 - 4) , var_1_2));
		} else {
			var_1_24 = (var_1_3 - (min (var_1_11 , 4)));
		}
	} else {
		if ((-5 < var_1_3) || stepLocal_6) {
			...
			if (last_1_var_1_24 <= stepLocal_7) {
				var_1_24 = (min (var_1_39 , (var_1_11 - (var_1_26 - 10))));
			} else {
				var_1_24 = ((max ((min (var_1_11 , var_1_3)) , (abs (var_1_2)))) + (min ((abs (-5)) , var_1_88)));
			}
		}
	}
	...
	if (var_1_68) {
		var_1_85 = ((abs (last_1_var_1_85 + var_1_45)) + (4 + var_1_80));
	} else {
		if ((var_1_82 + var_1_52) < ((var_1_10 + var_1_74) % var_1_18)) {
			var_1_85 = (min (var_1_10 , (max (var_1_61 , var_1_94))));
		} else {
			if (var_1_14) {
				if (var_1_46) {
				...
				if (var_1_58 && var_1_16) {
					var_1_85 = (-5 + (var_1_59 - (abs (var_1_24))));
				} else {
					var_1_85 = ((min (last_1_var_1_85 , 128)) - var_1_45);
				}
			}
		}
	}
	...
	if (stepLocal_24 > (~ var_1_24)) {
		if (var_1_86 || stepLocal_22) {
			if (5 <= stepLocal_23) {
				var_1_71 = ((max (var_1_32 , (abs (31.75f)))) + (max (var_1_72 , var_1_73)));
			} else {
				var_1_71 = (min ((min (var_1_30 , 255.5f)) , var_1_72));
			}
		}
	} else {
		var_1_71 = var_1_31;
	...
	if (! var_1_14) {
		if (((var_1_49 - 4) * var_1_97) <= stepLocal_13) {
			...
			if (var_1_69) {
				var_1_48 = (min (64 , var_1_10));
			} else {
				var_1_48 = var_1_65;
			}
		}
	} else {
		var_1_48 = (abs (max (var_1_65 , var_1_4)));
	}


	// From: Req25Batch39Amount500
	if ((var_1_1 / (max (var_1_11 , var_1_10))) >= -8) {
		if (! var_1_15) {
			var_1_53 = (min (var_1_26 , var_1_47));
		} else {
			if (var_1_8 >= var_1_42) {
				if (var_1_49 > var_1_48) {
					var_1_53 = (var_1_48 + var_1_3);
				} else {
					var_1_53 = (max (((max (var_1_28 , var_1_26)) - var_1_27) , var_1_64));
				}
			} else {
				if (var_1_15) {
					var_1_53 = ((var_1_75 - 32) + (max (var_1_3 , var_1_11)));
				} else {
					if (var_1_44) {
						var_1_53 = ((abs (var_1_88)) - (max ((1258881043 - var_1_27) , var_1_4)));
					}
				}
			}
		}
	...
	if (var_1_53 < (max ((min (var_1_26 , var_1_11)) , var_1_10))) {
		var_1_36 = (1 - (64 - var_1_3));
	} else {
		var_1_36 = (max (var_1_3 , var_1_4));
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((min (8 , var_1_2)) << (max (var_1_3 , var_1_4))) <= last_1_var_1_74) ? ((99.7f >= ((var_1_6 - var_1_7) / var_1_8)) ? (var_1_1 == ((unsigned char) (var_1_2 + var_1_3))) : 1) : ((! last_1_var_1_69) ? (var_1_1 == ((unsigned char) ((64 + var_1_10) - (var_1_11 - var_1_4)))) : 1)) && ((var_1_6 >= (max (1.25f , var_1_7))) ? (var_1_12 == ((signed long int) (min (var_1_2 , (var_1_3 - (var_1_10 + last_1_var_1_12)))))) : (var_1_12 == ((signed long int) var_1_3)))) && ((var_1_8 > var_1_7) ? (var_1_13 == ((unsigned char) (var_1_14 && var_1_15))) : (var_1_13 == ((unsigned char) ((! var_1_16) && var_1_15))))) && (((var_1_10 / var_1_11) > ((var_1_18 - var_1_3) - var_1_45)) ? (var_1_17 == ((signed long int) var_1_3)) : 1)) && ((var_1_15 || var_1_14) ? (var_1_15 ? ((var_1_86 || (0 < (min (var_1_11 , var_1_82)))) ? (var_1_19 == ((unsigned long int) (var_1_90 + var_1_10))) : ((((abs (var_1_3)) + 8) <= 100000) ? (var_1_19 == ((unsigned long int) var_1_3)) : (var_1_19 == ((unsigned long int) var_1_11)))) : (var_1_19 == ((unsigned long int) var_1_2))) : (var_1_19 == ((unsigned long int) var_1_90)))) && ((5 >= var_1_57) ? (var_1_20 == ((signed long int) ((var_1_10 - var_1_11) + 25))) : 1)) && ((var_1_2 == var_1_18) ? (var_1_21 == ((unsigned long int) var_1_3)) : (var_1_21 == ((unsigned long int) (var_1_22 - var_1_2))))) && (var_1_23 == ((signed char) (var_1_4 + var_1_3)))) && ((((min (var_1_10 , var_1_3)) << var_1_88) != last_1_var_1_24) ? (var_1_14 ? (var_1_24 == ((signed long int) (max ((var_1_39 - 4) , var_1_2)))) : (var_1_24 == ((signed long int) (var_1_3 - (min (var_1_11 , 4)))))) : (((-5 < var_1_3) || (var_1_18 <= var_1_59)) ? (var_1_24 == ((signed long int) (10 - var_1_39))) : ((last_1_var_1_24 <= var_1_18) ? (var_1_24 == ((signed long int) (min (var_1_39 , (var_1_11 - (var_1_26 - 10)))))) : (var_1_24 == ((signed long int) ((max ((min (var_1_11 , var_1_3)) , (abs (var_1_2)))) + (min ((abs (-5)) , var_1_88))))))))) && (((min (-16 , var_1_75)) < ((var_1_22 - var_1_41) * var_1_59)) ? (var_1_27 == ((unsigned char) ((var_1_10 + (var_1_28 - var_1_4)) - var_1_11))) : (var_1_27 == ((unsigned char) var_1_28)))) && (((min (var_1_7 , var_1_6)) <= var_1_8) ? (var_1_29 == ((double) (var_1_30 - (var_1_31 - (3.325366097017101E18 - var_1_32))))) : 1)) && (var_1_86 ? (var_1_14 ? (var_1_33 == ((unsigned char) var_1_11)) : ((((var_1_8 / var_1_31) / (max (var_1_34 , var_1_35))) <= var_1_29) ? (var_1_33 == ((unsigned char) var_1_10)) : (var_1_33 == ((unsigned char) (abs (var_1_3)))))) : (var_1_33 == ((unsigned char) (max (var_1_28 , var_1_3)))))) && ((var_1_53 < (max ((min (var_1_26 , var_1_11)) , var_1_10))) ? (var_1_36 == ((signed char) (1 - (64 - var_1_3)))) : (var_1_36 == ((signed char) (max (var_1_3 , var_1_4)))))) && ((var_1_35 <= var_1_31) ? ((var_1_26 >= last_1_var_1_61) ? (var_1_37 == ((unsigned char) ((var_1_28 < 64) || var_1_14))) : (var_1_37 == ((unsigned char) (! ((var_1_35 >= 1.3199999999999998) || var_1_14))))) : 1)) && (var_1_38 == ((float) (min (var_1_31 , 1.00000005E7f))))) && ((var_1_16 && var_1_46) ? (((var_1_92 + (var_1_20 * -50)) < (var_1_59 * (var_1_10 - var_1_21))) ? (var_1_39 == ((signed short int) (((var_1_3 - var_1_55) + var_1_21) + (var_1_28 - var_1_40)))) : (var_1_39 == ((signed short int) (min (var_1_54 , ((min (var_1_10 , var_1_4)) - var_1_2)))))) : 1)) && (var_1_16 ? (var_1_41 == ((signed long int) (min (last_1_var_1_48 , 1000000000)))) : ((((31.4 - var_1_6) / var_1_8) >= (var_1_30 - (var_1_42 - var_1_32))) ? (last_1_var_1_69 ? (var_1_41 == ((signed long int) (var_1_28 - (min ((var_1_26 - var_1_11) , var_1_2))))) : 1) : (var_1_41 == ((signed long int) (var_1_3 + last_1_var_1_94)))))) && (var_1_58 ? (var_1_43 == ((unsigned char) (var_1_16 || var_1_44))) : (var_1_43 == ((unsigned char) ((! var_1_16) && (var_1_69 || var_1_14)))))) && ((var_1_8 >= var_1_42) ? (var_1_45 == ((unsigned short int) (var_1_54 + (abs (var_1_4))))) : 1)) && (((var_1_14 && var_1_15) && var_1_37) ? (var_1_46 == ((unsigned char) var_1_44)) : 1)) && ((var_1_44 || var_1_58) ? (var_1_14 ? (var_1_47 == ((unsigned long int) (min ((min (var_1_75 , var_1_41)) , (abs (var_1_3 + var_1_2)))))) : 1) : 1)) && ((! var_1_14) ? ((((var_1_49 - 4) * var_1_97) <= var_1_26) ? (var_1_48 == ((unsigned short int) var_1_4)) : (var_1_69 ? (var_1_48 == ((unsigned short int) (min (64 , var_1_10)))) : (var_1_48 == ((unsigned short int) var_1_65)))) : (var_1_48 == ((unsigned short int) (abs (max (var_1_65 , var_1_4))))))) && ((! ((10000 * var_1_3) == (var_1_40 << var_1_12))) ? (var_1_50 == ((signed char) (16 - (min (var_1_4 , var_1_3))))) : 1)) && ((var_1_15 || var_1_44) ? (((var_1_26 >> var_1_52) <= var_1_18) ? (var_1_51 == ((signed char) (abs (var_1_4)))) : 1) : 1)) && (((var_1_1 / (max (var_1_11 , var_1_10))) >= -8) ? ((! var_1_15) ? (var_1_53 == ((signed long int) (min (var_1_26 , var_1_47)))) : ((var_1_8 >= var_1_42) ? ((var_1_49 > var_1_48) ? (var_1_53 == ((signed long int) (var_1_48 + var_1_3))) : (var_1_53 == ((signed long int) (max (((max (var_1_28 , var_1_26)) - var_1_27) , var_1_64))))) : (var_1_15 ? (var_1_53 == ((signed long int) ((var_1_75 - 32) + (max (var_1_3 , var_1_11))))) : (var_1_44 ? (var_1_53 == ((signed long int) ((abs (var_1_88)) - (max ((1258881043 - var_1_27) , var_1_4))))) : 1)))) : 1)) && ((var_1_18 > last_1_var_1_90) ? (var_1_54 == ((signed short int) (var_1_52 + last_1_var_1_94))) : (((last_1_var_1_39 * (var_1_3 / var_1_11)) < last_1_var_1_94) ? (var_1_54 == ((signed short int) (abs (last_1_var_1_54)))) : 1))) && (var_1_55 == ((signed long int) (abs ((max (var_1_56 , var_1_10)) - var_1_90))))) && (var_1_57 == ((unsigned long int) (max (64u , var_1_97))))) && (((199.7f / var_1_42) != ((var_1_6 + var_1_38) / (min (10.25 , var_1_35)))) ? (var_1_58 == ((unsigned char) (! (var_1_44 || (! var_1_14))))) : 1)) && (((var_1_18 >> var_1_52) == (var_1_4 - var_1_11)) ? ((last_1_var_1_64 <= last_1_var_1_24) ? (var_1_59 == ((unsigned long int) (min (last_1_var_1_41 , var_1_22)))) : (var_1_59 == ((unsigned long int) var_1_26))) : (var_1_59 == ((unsigned long int) (min ((var_1_22 - var_1_10) , (var_1_60 + var_1_28))))))) && ((var_1_86 || var_1_46) ? (var_1_61 == ((signed char) (max (var_1_4 , var_1_52)))) : (var_1_61 == ((signed char) (max ((max ((var_1_4 - var_1_52) , var_1_3)) , var_1_62)))))) && ((! ((var_1_35 + var_1_34) >= var_1_30)) ? (var_1_63 == ((unsigned char) (var_1_16 || ((! var_1_43) && var_1_44)))) : 1)) && ((var_1_29 <= (1.000000007E8 / var_1_34)) ? ((-256 <= var_1_11) ? (var_1_64 == ((unsigned char) (var_1_11 + var_1_28))) : 1) : 1)) && ((var_1_14 || var_1_44) ? ((! (var_1_85 != var_1_2)) ? ((var_1_21 <= var_1_2) ? ((((var_1_38 * 2.75) * var_1_34) >= ((var_1_6 - var_1_7) / var_1_42)) ? (var_1_65 == ((unsigned char) (var_1_66 - ((var_1_3 + 16) + var_1_52)))) : 1) : 1) : (var_1_65 == ((unsigned char) var_1_11))) : 1)) && (last_1_var_1_67 ? (var_1_67 == ((unsigned char) (((var_1_1 * var_1_41) < (var_1_94 * var_1_20)) || (! var_1_16)))) : (var_1_67 == ((unsigned char) (! ((var_1_15 || var_1_14) && var_1_68)))))) && ((! ((var_1_40 * var_1_90) > (var_1_41 % var_1_18))) ? (var_1_69 == ((unsigned char) (var_1_16 || var_1_44))) : (var_1_69 == ((unsigned char) (! (var_1_44 || var_1_16)))))) && ((var_1_97 < var_1_55) ? (var_1_70 == ((signed char) (max (var_1_62 , var_1_52)))) : 1)) && ((var_1_24 > (~ var_1_24)) ? ((var_1_86 || var_1_69) ? ((5 <= var_1_47) ? (var_1_71 == ((float) ((max (var_1_32 , (abs (31.75f)))) + (max (var_1_72 , var_1_73))))) : (var_1_71 == ((float) (min ((min (var_1_30 , 255.5f)) , var_1_72))))) : 1) : (var_1_71 == ((float) var_1_31)))) && (var_1_74 == ((unsigned long int) (var_1_75 + var_1_97)))) && ((last_1_var_1_97 >= last_1_var_1_65) ? (var_1_75 == ((unsigned long int) var_1_40)) : (var_1_75 == ((unsigned long int) var_1_56)))) && ((var_1_72 > var_1_7) ? (var_1_76 == ((float) (var_1_32 - var_1_77))) : (var_1_76 == ((float) (max ((min (var_1_30 , 999.3f)) , var_1_32)))))) && (((- var_1_20) == var_1_52) ? ((var_1_16 && (var_1_91 != var_1_17)) ? (var_1_78 == ((signed char) (min ((var_1_52 + 32) , (var_1_4 - var_1_3))))) : 1) : (var_1_78 == ((signed char) (min ((var_1_79 + var_1_3) , ((abs (var_1_4)) + 1))))))) && ((var_1_86 && ((min (var_1_2 , last_1_var_1_80)) > var_1_12)) ? (var_1_80 == ((signed short int) last_1_var_1_80)) : (((abs (var_1_73)) <= var_1_29) ? (var_1_80 == ((signed short int) (var_1_3 - (var_1_81 - var_1_41)))) : (var_1_80 == ((signed short int) (max (var_1_52 , (var_1_66 - var_1_1)))))))) && (var_1_86 ? ((var_1_75 > 10u) ? (var_1_82 == ((unsigned long int) (abs (var_1_28)))) : (var_1_82 == ((unsigned long int) (max (var_1_83 , (var_1_40 + var_1_84)))))) : (var_1_82 == ((unsigned long int) (max (100000000u , var_1_11)))))) && (var_1_68 ? (var_1_85 == ((signed long int) ((abs (last_1_var_1_85 + var_1_45)) + (4 + var_1_80)))) : (((var_1_82 + var_1_52) < ((var_1_10 + var_1_74) % var_1_18)) ? (var_1_85 == ((signed long int) (min (var_1_10 , (max (var_1_61 , var_1_94)))))) : (var_1_14 ? (var_1_46 ? (var_1_85 == ((signed long int) ((var_1_26 - var_1_59) - 256))) : (var_1_85 == ((signed long int) (var_1_45 + var_1_52)))) : ((var_1_58 && var_1_16) ? (var_1_85 == ((signed long int) (-5 + (var_1_59 - (abs (var_1_24)))))) : (var_1_85 == ((signed long int) ((min (last_1_var_1_85 , 128)) - var_1_45)))))))) && (var_1_16 ? (var_1_86 == ((unsigned char) var_1_15)) : 1)) && (var_1_87 == ((float) var_1_30))) && (var_1_67 ? (var_1_88 == ((unsigned long int) var_1_54)) : (var_1_88 == ((unsigned long int) var_1_4)))) && (var_1_68 ? (var_1_90 == ((signed long int) var_1_1)) : 1)) && (var_1_91 == ((unsigned short int) var_1_52))) && (var_1_92 == ((signed long int) 32))) && (var_1_68 ? (var_1_93 == ((signed short int) var_1_94)) : (var_1_93 == ((signed short int) 1)))) && (last_1_var_1_63 ? (var_1_94 == ((unsigned short int) var_1_10)) : (var_1_94 == ((unsigned short int) last_1_var_1_48)))) && (var_1_15 ? (var_1_95 == ((signed short int) var_1_66)) : 1)) && (var_1_63 ? (var_1_96 == ((signed char) var_1_79)) : (var_1_96 == ((signed char) var_1_62)))) && ((var_1_83 == last_1_var_1_55) ? (var_1_97 == ((unsigned long int) (var_1_28 + (var_1_11 + (var_1_40 + var_1_3))))) : ((last_1_var_1_50 < last_1_var_1_19) ? (var_1_97 == ((unsigned long int) (min ((var_1_22 - last_1_var_1_53) , var_1_83)))) : (var_1_97 == ((unsigned long int) 256u))))
;
}
int main(void) {
	isInitial = 1;
