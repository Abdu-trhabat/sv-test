...
void step(void) {
	// From: Req1Batch129Amount10
	var_1_1 = (max (var_1_2 , var_1_3));


	// From: Req2Batch129Amount10
	var_1_4 = (var_1_5 + var_1_6);


	// From: Req3Batch129Amount10
...
int property(void) {
	return ((var_1_1 == ((signed long int) (max (var_1_2 , var_1_3)))) && (var_1_4 == ((signed long int) (var_1_5 + var_1_6)))) && ((var_1_8 || var_1_9) ? ((! var_1_9) ? (var_1_7 == ((unsigned short int) (var_1_10 + var_1_11))) : 1) : (var_1_7 == ((unsigned short int) var_1_11)))
;
}
int main(void) {
	isInitial = 1;
