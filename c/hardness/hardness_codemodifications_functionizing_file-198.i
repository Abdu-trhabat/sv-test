...
void functionized0(unsigned short int functionized0_localFunctionVar0) {
 if (var_1_8 > var_1_5) {
  if (var_1_6) {
   if (functionized0_localFunctionVar0 <= ((((var_1_8) > (var_1_5)) ? (var_1_8) : (var_1_5)))) {
    var_1_10 = var_1_5;
   } else {
...
unsigned long int functionized1(signed long int functionized1_localFunctionVar0) {
 return (var_1_13 - ((((functionized1_localFunctionVar0) > (var_1_9)) ? (functionized1_localFunctionVar0) : (var_1_9))));
}
...
void functionized3(unsigned char functionized3_localFunctionVar0, unsigned short int functionized3_localFunctionVar1, unsigned short int functionized3_localFunctionVar2, signed char functionized3_localFunctionVar3) {
 if (functionized3_localFunctionVar3 > ((64 - var_1_18) - functionized3_localFunctionVar0)) {
  if (((functionized3_localFunctionVar1 - functionized3_localFunctionVar0) - ((((var_1_18) < (32)) ? (var_1_18) : (32)))) >= ((((var_1_5) < ((functionized3_localFunctionVar2 / var_1_11))) ? (var_1_5) : ((functionized3_localFunctionVar2 / var_1_11))))) {
   var_1_17 = var_1_9;
  }
 } else {
  var_1_17 = var_1_9;
