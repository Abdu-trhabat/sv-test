...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17750_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch17750_1loop
	if (((var_1_13 - 9.75) / (abs (var_1_14))) > var_1_3) {
		var_1_12 = var_1_15;
	}


	// From: Req4Batch17750_1loop
	if (var_1_2 <= (- (- var_1_14))) {
		if (var_1_9 < var_1_6) {
	...
	// From: Req5Batch17750_1loop
	var_1_19 = ((var_1_20 + (var_1_21 - var_1_22)) + var_1_23);


	// From: Req6Batch17750_1loop
