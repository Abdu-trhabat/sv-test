...
void step(void) {
	// From: Req4Batch3625_1loop
	var_1_15 = var_1_16;


	// From: Req5Batch3625_1loop
	var_1_17 = var_1_12;


	// From: Req6Batch3625_1loop
	var_1_18 = var_1_10;
	...
	if (stepLocal_0 && var_1_15) {
		if ((max (var_1_2 , (- var_1_3))) != var_1_5) {
