...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch182Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch182Amount25
	if (! var_1_3) {
		var_1_1 = ((min (var_1_4 , var_1_5)) - var_1_6);
	}


	// From: Req2Batch182Amount25
	...
	// From: Req4Batch182Amount25
	var_1_12 = (min ((max (var_1_4 , var_1_11)) , var_1_6));


	// From: Req5Batch182Amount25
	if (var_1_3) {
		var_1_13 = (max (16.5 , (var_1_4 - 9.99999999975E9)));
	}


	// From: Req6Batch182Amount25
	var_1_14 = var_1_11;


	// From: Req7Batch182Amount25
	var_1_15 = var_1_11;


	// From: Req8Batch182Amount25
	var_1_16 = var_1_17;
}
