...
void step(void) {
	...
	// From: CodeObject3
	/* 334L, 94L) */ if (/* 335L, 67L, 68L) */ ((var_1_1) <= (/* 337L, 66L, 70L) */ (min (/* 337L, 66L, 70L) */ (var_1_31) , (var_1_32)))))) {
		/* 340L, 83L) */ var_1_39 = (
			/* 343L, 82L) */ (min (
				/* 343L, 82L) */ (
					var_1_40
	...
	// From: CodeObject4
	/* 356L, 149L) */ if (/* 357L, 105L, 106L) */ ((/* 358L, 100L, 107L) */ ((8) & (var_1_8))) > (/* 361L, 104L, 110L) */ ((var_1_19) | (/* 363L, 103L, 112L) */ (~ (-128))))))) {
		/* 365L, 147L) */ if (/* 366L, 124L, 125L) */ ((0) < (var_1_1))) {
			/* 369L, 134L) */ var_1_45 = (
				var_1_42
			);
		} else {
	...
	// From: CodeObject1
	/* 238L, 29L) */ if (/* 239L, 7L, 8L) */ ((var_1_7) < (/* 241L, 6L, 10L) */ ((var_1_7) - (/* 243L, 5L, 12L) */ (abs (var_1_6))))))) {
	...
	// From: CodeObject5
	/* 377L, 166L) */ if (/* 378L, 155L, 156L) */ ((var_1_40) < (var_1_5))) {
		/* 381L, 165L) */ var_1_46 = (
			var_1_41
		);
	}
	...
	// From: CodeObject2
	/* 251L, 59L) */ if (/* 252L, 35L, 36L) */ ((var_1_6) < (var_1_18))) {
		/* 255L, 45L) */ var_1_35 = (
			var_1_22
		);
	} else {
