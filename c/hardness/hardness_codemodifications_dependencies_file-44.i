...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch44dependencies.c", 13, "reach_error"); }
...
void step(void) {
 if (((var_1_15 * last_1_var_1_31) + var_1_16) < (last_1_var_1_14 + last_1_var_1_1)) {
 ...
 if (var_1_8 == ((var_1_8 + var_1_28) ^ (var_1_8 + var_1_19))) {
  var_1_1 = var_1_8;
 }
}
void updateVariables(void) {
