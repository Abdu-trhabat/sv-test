...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch123dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch123dependencies
	if (var_1_6) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch123dependencies
	if (8 == var_1_3) {
		if (var_1_1 >= var_1_3) {
	...
	// From: Req4Batch123dependencies
	if ((var_1_3 == 32u) || (var_1_5 == var_1_1)) {
		var_1_10 = var_1_8;
	}


	// From: Req6Batch123dependencies
	if (var_1_4 > var_1_11) {
