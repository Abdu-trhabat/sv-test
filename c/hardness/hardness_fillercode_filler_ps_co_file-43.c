...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch43Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 376L, 227L) */ if (/* 377L, 155L, 156L) */ ((/* 378L, 153L, 157L) */ (- (var_1_1))) < (var_1_36))) {
		/* 381L, 219L) */ if (/* 382L, 166L, 167L) */ ((var_1_1) > (var_1_36))) {
			/* 385L, 217L) */ if (/* 386L, 188L, 189L) */ ((/* 387L, 184L, 190L) */ ((/* 388L, 181L, 191L) */ ((var_1_23) % (var_1_40))) % (/* 391L, 183L, 194L) */ (abs (var_1_41))))) == (/* 393L, 187L, 196L) */ ((var_1_23) / (var_1_42))))) {
				/* 396L, 216L) */ var_1_39 = (
					/* 399L, 215L) */ ((
						/* 400L, 213L) */ (max (
							/* 400L, 213L) */ (
