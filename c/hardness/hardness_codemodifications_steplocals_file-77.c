...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch77stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	var_1_8 = (min ((var_1_1 - var_1_7) , ((128 + var_1_9) - var_1_10)));
	...
	// From: Req7Batch77stepLocals
	signed long int stepLocal_1 = var_1_8;
	if (stepLocal_1 != (abs (min (var_1_16 , var_1_22)))) {
		var_1_21 = (var_1_17 + (var_1_23 + var_1_24));
	}


	// From: Req8Batch77stepLocals
	if (! (var_1_20 > (abs (var_1_6)))) {
		if ((max (1 , (var_1_17 + var_1_8))) <= (var_1_22 * var_1_1)) {
...
int property(void) {
	return (((((((((abs (var_1_4)) <= var_1_5) ? (((- var_1_3) > (max (var_1_2 , var_1_6))) ? (var_1_1 == ((unsigned short int) var_1_7)) : (var_1_1 == ((unsigned short int) 50))) : (var_1_1 == ((unsigned short int) var_1_7))) && (var_1_8 == ((signed long int) (min ((var_1_1 - var_1_7) , ((128 + var_1_9) - var_1_10)))))) && (var_1_11 == ((float) var_1_12))) && ((var_1_9 >= var_1_7) ? (((var_1_11 >= var_1_3) || var_1_14) ? (var_1_13 == ((signed short int) 50)) : (var_1_13 == ((signed short int) var_1_4))) : (var_1_13 == ((signed short int) 256)))) && ((var_1_11 > var_1_2) ? (var_1_15 == ((unsigned short int) (var_1_16 + (10000 + var_1_17)))) : 1)) && (var_1_18 == ((double) (var_1_19 - var_1_20)))) && ((var_1_8 != (abs (min (var_1_16 , var_1_22)))) ? (var_1_21 == ((unsigned short int) (var_1_17 + (var_1_23 + var_1_24)))) : 1)) && ((! (var_1_20 > (abs (var_1_6)))) ? (((max (1 , (var_1_17 + var_1_8))) <= (var_1_22 * var_1_1)) ? (var_1_25 == ((signed short int) (var_1_23 - var_1_17))) : (var_1_25 == ((signed short int) var_1_24))) : (var_1_25 == ((signed short int) var_1_23)))
;
}
int main(void) {
	isInitial = 1;
