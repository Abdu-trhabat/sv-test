...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19325_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch19325_while
	var_1_5 = ((var_1_6 - var_1_7) + (var_1_8 + 16.6f));


	// From: Req3Batch19325_while
