...
void step(void) {
	// From: Req1Batch112Wrapper_A
	if (float_Array_0[1][2] <= float_Array_0[0][2]) {
		float_Array_0[2][2] = (min (float_Array_0[2][1] , (max (float_Array_0[1][1] , float_Array_0[0][1]))));
	}


	// From: Req2Batch112Wrapper_A
	if (BOOL_unsigned_char_Array_0[0]) {
		if (last_1_float_Array_0_2__0_ < float_Array_0[2][2]) {
			float_Array_0[2][0] = ((max (float_Array_0[0][0] , 32.75f)) + float_Array_0[1][0]);
		}
	} else {
	...
	// From: Req3Batch112Wrapper_A
	unsigned_short_int_Array_0[2] = (max (unsigned_short_int_Array_0[0] , unsigned_short_int_Array_0[1]));


	// From: Req4Batch112Wrapper_A
	...
	if (stepLocal_0 <= (unsigned_short_int_Array_0[0] >> signed_char_Array_0[0])) {
		if (! (float_Array_0[2][2] != float_Array_0[1][2])) {
			if (BOOL_unsigned_char_Array_0[0]) {
				unsigned_char_Array_0[0][1] = ((max (128 , unsigned_char_Array_0[1][0])) - signed_char_Array_0[0]);
			} else {
...
int property(void) {
	return ((((float_Array_0[1][2] <= float_Array_0[0][2]) ? (float_Array_0[2][2] == ((float) (min (float_Array_0[2][1] , (max (float_Array_0[1][1] , float_Array_0[0][1])))))) : 1) && (BOOL_unsigned_char_Array_0[0] ? ((last_1_float_Array_0_2__0_ < float_Array_0[2][2]) ? (float_Array_0[2][0] == ((float) ((max (float_Array_0[0][0] , 32.75f)) + float_Array_0[1][0]))) : 1) : (float_Array_0[2][0] == ((float) float_Array_0[0][0])))) && (unsigned_short_int_Array_0[2] == ((unsigned short int) (max (unsigned_short_int_Array_0[0] , unsigned_short_int_Array_0[1]))))) && ((0 <= (unsigned_short_int_Array_0[0] >> signed_char_Array_0[0])) ? ((! (float_Array_0[2][2] != float_Array_0[1][2])) ? (BOOL_unsigned_char_Array_0[0] ? (unsigned_char_Array_0[0][1] == ((unsigned char) ((max (128 , unsigned_char_Array_0[1][0])) - signed_char_Array_0[0]))) : ((float_Array_0[2][0] >= float_Array_0[1][0]) ? (unsigned_char_Array_0[0][1] == ((unsigned char) (signed_char_Array_0[0] + unsigned_char_Array_0[1][1]))) : (BOOL_unsigned_char_Array_0[1] ? (unsigned_char_Array_0[0][1] == ((unsigned char) unsigned_char_Array_0[1][1])) : (unsigned_char_Array_0[0][1] == ((unsigned char) unsigned_char_Array_0[0][0]))))) : 1) : (unsigned_char_Array_0[0][1] == ((unsigned char) unsigned_char_Array_0[1][1])))
;
}
int main(void) {
	isInitial = 1;
