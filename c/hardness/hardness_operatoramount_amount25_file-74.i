...
void step(void) {
 ...
 if (var_1_9) {
  if (255.5f != (var_1_11 - var_1_12)) {
   var_1_10 = ((((((((var_1_13) > (var_1_14)) ? (var_1_13) : (var_1_14)))) > (var_1_15)) ? (((((var_1_13) > (var_1_14)) ? (var_1_13) : (var_1_14)))) : (var_1_15)));
  }
 } else {
  if (var_1_4 <= var_1_3) {
   var_1_10 = var_1_15;
