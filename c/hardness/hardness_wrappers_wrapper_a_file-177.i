...
void step(void) {
 signed long int stepLocal_2 = (((5) < ((unsigned_short_int_Array_0[1][2] * unsigned_short_int_Array_0[0][2]))) ? (5) : ((unsigned_short_int_Array_0[1][2] * unsigned_short_int_Array_0[0][2])));
 ...
 if (stepLocal_2 <= signed_long_int_Array_0[0]) {
  if (unsigned_short_int_Array_0[1][2] > stepLocal_0) {
   if ((- signed_long_int_Array_0[0]) == stepLocal_1) {
    double_Array_0[4] = (((((double_Array_0[3] - double_Array_0[2])) > (double_Array_0[0])) ? ((double_Array_0[3] - double_Array_0[2])) : (double_Array_0[0])));
   }
  }
 } else {
