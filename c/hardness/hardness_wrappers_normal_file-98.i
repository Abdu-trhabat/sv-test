...
void step(void) {
 ...
 if (var_1_2 < var_1_8) {
  if (((- var_1_5) <= var_1_6) || (var_1_4 < var_1_10)) {
   var_1_12 = ((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6)));
  } else {
   var_1_12 = (var_1_13 - var_1_5);
  }
 }
 if (((((-128) < (var_1_12)) ? (-128) : (var_1_12))) < var_1_13) {
  if (var_1_2 > var_1_10) {
...
int property(void) {
 return (((var_1_1 == ((double) (var_1_2 - var_1_3))) && ((8 < ((var_1_5 >> var_1_6) / var_1_7)) ? (var_1_4 == ((double) (((var_1_8 + var_1_9) + ((((var_1_10) < (1.9)) ? (var_1_10) : (1.9)))) + (99.125 + var_1_11)))) : 1)) && ((var_1_2 < var_1_8) ? ((((- var_1_5) <= var_1_6) || (var_1_4 < var_1_10)) ? (var_1_12 == ((unsigned long int) ((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6))))) : (var_1_12 == ((unsigned long int) (var_1_13 - var_1_5)))) : 1)) && ((((((-128) < (var_1_12)) ? (-128) : (var_1_12))) < var_1_13) ? ((var_1_2 > var_1_10) ? (var_1_14 == ((unsigned long int) (var_1_6 + var_1_5))) : (var_1_14 == ((unsigned long int) var_1_13))) : (var_1_14 == ((unsigned long int) var_1_13)))
;
}
int main(void) {
 isInitial = 1;
