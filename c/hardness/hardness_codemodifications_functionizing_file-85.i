...
double functionized4(double functionized4_localFunctionVar0) {
 return ((((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))) + functionized4_localFunctionVar0) - 63.6);
}
void initially(void) {
}
void step(void) {
 ...
 if (var_1_4) {
  var_1_15 = ((((var_1_3) > ((var_1_13 + functionized3(var_1_14)))) ? (var_1_3) : ((var_1_13 + functionized3(var_1_14)))));
 }
