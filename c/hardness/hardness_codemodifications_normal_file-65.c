...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch65normal.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch65normal
	if ((var_1_2 <= var_1_3) || (var_1_4 > 4)) {
		var_1_1 = (max ((var_1_5 + (var_1_6 + var_1_7)) , -100));
	} else {
		var_1_1 = var_1_7;
	}


	// From: Req2Batch65normal
	if (var_1_9) {
		if (var_1_10) {
	...
	// From: Req5Batch65normal
	var_1_20 = (var_1_21 - (var_1_22 + 1.5));


	// From: Req6Batch65normal
	...
	// From: Req7Batch65normal
	var_1_24 = ((var_1_16 <= (var_1_25 - var_1_26)) && var_1_27);


	// From: Req8Batch65normal
	var_1_28 = var_1_21;
}
