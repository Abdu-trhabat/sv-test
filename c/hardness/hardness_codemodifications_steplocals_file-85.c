...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch85stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch85stepLocals
	unsigned short int stepLocal_1 = var_1_2;
	signed long int stepLocal_0 = -10000000;
	if (stepLocal_1 < ((- var_1_3) * 64)) {
		if (var_1_4) {
			var_1_1 = (abs (var_1_3));
		} else {
	...
	// From: Req2Batch85stepLocals
	unsigned long int stepLocal_2 = var_1_3 + var_1_1;
	...
	// From: Req3Batch85stepLocals
	if ((var_1_2 + (var_1_3 * var_1_1)) <= ((32u / var_1_8) / var_1_9)) {
		if (1.25f < var_1_10) {
			var_1_7 = 1000000.1f;
		}
	} else {
	...
	// From: Req4Batch85stepLocals
	if (var_1_7 <= (- (32.8f + var_1_10))) {
		var_1_12 = var_1_3;
	}


	// From: Req5Batch85stepLocals
	var_1_13 = (abs (var_1_14));


	// From: Req6Batch85stepLocals
	if (var_1_4) {
		var_1_15 = (max (var_1_3 , (var_1_13 + (abs (var_1_14)))));
	}


	// From: Req7Batch85stepLocals
	var_1_16 = (var_1_6 && var_1_17);


	// From: Req8Batch85stepLocals
