...
void functionized0(unsigned long int functionized0_localFunctionVar0, signed long int functionized0_localFunctionVar1) {
 if (-16 < var_1_2) {
  if (var_1_2 == (100 - functionized0_localFunctionVar1)) {
   var_1_1 = ((((((functionized0_localFunctionVar0) < (1415909508u)) ? (functionized0_localFunctionVar0) : (1415909508u))) - (var_1_5 - var_1_6)) + functionized0_localFunctionVar1);
  }
 } else {
...
void functionized2(unsigned long int functionized2_localFunctionVar0, unsigned char functionized2_localFunctionVar1, signed long int functionized2_localFunctionVar2) {
 if (((functionized2_localFunctionVar2 * functionized2_localFunctionVar1) + var_1_4) < (var_1_6 + ((((functionized2_localFunctionVar0) < (var_1_10)) ? (functionized2_localFunctionVar0) : (var_1_10))))) {
  var_1_11 = var_1_12;
 } else {
  var_1_11 = 32;
 }
...
void functionized4(unsigned char functionized4_localFunctionVar0, unsigned char functionized4_localFunctionVar1, unsigned char functionized4_localFunctionVar2, unsigned long int functionized4_localFunctionVar3) {
 if (var_1_8 != (functionized4_localFunctionVar2 - ((((functionized4_localFunctionVar1) > (functionized4_localFunctionVar0)) ? (functionized4_localFunctionVar1) : (functionized4_localFunctionVar0))))) {
...
void step(void) {
 ...
 if ((-128 >= ((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11)))) && var_1_9) {
  var_1_13 = var_1_12;
 }
 var_1_14 = var_1_10;
 functionized3();
