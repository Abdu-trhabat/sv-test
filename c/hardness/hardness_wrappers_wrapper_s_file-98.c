...
void step(void) {
	...
	if (WrapperStruct00.var_1_2 < WrapperStruct00.var_1_8) {
		if (((- WrapperStruct00.var_1_5) <= WrapperStruct00.var_1_6) || (WrapperStruct00.var_1_4 < WrapperStruct00.var_1_10)) {
			WrapperStruct00.var_1_12 = (min (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_6));
		} else {
	...
	if ((min (-128 , WrapperStruct00.var_1_12)) < WrapperStruct00.var_1_13) {
