...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch165functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
void functionized0(unsigned long int, double, unsigned long int);
signed long int functionized1(void);
signed long int functionized2(void);
unsigned char functionized3(unsigned char);
unsigned char functionized4(unsigned char, unsigned char);
...
void functionized0(unsigned long int functionized0_localFunctionVar0, double functionized0_localFunctionVar1, unsigned long int functionized0_localFunctionVar2) {
 if (var_1_4 <= ((((var_1_3) < (functionized0_localFunctionVar1)) ? (var_1_3) : (functionized0_localFunctionVar1)))) {
  var_1_1 = (functionized0_localFunctionVar0 + ((((functionized0_localFunctionVar2) < (1u)) ? (functionized0_localFunctionVar2) : (1u))));
 } else {
  var_1_1 = 0u;
 }
}
signed long int functionized1(void) {
 return (18598 - var_1_13);
}
signed long int functionized2(void) {
 return (var_1_15 - var_1_9);
}
unsigned char functionized3(unsigned char functionized3_localFunctionVar0) {
 return (! functionized3_localFunctionVar0);
}
unsigned char functionized4(unsigned char functionized4_localFunctionVar0, unsigned char functionized4_localFunctionVar1) {
 return (functionized4_localFunctionVar0 && functionized4_localFunctionVar1);
}
unsigned long int functionized5(void) {
 return (var_1_15 | var_1_1);
}
unsigned char functionized6(void) {
 return ((var_1_6 + (var_1_13 / 4u)) >= (var_1_22 - var_1_15));
}
void initially(void) {
}
void step(void) {
 if (var_1_3 <= var_1_4) {
  functionized0(var_1_6, var_1_5, var_1_7);
 } else {
  var_1_1 = var_1_6;
 }
 ...
 if (var_1_3 <= (var_1_4 + var_1_5)) {
  var_1_12 = (functionized1() - var_1_9);
 }
 if ((functionized2() * var_1_6) >= var_1_1) {
  if (var_1_9 < (8 + var_1_8)) {
   var_1_14 = (! (var_1_16 || functionized3(var_1_17)));
  } else {
   var_1_14 = (functionized4(var_1_17, var_1_18));
  }
 } else {
  var_1_14 = var_1_16;
 }
 if (var_1_6 < functionized5()) {
  var_1_19 = var_1_13;
 }
 if (var_1_18) {
  if (9.25 >= var_1_3) {
