...
void step(void) {
	...
	if ((var_1_2 ^ (max (var_1_3 , var_1_4))) != stepLocal_0) {
...
int property(void) {
	return ((((var_1_2 ^ (max (var_1_3 , var_1_4))) != var_1_5) ? ((var_1_2 == (var_1_6 - (var_1_7 - var_1_8))) ? (var_1_1 == ((float) (min (var_1_9 , var_1_10)))) : 1) : (var_1_1 == ((float) 10.5f))) && ((last_1_var_1_14 > var_1_8) ? ((((var_1_6 - var_1_8) + var_1_7) > last_1_var_1_14) ? (var_1_11 == ((unsigned char) (min (var_1_12 , var_1_13)))) : (var_1_11 == ((unsigned char) var_1_12))) : 1)) && (((var_1_4 & var_1_7) > ((var_1_12 * var_1_5) * (var_1_11 + var_1_3))) ? ((var_1_15 && (var_1_9 > var_1_10)) ? (var_1_14 == ((unsigned long int) var_1_7)) : 1) : (var_1_14 == ((unsigned long int) var_1_7)))
;
}
int main(void) {
	isInitial = 1;
