...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch47Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
   ...
   var_1_18
             ...
             if ( (( (( ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31)))) / (var_1_37))) > ( ((var_1_34) * (10))))) {
              if ( (! (var_1_28))) {
               var_1_43 = (
    var_1_33
   );
 ...
 unsigned char stepLocal_1 = ((var_1_1) < (64));
    ...
    var_1_17
     ...
     var_1_29
             ...
             if ( ((var_1_30) > (32.8))) {
              var_1_34 = (
               ((((( (( var_1_35 ) - ( var_1_26 )) )) > (( var_1_32 ))) ? (( (( var_1_35 ) - ( var_1_26 )) )) : (( var_1_32 ))))
  );
 }
