...
void step(void) {
 ...
 if ((*(var_1_23_Pointer)) < (((((*(var_1_20_Pointer))) > ((*(var_1_23_Pointer)))) ? ((*(var_1_20_Pointer))) : ((*(var_1_23_Pointer)))))) {
