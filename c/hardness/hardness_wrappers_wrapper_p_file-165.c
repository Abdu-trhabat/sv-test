...
void step(void) {
	// From: Req1Batch165Wrapper_P
	if ((*(var_1_2_Pointer)) >= ((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) {
		(*(var_1_1_Pointer)) = (max ((*(var_1_5_Pointer)) , (((*(var_1_6_Pointer)) - (*(var_1_7_Pointer))) + ((*(var_1_8_Pointer)) - 200.2f))));
	} else {
		(*(var_1_1_Pointer)) = (*(var_1_7_Pointer));
	}


	// From: Req2Batch165Wrapper_P
	if ((*(var_1_10_Pointer)) && (*(var_1_11_Pointer))) {
		(*(var_1_9_Pointer)) = ((*(var_1_12_Pointer)) + (*(var_1_13_Pointer)));
	} else {
		(*(var_1_9_Pointer)) = (min ((*(var_1_13_Pointer)) , ((*(var_1_12_Pointer)) + (*(var_1_14_Pointer)))));
	}


	// From: Req3Batch165Wrapper_P
	if ((*(var_1_10_Pointer))) {
		(*(var_1_15_Pointer)) = ((max ((*(var_1_16_Pointer)) , ((*(var_1_17_Pointer)) - (*(var_1_18_Pointer))))) + ((*(var_1_19_Pointer)) - 100));
	}


	// From: Req4Batch165Wrapper_P
	if ((*(var_1_10_Pointer))) {
		(*(var_1_20_Pointer)) = ((*(var_1_21_Pointer)) - ((*(var_1_22_Pointer)) - (max ((*(var_1_19_Pointer)) , (*(var_1_18_Pointer))))));
	} else {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) >= ((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((float) (max ((*(var_1_5_Pointer)) , (((*(var_1_6_Pointer)) - (*(var_1_7_Pointer))) + ((*(var_1_8_Pointer)) - 200.2f)))))) : ((*(var_1_1_Pointer)) == ((float) (*(var_1_7_Pointer))))) && (((*(var_1_10_Pointer)) && (*(var_1_11_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed short int) ((*(var_1_12_Pointer)) + (*(var_1_13_Pointer))))) : ((*(var_1_9_Pointer)) == ((signed short int) (min ((*(var_1_13_Pointer)) , ((*(var_1_12_Pointer)) + (*(var_1_14_Pointer))))))))) && ((*(var_1_10_Pointer)) ? ((*(var_1_15_Pointer)) == ((signed short int) ((max ((*(var_1_16_Pointer)) , ((*(var_1_17_Pointer)) - (*(var_1_18_Pointer))))) + ((*(var_1_19_Pointer)) - 100)))) : 1)) && ((*(var_1_10_Pointer)) ? ((*(var_1_20_Pointer)) == ((unsigned short int) ((*(var_1_21_Pointer)) - ((*(var_1_22_Pointer)) - (max ((*(var_1_19_Pointer)) , (*(var_1_18_Pointer)))))))) : ((*(var_1_20_Pointer)) == ((unsigned short int) (((*(var_1_23_Pointer)) - (*(var_1_18_Pointer))) - (*(var_1_17_Pointer))))))
;
}
int main(void) {
	isInitial = 1;
