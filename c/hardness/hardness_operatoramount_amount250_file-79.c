...
void step(void) {
	...
	if (var_1_48) {
		...
		var_1_55 = (max (((var_1_56 - var_1_57) - var_1_30) , (max ((var_1_33 + var_1_39) , var_1_34))));
	}


	// From: Req23Batch79Amount250
	if (var_1_34 > (var_1_55 / (min (var_1_56 , var_1_68)))) {
		var_1_67 = var_1_53;
	} else {
		var_1_67 = var_1_5;
	}
	...
	if ((- 5.1) < (var_1_55 * (- var_1_55))) {
		...
		var_1_26 = (var_1_13 + ((abs (var_1_23)) - (2 + var_1_22)));
	}


	// From: Req7Batch79Amount250
	if (var_1_48) {
		var_1_27 = (max (var_1_16 , ((var_1_7 - 100) + var_1_10)));
	}


	// From: Req8Batch79Amount250
	if ((var_1_29 - 200) < var_1_12) {
		var_1_28 = (min (((max (var_1_30 , var_1_31)) - 0.5f) , var_1_32));
	} else {
	...
	var_1_47 = (max ((abs (var_1_12)) , (var_1_22 + var_1_23)));
	...
	if (var_1_29 != var_1_7) {
		...
		var_1_54 = ((min (var_1_52 , (var_1_23 + var_1_53))) + var_1_13);
	}


	// From: Req21Batch79Amount250
	if (var_1_33 <= 16.6f) {
		var_1_61 = (min (((var_1_57 + var_1_62) - var_1_30) , (var_1_34 + (var_1_63 + var_1_64))));
	}


	// From: Req22Batch79Amount250
	if (! ((var_1_27 >> var_1_66) <= var_1_23)) {
		if (var_1_32 < var_1_64) {
			var_1_65 = (max (var_1_52 , var_1_46));
		}
	}


	// From: Req24Batch79Amount250
	var_1_69 = var_1_7;


	// From: Req25Batch79Amount250
	if (var_1_50) {
		var_1_70 = var_1_46;
	} else {
		var_1_70 = var_1_60;
	...
	signed long int stepLocal_7 = max (var_1_13 , var_1_10);
	...
	if (var_1_40 > stepLocal_7) {
		if (var_1_12 >= stepLocal_8) {
			if (stepLocal_6 <= (var_1_22 * var_1_40)) {
				...
				var_1_24 = (max (var_1_23 , var_1_7));
			}
		} else {
			if (stepLocal_9 || (var_1_16 <= var_1_19)) {
				var_1_24 = ((max ((var_1_25 - var_1_12) , var_1_16)) + var_1_23);
			}
		}
	} else {
		var_1_24 = var_1_7;
	...
	// From: Req27Batch79Amount250
	signed long int stepLocal_15 = 256 * var_1_6;
	if ((var_1_40 | (max (var_1_69 , var_1_37))) < stepLocal_15) {
		if (! (! var_1_48)) {
			var_1_72 = var_1_57;
		}
	} else {
	...
	signed long int stepLocal_2 = (var_1_5 + var_1_9) << (abs (var_1_12));
	signed long int stepLocal_1 = (var_1_10 * var_1_7) & (max (-50 , var_1_13));
	...
	signed long int stepLocal_3 = abs (var_1_13 + var_1_8);
	...
	if (var_1_48) {
		var_1_36 = (min (var_1_29 , var_1_37));
	} else {
		var_1_36 = (abs (var_1_12 + var_1_65));
	}
	...
	if (stepLocal_11 == var_1_12) {
		var_1_38 = (min (var_1_34 , (var_1_33 + var_1_39)));
	}
	...
	if (var_1_5 >= stepLocal_12) {
		if ((5.6f - var_1_31) != var_1_55) {
			var_1_44 = ((max (var_1_13 , (max (var_1_43 , 1)))) - var_1_42);
		}
	}


	// From: Req14Batch79Amount250
	if (((min (var_1_38 , var_1_32)) <= var_1_31) && var_1_48) {
		var_1_45 = (var_1_42 - var_1_22);
	} else {
		var_1_45 = (min ((var_1_42 - (var_1_46 - var_1_19)) , var_1_16));
	}
	...
	if ((var_1_19 ^ (~ var_1_16)) > stepLocal_5) {
		if (var_1_36 >= stepLocal_4) {
			var_1_20 = ((abs (var_1_12 - var_1_22)) - var_1_23);
		}
	} else {
		var_1_20 = (abs (var_1_12));
	}
	...
	if ((abs (var_1_24 + var_1_29)) == var_1_43) {
		var_1_58 = (abs (var_1_35 + var_1_59));
	} else {
		var_1_58 = var_1_60;
	}
}
...
int property(void) {
	return (((((((((((((((((((((((((((var_1_2 && var_1_3) ? ((var_1_72 != 16.5) ? (var_1_1 == ((signed short int) (max (-256 , var_1_5)))) : (var_1_1 == ((signed short int) (var_1_6 - var_1_7)))) : (var_1_1 == ((signed short int) ((min (var_1_8 , var_1_9)) + var_1_10)))) && ((((var_1_5 + var_1_9) << (abs (var_1_12))) <= (var_1_8 * var_1_7)) ? (var_1_11 == ((signed short int) ((var_1_12 + var_1_13) - var_1_7))) : (((~ (var_1_8 ^ var_1_9)) <= ((var_1_10 * var_1_7) & (max (-50 , var_1_13)))) ? (var_1_48 ? (((var_1_70 | (var_1_6 % var_1_15)) >= var_1_8) ? (var_1_11 == ((signed short int) (var_1_12 - (var_1_16 - var_1_13)))) : 1) : (var_1_11 == ((signed short int) (var_1_9 + var_1_10)))) : (var_1_48 ? (var_1_11 == ((signed short int) var_1_7)) : (var_1_11 == ((signed short int) var_1_10)))))) && (((var_1_5 + var_1_65) == (abs (var_1_13 + var_1_8))) ? (var_1_17 == ((signed short int) (var_1_10 + (var_1_13 - (var_1_12 + var_1_19))))) : 1)) && (((var_1_19 ^ (~ var_1_16)) > var_1_13) ? ((var_1_36 >= var_1_1) ? (var_1_20 == ((signed char) ((abs (var_1_12 - var_1_22)) - var_1_23))) : 1) : (var_1_20 == ((signed char) (abs (var_1_12)))))) && ((var_1_40 > (max (var_1_13 , var_1_10))) ? ((var_1_12 >= var_1_67) ? ((var_1_6 <= (var_1_22 * var_1_40)) ? (var_1_48 ? (var_1_24 == ((unsigned long int) (2999457086u - var_1_7))) : 1) : (var_1_24 == ((unsigned long int) (max (var_1_23 , var_1_7))))) : ((var_1_48 || (var_1_16 <= var_1_19)) ? (var_1_24 == ((unsigned long int) ((max ((var_1_25 - var_1_12) , var_1_16)) + var_1_23))) : 1)) : (var_1_24 == ((unsigned long int) var_1_7)))) && (((- 5.1) < (var_1_55 * (- var_1_55))) ? (var_1_26 == ((signed short int) -128)) : (var_1_26 == ((signed short int) (var_1_13 + ((abs (var_1_23)) - (2 + var_1_22))))))) && (var_1_48 ? (var_1_27 == ((signed long int) (max (var_1_16 , ((var_1_7 - 100) + var_1_10))))) : 1)) && (((var_1_29 - 200) < var_1_12) ? (var_1_28 == ((float) (min (((max (var_1_30 , var_1_31)) - 0.5f) , var_1_32)))) : (var_1_28 == ((float) (var_1_33 + var_1_34))))) && (((var_1_72 <= var_1_38) && var_1_48) ? (var_1_35 == ((signed short int) (256 - var_1_22))) : 1)) && (var_1_48 ? (var_1_36 == ((signed long int) (min (var_1_29 , var_1_37)))) : (var_1_36 == ((signed long int) (abs (var_1_12 + var_1_65)))))) && ((var_1_70 == var_1_12) ? (var_1_38 == ((double) (min (var_1_34 , (var_1_33 + var_1_39))))) : 1)) && (var_1_2 ? ((var_1_3 || var_1_41) ? ((((63.4 - var_1_30) * last_1_var_1_72) >= last_1_var_1_72) ? (var_1_40 == ((unsigned short int) (var_1_7 + (var_1_16 - (var_1_22 + var_1_12))))) : (((~ var_1_15) <= last_1_var_1_24) ? (var_1_40 == ((unsigned short int) (abs (var_1_12)))) : 1)) : (var_1_40 == ((unsigned short int) (var_1_42 - ((var_1_43 - var_1_19) - var_1_23))))) : (var_1_40 == ((unsigned short int) (var_1_42 - var_1_22))))) && ((var_1_5 >= var_1_54) ? (((5.6f - var_1_31) != var_1_55) ? (var_1_44 == ((signed long int) ((max (var_1_13 , (max (var_1_43 , 1)))) - var_1_42))) : 1) : 1)) && ((((min (var_1_38 , var_1_32)) <= var_1_31) && var_1_48) ? (var_1_45 == ((unsigned short int) (var_1_42 - var_1_22))) : (var_1_45 == ((unsigned short int) (min ((var_1_42 - (var_1_46 - var_1_19)) , var_1_16)))))) && (var_1_47 == ((unsigned char) (max ((abs (var_1_12)) , (var_1_22 + var_1_23)))))) && ((last_1_var_1_24 == (128u / var_1_25)) ? (var_1_48 == ((unsigned char) (! var_1_49))) : (var_1_48 == ((unsigned char) ((var_1_3 && (var_1_2 && var_1_49)) || var_1_50))))) && ((var_1_49 && var_1_48) ? (var_1_51 == ((unsigned short int) (((var_1_52 - var_1_22) + (var_1_53 + 16)) + var_1_16))) : (var_1_51 == ((unsigned short int) (var_1_42 - (var_1_16 - var_1_13)))))) && ((var_1_29 != var_1_7) ? (var_1_54 == ((unsigned short int) (abs (var_1_13)))) : (var_1_54 == ((unsigned short int) ((min (var_1_52 , (var_1_23 + var_1_53))) + var_1_13))))) && (var_1_48 ? (var_1_55 == ((double) (abs (var_1_33)))) : (var_1_55 == ((double) (max (((var_1_56 - var_1_57) - var_1_30) , (max ((var_1_33 + var_1_39) , var_1_34)))))))) && (((abs (var_1_24 + var_1_29)) == var_1_43) ? (var_1_58 == ((unsigned short int) (abs (var_1_35 + var_1_59)))) : (var_1_58 == ((unsigned short int) var_1_60)))) && ((var_1_33 <= 16.6f) ? (var_1_61 == ((float) (min (((var_1_57 + var_1_62) - var_1_30) , (var_1_34 + (var_1_63 + var_1_64)))))) : 1)) && ((! ((var_1_27 >> var_1_66) <= var_1_23)) ? ((var_1_32 < var_1_64) ? (var_1_65 == ((unsigned short int) (max (var_1_52 , var_1_46)))) : 1) : 1)) && ((var_1_34 > (var_1_55 / (min (var_1_56 , var_1_68)))) ? (var_1_67 == ((signed short int) var_1_53)) : (var_1_67 == ((signed short int) var_1_5)))) && (var_1_69 == ((signed short int) var_1_7))) && (var_1_50 ? (var_1_70 == ((unsigned short int) var_1_46)) : (var_1_70 == ((unsigned short int) var_1_60)))) && (var_1_71 == ((unsigned char) ((var_1_12 + var_1_66) + var_1_22)))) && (((var_1_40 | (max (var_1_69 , var_1_37))) < (256 * var_1_6)) ? ((! (! var_1_48)) ? (var_1_72 == ((double) var_1_57)) : 1) : (var_1_72 == ((double) var_1_30)))
;
}
int main(void) {
	isInitial = 1;
