...
void step(void) {
	...
	// From: Req3Batch188Amount100
	var_1_9 = var_1_8;


	// From: Req9Batch188Amount100
	var_1_21 = (128 - (var_1_22 - var_1_8));


	// From: Req2Batch188Amount100
	...
	// From: Req12Batch188Amount100
	if (var_1_30) {
		var_1_29 = (var_1_6 + var_1_5);
	}


	// From: Req5Batch188Amount100
