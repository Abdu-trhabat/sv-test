...
unsigned char functionized2(unsigned short int functionized2_localFunctionVar0, signed long int functionized2_localFunctionVar1) {
 return ((functionized2_localFunctionVar0 * var_1_10) < (((((-1) > (var_1_11)) ? (-1) : (var_1_11))) - functionized2_localFunctionVar1));
}
void functionized3(unsigned char functionized3_localFunctionVar0, signed short int functionized3_localFunctionVar1) {
 if ((var_1_10 + 4u) <= (var_1_9 >> functionized3_localFunctionVar0)) {
  var_1_21 = (((((functionized3_localFunctionVar0 + var_1_23)) < (functionized3_localFunctionVar1)) ? ((functionized3_localFunctionVar0 + var_1_23)) : (functionized3_localFunctionVar1)));
 } else {
...
int property(void) {
 return (((((((- var_1_2) <= var_1_3) ? (var_1_1 == ((unsigned char) var_1_4)) : ((var_1_5 <= var_1_2) ? (var_1_1 == ((unsigned char) var_1_6)) : (var_1_1 == ((unsigned char) var_1_4)))) && ((var_1_2 < ((((var_1_3) > ((128.5 * var_1_5))) ? (var_1_3) : ((128.5 * var_1_5))))) ? (var_1_7 == ((unsigned char) (var_1_1 && (! 1)))) : 1)) && (((var_1_9 * var_1_10) < (((((-1) > (var_1_11)) ? (-1) : (var_1_11))) - var_1_12)) ? (((var_1_9 + var_1_10) < var_1_12) ? (var_1_8 == ((unsigned short int) var_1_13)) : 1) : (var_1_8 == ((unsigned short int) var_1_13)))) && (((8 / var_1_15) < (64 / var_1_16)) ? ((var_1_12 >= var_1_15) ? (var_1_14 == ((double) (var_1_17 - var_1_18))) : (var_1_14 == ((double) (var_1_18 - (64.25 + ((((var_1_19) > (var_1_20)) ? (var_1_19) : (var_1_20)))))))) : (var_1_14 == ((double) var_1_18)))) && (((var_1_10 + 4u) <= (var_1_9 >> var_1_22)) ? (var_1_21 == ((signed short int) (((((var_1_22 + var_1_23)) < (var_1_24)) ? ((var_1_22 + var_1_23)) : (var_1_24))))) : (var_1_21 == ((signed short int) var_1_24)))) && ((! (var_1_21 > var_1_12)) ? (var_1_4 ? (var_1_25 == ((signed char) var_1_22)) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
