...
void step(void) {
 ...
 if (var_1_1 > (var_1_4 * var_1_5)) {
  if (var_1_1 <= var_1_5) {
   if (var_1_5 > var_1_4) {
    var_1_6 = (var_1_4 + (((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8))) - var_1_9));
   } else {
...
int property(void) {
 return ((((var_1_2 && (! var_1_3)) ? (var_1_1 == ((double) (((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5))) + 7.5))) : 1) && ((var_1_1 > (var_1_4 * var_1_5)) ? ((var_1_1 <= var_1_5) ? ((var_1_5 > var_1_4) ? (var_1_6 == ((double) (var_1_4 + (((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8))) - var_1_9)))) : (var_1_6 == ((double) ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))))) : (var_1_6 == ((double) var_1_8))) : (var_1_6 == ((double) var_1_4)))) && ((var_1_5 > var_1_8) ? (var_1_10 == ((unsigned short int) (((29089 - var_1_11) - 8) + 16))) : (var_1_10 == ((unsigned short int) ((((var_1_11) < (var_1_12)) ? (var_1_11) : (var_1_12))))))) && (var_1_13 == ((double) var_1_7))
;
}
int main(void) {
 isInitial = 1;
