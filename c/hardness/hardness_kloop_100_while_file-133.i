...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch133100_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_6 = (((last_1_var_1_31) < (last_1_var_1_32)) ? (last_1_var_1_31) : (last_1_var_1_32));
 ...
 if (var_1_14) {
  if (var_1_29 && stepLocal_7) {
   if (stepLocal_5 < ((var_1_34 - last_1_var_1_32) + last_1_var_1_31)) {
    ...
    var_1_33 = (var_1_19 + ((((last_1_var_1_33) > (last_1_var_1_31)) ? (last_1_var_1_33) : (last_1_var_1_31))));
   }
  } else {
  ...
  if (last_1_var_1_8) {
   if (stepLocal_6 >= (((((last_1_var_1_32) < (last_1_var_1_31)) ? (last_1_var_1_32) : (last_1_var_1_31))) << ((((var_1_35) > (10)) ? (var_1_35) : (10))))) {
    var_1_33 = var_1_28;
   } else {
 ...
 signed long int stepLocal_1 = (((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32));
 if (var_1_31 >= stepLocal_1) {
  var_1_21 = (var_1_23 - (var_1_24 - var_1_25));
 } else {
  var_1_21 = ((((var_1_23) < ((var_1_25 - var_1_24))) ? (var_1_23) : ((var_1_25 - var_1_24))));
 }
 if (var_1_2 && var_1_3) {
