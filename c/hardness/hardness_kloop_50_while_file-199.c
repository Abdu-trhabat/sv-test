...
void step(void) {
	// From: Req6Batch19950_while
	var_1_21 = var_1_20;


	// From: Req7Batch19950_while
	var_1_22 = var_1_20;


	// From: Req3Batch19950_while
	...
	// From: Req2Batch19950_while
	signed long int stepLocal_2 = (var_1_10 - var_1_11) % (max (var_1_3 , -64));
...
int property(void) {
	return ((((((var_1_12 ? ((((-128 / var_1_3) / var_1_4) < (var_1_5 * var_1_6)) ? (var_1_12 ? (var_1_1 == ((double) var_1_8)) : (var_1_1 == ((double) 5.2))) : 1) : 1) && ((var_1_12 && (var_1_1 < var_1_8)) ? ((var_1_4 <= ((var_1_10 - var_1_11) % (max (var_1_3 , -64)))) ? (var_1_9 == ((unsigned short int) var_1_11)) : (var_1_9 == ((unsigned short int) 256))) : (var_1_9 == ((unsigned short int) var_1_11)))) && ((var_1_11 != var_1_4) ? (((var_1_21 * var_1_5) != 5) ? (var_1_12 == ((unsigned char) var_1_13)) : 1) : 1)) && ((var_1_11 < var_1_3) ? (var_1_14 == ((signed long int) (var_1_9 + var_1_15))) : (var_1_14 == ((signed long int) (((var_1_16 - var_1_11) + var_1_9) - var_1_17))))) && ((var_1_14 <= var_1_3) ? ((var_1_13 || (var_1_10 != (var_1_11 >> var_1_19))) ? (var_1_18 == ((unsigned char) ((abs (100 + var_1_20)) - var_1_19))) : (var_1_12 ? (var_1_18 == ((unsigned char) var_1_20)) : (var_1_18 == ((unsigned char) 32)))) : (var_1_18 == ((unsigned char) var_1_20)))) && (var_1_21 == ((unsigned short int) var_1_20))) && (var_1_22 == ((signed short int) var_1_20))
;
}
int main(void) {
	isInitial = 1;
