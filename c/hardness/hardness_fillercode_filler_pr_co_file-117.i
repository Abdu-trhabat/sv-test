...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch117Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 unsigned long int stepLocal_0 = (( (((((var_1_2)) < ((var_1_3))) ? ((var_1_2)) : ((var_1_3))))) + (64u));
    ...
    var_1_35
                   ...
                   if ( (( (( ((var_1_40) - (var_1_41))) << (var_1_26))) <= ( (~ (var_1_36))))) {
                    if ( (( (( ((((16) < 0 ) ? -(16) : (16)))) >> ( ((var_1_47) - (var_1_48))))) <= (var_1_26))) {
                     var_1_46 = (
    var_1_37
   );
  }
