...
void step(void) {
	...
	// From: CodeObject9
	/* 449L, 328L) */ if (/* 450L, 308L, 309L) */ ((var_1_10) >= (var_1_29))) {
		/* 453L, 318L) */ var_1_36 = (
			-8
		);
	} else {
	...
	// From: CodeObject4
	/* 396L, 223L) */ if (/* 397L, 206L, 207L) */ (! (var_1_8))) {
		/* 399L, 214L) */ var_1_28 = (
			var_1_29
		);
	} else {
	...
	/* 369L, 201L) */ if (var_1_8) {
		/* 371L, 199L) */ if (/* 372L, 155L, 156L) */ ((var_1_17) < (/* 374L, 154L, 158L) */ ((var_1_18) * (var_1_23))))) {
			/* 377L, 197L) */ if (/* 378L, 168L, 169L) */ ((var_1_20) <= (var_1_16))) {
				...
				/* 388L, 195L) */ if (/* 389L, 184L, 185L) */ ((var_1_7) || (var_1_8))) {
					/* 392L, 194L) */ var_1_21 = (
						var_1_25
					);
				}
	...
	// From: CodeObject7
	/* 434L, 290L) */ if (/* 435L, 279L, 280L) */ ((var_1_11) <= (var_1_9))) {
		/* 438L, 289L) */ var_1_33 = (
			var_1_9
		);
	}
