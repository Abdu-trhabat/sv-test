...
void step(void) {
	// From: Req1Batch113Wrapper_S
	unsigned long int stepLocal_0 = WrapperStruct00.var_1_3;
	if (WrapperStruct00.var_1_2 >= stepLocal_0) {
		WrapperStruct00.var_1_1 = (min (128 , WrapperStruct00.var_1_4));
	} else {
		WrapperStruct00.var_1_1 = (min ((WrapperStruct00.var_1_5 + WrapperStruct00.var_1_6) , WrapperStruct00.var_1_4));
	}


	// From: Req4Batch113Wrapper_S
	...
	// From: Req2Batch113Wrapper_S
	if (WrapperStruct00.var_1_14 >= WrapperStruct00.var_1_6) {
		WrapperStruct00.var_1_7 = WrapperStruct00.var_1_8;
	}


	// From: Req3Batch113Wrapper_S
	if (-64 >= WrapperStruct00.var_1_14) {
		if ((-1000 < 256) && ((max (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_6)) > WrapperStruct00.var_1_4)) {
