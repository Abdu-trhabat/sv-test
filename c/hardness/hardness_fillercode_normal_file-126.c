...
void step(void) {
	// From: Req1Batch126normal
	if (var_1_2) {
		var_1_1 = var_1_3;
	}


	// From: Req2Batch126normal
	if (var_1_2) {
		var_1_4 = var_1_3;
	} else {
	...
	// From: Req8Batch126normal
	var_1_29 = var_1_22;


	// From: Req3Batch126normal
	if (var_1_2) {
		if (var_1_20 <= var_1_5) {
			if (var_1_7 || var_1_8) {
				var_1_6 = var_1_9;
	...
	// From: Req5Batch126normal
	if ((var_1_29 % (128 - var_1_12)) <= var_1_14) {
		var_1_11 = var_1_12;
	}


	// From: Req4Batch126normal
