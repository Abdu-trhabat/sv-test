...
void step(void) {
	...
	if (((*(WrapperStruct00_var_1_1_Pointer)) * (*(WrapperStruct00_var_1_3_Pointer))) <= (*(WrapperStruct00_var_1_4_Pointer))) {
		if (((*(WrapperStruct00_var_1_9_Pointer)) - (abs (-1))) <= ((*(WrapperStruct00_var_1_1_Pointer)) * (*(WrapperStruct00_var_1_8_Pointer)))) {
