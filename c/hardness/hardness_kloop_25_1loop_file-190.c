...
void step(void) {
	...
	// From: Req2Batch19025_1loop
	unsigned long int stepLocal_3 = var_1_13;
	unsigned long int stepLocal_2 = max (var_1_10 , var_1_13);
...
int property(void) {
	return (((var_1_11 || (var_1_11 && (var_1_5 <= var_1_6))) ? (var_1_1 == ((signed short int) var_1_7)) : ((var_1_11 || ((- var_1_8) < 32.6f)) ? (var_1_1 == ((signed short int) (var_1_9 + var_1_10))) : (var_1_1 == ((signed short int) var_1_10)))) && ((var_1_7 == var_1_13) ? (var_1_11 == ((unsigned char) var_1_12)) : ((var_1_7 <= (max (var_1_10 , var_1_13))) ? (var_1_4 ? (var_1_11 == ((unsigned char) 1)) : 1) : (var_1_11 == ((unsigned char) var_1_12))))) && ((var_1_10 <= var_1_6) ? (var_1_13 == ((unsigned long int) (var_1_14 - var_1_5))) : 1)
;
}
int main(void) {
	isInitial = 1;
