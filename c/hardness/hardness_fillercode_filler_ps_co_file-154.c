...
void step(void) {
	// From: CodeObject1
	/* 347L, 50L) */ if (var_1_31) {
		/* 349L, 48L) */ if (/* 350L, 11L, 12L) */ ((/* 351L, 7L, 13L) */ ((var_1_32) * (var_1_33))) <= (/* 354L, 10L, 16L) */ (max (/* 354L, 10L, 16L) */ (var_1_34) , (var_1_35)))))) {
			/* 357L, 40L) */ if (var_1_36) {
				/* 359L, 33L) */ var_1_30 = (
					/* 362L, 32L) */ (abs (
						var_1_37
					))
	...
	// From: CodeObject2
	/* 376L, 79L) */ if (var_1_31) {
		/* 378L, 77L) */ if (/* 379L, 58L, 59L) */ (! (var_1_36))) {
			/* 381L, 67L) */ var_1_39 = (
				/* 384L, 66L) */ (abs (
					var_1_40
				))
	...
	// From: CodeObject3
	/* 390L, 146L) */ if (/* 391L, 89L, 90L) */ ((/* 392L, 87L, 91L) */ ((/* 393L, 85L, 92L) */ ((var_1_41) % (var_1_43))) >> (var_1_44))) < (var_1_15))) {
		/* 398L, 140L) */ if (/* 399L, 108L, 109L) */ ((var_1_36) && (/* 401L, 107L, 111L) */ ((var_1_31) || (var_1_45))))) {
			/* 404L, 122L) */ var_1_42 = (
				var_1_46
			);
		} else {
			/* 408L, 138L) */ if (/* 409L, 125L, 126L) */ ((var_1_1) < (-100))) {
				/* 412L, 137L) */ var_1_42 = (
					/* 415L, 136L) */ ((
						var_1_47
					) && (
	...
	// From: CodeObject5
	/* 427L, 209L) */ if (/* 428L, 171L, 172L) */ ((/* 429L, 163L, 173L) */ ((var_1_14) & (var_1_40))) >= (/* 432L, 170L, 176L) */ ((/* 433L, 166L, 177L) */ (min (/* 433L, 166L, 177L) */ (var_1_44) , (var_1_43)))) >> (/* 436L, 169L, 180L) */ (max (/* 436L, 169L, 180L) */ (var_1_51) , (var_1_52)))))))) {
		/* 439L, 202L) */ if (var_1_53) {
			/* 441L, 201L) */ var_1_50 = (
				/* 444L, 200L) */ (abs (
					var_1_51
				))
	...
	// From: CodeObject6
	/* 452L, 256L) */ if (/* 453L, 218L, 219L) */ ((/* 454L, 215L, 220L) */ ((var_1_1) ^ (var_1_15))) > (/* 457L, 217L, 223L) */ (abs (var_1_41))))) {
		/* 459L, 254L) */ if (/* 460L, 235L, 236L) */ ((var_1_37) < (/* 462L, 234L, 238L) */ ((15.98f) + (var_1_38))))) {
			/* 465L, 249L) */ var_1_55 = (
				var_1_44
			);
		} else {
...
int property(void) {
	...
	if (/* 498L, 35L, 39L, 414L, 428L, 1031L) */ ((var_1_4) == (var_1_5))) {
	}
	if (/* 512L, 62L, 66L, 470L, 484L, 1045L) */ ((var_1_11) > (var_1_4))) {
		if (/* 516L, 71L, 75L, 474L, 488L, 1049L) */ ((var_1_8) > (var_1_4))) {
		}
	}
	if (/* 527L, 102L, 114L, 545L, 568L, 1060L) */ ((/* 528L, 96L, 115L, 546L, 569L, 1061L) */ ((var_1_16) * (/* 530L, 95L, 117L, 548L, 571L, 1063L) */ ((var_1_17) + (var_1_18))))) < (/* 533L, 101L, 120L, 551L, 574L, 1066L) */ ((/* 534L, 99L, 121L, 552L, 575L, 1067L) */ ((var_1_19) + (var_1_20))) - (var_1_21))))) {
	} else {
	}
	if (var_1_2) {
		if (/* 550L, 152L, 156L, 649L, 678L, 1083L) */ ((var_1_21) > (var_1_20))) {
			if (/* 554L, 169L, 175L, 653L, 682L, 1087L) */ ((-16) != (/* 556L, 168L, 177L, 655L, 684L, 1089L) */ ((-25) / (var_1_7))))) {
			} else {
			}
		} else {
		}
	...
	if (/* 577L, 216L, 220L, 767L, 798L, 1110L) */ ((var_1_2) || (var_1_25))) {
		if (/* 581L, 230L, 236L, 771L, 802L, 1114L) */ ((var_1_2) && (/* 583L, 229L, 238L, 773L, 804L, 1116L) */ ((var_1_15) <= (var_1_8))))) {
			if (/* 587L, 247L, 255L, 777L, 808L, 1120L) */ ((var_1_7) == (/* 589L, 246L, 257L, 779L, 810L, 1122L) */ ((/* 590L, 244L, 258L, 780L, 811L, 1123L) */ (max (/* 590L, 244L, 258L, 780L, 811L, 1123L) */ (var_1_5) , (var_1_9)))) * (var_1_4))))) {
			}
		}
	} else {
	}
	...
	/* 617L) */ ((
		/* 616L) */ ((
			/* 615L) */ ((
				/* 614L) */ ((
					/* 613L) */ ((
						/* 475L, 24L, 340L, 363L, 1008L) */ ((
							var_1_2
						) ? (
							/* 477L, 10L, 342L, 365L, 1010L) */ ((
								var_1_1
							) == (
								/* 477L, 10L, 342L, 365L, 1010L) */ ((unsigned long int) (
									/* 480L, 9L, 345L, 368L, 1013L) */ (max (
										/* 480L, 9L, 345L, 368L, 1013L) */ (
											var_1_3
										) , (
											var_1_4
										)
							...
							/* 483L, 22L, 348L, 371L, 1016L) */ ((
								var_1_1
							) == (
								/* 483L, 22L, 348L, 371L, 1016L) */ ((unsigned long int) (
									/* 486L, 21L, 351L, 374L, 1019L) */ ((
										/* 487L, 15L, 352L, 375L, 1020L) */ (min (
											/* 487L, 15L, 352L, 375L, 1020L) */ (
												var_1_5
											) , (
												var_1_6
											)
										...
										/* 490L, 20L, 355L, 378L, 1023L) */ ((
											/* 491L, 18L, 356L, 379L, 1024L) */ ((
												var_1_7
											) - (
												var_1_8
											))
						...
						/* 497L, 51L, 413L, 427L, 1030L) */ ((
							/* 498L, 35L, 39L, 414L, 428L, 1031L) */ ((
								var_1_4
							) == (
								var_1_5
							))
						) ? (
							/* 501L, 49L, 417L, 431L, 1034L) */ ((
								var_1_10
							) == (
								/* 501L, 49L, 417L, 431L, 1034L) */ ((signed char) (
									/* 504L, 48L, 420L, 434L, 1037L) */ (max (
										/* 504L, 48L, 420L, 434L, 1037L) */ (
											/* 505L, 46L, 421L, 435L, 1038L) */ ((
												var_1_11
											) + (
												var_1_12
											))
					...
					/* 511L, 85L, 469L, 483L, 1044L) */ ((
						/* 512L, 62L, 66L, 470L, 484L, 1045L) */ ((
							var_1_11
						) > (
							var_1_4
						))
					) ? (
						/* 515L, 83L, 473L, 487L, 1048L) */ ((
							/* 516L, 71L, 75L, 474L, 488L, 1049L) */ ((
								var_1_8
							) > (
								var_1_4
							))
						) ? (
							/* 519L, 81L, 477L, 491L, 1052L) */ ((
								var_1_14
							) == (
								/* 519L, 81L, 477L, 491L, 1052L) */ ((signed long int) (
									var_1_8
								))
							))
						) : (
				...
				/* 526L, 138L, 544L, 567L, 1059L) */ ((
					/* 527L, 102L, 114L, 545L, 568L, 1060L) */ ((
						/* 528L, 96L, 115L, 546L, 569L, 1061L) */ ((
							var_1_16
						) * (
							/* 530L, 95L, 117L, 548L, 571L, 1063L) */ ((
								var_1_17
							) + (
								var_1_18
							))
						...
						/* 533L, 101L, 120L, 551L, 574L, 1066L) */ ((
							/* 534L, 99L, 121L, 552L, 575L, 1067L) */ ((
								var_1_19
							) + (
								var_1_20
							))
					...
					/* 538L, 128L, 556L, 579L, 1071L) */ ((
						var_1_15
					) == (
						/* 538L, 128L, 556L, 579L, 1071L) */ ((signed long int) (
							var_1_9
						))
					))
				) : (
					/* 542L, 136L, 560L, 583L, 1075L) */ ((
						var_1_15
					) == (
						/* 542L, 136L, 560L, 583L, 1075L) */ ((signed long int) (
							var_1_22
						))
					))
				))
			...
			/* 547L, 209L, 646L, 675L, 1080L) */ ((
				var_1_2
			) ? (
				/* 549L, 203L, 648L, 677L, 1082L) */ ((
					/* 550L, 152L, 156L, 649L, 678L, 1083L) */ ((
						var_1_21
					) > (
						var_1_20
					))
				) ? (
					/* 553L, 197L, 652L, 681L, 1086L) */ ((
						/* 554L, 169L, 175L, 653L, 682L, 1087L) */ ((
							-16
						) != (
							/* 556L, 168L, 177L, 655L, 684L, 1089L) */ ((
								-25
							) / (
								var_1_7
							))
						...
						/* 559L, 183L, 658L, 687L, 1092L) */ ((
							var_1_23
						) == (
							/* 559L, 183L, 658L, 687L, 1092L) */ ((signed char) (
								var_1_13
							))
						))
					) : (
						/* 563L, 195L, 662L, 691L, 1096L) */ ((
							var_1_23
						) == (
							/* 563L, 195L, 662L, 691L, 1096L) */ ((signed char) (
								var_1_11
							))
						))
					))
				) : (
					/* 567L, 201L, 666L, 695L, 1100L) */ ((
						var_1_23
					) == (
						/* 567L, 201L, 666L, 695L, 1100L) */ ((signed char) (
							var_1_11
						))
					))
				))
			) : (
				/* 571L, 207L, 670L, 699L, 1104L) */ ((
					var_1_23
				) == (
					/* 571L, 207L, 670L, 699L, 1104L) */ ((signed char) (
						var_1_11
					))
				))
			))
		...
		/* 576L, 279L, 766L, 797L, 1109L) */ ((
			/* 577L, 216L, 220L, 767L, 798L, 1110L) */ ((
				var_1_2
			) || (
				var_1_25
			))
		) ? (
			/* 580L, 273L, 770L, 801L, 1113L) */ ((
				/* 581L, 230L, 236L, 771L, 802L, 1114L) */ ((
					var_1_2
				) && (
					/* 583L, 229L, 238L, 773L, 804L, 1116L) */ ((
						var_1_15
					) <= (
						var_1_8
					))
				...
				/* 586L, 271L, 776L, 807L, 1119L) */ ((
					/* 587L, 247L, 255L, 777L, 808L, 1120L) */ ((
						var_1_7
					) == (
						/* 589L, 246L, 257L, 779L, 810L, 1122L) */ ((
							/* 590L, 244L, 258L, 780L, 811L, 1123L) */ (max (
								/* 590L, 244L, 258L, 780L, 811L, 1123L) */ (
									var_1_5
								) , (
									var_1_9
								)
					...
					/* 594L, 269L, 784L, 815L, 1127L) */ ((
						var_1_24
					) == (
						/* 594L, 269L, 784L, 815L, 1127L) */ ((signed short int) (
							/* 597L, 268L, 787L, 818L, 1130L) */ ((
								/* 598L, 266L, 788L, 819L, 1131L) */ ((
									var_1_26
								) - (
									var_1_27
								))
			...
			/* 602L, 277L, 792L, 823L, 1135L) */ ((
				var_1_24
			) == (
				/* 602L, 277L, 792L, 823L, 1135L) */ ((signed short int) (
					var_1_15
				))
			))
		))
	...
	/* 608L, 287L, 841L, 847L, 1141L) */ ((
		var_1_28
	) == (
		/* 608L, 287L, 841L, 847L, 1141L) */ ((unsigned char) (
			var_1_29
		))
	))
))
