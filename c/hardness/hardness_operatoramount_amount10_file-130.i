...
void step(void) {
 if (var_1_2 && ((100 >> var_1_3) > var_1_4)) {
  var_1_1 = (5.5f - (var_1_5 + ((((var_1_6) < (var_1_7)) ? (var_1_6) : (var_1_7)))));
 } else {
  var_1_1 = var_1_7;
 }
 var_1_8 = var_1_3;
...
int property(void) {
 return ((var_1_2 && ((100 >> var_1_3) > var_1_4)) ? (var_1_1 == ((float) (5.5f - (var_1_5 + ((((var_1_6) < (var_1_7)) ? (var_1_6) : (var_1_7))))))) : (var_1_1 == ((float) var_1_7))) && (var_1_8 == ((signed char) var_1_3))
;
}
int main(void) {
 isInitial = 1;
