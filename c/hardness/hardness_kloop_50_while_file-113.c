...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11350_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch11350_while
	var_1_15 = var_1_6;


	// From: Req5Batch11350_while
	...
	// From: Req7Batch11350_while
	var_1_22 = (var_1_23 - var_1_24);


	// From: Req8Batch11350_while
	if (var_1_7 > 256.8) {
