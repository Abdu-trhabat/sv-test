...
signed long int functionized4(unsigned char functionized4_localFunctionVar0) {
	return (min (var_1_17 , functionized4_localFunctionVar0));
}
...
void functionized6(unsigned char functionized6_localFunctionVar0, unsigned char functionized6_localFunctionVar1, float functionized6_localFunctionVar2, float functionized6_localFunctionVar3) {
	if ((min (var_1_10 , (var_1_2 / functionized6_localFunctionVar2))) > functionized6_localFunctionVar3) {
		var_1_15 = (min ((min (5 , (abs (functionized6_localFunctionVar1)))) , (max (functionized6_localFunctionVar0 , var_1_17))));
	} else {
		var_1_15 = var_1_18;
	}
}
...
void step(void) {
	...
	if ((max (var_1_16 , var_1_6)) > var_1_13) {
	...
	// From: Req8Batch3functionizing
	var_1_24 = var_1_20;


	// From: Req9Batch3functionizing
	var_1_25 = 10;
}
...
int property(void) {
	return (((((((((99999.8f < var_1_2) ? ((! var_1_3) ? ((var_1_2 >= (var_1_4 / 2.5f)) ? (var_1_3 ? (var_1_1 == ((signed char) var_1_5)) : (var_1_1 == ((signed char) -2))) : 1) : 1) : 1) && (((- (abs (2.45f))) < var_1_2) ? (var_1_6 == ((unsigned long int) var_1_7)) : 1)) && ((var_1_3 || ((var_1_2 + var_1_4) > var_1_10)) ? (var_1_8 == ((unsigned short int) (var_1_11 + var_1_12))) : (var_1_8 == ((unsigned short int) var_1_12)))) && ((var_1_12 > var_1_8) ? ((15.8f != var_1_10) ? (var_1_13 == ((unsigned long int) var_1_8)) : 1) : 1)) && ((! var_1_9) ? (var_1_14 == ((signed short int) var_1_1)) : 1)) && (((max (var_1_16 , var_1_6)) > var_1_13) ? (var_1_15 == ((unsigned char) ((min (var_1_17 , var_1_18)) - (var_1_19 - var_1_20)))) : (((min (var_1_10 , (var_1_2 / var_1_21))) > var_1_4) ? (var_1_15 == ((unsigned char) (min ((min (5 , (abs (var_1_19)))) , (max (var_1_20 , var_1_17)))))) : (var_1_15 == ((unsigned char) var_1_18))))) && (var_1_22 == ((double) var_1_23))) && (var_1_24 == ((signed char) var_1_20))) && (var_1_25 == ((signed long int) 10))
;
}
int main(void) {
	isInitial = 1;
