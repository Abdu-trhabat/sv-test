...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch131stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch131stepLocals
	if ((var_1_6 * var_1_7) < (- var_1_8)) {
		var_1_5 = var_1_3;
	}


	// From: Req3Batch131stepLocals
	var_1_9 = (var_1_4 + var_1_10);


	// From: Req4Batch131stepLocals
	if (var_1_1 > var_1_5) {
		var_1_11 = (! (! var_1_12));
	}


	// From: Req5Batch131stepLocals
	if ((var_1_7 * (- var_1_6)) <= (4.25 * var_1_8)) {
		var_1_13 = (var_1_12 && var_1_14);
	}


	// From: Req6Batch131stepLocals
	...
	// From: Req7Batch131stepLocals
	unsigned char stepLocal_3 = var_1_13;
	signed long int stepLocal_2 = (var_1_3 - var_1_16) * var_1_5;
	if (stepLocal_3 && (var_1_18 > (var_1_4 % var_1_16))) {
		if (stepLocal_2 > (var_1_15 / -2)) {
