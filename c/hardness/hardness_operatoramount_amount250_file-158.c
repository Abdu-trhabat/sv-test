...
void step(void) {
	...
	// From: Req14Batch158Amount250
	if (var_1_20 < var_1_17) {
		var_1_47 = var_1_20;
	} else {
		if (var_1_12 > 499.8) {
			var_1_47 = (var_1_36 + (abs (var_1_41)));
		}
	}


	// From: Req1Batch158Amount250
	...
	if ((var_1_34 & last_1_var_1_54) > stepLocal_5) {
		...
		if (stepLocal_6 < -32) {
			var_1_38 = ((min (last_1_var_1_47 , (var_1_32 + last_1_var_1_38))) + var_1_6);
		} else {
			var_1_38 = ((min ((var_1_41 - var_1_36) , last_1_var_1_20)) + 500u);
		}
	}


	// From: Req9Batch158Amount250
	var_1_35 = ((min ((min (var_1_32 , var_1_38)) , var_1_34)) + (var_1_36 - var_1_33));


	// From: Req23Batch158Amount250
	...
	// From: Req8Batch158Amount250
	var_1_31 = (var_1_32 - (var_1_33 + var_1_34));


	// From: Req17Batch158Amount250
	...
	// From: Req15Batch158Amount250
	if (var_1_33 <= (var_1_27 << (max (var_1_49 , var_1_50)))) {
		if (((var_1_22 + var_1_46) + var_1_14) <= 63.5) {
			var_1_48 = (min (var_1_12 , var_1_13));
		}
	}


	// From: Req19Batch158Amount250
	if ((var_1_13 + var_1_14) > var_1_48) {
		var_1_55 = (min ((min ((var_1_13 + var_1_14) , var_1_56)) , (var_1_57 + var_1_58)));
	}


	// From: Req5Batch158Amount250
	if ((var_1_48 / (max (var_1_13 , var_1_22))) < var_1_12) {
		if (var_1_8) {
			var_1_21 = var_1_9;
		} else {
			var_1_21 = ((var_1_19 > (min (var_1_47 , var_1_6))) || (! (var_1_9 || var_1_23)));
		}
	} else {
		var_1_21 = var_1_10;
	}
	...
	// From: Req10Batch158Amount250
	if (var_1_30) {
		var_1_37 = (((var_1_12 == var_1_13) || var_1_4) && var_1_10);
	}


	// From: Req22Batch158Amount250
	if (var_1_30) {
		var_1_62 = var_1_33;
	} else {
		var_1_62 = var_1_50;
	...
	// From: Req12Batch158Amount250
	if (var_1_30) {
		var_1_42 = (min (((min (var_1_34 , var_1_33)) - (var_1_43 - var_1_44)) , var_1_45));
	}


	// From: Req2Batch158Amount250
	if (var_1_37) {
		var_1_11 = var_1_12;
	} else {
	...
	// From: Req3Batch158Amount250
	if ((var_1_16 - var_1_62) == ((var_1_54 + 100u) * var_1_6)) {
		if (var_1_21) {
			var_1_15 = 5;
		} else {
			var_1_15 = ((var_1_62 + (var_1_6 + var_1_17)) + (var_1_18 + (min (-256 , var_1_19))));
		}
	}


	// From: Req16Batch158Amount250
	signed long int stepLocal_9 = var_1_20;
	if (var_1_22 < (var_1_12 / (min (5.65 , var_1_13)))) {
	...
	// From: Req21Batch158Amount250
	if ((max (var_1_11 , 99.75f)) >= var_1_12) {
	...
	// From: Req20Batch158Amount250
	if ((var_1_36 * (var_1_47 + last_1_var_1_59)) <= var_1_44) {
		if (var_1_15 < var_1_47) {
			var_1_59 = (min ((min (var_1_15 , var_1_60)) , var_1_15));
		} else {
			var_1_59 = (min (32u , var_1_39));
		}
	} else {
		if (var_1_8) {
			var_1_59 = (min ((max (var_1_15 , var_1_47)) , var_1_15));
		} else {
			if (var_1_1 && var_1_4) {
				if (var_1_25 >= -2) {
					var_1_59 = ((min (var_1_44 , var_1_15)) + var_1_36);
				}
			}
		}
	}
	...
	// From: Req6Batch158Amount250
	if (var_1_23 && var_1_4) {
		var_1_24 = (var_1_25 + (min (2 , (var_1_26 + var_1_27))));
	} else {
		if (! var_1_51) {
			var_1_24 = (min ((var_1_26 + (var_1_27 + var_1_29)) , -5));
		}
	}
}
...
int property(void) {
	return ((((((((((((((((((((((last_1_var_1_21 ? ((128u < last_1_var_1_59) ? (var_1_1 == ((unsigned char) (! var_1_4))) : ((((- last_1_var_1_59) + (last_1_var_1_62 % var_1_6)) < last_1_var_1_47) ? (var_1_1 == ((unsigned char) (var_1_4 || (! var_1_8)))) : ((last_1_var_1_47 > (- last_1_var_1_59)) ? (var_1_1 == ((unsigned char) (var_1_8 || (var_1_4 && var_1_9)))) : (var_1_1 == ((unsigned char) var_1_4))))) : ((last_1_var_1_47 >= var_1_6) ? (var_1_1 == ((unsigned char) (var_1_4 && var_1_10))) : (var_1_1 == ((unsigned char) (! (var_1_9 || var_1_8)))))) && (var_1_37 ? (var_1_11 == ((double) var_1_12)) : (var_1_11 == ((double) ((8.211064086987161E18 - (var_1_13 - var_1_14)) - 49.5))))) && (((var_1_16 - var_1_62) == ((var_1_54 + 100u) * var_1_6)) ? (var_1_21 ? (var_1_15 == ((signed long int) 5)) : (var_1_15 == ((signed long int) ((var_1_62 + (var_1_6 + var_1_17)) + (var_1_18 + (min (-256 , var_1_19))))))) : 1)) && ((var_1_18 <= (var_1_6 - (last_1_var_1_47 + 256))) ? (var_1_10 ? (var_1_20 == ((signed long int) (min (var_1_17 , var_1_6)))) : (var_1_20 == ((signed long int) last_1_var_1_47))) : 1)) && (((var_1_48 / (max (var_1_13 , var_1_22))) < var_1_12) ? (var_1_8 ? (var_1_21 == ((unsigned char) var_1_9)) : (var_1_21 == ((unsigned char) ((var_1_19 > (min (var_1_47 , var_1_6))) || (! (var_1_9 || var_1_23)))))) : (var_1_21 == ((unsigned char) var_1_10)))) && ((var_1_23 && var_1_4) ? (var_1_24 == ((signed short int) (var_1_25 + (min (2 , (var_1_26 + var_1_27)))))) : ((! var_1_51) ? (var_1_24 == ((signed short int) (min ((var_1_26 + (var_1_27 + var_1_29)) , -5)))) : 1))) && ((! (var_1_16 <= var_1_6)) ? (var_1_30 == ((unsigned char) (((var_1_12 < var_1_13) && (var_1_38 <= var_1_16)) && (! var_1_10)))) : (var_1_9 ? ((! var_1_21) ? (var_1_10 ? (var_1_30 == ((unsigned char) var_1_4)) : (var_1_30 == ((unsigned char) 0))) : (var_1_30 == ((unsigned char) var_1_4))) : (var_1_30 == ((unsigned char) var_1_8))))) && (var_1_31 == ((unsigned char) (var_1_32 - (var_1_33 + var_1_34))))) && (var_1_35 == ((unsigned short int) ((min ((min (var_1_32 , var_1_38)) , var_1_34)) + (var_1_36 - var_1_33))))) && (var_1_30 ? (var_1_37 == ((unsigned char) (((var_1_12 == var_1_13) || var_1_4) && var_1_10))) : 1)) && (((var_1_34 & last_1_var_1_54) > var_1_6) ? (var_1_38 == ((unsigned long int) (var_1_39 - (var_1_40 - var_1_34)))) : (((last_1_var_1_47 * var_1_18) < -32) ? (var_1_38 == ((unsigned long int) ((min (last_1_var_1_47 , (var_1_32 + last_1_var_1_38))) + var_1_6))) : (var_1_38 == ((unsigned long int) ((min ((var_1_41 - var_1_36) , last_1_var_1_20)) + 500u)))))) && (var_1_30 ? (var_1_42 == ((signed char) (min (((min (var_1_34 , var_1_33)) - (var_1_43 - var_1_44)) , var_1_45)))) : 1)) && ((var_1_39 < var_1_54) ? (var_1_46 == ((double) (min (var_1_12 , var_1_13)))) : (var_1_23 ? (var_1_46 == ((double) (abs (var_1_14)))) : ((var_1_63 >= var_1_44) ? (var_1_46 == ((double) (var_1_13 - var_1_14))) : 1)))) && ((var_1_20 < var_1_17) ? (var_1_47 == ((unsigned long int) var_1_20)) : ((var_1_12 > 499.8) ? (var_1_47 == ((unsigned long int) (var_1_36 + (abs (var_1_41))))) : 1))) && ((var_1_33 <= (var_1_27 << (max (var_1_49 , var_1_50)))) ? ((((var_1_22 + var_1_46) + var_1_14) <= 63.5) ? (var_1_48 == ((double) (min (var_1_12 , var_1_13)))) : 1) : 1)) && ((var_1_22 < (var_1_12 / (min (5.65 , var_1_13)))) ? ((var_1_17 < var_1_20) ? (var_1_51 == ((unsigned char) ((var_1_44 > var_1_38) || (! var_1_8)))) : ((200.9f >= var_1_11) ? (var_1_51 == ((unsigned char) (! var_1_10))) : (var_1_51 == ((unsigned char) (! (var_1_4 && (var_1_10 && var_1_52))))))) : ((! var_1_4) ? (var_1_51 == ((unsigned char) (! var_1_10))) : 1))) && (((var_1_40 ^ var_1_25) < 200u) ? (var_1_53 == ((signed short int) (var_1_33 + (var_1_49 - var_1_63)))) : (var_1_53 == ((signed short int) var_1_50)))) && ((var_1_25 >= (last_1_var_1_38 ^ -4)) ? ((((var_1_44 + last_1_var_1_38) / var_1_6) <= var_1_32) ? (var_1_54 == ((unsigned long int) (max (var_1_6 , last_1_var_1_24)))) : (var_1_54 == ((unsigned long int) ((var_1_40 - last_1_var_1_15) + 128u)))) : 1)) && (((var_1_13 + var_1_14) > var_1_48) ? (var_1_55 == ((float) (min ((min ((var_1_13 + var_1_14) , var_1_56)) , (var_1_57 + var_1_58))))) : 1)) && (((var_1_36 * (var_1_47 + last_1_var_1_59)) <= var_1_44) ? ((var_1_15 < var_1_47) ? (var_1_59 == ((unsigned long int) (min ((min (var_1_15 , var_1_60)) , var_1_15)))) : (var_1_59 == ((unsigned long int) (min (32u , var_1_39))))) : (var_1_8 ? (var_1_59 == ((unsigned long int) (min ((max (var_1_15 , var_1_47)) , var_1_15)))) : ((var_1_1 && var_1_4) ? ((var_1_25 >= -2) ? (var_1_59 == ((unsigned long int) ((min (var_1_44 , var_1_15)) + var_1_36))) : 1) : 1)))) && (((max (var_1_11 , 99.75f)) >= var_1_12) ? (var_1_61 == ((unsigned short int) (abs (var_1_43)))) : (var_1_61 == ((unsigned short int) var_1_50)))) && (var_1_30 ? (var_1_62 == ((unsigned short int) var_1_33)) : (var_1_62 == ((unsigned short int) var_1_50)))) && ((var_1_35 >= (var_1_64 - (var_1_36 - var_1_50))) ? ((var_1_19 <= (var_1_38 / var_1_41)) ? (var_1_63 == ((signed long int) (100 + var_1_17))) : (var_1_63 == ((signed long int) -16))) : 1)
;
}
int main(void) {
	isInitial = 1;
