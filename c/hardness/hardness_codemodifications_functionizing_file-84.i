...
unsigned long int functionized1(void) {
 return ((((32u) < 0 ) ? -(32u) : (32u)));
}
void functionized2(signed char functionized2_localFunctionVar0) {
 if ((~ var_1_3) < var_1_14) {
  var_1_13 = (((((functionized2_localFunctionVar0 + var_1_3)) > (-5)) ? ((functionized2_localFunctionVar0 + var_1_3)) : (-5)));
 }
}
unsigned char functionized3(signed long int functionized3_localFunctionVar0, unsigned char functionized3_localFunctionVar1, signed long int functionized3_localFunctionVar2, signed char functionized3_localFunctionVar3, signed long int functionized3_localFunctionVar4) {
 return (((functionized3_localFunctionVar3 + functionized3_localFunctionVar4) & functionized3_localFunctionVar2) <= (var_1_10 - ((((functionized3_localFunctionVar1) < (functionized3_localFunctionVar0)) ? (functionized3_localFunctionVar1) : (functionized3_localFunctionVar0)))));
}
signed long int functionized4(void) {
 return ((((((((var_1_10) > ((var_1_17 - var_1_4))) ? (var_1_10) : ((var_1_17 - var_1_4))))) > (var_1_11)) ? (((((var_1_10) > ((var_1_17 - var_1_4))) ? (var_1_10) : ((var_1_17 - var_1_4))))) : (var_1_11)));
}
void initially(void) {
}
void step(void) {
 if (var_1_2) {
  var_1_1 = ((((functionized0()) < (var_1_5)) ? (functionized0()) : (var_1_5)));
 }
