...
void step(void) {
	...
	if ((unsigned_short_int_Array_0[0] / 32) < (min ((signed_long_int_Array_0[2] + signed_long_int_Array_0[1]) , signed_long_int_Array_0[0]))) {
