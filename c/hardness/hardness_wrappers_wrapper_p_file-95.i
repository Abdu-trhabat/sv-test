...
void step(void) {
 (*(var_1_1_Pointer)) = (((((*(var_1_2_Pointer))) < 0 ) ? -((*(var_1_2_Pointer))) : ((*(var_1_2_Pointer)))));
 ...
 if (((*(var_1_7_Pointer)) / (*(var_1_14_Pointer))) < ((*(var_1_15_Pointer)) >> (*(var_1_16_Pointer)))) {
  (*(var_1_13_Pointer)) = ((((4 - (*(var_1_12_Pointer))) < 0 ) ? -(4 - (*(var_1_12_Pointer))) : (4 - (*(var_1_12_Pointer)))));
 } else {
  if ((*(var_1_9_Pointer)) >= (*(var_1_1_Pointer))) {
   (*(var_1_13_Pointer)) = (((((256 - (*(var_1_16_Pointer)))) > ((*(var_1_7_Pointer)))) ? ((256 - (*(var_1_16_Pointer)))) : ((*(var_1_7_Pointer)))));
  } else {
...
int property(void) {
 return (((((*(var_1_1_Pointer)) == ((signed long int) (((((*(var_1_2_Pointer))) < 0 ) ? -((*(var_1_2_Pointer))) : ((*(var_1_2_Pointer))))))) && ((*(var_1_3_Pointer)) == ((float) (((*(var_1_4_Pointer)) - (*(var_1_5_Pointer))) + ((((256.5f) < (((*(var_1_6_Pointer)) - 16.125f))) ? (256.5f) : (((*(var_1_6_Pointer)) - 16.125f)))))))) && (((- (3351680781u - (*(var_1_8_Pointer)))) > ((*(var_1_1_Pointer)) & (*(var_1_9_Pointer)))) ? ((*(var_1_7_Pointer)) == ((unsigned char) ((((((*(var_1_10_Pointer))) < ((((((*(var_1_11_Pointer))) < 0 ) ? -((*(var_1_11_Pointer))) : ((*(var_1_11_Pointer))))))) ? ((*(var_1_10_Pointer))) : ((((((*(var_1_11_Pointer))) < 0 ) ? -((*(var_1_11_Pointer))) : ((*(var_1_11_Pointer)))))))) + (*(var_1_12_Pointer))))) : 1)) && ((((*(var_1_7_Pointer)) / (*(var_1_14_Pointer))) < ((*(var_1_15_Pointer)) >> (*(var_1_16_Pointer)))) ? ((*(var_1_13_Pointer)) == ((signed short int) ((((4 - (*(var_1_12_Pointer))) < 0 ) ? -(4 - (*(var_1_12_Pointer))) : (4 - (*(var_1_12_Pointer))))))) : (((*(var_1_9_Pointer)) >= (*(var_1_1_Pointer))) ? ((*(var_1_13_Pointer)) == ((signed short int) (((((256 - (*(var_1_16_Pointer)))) > ((*(var_1_7_Pointer)))) ? ((256 - (*(var_1_16_Pointer)))) : ((*(var_1_7_Pointer))))))) : ((*(var_1_13_Pointer)) == ((signed short int) (*(var_1_12_Pointer))))))) && ((*(var_1_17_Pointer)) == ((double) (*(var_1_6_Pointer))))
;
}
int main(void) {
 isInitial = 1;
