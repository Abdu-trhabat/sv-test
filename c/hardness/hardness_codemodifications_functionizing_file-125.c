...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch125functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
void functionized0(signed char);
void functionized1(unsigned short int, signed char);
...
void functionized0(signed char functionized0_localFunctionVar0) {
	var_1_11 = ((abs (var_1_12)) + functionized0_localFunctionVar0);
}
void functionized1(unsigned short int functionized1_localFunctionVar0, signed char functionized1_localFunctionVar1) {
	var_1_18 = (min ((functionized1_localFunctionVar0 - 100) , functionized1_localFunctionVar1));
}
void functionized2(signed char functionized2_localFunctionVar0) {
	if (var_1_2) {
		var_1_20 = functionized2_localFunctionVar0;
	} else {
		var_1_20 = ((var_1_9 - 64) + functionized2_localFunctionVar0);
	}
}
void functionized3(signed char functionized3_localFunctionVar0, signed char functionized3_localFunctionVar1) {
	if (var_1_18 < var_1_21) {
		if (var_1_2 && var_1_24) {
			var_1_23 = ((min ((functionized3_localFunctionVar1 - 5) , (min (var_1_13 , var_1_12)))) + functionized3_localFunctionVar0);
		} else {
			var_1_23 = var_1_12;
		}
	}
...
void step(void) {
	// From: Req1Batch125functionizing
	...
	// From: Req2Batch125functionizing
	functionized0(var_1_13);


	// From: Req3Batch125functionizing
	if (var_1_2) {
		if (var_1_8 > var_1_12) {
	...
	// From: Req4Batch125functionizing
	functionized1(var_1_19, var_1_9);


	// From: Req5Batch125functionizing
	functionized2(var_1_11);


	// From: Req6Batch125functionizing
	...
	// From: Req7Batch125functionizing
	functionized3(var_1_26, var_1_25);
}
