...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch77Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(float_Array_0_arrayfloat_Array_0arrayVar6_Pointer)) != (*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer))) {
	...
	if ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)) > ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var5_Pointer)) * (max ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)))))) {
