...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch74Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned char stepLocal_0 = WrapperStruct00.var_1_5 > WrapperStruct00.var_1_11;
