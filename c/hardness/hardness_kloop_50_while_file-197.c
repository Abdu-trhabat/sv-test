...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19750_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch19750_while
	var_1_22 = var_1_13;


	// From: Req8Batch19750_while
	var_1_23 = var_1_20;


	// From: Req5Batch19750_while
	if (var_1_7 && var_1_10) {
