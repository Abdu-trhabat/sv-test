...
void step(void) {
	...
	unsigned char stepLocal_2 = (var_1_13 - var_1_14) != (min (var_1_15 , var_1_16));
	...
	if ((min (var_1_1 , var_1_19)) < var_1_1) {
		var_1_20 = var_1_22;
	}
	...
	if (var_1_10) {
		if (stepLocal_3 && var_1_25) {
			var_1_23 = ((max (0 , var_1_11)) + (max (var_1_26 , var_1_27)));
		} else {
			var_1_23 = var_1_11;
		}
	} else {
	...
	unsigned long int stepLocal_5 = min (var_1_1 , var_1_6);
	...
	if (! var_1_10) {
		if ((max (var_1_6 , var_1_28)) >= var_1_1) {
			var_1_9 = (-16 + var_1_11);
		} else {
			var_1_9 = var_1_11;
		}
...
int property(void) {
	return ((((((((var_1_2 + var_1_3) / var_1_4) == var_1_5) ? (var_1_1 == ((unsigned long int) ((min (var_1_6 , var_1_7)) + var_1_8))) : 1) && ((! var_1_10) ? (((max (var_1_6 , var_1_28)) >= var_1_1) ? (var_1_9 == ((signed char) (-16 + var_1_11))) : (var_1_9 == ((signed char) var_1_11))) : (var_1_9 == ((signed char) var_1_11)))) && ((((var_1_13 - var_1_14) != (min (var_1_15 , var_1_16))) || var_1_10) ? ((var_1_1 >= var_1_17) ? (var_1_12 == ((unsigned short int) ((min (var_1_18 , var_1_19)) + 32))) : (var_1_12 == ((unsigned short int) var_1_19))) : 1)) && (((min (var_1_1 , var_1_19)) < var_1_1) ? (var_1_20 == ((double) var_1_22)) : 1)) && (var_1_10 ? ((var_1_24 && var_1_25) ? (var_1_23 == ((signed char) ((max (0 , var_1_11)) + (max (var_1_26 , var_1_27))))) : (var_1_23 == ((signed char) var_1_11))) : (var_1_23 == ((signed char) var_1_26)))) && (((min (var_1_1 , var_1_6)) > (var_1_7 | var_1_19)) ? ((var_1_25 && (var_1_11 < var_1_1)) ? (var_1_28 == ((signed long int) (var_1_19 - var_1_18))) : (var_1_28 == ((signed long int) var_1_11))) : (var_1_28 == ((signed long int) var_1_12)))
;
}
int main(void) {
	isInitial = 1;
