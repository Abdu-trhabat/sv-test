...
void step(void) {
	...
	// From: Req2Batch16650_while
	if (var_1_2 != var_1_6) {
		var_1_8 = (var_1_10 - (var_1_11 + var_1_12));
	}


	// From: Req4Batch16650_while
