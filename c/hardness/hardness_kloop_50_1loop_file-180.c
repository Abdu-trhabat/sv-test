...
void step(void) {
	...
	// From: Req4Batch18050_1loop
	var_1_14 = (min ((var_1_1 - var_1_12) , var_1_15));


	// From: Req3Batch18050_1loop
	if (var_1_7) {
		if (! var_1_11) {
	...
	// From: Req7Batch18050_1loop
	var_1_19 = (min (var_1_8 , var_1_9));


	// From: Req6Batch18050_1loop
