...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch137Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch137Filler_PE_CI
	/* 1072L, 248L, 864L, 870L) */ var_1_22 = (
		var_1_4
	);


	// From: Req8Batch137Filler_PE_CI
	/* 1078L, 258L, 888L, 894L) */ var_1_23 = (
		var_1_13
	);


	// From: Req9Batch137Filler_PE_CI
	/* 1084L, 268L, 912L, 918L) */ var_1_24 = (
		var_1_7
	);


	// From: Req3Batch137Filler_PE_CI
