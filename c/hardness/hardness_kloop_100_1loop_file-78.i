...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch78100_1loop.c", 13, "reach_error"); }
...
unsigned long int last_1_var_1_13 = 16;
signed char last_1_var_1_21 = -10;
unsigned char last_1_var_1_35 = 1;
signed short int last_1_var_1_38 = -4;
void initially(void) {
}
void step(void) {
 if (last_1_var_1_35) {
  if ((var_1_5 + var_1_3) >= last_1_var_1_13) {
   var_1_6 = (var_1_8 + (var_1_9 - var_1_10));
  } else {
   var_1_6 = ((var_1_11 + ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) + (8.25 - var_1_9));
  }
 }
 var_1_35 = ((var_1_6 < var_1_8) || (! var_1_37));
 if (var_1_10 < (var_1_12 * var_1_9)) {
  var_1_13 = var_1_3;
 } else {
  var_1_13 = ((((var_1_3) > (16u)) ? (var_1_3) : (16u)));
 }
 signed long int stepLocal_3 = - var_1_16;
 unsigned long int stepLocal_2 = ((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27))) - var_1_4;
 ...
 if (stepLocal_4 >= ((((var_1_13) < ((- var_1_3))) ? (var_1_13) : ((- var_1_3))))) {
  if (var_1_25) {
   var_1_29 = var_1_17;
  }
 }
 var_1_30 = (((((var_1_10) > ((var_1_9 + var_1_31))) ? (var_1_10) : ((var_1_9 + var_1_31)))) - var_1_32);
 if (var_1_12 == (var_1_10 - ((((var_1_9) < (var_1_32)) ? (var_1_9) : (var_1_32))))) {
  var_1_33 = (var_1_34 - 128u);
 }
 if ((var_1_18 - var_1_19) < ((var_1_17 / var_1_3) * last_1_var_1_38)) {
 ...
 if (! var_1_25) {
  var_1_1 = (((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4))) - (5 + var_1_5));
 } else {
  var_1_1 = var_1_3;
 }
 ...
 if (stepLocal_0 >= (- (- var_1_3))) {
  ...
  var_1_14 = (((((var_1_19 - 64)) < (var_1_15)) ? ((var_1_19 - 64)) : (var_1_15)));
 }
 unsigned char stepLocal_1 = var_1_33 <= var_1_4;
 if (var_1_9 <= var_1_30) {
...
int property(void) {
 return (((((((((((((! var_1_25) ? (var_1_1 == ((unsigned short int) (((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4))) - (5 + var_1_5)))) : (var_1_1 == ((unsigned short int) var_1_3))) && (last_1_var_1_35 ? (((var_1_5 + var_1_3) >= last_1_var_1_13) ? (var_1_6 == ((double) (var_1_8 + (var_1_9 - var_1_10)))) : (var_1_6 == ((double) ((var_1_11 + ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) + (8.25 - var_1_9))))) : 1)) && ((var_1_10 < (var_1_12 * var_1_9)) ? (var_1_13 == ((unsigned long int) var_1_3)) : (var_1_13 == ((unsigned long int) ((((var_1_3) > (16u)) ? (var_1_3) : (16u))))))) && ((var_1_13 >= (- (- var_1_3))) ? (var_1_25 ? (var_1_14 == ((signed char) (var_1_15 - var_1_16))) : (var_1_14 == ((signed char) ((var_1_17 - var_1_18) - (var_1_19 + var_1_20))))) : (var_1_14 == ((signed char) (((((var_1_19 - 64)) < (var_1_15)) ? ((var_1_19 - 64)) : (var_1_15))))))) && ((var_1_9 <= var_1_30) ? (((var_1_33 <= var_1_4) && (! (var_1_18 == last_1_var_1_21))) ? (var_1_21 == ((signed char) var_1_15)) : (var_1_21 == ((signed char) var_1_23))) : 1)) && (var_1_25 ? (var_1_24 == ((signed char) (var_1_20 + var_1_18))) : (var_1_24 == ((signed char) var_1_17)))) && (((((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27))) - var_1_4) <= var_1_3) ? (((- var_1_16) == var_1_3) ? (var_1_35 ? (var_1_25 == ((unsigned char) 0)) : 1) : 1) : 1)) && ((var_1_4 <= var_1_5) ? ((var_1_26 == (var_1_16 * (var_1_27 & var_1_19))) ? (var_1_35 ? (var_1_28 == ((unsigned char) var_1_20)) : (var_1_28 == ((unsigned char) var_1_19))) : 1) : (var_1_28 == ((unsigned char) var_1_20)))) && ((var_1_13 >= ((((var_1_13) < ((- var_1_3))) ? (var_1_13) : ((- var_1_3))))) ? (var_1_25 ? (var_1_29 == ((unsigned char) var_1_17)) : 1) : 1)) && (var_1_30 == ((double) (((((var_1_10) > ((var_1_9 + var_1_31))) ? (var_1_10) : ((var_1_9 + var_1_31)))) - var_1_32)))) && ((var_1_12 == (var_1_10 - ((((var_1_9) < (var_1_32)) ? (var_1_9) : (var_1_32))))) ? (var_1_33 == ((unsigned long int) (var_1_34 - 128u))) : 1)) && (var_1_35 == ((unsigned char) ((var_1_6 < var_1_8) || (! var_1_37))))) && (((var_1_18 - var_1_19) < ((var_1_17 / var_1_3) * last_1_var_1_38)) ? ((var_1_32 >= (var_1_10 - var_1_31)) ? (var_1_38 == ((signed short int) var_1_18)) : (var_1_38 == ((signed short int) var_1_19))) : (var_1_38 == ((signed short int) var_1_28)))
;
}
int main(void) {
 isInitial = 1;
