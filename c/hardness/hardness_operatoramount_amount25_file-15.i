...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15Amount25.c", 13, "reach_error"); }
...
void step(void) {
 if (((var_1_10 * var_1_11) / var_1_12) >= ((((255.025) < 0 ) ? -(255.025) : (255.025)))) {
  var_1_9 = var_1_13;
 }
 var_1_14 = var_1_9;
 var_1_15 = var_1_16;
