...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch31Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch31Wrapper_P
	if ((*(var_1_2_Pointer))) {
		(*(var_1_1_Pointer)) = (((*(var_1_3_Pointer)) - (*(var_1_4_Pointer))) - (*(var_1_5_Pointer)));
	} else {
		if ((*(var_1_6_Pointer)) && ((*(var_1_3_Pointer)) < (*(var_1_4_Pointer)))) {
			(*(var_1_1_Pointer)) = (*(var_1_3_Pointer));
		}
	}


	// From: Req2Batch31Wrapper_P
	if ((*(var_1_5_Pointer)) < (*(var_1_4_Pointer))) {
		(*(var_1_7_Pointer)) = ((*(var_1_4_Pointer)) + (*(var_1_8_Pointer)));
	} else {
		(*(var_1_7_Pointer)) = ((*(var_1_4_Pointer)) - (*(var_1_3_Pointer)));
	}


	// From: Req4Batch31Wrapper_P
	if (((*(var_1_7_Pointer)) + (*(var_1_3_Pointer))) < (*(var_1_4_Pointer))) {
	...
	// From: Req3Batch31Wrapper_P
	if (! ((*(var_1_3_Pointer)) < ((*(var_1_8_Pointer)) * (*(var_1_7_Pointer))))) {
		if ((abs ((*(var_1_13_Pointer)))) < (*(var_1_13_Pointer))) {
			if ((*(var_1_6_Pointer))) {
...
int property(void) {
	return ((((*(var_1_2_Pointer)) ? ((*(var_1_1_Pointer)) == ((signed long int) (((*(var_1_3_Pointer)) - (*(var_1_4_Pointer))) - (*(var_1_5_Pointer))))) : (((*(var_1_6_Pointer)) && ((*(var_1_3_Pointer)) < (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed long int) (*(var_1_3_Pointer)))) : 1)) && (((*(var_1_5_Pointer)) < (*(var_1_4_Pointer))) ? ((*(var_1_7_Pointer)) == ((signed long int) ((*(var_1_4_Pointer)) + (*(var_1_8_Pointer))))) : ((*(var_1_7_Pointer)) == ((signed long int) ((*(var_1_4_Pointer)) - (*(var_1_3_Pointer))))))) && ((! ((*(var_1_3_Pointer)) < ((*(var_1_8_Pointer)) * (*(var_1_7_Pointer))))) ? (((abs ((*(var_1_13_Pointer)))) < (*(var_1_13_Pointer))) ? ((*(var_1_6_Pointer)) ? ((*(var_1_9_Pointer)) == ((unsigned char) (*(var_1_12_Pointer)))) : 1) : 1) : ((*(var_1_9_Pointer)) == ((unsigned char) (*(var_1_12_Pointer)))))) && ((((*(var_1_7_Pointer)) + (*(var_1_3_Pointer))) < (*(var_1_4_Pointer))) ? (((*(var_1_2_Pointer)) && (*(var_1_6_Pointer))) ? ((*(var_1_6_Pointer)) ? ((*(var_1_13_Pointer)) == ((double) 0.8)) : ((*(var_1_13_Pointer)) == ((double) (*(var_1_14_Pointer))))) : ((*(var_1_13_Pointer)) == ((double) (*(var_1_14_Pointer))))) : ((*(var_1_13_Pointer)) == ((double) (*(var_1_14_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
