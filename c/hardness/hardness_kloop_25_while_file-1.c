...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch125_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_1 <= var_1_4) {
		var_1_5 = (max (64 , (var_1_6 + var_1_7)));
	} else {
		if (var_1_1 < var_1_4) {
			var_1_5 = var_1_6;
		} else {
