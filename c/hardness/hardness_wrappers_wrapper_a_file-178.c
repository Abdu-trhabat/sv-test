...
void step(void) {
	...
	// From: Req3Batch178Wrapper_A
	if (BOOL_unsigned_char_Array_0[0][0]) {
		signed_short_int_Array_0[1][0] = unsigned_char_Array_0[0][0];
	} else {
		signed_short_int_Array_0[1][0] = (min (unsigned_char_Array_0[1][0] , (unsigned_char_Array_0[0][0] - signed_short_int_Array_0[0][1])));
	}


	// From: Req1Batch178Wrapper_A
