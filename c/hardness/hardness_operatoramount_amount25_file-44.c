...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch44Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch44Amount25
	var_1_8 = (var_1_9 - (var_1_10 + var_1_11));


	// From: Req3Batch44Amount25
	if (! var_1_13) {
	...
	// From: Req4Batch44Amount25
	signed long int stepLocal_2 = var_1_14 >> var_1_18;
	if (stepLocal_2 != ((last_1_var_1_17 * var_1_10) / (abs (var_1_7)))) {
		var_1_17 = var_1_9;
	} else {
		var_1_17 = var_1_14;
	}
