...
void step(void) {
	...
	// From: CodeObject5
	/* 269L, 119L) */ if (/* 270L, 75L, 76L) */ ((/* 271L, 73L, 77L) */ ((/* 272L, 71L, 78L) */ ((var_1_39) >> (var_1_40))) + (var_1_23))) <= (var_1_13))) {
