...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch113Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch113Amount50
	var_1_15 = var_1_6;


	// From: Req5Batch113Amount50
	...
	// From: Req7Batch113Amount50
	var_1_22 = (var_1_23 - var_1_24);


	// From: Req8Batch113Amount50
	if (var_1_7 > 256.8) {
