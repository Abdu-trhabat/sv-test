...
int property(void) {
	return ((((var_1_2 ? (var_1_1 == ((unsigned short int) ((17222 - var_1_3) + ((min (29916 , var_1_4)) - var_1_5)))) : 1) && ((var_1_2 && (var_1_4 >= (var_1_3 + var_1_1))) ? (var_1_6 == ((signed char) 8)) : 1)) && ((var_1_4 <= (max (var_1_3 , (var_1_5 << var_1_1)))) ? (var_1_7 == ((signed long int) (min ((var_1_5 - var_1_3) , var_1_4)))) : (var_1_7 == ((signed long int) (var_1_5 + (var_1_1 + var_1_4)))))) && (var_1_8 == ((double) (var_1_9 + var_1_10)))) && ((var_1_7 > ((var_1_4 * var_1_3) + var_1_5)) ? (var_1_11 == ((double) (min (var_1_10 , (var_1_13 - var_1_14))))) : 1)
;
}
int main(void) {
	isInitial = 1;
