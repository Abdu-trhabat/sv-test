...
void step(void) {
 ...
 if (stepLocal_0 >= ((signed_short_int_Array_0[1][0] - signed_short_int_Array_0[0][0]) - signed_short_int_Array_0[1][1])) {
  if (double_Array_0[1][2] == ((((double_Array_0[0][2]) > ((- double_Array_0[1][1]))) ? (double_Array_0[0][2]) : ((- double_Array_0[1][1]))))) {
 ...
 if (signed_short_int_Array_0[1][1] > signed_long_int_Array_0[0]) {
  if (BOOL_unsigned_char_Array_0[0]) {
   double_Array_0[0][1] = (((((double_Array_0[0][0]) < 0 ) ? -(double_Array_0[0][0]) : (double_Array_0[0][0]))) - double_Array_0[1][0]);
  } else {
