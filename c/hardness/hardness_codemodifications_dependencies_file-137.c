...
void step(void) {
	// From: Req1Batch137dependencies
	if (var_1_2 >= var_1_3) {
		var_1_1 = (min ((var_1_4 + (var_1_5 - var_1_6)) , var_1_7));
	}


	// From: Req4Batch137dependencies
	var_1_14 = (min (var_1_6 , var_1_5));


	// From: Req7Batch137dependencies
	var_1_22 = var_1_4;


	// From: Req8Batch137dependencies
	var_1_23 = var_1_13;


	// From: Req9Batch137dependencies
	var_1_24 = var_1_7;


	// From: Req3Batch137dependencies
	if ((2.75f >= var_1_23) && ((var_1_6 - var_1_5) > (var_1_7 * var_1_4))) {
		var_1_11 = var_1_13;
	}


	// From: Req5Batch137dependencies
	if (128.8f != (1.6f * var_1_11)) {
		var_1_15 = ((var_1_16 + (max (var_1_17 , 4))) + (min (var_1_5 , var_1_4)));
	}


	// From: Req6Batch137dependencies
	...
	// From: Req2Batch137dependencies
	if (var_1_5 > (min (var_1_7 , var_1_24))) {
