...
void step(void) {
	...
	if ((((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))) * last_1_double_Array_0_0__0_) <= last_1_double_Array_0_0__0_) {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer)) = (abs ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer))));
	} else {
	...
	if (stepLocal_1 <= (abs ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer))))) {
	...
	if ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer)) < ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer)) & ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) - (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer))))) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) = (min ((((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) - 128) - 2) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))));
	} else {
