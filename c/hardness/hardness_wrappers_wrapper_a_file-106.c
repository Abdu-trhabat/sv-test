...
void step(void) {
	// From: Req1Batch106Wrapper_A
	signed_long_int_Array_0[2] = signed_long_int_Array_0[1];


	// From: Req2Batch106Wrapper_A
	...
	if (! BOOL_unsigned_char_Array_0[1]) {
		if (stepLocal_0 >= signed_long_int_Array_0[2]) {
			...
			if (stepLocal_1 <= signed_long_int_Array_0[1]) {
				float_Array_0[4] = (min ((min (float_Array_0[2] , float_Array_0[3])) , float_Array_0[1]));
			}
		}
	} else {
	...
	// From: Req3Batch106Wrapper_A
	signed long int stepLocal_3 = (max (signed_char_Array_0[0] , signed_char_Array_0[1])) >> signed_long_int_Array_0[0];
