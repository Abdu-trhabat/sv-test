...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch135100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch135100_1loop
	if (var_1_18) {
		var_1_31 = (min (var_1_11 , (var_1_13 + 64.4)));
	}


	// From: Req10Batch135100_1loop
	if ((max (var_1_31 , (var_1_31 / var_1_26))) >= (- var_1_11)) {
		var_1_25 = ((min (2 , (max (var_1_8 , var_1_27)))) + var_1_28);
	} else {
		var_1_25 = (var_1_28 + (max (var_1_27 , (var_1_29 + var_1_30))));
	}


	// From: Req5Batch135100_1loop
	if ((~ var_1_8) < var_1_25) {
		var_1_15 = (max (var_1_13 , var_1_11));
	}


	// From: Req4Batch135100_1loop
	var_1_14 = (abs (var_1_9));


	// From: Req13Batch135100_1loop
	var_1_36 = var_1_9;


	// From: Req6Batch135100_1loop
	if (((var_1_31 > var_1_15) && var_1_18) || var_1_18) {
		var_1_16 = (var_1_9 + var_1_8);
	}


	// From: Req3Batch135100_1loop
	...
	// From: Req12Batch135100_1loop
	if ((var_1_1 >> var_1_33) != var_1_9) {
		if ((max ((var_1_12 * var_1_31) , (var_1_34 - var_1_35))) >= var_1_10) {
			if ((abs (var_1_27)) > var_1_8) {
				var_1_32 = (min ((var_1_28 + (max (var_1_27 , var_1_33))) , var_1_14));
			} else {
				var_1_32 = var_1_28;
			}
		}
...
int property(void) {
	return (((((((((((((last_1_var_1_22 != last_1_var_1_32) ? (var_1_1 == ((unsigned long int) var_1_5)) : (((50.6f + 199.5f) >= last_1_var_1_31) ? (var_1_1 == ((unsigned long int) (abs (var_1_5)))) : 1)) && (((128 - var_1_8) == var_1_16) ? (var_1_7 == ((signed long int) ((1176345877 - var_1_8) - var_1_9))) : (var_1_7 == ((signed long int) (var_1_8 - (abs (var_1_22))))))) && ((var_1_14 <= -10) ? (var_1_10 == ((float) var_1_11)) : ((var_1_36 > var_1_9) ? (var_1_18 ? (var_1_10 == ((float) (abs (var_1_11)))) : 1) : (var_1_10 == ((float) (var_1_12 + var_1_13)))))) && (var_1_14 == ((signed long int) (abs (var_1_9))))) && (((~ var_1_8) < var_1_25) ? (var_1_15 == ((double) (max (var_1_13 , var_1_11)))) : 1)) && ((((var_1_31 > var_1_15) && var_1_18) || var_1_18) ? (var_1_16 == ((unsigned long int) (var_1_9 + var_1_8))) : 1)) && ((last_1_var_1_16 > last_1_var_1_24) ? ((var_1_17 && (var_1_13 >= last_1_var_1_31)) ? (var_1_18 == ((unsigned char) (var_1_20 || var_1_21))) : 1) : 1)) && (var_1_18 ? (((var_1_1 / var_1_23) > var_1_14) ? (var_1_22 == ((signed long int) (abs (var_1_16)))) : ((var_1_18 || var_1_21) ? (var_1_22 == ((signed long int) 1)) : 1)) : (var_1_22 == ((signed long int) -5)))) && (var_1_18 ? ((var_1_22 != (var_1_8 - var_1_9)) ? (var_1_24 == ((signed long int) (var_1_8 - var_1_9))) : (var_1_24 == ((signed long int) last_1_var_1_24))) : (var_1_24 == ((signed long int) var_1_8)))) && (((max (var_1_31 , (var_1_31 / var_1_26))) >= (- var_1_11)) ? (var_1_25 == ((unsigned char) ((min (2 , (max (var_1_8 , var_1_27)))) + var_1_28))) : (var_1_25 == ((unsigned char) (var_1_28 + (max (var_1_27 , (var_1_29 + var_1_30)))))))) && (var_1_18 ? (var_1_31 == ((double) (min (var_1_11 , (var_1_13 + 64.4))))) : 1)) && (((var_1_1 >> var_1_33) != var_1_9) ? (((max ((var_1_12 * var_1_31) , (var_1_34 - var_1_35))) >= var_1_10) ? (((abs (var_1_27)) > var_1_8) ? (var_1_32 == ((unsigned long int) (min ((var_1_28 + (max (var_1_27 , var_1_33))) , var_1_14)))) : (var_1_32 == ((unsigned long int) var_1_28))) : 1) : (var_1_32 == ((unsigned long int) var_1_27)))) && (var_1_36 == ((unsigned long int) var_1_9))
;
}
int main(void) {
	isInitial = 1;
