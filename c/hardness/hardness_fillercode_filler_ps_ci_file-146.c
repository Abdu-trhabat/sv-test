...
void step(void) {
	// From: CodeObject1
	/* 282L, 67L) */ if (/* 283L, 54L, 55L) */ ((var_1_25) <= (var_1_14))) {
		/* 286L, 66L) */ var_1_26 = (
			/* 289L, 65L) */ (min (
				/* 289L, 65L) */ (
					var_1_29
	...
	/* 312L, 101L) */ if (/* 313L, 73L, 74L) */ ((var_1_30) >= (var_1_29))) {
		/* 316L, 99L) */ if (/* 317L, 83L, 84L) */ ((var_1_7) >= (/* 319L, 82L, 86L) */ (abs (var_1_7))))) {
			/* 321L, 98L) */ var_1_31 = (
				/* 324L, 97L) */ (abs (
					/* 325L, 96L) */ ((
						var_1_17
	...
	// From: CodeObject3
	/* 328L, 130L) */ if (var_1_3) {
		/* 330L, 128L) */ if (/* 331L, 115L, 116L) */ ((/* 332L, 113L, 117L) */ (~ (var_1_21))) >= (var_1_21))) {
			/* 335L, 127L) */ var_1_33 = (
				var_1_36
			);
		}
	...
	/* 344L, 172L) */ if (var_1_2) {
		/* 346L, 170L) */ if (/* 347L, 146L, 147L) */ (! (var_1_3))) {
			/* 349L, 156L) */ var_1_39 = (
				/* 352L, 155L) */ ((
					var_1_40
				) + (
	...
	/* 386L, 270L) */ if (var_1_2) {
		/* 388L, 250L) */ if (/* 389L, 215L, 216L) */ ((var_1_45) < (var_1_14))) {
			/* 392L, 248L) */ if (/* 393L, 226L, 227L) */ ((var_1_38) != (/* 395L, 225L, 229L) */ (min (/* 395L, 225L, 229L) */ (var_1_31) , (var_1_20)))))) {
				/* 398L, 243L) */ var_1_50 = (
					/* 401L, 242L) */ (min (
						/* 401L, 242L) */ (
							var_1_7
	...
	// From: Req8Batch146Filler_PS_CI
	/* 1210L, 283L, 991L, 997L) */ var_1_25 = (
		var_1_21
	);


	// From: Req6Batch146Filler_PS_CI
