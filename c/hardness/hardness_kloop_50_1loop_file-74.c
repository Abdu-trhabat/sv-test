...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch7450_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch7450_1loop
	var_1_22 = 8.625;


	// From: Req7Batch7450_1loop
	var_1_23 = var_1_24;


	// From: Req8Batch7450_1loop
	var_1_25 = -4;


	// From: Req4Batch7450_1loop
	if ((- (max (var_1_22 , var_1_23))) == 32.2f) {
		var_1_16 = 10;
	}


	// From: Req5Batch7450_1loop
	if (var_1_8 && var_1_9) {
