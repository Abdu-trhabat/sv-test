...
void step(void) {
 ...
 if (stepLocal_1 > unsigned_long_int_Array_0[0]) {
  if (stepLocal_4 > unsigned_long_int_Array_0[1]) {
   ...
   unsigned_char_Array_0[1][1] = ((((unsigned_char_Array_0[1][0]) > (unsigned_char_Array_0[0][0])) ? (unsigned_char_Array_0[1][0]) : (unsigned_char_Array_0[0][0])));
  }
 } else {
 ...
 if ((unsigned_char_Array_0[0][1] != ((((unsigned_char_Array_0[1][1]) < (64)) ? (unsigned_char_Array_0[1][1]) : (64)))) || stepLocal_0) {
