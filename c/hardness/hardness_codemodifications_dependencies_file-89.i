...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch89dependencies.c", 13, "reach_error"); }
...
void step(void) {
 if ((((((var_1_15) < (1.75f)) ? (var_1_15) : (1.75f))) / ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) != var_1_17) {
  var_1_14 = ((((((((var_1_18) > (var_1_19)) ? (var_1_18) : (var_1_19)))) < (var_1_20)) ? (((((var_1_18) > (var_1_19)) ? (var_1_18) : (var_1_19)))) : (var_1_20)));
 } else {
  var_1_14 = var_1_21;
 }
...
int property(void) {
 return (((((((last_1_var_1_1 != var_1_3) ? (var_1_22 ? (var_1_1 == ((signed long int) ((((((((-5) > (var_1_5)) ? (-5) : (var_1_5)))) < (((((var_1_6) < (var_1_7)) ? (var_1_6) : (var_1_7))))) ? (((((-5) > (var_1_5)) ? (-5) : (var_1_5)))) : (((((var_1_6) < (var_1_7)) ? (var_1_6) : (var_1_7)))))))) : 1) : 1) && ((var_1_6 >= (var_1_5 / var_1_9)) ? ((var_1_1 < (var_1_1 * 256)) ? (var_1_8 == ((unsigned short int) ((((var_1_10) < (((((128) < (var_1_11)) ? (128) : (var_1_11))))) ? (var_1_10) : (((((128) < (var_1_11)) ? (128) : (var_1_11)))))))) : (var_1_8 == ((unsigned short int) var_1_11))) : (var_1_8 == ((unsigned short int) var_1_10)))) && ((var_1_10 < var_1_25) ? ((var_1_25 <= (5 - var_1_1)) ? (var_1_12 == ((unsigned char) var_1_13)) : ((var_1_25 == var_1_6) ? (var_1_12 == ((unsigned char) var_1_13)) : (var_1_12 == ((unsigned char) 4)))) : 1)) && (((((((var_1_15) < (1.75f)) ? (var_1_15) : (1.75f))) / ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))) != var_1_17) ? (var_1_14 == ((float) ((((((((var_1_18) > (var_1_19)) ? (var_1_18) : (var_1_19)))) < (var_1_20)) ? (((((var_1_18) > (var_1_19)) ? (var_1_18) : (var_1_19)))) : (var_1_20))))) : (var_1_14 == ((float) var_1_21)))) && (var_1_22 == ((unsigned char) (var_1_23 && var_1_24)))) && (var_1_24 ? (var_1_25 == ((unsigned long int) (2957161658u - (var_1_8 + var_1_10)))) : (var_1_25 == ((unsigned long int) ((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11))))))) && ((var_1_1 < ((var_1_8 ^ var_1_25) | var_1_7)) ? (var_1_23 ? (var_1_26 == ((unsigned short int) var_1_10)) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
