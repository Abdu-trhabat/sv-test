...
void step(void) {
	// From: Req1Batch138Wrapper_A
	signed char stepLocal_0 = signed_char_Array_0[1][1];
	if (stepLocal_0 >= signed_char_Array_0[0][1]) {
		unsigned_short_int_Array_0[1][1] = (max (unsigned_short_int_Array_0[0][1] , (unsigned_short_int_Array_0[1][0] - (max (100 , unsigned_short_int_Array_0[0][0])))));
	} else {
		unsigned_short_int_Array_0[1][1] = unsigned_short_int_Array_0[0][1];
	}


	// From: Req3Batch138Wrapper_A
	...
	if (-128 >= stepLocal_1) {
		if (stepLocal_2 && BOOL_unsigned_char_Array_0[0]) {
			...
			float_Array_0[0] = (abs (float_Array_0[3] - (float_Array_0[4] + float_Array_0[1])));
		}
	} else {
