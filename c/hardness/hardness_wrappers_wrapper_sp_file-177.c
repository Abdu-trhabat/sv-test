...
void step(void) {
	// From: Req1Batch177Wrapper_SP
	signed long int stepLocal_2 = min (5 , ((*(WrapperStruct00_var_1_2_Pointer)) * (*(WrapperStruct00_var_1_3_Pointer))));
	...
	if (stepLocal_2 <= (*(WrapperStruct00_var_1_4_Pointer))) {
		if ((*(WrapperStruct00_var_1_2_Pointer)) > stepLocal_0) {
			if ((- (*(WrapperStruct00_var_1_4_Pointer))) == stepLocal_1) {
				(*(WrapperStruct00_var_1_1_Pointer)) = (max (((*(WrapperStruct00_var_1_5_Pointer)) - (*(WrapperStruct00_var_1_6_Pointer))) , (*(WrapperStruct00_var_1_7_Pointer))));
			}
		}
	} else {
