...
void step(void) {
	...
	// From: Req2Batch92normal
	if (((abs (var_1_10)) >> var_1_13) >= (max (var_1_1 , var_1_9))) {
		var_1_12 = var_1_8;
	}


	// From: Req3Batch92normal
	...
	// From: Req6Batch92normal
	var_1_23 = var_1_13;


	// From: Req7Batch92normal
	var_1_24 = var_1_8;


	// From: Req8Batch92normal
	var_1_25 = var_1_22;
}
