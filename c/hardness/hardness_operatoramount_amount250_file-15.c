...
void step(void) {
	...
	if (last_1_var_1_27) {
		if (((var_1_3 / 1) / var_1_6) == stepLocal_0) {
			...
			if (last_1_var_1_16) {
				if ((last_1_var_1_33 / (min (var_1_6 , var_1_7))) != stepLocal_1) {
	...
	if (var_1_10 < (var_1_9 - (var_1_36 + var_1_39))) {
		if (stepLocal_14 <= var_1_25) {
			...
			if (stepLocal_13 || (! (var_1_10 >= last_1_var_1_5))) {
				var_1_38 = (last_1_var_1_43 - ((var_1_40 + var_1_41) - (max (var_1_29 , last_1_var_1_45))));
			}
		}
	} else {
		if (var_1_9 <= var_1_39) {
			var_1_38 = (min (((var_1_41 - last_1_var_1_43) + var_1_40) , ((last_1_var_1_32 + last_1_var_1_45) + var_1_4)));
		} else {
			if ((max ((var_1_36 + 1.15f) , var_1_37)) == 63.5f) {
				var_1_38 = (min ((var_1_15 - var_1_29) , last_1_var_1_23));
			} else {
				var_1_38 = (max ((abs (abs (-5))) , (var_1_15 - (var_1_41 + last_1_var_1_32))));
			}
		}
	}
	...
	if (var_1_3 != stepLocal_8) {
		var_1_23 = (max ((abs (last_1_var_1_19)) , var_1_4));
	} else {
		var_1_23 = (((max (var_1_24 , var_1_25)) + var_1_26) - (var_1_4 + last_1_var_1_33));
	}
	...
	if (stepLocal_17 != (max (var_1_26 , var_1_47))) {
		if (stepLocal_18 < var_1_23) {
			var_1_48 = (min ((var_1_46 - var_1_4) , var_1_49));
		} else {
			var_1_48 = var_1_49;
		}
	}
	...
	if (var_1_10 < (min (var_1_8 , (-0.25 * var_1_9)))) {
		if (stepLocal_7 <= last_1_var_1_22) {
			var_1_22 = (min (var_1_4 , (max (var_1_23 , var_1_3))));
		} else {
			var_1_22 = (min (var_1_23 , var_1_4));
		}
	}
	...
	if (stepLocal_16 < var_1_32) {
		if (stepLocal_15 <= (var_1_7 + var_1_41)) {
			...
			var_1_45 = (max ((var_1_46 - var_1_3) , var_1_47));
		}
	}
	...
	if ((var_1_6 < var_1_7) || stepLocal_5) {
		...
		if (var_1_31) {
			if (((var_1_48 / var_1_7) & (abs (var_1_3))) >= stepLocal_4) {
	...
	signed long int stepLocal_19 = max ((var_1_4 - var_1_51) , 2);
	...
	signed long int stepLocal_10 = var_1_29 - (max (var_1_3 , var_1_4));
...
int property(void) {
	return ((((((((((((((((((((var_1_21 ? (var_1_1 == ((unsigned char) ((var_1_3 + var_1_4) + 8))) : 1) && (last_1_var_1_27 ? ((((var_1_3 / 1) / var_1_6) == ((last_1_var_1_33 * var_1_4) % var_1_7)) ? (var_1_5 == ((double) (max ((var_1_8 - (var_1_9 + 8.2)) , (var_1_10 + (var_1_11 + var_1_12)))))) : (last_1_var_1_16 ? (((last_1_var_1_33 / (min (var_1_6 , var_1_7))) != var_1_4) ? (var_1_5 == ((double) (var_1_8 - (abs (var_1_10))))) : (var_1_5 == ((double) var_1_11))) : (var_1_5 == ((double) var_1_10)))) : (var_1_5 == ((double) 7.875)))) && (((var_1_48 != var_1_3) || (var_1_8 < var_1_11)) ? (var_1_14 == ((signed char) (var_1_15 - var_1_4))) : 1)) && ((! (var_1_6 >= 50)) ? ((((~ var_1_4) * (var_1_3 / var_1_7)) <= (last_1_var_1_48 + last_1_var_1_19)) ? (var_1_16 == ((unsigned char) ((! var_1_17) || (last_1_var_1_27 && var_1_18)))) : 1) : (var_1_16 == ((unsigned char) (! var_1_18))))) && ((var_1_12 > var_1_8) ? (var_1_21 ? (var_1_19 == ((unsigned short int) (min (var_1_4 , var_1_3)))) : (var_1_19 == ((unsigned short int) var_1_4))) : 1)) && (((var_1_6 < var_1_7) || var_1_31) ? (var_1_20 == ((signed char) (max (var_1_4 , var_1_3)))) : (var_1_31 ? ((((var_1_48 / var_1_7) & (abs (var_1_3))) >= ((var_1_32 + var_1_4) * var_1_15)) ? (var_1_20 == ((signed char) (max (var_1_15 , var_1_4)))) : (var_1_20 == ((signed char) (var_1_4 - var_1_3)))) : (var_1_17 ? (var_1_20 == ((signed char) var_1_4)) : 1)))) && ((var_1_16 || (var_1_48 <= (16 - var_1_4))) ? (var_1_21 == ((unsigned char) (var_1_16 && var_1_18))) : 1)) && ((var_1_10 < (min (var_1_8 , (-0.25 * var_1_9)))) ? ((var_1_23 <= last_1_var_1_22) ? (var_1_22 == ((unsigned short int) (min (var_1_4 , (max (var_1_23 , var_1_3)))))) : (var_1_22 == ((unsigned short int) (min (var_1_23 , var_1_4))))) : 1)) && ((var_1_3 != last_1_var_1_19) ? (var_1_23 == ((unsigned long int) (max ((abs (last_1_var_1_19)) , var_1_4)))) : (var_1_23 == ((unsigned long int) (((max (var_1_24 , var_1_25)) + var_1_26) - (var_1_4 + last_1_var_1_33)))))) && ((((var_1_3 - var_1_4) / var_1_6) < var_1_24) ? ((var_1_26 != var_1_38) ? (((var_1_29 - (max (var_1_3 , var_1_4))) > var_1_6) ? (var_1_27 == ((unsigned char) (var_1_16 || var_1_17))) : (var_1_27 == ((unsigned char) (((var_1_5 < var_1_10) && var_1_18) || (var_1_21 && var_1_30))))) : (var_1_27 == ((unsigned char) (var_1_17 && (! (var_1_18 || var_1_30)))))) : 1)) && ((! var_1_16) ? (var_1_31 == ((unsigned char) ((16.375f >= (7.25f * var_1_8)) || var_1_17))) : 1)) && ((var_1_10 < (- (- var_1_8))) ? ((var_1_23 > var_1_25) ? (var_1_32 == ((unsigned long int) var_1_19)) : (var_1_32 == ((unsigned long int) var_1_24))) : 1)) && ((var_1_8 < last_1_var_1_42) ? (var_1_33 == ((unsigned long int) var_1_25)) : ((last_1_var_1_38 > last_1_var_1_48) ? (var_1_33 == ((unsigned long int) (var_1_34 - var_1_4))) : 1))) && ((1.875f >= var_1_12) ? (var_1_35 == ((float) ((var_1_12 + var_1_11) + (var_1_9 - var_1_36)))) : (var_1_31 ? (var_1_35 == ((float) (var_1_9 - (min (31.6f , var_1_37))))) : 1))) && ((var_1_10 < (var_1_9 - (var_1_36 + var_1_39))) ? ((var_1_7 <= var_1_25) ? (last_1_var_1_21 ? ((var_1_12 < var_1_37) ? (var_1_38 == ((signed long int) last_1_var_1_32)) : 1) : 1) : (((8.5f == (var_1_11 * var_1_37)) || (! (var_1_10 >= last_1_var_1_5))) ? (var_1_38 == ((signed long int) (last_1_var_1_43 - ((var_1_40 + var_1_41) - (max (var_1_29 , last_1_var_1_45)))))) : 1)) : ((var_1_9 <= var_1_39) ? (var_1_38 == ((signed long int) (min (((var_1_41 - last_1_var_1_43) + var_1_40) , ((last_1_var_1_32 + last_1_var_1_45) + var_1_4))))) : (((max ((var_1_36 + 1.15f) , var_1_37)) == 63.5f) ? (var_1_38 == ((signed long int) (min ((var_1_15 - var_1_29) , last_1_var_1_23)))) : (var_1_38 == ((signed long int) (max ((abs (abs (-5))) , (var_1_15 - (var_1_41 + last_1_var_1_32)))))))))) && ((((var_1_25 * var_1_6) + var_1_33) >= var_1_23) ? (var_1_42 == ((double) (var_1_10 + var_1_36))) : ((var_1_7 == var_1_33) ? (var_1_42 == ((double) ((var_1_12 + 128.75) + var_1_9))) : (var_1_42 == ((double) (var_1_36 + var_1_10)))))) && (var_1_16 ? (var_1_43 == ((signed long int) (var_1_4 - (var_1_38 + var_1_33)))) : 1)) && (((var_1_40 % (36410 - var_1_29)) >= var_1_38) ? (var_1_44 == ((unsigned char) (! var_1_17))) : 1)) && (((64 * var_1_40) < var_1_32) ? (((var_1_34 - (var_1_32 + var_1_3)) <= (var_1_7 + var_1_41)) ? (var_1_45 == ((unsigned short int) (var_1_46 - var_1_29))) : (var_1_45 == ((unsigned short int) (max ((var_1_46 - var_1_3) , var_1_47))))) : 1)) && ((var_1_46 != (max (var_1_26 , var_1_47))) ? ((var_1_15 < var_1_23) ? (var_1_48 == ((unsigned short int) (min ((var_1_46 - var_1_4) , var_1_49)))) : (var_1_48 == ((unsigned short int) var_1_49))) : 1)) && (((- var_1_32) >= (max ((var_1_4 - var_1_51) , 2))) ? (var_1_50 == ((signed char) (max ((max (-1 , var_1_4)) , (var_1_52 + var_1_53))))) : (var_1_50 == ((signed char) var_1_15)))
;
}
int main(void) {
	isInitial = 1;
