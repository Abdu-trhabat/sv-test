...
void step(void) {
 ...
 unsigned long int stepLocal_2 = ((((var_1_4 / var_1_8)) > (var_1_6)) ? ((var_1_4 / var_1_8)) : (var_1_6));
 ...
 if (var_1_2 <= var_1_5) {
  if (! var_1_15) {
   var_1_10 = ((((var_1_11) < ((var_1_12 + 2))) ? (var_1_11) : ((var_1_12 + 2))));
  } else {
   var_1_10 = ((((((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) < (var_1_11)) ? (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) : (var_1_11)));
  }
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((((var_1_2 + var_1_3) - (var_1_4 + var_1_5)) == (- (- var_1_6))) ? ((var_1_3 != var_1_2) ? (var_1_1 == ((signed long int) var_1_4)) : 1) : (var_1_1 == ((signed long int) var_1_5))) && ((var_1_3 <= (((((var_1_4 / var_1_8)) > (var_1_6)) ? ((var_1_4 / var_1_8)) : (var_1_6)))) ? (var_1_7 == ((unsigned char) (! var_1_9))) : (var_1_7 == ((unsigned char) 0)))) && ((var_1_2 <= var_1_5) ? ((! var_1_15) ? (var_1_10 == ((signed short int) ((((var_1_11) < ((var_1_12 + 2))) ? (var_1_11) : ((var_1_12 + 2)))))) : (var_1_10 == ((signed short int) ((((((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) < (var_1_11)) ? (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) : (var_1_11)))))) : 1)) && (var_1_13 == ((unsigned char) var_1_14))) && (var_1_15 == ((unsigned char) var_1_16))
;
}
int main(void) {
 isInitial = 1;
