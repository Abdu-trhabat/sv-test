...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch53normal.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_1) {
  var_1_14 = ((((var_1_20) > (var_1_16)) ? (var_1_20) : (var_1_16)));
 } else {
...
int property(void) {
 return (((((((((last_1_var_1_9 * last_1_var_1_14) == last_1_var_1_9) ? (((last_1_var_1_9 > (var_1_5 - var_1_6)) && last_1_var_1_1) ? (var_1_1 == ((unsigned char) var_1_8)) : 1) : 1) && (((last_1_var_1_1 || (var_1_6 <= last_1_var_1_23)) || (last_1_var_1_20 != var_1_4)) ? ((((((var_1_6) < (0)) ? (var_1_6) : (0))) <= (-5 + var_1_5)) ? (var_1_9 == ((unsigned long int) var_1_6)) : 1) : 1)) && (((! var_1_1) || var_1_8) ? (var_1_10 == ((float) (((((var_1_11 + var_1_12)) < (((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13))))) ? ((var_1_11 + var_1_12)) : (((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))))))) : (((var_1_11 < var_1_12) || (var_1_9 != var_1_6)) ? (var_1_10 == ((float) var_1_13)) : (var_1_10 == ((float) var_1_12))))) && (var_1_1 ? (var_1_14 == ((signed short int) ((((var_1_20) > (var_1_16)) ? (var_1_20) : (var_1_16))))) : ((((var_1_9 / var_1_15) & var_1_6) >= var_1_9) ? (var_1_14 == ((signed short int) var_1_16)) : (var_1_14 == ((signed short int) -128))))) && (((((((var_1_15) > (var_1_9)) ? (var_1_15) : (var_1_9))) / var_1_17) <= (256u << var_1_20)) ? (var_1_16 == ((unsigned char) ((((var_1_18) > (var_1_19)) ? (var_1_18) : (var_1_19))))) : 1)) && (var_1_20 == ((signed char) var_1_21))) && (var_1_22 == ((float) var_1_12))) && (var_1_23 == ((signed char) var_1_21))
;
}
int main(void) {
 isInitial = 1;
