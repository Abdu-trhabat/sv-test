...
void step(void) {
	...
	// From: CodeObject7
	/* 348L, 205L) */ if (/* 349L, 188L, 189L) */ ((var_1_26) >= (/* 351L, 187L, 191L) */ ((8) % (var_1_40))))) {
		/* 354L, 204L) */ var_1_43 = (
			/* 357L, 203L) */ (min (
				/* 357L, 203L) */ (
					100.25f
	...
	/* 268L, 68L) */ if (/* 269L, 32L, 33L) */ ((var_1_29) > (var_1_27))) {
		/* 272L, 66L) */ if (/* 273L, 42L, 43L) */ ((var_1_7) < (/* 275L, 41L, 45L) */ (abs (var_1_30))))) {
