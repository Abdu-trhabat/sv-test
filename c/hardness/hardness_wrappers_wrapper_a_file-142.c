...
void step(void) {
	...
	// From: Req2Batch142Wrapper_A
	if ((unsigned_short_int_Array_0[1] - unsigned_short_int_Array_0[0]) <= 0) {
		double_Array_0[1][1][1] = (abs (double_Array_0[1][0][0]));
	}


	// From: Req3Batch142Wrapper_A
	...
	if (stepLocal_0 && BOOL_unsigned_char_Array_0[0]) {
		...
		signed_short_int_Array_0[1] = (min (signed_short_int_Array_0[0] , signed_short_int_Array_0[2]));
	}


	// From: Req4Batch142Wrapper_A
	unsigned long int stepLocal_1 = unsigned_long_int_Array_0[1];
	if (stepLocal_1 == (max (unsigned_short_int_Array_0[1] , signed_long_int_Array_0[0]))) {
