...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_10_Pointer)) || stepLocal_0) {
		...
		(*(WrapperStruct00_var_1_9_Pointer)) = ((*(WrapperStruct00_var_1_13_Pointer)) + (abs ((*(WrapperStruct00_var_1_12_Pointer)))));
	}
