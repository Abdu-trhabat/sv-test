...
void step(void) {
	...
	if ((WrapperStruct00.var_1_1 * WrapperStruct00.var_1_3) <= WrapperStruct00.var_1_4) {
		if ((WrapperStruct00.var_1_9 - (abs (-1))) <= (WrapperStruct00.var_1_1 * WrapperStruct00.var_1_8)) {
