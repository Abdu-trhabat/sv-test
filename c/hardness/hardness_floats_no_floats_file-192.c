...
void step(void) {
	...
	// From: Req4Batch192no_floats
	var_1_18 = 500;


	// From: Req5Batch192no_floats
	var_1_19 = var_1_3;


	// From: Req6Batch192no_floats
	var_1_20 = var_1_3;


	// From: Req1Batch192no_floats
	if (var_1_20 > (var_1_3 - var_1_4)) {
		var_1_1 = (max (var_1_5 , (var_1_6 - 5)));
	} else {
		var_1_1 = ((max ((max (var_1_7 , var_1_8)) , var_1_9)) + var_1_10);
	}


	// From: Req3Batch192no_floats
...
int property(void) {
	return ((((((var_1_20 > (var_1_3 - var_1_4)) ? (var_1_1 == ((signed long int) (max (var_1_5 , (var_1_6 - 5))))) : (var_1_1 == ((signed long int) ((max ((max (var_1_7 , var_1_8)) , var_1_9)) + var_1_10)))) && (var_1_12 ? (var_1_11 == ((signed long int) (var_1_7 + (var_1_13 - var_1_14)))) : ((var_1_9 <= var_1_10) ? (var_1_11 == ((signed long int) var_1_10)) : 1))) && (((var_1_4 / (max (var_1_3 , var_1_16))) < (var_1_18 * var_1_17)) ? ((((max (var_1_17 , -5)) < var_1_3) || var_1_12) ? (var_1_15 == ((signed char) 32)) : 1) : 1)) && (var_1_18 == ((unsigned short int) 500))) && (var_1_19 == ((unsigned long int) var_1_3))) && (var_1_20 == ((signed long int) var_1_3))
;
}
int main(void) {
	isInitial = 1;
