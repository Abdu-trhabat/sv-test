...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch65Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((max (last_1_var_1_23 , var_1_5)) | var_1_6) >= var_1_8) {
		var_1_23 = (5 - var_1_12);
	} else {
		var_1_23 = (max (var_1_11 , var_1_1));
	}
	...
	if (stepLocal_2 < var_1_23) {
		if ((! (var_1_10 || var_1_9)) && stepLocal_3) {
			if ((max (2.75f , (min (var_1_20 , 999999.95f)))) != var_1_20) {
				var_1_16 = 10;
			} else {
				var_1_16 = var_1_19;
			}
...
int property(void) {
	return (((((((((var_1_2 <= var_1_3) || (var_1_4 > 4)) ? (var_1_1 == ((signed short int) (max ((var_1_5 + (var_1_6 + var_1_7)) , -100)))) : (var_1_1 == ((signed short int) var_1_7))) && (last_1_var_1_24 ? (last_1_var_1_24 ? (var_1_8 == ((unsigned short int) (max ((var_1_11 + var_1_12) , var_1_13)))) : 1) : 1)) && ((var_1_5 > (var_1_8 + (var_1_6 ^ var_1_7))) ? (var_1_14 == ((unsigned char) (var_1_24 || var_1_15))) : 1)) && ((var_1_1 < var_1_23) ? (((! (var_1_10 || var_1_9)) && var_1_14) ? (((max (2.75f , (min (var_1_20 , 999999.95f)))) != var_1_20) ? (var_1_16 == ((signed char) 10)) : (var_1_16 == ((signed char) var_1_19))) : (var_1_16 == ((signed char) var_1_19))) : (var_1_16 == ((signed char) 100)))) && (var_1_20 == ((double) (var_1_21 - (var_1_22 + 1.5))))) && ((((max (last_1_var_1_23 , var_1_5)) | var_1_6) >= var_1_8) ? (var_1_23 == ((signed long int) (5 - var_1_12))) : (var_1_23 == ((signed long int) (max (var_1_11 , var_1_1)))))) && (var_1_24 == ((unsigned char) ((last_1_var_1_16 <= (var_1_25 - var_1_26)) && var_1_27)))) && (var_1_28 == ((double) var_1_21))
;
}
int main(void) {
	isInitial = 1;
