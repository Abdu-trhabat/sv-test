...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch144has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch144has_floats
	if (var_1_5 || var_1_6) {
		var_1_16 = (! var_1_17);
	}


	// From: Req5Batch144has_floats
	var_1_18 = var_1_11;


	// From: Req3Batch144has_floats
...
int property(void) {
	return (((((var_1_2 < var_1_3) ? (var_1_1 == ((unsigned char) ((var_1_4 || var_1_5) || (var_1_6 || var_1_7)))) : (var_1_1 == ((unsigned char) (! var_1_7)))) && ((var_1_12 == (abs (var_1_9))) ? ((-32 > (var_1_12 % var_1_10)) ? (var_1_8 == ((double) var_1_11)) : (var_1_8 == ((double) -32.0))) : 1)) && ((var_1_18 < var_1_11) ? (var_1_12 == ((signed char) (var_1_13 - (min (var_1_14 , (abs (var_1_15))))))) : (var_1_12 == ((signed char) (min ((min (var_1_13 , var_1_15)) , var_1_14)))))) && ((var_1_5 || var_1_6) ? (var_1_16 == ((unsigned char) (! var_1_17))) : 1)) && (var_1_18 == ((double) var_1_11))
;
}
int main(void) {
	isInitial = 1;
