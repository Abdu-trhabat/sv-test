...
void step(void) {
	...
	if (((var_1_33 / var_1_42) | (var_1_46 - var_1_36)) >= stepLocal_3) {
		if ((var_1_21 + (var_1_26 ^ var_1_41)) >= stepLocal_4) {
			var_1_45 = (max ((abs (max (var_1_39 , 5))) , (var_1_41 - last_1_var_1_89)));
		} else {
			var_1_45 = var_1_32;
		}
	} else {
	...
	// From: Req3Batch129Amount500
	unsigned long int stepLocal_1 = last_1_var_1_71;
	if (-256 == stepLocal_1) {
		var_1_17 = ((var_1_21 - (var_1_22 + var_1_23)) + (min (var_1_20 , var_1_24)));
	} else {
		var_1_17 = var_1_24;
	}


	// From: Req26Batch129Amount500
	if (var_1_30) {
		var_1_71 = var_1_17;
	} else {
		var_1_71 = var_1_26;
	...
	// From: Req9Batch129Amount500
	var_1_43 = (var_1_3 - (min ((var_1_44 - var_1_15) , var_1_12)));


	// From: Req11Batch129Amount500
	signed long int stepLocal_5 = var_1_26 / (max (var_1_48 , var_1_36));
	if (64 <= stepLocal_5) {
		var_1_47 = (max (var_1_7 , var_1_4));
	} else {
		var_1_47 = (((abs (var_1_10)) + var_1_16) - (min (var_1_3 , var_1_14)));
	}


	// From: Req12Batch129Amount500
	if (((var_1_38 / var_1_39) / var_1_36) > var_1_32) {
		var_1_49 = ((max (25 , var_1_38)) + var_1_39);
	}


	// From: Req16Batch129Amount500
	...
	// From: Req18Batch129Amount500
	var_1_61 = (abs (var_1_54));


	// From: Req19Batch129Amount500
	if ((2.875 - var_1_16) > var_1_47) {
		var_1_62 = ((var_1_37 < var_1_17) || (! var_1_58));
	}


	// From: Req21Batch129Amount500
	unsigned char stepLocal_10 = (min (var_1_39 , var_1_24)) >= var_1_51;
	signed long int stepLocal_9 = var_1_48;
	if (stepLocal_9 < var_1_64) {
		var_1_65 = (var_1_42 - (var_1_41 + (min (var_1_40 , var_1_54))));
	} else {
		if (var_1_30 && stepLocal_10) {
			var_1_65 = (min (var_1_40 , (min (var_1_41 , (max (var_1_36 , var_1_37))))));
		} else {
	...
	// From: Req23Batch129Amount500
	if ((- (var_1_15 * var_1_14)) < var_1_3) {
		var_1_68 = (abs (var_1_15));
	} else {
		var_1_68 = var_1_12;
	}


	// From: Req25Batch129Amount500
	if (var_1_14 < (- 4.425f)) {
	...
	// From: Req35Batch129Amount500
	var_1_88 = (max (128.875f , (var_1_16 - var_1_11)));


	// From: Req42Batch129Amount500
	if (var_1_57) {
		var_1_102 = var_1_10;
	} else {
		var_1_102 = var_1_7;
	...
	// From: Req45Batch129Amount500
	if (var_1_59) {
		var_1_105 = var_1_51;
	}


	// From: Req46Batch129Amount500
	if (var_1_30) {
		var_1_106 = var_1_9;
	} else {
		var_1_106 = var_1_7;
	...
	// From: Req47Batch129Amount500
	if (var_1_56) {
		var_1_107 = var_1_59;
	}


	// From: Req48Batch129Amount500
	var_1_109 = 0;


	// From: Req49Batch129Amount500
	if (var_1_30) {
		var_1_110 = var_1_59;
	} else {
		var_1_110 = var_1_57;
	...
	// From: Req52Batch129Amount500
	var_1_115 = var_1_38;


	// From: Req53Batch129Amount500
	var_1_116 = var_1_59;


	// From: Req38Batch129Amount500
	unsigned short int stepLocal_21 = var_1_49;
	if (stepLocal_21 != ((var_1_37 - var_1_45) / var_1_73)) {
		var_1_93 = (var_1_11 - (var_1_13 + (min (var_1_80 , var_1_12))));
	} else {
		var_1_93 = (15.25f + var_1_10);
	}


	// From: Req5Batch129Amount500
	if (var_1_9 >= (- var_1_12)) {
		if (var_1_16 <= var_1_5) {
			var_1_28 = (var_1_3 - (8.75 + var_1_15));
		} else {
			var_1_28 = (max ((min (2.5 , (var_1_16 + var_1_15))) , ((var_1_13 - 9.275) + (var_1_14 - var_1_12))));
		}
	} else {
		if (var_1_116) {
			var_1_28 = (var_1_14 + (var_1_16 - 256.5));
		} else {
			var_1_28 = (max (var_1_12 , (max (var_1_10 , (49.2 + var_1_14)))));
		}
	}


	// From: Req7Batch129Amount500
	if (var_1_12 <= var_1_4) {
		if (var_1_30) {
	...
	// From: Req22Batch129Amount500
	if ((var_1_13 * var_1_102) < ((var_1_8 * var_1_15) / var_1_44)) {
		var_1_66 = (var_1_37 + (min (var_1_54 , (var_1_41 - var_1_40))));
	} else {
		if (var_1_10 <= 10.4f) {
			var_1_66 = ((abs (var_1_41)) + (var_1_54 - (var_1_40 - var_1_67)));
		} else {
			var_1_66 = (min (var_1_54 , var_1_37));
		}
	}


	// From: Req32Batch129Amount500
	if (var_1_53) {
		var_1_81 = (max ((var_1_27 - (var_1_40 + var_1_46)) , last_1_var_1_81));
	} else {
		var_1_81 = (max ((var_1_33 + var_1_55) , (last_1_var_1_81 + (var_1_38 + var_1_36))));
	}


	// From: Req34Batch129Amount500
	unsigned long int stepLocal_16 = (var_1_71 * var_1_73) / 2;
	if (stepLocal_16 > ((var_1_38 >> var_1_87) * (var_1_71 % var_1_40))) {
		var_1_86 = ((var_1_73 + (min (var_1_31 , var_1_46))) + var_1_54);
	}


	// From: Req44Batch129Amount500
	if (var_1_116) {
		var_1_104 = var_1_46;
	} else {
		var_1_104 = var_1_86;
	...
	if (var_1_20 <= stepLocal_13) {
		if (var_1_81 <= stepLocal_11) {
			var_1_69 = (var_1_8 + (abs (var_1_10)));
		} else {
			if ((min (200 , var_1_32)) <= stepLocal_12) {
				var_1_69 = (min ((var_1_3 - (var_1_44 - var_1_14)) , var_1_11));
			} else {
				var_1_69 = (var_1_15 - var_1_14);
			}
		}
	} else {
		var_1_69 = ((max (var_1_13 , var_1_4)) - var_1_44);
	}


	// From: Req29Batch129Amount500
	if (var_1_52) {
		var_1_75 = ((var_1_51 - (var_1_40 - var_1_54)) - var_1_73);
	}


	// From: Req39Batch129Amount500
	if ((var_1_104 * var_1_27) <= var_1_67) {
		if (var_1_49 < (var_1_67 >> 4)) {
			var_1_94 = (var_1_95 - var_1_54);
		} else {
			var_1_94 = (var_1_67 + (abs (var_1_96 - var_1_97)));
		}
	} else {
	...
	// From: Req50Batch129Amount500
	if (var_1_52) {
		var_1_111 = 64;
	}


	// From: Req51Batch129Amount500
	if ((var_1_27 & (var_1_25 + var_1_32)) <= var_1_104) {
		if ((min (var_1_9 , var_1_10)) < var_1_47) {
			var_1_112 = var_1_30;
		} else {
			var_1_112 = var_1_59;
		}
	...
	// From: Req1Batch129Amount500
	if (! var_1_52) {
		var_1_1 = (max ((var_1_3 - var_1_4) , var_1_5));
	}


	// From: Req6Batch129Amount500
	if (var_1_5 <= (max (var_1_13 , (var_1_10 * var_1_69)))) {
	...
	// From: Req8Batch129Amount500
	if (var_1_12 == (max ((min (var_1_1 , var_1_14)) , var_1_69))) {
		var_1_34 = (((var_1_36 - var_1_37) + var_1_38) - (var_1_39 - (var_1_40 - var_1_41)));
	} else {
		if (var_1_7 <= (var_1_14 / var_1_15)) {
			var_1_34 = (var_1_39 + (min (var_1_41 , 0)));
		} else {
	...
	// From: Req13Batch129Amount500
	unsigned long int stepLocal_6 = var_1_21;
	if (! var_1_52) {
		if (stepLocal_6 >= (var_1_41 / (max (var_1_38 , var_1_26)))) {
			var_1_50 = var_1_38;
		}
	} else {
		if (var_1_15 != var_1_11) {
			if (var_1_4 > var_1_7) {
				var_1_50 = (((max (var_1_51 , 200)) - var_1_41) - (min (var_1_37 , (1 + var_1_40))));
			} else {
				var_1_50 = (min (8 , var_1_38));
			}
		}
	}


	// From: Req20Batch129Amount500
	signed long int stepLocal_8 = var_1_94 % var_1_64;
	if (-4 < stepLocal_8) {
		var_1_63 = (max (var_1_46 , var_1_81));
	}


	// From: Req28Batch129Amount500
	...
	// From: Req40Batch129Amount500
	unsigned char stepLocal_23 = var_1_42;
	unsigned short int stepLocal_22 = var_1_49;
	if (var_1_111 < stepLocal_22) {
		var_1_98 = ((max (var_1_67 , (var_1_100 - var_1_75))) - (max ((var_1_46 + var_1_85) , var_1_81)));
	} else {
		if (stepLocal_23 <= (max (var_1_75 , var_1_49))) {
			var_1_98 = ((min (var_1_75 , var_1_73)) - var_1_51);
		} else {
			var_1_98 = var_1_100;
		}
	}
	...
	// From: Req33Batch129Amount500
	if (var_1_68 <= var_1_80) {
		if (((- var_1_12) * 500.4) <= var_1_102) {
			if (var_1_59) {
				if (var_1_101) {
					var_1_83 = (var_1_37 - ((min (var_1_85 , 1)) + (min (var_1_41 , var_1_67))));
				}
			}
		}
	} else {
		var_1_83 = (abs (var_1_54));
	}


	// From: Req37Batch129Amount500
		...
		if (var_1_23 < stepLocal_19) {
			if (((- var_1_68) >= var_1_6) || stepLocal_18) {
				...
				if (stepLocal_20 < (var_1_82 / var_1_36)) {
					var_1_90 = (min ((var_1_92 - var_1_54) , var_1_21));
				} else {
					var_1_90 = var_1_73;
				}
			}
	...
	// From: Req17Batch129Amount500
	if (var_1_90 <= ((var_1_51 - var_1_36) * (var_1_42 - var_1_41))) {
		var_1_60 = (max (var_1_46 , -10));
	}


	// From: Req27Batch129Amount500
	if ((var_1_21 << var_1_17) >= 4u) {
		if (var_1_64 <= var_1_22) {
			var_1_72 = (abs (var_1_40));
		} else {
			if (var_1_90 < var_1_105) {
				var_1_72 = (min ((var_1_41 - (var_1_73 - var_1_54)) , var_1_51));
			}
		}
	} else {
		if (var_1_38 >= (max (var_1_55 , var_1_90))) {
			var_1_72 = (abs (var_1_67));
		}
	}


	// From: Req31Batch129Amount500
	unsigned long int stepLocal_15 = var_1_90;
	if (var_1_69 != (min (var_1_102 , (- var_1_106)))) {
		if ((- (- var_1_8)) > (- var_1_9)) {
			var_1_77 = (abs (var_1_9));
		} else {
			if (var_1_89 != stepLocal_15) {
				if (var_1_3 != var_1_15) {
					var_1_77 = ((var_1_16 + var_1_13) + (var_1_14 - (max (var_1_15 , var_1_80))));
				}
			} else {
				var_1_77 = (abs (var_1_11));
			}
		}
	}
}
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((! var_1_52) ? (var_1_1 == ((float) (max ((var_1_3 - var_1_4) , var_1_5)))) : 1) && (((var_1_5 == var_1_102) && var_1_101) ? ((var_1_102 > (var_1_4 + var_1_5)) ? (var_1_6 == ((float) (var_1_7 + (min (var_1_8 , (var_1_9 + var_1_10)))))) : 1) : (((- var_1_3) <= (min (9.625f , var_1_7))) ? (var_1_6 == ((float) (var_1_4 - var_1_11))) : (var_1_6 == ((float) ((var_1_12 + 63.2f) - ((var_1_13 + var_1_14) + (var_1_15 - var_1_16)))))))) && ((-256 == last_1_var_1_71) ? (var_1_17 == ((unsigned long int) ((var_1_21 - (var_1_22 + var_1_23)) + (min (var_1_20 , var_1_24))))) : (var_1_17 == ((unsigned long int) var_1_24)))) && (((var_1_26 - var_1_27) != var_1_104) ? (var_1_25 == ((signed long int) (var_1_23 + (var_1_26 + var_1_27)))) : (var_1_25 == ((signed long int) (min (5 , var_1_23)))))) && ((var_1_9 >= (- var_1_12)) ? ((var_1_16 <= var_1_5) ? (var_1_28 == ((double) (var_1_3 - (8.75 + var_1_15)))) : (var_1_28 == ((double) (max ((min (2.5 , (var_1_16 + var_1_15))) , ((var_1_13 - 9.275) + (var_1_14 - var_1_12))))))) : (var_1_116 ? (var_1_28 == ((double) (var_1_14 + (var_1_16 - 256.5)))) : (var_1_28 == ((double) (max (var_1_12 , (max (var_1_10 , (49.2 + var_1_14)))))))))) && ((var_1_5 <= (max (var_1_13 , (var_1_10 * var_1_69)))) ? (var_1_29 == ((unsigned char) (! ((var_1_16 >= 255.75f) || var_1_30)))) : (var_1_29 == ((unsigned char) (! (! var_1_30)))))) && ((var_1_12 <= var_1_4) ? (var_1_30 ? (var_1_31 == ((signed short int) (min (var_1_32 , var_1_33)))) : (var_1_116 ? (var_1_31 == ((signed short int) var_1_33)) : 1)) : 1)) && ((var_1_12 == (max ((min (var_1_1 , var_1_14)) , var_1_69))) ? (var_1_34 == ((unsigned char) (((var_1_36 - var_1_37) + var_1_38) - (var_1_39 - (var_1_40 - var_1_41))))) : ((var_1_7 <= (var_1_14 / var_1_15)) ? (var_1_34 == ((unsigned char) (var_1_39 + (min (var_1_41 , 0))))) : (var_1_34 == ((unsigned char) (var_1_42 - var_1_41)))))) && (var_1_43 == ((float) (var_1_3 - (min ((var_1_44 - var_1_15) , var_1_12)))))) && ((((var_1_33 / var_1_42) | (var_1_46 - var_1_36)) >= last_1_var_1_86) ? (((var_1_21 + (var_1_26 ^ var_1_41)) >= var_1_24) ? (var_1_45 == ((signed short int) (max ((abs (max (var_1_39 , 5))) , (var_1_41 - last_1_var_1_89))))) : (var_1_45 == ((signed short int) var_1_32))) : (var_1_45 == ((signed short int) var_1_40)))) && ((64 <= (var_1_26 / (max (var_1_48 , var_1_36)))) ? (var_1_47 == ((float) (max (var_1_7 , var_1_4)))) : (var_1_47 == ((float) (((abs (var_1_10)) + var_1_16) - (min (var_1_3 , var_1_14))))))) && ((((var_1_38 / var_1_39) / var_1_36) > var_1_32) ? (var_1_49 == ((unsigned short int) ((max (25 , var_1_38)) + var_1_39))) : 1)) && ((! var_1_52) ? ((var_1_21 >= (var_1_41 / (max (var_1_38 , var_1_26)))) ? (var_1_50 == ((unsigned char) var_1_38)) : 1) : ((var_1_15 != var_1_11) ? ((var_1_4 > var_1_7) ? (var_1_50 == ((unsigned char) (((max (var_1_51 , 200)) - var_1_41) - (min (var_1_37 , (1 + var_1_40)))))) : (var_1_50 == ((unsigned char) (min (8 , var_1_38))))) : 1))) && ((var_1_48 == (~ var_1_41)) ? ((-10 <= var_1_81) ? (var_1_52 == ((unsigned char) (var_1_30 && (! var_1_53)))) : 1) : ((var_1_42 >= ((128 - var_1_37) >> var_1_54)) ? (var_1_52 == ((unsigned char) var_1_30)) : (var_1_52 == ((unsigned char) (! var_1_53)))))) && (((var_1_16 * var_1_106) < (15.25 + 1.8)) ? (var_1_55 == ((signed long int) var_1_27)) : (var_1_55 == ((signed long int) var_1_32)))) && ((var_1_39 >= var_1_33) ? (var_1_30 ? (var_1_56 == ((unsigned char) ((! var_1_53) && var_1_57))) : (var_1_56 == ((unsigned char) (var_1_53 && var_1_58)))) : (var_1_56 == ((unsigned char) ((var_1_53 || var_1_58) || var_1_59))))) && ((var_1_90 <= ((var_1_51 - var_1_36) * (var_1_42 - var_1_41))) ? (var_1_60 == ((signed short int) (max (var_1_46 , -10)))) : 1)) && (var_1_61 == ((unsigned long int) (abs (var_1_54))))) && (((2.875 - var_1_16) > var_1_47) ? (var_1_62 == ((unsigned char) ((var_1_37 < var_1_17) || (! var_1_58)))) : 1)) && ((-4 < (var_1_94 % var_1_64)) ? (var_1_63 == ((signed short int) (max (var_1_46 , var_1_81)))) : 1)) && ((var_1_48 < var_1_64) ? (var_1_65 == ((unsigned char) (var_1_42 - (var_1_41 + (min (var_1_40 , var_1_54)))))) : ((var_1_30 && ((min (var_1_39 , var_1_24)) >= var_1_51)) ? (var_1_65 == ((unsigned char) (min (var_1_40 , (min (var_1_41 , (max (var_1_36 , var_1_37)))))))) : (var_1_65 == ((unsigned char) (var_1_36 + var_1_40)))))) && (((var_1_13 * var_1_102) < ((var_1_8 * var_1_15) / var_1_44)) ? (var_1_66 == ((signed char) (var_1_37 + (min (var_1_54 , (var_1_41 - var_1_40)))))) : ((var_1_10 <= 10.4f) ? (var_1_66 == ((signed char) ((abs (var_1_41)) + (var_1_54 - (var_1_40 - var_1_67))))) : (var_1_66 == ((signed char) (min (var_1_54 , var_1_37))))))) && (((- (var_1_15 * var_1_14)) < var_1_3) ? (var_1_68 == ((double) (abs (var_1_15)))) : (var_1_68 == ((double) var_1_12)))) && ((var_1_20 <= var_1_17) ? ((var_1_81 <= (-32 + var_1_51)) ? (var_1_69 == ((double) (var_1_8 + (abs (var_1_10))))) : (((min (200 , var_1_32)) <= var_1_24) ? (var_1_69 == ((double) (min ((var_1_3 - (var_1_44 - var_1_14)) , var_1_11)))) : (var_1_69 == ((double) (var_1_15 - var_1_14))))) : (var_1_69 == ((double) ((max (var_1_13 , var_1_4)) - var_1_44))))) && ((var_1_14 < (- 4.425f)) ? (((var_1_4 * var_1_14) == var_1_15) ? (var_1_70 == ((unsigned char) (var_1_41 + 16))) : (((128.2f - var_1_13) > var_1_4) ? (var_1_70 == ((unsigned char) (var_1_67 + var_1_41))) : 1)) : (var_1_70 == ((unsigned char) ((var_1_67 + 5) + 1))))) && (var_1_30 ? (var_1_71 == ((unsigned long int) var_1_17)) : (var_1_71 == ((unsigned long int) var_1_26)))) && (((var_1_21 << var_1_17) >= 4u) ? ((var_1_64 <= var_1_22) ? (var_1_72 == ((signed char) (abs (var_1_40)))) : ((var_1_90 < var_1_105) ? (var_1_72 == ((signed char) (min ((var_1_41 - (var_1_73 - var_1_54)) , var_1_51)))) : 1)) : ((var_1_38 >= (max (var_1_55 , var_1_90))) ? (var_1_72 == ((signed char) (abs (var_1_67)))) : 1))) && (var_1_58 ? (((~ var_1_41) > (var_1_94 * var_1_81)) ? (var_1_74 == ((float) (var_1_13 + var_1_12))) : (var_1_74 == ((float) (var_1_11 - var_1_13)))) : (var_1_74 == ((float) (((var_1_15 - var_1_14) + var_1_16) - (var_1_13 + var_1_12)))))) && (var_1_52 ? (var_1_75 == ((unsigned char) ((var_1_51 - (var_1_40 - var_1_54)) - var_1_73))) : 1)) && (var_1_56 ? (var_1_30 ? (var_1_76 == ((signed short int) (var_1_41 + var_1_67))) : 1) : 1)) && ((var_1_69 != (min (var_1_102 , (- var_1_106)))) ? (((- (- var_1_8)) > (- var_1_9)) ? (var_1_77 == ((double) (abs (var_1_9)))) : ((var_1_89 != var_1_90) ? ((var_1_3 != var_1_15) ? (var_1_77 == ((double) ((var_1_16 + var_1_13) + (var_1_14 - (max (var_1_15 , var_1_80)))))) : 1) : (var_1_77 == ((double) (abs (var_1_11)))))) : 1)) && (var_1_53 ? (var_1_81 == ((signed long int) (max ((var_1_27 - (var_1_40 + var_1_46)) , last_1_var_1_81)))) : (var_1_81 == ((signed long int) (max ((var_1_33 + var_1_55) , (last_1_var_1_81 + (var_1_38 + var_1_36)))))))) && ((var_1_68 <= var_1_80) ? ((((- var_1_12) * 500.4) <= var_1_102) ? (var_1_59 ? (var_1_101 ? (var_1_83 == ((signed char) (var_1_37 - ((min (var_1_85 , 1)) + (min (var_1_41 , var_1_67)))))) : 1) : 1) : 1) : (var_1_83 == ((signed char) (abs (var_1_54)))))) && ((((var_1_71 * var_1_73) / 2) > ((var_1_38 >> var_1_87) * (var_1_71 % var_1_40))) ? (var_1_86 == ((signed long int) ((var_1_73 + (min (var_1_31 , var_1_46))) + var_1_54))) : 1)) && (var_1_88 == ((float) (max (128.875f , (var_1_16 - var_1_11)))))) && (((var_1_93 * var_1_7) <= var_1_15) ? (var_1_89 == ((signed short int) (var_1_87 + var_1_38))) : (var_1_89 == ((signed short int) (var_1_40 - (var_1_85 + var_1_67)))))) && ((var_1_26 <= var_1_25) ? ((var_1_23 < (var_1_73 ^ (- var_1_46))) ? ((((- var_1_68) >= var_1_6) || ((var_1_85 + var_1_54) == var_1_64)) ? (var_1_90 == ((unsigned long int) var_1_22)) : ((var_1_49 < (var_1_82 / var_1_36)) ? (var_1_90 == ((unsigned long int) (min ((var_1_92 - var_1_54) , var_1_21)))) : (var_1_90 == ((unsigned long int) var_1_73)))) : (var_1_90 == ((unsigned long int) (var_1_92 - var_1_46)))) : 1)) && ((var_1_49 != ((var_1_37 - var_1_45) / var_1_73)) ? (var_1_93 == ((float) (var_1_11 - (var_1_13 + (min (var_1_80 , var_1_12)))))) : (var_1_93 == ((float) (15.25f + var_1_10))))) && (((var_1_104 * var_1_27) <= var_1_67) ? ((var_1_49 < (var_1_67 >> 4)) ? (var_1_94 == ((unsigned short int) (var_1_95 - var_1_54))) : (var_1_94 == ((unsigned short int) (var_1_67 + (abs (var_1_96 - var_1_97)))))) : (var_1_94 == ((unsigned short int) (var_1_65 + (var_1_96 - var_1_46)))))) && ((var_1_111 < var_1_49) ? (var_1_98 == ((signed long int) ((max (var_1_67 , (var_1_100 - var_1_75))) - (max ((var_1_46 + var_1_85) , var_1_81))))) : ((var_1_42 <= (max (var_1_75 , var_1_49))) ? (var_1_98 == ((signed long int) ((min (var_1_75 , var_1_73)) - var_1_51))) : (var_1_98 == ((signed long int) var_1_100))))) && (var_1_29 ? (var_1_101 == ((unsigned char) 0)) : (var_1_101 == ((unsigned char) var_1_30)))) && (var_1_57 ? (var_1_102 == ((double) var_1_10)) : (var_1_102 == ((double) var_1_7)))) && (var_1_101 ? (var_1_103 == ((signed char) var_1_51)) : (var_1_103 == ((signed char) var_1_85)))) && (var_1_116 ? (var_1_104 == ((unsigned long int) var_1_46)) : (var_1_104 == ((unsigned long int) var_1_86)))) && (var_1_59 ? (var_1_105 == ((unsigned long int) var_1_51)) : 1)) && (var_1_30 ? (var_1_106 == ((double) var_1_9)) : (var_1_106 == ((double) var_1_7)))) && (var_1_56 ? (var_1_107 == ((unsigned char) var_1_59)) : 1)) && (var_1_109 == ((unsigned char) 0))) && (var_1_30 ? (var_1_110 == ((unsigned char) var_1_59)) : (var_1_110 == ((unsigned char) var_1_57)))) && (var_1_52 ? (var_1_111 == ((unsigned char) 64)) : 1)) && (((var_1_27 & (var_1_25 + var_1_32)) <= var_1_104) ? (((min (var_1_9 , var_1_10)) < var_1_47) ? (var_1_112 == ((unsigned char) var_1_30)) : (var_1_112 == ((unsigned char) var_1_59))) : 1)) && (var_1_115 == ((unsigned char) var_1_38))) && (var_1_116 == ((unsigned char) var_1_59))
;
}
int main(void) {
	isInitial = 1;
