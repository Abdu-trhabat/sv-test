...
void step(void) {
	...
	// From: Req8Batch112Amount100
	var_1_23 = (var_1_10 + var_1_24);


	// From: Req4Batch112Amount100
	var_1_14 = (max (var_1_11 , var_1_10));


	// From: Req10Batch112Amount100
	var_1_28 = (! var_1_29);


	// From: Req14Batch112Amount100
	if (-1 <= var_1_17) {
		var_1_33 = (var_1_21 - var_1_4);
	}


	// From: Req5Batch112Amount100
	...
	// From: Req2Batch112Amount100
	if (var_1_28) {
		var_1_8 = (max (var_1_10 , var_1_11));
	}


	// From: Req7Batch112Amount100
	if (var_1_28) {
		var_1_22 = var_1_17;
	}


	// From: Req15Batch112Amount100
	...
	// From: Req3Batch112Amount100
	if (var_1_28) {
		var_1_12 = ((min ((var_1_13 - 50) , var_1_24)) - var_1_22);
	}


	// From: Req1Batch112Amount100
