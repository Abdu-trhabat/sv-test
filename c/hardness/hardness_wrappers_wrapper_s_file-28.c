...
void step(void) {
	...
	if (stepLocal_1 <= (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_7))) {
		WrapperStruct00.var_1_12 = ((min (WrapperStruct00.var_1_6 , (WrapperStruct00.var_1_13 - WrapperStruct00.var_1_14))) - (WrapperStruct00.var_1_15 - (abs (WrapperStruct00.var_1_5))));
	} else {
		WrapperStruct00.var_1_12 = (WrapperStruct00.var_1_6 + ((min (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_16)) - WrapperStruct00.var_1_17));
	}
