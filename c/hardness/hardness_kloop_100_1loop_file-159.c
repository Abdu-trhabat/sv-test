...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch159100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch159100_1loop
	var_1_8 = (((max (var_1_9 , var_1_10)) - (var_1_11 + var_1_12)) - var_1_13);


	// From: Req4Batch159100_1loop
	if (var_1_2) {
		var_1_16 = (var_1_17 - var_1_18);
	}


	// From: Req5Batch159100_1loop
	if (var_1_15 != (var_1_18 - 64)) {
		var_1_19 = var_1_17;
	}


	// From: Req7Batch159100_1loop
	if (var_1_6 > var_1_1) {
		var_1_22 = (var_1_6 + var_1_7);
	}


	// From: Req8Batch159100_1loop
