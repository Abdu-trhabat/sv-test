...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch3525_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_7) {
  if (stepLocal_2 > (((((var_1_12) < (var_1_15)) ? (var_1_12) : (var_1_15))) - var_1_16)) {
