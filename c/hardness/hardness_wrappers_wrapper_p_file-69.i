...
void step(void) {
 ...
 if ((*(var_1_8_Pointer)) || stepLocal_2) {
  (*(var_1_7_Pointer)) = (((((*(var_1_1_Pointer))) < (((((-200) < ((*(var_1_6_Pointer)))) ? (-200) : ((*(var_1_6_Pointer))))))) ? ((*(var_1_1_Pointer))) : (((((-200) < ((*(var_1_6_Pointer)))) ? (-200) : ((*(var_1_6_Pointer))))))));
 } else {
  if (stepLocal_3 != 1u) {
 ...
 if (((*(var_1_10_Pointer)) - (*(var_1_11_Pointer))) >= stepLocal_4) {
  if ((- 999999.75f) > (*(var_1_14_Pointer))) {
   (*(var_1_9_Pointer)) = ((*(var_1_13_Pointer)) + (((((*(var_1_15_Pointer))) > ((*(var_1_16_Pointer)))) ? ((*(var_1_15_Pointer))) : ((*(var_1_16_Pointer))))));
  }
 }
 (*(var_1_17_Pointer)) = 4;
}
...
int property(void) {
 return ((((((*(var_1_2_Pointer)) * (((((*(var_1_3_Pointer))) < ((*(var_1_4_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_4_Pointer)))))) < (*(var_1_5_Pointer))) ? (((*(var_1_5_Pointer)) > (*(var_1_2_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed short int) (*(var_1_6_Pointer)))) : ((*(var_1_1_Pointer)) == ((signed short int) 4))) : 1) && (((*(var_1_8_Pointer)) || ((*(var_1_2_Pointer)) > ((*(var_1_4_Pointer)) + (*(var_1_3_Pointer))))) ? ((*(var_1_7_Pointer)) == ((signed long int) (((((*(var_1_1_Pointer))) < (((((-200) < ((*(var_1_6_Pointer)))) ? (-200) : ((*(var_1_6_Pointer))))))) ? ((*(var_1_1_Pointer))) : (((((-200) < ((*(var_1_6_Pointer)))) ? (-200) : ((*(var_1_6_Pointer)))))))))) : (((*(var_1_2_Pointer)) != 1u) ? ((*(var_1_7_Pointer)) == ((signed long int) (*(var_1_1_Pointer)))) : ((*(var_1_7_Pointer)) == ((signed long int) (*(var_1_6_Pointer))))))) && ((((*(var_1_10_Pointer)) - (*(var_1_11_Pointer))) >= ((*(var_1_12_Pointer)) >> (*(var_1_13_Pointer)))) ? (((- 999999.75f) > (*(var_1_14_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed char) ((*(var_1_13_Pointer)) + (((((*(var_1_15_Pointer))) > ((*(var_1_16_Pointer)))) ? ((*(var_1_15_Pointer))) : ((*(var_1_16_Pointer)))))))) : 1) : 1)) && ((*(var_1_17_Pointer)) == ((signed char) 4))
;
}
int main(void) {
 isInitial = 1;
