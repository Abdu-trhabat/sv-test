...
void step(void) {
	...
	// From: CodeObject1
	/* 273L, 63L) */ if (/* 274L, 50L, 51L) */ ((var_1_23) > (var_1_8))) {
		/* 277L, 62L) */ var_1_30 = (
			/* 280L, 61L) */ (max (
				/* 280L, 61L) */ (
					16
	...
	/* 388L, 220L) */ if (/* 389L, 186L, 187L) */ ((var_1_36) >= (/* 391L, 185L, 189L) */ (abs (var_1_41))))) {
		/* 393L, 218L) */ if (/* 394L, 199L, 200L) */ ((var_1_12) && (/* 396L, 198L, 202L) */ ((var_1_39) > (var_1_38))))) {
			/* 399L, 217L) */ var_1_47 = (
				/* 402L, 216L) */ (max (
					/* 402L, 216L) */ (
						var_1_41
	...
	// From: CodeObject2
	/* 283L, 97L) */ if (/* 284L, 70L, 71L) */ ((var_1_3) > (/* 286L, 69L, 73L) */ (abs (var_1_3))))) {
		/* 288L, 83L) */ var_1_34 = (
			/* 291L, 82L) */ (abs (
				var_1_3
			))
	...
	/* 408L, 269L) */ if (/* 409L, 227L, 228L) */ ((/* 410L, 225L, 229L) */ (abs (var_1_41))) == (128))) {
		/* 413L, 263L) */ if (/* 414L, 240L, 241L) */ ((var_1_34) <= (/* 416L, 239L, 243L) */ ((var_1_35) - (var_1_4))))) {
			/* 419L, 258L) */ var_1_50 = (
				/* 422L, 257L) */ ((
					/* 423L, 255L) */ ((
						2054545849u
