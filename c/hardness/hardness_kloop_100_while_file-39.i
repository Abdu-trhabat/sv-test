...
void step(void) {
 if ((((((var_1_13) > (last_1_var_1_40)) ? (var_1_13) : (last_1_var_1_40))) + (var_1_4 - var_1_25)) >= last_1_var_1_39) {
  if (last_1_var_1_19) {
 ...
 if (! var_1_19) {
  var_1_10 = (((((var_1_12 - (var_1_13 - var_1_36))) > (var_1_2)) ? ((var_1_12 - (var_1_13 - var_1_36))) : (var_1_2)));
 }
 if (var_1_10 >= var_1_2) {
  if ((var_1_8 / var_1_15) < 0.19999999999999996f) {
   var_1_14 = (((((((((var_1_4 - var_1_3)) < (var_1_16)) ? ((var_1_4 - var_1_3)) : (var_1_16)))) < (var_1_17)) ? ((((((var_1_4 - var_1_3)) < (var_1_16)) ? ((var_1_4 - var_1_3)) : (var_1_16)))) : (var_1_17)));
  } else {
 ...
 if (((((var_1_12 - var_1_36) < 0 ) ? -(var_1_12 - var_1_36) : (var_1_12 - var_1_36))) >= var_1_18) {
  if (var_1_21) {
   var_1_22 = ((((var_1_23 - var_1_4) < 0 ) ? -(var_1_23 - var_1_4) : (var_1_23 - var_1_4)));
  } else {
   var_1_22 = 8;
  }
 } else {
 ...
 if (var_1_28 >= var_1_8) {
  ...
  var_1_29 = ((((var_1_31) < (var_1_30)) ? (var_1_31) : (var_1_30)));
 }
...
int property(void) {
 return ((((((((((((((((((((8) < (var_1_2)) ? (8) : (var_1_2))) << ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4)))) <= var_1_36) ? ((99.7f >= ((var_1_6 - var_1_7) / var_1_8)) ? (var_1_1 == ((unsigned char) 100)) : 1) : (var_1_1 == ((unsigned char) var_1_3))) && ((var_1_8 >= 5.75f) ? (var_1_9 == ((signed long int) ((var_1_4 + var_1_2) - var_1_3))) : 1)) && ((! var_1_19) ? (var_1_10 == ((unsigned long int) (((((var_1_12 - (var_1_13 - var_1_36))) > (var_1_2)) ? ((var_1_12 - (var_1_13 - var_1_36))) : (var_1_2))))) : 1)) && ((var_1_10 >= var_1_2) ? (((var_1_8 / var_1_15) < 0.19999999999999996f) ? (var_1_14 == ((signed char) (((((((((var_1_4 - var_1_3)) < (var_1_16)) ? ((var_1_4 - var_1_3)) : (var_1_16)))) < (var_1_17)) ? ((((((var_1_4 - var_1_3)) < (var_1_16)) ? ((var_1_4 - var_1_3)) : (var_1_16)))) : (var_1_17))))) : (var_1_14 == ((signed char) ((var_1_18 - 1) - var_1_3)))) : (var_1_14 == ((signed char) var_1_4)))) && (var_1_32 ? (var_1_19 == ((unsigned char) (var_1_20 || var_1_21))) : 1)) && ((((((var_1_12 - var_1_36) < 0 ) ? -(var_1_12 - var_1_36) : (var_1_12 - var_1_36))) >= var_1_18) ? (var_1_21 ? (var_1_22 == ((unsigned short int) ((((var_1_23 - var_1_4) < 0 ) ? -(var_1_23 - var_1_4) : (var_1_23 - var_1_4))))) : (var_1_22 == ((unsigned short int) 8))) : (var_1_22 == ((unsigned short int) var_1_3)))) && ((! (var_1_20 && var_1_32)) ? (var_1_24 == ((unsigned char) ((var_1_25 + var_1_26) - var_1_18))) : ((var_1_22 <= var_1_23) ? (var_1_24 == ((unsigned char) var_1_2)) : (var_1_24 == ((unsigned char) var_1_18))))) && ((! (! var_1_19)) ? ((var_1_3 < (var_1_38 * var_1_18)) ? (var_1_27 == ((double) var_1_28)) : (var_1_27 == ((double) 10.9))) : (var_1_27 == ((double) var_1_28)))) && ((var_1_28 >= var_1_8) ? ((var_1_10 <= 10u) ? (var_1_29 == ((double) ((var_1_30 - var_1_31) - 64.5))) : 1) : (var_1_29 == ((double) ((((var_1_31) < (var_1_30)) ? (var_1_31) : (var_1_30))))))) && (((((((var_1_13) > (last_1_var_1_40)) ? (var_1_13) : (last_1_var_1_40))) + (var_1_4 - var_1_25)) >= last_1_var_1_39) ? (last_1_var_1_19 ? (var_1_32 == ((unsigned char) (var_1_21 || var_1_33))) : 1) : (var_1_32 == ((unsigned char) (! var_1_33))))) && ((var_1_40 <= var_1_12) ? ((0 <= var_1_3) ? (var_1_34 == ((unsigned long int) (var_1_4 + var_1_22))) : (var_1_34 == ((unsigned long int) var_1_35))) : (var_1_34 == ((unsigned long int) (var_1_22 + last_1_var_1_34))))) && (var_1_36 == ((unsigned long int) (var_1_12 - var_1_37)))) && (var_1_38 == ((unsigned short int) var_1_40))) && (var_1_39 == ((signed short int) var_1_24))) && (var_1_40 == ((unsigned long int) var_1_23))
;
}
int main(void) {
 isInitial = 1;
