...
void step(void) {
 if ((unsigned_char_Array_0[2] + ((((unsigned_char_Array_0[1]) > (unsigned_char_Array_0[0])) ? (unsigned_char_Array_0[1]) : (unsigned_char_Array_0[0])))) < (signed_long_int_Array_0[1] * signed_long_int_Array_0[0])) {
  if (signed_long_int_Array_0[1] < (unsigned_char_Array_0[2] - unsigned_char_Array_0[1])) {
   if (signed_long_int_Array_0[1] != (((((((unsigned_char_Array_0[0]) < (unsigned_char_Array_0[2])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[2]))) < 0 ) ? -((((unsigned_char_Array_0[0]) < (unsigned_char_Array_0[2])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[2]))) : ((((unsigned_char_Array_0[0]) < (unsigned_char_Array_0[2])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[2])))))) {
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  if ((float_Array_0[0] - float_Array_0[1]) >= ((double_Array_0[1] + double_Array_0[2]) + double_Array_0[0])) {
   signed_short_int_Array_0[0] = ((((unsigned_char_Array_0[2]) > (unsigned_char_Array_0[1])) ? (unsigned_char_Array_0[2]) : (unsigned_char_Array_0[1])));
  } else {
...
int property(void) {
 return ((((unsigned_char_Array_0[2] + ((((unsigned_char_Array_0[1]) > (unsigned_char_Array_0[0])) ? (unsigned_char_Array_0[1]) : (unsigned_char_Array_0[0])))) < (signed_long_int_Array_0[1] * signed_long_int_Array_0[0])) ? ((signed_long_int_Array_0[1] < (unsigned_char_Array_0[2] - unsigned_char_Array_0[1])) ? ((signed_long_int_Array_0[1] != (((((((unsigned_char_Array_0[0]) < (unsigned_char_Array_0[2])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[2]))) < 0 ) ? -((((unsigned_char_Array_0[0]) < (unsigned_char_Array_0[2])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[2]))) : ((((unsigned_char_Array_0[0]) < (unsigned_char_Array_0[2])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[2])))))) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_char_Array_0[2])) : 1) : 1) : (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_char_Array_0[0]))) && ((((((double_Array_0[1]) < (double_Array_0[0])) ? (double_Array_0[1]) : (double_Array_0[0]))) <= double_Array_0[2]) ? ((last_1_BOOL_unsigned_char_Array_0_1_ && (signed_long_int_Array_0[1] >= unsigned_short_int_Array_0[0])) ? (BOOL_unsigned_char_Array_0[1] == ((unsigned char) 0)) : 1) : (BOOL_unsigned_char_Array_0[1] == ((unsigned char) BOOL_unsigned_char_Array_0[0])))) && (BOOL_unsigned_char_Array_0[0] ? (((float_Array_0[0] - float_Array_0[1]) >= ((double_Array_0[1] + double_Array_0[2]) + double_Array_0[0])) ? (signed_short_int_Array_0[0] == ((signed short int) ((((unsigned_char_Array_0[2]) > (unsigned_char_Array_0[1])) ? (unsigned_char_Array_0[2]) : (unsigned_char_Array_0[1]))))) : (signed_short_int_Array_0[0] == ((signed short int) unsigned_char_Array_0[0]))) : 1)
;
}
int main(void) {
 isInitial = 1;
