...
void step(void) {
 if (0.625f > last_1_double_Array_0_1_) {
  if (BOOL_unsigned_char_Array_0[0]) {
   float_Array_0[2] = ((((float_Array_0[0]) < 0 ) ? -(float_Array_0[0]) : (float_Array_0[0])));
  }
 } else {
  float_Array_0[2] = ((((float_Array_0[0]) < 0 ) ? -(float_Array_0[0]) : (float_Array_0[0])));
 }
 ...
 if (float_Array_0[0] > float_Array_0[2]) {
  signed_long_int_Array_0[1][2] = (((((signed_long_int_Array_0[0][2]) > (-64)) ? (signed_long_int_Array_0[0][2]) : (-64))) + ((signed_long_int_Array_0[1][1] + -2) + signed_long_int_Array_0[1][0]));
 }
...
int property(void) {
 return ((((((0.625f > last_1_double_Array_0_1_) ? (BOOL_unsigned_char_Array_0[0] ? (float_Array_0[2] == ((float) ((((float_Array_0[0]) < 0 ) ? -(float_Array_0[0]) : (float_Array_0[0]))))) : 1) : (float_Array_0[2] == ((float) ((((float_Array_0[0]) < 0 ) ? -(float_Array_0[0]) : (float_Array_0[0])))))) && ((float_Array_0[0] > float_Array_0[2]) ? (signed_long_int_Array_0[1][2] == ((signed long int) (((((signed_long_int_Array_0[0][2]) > (-64)) ? (signed_long_int_Array_0[0][2]) : (-64))) + ((signed_long_int_Array_0[1][1] + -2) + signed_long_int_Array_0[1][0])))) : 1)) && (BOOL_unsigned_char_Array_0[0] ? ((signed_long_int_Array_0[0][2] >= ((signed_long_int_Array_0[0][0] - signed_long_int_Array_0[0][1]) * 64)) ? (double_Array_0[1] == ((double) (((((double_Array_0[0]) < (50.5)) ? (double_Array_0[0]) : (50.5))) - double_Array_0[2]))) : 1) : ((float_Array_0[1] <= float_Array_0[2]) ? (double_Array_0[1] == ((double) (double_Array_0[2] - (double_Array_0[3] - double_Array_0[4])))) : 1))) && (signed_char_Array_0[0] == ((signed char) signed_char_Array_0[1]))) && (unsigned_short_int_Array_0[1] == ((unsigned short int) unsigned_short_int_Array_0[2]))) && (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_short_int_Array_0[2]))
;
}
int main(void) {
 isInitial = 1;
