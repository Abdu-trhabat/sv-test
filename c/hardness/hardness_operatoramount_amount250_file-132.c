...
void step(void) {
	// From: Req5Batch132Amount250
	if (var_1_8 < last_1_var_1_61) {
		var_1_26 = (abs (last_1_var_1_49));
	}


	// From: Req17Batch132Amount250
	if (var_1_35) {
		if (var_1_41 > last_1_var_1_40) {
			if (var_1_24 <= 256.8f) {
				var_1_58 = (max (var_1_47 , (var_1_48 + var_1_42)));
			} else {
				var_1_58 = ((abs (var_1_22)) - (var_1_59 - var_1_60));
			}
		} else {
			var_1_58 = (min (var_1_42 , (min (var_1_25 , var_1_21))));
		}
	} else {
		var_1_58 = (abs (var_1_48));
	}


	// From: Req8Batch132Amount250
	var_1_34 = (var_1_28 && var_1_35);


	// From: Req9Batch132Amount250
	if (var_1_34) {
		var_1_36 = (max ((max (var_1_29 , var_1_31)) , (min (var_1_12 , var_1_30))));
	} else {
		if (var_1_35) {
			var_1_36 = 10;
		} else {
	...
	// From: Req16Batch132Amount250
	var_1_57 = (min (var_1_30 , (abs (var_1_31))));


	// From: Req19Batch132Amount250
	var_1_62 = var_1_44;


	// From: Req20Batch132Amount250
	if (var_1_34) {
		if (var_1_35) {
	...
	// From: Req4Batch132Amount250
	if ((31.5 / var_1_20) != (max (last_1_var_1_19 , var_1_14))) {
		if (var_1_34) {
			if (var_1_17 < var_1_7) {
				var_1_19 = (max ((var_1_21 - var_1_22) , (max (var_1_23 , (var_1_24 - var_1_25)))));
			} else {
				var_1_19 = var_1_24;
			}
		} else {
			if (var_1_20 < var_1_23) {
				var_1_19 = (max (var_1_22 , var_1_23));
			} else {
				var_1_19 = var_1_25;
			}
		}
	...
	// From: Req15Batch132Amount250
	if (1.00000003E7f > var_1_24) {
		if (var_1_6 != var_1_57) {
			if ((abs (var_1_13)) > var_1_12) {
				var_1_52 = ((min (var_1_30 , var_1_29)) + var_1_53);
			} else {
				var_1_52 = (var_1_29 + (var_1_54 + var_1_55));
			}
		} else {
			if (var_1_45 <= var_1_7) {
				var_1_52 = ((var_1_54 + (max (var_1_55 , var_1_56))) + (abs (-50)));
			}
		}
	} else {
		var_1_52 = var_1_30;
	...
	// From: Req3Batch132Amount250
	if (var_1_19 < (var_1_19 + var_1_58)) {
		var_1_15 = var_1_57;
	} else {
		if ((256u < last_1_var_1_15) || var_1_34) {
			var_1_15 = (min ((var_1_57 - var_1_17) , var_1_18));
		} else {
			var_1_15 = (min ((var_1_17 - var_1_57) , last_1_var_1_15));
		}
	}


	// From: Req13Batch132Amount250
	...
	// From: Req18Batch132Amount250
	if ((min (var_1_40 , (5.6 - var_1_59))) <= (max (var_1_23 , var_1_25))) {
		var_1_61 = var_1_29;
	} else {
		var_1_61 = var_1_51;
	}
	...
	// From: Req10Batch132Amount250
	unsigned char stepLocal_4 = var_1_1;
	if (((var_1_31 + 100) - var_1_61) == stepLocal_4) {
		if ((max (var_1_25 , (var_1_24 - var_1_21))) <= (min (var_1_58 , var_1_46))) {
			var_1_37 = (min (((abs (3826329098u)) - (var_1_38 - var_1_7)) , (var_1_39 - (last_1_var_1_37 + var_1_1))));
		}
	}


	// From: Req14Batch132Amount250
	...
	if (var_1_34) {
		if (-5 >= stepLocal_18) {
			if (stepLocal_15 > last_1_var_1_49) {
				if ((min (last_1_var_1_49 , var_1_38)) < stepLocal_17) {
					var_1_49 = ((var_1_50 - (var_1_51 - var_1_30)) - (min (var_1_26 , var_1_44)));
				} else {
					var_1_49 = ((max (-10 , var_1_30)) + (var_1_26 + (abs (var_1_29))));
				}
			} else {
				if (var_1_35) {
					var_1_49 = (var_1_13 + (max ((var_1_26 + -16) , var_1_1)));
				} else {
					if (stepLocal_16 || ((var_1_50 > var_1_31) || var_1_34)) {
						var_1_49 = (max (var_1_26 , last_1_var_1_49));
					}
				}
			}
		}
	...
	// From: Req2Batch132Amount250
	unsigned short int stepLocal_1 = var_1_62;
	if (((min (5 , var_1_26)) + (var_1_7 << var_1_37)) < stepLocal_1) {
		var_1_11 = (var_1_12 + (abs (var_1_13)));
	} else {
		if (((min (var_1_46 , var_1_19)) * var_1_40) < 4.745f) {
			var_1_11 = var_1_12;
		} else {
			var_1_11 = var_1_13;
		}
	...
	if (stepLocal_11 && var_1_16) {
		if (stepLocal_9 >= var_1_39) {
			var_1_43 = (var_1_29 + (abs (var_1_44 - var_1_30)));
		} else {
			if ((max (var_1_8 , var_1_37)) <= stepLocal_8) {
				if (stepLocal_10 <= (abs (var_1_10))) {
					var_1_43 = var_1_31;
				}
			}
		}
...
int property(void) {
	return (((((((((((((((((((((last_1_var_1_1 * var_1_62) == ((var_1_6 + var_1_7) - (min (var_1_8 , var_1_9)))) ? (var_1_1 == ((unsigned char) var_1_10)) : 1) && ((((min (5 , var_1_26)) + (var_1_7 << var_1_37)) < var_1_62) ? (var_1_11 == ((signed char) (var_1_12 + (abs (var_1_13))))) : ((((min (var_1_46 , var_1_19)) * var_1_40) < 4.745f) ? (var_1_11 == ((signed char) var_1_12)) : (var_1_11 == ((signed char) var_1_13))))) && ((var_1_19 < (var_1_19 + var_1_58)) ? (var_1_15 == ((signed short int) var_1_57)) : (((256u < last_1_var_1_15) || var_1_34) ? (var_1_15 == ((signed short int) (min ((var_1_57 - var_1_17) , var_1_18)))) : (var_1_15 == ((signed short int) (min ((var_1_17 - var_1_57) , last_1_var_1_15))))))) && (((31.5 / var_1_20) != (max (last_1_var_1_19 , var_1_14))) ? (var_1_34 ? ((var_1_17 < var_1_7) ? (var_1_19 == ((float) (max ((var_1_21 - var_1_22) , (max (var_1_23 , (var_1_24 - var_1_25))))))) : (var_1_19 == ((float) var_1_24))) : ((var_1_20 < var_1_23) ? (var_1_19 == ((float) (max (var_1_22 , var_1_23)))) : (var_1_19 == ((float) var_1_25)))) : 1)) && ((var_1_8 < last_1_var_1_61) ? (var_1_26 == ((signed long int) (abs (last_1_var_1_49)))) : 1)) && ((var_1_16 && var_1_28) ? ((var_1_24 <= var_1_40) ? (var_1_27 == ((signed char) ((var_1_29 + var_1_30) - var_1_31))) : (var_1_27 == ((signed char) (max (var_1_31 , 8))))) : (var_1_27 == ((signed char) var_1_31)))) && ((var_1_37 >= (var_1_31 / var_1_33)) ? (var_1_32 == ((signed char) (var_1_13 + var_1_12))) : ((! var_1_34) ? (var_1_32 == ((signed char) (var_1_13 + (max ((max (var_1_29 , var_1_12)) , var_1_30))))) : (var_1_32 == ((signed char) (min (-16 , -25))))))) && (var_1_34 == ((unsigned char) (var_1_28 && var_1_35)))) && (var_1_34 ? (var_1_36 == ((signed char) (max ((max (var_1_29 , var_1_31)) , (min (var_1_12 , var_1_30)))))) : (var_1_35 ? (var_1_36 == ((signed char) 10)) : (var_1_36 == ((signed char) -10))))) && ((((var_1_31 + 100) - var_1_61) == var_1_1) ? (((max (var_1_25 , (var_1_24 - var_1_21))) <= (min (var_1_58 , var_1_46))) ? (var_1_37 == ((unsigned long int) (min (((abs (3826329098u)) - (var_1_38 - var_1_7)) , (var_1_39 - (last_1_var_1_37 + var_1_1)))))) : 1) : 1)) && ((var_1_7 <= (var_1_15 / (min (var_1_33 , var_1_38)))) ? (((var_1_36 % var_1_33) >= (var_1_29 - var_1_26)) ? (var_1_40 == ((double) var_1_24)) : ((8.3 < (var_1_58 / var_1_20)) ? ((var_1_36 <= var_1_7) ? (var_1_40 == ((double) (var_1_41 + var_1_42))) : (var_1_40 == ((double) var_1_22))) : (var_1_40 == ((double) var_1_23)))) : (var_1_40 == ((double) var_1_24)))) && ((var_1_28 && var_1_16) ? ((var_1_49 >= var_1_39) ? (var_1_43 == ((unsigned char) (var_1_29 + (abs (var_1_44 - var_1_30))))) : (((max (var_1_8 , var_1_37)) <= var_1_1) ? (((var_1_9 * var_1_38) <= (abs (var_1_10))) ? (var_1_43 == ((unsigned char) var_1_31)) : 1) : 1)) : (var_1_43 == ((unsigned char) (var_1_45 - var_1_29))))) && ((var_1_34 && var_1_35) ? ((var_1_45 < var_1_17) ? (var_1_46 == ((double) (var_1_41 + (var_1_47 + var_1_48)))) : 1) : ((((var_1_29 + var_1_33) / var_1_44) >= ((var_1_38 - var_1_15) - var_1_30)) ? (var_1_46 == ((double) (var_1_42 + (max (var_1_47 , var_1_41))))) : 1))) && (var_1_34 ? ((-5 >= var_1_37) ? (((var_1_10 + var_1_37) > last_1_var_1_49) ? (((min (last_1_var_1_49 , var_1_38)) < (var_1_39 - 25u)) ? (var_1_49 == ((signed short int) ((var_1_50 - (var_1_51 - var_1_30)) - (min (var_1_26 , var_1_44))))) : (var_1_49 == ((signed short int) ((max (-10 , var_1_30)) + (var_1_26 + (abs (var_1_29))))))) : (var_1_35 ? (var_1_49 == ((signed short int) (var_1_13 + (max ((var_1_26 + -16) , var_1_1))))) : (((var_1_22 < var_1_41) || ((var_1_50 > var_1_31) || var_1_34)) ? (var_1_49 == ((signed short int) (max (var_1_26 , last_1_var_1_49)))) : 1))) : 1) : (var_1_49 == ((signed short int) 32)))) && ((1.00000003E7f > var_1_24) ? ((var_1_6 != var_1_57) ? (((abs (var_1_13)) > var_1_12) ? (var_1_52 == ((signed char) ((min (var_1_30 , var_1_29)) + var_1_53))) : (var_1_52 == ((signed char) (var_1_29 + (var_1_54 + var_1_55))))) : ((var_1_45 <= var_1_7) ? (var_1_52 == ((signed char) ((var_1_54 + (max (var_1_55 , var_1_56))) + (abs (-50))))) : 1)) : (var_1_52 == ((signed char) var_1_30)))) && (var_1_57 == ((unsigned char) (min (var_1_30 , (abs (var_1_31))))))) && (var_1_35 ? ((var_1_41 > last_1_var_1_40) ? ((var_1_24 <= 256.8f) ? (var_1_58 == ((float) (max (var_1_47 , (var_1_48 + var_1_42))))) : (var_1_58 == ((float) ((abs (var_1_22)) - (var_1_59 - var_1_60))))) : (var_1_58 == ((float) (min (var_1_42 , (min (var_1_25 , var_1_21))))))) : (var_1_58 == ((float) (abs (var_1_48)))))) && (((min (var_1_40 , (5.6 - var_1_59))) <= (max (var_1_23 , var_1_25))) ? (var_1_61 == ((unsigned short int) var_1_29)) : (var_1_61 == ((unsigned short int) var_1_51)))) && (var_1_62 == ((unsigned short int) var_1_44))) && (var_1_34 ? (var_1_35 ? (var_1_63 == ((signed char) (var_1_55 + (var_1_54 + var_1_56)))) : (var_1_63 == ((signed char) ((var_1_30 - var_1_29) + (var_1_64 + var_1_55))))) : (var_1_63 == ((signed char) var_1_56)))
;
}
int main(void) {
	isInitial = 1;
