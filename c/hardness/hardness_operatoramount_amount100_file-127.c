...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch127Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req10Batch127Amount100
	var_1_24 = ((var_1_17 + (min (var_1_13 , var_1_16))) - var_1_19);


	// From: Req8Batch127Amount100
	...
	// From: Req9Batch127Amount100
	var_1_23 = (var_1_8 || var_1_9);


	// From: Req13Batch127Amount100
	var_1_29 = (var_1_13 - (var_1_30 + var_1_31));


	// From: Req12Batch127Amount100
	...
	// From: Req4Batch127Amount100
	if (! ((min (var_1_28 , var_1_24)) >= 16)) {
		var_1_14 = var_1_15;
	}


	// From: Req11Batch127Amount100
