...
void step(void) {
	...
	if ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) < (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer))) {
		...
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) = (max (-4 , ((max (128 , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)))) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))));
	}


	// From: Req3Batch172Wrapper_AP
	(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) = (min ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))));


	// From: Req4Batch172Wrapper_AP
	...
	if (stepLocal_0 && ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) != (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))) {
		(*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) = ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) + (max (3.25f , (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)))));
	}


	// From: Req5Batch172Wrapper_AP
