...
void step(void) {
	...
	if (stepLocal_1 <= (max ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_7_Pointer))))) {
		(*(WrapperStruct00_var_1_12_Pointer)) = ((min ((*(WrapperStruct00_var_1_6_Pointer)) , ((*(WrapperStruct00_var_1_13_Pointer)) - (*(WrapperStruct00_var_1_14_Pointer))))) - ((*(WrapperStruct00_var_1_15_Pointer)) - (abs ((*(WrapperStruct00_var_1_5_Pointer))))));
	} else {
		(*(WrapperStruct00_var_1_12_Pointer)) = ((*(WrapperStruct00_var_1_6_Pointer)) + ((min ((*(WrapperStruct00_var_1_14_Pointer)) , (*(WrapperStruct00_var_1_16_Pointer)))) - (*(WrapperStruct00_var_1_17_Pointer))));
	}
