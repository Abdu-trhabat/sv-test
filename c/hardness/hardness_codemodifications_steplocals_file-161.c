...
void step(void) {
	...
	// From: Req3Batch161stepLocals
	var_1_11 = (64 + var_1_12);


	// From: Req4Batch161stepLocals
	var_1_13 = (min (var_1_14 , var_1_15));


	// From: Req5Batch161stepLocals
	...
	// From: Req6Batch161stepLocals
	if (var_1_7 || var_1_23) {
		var_1_22 = (min (var_1_15 , var_1_14));
	}


	// From: Req7Batch161stepLocals
	if (var_1_8 >= (- var_1_1)) {
