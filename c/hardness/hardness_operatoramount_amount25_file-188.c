...
void step(void) {
	...
	// From: Req2Batch188Amount25
	var_1_9 = (max ((var_1_10 - var_1_11) , var_1_8));


	// From: Req4Batch188Amount25
	var_1_15 = var_1_16;


	// From: Req5Batch188Amount25
	var_1_17 = var_1_10;


	// From: Req3Batch188Amount25
...
int property(void) {
	return (((((last_1_var_1_12 != last_1_var_1_9) ? (((last_1_var_1_9 != last_1_var_1_12) && (var_1_4 < var_1_5)) ? (var_1_1 == ((signed char) (min ((var_1_6 + var_1_7) , var_1_8)))) : 1) : 1) && (var_1_9 == ((signed char) (max ((var_1_10 - var_1_11) , var_1_8))))) && ((var_1_10 <= (~ -128)) ? ((var_1_17 <= var_1_1) ? (var_1_12 == ((unsigned char) (((var_1_13 - 4) - var_1_14) - var_1_11))) : (var_1_12 == ((unsigned char) 1))) : (var_1_12 == ((unsigned char) var_1_11)))) && (var_1_15 == ((double) var_1_16))) && (var_1_17 == ((signed long int) var_1_10))
;
}
int main(void) {
	isInitial = 1;
