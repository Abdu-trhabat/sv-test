...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch60Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (double_Array_0[0][1] > double_Array_0[1][1]) {
		if (BOOL_unsigned_char_Array_0[0]) {
			if (double_Array_0[1][0] <= (min (double_Array_0[1][1] , float_Array_0[4]))) {
