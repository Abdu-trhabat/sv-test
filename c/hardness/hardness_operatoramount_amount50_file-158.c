...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch158Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch158Amount50
	if (var_1_7 > var_1_9) {
		var_1_18 = var_1_20;
	}


	// From: Req5Batch158Amount50
	var_1_22 = ((var_1_2 && var_1_23) || (! var_1_24));


	// From: Req6Batch158Amount50
	...
	if (stepLocal_5 || (var_1_17 < var_1_1)) {
		...
		if (stepLocal_4 > ((max (var_1_15 , var_1_13)) - var_1_1)) {
	...
	// From: Req7Batch158Amount50
	if (var_1_26 <= (-1 * var_1_12)) {
		var_1_27 = var_1_18;
	}


	// From: Req4Batch158Amount50
...
int property(void) {
	return ((((((((var_1_3 < var_1_4) && ((var_1_2 || var_1_5) && var_1_6)) ? (((- (9.75 + var_1_7)) >= (var_1_8 - var_1_9)) ? (var_1_1 == ((signed long int) (var_1_10 + var_1_11))) : (var_1_1 == ((signed long int) var_1_10))) : (var_1_1 == ((signed long int) var_1_10))) && (((var_1_13 >> var_1_14) < (var_1_10 * -32)) ? (var_1_12 == ((signed long int) var_1_17)) : (var_1_12 == ((signed long int) var_1_11)))) && ((var_1_7 > var_1_9) ? (var_1_18 == ((signed short int) var_1_20)) : 1)) && (var_1_22 ? ((var_1_17 > -256) ? (var_1_21 == ((unsigned char) (max (8 , var_1_14)))) : 1) : 1)) && (var_1_22 == ((unsigned char) ((var_1_2 && var_1_23) || (! var_1_24))))) && ((var_1_22 || (var_1_17 < var_1_1)) ? (var_1_25 == ((signed char) var_1_14)) : (((var_1_19 * var_1_12) > ((max (var_1_15 , var_1_13)) - var_1_1)) ? (((var_1_13 / var_1_14) <= var_1_15) ? (var_1_25 == ((signed char) var_1_14)) : (var_1_25 == ((signed char) var_1_26))) : 1))) && ((var_1_26 <= (-1 * var_1_12)) ? (var_1_27 == ((signed long int) var_1_18)) : 1)
;
}
int main(void) {
	isInitial = 1;
