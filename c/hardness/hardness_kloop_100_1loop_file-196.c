...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch196100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch196100_1loop
	var_1_15 = (var_1_16 - ((var_1_13 + var_1_14) + var_1_17));


	// From: Req5Batch196100_1loop
	...
	// From: Req13Batch196100_1loop
	var_1_39 = var_1_31;


	// From: Req9Batch196100_1loop
	...
	// From: Req4Batch196100_1loop
	if (var_1_29) {
		var_1_18 = (var_1_19 || (! var_1_20));
	}


	// From: Req1Batch196100_1loop
	if (var_1_29) {
		if (! var_1_18) {
