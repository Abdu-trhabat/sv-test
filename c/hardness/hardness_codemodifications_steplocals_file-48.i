...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch48stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_1 = ((((var_1_15 - var_1_16)) > (var_1_13)) ? ((var_1_15 - var_1_16)) : (var_1_13));
