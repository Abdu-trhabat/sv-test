...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch129dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch129dependencies
	if (((var_1_10 - var_1_11) - var_1_12) < var_1_2) {
		var_1_9 = var_1_8;
	}


	// From: Req3Batch129dependencies
	...
	// From: Req5Batch129dependencies
	var_1_21 = (1.000000005E8 - (7.46417232161781E18 - var_1_22));


	// From: Req6Batch129dependencies
