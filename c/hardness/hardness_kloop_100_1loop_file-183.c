...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch183100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch183100_1loop
	var_1_38 = (max (var_1_29 , var_1_22));


	// From: Req13Batch183100_1loop
	var_1_42 = var_1_43;


	// From: Req14Batch183100_1loop
	var_1_44 = var_1_33;


	// From: Req5Batch183100_1loop
	if (var_1_42) {
		if (var_1_4 > var_1_6) {
