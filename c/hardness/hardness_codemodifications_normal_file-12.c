...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch12normal
	if ((- var_1_3) > var_1_6) {
		var_1_8 = ((var_1_9 - var_1_1) - var_1_5);
	}


	// From: Req3Batch12normal
	if (var_1_4 != (min (var_1_6 , var_1_5))) {
	...
	// From: Req6Batch12normal
	var_1_21 = (abs (var_1_7));


	// From: Req7Batch12normal
	if (var_1_21 == var_1_3) {
		if (! var_1_20) {
