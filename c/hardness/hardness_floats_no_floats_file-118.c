...
void step(void) {
	// From: Req4Batch118no_floats
	if (var_1_5 < 64) {
		var_1_14 = 25u;
	}


	// From: Req5Batch118no_floats
	var_1_15 = var_1_9;


	// From: Req6Batch118no_floats
	var_1_16 = var_1_8;


	// From: Req1Batch118no_floats
