...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch155has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch155has_floats
	if (last_1_var_1_6 < last_1_var_1_15) {
		var_1_1 = (var_1_4 + (var_1_5 + 64));
	}


	// From: Req4Batch155has_floats
	var_1_13 = var_1_11;


	// From: Req5Batch155has_floats
	var_1_14 = var_1_11;


	// From: Req6Batch155has_floats
	var_1_15 = var_1_5;


	// From: Req2Batch155has_floats
