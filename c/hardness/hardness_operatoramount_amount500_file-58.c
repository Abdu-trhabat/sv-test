...
void step(void) {
	...
	if (stepLocal_2 <= ((last_1_var_1_69 * last_1_var_1_32) + (last_1_var_1_98 * var_1_6))) {
		...
		if ((last_1_var_1_9 * (var_1_24 - var_1_23)) >= (max (var_1_20 , var_1_22))) {
			if (var_1_27) {
	...
	if (last_1_var_1_53 < (var_1_54 / var_1_36)) {
		if ((abs (last_1_var_1_53 / var_1_54)) < 32.5) {
			if (stepLocal_17 < ((last_1_var_1_58 ^ var_1_8) * var_1_56)) {
				var_1_58 = (var_1_59 - var_1_55);
			} else {
				var_1_58 = (max (var_1_7 , (min (var_1_34 , (var_1_8 + var_1_49)))));
			}
		}
	} else {
		if (stepLocal_18 >= (- (var_1_48 - var_1_43))) {
			var_1_58 = (min ((max (var_1_7 , 10u)) , var_1_50));
		}
	}


	// From: Req18Batch58Amount500
	if (last_1_var_1_53 != (max ((var_1_16 + var_1_23) , (min (last_1_var_1_95 , var_1_18))))) {
		var_1_61 = (256.5 + var_1_17);
	} else {
		if (last_1_var_1_61 != last_1_var_1_9) {
			var_1_61 = (min (var_1_20 , (var_1_22 + var_1_62)));
		}
	}
	...
	if (var_1_29) {
		if (stepLocal_12 && var_1_28) {
			if (var_1_22 >= (var_1_95 * var_1_61)) {
				var_1_51 = (max ((var_1_23 + var_1_16) , ((min (var_1_21 , var_1_24)) - (min (var_1_20 , var_1_22)))));
			} else {
				if (var_1_21 <= (abs (var_1_23 - var_1_24))) {
					var_1_51 = (min ((var_1_20 - (min (var_1_21 , var_1_23))) , (max ((var_1_22 - var_1_24) , var_1_52))));
				}
			}
		}
	} else {
		var_1_51 = (abs (var_1_16));
	}
	...
	if ((! (var_1_20 < 2.5)) || stepLocal_5) {
		...
		var_1_42 = (min (var_1_91 , ((var_1_43 - var_1_4) - var_1_8)));
	}


	// From: Req11Batch58Amount500
	if (! var_1_99) {
		var_1_46 = ((min (var_1_16 , var_1_22)) + (min (var_1_19 , (var_1_23 - var_1_20))));
	} else {
		var_1_46 = (abs (var_1_20));
	}
	...
	if (var_1_63) {
		var_1_87 = (abs (var_1_65 + 8));
	} else {
		if (var_1_27) {
			var_1_87 = (abs (var_1_10));
		}
	}
	...
	if (((var_1_8 + var_1_72) - var_1_65) <= stepLocal_27) {
		var_1_102 = (abs ((min (var_1_23 , var_1_21)) - var_1_68));
	} else {
		var_1_102 = var_1_15;
	}
	...
	if (stepLocal_26 > (var_1_56 - var_1_50)) {
		var_1_80 = (var_1_59 - (min (var_1_43 , (var_1_34 - var_1_8))));
	} else {
	...
	if (stepLocal_8 >= var_1_80) {
		if (stepLocal_7 < var_1_43) {
			var_1_44 = (max (var_1_21 , var_1_20));
		} else {
			var_1_44 = 4.375;
		}
	} else {
	...
	if ((var_1_4 * var_1_56) <= stepLocal_16) {
		if (stepLocal_15 >= var_1_98) {
			var_1_57 = (max (var_1_98 , var_1_55));
		} else {
		...
		var_1_57 = (max (var_1_10 , 0u));
	}


	// From: Req1Batch58Amount500
	unsigned long int stepLocal_1 = max (-256 , (var_1_57 / var_1_6));
	unsigned long int stepLocal_0 = var_1_57;
	if ((var_1_76 / (8 + var_1_4)) > stepLocal_1) {
		if (var_1_4 != stepLocal_0) {
			var_1_1 = (min (var_1_4 , (var_1_7 - (min (var_1_76 , var_1_8)))));
		} else {
			var_1_1 = (min (var_1_7 , (var_1_4 + var_1_76)));
		}
	} else {
		var_1_1 = (abs (var_1_4));
	}
	...
	unsigned char stepLocal_19 = (min (var_1_21 , var_1_18)) >= var_1_22;
	if (var_1_36 != (max (var_1_17 , var_1_14))) {
		if (var_1_27) {
			if (var_1_78) {
				if (var_1_15 < (min ((var_1_61 / var_1_54) , var_1_36))) {
					var_1_60 = ((min (var_1_20 , (var_1_22 - 10.15))) + var_1_18);
				}
			} else {
			...
			if (stepLocal_19 || var_1_31) {
				var_1_60 = (min ((255.375 + var_1_23) , var_1_15));
			} else {
				var_1_60 = 8.25;
			}
		}
	...
	if (4 < stepLocal_22) {
		...
		if ((var_1_78 && var_1_99) || stepLocal_23) {
			if (var_1_29) {
				var_1_67 = (min (255.25f , var_1_52));
			}
		} else {
			var_1_67 = (var_1_22 - ((max (var_1_54 , var_1_68)) - (var_1_23 + var_1_24)));
		}
	}
	...
	if (var_1_57 <= 256u) {
		if ((max (var_1_95 , (var_1_24 - var_1_20))) >= var_1_54) {
			var_1_88 = (max (var_1_16 , var_1_23));
		}
	} else {
		var_1_88 = var_1_62;
	}
	...
	if (var_1_28) {
		if (var_1_58 <= stepLocal_21) {
			if (var_1_29) {
				var_1_64 = (var_1_56 + ((abs (var_1_65)) - var_1_50));
			} else {
				var_1_64 = (43260 - (var_1_65 - var_1_66));
			}
		} else {
			var_1_64 = (max ((58460 - var_1_8) , (var_1_7 - (var_1_50 + var_1_76))));
		}
	} else {
		if ((var_1_54 - var_1_20) > var_1_46) {
			if (stepLocal_20 == var_1_57) {
				var_1_64 = (min ((var_1_7 - var_1_76) , var_1_50));
			} else {
				var_1_64 = (var_1_8 + var_1_87);
			}
		} else {
			var_1_64 = ((abs (min (var_1_7 , var_1_43))) - var_1_87);
		}
	}
	...
	if (stepLocal_14 <= ((var_1_49 + var_1_50) / var_1_6)) {
		var_1_53 = ((var_1_54 - var_1_22) - (abs (var_1_16)));
	} else {
		if (stepLocal_13 != (var_1_64 ^ (var_1_93 + var_1_49))) {
			var_1_53 = (var_1_21 - var_1_54);
		} else {
			var_1_53 = (min ((var_1_21 - var_1_23) , 25.3));
		}
	}
	...
	if (var_1_8 == stepLocal_10) {
		...
		var_1_47 = (max ((max (var_1_49 , var_1_4)) , var_1_50));
	}
	...
	if (var_1_54 >= var_1_20) {
		if (stepLocal_25 && (var_1_101 > var_1_80)) {
			if (stepLocal_24 == var_1_56) {
				...
				var_1_73 = (((min (var_1_74 , var_1_49)) + (max (var_1_55 , var_1_4))) - (abs (var_1_66)));
			}
		}
	} else {
		var_1_73 = ((var_1_75 - (var_1_58 + var_1_56)) - (max ((max (var_1_74 , var_1_71)) , var_1_4)));
	}


	// From: Req28Batch58Amount500
	if ((min (var_1_54 , (var_1_51 + var_1_16))) < var_1_88) {
		var_1_81 = var_1_18;
	} else {
	...
	if ((max (var_1_43 , var_1_48)) <= ((var_1_96 + var_1_98) + var_1_32)) {
		if (var_1_25) {
			var_1_69 = (var_1_43 - (min (var_1_93 , (min (var_1_8 , var_1_32)))));
		}
	} else {
		var_1_69 = (max (var_1_10 , var_1_8));
	}
	...
	if (var_1_30) {
		if (var_1_7 != (var_1_58 ^ var_1_101)) {
			...
			if ((var_1_6 + var_1_98) >= (abs (var_1_7))) {
				var_1_41 = (abs (max (var_1_20 , var_1_18)));
			} else {
				var_1_41 = (var_1_23 + (min (var_1_22 , 64.25)));
			}
		}
	}
	...
	if ((abs (abs (var_1_68))) > var_1_41) {
		var_1_85 = (abs (var_1_23));
	} else {
		var_1_85 = var_1_68;
	}
	...
	if (var_1_7 < (var_1_10 - var_1_58)) {
		if (var_1_8 > var_1_58) {
			if ((min (var_1_96 , var_1_10)) < ((max (10000 , var_1_64)) - var_1_58)) {
				if ((max (var_1_51 , var_1_41)) != var_1_61) {
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((var_1_76 / (8 + var_1_4)) > (max (-256 , (var_1_57 / var_1_6)))) ? ((var_1_4 != var_1_57) ? (var_1_1 == ((unsigned short int) (min (var_1_4 , (var_1_7 - (min (var_1_76 , var_1_8))))))) : (var_1_1 == ((unsigned short int) (min (var_1_7 , (var_1_4 + var_1_76)))))) : (var_1_1 == ((unsigned short int) (abs (var_1_4))))) && ((var_1_7 < (var_1_10 - var_1_58)) ? ((var_1_8 > var_1_58) ? (((min (var_1_96 , var_1_10)) < ((max (10000 , var_1_64)) - var_1_58)) ? (((max (var_1_51 , var_1_41)) != var_1_61) ? ((var_1_58 >= (var_1_7 * var_1_4)) ? (var_1_9 == ((double) (min ((max (var_1_14 , (abs (var_1_15)))) , ((var_1_16 + var_1_17) + (var_1_18 + var_1_19)))))) : 1) : (var_1_9 == ((double) ((7.204363062650301E18 - var_1_20) - (min (var_1_21 , (7.812042275699702E18 - var_1_22))))))) : (var_1_9 == ((double) ((abs (var_1_19)) + ((var_1_23 + var_1_24) - var_1_20))))) : (var_1_9 == ((double) (max (var_1_16 , var_1_24))))) : 1)) && ((last_1_var_1_57 <= ((last_1_var_1_69 * last_1_var_1_32) + (last_1_var_1_98 * var_1_6))) ? (var_1_25 == ((unsigned char) (! var_1_27))) : (((last_1_var_1_9 * (var_1_24 - var_1_23)) >= (max (var_1_20 , var_1_22))) ? (var_1_27 ? (var_1_25 == ((unsigned char) ((var_1_28 || var_1_29) || var_1_30))) : (var_1_25 == ((unsigned char) ((! var_1_29) || var_1_31)))) : (var_1_25 == ((unsigned char) var_1_31))))) && ((var_1_93 >= var_1_1) ? (var_1_27 ? (var_1_32 == ((unsigned long int) ((var_1_96 + var_1_7) + (var_1_34 - var_1_8)))) : 1) : 1)) && ((var_1_21 >= (var_1_53 / var_1_36)) ? (var_1_35 == ((double) ((var_1_24 - var_1_20) + var_1_19))) : (((var_1_90 < var_1_10) && var_1_38) ? (var_1_35 == ((double) (var_1_20 - 999.3))) : ((var_1_1 < var_1_6) ? (var_1_27 ? (var_1_35 == ((double) (max (var_1_17 , var_1_15)))) : ((var_1_102 > var_1_21) ? ((var_1_14 == var_1_53) ? (var_1_35 == ((double) (var_1_17 + (max ((var_1_19 + var_1_23) , var_1_16))))) : 1) : (var_1_35 == ((double) ((abs (var_1_17)) + var_1_19))))) : (var_1_35 == ((double) (min (var_1_23 , (var_1_19 + var_1_22))))))))) && (var_1_38 ? (var_1_30 ? (var_1_37 == ((unsigned short int) var_1_8)) : (var_1_37 == ((unsigned short int) var_1_80))) : 1)) && (last_1_var_1_25 ? (var_1_38 == ((unsigned char) (! ((var_1_27 && var_1_31) && var_1_40)))) : 1)) && (var_1_30 ? ((var_1_7 != (var_1_58 ^ var_1_101)) ? (var_1_41 == ((double) ((var_1_23 + var_1_22) - var_1_20))) : (((var_1_6 + var_1_98) >= (abs (var_1_7))) ? (var_1_41 == ((double) (abs (max (var_1_20 , var_1_18))))) : (var_1_41 == ((double) (var_1_23 + (min (var_1_22 , 64.25))))))) : 1)) && (((! (var_1_20 < 2.5)) || var_1_28) ? ((var_1_27 && ((var_1_90 + var_1_4) <= var_1_6)) ? (var_1_42 == ((unsigned short int) var_1_7)) : 1) : (var_1_42 == ((unsigned short int) (min (var_1_91 , ((var_1_43 - var_1_4) - var_1_8))))))) && ((var_1_34 >= var_1_80) ? ((var_1_87 < var_1_43) ? (var_1_44 == ((double) (max (var_1_21 , var_1_20)))) : (var_1_44 == ((double) 4.375))) : ((var_1_34 > var_1_80) ? (var_1_44 == ((double) var_1_24)) : (var_1_44 == ((double) 999999.25))))) && ((! var_1_99) ? (var_1_46 == ((double) ((min (var_1_16 , var_1_22)) + (min (var_1_19 , (var_1_23 - var_1_20)))))) : (var_1_46 == ((double) (abs (var_1_20)))))) && ((var_1_8 == var_1_101) ? (((var_1_80 + (var_1_48 - var_1_10)) < var_1_57) ? ((var_1_46 < 1.5) ? (var_1_47 == ((unsigned char) (var_1_49 - var_1_4))) : 1) : (var_1_47 == ((unsigned char) var_1_4))) : (var_1_47 == ((unsigned char) (max ((max (var_1_49 , var_1_4)) , var_1_50)))))) && (var_1_29 ? ((var_1_38 && var_1_28) ? ((var_1_22 >= (var_1_95 * var_1_61)) ? (var_1_51 == ((double) (max ((var_1_23 + var_1_16) , ((min (var_1_21 , var_1_24)) - (min (var_1_20 , var_1_22))))))) : ((var_1_21 <= (abs (var_1_23 - var_1_24))) ? (var_1_51 == ((double) (min ((var_1_20 - (min (var_1_21 , var_1_23))) , (max ((var_1_22 - var_1_24) , var_1_52)))))) : 1)) : 1) : (var_1_51 == ((double) (abs (var_1_16)))))) && (((128 % var_1_43) <= ((var_1_49 + var_1_50) / var_1_6)) ? (var_1_53 == ((double) ((var_1_54 - var_1_22) - (abs (var_1_16))))) : (((var_1_50 >> (var_1_55 - var_1_56)) != (var_1_64 ^ (var_1_93 + var_1_49))) ? (var_1_53 == ((double) (var_1_21 - var_1_54))) : (var_1_53 == ((double) (min ((var_1_21 - var_1_23) , 25.3))))))) && (((var_1_4 * var_1_56) <= var_1_55) ? ((-2 >= var_1_98) ? (var_1_57 == ((unsigned long int) (max (var_1_98 , var_1_55)))) : (((var_1_54 / var_1_36) <= (var_1_24 + (var_1_102 * var_1_52))) ? (var_1_57 == ((unsigned long int) (var_1_43 + var_1_8))) : (var_1_57 == ((unsigned long int) (var_1_37 + (var_1_55 + var_1_56)))))) : (var_1_57 == ((unsigned long int) (max (var_1_10 , 0u)))))) && ((last_1_var_1_53 < (var_1_54 / var_1_36)) ? (((abs (last_1_var_1_53 / var_1_54)) < 32.5) ? (((- last_1_var_1_93) < ((last_1_var_1_58 ^ var_1_8) * var_1_56)) ? (var_1_58 == ((unsigned long int) (var_1_59 - var_1_55))) : (var_1_58 == ((unsigned long int) (max (var_1_7 , (min (var_1_34 , (var_1_8 + var_1_49)))))))) : 1) : ((((var_1_55 / 32) / 32) >= (- (var_1_48 - var_1_43))) ? (var_1_58 == ((unsigned long int) (min ((max (var_1_7 , 10u)) , var_1_50)))) : 1))) && ((var_1_36 != (max (var_1_17 , var_1_14))) ? (var_1_27 ? (var_1_78 ? ((var_1_15 < (min ((var_1_61 / var_1_54) , var_1_36))) ? (var_1_60 == ((double) ((min (var_1_20 , (var_1_22 - 10.15))) + var_1_18))) : 1) : (var_1_60 == ((double) (var_1_23 + var_1_18)))) : ((((min (var_1_21 , var_1_18)) >= var_1_22) || var_1_31) ? (var_1_60 == ((double) (min ((255.375 + var_1_23) , var_1_15)))) : (var_1_60 == ((double) 8.25)))) : (var_1_60 == ((double) var_1_52)))) && ((last_1_var_1_53 != (max ((var_1_16 + var_1_23) , (min (last_1_var_1_95 , var_1_18))))) ? (var_1_61 == ((double) (256.5 + var_1_17))) : ((last_1_var_1_61 != last_1_var_1_9) ? (var_1_61 == ((double) (min (var_1_20 , (var_1_22 + var_1_62))))) : 1))) && (var_1_97 ? (var_1_63 == ((unsigned char) (! (! 1)))) : 1)) && (var_1_28 ? ((var_1_58 <= var_1_80) ? (var_1_29 ? (var_1_64 == ((unsigned short int) (var_1_56 + ((abs (var_1_65)) - var_1_50)))) : (var_1_64 == ((unsigned short int) (43260 - (var_1_65 - var_1_66))))) : (var_1_64 == ((unsigned short int) (max ((58460 - var_1_8) , (var_1_7 - (var_1_50 + var_1_76))))))) : (((var_1_54 - var_1_20) > var_1_46) ? ((var_1_87 == var_1_57) ? (var_1_64 == ((unsigned short int) (min ((var_1_7 - var_1_76) , var_1_50)))) : (var_1_64 == ((unsigned short int) (var_1_8 + var_1_87)))) : (var_1_64 == ((unsigned short int) ((abs (min (var_1_7 , var_1_43))) - var_1_87)))))) && ((4 < (var_1_7 + var_1_98)) ? (var_1_67 == ((float) var_1_62)) : (((var_1_78 && var_1_99) || var_1_38) ? (var_1_29 ? (var_1_67 == ((float) (min (255.25f , var_1_52)))) : 1) : (var_1_67 == ((float) (var_1_22 - ((max (var_1_54 , var_1_68)) - (var_1_23 + var_1_24)))))))) && (((max (var_1_43 , var_1_48)) <= ((var_1_96 + var_1_98) + var_1_32)) ? (var_1_25 ? (var_1_69 == ((signed long int) (var_1_43 - (min (var_1_93 , (min (var_1_8 , var_1_32))))))) : 1) : (var_1_69 == ((signed long int) (max (var_1_10 , var_1_8)))))) && ((var_1_18 < var_1_22) ? (var_1_70 == ((signed short int) (((var_1_37 + var_1_4) + (var_1_71 - var_1_50)) - (17461 - (var_1_72 - var_1_49))))) : 1)) && ((var_1_54 >= var_1_20) ? ((var_1_25 && (var_1_101 > var_1_80)) ? (((var_1_72 / var_1_4) == var_1_56) ? (var_1_73 == ((signed short int) var_1_43)) : (var_1_73 == ((signed short int) (((min (var_1_74 , var_1_49)) + (max (var_1_55 , var_1_4))) - (abs (var_1_66)))))) : 1) : (var_1_73 == ((signed short int) ((var_1_75 - (var_1_58 + var_1_56)) - (max ((max (var_1_74 , var_1_71)) , var_1_4))))))) && ((var_1_100 > var_1_95) ? (var_1_76 == ((unsigned char) var_1_56)) : (var_1_76 == ((unsigned char) var_1_55)))) && ((var_1_46 <= var_1_44) ? (var_1_78 == ((unsigned char) (((var_1_99 && var_1_29) || var_1_30) || var_1_79))) : (var_1_78 == ((unsigned char) (var_1_40 || (var_1_29 || var_1_27)))))) && ((var_1_87 > (var_1_56 - var_1_50)) ? (var_1_80 == ((unsigned long int) (var_1_59 - (min (var_1_43 , (var_1_34 - var_1_8)))))) : (var_1_80 == ((unsigned long int) (var_1_59 - var_1_74))))) && (((min (var_1_54 , (var_1_51 + var_1_16))) < var_1_88) ? (var_1_81 == ((double) var_1_18)) : (var_1_81 == ((double) ((var_1_23 - var_1_24) + (var_1_22 - var_1_20)))))) && ((var_1_14 > (- (var_1_53 / var_1_36))) ? (var_1_82 == ((unsigned char) ((64 + var_1_83) - ((16 + var_1_56) + var_1_55)))) : (var_1_82 == ((unsigned char) (var_1_49 - var_1_55))))) && (var_1_84 == ((float) (var_1_17 + (var_1_22 - var_1_24))))) && (((abs (abs (var_1_68))) > var_1_41) ? (var_1_85 == ((float) (abs (var_1_23)))) : (var_1_85 == ((float) var_1_68)))) && (var_1_63 ? (var_1_87 == ((signed long int) (abs (var_1_65 + 8)))) : (var_1_27 ? (var_1_87 == ((signed long int) (abs (var_1_10)))) : 1))) && ((var_1_57 <= 256u) ? (((max (var_1_95 , (var_1_24 - var_1_20))) >= var_1_54) ? (var_1_88 == ((double) (max (var_1_16 , var_1_23)))) : 1) : (var_1_88 == ((double) var_1_62)))) && (var_1_89 == ((float) var_1_68))) && (var_1_90 == ((unsigned long int) var_1_65))) && (var_1_30 ? (var_1_91 == ((unsigned char) var_1_50)) : (var_1_91 == ((unsigned char) var_1_4)))) && (var_1_25 ? (var_1_92 == ((signed char) var_1_56)) : (var_1_92 == ((signed char) 64)))) && (var_1_27 ? (var_1_93 == ((signed long int) last_1_var_1_1)) : 1)) && (var_1_94 == ((float) var_1_21))) && (var_1_95 == ((double) var_1_18))) && (var_1_96 == ((unsigned long int) last_1_var_1_96))) && (var_1_29 ? (var_1_97 == ((unsigned char) var_1_79)) : (var_1_97 == ((unsigned char) 0)))) && (var_1_98 == ((signed long int) var_1_49))) && (var_1_99 == ((unsigned char) var_1_29))) && (var_1_28 ? (var_1_100 == ((float) 32.38f)) : (var_1_100 == ((float) var_1_17)))) && (var_1_38 ? (var_1_101 == ((signed long int) var_1_64)) : (var_1_101 == ((signed long int) var_1_7)))) && ((((var_1_8 + var_1_72) - var_1_65) <= (var_1_87 * var_1_43)) ? (var_1_102 == ((double) (abs ((min (var_1_23 , var_1_21)) - var_1_68)))) : (var_1_102 == ((double) var_1_15)))
;
}
int main(void) {
	isInitial = 1;
