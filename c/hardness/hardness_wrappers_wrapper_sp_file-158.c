...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_7_Pointer))) {
		if ((*(WrapperStruct00_var_1_14_Pointer)) <= stepLocal_1) {
			(*(WrapperStruct00_var_1_17_Pointer)) = (max ((*(WrapperStruct00_var_1_10_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer))));
		} else {
