...
double functionized2(void) {
	return (min (var_1_8 , (min (var_1_9 , var_1_14))));
}
double functionized3(void) {
	return (min (var_1_5 , (var_1_3 - var_1_4)));
}
...
void step(void) {
	// From: Req1Batch73functionizing
	if (var_1_2 > (functionized0() / (max (var_1_5 , var_1_6)))) {
		if (var_1_7) {
			var_1_1 = var_1_8;
		} else {
			var_1_1 = var_1_9;
	...
	// From: Req2Batch73functionizing
	if (functionized1(var_1_7)) {
		var_1_10 = (max (var_1_11 , var_1_12));
	}


	// From: Req3Batch73functionizing
	var_1_13 = functionized2();


	// From: Req4Batch73functionizing
	...
	// From: Req6Batch73functionizing
	if (var_1_6 <= (max (var_1_5 , var_1_21))) {
		var_1_20 = (var_1_18 + var_1_19);
	}


	// From: Req7Batch73functionizing
...
int property(void) {
	return (((((((var_1_2 > ((var_1_3 - var_1_4) / (max (var_1_5 , var_1_6)))) ? (var_1_7 ? (var_1_1 == ((double) var_1_8)) : (var_1_1 == ((double) var_1_9))) : (var_1_1 == ((double) var_1_9))) && ((! var_1_7) ? (var_1_10 == ((unsigned char) (max (var_1_11 , var_1_12)))) : 1)) && (var_1_13 == ((double) (min (var_1_8 , (min (var_1_9 , var_1_14))))))) && ((((var_1_8 + var_1_13) / 63.75f) < (min (var_1_5 , (var_1_3 - var_1_4)))) ? (var_1_15 == ((signed long int) var_1_10)) : (var_1_15 == ((signed long int) var_1_11)))) && (((var_1_8 >= var_1_4) || (var_1_12 > var_1_11)) ? ((var_1_13 != var_1_8) ? (var_1_16 == ((float) (1.975f + ((var_1_17 - var_1_18) - var_1_19)))) : 1) : (var_1_16 == ((float) (var_1_19 - var_1_18))))) && ((var_1_6 <= (max (var_1_5 , var_1_21))) ? (var_1_20 == ((float) (var_1_18 + var_1_19))) : 1)) && (((var_1_15 == var_1_10) && var_1_7) ? ((var_1_7 || (var_1_1 <= var_1_13)) ? (var_1_22 == ((unsigned char) (min ((var_1_23 + var_1_24) , var_1_11)))) : (var_1_22 == ((unsigned char) var_1_23))) : (var_1_22 == ((unsigned char) var_1_12)))
;
}
int main(void) {
	isInitial = 1;
