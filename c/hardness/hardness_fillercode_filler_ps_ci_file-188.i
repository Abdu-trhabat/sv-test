...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch188Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
  ...
  var_1_25
                   ...
                   if (var_1_16) {
                    if ( (( (((((var_1_3)) > ((var_1_2))) ? ((var_1_3)) : ((var_1_2))))) >= ( ((var_1_19) + (var_1_2))))) {
                     var_1_27 = (
    ...
    var_1_42
                   ...
                   if ( ((2) <= ( ((var_1_14) & ( ((var_1_42) >> (var_1_6))))))) {
                    var_1_43 = (
