...
void step(void) {
 ...
 if (var_1_3 < stepLocal_4) {
  if (last_1_var_1_5 < stepLocal_3) {
   var_1_5 = (var_1_4 + last_1_var_1_5);
  } else {
   var_1_5 = last_1_var_1_5;
  }
 }
 unsigned char stepLocal_6 = var_1_2;
 unsigned long int stepLocal_5 = ~ (var_1_5 + var_1_4);
 if ((var_1_3 % var_1_7) < stepLocal_5) {
  if (stepLocal_6 && (var_1_8 && var_1_9)) {
   var_1_6 = var_1_10;
  }
 } else {
  var_1_6 = var_1_10;
...
int property(void) {
 return ((var_1_2 ? (var_1_1 == ((unsigned short int) (var_1_3 - var_1_4))) : ((var_1_3 == var_1_4) ? ((var_1_3 < 4) ? (var_1_1 == ((unsigned short int) var_1_4)) : (((- 4) < var_1_3) ? (var_1_1 == ((unsigned short int) ((((var_1_3) < (var_1_4)) ? (var_1_3) : (var_1_4))))) : (var_1_1 == ((unsigned short int) var_1_3)))) : (var_1_1 == ((unsigned short int) var_1_4)))) && ((var_1_3 < var_1_4) ? ((last_1_var_1_5 < var_1_3) ? (var_1_5 == ((unsigned long int) (var_1_4 + last_1_var_1_5))) : (var_1_5 == ((unsigned long int) last_1_var_1_5))) : 1)) && (((var_1_3 % var_1_7) < (~ (var_1_5 + var_1_4))) ? ((var_1_2 && (var_1_8 && var_1_9)) ? (var_1_6 == ((double) var_1_10)) : 1) : (var_1_6 == ((double) var_1_10)))
;
}
int main(void) {
 isInitial = 1;
