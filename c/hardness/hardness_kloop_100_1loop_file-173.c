...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch173100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req10Batch173100_1loop
	var_1_31 = (var_1_11 + (min (var_1_20 , (max (var_1_24 , var_1_12)))));


	// From: Req9Batch173100_1loop
