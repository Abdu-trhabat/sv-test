...
void step(void) {
 ...
 if ((- (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) >= 16.75) {
  if (stepLocal_0 >= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) {
   if ((((((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer))) < ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)))) ? ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer))) : ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer))))) > stepLocal_1) {
