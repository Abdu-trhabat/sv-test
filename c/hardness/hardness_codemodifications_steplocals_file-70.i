...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch70stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_6 > ((((var_1_8) < (var_1_1)) ? (var_1_8) : (var_1_1)))) {
  if (! ((var_1_1 == var_1_7) && (var_1_2 || var_1_10))) {
   if (! (var_1_6 <= var_1_7)) {
    var_1_9 = ((((var_1_3) < (var_1_4)) ? (var_1_3) : (var_1_4)));
   }
  } else {
   var_1_9 = var_1_4;
  }
 }
 var_1_11 = (var_1_3 + (((((var_1_9) < (var_1_4)) ? (var_1_9) : (var_1_4))) + 2u));
 if (var_1_2) {
  var_1_12 = var_1_13;
 }
 ...
 if ((var_1_5 / var_1_19) <= ((((var_1_4) < (var_1_9)) ? (var_1_4) : (var_1_9)))) {
  var_1_20 = var_1_13;
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((((var_1_3 >= (- ((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5))))) ? (var_1_1 == ((double) (((var_1_6 - var_1_7) - ((((64.75) > (128.725)) ? (64.75) : (128.725)))) + var_1_8))) : (var_1_1 == ((double) var_1_7))) && ((var_1_6 > ((((var_1_8) < (var_1_1)) ? (var_1_8) : (var_1_1)))) ? ((! ((var_1_1 == var_1_7) && (var_1_2 || var_1_10))) ? ((! (var_1_6 <= var_1_7)) ? (var_1_9 == ((unsigned short int) ((((var_1_3) < (var_1_4)) ? (var_1_3) : (var_1_4))))) : 1) : (var_1_9 == ((unsigned short int) var_1_4))) : 1)) && (var_1_11 == ((unsigned long int) (var_1_3 + (((((var_1_9) < (var_1_4)) ? (var_1_9) : (var_1_4))) + 2u))))) && (var_1_2 ? (var_1_12 == ((unsigned char) var_1_13)) : 1)) && (((8 - 64) <= (var_1_9 - var_1_3)) ? (var_1_14 == ((unsigned char) (((((var_1_15 + var_1_16)) < (var_1_17)) ? ((var_1_15 + var_1_16)) : (var_1_17))))) : (var_1_14 == ((unsigned char) var_1_17)))) && (var_1_13 ? (var_1_18 == ((unsigned long int) ((var_1_19 - var_1_9) - var_1_14))) : (var_1_18 == ((unsigned long int) (((((var_1_19 - var_1_17)) > (var_1_15)) ? ((var_1_19 - var_1_17)) : (var_1_15))))))) && (((var_1_5 / var_1_19) <= ((((var_1_4) < (var_1_9)) ? (var_1_4) : (var_1_9)))) ? (var_1_20 == ((unsigned char) var_1_13)) : 1)
;
}
int main(void) {
 isInitial = 1;
