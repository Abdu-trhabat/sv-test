...
void step(void) {
	// From: Req1Batch115Wrapper_A
	if ((float_Array_0[2] * last_1_double_Array_0_1__1_) >= (max (float_Array_0[1] , float_Array_0[0]))) {
	...
	// From: Req3Batch115Wrapper_A
	signed_short_int_Array_0[0][0] = (min ((signed_short_int_Array_0[1][0] - (abs (signed_short_int_Array_0[0][1]))) , signed_short_int_Array_0[1][1]));


	// From: Req4Batch115Wrapper_A
...
int property(void) {
	return (((((float_Array_0[2] * last_1_double_Array_0_1__1_) >= (max (float_Array_0[1] , float_Array_0[0]))) ? (double_Array_0[1][1] == ((double) (double_Array_0[0][1] + double_Array_0[0][0]))) : ((last_1_double_Array_0_1__1_ <= double_Array_0[0][0]) ? (double_Array_0[1][1] == ((double) double_Array_0[0][0])) : (double_Array_0[1][1] == ((double) 3.2)))) && ((double_Array_0[1][0] > (- double_Array_0[0][1])) ? (unsigned_long_int_Array_0[1][0] == ((unsigned long int) (unsigned_long_int_Array_0[0][0] - (unsigned_long_int_Array_0[0][1] - unsigned_long_int_Array_0[1][1])))) : 1)) && (signed_short_int_Array_0[0][0] == ((signed short int) (min ((signed_short_int_Array_0[1][0] - (abs (signed_short_int_Array_0[0][1]))) , signed_short_int_Array_0[1][1]))))) && (((signed_short_int_Array_0[0][0] ^ unsigned_long_int_Array_0[1][1]) < (- unsigned_long_int_Array_0[0][0])) ? ((double_Array_0[0][1] >= double_Array_0[0][0]) ? ((double_Array_0[1][1] > (- double_Array_0[1][1])) ? (double_Array_0[1][0] == ((double) double_Array_0[0][1])) : 1) : (double_Array_0[1][0] == ((double) double_Array_0[0][0]))) : (double_Array_0[1][0] == ((double) double_Array_0[0][1])))
;
}
int main(void) {
	isInitial = 1;
