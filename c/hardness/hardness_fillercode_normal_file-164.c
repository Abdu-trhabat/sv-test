...
void step(void) {
	...
	// From: Req3Batch164normal
	if ((min (var_1_6 , var_1_17)) == (var_1_17 + var_1_7)) {
		var_1_14 = (var_1_15 || var_1_16);
	}


	// From: Req5Batch164normal
	...
	// From: Req6Batch164normal
	unsigned long int stepLocal_2 = var_1_17;
	if ((max (var_1_5 , var_1_17)) >= stepLocal_2) {
	...
	// From: Req7Batch164normal
	if ((var_1_21 / (abs (var_1_30))) <= var_1_19) {
		var_1_29 = var_1_6;
	}


	// From: Req2Batch164normal
	if (var_1_24) {
		if ((- var_1_10) < 127.25f) {
...
int property(void) {
	return ((((((((4 <= var_1_2) || (var_1_3 < var_1_4)) ? (var_1_1 == ((signed char) (var_1_5 + (max (var_1_6 , var_1_7))))) : 1) && (var_1_24 ? (((- var_1_10) < 127.25f) ? (var_1_8 == ((float) (min ((var_1_11 + var_1_12) , var_1_13)))) : 1) : (var_1_8 == ((float) var_1_11)))) && (((min (var_1_6 , var_1_17)) == (var_1_17 + var_1_7)) ? (var_1_14 == ((unsigned char) (var_1_15 || var_1_16))) : 1)) && ((last_1_var_1_19 >= 4) ? ((var_1_16 || last_1_var_1_14) ? (var_1_17 == ((unsigned long int) var_1_18)) : 1) : 1)) && ((var_1_11 != (- var_1_12)) ? ((! var_1_16) ? (var_1_19 == ((unsigned long int) (var_1_20 + var_1_21))) : 1) : ((var_1_16 && (var_1_17 <= (var_1_22 - var_1_23))) ? (var_1_19 == ((unsigned long int) var_1_21)) : 1))) && (((max (var_1_5 , var_1_17)) >= var_1_17) ? (var_1_24 == ((unsigned char) (var_1_25 && (var_1_26 && (var_1_27 && var_1_28))))) : (var_1_24 == ((unsigned char) var_1_25)))) && (((var_1_21 / (abs (var_1_30))) <= var_1_19) ? (var_1_29 == ((signed char) var_1_6)) : 1)
;
}
int main(void) {
	isInitial = 1;
