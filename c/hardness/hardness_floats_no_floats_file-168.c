...
void step(void) {
	// From: Req4Batch168no_floats
	var_1_12 = var_1_2;


	// From: Req5Batch168no_floats
	var_1_13 = -5;


	// From: Req6Batch168no_floats
	var_1_14 = var_1_2;


	// From: Req1Batch168no_floats
	...
	// From: Req3Batch168no_floats
	signed char stepLocal_2 = var_1_2;
	if ((max (var_1_7 , (var_1_13 + var_1_8))) < (16 + -128)) {
...
int property(void) {
	return (((((((1 - var_1_2) == var_1_12) ? (var_1_1 == ((signed long int) (max (2 , 25)))) : (var_1_1 == ((signed long int) (var_1_2 + var_1_4)))) && ((! var_1_6) ? ((var_1_2 > var_1_1) ? (var_1_5 == ((signed long int) (var_1_7 + var_1_8))) : 1) : (var_1_5 == ((signed long int) (min (var_1_7 , var_1_8)))))) && (((max (var_1_7 , (var_1_13 + var_1_8))) < (16 + -128)) ? ((((var_1_4 * -1) | var_1_1) < var_1_2) ? (var_1_9 == ((signed short int) (max ((min (var_1_2 , var_1_10)) , var_1_11)))) : 1) : 1)) && (var_1_12 == ((signed long int) var_1_2))) && (var_1_13 == ((signed long int) -5))) && (var_1_14 == ((unsigned short int) var_1_2))
;
}
int main(void) {
	isInitial = 1;
