...
void step(void) {
	...
	if (WrapperStruct00.var_1_2 > WrapperStruct00.var_1_1) {
		if (WrapperStruct00.var_1_9) {
			if (WrapperStruct00.var_1_3 <= (min (WrapperStruct00.var_1_1 , WrapperStruct00.var_1_11))) {
