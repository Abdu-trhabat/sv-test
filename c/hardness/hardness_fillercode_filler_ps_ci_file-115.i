...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch115Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
  ...
  var_1_21
                   ...
                   if (var_1_42) {
                    if ( ((var_1_43) && (var_1_44))) {
                     if ( ((var_1_35) < (var_1_36))) {
                      if ( (( ((var_1_36) | (var_1_9))) < ( (((((var_1_9)) < ((var_1_15))) ? ((var_1_9)) : ((var_1_15))))))) {
                       var_1_41 = (
      var_1_38
     );
    } else {
    ...
    var_1_9
                      ...
                      ((((( var_1_10 )) > (( var_1_20 ))) ? (( var_1_10 )) : (( var_1_20 ))))
   ))
  );
 }
                   if ( (( ((50u) ^ (var_1_9))) > ( ((var_1_10) * (var_1_4))))) {
                    var_1_46 = (
                     (((((((((( var_1_24 ) - ( var_1_23 ))) < 0 ) ? -((( var_1_24 ) - ( var_1_23 ))) : ((( var_1_24 ) - ( var_1_23 )))))) < 0 ) ? -((((((( var_1_24 ) - ( var_1_23 ))) < 0 ) ? -((( var_1_24 ) - ( var_1_23 ))) : ((( var_1_24 ) - ( var_1_23 )))))) : ((((((( var_1_24 ) - ( var_1_23 ))) < 0 ) ? -((( var_1_24 ) - ( var_1_23 ))) : ((( var_1_24 ) - ( var_1_23 ))))))))
  );
 } else {
                    if (var_1_7) {
                     var_1_46 = (
                      ((((( var_1_23 )) < (( ((((( var_1_24 )) < (( var_1_23 ))) ? (( var_1_24 )) : (( var_1_23 )))) ))) ? (( var_1_23 )) : (( ((((( var_1_24 )) < (( var_1_23 ))) ? (( var_1_24 )) : (( var_1_23 )))) ))))
   );
  }
 }
                   if (var_1_7) {
