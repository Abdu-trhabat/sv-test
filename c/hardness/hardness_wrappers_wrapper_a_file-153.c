...
void step(void) {
	// From: Req1Batch153Wrapper_A
	if (last_1_signed_short_int_Array_0_1_ <= ((abs (-32)) + 16)) {
		unsigned_long_int_Array_0[1] = (abs (unsigned_long_int_Array_0[0]));
	} else {
		unsigned_long_int_Array_0[1] = unsigned_long_int_Array_0[0];
	}


	// From: Req3Batch153Wrapper_A
	unsigned_short_int_Array_0[2] = ((abs (unsigned_short_int_Array_0[1])) + unsigned_short_int_Array_0[0]);


	// From: Req6Batch153Wrapper_A
	double_Array_0[2] = double_Array_0[1];


	// From: Req7Batch153Wrapper_A
	signed_short_int_Array_0[0] = unsigned_short_int_Array_0[2];


	// From: Req4Batch153Wrapper_A
	...
	if ((signed_short_int_Array_0[1] / signed_char_Array_0[0]) == stepLocal_1) {
		if (BOOL_unsigned_char_Array_0[0][1]) {
			double_Array_0[0] = (min (double_Array_0[1] , 1000000.5));
		}
	}
}
...
int property(void) {
	return (((((((last_1_signed_short_int_Array_0_1_ <= ((abs (-32)) + 16)) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) (abs (unsigned_long_int_Array_0[0])))) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_long_int_Array_0[0]))) && ((signed_short_int_Array_0[0] <= unsigned_long_int_Array_0[0]) ? ((signed_short_int_Array_0[0] <= unsigned_long_int_Array_0[1]) ? (BOOL_unsigned_char_Array_0[1][0] ? (signed_short_int_Array_0[1] == ((signed short int) signed_short_int_Array_0[0])) : 1) : 1) : 1)) && (unsigned_short_int_Array_0[2] == ((unsigned short int) ((abs (unsigned_short_int_Array_0[1])) + unsigned_short_int_Array_0[0])))) && ((unsigned_short_int_Array_0[2] <= signed_short_int_Array_0[0]) ? (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) (! BOOL_unsigned_char_Array_0[0][1]))) : (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) (BOOL_unsigned_char_Array_0[1][1] && BOOL_unsigned_char_Array_0[0][0]))))) && (((signed_short_int_Array_0[1] / signed_char_Array_0[0]) == unsigned_long_int_Array_0[1]) ? (BOOL_unsigned_char_Array_0[0][1] ? (double_Array_0[0] == ((double) (min (double_Array_0[1] , 1000000.5)))) : 1) : 1)) && (double_Array_0[2] == ((double) double_Array_0[1]))) && (signed_short_int_Array_0[0] == ((signed short int) unsigned_short_int_Array_0[2]))
;
}
int main(void) {
	isInitial = 1;
