...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch170100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch170100_while
	if (var_1_5 != ((var_1_9 - var_1_21) - var_1_25)) {
		var_1_27 = var_1_28;
	}


	// From: Req11Batch170100_while
	var_1_34 = (min (var_1_13 , var_1_12));


	// From: Req4Batch170100_while
	if (var_1_27) {
		var_1_20 = var_1_21;
	}


	// From: Req5Batch170100_while
