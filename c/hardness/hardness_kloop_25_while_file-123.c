...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12325_while.c", 13, "reach_error"); }
...
unsigned short int var_1_8 = 52121;
unsigned short int var_1_9 = 54711;
...
void step(void) {
	...
	// From: Req2Batch12325_while
	var_1_7 = ((min (var_1_8 , var_1_9)) - (var_1_10 + 1));


	// From: Req3Batch12325_while
	signed long int stepLocal_2 = var_1_10 * var_1_6;
	...
	// From: Req4Batch12325_while
	var_1_17 = (max (0 , var_1_13));


	// From: Req5Batch12325_while
	var_1_18 = var_1_13;


	// From: Req6Batch12325_while
	var_1_19 = var_1_16;
}
...
int property(void) {
	return ((((((var_1_2 || var_1_3) ? (var_1_1 == ((signed long int) ((256 + var_1_4) - (min (var_1_5 , var_1_6))))) : ((var_1_4 <= var_1_6) ? (var_1_1 == ((signed long int) var_1_6)) : 1)) && (var_1_7 == ((unsigned short int) ((min (var_1_8 , var_1_9)) - (var_1_10 + 1))))) && (((var_1_10 * var_1_6) > var_1_7) ? (var_1_11 == ((signed char) (var_1_12 + var_1_13))) : (var_1_11 == ((signed char) (var_1_14 - (var_1_15 + var_1_16)))))) && (var_1_17 == ((signed char) (max (0 , var_1_13))))) && (var_1_18 == ((signed char) var_1_13))) && (var_1_19 == ((signed char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
