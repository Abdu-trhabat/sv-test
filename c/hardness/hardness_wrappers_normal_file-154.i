...
void step(void) {
 ...
 if (stepLocal_1 < (var_1_8 + ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) {
  var_1_14 = var_1_7;
 } else {
  var_1_14 = 5;
 }
 ...
 if (((((var_1_2) > (var_1_3)) ? (var_1_2) : (var_1_3))) != stepLocal_0) {
  ...
  var_1_1 = (((((var_1_7 + var_1_8)) < (var_1_6)) ? ((var_1_7 + var_1_8)) : (var_1_6)));
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((((var_1_2) > (var_1_3)) ? (var_1_2) : (var_1_3))) != (var_1_4 + var_1_5)) ? (var_1_1 == ((unsigned char) ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))))) : (var_1_1 == ((unsigned char) (((((var_1_7 + var_1_8)) < (var_1_6)) ? ((var_1_7 + var_1_8)) : (var_1_6)))))) && ((last_1_var_1_9 < var_1_3) ? ((last_1_var_1_14 <= ((var_1_10 - var_1_11) - var_1_7)) ? (var_1_9 == ((unsigned long int) ((1211749435u + (var_1_12 + var_1_13)) - var_1_8))) : ((var_1_10 < (var_1_7 | var_1_5)) ? (var_1_9 == ((unsigned long int) var_1_10)) : 1)) : (var_1_9 == ((unsigned long int) var_1_8)))) && ((((var_1_7 & var_1_9) / var_1_10) < (var_1_8 + ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))) ? (var_1_14 == ((unsigned char) var_1_7)) : (var_1_14 == ((unsigned char) 5)))
;
}
int main(void) {
 isInitial = 1;
