...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch143Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch143Amount100
	var_1_19 = ((var_1_12 + 10000) + var_1_10);


	// From: Req6Batch143Amount100
	var_1_20 = (abs (var_1_15 + var_1_12));


	// From: Req2Batch143Amount100
	...
	// From: Req9Batch143Amount100
	if (var_1_13 <= var_1_19) {
		var_1_23 = (var_1_24 - (var_1_25 - 8));
	}


	// From: Req12Batch143Amount100
	if (var_1_7 == var_1_13) {
		var_1_29 = (min (var_1_24 , var_1_25));
	}


	// From: Req1Batch143Amount100
