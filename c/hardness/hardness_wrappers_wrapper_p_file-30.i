...
void step(void) {
 ...
 if ((*(var_1_2_Pointer))) {
  if (stepLocal_0 > ((last_1_var_1_10 / (*(var_1_5_Pointer))) % (*(var_1_6_Pointer)))) {
   (*(var_1_1_Pointer)) = (((((((((*(var_1_7_Pointer))) < ((*(var_1_8_Pointer)))) ? ((*(var_1_7_Pointer))) : ((*(var_1_8_Pointer)))))) > ((*(var_1_9_Pointer)))) ? ((((((*(var_1_7_Pointer))) < ((*(var_1_8_Pointer)))) ? ((*(var_1_7_Pointer))) : ((*(var_1_8_Pointer)))))) : ((*(var_1_9_Pointer)))));
  }
 } else {
 ...
 if ((*(var_1_3_Pointer)) > stepLocal_4) {
  if (stepLocal_3 <= ((((((*(var_1_9_Pointer))) > ((*(var_1_1_Pointer)))) ? ((*(var_1_9_Pointer))) : ((*(var_1_1_Pointer))))) << ((*(var_1_13_Pointer)) - (*(var_1_14_Pointer))))) {
