...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch8550_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (last_1_var_1_15 <= stepLocal_2) {
  var_1_5 = ((last_1_var_1_12 == last_1_var_1_15) && var_1_6);
 } else {
  var_1_5 = var_1_6;
 }
 ...
 if (var_1_5) {
  var_1_15 = ((((var_1_12) > ((var_1_13 + ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))))) ? (var_1_12) : ((var_1_13 + ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))))));
 }
 ...
 if (stepLocal_1 < ((- var_1_15) * 64)) {
  if (var_1_5) {
   ...
   if (-10000000 < stepLocal_0) {
    var_1_1 = (((((((var_1_15) > (5u)) ? (var_1_15) : (5u))) < 0 ) ? -((((var_1_15) > (5u)) ? (var_1_15) : (5u))) : ((((var_1_15) > (5u)) ? (var_1_15) : (5u)))));
   } else {
    var_1_1 = 50u;
   }
  }
...
int property(void) {
 return ((((((((var_1_12 < ((- var_1_15) * 64)) ? (var_1_5 ? (var_1_1 == ((unsigned long int) ((((var_1_15) < 0 ) ? -(var_1_15) : (var_1_15))))) : ((-10000000 < var_1_12) ? (var_1_1 == ((unsigned long int) (((((((var_1_15) > (5u)) ? (var_1_15) : (5u))) < 0 ) ? -((((var_1_15) > (5u)) ? (var_1_15) : (5u))) : ((((var_1_15) > (5u)) ? (var_1_15) : (5u))))))) : (var_1_1 == ((unsigned long int) 50u)))) : 1) && ((last_1_var_1_15 <= (last_1_var_1_12 + last_1_var_1_1)) ? (var_1_5 == ((unsigned char) ((last_1_var_1_12 == last_1_var_1_15) && var_1_6))) : (var_1_5 == ((unsigned char) var_1_6)))) && (((var_1_12 + (var_1_12 * var_1_15)) <= ((32u / var_1_8) / var_1_9)) ? ((1.25f < var_1_18) ? (var_1_7 == ((float) 1000000.1f)) : 1) : (var_1_7 == ((float) var_1_11)))) && ((last_1_var_1_7 <= (- (32.8f + last_1_var_1_7))) ? (var_1_12 == ((unsigned long int) last_1_var_1_12)) : 1)) && (var_1_13 == ((unsigned char) ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))))) && (var_1_5 ? (var_1_15 == ((unsigned long int) ((((var_1_12) > ((var_1_13 + ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))))) ? (var_1_12) : ((var_1_13 + ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14))))))))) : 1)) && (var_1_16 == ((unsigned char) (var_1_6 && var_1_17)))) && ((var_1_5 || var_1_17) ? (var_1_18 == ((double) ((((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))) + var_1_20) - 63.6))) : 1)
;
}
int main(void) {
 isInitial = 1;
