...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch9100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req12Batch9100_while
	var_1_38 = var_1_12;


	// From: Req8Batch9100_while
	var_1_26 = (max (var_1_14 , (abs (max (var_1_11 , var_1_38)))));


	// From: Req9Batch9100_while
