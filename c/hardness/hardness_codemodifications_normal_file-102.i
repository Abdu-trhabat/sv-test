...
void step(void) {
 ...
 if ((var_1_6 * -64) == var_1_7) {
  var_1_5 = ((var_1_3 - ((((var_1_2) > (var_1_8)) ? (var_1_2) : (var_1_8)))) + var_1_4);
 } else {
  var_1_5 = ((((var_1_8) > (var_1_2)) ? (var_1_8) : (var_1_2)));
 }
 var_1_9 = ((((var_1_10) < (var_1_4)) ? (var_1_10) : (var_1_4)));
 if (var_1_10 >= var_1_2) {
  if ((var_1_6 - var_1_12) <= var_1_7) {
   var_1_11 = var_1_13;
  }
 }
 if (var_1_8 > (((((var_1_9) < (var_1_11)) ? (var_1_9) : (var_1_11))) + var_1_1)) {
  if (var_1_15) {
   var_1_14 = var_1_12;
  }
 }
