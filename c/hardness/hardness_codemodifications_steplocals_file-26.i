...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch26stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_1) < (var_1_19)) ? (var_1_1) : (var_1_19))) < var_1_2) {
  var_1_20 = var_1_22;
 }
 ...
 unsigned char stepLocal_5 = var_1_11 < var_1_23;
 unsigned long int stepLocal_4 = (((var_1_17) < (var_1_6)) ? (var_1_17) : (var_1_6));
 if (stepLocal_4 > (var_1_7 | var_1_19)) {
