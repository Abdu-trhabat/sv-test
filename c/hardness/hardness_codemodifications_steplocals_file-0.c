...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch0stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned long int stepLocal_4 = - 8u;
	if (stepLocal_4 >= (var_1_9 - var_1_2)) {
		var_1_8 = (! var_1_10);
	} else {
	...
	// From: Req8Batch0stepLocals
	var_1_20 = var_1_2;


	// From: Req9Batch0stepLocals
	var_1_21 = var_1_2;
}
