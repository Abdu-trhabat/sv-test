...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch175has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch175has_floats
	if (var_1_9) {
		var_1_8 = (16.0f + var_1_10);
	} else {
		var_1_8 = (min ((max (var_1_10 , var_1_11)) , var_1_12));
	}


	// From: Req3Batch175has_floats
	if (var_1_9) {
		var_1_13 = (max (var_1_6 , var_1_5));
	}


	// From: Req4Batch175has_floats
	signed long int stepLocal_3 = - var_1_4;
	unsigned char stepLocal_2 = ! var_1_15;
	unsigned char stepLocal_1 = var_1_2;
	if (stepLocal_3 != (var_1_2 + (var_1_3 - var_1_1))) {
...
int property(void) {
	return ((((var_1_2 > var_1_3) ? (var_1_1 == ((unsigned char) var_1_4)) : (var_1_1 == ((unsigned char) (var_1_5 - (abs (var_1_6 + var_1_7)))))) && (var_1_9 ? (var_1_8 == ((float) (16.0f + var_1_10))) : (var_1_8 == ((float) (min ((max (var_1_10 , var_1_11)) , var_1_12)))))) && (var_1_9 ? (var_1_13 == ((signed long int) (max (var_1_6 , var_1_5)))) : 1)) && (((- var_1_4) != (var_1_2 + (var_1_3 - var_1_1))) ? ((var_1_9 && (! var_1_15)) ? ((var_1_10 <= var_1_12) ? (((- var_1_6) >= var_1_2) ? (var_1_14 == ((float) 64.0f)) : (var_1_14 == ((float) var_1_11))) : (var_1_14 == ((float) var_1_10))) : 1) : (var_1_14 == ((float) var_1_11)))
;
}
int main(void) {
	isInitial = 1;
