...
void step(void) {
	...
	// From: Req3Batch158no_floats
	if ((var_1_6 % var_1_11) != (var_1_4 * var_1_1)) {
		if (((max (var_1_12 , 47941)) - var_1_3) < var_1_1) {
			var_1_10 = (max (var_1_3 , (4 + var_1_1)));
		} else {
			var_1_10 = var_1_3;
		}
	} else {
	...
	// From: Req2Batch158no_floats
	unsigned char stepLocal_1 = var_1_7;
	signed long int stepLocal_0 = (abs (4)) % var_1_6;
...
int property(void) {
	return (((last_1_var_1_5 >= (-100000 / -1)) ? (var_1_1 == ((unsigned char) var_1_3)) : (((var_1_3 + 100) > var_1_4) ? (var_1_1 == ((unsigned char) 32)) : 1)) && ((var_1_4 <= ((abs (4)) % var_1_6)) ? ((var_1_7 && (var_1_6 > var_1_10)) ? (var_1_5 == ((signed long int) var_1_8)) : (var_1_5 == ((signed long int) var_1_9))) : 1)) && (((var_1_6 % var_1_11) != (var_1_4 * var_1_1)) ? ((((max (var_1_12 , 47941)) - var_1_3) < var_1_1) ? (var_1_10 == ((unsigned short int) (max (var_1_3 , (4 + var_1_1))))) : (var_1_10 == ((unsigned short int) var_1_3))) : (var_1_10 == ((unsigned short int) var_1_3)))
;
}
int main(void) {
	isInitial = 1;
