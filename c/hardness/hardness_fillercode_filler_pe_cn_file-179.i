...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch179Filler_PE_CN.c", 13, "reach_error"); }
 ...
 unsigned char stepLocal_1 = var_1_13;
   ...
   var_1_29
     ...
     var_1_32
             ...
             if ( ((var_1_26) > ( ((((( ((var_1_30) << (var_1_32)))) < ((var_1_31))) ? (( ((var_1_30) << (var_1_32)))) : ((var_1_31))))))) {
              var_1_34 = (
               ((
    var_1_35
   ) - (
