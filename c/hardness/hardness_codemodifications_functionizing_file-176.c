...
signed long int functionized0(signed char functionized0_localFunctionVar0) {
	return ((max ((functionized0_localFunctionVar0 - var_1_7) , var_1_8)) - var_1_9);
}
void functionized1(unsigned char functionized1_localFunctionVar0, double functionized1_localFunctionVar1, double functionized1_localFunctionVar2, double localFunctionVar3) {
	if ((var_1_5 <= var_1_3) && functionized1_localFunctionVar0) {
		if ((max (functionized1_localFunctionVar1 , var_1_13)) < var_1_14) {
...
unsigned char functionized5(float functionized5_localFunctionVar0, float functionized5_localFunctionVar1) {
	return ((max (var_1_14 , functionized5_localFunctionVar0)) >= functionized5_localFunctionVar1);
}
...
void step(void) {
	...
	// From: Req5Batch176functionizing
	if (var_1_11) {
	...
	// From: Req6Batch176functionizing
	if (functionized5(var_1_21, var_1_24)) {
		var_1_26 = (var_1_7 - 8);
	}


	// From: Req7Batch176functionizing
	var_1_27 = var_1_6;
}
