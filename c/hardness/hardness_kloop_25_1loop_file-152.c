...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15225_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch15225_1loop
	var_1_12 = var_1_10;


	// From: Req4Batch15225_1loop
	var_1_13 = var_1_7;
}
