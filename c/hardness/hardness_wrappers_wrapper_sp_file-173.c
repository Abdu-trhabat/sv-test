...
void step(void) {
	// From: Req1Batch173Wrapper_SP
	if ((*(WrapperStruct00_var_1_2_Pointer)) < (*(WrapperStruct00_var_1_3_Pointer))) {
		if (((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer)))) << (*(WrapperStruct00_var_1_6_Pointer))) < ((~ (*(WrapperStruct00_var_1_7_Pointer))) / (*(WrapperStruct00_var_1_8_Pointer)))) {
			(*(WrapperStruct00_var_1_1_Pointer)) = (min (((*(WrapperStruct00_var_1_9_Pointer)) - (*(WrapperStruct00_var_1_10_Pointer))) , ((*(WrapperStruct00_var_1_11_Pointer)) - (*(WrapperStruct00_var_1_12_Pointer)))));
		}
	}


	// From: Req3Batch173Wrapper_SP
