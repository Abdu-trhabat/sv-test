...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1450_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch1450_while
	var_1_1 = (var_1_2 + var_1_3);


	// From: Req3Batch1450_while
	if ((var_1_3 / var_1_12) <= last_1_var_1_11) {
		var_1_11 = (max (var_1_13 , var_1_14));
	}


	// From: Req8Batch1450_while
	var_1_28 = var_1_17;


	// From: Req5Batch1450_while
	unsigned char stepLocal_1 = var_1_17;
	unsigned long int stepLocal_0 = var_1_13 % var_1_20;
	...
	// From: Req6Batch1450_while
	if (((~ var_1_1) * var_1_26) >= (var_1_3 % var_1_23)) {
		var_1_21 = (max (var_1_24 , var_1_25));
	}


	// From: Req4Batch1450_while
	if ((min (var_1_21 , -0.5)) > (10.9 * var_1_21)) {
		if (var_1_4) {
...
int property(void) {
	return (((((((var_1_1 == ((signed long int) (var_1_2 + var_1_3))) && (((last_1_var_1_21 + 9.999999999999994E14f) < (- last_1_var_1_21)) ? (var_1_4 == ((unsigned char) (var_1_7 && var_1_8))) : (var_1_7 ? (var_1_4 == ((unsigned char) ((var_1_8 || var_1_9) && var_1_10))) : 1))) && (((var_1_3 / var_1_12) <= last_1_var_1_11) ? (var_1_11 == ((unsigned long int) (max (var_1_13 , var_1_14)))) : 1)) && (((min (var_1_21 , -0.5)) > (10.9 * var_1_21)) ? (var_1_4 ? (var_1_15 == ((unsigned char) (min ((abs (var_1_17)) , var_1_18)))) : (var_1_15 == ((unsigned char) var_1_18))) : 1)) && (((var_1_13 % var_1_20) != var_1_11) ? ((var_1_18 == var_1_17) ? (var_1_4 ? (var_1_19 == ((signed long int) var_1_18)) : (var_1_19 == ((signed long int) var_1_11))) : 1) : 1)) && ((((~ var_1_1) * var_1_26) >= (var_1_3 % var_1_23)) ? (var_1_21 == ((float) (max (var_1_24 , var_1_25)))) : 1)) && ((var_1_9 || ((var_1_11 + var_1_19) <= 4)) ? (var_1_26 == ((signed long int) (var_1_19 - var_1_20))) : (var_1_26 == ((signed long int) (var_1_20 - var_1_17))))) && (var_1_28 == ((unsigned char) var_1_17))
;
}
int main(void) {
	isInitial = 1;
