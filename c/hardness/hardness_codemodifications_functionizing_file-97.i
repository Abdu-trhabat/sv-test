...
void functionized0(unsigned short int functionized0_localFunctionVar0, unsigned long int localFunctionVar1) {
 if (((((var_1_2) > (var_1_1)) ? (var_1_2) : (var_1_1))) > (functionized0_localFunctionVar0 * localFunctionVar1)) {
...
void step(void) {
 ...
 if ((127.75 <= var_1_8) && var_1_4) {
  var_1_7 = ((((functionized1(var_1_10)) > (var_1_11)) ? (functionized1(var_1_10)) : (var_1_11)));
 }
 ...
 if (var_1_17 <= var_1_5) {
  ...
  var_1_16 = ((((var_1_17) < (functionized2(var_1_2))) ? (var_1_17) : (functionized2(var_1_2))));
 }
