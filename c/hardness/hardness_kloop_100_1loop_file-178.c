...
void step(void) {
	// From: Req2Batch178100_1loop
	if (last_1_var_1_10 > last_1_var_1_9) {
		var_1_5 = ((max (var_1_6 , var_1_7)) - var_1_8);
	}


	// From: Req5Batch178100_1loop
	var_1_16 = (max (10 , var_1_17));


	// From: Req6Batch178100_1loop
	var_1_18 = var_1_17;


	// From: Req8Batch178100_1loop
	if (var_1_5 < var_1_11) {
		var_1_21 = var_1_17;
	} else {
	...
	// From: Req14Batch178100_1loop
	var_1_40 = var_1_37;


	// From: Req1Batch178100_1loop
	...
	// From: Req13Batch178100_1loop
	if (var_1_5 <= var_1_7) {
		var_1_38 = ((var_1_39 - var_1_13) + var_1_9);
	}


	// From: Req4Batch178100_1loop
