...
void step(void) {
	...
	signed long int stepLocal_5 = (min (last_1_var_1_33 , var_1_31)) / var_1_36;
	if (var_1_25) {
		var_1_35 = (max ((min (last_1_var_1_16 , var_1_15)) , last_1_var_1_33));
	} else {
		if (-128 <= stepLocal_6) {
			...
			if (var_1_27) {
				var_1_35 = (min (-64 , last_1_var_1_33));
			}
		}
	}
	...
	if (var_1_7 < (~ (var_1_8 - var_1_15))) {
		...
		var_1_16 = (min (last_1_var_1_16 , (min (var_1_13 , var_1_11))));
	}
	...
	if (stepLocal_10 || var_1_27) {
		if (var_1_26) {
			var_1_44 = (min (var_1_11 , ((last_1_var_1_44 - var_1_31) + var_1_7)));
		} else {
	...
	if (var_1_9 <= stepLocal_3) {
		var_1_34 = (min ((min ((max (var_1_10 , var_1_15)) , var_1_11)) , var_1_13));
	} else {
	...
	// From: Req24Batch51Amount250
	if (var_1_38) {
		var_1_61 = (min ((min (var_1_10 , var_1_39)) , last_1_var_1_61));
	}
	...
	if ((var_1_6 > (min (var_1_4 , var_1_3))) && stepLocal_2) {
		if (! var_1_37) {
			var_1_33 = (abs (var_1_59 + (var_1_35 + var_1_44)));
		}
	} else {
		if (! var_1_27) {
			if (! var_1_25) {
	...
	if (var_1_61 >= ((max (var_1_15 , last_1_var_1_55)) >> var_1_56)) {
		var_1_55 = (var_1_57 - 8u);
	}


	// From: Req23Batch51Amount250
	...
	if (stepLocal_12 > var_1_17) {
		var_1_58 = (min (var_1_52 , var_1_61));
	} else {
		var_1_58 = ((max (var_1_32 , var_1_8)) - (min (var_1_19 , var_1_30)));
	}


	// From: Req3Batch51Amount250
	if (! var_1_47) {
		var_1_12 = (min ((var_1_13 - var_1_11) , (var_1_8 + var_1_58)));
	} else {
		if (var_1_11 > ((128 - var_1_8) / (var_1_14 + var_1_15))) {
			if (((- var_1_15) / 100) > (var_1_28 / (max (50 , -1000000000)))) {
				var_1_12 = 8;
			}
		} else {
			var_1_12 = var_1_14;
...
int property(void) {
	return (((((((((((((((((((((((((- var_1_3) <= (var_1_4 - var_1_5)) ? ((var_1_3 >= ((min (var_1_5 , var_1_4)) / var_1_6)) ? (var_1_1 == ((signed char) (min ((var_1_7 - var_1_8) , var_1_9)))) : (var_1_1 == ((signed char) (min ((abs (var_1_8)) , var_1_9))))) : 1) && ((var_1_4 < 64.4f) ? (var_1_10 == ((unsigned char) (max ((abs (max (8 , var_1_8))) , var_1_11)))) : 1)) && ((! var_1_47) ? (var_1_12 == ((unsigned short int) (min ((var_1_13 - var_1_11) , (var_1_8 + var_1_58))))) : ((var_1_11 > ((128 - var_1_8) / (var_1_14 + var_1_15))) ? ((((- var_1_15) / 100) > (var_1_28 / (max (50 , -1000000000)))) ? (var_1_12 == ((unsigned short int) 8)) : 1) : (var_1_12 == ((unsigned short int) var_1_14))))) && ((var_1_7 < (~ (var_1_8 - var_1_15))) ? (var_1_16 == ((unsigned long int) (min (var_1_13 , var_1_14)))) : (var_1_16 == ((unsigned long int) (min (last_1_var_1_16 , (min (var_1_13 , var_1_11)))))))) && ((var_1_55 < ((var_1_18 + var_1_19) - var_1_15)) ? (var_1_17 == ((unsigned short int) (abs ((var_1_20 - var_1_19) - var_1_11)))) : 1)) && (((var_1_13 + var_1_8) >= var_1_9) ? (last_1_var_1_21 ? (var_1_21 == ((unsigned char) (last_1_var_1_21 || (last_1_var_1_37 || (last_1_var_1_47 || var_1_25))))) : ((! last_1_var_1_21) ? (var_1_21 == ((unsigned char) (var_1_26 || var_1_27))) : 1)) : (var_1_21 == ((unsigned char) var_1_27)))) && ((var_1_13 == var_1_59) ? (var_1_28 == ((unsigned char) (var_1_29 - var_1_8))) : (var_1_28 == ((unsigned char) (var_1_15 + ((max (var_1_30 , var_1_31)) + var_1_32)))))) && (((var_1_6 > (min (var_1_4 , var_1_3))) && var_1_38) ? ((! var_1_37) ? (var_1_33 == ((signed long int) (abs (var_1_59 + (var_1_35 + var_1_44))))) : 1) : ((! var_1_27) ? ((! var_1_25) ? (var_1_33 == ((signed long int) var_1_59)) : (var_1_33 == ((signed long int) (var_1_19 - var_1_32)))) : (var_1_33 == ((signed long int) (-10 + var_1_31)))))) && ((var_1_9 <= var_1_20) ? (var_1_34 == ((signed long int) (min ((min ((max (var_1_10 , var_1_15)) , var_1_11)) , var_1_13)))) : ((var_1_14 < var_1_35) ? (var_1_34 == ((signed long int) (var_1_20 + (var_1_30 + var_1_13)))) : 1))) && (var_1_25 ? (var_1_35 == ((signed long int) (max ((min (last_1_var_1_16 , var_1_15)) , last_1_var_1_33)))) : ((-128 <= var_1_18) ? ((last_1_var_1_34 == ((min (last_1_var_1_33 , var_1_31)) / var_1_36)) ? (var_1_35 == ((signed long int) (abs ((var_1_14 - 50) + var_1_15)))) : 1) : (var_1_27 ? (var_1_35 == ((signed long int) (min (-64 , last_1_var_1_33)))) : 1)))) && ((var_1_3 != var_1_5) ? (var_1_37 == ((unsigned char) var_1_25)) : (var_1_37 == ((unsigned char) (! var_1_25))))) && ((var_1_11 < var_1_20) ? (var_1_38 == ((unsigned char) var_1_26)) : 1)) && (((- var_1_8) < var_1_59) ? (var_1_27 ? (var_1_39 == ((unsigned char) (max ((var_1_31 + 4) , var_1_29)))) : (var_1_39 == ((unsigned char) (min ((var_1_32 + var_1_31) , var_1_29))))) : (var_1_39 == ((unsigned char) (abs (var_1_15 + var_1_19)))))) && (((-5 >= var_1_19) || var_1_27) ? ((((var_1_61 + var_1_18) * var_1_32) <= var_1_11) ? (var_1_40 == ((signed char) var_1_9)) : (var_1_40 == ((signed char) ((max (var_1_32 , (var_1_41 - var_1_42))) + var_1_43)))) : (var_1_40 == ((signed char) (max (var_1_43 , 100)))))) && ((var_1_25 || var_1_27) ? (var_1_26 ? (var_1_44 == ((signed short int) (min (var_1_11 , ((last_1_var_1_44 - var_1_31) + var_1_7))))) : (var_1_44 == ((signed short int) ((var_1_18 + (max (var_1_11 , var_1_29))) - var_1_14)))) : 1)) && ((5.88 > (max (var_1_4 , (var_1_5 - var_1_46)))) ? (var_1_45 == ((unsigned short int) (var_1_13 - var_1_11))) : ((var_1_31 > var_1_55) ? (var_1_45 == ((unsigned short int) (var_1_13 - (var_1_19 + var_1_8)))) : (var_1_45 == ((unsigned short int) (max ((var_1_13 - var_1_41) , (abs (var_1_42))))))))) && ((var_1_5 <= var_1_4) ? (var_1_47 == ((unsigned char) (var_1_48 && ((var_1_41 != var_1_32) || var_1_25)))) : (var_1_47 == ((unsigned char) ((var_1_21 || var_1_25) && (var_1_48 && var_1_49)))))) && (((abs (var_1_6 + var_1_5)) <= (var_1_3 / var_1_51)) ? (((var_1_13 | (var_1_45 - var_1_29)) > var_1_43) ? (var_1_50 == ((signed char) var_1_43)) : (var_1_50 == ((signed char) (max ((var_1_32 + (var_1_52 + var_1_53)) , (-1 - (var_1_41 + var_1_42))))))) : (var_1_50 == ((signed char) (min (var_1_30 , (max ((var_1_7 - var_1_41) , var_1_53)))))))) && (var_1_21 ? (var_1_54 == ((signed char) (abs (var_1_8)))) : 1)) && ((var_1_61 >= ((max (var_1_15 , last_1_var_1_55)) >> var_1_56)) ? (var_1_55 == ((unsigned long int) (var_1_57 - 8u))) : 1)) && (((var_1_59 / var_1_15) > var_1_17) ? (var_1_58 == ((signed long int) (min (var_1_52 , var_1_61)))) : (var_1_58 == ((signed long int) ((max (var_1_32 , var_1_8)) - (min (var_1_19 , var_1_30))))))) && ((var_1_14 != (last_1_var_1_59 ^ var_1_35)) ? (var_1_26 ? (var_1_37 ? (var_1_59 == ((unsigned long int) var_1_19)) : (var_1_59 == ((unsigned long int) var_1_30))) : 1) : (var_1_59 == ((unsigned long int) var_1_10)))) && ((((var_1_19 * 128) + var_1_55) == var_1_13) ? (var_1_60 == ((unsigned short int) var_1_29)) : 1)) && (var_1_38 ? (var_1_61 == ((signed short int) (min ((min (var_1_10 , var_1_39)) , last_1_var_1_61)))) : 1)
;
}
int main(void) {
	isInitial = 1;
