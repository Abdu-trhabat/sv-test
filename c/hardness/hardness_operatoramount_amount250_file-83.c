...
void step(void) {
	...
	if (stepLocal_1 <= (max ((max (var_1_4 , var_1_9)) , var_1_10))) {
		var_1_23 = ((2u + var_1_3) + var_1_10);
	} else {
		if ((min (var_1_10 , last_1_var_1_18)) >= stepLocal_2) {
			var_1_23 = (var_1_24 + var_1_9);
		} else {
			var_1_23 = (min (last_1_var_1_7 , (var_1_25 - (last_1_var_1_30 + 128u))));
		}
	}
	...
	if ((- var_1_28) <= (min (var_1_12 , (var_1_17 * var_1_16)))) {
		var_1_27 = (abs (var_1_58));
	} else {
	...
	if (((var_1_5 * var_1_30) * 1u) <= var_1_23) {
		...
		var_1_35 = ((abs (abs (var_1_13))) - (var_1_29 + var_1_3));
	}
	...
	if (var_1_47) {
		if ((var_1_37 < var_1_3) && stepLocal_8) {
			...
			if ((-256 == (max (var_1_32 , var_1_30))) && stepLocal_9) {
				var_1_57 = var_1_11;
			} else {
				var_1_57 = 4;
			}
	...
	if ((128 - (var_1_31 + var_1_9)) < var_1_30) {
		var_1_48 = (max ((min (var_1_6 , var_1_38)) , var_1_37));
	} else {
			...
			if ((var_1_32 & (var_1_50 - var_1_38)) < var_1_37) {
				...
				if (var_1_42 < var_1_31) {
					if (! ((var_1_41 + var_1_8) != var_1_22)) {
						var_1_48 = ((max (last_1_var_1_48 , (var_1_51 - var_1_8))) - ((abs (var_1_50)) + var_1_52));
					}
				} else {
					if (var_1_47 && var_1_45) {
						var_1_48 = (max ((max ((max (var_1_7 , var_1_51)) , (var_1_10 - var_1_58))) , (max ((var_1_49 - 1) , var_1_9))));
					}
				}
			}
		}
...
int property(void) {
	return (((((((((((((((((var_1_45 ? (var_1_1 == ((signed short int) ((var_1_3 - var_1_4) - var_1_5))) : (var_1_1 == ((signed short int) ((max (var_1_3 , (var_1_6 - var_1_4))) - var_1_5)))) && (var_1_7 == ((unsigned char) ((var_1_8 - var_1_9) - (100 - (var_1_10 + var_1_11)))))) && ((! var_1_55) ? (var_1_12 == ((float) ((var_1_14 + (abs (49.5f))) + var_1_15))) : (var_1_12 == ((float) (((max (10.6f , var_1_16)) - var_1_17) + var_1_15))))) && (((var_1_3 / var_1_8) < var_1_13) ? (var_1_18 == ((signed long int) (var_1_5 + (var_1_10 - var_1_13)))) : ((var_1_8 <= var_1_9) ? (var_1_18 == ((signed long int) 128)) : (var_1_18 == ((signed long int) (abs (var_1_23))))))) && (var_1_2 ? ((var_1_20 && var_1_21) ? (var_1_19 == ((unsigned char) var_1_9)) : (((var_1_14 + (var_1_17 - var_1_16)) > var_1_15) ? ((var_1_14 > -0.5f) ? (var_1_19 == ((unsigned char) (min (var_1_8 , var_1_22)))) : 1) : (var_1_19 == ((unsigned char) var_1_8)))) : (var_1_19 == ((unsigned char) var_1_22)))) && (((-8 + var_1_3) <= (max ((max (var_1_4 , var_1_9)) , var_1_10))) ? (var_1_23 == ((unsigned long int) ((2u + var_1_3) + var_1_10))) : (((min (var_1_10 , last_1_var_1_18)) >= (var_1_11 % var_1_8)) ? (var_1_23 == ((unsigned long int) (var_1_24 + var_1_9))) : (var_1_23 == ((unsigned long int) (min (last_1_var_1_7 , (var_1_25 - (last_1_var_1_30 + 128u))))))))) && ((var_1_6 >= var_1_3) ? ((! var_1_45) ? (var_1_26 == ((signed long int) (var_1_8 + var_1_3))) : 1) : (var_1_26 == ((signed long int) (abs (var_1_3)))))) && (((- var_1_28) <= (min (var_1_12 , (var_1_17 * var_1_16)))) ? (var_1_27 == ((unsigned short int) (abs (var_1_58)))) : (var_1_27 == ((unsigned short int) (var_1_29 - var_1_58))))) && ((((var_1_10 + var_1_9) >> (var_1_31 - var_1_32)) <= var_1_29) ? (((last_1_var_1_19 + last_1_var_1_27) <= var_1_32) ? (var_1_30 == ((unsigned long int) (var_1_25 - var_1_13))) : (var_1_30 == ((unsigned long int) (((var_1_33 - var_1_4) + (var_1_34 - last_1_var_1_48)) - 10000000u)))) : ((last_1_var_1_48 > last_1_var_1_23) ? (var_1_30 == ((unsigned long int) (max (var_1_9 , var_1_6)))) : 1))) && ((((var_1_5 * var_1_30) * 1u) <= var_1_23) ? ((var_1_9 < 2) ? (var_1_35 == ((signed long int) (var_1_10 + var_1_6))) : 1) : (var_1_35 == ((signed long int) ((abs (abs (var_1_13))) - (var_1_29 + var_1_3)))))) && (((var_1_17 + var_1_16) >= var_1_12) ? (var_1_37 == ((unsigned char) (min ((var_1_8 - var_1_38) , (var_1_39 - var_1_10))))) : (((abs (var_1_29)) <= var_1_30) ? (((50 << var_1_8) != ((var_1_23 | -200) / var_1_33)) ? (var_1_37 == ((unsigned char) (var_1_39 - var_1_38))) : (var_1_37 == ((unsigned char) (var_1_38 + var_1_32)))) : (var_1_37 == ((unsigned char) (abs (var_1_10))))))) && ((var_1_2 && var_1_21) ? (var_1_41 == ((unsigned char) ((min ((max (var_1_38 , var_1_10)) , var_1_11)) + (min ((min (var_1_9 , var_1_32)) , (max (var_1_31 , var_1_42))))))) : ((var_1_28 == var_1_16) ? (var_1_21 ? (var_1_41 == ((unsigned char) (max (var_1_38 , (min ((128 - var_1_42) , (var_1_9 + 5))))))) : 1) : (var_1_41 == ((unsigned char) (((var_1_43 + var_1_44) - var_1_11) - var_1_32)))))) && ((((64 % var_1_43) + (var_1_11 - var_1_42)) >= (8 * last_1_var_1_30)) ? (var_1_45 == ((unsigned char) (last_1_var_1_55 && var_1_46))) : (var_1_45 == ((unsigned char) ((var_1_46 && last_1_var_1_55) || var_1_47))))) && (((128 - (var_1_31 + var_1_9)) < var_1_30) ? (var_1_48 == ((signed long int) (max ((min (var_1_6 , var_1_38)) , var_1_37)))) : ((var_1_35 <= (var_1_5 + var_1_39)) ? (var_1_48 == ((signed long int) (var_1_10 - (var_1_49 - var_1_3)))) : (((var_1_32 & (var_1_50 - var_1_38)) < var_1_37) ? ((var_1_45 || ((var_1_14 + var_1_28) >= var_1_17)) ? (var_1_48 == ((signed long int) (256 + var_1_1))) : (var_1_48 == ((signed long int) (var_1_50 - ((var_1_51 - var_1_31) - var_1_29))))) : ((var_1_42 < var_1_31) ? ((! ((var_1_41 + var_1_8) != var_1_22)) ? (var_1_48 == ((signed long int) ((max (last_1_var_1_48 , (var_1_51 - var_1_8))) - ((abs (var_1_50)) + var_1_52)))) : 1) : ((var_1_47 && var_1_45) ? (var_1_48 == ((signed long int) (max ((max ((max (var_1_7 , var_1_51)) , (var_1_10 - var_1_58))) , (max ((var_1_49 - 1) , var_1_9)))))) : 1)))))) && ((1.5 < var_1_12) ? ((var_1_21 && var_1_20) ? (var_1_53 == ((signed char) ((var_1_54 - var_1_10) - (var_1_9 + var_1_31)))) : 1) : 1)) && (var_1_47 ? (var_1_55 == ((unsigned char) (var_1_46 || (var_1_45 && var_1_56)))) : 1)) && (var_1_47 ? (((var_1_37 < var_1_3) && (var_1_43 > var_1_31)) ? (var_1_57 == ((unsigned char) (128 - var_1_10))) : (((-256 == (max (var_1_32 , var_1_30))) && var_1_56) ? (var_1_57 == ((unsigned char) var_1_11)) : (var_1_57 == ((unsigned char) 4)))) : (var_1_57 == ((unsigned char) var_1_11)))) && (((var_1_25 + var_1_30) < (~ var_1_52)) ? (var_1_58 == ((unsigned short int) var_1_22)) : (((var_1_30 < var_1_29) && var_1_45) ? (var_1_58 == ((unsigned short int) var_1_39)) : (var_1_58 == ((unsigned short int) var_1_54))))
;
}
int main(void) {
	isInitial = 1;
