...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4850_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_7 == var_1_12) {
  var_1_18 = (var_1_10 + ((((var_1_8) < (var_1_16)) ? (var_1_8) : (var_1_16))));
 } else {
