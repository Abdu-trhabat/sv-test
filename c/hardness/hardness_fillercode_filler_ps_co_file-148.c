...
void step(void) {
	...
	// From: CodeObject3
	/* 301L, 120L) */ if (/* 302L, 91L, 92L) */ ((/* 303L, 89L, 93L) */ (abs (4.2))) <= (var_1_14))) {
	...
	/* 319L, 170L) */ if (/* 320L, 131L, 132L) */ ((var_1_39) >= (/* 322L, 130L, 134L) */ (max (/* 322L, 130L, 134L) */ (var_1_32) , (/* 324L, 129L, 136L) */ ((var_1_36) >> (16)))))))) {
		/* 327L, 168L) */ if (/* 328L, 151L, 152L) */ ((/* 329L, 147L, 153L) */ (- (var_1_30))) > (/* 331L, 150L, 155L) */ ((var_1_36) + (var_1_39))))) {
			/* 334L, 167L) */ var_1_41 = (
				var_1_42
			);
		}
	...
	// From: CodeObject5
	/* 338L, 223L) */ if (/* 339L, 176L, 177L) */ ((var_1_30) > (var_1_33))) {
		/* 342L, 217L) */ if (/* 343L, 187L, 188L) */ ((/* 344L, 185L, 189L) */ (min (/* 344L, 185L, 189L) */ (8.5f) , (16.4f)))) > (var_1_7))) {
	...
	// From: Req11Batch148Filler_PS_CO
	/* 1151L, 258L, 916L, 922L) */ var_1_30 = (
		var_1_1
	);


	// From: Req2Batch148Filler_PS_CO
	...
	// From: Req9Batch148Filler_PS_CO
	/* 1139L, 238L, 868L, 874L) */ var_1_28 = (
		var_1_4
	);


	// From: Req10Batch148Filler_PS_CO
	/* 1145L, 248L, 892L, 898L) */ var_1_29 = (
		var_1_23
	);


	// From: Req6Batch148Filler_PS_CO
