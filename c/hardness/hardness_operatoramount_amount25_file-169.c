...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch169Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch169Amount25
	if (var_1_2 >= (var_1_3 + var_1_4)) {
		var_1_1 = (var_1_5 - var_1_6);
	}


	// From: Req2Batch169Amount25
...
int property(void) {
	return (((var_1_2 >= (var_1_3 + var_1_4)) ? (var_1_1 == ((signed short int) (var_1_5 - var_1_6))) : 1) && ((var_1_5 >= ((var_1_8 - var_1_9) - var_1_6)) ? ((var_1_2 == (max (var_1_3 , (- var_1_4)))) ? (var_1_7 == ((unsigned long int) (var_1_6 + var_1_8))) : (var_1_10 ? (var_1_7 == ((unsigned long int) var_1_8)) : 1)) : (var_1_7 == ((unsigned long int) var_1_6)))) && ((var_1_1 <= -128) ? ((var_1_1 > (~ var_1_5)) ? (var_1_11 == ((signed char) var_1_12)) : (var_1_11 == ((signed char) -4))) : (var_1_11 == ((signed char) -64)))
;
}
int main(void) {
	isInitial = 1;
