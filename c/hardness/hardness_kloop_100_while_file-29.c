...
void step(void) {
	...
	signed long int stepLocal_7 = var_1_12 / (min (var_1_13 , var_1_10));
	if ((var_1_15 - (max (var_1_16 , var_1_28))) < stepLocal_7) {
	...
	signed long int stepLocal_2 = max (256 , var_1_17);
	if (var_1_30) {
	...
	if (var_1_1) {
		if ((min (var_1_13 , var_1_27)) > ((var_1_16 << var_1_12) / var_1_15)) {
...
int property(void) {
	return ((((((((((((var_1_17 != var_1_31) ? ((var_1_31 >= (var_1_17 + var_1_40)) ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_5 ? (var_1_1 == ((unsigned char) var_1_6)) : 1)) : (var_1_1 == ((unsigned char) var_1_7))) && ((! var_1_1) ? ((var_1_31 > (var_1_17 % var_1_10)) ? (var_1_8 == ((unsigned char) var_1_11)) : 1) : 1)) && ((var_1_40 > var_1_31) ? ((var_1_31 == var_1_40) ? (var_1_12 == ((unsigned short int) ((var_1_13 - var_1_11) + var_1_40))) : 1) : 1)) && (var_1_30 ? ((var_1_13 > (max (256 , var_1_17))) ? (var_1_14 == ((unsigned char) (var_1_15 - var_1_16))) : (var_1_14 == ((unsigned char) (var_1_16 + 10)))) : 1)) && ((! last_1_var_1_1) ? ((! (! (! var_1_5))) ? (var_1_17 == ((unsigned short int) last_1_var_1_31)) : (var_1_17 == ((unsigned short int) var_1_13))) : (var_1_17 == ((unsigned short int) var_1_15)))) && (var_1_1 ? (((min (var_1_13 , var_1_27)) > ((var_1_16 << var_1_12) / var_1_15)) ? (var_1_18 == ((unsigned char) (max (2 , var_1_11)))) : 1) : 1)) && ((var_1_5 && (var_1_12 <= var_1_31)) ? ((var_1_17 > var_1_31) ? (var_1_19 == ((double) (min ((var_1_20 - var_1_21) , var_1_22)))) : 1) : (var_1_19 == ((double) (var_1_23 + ((var_1_24 + var_1_25) + var_1_26)))))) && (((var_1_16 - (var_1_28 + var_1_29)) <= var_1_40) ? (var_1_27 == ((unsigned char) (max (var_1_29 , var_1_28)))) : (var_1_27 == ((unsigned char) var_1_29)))) && (var_1_1 ? (var_1_30 == ((unsigned char) 1)) : (var_1_30 == ((unsigned char) (! var_1_5))))) && ((last_1_var_1_19 != var_1_22) ? (var_1_31 == ((unsigned long int) (var_1_32 - (last_1_var_1_12 + var_1_13)))) : (((last_1_var_1_12 + last_1_var_1_14) >= (var_1_15 + var_1_29)) ? (((var_1_24 * (var_1_23 * last_1_var_1_19)) >= ((var_1_33 - var_1_34) - (var_1_35 - var_1_36))) ? (var_1_31 == ((unsigned long int) last_1_var_1_14)) : (var_1_31 == ((unsigned long int) last_1_var_1_12))) : 1))) && (((var_1_15 - (max (var_1_16 , var_1_28))) < (var_1_12 / (min (var_1_13 , var_1_10)))) ? (var_1_37 == ((signed char) ((var_1_38 + var_1_39) + var_1_29))) : (var_1_37 == ((signed char) (min (var_1_28 , var_1_38)))))) && (var_1_40 == ((signed long int) var_1_17))
;
}
int main(void) {
	isInitial = 1;
