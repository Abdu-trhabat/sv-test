 ...
 if (stepLocal_1 == var_1_5) {
  if (stepLocal_2 < var_1_14) {
   if (var_1_10) {
    ...
    var_1_9 = (((((0.25f + var_1_13)) > (var_1_12)) ? ((0.25f + var_1_13)) : (var_1_12)));
   }
  } else {
   var_1_9 = var_1_12;
  }
...
int property(void) {
 return (((((8 >= (var_1_2 + var_1_3)) ? (var_1_1 == ((signed short int) ((((var_1_4) < (((var_1_5 + var_1_6) + var_1_7))) ? (var_1_4) : (((var_1_5 + var_1_6) + var_1_7)))))) : 1) && ((var_1_6 != var_1_7) ? (var_1_8 == ((signed short int) var_1_7)) : 1)) && ((var_1_6 == var_1_5) ? (((var_1_8 + var_1_14) < var_1_14) ? (var_1_10 ? (var_1_11 ? (var_1_9 == ((float) var_1_12)) : 1) : (var_1_9 == ((float) (((((0.25f + var_1_13)) > (var_1_12)) ? ((0.25f + var_1_13)) : (var_1_12)))))) : (var_1_9 == ((float) var_1_12))) : (var_1_9 == ((float) var_1_12)))) && (var_1_14 == ((unsigned long int) var_1_15))) && (var_1_16 == ((float) var_1_13))
;
}
int main(void) {
 isInitial = 1;
