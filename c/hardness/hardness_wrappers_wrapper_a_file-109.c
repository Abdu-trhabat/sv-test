...
void step(void) {
	...
	if (stepLocal_1 <= signed_char_Array_0[0]) {
		...
		signed_long_int_Array_0[1] = (max (last_1_signed_short_int_Array_0_1_ , ((signed_char_Array_0[0] + 16) - signed_long_int_Array_0[0])));
	}


	// From: Req7Batch109Wrapper_A
	signed_short_int_Array_0[3] = signed_long_int_Array_0[1];


	// From: Req3Batch109Wrapper_A
	signed_short_int_Array_0[1] = (signed_char_Array_0[0] - signed_short_int_Array_0[0]);


	// From: Req1Batch109Wrapper_A
