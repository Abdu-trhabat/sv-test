...
void step(void) {
 ...
 if (stepLocal_1 != var_1_6) {
  if (var_1_1 >= var_1_4) {
   var_1_10 = (((var_1_9 + var_1_5) + ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) - var_1_12);
  } else {
   if (var_1_2) {
    var_1_10 = var_1_6;
   } else {
...
int property(void) {
 return (((! var_1_2) ? (var_1_2 ? (var_1_1 == ((float) ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4))))) : 1) : 1) && (((var_1_6 / -2) >= (var_1_7 | var_1_8)) ? (var_1_5 == ((unsigned char) ((((var_1_9) < 0 ) ? -(var_1_9) : (var_1_9))))) : (var_1_5 == ((unsigned char) var_1_9)))) && ((var_1_8 != var_1_6) ? ((var_1_1 >= var_1_4) ? (var_1_10 == ((signed long int) (((var_1_9 + var_1_5) + ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) - var_1_12))) : (var_1_2 ? (var_1_10 == ((signed long int) var_1_6)) : (var_1_10 == ((signed long int) var_1_11)))) : (var_1_10 == ((signed long int) var_1_9)))
;
}
int main(void) {
 isInitial = 1;
