...
void step(void) {
	...
	if ((abs (WrapperStruct00.var_1_15)) > WrapperStruct00.var_1_1) {
		if ((WrapperStruct00.var_1_15 / -5) >= ((WrapperStruct00.var_1_4 + WrapperStruct00.var_1_1) - (min (WrapperStruct00.var_1_12 , WrapperStruct00.var_1_3)))) {
