...
void step(void) {
 ...
 signed long int stepLocal_1 = ((var_1_7) - ( ((var_1_8) - (var_1_2))));
   ...
   var_1_37
             ...
             if (var_1_40) {
              if ( (( (( (~ (var_1_34))) ^ (var_1_33))) < ( (( ((var_1_32) | (var_1_43))) % ( (((((var_1_44)) < ((var_1_45))) ? ((var_1_44)) : ((var_1_45))))))))) {
               var_1_42 = (
  ...
  var_1_48
             ...
             if ( ((var_1_37) >= ( ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))))) {
              var_1_47 = (
   var_1_48
  );
 } else {
              if ( ((2) >= ( ((var_1_45) * ( ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))))))) {
               var_1_47 = (
    0
   );
  } else {
