...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch154functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
void functionized0(unsigned long int, unsigned long int, unsigned long int, unsigned char);
void functionized1(signed char, signed char, unsigned long int);
void functionized2(void);
void functionized3(signed char, signed char);
void functionized4(unsigned long int, unsigned long int, unsigned long int);
...
void functionized0(unsigned long int functionized0_localFunctionVar0, unsigned long int functionized0_localFunctionVar1, unsigned long int functionized0_localFunctionVar2, unsigned char functionized0_localFunctionVar3) {
 if (functionized0_localFunctionVar3) {
  var_1_1 = ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4)));
 } else {
  var_1_1 = (((((functionized0_localFunctionVar1) < (functionized0_localFunctionVar0)) ? (functionized0_localFunctionVar1) : (functionized0_localFunctionVar0))) + ((functionized0_localFunctionVar2 - var_1_8) - var_1_9));
 }
}
void functionized1(signed char functionized1_localFunctionVar0, signed char functionized1_localFunctionVar1, unsigned long int functionized1_localFunctionVar2) {
 if (functionized1_localFunctionVar2 == var_1_5) {
  var_1_10 = (((((functionized1_localFunctionVar0 + var_1_12)) > (functionized1_localFunctionVar1)) ? ((functionized1_localFunctionVar0 + var_1_12)) : (functionized1_localFunctionVar1)));
 }
}
void functionized2(void) {
 if (var_1_11 > var_1_4) {
...
void functionized3(signed char functionized3_localFunctionVar0, signed char functionized3_localFunctionVar1) {
 if (-16 != (-25 / var_1_7)) {
  var_1_23 = functionized3_localFunctionVar1;
 } else {
  var_1_23 = functionized3_localFunctionVar0;
 }
}
void functionized4(unsigned long int functionized4_localFunctionVar0, unsigned long int functionized4_localFunctionVar1, unsigned long int functionized4_localFunctionVar2) {
 if (var_1_2 || var_1_25) {
  if (var_1_2 && (var_1_14 <= var_1_8)) {
   if (functionized4_localFunctionVar1 == (((((functionized4_localFunctionVar0) > (var_1_9)) ? (functionized4_localFunctionVar0) : (var_1_9))) * functionized4_localFunctionVar2)) {
...
void step(void) {
 functionized0(var_1_6, var_1_5, var_1_7, var_1_2);
 functionized1(var_1_11, var_1_13, var_1_4);
 functionized2();
 ...
 if (var_1_2) {
  if (var_1_21 > var_1_20) {
   functionized3(var_1_11, var_1_13);
  } else {
   var_1_23 = var_1_11;
  }
 } else {
 ...
 functionized4(var_1_5, var_1_7, var_1_4);
 var_1_28 = var_1_29;
}
void updateVariables(void) {
