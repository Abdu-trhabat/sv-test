...
unsigned long int functionized0(unsigned long int functionized0_localFunctionVar0, unsigned long int localFunctionVar1) {
	return (functionized0_localFunctionVar0 / (abs (localFunctionVar1)));
}
unsigned long int functionized1(void) {
	return (max (var_1_3 , var_1_5));
}
unsigned char functionized2(void) {
...
unsigned char functionized5(unsigned long int functionized5_localFunctionVar0, unsigned long int functionized5_localFunctionVar1) {
	return (functionized5_localFunctionVar1 >= (var_1_14 - (min (var_1_15 , functionized5_localFunctionVar0))));
}
...
void step(void) {
	// From: Req1Batch61functionizing
	if ((functionized0(var_1_2, 64u)) == var_1_3) {
		var_1_1 = (8.8 - 255.2);
	}


	// From: Req2Batch61functionizing
	if (var_1_3 < var_1_2) {
		var_1_4 = (max (var_1_5 , var_1_6));
	}


	// From: Req3Batch61functionizing
	...
	// From: Req4Batch61functionizing
	if (var_1_4 >= (4256310412u - 128u)) {
		var_1_9 = ((abs (functionized4())) + var_1_12);
	}


	// From: Req5Batch61functionizing
	...
	// From: Req6Batch61functionizing
	var_1_19 = (var_1_20 + (10 + (abs (var_1_21))));


	// From: Req7Batch61functionizing
	if (var_1_18) {
		var_1_22 = (functionized7(var_1_8, var_1_23));
	}


	// From: Req8Batch61functionizing
	var_1_26 = var_1_21;


	// From: Req9Batch61functionizing
	var_1_27 = var_1_21;
}
...
int property(void) {
	return ((((((((((var_1_2 / (abs (64u))) == var_1_3) ? (var_1_1 == ((double) (8.8 - 255.2))) : 1) && ((var_1_3 < var_1_2) ? (var_1_4 == ((unsigned long int) (max (var_1_5 , var_1_6)))) : 1)) && ((var_1_4 <= (max (var_1_3 , var_1_5))) ? ((var_1_4 < var_1_5) ? ((var_1_4 >= (var_1_3 ^ 4u)) ? (var_1_7 == ((float) var_1_8)) : 1) : (var_1_7 == ((float) var_1_8))) : (var_1_7 == ((float) var_1_8)))) && ((var_1_4 >= (4256310412u - 128u)) ? (var_1_9 == ((signed long int) ((abs (var_1_10 + var_1_11)) + var_1_12))) : 1)) && ((var_1_2 >= (var_1_14 - (min (var_1_15 , var_1_16)))) ? ((var_1_16 < var_1_9) ? (var_1_13 == ((unsigned char) var_1_17)) : (var_1_13 == ((unsigned char) var_1_18))) : (var_1_13 == ((unsigned char) var_1_18)))) && (var_1_19 == ((unsigned char) (var_1_20 + (10 + (abs (var_1_21))))))) && (var_1_18 ? (var_1_22 == ((unsigned char) (((- var_1_1) <= var_1_8) && (var_1_23 || (var_1_24 || var_1_25))))) : 1)) && (var_1_26 == ((signed char) var_1_21))) && (var_1_27 == ((unsigned short int) var_1_21))
;
}
int main(void) {
	isInitial = 1;
