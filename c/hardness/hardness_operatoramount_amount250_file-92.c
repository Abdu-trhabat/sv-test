...
void step(void) {
	...
	if ((3.2 + (var_1_43 * last_1_var_1_35)) >= last_1_var_1_66) {
		if (last_1_var_1_1 || stepLocal_9) {
			...
			var_1_61 = (abs (var_1_26));
		}
	}


	// From: Req25Batch92Amount250
	if ((3.2 / 50.5) > (var_1_61 / (abs (var_1_37)))) {
		var_1_64 = var_1_47;
	} else {
		var_1_64 = var_1_51;
	}
	...
	if (var_1_49 <= stepLocal_8) {
		if (var_1_9) {
			var_1_53 = ((max (var_1_38 , (var_1_39 + var_1_40))) - ((var_1_54 - var_1_55) + (var_1_56 - var_1_57)));
		} else {
			var_1_53 = (min (var_1_38 , (var_1_43 + var_1_39)));
		}
	}
	...
	if (var_1_18 <= var_1_11) {
		if (((var_1_8 | var_1_20) < var_1_13) || (var_1_5 && var_1_1)) {
			var_1_21 = (max (((max (2u , var_1_8)) + var_1_20) , var_1_64));
		} else {
			var_1_21 = (((min (var_1_13 , var_1_64)) + var_1_8) + var_1_20);
		}
	}
	...
	if (var_1_10 < (var_1_23 << var_1_13)) {
		if (((var_1_23 >> var_1_33) + var_1_30) == (abs (var_1_18))) {
			var_1_32 = (max (var_1_30 , var_1_8));
		}
	} else {
		if (var_1_9) {
			...
			if (var_1_10 > var_1_8) {
				var_1_32 = (max (var_1_12 , (var_1_24 - var_1_30)));
			} else {
	...
	if (var_1_9) {
		if (((abs (var_1_13)) + var_1_24) != var_1_7) {
	...
	var_1_58 = (abs (var_1_29 - (min (var_1_33 , var_1_59))));
	...
	// From: Req30Batch92Amount250
	var_1_69 = last_1_var_1_69;


	// From: Req9Batch92Amount250
	if (49.3 >= (var_1_68 * var_1_53)) {
		var_1_28 = ((abs (var_1_29)) - ((var_1_58 + var_1_24) + var_1_65));
	} else {
	...
	if (((- var_1_61) > (min (var_1_53 , var_1_61))) && stepLocal_2) {
		if (var_1_8 >= stepLocal_3) {
			var_1_22 = (min (var_1_13 , (var_1_69 + var_1_8)));
		} else {
	...
	signed long int stepLocal_5 = (max (var_1_22 , var_1_33)) << var_1_65;
	if (stepLocal_5 > (max (var_1_14 , var_1_64))) {
		var_1_34 = (min (var_1_11 , var_1_29));
	}
	...
	if (! (var_1_34 != (var_1_58 * var_1_23))) {
		if (var_1_6) {
			var_1_35 = (((min (var_1_36 , var_1_37)) - var_1_38) - ((max (8.5f , var_1_39)) + var_1_40));
		} else {
			if (stepLocal_6 >= var_1_44) {
				var_1_35 = ((max (var_1_40 , var_1_39)) + var_1_27);
			} else {
	...
	if (var_1_43 <= (min (var_1_66 , (- var_1_61)))) {
		if (var_1_1) {
			var_1_46 = ((var_1_50 + (var_1_47 - var_1_13)) - var_1_33);
		} else {
			var_1_46 = ((min ((var_1_33 + var_1_47) , var_1_8)) - var_1_13);
		}
	} else {
	...
	if (var_1_1) {
		...
		var_1_60 = ((4 + var_1_48) - (min (var_1_33 , var_1_8)));
	}


	// From: Req24Batch92Amount250
	if (var_1_69 <= var_1_10) {
		var_1_63 = (max (((var_1_47 - var_1_51) + (abs (var_1_49))) , (var_1_31 + (var_1_13 - var_1_33))));
	}


	// From: Req28Batch92Amount250
	if (var_1_9) {
		var_1_67 = var_1_22;
	} else {
		var_1_67 = var_1_7;
...
int property(void) {
	return (((((((((((((((((((((((((((((var_1_2 ? ((last_1_var_1_50 > last_1_var_1_62) ? (var_1_1 == ((unsigned char) (! (! (var_1_5 || var_1_6))))) : 1) : ((last_1_var_1_50 < (var_1_7 - (31514 - var_1_8))) ? (var_1_1 == ((unsigned char) (! var_1_9))) : (var_1_1 == ((unsigned char) (var_1_9 && var_1_6))))) && (var_1_10 == ((unsigned long int) (max (var_1_8 , var_1_11))))) && ((8u == ((3877202530u - var_1_8) >> var_1_13)) ? (var_1_12 == ((unsigned char) (abs (var_1_13)))) : 1)) && (((var_1_61 * var_1_53) != var_1_61) ? ((var_1_61 > (var_1_53 + var_1_61)) ? (var_1_14 == ((unsigned long int) (var_1_13 + ((var_1_18 - var_1_8) + var_1_69)))) : (var_1_14 == ((unsigned long int) (3685578368u - var_1_69)))) : 1)) && ((var_1_8 >= var_1_21) ? (var_1_19 == ((signed long int) last_1_var_1_19)) : ((var_1_53 != (abs (var_1_68))) ? (var_1_19 == ((signed long int) ((var_1_20 - var_1_13) - 128))) : (var_1_19 == ((signed long int) (var_1_13 + last_1_var_1_19)))))) && ((var_1_18 <= var_1_11) ? ((((var_1_8 | var_1_20) < var_1_13) || (var_1_5 && var_1_1)) ? (var_1_21 == ((unsigned long int) (max (((max (2u , var_1_8)) + var_1_20) , var_1_64)))) : (var_1_21 == ((unsigned long int) (((min (var_1_13 , var_1_64)) + var_1_8) + var_1_20)))) : 1)) && ((((- var_1_61) > (min (var_1_53 , var_1_61))) && var_1_1) ? ((var_1_8 >= (var_1_20 + -10000)) ? (var_1_22 == ((unsigned short int) (min (var_1_13 , (var_1_69 + var_1_8))))) : (var_1_22 == ((unsigned short int) ((var_1_69 + var_1_8) + (var_1_23 - var_1_13))))) : (var_1_22 == ((unsigned short int) (var_1_24 - var_1_8))))) && (((var_1_19 + 10u) >= var_1_20) ? (var_1_25 == ((float) var_1_26)) : (var_1_25 == ((float) (max ((var_1_27 + 255.5f) , var_1_26)))))) && ((49.3 >= (var_1_68 * var_1_53)) ? (var_1_28 == ((unsigned long int) ((abs (var_1_29)) - ((var_1_58 + var_1_24) + var_1_65)))) : (var_1_28 == ((unsigned long int) (var_1_29 - (min (var_1_20 , var_1_13))))))) && (var_1_9 ? (var_1_30 == ((unsigned char) (max (var_1_13 , var_1_31)))) : 1)) && ((var_1_10 < (var_1_23 << var_1_13)) ? ((((var_1_23 >> var_1_33) + var_1_30) == (abs (var_1_18))) ? (var_1_32 == ((unsigned short int) (max (var_1_30 , var_1_8)))) : 1) : (var_1_9 ? (var_1_32 == ((unsigned short int) (var_1_31 + var_1_23))) : ((var_1_10 > var_1_8) ? (var_1_32 == ((unsigned short int) (max (var_1_12 , (var_1_24 - var_1_30))))) : (var_1_32 == ((unsigned short int) ((var_1_23 - var_1_8) + (var_1_12 + var_1_30)))))))) && ((((max (var_1_22 , var_1_33)) << var_1_65) > (max (var_1_14 , var_1_64))) ? (var_1_34 == ((unsigned long int) (min (var_1_11 , var_1_29)))) : 1)) && ((! (var_1_34 != (var_1_58 * var_1_23))) ? (var_1_6 ? (var_1_35 == ((float) (((min (var_1_36 , var_1_37)) - var_1_38) - ((max (8.5f , var_1_39)) + var_1_40)))) : ((var_1_13 >= var_1_44) ? (var_1_35 == ((float) ((max (var_1_40 , var_1_39)) + var_1_27))) : (var_1_35 == ((float) (var_1_36 - var_1_41))))) : (var_1_35 == ((float) (var_1_40 + var_1_27))))) && ((var_1_28 > var_1_31) ? (var_1_42 == ((float) (var_1_39 + var_1_43))) : 1)) && (var_1_9 ? ((((abs (var_1_13)) + var_1_24) != var_1_7) ? (var_1_44 == ((unsigned long int) ((1491051567u + var_1_45) - var_1_33))) : 1) : 1)) && ((var_1_43 <= (min (var_1_66 , (- var_1_61)))) ? (var_1_1 ? (var_1_46 == ((signed short int) ((var_1_50 + (var_1_47 - var_1_13)) - var_1_33))) : (var_1_46 == ((signed short int) ((min ((var_1_33 + var_1_47) , var_1_8)) - var_1_13)))) : (var_1_46 == ((signed short int) (var_1_47 + var_1_33))))) && (var_1_48 == ((signed short int) ((var_1_31 + var_1_49) + 8)))) && ((((var_1_28 + var_1_58) >> (var_1_51 - var_1_52)) > var_1_69) ? (var_1_50 == ((unsigned short int) var_1_58)) : 1)) && ((var_1_49 <= last_1_var_1_14) ? (var_1_9 ? (var_1_53 == ((double) ((max (var_1_38 , (var_1_39 + var_1_40))) - ((var_1_54 - var_1_55) + (var_1_56 - var_1_57))))) : (var_1_53 == ((double) (min (var_1_38 , (var_1_43 + var_1_39)))))) : 1)) && (var_1_58 == ((unsigned long int) (abs (var_1_29 - (min (var_1_33 , var_1_59))))))) && (var_1_1 ? ((10u >= var_1_31) ? (var_1_60 == ((signed short int) var_1_34)) : 1) : (var_1_60 == ((signed short int) ((4 + var_1_48) - (min (var_1_33 , var_1_8))))))) && (((3.2 + (var_1_43 * last_1_var_1_35)) >= last_1_var_1_66) ? ((last_1_var_1_1 || (! 0)) ? (var_1_61 == ((double) var_1_26)) : (var_1_61 == ((double) (abs (var_1_26))))) : 1)) && (var_1_62 == ((unsigned short int) 16))) && ((var_1_69 <= var_1_10) ? (var_1_63 == ((signed short int) (max (((var_1_47 - var_1_51) + (abs (var_1_49))) , (var_1_31 + (var_1_13 - var_1_33)))))) : 1)) && (((3.2 / 50.5) > (var_1_61 / (abs (var_1_37)))) ? (var_1_64 == ((unsigned short int) var_1_47)) : (var_1_64 == ((unsigned short int) var_1_51)))) && (last_1_var_1_1 ? (var_1_65 == ((unsigned long int) last_1_var_1_28)) : 1)) && (var_1_66 == ((float) var_1_57))) && (var_1_9 ? (var_1_67 == ((signed long int) var_1_22)) : (var_1_67 == ((signed long int) var_1_7)))) && (var_1_6 ? (var_1_68 == ((double) (abs (var_1_36)))) : (var_1_68 == ((double) (((var_1_57 + var_1_55) + var_1_40) - var_1_41))))) && (var_1_69 == ((unsigned long int) last_1_var_1_69))
;
}
int main(void) {
	isInitial = 1;
