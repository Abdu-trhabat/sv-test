...
void step(void) {
	...
	// From: CodeObject7
	/* 319L, 203L) */ if (/* 320L, 166L, 167L) */ ((/* 321L, 164L, 168L) */ (min (/* 321L, 164L, 168L) */ (var_1_10) , (/* 323L, 163L, 170L) */ (min (/* 323L, 163L, 170L) */ (var_1_13) , (var_1_3))))))) >= (var_1_11))) {
	...
	// From: CodeObject6
	/* 305L, 153L) */ if (/* 306L, 134L, 135L) */ ((var_1_11) >= (/* 308L, 133L, 137L) */ (min (/* 308L, 133L, 137L) */ (/* 309L, 131L, 138L) */ (- (var_1_4))) , (64.1)))))) {
		/* 312L, 152L) */ var_1_44 = (
			/* 315L, 151L) */ ((
				var_1_45
			) - (
	...
	// From: CodeObject4
	/* 282L, 113L) */ if (/* 283L, 89L, 90L) */ ((var_1_36) <= (/* 285L, 88L, 92L) */ ((-128) | (var_1_7))))) {
