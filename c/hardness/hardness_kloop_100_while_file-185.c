...
void step(void) {
	// From: Req2Batch185100_while
	if ((var_1_9 - (min (var_1_10 , var_1_11))) >= var_1_3) {
		var_1_8 = (last_1_var_1_42 || var_1_13);
	}


	// From: Req12Batch185100_while
	var_1_42 = (! (! (var_1_8 && var_1_43)));


	// From: Req1Batch185100_while
	if (-0.87 >= (- (var_1_2 + var_1_3))) {
		var_1_1 = (min ((max ((max (var_1_4 , var_1_5)) , var_1_6)) , var_1_7));
	}


	// From: Req3Batch185100_while
	...
	// From: Req6Batch185100_while
	var_1_22 = var_1_5;


	// From: Req7Batch185100_while
	var_1_23 = ((min (var_1_24 , var_1_25)) - (var_1_18 + (var_1_26 - var_1_16)));


	// From: Req10Batch185100_while
	var_1_31 = ((min (var_1_32 , (var_1_33 + var_1_34))) + (min (var_1_35 , (min (var_1_36 , var_1_37)))));


	// From: Req11Batch185100_while
	if (var_1_10 > var_1_2) {
		var_1_38 = 5;
	} else {
	...
	// From: Req5Batch185100_while
	if (var_1_44) {
		var_1_20 = ((max (var_1_18 , var_1_19)) + (max (var_1_21 , 8u)));
	} else {
		var_1_20 = (min (var_1_22 , var_1_17));
	}


	// From: Req8Batch185100_while
...
int property(void) {
	return ((((((((((((((-0.87 >= (- (var_1_2 + var_1_3))) ? (var_1_1 == ((signed short int) (min ((max ((max (var_1_4 , var_1_5)) , var_1_6)) , var_1_7)))) : 1) && (((var_1_9 - (min (var_1_10 , var_1_11))) >= var_1_3) ? (var_1_8 == ((unsigned char) (last_1_var_1_42 || var_1_13))) : 1)) && ((var_1_8 && var_1_13) ? (var_1_14 == ((signed short int) (max (-200 , var_1_4)))) : 1)) && ((var_1_10 > var_1_2) ? (var_1_15 == ((unsigned char) (var_1_16 + ((max (var_1_17 , var_1_18)) - 16)))) : (((var_1_23 * var_1_4) <= var_1_5) ? (var_1_15 == ((unsigned char) var_1_19)) : (var_1_15 == ((unsigned char) var_1_17))))) && (var_1_44 ? (var_1_20 == ((unsigned long int) ((max (var_1_18 , var_1_19)) + (max (var_1_21 , 8u))))) : (var_1_20 == ((unsigned long int) (min (var_1_22 , var_1_17)))))) && (var_1_22 == ((signed short int) var_1_5))) && (var_1_23 == ((unsigned long int) ((min (var_1_24 , var_1_25)) - (var_1_18 + (var_1_26 - var_1_16)))))) && (((var_1_1 <= var_1_6) || var_1_44) ? ((var_1_42 || (var_1_9 >= var_1_11)) ? (var_1_27 == ((unsigned long int) var_1_25)) : 1) : (var_1_27 == ((unsigned long int) var_1_18)))) && (((~ var_1_18) <= (var_1_27 - var_1_21)) ? ((! var_1_8) ? (var_1_28 == ((unsigned char) ((var_1_18 + var_1_30) - var_1_16))) : 1) : 1)) && (var_1_31 == ((signed char) ((min (var_1_32 , (var_1_33 + var_1_34))) + (min (var_1_35 , (min (var_1_36 , var_1_37)))))))) && ((var_1_10 > var_1_2) ? (var_1_38 == ((unsigned short int) 5)) : ((var_1_23 <= ((var_1_39 - last_1_var_1_38) << var_1_26)) ? (var_1_38 == ((unsigned short int) (var_1_40 - var_1_17))) : (((var_1_1 <= var_1_14) || var_1_42) ? (var_1_38 == ((unsigned short int) (var_1_16 + var_1_14))) : (var_1_38 == ((unsigned short int) (48154 - var_1_30))))))) && (var_1_42 == ((unsigned char) (! (! (var_1_8 && var_1_43)))))) && (var_1_42 ? ((var_1_33 < var_1_17) ? (var_1_44 == ((unsigned char) (! (! 1)))) : 1) : (var_1_44 == ((unsigned char) var_1_43)))) && ((var_1_30 <= (128 + var_1_18)) ? ((var_1_21 > var_1_24) ? ((var_1_37 < (var_1_39 / var_1_30)) ? (var_1_45 == ((signed char) 1)) : (var_1_45 == ((signed char) var_1_37))) : (var_1_45 == ((signed char) var_1_32))) : (var_1_45 == ((signed char) var_1_34)))
;
}
int main(void) {
	isInitial = 1;
