...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch105functionizing.c", 13, "reach_error"); }
...
void functionized1(unsigned char, signed short int, signed short int, unsigned char, float, signed short int, signed short int, double);
void functionized2(double);
void functionized3(double, unsigned char, double);
double functionized4(double);
unsigned char functionized5(void);
unsigned long int functionized6(signed short int, unsigned long int);
...
void functionized0(float functionized0_localFunctionVar0) {
	if (var_1_3 != 255.6) {
		...
		var_1_1 = (max (functionized0_localFunctionVar0 , var_1_5));
	}
}
void functionized1(unsigned char functionized1_localFunctionVar0, signed short int functionized1_localFunctionVar1, signed short int functionized1_localFunctionVar2, unsigned char functionized1_localFunctionVar3, float functionized1_localFunctionVar4, signed short int functionized1_localFunctionVar5, signed short int functionized1_localFunctionVar6, double functionized1_localFunctionVar7) {
	if (functionized1_localFunctionVar3) {
		var_1_6 = functionized1_localFunctionVar2;
	} else {
		if (functionized1_localFunctionVar7 >= functionized1_localFunctionVar4) {
			if (functionized1_localFunctionVar0) {
				var_1_6 = ((functionized1_localFunctionVar5 - var_1_10) + ((functionized1_localFunctionVar1 - 100) - functionized1_localFunctionVar6));
			} else {
				var_1_6 = 64;
			}
		} else {
...
void functionized2(double functionized2_localFunctionVar0) {
	if ((var_1_18 - (max (functionized2_localFunctionVar0 , var_1_20))) > 0.0) {
		var_1_17 = var_1_9;
	}
}
void functionized3(double functionized3_localFunctionVar0, unsigned char functionized3_localFunctionVar1, double localFunctionVar2) {
	if (functionized3_localFunctionVar1 || var_1_8) {
		var_1_21 = ((functionized3_localFunctionVar0 + var_1_23) + localFunctionVar2);
	}
}
double functionized4(double functionized4_localFunctionVar0) {
	return (functionized4_localFunctionVar0 - var_1_20);
}
unsigned char functionized5(void) {
	return (! var_1_2);
}
unsigned long int functionized6(signed short int functionized6_localFunctionVar0, unsigned long int functionized6_localFunctionVar1) {
	return (max (functionized6_localFunctionVar1 , functionized6_localFunctionVar0));
}
...
void step(void) {
	// From: Req1Batch105functionizing
	functionized0(var_1_4);


	// From: Req2Batch105functionizing
	functionized1(var_1_8, var_1_11, var_1_7, var_1_2, var_1_1, var_1_9, var_1_12, var_1_3);


	// From: Req3Batch105functionizing
	if (var_1_1 == var_1_4) {
	...
	// From: Req4Batch105functionizing
	functionized2(var_1_19);


	// From: Req5Batch105functionizing
	functionized3(var_1_22, var_1_2, 3.75);


	// From: Req6Batch105functionizing
	if (functionized4(var_1_19) > (min ((min (var_1_1 , var_1_25)) , var_1_3))) {
		if (functionized5()) {
	...
	// From: Req7Batch105functionizing
	if (var_1_7 >= (functionized6(var_1_11, var_1_24))) {
