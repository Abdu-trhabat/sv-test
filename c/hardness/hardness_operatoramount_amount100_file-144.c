...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch144Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch144Amount100
	var_1_16 = (! (var_1_27 || var_1_17));


	// From: Req4Batch144Amount100
	if (last_1_var_1_27) {
	...
	// From: Req14Batch144Amount100
	var_1_33 = var_1_11;


	// From: Req3Batch144Amount100
	...
	// From: Req6Batch144Amount100
	if (10 > var_1_20) {
		var_1_15 = var_1_4;
	} else {
		var_1_15 = (min (var_1_4 , (min (var_1_3 , var_1_2))));
	}


	// From: Req1Batch144Amount100
	var_1_1 = ((100 - var_1_2) - (max (var_1_3 , var_1_4)));


	// From: Req10Batch144Amount100
	if (! var_1_16) {
		var_1_23 = var_1_2;
	} else {
		var_1_23 = (min (var_1_4 , var_1_2));
	}


	// From: Req13Batch144Amount100
	var_1_32 = var_1_3;


	// From: Req2Batch144Amount100
	...
	// From: Req5Batch144Amount100
	var_1_14 = var_1_32;


	// From: Req8Batch144Amount100
...
int property(void) {
	return (((((((((((((var_1_1 == ((signed char) ((100 - var_1_2) - (max (var_1_3 , var_1_4))))) && (((var_1_20 & var_1_9) >= var_1_4) ? (((- 16) <= var_1_9) ? (var_1_5 == ((double) var_1_7)) : (var_1_5 == ((double) var_1_8))) : 1)) && ((last_1_var_1_5 > var_1_7) ? (last_1_var_1_16 ? (var_1_9 == ((unsigned short int) ((var_1_2 + var_1_3) + var_1_4))) : (var_1_9 == ((unsigned short int) var_1_2))) : (var_1_9 == ((unsigned short int) var_1_2)))) && (last_1_var_1_27 ? (var_1_11 == ((unsigned long int) ((var_1_12 - (var_1_13 - 128u)) + var_1_3))) : ((16 <= var_1_13) ? (var_1_11 == ((unsigned long int) var_1_12)) : (var_1_11 == ((unsigned long int) var_1_13))))) && (var_1_14 == ((signed short int) var_1_32))) && ((10 > var_1_20) ? (var_1_15 == ((unsigned short int) var_1_4)) : (var_1_15 == ((unsigned short int) (min (var_1_4 , (min (var_1_3 , var_1_2)))))))) && (var_1_16 == ((unsigned char) (! (var_1_27 || var_1_17))))) && ((((var_1_5 + var_1_8) + var_1_7) > var_1_5) ? ((var_1_11 < var_1_4) ? (var_1_18 == ((float) var_1_8)) : (var_1_18 == ((float) var_1_7))) : 1)) && ((((- var_1_13) / (3056966758u - var_1_21)) < (var_1_12 * last_1_var_1_33)) ? (var_1_20 == ((signed long int) (last_1_var_1_33 - var_1_21))) : (var_1_20 == ((signed long int) ((var_1_22 - (var_1_13 - 16)) - var_1_2))))) && ((! var_1_16) ? (var_1_23 == ((unsigned short int) var_1_2)) : (var_1_23 == ((unsigned short int) (min (var_1_4 , var_1_2)))))) && (((var_1_8 != var_1_5) || var_1_17) ? (var_1_16 ? (var_1_24 == ((unsigned char) (var_1_26 - var_1_3))) : ((var_1_9 <= var_1_11) ? (var_1_24 == ((unsigned char) var_1_3)) : (var_1_24 == ((unsigned char) (max (var_1_3 , var_1_26)))))) : (var_1_24 == ((unsigned char) var_1_4)))) && ((var_1_2 >= ((var_1_3 + last_1_var_1_9) ^ var_1_12)) ? ((! last_1_var_1_16) ? ((((1 + var_1_26) <= last_1_var_1_20) || (var_1_4 < last_1_var_1_11)) ? (var_1_27 == ((unsigned char) (! var_1_29))) : (var_1_27 == ((unsigned char) ((last_1_var_1_15 < last_1_var_1_33) || (last_1_var_1_16 || (var_1_17 || var_1_29)))))) : (var_1_27 == ((unsigned char) ((10000 > last_1_var_1_20) && var_1_31)))) : (var_1_27 == ((unsigned char) 0)))) && (var_1_32 == ((signed char) var_1_3))) && (var_1_33 == ((signed long int) var_1_11))
;
}
int main(void) {
	isInitial = 1;
