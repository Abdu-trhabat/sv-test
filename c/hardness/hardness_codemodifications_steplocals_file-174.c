...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch174stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch174stepLocals
	if (var_1_2 < (var_1_3 / var_1_4)) {
		var_1_1 = (var_1_5 + var_1_6);
	}


	// From: Req2Batch174stepLocals
	signed long int stepLocal_0 = var_1_2 & (min (var_1_6 , var_1_5));
	if (var_1_8) {
		if (var_1_9) {
			var_1_7 = var_1_5;
		}
	...
	// From: Req3Batch174stepLocals
	signed long int stepLocal_2 = var_1_11 / var_1_10;
	...
	// From: Req4Batch174stepLocals
	signed long int stepLocal_4 = var_1_10 - var_1_13;
	...
	// From: Req5Batch174stepLocals
	signed long int stepLocal_5 = var_1_4 % var_1_10;
	...
	// From: Req6Batch174stepLocals
	var_1_22 = (var_1_16 - var_1_19);


	// From: Req7Batch174stepLocals
