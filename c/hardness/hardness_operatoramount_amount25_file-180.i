...
void step(void) {
 ...
 var_1_11 = (((7.2 - var_1_12) + var_1_13) + (((((16.6) < 0 ) ? -(16.6) : (16.6))) + var_1_14));
...
int property(void) {
 return (((((~ last_1_var_1_1) >= ((var_1_3 * -10) & var_1_4)) ? (var_1_1 == ((signed short int) last_1_var_1_1)) : 1) && ((! var_1_15) ? (var_1_5 == ((unsigned char) ((((var_1_7) < ((var_1_8 - (var_1_9 + var_1_10)))) ? (var_1_7) : ((var_1_8 - (var_1_9 + var_1_10))))))) : (var_1_5 == ((unsigned char) 10)))) && (var_1_11 == ((double) (((7.2 - var_1_12) + var_1_13) + (((((16.6) < 0 ) ? -(16.6) : (16.6))) + var_1_14))))) && ((var_1_12 == ((var_1_16 + var_1_17) - (var_1_18 + var_1_19))) ? (var_1_6 ? (var_1_15 == ((unsigned char) var_1_20)) : (var_1_15 == ((unsigned char) var_1_21))) : (var_1_15 == ((unsigned char) var_1_21)))
;
}
int main(void) {
 isInitial = 1;
