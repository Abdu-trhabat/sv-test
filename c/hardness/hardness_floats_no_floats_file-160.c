...
void step(void) {
	...
	// From: Req5Batch160no_floats
	var_1_18 = var_1_19;


	// From: Req2Batch160no_floats
	if (var_1_18) {
		var_1_10 = (1 - var_1_12);
	} else {
...
int property(void) {
	return (((((var_1_2 >= (var_1_3 + var_1_4)) ? (var_1_1 == ((signed char) (var_1_5 - ((var_1_6 + var_1_7) + (max (var_1_8 , var_1_9)))))) : (var_1_1 == ((signed char) var_1_8))) && (var_1_18 ? (var_1_10 == ((signed long int) (1 - var_1_12))) : (var_1_10 == ((signed long int) (max (var_1_13 , var_1_12)))))) && ((var_1_5 != var_1_9) ? (var_1_14 == ((unsigned char) ((var_1_17 > var_1_9) && var_1_16))) : 1)) && ((var_1_16 && var_1_18) ? (var_1_17 == ((signed short int) ((max ((max (var_1_8 , var_1_9)) , var_1_1)) + (var_1_7 + (var_1_15 - var_1_6))))) : (var_1_17 == ((signed short int) (abs (var_1_9)))))) && (var_1_18 == ((unsigned char) var_1_19))
;
}
int main(void) {
	isInitial = 1;
