...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch6Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	/* 384L, 272L) */ if (/* 385L, 229L, 230L) */ ((var_1_16) > (/* 387L, 228L, 232L) */ (min (/* 387L, 228L, 232L) */ (var_1_16) , (/* 389L, 227L, 234L) */ (max (/* 389L, 227L, 234L) */ (var_1_29) , (var_1_8))))))))) {
