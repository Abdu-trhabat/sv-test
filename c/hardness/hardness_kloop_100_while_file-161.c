...
void step(void) {
	// From: Req2Batch161100_while
	var_1_11 = (var_1_4 - (8.321944475028179E18f - var_1_8));


	// From: Req7Batch161100_while
	...
	// From: Req8Batch161100_while
	if (var_1_15 || (var_1_5 > (abs (-0.5f)))) {
		var_1_33 = var_1_34;
	}


	// From: Req9Batch161100_while
	var_1_35 = (2.5 - var_1_4);


	// From: Req10Batch161100_while
	if (! var_1_15) {
		var_1_36 = (max (var_1_37 , (var_1_38 + (max (var_1_39 , var_1_40)))));
	}


	// From: Req12Batch161100_while
	var_1_44 = var_1_25;


	// From: Req13Batch161100_while
	var_1_45 = var_1_37;


	// From: Req3Batch161100_while
	if ((var_1_30 * var_1_5) > (abs (var_1_30))) {
		if (! (var_1_4 != var_1_9)) {
			var_1_12 = var_1_15;
		}
	} else {
	...
	// From: Req6Batch161100_while
	signed long int stepLocal_1 = var_1_45 % 10;
	if (stepLocal_1 < ((var_1_29 - var_1_23) << var_1_22)) {
		var_1_28 = (max (var_1_23 , var_1_24));
	}


	// From: Req1Batch161100_while
	...
	// From: Req5Batch161100_while
	if (var_1_1 == var_1_11) {
		var_1_20 = ((max (var_1_21 , var_1_22)) + ((1000000000u + var_1_23) - (var_1_24 - var_1_25)));
	} else {
		var_1_20 = ((min (var_1_26 , var_1_27)) - var_1_24);
	}


	// From: Req11Batch161100_while
	...
	if ((var_1_20 - var_1_34) > stepLocal_5) {
		if (stepLocal_4 < var_1_34) {
			var_1_41 = (max (var_1_20 , var_1_34));
		} else {
			var_1_41 = var_1_42;
		}
	} else {
		if (var_1_39 < stepLocal_3) {
			var_1_41 = ((var_1_43 - var_1_42) + (max ((10 + var_1_34) , var_1_20)));
		} else {
	...
	// From: Req4Batch161100_while
	signed long int stepLocal_0 = var_1_45;
	if (var_1_30 == (max (49.25 , (- var_1_6)))) {
		if (! var_1_12) {
...
int property(void) {
	return (((((((((((((var_1_28 >= (var_1_28 / -4)) ? (var_1_1 == ((float) (var_1_4 - (var_1_5 - var_1_6)))) : ((64.075 <= var_1_5) ? (var_1_1 == ((float) (var_1_6 + (min (var_1_7 , (var_1_8 - var_1_9)))))) : ((! var_1_12) ? (var_1_1 == ((float) var_1_5)) : 1))) && (var_1_11 == ((float) (var_1_4 - (8.321944475028179E18f - var_1_8))))) && (((var_1_30 * var_1_5) > (abs (var_1_30))) ? ((! (var_1_4 != var_1_9)) ? (var_1_12 == ((unsigned char) var_1_15)) : 1) : (var_1_12 == ((unsigned char) var_1_16)))) && ((var_1_30 == (max (49.25 , (- var_1_6)))) ? ((! var_1_12) ? (((var_1_28 * var_1_41) > var_1_45) ? (var_1_17 == ((unsigned long int) var_1_19)) : (var_1_17 == ((unsigned long int) 256u))) : 1) : (var_1_17 == ((unsigned long int) var_1_19)))) && ((var_1_1 == var_1_11) ? (var_1_20 == ((unsigned long int) ((max (var_1_21 , var_1_22)) + ((1000000000u + var_1_23) - (var_1_24 - var_1_25))))) : (var_1_20 == ((unsigned long int) ((min (var_1_26 , var_1_27)) - var_1_24))))) && (((var_1_45 % 10) < ((var_1_29 - var_1_23) << var_1_22)) ? (var_1_28 == ((signed long int) (max (var_1_23 , var_1_24)))) : 1)) && ((var_1_21 > (var_1_26 - (var_1_29 - 128u))) ? ((9.2 == (var_1_31 - var_1_5)) ? (var_1_30 == ((double) var_1_32)) : (var_1_30 == ((double) var_1_9))) : (var_1_30 == ((double) var_1_32)))) && ((var_1_15 || (var_1_5 > (abs (-0.5f)))) ? (var_1_33 == ((unsigned char) var_1_34)) : 1)) && (var_1_35 == ((double) (2.5 - var_1_4)))) && ((! var_1_15) ? (var_1_36 == ((signed char) (max (var_1_37 , (var_1_38 + (max (var_1_39 , var_1_40))))))) : 1)) && (((var_1_20 - var_1_34) > var_1_21) ? (((var_1_25 >> var_1_42) < var_1_34) ? (var_1_41 == ((unsigned short int) (max (var_1_20 , var_1_34)))) : (var_1_41 == ((unsigned short int) var_1_42))) : ((var_1_39 < var_1_29) ? (var_1_41 == ((unsigned short int) ((var_1_43 - var_1_42) + (max ((10 + var_1_34) , var_1_20))))) : (var_1_41 == ((unsigned short int) (var_1_20 + var_1_42)))))) && (var_1_44 == ((signed long int) var_1_25))) && (var_1_45 == ((signed long int) var_1_37))
;
}
int main(void) {
	isInitial = 1;
