...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_3 < ((min (var_1_8 , var_1_9)) - var_1_10)) {
		if (var_1_6) {
			var_1_7 = var_1_9;
		}
	}
	...
	// From: Req5Batch52normal
	if ((var_1_8 < var_1_16) && var_1_12) {
		var_1_15 = (max (var_1_10 , (var_1_16 - var_1_2)));
	} else {
		if (var_1_10 < var_1_1) {
			var_1_15 = var_1_8;
		} else {
	...
	// From: Req6Batch52normal
	var_1_17 = (abs (var_1_10));


	// From: Req7Batch52normal
	if ((var_1_1 + var_1_11) < var_1_8) {
		if (! var_1_13) {
			var_1_18 = var_1_19;
		}
	}
	...
	// From: Req8Batch52normal
	if (((var_1_10 | var_1_2) % (var_1_8 + var_1_9)) != var_1_17) {
		if (var_1_12) {
			var_1_20 = 5;
		} else {
			var_1_20 = var_1_10;
...
int property(void) {
	return (((((((((var_1_2 * (~ var_1_3)) >= var_1_4) ? ((var_1_4 <= var_1_5) ? (var_1_1 == ((signed long int) ((abs (var_1_2)) - var_1_3))) : 1) : (var_1_6 ? (var_1_1 == ((signed long int) var_1_2)) : (var_1_1 == ((signed long int) var_1_3)))) && ((var_1_3 < ((min (var_1_8 , var_1_9)) - var_1_10)) ? (var_1_6 ? (var_1_7 == ((unsigned long int) var_1_9)) : 1) : 1)) && (((64 - var_1_3) >= var_1_2) ? ((! var_1_6) ? (var_1_11 == ((signed long int) var_1_10)) : 1) : 1)) && (var_1_12 == ((unsigned char) (var_1_13 && var_1_14)))) && (((var_1_8 < var_1_16) && var_1_12) ? (var_1_15 == ((signed long int) (max (var_1_10 , (var_1_16 - var_1_2))))) : ((var_1_10 < var_1_1) ? (var_1_15 == ((signed long int) var_1_8)) : (var_1_15 == ((signed long int) var_1_10))))) && (var_1_17 == ((unsigned char) (abs (var_1_10))))) && (((var_1_1 + var_1_11) < var_1_8) ? ((! var_1_13) ? (var_1_18 == ((double) var_1_19)) : 1) : 1)) && ((((var_1_10 | var_1_2) % (var_1_8 + var_1_9)) != var_1_17) ? (var_1_12 ? (var_1_20 == ((unsigned char) 5)) : (var_1_20 == ((unsigned char) var_1_10))) : 1)
;
}
int main(void) {
	isInitial = 1;
