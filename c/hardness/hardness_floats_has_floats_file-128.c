...
void step(void) {
	...
	// From: Req3Batch128has_floats
	if (var_1_2) {
		var_1_10 = ((var_1_3 + var_1_4) + var_1_11);
	}


	// From: Req2Batch128has_floats
	...
	// From: Req4Batch128has_floats
	if (var_1_7 < var_1_9) {
		if (-10 == (max (var_1_10 , (var_1_11 << var_1_7)))) {
			if (var_1_2) {
				var_1_12 = ((max (var_1_14 , var_1_13)) + var_1_15);
			} else {
				var_1_12 = var_1_15;
			}
		}
...
int property(void) {
	return ((((var_1_2 || ((var_1_3 * var_1_4) >= var_1_5)) ? ((((var_1_3 + var_1_5) ^ var_1_4) >= 64) ? (var_1_1 == ((double) var_1_6)) : 1) : (var_1_1 == ((double) var_1_6))) && (((! var_1_2) && var_1_8) ? (var_1_7 == ((signed long int) (max (var_1_9 , var_1_10)))) : 1)) && (var_1_2 ? (var_1_10 == ((unsigned long int) ((var_1_3 + var_1_4) + var_1_11))) : 1)) && ((var_1_7 < var_1_9) ? ((-10 == (max (var_1_10 , (var_1_11 << var_1_7)))) ? (var_1_2 ? (var_1_12 == ((unsigned short int) ((max (var_1_14 , var_1_13)) + var_1_15))) : (var_1_12 == ((unsigned short int) var_1_15))) : 1) : (var_1_12 == ((unsigned short int) var_1_14)))
;
}
int main(void) {
	isInitial = 1;
