...
void step(void) {
 ...
 if (unsigned_short_int_Array_0[0][0] > stepLocal_2) {
  if (double_Array_0[3] < (double_Array_0[1] - double_Array_0[0])) {
   signed_long_int_Array_0[2] = ((((unsigned_short_int_Array_0[1][1]) < 0 ) ? -(unsigned_short_int_Array_0[1][1]) : (unsigned_short_int_Array_0[1][1])));
  } else {
 ...
 if (((((-25) < (unsigned_short_int_Array_0[0][0])) ? (-25) : (unsigned_short_int_Array_0[0][0]))) != stepLocal_0) {
  if (BOOL_unsigned_char_Array_0[1]) {
   signed_char_Array_0[2] = (signed_char_Array_0[1] + signed_char_Array_0[0]);
  }
 } else {
  signed_char_Array_0[2] = ((((signed_char_Array_0[0]) < (signed_char_Array_0[1])) ? (signed_char_Array_0[0]) : (signed_char_Array_0[1])));
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((BOOL_unsigned_char_Array_0[1] ? (double_Array_0[4] == ((double) ((((double_Array_0[3]) > ((double_Array_0[2] - (double_Array_0[1] - double_Array_0[0])))) ? (double_Array_0[3]) : ((double_Array_0[2] - (double_Array_0[1] - double_Array_0[0]))))))) : 1) && ((((((-25) < (unsigned_short_int_Array_0[0][0])) ? (-25) : (unsigned_short_int_Array_0[0][0]))) != (signed_long_int_Array_0[0] ^ signed_long_int_Array_0[1])) ? (BOOL_unsigned_char_Array_0[1] ? (signed_char_Array_0[2] == ((signed char) (signed_char_Array_0[1] + signed_char_Array_0[0]))) : 1) : (signed_char_Array_0[2] == ((signed char) ((((signed_char_Array_0[0]) < (signed_char_Array_0[1])) ? (signed_char_Array_0[0]) : (signed_char_Array_0[1]))))))) && (((signed_char_Array_0[1] >= last_1_signed_long_int_Array_0_2_) && BOOL_unsigned_char_Array_0[0]) ? (unsigned_short_int_Array_0[0][0] == ((unsigned short int) ((((unsigned_short_int_Array_0[1][1]) < (100)) ? (unsigned_short_int_Array_0[1][1]) : (100))))) : (unsigned_short_int_Array_0[0][0] == ((unsigned short int) ((unsigned_short_int_Array_0[1][0] - 5) + unsigned_short_int_Array_0[0][1]))))) && ((unsigned_short_int_Array_0[0][0] > unsigned_short_int_Array_0[1][0]) ? ((double_Array_0[3] < (double_Array_0[1] - double_Array_0[0])) ? (signed_long_int_Array_0[2] == ((signed long int) ((((unsigned_short_int_Array_0[1][1]) < 0 ) ? -(unsigned_short_int_Array_0[1][1]) : (unsigned_short_int_Array_0[1][1]))))) : (signed_long_int_Array_0[2] == ((signed long int) unsigned_short_int_Array_0[0][0]))) : (signed_long_int_Array_0[2] == ((signed long int) unsigned_short_int_Array_0[1][1])))
;
}
int main(void) {
 isInitial = 1;
