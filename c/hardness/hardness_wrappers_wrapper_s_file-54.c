...
void step(void) {
	...
	if (stepLocal_1 == (max (10 , WrapperStruct00.var_1_5))) {
		if (WrapperStruct00.var_1_6) {
			...
			if (WrapperStruct00.var_1_11 >= (abs (WrapperStruct00.var_1_14))) {
...
int property(void) {
	return (((((-4 >= WrapperStruct00.var_1_2) ? (WrapperStruct00.var_1_1 == ((unsigned char) (min (WrapperStruct00.var_1_3 , (abs (1)))))) : 1) && (((8 * WrapperStruct00.var_1_2) == (max (10 , WrapperStruct00.var_1_5))) ? (WrapperStruct00.var_1_6 ? (WrapperStruct00.var_1_4 == ((unsigned char) ((WrapperStruct00.var_1_14 < WrapperStruct00.var_1_11) && WrapperStruct00.var_1_9))) : ((WrapperStruct00.var_1_11 >= (abs (WrapperStruct00.var_1_14))) ? (WrapperStruct00.var_1_4 == ((unsigned char) (! WrapperStruct00.var_1_9))) : (WrapperStruct00.var_1_4 == ((unsigned char) 0)))) : (WrapperStruct00.var_1_4 == ((unsigned char) WrapperStruct00.var_1_10)))) && (WrapperStruct00.var_1_9 ? ((WrapperStruct00.var_1_3 > WrapperStruct00.var_1_5) ? (WrapperStruct00.var_1_11 == ((double) (max ((max (WrapperStruct00.var_1_12 , 16.5)) , WrapperStruct00.var_1_13)))) : (WrapperStruct00.var_1_10 ? (WrapperStruct00.var_1_11 == ((double) WrapperStruct00.var_1_12)) : 1)) : 1)) && (WrapperStruct00.var_1_14 == ((float) WrapperStruct00.var_1_12))) && (WrapperStruct00.var_1_15 == ((signed char) WrapperStruct00.var_1_16))
;
}
int main(void) {
	isInitial = 1;
