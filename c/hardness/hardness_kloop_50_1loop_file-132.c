...
void step(void) {
	...
	// From: Req3Batch13250_1loop
	var_1_9 = (! 0);


	// From: Req6Batch13250_1loop
	if (var_1_5 != var_1_13) {
		if (var_1_5 <= var_1_1) {
