...
void functionized1(float functionized1_localFunctionVar0, float functionized1_localFunctionVar1, float functionized1_localFunctionVar2) {
 if ((((((functionized1_localFunctionVar0) < (functionized1_localFunctionVar1)) ? (functionized1_localFunctionVar0) : (functionized1_localFunctionVar1))) <= functionized1_localFunctionVar2) && var_1_2) {
  var_1_15 = var_1_7;
 } else {
  var_1_15 = var_1_6;
 }
