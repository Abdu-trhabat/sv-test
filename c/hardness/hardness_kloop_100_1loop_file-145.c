...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch145100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch145100_1loop
	var_1_17 = (var_1_6 + var_1_7);


	// From: Req7Batch145100_1loop
