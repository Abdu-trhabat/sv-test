...
void step(void) {
	...
	if ((max ((WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3) , WrapperStruct00.var_1_4)) <= (min ((WrapperStruct00.var_1_5 - WrapperStruct00.var_1_6) , (WrapperStruct00.var_1_7 % WrapperStruct00.var_1_8)))) {
		WrapperStruct00.var_1_1 = (min ((WrapperStruct00.var_1_9 - WrapperStruct00.var_1_10) , WrapperStruct00.var_1_11));
	}
...
int property(void) {
	return (((((((max ((WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3) , WrapperStruct00.var_1_4)) <= (min ((WrapperStruct00.var_1_5 - WrapperStruct00.var_1_6) , (WrapperStruct00.var_1_7 % WrapperStruct00.var_1_8)))) ? (WrapperStruct00.var_1_1 == ((signed short int) (min ((WrapperStruct00.var_1_9 - WrapperStruct00.var_1_10) , WrapperStruct00.var_1_11)))) : 1) && ((WrapperStruct00.var_1_13 || (WrapperStruct00.var_1_1 <= WrapperStruct00.var_1_11)) ? (WrapperStruct00.var_1_12 == ((signed char) (abs (1 - WrapperStruct00.var_1_14)))) : (WrapperStruct00.var_1_12 == ((signed char) WrapperStruct00.var_1_14)))) && ((WrapperStruct00.var_1_10 <= (WrapperStruct00.var_1_2 / WrapperStruct00.var_1_8)) ? (WrapperStruct00.var_1_15 == ((double) (min ((max ((min (WrapperStruct00.var_1_16 , WrapperStruct00.var_1_17)) , WrapperStruct00.var_1_18)) , (max (3.6 , WrapperStruct00.var_1_19)))))) : (WrapperStruct00.var_1_15 == ((double) (WrapperStruct00.var_1_20 - WrapperStruct00.var_1_21))))) && (WrapperStruct00.var_1_22 == ((double) WrapperStruct00.var_1_19))) && (WrapperStruct00.var_1_23 == ((unsigned short int) WrapperStruct00.var_1_10))) && (WrapperStruct00.var_1_24 == ((signed char) WrapperStruct00.var_1_14))
;
}
int main(void) {
	isInitial = 1;
