...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch130Amount10.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch130Amount10
	if (var_1_2 && ((100 >> var_1_3) > var_1_4)) {
		var_1_1 = (5.5f - (var_1_5 + (min (var_1_6 , var_1_7))));
	} else {
		var_1_1 = var_1_7;
	}


	// From: Req2Batch130Amount10
	var_1_8 = var_1_3;
}
...
int property(void) {
	return ((var_1_2 && ((100 >> var_1_3) > var_1_4)) ? (var_1_1 == ((float) (5.5f - (var_1_5 + (min (var_1_6 , var_1_7)))))) : (var_1_1 == ((float) var_1_7))) && (var_1_8 == ((signed char) var_1_3))
;
}
int main(void) {
	isInitial = 1;
