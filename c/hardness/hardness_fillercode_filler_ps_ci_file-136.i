...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch136Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
                  if ( (( (( ((var_1_14) ^ (var_1_20))) * (var_1_13))) >= (var_1_6))) {
                   var_1_26 = (
   var_1_20
  );
 }
                  if ( (( ((var_1_5) >> (var_1_32))) < (var_1_13))) {
                   var_1_31 = (
                    ((((( ((((( var_1_32 )) < (( var_1_19 ))) ? (( var_1_32 )) : (( var_1_19 )))) )) > (( -50 ))) ? (( ((((( var_1_32 )) < (( var_1_19 ))) ? (( var_1_32 )) : (( var_1_19 )))) )) : (( -50 ))))
  );
 }
                  if ( ((var_1_14) <= (var_1_17))) {
                   var_1_34 = (
                    ((((( (( var_1_35 ) - ( ((((( var_1_32 )) > (( var_1_21 ))) ? (( var_1_32 )) : (( var_1_21 )))) )) )) < (( var_1_21 ))) ? (( (( var_1_35 ) - ( ((((( var_1_32 )) > (( var_1_21 ))) ? (( var_1_32 )) : (( var_1_21 )))) )) )) : (( var_1_21 ))))
  );
 }
                   if (var_1_9) {
                   var_1_38 = (
      ...
      var_1_32
                   ...
                   if ( ((var_1_25) <= (var_1_10))) {
                    var_1_46 = (
                     ((((( ((((( var_1_19 )) < (( var_1_32 ))) ? (( var_1_19 )) : (( var_1_32 )))) )) < (( var_1_18 ))) ? (( ((((( var_1_19 )) < (( var_1_32 ))) ? (( var_1_19 )) : (( var_1_32 )))) )) : (( var_1_18 ))))
  );
 } else {
