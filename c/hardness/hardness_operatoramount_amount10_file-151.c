...
int property(void) {
	return ((var_1_2 < last_1_var_1_1) ? (var_1_1 == ((unsigned long int) (var_1_4 - var_1_5))) : (var_1_1 == ((unsigned long int) (min (var_1_4 , var_1_5))))) && ((var_1_4 != (2953558882u - var_1_5)) ? (var_1_6 == ((signed short int) 16)) : 1)
;
}
int main(void) {
	isInitial = 1;
