...
void step(void) {
	...
	if (stepLocal_1 <= WrapperStruct00.var_1_1) {
		if ((abs (WrapperStruct00.var_1_14)) < stepLocal_2) {
	...
	// From: Req2Batch183Wrapper_S
	signed long int stepLocal_0 = max (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_6);
