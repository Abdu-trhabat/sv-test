...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch120functionizing.c", 13, "reach_error"); }
...
unsigned char functionized0(float functionized0_localFunctionVar0) {
 return ((var_1_7 + functionized0_localFunctionVar0) >= (var_1_8 / 0.5f));
}
signed long int functionized1(void) {
 return ((((var_1_3) > (var_1_12)) ? (var_1_3) : (var_1_12)));
}
signed long int functionized2(void) {
 return (8 & var_1_11);
}
...
void step(void) {
 ...
 var_1_11 = ((((var_1_2) < (functionized1())) ? (var_1_2) : (functionized1())));
 if (var_1_5) {
 ...
 if ((- (var_1_16 % var_1_19)) >= var_1_12) {
  if (((var_1_12 * var_1_2) ^ functionized2()) <= (128 / -100)) {
