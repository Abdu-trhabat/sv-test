...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch53Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_3 || (last_1_var_1_20 != var_1_4)) {
		if ((min (var_1_6 , 0)) <= stepLocal_2) {
			var_1_9 = var_1_6;
		}
	}


	// From: Req3Batch53Amount50
	...
	// From: Req6Batch53Amount50
	var_1_20 = var_1_21;


	// From: Req7Batch53Amount50
	var_1_22 = var_1_12;


	// From: Req8Batch53Amount50
	var_1_23 = var_1_21;


	// From: Req5Batch53Amount50
	unsigned long int stepLocal_6 = (max (var_1_15 , var_1_9)) / var_1_17;
	if (stepLocal_6 <= (256u << var_1_20)) {
		var_1_16 = (max (var_1_18 , var_1_19));
	}


	// From: Req4Batch53Amount50
	if (var_1_1) {
		var_1_14 = (max (var_1_20 , var_1_16));
	} else {
...
int property(void) {
	return (((((((((last_1_var_1_9 * last_1_var_1_14) == last_1_var_1_9) ? (((last_1_var_1_9 > (var_1_5 - var_1_6)) && last_1_var_1_1) ? (var_1_1 == ((unsigned char) var_1_8)) : 1) : 1) && (((last_1_var_1_1 || (var_1_6 <= last_1_var_1_23)) || (last_1_var_1_20 != var_1_4)) ? (((min (var_1_6 , 0)) <= (-5 + var_1_5)) ? (var_1_9 == ((unsigned long int) var_1_6)) : 1) : 1)) && (((! var_1_1) || var_1_8) ? (var_1_10 == ((float) (min ((var_1_11 + var_1_12) , (abs (var_1_13)))))) : (((var_1_11 < var_1_12) || (var_1_9 != var_1_6)) ? (var_1_10 == ((float) var_1_13)) : (var_1_10 == ((float) var_1_12))))) && (var_1_1 ? (var_1_14 == ((signed short int) (max (var_1_20 , var_1_16)))) : ((((var_1_9 / var_1_15) & var_1_6) >= var_1_9) ? (var_1_14 == ((signed short int) var_1_16)) : (var_1_14 == ((signed short int) -128))))) && ((((max (var_1_15 , var_1_9)) / var_1_17) <= (256u << var_1_20)) ? (var_1_16 == ((unsigned char) (max (var_1_18 , var_1_19)))) : 1)) && (var_1_20 == ((signed char) var_1_21))) && (var_1_22 == ((float) var_1_12))) && (var_1_23 == ((signed char) var_1_21))
;
}
int main(void) {
	isInitial = 1;
