...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10350_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch10350_while
	var_1_16 = ((min ((var_1_8 + var_1_9) , var_1_7)) - var_1_17);


	// From: Req6Batch10350_while
	...
	// From: Req7Batch10350_while
	var_1_24 = 2;


	// From: Req5Batch10350_while
