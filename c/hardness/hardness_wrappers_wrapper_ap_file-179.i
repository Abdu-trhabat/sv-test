...
void step(void) {
 ...
 if (stepLocal_0 && (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)))) {
  (*(double_Array_0_arraydouble_Array_0arrayVar7_Pointer)) = ((((((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer))) < ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer))))) + 7.5);
 }
 if ((*(double_Array_0_arraydouble_Array_0arrayVar7_Pointer)) > ((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer)) * (*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)))) {
  if ((*(double_Array_0_arraydouble_Array_0arrayVar7_Pointer)) <= (*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer))) {
   if ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) > (*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer))) {
    (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) = ((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer)) + ((((((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))) > ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))))) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))));
   } else {
