...
void functionized1(double functionized1_localFunctionVar0, double functionized1_localFunctionVar1) {
 if (functionized1_localFunctionVar0 > var_1_5) {
  if (functionized1_localFunctionVar1 != 199.5) {
   if (var_1_4 != (((((- 8.5)) > (functionized1_localFunctionVar0)) ? ((- 8.5)) : (functionized1_localFunctionVar0)))) {
    if (var_1_2) {
...
signed long int functionized4(void) {
 return ((((var_1_13) < ((var_1_14 + var_1_15))) ? (var_1_13) : ((var_1_14 + var_1_15))));
}
...
void step(void) {
 ...
 var_1_11 = ((((functionized3(var_1_10)) < (var_1_8)) ? (functionized3(var_1_10)) : (var_1_8)));
