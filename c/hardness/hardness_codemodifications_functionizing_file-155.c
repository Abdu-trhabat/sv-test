...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch155functionizing.c", 13, "reach_error"); }
...
void functionized2(unsigned char, unsigned char, unsigned short int);
...
signed long int functionized0(unsigned short int functionized0_localFunctionVar0) {
	return (abs (functionized0_localFunctionVar0 - var_1_15));
}
...
void functionized2(unsigned char functionized2_localFunctionVar0, unsigned char functionized2_localFunctionVar1, unsigned short int functionized2_localFunctionVar2) {
	if (var_1_13 > (var_1_10 * var_1_15)) {
		var_1_24 = (functionized2_localFunctionVar2 - functionized2_localFunctionVar0);
	} else {
		var_1_24 = (functionized2_localFunctionVar2 - (max (var_1_22 , functionized2_localFunctionVar1)));
	}
}
signed long int functionized3(void) {
	return (((abs (var_1_26)) - 25) - var_1_21);
}
void functionized4(void) {
...
void step(void) {
	// From: Req1Batch155functionizing
	if (var_1_2) {
		var_1_1 = var_1_3;
	} else {
	...
	// From: Req2Batch155functionizing
	...
	// From: Req3Batch155functionizing
	if ((abs (var_1_7)) == var_1_9) {
		var_1_11 = var_1_12;
	}


	// From: Req4Batch155functionizing
	if ((32.3 * var_1_1) > var_1_8) {
		var_1_13 = functionized0(var_1_14);
	}


	// From: Req5Batch155functionizing
	var_1_16 = (var_1_17 + var_1_18);


	// From: Req6Batch155functionizing
	if ((functionized1(var_1_20) / var_1_21) >= var_1_17) {
		var_1_19 = (var_1_22 + var_1_23);
	}


	// From: Req7Batch155functionizing
	functionized2(var_1_19, var_1_21, var_1_14);


	// From: Req8Batch155functionizing
	if (var_1_12) {
		var_1_25 = functionized3();
	}


	// From: Req9Batch155functionizing
	functionized4();
}
