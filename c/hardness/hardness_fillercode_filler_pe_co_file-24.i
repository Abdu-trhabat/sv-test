...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch24Filler_PE_CO.c", 13, "reach_error"); }
 ...
 signed long int stepLocal_0 = var_1_2;
  ...
  var_1_40
   ...
   var_1_38
                   ...
                   if ( (( ((var_1_38) / (var_1_47))) > ( ((var_1_16) / (16))))) {
                    var_1_46 = (
   var_1_38
  );
 } else {
                    if ( (( ((((((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)))) < 0 ) ? -(((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40)))) : (((((var_1_40) < 0 ) ? -(var_1_40) : (var_1_40))))))) != ( ((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))))) {
                     var_1_46 = (
    var_1_38
   );
  }
