...
void step(void) {
	...
	// From: Req7Batch156Amount100
	var_1_24 = 100u;


	// From: Req10Batch156Amount100
	if (var_1_26) {
		var_1_28 = var_1_9;
	}


	// From: Req2Batch156Amount100
	if (var_1_26) {
		if (var_1_4 > var_1_29) {
			var_1_10 = var_1_9;
		}
