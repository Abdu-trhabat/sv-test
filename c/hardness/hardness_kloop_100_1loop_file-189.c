...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch189100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req13Batch189100_1loop
	var_1_34 = (var_1_12 || (var_1_10 || var_1_11));


	// From: Req2Batch189100_1loop
	if (! last_1_var_1_34) {
	...
	// From: Req1Batch189100_1loop
	if (! (var_1_2 || var_1_4)) {
		var_1_1 = ((var_1_5 + var_1_6) - 1.000000000000005E13f);
	}


	// From: Req4Batch189100_1loop
	if (var_1_6 < var_1_1) {
		if (var_1_14 >= var_1_6) {
	...
	// From: Req9Batch189100_1loop
	if (var_1_11) {
		var_1_24 = (max ((min (var_1_9 , 4)) , (var_1_25 - var_1_18)));
	}


	// From: Req10Batch189100_1loop
	var_1_26 = ((min ((var_1_19 - var_1_17) , var_1_7)) + (var_1_18 + var_1_27));


	// From: Req12Batch189100_1loop
	if (! (var_1_17 >= var_1_22)) {
		var_1_30 = (max (((max (var_1_31 , var_1_32)) - var_1_25) , (max (128u , (var_1_33 - var_1_17)))));
	}


	// From: Req15Batch189100_1loop
	if ((max (var_1_6 , var_1_14)) < (max (var_1_5 , (var_1_37 - 100000.8)))) {
		var_1_36 = 4;
	}


	// From: Req5Batch189100_1loop
	...
	// From: Req6Batch189100_1loop
	if (var_1_10 && ((abs (var_1_17)) < (~ var_1_21))) {
		var_1_20 = var_1_19;
	} else {
		var_1_20 = var_1_7;
	}
	...
	if (var_1_14 >= var_1_5) {
		...
		var_1_23 = (max (var_1_9 , (abs (var_1_20))));
	}


	// From: Req14Batch189100_1loop
...
int property(void) {
	return (((((((((((((((! (var_1_2 || var_1_4)) ? (var_1_1 == ((float) ((var_1_5 + var_1_6) - 1.000000000000005E13f))) : 1) && ((! last_1_var_1_34) ? (((var_1_8 - var_1_9) < last_1_var_1_28) ? (var_1_7 == ((unsigned long int) var_1_8)) : 1) : 1)) && (last_1_var_1_34 ? (last_1_var_1_34 ? (var_1_10 == ((unsigned char) ((! 1) || (! var_1_11)))) : 1) : (var_1_10 == ((unsigned char) (! var_1_12))))) && ((var_1_6 < var_1_1) ? ((var_1_14 >= var_1_6) ? (var_1_13 == ((signed long int) (var_1_7 - var_1_9))) : (var_1_13 == ((signed long int) var_1_7))) : (var_1_13 == ((signed long int) var_1_7)))) && ((var_1_9 <= var_1_30) ? (var_1_12 ? (var_1_15 == ((unsigned char) var_1_17)) : (var_1_15 == ((unsigned char) (128 - (var_1_18 + var_1_19))))) : (var_1_15 == ((unsigned char) var_1_17)))) && ((var_1_10 && ((abs (var_1_17)) < (~ var_1_21))) ? (var_1_20 == ((unsigned short int) var_1_19)) : (var_1_20 == ((unsigned short int) var_1_7)))) && ((var_1_1 > (999.75f - (var_1_6 + var_1_5))) ? (var_1_12 ? ((var_1_19 > (var_1_7 + var_1_30)) ? (var_1_21 == ((unsigned long int) (var_1_8 + var_1_9))) : (var_1_21 == ((unsigned long int) var_1_22))) : (var_1_21 == ((unsigned long int) 10u))) : 1)) && ((var_1_14 >= var_1_5) ? ((var_1_5 >= var_1_6) ? (var_1_23 == ((signed long int) var_1_30)) : (var_1_23 == ((signed long int) var_1_19))) : (var_1_23 == ((signed long int) (max (var_1_9 , (abs (var_1_20)))))))) && (var_1_11 ? (var_1_24 == ((unsigned short int) (max ((min (var_1_9 , 4)) , (var_1_25 - var_1_18))))) : 1)) && (var_1_26 == ((signed short int) ((min ((var_1_19 - var_1_17) , var_1_7)) + (var_1_18 + var_1_27))))) && (var_1_28 == ((signed long int) (var_1_35 - (var_1_29 - var_1_20))))) && ((! (var_1_17 >= var_1_22)) ? (var_1_30 == ((unsigned long int) (max (((max (var_1_31 , var_1_32)) - var_1_25) , (max (128u , (var_1_33 - var_1_17))))))) : 1)) && (var_1_34 == ((unsigned char) (var_1_12 || (var_1_10 || var_1_11))))) && ((var_1_32 <= (var_1_7 + var_1_23)) ? (var_1_35 == ((signed short int) var_1_18)) : (var_1_35 == ((signed short int) (var_1_27 + var_1_17))))) && (((max (var_1_6 , var_1_14)) < (max (var_1_5 , (var_1_37 - 100000.8)))) ? (var_1_36 == ((signed short int) 4)) : 1)
;
}
int main(void) {
	isInitial = 1;
