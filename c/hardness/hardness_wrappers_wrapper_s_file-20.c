...
void step(void) {
	...
	if (WrapperStruct00.var_1_10 || stepLocal_0) {
		...
		WrapperStruct00.var_1_9 = (WrapperStruct00.var_1_13 + (abs (WrapperStruct00.var_1_12)));
	}
