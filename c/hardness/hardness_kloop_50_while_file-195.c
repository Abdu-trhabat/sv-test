...
void step(void) {
	// From: Req4Batch19550_while
	if ((last_1_var_1_16 ^ (last_1_var_1_24 / var_1_14)) <= last_1_var_1_24) {
		var_1_13 = var_1_15;
	}


	// From: Req9Batch19550_while
	var_1_24 = var_1_13;


	// From: Req1Batch19550_while
	...
	// From: Req5Batch19550_while
	if (var_1_6 < 0.375f) {
		var_1_16 = (max (var_1_17 , var_1_18));
	}


	// From: Req7Batch19550_while
	if (var_1_4) {
		var_1_22 = (min (var_1_7 , var_1_6));
	}


	// From: Req8Batch19550_while
	var_1_23 = var_1_15;


	// From: Req6Batch19550_while
	unsigned char stepLocal_2 = var_1_4;
	if (((min (var_1_23 , var_1_14)) >= (var_1_24 * var_1_18)) && stepLocal_2) {
		if (var_1_4) {
			var_1_19 = var_1_18;
		} else {
			var_1_19 = var_1_17;
