...
void step(void) {
	// From: Req18Batch169Amount250
	unsigned long int stepLocal_12 = var_1_38;
	signed long int stepLocal_11 = (max (var_1_27 , var_1_51)) - (var_1_48 - var_1_29);
	if (stepLocal_12 >= (max (last_1_var_1_59 , (- var_1_37)))) {
		if (var_1_24 >= stepLocal_11) {
			var_1_50 = ((4076336116u - last_1_var_1_36) - var_1_27);
		}
	} else {
		var_1_50 = (max (((var_1_27 + var_1_49) + var_1_25) , (min ((max (var_1_37 , last_1_var_1_36)) , var_1_48))));
	}


	// From: Req25Batch169Amount250
	unsigned short int stepLocal_16 = var_1_22;
	if (32.7f != last_1_var_1_35) {
		var_1_59 = var_1_21;
	} else {
		if (last_1_var_1_36 > stepLocal_16) {
			var_1_59 = (min (64u , var_1_53));
		}
	}


	// From: Req11Batch169Amount250
	if ((10 * -16) == ((50 + var_1_4) % var_1_21)) {
		var_1_35 = (min (var_1_12 , (9999999.4f + var_1_15)));
	} else {
		if (var_1_59 != (var_1_3 | (-1 + var_1_28))) {
			var_1_35 = (abs (max (var_1_11 , var_1_13)));
		} else {
	...
	// From: Req4Batch169Amount250
	if (var_1_6) {
		var_1_19 = (max (-2 , var_1_4));
	}


	// From: Req7Batch169Amount250
	...
	// From: Req10Batch169Amount250
	if (var_1_1) {
		var_1_34 = ((min ((max (var_1_15 , var_1_14)) , var_1_12)) + var_1_11);
	}


	// From: Req13Batch169Amount250
	var_1_39 = (min (var_1_12 , var_1_40));


	// From: Req14Batch169Amount250
	...
	// From: Req19Batch169Amount250
	unsigned char stepLocal_13 = var_1_48;
	if ((5u & (var_1_29 + var_1_4)) >= stepLocal_13) {
		var_1_52 = (var_1_27 - var_1_29);
	} else {
		if (var_1_17) {
			var_1_52 = ((max ((var_1_49 + var_1_48) , (var_1_53 - 32))) - 50);
		} else {
			var_1_52 = (max (((abs (100)) + var_1_28) , var_1_29));
		}
	}


	// From: Req20Batch169Amount250
	var_1_54 = var_1_10;


	// From: Req22Batch169Amount250
	var_1_56 = var_1_49;


	// From: Req27Batch169Amount250
	...
	// From: Req28Batch169Amount250
	var_1_65 = var_1_13;


	// From: Req29Batch169Amount250
	if (var_1_17) {
		var_1_66 = var_1_25;
	} else {
		var_1_66 = var_1_51;
	...
	// From: Req31Batch169Amount250
	var_1_68 = var_1_9;


	// From: Req21Batch169Amount250
	if (((var_1_37 * var_1_50) + var_1_3) != (max (var_1_56 , var_1_59))) {
	...
	// From: Req26Batch169Amount250
	if ((max (var_1_4 , var_1_2)) >= var_1_19) {
		var_1_61 = (var_1_23 + (var_1_62 - (var_1_63 - var_1_51)));
	}


	// From: Req30Batch169Amount250
	...
	// From: Req12Batch169Amount250
	if (var_1_55 || var_1_6) {
		if (var_1_5) {
			if (var_1_34 > var_1_13) {
				var_1_36 = ((max (var_1_33 , (1537811546u - var_1_21))) + var_1_50);
			} else {
				var_1_36 = (3798402642u - (max (var_1_25 , var_1_4)));
			}
		} else {
			var_1_36 = ((var_1_37 + 1121932705u) - var_1_21);
		}
	} else {
		var_1_36 = (min ((var_1_28 + var_1_3) , var_1_38));
	}


	// From: Req23Batch169Amount250
...
int property(void) {
	return (((((((((((((((((((((((((((((((1 < (var_1_2 - (var_1_3 + var_1_4))) ? (var_1_1 == ((unsigned char) (! (var_1_5 || var_1_6)))) : 1) && ((var_1_4 > ((var_1_3 - var_1_8) + var_1_2)) ? ((! var_1_5) ? (var_1_7 == ((float) var_1_9)) : 1) : (var_1_7 == ((float) (((max (4.625f , var_1_10)) - (var_1_11 + var_1_12)) + (var_1_13 + (var_1_14 - var_1_15))))))) && ((127.725f < var_1_13) ? ((var_1_4 < var_1_2) ? (var_1_16 == ((unsigned char) (! (var_1_17 && var_1_18)))) : ((var_1_10 < (var_1_14 * var_1_12)) ? (var_1_16 == ((unsigned char) ((var_1_15 >= (var_1_14 + 7.5f)) || var_1_17))) : (var_1_16 == ((unsigned char) var_1_18)))) : (var_1_16 == ((unsigned char) var_1_5)))) && (var_1_6 ? (var_1_19 == ((signed long int) (max (-2 , var_1_4)))) : 1)) && ((var_1_15 == (- var_1_43)) ? (var_1_20 == ((unsigned short int) (var_1_21 - var_1_22))) : 1)) && ((var_1_6 || ((var_1_21 * var_1_20) >= var_1_3)) ? (var_1_23 == ((unsigned char) (min ((max (var_1_24 , (max (1 , var_1_25)))) , (var_1_26 + 2))))) : (var_1_23 == ((unsigned char) (var_1_27 - (var_1_28 + var_1_29)))))) && ((var_1_5 || var_1_18) ? ((((var_1_19 | var_1_22) | var_1_4) > var_1_26) ? ((var_1_1 && var_1_6) ? (var_1_30 == ((signed char) var_1_31)) : 1) : 1) : 1)) && ((! ((var_1_57 | var_1_27) == var_1_28)) ? (var_1_32 == ((signed char) (-4 + (abs (var_1_29))))) : 1)) && ((var_1_18 && var_1_6) ? (var_1_33 == ((unsigned short int) 10)) : 1)) && (var_1_1 ? (var_1_34 == ((float) ((min ((max (var_1_15 , var_1_14)) , var_1_12)) + var_1_11))) : 1)) && (((10 * -16) == ((50 + var_1_4) % var_1_21)) ? (var_1_35 == ((float) (min (var_1_12 , (9999999.4f + var_1_15))))) : ((var_1_59 != (var_1_3 | (-1 + var_1_28))) ? (var_1_35 == ((float) (abs (max (var_1_11 , var_1_13))))) : (var_1_35 == ((float) (var_1_14 + var_1_12)))))) && ((var_1_55 || var_1_6) ? (var_1_5 ? ((var_1_34 > var_1_13) ? (var_1_36 == ((unsigned long int) ((max (var_1_33 , (1537811546u - var_1_21))) + var_1_50))) : (var_1_36 == ((unsigned long int) (3798402642u - (max (var_1_25 , var_1_4)))))) : (var_1_36 == ((unsigned long int) ((var_1_37 + 1121932705u) - var_1_21)))) : (var_1_36 == ((unsigned long int) (min ((var_1_28 + var_1_3) , var_1_38)))))) && (var_1_39 == ((float) (min (var_1_12 , var_1_40))))) && ((var_1_37 <= (var_1_42 - var_1_8)) ? (var_1_41 == ((float) (var_1_13 + var_1_14))) : 1)) && ((var_1_17 || (var_1_41 == var_1_15)) ? (var_1_43 == ((float) (var_1_44 - (var_1_10 + var_1_14)))) : 1)) && ((var_1_18 && var_1_5) ? ((var_1_4 != var_1_20) ? (var_1_45 == ((unsigned char) var_1_18)) : 1) : 1)) && ((((var_1_29 % var_1_47) & 32) == var_1_22) ? (((- var_1_44) < var_1_39) ? (var_1_46 == ((unsigned char) var_1_27)) : (var_1_46 == ((unsigned char) (((var_1_48 + var_1_49) - var_1_29) - var_1_28)))) : 1)) && ((var_1_38 >= (max (last_1_var_1_59 , (- var_1_37)))) ? ((var_1_24 >= ((max (var_1_27 , var_1_51)) - (var_1_48 - var_1_29))) ? (var_1_50 == ((unsigned long int) ((4076336116u - last_1_var_1_36) - var_1_27))) : 1) : (var_1_50 == ((unsigned long int) (max (((var_1_27 + var_1_49) + var_1_25) , (min ((max (var_1_37 , last_1_var_1_36)) , var_1_48)))))))) && (((5u & (var_1_29 + var_1_4)) >= var_1_48) ? (var_1_52 == ((unsigned char) (var_1_27 - var_1_29))) : (var_1_17 ? (var_1_52 == ((unsigned char) ((max ((var_1_49 + var_1_48) , (var_1_53 - 32))) - 50))) : (var_1_52 == ((unsigned char) (max (((abs (100)) + var_1_28) , var_1_29))))))) && (var_1_54 == ((double) var_1_10))) && ((((var_1_37 * var_1_50) + var_1_3) != (max (var_1_56 , var_1_59))) ? (var_1_55 == ((unsigned char) (var_1_16 && var_1_5))) : (var_1_55 == ((unsigned char) (! var_1_6))))) && (var_1_56 == ((unsigned short int) var_1_49))) && ((var_1_2 > var_1_48) ? ((! var_1_55) ? (var_1_57 == ((signed long int) ((var_1_56 + var_1_26) + var_1_53))) : (var_1_57 == ((signed long int) (abs (var_1_36))))) : 1)) && (((var_1_26 - var_1_49) >= var_1_61) ? ((var_1_43 == var_1_65) ? (var_1_58 == ((signed short int) (abs (var_1_51)))) : (var_1_58 == ((signed short int) (var_1_31 + (abs (max (var_1_46 , var_1_53))))))) : 1)) && ((32.7f != last_1_var_1_35) ? (var_1_59 == ((unsigned long int) var_1_21)) : ((last_1_var_1_36 > var_1_22) ? (var_1_59 == ((unsigned long int) (min (64u , var_1_53)))) : 1))) && (((max (var_1_4 , var_1_2)) >= var_1_19) ? (var_1_61 == ((unsigned short int) (var_1_23 + (var_1_62 - (var_1_63 - var_1_51))))) : 1)) && ((var_1_10 >= var_1_41) ? (((- var_1_53) < var_1_4) ? (((var_1_24 ^ (var_1_42 - var_1_56)) == var_1_8) ? (var_1_64 == ((unsigned char) var_1_17)) : (var_1_64 == ((unsigned char) var_1_18))) : 1) : 1)) && (var_1_65 == ((double) var_1_13))) && (var_1_17 ? (var_1_66 == ((unsigned long int) var_1_25)) : (var_1_66 == ((unsigned long int) var_1_51)))) && ((! (var_1_25 < var_1_20)) ? ((var_1_47 != ((var_1_29 - var_1_28) ^ var_1_66)) ? (var_1_67 == ((signed char) var_1_29)) : 1) : (var_1_67 == ((signed char) var_1_53)))) && (var_1_68 == ((float) var_1_9))
;
}
int main(void) {
	isInitial = 1;
