...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch129Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch129Amount50
	if ((var_1_2 ^ var_1_3) != var_1_4) {
		var_1_1 = (var_1_5 + var_1_6);
	} else {
		var_1_1 = ((max (var_1_7 , var_1_8)) - 32.4f);
	}


	// From: Req2Batch129Amount50
	if (((var_1_10 - var_1_11) - var_1_12) < var_1_2) {
		var_1_9 = var_1_8;
	}


	// From: Req3Batch129Amount50
	if ((var_1_10 ^ var_1_2) >= (var_1_4 | var_1_12)) {
		if (var_1_10 != (~ var_1_11)) {
			var_1_13 = (var_1_14 + (max (var_1_15 , var_1_16)));
		} else {
			var_1_13 = var_1_14;
		}
	}
	...
	// From: Req7Batch129Amount50
	signed long int stepLocal_3 = -8;
	if (stepLocal_3 < var_1_13) {
		var_1_26 = (max (var_1_22 , (max (var_1_8 , (var_1_7 - var_1_27)))));
	} else {
		var_1_26 = var_1_8;
	}
}
...
int property(void) {
	return ((((((((var_1_2 ^ var_1_3) != var_1_4) ? (var_1_1 == ((float) (var_1_5 + var_1_6))) : (var_1_1 == ((float) ((max (var_1_7 , var_1_8)) - 32.4f)))) && ((((var_1_10 - var_1_11) - var_1_12) < var_1_2) ? (var_1_9 == ((float) var_1_8)) : 1)) && (((var_1_10 ^ var_1_2) >= (var_1_4 | var_1_12)) ? ((var_1_10 != (~ var_1_11)) ? (var_1_13 == ((signed short int) (var_1_14 + (max (var_1_15 , var_1_16))))) : (var_1_13 == ((signed short int) var_1_14))) : 1)) && ((! last_1_var_1_17) ? (var_1_17 == ((unsigned char) var_1_19)) : (var_1_17 == ((unsigned char) ((! var_1_19) && var_1_20))))) && (var_1_21 == ((double) (1.000000005E8 - (7.46417232161781E18 - var_1_22))))) && ((var_1_17 || var_1_19) ? (((var_1_24 - 16) >= var_1_14) ? ((var_1_2 < var_1_4) ? (var_1_23 == ((unsigned char) var_1_25)) : 1) : (var_1_23 == ((unsigned char) var_1_25))) : (var_1_23 == ((unsigned char) var_1_25)))) && ((-8 < var_1_13) ? (var_1_26 == ((double) (max (var_1_22 , (max (var_1_8 , (var_1_7 - var_1_27))))))) : (var_1_26 == ((double) var_1_8)))
;
}
int main(void) {
	isInitial = 1;
