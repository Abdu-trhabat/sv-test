...
void step(void) {
	...
	// From: CodeObject2
	/* 252L, 53L) */ if (/* 253L, 36L, 37L) */ ((/* 254L, 32L, 38L) */ (- (var_1_2))) < (/* 256L, 35L, 40L) */ (max (/* 256L, 35L, 40L) */ (var_1_3) , (var_1_2)))))) {
		/* 259L, 52L) */ var_1_30 = (
			var_1_22
		);
	}
	...
	// From: CodeObject6
	/* 297L, 161L) */ if (/* 298L, 119L, 120L) */ ((var_1_28) == (var_1_40))) {
		/* 301L, 153L) */ if (/* 302L, 130L, 131L) */ ((/* 303L, 128L, 132L) */ ((var_1_16) * (var_1_17))) != (var_1_18))) {
			/* 307L, 146L) */ var_1_43 = (
				/* 310L, 145L) */ (max (
					/* 310L, 145L) */ (
						var_1_21
	...
	// From: CodeObject7
	/* 342L, 185L) */ if (/* 343L, 166L, 167L) */ (! (var_1_7))) {
		/* 345L, 178L) */ var_1_45 = (
			/* 348L, 177L) */ (max (
				/* 348L, 177L) */ (
					/* 349L, 175L) */ (max (
	...
	// From: CodeObject8
	/* 379L, 224L) */ if (/* 380L, 196L, 197L) */ ((var_1_4) <= (/* 382L, 195L, 199L) */ ((/* 383L, 191L, 200L) */ (abs (var_1_21))) * (/* 385L, 194L, 202L) */ ((var_1_21) * (var_1_2))))))) {
		/* 388L, 218L) */ var_1_50 = (
			/* 391L, 217L) */ ((
				var_1_51
			) - (
...
int property(void) {
	if (/* 401L, 8L, 16L, 336L, 358L, 1024L) */ ((var_1_2) != (/* 403L, 7L, 18L, 338L, 360L, 1026L) */ (max (/* 403L, 7L, 18L, 338L, 360L, 1026L) */ (64.8) , (/* 405L, 6L, 20L, 340L, 362L, 1028L) */ ((var_1_3) * (var_1_4)))))))) {
		if (/* 409L, 25L, 29L, 344L, 366L, 1032L) */ ((9.9999999999995E12) < (var_1_3))) {
		}
	} else {
	}
	if (/* 424L, 52L, 56L, 431L, 456L, 1047L) */ ((var_1_7) && (var_1_8))) {
	} else {
		if (var_1_8) {
		} else {
		}
	}
	if (/* 447L, 94L, 100L, 603L, 634L, 1070L) */ ((/* 448L, 92L, 101L, 604L, 635L, 1071L) */ ((var_1_8) && (var_1_7))) || (var_1_13))) {
		if (/* 453L, 113L, 123L, 609L, 640L, 1076L) */ ((/* 454L, 109L, 124L, 610L, 641L, 1077L) */ ((/* 455L, 107L, 125L, 611L, 642L, 1078L) */ ((var_1_10) / (var_1_14))) <= (var_1_18))) && (/* 459L, 112L, 129L, 615L, 646L, 1082L) */ ((var_1_2) < (var_1_4))))) {
			if (var_1_8) {
			} else {
			}
		}
	...
	if (/* 478L, 163L, 171L, 695L, 710L, 1101L) */ ((/* 479L, 161L, 172L, 696L, 711L, 1102L) */ ((var_1_10) << (/* 481L, 160L, 174L, 698L, 713L, 1104L) */ (min (/* 481L, 160L, 174L, 698L, 713L, 1104L) */ (1) , (var_1_17)))))) < (-1000000000))) {
	}
	if (/* 493L, 195L, 202L, 775L, 800L, 1116L) */ ((/* 494L, 193L, 203L, 776L, 801L, 1117L) */ ((/* 495L, 191L, 204L, 777L, 802L, 1118L) */ (abs (var_1_19))) - (var_1_17))) > (var_1_16))) {
	} else {
	}
	return /* 534L) */ ((
	/* 533L) */ ((
		/* 532L) */ ((
			/* 531L) */ ((
				/* 530L) */ ((
					/* 400L, 43L, 335L, 357L, 1023L) */ ((
						/* 401L, 8L, 16L, 336L, 358L, 1024L) */ ((
							var_1_2
						) != (
							/* 403L, 7L, 18L, 338L, 360L, 1026L) */ (max (
								/* 403L, 7L, 18L, 338L, 360L, 1026L) */ (
									64.8
								) , (
									/* 405L, 6L, 20L, 340L, 362L, 1028L) */ ((
										var_1_3
									) * (
										var_1_4
									))
						...
						/* 408L, 37L, 343L, 365L, 1031L) */ ((
							/* 409L, 25L, 29L, 344L, 366L, 1032L) */ ((
								9.9999999999995E12
							) < (
								var_1_3
							))
						) ? (
							/* 412L, 35L, 347L, 369L, 1035L) */ ((
								var_1_1
							) == (
								/* 412L, 35L, 347L, 369L, 1035L) */ ((signed short int) (
									var_1_5
								))
							))
						) : (
						...
						/* 416L, 41L, 351L, 373L, 1039L) */ ((
							var_1_1
						) == (
							/* 416L, 41L, 351L, 373L, 1039L) */ ((signed short int) (
								var_1_5
							))
						))
					))
				) && (
					/* 423L, 81L, 430L, 455L, 1046L) */ ((
						/* 424L, 52L, 56L, 431L, 456L, 1047L) */ ((
							var_1_7
						) && (
							var_1_8
						))
					) ? (
						/* 427L, 66L, 434L, 459L, 1050L) */ ((
							var_1_6
						) == (
							/* 427L, 66L, 434L, 459L, 1050L) */ ((signed long int) (
								/* 430L, 65L, 437L, 462L, 1053L) */ ((
									/* 431L, 63L, 438L, 463L, 1054L) */ ((
										var_1_9
									) - (
										var_1_10
									))
						...
						/* 435L, 79L, 442L, 467L, 1058L) */ ((
							var_1_8
						) ? (
							/* 437L, 73L, 444L, 469L, 1060L) */ ((
								var_1_6
							) == (
								/* 437L, 73L, 444L, 469L, 1060L) */ ((signed long int) (
									var_1_10
								))
							))
						) : (
							/* 441L, 77L, 448L, 473L, 1064L) */ ((
								var_1_6
							) == (
								/* 441L, 77L, 448L, 473L, 1064L) */ ((signed long int) (
									8
								))
							))
						))
				...
				/* 446L, 152L, 602L, 633L, 1069L) */ ((
					/* 447L, 94L, 100L, 603L, 634L, 1070L) */ ((
						/* 448L, 92L, 101L, 604L, 635L, 1071L) */ ((
							var_1_8
						) && (
							var_1_7
						))
					...
					/* 452L, 146L, 608L, 639L, 1075L) */ ((
						/* 453L, 113L, 123L, 609L, 640L, 1076L) */ ((
							/* 454L, 109L, 124L, 610L, 641L, 1077L) */ ((
								/* 455L, 107L, 125L, 611L, 642L, 1078L) */ ((
									var_1_10
								) / (
									var_1_14
								))
							...
							/* 459L, 112L, 129L, 615L, 646L, 1082L) */ ((
								var_1_2
							) < (
								var_1_4
							))
						...
						/* 462L, 144L, 618L, 649L, 1085L) */ ((
							var_1_8
						) ? (
							/* 464L, 138L, 620L, 651L, 1087L) */ ((
								var_1_12
							) == (
								/* 464L, 138L, 620L, 651L, 1087L) */ ((signed long int) (
									var_1_15
								))
							))
						) : (
							/* 468L, 142L, 624L, 655L, 1091L) */ ((
								var_1_12
							) == (
								/* 468L, 142L, 624L, 655L, 1091L) */ ((signed long int) (
									var_1_11
								))
							))
						))
					...
					/* 472L, 150L, 628L, 659L, 1095L) */ ((
						var_1_12
					) == (
						/* 472L, 150L, 628L, 659L, 1095L) */ ((signed long int) (
							var_1_9
						))
					))
				))
			...
			/* 477L, 185L, 694L, 709L, 1100L) */ ((
				/* 478L, 163L, 171L, 695L, 710L, 1101L) */ ((
					/* 479L, 161L, 172L, 696L, 711L, 1102L) */ ((
						var_1_10
					) << (
						/* 481L, 160L, 174L, 698L, 713L, 1104L) */ (min (
							/* 481L, 160L, 174L, 698L, 713L, 1104L) */ (
								1
							) , (
								var_1_17
							)
				...
				/* 485L, 183L, 702L, 717L, 1108L) */ ((
					var_1_16
				) == (
					/* 485L, 183L, 702L, 717L, 1108L) */ ((unsigned long int) (
						/* 488L, 182L, 705L, 720L, 1111L) */ (max (
							/* 488L, 182L, 705L, 720L, 1111L) */ (
								var_1_17
							) , (
								var_1_10
							)
		...
		/* 492L, 226L, 774L, 799L, 1115L) */ ((
			/* 493L, 195L, 202L, 775L, 800L, 1116L) */ ((
				/* 494L, 193L, 203L, 776L, 801L, 1117L) */ ((
					/* 495L, 191L, 204L, 777L, 802L, 1118L) */ (abs (
						var_1_19
					))
				) - (
					var_1_17
			...
			/* 499L, 216L, 781L, 806L, 1122L) */ ((
				var_1_18
			) == (
				/* 499L, 216L, 781L, 806L, 1122L) */ ((signed long int) (
					/* 502L, 215L, 784L, 809L, 1125L) */ ((
						var_1_19
					) - (
						/* 504L, 214L, 786L, 811L, 1127L) */ ((
							var_1_14
						) + (
							/* 506L, 213L, 788L, 813L, 1129L) */ (abs (
								var_1_10
							))
						))
					))
			...
			/* 508L, 224L, 790L, 815L, 1131L) */ ((
				var_1_18
			) == (
				/* 508L, 224L, 790L, 815L, 1131L) */ ((signed long int) (
					/* 511L, 223L, 793L, 818L, 1134L) */ (max (
						/* 511L, 223L, 793L, 818L, 1134L) */ (
							/* 512L, 221L, 794L, 819L, 1135L) */ ((
								var_1_10
							) + (
								var_1_5
							))
	...
	/* 518L, 241L, 851L, 864L, 1141L) */ ((
		var_1_20
	) == (
		/* 518L, 241L, 851L, 864L, 1141L) */ ((double) (
			/* 521L, 240L, 854L, 867L, 1144L) */ (max (
				/* 521L, 240L, 854L, 867L, 1144L) */ (
					/* 522L, 235L, 855L, 868L, 1145L) */ (min (
						/* 522L, 235L, 855L, 868L, 1145L) */ (
							var_1_21
						) , (
							var_1_22
						)
					...
					/* 525L, 239L, 858L, 871L, 1148L) */ ((
						/* 526L, 237L, 859L, 872L, 1149L) */ (abs (
							15.5
						))
					) - (
						var_1_23
