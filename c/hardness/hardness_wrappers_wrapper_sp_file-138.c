...
void step(void) {
	// From: Req1Batch138Wrapper_SP
	signed char stepLocal_0 = (*(WrapperStruct00_var_1_2_Pointer));
	if (stepLocal_0 >= (*(WrapperStruct00_var_1_3_Pointer))) {
		(*(WrapperStruct00_var_1_1_Pointer)) = (max ((*(WrapperStruct00_var_1_4_Pointer)) , ((*(WrapperStruct00_var_1_5_Pointer)) - (max (100 , (*(WrapperStruct00_var_1_6_Pointer)))))));
	} else {
		(*(WrapperStruct00_var_1_1_Pointer)) = (*(WrapperStruct00_var_1_4_Pointer));
	}


	// From: Req3Batch138Wrapper_SP
	...
	if (-128 >= stepLocal_1) {
		if (stepLocal_2 && (*(WrapperStruct00_var_1_13_Pointer))) {
			...
			(*(WrapperStruct00_var_1_11_Pointer)) = (abs ((*(WrapperStruct00_var_1_14_Pointer)) - ((*(WrapperStruct00_var_1_15_Pointer)) + (*(WrapperStruct00_var_1_16_Pointer)))));
		}
	} else {
