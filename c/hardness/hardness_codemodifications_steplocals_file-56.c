...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch56stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch56stepLocals
	if (var_1_4) {
		var_1_6 = (var_1_7 + (min (var_1_8 , var_1_9)));
	}


	// From: Req3Batch56stepLocals
	unsigned short int stepLocal_1 = var_1_7;
	if (stepLocal_1 >= (min (var_1_6 , (var_1_8 / 256)))) {
		var_1_10 = var_1_11;
	} else {
		var_1_10 = (max (var_1_6 , var_1_8));
	}


	// From: Req4Batch56stepLocals
	var_1_12 = ((64 + var_1_13) - var_1_14);


	// From: Req5Batch56stepLocals
	var_1_15 = ((var_1_16 - var_1_17) - 10);


	// From: Req6Batch56stepLocals
	if (var_1_3) {
		var_1_18 = (var_1_16 - var_1_13);
	}


	// From: Req7Batch56stepLocals
	signed long int stepLocal_2 = - (var_1_18 / var_1_13);
