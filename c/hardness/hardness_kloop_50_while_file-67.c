...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch6750_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch6750_while
	if (50 != var_1_2) {
		var_1_1 = (1.00000000000025E12 - 24.25);
	}


	// From: Req2Batch6750_while
	var_1_3 = (((5 - var_1_4) <= (var_1_2 + var_1_5)) || var_1_6);


	// From: Req3Batch6750_while
	unsigned char stepLocal_1 = var_1_5 > (var_1_4 * var_1_8);
	signed long int stepLocal_0 = var_1_5;
	if (((var_1_2 + 100) / var_1_8) >= stepLocal_0) {
	...
	// From: Req7Batch6750_while
	signed long int stepLocal_3 = var_1_4 / var_1_8;
	if (var_1_3) {
		if (var_1_6) {
			if (var_1_3) {
				var_1_17 = var_1_14;
			...
			if ((var_1_22 - var_1_20) > stepLocal_3) {
				if (var_1_7 >= var_1_10) {
					var_1_17 = var_1_14;
				}
			}
...
int property(void) {
	return (((((((50 != var_1_2) ? (var_1_1 == ((double) (1.00000000000025E12 - 24.25))) : 1) && (var_1_3 == ((unsigned char) (((5 - var_1_4) <= (var_1_2 + var_1_5)) || var_1_6)))) && ((((var_1_2 + 100) / var_1_8) >= var_1_5) ? ((var_1_3 || (var_1_5 > (var_1_4 * var_1_8))) ? (var_1_7 == ((float) var_1_9)) : (var_1_7 == ((float) (var_1_10 + var_1_11)))) : 1)) && (var_1_12 == ((signed char) (var_1_13 - var_1_14)))) && (var_1_15 == ((float) (abs (var_1_9))))) && ((var_1_1 > (var_1_11 + var_1_1)) ? ((var_1_14 < ((max (var_1_13 , var_1_4)) | var_1_2)) ? (var_1_3 ? (var_1_16 == ((signed char) -2)) : 1) : (var_1_16 == ((signed char) var_1_13))) : 1)) && (var_1_3 ? (var_1_6 ? (var_1_3 ? (var_1_17 == ((unsigned short int) var_1_14)) : (var_1_17 == ((unsigned short int) ((min (var_1_19 , var_1_20)) - ((var_1_21 - 256) - 256))))) : (((var_1_22 - var_1_20) > (var_1_4 / var_1_8)) ? ((var_1_7 >= var_1_10) ? (var_1_17 == ((unsigned short int) var_1_14)) : 1) : 1)) : (var_1_17 == ((unsigned short int) var_1_21)))
;
}
int main(void) {
	isInitial = 1;
