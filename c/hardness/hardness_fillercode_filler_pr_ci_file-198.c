...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch198Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	/* 341L, 183L) */ if (/* 342L, 160L, 161L) */ ((var_1_11) != (var_1_12))) {
		/* 345L, 181L) */ if (var_1_6) {
			/* 347L, 173L) */ var_1_27 = (
				var_1_26
			);
		} else {
	...
	// From: CodeObject4
	/* 358L, 215L) */ if (var_1_15) {
		/* 360L, 213L) */ if (/* 361L, 192L, 193L) */ ((var_1_19) >= (var_1_28))) {
			/* 364L, 208L) */ var_1_29 = (
				/* 367L, 207L) */ ((
					/* 368L, 205L) */ ((
						var_1_28
	...
	// From: CodeObject2
	/* 315L, 154L) */ if (/* 316L, 110L, 111L) */ ((/* 317L, 108L, 112L) */ ((/* 318L, 104L, 113L) */ (abs (var_1_12))) * (/* 320L, 107L, 115L) */ (abs (var_1_16))))) < (var_1_20))) {
		/* 323L, 148L) */ if (/* 324L, 129L, 130L) */ ((/* 325L, 127L, 131L) */ ((var_1_20) % (var_1_26))) > (var_1_16))) {
			/* 329L, 143L) */ var_1_25 = (
				var_1_16
			);
		} else {
