...
void step(void) {
	...
	// From: Req4Batch180Amount50
	var_1_14 = (min ((var_1_1 - var_1_12) , var_1_15));


	// From: Req3Batch180Amount50
	if (var_1_7) {
		if (! var_1_11) {
	...
	// From: Req7Batch180Amount50
	var_1_19 = (min (var_1_8 , var_1_9));


	// From: Req6Batch180Amount50
