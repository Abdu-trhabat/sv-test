...
void step(void) {
		...
		if ((last_1_var_1_108 == last_1_var_1_47) && stepLocal_37) {
			...
			if (stepLocal_35 >= last_1_var_1_103) {
				if (last_1_var_1_116 && stepLocal_36) {
					...
					var_1_103 = (max ((var_1_81 + (var_1_105 - var_1_13)) , ((max (46288 , var_1_39)) - var_1_12)));
				}
			} else {
				if ((var_1_24 * var_1_33) >= var_1_28) {
					var_1_103 = (abs (var_1_39 - (23813 - var_1_6)));
				} else {
	...
	// From: Req31Batch115Amount500
	if (var_1_40) {
		var_1_84 = (32 + (max (var_1_61 , (var_1_76 + var_1_62))));
	}


	// From: Req19Batch115Amount500
	var_1_64 = (max (var_1_54 , ((var_1_84 + var_1_6) + var_1_42)));


	// From: Req6Batch115Amount500
	if (var_1_33 == var_1_24) {
		var_1_36 = (var_1_9 - var_1_12);
	}


	// From: Req9Batch115Amount500
	var_1_41 = (var_1_42 - var_1_43);


	// From: Req15Batch115Amount500
	var_1_55 = (var_1_39 - (256 + (max (var_1_43 , 128))));


	// From: Req16Batch115Amount500
	if (var_1_10 <= var_1_13) {
		var_1_56 = (var_1_57 - var_1_11);
	}


	// From: Req21Batch115Amount500
	var_1_68 = var_1_49;


	// From: Req22Batch115Amount500
	unsigned long int stepLocal_21 = var_1_57;
	if (stepLocal_21 >= var_1_45) {
		var_1_69 = (max ((min ((min (256.55f , var_1_27)) , 24.4f)) , var_1_34));
	} else {
		var_1_69 = (min ((max ((max (var_1_24 , 9.75f)) , var_1_33)) , var_1_28));
	}


	// From: Req28Batch115Amount500
	var_1_80 = (var_1_81 + var_1_12);


	// From: Req35Batch115Amount500
	if (var_1_16) {
	...
	// From: Req43Batch115Amount500
	var_1_106 = var_1_54;


	// From: Req44Batch115Amount500
	if (var_1_18) {
		var_1_107 = var_1_26;
	} else {
		var_1_107 = var_1_33;
	...
	// From: Req45Batch115Amount500
	var_1_108 = var_1_56;


	// From: Req46Batch115Amount500
	if (var_1_88) {
		var_1_109 = var_1_110;
	}


	// From: Req48Batch115Amount500
	if (var_1_88) {
		var_1_112 = var_1_105;
	}


	// From: Req49Batch115Amount500
	var_1_113 = var_1_61;


	// From: Req51Batch115Amount500
	if (var_1_30) {
		var_1_115 = var_1_105;
	} else {
		var_1_115 = var_1_108;
	...
	// From: Req52Batch115Amount500
	var_1_116 = var_1_88;


	// From: Req53Batch115Amount500
	var_1_117 = var_1_73;


	// From: Req55Batch115Amount500
	if (var_1_89) {
		var_1_119 = var_1_23;
	}


	// From: Req56Batch115Amount500
	if (((-128 + var_1_112) + (max (-5 , -50))) > (var_1_12 - 50)) {
	...
	// From: Req2Batch115Amount500
	signed long int stepLocal_2 = abs (var_1_10);
	...
	// From: Req24Batch115Amount500
	if (var_1_49 >= (var_1_50 - (5.273781522086461E18f - var_1_34))) {
		if (var_1_116 || ((var_1_120 - var_1_8) != -25)) {
			if (var_1_115 > var_1_80) {
				if (var_1_54 == (var_1_39 / (min (2 , 32)))) {
					var_1_72 = (abs (var_1_43));
				} else {
					var_1_72 = (max (((var_1_73 - var_1_54) - (1 + var_1_62)) , var_1_61));
				}
			} else {
				var_1_72 = (min (var_1_73 , (max (var_1_43 , (-1 - var_1_62)))));
			}
		}
	}


	// From: Req32Batch115Amount500
	...
	// From: Req47Batch115Amount500
	if (var_1_116) {
		var_1_111 = 127.375f;
	}


	// From: Req50Batch115Amount500
	if (var_1_14) {
		var_1_114 = var_1_61;
	} else {
		var_1_114 = var_1_73;
	...
	// From: Req37Batch115Amount500
	if (var_1_85 == (- var_1_33)) {
		var_1_93 = (var_1_103 + (var_1_94 - var_1_81));
	} else {
		var_1_93 = ((var_1_73 + var_1_112) + ((max (var_1_94 , var_1_95)) - var_1_56));
	}


	// From: Req1Batch115Amount500
	if ((last_1_var_1_1 / (min (8 , var_1_3))) >= var_1_115) {
		if (! ((min (var_1_115 , last_1_var_1_1)) >= (5 / var_1_3))) {
	...
	// From: Req23Batch115Amount500
	signed char stepLocal_22 = var_1_42;
	if (! var_1_18) {
		var_1_70 = (var_1_51 - ((var_1_49 + var_1_71) + var_1_34));
	} else {
		if (stepLocal_22 > (-128 + var_1_93)) {
			var_1_70 = (min ((max (var_1_52 , var_1_29)) , var_1_34));
		} else {
			var_1_70 = (min (var_1_52 , (var_1_51 - var_1_24)));
		}
	}


	// From: Req26Batch115Amount500
	if (! ((max (var_1_29 , var_1_28)) >= var_1_107)) {
		var_1_77 = (var_1_97 + var_1_12);
	}


	// From: Req29Batch115Amount500
	if (var_1_46 >= var_1_57) {
		var_1_82 = (abs (var_1_36));
	} else {
		var_1_82 = ((min (var_1_61 , var_1_77)) - var_1_62);
	}


	// From: Req38Batch115Amount500
	signed long int stepLocal_30 = var_1_75 - var_1_10;
	if (var_1_16) {
		if (var_1_40) {
			if (var_1_18) {
				var_1_96 = (min ((max (var_1_10 , var_1_8)) , var_1_13));
			} else {
				if (var_1_88) {
					var_1_96 = var_1_62;
				} else {
					var_1_96 = ((abs (var_1_101)) + (var_1_75 + var_1_43));
				}
			}
		} else {
			var_1_96 = (min (var_1_76 , var_1_39));
		}
	} else {
		if (var_1_30) {
			if (var_1_43 >= stepLocal_30) {
				var_1_96 = (var_1_59 + (min (var_1_120 , var_1_64)));
			} else {
	...
	if (stepLocal_14 >= var_1_120) {
		var_1_58 = (abs (var_1_82));
	} else {
		if (stepLocal_13 < var_1_120) {
			if (var_1_84 < stepLocal_15) {
				var_1_58 = var_1_3;
			} else {
				var_1_58 = ((var_1_59 - (var_1_6 + var_1_54)) - (max (256 , var_1_55)));
			}
		} else {
			var_1_58 = (abs (var_1_5 - 25));
		}
	}


	// From: Req4Batch115Amount500
	...
	if (stepLocal_11 && (var_1_101 != var_1_109)) {
		...
		if (stepLocal_9 <= var_1_120) {
			if (var_1_87) {
				...
				var_1_48 = (var_1_33 - ((max (var_1_51 , var_1_52)) - var_1_50));
			}
		}
	}


	// From: Req20Batch115Amount500
	signed long int stepLocal_20 = min ((-128 ^ -2) , var_1_39);
	unsigned short int stepLocal_19 = var_1_113;
	signed short int stepLocal_18 = var_1_98;
	if (var_1_42 >= stepLocal_19) {
		if (10 >= stepLocal_20) {
			if ((min ((- var_1_118) , var_1_27)) > last_1_var_1_65) {
		...
		if (stepLocal_18 > (max (var_1_39 , var_1_5))) {
			var_1_65 = var_1_26;
		}
	}


	// From: Req25Batch115Amount500
	unsigned long int stepLocal_24 = - var_1_57;
	signed long int stepLocal_23 = var_1_101 + var_1_77;
	if ((min ((var_1_45 + var_1_56) , var_1_13)) == stepLocal_24) {
		var_1_74 = (var_1_43 + ((min (var_1_54 , var_1_62)) + (var_1_75 - var_1_76)));
	} else {
		if ((var_1_56 / var_1_61) == stepLocal_23) {
			var_1_74 = var_1_6;
		} else {
			var_1_74 = (abs (var_1_61 - (abs (var_1_12))));
		}
	}


	// From: Req30Batch115Amount500
	unsigned char stepLocal_26 = var_1_116;
	if ((var_1_14 && (var_1_17 && var_1_18)) && stepLocal_26) {
		if (var_1_69 > (var_1_21 * var_1_25)) {
			var_1_83 = (abs (min (var_1_62 , (max (var_1_42 , var_1_76)))));
		} else {
			var_1_83 = (max (var_1_73 , var_1_61));
		}
	} else {
		if (var_1_116) {
			var_1_83 = (max (var_1_75 , (abs (var_1_61))));
		} else {
			var_1_83 = (min ((var_1_76 + var_1_54) , 100));
		}
	}


	// From: Req10Batch115Amount500
	if (var_1_98 >= var_1_103) {
		if (var_1_87 && var_1_116) {
			var_1_44 = (var_1_98 + (max ((var_1_60 - var_1_12) , var_1_9)));
		} else {
	...
	// From: Req14Batch115Amount500
	signed long int stepLocal_12 = -2;
	if (var_1_116) {
		var_1_53 = (abs (abs (-64)));
	} else {
		if ((var_1_96 * (var_1_90 >> var_1_54)) != stepLocal_12) {
			var_1_53 = (abs ((26769 - var_1_98) - var_1_6));
		}
	}


	// From: Req12Batch115Amount500
	if (((max (-5 , var_1_97)) & (var_1_13 << 1)) > var_1_3) {
		var_1_47 = (max (var_1_53 , var_1_58));
	} else {
		var_1_47 = (min (var_1_10 , var_1_11));
	}


	// From: Req7Batch115Amount500
	...
	if (stepLocal_7 && var_1_17) {
		if (var_1_6 >= stepLocal_6) {
			var_1_37 = (max ((128 + var_1_6) , var_1_86));
		} else {
			var_1_37 = var_1_10;
		}
	} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((last_1_var_1_1 / (min (8 , var_1_3))) >= var_1_115) ? ((! ((min (var_1_115 , last_1_var_1_1)) >= (5 / var_1_3))) ? (var_1_1 == ((unsigned char) (max (var_1_5 , var_1_6)))) : (var_1_87 ? (var_1_1 == ((unsigned char) ((max (var_1_8 , var_1_9)) - var_1_10))) : (var_1_1 == ((unsigned char) ((var_1_11 + (abs (var_1_12))) - (max (var_1_10 , var_1_13))))))) : 1) && (((var_1_12 * var_1_3) <= (abs (var_1_10))) ? ((var_1_40 || var_1_116) ? (((min (var_1_12 , var_1_13)) < var_1_9) ? (var_1_14 == ((unsigned char) (var_1_16 && var_1_17))) : (var_1_14 == ((unsigned char) (var_1_16 && (var_1_17 || var_1_18))))) : 1) : 1)) && ((var_1_11 == ((- last_1_var_1_19) * (var_1_47 & 8))) ? (var_1_19 == ((signed short int) (min (var_1_9 , var_1_3)))) : (var_1_19 == ((signed short int) (max (var_1_10 , -1)))))) && (var_1_40 ? (var_1_116 ? (var_1_16 ? (var_1_87 ? (var_1_21 == ((float) (min (var_1_23 , ((min (var_1_24 , var_1_25)) - var_1_26))))) : (var_1_21 == ((float) (var_1_24 - (max (var_1_26 , var_1_25)))))) : (var_1_21 == ((float) ((var_1_27 + var_1_28) + var_1_29)))) : ((var_1_10 < (var_1_98 * var_1_55)) ? (var_1_21 == ((float) ((var_1_33 - (var_1_34 - 64.25f)) - var_1_26))) : (var_1_21 == ((float) var_1_24)))) : (var_1_21 == ((float) (var_1_33 - var_1_34))))) && ((var_1_34 >= var_1_27) ? ((var_1_9 > var_1_47) ? ((var_1_25 <= var_1_29) ? (var_1_35 == ((float) (min ((var_1_34 + var_1_29) , var_1_24)))) : (var_1_35 == ((float) var_1_29))) : 1) : 1)) && ((var_1_33 == var_1_24) ? (var_1_36 == ((unsigned char) (var_1_9 - var_1_12))) : 1)) && ((((- var_1_85) > var_1_29) && var_1_17) ? ((var_1_6 >= (var_1_11 * var_1_47)) ? (var_1_37 == ((unsigned short int) (max ((128 + var_1_6) , var_1_86)))) : (var_1_37 == ((unsigned short int) var_1_10))) : (var_1_37 == ((unsigned short int) ((var_1_39 - var_1_10) - var_1_5))))) && ((var_1_24 <= last_1_var_1_91) ? ((var_1_8 < (32 * (last_1_var_1_44 / var_1_11))) ? (var_1_40 == ((unsigned char) var_1_30)) : 1) : 1)) && (var_1_41 == ((signed char) (var_1_42 - var_1_43)))) && ((var_1_98 >= var_1_103) ? ((var_1_87 && var_1_116) ? (var_1_44 == ((signed long int) (var_1_98 + (max ((var_1_60 - var_1_12) , var_1_9))))) : (var_1_44 == ((signed long int) ((var_1_45 - var_1_55) - var_1_8)))) : 1)) && ((var_1_85 < var_1_25) ? (((last_1_var_1_46 + var_1_120) < (var_1_3 * (var_1_56 * var_1_8))) ? (var_1_46 == ((unsigned short int) (max (256 , var_1_6)))) : (var_1_46 == ((unsigned short int) var_1_12))) : 1)) && ((((max (-5 , var_1_97)) & (var_1_13 << 1)) > var_1_3) ? (var_1_47 == ((unsigned long int) (max (var_1_53 , var_1_58)))) : (var_1_47 == ((unsigned long int) (min (var_1_10 , var_1_11)))))) && ((var_1_18 && (var_1_101 != var_1_109)) ? (var_1_48 == ((float) var_1_28)) : (((min (var_1_39 , var_1_77)) <= var_1_120) ? (var_1_87 ? (((var_1_77 * (~ var_1_11)) <= var_1_5) ? (var_1_48 == ((float) var_1_34)) : (var_1_48 == ((float) (((var_1_34 - var_1_49) - var_1_50) + var_1_28)))) : (var_1_48 == ((float) (var_1_33 - ((max (var_1_51 , var_1_52)) - var_1_50))))) : 1))) && (var_1_116 ? (var_1_53 == ((signed short int) (abs (abs (-64))))) : (((var_1_96 * (var_1_90 >> var_1_54)) != -2) ? (var_1_53 == ((signed short int) (abs ((26769 - var_1_98) - var_1_6)))) : 1))) && (var_1_55 == ((unsigned short int) (var_1_39 - (256 + (max (var_1_43 , 128))))))) && ((var_1_10 <= var_1_13) ? (var_1_56 == ((unsigned long int) (var_1_57 - var_1_11))) : 1)) && ((var_1_82 >= var_1_120) ? (var_1_58 == ((signed short int) (abs (var_1_82)))) : ((var_1_84 < var_1_120) ? ((var_1_84 < (var_1_13 >> 2)) ? (var_1_58 == ((signed short int) var_1_3)) : (var_1_58 == ((signed short int) ((var_1_59 - (var_1_6 + var_1_54)) - (max (256 , var_1_55)))))) : (var_1_58 == ((signed short int) (abs (var_1_5 - 25))))))) && (((- var_1_11) < last_1_var_1_44) ? (var_1_60 == ((unsigned char) (((var_1_61 - var_1_54) - (8 + var_1_62)) - var_1_10))) : (((last_1_var_1_37 != last_1_var_1_93) || last_1_var_1_116) ? (var_1_60 == ((unsigned char) (var_1_62 + var_1_54))) : 1))) && (var_1_64 == ((signed short int) (max (var_1_54 , ((var_1_84 + var_1_6) + var_1_42)))))) && ((var_1_42 >= var_1_113) ? ((10 >= (min ((-128 ^ -2) , var_1_39))) ? (((min ((- var_1_118) , var_1_27)) > last_1_var_1_65) ? (var_1_65 == ((double) (var_1_34 + var_1_27))) : (var_1_65 == ((double) var_1_27))) : 1) : ((var_1_98 > (max (var_1_39 , var_1_5))) ? (var_1_65 == ((double) var_1_26)) : 1))) && (var_1_68 == ((double) var_1_49))) && ((var_1_57 >= var_1_45) ? (var_1_69 == ((float) (max ((min ((min (256.55f , var_1_27)) , 24.4f)) , var_1_34)))) : (var_1_69 == ((float) (min ((max ((max (var_1_24 , 9.75f)) , var_1_33)) , var_1_28)))))) && ((! var_1_18) ? (var_1_70 == ((float) (var_1_51 - ((var_1_49 + var_1_71) + var_1_34)))) : ((var_1_42 > (-128 + var_1_93)) ? (var_1_70 == ((float) (min ((max (var_1_52 , var_1_29)) , var_1_34)))) : (var_1_70 == ((float) (min (var_1_52 , (var_1_51 - var_1_24)))))))) && ((var_1_49 >= (var_1_50 - (5.273781522086461E18f - var_1_34))) ? ((var_1_116 || ((var_1_120 - var_1_8) != -25)) ? ((var_1_115 > var_1_80) ? ((var_1_54 == (var_1_39 / (min (2 , 32)))) ? (var_1_72 == ((signed char) (abs (var_1_43)))) : (var_1_72 == ((signed char) (max (((var_1_73 - var_1_54) - (1 + var_1_62)) , var_1_61))))) : (var_1_72 == ((signed char) (min (var_1_73 , (max (var_1_43 , (-1 - var_1_62)))))))) : 1) : 1)) && (((min ((var_1_45 + var_1_56) , var_1_13)) == (- var_1_57)) ? (var_1_74 == ((unsigned char) (var_1_43 + ((min (var_1_54 , var_1_62)) + (var_1_75 - var_1_76))))) : (((var_1_56 / var_1_61) == (var_1_101 + var_1_77)) ? (var_1_74 == ((unsigned char) var_1_6)) : (var_1_74 == ((unsigned char) (abs (var_1_61 - (abs (var_1_12))))))))) && ((! ((max (var_1_29 , var_1_28)) >= var_1_107)) ? (var_1_77 == ((signed short int) (var_1_97 + var_1_12))) : 1)) && ((var_1_10 < (var_1_47 + var_1_77)) ? (var_1_78 == ((unsigned short int) ((var_1_5 + (10000 - var_1_13)) + var_1_75))) : 1)) && (var_1_80 == ((unsigned char) (var_1_81 + var_1_12)))) && ((var_1_46 >= var_1_57) ? (var_1_82 == ((signed short int) (abs (var_1_36)))) : (var_1_82 == ((signed short int) ((min (var_1_61 , var_1_77)) - var_1_62))))) && (((var_1_14 && (var_1_17 && var_1_18)) && var_1_116) ? ((var_1_69 > (var_1_21 * var_1_25)) ? (var_1_83 == ((signed char) (abs (min (var_1_62 , (max (var_1_42 , var_1_76))))))) : (var_1_83 == ((signed char) (max (var_1_73 , var_1_61))))) : (var_1_116 ? (var_1_83 == ((signed char) (max (var_1_75 , (abs (var_1_61)))))) : (var_1_83 == ((signed char) (min ((var_1_76 + var_1_54) , 100))))))) && (var_1_40 ? (var_1_84 == ((signed char) (32 + (max (var_1_61 , (var_1_76 + var_1_62)))))) : 1)) && (((- var_1_81) > var_1_101) ? (var_1_85 == ((double) var_1_52)) : 1)) && ((var_1_96 <= (- var_1_8)) ? (var_1_86 == ((unsigned short int) ((var_1_39 - var_1_13) - (var_1_115 + var_1_90)))) : 1)) && (var_1_116 ? (var_1_87 == ((unsigned char) (! (var_1_88 || var_1_89)))) : (var_1_87 == ((unsigned char) ((var_1_30 && var_1_18) && var_1_16))))) && (var_1_16 ? (var_1_90 == ((unsigned char) ((var_1_76 + var_1_75) + var_1_10))) : (var_1_90 == ((unsigned char) var_1_11)))) && ((-4 == (~ var_1_78)) ? (var_1_91 == ((double) var_1_92)) : 1)) && ((var_1_85 == (- var_1_33)) ? (var_1_93 == ((unsigned long int) (var_1_103 + (var_1_94 - var_1_81)))) : (var_1_93 == ((unsigned long int) ((var_1_73 + var_1_112) + ((max (var_1_94 , var_1_95)) - var_1_56)))))) && (var_1_16 ? (var_1_40 ? (var_1_18 ? (var_1_96 == ((signed long int) (min ((max (var_1_10 , var_1_8)) , var_1_13)))) : (var_1_88 ? (var_1_96 == ((signed long int) var_1_62)) : (var_1_96 == ((signed long int) ((abs (var_1_101)) + (var_1_75 + var_1_43)))))) : (var_1_96 == ((signed long int) (min (var_1_76 , var_1_39))))) : (var_1_30 ? ((var_1_43 >= (var_1_75 - var_1_10)) ? (var_1_96 == ((signed long int) (var_1_59 + (min (var_1_120 , var_1_64))))) : (var_1_96 == ((signed long int) ((var_1_112 - var_1_82) + ((var_1_60 - var_1_9) + (var_1_101 + var_1_13)))))) : 1))) && ((var_1_112 > ((var_1_39 - var_1_9) / var_1_12)) ? (var_1_97 == ((signed short int) var_1_81)) : (var_1_97 == ((signed short int) var_1_11)))) && ((var_1_1 >= var_1_103) ? (var_1_98 == ((signed short int) (abs (var_1_61)))) : (var_1_98 == ((signed short int) (((var_1_99 + var_1_100) - var_1_10) - var_1_5))))) && (((var_1_13 / (var_1_102 + var_1_11)) > var_1_54) ? (var_1_101 == ((signed long int) (50 - var_1_61))) : 1)) && ((last_1_var_1_40 && var_1_30) ? (((last_1_var_1_108 == last_1_var_1_47) && last_1_var_1_116) ? (var_1_103 == ((unsigned short int) (var_1_39 - var_1_9))) : ((((19746 - 64) << 4) >= last_1_var_1_103) ? ((last_1_var_1_116 && var_1_18) ? (var_1_103 == ((unsigned short int) (var_1_39 - (var_1_10 + var_1_12)))) : (var_1_103 == ((unsigned short int) (max ((var_1_81 + (var_1_105 - var_1_13)) , ((max (46288 , var_1_39)) - var_1_12)))))) : (((var_1_24 * var_1_33) >= var_1_28) ? (var_1_103 == ((unsigned short int) (abs (var_1_39 - (23813 - var_1_6))))) : (var_1_103 == ((unsigned short int) (var_1_61 + var_1_59)))))) : ((var_1_49 != var_1_29) ? (var_1_103 == ((unsigned short int) var_1_62)) : (var_1_103 == ((unsigned short int) var_1_6))))) && (var_1_106 == ((unsigned char) var_1_54))) && (var_1_18 ? (var_1_107 == ((double) var_1_26)) : (var_1_107 == ((double) var_1_33)))) && (var_1_108 == ((unsigned short int) var_1_56))) && (var_1_88 ? (var_1_109 == ((signed short int) var_1_110)) : 1)) && (var_1_116 ? (var_1_111 == ((float) 127.375f)) : 1)) && (var_1_88 ? (var_1_112 == ((unsigned long int) var_1_105)) : 1)) && (var_1_113 == ((unsigned short int) var_1_61))) && (var_1_14 ? (var_1_114 == ((signed char) var_1_61)) : (var_1_114 == ((signed char) var_1_73)))) && (var_1_30 ? (var_1_115 == ((signed long int) var_1_105)) : (var_1_115 == ((signed long int) var_1_108)))) && (var_1_116 == ((unsigned char) var_1_88))) && (var_1_117 == ((signed char) var_1_73))) && (var_1_87 ? (var_1_118 == ((float) var_1_24)) : (var_1_118 == ((float) var_1_34)))) && (var_1_89 ? (var_1_119 == ((double) var_1_23)) : 1)) && ((((-128 + var_1_112) + (max (-5 , -50))) > (var_1_12 - 50)) ? ((var_1_59 < (64 | var_1_12)) ? (var_1_120 == ((unsigned short int) var_1_81)) : (var_1_120 == ((unsigned short int) var_1_106))) : 1)
;
}
int main(void) {
	isInitial = 1;
