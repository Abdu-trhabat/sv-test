...
void step(void) {
	...
	WrapperStruct00.var_1_11 = ((min (WrapperStruct00.var_1_12 , (max (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_14)))) - 32);
	...
	if ((- WrapperStruct00.var_1_2) >= 16.75) {
		if (stepLocal_0 >= WrapperStruct00.var_1_5) {
			if ((min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_11)) > stepLocal_1) {
