...
void step(void) {
 ...
 double_Array_0[0][0] = ((double_Array_0[0][1] + ((((double_Array_0[1][1]) > (double_Array_0[1][0])) ? (double_Array_0[1][1]) : (double_Array_0[1][0])))) - float_Array_0[0][1]);
