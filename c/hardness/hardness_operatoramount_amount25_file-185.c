...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch185Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch185Amount25
	signed short int stepLocal_2 = var_1_4;
	if (stepLocal_2 == (min (32 , var_1_5))) {
		if (! var_1_2) {
	...
	// From: Req3Batch185Amount25
	if (var_1_1 != (max (var_1_4 , var_1_5))) {
...
int property(void) {
	return (((var_1_2 && var_1_3) ? (((var_1_4 - var_1_5) <= last_1_var_1_10) ? (var_1_1 == ((signed long int) var_1_5)) : 1) : 1) && ((var_1_4 == (min (32 , var_1_5))) ? ((! var_1_2) ? (var_1_7 == ((double) (var_1_8 - var_1_9))) : (var_1_7 == ((double) var_1_8))) : (var_1_7 == ((double) var_1_8)))) && ((var_1_1 != (max (var_1_4 , var_1_5))) ? (var_1_10 == ((signed long int) (var_1_5 - var_1_11))) : ((var_1_7 != var_1_8) ? (var_1_2 ? (var_1_10 == ((signed long int) var_1_11)) : (var_1_10 == ((signed long int) var_1_4))) : (var_1_10 == ((signed long int) var_1_4))))
;
}
int main(void) {
	isInitial = 1;
