...
void step(void) {
	...
	// From: Req7Batch134Filler_PE_CO
	/* 1010L, 270L, 794L, 800L) */ var_1_20 = (
		var_1_7
	);


	// From: Req8Batch134Filler_PE_CO
	/* 1016L, 280L, 818L, 824L) */ var_1_21 = (
		var_1_7
	);


	// From: Req4Batch134Filler_PE_CO
