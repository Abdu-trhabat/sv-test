...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch162Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch162Filler_PE_CI
	/* 1152L, 308L, 904L, 910L) */ var_1_20 = (
		var_1_21
	);


	// From: Req7Batch162Filler_PE_CI
	/* 1158L, 318L, 928L, 934L) */ var_1_22 = (
		1
	);


	// From: Req2Batch162Filler_PE_CI
