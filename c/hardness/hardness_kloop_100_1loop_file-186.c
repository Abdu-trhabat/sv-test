...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch186100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch186100_1loop
	var_1_38 = var_1_8;


	// From: Req4Batch186100_1loop
