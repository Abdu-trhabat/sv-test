...
void step(void) {
 ...
 if (stepLocal_0 || (*(var_1_14_Pointer))) {
  if (! (*(var_1_14_Pointer))) {
   (*(var_1_12_Pointer)) = ((((((((*(var_1_4_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_5_Pointer))))) < 0 ) ? -(((((*(var_1_4_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_5_Pointer))))) : (((((*(var_1_4_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_5_Pointer)))))));
  } else {
 ...
 if (-4 > (*(var_1_12_Pointer))) {
  if ((~ (*(var_1_12_Pointer))) <= (*(var_1_12_Pointer))) {
   (*(var_1_9_Pointer)) = (((((*(var_1_10_Pointer)) + (*(var_1_11_Pointer))) < 0 ) ? -((*(var_1_10_Pointer)) + (*(var_1_11_Pointer))) : ((*(var_1_10_Pointer)) + (*(var_1_11_Pointer)))));
  }
 } else {
