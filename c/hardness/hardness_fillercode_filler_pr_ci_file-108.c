...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch108Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 450L, 272L) */ if (var_1_15) {
		...
		/* 461L, 270L) */ if (/* 462L, 230L, 231L) */ ((var_1_9) > (/* 464L, 229L, 233L) */ (min (/* 464L, 229L, 233L) */ (/* 465L, 225L, 234L) */ ((16) % (50))) , (/* 468L, 228L, 237L) */ (max (/* 468L, 228L, 237L) */ (var_1_32) , (var_1_27))))))))) {
			/* 471L, 258L) */ var_1_41 = (
				/* 474L, 257L) */ ((
					/* 475L, 255L) */ ((
						/* 476L, 253L) */ ((
	...
	// From: CodeObject3
	/* 333L, 174L) */ if (/* 334L, 130L, 131L) */ ((var_1_5) <= (/* 336L, 129L, 133L) */ ((/* 337L, 127L, 134L) */ (abs (var_1_33))) - (var_1_36))))) {
	...
	// From: CodeObject7
	/* 488L, 298L) */ if (/* 489L, 281L, 282L) */ ((-32) >= (/* 491L, 280L, 284L) */ ((/* 492L, 278L, 285L) */ (abs (var_1_16))) - (var_1_9))))) {
		/* 495L, 297L) */ var_1_46 = (
			var_1_21
		);
	}
