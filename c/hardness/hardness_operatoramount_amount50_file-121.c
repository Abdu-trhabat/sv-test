...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch121Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch121Amount50
	var_1_24 = (min (4.4f , var_1_25));


	// From: Req8Batch121Amount50
	...
	// From: Req3Batch121Amount50
	if (var_1_17 < var_1_10) {
		var_1_16 = var_1_9;
	}


	// From: Req1Batch121Amount50
