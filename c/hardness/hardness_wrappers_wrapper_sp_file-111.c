...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_2_Pointer)) < (*(WrapperStruct00_var_1_3_Pointer))) {
		(*(WrapperStruct00_var_1_1_Pointer)) = (min (1.25 , (*(WrapperStruct00_var_1_4_Pointer))));
	} else {
		if ((*(WrapperStruct00_var_1_5_Pointer)) || stepLocal_0) {
			(*(WrapperStruct00_var_1_1_Pointer)) = ((abs ((*(WrapperStruct00_var_1_7_Pointer)))) + (*(WrapperStruct00_var_1_8_Pointer)));
		}
	}


	// From: Req4Batch111Wrapper_SP
	...
	// From: Req2Batch111Wrapper_SP
	if ((*(WrapperStruct00_var_1_7_Pointer)) != (max (((*(WrapperStruct00_var_1_8_Pointer)) * (*(WrapperStruct00_var_1_15_Pointer))) , (*(WrapperStruct00_var_1_15_Pointer))))) {
