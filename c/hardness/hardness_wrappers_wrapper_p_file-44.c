...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch44Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	signed long int stepLocal_0 = (min ((*(var_1_4_Pointer)) , (*(var_1_3_Pointer)))) / (*(var_1_7_Pointer));
	if (stepLocal_1 > ((*(var_1_5_Pointer)) - (*(var_1_6_Pointer)))) {
	...
	if (((*(var_1_12_Pointer)) - (abs ((*(var_1_13_Pointer))))) >= (*(var_1_14_Pointer))) {
	...
	signed char stepLocal_3 = (*(var_1_2_Pointer));
	signed long int stepLocal_2 = (*(var_1_2_Pointer)) * ((*(var_1_4_Pointer)) * (*(var_1_6_Pointer)));
	if ((*(var_1_11_Pointer))) {
...
int property(void) {
	return (((((*(var_1_4_Pointer)) > ((*(var_1_5_Pointer)) - (*(var_1_6_Pointer)))) ? ((((min ((*(var_1_4_Pointer)) , (*(var_1_3_Pointer)))) / (*(var_1_7_Pointer))) <= (*(var_1_6_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed long int) (*(var_1_7_Pointer)))) : 1) : ((*(var_1_1_Pointer)) == ((signed long int) (*(var_1_3_Pointer))))) && ((*(var_1_11_Pointer)) ? (((*(var_1_1_Pointer)) > (*(var_1_2_Pointer))) ? ((*(var_1_8_Pointer)) == ((unsigned char) (! (*(var_1_10_Pointer))))) : ((((*(var_1_1_Pointer)) % (*(var_1_7_Pointer))) < ((*(var_1_2_Pointer)) * ((*(var_1_4_Pointer)) * (*(var_1_6_Pointer))))) ? ((*(var_1_8_Pointer)) == ((unsigned char) (*(var_1_10_Pointer)))) : 1)) : 1)) && ((((*(var_1_12_Pointer)) - (abs ((*(var_1_13_Pointer))))) >= (*(var_1_14_Pointer))) ? ((*(var_1_11_Pointer)) == ((unsigned char) ((((*(var_1_6_Pointer)) < (*(var_1_1_Pointer))) && (*(var_1_15_Pointer))) || ((*(var_1_16_Pointer)) || (*(var_1_17_Pointer)))))) : 1)) && ((*(var_1_18_Pointer)) == ((float) (*(var_1_19_Pointer))))
;
}
int main(void) {
	isInitial = 1;
