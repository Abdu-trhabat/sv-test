...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch176has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch176has_floats
	var_1_1 = ((10000000 + 5) - (var_1_2 - var_1_3));


	// From: Req2Batch176has_floats
	if (var_1_2 > 32) {
		var_1_4 = var_1_5;
	} else {
		var_1_4 = (min ((var_1_6 - var_1_7) , (min (var_1_5 , var_1_8))));
	}


	// From: Req3Batch176has_floats
	if (var_1_10 || var_1_11) {
		var_1_9 = (max ((min ((min (64 , var_1_12)) , (var_1_13 + var_1_14))) , var_1_15));
	} else {
		if ((- var_1_5) == var_1_8) {
			if (var_1_8 > var_1_4) {
				var_1_9 = var_1_15;
...
int property(void) {
	return (((var_1_1 == ((signed long int) ((10000000 + 5) - (var_1_2 - var_1_3)))) && ((var_1_2 > 32) ? (var_1_4 == ((double) var_1_5)) : (var_1_4 == ((double) (min ((var_1_6 - var_1_7) , (min (var_1_5 , var_1_8)))))))) && ((var_1_10 || var_1_11) ? (var_1_9 == ((unsigned char) (max ((min ((min (64 , var_1_12)) , (var_1_13 + var_1_14))) , var_1_15)))) : (((- var_1_5) == var_1_8) ? ((var_1_8 > var_1_4) ? (var_1_9 == ((unsigned char) var_1_15)) : 1) : (var_1_9 == ((unsigned char) var_1_14))))) && (((var_1_17 - (var_1_18 + var_1_19)) > (-16 * var_1_15)) ? (var_1_16 == ((unsigned char) var_1_20)) : 1)
;
}
int main(void) {
	isInitial = 1;
