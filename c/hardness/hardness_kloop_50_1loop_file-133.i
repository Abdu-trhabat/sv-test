...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13350_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_11 = ((((var_1_10) < (var_1_12)) ? (var_1_10) : (var_1_12)));
 ...
 if (var_1_12 != stepLocal_5) {
  var_1_16 = ((var_1_9 < var_1_8) && (! var_1_15));
 } else {
  if (! var_1_22) {
   var_1_16 = 0;
  } else {
...
int property(void) {
 return (((((((((! var_1_2) || (var_1_3 && var_1_4)) ? ((var_1_5 == var_1_6) ? (var_1_1 == ((signed short int) var_1_7)) : (var_1_1 == ((signed short int) -128))) : (var_1_1 == ((signed short int) var_1_7))) && ((var_1_7 > (var_1_9 - var_1_10)) ? (var_1_8 == ((signed long int) ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))))) : 1)) && (var_1_11 == ((unsigned long int) ((((var_1_10) < (var_1_12)) ? (var_1_10) : (var_1_12)))))) && ((var_1_11 == -50) ? ((var_1_11 > 10u) ? (var_1_13 == ((unsigned char) (var_1_22 && var_1_14))) : (var_1_13 == ((unsigned char) var_1_15))) : (var_1_13 == ((unsigned char) var_1_15)))) && ((var_1_12 != (var_1_11 + (var_1_11 * 10u))) ? (var_1_16 == ((unsigned char) ((var_1_9 < var_1_8) && (! var_1_15)))) : ((! var_1_22) ? (var_1_16 == ((unsigned char) 0)) : (var_1_16 == ((unsigned char) var_1_15))))) && ((((((var_1_18) > (var_1_19)) ? (var_1_18) : (var_1_19))) != (var_1_20 * 9999.5)) ? (var_1_17 == ((signed short int) ((var_1_21 + 2) + -64))) : 1)) && (((var_1_7 / ((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23)))) > (25 - var_1_10)) ? (var_1_22 == ((unsigned char) var_1_15)) : 1)) && (var_1_24 == ((signed char) var_1_25))
;
}
int main(void) {
 isInitial = 1;
