...
void step(void) {
 ...
 if (var_1_7 < ((- -100.0) + (var_1_1 / var_1_15))) {
  var_1_14 = ((((((var_1_9 + var_1_8) + 5.0)) < (var_1_7)) ? (((var_1_9 + var_1_8) + 5.0)) : (var_1_7)));
 }
...
int property(void) {
 return (((((var_1_2 || var_1_3) && (8.0 == last_1_var_1_14)) ? (var_1_1 == ((double) (var_1_7 + (var_1_8 + var_1_9)))) : (var_1_1 == ((double) var_1_9))) && (((-32 % var_1_11) <= var_1_12) ? (var_1_10 == ((signed char) var_1_13)) : ((var_1_7 <= var_1_14) ? (var_1_10 == ((signed char) var_1_13)) : 1))) && ((var_1_7 < ((- -100.0) + (var_1_1 / var_1_15))) ? (var_1_14 == ((double) ((((((var_1_9 + var_1_8) + 5.0)) < (var_1_7)) ? (((var_1_9 + var_1_8) + 5.0)) : (var_1_7))))) : 1)) && (var_1_2 ? (((var_1_12 * var_1_10) < var_1_11) ? ((var_1_1 > var_1_9) ? (var_1_16 == ((unsigned short int) var_1_17)) : (var_1_16 == ((unsigned short int) 0))) : 1) : (var_1_16 == ((unsigned short int) var_1_17)))
;
}
int main(void) {
 isInitial = 1;
