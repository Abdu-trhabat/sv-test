...
unsigned char functionized1(signed char functionized1_localFunctionVar0, signed char functionized1_localFunctionVar1) {
	return (functionized1_localFunctionVar1 == (min (var_1_4 , (var_1_13 / functionized1_localFunctionVar0))));
}
...
void functionized4(float functionized4_localFunctionVar0) {
	if (var_1_5) {
		...
		var_1_25 = ((abs (functionized4_localFunctionVar0)) - var_1_27);
	}
}
...
void step(void) {
	// From: Req1Batch44functionizing
	if (var_1_2 == ((var_1_3 + var_1_4) ^ (var_1_6 + var_1_7))) {
		var_1_1 = var_1_2;
	}


	// From: Req2Batch44functionizing
	if ((abs (var_1_9)) < (min ((var_1_10 - var_1_11) , functionized0()))) {
		if (var_1_9 >= var_1_12) {
			var_1_8 = var_1_13;
		} else {
			var_1_8 = var_1_2;
	...
	// From: Req4Batch44functionizing
	functionized2(var_1_20, var_1_7);


	// From: Req5Batch44functionizing
	functionized3(var_1_10, var_1_18, var_1_24, var_1_2, var_1_13, var_1_9, var_1_15);


	// From: Req6Batch44functionizing
	functionized4(var_1_26);


	// From: Req7Batch44functionizing
	var_1_28 = var_1_24;


	// From: Req8Batch44functionizing
	var_1_29 = var_1_30;


	// From: Req9Batch44functionizing
	var_1_31 = var_1_20;
}
