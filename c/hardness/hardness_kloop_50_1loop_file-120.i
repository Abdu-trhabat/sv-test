...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12050_1loop.c", 13, "reach_error"); }
...
void step(void) {
 var_1_11 = ((((last_1_var_1_18) < (((((last_1_var_1_20) > (var_1_12)) ? (last_1_var_1_20) : (var_1_12))))) ? (last_1_var_1_18) : (((((last_1_var_1_20) > (var_1_12)) ? (last_1_var_1_20) : (var_1_12))))));
...
int property(void) {
 return ((((((((var_1_20 <= var_1_16) ? ((! (var_1_13 && var_1_22)) ? (var_1_1 == ((float) (var_1_6 + (((((var_1_7 - var_1_8)) > (var_1_9)) ? ((var_1_7 - var_1_8)) : (var_1_9)))))) : (var_1_1 == ((float) var_1_7))) : (var_1_1 == ((float) var_1_9))) && ((var_1_16 != var_1_20) ? (var_1_22 ? (((var_1_7 + var_1_1) >= (var_1_8 / 0.5f)) ? (var_1_10 == ((double) var_1_6)) : (var_1_10 == ((double) var_1_8))) : 1) : 1)) && (var_1_11 == ((signed short int) ((((last_1_var_1_18) < (((((last_1_var_1_20) > (var_1_12)) ? (last_1_var_1_20) : (var_1_12))))) ? (last_1_var_1_18) : (((((last_1_var_1_20) > (var_1_12)) ? (last_1_var_1_20) : (var_1_12))))))))) && (var_1_22 ? (var_1_13 == ((unsigned char) (var_1_14 && (! var_1_15)))) : 1)) && ((! var_1_22) ? (var_1_16 == ((unsigned char) var_1_17)) : 1)) && (((- (var_1_16 % var_1_19)) >= var_1_12) ? ((((var_1_12 * var_1_20) ^ (8 & var_1_11)) <= (128 / -100)) ? (var_1_18 == ((signed long int) ((var_1_19 - var_1_17) + var_1_16))) : 1) : (var_1_18 == ((signed long int) var_1_17)))) && ((var_1_14 || var_1_15) ? (var_1_20 == ((unsigned short int) (var_1_21 - ((((var_1_19) < (var_1_17)) ? (var_1_19) : (var_1_17)))))) : 1)) && (var_1_22 == ((unsigned char) var_1_14))
;
}
int main(void) {
 isInitial = 1;
