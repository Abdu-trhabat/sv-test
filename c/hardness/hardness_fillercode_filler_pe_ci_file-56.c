...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch56Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 243L, 26L) */ if (/* 244L, 6L, 7L) */ ((/* 245L, 4L, 8L) */ ((var_1_8) ^ (var_1_10))) >= (var_1_10))) {
		/* 249L, 25L) */ var_1_24 = (
			/* 252L, 24L) */ (max (
				/* 252L, 24L) */ (
					/* 253L, 22L) */ (abs (
	...
	/* 287L, 130L) */ if (/* 288L, 91L, 92L) */ ((var_1_28) < (/* 290L, 90L, 94L) */ ((var_1_8) - (/* 292L, 89L, 96L) */ (abs (var_1_30))))))) {
		/* 294L, 128L) */ if (/* 295L, 108L, 109L) */ ((/* 296L, 106L, 110L) */ ((var_1_20) - (var_1_14))) > (var_1_6))) {
			/* 300L, 123L) */ var_1_35 = (
				/* 303L, 122L) */ (abs (
					var_1_33
				))
	...
	// From: CodeObject5
	/* 309L, 175L) */ if (/* 310L, 139L, 140L) */ (! (/* 311L, 138L, 141L) */ ((var_1_17) > (/* 313L, 137L, 143L) */ ((var_1_33) + (var_1_32))))))) {
		/* 316L, 168L) */ if (/* 317L, 154L, 155L) */ ((var_1_2) && (var_1_3))) {
			/* 320L, 167L) */ var_1_39 = (
				/* 323L, 166L) */ (abs (
					/* 324L, 165L) */ (min (
						/* 324L, 165L) */ (
	...
	// From: CodeObject6
	/* 332L, 203L) */ if (/* 333L, 191L, 192L) */ ((var_1_6) >= (var_1_33))) {
		/* 336L, 202L) */ var_1_43 = (
			/* 339L, 201L) */ (abs (
				var_1_44
			))
