...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch127Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch127Amount50
	var_1_13 = (var_1_14 - last_1_var_1_18);


	// From: Req2Batch127Amount50
	...
	// From: Req3Batch127Amount50
	if (var_1_10) {
		var_1_11 = (var_1_6 && (var_1_8 && var_1_9));
	}


	// From: Req1Batch127Amount50
	if (! last_1_var_1_12) {
