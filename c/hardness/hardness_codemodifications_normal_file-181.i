...
void step(void) {
 ...
 var_1_6 = var_1_7;
 if ((var_1_9 - ((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11)))) >= var_1_5) {
  var_1_8 = ((((var_1_12) > (var_1_13)) ? (var_1_12) : (var_1_13)));
 }
 if (var_1_2) {
  var_1_14 = ((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11)));
 }
 if ((var_1_14 >> 10) < (var_1_1 / ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))) {
  if (((var_1_9 / var_1_16) % var_1_17) <= (var_1_4 - var_1_14)) {
