...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch37functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
void functionized0(signed long int, signed long int, unsigned short int);
...
unsigned char functionized6(double, double, double, double);
signed long int functionized7(signed char);
...
void functionized0(signed long int functionized0_localFunctionVar0, signed long int functionized0_localFunctionVar1, unsigned short int functionized0_localFunctionVar2) {
	if ((var_1_2 - functionized0_localFunctionVar2) > var_1_4) {
		var_1_1 = (min ((min ((functionized0_localFunctionVar1 + functionized0_localFunctionVar2) , var_1_2)) , functionized0_localFunctionVar0));
	} else {
		var_1_1 = 0;
	}
}
...
signed long int functionized2(unsigned short int functionized2_localFunctionVar0) {
	return (min (2 , functionized2_localFunctionVar0));
}
unsigned char functionized3(unsigned short int functionized3_localFunctionVar0) {
	return (var_1_1 >= functionized3_localFunctionVar0);
}
void functionized4(signed char functionized4_localFunctionVar0) {
	if (var_1_10 >= var_1_7) {
		if (var_1_9 < var_1_10) {
			var_1_11 = functionized4_localFunctionVar0;
		}
	}
}
unsigned char functionized5(float functionized5_localFunctionVar0) {
	return (var_1_10 <= functionized5_localFunctionVar0);
}
unsigned char functionized6(double functionized6_localFunctionVar0, double functionized6_localFunctionVar1, double functionized6_localFunctionVar2, double functionized6_localFunctionVar3) {
	return (functionized6_localFunctionVar2 > ((var_1_20 - functionized6_localFunctionVar3) - (functionized6_localFunctionVar1 - functionized6_localFunctionVar0)));
}
signed long int functionized7(signed char functionized7_localFunctionVar0) {
	return (max (functionized7_localFunctionVar0 , var_1_22));
}
...
void step(void) {
	// From: Req1Batch37functionizing
	functionized0(var_1_6, var_1_5, var_1_3);


	// From: Req2Batch37functionizing
	if (functionized1(var_1_5) < (var_1_1 / functionized2(var_1_2))) {
		if (functionized3(var_1_3)) {
			var_1_7 = 0.75f;
		} else {
			var_1_7 = var_1_9;
		}
	...
	// From: Req3Batch37functionizing
	if ((var_1_6 >= var_1_4) || (var_1_9 > var_1_7)) {
		var_1_10 = var_1_9;
	}


	// From: Req4Batch37functionizing
	functionized4(var_1_12);


	// From: Req5Batch37functionizing
	if (var_1_14) {
		if (functionized5(var_1_9)) {
			var_1_13 = var_1_9;
		} else {
	...
	// From: Req6Batch37functionizing
	var_1_17 = (var_1_18 - var_1_3);


	// From: Req7Batch37functionizing
	if (functionized6(var_1_16, var_1_21, var_1_13, var_1_15)) {
		var_1_19 = functionized7(var_1_12);
	} else {
		var_1_19 = var_1_12;
	}
}
