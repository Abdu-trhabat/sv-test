...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17650_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch17650_while
	signed char stepLocal_2 = var_1_8;
	if (last_1_var_1_26 > stepLocal_2) {
		var_1_16 = (var_1_7 + var_1_6);
	}


	// From: Req4Batch17650_while
	...
	// From: Req2Batch17650_while
	unsigned char stepLocal_1 = var_1_17;
	if ((var_1_16 <= var_1_3) && stepLocal_1) {
	...
	// From: Req7Batch17650_while
	var_1_27 = var_1_6;


	// From: Req1Batch17650_while
	unsigned long int stepLocal_0 = var_1_16;
	if (((var_1_27 * 4) % (min (var_1_3 , var_1_4))) <= stepLocal_0) {
		var_1_1 = ((max ((var_1_6 - var_1_7) , var_1_8)) - var_1_9);
	}


	// From: Req5Batch17650_while
	if (var_1_17) {
