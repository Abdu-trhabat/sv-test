...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch139Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned char stepLocal_0 = var_1_15;
   ...
   var_1_25
                  ...
                  if ( (( (( ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))) / (-5))) < (var_1_18))) {
                   if ( ((var_1_25) >= ( (((((var_1_9)) < (( (((((var_1_9)) > ((5.75f))) ? ((var_1_9)) : ((5.75f))))))) ? ((var_1_9)) : (( (((((var_1_9)) > ((5.75f))) ? ((var_1_9)) : ((5.75f))))))))))) {
                    if ( (( (~ ( ((var_1_18) / (var_1_30))))) >= ( (~ (var_1_27))))) {
                     var_1_26 = (
