...
void step(void) {
	...
	// From: CodeObject1
	/* 244L, 45L) */ if (/* 245L, 4L, 5L) */ ((var_1_21) >= (var_1_20))) {
		/* 248L, 37L) */ if (/* 249L, 15L, 16L) */ ((var_1_21) > (/* 251L, 14L, 18L) */ ((var_1_20) | (var_1_18))))) {
			/* 254L, 32L) */ var_1_27 = (
				/* 257L, 31L) */ (abs (
					/* 258L, 30L) */ ((
						var_1_31
	...
	/* 272L, 110L) */ if (/* 273L, 51L, 52L) */ ((var_1_32) != (var_1_20))) {
		/* 276L, 104L) */ if (/* 277L, 64L, 65L) */ ((/* 278L, 62L, 66L) */ ((var_1_34) - (/* 280L, 61L, 68L) */ (min (/* 280L, 61L, 68L) */ (var_1_21) , (var_1_31)))))) < (var_1_20))) {
			/* 284L, 98L) */ if (/* 285L, 83L, 84L) */ ((/* 286L, 81L, 85L) */ (max (/* 286L, 81L, 85L) */ (var_1_18) , (var_1_32)))) >= (var_1_21))) {
				/* 290L, 97L) */ var_1_33 = (
					var_1_20
				);
			}
	...
	// From: CodeObject6
	/* 331L, 199L) */ if (/* 332L, 174L, 175L) */ ((var_1_21) >= (/* 334L, 173L, 177L) */ ((var_1_18) / (var_1_41))))) {
		/* 337L, 188L) */ var_1_40 = (
			var_1_18
		);
	} else {
	...
	// From: CodeObject7
	/* 348L, 218L) */ if (/* 349L, 205L, 206L) */ ((var_1_11) > (var_1_18))) {
		/* 352L, 217L) */ var_1_42 = (
			/* 355L, 216L) */ (abs (
				/* 356L, 215L) */ (abs (
					var_1_39
