...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch61Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((*(WrapperStruct00_var_1_23_Pointer)) < (((((*(WrapperStruct00_var_1_20_Pointer))) > ((*(WrapperStruct00_var_1_23_Pointer)))) ? ((*(WrapperStruct00_var_1_20_Pointer))) : ((*(WrapperStruct00_var_1_23_Pointer)))))) {
