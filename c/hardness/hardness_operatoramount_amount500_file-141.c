...
void step(void) {
	...
	if (var_1_14 < (min (var_1_24 , var_1_68))) {
		if (last_1_var_1_58) {
			var_1_75 = var_1_76;
		}
	} else {
		if (var_1_44) {
			if ((var_1_14 / var_1_24) >= (last_1_var_1_51 + var_1_15)) {
				if (stepLocal_24 == last_1_var_1_94) {
					var_1_75 = (max (var_1_77 , ((max (var_1_4 , last_1_var_1_48)) + last_1_var_1_94)));
				} else {
					if (var_1_4 > stepLocal_25) {
						var_1_75 = (max (var_1_30 , var_1_20));
					} else {
						if (stepLocal_26 && (last_1_var_1_95 > last_1_var_1_75)) {
							if (stepLocal_27 <= ((~ last_1_var_1_53) / var_1_4)) {
								var_1_75 = (max (var_1_74 , var_1_77));
							} else {
								var_1_75 = (max (var_1_31 , (max (var_1_27 , var_1_37))));
							}
						} else {
							var_1_75 = (min (100000000u , (min (var_1_50 , (max (var_1_30 , var_1_17))))));
						}
					}
				}
			} else {
				var_1_75 = (max (128u , var_1_25));
			}
		} else {
			if (last_1_var_1_53 > stepLocal_23) {
				var_1_75 = (((min (var_1_79 , var_1_80)) + (var_1_81 + var_1_82)) - var_1_29);
			}
		}
	}


	// From: Req3Batch141Amount500
	if (last_1_var_1_21) {
		if (var_1_8) {
	...
	// From: Req10Batch141Amount500
	if (-4 > (var_1_25 / var_1_17)) {
		var_1_41 = ((var_1_34 - var_1_35) - (max (var_1_33 , var_1_42)));
	} else {
		if (var_1_9) {
			var_1_41 = var_1_34;
		} else {
	...
	// From: Req38Batch141Amount500
	if (var_1_91) {
		var_1_99 = var_1_88;
	}


	// From: Req39Batch141Amount500
	if (var_1_60) {
		var_1_100 = var_1_26;
	} else {
		var_1_100 = var_1_29;
	...
	// From: Req40Batch141Amount500
	var_1_101 = var_1_4;


	// From: Req41Batch141Amount500
	var_1_102 = var_1_29;


	// From: Req43Batch141Amount500
	signed long int stepLocal_33 = var_1_100;
	signed long int stepLocal_32 = - (var_1_19 >> var_1_105);
	if (stepLocal_32 < var_1_73) {
		if (stepLocal_33 >= (min (var_1_75 , var_1_29))) {
			var_1_104 = var_1_67;
		} else {
			var_1_104 = var_1_68;
		}
	...
	// From: Req18Batch141Amount500
	signed long int stepLocal_17 = 32;
	unsigned char stepLocal_16 = var_1_38 <= (max (var_1_30 , var_1_75));
	if ((-2 > (min (var_1_27 , var_1_20))) || stepLocal_16) {
		if ((abs (var_1_99)) < stepLocal_17) {
			var_1_58 = var_1_8;
		} else {
	...
	// From: Req6Batch141Amount500
	unsigned char stepLocal_4 = var_1_29;
	if (var_1_17 >= stepLocal_4) {
		if (! var_1_22) {
			var_1_32 = (max (var_1_14 , ((var_1_33 - 7.4) - (var_1_34 - var_1_35))));
		}
	} else {
	...
	// From: Req13Batch141Amount500
	if (var_1_4 < var_1_37) {
		if (((var_1_29 - var_1_53) / var_1_20) < var_1_25) {
			var_1_47 = (max (var_1_17 , var_1_18));
		}
	} else {
		var_1_47 = (var_1_27 + (min (var_1_29 , var_1_73)));
	}


	// From: Req33Batch141Amount500
	if (var_1_91) {
		var_1_94 = var_1_57;
	} else {
		var_1_94 = var_1_23;
	...
	// From: Req36Batch141Amount500
	var_1_97 = var_1_98;


	// From: Req42Batch141Amount500
	if (var_1_21) {
		var_1_103 = var_1_62;
	} else {
		var_1_103 = var_1_57;
	...
	// From: Req32Batch141Amount500
	if (var_1_1) {
		var_1_93 = var_1_60;
	}


	// From: Req26Batch141Amount500
	if (var_1_94 <= var_1_16) {
		var_1_83 = (((31.5f + var_1_69) - var_1_35) + 127.75f);
	} else {
		var_1_83 = (((max (var_1_34 , var_1_68)) - var_1_52) - (var_1_67 + var_1_35));
	}


	// From: Req34Batch141Amount500
	if (var_1_93) {
		var_1_95 = var_1_28;
	}


	// From: Req21Batch141Amount500
	...
	// From: Req27Batch141Amount500
	unsigned char stepLocal_28 = var_1_59;
	if (var_1_63 || stepLocal_28) {
		var_1_85 = ((max (var_1_33 , (abs (var_1_67)))) - var_1_42);
	}


	// From: Req9Batch141Amount500
	signed long int stepLocal_8 = (var_1_25 / var_1_18) ^ -50;
	if (stepLocal_8 <= (max (1 , var_1_28))) {
		var_1_40 = (max (var_1_95 , var_1_103));
	}


	// From: Req28Batch141Amount500
	if (((var_1_31 + var_1_88) << var_1_53) < (var_1_75 + var_1_29)) {
		if (var_1_41 >= var_1_32) {
			var_1_87 = (min (var_1_14 , ((var_1_35 + var_1_69) - var_1_52)));
		} else {
			var_1_87 = (max ((var_1_70 + (var_1_69 + var_1_89)) , var_1_33));
		}
	} else {
		if (var_1_41 != (var_1_85 * (abs (var_1_90)))) {
	...
	// From: Req2Batch141Amount500
	if ((min (var_1_85 , var_1_41)) >= var_1_61) {
		var_1_10 = var_1_14;
	} else {
		if (var_1_43) {
			var_1_10 = var_1_14;
	...
	// From: Req14Batch141Amount500
	unsigned long int stepLocal_12 = min (var_1_4 , (var_1_73 / -8));
	...
	if (stepLocal_12 >= var_1_38) {
		...
		if (stepLocal_11 >= var_1_30) {
			...
			if (var_1_10 < var_1_32) {
				var_1_48 = (min ((var_1_50 - (max (var_1_28 , var_1_27))) , (min (var_1_20 , (64260 - var_1_25)))));
			} else {
				var_1_48 = (var_1_4 + (max ((min (var_1_26 , var_1_27)) , var_1_31)));
			}
		}
	}


	// From: Req7Batch141Amount500
	...
	// From: Req8Batch141Amount500
	signed long int stepLocal_7 = var_1_40 * var_1_26;
	if (stepLocal_7 < var_1_46) {
		if (((min (var_1_34 , 1.4f)) - 255.75f) >= (min (var_1_33 , var_1_15))) {
	...
	if (var_1_39) {
		...
		if (stepLocal_15 >= (~ var_1_47)) {
			if (var_1_34 < var_1_41) {
				var_1_54 = (abs ((var_1_31 + var_1_37) - var_1_30));
			} else {
				var_1_54 = ((var_1_30 + var_1_56) + var_1_37);
			}
		} else {
			if (var_1_28 >= stepLocal_13) {
				var_1_54 = (var_1_29 - (max (var_1_37 , var_1_30)));
			} else {
	...
	if (var_1_7) {
		if (stepLocal_19 <= var_1_25) {
			...
			var_1_65 = ((min (var_1_52 , var_1_35)) + (4.125f - (min (var_1_66 , var_1_67))));
		}
	} else {
		if ((var_1_10 * var_1_104) >= (max ((var_1_52 + var_1_15) , var_1_35))) {
			if (stepLocal_20 <= (max ((var_1_20 / -10) , (abs (var_1_29))))) {
				if (! var_1_63) {
					var_1_65 = (min ((max (16.8f , var_1_66)) , (max (var_1_67 , (var_1_35 + var_1_52)))));
				}
			} else {
				if ((var_1_25 - var_1_30) > stepLocal_21) {
					var_1_65 = (var_1_67 + (max ((var_1_35 - 64.7f) , var_1_66)));
				} else {
					var_1_65 = (min ((min (var_1_52 , var_1_66)) , (max ((min (var_1_15 , var_1_14)) , var_1_34))));
				}
			}
		} else {
	...
	// From: Req23Batch141Amount500
	if (var_1_34 > (var_1_33 / (min (var_1_24 , 4.75)))) {
		...
		if (var_1_35 > (max (var_1_96 , var_1_15))) {
			if (var_1_22) {
				if (var_1_7) {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((var_1_62 != (var_1_16 % var_1_4)) ? (var_1_1 == ((unsigned char) (var_1_21 || (! (var_1_21 && var_1_7))))) : (var_1_1 == ((unsigned char) (var_1_7 || (var_1_8 || var_1_9))))) && (((min (var_1_85 , var_1_41)) >= var_1_61) ? (var_1_10 == ((double) var_1_14)) : (var_1_43 ? (var_1_10 == ((double) var_1_14)) : ((var_1_85 <= (- (var_1_61 * var_1_41))) ? (var_1_10 == ((double) (max (var_1_14 , var_1_15)))) : 1)))) && (last_1_var_1_21 ? (var_1_8 ? (var_1_16 == ((unsigned short int) last_1_var_1_101)) : 1) : (last_1_var_1_63 ? (var_1_16 == ((unsigned short int) ((min (var_1_17 , (min (var_1_18 , var_1_19)))) - ((var_1_20 - 64) + (abs (var_1_4)))))) : 1))) && (last_1_var_1_1 ? (var_1_21 == ((unsigned char) var_1_22)) : (var_1_21 == ((unsigned char) 0)))) && ((! ((var_1_14 / var_1_24) >= 24.8)) ? (var_1_9 ? (((min (var_1_99 , var_1_18)) >= (abs (var_1_20))) ? ((var_1_4 < ((var_1_25 - var_1_26) + (- var_1_17))) ? (var_1_23 == ((unsigned char) (min (var_1_26 , var_1_27)))) : (var_1_23 == ((unsigned char) ((min (var_1_28 , 128)) - ((var_1_29 - var_1_30) + var_1_31))))) : (var_1_23 == ((unsigned char) 5))) : ((var_1_26 != var_1_28) ? (var_1_23 == ((unsigned char) (var_1_28 - 32))) : (var_1_23 == ((unsigned char) (var_1_28 - var_1_30))))) : 1)) && ((var_1_17 >= var_1_29) ? ((! var_1_22) ? (var_1_32 == ((double) (max (var_1_14 , ((var_1_33 - 7.4) - (var_1_34 - var_1_35)))))) : 1) : ((var_1_51 >= var_1_24) ? (var_1_32 == ((double) var_1_33)) : (var_1_32 == ((double) var_1_34))))) && (var_1_63 ? ((var_1_25 != (var_1_27 + (var_1_40 ^ var_1_94))) ? (var_1_36 == ((signed char) var_1_31)) : 1) : ((((var_1_25 - var_1_26) + var_1_4) <= var_1_27) ? ((var_1_34 <= var_1_24) ? (var_1_36 == ((signed char) (var_1_31 + (var_1_30 - var_1_37)))) : (var_1_36 == ((signed char) (abs (var_1_31))))) : (var_1_36 == ((signed char) var_1_38))))) && (((var_1_40 * var_1_26) < var_1_46) ? ((((min (var_1_34 , 1.4f)) - 255.75f) >= (min (var_1_33 , var_1_15))) ? (var_1_39 == ((unsigned char) ((var_1_100 < var_1_40) || (! var_1_8)))) : (var_1_39 == ((unsigned char) (var_1_9 || (! var_1_7))))) : (var_1_39 == ((unsigned char) (! var_1_22))))) && ((((var_1_25 / var_1_18) ^ -50) <= (max (1 , var_1_28))) ? (var_1_40 == ((signed short int) (max (var_1_95 , var_1_103)))) : 1)) && ((-4 > (var_1_25 / var_1_17)) ? (var_1_41 == ((double) ((var_1_34 - var_1_35) - (max (var_1_33 , var_1_42))))) : (var_1_9 ? (var_1_41 == ((double) var_1_34)) : (var_1_41 == ((double) 5.2))))) && ((var_1_17 > var_1_31) ? ((var_1_42 < var_1_35) ? ((var_1_27 < var_1_46) ? (var_1_22 ? (var_1_43 == ((unsigned char) ((var_1_9 || (var_1_7 && var_1_8)) || (var_1_44 || var_1_45)))) : (var_1_43 == ((unsigned char) (var_1_9 && var_1_7)))) : (var_1_43 == ((unsigned char) (! var_1_8)))) : (var_1_43 == ((unsigned char) var_1_45))) : 1)) && (var_1_46 == ((signed long int) ((var_1_28 - var_1_19) + ((var_1_17 - var_1_31) + var_1_26))))) && ((var_1_4 < var_1_37) ? ((((var_1_29 - var_1_53) / var_1_20) < var_1_25) ? (var_1_47 == ((unsigned long int) (max (var_1_17 , var_1_18)))) : 1) : (var_1_47 == ((unsigned long int) (var_1_27 + (min (var_1_29 , var_1_73))))))) && (((min (var_1_4 , (var_1_73 / -8))) >= var_1_38) ? (var_1_48 == ((unsigned short int) (var_1_17 - var_1_25))) : ((var_1_99 >= var_1_30) ? (var_1_48 == ((unsigned short int) (abs (var_1_18)))) : ((var_1_10 < var_1_32) ? (var_1_48 == ((unsigned short int) (min ((var_1_50 - (max (var_1_28 , var_1_27))) , (min (var_1_20 , (64260 - var_1_25))))))) : (var_1_48 == ((unsigned short int) (var_1_4 + (max ((min (var_1_26 , var_1_27)) , var_1_31))))))))) && (var_1_51 == ((double) (var_1_35 + (50.76 - var_1_52))))) && (((var_1_31 * var_1_29) > (var_1_37 - 100)) ? (var_1_53 == ((unsigned long int) var_1_17)) : 1)) && (var_1_39 ? (var_1_54 == ((signed char) ((64 - var_1_30) - var_1_37))) : (((1 << var_1_19) >= (~ var_1_47)) ? ((var_1_34 < var_1_41) ? (var_1_54 == ((signed char) (abs ((var_1_31 + var_1_37) - var_1_30)))) : (var_1_54 == ((signed char) ((var_1_30 + var_1_56) + var_1_37)))) : ((var_1_28 >= var_1_4) ? (var_1_54 == ((signed char) (var_1_29 - (max (var_1_37 , var_1_30))))) : ((5 != (var_1_30 * (var_1_20 * var_1_75))) ? (var_1_54 == ((signed char) var_1_37)) : (var_1_54 == ((signed char) ((var_1_57 - var_1_30) - var_1_29)))))))) && (((-2 > (min (var_1_27 , var_1_20))) || (var_1_38 <= (max (var_1_30 , var_1_75)))) ? (((abs (var_1_99)) < 32) ? (var_1_58 == ((unsigned char) var_1_8)) : (var_1_58 == ((unsigned char) (var_1_8 && var_1_45)))) : (((- var_1_14) > var_1_34) ? (var_1_58 == ((unsigned char) ((var_1_22 && var_1_59) && var_1_60))) : 1))) && ((var_1_4 >= ((var_1_25 - var_1_57) + (var_1_28 * var_1_31))) ? (var_1_61 == ((double) (var_1_35 + var_1_52))) : 1)) && ((((var_1_29 - 32) + var_1_75) != var_1_31) ? (var_1_62 == ((signed short int) ((min ((max (var_1_37 , var_1_26)) , var_1_4)) + (var_1_16 - var_1_27)))) : (var_1_62 == ((signed short int) (var_1_26 - var_1_20))))) && (((var_1_64 - 256u) > var_1_95) ? ((var_1_22 || (var_1_32 > (var_1_35 / var_1_33))) ? (var_1_63 == ((unsigned char) (((var_1_21 && var_1_44) || var_1_7) || var_1_45))) : 1) : ((((var_1_4 & var_1_28) <= (var_1_25 - var_1_57)) && (var_1_17 < var_1_73)) ? (var_1_63 == ((unsigned char) (var_1_59 || var_1_60))) : 1))) && (var_1_7 ? (((var_1_48 / var_1_57) <= var_1_25) ? (var_1_65 == ((float) (var_1_52 + var_1_35))) : (var_1_65 == ((float) ((min (var_1_52 , var_1_35)) + (4.125f - (min (var_1_66 , var_1_67))))))) : (((var_1_10 * var_1_104) >= (max ((var_1_52 + var_1_15) , var_1_35))) ? (((var_1_57 * var_1_25) <= (max ((var_1_20 / -10) , (abs (var_1_29))))) ? ((! var_1_63) ? (var_1_65 == ((float) (min ((max (16.8f , var_1_66)) , (max (var_1_67 , (var_1_35 + var_1_52))))))) : 1) : (((var_1_25 - var_1_30) > var_1_100) ? (var_1_65 == ((float) (var_1_67 + (max ((var_1_35 - 64.7f) , var_1_66))))) : (var_1_65 == ((float) (min ((min (var_1_52 , var_1_66)) , (max ((min (var_1_15 , var_1_14)) , var_1_34)))))))) : (var_1_65 == ((float) ((var_1_33 - var_1_52) - (var_1_34 - (var_1_70 - var_1_69)))))))) && ((var_1_34 > (var_1_33 / (min (var_1_24 , 4.75)))) ? ((var_1_46 >= var_1_48) ? (var_1_71 == ((unsigned char) (var_1_59 && (! var_1_9)))) : (var_1_71 == ((unsigned char) (! (var_1_22 && var_1_8))))) : ((var_1_35 > (max (var_1_96 , var_1_15))) ? (var_1_22 ? (var_1_7 ? ((var_1_46 <= ((var_1_19 / -10) / var_1_18)) ? (var_1_71 == ((unsigned char) var_1_8)) : (var_1_71 == ((unsigned char) ((var_1_9 || var_1_8) || (! (var_1_91 || var_1_59)))))) : 1) : (var_1_71 == ((unsigned char) ((var_1_91 && (var_1_57 < var_1_30)) && var_1_72)))) : 1))) && ((var_1_31 > (~ (128 - var_1_37))) ? (var_1_73 == ((unsigned long int) (var_1_74 - var_1_28))) : (var_1_73 == ((unsigned long int) (min (var_1_18 , 0u)))))) && ((var_1_14 < (min (var_1_24 , var_1_68))) ? (last_1_var_1_58 ? (var_1_75 == ((unsigned long int) var_1_76)) : 1) : (var_1_44 ? (((var_1_14 / var_1_24) >= (last_1_var_1_51 + var_1_15)) ? ((var_1_57 == last_1_var_1_94) ? (var_1_75 == ((unsigned long int) (max (var_1_77 , ((max (var_1_4 , last_1_var_1_48)) + last_1_var_1_94))))) : ((var_1_4 > var_1_20) ? (var_1_75 == ((unsigned long int) (max (var_1_30 , var_1_20)))) : ((last_1_var_1_91 && (last_1_var_1_95 > last_1_var_1_75)) ? ((var_1_31 <= ((~ last_1_var_1_53) / var_1_4)) ? (var_1_75 == ((unsigned long int) (max (var_1_74 , var_1_77)))) : (var_1_75 == ((unsigned long int) (max (var_1_31 , (max (var_1_27 , var_1_37))))))) : (var_1_75 == ((unsigned long int) (min (100000000u , (min (var_1_50 , (max (var_1_30 , var_1_17))))))))))) : (var_1_75 == ((unsigned long int) (max (128u , var_1_25))))) : ((last_1_var_1_53 > 5u) ? (var_1_75 == ((unsigned long int) (((min (var_1_79 , var_1_80)) + (var_1_81 + var_1_82)) - var_1_29))) : 1)))) && ((var_1_94 <= var_1_16) ? (var_1_83 == ((float) (((31.5f + var_1_69) - var_1_35) + 127.75f))) : (var_1_83 == ((float) (((max (var_1_34 , var_1_68)) - var_1_52) - (var_1_67 + var_1_35)))))) && ((var_1_63 || var_1_59) ? (var_1_85 == ((double) ((max (var_1_33 , (abs (var_1_67)))) - var_1_42))) : 1)) && ((((var_1_31 + var_1_88) << var_1_53) < (var_1_75 + var_1_29)) ? ((var_1_41 >= var_1_32) ? (var_1_87 == ((float) (min (var_1_14 , ((var_1_35 + var_1_69) - var_1_52))))) : (var_1_87 == ((float) (max ((var_1_70 + (var_1_69 + var_1_89)) , var_1_33))))) : ((var_1_41 != (var_1_85 * (abs (var_1_90)))) ? (((var_1_53 + (- var_1_57)) < var_1_81) ? (var_1_87 == ((float) var_1_89)) : 1) : (var_1_87 == ((float) (var_1_66 + var_1_69)))))) && (((- (- var_1_64)) > (- var_1_25)) ? (var_1_90 == ((float) (abs (var_1_15)))) : 1)) && ((var_1_81 > 1u) ? (((min ((var_1_30 * 25) , var_1_64)) < var_1_4) ? (var_1_91 == ((unsigned char) var_1_72)) : 1) : (var_1_91 == ((unsigned char) var_1_59)))) && (var_1_63 ? (var_1_92 == ((signed char) -64)) : (var_1_92 == ((signed char) var_1_31)))) && (var_1_1 ? (var_1_93 == ((unsigned char) var_1_60)) : 1)) && (var_1_91 ? (var_1_94 == ((unsigned short int) var_1_57)) : (var_1_94 == ((unsigned short int) var_1_23)))) && (var_1_93 ? (var_1_95 == ((signed short int) var_1_28)) : 1)) && (var_1_43 ? (var_1_96 == ((double) var_1_33)) : (var_1_96 == ((double) var_1_68)))) && (var_1_97 == ((signed short int) var_1_98))) && (var_1_60 ? (var_1_98 == ((unsigned char) var_1_30)) : (var_1_98 == ((unsigned char) var_1_29)))) && (var_1_91 ? (var_1_99 == ((unsigned short int) var_1_88)) : 1)) && (var_1_60 ? (var_1_100 == ((signed long int) var_1_26)) : (var_1_100 == ((signed long int) var_1_29)))) && (var_1_101 == ((signed short int) var_1_4))) && (var_1_102 == ((unsigned char) var_1_29))) && (var_1_21 ? (var_1_103 == ((signed short int) var_1_62)) : (var_1_103 == ((signed short int) var_1_57)))) && (((- (var_1_19 >> var_1_105)) < var_1_73) ? ((var_1_100 >= (min (var_1_75 , var_1_29))) ? (var_1_104 == ((float) var_1_67)) : (var_1_104 == ((float) var_1_68))) : (var_1_104 == ((float) var_1_42)))
;
}
int main(void) {
	isInitial = 1;
