...
void step(void) {
	// From: Req4Batch195dependencies
	if ((last_1_var_1_16 ^ (last_1_var_1_24 / var_1_14)) <= last_1_var_1_24) {
		var_1_13 = var_1_15;
	}


	// From: Req9Batch195dependencies
	var_1_24 = var_1_13;


	// From: Req1Batch195dependencies
	if (128 >= (var_1_24 * 1)) {
		var_1_1 = 4;
	}


	// From: Req2Batch195dependencies
	if (var_1_4) {
		...
		if (((var_1_6 - var_1_8) / (max (var_1_9 , 3.5))) == var_1_7) {
			var_1_3 = var_1_7;
		}
	}


	// From: Req3Batch195dependencies
	...
	// From: Req5Batch195dependencies
	if (var_1_6 < 0.375f) {
		var_1_16 = (max (var_1_17 , var_1_18));
	}


	// From: Req7Batch195dependencies
	if (var_1_4) {
		var_1_22 = (min (var_1_7 , var_1_6));
	}


	// From: Req8Batch195dependencies
	var_1_23 = var_1_15;


	// From: Req6Batch195dependencies
	if (((min (var_1_23 , var_1_14)) >= (var_1_24 * var_1_18)) && var_1_4) {
		if (var_1_4) {
			var_1_19 = var_1_18;
		} else {
			var_1_19 = var_1_17;
...
int property(void) {
	return (((((((((128 >= (var_1_24 * 1)) ? (var_1_1 == ((signed char) 4)) : 1) && (var_1_4 ? (((var_1_24 | var_1_13) <= var_1_24) ? (var_1_3 == ((float) ((10000.6f - var_1_6) + var_1_7))) : (var_1_3 == ((float) var_1_6))) : ((((var_1_6 - var_1_8) / (max (var_1_9 , 3.5))) == var_1_7) ? (var_1_3 == ((float) var_1_7)) : 1))) && (((var_1_3 / var_1_9) >= var_1_6) ? (var_1_4 ? (var_1_10 == ((float) (var_1_6 - var_1_11))) : (var_1_10 == ((float) ((var_1_6 + var_1_12) - var_1_11)))) : (var_1_10 == ((float) var_1_11)))) && (((last_1_var_1_16 ^ (last_1_var_1_24 / var_1_14)) <= last_1_var_1_24) ? (var_1_13 == ((unsigned short int) var_1_15)) : 1)) && ((var_1_6 < 0.375f) ? (var_1_16 == ((signed char) (max (var_1_17 , var_1_18)))) : 1)) && ((((min (var_1_23 , var_1_14)) >= (var_1_24 * var_1_18)) && var_1_4) ? (var_1_4 ? (var_1_19 == ((signed char) var_1_18)) : (var_1_19 == ((signed char) var_1_17))) : 1)) && (var_1_4 ? (var_1_22 == ((float) (min (var_1_7 , var_1_6)))) : 1)) && (var_1_23 == ((unsigned short int) var_1_15))) && (var_1_24 == ((unsigned long int) var_1_13))
;
}
int main(void) {
	isInitial = 1;
