...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch130Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned char stepLocal_2 = ((var_1_15) < (var_1_13));
   ...
   var_1_30
             ...
             if ( (( (((((var_1_41)) > (( ((var_1_45) - (3.2f))))) ? ((var_1_41)) : (( ((var_1_45) - (3.2f))))))) <= (var_1_37))) {
     ...
     1
             ...
             if ( (( ((((((var_1_36) % (var_1_47))) < 0 ) ? -(((var_1_36) % (var_1_47))) : (((var_1_36) % (var_1_47)))))) > (var_1_48))) {
              var_1_46 = (
