...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch153Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch153Amount100
	if (var_1_2) {
		var_1_1 = (min ((64 + var_1_3) , (var_1_4 + (max (var_1_5 , var_1_6)))));
	}


	// From: Req5Batch153Amount100
	unsigned char stepLocal_2 = var_1_2;
	if (stepLocal_2 && var_1_18) {
		var_1_17 = (((min (var_1_19 , var_1_20)) - var_1_21) + 10);
	}


	// From: Req6Batch153Amount100
	if (! var_1_18) {
		var_1_22 = (var_1_15 - (var_1_23 - var_1_20));
	}


	// From: Req7Batch153Amount100
	if (var_1_2 || var_1_18) {
	...
	// From: Req8Batch153Amount100
	if (var_1_18) {
		if (! (! var_1_2)) {
			if (var_1_21 == ((var_1_28 - var_1_29) - var_1_20)) {
				var_1_27 = (max (4 , (var_1_30 - var_1_21)));
			}
		} else {
			var_1_27 = (var_1_29 + (min (var_1_19 , (var_1_21 + var_1_31))));
		}
	} else {
		var_1_27 = (max (var_1_29 , var_1_31));
	}


	// From: Req11Batch153Amount100
	if (var_1_41) {
		var_1_40 = (max (-5 , var_1_17));
	}


	// From: Req12Batch153Amount100
	...
	if (var_1_2) {
		if (var_1_30 < stepLocal_4) {
			if (stepLocal_6 >= var_1_22) {
				var_1_42 = (max (var_1_1 , (min ((min (var_1_14 , var_1_22)) , var_1_19))));
			}
		} else {
			var_1_42 = (abs (3721222567u - var_1_29));
		}
	} else {
		if (100000u > stepLocal_5) {
			var_1_42 = (min (var_1_28 , var_1_21));
		} else {
			var_1_42 = var_1_15;
		}
	}
	...
	// From: Req13Batch153Amount100
	var_1_43 = var_1_34;


	// From: Req2Batch153Amount100
	...
	// From: Req3Batch153Amount100
	if (var_1_40 <= (var_1_3 + (abs (last_1_var_1_11)))) {
	...
	// From: Req9Batch153Amount100
	unsigned long int stepLocal_3 = max (4 , var_1_42);
	if (! var_1_18) {
...
int property(void) {
	return ((((((((((((var_1_2 ? (var_1_1 == ((signed short int) (min ((64 + var_1_3) , (var_1_4 + (max (var_1_5 , var_1_6))))))) : 1) && ((((var_1_5 * var_1_22) < (var_1_8 - var_1_9)) || var_1_2) ? (var_1_7 == ((float) var_1_10)) : 1)) && ((var_1_40 <= (var_1_3 + (abs (last_1_var_1_11)))) ? (var_1_11 == ((unsigned short int) ((var_1_40 + (var_1_13 + var_1_14)) + var_1_15))) : (var_1_11 == ((unsigned short int) var_1_14)))) && ((var_1_5 >= ((var_1_6 | var_1_3) | var_1_8)) ? ((var_1_10 <= var_1_43) ? (var_1_16 == ((signed long int) (16 - var_1_15))) : 1) : (var_1_16 == ((signed long int) var_1_5)))) && ((var_1_2 && var_1_18) ? (var_1_17 == ((unsigned char) (((min (var_1_19 , var_1_20)) - var_1_21) + 10))) : 1)) && ((! var_1_18) ? (var_1_22 == ((signed long int) (var_1_15 - (var_1_23 - var_1_20)))) : 1)) && ((var_1_2 || var_1_18) ? (var_1_24 == ((float) (var_1_25 - var_1_26))) : (var_1_2 ? (var_1_24 == ((float) var_1_10)) : 1))) && (var_1_18 ? ((! (! var_1_2)) ? ((var_1_21 == ((var_1_28 - var_1_29) - var_1_20)) ? (var_1_27 == ((unsigned char) (max (4 , (var_1_30 - var_1_21))))) : 1) : (var_1_27 == ((unsigned char) (var_1_29 + (min (var_1_19 , (var_1_21 + var_1_31))))))) : (var_1_27 == ((unsigned char) (max (var_1_29 , var_1_31)))))) && ((! var_1_18) ? (var_1_32 == ((double) ((var_1_33 + var_1_34) + var_1_35))) : ((var_1_17 > (max (4 , var_1_42))) ? (var_1_32 == ((double) var_1_34)) : 1))) && ((var_1_43 <= (var_1_26 - var_1_25)) ? (var_1_39 == ((float) var_1_10)) : 1)) && (var_1_41 ? (var_1_40 == ((signed short int) (max (-5 , var_1_17)))) : 1)) && (var_1_2 ? ((var_1_30 < var_1_28) ? ((((var_1_9 & var_1_8) % var_1_28) >= var_1_22) ? (var_1_42 == ((unsigned long int) (max (var_1_1 , (min ((min (var_1_14 , var_1_22)) , var_1_19)))))) : 1) : (var_1_42 == ((unsigned long int) (abs (3721222567u - var_1_29))))) : ((100000u > var_1_9) ? (var_1_42 == ((unsigned long int) (min (var_1_28 , var_1_21)))) : (var_1_42 == ((unsigned long int) var_1_15))))) && (var_1_43 == ((double) var_1_34))
;
}
int main(void) {
	isInitial = 1;
