...
void step(void) {
	// From: Req3Batch121Amount250
	unsigned long int stepLocal_4 = var_1_11;
	if (stepLocal_4 == var_1_10) {
		var_1_23 = (var_1_15 + (min (500u , var_1_21)));
	}


	// From: Req8Batch121Amount250
	var_1_34 = (var_1_30 + var_1_31);


	// From: Req13Batch121Amount250
	if ((var_1_49 - var_1_14) >= var_1_18) {
		var_1_50 = var_1_41;
	}


	// From: Req15Batch121Amount250
	...
	// From: Req18Batch121Amount250
	var_1_62 = ((var_1_63 || var_1_64) || var_1_65);


	// From: Req22Batch121Amount250
	if (var_1_62 || var_1_63) {
		var_1_70 = var_1_31;
	}


	// From: Req23Batch121Amount250
	if (var_1_23 <= (- 5u)) {
		if (var_1_3 < var_1_34) {
			var_1_71 = var_1_29;
		}
	...
	// From: Req1Batch121Amount250
	if ((var_1_71 / (min (var_1_3 , var_1_4))) <= (var_1_71 / (min (var_1_6 , var_1_7)))) {
		if (var_1_53) {
		...
		var_1_1 = (max (var_1_11 , var_1_9));
	}


	// From: Req9Batch121Amount250
	if (var_1_18 < var_1_1) {
		var_1_35 = (var_1_20 + 8u);
	} else {
		var_1_35 = (max ((abs (var_1_26)) , 2u));
	}


	// From: Req10Batch121Amount250
	if (var_1_26 <= (~ var_1_25)) {
		if (var_1_6 < var_1_30) {
			if ((var_1_26 * var_1_23) != (var_1_1 + (abs (var_1_18)))) {
				var_1_37 = (abs (var_1_22));
			} else {
				var_1_37 = (min (((min (var_1_22 , var_1_21)) - var_1_38) , ((var_1_39 + var_1_40) + (min (var_1_41 , var_1_42)))));
			}
		} else {
			var_1_37 = var_1_42;
		}
	...
	if ((var_1_11 != (var_1_35 * var_1_18)) || var_1_53) {
		...
		if ((var_1_25 + 50) < var_1_15) {
			var_1_45 = (var_1_9 - (min (var_1_26 , (var_1_46 - var_1_15))));
		}
	}


	// From: Req20Batch121Amount250
	var_1_68 = var_1_37;


	// From: Req7Batch121Amount250
	var_1_32 = ((var_1_35 <= (abs (var_1_45))) && (! var_1_33));


	// From: Req21Batch121Amount250
	if (var_1_32) {
		var_1_69 = var_1_31;
	} else {
		var_1_69 = var_1_29;
	...
	// From: Req4Batch121Amount250
	if (var_1_18 <= (var_1_10 % (min (var_1_14 , var_1_22)))) {
		if (var_1_5 <= var_1_2) {
			var_1_24 = (var_1_21 + ((min (var_1_22 , var_1_25)) - var_1_26));
		} else {
			var_1_24 = var_1_26;
		}
	} else {
	...
	// From: Req14Batch121Amount250
	if ((var_1_44 * var_1_23) == var_1_9) {
		var_1_51 = (last_1_var_1_51 - (max (var_1_22 , (abs (var_1_38)))));
	} else {
		if (var_1_48 <= ((var_1_3 + var_1_28) * var_1_30)) {
			var_1_51 = (var_1_41 + var_1_44);
		} else {
			var_1_51 = (min ((min (var_1_41 , var_1_23)) , ((min (var_1_26 , var_1_44)) - (var_1_52 - 64))));
		}
	}


	// From: Req19Batch121Amount250
	...
	// From: Req5Batch121Amount250
	if (! var_1_66) {
		var_1_27 = (max (var_1_15 , var_1_11));
	}


	// From: Req16Batch121Amount250
	if (var_1_1 <= (max ((var_1_1 * var_1_35) , (max (var_1_26 , 64))))) {
		...
		if (var_1_62 || (var_1_32 || var_1_54)) {
			if (var_1_54) {
				if ((- var_1_30) <= (var_1_71 / (max (var_1_7 , var_1_3)))) {
					var_1_55 = (max ((min ((max (var_1_41 , var_1_26)) , var_1_39)) , var_1_1));
				} else {
					var_1_55 = (var_1_26 - var_1_38);
				}
			}
		} else {
			var_1_55 = (var_1_44 + (min (var_1_41 , var_1_21)));
		}
	}


	// From: Req2Batch121Amount250
			...
			if (! (var_1_66 || (var_1_27 <= var_1_13))) {
				if (stepLocal_2 > (var_1_16 ^ var_1_10)) {
					if (var_1_66 || stepLocal_1) {
						var_1_12 = ((min (var_1_14 , var_1_13)) - (var_1_15 + var_1_18));
					}
				} else {
	...
	// From: Req17Batch121Amount250
	unsigned long int stepLocal_7 = var_1_1;
	if ((var_1_1 + var_1_12) >= stepLocal_7) {
		if (var_1_33) {
			var_1_57 = ((var_1_22 + (var_1_21 + var_1_59)) - (var_1_60 - (max (1 , 32))));
		}
	} else {
		var_1_57 = (min (4 , (var_1_59 - (min (var_1_38 , var_1_61)))));
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((var_1_71 / (min (var_1_3 , var_1_4))) <= (var_1_71 / (min (var_1_6 , var_1_7)))) ? (var_1_53 ? (var_1_1 == ((unsigned long int) (var_1_9 - (max (var_1_10 , var_1_11))))) : (var_1_1 == ((unsigned long int) (min (var_1_9 , var_1_11))))) : (var_1_1 == ((unsigned long int) (max (var_1_11 , var_1_9))))) && ((var_1_27 <= var_1_10) ? (var_1_12 == ((signed long int) ((var_1_13 - (var_1_14 - var_1_15)) - var_1_16))) : (var_1_53 ? ((! (var_1_66 || (var_1_27 <= var_1_13))) ? (((var_1_9 + var_1_27) > (var_1_16 ^ var_1_10)) ? ((var_1_66 || ((var_1_11 * var_1_10) > var_1_16)) ? (var_1_12 == ((signed long int) ((min (var_1_14 , var_1_13)) - (var_1_15 + var_1_18)))) : 1) : ((((var_1_19 - var_1_20) | (var_1_10 * var_1_11)) >= (var_1_15 >> (var_1_21 + var_1_22))) ? (var_1_12 == ((signed long int) 16)) : 1)) : (var_1_12 == ((signed long int) var_1_14))) : (var_1_12 == ((signed long int) var_1_16))))) && ((var_1_11 == var_1_10) ? (var_1_23 == ((unsigned long int) (var_1_15 + (min (500u , var_1_21))))) : 1)) && ((var_1_18 <= (var_1_10 % (min (var_1_14 , var_1_22)))) ? ((var_1_5 <= var_1_2) ? (var_1_24 == ((signed short int) (var_1_21 + ((min (var_1_22 , var_1_25)) - var_1_26)))) : (var_1_24 == ((signed short int) var_1_26))) : (var_1_32 ? (var_1_24 == ((signed short int) var_1_25)) : 1))) && ((! var_1_66) ? (var_1_27 == ((unsigned long int) (max (var_1_15 , var_1_11)))) : 1)) && ((var_1_1 > (-16 & var_1_22)) ? ((((var_1_11 * 8u) >= var_1_20) || var_1_32) ? (var_1_28 == ((float) var_1_29)) : ((var_1_10 != var_1_45) ? (var_1_28 == ((float) (var_1_30 + var_1_31))) : ((-100 >= var_1_25) ? (var_1_28 == ((float) var_1_31)) : 1))) : 1)) && (var_1_32 == ((unsigned char) ((var_1_35 <= (abs (var_1_45))) && (! var_1_33))))) && (var_1_34 == ((float) (var_1_30 + var_1_31)))) && ((var_1_18 < var_1_1) ? (var_1_35 == ((unsigned long int) (var_1_20 + 8u))) : (var_1_35 == ((unsigned long int) (max ((abs (var_1_26)) , 2u)))))) && ((var_1_26 <= (~ var_1_25)) ? ((var_1_6 < var_1_30) ? (((var_1_26 * var_1_23) != (var_1_1 + (abs (var_1_18)))) ? (var_1_37 == ((signed char) (abs (var_1_22)))) : (var_1_37 == ((signed char) (min (((min (var_1_22 , var_1_21)) - var_1_38) , ((var_1_39 + var_1_40) + (min (var_1_41 , var_1_42)))))))) : (var_1_37 == ((signed char) var_1_42))) : 1)) && (((var_1_29 * var_1_6) > var_1_70) ? ((var_1_18 == ((var_1_22 - var_1_25) / var_1_19)) ? (var_1_43 == ((unsigned char) (min ((var_1_44 - var_1_21) , var_1_38)))) : (var_1_43 == ((unsigned char) var_1_21))) : 1)) && (((var_1_11 != (var_1_35 * var_1_18)) || var_1_53) ? ((last_1_var_1_45 > var_1_22) ? (var_1_45 == ((unsigned long int) (last_1_var_1_45 + (var_1_46 - var_1_19)))) : (((var_1_47 - var_1_48) <= (min (var_1_71 , var_1_4))) ? (var_1_45 == ((unsigned long int) ((var_1_49 - var_1_19) - (var_1_46 - var_1_38)))) : (var_1_45 == ((unsigned long int) (last_1_var_1_45 + var_1_14))))) : (((var_1_25 + 50) < var_1_15) ? (var_1_45 == ((unsigned long int) (var_1_9 - (min (var_1_26 , (var_1_46 - var_1_15)))))) : 1))) && (((var_1_49 - var_1_14) >= var_1_18) ? (var_1_50 == ((signed short int) var_1_41)) : 1)) && (((var_1_44 * var_1_23) == var_1_9) ? (var_1_51 == ((signed short int) (last_1_var_1_51 - (max (var_1_22 , (abs (var_1_38))))))) : ((var_1_48 <= ((var_1_3 + var_1_28) * var_1_30)) ? (var_1_51 == ((signed short int) (var_1_41 + var_1_44))) : (var_1_51 == ((signed short int) (min ((min (var_1_41 , var_1_23)) , ((min (var_1_26 , var_1_44)) - (var_1_52 - 64))))))))) && ((var_1_38 != var_1_16) ? (var_1_53 == ((unsigned char) (var_1_33 && (! (! var_1_54))))) : 1)) && ((var_1_1 <= (max ((var_1_1 * var_1_35) , (max (var_1_26 , 64))))) ? ((var_1_66 && (var_1_62 || var_1_54)) ? (var_1_55 == ((signed short int) (var_1_25 - var_1_26))) : (var_1_55 == ((signed short int) ((256 - var_1_44) + var_1_1)))) : ((var_1_62 || (var_1_32 || var_1_54)) ? (var_1_54 ? (((- var_1_30) <= (var_1_71 / (max (var_1_7 , var_1_3)))) ? (var_1_55 == ((signed short int) (max ((min ((max (var_1_41 , var_1_26)) , var_1_39)) , var_1_1)))) : (var_1_55 == ((signed short int) (var_1_26 - var_1_38)))) : 1) : (var_1_55 == ((signed short int) (var_1_44 + (min (var_1_41 , var_1_21)))))))) && (((var_1_1 + var_1_12) >= var_1_1) ? (var_1_33 ? (var_1_57 == ((signed char) ((var_1_22 + (var_1_21 + var_1_59)) - (var_1_60 - (max (1 , 32)))))) : 1) : (var_1_57 == ((signed char) (min (4 , (var_1_59 - (min (var_1_38 , var_1_61))))))))) && (var_1_62 == ((unsigned char) ((var_1_63 || var_1_64) || var_1_65)))) && ((var_1_53 && (var_1_31 >= (var_1_4 * var_1_28))) ? (var_1_66 == ((unsigned char) (var_1_33 && var_1_54))) : 1)) && (var_1_68 == ((signed long int) var_1_37))) && (var_1_32 ? (var_1_69 == ((float) var_1_31)) : (var_1_69 == ((float) var_1_29)))) && ((var_1_62 || var_1_63) ? (var_1_70 == ((float) var_1_31)) : 1)) && ((var_1_23 <= (- 5u)) ? ((var_1_3 < var_1_34) ? (var_1_71 == ((double) var_1_29)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
