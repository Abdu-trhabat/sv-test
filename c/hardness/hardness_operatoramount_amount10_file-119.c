...
void step(void) {
	// From: Req1Batch119Amount10
	if (var_1_2 > (max (10 , var_1_3))) {
...
int property(void) {
	return (var_1_2 > (max (10 , var_1_3))) ? (var_1_1 == ((float) (max (var_1_4 , ((var_1_5 - var_1_6) + (max (var_1_7 , var_1_8))))))) : (var_1_9 ? (var_1_1 == ((float) var_1_7)) : (var_1_1 == ((float) var_1_5)))
;
}
int main(void) {
	isInitial = 1;
