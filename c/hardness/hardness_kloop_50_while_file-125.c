...
void step(void) {
	...
	// From: Req2Batch12550_while
	var_1_11 = ((abs (var_1_12)) + var_1_13);


	// From: Req3Batch12550_while
	...
	// From: Req4Batch12550_while
	var_1_18 = (min ((var_1_19 - 100) , var_1_9));


	// From: Req5Batch12550_while
	if (var_1_2) {
		var_1_20 = var_1_18;
	} else {
