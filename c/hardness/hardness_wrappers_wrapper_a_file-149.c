...
int property(void) {
	return ((BOOL_unsigned_char_Array_0[2] ? (unsigned_short_int_Array_0[2] == ((unsigned short int) (unsigned_short_int_Array_0[1] - unsigned_short_int_Array_0[0]))) : ((unsigned_short_int_Array_0[1] == unsigned_short_int_Array_0[0]) ? ((unsigned_short_int_Array_0[1] < 4) ? (unsigned_short_int_Array_0[2] == ((unsigned short int) unsigned_short_int_Array_0[0])) : (((- 4) < unsigned_short_int_Array_0[1]) ? (unsigned_short_int_Array_0[2] == ((unsigned short int) (min (unsigned_short_int_Array_0[1] , unsigned_short_int_Array_0[0])))) : (unsigned_short_int_Array_0[2] == ((unsigned short int) unsigned_short_int_Array_0[1])))) : (unsigned_short_int_Array_0[2] == ((unsigned short int) unsigned_short_int_Array_0[0])))) && ((unsigned_short_int_Array_0[1] < unsigned_short_int_Array_0[0]) ? ((last_1_unsigned_long_int_Array_0_0_ < unsigned_short_int_Array_0[1]) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) (unsigned_short_int_Array_0[0] + last_1_unsigned_long_int_Array_0_0_))) : (unsigned_long_int_Array_0[0] == ((unsigned long int) last_1_unsigned_long_int_Array_0_0_))) : 1)) && (((unsigned_short_int_Array_0[1] % signed_char_Array_0[0]) < (~ (unsigned_long_int_Array_0[0] + unsigned_short_int_Array_0[0]))) ? ((BOOL_unsigned_char_Array_0[2] && (BOOL_unsigned_char_Array_0[1] && BOOL_unsigned_char_Array_0[0])) ? (double_Array_0[1] == ((double) double_Array_0[0])) : 1) : (double_Array_0[1] == ((double) double_Array_0[0])))
;
}
int main(void) {
	isInitial = 1;
