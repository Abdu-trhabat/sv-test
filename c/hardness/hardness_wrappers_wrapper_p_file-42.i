...
void step(void) {
 if ((*(var_1_2_Pointer)) > (*(var_1_3_Pointer))) {
  (*(var_1_1_Pointer)) = ((((((*(var_1_4_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_5_Pointer))))) - 10);
 } else {
  (*(var_1_1_Pointer)) = ((((((*(var_1_5_Pointer)) - (*(var_1_6_Pointer)))) > (((*(var_1_4_Pointer)) - (*(var_1_7_Pointer))))) ? (((*(var_1_5_Pointer)) - (*(var_1_6_Pointer)))) : (((*(var_1_4_Pointer)) - (*(var_1_7_Pointer))))));
 }
