...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch157Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch157Amount50
	if (((var_1_5 / var_1_10) < var_1_1) && var_1_7) {
		var_1_9 = 32;
	}


	// From: Req4Batch157Amount50
	var_1_11 = 199.4;


	// From: Req7Batch157Amount50
	...
	// From: Req8Batch157Amount50
	var_1_21 = last_1_var_1_21;


	// From: Req9Batch157Amount50
	var_1_22 = var_1_18;


	// From: Req2Batch157Amount50
	if (32.5 >= var_1_11) {
		if (var_1_7 && var_1_8) {
			var_1_6 = -4;
		}
