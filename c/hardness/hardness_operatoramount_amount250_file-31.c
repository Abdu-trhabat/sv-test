...
void step(void) {
	...
	if (((last_1_var_1_21 * var_1_15) * var_1_24) < last_1_var_1_25) {
		...
		if (((- var_1_18) * var_1_19) > last_1_var_1_13) {
			...
			var_1_48 = (var_1_51 - (min (var_1_11 , var_1_50)));
		}
	}
	...
	if (var_1_17 || (var_1_9 >= var_1_8)) {
		...
		if (! (var_1_17 && var_1_2)) {
			...
			var_1_29 = ((min ((var_1_12 + var_1_6) , var_1_8)) + (min (var_1_30 , var_1_7)));
		}
	}
	...
	if ((var_1_38 + (min (32 , var_1_12))) >= var_1_48) {
	...
	unsigned long int stepLocal_13 = var_1_35 + (min (var_1_26 , var_1_3));
	if (var_1_32) {
		if (((max (var_1_48 , var_1_29)) / 1) > stepLocal_13) {
			if (var_1_32) {
...
int property(void) {
	return (((((((((((((((((((var_1_48 % var_1_4) >= var_1_48) ? ((var_1_32 && (var_1_48 < var_1_4)) ? (var_1_1 == ((unsigned char) var_1_6)) : 1) : (((var_1_6 + var_1_48) > var_1_48) ? (var_1_1 == ((unsigned char) (min ((min ((min (var_1_6 , var_1_7)) , var_1_8)) , var_1_9)))) : (var_1_1 == ((unsigned char) ((max (var_1_10 , (abs (var_1_11)))) - var_1_12))))) && ((var_1_29 != var_1_8) ? (var_1_13 == ((double) (min ((var_1_14 - (min (var_1_15 , var_1_16))) , (abs (64.4)))))) : (var_1_32 ? (var_1_13 == ((double) (max ((abs (var_1_16)) , var_1_15)))) : ((! var_1_32) ? (var_1_13 == ((double) ((min ((max (199.75 , var_1_15)) , (var_1_18 - var_1_19))) - (max (var_1_16 , (min (var_1_14 , var_1_20))))))) : (var_1_13 == ((double) var_1_19)))))) && ((var_1_8 == (- var_1_55)) ? (var_1_21 == ((float) ((var_1_19 + var_1_22) - (var_1_23 + var_1_24)))) : ((-2 < ((var_1_12 * var_1_11) | var_1_7)) ? (var_1_21 == ((float) 127.4f)) : (var_1_21 == ((float) var_1_18))))) && (((var_1_12 + var_1_11) <= -100) ? ((((var_1_26 - var_1_58) / var_1_10) < var_1_11) ? (var_1_25 == ((float) (max (var_1_27 , var_1_15)))) : (var_1_25 == ((float) (min (var_1_14 , var_1_18))))) : (var_1_25 == ((float) (max ((16.2f - (var_1_22 + var_1_24)) , var_1_14)))))) && ((0 > var_1_39) ? (var_1_28 == ((float) (min (99.2f , var_1_16)))) : 1)) && ((var_1_17 || (var_1_9 >= var_1_8)) ? (var_1_29 == ((unsigned long int) (5u + (32u + var_1_12)))) : ((! (var_1_17 && var_1_2)) ? (var_1_29 == ((unsigned long int) ((abs (32u)) + var_1_8))) : (var_1_29 == ((unsigned long int) ((min ((var_1_12 + var_1_6) , var_1_8)) + (min (var_1_30 , var_1_7)))))))) && (var_1_31 == ((double) (var_1_23 + var_1_19)))) && ((var_1_7 >= (var_1_29 + var_1_11)) ? ((var_1_6 >= var_1_11) ? (var_1_32 == ((unsigned char) (! var_1_33))) : (var_1_32 == ((unsigned char) (var_1_33 && var_1_34)))) : 1)) && (var_1_32 ? (((var_1_6 / 1) <= var_1_30) ? (var_1_35 == ((unsigned char) (min (var_1_36 , var_1_8)))) : 1) : ((! var_1_34) ? (var_1_35 == ((unsigned char) (min (var_1_36 , var_1_8)))) : ((var_1_34 && var_1_33) ? (((var_1_18 - (var_1_37 - var_1_19)) <= var_1_52) ? (var_1_35 == ((unsigned char) (var_1_12 + var_1_38))) : (var_1_35 == ((unsigned char) (var_1_11 - var_1_12)))) : ((var_1_14 > (- var_1_15)) ? (var_1_35 == ((unsigned char) (var_1_11 - (max ((10 + 16) , 5))))) : (var_1_35 == ((unsigned char) var_1_36))))))) && (var_1_32 ? (var_1_39 == ((signed short int) ((var_1_8 - var_1_9) + var_1_36))) : 1)) && ((var_1_48 != var_1_38) ? (var_1_41 == ((signed char) (min (1 , var_1_42)))) : 1)) && (((var_1_38 + (min (32 , var_1_12))) >= var_1_48) ? (var_1_43 == ((signed char) (max (var_1_42 , 5)))) : (var_1_43 == ((signed char) -2)))) && ((var_1_15 == (- (- var_1_52))) ? ((! var_1_34) ? (var_1_44 == ((signed char) var_1_42)) : ((var_1_29 <= var_1_8) ? (var_1_44 == ((signed char) (max (var_1_42 , (min (var_1_46 , var_1_47)))))) : (var_1_44 == ((signed char) -10)))) : 1)) && ((((last_1_var_1_21 * var_1_15) * var_1_24) < last_1_var_1_25) ? (var_1_48 == ((unsigned long int) var_1_12)) : ((((- var_1_18) * var_1_19) > last_1_var_1_13) ? (var_1_48 == ((unsigned long int) ((var_1_8 + var_1_7) + var_1_50))) : (var_1_48 == ((unsigned long int) (var_1_51 - (min (var_1_11 , var_1_50)))))))) && (((16 & (var_1_7 + var_1_36)) != (var_1_38 / (abs (var_1_10)))) ? (var_1_52 == ((double) (min (var_1_15 , (max (var_1_22 , var_1_53)))))) : ((var_1_37 >= (100.4 + (var_1_19 - var_1_18))) ? (var_1_52 == ((double) (var_1_20 - (var_1_23 + var_1_22)))) : (var_1_52 == ((double) (max ((var_1_20 - (max (var_1_22 , var_1_54))) , var_1_18))))))) && ((! ((var_1_29 ^ var_1_48) > var_1_48)) ? ((((var_1_11 - var_1_38) / var_1_10) >= var_1_48) ? (var_1_32 ? ((! (var_1_42 != var_1_47)) ? (var_1_55 == ((unsigned short int) (max (var_1_6 , (var_1_11 + var_1_12))))) : 1) : (var_1_55 == ((unsigned short int) (max ((var_1_56 - var_1_36) , (32989 - (var_1_6 + 4))))))) : ((((100 + var_1_57) - var_1_12) == (var_1_29 + var_1_48)) ? (var_1_55 == ((unsigned short int) ((min (2 , (256 + 1))) + var_1_11))) : ((var_1_20 <= (- var_1_31)) ? (var_1_55 == ((unsigned short int) (max (var_1_12 , var_1_36)))) : 1))) : 1)) && (var_1_32 ? ((((max (var_1_48 , var_1_29)) / 1) > (var_1_35 + (min (var_1_26 , var_1_3)))) ? (var_1_32 ? (var_1_58 == ((unsigned char) ((var_1_57 - var_1_59) + 4))) : (var_1_58 == ((unsigned char) (var_1_38 + var_1_57)))) : (var_1_58 == ((unsigned char) ((var_1_57 + (var_1_60 - var_1_61)) - var_1_59)))) : (var_1_58 == ((unsigned char) var_1_38)))) && ((256 < var_1_29) ? (((var_1_9 - (var_1_61 + var_1_57)) >= var_1_58) ? (var_1_62 == ((signed char) (max (var_1_47 , var_1_61)))) : 1) : (var_1_62 == ((signed char) var_1_46)))
;
}
int main(void) {
	isInitial = 1;
