...
void step(void) {
 if ((*(var_1_2_Pointer))) {
  (*(var_1_1_Pointer)) = (((((*(var_1_3_Pointer))) > (100)) ? ((*(var_1_3_Pointer))) : (100)));
 } else {
  (*(var_1_1_Pointer)) = (((((((*(var_1_4_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_5_Pointer))))) - 32) + 10);
 }
 ...
 if ((*(var_1_1_Pointer)) <= stepLocal_1) {
  if (stepLocal_0 >= (*(var_1_3_Pointer))) {
   (*(var_1_6_Pointer)) = ((((((((((*(var_1_7_Pointer)) - (*(var_1_5_Pointer)))) < ((*(var_1_4_Pointer)))) ? (((*(var_1_7_Pointer)) - (*(var_1_5_Pointer)))) : ((*(var_1_4_Pointer)))))) < ((((((*(var_1_3_Pointer))) < ((*(var_1_8_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_8_Pointer))))))) ? (((((((*(var_1_7_Pointer)) - (*(var_1_5_Pointer)))) < ((*(var_1_4_Pointer)))) ? (((*(var_1_7_Pointer)) - (*(var_1_5_Pointer)))) : ((*(var_1_4_Pointer)))))) : ((((((*(var_1_3_Pointer))) < ((*(var_1_8_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_8_Pointer))))))));
  }
 } else {
  (*(var_1_6_Pointer)) = (*(var_1_3_Pointer));
 }
 if ((*(var_1_8_Pointer)) <= (((((*(var_1_6_Pointer))) < 0 ) ? -((*(var_1_6_Pointer))) : ((*(var_1_6_Pointer)))))) {
  (*(var_1_9_Pointer)) = (10 - (*(var_1_10_Pointer)));
 } else {
  if (! (*(var_1_2_Pointer))) {
   (*(var_1_9_Pointer)) = ((*(var_1_11_Pointer)) + (((((*(var_1_12_Pointer))) < ((*(var_1_13_Pointer)))) ? ((*(var_1_12_Pointer))) : ((*(var_1_13_Pointer))))));
  } else {
   if ((*(var_1_2_Pointer))) {
    (*(var_1_9_Pointer)) = 64;
   } else {
...
int property(void) {
 return (((*(var_1_2_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (((((*(var_1_3_Pointer))) > (100)) ? ((*(var_1_3_Pointer))) : (100))))) : ((*(var_1_1_Pointer)) == ((unsigned short int) (((((((*(var_1_4_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_5_Pointer))))) - 32) + 10)))) && (((*(var_1_1_Pointer)) <= (*(var_1_3_Pointer))) ? (((*(var_1_1_Pointer)) >= (*(var_1_3_Pointer))) ? ((*(var_1_6_Pointer)) == ((unsigned short int) ((((((((((*(var_1_7_Pointer)) - (*(var_1_5_Pointer)))) < ((*(var_1_4_Pointer)))) ? (((*(var_1_7_Pointer)) - (*(var_1_5_Pointer)))) : ((*(var_1_4_Pointer)))))) < ((((((*(var_1_3_Pointer))) < ((*(var_1_8_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_8_Pointer))))))) ? (((((((*(var_1_7_Pointer)) - (*(var_1_5_Pointer)))) < ((*(var_1_4_Pointer)))) ? (((*(var_1_7_Pointer)) - (*(var_1_5_Pointer)))) : ((*(var_1_4_Pointer)))))) : ((((((*(var_1_3_Pointer))) < ((*(var_1_8_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_8_Pointer)))))))))) : 1) : ((*(var_1_6_Pointer)) == ((unsigned short int) (*(var_1_3_Pointer)))))) && (((*(var_1_8_Pointer)) <= (((((*(var_1_6_Pointer))) < 0 ) ? -((*(var_1_6_Pointer))) : ((*(var_1_6_Pointer)))))) ? ((*(var_1_9_Pointer)) == ((signed char) (10 - (*(var_1_10_Pointer))))) : ((! (*(var_1_2_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed char) ((*(var_1_11_Pointer)) + (((((*(var_1_12_Pointer))) < ((*(var_1_13_Pointer)))) ? ((*(var_1_12_Pointer))) : ((*(var_1_13_Pointer)))))))) : ((*(var_1_2_Pointer)) ? ((*(var_1_9_Pointer)) == ((signed char) 64)) : ((*(var_1_9_Pointer)) == ((signed char) (*(var_1_11_Pointer)))))))
;
}
int main(void) {
 isInitial = 1;
