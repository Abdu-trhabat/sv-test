...
void step(void) {
	...
	if (stepLocal_14 < last_1_var_1_49) {
		if (stepLocal_13 == ((max (51166 , var_1_24)) - (max (var_1_25 , 0)))) {
			var_1_54 = ((var_1_55 && var_1_56) && (var_1_57 && (last_1_var_1_63 || var_1_58)));
		} else {
			var_1_54 = (! (var_1_57 && var_1_55));
		}
	} else {
		if (! (var_1_5 > (abs (var_1_23)))) {
			if (last_1_var_1_63) {
				if ((min (last_1_var_1_17 , last_1_var_1_10)) >= last_1_var_1_17) {
	...
	// From: Req4Batch110Amount250
	signed long int stepLocal_2 = var_1_6 * (var_1_7 - var_1_8);
	if (last_1_var_1_64 >= stepLocal_2) {
		var_1_17 = (var_1_14 + (max (499.5 , var_1_15)));
	}


	// From: Req23Batch110Amount250
	if (var_1_54) {
		var_1_64 = var_1_24;
	}


	// From: Req5Batch110Amount250
	if (var_1_15 > var_1_16) {
		var_1_18 = (var_1_12 - (var_1_14 + var_1_13));
	}


	// From: Req6Batch110Amount250
	var_1_19 = var_1_6;


	// From: Req9Batch110Amount250
	if (var_1_17 > (50.15 + var_1_12)) {
		var_1_27 = ((var_1_8 + var_1_7) + (max (var_1_23 , (var_1_28 - var_1_29))));
	}


	// From: Req18Batch110Amount250
	var_1_52 = ((max (var_1_29 , 8)) + (var_1_23 + 32));


	// From: Req22Batch110Amount250
	var_1_63 = var_1_60;


	// From: Req24Batch110Amount250
	var_1_65 = var_1_8;


	// From: Req25Batch110Amount250
	if (var_1_57) {
		var_1_66 = var_1_51;
	} else {
		var_1_66 = var_1_5;
	...
	// From: Req26Batch110Amount250
	var_1_67 = (var_1_35 - var_1_8);


	// From: Req28Batch110Amount250
	var_1_70 = var_1_6;


	// From: Req15Batch110Amount250
	...
	if (stepLocal_10 || var_1_63) {
		if (stepLocal_8 && ((max (var_1_14 , var_1_15)) < var_1_18)) {
			if (var_1_28 < stepLocal_7) {
				var_1_41 = (min (var_1_4 , (min (var_1_29 , var_1_7))));
			} else {
				var_1_41 = ((var_1_35 - (var_1_43 - var_1_19)) + var_1_28);
			}
		} else {
			var_1_41 = (max (((var_1_37 - var_1_35) - 8) , var_1_19));
		}
	} else {
		if (stepLocal_9 < var_1_37) {
			var_1_41 = (max (var_1_6 , var_1_44));
		}
	}


	// From: Req8Batch110Amount250
	if (var_1_54) {
		if ((var_1_7 - (var_1_8 + var_1_23)) < (2 * var_1_66)) {
			if (var_1_3 > var_1_66) {
				var_1_22 = (var_1_24 - ((max (var_1_25 , var_1_26)) - var_1_7));
			} else {
				var_1_22 = var_1_7;
			}
		} else {
			var_1_22 = (abs (var_1_7));
		}
	}


	// From: Req11Batch110Amount250
	if (var_1_63) {
		var_1_32 = last_1_var_1_32;
	} else {
		var_1_32 = (var_1_24 + (max (var_1_28 , var_1_8)));
	}


	// From: Req16Batch110Amount250
	if (4.5 > (min (var_1_18 , var_1_16))) {
		var_1_45 = ((2028031234u + var_1_46) - var_1_26);
	} else {
		var_1_45 = ((max (var_1_47 , var_1_48)) - (abs (var_1_32)));
	}


	// From: Req2Batch110Amount250
	...
	// From: Req27Batch110Amount250
	if ((max (var_1_61 , var_1_18)) == (- var_1_16)) {
		var_1_68 = var_1_29;
	}


	// From: Req1Batch110Amount250
	...
	// From: Req14Batch110Amount250
	unsigned long int stepLocal_6 = max (var_1_23 , (var_1_39 - var_1_68));
	if (((~ var_1_32) & 25) > stepLocal_6) {
		var_1_38 = ((max (var_1_40 , var_1_7)) + (max (var_1_68 , var_1_66)));
	} else {
		var_1_38 = (abs (max (var_1_28 , var_1_35)));
	}


	// From: Req7Batch110Amount250
	signed char stepLocal_4 = var_1_5;
	signed long int stepLocal_3 = 200 - var_1_7;
	if (var_1_6 >= stepLocal_4) {
		if (stepLocal_3 <= var_1_4) {
			var_1_20 = ((max ((var_1_8 - var_1_7) , var_1_21)) + (var_1_38 + var_1_4));
		} else {
	...
	// From: Req12Batch110Amount250
	if ((var_1_8 < -128) && var_1_63) {
		var_1_33 = var_1_28;
	} else {
		if (var_1_19 <= var_1_20) {
			var_1_33 = (var_1_29 + (abs (var_1_7 + 5)));
		} else {
	...
	if (stepLocal_11 == (var_1_8 - var_1_40)) {
		if ((var_1_44 / (abs (32))) > stepLocal_12) {
			var_1_49 = (var_1_51 - var_1_26);
		} else {
			var_1_49 = (10000000 - (min (var_1_33 , var_1_23)));
		}
	} else {
		var_1_49 = ((abs (last_1_var_1_49)) + var_1_24);
	}


	// From: Req10Batch110Amount250
	if (var_1_63 && (var_1_13 < var_1_10)) {
		if (var_1_63) {
			var_1_30 = (max (var_1_29 , var_1_20));
		} else {
...
int property(void) {
	return ((((((((((((((((((((((((((((8 < (var_1_9 % var_1_3)) ? (var_1_1 == ((signed char) ((max ((var_1_4 + 16) , var_1_5)) + (var_1_6 + (var_1_7 - var_1_8))))) : (var_1_1 == ((signed char) (max (var_1_4 , var_1_5))))) && ((var_1_41 < (var_1_3 | -10)) ? (var_1_9 == ((signed long int) var_1_8)) : 1)) && ((var_1_19 != var_1_4) ? ((var_1_63 && (var_1_3 > (var_1_9 ^ var_1_66))) ? (var_1_10 == ((float) ((min (var_1_12 , (var_1_13 + var_1_14))) - (var_1_15 + var_1_16)))) : (var_1_10 == ((float) (var_1_16 + var_1_13)))) : (var_1_10 == ((float) var_1_14)))) && ((last_1_var_1_64 >= (var_1_6 * (var_1_7 - var_1_8))) ? (var_1_17 == ((double) (var_1_14 + (max (499.5 , var_1_15))))) : 1)) && ((var_1_15 > var_1_16) ? (var_1_18 == ((double) (var_1_12 - (var_1_14 + var_1_13)))) : 1)) && (var_1_19 == ((signed short int) var_1_6))) && ((var_1_6 >= var_1_5) ? (((200 - var_1_7) <= var_1_4) ? (var_1_20 == ((signed long int) ((max ((var_1_8 - var_1_7) , var_1_21)) + (var_1_38 + var_1_4)))) : (var_1_20 == ((signed long int) (var_1_7 + var_1_32)))) : 1)) && (var_1_54 ? (((var_1_7 - (var_1_8 + var_1_23)) < (2 * var_1_66)) ? ((var_1_3 > var_1_66) ? (var_1_22 == ((unsigned short int) (var_1_24 - ((max (var_1_25 , var_1_26)) - var_1_7)))) : (var_1_22 == ((unsigned short int) var_1_7))) : (var_1_22 == ((unsigned short int) (abs (var_1_7))))) : 1)) && ((var_1_17 > (50.15 + var_1_12)) ? (var_1_27 == ((unsigned char) ((var_1_8 + var_1_7) + (max (var_1_23 , (var_1_28 - var_1_29)))))) : 1)) && ((var_1_63 && (var_1_13 < var_1_10)) ? (var_1_63 ? (var_1_30 == ((unsigned short int) (max (var_1_29 , var_1_20)))) : ((var_1_17 > var_1_10) ? (var_1_30 == ((unsigned short int) var_1_8)) : (var_1_30 == ((unsigned short int) (var_1_23 + 4))))) : 1)) && (var_1_63 ? (var_1_32 == ((unsigned long int) last_1_var_1_32)) : (var_1_32 == ((unsigned long int) (var_1_24 + (max (var_1_28 , var_1_8))))))) && (((var_1_8 < -128) && var_1_63) ? (var_1_33 == ((unsigned char) var_1_28)) : ((var_1_19 <= var_1_20) ? (var_1_33 == ((unsigned char) (var_1_29 + (abs (var_1_7 + 5))))) : (var_1_33 == ((unsigned char) (var_1_35 - var_1_28)))))) && ((var_1_5 < var_1_49) ? (var_1_36 == ((signed short int) ((var_1_37 - var_1_7) - var_1_28))) : 1)) && ((((~ var_1_32) & 25) > (max (var_1_23 , (var_1_39 - var_1_68)))) ? (var_1_38 == ((unsigned long int) ((max (var_1_40 , var_1_7)) + (max (var_1_68 , var_1_66))))) : (var_1_38 == ((unsigned long int) (abs (max (var_1_28 , var_1_35))))))) && ((var_1_54 || var_1_63) ? ((var_1_63 && ((max (var_1_14 , var_1_15)) < var_1_18)) ? ((var_1_28 < var_1_35) ? (var_1_41 == ((signed short int) (min (var_1_4 , (min (var_1_29 , var_1_7)))))) : (var_1_41 == ((signed short int) ((var_1_35 - (var_1_43 - var_1_19)) + var_1_28)))) : (var_1_41 == ((signed short int) (max (((var_1_37 - var_1_35) - 8) , var_1_19))))) : ((var_1_26 < var_1_37) ? (var_1_41 == ((signed short int) (max (var_1_6 , var_1_44)))) : 1))) && ((4.5 > (min (var_1_18 , var_1_16))) ? (var_1_45 == ((unsigned long int) ((2028031234u + var_1_46) - var_1_26))) : (var_1_45 == ((unsigned long int) ((max (var_1_47 , var_1_48)) - (abs (var_1_32))))))) && ((((var_1_37 / var_1_3) / var_1_28) == (var_1_8 - var_1_40)) ? (((var_1_44 / (abs (32))) > (var_1_19 & var_1_32)) ? (var_1_49 == ((signed long int) (var_1_51 - var_1_26))) : (var_1_49 == ((signed long int) (10000000 - (min (var_1_33 , var_1_23)))))) : (var_1_49 == ((signed long int) ((abs (last_1_var_1_49)) + var_1_24))))) && (var_1_52 == ((unsigned char) ((max (var_1_29 , 8)) + (var_1_23 + 32))))) && (var_1_54 ? (var_1_53 == ((float) 2.5f)) : ((((var_1_39 - var_1_67) <= (var_1_48 - 100u)) && ((var_1_61 + var_1_14) == (var_1_15 - var_1_16))) ? (var_1_53 == ((float) (max (var_1_15 , var_1_13)))) : (var_1_53 == ((float) var_1_13))))) && (((last_1_var_1_38 / var_1_26) < last_1_var_1_49) ? ((var_1_26 == ((max (51166 , var_1_24)) - (max (var_1_25 , 0)))) ? (var_1_54 == ((unsigned char) ((var_1_55 && var_1_56) && (var_1_57 && (last_1_var_1_63 || var_1_58))))) : (var_1_54 == ((unsigned char) (! (var_1_57 && var_1_55))))) : ((! (var_1_5 > (abs (var_1_23)))) ? (last_1_var_1_63 ? (((min (last_1_var_1_17 , last_1_var_1_10)) >= last_1_var_1_17) ? (var_1_54 == ((unsigned char) (last_1_var_1_63 || (var_1_56 && var_1_55)))) : 1) : (var_1_54 == ((unsigned char) (! (var_1_57 && (last_1_var_1_63 || var_1_56)))))) : (var_1_54 == ((unsigned char) (var_1_55 && (var_1_58 && var_1_60))))))) && (((var_1_17 + var_1_13) <= (var_1_17 * var_1_12)) ? (((var_1_45 % var_1_26) > (var_1_40 * var_1_50)) ? (var_1_61 == ((float) var_1_14)) : 1) : (var_1_61 == ((float) var_1_62)))) && (var_1_63 == ((unsigned char) var_1_60))) && (var_1_54 ? (var_1_64 == ((signed long int) var_1_24)) : 1)) && (var_1_65 == ((signed char) var_1_8))) && (var_1_57 ? (var_1_66 == ((signed long int) var_1_51)) : (var_1_66 == ((signed long int) var_1_5)))) && (var_1_67 == ((unsigned char) (var_1_35 - var_1_8)))) && (((max (var_1_61 , var_1_18)) == (- var_1_16)) ? (var_1_68 == ((unsigned char) var_1_29)) : 1)) && (var_1_70 == ((signed char) var_1_6))
;
}
int main(void) {
	isInitial = 1;
