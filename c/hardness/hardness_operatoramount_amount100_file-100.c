...
void step(void) {
	...
	// From: Req3Batch100Amount100
	var_1_14 = ((min (128 , (min (var_1_15 , var_1_16)))) - var_1_17);


	// From: Req8Batch100Amount100
	if (var_1_18) {
	...
	// From: Req9Batch100Amount100
	if (var_1_10 >= (var_1_11 + -0.6)) {
		var_1_25 = (var_1_13 - var_1_11);
	}


	// From: Req12Batch100Amount100
	...
	// From: Req13Batch100Amount100
	var_1_32 = var_1_11;


	// From: Req14Batch100Amount100
	var_1_33 = var_1_24;


	// From: Req6Batch100Amount100
