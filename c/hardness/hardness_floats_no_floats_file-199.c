...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch199no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch199no_floats
	if (var_1_2) {
		var_1_1 = ((max ((abs (var_1_3)) , var_1_4)) - 2);
	} else {
		var_1_1 = (var_1_5 + var_1_6);
	}


	// From: Req3Batch199no_floats
	var_1_12 = (min (var_1_13 , (var_1_14 + 5)));


	// From: Req4Batch199no_floats
...
int property(void) {
	return (((var_1_2 ? (var_1_1 == ((signed long int) ((max ((abs (var_1_3)) , var_1_4)) - 2))) : (var_1_1 == ((signed long int) (var_1_5 + var_1_6)))) && ((((var_1_8 - 8) + var_1_12) < -500) ? ((var_1_12 <= var_1_8) ? (((! var_1_2) && var_1_10) ? (var_1_7 == ((signed char) var_1_11)) : 1) : (var_1_7 == ((signed char) var_1_11))) : (var_1_7 == ((signed char) var_1_11)))) && (var_1_12 == ((unsigned short int) (min (var_1_13 , (var_1_14 + 5)))))) && ((-500 > (max ((var_1_13 - var_1_8) , (var_1_12 - var_1_9)))) ? (((var_1_10 || var_1_2) && var_1_16) ? (var_1_15 == ((unsigned short int) var_1_14)) : (var_1_15 == ((unsigned short int) var_1_13))) : (var_1_15 == ((unsigned short int) var_1_13)))
;
}
int main(void) {
	isInitial = 1;
