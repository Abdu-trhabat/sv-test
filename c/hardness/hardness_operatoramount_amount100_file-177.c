...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch177Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch177Amount100
	if ((2.8 / var_1_17) < (8.5 - (var_1_5 + var_1_6))) {
		var_1_16 = var_1_18;
	}


	// From: Req11Batch177Amount100
	var_1_38 = var_1_24;


	// From: Req9Batch177Amount100
