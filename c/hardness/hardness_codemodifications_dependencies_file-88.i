...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch88dependencies.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((- var_1_18) > (500 / ((((var_1_19) < (var_1_20)) ? (var_1_19) : (var_1_20))))) {
  var_1_17 = ((((var_1_21) > (var_1_22)) ? (var_1_21) : (var_1_22)));
 }
...
int property(void) {
 return ((((((64.5f <= last_1_var_1_16) ? (last_1_var_1_8 ? ((last_1_var_1_16 == last_1_var_1_15) ? (var_1_1 == ((double) (var_1_5 + ((((((((var_1_6) > (var_1_7)) ? (var_1_6) : (var_1_7)))) < (50.25)) ? (((((var_1_6) > (var_1_7)) ? (var_1_6) : (var_1_7)))) : (50.25)))))) : (var_1_1 == ((double) var_1_7))) : (var_1_1 == ((double) var_1_5))) : 1) && ((var_1_1 > ((var_1_15 * var_1_5) + 5.3)) ? (((var_1_7 + var_1_15) < var_1_6) ? (var_1_8 == ((unsigned char) var_1_9)) : (var_1_8 == ((unsigned char) var_1_10))) : (var_1_8 == ((unsigned char) var_1_11)))) && ((((- var_1_15) / 24.75) < var_1_6) ? ((var_1_7 >= var_1_15) ? (var_1_12 == ((signed char) var_1_13)) : (var_1_12 == ((signed char) var_1_14))) : 1)) && ((var_1_5 < var_1_7) ? ((last_1_var_1_15 <= (- 8.5)) ? (var_1_15 == ((double) (var_1_5 + var_1_7))) : (var_1_15 == ((double) var_1_5))) : (var_1_15 == ((double) var_1_6)))) && ((var_1_5 < var_1_15) ? ((! var_1_10) ? (var_1_16 == ((float) var_1_6)) : 1) : 1)) && (((- var_1_18) > (500 / ((((var_1_19) < (var_1_20)) ? (var_1_19) : (var_1_20))))) ? (var_1_17 == ((unsigned short int) ((((var_1_21) > (var_1_22)) ? (var_1_21) : (var_1_22))))) : 1)
;
}
int main(void) {
 isInitial = 1;
