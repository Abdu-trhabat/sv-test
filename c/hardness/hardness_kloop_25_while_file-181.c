...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch18125_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch18125_while
	if (var_1_5 > (8.5 - (var_1_10 - var_1_11))) {
		var_1_9 = var_1_12;
	}


	// From: Req4Batch18125_while
