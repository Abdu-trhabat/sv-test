...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch150stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((var_1_13 + 200) & var_1_14) != stepLocal_0) {
  var_1_12 = var_1_14;
 }
 ...
 if ((- var_1_6) > var_1_3) {
  if (stepLocal_1 > ((var_1_13 * var_1_12) * (var_1_21 - var_1_14))) {
   if (var_1_11) {
    var_1_19 = var_1_22;
   } else {
    var_1_19 = 128;
 ...
 signed long int stepLocal_2 = var_1_25 ^ (var_1_14 % 1);
