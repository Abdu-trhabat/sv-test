...
void step(void) {
	...
	// From: Req4Batch161no_floats
	var_1_19 = 128;


	// From: Req5Batch161no_floats
	var_1_20 = var_1_4;


	// From: Req1Batch161no_floats
...
int property(void) {
	return ((((((var_1_14 + (var_1_4 - var_1_5)) > (var_1_6 - var_1_7)) ? (((var_1_8 + var_1_9) <= var_1_10) ? (var_1_1 == ((signed long int) (var_1_11 + (var_1_12 - var_1_13)))) : 1) : 1) && ((256 <= (- (var_1_13 * var_1_9))) ? (var_1_14 == ((unsigned long int) var_1_5)) : (var_1_14 == ((unsigned long int) (var_1_5 + (abs (var_1_7))))))) && (((var_1_16 - (var_1_5 + var_1_17)) != (64u | var_1_14)) ? (var_1_15 == ((signed short int) (abs (var_1_5 - var_1_18)))) : (var_1_15 == ((signed short int) var_1_14)))) && (var_1_19 == ((signed long int) 128))) && (var_1_20 == ((signed short int) var_1_4))
;
}
int main(void) {
	isInitial = 1;
