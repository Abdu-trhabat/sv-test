...
void step(void) {
 ...
 if (var_1_2 == stepLocal_0) {
  if (stepLocal_1 > (((((- var_1_3)) > (var_1_4)) ? ((- var_1_3)) : (var_1_4)))) {
 ...
 var_1_14 = var_1_13;
 if (var_1_6) {
  var_1_5 = (var_1_14 + ((((((((var_1_1) < (var_1_13)) ? (var_1_1) : (var_1_13)))) > (last_1_var_1_5)) ? (((((var_1_1) < (var_1_13)) ? (var_1_1) : (var_1_13)))) : (last_1_var_1_5))));
 }
...
int property(void) {
 return (((((var_1_2 == var_1_3) ? ((var_1_2 > (((((- var_1_3)) > (var_1_4)) ? ((- var_1_3)) : (var_1_4)))) ? (((var_1_2 * (var_1_4 * -5)) > var_1_3) ? (var_1_1 == ((signed short int) var_1_3)) : 1) : (var_1_1 == ((signed short int) var_1_2))) : (var_1_1 == ((signed short int) var_1_4))) && (var_1_6 ? (var_1_5 == ((signed long int) (var_1_14 + ((((((((var_1_1) < (var_1_13)) ? (var_1_1) : (var_1_13)))) > (last_1_var_1_5)) ? (((((var_1_1) < (var_1_13)) ? (var_1_1) : (var_1_13)))) : (last_1_var_1_5)))))) : 1)) && ((var_1_13 > 64) ? (var_1_7 == ((double) (var_1_8 - var_1_9))) : ((16u == (var_1_13 / var_1_10)) ? (var_1_7 == ((double) (var_1_11 + var_1_12))) : (var_1_7 == ((double) var_1_11))))) && (var_1_13 == ((signed short int) 4))) && (var_1_14 == ((signed short int) var_1_13))
;
}
int main(void) {
 isInitial = 1;
