...
void step(void) {
	...
	// From: Req15Batch131Amount250
	signed long int stepLocal_10 = (var_1_6 - var_1_36) / (min (var_1_8 , var_1_41));
	...
	// From: Req7Batch131Amount250
	if (last_1_var_1_20 && last_1_var_1_11) {
		if (last_1_var_1_15 > (min (last_1_var_1_40 , (last_1_var_1_56 & var_1_6)))) {
			if (last_1_var_1_24) {
				var_1_20 = (! var_1_14);
			} else {
				var_1_20 = var_1_13;
	...
	// From: Req17Batch131Amount250
	if ((max (var_1_25 , last_1_var_1_56)) > last_1_var_1_15) {
	...
	// From: Req9Batch131Amount250
	if ((var_1_47 / var_1_26) < (var_1_18 - var_1_17)) {
		if (var_1_47 < (max (var_1_17 , (var_1_19 - var_1_18)))) {
			if (((var_1_23 * var_1_2) % (min (1u , 256u))) >= var_1_7) {
	...
	if (stepLocal_9 && (var_1_30 <= var_1_56)) {
		if ((max ((- var_1_8) , (var_1_22 / 100))) >= stepLocal_8) {
			var_1_39 = var_1_17;
		} else {
			var_1_39 = (var_1_19 - var_1_17);
		}
	} else {
		var_1_39 = (max (var_1_18 , var_1_17));
	}


	// From: Req1Batch131Amount250
	var_1_1 = (abs (var_1_2));


	// From: Req3Batch131Amount250
	...
	// From: Req6Batch131Amount250
	signed long int stepLocal_4 = - var_1_10;
	if (var_1_8 < stepLocal_4) {
		var_1_16 = ((min (var_1_17 , var_1_18)) - ((abs (-8.320171373278239E18)) - var_1_19));
	} else {
		var_1_16 = (abs (var_1_17));
	}


	// From: Req11Batch131Amount250
	signed long int stepLocal_7 = min (var_1_30 , var_1_2);
	unsigned long int stepLocal_6 = var_1_15;
	if (stepLocal_7 >= var_1_56) {
		if (var_1_16 <= (max (var_1_18 , var_1_19))) {
			var_1_33 = (var_1_35 + (min (25 , (var_1_36 - var_1_37))));
		}
	} else {
		if (stepLocal_6 <= (max (-2 , var_1_3))) {
			var_1_33 = var_1_37;
		} else {
			var_1_33 = var_1_35;
		}
	...
	// From: Req19Batch131Amount250
	signed long int stepLocal_12 = max (var_1_5 , var_1_41);
	if (var_1_11) {
		if (var_1_3 >= stepLocal_12) {
			var_1_51 = var_1_35;
		} else {
			var_1_51 = ((min ((var_1_36 - var_1_37) , var_1_35)) + (min (var_1_52 , var_1_53)));
		}
	} else {
		if (var_1_43) {
			var_1_51 = ((min ((max (var_1_37 , var_1_36)) , var_1_54)) - var_1_55);
		}
	}


	// From: Req13Batch131Amount250
	if (var_1_31 > var_1_56) {
		if (! ((var_1_31 > var_1_32) || var_1_14)) {
			...
			if (! var_1_20) {
				if (var_1_35 >= 10) {
					var_1_40 = ((min ((var_1_6 + var_1_36) , (var_1_22 + var_1_9))) + var_1_32);
				} else {
					if (var_1_11) {
						var_1_40 = (min (var_1_32 , var_1_5));
					}
				}
			} else {
				if (var_1_14) {
					...
					var_1_40 = (min (var_1_2 , var_1_8));
				}
			}
		}
	} else {
		var_1_40 = (min ((var_1_41 - var_1_6) , (min (var_1_37 , var_1_32))));
	}


	// From: Req8Batch131Amount250
	unsigned long int stepLocal_5 = var_1_1 & (var_1_5 & var_1_56);
	if (((var_1_6 << var_1_9) / (min (64 , var_1_8))) > stepLocal_5) {
	...
	// From: Req10Batch131Amount250
	if ((min ((var_1_8 * var_1_3) , var_1_9)) <= var_1_21) {
		if ((var_1_6 * var_1_25) < 1u) {
			if (var_1_56 < (var_1_25 - var_1_2)) {
				var_1_29 = (var_1_9 + (max (var_1_2 , (var_1_5 - var_1_7))));
			} else {
		...
		if (var_1_11 || ((var_1_31 - var_1_32) <= (var_1_23 * var_1_56))) {
			...
			var_1_29 = (min (var_1_7 , (min (var_1_21 , var_1_30))));
		}
	}


	// From: Req21Batch131Amount250
...
int property(void) {
	return ((((((((((((((((((((var_1_1 == ((unsigned short int) (abs (var_1_2)))) && (((last_1_var_1_15 == var_1_2) || last_1_var_1_42) ? (var_1_3 == ((unsigned short int) ((var_1_5 + var_1_6) + (max (var_1_7 , (var_1_8 - var_1_9)))))) : 1)) && (((var_1_9 * var_1_2) >= (var_1_6 << var_1_5)) ? (var_1_10 == ((signed long int) (min (var_1_2 , var_1_5)))) : 1)) && (last_1_var_1_42 ? (last_1_var_1_57 ? (var_1_11 == ((unsigned char) (! var_1_13))) : (var_1_11 == ((unsigned char) ((! var_1_13) && var_1_14)))) : (var_1_11 == ((unsigned char) var_1_13)))) && ((((var_1_6 + 25) / var_1_8) < (100000 << var_1_9)) ? (((var_1_6 * (var_1_5 * var_1_3)) > var_1_7) ? (var_1_15 == ((unsigned long int) var_1_9)) : (var_1_15 == ((unsigned long int) var_1_6))) : (var_1_15 == ((unsigned long int) 4u)))) && ((var_1_8 < (- var_1_10)) ? (var_1_16 == ((double) ((min (var_1_17 , var_1_18)) - ((abs (-8.320171373278239E18)) - var_1_19)))) : (var_1_16 == ((double) (abs (var_1_17)))))) && ((last_1_var_1_20 && last_1_var_1_11) ? ((last_1_var_1_15 > (min (last_1_var_1_40 , (last_1_var_1_56 & var_1_6)))) ? (last_1_var_1_24 ? (var_1_20 == ((unsigned char) (! var_1_14))) : (var_1_20 == ((unsigned char) var_1_13))) : 1) : 1)) && ((((var_1_6 << var_1_9) / (min (64 , var_1_8))) > (var_1_1 & (var_1_5 & var_1_56))) ? ((var_1_47 < var_1_17) ? (var_1_21 == ((signed short int) (((var_1_22 + var_1_23) - var_1_6) + -256))) : (var_1_21 == ((signed short int) var_1_9))) : 1)) && (((var_1_47 / var_1_26) < (var_1_18 - var_1_17)) ? ((var_1_47 < (max (var_1_17 , (var_1_19 - var_1_18)))) ? ((((var_1_23 * var_1_2) % (min (1u , 256u))) >= var_1_7) ? (var_1_24 == ((unsigned char) (var_1_14 || (var_1_27 || (! var_1_13))))) : (var_1_13 ? (var_1_24 == ((unsigned char) (! var_1_28))) : 1)) : (var_1_24 == ((unsigned char) var_1_27))) : 1)) && (((min ((var_1_8 * var_1_3) , var_1_9)) <= var_1_21) ? (((var_1_6 * var_1_25) < 1u) ? ((var_1_56 < (var_1_25 - var_1_2)) ? (var_1_29 == ((signed long int) (var_1_9 + (max (var_1_2 , (var_1_5 - var_1_7)))))) : (var_1_29 == ((signed long int) (var_1_30 - var_1_5)))) : (var_1_29 == ((signed long int) (var_1_2 + (var_1_7 - var_1_9))))) : ((var_1_11 || ((var_1_31 - var_1_32) <= (var_1_23 * var_1_56))) ? (var_1_29 == ((signed long int) var_1_3)) : (var_1_29 == ((signed long int) (min (var_1_7 , (min (var_1_21 , var_1_30))))))))) && (((min (var_1_30 , var_1_2)) >= var_1_56) ? ((var_1_16 <= (max (var_1_18 , var_1_19))) ? (var_1_33 == ((signed char) (var_1_35 + (min (25 , (var_1_36 - var_1_37)))))) : 1) : ((var_1_15 <= (max (-2 , var_1_3))) ? (var_1_33 == ((signed char) var_1_37)) : (var_1_33 == ((signed char) var_1_35))))) && ((((var_1_6 << var_1_25) > var_1_31) && (var_1_30 <= var_1_56)) ? (((max ((- var_1_8) , (var_1_22 / 100))) >= var_1_56) ? (var_1_39 == ((float) var_1_17)) : (var_1_39 == ((float) (var_1_19 - var_1_17)))) : (var_1_39 == ((float) (max (var_1_18 , var_1_17)))))) && ((var_1_31 > var_1_56) ? ((! ((var_1_31 > var_1_32) || var_1_14)) ? ((var_1_47 >= var_1_19) ? (var_1_40 == ((unsigned short int) var_1_2)) : 1) : ((! var_1_20) ? ((var_1_35 >= 10) ? (var_1_40 == ((unsigned short int) ((min ((var_1_6 + var_1_36) , (var_1_22 + var_1_9))) + var_1_32))) : (var_1_11 ? (var_1_40 == ((unsigned short int) (min (var_1_32 , var_1_5)))) : 1)) : (var_1_14 ? (var_1_40 == ((unsigned short int) (var_1_41 - var_1_36))) : (var_1_40 == ((unsigned short int) (min (var_1_2 , var_1_8))))))) : (var_1_40 == ((unsigned short int) (min ((var_1_41 - var_1_6) , (min (var_1_37 , var_1_32)))))))) && ((! (var_1_37 > var_1_8)) ? ((var_1_37 >= 2) ? (var_1_42 == ((unsigned char) var_1_14)) : 1) : 1)) && ((last_1_var_1_44 < ((var_1_6 - var_1_36) / (min (var_1_8 , var_1_41)))) ? (var_1_43 == ((unsigned char) ((last_1_var_1_39 == var_1_18) || var_1_28))) : (var_1_43 == ((unsigned char) (var_1_14 || var_1_27))))) && ((var_1_42 && var_1_57) ? (var_1_44 == ((unsigned long int) ((var_1_45 - (var_1_46 - var_1_6)) - var_1_36))) : 1)) && (((max (var_1_25 , last_1_var_1_56)) > last_1_var_1_15) ? ((last_1_var_1_43 || last_1_var_1_20) ? (var_1_47 == ((double) (var_1_19 + 31.4))) : 1) : (var_1_47 == ((double) var_1_17)))) && ((! var_1_24) ? (var_1_50 == ((unsigned short int) var_1_6)) : (var_1_50 == ((unsigned short int) (51585 - var_1_7))))) && (var_1_11 ? ((var_1_3 >= (max (var_1_5 , var_1_41))) ? (var_1_51 == ((signed char) var_1_35)) : (var_1_51 == ((signed char) ((min ((var_1_36 - var_1_37) , var_1_35)) + (min (var_1_52 , var_1_53)))))) : (var_1_43 ? (var_1_51 == ((signed char) ((min ((max (var_1_37 , var_1_36)) , var_1_54)) - var_1_55))) : 1))) && (var_1_28 ? (var_1_56 == ((unsigned long int) (max ((var_1_8 + var_1_32) , var_1_37)))) : ((last_1_var_1_56 < ((last_1_var_1_44 % var_1_45) >> 1u)) ? ((last_1_var_1_29 >= var_1_52) ? (var_1_56 == ((unsigned long int) var_1_7)) : 1) : 1))) && ((var_1_39 < var_1_16) ? (var_1_14 ? (((var_1_8 * var_1_30) >= var_1_29) ? (var_1_43 ? (var_1_57 == ((unsigned char) (last_1_var_1_57 && var_1_27))) : (var_1_57 == ((unsigned char) var_1_28))) : (var_1_57 == ((unsigned char) var_1_27))) : (var_1_57 == ((unsigned char) var_1_27))) : (var_1_57 == ((unsigned char) var_1_28)))
;
}
int main(void) {
	isInitial = 1;
