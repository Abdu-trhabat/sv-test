...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	/* 363L, 205L) */ if (/* 364L, 193L, 194L) */ ((var_1_35) <= (var_1_19))) {
		/* 367L, 204L) */ var_1_43 = (
			/* 370L, 203L) */ (abs (
				var_1_44
			))
