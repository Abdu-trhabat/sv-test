...
void step(void) {
	...
	// From: Req7Batch176Amount50
	var_1_27 = var_1_6;


	// From: Req2Batch176Amount50
	...
	// From: Req6Batch176Amount50
	if ((max (var_1_14 , var_1_21)) >= var_1_24) {
		var_1_26 = (var_1_7 - 8);
	}


	// From: Req1Batch176Amount50
