...
void step(void) {
	...
	// From: Req8Batch136100_while
	var_1_26 = ((var_1_27 && (last_1_var_1_26 || var_1_28)) && (! var_1_29));


	// From: Req10Batch136100_while
	...
	// From: Req12Batch136100_while
	var_1_35 = 1;


	// From: Req14Batch136100_while
	var_1_37 = 255.8;


	// From: Req2Batch136100_while
	...
	// From: Req11Batch136100_while
	if (var_1_8 >= var_1_7) {
		var_1_34 = var_1_10;
	}


	// From: Req13Batch136100_while
	var_1_36 = var_1_22;


	// From: Req1Batch136100_while
	if (var_1_8 < var_1_36) {
