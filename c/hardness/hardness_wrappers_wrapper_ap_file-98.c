...
void step(void) {
	...
	if ((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer)) < (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) {
		if (((- (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))) <= (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) || ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) < (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) {
			(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) = (min ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))));
		} else {
	...
	if ((min (-128 , (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)))) < (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer))) {
