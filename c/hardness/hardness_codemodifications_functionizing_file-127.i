...
void functionized1(signed long int localFunctionVar0) {
 if ((localFunctionVar0 + var_1_3) >= ((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5)))) {
  var_1_1 = var_1_3;
 } else {
  var_1_1 = -128;
 }
...
signed long int functionized4(unsigned char functionized4_localFunctionVar0) {
 return ((((functionized4_localFunctionVar0) < 0 ) ? -(functionized4_localFunctionVar0) : (functionized4_localFunctionVar0)));
}
signed long int functionized5(void) {
 return ((((var_1_3) > ((var_1_7 * var_1_14))) ? (var_1_3) : ((var_1_7 * var_1_14))));
}
unsigned char functionized6(signed long int functionized6_localFunctionVar0, unsigned char functionized6_localFunctionVar1) {
 return (((((var_1_3) > ((var_1_4 * functionized6_localFunctionVar0))) ? (var_1_3) : ((var_1_4 * functionized6_localFunctionVar0)))) != functionized6_localFunctionVar1);
}
void initially(void) {
}
void step(void) {
 ...
 if (var_1_12) {
  if (functionized5() <= ((((var_1_13) > (var_1_5)) ? (var_1_13) : (var_1_5)))) {
