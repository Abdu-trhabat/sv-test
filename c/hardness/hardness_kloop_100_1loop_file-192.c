...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch192100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch192100_1loop
	var_1_28 = ((abs (var_1_29)) - (abs (var_1_11)));


	// From: Req9Batch192100_1loop
	...
	// From: Req10Batch192100_1loop
	var_1_34 = (max ((var_1_6 - var_1_11) , var_1_7));


	// From: Req12Batch192100_1loop
	var_1_36 = var_1_31;


	// From: Req1Batch192100_1loop
