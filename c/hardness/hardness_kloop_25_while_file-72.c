...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch7225_while.c", 13, "reach_error"); }
...
int property(void) {
	return ((((var_1_3 < ((min (var_1_4 , var_1_2)) * var_1_5)) ? (var_1_1 == ((unsigned char) (var_1_6 && ((last_1_var_1_1 || var_1_8) && var_1_9)))) : 1) && (var_1_9 ? (var_1_10 == ((unsigned long int) 2u)) : 1)) && (var_1_11 == ((signed char) (min ((var_1_12 + var_1_13) , (10 - var_1_14)))))) && (((var_1_2 + (var_1_3 / var_1_16)) == var_1_5) ? ((var_1_3 >= var_1_4) ? (var_1_15 == ((double) (var_1_17 - (min ((var_1_18 + var_1_19) , 9.9999999999995E12))))) : (var_1_15 == ((double) var_1_17))) : 1)
;
}
int main(void) {
	isInitial = 1;
