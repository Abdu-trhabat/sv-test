...
void step(void) {
	...
	if (last_1_var_1_9 || stepLocal_23) {
		...
		var_1_58 = (min (((min (var_1_41 , var_1_60)) - var_1_56) , var_1_45));
	}


	// From: Req10Batch125Amount250
	...
	// From: Req9Batch125Amount250
	if (var_1_12) {
		var_1_40 = ((min (var_1_41 , (abs (3916741855u)))) - (max (var_1_37 , var_1_34)));
	} else {
		if (var_1_25 > var_1_23) {
			if (last_1_var_1_65 != last_1_var_1_46) {
				var_1_40 = (var_1_41 - var_1_7);
			} else {
				if ((max ((max (var_1_2 , var_1_30)) , last_1_var_1_58)) > var_1_17) {
					var_1_40 = (max (var_1_33 , (max (var_1_31 , (var_1_41 - last_1_var_1_46)))));
				}
			}
		} else {
	...
	// From: Req22Batch125Amount250
	unsigned long int stepLocal_26 = var_1_40 / var_1_55;
	if (stepLocal_26 <= var_1_18) {
		var_1_65 = (var_1_33 - 1);
	} else {
		var_1_65 = (min (var_1_34 , var_1_66));
	}


	// From: Req12Batch125Amount250
	signed long int stepLocal_14 = abs (var_1_8 - var_1_45);
	if (var_1_26 < last_1_var_1_22) {
		if (stepLocal_14 > var_1_31) {
			var_1_46 = ((var_1_47 - (min (var_1_39 , var_1_18))) + var_1_38);
		}
	}


	// From: Req2Batch125Amount250
	...
	if (var_1_13) {
		...
		if (var_1_9) {
			...
			var_1_36 = (var_1_39 + (max (var_1_17 , var_1_20)));
		}
	}


	// From: Req3Batch125Amount250
	...
	// From: Req7Batch125Amount250
	signed long int stepLocal_12 = - var_1_31;
	if (stepLocal_12 < var_1_20) {
		var_1_32 = (var_1_33 - var_1_17);
	} else {
		var_1_32 = (min (((var_1_34 + var_1_35) - var_1_17) , var_1_33));
	}


	// From: Req13Batch125Amount250
	unsigned char stepLocal_17 = var_1_10;
	unsigned char stepLocal_16 = var_1_15;
	signed long int stepLocal_15 = max ((var_1_31 / var_1_7) , var_1_42);
	if (stepLocal_17 && var_1_12) {
		if (var_1_12) {
			var_1_48 = (var_1_33 - (max (var_1_35 , var_1_39)));
		} else {
			if (stepLocal_16 && (var_1_5 && var_1_11)) {
				var_1_48 = (max (50 , var_1_34));
			}
		}
	} else {
		if (stepLocal_15 != -8) {
	...
	// From: Req14Batch125Amount250
	if (var_1_12) {
		var_1_50 = ((min (var_1_18 , var_1_17)) + var_1_39);
	}


	// From: Req15Batch125Amount250
	var_1_51 = var_1_16;


	// From: Req17Batch125Amount250
		...
		if (var_1_2 != stepLocal_21) {
			if (var_1_23 > var_1_25) {
				if (stepLocal_20 < var_1_6) {
					...
					var_1_53 = (abs (min (var_1_34 , var_1_21)));
				}
			} else {
	...
	// From: Req21Batch125Amount250
	unsigned char stepLocal_25 = var_1_9;
	if (var_1_12 || stepLocal_25) {
		var_1_62 = ((var_1_38 + var_1_33) - (var_1_63 - (min (var_1_18 , var_1_64))));
	} else {
		var_1_62 = (max (2 , ((var_1_31 - var_1_35) - var_1_63)));
	}


	// From: Req23Batch125Amount250
	var_1_67 = var_1_26;


	// From: Req24Batch125Amount250
	var_1_68 = var_1_54;


	// From: Req18Batch125Amount250
	if (var_1_46 <= (16 + var_1_42)) {
		var_1_57 = var_1_42;
	}


	// From: Req1Batch125Amount250
	...
	if (stepLocal_19 < var_1_1) {
		if (var_1_18 >= stepLocal_18) {
			var_1_52 = (min (var_1_23 , var_1_27));
		} else {
			var_1_52 = var_1_27;
		}
	}
	...
	// From: Req20Batch125Amount250
	unsigned long int stepLocal_24 = (var_1_18 * var_1_58) + (max (var_1_7 , var_1_1));
	if (var_1_20 < stepLocal_24) {
		var_1_61 = (var_1_27 - (max (var_1_25 , var_1_26)));
	}


	// From: Req6Batch125Amount250
	if ((min ((var_1_7 - var_1_21) , var_1_17)) < var_1_46) {
		if ((max (var_1_61 , var_1_27)) < var_1_23) {
			var_1_29 = (1 - var_1_17);
		} else {
			var_1_29 = (((max (var_1_30 , var_1_31)) - var_1_18) - var_1_21);
		}
	} else {
		var_1_29 = (max (var_1_40 , var_1_30));
	}


	// From: Req11Batch125Amount250
	if (var_1_52 < var_1_67) {
		var_1_43 = (max (var_1_37 , var_1_18));
	} else {
		if (! var_1_9) {
...
int property(void) {
	return (((((((((((((((((((((((((var_1_2 - var_1_3) <= var_1_42) ? (var_1_9 ? (var_1_1 == ((unsigned short int) (abs (var_1_6)))) : 1) : (var_1_1 == ((unsigned short int) (var_1_7 - var_1_8)))) && ((var_1_6 < last_1_var_1_40) ? ((var_1_5 || var_1_10) ? ((var_1_11 || var_1_10) ? (var_1_9 == ((unsigned char) (! var_1_12))) : (var_1_9 == ((unsigned char) ((var_1_5 || (var_1_13 && var_1_14)) && var_1_15)))) : 1) : (var_1_9 == ((unsigned char) (! (var_1_15 && var_1_12)))))) && (((500 << (var_1_17 - var_1_18)) > var_1_7) ? (((var_1_19 - var_1_6) == var_1_18) ? (var_1_16 == ((signed char) ((var_1_18 + var_1_17) + var_1_20))) : (var_1_16 == ((signed char) (var_1_17 - (min (var_1_18 , var_1_21)))))) : (var_1_16 == ((signed char) var_1_20)))) && ((var_1_20 <= (var_1_19 * var_1_18)) ? ((var_1_40 != var_1_20) ? (((var_1_36 * 32) < (var_1_46 + (var_1_40 / var_1_7))) ? (var_1_15 ? (var_1_22 == ((double) var_1_23)) : (var_1_22 == ((double) 1.0000000000000125E13))) : 1) : (var_1_22 == ((double) var_1_23))) : 1)) && (((~ var_1_1) <= (var_1_21 ^ var_1_3)) ? (var_1_24 == ((double) (var_1_25 - (var_1_26 + var_1_27)))) : (((var_1_19 % var_1_17) != (~ var_1_40)) ? ((((var_1_42 <= var_1_2) && (var_1_26 <= var_1_23)) && var_1_9) ? (var_1_9 ? (var_1_24 == ((double) var_1_25)) : 1) : (var_1_24 == ((double) 99.6))) : (var_1_24 == ((double) var_1_23))))) && (((min ((var_1_7 - var_1_21) , var_1_17)) < var_1_46) ? (((max (var_1_61 , var_1_27)) < var_1_23) ? (var_1_29 == ((signed short int) (1 - var_1_17))) : (var_1_29 == ((signed short int) (((max (var_1_30 , var_1_31)) - var_1_18) - var_1_21)))) : (var_1_29 == ((signed short int) (max (var_1_40 , var_1_30)))))) && (((- var_1_31) < var_1_20) ? (var_1_32 == ((unsigned char) (var_1_33 - var_1_17))) : (var_1_32 == ((unsigned char) (min (((var_1_34 + var_1_35) - var_1_17) , var_1_33)))))) && (var_1_13 ? (var_1_36 == ((signed char) ((var_1_37 - (var_1_17 + 25)) - (var_1_38 - (var_1_18 + var_1_39))))) : (var_1_9 ? (var_1_36 == ((signed char) (var_1_17 + var_1_18))) : (var_1_36 == ((signed char) (var_1_39 + (max (var_1_17 , var_1_20)))))))) && (var_1_12 ? (var_1_40 == ((unsigned long int) ((min (var_1_41 , (abs (3916741855u)))) - (max (var_1_37 , var_1_34))))) : ((var_1_25 > var_1_23) ? ((last_1_var_1_65 != last_1_var_1_46) ? (var_1_40 == ((unsigned long int) (var_1_41 - var_1_7))) : (((max ((max (var_1_2 , var_1_30)) , last_1_var_1_58)) > var_1_17) ? (var_1_40 == ((unsigned long int) (max (var_1_33 , (max (var_1_31 , (var_1_41 - last_1_var_1_46))))))) : 1)) : ((var_1_38 >= var_1_31) ? (var_1_14 ? (var_1_40 == ((unsigned long int) var_1_33)) : 1) : 1)))) && ((var_1_2 > var_1_34) ? (var_1_42 == ((signed long int) (last_1_var_1_42 + (var_1_38 + last_1_var_1_57)))) : 1)) && ((var_1_52 < var_1_67) ? (var_1_43 == ((signed char) (max (var_1_37 , var_1_18)))) : ((! var_1_9) ? (var_1_43 == ((signed char) (((var_1_45 - var_1_17) - var_1_39) - 2))) : (var_1_43 == ((signed char) (var_1_17 + var_1_20)))))) && ((var_1_26 < last_1_var_1_22) ? (((abs (var_1_8 - var_1_45)) > var_1_31) ? (var_1_46 == ((unsigned short int) ((var_1_47 - (min (var_1_39 , var_1_18))) + var_1_38))) : 1) : 1)) && ((var_1_10 && var_1_12) ? (var_1_12 ? (var_1_48 == ((unsigned char) (var_1_33 - (max (var_1_35 , var_1_39))))) : ((var_1_15 && (var_1_5 && var_1_11)) ? (var_1_48 == ((unsigned char) (max (50 , var_1_34)))) : 1)) : (((max ((var_1_31 / var_1_7) , var_1_42)) != -8) ? (var_1_48 == ((unsigned char) var_1_21)) : 1))) && (var_1_12 ? (var_1_50 == ((signed char) ((min (var_1_18 , var_1_17)) + var_1_39))) : 1)) && (var_1_51 == ((signed short int) var_1_16))) && (((var_1_47 << var_1_38) < var_1_1) ? ((var_1_18 >= var_1_7) ? (var_1_52 == ((double) (min (var_1_23 , var_1_27)))) : (var_1_52 == ((double) var_1_27))) : 1)) && (((var_1_37 >> (var_1_54 + var_1_55)) < var_1_2) ? ((var_1_2 != var_1_20) ? ((var_1_23 > var_1_25) ? ((var_1_19 < var_1_6) ? (var_1_53 == ((unsigned char) (var_1_33 - var_1_45))) : (var_1_53 == ((unsigned char) (abs (min (var_1_34 , var_1_21)))))) : (var_1_53 == ((unsigned char) (var_1_55 + (var_1_17 + (var_1_56 - var_1_18)))))) : 1) : 1)) && ((var_1_46 <= (16 + var_1_42)) ? (var_1_57 == ((unsigned short int) var_1_42)) : 1)) && ((last_1_var_1_9 || ((var_1_27 * last_1_var_1_67) != (last_1_var_1_61 + var_1_23))) ? (var_1_58 == ((unsigned long int) (var_1_41 - var_1_33))) : (var_1_58 == ((unsigned long int) (min (((min (var_1_41 , var_1_60)) - var_1_56) , var_1_45)))))) && ((var_1_20 < ((var_1_18 * var_1_58) + (max (var_1_7 , var_1_1)))) ? (var_1_61 == ((double) (var_1_27 - (max (var_1_25 , var_1_26))))) : 1)) && ((var_1_12 || var_1_9) ? (var_1_62 == ((signed short int) ((var_1_38 + var_1_33) - (var_1_63 - (min (var_1_18 , var_1_64)))))) : (var_1_62 == ((signed short int) (max (2 , ((var_1_31 - var_1_35) - var_1_63))))))) && (((var_1_40 / var_1_55) <= var_1_18) ? (var_1_65 == ((unsigned char) (var_1_33 - 1))) : (var_1_65 == ((unsigned char) (min (var_1_34 , var_1_66)))))) && (var_1_67 == ((double) var_1_26))) && (var_1_68 == ((signed char) var_1_54))
;
}
int main(void) {
	isInitial = 1;
