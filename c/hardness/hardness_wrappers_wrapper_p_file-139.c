...
void step(void) {
	// From: Req1Batch139Wrapper_P
	if ((min (last_1_var_1_17 , (abs (last_1_var_1_14)))) <= last_1_var_1_14) {
		(*(var_1_1_Pointer)) = (abs (32 - ((*(var_1_5_Pointer)) + (*(var_1_6_Pointer)))));
	} else {
		(*(var_1_1_Pointer)) = (*(var_1_6_Pointer));
	}


	// From: Req2Batch139Wrapper_P
