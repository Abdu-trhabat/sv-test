...
void step(void) {
	...
	if (! ((var_1_66 < var_1_6) || last_1_var_1_99)) {
		var_1_71 = (min (last_1_var_1_33 , 0));
	}
	...
	signed long int stepLocal_13 = (var_1_38 + last_1_var_1_17) << (max (var_1_3 , var_1_92));
	...
	if (var_1_10) {
		if (stepLocal_9 != (200 - var_1_3)) {
			...
			if (last_1_var_1_80 == stepLocal_10) {
				var_1_80 = ((max (var_1_31 , 1)) - var_1_52);
			}
		}
	} else {
		var_1_80 = (((max (last_1_var_1_111 , var_1_51)) + (max (var_1_2 , last_1_var_1_34))) - var_1_82);
	}
	...
	if (3.5 >= ((var_1_19 - var_1_20) + var_1_21)) {
		if ((last_1_var_1_111 * last_1_var_1_62) > (var_1_12 + var_1_31)) {
			var_1_34 = (min ((var_1_22 + var_1_13) , (100000u + (abs (100u)))));
		}
	} else {
	...
	if ((var_1_3 - var_1_39) < var_1_32) {
		var_1_50 = (((min (var_1_28 , 25940)) + var_1_51) - ((max (26366 , var_1_52)) - (var_1_32 + var_1_38)));
	}


	// From: Req18Batch52Amount500
	if (var_1_49 > var_1_51) {
		var_1_53 = (((min (var_1_54 , var_1_55)) + var_1_56) - 99.25f);
	} else {
		var_1_53 = ((max (var_1_5 , var_1_6)) + var_1_7);
	}
	...
	var_1_86 = (max (var_1_32 , var_1_30));
	...
	if (((var_1_32 | var_1_78) * var_1_80) >= var_1_30) {
		var_1_88 = (max (var_1_39 , var_1_111));
	} else {
	...
	if (var_1_5 >= var_1_6) {
		if (stepLocal_2 <= ((var_1_62 | var_1_3) + var_1_22)) {
			var_1_25 = (max (((var_1_13 + 4) - var_1_11) , var_1_62));
		}
	} else {
		var_1_25 = (min (var_1_62 , (var_1_12 + var_1_2)));
	}


	// From: Req9Batch52Amount500
	if (var_1_10) {
		var_1_29 = (((max (var_1_30 , var_1_31)) - 16) + var_1_3);
	} else {
		if (var_1_113) {
			var_1_29 = var_1_31;
		} else {
	...
	var_1_33 = (abs (var_1_13 - (var_1_112 + 2)));


	// From: Req28Batch52Amount500
	if ((var_1_7 < (var_1_59 / var_1_74)) || (! var_1_113)) {
		if (var_1_32 >= (- (var_1_38 - var_1_78))) {
			var_1_76 = ((min (var_1_68 , var_1_65)) + var_1_7);
		} else {
			var_1_76 = (max (var_1_7 , var_1_58));
		}
	}
	...
	if ((4 / (min (var_1_3 , var_1_30))) <= stepLocal_12) {
		var_1_90 = (var_1_54 - (max (var_1_58 , 32.75f)));
	} else {
		var_1_90 = var_1_7;
	}
	...
	signed long int stepLocal_17 = (max (var_1_32 , var_1_3)) - (var_1_92 + 32);
	if (stepLocal_17 <= var_1_36) {
		if (var_1_67 < (var_1_54 - (var_1_66 + var_1_74))) {
			var_1_97 = (var_1_78 + var_1_52);
		} else {
			var_1_97 = (abs (var_1_51 + var_1_28));
		}
	} else {
	...
	if (stepLocal_8 <= var_1_102) {
		...
		var_1_73 = (((max (var_1_55 , var_1_67)) + var_1_54) - ((var_1_74 - 0.125f) + var_1_64));
	}


	// From: Req44Batch52Amount500
	if (var_1_90 >= (min (var_1_73 , var_1_64))) {
		var_1_99 = var_1_45;
	}
	...
	if (stepLocal_7 >= ((min (var_1_100 , 4)) - var_1_71)) {
		var_1_69 = ((max ((var_1_67 - var_1_54) , var_1_66)) + (var_1_68 + var_1_70));
	} else {
		var_1_69 = ((var_1_66 + (max (var_1_68 , var_1_67))) + var_1_5);
	}


	// From: Req29Batch52Amount500
	if (24.14 >= var_1_93) {
		var_1_79 = ((var_1_51 + var_1_28) - (max ((var_1_34 + var_1_109) , 8)));
	}
		...
		if (var_1_113) {
			if (((2 << var_1_28) & var_1_13) > var_1_91) {
				if (((7.75f - var_1_55) * var_1_54) >= var_1_7) {
					var_1_61 = (min (var_1_22 , (var_1_38 + var_1_31)));
				}
			} else {
	...
	unsigned char stepLocal_15 = 0 >= (min (var_1_88 , var_1_108));
	if (stepLocal_15 || var_1_45) {
		var_1_94 = (var_1_7 + (min ((min (var_1_74 , var_1_5)) , var_1_65)));
	} else {
		var_1_94 = (min ((var_1_67 + (min (var_1_65 , var_1_70))) , ((min (var_1_74 , var_1_7)) + (var_1_64 - 999999.25f))));
	}
	...
	if (var_1_48 <= var_1_51) {
		if (var_1_41) {
			if (var_1_99 && var_1_8) {
				...
				var_1_115 = ((max (128 , var_1_116)) - var_1_92);
			}
		} else {
			var_1_115 = var_1_3;
		}
	...
	if ((- var_1_23) == var_1_46) {
		...
		if (var_1_42) {
			var_1_83 = ((max (var_1_65 , var_1_64)) - (var_1_66 + var_1_54));
		} else {
			var_1_83 = (max (var_1_70 , var_1_74));
		}
	}


	// From: Req12Batch52Amount500
	unsigned long int stepLocal_3 = max (var_1_12 , var_1_88);
	if (var_1_8) {
	...
	if (((var_1_31 + var_1_32) - var_1_23) == stepLocal_6) {
		if (var_1_37) {
			if (! var_1_47) {
				...
				var_1_63 = ((min ((var_1_64 - var_1_65) , var_1_5)) + ((var_1_66 - var_1_67) + var_1_68));
			}
		} else {
			var_1_63 = var_1_5;
		}
	...
	if (stepLocal_11 <= var_1_36) {
		...
		var_1_85 = (min ((999999.4 - 49.625) , var_1_64));
	}
	...
	if (! var_1_37) {
		...
		var_1_24 = (min (var_1_22 , var_1_91));
	}
	...
	if ((100000.88f * var_1_68) >= var_1_66) {
		var_1_98 = (var_1_55 + (min (var_1_67 , var_1_7)));
	} else {
		if (stepLocal_18 && var_1_75) {
			var_1_98 = (min ((min (4.4 , var_1_70)) , var_1_58));
		}
	}
	...
	if (((var_1_1 + var_1_21) + var_1_20) < (var_1_14 * var_1_69)) {
		var_1_57 = ((min ((min (var_1_54 , var_1_56)) , var_1_55)) - (max (var_1_58 , var_1_59)));
	} else {
	...
	if ((var_1_98 * var_1_59) > (max (var_1_20 , (max (var_1_74 , var_1_66))))) {
		var_1_89 = (var_1_39 - var_1_3);
	} else {
		if (0 >= ((var_1_49 - var_1_3) - var_1_28)) {
			var_1_89 = var_1_39;
		} else {
			var_1_89 = (min (var_1_3 , var_1_39));
		}
	}
	...
	if (var_1_51 <= stepLocal_16) {
		if (var_1_19 < var_1_57) {
			var_1_95 = (min (var_1_23 , (var_1_52 + var_1_13)));
		} else {
			var_1_95 = var_1_96;
		}
	} else {
		if (((128.6f * var_1_69) + var_1_98) <= (- var_1_6)) {
			var_1_95 = (min (var_1_82 , (var_1_3 + var_1_23)));
		} else {
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_2 >> var_1_3) | var_1_97) >= 10) ? (var_1_1 == ((float) ((min (var_1_5 , var_1_6)) + var_1_7))) : (var_1_1 == ((float) (abs (var_1_5 + var_1_7))))) && (((-2 / -10000000) != ((var_1_3 + var_1_11) + var_1_2)) ? (var_1_8 == ((unsigned char) (var_1_43 || var_1_10))) : 1)) && ((! (! var_1_43)) ? (var_1_11 == ((unsigned short int) ((var_1_3 + 128) + var_1_2))) : (var_1_11 == ((unsigned short int) (((min (var_1_12 , var_1_13)) - var_1_3) - var_1_2))))) && (((var_1_98 / 24.5) <= last_1_var_1_14) ? (var_1_43 ? (var_1_14 == ((double) (var_1_5 + var_1_6))) : 1) : 1)) && ((! var_1_99) ? ((var_1_5 <= (-0.5f * var_1_69)) ? (var_1_17 == ((unsigned char) (abs (var_1_3)))) : (((var_1_19 - var_1_20) > ((var_1_85 * var_1_7) / var_1_21)) ? (var_1_17 == ((unsigned char) (max ((128 - var_1_3) , (min (var_1_22 , 200)))))) : (var_1_17 == ((unsigned char) (var_1_3 + var_1_23))))) : (((var_1_73 / var_1_21) != var_1_69) ? (var_1_17 == ((unsigned char) var_1_23)) : (var_1_17 == ((unsigned char) (min ((var_1_3 + var_1_23) , var_1_22))))))) && ((! var_1_37) ? (var_1_24 == ((signed short int) (var_1_23 - var_1_22))) : (var_1_24 == ((signed short int) (min (var_1_22 , var_1_91)))))) && ((var_1_5 >= var_1_6) ? ((-128 <= ((var_1_62 | var_1_3) + var_1_22)) ? (var_1_25 == ((signed long int) (max (((var_1_13 + 4) - var_1_11) , var_1_62)))) : 1) : (var_1_25 == ((signed long int) (min (var_1_62 , (var_1_12 + var_1_2))))))) && ((var_1_3 > (var_1_106 ^ (- var_1_34))) ? (var_1_26 == ((unsigned short int) (((var_1_28 - var_1_23) + 18969) - var_1_2))) : (var_1_26 == ((unsigned short int) var_1_23)))) && (var_1_10 ? (var_1_29 == ((unsigned char) (((max (var_1_30 , var_1_31)) - 16) + var_1_3))) : (var_1_113 ? (var_1_29 == ((unsigned char) var_1_31)) : (var_1_29 == ((unsigned char) ((var_1_31 + var_1_32) - (var_1_30 - (var_1_3 + 16)))))))) && (var_1_33 == ((unsigned short int) (abs (var_1_13 - (var_1_112 + 2)))))) && ((3.5 >= ((var_1_19 - var_1_20) + var_1_21)) ? (((last_1_var_1_111 * last_1_var_1_62) > (var_1_12 + var_1_31)) ? (var_1_34 == ((unsigned long int) (min ((var_1_22 + var_1_13) , (100000u + (abs (100u))))))) : 1) : (var_1_34 == ((unsigned long int) (var_1_35 - ((var_1_36 - last_1_var_1_111) - var_1_3)))))) && (var_1_8 ? ((var_1_19 < var_1_83) ? (((var_1_38 - (var_1_3 + var_1_39)) <= (max (var_1_12 , var_1_88))) ? (var_1_37 == ((unsigned char) (! (var_1_40 || var_1_41)))) : (var_1_37 == ((unsigned char) ((! (! var_1_10)) && var_1_42)))) : 1) : 1)) && ((! var_1_41) ? (var_1_43 == ((unsigned char) ((! var_1_41) && var_1_42))) : (var_1_43 == ((unsigned char) (var_1_10 && (var_1_42 && (var_1_44 && var_1_45))))))) && ((! (var_1_13 < (var_1_34 * var_1_38))) ? (var_1_46 == ((signed long int) (var_1_32 - (var_1_48 + var_1_108)))) : 1)) && (var_1_44 ? (var_1_47 == ((unsigned char) (var_1_40 || var_1_10))) : ((var_1_38 > var_1_35) ? ((-5 > (var_1_91 & (var_1_80 / var_1_13))) ? (var_1_47 == ((unsigned char) ((var_1_25 < var_1_106) || var_1_45))) : (var_1_47 == ((unsigned char) (! var_1_41)))) : (var_1_47 == ((unsigned char) (! ((! var_1_10) || var_1_40))))))) && ((var_1_7 <= var_1_6) ? (var_1_48 == ((unsigned long int) ((var_1_36 + var_1_49) - var_1_39))) : 1)) && (((var_1_3 - var_1_39) < var_1_32) ? (var_1_50 == ((unsigned short int) (((min (var_1_28 , 25940)) + var_1_51) - ((max (26366 , var_1_52)) - (var_1_32 + var_1_38))))) : 1)) && ((var_1_49 > var_1_51) ? (var_1_53 == ((float) (((min (var_1_54 , var_1_55)) + var_1_56) - 99.25f))) : (var_1_53 == ((float) ((max (var_1_5 , var_1_6)) + var_1_7))))) && ((((var_1_1 + var_1_21) + var_1_20) < (var_1_14 * var_1_69)) ? (var_1_57 == ((double) ((min ((min (var_1_54 , var_1_56)) , var_1_55)) - (max (var_1_58 , var_1_59))))) : (var_1_57 == ((double) (var_1_58 - var_1_54))))) && ((var_1_28 > 100) ? (var_1_37 ? (var_1_60 == ((unsigned short int) (var_1_13 - 1))) : (var_1_60 == ((unsigned short int) (var_1_52 + (var_1_51 - 100))))) : 1)) && ((var_1_7 != var_1_73) ? (var_1_113 ? ((((2 << var_1_28) & var_1_13) > var_1_91) ? ((((7.75f - var_1_55) * var_1_54) >= var_1_7) ? (var_1_61 == ((signed short int) (min (var_1_22 , (var_1_38 + var_1_31))))) : 1) : (var_1_61 == ((signed short int) ((2 - var_1_38) + var_1_39)))) : 1) : 1)) && ((var_1_30 != var_1_2) ? (var_1_62 == ((signed short int) ((last_1_var_1_62 + var_1_38) + var_1_32))) : 1)) && ((((var_1_31 + var_1_32) - var_1_23) == var_1_28) ? (var_1_37 ? ((! var_1_47) ? (var_1_63 == ((double) var_1_59)) : (var_1_63 == ((double) ((min ((var_1_64 - var_1_65) , var_1_5)) + ((var_1_66 - var_1_67) + var_1_68))))) : (var_1_63 == ((double) var_1_5))) : 1)) && ((1 >= ((min (var_1_100 , 4)) - var_1_71)) ? (var_1_69 == ((double) ((max ((var_1_67 - var_1_54) , var_1_66)) + (var_1_68 + var_1_70)))) : (var_1_69 == ((double) ((var_1_66 + (max (var_1_68 , var_1_67))) + var_1_5))))) && ((! ((var_1_66 < var_1_6) || last_1_var_1_99)) ? (var_1_71 == ((signed long int) (min (last_1_var_1_33 , 0)))) : 1)) && ((var_1_26 <= var_1_102) ? (var_1_73 == ((float) (var_1_55 - (var_1_64 + var_1_66)))) : (var_1_73 == ((float) (((max (var_1_55 , var_1_67)) + var_1_54) - ((var_1_74 - 0.125f) + var_1_64)))))) && ((var_1_63 == (25.5f + (var_1_20 / 9.4f))) ? (var_1_75 == ((unsigned char) (var_1_43 || var_1_44))) : 1)) && (((var_1_7 < (var_1_59 / var_1_74)) || (! var_1_113)) ? ((var_1_32 >= (- (var_1_38 - var_1_78))) ? (var_1_76 == ((float) ((min (var_1_68 , var_1_65)) + var_1_7))) : (var_1_76 == ((float) (max (var_1_7 , var_1_58))))) : 1)) && ((24.14 >= var_1_93) ? (var_1_79 == ((unsigned short int) ((var_1_51 + var_1_28) - (max ((var_1_34 + var_1_109) , 8))))) : 1)) && (var_1_10 ? ((var_1_38 != (200 - var_1_3)) ? (var_1_80 == ((signed long int) ((var_1_81 - last_1_var_1_111) - var_1_22))) : ((last_1_var_1_80 == (1000000000 * var_1_23)) ? (var_1_80 == ((signed long int) ((max (var_1_31 , 1)) - var_1_52))) : 1)) : (var_1_80 == ((signed long int) (((max (last_1_var_1_111 , var_1_51)) + (max (var_1_2 , last_1_var_1_34))) - var_1_82))))) && (((- var_1_23) == var_1_46) ? (var_1_43 ? (var_1_83 == ((double) (var_1_65 + ((var_1_67 - var_1_66) + var_1_70)))) : (var_1_83 == ((double) var_1_64))) : (var_1_42 ? (var_1_83 == ((double) ((max (var_1_65 , var_1_64)) - (var_1_66 + var_1_54)))) : (var_1_83 == ((double) (max (var_1_70 , var_1_74))))))) && ((var_1_3 <= var_1_36) ? (var_1_75 ? (var_1_85 == ((double) var_1_54)) : 1) : (var_1_85 == ((double) (min ((999999.4 - 49.625) , var_1_64)))))) && (var_1_86 == ((unsigned char) (max (var_1_32 , var_1_30))))) && ((var_1_64 <= var_1_57) ? (var_1_87 == ((double) (127.8 - var_1_58))) : 1)) && ((((var_1_32 | var_1_78) * var_1_80) >= var_1_30) ? (var_1_88 == ((unsigned long int) (max (var_1_39 , var_1_111)))) : (var_1_88 == ((unsigned long int) (var_1_31 + var_1_30))))) && (((var_1_98 * var_1_59) > (max (var_1_20 , (max (var_1_74 , var_1_66))))) ? (var_1_89 == ((signed char) (var_1_39 - var_1_3))) : ((0 >= ((var_1_49 - var_1_3) - var_1_28)) ? (var_1_89 == ((signed char) var_1_39)) : (var_1_89 == ((signed char) (min (var_1_3 , var_1_39))))))) && (((4 / (min (var_1_3 , var_1_30))) <= var_1_114) ? (var_1_90 == ((float) (var_1_54 - (max (var_1_58 , 32.75f))))) : (var_1_90 == ((float) var_1_7)))) && ((last_1_var_1_80 != ((var_1_38 + last_1_var_1_17) << (max (var_1_3 , var_1_92)))) ? ((var_1_13 <= var_1_23) ? (var_1_91 == ((unsigned long int) var_1_13)) : 1) : 1)) && (var_1_93 == ((double) ((var_1_74 + var_1_55) - var_1_64)))) && (((0 >= (min (var_1_88 , var_1_108))) || var_1_45) ? (var_1_94 == ((float) (var_1_7 + (min ((min (var_1_74 , var_1_5)) , var_1_65))))) : (var_1_94 == ((float) (min ((var_1_67 + (min (var_1_65 , var_1_70))) , ((min (var_1_74 , var_1_7)) + (var_1_64 - 999999.25f)))))))) && ((var_1_51 <= var_1_88) ? ((var_1_19 < var_1_57) ? (var_1_95 == ((unsigned long int) (min (var_1_23 , (var_1_52 + var_1_13))))) : (var_1_95 == ((unsigned long int) var_1_96))) : ((((128.6f * var_1_69) + var_1_98) <= (- var_1_6)) ? (var_1_95 == ((unsigned long int) (min (var_1_82 , (var_1_3 + var_1_23))))) : (var_1_95 == ((unsigned long int) (var_1_36 + var_1_92)))))) && ((((max (var_1_32 , var_1_3)) - (var_1_92 + 32)) <= var_1_36) ? ((var_1_67 < (var_1_54 - (var_1_66 + var_1_74))) ? (var_1_97 == ((unsigned short int) (var_1_78 + var_1_52))) : (var_1_97 == ((unsigned short int) (abs (var_1_51 + var_1_28))))) : (((var_1_21 * var_1_55) >= (- var_1_20)) ? (var_1_97 == ((unsigned short int) var_1_52)) : (var_1_97 == ((unsigned short int) (var_1_29 + var_1_62)))))) && (((100000.88f * var_1_68) >= var_1_66) ? (var_1_98 == ((double) (var_1_55 + (min (var_1_67 , var_1_7))))) : ((var_1_44 && var_1_75) ? (var_1_98 == ((double) (min ((min (4.4 , var_1_70)) , var_1_58)))) : 1))) && ((var_1_90 >= (min (var_1_73 , var_1_64))) ? (var_1_99 == ((unsigned char) var_1_45)) : 1)) && (var_1_40 ? (var_1_100 == ((unsigned short int) var_1_29)) : (var_1_100 == ((unsigned short int) var_1_22)))) && (var_1_44 ? (var_1_101 == ((signed char) var_1_3)) : (var_1_101 == ((signed char) var_1_39)))) && (var_1_102 == ((signed short int) var_1_31))) && (var_1_103 == ((unsigned char) var_1_42))) && (var_1_40 ? (var_1_104 == ((float) var_1_67)) : (var_1_104 == ((float) var_1_74)))) && (var_1_75 ? (var_1_105 == ((signed char) var_1_39)) : 1)) && (var_1_106 == ((signed long int) var_1_71))) && (var_1_107 == ((unsigned char) var_1_31))) && (var_1_42 ? (var_1_108 == ((signed long int) var_1_79)) : 1)) && (var_1_45 ? (var_1_109 == ((unsigned short int) var_1_25)) : (var_1_109 == ((unsigned short int) var_1_23)))) && (var_1_110 == ((unsigned char) var_1_32))) && (var_1_111 == ((unsigned short int) var_1_91))) && (var_1_44 ? (var_1_112 == ((unsigned char) var_1_32)) : 1)) && (var_1_113 == ((unsigned char) var_1_45))) && (var_1_114 == ((unsigned char) var_1_92))) && ((var_1_48 <= var_1_51) ? (var_1_41 ? ((var_1_99 && var_1_8) ? (var_1_115 == ((unsigned char) (var_1_23 + var_1_32))) : (var_1_115 == ((unsigned char) ((max (128 , var_1_116)) - var_1_92)))) : (var_1_115 == ((unsigned char) var_1_3))) : 1)
;
}
int main(void) {
	isInitial = 1;
