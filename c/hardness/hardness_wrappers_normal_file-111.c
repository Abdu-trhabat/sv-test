...
void step(void) {
	...
	if (var_1_7 != (max ((var_1_8 * var_1_15) , var_1_15))) {
		if (var_1_7 <= var_1_15) {
			if (var_1_6) {
				var_1_9 = var_1_10;
			}
...
int property(void) {
	return ((((var_1_2 < var_1_3) ? (var_1_1 == ((double) (min (1.25 , var_1_4)))) : ((var_1_5 || var_1_6) ? (var_1_1 == ((double) ((abs (var_1_7)) + var_1_8))) : 1)) && ((var_1_7 != (max ((var_1_8 * var_1_15) , var_1_15))) ? ((var_1_7 <= var_1_15) ? (var_1_6 ? (var_1_9 == ((signed long int) var_1_10)) : 1) : 1) : (var_1_9 == ((signed long int) var_1_10)))) && ((var_1_8 <= var_1_15) ? (var_1_11 == ((unsigned short int) (32 + (var_1_12 + (var_1_13 - var_1_14))))) : 1)) && ((var_1_14 >= var_1_12) ? ((last_1_var_1_15 > var_1_8) ? ((var_1_4 >= var_1_7) ? (var_1_15 == ((double) var_1_8)) : (var_1_15 == ((double) var_1_4))) : 1) : (var_1_15 == ((double) var_1_8)))
;
}
int main(void) {
	isInitial = 1;
