...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch118Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch118Amount100
	var_1_27 = (var_1_35 && var_1_28);


	// From: Req1Batch118Amount100
	...
	// From: Req12Batch118Amount100
	var_1_42 = var_1_32;


	// From: Req3Batch118Amount100
	if (-32 <= (var_1_16 ^ (abs (var_1_14)))) {
		if ((max (var_1_8 , 32.25)) < var_1_9) {
			var_1_12 = var_1_15;
		} else {
			var_1_12 = 4;
		}
