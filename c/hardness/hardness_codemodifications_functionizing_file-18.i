...
void step(void) {
 ...
 if (var_1_5 <= (var_1_6 / var_1_3)) {
  var_1_12 = ((((var_1_13) > (functionized1(var_1_14))) ? (var_1_13) : (functionized1(var_1_14))));
 } else {
  var_1_12 = var_1_14;
 }
 if (var_1_7) {
  ...
  var_1_16 = (var_1_11 - ((((functionized2(var_1_17, var_1_10)) < 0 ) ? -(functionized2(var_1_17, var_1_10)) : (functionized2(var_1_17, var_1_10)))));
 }
