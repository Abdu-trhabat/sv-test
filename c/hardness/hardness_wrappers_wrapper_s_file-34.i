...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch34Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 if (WrapperStruct00.var_1_3 || (256 >= (WrapperStruct00.var_1_6 + 4))) {
 ...
 signed long int stepLocal_1 = ~ WrapperStruct00.var_1_6;
 signed long int stepLocal_0 = -10;
 if (stepLocal_0 >= WrapperStruct00.var_1_6) {
  if (((WrapperStruct00.var_1_11 + WrapperStruct00.var_1_12) - ((((WrapperStruct00.var_1_13) < (1)) ? (WrapperStruct00.var_1_13) : (1)))) > stepLocal_1) {
