...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch164Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 if (BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]) {
  if ((signed_long_int_Array_0[1][2] + signed_long_int_Array_0[0][2]) <= -1) {
   double_Array_0[1][1] = double_Array_0[0][1];
  } else {
   if (signed_long_int_Array_0[0][2] > (((((signed_long_int_Array_0[1][2]) < (signed_long_int_Array_0[1][1])) ? (signed_long_int_Array_0[1][2]) : (signed_long_int_Array_0[1][1]))) * signed_long_int_Array_0[0][1])) {
    double_Array_0[1][1] = (double_Array_0[0][0] - double_Array_0[1][0]);
   } else {
    double_Array_0[1][1] = ((((99.5) < (double_Array_0[0][1])) ? (99.5) : (double_Array_0[0][1])));
   }
  }
 } else {
  double_Array_0[1][1] = double_Array_0[0][1];
 }
 signed long int stepLocal_0 = signed_long_int_Array_0[0][1];
 if ((signed_long_int_Array_0[0][0] - signed_long_int_Array_0[1][0]) <= stepLocal_0) {
  unsigned_short_int_Array_0[0][0] = ((((5) < (unsigned_short_int_Array_0[0][1])) ? (5) : (unsigned_short_int_Array_0[0][1])));
 }
 if (BOOL_unsigned_char_Array_0[1]) {
  if (! ((signed_long_int_Array_0[1][2] / signed_short_int_Array_0[0]) < unsigned_short_int_Array_0[0][0])) {
   unsigned_short_int_Array_0[1][1] = (10 + ((unsigned_short_int_Array_0[1][0] - unsigned_short_int_Array_0[0][2]) + unsigned_short_int_Array_0[1][2]));
  }
 } else {
...
int property(void) {
 return (((BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]) ? (((signed_long_int_Array_0[1][2] + signed_long_int_Array_0[0][2]) <= -1) ? (double_Array_0[1][1] == ((double) double_Array_0[0][1])) : ((signed_long_int_Array_0[0][2] > (((((signed_long_int_Array_0[1][2]) < (signed_long_int_Array_0[1][1])) ? (signed_long_int_Array_0[1][2]) : (signed_long_int_Array_0[1][1]))) * signed_long_int_Array_0[0][1])) ? (double_Array_0[1][1] == ((double) (double_Array_0[0][0] - double_Array_0[1][0]))) : (double_Array_0[1][1] == ((double) ((((99.5) < (double_Array_0[0][1])) ? (99.5) : (double_Array_0[0][1]))))))) : (double_Array_0[1][1] == ((double) double_Array_0[0][1]))) && (((signed_long_int_Array_0[0][0] - signed_long_int_Array_0[1][0]) <= signed_long_int_Array_0[0][1]) ? (unsigned_short_int_Array_0[0][0] == ((unsigned short int) ((((5) < (unsigned_short_int_Array_0[0][1])) ? (5) : (unsigned_short_int_Array_0[0][1]))))) : 1)) && (BOOL_unsigned_char_Array_0[1] ? ((! ((signed_long_int_Array_0[1][2] / signed_short_int_Array_0[0]) < unsigned_short_int_Array_0[0][0])) ? (unsigned_short_int_Array_0[1][1] == ((unsigned short int) (10 + ((unsigned_short_int_Array_0[1][0] - unsigned_short_int_Array_0[0][2]) + unsigned_short_int_Array_0[1][2])))) : 1) : (unsigned_short_int_Array_0[1][1] == ((unsigned short int) unsigned_short_int_Array_0[0][1])))
;
}
int main(void) {
 isInitial = 1;
