...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch128Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch128Wrapper_P
	unsigned long int stepLocal_1 = (*(var_1_4_Pointer));
	unsigned long int stepLocal_0 = (*(var_1_3_Pointer)) + ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer)));
	if ((*(var_1_2_Pointer)) > stepLocal_0) {
		if (stepLocal_1 >= ((*(var_1_6_Pointer)) - (*(var_1_7_Pointer)))) {
			(*(var_1_1_Pointer)) = (*(var_1_8_Pointer));
		}
	}


	// From: Req2Batch128Wrapper_P
	unsigned long int stepLocal_3 = (*(var_1_5_Pointer));
	unsigned char stepLocal_2 = (*(var_1_10_Pointer));
	if (((*(var_1_4_Pointer)) < (*(var_1_3_Pointer))) || stepLocal_2) {
		(*(var_1_9_Pointer)) = (*(var_1_11_Pointer));
	} else {
		if (((*(var_1_2_Pointer)) / (*(var_1_12_Pointer))) < stepLocal_3) {
			(*(var_1_9_Pointer)) = (*(var_1_11_Pointer));
		} else {
			(*(var_1_9_Pointer)) = 0;
		}
	...
	// From: Req3Batch128Wrapper_P
	if ((~ (*(var_1_6_Pointer))) < ((*(var_1_3_Pointer)) ^ (*(var_1_4_Pointer)))) {
		(*(var_1_13_Pointer)) = (abs (((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) - (abs ((*(var_1_8_Pointer))))));
	}


	// From: Req4Batch128Wrapper_P
	unsigned long int stepLocal_4 = (*(var_1_7_Pointer)) << (*(var_1_5_Pointer));
	if (((*(var_1_17_Pointer)) - (*(var_1_18_Pointer))) <= stepLocal_4) {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) > ((*(var_1_3_Pointer)) + ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer))))) ? (((*(var_1_4_Pointer)) >= ((*(var_1_6_Pointer)) - (*(var_1_7_Pointer)))) ? ((*(var_1_1_Pointer)) == ((double) (*(var_1_8_Pointer)))) : 1) : 1) && ((((*(var_1_4_Pointer)) < (*(var_1_3_Pointer))) || (*(var_1_10_Pointer))) ? ((*(var_1_9_Pointer)) == ((unsigned char) (*(var_1_11_Pointer)))) : ((((*(var_1_2_Pointer)) / (*(var_1_12_Pointer))) < (*(var_1_5_Pointer))) ? ((*(var_1_9_Pointer)) == ((unsigned char) (*(var_1_11_Pointer)))) : ((*(var_1_9_Pointer)) == ((unsigned char) 0))))) && (((~ (*(var_1_6_Pointer))) < ((*(var_1_3_Pointer)) ^ (*(var_1_4_Pointer)))) ? ((*(var_1_13_Pointer)) == ((float) (abs (((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) - (abs ((*(var_1_8_Pointer)))))))) : 1)) && ((((*(var_1_17_Pointer)) - (*(var_1_18_Pointer))) <= ((*(var_1_7_Pointer)) << (*(var_1_5_Pointer)))) ? ((*(var_1_16_Pointer)) == ((double) (*(var_1_8_Pointer)))) : 1)
;
}
int main(void) {
	isInitial = 1;
