...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch142100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch142100_1loop
	var_1_19 = var_1_20;


	// From: Req7Batch142100_1loop
	if (var_1_17 >= var_1_9) {
		if (var_1_19) {
	...
	// From: Req13Batch142100_1loop
	var_1_39 = var_1_33;


	// From: Req4Batch142100_1loop
	...
	// From: Req11Batch142100_1loop
	var_1_37 = (var_1_24 + (var_1_34 + var_1_25));


	// From: Req2Batch142100_1loop
