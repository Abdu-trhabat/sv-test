...
void step(void) {
	...
	if (var_1_6 > (var_1_1 * (max (var_1_5 , var_1_7)))) {
...
int property(void) {
	return ((((var_1_2 != var_1_3) ? (var_1_1 == ((unsigned short int) (var_1_4 - (min (var_1_5 , (var_1_6 - var_1_7)))))) : 1) && ((var_1_7 > var_1_5) ? (var_1_8 == ((float) (abs (var_1_9)))) : (var_1_8 == ((float) ((max (var_1_10 , var_1_11)) - (var_1_12 - 3.4f)))))) && ((var_1_6 <= var_1_5) ? (((max (var_1_8 , (var_1_12 / var_1_15))) > (min (var_1_10 , var_1_8))) ? (var_1_13 == ((signed short int) var_1_7)) : 1) : (var_1_13 == ((signed short int) var_1_7)))) && ((var_1_6 > (var_1_1 * (max (var_1_5 , var_1_7)))) ? ((var_1_17 || var_1_18) ? (var_1_16 == ((unsigned short int) var_1_4)) : (var_1_16 == ((unsigned short int) var_1_7))) : (var_1_16 == ((unsigned short int) var_1_6)))
;
}
int main(void) {
	isInitial = 1;
