...
void step(void) {
 ...
 if (signed_short_int_Array_0[0] >= (unsigned_char_Array_0[1] << signed_long_int_Array_0[2])) {
  signed_long_int_Array_0[1] = ((((unsigned_char_Array_0[1]) < 0 ) ? -(unsigned_char_Array_0[1]) : (unsigned_char_Array_0[1])));
 } else {
  if (BOOL_unsigned_char_Array_0[0]) {
