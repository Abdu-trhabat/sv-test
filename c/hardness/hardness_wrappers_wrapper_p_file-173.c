...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch173Wrapper_P.c", 13, "reach_error"); }
...
float var_1_22 = 16.4;
float* var_1_22_Pointer = &(var_1_22);
...
void step(void) {
	// From: Req1Batch173Wrapper_P
	if ((*(var_1_2_Pointer)) < (*(var_1_3_Pointer))) {
		if (((min ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) << (*(var_1_6_Pointer))) < ((~ (*(var_1_7_Pointer))) / (*(var_1_8_Pointer)))) {
			(*(var_1_1_Pointer)) = (min (((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) , ((*(var_1_11_Pointer)) - (*(var_1_12_Pointer)))));
		}
	}


	// From: Req3Batch173Wrapper_P
	if ((*(var_1_14_Pointer))) {
		(*(var_1_17_Pointer)) = ((*(var_1_18_Pointer)) || (*(var_1_19_Pointer)));
	} else {
		(*(var_1_17_Pointer)) = ((*(var_1_20_Pointer)) || (*(var_1_19_Pointer)));
	}


	// From: Req4Batch173Wrapper_P
	(*(var_1_21_Pointer)) = (*(var_1_6_Pointer));


	// From: Req5Batch173Wrapper_P
	(*(var_1_22_Pointer)) = (*(var_1_10_Pointer));


	// From: Req6Batch173Wrapper_P
	(*(var_1_23_Pointer)) = (*(var_1_6_Pointer));


	// From: Req2Batch173Wrapper_P
	if (((*(var_1_12_Pointer)) < (*(var_1_10_Pointer))) || (*(var_1_17_Pointer))) {
		if ((*(var_1_17_Pointer)) || ((*(var_1_9_Pointer)) <= (*(var_1_22_Pointer)))) {
			(*(var_1_13_Pointer)) = ((*(var_1_15_Pointer)) - ((*(var_1_16_Pointer)) - (*(var_1_4_Pointer))));
		}
	} else {
...
int property(void) {
	return (((((((*(var_1_2_Pointer)) < (*(var_1_3_Pointer))) ? ((((min ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) << (*(var_1_6_Pointer))) < ((~ (*(var_1_7_Pointer))) / (*(var_1_8_Pointer)))) ? ((*(var_1_1_Pointer)) == ((double) (min (((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) , ((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))))))) : 1) : 1) && ((((*(var_1_12_Pointer)) < (*(var_1_10_Pointer))) || (*(var_1_17_Pointer))) ? (((*(var_1_17_Pointer)) || ((*(var_1_9_Pointer)) <= (*(var_1_22_Pointer)))) ? ((*(var_1_13_Pointer)) == ((unsigned long int) ((*(var_1_15_Pointer)) - ((*(var_1_16_Pointer)) - (*(var_1_4_Pointer)))))) : 1) : ((*(var_1_13_Pointer)) == ((unsigned long int) (*(var_1_15_Pointer)))))) && ((*(var_1_14_Pointer)) ? ((*(var_1_17_Pointer)) == ((unsigned char) ((*(var_1_18_Pointer)) || (*(var_1_19_Pointer))))) : ((*(var_1_17_Pointer)) == ((unsigned char) ((*(var_1_20_Pointer)) || (*(var_1_19_Pointer))))))) && ((*(var_1_21_Pointer)) == ((signed char) (*(var_1_6_Pointer))))) && ((*(var_1_22_Pointer)) == ((float) (*(var_1_10_Pointer))))) && ((*(var_1_23_Pointer)) == ((signed char) (*(var_1_6_Pointer))))
;
}
int main(void) {
	isInitial = 1;
