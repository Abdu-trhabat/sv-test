...
void step(void) {
	...
	if (var_1_5 < var_1_2) {
		var_1_10 = (min ((var_1_11 - var_1_12) , var_1_1));
	} else {
	...
	// From: Req7Batch121normal
	var_1_24 = (min (4.4f , var_1_25));


	// From: Req8Batch121normal
...
int property(void) {
	return (((((((((var_1_2 / (min (var_1_3 , var_1_4))) <= (var_1_5 / (min (var_1_6 , var_1_7)))) ? (var_1_8 ? (var_1_1 == ((signed char) var_1_9)) : (var_1_1 == ((signed char) 64))) : (var_1_1 == ((signed char) var_1_9))) && ((var_1_5 < var_1_2) ? (var_1_10 == ((signed long int) (min ((var_1_11 - var_1_12) , var_1_1)))) : (var_1_10 == ((signed long int) (var_1_12 - (var_1_13 - (max (var_1_14 , var_1_15)))))))) && ((var_1_1 < var_1_10) ? (var_1_16 == ((signed char) var_1_9)) : 1)) && ((var_1_13 == var_1_11) ? (var_1_17 == ((signed char) ((min ((var_1_18 + 50) , var_1_19)) - (var_1_20 + var_1_21)))) : (var_1_17 == ((signed char) var_1_20)))) && (var_1_8 ? (var_1_22 == ((signed short int) (min ((var_1_18 - var_1_20) , (var_1_19 + var_1_9))))) : (var_1_22 == ((signed short int) 4)))) && ((var_1_5 >= var_1_3) ? (var_1_23 == ((unsigned short int) var_1_21)) : (var_1_23 == ((unsigned short int) (max (var_1_18 , var_1_21)))))) && (var_1_24 == ((float) (min (4.4f , var_1_25))))) && ((var_1_15 <= (max (-5 , var_1_10))) ? (var_1_26 == ((unsigned char) (var_1_8 || (var_1_27 && var_1_28)))) : (var_1_27 ? (var_1_26 == ((unsigned char) var_1_29)) : (var_1_26 == ((unsigned char) var_1_28))))
;
}
int main(void) {
	isInitial = 1;
