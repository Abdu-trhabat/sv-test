...
void step(void) {
	// From: Req8Batch154100_while
	if (64.75 >= var_1_13) {
		var_1_18 = (var_1_7 && (last_1_var_1_5 || var_1_6));
	}


	// From: Req1Batch154100_while
	if (last_1_var_1_18) {
	...
	// From: Req3Batch154100_while
	if (var_1_1 > var_1_4) {
		var_1_8 = (abs (abs (var_1_9)));
	}


	// From: Req4Batch154100_while
