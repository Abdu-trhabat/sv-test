...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch146dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch146dependencies
	if ((- var_1_8) > var_1_8) {
		var_1_14 = 5;
	}


	// From: Req1Batch146dependencies
	if (var_1_2 && var_1_3) {
		if (var_1_4 >= var_1_5) {
			var_1_1 = var_1_6;
		} else {
	...
	// From: Req7Batch146dependencies
	if (last_1_var_1_24 < var_1_14) {
		var_1_24 = (min (100 , (max (32 , var_1_21))));
	}


	// From: Req8Batch146dependencies
	var_1_25 = var_1_21;


	// From: Req6Batch146dependencies
	if (var_1_2) {
