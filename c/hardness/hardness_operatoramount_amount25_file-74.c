...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch74Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch74Amount25
	if (var_1_9) {
		if (255.5f != (var_1_11 - var_1_12)) {
			var_1_10 = (max ((max (var_1_13 , var_1_14)) , var_1_15));
		}
	} else {
		if (var_1_4 <= var_1_3) {
			var_1_10 = var_1_15;
	...
	// From: Req3Batch74Amount25
	if (var_1_9) {
		var_1_16 = (abs (var_1_17));
	}


	// From: Req4Batch74Amount25
	var_1_18 = var_1_14;


	// From: Req5Batch74Amount25
	var_1_19 = -2;
}
