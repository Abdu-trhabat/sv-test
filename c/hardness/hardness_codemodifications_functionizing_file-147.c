...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch147functionizing.c", 13, "reach_error"); }
...
void functionized1(double);
void functionized2(unsigned long int, unsigned short int, unsigned long int, unsigned char);
void functionized3(unsigned short int, unsigned char, signed char, unsigned char);
...
void functionized0(unsigned char functionized0_localFunctionVar0) {
	if (var_1_2 > functionized0_localFunctionVar0) {
		if (functionized0_localFunctionVar0 == (128 - var_1_4)) {
			var_1_1 = var_1_4;
		} else {
			var_1_1 = (max ((abs (functionized0_localFunctionVar0)) , (abs (32u))));
		}
	} else {
		var_1_1 = var_1_2;
	}
}
void functionized1(double functionized1_localFunctionVar0) {
	if (var_1_1 == var_1_4) {
		var_1_5 = (functionized1_localFunctionVar0 + var_1_7);
	}
}
void functionized2(unsigned long int functionized2_localFunctionVar0, unsigned short int functionized2_localFunctionVar1, unsigned long int functionized2_localFunctionVar2, unsigned char functionized2_localFunctionVar3) {
	if ((functionized2_localFunctionVar2 < 16u) || var_1_9) {
		if (var_1_9) {
			if (functionized2_localFunctionVar1 >= functionized2_localFunctionVar3) {
				var_1_8 = (functionized2_localFunctionVar0 - var_1_2);
			} else {
				var_1_8 = var_1_2;
			}
		} else {
...
void functionized3(unsigned short int functionized3_localFunctionVar0, unsigned char functionized3_localFunctionVar1, signed char functionized3_localFunctionVar2, unsigned char functionized3_localFunctionVar3) {
	if (functionized3_localFunctionVar3 <= (functionized3_localFunctionVar0 + (functionized3_localFunctionVar2 + 5))) {
		var_1_16 = functionized3_localFunctionVar1;
	}
}
signed long int functionized4(signed long int localFunctionVar0) {
	return (min ((max (var_1_4 , var_1_14)) , (localFunctionVar0 + var_1_13)));
}
...
void step(void) {
	// From: Req1Batch147functionizing
	functionized0(var_1_3);


	// From: Req2Batch147functionizing
	functionized1(var_1_6);


	// From: Req3Batch147functionizing
	functionized2(var_1_11, var_1_10, var_1_1, var_1_4);


	// From: Req4Batch147functionizing
	if (-1000000 != var_1_1) {
		var_1_12 = (min ((max (var_1_13 , var_1_14)) , var_1_15));
	}


	// From: Req5Batch147functionizing
	functionized3(var_1_10, var_1_2, var_1_12, var_1_4);


	// From: Req6Batch147functionizing
	if ((min (var_1_12 , var_1_13)) <= var_1_15) {
		var_1_17 = (var_1_3 - var_1_10);
	}


	// From: Req7Batch147functionizing
	if (var_1_9) {
		if (var_1_19) {
			var_1_18 = functionized4(2);
		}
	} else {
