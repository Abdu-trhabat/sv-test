...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch87Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_0 < unsigned_long_int_Array_0[1][0]) {
		if (stepLocal_1 != unsigned_long_int_Array_0[0][0]) {
	...
	if ((unsigned_long_int_Array_0[1][1] * unsigned_long_int_Array_0[0][1]) <= unsigned_long_int_Array_0[1][0]) {
		if ((signed_char_Array_0[0] - (abs (-1))) <= (unsigned_long_int_Array_0[1][1] * signed_char_Array_0[1])) {
...
int property(void) {
	return (((((BOOL_unsigned_char_Array_0[0] ? (unsigned_long_int_Array_0[1][1] == ((unsigned long int) (abs (unsigned_long_int_Array_0[0][1] - unsigned_long_int_Array_0[1][0])))) : 1) && ((-8 < unsigned_long_int_Array_0[1][0]) ? ((unsigned_long_int_Array_0[1][0] != unsigned_long_int_Array_0[0][0]) ? (signed_char_Array_0[4] == ((signed char) ((abs (signed_char_Array_0[3])) - ((min (signed_char_Array_0[2] , signed_char_Array_0[1])) + signed_char_Array_0[0])))) : (signed_char_Array_0[4] == ((signed char) -8))) : (signed_char_Array_0[4] == ((signed char) signed_char_Array_0[1])))) && (((unsigned_long_int_Array_0[1][1] * unsigned_long_int_Array_0[0][1]) <= unsigned_long_int_Array_0[1][0]) ? (((signed_char_Array_0[0] - (abs (-1))) <= (unsigned_long_int_Array_0[1][1] * signed_char_Array_0[1])) ? (signed_long_int_Array_0[1] == ((signed long int) (signed_char_Array_0[1] - signed_char_Array_0[0]))) : (signed_long_int_Array_0[1] == ((signed long int) signed_char_Array_0[2]))) : (signed_long_int_Array_0[1] == ((signed long int) signed_char_Array_0[2])))) && (signed_long_int_Array_0[0] == ((signed long int) signed_char_Array_0[1]))) && (BOOL_unsigned_char_Array_0[0] == ((unsigned char) BOOL_unsigned_char_Array_0[1]))) && (unsigned_long_int_Array_0[0][0] == ((unsigned long int) signed_char_Array_0[0]))
;
}
int main(void) {
	isInitial = 1;
