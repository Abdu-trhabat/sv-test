...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch191stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch191stepLocals
	signed long int stepLocal_0 = max ((max (var_1_3 , var_1_4)) , var_1_5);
	...
	// From: Req3Batch191stepLocals
	unsigned char stepLocal_1 = var_1_6 >= (min (var_1_9 , var_1_1));
	if (stepLocal_1 && var_1_8) {
		var_1_10 = (abs (max (var_1_6 , var_1_7)));
	}


	// From: Req4Batch191stepLocals
	if (var_1_8) {
		if (! (! (var_1_3 < var_1_5))) {
	...
	// From: Req5Batch191stepLocals
	if (var_1_9 > var_1_10) {
		var_1_15 = (10 + var_1_16);
	}


	// From: Req6Batch191stepLocals
	var_1_17 = (var_1_18 + var_1_19);


	// From: Req7Batch191stepLocals
	var_1_20 = (var_1_21 - (var_1_22 + var_1_23));


	// From: Req8Batch191stepLocals
	unsigned char stepLocal_2 = var_1_11;
	if ((var_1_20 == (var_1_2 * var_1_22)) || stepLocal_2) {
		var_1_24 = var_1_18;
	}


	// From: Req9Batch191stepLocals
	if ((var_1_4 < var_1_5) || var_1_13) {
		var_1_25 = (((var_1_7 | var_1_22) > var_1_15) && ((var_1_19 < var_1_18) && var_1_26));
	}
}
