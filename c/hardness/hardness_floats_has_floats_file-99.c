...
void step(void) {
	...
	if (var_1_9) {
		...
		var_1_8 = (abs (var_1_12));
	}


	// From: Req5Batch99has_floats
	var_1_19 = var_1_12;
	...
	if (var_1_8 < stepLocal_0) {
		if (stepLocal_1 == (abs (var_1_4))) {
			var_1_1 = var_1_5;
		} else {
			var_1_1 = ((max (var_1_6 , var_1_7)) - (abs (var_1_5)));
		}
	} else {
		var_1_1 = 1.0f;
	}
	...
	if (var_1_1 < (var_1_5 / (min (var_1_14 , var_1_15)))) {
		if (var_1_9) {
			var_1_13 = (max (var_1_10 , var_1_8));
		} else {
...
int property(void) {
	return (((((var_1_8 < var_1_19) ? ((var_1_8 == (abs (var_1_4))) ? (var_1_1 == ((float) var_1_5)) : (var_1_1 == ((float) ((max (var_1_6 , var_1_7)) - (abs (var_1_5)))))) : (var_1_1 == ((float) 1.0f))) && (var_1_9 ? (var_1_8 == ((unsigned char) (var_1_10 - (var_1_11 - var_1_12)))) : (var_1_8 == ((unsigned char) (abs (var_1_12)))))) && ((var_1_1 < (var_1_5 / (min (var_1_14 , var_1_15)))) ? (var_1_9 ? (var_1_13 == ((unsigned short int) (max (var_1_10 , var_1_8)))) : (var_1_13 == ((unsigned short int) (var_1_16 - var_1_8)))) : (var_1_17 ? (var_1_13 == ((unsigned short int) var_1_11)) : 1))) && (var_1_18 == ((signed short int) var_1_13))) && (var_1_19 == ((signed short int) var_1_12))
;
}
int main(void) {
	isInitial = 1;
