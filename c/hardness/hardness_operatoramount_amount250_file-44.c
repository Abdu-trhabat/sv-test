...
void step(void) {
	...
	if (((max (var_1_32 , 4)) - var_1_33) <= var_1_24) {
		if (! var_1_4) {
			if (var_1_39 >= (var_1_51 - (var_1_41 - var_1_21))) {
				...
				var_1_50 = ((min (var_1_33 , (max (last_1_var_1_23 , last_1_var_1_38)))) - (var_1_31 + var_1_24));
			}
		} else {
			var_1_50 = ((abs (min (last_1_var_1_49 , 4))) - ((min (last_1_var_1_38 , last_1_var_1_45)) + (max (last_1_var_1_23 , var_1_40))));
		}
	}
	...
	if (var_1_35 >= var_1_16) {
		if (last_1_var_1_25 <= var_1_37) {
			var_1_53 = (((var_1_48 - var_1_21) + (var_1_33 + var_1_24)) + (last_1_var_1_20 + (min (32 , -5))));
		}
	} else {
		var_1_53 = (((max (1692685638 , var_1_54)) - var_1_32) - (abs (last_1_var_1_63)));
	}
			...
			if (var_1_15 <= last_1_var_1_64) {
				if (stepLocal_7 <= ((1687852967 - var_1_40) >> var_1_33)) {
					if (var_1_33 < stepLocal_9) {
						var_1_38 = ((max (var_1_7 , (var_1_41 - last_1_var_1_38))) + var_1_24);
					}
				} else {
					if (var_1_4) {
						var_1_38 = (((max (var_1_41 , var_1_42)) - last_1_var_1_38) + var_1_43);
					}
				}
			} else {
	...
	if (var_1_21 < (- var_1_38)) {
		if ((var_1_51 - var_1_32) < var_1_60) {
			var_1_65 = (max ((max (var_1_15 , var_1_17)) , 1.9f));
		}
	} else {
		if (var_1_1) {
			var_1_65 = var_1_18;
	...
	if ((- var_1_65) < (min (var_1_17 , var_1_29))) {
		var_1_56 = (! var_1_28);
	}
	...
	if (var_1_45 <= (var_1_30 % (max (var_1_33 , var_1_58)))) {
		...
		if (((min (var_1_51 , var_1_45)) + var_1_45) >= (var_1_59 / var_1_30)) {
...
int property(void) {
	return ((((((((((((((((((((((((var_1_38 >= var_1_53) ? (var_1_1 == ((unsigned char) (! var_1_4))) : 1) && ((var_1_50 <= (var_1_6 - var_1_7)) ? (var_1_5 == ((unsigned char) (var_1_56 || var_1_4))) : (var_1_5 == ((unsigned char) (! (! var_1_8)))))) && (var_1_9 == ((signed short int) (min (-10 , var_1_10))))) && (var_1_11 == ((unsigned char) ((var_1_8 || var_1_4) && var_1_12)))) && (var_1_1 ? ((var_1_7 > var_1_50) ? (var_1_13 == ((float) (max (var_1_15 , var_1_16)))) : 1) : (var_1_13 == ((float) (abs (var_1_17 - (var_1_18 - var_1_19))))))) && (var_1_20 == ((unsigned short int) (45013 - var_1_21)))) && (var_1_22 == ((float) (max ((max ((max (var_1_15 , var_1_16)) , var_1_19)) , var_1_17))))) && (((9999999.6 / var_1_18) > var_1_16) ? (var_1_23 == ((unsigned short int) (abs (var_1_21 + var_1_24)))) : 1)) && (var_1_25 == ((double) (max (((max (var_1_19 , 999.5)) - var_1_17) , var_1_16))))) && (((var_1_24 * var_1_53) > (var_1_27 - var_1_20)) ? (var_1_26 == ((unsigned char) (! ((var_1_4 && var_1_12) && var_1_28)))) : 1)) && (var_1_12 ? ((var_1_27 <= (var_1_38 >> var_1_30)) ? ((((var_1_30 + var_1_31) - var_1_21) >= 128) ? (((var_1_24 - var_1_7) <= (var_1_63 >> (var_1_32 + var_1_33))) ? (var_1_29 == ((double) (-0.4 + var_1_19))) : (var_1_29 == ((double) (((min (var_1_18 , var_1_34)) - var_1_19) - ((var_1_35 + var_1_36) + var_1_37))))) : 1) : 1) : 1)) && ((var_1_17 >= (- var_1_34)) ? ((var_1_27 <= -1) ? (((~ var_1_30) > (var_1_31 & (var_1_27 * var_1_6))) ? (var_1_38 == ((unsigned long int) var_1_24)) : 1) : (var_1_38 == ((unsigned long int) ((var_1_39 - (last_1_var_1_38 + 500u)) - 4u)))) : ((last_1_var_1_23 <= (last_1_var_1_53 ^ var_1_32)) ? ((var_1_15 <= last_1_var_1_64) ? (((var_1_24 * last_1_var_1_53) <= ((1687852967 - var_1_40) >> var_1_33)) ? ((var_1_33 < var_1_21) ? (var_1_38 == ((unsigned long int) ((max (var_1_7 , (var_1_41 - last_1_var_1_38))) + var_1_24))) : 1) : (var_1_4 ? (var_1_38 == ((unsigned long int) (((max (var_1_41 , var_1_42)) - last_1_var_1_38) + var_1_43))) : 1)) : (var_1_38 == ((unsigned long int) (abs (max (var_1_7 , var_1_44)))))) : 1))) && (var_1_11 ? ((! (var_1_55 < (var_1_35 * 2.8f))) ? (var_1_45 == ((unsigned short int) (61202 - 5))) : 1) : 1)) && (((max (32 , var_1_38)) >= var_1_50) ? ((128.25f > var_1_37) ? (var_1_47 == ((signed short int) (min (((var_1_32 + -64) + var_1_31) , (max (var_1_30 , var_1_10)))))) : (var_1_47 == ((signed short int) (abs (var_1_32))))) : (var_1_47 == ((signed short int) (max ((abs (var_1_33)) , (max (var_1_10 , var_1_32)))))))) && ((var_1_38 < -32) ? (var_1_26 ? (var_1_49 == ((signed char) ((max (-4 , (var_1_30 - 4))) + var_1_32))) : 1) : 1)) && ((((max (var_1_32 , 4)) - var_1_33) <= var_1_24) ? ((! var_1_4) ? ((var_1_39 >= (var_1_51 - (var_1_41 - var_1_21))) ? ((last_1_var_1_23 >= var_1_27) ? ((last_1_var_1_23 == (last_1_var_1_61 + (last_1_var_1_45 / var_1_33))) ? (var_1_50 == ((signed long int) ((max (var_1_21 , var_1_24)) - var_1_30))) : (var_1_50 == ((signed long int) (abs (var_1_39))))) : (var_1_50 == ((signed long int) var_1_52))) : (var_1_50 == ((signed long int) ((min (var_1_33 , (max (last_1_var_1_23 , last_1_var_1_38)))) - (var_1_31 + var_1_24))))) : (var_1_50 == ((signed long int) ((abs (min (last_1_var_1_49 , 4))) - ((min (last_1_var_1_38 , last_1_var_1_45)) + (max (last_1_var_1_23 , var_1_40))))))) : 1)) && ((var_1_35 >= var_1_16) ? ((last_1_var_1_25 <= var_1_37) ? (var_1_53 == ((signed long int) (((var_1_48 - var_1_21) + (var_1_33 + var_1_24)) + (last_1_var_1_20 + (min (32 , -5)))))) : 1) : (var_1_53 == ((signed long int) (((max (1692685638 , var_1_54)) - var_1_32) - (abs (last_1_var_1_63))))))) && ((var_1_10 < var_1_30) ? (var_1_55 == ((double) var_1_16)) : (var_1_55 == ((double) (var_1_34 - var_1_37))))) && (((- var_1_65) < (min (var_1_17 , var_1_29))) ? (var_1_56 == ((unsigned char) (! var_1_28))) : 1)) && ((var_1_45 <= (var_1_30 % (max (var_1_33 , var_1_58)))) ? ((var_1_51 > (var_1_33 * (var_1_3 + var_1_2))) ? (var_1_57 == ((signed char) (abs (abs (var_1_30 - var_1_33))))) : (var_1_57 == ((signed char) var_1_33))) : ((((min (var_1_51 , var_1_45)) + var_1_45) >= (var_1_59 / var_1_30)) ? (((var_1_5 && var_1_28) || var_1_12) ? (var_1_57 == ((signed char) ((var_1_33 + var_1_60) - (var_1_30 + var_1_32)))) : 1) : 1))) && ((var_1_24 > var_1_33) ? (var_1_4 ? (var_1_61 == ((signed short int) var_1_9)) : (((var_1_47 | 32) <= last_1_var_1_61) ? (var_1_61 == ((signed short int) var_1_30)) : (var_1_61 == ((signed short int) var_1_60)))) : (var_1_61 == ((signed short int) var_1_33)))) && (last_1_var_1_5 ? (var_1_63 == ((unsigned short int) var_1_60)) : 1)) && (var_1_64 == ((float) var_1_19))) && ((var_1_21 < (- var_1_38)) ? (((var_1_51 - var_1_32) < var_1_60) ? (var_1_65 == ((float) (max ((max (var_1_15 , var_1_17)) , 1.9f)))) : 1) : (var_1_1 ? (var_1_65 == ((float) var_1_18)) : 1))
;
}
int main(void) {
	isInitial = 1;
