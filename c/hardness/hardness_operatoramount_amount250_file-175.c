...
void step(void) {
	// From: Req12Batch175Amount250
	signed long int stepLocal_15 = var_1_35;
	signed long int stepLocal_14 = last_1_var_1_12;
	if (stepLocal_14 < (max (var_1_41 , var_1_35))) {
		var_1_44 = last_1_var_1_28;
	} else {
		if (stepLocal_15 >= (~ -10)) {
			var_1_44 = ((var_1_45 - (min (var_1_41 , last_1_var_1_46))) - var_1_43);
		} else {
	...
	// From: Req18Batch175Amount250
	signed long int stepLocal_22 = var_1_11 % (min (var_1_42 , var_1_45));
	if (stepLocal_22 <= ((max (5 , var_1_22)) / (min (var_1_49 , var_1_5)))) {
		var_1_63 = var_1_38;
	} else {
	...
	// From: Req5Batch175Amount250
	unsigned long int stepLocal_9 = (var_1_5 * var_1_63) | var_1_24;
	if ((var_1_11 * var_1_63) >= stepLocal_9) {
		var_1_26 = (var_1_10 - (abs (var_1_5)));
	} else {
		var_1_26 = ((min (var_1_6 , (min (var_1_22 , var_1_8)))) + var_1_5);
	}


	// From: Req13Batch175Amount250
	unsigned char stepLocal_16 = var_1_63 < 256;
	if ((abs (var_1_34)) < (var_1_31 / (max (var_1_47 , var_1_48)))) {
		if (stepLocal_16 && (! (var_1_47 < var_1_31))) {
			var_1_46 = (200 - (abs (var_1_43)));
		} else {
			var_1_46 = ((var_1_49 - var_1_43) + (max (var_1_41 , var_1_42)));
		}
	}


	// From: Req9Batch175Amount250
	...
	if ((10000.25f - var_1_34) < var_1_31) {
		...
		var_1_33 = (8 - (min (var_1_8 , (var_1_10 + var_1_35))));
	}


	// From: Req15Batch175Amount250
	unsigned char stepLocal_19 = (var_1_11 - var_1_41) > var_1_63;
	if (var_1_18 || stepLocal_19) {
		var_1_58 = var_1_43;
	} else {
		var_1_58 = (var_1_41 + (abs (var_1_6)));
	}


	// From: Req1Batch175Amount250
	...
	if (var_1_10 < stepLocal_8) {
		if (((var_1_22 - var_1_6) << var_1_2) <= stepLocal_7) {
			var_1_21 = (min ((min (var_1_5 , var_1_1)) , (var_1_23 - var_1_24)));
		} else {
	...
	// From: Req2Batch175Amount250
	unsigned char stepLocal_2 = var_1_13;
	if (stepLocal_2 && (var_1_14 && var_1_15)) {
		var_1_12 = (max ((var_1_5 + var_1_26) , (max (var_1_8 , (var_1_10 - var_1_11)))));
	} else {
		var_1_12 = (min (var_1_26 , (abs (var_1_8))));
	}


	// From: Req6Batch175Amount250
	...
	// From: Req14Batch175Amount250
	signed long int stepLocal_18 = var_1_12;
	unsigned long int stepLocal_17 = max (var_1_5 , var_1_63);
	if (var_1_8 != stepLocal_18) {
		if (var_1_16) {
			if (var_1_16) {
				var_1_50 = ((max ((var_1_51 - var_1_52) , (var_1_53 + var_1_54))) - (min (var_1_55 , (var_1_56 - var_1_57))));
			} else {
				var_1_50 = ((max (var_1_52 , (var_1_54 + var_1_53))) - var_1_51);
			}
		}
	} else {
		if (stepLocal_17 == (var_1_23 - var_1_43)) {
			var_1_50 = (max (var_1_54 , var_1_31));
		} else {
			var_1_50 = (min ((max ((3.8 - var_1_56) , var_1_57)) , var_1_52));
		}
	}


	// From: Req8Batch175Amount250
	...
	// From: Req11Batch175Amount250
	if (var_1_16) {
		var_1_39 = (max (5 , var_1_6));
	} else {
		var_1_39 = (((max (var_1_40 , var_1_41)) + (var_1_42 - var_1_43)) + var_1_6);
	}


	// From: Req16Batch175Amount250
	...
	if (var_1_29 && stepLocal_21) {
		if ((var_1_15 && var_1_16) && stepLocal_20) {
			if (var_1_20) {
				var_1_59 = (abs (var_1_54));
			}
		}
	}


	// From: Req17Batch175Amount250
	if (var_1_61) {
	...
	// From: Req10Batch175Amount250
	if (! var_1_16) {
		if (var_1_44 < -2) {
			if (var_1_16) {
				if (var_1_9 <= (min (var_1_21 , last_1_var_1_36))) {
					if ((var_1_28 >= (var_1_11 + var_1_12)) && var_1_16) {
						var_1_36 = ((var_1_10 + var_1_11) + (abs (var_1_25 - var_1_6)));
					} else {
						var_1_36 = (((var_1_38 - var_1_21) + var_1_25) - 10000000u);
					}
				}
			} else {
				var_1_36 = (max (var_1_25 , var_1_9));
			}
		}
	} else {
...
int property(void) {
	return (((((((((((((((((((var_1_2 - var_1_3) <= var_1_28) ? (((var_1_5 - var_1_6) != (var_1_63 * var_1_28)) ? (var_1_1 == ((unsigned short int) (min (((max (var_1_6 , var_1_5)) + (max (var_1_8 , 256))) , var_1_9)))) : (var_1_1 == ((unsigned short int) ((max (var_1_10 , (var_1_11 - var_1_6))) - (max (var_1_8 , var_1_5)))))) : 1) && ((var_1_13 && (var_1_14 && var_1_15)) ? (var_1_12 == ((signed long int) (max ((var_1_5 + var_1_26) , (max (var_1_8 , (var_1_10 - var_1_11))))))) : (var_1_12 == ((signed long int) (min (var_1_26 , (abs (var_1_8)))))))) && ((var_1_3 >= var_1_10) ? (((var_1_5 - var_1_8) > (var_1_33 + (var_1_10 + var_1_63))) ? (var_1_16 == ((unsigned char) (((var_1_8 / var_1_17) < var_1_63) || (var_1_18 && var_1_19)))) : (((var_1_1 * var_1_21) > var_1_9) ? (var_1_16 == ((unsigned char) (var_1_18 && var_1_19))) : 1)) : ((var_1_9 > var_1_10) ? (var_1_16 == ((unsigned char) var_1_19)) : (var_1_16 == ((unsigned char) var_1_20))))) && ((var_1_10 < 0) ? ((((var_1_22 - var_1_6) << var_1_2) <= var_1_5) ? (var_1_21 == ((unsigned long int) (min ((min (var_1_5 , var_1_1)) , (var_1_23 - var_1_24))))) : (var_1_21 == ((unsigned long int) (((2072066314u - var_1_11) + var_1_25) - (8u + var_1_8))))) : (var_1_21 == ((unsigned long int) (var_1_23 - var_1_10))))) && (((var_1_11 * var_1_63) >= ((var_1_5 * var_1_63) | var_1_24)) ? (var_1_26 == ((unsigned short int) (var_1_10 - (abs (var_1_5))))) : (var_1_26 == ((unsigned short int) ((min (var_1_6 , (min (var_1_22 , var_1_8)))) + var_1_5))))) && ((var_1_25 < var_1_24) ? ((var_1_11 < (var_1_25 / var_1_5)) ? (var_1_27 == ((signed short int) var_1_17)) : (var_1_27 == ((signed short int) (max (-25 , var_1_6))))) : ((var_1_2 < (var_1_33 / var_1_11)) ? (var_1_27 == ((signed short int) var_1_11)) : (var_1_27 == ((signed short int) var_1_17))))) && (last_1_var_1_16 ? ((var_1_22 > var_1_8) ? (var_1_28 == ((signed long int) (var_1_5 + (last_1_var_1_44 + var_1_9)))) : 1) : (var_1_28 == ((signed long int) last_1_var_1_28)))) && ((var_1_13 && var_1_16) ? (var_1_30 == ((double) (0.75 - 9.999999999995E11))) : (var_1_30 == ((double) (min (var_1_31 , var_1_32)))))) && (((10000.25f - var_1_34) < var_1_31) ? ((var_1_20 && var_1_18) ? (var_1_33 == ((signed long int) (var_1_8 - var_1_6))) : (var_1_33 == ((signed long int) var_1_9))) : (var_1_33 == ((signed long int) (8 - (min (var_1_8 , (var_1_10 + var_1_35)))))))) && ((! var_1_16) ? ((var_1_44 < -2) ? (var_1_16 ? ((var_1_9 <= (min (var_1_21 , last_1_var_1_36))) ? (((var_1_28 >= (var_1_11 + var_1_12)) && var_1_16) ? (var_1_36 == ((unsigned long int) ((var_1_10 + var_1_11) + (abs (var_1_25 - var_1_6))))) : (var_1_36 == ((unsigned long int) (((var_1_38 - var_1_21) + var_1_25) - 10000000u)))) : 1) : (var_1_36 == ((unsigned long int) (max (var_1_25 , var_1_9))))) : 1) : (var_1_36 == ((unsigned long int) (var_1_23 - var_1_21))))) && (var_1_16 ? (var_1_39 == ((unsigned char) (max (5 , var_1_6)))) : (var_1_39 == ((unsigned char) (((max (var_1_40 , var_1_41)) + (var_1_42 - var_1_43)) + var_1_6))))) && ((last_1_var_1_12 < (max (var_1_41 , var_1_35))) ? (var_1_44 == ((signed long int) last_1_var_1_28)) : ((var_1_35 >= (~ -10)) ? (var_1_44 == ((signed long int) ((var_1_45 - (min (var_1_41 , last_1_var_1_46))) - var_1_43))) : ((last_1_var_1_50 >= var_1_34) ? (var_1_19 ? (var_1_44 == ((signed long int) ((last_1_var_1_26 + (var_1_5 + var_1_22)) + (last_1_var_1_36 - 32)))) : 1) : (var_1_44 == ((signed long int) (last_1_var_1_46 - (16 + (var_1_40 + 8))))))))) && (((abs (var_1_34)) < (var_1_31 / (max (var_1_47 , var_1_48)))) ? (((var_1_63 < 256) && (! (var_1_47 < var_1_31))) ? (var_1_46 == ((unsigned char) (200 - (abs (var_1_43))))) : (var_1_46 == ((unsigned char) ((var_1_49 - var_1_43) + (max (var_1_41 , var_1_42)))))) : 1)) && ((var_1_8 != var_1_12) ? (var_1_16 ? (var_1_16 ? (var_1_50 == ((double) ((max ((var_1_51 - var_1_52) , (var_1_53 + var_1_54))) - (min (var_1_55 , (var_1_56 - var_1_57)))))) : (var_1_50 == ((double) ((max (var_1_52 , (var_1_54 + var_1_53))) - var_1_51)))) : 1) : (((max (var_1_5 , var_1_63)) == (var_1_23 - var_1_43)) ? (var_1_50 == ((double) (max (var_1_54 , var_1_31)))) : (var_1_50 == ((double) (min ((max ((3.8 - var_1_56) , var_1_57)) , var_1_52))))))) && ((var_1_18 || ((var_1_11 - var_1_41) > var_1_63)) ? (var_1_58 == ((unsigned char) var_1_43)) : (var_1_58 == ((unsigned char) (var_1_41 + (abs (var_1_6))))))) && ((var_1_29 && var_1_13) ? (((var_1_15 && var_1_16) && var_1_29) ? (var_1_20 ? (var_1_59 == ((double) (abs (var_1_54)))) : 1) : 1) : 1)) && (var_1_61 ? ((var_1_55 == var_1_50) ? ((var_1_13 || var_1_14) ? (var_1_60 == ((unsigned char) (var_1_62 - var_1_6))) : (var_1_60 == ((unsigned char) (var_1_6 + var_1_42)))) : (var_1_19 ? (var_1_60 == ((unsigned char) var_1_43)) : (var_1_60 == ((unsigned char) var_1_41)))) : (var_1_60 == ((unsigned char) var_1_40)))) && (((var_1_11 % (min (var_1_42 , var_1_45))) <= ((max (5 , var_1_22)) / (min (var_1_49 , var_1_5)))) ? (var_1_63 == ((unsigned long int) var_1_38)) : (var_1_63 == ((unsigned long int) last_1_var_1_28)))
;
}
int main(void) {
	isInitial = 1;
