...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch97Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (127.5f > (*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer))) {
		...
		(*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) = (((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) >= (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))) || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer)));
	}
