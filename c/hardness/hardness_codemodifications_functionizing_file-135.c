...
void functionized0(unsigned char functionized0_localFunctionVar0, signed long int functionized0_localFunctionVar1, signed long int functionized0_localFunctionVar2, signed long int functionized0_localFunctionVar3) {
	if (functionized0_localFunctionVar0) {
		var_1_7 = (max ((max ((functionized0_localFunctionVar3 - functionized0_localFunctionVar2) , functionized0_localFunctionVar1)) , (abs (10))));
	} else {
...
double functionized4(double functionized4_localFunctionVar0, double functionized4_localFunctionVar1) {
	return (min (functionized4_localFunctionVar0 , functionized4_localFunctionVar1));
}
...
void step(void) {
	// From: Req1Batch135functionizing
	if (var_1_2 > ((var_1_3 * var_1_4) * var_1_5)) {
		var_1_1 = (abs (var_1_6));
	}


	// From: Req2Batch135functionizing
	functionized0(var_1_8, var_1_11, var_1_10, var_1_9);


	// From: Req3Batch135functionizing
	...
	// From: Req4Batch135functionizing
	if (var_1_8) {
	...
	// From: Req7Batch135functionizing
	if (4u >= var_1_4) {
		if (var_1_23 && var_1_16) {
			var_1_28 = (max (var_1_18 , var_1_10));
		} else {
			var_1_28 = var_1_18;
		}
	} else {
...
int property(void) {
	return (((((((var_1_2 > ((var_1_3 * var_1_4) * var_1_5)) ? (var_1_1 == ((double) (abs (var_1_6)))) : 1) && (var_1_8 ? (var_1_7 == ((signed long int) (max ((max ((var_1_9 - var_1_10) , var_1_11)) , (abs (10)))))) : (var_1_7 == ((signed long int) var_1_11)))) && (((var_1_4 | (var_1_2 + var_1_10)) >= var_1_3) ? (var_1_8 ? (var_1_12 == ((signed short int) var_1_13)) : 1) : 1)) && (var_1_8 ? (var_1_14 == ((signed short int) (4 - (abs (var_1_15))))) : (var_1_16 ? (var_1_14 == ((signed short int) (max ((var_1_17 - var_1_18) , var_1_19)))) : (var_1_14 == ((signed short int) var_1_18))))) && (((- (var_1_6 * var_1_1)) < var_1_21) ? (var_1_20 == ((double) (min (var_1_6 , var_1_22)))) : 1)) && ((var_1_7 < (var_1_19 / var_1_24)) ? ((var_1_5 > var_1_18) ? (var_1_23 == ((unsigned char) (! (var_1_25 && var_1_26)))) : (var_1_23 == ((unsigned char) var_1_26))) : (var_1_23 == ((unsigned char) var_1_27)))) && ((4u >= var_1_4) ? ((var_1_23 && var_1_16) ? (var_1_28 == ((unsigned long int) (max (var_1_18 , var_1_10)))) : (var_1_28 == ((unsigned long int) var_1_18))) : (var_1_28 == ((unsigned long int) var_1_10)))
;
}
int main(void) {
	isInitial = 1;
