...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch87dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch87dependencies
	if ((var_1_2 - var_1_3) >= (var_1_5 - (min (var_1_6 , var_1_7)))) {
		var_1_1 = (((var_1_4 || var_1_8) && var_1_9) || var_1_10);
	}


	// From: Req2Batch87dependencies
	var_1_11 = (max ((max (var_1_12 , var_1_13)) , (var_1_14 - (5.86478081602821E18 - var_1_15))));


	// From: Req3Batch87dependencies
	...
	// From: Req4Batch87dependencies
	if (var_1_3 < var_1_5) {
		var_1_21 = var_1_14;
	}


	// From: Req5Batch87dependencies
