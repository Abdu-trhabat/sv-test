...
void functionized3(signed short int functionized3_localFunctionVar0) {
	if ((min ((var_1_18 >> var_1_20) , functionized3_localFunctionVar0)) < var_1_17) {
		var_1_19 = var_1_18;
	}
}
...
void step(void) {
	// From: Req1Batch145functionizing
	if (var_1_2) {
		if (var_1_3 == var_1_4) {
	...
	// From: Req2Batch145functionizing
	...
	// From: Req3Batch145functionizing
	...
	// From: Req4Batch145functionizing
	var_1_16 = (min (var_1_17 , var_1_18));


	// From: Req5Batch145functionizing
	functionized3(var_1_5);


	// From: Req6Batch145functionizing
	if (! var_1_11) {
	...
	// From: Req7Batch145functionizing
	var_1_23 = (var_1_24 - var_1_7);


	// From: Req8Batch145functionizing
