    ...
    var_1_42
                   ...
                   if ( ((var_1_5) < ( ((var_1_46) | (var_1_6))))) {
                    ...
                    if (var_1_15) {
                     if (var_1_42) {
                      var_1_48 = (
                       ((((( ((((( var_1_44 )) < (( var_1_46 ))) ? (( var_1_44 )) : (( var_1_46 )))) )) < (( var_1_20 ))) ? (( ((((( var_1_44 )) < (( var_1_46 ))) ? (( var_1_44 )) : (( var_1_46 )))) )) : (( var_1_20 ))))
    );
   } else {
                      var_1_48 = (
                       (((((( var_1_49 ) - ( var_1_20 ))) < 0 ) ? -((( var_1_49 ) - ( var_1_20 ))) : ((( var_1_49 ) - ( var_1_20 )))))
    );
   }
  } else {
                     if (var_1_36) {
