...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch108Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch108Wrapper_S
	if ((WrapperStruct00.var_1_3 * WrapperStruct00.var_1_12) != (WrapperStruct00.var_1_2 & WrapperStruct00.var_1_13)) {
		WrapperStruct00.var_1_11 = (max (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_15));
	} else {
		WrapperStruct00.var_1_11 = (100 + WrapperStruct00.var_1_16);
	}


	// From: Req3Batch108Wrapper_S
	if (WrapperStruct00.var_1_4) {
		WrapperStruct00.var_1_17 = (max ((max (WrapperStruct00.var_1_6 , WrapperStruct00.var_1_10)) , WrapperStruct00.var_1_7));
	}


	// From: Req1Batch108Wrapper_S
	unsigned char stepLocal_1 = (WrapperStruct00.var_1_11 * -2) != WrapperStruct00.var_1_3;
	...
	if (stepLocal_1 || WrapperStruct00.var_1_4) {
		if (WrapperStruct00.var_1_11 > stepLocal_0) {
			if (! (WrapperStruct00.var_1_3 > WrapperStruct00.var_1_11)) {
				WrapperStruct00.var_1_1 = ((max (WrapperStruct00.var_1_5 , (WrapperStruct00.var_1_6 - WrapperStruct00.var_1_7))) + ((WrapperStruct00.var_1_8 + WrapperStruct00.var_1_9) + WrapperStruct00.var_1_10));
			} else {
...
int property(void) {
	return (((((WrapperStruct00.var_1_11 * -2) != WrapperStruct00.var_1_3) || WrapperStruct00.var_1_4) ? ((WrapperStruct00.var_1_11 > WrapperStruct00.var_1_3) ? ((! (WrapperStruct00.var_1_3 > WrapperStruct00.var_1_11)) ? (WrapperStruct00.var_1_1 == ((float) ((max (WrapperStruct00.var_1_5 , (WrapperStruct00.var_1_6 - WrapperStruct00.var_1_7))) + ((WrapperStruct00.var_1_8 + WrapperStruct00.var_1_9) + WrapperStruct00.var_1_10)))) : (WrapperStruct00.var_1_1 == ((float) WrapperStruct00.var_1_7))) : (WrapperStruct00.var_1_1 == ((float) WrapperStruct00.var_1_9))) : (WrapperStruct00.var_1_1 == ((float) WrapperStruct00.var_1_8))) && (((WrapperStruct00.var_1_3 * WrapperStruct00.var_1_12) != (WrapperStruct00.var_1_2 & WrapperStruct00.var_1_13)) ? (WrapperStruct00.var_1_11 == ((unsigned char) (max (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_15)))) : (WrapperStruct00.var_1_11 == ((unsigned char) (100 + WrapperStruct00.var_1_16))))) && (WrapperStruct00.var_1_4 ? (WrapperStruct00.var_1_17 == ((float) (max ((max (WrapperStruct00.var_1_6 , WrapperStruct00.var_1_10)) , WrapperStruct00.var_1_7)))) : 1)
;
}
int main(void) {
	isInitial = 1;
