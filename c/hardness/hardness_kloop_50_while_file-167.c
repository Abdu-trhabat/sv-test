...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16750_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch16750_while
	var_1_20 = ((var_1_21 + 16) + (var_1_22 + var_1_23));


	// From: Req6Batch16750_while
