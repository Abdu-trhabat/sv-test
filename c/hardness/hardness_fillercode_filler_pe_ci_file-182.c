...
void step(void) {
	...
	/* 268L, 68L) */ if (/* 269L, 32L, 33L) */ ((var_1_29) > (var_1_27))) {
		/* 272L, 66L) */ if (/* 273L, 42L, 43L) */ ((var_1_5) < (/* 275L, 41L, 45L) */ (abs (var_1_6))))) {
	...
	// From: CodeObject7
	/* 348L, 205L) */ if (/* 349L, 188L, 189L) */ ((var_1_3) >= (/* 351L, 187L, 191L) */ ((8) % (var_1_40))))) {
		/* 354L, 204L) */ var_1_43 = (
			/* 357L, 203L) */ (min (
				/* 357L, 203L) */ (
					100.25f
	...
	// From: CodeObject8
	/* 370L, 227L) */ if (var_1_9) {
		/* 372L, 225L) */ if (/* 373L, 214L, 215L) */ ((var_1_3) >= (var_1_27))) {
			/* 376L, 224L) */ var_1_44 = (
				var_1_46
			);
		}
...
int property(void) {
	if (/* 386L, 8L, 16L, 316L, 331L, 1014L) */ ((/* 387L, 6L, 17L, 317L, 332L, 1015L) */ ((/* 388L, 4L, 18L, 318L, 333L, 1016L) */ ((var_1_20) * (16))) / (var_1_3))) <= (var_1_20))) {
	}
	if (/* 403L, 37L, 41L, 406L, 435L, 1031L) */ ((var_1_1) >= (var_1_13))) {
		if (var_1_9) {
		} else {
			if (/* 417L, 57L, 61L, 420L, 449L, 1045L) */ ((var_1_3) >= (var_1_20))) {
			} else {
			}
		}
	}
	if (/* 432L, 90L, 96L, 490L, 503L, 1060L) */ ((/* 433L, 88L, 97L, 491L, 504L, 1061L) */ ((var_1_14) - (var_1_15))) != (var_1_20))) {
	}
	if (/* 443L, 121L, 129L, 548L, 565L, 1071L) */ ((/* 444L, 117L, 130L, 549L, 566L, 1072L) */ ((var_1_12) - (var_1_11))) >= (/* 447L, 120L, 133L, 552L, 569L, 1075L) */ ((var_1_10) / (var_1_17))))) {
	}
	if (/* 460L, 152L, 156L, 632L, 657L, 1088L) */ ((var_1_17) >= (var_1_12))) {
		if (/* 464L, 167L, 177L, 636L, 661L, 1092L) */ ((var_1_21) != (/* 466L, 166L, 179L, 638L, 663L, 1094L) */ ((/* 467L, 162L, 180L, 639L, 664L, 1095L) */ (max (/* 467L, 162L, 180L, 639L, 664L, 1095L) */ (var_1_14) , (var_1_22)))) - (/* 470L, 165L, 183L, 642L, 667L, 1098L) */ ((5) + (var_1_23))))))) {
		} else {
		}
	}
	if (/* 485L, 206L, 210L, 716L, 733L, 1113L) */ ((var_1_10) < (var_1_12))) {
	} else {
	}
	if (/* 505L, 239L, 249L, 809L, 837L, 1133L) */ ((/* 506L, 233L, 250L, 810L, 838L, 1134L) */ (max (/* 506L, 233L, 250L, 810L, 838L, 1134L) */ (var_1_1) , (var_1_17)))) >= (/* 509L, 238L, 253L, 813L, 841L, 1137L) */ ((var_1_10) + (/* 511L, 237L, 255L, 815L, 843L, 1139L) */ ((var_1_13) / (128.9f))))))) {
		if (var_1_9) {
		} else {
		}
	} else {
	...
	/* 533L) */ ((
		/* 532L) */ ((
			/* 531L) */ ((
				/* 530L) */ ((
					/* 529L) */ ((
						/* 385L, 30L, 315L, 330L, 1013L) */ ((
							/* 386L, 8L, 16L, 316L, 331L, 1014L) */ ((
								/* 387L, 6L, 17L, 317L, 332L, 1015L) */ ((
									/* 388L, 4L, 18L, 318L, 333L, 1016L) */ ((
										var_1_20
									) * (
										16
									))
							...
							/* 393L, 28L, 323L, 338L, 1021L) */ ((
								var_1_1
							) == (
								/* 393L, 28L, 323L, 338L, 1021L) */ ((float) (
									/* 396L, 27L, 326L, 341L, 1024L) */ (min (
										/* 396L, 27L, 326L, 341L, 1024L) */ (
											var_1_5
										) , (
											var_1_6
										)
						...
						/* 402L, 77L, 405L, 434L, 1030L) */ ((
							/* 403L, 37L, 41L, 406L, 435L, 1031L) */ ((
								var_1_1
							) >= (
								var_1_13
							))
						) ? (
							/* 406L, 75L, 409L, 438L, 1034L) */ ((
								var_1_9
							) ? (
								/* 408L, 54L, 411L, 440L, 1036L) */ ((
									var_1_7
								) == (
									/* 408L, 54L, 411L, 440L, 1036L) */ ((float) (
										/* 411L, 53L, 414L, 443L, 1039L) */ ((
											var_1_10
										) + (
											/* 413L, 52L, 416L, 445L, 1041L) */ ((
												var_1_11
											) - (
												var_1_12
											))
								...
								/* 416L, 73L, 419L, 448L, 1044L) */ ((
									/* 417L, 57L, 61L, 420L, 449L, 1045L) */ ((
										var_1_3
									) >= (
										var_1_20
									))
								) ? (
									/* 420L, 67L, 423L, 452L, 1048L) */ ((
										var_1_7
									) == (
										/* 420L, 67L, 423L, 452L, 1048L) */ ((float) (
											var_1_5
										))
									))
								) : (
									/* 424L, 71L, 427L, 456L, 1052L) */ ((
										var_1_7
									) == (
										/* 424L, 71L, 427L, 456L, 1052L) */ ((float) (
											var_1_6
										))
									))
								))
					...
					/* 431L, 106L, 489L, 502L, 1059L) */ ((
						/* 432L, 90L, 96L, 490L, 503L, 1060L) */ ((
							/* 433L, 88L, 97L, 491L, 504L, 1061L) */ ((
								var_1_14
							) - (
								var_1_15
							))
						...
						/* 437L, 104L, 495L, 508L, 1065L) */ ((
							var_1_13
						) == (
							/* 437L, 104L, 495L, 508L, 1065L) */ ((float) (
								0.8f
							))
						))
					) : (
				...
				/* 442L, 145L, 547L, 564L, 1070L) */ ((
					/* 443L, 121L, 129L, 548L, 565L, 1071L) */ ((
						/* 444L, 117L, 130L, 549L, 566L, 1072L) */ ((
							var_1_12
						) - (
							var_1_11
						))
					) >= (
						/* 447L, 120L, 133L, 552L, 569L, 1075L) */ ((
							var_1_10
						) / (
							var_1_17
						))
					...
					/* 450L, 143L, 555L, 572L, 1078L) */ ((
						var_1_16
					) == (
						/* 450L, 143L, 555L, 572L, 1078L) */ ((signed short int) (
							/* 453L, 142L, 558L, 575L, 1081L) */ ((
								/* 454L, 140L, 559L, 576L, 1082L) */ ((
									var_1_18
								) - (
									1
								))
			...
			/* 459L, 199L, 631L, 656L, 1087L) */ ((
				/* 460L, 152L, 156L, 632L, 657L, 1088L) */ ((
					var_1_17
				) >= (
					var_1_12
				))
			) ? (
				/* 463L, 197L, 635L, 660L, 1091L) */ ((
					/* 464L, 167L, 177L, 636L, 661L, 1092L) */ ((
						var_1_21
					) != (
						/* 466L, 166L, 179L, 638L, 663L, 1094L) */ ((
							/* 467L, 162L, 180L, 639L, 664L, 1095L) */ (max (
								/* 467L, 162L, 180L, 639L, 664L, 1095L) */ (
									var_1_14
								) , (
									var_1_22
								)
							...
							/* 470L, 165L, 183L, 642L, 667L, 1098L) */ ((
								5
							) + (
								var_1_23
							))
					...
					/* 473L, 191L, 645L, 670L, 1101L) */ ((
						var_1_20
					) == (
						/* 473L, 191L, 645L, 670L, 1101L) */ ((unsigned long int) (
							/* 476L, 190L, 648L, 673L, 1104L) */ (min (
								/* 476L, 190L, 648L, 673L, 1104L) */ (
									var_1_22
								) , (
									var_1_3
								)
					...
					/* 479L, 195L, 651L, 676L, 1107L) */ ((
						var_1_20
					) == (
						/* 479L, 195L, 651L, 676L, 1107L) */ ((unsigned long int) (
							var_1_21
						))
					))
				))
		...
		/* 484L, 226L, 715L, 732L, 1112L) */ ((
			/* 485L, 206L, 210L, 716L, 733L, 1113L) */ ((
				var_1_10
			) < (
				var_1_12
			))
		) ? (
			/* 488L, 218L, 719L, 736L, 1116L) */ ((
				var_1_24
			) == (
				/* 488L, 218L, 719L, 736L, 1116L) */ ((signed short int) (
					/* 491L, 217L, 722L, 739L, 1119L) */ ((
						var_1_23
					) + (
						var_1_25
					))
			...
			/* 494L, 224L, 725L, 742L, 1122L) */ ((
				var_1_24
			) == (
				/* 494L, 224L, 725L, 742L, 1122L) */ ((signed short int) (
					/* 497L, 223L, 728L, 745L, 1125L) */ (max (
						/* 497L, 223L, 728L, 745L, 1125L) */ (
							var_1_18
						) , (
							-2
						)
	...
	/* 504L, 276L, 808L, 836L, 1132L) */ ((
		/* 505L, 239L, 249L, 809L, 837L, 1133L) */ ((
			/* 506L, 233L, 250L, 810L, 838L, 1134L) */ (max (
				/* 506L, 233L, 250L, 810L, 838L, 1134L) */ (
					var_1_1
				) , (
					var_1_17
				)
			...
			/* 509L, 238L, 253L, 813L, 841L, 1137L) */ ((
				var_1_10
			) + (
				/* 511L, 237L, 255L, 815L, 843L, 1139L) */ ((
					var_1_13
				) / (
					128.9f
				))
		...
		/* 514L, 270L, 818L, 846L, 1142L) */ ((
			var_1_9
		) ? (
			/* 516L, 264L, 820L, 848L, 1144L) */ ((
				var_1_26
			) == (
				/* 516L, 264L, 820L, 848L, 1144L) */ ((signed short int) (
					var_1_25
				))
			))
		) : (
			/* 520L, 268L, 824L, 852L, 1148L) */ ((
				var_1_26
			) == (
				/* 520L, 268L, 824L, 852L, 1148L) */ ((signed short int) (
					var_1_18
				))
			))
		))
	) : (
		/* 524L, 274L, 828L, 856L, 1152L) */ ((
			var_1_26
		) == (
			/* 524L, 274L, 828L, 856L, 1152L) */ ((signed short int) (
				var_1_19
			))
		))
	))
