...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch158Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch158Amount25
	if (var_1_8) {
		var_1_6 = (var_1_5 + -128);
	}


	// From: Req5Batch158Amount25
	var_1_14 = var_1_5;


	// From: Req6Batch158Amount25
	var_1_15 = 32.5f;
}
