...
void step(void) {
	// From: Req2Batch152Wrapper_S
	WrapperStruct00.var_1_5 = (32 - WrapperStruct00.var_1_6);


	// From: Req3Batch152Wrapper_S
	...
	// From: Req4Batch152Wrapper_S
	if (WrapperStruct00.var_1_4 >= (WrapperStruct00.var_1_11 << WrapperStruct00.var_1_6)) {
		WrapperStruct00.var_1_15 = (abs (WrapperStruct00.var_1_11));
	} else {
		if (WrapperStruct00.var_1_13) {
