...
void step(void) {
 ...
 if (stepLocal_0 >= (*(var_1_6_Pointer))) {
  if ((((*(var_1_11_Pointer)) + (*(var_1_12_Pointer))) - (((((*(var_1_13_Pointer))) < (1)) ? ((*(var_1_13_Pointer))) : (1)))) > stepLocal_1) {
