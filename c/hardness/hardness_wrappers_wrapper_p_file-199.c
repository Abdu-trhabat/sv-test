...
void step(void) {
	// From: Req1Batch199Wrapper_P
	if ((*(var_1_2_Pointer)) >= (*(var_1_3_Pointer))) {
		if ((*(var_1_3_Pointer)) == (*(var_1_2_Pointer))) {
			if ((*(var_1_2_Pointer)) != 4.15f) {
				if ((min ((*(var_1_2_Pointer)) , (*(var_1_3_Pointer)))) >= (min (((*(var_1_4_Pointer)) - (*(var_1_5_Pointer))) , 3.9f))) {
	...
	// From: Req2Batch199Wrapper_P
	if (((*(var_1_8_Pointer)) + (*(var_1_9_Pointer))) < (*(var_1_10_Pointer))) {
		(*(var_1_7_Pointer)) = (((*(var_1_11_Pointer)) - (min ((*(var_1_12_Pointer)) , (*(var_1_13_Pointer))))) + (*(var_1_14_Pointer)));
	} else {
	...
	// From: Req3Batch199Wrapper_P
	(*(var_1_15_Pointer)) = (abs ((*(var_1_11_Pointer)) + (*(var_1_13_Pointer))));


	// From: Req4Batch199Wrapper_P
	(*(var_1_16_Pointer)) = (*(var_1_17_Pointer));


	// From: Req5Batch199Wrapper_P
...
int property(void) {
	return ((((((*(var_1_2_Pointer)) >= (*(var_1_3_Pointer))) ? (((*(var_1_3_Pointer)) == (*(var_1_2_Pointer))) ? (((*(var_1_2_Pointer)) != 4.15f) ? (((min ((*(var_1_2_Pointer)) , (*(var_1_3_Pointer)))) >= (min (((*(var_1_4_Pointer)) - (*(var_1_5_Pointer))) , 3.9f))) ? ((*(var_1_1_Pointer)) == ((float) (*(var_1_6_Pointer)))) : ((*(var_1_1_Pointer)) == ((float) 63.42f))) : ((*(var_1_1_Pointer)) == ((float) (*(var_1_6_Pointer))))) : 1) : 1) && ((((*(var_1_8_Pointer)) + (*(var_1_9_Pointer))) < (*(var_1_10_Pointer))) ? ((*(var_1_7_Pointer)) == ((float) (((*(var_1_11_Pointer)) - (min ((*(var_1_12_Pointer)) , (*(var_1_13_Pointer))))) + (*(var_1_14_Pointer))))) : (((*(var_1_10_Pointer)) < (*(var_1_9_Pointer))) ? ((*(var_1_7_Pointer)) == ((float) (*(var_1_13_Pointer)))) : ((*(var_1_7_Pointer)) == ((float) (*(var_1_12_Pointer))))))) && ((*(var_1_15_Pointer)) == ((double) (abs ((*(var_1_11_Pointer)) + (*(var_1_13_Pointer))))))) && ((*(var_1_16_Pointer)) == ((unsigned short int) (*(var_1_17_Pointer))))) && ((*(var_1_18_Pointer)) == ((signed long int) (*(var_1_17_Pointer))))
;
}
int main(void) {
	isInitial = 1;
