...
void step(void) {
	...
	// From: Req3Batch163has_floats
	signed long int stepLocal_4 = (var_1_11 - var_1_12) - 32;
	if (stepLocal_4 < var_1_4) {
		var_1_10 = (min ((-128.0 + (max (var_1_13 , -100.0))) , var_1_14));
	}


	// From: Req4Batch163has_floats
