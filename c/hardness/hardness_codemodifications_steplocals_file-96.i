...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch96stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_0 < (-1 - var_1_10)) {
  if (var_1_7) {
   var_1_9 = (var_1_10 + ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))));
  } else {
 ...
 if (var_1_4) {
  ...
  var_1_24 = (var_1_6 && ((var_1_10 >= var_1_26) && var_1_25));
 }
 if (var_1_17 < (var_1_21 + var_1_14)) {
