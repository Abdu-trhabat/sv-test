...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch5925_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((max (var_1_2 , 1)) <= (256 + last_1_var_1_7)) {
	...
	if (var_1_8) {
		if (var_1_2 <= var_1_1) {
			var_1_7 = (max (var_1_2 , (max (var_1_9 , var_1_10))));
		} else {
			var_1_7 = var_1_10;
		}
	} else {
	...
	if (var_1_10 <= stepLocal_0) {
		if ((var_1_12 - var_1_13) == var_1_14) {
			var_1_11 = (max (var_1_15 , ((var_1_16 + var_1_17) - var_1_18)));
		} else {
			var_1_11 = var_1_18;
		}
	} else {
...
int property(void) {
	return ((((max (var_1_2 , 1)) <= (256 + last_1_var_1_7)) ? (var_1_1 == ((signed long int) ((var_1_4 + var_1_5) + var_1_6))) : (var_1_1 == ((signed long int) var_1_6))) && (var_1_8 ? ((var_1_2 <= var_1_1) ? (var_1_7 == ((unsigned long int) (max (var_1_2 , (max (var_1_9 , var_1_10)))))) : (var_1_7 == ((unsigned long int) var_1_10))) : (var_1_7 == ((unsigned long int) var_1_2)))) && ((var_1_10 <= var_1_1) ? (((var_1_12 - var_1_13) == var_1_14) ? (var_1_11 == ((float) (max (var_1_15 , ((var_1_16 + var_1_17) - var_1_18))))) : (var_1_11 == ((float) var_1_18))) : (var_1_11 == ((float) var_1_16)))
;
}
int main(void) {
	isInitial = 1;
