...
void step(void) {
	// From: Req1Batch26has_floats
	unsigned char stepLocal_0 = var_1_5;
	if (var_1_2 > (min ((var_1_3 / -5.0) , var_1_4))) {
	...
	// From: Req3Batch26has_floats
	if (var_1_5 && (var_1_2 == (var_1_4 * var_1_3))) {
		var_1_11 = (max (var_1_7 , var_1_9));
	} else {
		var_1_11 = (var_1_12 - var_1_8);
	}


	// From: Req4Batch26has_floats
	var_1_13 = var_1_14;
}
...
int property(void) {
	return ((((var_1_2 > (min ((var_1_3 / -5.0) , var_1_4))) ? ((var_1_5 || (var_1_3 <= var_1_2)) ? (var_1_1 == ((signed short int) (((var_1_6 + var_1_7) - 10) - (var_1_8 + var_1_9)))) : (var_1_1 == ((signed short int) (var_1_9 - var_1_8)))) : (var_1_1 == ((signed short int) var_1_6))) && ((var_1_7 >= (var_1_9 % -5)) ? ((var_1_2 >= var_1_3) ? (var_1_10 == ((signed long int) last_1_var_1_10)) : 1) : 1)) && ((var_1_5 && (var_1_2 == (var_1_4 * var_1_3))) ? (var_1_11 == ((unsigned short int) (max (var_1_7 , var_1_9)))) : (var_1_11 == ((unsigned short int) (var_1_12 - var_1_8))))) && (var_1_13 == ((double) var_1_14))
;
}
int main(void) {
	isInitial = 1;
