...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch87Filler_PE_CI.c", 13, "reach_error"); }
 ...
 signed short int stepLocal_1 = var_1_17;
  ...
  var_1_32
   ...
   var_1_32
                    ...
                    if ( ((var_1_12) >= (var_1_13))) {
                     if ( (( ((var_1_3) % (var_1_17))) > ( ((var_1_19) + (var_1_32))))) {
                     var_1_33 = (
                      ((((((((2) < 0 ) ? -(2) : (2)))) < 0 ) ? -(((((2) < 0 ) ? -(2) : (2)))) : (((((2) < 0 ) ? -(2) : (2))))))
    );
   } else {
                      if ( (( ((var_1_3) & (var_1_17))) <= ( (((((var_1_19)) < ((var_1_28))) ? ((var_1_19)) : ((var_1_28))))))) {
                       var_1_33 = (
      var_1_32
     );
    } else {
    ...
    var_1_28
                   ...
                   if ( ((var_1_19) > ( (( ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)))) << (var_1_3))))) {
                    var_1_35 = (
                     ((
    var_1_32
   ) + (
    var_1_19
                   ...
                   if ( ((var_1_5) == (var_1_17))) {
                    var_1_36 = (
                     ((((( var_1_3 )) > (( var_1_32 ))) ? (( var_1_3 )) : (( var_1_32 ))))
  );
 } else {
                    var_1_36 = (
                     ((((( var_1_32 )) < (( ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))) ))) ? (( var_1_32 )) : (( ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))) ))))
  );
 }
                   if (var_1_1) {
                    var_1_37 = (
                    ...
                    if ( (( (( ((var_1_36) + (var_1_32))) >> (var_1_39))) > (var_1_5))) {
                     var_1_37 = (
                      ((
     var_1_39
    ) + (
