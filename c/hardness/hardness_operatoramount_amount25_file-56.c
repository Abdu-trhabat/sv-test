...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch56Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch56Amount25
	var_1_12 = var_1_13;


	// From: Req2Batch56Amount25
