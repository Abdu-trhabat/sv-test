...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch183functionizing.c", 13, "reach_error"); }
...
signed long int functionized1(signed short int functionized1_localFunctionVar0) {
	return (min ((functionized1_localFunctionVar0 - var_1_11) , var_1_3));
}
signed long int functionized2(signed short int functionized2_localFunctionVar0) {
	return (((min (var_1_12 , var_1_13)) + (min (var_1_14 , functionized2_localFunctionVar0))) - 256);
}
...
void step(void) {
	// From: Req1Batch183functionizing
	if (! var_1_2) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req2Batch183functionizing
	if (var_1_1 > var_1_3) {
		if (functionized0(var_1_1, var_1_4)) {
			var_1_5 = var_1_1;
		}
	}


	// From: Req3Batch183functionizing
	if ((max (var_1_7 , var_1_8)) <= var_1_9) {
		var_1_6 = functionized1(var_1_10);
	} else {
		var_1_6 = functionized2(var_1_15);
	}


	// From: Req4Batch183functionizing
	if ((var_1_8 * var_1_9) <= var_1_7) {
		var_1_16 = (min ((var_1_15 + 1) , var_1_12));
	}


	// From: Req5Batch183functionizing
	if (var_1_2) {
		var_1_17 = (min (var_1_18 , var_1_19));
	}


	// From: Req6Batch183functionizing
	if (var_1_5 <= ((var_1_14 - var_1_13) / var_1_21)) {
		var_1_20 = (max (((var_1_22 - var_1_23) + var_1_4) , var_1_3));
	}


	// From: Req7Batch183functionizing
	if (var_1_2) {
