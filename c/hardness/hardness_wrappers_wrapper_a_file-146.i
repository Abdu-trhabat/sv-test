...
void step(void) {
 signed_long_int_Array_0[4] = (signed_long_int_Array_0[3] + (((((16 + signed_long_int_Array_0[2])) < (((((signed_long_int_Array_0[1]) > (-32)) ? (signed_long_int_Array_0[1]) : (-32))))) ? ((16 + signed_long_int_Array_0[2])) : (((((signed_long_int_Array_0[1]) > (-32)) ? (signed_long_int_Array_0[1]) : (-32)))))));
 if (signed_long_int_Array_0[4] >= (((((signed_long_int_Array_0[3]) > (signed_long_int_Array_0[1])) ? (signed_long_int_Array_0[3]) : (signed_long_int_Array_0[1]))) % signed_long_int_Array_0[0])) {
