...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch197Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch197Amount100
	var_1_14 = (var_1_15 - var_1_16);


	// From: Req4Batch197Amount100
	...
	// From: Req7Batch197Amount100
	unsigned long int stepLocal_3 = var_1_18;
	if (stepLocal_3 == var_1_22) {
		var_1_25 = (min (var_1_26 , var_1_22));
	}


	// From: Req8Batch197Amount100
	var_1_27 = var_1_28;


	// From: Req9Batch197Amount100
	...
	// From: Req11Batch197Amount100
	var_1_35 = (min ((max ((min (32 , var_1_22)) , var_1_36)) , (128 - var_1_37)));


	// From: Req13Batch197Amount100
	var_1_43 = var_1_37;


	// From: Req14Batch197Amount100
	var_1_44 = var_1_6;


	// From: Req1Batch197Amount100
	if (var_1_2 != var_1_3) {
	...
	// From: Req2Batch197Amount100
	if (var_1_3 <= var_1_2) {
		if (var_1_2 >= var_1_3) {
			var_1_9 = (((max (var_1_10 , var_1_11)) + var_1_12) + var_1_13);
		} else {
			if (var_1_44) {
				var_1_9 = var_1_11;
			} else {
