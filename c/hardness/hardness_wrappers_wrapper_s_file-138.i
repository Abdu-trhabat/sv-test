...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch138Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 signed char stepLocal_0 = WrapperStruct00.var_1_2;
 if (stepLocal_0 >= WrapperStruct00.var_1_3) {
  WrapperStruct00.var_1_1 = ((((WrapperStruct00.var_1_4) > ((WrapperStruct00.var_1_5 - ((((100) > (WrapperStruct00.var_1_6)) ? (100) : (WrapperStruct00.var_1_6)))))) ? (WrapperStruct00.var_1_4) : ((WrapperStruct00.var_1_5 - ((((100) > (WrapperStruct00.var_1_6)) ? (100) : (WrapperStruct00.var_1_6)))))));
 } else {
  WrapperStruct00.var_1_1 = WrapperStruct00.var_1_4;
 }
 unsigned char stepLocal_2 = WrapperStruct00.var_1_8;
 signed long int stepLocal_1 = WrapperStruct00.var_1_6 << WrapperStruct00.var_1_5;
 if (-128 >= stepLocal_1) {
  if (stepLocal_2 && WrapperStruct00.var_1_13) {
   WrapperStruct00.var_1_11 = (15.125f - WrapperStruct00.var_1_14);
  } else {
   WrapperStruct00.var_1_11 = ((((WrapperStruct00.var_1_14 - (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16)) < 0 ) ? -(WrapperStruct00.var_1_14 - (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16)) : (WrapperStruct00.var_1_14 - (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16))));
  }
 } else {
  if (! (WrapperStruct00.var_1_4 == WrapperStruct00.var_1_5)) {
   WrapperStruct00.var_1_11 = WrapperStruct00.var_1_17;
  } else {
   WrapperStruct00.var_1_11 = WrapperStruct00.var_1_16;
  }
 }
 if (WrapperStruct00.var_1_8 && (4.5f >= WrapperStruct00.var_1_11)) {
  if ((WrapperStruct00.var_1_6 & WrapperStruct00.var_1_1) > WrapperStruct00.var_1_1) {
...
int property(void) {
 return (((WrapperStruct00.var_1_2 >= WrapperStruct00.var_1_3) ? (WrapperStruct00.var_1_1 == ((unsigned short int) ((((WrapperStruct00.var_1_4) > ((WrapperStruct00.var_1_5 - ((((100) > (WrapperStruct00.var_1_6)) ? (100) : (WrapperStruct00.var_1_6)))))) ? (WrapperStruct00.var_1_4) : ((WrapperStruct00.var_1_5 - ((((100) > (WrapperStruct00.var_1_6)) ? (100) : (WrapperStruct00.var_1_6))))))))) : (WrapperStruct00.var_1_1 == ((unsigned short int) WrapperStruct00.var_1_4))) && ((WrapperStruct00.var_1_8 && (4.5f >= WrapperStruct00.var_1_11)) ? (((WrapperStruct00.var_1_6 & WrapperStruct00.var_1_1) > WrapperStruct00.var_1_1) ? (WrapperStruct00.var_1_7 == ((signed char) WrapperStruct00.var_1_10)) : 1) : (WrapperStruct00.var_1_7 == ((signed char) WrapperStruct00.var_1_10)))) && ((-128 >= (WrapperStruct00.var_1_6 << WrapperStruct00.var_1_5)) ? ((WrapperStruct00.var_1_8 && WrapperStruct00.var_1_13) ? (WrapperStruct00.var_1_11 == ((float) (15.125f - WrapperStruct00.var_1_14))) : (WrapperStruct00.var_1_11 == ((float) ((((WrapperStruct00.var_1_14 - (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16)) < 0 ) ? -(WrapperStruct00.var_1_14 - (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16)) : (WrapperStruct00.var_1_14 - (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16))))))) : ((! (WrapperStruct00.var_1_4 == WrapperStruct00.var_1_5)) ? (WrapperStruct00.var_1_11 == ((float) WrapperStruct00.var_1_17)) : (WrapperStruct00.var_1_11 == ((float) WrapperStruct00.var_1_16))))
;
}
int main(void) {
 isInitial = 1;
