...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch182Amount50.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_10 < var_1_12) {
  ...
  var_1_24 = ((((var_1_18) > (-2)) ? (var_1_18) : (-2)));
 }
