...
void functionized6(signed char functionized6_localFunctionVar0) {
	if (! (! (var_1_15 || var_1_7))) {
		if ((min (var_1_17 , var_1_1)) <= (abs (var_1_4))) {
			var_1_22 = var_1_8;
		} else {
			var_1_22 = var_1_11;
		}
...
void step(void) {
	// From: Req1Batch181functionizing
	if (var_1_2) {
	...
	// From: Req2Batch181functionizing
	var_1_6 = var_1_7;


	// From: Req3Batch181functionizing
	if (functionized1(var_1_11)) {
		var_1_8 = (max (var_1_12 , var_1_13));
	}


	// From: Req4Batch181functionizing
	functionized2(var_1_2);


	// From: Req5Batch181functionizing
	...
	// From: Req6Batch181functionizing
	functionized6(var_1_13);


	// From: Req7Batch181functionizing
...
int property(void) {
	return ((((((var_1_2 ? (var_1_1 == ((signed long int) (var_1_3 - (var_1_4 + 5)))) : ((var_1_4 > (var_1_3 * var_1_5)) ? (var_1_1 == ((signed long int) var_1_3)) : 1)) && (var_1_6 == ((unsigned char) var_1_7))) && (((var_1_9 - (min (var_1_10 , var_1_11))) >= var_1_5) ? (var_1_8 == ((signed char) (max (var_1_12 , var_1_13)))) : 1)) && (var_1_2 ? (var_1_14 == ((unsigned short int) (max (var_1_10 , var_1_11)))) : 1)) && (((var_1_14 >> 10) < (var_1_1 / (abs (var_1_16)))) ? ((((var_1_9 / var_1_16) % var_1_17) <= (var_1_4 - var_1_14)) ? (((var_1_18 / var_1_19) != var_1_20) ? (var_1_15 == ((unsigned char) var_1_21)) : (var_1_15 == ((unsigned char) var_1_7))) : (var_1_15 == ((unsigned char) var_1_21))) : (var_1_15 == ((unsigned char) var_1_21)))) && ((! (! (var_1_15 || var_1_7))) ? (((min (var_1_17 , var_1_1)) <= (abs (var_1_4))) ? (var_1_22 == ((signed long int) var_1_8)) : (var_1_22 == ((signed long int) var_1_11))) : (var_1_22 == ((signed long int) var_1_13)))) && (var_1_24 == ((float) (((var_1_25 + var_1_26) - var_1_27) - var_1_28)))
;
}
int main(void) {
	isInitial = 1;
