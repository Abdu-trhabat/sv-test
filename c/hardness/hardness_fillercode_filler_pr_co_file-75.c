...
void step(void) {
	...
	/* 299L, 144L) */ if (/* 300L, 82L, 83L) */ ((/* 301L, 77L, 84L) */ ((var_1_25) ^ (/* 303L, 76L, 86L) */ ((var_1_28) + (var_1_25))))) <= (/* 306L, 81L, 89L) */ (abs (/* 307L, 80L, 90L) */ (min (/* 307L, 80L, 90L) */ (var_1_34) , (var_1_35)))))))) {
		...
		/* 319L, 142L) */ if (/* 320L, 118L, 119L) */ ((var_1_38) >= (/* 322L, 117L, 121L) */ (max (/* 322L, 117L, 121L) */ (var_1_37) , (/* 324L, 116L, 123L) */ ((var_1_36) * (var_1_15)))))))) {
	...
	// From: CodeObject6
	/* 398L, 277L) */ if (/* 399L, 247L, 248L) */ ((var_1_36) < (/* 401L, 246L, 250L) */ (max (/* 401L, 246L, 250L) */ (/* 402L, 242L, 251L) */ ((var_1_22) * (var_1_37))) , (/* 405L, 245L, 254L) */ (min (/* 405L, 245L, 254L) */ (var_1_38) , (-0.8f))))))))) {
		/* 408L, 272L) */ var_1_47 = (
			/* 411L, 271L) */ (min (
				/* 411L, 271L) */ (
					/* 412L, 269L) */ (abs (
	...
	/* 354L, 194L) */ if (/* 355L, 152L, 153L) */ ((/* 356L, 150L, 154L) */ ((var_1_29) & (var_1_42))) <= (var_1_43))) {
		/* 360L, 192L) */ if (/* 361L, 165L, 166L) */ ((var_1_38) <= (var_1_22))) {
