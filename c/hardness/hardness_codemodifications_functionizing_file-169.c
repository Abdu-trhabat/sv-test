...
signed long int functionized0(void) {
	return ((var_1_3 - var_1_4) / (max (var_1_5 , var_1_6)));
}
...
unsigned char functionized2(signed long int functionized2_localFunctionVar0, signed short int functionized2_localFunctionVar1) {
	return (functionized2_localFunctionVar1 > (max (functionized2_localFunctionVar0 , -8)));
}
signed long int functionized3(void) {
	return (max (var_1_17 , var_1_18));
}
...
unsigned char functionized5(unsigned long int functionized5_localFunctionVar0) {
	return ((5u >> 16) > (functionized5_localFunctionVar0 - (abs (100u))));
}
...
int property(void) {
	return ((((((((var_1_2 < ((var_1_3 - var_1_4) / (max (var_1_5 , var_1_6)))) ? (var_1_1 == ((signed long int) (var_1_3 - (max ((max (64 , var_1_4)) , var_1_7))))) : 1) && ((var_1_6 > var_1_5) ? (var_1_8 == ((signed long int) (abs (var_1_3)))) : 1)) && (var_1_9 == ((double) ((min (var_1_10 , (1.000000000000005E14 + 256.1))) - (var_1_11 + var_1_12))))) && ((var_1_4 == (~ (var_1_5 + var_1_8))) ? (var_1_13 == ((signed short int) var_1_14)) : 1)) && ((var_1_14 > (max (var_1_1 , -8))) ? (var_1_15 == ((signed char) (min ((var_1_16 + (max (var_1_17 , var_1_18))) , var_1_19)))) : (var_1_15 == ((signed char) (min (var_1_16 , var_1_19)))))) && ((((var_1_21 - var_1_4) << var_1_16) < var_1_8) ? (var_1_20 == ((signed char) var_1_16)) : 1)) && (var_1_22 == ((unsigned short int) ((min (var_1_4 , var_1_23)) + (var_1_24 + var_1_25))))) && (((8 << var_1_17) < var_1_27) ? (((5u >> 16) > (var_1_28 - (abs (100u)))) ? (var_1_26 == ((unsigned char) var_1_29)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
