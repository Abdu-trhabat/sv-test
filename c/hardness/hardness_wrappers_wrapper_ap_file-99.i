...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch99Wrapper_AP.c", 13, "reach_error"); }
...
void updateVariables(void) {
 ...
 assume_abort_if_not((float_Array_0[4] >= 0.0F && float_Array_0[4] <= -1.0e-20F) || (float_Array_0[4] <= 9223372.036854766000e+12F && float_Array_0[4] >= 1.0e-20F ));
 float_Array_0[5] = __VERIFIER_nondet_float();
 assume_abort_if_not((float_Array_0[5] >= 0.0F && float_Array_0[5] <= -1.0e-20F) || (float_Array_0[5] <= 9223372.036854766000e+12F && float_Array_0[5] >= 1.0e-20F ));
