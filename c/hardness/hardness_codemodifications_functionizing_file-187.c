...
signed long int functionized2(signed char functionized2_localFunctionVar0) {
	return (max (var_1_10 , functionized2_localFunctionVar0));
}
...
void functionized5(signed long int functionized5_localFunctionVar0, signed char functionized5_localFunctionVar1, unsigned char functionized5_localFunctionVar2, signed char functionized5_localFunctionVar3) {
	if ((functionized5_localFunctionVar2 % (abs (var_1_19))) >= (functionized5_localFunctionVar3 * functionized5_localFunctionVar0)) {
...
void step(void) {
	// From: Req1Batch187functionizing
	if (var_1_2) {
		functionized0(var_1_6, var_1_5);
	}


	// From: Req2Batch187functionizing
	functionized1(var_1_5, var_1_8, var_1_1, var_1_3);


	// From: Req3Batch187functionizing
	if (var_1_2) {
		var_1_9 = (max (functionized2(var_1_11) , var_1_12));
	}


	// From: Req4Batch187functionizing
	functionized3(var_1_20, var_1_16, var_1_19, var_1_10, var_1_15);


	// From: Req5Batch187functionizing
	...
	// From: Req6Batch187functionizing
	functionized5(var_1_16, var_1_11, var_1_13, var_1_9);


	// From: Req7Batch187functionizing
	functionized6();


	// From: Req8Batch187functionizing
	var_1_24 = 32;


	// From: Req9Batch187functionizing
	var_1_25 = var_1_18;
}
...
int property(void) {
	return ((((((((var_1_2 ? ((var_1_3 != var_1_4) ? (var_1_1 == ((double) var_1_5)) : ((((- var_1_3) * var_1_6) < var_1_4) ? (var_1_1 == ((double) var_1_5)) : (var_1_1 == ((double) 199.4)))) : 1) && (((var_1_1 / var_1_8) < var_1_3) ? ((var_1_1 < var_1_5) ? (var_1_7 == ((double) var_1_5)) : 1) : 1)) && (var_1_2 ? (var_1_9 == ((signed char) (max ((max (var_1_10 , var_1_11)) , var_1_12)))) : 1)) && (((var_1_14 - var_1_15) > ((var_1_10 + 1000000000) / var_1_16)) ? (var_1_13 == ((unsigned char) (var_1_17 + var_1_18))) : (var_1_13 == ((unsigned char) (var_1_19 - var_1_20))))) && ((((~ var_1_17) / var_1_19) >= (var_1_18 << (1 - 0))) ? (var_1_21 == ((float) 25.8f)) : (var_1_21 == ((float) var_1_5)))) && (((var_1_13 % (abs (var_1_19))) >= (var_1_9 * var_1_16)) ? ((((2 ^ var_1_19) + var_1_16) < var_1_11) ? (var_1_22 == ((signed short int) var_1_18)) : 1) : 1)) && (var_1_23 == ((unsigned short int) var_1_18))) && (var_1_24 == ((unsigned char) 32))) && (var_1_25 == ((unsigned char) var_1_18))
;
}
int main(void) {
	isInitial = 1;
