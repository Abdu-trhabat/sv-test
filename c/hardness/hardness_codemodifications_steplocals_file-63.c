...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch63stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch63stepLocals
	if (32u < ((var_1_2 + 4u) | var_1_3)) {
		var_1_1 = (var_1_4 + (var_1_5 + var_1_6));
	} else {
		if (! var_1_7) {
			var_1_1 = (min (var_1_4 , (var_1_8 - var_1_9)));
		} else {
	...
	// From: Req3Batch63stepLocals
	signed long int stepLocal_1 = var_1_9;
	if ((var_1_3 + (var_1_12 / var_1_14)) >= stepLocal_1) {
		var_1_13 = var_1_12;
	}


	// From: Req4Batch63stepLocals
	unsigned char stepLocal_2 = (abs (var_1_12)) >= (var_1_1 & var_1_10);
	...
	// From: Req5Batch63stepLocals
	if (var_1_18 != 999999.5) {
		var_1_19 = (15.75 + (var_1_20 - var_1_21));
	}


	// From: Req6Batch63stepLocals
	if (var_1_7) {
		if (-128 < var_1_5) {
			var_1_22 = var_1_12;
		}
	...
	// From: Req7Batch63stepLocals
	if (var_1_16 > var_1_21) {
		var_1_23 = (min (var_1_13 , (min (var_1_12 , (min (8 , var_1_24))))));
	}


	// From: Req8Batch63stepLocals
	var_1_25 = var_1_12;


	// From: Req9Batch63stepLocals
	var_1_26 = var_1_12;


	// From: Req10Batch63stepLocals
	var_1_27 = var_1_13;
}
