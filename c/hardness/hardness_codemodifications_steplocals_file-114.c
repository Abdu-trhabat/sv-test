...
void step(void) {
	...
	// From: Req2Batch114stepLocals
	if (var_1_1 || var_1_6) {
		var_1_7 = (min (var_1_5 , var_1_8));
	}


	// From: Req3Batch114stepLocals
	...
	// From: Req5Batch114stepLocals
	unsigned long int stepLocal_3 = max ((~ 0u) , var_1_10);
	if (stepLocal_3 > var_1_5) {
		var_1_14 = var_1_5;
	}


	// From: Req6Batch114stepLocals
	...
	// From: Req7Batch114stepLocals
	var_1_20 = var_1_21;


	// From: Req8Batch114stepLocals
	var_1_22 = 16u;


	// From: Req9Batch114stepLocals
	var_1_23 = var_1_18;
}
