...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch150_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch150_1loop
	if (var_1_5 < (var_1_7 - var_1_8)) {
		var_1_6 = var_1_9;
	}


	// From: Req3Batch150_1loop
	...
	// From: Req8Batch150_1loop
	var_1_27 = var_1_21;


	// From: Req4Batch150_1loop
