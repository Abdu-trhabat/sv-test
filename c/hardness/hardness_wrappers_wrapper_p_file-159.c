...
void step(void) {
	...
	// From: Req2Batch159Wrapper_P
	if ((((*(var_1_8_Pointer)) - (*(var_1_9_Pointer))) / (*(var_1_10_Pointer))) < (*(var_1_11_Pointer))) {
		if ((min ((*(var_1_3_Pointer)) , (*(var_1_12_Pointer)))) < (*(var_1_13_Pointer))) {
			if ((*(var_1_4_Pointer))) {
				(*(var_1_7_Pointer)) = (min ((*(var_1_14_Pointer)) , 1));
			}
		}
	}


	// From: Req3Batch159Wrapper_P
