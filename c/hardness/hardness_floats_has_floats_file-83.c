...
int property(void) {
	return ((var_1_2 ? (var_1_1 == ((unsigned short int) (abs (abs (var_1_3))))) : (((var_1_3 / var_1_4) >= (min ((var_1_5 * var_1_6) , (~ var_1_7)))) ? (var_1_1 == ((unsigned short int) var_1_4)) : (var_1_1 == ((unsigned short int) var_1_3)))) && (((var_1_9 - 8.0) != (- (var_1_10 + var_1_11))) ? (var_1_8 == ((double) (min (var_1_12 , ((var_1_13 - var_1_14) + var_1_15))))) : (var_1_8 == ((double) var_1_13)))) && (((var_1_4 + var_1_5) > (var_1_3 - var_1_7)) ? (var_1_16 == ((double) (abs (var_1_14)))) : ((var_1_5 >= var_1_7) ? (var_1_16 == ((double) var_1_12)) : (var_1_16 == ((double) var_1_13))))
;
}
int main(void) {
	isInitial = 1;
