...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch102has_floats.c", 13, "reach_error"); }
...
float var_1_12 = 2.0;
float var_1_13 = 128.0;
float var_1_14 = 500.0;
float var_1_15 = -1.0;
...
void step(void) {
	// From: Req1Batch102has_floats
	if (((var_1_2 - var_1_3) * 1000000.0) <= var_1_4) {
		if (var_1_3 <= var_1_4) {
			var_1_1 = (abs (var_1_5));
		}
	} else {
	...
	// From: Req3Batch102has_floats
	if (! var_1_11) {
		if (var_1_11) {
			if (var_1_1 >= var_1_6) {
				var_1_10 = (min ((max ((var_1_12 - var_1_13) , var_1_14)) , var_1_15));
			} else {
				var_1_10 = var_1_15;
			}
		} else {
...
int property(void) {
	return (((((var_1_2 - var_1_3) * 1000000.0) <= var_1_4) ? ((var_1_3 <= var_1_4) ? (var_1_1 == ((unsigned long int) (abs (var_1_5)))) : 1) : (var_1_1 == ((unsigned long int) (var_1_6 - var_1_7)))) && (((2 * 100) != var_1_1) ? (var_1_8 == ((signed long int) var_1_9)) : ((var_1_5 <= var_1_6) ? (var_1_8 == ((signed long int) (16 - 256))) : (var_1_8 == ((signed long int) var_1_9))))) && ((! var_1_11) ? (var_1_11 ? ((var_1_1 >= var_1_6) ? (var_1_10 == ((float) (min ((max ((var_1_12 - var_1_13) , var_1_14)) , var_1_15)))) : (var_1_10 == ((float) var_1_15))) : (var_1_10 == ((float) var_1_15))) : 1)
;
}
int main(void) {
	isInitial = 1;
