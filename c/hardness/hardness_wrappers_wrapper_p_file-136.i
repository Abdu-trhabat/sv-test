...
void step(void) {
 if ((*(var_1_2_Pointer))) {
  if ((*(var_1_3_Pointer))) {
   ...
   (*(var_1_1_Pointer)) = ((((((*(var_1_6_Pointer))) < (3757035609u)) ? ((*(var_1_6_Pointer))) : (3757035609u))) - (*(var_1_4_Pointer)));
  }
 } else {
 ...
 if (stepLocal_0 == (*(var_1_4_Pointer))) {
  if ((*(var_1_8_Pointer)) < stepLocal_1) {
   (*(var_1_7_Pointer)) = (((((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))) < 0 ) ? -((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))) : ((*(var_1_11_Pointer)) - (*(var_1_12_Pointer)))));
  } else {
   if ((*(var_1_2_Pointer))) {
