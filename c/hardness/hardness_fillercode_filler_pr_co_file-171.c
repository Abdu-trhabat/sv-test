...
void step(void) {
	...
	/* 294L, 155L) */ if (/* 295L, 114L, 115L) */ ((var_1_31) >= (/* 297L, 113L, 117L) */ ((var_1_26) * (var_1_32))))) {
		/* 300L, 149L) */ if (/* 301L, 129L, 130L) */ ((/* 302L, 127L, 131L) */ ((var_1_31) > (var_1_26))) || (var_1_20))) {
			/* 306L, 148L) */ var_1_37 = (
				/* 309L, 147L) */ (abs (
					/* 310L, 146L) */ ((
						/* 311L, 144L) */ ((
