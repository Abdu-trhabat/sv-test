...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch101100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch101100_while
	var_1_34 = var_1_35;


	// From: Req12Batch101100_while
	var_1_36 = var_1_21;


	// From: Req13Batch101100_while
	var_1_37 = var_1_30;


	// From: Req2Batch101100_while
	if (var_1_4 < var_1_7) {
		if (var_1_34) {
	...
	// From: Req5Batch101100_while
	signed long int stepLocal_5 = 0;
	if (var_1_8 >= stepLocal_5) {
		if (! var_1_34) {
			var_1_22 = (max (var_1_9 , var_1_21));
		} else {
			var_1_22 = var_1_9;
		}
	} else {
	...
	// From: Req6Batch101100_while
	if (var_1_34) {
		var_1_23 = (min (var_1_18 , (var_1_20 - var_1_24)));
	} else {
		var_1_23 = (var_1_19 + var_1_18);
	}


	// From: Req9Batch101100_while
	...
	// From: Req10Batch101100_while
	if (var_1_37 >= (var_1_28 + var_1_30)) {
		var_1_31 = (min (var_1_23 , var_1_8));
	} else {
...
int property(void) {
	return (((((((((((((var_1_2 || var_1_3) ? (((- last_1_var_1_28) <= -0.033) ? (var_1_1 == ((unsigned long int) (3824271162u - var_1_5))) : (var_1_1 == ((unsigned long int) (min (128u , var_1_5))))) : 1) && ((var_1_4 < var_1_7) ? (var_1_34 ? (var_1_6 == ((unsigned short int) ((var_1_8 - (var_1_9 + var_1_10)) + var_1_11))) : (var_1_6 == ((unsigned short int) var_1_8))) : 1)) && (last_1_var_1_34 ? (var_1_12 == ((signed long int) var_1_9)) : ((var_1_8 != last_1_var_1_26) ? ((last_1_var_1_12 < (49194 - (var_1_9 + var_1_10))) ? (var_1_12 == ((signed long int) (last_1_var_1_12 - var_1_8))) : 1) : 1))) && ((((var_1_4 + var_1_7) + (var_1_15 * var_1_16)) >= var_1_17) ? ((var_1_26 >= ((max (var_1_11 , var_1_12)) * var_1_8)) ? (var_1_14 == ((signed char) (var_1_18 + var_1_19))) : 1) : ((var_1_34 || ((var_1_31 * -10) != var_1_18)) ? (var_1_34 ? (var_1_14 == ((signed char) (var_1_20 - var_1_21))) : (var_1_14 == ((signed char) -32))) : (var_1_14 == ((signed char) var_1_21))))) && ((var_1_8 >= 0) ? ((! var_1_34) ? (var_1_22 == ((unsigned short int) (max (var_1_9 , var_1_21)))) : (var_1_22 == ((unsigned short int) var_1_9))) : (var_1_22 == ((unsigned short int) var_1_8)))) && (var_1_34 ? (var_1_23 == ((signed char) (min (var_1_18 , (var_1_20 - var_1_24))))) : (var_1_23 == ((signed char) (var_1_19 + var_1_18))))) && (((var_1_20 == (var_1_12 & var_1_1)) || (var_1_28 > var_1_37)) ? (var_1_25 == ((signed short int) -32)) : 1)) && ((-8 > var_1_20) ? ((var_1_34 && ((var_1_21 | var_1_1) >= var_1_8)) ? ((var_1_36 >= (min ((var_1_25 / var_1_27) , var_1_10))) ? (var_1_34 ? (var_1_26 == ((unsigned long int) var_1_8)) : 1) : (var_1_26 == ((unsigned long int) var_1_24))) : 1) : (var_1_26 == ((unsigned long int) var_1_21)))) && (((var_1_11 + var_1_10) < var_1_5) ? ((var_1_6 < var_1_12) ? (var_1_28 == ((double) var_1_30)) : 1) : 1)) && ((var_1_37 >= (var_1_28 + var_1_30)) ? (var_1_31 == ((signed long int) (min (var_1_23 , var_1_8)))) : (((var_1_37 / var_1_32) > var_1_37) ? (var_1_31 == ((signed long int) (var_1_12 - var_1_24))) : 1))) && (var_1_34 == ((unsigned char) var_1_35))) && (var_1_36 == ((unsigned char) var_1_21))) && (var_1_37 == ((double) var_1_30))
;
}
int main(void) {
	isInitial = 1;
