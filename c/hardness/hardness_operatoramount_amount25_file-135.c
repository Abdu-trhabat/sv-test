...
void step(void) {
	...
	// From: Req2Batch135Amount25
	if ((var_1_5 < (max (var_1_7 , var_1_6))) || var_1_2) {
		var_1_8 = var_1_9;
	}


	// From: Req3Batch135Amount25
	unsigned char stepLocal_0 = var_1_9;
	if (((var_1_11 - var_1_8) ^ var_1_3) <= stepLocal_0) {
		var_1_10 = (abs (var_1_9));
	} else {
		var_1_10 = var_1_8;
	}


	// From: Req4Batch135Amount25
	if (var_1_8 < var_1_10) {
		if (var_1_2) {
...
int property(void) {
	return (((var_1_2 ? ((! var_1_4) ? (var_1_1 == ((float) ((var_1_5 + 256.4f) - var_1_6))) : (var_1_1 == ((float) (var_1_5 + var_1_7)))) : 1) && (((var_1_5 < (max (var_1_7 , var_1_6))) || var_1_2) ? (var_1_8 == ((unsigned char) var_1_9)) : 1)) && ((((var_1_11 - var_1_8) ^ var_1_3) <= var_1_9) ? (var_1_10 == ((signed short int) (abs (var_1_9)))) : (var_1_10 == ((signed short int) var_1_8)))) && ((var_1_8 < var_1_10) ? (var_1_2 ? (var_1_12 == ((double) (var_1_5 + var_1_7))) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
