...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch168Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch168Filler_PE_CO
	/* 1179L, 245L, 987L, 993L) */ var_1_27 = (
		var_1_4
	);


	// From: Req8Batch168Filler_PE_CO
	/* 1185L, 255L, 1011L, 1017L) */ var_1_28 = (
		var_1_22
	);


	// From: Req3Batch168Filler_PE_CO
