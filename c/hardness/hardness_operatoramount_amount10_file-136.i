...
int property(void) {
 return (((var_1_6 ? (var_1_1 == ((signed char) (((((var_1_3 - var_1_4) < 0 ) ? -(var_1_3 - var_1_4) : (var_1_3 - var_1_4))) + var_1_5))) : (var_1_1 == ((signed char) (var_1_3 + -2)))) && (var_1_6 == ((unsigned char) var_1_7))) && (var_1_8 == ((signed long int) var_1_4))) && (var_1_9 == ((float) var_1_10))
;
}
int main(void) {
 isInitial = 1;
