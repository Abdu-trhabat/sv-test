...
void step(void) {
	...
	// From: CodeObject3
	/* 328L, 121L) */ if (/* 329L, 87L, 88L) */ ((/* 330L, 85L, 89L) */ ((200) >> (16u))) >= (var_1_16))) {
		/* 334L, 119L) */ if (/* 335L, 102L, 103L) */ ((var_1_16) >= (/* 337L, 101L, 105L) */ ((var_1_24) + (var_1_25))))) {
			/* 340L, 118L) */ var_1_27 = (
				/* 343L, 117L) */ ((
					var_1_21
				) || (
	...
	// From: CodeObject6
	/* 422L, 286L) */ if (/* 423L, 231L, 232L) */ ((var_1_10) < (/* 425L, 230L, 234L) */ ((-100) / (var_1_31))))) {
