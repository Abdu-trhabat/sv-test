...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch20Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) || stepLocal_0) {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) = (((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer)) - (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))) - (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)));
	} else {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) = ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)) + (abs ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)))));
	}


	// From: Req4Batch20Wrapper_AP
	unsigned long int stepLocal_2 = (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer));
