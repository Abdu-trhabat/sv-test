...
void step(void) {
	// From: Req2Batch152Wrapper_P
	(*(var_1_5_Pointer)) = (32 - (*(var_1_6_Pointer)));


	// From: Req3Batch152Wrapper_P
	...
	// From: Req4Batch152Wrapper_P
	if ((*(var_1_4_Pointer)) >= ((*(var_1_11_Pointer)) << (*(var_1_6_Pointer)))) {
		(*(var_1_15_Pointer)) = (abs ((*(var_1_11_Pointer))));
	} else {
		if ((*(var_1_13_Pointer))) {
			(*(var_1_15_Pointer)) = -4;
		}
