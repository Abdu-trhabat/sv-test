...
void step(void) {
	...
	// From: Req2Batch163Wrapper_SP
	signed long int stepLocal_3 = (max ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_2_Pointer)))) * (*(WrapperStruct00_var_1_8_Pointer));
	...
	if (stepLocal_1 || (*(WrapperStruct00_var_1_7_Pointer))) {
		if ((max (last_1_WrapperStruct00_var_1_5 , (*(WrapperStruct00_var_1_1_Pointer)))) < stepLocal_3) {
