...
void step(void) {
 ...
 unsigned long int stepLocal_1 = (((var_1_8) > (var_1_7)) ? (var_1_8) : (var_1_7));
 if (((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))) < stepLocal_1) {
  var_1_9 = ((var_1_10 - var_1_11) - ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))));
 }
 var_1_14 = 16;
 if (var_1_4) {
  if (var_1_5 > 99.4) {
   if (var_1_14 >= var_1_6) {
    var_1_13 = ((((var_1_10) < (256)) ? (var_1_10) : (256)));
   }
  }
 }
}
...
int property(void) {
 return (((((! (var_1_2 == (15.2 + var_1_3))) ? ((var_1_4 && (var_1_2 == var_1_3)) ? (var_1_4 ? (var_1_1 == ((double) (2.5 - var_1_5))) : (var_1_1 == ((double) var_1_5))) : 1) : (var_1_1 == ((double) var_1_5))) && (var_1_6 == ((unsigned long int) (var_1_7 + var_1_8)))) && ((((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))) < ((((var_1_8) > (var_1_7)) ? (var_1_8) : (var_1_7)))) ? (var_1_9 == ((signed char) ((var_1_10 - var_1_11) - ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))))) : 1)) && (var_1_4 ? ((var_1_5 > 99.4) ? ((var_1_14 >= var_1_6) ? (var_1_13 == ((unsigned short int) ((((var_1_10) < (256)) ? (var_1_10) : (256))))) : 1) : 1) : 1)) && (var_1_14 == ((signed short int) 16))
;
}
int main(void) {
 isInitial = 1;
