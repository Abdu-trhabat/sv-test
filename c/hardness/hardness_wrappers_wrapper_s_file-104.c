...
void step(void) {
	...
	if (stepLocal_0 > last_1_WrapperStruct00_var_1_11) {
		...
		WrapperStruct00.var_1_1 = (abs (max (last_1_WrapperStruct00_var_1_13 , last_1_WrapperStruct00_var_1_11)));
	}


	// From: Req4Batch104Wrapper_S
	if ((~ WrapperStruct00.var_1_10) < WrapperStruct00.var_1_9) {
		WrapperStruct00.var_1_11 = ((max (last_1_WrapperStruct00_var_1_13 , (WrapperStruct00.var_1_12 - last_1_WrapperStruct00_var_1_1))) + (max (last_1_WrapperStruct00_var_1_1 , WrapperStruct00.var_1_10)));
	} else {
		WrapperStruct00.var_1_11 = ((max (WrapperStruct00.var_1_12 , last_1_WrapperStruct00_var_1_13)) + WrapperStruct00.var_1_10);
	}


	// From: Req2Batch104Wrapper_S
	if (WrapperStruct00.var_1_6) {
		WrapperStruct00.var_1_5 = (! WrapperStruct00.var_1_7);
	}


	// From: Req3Batch104Wrapper_S
	if (WrapperStruct00.var_1_5) {
		WrapperStruct00.var_1_8 = (WrapperStruct00.var_1_9 - WrapperStruct00.var_1_10);
	}


	// From: Req5Batch104Wrapper_S
