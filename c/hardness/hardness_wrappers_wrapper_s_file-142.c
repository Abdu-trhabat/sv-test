...
void step(void) {
	...
	// From: Req2Batch142Wrapper_S
	if ((WrapperStruct00.var_1_7 - WrapperStruct00.var_1_8) <= 0) {
		WrapperStruct00.var_1_6 = (abs (WrapperStruct00.var_1_9));
	}


	// From: Req3Batch142Wrapper_S
	...
	if (stepLocal_0 && WrapperStruct00.var_1_12) {
		...
		WrapperStruct00.var_1_10 = (min (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_14));
	}


	// From: Req4Batch142Wrapper_S
	unsigned long int stepLocal_1 = WrapperStruct00.var_1_2;
	if (stepLocal_1 == (max (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_5))) {
