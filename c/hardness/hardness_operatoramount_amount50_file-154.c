...
void step(void) {
	...
	// From: Req2Batch154Amount50
	if (var_1_4 == var_1_5) {
		var_1_10 = (max ((var_1_11 + var_1_12) , var_1_13));
	}


	// From: Req3Batch154Amount50
	if (var_1_11 > var_1_4) {
		if (var_1_8 > var_1_4) {
			var_1_14 = var_1_8;
		}
