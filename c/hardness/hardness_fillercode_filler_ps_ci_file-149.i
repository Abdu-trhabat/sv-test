...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch149Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
  ...
  var_1_20
   ...
   0
                   ...
                   if ( (( ((var_1_16) * ( ((var_1_16) & (var_1_30))))) <= ( ((var_1_29) | (1u))))) {
                    var_1_32 = (
