...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[1] && stepLocal_1) {
  double_Array_0[6] = (((((double_Array_0[0] - double_Array_0[3])) < (((((((((double_Array_0[2]) > (double_Array_0[5])) ? (double_Array_0[2]) : (double_Array_0[5])))) > (double_Array_0[1])) ? (((((double_Array_0[2]) > (double_Array_0[5])) ? (double_Array_0[2]) : (double_Array_0[5])))) : (double_Array_0[1]))))) ? ((double_Array_0[0] - double_Array_0[3])) : (((((((((double_Array_0[2]) > (double_Array_0[5])) ? (double_Array_0[2]) : (double_Array_0[5])))) > (double_Array_0[1])) ? (((((double_Array_0[2]) > (double_Array_0[5])) ? (double_Array_0[2]) : (double_Array_0[5])))) : (double_Array_0[1]))))));
 } else {
 ...
 if ((unsigned_long_int_Array_0[0][1] >= unsigned_long_int_Array_0[1][0]) || BOOL_unsigned_char_Array_0[2]) {
  if (BOOL_unsigned_char_Array_0[2]) {
   ...
   unsigned_long_int_Array_0[1][1] = ((((unsigned_long_int_Array_0[0][0]) > (32u)) ? (unsigned_long_int_Array_0[0][0]) : (32u)));
  }
 }
 if (BOOL_unsigned_char_Array_0[2]) {
...
int property(void) {
 return ((((((unsigned_long_int_Array_0[0][1] >= unsigned_long_int_Array_0[1][0]) || BOOL_unsigned_char_Array_0[2]) ? (BOOL_unsigned_char_Array_0[2] ? (unsigned_long_int_Array_0[1][1] == ((unsigned long int) 4u)) : (unsigned_long_int_Array_0[1][1] == ((unsigned long int) ((((unsigned_long_int_Array_0[0][0]) > (32u)) ? (unsigned_long_int_Array_0[0][0]) : (32u)))))) : 1) && (BOOL_unsigned_char_Array_0[2] ? (double_Array_0[4] == ((double) double_Array_0[2])) : 1)) && ((BOOL_unsigned_char_Array_0[6] && BOOL_unsigned_char_Array_0[3]) ? (BOOL_unsigned_char_Array_0[2] == ((unsigned char) ((BOOL_unsigned_char_Array_0[0] || BOOL_unsigned_char_Array_0[1]) || (BOOL_unsigned_char_Array_0[4] || BOOL_unsigned_char_Array_0[5])))) : 1)) && (((- double_Array_0[2]) < double_Array_0[6]) ? (signed_long_int_Array_0[0] == ((signed long int) (signed_long_int_Array_0[1] - (signed_long_int_Array_0[2] - 5)))) : (signed_long_int_Array_0[0] == ((signed long int) (32 - signed_long_int_Array_0[2]))))) && ((BOOL_unsigned_char_Array_0[1] && BOOL_unsigned_char_Array_0[4]) ? (double_Array_0[6] == ((double) (((((double_Array_0[0] - double_Array_0[3])) < (((((((((double_Array_0[2]) > (double_Array_0[5])) ? (double_Array_0[2]) : (double_Array_0[5])))) > (double_Array_0[1])) ? (((((double_Array_0[2]) > (double_Array_0[5])) ? (double_Array_0[2]) : (double_Array_0[5])))) : (double_Array_0[1]))))) ? ((double_Array_0[0] - double_Array_0[3])) : (((((((((double_Array_0[2]) > (double_Array_0[5])) ? (double_Array_0[2]) : (double_Array_0[5])))) > (double_Array_0[1])) ? (((((double_Array_0[2]) > (double_Array_0[5])) ? (double_Array_0[2]) : (double_Array_0[5])))) : (double_Array_0[1])))))))) : (double_Array_0[6] == ((double) double_Array_0[3])))
;
}
int main(void) {
 isInitial = 1;
