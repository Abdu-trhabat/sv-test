...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch112100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch112100_1loop
	var_1_23 = (var_1_10 + var_1_24);


	// From: Req4Batch112100_1loop
	var_1_14 = (max (var_1_11 , var_1_10));


	// From: Req10Batch112100_1loop
	var_1_28 = (! var_1_29);


	// From: Req14Batch112100_1loop
	if (-1 <= var_1_17) {
		var_1_33 = (var_1_21 - var_1_4);
	}


	// From: Req2Batch112100_1loop
	if (var_1_28) {
		var_1_8 = (max (var_1_10 , var_1_11));
	}


	// From: Req7Batch112100_1loop
	if (var_1_28) {
		var_1_22 = var_1_17;
	}


	// From: Req6Batch112100_1loop
	...
	// From: Req3Batch112100_1loop
	if (var_1_28) {
		var_1_12 = ((min ((var_1_13 - 50) , var_1_24)) - var_1_22);
	}


	// From: Req1Batch112100_1loop
