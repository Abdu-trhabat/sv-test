...
void functionized0(signed short int functionized0_localFunctionVar0, signed short int functionized0_localFunctionVar1, float functionized0_localFunctionVar2) {
 if (var_1_2 || (var_1_3 > functionized0_localFunctionVar2)) {
  ...
  var_1_1 = ((((((var_1_7 + 1)) < (var_1_8)) ? ((var_1_7 + 1)) : (var_1_8))) - (24762 - functionized0_localFunctionVar1));
 }
}
void functionized1(void) {
 var_1_10 = var_1_11;
...
void functionized3(unsigned short int functionized3_localFunctionVar0, unsigned char functionized3_localFunctionVar1, signed short int functionized3_localFunctionVar2) {
 if (! functionized3_localFunctionVar1) {
  var_1_19 = (((((var_1_7) < (functionized3_localFunctionVar2)) ? (var_1_7) : (functionized3_localFunctionVar2))) + functionized3_localFunctionVar0);
 }
}
void initially(void) {
}
