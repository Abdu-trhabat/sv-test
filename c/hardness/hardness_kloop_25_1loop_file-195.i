...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19525_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_10 <= stepLocal_0) {
  var_1_6 = (((((((((var_1_7 + var_1_8)) < (var_1_9)) ? ((var_1_7 + var_1_8)) : (var_1_9)))) > (9.2)) ? ((((((var_1_7 + var_1_8)) < (var_1_9)) ? ((var_1_7 + var_1_8)) : (var_1_9)))) : (9.2)));
 } else {
  var_1_6 = var_1_8;
 }
}
...
int property(void) {
 return ((((var_1_2 < var_1_3) ? (var_1_1 == ((unsigned char) var_1_4)) : (var_1_1 == ((unsigned char) (var_1_4 && var_1_5)))) && ((var_1_10 <= var_1_13) ? (var_1_6 == ((double) (((((((((var_1_7 + var_1_8)) < (var_1_9)) ? ((var_1_7 + var_1_8)) : (var_1_9)))) > (9.2)) ? ((((((var_1_7 + var_1_8)) < (var_1_9)) ? ((var_1_7 + var_1_8)) : (var_1_9)))) : (9.2))))) : (var_1_6 == ((double) var_1_8)))) && ((var_1_7 < var_1_9) ? ((var_1_5 || var_1_1) ? (var_1_10 == ((unsigned short int) var_1_13)) : (var_1_10 == ((unsigned short int) (((var_1_11 - var_1_13) - last_1_var_1_10) - var_1_12)))) : 1)) && ((var_1_8 <= var_1_9) ? ((var_1_3 > var_1_2) ? (var_1_13 == ((signed short int) 1)) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
