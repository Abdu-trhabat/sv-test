...
void step(void) {
	...
	if (var_1_7 <= stepLocal_2) {
		if (var_1_3 >= stepLocal_1) {
			var_1_9 = (var_1_12 + (abs (min (var_1_13 , var_1_14))));
		}
	} else {
...
int property(void) {
	return ((((8 >= (var_1_2 + var_1_3)) ? (var_1_1 == ((signed short int) (min (var_1_4 , (var_1_5 + 10))))) : 1) && ((var_1_3 <= var_1_2) ? (var_1_6 == ((unsigned short int) (var_1_7 + var_1_8))) : 1)) && ((var_1_7 <= (var_1_6 + var_1_15)) ? ((var_1_3 >= var_1_7) ? (var_1_9 == ((double) (var_1_12 + (abs (min (var_1_13 , var_1_14)))))) : 1) : (var_1_9 == ((double) (var_1_14 + var_1_12))))) && (((var_1_11 || var_1_16) || (! var_1_17)) ? ((var_1_6 < var_1_7) ? (var_1_15 == ((signed short int) (min (var_1_5 , var_1_4)))) : (var_1_17 ? (var_1_15 == ((signed short int) var_1_5)) : 1)) : (var_1_15 == ((signed short int) var_1_5)))
;
}
int main(void) {
	isInitial = 1;
