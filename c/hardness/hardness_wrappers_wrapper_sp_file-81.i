...
void step(void) {
 ...
 if (((((-25) < ((*(WrapperStruct00_var_1_13_Pointer)))) ? (-25) : ((*(WrapperStruct00_var_1_13_Pointer))))) != stepLocal_0) {
  if ((*(WrapperStruct00_var_1_2_Pointer))) {
