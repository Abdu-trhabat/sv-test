...
void step(void) {
	...
	if (var_1_2 <= ((var_1_3 / var_1_4) & 8)) {
		if (-16 <= var_1_3) {
			if (var_1_2 != (var_1_3 / (min (var_1_4 , var_1_5)))) {
				var_1_1 = (max (var_1_3 , var_1_2));
			} else {
				var_1_1 = (abs (var_1_2));
			}
		}
