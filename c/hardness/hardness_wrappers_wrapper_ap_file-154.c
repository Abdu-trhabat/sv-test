...
void step(void) {
	...
	if (stepLocal_1 < ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) + (abs ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)))))) {
	...
	if ((max ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)))) != stepLocal_0) {
		(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var6_Pointer)) = (abs ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var5_Pointer))));
	} else {
		(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var6_Pointer)) = (min (((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)) + (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var5_Pointer))));
	}
}
