...
void step(void) {
	...
	// From: Req5Batch114normal
	if ((max ((~ 0u) , var_1_10)) > var_1_5) {
		var_1_14 = var_1_5;
	}


	// From: Req6Batch114normal
	if (var_1_5 < var_1_3) {
		if (var_1_6 && var_1_4) {
	...
	// From: Req7Batch114normal
	var_1_20 = var_1_21;


	// From: Req8Batch114normal
	var_1_22 = 16u;


	// From: Req9Batch114normal
	var_1_23 = var_1_18;
}
