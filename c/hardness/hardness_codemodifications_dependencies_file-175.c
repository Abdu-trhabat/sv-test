...
void step(void) {
	...
	// From: Req2Batch175dependencies
	var_1_5 = (! (var_1_6 && var_1_7));


	// From: Req5Batch175dependencies
	...
	// From: Req6Batch175dependencies
	var_1_20 = (var_1_18 + (max ((var_1_19 - 5.9f) , var_1_21)));


	// From: Req7Batch175dependencies
	...
	// From: Req8Batch175dependencies
	var_1_28 = var_1_2;


	// From: Req3Batch175dependencies
	if ((var_1_20 * (var_1_15 + var_1_20)) > var_1_20) {
		var_1_8 = var_1_7;
	}


	// From: Req4Batch175dependencies
