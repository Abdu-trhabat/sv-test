...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	/* 341L, 204L) */ if (/* 342L, 156L, 157L) */ ((var_1_33) >= (/* 344L, 155L, 159L) */ ((var_1_12) % (/* 346L, 154L, 161L) */ (abs (var_1_37))))))) {
	...
	// From: CodeObject5
	/* 363L, 227L) */ if (/* 364L, 213L, 214L) */ ((var_1_21) > (var_1_22))) {
		/* 367L, 226L) */ var_1_39 = (
			/* 370L, 225L) */ (min (
				/* 370L, 225L) */ (
					var_1_23
	...
	// From: CodeObject6
	/* 375L, 281L) */ if (/* 376L, 235L, 236L) */ ((var_1_1) < (/* 378L, 234L, 238L) */ (min (/* 378L, 234L, 238L) */ (var_1_38) , (-64)))))) {
		/* 381L, 249L) */ var_1_40 = (
			var_1_26
		);
	} else {
		/* 385L, 279L) */ if (/* 386L, 256L, 257L) */ ((/* 387L, 252L, 258L) */ ((var_1_37) | (var_1_31))) < (/* 390L, 255L, 261L) */ ((8) + (var_1_23))))) {
			/* 393L, 278L) */ var_1_40 = (
				/* 396L, 277L) */ (abs (
					/* 397L, 276L) */ (max (
						/* 397L, 276L) */ (
	...
	// From: CodeObject2
	/* 298L, 114L) */ if (/* 299L, 78L, 79L) */ ((/* 300L, 74L, 80L) */ ((var_1_26) >= (var_1_15))) && (/* 303L, 77L, 83L) */ ((var_1_8) >= (var_1_12))))) {
	...
	/* 324L, 147L) */ if (/* 325L, 120L, 121L) */ ((var_1_26) > (var_1_15))) {
		/* 328L, 145L) */ if (/* 329L, 129L, 130L) */ ((var_1_8) >= (var_1_34))) {
			/* 332L, 144L) */ var_1_35 = (
				/* 335L, 143L) */ (abs (
					/* 336L, 142L) */ (min (
						/* 336L, 142L) */ (
