...
void step(void) {
	...
	if (var_1_29 <= stepLocal_8) {
		...
		if ((max (last_1_var_1_65 , var_1_36)) > stepLocal_9) {
			var_1_55 = (! 0);
		}
	}
	...
	if (var_1_25) {
		var_1_35 = (((max (var_1_36 , 1681572688)) - (var_1_14 + last_1_var_1_23)) - last_1_var_1_27);
	} else {
		if ((var_1_38 - 4u) < last_1_var_1_35) {
			...
			if (last_1_var_1_23 != var_1_4) {
				...
				var_1_35 = ((1718673321 - var_1_14) - (max ((last_1_var_1_35 + var_1_34) , var_1_33)));
			}
		}
	}


	// From: Req25Batch25Amount250
	...
	if (var_1_26) {
		var_1_27 = (max ((max (last_1_var_1_66 , last_1_var_1_11)) , ((var_1_28 + var_1_29) - last_1_var_1_13)));
	} else {
		var_1_27 = (min (last_1_var_1_66 , var_1_14));
	}
	...
	if (var_1_26 || (var_1_27 >= (~ var_1_6))) {
		var_1_43 = ((min (var_1_7 , var_1_33)) + var_1_6);
	}
	...
	if (! var_1_20) {
		var_1_63 = (var_1_32 - (max (var_1_34 , var_1_33)));
	} else {
		var_1_63 = (min (var_1_6 , (max (var_1_34 , (var_1_32 + var_1_33)))));
	}


	// From: Req24Batch25Amount250
	if (! var_1_20) {
		var_1_64 = (min (var_1_51 , (abs (var_1_40))));
	}


	// From: Req27Batch25Amount250
	var_1_67 = var_1_49;
	...
	if (var_1_25) {
		var_1_46 = ((var_1_47 - (min (var_1_48 , var_1_49))) - (var_1_50 - var_1_51));
	} else {
		if ((var_1_48 + var_1_64) <= var_1_51) {
			var_1_46 = (min (var_1_40 , var_1_41));
		}
	}
	...
	if (! (var_1_11 >= var_1_35)) {
		if (256 != stepLocal_0) {
			var_1_1 = (max ((var_1_4 + -25) , (abs (var_1_35))));
		}
	} else {
		var_1_1 = var_1_4;
	}
	...
	if ((var_1_33 + last_1_var_1_44) > var_1_35) {
		var_1_44 = (max (((var_1_11 + last_1_var_1_44) + var_1_27) , (min (var_1_68 , (min (0 , var_1_33))))));
	}
	...
	if (var_1_51 >= ((- var_1_16) + (var_1_40 + 7.4f))) {
		if (! (! var_1_26)) {
			...
			if (stepLocal_10 != var_1_42) {
				if ((abs (var_1_7)) >= stepLocal_11) {
					var_1_57 = ((max (var_1_48 , var_1_58)) + (var_1_49 - var_1_51));
				} else {
					var_1_57 = (max ((var_1_58 + var_1_59) , var_1_47));
				}
			} else {
					...
					if (var_1_37 <= stepLocal_12) {
						if (var_1_20) {
							...
							if (var_1_60 < var_1_41) {
								...
								var_1_57 = (min ((var_1_58 - var_1_50) , 127.525f));
							}
						}
					} else {
						var_1_57 = (max ((var_1_61 + (var_1_48 - var_1_51)) , ((abs (var_1_41)) + (var_1_58 - 8.825f))));
					}
				}
			}
		}
	} else {
		var_1_57 = (var_1_49 - ((max (var_1_50 , var_1_47)) - 3.6f));
	}
	...
	if (stepLocal_2 >= var_1_1) {
		...
		if (128.25 < (- (var_1_9 + var_1_10))) {
			if (stepLocal_1 >= var_1_4) {
				var_1_8 = (min ((min (var_1_54 , var_1_7)) , var_1_6));
			}
		}
	}
	...
	if (! var_1_55) {
		...
		if (var_1_17 < var_1_67) {
			var_1_21 = (max ((max ((var_1_66 - var_1_54) , -10000)) , var_1_6));
		} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((! (var_1_11 >= var_1_35)) ? ((256 != (var_1_35 + var_1_11)) ? (var_1_1 == ((signed long int) (max ((var_1_4 + -25) , (abs (var_1_35)))))) : 1) : (var_1_1 == ((signed long int) var_1_4))) && (var_1_5 == ((signed char) (var_1_6 + var_1_7)))) && ((var_1_6 >= var_1_1) ? (var_1_8 == ((signed long int) (-32 + (var_1_54 - var_1_1)))) : ((128.25 < (- (var_1_9 + var_1_10))) ? ((var_1_1 >= var_1_4) ? (var_1_8 == ((signed long int) (min ((min (var_1_54 , var_1_7)) , var_1_6)))) : 1) : 1))) && (var_1_24 ? (var_1_11 == ((signed long int) (var_1_7 + var_1_4))) : 1)) && (var_1_13 == ((unsigned short int) (var_1_14 - var_1_65)))) && ((var_1_13 < -32) ? (var_1_15 == ((float) (var_1_16 - (abs (var_1_17 - var_1_18))))) : 1)) && ((var_1_8 == var_1_27) ? (var_1_19 == ((unsigned char) (! (! 0)))) : (var_1_19 == ((unsigned char) var_1_20)))) && ((! var_1_55) ? (((var_1_14 * var_1_8) > 128) ? (var_1_21 == ((signed short int) (var_1_6 + 200))) : 1) : ((var_1_17 < var_1_67) ? (var_1_21 == ((signed short int) (max ((max ((var_1_66 - var_1_54) , -10000)) , var_1_6)))) : ((var_1_18 > var_1_67) ? (var_1_55 ? (var_1_21 == ((signed short int) (((var_1_42 + var_1_54) + var_1_66) + var_1_7))) : 1) : (var_1_21 == ((signed short int) var_1_42)))))) && ((var_1_7 <= (var_1_66 * last_1_var_1_23)) ? (var_1_23 == ((signed short int) var_1_7)) : 1)) && ((var_1_20 && var_1_52) ? (var_1_24 == ((unsigned char) (var_1_20 || (var_1_25 || var_1_26)))) : (var_1_24 == ((unsigned char) (var_1_52 && (var_1_25 && var_1_20)))))) && (var_1_26 ? (var_1_27 == ((unsigned long int) (max ((max (last_1_var_1_66 , last_1_var_1_11)) , ((var_1_28 + var_1_29) - last_1_var_1_13))))) : (var_1_27 == ((unsigned long int) (min (last_1_var_1_66 , var_1_14)))))) && (var_1_55 ? (var_1_30 == ((signed char) (var_1_31 - (var_1_32 + (var_1_33 - var_1_34))))) : (var_1_30 == ((signed char) (var_1_7 + (var_1_34 + 4)))))) && (var_1_25 ? (var_1_35 == ((signed long int) (((max (var_1_36 , 1681572688)) - (var_1_14 + last_1_var_1_23)) - last_1_var_1_27))) : (((var_1_38 - 4u) < last_1_var_1_35) ? (var_1_35 == ((signed long int) last_1_var_1_65)) : ((last_1_var_1_23 != var_1_4) ? (var_1_35 == ((signed long int) last_1_var_1_65)) : (var_1_35 == ((signed long int) ((1718673321 - var_1_14) - (max ((last_1_var_1_35 + var_1_34) , var_1_33))))))))) && (var_1_39 == ((double) (var_1_40 + var_1_41)))) && (var_1_42 == ((unsigned short int) var_1_1))) && ((var_1_26 || (var_1_27 >= (~ var_1_6))) ? (var_1_43 == ((signed char) ((min (var_1_7 , var_1_33)) + var_1_6))) : 1)) && (((var_1_33 + last_1_var_1_44) > var_1_35) ? (var_1_44 == ((signed long int) (max (((var_1_11 + last_1_var_1_44) + var_1_27) , (min (var_1_68 , (min (0 , var_1_33)))))))) : 1)) && (var_1_25 ? (var_1_46 == ((float) ((var_1_47 - (min (var_1_48 , var_1_49))) - (var_1_50 - var_1_51)))) : (((var_1_48 + var_1_64) <= var_1_51) ? (var_1_46 == ((float) (min (var_1_40 , var_1_41)))) : 1))) && (var_1_52 == ((unsigned char) var_1_53))) && ((var_1_50 > var_1_57) ? (((var_1_34 - var_1_33) > (256 + 5)) ? (var_1_54 == ((signed short int) (var_1_31 - var_1_32))) : (var_1_54 == ((signed short int) (var_1_34 - (var_1_27 + (var_1_32 + var_1_33)))))) : (var_1_54 == ((signed short int) (var_1_33 - var_1_32))))) && ((var_1_29 <= var_1_14) ? (var_1_55 == ((unsigned char) var_1_53)) : (((max (last_1_var_1_65 , var_1_36)) > last_1_var_1_44) ? (var_1_55 == ((unsigned char) (! 0))) : 1))) && ((var_1_51 >= ((- var_1_16) + (var_1_40 + 7.4f))) ? ((! (! var_1_26)) ? (var_1_57 == ((float) (((var_1_58 - var_1_59) - var_1_51) + (var_1_60 + var_1_61)))) : ((var_1_32 != var_1_42) ? (((abs (var_1_7)) >= var_1_23) ? (var_1_57 == ((float) ((max (var_1_48 , var_1_58)) + (var_1_49 - var_1_51)))) : (var_1_57 == ((float) (max ((var_1_58 + var_1_59) , var_1_47))))) : ((var_1_47 == last_1_var_1_57) ? (var_1_57 == ((float) (var_1_60 + 16.5f))) : ((var_1_37 <= var_1_28) ? (var_1_20 ? (var_1_57 == ((float) (3.5f - var_1_48))) : ((var_1_60 < var_1_41) ? (var_1_57 == ((float) (var_1_41 + var_1_58))) : (var_1_57 == ((float) (min ((var_1_58 - var_1_50) , 127.525f)))))) : (var_1_57 == ((float) (max ((var_1_61 + (var_1_48 - var_1_51)) , ((abs (var_1_41)) + (var_1_58 - 8.825f)))))))))) : (var_1_57 == ((float) (var_1_49 - ((max (var_1_50 , var_1_47)) - 3.6f)))))) && ((! var_1_20) ? (var_1_63 == ((signed char) (var_1_32 - (max (var_1_34 , var_1_33))))) : (var_1_63 == ((signed char) (min (var_1_6 , (max (var_1_34 , (var_1_32 + var_1_33))))))))) && ((! var_1_20) ? (var_1_64 == ((float) (min (var_1_51 , (abs (var_1_40)))))) : 1)) && ((var_1_35 < var_1_29) ? (var_1_65 == ((unsigned char) var_1_33)) : 1)) && (var_1_25 ? (var_1_66 == ((unsigned long int) last_1_var_1_69)) : (var_1_66 == ((unsigned long int) last_1_var_1_8)))) && (var_1_67 == ((double) var_1_49))) && (var_1_55 ? (var_1_68 == ((signed short int) var_1_69)) : (var_1_68 == ((signed short int) var_1_6)))) && ((var_1_11 < var_1_30) ? (var_1_69 == ((unsigned short int) (16 + var_1_13))) : ((var_1_14 > var_1_66) ? (var_1_69 == ((unsigned short int) ((var_1_71 - var_1_34) + var_1_11))) : (var_1_69 == ((unsigned short int) var_1_33))))
;
}
int main(void) {
	isInitial = 1;
