...
void step(void) {
	// From: Req1Batch169no_floats
	if (var_1_2 >= var_1_3) {
		if (var_1_2 < (max ((var_1_3 / var_1_4) , (-128 * var_1_5)))) {
			var_1_1 = var_1_6;
		}
	}


	// From: Req4Batch169no_floats
	var_1_16 = 0;


	// From: Req5Batch169no_floats
	var_1_17 = var_1_18;


	// From: Req6Batch169no_floats
	var_1_19 = var_1_13;


	// From: Req3Batch169no_floats
	unsigned char stepLocal_0 = -25 >= (min (var_1_8 , var_1_1));
	if (var_1_11 && stepLocal_0) {
		if ((min (var_1_10 , var_1_19)) <= var_1_19) {
			var_1_14 = 0;
		} else {
			var_1_14 = 1;
		}
	...
	// From: Req2Batch169no_floats
	if (var_1_6 == (min (var_1_16 , var_1_1))) {
...
int property(void) {
	return ((((((var_1_2 >= var_1_3) ? ((var_1_2 < (max ((var_1_3 / var_1_4) , (-128 * var_1_5)))) ? (var_1_1 == ((signed short int) var_1_6)) : 1) : 1) && ((var_1_6 == (min (var_1_16 , var_1_1))) ? (var_1_7 == ((signed long int) (var_1_9 - var_1_10))) : (var_1_14 ? (var_1_7 == ((signed long int) (var_1_12 + var_1_13))) : (var_1_7 == ((signed long int) var_1_10))))) && ((var_1_11 && (-25 >= (min (var_1_8 , var_1_1)))) ? (((min (var_1_10 , var_1_19)) <= var_1_19) ? (var_1_14 == ((unsigned char) 0)) : (var_1_14 == ((unsigned char) 1))) : (var_1_14 == ((unsigned char) var_1_15)))) && (var_1_16 == ((signed short int) 0))) && (var_1_17 == ((signed char) var_1_18))) && (var_1_19 == ((signed long int) var_1_13))
;
}
int main(void) {
	isInitial = 1;
