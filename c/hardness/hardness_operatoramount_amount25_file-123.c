...
void step(void) {
	...
	// From: Req2Batch123Amount25
	var_1_7 = ((min (var_1_8 , var_1_9)) - (var_1_10 + 1));


	// From: Req3Batch123Amount25
	...
	// From: Req4Batch123Amount25
	var_1_17 = (max (0 , var_1_13));


	// From: Req5Batch123Amount25
	var_1_18 = var_1_13;


	// From: Req6Batch123Amount25
	var_1_19 = var_1_16;
}
