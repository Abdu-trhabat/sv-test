...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4025_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch4025_1loop
	if (var_1_2) {
		if (var_1_3 && (var_1_4 <= (- 63.9f))) {
			if (var_1_4 >= var_1_5) {
				if ((last_1_var_1_9 / var_1_7) <= last_1_var_1_9) {
	...
	// From: Req2Batch4025_1loop
	if ((var_1_10 - var_1_11) >= var_1_1) {
		var_1_9 = (var_1_11 + 2u);
	}


	// From: Req3Batch4025_1loop
	if (var_1_2) {
		var_1_12 = (min ((abs (var_1_13 - var_1_14)) , (min (var_1_15 , var_1_16))));
	} else {
		var_1_12 = (max (var_1_15 , var_1_16));
	}


	// From: Req4Batch4025_1loop
	var_1_17 = -4;
}
...
int property(void) {
	return (((var_1_2 ? ((var_1_3 && (var_1_4 <= (- 63.9f))) ? ((var_1_4 >= var_1_5) ? (((last_1_var_1_9 / var_1_7) <= last_1_var_1_9) ? (var_1_1 == ((signed long int) last_1_var_1_9)) : 1) : 1) : 1) : 1) && (((var_1_10 - var_1_11) >= var_1_1) ? (var_1_9 == ((unsigned long int) (var_1_11 + 2u))) : 1)) && (var_1_2 ? (var_1_12 == ((float) (min ((abs (var_1_13 - var_1_14)) , (min (var_1_15 , var_1_16)))))) : (var_1_12 == ((float) (max (var_1_15 , var_1_16)))))) && (var_1_17 == ((signed char) -4))
;
}
int main(void) {
	isInitial = 1;
