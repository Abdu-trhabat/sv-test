...
void step(void) {
	...
	// From: Req4Batch184normal
	var_1_13 = var_1_11;


	// From: Req6Batch184normal
	var_1_15 = var_1_4;


	// From: Req2Batch184normal
	unsigned long int stepLocal_1 = (max (var_1_15 , var_1_2)) / (max (var_1_7 , var_1_8));
	if ((var_1_5 + var_1_4) > stepLocal_1) {
		var_1_6 = (max (var_1_4 , var_1_15));
	}


	// From: Req5Batch184normal
	var_1_14 = var_1_15;
}
...
int property(void) {
	return ((((((var_1_2 <= var_1_3) ? (var_1_1 == ((unsigned char) (var_1_4 - 32))) : (var_1_1 == ((unsigned char) (max ((max (var_1_4 , 100)) , var_1_5))))) && (((var_1_5 + var_1_4) > ((max (var_1_15 , var_1_2)) / (max (var_1_7 , var_1_8)))) ? (var_1_6 == ((unsigned short int) (max (var_1_4 , var_1_15)))) : 1)) && ((((var_1_1 + var_1_8) + var_1_2) < var_1_5) ? (var_1_10 ? (var_1_9 == ((float) (abs (var_1_11 - 4.25f)))) : (var_1_9 == ((float) (var_1_11 - (8.966829933912052E18f - var_1_12))))) : (var_1_9 == ((float) var_1_12)))) && (var_1_13 == ((float) var_1_11))) && (var_1_14 == ((signed long int) var_1_15))) && (var_1_15 == ((unsigned short int) var_1_4))
;
}
int main(void) {
	isInitial = 1;
