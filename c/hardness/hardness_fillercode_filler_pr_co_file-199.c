...
void step(void) {
	...
	// From: CodeObject3
	/* 253L, 73L) */ if (/* 254L, 28L, 29L) */ ((var_1_9) < (var_1_14))) {
		/* 257L, 67L) */ if (/* 258L, 39L, 40L) */ ((var_1_29) == (/* 260L, 38L, 42L) */ ((var_1_9) ^ (32))))) {
			/* 263L, 55L) */ var_1_30 = (
				/* 266L, 54L) */ (abs (
					/* 267L, 53L) */ (abs (
						var_1_31
	...
	// From: CodeObject7
	/* 341L, 233L) */ if (/* 342L, 197L, 198L) */ ((/* 343L, 193L, 199L) */ ((/* 344L, 191L, 200L) */ (min (/* 344L, 191L, 200L) */ (var_1_32) , (var_1_31)))) <= (var_1_1))) && (/* 348L, 196L, 204L) */ ((var_1_33) < (var_1_34))))) {
		/* 351L, 227L) */ if (var_1_12) {
			/* 353L, 222L) */ var_1_41 = (
				var_1_38
			);
		} else {
	...
	// From: CodeObject4
	/* 284L, 114L) */ if (/* 285L, 83L, 84L) */ ((/* 286L, 81L, 85L) */ (max (/* 286L, 81L, 85L) */ (var_1_26) , (/* 288L, 80L, 87L) */ ((var_1_21) / (2)))))) <= (4))) {
		/* 292L, 101L) */ var_1_35 = (
			var_1_36
		);
	} else {
	...
	// From: CodeObject6
	/* 321L, 185L) */ if (/* 322L, 157L, 158L) */ ((var_1_27) != (/* 324L, 156L, 160L) */ ((var_1_26) * (var_1_21))))) {
		/* 327L, 183L) */ if (var_1_36) {
			/* 329L, 178L) */ var_1_40 = (
				/* 332L, 177L) */ (min (
					/* 332L, 177L) */ (
						/* 333L, 175L) */ (max (
