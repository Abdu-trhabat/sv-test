...
void step(void) {
	...
	if (last_1_var_1_19 <= ((abs (var_1_13)) ^ last_1_var_1_35)) {
		var_1_20 = (max (var_1_6 , (var_1_5 + var_1_16)));
	} else {
		var_1_20 = var_1_6;
	}
	...
	if (var_1_21) {
		...
		var_1_29 = (max (((var_1_16 + var_1_15) + -16) , (min (var_1_14 , (min (var_1_30 , var_1_17))))));
	}
	...
	if (((var_1_31 / var_1_32) > (max (var_1_18 , var_1_33))) && stepLocal_4) {
		if (var_1_38 <= 0.125f) {
...
int property(void) {
	return ((((((((((((((- var_1_23) == var_1_38) ? (var_1_1 == ((unsigned long int) (min ((var_1_4 + var_1_5) , var_1_6)))) : (var_1_1 == ((unsigned long int) var_1_4))) && (((127.35 + var_1_38) <= var_1_38) ? (((var_1_20 < var_1_4) || last_1_var_1_7) ? (var_1_7 == ((unsigned char) (last_1_var_1_7 && var_1_9))) : (var_1_7 == ((unsigned char) (! var_1_10)))) : 1)) && (var_1_7 ? (var_1_11 == ((signed char) (min (var_1_12 , (min (var_1_13 , var_1_14)))))) : (var_1_11 == ((signed char) (var_1_15 - var_1_16))))) && (var_1_17 == ((signed long int) (min (4 , ((1807938565 - 128) - var_1_16)))))) && (var_1_21 ? (var_1_18 == ((signed long int) var_1_14)) : (var_1_18 == ((signed long int) (var_1_15 + var_1_14))))) && (((var_1_15 + var_1_1) == var_1_1) ? ((var_1_7 && var_1_10) ? ((var_1_16 < var_1_1) ? (var_1_19 == ((signed short int) ((var_1_12 + var_1_18) + var_1_15))) : 1) : 1) : (var_1_19 == ((signed short int) (min (var_1_13 , 128)))))) && ((last_1_var_1_19 <= ((abs (var_1_13)) ^ last_1_var_1_35)) ? (var_1_20 == ((unsigned long int) (max (var_1_6 , (var_1_5 + var_1_16))))) : (var_1_20 == ((unsigned long int) var_1_6)))) && (var_1_21 == ((unsigned char) (! (var_1_9 && var_1_22))))) && (var_1_21 ? (var_1_23 == ((float) ((var_1_24 + var_1_25) + (min (var_1_26 , (min (var_1_27 , var_1_28))))))) : 1)) && (var_1_21 ? (var_1_29 == ((signed long int) ((1349734853 - var_1_16) - (1715174523 - var_1_30)))) : (var_1_29 == ((signed long int) (max (((var_1_16 + var_1_15) + -16) , (min (var_1_14 , (min (var_1_30 , var_1_17)))))))))) && (var_1_22 ? (var_1_31 == ((unsigned char) (min (var_1_16 , (var_1_32 - (var_1_33 - var_1_34)))))) : 1)) && ((((var_1_31 / var_1_32) > (max (var_1_18 , var_1_33))) && var_1_21) ? ((var_1_38 <= 0.125f) ? (var_1_35 == ((signed short int) (((min (var_1_36 , var_1_37)) - var_1_33) - var_1_16))) : 1) : ((var_1_18 == var_1_20) ? (var_1_35 == ((signed short int) (abs (var_1_32)))) : (var_1_35 == ((signed short int) var_1_13))))) && (var_1_9 ? ((var_1_25 == var_1_26) ? (var_1_38 == ((float) ((min (var_1_24 , var_1_39)) + var_1_25))) : (var_1_38 == ((float) var_1_39))) : (var_1_38 == ((float) var_1_25)))
;
}
int main(void) {
	isInitial = 1;
