...
void step(void) {
	...
	// From: CodeObject2
	/* 279L, 110L) */ if (/* 280L, 52L, 53L) */ ((var_1_19) > (/* 282L, 51L, 55L) */ ((var_1_29) / (/* 284L, 50L, 57L) */ (max (/* 284L, 50L, 57L) */ (var_1_31) , (var_1_32)))))))) {
		/* 287L, 108L) */ if (/* 288L, 71L, 72L) */ ((/* 289L, 69L, 73L) */ (abs (/* 290L, 68L, 74L) */ (abs (var_1_19))))) <= (var_1_32))) {
			/* 293L, 86L) */ var_1_30 = (
				/* 296L, 85L) */ (abs (
					var_1_31
				))
	...
	/* 330L, 225L) */ if (/* 331L, 163L, 164L) */ ((-2) <= (var_1_29))) {
		/* 334L, 219L) */ if (/* 335L, 172L, 173L) */ ((var_1_21) <= (var_1_29))) {
			/* 338L, 217L) */ if (var_1_33) {
				...
				/* 346L, 215L) */ if (/* 347L, 193L, 194L) */ ((/* 348L, 191L, 195L) */ ((var_1_29) / (var_1_32))) != (var_1_21))) {
					/* 352L, 210L) */ var_1_36 = (
						/* 355L, 209L) */ ((
							/* 356L, 207L) */ (abs (
								var_1_31
