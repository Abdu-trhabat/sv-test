...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch33Filler_PE_CI.c", 13, "reach_error"); }
 ...
 unsigned char stepLocal_2 = (( ((32.6) * (var_1_8))) >= (var_1_9));
   ...
   var_1_18
    ...
    var_1_13
                   ...
                   if ( (( (- ( (((((var_1_19)) > ((var_1_3))) ? ((var_1_19)) : ((var_1_3))))))) == (var_1_3))) {
                    var_1_22 = (
   var_1_26
  );
 }
  ...
  var_1_28
                   ...
                   if ( ((var_1_7) > (var_1_4))) {
                    var_1_29 = (
                     ((((( -2 )) > (( var_1_17 ))) ? (( -2 )) : (( var_1_17 ))))
  );
 }
                   if ( ((0) <= ( ((var_1_19) - ( (((((var_1_19)) < ((var_1_26))) ? ((var_1_19)) : ((var_1_26))))))))) {
                    var_1_31 = (
                     ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))
  );
 }
                   if ( ((var_1_4) <= ( ((var_1_19) / ( ((var_1_33) - (var_1_34))))))) {
                    if ( ((-64) >= ( ((((((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) < 0 ) ? -(((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) : (((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1))))))))) {
                     if ( ((-8) > (var_1_19))) {
                      if ( ((var_1_9) >= (var_1_28))) {
                       var_1_32 = (
     ...
     var_1_35
                   ...
                   if ( ((var_1_33) < (var_1_11))) {
                    var_1_38 = (
                     ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))
  );
 } else {
                    if ( ((var_1_34) <= (var_1_19))) {
                     var_1_38 = (
                      ((((( var_1_37 )) < (( ((((( var_1_6 )) > (( var_1_11 ))) ? (( var_1_6 )) : (( var_1_11 )))) ))) ? (( var_1_37 )) : (( ((((( var_1_6 )) > (( var_1_11 ))) ? (( var_1_6 )) : (( var_1_11 )))) ))))
   );
  }
 }
