...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch20Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch20Amount25
	if (var_1_2) {
		var_1_7 = ((min ((var_1_3 - 255.719) , var_1_5)) - 2.3);
	}


	// From: Req3Batch20Amount25
	if (var_1_2) {
