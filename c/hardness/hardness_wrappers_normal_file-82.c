...
void step(void) {
	...
	if ((var_1_7 + var_1_11) >= stepLocal_1) {
		if ((max (var_1_4 , (var_1_1 * var_1_3))) <= var_1_18) {
...
int property(void) {
	return ((((((! var_1_2) ? (var_1_2 ? (var_1_1 == ((float) (max (var_1_3 , var_1_4)))) : 1) : 1) && (((var_1_6 / -2) >= (var_1_7 | var_1_8)) ? (var_1_5 == ((unsigned char) (abs (var_1_9)))) : (var_1_5 == ((unsigned char) (var_1_10 - (abs (var_1_11))))))) && (((var_1_7 + var_1_11) >= var_1_9) ? (((max (var_1_4 , (var_1_1 * var_1_3))) <= var_1_18) ? (var_1_12 == ((unsigned char) (max (var_1_11 , var_1_14)))) : (var_1_2 ? (var_1_12 == ((unsigned char) (var_1_11 + var_1_15))) : 1)) : (var_1_12 == ((unsigned char) var_1_9)))) && (var_1_16 == ((double) var_1_4))) && (var_1_17 == ((unsigned char) var_1_9))) && (var_1_18 == ((double) var_1_3))
;
}
int main(void) {
	isInitial = 1;
