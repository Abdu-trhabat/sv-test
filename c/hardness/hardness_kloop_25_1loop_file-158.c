...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15825_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch15825_1loop
	if (var_1_8) {
		var_1_6 = (var_1_5 + -128);
	}


	// From: Req5Batch15825_1loop
	var_1_14 = var_1_5;


	// From: Req6Batch15825_1loop
	var_1_15 = 32.5f;
}
