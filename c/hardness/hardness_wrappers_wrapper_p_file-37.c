...
void step(void) {
	...
	if (stepLocal_1 >= 4) {
		if ((*(var_1_2_Pointer)) <= stepLocal_0) {
			(*(var_1_7_Pointer)) = (min (((*(var_1_8_Pointer)) - ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer)))) , (*(var_1_11_Pointer))));
		}
	}


	// From: Req3Batch37Wrapper_P
	(*(var_1_12_Pointer)) = ((*(var_1_10_Pointer)) + (max ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))));
	...
	if (63.8 > (*(var_1_7_Pointer))) {
		if (stepLocal_2 <= (*(var_1_2_Pointer))) {
			...
			(*(var_1_15_Pointer)) = (min (((min ((*(var_1_16_Pointer)) , (*(var_1_17_Pointer)))) - (*(var_1_4_Pointer))) , (*(var_1_5_Pointer))));
		}
	}
...
int property(void) {
	return ((((((((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) ^ ((*(var_1_4_Pointer)) * (*(var_1_5_Pointer)))) <= -64) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_6_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned char) 16))) && (((*(var_1_6_Pointer)) >= 4) ? (((*(var_1_2_Pointer)) <= (*(var_1_3_Pointer))) ? ((*(var_1_7_Pointer)) == ((double) (min (((*(var_1_8_Pointer)) - ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer)))) , (*(var_1_11_Pointer)))))) : 1) : 1)) && ((*(var_1_12_Pointer)) == ((double) ((*(var_1_10_Pointer)) + (max ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))))))) && ((63.8 > (*(var_1_7_Pointer))) ? (((- (*(var_1_6_Pointer))) <= (*(var_1_2_Pointer))) ? ((*(var_1_15_Pointer)) == ((unsigned long int) ((*(var_1_16_Pointer)) - (*(var_1_6_Pointer))))) : ((*(var_1_15_Pointer)) == ((unsigned long int) (min (((min ((*(var_1_16_Pointer)) , (*(var_1_17_Pointer)))) - (*(var_1_4_Pointer))) , (*(var_1_5_Pointer))))))) : 1)) && ((*(var_1_18_Pointer)) == ((unsigned char) (*(var_1_6_Pointer))))
;
}
int main(void) {
	isInitial = 1;
