...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch107Amount25.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_2 + var_1_4) >= 1.2) {
  var_1_7 = (((var_1_8 + 64.2f) - var_1_9) + var_1_10);
 }
 unsigned char stepLocal_1 = var_1_14;
 signed long int stepLocal_0 = var_1_6 * (var_1_12 - var_1_13);
 if (stepLocal_0 == var_1_5) {
  if (stepLocal_1 && (var_1_13 > 8)) {
   var_1_11 = var_1_13;
  }
 }
 var_1_15 = var_1_13;
...
int property(void) {
 return ((((var_1_2 > (var_1_3 - var_1_4)) ? (var_1_1 == ((signed char) var_1_5)) : ((var_1_4 > var_1_2) ? (var_1_1 == ((signed char) ((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6))))) : (var_1_1 == ((signed char) var_1_6)))) && (((var_1_2 + var_1_4) >= 1.2) ? (var_1_7 == ((float) (((var_1_8 + 64.2f) - var_1_9) + var_1_10))) : 1)) && (((var_1_6 * (var_1_12 - var_1_13)) == var_1_5) ? ((var_1_14 && (var_1_13 > 8)) ? (var_1_11 == ((unsigned short int) var_1_13)) : 1) : 1)) && (var_1_15 == ((unsigned long int) var_1_13))
;
}
int main(void) {
 isInitial = 1;
