...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch71Amount50.c", 13, "reach_error"); }
...
void step(void) {
 var_1_10 = var_1_11;
 if (var_1_9 == var_1_5) {
  var_1_20 = ((((var_1_4) > ((last_1_var_1_20 + -8))) ? (var_1_4) : ((last_1_var_1_20 + -8))));
 }
 ...
 if ((var_1_15 - var_1_16) > var_1_13) {
  ...
  var_1_14 = (3919152995u - (((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) - var_1_20));
 }
...
int property(void) {
 return (((((((var_1_21 ? (((var_1_4 - var_1_5) > ((var_1_6 + var_1_7) * var_1_8)) ? (var_1_1 == ((unsigned short int) (var_1_9 - var_1_5))) : 1) : (var_1_21 ? (var_1_1 == ((unsigned short int) 32)) : (var_1_1 == ((unsigned short int) var_1_5)))) && (var_1_10 == ((float) var_1_11))) && ((var_1_10 >= ((var_1_11 / var_1_13) / 31.9f)) ? ((var_1_14 > var_1_4) ? (var_1_12 == ((float) var_1_11)) : (var_1_12 == ((float) 3.125f))) : 1)) && (((var_1_15 - var_1_16) > var_1_13) ? ((((((var_1_20) < (var_1_9)) ? (var_1_20) : (var_1_9))) <= ((((var_1_19) > (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))) ? (var_1_19) : (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))))) ? (var_1_14 == ((unsigned long int) (var_1_20 + var_1_9))) : (var_1_14 == ((unsigned long int) (var_1_5 + var_1_9)))) : (var_1_14 == ((unsigned long int) (3919152995u - (((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) - var_1_20)))))) && ((! var_1_21) ? (var_1_19 == ((signed long int) (var_1_5 + 256))) : 1)) && ((var_1_9 == var_1_5) ? (var_1_20 == ((signed long int) ((((var_1_4) > ((last_1_var_1_20 + -8))) ? (var_1_4) : ((last_1_var_1_20 + -8)))))) : 1)) && (var_1_21 == ((unsigned char) (! (var_1_22 || (var_1_23 || var_1_24)))))) && (var_1_25 == ((unsigned short int) 16))
;
}
int main(void) {
 isInitial = 1;
