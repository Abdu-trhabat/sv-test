...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch124Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
   ...
   16u
    ...
    50
                   ...
                   if (var_1_20) {
                    if ( ((var_1_26) <= ( (((((var_1_25)) > ((var_1_6))) ? ((var_1_25)) : ((var_1_6))))))) {
    ...
    var_1_31
                   ...
                   if (var_1_20) {
                    if (var_1_21) {
                     var_1_34 = (
                      ((((( var_1_26 )) > (( var_1_5 ))) ? (( var_1_26 )) : (( var_1_5 ))))
   );
  } else {
                     if ( (( (( ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))) - ( (((((var_1_27)) > ((var_1_5))) ? ((var_1_27)) : ((var_1_5))))))) > ( ((5u) % (var_1_37))))) {
                      var_1_34 = (
     var_1_36
    );
   }
