...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch165Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	/* 276L, 80L) */ if (/* 277L, 69L, 70L) */ (! (var_1_16))) {
		/* 279L, 79L) */ var_1_33 = (
			/* 282L, 78L) */ ((
				var_1_35
			) + (
	...
	// From: CodeObject6
	/* 321L, 230L) */ if (/* 322L, 167L, 168L) */ ((/* 323L, 161L, 169L) */ ((/* 324L, 158L, 170L) */ ((var_1_35) / (var_1_39))) * (/* 327L, 160L, 173L) */ (~ (var_1_29))))) <= (/* 329L, 166L, 175L) */ ((/* 330L, 164L, 176L) */ ((128) / (var_1_46))) | (var_1_7))))) {
	...
	/* 286L, 150L) */ if (var_1_16) {
		...
		/* 298L, 148L) */ if (/* 299L, 110L, 111L) */ ((/* 300L, 104L, 112L) */ (abs (var_1_3))) > (/* 302L, 109L, 114L) */ ((/* 303L, 107L, 115L) */ ((var_1_42) - (var_1_43))) - (256.95f))))) {
