...
void step(void) {
	...
	if (stepLocal_7 >= (last_1_var_1_84 + (var_1_7 - var_1_5))) {
		...
		if (var_1_28) {
			...
			if ((var_1_16 * var_1_18) > last_1_var_1_63) {
				var_1_35 = (min (var_1_15 , (var_1_17 + var_1_18)));
			} else {
				var_1_35 = (min (((max (var_1_31 , var_1_15)) - 63.5) , ((var_1_36 - var_1_20) - (6.502066781597943E18 - var_1_19))));
			}
		}
	}


	// From: Req21Batch164Amount500
	if (((- var_1_59) * (var_1_35 + 100.75f)) != var_1_58) {
		var_1_63 = ((min (var_1_65 , var_1_18)) + ((min (var_1_61 , 32.17f)) + var_1_66));
	} else {
		var_1_63 = ((var_1_20 - var_1_19) + var_1_21);
	}


	// From: Req14Batch164Amount500
	signed long int stepLocal_12 = last_1_var_1_24 % var_1_33;
	unsigned long int stepLocal_11 = last_1_var_1_69;
	signed long int stepLocal_10 = min (last_1_var_1_8 , last_1_var_1_84);
	signed long int stepLocal_9 = last_1_var_1_24;
	if (var_1_27) {
		if (var_1_9 != var_1_17) {
			var_1_46 = (var_1_45 - (9.9999999999995E12 + var_1_43));
		} else {
			var_1_46 = (min (var_1_20 , (var_1_15 - (min (var_1_36 , var_1_19)))));
		}
	} else {
		if (stepLocal_10 > (max (last_1_var_1_12 , last_1_var_1_69))) {
			if (last_1_var_1_79) {
	...
	// From: Req38Batch164Amount500
	if (var_1_39) {
		var_1_95 = var_1_78;
	}


	// From: Req2Batch164Amount500
	signed long int stepLocal_0 = (var_1_7 & -32) | (min (var_1_6 , var_1_4));
	if (last_1_var_1_8 > stepLocal_0) {
		var_1_8 = (var_1_7 + var_1_6);
	} else {
		if ((var_1_9 - (abs (last_1_var_1_30))) >= (0.75f - var_1_11)) {
			var_1_8 = ((10 - var_1_4) + last_1_var_1_37);
		}
	}


	// From: Req24Batch164Amount500
	signed long int stepLocal_18 = last_1_var_1_12;
	if ((var_1_66 + var_1_65) != (min (last_1_var_1_91 , (var_1_20 - var_1_36)))) {
		if (last_1_var_1_22 < (max ((- last_1_var_1_49) , last_1_var_1_42))) {
			var_1_71 = (abs (200u));
		}
	} else {
		if (last_1_var_1_71 < stepLocal_18) {
			var_1_71 = (max ((var_1_34 - (max (var_1_5 , var_1_51))) , (abs (var_1_6))));
		} else {
			var_1_71 = ((min ((var_1_70 + 1789358012u) , (1787145521u + var_1_72))) - var_1_6);
		}
	}


	// From: Req3Batch164Amount500
	var_1_12 = var_1_7;


	// From: Req33Batch164Amount500
	if (var_1_28) {
		var_1_90 = var_1_45;
	} else {
		var_1_90 = 32.5f;
	...
	// From: Req35Batch164Amount500
	var_1_92 = -1;


	// From: Req37Batch164Amount500
	var_1_94 = var_1_41;


	// From: Req39Batch164Amount500
	if (var_1_27) {
		var_1_96 = var_1_97;
	} else {
		var_1_96 = var_1_29;
	...
	// From: Req29Batch164Amount500
	unsigned long int stepLocal_23 = var_1_70;
	if (var_1_71 <= stepLocal_23) {
		var_1_84 = (max ((var_1_55 + (var_1_51 - 5)) , var_1_95));
	}


	// From: Req23Batch164Amount500
	signed long int stepLocal_17 = 1;
	unsigned long int stepLocal_16 = (max (var_1_71 , var_1_8)) + var_1_68;
	if (stepLocal_16 <= var_1_38) {
		if ((max (var_1_4 , var_1_51)) > stepLocal_17) {
			var_1_69 = ((min ((var_1_70 - var_1_5) , (min (var_1_54 , 128u)))) + var_1_68);
		} else {
			var_1_69 = (min (var_1_4 , (var_1_71 + var_1_5)));
		}
	} else {
		var_1_69 = var_1_38;
	}
	...
	// From: Req4Batch164Amount500
	if (var_1_94) {
		if (last_1_var_1_13 == (var_1_11 + 16.75f)) {
			var_1_13 = (var_1_15 - var_1_16);
		} else {
			var_1_13 = (min ((max (2.4f , var_1_15)) , (min (1.7f , var_1_16))));
		}
	} else {
		var_1_13 = (max ((var_1_17 + var_1_18) , ((var_1_19 - var_1_20) + var_1_21)));
	}


	// From: Req25Batch164Amount500
	if (var_1_91 > (var_1_52 / 0.2)) {
		var_1_73 = (max (0 , (max (var_1_54 , (abs (var_1_38))))));
	} else {
		var_1_73 = (max (var_1_7 , var_1_74));
	}


	// From: Req31Batch164Amount500
	if (var_1_94) {
		var_1_88 = var_1_15;
	}


	// From: Req32Batch164Amount500
	if (var_1_96) {
		var_1_89 = var_1_66;
	} else {
		var_1_89 = var_1_60;
	...
	if (last_1_var_1_24 < stepLocal_2) {
		if (stepLocal_1 || (! var_1_39)) {
			var_1_24 = (min (25 , ((max (var_1_4 , var_1_5)) + var_1_6)));
		}
	} else {
	...
	// From: Req11Batch164Amount500
	if (var_1_7 == (- var_1_8)) {
		var_1_37 = (max ((var_1_75 + 8) , ((abs (var_1_38)) - last_1_var_1_37)));
	} else {
		var_1_37 = (var_1_6 + var_1_75);
	}


	// From: Req8Batch164Amount500
	...
	// From: Req27Batch164Amount500
	if (var_1_41) {
		if (var_1_74 > var_1_98) {
			var_1_79 = (((1.000000000000025E13f * var_1_50) > (var_1_21 * var_1_9)) || var_1_40);
		} else {
			if (((var_1_66 * var_1_36) * var_1_43) != ((var_1_80 - var_1_81) - (min (var_1_61 , var_1_45)))) {
				var_1_79 = var_1_29;
			}
		}
	}
	...
	// From: Req13Batch164Amount500
	if (var_1_34 > var_1_33) {
		if (var_1_37 >= var_1_95) {
			var_1_42 = ((min ((var_1_19 - var_1_20) , var_1_21)) + (var_1_43 - (min (var_1_44 , var_1_45))));
		}
	}


	// From: Req28Batch164Amount500
	...
	if (((min (var_1_5 , var_1_73)) & var_1_51) > stepLocal_20) {
		if (((var_1_78 + var_1_69) * var_1_77) < stepLocal_21) {
			if (((max (var_1_19 , var_1_59)) / var_1_58) < var_1_43) {
	...
	// From: Req18Batch164Amount500
	if ((var_1_42 * var_1_20) <= (min ((var_1_46 + var_1_35) , 99.25))) {
			...
			if (var_1_82) {
				...
				if (var_1_32 <= ((var_1_51 - var_1_54) - var_1_55)) {
					if (var_1_11 <= (- (var_1_91 + var_1_50))) {
						if ((min (var_1_54 , var_1_4)) >= var_1_84) {
							var_1_67 = (var_1_19 - (min ((var_1_20 + var_1_59) , (var_1_44 + var_1_60))));
						} else {
							var_1_67 = var_1_31;
						}
					} else {
						var_1_67 = ((var_1_59 + (abs (var_1_43))) - var_1_19);
					}
				}
			}
		}
	...
	// From: Req5Batch164Amount500
	if (var_1_39 && var_1_79) {
		var_1_22 = var_1_18;
	}


	// From: Req7Batch164Amount500
	...
	// From: Req36Batch164Amount500
	if (var_1_26) {
		var_1_93 = var_1_21;
	}


	// From: Req19Batch164Amount500
	if (! var_1_26) {
		var_1_57 = (min ((var_1_20 - 0.8f) , ((var_1_36 - var_1_43) - (var_1_45 + var_1_44))));
	} else {
		var_1_57 = ((var_1_31 - (min (var_1_44 , var_1_19))) - ((var_1_58 + var_1_59) - (var_1_60 - var_1_61)));
	}


	// From: Req20Batch164Amount500
	if (var_1_22 >= (var_1_93 * var_1_44)) {
		var_1_62 = (max (var_1_55 , var_1_100));
	} else {
		var_1_62 = (var_1_55 + var_1_6);
	}


	// From: Req16Batch164Amount500
	...
	if (stepLocal_27 || (last_1_var_1_86 <= var_1_17)) {
		if (stepLocal_26 && var_1_94) {
			if (stepLocal_28 >= ((- var_1_34) / var_1_38)) {
				var_1_86 = ((max (var_1_44 , 24.25)) + var_1_66);
			}
		}
	} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((- var_1_69) < var_1_71) ? (var_1_1 == ((unsigned char) (min ((var_1_4 + (var_1_5 - var_1_6)) , var_1_7)))) : (var_1_1 == ((unsigned char) (max ((max ((abs (var_1_5)) , var_1_4)) , var_1_6))))) && ((last_1_var_1_8 > ((var_1_7 & -32) | (min (var_1_6 , var_1_4)))) ? (var_1_8 == ((signed long int) (var_1_7 + var_1_6))) : (((var_1_9 - (abs (last_1_var_1_30))) >= (0.75f - var_1_11)) ? (var_1_8 == ((signed long int) ((10 - var_1_4) + last_1_var_1_37))) : 1))) && (var_1_12 == ((signed long int) var_1_7))) && (var_1_94 ? ((last_1_var_1_13 == (var_1_11 + 16.75f)) ? (var_1_13 == ((float) (var_1_15 - var_1_16))) : (var_1_13 == ((float) (min ((max (2.4f , var_1_15)) , (min (1.7f , var_1_16))))))) : (var_1_13 == ((float) (max ((var_1_17 + var_1_18) , ((var_1_19 - var_1_20) + var_1_21))))))) && ((var_1_39 && var_1_79) ? (var_1_22 == ((double) var_1_18)) : 1)) && ((last_1_var_1_24 < var_1_73) ? (((var_1_46 < var_1_11) || (! var_1_39)) ? (var_1_24 == ((unsigned char) (min (25 , ((max (var_1_4 , var_1_5)) + var_1_6))))) : 1) : (var_1_24 == ((unsigned char) (var_1_4 + var_1_5))))) && ((! ((var_1_71 / var_1_5) != var_1_32)) ? (var_1_26 == ((unsigned char) (! ((! var_1_94) || (var_1_82 || var_1_27))))) : (var_1_26 == ((unsigned char) (var_1_28 || var_1_29))))) && ((var_1_75 == (var_1_84 / (var_1_5 + 5))) ? (var_1_30 == ((float) var_1_16)) : (((var_1_5 > var_1_7) && (-4 == 8)) ? ((var_1_28 || var_1_27) ? (var_1_30 == ((float) 0.4f)) : (var_1_30 == ((float) ((var_1_31 - 256.25f) - 1.2f)))) : 1))) && (((var_1_4 * var_1_5) == ((var_1_84 / var_1_33) + (var_1_8 ^ var_1_1))) ? (var_1_32 == ((unsigned long int) (var_1_8 + var_1_1))) : (var_1_32 == ((unsigned long int) (min ((min ((var_1_34 - var_1_5) , var_1_8)) , 0u)))))) && (((var_1_4 - var_1_6) >= (last_1_var_1_84 + (var_1_7 - var_1_5))) ? (var_1_35 == ((double) ((var_1_20 + var_1_19) - var_1_31))) : (var_1_28 ? (var_1_35 == ((double) var_1_16)) : (((var_1_16 * var_1_18) > last_1_var_1_63) ? (var_1_35 == ((double) (min (var_1_15 , (var_1_17 + var_1_18))))) : (var_1_35 == ((double) (min (((max (var_1_31 , var_1_15)) - 63.5) , ((var_1_36 - var_1_20) - (6.502066781597943E18 - var_1_19)))))))))) && ((var_1_7 == (- var_1_8)) ? (var_1_37 == ((unsigned short int) (max ((var_1_75 + 8) , ((abs (var_1_38)) - last_1_var_1_37))))) : (var_1_37 == ((unsigned short int) (var_1_6 + var_1_75))))) && (((- last_1_var_1_46) <= var_1_31) ? (var_1_39 == ((unsigned char) (var_1_27 || (! var_1_29)))) : (((var_1_27 || last_1_var_1_79) || last_1_var_1_79) ? (var_1_39 == ((unsigned char) ((var_1_27 && var_1_40) && var_1_41))) : (var_1_39 == ((unsigned char) (var_1_29 || var_1_28)))))) && ((var_1_34 > var_1_33) ? ((var_1_37 >= var_1_95) ? (var_1_42 == ((double) ((min ((var_1_19 - var_1_20) , var_1_21)) + (var_1_43 - (min (var_1_44 , var_1_45)))))) : 1) : 1)) && (var_1_27 ? ((var_1_9 != var_1_17) ? (var_1_46 == ((double) (var_1_45 - (9.9999999999995E12 + var_1_43)))) : (var_1_46 == ((double) (min (var_1_20 , (var_1_15 - (min (var_1_36 , var_1_19)))))))) : (((min (last_1_var_1_8 , last_1_var_1_84)) > (max (last_1_var_1_12 , last_1_var_1_69))) ? (last_1_var_1_79 ? ((last_1_var_1_22 >= (var_1_19 * last_1_var_1_22)) ? (((last_1_var_1_69 / var_1_33) > last_1_var_1_24) ? (var_1_46 == ((double) (var_1_43 - var_1_20))) : 1) : (var_1_46 == ((double) (var_1_45 + var_1_17)))) : (var_1_46 == ((double) (abs (var_1_21))))) : ((((-32 * var_1_5) + last_1_var_1_69) > (last_1_var_1_24 % var_1_33)) ? ((((var_1_6 | last_1_var_1_84) * last_1_var_1_24) > last_1_var_1_69) ? (var_1_46 == ((double) ((abs (var_1_18)) + var_1_21))) : (var_1_46 == ((double) (min (var_1_43 , var_1_36))))) : 1)))) && (var_1_28 ? ((var_1_93 >= (var_1_16 / var_1_31)) ? ((! (var_1_86 >= var_1_19)) ? (var_1_47 == ((float) var_1_19)) : (var_1_47 == ((float) var_1_48))) : 1) : (var_1_47 == ((float) var_1_31)))) && (((var_1_62 * var_1_71) >= ((var_1_38 & var_1_6) | var_1_7)) ? (var_1_96 ? (var_1_49 == ((double) (15.8 - var_1_16))) : 1) : 1)) && ((var_1_4 >= ((var_1_51 - var_1_6) - var_1_5)) ? (var_1_96 ? (var_1_50 == ((double) (max (var_1_48 , (min (var_1_20 , 499.5)))))) : (var_1_50 == ((double) (max (var_1_18 , var_1_52))))) : (((var_1_6 * var_1_71) != (~ (var_1_4 / var_1_33))) ? (var_1_50 == ((double) (var_1_43 - var_1_36))) : 1))) && (((var_1_42 * var_1_20) <= (min ((var_1_46 + var_1_35) , 99.25))) ? (var_1_53 == ((signed char) (var_1_6 + (var_1_54 - (var_1_55 - var_1_56))))) : (var_1_53 == ((signed char) (abs (var_1_56)))))) && ((! var_1_26) ? (var_1_57 == ((float) (min ((var_1_20 - 0.8f) , ((var_1_36 - var_1_43) - (var_1_45 + var_1_44)))))) : (var_1_57 == ((float) ((var_1_31 - (min (var_1_44 , var_1_19))) - ((var_1_58 + var_1_59) - (var_1_60 - var_1_61))))))) && ((var_1_22 >= (var_1_93 * var_1_44)) ? (var_1_62 == ((signed short int) (max (var_1_55 , var_1_100)))) : (var_1_62 == ((signed short int) (var_1_55 + var_1_6))))) && ((((- var_1_59) * (var_1_35 + 100.75f)) != var_1_58) ? (var_1_63 == ((float) ((min (var_1_65 , var_1_18)) + ((min (var_1_61 , 32.17f)) + var_1_66)))) : (var_1_63 == ((float) ((var_1_20 - var_1_19) + var_1_21))))) && ((((var_1_68 - var_1_4) - (var_1_32 + var_1_7)) >= 5) ? ((var_1_82 || (var_1_43 > 1.5)) ? (var_1_67 == ((float) (var_1_45 - (var_1_31 - var_1_61)))) : (var_1_67 == ((float) (var_1_36 - var_1_44)))) : ((var_1_34 != (var_1_55 * var_1_37)) ? (var_1_82 ? (var_1_67 == ((float) (var_1_19 - var_1_20))) : ((var_1_32 <= ((var_1_51 - var_1_54) - var_1_55)) ? ((var_1_11 <= (- (var_1_91 + var_1_50))) ? (((min (var_1_54 , var_1_4)) >= var_1_84) ? (var_1_67 == ((float) (var_1_19 - (min ((var_1_20 + var_1_59) , (var_1_44 + var_1_60)))))) : (var_1_67 == ((float) var_1_31))) : (var_1_67 == ((float) ((var_1_59 + (abs (var_1_43))) - var_1_19)))) : 1)) : 1))) && ((((max (var_1_71 , var_1_8)) + var_1_68) <= var_1_38) ? (((max (var_1_4 , var_1_51)) > 1) ? (var_1_69 == ((unsigned long int) ((min ((var_1_70 - var_1_5) , (min (var_1_54 , 128u)))) + var_1_68))) : (var_1_69 == ((unsigned long int) (min (var_1_4 , (var_1_71 + var_1_5)))))) : (var_1_69 == ((unsigned long int) var_1_38)))) && (((var_1_66 + var_1_65) != (min (last_1_var_1_91 , (var_1_20 - var_1_36)))) ? ((last_1_var_1_22 < (max ((- last_1_var_1_49) , last_1_var_1_42))) ? (var_1_71 == ((unsigned long int) (abs (200u)))) : 1) : ((last_1_var_1_71 < last_1_var_1_12) ? (var_1_71 == ((unsigned long int) (max ((var_1_34 - (max (var_1_5 , var_1_51))) , (abs (var_1_6)))))) : (var_1_71 == ((unsigned long int) ((min ((var_1_70 + 1789358012u) , (1787145521u + var_1_72))) - var_1_6)))))) && ((var_1_91 > (var_1_52 / 0.2)) ? (var_1_73 == ((unsigned short int) (max (0 , (max (var_1_54 , (abs (var_1_38)))))))) : (var_1_73 == ((unsigned short int) (max (var_1_7 , var_1_74)))))) && ((var_1_5 != ((- var_1_95) & var_1_100)) ? (((- var_1_35) <= (- var_1_90)) ? (var_1_75 == ((unsigned short int) ((var_1_76 + var_1_77) - var_1_1))) : 1) : (var_1_75 == ((unsigned short int) (((var_1_78 - var_1_54) + var_1_6) + var_1_7))))) && (var_1_41 ? ((var_1_74 > var_1_98) ? (var_1_79 == ((unsigned char) (((1.000000000000025E13f * var_1_50) > (var_1_21 * var_1_9)) || var_1_40))) : ((((var_1_66 * var_1_36) * var_1_43) != ((var_1_80 - var_1_81) - (min (var_1_61 , var_1_45)))) ? (var_1_79 == ((unsigned char) var_1_29)) : 1)) : 1)) && ((((min (var_1_5 , var_1_73)) & var_1_51) > (var_1_77 + (32 << var_1_76))) ? ((((var_1_78 + var_1_69) * var_1_77) < (var_1_34 - (var_1_38 + var_1_73))) ? ((((max (var_1_19 , var_1_59)) / var_1_58) < var_1_43) ? ((var_1_41 && var_1_27) ? (((var_1_32 * var_1_51) != var_1_12) ? (var_1_82 == ((unsigned char) (((var_1_95 % var_1_34) < var_1_7) && var_1_29))) : (var_1_82 == ((unsigned char) (var_1_94 && (var_1_79 && (var_1_29 || var_1_28)))))) : (var_1_82 == ((unsigned char) (! ((var_1_40 && var_1_41) && var_1_27))))) : 1) : (var_1_82 == ((unsigned char) (last_1_var_1_82 || (! var_1_28))))) : (var_1_82 == ((unsigned char) var_1_29)))) && ((var_1_71 <= var_1_70) ? (var_1_84 == ((signed long int) (max ((var_1_55 + (var_1_51 - 5)) , var_1_95)))) : 1)) && ((var_1_40 || (last_1_var_1_86 <= var_1_17)) ? (((var_1_66 < var_1_49) && var_1_94) ? (((var_1_12 / var_1_70) >= ((- var_1_34) / var_1_38)) ? (var_1_86 == ((double) ((max (var_1_44 , 24.25)) + var_1_66))) : 1) : 1) : (((var_1_12 + var_1_55) >= var_1_38) ? ((var_1_32 < (var_1_76 + var_1_68)) ? ((var_1_56 > var_1_74) ? (var_1_86 == ((double) (var_1_61 + var_1_21))) : 1) : (var_1_86 == ((double) var_1_15))) : (var_1_86 == ((double) var_1_66))))) && (var_1_94 ? (var_1_88 == ((float) var_1_15)) : 1)) && (var_1_96 ? (var_1_89 == ((float) var_1_66)) : (var_1_89 == ((float) var_1_60)))) && (var_1_28 ? (var_1_90 == ((float) var_1_45)) : (var_1_90 == ((float) 32.5f)))) && (var_1_41 ? (var_1_91 == ((double) var_1_81)) : (var_1_91 == ((double) var_1_18)))) && (var_1_92 == ((signed char) -1))) && (var_1_26 ? (var_1_93 == ((double) var_1_21)) : 1)) && (var_1_94 == ((unsigned char) var_1_41))) && (var_1_39 ? (var_1_95 == ((unsigned short int) var_1_78)) : 1)) && (var_1_27 ? (var_1_96 == ((unsigned char) var_1_97)) : (var_1_96 == ((unsigned char) var_1_29)))) && (var_1_28 ? (var_1_98 == ((unsigned char) 5)) : (var_1_98 == ((unsigned char) 10)))) && (var_1_27 ? (var_1_99 == ((signed char) var_1_54)) : (var_1_99 == ((signed char) var_1_51)))) && (((var_1_60 - (var_1_80 - var_1_81)) >= (- 7.5)) ? (((var_1_74 >> var_1_101) != var_1_69) ? (var_1_100 == ((signed char) (min (-64 , (8 - var_1_56))))) : (var_1_100 == ((signed char) var_1_54))) : (var_1_100 == ((signed char) var_1_56)))
;
}
int main(void) {
	isInitial = 1;
