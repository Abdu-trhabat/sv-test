...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer))) {
		if ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) <= stepLocal_2) {
			if ((min (10.4 , (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)))) < ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) * (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)))) {
