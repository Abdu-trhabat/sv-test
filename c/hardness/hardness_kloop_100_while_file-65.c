...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch65100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned long int stepLocal_1 = (max (last_1_var_1_20 , var_1_6)) / var_1_10;
	...
	var_1_20 = (min (last_1_var_1_21 , 64u));
	...
	if ((var_1_23 - (var_1_25 - var_1_7)) <= stepLocal_3) {
		if (var_1_18) {
			var_1_24 = (min ((var_1_1 - (var_1_8 + var_1_26)) , var_1_23));
		}
	}
	...
	unsigned long int stepLocal_5 = min (var_1_24 , var_1_20);
...
int property(void) {
	return (((((((((((((last_1_var_1_33 ? (last_1_var_1_17 ? (var_1_1 == ((signed long int) (16 - 2))) : (var_1_1 == ((signed long int) var_1_4))) : 1) && (var_1_27 ? (var_1_5 == ((unsigned char) (min (var_1_6 , (var_1_7 - var_1_8))))) : 1)) && ((var_1_4 <= ((var_1_7 + var_1_8) / var_1_10)) ? ((7.5 >= var_1_11) ? (var_1_9 == ((signed short int) var_1_7)) : (var_1_9 == ((signed short int) var_1_8))) : 1)) && (var_1_27 ? (var_1_12 == ((float) (max (var_1_13 , var_1_14)))) : (var_1_12 == ((float) (max ((min (var_1_13 , var_1_14)) , var_1_15)))))) && ((var_1_12 > (- (var_1_13 + var_1_11))) ? (var_1_16 == ((signed long int) var_1_7)) : ((var_1_21 <= var_1_7) ? (var_1_16 == ((signed long int) var_1_21)) : (var_1_16 == ((signed long int) var_1_6))))) && ((last_1_var_1_31 == ((max (last_1_var_1_20 , var_1_6)) / var_1_10)) ? (var_1_17 == ((unsigned char) (! (var_1_18 && (! var_1_19))))) : (last_1_var_1_33 ? (var_1_17 == ((unsigned char) var_1_19)) : 1))) && (var_1_20 == ((unsigned long int) (min (last_1_var_1_21 , 64u))))) && ((var_1_13 == var_1_11) ? ((last_1_var_1_31 <= ((var_1_23 - var_1_6) - last_1_var_1_24)) ? (var_1_21 == ((unsigned short int) var_1_8)) : 1) : 1)) && (((var_1_23 - (var_1_25 - var_1_7)) <= (~ var_1_20)) ? (var_1_18 ? (var_1_24 == ((signed short int) (min ((var_1_1 - (var_1_8 + var_1_26)) , var_1_23)))) : 1) : 1)) && ((! var_1_17) ? ((var_1_21 >= var_1_20) ? (var_1_27 == ((unsigned char) (var_1_19 || ((var_1_4 <= var_1_10) && var_1_28)))) : 1) : 1)) && (((min (var_1_24 , var_1_20)) >= var_1_26) ? (var_1_29 == ((unsigned char) var_1_30)) : 1)) && (((var_1_1 * (var_1_1 + var_1_23)) >= (var_1_7 * (-1 - var_1_21))) ? ((var_1_19 || var_1_27) ? (var_1_31 == ((signed long int) (var_1_8 + var_1_24))) : (var_1_31 == ((signed long int) (var_1_26 + var_1_25)))) : 1)) && ((var_1_8 <= var_1_6) ? (var_1_19 ? (var_1_33 == ((unsigned char) ((! var_1_32) || (! var_1_18)))) : 1) : (var_1_33 == ((unsigned char) (var_1_28 || (! (var_1_32 && var_1_18))))))) && ((var_1_4 <= var_1_23) ? ((var_1_31 > var_1_7) ? (var_1_34 == ((unsigned char) var_1_30)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
