...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch174Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req8Batch174Amount100
	if (((abs (var_1_19)) / var_1_30) < var_1_10) {
		var_1_29 = (min (last_1_var_1_20 , 256u));
	} else {
		if (((min (var_1_13 , var_1_14)) / (max (var_1_30 , var_1_19))) == 7.5f) {
			var_1_29 = last_1_var_1_31;
		}
	}


	// From: Req7Batch174Amount100
	...
	// From: Req5Batch174Amount100
	if ((var_1_16 / var_1_19) > (- var_1_17)) {
		var_1_18 = ((min ((max (var_1_16 , var_1_12)) , var_1_10)) - (min (var_1_13 , var_1_17)));
	} else {
	...
	if (stepLocal_0 != -8) {
		if (stepLocal_1 > var_1_29) {
			...
			var_1_1 = (var_1_25 - (max (10 , var_1_29)));
		}
	} else {
		if ((abs (-16)) > stepLocal_2) {
			var_1_1 = (var_1_29 - var_1_25);
		}
	}


	// From: Req6Batch174Amount100
	unsigned long int stepLocal_3 = min ((max (var_1_25 , var_1_29)) , var_1_1);
	if (stepLocal_3 < ((min (var_1_31 , var_1_1)) * (~ var_1_29))) {
		var_1_20 = (var_1_23 + var_1_24);
	}


	// From: Req2Batch174Amount100
	if (var_1_20 < 64) {
	...
	// From: Req3Batch174Amount100
	if (var_1_4 != var_1_29) {
		if (var_1_6) {
			if (9999999.8f <= last_1_var_1_5) {
				var_1_5 = (min ((var_1_10 - 4.4f) , (max (var_1_11 , (var_1_12 - var_1_13)))));
			} else {
				var_1_5 = 63.2f;
			}
		} else {
	...
	// From: Req10Batch174Amount100
	unsigned long int stepLocal_7 = max ((var_1_1 * 128u) , var_1_29);
...
int property(void) {
	return (((((((((((var_1_29 + var_1_25) != -8) ? ((var_1_25 > var_1_29) ? (var_1_1 == ((signed long int) var_1_25)) : (var_1_1 == ((signed long int) (var_1_25 - (max (10 , var_1_29)))))) : (((abs (-16)) > var_1_29) ? (var_1_1 == ((signed long int) (var_1_29 - var_1_25))) : 1)) && ((var_1_20 < 64) ? ((var_1_20 <= (var_1_29 | last_1_var_1_4)) ? (var_1_4 == ((signed short int) last_1_var_1_4)) : 1) : 1)) && ((var_1_4 != var_1_29) ? (var_1_6 ? ((9999999.8f <= last_1_var_1_5) ? (var_1_5 == ((float) (min ((var_1_10 - 4.4f) , (max (var_1_11 , (var_1_12 - var_1_13))))))) : (var_1_5 == ((float) 63.2f))) : (var_1_5 == ((float) (0.725f + var_1_14)))) : (var_1_5 == ((float) var_1_11)))) && ((var_1_12 < var_1_10) ? (var_1_15 == ((double) (var_1_14 + (var_1_16 - var_1_17)))) : ((! var_1_6) ? (var_1_15 == ((double) var_1_14)) : (var_1_15 == ((double) var_1_10))))) && (((var_1_16 / var_1_19) > (- var_1_17)) ? (var_1_18 == ((float) ((min ((max (var_1_16 , var_1_12)) , var_1_10)) - (min (var_1_13 , var_1_17))))) : ((var_1_16 >= var_1_14) ? (var_1_18 == ((float) var_1_11)) : (var_1_18 == ((float) var_1_14))))) && (((min ((max (var_1_25 , var_1_29)) , var_1_1)) < ((min (var_1_31 , var_1_1)) * (~ var_1_29))) ? (var_1_20 == ((unsigned char) (var_1_23 + var_1_24))) : 1)) && ((((var_1_26 + var_1_27) - var_1_28) > (last_1_var_1_31 * last_1_var_1_1)) ? ((var_1_7 && (last_1_var_1_18 > var_1_11)) ? (var_1_25 == ((unsigned short int) var_1_28)) : 1) : (var_1_25 == ((unsigned short int) last_1_var_1_31)))) && ((((abs (var_1_19)) / var_1_30) < var_1_10) ? (var_1_29 == ((unsigned long int) (min (last_1_var_1_20 , 256u)))) : ((((min (var_1_13 , var_1_14)) / (max (var_1_30 , var_1_19))) == 7.5f) ? (var_1_29 == ((unsigned long int) last_1_var_1_31)) : 1))) && ((var_1_25 <= (var_1_24 + (var_1_32 - var_1_23))) ? (var_1_31 == ((unsigned char) var_1_23)) : 1)) && (((var_1_29 / var_1_32) >= (max ((var_1_1 * 128u) , var_1_29))) ? (var_1_7 ? (var_1_33 == ((double) var_1_14)) : (var_1_33 == ((double) 255.5))) : (var_1_33 == ((double) var_1_14)))
;
}
int main(void) {
	isInitial = 1;
