...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch105Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((((*(WrapperStruct00_var_1_3_Pointer)) >> 2) * (*(WrapperStruct00_var_1_1_Pointer))) <= ((*(WrapperStruct00_var_1_2_Pointer)) / 1000000)) {
  (*(WrapperStruct00_var_1_4_Pointer)) = (5 - ((*(WrapperStruct00_var_1_3_Pointer)) + (*(WrapperStruct00_var_1_5_Pointer))));
 } else {
  (*(WrapperStruct00_var_1_4_Pointer)) = (*(WrapperStruct00_var_1_3_Pointer));
 }
 unsigned char stepLocal_0 = (*(WrapperStruct00_var_1_4_Pointer)) > (*(WrapperStruct00_var_1_2_Pointer));
 if ((7.7f - (*(WrapperStruct00_var_1_7_Pointer))) > (*(WrapperStruct00_var_1_8_Pointer))) {
  if (stepLocal_0 && (*(WrapperStruct00_var_1_9_Pointer))) {
   if (! (((*(WrapperStruct00_var_1_10_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer))) < -4)) {
    (*(WrapperStruct00_var_1_6_Pointer)) = (((*(WrapperStruct00_var_1_11_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer))) + (*(WrapperStruct00_var_1_10_Pointer)));
   } else {
 ...
 if ((*(WrapperStruct00_var_1_7_Pointer)) <= (*(WrapperStruct00_var_1_13_Pointer))) {
  (*(WrapperStruct00_var_1_12_Pointer)) = ((*(WrapperStruct00_var_1_14_Pointer)) + (*(WrapperStruct00_var_1_3_Pointer)));
 }
}
void updateVariables(void) {
 WrapperStruct00.var_1_2 = __VERIFIER_nondet_char();
 assume_abort_if_not(WrapperStruct00.var_1_2 >= -1);
 assume_abort_if_not(WrapperStruct00.var_1_2 <= 126);
 WrapperStruct00.var_1_3 = __VERIFIER_nondet_char();
 assume_abort_if_not(WrapperStruct00.var_1_3 >= 0);
 assume_abort_if_not(WrapperStruct00.var_1_3 <= 126);
...
int property(void) {
 return ((((*(WrapperStruct00_var_1_1_Pointer)) == ((signed char) ((*(WrapperStruct00_var_1_2_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer))))) && (((((*(WrapperStruct00_var_1_3_Pointer)) >> 2) * (*(WrapperStruct00_var_1_1_Pointer))) <= ((*(WrapperStruct00_var_1_2_Pointer)) / 1000000)) ? ((*(WrapperStruct00_var_1_4_Pointer)) == ((signed long int) (5 - ((*(WrapperStruct00_var_1_3_Pointer)) + (*(WrapperStruct00_var_1_5_Pointer)))))) : ((*(WrapperStruct00_var_1_4_Pointer)) == ((signed long int) (*(WrapperStruct00_var_1_3_Pointer)))))) && (((7.7f - (*(WrapperStruct00_var_1_7_Pointer))) > (*(WrapperStruct00_var_1_8_Pointer))) ? ((((*(WrapperStruct00_var_1_4_Pointer)) > (*(WrapperStruct00_var_1_2_Pointer))) && (*(WrapperStruct00_var_1_9_Pointer))) ? ((! (((*(WrapperStruct00_var_1_10_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer))) < -4)) ? ((*(WrapperStruct00_var_1_6_Pointer)) == ((unsigned short int) (((*(WrapperStruct00_var_1_11_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer))) + (*(WrapperStruct00_var_1_10_Pointer))))) : ((*(WrapperStruct00_var_1_6_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_11_Pointer))))) : ((*(WrapperStruct00_var_1_6_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_10_Pointer))))) : 1)) && (((*(WrapperStruct00_var_1_7_Pointer)) <= (*(WrapperStruct00_var_1_13_Pointer))) ? ((*(WrapperStruct00_var_1_12_Pointer)) == ((unsigned char) ((*(WrapperStruct00_var_1_14_Pointer)) + (*(WrapperStruct00_var_1_3_Pointer))))) : 1)
;
}
int main(void) {
 isInitial = 1;
