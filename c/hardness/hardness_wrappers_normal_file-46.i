...
void step(void) {
 var_1_11 = (((((var_1_12) < (((((var_1_13) > (var_1_14)) ? (var_1_13) : (var_1_14))))) ? (var_1_12) : (((((var_1_13) > (var_1_14)) ? (var_1_13) : (var_1_14)))))) - 32);
 var_1_15 = var_1_10;
 signed long int stepLocal_1 = -32;
 signed long int stepLocal_0 = var_1_11 / var_1_4;
 if ((- var_1_2) >= 16.75) {
  if (stepLocal_0 >= var_1_5) {
   if (((((var_1_4) < (var_1_11)) ? (var_1_4) : (var_1_11))) > stepLocal_1) {
    var_1_1 = 0;
   } else {
...
int property(void) {
 return (((((- var_1_2) >= 16.75) ? (((var_1_11 / var_1_4) >= var_1_5) ? ((((((var_1_4) < (var_1_11)) ? (var_1_4) : (var_1_11))) > -32) ? (var_1_1 == ((unsigned char) 0)) : (var_1_1 == ((unsigned char) (var_1_6 || var_1_7)))) : (var_1_6 ? (var_1_1 == ((unsigned char) 1)) : (var_1_1 == ((unsigned char) var_1_7)))) : (var_1_1 == ((unsigned char) 1))) && ((1 == (var_1_5 + var_1_11)) ? ((((var_1_5 * var_1_4) + var_1_11) >= var_1_11) ? (var_1_8 == ((unsigned char) var_1_10)) : (var_1_8 == ((unsigned char) var_1_6))) : 1)) && (var_1_11 == ((unsigned short int) (((((var_1_12) < (((((var_1_13) > (var_1_14)) ? (var_1_13) : (var_1_14))))) ? (var_1_12) : (((((var_1_13) > (var_1_14)) ? (var_1_13) : (var_1_14)))))) - 32)))) && (var_1_15 == ((unsigned char) var_1_10))
;
}
int main(void) {
 isInitial = 1;
