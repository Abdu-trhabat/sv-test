...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch106stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch106stepLocals
	if (var_1_2) {
		if (var_1_3) {
			var_1_1 = (min (var_1_4 , ((var_1_5 + 256) - (min (var_1_6 , var_1_7)))));
		} else {
	...
	// From: Req3Batch106stepLocals
	signed long int stepLocal_0 = var_1_7 + var_1_6;
	...
	// From: Req4Batch106stepLocals
	var_1_14 = (((min (4 , var_1_13)) + var_1_5) + var_1_7);


	// From: Req5Batch106stepLocals
	var_1_15 = var_1_6;


	// From: Req6Batch106stepLocals
	...
	// From: Req7Batch106stepLocals
	signed long int stepLocal_2 = var_1_6 + var_1_15;
	if (stepLocal_2 <= var_1_12) {
		var_1_20 = var_1_10;
	} else {
		var_1_20 = (max (var_1_11 , (min (var_1_10 , (var_1_21 + var_1_22)))));
	}


	// From: Req8Batch106stepLocals
	var_1_23 = var_1_24;


	// From: Req9Batch106stepLocals
	var_1_25 = var_1_16;


	// From: Req10Batch106stepLocals
	var_1_26 = var_1_25;
}
