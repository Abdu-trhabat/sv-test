...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch33Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	/* 345L, 125L) */ if (/* 346L, 108L, 109L) */ ((/* 347L, 106L, 110L) */ (- (/* 348L, 105L, 111L) */ (max (/* 348L, 105L, 111L) */ (var_1_19) , (var_1_3)))))) == (var_1_3))) {
		/* 352L, 124L) */ var_1_22 = (
			var_1_26
		);
	}
	...
	// From: CodeObject3
	/* 361L, 152L) */ if (/* 362L, 139L, 140L) */ ((var_1_7) > (var_1_4))) {
		/* 365L, 151L) */ var_1_29 = (
			/* 368L, 150L) */ (max (
				/* 368L, 150L) */ (
					-2
	...
	// From: CodeObject4
	/* 371L, 182L) */ if (/* 372L, 162L, 163L) */ ((0) <= (/* 374L, 161L, 165L) */ ((var_1_19) - (/* 376L, 160L, 167L) */ (min (/* 376L, 160L, 167L) */ (var_1_19) , (var_1_26)))))))) {
		/* 379L, 181L) */ var_1_31 = (
			/* 382L, 180L) */ (abs (
				var_1_26
			))
	...
	// From: CodeObject5
	/* 384L, 266L) */ if (/* 385L, 192L, 193L) */ ((var_1_4) <= (/* 387L, 191L, 195L) */ ((var_1_19) / (/* 389L, 190L, 197L) */ ((var_1_33) - (var_1_34))))))) {
		/* 392L, 264L) */ if (/* 393L, 211L, 212L) */ ((-64) >= (/* 395L, 210L, 214L) */ (abs (/* 396L, 209L, 215L) */ (abs (var_1_1))))))) {
			/* 398L, 256L) */ if (/* 399L, 224L, 225L) */ ((-8) > (var_1_19))) {
				/* 402L, 248L) */ if (/* 403L, 233L, 234L) */ ((var_1_9) >= (var_1_28))) {
					/* 406L, 247L) */ var_1_32 = (
						/* 409L, 246L) */ (min (
							/* 409L, 246L) */ (
								/* 410L, 244L) */ ((
	...
	// From: CodeObject6
	/* 426L, 306L) */ if (/* 427L, 272L, 273L) */ ((var_1_33) < (var_1_11))) {
		/* 430L, 283L) */ var_1_38 = (
			/* 433L, 282L) */ (abs (
				var_1_16
			))
