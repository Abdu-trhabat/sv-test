	...
	if (stepLocal_2 > var_1_6) {
		if ((var_1_10 > -2) || stepLocal_1) {
			if (var_1_1 == stepLocal_0) {
				var_1_13 = (var_1_14 - (min ((abs (var_1_12)) , 1)));
			} else {
				var_1_13 = var_1_12;
			}
		} else {
...
int property(void) {
	return (((((var_1_2 > var_1_3) ? (var_1_1 == ((signed long int) ((min (var_1_4 , var_1_5)) - 10))) : (var_1_1 == ((signed long int) (max ((var_1_5 - var_1_6) , (var_1_4 - var_1_7)))))) && (var_1_8 == ((unsigned char) (var_1_9 + 100)))) && (var_1_10 == ((signed long int) (max (var_1_11 , var_1_12))))) && ((var_1_7 > var_1_6) ? (((var_1_10 > -2) || (var_1_7 > var_1_9)) ? ((var_1_1 == (~ -1)) ? (var_1_13 == ((signed long int) (var_1_14 - (min ((abs (var_1_12)) , 1))))) : (var_1_13 == ((signed long int) var_1_12))) : (var_1_13 == ((signed long int) var_1_12))) : (var_1_13 == ((signed long int) var_1_12)))) && (var_1_15 == ((signed char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
