...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch190functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
void functionized0(unsigned char, signed short int, signed char, signed short int);
unsigned char functionized1(unsigned char);
double functionized2(double, double);
void functionized3(signed char, signed char, signed char);
signed long int functionized4(signed char, signed char);
...
void functionized0(unsigned char functionized0_localFunctionVar0, signed short int functionized0_localFunctionVar1, signed char functionized0_localFunctionVar2, signed short int functionized0_localFunctionVar3) {
	if (functionized0_localFunctionVar1 <= functionized0_localFunctionVar3) {
		if (functionized0_localFunctionVar3 <= functionized0_localFunctionVar1) {
			var_1_1 = functionized0_localFunctionVar2;
		} else {
			if (functionized0_localFunctionVar0 || ((- var_1_6) < 32.6f)) {
				var_1_1 = 64;
			} else {
				var_1_1 = functionized0_localFunctionVar2;
			}
...
double functionized2(double functionized2_localFunctionVar0, double functionized2_localFunctionVar1) {
	return (max (functionized2_localFunctionVar0 , functionized2_localFunctionVar1));
}
void functionized3(signed char functionized3_localFunctionVar0, signed char functionized3_localFunctionVar1, signed char functionized3_localFunctionVar2) {
	if (var_1_4 >= (var_1_17 - functionized3_localFunctionVar2)) {
		var_1_16 = (functionized3_localFunctionVar1 + (functionized3_localFunctionVar0 - var_1_21));
	}
}
signed long int functionized4(signed char functionized4_localFunctionVar0, signed char functionized4_localFunctionVar1) {
	return (min (var_1_19 , (min (functionized4_localFunctionVar0 , (functionized4_localFunctionVar1 - var_1_18)))));
}
...
void step(void) {
	// From: Req1Batch190functionizing
	functionized0(var_1_5, var_1_2, var_1_4, var_1_3);


	// From: Req2Batch190functionizing
	...
	// From: Req3Batch190functionizing
	if (var_1_3 <= var_1_2) {
		if ((var_1_6 + var_1_12) <= (functionized2(var_1_13, var_1_14))) {
			var_1_11 = var_1_15;
		}
	}


	// From: Req4Batch190functionizing
	functionized3(var_1_20, var_1_19, var_1_18);


	// From: Req5Batch190functionizing
	var_1_22 = (functionized4(var_1_20, var_1_21));


	// From: Req6Batch190functionizing
	var_1_23 = (var_1_8 || (var_1_5 || var_1_24));


	// From: Req7Batch190functionizing
