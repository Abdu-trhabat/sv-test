...
void functionized3(float functionized3_localFunctionVar0, signed long int functionized3_localFunctionVar1, unsigned short int functionized3_localFunctionVar2, float functionized3_localFunctionVar3) {
 if (var_1_5 || var_1_7) {
  ...
  if ((((((var_1_14) > (functionized3_localFunctionVar3)) ? (var_1_14) : (functionized3_localFunctionVar3))) * var_1_16) <= var_1_17) {
   if (functionized3_localFunctionVar1 == functionized3_localFunctionVar2) {
    var_1_13 = (var_1_18 - ((((functionized3_localFunctionVar0) < (2.225f)) ? (functionized3_localFunctionVar0) : (2.225f))));
   }
  } else {
...
void functionized5(float functionized5_localFunctionVar0, unsigned short int functionized5_localFunctionVar1, unsigned short int functionized5_localFunctionVar2) {
 if (var_1_15 < (- functionized5_localFunctionVar0)) {
  var_1_21 = ((((functionized5_localFunctionVar2) < (functionized5_localFunctionVar1)) ? (functionized5_localFunctionVar2) : (functionized5_localFunctionVar1)));
 } else {
  if (var_1_5) {
   if (var_1_1) {
...
int property(void) {
 return ((((((var_1_2 <= var_1_3) ? ((var_1_2 > (var_1_3 * var_1_6)) ? (var_1_1 == ((unsigned char) (! ((var_1_3 <= var_1_2) || var_1_7)))) : (var_1_1 == ((unsigned char) var_1_7))) : 1) && ((var_1_2 != var_1_6) ? (var_1_8 == ((unsigned short int) (var_1_10 - (var_1_11 + var_1_12)))) : 1)) && ((var_1_5 || var_1_7) ? (var_1_13 == ((float) (var_1_14 + var_1_15))) : (((((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15))) * var_1_16) <= var_1_17) ? ((var_1_9 == var_1_12) ? (var_1_13 == ((float) (var_1_18 - ((((var_1_19) < (2.225f)) ? (var_1_19) : (2.225f)))))) : 1) : (var_1_13 == ((float) var_1_15))))) && ((var_1_3 > var_1_11) ? (var_1_20 == ((float) ((((((((63.5f) < 0 ) ? -(63.5f) : (63.5f)))) < (var_1_15)) ? (((((63.5f) < 0 ) ? -(63.5f) : (63.5f)))) : (var_1_15))))) : 1)) && ((var_1_15 < (- var_1_17)) ? (var_1_21 == ((signed short int) ((((var_1_12) < (var_1_11)) ? (var_1_12) : (var_1_11))))) : (var_1_5 ? (var_1_1 ? (var_1_21 == ((signed short int) var_1_12)) : 1) : (var_1_21 == ((signed short int) var_1_11))))) && (var_1_1 ? ((10 == (var_1_11 + var_1_3)) ? (var_1_22 == ((signed short int) (var_1_12 - var_1_11))) : (var_1_22 == ((signed short int) var_1_11))) : (var_1_22 == ((signed short int) var_1_12)))
;
}
int main(void) {
 isInitial = 1;
