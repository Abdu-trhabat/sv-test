...
void step(void) {
	...
	// From: Req2Batch107Wrapper_A
	unsigned long int stepLocal_0 = ~ (- unsigned_long_int_Array_0[0]);
	if (! (signed_char_Array_0[5] >= signed_char_Array_0[6])) {
		if ((min (unsigned_long_int_Array_0[2] , unsigned_long_int_Array_0[1])) >= stepLocal_0) {
			signed_short_int_Array_0[1][1] = (signed_char_Array_0[6] + (signed_short_int_Array_0[1][0] + -2));
		} else {
			signed_short_int_Array_0[1][1] = ((min ((abs (-8)) , signed_short_int_Array_0[0][1])) - signed_short_int_Array_0[0][0]);
		}
	}


	// From: Req3Batch107Wrapper_A
	signed_char_Array_0[0] = signed_char_Array_0[5];


	// From: Req4Batch107Wrapper_A
