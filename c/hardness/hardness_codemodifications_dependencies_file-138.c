...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch138dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch138dependencies
	if ((last_1_var_1_11 >> var_1_8) != last_1_var_1_11) {
		var_1_6 = (! var_1_10);
	}


	// From: Req3Batch138dependencies
