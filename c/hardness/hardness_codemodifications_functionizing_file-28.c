...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch28functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
signed long int functionized0(unsigned short int, unsigned char);
...
void functionized4(float, double, float, unsigned char);
...
signed long int functionized0(unsigned short int functionized0_localFunctionVar0, unsigned char functionized0_localFunctionVar1) {
...
unsigned char functionized1(unsigned short int functionized1_localFunctionVar0) {
	return (functionized1_localFunctionVar0 < 5);
}
signed long int functionized2(unsigned char functionized2_localFunctionVar0) {
	return (min ((min (var_1_7 , var_1_8)) , functionized2_localFunctionVar0));
}
void functionized3(unsigned char functionized3_localFunctionVar0, unsigned short int functionized3_localFunctionVar1) {
	if (var_1_12) {
		if (functionized3_localFunctionVar0) {
			if ((functionized3_localFunctionVar1 > (~ var_1_10)) && var_1_14) {
...
void functionized4(float functionized4_localFunctionVar0, double functionized4_localFunctionVar1, float functionized4_localFunctionVar2, unsigned char functionized4_localFunctionVar3) {
	if (var_1_14) {
		if (var_1_12) {
			var_1_20 = (functionized4_localFunctionVar2 + (max (functionized4_localFunctionVar0 , var_1_23)));
		}
	} else {
		if (functionized4_localFunctionVar3 <= 0) {
			var_1_20 = functionized4_localFunctionVar1;
		} else {
...
void step(void) {
	// From: Req1Batch28functionizing
	if (var_1_2 <= var_1_3) {
		var_1_1 = (max ((min (var_1_2 , (functionized0(var_1_4, var_1_3)))) , var_1_5));
	}


	// From: Req2Batch28functionizing
	if (functionized1(var_1_1)) {
		var_1_6 = (max (functionized2(var_1_9) , var_1_10));
	} else {
		var_1_6 = var_1_10;
	}


	// From: Req3Batch28functionizing
	functionized3(var_1_13, var_1_4);


	// From: Req4Batch28functionizing
	...
	// From: Req5Batch28functionizing
	if (((200 << var_1_1) * (var_1_17 * var_1_7)) < var_1_11) {
		var_1_18 = var_1_19;
	}


	// From: Req6Batch28functionizing
	if (var_1_13) {
		functionized4(var_1_22, var_1_19, var_1_21, var_1_24);
	} else {
		var_1_20 = var_1_23;
	}
}
