...
void step(void) {
	...
	// From: Req2Batch188dependencies
	if (var_1_13 >= var_1_8) {
		var_1_10 = (min (var_1_6 , var_1_11));
	}


	// From: Req6Batch188dependencies
	if ((-64 >= var_1_13) || (var_1_13 < var_1_7)) {
		if ((max (var_1_13 , -2)) > (max (var_1_7 , (var_1_12 * var_1_13)))) {
	...
	// From: Req5Batch188dependencies
	if (var_1_4) {
		var_1_15 = var_1_16;
	}


	// From: Req1Batch188dependencies
	if (var_1_2 < var_1_3) {
