...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch134100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch134100_while
	if ((- var_1_16) == var_1_3) {
		var_1_25 = (max (var_1_10 , ((var_1_14 + var_1_16) - var_1_20)));
	}


	// From: Req5Batch134100_while
	...
	// From: Req6Batch134100_while
	var_1_27 = (abs (1));


	// From: Req7Batch134100_while
	if ((var_1_3 * (var_1_20 * var_1_16)) < (var_1_15 % var_1_29)) {
		var_1_28 = var_1_19;
	}


	// From: Req8Batch134100_while
