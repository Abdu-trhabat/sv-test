...
int property(void) {
	return (((var_1_2 ? ((var_1_3 <= var_1_4) ? ((var_1_5 && ((var_1_4 / var_1_6) < var_1_3)) ? (var_1_1 == ((unsigned long int) var_1_4)) : 1) : (var_1_1 == ((unsigned long int) var_1_3))) : 1) && (var_1_7 == ((signed short int) 50))) && ((var_1_6 != var_1_1) ? (var_1_8 == ((double) ((min (2.9 , var_1_9)) + var_1_10))) : 1)) && ((var_1_1 != (- var_1_1)) ? (var_1_11 == ((float) (min (var_1_9 , (var_1_12 - var_1_13))))) : ((var_1_1 <= (~ 1u)) ? (var_1_11 == ((float) var_1_12)) : (var_1_11 == ((float) var_1_9))))
;
}
int main(void) {
	isInitial = 1;
