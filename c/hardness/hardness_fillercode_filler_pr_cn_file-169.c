...
void step(void) {
	...
	// From: CodeObject1
	/* 73L) */ if (/* 55L, 54L) */ ((/* 56L, 52L) */ ((/* 57L, 50L) */ (min (/* 57L, 50L) */ (var_1_31) , (var_1_32)))) - (var_1_33))) <= (var_1_34))) {
		/* 72L) */ var_1_30 = (
			var_1_31
		);
	}
	...
	// From: CodeObject7
	/* 293L) */ if (/* 257L, 256L) */ ((/* 258L, 254L) */ ((/* 259L, 252L) */ ((var_1_46) - (var_1_48))) / (-2))) < (var_1_40))) {
		/* 287L) */ if (var_1_42) {
			/* 281L) */ if (var_1_36) {
				/* 280L) */ var_1_47 = (
					var_1_43
	...
	// From: CodeObject6
	/* 246L) */ if (/* 216L, 215L) */ ((var_1_44) < (var_1_34))) {
		/* 244L) */ if (/* 227L, 226L) */ ((var_1_30) <= (/* 229L, 225L) */ ((var_1_38) / (-32))))) {
			/* 243L) */ var_1_43 = (
				/* 242L) */ (abs (
					/* 241L) */ ((
						var_1_45
	...
	// From: CodeObject2
	/* 136L) */ if (/* 88L, 87L) */ ((var_1_30) >= (/* 90L, 86L) */ (min (/* 90L, 86L) */ (var_1_31) , (var_1_33)))))) {
		/* 134L) */ if (/* 107L, 106L) */ ((/* 108L, 104L) */ ((/* 109L, 102L) */ ((var_1_33) ^ (var_1_30))) * (var_1_34))) >= (var_1_31))) {
			/* 125L) */ var_1_35 = (
				/* 124L) */ (abs (
					var_1_37
				))
	...
	// From: CodeObject3
	/* 156L) */ if (/* 143L, 142L) */ ((var_1_35) >= (var_1_37))) {
		/* 155L) */ var_1_38 = (
			/* 154L) */ (max (
				/* 154L) */ (
					var_1_31
	...
	// From: CodeObject5
	/* 209L) */ if (/* 173L, 172L) */ ((/* 174L, 170L) */ (~ (/* 175L, 169L) */ (~ (var_1_31))))) <= (128))) {
		/* 187L) */ var_1_40 = (
			/* 186L) */ (abs (
				var_1_41
			))
		...
		/* 207L) */ if (/* 191L, 190L) */ ((var_1_36) && (var_1_42))) {
			/* 202L) */ var_1_40 = (
				/* 201L) */ (abs (
					/* 200L) */ (abs (
						var_1_41
...
int property(void) {
	if (/* 297L, 13L, 23L, 303L, 325L, 809L, 967L, 32L) */ ((last_1_var_1_13) < (/* 300L, 12L, 25L, 305L, 327L, 808L, 970L, 31L) */ ((/* 301L, 8L, 26L, 306L, 328L, 804L, 971L, 27L) */ ((var_1_3) - (var_1_4))) / (/* 304L, 11L, 29L, 309L, 331L, 807L, 974L, 30L) */ (max (/* 304L, 11L, 29L, 309L, 331L, 807L, 974L, 30L) */ (var_1_5) , (var_1_6)))))))) {
	}
	if (/* 320L, 52L, 56L, 369L, 380L, 990L) */ ((var_1_6) > (var_1_5))) {
	}
	if (/* 346L, 97L, 104L, 477L, 490L, 1016L) */ ((var_1_4) == (/* 348L, 96L, 106L, 479L, 492L, 1018L) */ (~ (/* 349L, 95L, 107L, 480L, 493L, 1019L) */ ((var_1_5) + (var_1_1))))))) {
	}
	if (/* 359L, 126L, 132L, 551L, 575L, 1029L) */ ((var_1_14) > (/* 361L, 125L, 134L, 553L, 577L, 1031L) */ (max (/* 361L, 125L, 134L, 553L, 577L, 1031L) */ (var_1_1) , (-8)))))) {
	} else {
	}
	if (/* 382L, 167L, 175L, 624L, 637L, 1052L) */ ((/* 383L, 165L, 176L, 625L, 638L, 1053L) */ ((/* 384L, 163L, 177L, 626L, 639L, 1054L) */ ((var_1_21) - (var_1_4))) << (var_1_16))) < (var_1_8))) {
	}
	if (/* 407L, 212L, 218L, 738L, 758L, 1077L) */ ((/* 408L, 210L, 219L, 739L, 759L, 1078L) */ ((8) << (var_1_17))) < (var_1_8))) {
		if (/* 413L, 230L, 239L, 744L, 764L, 1083L) */ ((/* 414L, 225L, 240L, 745L, 765L, 1084L) */ ((5u) >> (16))) > (/* 417L, 229L, 243L, 748L, 768L, 1087L) */ ((var_1_28) - (/* 419L, 228L, 245L, 750L, 770L, 1089L) */ (abs (100u))))))) {
		}
	}
	return /* 432L) */ ((
	/* 431L) */ ((
		/* 430L) */ ((
			/* 429L) */ ((
				/* 428L) */ ((
					/* 427L) */ ((
						/* 426L) */ ((
							/* 296L, 43L, 302L, 324L, 820L, 966L, 43L) */ ((
								/* 297L, 13L, 23L, 303L, 325L, 809L, 967L, 32L) */ ((
									last_1_var_1_13
								) < (
									/* 300L, 12L, 25L, 305L, 327L, 808L, 970L, 31L) */ ((
										/* 301L, 8L, 26L, 306L, 328L, 804L, 971L, 27L) */ ((
											var_1_3
										) - (
											var_1_4
										))
									) / (
										/* 304L, 11L, 29L, 309L, 331L, 807L, 974L, 30L) */ (max (
											/* 304L, 11L, 29L, 309L, 331L, 807L, 974L, 30L) */ (
												var_1_5
											) , (
												var_1_6
											)
								...
								/* 307L, 41L, 312L, 334L, 819L, 977L, 42L) */ ((
									var_1_1
								) == (
									/* 307L, 41L, 312L, 334L, 819L, 977L, 42L) */ ((signed long int) (
										/* 310L, 40L, 315L, 337L, 818L, 980L, 41L) */ ((
											var_1_3
										) - (
											/* 312L, 39L, 317L, 339L, 817L, 982L, 40L) */ (max (
												/* 312L, 39L, 317L, 339L, 817L, 982L, 40L) */ (
													/* 313L, 37L, 318L, 340L, 815L, 983L, 38L) */ (max (
														/* 313L, 37L, 318L, 340L, 815L, 983L, 38L) */ (
															64
														) , (
															var_1_4
														)
							...
							/* 319L, 65L, 368L, 379L, 989L) */ ((
								/* 320L, 52L, 56L, 369L, 380L, 990L) */ ((
									var_1_6
								) > (
									var_1_5
								))
							) ? (
								/* 323L, 63L, 372L, 383L, 993L) */ ((
									var_1_8
								) == (
									/* 323L, 63L, 372L, 383L, 993L) */ ((signed long int) (
										/* 326L, 62L, 375L, 386L, 996L) */ (abs (
											var_1_3
										))
									))
								))
						...
						/* 331L, 83L, 421L, 436L, 1001L) */ ((
							var_1_9
						) == (
							/* 331L, 83L, 421L, 436L, 1001L) */ ((double) (
								/* 334L, 82L, 424L, 439L, 1004L) */ ((
									/* 335L, 78L, 425L, 440L, 1005L) */ (min (
										/* 335L, 78L, 425L, 440L, 1005L) */ (
											var_1_10
										) , (
											/* 337L, 77L, 427L, 442L, 1007L) */ ((
												1.000000000000005E14
											) + (
												256.1
											))
					...
					/* 345L, 115L, 476L, 489L, 1015L) */ ((
						/* 346L, 97L, 104L, 477L, 490L, 1016L) */ ((
							var_1_4
						) == (
							/* 348L, 96L, 106L, 479L, 492L, 1018L) */ (~ (
								/* 349L, 95L, 107L, 480L, 493L, 1019L) */ ((
									var_1_5
								) + (
									var_1_1
								))
						...
						/* 352L, 113L, 483L, 496L, 1022L) */ ((
							var_1_13
						) == (
							/* 352L, 113L, 483L, 496L, 1022L) */ ((signed short int) (
								var_1_14
							))
						))
					) : (
				...
				/* 358L, 154L, 550L, 574L, 1028L) */ ((
					/* 359L, 126L, 132L, 551L, 575L, 1029L) */ ((
						var_1_14
					) > (
						/* 361L, 125L, 134L, 553L, 577L, 1031L) */ (max (
							/* 361L, 125L, 134L, 553L, 577L, 1031L) */ (
								var_1_1
							) , (
								-8
							)
					...
					/* 364L, 146L, 556L, 580L, 1034L) */ ((
						var_1_15
					) == (
						/* 364L, 146L, 556L, 580L, 1034L) */ ((signed char) (
							/* 367L, 145L, 559L, 583L, 1037L) */ (min (
								/* 367L, 145L, 559L, 583L, 1037L) */ (
									/* 368L, 143L, 560L, 584L, 1038L) */ ((
										var_1_16
									) + (
										/* 370L, 142L, 562L, 586L, 1040L) */ (max (
											/* 370L, 142L, 562L, 586L, 1040L) */ (
												var_1_17
											) , (
												var_1_18
											)
					...
					/* 374L, 152L, 566L, 590L, 1044L) */ ((
						var_1_15
					) == (
						/* 374L, 152L, 566L, 590L, 1044L) */ ((signed char) (
							/* 377L, 151L, 569L, 593L, 1047L) */ (min (
								/* 377L, 151L, 569L, 593L, 1047L) */ (
									var_1_16
								) , (
									var_1_19
								)
			...
			/* 381L, 187L, 623L, 636L, 1051L) */ ((
				/* 382L, 167L, 175L, 624L, 637L, 1052L) */ ((
					/* 383L, 165L, 176L, 625L, 638L, 1053L) */ ((
						/* 384L, 163L, 177L, 626L, 639L, 1054L) */ ((
							var_1_21
						) - (
							var_1_4
						))
				...
				/* 389L, 185L, 631L, 644L, 1059L) */ ((
					var_1_20
				) == (
					/* 389L, 185L, 631L, 644L, 1059L) */ ((signed char) (
						var_1_16
					))
				))
			) : (
		...
		/* 395L, 201L, 674L, 686L, 1065L) */ ((
			var_1_22
		) == (
			/* 395L, 201L, 674L, 686L, 1065L) */ ((unsigned short int) (
				/* 398L, 200L, 677L, 689L, 1068L) */ ((
					/* 399L, 196L, 678L, 690L, 1069L) */ (min (
						/* 399L, 196L, 678L, 690L, 1069L) */ (
							var_1_4
						) , (
							var_1_23
						)
	...
	/* 406L, 254L, 737L, 757L, 1076L) */ ((
		/* 407L, 212L, 218L, 738L, 758L, 1077L) */ ((
			/* 408L, 210L, 219L, 739L, 759L, 1078L) */ ((
				8
			) << (
				var_1_17
			))
		...
		/* 412L, 252L, 743L, 763L, 1082L) */ ((
			/* 413L, 230L, 239L, 744L, 764L, 1083L) */ ((
				/* 414L, 225L, 240L, 745L, 765L, 1084L) */ ((
					5u
				) >> (
					16
				))
			) > (
				/* 417L, 229L, 243L, 748L, 768L, 1087L) */ ((
					var_1_28
				) - (
					/* 419L, 228L, 245L, 750L, 770L, 1089L) */ (abs (
						100u
					))
				))
			))
		) ? (
			/* 421L, 250L, 752L, 772L, 1091L) */ ((
				var_1_26
			) == (
				/* 421L, 250L, 752L, 772L, 1091L) */ ((unsigned char) (
					var_1_29
				))
			))
		) : (
