...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15450_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch15450_1loop
	if (var_1_4 == var_1_5) {
		var_1_10 = (max ((var_1_11 + var_1_12) , var_1_13));
	}


	// From: Req3Batch15450_1loop
	if (var_1_11 > var_1_4) {
		if (var_1_8 > var_1_4) {
			var_1_14 = var_1_8;
		}
