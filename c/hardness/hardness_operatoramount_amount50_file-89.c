...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch89Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch89Amount50
	var_1_22 = (var_1_23 && var_1_24);


	// From: Req1Batch89Amount50
	...
	// From: Req2Batch89Amount50
	signed long int stepLocal_1 = var_1_5 / var_1_9;
	signed long int stepLocal_0 = var_1_1;
	if (var_1_6 >= stepLocal_1) {
		if (stepLocal_0 < (var_1_1 * 256)) {
	...
	// From: Req7Batch89Amount50
	if (var_1_1 < ((var_1_8 ^ var_1_25) | var_1_7)) {
		if (var_1_23) {
			var_1_26 = var_1_10;
		}
	}
	...
	// From: Req3Batch89Amount50
	if (var_1_10 < var_1_25) {
		if (var_1_25 <= (5 - var_1_1)) {
			var_1_12 = var_1_13;
		} else {
			if (var_1_25 == var_1_6) {
				var_1_12 = var_1_13;
...
int property(void) {
	return (((((((last_1_var_1_1 != var_1_3) ? (var_1_22 ? (var_1_1 == ((signed long int) (min ((max (-5 , var_1_5)) , (min (var_1_6 , var_1_7)))))) : 1) : 1) && ((var_1_6 >= (var_1_5 / var_1_9)) ? ((var_1_1 < (var_1_1 * 256)) ? (var_1_8 == ((unsigned short int) (min (var_1_10 , (min (128 , var_1_11)))))) : (var_1_8 == ((unsigned short int) var_1_11))) : (var_1_8 == ((unsigned short int) var_1_10)))) && ((var_1_10 < var_1_25) ? ((var_1_25 <= (5 - var_1_1)) ? (var_1_12 == ((unsigned char) var_1_13)) : ((var_1_25 == var_1_6) ? (var_1_12 == ((unsigned char) var_1_13)) : (var_1_12 == ((unsigned char) 4)))) : 1)) && ((((min (var_1_15 , 1.75f)) / (abs (var_1_16))) != var_1_17) ? (var_1_14 == ((float) (min ((max (var_1_18 , var_1_19)) , var_1_20)))) : (var_1_14 == ((float) var_1_21)))) && (var_1_22 == ((unsigned char) (var_1_23 && var_1_24)))) && (var_1_24 ? (var_1_25 == ((unsigned long int) (2957161658u - (var_1_8 + var_1_10)))) : (var_1_25 == ((unsigned long int) (max (var_1_10 , var_1_11)))))) && ((var_1_1 < ((var_1_8 ^ var_1_25) | var_1_7)) ? (var_1_23 ? (var_1_26 == ((unsigned short int) var_1_10)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
