...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch187has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch187has_floats
	unsigned char stepLocal_1 = (var_1_4 / var_1_6) < var_1_3;
	...
	// From: Req3Batch187has_floats
	signed long int stepLocal_5 = var_1_6;
	unsigned long int stepLocal_4 = var_1_1;
	if (last_1_var_1_10 > stepLocal_5) {
		if ((var_1_8 - var_1_11) > stepLocal_4) {
			var_1_10 = ((min (var_1_11 , (last_1_var_1_10 + var_1_1))) + var_1_12);
		}
	} else {
		var_1_10 = var_1_1;
	}
	...
	// From: Req2Batch187has_floats
	unsigned long int stepLocal_3 = var_1_1;
	signed long int stepLocal_2 = 2;
	if (stepLocal_2 == (min ((var_1_10 | var_1_1) , var_1_1))) {
...
int property(void) {
	return ((var_1_2 ? ((var_1_3 <= var_1_4) ? ((var_1_5 && ((var_1_4 / var_1_6) < var_1_3)) ? (var_1_1 == ((unsigned long int) var_1_4)) : 1) : (var_1_1 == ((unsigned long int) var_1_3))) : 1) && ((2 == (min ((var_1_10 | var_1_1) , var_1_1))) ? ((var_1_10 < var_1_1) ? (var_1_7 == ((signed short int) (var_1_8 - 8))) : (var_1_7 == ((signed short int) var_1_8))) : (var_1_2 ? (var_1_7 == ((signed short int) var_1_8)) : (var_1_7 == ((signed short int) var_1_9))))) && ((last_1_var_1_10 > var_1_6) ? (((var_1_8 - var_1_11) > var_1_1) ? (var_1_10 == ((unsigned long int) ((min (var_1_11 , (last_1_var_1_10 + var_1_1))) + var_1_12))) : 1) : (var_1_10 == ((unsigned long int) var_1_1)))
;
}
int main(void) {
	isInitial = 1;
