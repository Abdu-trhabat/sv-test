...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12450_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch12450_1loop
	var_1_15 = (max (var_1_22 , (min (var_1_12 , (var_1_13 - 1)))));


	// From: Req1Batch12450_1loop
	...
	// From: Req3Batch12450_1loop
	if ((~ var_1_7) != (var_1_15 ^ var_1_3)) {
		var_1_14 = var_1_9;
	}


	// From: Req5Batch12450_1loop
	var_1_16 = var_1_17;
}
