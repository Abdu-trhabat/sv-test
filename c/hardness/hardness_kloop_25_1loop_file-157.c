...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15725_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch15725_1loop
	signed long int stepLocal_1 = max ((var_1_2 - var_1_3) , last_1_var_1_10);
	signed long int stepLocal_0 = var_1_3;
	if (128 <= stepLocal_1) {
		if (stepLocal_0 <= (var_1_2 / var_1_5)) {
			if (var_1_6) {
				var_1_1 = (max (var_1_7 , (min (var_1_8 , var_1_9))));
			} else {
				var_1_1 = var_1_8;
			}
		} else {
	...
	// From: Req3Batch15725_1loop
	if (var_1_6) {
		if (var_1_1 <= ((var_1_9 * var_1_3) / (max (var_1_5 , var_1_14)))) {
			var_1_13 = var_1_12;
		} else {
			var_1_13 = 16u;
		}
...
int property(void) {
	return (((128 <= (max ((var_1_2 - var_1_3) , last_1_var_1_10))) ? ((var_1_3 <= (var_1_2 / var_1_5)) ? (var_1_6 ? (var_1_1 == ((signed long int) (max (var_1_7 , (min (var_1_8 , var_1_9)))))) : (var_1_1 == ((signed long int) var_1_8))) : (var_1_1 == ((signed long int) var_1_8))) : (var_1_1 == ((signed long int) var_1_7))) && ((var_1_7 > var_1_13) ? (var_1_10 == ((signed long int) (var_1_11 - var_1_12))) : 1)) && (var_1_6 ? ((var_1_1 <= ((var_1_9 * var_1_3) / (max (var_1_5 , var_1_14)))) ? (var_1_13 == ((unsigned long int) var_1_12)) : (var_1_13 == ((unsigned long int) 16u))) : (var_1_13 == ((unsigned long int) var_1_12)))
;
}
int main(void) {
	isInitial = 1;
