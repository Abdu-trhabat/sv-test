...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch195Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch195Wrapper_S
	if ((WrapperStruct00.var_1_13 - WrapperStruct00.var_1_14) > last_1_WrapperStruct00_var_1_6) {
		WrapperStruct00.var_1_12 = (min ((WrapperStruct00.var_1_3 - last_1_WrapperStruct00_var_1_12) , (min (WrapperStruct00.var_1_15 , WrapperStruct00.var_1_16))));
	} else {
		WrapperStruct00.var_1_12 = (last_1_WrapperStruct00_var_1_12 - (max (WrapperStruct00.var_1_17 , WrapperStruct00.var_1_3)));
	}


	// From: Req4Batch195Wrapper_S
	if (WrapperStruct00.var_1_12 <= (WrapperStruct00.var_1_17 * (- WrapperStruct00.var_1_12))) {
		WrapperStruct00.var_1_18 = (max (WrapperStruct00.var_1_12 , WrapperStruct00.var_1_19));
	} else {
		WrapperStruct00.var_1_18 = WrapperStruct00.var_1_12;
	}


	// From: Req2Batch195Wrapper_S
	signed long int stepLocal_0 = WrapperStruct00.var_1_12;
	if (stepLocal_0 <= WrapperStruct00.var_1_18) {
		WrapperStruct00.var_1_6 = (max ((min ((WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8) , WrapperStruct00.var_1_9)) , (min (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_11))));
	} else {
		WrapperStruct00.var_1_6 = 16.2;
	}


	// From: Req1Batch195Wrapper_S
	if (WrapperStruct00.var_1_12 < WrapperStruct00.var_1_18) {
...
int property(void) {
	return ((((WrapperStruct00.var_1_12 < WrapperStruct00.var_1_18) ? (WrapperStruct00.var_1_1 == ((unsigned char) WrapperStruct00.var_1_4)) : (WrapperStruct00.var_1_1 == ((unsigned char) (WrapperStruct00.var_1_4 && WrapperStruct00.var_1_5)))) && ((WrapperStruct00.var_1_12 <= WrapperStruct00.var_1_18) ? (WrapperStruct00.var_1_6 == ((double) (max ((min ((WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8) , WrapperStruct00.var_1_9)) , (min (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_11)))))) : (WrapperStruct00.var_1_6 == ((double) 16.2)))) && (((WrapperStruct00.var_1_13 - WrapperStruct00.var_1_14) > last_1_WrapperStruct00_var_1_6) ? (WrapperStruct00.var_1_12 == ((signed long int) (min ((WrapperStruct00.var_1_3 - last_1_WrapperStruct00_var_1_12) , (min (WrapperStruct00.var_1_15 , WrapperStruct00.var_1_16)))))) : (WrapperStruct00.var_1_12 == ((signed long int) (last_1_WrapperStruct00_var_1_12 - (max (WrapperStruct00.var_1_17 , WrapperStruct00.var_1_3))))))) && ((WrapperStruct00.var_1_12 <= (WrapperStruct00.var_1_17 * (- WrapperStruct00.var_1_12))) ? (WrapperStruct00.var_1_18 == ((unsigned long int) (max (WrapperStruct00.var_1_12 , WrapperStruct00.var_1_19)))) : (WrapperStruct00.var_1_18 == ((unsigned long int) WrapperStruct00.var_1_12)))
;
}
int main(void) {
	isInitial = 1;
