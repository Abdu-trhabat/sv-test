...
void step(void) {
	...
	// From: CodeObject6
	/* 262L, 111L) */ if (var_1_39) {
		/* 264L, 109L) */ if (/* 265L, 85L, 86L) */ ((/* 266L, 81L, 87L) */ ((/* 267L, 79L, 88L) */ ((var_1_34) + (var_1_31))) / (var_1_40))) != (/* 271L, 84L, 92L) */ ((var_1_35) / (var_1_41))))) {
			/* 274L, 108L) */ var_1_38 = (
				/* 277L, 107L) */ (abs (
					var_1_1
				))
	...
	// From: CodeObject7
	/* 279L, 148L) */ if (/* 280L, 120L, 121L) */ ((var_1_15) < (/* 282L, 119L, 123L) */ (~ (-32))))) {
		/* 284L, 136L) */ var_1_42 = (
			/* 287L, 135L) */ ((
				/* 288L, 133L) */ ((
					var_1_43
	...
	// From: CodeObject8
	/* 303L, 200L) */ if (/* 304L, 161L, 162L) */ ((/* 305L, 159L, 163L) */ ((var_1_37) - (/* 307L, 158L, 165L) */ (abs (var_1_35))))) > (var_1_30))) {
		/* 310L, 181L) */ var_1_46 = (
			/* 313L, 180L) */ (! (
				/* 314L, 179L) */ (! (
					/* 315L, 178L) */ ((
		...
		/* 318L, 198L) */ if (/* 319L, 187L, 188L) */ ((var_1_47) || (var_1_39))) {
			/* 322L, 197L) */ var_1_46 = (
				var_1_48
			);
		}
