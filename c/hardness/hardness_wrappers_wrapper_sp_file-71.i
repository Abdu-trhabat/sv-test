...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch71Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((*(WrapperStruct00_var_1_7_Pointer))) {
  ...
  (*(WrapperStruct00_var_1_8_Pointer)) = ((*(WrapperStruct00_var_1_15_Pointer)) + (*(WrapperStruct00_var_1_3_Pointer)));
 }
