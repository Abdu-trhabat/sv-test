...
void step(void) {
	...
	// From: Req8Batch62stepLocals
	signed long int stepLocal_3 = var_1_17 + var_1_4;
	if (var_1_16 < (max (var_1_7 , var_1_20))) {
		if (-5 < stepLocal_3) {
...
int property(void) {
	return ((((((((var_1_2 > ((var_1_3 % var_1_4) * var_1_5)) ? (var_1_1 == ((double) (var_1_6 - (var_1_7 + var_1_8)))) : ((var_1_8 > var_1_7) ? (var_1_1 == ((double) (var_1_7 + var_1_8))) : (var_1_1 == ((double) var_1_8)))) && ((var_1_6 > (- var_1_8)) ? (var_1_9 == ((signed char) (var_1_10 - var_1_11))) : (var_1_12 ? (var_1_9 == ((signed char) (min (var_1_10 , var_1_11)))) : 1))) && (var_1_13 == ((double) ((min (var_1_7 , var_1_8)) + (var_1_14 + var_1_15))))) && (((- var_1_3) <= -100000) ? (var_1_16 == ((float) ((var_1_7 - var_1_8) + var_1_15))) : (var_1_16 == ((float) var_1_15)))) && (((var_1_12 || (var_1_4 >= var_1_3)) && var_1_18) ? (var_1_17 == ((unsigned char) var_1_11)) : 1)) && (var_1_19 == ((unsigned char) var_1_11))) && (var_1_20 == ((double) (max (var_1_7 , var_1_15))))) && ((var_1_16 < (max (var_1_7 , var_1_20))) ? ((-5 < (var_1_17 + var_1_4)) ? (var_1_21 == ((double) (max (var_1_15 , (var_1_7 - var_1_6))))) : (var_1_21 == ((double) var_1_14))) : (var_1_21 == ((double) var_1_15)))
;
}
int main(void) {
	isInitial = 1;
