...
void step(void) {
	...
	if (((var_1_31 << var_1_22) + (var_1_4 ^ last_1_var_1_41)) <= stepLocal_5) {
		...
		var_1_33 = (min ((var_1_34 - var_1_35) , (var_1_36 - 15.8)));
	}
	...
	if (var_1_24) {
		var_1_41 = ((max (var_1_31 , var_1_22)) + var_1_12);
	} else {
		var_1_41 = (abs (var_1_4));
	}
	...
	if (var_1_36 >= var_1_10) {
		if (stepLocal_9 <= var_1_5) {
			var_1_46 = (((min (var_1_47 , var_1_48)) + (var_1_49 + var_1_50)) - var_1_45);
		} else {
	...
	if (((abs (3096462083u)) - var_1_53) >= stepLocal_10) {
		var_1_61 = var_1_32;
	} else {
	...
	signed long int stepLocal_2 = abs (var_1_8);
	...
	if (! ((var_1_4 > var_1_46) && var_1_25)) {
		if (var_1_55 >= ((var_1_19 + var_1_11) / (min (var_1_30 , var_1_29)))) {
			if (var_1_55 > var_1_36) {
				var_1_42 = ((var_1_43 - var_1_22) - (abs (var_1_32)));
			}
		} else {
	...
	signed long int stepLocal_1 = (8 / var_1_4) * (min (var_1_40 , 16));
	if (var_1_15 >= var_1_55) {
		var_1_13 = (max (-16 , var_1_4));
	} else {
		if (var_1_5 <= stepLocal_1) {
			var_1_13 = (min (((var_1_5 - var_1_41) + var_1_4) , var_1_8));
		}
	}
	...
	if (var_1_30 == var_1_19) {
		var_1_37 = ((max ((var_1_22 + var_1_46) , var_1_31)) - 8);
	} else {
	...
	if (var_1_68 >= var_1_12) {
		...
		var_1_58 = (((var_1_59 + 50) - var_1_60) + (abs (var_1_5)));
	}
	...
	if ((8 << var_1_51) != var_1_50) {
		var_1_54 = ((max (var_1_22 , (var_1_8 + var_1_58))) + var_1_5);
	}
	...
	if (var_1_21) {
		if (var_1_18 != (- (var_1_10 - var_1_11))) {
			...
			var_1_39 = (min (var_1_8 , (min (var_1_5 , var_1_62))));
		}
	}


	// From: Req16Batch99Amount250
	if ((abs (var_1_8)) <= var_1_54) {
		if ((max ((var_1_43 + var_1_54) , (var_1_20 ^ 0))) < var_1_13) {
			var_1_44 = var_1_5;
		} else {
			var_1_44 = ((max (var_1_43 , var_1_22)) + (max (var_1_45 , var_1_5)));
		}
	} else {
...
int property(void) {
	return (((((((((((((((((((((((((! var_1_21) && var_1_21) ? (var_1_1 == ((unsigned char) (var_1_4 - var_1_5))) : (((64.888 * var_1_55) > var_1_33) ? (var_1_1 == ((unsigned char) (var_1_4 - (min (var_1_5 , var_1_8))))) : (var_1_1 == ((unsigned char) (var_1_5 + var_1_8))))) && ((var_1_15 != (var_1_10 - var_1_11)) ? (var_1_21 ? (var_1_9 == ((signed short int) (var_1_4 + (max (var_1_67 , (var_1_5 + 10)))))) : 1) : (var_1_21 ? (var_1_9 == ((signed short int) 16)) : (var_1_9 == ((signed short int) var_1_5))))) && ((! last_1_var_1_21) ? ((last_1_var_1_33 >= var_1_11) ? (var_1_12 == ((unsigned short int) (var_1_8 + 25))) : 1) : 1)) && ((var_1_15 >= var_1_55) ? (var_1_13 == ((signed short int) (max (-16 , var_1_4)))) : ((var_1_5 <= ((8 / var_1_4) * (min (var_1_40 , 16)))) ? (var_1_13 == ((signed short int) (min (((var_1_5 - var_1_41) + var_1_4) , var_1_8)))) : 1))) && ((var_1_10 > (var_1_55 + (var_1_55 + var_1_11))) ? (var_1_15 == ((double) (abs (max (7.25 , (min (var_1_16 , var_1_17))))))) : (var_1_15 == ((double) (min ((min (var_1_17 , (max (var_1_16 , var_1_18)))) , var_1_19)))))) && (((- var_1_12) != var_1_5) ? ((var_1_40 > (abs (var_1_8))) ? (var_1_20 == ((unsigned short int) ((var_1_4 + var_1_5) + var_1_8))) : (var_1_20 == ((unsigned short int) var_1_8))) : 1)) && ((var_1_33 >= var_1_16) ? (((var_1_5 << (var_1_22 - 0)) <= var_1_68) ? (var_1_21 == ((unsigned char) (((last_1_var_1_21 || var_1_23) && var_1_24) && var_1_25))) : (var_1_21 == ((unsigned char) (var_1_24 && (var_1_25 || var_1_23))))) : (var_1_21 == ((unsigned char) (var_1_26 || var_1_27))))) && ((var_1_27 && var_1_24) ? (var_1_28 == ((unsigned char) var_1_8)) : ((var_1_18 >= (var_1_19 / (max (var_1_29 , var_1_30)))) ? ((last_1_var_1_28 > var_1_67) ? (var_1_28 == ((unsigned char) (var_1_22 + var_1_8))) : 1) : (((var_1_20 / var_1_4) <= var_1_62) ? ((var_1_62 == var_1_54) ? (var_1_28 == ((unsigned char) var_1_8)) : 1) : (var_1_28 == ((unsigned char) (var_1_5 + (var_1_31 - (var_1_22 + var_1_32))))))))) && ((((var_1_31 << var_1_22) + (var_1_4 ^ last_1_var_1_41)) <= (var_1_32 * last_1_var_1_44)) ? (var_1_33 == ((double) (max (var_1_19 , var_1_16)))) : (var_1_33 == ((double) (min ((var_1_34 - var_1_35) , (var_1_36 - 15.8))))))) && ((var_1_30 == var_1_19) ? (var_1_37 == ((signed short int) ((max ((var_1_22 + var_1_46) , var_1_31)) - 8))) : ((4 >= var_1_13) ? (var_1_37 == ((signed short int) var_1_4)) : (var_1_37 == ((signed short int) ((var_1_8 - var_1_46) + var_1_4)))))) && ((var_1_21 && (var_1_26 && (var_1_29 <= var_1_33))) ? ((var_1_68 <= var_1_13) ? (var_1_38 == ((signed char) var_1_22)) : 1) : 1)) && (var_1_21 ? ((var_1_18 != (- (var_1_10 - var_1_11))) ? (var_1_39 == ((signed long int) var_1_9)) : (var_1_39 == ((signed long int) (min (var_1_8 , (min (var_1_5 , var_1_62))))))) : 1)) && (var_1_40 == ((signed short int) var_1_4))) && (var_1_24 ? (var_1_41 == ((unsigned long int) ((max (var_1_31 , var_1_22)) + var_1_12))) : (var_1_41 == ((unsigned long int) (abs (var_1_4)))))) && ((! ((var_1_4 > var_1_46) && var_1_25)) ? ((var_1_55 >= ((var_1_19 + var_1_11) / (min (var_1_30 , var_1_29)))) ? ((var_1_55 > var_1_36) ? (var_1_42 == ((signed char) ((var_1_43 - var_1_22) - (abs (var_1_32))))) : 1) : (var_1_42 == ((signed char) (var_1_22 + var_1_32)))) : 1)) && (((abs (var_1_8)) <= var_1_54) ? (((max ((var_1_43 + var_1_54) , (var_1_20 ^ 0))) < var_1_13) ? (var_1_44 == ((unsigned char) var_1_5)) : (var_1_44 == ((unsigned char) ((max (var_1_43 , var_1_22)) + (max (var_1_45 , var_1_5)))))) : (var_1_44 == ((unsigned char) ((var_1_22 + var_1_32) + var_1_8))))) && ((var_1_36 >= var_1_10) ? (((var_1_32 - (var_1_22 + var_1_4)) <= var_1_5) ? (var_1_46 == ((unsigned short int) (((min (var_1_47 , var_1_48)) + (var_1_49 + var_1_50)) - var_1_45))) : (var_1_46 == ((unsigned short int) (((var_1_51 - var_1_52) + var_1_53) - (var_1_5 + var_1_45))))) : 1)) && (((8 << var_1_51) != var_1_50) ? (var_1_54 == ((unsigned short int) ((max (var_1_22 , (var_1_8 + var_1_58))) + var_1_5))) : 1)) && (var_1_55 == ((double) (var_1_56 + var_1_57)))) && ((var_1_68 >= var_1_12) ? (var_1_58 == ((unsigned char) var_1_22)) : (var_1_58 == ((unsigned char) (((var_1_59 + 50) - var_1_60) + (abs (var_1_5))))))) && ((((abs (3096462083u)) - var_1_53) >= ((64u & var_1_41) + var_1_12)) ? (var_1_61 == ((signed char) var_1_32)) : (var_1_61 == ((signed char) (var_1_60 + var_1_32))))) && (var_1_21 ? (var_1_62 == ((unsigned long int) var_1_20)) : ((var_1_22 < var_1_51) ? (var_1_62 == ((unsigned long int) ((var_1_63 + (var_1_64 - var_1_53)) - var_1_4))) : (var_1_62 == ((unsigned long int) ((var_1_65 - (var_1_66 - var_1_43)) - var_1_60)))))) && ((var_1_19 <= (abs (127.2))) ? ((var_1_46 < last_1_var_1_67) ? (var_1_67 == ((signed short int) var_1_4)) : (var_1_67 == ((signed short int) var_1_37))) : (var_1_67 == ((signed short int) var_1_50)))) && ((var_1_13 < last_1_var_1_68) ? ((var_1_33 >= ((max (var_1_35 , var_1_36)) - var_1_34)) ? (var_1_23 ? (var_1_68 == ((unsigned long int) var_1_31)) : (var_1_68 == ((unsigned long int) var_1_69))) : (var_1_68 == ((unsigned long int) var_1_63))) : (var_1_68 == ((unsigned long int) var_1_70)))
;
}
int main(void) {
	isInitial = 1;
