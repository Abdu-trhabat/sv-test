...
void step(void) {
	...
	// From: CodeObject5
	/* 237L, 70L) */ if (/* 238L, 43L, 44L) */ ((var_1_30) < (var_1_31))) {
		/* 241L, 62L) */ var_1_32 = (
			/* 244L, 61L) */ (min (
				/* 244L, 61L) */ (
					/* 245L, 55L) */ (min (
	...
	// From: CodeObject6
	/* 262L, 111L) */ if (var_1_12) {
		/* 264L, 109L) */ if (/* 265L, 85L, 86L) */ ((/* 266L, 81L, 87L) */ ((/* 267L, 79L, 88L) */ ((var_1_34) + (var_1_31))) / (var_1_17))) != (/* 271L, 84L, 92L) */ ((var_1_35) / (var_1_41))))) {
			/* 274L, 108L) */ var_1_38 = (
				/* 277L, 107L) */ (abs (
					var_1_7
				))
	...
	// From: CodeObject7
	/* 279L, 148L) */ if (/* 280L, 120L, 121L) */ ((var_1_2) < (/* 282L, 119L, 123L) */ (~ (-32))))) {
		/* 284L, 136L) */ var_1_42 = (
			/* 287L, 135L) */ ((
				/* 288L, 133L) */ ((
					var_1_43
	...
	// From: CodeObject8
	/* 303L, 200L) */ if (/* 304L, 161L, 162L) */ ((/* 305L, 159L, 163L) */ ((var_1_21) - (/* 307L, 158L, 165L) */ (abs (var_1_35))))) > (var_1_30))) {
		/* 310L, 181L) */ var_1_46 = (
			/* 313L, 180L) */ (! (
				/* 314L, 179L) */ (! (
					/* 315L, 178L) */ ((
		...
		/* 318L, 198L) */ if (/* 319L, 187L, 188L) */ ((var_1_47) || (var_1_12))) {
			/* 322L, 197L) */ var_1_46 = (
				var_1_48
			);
		}
...
int property(void) {
	if (/* 348L, 26L, 34L, 340L, 355L, 1028L) */ ((var_1_15) >= (/* 350L, 25L, 36L, 342L, 357L, 1030L) */ ((/* 351L, 23L, 37L, 343L, 358L, 1031L) */ (min (/* 351L, 23L, 37L, 343L, 358L, 1031L) */ (var_1_3) , (var_1_4)))) * (1))))) {
	}
	if (/* 361L, 65L, 77L, 434L, 467L, 1041L) */ ((/* 362L, 57L, 78L, 435L, 468L, 1042L) */ ((var_1_2) / (var_1_7))) < (/* 365L, 64L, 81L, 438L, 471L, 1045L) */ ((/* 366L, 60L, 82L, 439L, 472L, 1046L) */ ((var_1_4) | (var_1_3))) + (/* 369L, 63L, 85L, 442L, 475L, 1049L) */ ((var_1_15) / (var_1_8))))))) {
	} else {
		if (var_1_12) {
		} else {
		}
	...
	if (var_1_12) {
		if (/* 399L, 126L, 134L, 541L, 559L, 1079L) */ ((/* 400L, 124L, 135L, 542L, 560L, 1080L) */ (max (/* 400L, 124L, 135L, 542L, 560L, 1080L) */ (var_1_15) , (/* 402L, 123L, 137L, 544L, 562L, 1082L) */ ((var_1_2) - (var_1_11)))))) >= (var_1_1))) {
		}
	}
	if (var_1_12) {
	}
	if (/* 423L, 181L, 187L, 784L, 826L, 1103L) */ ((/* 424L, 179L, 188L, 785L, 827L, 1104L) */ ((var_1_13) / (var_1_17))) >= (var_1_14))) {
		if (/* 429L, 197L, 204L, 790L, 832L, 1109L) */ ((/* 430L, 195L, 205L, 791L, 833L, 1110L) */ ((var_1_11) << (/* 432L, 194L, 207L, 793L, 835L, 1112L) */ (abs (var_1_18))))) <= (var_1_9))) {
		} else {
			if (/* 442L, 218L, 222L, 803L, 845L, 1122L) */ ((var_1_15) >= (var_1_1))) {
			} else {
			}
		}
	} else {
	...
	/* 467L) */ ((
		/* 466L) */ ((
			/* 465L) */ ((
				/* 464L) */ ((
					/* 332L, 13L, 280L, 294L, 1012L) */ ((
						var_1_1
					) == (
						/* 332L, 13L, 280L, 294L, 1012L) */ ((signed char) (
							/* 335L, 12L, 283L, 297L, 1015L) */ (max (
								/* 335L, 12L, 283L, 297L, 1015L) */ (
									/* 336L, 6L, 284L, 298L, 1016L) */ ((
										var_1_2
									) - (
										25
									))
								) , (
									/* 339L, 11L, 287L, 301L, 1019L) */ ((
										var_1_3
									) + (
										/* 341L, 10L, 289L, 303L, 1021L) */ ((
											1
										) + (
											var_1_4
										))
					...
					/* 347L, 46L, 339L, 354L, 1027L) */ ((
						/* 348L, 26L, 34L, 340L, 355L, 1028L) */ ((
							var_1_15
						) >= (
							/* 350L, 25L, 36L, 342L, 357L, 1030L) */ ((
								/* 351L, 23L, 37L, 343L, 358L, 1031L) */ (min (
									/* 351L, 23L, 37L, 343L, 358L, 1031L) */ (
										var_1_3
									) , (
										var_1_4
									)
						...
						/* 355L, 44L, 347L, 362L, 1035L) */ ((
							var_1_5
						) == (
							/* 355L, 44L, 347L, 362L, 1035L) */ ((signed char) (
								var_1_3
							))
						))
					) : (
				...
				/* 360L, 112L, 433L, 466L, 1040L) */ ((
					/* 361L, 65L, 77L, 434L, 467L, 1041L) */ ((
						/* 362L, 57L, 78L, 435L, 468L, 1042L) */ ((
							var_1_2
						) / (
							var_1_7
						))
					) < (
						/* 365L, 64L, 81L, 438L, 471L, 1045L) */ ((
							/* 366L, 60L, 82L, 439L, 472L, 1046L) */ ((
								var_1_4
							) | (
								var_1_3
							))
						) + (
							/* 369L, 63L, 85L, 442L, 475L, 1049L) */ ((
								var_1_15
							) / (
								var_1_8
							))
					...
					/* 372L, 97L, 445L, 478L, 1052L) */ ((
						var_1_6
					) == (
						/* 372L, 97L, 445L, 478L, 1052L) */ ((signed char) (
							/* 375L, 96L, 448L, 481L, 1055L) */ ((
								/* 376L, 92L, 449L, 482L, 1056L) */ (max (
									/* 376L, 92L, 449L, 482L, 1056L) */ (
										var_1_2
									) , (
										var_1_9
									)
					...
					/* 382L, 110L, 455L, 488L, 1062L) */ ((
						var_1_12
					) ? (
						/* 384L, 104L, 457L, 490L, 1064L) */ ((
							var_1_6
						) == (
							/* 384L, 104L, 457L, 490L, 1064L) */ ((signed char) (
								var_1_3
							))
						))
					) : (
						/* 388L, 108L, 461L, 494L, 1068L) */ ((
							var_1_6
						) == (
							/* 388L, 108L, 461L, 494L, 1068L) */ ((signed char) (
								var_1_9
							))
						))
					))
			...
			/* 396L, 148L, 538L, 556L, 1076L) */ ((
				var_1_12
			) ? (
				/* 398L, 146L, 540L, 558L, 1078L) */ ((
					/* 399L, 126L, 134L, 541L, 559L, 1079L) */ ((
						/* 400L, 124L, 135L, 542L, 560L, 1080L) */ (max (
							/* 400L, 124L, 135L, 542L, 560L, 1080L) */ (
								var_1_15
							) , (
								/* 402L, 123L, 137L, 544L, 562L, 1082L) */ ((
									var_1_2
								) - (
									var_1_11
								))
					...
					/* 406L, 144L, 548L, 566L, 1086L) */ ((
						var_1_13
					) == (
						/* 406L, 144L, 548L, 566L, 1086L) */ ((float) (
							var_1_14
						))
					))
				) : (
		...
		/* 412L, 170L, 594L, 605L, 1092L) */ ((
			var_1_12
		) ? (
			/* 414L, 168L, 596L, 607L, 1094L) */ ((
				var_1_15
			) == (
				/* 414L, 168L, 596L, 607L, 1094L) */ ((signed long int) (
					/* 417L, 167L, 599L, 610L, 1097L) */ ((
						var_1_2
					) - (
						/* 419L, 166L, 601L, 612L, 1099L) */ (abs (
							var_1_1
						))
					))
				))
	...
	/* 422L, 248L, 783L, 825L, 1102L) */ ((
		/* 423L, 181L, 187L, 784L, 826L, 1103L) */ ((
			/* 424L, 179L, 188L, 785L, 827L, 1104L) */ ((
				var_1_13
			) / (
				var_1_17
			))
		...
		/* 428L, 242L, 789L, 831L, 1108L) */ ((
			/* 429L, 197L, 204L, 790L, 832L, 1109L) */ ((
				/* 430L, 195L, 205L, 791L, 833L, 1110L) */ ((
					var_1_11
				) << (
					/* 432L, 194L, 207L, 793L, 835L, 1112L) */ (abs (
						var_1_18
					))
				))
			) <= (
			...
			/* 435L, 215L, 796L, 838L, 1115L) */ ((
				var_1_16
			) == (
				/* 435L, 215L, 796L, 838L, 1115L) */ ((float) (
					/* 438L, 214L, 799L, 841L, 1118L) */ ((
						var_1_19
					) - (
						64.4f
					))
			...
			/* 441L, 240L, 802L, 844L, 1121L) */ ((
				/* 442L, 218L, 222L, 803L, 845L, 1122L) */ ((
					var_1_15
				) >= (
					var_1_1
				))
			) ? (
				/* 445L, 234L, 806L, 848L, 1125L) */ ((
					var_1_16
				) == (
					/* 445L, 234L, 806L, 848L, 1125L) */ ((float) (
						/* 448L, 233L, 809L, 851L, 1128L) */ (max (
							/* 448L, 233L, 809L, 851L, 1128L) */ (
								var_1_14
							) , (
								/* 450L, 232L, 811L, 853L, 1130L) */ ((
									var_1_19
								) - (
									/* 452L, 231L, 813L, 855L, 1132L) */ ((
										var_1_20
									) - (
										var_1_21
									))
				...
				/* 455L, 238L, 816L, 858L, 1135L) */ ((
					var_1_16
				) == (
					/* 455L, 238L, 816L, 858L, 1135L) */ ((float) (
						var_1_22
					))
				))
			))
		...
		/* 459L, 246L, 820L, 862L, 1139L) */ ((
			var_1_16
		) == (
			/* 459L, 246L, 820L, 862L, 1139L) */ ((float) (
				var_1_20
			))
		))
	))
