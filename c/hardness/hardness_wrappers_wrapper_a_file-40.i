...
void step(void) {
 ...
 if (last_1_double_Array_0_0_ != ((((float_Array_0[1][1]) < (float_Array_0[0][0])) ? (float_Array_0[1][1]) : (float_Array_0[0][0])))) {
