...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch43Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch43Amount25
	var_1_13 = (128.75f + var_1_14);


	// From: Req5Batch43Amount25
	var_1_18 = var_1_19;


	// From: Req6Batch43Amount25
	var_1_20 = var_1_21;


	// From: Req2Batch43Amount25
	...
	// From: Req4Batch43Amount25
	if (var_1_18) {
		var_1_15 = (var_1_16 + var_1_17);
	}


	// From: Req1Batch43Amount25
