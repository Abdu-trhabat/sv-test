...
void step(void) {
	// From: Req8Batch21100_1loop
	signed long int stepLocal_2 = max (var_1_10 , last_1_var_1_42);
	...
	// From: Req1Batch21100_1loop
	if ((min (var_1_18 , var_1_25)) > var_1_18) {
	...
	// From: Req3Batch21100_1loop
	if (! (! (var_1_8 <= var_1_12))) {
		var_1_13 = var_1_8;
	}


	// From: Req13Batch21100_1loop
	var_1_39 = var_1_22;


	// From: Req14Batch21100_1loop
	var_1_40 = var_1_41;


	// From: Req15Batch21100_1loop
	var_1_42 = var_1_11;


	// From: Req5Batch21100_1loop
	if ((min ((var_1_12 - 50) , var_1_13)) != var_1_13) {
		if (var_1_40) {
			var_1_15 = var_1_17;
		}
	}
	...
	// From: Req9Batch21100_1loop
	if (var_1_40) {
		var_1_27 = (min ((min (var_1_6 , var_1_12)) , var_1_7));
	} else {
		var_1_27 = (var_1_42 + (min (var_1_10 , var_1_6)));
	}


	// From: Req11Batch21100_1loop
...
int property(void) {
	return ((((((((((((((((min (var_1_18 , var_1_25)) > var_1_18) ? (var_1_1 == ((signed long int) (((var_1_5 + var_1_6) - var_1_7) - var_1_8))) : (var_1_1 == ((signed long int) var_1_7))) && ((var_1_5 >= var_1_7) ? (var_1_9 == ((unsigned char) ((var_1_10 + var_1_11) - var_1_12))) : (var_1_9 == ((unsigned char) var_1_12)))) && ((! (! (var_1_8 <= var_1_12))) ? (var_1_13 == ((signed long int) var_1_8)) : 1)) && ((var_1_27 > (min ((var_1_10 / var_1_11) , (var_1_12 * var_1_9)))) ? (var_1_14 == ((signed short int) ((abs (var_1_11)) + (var_1_10 - var_1_12)))) : 1)) && (((min ((var_1_12 - 50) , var_1_13)) != var_1_13) ? (var_1_40 ? (var_1_15 == ((unsigned char) var_1_17)) : 1) : 1)) && ((var_1_25 < (var_1_19 - var_1_20)) ? ((var_1_6 < var_1_10) ? (var_1_18 == ((float) (max (var_1_21 , (var_1_22 + var_1_23))))) : (var_1_18 == ((float) 3.5f))) : (var_1_18 == ((float) var_1_21)))) && ((var_1_10 <= 16) ? (((max (var_1_18 , var_1_21)) <= var_1_25) ? (var_1_24 == ((unsigned char) var_1_11)) : (var_1_24 == ((unsigned char) 1))) : (var_1_24 == ((unsigned char) var_1_12)))) && (last_1_var_1_15 ? (((max (var_1_10 , last_1_var_1_42)) >= var_1_11) ? (var_1_25 == ((double) 128.8)) : 1) : ((var_1_17 && (var_1_8 <= last_1_var_1_28)) ? (var_1_25 == ((double) var_1_23)) : 1))) && (var_1_40 ? (var_1_27 == ((signed long int) (min ((min (var_1_6 , var_1_12)) , var_1_7)))) : (var_1_27 == ((signed long int) (var_1_42 + (min (var_1_10 , var_1_6))))))) && ((var_1_39 > var_1_22) ? ((var_1_23 == (- (var_1_25 / var_1_29))) ? (((var_1_7 <= 16) && (var_1_17 || var_1_15)) ? (var_1_28 == ((signed short int) var_1_24)) : 1) : 1) : (var_1_28 == ((signed short int) var_1_27)))) && ((var_1_21 >= var_1_22) ? (var_1_15 ? (var_1_30 == ((signed char) (max (var_1_31 , (max (var_1_32 , var_1_33)))))) : (var_1_30 == ((signed char) -32))) : (var_1_30 == ((signed char) ((min ((min (var_1_34 , var_1_35)) , var_1_36)) + var_1_37))))) && (((var_1_23 <= var_1_39) && (var_1_7 <= -128)) ? (var_1_38 == ((signed char) (max (var_1_34 , var_1_32)))) : 1)) && (var_1_39 == ((double) var_1_22))) && (var_1_40 == ((unsigned char) var_1_41))) && (var_1_42 == ((unsigned short int) var_1_11))
;
}
int main(void) {
	isInitial = 1;
