...
void step(void) {
	...
	if (stepLocal_0 != (min (var_1_4 , var_1_3))) {
		if (var_1_9 == (min (-50.0 , (var_1_10 * var_1_11)))) {
...
int property(void) {
	return (((var_1_1 == ((unsigned long int) (var_1_2 + (var_1_3 - (var_1_4 - var_1_5))))) && (var_1_6 == ((unsigned char) var_1_7))) && (((min (var_1_1 , var_1_5)) != (min (var_1_4 , var_1_3))) ? ((var_1_9 == (min (-50.0 , (var_1_10 * var_1_11)))) ? (var_1_8 == ((unsigned char) ((! var_1_12) || var_1_7))) : 1) : (var_1_8 == ((unsigned char) 0)))) && ((((min (var_1_14 , 10)) - (abs (-500))) != var_1_4) ? ((! var_1_7) ? ((var_1_11 > var_1_10) ? (((var_1_4 - var_1_2) <= var_1_3) ? (var_1_13 == ((float) var_1_15)) : (var_1_13 == ((float) -10.0f))) : (var_1_13 == ((float) 128.0f))) : 1) : (var_1_13 == ((float) var_1_15)))
;
}
int main(void) {
	isInitial = 1;
