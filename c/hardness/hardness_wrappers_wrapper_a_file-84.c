...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch84Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (signed_long_int_Array_0[1] != stepLocal_0) {
	...
	if (signed_long_int_Array_0[0] < unsigned_short_int_Array_0[0]) {
		if (((- 8) / (unsigned_char_Array_0[0] - unsigned_char_Array_0[2])) >= unsigned_char_Array_0[3]) {
			signed_short_int_Array_0[0] = (unsigned_char_Array_0[6] - (signed_short_int_Array_0[2] - unsigned_char_Array_0[2]));
		}
	}
...
int property(void) {
	return (((((signed_long_int_Array_0[1] != signed_long_int_Array_0[0]) ? (unsigned_char_Array_0[6] == ((unsigned char) (unsigned_char_Array_0[5] + (max ((min (unsigned_char_Array_0[4] , unsigned_char_Array_0[3])) , unsigned_char_Array_0[1]))))) : (unsigned_char_Array_0[6] == ((unsigned char) unsigned_char_Array_0[5]))) && (BOOL_unsigned_char_Array_0[0] ? (unsigned_short_int_Array_0[0] == ((unsigned short int) ((unsigned_short_int_Array_0[1] + 23103) - (32 + unsigned_char_Array_0[3])))) : 1)) && ((signed_long_int_Array_0[0] < unsigned_short_int_Array_0[0]) ? ((((- 8) / (unsigned_char_Array_0[0] - unsigned_char_Array_0[2])) >= unsigned_char_Array_0[3]) ? (signed_short_int_Array_0[0] == ((signed short int) (unsigned_char_Array_0[6] - (signed_short_int_Array_0[2] - unsigned_char_Array_0[2])))) : 1) : 1)) && ((! (unsigned_char_Array_0[4] > unsigned_short_int_Array_0[1])) ? (signed_short_int_Array_0[1] == ((signed short int) (32 - 8))) : (signed_short_int_Array_0[1] == ((signed short int) (unsigned_char_Array_0[0] - unsigned_char_Array_0[5]))))) && (float_Array_0[0] == ((float) float_Array_0[1]))
;
}
int main(void) {
	isInitial = 1;
