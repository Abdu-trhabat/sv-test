...
void step(void) {
	...
	// From: Req5Batch12750_while
	var_1_13 = (var_1_14 - last_1_var_1_18);


	// From: Req2Batch12750_while
	...
	// From: Req3Batch12750_while
	if (var_1_10) {
		var_1_11 = (var_1_6 && (var_1_8 && var_1_9));
	}


	// From: Req1Batch12750_while
	if (! last_1_var_1_12) {
