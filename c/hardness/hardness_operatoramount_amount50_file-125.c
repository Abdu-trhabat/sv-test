...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch125Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch125Amount50
	var_1_11 = ((abs (var_1_12)) + var_1_13);


	// From: Req3Batch125Amount50
	...
	// From: Req4Batch125Amount50
	var_1_18 = (min ((var_1_19 - 100) , var_1_9));


	// From: Req5Batch125Amount50
	if (var_1_2) {
		var_1_20 = var_1_18;
	} else {
