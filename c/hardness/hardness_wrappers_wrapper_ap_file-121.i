...
void step(void) {
 ...
 if ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var5_Pointer)) <= (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer))) {
  if (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer))) {
   (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) = (((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))) < (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) + 2))) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))) : (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) + 2))));
  } else {
   (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) = (((((((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) < 0 ) ? -((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)))))) < ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)))) ? ((((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) < 0 ) ? -((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)))))) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)))));
  }
 }
}
void updateVariables(void) {
