...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch149Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch149Amount100
	var_1_9 = var_1_5;


	// From: Req9Batch149Amount100
	var_1_22 = ((var_1_23 - var_1_19) - var_1_20);


	// From: Req14Batch149Amount100
	var_1_36 = 16u;


	// From: Req13Batch149Amount100
	...
	// From: Req3Batch149Amount100
	if ((var_1_8 - var_1_22) <= var_1_35) {
		var_1_7 = var_1_22;
	}


	// From: Req7Batch149Amount100
	if (255.5 <= var_1_15) {
	...
	// From: Req12Batch149Amount100
	if ((abs (var_1_31)) == var_1_7) {
		var_1_30 = (var_1_32 + (var_1_33 + var_1_34));
	}


	// From: Req2Batch149Amount100
	if (var_1_25) {
		var_1_6 = 8;
	}


	// From: Req5Batch149Amount100
	...
	// From: Req8Batch149Amount100
	if (! var_1_25) {
		var_1_21 = (abs (var_1_18));
	}


	// From: Req15Batch149Amount100
