...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch175Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	/* 302L, 106L) */ if (/* 303L, 63L, 64L) */ ((/* 304L, 59L, 65L) */ ((var_1_28) ^ (var_1_24))) >= (/* 307L, 62L, 68L) */ (max (/* 307L, 62L, 68L) */ (var_1_28) , (var_1_4)))))) {
		/* 310L, 100L) */ if (var_1_6) {
			/* 312L, 98L) */ if (/* 313L, 83L, 84L) */ ((var_1_4) < (var_1_28))) {
				/* 316L, 93L) */ var_1_38 = (
					var_1_24
				);
			} else {
	...
	// From: CodeObject4
	/* 328L, 165L) */ if (/* 329L, 112L, 113L) */ ((2) <= (var_1_25))) {
		/* 332L, 124L) */ var_1_39 = (
			/* 335L, 123L) */ ((
				var_1_40
			) - (
		...
		/* 338L, 163L) */ if (/* 339L, 133L, 134L) */ ((/* 340L, 131L, 135L) */ ((/* 341L, 127L, 136L) */ ((var_1_28) ^ (var_1_2))) / (/* 344L, 130L, 139L) */ (min (/* 344L, 130L, 139L) */ (var_1_42) , (var_1_43)))))) != (var_1_28))) {
			/* 348L, 158L) */ var_1_39 = (
				/* 351L, 157L) */ (min (
					/* 351L, 157L) */ (
						/* 352L, 155L) */ (abs (
	...
	/* 373L, 236L) */ if (var_1_7) {
		/* 375L, 230L) */ if (/* 376L, 197L, 198L) */ ((var_1_41) <= (var_1_43))) {
			/* 379L, 228L) */ if (/* 380L, 209L, 210L) */ ((/* 381L, 207L, 211L) */ (abs (/* 382L, 206L, 212L) */ ((var_1_18) / (var_1_49))))) <= (var_1_19))) {
				/* 386L, 227L) */ var_1_47 = (
					/* 389L, 226L) */ (max (
						/* 389L, 226L) */ (
							var_1_23
	...
	/* 290L, 53L) */ if (/* 291L, 31L, 32L) */ ((var_1_35) || (var_1_36))) {
		/* 294L, 51L) */ if (/* 295L, 40L, 41L) */ ((var_1_28) < (var_1_2))) {
			/* 298L, 50L) */ var_1_34 = (
				var_1_37
			);
		}
