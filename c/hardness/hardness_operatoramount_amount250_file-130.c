...
void step(void) {
	...
	// From: Req2Batch130Amount250
	unsigned char stepLocal_3 = var_1_14;
	signed long int stepLocal_2 = var_1_6;
	if (var_1_72 == stepLocal_2) {
		if (stepLocal_3 || var_1_2) {
			var_1_13 = (min (-32 , var_1_15));
		}
	}


	// From: Req8Batch130Amount250
	var_1_34 = (var_1_35 - var_1_7);


	// From: Req9Batch130Amount250
	var_1_36 = (var_1_33 + (var_1_37 - (var_1_38 - var_1_31)));


	// From: Req10Batch130Amount250
	if ((max (var_1_38 , (1 * var_1_5))) != 2) {
		var_1_39 = (var_1_31 + ((min (last_1_var_1_39 , var_1_30)) + var_1_40));
	} else {
		var_1_39 = (abs (var_1_33));
	}


	// From: Req13Batch130Amount250
	if ((min ((var_1_24 - var_1_22) , (var_1_19 * var_1_20))) <= var_1_29) {
		var_1_47 = (min (var_1_48 , (abs (var_1_13))));
	} else {
		var_1_47 = (4 + (var_1_30 + (var_1_13 + var_1_31)));
	}


	// From: Req17Batch130Amount250
	signed long int stepLocal_12 = 1 + (min (-64 , var_1_12));
	if (var_1_24 == (var_1_22 - (var_1_29 + var_1_21))) {
		if (var_1_6 >= stepLocal_12) {
			var_1_57 = (max (((max (var_1_52 , var_1_58)) + var_1_59) , (var_1_60 + var_1_61)));
		} else {
			var_1_57 = (var_1_61 + 32);
		}
	} else {
		var_1_57 = (min ((1 - (var_1_62 + var_1_63)) , (min (var_1_60 , var_1_52))));
	}


	// From: Req21Batch130Amount250
	if (var_1_43) {
		var_1_74 = var_1_62;
	}


	// From: Req22Batch130Amount250
	if ((var_1_24 / var_1_22) <= var_1_20) {
		var_1_75 = 4.5f;
	}


	// From: Req23Batch130Amount250
	...
	if ((var_1_38 - var_1_62) < stepLocal_17) {
		if (stepLocal_18 < last_1_var_1_76) {
			var_1_76 = (max (var_1_30 , var_1_59));
		}
	} else {
		if (var_1_41) {
			var_1_76 = var_1_6;
	...
	// From: Req6Batch130Amount250
	unsigned long int stepLocal_6 = var_1_34;
	signed long int stepLocal_5 = var_1_8;
	if (stepLocal_5 < var_1_34) {
		if (var_1_5 >= stepLocal_6) {
			if (((max (var_1_25 , var_1_21)) * (- var_1_23)) < (15.5 - (var_1_24 + var_1_29))) {
				var_1_28 = (min ((min (0 , var_1_30)) , var_1_31));
			}
		} else {
			var_1_28 = var_1_31;
		}
	...
	// From: Req14Batch130Amount250
	if (! ((abs (var_1_76)) >= (var_1_76 - var_1_10))) {
		var_1_49 = (max ((10 - (max (var_1_50 , var_1_51))) , (var_1_52 + 25)));
	}


	// From: Req1Batch130Amount250
	...
	if (var_1_26) {
		if (var_1_72 != stepLocal_1) {
			...
			if (8.5f >= var_1_75) {
				var_1_1 = (max ((var_1_32 + (var_1_8 - var_1_7)) , var_1_6));
			} else {
				var_1_1 = (((var_1_10 - var_1_8) - var_1_7) - (var_1_6 + (max (var_1_11 , var_1_12))));
			}
		}
	} else {
		var_1_1 = (var_1_7 - (min ((var_1_6 + var_1_11) , var_1_5)));
	}


	// From: Req18Batch130Amount250
	...
	if ((~ var_1_40) >= stepLocal_14) {
		if (stepLocal_15 && var_1_46) {
			if ((! (var_1_32 < var_1_11)) || stepLocal_13) {
				var_1_64 = (min (var_1_37 , (var_1_51 + var_1_38)));
			} else {
				var_1_64 = (max (var_1_8 , (min (var_1_33 , (var_1_38 + 50u)))));
			}
		} else {
			var_1_64 = ((max ((var_1_10 + var_1_65) , var_1_35)) - (min ((var_1_11 + var_1_72) , var_1_1)));
		}
	}


	// From: Req15Batch130Amount250
	signed long int stepLocal_10 = - var_1_12;
	unsigned long int stepLocal_9 = max (var_1_16 , var_1_37);
	if (stepLocal_9 < (var_1_64 / var_1_38)) {
		var_1_53 = (abs (var_1_51));
	} else {
	...
	// From: Req16Batch130Amount250
	unsigned char stepLocal_11 = var_1_26;
	if (var_1_41 && stepLocal_11) {
		var_1_55 = ((max (last_1_var_1_55 , var_1_56)) + var_1_66);
	}
}
...
int property(void) {
	return ((((((((((((((((((((((var_1_26 ? ((var_1_72 != var_1_32) ? ((var_1_72 < var_1_32) ? (var_1_1 == ((signed long int) ((var_1_5 - (max (2 , var_1_6))) - 64))) : (var_1_1 == ((signed long int) ((var_1_6 - (var_1_7 - var_1_8)) + var_1_72)))) : ((8.5f >= var_1_75) ? (var_1_1 == ((signed long int) (max ((var_1_32 + (var_1_8 - var_1_7)) , var_1_6)))) : (var_1_1 == ((signed long int) (((var_1_10 - var_1_8) - var_1_7) - (var_1_6 + (max (var_1_11 , var_1_12)))))))) : (var_1_1 == ((signed long int) (var_1_7 - (min ((var_1_6 + var_1_11) , var_1_5)))))) && ((var_1_72 == var_1_6) ? ((var_1_14 || var_1_2) ? (var_1_13 == ((signed short int) (min (-32 , var_1_15)))) : 1) : 1)) && ((var_1_44 && var_1_41) ? (var_1_44 ? (var_1_16 == ((unsigned long int) (abs (var_1_5)))) : (var_1_16 == ((unsigned long int) (abs ((3507549886u - var_1_11) - 256u))))) : 1)) && (var_1_44 ? ((var_1_11 > var_1_72) ? (var_1_17 == ((double) (var_1_19 + var_1_20))) : ((! var_1_26) ? (var_1_17 == ((double) ((var_1_21 - (var_1_22 - var_1_23)) + var_1_20))) : (var_1_17 == ((double) (var_1_21 - 7.4))))) : (var_1_17 == ((double) (((var_1_23 + var_1_24) + var_1_25) - var_1_21))))) && ((last_1_var_1_26 || (var_1_41 && var_1_44)) ? (var_1_26 == ((unsigned char) (var_1_44 && var_1_27))) : 1)) && ((var_1_8 < var_1_34) ? ((var_1_5 >= var_1_34) ? ((((max (var_1_25 , var_1_21)) * (- var_1_23)) < (15.5 - (var_1_24 + var_1_29))) ? (var_1_28 == ((unsigned char) (min ((min (0 , var_1_30)) , var_1_31)))) : 1) : (var_1_28 == ((unsigned char) var_1_31))) : (var_1_28 == ((unsigned char) var_1_30)))) && ((var_1_29 <= var_1_19) ? (var_1_32 == ((signed short int) ((min (var_1_13 , (var_1_30 + var_1_31))) + -16))) : ((var_1_6 < var_1_39) ? (var_1_32 == ((signed short int) ((var_1_33 - var_1_31) - var_1_13))) : (var_1_32 == ((signed short int) (var_1_13 - var_1_31)))))) && (var_1_34 == ((unsigned long int) (var_1_35 - var_1_7)))) && (var_1_36 == ((unsigned short int) (var_1_33 + (var_1_37 - (var_1_38 - var_1_31)))))) && (((max (var_1_38 , (1 * var_1_5))) != 2) ? (var_1_39 == ((signed short int) (var_1_31 + ((min (last_1_var_1_39 , var_1_30)) + var_1_40)))) : (var_1_39 == ((signed short int) (abs (var_1_33)))))) && ((last_1_var_1_75 < var_1_29) ? (var_1_41 == ((unsigned char) ((var_1_7 > last_1_var_1_64) && (var_1_42 || (var_1_27 && var_1_43))))) : 1)) && ((var_1_24 <= var_1_21) ? (((var_1_11 * (var_1_37 + var_1_72)) != (128 / var_1_33)) ? (var_1_44 == ((unsigned char) (var_1_45 && var_1_46))) : (var_1_44 == ((unsigned char) (! var_1_27)))) : 1)) && (((min ((var_1_24 - var_1_22) , (var_1_19 * var_1_20))) <= var_1_29) ? (var_1_47 == ((unsigned short int) (min (var_1_48 , (abs (var_1_13)))))) : (var_1_47 == ((unsigned short int) (4 + (var_1_30 + (var_1_13 + var_1_31))))))) && ((! ((abs (var_1_76)) >= (var_1_76 - var_1_10))) ? (var_1_49 == ((signed char) (max ((10 - (max (var_1_50 , var_1_51))) , (var_1_52 + 25))))) : 1)) && (((max (var_1_16 , var_1_37)) < (var_1_64 / var_1_38)) ? (var_1_53 == ((unsigned char) (abs (var_1_51)))) : (((- var_1_12) == var_1_31) ? (var_1_26 ? (var_1_53 == ((unsigned char) var_1_54)) : 1) : 1))) && ((var_1_41 && var_1_26) ? (var_1_55 == ((signed long int) ((max (last_1_var_1_55 , var_1_56)) + var_1_66))) : 1)) && ((var_1_24 == (var_1_22 - (var_1_29 + var_1_21))) ? ((var_1_6 >= (1 + (min (-64 , var_1_12)))) ? (var_1_57 == ((signed char) (max (((max (var_1_52 , var_1_58)) + var_1_59) , (var_1_60 + var_1_61))))) : (var_1_57 == ((signed char) (var_1_61 + 32)))) : (var_1_57 == ((signed char) (min ((1 - (var_1_62 + var_1_63)) , (min (var_1_60 , var_1_52)))))))) && (((~ var_1_40) >= (var_1_6 & var_1_33)) ? ((((var_1_12 < var_1_51) && var_1_43) && var_1_46) ? (((! (var_1_32 < var_1_11)) || (var_1_16 != var_1_58)) ? (var_1_64 == ((unsigned long int) (min (var_1_37 , (var_1_51 + var_1_38))))) : (var_1_64 == ((unsigned long int) (max (var_1_8 , (min (var_1_33 , (var_1_38 + 50u)))))))) : (var_1_64 == ((unsigned long int) ((max ((var_1_10 + var_1_65) , var_1_35)) - (min ((var_1_11 + var_1_72) , var_1_1)))))) : 1)) && ((var_1_21 >= var_1_22) ? ((((25u * var_1_7) / var_1_5) != var_1_64) ? (var_1_66 == ((unsigned char) (var_1_67 - var_1_62))) : (var_1_66 == ((unsigned char) 4))) : (var_1_66 == ((unsigned char) (((var_1_68 - var_1_69) + (var_1_70 - var_1_71)) + (var_1_63 + var_1_62)))))) && ((var_1_29 < var_1_20) ? (last_1_var_1_26 ? (var_1_72 == ((unsigned long int) (min (((var_1_73 - var_1_38) - var_1_12) , var_1_68)))) : (var_1_72 == ((unsigned long int) var_1_68))) : 1)) && (var_1_43 ? (var_1_74 == ((unsigned char) var_1_62)) : 1)) && (((var_1_24 / var_1_22) <= var_1_20) ? (var_1_75 == ((float) 4.5f)) : 1)) && (((var_1_38 - var_1_62) < var_1_72) ? ((var_1_52 < last_1_var_1_76) ? (var_1_76 == ((signed long int) (max (var_1_30 , var_1_59)))) : 1) : (var_1_41 ? (var_1_76 == ((signed long int) var_1_6)) : 1))
;
}
int main(void) {
	isInitial = 1;
