...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch18750_1loop.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_2) {
  var_1_9 = ((((((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11)))) > (var_1_12)) ? (((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11)))) : (var_1_12)));
 }
