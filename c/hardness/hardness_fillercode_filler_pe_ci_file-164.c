...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch164Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 262L, 53L) */ if (/* 263L, 37L, 38L) */ ((127.5f) > (/* 265L, 36L, 40L) */ (- (var_1_11))))) {
		/* 267L, 52L) */ var_1_31 = (
			/* 270L, 51L) */ (min (
				/* 270L, 51L) */ (
					var_1_33
	...
	// From: CodeObject3
	/* 279L, 106L) */ if (/* 280L, 69L, 70L) */ ((/* 281L, 67L, 71L) */ ((var_1_21) / (var_1_30))) >= (var_1_33))) {
		/* 285L, 94L) */ if (/* 286L, 82L, 83L) */ ((var_1_25) || (var_1_15))) {
			/* 289L, 93L) */ var_1_37 = (
				/* 292L, 92L) */ (abs (
					var_1_7
				))
	...
	// From: CodeObject4
	/* 304L, 138L) */ if (/* 305L, 115L, 116L) */ ((var_1_18) > (/* 307L, 114L, 118L) */ (abs (/* 308L, 113L, 119L) */ (max (/* 308L, 113L, 119L) */ (var_1_7) , (var_1_23)))))))) {
		/* 311L, 133L) */ var_1_45 = (
			/* 314L, 132L) */ ((
				var_1_48
			) - (
	...
	// From: CodeObject5
	/* 322L, 198L) */ if (/* 323L, 155L, 156L) */ ((var_1_11) <= (/* 325L, 154L, 158L) */ (max (/* 325L, 154L, 158L) */ (var_1_36) , (var_1_48)))))) {
		/* 328L, 196L) */ if (/* 329L, 171L, 172L) */ ((/* 330L, 168L, 173L) */ ((var_1_22) - (16))) <= (/* 333L, 170L, 176L) */ (abs (var_1_34))))) {
			/* 335L, 195L) */ var_1_50 = (
				/* 338L, 194L) */ (min (
					/* 338L, 194L) */ (
						/* 339L, 192L) */ ((
	...
	// From: CodeObject7
	/* 356L, 260L) */ if (/* 357L, 219L, 220L) */ ((var_1_7) >= (var_1_22))) {
		/* 360L, 234L) */ var_1_57 = (
			/* 363L, 233L) */ (min (
				/* 363L, 233L) */ (
					/* 364L, 229L) */ (abs (
		...
		/* 369L, 258L) */ if (/* 370L, 239L, 240L) */ ((/* 371L, 237L, 241L) */ ((var_1_19) / (var_1_30))) < (var_1_33))) {
			/* 375L, 253L) */ var_1_57 = (
				var_1_7
			);
		} else {
