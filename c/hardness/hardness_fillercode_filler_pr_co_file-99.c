...
void step(void) {
	...
	// From: CodeObject4
	/* 262L, 86L) */ if (/* 263L, 55L, 56L) */ ((var_1_6) < (/* 265L, 54L, 58L) */ ((var_1_33) * (var_1_26))))) {
		/* 268L, 84L) */ if (/* 269L, 68L, 69L) */ ((var_1_6) <= (var_1_26))) {
			/* 272L, 79L) */ var_1_35 = (
				/* 275L, 78L) */ (abs (
					var_1_32
				))
	...
	// From: CodeObject10
	/* 341L, 206L) */ if (/* 342L, 191L, 192L) */ ((var_1_26) < (var_1_30))) {
		/* 345L, 205L) */ var_1_44 = (
			/* 348L, 204L) */ (min (
				/* 348L, 204L) */ (
					var_1_33
	...
	// From: CodeObject8
	/* 307L, 156L) */ if (/* 308L, 131L, 132L) */ ((var_1_6) > (var_1_30))) {
		/* 311L, 146L) */ var_1_41 = (
			/* 314L, 145L) */ (max (
				/* 314L, 145L) */ (
					/* 315L, 142L) */ (min (
	...
	// From: CodeObject9
	/* 329L, 179L) */ if (/* 330L, 164L, 165L) */ ((var_1_26) <= (var_1_33))) {
		/* 333L, 178L) */ var_1_42 = (
			/* 336L, 177L) */ (abs (
				/* 337L, 176L) */ (abs (
					/* 338L, 175L) */ ((
...
int property(void) {
	...
	if (/* 398L, 43L, 49L, 401L, 426L, 988L) */ ((var_1_9) < (/* 400L, 42L, 51L, 403L, 428L, 990L) */ ((var_1_6) * (var_1_8))))) {
		if (var_1_3) {
			if (/* 406L, 59L, 63L, 409L, 434L, 996L) */ ((var_1_9) <= (var_1_6))) {
			}
		}
	} else {
	}
	if (/* 421L, 92L, 96L, 493L, 515L, 1011L) */ ((var_1_12) != (var_1_24))) {
	} else {
		if (/* 429L, 109L, 114L, 501L, 523L, 1019L) */ ((/* 430L, 107L, 115L, 502L, 524L, 1020L) */ (- (var_1_6))) > (var_1_14))) {
		} else {
		}
	}
	if (/* 443L, 135L, 138L, 561L, 573L, 1033L) */ (! (var_1_5))) {
	}
	if (/* 471L, 178L, 184L, 687L, 706L, 1061L) */ ((var_1_23) >= (/* 473L, 177L, 186L, 689L, 708L, 1063L) */ ((var_1_20) ^ (var_1_28))))) {
	}
	if (var_1_1) {
	}
	return /* 517L) */ ((
	/* 516L) */ ((
		/* 515L) */ ((
			/* 514L) */ ((
				/* 513L) */ ((
					/* 512L) */ ((
						/* 511L) */ ((
							/* 510L) */ ((
								/* 368L, 20L, 274L, 291L, 958L) */ ((
									var_1_2
								) ? (
									/* 370L, 10L, 276L, 293L, 960L) */ ((
										var_1_1
									) == (
										/* 370L, 10L, 276L, 293L, 960L) */ ((unsigned char) (
											/* 373L, 9L, 279L, 296L, 963L) */ ((
												var_1_3
											) || (
												var_1_4
											))
									...
									/* 376L, 18L, 282L, 299L, 966L) */ ((
										var_1_1
									) == (
										/* 376L, 18L, 282L, 299L, 966L) */ ((unsigned char) (
											/* 379L, 17L, 285L, 302L, 969L) */ ((
												var_1_3
											) || (
												/* 381L, 16L, 287L, 304L, 971L) */ ((
													var_1_4
												) || (
													var_1_5
												))
								...
								/* 386L, 32L, 329L, 339L, 976L) */ ((
									var_1_6
								) == (
									/* 386L, 32L, 329L, 339L, 976L) */ ((signed long int) (
										/* 389L, 31L, 332L, 342L, 979L) */ ((
											/* 390L, 29L, 333L, 343L, 980L) */ ((
												var_1_7
											) - (
												var_1_8
											))
							...
							/* 397L, 81L, 400L, 425L, 987L) */ ((
								/* 398L, 43L, 49L, 401L, 426L, 988L) */ ((
									var_1_9
								) < (
									/* 400L, 42L, 51L, 403L, 428L, 990L) */ ((
										var_1_6
									) * (
										var_1_8
									))
								...
								/* 403L, 75L, 406L, 431L, 993L) */ ((
									var_1_3
								) ? (
									/* 405L, 73L, 408L, 433L, 995L) */ ((
										/* 406L, 59L, 63L, 409L, 434L, 996L) */ ((
											var_1_9
										) <= (
											var_1_6
										))
									) ? (
										/* 409L, 71L, 412L, 437L, 999L) */ ((
											var_1_10
										) == (
											/* 409L, 71L, 412L, 437L, 999L) */ ((double) (
												/* 412L, 70L, 415L, 440L, 1002L) */ ((
													var_1_11
												) - (
													var_1_12
												))
								...
								/* 415L, 79L, 418L, 443L, 1005L) */ ((
									var_1_10
								) == (
									/* 415L, 79L, 418L, 443L, 1005L) */ ((double) (
										var_1_12
									))
								))
							))
						...
						/* 420L, 129L, 492L, 514L, 1010L) */ ((
							/* 421L, 92L, 96L, 493L, 515L, 1011L) */ ((
								var_1_12
							) != (
								var_1_24
							))
						) ? (
							/* 424L, 102L, 496L, 518L, 1014L) */ ((
								var_1_13
							) == (
								/* 424L, 102L, 496L, 518L, 1014L) */ ((unsigned char) (
									var_1_14
								))
							))
						) : (
							/* 428L, 127L, 500L, 522L, 1018L) */ ((
								/* 429L, 109L, 114L, 501L, 523L, 1019L) */ ((
									/* 430L, 107L, 115L, 502L, 524L, 1020L) */ (- (
										var_1_6
									))
								) > (
									var_1_14
								...
								/* 433L, 121L, 505L, 527L, 1023L) */ ((
									var_1_13
								) == (
									/* 433L, 121L, 505L, 527L, 1023L) */ ((unsigned char) (
										var_1_14
									))
								))
							) : (
								/* 437L, 125L, 509L, 531L, 1027L) */ ((
									var_1_13
								) == (
									/* 437L, 125L, 509L, 531L, 1027L) */ ((unsigned char) (
										25
									))
								))
							))
					...
					/* 442L, 149L, 560L, 572L, 1032L) */ ((
						/* 443L, 135L, 138L, 561L, 573L, 1033L) */ (! (
							var_1_5
						))
					) ? (
						/* 445L, 147L, 563L, 575L, 1035L) */ ((
							var_1_15
						) == (
							/* 445L, 147L, 563L, 575L, 1035L) */ ((unsigned char) (
								/* 448L, 146L, 566L, 578L, 1038L) */ (max (
									/* 448L, 146L, 566L, 578L, 1038L) */ (
										/* 449L, 144L, 567L, 579L, 1039L) */ ((
											var_1_16
										) + (
											var_1_17
										))
				...
				/* 457L, 165L, 619L, 635L, 1047L) */ ((
					var_1_18
				) == (
					/* 457L, 165L, 619L, 635L, 1047L) */ ((signed char) (
						/* 460L, 164L, 622L, 638L, 1050L) */ (max (
							/* 460L, 164L, 622L, 638L, 1050L) */ (
								/* 461L, 160L, 623L, 639L, 1051L) */ ((
									/* 462L, 158L, 624L, 640L, 1052L) */ ((
										var_1_19
									) - (
										var_1_20
									))
			...
			/* 470L, 202L, 686L, 705L, 1060L) */ ((
				/* 471L, 178L, 184L, 687L, 706L, 1061L) */ ((
					var_1_23
				) >= (
					/* 473L, 177L, 186L, 689L, 708L, 1063L) */ ((
						var_1_20
					) ^ (
						var_1_28
					))
				...
				/* 476L, 200L, 692L, 711L, 1066L) */ ((
					var_1_24
				) == (
					/* 476L, 200L, 692L, 711L, 1066L) */ ((double) (
						/* 479L, 199L, 695L, 714L, 1069L) */ (max (
							/* 479L, 199L, 695L, 714L, 1069L) */ (
								/* 480L, 193L, 696L, 715L, 1070L) */ (min (
									/* 480L, 193L, 696L, 715L, 1070L) */ (
										var_1_12
									) , (
										var_1_11
									)
								...
								/* 483L, 198L, 699L, 718L, 1073L) */ ((
									/* 484L, 196L, 700L, 719L, 1074L) */ ((
										var_1_25
									) - (
										25.5
									))
		...
		/* 491L, 223L, 756L, 771L, 1081L) */ ((
			var_1_1
		) ? (
			/* 493L, 221L, 758L, 773L, 1083L) */ ((
				var_1_26
			) == (
				/* 493L, 221L, 758L, 773L, 1083L) */ ((unsigned short int) (
					/* 496L, 220L, 761L, 776L, 1086L) */ (min (
						/* 496L, 220L, 761L, 776L, 1086L) */ (
							/* 497L, 216L, 762L, 777L, 1087L) */ (min (
								/* 497L, 216L, 762L, 777L, 1087L) */ (
									var_1_15
								) , (
									var_1_14
								)
	...
	/* 505L, 235L, 797L, 803L, 1095L) */ ((
		var_1_28
	) == (
		/* 505L, 235L, 797L, 803L, 1095L) */ ((unsigned char) (
			var_1_16
		))
	))
))
