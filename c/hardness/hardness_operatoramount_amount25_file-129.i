...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch129Amount25.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (! var_1_6) {
  var_1_7 = (((((((((var_1_8) < (var_1_9)) ? (var_1_8) : (var_1_9))) - var_1_10)) > ((128 - var_1_11))) ? ((((((var_1_8) < (var_1_9)) ? (var_1_8) : (var_1_9))) - var_1_10)) : ((128 - var_1_11))));
 } else {
  var_1_7 = var_1_9;
 }
