...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((((*(WrapperStruct00_var_1_4_Pointer)) >= (*(WrapperStruct00_var_1_12_Pointer))) && (*(WrapperStruct00_var_1_2_Pointer))) && (*(WrapperStruct00_var_1_3_Pointer))) {
