...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17550_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch17550_1loop
	var_1_5 = (! (var_1_6 && var_1_7));


	// From: Req5Batch17550_1loop
	...
	// From: Req6Batch17550_1loop
	var_1_20 = (var_1_18 + (max ((var_1_19 - 5.9f) , var_1_21)));


	// From: Req7Batch17550_1loop
	if (((var_1_3 >> var_1_23) + var_1_1) < (min (var_1_4 , var_1_2))) {
		var_1_22 = ((min (var_1_23 , (var_1_1 + var_1_24))) + ((var_1_25 - var_1_26) - var_1_27));
	} else {
		if (var_1_1 <= var_1_26) {
			var_1_22 = 128;
		}
	...
	// From: Req8Batch17550_1loop
	var_1_28 = var_1_2;


	// From: Req3Batch17550_1loop
	if ((var_1_20 * (var_1_15 + var_1_20)) > var_1_20) {
		var_1_8 = var_1_7;
	}


	// From: Req4Batch17550_1loop
	var_1_13 = (((var_1_2 * var_1_4) > var_1_28) && (! var_1_6));
}
...
int property(void) {
	return ((((((((((var_1_2 - var_1_3) - var_1_4) > 2) ? ((var_1_2 < var_1_3) ? (var_1_1 == ((unsigned short int) (32 + var_1_3))) : 1) : 1) && (var_1_5 == ((unsigned char) (! (var_1_6 && var_1_7))))) && (((var_1_20 * (var_1_15 + var_1_20)) > var_1_20) ? (var_1_8 == ((unsigned char) var_1_7)) : 1)) && (var_1_13 == ((unsigned char) (((var_1_2 * var_1_4) > var_1_28) && (! var_1_6))))) && (((var_1_2 & var_1_3) > var_1_4) ? ((var_1_1 > var_1_3) ? (var_1_15 == ((float) (var_1_17 - (var_1_18 + var_1_19)))) : 1) : (var_1_15 == ((float) (var_1_19 + var_1_18))))) && (var_1_20 == ((float) (var_1_18 + (max ((var_1_19 - 5.9f) , var_1_21)))))) && ((((var_1_3 >> var_1_23) + var_1_1) < (min (var_1_4 , var_1_2))) ? (var_1_22 == ((signed short int) ((min (var_1_23 , (var_1_1 + var_1_24))) + ((var_1_25 - var_1_26) - var_1_27)))) : ((var_1_1 <= var_1_26) ? (var_1_22 == ((signed short int) 128)) : 1))) && (var_1_28 == ((signed long int) var_1_2))
;
}
int main(void) {
	isInitial = 1;
