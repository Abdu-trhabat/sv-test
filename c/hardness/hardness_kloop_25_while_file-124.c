...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12425_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch12425_while
	var_1_15 = var_1_16;


	// From: Req2Batch12425_while
