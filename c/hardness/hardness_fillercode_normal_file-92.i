...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch92normal.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_21) {
  var_1_16 = (var_1_13 - ((var_1_17 - var_1_18) + (var_1_19 - var_1_20)));
 } else {
  var_1_16 = var_1_18;
 }
}
...
int property(void) {
 return (((((((((var_1_12 == var_1_23) && (var_1_4 >= var_1_5)) ? (var_1_21 ? (var_1_21 ? (var_1_1 == ((unsigned short int) ((((var_1_8) < (var_1_9)) ? (var_1_8) : (var_1_9))))) : (var_1_1 == ((unsigned short int) ((((var_1_9) > (var_1_8)) ? (var_1_9) : (var_1_8)))))) : (var_1_1 == ((unsigned short int) (((((46167) > (var_1_10)) ? (46167) : (var_1_10))) - var_1_11)))) : (var_1_1 == ((unsigned short int) var_1_10))) && (((((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))) >> var_1_13) >= ((((last_1_var_1_12) > (var_1_9)) ? (last_1_var_1_12) : (var_1_9)))) ? (var_1_12 == ((unsigned long int) var_1_8)) : 1)) && ((var_1_13 >= var_1_11) ? (var_1_14 == ((unsigned long int) (var_1_13 + var_1_11))) : ((var_1_5 != (var_1_4 / var_1_15)) ? (var_1_21 ? (var_1_14 == ((unsigned long int) var_1_11)) : (var_1_14 == ((unsigned long int) var_1_10))) : (var_1_14 == ((unsigned long int) var_1_11))))) && (var_1_21 ? (var_1_16 == ((signed short int) (var_1_13 - ((var_1_17 - var_1_18) + (var_1_19 - var_1_20))))) : (var_1_16 == ((signed short int) var_1_18)))) && (((1.00000000000005E13f == var_1_15) || var_1_25) ? ((var_1_4 > ((((var_1_5) > (var_1_15)) ? (var_1_5) : (var_1_15)))) ? (var_1_21 == ((unsigned char) var_1_22)) : (var_1_21 == ((unsigned char) 1))) : (var_1_21 == ((unsigned char) 0)))) && (var_1_23 == ((unsigned long int) var_1_13))) && (var_1_24 == ((signed long int) var_1_8))) && (var_1_25 == ((unsigned char) var_1_22))
;
}
int main(void) {
 isInitial = 1;
