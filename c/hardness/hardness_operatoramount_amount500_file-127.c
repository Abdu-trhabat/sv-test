...
void step(void) {
	// From: Req20Batch127Amount500
	unsigned char stepLocal_21 = var_1_58;
	unsigned long int stepLocal_20 = max (last_1_var_1_24 , var_1_36);
		...
		if (last_1_var_1_82 < stepLocal_20) {
			if ((var_1_27 ^ var_1_32) == stepLocal_19) {
				if ((! (last_1_var_1_47 != var_1_49)) && stepLocal_21) {
					var_1_56 = ((max (var_1_50 , var_1_36)) - (last_1_var_1_1 + var_1_6));
				} else {
					var_1_56 = var_1_36;
				}
			} else {
				if (last_1_var_1_90 < var_1_15) {
					...
					if (var_1_34 || stepLocal_18) {
						...
						if (! (var_1_15 >= (var_1_19 * last_1_var_1_91))) {
							...
							var_1_56 = (min (last_1_var_1_72 , var_1_59));
						}
					}
				}
			}
	...
	// From: Req15Batch127Amount500
	unsigned long int stepLocal_14 = var_1_28;
	if (stepLocal_14 == var_1_6) {
		var_1_43 = (min ((last_1_var_1_71 + last_1_var_1_56) , last_1_var_1_41));
	}


	// From: Req7Batch127Amount500
	signed long int stepLocal_2 = 64 << (var_1_27 + var_1_28);
	if ((var_1_19 * (var_1_23 + last_1_var_1_13)) > ((var_1_17 + var_1_25) - 16.5)) {
		if ((max (var_1_23 , var_1_19)) <= last_1_var_1_13) {
			var_1_24 = (min (var_1_9 , var_1_7));
		} else {
			var_1_24 = (max (last_1_var_1_31 , var_1_6));
		}
	} else {
		if ((max ((var_1_26 - last_1_var_1_31) , var_1_6)) < stepLocal_2) {
			var_1_24 = (var_1_28 + 32u);
		}
	}


	// From: Req19Batch127Amount500
	if (var_1_52 && var_1_11) {
		if (last_1_var_1_85 > ((var_1_9 + last_1_var_1_38) * last_1_var_1_24)) {
			var_1_51 = var_1_53;
		} else {
			if ((min (var_1_16 , var_1_19)) == var_1_20) {
				var_1_51 = var_1_54;
			} else {
	...
	// From: Req24Batch127Amount500
	if (var_1_54) {
		var_1_65 = (var_1_51 || var_1_55);
	}


	// From: Req27Batch127Amount500
	if (var_1_65) {
		var_1_71 = (-128 + var_1_70);
	}


	// From: Req34Batch127Amount500
	if (var_1_65) {
		var_1_87 = var_1_37;
	} else {
	...
	// From: Req40Batch127Amount500
	if (var_1_51) {
		var_1_93 = var_1_30;
	}


	// From: Req4Batch127Amount500
	var_1_13 = ((max (var_1_14 , var_1_15)) - (var_1_16 - var_1_17));


	// From: Req5Batch127Amount500
	...
	// From: Req21Batch127Amount500
	var_1_61 = (max (last_1_var_1_61 , var_1_36));


	// From: Req25Batch127Amount500
	if ((var_1_49 - var_1_37) >= (var_1_41 * var_1_9)) {
		var_1_66 = (abs (var_1_6));
	} else {
		var_1_66 = var_1_28;
	}


	// From: Req31Batch127Amount500
	if ((var_1_15 * (var_1_19 - var_1_20)) >= var_1_30) {
		var_1_83 = ((abs (var_1_74)) - var_1_36);
	}


	// From: Req35Batch127Amount500
	if (var_1_65) {
		var_1_88 = 25.5f;
	}


	// From: Req36Batch127Amount500
	if (var_1_65) {
		var_1_89 = var_1_69;
	} else {
		var_1_89 = var_1_27;
	...
	// From: Req37Batch127Amount500
	var_1_90 = var_1_20;


	// From: Req38Batch127Amount500
	var_1_91 = var_1_16;


	// From: Req41Batch127Amount500
	if (var_1_55) {
		var_1_94 = var_1_79;
	} else {
		var_1_94 = -8;
	...
	// From: Req43Batch127Amount500
	if (var_1_65) {
		var_1_96 = var_1_30;
	}


	// From: Req44Batch127Amount500
	if (var_1_53) {
		var_1_97 = -32;
	} else {
		var_1_97 = -50;
	...
	// From: Req46Batch127Amount500
	var_1_99 = var_1_75;


	// From: Req47Batch127Amount500
	var_1_100 = var_1_69;


	// From: Req30Batch127Amount500
	var_1_82 = (min (((min (2u , 1000000000u)) + var_1_61) , var_1_43));


	// From: Req11Batch127Amount500
	if ((last_1_var_1_38 / var_1_12) > (var_1_82 * var_1_41)) {
		if (var_1_14 < (abs (var_1_15))) {
			if (var_1_93 <= var_1_19) {
				var_1_38 = var_1_37;
			} else {
				var_1_38 = ((max (var_1_41 , var_1_6)) + 8);
			}
		} else {
	...
	// From: Req2Batch127Amount500
	if (((var_1_9 - var_1_82) - var_1_6) < var_1_41) {
		var_1_8 = var_1_7;
	} else {
		if (-128 < var_1_41) {
			var_1_8 = (var_1_7 - (var_1_82 + (max (var_1_6 , 32))));
		} else {
			var_1_8 = (min (var_1_82 , var_1_9));
		}
	}


	// From: Req1Batch127Amount500
	if (! var_1_51) {
		if ((4 + var_1_87) >= (min (var_1_24 , var_1_43))) {
			var_1_1 = ((var_1_87 + var_1_6) - var_1_7);
		} else {
			var_1_1 = (var_1_7 - 2);
		}
	} else {
		var_1_1 = (abs (var_1_87));
	}


	// From: Req18Batch127Amount500
	if ((var_1_61 * (min (var_1_99 , 4u))) > (var_1_48 - 32u)) {
		if (var_1_8 > 4) {
			var_1_47 = (var_1_49 - (var_1_50 - var_1_28));
		} else {
			var_1_47 = (min ((var_1_49 - var_1_36) , var_1_28));
		}
	} else {
		if (32 <= var_1_24) {
			var_1_47 = (var_1_36 + (var_1_50 - (abs (var_1_27))));
		}
	}


	// From: Req9Batch127Amount500
	if (var_1_38 > var_1_12) {
		var_1_31 = (min ((max (var_1_9 , var_1_7)) , (max (var_1_6 , var_1_28))));
	}


	// From: Req33Batch127Amount500
	if ((var_1_17 - var_1_20) < (var_1_30 / (max (var_1_16 , var_1_19)))) {
		var_1_85 = (min ((max (var_1_81 , (var_1_86 - var_1_71))) , var_1_49));
	} else {
		var_1_85 = (var_1_7 + var_1_8);
	}


	// From: Req8Batch127Amount500
			...
			if (var_1_51) {
				...
				if ((~ 1u) < stepLocal_6) {
					if (stepLocal_7 || (var_1_93 > var_1_15)) {
						var_1_33 = (min ((var_1_28 + var_1_27) , 5));
					}
				} else {
					var_1_33 = ((abs (var_1_36)) - (min (var_1_28 , (var_1_27 + var_1_37))));
				}
			}
		}
	} else {
	...
	if (stepLocal_16 <= 128) {
		if (((var_1_25 + var_1_17) - var_1_14) >= var_1_91) {
			var_1_44 = (max (var_1_27 , var_1_7));
		}
	} else {
		if (((var_1_71 * var_1_24) & 256) != stepLocal_15) {
			if (var_1_15 >= var_1_91) {
				var_1_44 = (min (var_1_12 , (abs (var_1_7))));
			}
		} else {
	...
	// From: Req23Batch127Amount500
	signed short int stepLocal_22 = var_1_7;
	if (var_1_13 >= var_1_18) {
		if (stepLocal_22 < var_1_99) {
			var_1_64 = (var_1_6 + (max (var_1_37 , var_1_49)));
		}
	}


	// From: Req26Batch127Amount500
	if (((min (var_1_37 , 16)) >> (max (var_1_69 , var_1_70))) < (var_1_12 / var_1_60)) {
		var_1_68 = (max ((min ((min (var_1_70 , var_1_60)) , (var_1_94 + var_1_27))) , (max (var_1_37 , var_1_28))));
	}


	// From: Req39Batch127Amount500
	if (var_1_65) {
		var_1_92 = var_1_85;
	}


	// From: Req45Batch127Amount500
	if ((abs (min (var_1_69 , var_1_37))) <= (var_1_24 - (max (var_1_85 , var_1_68)))) {
		if ((var_1_64 > -8) && var_1_53) {
			var_1_98 = (min (var_1_49 , var_1_28));
		} else {
			var_1_98 = (min (var_1_37 , var_1_50));
		}
	} else {
	...
	if (var_1_40 <= stepLocal_23) {
		...
		if (stepLocal_24 <= ((var_1_41 + var_1_48) | (var_1_38 / var_1_49))) {
			if (stepLocal_25 < (var_1_60 + var_1_41)) {
				...
				var_1_72 = (max ((min (var_1_56 , (abs (var_1_12)))) , var_1_69));
			}
		} else {
			var_1_72 = ((min (var_1_76 , var_1_77)) - var_1_70);
		}
	}


	// From: Req3Batch127Amount500
	if (var_1_65) {
		if (var_1_51) {
			var_1_10 = (var_1_6 + ((abs (var_1_12)) - var_1_92));
		}
	} else {
	...
	// From: Req12Batch127Amount500
	signed long int stepLocal_11 = -10 + (min (var_1_71 , var_1_43));
	...
	if ((- var_1_17) < var_1_21) {
		if ((var_1_99 + var_1_72) < stepLocal_11) {
			if ((-10 * var_1_36) > stepLocal_9) {
				var_1_39 = ((min (var_1_37 , (max (var_1_40 , var_1_36)))) + 8);
			} else {
				var_1_39 = (var_1_36 + var_1_40);
			}
		} else {
			var_1_39 = (var_1_36 - (min (var_1_37 , 100)));
		}
	} else {
		if ((- var_1_32) <= stepLocal_10) {
			if (((var_1_15 - var_1_14) + (var_1_23 / var_1_19)) > ((var_1_25 + var_1_17) - (max (var_1_16 , var_1_20)))) {
				var_1_39 = ((abs (var_1_40)) + var_1_28);
			} else {
				var_1_39 = (max (5 , -64));
			}
		} else {
			if (stepLocal_8 > var_1_71) {
				var_1_39 = (max (-4 , var_1_40));
			} else {
				var_1_39 = ((min (var_1_36 , var_1_28)) - var_1_37);
			}
		}
	}


	// From: Req17Batch127Amount500
	if (var_1_13 > var_1_21) {
		var_1_46 = (max ((var_1_27 + var_1_37) , (var_1_28 + var_1_36)));
	}


	// From: Req22Batch127Amount500
	if ((max (var_1_13 , var_1_23)) == (var_1_22 * (var_1_17 - 199.8))) {
		if (var_1_51) {
			if (var_1_30 > var_1_25) {
				var_1_62 = var_1_6;
			} else {
				var_1_62 = (var_1_6 - (abs (var_1_46)));
			}
		} else {
			var_1_62 = (min ((var_1_37 + 128) , (var_1_50 + (max (var_1_40 , var_1_10)))));
		}
	} else {
		var_1_62 = ((min (var_1_7 , var_1_36)) - (var_1_6 + var_1_10));
	}


	// From: Req32Batch127Amount500
	if (! (var_1_82 == var_1_62)) {
		var_1_84 = (var_1_81 + var_1_37);
	}


	// From: Req29Batch127Amount500
	unsigned long int stepLocal_30 = 16u;
	unsigned long int stepLocal_29 = (min (var_1_85 , var_1_24)) & var_1_82;
	...
	if (stepLocal_26 >= var_1_99) {
		if (stepLocal_30 <= (var_1_49 * var_1_84)) {
			if ((- var_1_82) > stepLocal_27) {
				var_1_78 = (var_1_80 + (min (var_1_40 , var_1_79)));
			} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((! var_1_51) ? (((4 + var_1_87) >= (min (var_1_24 , var_1_43))) ? (var_1_1 == ((signed short int) ((var_1_87 + var_1_6) - var_1_7))) : (var_1_1 == ((signed short int) (var_1_7 - 2)))) : (var_1_1 == ((signed short int) (abs (var_1_87))))) && ((((var_1_9 - var_1_82) - var_1_6) < var_1_41) ? (var_1_8 == ((signed short int) var_1_7)) : ((-128 < var_1_41) ? (var_1_8 == ((signed short int) (var_1_7 - (var_1_82 + (max (var_1_6 , 32)))))) : (var_1_8 == ((signed short int) (min (var_1_82 , var_1_9))))))) && (var_1_65 ? (var_1_51 ? (var_1_10 == ((unsigned short int) (var_1_6 + ((abs (var_1_12)) - var_1_92)))) : 1) : (var_1_10 == ((unsigned short int) (var_1_7 + var_1_6))))) && (var_1_13 == ((double) ((max (var_1_14 , var_1_15)) - (var_1_16 - var_1_17))))) && ((((var_1_19 - 9.5f) - var_1_15) >= var_1_13) ? ((! var_1_65) ? ((1000000 > var_1_71) ? (var_1_18 == ((float) (var_1_16 - var_1_17))) : (var_1_18 == ((float) (var_1_20 - (min (var_1_16 , (max (var_1_14 , var_1_17)))))))) : 1) : 1)) && ((var_1_42 >= (max (2.7f , (31.4f * var_1_20)))) ? (((var_1_14 <= var_1_15) || var_1_65) ? (var_1_21 == ((double) ((var_1_22 + var_1_23) + var_1_17))) : (var_1_21 == ((double) (max (var_1_20 , var_1_15))))) : (var_1_21 == ((double) (var_1_14 - var_1_16))))) && (((var_1_19 * (var_1_23 + last_1_var_1_13)) > ((var_1_17 + var_1_25) - 16.5)) ? (((max (var_1_23 , var_1_19)) <= last_1_var_1_13) ? (var_1_24 == ((unsigned long int) (min (var_1_9 , var_1_7)))) : (var_1_24 == ((unsigned long int) (max (last_1_var_1_31 , var_1_6))))) : (((max ((var_1_26 - last_1_var_1_31) , var_1_6)) < (64 << (var_1_27 + var_1_28))) ? (var_1_24 == ((unsigned long int) (var_1_28 + 32u))) : 1))) && ((-1 < var_1_43) ? ((var_1_43 > (var_1_71 + var_1_61)) ? ((var_1_28 < var_1_85) ? (var_1_29 == ((double) var_1_23)) : (var_1_29 == ((double) var_1_15))) : (var_1_29 == ((double) var_1_14))) : (var_1_29 == ((double) var_1_30)))) && ((var_1_38 > var_1_12) ? (var_1_31 == ((signed short int) (min ((max (var_1_9 , var_1_7)) , (max (var_1_6 , var_1_28)))))) : 1)) && (var_1_65 ? (((16.5f * var_1_15) > (- (var_1_29 + var_1_20))) ? (var_1_51 ? (var_1_33 == ((signed char) (10 + var_1_28))) : (((~ 1u) < (var_1_28 * var_1_6)) ? ((var_1_51 || (var_1_93 > var_1_15)) ? (var_1_33 == ((signed char) (min ((var_1_28 + var_1_27) , 5)))) : 1) : (var_1_33 == ((signed char) ((abs (var_1_36)) - (min (var_1_28 , (var_1_27 + var_1_37)))))))) : 1) : (var_1_33 == ((signed char) (var_1_27 - var_1_36))))) && (((last_1_var_1_38 / var_1_12) > (var_1_82 * var_1_41)) ? ((var_1_14 < (abs (var_1_15))) ? ((var_1_93 <= var_1_19) ? (var_1_38 == ((unsigned short int) var_1_37)) : (var_1_38 == ((unsigned short int) ((max (var_1_41 , var_1_6)) + 8)))) : ((var_1_43 <= var_1_27) ? (var_1_38 == ((unsigned short int) var_1_36)) : (var_1_38 == ((unsigned short int) var_1_27)))) : (var_1_38 == ((unsigned short int) var_1_37)))) && (((- var_1_17) < var_1_21) ? (((var_1_99 + var_1_72) < (-10 + (min (var_1_71 , var_1_43)))) ? (((-10 * var_1_36) > var_1_99) ? (var_1_39 == ((signed char) ((min (var_1_37 , (max (var_1_40 , var_1_36)))) + 8))) : (var_1_39 == ((signed char) (var_1_36 + var_1_40)))) : (var_1_39 == ((signed char) (var_1_36 - (min (var_1_37 , 100)))))) : (((- var_1_32) <= var_1_37) ? ((((var_1_15 - var_1_14) + (var_1_23 / var_1_19)) > ((var_1_25 + var_1_17) - (max (var_1_16 , var_1_20)))) ? (var_1_39 == ((signed char) ((abs (var_1_40)) + var_1_28))) : (var_1_39 == ((signed char) (max (5 , -64))))) : ((var_1_99 > var_1_71) ? (var_1_39 == ((signed char) (max (-4 , var_1_40)))) : (var_1_39 == ((signed char) ((min (var_1_36 , var_1_28)) - var_1_37))))))) && (var_1_51 ? ((var_1_9 <= var_1_37) ? (var_1_41 == ((signed long int) var_1_36)) : 1) : (var_1_41 == ((signed long int) (var_1_9 - var_1_28))))) && ((var_1_10 >= var_1_6) ? (var_1_42 == ((float) (min (var_1_22 , var_1_20)))) : ((((8 * 32) + (5 & var_1_83)) == (var_1_7 - var_1_28)) ? (var_1_42 == ((float) (max (var_1_23 , var_1_15)))) : 1))) && ((var_1_28 == var_1_6) ? (var_1_43 == ((signed long int) (min ((last_1_var_1_71 + last_1_var_1_56) , last_1_var_1_41)))) : 1)) && (((var_1_7 / var_1_9) <= 128) ? ((((var_1_25 + var_1_17) - var_1_14) >= var_1_91) ? (var_1_44 == ((unsigned short int) (max (var_1_27 , var_1_7)))) : 1) : ((((var_1_71 * var_1_24) & 256) != var_1_99) ? ((var_1_15 >= var_1_91) ? (var_1_44 == ((unsigned short int) (min (var_1_12 , (abs (var_1_7)))))) : 1) : (var_1_44 == ((unsigned short int) (50 + ((var_1_28 + 128) + var_1_6))))))) && ((var_1_13 > var_1_21) ? (var_1_46 == ((unsigned char) (max ((var_1_27 + var_1_37) , (var_1_28 + var_1_36))))) : 1)) && (((var_1_61 * (min (var_1_99 , 4u))) > (var_1_48 - 32u)) ? ((var_1_8 > 4) ? (var_1_47 == ((unsigned char) (var_1_49 - (var_1_50 - var_1_28)))) : (var_1_47 == ((unsigned char) (min ((var_1_49 - var_1_36) , var_1_28))))) : ((32 <= var_1_24) ? (var_1_47 == ((unsigned char) (var_1_36 + (var_1_50 - (abs (var_1_27)))))) : 1))) && ((var_1_52 && var_1_11) ? ((last_1_var_1_85 > ((var_1_9 + last_1_var_1_38) * last_1_var_1_24)) ? (var_1_51 == ((unsigned char) var_1_53)) : (((min (var_1_16 , var_1_19)) == var_1_20) ? (var_1_51 == ((unsigned char) var_1_54)) : (var_1_51 == ((unsigned char) (var_1_11 || (var_1_53 || (! var_1_54))))))) : (var_1_51 == ((unsigned char) (! (var_1_53 && var_1_55)))))) && (((var_1_32 % var_1_49) <= (var_1_36 + last_1_var_1_82)) ? ((last_1_var_1_82 < (max (last_1_var_1_24 , var_1_36))) ? (((var_1_27 ^ var_1_32) == var_1_12) ? (((! (last_1_var_1_47 != var_1_49)) && var_1_58) ? (var_1_56 == ((signed short int) ((max (var_1_50 , var_1_36)) - (last_1_var_1_1 + var_1_6)))) : (var_1_56 == ((signed short int) var_1_36))) : ((last_1_var_1_90 < var_1_15) ? (var_1_56 == ((signed short int) (var_1_49 - var_1_28))) : ((var_1_34 || last_1_var_1_51) ? (var_1_56 == ((signed short int) ((var_1_60 - var_1_37) - 16))) : ((! (var_1_15 >= (var_1_19 * last_1_var_1_91))) ? (var_1_56 == ((signed short int) (last_1_var_1_72 + last_1_var_1_87))) : (var_1_56 == ((signed short int) (min (last_1_var_1_72 , var_1_59)))))))) : 1) : (var_1_56 == ((signed short int) var_1_36)))) && (var_1_61 == ((unsigned short int) (max (last_1_var_1_61 , var_1_36))))) && (((max (var_1_13 , var_1_23)) == (var_1_22 * (var_1_17 - 199.8))) ? (var_1_51 ? ((var_1_30 > var_1_25) ? (var_1_62 == ((signed short int) var_1_6)) : (var_1_62 == ((signed short int) (var_1_6 - (abs (var_1_46)))))) : (var_1_62 == ((signed short int) (min ((var_1_37 + 128) , (var_1_50 + (max (var_1_40 , var_1_10)))))))) : (var_1_62 == ((signed short int) ((min (var_1_7 , var_1_36)) - (var_1_6 + var_1_10)))))) && ((var_1_13 >= var_1_18) ? ((var_1_7 < var_1_99) ? (var_1_64 == ((signed short int) (var_1_6 + (max (var_1_37 , var_1_49))))) : 1) : 1)) && (var_1_54 ? (var_1_65 == ((unsigned char) (var_1_51 || var_1_55))) : 1)) && (((var_1_49 - var_1_37) >= (var_1_41 * var_1_9)) ? (var_1_66 == ((signed short int) (abs (var_1_6)))) : (var_1_66 == ((signed short int) var_1_28)))) && ((((min (var_1_37 , 16)) >> (max (var_1_69 , var_1_70))) < (var_1_12 / var_1_60)) ? (var_1_68 == ((unsigned short int) (max ((min ((min (var_1_70 , var_1_60)) , (var_1_94 + var_1_27))) , (max (var_1_37 , var_1_28)))))) : 1)) && (var_1_65 ? (var_1_71 == ((signed long int) (-128 + var_1_70))) : 1)) && ((var_1_40 <= (-4 % var_1_70)) ? (var_1_72 == ((unsigned short int) (((var_1_73 + var_1_74) + (var_1_75 - var_1_28)) - var_1_7))) : ((var_1_12 <= ((var_1_41 + var_1_48) | (var_1_38 / var_1_49))) ? (((var_1_49 | var_1_6) < (var_1_60 + var_1_41)) ? ((((var_1_19 - 127.4) - (var_1_17 + var_1_25)) > ((var_1_20 - 64.3) + var_1_30)) ? (var_1_72 == ((unsigned short int) var_1_73)) : (var_1_72 == ((unsigned short int) var_1_27))) : (var_1_72 == ((unsigned short int) (max ((min (var_1_56 , (abs (var_1_12)))) , var_1_69))))) : (var_1_72 == ((unsigned short int) ((min (var_1_76 , var_1_77)) - var_1_70)))))) && ((32u >= var_1_99) ? ((16u <= (var_1_49 * var_1_84)) ? (((- var_1_82) > var_1_75) ? (var_1_78 == ((signed char) (var_1_80 + (min (var_1_40 , var_1_79))))) : (((var_1_9 >> var_1_81) > ((min (var_1_85 , var_1_24)) & var_1_82)) ? (var_1_78 == ((signed char) var_1_69)) : (var_1_78 == ((signed char) var_1_70)))) : (var_1_78 == ((signed char) var_1_40))) : ((var_1_65 && (var_1_30 >= var_1_25)) ? (var_1_78 == ((signed char) (var_1_27 - var_1_69))) : 1))) && (var_1_82 == ((unsigned long int) (min (((min (2u , 1000000000u)) + var_1_61) , var_1_43))))) && (((var_1_15 * (var_1_19 - var_1_20)) >= var_1_30) ? (var_1_83 == ((signed short int) ((abs (var_1_74)) - var_1_36))) : 1)) && ((! (var_1_82 == var_1_62)) ? (var_1_84 == ((unsigned char) (var_1_81 + var_1_37))) : 1)) && (((var_1_17 - var_1_20) < (var_1_30 / (max (var_1_16 , var_1_19)))) ? (var_1_85 == ((unsigned long int) (min ((max (var_1_81 , (var_1_86 - var_1_71))) , var_1_49)))) : (var_1_85 == ((unsigned long int) (var_1_7 + var_1_8))))) && (var_1_65 ? (var_1_87 == ((signed short int) var_1_37)) : (var_1_87 == ((signed short int) last_1_var_1_87)))) && (var_1_65 ? (var_1_88 == ((float) 25.5f)) : 1)) && (var_1_65 ? (var_1_89 == ((unsigned char) var_1_69)) : (var_1_89 == ((unsigned char) var_1_27)))) && (var_1_90 == ((double) var_1_20))) && (var_1_91 == ((double) var_1_16))) && (var_1_65 ? (var_1_92 == ((unsigned short int) var_1_85)) : 1)) && (var_1_51 ? (var_1_93 == ((double) var_1_30)) : 1)) && (var_1_55 ? (var_1_94 == ((signed short int) var_1_79)) : (var_1_94 == ((signed short int) -8)))) && (var_1_51 ? (var_1_95 == ((signed char) 10)) : (var_1_95 == ((signed char) var_1_80)))) && (var_1_65 ? (var_1_96 == ((float) var_1_30)) : 1)) && (var_1_53 ? (var_1_97 == ((signed char) -32)) : (var_1_97 == ((signed char) -50)))) && (((abs (min (var_1_69 , var_1_37))) <= (var_1_24 - (max (var_1_85 , var_1_68)))) ? (((var_1_64 > -8) && var_1_53) ? (var_1_98 == ((unsigned char) (min (var_1_49 , var_1_28)))) : (var_1_98 == ((unsigned char) (min (var_1_37 , var_1_50))))) : ((((var_1_48 + var_1_49) + var_1_37) < var_1_99) ? (var_1_98 == ((unsigned char) var_1_28)) : 1))) && (var_1_99 == ((unsigned long int) var_1_75))) && (var_1_100 == ((unsigned char) var_1_69))
;
}
int main(void) {
	isInitial = 1;
