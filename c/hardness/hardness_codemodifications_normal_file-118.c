...
void step(void) {
	// From: Req1Batch118normal
	var_1_1 = -5;


	// From: Req2Batch118normal
	var_1_2 = (max (var_1_3 , var_1_4));


	// From: Req3Batch118normal
	...
	// From: Req4Batch118normal
	if (var_1_8 && var_1_9) {
		var_1_7 = var_1_6;
	}


	// From: Req5Batch118normal
	...
	// From: Req6Batch118normal
	if (var_1_10 == var_1_6) {
		var_1_11 = (32.7f + (var_1_12 - var_1_13));
	}


	// From: Req7Batch118normal
