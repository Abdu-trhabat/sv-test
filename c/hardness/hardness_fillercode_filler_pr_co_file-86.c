...
void step(void) {
	...
	// From: CodeObject6
	/* 364L, 244L) */ if (/* 365L, 216L, 217L) */ ((/* 366L, 214L, 218L) */ ((-100000) + (var_1_14))) >= (var_1_33))) {
		/* 370L, 233L) */ var_1_38 = (
			/* 373L, 232L) */ ((
				var_1_27
			) - (
	...
	/* 310L, 155L) */ if (/* 311L, 108L, 109L) */ ((/* 312L, 106L, 110L) */ ((var_1_16) / (/* 314L, 105L, 112L) */ ((var_1_30) + (var_1_31))))) >= (var_1_27))) {
		/* 318L, 149L) */ if (/* 319L, 130L, 131L) */ ((var_1_6) || (/* 321L, 129L, 133L) */ ((/* 322L, 127L, 134L) */ (abs (var_1_31))) > (var_1_30))))) {
			/* 325L, 148L) */ var_1_29 = (
				/* 328L, 147L) */ (abs (
					/* 329L, 146L) */ (abs (
						var_1_27
