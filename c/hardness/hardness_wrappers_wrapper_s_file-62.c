...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch62Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (last_1_WrapperStruct00_var_1_5 <= stepLocal_1) {
		if (stepLocal_0 <= WrapperStruct00.var_1_4) {
			WrapperStruct00.var_1_7 = ((WrapperStruct00.var_1_8 - WrapperStruct00.var_1_6) - last_1_WrapperStruct00_var_1_5);
		} else {
	...
	// From: Req6Batch62Wrapper_S
	WrapperStruct00.var_1_10 = WrapperStruct00.var_1_7;


	// From: Req1Batch62Wrapper_S
	WrapperStruct00.var_1_1 = (16 - 2);


	// From: Req2Batch62Wrapper_S
	if (WrapperStruct00.var_1_3) {
		WrapperStruct00.var_1_2 = (abs (-4));
	} else {
		WrapperStruct00.var_1_2 = (abs (WrapperStruct00.var_1_4));
	}


	// From: Req5Batch62Wrapper_S
	WrapperStruct00.var_1_9 = WrapperStruct00.var_1_8;


	// From: Req3Batch62Wrapper_S
...
int property(void) {
	return (((((WrapperStruct00.var_1_1 == ((signed char) (16 - 2))) && (WrapperStruct00.var_1_3 ? (WrapperStruct00.var_1_2 == ((signed char) (abs (-4)))) : (WrapperStruct00.var_1_2 == ((signed char) (abs (WrapperStruct00.var_1_4)))))) && ((WrapperStruct00.var_1_4 < WrapperStruct00.var_1_9) ? (WrapperStruct00.var_1_3 ? ((WrapperStruct00.var_1_1 != WrapperStruct00.var_1_4) ? (WrapperStruct00.var_1_5 == ((unsigned char) WrapperStruct00.var_1_6)) : 1) : 1) : 1)) && ((last_1_WrapperStruct00_var_1_5 <= WrapperStruct00.var_1_4) ? ((last_1_WrapperStruct00_var_1_5 <= WrapperStruct00.var_1_4) ? (WrapperStruct00.var_1_7 == ((signed long int) ((WrapperStruct00.var_1_8 - WrapperStruct00.var_1_6) - last_1_WrapperStruct00_var_1_5))) : ((! WrapperStruct00.var_1_3) ? (WrapperStruct00.var_1_7 == ((signed long int) last_1_WrapperStruct00_var_1_10)) : (WrapperStruct00.var_1_7 == ((signed long int) (last_1_WrapperStruct00_var_1_5 + WrapperStruct00.var_1_6))))) : (WrapperStruct00.var_1_7 == ((signed long int) ((WrapperStruct00.var_1_8 - WrapperStruct00.var_1_6) - last_1_WrapperStruct00_var_1_5))))) && (WrapperStruct00.var_1_9 == ((signed long int) WrapperStruct00.var_1_8))) && (WrapperStruct00.var_1_10 == ((signed short int) WrapperStruct00.var_1_7))
;
}
int main(void) {
	isInitial = 1;
