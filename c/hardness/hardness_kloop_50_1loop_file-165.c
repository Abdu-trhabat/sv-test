...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16550_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch16550_1loop
	if (var_1_3 <= var_1_4) {
		if (var_1_4 <= (min (var_1_3 , var_1_5))) {
			var_1_1 = (var_1_6 + (min (var_1_7 , 1u)));
		} else {
			var_1_1 = 0u;
		}
	} else {
	...
	// From: Req2Batch16550_1loop
	if ((var_1_6 / var_1_9) <= 1u) {
		var_1_8 = (var_1_9 + var_1_10);
	} else {
		var_1_8 = (max (var_1_10 , (var_1_9 + var_1_11)));
	}


	// From: Req3Batch16550_1loop
	if (var_1_3 <= (var_1_4 + var_1_5)) {
		var_1_12 = ((18598 - var_1_13) - var_1_9);
	}


	// From: Req4Batch16550_1loop
...
int property(void) {
	return ((((((var_1_3 <= var_1_4) ? ((var_1_4 <= (min (var_1_3 , var_1_5))) ? (var_1_1 == ((unsigned long int) (var_1_6 + (min (var_1_7 , 1u))))) : (var_1_1 == ((unsigned long int) 0u))) : (var_1_1 == ((unsigned long int) var_1_6))) && (((var_1_6 / var_1_9) <= 1u) ? (var_1_8 == ((signed short int) (var_1_9 + var_1_10))) : (var_1_8 == ((signed short int) (max (var_1_10 , (var_1_9 + var_1_11))))))) && ((var_1_3 <= (var_1_4 + var_1_5)) ? (var_1_12 == ((signed short int) ((18598 - var_1_13) - var_1_9))) : 1)) && ((((var_1_15 - var_1_9) * var_1_6) >= var_1_1) ? ((var_1_9 < (8 + var_1_8)) ? (var_1_14 == ((unsigned char) (! (var_1_16 || (! var_1_17))))) : (var_1_14 == ((unsigned char) (var_1_17 && var_1_18)))) : (var_1_14 == ((unsigned char) var_1_16)))) && ((var_1_6 < (var_1_15 | var_1_1)) ? (var_1_19 == ((unsigned short int) var_1_13)) : 1)) && (var_1_18 ? ((9.25 >= var_1_3) ? (((var_1_6 + (var_1_13 / 4u)) >= (var_1_22 - var_1_15)) ? (var_1_20 == ((signed char) var_1_23)) : 1) : 1) : (var_1_20 == ((signed char) var_1_23)))
;
}
int main(void) {
	isInitial = 1;
