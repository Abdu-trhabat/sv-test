...
void step(void) {
	// From: Req1Batch194100_1loop
	if (last_1_var_1_9) {
		if ((-0.5 + last_1_var_1_38) != (min (last_1_var_1_17 , last_1_var_1_38))) {
	...
	// From: Req8Batch194100_1loop
	signed long int stepLocal_1 = - 4;
	if (stepLocal_1 >= (max (0 , last_1_var_1_30))) {
		var_1_23 = (max (last_1_var_1_15 , var_1_6));
	}


	// From: Req5Batch194100_1loop
	if ((- last_1_var_1_28) == var_1_8) {
		var_1_15 = ((var_1_16 - last_1_var_1_28) - var_1_12);
	}


	// From: Req4Batch194100_1loop
	...
	// From: Req2Batch194100_1loop
	if (var_1_6 >= var_1_8) {
		var_1_9 = 0;
	}


	// From: Req3Batch194100_1loop
	var_1_10 = ((var_1_11 + var_1_12) - var_1_13);


	// From: Req13Batch194100_1loop
	var_1_38 = var_1_20;


	// From: Req14Batch194100_1loop
	signed long int stepLocal_6 = 59489 - var_1_10;
	if (stepLocal_6 < (abs (100))) {
		var_1_39 = var_1_20;
	}


	// From: Req15Batch194100_1loop
	var_1_40 = var_1_13;


	// From: Req16Batch194100_1loop
	var_1_41 = var_1_42;


	// From: Req17Batch194100_1loop
	var_1_43 = -10;


	// From: Req9Batch194100_1loop
	if (var_1_19 < var_1_38) {
		var_1_25 = (last_1_var_1_25 && var_1_27);
	}


	// From: Req7Batch194100_1loop
	if (var_1_25) {
		var_1_22 = var_1_13;
	}


	// From: Req6Batch194100_1loop
	...
	// From: Req11Batch194100_1loop
	unsigned char stepLocal_3 = var_1_27;
	unsigned long int stepLocal_2 = var_1_15;
	if ((var_1_23 / (max (var_1_11 , var_1_12))) <= stepLocal_2) {
		if (var_1_9 || stepLocal_3) {
			var_1_30 = ((abs (var_1_12)) + (abs (-1)));
		} else {
			var_1_30 = ((min ((min (var_1_12 , var_1_23)) , (max (var_1_8 , var_1_7)))) - var_1_14);
		}
	}


	// From: Req10Batch194100_1loop
	if (! var_1_25) {
		var_1_28 = (max (var_1_23 , (34596 - 8)));
	} else {
		if (var_1_25) {
			var_1_28 = (min (var_1_40 , (max ((var_1_6 + var_1_11) , var_1_7))));
		}
	}


	// From: Req12Batch194100_1loop
	...
	if (stepLocal_4 <= (var_1_23 * var_1_8)) {
		...
		var_1_31 = ((min (var_1_35 , var_1_18)) - var_1_37);
	}
}
...
int property(void) {
	return ((((((((((((((((last_1_var_1_9 ? (((-0.5 + last_1_var_1_38) != (min (last_1_var_1_17 , last_1_var_1_38))) ? (var_1_1 == ((unsigned short int) ((var_1_6 + var_1_7) + var_1_8))) : (var_1_1 == ((unsigned short int) var_1_8))) : 1) && ((var_1_6 >= var_1_8) ? (var_1_9 == ((unsigned char) 0)) : 1)) && (var_1_10 == ((unsigned char) ((var_1_11 + var_1_12) - var_1_13)))) && (((var_1_8 << var_1_15) >= (var_1_11 * var_1_7)) ? (var_1_14 == ((unsigned char) (var_1_13 + 100))) : (var_1_14 == ((unsigned char) var_1_12)))) && (((- last_1_var_1_28) == var_1_8) ? (var_1_15 == ((unsigned long int) ((var_1_16 - last_1_var_1_28) - var_1_12))) : 1)) && (((var_1_1 ^ var_1_11) == var_1_15) ? (var_1_17 == ((double) (min ((var_1_18 - var_1_19) , var_1_20)))) : (var_1_17 == ((double) var_1_21)))) && (var_1_25 ? (var_1_22 == ((signed short int) var_1_13)) : 1)) && (((- 4) >= (max (0 , last_1_var_1_30))) ? (var_1_23 == ((signed long int) (max (last_1_var_1_15 , var_1_6)))) : 1)) && ((var_1_19 < var_1_38) ? (var_1_25 == ((unsigned char) (last_1_var_1_25 && var_1_27))) : 1)) && ((! var_1_25) ? (var_1_28 == ((unsigned short int) (max (var_1_23 , (34596 - 8))))) : (var_1_25 ? (var_1_28 == ((unsigned short int) (min (var_1_40 , (max ((var_1_6 + var_1_11) , var_1_7)))))) : 1))) && (((var_1_23 / (max (var_1_11 , var_1_12))) <= var_1_15) ? ((var_1_9 || var_1_27) ? (var_1_30 == ((signed long int) ((abs (var_1_12)) + (abs (-1))))) : (var_1_30 == ((signed long int) ((min ((min (var_1_12 , var_1_23)) , (max (var_1_8 , var_1_7)))) - var_1_14)))) : 1)) && ((var_1_1 <= (var_1_23 * var_1_8)) ? ((var_1_9 && ((- var_1_30) >= var_1_30)) ? (var_1_31 == ((float) ((var_1_32 - var_1_33) - (var_1_34 + (var_1_35 - var_1_36))))) : (var_1_31 == ((float) (var_1_33 - ((var_1_35 + var_1_37) - 25.625f))))) : (var_1_31 == ((float) ((min (var_1_35 , var_1_18)) - var_1_37))))) && (var_1_38 == ((double) var_1_20))) && (((59489 - var_1_10) < (abs (100))) ? (var_1_39 == ((double) var_1_20)) : 1)) && (var_1_40 == ((unsigned char) var_1_13))) && (var_1_41 == ((signed char) var_1_42))) && (var_1_43 == ((signed long int) -10))
;
}
int main(void) {
	isInitial = 1;
