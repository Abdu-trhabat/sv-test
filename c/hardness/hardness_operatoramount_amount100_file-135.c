...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch135Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch135Amount100
	if (var_1_18) {
		var_1_31 = (min (var_1_11 , (var_1_13 + 64.4)));
	}


	// From: Req10Batch135Amount100
	...
	// From: Req4Batch135Amount100
	var_1_14 = (abs (var_1_9));


	// From: Req13Batch135Amount100
	var_1_36 = var_1_9;


	// From: Req3Batch135Amount100
	...
	// From: Req5Batch135Amount100
	if ((~ var_1_8) < var_1_25) {
		var_1_15 = (max (var_1_13 , var_1_11));
	}


	// From: Req12Batch135Amount100
