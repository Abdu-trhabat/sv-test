...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  if ((((((16) < 0 ) ? -(16) : (16))) + unsigned_short_int_Array_0[1][0]) <= signed_long_int_Array_0[0]) {
   unsigned_short_int_Array_0[0][1] = ((((0) > (unsigned_short_int_Array_0[1][1])) ? (0) : (unsigned_short_int_Array_0[1][1])));
  } else {
   unsigned_short_int_Array_0[0][1] = (unsigned_short_int_Array_0[0][0] + ((((5) < 0 ) ? -(5) : (5))));
  }
 }
 if ((unsigned_short_int_Array_0[0][0] * signed_long_int_Array_0[0]) < unsigned_short_int_Array_0[0][1]) {
  float_Array_0[0][0] = ((((float_Array_0[0][2]) > ((float_Array_0[0][1] + (float_Array_0[1][1] + float_Array_0[1][0])))) ? (float_Array_0[0][2]) : ((float_Array_0[0][1] + (float_Array_0[1][1] + float_Array_0[1][0])))));
 } else {
  if (((((unsigned_short_int_Array_0[0][1]) > (signed_long_int_Array_0[0])) ? (unsigned_short_int_Array_0[0][1]) : (signed_long_int_Array_0[0]))) <= 50) {
...
int property(void) {
 return (((float_Array_0[0][4] <= float_Array_0[1][3]) ? ((float_Array_0[1][3] < ((float_Array_0[0][3] - float_Array_0[1][2]) + 1.395f)) ? (float_Array_0[1][4] == ((float) float_Array_0[0][2])) : (float_Array_0[1][4] == ((float) 3.25f))) : (float_Array_0[1][4] == ((float) float_Array_0[0][2]))) && (BOOL_unsigned_char_Array_0[0] ? (((((((16) < 0 ) ? -(16) : (16))) + unsigned_short_int_Array_0[1][0]) <= signed_long_int_Array_0[0]) ? (unsigned_short_int_Array_0[0][1] == ((unsigned short int) ((((0) > (unsigned_short_int_Array_0[1][1])) ? (0) : (unsigned_short_int_Array_0[1][1]))))) : (unsigned_short_int_Array_0[0][1] == ((unsigned short int) (unsigned_short_int_Array_0[0][0] + ((((5) < 0 ) ? -(5) : (5))))))) : 1)) && (((unsigned_short_int_Array_0[0][0] * signed_long_int_Array_0[0]) < unsigned_short_int_Array_0[0][1]) ? (float_Array_0[0][0] == ((float) ((((float_Array_0[0][2]) > ((float_Array_0[0][1] + (float_Array_0[1][1] + float_Array_0[1][0])))) ? (float_Array_0[0][2]) : ((float_Array_0[0][1] + (float_Array_0[1][1] + float_Array_0[1][0]))))))) : ((((((unsigned_short_int_Array_0[0][1]) > (signed_long_int_Array_0[0])) ? (unsigned_short_int_Array_0[0][1]) : (signed_long_int_Array_0[0]))) <= 50) ? (float_Array_0[0][0] == ((float) float_Array_0[1][0])) : (float_Array_0[0][0] == ((float) float_Array_0[1][1]))))
;
}
int main(void) {
 isInitial = 1;
