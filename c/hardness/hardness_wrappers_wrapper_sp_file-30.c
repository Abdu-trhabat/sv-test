...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_3_Pointer)) > stepLocal_4) {
		if (stepLocal_3 <= ((max ((*(WrapperStruct00_var_1_9_Pointer)) , (*(WrapperStruct00_var_1_1_Pointer)))) << ((*(WrapperStruct00_var_1_13_Pointer)) - (*(WrapperStruct00_var_1_14_Pointer))))) {
