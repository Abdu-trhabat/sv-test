...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch146100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req9Batch146100_1loop
	if ((abs (-2)) == (max (last_1_var_1_21 , last_1_var_1_9))) {
		if (-32 <= var_1_3) {
			if (var_1_14) {
				var_1_23 = last_1_var_1_9;
			} else {
				var_1_23 = ((min (var_1_10 , last_1_var_1_21)) - last_1_var_1_29);
			}
		} else {
	...
	// From: Req4Batch146100_1loop
	if (var_1_14) {
		var_1_15 = (! var_1_16);
	}


	// From: Req5Batch146100_1loop
	if (! (var_1_10 >= var_1_12)) {
		if ((max (var_1_22 , var_1_3)) <= (var_1_4 % var_1_10)) {
			var_1_17 = var_1_12;
		} else {
	...
	// From: Req6Batch146100_1loop
	var_1_19 = ((var_1_20 - (abs (var_1_11))) - (abs (var_1_10)));


	// From: Req7Batch146100_1loop
	if ((var_1_10 * var_1_12) >= var_1_19) {
		var_1_21 = (256 + var_1_12);
	}


	// From: Req10Batch146100_1loop
	if (! var_1_6) {
	...
	if (stepLocal_2 && var_1_13) {
		if (! var_1_6) {
			if (stepLocal_4 < var_1_21) {
				if (var_1_15) {
					var_1_29 = (min (var_1_11 , (min (var_1_20 , (var_1_31 - var_1_10)))));
				} else {
...
int property(void) {
	return (((((((((((var_1_22 == (var_1_3 - var_1_4)) ? (((var_1_22 / var_1_5) <= var_1_3) ? (var_1_1 == ((unsigned char) (var_1_6 && (var_1_7 && var_1_8)))) : (var_1_1 == ((unsigned char) (! var_1_6)))) : (var_1_1 == ((unsigned char) var_1_8))) && (var_1_7 ? (var_1_9 == ((signed char) ((var_1_10 - var_1_11) - var_1_12))) : (var_1_9 == ((signed char) (abs (5)))))) && ((! (var_1_5 <= var_1_21)) ? (var_1_13 == ((unsigned char) var_1_14)) : (var_1_13 == ((unsigned char) var_1_8)))) && (var_1_14 ? (var_1_15 == ((unsigned char) (! var_1_16))) : 1)) && ((! (var_1_10 >= var_1_12)) ? (((max (var_1_22 , var_1_3)) <= (var_1_4 % var_1_10)) ? (var_1_17 == ((unsigned char) var_1_12)) : ((var_1_10 >= var_1_11) ? ((var_1_5 == (var_1_3 - var_1_18)) ? (var_1_17 == ((unsigned char) var_1_12)) : (var_1_17 == ((unsigned char) var_1_10))) : (var_1_17 == ((unsigned char) var_1_12)))) : 1)) && (var_1_19 == ((unsigned char) ((var_1_20 - (abs (var_1_11))) - (abs (var_1_10)))))) && (((var_1_10 * var_1_12) >= var_1_19) ? (var_1_21 == ((unsigned short int) (256 + var_1_12))) : 1)) && ((! (last_1_var_1_21 >= (var_1_20 + var_1_4))) ? ((! last_1_var_1_1) ? (var_1_22 == ((signed long int) last_1_var_1_21)) : 1) : (var_1_22 == ((signed long int) last_1_var_1_23)))) && (((abs (-2)) == (max (last_1_var_1_21 , last_1_var_1_9))) ? ((-32 <= var_1_3) ? (var_1_14 ? (var_1_23 == ((signed short int) last_1_var_1_9)) : (var_1_23 == ((signed short int) ((min (var_1_10 , last_1_var_1_21)) - last_1_var_1_29)))) : (var_1_23 == ((signed short int) (last_1_var_1_29 + 100)))) : (((last_1_var_1_22 * 128) > (var_1_11 << var_1_10)) ? (var_1_23 == ((signed short int) var_1_12)) : 1))) && ((! var_1_6) ? (var_1_24 == ((double) (var_1_25 - (var_1_26 - 16.5)))) : (var_1_24 == ((double) (var_1_27 + var_1_28))))) && ((var_1_15 && var_1_13) ? ((! var_1_6) ? ((var_1_23 < var_1_21) ? (var_1_15 ? (var_1_29 == ((unsigned char) (min (var_1_11 , (min (var_1_20 , (var_1_31 - var_1_10))))))) : ((var_1_21 == (16 << var_1_22)) ? (var_1_29 == ((unsigned char) var_1_20)) : 1)) : (var_1_29 == ((unsigned char) var_1_10))) : (var_1_29 == ((unsigned char) var_1_20))) : (var_1_29 == ((unsigned char) var_1_12)))
;
}
int main(void) {
	isInitial = 1;
