...
void step(void) {
	...
	// From: Req3Batch121100_while
	if (var_1_6 > var_1_2) {
		var_1_13 = var_1_14;
	}


	// From: Req4Batch121100_while
	var_1_15 = ((abs (var_1_16)) - var_1_17);


	// From: Req5Batch121100_while
	if ((max (var_1_2 , (var_1_17 + var_1_5))) == var_1_16) {
		var_1_18 = (abs (var_1_14));
	}


	// From: Req6Batch121100_while
