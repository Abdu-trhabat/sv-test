...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch28Wrapper_A.c", 13, "reach_error"); }
...
signed long int signed_long_int_Array_0[2][3] = {
 {-2, 64, 1}, {1629954775, 5, 1928642731}
};
...
void step(void) {
 ...
 if (stepLocal_1 <= ((((signed_char_Array_0[0][1]) > (signed_char_Array_0[0][0])) ? (signed_char_Array_0[0][1]) : (signed_char_Array_0[0][0])))) {
  signed_long_int_Array_0[0][0] = (((((signed_char_Array_0[1][0]) < ((signed_long_int_Array_0[1][0] - signed_long_int_Array_0[0][2]))) ? (signed_char_Array_0[1][0]) : ((signed_long_int_Array_0[1][0] - signed_long_int_Array_0[0][2])))) - (signed_long_int_Array_0[1][2] - ((((signed_char_Array_0[0][1]) < 0 ) ? -(signed_char_Array_0[0][1]) : (signed_char_Array_0[0][1])))));
 } else {
  signed_long_int_Array_0[0][0] = (signed_char_Array_0[1][0] + (((((signed_long_int_Array_0[0][2]) < (signed_long_int_Array_0[0][1])) ? (signed_long_int_Array_0[0][2]) : (signed_long_int_Array_0[0][1]))) - signed_long_int_Array_0[1][1]));
 }
...
void updateVariables(void) {
 ...
 assume_abort_if_not(signed_long_int_Array_0[1][0] >= 1073741822);
 ...
 assume_abort_if_not(signed_long_int_Array_0[1][2] >= 1073741823);
 assume_abort_if_not(signed_long_int_Array_0[1][2] <= 2147483646);
}
void updateLastVariables(void) {
}
int property(void) {
 return (((((((float_Array_0[1][2] - float_Array_0[0][2]) <= (- float_Array_0[1][0])) ? (signed_char_Array_0[1][1] == ((signed char) (((((signed_char_Array_0[0][1] - signed_char_Array_0[1][0])) < (signed_char_Array_0[0][0])) ? ((signed_char_Array_0[0][1] - signed_char_Array_0[1][0])) : (signed_char_Array_0[0][0]))))) : (signed_char_Array_0[1][1] == ((signed char) signed_char_Array_0[0][1]))) && ((-4 < signed_char_Array_0[1][0]) ? (float_Array_0[1][0] == ((float) ((((float_Array_0[0][0]) < (float_Array_0[0][1])) ? (float_Array_0[0][0]) : (float_Array_0[0][1]))))) : 1)) && (float_Array_0[1][1] == ((float) ((((float_Array_0[0][0]) > (float_Array_0[0][1])) ? (float_Array_0[0][0]) : (float_Array_0[0][1])))))) && (((signed_char_Array_0[1][0] | 5) <= ((((signed_char_Array_0[0][1]) > (signed_char_Array_0[0][0])) ? (signed_char_Array_0[0][1]) : (signed_char_Array_0[0][0])))) ? (signed_long_int_Array_0[0][0] == ((signed long int) (((((signed_char_Array_0[1][0]) < ((signed_long_int_Array_0[1][0] - signed_long_int_Array_0[0][2]))) ? (signed_char_Array_0[1][0]) : ((signed_long_int_Array_0[1][0] - signed_long_int_Array_0[0][2])))) - (signed_long_int_Array_0[1][2] - ((((signed_char_Array_0[0][1]) < 0 ) ? -(signed_char_Array_0[0][1]) : (signed_char_Array_0[0][1]))))))) : (signed_long_int_Array_0[0][0] == ((signed long int) (signed_char_Array_0[1][0] + (((((signed_long_int_Array_0[0][2]) < (signed_long_int_Array_0[0][1])) ? (signed_long_int_Array_0[0][2]) : (signed_long_int_Array_0[0][1]))) - signed_long_int_Array_0[1][1])))))) && (signed_short_int_Array_0[0] == ((signed short int) signed_char_Array_0[0][1]))) && (unsigned_short_int_Array_0[0] == ((unsigned short int) signed_char_Array_0[1][0]))
;
}
int main(void) {
 isInitial = 1;
