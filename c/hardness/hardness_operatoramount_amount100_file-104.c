...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch104Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch104Amount100
	var_1_17 = (var_1_6 || (var_1_18 || var_1_19));


	// From: Req6Batch104Amount100
	var_1_20 = (var_1_21 - ((var_1_22 + 5) + var_1_23));


	// From: Req7Batch104Amount100
	var_1_24 = ((max (var_1_23 , var_1_22)) + 4);


	// From: Req10Batch104Amount100
