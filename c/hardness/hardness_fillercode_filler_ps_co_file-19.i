...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
   ...
   var_1_37
                   ...
                   if (var_1_15) {
                    if ( (( (( (~ (var_1_34))) ^ (var_1_33))) < ( (( ((var_1_29) | (var_1_1))) % ( (((((var_1_44)) < ((var_1_45))) ? ((var_1_44)) : ((var_1_45))))))))) {
                     var_1_42 = (
