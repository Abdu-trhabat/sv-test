...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch118Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch118Amount50
	var_1_1 = -5;


	// From: Req2Batch118Amount50
	var_1_2 = (max (var_1_3 , var_1_4));


	// From: Req4Batch118Amount50
	if (var_1_8 && var_1_9) {
		var_1_7 = var_1_6;
	}


	// From: Req7Batch118Amount50
