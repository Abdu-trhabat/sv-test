...
void step(void) {
	...
	// From: Req2Batch124Wrapper_P
	(*(var_1_6_Pointer)) = ((*(var_1_7_Pointer)) + (*(var_1_8_Pointer)));


	// From: Req3Batch124Wrapper_P
	unsigned long int stepLocal_1 = max ((*(var_1_8_Pointer)) , (*(var_1_7_Pointer)));
	if ((abs ((*(var_1_6_Pointer)))) < stepLocal_1) {
		(*(var_1_9_Pointer)) = (((*(var_1_10_Pointer)) - (*(var_1_11_Pointer))) - (abs ((*(var_1_12_Pointer)))));
	}


	// From: Req5Batch124Wrapper_P
	(*(var_1_14_Pointer)) = 16;


	// From: Req4Batch124Wrapper_P
	if ((*(var_1_4_Pointer))) {
		if ((*(var_1_5_Pointer)) > 99.4) {
			if ((*(var_1_14_Pointer)) >= (*(var_1_6_Pointer))) {
				(*(var_1_13_Pointer)) = (min ((*(var_1_10_Pointer)) , 256));
			}
		}
	}
}
...
int property(void) {
	return (((((! ((*(var_1_2_Pointer)) == (15.2 + (*(var_1_3_Pointer))))) ? (((*(var_1_4_Pointer)) && ((*(var_1_2_Pointer)) == (*(var_1_3_Pointer)))) ? ((*(var_1_4_Pointer)) ? ((*(var_1_1_Pointer)) == ((double) (2.5 - (*(var_1_5_Pointer))))) : ((*(var_1_1_Pointer)) == ((double) (*(var_1_5_Pointer))))) : 1) : ((*(var_1_1_Pointer)) == ((double) (*(var_1_5_Pointer))))) && ((*(var_1_6_Pointer)) == ((unsigned long int) ((*(var_1_7_Pointer)) + (*(var_1_8_Pointer)))))) && (((abs ((*(var_1_6_Pointer)))) < (max ((*(var_1_8_Pointer)) , (*(var_1_7_Pointer))))) ? ((*(var_1_9_Pointer)) == ((signed char) (((*(var_1_10_Pointer)) - (*(var_1_11_Pointer))) - (abs ((*(var_1_12_Pointer))))))) : 1)) && ((*(var_1_4_Pointer)) ? (((*(var_1_5_Pointer)) > 99.4) ? (((*(var_1_14_Pointer)) >= (*(var_1_6_Pointer))) ? ((*(var_1_13_Pointer)) == ((unsigned short int) (min ((*(var_1_10_Pointer)) , 256)))) : 1) : 1) : 1)) && ((*(var_1_14_Pointer)) == ((signed short int) 16))
;
}
int main(void) {
	isInitial = 1;
