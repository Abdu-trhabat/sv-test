...
void step(void) {
	...
	if (WrapperStruct00.var_1_4 <= ((min (WrapperStruct00.var_1_2 , WrapperStruct00.var_1_3)) * WrapperStruct00.var_1_8)) {
		WrapperStruct00.var_1_7 = (max ((max ((WrapperStruct00.var_1_9 + WrapperStruct00.var_1_10) , WrapperStruct00.var_1_11)) , (abs (WrapperStruct00.var_1_12))));
	} else {
	...
	if (stepLocal_0 != (min (WrapperStruct00.var_1_9 , WrapperStruct00.var_1_12))) {
...
int property(void) {
	return ((((((((min (1.1f , WrapperStruct00.var_1_2)) > (WrapperStruct00.var_1_3 * WrapperStruct00.var_1_4)) ? (WrapperStruct00.var_1_1 == ((unsigned char) (WrapperStruct00.var_1_23 && WrapperStruct00.var_1_6))) : 1) && ((WrapperStruct00.var_1_4 <= ((min (WrapperStruct00.var_1_2 , WrapperStruct00.var_1_3)) * WrapperStruct00.var_1_8)) ? (WrapperStruct00.var_1_7 == ((signed long int) (max ((max ((WrapperStruct00.var_1_9 + WrapperStruct00.var_1_10) , WrapperStruct00.var_1_11)) , (abs (WrapperStruct00.var_1_12)))))) : (WrapperStruct00.var_1_7 == ((signed long int) WrapperStruct00.var_1_9)))) && (WrapperStruct00.var_1_13 == ((unsigned long int) WrapperStruct00.var_1_14))) && ((WrapperStruct00.var_1_7 != (min (WrapperStruct00.var_1_9 , WrapperStruct00.var_1_12))) ? (WrapperStruct00.var_1_15 == ((signed char) ((min ((10 + WrapperStruct00.var_1_16) , WrapperStruct00.var_1_17)) - ((32 - WrapperStruct00.var_1_18) + (max (WrapperStruct00.var_1_19 , WrapperStruct00.var_1_20)))))) : 1)) && (WrapperStruct00.var_1_21 == ((signed short int) WrapperStruct00.var_1_13))) && (WrapperStruct00.var_1_22 == ((signed char) WrapperStruct00.var_1_16))) && (WrapperStruct00.var_1_23 == ((unsigned char) WrapperStruct00.var_1_6))
;
}
int main(void) {
	isInitial = 1;
