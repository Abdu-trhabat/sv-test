...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch100Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 279L, 110L) */ if (/* 280L, 52L, 53L) */ ((var_1_10) > (/* 282L, 51L, 55L) */ ((var_1_29) / (/* 284L, 50L, 57L) */ (max (/* 284L, 50L, 57L) */ (var_1_31) , (var_1_32)))))))) {
		/* 287L, 108L) */ if (/* 288L, 71L, 72L) */ ((/* 289L, 69L, 73L) */ (abs (/* 290L, 68L, 74L) */ (abs (var_1_10))))) <= (var_1_32))) {
			/* 293L, 86L) */ var_1_30 = (
				/* 296L, 85L) */ (abs (
					var_1_31
				))
	...
	// From: CodeObject5
	/* 369L, 268L) */ if (/* 370L, 231L, 232L) */ ((var_1_38) <= (var_1_6))) {
