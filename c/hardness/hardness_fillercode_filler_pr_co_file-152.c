...
void step(void) {
	...
	// From: CodeObject7
	/* 279L, 148L) */ if (/* 280L, 120L, 121L) */ ((var_1_6) < (/* 282L, 119L, 123L) */ (~ (-32))))) {
		/* 284L, 136L) */ var_1_42 = (
			/* 287L, 135L) */ ((
				/* 288L, 133L) */ ((
					var_1_43
