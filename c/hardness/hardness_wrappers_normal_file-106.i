 ...
 if (! var_1_4) {
  if (stepLocal_0 >= var_1_1) {
   ...
   if (stepLocal_1 <= var_1_2) {
    var_1_3 = ((((((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5)))) < (var_1_7)) ? (((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5)))) : (var_1_7)));
   }
  }
 } else {
  var_1_3 = 64.6f;
 }
 signed long int stepLocal_3 = ((((var_1_9) > (var_1_10)) ? (var_1_9) : (var_1_10))) >> var_1_11;
...
int property(void) {
 return (((var_1_1 == ((signed long int) var_1_2)) && ((! var_1_4) ? ((var_1_2 >= var_1_1) ? (var_1_3 == ((float) (var_1_5 + var_1_6))) : ((var_1_1 <= var_1_2) ? (var_1_3 == ((float) ((((((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5)))) < (var_1_7)) ? (((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5)))) : (var_1_7))))) : 1)) : (var_1_3 == ((float) 64.6f)))) && (((var_1_5 == var_1_7) || var_1_4) ? (((((((var_1_9) > (var_1_10)) ? (var_1_9) : (var_1_10))) >> var_1_11) >= (var_1_2 + -32)) ? (var_1_8 == ((float) var_1_5)) : (var_1_8 == ((float) var_1_6))) : (var_1_8 == ((float) var_1_5)))) && (var_1_4 ? (((8 > var_1_10) || var_1_13) ? (var_1_13 ? (var_1_12 == ((signed short int) var_1_11)) : (var_1_12 == ((signed short int) var_1_9))) : (var_1_12 == ((signed short int) var_1_11))) : (var_1_12 == ((signed short int) var_1_11)))
;
}
int main(void) {
 isInitial = 1;
