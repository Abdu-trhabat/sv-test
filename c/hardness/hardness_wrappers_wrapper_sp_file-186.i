...
void step(void) {
 if ((*(WrapperStruct00_var_1_2_Pointer)) < (*(WrapperStruct00_var_1_3_Pointer))) {
  if ((*(WrapperStruct00_var_1_3_Pointer)) < (*(WrapperStruct00_var_1_2_Pointer))) {
   (*(WrapperStruct00_var_1_1_Pointer)) = ((*(WrapperStruct00_var_1_4_Pointer)) + ((((128) < 0 ) ? -(128) : (128))));
  } else {
   (*(WrapperStruct00_var_1_1_Pointer)) = (*(WrapperStruct00_var_1_4_Pointer));
  }
 }
 if ((((((*(WrapperStruct00_var_1_3_Pointer))) > ((*(WrapperStruct00_var_1_2_Pointer)))) ? ((*(WrapperStruct00_var_1_3_Pointer))) : ((*(WrapperStruct00_var_1_2_Pointer))))) > (*(WrapperStruct00_var_1_6_Pointer))) {
