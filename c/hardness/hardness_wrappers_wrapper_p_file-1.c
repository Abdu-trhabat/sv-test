...
void step(void) {
	...
	if ((*(var_1_5_Pointer))) {
		(*(var_1_10_Pointer)) = (((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))) + ((min ((*(var_1_13_Pointer)) , 8)) + (abs ((*(var_1_14_Pointer))))));
	}


	// From: Req5Batch1Wrapper_P
	signed long int stepLocal_0 = (*(var_1_7_Pointer));
	if ((min ((*(var_1_8_Pointer)) , (*(var_1_7_Pointer)))) > stepLocal_0) {
		(*(var_1_16_Pointer)) = (min ((max ((*(var_1_13_Pointer)) , (*(var_1_7_Pointer)))) , (*(var_1_12_Pointer))));
	} else {
		(*(var_1_16_Pointer)) = (min ((*(var_1_11_Pointer)) , (*(var_1_13_Pointer))));
	}


	// From: Req6Batch1Wrapper_P
	(*(var_1_17_Pointer)) = (*(var_1_4_Pointer));


	// From: Req7Batch1Wrapper_P
...
int property(void) {
	return ((((((((*(var_1_18_Pointer)) <= (- (*(var_1_17_Pointer)))) ? ((*(var_1_1_Pointer)) == ((float) (abs ((*(var_1_4_Pointer)))))) : ((*(var_1_5_Pointer)) ? ((*(var_1_1_Pointer)) == ((float) (*(var_1_4_Pointer)))) : ((*(var_1_1_Pointer)) == ((float) (*(var_1_6_Pointer)))))) && ((*(var_1_7_Pointer)) == ((signed long int) ((*(var_1_8_Pointer)) + (*(var_1_9_Pointer)))))) && ((*(var_1_5_Pointer)) ? ((*(var_1_10_Pointer)) == ((unsigned char) (((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))) + ((min ((*(var_1_13_Pointer)) , 8)) + (abs ((*(var_1_14_Pointer)))))))) : 1)) && (((*(var_1_17_Pointer)) < 1.25f) ? ((*(var_1_15_Pointer)) == ((signed char) (*(var_1_13_Pointer)))) : 1)) && (((min ((*(var_1_8_Pointer)) , (*(var_1_7_Pointer)))) > (*(var_1_7_Pointer))) ? ((*(var_1_16_Pointer)) == ((unsigned long int) (min ((max ((*(var_1_13_Pointer)) , (*(var_1_7_Pointer)))) , (*(var_1_12_Pointer)))))) : ((*(var_1_16_Pointer)) == ((unsigned long int) (min ((*(var_1_11_Pointer)) , (*(var_1_13_Pointer)))))))) && ((*(var_1_17_Pointer)) == ((double) (*(var_1_4_Pointer))))) && ((*(var_1_18_Pointer)) == ((double) (*(var_1_6_Pointer))))
;
}
int main(void) {
	isInitial = 1;
