...
double functionized1(float functionized1_localFunctionVar0) {
 return ((((var_1_1) > (((((functionized1_localFunctionVar0) > (199.78)) ? (functionized1_localFunctionVar0) : (199.78))))) ? (var_1_1) : (((((functionized1_localFunctionVar0) > (199.78)) ? (functionized1_localFunctionVar0) : (199.78))))));
}
void functionized2(double functionized2_localFunctionVar0, float functionized2_localFunctionVar1, float functionized2_localFunctionVar2, float localFunctionVar3) {
 if ((var_1_5 / var_1_11) >= (functionized2_localFunctionVar0 - functionized2_localFunctionVar2)) {
  var_1_10 = (((((var_1_5 - (var_1_12 - functionized2_localFunctionVar1))) < (functionized2_localFunctionVar2)) ? ((var_1_5 - (var_1_12 - functionized2_localFunctionVar1))) : (functionized2_localFunctionVar2)));
 } else {
