...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch3825_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch3825_1loop
	var_1_1 = ((max (var_1_2 , var_1_3)) - var_1_4);


	// From: Req2Batch3825_1loop
	...
	// From: Req3Batch3825_1loop
	var_1_7 = (var_1_8 + (var_1_9 + (var_1_10 + var_1_11)));


	// From: Req4Batch3825_1loop
	if (! var_1_13) {
		var_1_12 = (var_1_3 - (var_1_14 - var_1_15));
	} else {
		if (var_1_13) {
			var_1_12 = ((27636 + var_1_16) - (max ((16853 - 10) , var_1_14)));
		} else {
			var_1_12 = var_1_3;
		}
	}
...
int property(void) {
	return (((var_1_1 == ((unsigned short int) ((max (var_1_2 , var_1_3)) - var_1_4))) && ((var_1_4 > var_1_2) ? (var_1_5 == ((unsigned long int) (((var_1_6 - var_1_3) + 2144048120u) - var_1_2))) : 1)) && (var_1_7 == ((double) (var_1_8 + (var_1_9 + (var_1_10 + var_1_11)))))) && ((! var_1_13) ? (var_1_12 == ((unsigned short int) (var_1_3 - (var_1_14 - var_1_15)))) : (var_1_13 ? (var_1_12 == ((unsigned short int) ((27636 + var_1_16) - (max ((16853 - 10) , var_1_14))))) : (var_1_12 == ((unsigned short int) var_1_3))))
;
}
int main(void) {
	isInitial = 1;
