...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch177100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch177100_while
	if ((2.8 / var_1_17) < (8.5 - (var_1_5 + var_1_6))) {
		var_1_16 = var_1_18;
	}


	// From: Req11Batch177100_while
	var_1_38 = var_1_24;


	// From: Req8Batch177100_while
