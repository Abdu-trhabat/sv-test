...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch76Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_0 = (- 5) + (*(var_1_3_Pointer));
