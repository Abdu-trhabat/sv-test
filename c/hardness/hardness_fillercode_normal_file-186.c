...
void step(void) {
	// From: Req1Batch186normal
	var_1_1 = var_1_2;


	// From: Req2Batch186normal
	...
	// From: Req3Batch186normal
	if ((var_1_7 > (max (9.6 , var_1_6))) || (var_1_5 < var_1_3)) {
		var_1_9 = var_1_10;
	}


	// From: Req5Batch186normal
