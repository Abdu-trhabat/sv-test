...
void step(void) {
 ...
 if (stepLocal_1 || BOOL_unsigned_char_Array_0[1][0]) {
  unsigned_char_Array_0[0] = (((((200 - unsigned_char_Array_0[1]) < 0 ) ? -(200 - unsigned_char_Array_0[1]) : (200 - unsigned_char_Array_0[1]))) - unsigned_char_Array_0[2]);
 }
 if (unsigned_long_int_Array_0[1] >= unsigned_long_int_Array_0[0]) {
  signed_short_int_Array_0[1][2] = ((((signed_short_int_Array_0[0][2]) < (((((signed_short_int_Array_0[1][1]) < ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0]))) ? (signed_short_int_Array_0[1][1]) : ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0])))))) ? (signed_short_int_Array_0[0][2]) : (((((signed_short_int_Array_0[1][1]) < ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0]))) ? (signed_short_int_Array_0[1][1]) : ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0])))))));
 }
 if (unsigned_char_Array_0[1] > ((((unsigned_char_Array_0[2]) > (signed_short_int_Array_0[0][1])) ? (unsigned_char_Array_0[2]) : (signed_short_int_Array_0[0][1])))) {
...
int property(void) {
 return ((((unsigned_long_int_Array_0[1] >= unsigned_long_int_Array_0[0]) ? (signed_short_int_Array_0[1][2] == ((signed short int) ((((signed_short_int_Array_0[0][2]) < (((((signed_short_int_Array_0[1][1]) < ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0]))) ? (signed_short_int_Array_0[1][1]) : ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0])))))) ? (signed_short_int_Array_0[0][2]) : (((((signed_short_int_Array_0[1][1]) < ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0]))) ? (signed_short_int_Array_0[1][1]) : ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0]))))))))) : 1) && ((! BOOL_unsigned_char_Array_0[0][0]) ? ((signed_short_int_Array_0[0][2] < last_1_unsigned_short_int_Array_0_0_) ? (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1])) : (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) (BOOL_unsigned_char_Array_0[0][1] && BOOL_unsigned_char_Array_0[1][1])))) : 1)) && ((((signed_short_int_Array_0[0][0] >> unsigned_char_Array_0[1]) > unsigned_long_int_Array_0[0]) || BOOL_unsigned_char_Array_0[1][0]) ? (unsigned_char_Array_0[0] == ((unsigned char) (((((200 - unsigned_char_Array_0[1]) < 0 ) ? -(200 - unsigned_char_Array_0[1]) : (200 - unsigned_char_Array_0[1]))) - unsigned_char_Array_0[2]))) : 1)) && ((unsigned_char_Array_0[1] > ((((unsigned_char_Array_0[2]) > (signed_short_int_Array_0[0][1])) ? (unsigned_char_Array_0[2]) : (signed_short_int_Array_0[0][1])))) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) ((unsigned_short_int_Array_0[1] - unsigned_char_Array_0[1]) - unsigned_char_Array_0[2]))) : ((unsigned_char_Array_0[2] < (signed_short_int_Array_0[1][2] * signed_short_int_Array_0[1][0])) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_char_Array_0[0])) : (unsigned_short_int_Array_0[0] == ((unsigned short int) 8))))
;
}
int main(void) {
 isInitial = 1;
