...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch79Amount50.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_12 && (50.5 <= (var_1_15 / 99999.24))) {
  ...
  var_1_16 = (((((var_1_17 - var_1_19)) > ((var_1_18 + var_1_20))) ? ((var_1_17 - var_1_19)) : ((var_1_18 + var_1_20))));
 }
 if (var_1_12) {
  if (! var_1_12) {
   var_1_1 = (var_1_4 + 5);
...
int property(void) {
 return (((((var_1_12 ? ((! var_1_12) ? (var_1_1 == ((signed short int) (var_1_4 + 5))) : (var_1_1 == ((signed short int) (var_1_5 - var_1_6)))) : (var_1_1 == ((signed short int) var_1_5))) && ((var_1_3 && var_1_2) ? ((((((var_1_5) < ((var_1_6 * var_1_4))) ? (var_1_5) : ((var_1_6 * var_1_4)))) > var_1_1) ? (var_1_7 == ((unsigned char) var_1_8)) : (var_1_7 == ((unsigned char) 200))) : (var_1_7 == ((unsigned char) var_1_8)))) && ((var_1_7 <= var_1_4) ? (((var_1_8 / var_1_10) == ((var_1_5 * var_1_7) % var_1_11)) ? (var_1_9 == ((unsigned long int) var_1_10)) : (var_1_9 == ((unsigned long int) (5u + var_1_8)))) : (var_1_9 == ((unsigned long int) var_1_8)))) && ((((((((((var_1_13) > (9.999999999999025E12)) ? (var_1_13) : (9.999999999999025E12)))) < (var_1_14)) ? (((((var_1_13) > (9.999999999999025E12)) ? (var_1_13) : (9.999999999999025E12)))) : (var_1_14))) > var_1_15) ? (var_1_12 == ((unsigned char) 0)) : 1)) && ((var_1_12 && (50.5 <= (var_1_15 / 99999.24))) ? (var_1_16 == ((signed char) (var_1_17 - ((((-50 + var_1_18) < 0 ) ? -(-50 + var_1_18) : (-50 + var_1_18)))))) : (var_1_16 == ((signed char) (((((var_1_17 - var_1_19)) > ((var_1_18 + var_1_20))) ? ((var_1_17 - var_1_19)) : ((var_1_18 + var_1_20)))))))) && ((var_1_9 <= (var_1_22 - (var_1_23 - 32u))) ? (var_1_21 == ((signed char) 32)) : 1)
;
}
int main(void) {
 isInitial = 1;
