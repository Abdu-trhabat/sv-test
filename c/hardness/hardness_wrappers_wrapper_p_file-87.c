...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch87Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_0 < (*(var_1_4_Pointer))) {
		if (stepLocal_1 != (*(var_1_15_Pointer))) {
	...
	if (((*(var_1_1_Pointer)) * (*(var_1_3_Pointer))) <= (*(var_1_4_Pointer))) {
		if (((*(var_1_9_Pointer)) - (abs (-1))) <= ((*(var_1_1_Pointer)) * (*(var_1_8_Pointer)))) {
