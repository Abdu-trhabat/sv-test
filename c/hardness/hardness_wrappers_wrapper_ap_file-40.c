...
void step(void) {
	...
	if (last_1_double_Array_0_0_ != (min ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))))) {
