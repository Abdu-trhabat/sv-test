...
void step(void) {
	...
	if ((var_1_1 * var_1_3) <= var_1_4) {
		if ((var_1_9 - (abs (-1))) <= (var_1_1 * var_1_8)) {
...
int property(void) {
	return (((((var_1_13 ? (var_1_1 == ((unsigned long int) (abs (var_1_3 - var_1_4)))) : 1) && ((-8 < var_1_4) ? ((var_1_4 != var_1_15) ? (var_1_5 == ((signed char) ((abs (var_1_6)) - ((min (var_1_7 , var_1_8)) + var_1_9)))) : (var_1_5 == ((signed char) -8))) : (var_1_5 == ((signed char) var_1_8)))) && (((var_1_1 * var_1_3) <= var_1_4) ? (((var_1_9 - (abs (-1))) <= (var_1_1 * var_1_8)) ? (var_1_10 == ((signed long int) (var_1_8 - var_1_9))) : (var_1_10 == ((signed long int) var_1_7))) : (var_1_10 == ((signed long int) var_1_7)))) && (var_1_12 == ((signed long int) var_1_8))) && (var_1_13 == ((unsigned char) var_1_14))) && (var_1_15 == ((unsigned long int) var_1_9))
;
}
int main(void) {
	isInitial = 1;
