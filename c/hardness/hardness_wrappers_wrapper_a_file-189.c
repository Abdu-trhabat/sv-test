...
void step(void) {
	...
	if (unsigned_char_Array_0[0] <= stepLocal_2) {
		if (! (unsigned_short_int_Array_0[1] <= unsigned_short_int_Array_0[0])) {
			unsigned_long_int_Array_0[0] = (max ((max ((unsigned_char_Array_0[0] + unsigned_char_Array_0[1]) , unsigned_short_int_Array_0[0])) , unsigned_short_int_Array_0[1]));
		}
	} else {
	...
	// From: Req2Batch189Wrapper_A
	unsigned long int stepLocal_0 = min (unsigned_long_int_Array_0[0] , unsigned_char_Array_0[0]);
	if (stepLocal_0 >= unsigned_long_int_Array_0[0]) {
		float_Array_0[1][1] = (abs (float_Array_0[0][0] - float_Array_0[1][0]));
	} else {
		float_Array_0[1][1] = (abs (float_Array_0[1][0]));
	}
}
...
int property(void) {
	return ((((BOOL_unsigned_char_Array_0[0][1] ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0])) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) (! BOOL_unsigned_char_Array_0[0][0])))) && (((min (unsigned_long_int_Array_0[0] , unsigned_char_Array_0[0])) >= unsigned_long_int_Array_0[0]) ? (float_Array_0[1][1] == ((float) (abs (float_Array_0[0][0] - float_Array_0[1][0])))) : (float_Array_0[1][1] == ((float) (abs (float_Array_0[1][0])))))) && (last_1_BOOL_unsigned_char_Array_0_1__1_ ? (((unsigned_short_int_Array_0[0] - unsigned_short_int_Array_0[1]) < last_1_unsigned_long_int_Array_0_0_) ? (float_Array_0[0][1] == ((float) float_Array_0[0][0])) : 1) : (float_Array_0[0][1] == ((float) float_Array_0[0][0])))) && ((64.8f <= float_Array_0[0][1]) ? (unsigned_char_Array_0[0] == ((unsigned char) unsigned_char_Array_0[1])) : 1)) && ((unsigned_char_Array_0[0] <= signed_long_int_Array_0[0]) ? ((! (unsigned_short_int_Array_0[1] <= unsigned_short_int_Array_0[0])) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) (max ((max ((unsigned_char_Array_0[0] + unsigned_char_Array_0[1]) , unsigned_short_int_Array_0[0])) , unsigned_short_int_Array_0[1])))) : 1) : (unsigned_long_int_Array_0[0] == ((unsigned long int) unsigned_short_int_Array_0[1])))
;
}
int main(void) {
	isInitial = 1;
