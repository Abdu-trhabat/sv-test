...
void step(void) {
	...
	if ((max ((signed_long_int_Array_0[6] - signed_long_int_Array_0[5]) , signed_long_int_Array_0[4])) <= (min ((signed_long_int_Array_0[3] - signed_long_int_Array_0[2]) , (signed_long_int_Array_0[1] % signed_long_int_Array_0[0])))) {
		signed_short_int_Array_0[1][1] = (min ((signed_short_int_Array_0[0][1] - signed_short_int_Array_0[0][0]) , signed_short_int_Array_0[1][0]));
	}
	...
	if (BOOL_unsigned_char_Array_0[0] || stepLocal_0) {
		signed_char_Array_0[0] = (abs (1 - signed_char_Array_0[1]));
	} else {
	...
	if (signed_short_int_Array_0[0][0] <= stepLocal_1) {
		double_Array_0[0][1][0] = (min ((max ((min (double_Array_0[0][0][0] , double_Array_0[1][0][0])) , double_Array_0[1][1][0])) , (max (3.6 , double_Array_0[0][0][1]))));
	} else {
...
int property(void) {
	return (((((((max ((signed_long_int_Array_0[6] - signed_long_int_Array_0[5]) , signed_long_int_Array_0[4])) <= (min ((signed_long_int_Array_0[3] - signed_long_int_Array_0[2]) , (signed_long_int_Array_0[1] % signed_long_int_Array_0[0])))) ? (signed_short_int_Array_0[1][1] == ((signed short int) (min ((signed_short_int_Array_0[0][1] - signed_short_int_Array_0[0][0]) , signed_short_int_Array_0[1][0])))) : 1) && ((BOOL_unsigned_char_Array_0[0] || (signed_short_int_Array_0[1][1] <= signed_short_int_Array_0[1][0])) ? (signed_char_Array_0[0] == ((signed char) (abs (1 - signed_char_Array_0[1])))) : (signed_char_Array_0[0] == ((signed char) signed_char_Array_0[1])))) && ((signed_short_int_Array_0[0][0] <= (signed_long_int_Array_0[6] / signed_long_int_Array_0[0])) ? (double_Array_0[0][1][0] == ((double) (min ((max ((min (double_Array_0[0][0][0] , double_Array_0[1][0][0])) , double_Array_0[1][1][0])) , (max (3.6 , double_Array_0[0][0][1])))))) : (double_Array_0[0][1][0] == ((double) (double_Array_0[1][0][1] - double_Array_0[0][1][1]))))) && (double_Array_0[1][1][1] == ((double) double_Array_0[0][0][1]))) && (unsigned_short_int_Array_0[0] == ((unsigned short int) signed_short_int_Array_0[0][0]))) && (signed_char_Array_0[2] == ((signed char) signed_char_Array_0[1]))
;
}
int main(void) {
	isInitial = 1;
