...
void step(void) {
	...
	if (stepLocal_1 && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if ((max ((abs ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))) , (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)))) < stepLocal_0) {
