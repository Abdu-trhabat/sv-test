...
void functionized1(float functionized1_localFunctionVar0, signed long int functionized1_localFunctionVar1, float functionized1_localFunctionVar2) {
 if ((var_1_6 * -64) == functionized1_localFunctionVar1) {
  var_1_5 = ((var_1_3 - ((((functionized1_localFunctionVar2) > (functionized1_localFunctionVar0)) ? (functionized1_localFunctionVar2) : (functionized1_localFunctionVar0)))) + var_1_4);
 } else {
  var_1_5 = ((((functionized1_localFunctionVar0) > (functionized1_localFunctionVar2)) ? (functionized1_localFunctionVar0) : (functionized1_localFunctionVar2)));
 }
}
void functionized2(double functionized2_localFunctionVar0, float functionized2_localFunctionVar1) {
 var_1_9 = ((((functionized2_localFunctionVar0) < (functionized2_localFunctionVar1)) ? (functionized2_localFunctionVar0) : (functionized2_localFunctionVar1)));
}
...
void functionized4(float functionized4_localFunctionVar0, float functionized4_localFunctionVar1) {
 if (functionized4_localFunctionVar0 > (((((var_1_9) < (var_1_11)) ? (var_1_9) : (var_1_11))) + functionized4_localFunctionVar1)) {
  if (var_1_15) {
   var_1_14 = var_1_12;
  }
 }
...
void step(void) {
 ...
 if ((var_1_7 % ((((var_1_25) < (var_1_26)) ? (var_1_25) : (var_1_26)))) < functionized6()) {
...
int property(void) {
 return (((((((var_1_1 == ((float) ((var_1_2 - var_1_3) + var_1_4))) && (((var_1_6 * -64) == var_1_7) ? (var_1_5 == ((float) ((var_1_3 - ((((var_1_2) > (var_1_8)) ? (var_1_2) : (var_1_8)))) + var_1_4))) : (var_1_5 == ((float) ((((var_1_8) > (var_1_2)) ? (var_1_8) : (var_1_2))))))) && (var_1_9 == ((double) ((((var_1_10) < (var_1_4)) ? (var_1_10) : (var_1_4)))))) && ((var_1_10 >= var_1_2) ? (((var_1_6 - var_1_12) <= var_1_7) ? (var_1_11 == ((double) var_1_13)) : 1) : 1)) && ((var_1_8 > (((((var_1_9) < (var_1_11)) ? (var_1_9) : (var_1_11))) + var_1_1)) ? (var_1_15 ? (var_1_14 == ((signed short int) var_1_12)) : 1) : 1)) && (var_1_15 ? ((9.76f > var_1_4) ? ((var_1_5 <= var_1_10) ? (var_1_16 == ((signed char) var_1_17)) : (((var_1_2 + var_1_10) == ((var_1_8 + var_1_3) - var_1_18)) ? (var_1_16 == ((signed char) var_1_17)) : 1)) : 1) : (var_1_16 == ((signed char) -1)))) && (var_1_19 == ((signed char) (var_1_20 + (var_1_21 + (var_1_22 + 4)))))) && (((var_1_7 % ((((var_1_25) < (var_1_26)) ? (var_1_25) : (var_1_26)))) < (-5 * var_1_21)) ? (var_1_23 == ((unsigned char) (var_1_27 - var_1_12))) : (var_1_23 == ((unsigned char) var_1_12)))
;
}
int main(void) {
 isInitial = 1;
