...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch184stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_4 <= stepLocal_0) {
  var_1_8 = (((((var_1_9) < (var_1_10)) ? (var_1_9) : (var_1_10))) - (64 - var_1_11));
 } else {
  var_1_8 = ((((((((var_1_9) < (var_1_11)) ? (var_1_9) : (var_1_11)))) > (var_1_10)) ? (((((var_1_9) < (var_1_11)) ? (var_1_9) : (var_1_11)))) : (var_1_10)));
 }
 ...
 if (stepLocal_2 || (var_1_1 || var_1_6)) {
  if (var_1_21) {
   var_1_20 = ((((var_1_15) < (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))) ? (var_1_15) : (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))));
  }
 } else {
