...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch145100_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_5 > (last_1_var_1_32 | last_1_var_1_22)) {
  if (last_1_var_1_24 || stepLocal_4) {
   if ((var_1_5 <= (- last_1_var_1_32)) || stepLocal_6) {
    var_1_18 = ((((var_1_19) > ((((((var_1_20 - var_1_21)) < (64.125f)) ? ((var_1_20 - var_1_21)) : (64.125f))))) ? (var_1_19) : ((((((var_1_20 - var_1_21)) < (64.125f)) ? ((var_1_20 - var_1_21)) : (64.125f))))));
   } else {
    var_1_18 = var_1_20;
   }
  }
 ...
 if (var_1_23 <= (((((var_1_23 + var_1_11)) > ((var_1_28 - var_1_30))) ? ((var_1_23 + var_1_11)) : ((var_1_28 - var_1_30))))) {
  var_1_32 = (var_1_7 + var_1_23);
 }
 unsigned char stepLocal_1 = var_1_10;
 if (var_1_2 || stepLocal_1) {
  var_1_9 = (((((var_1_17 + var_1_32)) > ((var_1_7 + (var_1_5 - var_1_11)))) ? ((var_1_17 + var_1_32)) : ((var_1_7 + (var_1_5 - var_1_11)))));
 } else {
 ...
 if (var_1_16 >= stepLocal_11) {
  var_1_26 = ((((var_1_7) < (var_1_27)) ? (var_1_7) : (var_1_27)));
 } else {
 ...
 if (var_1_24) {
  if (var_1_15 == stepLocal_0) {
   var_1_1 = ((((10) > (((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6))))) ? (10) : (((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6))))));
  } else {
   var_1_1 = ((((((var_1_7 - 25)) < (128)) ? ((var_1_7 - 25)) : (128))) - var_1_8);
  }
 }
}
void updateVariables(void) {
