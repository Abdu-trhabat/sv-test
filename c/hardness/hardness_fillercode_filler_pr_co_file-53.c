...
void step(void) {
	...
	/* 340L, 150L) */ if (var_1_1) {
		/* 342L, 144L) */ if (var_1_1) {
			/* 344L, 142L) */ if (/* 345L, 127L, 128L) */ ((var_1_22) <= (/* 347L, 126L, 130L) */ (abs (var_1_22))))) {
				/* 349L, 141L) */ var_1_24 = (
					/* 352L, 140L) */ (min (
						/* 352L, 140L) */ (
							var_1_29
	...
	// From: CodeObject4
	/* 387L, 221L) */ if (/* 388L, 206L, 207L) */ ((var_1_9) >= (var_1_29))) {
		/* 391L, 220L) */ var_1_35 = (
			/* 394L, 219L) */ ((
				/* 395L, 217L) */ ((
					var_1_36
	...
	// From: CodeObject7
	/* 428L, 282L) */ if (/* 429L, 265L, 266L) */ ((var_1_10) <= (/* 431L, 264L, 268L) */ (abs (var_1_38))))) {
		/* 433L, 281L) */ var_1_42 = (
			/* 436L, 280L) */ (abs (
				/* 437L, 279L) */ (abs (
					/* 438L, 278L) */ ((
