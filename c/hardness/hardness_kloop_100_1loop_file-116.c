...
void step(void) {
	...
	// From: Req2Batch116100_1loop
	var_1_7 = ((max (var_1_8 , var_1_9)) + (min (var_1_10 , var_1_11)));


	// From: Req4Batch116100_1loop
