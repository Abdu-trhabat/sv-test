...
void functionized1(signed short int functionized1_localFunctionVar0, unsigned char functionized1_localFunctionVar1, unsigned char functionized1_localFunctionVar2, unsigned char functionized1_localFunctionVar3, unsigned long int localFunctionVar4) {
 if (functionized1_localFunctionVar1 || (((((functionized1_localFunctionVar0) > (var_1_3)) ? (functionized1_localFunctionVar0) : (var_1_3))) < ((((functionized1_localFunctionVar3) < (functionized1_localFunctionVar2)) ? (functionized1_localFunctionVar3) : (functionized1_localFunctionVar2))))) {
  var_1_15 = ((((1u) > (functionized1_localFunctionVar3)) ? (1u) : (functionized1_localFunctionVar3)));
 } else {
...
void step(void) {
 if ((var_1_2 / var_1_3) <= 2) {
  if (var_1_3 < (((((~ var_1_2)) < (var_1_4)) ? ((~ var_1_2)) : (var_1_4)))) {
   var_1_1 = ((((var_1_5) < (16)) ? (var_1_5) : (16)));
  } else {
 ...
 if (var_1_5 >= var_1_3) {
  var_1_14 = ((((var_1_2) < (var_1_1)) ? (var_1_2) : (var_1_1)));
 } else {
  var_1_14 = (32 + var_1_1);
 }
...
int property(void) {
 return ((((((((var_1_2 / var_1_3) <= 2) ? ((var_1_3 < (((((~ var_1_2)) < (var_1_4)) ? ((~ var_1_2)) : (var_1_4)))) ? (var_1_1 == ((unsigned char) ((((var_1_5) < (16)) ? (var_1_5) : (16))))) : ((((var_1_6 || var_1_7) && var_1_8) || var_1_9) ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_1 == ((unsigned char) 32)))) : (var_1_1 == ((unsigned char) var_1_5))) && ((var_1_2 <= var_1_5) ? (var_1_10 == ((unsigned char) (var_1_9 || ((var_1_3 != var_1_5) || var_1_11)))) : (var_1_10 == ((unsigned char) (var_1_12 || var_1_13))))) && ((var_1_5 >= var_1_3) ? (var_1_14 == ((signed long int) ((((var_1_2) < (var_1_1)) ? (var_1_2) : (var_1_1))))) : (var_1_14 == ((signed long int) (32 + var_1_1))))) && ((var_1_8 || (((((var_1_16) > (var_1_3)) ? (var_1_16) : (var_1_3))) < ((((var_1_4) < (var_1_2)) ? (var_1_4) : (var_1_2))))) ? (var_1_15 == ((unsigned long int) ((((1u) > (var_1_4)) ? (1u) : (var_1_4))))) : (var_1_15 == ((unsigned long int) 32u)))) && ((var_1_4 < (32 / var_1_3)) ? ((var_1_9 || var_1_7) ? (var_1_17 == ((unsigned long int) var_1_2)) : 1) : 1)) && (var_1_18 == ((unsigned short int) var_1_1))) && (((var_1_16 + var_1_14) < 1) ? (var_1_12 ? (var_1_9 ? (var_1_19 == ((unsigned char) var_1_11)) : 1) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
