...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch179stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch179stepLocals
	if (var_1_10) {
		var_1_12 = (64 - var_1_7);
	}


	// From: Req4Batch179stepLocals
	...
	// From: Req5Batch179stepLocals
	if (var_1_16 != (max (var_1_8 , (var_1_11 + var_1_17)))) {
	...
	// From: Req7Batch179stepLocals
	if ((var_1_15 / (abs (var_1_22))) != var_1_5) {
