...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch127Amount25.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_2 != stepLocal_0) {
  var_1_7 = (((((var_1_8) > (var_1_9)) ? (var_1_8) : (var_1_9))) - 256);
 }
 ...
 if (((((0u) > (var_1_10)) ? (0u) : (var_1_10))) > (~ var_1_10)) {
...
int property(void) {
 return (((((((0u) > (var_1_10)) ? (0u) : (var_1_10))) > (~ var_1_10)) ? (var_1_1 == ((unsigned char) ((! var_1_4) && (last_1_var_1_1 || var_1_6)))) : 1) && ((var_1_2 != var_1_3) ? (var_1_7 == ((signed short int) (((((var_1_8) > (var_1_9)) ? (var_1_8) : (var_1_9))) - 256))) : 1)) && (((var_1_2 * (var_1_7 & var_1_8)) <= var_1_3) ? (var_1_10 == ((unsigned long int) var_1_11)) : ((-128 < var_1_8) ? (var_1_10 == ((unsigned long int) ((var_1_12 - (var_1_13 + var_1_14)) + var_1_15))) : (var_1_10 == ((unsigned long int) var_1_15))))
;
}
int main(void) {
 isInitial = 1;
