...
int property(void) {
	return ((((! var_1_2) ? (var_1_1 == ((signed short int) (min ((var_1_3 + (var_1_4 + var_1_5)) , var_1_6)))) : (var_1_1 == ((signed short int) var_1_5))) && (((var_1_4 << (min (var_1_8 , var_1_9))) != (var_1_10 - var_1_11)) ? (var_1_2 ? (var_1_7 == ((float) var_1_12)) : 1) : (var_1_7 == ((float) var_1_12)))) && (((min (var_1_5 , var_1_9)) < -500) ? (var_1_13 == ((signed char) (var_1_14 - var_1_9))) : (var_1_13 == ((signed char) (min (var_1_14 , (var_1_8 - (var_1_9 + var_1_15)))))))) && ((var_1_5 >= (var_1_10 / (abs (var_1_17)))) ? (var_1_16 == ((signed short int) (abs (var_1_3)))) : 1)
;
}
int main(void) {
	isInitial = 1;
