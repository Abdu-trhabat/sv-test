...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_2_Pointer)) == stepLocal_0) {
		if (stepLocal_1 > (max ((- (*(WrapperStruct00_var_1_3_Pointer))) , (*(WrapperStruct00_var_1_4_Pointer))))) {
	...
	// From: Req4Batch193Wrapper_SP
	(*(WrapperStruct00_var_1_13_Pointer)) = 4;


	// From: Req5Batch193Wrapper_SP
	(*(WrapperStruct00_var_1_14_Pointer)) = (*(WrapperStruct00_var_1_13_Pointer));


	// From: Req2Batch193Wrapper_SP
	if ((*(WrapperStruct00_var_1_6_Pointer))) {
		(*(WrapperStruct00_var_1_5_Pointer)) = ((*(WrapperStruct00_var_1_14_Pointer)) + (max ((min ((*(WrapperStruct00_var_1_1_Pointer)) , (*(WrapperStruct00_var_1_13_Pointer)))) , last_1_WrapperStruct00_var_1_5)));
	}


	// From: Req3Batch193Wrapper_SP
