...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch146Amount25.c", 13, "reach_error"); }
 ...
 if (stepLocal_1 > ((var_1_6 + var_1_5) / var_1_8)) {
  if (stepLocal_3 < var_1_9) {
   if (stepLocal_2 || var_1_13) {
    var_1_7 = ((((((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) > (var_1_15)) ? (((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) : (var_1_15)));
   } else {
    var_1_7 = var_1_15;
   }
  }
...
int property(void) {
 return ((((var_1_1 == ((signed long int) (var_1_2 + (((((16 + var_1_3)) < (((((var_1_4) > (-32)) ? (var_1_4) : (-32))))) ? ((16 + var_1_3)) : (((((var_1_4) > (-32)) ? (var_1_4) : (-32))))))))) && (((var_1_2 ^ (var_1_4 / var_1_6)) >= var_1_3) ? (var_1_5 == ((unsigned long int) var_1_6)) : 1)) && ((var_1_5 > ((var_1_6 + var_1_5) / var_1_8)) ? ((var_1_3 < var_1_9) ? ((var_1_12 || var_1_13) ? (var_1_7 == ((unsigned char) ((((((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) > (var_1_15)) ? (((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) : (var_1_15))))) : (var_1_7 == ((unsigned char) var_1_15))) : 1) : (var_1_7 == ((unsigned char) var_1_15)))) && (var_1_16 == ((unsigned char) var_1_14))) && (var_1_17 == ((double) var_1_18))
;
}
int main(void) {
 isInitial = 1;
