...
void step(void) {
	...
	// From: Req4Batch188Wrapper_SP
	(*(WrapperStruct00_var_1_19_Pointer)) = (*(WrapperStruct00_var_1_18_Pointer));


	// From: Req5Batch188Wrapper_SP
	(*(WrapperStruct00_var_1_20_Pointer)) = (*(WrapperStruct00_var_1_13_Pointer));


	// From: Req3Batch188Wrapper_SP
	if ((abs ((*(WrapperStruct00_var_1_7_Pointer)))) <= (*(WrapperStruct00_var_1_7_Pointer))) {
		if ((*(WrapperStruct00_var_1_1_Pointer)) <= (*(WrapperStruct00_var_1_7_Pointer))) {
			(*(WrapperStruct00_var_1_11_Pointer)) = ((((*(WrapperStruct00_var_1_13_Pointer)) - 4) - (max ((*(WrapperStruct00_var_1_14_Pointer)) , (*(WrapperStruct00_var_1_15_Pointer))))) - ((*(WrapperStruct00_var_1_16_Pointer)) - (*(WrapperStruct00_var_1_17_Pointer))));
		} else {
			(*(WrapperStruct00_var_1_11_Pointer)) = ((min ((*(WrapperStruct00_var_1_18_Pointer)) , (*(WrapperStruct00_var_1_14_Pointer)))) + ((*(WrapperStruct00_var_1_15_Pointer)) + (*(WrapperStruct00_var_1_17_Pointer))));
		}
	} else {
