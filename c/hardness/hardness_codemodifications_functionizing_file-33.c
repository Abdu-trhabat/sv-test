...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch33functionizing.c", 13, "reach_error"); }
...
void functionized4(signed char, unsigned short int, signed long int, signed char);
...
void functionized2(signed long int functionized2_localFunctionVar0) {
	var_1_12 = (! ((var_1_2 < functionized2_localFunctionVar0) || var_1_13));
}
signed long int functionized3(signed char functionized3_localFunctionVar0, signed char functionized3_localFunctionVar1) {
	return (((max (var_1_15 , 1)) - functionized3_localFunctionVar0) + (var_1_17 - (4 + functionized3_localFunctionVar1)));
}
void functionized4(signed char functionized4_localFunctionVar0, unsigned short int functionized4_localFunctionVar1, signed long int functionized4_localFunctionVar2, signed char functionized4_localFunctionVar3) {
	if (var_1_14 >= var_1_11) {
		if ((var_1_17 + (- 256u)) >= (functionized4_localFunctionVar2 % (abs (500u)))) {
			if (var_1_14 >= ((max (functionized4_localFunctionVar3 , var_1_1)) / (min (var_1_20 , var_1_21)))) {
				var_1_19 = var_1_17;
			} else {
				var_1_19 = functionized4_localFunctionVar1;
			}
		} else {
			var_1_19 = functionized4_localFunctionVar0;
		}
	} else {
		var_1_19 = var_1_18;
	}
...
void step(void) {
	...
	// From: Req2Batch33functionizing
	var_1_5 = (max (var_1_2 , var_1_6));


	// From: Req3Batch33functionizing
	if ((functionized0() >= var_1_9) && var_1_10) {
		var_1_7 = var_1_2;
	}


	// From: Req4Batch33functionizing
	if (functionized1(var_1_5)) {
		var_1_11 = ((max (0 , var_1_2)) + 100);
	}


	// From: Req5Batch33functionizing
	functionized2(var_1_4);


	// From: Req6Batch33functionizing
	var_1_14 = (functionized3(var_1_16, var_1_18));


	// From: Req7Batch33functionizing
	functionized4(var_1_16, var_1_7, var_1_4, var_1_15);
}
