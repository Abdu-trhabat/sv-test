...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch195Amount10.c", 13, "reach_error"); }
...
float var_1_1 = 24.8;
double var_1_2 = 127.6;
double var_1_3 = 2.5;
double var_1_4 = 199.6;
double var_1_5 = 4.6;
float var_1_6 = 255.6;
float var_1_7 = 3.9;
float var_1_8 = 50.2;
...
void step(void) {
 if ((var_1_2 * var_1_3) < (- (var_1_4 - var_1_5))) {
  var_1_1 = ((var_1_6 + var_1_7) - (var_1_8 + 0.95f));
 } else {
  var_1_1 = var_1_8;
 }
}
...
int property(void) {
 return ((var_1_2 * var_1_3) < (- (var_1_4 - var_1_5))) ? (var_1_1 == ((float) ((var_1_6 + var_1_7) - (var_1_8 + 0.95f)))) : (var_1_1 == ((float) var_1_8))
;
}
int main(void) {
 isInitial = 1;
