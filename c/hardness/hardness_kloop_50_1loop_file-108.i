...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10850_1loop.c", 13, "reach_error"); }
...
int property(void) {
 return ((((((((var_1_7 * ((((var_1_7) > (var_1_17)) ? (var_1_7) : (var_1_17)))) != 4) ? (var_1_1 == ((float) (var_1_5 + var_1_6))) : (var_1_1 == ((float) var_1_5))) && (((last_1_var_1_13 | 32) > (last_1_var_1_20 + last_1_var_1_22)) ? (var_1_7 == ((unsigned short int) (256 + ((var_1_9 + var_1_10) - var_1_11)))) : (var_1_7 == ((unsigned short int) (var_1_12 - var_1_9))))) && (var_1_14 ? (var_1_13 == ((signed long int) var_1_9)) : (var_1_15 ? (var_1_13 == ((signed long int) (var_1_7 - var_1_16))) : 1))) && (((var_1_7 + var_1_13) >= ((((var_1_7 + var_1_10) < 0 ) ? -(var_1_7 + var_1_10) : (var_1_7 + var_1_10)))) ? (var_1_17 == ((unsigned short int) (((var_1_10 + 10000) + var_1_19) - var_1_9))) : (var_1_17 == ((unsigned short int) var_1_11)))) && ((var_1_9 < var_1_19) ? ((var_1_17 >= 0) ? (var_1_20 == ((unsigned char) var_1_21)) : 1) : 1)) && (var_1_15 ? (var_1_22 == ((unsigned char) (((((var_1_23) > (var_1_24)) ? (var_1_23) : (var_1_24))) - var_1_25))) : 1)) && (var_1_15 ? ((var_1_21 >= 2) ? (var_1_26 == ((signed short int) var_1_10)) : (var_1_26 == ((signed short int) (4 + (16 + var_1_13))))) : (var_1_26 == ((signed short int) (var_1_21 - var_1_13))))
;
}
int main(void) {
 isInitial = 1;
