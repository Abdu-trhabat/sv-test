...
void step(void) {
	...
	// From: Req3Batch155Amount50
	if ((abs (var_1_7)) == var_1_9) {
		var_1_11 = var_1_12;
	}


	// From: Req5Batch155Amount50
	var_1_16 = (var_1_17 + var_1_18);


	// From: Req8Batch155Amount50
	if (var_1_12) {
		var_1_25 = (((abs (var_1_26)) - 25) - var_1_21);
	}


	// From: Req9Batch155Amount50
	if ((~ (abs (var_1_21))) > var_1_10) {
		var_1_27 = 10;
	}


	// From: Req1Batch155Amount50
	if (var_1_11) {
		var_1_1 = var_1_3;
	} else {
