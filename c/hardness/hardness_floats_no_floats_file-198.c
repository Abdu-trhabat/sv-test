...
void step(void) {
	...
	// From: Req1Batch198no_floats
	if (8u <= (- (var_1_12 + 2u))) {
		var_1_1 = ((var_1_4 - (max (var_1_5 , var_1_6))) + (max (var_1_7 , 128)));
	}


	// From: Req2Batch198no_floats
...
int property(void) {
	return ((((8u <= (- (var_1_12 + 2u))) ? (var_1_1 == ((signed long int) ((var_1_4 - (max (var_1_5 , var_1_6))) + (max (var_1_7 , 128))))) : 1) && (((max ((var_1_9 - var_1_10) , var_1_12)) >= var_1_12) ? (var_1_8 == ((signed long int) (var_1_7 + (max (var_1_6 , var_1_4))))) : (var_1_8 == ((signed long int) var_1_7)))) && (((abs (last_1_var_1_1)) < last_1_var_1_8) ? ((var_1_9 <= var_1_11) ? (var_1_12 == ((unsigned long int) (max ((var_1_13 - var_1_10) , (2468038396u - var_1_9))))) : (var_1_12 == ((unsigned long int) (max ((var_1_13 - var_1_9) , var_1_10))))) : 1)) && (var_1_14 == ((signed long int) var_1_9))
;
}
int main(void) {
	isInitial = 1;
