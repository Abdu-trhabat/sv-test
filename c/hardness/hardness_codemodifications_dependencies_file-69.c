...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch69dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch69dependencies
	var_1_21 = var_1_13;


	// From: Req8Batch69dependencies
	var_1_22 = 2.7;
}
