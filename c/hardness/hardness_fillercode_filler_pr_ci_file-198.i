...
void step(void) {
 ...
 signed char stepLocal_3 = var_1_2;
  ...
  var_1_17
    ...
    var_1_26
                     ...
                     var_1_27 = (
                      (((((( var_1_28 ) - ( var_1_8 ))) < 0 ) ? -((( var_1_28 ) - ( var_1_8 ))) : ((( var_1_28 ) - ( var_1_8 )))))
   );
  }
 }
                              var_1_1 = (
 ...
 signed long int stepLocal_2 = var_1_10;
   ...
   var_1_9
                   ...
                   if ( (( (( ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))) * ( ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))))) < (var_1_20))) {
                    if ( (( ((var_1_20) % (var_1_26))) > (var_1_16))) {
                     var_1_25 = (
    var_1_16
   );
  } else {
