...
void step(void) {
	...
	unsigned char stepLocal_2 = var_1_2 > (var_1_4 + var_1_3);
	if (var_1_8 || stepLocal_2) {
		var_1_7 = (min (var_1_1 , (min (-200 , var_1_6))));
	} else {
		if (stepLocal_3 != 1u) {
			var_1_7 = var_1_1;
		} else {
	...
	if ((var_1_10 - var_1_11) >= stepLocal_4) {
		if ((- 999999.75f) > var_1_14) {
			var_1_9 = (var_1_13 + (max (var_1_15 , var_1_16)));
		}
	}
...
int property(void) {
	return (((((var_1_2 * (min (var_1_3 , var_1_4))) < var_1_5) ? ((var_1_5 > var_1_2) ? (var_1_1 == ((signed short int) var_1_6)) : (var_1_1 == ((signed short int) 4))) : 1) && ((var_1_8 || (var_1_2 > (var_1_4 + var_1_3))) ? (var_1_7 == ((signed long int) (min (var_1_1 , (min (-200 , var_1_6)))))) : ((var_1_2 != 1u) ? (var_1_7 == ((signed long int) var_1_1)) : (var_1_7 == ((signed long int) var_1_6))))) && (((var_1_10 - var_1_11) >= (var_1_12 >> var_1_13)) ? (((- 999999.75f) > var_1_14) ? (var_1_9 == ((signed char) (var_1_13 + (max (var_1_15 , var_1_16))))) : 1) : 1)) && (var_1_17 == ((signed char) 4))
;
}
int main(void) {
	isInitial = 1;
