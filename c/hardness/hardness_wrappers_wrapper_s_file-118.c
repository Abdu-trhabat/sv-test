...
void step(void) {
	...
	// From: Req2Batch118Wrapper_S
	signed long int stepLocal_1 = WrapperStruct00.var_1_15;
	if (WrapperStruct00.var_1_4 == stepLocal_1) {
		WrapperStruct00.var_1_6 = ((min (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_8)) + (max ((64 + 8) , WrapperStruct00.var_1_9)));
	} else {
		WrapperStruct00.var_1_6 = (WrapperStruct00.var_1_7 + 4);
	}


	// From: Req3Batch118Wrapper_S
	if ((WrapperStruct00.var_1_11 - WrapperStruct00.var_1_12) < WrapperStruct00.var_1_17) {
		if (WrapperStruct00.var_1_14 || (WrapperStruct00.var_1_15 >= (max (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_3)))) {
