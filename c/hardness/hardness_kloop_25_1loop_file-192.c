...
void step(void) {
	...
	// From: Req1Batch19225_1loop
	signed long int stepLocal_0 = (min (var_1_4 , -5)) + var_1_5;
	if (var_1_7) {
		if ((min (var_1_3 , 0)) <= stepLocal_0) {
			var_1_1 = var_1_6;
		} else {
			var_1_1 = 24.2;
		}
	...
	// From: Req3Batch19225_1loop
	if ((var_1_11 - (min (var_1_12 , var_1_13))) <= (var_1_1 * var_1_6)) {
		var_1_10 = ((max ((var_1_14 + var_1_15) , var_1_16)) - var_1_17);
	} else {
		var_1_10 = var_1_14;
	}
}
...
int property(void) {
	return ((var_1_7 ? (((min (var_1_3 , 0)) <= ((min (var_1_4 , -5)) + var_1_5)) ? (var_1_1 == ((double) var_1_6)) : (var_1_1 == ((double) 24.2))) : (var_1_1 == ((double) 15.5))) && ((var_1_8 >= var_1_4) ? (((var_1_3 + var_1_5) >= var_1_8) ? (var_1_7 == ((unsigned char) var_1_9)) : 1) : 1)) && (((var_1_11 - (min (var_1_12 , var_1_13))) <= (var_1_1 * var_1_6)) ? (var_1_10 == ((signed short int) ((max ((var_1_14 + var_1_15) , var_1_16)) - var_1_17))) : (var_1_10 == ((signed short int) var_1_14)))
;
}
int main(void) {
	isInitial = 1;
