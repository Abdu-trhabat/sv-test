...
void step(void) {
	...
	if (! var_1_13) {
		var_1_14 = ((max ((var_1_15 + var_1_16) , var_1_17)) + (abs (var_1_18 + var_1_19)));
	} else {
		if (var_1_13) {
			var_1_14 = var_1_19;
		}
...
int property(void) {
	return (((var_1_1 == ((double) ((var_1_2 - var_1_3) - var_1_4))) && (var_1_5 == ((float) ((var_1_3 - var_1_6) + var_1_7)))) && ((25 <= ((100000000 + var_1_9) - var_1_10)) ? ((1 >= var_1_9) ? (((abs (var_1_11 - 8)) == var_1_10) ? (var_1_8 == ((unsigned char) (var_1_12 && (! 0)))) : (var_1_8 == ((unsigned char) (var_1_12 && var_1_13)))) : 1) : 1)) && ((! var_1_13) ? (var_1_14 == ((unsigned char) ((max ((var_1_15 + var_1_16) , var_1_17)) + (abs (var_1_18 + var_1_19))))) : (var_1_13 ? (var_1_14 == ((unsigned char) var_1_19)) : 1))
;
}
int main(void) {
	isInitial = 1;
