...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (! ((*(var_1_13_Pointer)) < (127.125 / (*(var_1_12_Pointer))))) {
		if ((*(var_1_1_Pointer)) <= (((*(var_1_4_Pointer)) * (*(var_1_3_Pointer))) + (4 << (*(var_1_16_Pointer))))) {
...
void updateVariables(void) {
	...
	assume_abort_if_not(var_1_16 <= 28);
}
