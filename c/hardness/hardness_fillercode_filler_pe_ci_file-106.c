...
void step(void) {
	...
	// From: Req5Batch106Filler_PE_CI
	/* 938L, 149L, 609L, 615L) */ var_1_15 = (
		var_1_6
	);


	// From: Req6Batch106Filler_PE_CI
	...
	// From: Req8Batch106Filler_PE_CI
	/* 987L, 227L, 773L, 779L) */ var_1_23 = (
		var_1_24
	);


	// From: Req10Batch106Filler_PE_CI
	/* 999L, 247L, 821L, 827L) */ var_1_26 = (
		var_1_23
	);


	// From: Req3Batch106Filler_PE_CI
	...
	/* 301L, 183L) */ if (/* 302L, 115L, 116L) */ ((/* 303L, 113L, 117L) */ ((var_1_30) & (var_1_33))) <= (var_1_39))) {
		/* 307L, 149L) */ if (var_1_2) {
			/* 309L, 142L) */ if (/* 310L, 131L, 132L) */ ((var_1_22) <= (var_1_45))) {
				/* 313L, 141L) */ var_1_47 = (
					var_1_30
				);
			}
		...
		/* 322L, 181L) */ if (/* 323L, 160L, 161L) */ ((var_1_22) >= (/* 325L, 159L, 163L) */ ((var_1_21) * (/* 327L, 158L, 165L) */ (abs (var_1_45))))))) {
			/* 329L, 176L) */ var_1_47 = (
				var_1_31
			);
		} else {
	...
	// From: CodeObject8
	/* 337L, 226L) */ if (/* 338L, 194L, 195L) */ ((/* 339L, 191L, 196L) */ (min (/* 339L, 191L, 196L) */ (/* 340L, 189L, 197L) */ (min (/* 340L, 189L, 197L) */ (var_1_22) , (var_1_21)))) , (var_1_22)))) < (/* 344L, 193L, 201L) */ (- (var_1_21))))) {
		/* 346L, 224L) */ if (var_1_17) {
			/* 348L, 219L) */ var_1_49 = (
				/* 351L, 218L) */ ((
					var_1_50
				) || (
