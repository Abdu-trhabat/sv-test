...
int property(void) {
	return (((var_1_2 || var_1_3) ? (var_1_1 == ((signed long int) ((256 + var_1_4) - (min (var_1_5 , var_1_6))))) : ((var_1_4 <= var_1_6) ? (var_1_1 == ((signed long int) var_1_6)) : 1)) && (var_1_3 ? ((var_1_1 >= var_1_4) ? ((((var_1_5 + var_1_1) < (var_1_6 * var_1_4)) && var_1_2) ? (var_1_7 == ((unsigned short int) var_1_8)) : (var_1_7 == ((unsigned short int) 5))) : (var_1_7 == ((unsigned short int) var_1_8))) : 1)) && ((var_1_4 <= var_1_7) ? (((! var_1_3) && var_1_2) ? ((var_1_8 > var_1_1) ? ((var_1_4 <= var_1_6) ? (var_1_9 == ((signed long int) var_1_10)) : (var_1_9 == ((signed long int) 1))) : (var_1_9 == ((signed long int) var_1_10))) : (var_1_9 == ((signed long int) var_1_10))) : 1)
;
}
int main(void) {
	isInitial = 1;
