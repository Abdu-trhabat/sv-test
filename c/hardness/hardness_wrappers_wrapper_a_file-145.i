...
void step(void) {
 ...
 if (double_Array_0[2] <= ((((double_Array_0[0]) < (double_Array_0[1])) ? (double_Array_0[0]) : (double_Array_0[1])))) {
  if (((((signed_long_int_Array_0[0]) < ((signed_long_int_Array_0[0] & unsigned_short_int_Array_0[3]))) ? (signed_long_int_Array_0[0]) : ((signed_long_int_Array_0[0] & unsigned_short_int_Array_0[3])))) < stepLocal_3) {
   signed_short_int_Array_0[1] = unsigned_short_int_Array_0[2];
  } else {
   signed_short_int_Array_0[1] = ((((((((unsigned_short_int_Array_0[1]) < (unsigned_short_int_Array_0[2])) ? (unsigned_short_int_Array_0[1]) : (unsigned_short_int_Array_0[2])))) < (signed_short_int_Array_0[0])) ? (((((unsigned_short_int_Array_0[1]) < (unsigned_short_int_Array_0[2])) ? (unsigned_short_int_Array_0[1]) : (unsigned_short_int_Array_0[2])))) : (signed_short_int_Array_0[0])));
  }
 } else {
  signed_short_int_Array_0[1] = unsigned_short_int_Array_0[2];
 }
...
int property(void) {
 return (((((signed_long_int_Array_0[4] + signed_long_int_Array_0[3]) <= signed_long_int_Array_0[2]) ? (unsigned_short_int_Array_0[4] == ((unsigned short int) ((unsigned_short_int_Array_0[3] + (unsigned_short_int_Array_0[2] + unsigned_short_int_Array_0[1])) - unsigned_short_int_Array_0[0]))) : 1) && ((((10 > signed_long_int_Array_0[1]) && BOOL_unsigned_char_Array_0[1]) || BOOL_unsigned_char_Array_0[0]) ? ((unsigned_short_int_Array_0[3] >= signed_long_int_Array_0[1]) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[0])) : 1) : (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[4])))) && ((signed_long_int_Array_0[0] != unsigned_short_int_Array_0[0]) ? (double_Array_0[0] == ((double) double_Array_0[2])) : 1)) && ((double_Array_0[2] <= ((((double_Array_0[0]) < (double_Array_0[1])) ? (double_Array_0[0]) : (double_Array_0[1])))) ? ((((((signed_long_int_Array_0[0]) < ((signed_long_int_Array_0[0] & unsigned_short_int_Array_0[3]))) ? (signed_long_int_Array_0[0]) : ((signed_long_int_Array_0[0] & unsigned_short_int_Array_0[3])))) < unsigned_short_int_Array_0[0]) ? (signed_short_int_Array_0[1] == ((signed short int) unsigned_short_int_Array_0[2])) : (signed_short_int_Array_0[1] == ((signed short int) ((((((((unsigned_short_int_Array_0[1]) < (unsigned_short_int_Array_0[2])) ? (unsigned_short_int_Array_0[1]) : (unsigned_short_int_Array_0[2])))) < (signed_short_int_Array_0[0])) ? (((((unsigned_short_int_Array_0[1]) < (unsigned_short_int_Array_0[2])) ? (unsigned_short_int_Array_0[1]) : (unsigned_short_int_Array_0[2])))) : (signed_short_int_Array_0[0])))))) : (signed_short_int_Array_0[1] == ((signed short int) unsigned_short_int_Array_0[2])))
;
}
int main(void) {
 isInitial = 1;
