...
void step(void) {
	...
	// From: Req11Batch184100_1loop
	if ((var_1_5 > (~ var_1_7)) || var_1_11) {
		var_1_27 = (abs (var_1_28));
	}


	// From: Req1Batch184100_1loop
