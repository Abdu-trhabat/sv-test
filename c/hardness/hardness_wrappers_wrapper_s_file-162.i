...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch162Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 if (((((last_1_WrapperStruct00_var_1_17) < (10.3)) ? (last_1_WrapperStruct00_var_1_17) : (10.3))) >= last_1_WrapperStruct00_var_1_17) {
  ...
  WrapperStruct00.var_1_1 = (WrapperStruct00.var_1_4 + (499.94 - (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7)));
 }
 if (WrapperStruct00.var_1_18 || ((WrapperStruct00.var_1_1 * last_1_WrapperStruct00_var_1_17) <= WrapperStruct00.var_1_5)) {
  if (WrapperStruct00.var_1_10 >= WrapperStruct00.var_1_12) {
   WrapperStruct00.var_1_17 = WrapperStruct00.var_1_6;
  } else {
   WrapperStruct00.var_1_17 = 1.45;
  }
 } else {
  WrapperStruct00.var_1_17 = 128.2;
 }
 ...
 if ((last_1_WrapperStruct00_var_1_8 * (25 + 64)) != stepLocal_1) {
  if ((last_1_WrapperStruct00_var_1_8 - WrapperStruct00.var_1_11) == stepLocal_0) {
   WrapperStruct00.var_1_8 = WrapperStruct00.var_1_12;
  } else {
   WrapperStruct00.var_1_8 = 16;
  }
 }
 if (WrapperStruct00.var_1_1 < WrapperStruct00.var_1_17) {
...
int property(void) {
 return ((((((((last_1_WrapperStruct00_var_1_17) < (10.3)) ? (last_1_WrapperStruct00_var_1_17) : (10.3))) >= last_1_WrapperStruct00_var_1_17) ? (WrapperStruct00.var_1_1 == ((double) (WrapperStruct00.var_1_4 + WrapperStruct00.var_1_5))) : (WrapperStruct00.var_1_1 == ((double) (WrapperStruct00.var_1_4 + (499.94 - (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7)))))) && (((last_1_WrapperStruct00_var_1_8 * (25 + 64)) != WrapperStruct00.var_1_10) ? (((last_1_WrapperStruct00_var_1_8 - WrapperStruct00.var_1_11) == WrapperStruct00.var_1_10) ? (WrapperStruct00.var_1_8 == ((unsigned char) WrapperStruct00.var_1_12)) : (WrapperStruct00.var_1_8 == ((unsigned char) 16))) : 1)) && ((WrapperStruct00.var_1_1 < WrapperStruct00.var_1_17) ? (WrapperStruct00.var_1_13 == ((signed char) WrapperStruct00.var_1_14)) : (WrapperStruct00.var_1_13 == ((signed char) (WrapperStruct00.var_1_15 - WrapperStruct00.var_1_16))))) && ((WrapperStruct00.var_1_18 || ((WrapperStruct00.var_1_1 * last_1_WrapperStruct00_var_1_17) <= WrapperStruct00.var_1_5)) ? ((WrapperStruct00.var_1_10 >= WrapperStruct00.var_1_12) ? (WrapperStruct00.var_1_17 == ((double) WrapperStruct00.var_1_6)) : (WrapperStruct00.var_1_17 == ((double) 1.45))) : (WrapperStruct00.var_1_17 == ((double) 128.2)))
;
}
int main(void) {
 isInitial = 1;
