...
void step(void) {
	...
	if (! last_1_var_1_58) {
		var_1_18 = (min ((abs (last_1_var_1_30)) , var_1_16));
	} else {
	...
	if (((~ var_1_26) * var_1_31) < stepLocal_14) {
		var_1_46 = (abs (var_1_12 - var_1_10));
	} else {
		if (var_1_30 == stepLocal_15) {
			var_1_46 = (max ((min (500 , var_1_29)) , (var_1_17 + var_1_18)));
		}
	}
	...
	signed long int stepLocal_0 = abs (5 - var_1_10);
	if (stepLocal_0 != ((max (-10000 , var_1_1)) * var_1_8)) {
	...
	if (stepLocal_4 != (- (max (25 , var_1_17)))) {
	...
	if ((var_1_63 * 8.2) < 10.4) {
		var_1_6 = (((abs (var_1_8)) - last_1_var_1_6) - (min (var_1_25 , var_1_5)));
	} else {
		var_1_6 = (abs (var_1_5 + var_1_25));
	}
	...
	unsigned char stepLocal_13 = var_1_11 >= (max (var_1_15 , var_1_29));
	signed long int stepLocal_12 = var_1_11 | 25;
	signed long int stepLocal_11 = var_1_12 & var_1_11;
	signed long int stepLocal_10 = max (0 , var_1_41);
	...
	// From: Req24Batch66Amount250
	unsigned long int stepLocal_18 = var_1_54;
	if (-128 != stepLocal_18) {
		var_1_62 = (min (var_1_40 , var_1_36));
	}
	...
	if (var_1_21 > var_1_54) {
		if (var_1_18 > var_1_54) {
			var_1_51 = (min ((var_1_22 + var_1_16) , var_1_24));
		} else {
			if ((- var_1_17) >= var_1_46) {
				if ((min (var_1_29 , var_1_46)) <= var_1_11) {
					var_1_51 = ((max ((var_1_17 + 10) , var_1_12)) + 16);
				} else {
					var_1_51 = 100;
				}
			}
		...
		var_1_51 = (var_1_17 + (max (var_1_15 , (max (var_1_24 , var_1_12)))));
	}
...
int property(void) {
	return (((((((((((((((((((((((((var_1_55 >= last_1_var_1_1) ? (var_1_58 ? (var_1_1 == ((unsigned short int) (var_1_5 - var_1_55))) : 1) : 1) && (((var_1_63 * 8.2) < 10.4) ? (var_1_6 == ((unsigned long int) (((abs (var_1_8)) - last_1_var_1_6) - (min (var_1_25 , var_1_5))))) : (var_1_6 == ((unsigned long int) (abs (var_1_5 + var_1_25)))))) && (((abs (5 - var_1_10)) != ((max (-10000 , var_1_1)) * var_1_8)) ? ((((var_1_8 * var_1_18) * -4) < var_1_1) ? ((var_1_1 < (var_1_10 % (var_1_11 + var_1_12))) ? ((! var_1_58) ? (var_1_9 == ((float) var_1_13)) : 1) : (var_1_9 == ((float) var_1_13))) : (var_1_9 == ((float) var_1_13))) : (var_1_9 == ((float) var_1_13)))) && ((((- var_1_12) == var_1_61) && (var_1_54 < var_1_20)) ? (var_1_14 == ((signed char) (2 - var_1_15))) : (((abs (var_1_8)) < var_1_5) ? (var_1_14 == ((signed char) (max (((var_1_16 - var_1_17) - var_1_15) , 16)))) : 1))) && ((! last_1_var_1_58) ? (var_1_18 == ((unsigned long int) (min ((abs (last_1_var_1_30)) , var_1_16)))) : (var_1_18 == ((unsigned long int) (var_1_10 + last_1_var_1_46))))) && ((var_1_47 || var_1_58) ? (var_1_20 == ((unsigned char) ((var_1_21 + var_1_22) - var_1_15))) : 1)) && ((var_1_13 < (var_1_63 + (- var_1_62))) ? (var_1_23 == ((unsigned char) (var_1_24 + var_1_15))) : ((! var_1_47) ? (var_1_23 == ((unsigned char) ((abs (var_1_22)) + (var_1_21 - var_1_17)))) : 1))) && ((var_1_16 <= var_1_30) ? (var_1_25 == ((signed short int) (var_1_15 + var_1_1))) : 1)) && ((var_1_1 != (- (max (25 , var_1_17)))) ? (var_1_27 == ((signed char) (min (var_1_15 , var_1_17)))) : (var_1_27 == ((signed char) var_1_17)))) && ((var_1_30 < (var_1_26 - var_1_21)) ? (var_1_28 == ((unsigned short int) (var_1_30 + (var_1_21 + (var_1_29 - var_1_15))))) : 1)) && ((var_1_18 != var_1_26) ? (var_1_30 == ((unsigned char) ((var_1_31 - 10) - var_1_16))) : (var_1_30 == ((unsigned char) (abs (var_1_31 - var_1_24)))))) && (((var_1_5 - var_1_12) < var_1_28) ? (((var_1_63 / var_1_33) != var_1_13) ? (var_1_32 == ((double) (var_1_34 - (min ((255.2 + var_1_35) , var_1_36))))) : (var_1_58 ? (var_1_32 == ((double) (min ((min ((max (var_1_35 , var_1_36)) , var_1_13)) , (abs (var_1_34)))))) : (var_1_32 == ((double) ((var_1_37 - var_1_35) - var_1_36))))) : ((! var_1_58) ? ((var_1_5 >= (- var_1_55)) ? (var_1_32 == ((double) (min ((min (var_1_34 , var_1_36)) , var_1_13)))) : (var_1_32 == ((double) (var_1_36 - var_1_34)))) : 1))) && ((var_1_11 > (var_1_18 * var_1_51)) ? (var_1_38 == ((double) ((abs (var_1_35 + var_1_40)) - var_1_36))) : (var_1_38 == ((double) var_1_34)))) && (((var_1_6 > var_1_1) && ((var_1_31 <= var_1_29) || var_1_58)) ? (var_1_41 == ((signed char) (max (var_1_17 , (min (var_1_16 , -16)))))) : 1)) && (((var_1_11 >= (max (var_1_15 , var_1_29))) || (var_1_33 > var_1_32)) ? (var_1_43 == ((signed char) (max ((var_1_17 + (max (var_1_44 , var_1_45))) , var_1_31)))) : (((max (0 , var_1_41)) < var_1_16) ? (var_1_43 == ((signed char) (abs (abs (var_1_44))))) : (((var_1_11 | 25) == var_1_8) ? (((var_1_12 & var_1_11) == (last_1_var_1_43 * var_1_17)) ? (var_1_43 == ((signed char) (var_1_16 - var_1_17))) : 1) : 1)))) && ((((~ var_1_26) * var_1_31) < ((var_1_5 * var_1_21) | 1)) ? (var_1_46 == ((signed long int) (abs (var_1_12 - var_1_10)))) : ((var_1_30 == var_1_5) ? (var_1_46 == ((signed long int) (max ((min (500 , var_1_29)) , (var_1_17 + var_1_18))))) : 1))) && ((var_1_63 <= (var_1_40 + var_1_32)) ? (var_1_47 == ((unsigned char) var_1_48)) : ((var_1_17 > var_1_6) ? (var_1_47 == ((unsigned char) var_1_49)) : (var_1_47 == ((unsigned char) (var_1_48 && var_1_50)))))) && ((var_1_21 > var_1_54) ? ((var_1_18 > var_1_54) ? (var_1_51 == ((unsigned char) (min ((var_1_22 + var_1_16) , var_1_24)))) : (((- var_1_17) >= var_1_46) ? (((min (var_1_29 , var_1_46)) <= var_1_11) ? (var_1_51 == ((unsigned char) ((max ((var_1_17 + 10) , var_1_12)) + 16))) : (var_1_51 == ((unsigned char) 100))) : 1)) : (var_1_51 == ((unsigned char) (var_1_17 + (max (var_1_15 , (max (var_1_24 , var_1_12))))))))) && (var_1_47 ? (var_1_54 == ((unsigned long int) (var_1_8 - var_1_5))) : 1)) && (last_1_var_1_47 ? (var_1_55 == ((signed long int) (var_1_11 - (var_1_56 - 100)))) : ((last_1_var_1_61 != (var_1_24 - var_1_16)) ? (var_1_55 == ((signed long int) ((var_1_56 - var_1_16) - ((var_1_57 - last_1_var_1_46) + 100000000)))) : (var_1_55 == ((signed long int) (var_1_45 + last_1_var_1_55)))))) && ((var_1_18 < var_1_11) ? (var_1_58 == ((unsigned char) var_1_49)) : (var_1_58 == ((unsigned char) var_1_59)))) && (var_1_47 ? (var_1_60 == ((float) var_1_40)) : (var_1_60 == ((float) var_1_36)))) && ((var_1_5 > var_1_12) ? (var_1_61 == ((signed short int) var_1_55)) : ((var_1_20 <= var_1_15) ? (var_1_61 == ((signed short int) var_1_12)) : 1))) && ((-128 != var_1_54) ? (var_1_62 == ((double) (min (var_1_40 , var_1_36)))) : 1)) && (var_1_63 == ((double) 4.75))
;
}
int main(void) {
	isInitial = 1;
