...
void step(void) {
	...
	if (100u != last_1_var_1_15) {
		if ((var_1_68 - (var_1_52 - var_1_34)) > ((var_1_51 ^ last_1_var_1_15) / var_1_37)) {
			...
			var_1_81 = (min (var_1_55 , var_1_14));
		}
	} else {
		if (-2 <= var_1_52) {
			var_1_81 = (min ((var_1_12 + var_1_11) , (var_1_58 + var_1_55)));
		} else {
			if (last_1_var_1_100 != var_1_73) {
				if ((max (1.5f , (0.7f / var_1_54))) >= var_1_55) {
					if (last_1_var_1_71 <= last_1_var_1_65) {
						var_1_81 = (min ((var_1_55 + var_1_12) , (abs (1.8 - var_1_58))));
					} else {
						var_1_81 = (min (var_1_55 , (var_1_57 - var_1_58)));
					}
				} else {
					var_1_81 = (var_1_55 - (min (var_1_58 , var_1_14)));
				}
			}
		}
	}
	...
	// From: Req24Batch179Amount500
	if ((7.375 - (abs (var_1_57))) >= var_1_81) {
		var_1_71 = (min (last_1_var_1_71 , var_1_19));
	} else {
		var_1_71 = (max (var_1_73 , var_1_20));
	}


	// From: Req21Batch179Amount500
	if (var_1_58 != (last_1_var_1_9 / var_1_54)) {
		var_1_65 = ((min (var_1_19 , var_1_66)) - var_1_7);
	}


	// From: Req40Batch179Amount500
	if (var_1_97) {
		var_1_93 = var_1_39;
	}


	// From: Req7Batch179Amount500
	if (last_1_var_1_75 < var_1_14) {
		var_1_26 = (var_1_28 || (var_1_29 || var_1_30));
	}


	// From: Req43Batch179Amount500
	if (var_1_26) {
		var_1_96 = var_1_44;
	}


	// From: Req4Batch179Amount500
	unsigned long int stepLocal_6 = ~ var_1_65;
	if (((var_1_5 + var_1_7) >> var_1_22) < stepLocal_6) {
		var_1_21 = (max (var_1_7 , var_1_22));
	}


	// From: Req5Batch179Amount500
	if (var_1_26) {
		var_1_23 = (var_1_5 + (var_1_24 - var_1_22));
	}


	// From: Req8Batch179Amount500
	if (! var_1_30) {
		if (var_1_97) {
			if ((var_1_4 * -32) < (var_1_24 / (max (var_1_19 , var_1_16)))) {
				var_1_31 = var_1_11;
			} else {
				var_1_31 = var_1_12;
			}
	...
	// From: Req22Batch179Amount500
	var_1_67 = ((var_1_68 - (var_1_33 + var_1_34)) - var_1_22);


	// From: Req23Batch179Amount500
	if (var_1_26) {
		var_1_69 = ((var_1_56 + var_1_70) + var_1_58);
	}


	// From: Req33Batch179Amount500
	var_1_85 = (min (2 , (var_1_51 + (var_1_52 - var_1_22))));


	// From: Req36Batch179Amount500
	if (var_1_29) {
		var_1_88 = var_1_24;
	}


	// From: Req37Batch179Amount500
	var_1_89 = var_1_22;


	// From: Req38Batch179Amount500
	if (var_1_30) {
		var_1_90 = var_1_91;
	} else {
		var_1_90 = var_1_11;
	...
	// From: Req39Batch179Amount500
	var_1_92 = var_1_52;


	// From: Req41Batch179Amount500
	if (var_1_30) {
		var_1_94 = 0.2f;
	} else {
		var_1_94 = var_1_14;
	...
	// From: Req42Batch179Amount500
	var_1_95 = var_1_20;


	// From: Req45Batch179Amount500
	var_1_99 = var_1_68;


	// From: Req46Batch179Amount500
	if (var_1_98) {
		var_1_100 = var_1_101;
	}


	// From: Req47Batch179Amount500
	if (var_1_76) {
		var_1_102 = var_1_10;
	}


	// From: Req48Batch179Amount500
	if (var_1_29) {
		var_1_103 = 128;
	} else {
		var_1_103 = var_1_101;
	...
	// From: Req49Batch179Amount500
	var_1_104 = var_1_101;


	// From: Req50Batch179Amount500
	if (var_1_79 > ((var_1_106 - var_1_5) - var_1_101)) {
		var_1_105 = ((var_1_106 + (var_1_20 - var_1_24)) + var_1_95);
	}


	// From: Req51Batch179Amount500
	var_1_107 = var_1_6;


	// From: Req52Batch179Amount500
	var_1_108 = var_1_68;


	// From: Req3Batch179Amount500
	...
	if (var_1_8 <= stepLocal_3) {
		if ((max ((var_1_107 % var_1_16) , var_1_4)) >= stepLocal_5) {
			if (var_1_76) {
				if ((- var_1_10) <= (- (abs (var_1_81)))) {
					if ((var_1_7 + var_1_6) == stepLocal_4) {
						var_1_15 = ((var_1_19 - (var_1_20 - var_1_8)) - (var_1_4 + var_1_107));
					} else {
						var_1_15 = (max (var_1_19 , 16u));
					}
				} else {
					var_1_15 = (max (var_1_16 , var_1_5));
				}
			} else {
	...
	// From: Req19Batch179Amount500
	unsigned long int stepLocal_23 = var_1_95 / var_1_20;
	if (var_1_26) {
		if (4 < stepLocal_23) {
			var_1_61 = ((min ((var_1_96 + var_1_22) , (var_1_7 + var_1_99))) - var_1_51);
		}
	}


	// From: Req16Batch179Amount500
	...
	if (stepLocal_17 > var_1_105) {
		if (var_1_38 <= stepLocal_18) {
			var_1_50 = (var_1_33 + (max (var_1_34 , var_1_22)));
		} else {
	...
	// From: Req20Batch179Amount500
	unsigned short int stepLocal_24 = var_1_7;
	if ((~ (var_1_6 + var_1_67)) < stepLocal_24) {
		var_1_63 = ((min (var_1_37 , var_1_64)) - (min ((max (32 , var_1_8)) , (max (var_1_34 , var_1_39)))));
	} else {
		var_1_63 = (var_1_37 - (max (25 , var_1_8)));
	}


	// From: Req25Batch179Amount500
	if (var_1_7 > var_1_105) {
		var_1_74 = var_1_54;
	}


	// From: Req1Batch179Amount500
	...
	// From: Req31Batch179Amount500
	if ((var_1_30 || var_1_97) && (var_1_1 > 16)) {
		if (var_1_97) {
			var_1_83 = (max (var_1_65 , (min ((var_1_34 + var_1_1) , var_1_51))));
		} else {
			var_1_83 = var_1_66;
		}
	}
	...
	if (var_1_22 > stepLocal_28) {
		...
		if (stepLocal_27 <= var_1_66) {
			var_1_77 = (max (var_1_54 , 8.8));
		} else {
			var_1_77 = ((var_1_55 + (max (var_1_58 , var_1_56))) - var_1_57);
		}
	}


	// From: Req29Batch179Amount500
	if (var_1_17 && var_1_76) {
		if (var_1_76) {
			if (var_1_42 > (abs (var_1_7))) {
				if (((var_1_107 + var_1_60) + var_1_83) < 256u) {
					var_1_78 = (var_1_22 + var_1_6);
				} else {
					var_1_78 = (var_1_64 - (max ((var_1_24 - var_1_16) , (var_1_79 - var_1_93))));
				}
			} else {
				var_1_78 = (((var_1_80 - var_1_33) + (var_1_6 - var_1_68)) + (var_1_79 - var_1_7));
			}
		} else {
			if ((var_1_58 * var_1_70) > (max (var_1_77 , var_1_81))) {
				var_1_78 = var_1_16;
			} else {
				if (last_1_var_1_78 != var_1_79) {
					var_1_78 = (min ((var_1_16 + var_1_24) , var_1_38));
				} else {
	...
	if (stepLocal_8 < (var_1_71 * var_1_47)) {
		if (var_1_77 == var_1_31) {
			...
			var_1_32 = (abs ((var_1_33 + var_1_22) + var_1_34));
		}
	} else {
		if (stepLocal_7 <= 128) {
	...
	if (stepLocal_20 > -5) {
		if (stepLocal_22 <= var_1_1) {
			...
			if (var_1_107 > stepLocal_21) {
				var_1_53 = ((max (var_1_55 , var_1_56)) + var_1_58);
			} else {
				if (8 < stepLocal_19) {
					var_1_53 = (var_1_54 - var_1_14);
				} else {
					var_1_53 = (min (4.6f , var_1_54));
				}
			}
		}
	} else {
		var_1_53 = ((max ((min (var_1_12 , var_1_56)) , var_1_58)) + (max (var_1_55 , var_1_11)));
	}


	// From: Req18Batch179Amount500
	if ((var_1_90 / var_1_55) != var_1_12) {
		if (var_1_90 >= var_1_81) {
			var_1_59 = (var_1_22 - 25);
		} else {
			if ((min (var_1_55 , var_1_54)) >= var_1_81) {
	...
	// From: Req35Batch179Amount500
	unsigned short int stepLocal_30 = var_1_78;
	if (stepLocal_30 < ((abs (var_1_8)) + var_1_61)) {
		var_1_87 = var_1_70;
	}


	// From: Req2Batch179Amount500
	...
	if (var_1_78 > stepLocal_2) {
		...
		if ((min (var_1_65 , (var_1_4 + 5u))) > stepLocal_0) {
			var_1_9 = (var_1_14 - 7.15);
		}
	}


	// From: Req6Batch179Amount500
	if (var_1_97) {
		var_1_25 = (var_1_7 + ((max (5 , 64)) - var_1_24));
	} else {
		var_1_25 = (var_1_47 - var_1_24);
	}


	// From: Req26Batch179Amount500
	unsigned char stepLocal_25 = var_1_97;
	if (stepLocal_25 || (var_1_25 > var_1_107)) {
		var_1_75 = var_1_70;
	} else {
		var_1_75 = (max ((var_1_56 + var_1_70) , 5.2));
	}


	// From: Req11Batch179Amount500
	unsigned char stepLocal_10 = var_1_16;
	signed long int stepLocal_9 = - var_1_21;
	if (var_1_84 <= stepLocal_10) {
		var_1_36 = (var_1_24 + (min (var_1_7 , var_1_8)));
	} else {
		if (var_1_26) {
			if (stepLocal_9 == var_1_33) {
				var_1_36 = ((max (var_1_24 , var_1_6)) + var_1_7);
			} else {
				var_1_36 = (var_1_37 - var_1_38);
			}
		} else {
			if (var_1_81 > (var_1_10 / 10.4)) {
				var_1_36 = ((max (var_1_37 , (var_1_24 + 29482))) - var_1_34);
			} else {
				if (var_1_97) {
	...
	if (var_1_14 > var_1_75) {
		...
		var_1_40 = (abs (min (var_1_34 , var_1_84)));
	}


	// From: Req14Batch179Amount500
	signed long int stepLocal_15 = (var_1_34 / var_1_22) / var_1_24;
	unsigned long int stepLocal_14 = max (var_1_105 , (var_1_84 * var_1_95));
	...
	if (stepLocal_15 != var_1_95) {
		...
		if (stepLocal_14 > var_1_6) {
			if (((var_1_34 - var_1_24) | var_1_4) != stepLocal_13) {
				if (var_1_29) {
					var_1_43 = (((max (var_1_22 , var_1_16)) - var_1_6) + var_1_44);
				} else {
					if (var_1_30) {
						if ((var_1_14 - (min (var_1_45 , var_1_46))) == var_1_9) {
							var_1_43 = ((max (var_1_16 , var_1_5)) - var_1_4);
						}
					} else {
				...
				var_1_43 = (var_1_5 - ((max (var_1_34 , var_1_22)) + var_1_33));
			}
		} else {
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((last_1_var_1_1 >= var_1_61) ? (var_1_1 == ((unsigned short int) (((min (var_1_4 , var_1_5)) + (var_1_6 - var_1_7)) + (max (var_1_8 , 16))))) : (var_1_1 == ((unsigned short int) (max ((var_1_7 + var_1_6) , var_1_8))))) && ((var_1_78 > var_1_4) ? ((var_1_7 >= var_1_63) ? (var_1_9 == ((double) var_1_10)) : (var_1_9 == ((double) (var_1_11 + var_1_12)))) : (((min (var_1_65 , (var_1_4 + 5u))) > 10000u) ? (var_1_9 == ((double) (var_1_14 - 7.15))) : 1))) && ((var_1_8 <= var_1_96) ? (((max ((var_1_107 % var_1_16) , var_1_4)) >= var_1_6) ? (var_1_76 ? (((- var_1_10) <= (- (abs (var_1_81)))) ? (((var_1_7 + var_1_6) == ((var_1_8 << var_1_16) / -200)) ? (var_1_15 == ((unsigned long int) ((var_1_19 - (var_1_20 - var_1_8)) - (var_1_4 + var_1_107)))) : (var_1_15 == ((unsigned long int) (max (var_1_19 , 16u))))) : (var_1_15 == ((unsigned long int) (max (var_1_16 , var_1_5))))) : (var_1_15 == ((unsigned long int) ((var_1_5 + var_1_107) + var_1_4)))) : (var_1_15 == ((unsigned long int) var_1_19))) : 1)) && ((((var_1_5 + var_1_7) >> var_1_22) < (~ var_1_65)) ? (var_1_21 == ((unsigned short int) (max (var_1_7 , var_1_22)))) : 1)) && (var_1_26 ? (var_1_23 == ((unsigned short int) (var_1_5 + (var_1_24 - var_1_22)))) : 1)) && (var_1_97 ? (var_1_25 == ((signed long int) (var_1_7 + ((max (5 , 64)) - var_1_24)))) : (var_1_25 == ((signed long int) (var_1_47 - var_1_24))))) && ((last_1_var_1_75 < var_1_14) ? (var_1_26 == ((unsigned char) (var_1_28 || (var_1_29 || var_1_30)))) : 1)) && ((! var_1_30) ? (var_1_97 ? (((var_1_4 * -32) < (var_1_24 / (max (var_1_19 , var_1_16)))) ? (var_1_31 == ((float) var_1_11)) : (var_1_31 == ((float) var_1_12))) : (var_1_31 == ((float) var_1_10))) : (var_1_31 == ((float) var_1_12)))) && ((var_1_7 < (var_1_71 * var_1_47)) ? ((var_1_77 == var_1_31) ? (var_1_32 == ((unsigned char) (128 - ((var_1_22 + var_1_33) + (10 + var_1_34))))) : (var_1_32 == ((unsigned char) (abs ((var_1_33 + var_1_22) + var_1_34))))) : ((var_1_21 <= 128) ? (var_1_32 == ((unsigned char) (10 + (var_1_34 + var_1_22)))) : 1))) && ((var_1_92 >= (var_1_6 * var_1_88)) ? ((((var_1_19 ^ var_1_92) + -2) <= var_1_83) ? (var_1_29 ? (var_1_35 == ((signed short int) var_1_7)) : (var_1_35 == ((signed short int) var_1_4))) : (var_1_35 == ((signed short int) var_1_34))) : 1)) && ((var_1_84 <= var_1_16) ? (var_1_36 == ((unsigned short int) (var_1_24 + (min (var_1_7 , var_1_8))))) : (var_1_26 ? (((- var_1_21) == var_1_33) ? (var_1_36 == ((unsigned short int) ((max (var_1_24 , var_1_6)) + var_1_7))) : (var_1_36 == ((unsigned short int) (var_1_37 - var_1_38)))) : ((var_1_81 > (var_1_10 / 10.4)) ? (var_1_36 == ((unsigned short int) ((max (var_1_37 , (var_1_24 + 29482))) - var_1_34))) : (var_1_97 ? (var_1_36 == ((unsigned short int) (256 + var_1_34))) : (var_1_36 == ((unsigned short int) (var_1_39 + var_1_34)))))))) && ((var_1_14 > var_1_75) ? ((var_1_76 && var_1_97) ? (var_1_40 == ((signed short int) (var_1_84 - (var_1_34 + var_1_6)))) : 1) : (var_1_40 == ((signed short int) (abs (min (var_1_34 , var_1_84))))))) && ((var_1_39 == var_1_34) ? (var_1_42 == ((unsigned long int) (var_1_8 + var_1_22))) : 1)) && ((((var_1_34 / var_1_22) / var_1_24) != var_1_95) ? (var_1_43 == ((signed short int) var_1_22)) : (((max (var_1_105 , (var_1_84 * var_1_95))) > var_1_6) ? ((((var_1_34 - var_1_24) | var_1_4) != var_1_25) ? (var_1_29 ? (var_1_43 == ((signed short int) (((max (var_1_22 , var_1_16)) - var_1_6) + var_1_44))) : (var_1_30 ? (((var_1_14 - (min (var_1_45 , var_1_46))) == var_1_9) ? (var_1_43 == ((signed short int) ((max (var_1_16 , var_1_5)) - var_1_4))) : 1) : (var_1_43 == ((signed short int) (var_1_4 - (19728 - var_1_34)))))) : (var_1_43 == ((signed short int) (var_1_5 - ((max (var_1_34 , var_1_22)) + var_1_33))))) : (var_1_43 == ((signed short int) (var_1_22 + var_1_7)))))) && ((var_1_97 || var_1_26) ? ((var_1_77 < 255.5) ? (var_1_47 == ((signed long int) ((var_1_37 - var_1_16) + var_1_108))) : (var_1_47 == ((signed long int) ((128 + var_1_24) - ((max (var_1_49 , 1866799460)) - var_1_34))))) : (var_1_47 == ((signed long int) (5 - var_1_38))))) && ((var_1_65 > var_1_105) ? ((var_1_38 <= var_1_65) ? (var_1_50 == ((unsigned char) (var_1_33 + (max (var_1_34 , var_1_22))))) : (var_1_50 == ((unsigned char) ((var_1_51 + var_1_52) - var_1_22)))) : 1)) && ((var_1_1 > -5) ? ((var_1_47 <= var_1_1) ? (var_1_53 == ((float) ((var_1_54 - (var_1_55 - var_1_56)) - (var_1_57 - var_1_58)))) : ((var_1_107 > var_1_83) ? (var_1_53 == ((float) ((max (var_1_55 , var_1_56)) + var_1_58))) : ((8 < (var_1_4 % var_1_49)) ? (var_1_53 == ((float) (var_1_54 - var_1_14))) : (var_1_53 == ((float) (min (4.6f , var_1_54))))))) : (var_1_53 == ((float) ((max ((min (var_1_12 , var_1_56)) , var_1_58)) + (max (var_1_55 , var_1_11))))))) && (((var_1_90 / var_1_55) != var_1_12) ? ((var_1_90 >= var_1_81) ? (var_1_59 == ((signed char) (var_1_22 - 25))) : (((min (var_1_55 , var_1_54)) >= var_1_81) ? (var_1_59 == ((signed char) (abs (var_1_34)))) : 1)) : (((var_1_26 && var_1_17) && (var_1_47 != var_1_39)) ? (var_1_59 == ((signed char) (var_1_22 + var_1_34))) : 1))) && (var_1_26 ? ((4 < (var_1_95 / var_1_20)) ? (var_1_61 == ((signed short int) ((min ((var_1_96 + var_1_22) , (var_1_7 + var_1_99))) - var_1_51))) : 1) : 1)) && (((~ (var_1_6 + var_1_67)) < var_1_7) ? (var_1_63 == ((unsigned short int) ((min (var_1_37 , var_1_64)) - (min ((max (32 , var_1_8)) , (max (var_1_34 , var_1_39))))))) : (var_1_63 == ((unsigned short int) (var_1_37 - (max (25 , var_1_8))))))) && ((var_1_58 != (last_1_var_1_9 / var_1_54)) ? (var_1_65 == ((unsigned long int) ((min (var_1_19 , var_1_66)) - var_1_7))) : 1)) && (var_1_67 == ((unsigned char) ((var_1_68 - (var_1_33 + var_1_34)) - var_1_22)))) && (var_1_26 ? (var_1_69 == ((float) ((var_1_56 + var_1_70) + var_1_58))) : 1)) && (((7.375 - (abs (var_1_57))) >= var_1_81) ? (var_1_71 == ((unsigned long int) (min (last_1_var_1_71 , var_1_19)))) : (var_1_71 == ((unsigned long int) (max (var_1_73 , var_1_20)))))) && ((var_1_7 > var_1_105) ? (var_1_74 == ((float) var_1_54)) : 1)) && ((var_1_97 || (var_1_25 > var_1_107)) ? (var_1_75 == ((double) var_1_70)) : (var_1_75 == ((double) (max ((var_1_56 + var_1_70) , 5.2)))))) && ((var_1_28 || (last_1_var_1_86 > (~ var_1_52))) ? (var_1_76 == ((unsigned char) (var_1_29 && ((last_1_var_1_26 && var_1_28) && var_1_30)))) : (var_1_76 == ((unsigned char) var_1_28)))) && ((var_1_22 > ((- var_1_95) / var_1_60)) ? (var_1_77 == ((double) (var_1_58 - var_1_57))) : ((var_1_83 <= var_1_66) ? (var_1_77 == ((double) (max (var_1_54 , 8.8)))) : (var_1_77 == ((double) ((var_1_55 + (max (var_1_58 , var_1_56))) - var_1_57)))))) && ((var_1_17 && var_1_76) ? (var_1_76 ? ((var_1_42 > (abs (var_1_7))) ? ((((var_1_107 + var_1_60) + var_1_83) < 256u) ? (var_1_78 == ((unsigned short int) (var_1_22 + var_1_6))) : (var_1_78 == ((unsigned short int) (var_1_64 - (max ((var_1_24 - var_1_16) , (var_1_79 - var_1_93))))))) : (var_1_78 == ((unsigned short int) (((var_1_80 - var_1_33) + (var_1_6 - var_1_68)) + (var_1_79 - var_1_7))))) : (((var_1_58 * var_1_70) > (max (var_1_77 , var_1_81))) ? (var_1_78 == ((unsigned short int) var_1_16)) : ((last_1_var_1_78 != var_1_79) ? (var_1_78 == ((unsigned short int) (min ((var_1_16 + var_1_24) , var_1_38)))) : (var_1_78 == ((unsigned short int) (var_1_24 + (var_1_5 + 1))))))) : (var_1_26 ? (var_1_78 == ((unsigned short int) (var_1_79 + (var_1_24 - var_1_16)))) : 1))) && ((100u != last_1_var_1_15) ? (((var_1_68 - (var_1_52 - var_1_34)) > ((var_1_51 ^ last_1_var_1_15) / var_1_37)) ? (var_1_81 == ((double) ((var_1_56 + var_1_70) + var_1_12))) : (var_1_81 == ((double) (min (var_1_55 , var_1_14))))) : ((-2 <= var_1_52) ? (var_1_81 == ((double) (min ((var_1_12 + var_1_11) , (var_1_58 + var_1_55))))) : ((last_1_var_1_100 != var_1_73) ? (((max (1.5f , (0.7f / var_1_54))) >= var_1_55) ? ((last_1_var_1_71 <= last_1_var_1_65) ? (var_1_81 == ((double) (min ((var_1_55 + var_1_12) , (abs (1.8 - var_1_58)))))) : (var_1_81 == ((double) (min (var_1_55 , (var_1_57 - var_1_58)))))) : (var_1_81 == ((double) (var_1_55 - (min (var_1_58 , var_1_14)))))) : 1)))) && (((var_1_30 || var_1_97) && (var_1_1 > 16)) ? (var_1_97 ? (var_1_83 == ((unsigned long int) (max (var_1_65 , (min ((var_1_34 + var_1_1) , var_1_51)))))) : (var_1_83 == ((unsigned long int) var_1_66))) : 1)) && (((var_1_83 + (var_1_80 / var_1_52)) < ((var_1_19 - var_1_8) + 32u)) ? (((- var_1_53) > (var_1_11 / var_1_54)) ? (var_1_84 == ((unsigned long int) (min (var_1_24 , var_1_83)))) : (var_1_84 == ((unsigned long int) (var_1_19 - ((var_1_20 + 1000000000u) - var_1_22))))) : ((var_1_81 >= var_1_14) ? (var_1_84 == ((unsigned long int) (var_1_19 - (var_1_49 - var_1_22)))) : 1))) && (var_1_85 == ((unsigned char) (min (2 , (var_1_51 + (var_1_52 - var_1_22))))))) && ((var_1_4 >= (var_1_16 * last_1_var_1_86)) ? (var_1_86 == ((signed short int) (var_1_44 + (var_1_35 - var_1_6)))) : 1)) && ((var_1_78 < ((abs (var_1_8)) + var_1_61)) ? (var_1_87 == ((float) var_1_70)) : 1)) && (var_1_29 ? (var_1_88 == ((unsigned short int) var_1_24)) : 1)) && (var_1_89 == ((signed char) var_1_22))) && (var_1_30 ? (var_1_90 == ((float) var_1_91)) : (var_1_90 == ((float) var_1_11)))) && (var_1_92 == ((unsigned char) var_1_52))) && (var_1_97 ? (var_1_93 == ((unsigned short int) var_1_39)) : 1)) && (var_1_30 ? (var_1_94 == ((float) 0.2f)) : (var_1_94 == ((float) var_1_14)))) && (var_1_95 == ((unsigned long int) var_1_20))) && (var_1_26 ? (var_1_96 == ((signed short int) var_1_44)) : 1)) && (var_1_76 ? (var_1_97 == ((unsigned char) var_1_98)) : (var_1_97 == ((unsigned char) 0)))) && (var_1_99 == ((unsigned char) var_1_68))) && (var_1_98 ? (var_1_100 == ((unsigned char) var_1_101)) : 1)) && (var_1_76 ? (var_1_102 == ((float) var_1_10)) : 1)) && (var_1_29 ? (var_1_103 == ((unsigned char) 128)) : (var_1_103 == ((unsigned char) var_1_101)))) && (var_1_104 == ((signed short int) var_1_101))) && ((var_1_79 > ((var_1_106 - var_1_5) - var_1_101)) ? (var_1_105 == ((unsigned long int) ((var_1_106 + (var_1_20 - var_1_24)) + var_1_95))) : 1)) && (var_1_107 == ((unsigned short int) var_1_6))) && (var_1_108 == ((unsigned char) var_1_68))
;
}
int main(void) {
	isInitial = 1;
