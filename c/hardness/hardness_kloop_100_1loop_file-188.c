...
void step(void) {
	...
	// From: Req3Batch188100_1loop
	var_1_9 = var_1_8;


	// From: Req9Batch188100_1loop
	var_1_21 = (128 - (var_1_22 - var_1_8));


	// From: Req2Batch188100_1loop
	...
	// From: Req4Batch188100_1loop
	if ((abs (var_1_5)) < var_1_8) {
		if (var_1_9 < var_1_2) {
			var_1_10 = (min ((500 - var_1_8) , (max (var_1_21 , (var_1_6 + 100)))));
		} else {
			var_1_10 = (max (var_1_6 , var_1_21));
		}
	}


	// From: Req8Batch188100_1loop
	if (var_1_17) {
		var_1_20 = (min (var_1_4 , (max (var_1_8 , var_1_21))));
	} else {
		var_1_20 = (var_1_7 + ((var_1_8 + var_1_7) - var_1_5));
	}


	// From: Req13Batch188100_1loop
	signed long int stepLocal_5 = var_1_5 + var_1_20;
	if (((max (var_1_31 , var_1_27)) / var_1_22) >= stepLocal_5) {
	...
	if (var_1_30 && stepLocal_4) {
		if (var_1_19) {
			...
			var_1_24 = (abs ((min (var_1_28 , 35068)) - (var_1_27 - var_1_5)));
		}
	} else {
	...
	// From: Req12Batch188100_1loop
	if (var_1_30) {
		var_1_29 = (var_1_6 + var_1_5);
	}


	// From: Req5Batch188100_1loop
	unsigned short int stepLocal_2 = var_1_24;
	signed long int stepLocal_1 = min (var_1_29 , (var_1_6 * var_1_4));
	...
	// From: Req10Batch188100_1loop
	unsigned char stepLocal_3 = var_1_8;
	if (var_1_11 > 127.8) {
		var_1_23 = ((abs (var_1_15)) + var_1_16);
	} else {
...
int property(void) {
	return (((((((((((((var_1_2 != (- 16u)) ? (var_1_17 ? (var_1_1 == ((signed char) (var_1_4 + (var_1_5 - var_1_6)))) : ((var_1_5 >= var_1_6) ? (var_1_1 == ((signed char) var_1_6)) : (var_1_1 == ((signed char) var_1_5)))) : (var_1_1 == ((signed char) 0))) && (((var_1_21 + -8) != var_1_2) ? (var_1_7 == ((unsigned char) (abs (var_1_8)))) : 1)) && (var_1_9 == ((unsigned char) var_1_8))) && (((abs (var_1_5)) < var_1_8) ? ((var_1_9 < var_1_2) ? (var_1_10 == ((signed short int) (min ((500 - var_1_8) , (max (var_1_21 , (var_1_6 + 100))))))) : (var_1_10 == ((signed short int) (max (var_1_6 , var_1_21))))) : 1)) && ((var_1_29 > (min (var_1_29 , (var_1_6 * var_1_4)))) ? ((var_1_2 < var_1_24) ? (var_1_11 == ((double) var_1_12)) : (var_1_11 == ((double) 0.4))) : 1)) && ((var_1_11 == var_1_12) ? (var_1_13 == ((float) (var_1_14 + (var_1_15 - var_1_16)))) : (var_1_13 == ((float) var_1_15)))) && (((var_1_2 * last_1_var_1_24) == (last_1_var_1_20 >> 1u)) ? (last_1_var_1_17 ? (last_1_var_1_30 ? (var_1_17 == ((unsigned char) var_1_19)) : 1) : 1) : (var_1_17 == ((unsigned char) 0)))) && (var_1_17 ? (var_1_20 == ((signed short int) (min (var_1_4 , (max (var_1_8 , var_1_21)))))) : (var_1_20 == ((signed short int) (var_1_7 + ((var_1_8 + var_1_7) - var_1_5)))))) && (var_1_21 == ((signed long int) (128 - (var_1_22 - var_1_8))))) && ((var_1_11 > 127.8) ? (var_1_23 == ((double) ((abs (var_1_15)) + var_1_16))) : ((var_1_8 > var_1_21) ? (var_1_23 == ((double) var_1_16)) : (var_1_23 == ((double) var_1_14))))) && ((var_1_30 && var_1_17) ? (var_1_19 ? (var_1_17 ? (var_1_24 == ((unsigned short int) ((29019 + (var_1_26 - var_1_21)) - (var_1_27 - var_1_6)))) : 1) : (var_1_24 == ((unsigned short int) (abs ((min (var_1_28 , 35068)) - (var_1_27 - var_1_5)))))) : (var_1_24 == ((unsigned short int) (var_1_28 - var_1_8))))) && (var_1_30 ? (var_1_29 == ((unsigned char) (var_1_6 + var_1_5))) : 1)) && ((((max (var_1_31 , var_1_27)) / var_1_22) >= (var_1_5 + var_1_20)) ? (var_1_30 == ((unsigned char) (! (! (var_1_19 || var_1_32))))) : (var_1_30 == ((unsigned char) var_1_19)))
;
}
int main(void) {
	isInitial = 1;
