...
void step(void) {
	...
	// From: Req2Batch133normal
	if (var_1_7 > (var_1_9 - var_1_10)) {
		var_1_8 = (abs (var_1_7));
	}


	// From: Req3Batch133normal
	var_1_11 = (min (var_1_10 , var_1_12));


	// From: Req4Batch133normal
	if (var_1_8 == -50) {
		if (var_1_11 > 10u) {
			var_1_13 = (var_1_3 && var_1_14);
		} else {
			var_1_13 = var_1_15;
		}
	} else {
	...
	// From: Req5Batch133normal
	if (var_1_12 != (var_1_11 + (var_1_8 * 10u))) {
