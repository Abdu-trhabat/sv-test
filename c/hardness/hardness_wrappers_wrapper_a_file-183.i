...
void step(void) {
 ...
 if (stepLocal_1 <= unsigned_short_int_Array_0[1][1]) {
  if (((((signed_char_Array_0[0]) < 0 ) ? -(signed_char_Array_0[0]) : (signed_char_Array_0[0]))) < stepLocal_2) {
 ...
 signed long int stepLocal_0 = (((signed_long_int_Array_0[0]) > (unsigned_short_int_Array_0[1][0])) ? (signed_long_int_Array_0[0]) : (unsigned_short_int_Array_0[1][0]));
...
int property(void) {
 return (((((double_Array_0[2] / double_Array_0[1]) >= double_Array_0[0]) ? (unsigned_short_int_Array_0[1][1] == ((unsigned short int) ((unsigned_short_int_Array_0[0][1] - unsigned_short_int_Array_0[1][0]) - unsigned_short_int_Array_0[0][0]))) : 1) && ((unsigned_short_int_Array_0[0][1] >= ((((signed_long_int_Array_0[0]) > (unsigned_short_int_Array_0[1][0])) ? (signed_long_int_Array_0[0]) : (unsigned_short_int_Array_0[1][0])))) ? ((! BOOL_unsigned_char_Array_0[1]) ? (signed_short_int_Array_0[0] == ((signed short int) unsigned_short_int_Array_0[1][0])) : (signed_short_int_Array_0[0] == ((signed short int) -4))) : (signed_short_int_Array_0[0] == ((signed short int) unsigned_short_int_Array_0[0][1])))) && ((unsigned_short_int_Array_0[1][1] > unsigned_short_int_Array_0[0][0]) ? ((double_Array_0[0] > (double_Array_0[2] + double_Array_0[1])) ? (BOOL_unsigned_char_Array_0[1] == ((unsigned char) BOOL_unsigned_char_Array_0[2])) : (BOOL_unsigned_char_Array_0[1] == ((unsigned char) 0))) : (BOOL_unsigned_char_Array_0[1] == ((unsigned char) (BOOL_unsigned_char_Array_0[2] && (! BOOL_unsigned_char_Array_0[0])))))) && ((unsigned_short_int_Array_0[0][0] <= unsigned_short_int_Array_0[1][1]) ? ((((((signed_char_Array_0[0]) < 0 ) ? -(signed_char_Array_0[0]) : (signed_char_Array_0[0]))) < unsigned_short_int_Array_0[0][1]) ? (signed_long_int_Array_0[0] == ((signed long int) signed_char_Array_0[0])) : (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[0][0]))) : (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[0][1])))
;
}
int main(void) {
 isInitial = 1;
