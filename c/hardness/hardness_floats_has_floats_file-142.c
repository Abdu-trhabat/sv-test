...
void step(void) {
	...
	// From: Req4Batch142has_floats
	var_1_17 = (100000.0f - var_1_18);


	// From: Req5Batch142has_floats
	var_1_19 = var_1_16;


	// From: Req6Batch142has_floats
	var_1_20 = var_1_19;


	// From: Req3Batch142has_floats
	if (var_1_10) {
...
int property(void) {
	return ((((((var_1_2 <= var_1_3) ? ((var_1_3 <= var_1_2) ? (var_1_1 == ((signed long int) (1 - var_1_4))) : (var_1_1 == ((signed long int) (var_1_4 - var_1_5)))) : 1) && ((last_1_var_1_13 >= (var_1_8 - var_1_9)) ? ((! var_1_10) ? (var_1_6 == ((double) (var_1_11 + var_1_12))) : (var_1_6 == ((double) var_1_11))) : 1)) && (var_1_10 ? ((((min (var_1_6 , var_1_17)) >= (- var_1_11)) && var_1_15) ? (var_1_13 == ((unsigned short int) (var_1_9 + var_1_16))) : (var_1_13 == ((unsigned short int) var_1_16))) : (var_1_13 == ((unsigned short int) var_1_9)))) && (var_1_17 == ((float) (100000.0f - var_1_18)))) && (var_1_19 == ((unsigned short int) var_1_16))) && (var_1_20 == ((signed long int) var_1_19))
;
}
int main(void) {
	isInitial = 1;
