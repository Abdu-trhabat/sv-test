...
void step(void) {
 ...
 if ((*(var_1_2_Pointer)) <= stepLocal_0) {
  ...
  (*(var_1_1_Pointer)) = (((((((((*(var_1_4_Pointer))) > (100)) ? ((*(var_1_4_Pointer))) : (100)))) > ((*(var_1_5_Pointer)))) ? ((((((*(var_1_4_Pointer))) > (100)) ? ((*(var_1_4_Pointer))) : (100)))) : ((*(var_1_5_Pointer)))));
 }
 unsigned char stepLocal_2 = (*(var_1_5_Pointer));
 if ((((*(var_1_1_Pointer)) + (*(var_1_8_Pointer))) + (*(var_1_2_Pointer))) < stepLocal_2) {
  if ((*(var_1_10_Pointer))) {
   (*(var_1_9_Pointer)) = (((((*(var_1_11_Pointer)) - 4.25f) < 0 ) ? -((*(var_1_11_Pointer)) - 4.25f) : ((*(var_1_11_Pointer)) - 4.25f)));
  } else {
 ...
 unsigned long int stepLocal_1 = (((((*(var_1_15_Pointer))) > ((*(var_1_2_Pointer)))) ? ((*(var_1_15_Pointer))) : ((*(var_1_2_Pointer))))) / (((((*(var_1_7_Pointer))) > ((*(var_1_8_Pointer)))) ? ((*(var_1_7_Pointer))) : ((*(var_1_8_Pointer)))));
 if (((*(var_1_5_Pointer)) + (*(var_1_4_Pointer))) > stepLocal_1) {
  (*(var_1_6_Pointer)) = (((((*(var_1_4_Pointer))) > ((*(var_1_15_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_15_Pointer)))));
 }
...
int property(void) {
 return (((((((*(var_1_2_Pointer)) <= (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned char) ((*(var_1_4_Pointer)) - 32))) : ((*(var_1_1_Pointer)) == ((unsigned char) (((((((((*(var_1_4_Pointer))) > (100)) ? ((*(var_1_4_Pointer))) : (100)))) > ((*(var_1_5_Pointer)))) ? ((((((*(var_1_4_Pointer))) > (100)) ? ((*(var_1_4_Pointer))) : (100)))) : ((*(var_1_5_Pointer)))))))) && ((((*(var_1_5_Pointer)) + (*(var_1_4_Pointer))) > ((((((*(var_1_15_Pointer))) > ((*(var_1_2_Pointer)))) ? ((*(var_1_15_Pointer))) : ((*(var_1_2_Pointer))))) / (((((*(var_1_7_Pointer))) > ((*(var_1_8_Pointer)))) ? ((*(var_1_7_Pointer))) : ((*(var_1_8_Pointer))))))) ? ((*(var_1_6_Pointer)) == ((unsigned short int) (((((*(var_1_4_Pointer))) > ((*(var_1_15_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_15_Pointer))))))) : 1)) && (((((*(var_1_1_Pointer)) + (*(var_1_8_Pointer))) + (*(var_1_2_Pointer))) < (*(var_1_5_Pointer))) ? ((*(var_1_10_Pointer)) ? ((*(var_1_9_Pointer)) == ((float) (((((*(var_1_11_Pointer)) - 4.25f) < 0 ) ? -((*(var_1_11_Pointer)) - 4.25f) : ((*(var_1_11_Pointer)) - 4.25f))))) : ((*(var_1_9_Pointer)) == ((float) ((*(var_1_11_Pointer)) - (8.966829933912052E18f - (*(var_1_12_Pointer))))))) : ((*(var_1_9_Pointer)) == ((float) (*(var_1_12_Pointer)))))) && ((*(var_1_13_Pointer)) == ((float) (*(var_1_11_Pointer))))) && ((*(var_1_14_Pointer)) == ((signed long int) (*(var_1_15_Pointer))))) && ((*(var_1_15_Pointer)) == ((unsigned short int) (*(var_1_4_Pointer))))
;
}
int main(void) {
 isInitial = 1;
