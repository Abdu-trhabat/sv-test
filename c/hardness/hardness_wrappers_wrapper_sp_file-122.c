...
void step(void) {
	// From: Req1Batch122Wrapper_SP
	(*(WrapperStruct00_var_1_1_Pointer)) = (abs (min (1 , (*(WrapperStruct00_var_1_2_Pointer)))));


	// From: Req2Batch122Wrapper_SP
	if ((*(WrapperStruct00_var_1_4_Pointer)) < (*(WrapperStruct00_var_1_5_Pointer))) {
		(*(WrapperStruct00_var_1_3_Pointer)) = ((abs ((*(WrapperStruct00_var_1_1_Pointer)))) + (*(WrapperStruct00_var_1_2_Pointer)));
	} else {
		(*(WrapperStruct00_var_1_3_Pointer)) = (*(WrapperStruct00_var_1_2_Pointer));
	}


	// From: Req3Batch122Wrapper_SP
	if ((*(WrapperStruct00_var_1_4_Pointer)) >= (*(WrapperStruct00_var_1_5_Pointer))) {
		(*(WrapperStruct00_var_1_6_Pointer)) = (min (7.8 , ((*(WrapperStruct00_var_1_7_Pointer)) - (*(WrapperStruct00_var_1_8_Pointer)))));
	}


	// From: Req4Batch122Wrapper_SP
	...
	if ((*(WrapperStruct00_var_1_10_Pointer)) || stepLocal_0) {
		...
		if ((*(WrapperStruct00_var_1_2_Pointer)) < stepLocal_1) {
			(*(WrapperStruct00_var_1_9_Pointer)) = (min (((*(WrapperStruct00_var_1_2_Pointer)) - ((*(WrapperStruct00_var_1_12_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer)))) , ((*(WrapperStruct00_var_1_13_Pointer)) - ((*(WrapperStruct00_var_1_14_Pointer)) - (*(WrapperStruct00_var_1_15_Pointer))))));
		}
	}


	// From: Req5Batch122Wrapper_SP
...
int property(void) {
	return (((((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned char) (abs (min (1 , (*(WrapperStruct00_var_1_2_Pointer))))))) && (((*(WrapperStruct00_var_1_4_Pointer)) < (*(WrapperStruct00_var_1_5_Pointer))) ? ((*(WrapperStruct00_var_1_3_Pointer)) == ((unsigned long int) ((abs ((*(WrapperStruct00_var_1_1_Pointer)))) + (*(WrapperStruct00_var_1_2_Pointer))))) : ((*(WrapperStruct00_var_1_3_Pointer)) == ((unsigned long int) (*(WrapperStruct00_var_1_2_Pointer)))))) && (((*(WrapperStruct00_var_1_4_Pointer)) >= (*(WrapperStruct00_var_1_5_Pointer))) ? ((*(WrapperStruct00_var_1_6_Pointer)) == ((double) (min (7.8 , ((*(WrapperStruct00_var_1_7_Pointer)) - (*(WrapperStruct00_var_1_8_Pointer))))))) : 1)) && (((*(WrapperStruct00_var_1_10_Pointer)) || (*(WrapperStruct00_var_1_11_Pointer))) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed long int) 128)) : (((*(WrapperStruct00_var_1_2_Pointer)) < (*(WrapperStruct00_var_1_3_Pointer))) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed long int) (min (((*(WrapperStruct00_var_1_2_Pointer)) - ((*(WrapperStruct00_var_1_12_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer)))) , ((*(WrapperStruct00_var_1_13_Pointer)) - ((*(WrapperStruct00_var_1_14_Pointer)) - (*(WrapperStruct00_var_1_15_Pointer)))))))) : 1))) && (((*(WrapperStruct00_var_1_3_Pointer)) > ((*(WrapperStruct00_var_1_14_Pointer)) % ((*(WrapperStruct00_var_1_17_Pointer)) - (*(WrapperStruct00_var_1_12_Pointer))))) ? ((*(WrapperStruct00_var_1_16_Pointer)) == ((float) (*(WrapperStruct00_var_1_7_Pointer)))) : 1)
;
}
int main(void) {
	isInitial = 1;
