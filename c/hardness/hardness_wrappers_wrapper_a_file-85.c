...
void step(void) {
	...
	if (last_1_BOOL_unsigned_char_Array_0_1__1_) {
		signed_long_int_Array_0[2] = (min ((signed_long_int_Array_0[1] + signed_long_int_Array_0[0]) , -16));
	} else {
