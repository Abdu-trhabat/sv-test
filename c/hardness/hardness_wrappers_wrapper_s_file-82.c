...
void step(void) {
	...
	if ((WrapperStruct00.var_1_7 + WrapperStruct00.var_1_11) >= stepLocal_1) {
		if ((max (WrapperStruct00.var_1_4 , (WrapperStruct00.var_1_1 * WrapperStruct00.var_1_3))) <= WrapperStruct00.var_1_18) {
...
int property(void) {
	return ((((((! WrapperStruct00.var_1_2) ? (WrapperStruct00.var_1_2 ? (WrapperStruct00.var_1_1 == ((float) (max (WrapperStruct00.var_1_3 , WrapperStruct00.var_1_4)))) : 1) : 1) && (((WrapperStruct00.var_1_6 / -2) >= (WrapperStruct00.var_1_7 | WrapperStruct00.var_1_8)) ? (WrapperStruct00.var_1_5 == ((unsigned char) (abs (WrapperStruct00.var_1_9)))) : (WrapperStruct00.var_1_5 == ((unsigned char) (WrapperStruct00.var_1_10 - (abs (WrapperStruct00.var_1_11))))))) && (((WrapperStruct00.var_1_7 + WrapperStruct00.var_1_11) >= WrapperStruct00.var_1_9) ? (((max (WrapperStruct00.var_1_4 , (WrapperStruct00.var_1_1 * WrapperStruct00.var_1_3))) <= WrapperStruct00.var_1_18) ? (WrapperStruct00.var_1_12 == ((unsigned char) (max (WrapperStruct00.var_1_11 , WrapperStruct00.var_1_14)))) : (WrapperStruct00.var_1_2 ? (WrapperStruct00.var_1_12 == ((unsigned char) (WrapperStruct00.var_1_11 + WrapperStruct00.var_1_15))) : 1)) : (WrapperStruct00.var_1_12 == ((unsigned char) WrapperStruct00.var_1_9)))) && (WrapperStruct00.var_1_16 == ((double) WrapperStruct00.var_1_4))) && (WrapperStruct00.var_1_17 == ((unsigned char) WrapperStruct00.var_1_9))) && (WrapperStruct00.var_1_18 == ((double) WrapperStruct00.var_1_3))
;
}
int main(void) {
	isInitial = 1;
