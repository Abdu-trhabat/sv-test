...
void step(void) {
	...
	if (stepLocal_1 && BOOL_unsigned_char_Array_0[0]) {
		if ((max ((abs (signed_char_Array_0[2])) , signed_char_Array_0[1])) < stepLocal_0) {
			signed_long_int_Array_0[1][1] = (signed_long_int_Array_0[0][1] - signed_long_int_Array_0[1][0]);
		} else {
			if (BOOL_unsigned_char_Array_0[0]) {
				signed_long_int_Array_0[1][1] = (max ((max ((signed_char_Array_0[2] + signed_char_Array_0[1]) , signed_long_int_Array_0[1][0])) , (max (signed_long_int_Array_0[0][1] , signed_long_int_Array_0[0][0]))));
			} else {
...
int property(void) {
	return (((BOOL_unsigned_char_Array_0[1] && BOOL_unsigned_char_Array_0[0]) ? (((max ((abs (signed_char_Array_0[2])) , signed_char_Array_0[1])) < (-5 * -8)) ? (signed_long_int_Array_0[1][1] == ((signed long int) (signed_long_int_Array_0[0][1] - signed_long_int_Array_0[1][0]))) : (BOOL_unsigned_char_Array_0[0] ? (signed_long_int_Array_0[1][1] == ((signed long int) (max ((max ((signed_char_Array_0[2] + signed_char_Array_0[1]) , signed_long_int_Array_0[1][0])) , (max (signed_long_int_Array_0[0][1] , signed_long_int_Array_0[0][0])))))) : (signed_long_int_Array_0[1][1] == ((signed long int) 4)))) : 1) && (((- 256.5f) > (float_Array_0[1][0] - float_Array_0[0][1])) ? ((float_Array_0[0][1] >= float_Array_0[1][0]) ? (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0])) : 1) : (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0])))) && ((signed_long_int_Array_0[0][0] >= signed_char_Array_0[0]) ? (float_Array_0[0][0] == ((float) float_Array_0[0][2])) : (float_Array_0[0][0] == ((float) (float_Array_0[1][2] + (float_Array_0[1][1] - 2.6f)))))
;
}
int main(void) {
	isInitial = 1;
