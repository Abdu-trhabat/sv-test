...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (! (WrapperStruct00.var_1_13 < (127.125 / WrapperStruct00.var_1_12))) {
  if (WrapperStruct00.var_1_1 <= ((WrapperStruct00.var_1_4 * WrapperStruct00.var_1_3) + (4 << WrapperStruct00.var_1_16))) {
