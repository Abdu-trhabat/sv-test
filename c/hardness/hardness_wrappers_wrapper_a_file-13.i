...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 if (BOOL_unsigned_char_Array_0[1]) {
  unsigned_short_int_Array_0[4] = ((((unsigned_short_int_Array_0[3]) > (unsigned_short_int_Array_0[2])) ? (unsigned_short_int_Array_0[3]) : (unsigned_short_int_Array_0[2])));
 }
 if ((unsigned_short_int_Array_0[4] == unsigned_short_int_Array_0[2]) || BOOL_unsigned_char_Array_0[1]) {
  signed_char_Array_0[2] = (signed_char_Array_0[1] - signed_char_Array_0[0]);
 } else {
 ...
 if (unsigned_short_int_Array_0[2] < stepLocal_0) {
  unsigned_short_int_Array_0[0] = unsigned_short_int_Array_0[3];
 } else {
  unsigned_short_int_Array_0[0] = (signed_char_Array_0[0] + unsigned_short_int_Array_0[1]);
 }
 unsigned short int stepLocal_1 = unsigned_short_int_Array_0[1];
 if (unsigned_short_int_Array_0[3] > stepLocal_1) {
  if ((float_Array_0[0][0] * (- float_Array_0[1][0])) < (- float_Array_0[0][1])) {
   signed_long_int_Array_0[0] = unsigned_short_int_Array_0[2];
  }
 } else {
  if (float_Array_0[0][0] < (float_Array_0[1][0] / float_Array_0[1][1])) {
...
int property(void) {
 return (((BOOL_unsigned_char_Array_0[1] ? (unsigned_short_int_Array_0[4] == ((unsigned short int) ((((unsigned_short_int_Array_0[3]) > (unsigned_short_int_Array_0[2])) ? (unsigned_short_int_Array_0[3]) : (unsigned_short_int_Array_0[2]))))) : 1) && (((unsigned_short_int_Array_0[4] == unsigned_short_int_Array_0[2]) || BOOL_unsigned_char_Array_0[1]) ? (signed_char_Array_0[2] == ((signed char) (signed_char_Array_0[1] - signed_char_Array_0[0]))) : ((BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]) ? (signed_char_Array_0[2] == ((signed char) signed_char_Array_0[1])) : 1))) && ((unsigned_short_int_Array_0[2] < signed_char_Array_0[0]) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_short_int_Array_0[3])) : (unsigned_short_int_Array_0[0] == ((unsigned short int) (signed_char_Array_0[0] + unsigned_short_int_Array_0[1]))))) && ((unsigned_short_int_Array_0[3] > unsigned_short_int_Array_0[1]) ? (((float_Array_0[0][0] * (- float_Array_0[1][0])) < (- float_Array_0[0][1])) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[2])) : 1) : ((float_Array_0[0][0] < (float_Array_0[1][0] / float_Array_0[1][1])) ? ((float_Array_0[1][1] > float_Array_0[0][1]) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[2])) : 1) : 1))
;
}
int main(void) {
 isInitial = 1;
