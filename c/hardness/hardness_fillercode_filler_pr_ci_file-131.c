...
void step(void) {
	...
	// From: CodeObject6
	/* 325L, 208L) */ if (/* 326L, 190L, 191L) */ ((var_1_17) > (/* 328L, 189L, 193L) */ ((32) - (var_1_35))))) {
		/* 331L, 207L) */ var_1_38 = (
			/* 334L, 206L) */ (abs (
				/* 335L, 205L) */ (max (
					/* 335L, 205L) */ (
	...
	// From: CodeObject7
	/* 338L, 239L) */ if (/* 339L, 218L, 219L) */ ((var_1_23) <= (/* 341L, 217L, 221L) */ ((/* 342L, 215L, 222L) */ (min (/* 342L, 215L, 222L) */ (var_1_40) , (var_1_41)))) - (var_1_4))))) {
		/* 346L, 238L) */ var_1_39 = (
			/* 349L, 237L) */ ((
				var_1_17
			) + (
	...
	// From: CodeObject5
	/* 292L, 174L) */ if (/* 293L, 117L, 118L) */ ((/* 294L, 114L, 119L) */ ((var_1_30) / (7.5f))) > (/* 297L, 116L, 122L) */ (- (var_1_8))))) {
