...
void step(void) {
	...
	if (last_1_WrapperStruct00_var_1_21) {
		WrapperStruct00.var_1_1 = (min ((WrapperStruct00.var_1_3 + WrapperStruct00.var_1_4) , -16));
	} else {
