...
void functionized0(signed char functionized0_localFunctionVar0, signed long int functionized0_localFunctionVar1) {
 if (var_1_8 == functionized0_localFunctionVar1) {
  var_1_12 = ((((functionized0_localFunctionVar0) < 0 ) ? -(functionized0_localFunctionVar0) : (functionized0_localFunctionVar0)));
 }
}
void functionized1(unsigned short int functionized1_localFunctionVar0, unsigned short int functionized1_localFunctionVar1, unsigned char functionized1_localFunctionVar2, signed long int functionized1_localFunctionVar3) {
 if (((var_1_10 + functionized1_localFunctionVar1) << var_1_5) < functionized1_localFunctionVar3) {
  var_1_13 = ((((var_1_7) < (((((functionized1_localFunctionVar2) > (((((functionized1_localFunctionVar1) < (var_1_6)) ? (functionized1_localFunctionVar1) : (var_1_6))))) ? (functionized1_localFunctionVar2) : (((((functionized1_localFunctionVar1) < (var_1_6)) ? (functionized1_localFunctionVar1) : (var_1_6)))))))) ? (var_1_7) : (((((functionized1_localFunctionVar2) > (((((functionized1_localFunctionVar1) < (var_1_6)) ? (functionized1_localFunctionVar1) : (var_1_6))))) ? (functionized1_localFunctionVar2) : (((((functionized1_localFunctionVar1) < (var_1_6)) ? (functionized1_localFunctionVar1) : (var_1_6)))))))));
 } else {
...
void functionized3(signed char functionized3_localFunctionVar0, unsigned short int functionized3_localFunctionVar1, unsigned short int functionized3_localFunctionVar2, unsigned char functionized3_localFunctionVar3, signed char functionized3_localFunctionVar4) {
 if (((((((((functionized3_localFunctionVar1) > (functionized3_localFunctionVar0)) ? (functionized3_localFunctionVar1) : (functionized3_localFunctionVar0)))) < (functionized3_localFunctionVar2)) ? (((((functionized3_localFunctionVar1) > (functionized3_localFunctionVar0)) ? (functionized3_localFunctionVar1) : (functionized3_localFunctionVar0)))) : (functionized3_localFunctionVar2))) > (functionized3_localFunctionVar4 * var_1_12)) {
...
double functionized4(double functionized4_localFunctionVar0, double functionized4_localFunctionVar1) {
 return (((((functionized4_localFunctionVar0) < ((var_1_22 - var_1_23))) ? (functionized4_localFunctionVar0) : ((var_1_22 - var_1_23)))) - functionized4_localFunctionVar1);
}
