...
void step(void) {
 ...
 if (stepLocal_0 >= (*(WrapperStruct00_var_1_6_Pointer))) {
  if ((((*(WrapperStruct00_var_1_11_Pointer)) + (*(WrapperStruct00_var_1_12_Pointer))) - (((((*(WrapperStruct00_var_1_13_Pointer))) < (1)) ? ((*(WrapperStruct00_var_1_13_Pointer))) : (1)))) > stepLocal_1) {
