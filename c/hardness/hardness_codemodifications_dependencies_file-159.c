...
void step(void) {
	...
	// From: Req4Batch159dependencies
	if ((var_1_10 << (min (1 , var_1_17))) < -1000000000) {
		var_1_16 = (max (var_1_17 , var_1_10));
	}


	// From: Req5Batch159dependencies
	if (((abs (var_1_19)) - var_1_17) > var_1_16) {
	...
	// From: Req6Batch159dependencies
	var_1_20 = (max ((min (var_1_21 , var_1_22)) , ((abs (15.5)) - var_1_23)));


	// From: Req3Batch159dependencies
