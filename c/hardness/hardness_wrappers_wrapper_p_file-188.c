...
void step(void) {
	...
	// From: Req4Batch188Wrapper_P
	(*(var_1_19_Pointer)) = (*(var_1_18_Pointer));


	// From: Req5Batch188Wrapper_P
	(*(var_1_20_Pointer)) = (*(var_1_13_Pointer));


	// From: Req3Batch188Wrapper_P
	if ((abs ((*(var_1_7_Pointer)))) <= (*(var_1_7_Pointer))) {
		if ((*(var_1_1_Pointer)) <= (*(var_1_7_Pointer))) {
			(*(var_1_11_Pointer)) = ((((*(var_1_13_Pointer)) - 4) - (max ((*(var_1_14_Pointer)) , (*(var_1_15_Pointer))))) - ((*(var_1_16_Pointer)) - (*(var_1_17_Pointer))));
		} else {
			(*(var_1_11_Pointer)) = ((min ((*(var_1_18_Pointer)) , (*(var_1_14_Pointer)))) + ((*(var_1_15_Pointer)) + (*(var_1_17_Pointer))));
		}
	} else {
		(*(var_1_11_Pointer)) = 64;
	}
