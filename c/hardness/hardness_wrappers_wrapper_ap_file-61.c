...
void step(void) {
	...
	if ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) < (max ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))))) {
