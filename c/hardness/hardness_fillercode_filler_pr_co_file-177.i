...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch177Filler_PR_CO.c", 13, "reach_error"); }
    ...
    var_1_42
                   ...
                   if ( ((var_1_1) < ( ((var_1_46) | (var_1_1))))) {
                    ...
                    if (var_1_31) {
                     if (var_1_42) {
                      var_1_48 = (
                       ((((( ((((( var_1_44 )) < (( var_1_46 ))) ? (( var_1_44 )) : (( var_1_46 )))) )) < (( var_1_7 ))) ? (( ((((( var_1_44 )) < (( var_1_46 ))) ? (( var_1_44 )) : (( var_1_46 )))) )) : (( var_1_7 ))))
    );
   } else {
                      var_1_48 = (
                       (((((( var_1_49 ) - ( var_1_7 ))) < 0 ) ? -((( var_1_49 ) - ( var_1_7 ))) : ((( var_1_49 ) - ( var_1_7 )))))
    );
   }
  } else {
                     if (var_1_36) {
