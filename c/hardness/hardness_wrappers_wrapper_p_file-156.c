...
void step(void) {
	...
	// From: Req3Batch156Wrapper_P
	if (! ((*(var_1_1_Pointer)) <= (*(var_1_6_Pointer)))) {
		if (((*(var_1_9_Pointer)) - (max ((*(var_1_4_Pointer)) , (*(var_1_11_Pointer))))) >= (*(var_1_5_Pointer))) {
			(*(var_1_8_Pointer)) = ((abs ((*(var_1_10_Pointer)))) - (*(var_1_5_Pointer)));
		} else {
			(*(var_1_8_Pointer)) = (max (32 , (*(var_1_11_Pointer))));
		}
	}
}
...
int property(void) {
	return ((((last_1_var_1_11 <= last_1_var_1_6) ? ((*(var_1_1_Pointer)) == ((unsigned char) (min ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))))) : 1) && (((*(var_1_1_Pointer)) < (*(var_1_3_Pointer))) ? ((((*(var_1_5_Pointer)) + (*(var_1_1_Pointer))) >= ((*(var_1_4_Pointer)) % (*(var_1_7_Pointer)))) ? ((*(var_1_6_Pointer)) == ((unsigned short int) (100 + (*(var_1_5_Pointer))))) : ((*(var_1_6_Pointer)) == ((unsigned short int) (*(var_1_5_Pointer))))) : 1)) && ((! ((*(var_1_1_Pointer)) <= (*(var_1_6_Pointer)))) ? ((((*(var_1_9_Pointer)) - (max ((*(var_1_4_Pointer)) , (*(var_1_11_Pointer))))) >= (*(var_1_5_Pointer))) ? ((*(var_1_8_Pointer)) == ((unsigned short int) ((abs ((*(var_1_10_Pointer)))) - (*(var_1_5_Pointer))))) : ((*(var_1_8_Pointer)) == ((unsigned short int) (max (32 , (*(var_1_11_Pointer))))))) : 1)) && (((last_1_var_1_1 % (*(var_1_9_Pointer))) <= (((*(var_1_12_Pointer)) - last_1_var_1_8) - last_1_var_1_6)) ? ((*(var_1_11_Pointer)) == ((unsigned long int) 32u)) : 1)
;
}
int main(void) {
	isInitial = 1;
