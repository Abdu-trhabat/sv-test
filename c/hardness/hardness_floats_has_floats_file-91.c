...
int property(void) {
	return (((var_1_2 >= var_1_3) ? (var_1_4 ? (var_1_1 == ((unsigned long int) (var_1_5 + (min (var_1_6 , var_1_7))))) : 1) : 1) && ((var_1_1 <= var_1_9) ? (var_1_8 == ((signed long int) (var_1_10 + (abs (max (256 , var_1_11)))))) : 1)) && ((var_1_3 <= (var_1_2 * (var_1_13 + var_1_14))) ? ((var_1_4 && var_1_15) ? (var_1_12 == ((float) (abs (abs (min (var_1_16 , var_1_17)))))) : (((var_1_18 - var_1_19) >= var_1_5) ? (var_1_12 == ((float) (var_1_20 + var_1_21))) : 1)) : (var_1_22 ? (var_1_12 == ((float) 10000.0f)) : (var_1_12 == ((float) var_1_21))))
;
}
int main(void) {
	isInitial = 1;
