...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch68normal.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch68normal
	if ((var_1_15 - var_1_16) == (var_1_17 - var_1_18)) {
		var_1_14 = var_1_19;
	}


	// From: Req4Batch68normal
	if (! (var_1_7 > var_1_14)) {
		if (var_1_12) {
			var_1_23 = var_1_5;
		}
