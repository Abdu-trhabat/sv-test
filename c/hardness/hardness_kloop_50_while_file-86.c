...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch8650_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch8650_while
	if (last_1_var_1_6) {
		var_1_6 = (last_1_var_1_19 || var_1_9);
	}


	// From: Req3Batch8650_while
	signed long int stepLocal_1 = var_1_11 - var_1_12;
	if (stepLocal_1 < (abs (min (32 , last_1_var_1_14)))) {
		var_1_10 = var_1_11;
	} else {
		if (last_1_var_1_6) {
			var_1_10 = var_1_13;
	...
	// From: Req7Batch8650_while
	var_1_22 = var_1_15;


	// From: Req6Batch8650_while
...
int property(void) {
	return (((((((var_1_10 <= (var_1_14 / -2)) ? (var_1_1 == ((unsigned short int) (57907 - (var_1_4 + var_1_5)))) : (var_1_1 == ((unsigned short int) 1))) && (last_1_var_1_6 ? (var_1_6 == ((unsigned char) (last_1_var_1_19 || var_1_9))) : 1)) && (((var_1_11 - var_1_12) < (abs (min (32 , last_1_var_1_14)))) ? (var_1_10 == ((signed long int) var_1_11)) : (last_1_var_1_6 ? (var_1_10 == ((signed long int) var_1_13)) : (var_1_10 == ((signed long int) var_1_4))))) && ((! var_1_19) ? ((((var_1_15 - var_1_12) * (- var_1_10)) <= var_1_11) ? (var_1_14 == ((signed long int) var_1_11)) : 1) : 1)) && ((var_1_14 >= var_1_12) ? (var_1_16 == ((unsigned char) (var_1_12 + var_1_17))) : ((var_1_1 > var_1_13) ? (var_1_16 == ((unsigned char) (min (var_1_17 , var_1_12)))) : (var_1_16 == ((unsigned char) var_1_12))))) && ((((var_1_5 % var_1_15) + (var_1_10 / var_1_20)) != var_1_10) ? (var_1_19 == ((unsigned char) var_1_9)) : ((! (! var_1_6)) ? (var_1_19 == ((unsigned char) ((var_1_13 >= var_1_15) || (var_1_9 && var_1_21)))) : 1))) && (var_1_22 == ((unsigned short int) var_1_15))
;
}
int main(void) {
	isInitial = 1;
