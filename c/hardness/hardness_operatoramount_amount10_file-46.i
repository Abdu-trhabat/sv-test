...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch46Amount10.c", 13, "reach_error"); }
...
double var_1_1 = 255.3;
unsigned char var_1_2 = 0;
double var_1_3 = 1000000000000.5;
double var_1_4 = 999999999.125;
signed long int var_1_5 = 0;
signed long int var_1_6 = 100;
signed long int var_1_7 = 256;
signed long int var_1_8 = -5;
double var_1_9 = 24.2;
double var_1_10 = -0.125;
double var_1_11 = -0.5;
void initially(void) {
}
void step(void) {
 signed long int stepLocal_0 = (((((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6)))) > (var_1_7)) ? (((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6)))) : (var_1_7));
 if (var_1_2) {
...
int property(void) {
 return (var_1_2 ? (var_1_1 == ((double) ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4))))) : ((((((((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6)))) > (var_1_7)) ? (((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6)))) : (var_1_7))) < var_1_8) ? (var_1_1 == ((double) (var_1_9 + var_1_10))) : 1)) && (var_1_11 == ((double) var_1_3))
;
}
int main(void) {
 isInitial = 1;
