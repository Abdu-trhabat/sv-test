...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch42Amount50.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_4 > stepLocal_7) {
  var_1_17 = ((((25) > ((var_1_13 + var_1_18))) ? (25) : ((var_1_13 + var_1_18))));
 }
...
int property(void) {
 return ((((((var_1_19 ? (var_1_1 == ((signed short int) ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4))))) : ((((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5))) >= var_1_3) ? (var_1_1 == ((signed short int) var_1_5)) : 1)) && ((var_1_5 >= -2) ? (var_1_6 == ((unsigned char) (var_1_7 - 100))) : 1)) && (((49.5f <= var_1_14) && (var_1_2 && var_1_10)) ? ((var_1_13 < var_1_7) ? (var_1_8 == ((unsigned char) (var_1_2 || var_1_11))) : (var_1_8 == ((unsigned char) var_1_11))) : (var_1_8 == ((unsigned char) var_1_12)))) && ((last_1_var_1_17 >= (last_1_var_1_17 / var_1_7)) ? ((last_1_var_1_17 != ((((((((var_1_3) > (last_1_var_1_17)) ? (var_1_3) : (last_1_var_1_17)))) > (var_1_5)) ? (((((var_1_3) > (last_1_var_1_17)) ? (var_1_3) : (last_1_var_1_17)))) : (var_1_5)))) ? (var_1_13 == ((signed short int) var_1_7)) : (var_1_13 == ((signed short int) last_1_var_1_17))) : (var_1_13 == ((signed short int) var_1_3)))) && (((((((last_1_var_1_1) < (8)) ? (last_1_var_1_1) : (8))) <= var_1_5) || last_1_var_1_8) ? ((last_1_var_1_1 <= var_1_3) ? (var_1_14 == ((float) (var_1_15 + var_1_16))) : (var_1_14 == ((float) var_1_16))) : (var_1_14 == ((float) var_1_16)))) && ((var_1_4 > var_1_3) ? (var_1_17 == ((unsigned short int) ((((25) > ((var_1_13 + var_1_18))) ? (25) : ((var_1_13 + var_1_18)))))) : 1)) && ((var_1_14 <= var_1_15) ? (var_1_19 == ((unsigned char) (var_1_12 || var_1_20))) : 1)
;
}
int main(void) {
 isInitial = 1;
