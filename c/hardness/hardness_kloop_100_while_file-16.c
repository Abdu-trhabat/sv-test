...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16100_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch16100_while
	if (last_1_var_1_14) {
		var_1_7 = var_1_9;
	}


	// From: Req4Batch16100_while
	...
	// From: Req7Batch16100_while
	var_1_18 = (! (var_1_19 || var_1_20));


	// From: Req8Batch16100_while
	...
	// From: Req9Batch16100_while
	if ((- var_1_24) < var_1_23) {
		var_1_25 = ((min (-10 , var_1_26)) + var_1_27);
	}


	// From: Req13Batch16100_while
	var_1_37 = var_1_11;


	// From: Req14Batch16100_while
	var_1_38 = var_1_11;


	// From: Req15Batch16100_while
	var_1_39 = var_1_11;


	// From: Req6Batch16100_while
	if (var_1_39 <= var_1_7) {
		var_1_15 = (max (var_1_11 , var_1_17));
	}


	// From: Req5Batch16100_while
