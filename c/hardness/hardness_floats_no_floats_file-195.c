...
void step(void) {
	...
	// From: Req2Batch195no_floats
	if ((abs (var_1_7)) != last_1_var_1_6) {
		var_1_6 = (max (var_1_9 , (min (var_1_10 , var_1_11))));
	} else {
		var_1_6 = var_1_10;
	}


	// From: Req3Batch195no_floats
	...
	// From: Req4Batch195no_floats
	if (var_1_12) {
		var_1_13 = ((max (var_1_14 , (abs (var_1_15)))) + ((var_1_16 - var_1_17) - (var_1_18 + var_1_19)));
	} else {
		if (var_1_4) {
			var_1_13 = var_1_18;
		} else {
...
int property(void) {
	return ((((var_1_2 < var_1_3) ? (var_1_1 == ((unsigned char) var_1_4)) : (var_1_1 == ((unsigned char) (var_1_4 && var_1_5)))) && (((abs (var_1_7)) != last_1_var_1_6) ? (var_1_6 == ((signed long int) (max (var_1_9 , (min (var_1_10 , var_1_11)))))) : (var_1_6 == ((signed long int) var_1_10)))) && ((var_1_11 != (var_1_7 * var_1_8)) ? (var_1_12 == ((unsigned char) (var_1_5 || var_1_4))) : (var_1_12 == ((unsigned char) (! ((var_1_9 > var_1_6) || var_1_4)))))) && (var_1_12 ? (var_1_13 == ((signed char) ((max (var_1_14 , (abs (var_1_15)))) + ((var_1_16 - var_1_17) - (var_1_18 + var_1_19))))) : (var_1_4 ? (var_1_13 == ((signed char) var_1_18)) : (var_1_13 == ((signed char) var_1_19))))
;
}
int main(void) {
	isInitial = 1;
