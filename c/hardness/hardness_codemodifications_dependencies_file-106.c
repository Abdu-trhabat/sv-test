...
void step(void) {
	...
	// From: Req4Batch106dependencies
	var_1_14 = (((min (4 , var_1_13)) + var_1_5) + var_1_7);


	// From: Req5Batch106dependencies
	var_1_15 = var_1_6;


	// From: Req6Batch106dependencies
	if (var_1_17 || var_1_2) {
		if (var_1_11 > (- var_1_8)) {
			var_1_16 = var_1_19;
		}
	...
	// From: Req8Batch106dependencies
	var_1_23 = var_1_24;


	// From: Req10Batch106dependencies
	var_1_26 = var_1_23;


	// From: Req3Batch106dependencies
