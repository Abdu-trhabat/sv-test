...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch65Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch65Wrapper_AP
	if (0.625f > last_1_double_Array_0_1_) {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
			(*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = (abs ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))));
		}
	} else {
		(*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = (abs ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))));
	}
	...
	// From: Req3Batch65Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) >= (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer))) * 64)) {
			(*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) = ((min ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) , 50.5)) - (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)));
		}
	} else {
		if ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) <= (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))) {
	...
	// From: Req2Batch65Wrapper_AP
	if ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) > (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var5_Pointer)) = ((max ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) , -64)) + (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) + -2) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))));
	}


	// From: Req4Batch65Wrapper_AP
	(*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) = (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer));


	// From: Req5Batch65Wrapper_AP
