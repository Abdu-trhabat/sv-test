...
void step(void) {
 ...
 if ((((((*(WrapperStruct00_var_1_9_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_9_Pointer))) : ((*(WrapperStruct00_var_1_9_Pointer))))) >= (*(WrapperStruct00_var_1_7_Pointer))) {
 ...
 signed long int stepLocal_0 = (((((*(WrapperStruct00_var_1_4_Pointer))) < (-5)) ? ((*(WrapperStruct00_var_1_4_Pointer))) : (-5))) + (((((*(WrapperStruct00_var_1_5_Pointer))) > ((*(WrapperStruct00_var_1_6_Pointer)))) ? ((*(WrapperStruct00_var_1_5_Pointer))) : ((*(WrapperStruct00_var_1_6_Pointer)))));
 if ((*(WrapperStruct00_var_1_2_Pointer))) {
  if ((((((*(WrapperStruct00_var_1_11_Pointer))) < (0)) ? ((*(WrapperStruct00_var_1_11_Pointer))) : (0))) <= stepLocal_0) {
   (*(WrapperStruct00_var_1_1_Pointer)) = (((((*(WrapperStruct00_var_1_7_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_7_Pointer))) : ((*(WrapperStruct00_var_1_7_Pointer)))));
  } else {
...
int property(void) {
 return (((*(WrapperStruct00_var_1_2_Pointer)) ? (((((((*(WrapperStruct00_var_1_11_Pointer))) < (0)) ? ((*(WrapperStruct00_var_1_11_Pointer))) : (0))) <= ((((((*(WrapperStruct00_var_1_4_Pointer))) < (-5)) ? ((*(WrapperStruct00_var_1_4_Pointer))) : (-5))) + (((((*(WrapperStruct00_var_1_5_Pointer))) > ((*(WrapperStruct00_var_1_6_Pointer)))) ? ((*(WrapperStruct00_var_1_5_Pointer))) : ((*(WrapperStruct00_var_1_6_Pointer))))))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((double) (((((*(WrapperStruct00_var_1_7_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_7_Pointer))) : ((*(WrapperStruct00_var_1_7_Pointer))))))) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((double) (((*(WrapperStruct00_var_1_8_Pointer)) + (*(WrapperStruct00_var_1_9_Pointer))) - (*(WrapperStruct00_var_1_10_Pointer)))))) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((double) (*(WrapperStruct00_var_1_8_Pointer))))) && (((*(WrapperStruct00_var_1_5_Pointer)) < (*(WrapperStruct00_var_1_3_Pointer))) ? ((((200 - (*(WrapperStruct00_var_1_12_Pointer))) - (*(WrapperStruct00_var_1_13_Pointer))) >= -100) ? ((*(WrapperStruct00_var_1_11_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_12_Pointer)))) : ((*(WrapperStruct00_var_1_11_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_13_Pointer))))) : 1)) && (((((((*(WrapperStruct00_var_1_9_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_9_Pointer))) : ((*(WrapperStruct00_var_1_9_Pointer))))) >= (*(WrapperStruct00_var_1_7_Pointer))) ? (((-4 + ((*(WrapperStruct00_var_1_12_Pointer)) * (*(WrapperStruct00_var_1_11_Pointer)))) < (1 - (*(WrapperStruct00_var_1_13_Pointer)))) ? ((*(WrapperStruct00_var_1_14_Pointer)) == ((signed char) (*(WrapperStruct00_var_1_12_Pointer)))) : ((*(WrapperStruct00_var_1_14_Pointer)) == ((signed char) -8))) : ((*(WrapperStruct00_var_1_14_Pointer)) == ((signed char) (*(WrapperStruct00_var_1_12_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
