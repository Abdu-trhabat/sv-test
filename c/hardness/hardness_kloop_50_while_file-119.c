...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11950_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch11950_while
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req2Batch11950_while
	if (var_1_5) {
		var_1_4 = (var_1_3 - (var_1_6 - var_1_7));
	}


	// From: Req3Batch11950_while
	...
	// From: Req4Batch11950_while
	var_1_14 = (min (((10 + var_1_15) - var_1_16) , var_1_13));


	// From: Req5Batch11950_while
	if (var_1_5) {
		var_1_17 = ((min (var_1_16 , var_1_15)) + var_1_18);
	} else {
		var_1_17 = (var_1_19 - var_1_18);
	}


	// From: Req6Batch11950_while
	unsigned long int stepLocal_1 = var_1_11;
	if (stepLocal_1 < var_1_10) {
		var_1_20 = var_1_2;
	} else {
		if (! (var_1_5 || var_1_21)) {
			var_1_20 = (max ((var_1_7 + var_1_22) , (min (99.9 , var_1_3))));
		}
	}


	// From: Req7Batch11950_while
	if (! (var_1_16 < var_1_8)) {
		...
		if ((abs (var_1_7)) > var_1_3) {
			var_1_23 = (max ((var_1_16 - 10) , var_1_8));
		} else {
			var_1_23 = var_1_13;
		}
	}
...
int property(void) {
	return ((((((var_1_1 == ((double) (var_1_2 - var_1_3))) && (var_1_5 ? (var_1_4 == ((float) (var_1_3 - (var_1_6 - var_1_7)))) : 1)) && ((var_1_1 <= (var_1_6 / var_1_9)) ? (((var_1_10 / var_1_11) == var_1_12) ? (var_1_8 == ((signed short int) var_1_13)) : 1) : (var_1_8 == ((signed short int) var_1_13)))) && (var_1_14 == ((signed short int) (min (((10 + var_1_15) - var_1_16) , var_1_13))))) && (var_1_5 ? (var_1_17 == ((unsigned short int) ((min (var_1_16 , var_1_15)) + var_1_18))) : (var_1_17 == ((unsigned short int) (var_1_19 - var_1_18))))) && ((var_1_11 < var_1_10) ? (var_1_20 == ((double) var_1_2)) : ((! (var_1_5 || var_1_21)) ? (var_1_20 == ((double) (max ((var_1_7 + var_1_22) , (min (99.9 , var_1_3)))))) : 1))) && ((! (var_1_16 < var_1_8)) ? ((var_1_11 <= var_1_16) ? (var_1_23 == ((signed long int) (var_1_15 + var_1_8))) : (var_1_23 == ((signed long int) (-1 - var_1_18)))) : (((abs (var_1_7)) > var_1_3) ? (var_1_23 == ((signed long int) (max ((var_1_16 - 10) , var_1_8)))) : (var_1_23 == ((signed long int) var_1_13))))
;
}
int main(void) {
	isInitial = 1;
