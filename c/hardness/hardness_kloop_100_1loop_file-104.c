...
void step(void) {
	// From: Req5Batch104100_1loop
	var_1_17 = (var_1_6 || (var_1_18 || var_1_19));


	// From: Req6Batch104100_1loop
	var_1_20 = (var_1_21 - ((var_1_22 + 5) + var_1_23));


	// From: Req7Batch104100_1loop
	var_1_24 = ((max (var_1_23 , var_1_22)) + 4);


	// From: Req10Batch104100_1loop
