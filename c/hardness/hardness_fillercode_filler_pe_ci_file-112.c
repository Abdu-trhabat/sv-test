...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch112Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch112Filler_PE_CI
	/* 1047L, 269L, 831L, 837L) */ var_1_24 = (
		var_1_25
	);


	// From: Req8Batch112Filler_PE_CI
