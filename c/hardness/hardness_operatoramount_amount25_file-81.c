...
void step(void) {
	...
	if (stepLocal_2 || var_1_15) {
		if ((max (25u , var_1_10)) <= stepLocal_3) {
			if (var_1_2) {
				var_1_14 = var_1_16;
			} else {
				var_1_14 = var_1_17;
	...
	signed long int stepLocal_1 = (min (var_1_10 , var_1_8)) + var_1_9;
...
int property(void) {
	return (((var_1_14 ? (var_1_1 == ((double) (max (var_1_3 , (var_1_4 - (var_1_5 - var_1_6)))))) : 1) && (((min (-25 , var_1_8)) != (var_1_9 ^ var_1_10)) ? (var_1_14 ? (var_1_7 == ((signed char) var_1_11)) : 1) : (var_1_7 == ((signed char) var_1_11)))) && ((var_1_7 <= ((min (var_1_10 , var_1_8)) + var_1_9)) ? (var_1_12 == ((signed char) (var_1_13 - 1))) : (var_1_12 == ((signed char) var_1_11)))) && ((var_1_2 || var_1_15) ? (((max (25u , var_1_10)) <= var_1_9) ? (var_1_2 ? (var_1_14 == ((unsigned char) var_1_16)) : (var_1_14 == ((unsigned char) var_1_17))) : 1) : (var_1_14 == ((unsigned char) var_1_16)))
;
}
int main(void) {
	isInitial = 1;
