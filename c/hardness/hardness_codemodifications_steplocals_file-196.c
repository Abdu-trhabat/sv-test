...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch196stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch196stepLocals
	if ((var_1_2 + 3.25) >= ((min (var_1_3 , var_1_4)) - var_1_5)) {
		var_1_1 = (var_1_6 || (var_1_7 && var_1_8));
	}


	// From: Req2Batch196stepLocals
	unsigned long int stepLocal_1 = (var_1_12 - var_1_11) + var_1_13;
	...
	// From: Req6Batch196stepLocals
	if (var_1_18 >= var_1_21) {
		var_1_23 = (min (var_1_18 , var_1_24));
	}


	// From: Req7Batch196stepLocals
	var_1_25 = var_1_23;


	// From: Req8Batch196stepLocals
	var_1_26 = var_1_24;


	// From: Req9Batch196stepLocals
	var_1_27 = var_1_16;
}
