...
void step(void) {
	...
	// From: Req7Batch144100_while
	var_1_16 = (! (var_1_27 || var_1_17));


	// From: Req4Batch144100_while
	if (last_1_var_1_27) {
	...
	// From: Req14Batch144100_while
	var_1_33 = var_1_11;


	// From: Req9Batch144100_while
	...
	// From: Req1Batch144100_while
	var_1_1 = ((100 - var_1_2) - (max (var_1_3 , var_1_4)));


	// From: Req10Batch144100_while
	if (! var_1_16) {
		var_1_23 = var_1_2;
	} else {
	...
	// From: Req13Batch144100_while
	var_1_32 = var_1_3;


	// From: Req5Batch144100_while
	var_1_14 = var_1_32;


	// From: Req2Batch144100_while
