...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch3625_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch3625_while
	var_1_15 = var_1_16;


	// From: Req5Batch3625_while
	var_1_17 = var_1_12;


	// From: Req6Batch3625_while
	var_1_18 = var_1_10;
