...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch86Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) = ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) + (min ((max ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var5_Pointer)))) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)))));
	} else {
		if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)) < (200 * (128 << (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))))) {
			(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) = (abs (max (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)) - 10000) , (min ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var5_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)))))));
		} else {
