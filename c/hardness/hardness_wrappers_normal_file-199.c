...
void step(void) {
	...
	if (var_1_2 >= var_1_3) {
		if (var_1_3 == var_1_2) {
			if (var_1_2 != 4.15f) {
				if ((min (var_1_2 , var_1_3)) >= (min ((var_1_4 - var_1_5) , 3.9f))) {
					var_1_1 = var_1_6;
				} else {
					var_1_1 = 63.42f;
				}
	...
	if ((var_1_8 + var_1_9) < var_1_10) {
		var_1_7 = ((var_1_11 - (min (var_1_12 , var_1_13))) + var_1_14);
	} else {
		if (var_1_10 < var_1_9) {
			var_1_7 = var_1_13;
		} else {
	...
	var_1_15 = (abs (var_1_11 + var_1_13));
...
int property(void) {
	return (((((var_1_2 >= var_1_3) ? ((var_1_3 == var_1_2) ? ((var_1_2 != 4.15f) ? (((min (var_1_2 , var_1_3)) >= (min ((var_1_4 - var_1_5) , 3.9f))) ? (var_1_1 == ((float) var_1_6)) : (var_1_1 == ((float) 63.42f))) : (var_1_1 == ((float) var_1_6))) : 1) : 1) && (((var_1_8 + var_1_9) < var_1_10) ? (var_1_7 == ((float) ((var_1_11 - (min (var_1_12 , var_1_13))) + var_1_14))) : ((var_1_10 < var_1_9) ? (var_1_7 == ((float) var_1_13)) : (var_1_7 == ((float) var_1_12))))) && (var_1_15 == ((double) (abs (var_1_11 + var_1_13))))) && (var_1_16 == ((unsigned short int) var_1_17))) && (var_1_18 == ((signed long int) var_1_17))
;
}
int main(void) {
	isInitial = 1;
