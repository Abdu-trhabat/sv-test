...
void step(void) {
	...
	// From: CodeObject6
	/* 398L, 256L) */ if (/* 399L, 201L, 202L) */ ((var_1_28) >= (var_1_35))) {
		/* 402L, 214L) */ var_1_43 = (
			/* 405L, 213L) */ (max (
				/* 405L, 213L) */ (
					9.99999999999996E13
		...
		/* 409L, 254L) */ if (/* 410L, 220L, 221L) */ ((/* 411L, 218L, 222L) */ ((/* 412L, 216L, 223L) */ (abs (var_1_44))) - (var_1_45))) <= (var_1_30))) {
			/* 416L, 248L) */ if (var_1_12) {
				/* 418L, 239L) */ var_1_43 = (
					var_1_18
				);
			} else {
	...
	// From: CodeObject3
	/* 313L, 133L) */ if (/* 314L, 112L, 113L) */ ((var_1_32) && (var_1_11))) {
		/* 317L, 126L) */ var_1_37 = (
			/* 320L, 125L) */ ((
				/* 321L, 123L) */ ((
					var_1_21
	...
	// From: CodeObject5
	/* 367L, 195L) */ if (var_1_12) {
		/* 369L, 189L) */ if (/* 370L, 151L, 152L) */ ((var_1_26) > (/* 372L, 150L, 154L) */ (abs (var_1_36))))) {
			/* 374L, 164L) */ var_1_42 = (
				/* 377L, 163L) */ (abs (
					var_1_21
				))
			...
			/* 379L, 187L) */ if (/* 380L, 168L, 169L) */ ((/* 381L, 166L, 170L) */ (~ (var_1_27))) >= (var_1_36))) {
				/* 384L, 186L) */ var_1_42 = (
					/* 387L, 185L) */ ((
						/* 388L, 183L) */ ((
							/* 389L, 181L) */ (min (
...
int property(void) {
	if (var_1_11) {
		if (/* 434L, 9L, 15L, 345L, 369L, 1127L) */ ((/* 435L, 7L, 16L, 346L, 370L, 1128L) */ ((var_1_8) / (var_1_4))) <= (var_1_24))) {
		} else {
		}
	} else {
	}
	if (/* 457L, 47L, 52L, 428L, 446L, 948L, 1150L, 25L) */ ((/* 458L, 45L, 53L, 429L, 447L, 946L, 1151L, 23L) */ (- (last_1_var_1_24))) <= (var_1_4))) {
		if (/* 463L, 60L, 66L, 433L, 451L, 955L, 1156L, 32L) */ ((/* 464L, 58L, 67L, 434L, 452L, 952L, 1157L, 29L) */ ((last_1_var_1_24) <= (var_1_4))) || (last_1_var_1_11))) {
		}
	}
	if (/* 476L, 91L, 97L, 570L, 597L, 1169L) */ ((var_1_8) < (/* 478L, 90L, 99L, 572L, 599L, 1171L) */ ((var_1_20) + (var_1_15))))) {
		if (/* 482L, 108L, 116L, 576L, 603L, 1175L) */ ((/* 483L, 104L, 117L, 577L, 604L, 1176L) */ (min (/* 483L, 104L, 117L, 577L, 604L, 1176L) */ (var_1_7) , (var_1_1)))) > (/* 486L, 107L, 120L, 580L, 607L, 1179L) */ ((var_1_6) * (1))))) {
		} else {
		}
	} else {
	}
	if (/* 509L, 179L, 183L, 690L, 711L, 1202L) */ ((var_1_7) < (var_1_6))) {
		if (var_1_11) {
		} else {
			if (/* 521L, 197L, 201L, 702L, 723L, 1214L) */ ((var_1_12) || (var_1_11))) {
			}
		}
	}
	if (var_1_11) {
	...
	if (/* 565L, 265L, 269L, 897L, 911L, 1258L) */ ((var_1_8) == (var_1_19))) {
		if (/* 569L, 274L, 278L, 901L, 915L, 1262L) */ ((var_1_13) < (var_1_6))) {
		}
	}
	return /* 583L) */ ((
	/* 582L) */ ((
		/* 581L) */ ((
			/* 580L) */ ((
				/* 579L) */ ((
					/* 578L) */ ((
						/* 577L) */ ((
							/* 431L, 37L, 342L, 366L, 1124L) */ ((
								var_1_11
							) ? (
								/* 433L, 31L, 344L, 368L, 1126L) */ ((
									/* 434L, 9L, 15L, 345L, 369L, 1127L) */ ((
										/* 435L, 7L, 16L, 346L, 370L, 1128L) */ ((
											var_1_8
										) / (
											var_1_4
										))
									...
									/* 439L, 25L, 350L, 374L, 1132L) */ ((
										var_1_1
									) == (
										/* 439L, 25L, 350L, 374L, 1132L) */ ((signed short int) (
											/* 442L, 24L, 353L, 377L, 1135L) */ ((
												var_1_6
											) - (
												var_1_7
											))
									...
									/* 445L, 29L, 356L, 380L, 1138L) */ ((
										var_1_1
									) == (
										/* 445L, 29L, 356L, 380L, 1138L) */ ((signed short int) (
											var_1_6
										))
									))
								))
							) : (
								/* 449L, 35L, 360L, 384L, 1142L) */ ((
									var_1_1
								) == (
									/* 449L, 35L, 360L, 384L, 1142L) */ ((signed short int) (
										var_1_7
									))
								))
							))
						) && (
							/* 456L, 78L, 427L, 445L, 961L, 1149L, 38L) */ ((
								/* 457L, 47L, 52L, 428L, 446L, 948L, 1150L, 25L) */ ((
									/* 458L, 45L, 53L, 429L, 447L, 946L, 1151L, 23L) */ (- (
										last_1_var_1_24
									))
								) <= (
									var_1_4
								...
								/* 462L, 76L, 432L, 450L, 960L, 1155L, 37L) */ ((
									/* 463L, 60L, 66L, 433L, 451L, 955L, 1156L, 32L) */ ((
										/* 464L, 58L, 67L, 434L, 452L, 952L, 1157L, 29L) */ ((
											last_1_var_1_24
										) <= (
											var_1_4
										))
									...
									/* 470L, 74L, 438L, 456L, 959L, 1163L, 36L) */ ((
										var_1_8
									) == (
										/* 470L, 74L, 438L, 456L, 959L, 1163L, 36L) */ ((float) (
											3.3f
										))
									))
								) : (
						...
						/* 475L, 162L, 569L, 596L, 1168L) */ ((
							/* 476L, 91L, 97L, 570L, 597L, 1169L) */ ((
								var_1_8
							) < (
								/* 478L, 90L, 99L, 572L, 599L, 1171L) */ ((
									var_1_20
								) + (
									var_1_15
								))
							...
							/* 481L, 156L, 575L, 602L, 1174L) */ ((
								/* 482L, 108L, 116L, 576L, 603L, 1175L) */ ((
									/* 483L, 104L, 117L, 577L, 604L, 1176L) */ (min (
										/* 483L, 104L, 117L, 577L, 604L, 1176L) */ (
											var_1_7
										) , (
											var_1_1
										)
									...
									/* 486L, 107L, 120L, 580L, 607L, 1179L) */ ((
										var_1_6
									) * (
										1
									))
								...
								/* 489L, 126L, 583L, 610L, 1182L) */ ((
									var_1_9
								) == (
									/* 489L, 126L, 583L, 610L, 1182L) */ ((unsigned char) (
										var_1_10
									))
								))
							) : (
								/* 493L, 154L, 587L, 614L, 1186L) */ ((
									var_1_9
								) == (
									/* 493L, 154L, 587L, 614L, 1186L) */ ((unsigned char) (
										64
									))
								))
							))
						) : (
							/* 497L, 160L, 591L, 618L, 1190L) */ ((
								var_1_9
							) == (
								/* 497L, 160L, 591L, 618L, 1190L) */ ((unsigned char) (
									var_1_10
								))
							))
						))
					...
					/* 503L, 170L, 636L, 642L, 1196L) */ ((
						var_1_11
					) == (
						/* 503L, 170L, 636L, 642L, 1196L) */ ((unsigned char) (
							var_1_12
						))
					))
				))
			) && (
				/* 508L, 213L, 689L, 710L, 1201L) */ ((
					/* 509L, 179L, 183L, 690L, 711L, 1202L) */ ((
						var_1_7
					) < (
						var_1_6
					))
				) ? (
					/* 512L, 211L, 693L, 714L, 1205L) */ ((
						var_1_11
					) ? (
						/* 514L, 194L, 695L, 716L, 1207L) */ ((
							var_1_13
						) == (
							/* 514L, 194L, 695L, 716L, 1207L) */ ((unsigned char) (
								/* 517L, 193L, 698L, 719L, 1210L) */ (max (
									/* 517L, 193L, 698L, 719L, 1210L) */ (
										var_1_10
									) , (
										var_1_14
									)
						...
						/* 520L, 209L, 701L, 722L, 1213L) */ ((
							/* 521L, 197L, 201L, 702L, 723L, 1214L) */ ((
								var_1_12
							) || (
								var_1_11
							))
						) ? (
							/* 524L, 207L, 705L, 726L, 1217L) */ ((
								var_1_13
							) == (
								/* 524L, 207L, 705L, 726L, 1217L) */ ((unsigned char) (
									var_1_14
								))
							))
						) : (
			...
			/* 530L, 240L, 776L, 798L, 1223L) */ ((
				var_1_11
			) ? (
				/* 532L, 228L, 778L, 800L, 1225L) */ ((
					var_1_15
				) == (
					/* 532L, 228L, 778L, 800L, 1225L) */ ((float) (
						/* 535L, 227L, 781L, 803L, 1228L) */ ((
							var_1_16
						) + (
							/* 537L, 226L, 783L, 805L, 1230L) */ ((
								var_1_17
							) + (
								32.5f
							))
				...
				/* 540L, 238L, 786L, 808L, 1233L) */ ((
					var_1_15
				) == (
					/* 540L, 238L, 786L, 808L, 1233L) */ ((float) (
						/* 543L, 237L, 789L, 811L, 1236L) */ ((
							/* 544L, 235L, 790L, 812L, 1237L) */ ((
								5.064290308105643E18f
							) - (
								/* 546L, 234L, 792L, 814L, 1239L) */ ((
									4.4f
								) + (
									var_1_18
								))
		...
		/* 552L, 256L, 844L, 856L, 1245L) */ ((
			var_1_20
		) == (
			/* 552L, 256L, 844L, 856L, 1245L) */ ((double) (
				/* 555L, 255L, 847L, 859L, 1248L) */ ((
					var_1_18
				) - (
					/* 557L, 254L, 849L, 861L, 1250L) */ ((
						/* 558L, 252L, 850L, 862L, 1251L) */ (min (
							/* 558L, 252L, 850L, 862L, 1251L) */ (
								var_1_21
							) , (
								var_1_22
							)
	...
	/* 564L, 288L, 896L, 910L, 1257L) */ ((
		/* 565L, 265L, 269L, 897L, 911L, 1258L) */ ((
			var_1_8
		) == (
			var_1_19
		))
	) ? (
		/* 568L, 286L, 900L, 914L, 1261L) */ ((
			/* 569L, 274L, 278L, 901L, 915L, 1262L) */ ((
				var_1_13
			) < (
				var_1_6
			))
		) ? (
			/* 572L, 284L, 904L, 918L, 1265L) */ ((
				var_1_24
			) == (
				/* 572L, 284L, 904L, 918L, 1265L) */ ((float) (
					var_1_23
				))
			))
		) : (
