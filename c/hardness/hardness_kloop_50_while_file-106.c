...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10650_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch10650_while
	var_1_14 = (((min (4 , var_1_13)) + var_1_5) + var_1_7);


	// From: Req5Batch10650_while
	var_1_15 = var_1_6;


	// From: Req6Batch10650_while
	...
	// From: Req8Batch10650_while
	var_1_23 = var_1_24;


	// From: Req10Batch10650_while
	var_1_26 = var_1_23;


	// From: Req3Batch10650_while
...
int property(void) {
	return (((((((((var_1_2 ? (var_1_3 ? (var_1_1 == ((signed short int) (min (var_1_4 , ((var_1_5 + 256) - (min (var_1_6 , var_1_7))))))) : (var_1_1 == ((signed short int) (var_1_5 - var_1_7)))) : (var_1_1 == ((signed short int) var_1_4))) && ((var_1_7 <= (var_1_5 + (var_1_6 - var_1_9))) ? (var_1_3 ? (var_1_8 == ((float) (var_1_10 - var_1_11))) : (var_1_8 == ((float) (max (var_1_11 , var_1_10))))) : (var_1_8 == ((float) var_1_11)))) && (((var_1_7 + var_1_6) > (var_1_23 * var_1_9)) ? (var_1_12 == ((signed short int) (var_1_5 - (var_1_13 + 64)))) : (var_1_12 == ((signed short int) var_1_13)))) && (var_1_14 == ((unsigned short int) (((min (4 , var_1_13)) + var_1_5) + var_1_7)))) && (var_1_15 == ((unsigned short int) var_1_6))) && ((var_1_17 || var_1_2) ? ((var_1_11 > (- var_1_8)) ? (var_1_16 == ((unsigned char) var_1_19)) : 1) : 1)) && (((var_1_6 + var_1_15) <= var_1_23) ? (var_1_20 == ((double) var_1_10)) : (var_1_20 == ((double) (max (var_1_11 , (min (var_1_10 , (var_1_21 + var_1_22))))))))) && (var_1_23 == ((unsigned long int) var_1_24))) && (var_1_25 == ((signed short int) var_1_12))) && (var_1_26 == ((signed long int) var_1_23))
;
}
int main(void) {
	isInitial = 1;
