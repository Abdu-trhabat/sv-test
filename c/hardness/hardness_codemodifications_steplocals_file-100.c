...
void step(void) {
	// From: Req1Batch100stepLocals
	unsigned long int stepLocal_1 = 8u;
	unsigned long int stepLocal_0 = (min (var_1_2 , var_1_3)) + var_1_4;
	...
	if ((var_1_3 ^ (var_1_9 - var_1_10)) > stepLocal_3) {
		if (((max (var_1_2 , var_1_9)) + var_1_3) == stepLocal_2) {
			var_1_6 = var_1_13;
		} else {
