...
void step(void) {
	...
	// From: Req7Batch164Amount50
	if ((var_1_21 / (abs (var_1_30))) <= var_1_19) {
		var_1_29 = var_1_6;
	}


	// From: Req2Batch164Amount50
	if (var_1_24) {
		if ((- var_1_10) < 127.25f) {
