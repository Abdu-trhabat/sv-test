...
void step(void) {
	...
	// From: CodeObject5
	/* 257L, 104L) */ if (/* 258L, 50L, 51L) */ ((/* 259L, 46L, 52L) */ (~ (var_1_33))) < (/* 261L, 49L, 54L) */ ((var_1_34) * (var_1_19))))) {
		/* 264L, 98L) */ if (var_1_15) {
			/* 266L, 76L) */ var_1_39 = (
				/* 269L, 75L) */ (min (
					/* 269L, 75L) */ (
						/* 270L, 71L) */ ((
			...
			/* 277L, 96L) */ if (/* 278L, 81L, 82L) */ ((/* 279L, 79L, 83L) */ ((var_1_33) | (var_1_19))) >= (var_1_34))) {
				/* 283L, 95L) */ var_1_39 = (
					var_1_36
				);
			}
	...
	/* 292L, 165L) */ if (var_1_15) {
		/* 294L, 163L) */ if (/* 295L, 125L, 126L) */ ((/* 296L, 117L, 127L) */ ((/* 297L, 115L, 128L) */ (~ (var_1_34))) ^ (var_1_33))) < (/* 300L, 124L, 131L) */ ((/* 301L, 120L, 132L) */ ((var_1_6) | (var_1_1))) % (/* 304L, 123L, 135L) */ (min (/* 304L, 123L, 135L) */ (var_1_44) , (var_1_45)))))))) {
			/* 307L, 157L) */ var_1_42 = (
				/* 310L, 156L) */ (min (
					/* 310L, 156L) */ (
						/* 311L, 154L) */ ((
