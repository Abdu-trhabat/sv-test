...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch8050_while.c", 13, "reach_error"); }
...
int property(void) {
 return (((((((((var_1_2 - var_1_3) * last_1_var_1_24) < last_1_var_1_24) ? (var_1_1 == ((signed short int) ((((-8) < ((var_1_6 + ((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8)))))) ? (-8) : ((var_1_6 + ((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))))))))) : (var_1_1 == ((signed short int) var_1_6))) && ((var_1_8 >= var_1_7) ? (var_1_9 == ((signed short int) (-256 + var_1_6))) : (var_1_9 == ((signed short int) (var_1_7 + var_1_6))))) && (var_1_11 ? (var_1_10 == ((unsigned char) ((((0) < (var_1_12)) ? (0) : (var_1_12))))) : ((! (last_1_var_1_19 > (255.9 / var_1_13))) ? (var_1_10 == ((unsigned char) var_1_12)) : 1))) && ((! var_1_11) ? ((((var_1_15 - var_1_16) - var_1_17) <= var_1_13) ? (var_1_14 == ((unsigned short int) var_1_10)) : (var_1_14 == ((unsigned short int) 128))) : 1)) && (((2935136887u - (var_1_12 + var_1_10)) <= var_1_14) ? (var_1_18 == ((signed char) 32)) : 1)) && ((var_1_12 < (1 + var_1_14)) ? (var_1_19 == ((double) (var_1_20 + (((((199.5 + var_1_21)) > (((((var_1_22) > (var_1_23)) ? (var_1_22) : (var_1_23))))) ? ((199.5 + var_1_21)) : (((((var_1_22) > (var_1_23)) ? (var_1_22) : (var_1_23))))))))) : (var_1_19 == ((double) (var_1_22 + var_1_20))))) && (((32 + var_1_12) != var_1_1) ? (var_1_24 == ((double) var_1_21)) : 1)
;
}
int main(void) {
 isInitial = 1;
