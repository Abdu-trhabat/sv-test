...
void step(void) {
	...
	// From: Req2Batch159Amount100
	var_1_8 = (((max (var_1_9 , var_1_10)) - (var_1_11 + var_1_12)) - var_1_13);


	// From: Req4Batch159Amount100
	if (var_1_2) {
		var_1_16 = (var_1_17 - var_1_18);
	}


	// From: Req5Batch159Amount100
	if (var_1_15 != (var_1_18 - 64)) {
		var_1_19 = var_1_17;
	}


	// From: Req7Batch159Amount100
	if (var_1_6 > var_1_1) {
		var_1_22 = (var_1_6 + var_1_7);
	}


	// From: Req8Batch159Amount100
