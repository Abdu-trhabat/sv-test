...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch90Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject8
	/* 408L, 306L) */ if (/* 409L, 267L, 268L) */ ((var_1_1) >= (/* 411L, 266L, 270L) */ ((16) << (var_1_27))))) {
		/* 414L, 300L) */ if (/* 415L, 282L, 283L) */ ((var_1_16) > (/* 417L, 281L, 285L) */ ((var_1_16) | (var_1_39))))) {
			/* 420L, 299L) */ var_1_50 = (
				/* 423L, 298L) */ ((
					/* 424L, 296L) */ (abs (
						var_1_51
	...
	/* 313L, 154L) */ if (var_1_29) {
		/* 315L, 152L) */ if (/* 316L, 102L, 103L) */ ((var_1_27) < (/* 318L, 101L, 105L) */ (max (/* 318L, 101L, 105L) */ (/* 319L, 97L, 106L) */ (min (/* 319L, 97L, 106L) */ (var_1_18) , (var_1_30)))) , (/* 322L, 100L, 109L) */ ((var_1_1) / (var_1_32)))))))) {
			/* 325L, 150L) */ if (/* 326L, 124L, 125L) */ ((/* 327L, 122L, 126L) */ (abs (var_1_21))) < (var_1_21))) {
				/* 330L, 138L) */ var_1_28 = (
					/* 333L, 137L) */ ((
						var_1_35
					) || (
	...
	// From: CodeObject6
	/* 382L, 236L) */ if (/* 383L, 217L, 218L) */ ((var_1_42) <= (/* 385L, 216L, 220L) */ ((/* 386L, 214L, 221L) */ ((var_1_41) >> (var_1_47))) % (var_1_32))))) {
		/* 390L, 235L) */ var_1_46 = (
			var_1_27
		);
	}
	...
	// From: CodeObject3
	/* 344L, 186L) */ if (/* 345L, 160L, 161L) */ ((var_1_15) == (var_1_21))) {
		/* 348L, 175L) */ var_1_38 = (
			/* 351L, 174L) */ (abs (
				/* 352L, 173L) */ (min (
					/* 352L, 173L) */ (
