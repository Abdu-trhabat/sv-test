...
void step(void) {
	// From: Req4Batch193has_floats
	var_1_10 = last_1_var_1_10;


	// From: Req5Batch193has_floats
	var_1_11 = var_1_10;


	// From: Req1Batch193has_floats
	signed short int stepLocal_2 = var_1_10;
	signed short int stepLocal_1 = var_1_10;
	signed long int stepLocal_0 = max ((- var_1_10) , var_1_11);
	...
	// From: Req2Batch193has_floats
	if (var_1_6) {
		var_1_5 = (var_1_11 + (max ((min (var_1_11 , var_1_10)) , var_1_11)));
	}


	// From: Req3Batch193has_floats
...
int property(void) {
	return (((((last_1_var_1_1 == var_1_10) ? ((last_1_var_1_1 > (max ((- var_1_10) , var_1_11))) ? (((last_1_var_1_1 * (var_1_11 * -5)) > var_1_10) ? (var_1_1 == ((signed short int) var_1_10)) : 1) : (var_1_1 == ((signed short int) last_1_var_1_1))) : (var_1_1 == ((signed short int) var_1_11))) && (var_1_6 ? (var_1_5 == ((signed long int) (var_1_11 + (max ((min (var_1_11 , var_1_10)) , var_1_11))))) : 1)) && ((var_1_10 == (var_1_5 * var_1_1)) ? ((var_1_10 >= (- var_1_1)) ? ((var_1_5 <= var_1_1) ? (var_1_7 == ((double) var_1_8)) : (var_1_7 == ((double) var_1_9))) : 1) : 1)) && (var_1_10 == ((signed short int) last_1_var_1_10))) && (var_1_11 == ((signed short int) var_1_10))
;
}
int main(void) {
	isInitial = 1;
