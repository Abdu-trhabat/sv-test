...
void step(void) {
	...
	if (((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)) < (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var4_Pointer))) || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) = ((max ((abs ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var4_Pointer)))) , 3934615513u)) - (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)));
	} else {
	...
	if ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) >= stepLocal_1) {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
			(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = (min ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer))));
		}
	} else {
