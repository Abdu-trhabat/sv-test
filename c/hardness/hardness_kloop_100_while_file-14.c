...
void step(void) {
	...
	// From: Req12Batch14100_while
	var_1_35 = var_1_33;


	// From: Req13Batch14100_while
	var_1_36 = var_1_37;


	// From: Req14Batch14100_while
	var_1_38 = var_1_27;


	// From: Req9Batch14100_while
	...
	// From: Req5Batch14100_while
	unsigned long int stepLocal_4 = var_1_5 / (max (var_1_8 , var_1_16));
	...
	// From: Req8Batch14100_while
	if ((min ((var_1_28 / var_1_24) , var_1_4)) < (min (var_1_38 , 500u))) {
		var_1_26 = (var_1_27 - (abs (var_1_25)));
	}


	// From: Req10Batch14100_while
	if (var_1_1 > var_1_28) {
		if (var_1_22 <= var_1_5) {
			var_1_29 = ((min (var_1_38 , (var_1_26 + var_1_25))) + (abs (var_1_27 + var_1_24)));
		}
	} else {
		if (var_1_5 > var_1_27) {
			var_1_29 = var_1_28;
	...
	// From: Req6Batch14100_while
	if ((var_1_18 - (max (var_1_19 , var_1_20))) <= var_1_21) {
		var_1_17 = (max ((4 + var_1_8) , (var_1_22 + (var_1_29 + var_1_9))));
	} else {
		var_1_17 = var_1_8;
	}


	// From: Req11Batch14100_while
	if (var_1_10) {
...
int property(void) {
	return ((((((((((((((var_1_2 >= var_1_3) ? (var_1_1 == ((unsigned long int) (var_1_4 - var_1_5))) : (((var_1_2 / 5) <= -64) ? (var_1_1 == ((unsigned long int) var_1_4)) : (var_1_1 == ((unsigned long int) var_1_5)))) && ((! var_1_13) ? ((var_1_28 >= var_1_1) ? (var_1_6 == ((unsigned char) (var_1_8 - var_1_9))) : ((var_1_28 <= var_1_1) ? (var_1_6 == ((unsigned char) var_1_8)) : 1)) : (var_1_6 == ((unsigned char) var_1_9)))) && ((var_1_38 < var_1_8) ? ((var_1_13 || ((var_1_1 / 10) >= var_1_9)) ? (var_1_10 == ((unsigned char) (! (! var_1_11)))) : ((var_1_4 >= var_1_38) ? (var_1_10 == ((unsigned char) var_1_12)) : (var_1_10 == ((unsigned char) var_1_11)))) : (var_1_10 == ((unsigned char) 1)))) && ((var_1_28 > -10) ? ((var_1_38 > (256u * var_1_28)) ? (var_1_13 == ((unsigned char) 0)) : (var_1_13 == ((unsigned char) var_1_12))) : 1)) && ((var_1_23 < var_1_28) ? (((var_1_5 / (max (var_1_8 , var_1_16))) >= var_1_38) ? (var_1_14 == ((unsigned char) 5)) : 1) : 1)) && (((var_1_18 - (max (var_1_19 , var_1_20))) <= var_1_21) ? (var_1_17 == ((unsigned short int) (max ((4 + var_1_8) , (var_1_22 + (var_1_29 + var_1_9)))))) : (var_1_17 == ((unsigned short int) var_1_8)))) && ((last_1_var_1_28 <= (- last_1_var_1_38)) ? (var_1_23 == ((unsigned char) ((var_1_24 + var_1_25) - var_1_9))) : 1)) && (((min ((var_1_28 / var_1_24) , var_1_4)) < (min (var_1_38 , 500u))) ? (var_1_26 == ((unsigned char) (var_1_27 - (abs (var_1_25))))) : 1)) && (var_1_12 ? ((last_1_var_1_28 > ((var_1_27 - var_1_25) + var_1_38)) ? (((var_1_23 / var_1_25) > var_1_27) ? (var_1_28 == ((signed long int) var_1_16)) : (var_1_28 == ((signed long int) -16))) : 1) : 1)) && ((var_1_1 > var_1_28) ? ((var_1_22 <= var_1_5) ? (var_1_29 == ((signed short int) ((min (var_1_38 , (var_1_26 + var_1_25))) + (abs (var_1_27 + var_1_24))))) : 1) : ((var_1_5 > var_1_27) ? (var_1_29 == ((signed short int) var_1_28)) : 1))) && (var_1_10 ? (var_1_31 == ((signed char) (max (var_1_33 , var_1_34)))) : 1)) && (var_1_35 == ((signed char) var_1_33))) && (var_1_36 == ((float) var_1_37))) && (var_1_38 == ((unsigned long int) var_1_27))
;
}
int main(void) {
	isInitial = 1;
