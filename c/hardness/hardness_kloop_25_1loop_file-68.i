...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch6825_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_3 > (var_1_2 - (var_1_12 + var_1_13))) {
  var_1_11 = ((((var_1_14) > ((((((var_1_15 + var_1_16)) > (8)) ? ((var_1_15 + var_1_16)) : (8))))) ? (var_1_14) : ((((((var_1_15 + var_1_16)) > (8)) ? ((var_1_15 + var_1_16)) : (8))))));
 }
 var_1_17 = var_1_18;
 signed short int stepLocal_1 = var_1_11;
 if ((((((- last_1_var_1_9)) > ((var_1_11 | var_1_8))) ? ((- last_1_var_1_9)) : ((var_1_11 | var_1_8)))) > stepLocal_1) {
  var_1_9 = -16;
 } else {
  var_1_9 = var_1_11;
 }
...
int property(void) {
 return (((((var_1_2 - var_1_3) >= var_1_4) ? (((var_1_5 + var_1_6) >= (var_1_7 / var_1_8)) ? (var_1_1 == ((signed long int) var_1_6)) : 1) : (var_1_1 == ((signed long int) var_1_6))) && (((((((- last_1_var_1_9)) > ((var_1_11 | var_1_8))) ? ((- last_1_var_1_9)) : ((var_1_11 | var_1_8)))) > var_1_11) ? (var_1_9 == ((signed long int) -16)) : (var_1_9 == ((signed long int) var_1_11)))) && ((var_1_3 > (var_1_2 - (var_1_12 + var_1_13))) ? (var_1_11 == ((signed short int) ((((var_1_14) > ((((((var_1_15 + var_1_16)) > (8)) ? ((var_1_15 + var_1_16)) : (8))))) ? (var_1_14) : ((((((var_1_15 + var_1_16)) > (8)) ? ((var_1_15 + var_1_16)) : (8)))))))) : 1)) && (var_1_17 == ((unsigned char) var_1_18))
;
}
int main(void) {
 isInitial = 1;
