...
void step(void) {
 ...
 if ((- (float_Array_0[0][0] / 0.6f)) > ((float_Array_0[0][1] + 3.25f) / ((((float_Array_0[1][1]) < (float_Array_0[1][0])) ? (float_Array_0[1][1]) : (float_Array_0[1][0]))))) {
  unsigned_long_int_Array_0[0] = (500u + ((((unsigned_char_Array_0[0][0]) < (unsigned_short_int_Array_0[0][0])) ? (unsigned_char_Array_0[0][0]) : (unsigned_short_int_Array_0[0][0]))));
 } else {
 ...
 if (stepLocal_2 != (unsigned_short_int_Array_0[0][1] - 64)) {
  unsigned_char_Array_0[1][0] = ((((unsigned_char_Array_0[0][0]) > (unsigned_char_Array_0[0][1])) ? (unsigned_char_Array_0[0][0]) : (unsigned_char_Array_0[0][1])));
 } else {
  unsigned_char_Array_0[1][0] = ((((unsigned_char_Array_0[0][1]) < (unsigned_char_Array_0[0][0])) ? (unsigned_char_Array_0[0][1]) : (unsigned_char_Array_0[0][0])));
 }
}
void updateVariables(void) {
...
int property(void) {
 return ((((((last_1_unsigned_short_int_Array_0_1__1_ / signed_short_int_Array_0[0]) >= unsigned_long_int_Array_0[0]) ? (((- signed_short_int_Array_0[0]) > last_1_unsigned_short_int_Array_0_1__1_) ? (unsigned_short_int_Array_0[1][1] == ((unsigned short int) ((((unsigned_short_int_Array_0[0][1]) < (unsigned_short_int_Array_0[1][0])) ? (unsigned_short_int_Array_0[0][1]) : (unsigned_short_int_Array_0[1][0]))))) : 1) : 1) && (unsigned_short_int_Array_0[0][0] == ((unsigned short int) unsigned_short_int_Array_0[0][1]))) && (((unsigned_long_int_Array_0[0] / signed_short_int_Array_0[0]) != (unsigned_short_int_Array_0[0][1] - 64)) ? (unsigned_char_Array_0[1][0] == ((unsigned char) ((((unsigned_char_Array_0[0][0]) > (unsigned_char_Array_0[0][1])) ? (unsigned_char_Array_0[0][0]) : (unsigned_char_Array_0[0][1]))))) : (unsigned_char_Array_0[1][0] == ((unsigned char) ((((unsigned_char_Array_0[0][1]) < (unsigned_char_Array_0[0][0])) ? (unsigned_char_Array_0[0][1]) : (unsigned_char_Array_0[0][0]))))))) && (((- (float_Array_0[0][0] / 0.6f)) > ((float_Array_0[0][1] + 3.25f) / ((((float_Array_0[1][1]) < (float_Array_0[1][0])) ? (float_Array_0[1][1]) : (float_Array_0[1][0]))))) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) (500u + ((((unsigned_char_Array_0[0][0]) < (unsigned_short_int_Array_0[0][0])) ? (unsigned_char_Array_0[0][0]) : (unsigned_short_int_Array_0[0][0])))))) : (unsigned_long_int_Array_0[0] == ((unsigned long int) (unsigned_long_int_Array_0[1] - unsigned_char_Array_0[0][0]))))) && (unsigned_char_Array_0[1][1] == ((unsigned char) unsigned_char_Array_0[0][1]))
;
}
int main(void) {
 isInitial = 1;
