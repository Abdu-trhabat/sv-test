...
void step(void) {
	...
	// From: Req2Batch11450_1loop
	if (var_1_1 || var_1_6) {
		var_1_7 = (min (var_1_5 , var_1_8));
	}


	// From: Req7Batch11450_1loop
	var_1_20 = var_1_21;


	// From: Req8Batch11450_1loop
	var_1_22 = 16u;


	// From: Req9Batch11450_1loop
	var_1_23 = var_1_18;


	// From: Req3Batch11450_1loop
