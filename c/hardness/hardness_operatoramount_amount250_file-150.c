...
void step(void) {
	// From: Req1Batch150Amount250
	var_1_1 = var_1_2;


	// From: Req5Batch150Amount250
	if (var_1_8 >= var_1_1) {
	...
	// From: Req9Batch150Amount250
	var_1_32 = ((abs (50.5f)) + var_1_33);


	// From: Req11Batch150Amount250
	unsigned char stepLocal_12 = var_1_7;
	if (((var_1_38 - var_1_39) - 100) != stepLocal_12) {
		var_1_37 = (max (((min (var_1_39 , var_1_40)) + var_1_41) , (max (var_1_7 , 1))));
	} else {
		var_1_37 = (abs (var_1_7));
	}


	// From: Req12Batch150Amount250
	var_1_42 = ((var_1_22 && var_1_21) && var_1_43);


	// From: Req15Batch150Amount250
	...
	// From: Req16Batch150Amount250
	if (var_1_20) {
		var_1_53 = var_1_16;
	}


	// From: Req18Batch150Amount250
	if (var_1_20) {
		var_1_56 = ((var_1_48 + (max (var_1_7 , var_1_49))) + (var_1_41 + last_1_var_1_56));
	} else {
		var_1_56 = ((abs (var_1_58)) - var_1_40);
	}


	// From: Req20Batch150Amount250
	if (var_1_42) {
		var_1_62 = (var_1_61 - (var_1_63 + var_1_64));
	}


	// From: Req21Batch150Amount250
	if ((16 != (~ var_1_49)) || (var_1_17 == var_1_63)) {
		var_1_65 = (max ((var_1_60 - (abs (var_1_33))) , var_1_63));
	} else {
		var_1_65 = (abs (var_1_63 + 128.4));
	}


	// From: Req22Batch150Amount250
	...
	// From: Req25Batch150Amount250
	var_1_71 = var_1_72;


	// From: Req26Batch150Amount250
	if (var_1_43) {
		var_1_73 = var_1_38;
	}


	// From: Req2Batch150Amount250
	...
	// From: Req4Batch150Amount250
	unsigned long int stepLocal_5 = var_1_66;
	if (var_1_7 > stepLocal_5) {
		var_1_15 = (max (var_1_16 , var_1_17));
	} else {
		var_1_15 = (min (var_1_16 , (min ((max (var_1_17 , var_1_18)) , var_1_19))));
	}


	// From: Req6Batch150Amount250
	if (var_1_52) {
		var_1_24 = (! var_1_23);
	} else {
	...
	// From: Req8Batch150Amount250
	if (var_1_53 != (min ((min (var_1_16 , var_1_18)) , var_1_30))) {
		var_1_31 = ((min (var_1_37 , var_1_7)) + (max (var_1_9 , (var_1_8 + 32))));
	}


	// From: Req10Batch150Amount250
	...
	if (stepLocal_10 == var_1_1) {
		if ((max ((var_1_8 & var_1_2) , var_1_1)) > stepLocal_9) {
			if (var_1_31 >= stepLocal_11) {
				var_1_34 = var_1_33;
			}
		}
	} else {
		var_1_34 = (max ((max (var_1_16 , var_1_35)) , (var_1_33 + var_1_36)));
	}


	// From: Req14Batch150Amount250
	if (var_1_71) {
		var_1_51 = (min (256 , var_1_47));
	} else {
		var_1_51 = var_1_46;
	}


	// From: Req17Batch150Amount250
	if (var_1_37 >= (var_1_3 * var_1_7)) {
		var_1_54 = (last_1_var_1_54 && var_1_13);
	}


	// From: Req23Batch150Amount250
	...
	if (var_1_39 == stepLocal_16) {
		...
		if (stepLocal_15 == var_1_49) {
			var_1_67 = (min (4.2 , 127.5));
		} else {
			if (((var_1_35 + var_1_61) / (abs (var_1_68))) < (max (var_1_34 , (max (var_1_65 , var_1_17))))) {
				var_1_67 = var_1_36;
			} else {
				var_1_67 = (min (var_1_64 , (min (500.4 , var_1_36))));
			}
		}
	}


	// From: Req24Batch150Amount250
	...
	if (stepLocal_18 || var_1_52) {
		if (var_1_48 <= stepLocal_19) {
			var_1_69 = (max ((min (var_1_38 , var_1_48)) , var_1_39));
		} else {
			if (var_1_18 < 10.5) {
				var_1_69 = var_1_48;
			} else {
		...
		if (! (var_1_42 && (var_1_18 > var_1_64))) {
			if (stepLocal_20 == (var_1_48 | var_1_9)) {
				...
				var_1_69 = (max (var_1_45 , var_1_49));
			}
		} else {
	...
	// From: Req27Batch150Amount250
	unsigned long int stepLocal_22 = 10u;
	unsigned long int stepLocal_21 = (min (var_1_41 , var_1_66)) * var_1_58;
	...
	// From: Req3Batch150Amount250
	unsigned long int stepLocal_4 = (var_1_1 & var_1_9) * var_1_73;
	unsigned long int stepLocal_3 = min (var_1_2 , (var_1_73 + var_1_4));
	...
	if (((~ var_1_8) + (~ var_1_12)) < stepLocal_13) {
		...
		if (var_1_30 > var_1_17) {
			var_1_44 = (var_1_45 - (min (var_1_46 , var_1_39)));
		} else {
	...
	// From: Req19Batch150Amount250
	if (var_1_10) {
		var_1_59 = (var_1_60 - var_1_61);
	}


	// From: Req7Batch150Amount250
	...
	if (stepLocal_7 >= var_1_73) {
		if ((max (var_1_7 , (var_1_2 + var_1_1))) != stepLocal_8) {
...
int property(void) {
	return ((((((((((((((((((((((((((var_1_1 == ((signed long int) var_1_2)) && ((var_1_2 <= (~ var_1_1)) ? ((((var_1_2 & var_1_1) / var_1_4) <= (var_1_66 | var_1_73)) ? (var_1_3 == ((unsigned char) (max ((max (var_1_7 , var_1_8)) , var_1_9)))) : 1) : (var_1_3 == ((unsigned char) var_1_9)))) && (((! 1) && var_1_24) ? ((var_1_37 >= ((var_1_1 & var_1_9) * var_1_73)) ? (((min (var_1_2 , (var_1_73 + var_1_4))) <= (var_1_8 / var_1_12)) ? (var_1_10 == ((unsigned char) (! var_1_13))) : 1) : 1) : (var_1_10 == ((unsigned char) (var_1_42 && var_1_13))))) && ((var_1_7 > var_1_66) ? (var_1_15 == ((double) (max (var_1_16 , var_1_17)))) : (var_1_15 == ((double) (min (var_1_16 , (min ((max (var_1_17 , var_1_18)) , var_1_19)))))))) && ((var_1_8 >= var_1_1) ? (var_1_20 == ((unsigned char) (var_1_21 && var_1_22))) : (var_1_20 == ((unsigned char) (var_1_13 || var_1_23))))) && (var_1_52 ? (var_1_24 == ((unsigned char) (! var_1_23))) : (((10 <= var_1_66) && var_1_20) ? (var_1_24 == ((unsigned char) (var_1_23 && (var_1_13 || var_1_25)))) : (var_1_24 == ((unsigned char) ((var_1_18 < var_1_16) && (var_1_13 && (var_1_25 && var_1_23)))))))) && ((var_1_8 >= var_1_73) ? (((max (var_1_7 , (var_1_2 + var_1_1))) != var_1_8) ? (((var_1_1 / var_1_4) >= (var_1_7 * var_1_73)) ? ((var_1_59 <= (128.75f + var_1_65)) ? (var_1_26 == ((double) var_1_19)) : (var_1_26 == ((double) var_1_18))) : (var_1_26 == ((double) var_1_17))) : (var_1_26 == ((double) var_1_30))) : 1)) && ((var_1_53 != (min ((min (var_1_16 , var_1_18)) , var_1_30))) ? (var_1_31 == ((unsigned short int) ((min (var_1_37 , var_1_7)) + (max (var_1_9 , (var_1_8 + 32)))))) : 1)) && (var_1_32 == ((float) ((abs (50.5f)) + var_1_33)))) && ((var_1_66 == var_1_1) ? (((max ((var_1_8 & var_1_2) , var_1_1)) > var_1_1) ? ((var_1_31 >= var_1_12) ? (var_1_34 == ((double) var_1_33)) : 1) : 1) : (var_1_34 == ((double) (max ((max (var_1_16 , var_1_35)) , (var_1_33 + var_1_36))))))) && ((((var_1_38 - var_1_39) - 100) != var_1_7) ? (var_1_37 == ((unsigned char) (max (((min (var_1_39 , var_1_40)) + var_1_41) , (max (var_1_7 , 1)))))) : (var_1_37 == ((unsigned char) (abs (var_1_7)))))) && (var_1_42 == ((unsigned char) ((var_1_22 && var_1_21) && var_1_43)))) && ((((~ var_1_8) + (~ var_1_12)) < (var_1_51 ^ (var_1_39 - var_1_4))) ? (var_1_44 == ((signed char) ((var_1_45 - var_1_46) - var_1_39))) : ((var_1_30 > var_1_17) ? (var_1_44 == ((signed char) (var_1_45 - (min (var_1_46 , var_1_39))))) : (var_1_44 == ((signed char) (var_1_46 - ((var_1_47 - var_1_48) + (var_1_49 - var_1_50)))))))) && (var_1_71 ? (var_1_51 == ((unsigned short int) (min (256 , var_1_47)))) : (var_1_51 == ((unsigned short int) var_1_46)))) && ((var_1_39 > var_1_48) ? (var_1_52 == ((unsigned char) var_1_22)) : 1)) && (var_1_20 ? (var_1_53 == ((double) var_1_16)) : 1)) && ((var_1_37 >= (var_1_3 * var_1_7)) ? (var_1_54 == ((unsigned char) (last_1_var_1_54 && var_1_13))) : 1)) && (var_1_20 ? (var_1_56 == ((unsigned short int) ((var_1_48 + (max (var_1_7 , var_1_49))) + (var_1_41 + last_1_var_1_56)))) : (var_1_56 == ((unsigned short int) ((abs (var_1_58)) - var_1_40))))) && (var_1_10 ? (var_1_59 == ((float) (var_1_60 - var_1_61))) : 1)) && (var_1_42 ? (var_1_62 == ((double) (var_1_61 - (var_1_63 + var_1_64)))) : 1)) && (((16 != (~ var_1_49)) || (var_1_17 == var_1_63)) ? (var_1_65 == ((double) (max ((var_1_60 - (abs (var_1_33))) , var_1_63)))) : (var_1_65 == ((double) (abs (var_1_63 + 128.4)))))) && (((- (var_1_45 / var_1_38)) >= var_1_8) ? (var_1_66 == ((unsigned long int) ((3456630165u - var_1_56) - var_1_40))) : (var_1_66 == ((unsigned long int) (32u + var_1_38))))) && ((var_1_39 == (var_1_2 | var_1_73)) ? (((31.25 + (var_1_61 + var_1_53)) != var_1_16) ? (var_1_67 == ((double) var_1_36)) : (var_1_67 == ((double) var_1_64))) : ((var_1_58 == var_1_49) ? (var_1_67 == ((double) (min (4.2 , 127.5)))) : ((((var_1_35 + var_1_61) / (abs (var_1_68))) < (max (var_1_34 , (max (var_1_65 , var_1_17))))) ? (var_1_67 == ((double) var_1_36)) : (var_1_67 == ((double) (min (var_1_64 , (min (500.4 , var_1_36)))))))))) && ((var_1_22 || var_1_52) ? ((var_1_48 <= var_1_2) ? (var_1_69 == ((signed char) (max ((min (var_1_38 , var_1_48)) , var_1_39)))) : ((var_1_18 < 10.5) ? (var_1_69 == ((signed char) var_1_48)) : (var_1_69 == ((signed char) (var_1_49 + var_1_50))))) : ((! (var_1_42 && (var_1_18 > var_1_64))) ? ((var_1_1 == (var_1_48 | var_1_9)) ? ((var_1_73 < var_1_8) ? (var_1_69 == ((signed char) (var_1_47 - var_1_45))) : 1) : (var_1_69 == ((signed char) (max (var_1_45 , var_1_49))))) : ((var_1_16 >= var_1_53) ? (var_1_69 == ((signed char) var_1_49)) : (var_1_69 == ((signed char) var_1_39)))))) && (var_1_71 == ((unsigned char) var_1_72))) && (var_1_43 ? (var_1_73 == ((unsigned long int) var_1_38)) : 1)) && (((var_1_31 + var_1_56) > ((min (var_1_41 , var_1_66)) * var_1_58)) ? ((((var_1_75 - var_1_49) - var_1_51) <= 10u) ? (var_1_74 == ((signed char) var_1_48)) : (var_1_74 == ((signed char) var_1_50))) : 1)
;
}
int main(void) {
	isInitial = 1;
