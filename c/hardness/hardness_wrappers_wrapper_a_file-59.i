...
void step(void) {
 if (((((signed_long_int_Array_0[5]) > (1)) ? (signed_long_int_Array_0[5]) : (1))) <= (256 + signed_long_int_Array_0[4])) {
 ...
 if (signed_long_int_Array_0[6] > ((((signed_long_int_Array_0[3]) < 0 ) ? -(signed_long_int_Array_0[3]) : (signed_long_int_Array_0[3])))) {
