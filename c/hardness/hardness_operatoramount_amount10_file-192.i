...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch192Amount10.c", 13, "reach_error"); }
...
float var_1_1 = 0.75;
float var_1_2 = 0.75;
float var_1_3 = 10000.6;
float var_1_4 = 32.2;
float var_1_5 = 64.8;
unsigned char var_1_6 = 2;
...
void step(void) {
 var_1_1 = ((var_1_2 + var_1_3) - ((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5))));
 if (var_1_7) {
  var_1_6 = (var_1_8 + 4);
 } else {
  if (var_1_3 < var_1_1) {
...
int property(void) {
 return (var_1_1 == ((float) ((var_1_2 + var_1_3) - ((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5)))))) && (var_1_7 ? (var_1_6 == ((unsigned char) (var_1_8 + 4))) : ((var_1_3 < var_1_1) ? (var_1_6 == ((unsigned char) var_1_8)) : (var_1_6 == ((unsigned char) var_1_9))))
;
}
int main(void) {
 isInitial = 1;
