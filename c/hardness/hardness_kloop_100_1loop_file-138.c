...
void step(void) {
	...
	// From: Req4Batch138100_1loop
	if ((var_1_3 + var_1_2) > var_1_20) {
		var_1_19 = (min ((var_1_14 - var_1_13) , var_1_12));
	} else {
		var_1_19 = var_1_12;
	}


	// From: Req5Batch138100_1loop
	var_1_21 = ((var_1_22 - var_1_23) - (64 - var_1_24));


	// From: Req8Batch138100_1loop
	var_1_28 = var_1_4;


	// From: Req10Batch138100_1loop
	...
	// From: Req9Batch138100_1loop
	signed long int stepLocal_4 = var_1_26 / (min (var_1_27 , 1));
	if (var_1_17 != (var_1_13 / var_1_30)) {
		if ((var_1_13 - (min (var_1_17 , var_1_14))) < (max (var_1_19 , 63.25))) {
	...
	// From: Req2Batch138100_1loop
	if ((min ((- var_1_19) , (- 7.75))) <= (- var_1_19)) {
		if (var_1_1) {
	...
	// From: Req6Batch138100_1loop
	signed char stepLocal_1 = var_1_23;
	if (var_1_7 < 24.75) {
		if ((var_1_26 ^ var_1_20) < stepLocal_1) {
			var_1_25 = ((min ((min (var_1_10 , var_1_12)) , var_1_11)) + 4.5f);
		} else {
			var_1_25 = (max (var_1_12 , var_1_10));
		}
	} else {
		var_1_25 = (max (31.4f , var_1_10));
	}
}
...
int property(void) {
	return (((((((((((var_1_26 < var_1_29) ? (var_1_1 == ((unsigned char) (var_1_4 || (! (var_1_5 && var_1_6))))) : 1) && (((min ((- var_1_19) , (- 7.75))) <= (- var_1_19)) ? (var_1_1 ? (var_1_7 == ((double) (abs ((min (var_1_10 , var_1_11)) + var_1_12)))) : (var_1_7 == ((double) (var_1_11 + var_1_10)))) : (var_1_7 == ((double) (var_1_13 - var_1_14))))) && ((((var_1_14 - var_1_13) * (var_1_16 - var_1_17)) != last_1_var_1_15) ? (var_1_1 ? (var_1_15 == ((double) var_1_14)) : (var_1_15 == ((double) var_1_12))) : (var_1_15 == ((double) var_1_18)))) && (((var_1_3 + var_1_2) > var_1_20) ? (var_1_19 == ((double) (min ((var_1_14 - var_1_13) , var_1_12)))) : (var_1_19 == ((double) var_1_12)))) && (var_1_21 == ((signed char) ((var_1_22 - var_1_23) - (64 - var_1_24))))) && ((var_1_7 < 24.75) ? (((var_1_26 ^ var_1_20) < var_1_23) ? (var_1_25 == ((float) ((min ((min (var_1_10 , var_1_12)) , var_1_11)) + 4.5f))) : (var_1_25 == ((float) (max (var_1_12 , var_1_10))))) : (var_1_25 == ((float) (max (31.4f , var_1_10)))))) && ((var_1_5 && var_1_4) ? (var_1_4 ? ((((last_1_var_1_26 / var_1_22) >= (var_1_20 / var_1_27)) || last_1_var_1_1) ? (var_1_26 == ((unsigned char) (max ((min (var_1_24 , 5)) , 4)))) : (var_1_26 == ((unsigned char) var_1_24))) : 1) : (var_1_26 == ((unsigned char) 64)))) && (var_1_28 == ((unsigned char) var_1_4))) && ((var_1_17 != (var_1_13 / var_1_30)) ? (((var_1_13 - (min (var_1_17 , var_1_14))) < (max (var_1_19 , 63.25))) ? (((var_1_26 / (min (var_1_27 , 1))) == var_1_23) ? (var_1_29 == ((unsigned char) var_1_23)) : (var_1_29 == ((unsigned char) var_1_31))) : (var_1_29 == ((unsigned char) var_1_31))) : (var_1_29 == ((unsigned char) var_1_22)))) && (var_1_6 ? (((- var_1_31) < var_1_20) ? ((! var_1_5) ? (var_1_32 == ((signed char) var_1_23)) : 1) : (var_1_32 == ((signed char) var_1_23))) : (var_1_32 == ((signed char) var_1_23)))) && (((var_1_31 - var_1_23) >= var_1_24) ? (var_1_33 == ((unsigned short int) var_1_22)) : (var_1_33 == ((unsigned short int) (abs (var_1_34 - var_1_35)))))
;
}
int main(void) {
	isInitial = 1;
