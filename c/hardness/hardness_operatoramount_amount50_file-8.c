...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch8Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch8Amount50
	var_1_25 = var_1_21;


	// From: Req9Batch8Amount50
	var_1_26 = var_1_8;
