...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch79Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	/* 361L, 221L) */ if (/* 362L, 202L, 203L) */ ((/* 363L, 197L, 204L) */ ((var_1_9) ^ (var_1_1))) == (/* 366L, 201L, 207L) */ ((var_1_25) - (var_1_26))))) {
		/* 369L, 220L) */ var_1_41 = (
			var_1_42
		);
	}
