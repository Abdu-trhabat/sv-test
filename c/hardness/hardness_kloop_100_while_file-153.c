...
void step(void) {
	// From: Req1Batch153100_while
	if (var_1_2) {
		var_1_1 = (min ((64 + var_1_3) , (var_1_4 + (max (var_1_5 , var_1_6)))));
	}


	// From: Req5Batch153100_while
	...
	// From: Req6Batch153100_while
	if (! var_1_18) {
		var_1_22 = (var_1_15 - (var_1_23 - var_1_20));
	}


	// From: Req7Batch153100_while
	if (var_1_2 || var_1_18) {
	...
	// From: Req11Batch153100_while
	if (var_1_41) {
		var_1_40 = (max (-5 , var_1_17));
	}


	// From: Req12Batch153100_while
	...
	// From: Req13Batch153100_while
	var_1_43 = var_1_34;


	// From: Req2Batch153100_while
