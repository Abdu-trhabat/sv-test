...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch114stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned long int stepLocal_3 = ((((~ 0u)) > (var_1_10)) ? ((~ 0u)) : (var_1_10));
 if (stepLocal_3 > var_1_5) {
  var_1_14 = var_1_5;
 }
 unsigned char stepLocal_6 = var_1_6;
 unsigned long int stepLocal_5 = var_1_3;
 signed long int stepLocal_4 = var_1_16 - 10;
