...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch19Amount25
	var_1_11 = (var_1_12 + (var_1_13 + var_1_14));


	// From: Req5Batch19Amount25
	var_1_16 = 64;


	// From: Req1Batch19Amount25
