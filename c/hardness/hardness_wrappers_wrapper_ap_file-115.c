...
void step(void) {
	// From: Req1Batch115Wrapper_AP
	if (((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) * last_1_double_Array_0_1__1_) >= (max ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))))) {
	...
	// From: Req3Batch115Wrapper_AP
	(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = (min (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) - (abs ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))))) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer))));


	// From: Req4Batch115Wrapper_AP
