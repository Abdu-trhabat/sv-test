...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) < (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) {
		...
		if (((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) + (abs ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))))) > (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))) {
	...
	if ((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) << ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) + (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)))) <= stepLocal_0) {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) = (max ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) , (abs ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer))))));
	} else {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
