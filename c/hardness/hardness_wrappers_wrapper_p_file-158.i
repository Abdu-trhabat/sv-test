...
void step(void) {
 ...
 if ((*(var_1_7_Pointer))) {
  if ((*(var_1_14_Pointer)) <= stepLocal_1) {
   (*(var_1_17_Pointer)) = (((((*(var_1_10_Pointer))) > ((*(var_1_6_Pointer)))) ? ((*(var_1_10_Pointer))) : ((*(var_1_6_Pointer)))));
  } else {
