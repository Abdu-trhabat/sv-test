...
void step(void) {
 ...
 if (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) % (((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))) > ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)))) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)))))) <= -1000000) {
 ...
 if ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) < ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) / (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)))) {
  if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer)) || stepLocal_0) {
   (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) = (((((((*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer))) > (5)) ? ((*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer))) : (5))) + ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) - (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)))) - (*(signed_char_Array_0_arraysigned_char_Array_0Var4_Pointer)));
  } else {
