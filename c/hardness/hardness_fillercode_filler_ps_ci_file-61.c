...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch61Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 257L, 95L) */ if (/* 258L, 12L, 13L) */ ((var_1_5) != (var_1_2))) {
		/* 261L, 89L) */ if (/* 262L, 28L, 29L) */ ((/* 263L, 23L, 30L) */ (~ (var_1_2))) != (/* 265L, 27L, 32L) */ (abs (/* 266L, 26L, 33L) */ (min (/* 266L, 26L, 33L) */ (var_1_31) , (var_1_5)))))))) {
			/* 269L, 83L) */ if (/* 270L, 45L, 46L) */ ((var_1_5) < (5u))) {
				/* 273L, 81L) */ if (/* 274L, 60L, 61L) */ ((/* 275L, 57L, 62L) */ (min (/* 275L, 57L, 62L) */ (32) , (/* 277L, 56L, 64L) */ ((50983) - (var_1_32)))))) >= (/* 280L, 59L, 67L) */ (abs (var_1_12))))) {
					/* 282L, 80L) */ var_1_30 = (
						var_1_32
					);
				}
	...
	// From: CodeObject4
	/* 303L, 138L) */ if (/* 304L, 116L, 117L) */ ((var_1_6) >= (var_1_31))) {
		/* 307L, 136L) */ if (/* 308L, 125L, 126L) */ ((var_1_6) > (var_1_31))) {
			/* 311L, 135L) */ var_1_38 = (
				var_1_32
			);
		}
	...
	// From: CodeObject5
	/* 315L, 216L) */ if (/* 316L, 149L, 150L) */ ((var_1_31) < (/* 318L, 148L, 152L) */ ((/* 319L, 144L, 153L) */ (abs (var_1_32))) & (/* 321L, 147L, 155L) */ ((var_1_11) % (var_1_40))))))) {
		/* 324L, 214L) */ if (/* 325L, 168L, 169L) */ ((var_1_36) < (var_1_37))) {
			...
			/* 333L, 212L) */ if (var_1_23) {
				...
				/* 341L, 210L) */ if (/* 342L, 191L, 192L) */ ((var_1_40) <= (var_1_16))) {
					/* 345L, 201L) */ var_1_39 = (
						var_1_23
					);
				} else {
