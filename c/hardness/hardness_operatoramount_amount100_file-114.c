...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch114Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch114Amount100
	if (var_1_6 != var_1_12) {
		var_1_13 = (max (16 , var_1_6));
	}


	// From: Req3Batch114Amount100
