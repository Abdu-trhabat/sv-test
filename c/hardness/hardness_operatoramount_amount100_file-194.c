...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch194Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch194Amount100
	if (var_1_6 >= var_1_8) {
		var_1_9 = 0;
	}


	// From: Req3Batch194Amount100
	var_1_10 = ((var_1_11 + var_1_12) - var_1_13);


	// From: Req13Batch194Amount100
	var_1_38 = var_1_20;


	// From: Req14Batch194Amount100
	...
	// From: Req15Batch194Amount100
	var_1_40 = var_1_13;


	// From: Req16Batch194Amount100
	var_1_41 = var_1_42;


	// From: Req17Batch194Amount100
	var_1_43 = -10;


	// From: Req6Batch194Amount100
	...
	// From: Req9Batch194Amount100
	if (var_1_19 < var_1_38) {
		var_1_25 = (last_1_var_1_25 && var_1_27);
	}


	// From: Req12Batch194Amount100
