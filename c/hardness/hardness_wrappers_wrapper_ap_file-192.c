...
void step(void) {
	...
	// From: Req3Batch192Wrapper_AP
	signed long int stepLocal_3 = 1 - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer));
	if ((abs ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))) >= (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))) {
	...
	// From: Req1Batch192Wrapper_AP
	signed long int stepLocal_0 = (min ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) , -5)) + (max ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))));
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if ((min ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) , 0)) <= stepLocal_0) {
