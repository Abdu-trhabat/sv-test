...
void step(void) {
	// From: Req2Batch131dependencies
	if ((var_1_6 * var_1_7) < (- var_1_8)) {
		var_1_5 = var_1_3;
	}


	// From: Req3Batch131dependencies
	var_1_9 = (var_1_4 + var_1_10);


	// From: Req5Batch131dependencies
	if ((var_1_7 * (- var_1_6)) <= (4.25 * var_1_8)) {
		var_1_13 = (var_1_12 && var_1_14);
	}


	// From: Req6Batch131dependencies
