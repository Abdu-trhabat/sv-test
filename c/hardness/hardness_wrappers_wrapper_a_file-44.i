...
void step(void) {
 ...
 signed long int stepLocal_0 = ((((signed_char_Array_0[2]) < (signed_char_Array_0[3])) ? (signed_char_Array_0[2]) : (signed_char_Array_0[3]))) / unsigned_char_Array_0[0];
 ...
 if ((double_Array_0[0] - ((((double_Array_0[1]) < 0 ) ? -(double_Array_0[1]) : (double_Array_0[1])))) >= double_Array_0[2]) {
...
int property(void) {
 return ((((signed_char_Array_0[2] > (signed_char_Array_0[1] - signed_char_Array_0[0])) ? (((((((signed_char_Array_0[2]) < (signed_char_Array_0[3])) ? (signed_char_Array_0[2]) : (signed_char_Array_0[3]))) / unsigned_char_Array_0[0]) <= signed_char_Array_0[0]) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_char_Array_0[0])) : 1) : (signed_long_int_Array_0[0] == ((signed long int) signed_char_Array_0[3]))) && (BOOL_unsigned_char_Array_0[0][1] ? ((signed_long_int_Array_0[0] > signed_char_Array_0[4]) ? (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) (! BOOL_unsigned_char_Array_0[1][0]))) : (((signed_long_int_Array_0[0] % unsigned_char_Array_0[0]) < (signed_char_Array_0[4] * (signed_char_Array_0[2] * signed_char_Array_0[0]))) ? (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0])) : 1)) : 1)) && (((double_Array_0[0] - ((((double_Array_0[1]) < 0 ) ? -(double_Array_0[1]) : (double_Array_0[1])))) >= double_Array_0[2]) ? (BOOL_unsigned_char_Array_0[0][1] == ((unsigned char) (((signed_char_Array_0[0] < signed_long_int_Array_0[0]) && BOOL_unsigned_char_Array_0[1][2]) || (BOOL_unsigned_char_Array_0[1][1] || BOOL_unsigned_char_Array_0[0][2])))) : 1)) && (float_Array_0[0] == ((float) float_Array_0[1]))
;
}
int main(void) {
 isInitial = 1;
