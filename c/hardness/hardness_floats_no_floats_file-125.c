...
void step(void) {
	...
	// From: Req3Batch125no_floats
	var_1_10 = (((var_1_6 + 4) - var_1_8) + (max (var_1_11 , -64)));


	// From: Req1Batch125no_floats
...
int property(void) {
	return (((((32 * (var_1_6 | 4)) >= var_1_6) ? (var_1_1 == ((signed long int) (var_1_4 - var_1_5))) : (var_1_1 == ((signed long int) var_1_5))) && ((var_1_4 < (var_1_5 / var_1_7)) ? (var_1_6 == ((signed long int) (max (last_1_var_1_10 , ((var_1_8 + 4) - var_1_9))))) : (var_1_6 == ((signed long int) var_1_8)))) && (var_1_10 == ((signed long int) (((var_1_6 + 4) - var_1_8) + (max (var_1_11 , -64)))))) && (((- (max (8u , var_1_9))) <= var_1_8) ? (var_1_12 == ((signed short int) (50 - ((32541 - var_1_13) - (var_1_14 - var_1_15))))) : (var_1_12 == ((signed short int) 2)))
;
}
int main(void) {
	isInitial = 1;
