...
void step(void) {
	...
	// From: Req4Batch129Wrapper_S
	unsigned short int stepLocal_2 = WrapperStruct00.var_1_6;
	if (WrapperStruct00.var_1_1) {
		if (WrapperStruct00.var_1_8 <= stepLocal_2) {
			if ((min (10.4 , WrapperStruct00.var_1_13)) < (WrapperStruct00.var_1_14 * WrapperStruct00.var_1_15)) {
