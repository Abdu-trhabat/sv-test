...
void step(void) {
	...
	// From: Req3Batch143normal
	var_1_10 = (min (var_1_11 , var_1_12));


	// From: Req4Batch143normal
	var_1_13 = var_1_12;


	// From: Req5Batch143normal
	var_1_14 = ((var_1_15 - (4 + var_1_10)) - var_1_12);


	// From: Req7Batch143normal
	if (var_1_9 <= -16) {
		var_1_18 = (abs ((var_1_11 + var_1_10) + var_1_2));
	}


	// From: Req8Batch143normal
	var_1_19 = (((var_1_20 - var_1_14) + var_1_12) - var_1_13);


	// From: Req9Batch143normal
	var_1_21 = var_1_9;


	// From: Req10Batch143normal
	var_1_22 = var_1_23;


	// From: Req1Batch143normal
	signed long int stepLocal_0 = max (64 , var_1_18);
...
int property(void) {
	return (((((((((((max (64 , var_1_18)) <= var_1_18) ? (var_1_1 == ((float) (var_1_4 - (var_1_5 + var_1_6)))) : ((var_1_5 == var_1_6) ? (var_1_1 == ((float) (var_1_6 + var_1_5))) : (var_1_1 == ((float) var_1_4)))) && ((var_1_6 > var_1_4) ? ((25 <= (max (var_1_3 , var_1_2))) ? (((~ (var_1_2 ^ var_1_3)) <= var_1_8) ? (var_1_7 == ((signed short int) 32)) : (var_1_7 == ((signed short int) var_1_9))) : 1) : 1)) && (var_1_10 == ((unsigned char) (min (var_1_11 , var_1_12))))) && (var_1_13 == ((unsigned char) var_1_12))) && (var_1_14 == ((signed short int) ((var_1_15 - (4 + var_1_10)) - var_1_12)))) && ((var_1_2 > var_1_21) ? (var_1_16 == ((unsigned char) ((var_1_8 > var_1_7) && var_1_17))) : (var_1_16 == ((unsigned char) ((var_1_4 < (min (var_1_6 , var_1_5))) && var_1_17))))) && ((var_1_9 <= -16) ? (var_1_18 == ((signed long int) (abs ((var_1_11 + var_1_10) + var_1_2)))) : 1)) && (var_1_19 == ((signed short int) (((var_1_20 - var_1_14) + var_1_12) - var_1_13)))) && (var_1_21 == ((signed short int) var_1_9))) && (var_1_22 == ((unsigned char) var_1_23))
;
}
int main(void) {
	isInitial = 1;
