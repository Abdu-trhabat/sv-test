...
void step(void) {
	...
	if ((*(var_1_2_Pointer)) <= stepLocal_1) {
		(*(var_1_1_Pointer)) = (min ((abs ((*(var_1_2_Pointer)))) , ((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))));
	} else {
	...
	// From: Req2Batch167Wrapper_P
	signed short int stepLocal_2 = (*(var_1_1_Pointer));
	if (stepLocal_2 == (*(var_1_5_Pointer))) {
		(*(var_1_6_Pointer)) = ((*(var_1_7_Pointer)) + (max ((*(var_1_8_Pointer)) , (*(var_1_9_Pointer)))));
	}


	// From: Req3Batch167Wrapper_P
	if ((*(var_1_6_Pointer)) > (*(var_1_4_Pointer))) {
		if ((~ 16u) > (max ((*(var_1_5_Pointer)) , (*(var_1_4_Pointer))))) {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) <= ((*(var_1_3_Pointer)) * (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed short int) (min ((abs ((*(var_1_2_Pointer)))) , ((*(var_1_3_Pointer)) + (*(var_1_4_Pointer))))))) : ((((*(var_1_4_Pointer)) % (*(var_1_5_Pointer))) <= (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed short int) (*(var_1_2_Pointer)))) : 1)) && (((*(var_1_1_Pointer)) == (*(var_1_5_Pointer))) ? ((*(var_1_6_Pointer)) == ((signed char) ((*(var_1_7_Pointer)) + (max ((*(var_1_8_Pointer)) , (*(var_1_9_Pointer))))))) : 1)) && (((*(var_1_6_Pointer)) > (*(var_1_4_Pointer))) ? (((~ 16u) > (max ((*(var_1_5_Pointer)) , (*(var_1_4_Pointer))))) ? (((~ ((*(var_1_3_Pointer)) & (*(var_1_2_Pointer)))) <= (*(var_1_5_Pointer))) ? ((*(var_1_10_Pointer)) == ((float) (*(var_1_11_Pointer)))) : ((*(var_1_10_Pointer)) == ((float) 24.575f))) : 1) : ((*(var_1_10_Pointer)) == ((float) (*(var_1_11_Pointer)))))) && ((*(var_1_12_Pointer)) == ((unsigned short int) (*(var_1_13_Pointer))))
;
}
int main(void) {
	isInitial = 1;
