...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch119dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch119dependencies
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req2Batch119dependencies
	if (var_1_5) {
		var_1_4 = (var_1_3 - (var_1_6 - var_1_7));
	}


	// From: Req3Batch119dependencies
	...
	// From: Req4Batch119dependencies
	var_1_14 = (min (((10 + var_1_15) - var_1_16) , var_1_13));


	// From: Req5Batch119dependencies
	if (var_1_5) {
