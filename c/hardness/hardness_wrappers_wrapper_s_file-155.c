...
void step(void) {
	...
	if (stepLocal_0 == (WrapperStruct00.var_1_1 - (WrapperStruct00.var_1_9 - WrapperStruct00.var_1_5))) {
		WrapperStruct00.var_1_8 = (min ((max (-16 , (WrapperStruct00.var_1_10 - WrapperStruct00.var_1_11))) , WrapperStruct00.var_1_12));
	} else {
