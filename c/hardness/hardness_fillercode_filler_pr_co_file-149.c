...
void step(void) {
	...
	// From: CodeObject9
	/* 449L, 328L) */ if (/* 450L, 308L, 309L) */ ((var_1_1) >= (var_1_29))) {
		/* 453L, 318L) */ var_1_36 = (
			-8
		);
	} else {
	...
	// From: CodeObject7
	/* 434L, 290L) */ if (/* 435L, 279L, 280L) */ ((var_1_11) <= (var_1_16))) {
		/* 438L, 289L) */ var_1_33 = (
			var_1_16
		);
	}
