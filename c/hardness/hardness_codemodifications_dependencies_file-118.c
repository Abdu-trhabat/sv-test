...
void step(void) {
	// From: Req1Batch118dependencies
	var_1_1 = -5;


	// From: Req2Batch118dependencies
	var_1_2 = (max (var_1_3 , var_1_4));


	// From: Req4Batch118dependencies
	if (var_1_8 && var_1_9) {
		var_1_7 = var_1_6;
	}


	// From: Req7Batch118dependencies
