...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch7Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	/* 240L, 67L) */ if (/* 241L, 11L, 12L) */ ((/* 242L, 4L, 13L) */ ((var_1_6) >> (var_1_27))) > (/* 245L, 10L, 16L) */ (max (/* 245L, 10L, 16L) */ (var_1_29) , (var_1_28)))))) {
	...
	// From: CodeObject2
	/* 269L, 97L) */ if (/* 270L, 78L, 79L) */ (! (/* 271L, 77L, 80L) */ ((/* 272L, 75L, 81L) */ (max (/* 272L, 75L, 81L) */ (var_1_5) , (5)))) != (var_1_27))))) {
		/* 276L, 96L) */ var_1_33 = (
			/* 279L, 95L) */ (abs (
				/* 280L, 94L) */ (abs (
					var_1_27
	...
	// From: CodeObject3
	/* 282L, 131L) */ if (/* 283L, 105L, 106L) */ ((/* 284L, 103L, 107L) */ ((var_1_6) ^ (var_1_5))) > (var_1_10))) {
	...
	// From: CodeObject5
	/* 301L, 194L) */ if (/* 302L, 148L, 149L) */ ((/* 303L, 144L, 150L) */ (abs (var_1_6))) > (/* 305L, 147L, 152L) */ ((var_1_10) / (var_1_28))))) {
		/* 308L, 179L) */ if (/* 309L, 162L, 163L) */ (! (var_1_8))) {
			/* 311L, 178L) */ var_1_36 = (
				/* 314L, 177L) */ ((
					var_1_27
				) + (
	...
	// From: Req8Batch7Filler_PS_CI
	/* 916L, 239L, 757L, 763L) */ var_1_24 = (
		16
	);


	// From: Req1Batch7Filler_PS_CI
