...
void step(void) {
   ...
   var_1_22
                                ...
                                var_1_24 = (
                                 (((((( var_1_25 ) - ( var_1_26 ))) < 0 ) ? -((( var_1_25 ) - ( var_1_26 ))) : ((( var_1_25 ) - ( var_1_26 )))))
  );
 }
                               if (var_1_7) {
                                if (var_1_7) {
 ...
 signed short int stepLocal_2 = var_1_12;
   ...
   var_1_36
     ...
     var_1_40
                     ...
                     if ( ((var_1_36) <= (var_1_1))) {
                     var_1_37 = (
                      ((((( ((((( var_1_38 )) > (( var_1_39 ))) ? (( var_1_38 )) : (( var_1_39 )))) )) > (( var_1_40 ))) ? (( ((((( var_1_38 )) > (( var_1_39 ))) ? (( var_1_38 )) : (( var_1_39 )))) )) : (( var_1_40 ))))
    );
   } else {
                      if ( ((var_1_38) > ( ((var_1_40) | (var_1_19))))) {
                       var_1_37 = (
                        ((
       var_1_40
      ) + (
  ...
  var_1_39
                   ...
                   if ( (( ((var_1_36) + ( (((((var_1_1)) < ((63.5))) ? ((var_1_1)) : ((63.5))))))) > (var_1_35))) {
                    var_1_45 = (
    ...
    var_1_40
                      ...
                      ((((((((( var_1_12 )) > (( var_1_39 ))) ? (( var_1_12 )) : (( var_1_39 ))))) < 0 ) ? -(((((( var_1_12 )) > (( var_1_39 ))) ? (( var_1_12 )) : (( var_1_39 ))))) : (((((( var_1_12 )) > (( var_1_39 ))) ? (( var_1_12 )) : (( var_1_39 )))))))
   ))
  );
 } else {
                    var_1_47 = (
...
int property(void) {
 ...
 if ( (( (( ((var_1_19) + (200))) & (var_1_24))) != (var_1_28))) {
 }
 if ( (( ((var_1_3) / (var_1_17))) >= ( (( ((var_1_1) / (16.69))) * (var_1_1))))) {
 }
 if ( (( (- (var_1_6))) > (var_1_3))) {
  if ( ((var_1_28) > ( (( ((var_1_24) * (var_1_28))) * ( ((var_1_21) - (var_1_28))))))) {
   if (var_1_11) {
   } else {
   }
  } else {
 ...
 if ( ((var_1_12) < ( ((var_1_25) ^ ( ((var_1_24) % (1))))))) {
 }
 if (var_1_7) {
  if (var_1_7) {
  }
