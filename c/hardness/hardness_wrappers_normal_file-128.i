...
void step(void) {
 ...
 if ((~ var_1_6) < (var_1_3 ^ var_1_4)) {
  var_1_13 = (((((var_1_14 - var_1_15) - ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) < 0 ) ? -((var_1_14 - var_1_15) - ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) : ((var_1_14 - var_1_15) - ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))))));
 }
...
int property(void) {
 return ((((var_1_2 > (var_1_3 + (var_1_4 + var_1_5))) ? ((var_1_4 >= (var_1_6 - var_1_7)) ? (var_1_1 == ((double) var_1_8)) : 1) : 1) && (((var_1_4 < var_1_3) || var_1_10) ? (var_1_9 == ((unsigned char) var_1_11)) : (((var_1_2 / var_1_12) < var_1_5) ? (var_1_9 == ((unsigned char) var_1_11)) : (var_1_9 == ((unsigned char) 0))))) && (((~ var_1_6) < (var_1_3 ^ var_1_4)) ? (var_1_13 == ((float) (((((var_1_14 - var_1_15) - ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) < 0 ) ? -((var_1_14 - var_1_15) - ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) : ((var_1_14 - var_1_15) - ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))))))) : 1)) && (((var_1_17 - var_1_18) <= (var_1_7 << var_1_5)) ? (var_1_16 == ((double) var_1_8)) : 1)
;
}
int main(void) {
 isInitial = 1;
