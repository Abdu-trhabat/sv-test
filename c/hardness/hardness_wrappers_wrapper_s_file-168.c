...
void step(void) {
	...
	if (stepLocal_1 >= WrapperStruct00.var_1_6) {
		if (stepLocal_2 < (WrapperStruct00.var_1_2 - WrapperStruct00.var_1_7)) {
			WrapperStruct00.var_1_5 = ((max (WrapperStruct00.var_1_8 , (WrapperStruct00.var_1_9 - WrapperStruct00.var_1_10))) - WrapperStruct00.var_1_11);
		}
	} else {
