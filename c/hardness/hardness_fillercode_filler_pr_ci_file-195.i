...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch195Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned long int stepLocal_1 = ((var_1_24) | (var_1_13));
    ...
    var_1_7
                   ...
                   if ( ((var_1_42) <= ( ((((((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) < 0 ) ? -(((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))) : (((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14))))))))) {
