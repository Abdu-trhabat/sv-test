...
signed long int functionized1(signed short int functionized1_localFunctionVar0, signed short int functionized1_localFunctionVar1) {
	return (min (functionized1_localFunctionVar1 , (functionized1_localFunctionVar0 * var_1_4)));
}
...
void functionized3(double functionized3_localFunctionVar0) {
	if ((min ((max (functionized3_localFunctionVar0 , 9.999999999999025E12)) , var_1_14)) > var_1_15) {
		var_1_12 = 0;
	}
}
...
void step(void) {
	...
	// From: Req4Batch79functionizing
	functionized3(var_1_13);


	// From: Req5Batch79functionizing
	if (var_1_3 && (50.5 <= functionized4(var_1_15))) {
		var_1_16 = (var_1_17 - (abs (-50 + var_1_18)));
	} else {
		var_1_16 = (max (functionized5(var_1_17) , (var_1_18 + var_1_20)));
	}


	// From: Req6Batch79functionizing
