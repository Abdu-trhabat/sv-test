...
void step(void) {
	...
	// From: Req2Batch163Wrapper_AP
	signed long int stepLocal_3 = (max ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)))) * (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer));
	...
	if (stepLocal_1 || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if ((max (last_1_unsigned_long_int_Array_0_0_ , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)))) < stepLocal_3) {
