...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch86Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((*(WrapperStruct00_var_1_2_Pointer)) && (*(WrapperStruct00_var_1_12_Pointer))) {
  ...
  if ((*(WrapperStruct00_var_1_3_Pointer)) < (200 * (128 << (*(WrapperStruct00_var_1_18_Pointer))))) {
