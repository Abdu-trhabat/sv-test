...
void step(void) {
	...
	// From: Req3Batch176100_while
	if (var_1_29) {
		var_1_9 = (var_1_8 + var_1_7);
	}


	// From: Req10Batch176100_while
	...
	// From: Req1Batch176100_while
	if (! ((var_1_2 - var_1_3) < var_1_22)) {
		var_1_1 = (128 - var_1_5);
	}


	// From: Req2Batch176100_while
	var_1_6 = ((64 - (var_1_7 - var_1_8)) + var_1_5);


	// From: Req4Batch176100_while
	if (50 < var_1_9) {
		var_1_11 = var_1_8;
	}


	// From: Req5Batch176100_while
	if (var_1_3 < var_1_2) {
		var_1_12 = var_1_8;
	}


	// From: Req11Batch176100_while
