...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch169has_floats.c", 13, "reach_error"); }
...
float var_1_9 = 4.0;
float var_1_10 = 256.0;
unsigned char var_1_11 = 1;
float var_1_12 = 16.0;
float var_1_13 = -100000.0;
...
void step(void) {
 if (var_1_2 >= var_1_3) {
  if (var_1_2 < (((((var_1_3 / var_1_4)) > ((-128.0 * var_1_5))) ? ((var_1_3 / var_1_4)) : ((-128.0 * var_1_5))))) {
   var_1_1 = var_1_6;
  }
 }
 var_1_16 = 0;
...
int property(void) {
 return ((((((var_1_2 >= var_1_3) ? ((var_1_2 < (((((var_1_3 / var_1_4)) > ((-128.0 * var_1_5))) ? ((var_1_3 / var_1_4)) : ((-128.0 * var_1_5))))) ? (var_1_1 == ((signed short int) var_1_6)) : 1) : 1) && ((var_1_6 == ((((var_1_16) < (var_1_1)) ? (var_1_16) : (var_1_1)))) ? (var_1_7 == ((float) (var_1_9 - var_1_10))) : (var_1_14 ? (var_1_7 == ((float) (var_1_12 + var_1_13))) : (var_1_7 == ((float) var_1_10))))) && ((var_1_11 && (-25 >= ((((var_1_8) < (var_1_1)) ? (var_1_8) : (var_1_1))))) ? ((((((var_1_10) < (var_1_19)) ? (var_1_10) : (var_1_19))) <= var_1_19) ? (var_1_14 == ((unsigned char) 0)) : (var_1_14 == ((unsigned char) 1))) : (var_1_14 == ((unsigned char) var_1_15)))) && (var_1_16 == ((signed short int) 0))) && (var_1_17 == ((signed char) var_1_18))) && (var_1_19 == ((double) var_1_13))
;
}
int main(void) {
 isInitial = 1;
