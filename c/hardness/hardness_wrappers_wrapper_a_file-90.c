...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[0]) {
		signed_short_int_Array_0[1][1] = (min ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0]) , signed_short_int_Array_0[0][0]));
	}


	// From: Req3Batch90Wrapper_A
	if (! BOOL_unsigned_char_Array_0[0]) {
		if (((max (double_Array_0[0][0] , double_Array_0[1][0])) - double_Array_0[0][1]) >= (- (32.25 * double_Array_0[1][1]))) {
			if (BOOL_unsigned_char_Array_0[0]) {
	...
	if (stepLocal_0 != (min (signed_short_int_Array_0[0][1] , signed_short_int_Array_0[0][0]))) {
...
int property(void) {
	return ((((BOOL_unsigned_char_Array_0[0] ? (signed_short_int_Array_0[1][1] == ((signed short int) (min ((signed_short_int_Array_0[0][1] + signed_short_int_Array_0[1][0]) , signed_short_int_Array_0[0][0])))) : 1) && ((signed_short_int_Array_0[1][1] != (min (signed_short_int_Array_0[0][1] , signed_short_int_Array_0[0][0]))) ? (((unsigned_long_int_Array_0[3] - unsigned_long_int_Array_0[1]) >= unsigned_long_int_Array_0[2]) ? (BOOL_unsigned_char_Array_0[0] ? (unsigned_long_int_Array_0[4] == ((unsigned long int) unsigned_long_int_Array_0[1])) : (unsigned_long_int_Array_0[4] == ((unsigned long int) unsigned_long_int_Array_0[0]))) : (unsigned_long_int_Array_0[4] == ((unsigned long int) unsigned_long_int_Array_0[1]))) : (unsigned_long_int_Array_0[4] == ((unsigned long int) unsigned_long_int_Array_0[1])))) && ((! BOOL_unsigned_char_Array_0[0]) ? ((((max (double_Array_0[0][0] , double_Array_0[1][0])) - double_Array_0[0][1]) >= (- (32.25 * double_Array_0[1][1]))) ? (BOOL_unsigned_char_Array_0[0] ? (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[0])) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[1]))) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[1]))) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[0])))) && (unsigned_char_Array_0[0] == ((unsigned char) unsigned_char_Array_0[1]))) && (unsigned_char_Array_0[2] == ((unsigned char) unsigned_char_Array_0[1]))
;
}
int main(void) {
	isInitial = 1;
