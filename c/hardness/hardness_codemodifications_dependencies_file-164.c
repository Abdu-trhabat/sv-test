...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch164dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch164dependencies
	if ((4 <= var_1_2) || (var_1_3 < var_1_4)) {
		var_1_1 = (var_1_5 + (max (var_1_6 , var_1_7)));
	}


	// From: Req6Batch164dependencies
	if ((max (var_1_5 , var_1_17)) >= var_1_17) {
	...
	// From: Req7Batch164dependencies
	if ((var_1_21 / (abs (var_1_30))) <= var_1_19) {
		var_1_29 = var_1_6;
	}


	// From: Req2Batch164dependencies
	if (var_1_24) {
		if ((- var_1_10) < 127.25f) {
