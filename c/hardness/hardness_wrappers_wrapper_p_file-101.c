...
void step(void) {
	...
	// From: Req2Batch101Wrapper_P
	if ((*(var_1_5_Pointer)) > (*(var_1_4_Pointer))) {
		(*(var_1_9_Pointer)) = (min ((*(var_1_10_Pointer)) , (max ((min ((*(var_1_11_Pointer)) , (*(var_1_12_Pointer)))) , (*(var_1_13_Pointer))))));
	} else {
		if ((*(var_1_2_Pointer))) {
			(*(var_1_9_Pointer)) = 2.5;
		} else {
	...
	// From: Req3Batch101Wrapper_P
	if (((*(var_1_1_Pointer)) / (*(var_1_3_Pointer))) > (-1000 % (abs (16)))) {
