...
void step(void) {
 ...
 signed long int stepLocal_1 = -5 / ((((256) > (var_1_3)) ? (256) : (var_1_3)));
...
int property(void) {
 return (var_1_2 > (-5 / ((((256) > (var_1_3)) ? (256) : (var_1_3))))) ? (var_1_1 == ((unsigned short int) var_1_4)) : ((var_1_4 <= var_1_2) ? ((var_1_5 <= var_1_2) ? (var_1_1 == ((unsigned short int) var_1_4)) : (var_1_1 == ((unsigned short int) var_1_5))) : (var_1_1 == ((unsigned short int) var_1_5)))
;
}
int main(void) {
 isInitial = 1;
