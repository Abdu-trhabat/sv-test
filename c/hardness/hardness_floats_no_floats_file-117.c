...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch117no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch117no_floats
	if (var_1_9) {
		var_1_8 = -100;
	}


	// From: Req4Batch117no_floats
