...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch121stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch121stepLocals
	if (var_1_1 < var_1_10) {
		var_1_16 = var_1_9;
	}


	// From: Req4Batch121stepLocals
	...
	// From: Req7Batch121stepLocals
	var_1_24 = (min (4.4f , var_1_25));


	// From: Req8Batch121stepLocals
