...
void functionized0(signed short int functionized0_localFunctionVar0, signed short int functionized0_localFunctionVar1, signed short int functionized0_localFunctionVar2, unsigned char functionized0_localFunctionVar3) {
 if (functionized0_localFunctionVar3) {
  var_1_1 = ((((functionized0_localFunctionVar2) < (((var_1_5 + 256) - ((((functionized0_localFunctionVar0) < (functionized0_localFunctionVar1)) ? (functionized0_localFunctionVar0) : (functionized0_localFunctionVar1)))))) ? (functionized0_localFunctionVar2) : (((var_1_5 + 256) - ((((functionized0_localFunctionVar0) < (functionized0_localFunctionVar1)) ? (functionized0_localFunctionVar0) : (functionized0_localFunctionVar1)))))));
 } else {
...
void functionized6(signed short int functionized6_localFunctionVar0, double functionized6_localFunctionVar1, float functionized6_localFunctionVar2, unsigned short int functionized6_localFunctionVar3) {
 if ((functionized6_localFunctionVar0 + functionized6_localFunctionVar3) <= var_1_12) {
  ...
  var_1_20 = ((((var_1_11) > (((((functionized6_localFunctionVar2) < ((var_1_21 + functionized6_localFunctionVar1))) ? (functionized6_localFunctionVar2) : ((var_1_21 + functionized6_localFunctionVar1)))))) ? (var_1_11) : (((((functionized6_localFunctionVar2) < ((var_1_21 + functionized6_localFunctionVar1))) ? (functionized6_localFunctionVar2) : ((var_1_21 + functionized6_localFunctionVar1)))))));
 }
}
void initially(void) {
}
