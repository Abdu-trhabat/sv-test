...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch134no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch134no_floats
	var_1_1 = (256 - var_1_2);


	// From: Req2Batch134no_floats
	if (var_1_1 < (var_1_2 + var_1_1)) {
		var_1_3 = (min ((var_1_5 - var_1_6) , var_1_7));
	}


	// From: Req4Batch134no_floats
	signed char stepLocal_2 = var_1_3;
	if ((var_1_6 % var_1_15) != stepLocal_2) {
		var_1_14 = (abs (var_1_6));
	} else {
		var_1_14 = ((abs (var_1_16)) - var_1_15);
	}


	// From: Req5Batch134no_floats
	var_1_17 = var_1_7;


	// From: Req6Batch134no_floats
	var_1_18 = var_1_6;


	// From: Req7Batch134no_floats
	var_1_19 = var_1_6;


	// From: Req3Batch134no_floats
...
int property(void) {
	return ((((((var_1_1 == ((signed long int) (256 - var_1_2))) && ((var_1_1 < (var_1_2 + var_1_1)) ? (var_1_3 == ((signed char) (min ((var_1_5 - var_1_6) , var_1_7)))) : 1)) && ((var_1_9 || last_1_var_1_8) ? (last_1_var_1_8 ? (var_1_8 == ((unsigned char) (! var_1_11))) : (var_1_8 == ((unsigned char) (var_1_11 || var_1_12)))) : ((var_1_14 >= -64) ? (var_1_8 == ((unsigned char) var_1_11)) : (var_1_8 == ((unsigned char) var_1_13))))) && (((var_1_6 % var_1_15) != var_1_3) ? (var_1_14 == ((unsigned long int) (abs (var_1_6)))) : (var_1_14 == ((unsigned long int) ((abs (var_1_16)) - var_1_15))))) && (var_1_17 == ((signed long int) var_1_7))) && (var_1_18 == ((signed char) var_1_6))) && (var_1_19 == ((signed char) var_1_6))
;
}
int main(void) {
	isInitial = 1;
