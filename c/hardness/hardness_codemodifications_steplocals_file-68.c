...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch68stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch68stepLocals
	unsigned char stepLocal_2 = var_1_3;
	unsigned char stepLocal_1 = var_1_2;
	signed long int stepLocal_0 = var_1_3 / (min (var_1_10 , var_1_11));
	if (stepLocal_1 <= (var_1_3 ^ var_1_4)) {
		...
		if ((var_1_6 + (- var_1_7)) >= var_1_8) {
			if (stepLocal_0 > var_1_2) {
				...
				if ((var_1_13 * var_1_4) < stepLocal_2) {
					var_1_1 = var_1_12;
				} else {
					var_1_1 = var_1_9;
				}
	...
	// From: Req6Batch68stepLocals
	if (var_1_14 > var_1_22) {
		if (! var_1_1) {
			var_1_28 = (var_1_27 + var_1_3);
		} else {
			var_1_28 = var_1_29;
		}
	}
...
int property(void) {
	return ((((((var_1_2 <= (var_1_3 ^ var_1_4)) ? (var_1_1 == ((unsigned char) (! var_1_5))) : (((var_1_6 + (- var_1_7)) >= var_1_8) ? (((var_1_3 / (min (var_1_10 , var_1_11))) > var_1_2) ? (var_1_1 == ((unsigned char) (var_1_9 || (var_1_5 || var_1_12)))) : (((var_1_13 * var_1_4) < var_1_3) ? (var_1_1 == ((unsigned char) var_1_12)) : (var_1_1 == ((unsigned char) var_1_9)))) : (var_1_1 == ((unsigned char) var_1_12)))) && (((var_1_15 - var_1_16) == (var_1_17 - var_1_18)) ? (var_1_14 == ((float) var_1_19)) : 1)) && ((((min (var_1_17 , var_1_16)) - (var_1_21 + var_1_22)) >= 63.6) ? (var_1_20 == ((signed short int) var_1_2)) : 1)) && ((! (var_1_7 > var_1_14)) ? (var_1_12 ? (var_1_23 == ((unsigned char) var_1_5)) : 1) : 1)) && ((var_1_1 || var_1_12) ? (var_1_9 ? (var_1_24 == ((signed char) (var_1_25 - (var_1_26 + var_1_27)))) : 1) : 1)) && ((var_1_14 > var_1_22) ? ((! var_1_1) ? (var_1_28 == ((unsigned long int) (var_1_27 + var_1_3))) : (var_1_28 == ((unsigned long int) var_1_29))) : 1)
;
}
int main(void) {
	isInitial = 1;
