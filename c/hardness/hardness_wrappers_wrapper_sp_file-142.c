...
void step(void) {
	...
	// From: Req2Batch142Wrapper_SP
	if (((*(WrapperStruct00_var_1_7_Pointer)) - (*(WrapperStruct00_var_1_8_Pointer))) <= 0) {
		(*(WrapperStruct00_var_1_6_Pointer)) = (abs ((*(WrapperStruct00_var_1_9_Pointer))));
	}


	// From: Req3Batch142Wrapper_SP
	...
	if (stepLocal_0 && (*(WrapperStruct00_var_1_12_Pointer))) {
		...
		(*(WrapperStruct00_var_1_10_Pointer)) = (min ((*(WrapperStruct00_var_1_13_Pointer)) , (*(WrapperStruct00_var_1_14_Pointer))));
	}


	// From: Req4Batch142Wrapper_SP
	unsigned long int stepLocal_1 = (*(WrapperStruct00_var_1_2_Pointer));
	if (stepLocal_1 == (max ((*(WrapperStruct00_var_1_7_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer))))) {
