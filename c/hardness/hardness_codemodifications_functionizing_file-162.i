...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch162functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
void functionized0(unsigned short int, unsigned char, float);
unsigned char functionized1(float, double);
...
void functionized0(unsigned short int functionized0_localFunctionVar0, unsigned char functionized0_localFunctionVar1, float localFunctionVar2) {
 if (var_1_8) {
  if ((var_1_3 >= functionized0_localFunctionVar0) || (var_1_4 < var_1_5)) {
   if ((- functionized0_localFunctionVar0) < var_1_3) {
    if (functionized0_localFunctionVar1) {
     var_1_7 = var_1_6;
    } else {
     var_1_7 = localFunctionVar2;
    }
   } else {
    var_1_7 = var_1_6;
   }
...
unsigned char functionized1(float functionized1_localFunctionVar0, double functionized1_localFunctionVar1) {
 return (var_1_6 == ((var_1_1 + functionized1_localFunctionVar0) + functionized1_localFunctionVar1));
}
...
void step(void) {
 ...
 functionized0(var_1_2, var_1_9, 64.4f);
 if (var_1_9 || var_1_11) {
  if (functionized1(var_1_7, var_1_12)) {
   var_1_10 = var_1_3;
  } else {
   var_1_10 = var_1_2;
  }
 ...
 if (var_1_15 > var_1_10) {
  ...
  var_1_14 = (var_1_18 - functionized2(var_1_19));
 }
 var_1_20 = var_1_21;
 var_1_22 = 1;
}
