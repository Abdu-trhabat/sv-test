...
void step(void) {
	...
	if (stepLocal_2 == (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))) {
		...
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) - ((min ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)))) - (*(signed_char_Array_0_arraysigned_char_Array_0Var5_Pointer))));
	}


	// From: Req4Batch160Wrapper_AP
