...
void step(void) {
	...
	if (last_1_WrapperStruct00_var_1_1 == stepLocal_5) {
		if (stepLocal_3 <= (last_1_WrapperStruct00_var_1_14 / 500)) {
			if (WrapperStruct00.var_1_6 <= stepLocal_4) {
				WrapperStruct00.var_1_13 = (abs (abs (WrapperStruct00.var_1_12)));
			}
		} else {
	...
	if (stepLocal_0 >= (WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5)) {
		WrapperStruct00.var_1_1 = (abs (WrapperStruct00.var_1_6 - WrapperStruct00.var_1_7));
	}


	// From: Req2Batch5Wrapper_S
