...
void step(void) {
	...
	if (stepLocal_0 >= WrapperStruct00.var_1_6) {
		if (((WrapperStruct00.var_1_11 + WrapperStruct00.var_1_12) - (min (WrapperStruct00.var_1_13 , 1))) > stepLocal_1) {
