...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch5dependencies.c", 13, "reach_error"); }
...
void step(void) {
 if (((((last_1_var_1_6) < 0 ) ? -(last_1_var_1_6) : (last_1_var_1_6))) <= ((((last_1_var_1_6) > (var_1_4)) ? (last_1_var_1_6) : (var_1_4)))) {
  var_1_12 = ((var_1_14 - var_1_5) + ((((last_1_var_1_6) < 0 ) ? -(last_1_var_1_6) : (last_1_var_1_6))));
 } else {
...
int property(void) {
 return (((((((((- 64) + var_1_6) == var_1_6) ? (var_1_1 == ((unsigned char) (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))) - var_1_5))) : (var_1_1 == ((unsigned char) (((((128) < (var_1_4)) ? (128) : (var_1_4))) - 64)))) && ((var_1_12 > var_1_4) ? (((- var_1_15) < var_1_15) ? (var_1_6 == ((unsigned long int) 10u)) : 1) : 1)) && ((var_1_5 == (var_1_6 / var_1_4)) ? (var_1_9 == ((unsigned char) ((((var_1_5) < (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))) ? (var_1_5) : (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))))))) : (var_1_9 == ((unsigned char) ((var_1_10 + var_1_11) - var_1_5))))) && ((((((last_1_var_1_6) < 0 ) ? -(last_1_var_1_6) : (last_1_var_1_6))) <= ((((last_1_var_1_6) > (var_1_4)) ? (last_1_var_1_6) : (var_1_4)))) ? (var_1_12 == ((unsigned short int) ((var_1_14 - var_1_5) + ((((last_1_var_1_6) < 0 ) ? -(last_1_var_1_6) : (last_1_var_1_6)))))) : (var_1_12 == ((unsigned short int) last_1_var_1_6)))) && (((~ (var_1_5 * var_1_12)) <= var_1_12) ? (var_1_15 == ((double) (((((5.25 - var_1_16)) > (var_1_17)) ? ((5.25 - var_1_16)) : (var_1_17))))) : (var_1_15 == ((double) ((((((((var_1_17) < (var_1_16)) ? (var_1_17) : (var_1_16)))) < (var_1_18)) ? (((((var_1_17) < (var_1_16)) ? (var_1_17) : (var_1_16)))) : (var_1_18))))))) && ((var_1_4 < var_1_6) ? ((var_1_6 > var_1_12) ? (var_1_19 == ((unsigned char) var_1_20)) : 1) : 1)) && (var_1_21 == ((signed short int) var_1_10))
;
}
int main(void) {
 isInitial = 1;
