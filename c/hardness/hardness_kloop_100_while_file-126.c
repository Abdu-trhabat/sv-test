...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch126100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch126100_while
	if (var_1_8 || var_1_34) {
		var_1_1 = (abs (min (var_1_4 , var_1_5)));
	}


	// From: Req2Batch126100_while
	...
	// From: Req10Batch126100_while
	var_1_26 = (min ((max (var_1_4 , var_1_1)) , var_1_27));


	// From: Req11Batch126100_while
	var_1_28 = var_1_13;


	// From: Req15Batch126100_while
	...
	// From: Req16Batch126100_while
	var_1_41 = var_1_7;


	// From: Req4Batch126100_while
