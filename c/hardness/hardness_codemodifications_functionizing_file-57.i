...
signed long int functionized2(unsigned char functionized2_localFunctionVar0, signed char functionized2_localFunctionVar1) {
 return ((((functionized2_localFunctionVar1 + (var_1_1 - functionized2_localFunctionVar0)) < 0 ) ? -(functionized2_localFunctionVar1 + (var_1_1 - functionized2_localFunctionVar0)) : (functionized2_localFunctionVar1 + (var_1_1 - functionized2_localFunctionVar0))));
}
unsigned char functionized3(void) {
 return (! var_1_12);
}
