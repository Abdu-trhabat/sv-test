...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch165stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch165stepLocals
	unsigned long int stepLocal_0 = var_1_15 | var_1_1;
	if (var_1_6 < stepLocal_0) {
		var_1_19 = var_1_13;
	}


	// From: Req6Batch165stepLocals
	if (var_1_18) {
		if (9.25 >= var_1_3) {
