...
int property(void) {
	return ((((((((var_1_2 / (min (8 , var_1_3))) >= var_1_4) ? ((! (var_1_3 >= var_1_2)) ? (var_1_1 == ((signed char) var_1_5)) : (var_1_1 == ((signed char) -25))) : 1) && (var_1_7 ? (var_1_6 == ((unsigned short int) (min (var_1_8 , (var_1_9 - var_1_10))))) : 1)) && ((var_1_3 <= var_1_14) ? (var_1_11 == ((unsigned short int) (min (var_1_8 , var_1_9)))) : ((var_1_1 <= var_1_4) ? (var_1_11 == ((unsigned short int) var_1_15)) : 1))) && ((var_1_15 > var_1_4) ? (((var_1_15 - 1000000) == var_1_11) ? (var_1_16 == ((signed short int) ((24405 - var_1_17) - (abs (var_1_3))))) : 1) : (var_1_16 == ((signed short int) (var_1_17 - (max (100 , var_1_18))))))) && (((- var_1_9) > var_1_1) ? (var_1_19 == ((unsigned char) (var_1_20 - var_1_21))) : 1)) && ((256 > (var_1_19 - var_1_17)) ? (var_1_22 == ((signed char) (((var_1_23 - var_1_24) + var_1_25) - ((10 + 2) + var_1_26)))) : 1)) && ((var_1_25 < (abs (max (var_1_26 , var_1_23)))) ? (var_1_27 == ((unsigned short int) 64)) : 1)
;
}
int main(void) {
	isInitial = 1;
