...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch106100_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((last_1_var_1_17) < 0 ) ? -(last_1_var_1_17) : (last_1_var_1_17))) <= (var_1_8 + var_1_7)) {
  if (last_1_var_1_18) {
   var_1_11 = var_1_13;
  }
 } else {
 ...
 if (var_1_5 <= (var_1_4 / ((((-64) > (25)) ? (-64) : (25))))) {
  var_1_18 = (var_1_11 || ((var_1_11 || var_1_19) && var_1_14));
 } else {
  var_1_18 = (var_1_19 && var_1_14);
 }
 var_1_1 = var_1_2;
 var_1_6 = ((var_1_7 - var_1_8) - ((((var_1_9) > ((100.4 + var_1_10))) ? (var_1_9) : ((100.4 + var_1_10)))));
 signed long int stepLocal_1 = 1;
 unsigned char stepLocal_0 = var_1_4;
 if (var_1_5 < stepLocal_0) {
  var_1_15 = ((((var_1_4) > ((((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20))) + var_1_5))) ? (var_1_4) : ((((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20))) + var_1_5))));
 } else {
 ...
 if (! var_1_18) {
  ...
  var_1_25 = ((32 + var_1_26) - ((((var_1_27) < (var_1_28)) ? (var_1_27) : (var_1_28))));
 }
 signed char stepLocal_6 = var_1_27;
 signed short int stepLocal_5 = var_1_5;
 if (stepLocal_6 >= var_1_28) {
  var_1_29 = (((((var_1_15) > (var_1_2)) ? (var_1_15) : (var_1_2))) + ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28))));
 } else {
  if (var_1_11) {
   if ((var_1_21 / -256) >= stepLocal_5) {
    var_1_29 = ((((((((var_1_2) > (var_1_20)) ? (var_1_2) : (var_1_20)))) > (((var_1_5 + 100) + ((((var_1_28) < (var_1_3)) ? (var_1_28) : (var_1_3)))))) ? (((((var_1_2) > (var_1_20)) ? (var_1_2) : (var_1_20)))) : (((var_1_5 + 100) + ((((var_1_28) < (var_1_3)) ? (var_1_28) : (var_1_3)))))));
   } else {
...
int property(void) {
 return (((((((((((((var_1_1 == ((unsigned char) var_1_2)) && ((last_1_var_1_20 > (- (128 - var_1_4))) ? (var_1_3 == ((signed short int) ((last_1_var_1_20 - var_1_4) + (var_1_2 - (32 + var_1_5))))) : (var_1_3 == ((signed short int) (50 - last_1_var_1_20))))) && (var_1_6 == ((double) ((var_1_7 - var_1_8) - ((((var_1_9) > ((100.4 + var_1_10))) ? (var_1_9) : ((100.4 + var_1_10)))))))) && ((((((last_1_var_1_17) < 0 ) ? -(last_1_var_1_17) : (last_1_var_1_17))) <= (var_1_8 + var_1_7)) ? (last_1_var_1_18 ? (var_1_11 == ((unsigned char) var_1_13)) : 1) : (var_1_11 == ((unsigned char) var_1_14)))) && ((var_1_5 < var_1_4) ? (var_1_15 == ((unsigned long int) ((((var_1_4) > ((((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20))) + var_1_5))) ? (var_1_4) : ((((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20))) + var_1_5)))))) : ((1 < var_1_2) ? (var_1_15 == ((unsigned long int) var_1_2)) : 1))) && ((var_1_10 > var_1_8) ? ((var_1_4 <= var_1_2) ? (var_1_17 == ((double) ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))))) : (var_1_17 == ((double) var_1_8))) : (var_1_17 == ((double) var_1_8)))) && ((var_1_5 <= (var_1_4 / ((((-64) > (25)) ? (-64) : (25))))) ? (var_1_18 == ((unsigned char) (var_1_11 || ((var_1_11 || var_1_19) && var_1_14)))) : (var_1_18 == ((unsigned char) (var_1_19 && var_1_14))))) && ((((~ var_1_3) * (var_1_4 / var_1_21)) > var_1_2) ? ((var_1_3 >= var_1_4) ? (var_1_20 == ((unsigned long int) var_1_21)) : (var_1_20 == ((unsigned long int) var_1_2))) : (var_1_20 == ((unsigned long int) var_1_2)))) && (var_1_22 == ((float) ((var_1_23 + var_1_24) + (var_1_8 - var_1_10))))) && ((! var_1_18) ? (var_1_25 == ((signed char) (5 + (var_1_26 - var_1_27)))) : (var_1_25 == ((signed char) ((32 + var_1_26) - ((((var_1_27) < (var_1_28)) ? (var_1_27) : (var_1_28)))))))) && ((var_1_27 >= var_1_28) ? (var_1_29 == ((signed long int) (((((var_1_15) > (var_1_2)) ? (var_1_15) : (var_1_2))) + ((((var_1_28) < 0 ) ? -(var_1_28) : (var_1_28)))))) : (var_1_11 ? (((var_1_21 / -256) >= var_1_5) ? (var_1_29 == ((signed long int) ((((((((var_1_2) > (var_1_20)) ? (var_1_2) : (var_1_20)))) > (((var_1_5 + 100) + ((((var_1_28) < (var_1_3)) ? (var_1_28) : (var_1_3)))))) ? (((((var_1_2) > (var_1_20)) ? (var_1_2) : (var_1_20)))) : (((var_1_5 + 100) + ((((var_1_28) < (var_1_3)) ? (var_1_28) : (var_1_3))))))))) : (var_1_29 == ((signed long int) (var_1_27 - (var_1_31 - (var_1_32 - var_1_26)))))) : (var_1_29 == ((signed long int) (var_1_32 + (var_1_4 + var_1_2))))))) && (var_1_33 == ((signed short int) var_1_4))) && (var_1_34 == ((signed char) var_1_26))) && (var_1_35 == ((unsigned char) 25))
;
}
int main(void) {
 isInitial = 1;
