...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch98stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 signed short int stepLocal_3 = var_1_3;
 signed long int stepLocal_2 = (var_1_3 / var_1_4) & 8;
 signed short int stepLocal_1 = var_1_3;
 signed long int stepLocal_0 = var_1_3 / ((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5)));
