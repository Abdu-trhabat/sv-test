...
void step(void) {
	...
	if (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) - (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer))) <= 0) {
		(*(double_Array_0_arraydouble_Array_0arrayVar7_Pointer)) = (abs ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))));
	}


	// From: Req3Batch142Wrapper_AP
	...
	if (stepLocal_0 && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		...
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) = (min ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))));
	}


	// From: Req4Batch142Wrapper_AP
	unsigned long int stepLocal_1 = (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer));
	if (stepLocal_1 == (max ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))) {
