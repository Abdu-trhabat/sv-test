...
void step(void) {
	...
	// From: Req10Batch63100_while
	if (var_1_11) {
		var_1_32 = (var_1_8 + (var_1_5 + (min (var_1_1 , var_1_8))));
	}


	// From: Req4Batch63100_while
	if (var_1_11) {
		var_1_12 = var_1_6;
	}


	// From: Req5Batch63100_while
	...
	// From: Req13Batch63100_while
	var_1_37 = (abs ((var_1_6 + var_1_5) + var_1_29));


	// From: Req8Batch63100_while
