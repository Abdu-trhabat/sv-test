...
void step(void) {
	...
	// From: Req7Batch121dependencies
	var_1_24 = (min (4.4f , var_1_25));


	// From: Req8Batch121dependencies
	...
	// From: Req3Batch121dependencies
	if (var_1_17 < var_1_10) {
		var_1_16 = var_1_9;
	}


	// From: Req1Batch121dependencies
