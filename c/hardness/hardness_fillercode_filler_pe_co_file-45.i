...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch45Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned long int stepLocal_3 = ((var_1_18) * ( ((var_1_6) + (var_1_8))));
   ...
   var_1_32
                   ...
                   if ( ((var_1_16) && ( ((var_1_34) > ( ((var_1_18) + (var_1_6))))))) {
    ...
    -32
                   ...
                   if ( ((var_1_6) <= ( ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))))) {
                    var_1_38 = (
                     ((
