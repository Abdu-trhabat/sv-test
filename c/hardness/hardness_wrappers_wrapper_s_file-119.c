...
void step(void) {
	...
	// From: Req4Batch119Wrapper_S
	WrapperStruct00.var_1_8 = (! WrapperStruct00.var_1_9);


	// From: Req5Batch119Wrapper_S
	...
	if (WrapperStruct00.var_1_3 <= stepLocal_2) {
		if (WrapperStruct00.var_1_4 == stepLocal_1) {
			if (stepLocal_0 != WrapperStruct00.var_1_3) {
				...
				WrapperStruct00.var_1_10 = (abs (WrapperStruct00.var_1_12 - WrapperStruct00.var_1_3));
			}
		} else {
...
int property(void) {
	return ((((WrapperStruct00.var_1_1 == ((signed long int) (WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3))) && (WrapperStruct00.var_1_4 == ((signed short int) 200))) && ((WrapperStruct00.var_1_1 <= WrapperStruct00.var_1_4) ? (WrapperStruct00.var_1_5 == ((unsigned char) (WrapperStruct00.var_1_6 && WrapperStruct00.var_1_7))) : 1)) && (WrapperStruct00.var_1_8 == ((unsigned char) (! WrapperStruct00.var_1_9)))) && ((WrapperStruct00.var_1_3 <= (WrapperStruct00.var_1_4 + WrapperStruct00.var_1_2)) ? ((WrapperStruct00.var_1_4 == WrapperStruct00.var_1_11) ? ((WrapperStruct00.var_1_1 != WrapperStruct00.var_1_3) ? (WrapperStruct00.var_1_10 == ((unsigned long int) 128u)) : (WrapperStruct00.var_1_10 == ((unsigned long int) (abs (WrapperStruct00.var_1_12 - WrapperStruct00.var_1_3))))) : (WrapperStruct00.var_1_10 == ((unsigned long int) (WrapperStruct00.var_1_12 - (WrapperStruct00.var_1_13 + (WrapperStruct00.var_1_14 + 8u)))))) : (((~ WrapperStruct00.var_1_3) <= WrapperStruct00.var_1_2) ? (WrapperStruct00.var_1_7 ? (WrapperStruct00.var_1_10 == ((unsigned long int) WrapperStruct00.var_1_14)) : (WrapperStruct00.var_1_10 == ((unsigned long int) WrapperStruct00.var_1_13))) : 1))
;
}
int main(void) {
	isInitial = 1;
