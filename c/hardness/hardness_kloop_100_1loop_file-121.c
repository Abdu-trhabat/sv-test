...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch121100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req10Batch121100_1loop
	if (((var_1_11 & last_1_var_1_12) * (last_1_var_1_29 & last_1_var_1_24)) < last_1_var_1_1) {
		if (((max (last_1_var_1_31 , var_1_2)) / var_1_4) <= (var_1_27 * (var_1_3 / var_1_6))) {
			if (var_1_8) {
				var_1_29 = (var_1_28 + var_1_23);
			} else {
				var_1_29 = ((abs (var_1_28)) + last_1_var_1_24);
			}
		} else {
			var_1_29 = (min (last_1_var_1_24 , var_1_23));
		}
	} else {
		var_1_29 = var_1_10;
	}
	...
	// From: Req8Batch121100_1loop
	unsigned char stepLocal_0 = var_1_8;
	if (stepLocal_0 || var_1_25) {
		var_1_24 = (max (var_1_29 , var_1_20));
	}


	// From: Req11Batch121100_1loop
	...
	if (var_1_29 > stepLocal_2) {
		if (stepLocal_1 < var_1_23) {
			var_1_31 = ((abs (var_1_17)) - var_1_32);
		} else {
			var_1_31 = (((max (255.375f , var_1_33)) - var_1_34) + (var_1_35 - var_1_36));
		}
	} else {
		if (stepLocal_3 > -64) {
			var_1_31 = var_1_34;
	...
	// From: Req1Batch121100_1loop
	if ((var_1_2 / (min (var_1_3 , var_1_4))) <= (var_1_5 / (min (var_1_6 , var_1_7)))) {
		if (var_1_8) {
			var_1_1 = (var_1_9 - (max (var_1_10 , var_1_11)));
		} else {
			var_1_1 = (min (var_1_9 , var_1_11));
		}
	} else {
		var_1_1 = var_1_9;
	}
	...
	// From: Req2Batch121100_1loop
	if ((var_1_11 - 64) < var_1_9) {
		if (var_1_11 >= var_1_9) {
			var_1_12 = (max (var_1_10 , var_1_11));
		}
	}


	// From: Req3Batch121100_1loop
	if (var_1_6 > var_1_2) {
		var_1_13 = var_1_14;
	}


	// From: Req4Batch121100_1loop
	var_1_15 = ((abs (var_1_16)) - var_1_17);


	// From: Req5Batch121100_1loop
	if ((max (var_1_2 , (var_1_17 + var_1_5))) == var_1_16) {
		var_1_18 = (abs (var_1_14));
	}


	// From: Req6Batch121100_1loop
	if ((max (var_1_6 , var_1_16)) > 99.35) {
	...
	// From: Req7Batch121100_1loop
	if (var_1_6 > var_1_16) {
		var_1_21 = ((max ((abs (var_1_29)) , var_1_22)) - var_1_23);
	} else {
		var_1_21 = (var_1_20 + (abs (var_1_29)));
	}


	// From: Req9Batch121100_1loop
...
int property(void) {
	return ((((((((((((var_1_2 / (min (var_1_3 , var_1_4))) <= (var_1_5 / (min (var_1_6 , var_1_7)))) ? (var_1_8 ? (var_1_1 == ((unsigned long int) (var_1_9 - (max (var_1_10 , var_1_11))))) : (var_1_1 == ((unsigned long int) (min (var_1_9 , var_1_11))))) : (var_1_1 == ((unsigned long int) var_1_9))) && (((var_1_11 - 64) < var_1_9) ? ((var_1_11 >= var_1_9) ? (var_1_12 == ((unsigned long int) (max (var_1_10 , var_1_11)))) : 1) : 1)) && ((var_1_6 > var_1_2) ? (var_1_13 == ((signed char) var_1_14)) : 1)) && (var_1_15 == ((float) ((abs (var_1_16)) - var_1_17)))) && (((max (var_1_2 , (var_1_17 + var_1_5))) == var_1_16) ? (var_1_18 == ((signed short int) (abs (var_1_14)))) : 1)) && (((max (var_1_6 , var_1_16)) > 99.35) ? (var_1_19 == ((signed char) (abs (var_1_20)))) : (var_1_8 ? (var_1_19 == ((signed char) var_1_20)) : (var_1_19 == ((signed char) var_1_14))))) && ((var_1_6 > var_1_16) ? (var_1_21 == ((signed long int) ((max ((abs (var_1_29)) , var_1_22)) - var_1_23))) : (var_1_21 == ((signed long int) (var_1_20 + (abs (var_1_29))))))) && ((var_1_8 || var_1_25) ? (var_1_24 == ((signed long int) (max (var_1_29 , var_1_20)))) : 1)) && ((((1.6 + var_1_6) * 16.25) <= ((- var_1_4) + var_1_27)) ? ((-1 > var_1_20) ? (var_1_26 == ((unsigned short int) var_1_28)) : 1) : 1)) && ((((var_1_11 & last_1_var_1_12) * (last_1_var_1_29 & last_1_var_1_24)) < last_1_var_1_1) ? ((((max (last_1_var_1_31 , var_1_2)) / var_1_4) <= (var_1_27 * (var_1_3 / var_1_6))) ? (var_1_8 ? (var_1_29 == ((unsigned long int) (var_1_28 + var_1_23))) : (var_1_29 == ((unsigned long int) ((abs (var_1_28)) + last_1_var_1_24)))) : (var_1_29 == ((unsigned long int) (min (last_1_var_1_24 , var_1_23))))) : (var_1_29 == ((unsigned long int) var_1_10)))) && ((var_1_29 > 0u) ? (((var_1_29 & var_1_9) < var_1_23) ? (var_1_31 == ((float) ((abs (var_1_17)) - var_1_32))) : (var_1_31 == ((float) (((max (255.375f , var_1_33)) - var_1_34) + (var_1_35 - var_1_36))))) : (((var_1_29 + (var_1_37 - 100)) > -64) ? (var_1_31 == ((float) var_1_34)) : 1))
;
}
int main(void) {
	isInitial = 1;
