...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch74100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_1 >= var_1_34) {
		if (var_1_28) {
			if (stepLocal_0 >= (min ((- 128u) , var_1_3))) {
				var_1_7 = var_1_4;
			}
		} else {
			var_1_7 = var_1_4;
	...
	signed long int stepLocal_4 = (abs (var_1_20)) * var_1_11;
	signed long int stepLocal_3 = var_1_26 * (var_1_21 & var_1_26);
	unsigned char stepLocal_2 = (- var_1_8) <= (abs (var_1_26));
	...
	if (var_1_28) {
		if ((abs (- var_1_7)) <= (min (var_1_4 , (- var_1_1)))) {
...
int property(void) {
	return (((((((((((var_1_26 <= (128 - var_1_3)) ? (var_1_1 == ((double) var_1_4)) : ((var_1_22 || var_1_28) ? (var_1_1 == ((double) var_1_4)) : 1)) && ((var_1_3 >= var_1_34) ? (var_1_28 ? (((var_1_8 - (1212980845u - var_1_34)) >= (min ((- 128u) , var_1_3))) ? (var_1_7 == ((double) var_1_4)) : 1) : (var_1_7 == ((double) var_1_4))) : (var_1_7 == ((double) var_1_4)))) && ((! var_1_28) ? (var_1_9 == ((signed char) (min (var_1_10 , var_1_11)))) : 1)) && (var_1_28 ? (((abs (- var_1_7)) <= (min (var_1_4 , (- var_1_1)))) ? (((! var_1_28) || var_1_22) ? (var_1_12 == ((float) 100000.6f)) : (var_1_12 == ((float) var_1_4))) : (var_1_12 == ((float) var_1_14))) : (var_1_12 == ((float) var_1_4)))) && (var_1_22 ? ((last_1_var_1_15 < (var_1_16 - (var_1_17 - var_1_18))) ? (var_1_22 ? (var_1_15 == ((double) (max (var_1_4 , (255.4 - var_1_18))))) : (var_1_15 == ((double) (max (var_1_14 , 63.25))))) : 1) : (var_1_15 == ((double) 0.1)))) && (var_1_19 == ((signed char) (var_1_20 - var_1_21)))) && ((((var_1_21 | var_1_26) == var_1_20) && ((- var_1_8) <= (abs (var_1_26)))) ? (((var_1_26 * (var_1_21 & var_1_26)) >= (var_1_26 * var_1_34)) ? ((var_1_34 > ((abs (var_1_20)) * var_1_11)) ? (var_1_28 ? (var_1_22 == ((unsigned char) (! var_1_25))) : 1) : (var_1_22 == ((unsigned char) var_1_25))) : 1) : (var_1_22 == ((unsigned char) var_1_25)))) && (var_1_26 == ((signed long int) ((var_1_27 - var_1_23) + var_1_10)))) && (((last_1_var_1_12 < (var_1_18 + 128.9f)) || (var_1_14 > (var_1_16 * last_1_var_1_7))) ? ((16u <= var_1_29) ? (var_1_28 == ((unsigned char) var_1_25)) : (var_1_28 == ((unsigned char) 0))) : (var_1_28 == ((unsigned char) var_1_30)))) && ((var_1_28 || var_1_22) ? ((var_1_1 > var_1_17) ? (var_1_31 == ((signed char) ((var_1_32 - 2) + var_1_33))) : (var_1_31 == ((signed char) var_1_21))) : (var_1_31 == ((signed char) var_1_11)))) && (((var_1_26 % (var_1_35 + var_1_36)) == var_1_27) ? (var_1_30 ? (var_1_34 == ((signed short int) var_1_10)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
