...
void step(void) {
 signed long int stepLocal_0 = var_1_3 + ((((50) > (var_1_4)) ? (50) : (var_1_4)));
...
int property(void) {
 return ((((var_1_2 <= (var_1_3 + ((((50) > (var_1_4)) ? (50) : (var_1_4))))) ? (var_1_1 == ((double) ((var_1_5 + var_1_6) + var_1_7))) : 1) && (var_1_8 == ((double) var_1_5))) && (var_1_9 == ((signed short int) var_1_10))) && (var_1_11 == ((unsigned short int) var_1_12))
;
}
int main(void) {
 isInitial = 1;
