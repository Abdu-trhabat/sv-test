...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch121Amount10.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned char stepLocal_0 = var_1_3 < (var_1_2 / var_1_5);
 if (stepLocal_0 && var_1_6) {
  if (stepLocal_1 == last_1_var_1_1) {
   if ((var_1_3 * var_1_5) != stepLocal_2) {
    var_1_1 = var_1_7;
   } else {
    var_1_1 = var_1_8;
   }
...
int property(void) {
 return ((var_1_3 < (var_1_2 / var_1_5)) && var_1_6) ? ((var_1_5 == last_1_var_1_1) ? (((var_1_3 * var_1_5) != var_1_2) ? (var_1_1 == ((unsigned long int) var_1_7)) : (var_1_1 == ((unsigned long int) var_1_8))) : (var_1_1 == ((unsigned long int) var_1_8))) : (var_1_1 == ((unsigned long int) var_1_7))
;
}
int main(void) {
 isInitial = 1;
