...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch121no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch121no_floats
	var_1_13 = var_1_14;


	// From: Req5Batch121no_floats
	var_1_15 = var_1_16;


	// From: Req3Batch121no_floats
	if (var_1_2 <= var_1_5) {
		if (! var_1_15) {
