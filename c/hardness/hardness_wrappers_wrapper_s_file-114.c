...
void step(void) {
	...
	// From: Req3Batch114Wrapper_S
	if ((WrapperStruct00.var_1_10 / 1u) != (WrapperStruct00.var_1_11 + 10u)) {
		WrapperStruct00.var_1_9 = ((min (WrapperStruct00.var_1_12 , 128)) - WrapperStruct00.var_1_13);
	}


	// From: Req4Batch114Wrapper_S
	if ((WrapperStruct00.var_1_4 / (max (WrapperStruct00.var_1_15 , -8))) >= ((WrapperStruct00.var_1_5 | WrapperStruct00.var_1_1) + WrapperStruct00.var_1_13)) {
		WrapperStruct00.var_1_14 = WrapperStruct00.var_1_8;
	} else {
		if (WrapperStruct00.var_1_6 != ((abs (WrapperStruct00.var_1_8)) - WrapperStruct00.var_1_16)) {
			WrapperStruct00.var_1_14 = WrapperStruct00.var_1_8;
		}
	}
}
...
int property(void) {
	return ((((WrapperStruct00.var_1_2 > WrapperStruct00.var_1_3) ? (WrapperStruct00.var_1_1 == ((signed short int) (min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5)))) : (WrapperStruct00.var_1_1 == ((signed short int) 32))) && ((((WrapperStruct00.var_1_2 * WrapperStruct00.var_1_1) < WrapperStruct00.var_1_5) || WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_7 ? (WrapperStruct00.var_1_6 == ((float) WrapperStruct00.var_1_8)) : 1) : 1)) && (((WrapperStruct00.var_1_10 / 1u) != (WrapperStruct00.var_1_11 + 10u)) ? (WrapperStruct00.var_1_9 == ((unsigned char) ((min (WrapperStruct00.var_1_12 , 128)) - WrapperStruct00.var_1_13))) : 1)) && (((WrapperStruct00.var_1_4 / (max (WrapperStruct00.var_1_15 , -8))) >= ((WrapperStruct00.var_1_5 | WrapperStruct00.var_1_1) + WrapperStruct00.var_1_13)) ? (WrapperStruct00.var_1_14 == ((float) WrapperStruct00.var_1_8)) : ((WrapperStruct00.var_1_6 != ((abs (WrapperStruct00.var_1_8)) - WrapperStruct00.var_1_16)) ? (WrapperStruct00.var_1_14 == ((float) WrapperStruct00.var_1_8)) : 1))
;
}
int main(void) {
	isInitial = 1;
