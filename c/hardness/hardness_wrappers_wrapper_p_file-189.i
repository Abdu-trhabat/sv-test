...
void step(void) {
 ...
 if ((*(var_1_14_Pointer)) <= stepLocal_2) {
  if (! ((*(var_1_13_Pointer)) <= (*(var_1_12_Pointer)))) {
   (*(var_1_16_Pointer)) = ((((((((((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) > ((*(var_1_12_Pointer)))) ? (((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) : ((*(var_1_12_Pointer)))))) > ((*(var_1_13_Pointer)))) ? (((((((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) > ((*(var_1_12_Pointer)))) ? (((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) : ((*(var_1_12_Pointer)))))) : ((*(var_1_13_Pointer)))));
  }
 } else {
 ...
 unsigned long int stepLocal_0 = ((((*(var_1_16_Pointer))) < ((*(var_1_14_Pointer)))) ? ((*(var_1_16_Pointer))) : ((*(var_1_14_Pointer))));
 if (stepLocal_0 >= (*(var_1_16_Pointer))) {
  (*(var_1_5_Pointer)) = (((((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) < 0 ) ? -((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) : ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer)))));
 } else {
  (*(var_1_5_Pointer)) = (((((*(var_1_10_Pointer))) < 0 ) ? -((*(var_1_10_Pointer))) : ((*(var_1_10_Pointer)))));
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((*(var_1_2_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_3_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned char) (! (*(var_1_4_Pointer)))))) && (((((((*(var_1_16_Pointer))) < ((*(var_1_14_Pointer)))) ? ((*(var_1_16_Pointer))) : ((*(var_1_14_Pointer))))) >= (*(var_1_16_Pointer))) ? ((*(var_1_5_Pointer)) == ((float) (((((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) < 0 ) ? -((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) : ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))))))) : ((*(var_1_5_Pointer)) == ((float) (((((*(var_1_10_Pointer))) < 0 ) ? -((*(var_1_10_Pointer))) : ((*(var_1_10_Pointer))))))))) && (last_1_var_1_1 ? ((((*(var_1_12_Pointer)) - (*(var_1_13_Pointer))) < last_1_var_1_16) ? ((*(var_1_11_Pointer)) == ((float) (*(var_1_9_Pointer)))) : 1) : ((*(var_1_11_Pointer)) == ((float) (*(var_1_9_Pointer)))))) && ((64.8f <= (*(var_1_11_Pointer))) ? ((*(var_1_14_Pointer)) == ((unsigned char) (*(var_1_15_Pointer)))) : 1)) && (((*(var_1_14_Pointer)) <= (*(var_1_8_Pointer))) ? ((! ((*(var_1_13_Pointer)) <= (*(var_1_12_Pointer)))) ? ((*(var_1_16_Pointer)) == ((unsigned long int) ((((((((((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) > ((*(var_1_12_Pointer)))) ? (((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) : ((*(var_1_12_Pointer)))))) > ((*(var_1_13_Pointer)))) ? (((((((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) > ((*(var_1_12_Pointer)))) ? (((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) : ((*(var_1_12_Pointer)))))) : ((*(var_1_13_Pointer))))))) : 1) : ((*(var_1_16_Pointer)) == ((unsigned long int) (*(var_1_13_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
