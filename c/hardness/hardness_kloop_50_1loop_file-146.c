...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14650_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch14650_1loop
	if ((- var_1_8) > var_1_8) {
		var_1_14 = 5;
	}


	// From: Req1Batch14650_1loop
	...
	// From: Req8Batch14650_1loop
	var_1_25 = var_1_21;


	// From: Req6Batch14650_1loop
	if (var_1_2) {
