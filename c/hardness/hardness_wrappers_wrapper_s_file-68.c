...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch68Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3) >= WrapperStruct00.var_1_10) {
		if (stepLocal_0 >= (WrapperStruct00.var_1_18 / WrapperStruct00.var_1_8)) {
			WrapperStruct00.var_1_1 = (abs (WrapperStruct00.var_1_21));
		}
	} else {
		if (WrapperStruct00.var_1_9) {
			WrapperStruct00.var_1_1 = (max (WrapperStruct00.var_1_21 , WrapperStruct00.var_1_18));
		}
	}
}
