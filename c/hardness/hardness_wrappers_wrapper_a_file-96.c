...
void step(void) {
	...
	if ((abs (signed_long_int_Array_0[1])) > unsigned_short_int_Array_0[1][1]) {
		if ((signed_long_int_Array_0[1] / -5) >= ((unsigned_short_int_Array_0[1][0] + unsigned_short_int_Array_0[1][1]) - (min (signed_long_int_Array_0[0] , unsigned_short_int_Array_0[0][1])))) {
...
int property(void) {
	return ((((((! last_1_BOOL_unsigned_char_Array_0_0__2_) ? (unsigned_short_int_Array_0[1][1] == ((unsigned short int) (min (unsigned_short_int_Array_0[0][1] , unsigned_short_int_Array_0[1][0])))) : (unsigned_short_int_Array_0[1][1] == ((unsigned short int) unsigned_short_int_Array_0[1][0]))) && (BOOL_unsigned_char_Array_0[1][2] ? ((BOOL_unsigned_char_Array_0[1][1] && ((unsigned_short_int_Array_0[0][1] >= 16) || BOOL_unsigned_char_Array_0[0][1])) ? (BOOL_unsigned_char_Array_0[1][1] ? (BOOL_unsigned_char_Array_0[0][2] == ((unsigned char) ((unsigned_short_int_Array_0[1][1] < unsigned_short_int_Array_0[0][0]) && BOOL_unsigned_char_Array_0[0][0]))) : (BOOL_unsigned_char_Array_0[0][2] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0]))) : 1) : 1)) && (((abs (signed_long_int_Array_0[1])) > unsigned_short_int_Array_0[1][1]) ? (((signed_long_int_Array_0[1] / -5) >= ((unsigned_short_int_Array_0[1][0] + unsigned_short_int_Array_0[1][1]) - (min (signed_long_int_Array_0[0] , unsigned_short_int_Array_0[0][1])))) ? (double_Array_0[1] == ((double) (double_Array_0[0] + double_Array_0[2]))) : (double_Array_0[1] == ((double) double_Array_0[2]))) : 1)) && (signed_long_int_Array_0[1] == ((signed long int) unsigned_short_int_Array_0[1][1]))) && (float_Array_0[0] == ((float) double_Array_0[0]))) && (signed_char_Array_0[0] == ((signed char) signed_char_Array_0[1]))
;
}
int main(void) {
	isInitial = 1;
