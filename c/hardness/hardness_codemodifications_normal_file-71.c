...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch71normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch71normal
	var_1_10 = var_1_11;


	// From: Req3Batch71normal
	...
	// From: Req5Batch71normal
	if (! var_1_3) {
		var_1_19 = (var_1_5 + 256);
	}


	// From: Req6Batch71normal
	if (var_1_9 == var_1_5) {
		var_1_20 = (max (var_1_4 , (var_1_1 + -8)));
	}


	// From: Req7Batch71normal
	var_1_21 = (! (var_1_22 || (var_1_23 || var_1_24)));


	// From: Req8Batch71normal
	var_1_25 = 16;
}
