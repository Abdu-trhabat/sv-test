...
void step(void) {
	...
	// From: Req3Batch172has_floats
	var_1_11 = (min (var_1_12 , var_1_13));


	// From: Req4Batch172has_floats
	if (-8 > var_1_12) {
		var_1_14 = (var_1_15 - (min (1000000.0f , var_1_16)));
	} else {
		if (var_1_6) {
			var_1_14 = var_1_16;
		} else {
