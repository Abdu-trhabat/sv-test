...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch87100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 unsigned long int stepLocal_0 = last_1_var_1_28 / ((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6)));
 if ((last_1_var_1_25 + last_1_var_1_27) == stepLocal_0) {
  var_1_1 = (var_1_7 - var_1_8);
 }
 var_1_27 = (var_1_8 + ((((var_1_7) > ((32 + last_1_var_1_1))) ? (var_1_7) : ((32 + last_1_var_1_1)))));
 var_1_9 = (((((var_1_8) < (var_1_27)) ? (var_1_8) : (var_1_27))) + var_1_7);
 if (var_1_16) {
  var_1_23 = (! (! 0));
 }
 ...
 if (var_1_17 > (var_1_21 + var_1_20)) {
  var_1_25 = ((((var_1_8) < (last_1_var_1_25)) ? (var_1_8) : (last_1_var_1_25)));
 }
...
int property(void) {
 return (((((((((((((((last_1_var_1_25 + last_1_var_1_27) == (last_1_var_1_28 / ((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6))))) ? (var_1_1 == ((unsigned char) (var_1_7 - var_1_8))) : 1) && (var_1_9 == ((unsigned short int) (((((var_1_8) < (var_1_27)) ? (var_1_8) : (var_1_27))) + var_1_7)))) && (var_1_23 ? ((var_1_24 || var_1_23) ? (var_1_10 == ((unsigned char) var_1_14)) : (var_1_10 == ((unsigned char) (var_1_15 || var_1_16)))) : (var_1_10 == ((unsigned char) var_1_15)))) && (((var_1_27 / (var_1_7 + var_1_18)) < var_1_1) ? (((~ 5) < (var_1_19 - var_1_28)) ? (var_1_17 == ((float) (var_1_20 + var_1_21))) : (var_1_17 == ((float) var_1_21))) : (var_1_17 == ((float) var_1_20)))) && (var_1_22 == ((signed short int) (var_1_25 - (30604 - var_1_8))))) && (var_1_16 ? (var_1_23 == ((unsigned char) (! (! 0)))) : 1)) && ((var_1_19 <= (var_1_28 * var_1_8)) ? (var_1_24 == ((unsigned char) ((var_1_28 >= var_1_7) || var_1_14))) : 1)) && ((var_1_17 > (var_1_21 + var_1_20)) ? (var_1_25 == ((signed short int) ((((var_1_8) < (last_1_var_1_25)) ? (var_1_8) : (last_1_var_1_25))))) : 1)) && (var_1_26 == ((unsigned char) ((((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) < (((((50) < 0 ) ? -(50) : (50))))) ? (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))) : (((((50) < 0 ) ? -(50) : (50))))))))) && (var_1_27 == ((unsigned short int) (var_1_8 + ((((var_1_7) > ((32 + last_1_var_1_1))) ? (var_1_7) : ((32 + last_1_var_1_1)))))))) && (((var_1_9 + var_1_18) < (var_1_5 / -100)) ? (var_1_28 == ((unsigned long int) (((((var_1_18) > (var_1_7)) ? (var_1_18) : (var_1_7))) + var_1_8))) : 1)) && ((var_1_6 != (var_1_8 + (var_1_27 / var_1_7))) ? (((32.5 < 999.4) && var_1_10) ? ((var_1_27 < var_1_7) ? (var_1_29 == ((signed char) (var_1_31 - var_1_32))) : (var_1_29 == ((signed char) ((((var_1_32) < (var_1_31)) ? (var_1_32) : (var_1_31)))))) : (var_1_29 == ((signed char) ((var_1_33 - var_1_34) - (var_1_35 - ((((var_1_36) > (var_1_37)) ? (var_1_36) : (var_1_37)))))))) : ((var_1_10 || (var_1_37 < -4)) ? (var_1_29 == ((signed char) ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))))) : (var_1_29 == ((signed char) ((((((((var_1_37) < (var_1_36)) ? (var_1_37) : (var_1_36)))) > (var_1_33)) ? (((((var_1_37) < (var_1_36)) ? (var_1_37) : (var_1_36)))) : (var_1_33)))))))) && (((var_1_34 + (var_1_27 + var_1_8)) <= var_1_18) ? (((var_1_9 + (5u + var_1_28)) <= var_1_28) ? (var_1_38 == ((float) var_1_21)) : (var_1_38 == ((float) var_1_20))) : (var_1_38 == ((float) var_1_21)))) && (var_1_39 == ((double) var_1_21))
;
}
int main(void) {
 isInitial = 1;
