...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch148Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch148Wrapper_A
	float_Array_0[1][1] = (float_Array_0[0][1] - float_Array_0[1][0]);


	// From: Req4Batch148Wrapper_A
	double_Array_0[0][0] = ((double_Array_0[0][1] + (max (double_Array_0[1][1] , double_Array_0[1][0]))) - float_Array_0[0][1]);


	// From: Req5Batch148Wrapper_A
	float_Array_0[0][0] = 1.00000007E7f;


	// From: Req2Batch148Wrapper_A
	if (BOOL_unsigned_char_Array_0[3] && BOOL_unsigned_char_Array_0[2]) {
		BOOL_unsigned_char_Array_0[4] = (! BOOL_unsigned_char_Array_0[1]);
	} else {
		BOOL_unsigned_char_Array_0[4] = (! ((double_Array_0[0][0] > float_Array_0[1][0]) || BOOL_unsigned_char_Array_0[1]));
	}


	// From: Req3Batch148Wrapper_A
	signed long int stepLocal_0 = signed_char_Array_0[0] - signed_char_Array_0[1];
	if (float_Array_0[0][0] < float_Array_0[1][0]) {
		if (stepLocal_0 >= (signed_long_int_Array_0[1] / signed_long_int_Array_0[0])) {
			if (BOOL_unsigned_char_Array_0[4]) {
				...
				BOOL_unsigned_char_Array_0[0] = ((signed_char_Array_0[0] < (~ signed_long_int_Array_0[1])) || BOOL_unsigned_char_Array_0[1]);
			}
		}
	} else {
		if (BOOL_unsigned_char_Array_0[4]) {
...
int property(void) {
	return ((((float_Array_0[1][1] == ((float) (float_Array_0[0][1] - float_Array_0[1][0]))) && ((BOOL_unsigned_char_Array_0[3] && BOOL_unsigned_char_Array_0[2]) ? (BOOL_unsigned_char_Array_0[4] == ((unsigned char) (! BOOL_unsigned_char_Array_0[1]))) : (BOOL_unsigned_char_Array_0[4] == ((unsigned char) (! ((double_Array_0[0][0] > float_Array_0[1][0]) || BOOL_unsigned_char_Array_0[1])))))) && ((float_Array_0[0][0] < float_Array_0[1][0]) ? (((signed_char_Array_0[0] - signed_char_Array_0[1]) >= (signed_long_int_Array_0[1] / signed_long_int_Array_0[0])) ? (BOOL_unsigned_char_Array_0[4] ? (BOOL_unsigned_char_Array_0[0] == ((unsigned char) BOOL_unsigned_char_Array_0[1])) : (BOOL_unsigned_char_Array_0[0] == ((unsigned char) ((signed_char_Array_0[0] < (~ signed_long_int_Array_0[1])) || BOOL_unsigned_char_Array_0[1])))) : 1) : (BOOL_unsigned_char_Array_0[4] ? (BOOL_unsigned_char_Array_0[0] == ((unsigned char) BOOL_unsigned_char_Array_0[1])) : (BOOL_unsigned_char_Array_0[0] == ((unsigned char) 0))))) && (double_Array_0[0][0] == ((double) ((double_Array_0[0][1] + (max (double_Array_0[1][1] , double_Array_0[1][0]))) - float_Array_0[0][1])))) && (float_Array_0[0][0] == ((float) 1.00000007E7f))
;
}
int main(void) {
	isInitial = 1;
