...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch143stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch143stepLocals
	signed long int stepLocal_0 = max (64 , var_1_2);
	...
	// From: Req3Batch143stepLocals
	var_1_10 = (min (var_1_11 , var_1_12));


	// From: Req4Batch143stepLocals
	var_1_13 = var_1_12;


	// From: Req5Batch143stepLocals
	var_1_14 = ((var_1_15 - (4 + var_1_13)) - var_1_12);


	// From: Req6Batch143stepLocals
	unsigned short int stepLocal_3 = var_1_2;
	if (stepLocal_3 > var_1_10) {
		var_1_16 = ((var_1_8 > var_1_7) && var_1_17);
	} else {
		var_1_16 = ((var_1_4 < (min (var_1_6 , var_1_5))) && var_1_17);
	}


	// From: Req7Batch143stepLocals
	if (var_1_9 <= -16) {
		var_1_18 = (abs ((var_1_11 + var_1_10) + var_1_2));
	}


	// From: Req8Batch143stepLocals
	var_1_19 = (((var_1_20 - var_1_10) + var_1_12) - var_1_13);


	// From: Req9Batch143stepLocals
	var_1_21 = var_1_9;


	// From: Req10Batch143stepLocals
	var_1_22 = var_1_23;
}
