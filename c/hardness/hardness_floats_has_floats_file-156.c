...
void step(void) {
	...
	// From: Req3Batch156has_floats
	if (! (var_1_1 <= var_1_6)) {
		if ((var_1_9 - (max (var_1_4 , var_1_11))) >= var_1_5) {
			var_1_8 = ((abs (var_1_10)) - var_1_5);
		} else {
			var_1_8 = (max (32 , var_1_11));
		}
	}
}
...
int property(void) {
	return ((((last_1_var_1_11 <= last_1_var_1_6) ? (var_1_1 == ((unsigned char) (min (var_1_4 , var_1_5)))) : 1) && ((var_1_1 < var_1_3) ? (((var_1_5 + var_1_1) >= (var_1_4 % var_1_7)) ? (var_1_6 == ((unsigned short int) (100 + var_1_5))) : (var_1_6 == ((unsigned short int) var_1_5))) : 1)) && ((! (var_1_1 <= var_1_6)) ? (((var_1_9 - (max (var_1_4 , var_1_11))) >= var_1_5) ? (var_1_8 == ((unsigned short int) ((abs (var_1_10)) - var_1_5))) : (var_1_8 == ((unsigned short int) (max (32 , var_1_11))))) : 1)) && (((last_1_var_1_1 % var_1_9) <= ((var_1_12 - last_1_var_1_8) - last_1_var_1_6)) ? (var_1_11 == ((unsigned long int) 32u)) : 1)
;
}
int main(void) {
	isInitial = 1;
