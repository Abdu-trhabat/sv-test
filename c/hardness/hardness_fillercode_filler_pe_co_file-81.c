...
void step(void) {
	...
	// From: CodeObject3
	/* 341L, 138L) */ if (/* 342L, 119L, 120L) */ ((/* 343L, 117L, 121L) */ ((/* 344L, 115L, 122L) */ ((var_1_26) % (var_1_33))) != (var_1_10))) || (var_1_28))) {
		/* 349L, 137L) */ var_1_32 = (
			var_1_34
		);
	}
	...
	// From: CodeObject4
	/* 353L, 171L) */ if (/* 354L, 151L, 152L) */ ((var_1_10) >= (/* 356L, 150L, 154L) */ ((var_1_36) - (/* 358L, 149L, 156L) */ ((64) - (var_1_37))))))) {
		/* 361L, 170L) */ var_1_35 = (
			/* 364L, 169L) */ (abs (
				var_1_37
			))
	...
	// From: CodeObject5
	/* 366L, 245L) */ if (/* 367L, 180L, 181L) */ ((var_1_1) > (/* 369L, 179L, 183L) */ ((var_1_11) & (/* 371L, 178L, 185L) */ (~ (var_1_33))))))) {
	...
	// From: CodeObject7
	/* 419L, 321L) */ if (/* 420L, 287L, 288L) */ ((var_1_26) <= (var_1_11))) {
		/* 423L, 319L) */ if (/* 424L, 300L, 301L) */ ((/* 425L, 296L, 302L) */ ((var_1_37) << (var_1_24))) < (/* 428L, 299L, 305L) */ ((var_1_11) - (var_1_26))))) {
			/* 431L, 318L) */ var_1_45 = (
				var_1_34
			);
		}
