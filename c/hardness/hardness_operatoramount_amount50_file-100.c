...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch100Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch100Amount50
	if ((max (last_1_var_1_22 , var_1_5)) > last_1_var_1_22) {
		var_1_19 = (max (last_1_var_1_6 , var_1_14));
	}


	// From: Req2Batch100Amount50
	...
	if ((var_1_19 ^ (var_1_9 - var_1_10)) > stepLocal_3) {
		if (((max (var_1_19 , var_1_9)) + var_1_19) == stepLocal_2) {
			var_1_6 = var_1_13;
		} else {
			var_1_6 = (max ((abs (var_1_13)) , var_1_14));
		}
	}


	// From: Req5Batch100Amount50
	...
	// From: Req1Batch100Amount50
	unsigned long int stepLocal_1 = 8u;
	unsigned long int stepLocal_0 = (min (var_1_2 , var_1_21)) + var_1_21;
	...
	// From: Req6Batch100Amount50
	if (! ((abs (var_1_15)) >= (var_1_23 - var_1_24))) {
...
int property(void) {
	return ((((((8u < var_1_2) ? ((-8 > ((min (var_1_2 , var_1_21)) + var_1_21)) ? (var_1_1 == ((double) var_1_5)) : (var_1_1 == ((double) 256.5))) : 1) && (((var_1_19 ^ (var_1_9 - var_1_10)) > (var_1_19 * (3512938537u - var_1_11))) ? ((((max (var_1_19 , var_1_9)) + var_1_19) == (2u * (var_1_19 * var_1_11))) ? (var_1_6 == ((unsigned short int) var_1_13)) : (var_1_6 == ((unsigned short int) (max ((abs (var_1_13)) , var_1_14))))) : 1)) && (var_1_16 ? (((var_1_1 + (var_1_5 + var_1_1)) < 9.25) ? (var_1_15 == ((float) var_1_5)) : 1) : (var_1_15 == ((float) var_1_18)))) && (((max (last_1_var_1_22 , var_1_5)) > last_1_var_1_22) ? (var_1_19 == ((unsigned long int) (max (last_1_var_1_6 , var_1_14)))) : 1)) && ((var_1_4 > var_1_11) ? ((var_1_4 > var_1_19) ? (var_1_21 == ((signed long int) 8)) : 1) : 1)) && ((! ((abs (var_1_15)) >= (var_1_23 - var_1_24))) ? (var_1_22 == ((double) (var_1_25 + (var_1_26 - var_1_27)))) : (var_1_16 ? (var_1_22 == ((double) var_1_18)) : 1))
;
}
int main(void) {
	isInitial = 1;
