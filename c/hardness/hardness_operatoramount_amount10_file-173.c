...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch173Amount10.c", 13, "reach_error"); }
...
double var_1_2 = -0.825;
double var_1_3 = 1000000000.1;
...
int property(void) {
	return ((var_1_2 > var_1_3) ? (var_1_1 == ((signed short int) (min (var_1_4 , (var_1_5 + var_1_6))))) : 1) && ((var_1_8 && var_1_9) ? (var_1_7 == ((signed long int) (8 - (min (var_1_10 , var_1_11))))) : 1)
;
}
int main(void) {
	isInitial = 1;
