...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch18650_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch18650_1loop
	var_1_1 = var_1_2;


	// From: Req2Batch18650_1loop
	unsigned char stepLocal_0 = var_1_1 != (min (-10 , var_1_2));
	...
	// From: Req3Batch18650_1loop
	if ((var_1_7 > (max (9.6 , var_1_6))) || (var_1_5 < var_1_3)) {
		var_1_9 = var_1_10;
	}


	// From: Req5Batch18650_1loop
	...
	// From: Req7Batch18650_1loop
	unsigned long int stepLocal_5 = min ((var_1_15 + var_1_17) , var_1_9);
