...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1250_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch1250_1loop
	if ((var_1_12 / var_1_16) >= var_1_10) {
		var_1_15 = (var_1_17 + 255.5);
	}


	// From: Req6Batch1250_1loop
	var_1_21 = (abs (var_1_7));


	// From: Req7Batch1250_1loop
