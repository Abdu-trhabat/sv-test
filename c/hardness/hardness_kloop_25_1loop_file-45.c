...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4525_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((var_1_2 / 32) < (min ((var_1_3 + var_1_4) , var_1_5))) {
	...
	if (var_1_10) {
		...
		if (stepLocal_0 < (min ((var_1_4 + var_1_2) , var_1_5))) {
...
int property(void) {
	return (((((var_1_2 / 32) < (min ((var_1_3 + var_1_4) , var_1_5))) ? (var_1_1 == ((double) ((var_1_6 - var_1_7) - var_1_8))) : (var_1_1 == ((double) var_1_6))) && (var_1_10 ? (var_1_9 == ((unsigned long int) ((var_1_11 + var_1_12) - 5u))) : 1)) && (var_1_10 ? (var_1_13 == ((signed char) (var_1_14 - (min ((min (var_1_15 , var_1_16)) , 50))))) : ((var_1_12 < (min ((var_1_4 + var_1_2) , var_1_5))) ? (var_1_13 == ((signed char) (var_1_17 + var_1_18))) : 1))) && (var_1_19 == ((unsigned char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
