...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4725_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_12) {
		var_1_11 = (min (var_1_4 , var_1_5));
	} else {
		var_1_11 = (max (var_1_4 , (var_1_13 - (var_1_5 + 32u))));
	}


	// From: Req4Batch4725_1loop
	if ((max (var_1_1 , var_1_9)) >= var_1_1) {
		if (var_1_12) {
...
int property(void) {
	return ((((var_1_2 <= var_1_3) ? (((var_1_4 + var_1_5) >= (var_1_6 + var_1_7)) ? (var_1_1 == ((double) var_1_8)) : 1) : (var_1_1 == ((double) var_1_8))) && (var_1_9 == ((float) (abs (var_1_10 - (abs (10000.4f))))))) && (var_1_12 ? (var_1_11 == ((unsigned long int) (min (var_1_4 , var_1_5)))) : (var_1_11 == ((unsigned long int) (max (var_1_4 , (var_1_13 - (var_1_5 + 32u)))))))) && (((max (var_1_1 , var_1_9)) >= var_1_1) ? (var_1_12 ? (var_1_14 == ((signed char) (var_1_15 - var_1_16))) : 1) : (var_1_14 == ((signed char) var_1_15)))
;
}
int main(void) {
	isInitial = 1;
