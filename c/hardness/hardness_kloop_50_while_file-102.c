...
void step(void) {
	// From: Req1Batch10250_while
	var_1_1 = ((var_1_2 - var_1_3) + var_1_4);


	// From: Req2Batch10250_while
	...
	// From: Req3Batch10250_while
	var_1_9 = (min (var_1_10 , var_1_4));


	// From: Req4Batch10250_while
	...
	// From: Req7Batch10250_while
	var_1_19 = (var_1_20 + (var_1_21 + (var_1_22 + 4)));


	// From: Req8Batch10250_while
