...
void step(void) {
	...
	if (WrapperStruct00.var_1_8 || stepLocal_2) {
		WrapperStruct00.var_1_7 = (min (WrapperStruct00.var_1_1 , (min (-200 , WrapperStruct00.var_1_6))));
	} else {
		if (stepLocal_3 != 1u) {
	...
	if ((WrapperStruct00.var_1_10 - WrapperStruct00.var_1_11) >= stepLocal_4) {
		if ((- 999999.75f) > WrapperStruct00.var_1_14) {
			WrapperStruct00.var_1_9 = (WrapperStruct00.var_1_13 + (max (WrapperStruct00.var_1_15 , WrapperStruct00.var_1_16)));
		}
	}


	// From: Req4Batch69Wrapper_S
...
int property(void) {
	return (((((WrapperStruct00.var_1_2 * (min (WrapperStruct00.var_1_3 , WrapperStruct00.var_1_4))) < WrapperStruct00.var_1_5) ? ((WrapperStruct00.var_1_5 > WrapperStruct00.var_1_2) ? (WrapperStruct00.var_1_1 == ((signed short int) WrapperStruct00.var_1_6)) : (WrapperStruct00.var_1_1 == ((signed short int) 4))) : 1) && ((WrapperStruct00.var_1_8 || (WrapperStruct00.var_1_2 > (WrapperStruct00.var_1_4 + WrapperStruct00.var_1_3))) ? (WrapperStruct00.var_1_7 == ((signed long int) (min (WrapperStruct00.var_1_1 , (min (-200 , WrapperStruct00.var_1_6)))))) : ((WrapperStruct00.var_1_2 != 1u) ? (WrapperStruct00.var_1_7 == ((signed long int) WrapperStruct00.var_1_1)) : (WrapperStruct00.var_1_7 == ((signed long int) WrapperStruct00.var_1_6))))) && (((WrapperStruct00.var_1_10 - WrapperStruct00.var_1_11) >= (WrapperStruct00.var_1_12 >> WrapperStruct00.var_1_13)) ? (((- 999999.75f) > WrapperStruct00.var_1_14) ? (WrapperStruct00.var_1_9 == ((signed char) (WrapperStruct00.var_1_13 + (max (WrapperStruct00.var_1_15 , WrapperStruct00.var_1_16))))) : 1) : 1)) && (WrapperStruct00.var_1_17 == ((signed char) 4))
;
}
int main(void) {
	isInitial = 1;
