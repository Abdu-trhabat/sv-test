...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch153stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_0 >= (var_1_6 + var_1_3)) {
...
int property(void) {
 return (((((var_1_2 ? ((((var_1_3 + var_1_4) << var_1_5) > var_1_6) ? (var_1_1 == ((double) var_1_7)) : (var_1_1 == ((double) (1.06 + ((((var_1_8) > (var_1_9)) ? (var_1_8) : (var_1_9))))))) : ((((var_1_9 + 255.72) / 128.5) < ((- var_1_8) * var_1_7)) ? (var_1_1 == ((double) var_1_9)) : (var_1_1 == ((double) var_1_7)))) && ((var_1_1 < (var_1_8 * ((((var_1_9) > (var_1_7)) ? (var_1_9) : (var_1_7))))) ? (var_1_10 == ((signed short int) (var_1_5 - (((((32476 - var_1_4)) < (8)) ? ((32476 - var_1_4)) : (8)))))) : 1)) && ((var_1_10 >= (var_1_6 + var_1_3)) ? (var_1_11 == ((signed char) ((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5))))) : (var_1_11 == ((signed char) var_1_5)))) && (((var_1_5 + var_1_4) < var_1_11) ? (var_1_12 == ((double) (var_1_13 + var_1_9))) : (var_1_12 == ((double) var_1_7)))) && ((var_1_11 <= var_1_4) ? ((! (var_1_6 <= var_1_5)) ? (((var_1_4 & var_1_5) >= var_1_6) ? (var_1_14 == ((signed char) var_1_5)) : 1) : 1) : 1)) && (((var_1_16 - (var_1_17 - var_1_5)) <= var_1_11) ? (var_1_15 == ((signed long int) var_1_14)) : 1)
;
}
int main(void) {
 isInitial = 1;
