...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch151Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch151Amount50
	if ((32.4 == var_1_8) || ((var_1_5 > var_1_6) && var_1_2)) {
		var_1_1 = (abs (var_1_7));
	} else {
		var_1_1 = (max (var_1_7 , 200));
	}


	// From: Req4Batch151Amount50
	if (var_1_2) {
		var_1_13 = (max ((var_1_12 + (var_1_14 - var_1_15)) , (var_1_23 + (var_1_16 + var_1_17))));
	} else {
		if (var_1_3) {
			var_1_13 = var_1_7;
		} else {
	...
	// From: Req5Batch151Amount50
	if ((var_1_17 >= var_1_1) && var_1_3) {
		var_1_18 = (min (var_1_19 , ((var_1_20 + var_1_21) - var_1_22)));
	}


	// From: Req3Batch151Amount50
	unsigned char stepLocal_2 = var_1_3;
	unsigned long int stepLocal_1 = max (2u , var_1_11);
	if (stepLocal_2 || ((min (var_1_6 , var_1_5)) <= var_1_13)) {
...
int property(void) {
	return (((((((32.4 == var_1_8) || ((var_1_5 > var_1_6) && var_1_2)) ? (var_1_1 == ((signed long int) (abs (var_1_7)))) : (var_1_1 == ((signed long int) (max (var_1_7 , 200))))) && ((var_1_7 < var_1_5) ? (var_1_8 == ((double) var_1_9)) : 1)) && ((var_1_3 || ((min (var_1_6 , var_1_5)) <= var_1_13)) ? ((((var_1_5 + var_1_6) + var_1_13) <= (max (2u , var_1_11))) ? (var_1_10 == ((signed char) 10)) : (var_1_10 == ((signed char) var_1_12))) : (var_1_10 == ((signed char) var_1_12)))) && (var_1_2 ? (var_1_13 == ((signed long int) (max ((var_1_12 + (var_1_14 - var_1_15)) , (var_1_23 + (var_1_16 + var_1_17)))))) : (var_1_3 ? (var_1_13 == ((signed long int) var_1_7)) : (var_1_13 == ((signed long int) var_1_12))))) && (((var_1_17 >= var_1_1) && var_1_3) ? (var_1_18 == ((unsigned short int) (min (var_1_19 , ((var_1_20 + var_1_21) - var_1_22))))) : 1)) && ((9.99999999999925E12 <= var_1_8) ? (((- var_1_8) == var_1_8) ? (var_1_23 == ((unsigned char) (var_1_24 - (max (var_1_25 , var_1_26))))) : (var_1_23 == ((unsigned char) var_1_25))) : (var_1_23 == ((unsigned char) var_1_25)))
;
}
int main(void) {
	isInitial = 1;
