...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch186Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned char stepLocal_3 = (( ((var_1_10) > (var_1_17))) && (var_1_19));
  ...
  var_1_22
                  ...
                  if ( (( (( ((((var_1_2) < 0 ) ? -(var_1_2) : (var_1_2)))) * (var_1_20))) <= (var_1_17))) {
                   var_1_29 = (
   var_1_6
  );
 }
