...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14525_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch14525_while
	if ((var_1_2 + var_1_3) <= var_1_4) {
		var_1_1 = ((var_1_5 + (var_1_6 + var_1_7)) - var_1_8);
	}


	// From: Req2Batch14525_while
	signed long int stepLocal_1 = (min (var_1_1 , -25)) / var_1_7;
...
int property(void) {
	return ((((var_1_2 + var_1_3) <= var_1_4) ? (var_1_1 == ((unsigned short int) ((var_1_5 + (var_1_6 + var_1_7)) - var_1_8))) : 1) && ((((10 > var_1_10) && var_1_11) || var_1_12) ? ((((min (var_1_1 , -25)) / var_1_7) >= (var_1_8 + var_1_10)) ? (var_1_9 == ((signed long int) -100)) : 1) : (var_1_9 == ((signed long int) var_1_13)))) && ((var_1_9 < (var_1_7 | var_1_9)) ? (var_1_14 == ((unsigned char) var_1_15)) : (((var_1_7 >> var_1_16) >= var_1_9) ? (var_1_14 == ((unsigned char) var_1_15)) : 1))
;
}
int main(void) {
	isInitial = 1;
