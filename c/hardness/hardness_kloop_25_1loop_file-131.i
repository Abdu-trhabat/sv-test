...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13125_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((- var_1_4) < (((((var_1_2 + var_1_5)) < (var_1_6)) ? ((var_1_2 + var_1_5)) : (var_1_6)))) {
  var_1_14 = var_1_12;
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((~ (var_1_2 * var_1_3)) < (var_1_4 / ((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6))))) ? (var_1_1 == ((unsigned char) (! var_1_7))) : 1) && ((var_1_5 > var_1_4) ? (var_1_8 == ((unsigned char) (var_1_9 && (! var_1_7)))) : (var_1_8 == ((unsigned char) var_1_7)))) && (var_1_9 ? (var_1_10 == ((signed char) (var_1_11 + -25))) : (var_1_10 == ((signed char) (var_1_11 + (var_1_12 + var_1_13)))))) && (((- var_1_4) < (((((var_1_2 + var_1_5)) < (var_1_6)) ? ((var_1_2 + var_1_5)) : (var_1_6)))) ? (var_1_14 == ((signed long int) var_1_12)) : 1)
;
}
int main(void) {
 isInitial = 1;
