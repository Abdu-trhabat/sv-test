...
void step(void) {
	...
	if ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) > stepLocal_2) {
		if ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) < ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))) {
			(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = (abs ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer))));
		} else {
	...
	if ((min (-25 , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)))) != stepLocal_0) {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
		...
		(*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) = (min ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) , (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))));
	}
}
