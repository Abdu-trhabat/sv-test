...
void step(void) {
	...
	if ((max (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var6_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var5_Pointer))) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)))) <= (min (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer))) , ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) % (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))))) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)) = (min (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))));
	}
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) || stepLocal_0) {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) = (abs (1 - (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))));
	} else {
	...
	if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) <= stepLocal_1) {
		(*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) = (min ((max ((min ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)))) , (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)))) , (max (3.6 , (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer))))));
	} else {
