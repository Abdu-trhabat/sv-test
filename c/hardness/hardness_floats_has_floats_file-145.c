...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch145has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch145has_floats
	unsigned short int stepLocal_2 = var_1_8;
	if (stepLocal_2 > (var_1_17 * (var_1_1 + var_1_7))) {
		var_1_13 = (max ((var_1_14 - var_1_15) , var_1_16));
	} else {
		var_1_13 = (min (var_1_16 , var_1_15));
	}
}
...
int property(void) {
	return (((((var_1_2 + var_1_3) <= var_1_4) ? (var_1_1 == ((unsigned short int) ((var_1_5 + (var_1_6 + var_1_7)) - var_1_8))) : 1) && ((((10 > last_1_var_1_17) && var_1_11) || var_1_12) ? ((var_1_5 >= last_1_var_1_17) ? (var_1_9 == ((signed long int) var_1_8)) : 1) : (var_1_9 == ((signed long int) last_1_var_1_17)))) && ((var_1_8 > (var_1_17 * (var_1_1 + var_1_7))) ? (var_1_13 == ((double) (max ((var_1_14 - var_1_15) , var_1_16)))) : (var_1_13 == ((double) (min (var_1_16 , var_1_15)))))) && (((max (var_1_9 , (var_1_9 ^ var_1_5))) >= var_1_1) ? (var_1_17 == ((signed long int) (var_1_6 + var_1_5))) : (var_1_17 == ((signed long int) var_1_5)))
;
}
int main(void) {
	isInitial = 1;
