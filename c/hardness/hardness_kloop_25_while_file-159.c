...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15925_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch15925_while
	if (! var_1_5) {
		var_1_7 = (var_1_8 - var_1_9);
	}


	// From: Req4Batch15925_while
