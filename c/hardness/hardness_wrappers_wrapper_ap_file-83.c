...
void step(void) {
	...
	signed long int stepLocal_0 = min (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) * (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer))) , (~ (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))));
	...
	if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) <= stepLocal_1) {
		if ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) == stepLocal_2) {
			(*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) = ((abs ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) + (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)));
		} else {
	...
	if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) > (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) {
		(*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) = (min ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))));
	}
