...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch32no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_4 <= stepLocal_2) {
		if (var_1_1 < stepLocal_1) {
			...
			var_1_11 = (max (((var_1_8 + var_1_3) - var_1_12) , 100));
		}
	} else {
		var_1_11 = var_1_7;
	}
...
int property(void) {
	return (((last_1_var_1_6 >= -50) ? (var_1_1 == ((unsigned short int) (max ((var_1_3 + (abs (var_1_4))) , var_1_5)))) : 1) && (((var_1_7 - var_1_8) < var_1_1) ? (var_1_9 ? (var_1_6 == ((signed short int) var_1_8)) : (var_1_10 ? (var_1_6 == ((signed short int) var_1_7)) : 1)) : 1)) && ((var_1_4 <= (var_1_6 + var_1_3)) ? ((var_1_1 < (var_1_7 + (4 - var_1_3))) ? (var_1_9 ? (var_1_11 == ((signed long int) (var_1_3 - (var_1_12 - (var_1_13 - var_1_4))))) : 1) : (var_1_11 == ((signed long int) (max (((var_1_8 + var_1_3) - var_1_12) , 100))))) : (var_1_11 == ((signed long int) var_1_7)))
;
}
int main(void) {
	isInitial = 1;
