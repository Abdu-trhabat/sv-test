...
void step(void) {
	...
	// From: Req3Batch124Wrapper_AP
	unsigned long int stepLocal_1 = max ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) , (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)));
	if ((abs ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)))) < stepLocal_1) {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) = (((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) - (*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer))) - (abs ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))));
	}


	// From: Req5Batch124Wrapper_AP
	(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) = 16;


	// From: Req4Batch124Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) > 99.4) {
			if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) >= (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer))) {
				(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) = (min ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) , 256));
			}
		}
	}
}
