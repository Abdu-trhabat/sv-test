...
void step(void) {
	// From: Req1Batch127Wrapper_AP
	if ((max (0u , (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)))) > (~ (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)))) {
	...
	if ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) > (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) = (max ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))));
	} else {
