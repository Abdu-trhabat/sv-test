...
void step(void) {
	// From: Req2Batch6Wrapper_A
	if ((signed_char_Array_0[0] >> (signed_long_int_Array_0[1] + signed_long_int_Array_0[0])) >= (max ((last_1_unsigned_long_int_Array_0_2_ + signed_long_int_Array_0[2]) , unsigned_short_int_Array_0[2]))) {
	...
	// From: Req3Batch6Wrapper_A
	if ((- double_Array_0[1]) != double_Array_0[0]) {
		unsigned_long_int_Array_0[1] = (unsigned_long_int_Array_0[0] - (unsigned_short_int_Array_0[1] + (min (unsigned_short_int_Array_0[0] , unsigned_short_int_Array_0[2]))));
	}


	// From: Req1Batch6Wrapper_A
	unsigned long int stepLocal_1 = (max (unsigned_long_int_Array_0[1] , unsigned_short_int_Array_0[0])) / unsigned_short_int_Array_0[1];
...
int property(void) {
	return ((((((max (unsigned_long_int_Array_0[1] , unsigned_short_int_Array_0[0])) / unsigned_short_int_Array_0[1]) > unsigned_long_int_Array_0[1]) ? ((unsigned_long_int_Array_0[1] == unsigned_short_int_Array_0[0]) ? (unsigned_long_int_Array_0[2] == ((unsigned long int) 1000000000u)) : (unsigned_long_int_Array_0[2] == ((unsigned long int) 128u))) : 1) && (((signed_char_Array_0[0] >> (signed_long_int_Array_0[1] + signed_long_int_Array_0[0])) >= (max ((last_1_unsigned_long_int_Array_0_2_ + signed_long_int_Array_0[2]) , unsigned_short_int_Array_0[2]))) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) signed_long_int_Array_0[1])) : ((unsigned_short_int_Array_0[1] < 64) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) signed_char_Array_0[0])) : 1))) && (((- double_Array_0[1]) != double_Array_0[0]) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) (unsigned_long_int_Array_0[0] - (unsigned_short_int_Array_0[1] + (min (unsigned_short_int_Array_0[0] , unsigned_short_int_Array_0[2])))))) : 1)) && ((signed_long_int_Array_0[0] == (unsigned_short_int_Array_0[1] | -5)) ? (float_Array_0[0] == ((float) (max (1.5f , float_Array_0[1])))) : 1)
;
}
int main(void) {
	isInitial = 1;
