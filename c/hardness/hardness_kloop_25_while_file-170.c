...
void step(void) {
	...
	// From: Req3Batch17025_while
	if (var_1_4) {
		var_1_10 = (var_1_8 - var_1_7);
	}


	// From: Req1Batch17025_while
	unsigned char stepLocal_0 = ! var_1_4;
	if ((var_1_7 != (min (var_1_10 , 64))) || stepLocal_0) {
		var_1_1 = var_1_5;
	} else {
		var_1_1 = var_1_6;
	}
...
int property(void) {
	return (((((var_1_7 != (min (var_1_10 , 64))) || (! var_1_4)) ? (var_1_1 == ((unsigned long int) var_1_5)) : (var_1_1 == ((unsigned long int) var_1_6))) && ((var_1_5 > var_1_6) ? ((last_1_var_1_10 > var_1_5) ? (var_1_7 == ((unsigned char) var_1_8)) : (var_1_7 == ((unsigned char) (max (var_1_8 , var_1_9))))) : (var_1_7 == ((unsigned char) var_1_8)))) && (var_1_4 ? (var_1_10 == ((signed long int) (var_1_8 - var_1_7))) : 1)) && ((! var_1_4) ? (var_1_11 == ((float) (2.5f + (5.8f + var_1_12)))) : (var_1_11 == ((float) (max (var_1_12 , var_1_13)))))
;
}
int main(void) {
	isInitial = 1;
