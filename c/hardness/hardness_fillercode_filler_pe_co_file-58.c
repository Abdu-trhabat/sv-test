...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch58Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch58Filler_PE_CO
	/* 1363L, 240L, 965L, 973L) */ var_1_18 = (
		var_1_1
	);


	// From: Req2Batch58Filler_PE_CO
	...
	// From: CodeObject2
	/* 403L, 227L) */ if (/* 404L, 154L, 155L) */ ((/* 405L, 152L, 156L) */ ((var_1_17) / (var_1_24))) <= (var_1_15))) {
		/* 409L, 221L) */ if (/* 410L, 170L, 171L) */ ((/* 411L, 168L, 172L) */ (~ (/* 412L, 167L, 173L) */ ((var_1_26) - (var_1_27))))) < (var_1_17))) {
	...
	/* 436L, 284L) */ if (/* 437L, 240L, 241L) */ ((var_1_14) < (/* 439L, 239L, 243L) */ (min (/* 439L, 239L, 243L) */ (/* 440L, 237L, 244L) */ ((var_1_27) >> (var_1_30))) , (var_1_24)))))) {
		/* 444L, 282L) */ if (/* 445L, 259L, 260L) */ ((var_1_22) || (/* 447L, 258L, 262L) */ ((var_1_19) && (var_1_10))))) {
			/* 450L, 275L) */ var_1_29 = (
				/* 453L, 274L) */ ((
					var_1_26
				) - (
	...
	/* 462L, 331L) */ if (/* 463L, 290L, 291L) */ ((var_1_27) < (var_1_17))) {
		/* 466L, 325L) */ if (/* 467L, 304L, 305L) */ ((/* 468L, 299L, 306L) */ ((var_1_27) >= (var_1_30))) && (/* 471L, 303L, 309L) */ ((var_1_15) <= (/* 473L, 302L, 311L) */ (abs (var_1_17))))))) {
			/* 475L, 324L) */ var_1_32 = (
				var_1_33
			);
		}
	...
	// From: CodeObject5
	/* 483L, 347L) */ if (var_1_10) {
		/* 485L, 345L) */ if (var_1_22) {
			/* 487L, 344L) */ var_1_35 = (
				var_1_27
			);
		}
