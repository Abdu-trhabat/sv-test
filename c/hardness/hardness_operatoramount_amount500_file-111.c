...
void step(void) {
	...
	if (last_1_var_1_66 > var_1_42) {
		if (stepLocal_15 == last_1_var_1_43) {
			if ((var_1_31 - (var_1_35 - var_1_28)) >= stepLocal_14) {
				if (stepLocal_16 >= (min (var_1_8 , (var_1_30 - var_1_35)))) {
					var_1_43 = (-8 + var_1_13);
				}
			} else {
				if (stepLocal_13 >= var_1_31) {
					if (last_1_var_1_71 && stepLocal_12) {
						var_1_43 = ((abs (var_1_33 + var_1_13)) + var_1_46);
					}
				} else {
			...
			var_1_43 = (var_1_10 + ((min (last_1_var_1_74 , var_1_17)) + var_1_47));
		}
	} else {
	...
	// From: Req22Batch111Amount500
	if ((last_1_var_1_102 / (max (var_1_49 , var_1_63))) != last_1_var_1_102) {
	...
	// From: Req14Batch111Amount500
	if (var_1_104) {
		var_1_56 = (var_1_11 + var_1_12);
	}


	// From: Req2Batch111Amount500
	...
	// From: Req17Batch111Amount500
	if (var_1_54 <= 50.8f) {
		var_1_62 = ((var_1_63 - var_1_64) - var_1_41);
	}


	// From: Req19Batch111Amount500
	var_1_66 = var_1_54;


	// From: Req26Batch111Amount500
	if (var_1_26) {
		var_1_78 = var_1_33;
	} else {
		var_1_78 = ((var_1_28 + (abs (var_1_44))) + var_1_32);
	}


	// From: Req27Batch111Amount500
	if (var_1_62 < var_1_49) {
		var_1_79 = (var_1_32 + (min (var_1_31 , var_1_44)));
	}


	// From: Req29Batch111Amount500
	if (var_1_104) {
		if ((64.75f * var_1_54) < var_1_42) {
			var_1_81 = (var_1_14 + (max (var_1_68 , var_1_83)));
		}
	}


	// From: Req36Batch111Amount500
	var_1_94 = var_1_20;


	// From: Req38Batch111Amount500
	var_1_96 = var_1_81;


	// From: Req39Batch111Amount500
	var_1_97 = var_1_31;


	// From: Req40Batch111Amount500
	var_1_98 = var_1_26;


	// From: Req41Batch111Amount500
	var_1_99 = var_1_42;


	// From: Req42Batch111Amount500
	var_1_100 = var_1_69;


	// From: Req43Batch111Amount500
	var_1_101 = var_1_35;


	// From: Req45Batch111Amount500
	var_1_103 = var_1_41;


	// From: Req48Batch111Amount500
	if (var_1_71) {
		var_1_106 = var_1_64;
	} else {
		var_1_106 = var_1_54;
	...
	// From: Req21Batch111Amount500
	signed long int stepLocal_21 = abs (4 * var_1_8);
	...
	// From: Req4Batch111Amount500
	var_1_22 = (var_1_11 + var_1_94);


	// From: Req10Batch111Amount500
	...
	if (var_1_16 > stepLocal_11) {
		...
		if (var_1_7 >= stepLocal_10) {
			var_1_38 = (max ((min (var_1_40 , (var_1_41 - var_1_39))) , var_1_42));
		} else {
			var_1_38 = (min (var_1_40 , var_1_42));
		}
	}


	// From: Req35Batch111Amount500
	if (var_1_98) {
		var_1_93 = var_1_35;
	} else {
		var_1_93 = var_1_28;
	...
	// From: Req37Batch111Amount500
	if (var_1_98) {
		var_1_95 = var_1_73;
	}


	// From: Req18Batch111Amount500
	...
	if (stepLocal_19 <= var_1_21) {
		if (var_1_60) {
			...
			if (var_1_43 < stepLocal_18) {
				var_1_65 = (max (64 , var_1_46));
			} else {
				var_1_65 = (var_1_34 + var_1_18);
			}
		}
	} else {
		var_1_65 = (min (var_1_35 , var_1_47));
	}


	// From: Req15Batch111Amount500
	if ((min ((var_1_38 * var_1_40) , var_1_42)) > (min ((min (var_1_49 , var_1_66)) , var_1_54))) {
		if (var_1_16 < (min ((abs (var_1_20)) , var_1_95))) {
			if ((abs (var_1_91 / var_1_21)) > ((4u >> var_1_28) * var_1_44)) {
				if ((var_1_58 - (abs (var_1_16))) <= var_1_20) {
		...
		if (var_1_71) {
			...
			var_1_57 = (((-128 * var_1_18) == (abs (var_1_10))) || (var_1_60 && var_1_26));
		}
	}


	// From: Req13Batch111Amount500
	...
	// From: Req20Batch111Amount500
	signed long int stepLocal_20 = var_1_100 / var_1_34;
	if (var_1_16 > stepLocal_20) {
		if (var_1_71) {
			if (((min (var_1_66 , var_1_40)) + var_1_41) != (var_1_38 * var_1_39)) {
				var_1_67 = (var_1_35 + (abs (var_1_44)));
			}
		} else {
			if (! ((var_1_22 * var_1_100) > var_1_93)) {
				var_1_67 = ((max ((var_1_20 + var_1_21) , var_1_68)) - var_1_69);
			}
		}
	}


	// From: Req30Batch111Amount500
	if ((- var_1_73) <= (var_1_34 * (var_1_85 - var_1_12))) {
		var_1_84 = (min ((abs (1)) , (1 + var_1_44)));
	} else {
		if (var_1_28 == ((var_1_33 + var_1_95) / var_1_12)) {
			var_1_84 = (max (var_1_34 , (min (var_1_33 , var_1_28))));
		} else {
			var_1_84 = (var_1_30 - (min (var_1_28 , (var_1_44 + var_1_32))));
		}
	}


	// From: Req5Batch111Amount500
	...
	// From: Req6Batch111Amount500
	signed short int stepLocal_6 = var_1_12;
	if (stepLocal_6 > (abs (1))) {
		var_1_25 = ((var_1_11 >= var_1_23) || var_1_26);
	}


	// From: Req44Batch111Amount500
	if (var_1_25) {
		var_1_102 = var_1_63;
	}


	// From: Req23Batch111Amount500
	if (1.5 >= (min (var_1_54 , var_1_102))) {
		var_1_72 = ((abs (var_1_13)) - ((abs (var_1_73)) - var_1_16));
	} else {
		var_1_72 = (abs (var_1_7));
	}


	// From: Req47Batch111Amount500
	if (var_1_25) {
		var_1_105 = var_1_26;
	} else {
		var_1_105 = var_1_59;
	...
	// From: Req1Batch111Amount500
	signed long int stepLocal_2 = var_1_9 - (max (var_1_12 , var_1_10));
	unsigned char stepLocal_1 = var_1_98;
	signed long int stepLocal_0 = 2;
	if (var_1_70 == var_1_102) {
		if ((min (var_1_36 , last_1_var_1_1)) > stepLocal_0) {
	...
	// From: Req3Batch111Amount500
	if (var_1_105) {
		var_1_19 = ((var_1_20 + var_1_21) - var_1_16);
	}


	// From: Req12Batch111Amount500
		...
		if (((9.180583557610914E18f - var_1_54) - var_1_41) > (var_1_38 * var_1_40)) {
			if (var_1_71) {
				if (((var_1_54 * var_1_42) / var_1_49) >= (var_1_70 * 15.75)) {
					...
					var_1_48 = (max (var_1_50 , 1));
				}
			} else {
				if (stepLocal_17 >= var_1_46) {
					var_1_48 = (abs (var_1_72));
				} else {
					var_1_48 = (max ((-256 + var_1_72) , (min (var_1_31 , var_1_14))));
				}
			}
		} else {
			var_1_48 = var_1_101;
	...
	// From: Req49Batch111Amount500
	var_1_107 = ((var_1_86 - var_1_31) + (var_1_20 - var_1_36));


	// From: Req33Batch111Amount500
	if (var_1_75 < var_1_36) {
		var_1_88 = (min (var_1_89 , var_1_13));
	} else {
		if ((- (- var_1_66)) > (var_1_42 * (max (var_1_40 , var_1_49)))) {
			if (var_1_26 && var_1_98) {
				var_1_88 = (var_1_101 + (min (0 , -10)));
			} else {
				var_1_88 = (var_1_68 + (abs (var_1_101)));
			}
		} else {
			if (last_1_var_1_88 >= ((var_1_34 + var_1_16) >> var_1_28)) {
				...
				if ((var_1_107 / var_1_50) > var_1_11) {
					...
					var_1_88 = (max (((var_1_48 - var_1_101) + var_1_17) , var_1_89));
				}
			}
		}
	}
	...
	// From: Req50Batch111Amount500
	signed long int stepLocal_31 = 1 | var_1_69;
	signed long int stepLocal_30 = max (4 , var_1_88);
	...
	// From: Req28Batch111Amount500
	signed long int stepLocal_25 = abs (var_1_8);
	if (var_1_88 <= stepLocal_25) {
		var_1_80 = var_1_76;
	}


	// From: Req25Batch111Amount500
	...
	if ((last_1_var_1_77 + (var_1_11 - var_1_108)) > stepLocal_23) {
		...
		if (var_1_59) {
			var_1_77 = ((var_1_13 - var_1_68) + ((min (var_1_18 , -128)) + var_1_21));
		} else {
			var_1_77 = var_1_7;
		}
	}
	...
	// From: Req16Batch111Amount500
	if (var_1_59) {
		if (((var_1_44 + var_1_95) & var_1_33) > (var_1_53 * (var_1_10 * var_1_20))) {
			if ((min (var_1_95 , var_1_11)) < var_1_33) {
				var_1_61 = var_1_80;
			} else {
				var_1_61 = var_1_46;
			}
		} else {
			var_1_61 = (max (var_1_91 , -16));
		}
	} else {
		var_1_61 = (abs (var_1_65));
	}


	// From: Req24Batch111Amount500
	...
	if ((var_1_74 * (var_1_86 + var_1_16)) >= (var_1_11 >> var_1_28)) {
		if (! (var_1_74 < var_1_9)) {
			...
			if (var_1_95 >= var_1_20) {
				...
				if (var_1_16 <= var_1_17) {
					...
					var_1_27 = ((abs (var_1_86)) + var_1_16);
				}
			}
		}
	} else {
		if (var_1_71) {
			...
			var_1_27 = (max (var_1_16 , var_1_13));
		}
	}


	// From: Req8Batch111Amount500
	...
	if (var_1_105) {
		if (stepLocal_7 > var_1_74) {
			if (stepLocal_8 > (var_1_7 / var_1_21)) {
				var_1_29 = ((var_1_31 + (var_1_32 - var_1_28)) - (max (var_1_30 , var_1_33)));
			} else {
			...
			if ((- (var_1_21 * var_1_11)) != stepLocal_9) {
				...
				var_1_29 = (min (var_1_31 , var_1_32));
			}
		}
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((var_1_70 == var_1_102) ? (((min (var_1_36 , last_1_var_1_1)) > 2) ? (((4.25 <= var_1_102) || var_1_98) ? (var_1_1 == ((signed short int) (var_1_7 + var_1_8))) : (var_1_1 == ((signed short int) (8 - (var_1_9 + (min (50 , var_1_10))))))) : (var_1_1 == ((signed short int) (var_1_10 - ((max (var_1_11 , 21328)) - (var_1_12 - var_1_13)))))) : (((var_1_9 - (max (var_1_12 , var_1_10))) <= var_1_8) ? (var_1_1 == ((signed short int) ((min (var_1_9 , var_1_14)) + var_1_8))) : 1)) && (((var_1_7 * (2 - var_1_9)) <= (var_1_13 - (var_1_12 + 1))) ? (var_1_15 == ((unsigned char) (min ((var_1_16 + var_1_17) , var_1_18)))) : 1)) && (var_1_105 ? (var_1_19 == ((unsigned char) ((var_1_20 + var_1_21) - var_1_16))) : 1)) && (var_1_22 == ((unsigned long int) (var_1_11 + var_1_94)))) && ((var_1_11 >= (var_1_10 & var_1_43)) ? ((var_1_104 || var_1_57) ? (var_1_23 == ((signed long int) (max (var_1_8 , var_1_7)))) : 1) : (var_1_23 == ((signed long int) (var_1_8 + var_1_16))))) && ((var_1_12 > (abs (1))) ? (var_1_25 == ((unsigned char) ((var_1_11 >= var_1_23) || var_1_26))) : 1)) && (((var_1_74 * (var_1_86 + var_1_16)) >= (var_1_11 >> var_1_28)) ? ((! (var_1_74 < var_1_9)) ? (var_1_27 == ((signed short int) var_1_17)) : ((var_1_95 >= var_1_20) ? (var_1_27 == ((signed short int) (var_1_28 - var_1_10))) : ((var_1_16 <= var_1_17) ? (var_1_27 == ((signed short int) (-32 + var_1_8))) : (var_1_27 == ((signed short int) ((abs (var_1_86)) + var_1_16)))))) : (var_1_71 ? (var_1_27 == ((signed short int) ((var_1_11 - var_1_20) - (var_1_21 + 64)))) : (var_1_27 == ((signed short int) (max (var_1_16 , var_1_13))))))) && (var_1_105 ? ((var_1_36 > var_1_74) ? ((var_1_9 > (var_1_7 / var_1_21)) ? (var_1_29 == ((signed char) ((var_1_31 + (var_1_32 - var_1_28)) - (max (var_1_30 , var_1_33))))) : (var_1_29 == ((signed char) ((var_1_34 - 4) - (var_1_35 - var_1_30))))) : (((- (var_1_21 * var_1_11)) != var_1_35) ? (var_1_29 == ((signed char) var_1_28)) : (var_1_29 == ((signed char) (min (var_1_31 , var_1_32)))))) : 1)) && (((last_1_var_1_105 || (var_1_7 <= last_1_var_1_100)) || (var_1_34 <= var_1_32)) ? ((! var_1_26) ? (var_1_36 == ((unsigned long int) ((var_1_11 + var_1_28) + var_1_20))) : (var_1_36 == ((unsigned long int) var_1_18))) : (var_1_36 == ((unsigned long int) (var_1_28 + var_1_30))))) && ((var_1_16 > var_1_33) ? (var_1_38 == ((double) (var_1_39 - var_1_40))) : ((var_1_7 >= var_1_22) ? (var_1_38 == ((double) (max ((min (var_1_40 , (var_1_41 - var_1_39))) , var_1_42)))) : (var_1_38 == ((double) (min (var_1_40 , var_1_42))))))) && ((last_1_var_1_66 > var_1_42) ? ((var_1_31 == last_1_var_1_43) ? (((var_1_31 - (var_1_35 - var_1_28)) >= (var_1_20 >> var_1_44)) ? ((var_1_34 >= (min (var_1_8 , (var_1_30 - var_1_35)))) ? (var_1_43 == ((signed short int) (-8 + var_1_13))) : 1) : ((((max (last_1_var_1_74 , var_1_10)) / 32) >= var_1_31) ? ((last_1_var_1_71 && last_1_var_1_57) ? (var_1_43 == ((signed short int) ((abs (var_1_33 + var_1_13)) + var_1_46))) : 1) : (var_1_43 == ((signed short int) (((var_1_30 + var_1_17) + var_1_21) - (var_1_12 + (var_1_34 + var_1_31))))))) : (var_1_43 == ((signed short int) (var_1_10 + ((min (last_1_var_1_74 , var_1_17)) + var_1_47))))) : (var_1_43 == ((signed short int) (var_1_17 + var_1_20))))) && (((var_1_42 / var_1_49) < var_1_38) ? (var_1_48 == ((signed long int) ((var_1_50 - (var_1_51 - var_1_12)) - ((var_1_52 + var_1_53) - var_1_32)))) : ((((9.180583557610914E18f - var_1_54) - var_1_41) > (var_1_38 * var_1_40)) ? (var_1_71 ? ((((var_1_54 * var_1_42) / var_1_49) >= (var_1_70 * 15.75)) ? (var_1_48 == ((signed long int) (var_1_18 - (var_1_28 + (32 + 64))))) : (var_1_48 == ((signed long int) (max (var_1_50 , 1))))) : ((var_1_50 >= var_1_46) ? (var_1_48 == ((signed long int) (abs (var_1_72)))) : (var_1_48 == ((signed long int) (max ((-256 + var_1_72) , (min (var_1_31 , var_1_14)))))))) : (var_1_48 == ((signed long int) var_1_101))))) && ((var_1_96 >= (var_1_95 / var_1_21)) ? ((! var_1_26) ? (var_1_55 == ((signed char) (var_1_44 + var_1_31))) : 1) : (var_1_55 == ((signed char) (-16 + var_1_31))))) && (var_1_104 ? (var_1_56 == ((unsigned short int) (var_1_11 + var_1_12))) : 1)) && (((min ((var_1_38 * var_1_40) , var_1_42)) > (min ((min (var_1_49 , var_1_66)) , var_1_54))) ? ((var_1_16 < (min ((abs (var_1_20)) , var_1_95))) ? (((abs (var_1_91 / var_1_21)) > ((4u >> var_1_28) * var_1_44)) ? (((var_1_58 - (abs (var_1_16))) <= var_1_20) ? (var_1_57 == ((unsigned char) ((! var_1_26) || var_1_59))) : 1) : 1) : (var_1_57 == ((unsigned char) ((var_1_59 || (! var_1_26)) || (! 1))))) : (var_1_71 ? (var_1_57 == ((unsigned char) (var_1_26 && var_1_60))) : (var_1_57 == ((unsigned char) (((-128 * var_1_18) == (abs (var_1_10))) || (var_1_60 && var_1_26))))))) && (var_1_59 ? ((((var_1_44 + var_1_95) & var_1_33) > (var_1_53 * (var_1_10 * var_1_20))) ? (((min (var_1_95 , var_1_11)) < var_1_33) ? (var_1_61 == ((signed long int) var_1_80)) : (var_1_61 == ((signed long int) var_1_46))) : (var_1_61 == ((signed long int) (max (var_1_91 , -16))))) : (var_1_61 == ((signed long int) (abs (var_1_65)))))) && ((var_1_54 <= 50.8f) ? (var_1_62 == ((float) ((var_1_63 - var_1_64) - var_1_41))) : 1)) && ((var_1_18 <= var_1_21) ? (var_1_60 ? (var_1_65 == ((signed short int) (var_1_17 - var_1_10))) : ((var_1_43 < var_1_95) ? (var_1_65 == ((signed short int) (max (64 , var_1_46)))) : (var_1_65 == ((signed short int) (var_1_34 + var_1_18))))) : (var_1_65 == ((signed short int) (min (var_1_35 , var_1_47)))))) && (var_1_66 == ((double) var_1_54))) && ((var_1_16 > (var_1_100 / var_1_34)) ? (var_1_71 ? ((((min (var_1_66 , var_1_40)) + var_1_41) != (var_1_38 * var_1_39)) ? (var_1_67 == ((unsigned char) (var_1_35 + (abs (var_1_44))))) : 1) : ((! ((var_1_22 * var_1_100) > var_1_93)) ? (var_1_67 == ((unsigned char) ((max ((var_1_20 + var_1_21) , var_1_68)) - var_1_69))) : 1)) : 1)) && ((var_1_43 <= (abs (4 * var_1_8))) ? (var_1_98 ? (var_1_70 == ((double) var_1_64)) : 1) : 1)) && (((last_1_var_1_102 / (max (var_1_49 , var_1_63))) != last_1_var_1_102) ? (var_1_71 == ((unsigned char) ((last_1_var_1_25 && var_1_60) && var_1_59))) : (var_1_71 == ((unsigned char) (! (! var_1_59)))))) && ((1.5 >= (min (var_1_54 , var_1_102))) ? (var_1_72 == ((signed short int) ((abs (var_1_13)) - ((abs (var_1_73)) - var_1_16)))) : (var_1_72 == ((signed short int) (abs (var_1_7)))))) && ((var_1_12 <= (var_1_61 / var_1_75)) ? (var_1_74 == ((unsigned short int) ((var_1_76 - var_1_31) - var_1_34))) : 1)) && (((last_1_var_1_77 + (var_1_11 - var_1_108)) > var_1_96) ? (((var_1_34 > var_1_87) || var_1_59) ? (var_1_77 == ((signed short int) ((var_1_10 + var_1_68) - var_1_44))) : 1) : (var_1_59 ? (var_1_77 == ((signed short int) ((var_1_13 - var_1_68) + ((min (var_1_18 , -128)) + var_1_21)))) : (var_1_77 == ((signed short int) var_1_7))))) && (var_1_26 ? (var_1_78 == ((signed char) var_1_33)) : (var_1_78 == ((signed char) ((var_1_28 + (abs (var_1_44))) + var_1_32))))) && ((var_1_62 < var_1_49) ? (var_1_79 == ((signed char) (var_1_32 + (min (var_1_31 , var_1_44))))) : 1)) && ((var_1_88 <= (abs (var_1_8))) ? (var_1_80 == ((unsigned long int) var_1_76)) : 1)) && (var_1_104 ? (((64.75f * var_1_54) < var_1_42) ? (var_1_81 == ((signed short int) (var_1_14 + (max (var_1_68 , var_1_83))))) : 1) : 1)) && (((- var_1_73) <= (var_1_34 * (var_1_85 - var_1_12))) ? (var_1_84 == ((signed char) (min ((abs (1)) , (1 + var_1_44))))) : ((var_1_28 == ((var_1_33 + var_1_95) / var_1_12)) ? (var_1_84 == ((signed char) (max (var_1_34 , (min (var_1_33 , var_1_28)))))) : (var_1_84 == ((signed char) (var_1_30 - (min (var_1_28 , (var_1_44 + var_1_32))))))))) && (((var_1_32 + var_1_33) < (var_1_44 * 1)) ? ((var_1_100 != var_1_73) ? (var_1_86 == ((signed long int) ((var_1_50 - var_1_12) - var_1_58))) : 1) : (var_1_86 == ((signed long int) (var_1_48 + var_1_31))))) && (((var_1_73 - var_1_33) > -256) ? (var_1_87 == ((signed short int) (var_1_88 - var_1_30))) : (((50 + (var_1_44 - var_1_21)) < (~ (-25 + var_1_10))) ? (var_1_87 == ((signed short int) (var_1_10 - 4))) : 1))) && ((var_1_75 < var_1_36) ? (var_1_88 == ((signed short int) (min (var_1_89 , var_1_13)))) : (((- (- var_1_66)) > (var_1_42 * (max (var_1_40 , var_1_49)))) ? ((var_1_26 && var_1_98) ? (var_1_88 == ((signed short int) (var_1_101 + (min (0 , -10))))) : (var_1_88 == ((signed short int) (var_1_68 + (abs (var_1_101)))))) : ((last_1_var_1_88 >= ((var_1_34 + var_1_16) >> var_1_28)) ? (var_1_88 == ((signed short int) (var_1_48 - var_1_68))) : (((var_1_107 / var_1_50) > var_1_11) ? (var_1_88 == ((signed short int) ((var_1_32 + var_1_9) - var_1_28))) : (var_1_88 == ((signed short int) (max (((var_1_48 - var_1_101) + var_1_17) , var_1_89))))))))) && (((var_1_17 == var_1_97) || (var_1_75 <= var_1_20)) ? ((((1000000000u << var_1_92) > var_1_36) || var_1_60) ? (var_1_91 == ((unsigned long int) var_1_30)) : (var_1_91 == ((unsigned long int) var_1_58))) : (var_1_91 == ((unsigned long int) var_1_56)))) && (var_1_98 ? (var_1_93 == ((unsigned short int) var_1_35)) : (var_1_93 == ((unsigned short int) var_1_28)))) && (var_1_94 == ((unsigned char) var_1_20))) && (var_1_98 ? (var_1_95 == ((unsigned long int) var_1_73)) : 1)) && (var_1_96 == ((unsigned short int) var_1_81))) && (var_1_97 == ((signed char) var_1_31))) && (var_1_98 == ((unsigned char) var_1_26))) && (var_1_99 == ((float) var_1_42))) && (var_1_100 == ((unsigned short int) var_1_69))) && (var_1_101 == ((unsigned char) var_1_35))) && (var_1_25 ? (var_1_102 == ((double) var_1_63)) : 1)) && (var_1_103 == ((float) var_1_41))) && (var_1_71 ? (var_1_104 == ((unsigned char) var_1_59)) : (var_1_104 == ((unsigned char) var_1_26)))) && (var_1_25 ? (var_1_105 == ((unsigned char) var_1_26)) : (var_1_105 == ((unsigned char) var_1_59)))) && (var_1_71 ? (var_1_106 == ((float) var_1_64)) : (var_1_106 == ((float) var_1_54)))) && (var_1_107 == ((signed long int) ((var_1_86 - var_1_31) + (var_1_20 - var_1_36))))) && ((var_1_75 >= (max (4 , var_1_88))) ? ((var_1_35 < (1 | var_1_69)) ? (var_1_108 == ((unsigned char) var_1_20)) : (var_1_108 == ((unsigned char) var_1_92))) : (var_1_108 == ((unsigned char) var_1_109)))
;
}
int main(void) {
	isInitial = 1;
