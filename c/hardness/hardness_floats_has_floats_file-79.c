...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch79has_floats.c", 13, "reach_error"); }
...
int property(void) {
	return ((((((! var_1_2) ? ((! var_1_2) ? (var_1_1 == ((signed char) (var_1_3 + -32))) : (var_1_1 == ((signed char) (var_1_4 - (min (var_1_5 , 16)))))) : 1) && (((max (var_1_5 , var_1_7)) <= (var_1_4 * (var_1_8 >> var_1_9))) ? (((- var_1_14) >= var_1_14) ? (var_1_6 == ((signed long int) var_1_4)) : (var_1_6 == ((signed long int) var_1_1))) : (var_1_6 == ((signed long int) var_1_9)))) && (((var_1_3 | var_1_6) > var_1_9) ? (var_1_12 == ((unsigned char) var_1_5)) : 1)) && (var_1_13 == ((signed short int) last_1_var_1_16))) && (var_1_14 == ((double) var_1_15))) && (var_1_16 == ((signed short int) (max ((var_1_13 + var_1_9) , (abs (var_1_3))))))
;
}
int main(void) {
	isInitial = 1;
