...
void step(void) {
 ...
 if (((*(var_1_15_Pointer)) % (((((*(var_1_3_Pointer))) > ((*(var_1_4_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_4_Pointer)))))) <= -1000000) {
