...
void step(void) {
	...
	// From: Req2Batch142Wrapper_P
	if (((*(var_1_7_Pointer)) - (*(var_1_8_Pointer))) <= 0) {
		(*(var_1_6_Pointer)) = (abs ((*(var_1_9_Pointer))));
	}


	// From: Req3Batch142Wrapper_P
	unsigned char stepLocal_0 = (*(var_1_11_Pointer));
	if (stepLocal_0 && (*(var_1_12_Pointer))) {
		(*(var_1_10_Pointer)) = (*(var_1_13_Pointer));
	} else {
		(*(var_1_10_Pointer)) = (min ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer))));
	}


	// From: Req4Batch142Wrapper_P
	unsigned long int stepLocal_1 = (*(var_1_2_Pointer));
	if (stepLocal_1 == (max ((*(var_1_7_Pointer)) , (*(var_1_5_Pointer))))) {
...
int property(void) {
	return ((((((*(var_1_2_Pointer)) <= (*(var_1_3_Pointer))) ? (((*(var_1_3_Pointer)) <= (*(var_1_2_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed long int) (1 - (*(var_1_4_Pointer))))) : ((*(var_1_1_Pointer)) == ((signed long int) ((*(var_1_4_Pointer)) - (*(var_1_5_Pointer)))))) : 1) && ((((*(var_1_7_Pointer)) - (*(var_1_8_Pointer))) <= 0) ? ((*(var_1_6_Pointer)) == ((double) (abs ((*(var_1_9_Pointer)))))) : 1)) && (((*(var_1_11_Pointer)) && (*(var_1_12_Pointer))) ? ((*(var_1_10_Pointer)) == ((signed short int) (*(var_1_13_Pointer)))) : ((*(var_1_10_Pointer)) == ((signed short int) (min ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))))))) && (((*(var_1_2_Pointer)) == (max ((*(var_1_7_Pointer)) , (*(var_1_5_Pointer))))) ? ((*(var_1_15_Pointer)) == ((double) ((*(var_1_16_Pointer)) + (*(var_1_17_Pointer))))) : ((*(var_1_15_Pointer)) == ((double) ((*(var_1_18_Pointer)) - (*(var_1_19_Pointer))))))) && (((*(var_1_19_Pointer)) <= (*(var_1_17_Pointer))) ? (((*(var_1_3_Pointer)) < (*(var_1_7_Pointer))) ? ((*(var_1_20_Pointer)) == ((double) 199.75)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
