...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch101Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 249L, 135L) */ if (/* 250L, 23L, 24L) */ ((var_1_26) >= (var_1_27))) {
		/* 253L, 133L) */ if (/* 254L, 38L, 39L) */ ((/* 255L, 34L, 40L) */ ((var_1_27) ^ (/* 257L, 33L, 42L) */ (min (/* 257L, 33L, 42L) */ (var_1_26) , (2u)))))) != (/* 260L, 37L, 45L) */ ((var_1_1) ^ (var_1_30))))) {
			/* 263L, 60L) */ var_1_29 = (
				var_1_31
			);
		} else {
			/* 267L, 131L) */ if (/* 268L, 63L, 64L) */ ((var_1_1) <= (var_1_31))) {
				/* 271L, 125L) */ if (/* 272L, 72L, 73L) */ ((var_1_26) >= (-256))) {
					/* 275L, 85L) */ var_1_29 = (
						/* 278L, 84L) */ (abs (
							/* 279L, 83L) */ (max (
								/* 279L, 83L) */ (
	...
	// From: CodeObject3
	/* 308L, 177L) */ if (/* 309L, 142L, 143L) */ (! (/* 310L, 141L, 144L) */ ((var_1_35) >= (var_1_26))))) {
		/* 313L, 175L) */ if (/* 314L, 155L, 156L) */ ((/* 315L, 153L, 157L) */ (abs (/* 316L, 152L, 158L) */ (abs (var_1_26))))) > (var_1_32))) {
			/* 319L, 170L) */ var_1_37 = (
				/* 322L, 169L) */ (abs (
					var_1_35
				))
	...
	// From: CodeObject5
	/* 333L, 210L) */ if (/* 334L, 193L, 194L) */ ((var_1_1) != (/* 336L, 192L, 196L) */ (min (/* 336L, 192L, 196L) */ (64) , (var_1_26)))))) {
		/* 339L, 209L) */ var_1_40 = (
			/* 342L, 208L) */ (abs (
				/* 343L, 207L) */ (abs (
					var_1_34
