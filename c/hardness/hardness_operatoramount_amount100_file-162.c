...
void step(void) {
	...
	// From: Req8Batch162Amount100
	if (! (last_1_var_1_24 >= 4)) {
		var_1_24 = last_1_var_1_24;
	}


	// From: Req7Batch162Amount100
	if (((abs (var_1_20)) - var_1_19) >= var_1_18) {
		if (var_1_20 < (min (var_1_1 , var_1_8))) {
			var_1_22 = var_1_1;
		}
	}


	// From: Req10Batch162Amount100
	signed long int stepLocal_6 = abs (var_1_22);
	if (stepLocal_6 == var_1_18) {
		if (! ((var_1_12 && var_1_15) && var_1_15)) {
			var_1_26 = (((max (var_1_18 , var_1_17)) + var_1_19) + (var_1_27 + var_1_28));
		}
	}


	// From: Req11Batch162Amount100
	...
	if (var_1_11) {
		if (var_1_20 < stepLocal_5) {
			if ((var_1_6 + var_1_1) > stepLocal_4) {
				var_1_21 = (max (var_1_18 , var_1_17));
			}
		} else {
			var_1_21 = var_1_18;
		}
	...
	// From: Req3Batch162Amount100
	unsigned long int stepLocal_2 = var_1_29 + var_1_25;
	if (stepLocal_2 == (min (var_1_8 , (var_1_24 % 8u)))) {
		if (! var_1_12) {
...
int property(void) {
	return ((((((((((((var_1_15 || (var_1_3 >= var_1_4)) ? (var_1_15 ? (var_1_1 == ((signed long int) (var_1_5 - 256))) : (var_1_1 == ((signed long int) (max (var_1_5 , var_1_6))))) : (var_1_1 == ((signed long int) (var_1_7 + (var_1_8 - 4))))) && ((var_1_2 && var_1_10) ? (var_1_9 == ((unsigned char) (var_1_11 || (! var_1_12)))) : (var_1_2 ? (var_1_9 == ((unsigned char) (! var_1_11))) : 1))) && (((var_1_29 + var_1_25) == (min (var_1_8 , (var_1_24 % 8u)))) ? ((! var_1_12) ? (var_1_13 == ((unsigned short int) ((var_1_14 + 25) + 16))) : 1) : (var_1_13 == ((unsigned short int) var_1_14)))) && ((last_1_var_1_29 <= var_1_8) ? (var_1_15 == ((unsigned char) var_1_12)) : 1)) && (((var_1_8 >= var_1_6) && var_1_9) ? (var_1_9 ? (var_1_16 == ((unsigned char) (((var_1_17 + var_1_18) - var_1_19) + var_1_20))) : (var_1_16 == ((unsigned char) var_1_20))) : 1)) && (var_1_11 ? ((var_1_20 < var_1_17) ? (((var_1_6 + var_1_1) > var_1_22) ? (var_1_21 == ((unsigned short int) (max (var_1_18 , var_1_17)))) : 1) : (var_1_21 == ((unsigned short int) var_1_18))) : (var_1_21 == ((unsigned short int) var_1_18)))) && ((((abs (var_1_20)) - var_1_19) >= var_1_18) ? ((var_1_20 < (min (var_1_1 , var_1_8))) ? (var_1_22 == ((unsigned short int) var_1_1)) : 1) : 1)) && ((! (last_1_var_1_24 >= 4)) ? (var_1_24 == ((unsigned long int) last_1_var_1_24)) : 1)) && ((var_1_2 && var_1_15) ? ((last_1_var_1_25 >= (var_1_21 ^ var_1_26)) ? (var_1_15 ? (var_1_25 == ((signed long int) var_1_20)) : 1) : (var_1_25 == ((signed long int) var_1_19))) : 1)) && (((abs (var_1_22)) == var_1_18) ? ((! ((var_1_12 && var_1_15) && var_1_15)) ? (var_1_26 == ((unsigned char) (((max (var_1_18 , var_1_17)) + var_1_19) + (var_1_27 + var_1_28)))) : 1) : 1)) && (((var_1_26 < 8) && var_1_15) ? (var_1_29 == ((unsigned long int) (var_1_20 + ((var_1_18 + 16u) + (var_1_22 + var_1_27))))) : (var_1_29 == ((unsigned long int) var_1_14)))) && (((var_1_24 - var_1_22) <= -1) ? ((((var_1_24 * 25u) + var_1_24) > var_1_29) ? (var_1_30 == ((signed char) var_1_27)) : (var_1_30 == ((signed char) var_1_18))) : (var_1_30 == ((signed char) var_1_18)))
;
}
int main(void) {
	isInitial = 1;
