...
void step(void) {
	...
	// From: Req7Batch124Amount100
	var_1_26 = (var_1_5 + var_1_25);


	// From: Req11Batch124Amount100
	if (var_1_10) {
		var_1_34 = ((var_1_35 - var_1_22) - (var_1_4 - (max (var_1_24 , var_1_20))));
	} else {
		var_1_34 = (min (var_1_19 , (min ((var_1_25 + var_1_20) , (var_1_4 + var_1_13)))));
	}


	// From: Req12Batch124Amount100
	if ((var_1_4 << (var_1_37 + var_1_38)) > var_1_35) {
		var_1_36 = -64;
	}


	// From: Req8Batch124Amount100
	unsigned char stepLocal_4 = var_1_20;
	unsigned char stepLocal_3 = var_1_7;
	if (((var_1_20 + var_1_36) < var_1_34) || stepLocal_3) {
		if (stepLocal_4 < ((min (var_1_24 , var_1_21)) - var_1_25)) {
			var_1_27 = (min (var_1_22 , (3394507325u - (1587311803u - var_1_13))));
		} else {
	...
	// From: Req10Batch124Amount100
	signed long int stepLocal_7 = 64;
	if ((abs (var_1_34)) < stepLocal_7) {
...
int property(void) {
	return (((((((((((((var_1_34 * (3669925837u - var_1_3)) > (2965407302u - (var_1_4 - var_1_5))) ? (var_1_1 == ((float) (var_1_6 - 32.25f))) : 1) && ((var_1_8 && (last_1_var_1_27 < var_1_3)) ? (((var_1_6 * 1.0000000002E9) > last_1_var_1_11) ? (var_1_7 == ((unsigned char) var_1_9)) : 1) : (var_1_7 == ((unsigned char) var_1_10)))) && ((var_1_4 == (var_1_12 - (var_1_5 + var_1_13))) ? (var_1_11 == ((float) (min ((var_1_6 - var_1_14) , var_1_15)))) : (var_1_11 == ((float) (var_1_6 - 255.1f))))) && (((max ((var_1_3 + var_1_12) , var_1_5)) >= var_1_4) ? (var_1_16 == ((signed short int) (var_1_17 + var_1_18))) : (var_1_16 == ((signed short int) var_1_18)))) && ((((var_1_3 / var_1_20) & (var_1_21 - var_1_22)) >= (- 256u)) ? (var_1_19 == ((signed short int) var_1_21)) : (var_1_19 == ((signed short int) var_1_17)))) && (((var_1_13 - var_1_21) < ((var_1_12 - var_1_4) / var_1_20)) ? (var_1_23 == ((unsigned char) ((var_1_24 - var_1_25) - var_1_22))) : (var_1_23 == ((unsigned char) var_1_24)))) && (var_1_26 == ((signed long int) (var_1_5 + var_1_25)))) && ((((var_1_20 + var_1_36) < var_1_34) || var_1_7) ? ((var_1_20 < ((min (var_1_24 , var_1_21)) - var_1_25)) ? (var_1_27 == ((unsigned long int) (min (var_1_22 , (3394507325u - (1587311803u - var_1_13)))))) : (var_1_27 == ((unsigned long int) (var_1_20 + var_1_3)))) : 1)) && ((var_1_7 && (var_1_17 < var_1_34)) ? ((var_1_3 >= (var_1_13 * var_1_22)) ? (((- var_1_14) == var_1_11) ? (var_1_28 == ((unsigned short int) var_1_24)) : (var_1_28 == ((unsigned short int) var_1_34))) : 1) : (var_1_28 == ((unsigned short int) var_1_24)))) && (((abs (var_1_34)) < 64) ? (var_1_29 == ((double) (var_1_30 - ((var_1_31 + var_1_32) - var_1_33)))) : (var_1_29 == ((double) var_1_31)))) && (var_1_10 ? (var_1_34 == ((unsigned long int) ((var_1_35 - var_1_22) - (var_1_4 - (max (var_1_24 , var_1_20)))))) : (var_1_34 == ((unsigned long int) (min (var_1_19 , (min ((var_1_25 + var_1_20) , (var_1_4 + var_1_13))))))))) && (((var_1_4 << (var_1_37 + var_1_38)) > var_1_35) ? (var_1_36 == ((signed short int) -64)) : 1)
;
}
int main(void) {
	isInitial = 1;
