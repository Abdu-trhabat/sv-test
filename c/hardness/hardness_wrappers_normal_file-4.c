...
void step(void) {
	...
	if ((- (var_1_13 / 0.6f)) > ((var_1_14 + 3.25f) / (min (var_1_15 , var_1_16)))) {
		var_1_12 = (500u + (min (var_1_10 , var_1_7)));
	} else {
	...
	if ((last_1_var_1_1 / var_1_3) >= stepLocal_0) {
	...
	unsigned long int stepLocal_2 = var_1_12 / var_1_3;
	if (stepLocal_2 != (var_1_5 - 64)) {
