...
void step(void) {
 if (((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) - (((((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) > ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)))))) <= last_1_double_Array_0_6_) {
  (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = ((((((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) > ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)))) ? ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) : ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))))) - 50);
 }
 ...
 if (stepLocal_1 <= ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) / ((((-25) < ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)))) ? (-25) : ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer))))))) {
