...
void step(void) {
 (*(WrapperStruct00_var_1_1_Pointer)) = (((((*(WrapperStruct00_var_1_2_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_2_Pointer))) : ((*(WrapperStruct00_var_1_2_Pointer)))));
 ...
 if (((*(WrapperStruct00_var_1_7_Pointer)) / (*(WrapperStruct00_var_1_14_Pointer))) < ((*(WrapperStruct00_var_1_15_Pointer)) >> (*(WrapperStruct00_var_1_16_Pointer)))) {
  (*(WrapperStruct00_var_1_13_Pointer)) = ((((4 - (*(WrapperStruct00_var_1_12_Pointer))) < 0 ) ? -(4 - (*(WrapperStruct00_var_1_12_Pointer))) : (4 - (*(WrapperStruct00_var_1_12_Pointer)))));
 } else {
  if ((*(WrapperStruct00_var_1_9_Pointer)) >= (*(WrapperStruct00_var_1_1_Pointer))) {
   (*(WrapperStruct00_var_1_13_Pointer)) = (((((256 - (*(WrapperStruct00_var_1_16_Pointer)))) > ((*(WrapperStruct00_var_1_7_Pointer)))) ? ((256 - (*(WrapperStruct00_var_1_16_Pointer)))) : ((*(WrapperStruct00_var_1_7_Pointer)))));
  } else {
...
int property(void) {
 return (((((*(WrapperStruct00_var_1_1_Pointer)) == ((signed long int) (((((*(WrapperStruct00_var_1_2_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_2_Pointer))) : ((*(WrapperStruct00_var_1_2_Pointer))))))) && ((*(WrapperStruct00_var_1_3_Pointer)) == ((float) (((*(WrapperStruct00_var_1_4_Pointer)) - (*(WrapperStruct00_var_1_5_Pointer))) + ((((256.5f) < (((*(WrapperStruct00_var_1_6_Pointer)) - 16.125f))) ? (256.5f) : (((*(WrapperStruct00_var_1_6_Pointer)) - 16.125f)))))))) && (((- (3351680781u - (*(WrapperStruct00_var_1_8_Pointer)))) > ((*(WrapperStruct00_var_1_1_Pointer)) & (*(WrapperStruct00_var_1_9_Pointer)))) ? ((*(WrapperStruct00_var_1_7_Pointer)) == ((unsigned char) ((((((*(WrapperStruct00_var_1_10_Pointer))) < ((((((*(WrapperStruct00_var_1_11_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_11_Pointer))) : ((*(WrapperStruct00_var_1_11_Pointer))))))) ? ((*(WrapperStruct00_var_1_10_Pointer))) : ((((((*(WrapperStruct00_var_1_11_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_11_Pointer))) : ((*(WrapperStruct00_var_1_11_Pointer)))))))) + (*(WrapperStruct00_var_1_12_Pointer))))) : 1)) && ((((*(WrapperStruct00_var_1_7_Pointer)) / (*(WrapperStruct00_var_1_14_Pointer))) < ((*(WrapperStruct00_var_1_15_Pointer)) >> (*(WrapperStruct00_var_1_16_Pointer)))) ? ((*(WrapperStruct00_var_1_13_Pointer)) == ((signed short int) ((((4 - (*(WrapperStruct00_var_1_12_Pointer))) < 0 ) ? -(4 - (*(WrapperStruct00_var_1_12_Pointer))) : (4 - (*(WrapperStruct00_var_1_12_Pointer))))))) : (((*(WrapperStruct00_var_1_9_Pointer)) >= (*(WrapperStruct00_var_1_1_Pointer))) ? ((*(WrapperStruct00_var_1_13_Pointer)) == ((signed short int) (((((256 - (*(WrapperStruct00_var_1_16_Pointer)))) > ((*(WrapperStruct00_var_1_7_Pointer)))) ? ((256 - (*(WrapperStruct00_var_1_16_Pointer)))) : ((*(WrapperStruct00_var_1_7_Pointer))))))) : ((*(WrapperStruct00_var_1_13_Pointer)) == ((signed short int) (*(WrapperStruct00_var_1_12_Pointer))))))) && ((*(WrapperStruct00_var_1_17_Pointer)) == ((double) (*(WrapperStruct00_var_1_6_Pointer))))
;
}
int main(void) {
 isInitial = 1;
