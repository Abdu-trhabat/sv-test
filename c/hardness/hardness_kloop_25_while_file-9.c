...
void step(void) {
	...
	if (var_1_11 > 9999999.5f) {
		...
		var_1_9 = (max (((var_1_8 - var_1_3) + (var_1_13 - var_1_1)) , var_1_10));
	}
}
...
int property(void) {
	return ((((((last_1_var_1_8 <= 16) ? (var_1_1 == ((unsigned char) var_1_3)) : (((max (var_1_4 , var_1_5)) < var_1_6) ? (last_1_var_1_14 ? (var_1_1 == ((unsigned char) var_1_3)) : (var_1_1 == ((unsigned char) 64))) : (var_1_1 == ((unsigned char) var_1_3)))) && (var_1_8 == ((unsigned short int) (max (var_1_13 , var_1_3))))) && ((var_1_11 > 9999999.5f) ? (var_1_9 == ((signed long int) ((var_1_10 - var_1_1) - var_1_3))) : (var_1_9 == ((signed long int) (max (((var_1_8 - var_1_3) + (var_1_13 - var_1_1)) , var_1_10)))))) && (var_1_11 == ((float) var_1_12))) && (var_1_13 == ((unsigned short int) var_1_1))) && (var_1_14 == ((unsigned char) var_1_15))
;
}
int main(void) {
	isInitial = 1;
