...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch144stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch144stepLocals
	var_1_7 = (min (var_1_8 , ((var_1_9 - var_1_10) + var_1_11)));


	// From: Req3Batch144stepLocals
	if (((var_1_7 * var_1_9) <= var_1_1) || var_1_5) {
		var_1_12 = (var_1_13 + var_1_14);
	}


	// From: Req4Batch144stepLocals
	if (var_1_8 >= var_1_16) {
		var_1_15 = (var_1_17 && var_1_18);
	}


	// From: Req5Batch144stepLocals
	signed short int stepLocal_2 = var_1_16;
	if ((var_1_1 / var_1_20) <= stepLocal_2) {
		if (var_1_5) {
	...
	// From: Req6Batch144stepLocals
	if (var_1_18 || (var_1_5 && var_1_15)) {
		var_1_22 = var_1_3;
	}


	// From: Req7Batch144stepLocals
	...
	// From: Req8Batch144stepLocals
	var_1_26 = (var_1_17 && var_1_27);


	// From: Req9Batch144stepLocals
	signed long int stepLocal_4 = min (var_1_4 , var_1_7);
