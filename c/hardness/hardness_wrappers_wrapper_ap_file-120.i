...
void step(void) {
 ...
 if (last_1_BOOL_unsigned_char_Array_0_0_) {
  (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)) = (((((((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) + -5) < 0 ) ? -((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) + -5) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) + -5)))) > ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)))) ? ((((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) + -5) < 0 ) ? -((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) + -5) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) + -5)))) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)))));
 } else {
 ...
 if (10 > stepLocal_0) {
  if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
   (*(double_Array_0_arraydouble_Array_0arrayVar9_Pointer)) = (((((*(double_Array_0_arraydouble_Array_0arrayVar8_Pointer))) < 0 ) ? -((*(double_Array_0_arraydouble_Array_0arrayVar8_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar8_Pointer)))));
  }
 }
