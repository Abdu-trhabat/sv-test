...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	/* 319L, 111L) */ if (/* 320L, 82L, 83L) */ ((/* 321L, 79L, 84L) */ (abs (/* 322L, 78L, 85L) */ (max (/* 322L, 78L, 85L) */ (var_1_13) , (3.1)))))) < (/* 325L, 81L, 88L) */ (abs (255.5))))) {
		/* 327L, 106L) */ var_1_29 = (
			/* 330L, 105L) */ ((
				var_1_30
			) && (
	...
	// From: CodeObject5
	/* 341L, 152L) */ if (/* 342L, 121L, 122L) */ ((/* 343L, 119L, 123L) */ ((/* 344L, 117L, 124L) */ ((var_1_25) / (var_1_36))) ^ (var_1_8))) > (var_1_7))) {
	...
	// From: CodeObject6
	/* 381L, 197L) */ if (/* 382L, 159L, 160L) */ ((/* 383L, 157L, 161L) */ (abs (var_1_6))) < (var_1_10))) {
	...
	// From: CodeObject8
	/* 407L, 286L) */ if (/* 408L, 223L, 224L) */ ((var_1_16) == (/* 410L, 222L, 226L) */ ((/* 411L, 220L, 227L) */ ((var_1_36) / (var_1_46))) % (var_1_47))))) {
		/* 415L, 242L) */ var_1_44 = (
			/* 418L, 241L) */ (abs (
				-10
			))
		...
		/* 420L, 284L) */ if (/* 421L, 253L, 254L) */ ((/* 422L, 245L, 255L) */ ((var_1_48) - (var_1_5))) <= (/* 425L, 252L, 258L) */ ((/* 426L, 248L, 259L) */ ((var_1_10) - (var_1_11))) - (/* 429L, 251L, 262L) */ ((var_1_10) - (var_1_25))))))) {
			/* 432L, 279L) */ var_1_44 = (
				var_1_16
			);
		} else {
