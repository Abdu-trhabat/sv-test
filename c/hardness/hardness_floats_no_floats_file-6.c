...
int property(void) {
	return (((((((max (var_1_10 , var_1_13)) / var_1_4) > var_1_10) ? ((var_1_10 == var_1_13) ? (var_1_1 == ((unsigned long int) 1000000000u)) : (var_1_1 == ((unsigned long int) 128u))) : 1) && (((var_1_7 >> (var_1_8 + var_1_9)) >= (max ((var_1_1 + var_1_10) , var_1_13))) ? (var_1_6 == ((unsigned short int) var_1_8)) : ((var_1_4 < 64) ? (var_1_6 == ((unsigned short int) var_1_7)) : 1))) && (((- var_1_15) != var_1_15) ? (var_1_10 == ((unsigned long int) (1000000u + 32u))) : 1)) && ((var_1_14 && (var_1_15 <= 10)) ? (var_1_13 == ((unsigned short int) ((abs (var_1_8)) + var_1_7))) : 1)) && (var_1_15 == ((signed long int) var_1_16))
;
}
int main(void) {
	isInitial = 1;
