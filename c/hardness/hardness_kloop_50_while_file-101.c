...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10150_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch10150_while
	if (var_1_2) {
		var_1_1 = (((1000000000 - 64) + var_1_3) - var_1_4);
	}


	// From: Req2Batch10150_while
	...
	// From: Req4Batch10150_while
	if (((max (var_1_4 , var_1_13)) <= var_1_14) || var_1_6) {
		var_1_15 = var_1_13;
	}


	// From: Req5Batch10150_while
	...
	// From: Req7Batch10150_while
	if ((var_1_17 / var_1_10) <= var_1_16) {
		var_1_22 = (abs (min (var_1_12 , (var_1_13 + var_1_15))));
	}


	// From: Req8Batch10150_while
	var_1_23 = var_1_13;


	// From: Req3Batch10150_while
