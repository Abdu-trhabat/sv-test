...
void step(void) {
	// From: Req1Batch106Wrapper_P
	(*(var_1_1_Pointer)) = (*(var_1_2_Pointer));


	// From: Req2Batch106Wrapper_P
	...
	if (! (*(var_1_4_Pointer))) {
		if (stepLocal_0 >= (*(var_1_1_Pointer))) {
			...
			if (stepLocal_1 <= (*(var_1_2_Pointer))) {
				(*(var_1_3_Pointer)) = (min ((min ((*(var_1_6_Pointer)) , (*(var_1_5_Pointer)))) , (*(var_1_7_Pointer))));
			}
		}
	} else {
	...
	// From: Req3Batch106Wrapper_P
	signed long int stepLocal_3 = (max ((*(var_1_9_Pointer)) , (*(var_1_10_Pointer)))) >> (*(var_1_11_Pointer));
