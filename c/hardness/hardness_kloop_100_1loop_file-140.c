...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch140100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch140100_1loop
	var_1_26 = (var_1_17 + (2.33 - var_1_27));


	// From: Req11Batch140100_1loop
	if (var_1_18 < (var_1_11 + var_1_9)) {
		var_1_36 = (max (var_1_8 , (max ((abs (var_1_3)) , (abs (var_1_37))))));
	}


	// From: Req12Batch140100_1loop
	var_1_38 = var_1_8;


	// From: Req1Batch140100_1loop
	if ((- 255.45f) < var_1_26) {
		var_1_1 = (var_1_3 + -16);
	}


	// From: Req2Batch140100_1loop
	...
	// From: Req6Batch140100_1loop
	if (var_1_15 >= (var_1_28 * var_1_16)) {
		var_1_24 = (! var_1_25);
	}


	// From: Req10Batch140100_1loop
