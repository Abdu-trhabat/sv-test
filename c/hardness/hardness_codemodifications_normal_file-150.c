...
void step(void) {
	...
	if (((var_1_13 + 200) & var_1_14) != var_1_15) {
		var_1_12 = var_1_14;
	}


	// From: Req4Batch150normal
	if ((var_1_3 / var_1_17) >= ((var_1_1 / 16.69) * var_1_18)) {
		var_1_16 = var_1_14;
	}


	// From: Req5Batch150normal
	if ((- var_1_6) > var_1_3) {
		if (var_1_16 > ((var_1_13 * var_1_12) * (var_1_21 - var_1_14))) {
			if (var_1_11) {
				var_1_19 = var_1_22;
			} else {
				var_1_19 = 128;
...
int property(void) {
	return ((((((((var_1_2 < (var_1_3 - var_1_4)) ? (var_1_1 == ((double) (var_1_5 + var_1_6))) : 1) && (var_1_8 ? (var_1_7 == ((unsigned char) (var_1_9 && var_1_10))) : (var_1_7 == ((unsigned char) (! var_1_11))))) && ((((var_1_13 + 200) & var_1_14) != var_1_15) ? (var_1_12 == ((signed short int) var_1_14)) : 1)) && (((var_1_3 / var_1_17) >= ((var_1_1 / 16.69) * var_1_18)) ? (var_1_16 == ((signed long int) var_1_14)) : 1)) && (((- var_1_6) > var_1_3) ? ((var_1_16 > ((var_1_13 * var_1_12) * (var_1_21 - var_1_14))) ? (var_1_11 ? (var_1_19 == ((unsigned char) var_1_22)) : (var_1_19 == ((unsigned char) 128))) : (var_1_19 == ((unsigned char) var_1_23))) : 1)) && ((var_1_5 >= (abs (var_1_1))) ? (var_1_24 == ((unsigned char) var_1_22)) : (var_1_24 == ((unsigned char) (abs (var_1_25 - var_1_26)))))) && ((var_1_12 < (var_1_25 ^ (var_1_14 % 1))) ? (var_1_27 == ((float) (min (var_1_5 , var_1_6)))) : 1)) && (var_1_7 ? (var_1_8 ? (var_1_28 == ((unsigned long int) (var_1_29 - var_1_25))) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
