...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch102Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch102Amount100
	unsigned char stepLocal_3 = var_1_13;
	if (var_1_7 || stepLocal_3) {
		var_1_12 = (var_1_14 - var_1_11);
	} else {
		var_1_12 = (min (var_1_11 , (max (var_1_8 , (last_1_var_1_37 + var_1_15)))));
	}


	// From: Req8Batch102Amount100
	...
	// From: Req9Batch102Amount100
	unsigned char stepLocal_8 = var_1_26;
	if (var_1_28 || stepLocal_8) {
		var_1_30 = (min (var_1_5 , var_1_31));
	} else {
		var_1_30 = (((min (var_1_32 , var_1_33)) - var_1_34) + (min ((min (var_1_35 , 1.625)) , 1.875)));
	}


	// From: Req1Batch102Amount100
	...
	// From: Req5Batch102Amount100
	if (var_1_26) {
		var_1_16 = (min (var_1_17 , (max ((var_1_18 + var_1_19) , var_1_20))));
	} else {
		if (var_1_26) {
			var_1_16 = var_1_18;
		}
	...
	// From: Req7Batch102Amount100
	var_1_22 = ((var_1_23 + var_1_24) - var_1_25);


	// From: Req10Batch102Amount100
	var_1_36 = (abs (var_1_32));


	// From: Req12Batch102Amount100
	signed char stepLocal_11 = var_1_25;
	if (stepLocal_11 < var_1_18) {
		var_1_40 = (var_1_39 - (min (var_1_41 , var_1_25)));
	} else {
	...
	if (var_1_21 != stepLocal_9) {
		if (! (var_1_34 > var_1_31)) {
			if (stepLocal_10 >= (abs (64u >> var_1_39))) {
...
int property(void) {
	return (((((((((((((var_1_2 + var_1_3) != (25u / var_1_4)) ? (((~ var_1_4) > var_1_2) ? (var_1_1 == ((double) var_1_5)) : (var_1_1 == ((double) 100.75))) : 1) && ((var_1_5 < var_1_30) ? (((- var_1_5) < var_1_30) ? (var_1_26 ? (var_1_6 == ((unsigned short int) var_1_8)) : (var_1_6 == ((unsigned short int) 500))) : 1) : 1)) && (((last_1_var_1_9 / var_1_4) != ((var_1_10 - var_1_8) - var_1_11)) ? (var_1_9 == ((signed long int) (var_1_8 - last_1_var_1_9))) : (var_1_26 ? (var_1_9 == ((signed long int) var_1_8)) : 1))) && ((var_1_7 || var_1_13) ? (var_1_12 == ((unsigned long int) (var_1_14 - var_1_11))) : (var_1_12 == ((unsigned long int) (min (var_1_11 , (max (var_1_8 , (last_1_var_1_37 + var_1_15))))))))) && (var_1_26 ? (var_1_16 == ((unsigned char) (min (var_1_17 , (max ((var_1_18 + var_1_19) , var_1_20)))))) : (var_1_26 ? (var_1_16 == ((unsigned char) var_1_18)) : 1))) && ((var_1_6 >= (- (- var_1_14))) ? (var_1_21 == ((unsigned short int) var_1_17)) : 1)) && (var_1_22 == ((signed char) ((var_1_23 + var_1_24) - var_1_25)))) && ((((var_1_3 + last_1_var_1_12) + last_1_var_1_9) >= var_1_4) ? ((var_1_18 != (last_1_var_1_12 + var_1_2)) ? ((var_1_2 <= last_1_var_1_37) ? (var_1_26 == ((unsigned char) var_1_28)) : 1) : (var_1_26 == ((unsigned char) var_1_29))) : (var_1_26 == ((unsigned char) var_1_29)))) && ((var_1_28 || var_1_26) ? (var_1_30 == ((double) (min (var_1_5 , var_1_31)))) : (var_1_30 == ((double) (((min (var_1_32 , var_1_33)) - var_1_34) + (min ((min (var_1_35 , 1.625)) , 1.875))))))) && (var_1_36 == ((double) (abs (var_1_32))))) && ((var_1_21 != ((var_1_19 + var_1_25) - var_1_17)) ? ((! (var_1_34 > var_1_31)) ? ((((var_1_25 * var_1_20) + var_1_12) >= (abs (64u >> var_1_39))) ? (var_1_37 == ((unsigned short int) (var_1_24 + var_1_19))) : (var_1_26 ? (var_1_37 == ((unsigned short int) var_1_18)) : (var_1_37 == ((unsigned short int) var_1_19)))) : (var_1_37 == ((unsigned short int) var_1_17))) : 1)) && ((var_1_25 < var_1_18) ? (var_1_40 == ((signed char) (var_1_39 - (min (var_1_41 , var_1_25))))) : ((var_1_1 >= (var_1_34 - var_1_32)) ? (var_1_40 == ((signed char) var_1_25)) : (var_1_40 == ((signed char) var_1_24))))
;
}
int main(void) {
	isInitial = 1;
