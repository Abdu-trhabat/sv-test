...
void step(void) {
	// From: Req5Batch75Amount100
	if ((max ((min (last_1_var_1_31 , last_1_var_1_13)) , 1.0000000000000006E15f)) < last_1_var_1_29) {
		if (var_1_7) {
			var_1_13 = ((min (var_1_17 , var_1_18)) - ((var_1_19 - var_1_20) + var_1_21));
		}
	}


	// From: Req7Batch75Amount100
	if (last_1_var_1_8 >= (var_1_4 - var_1_26)) {
		var_1_28 = (min ((var_1_25 - last_1_var_1_22) , last_1_var_1_8));
	} else {
		var_1_28 = var_1_12;
	}


	// From: Req6Batch75Amount100
	if (var_1_7) {
	...
	// From: Req1Batch75Amount100
	if (var_1_2 <= var_1_3) {
		var_1_1 = (var_1_4 - var_1_5);
	}


	// From: Req2Batch75Amount100
	if (var_1_7) {
		if (var_1_5 > var_1_4) {
			if ((16 > var_1_5) || (var_1_1 == (min (var_1_2 , var_1_3)))) {
				var_1_6 = var_1_5;
			} else {
	...
	// From: Req4Batch75Amount100
	var_1_10 = (var_1_11 - var_1_12);


	// From: Req8Batch75Amount100
	...
	if (stepLocal_2 <= var_1_22) {
		if ((var_1_27 - (var_1_25 + var_1_30)) == stepLocal_3) {
			var_1_29 = (var_1_18 - (var_1_19 + (max (var_1_20 , var_1_21))));
		} else {
			var_1_29 = 63.5f;
		}
	} else {
	...
	// From: Req11Batch75Amount100
	unsigned char stepLocal_6 = var_1_24;
	if (var_1_21 <= 4.2f) {
		if ((min (var_1_22 , (var_1_34 - var_1_26))) == stepLocal_6) {
			var_1_33 = (min (32 , (max (var_1_11 , var_1_30))));
		} else {
			var_1_33 = var_1_30;
		}
	} else {
	...
	// From: Req3Batch75Amount100
	signed long int stepLocal_1 = abs (var_1_5);
	signed long int stepLocal_0 = var_1_28 / var_1_4;
	if (var_1_1 > stepLocal_1) {
		if (var_1_28 > stepLocal_0) {
			var_1_8 = (max (var_1_5 , var_1_4));
		} else {
			var_1_8 = var_1_9;
		}
	} else {
...
int property(void) {
	return (((((((((((var_1_2 <= var_1_3) ? (var_1_1 == ((unsigned char) (var_1_4 - var_1_5))) : 1) && (var_1_7 ? ((var_1_5 > var_1_4) ? (((16 > var_1_5) || (var_1_1 == (min (var_1_2 , var_1_3)))) ? (var_1_6 == ((unsigned char) var_1_5)) : (var_1_6 == ((unsigned char) (var_1_4 - var_1_5)))) : (var_1_6 == ((unsigned char) var_1_5))) : (var_1_6 == ((unsigned char) var_1_5)))) && ((var_1_1 > (abs (var_1_5))) ? ((var_1_28 > (var_1_28 / var_1_4)) ? (var_1_8 == ((unsigned char) (max (var_1_5 , var_1_4)))) : (var_1_8 == ((unsigned char) var_1_9))) : (var_1_8 == ((unsigned char) var_1_4)))) && (var_1_10 == ((signed char) (var_1_11 - var_1_12)))) && (((max ((min (last_1_var_1_31 , last_1_var_1_13)) , 1.0000000000000006E15f)) < last_1_var_1_29) ? (var_1_7 ? (var_1_13 == ((float) ((min (var_1_17 , var_1_18)) - ((var_1_19 - var_1_20) + var_1_21)))) : 1) : 1)) && (var_1_7 ? (((var_1_28 / var_1_4) >= 50) ? (var_1_22 == ((unsigned char) (((var_1_23 + var_1_24) - var_1_25) - (var_1_26 - (50 - var_1_27))))) : (var_1_22 == ((unsigned char) var_1_25))) : (var_1_22 == ((unsigned char) var_1_5)))) && ((last_1_var_1_8 >= (var_1_4 - var_1_26)) ? (var_1_28 == ((signed long int) (min ((var_1_25 - last_1_var_1_22) , last_1_var_1_8)))) : (var_1_28 == ((signed long int) var_1_12)))) && ((var_1_23 <= var_1_22) ? (((var_1_27 - (var_1_25 + var_1_30)) == (var_1_28 / var_1_24)) ? (var_1_29 == ((float) (var_1_18 - (var_1_19 + (max (var_1_20 , var_1_21)))))) : (var_1_29 == ((float) 63.5f))) : (var_1_29 == ((float) var_1_21)))) && ((var_1_13 <= (- var_1_29)) ? (var_1_31 == ((double) (var_1_19 + var_1_21))) : (((var_1_4 < (- var_1_8)) && var_1_7) ? (var_1_31 == ((double) var_1_21)) : (var_1_31 == ((double) var_1_20))))) && (((var_1_4 * var_1_12) != 16) ? (((var_1_24 - var_1_26) >= var_1_28) ? (var_1_32 == ((double) (var_1_20 + var_1_19))) : (var_1_32 == ((double) var_1_19))) : 1)) && ((var_1_21 <= 4.2f) ? (((min (var_1_22 , (var_1_34 - var_1_26))) == var_1_24) ? (var_1_33 == ((signed char) (min (32 , (max (var_1_11 , var_1_30)))))) : (var_1_33 == ((signed char) var_1_30))) : (var_1_33 == ((signed char) var_1_25)))
;
}
int main(void) {
	isInitial = 1;
