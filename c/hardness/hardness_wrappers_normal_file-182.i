...
void step(void) {
 ...
 if ((((((var_1_4) < (var_1_15)) ? (var_1_4) : (var_1_15))) - var_1_5) < ((var_1_6 - var_1_16) * (- var_1_12))) {
  if (var_1_3) {
   var_1_14 = var_1_5;
  } else {
