...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch185has_floats.c", 13, "reach_error"); }
...
int property(void) {
	return (((((var_1_2 && var_1_3) ? (((var_1_4 - var_1_5) <= var_1_15) ? (var_1_1 == ((signed long int) var_1_5)) : 1) : 1) && ((var_1_4 >= var_1_14) ? ((((var_1_5 % var_1_8) + var_1_14) <= (var_1_4 - var_1_9)) ? (var_1_7 == ((double) var_1_10)) : (var_1_7 == ((double) 128.0))) : (var_1_7 == ((double) var_1_10)))) && (var_1_11 == ((unsigned char) ((10 + var_1_12) + var_1_13)))) && (((var_1_12 >= last_1_var_1_15) || var_1_2) ? (var_1_14 == ((signed long int) (max (50 , (min (var_1_4 , (abs (last_1_var_1_15)))))))) : 1)) && (var_1_3 ? ((var_1_4 <= var_1_13) ? (var_1_15 == ((unsigned long int) var_1_14)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
