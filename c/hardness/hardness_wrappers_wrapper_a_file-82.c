...
void step(void) {
	...
	if ((signed_long_int_Array_0[1] + unsigned_char_Array_0[1][1][0]) >= stepLocal_1) {
		if ((max (float_Array_0[0] , (float_Array_0[2] * float_Array_0[1]))) <= double_Array_0[1]) {
