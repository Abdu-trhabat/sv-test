...
void step(void) {
 ...
 if (var_1_1) {
  if (((((5) > (var_1_17)) ? (5) : (var_1_17))) < stepLocal_1) {
   if (! var_1_5) {
    var_1_6 = var_1_8;
   } else {
    var_1_6 = 1;
 ...
 if (var_1_8 > var_1_6) {
  var_1_12 = ((var_1_13 - ((((var_1_14) < (var_1_15)) ? (var_1_14) : (var_1_15)))) + var_1_16);
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((! last_1_var_1_1) ? ((last_1_var_1_9 > last_1_var_1_6) ? (var_1_1 == ((unsigned char) (last_1_var_1_1 || var_1_5))) : ((! var_1_5) ? (var_1_1 == ((unsigned char) var_1_5)) : 1)) : (var_1_1 == ((unsigned char) var_1_5))) && (var_1_1 ? ((((((5) > (var_1_17)) ? (5) : (var_1_17))) < var_1_17) ? ((! var_1_5) ? (var_1_6 == ((unsigned short int) var_1_8)) : (var_1_6 == ((unsigned short int) 1))) : 1) : (var_1_6 == ((unsigned short int) var_1_8)))) && ((var_1_17 > (var_1_10 - var_1_11)) ? (var_1_9 == ((signed long int) var_1_10)) : 1)) && ((var_1_8 > var_1_6) ? (var_1_12 == ((double) ((var_1_13 - ((((var_1_14) < (var_1_15)) ? (var_1_14) : (var_1_15)))) + var_1_16))) : 1)) && (var_1_17 == ((unsigned long int) last_1_var_1_17))
;
}
int main(void) {
 isInitial = 1;
