...
void step(void) {
	...
	signed long int stepLocal_4 = (min (64513 , var_1_11)) - var_1_12;
...
int property(void) {
	return ((((var_1_9 / var_1_3) >= var_1_4) ? (((- var_1_3) > var_1_9) ? (var_1_1 == ((unsigned short int) (min (var_1_5 , var_1_6)))) : 1) : 1) && (var_1_8 ? (((var_1_1 * (var_1_3 + var_1_4)) > var_1_9) ? (var_1_7 == ((unsigned short int) 256)) : 1) : 1)) && ((var_1_8 || var_1_10) ? (var_1_9 == ((unsigned short int) (min (var_1_5 , var_1_6)))) : ((((min (64513 , var_1_11)) - var_1_12) >= (5 * last_1_var_1_7)) ? (var_1_9 == ((unsigned short int) var_1_6)) : (var_1_9 == ((unsigned short int) var_1_12))))
;
}
int main(void) {
	isInitial = 1;
