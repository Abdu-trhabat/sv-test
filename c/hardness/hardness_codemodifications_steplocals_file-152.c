...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch152stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch152stepLocals
	var_1_1 = (max ((var_1_2 - 25) , (var_1_3 + (1 + var_1_4))));


	// From: Req2Batch152stepLocals
	if (var_1_1 >= ((min (var_1_3 , var_1_4)) * 1)) {
		var_1_5 = var_1_3;
	}


	// From: Req3Batch152stepLocals
	signed long int stepLocal_0 = (var_1_4 | var_1_3) + (var_1_1 / var_1_8);
	...
	// From: Req4Batch152stepLocals
	if (var_1_12) {
		if ((max (var_1_5 , (var_1_2 - var_1_11))) >= var_1_1) {
			var_1_13 = var_1_14;
		}
	}


	// From: Req5Batch152stepLocals
	if (var_1_12) {
		var_1_15 = (var_1_2 - (abs (var_1_6)));
	}


	// From: Req6Batch152stepLocals
	signed char stepLocal_2 = var_1_1;
	signed long int stepLocal_1 = var_1_11 << (abs (var_1_18));
