...
void step(void) {
	...
	// From: Req3Batch132Wrapper_A
	if (BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]) {
		unsigned_short_int_Array_0[0][0] = (abs (min (unsigned_short_int_Array_0[1][0] , unsigned_short_int_Array_0[0][1])));
	} else {
		unsigned_short_int_Array_0[0][0] = unsigned_short_int_Array_0[1][0];
	}


	// From: Req4Batch132Wrapper_A
	...
	if (7.2 < double_Array_0[1][0]) {
		if ((signed_char_Array_0[0][0] - (signed_char_Array_0[0][1] + signed_char_Array_0[1][1])) >= stepLocal_0) {
			signed_short_int_Array_0[0] = (abs (signed_char_Array_0[0][1]));
		} else {
			signed_short_int_Array_0[0] = ((max (signed_char_Array_0[0][0] , signed_char_Array_0[0][1])) - (signed_short_int_Array_0[1] - signed_char_Array_0[1][1]));
		}
	}


	// From: Req5Batch132Wrapper_A
...
int property(void) {
	return (((((128 <= signed_long_int_Array_0[0]) ? (unsigned_short_int_Array_0[1][1] == ((unsigned short int) 25)) : 1) && (BOOL_unsigned_char_Array_0[1] ? (double_Array_0[1][1] == ((double) double_Array_0[0][1])) : (double_Array_0[1][1] == ((double) (double_Array_0[1][0] + double_Array_0[0][0]))))) && ((BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]) ? (unsigned_short_int_Array_0[0][0] == ((unsigned short int) (abs (min (unsigned_short_int_Array_0[1][0] , unsigned_short_int_Array_0[0][1]))))) : (unsigned_short_int_Array_0[0][0] == ((unsigned short int) unsigned_short_int_Array_0[1][0])))) && ((7.2 < double_Array_0[1][0]) ? (((signed_char_Array_0[0][0] - (signed_char_Array_0[0][1] + signed_char_Array_0[1][1])) >= (1000 - unsigned_short_int_Array_0[0][1])) ? (signed_short_int_Array_0[0] == ((signed short int) (abs (signed_char_Array_0[0][1])))) : (signed_short_int_Array_0[0] == ((signed short int) ((max (signed_char_Array_0[0][0] , signed_char_Array_0[0][1])) - (signed_short_int_Array_0[1] - signed_char_Array_0[1][1]))))) : 1)) && ((unsigned_short_int_Array_0[0][0] > ((- 128) + signed_short_int_Array_0[1])) ? (signed_char_Array_0[1][0] == ((signed char) signed_char_Array_0[1][1])) : 1)
;
}
int main(void) {
	isInitial = 1;
