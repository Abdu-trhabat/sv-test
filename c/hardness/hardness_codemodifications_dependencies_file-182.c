...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch182dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch182dependencies
	if ((var_1_12 - var_1_11) >= (var_1_10 / var_1_17)) {
		var_1_16 = ((var_1_18 - 1) - var_1_19);
	}


	// From: Req5Batch182dependencies
	if (var_1_17 >= var_1_12) {
		if (var_1_21 != ((max (var_1_14 , var_1_22)) - (5 + var_1_23))) {
	...
	// From: Req1Batch182dependencies
	if (((var_1_20 * 16) / var_1_3) <= var_1_20) {
		var_1_1 = (min (var_1_5 , var_1_6));
	}


	// From: Req3Batch182dependencies
	if ((var_1_14 - var_1_15) != var_1_20) {
		var_1_13 = 0.8f;
	}


	// From: Req7Batch182dependencies
