...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch69Amount100.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_3 = (((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3));
 unsigned long int stepLocal_2 = var_1_8;
 if (stepLocal_2 <= (var_1_25 - var_1_6)) {
  if (((((var_1_19) < ((var_1_8 + var_1_4))) ? (var_1_19) : ((var_1_8 + var_1_4)))) < stepLocal_3) {
   var_1_24 = var_1_7;
  }
 } else {
  var_1_24 = var_1_3;
 ...
 unsigned long int stepLocal_6 = ((((var_1_29) > (var_1_8)) ? (var_1_29) : (var_1_8))) << var_1_3;
 ...
 if (var_1_30 && ((var_1_3 - var_1_4) <= var_1_24)) {
  var_1_1 = ((((((var_1_3 + var_1_4)) > ((var_1_6 - var_1_7))) ? ((var_1_3 + var_1_4)) : ((var_1_6 - var_1_7)))) + var_1_8);
 } else {
  var_1_1 = var_1_4;
 }
 if (var_1_1 >= (var_1_6 | ((((64u) < 0 ) ? -(64u) : (64u))))) {
  if ((8 + 5) < var_1_6) {
   var_1_14 = var_1_13;
  } else {
   var_1_14 = var_1_12;
 ...
 unsigned long int stepLocal_0 = (((var_1_8) > (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))))) ? (var_1_8) : (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))));
...
int property(void) {
 return ((((((((((((var_1_30 && ((var_1_3 - var_1_4) <= var_1_24)) ? (var_1_1 == ((unsigned long int) ((((((var_1_3 + var_1_4)) > ((var_1_6 - var_1_7))) ? ((var_1_3 + var_1_4)) : ((var_1_6 - var_1_7)))) + var_1_8))) : (var_1_1 == ((unsigned long int) var_1_4))) && (((256.2 * var_1_15) < var_1_15) ? (var_1_30 ? (var_1_9 == ((float) (var_1_12 + var_1_13))) : 1) : 1)) && ((var_1_1 >= (var_1_6 | ((((64u) < 0 ) ? -(64u) : (64u))))) ? (((8 + 5) < var_1_6) ? (var_1_14 == ((float) var_1_13)) : (var_1_14 == ((float) var_1_12))) : (var_1_14 == ((float) var_1_12)))) && ((var_1_10 >= var_1_21) ? (var_1_15 == ((double) ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))) : (var_1_15 == ((double) (var_1_13 + var_1_12))))) && ((var_1_9 <= (var_1_13 / 64.8f)) ? ((((((var_1_8) > (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))))) ? (var_1_8) : (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))))) >= var_1_24) ? ((var_1_30 && ((- var_1_16) >= var_1_15)) ? (var_1_17 == ((signed short int) 8)) : 1) : (var_1_17 == ((signed short int) (var_1_18 - (var_1_19 - var_1_20))))) : (var_1_17 == ((signed short int) var_1_19)))) && (var_1_30 ? (var_1_21 == ((float) (var_1_22 - var_1_23))) : 1)) && ((var_1_8 <= (var_1_25 - var_1_6)) ? ((((((var_1_19) < ((var_1_8 + var_1_4))) ? (var_1_19) : ((var_1_8 + var_1_4)))) < ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) ? (var_1_24 == ((signed long int) var_1_7)) : 1) : (var_1_24 == ((signed long int) var_1_3)))) && (((var_1_19 | var_1_7) < (var_1_25 * (var_1_6 << var_1_20))) ? (var_1_26 == ((unsigned char) ((var_1_27 + var_1_28) + var_1_29))) : (var_1_26 == ((unsigned char) var_1_28)))) && ((var_1_4 > var_1_3) ? (var_1_30 == ((unsigned char) ((var_1_2 || var_1_31) && (var_1_32 || var_1_33)))) : (var_1_30 == ((unsigned char) ((! var_1_34) && ((var_1_8 < var_1_19) || var_1_31)))))) && (var_1_33 ? (((var_1_27 > var_1_1) && ((-100 / var_1_19) >= (10000 * var_1_24))) ? (var_1_35 == ((signed char) -50)) : 1) : 1)) && ((var_1_26 >= var_1_18) ? (var_1_36 == ((signed char) var_1_28)) : 1)) && (((var_1_25 - var_1_27) > (var_1_38 - var_1_6)) ? (((((((var_1_29) > (var_1_8)) ? (var_1_29) : (var_1_8))) << var_1_3) < var_1_25) ? (var_1_37 == ((signed char) -64)) : (var_1_37 == ((signed char) var_1_28))) : (var_1_37 == ((signed char) var_1_28)))
;
}
int main(void) {
 isInitial = 1;
