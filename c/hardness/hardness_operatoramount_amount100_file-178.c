...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch178Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch178Amount100
	if (last_1_var_1_10 > last_1_var_1_9) {
		var_1_5 = ((max (var_1_6 , var_1_7)) - var_1_8);
	}


	// From: Req5Batch178Amount100
	var_1_16 = (max (10 , var_1_17));


	// From: Req6Batch178Amount100
	var_1_18 = var_1_17;


	// From: Req8Batch178Amount100
	if (var_1_5 < var_1_11) {
		var_1_21 = var_1_17;
	} else {
	...
	// From: Req14Batch178Amount100
	var_1_40 = var_1_37;


	// From: Req1Batch178Amount100
	...
	// From: Req13Batch178Amount100
	if (var_1_5 <= var_1_7) {
		var_1_38 = ((var_1_39 - var_1_13) + var_1_9);
	}


	// From: Req4Batch178Amount100
