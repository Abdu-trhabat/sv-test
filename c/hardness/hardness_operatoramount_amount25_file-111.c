...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch111Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch111Amount25
	if ((- 16) <= last_1_var_1_10) {
		var_1_7 = var_1_9;
	}


	// From: Req3Batch111Amount25
	...
	// From: Req4Batch111Amount25
	var_1_14 = var_1_4;


	// From: Req5Batch111Amount25
	var_1_15 = var_1_16;


	// From: Req6Batch111Amount25
	var_1_17 = var_1_16;
}
