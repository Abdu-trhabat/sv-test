...
void step(void) {
	...
	if ((min ((var_1_2 + var_1_3) , (var_1_4 / -256))) != var_1_5) {
...
int property(void) {
	return ((((min ((var_1_2 + var_1_3) , (var_1_4 / -256))) != var_1_5) ? (var_1_1 == ((unsigned char) (var_1_6 && var_1_7))) : (var_1_1 == ((unsigned char) (var_1_8 && var_1_9)))) && ((var_1_2 == ((var_1_11 + var_1_12) - (min (var_1_13 , var_1_14)))) ? ((var_1_3 == (- var_1_4)) ? (var_1_1 ? (var_1_10 == ((signed long int) var_1_12)) : 1) : 1) : (var_1_10 == ((signed long int) var_1_11)))) && ((var_1_10 > (- var_1_12)) ? (var_1_16 == ((signed long int) (max ((var_1_17 + var_1_18) , var_1_11)))) : ((var_1_17 != (var_1_10 / var_1_19)) ? (var_1_16 == ((signed long int) -50)) : 1))
;
}
int main(void) {
	isInitial = 1;
