...
void step(void) {
 ...
 if (stepLocal_1 <= ((*(WrapperStruct00_var_1_3_Pointer)) - (*(WrapperStruct00_var_1_4_Pointer)))) {
  if (stepLocal_0 < ((((((*(WrapperStruct00_var_1_2_Pointer)) / (*(WrapperStruct00_var_1_5_Pointer)))) > ((*(WrapperStruct00_var_1_4_Pointer)))) ? (((*(WrapperStruct00_var_1_2_Pointer)) / (*(WrapperStruct00_var_1_5_Pointer)))) : ((*(WrapperStruct00_var_1_4_Pointer)))))) {
