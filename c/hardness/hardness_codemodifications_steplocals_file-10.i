...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_0 = (((var_1_7) > (var_1_5)) ? (var_1_7) : (var_1_5));
 ...
 signed long int stepLocal_4 = (((var_1_18) < (var_1_14)) ? (var_1_18) : (var_1_14));
 if (((((var_1_13) > ((~ var_1_5))) ? (var_1_13) : ((~ var_1_5)))) >= stepLocal_4) {
