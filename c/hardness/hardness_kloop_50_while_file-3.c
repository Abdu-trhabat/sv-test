...
void step(void) {
	...
	// From: Req8Batch350_while
	var_1_24 = var_1_20;


	// From: Req9Batch350_while
	var_1_25 = 10;
	...
	if ((max (var_1_6 , var_1_13)) > stepLocal_1) {
		var_1_15 = ((min (var_1_17 , var_1_18)) - (var_1_19 - var_1_20));
	} else {
		if ((min (var_1_22 , (var_1_22 / var_1_21))) > var_1_22) {
...
int property(void) {
	return (((((((((99999.8f < var_1_22) ? ((! var_1_3) ? ((var_1_22 >= (var_1_22 / 2.5f)) ? (var_1_3 ? (var_1_1 == ((signed char) var_1_5)) : (var_1_1 == ((signed char) -2))) : 1) : 1) : 1) && (((- (abs (2.45f))) < var_1_22) ? (var_1_6 == ((unsigned long int) var_1_7)) : 1)) && ((var_1_3 || ((var_1_2 + var_1_4) > var_1_10)) ? (var_1_8 == ((unsigned short int) (var_1_11 + var_1_12))) : (var_1_8 == ((unsigned short int) var_1_12)))) && ((var_1_12 > var_1_25) ? ((15.8f != var_1_22) ? (var_1_13 == ((unsigned long int) var_1_25)) : 1) : 1)) && ((! var_1_9) ? (var_1_14 == ((signed short int) var_1_6)) : 1)) && (((max (var_1_6 , var_1_13)) > var_1_13) ? (var_1_15 == ((unsigned char) ((min (var_1_17 , var_1_18)) - (var_1_19 - var_1_20)))) : (((min (var_1_22 , (var_1_22 / var_1_21))) > var_1_22) ? (var_1_15 == ((unsigned char) (min ((min (5 , (abs (var_1_19)))) , (max (var_1_20 , var_1_17)))))) : (var_1_15 == ((unsigned char) var_1_18))))) && (var_1_22 == ((double) var_1_23))) && (var_1_24 == ((signed char) var_1_20))) && (var_1_25 == ((signed long int) 10))
;
}
int main(void) {
	isInitial = 1;
