...
void step(void) {
	...
	if (stepLocal_3 <= var_1_3) {
		if (var_1_10) {
			if (stepLocal_2 <= (max ((-128 % var_1_3) , var_1_1))) {
				var_1_9 = var_1_11;
			} else {
				var_1_9 = var_1_12;
			}
