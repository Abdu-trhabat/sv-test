...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch3850_1loop.c", 13, "reach_error"); }
...
int property(void) {
	return (((((((- var_1_2) <= var_1_3) ? (var_1_1 == ((unsigned char) var_1_4)) : ((var_1_5 <= var_1_2) ? (var_1_1 == ((unsigned char) var_1_6)) : (var_1_1 == ((unsigned char) var_1_4)))) && ((var_1_14 < (max (var_1_14 , (128.5 * var_1_14)))) ? (var_1_7 == ((unsigned char) (var_1_1 && (! 1)))) : 1)) && (((var_1_9 * var_1_10) < ((max (-1 , var_1_11)) - var_1_12)) ? (((var_1_9 + var_1_10) < var_1_12) ? (var_1_8 == ((unsigned short int) var_1_13)) : 1) : (var_1_8 == ((unsigned short int) var_1_13)))) && (((8 / var_1_15) < (64 / var_1_16)) ? ((var_1_12 >= var_1_15) ? (var_1_14 == ((double) (var_1_17 - var_1_18))) : (var_1_14 == ((double) (var_1_18 - (64.25 + (max (var_1_19 , var_1_20))))))) : (var_1_14 == ((double) var_1_18)))) && (((var_1_8 + 4u) <= (var_1_8 >> var_1_22)) ? (var_1_21 == ((signed short int) (min ((var_1_22 + var_1_23) , var_1_24)))) : (var_1_21 == ((signed short int) var_1_24)))) && ((! (var_1_21 > var_1_12)) ? (var_1_4 ? (var_1_25 == ((signed char) var_1_22)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
