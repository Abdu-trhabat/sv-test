...
void step(void) {
	...
	if (stepLocal_2 && var_1_12) {
		var_1_22 = (abs ((var_1_6 + var_1_23) + last_1_var_1_10));
	} else {
		var_1_22 = (abs (last_1_var_1_29));
	}
	...
	if (10u <= (abs (var_1_28))) {
		if ((min (16u , var_1_28)) >= (var_1_28 % var_1_4)) {
	...
	if ((var_1_22 > var_1_21) && (var_1_19 < (var_1_15 / var_1_16))) {
		if (var_1_27 != (var_1_7 - var_1_6)) {
			var_1_29 = ((max (var_1_5 , var_1_7)) - ((10000 - var_1_6) + var_1_30));
		} else {
			var_1_29 = var_1_30;
		}
	} else {
...
int property(void) {
	return (((((((((((10u <= (abs (var_1_28))) ? (((min (16u , var_1_28)) >= (var_1_28 % var_1_4)) ? (var_1_1 == ((signed char) ((var_1_5 - var_1_6) - var_1_7))) : 1) : 1) && ((var_1_7 != var_1_4) ? (var_1_8 == ((signed long int) ((var_1_7 + (max (var_1_6 , var_1_5))) - var_1_9))) : (var_1_8 == ((signed long int) var_1_21)))) && ((var_1_6 >= (var_1_24 + (var_1_5 - var_1_7))) ? (var_1_10 == ((signed char) (var_1_7 - var_1_6))) : (var_1_10 == ((signed char) var_1_7)))) && (var_1_12 ? (var_1_11 == ((unsigned char) (((var_1_20 + 31.75f) <= 4.2f) && var_1_14))) : 1)) && (var_1_15 == ((float) ((max ((var_1_16 - var_1_17) , var_1_18)) - var_1_19)))) && ((last_1_var_1_28 <= (abs (var_1_7))) ? (var_1_20 == ((float) (min (var_1_17 , var_1_16)))) : 1)) && (var_1_14 ? (var_1_21 == ((signed char) (abs (var_1_5)))) : ((var_1_10 >= (var_1_6 + var_1_28)) ? (var_1_21 == ((signed char) var_1_6)) : (var_1_21 == ((signed char) var_1_7))))) && ((last_1_var_1_11 && var_1_12) ? (var_1_22 == ((signed long int) (abs ((var_1_6 + var_1_23) + last_1_var_1_10)))) : (var_1_22 == ((signed long int) (abs (last_1_var_1_29)))))) && ((var_1_17 > ((max (var_1_19 , var_1_16)) - (var_1_25 - var_1_26))) ? (var_1_24 == ((signed char) (32 - (var_1_6 + var_1_27)))) : ((var_1_11 && (var_1_11 && var_1_14)) ? (var_1_24 == ((signed char) (var_1_6 + var_1_27))) : ((var_1_15 >= var_1_18) ? (var_1_24 == ((signed char) var_1_6)) : (var_1_24 == ((signed char) var_1_27)))))) && (var_1_11 ? ((! (var_1_20 >= var_1_16)) ? (var_1_28 == ((unsigned long int) (var_1_27 + var_1_5))) : (((- var_1_26) < (- (var_1_20 + var_1_17))) ? (var_1_28 == ((unsigned long int) (max (var_1_7 , var_1_27)))) : 1)) : (var_1_28 == ((unsigned long int) (max (var_1_7 , var_1_6)))))) && (((var_1_22 > var_1_21) && (var_1_19 < (var_1_15 / var_1_16))) ? ((var_1_27 != (var_1_7 - var_1_6)) ? (var_1_29 == ((signed short int) ((max (var_1_5 , var_1_7)) - ((10000 - var_1_6) + var_1_30)))) : (var_1_29 == ((signed short int) var_1_30))) : (var_1_29 == ((signed short int) var_1_27)))
;
}
int main(void) {
	isInitial = 1;
