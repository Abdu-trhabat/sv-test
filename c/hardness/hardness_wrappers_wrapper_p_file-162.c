...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch162Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch162Wrapper_P
	if ((min (last_1_var_1_17 , 10.3)) >= last_1_var_1_17) {
		(*(var_1_1_Pointer)) = ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer)));
	} else {
		(*(var_1_1_Pointer)) = ((*(var_1_4_Pointer)) + (499.94 - ((*(var_1_6_Pointer)) + (*(var_1_7_Pointer)))));
	}


	// From: Req4Batch162Wrapper_P
	if ((*(var_1_18_Pointer)) || (((*(var_1_1_Pointer)) * last_1_var_1_17) <= (*(var_1_5_Pointer)))) {
		if ((*(var_1_10_Pointer)) >= (*(var_1_12_Pointer))) {
			(*(var_1_17_Pointer)) = (*(var_1_6_Pointer));
		} else {
			(*(var_1_17_Pointer)) = 1.45;
		}
	} else {
		(*(var_1_17_Pointer)) = 128.2;
	}


	// From: Req2Batch162Wrapper_P
	...
	if ((last_1_var_1_8 * (25 + 64)) != stepLocal_1) {
		if ((last_1_var_1_8 - (*(var_1_11_Pointer))) == stepLocal_0) {
	...
	// From: Req3Batch162Wrapper_P
	if ((*(var_1_1_Pointer)) < (*(var_1_17_Pointer))) {
...
int property(void) {
	return (((((min (last_1_var_1_17 , 10.3)) >= last_1_var_1_17) ? ((*(var_1_1_Pointer)) == ((double) ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer))))) : ((*(var_1_1_Pointer)) == ((double) ((*(var_1_4_Pointer)) + (499.94 - ((*(var_1_6_Pointer)) + (*(var_1_7_Pointer)))))))) && (((last_1_var_1_8 * (25 + 64)) != (*(var_1_10_Pointer))) ? (((last_1_var_1_8 - (*(var_1_11_Pointer))) == (*(var_1_10_Pointer))) ? ((*(var_1_8_Pointer)) == ((unsigned char) (*(var_1_12_Pointer)))) : ((*(var_1_8_Pointer)) == ((unsigned char) 16))) : 1)) && (((*(var_1_1_Pointer)) < (*(var_1_17_Pointer))) ? ((*(var_1_13_Pointer)) == ((signed char) (*(var_1_14_Pointer)))) : ((*(var_1_13_Pointer)) == ((signed char) ((*(var_1_15_Pointer)) - (*(var_1_16_Pointer))))))) && (((*(var_1_18_Pointer)) || (((*(var_1_1_Pointer)) * last_1_var_1_17) <= (*(var_1_5_Pointer)))) ? (((*(var_1_10_Pointer)) >= (*(var_1_12_Pointer))) ? ((*(var_1_17_Pointer)) == ((double) (*(var_1_6_Pointer)))) : ((*(var_1_17_Pointer)) == ((double) 1.45))) : ((*(var_1_17_Pointer)) == ((double) 128.2)))
;
}
int main(void) {
	isInitial = 1;
