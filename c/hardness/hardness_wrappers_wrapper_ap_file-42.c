...
void step(void) {
	...
	if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) > (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) = ((min ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)))) - 10);
	} else {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) = (max (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))) , ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))));
	}
