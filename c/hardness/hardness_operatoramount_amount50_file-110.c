...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch110Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch110Amount50
	var_1_20 = (min (var_1_21 , 8.25));


	// From: Req7Batch110Amount50
