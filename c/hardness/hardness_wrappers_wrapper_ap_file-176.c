...
void step(void) {
	...
	if (! ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) <= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)))) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) = (min ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) , (min ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) , (max (-128 , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))))));
	}


	// From: Req4Batch176Wrapper_AP
	unsigned long int stepLocal_2 = max ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var5_Pointer)));
