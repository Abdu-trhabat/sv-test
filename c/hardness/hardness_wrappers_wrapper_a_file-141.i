...
void step(void) {
 if (float_Array_0[1] < float_Array_0[0]) {
  signed_char_Array_0[4] = (((((-32 + signed_char_Array_0[3])) > (((((signed_char_Array_0[2]) > (signed_char_Array_0[1])) ? (signed_char_Array_0[2]) : (signed_char_Array_0[1]))))) ? ((-32 + signed_char_Array_0[3])) : (((((signed_char_Array_0[2]) > (signed_char_Array_0[1])) ? (signed_char_Array_0[2]) : (signed_char_Array_0[1]))))));
 } else {
  ...
  if (float_Array_0[1] > 63.5f) {
   if (! ((64 >> signed_long_int_Array_0[0]) >= signed_char_Array_0[2])) {
    if (stepLocal_0 >= signed_short_int_Array_0[0]) {
     double_Array_0[0] = ((((double_Array_0[1]) > (10.2)) ? (double_Array_0[1]) : (10.2)));
    }
   } else {
...
int property(void) {
 return ((((float_Array_0[1] < float_Array_0[0]) ? (signed_char_Array_0[4] == ((signed char) (((((-32 + signed_char_Array_0[3])) > (((((signed_char_Array_0[2]) > (signed_char_Array_0[1])) ? (signed_char_Array_0[2]) : (signed_char_Array_0[1]))))) ? ((-32 + signed_char_Array_0[3])) : (((((signed_char_Array_0[2]) > (signed_char_Array_0[1])) ? (signed_char_Array_0[2]) : (signed_char_Array_0[1])))))))) : (signed_char_Array_0[4] == ((signed char) ((1 - signed_char_Array_0[0]) + signed_char_Array_0[3])))) && ((BOOL_unsigned_char_Array_0[0] || ((signed_char_Array_0[0] / unsigned_char_Array_0[1]) <= (signed_char_Array_0[1] * signed_char_Array_0[3]))) ? (signed_short_int_Array_0[0] == ((signed short int) signed_char_Array_0[0])) : 1)) && (unsigned_char_Array_0[2] == ((unsigned char) (unsigned_char_Array_0[0] - signed_char_Array_0[0])))) && ((-100 >= signed_char_Array_0[3]) ? ((float_Array_0[1] > 63.5f) ? ((! ((64 >> signed_long_int_Array_0[0]) >= signed_char_Array_0[2])) ? ((4 >= signed_short_int_Array_0[0]) ? (double_Array_0[0] == ((double) ((((double_Array_0[1]) > (10.2)) ? (double_Array_0[1]) : (10.2))))) : 1) : (double_Array_0[0] == ((double) double_Array_0[1]))) : (double_Array_0[0] == ((double) double_Array_0[1]))) : 1)
;
}
int main(void) {
 isInitial = 1;
