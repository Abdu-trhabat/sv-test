...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch76Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req10Batch76Amount100
	unsigned long int stepLocal_5 = max (last_1_var_1_19 , 128u);
	signed long int stepLocal_4 = last_1_var_1_28;
	if (var_1_27 >= stepLocal_5) {
		var_1_30 = (var_1_31 + (min ((max (var_1_32 , var_1_33)) , (abs (var_1_34)))));
	} else {
		if (var_1_17 > stepLocal_4) {
			if (last_1_var_1_11 <= var_1_31) {
				var_1_30 = ((128.5 + (9.75 + var_1_35)) - var_1_13);
			} else {
				var_1_30 = (max (var_1_12 , (var_1_14 - (var_1_35 + var_1_36))));
			}
		} else {
			if (! last_1_var_1_1) {
				if (last_1_var_1_1) {
	...
	// From: Req9Batch76Amount100
	if (var_1_13 > var_1_14) {
		if (last_1_var_1_11 > (last_1_var_1_30 / (abs (var_1_29)))) {
			if (last_1_var_1_1) {
	...
	// From: Req8Batch76Amount100
	signed long int stepLocal_3 = max (var_1_7 , var_1_17);
	if (stepLocal_3 <= (max (var_1_28 , last_1_var_1_25))) {
		var_1_25 = ((min (var_1_26 , var_1_27)) - (max (var_1_17 , last_1_var_1_25)));
	} else {
		var_1_25 = var_1_23;
	}


	// From: Req4Batch76Amount100
...
int property(void) {
	return ((((((((((! (var_1_2 || var_1_3)) ? (var_1_1 == ((unsigned char) (var_1_4 || var_1_5))) : (var_1_1 == ((unsigned char) var_1_6))) && ((0.5 < var_1_11) ? ((var_1_11 >= var_1_30) ? ((! var_1_1) ? (var_1_7 == ((unsigned char) var_1_10)) : 1) : (var_1_7 == ((unsigned char) var_1_10))) : (var_1_7 == ((unsigned char) 64)))) && ((-8 <= (-1 ^ var_1_10)) ? (var_1_11 == ((double) (var_1_12 - var_1_13))) : (var_1_11 == ((double) (var_1_14 - var_1_13))))) && ((last_1_var_1_15 <= (- (var_1_10 + var_1_7))) ? (var_1_15 == ((unsigned char) var_1_10)) : (var_1_15 == ((unsigned char) (min (var_1_10 , (min ((var_1_17 - 16) , var_1_18)))))))) && ((var_1_18 < (- var_1_21)) ? ((1 > var_1_18) ? (var_1_19 == ((unsigned long int) var_1_25)) : 1) : 1)) && (((var_1_17 != (var_1_22 - var_1_23)) && ((last_1_var_1_21 + 5) > var_1_18)) ? (var_1_21 == ((signed short int) var_1_18)) : (var_1_21 == ((signed short int) var_1_10)))) && ((var_1_14 >= var_1_12) ? (var_1_24 == ((float) (abs (abs (var_1_12))))) : ((var_1_30 > var_1_14) ? (var_1_24 == ((float) var_1_13)) : (var_1_24 == ((float) 1.75f))))) && (((max (var_1_7 , var_1_17)) <= (max (var_1_28 , last_1_var_1_25))) ? (var_1_25 == ((unsigned long int) ((min (var_1_26 , var_1_27)) - (max (var_1_17 , last_1_var_1_25))))) : (var_1_25 == ((unsigned long int) var_1_23)))) && ((var_1_13 > var_1_14) ? ((last_1_var_1_11 > (last_1_var_1_30 / (abs (var_1_29)))) ? (last_1_var_1_1 ? (var_1_28 == ((signed short int) last_1_var_1_21)) : (var_1_28 == ((signed short int) var_1_18))) : (var_1_28 == ((signed short int) var_1_17))) : (var_1_28 == ((signed short int) last_1_var_1_21)))) && ((var_1_27 >= (max (last_1_var_1_19 , 128u))) ? (var_1_30 == ((double) (var_1_31 + (min ((max (var_1_32 , var_1_33)) , (abs (var_1_34))))))) : ((var_1_17 > last_1_var_1_28) ? ((last_1_var_1_11 <= var_1_31) ? (var_1_30 == ((double) ((128.5 + (9.75 + var_1_35)) - var_1_13))) : (var_1_30 == ((double) (max (var_1_12 , (var_1_14 - (var_1_35 + var_1_36))))))) : ((! last_1_var_1_1) ? (last_1_var_1_1 ? (var_1_30 == ((double) var_1_37)) : (var_1_30 == ((double) var_1_38))) : (var_1_30 == ((double) var_1_12)))))
;
}
int main(void) {
	isInitial = 1;
