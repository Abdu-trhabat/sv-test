...
void step(void) {
 ...
 if (var_1_30 < stepLocal_3) {
  var_1_16 = ((var_1_15 + var_1_17) + ((((var_1_14) > (var_1_18)) ? (var_1_14) : (var_1_18))));
 } else {
  var_1_16 = var_1_17;
 }
 signed long int stepLocal_4 = (((((((var_1_15) > (var_1_13)) ? (var_1_15) : (var_1_13)))) > (var_1_8)) ? (((((var_1_15) > (var_1_13)) ? (var_1_15) : (var_1_13)))) : (var_1_8));
 ...
 signed long int stepLocal_2 = (((var_1_8) < (var_1_10)) ? (var_1_8) : (var_1_10));
 ...
 if (stepLocal_8 && (var_1_14 < var_1_12)) {
  if (stepLocal_7 > (var_1_13 | var_1_11)) {
   var_1_31 = ((((-8) < (var_1_32)) ? (-8) : (var_1_32)));
  } else {
   var_1_31 = var_1_32;
  }
 }
...
int property(void) {
 return (((((((((((((((var_1_16 <= ((var_1_29 + var_1_33) * var_1_8)) ? (var_1_21 ? (var_1_1 == ((float) ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))))) : (var_1_1 == ((float) var_1_7))) : (var_1_1 == ((float) var_1_7))) && ((var_1_21 && (var_1_30 < var_1_29)) ? (var_1_8 == ((signed short int) var_1_10)) : (var_1_8 == ((signed short int) (-8 + var_1_11))))) && ((last_1_var_1_12 == ((((var_1_8) < (var_1_10)) ? (var_1_8) : (var_1_10)))) ? ((var_1_33 != (var_1_29 * last_1_var_1_12)) ? (var_1_21 ? (var_1_12 == ((signed long int) (var_1_13 - (var_1_14 - var_1_15)))) : 1) : (var_1_12 == ((signed long int) var_1_8))) : (var_1_12 == ((signed long int) var_1_11)))) && ((var_1_30 < var_1_29) ? (var_1_16 == ((unsigned long int) ((var_1_15 + var_1_17) + ((((var_1_14) > (var_1_18)) ? (var_1_14) : (var_1_18)))))) : (var_1_16 == ((unsigned long int) var_1_17)))) && ((var_1_29 <= ((((((((var_1_15) > (var_1_13)) ? (var_1_15) : (var_1_13)))) > (var_1_8)) ? (((((var_1_15) > (var_1_13)) ? (var_1_15) : (var_1_13)))) : (var_1_8)))) ? (var_1_21 ? (var_1_19 == ((unsigned char) var_1_20)) : (var_1_26 ? (var_1_19 == ((unsigned char) var_1_20)) : (var_1_19 == ((unsigned char) 64)))) : 1)) && ((last_1_var_1_12 < ((last_1_var_1_29 / -8) & var_1_13)) ? (var_1_21 == ((unsigned char) ((var_1_22 || var_1_23) || (! (last_1_var_1_26 || var_1_24))))) : (var_1_21 == ((unsigned char) var_1_24)))) && ((! ((var_1_16 > var_1_20) && var_1_26)) ? (var_1_25 == ((unsigned char) var_1_20)) : (var_1_25 == ((unsigned char) ((((32) < 0 ) ? -(32) : (32))))))) && (var_1_26 == ((unsigned char) (var_1_21 || (var_1_24 && (var_1_27 && var_1_28)))))) && ((last_1_var_1_16 > 8) ? (var_1_29 == ((signed short int) (last_1_var_1_25 + (last_1_var_1_16 - var_1_20)))) : (var_1_29 == ((signed short int) var_1_10)))) && (var_1_27 ? (var_1_30 == ((unsigned short int) var_1_20)) : 1)) && ((var_1_27 && (var_1_14 < var_1_12)) ? ((var_1_10 > (var_1_13 | var_1_11)) ? (var_1_31 == ((signed char) ((((-8) < (var_1_32)) ? (-8) : (var_1_32))))) : (var_1_31 == ((signed char) var_1_32))) : 1)) && ((var_1_14 > var_1_18) ? ((var_1_25 > var_1_10) ? (var_1_33 == ((signed short int) (var_1_25 - var_1_38))) : 1) : 1)) && ((! (var_1_14 > (var_1_30 - var_1_12))) ? (var_1_34 == ((double) ((var_1_35 - var_1_36) - var_1_37))) : ((63.8f > var_1_7) ? (var_1_34 == ((double) (var_1_35 - var_1_37))) : 1))) && (var_1_38 == ((unsigned char) var_1_20))) && (var_1_39 == ((float) var_1_35))
;
}
int main(void) {
 isInitial = 1;
