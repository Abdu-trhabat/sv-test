...
void step(void) {
	// From: Req1Batch176Wrapper_P
	(*(var_1_1_Pointer)) = ((10000000 + 5) - ((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))));


	// From: Req3Batch176Wrapper_P
	if (! ((*(var_1_2_Pointer)) <= (*(var_1_3_Pointer)))) {
		(*(var_1_7_Pointer)) = (min ((*(var_1_2_Pointer)) , (min ((*(var_1_3_Pointer)) , (max (-128 , (*(var_1_8_Pointer))))))));
	}


	// From: Req4Batch176Wrapper_P
	unsigned long int stepLocal_2 = max ((*(var_1_10_Pointer)) , (*(var_1_1_Pointer)));
	if (stepLocal_2 >= (*(var_1_5_Pointer))) {
		(*(var_1_9_Pointer)) = (16 + (*(var_1_11_Pointer)));
	}


	// From: Req5Batch176Wrapper_P
	if (((*(var_1_2_Pointer)) * (*(var_1_1_Pointer))) <= (*(var_1_7_Pointer))) {
		(*(var_1_12_Pointer)) = (*(var_1_13_Pointer));
	}


	// From: Req2Batch176Wrapper_P
...
int property(void) {
	return (((((*(var_1_1_Pointer)) == ((signed long int) ((10000000 + 5) - ((*(var_1_2_Pointer)) - (*(var_1_3_Pointer)))))) && (((*(var_1_2_Pointer)) > (*(var_1_3_Pointer))) ? ((((*(var_1_7_Pointer)) * ((*(var_1_2_Pointer)) * (*(var_1_3_Pointer)))) > (-1 / (*(var_1_5_Pointer)))) ? ((*(var_1_4_Pointer)) == ((double) (*(var_1_6_Pointer)))) : ((*(var_1_4_Pointer)) == ((double) 63.75))) : ((*(var_1_4_Pointer)) == ((double) 10.2)))) && ((! ((*(var_1_2_Pointer)) <= (*(var_1_3_Pointer)))) ? ((*(var_1_7_Pointer)) == ((signed long int) (min ((*(var_1_2_Pointer)) , (min ((*(var_1_3_Pointer)) , (max (-128 , (*(var_1_8_Pointer)))))))))) : 1)) && (((max ((*(var_1_10_Pointer)) , (*(var_1_1_Pointer)))) >= (*(var_1_5_Pointer))) ? ((*(var_1_9_Pointer)) == ((unsigned char) (16 + (*(var_1_11_Pointer))))) : 1)) && ((((*(var_1_2_Pointer)) * (*(var_1_1_Pointer))) <= (*(var_1_7_Pointer))) ? ((*(var_1_12_Pointer)) == ((unsigned char) (*(var_1_13_Pointer)))) : 1)
;
}
int main(void) {
	isInitial = 1;
