...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch93Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject8
	/* 363L, 255L) */ if (/* 364L, 182L, 183L) */ ((var_1_28) > (var_1_13))) {
		/* 367L, 249L) */ if (/* 368L, 191L, 192L) */ ((var_1_20) <= (var_1_45))) {
			/* 371L, 243L) */ if (/* 372L, 204L, 205L) */ ((/* 373L, 202L, 206L) */ ((/* 374L, 200L, 207L) */ ((var_1_30) - (var_1_29))) / (var_1_52))) > (var_1_32))) {
				/* 379L, 222L) */ var_1_51 = (
					var_1_49
				);
			} else {
	...
	// From: CodeObject4
	/* 316L, 138L) */ if (/* 317L, 98L, 99L) */ ((/* 318L, 96L, 100L) */ ((var_1_14) + (/* 320L, 95L, 102L) */ (min (/* 320L, 95L, 102L) */ (var_1_9) , (var_1_21)))))) <= (var_1_20))) {
		/* 324L, 136L) */ if (/* 325L, 118L, 119L) */ ((var_1_29) == (/* 327L, 117L, 121L) */ (max (/* 327L, 117L, 121L) */ (/* 328L, 115L, 122L) */ (abs (var_1_32))) , (var_1_28)))))) {
			/* 331L, 135L) */ var_1_40 = (
				/* 334L, 134L) */ (abs (
					var_1_45
				))
	...
	// From: CodeObject7
	/* 346L, 176L) */ if (/* 347L, 160L, 161L) */ ((var_1_27) >= (var_1_29))) {
		/* 350L, 175L) */ var_1_48 = (
			/* 353L, 174L) */ ((
				var_1_49
			) - (
