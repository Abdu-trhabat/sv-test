...
void step(void) {
	// From: Req1Batch110Wrapper_P
	signed long int stepLocal_0 = (min ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) / (*(var_1_6_Pointer));
	...
	// From: Req2Batch110Wrapper_P
	if ((*(var_1_3_Pointer)) <= ((*(var_1_6_Pointer)) * (max ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))))) {
		if ((min (((*(var_1_6_Pointer)) * (*(var_1_4_Pointer))) , ((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))))) > (min ((*(var_1_3_Pointer)) , (*(var_1_5_Pointer))))) {
			(*(var_1_10_Pointer)) = (*(var_1_13_Pointer));
		}
	}


	// From: Req3Batch110Wrapper_P
	if ((*(var_1_1_Pointer))) {
		(*(var_1_14_Pointer)) = ((min ((*(var_1_15_Pointer)) , (*(var_1_16_Pointer)))) + (*(var_1_17_Pointer)));
	} else {
		(*(var_1_14_Pointer)) = ((*(var_1_18_Pointer)) - (*(var_1_19_Pointer)));
	}


	// From: Req4Batch110Wrapper_P
	signed long int stepLocal_1 = (*(var_1_5_Pointer));
	if (stepLocal_1 <= ((*(var_1_12_Pointer)) << (max ((*(var_1_21_Pointer)) , (*(var_1_22_Pointer)))))) {
		(*(var_1_20_Pointer)) = -64;
	}
}
...
int property(void) {
	return (((((*(var_1_3_Pointer)) != ((min ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) / (*(var_1_6_Pointer)))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (! (*(var_1_7_Pointer))))) : ((*(var_1_1_Pointer)) == ((unsigned char) (((*(var_1_7_Pointer)) && (*(var_1_8_Pointer))) && (*(var_1_9_Pointer)))))) && (((*(var_1_3_Pointer)) <= ((*(var_1_6_Pointer)) * (max ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))))) ? (((min (((*(var_1_6_Pointer)) * (*(var_1_4_Pointer))) , ((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))))) > (min ((*(var_1_3_Pointer)) , (*(var_1_5_Pointer))))) ? ((*(var_1_10_Pointer)) == ((double) (*(var_1_13_Pointer)))) : 1) : 1)) && ((*(var_1_1_Pointer)) ? ((*(var_1_14_Pointer)) == ((signed short int) ((min ((*(var_1_15_Pointer)) , (*(var_1_16_Pointer)))) + (*(var_1_17_Pointer))))) : ((*(var_1_14_Pointer)) == ((signed short int) ((*(var_1_18_Pointer)) - (*(var_1_19_Pointer))))))) && (((*(var_1_5_Pointer)) <= ((*(var_1_12_Pointer)) << (max ((*(var_1_21_Pointer)) , (*(var_1_22_Pointer)))))) ? ((*(var_1_20_Pointer)) == ((signed char) -64)) : 1)
;
}
int main(void) {
	isInitial = 1;
