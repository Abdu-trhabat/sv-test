...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch94Amount100.c", 13, "reach_error"); }
...
void step(void) {
 if (last_1_var_1_9 || var_1_14) {
  if (var_1_25 >= (128 + last_1_var_1_29)) {
   if (var_1_24 > var_1_25) {
    if (var_1_25 <= var_1_6) {
     var_1_31 = (((((var_1_24 - var_1_25)) < (var_1_17)) ? ((var_1_24 - var_1_25)) : (var_1_17)));
    } else {
 ...
 if (var_1_6 >= (var_1_29 >> 4)) {
  var_1_15 = (((((var_1_29 + var_1_16)) < ((last_1_var_1_15 + (var_1_6 + var_1_17)))) ? ((var_1_29 + var_1_16)) : ((last_1_var_1_15 + (var_1_6 + var_1_17)))));
 }
 ...
 if (var_1_9) {
  if (var_1_3 <= ((((499.25) < (999999.3)) ? (499.25) : (999999.3)))) {
   var_1_4 = var_1_6;
  }
 }
 if (var_1_3 != (var_1_2 / var_1_22)) {
  var_1_21 = (var_1_23 + ((((var_1_24) < (var_1_25)) ? (var_1_24) : (var_1_25))));
 }
 unsigned char stepLocal_5 = var_1_9 && var_1_13;
 if ((var_1_19 < var_1_15) || stepLocal_5) {
  var_1_30 = (var_1_25 - (var_1_23 + var_1_15));
 } else {
  var_1_30 = ((((var_1_19) < ((var_1_29 - var_1_23))) ? (var_1_19) : ((var_1_29 - var_1_23))));
 }
 var_1_33 = var_1_3;
...
int property(void) {
 return (((((((((((var_1_1 == ((double) ((((9.999999999999925E13) < ((var_1_2 + ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))))) ? (9.999999999999925E13) : ((var_1_2 + ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))))))))) && (var_1_9 ? ((var_1_3 <= ((((499.25) < (999999.3)) ? (499.25) : (999999.3)))) ? (var_1_4 == ((unsigned char) var_1_6)) : 1) : 1)) && ((var_1_6 > (var_1_15 * var_1_29)) ? (((var_1_6 <= var_1_29) && var_1_9) ? (var_1_7 == ((float) var_1_3)) : 1) : 1)) && (var_1_5 ? ((var_1_11 || var_1_10) ? ((! (last_1_var_1_7 < var_1_2)) ? (var_1_9 == ((unsigned char) (var_1_12 || var_1_13))) : (var_1_9 == ((unsigned char) (var_1_11 && ((var_1_12 && var_1_13) || (! var_1_14)))))) : 1) : 1)) && ((var_1_6 >= (var_1_29 >> 4)) ? (var_1_15 == ((signed long int) (((((var_1_29 + var_1_16)) < ((last_1_var_1_15 + (var_1_6 + var_1_17)))) ? ((var_1_29 + var_1_16)) : ((last_1_var_1_15 + (var_1_6 + var_1_17))))))) : 1)) && ((var_1_3 != var_1_33) ? (((var_1_17 <= var_1_31) && var_1_9) ? (var_1_18 == ((signed char) var_1_19)) : (var_1_18 == ((signed char) var_1_20))) : (var_1_18 == ((signed char) var_1_20)))) && ((var_1_3 != (var_1_2 / var_1_22)) ? (var_1_21 == ((unsigned char) (var_1_23 + ((((var_1_24) < (var_1_25)) ? (var_1_24) : (var_1_25)))))) : 1)) && (((var_1_25 / (var_1_27 + var_1_28)) > var_1_15) ? (((- var_1_31) < var_1_24) ? (var_1_26 == ((unsigned short int) 25)) : (var_1_26 == ((unsigned short int) last_1_var_1_26))) : (var_1_26 == ((unsigned short int) var_1_23)))) && ((var_1_22 <= (last_1_var_1_7 + last_1_var_1_33)) ? (var_1_29 == ((unsigned short int) 32)) : ((var_1_25 > last_1_var_1_26) ? (var_1_29 == ((unsigned short int) last_1_var_1_26)) : (var_1_29 == ((unsigned short int) last_1_var_1_29))))) && (((var_1_19 < var_1_15) || (var_1_9 && var_1_13)) ? (var_1_30 == ((signed short int) (var_1_25 - (var_1_23 + var_1_15)))) : (var_1_30 == ((signed short int) ((((var_1_19) < ((var_1_29 - var_1_23))) ? (var_1_19) : ((var_1_29 - var_1_23)))))))) && ((last_1_var_1_9 || var_1_14) ? ((var_1_25 >= (128 + last_1_var_1_29)) ? ((var_1_24 > var_1_25) ? ((var_1_25 <= var_1_6) ? (var_1_31 == ((signed long int) (((((var_1_24 - var_1_25)) < (var_1_17)) ? ((var_1_24 - var_1_25)) : (var_1_17))))) : (var_1_31 == ((signed long int) (var_1_16 + var_1_32)))) : 1) : 1) : (last_1_var_1_9 ? (((var_1_20 <= 5) && var_1_14) ? (var_1_31 == ((signed long int) last_1_var_1_29)) : (var_1_31 == ((signed long int) last_1_var_1_18))) : 1))) && (var_1_33 == ((double) var_1_3))
;
}
int main(void) {
 isInitial = 1;
