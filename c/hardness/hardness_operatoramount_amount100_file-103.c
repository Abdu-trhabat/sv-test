...
void step(void) {
	...
	// From: Req8Batch103Amount100
	var_1_26 = (var_1_21 || (var_1_24 && (var_1_27 && var_1_28)));


	// From: Req9Batch103Amount100
	...
	// From: Req10Batch103Amount100
	if (var_1_27) {
		var_1_30 = var_1_20;
	}


	// From: Req14Batch103Amount100
	var_1_38 = var_1_20;


	// From: Req15Batch103Amount100
	var_1_39 = var_1_35;


	// From: Req2Batch103Amount100
