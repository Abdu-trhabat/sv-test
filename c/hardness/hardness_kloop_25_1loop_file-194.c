...
void step(void) {
	// From: Req4Batch19425_1loop
	var_1_19 = var_1_8;


	// From: Req5Batch19425_1loop
	var_1_20 = var_1_21;


	// From: Req3Batch19425_1loop
	if (((var_1_13 + var_1_14) - var_1_20) != var_1_4) {
		var_1_12 = (max (((var_1_15 + var_1_16) - var_1_17) , var_1_18));
	} else {
		var_1_12 = var_1_15;
	}


	// From: Req1Batch19425_1loop
	...
	// From: Req2Batch19425_1loop
	unsigned long int stepLocal_1 = 5u;
	if (var_1_4 <= stepLocal_1) {
		var_1_9 = (last_1_var_1_9 - (max (var_1_12 , (min (var_1_10 , var_1_11)))));
	}
}
...
int property(void) {
	return ((((var_1_2 ? (((var_1_3 == var_1_4) && ((var_1_12 % var_1_7) >= var_1_20)) ? (var_1_1 == ((signed char) var_1_8)) : 1) : (var_1_1 == ((signed char) -16))) && ((var_1_4 <= 5u) ? (var_1_9 == ((signed long int) (last_1_var_1_9 - (max (var_1_12 , (min (var_1_10 , var_1_11))))))) : 1)) && ((((var_1_13 + var_1_14) - var_1_20) != var_1_4) ? (var_1_12 == ((unsigned short int) (max (((var_1_15 + var_1_16) - var_1_17) , var_1_18)))) : (var_1_12 == ((unsigned short int) var_1_15)))) && (var_1_19 == ((signed char) var_1_8))) && (var_1_20 == ((signed long int) var_1_21))
;
}
int main(void) {
	isInitial = 1;
