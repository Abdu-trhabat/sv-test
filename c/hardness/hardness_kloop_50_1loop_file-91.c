...
void step(void) {
	// From: Req4Batch9150_1loop
	var_1_16 = (max (var_1_6 , (var_1_8 - 8)));


	// From: Req5Batch9150_1loop
	var_1_17 = (var_1_18 - var_1_7);


	// From: Req8Batch9150_1loop
	var_1_24 = var_1_7;


	// From: Req9Batch9150_1loop
	var_1_25 = var_1_6;


	// From: Req10Batch9150_1loop
	var_1_26 = var_1_5;


	// From: Req2Batch9150_1loop
	...
	// From: Req7Batch9150_1loop
	var_1_23 = var_1_12;


	// From: Req1Batch9150_1loop
	if (var_1_24 == var_1_23) {
		if (var_1_23 <= (max (var_1_24 , var_1_9))) {
			var_1_1 = (var_1_23 + (min ((var_1_5 - var_1_6) , (var_1_7 - var_1_8))));
		} else {
...
int property(void) {
	return ((((((((((var_1_24 == var_1_23) ? ((var_1_23 <= (max (var_1_24 , var_1_9))) ? (var_1_1 == ((signed short int) (var_1_23 + (min ((var_1_5 - var_1_6) , (var_1_7 - var_1_8)))))) : (var_1_1 == ((signed short int) (min ((var_1_8 - var_1_6) , ((var_1_7 - var_1_5) + -256)))))) : 1) && (var_1_10 ? (var_1_9 == ((signed char) var_1_11)) : ((var_1_7 <= (var_1_6 << var_1_11)) ? ((var_1_25 < var_1_5) ? (var_1_9 == ((signed char) var_1_11)) : 1) : (var_1_9 == ((signed char) var_1_11))))) && (((max (var_1_13 , (var_1_14 + var_1_15))) <= 31.5) ? ((var_1_8 != var_1_9) ? (var_1_12 == ((signed long int) last_1_var_1_12)) : (var_1_12 == ((signed long int) var_1_7))) : (var_1_12 == ((signed long int) var_1_11)))) && (var_1_16 == ((signed long int) (max (var_1_6 , (var_1_8 - 8)))))) && (var_1_17 == ((unsigned long int) (var_1_18 - var_1_7)))) && ((var_1_9 < var_1_1) ? (var_1_19 == ((double) ((var_1_20 + 128.8) + var_1_21))) : ((var_1_21 <= var_1_22) ? (var_1_19 == ((double) var_1_20)) : 1))) && (var_1_23 == ((signed short int) var_1_12))) && (var_1_24 == ((signed short int) var_1_7))) && (var_1_25 == ((signed long int) var_1_6))) && (var_1_26 == ((signed short int) var_1_5))
;
}
int main(void) {
	isInitial = 1;
