...
void step(void) {
	// From: Req2Batch10925_while
	signed char stepLocal_1 = var_1_5;
	if (var_1_4 <= stepLocal_1) {
		var_1_6 = (last_1_var_1_10 + (var_1_4 + last_1_var_1_1));
	} else {
		var_1_6 = (max (last_1_var_1_1 , ((var_1_5 + 16) - var_1_7)));
	}


	// From: Req4Batch10925_while
	var_1_10 = var_1_5;


	// From: Req5Batch10925_while
	var_1_11 = var_1_12;


	// From: Req3Batch10925_while
