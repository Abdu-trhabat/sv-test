...
void step(void) {
 if (8 >= (signed_long_int_Array_0[1] + signed_long_int_Array_0[0])) {
  signed_short_int_Array_0[1][1] = ((((signed_short_int_Array_0[0][1]) < ((signed_short_int_Array_0[1][0] + 10))) ? (signed_short_int_Array_0[0][1]) : ((signed_short_int_Array_0[1][0] + 10))));
 }
 ...
 if (stepLocal_3 || (! BOOL_unsigned_char_Array_0[2])) {
  if (stepLocal_4 < unsigned_short_int_Array_0[1]) {
   signed_short_int_Array_0[0][0] = ((((signed_short_int_Array_0[1][0]) < (signed_short_int_Array_0[0][1])) ? (signed_short_int_Array_0[1][0]) : (signed_short_int_Array_0[0][1])));
  } else {
 ...
 if (unsigned_short_int_Array_0[1] <= stepLocal_2) {
  if (signed_long_int_Array_0[0] >= stepLocal_1) {
   double_Array_0[1][0] = (double_Array_0[0][0] + (((((((double_Array_0[0][1]) < (double_Array_0[1][1])) ? (double_Array_0[0][1]) : (double_Array_0[1][1]))) < 0 ) ? -((((double_Array_0[0][1]) < (double_Array_0[1][1])) ? (double_Array_0[0][1]) : (double_Array_0[1][1]))) : ((((double_Array_0[0][1]) < (double_Array_0[1][1])) ? (double_Array_0[0][1]) : (double_Array_0[1][1]))))));
  }
 } else {
...
int property(void) {
 return ((((8 >= (signed_long_int_Array_0[1] + signed_long_int_Array_0[0])) ? (signed_short_int_Array_0[1][1] == ((signed short int) ((((signed_short_int_Array_0[0][1]) < ((signed_short_int_Array_0[1][0] + 10))) ? (signed_short_int_Array_0[0][1]) : ((signed_short_int_Array_0[1][0] + 10)))))) : 1) && ((signed_long_int_Array_0[0] <= signed_long_int_Array_0[1]) ? (unsigned_short_int_Array_0[2] == ((unsigned short int) (unsigned_short_int_Array_0[1] + unsigned_short_int_Array_0[0]))) : 1)) && ((unsigned_short_int_Array_0[1] <= (unsigned_short_int_Array_0[2] + signed_short_int_Array_0[0][0])) ? ((signed_long_int_Array_0[0] >= unsigned_short_int_Array_0[1]) ? (double_Array_0[1][0] == ((double) (double_Array_0[0][0] + (((((((double_Array_0[0][1]) < (double_Array_0[1][1])) ? (double_Array_0[0][1]) : (double_Array_0[1][1]))) < 0 ) ? -((((double_Array_0[0][1]) < (double_Array_0[1][1])) ? (double_Array_0[0][1]) : (double_Array_0[1][1]))) : ((((double_Array_0[0][1]) < (double_Array_0[1][1])) ? (double_Array_0[0][1]) : (double_Array_0[1][1])))))))) : 1) : (double_Array_0[1][0] == ((double) (double_Array_0[1][1] + double_Array_0[0][0]))))) && (((BOOL_unsigned_char_Array_0[0] || BOOL_unsigned_char_Array_0[1]) || (! BOOL_unsigned_char_Array_0[2])) ? ((unsigned_short_int_Array_0[2] < unsigned_short_int_Array_0[1]) ? (signed_short_int_Array_0[0][0] == ((signed short int) ((((signed_short_int_Array_0[1][0]) < (signed_short_int_Array_0[0][1])) ? (signed_short_int_Array_0[1][0]) : (signed_short_int_Array_0[0][1]))))) : (BOOL_unsigned_char_Array_0[2] ? (signed_short_int_Array_0[0][0] == ((signed short int) signed_short_int_Array_0[1][0])) : 1)) : (signed_short_int_Array_0[0][0] == ((signed short int) signed_short_int_Array_0[1][0])))
;
}
int main(void) {
 isInitial = 1;
