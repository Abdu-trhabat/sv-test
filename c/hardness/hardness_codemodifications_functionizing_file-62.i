...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch62functionizing.c", 13, "reach_error"); }
...
double functionized1(double, double);
void functionized2(double, double, double, signed long int);
...
void functionized0(signed long int functionized0_localFunctionVar0) {
 if (var_1_2 > ((var_1_3 % functionized0_localFunctionVar0) * var_1_5)) {
...
double functionized1(double functionized1_localFunctionVar0, double functionized1_localFunctionVar1) {
 return ((((functionized1_localFunctionVar1) < (functionized1_localFunctionVar0)) ? (functionized1_localFunctionVar1) : (functionized1_localFunctionVar0)));
}
void functionized2(double functionized2_localFunctionVar0, double functionized2_localFunctionVar1, double functionized2_localFunctionVar2, signed long int functionized2_localFunctionVar3) {
 if (var_1_16 < ((((functionized2_localFunctionVar2) > (functionized2_localFunctionVar0)) ? (functionized2_localFunctionVar2) : (functionized2_localFunctionVar0)))) {
  if (-5 < (var_1_17 + functionized2_localFunctionVar3)) {
   var_1_21 = ((((var_1_15) > ((functionized2_localFunctionVar2 - functionized2_localFunctionVar1))) ? (var_1_15) : ((functionized2_localFunctionVar2 - functionized2_localFunctionVar1))));
  } else {
   var_1_21 = var_1_14;
  }
 } else {
...
void step(void) {
 ...
 var_1_13 = ((functionized1(var_1_8, var_1_7)) + (var_1_14 + var_1_15));
 if ((- var_1_3) <= -100000) {
 ...
 functionized2(var_1_20, var_1_6, var_1_7, var_1_4);
}
void updateVariables(void) {
