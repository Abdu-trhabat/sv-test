...
void step(void) {
	...
	// From: Req4Batch145Wrapper_SP
	unsigned short int stepLocal_3 = (*(WrapperStruct00_var_1_8_Pointer));
	if ((*(WrapperStruct00_var_1_14_Pointer)) <= (min ((*(WrapperStruct00_var_1_13_Pointer)) , (*(WrapperStruct00_var_1_16_Pointer))))) {
		if ((min ((*(WrapperStruct00_var_1_9_Pointer)) , ((*(WrapperStruct00_var_1_9_Pointer)) & (*(WrapperStruct00_var_1_5_Pointer))))) < stepLocal_3) {
			(*(WrapperStruct00_var_1_15_Pointer)) = (*(WrapperStruct00_var_1_6_Pointer));
		} else {
			(*(WrapperStruct00_var_1_15_Pointer)) = (min ((min ((*(WrapperStruct00_var_1_7_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer)))) , (*(WrapperStruct00_var_1_17_Pointer))));
		}
	} else {
		(*(WrapperStruct00_var_1_15_Pointer)) = (*(WrapperStruct00_var_1_6_Pointer));
	}
