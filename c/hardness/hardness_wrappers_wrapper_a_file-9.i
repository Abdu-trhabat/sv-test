...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch9Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 if (last_1_float_Array_0_2_ > 9999999.5f) {
  signed_long_int_Array_0[0] = ((signed_long_int_Array_0[1] - last_1_signed_long_int_Array_0_0_) - unsigned_char_Array_0[0]);
 } else {
  signed_long_int_Array_0[0] = ((((((last_1_unsigned_char_Array_0_1_ - unsigned_char_Array_0[0]) + (last_1_unsigned_short_int_Array_0_0_ - last_1_signed_long_int_Array_0_0_))) > (signed_long_int_Array_0[1])) ? (((last_1_unsigned_char_Array_0_1_ - unsigned_char_Array_0[0]) + (last_1_unsigned_short_int_Array_0_0_ - last_1_signed_long_int_Array_0_0_))) : (signed_long_int_Array_0[1])));
 }
 if (last_1_signed_long_int_Array_0_0_ <= 16) {
  unsigned_char_Array_0[1] = unsigned_char_Array_0[0];
 } else {
  if (((((float_Array_0[6]) > (float_Array_0[5])) ? (float_Array_0[6]) : (float_Array_0[5]))) < float_Array_0[4]) {
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  if ((- signed_long_int_Array_0[0]) >= stepLocal_0) {
   float_Array_0[2] = (float_Array_0[0] + float_Array_0[1]);
  }
 } else {
  float_Array_0[2] = ((((float_Array_0[1]) < (float_Array_0[3])) ? (float_Array_0[1]) : (float_Array_0[3])));
 }
 unsigned_short_int_Array_0[0] = ((((unsigned_char_Array_0[1]) > (unsigned_char_Array_0[0])) ? (unsigned_char_Array_0[1]) : (unsigned_char_Array_0[0])));
}
void updateVariables(void) {
...
int property(void) {
 return ((((last_1_signed_long_int_Array_0_0_ <= 16) ? (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[0])) : ((((((float_Array_0[6]) > (float_Array_0[5])) ? (float_Array_0[6]) : (float_Array_0[5]))) < float_Array_0[4]) ? (BOOL_unsigned_char_Array_0[0] ? (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[0])) : (unsigned_char_Array_0[1] == ((unsigned char) 64))) : (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[0])))) && (unsigned_short_int_Array_0[0] == ((unsigned short int) ((((unsigned_char_Array_0[1]) > (unsigned_char_Array_0[0])) ? (unsigned_char_Array_0[1]) : (unsigned_char_Array_0[0])))))) && ((last_1_float_Array_0_2_ > 9999999.5f) ? (signed_long_int_Array_0[0] == ((signed long int) ((signed_long_int_Array_0[1] - last_1_signed_long_int_Array_0_0_) - unsigned_char_Array_0[0]))) : (signed_long_int_Array_0[0] == ((signed long int) ((((((last_1_unsigned_char_Array_0_1_ - unsigned_char_Array_0[0]) + (last_1_unsigned_short_int_Array_0_0_ - last_1_signed_long_int_Array_0_0_))) > (signed_long_int_Array_0[1])) ? (((last_1_unsigned_char_Array_0_1_ - unsigned_char_Array_0[0]) + (last_1_unsigned_short_int_Array_0_0_ - last_1_signed_long_int_Array_0_0_))) : (signed_long_int_Array_0[1]))))))) && (BOOL_unsigned_char_Array_0[0] ? (((- signed_long_int_Array_0[0]) >= signed_long_int_Array_0[0]) ? (float_Array_0[2] == ((float) (float_Array_0[0] + float_Array_0[1]))) : 1) : (float_Array_0[2] == ((float) ((((float_Array_0[1]) < (float_Array_0[3])) ? (float_Array_0[1]) : (float_Array_0[3]))))))
;
}
int main(void) {
 isInitial = 1;
