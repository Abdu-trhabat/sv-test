...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	/* 390L, 255L) */ if (/* 391L, 236L, 237L) */ ((var_1_41) >= (/* 393L, 235L, 239L) */ (min (/* 393L, 235L, 239L) */ (var_1_3) , (0)))))) {
		/* 396L, 254L) */ var_1_43 = (
			/* 399L, 253L) */ (min (
				/* 399L, 253L) */ (
					var_1_18
	...
	// From: CodeObject4
	/* 344L, 184L) */ if (/* 345L, 144L, 145L) */ ((var_1_7) < (/* 347L, 143L, 147L) */ ((var_1_7) / (var_1_37))))) {
		/* 350L, 158L) */ var_1_35 = (
			var_1_9
		);
	} else {
		/* 354L, 182L) */ if (/* 355L, 165L, 166L) */ ((/* 356L, 163L, 167L) */ ((/* 357L, 161L, 168L) */ (abs (var_1_6))) / (var_1_37))) < (var_1_9))) {
			/* 361L, 181L) */ var_1_35 = (
				var_1_6
			);
		}
	...
	// From: CodeObject5
	/* 365L, 224L) */ if (/* 366L, 190L, 191L) */ ((var_1_6) > (var_1_4))) {
	...
	// From: CodeObject2
	/* 309L, 108L) */ if (/* 310L, 72L, 73L) */ ((/* 311L, 67L, 74L) */ ((var_1_6) * (var_1_7))) < (/* 314L, 71L, 77L) */ (abs (var_1_9))))) {
		/* 316L, 102L) */ if (/* 317L, 87L, 88L) */ ((var_1_9) <= (var_1_6))) {
			/* 320L, 97L) */ var_1_29 = (
				var_1_7
			);
		} else {
	...
	// From: CodeObject3
	/* 332L, 136L) */ if (/* 333L, 116L, 117L) */ ((var_1_7) < (/* 335L, 115L, 119L) */ (max (/* 335L, 115L, 119L) */ (var_1_3) , (var_1_2)))))) {
