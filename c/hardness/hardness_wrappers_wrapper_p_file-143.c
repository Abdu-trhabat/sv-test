...
void step(void) {
	...
	if (stepLocal_1 && (! (*(var_1_7_Pointer)))) {
		...
		if (stepLocal_2 != (*(var_1_2_Pointer))) {
			(*(var_1_6_Pointer)) = (min ((*(var_1_8_Pointer)) , (((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) + (*(var_1_11_Pointer)))));
		} else {
...
int property(void) {
	return ((((- last_1_var_1_12) <= last_1_var_1_12) ? ((! (*(var_1_4_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed short int) (abs (1 - (*(var_1_5_Pointer)))))) : 1) : ((*(var_1_1_Pointer)) == ((signed short int) (*(var_1_5_Pointer))))) && (((*(var_1_4_Pointer)) && (! (*(var_1_7_Pointer)))) ? ((*(var_1_6_Pointer)) == ((unsigned char) (*(var_1_8_Pointer)))) : (((*(var_1_1_Pointer)) != (*(var_1_2_Pointer))) ? ((*(var_1_6_Pointer)) == ((unsigned char) (min ((*(var_1_8_Pointer)) , (((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) + (*(var_1_11_Pointer))))))) : ((*(var_1_6_Pointer)) == ((unsigned char) (*(var_1_11_Pointer))))))) && ((*(var_1_4_Pointer)) ? (((*(var_1_7_Pointer)) && (*(var_1_13_Pointer))) ? ((*(var_1_12_Pointer)) == ((unsigned long int) (abs (abs ((*(var_1_6_Pointer)) + (*(var_1_2_Pointer))))))) : 1) : (((*(var_1_5_Pointer)) > (*(var_1_9_Pointer))) ? ((*(var_1_12_Pointer)) == ((unsigned long int) (*(var_1_6_Pointer)))) : ((*(var_1_12_Pointer)) == ((unsigned long int) (*(var_1_10_Pointer))))))
;
}
int main(void) {
	isInitial = 1;
