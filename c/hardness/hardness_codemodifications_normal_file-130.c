...
void step(void) {
	...
	// From: Req2Batch130normal
	var_1_10 = (var_1_4 - 256);


	// From: Req3Batch130normal
	if (var_1_5 < 16) {
		if (var_1_1 <= var_1_6) {
			var_1_11 = var_1_12;
		}
