...
void step(void) {
	...
	// From: Req2Batch17525_1loop
	if ((var_1_6 >= var_1_1) || ((var_1_5 / var_1_9) < var_1_1)) {
		var_1_8 = var_1_10;
	}


	// From: Req3Batch17525_1loop
	unsigned char stepLocal_2 = var_1_6;
	signed long int stepLocal_1 = max (var_1_6 , var_1_5);
...
int property(void) {
	return (((var_1_2 > var_1_3) ? (var_1_1 == ((unsigned char) var_1_4)) : (var_1_1 == ((unsigned char) (var_1_5 - (abs (var_1_6 + var_1_7)))))) && (((var_1_6 >= var_1_1) || ((var_1_5 / var_1_9) < var_1_1)) ? (var_1_8 == ((float) var_1_10)) : 1)) && ((var_1_6 >= var_1_4) ? ((9.65 < ((2.8 * var_1_8) + var_1_10)) ? ((32 > (max (var_1_6 , var_1_5))) ? (var_1_11 == ((signed char) (var_1_6 - var_1_7))) : (var_1_11 == ((signed char) var_1_6))) : (var_1_11 == ((signed char) var_1_7))) : 1)
;
}
int main(void) {
	isInitial = 1;
