...
void step(void) {
	...
	// From: Req3Batch197normal
	unsigned char stepLocal_1 = (var_1_13 >> var_1_14) > var_1_3;
	if (stepLocal_1 || var_1_8) {
		var_1_12 = ((abs (200 - var_1_14)) - var_1_15);
	}


	// From: Req1Batch197normal
	if (var_1_2 >= var_1_3) {
		var_1_1 = (min (var_1_4 , (min (var_1_5 , (var_1_6 + var_1_7)))));
	}


	// From: Req4Batch197normal
	if (var_1_14 > (max (var_1_15 , var_1_6))) {
...
int property(void) {
	return ((((var_1_2 >= var_1_3) ? (var_1_1 == ((signed short int) (min (var_1_4 , (min (var_1_5 , (var_1_6 + var_1_7))))))) : 1) && ((! var_1_9) ? ((var_1_4 < last_1_var_1_16) ? (var_1_8 == ((unsigned char) var_1_10)) : (var_1_8 == ((unsigned char) (var_1_10 && var_1_11)))) : 1)) && ((((var_1_13 >> var_1_14) > var_1_3) || var_1_8) ? (var_1_12 == ((unsigned char) ((abs (200 - var_1_14)) - var_1_15))) : 1)) && ((var_1_14 > (max (var_1_15 , var_1_6))) ? (var_1_16 == ((unsigned short int) ((var_1_17 - var_1_14) - var_1_15))) : ((var_1_15 < (var_1_1 * var_1_7)) ? (var_1_16 == ((unsigned short int) var_1_12)) : (var_1_16 == ((unsigned short int) 8))))
;
}
int main(void) {
	isInitial = 1;
