...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch87Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_0 = ((var_1_5) - ( (((((var_1_6)) < ((var_1_7))) ? ((var_1_6)) : ((var_1_7))))));
   ...
   var_1_32
                    ...
                    if ( ((var_1_11) >= (var_1_30))) {
                     if ( (( ((var_1_16) % (var_1_34))) > ( ((var_1_16) + (var_1_32))))) {
                     var_1_33 = (
                      ((((((((2) < 0 ) ? -(2) : (2)))) < 0 ) ? -(((((2) < 0 ) ? -(2) : (2)))) : (((((2) < 0 ) ? -(2) : (2))))))
    );
   } else {
                      if ( (( ((var_1_16) & (var_1_34))) <= ( (((((var_1_16)) < ((var_1_28))) ? ((var_1_16)) : ((var_1_28))))))) {
                       var_1_33 = (
      var_1_32
     );
    } else {
    ...
    var_1_28
                   ...
                   if ( ((var_1_16) > ( (( ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))) << (var_1_16))))) {
                    var_1_35 = (
                     ((
    var_1_32
   ) + (
    var_1_16
                   ...
                   if ( ((var_1_16) == (var_1_34))) {
                    var_1_36 = (
                     ((((( var_1_16 )) > (( var_1_32 ))) ? (( var_1_16 )) : (( var_1_32 ))))
  );
 } else {
                    var_1_36 = (
                     ((((( var_1_32 )) < (( ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))) ))) ? (( var_1_32 )) : (( ((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))) ))))
  );
 }
                   if (var_1_1) {
                    var_1_37 = (
                    ...
                    if ( (( (( ((var_1_36) + (var_1_32))) >> (var_1_39))) > (var_1_16))) {
                     var_1_37 = (
                      ((
     var_1_39
    ) + (
