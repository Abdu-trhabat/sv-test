...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch2100_while.c", 13, "reach_error"); }
...
double var_1_9 = 1000000000000.4;
...
void step(void) {
	...
	unsigned char stepLocal_1 = var_1_1 >= var_1_9;
	...
	if ((var_1_3 / var_1_15) >= (var_1_4 - var_1_16)) {
		...
		var_1_14 = (max ((min (var_1_11 , (var_1_10 + var_1_21))) , var_1_17));
	}
	...
	if (stepLocal_3 <= var_1_19) {
		if ((var_1_1 + var_1_37) != var_1_1) {
			var_1_28 = ((var_1_23 + var_1_27) + ((abs (var_1_24)) + var_1_13));
		}
	} else {
		var_1_28 = var_1_27;
	}
	...
	if ((var_1_35 ^ (max (var_1_28 , var_1_35))) > var_1_10) {
	...
	if (stepLocal_5 >= (var_1_27 - var_1_23)) {
		if (var_1_20 <= stepLocal_6) {
			if (! (var_1_15 > 3.8f)) {
				var_1_29 = (max (var_1_10 , (min (var_1_11 , var_1_27))));
			}
		} else {
			if ((min (var_1_23 , (var_1_24 * var_1_28))) <= stepLocal_4) {
...
int property(void) {
	return (((((((((((((var_1_2 ? (var_1_1 == ((double) (min ((var_1_3 - var_1_4) , var_1_5)))) : ((var_1_6 && var_1_7) ? (var_1_1 == ((double) var_1_4)) : 1)) && (((var_1_1 >= var_1_9) || var_1_2) ? (var_1_7 ? (var_1_8 == ((signed char) (var_1_10 - (abs (25))))) : 1) : (var_1_8 == ((signed char) (-2 + var_1_11))))) && (var_1_7 ? (var_1_12 == ((float) var_1_5)) : 1)) && (var_1_13 == ((signed short int) (abs (last_1_var_1_18))))) && (((var_1_3 / var_1_15) >= (var_1_4 - var_1_16)) ? (var_1_14 == ((signed short int) var_1_11)) : (var_1_14 == ((signed short int) (max ((min (var_1_11 , (var_1_10 + var_1_21))) , var_1_17)))))) && (((var_1_35 ^ (max (var_1_28 , var_1_35))) > var_1_10) ? (var_1_18 == ((signed char) (var_1_11 + var_1_20))) : (var_1_18 == ((signed char) var_1_11)))) && ((var_1_10 <= var_1_17) ? (var_1_21 == ((unsigned char) (min ((var_1_22 + var_1_23) , var_1_24)))) : (var_1_21 == ((unsigned char) 128)))) && (var_1_25 == ((float) ((max (9.999999999999975E13f , var_1_4)) - var_1_3)))) && (((- 4.75) < (- var_1_15)) ? (var_1_26 == ((signed char) (max (var_1_11 , (var_1_10 - 16))))) : (var_1_26 == ((signed char) (var_1_10 - (5 + var_1_27)))))) && ((var_1_14 <= var_1_19) ? (((var_1_1 + var_1_37) != var_1_1) ? (var_1_28 == ((unsigned short int) ((var_1_23 + var_1_27) + ((abs (var_1_24)) + var_1_13)))) : 1) : (var_1_28 == ((unsigned short int) var_1_27)))) && ((var_1_11 >= (var_1_27 - var_1_23)) ? ((var_1_20 <= var_1_27) ? ((! (var_1_15 > 3.8f)) ? (var_1_29 == ((signed char) (max (var_1_10 , (min (var_1_11 , var_1_27)))))) : 1) : (((min (var_1_23 , (var_1_24 * var_1_28))) <= var_1_13) ? (var_1_29 == ((signed char) ((var_1_30 + (1 - var_1_31)) + (var_1_32 + (min (var_1_33 , var_1_34)))))) : 1)) : ((! (var_1_24 <= var_1_27)) ? (var_1_29 == ((signed char) var_1_20)) : ((var_1_27 < var_1_23) ? (var_1_29 == ((signed char) (var_1_27 - var_1_31))) : (var_1_29 == ((signed char) (var_1_34 + var_1_27))))))) && (var_1_35 == ((unsigned long int) var_1_21))) && (var_1_36 == ((float) var_1_3))) && (var_1_37 == ((float) var_1_4))
;
}
int main(void) {
	isInitial = 1;
