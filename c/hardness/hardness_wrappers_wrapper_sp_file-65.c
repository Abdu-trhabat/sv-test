...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_4_Pointer)) > (*(WrapperStruct00_var_1_1_Pointer))) {
		(*(WrapperStruct00_var_1_5_Pointer)) = ((max ((*(WrapperStruct00_var_1_6_Pointer)) , -64)) + (((*(WrapperStruct00_var_1_7_Pointer)) + -2) + (*(WrapperStruct00_var_1_8_Pointer))));
	}
...
int property(void) {
	return ((((((0.625f > last_1_WrapperStruct00_var_1_9) ? ((*(WrapperStruct00_var_1_3_Pointer)) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((float) (abs ((*(WrapperStruct00_var_1_4_Pointer)))))) : 1) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((float) (abs ((*(WrapperStruct00_var_1_4_Pointer))))))) && (((*(WrapperStruct00_var_1_4_Pointer)) > (*(WrapperStruct00_var_1_1_Pointer))) ? ((*(WrapperStruct00_var_1_5_Pointer)) == ((signed long int) ((max ((*(WrapperStruct00_var_1_6_Pointer)) , -64)) + (((*(WrapperStruct00_var_1_7_Pointer)) + -2) + (*(WrapperStruct00_var_1_8_Pointer)))))) : 1)) && ((*(WrapperStruct00_var_1_3_Pointer)) ? (((*(WrapperStruct00_var_1_6_Pointer)) >= (((*(WrapperStruct00_var_1_10_Pointer)) - (*(WrapperStruct00_var_1_11_Pointer))) * 64)) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((double) ((min ((*(WrapperStruct00_var_1_12_Pointer)) , 50.5)) - (*(WrapperStruct00_var_1_13_Pointer))))) : 1) : (((*(WrapperStruct00_var_1_2_Pointer)) <= (*(WrapperStruct00_var_1_1_Pointer))) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((double) ((*(WrapperStruct00_var_1_13_Pointer)) - ((*(WrapperStruct00_var_1_14_Pointer)) - (*(WrapperStruct00_var_1_15_Pointer)))))) : 1))) && ((*(WrapperStruct00_var_1_16_Pointer)) == ((signed char) (*(WrapperStruct00_var_1_17_Pointer))))) && ((*(WrapperStruct00_var_1_18_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_19_Pointer))))) && ((*(WrapperStruct00_var_1_20_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_19_Pointer))))
;
}
int main(void) {
	isInitial = 1;
