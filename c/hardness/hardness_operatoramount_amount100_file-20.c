...
void step(void) {
	// From: Req4Batch20Amount100
	var_1_10 = (var_1_11 - var_1_12);


	// From: Req8Batch20Amount100
	if (! (var_1_2 && var_1_3)) {
		var_1_22 = ((var_1_21 > var_1_11) && (! 1));
	}


	// From: Req9Batch20Amount100
	if ((abs (var_1_12)) >= var_1_6) {
		var_1_23 = (min ((abs (var_1_17)) , var_1_16));
	} else {
		if (var_1_5 <= var_1_10) {
			var_1_23 = var_1_15;
		} else {
	...
	// From: Req12Batch20Amount100
	var_1_32 = var_1_5;


	// From: Req13Batch20Amount100
	var_1_33 = var_1_15;


	// From: Req2Batch20Amount100
	...
	// From: Req10Batch20Amount100
	unsigned short int stepLocal_8 = var_1_8;
	if (stepLocal_8 > var_1_20) {
		if (! var_1_22) {
			var_1_24 = (max ((var_1_17 - var_1_16) , var_1_15));
		} else {
...
int property(void) {
	return (((((((((((((var_1_2 || var_1_3) ? ((var_1_18 == ((64 + var_1_5) - (var_1_6 + 10))) ? (var_1_1 == ((signed short int) var_1_18)) : 1) : 1) && (((var_1_6 / var_1_5) > var_1_10) ? (var_1_7 == ((unsigned short int) ((var_1_8 - var_1_5) + var_1_6))) : 1)) && ((var_1_20 <= var_1_7) ? (var_1_9 == ((signed long int) var_1_20)) : 1)) && (var_1_10 == ((unsigned long int) (var_1_11 - var_1_12)))) && ((var_1_6 >= (var_1_20 ^ var_1_10)) ? (var_1_13 == ((float) (max (var_1_15 , (var_1_16 - var_1_17))))) : 1)) && (var_1_22 ? ((var_1_10 != ((3451179663u - var_1_6) * var_1_8)) ? (var_1_18 == ((signed long int) (var_1_10 - ((var_1_19 - last_1_var_1_18) - var_1_6)))) : 1) : (var_1_18 == ((signed long int) (max (var_1_8 , (abs (var_1_10)))))))) && ((last_1_var_1_20 < var_1_10) ? (var_1_20 == ((unsigned short int) ((var_1_5 + (max (var_1_32 , var_1_6))) + 16))) : (var_1_22 ? ((4 >= var_1_32) ? (var_1_20 == ((unsigned short int) (abs (var_1_21 - (var_1_8 - 16))))) : (var_1_20 == ((unsigned short int) var_1_8))) : (var_1_20 == ((unsigned short int) var_1_6))))) && ((! (var_1_2 && var_1_3)) ? (var_1_22 == ((unsigned char) ((var_1_21 > var_1_11) && (! 1)))) : 1)) && (((abs (var_1_12)) >= var_1_6) ? (var_1_23 == ((double) (min ((abs (var_1_17)) , var_1_16)))) : ((var_1_5 <= var_1_10) ? (var_1_23 == ((double) var_1_15)) : (var_1_23 == ((double) var_1_17))))) && ((var_1_8 > var_1_20) ? ((! var_1_22) ? (var_1_24 == ((double) (max ((var_1_17 - var_1_16) , var_1_15)))) : ((! (last_1_var_1_24 <= var_1_15)) ? (var_1_24 == ((double) 9.8)) : (var_1_24 == ((double) var_1_15)))) : (var_1_24 == ((double) var_1_16)))) && ((var_1_3 || var_1_2) ? (var_1_3 ? (var_1_25 == ((unsigned char) var_1_5)) : ((var_1_12 < (1u * (100u >> var_1_26))) ? (var_1_25 == ((unsigned char) var_1_5)) : (var_1_25 == ((unsigned char) var_1_6)))) : (var_1_25 == ((unsigned char) ((var_1_27 - (var_1_28 - var_1_26)) - ((var_1_29 - var_1_30) - var_1_31)))))) && (var_1_32 == ((unsigned char) var_1_5))) && (var_1_33 == ((float) var_1_15))
;
}
int main(void) {
	isInitial = 1;
