...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch0100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((var_1_27 / 10) > var_1_13) {
		var_1_28 = (min ((abs (abs (var_1_19))) , var_1_15));
	} else {
		var_1_28 = var_1_14;
	}
	...
	if (var_1_14 < stepLocal_5) {
		var_1_32 = (max ((var_1_19 + var_1_16) , var_1_8));
	} else {
		var_1_32 = var_1_31;
	}
	...
	if (stepLocal_3 >= (var_1_32 + var_1_7)) {
		var_1_22 = (max (var_1_14 , (abs (var_1_7))));
	} else {
		if ((min (var_1_2 , var_1_20)) <= var_1_20) {
			var_1_22 = var_1_9;
		}
	}
	...
	if (5 < var_1_12) {
		if (var_1_24 || var_1_23) {
			if (var_1_1 >= var_1_14) {
				var_1_34 = (min ((max (var_1_21 , var_1_35)) , (var_1_36 - (var_1_37 + var_1_38))));
			}
		}
	} else {
		var_1_34 = var_1_21;
	...
	if (var_1_23 && stepLocal_0) {
		if (stepLocal_1 == var_1_8) {
			var_1_10 = (max (var_1_12 , var_1_13));
		} else {
...
int property(void) {
	return ((((((((((((((((var_1_2 - var_1_3) == (- var_1_20)) ? ((var_1_3 <= ((var_1_20 * 1.5) + 127.4)) ? (var_1_1 == ((signed short int) var_1_5)) : (var_1_1 == ((signed short int) -64))) : (var_1_1 == ((signed short int) 100))) && ((var_1_2 < (1.2 / 9.5)) ? (var_1_6 == ((unsigned long int) (var_1_7 - (max (var_1_8 , var_1_9))))) : (var_1_6 == ((unsigned long int) 2u)))) && ((var_1_23 && (var_1_20 == var_1_2)) ? ((var_1_7 == var_1_8) ? (var_1_10 == ((signed char) (max (var_1_12 , var_1_13)))) : (var_1_10 == ((signed char) ((var_1_14 - var_1_15) - var_1_16)))) : 1)) && ((var_1_11 || var_1_18) ? (var_1_17 == ((unsigned char) (var_1_14 + var_1_15))) : (var_1_17 == ((unsigned char) (var_1_19 - var_1_16))))) && (var_1_20 == ((double) var_1_21))) && ((var_1_5 >= (var_1_32 + var_1_7)) ? (var_1_22 == ((unsigned long int) (max (var_1_14 , (abs (var_1_7)))))) : (((min (var_1_2 , var_1_20)) <= var_1_20) ? (var_1_22 == ((unsigned long int) var_1_9)) : 1))) && ((var_1_25 < var_1_19) ? (var_1_23 == ((unsigned char) (! 1))) : (var_1_23 == ((unsigned char) (! var_1_24))))) && (var_1_25 == ((signed long int) (min ((var_1_6 + -2) , 64))))) && (((- var_1_14) > var_1_15) ? (var_1_26 == ((signed char) (var_1_27 + var_1_15))) : (var_1_26 == ((signed char) var_1_15)))) && (((var_1_27 / 10) > var_1_13) ? (var_1_28 == ((unsigned char) (min ((abs (abs (var_1_19))) , var_1_15)))) : (var_1_28 == ((unsigned char) var_1_14)))) && ((var_1_4 > var_1_30) ? (var_1_29 == ((unsigned char) (var_1_19 - var_1_15))) : ((var_1_12 == (var_1_39 / var_1_14)) ? (var_1_29 == ((unsigned char) (var_1_14 + (var_1_15 + var_1_31)))) : (var_1_29 == ((unsigned char) (var_1_19 - var_1_31)))))) && ((var_1_14 < var_1_28) ? (var_1_32 == ((unsigned long int) (max ((var_1_19 + var_1_16) , var_1_8)))) : (var_1_32 == ((unsigned long int) var_1_31)))) && ((5 < var_1_12) ? ((var_1_24 || var_1_23) ? ((var_1_1 >= var_1_14) ? (var_1_34 == ((float) (min ((max (var_1_21 , var_1_35)) , (var_1_36 - (var_1_37 + var_1_38)))))) : 1) : 1) : (var_1_34 == ((float) var_1_21)))) && (var_1_39 == ((signed long int) var_1_31))) && (var_1_40 == ((unsigned char) 0))
;
}
int main(void) {
	isInitial = 1;
