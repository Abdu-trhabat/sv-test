...
void step(void) {
 ...
 if (stepLocal_2 <= var_1_6) {
  var_1_18 = ((((((((var_1_3) > (var_1_6)) ? (var_1_3) : (var_1_6)))) > (var_1_4)) ? (((((var_1_3) > (var_1_6)) ? (var_1_3) : (var_1_6)))) : (var_1_4)));
 } else {
  var_1_18 = var_1_5;
 }
