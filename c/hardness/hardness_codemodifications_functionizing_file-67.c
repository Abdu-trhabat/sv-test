...
unsigned char functionized3(signed long int functionized3_localFunctionVar0, signed long int functionized3_localFunctionVar1) {
	return (var_1_14 < ((max (var_1_13 , functionized3_localFunctionVar1)) | functionized3_localFunctionVar0));
}
void functionized4(void) {
	if (var_1_3) {
		var_1_16 = -2;
...
void step(void) {
	// From: Req1Batch67functionizing
	if (50 != var_1_2) {
		var_1_1 = (1.00000000000025E12 - 24.25);
	}


	// From: Req2Batch67functionizing
	functionized0(var_1_5, var_1_4);


	// From: Req3Batch67functionizing
	...
	// From: Req4Batch67functionizing
	var_1_12 = (var_1_13 - var_1_14);


	// From: Req5Batch67functionizing
	var_1_15 = (abs (var_1_9));


	// From: Req6Batch67functionizing
	...
	// From: Req7Batch67functionizing
	if (var_1_3) {
		if (var_1_6) {
			if (var_1_18) {
				var_1_17 = var_1_14;
			} else {
				var_1_17 = ((min (var_1_19 , var_1_20)) - (functionized5() - 256));
			}
		} else {
