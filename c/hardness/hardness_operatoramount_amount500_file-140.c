...
void step(void) {
	// From: Req25Batch140Amount500
	unsigned long int stepLocal_35 = min (last_1_var_1_67 , last_1_var_1_12);
	if (var_1_22) {
		if (stepLocal_35 == (min (var_1_81 , var_1_20))) {
			var_1_84 = (var_1_25 + var_1_7);
		} else {
			var_1_84 = (max (var_1_44 , ((min (var_1_33 , var_1_24)) + last_1_var_1_112)));
		}
	} else {
	...
	if (var_1_54 > (var_1_53 / var_1_72)) {
		...
		if (stepLocal_29 && last_1_var_1_98) {
			...
			if (stepLocal_28 > var_1_11) {
				var_1_71 = (max (var_1_7 , (var_1_62 - var_1_36)));
			} else {
				if (stepLocal_27 > (var_1_20 / (max (var_1_43 , 1)))) {
	...
	// From: Req31Batch140Amount500
	if ((var_1_71 * (var_1_80 - var_1_87)) <= var_1_34) {
		var_1_92 = ((abs (var_1_78 - var_1_34)) + (abs (var_1_35)));
	} else {
		var_1_92 = (53410 - var_1_82);
	}


	// From: Req2Batch140Amount500
	signed long int stepLocal_4 = 32;
	unsigned long int stepLocal_3 = var_1_3 + last_1_var_1_12;
	signed long int stepLocal_2 = last_1_var_1_100 / (abs (var_1_5));
		...
		if (stepLocal_3 <= var_1_5) {
			if (stepLocal_0 > ((last_1_var_1_100 * var_1_5) * var_1_3)) {
				if ((var_1_7 - var_1_8) <= stepLocal_1) {
					...
					var_1_4 = (max (((var_1_11 + 10) - 2) , var_1_10));
				}
			} else {
				if (last_1_var_1_100 <= stepLocal_4) {
					var_1_4 = (var_1_9 - ((abs (var_1_3)) + var_1_11));
				} else {
					var_1_4 = var_1_11;
				}
			}
	...
	// From: Req28Batch140Amount500
	if (last_1_var_1_71 >= var_1_78) {
		var_1_88 = var_1_26;
	}


	// From: Req26Batch140Amount500
	if (var_1_88) {
		var_1_85 = (var_1_55 + var_1_56);
	}


	// From: Req43Batch140Amount500
	if (last_1_var_1_88) {
		var_1_108 = var_1_22;
	}


	// From: Req42Batch140Amount500
	if (var_1_108) {
		var_1_107 = var_1_22;
	}


	// From: Req6Batch140Amount500
	...
	if (stepLocal_13 < var_1_3) {
		if (stepLocal_12 || var_1_22) {
			var_1_39 = (min (var_1_34 , (var_1_35 - (abs (var_1_24)))));
		} else {
			var_1_39 = 100;
		}
	}
	...
	// From: Req41Batch140Amount500
	if (var_1_108) {
		var_1_105 = var_1_106;
	}


	// From: Req45Batch140Amount500
	if (var_1_107) {
		var_1_110 = var_1_52;
	}


	// From: Req3Batch140Amount500
	...
	if (stepLocal_6 || last_1_var_1_107) {
		if (((var_1_16 - var_1_11) - (var_1_8 + var_1_10)) >= stepLocal_5) {
			var_1_12 = (3428937324u - (min (var_1_10 , var_1_17)));
		}
	}


	// From: Req37Batch140Amount500
	...
	// From: Req10Batch140Amount500
	var_1_51 = (max ((min (var_1_52 , var_1_53)) , ((max (var_1_54 , var_1_55)) + var_1_56)));


	// From: Req13Batch140Amount500
	signed long int stepLocal_16 = abs (16);
	if (stepLocal_16 == (var_1_10 + -2)) {
		var_1_60 = ((abs (var_1_35)) + var_1_44);
	}


	// From: Req16Batch140Amount500
	if (var_1_52 <= var_1_55) {
		var_1_65 = var_1_22;
	}


	// From: Req23Batch140Amount500
	var_1_79 = ((min (var_1_46 , (max (var_1_80 , var_1_81)))) - ((var_1_48 + var_1_82) - var_1_62));


	// From: Req27Batch140Amount500
	...
	// From: Req33Batch140Amount500
	unsigned char stepLocal_41 = var_1_43;
	if (-1 < stepLocal_41) {
		var_1_95 = ((var_1_79 + (min (var_1_96 , var_1_36))) + var_1_11);
	} else {
		if (var_1_27) {
			var_1_95 = (var_1_78 + var_1_7);
		} else {
			var_1_95 = (var_1_47 + ((min (var_1_78 , var_1_97)) - var_1_11));
		}
	}


	// From: Req34Batch140Amount500
	...
	// From: Req35Batch140Amount500
	if (var_1_53 != var_1_51) {
		var_1_99 = (var_1_54 + var_1_56);
	} else {
		var_1_99 = (max (var_1_53 , 2.5));
	}


	// From: Req38Batch140Amount500
	if (var_1_98) {
		var_1_102 = var_1_35;
	}


	// From: Req39Batch140Amount500
	var_1_103 = var_1_59;


	// From: Req40Batch140Amount500
	if (var_1_98) {
		var_1_104 = var_1_52;
	} else {
		var_1_104 = 8.25f;
	...
	// From: Req44Batch140Amount500
	var_1_109 = var_1_62;


	// From: Req46Batch140Amount500
	if (var_1_107) {
		var_1_111 = var_1_52;
	} else {
		var_1_111 = var_1_55;
	...
	if (var_1_55 >= var_1_53) {
		...
		if (var_1_46 <= stepLocal_15) {
			var_1_58 = (max (var_1_39 , ((var_1_84 + var_1_92) + var_1_7)));
		} else {
			if (var_1_12 >= stepLocal_14) {
				var_1_58 = (min (var_1_16 , var_1_48));
			} else {
				var_1_58 = var_1_12;
			}
		}
	...
	// From: Req36Batch140Amount500
	unsigned char stepLocal_43 = var_1_83;
	if (stepLocal_43 && ((- var_1_99) == var_1_51)) {
		if (var_1_51 < (abs (var_1_85))) {
			var_1_100 = (max ((var_1_62 - var_1_44) , var_1_90));
		}
	} else {
	...
	unsigned long int stepLocal_7 = abs (4u);
	...
	// From: Req1Batch140Amount500
	if ((- 255.45f) < var_1_104) {
		var_1_1 = (var_1_3 + -16);
	}


	// From: Req8Batch140Amount500
	if ((var_1_3 / var_1_37) >= var_1_12) {
		if (var_1_98) {
			var_1_45 = ((max (var_1_35 , (min (var_1_41 , var_1_105)))) + (min (var_1_33 , (max (var_1_10 , var_1_36)))));
		} else {
			var_1_45 = (var_1_46 - (var_1_47 - (var_1_48 - var_1_49)));
		}
	} else {
		var_1_45 = (min (var_1_47 , (min ((max (var_1_10 , var_1_38)) , var_1_42))));
	}


	// From: Req11Batch140Amount500
	if (var_1_110 != var_1_99) {
		var_1_57 = var_1_53;
	}


	// From: Req15Batch140Amount500
		...
		if (stepLocal_19 >= var_1_48) {
			if (var_1_65) {
				if (stepLocal_20 >= var_1_84) {
					var_1_63 = (abs (var_1_44 + (min (var_1_62 , var_1_3))));
				}
			}
		} else {
			var_1_63 = (max (var_1_43 , var_1_38));
		}
	}


	// From: Req17Batch140Amount500
	unsigned long int stepLocal_22 = var_1_102;
	if (var_1_85 == (var_1_56 + var_1_51)) {
		if (stepLocal_22 <= var_1_44) {
			var_1_66 = var_1_3;
		} else {
			var_1_66 = (max ((var_1_41 + var_1_34) , var_1_36));
		}
	}


	// From: Req19Batch140Amount500
	...
	// From: Req22Batch140Amount500
	unsigned char stepLocal_33 = ! var_1_88;
	unsigned long int stepLocal_32 = min ((var_1_7 / 10) , (var_1_102 + var_1_86));
	if ((var_1_35 < var_1_112) && stepLocal_33) {
		if ((var_1_58 * var_1_12) < stepLocal_32) {
			var_1_76 = (max ((var_1_103 + (var_1_49 - 1)) , var_1_92));
		}
	} else {
		var_1_76 = (((var_1_49 + var_1_112) + var_1_42) - (var_1_78 - (min (var_1_44 , var_1_43))));
	}


	// From: Req29Batch140Amount500
	...
	if (var_1_3 <= stepLocal_23) {
		...
		if ((var_1_4 / var_1_37) >= stepLocal_25) {
			var_1_67 = (var_1_44 - (var_1_68 - (abs (var_1_59))));
		}
	}


	// From: Req5Batch140Amount500
	if ((var_1_104 * var_1_51) <= (min ((var_1_99 * var_1_51) , var_1_85))) {
		if (var_1_10 < (abs (var_1_25))) {
			if (var_1_67 <= (max (var_1_21 , var_1_16))) {
				var_1_28 = (max (((min (var_1_33 , var_1_34)) - var_1_25) , 16));
			} else {
				var_1_28 = (var_1_25 + var_1_35);
			}
		}
	} else {
		var_1_28 = (((max (var_1_36 , var_1_37)) - var_1_38) + var_1_35);
	}


	// From: Req7Batch140Amount500
	if (var_1_36 > ((var_1_9 ^ var_1_84) ^ var_1_28)) {
		var_1_40 = (var_1_34 - (min (32 , var_1_38)));
	} else {
		if (var_1_27 && var_1_107) {
			var_1_40 = (max ((var_1_33 - var_1_35) , var_1_37));
		} else {
			var_1_40 = (min (((var_1_38 + var_1_41) + (var_1_37 - var_1_42)) , ((var_1_43 - var_1_44) - (max (var_1_25 , var_1_35)))));
		}
	}


	// From: Req9Batch140Amount500
	if (! (var_1_8 <= (var_1_21 & 32))) {
		var_1_50 = var_1_35;
	} else {
		if (var_1_17 != var_1_105) {
			var_1_50 = ((min ((max (var_1_10 , var_1_67)) , var_1_9)) - (var_1_48 + var_1_38));
		} else {
			if (var_1_27) {
				var_1_50 = ((var_1_112 + (min (var_1_67 , var_1_35))) - var_1_42);
			} else {
				var_1_50 = var_1_41;
			}
		}
	...
	// From: Req14Batch140Amount500
	unsigned char stepLocal_18 = -32 >= var_1_8;
	signed long int stepLocal_17 = max (var_1_46 , var_1_10);
	if (stepLocal_17 != ((max (var_1_48 , var_1_41)) << (var_1_62 - 1))) {
		if ((var_1_53 >= var_1_104) || stepLocal_18) {
			var_1_61 = (max ((var_1_102 - var_1_33) , (max ((abs (8)) , (128 - var_1_35)))));
		}
	} else {
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((- 255.45f) < var_1_104) ? (var_1_1 == ((signed char) (var_1_3 + -16))) : 1) && ((var_1_3 >= (last_1_var_1_100 / (abs (var_1_5)))) ? (((var_1_3 + last_1_var_1_12) <= var_1_5) ? ((last_1_var_1_12 > ((last_1_var_1_100 * var_1_5) * var_1_3)) ? (((var_1_7 - var_1_8) <= 100000) ? (var_1_4 == ((signed short int) (var_1_9 - var_1_10))) : (var_1_4 == ((signed short int) (max (((var_1_11 + 10) - 2) , var_1_10))))) : ((last_1_var_1_100 <= 32) ? (var_1_4 == ((signed short int) (var_1_9 - ((abs (var_1_3)) + var_1_11)))) : (var_1_4 == ((signed short int) var_1_11)))) : (var_1_4 == ((signed short int) (var_1_5 + 5)))) : 1)) && ((((! last_1_var_1_65) && last_1_var_1_108) || last_1_var_1_107) ? ((((var_1_16 - var_1_11) - (var_1_8 + var_1_10)) >= var_1_7) ? (var_1_12 == ((unsigned long int) (3428937324u - (min (var_1_10 , var_1_17))))) : 1) : 1)) && (((abs (4u)) < (var_1_16 * (var_1_19 - var_1_11))) ? ((((var_1_11 / var_1_20) % var_1_21) == (abs (var_1_10))) ? (var_1_18 == ((unsigned char) var_1_22)) : (var_1_98 ? (((var_1_24 - var_1_25) <= var_1_8) ? (var_1_18 == ((unsigned char) (! var_1_22))) : (var_1_18 == ((unsigned char) (! (var_1_88 && var_1_22))))) : ((((var_1_8 + var_1_25) / var_1_16) > var_1_12) ? (((var_1_5 == var_1_24) || var_1_108) ? (var_1_18 == ((unsigned char) (var_1_22 || var_1_26))) : (var_1_18 == ((unsigned char) ((1 > var_1_3) || var_1_27)))) : (var_1_22 ? (var_1_18 == ((unsigned char) var_1_27)) : 1)))) : (var_1_18 == ((unsigned char) var_1_26)))) && (((var_1_104 * var_1_51) <= (min ((var_1_99 * var_1_51) , var_1_85))) ? ((var_1_10 < (abs (var_1_25))) ? ((var_1_67 <= (max (var_1_21 , var_1_16))) ? (var_1_28 == ((unsigned char) (max (((min (var_1_33 , var_1_34)) - var_1_25) , 16)))) : (var_1_28 == ((unsigned char) (var_1_25 + var_1_35)))) : 1) : (var_1_28 == ((unsigned char) (((max (var_1_36 , var_1_37)) - var_1_38) + var_1_35))))) && ((var_1_11 < var_1_3) ? (((var_1_26 || var_1_108) || var_1_22) ? (var_1_39 == ((signed long int) (min (var_1_34 , (var_1_35 - (abs (var_1_24))))))) : (var_1_39 == ((signed long int) 100))) : 1)) && ((var_1_36 > ((var_1_9 ^ var_1_84) ^ var_1_28)) ? (var_1_40 == ((unsigned char) (var_1_34 - (min (32 , var_1_38))))) : ((var_1_27 && var_1_107) ? (var_1_40 == ((unsigned char) (max ((var_1_33 - var_1_35) , var_1_37)))) : (var_1_40 == ((unsigned char) (min (((var_1_38 + var_1_41) + (var_1_37 - var_1_42)) , ((var_1_43 - var_1_44) - (max (var_1_25 , var_1_35)))))))))) && (((var_1_3 / var_1_37) >= var_1_12) ? (var_1_98 ? (var_1_45 == ((unsigned short int) ((max (var_1_35 , (min (var_1_41 , var_1_105)))) + (min (var_1_33 , (max (var_1_10 , var_1_36))))))) : (var_1_45 == ((unsigned short int) (var_1_46 - (var_1_47 - (var_1_48 - var_1_49)))))) : (var_1_45 == ((unsigned short int) (min (var_1_47 , (min ((max (var_1_10 , var_1_38)) , var_1_42)))))))) && ((! (var_1_8 <= (var_1_21 & 32))) ? (var_1_50 == ((signed short int) var_1_35)) : ((var_1_17 != var_1_105) ? (var_1_50 == ((signed short int) ((min ((max (var_1_10 , var_1_67)) , var_1_9)) - (var_1_48 + var_1_38)))) : (var_1_27 ? (var_1_50 == ((signed short int) ((var_1_112 + (min (var_1_67 , var_1_35))) - var_1_42))) : (var_1_50 == ((signed short int) var_1_41)))))) && (var_1_51 == ((double) (max ((min (var_1_52 , var_1_53)) , ((max (var_1_54 , var_1_55)) + var_1_56)))))) && ((var_1_110 != var_1_99) ? (var_1_57 == ((float) var_1_53)) : 1)) && ((var_1_55 >= var_1_53) ? ((200.2 <= var_1_110) ? (var_1_58 == ((signed long int) (var_1_7 + var_1_5))) : (var_1_58 == ((signed long int) (var_1_43 + (var_1_37 - var_1_44))))) : ((var_1_46 <= ((50 + var_1_21) | (43629 - var_1_59))) ? (var_1_58 == ((signed long int) (max (var_1_39 , ((var_1_84 + var_1_92) + var_1_7))))) : ((var_1_12 >= var_1_35) ? (var_1_58 == ((signed long int) (min (var_1_16 , var_1_48)))) : (var_1_58 == ((signed long int) var_1_12)))))) && (((abs (16)) == (var_1_10 + -2)) ? (var_1_60 == ((signed short int) ((abs (var_1_35)) + var_1_44))) : 1)) && (((max (var_1_46 , var_1_10)) != ((max (var_1_48 , var_1_41)) << (var_1_62 - 1))) ? (((var_1_53 >= var_1_104) || (-32 >= var_1_8)) ? (var_1_61 == ((signed long int) (max ((var_1_102 - var_1_33) , (max ((abs (8)) , (128 - var_1_35))))))) : 1) : ((var_1_51 == var_1_99) ? (var_1_61 == ((signed long int) (((var_1_59 + var_1_102) - (var_1_21 + var_1_20)) + (var_1_49 - var_1_47)))) : (var_1_61 == ((signed long int) (var_1_76 + (var_1_66 + (var_1_8 + var_1_5)))))))) && ((var_1_19 >= var_1_59) ? (((var_1_34 - (var_1_44 + var_1_38)) >= var_1_48) ? (var_1_65 ? ((var_1_103 >= var_1_84) ? (var_1_63 == ((signed char) (abs (var_1_44 + (min (var_1_62 , var_1_3)))))) : 1) : 1) : (var_1_63 == ((signed char) (max (var_1_43 , var_1_38))))) : 1)) && ((var_1_52 <= var_1_55) ? (var_1_65 == ((unsigned char) var_1_22)) : 1)) && ((var_1_85 == (var_1_56 + var_1_51)) ? ((var_1_102 <= var_1_44) ? (var_1_66 == ((signed short int) var_1_3)) : (var_1_66 == ((signed short int) (max ((var_1_41 + var_1_34) , var_1_36))))) : 1)) && ((var_1_3 <= var_1_62) ? ((var_1_8 >= var_1_37) ? (var_1_67 == ((signed long int) (var_1_38 + var_1_43))) : (var_1_18 ? (var_1_67 == ((signed long int) (var_1_43 - var_1_37))) : 1)) : (((var_1_4 / var_1_37) >= (~ var_1_84)) ? (var_1_67 == ((signed long int) (var_1_44 - (var_1_68 - (abs (var_1_59)))))) : 1))) && ((var_1_52 < var_1_85) ? ((var_1_107 && (var_1_103 <= var_1_39)) ? (var_1_69 == ((signed char) -8)) : 1) : 1)) && ((var_1_54 > (var_1_53 / var_1_72)) ? ((var_1_25 >= (32 * last_1_var_1_95)) ? (var_1_71 == ((signed long int) (((var_1_73 - var_1_20) + var_1_35) - (var_1_68 - var_1_74)))) : (var_1_71 == ((signed long int) last_1_var_1_102))) : ((var_1_26 && last_1_var_1_98) ? ((last_1_var_1_58 < (var_1_8 * var_1_11)) ? (var_1_71 == ((signed long int) var_1_49)) : 1) : ((var_1_5 > var_1_11) ? (var_1_71 == ((signed long int) (max (var_1_7 , (var_1_62 - var_1_36))))) : ((var_1_49 > (var_1_20 / (max (var_1_43 , 1)))) ? (var_1_71 == ((signed long int) (var_1_37 + var_1_5))) : 1))))) && ((var_1_102 <= var_1_39) ? (var_1_75 == ((signed long int) (((var_1_41 + var_1_48) + var_1_3) + var_1_102))) : (var_1_75 == ((signed long int) (var_1_11 + 128))))) && (((var_1_35 < var_1_112) && (! var_1_88)) ? (((var_1_58 * var_1_12) < (min ((var_1_7 / 10) , (var_1_102 + var_1_86)))) ? (var_1_76 == ((signed short int) (max ((var_1_103 + (var_1_49 - 1)) , var_1_92)))) : 1) : (var_1_76 == ((signed short int) (((var_1_49 + var_1_112) + var_1_42) - (var_1_78 - (min (var_1_44 , var_1_43)))))))) && (var_1_79 == ((unsigned short int) ((min (var_1_46 , (max (var_1_80 , var_1_81)))) - ((var_1_48 + var_1_82) - var_1_62))))) && ((((var_1_34 * var_1_43) | var_1_4) >= var_1_102) ? (var_1_83 == ((unsigned char) (var_1_98 || var_1_27))) : (var_1_83 == ((unsigned char) (var_1_22 || (var_1_88 && var_1_26)))))) && (var_1_22 ? (((min (last_1_var_1_67 , last_1_var_1_12)) == (min (var_1_81 , var_1_20))) ? (var_1_84 == ((signed long int) (var_1_25 + var_1_7))) : (var_1_84 == ((signed long int) (max (var_1_44 , ((min (var_1_33 , var_1_24)) + last_1_var_1_112)))))) : (var_1_84 == ((signed long int) (((var_1_20 + last_1_var_1_84) + var_1_8) + var_1_24))))) && (var_1_88 ? (var_1_85 == ((double) (var_1_55 + var_1_56))) : 1)) && ((var_1_17 < var_1_35) ? (var_1_86 == ((signed char) (var_1_62 - var_1_44))) : (var_1_86 == ((signed char) (((var_1_87 - var_1_62) - var_1_44) - var_1_41))))) && ((last_1_var_1_71 >= var_1_78) ? (var_1_88 == ((unsigned char) var_1_26)) : 1)) && (var_1_98 ? ((((var_1_19 - var_1_35) / var_1_81) != var_1_7) ? (var_1_89 == ((signed char) ((var_1_42 - (var_1_62 + var_1_90)) + var_1_3))) : ((var_1_35 >= (- var_1_81)) ? (var_1_89 == ((signed char) (var_1_38 + ((32 - var_1_62) - var_1_41)))) : (var_1_89 == ((signed char) var_1_38)))) : 1)) && ((var_1_24 < (var_1_62 - var_1_36)) ? (var_1_91 == ((unsigned short int) var_1_33)) : 1)) && (((var_1_71 * (var_1_80 - var_1_87)) <= var_1_34) ? (var_1_92 == ((unsigned short int) ((abs (var_1_78 - var_1_34)) + (abs (var_1_35))))) : (var_1_92 == ((unsigned short int) (53410 - var_1_82))))) && ((var_1_46 <= var_1_17) ? (var_1_93 == ((signed long int) (var_1_9 + (min ((min (var_1_74 , var_1_33)) , (max (var_1_38 , var_1_59))))))) : ((var_1_16 <= var_1_101) ? (var_1_93 == ((signed long int) var_1_84)) : 1))) && ((-1 < var_1_43) ? (var_1_95 == ((unsigned short int) ((var_1_79 + (min (var_1_96 , var_1_36))) + var_1_11))) : (var_1_27 ? (var_1_95 == ((unsigned short int) (var_1_78 + var_1_7))) : (var_1_95 == ((unsigned short int) (var_1_47 + ((min (var_1_78 , var_1_97)) - var_1_11))))))) && ((var_1_96 > (var_1_80 - var_1_78)) ? (var_1_98 == ((unsigned char) ((! var_1_27) || var_1_22))) : 1)) && ((var_1_53 != var_1_51) ? (var_1_99 == ((double) (var_1_54 + var_1_56))) : (var_1_99 == ((double) (max (var_1_53 , 2.5)))))) && ((var_1_83 && ((- var_1_99) == var_1_51)) ? ((var_1_51 < (abs (var_1_85))) ? (var_1_100 == ((signed char) (max ((var_1_62 - var_1_44) , var_1_90)))) : 1) : (var_1_100 == ((signed char) (var_1_90 + var_1_3))))) && ((8 != (var_1_38 - var_1_10)) ? (var_1_101 == ((unsigned long int) 128u)) : (var_1_101 == ((unsigned long int) var_1_12)))) && (var_1_98 ? (var_1_102 == ((unsigned long int) var_1_35)) : 1)) && (var_1_103 == ((signed long int) var_1_59))) && (var_1_98 ? (var_1_104 == ((float) var_1_52)) : (var_1_104 == ((float) 8.25f)))) && (var_1_108 ? (var_1_105 == ((unsigned long int) var_1_106)) : 1)) && (var_1_108 ? (var_1_107 == ((unsigned char) var_1_22)) : 1)) && (last_1_var_1_88 ? (var_1_108 == ((unsigned char) var_1_22)) : 1)) && (var_1_109 == ((unsigned char) var_1_62))) && (var_1_107 ? (var_1_110 == ((double) var_1_52)) : 1)) && (var_1_107 ? (var_1_111 == ((float) var_1_52)) : (var_1_111 == ((float) var_1_55)))) && (((var_1_101 < var_1_34) && var_1_98) ? ((var_1_96 <= (~ (var_1_37 << var_1_105))) ? ((var_1_82 <= ((var_1_102 ^ var_1_42) + (var_1_80 - var_1_60))) ? (var_1_112 == ((unsigned short int) var_1_8)) : (var_1_112 == ((unsigned short int) var_1_60))) : 1) : (var_1_112 == ((unsigned short int) var_1_10)))
;
}
int main(void) {
	isInitial = 1;
