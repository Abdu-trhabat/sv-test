...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch107functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
void functionized0(signed long int, signed char, unsigned long int);
signed long int functionized1(void);
void functionized2(float, unsigned char, unsigned char);
void functionized3(double);
unsigned long int functionized4(void);
...
void functionized0(signed long int functionized0_localFunctionVar0, signed char functionized0_localFunctionVar1, unsigned long int functionized0_localFunctionVar2) {
	if ((min (var_1_11 , functionized0_localFunctionVar1)) < functionized0_localFunctionVar0) {
		if ((functionized0_localFunctionVar0 + functionized0_localFunctionVar2) == 5u) {
			var_1_10 = var_1_15;
		}
	} else {
		var_1_10 = var_1_15;
...
void functionized2(float functionized2_localFunctionVar0, unsigned char functionized2_localFunctionVar1, unsigned char functionized2_localFunctionVar2) {
	if (functionized2_localFunctionVar1 && (functionized2_localFunctionVar0 > 16.75f)) {
		var_1_16 = functionized2_localFunctionVar2;
	}
}
void functionized3(double functionized3_localFunctionVar0) {
	var_1_23 = (functionized3_localFunctionVar0 - var_1_6);
}
unsigned long int functionized4(void) {
	return (var_1_15 ^ 16u);
}
signed long int functionized5(unsigned char functionized5_localFunctionVar0) {
	return (abs (min (functionized5_localFunctionVar0 , var_1_19)));
}
...
void step(void) {
	// From: Req1Batch107functionizing
	...
	// From: Req2Batch107functionizing
	functionized0(var_1_13, var_1_12, var_1_14);


	// From: Req3Batch107functionizing
	if (var_1_17) {
		var_1_16 = ((var_1_18 + functionized1()) - var_1_21);
	} else {
		functionized2(var_1_5, var_1_22, var_1_19);
	}


	// From: Req4Batch107functionizing
	functionized3(var_1_8);


	// From: Req5Batch107functionizing
	if ((functionized4() * 64u) > var_1_18) {
		var_1_24 = var_1_25;
	}


	// From: Req6Batch107functionizing
	if (var_1_6 < (var_1_1 * (var_1_8 - 9.99999998E7))) {
		var_1_26 = functionized5(var_1_20);
	} else {
		var_1_26 = var_1_20;
	}


	// From: Req7Batch107functionizing
	if ((max (var_1_5 , var_1_8)) < (var_1_7 + var_1_1)) {
		var_1_27 = (var_1_8 - var_1_6);
	}


	// From: Req8Batch107functionizing
	var_1_28 = var_1_12;


	// From: Req9Batch107functionizing
	var_1_29 = var_1_11;
}
