...
void step(void) {
	...
	// From: Req2Batch111stepLocals
	if ((max (var_1_2 , var_1_6)) == var_1_5) {
		var_1_7 = (! (! 1));
	}


	// From: Req3Batch111stepLocals
	...
	// From: Req5Batch111stepLocals
	unsigned char stepLocal_3 = var_1_9;
	if ((-128 >= (min (var_1_10 , var_1_11))) && stepLocal_3) {
		var_1_13 = var_1_12;
	}


	// From: Req6Batch111stepLocals
	var_1_14 = var_1_10;


	// From: Req7Batch111stepLocals
	var_1_15 = var_1_16;


	// From: Req8Batch111stepLocals
	...
	// From: Req9Batch111stepLocals
	if (var_1_15 == var_1_16) {
		var_1_21 = (var_1_19 + var_1_20);
	}


	// From: Req10Batch111stepLocals
	var_1_22 = var_1_16;


	// From: Req11Batch111stepLocals
	var_1_23 = var_1_19;


	// From: Req12Batch111stepLocals
	var_1_24 = -8;
}
