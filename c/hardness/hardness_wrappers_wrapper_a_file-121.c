...
void step(void) {
	...
	// From: Req2Batch121Wrapper_A
	unsigned long int stepLocal_2 = max ((unsigned_long_int_Array_0[1][1] / unsigned_long_int_Array_0[0][0]) , unsigned_long_int_Array_0[1][0]);
	...
	// From: Req4Batch121Wrapper_A
	unsigned_char_Array_0[0] = unsigned_char_Array_0[1];


	// From: Req5Batch121Wrapper_A
	BOOL_unsigned_char_Array_0[1][1] = BOOL_unsigned_char_Array_0[0][1];


	// From: Req3Batch121Wrapper_A
	if (unsigned_long_int_Array_0[1][2] <= unsigned_long_int_Array_0[0][1]) {
		if (! BOOL_unsigned_char_Array_0[1][1]) {
			signed_short_int_Array_0[1] = (min (signed_short_int_Array_0[2] , (signed_short_int_Array_0[0] + 2)));
		} else {
			signed_short_int_Array_0[1] = (min ((abs (signed_short_int_Array_0[0])) , signed_short_int_Array_0[2]));
		}
	}
}
...
int property(void) {
	return (((((((unsigned_long_int_Array_0[1][2] + unsigned_long_int_Array_0[0][2]) - (unsigned_long_int_Array_0[1][1] + unsigned_long_int_Array_0[0][1])) == (- (- unsigned_long_int_Array_0[1][0]))) ? ((unsigned_long_int_Array_0[0][2] != unsigned_long_int_Array_0[1][2]) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_long_int_Array_0[1][1])) : 1) : (signed_long_int_Array_0[0] == ((signed long int) unsigned_long_int_Array_0[0][1]))) && ((unsigned_long_int_Array_0[0][2] <= (max ((unsigned_long_int_Array_0[1][1] / unsigned_long_int_Array_0[0][0]) , unsigned_long_int_Array_0[1][0]))) ? (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) (! BOOL_unsigned_char_Array_0[0][0]))) : (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) 0)))) && ((unsigned_long_int_Array_0[1][2] <= unsigned_long_int_Array_0[0][1]) ? ((! BOOL_unsigned_char_Array_0[1][1]) ? (signed_short_int_Array_0[1] == ((signed short int) (min (signed_short_int_Array_0[2] , (signed_short_int_Array_0[0] + 2))))) : (signed_short_int_Array_0[1] == ((signed short int) (min ((abs (signed_short_int_Array_0[0])) , signed_short_int_Array_0[2]))))) : 1)) && (unsigned_char_Array_0[0] == ((unsigned char) unsigned_char_Array_0[1]))) && (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1]))
;
}
int main(void) {
	isInitial = 1;
