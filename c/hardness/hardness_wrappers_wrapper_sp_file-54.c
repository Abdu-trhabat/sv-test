...
void step(void) {
	...
	if (stepLocal_1 == (max (10 , (*(WrapperStruct00_var_1_5_Pointer))))) {
		if ((*(WrapperStruct00_var_1_6_Pointer))) {
			...
			if ((*(WrapperStruct00_var_1_11_Pointer)) >= (abs ((*(WrapperStruct00_var_1_14_Pointer))))) {
