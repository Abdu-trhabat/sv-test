 ...
 if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) <= stepLocal_2) {
  if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) == stepLocal_1) {
   if (stepLocal_0 != (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) {
    ...
    (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)) = (((((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) < 0 ) ? -((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) : ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))));
   }
  } else {
