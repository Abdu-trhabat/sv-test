...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12750_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req8Batch12750_1loop
	unsigned char stepLocal_2 = last_1_var_1_11;
	signed long int stepLocal_1 = max (last_1_var_1_17 , (var_1_4 * last_1_var_1_1));
	...
	// From: Req5Batch12750_1loop
	var_1_13 = (var_1_14 - last_1_var_1_18);


	// From: Req2Batch12750_1loop
	...
	// From: Req3Batch12750_1loop
	if (var_1_10) {
		var_1_11 = (var_1_6 && (var_1_8 && var_1_9));
	}


	// From: Req1Batch12750_1loop
	if (! last_1_var_1_12) {
		if ((4 + last_1_var_1_13) >= (min (var_1_4 , var_1_5))) {
	...
	// From: Req7Batch12750_1loop
	signed long int stepLocal_0 = max (var_1_13 , var_1_1);
	if (var_1_6) {
		if ((max (var_1_13 , (var_1_1 * var_1_14))) <= stepLocal_0) {
			var_1_17 = (var_1_13 + var_1_18);
		} else {
			var_1_17 = (min (var_1_18 , var_1_13));
		}
	}


	// From: Req4Batch12750_1loop
	if (var_1_6) {
		var_1_12 = (! var_1_8);
	} else {
