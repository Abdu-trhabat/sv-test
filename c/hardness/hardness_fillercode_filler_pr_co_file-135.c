...
void step(void) {
	...
	// From: CodeObject1
	/* 288L, 97L) */ if (/* 289L, 63L, 64L) */ ((var_1_12) > (/* 291L, 62L, 66L) */ (abs (var_1_28))))) {
		/* 293L, 81L) */ var_1_29 = (
			/* 296L, 80L) */ ((
				/* 297L, 75L) */ (abs (
					var_1_32
	...
	// From: CodeObject2
	/* 311L, 139L) */ if (/* 312L, 104L, 105L) */ (! (/* 313L, 103L, 106L) */ ((var_1_12) < (var_1_33))))) {
		/* 316L, 133L) */ if (/* 317L, 116L, 117L) */ ((/* 318L, 114L, 118L) */ (~ (var_1_33))) <= (var_1_12))) {
			/* 321L, 128L) */ var_1_35 = (
				var_1_32
			);
		} else {
	...
	/* 356L, 245L) */ if (var_1_23) {
		...
		/* 363L, 243L) */ if (/* 364L, 200L, 201L) */ ((var_1_7) > (var_1_28))) {
			/* 367L, 218L) */ var_1_41 = (
				/* 370L, 217L) */ ((
					/* 371L, 211L) */ ((
						var_1_42
			...
			/* 379L, 241L) */ if (/* 380L, 224L, 225L) */ ((var_1_12) > (/* 382L, 223L, 227L) */ (abs (/* 383L, 222L, 228L) */ ((var_1_12) - (var_1_7))))))) {
				/* 386L, 240L) */ var_1_41 = (
					var_1_37
				);
			}
