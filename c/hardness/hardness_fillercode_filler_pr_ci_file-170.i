...
void step(void) {
   ...
   var_1_9
                  ...
                  if ( ((var_1_11) < (var_1_18))) {
                   ...
                   if ( ((var_1_10) > ( ((var_1_25) % (var_1_18))))) {
                    var_1_28 = (
   var_1_20
  );
 } else {
                    var_1_28 = (
                     ((((( var_1_20 )) < (( (( ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) ) - ( var_1_32 )) ))) ? (( var_1_20 )) : (( (( ((((var_1_31) < 0 ) ? -(var_1_31) : (var_1_31))) ) - ( var_1_32 )) ))))
  );
 }
 signed long int stepLocal_0 = -256;
  ...
  0.5800000000000001
                   ...
                   if ( ((var_1_16) >= ( ((var_1_38) - (1.5f))))) {
                    var_1_37 = (
                     ((((( var_1_26 )) < (( var_1_32 ))) ? (( var_1_26 )) : (( var_1_32 ))))
  );
 }
                   if ( (( ((var_1_5) % (var_1_18))) < (var_1_25))) {
