...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch61Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (WrapperStruct00.var_1_23 < (max (WrapperStruct00.var_1_20 , WrapperStruct00.var_1_23))) {
