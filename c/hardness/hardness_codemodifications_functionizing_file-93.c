...
float functionized1(float functionized1_localFunctionVar0, float localFunctionVar1) {
	return ((min (functionized1_localFunctionVar0 , var_1_8)) + localFunctionVar1);
}
...
void functionized3(float functionized3_localFunctionVar0) {
	if (var_1_10) {
		var_1_13 = (max (var_1_7 , functionized3_localFunctionVar0));
	} else {
...
void functionized6(unsigned char functionized6_localFunctionVar0, signed short int functionized6_localFunctionVar1) {
	if (functionized6_localFunctionVar0) {
		var_1_23 = (var_1_22 + ((abs (functionized6_localFunctionVar1)) + var_1_25));
	} else {
		if (var_1_16) {
...
void step(void) {
	...
	// From: Req3Batch93functionizing
	functionized3(var_1_5);


	// From: Req4Batch93functionizing
	if (functionized4(var_1_10) || var_1_16) {
		var_1_14 = (max (var_1_17 , (var_1_18 - var_1_19)));
	}


	// From: Req5Batch93functionizing
	if (var_1_16) {
		var_1_20 = (var_1_3 - 50);
	}


	// From: Req6Batch93functionizing
	if (var_1_15) {
		var_1_21 = (functionized5(25) - var_1_19);
	}


	// From: Req7Batch93functionizing
