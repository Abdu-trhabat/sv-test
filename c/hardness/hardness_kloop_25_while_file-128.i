...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12825_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_3 > var_1_7) {
  ...
  if ((1u / var_1_6) > var_1_5) {
   var_1_12 = ((((var_1_13) > (var_1_8)) ? (var_1_13) : (var_1_8)));
  } else {
   if (var_1_4 < var_1_5) {
    if (var_1_11) {
     var_1_12 = var_1_13;
