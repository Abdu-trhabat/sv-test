...
void step(void) {
	...
	if (last_1_var_1_85 <= stepLocal_22) {
		...
		var_1_89 = (var_1_74 - (max (var_1_15 , var_1_5)));
	}
	...
	if (255.625f > (last_1_var_1_40 / var_1_35)) {
		if (last_1_var_1_53 < last_1_var_1_54) {
			var_1_61 = (var_1_56 + (min (last_1_var_1_104 , (var_1_18 - last_1_var_1_92))));
		}
	}


	// From: Req26Batch38Amount500
	if (last_1_var_1_61 <= (min (var_1_68 , 5))) {
	...
	var_1_105 = (max ((min (var_1_32 , var_1_31)) , var_1_106));
	...
	if (var_1_91) {
		if ((min ((var_1_74 * var_1_14) , var_1_5)) != stepLocal_30) {
			var_1_107 = (var_1_106 + var_1_92);
		}
	} else {
		var_1_107 = (min ((var_1_30 - var_1_68) , (var_1_106 - (min (var_1_69 , 0)))));
	}
	...
	if (var_1_9 < (var_1_109 / 0.125)) {
		if ((2 * (min (var_1_14 , var_1_3))) < stepLocal_3) {
			var_1_27 = (var_1_5 - var_1_15);
		} else {
			var_1_27 = (max (var_1_18 , 5));
		}
	} else {
		var_1_27 = ((var_1_14 + var_1_15) - (var_1_22 + (max (var_1_26 , var_1_18))));
	}
	...
	if ((var_1_4 + var_1_56) > stepLocal_26) {
		...
		if (var_1_90) {
			var_1_93 = (min (var_1_6 , ((min (var_1_68 , var_1_69)) + var_1_18)));
		} else {
	...
	signed long int stepLocal_14 = abs (var_1_22);
	unsigned char stepLocal_13 = ! var_1_51;
	if (((min (var_1_89 , var_1_25)) - var_1_6) <= stepLocal_14) {
	...
	if (stepLocal_20 >= var_1_13) {
		if (var_1_97) {
			if (var_1_107 <= stepLocal_19) {
				var_1_85 = ((abs (var_1_30)) - (max (var_1_32 , (max (var_1_67 , var_1_33)))));
			} else {
			...
			var_1_85 = (max (16 , (max (var_1_30 , (min (var_1_31 , var_1_69))))));
		}
	}
	...
	if (((var_1_14 << var_1_5) * (var_1_39 / var_1_22)) < var_1_72) {
		if (((- var_1_9) + var_1_46) >= var_1_35) {
			var_1_78 = (abs (min ((var_1_41 - var_1_42) , var_1_47)));
		} else {
			if (var_1_50) {
		...
		if (var_1_9 >= var_1_78) {
			...
			if (stepLocal_0 <= var_1_6) {
				if (stepLocal_1 < ((var_1_6 + var_1_87) + (var_1_92 / var_1_5))) {
					...
					var_1_7 = ((var_1_16 - (max (var_1_17 , 5))) - var_1_13);
				}
			} else {
				var_1_7 = ((max (var_1_17 , var_1_3)) + (var_1_14 - (var_1_18 + var_1_19)));
			}
		}
	} else {
		var_1_7 = var_1_3;
	...
	signed long int stepLocal_2 = (abs (var_1_5)) * var_1_3;
	...
	if (var_1_109 > var_1_102) {
		if (var_1_30 == var_1_26) {
			if ((var_1_61 < (var_1_5 - 32)) && var_1_50) {
				var_1_37 = (abs (var_1_93));
			} else {
				var_1_37 = ((1592924859u + 1867977025u) - (max ((var_1_38 - var_1_93) , (max (var_1_16 , var_1_13)))));
			}
		}
	} else {
		if ((min ((var_1_20 / var_1_32) , 1u)) < var_1_5) {
			var_1_37 = var_1_16;
		} else {
			var_1_37 = ((min ((var_1_61 + var_1_6) , (var_1_38 - var_1_93))) + var_1_15);
		}
	}
	...
	if (stepLocal_9 >= var_1_37) {
		var_1_54 = (min (var_1_39 , var_1_87));
	} else {
		var_1_54 = (max (var_1_39 , (var_1_22 - (last_1_var_1_54 + var_1_17))));
	}


	// From: Req13Batch38Amount500
	if (var_1_50) {
		var_1_53 = (min (var_1_5 , (max (var_1_37 , var_1_4))));
	} else {
		if (var_1_97 && var_1_51) {
			var_1_53 = ((var_1_55 - var_1_7) + (abs (var_1_25 + var_1_36)));
		}
	}
	...
	unsigned long int stepLocal_15 = var_1_37 + (min (var_1_18 , var_1_89));
	if (200.2f >= ((var_1_41 - 7.6f) * var_1_40)) {
		if (var_1_104 <= stepLocal_16) {
			var_1_71 = (abs (var_1_1 + 2u));
		} else {
			var_1_71 = ((var_1_38 + (max (var_1_72 , var_1_73))) - var_1_103);
		}
	} else {
		if (var_1_89 > stepLocal_17) {
			if (var_1_51) {
				if (var_1_50) {
					if (128 >= stepLocal_15) {
						var_1_71 = (abs (2704285562u - var_1_89));
					}
				} else {
				...
				if (var_1_90) {
					var_1_71 = (min ((max ((var_1_74 - var_1_33) , (var_1_36 + 10u))) , var_1_57));
				} else {
					var_1_71 = (min ((var_1_74 - var_1_6) , (min (8u , (var_1_75 + var_1_3)))));
				}
			}
		}
	}
	...
	if (stepLocal_27 && (var_1_97 && (var_1_84 >= var_1_100))) {
		if (stepLocal_28 >= var_1_32) {
			...
			if (stepLocal_29 >= (var_1_95 - 16)) {
				var_1_94 = (min (var_1_69 , var_1_14));
			} else {
				var_1_94 = ((var_1_72 + (var_1_96 - var_1_36)) - (max (var_1_69 , (var_1_53 + var_1_16))));
			}
		}
	} else {
		var_1_94 = var_1_33;
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((var_1_97 ? (var_1_1 == ((unsigned short int) (min ((var_1_3 + var_1_4) , (var_1_5 - (abs (var_1_6))))))) : (var_1_1 == ((unsigned short int) (min ((var_1_5 - var_1_6) , (var_1_3 + (256 + 1))))))) && (((var_1_40 / var_1_9) != var_1_78) ? ((var_1_9 >= var_1_78) ? (var_1_7 == ((unsigned short int) var_1_6)) : ((var_1_5 <= var_1_6) ? ((var_1_4 < ((var_1_6 + var_1_87) + (var_1_92 / var_1_5))) ? ((var_1_40 != var_1_9) ? (var_1_7 == ((unsigned short int) (var_1_5 - var_1_13))) : ((var_1_78 >= var_1_40) ? (var_1_7 == ((unsigned short int) ((var_1_14 + var_1_15) - var_1_3))) : 1)) : (var_1_7 == ((unsigned short int) ((var_1_16 - (max (var_1_17 , 5))) - var_1_13)))) : (var_1_7 == ((unsigned short int) ((max (var_1_17 , var_1_3)) + (var_1_14 - (var_1_18 + var_1_19))))))) : (var_1_7 == ((unsigned short int) var_1_3)))) && (((var_1_7 + 10) != ((abs (var_1_5)) * var_1_3)) ? (var_1_20 == ((unsigned short int) (var_1_3 + (var_1_14 - (var_1_22 - var_1_19))))) : (var_1_20 == ((unsigned short int) var_1_6)))) && ((! (var_1_97 && var_1_50)) ? (var_1_23 == ((signed char) (var_1_25 - var_1_26))) : 1)) && ((var_1_9 < (var_1_109 / 0.125)) ? (((2 * (min (var_1_14 , var_1_3))) < var_1_61) ? (var_1_27 == ((unsigned short int) (var_1_5 - var_1_15))) : (var_1_27 == ((unsigned short int) (max (var_1_18 , 5))))) : (var_1_27 == ((unsigned short int) ((var_1_14 + var_1_15) - (var_1_22 + (max (var_1_26 , var_1_18)))))))) && ((var_1_19 > 8) ? (var_1_29 == ((unsigned char) (abs (var_1_26)))) : ((var_1_18 < (var_1_93 * (var_1_3 ^ 5))) ? (var_1_29 == ((unsigned char) (max (5 , var_1_26)))) : (var_1_29 == ((unsigned char) ((var_1_30 - var_1_31) - (var_1_32 - (10 + var_1_33)))))))) && ((var_1_6 <= var_1_93) ? (((var_1_9 / var_1_35) > var_1_58) ? (var_1_34 == ((unsigned char) (max (((var_1_32 + 100) - var_1_33) , (var_1_30 - (var_1_36 - var_1_31)))))) : 1) : 1)) && ((var_1_109 > var_1_102) ? ((var_1_30 == var_1_26) ? (((var_1_61 < (var_1_5 - 32)) && var_1_50) ? (var_1_37 == ((unsigned long int) (abs (var_1_93)))) : (var_1_37 == ((unsigned long int) ((1592924859u + 1867977025u) - (max ((var_1_38 - var_1_93) , (max (var_1_16 , var_1_13)))))))) : 1) : (((min ((var_1_20 / var_1_32) , 1u)) < var_1_5) ? (var_1_37 == ((unsigned long int) var_1_16)) : (var_1_37 == ((unsigned long int) ((min ((var_1_61 + var_1_6) , (var_1_38 - var_1_93))) + var_1_15)))))) && ((var_1_50 || (var_1_32 == var_1_33)) ? (var_1_50 ? (var_1_39 == ((signed short int) (-32 + var_1_87))) : (var_1_90 ? (var_1_39 == ((signed short int) (abs (-128 + (max (var_1_26 , var_1_32)))))) : (var_1_39 == ((signed short int) var_1_17)))) : (var_1_39 == ((signed short int) var_1_87)))) && ((var_1_16 <= 1000) ? (var_1_50 ? (var_1_40 == ((double) (var_1_41 - (abs (var_1_42 - var_1_43))))) : (var_1_40 == ((double) var_1_41))) : ((var_1_50 || var_1_90) ? (var_1_40 == ((double) (var_1_45 + var_1_46))) : (var_1_40 == ((double) (var_1_45 + (var_1_47 - (max (var_1_48 , var_1_49))))))))) && ((var_1_17 == var_1_30) ? (var_1_50 == ((unsigned char) (! ((var_1_38 >= last_1_var_1_89) && (last_1_var_1_97 && var_1_51))))) : 1)) && (var_1_97 ? (var_1_52 == ((double) (var_1_49 + var_1_48))) : (var_1_52 == ((double) ((var_1_49 + var_1_48) - (7.2 + (max (4.375 , var_1_47)))))))) && (var_1_50 ? (var_1_53 == ((signed long int) (min (var_1_5 , (max (var_1_37 , var_1_4)))))) : ((var_1_97 && var_1_51) ? (var_1_53 == ((signed long int) ((var_1_55 - var_1_7) + (abs (var_1_25 + var_1_36))))) : 1))) && ((var_1_92 >= var_1_37) ? (var_1_54 == ((signed long int) (min (var_1_39 , var_1_87)))) : (var_1_54 == ((signed long int) (max (var_1_39 , (var_1_22 - (last_1_var_1_54 + var_1_17)))))))) && (((- (var_1_42 + 24.75f)) >= (- 99.2)) ? (var_1_55 == ((signed long int) var_1_16)) : (var_1_55 == ((signed long int) (((var_1_56 - 50) - var_1_57) + var_1_25))))) && ((var_1_38 < var_1_13) ? ((var_1_4 >= (var_1_16 - 8)) ? (var_1_58 == ((double) ((var_1_59 + (var_1_60 - 9999999.5)) + var_1_45))) : (var_1_58 == ((double) (var_1_43 - var_1_60)))) : 1)) && ((255.625f > (last_1_var_1_40 / var_1_35)) ? ((last_1_var_1_53 < last_1_var_1_54) ? (var_1_61 == ((signed long int) (var_1_56 + (min (last_1_var_1_104 , (var_1_18 - last_1_var_1_92)))))) : 1) : 1)) && ((((var_1_32 - var_1_26) * (~ 5)) <= (var_1_37 + var_1_22)) ? (var_1_62 == ((double) (var_1_42 - var_1_49))) : (var_1_62 == ((double) (min (((4.55 + var_1_59) + var_1_64) , var_1_49)))))) && ((var_1_51 || var_1_90) ? ((((var_1_66 - var_1_49) - var_1_41) > var_1_60) ? ((var_1_41 < (var_1_102 + var_1_35)) ? (var_1_65 == ((signed char) var_1_33)) : (var_1_65 == ((signed char) (((var_1_67 - var_1_33) + (var_1_68 + var_1_69)) - 1)))) : 1) : (var_1_65 == ((signed char) (var_1_26 - var_1_69))))) && ((((min (var_1_89 , var_1_25)) - var_1_6) <= (abs (var_1_22))) ? (var_1_70 == ((float) (var_1_46 + var_1_47))) : (((! var_1_51) && ((! var_1_90) || var_1_90)) ? (var_1_70 == ((float) var_1_41)) : (var_1_70 == ((float) (abs (var_1_60))))))) && ((200.2f >= ((var_1_41 - 7.6f) * var_1_40)) ? ((var_1_104 <= var_1_22) ? (var_1_71 == ((unsigned long int) (abs (var_1_1 + 2u)))) : (var_1_71 == ((unsigned long int) ((var_1_38 + (max (var_1_72 , var_1_73))) - var_1_103)))) : ((var_1_89 > var_1_61) ? (var_1_51 ? (var_1_50 ? ((128 >= (var_1_37 + (min (var_1_18 , var_1_89)))) ? (var_1_71 == ((unsigned long int) (abs (2704285562u - var_1_89)))) : 1) : (var_1_71 == ((unsigned long int) (var_1_74 - var_1_55)))) : (var_1_90 ? (var_1_71 == ((unsigned long int) (min ((max ((var_1_74 - var_1_33) , (var_1_36 + 10u))) , var_1_57)))) : (var_1_71 == ((unsigned long int) (min ((var_1_74 - var_1_6) , (min (8u , (var_1_75 + var_1_3))))))))) : 1))) && (var_1_50 ? ((var_1_71 >= (var_1_73 + var_1_37)) ? ((var_1_51 && (4 <= (var_1_33 * var_1_16))) ? ((var_1_68 != var_1_19) ? (var_1_76 == ((signed char) var_1_25)) : (var_1_76 == ((signed char) ((var_1_33 + var_1_69) + var_1_31)))) : (var_1_76 == ((signed char) (abs (16))))) : (var_1_76 == ((signed char) (var_1_77 + var_1_68)))) : 1)) && ((((var_1_14 << var_1_5) * (var_1_39 / var_1_22)) < var_1_72) ? ((((- var_1_9) + var_1_46) >= var_1_35) ? (var_1_78 == ((double) (abs (min ((var_1_41 - var_1_42) , var_1_47))))) : (var_1_50 ? ((var_1_73 >= var_1_18) ? (var_1_78 == ((double) var_1_64)) : (((-10 < var_1_92) || var_1_50) ? (var_1_78 == ((double) var_1_42)) : ((var_1_47 > var_1_102) ? (var_1_78 == ((double) (var_1_48 - (var_1_80 - (var_1_60 + var_1_81))))) : (var_1_50 ? (var_1_78 == ((double) (var_1_82 + var_1_81))) : (var_1_78 == ((double) 16.4)))))) : (var_1_78 == ((double) var_1_41)))) : ((var_1_97 && var_1_90) ? (var_1_78 == ((double) (var_1_81 - var_1_42))) : ((var_1_27 >= ((var_1_99 + var_1_36) * var_1_92)) ? (var_1_78 == ((double) var_1_42)) : (((var_1_82 / var_1_35) > 127.5) ? (var_1_78 == ((double) (var_1_48 - var_1_43))) : (var_1_78 == ((double) ((var_1_60 + (var_1_83 + var_1_84)) + ((2.7787266778944676E18 - var_1_81) - var_1_49))))))))) && (((var_1_69 - var_1_32) >= var_1_13) ? (var_1_97 ? ((var_1_107 <= var_1_3) ? (var_1_85 == ((unsigned char) ((abs (var_1_30)) - (max (var_1_32 , (max (var_1_67 , var_1_33))))))) : ((var_1_97 || var_1_50) ? (var_1_85 == ((unsigned char) var_1_36)) : ((var_1_31 == var_1_3) ? (var_1_85 == ((unsigned char) 1)) : 1))) : (var_1_85 == ((unsigned char) (max (16 , (max (var_1_30 , (min (var_1_31 , var_1_69))))))))) : 1)) && (var_1_86 == ((float) (((var_1_81 - var_1_60) + var_1_83) + var_1_49)))) && ((last_1_var_1_61 <= (min (var_1_68 , 5))) ? (var_1_87 == ((signed long int) ((25 - var_1_3) + (var_1_26 + var_1_88)))) : (var_1_87 == ((signed long int) ((var_1_68 + 2) - last_1_var_1_61))))) && ((last_1_var_1_85 <= last_1_var_1_54) ? (var_1_89 == ((unsigned long int) (last_1_var_1_37 + last_1_var_1_104))) : (var_1_89 == ((unsigned long int) (var_1_74 - (max (var_1_15 , var_1_5))))))) && ((var_1_31 > var_1_57) ? (var_1_90 == ((unsigned char) (! (var_1_51 || var_1_91)))) : (var_1_90 == ((unsigned char) (var_1_51 || var_1_91))))) && ((last_1_var_1_89 < ((var_1_74 - var_1_5) * var_1_69)) ? ((last_1_var_1_40 != var_1_48) ? (var_1_92 == ((unsigned long int) (var_1_68 + var_1_30))) : (var_1_92 == ((unsigned long int) (var_1_74 - last_1_var_1_92)))) : (var_1_92 == ((unsigned long int) (4078447304u - (var_1_69 + var_1_31)))))) && (((var_1_4 + var_1_56) > var_1_73) ? (var_1_93 == ((signed long int) var_1_92)) : (var_1_90 ? (var_1_93 == ((signed long int) (min (var_1_6 , ((min (var_1_68 , var_1_69)) + var_1_18))))) : (((-10 + var_1_87) < var_1_27) ? (var_1_93 == ((signed long int) ((var_1_13 - 8) + var_1_17))) : (var_1_93 == ((signed long int) (var_1_92 + var_1_1))))))) && ((var_1_90 && (var_1_97 && (var_1_84 >= var_1_100))) ? ((var_1_88 >= var_1_32) ? (var_1_94 == ((unsigned long int) (var_1_63 + var_1_19))) : ((var_1_30 >= (var_1_95 - 16)) ? (var_1_94 == ((unsigned long int) (min (var_1_69 , var_1_14)))) : (var_1_94 == ((unsigned long int) ((var_1_72 + (var_1_96 - var_1_36)) - (max (var_1_69 , (var_1_53 + var_1_16)))))))) : (var_1_94 == ((unsigned long int) var_1_33)))) && (var_1_50 ? (var_1_97 == ((unsigned char) var_1_98)) : (var_1_97 == ((unsigned char) var_1_51)))) && (var_1_50 ? (var_1_99 == ((unsigned long int) var_1_33)) : 1)) && (var_1_97 ? (var_1_100 == ((double) var_1_60)) : 1)) && (var_1_50 ? (var_1_101 == ((signed long int) var_1_57)) : (var_1_101 == ((signed long int) var_1_71)))) && (var_1_102 == ((double) 0.12))) && (var_1_97 ? (var_1_103 == ((unsigned short int) var_1_18)) : (var_1_103 == ((unsigned short int) var_1_3)))) && (var_1_104 == ((signed long int) var_1_67))) && (var_1_105 == ((unsigned char) (max ((min (var_1_32 , var_1_31)) , var_1_106))))) && (var_1_91 ? (((min ((var_1_74 * var_1_14) , var_1_5)) != var_1_89) ? (var_1_107 == ((signed short int) (var_1_106 + var_1_92))) : 1) : (var_1_107 == ((signed short int) (min ((var_1_30 - var_1_68) , (var_1_106 - (min (var_1_69 , 0))))))))) && (var_1_109 == ((double) var_1_80))
;
}
int main(void) {
	isInitial = 1;
