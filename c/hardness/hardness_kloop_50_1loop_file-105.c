...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10550_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch10550_1loop
	if ((var_1_18 - (max (var_1_19 , var_1_20))) > 0.0) {
		var_1_17 = var_1_9;
	}


	// From: Req5Batch10550_1loop
	if (var_1_2 || var_1_8) {
		var_1_21 = ((var_1_22 + var_1_23) + 3.75);
	}


	// From: Req1Batch10550_1loop
	if (var_1_21 != 255.6) {
		var_1_1 = var_1_4;
	} else {
