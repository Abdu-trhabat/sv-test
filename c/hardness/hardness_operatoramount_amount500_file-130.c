...
void step(void) {
	// From: Req13Batch130Amount500
	if (var_1_48 > 99.625) {
		var_1_52 = var_1_7;
	} else {
		if (var_1_48 > ((var_1_21 + var_1_29) - var_1_46)) {
			var_1_52 = ((min ((var_1_10 - var_1_11) , (last_1_var_1_108 + var_1_40))) + (max (var_1_7 , var_1_5)));
		} else {
			var_1_52 = (min (last_1_var_1_68 , var_1_40));
		}
	}


	// From: Req11Batch130Amount500
	...
	if (last_1_var_1_99) {
		if (! (last_1_var_1_36 < (~ last_1_var_1_1))) {
			if (200.7f > ((last_1_var_1_72 + last_1_var_1_88) * last_1_var_1_81)) {
				...
				var_1_42 = (((max (var_1_45 , var_1_46)) - (max (3.25 , var_1_21))) - ((max (var_1_47 , var_1_48)) - var_1_24));
			}
		}
	} else {
		if (stepLocal_7 > last_1_var_1_73) {
			var_1_42 = (min ((var_1_20 + 63.6) , 8.875));
		}
	}


	// From: Req22Batch130Amount500
	...
	if (var_1_48 < var_1_42) {
		if ((var_1_60 + var_1_59) > stepLocal_14) {
			...
			var_1_72 = (abs (var_1_25 - var_1_22));
		}
	} else {
		var_1_72 = (min (var_1_47 , ((var_1_46 - var_1_23) - (var_1_21 + var_1_25))));
	}


	// From: Req7Batch130Amount500
	...
	// From: Req8Batch130Amount500
	var_1_36 = (var_1_37 - var_1_35);


	// From: Req24Batch130Amount500
	unsigned long int stepLocal_16 = var_1_59;
	if (var_1_55) {
		if (var_1_37 > stepLocal_16) {
			var_1_75 = (abs (var_1_76 - var_1_77));
		} else {
			var_1_75 = ((min (var_1_77 , (var_1_78 + var_1_79))) - 4);
		}
	} else {
	...
	// From: Req32Batch130Amount500
	var_1_88 = (max ((min (var_1_48 , var_1_25)) , 7.8f));


	// From: Req35Batch130Amount500
	var_1_94 = 0;


	// From: Req36Batch130Amount500
	if (var_1_55) {
		var_1_95 = var_1_33;
	} else {
		var_1_95 = var_1_30;
	...
	// From: Req37Batch130Amount500
	if (var_1_27) {
		var_1_96 = var_1_90;
	}


	// From: Req39Batch130Amount500
	var_1_98 = var_1_27;


	// From: Req41Batch130Amount500
	var_1_100 = var_1_63;


	// From: Req42Batch130Amount500
	if (var_1_94) {
		var_1_101 = var_1_24;
	} else {
		var_1_101 = var_1_46;
	...
	// From: Req43Batch130Amount500
	var_1_102 = var_1_39;


	// From: Req46Batch130Amount500
	var_1_105 = var_1_93;


	// From: Req49Batch130Amount500
	var_1_108 = 25;


	// From: Req9Batch130Amount500
	var_1_38 = (var_1_96 + (var_1_39 - (var_1_40 - var_1_30)));


	// From: Req25Batch130Amount500
	if (var_1_94) {
		var_1_80 = var_1_76;
	} else {
	...
	// From: Req28Batch130Amount500
	if (var_1_98) {
		var_1_84 = (max (1 , (var_1_31 - (abs (var_1_32)))));
	} else {
		var_1_84 = var_1_40;
	}


	// From: Req33Batch130Amount500
	...
	if ((- var_1_36) < stepLocal_23) {
		...
		var_1_89 = (min ((max (var_1_90 , (var_1_79 - var_1_77))) , (var_1_76 - var_1_78)));
	}


	// From: Req38Batch130Amount500
	if (var_1_98) {
		var_1_97 = var_1_54;
	} else {
		var_1_97 = var_1_27;
	...
	// From: Req45Batch130Amount500
	if (var_1_97) {
		var_1_104 = var_1_22;
	}


	// From: Req3Batch130Amount500
	...
	if (var_1_8 < stepLocal_5) {
		if (stepLocal_6 >= var_1_36) {
			if (((max (var_1_25 , var_1_21)) * (- var_1_23)) < (15.5 - (var_1_24 + var_1_29))) {
				var_1_28 = (min ((min (0 , (min (var_1_30 , var_1_31)))) , (var_1_32 - var_1_33)));
			}
		} else {
			var_1_28 = (var_1_32 - var_1_33);
		}
	} else {
		var_1_28 = (max ((max (var_1_32 , (abs (var_1_33)))) , var_1_30));
	}


	// From: Req15Batch130Amount500
	if (var_1_99 && var_1_97) {
		var_1_56 = (((min (var_1_31 , var_1_15)) + var_1_39) + (var_1_38 + (abs (var_1_8))));
	}


	// From: Req47Batch130Amount500
	if (var_1_26) {
		var_1_106 = var_1_102;
	} else {
		var_1_106 = var_1_76;
	...
	// From: Req16Batch130Amount500
	signed long int stepLocal_9 = var_1_6;
	unsigned char stepLocal_8 = (var_1_6 % var_1_50) <= 64;
	if (-25 > stepLocal_9) {
		if (var_1_99) {
			if (stepLocal_8 && var_1_54) {
				var_1_57 = (abs (var_1_35));
			} else {
				var_1_57 = (var_1_59 + var_1_39);
			}
		} else {
			var_1_57 = (max (var_1_56 , var_1_30));
		}
	} else {
		if (var_1_42 < (- var_1_20)) {
			var_1_57 = ((max (10u , var_1_58)) + ((var_1_60 - var_1_8) - var_1_40));
		}
	}


	// From: Req14Batch130Amount500
	if (var_1_36 >= (min ((- var_1_57) , var_1_40))) {
		if ((min (var_1_39 , var_1_36)) != ((var_1_30 >> 1) / var_1_40)) {
	...
	// From: Req10Batch130Amount500
	if (((var_1_5 * -32) & (var_1_33 * var_1_57)) != var_1_15) {
		var_1_41 = (min ((abs (var_1_31)) , (max (var_1_40 , (var_1_16 + var_1_32)))));
	} else {
		if (var_1_26) {
			var_1_41 = -256;
		} else {
	...
	// From: Req12Batch130Amount500
	if (var_1_94 && (! var_1_27)) {
		if (! var_1_27) {
			if (var_1_13 <= (var_1_84 / (min (var_1_50 , var_1_39)))) {
				var_1_49 = (max ((var_1_20 + var_1_21) , var_1_23));
			} else {
				var_1_49 = (((max (var_1_23 , var_1_22)) + var_1_25) - (min ((abs (var_1_51)) , var_1_46)));
			}
		}
	}


	// From: Req30Batch130Amount500
	...
	if (stepLocal_19 == (50 / var_1_63)) {
		if (stepLocal_20 < (var_1_77 - var_1_78)) {
			var_1_86 = (max ((var_1_22 - (max (var_1_29 , var_1_24))) , (min ((var_1_25 + var_1_19) , 15.6))));
		} else {
			var_1_86 = (max ((var_1_24 + var_1_21) , var_1_23));
		}
	} else {
		var_1_86 = (var_1_25 + (abs (var_1_24)));
	}


	// From: Req48Batch130Amount500
	unsigned char stepLocal_26 = var_1_11 < var_1_13;
	if (stepLocal_26 && var_1_99) {
		var_1_107 = (var_1_24 + (max (var_1_20 , (min (var_1_25 , var_1_22)))));
	} else {
		var_1_107 = (abs (var_1_24 - var_1_47));
	}


	// From: Req20Batch130Amount500
	if ((- var_1_21) <= var_1_19) {
		if ((var_1_6 - var_1_39) < var_1_12) {
			var_1_67 = (var_1_6 + var_1_52);
		} else {
			var_1_67 = ((abs (var_1_32 + var_1_39)) + (var_1_31 + (max (var_1_40 , var_1_13))));
		}
	}


	// From: Req27Batch130Amount500
	unsigned long int stepLocal_18 = min (256u , var_1_30);
	...
	if (stepLocal_25 || (var_1_78 != var_1_38)) {
		if (stepLocal_24 <= var_1_16) {
			var_1_91 = (max (var_1_79 , (var_1_77 - var_1_76)));
		} else {
			var_1_91 = ((min (var_1_78 , (min (var_1_90 , var_1_77)))) - (var_1_79 + var_1_93));
		}
	} else {
	...
	// From: Req21Batch130Amount500
	if (var_1_51 <= var_1_22) {
		var_1_68 = ((max ((var_1_69 - var_1_33) , var_1_70)) - var_1_52);
	} else {
		if (var_1_42 >= var_1_45) {
			var_1_68 = (var_1_31 + ((max (var_1_30 , var_1_52)) + var_1_40));
		} else {
	...
	// From: Req23Batch130Amount500
	unsigned char stepLocal_15 = var_1_33;
	if (var_1_99) {
		if (stepLocal_15 < var_1_106) {
			var_1_73 = (min (var_1_15 , (var_1_40 + var_1_63)));
		}
	} else {
		var_1_73 = ((max ((min (var_1_66 , var_1_63)) , var_1_30)) + -4);
	}


	// From: Req1Batch130Amount500
	...
	if (var_1_98) {
		if (var_1_34 != stepLocal_1) {
			...
			if (8.5f >= var_1_104) {
				var_1_1 = (max ((var_1_68 + (var_1_8 - var_1_7)) , var_1_6));
			} else {
	...
	// From: Req26Batch130Amount500
	if ((var_1_37 - (var_1_60 - 8u)) != (var_1_57 + (- var_1_7))) {
		if (var_1_50 <= var_1_57) {
			var_1_81 = (var_1_20 + ((max (var_1_25 , var_1_21)) - var_1_23));
		}
	} else {
		if ((min ((var_1_76 / var_1_64) , (var_1_37 + var_1_78))) > ((var_1_66 * var_1_73) / var_1_70)) {
			var_1_81 = ((max (var_1_29 , var_1_82)) - (var_1_24 + var_1_22));
		} else {
			var_1_81 = ((max (var_1_20 , (0.5f + var_1_23))) + (abs (var_1_24 - var_1_21)));
		}
	}


	// From: Req17Batch130Amount500
	...
	if (stepLocal_11 && var_1_54) {
		if (stepLocal_10 && (var_1_107 < var_1_81)) {
			if ((var_1_32 + var_1_50) <= stepLocal_12) {
				var_1_61 = (min (var_1_30 , var_1_32));
			}
		}
	} else {
		if ((max ((- var_1_81) , -0.2f)) <= (var_1_46 - var_1_45)) {
			var_1_61 = ((var_1_63 + var_1_64) - var_1_33);
		}
	}


	// From: Req18Batch130Amount500
	if ((var_1_57 / var_1_32) <= var_1_66) {
		var_1_65 = (min (var_1_7 , (25 - var_1_5)));
	} else {
	...
	// From: Req29Batch130Amount500
	if (var_1_79 < (var_1_102 / var_1_50)) {
		var_1_85 = (abs (var_1_66));
	} else {
		var_1_85 = ((var_1_10 - var_1_8) - var_1_84);
	}


	// From: Req31Batch130Amount500
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((var_1_98 ? ((var_1_34 != var_1_68) ? ((var_1_34 < var_1_68) ? (var_1_1 == ((signed long int) ((var_1_5 - (max (2 , var_1_6))) - 64))) : (var_1_1 == ((signed long int) ((var_1_6 - (var_1_7 - var_1_8)) + var_1_34)))) : ((8.5f >= var_1_104) ? (var_1_1 == ((signed long int) (max ((var_1_68 + (var_1_8 - var_1_7)) , var_1_6)))) : (var_1_1 == ((signed long int) (((var_1_10 - var_1_8) - var_1_7) - (var_1_6 + (max (var_1_11 , var_1_12)))))))) : (var_1_1 == ((signed long int) (var_1_7 - (min ((var_1_6 + var_1_11) , var_1_5)))))) && ((var_1_16 == var_1_6) ? ((var_1_94 || var_1_98) ? (var_1_13 == ((signed short int) (min (-32 , var_1_15)))) : 1) : 1)) && ((var_1_94 && var_1_97) ? (var_1_94 ? (var_1_16 == ((unsigned long int) (abs (var_1_5)))) : (var_1_16 == ((unsigned long int) (abs ((3507549886u - var_1_11) - 256u))))) : 1)) && (var_1_53 ? ((var_1_11 > var_1_52) ? (var_1_17 == ((double) (var_1_19 + var_1_20))) : ((! var_1_26) ? (var_1_17 == ((double) ((var_1_21 - (var_1_22 - var_1_23)) + var_1_20))) : (var_1_17 == ((double) (var_1_21 - 7.4))))) : (var_1_17 == ((double) (((var_1_23 + var_1_24) + var_1_25) - var_1_21))))) && ((var_1_99 || (var_1_99 && var_1_94)) ? (var_1_26 == ((unsigned char) (var_1_94 && var_1_27))) : 1)) && ((var_1_8 < var_1_16) ? ((var_1_5 >= var_1_36) ? ((((max (var_1_25 , var_1_21)) * (- var_1_23)) < (15.5 - (var_1_24 + var_1_29))) ? (var_1_28 == ((unsigned char) (min ((min (0 , (min (var_1_30 , var_1_31)))) , (var_1_32 - var_1_33))))) : 1) : (var_1_28 == ((unsigned char) (var_1_32 - var_1_33)))) : (var_1_28 == ((unsigned char) (max ((max (var_1_32 , (abs (var_1_33)))) , var_1_30)))))) && ((var_1_22 < var_1_24) ? (var_1_34 == ((signed short int) ((var_1_35 - var_1_31) - var_1_33))) : (var_1_34 == ((signed short int) (var_1_31 - var_1_30))))) && (var_1_36 == ((unsigned long int) (var_1_37 - var_1_35)))) && (var_1_38 == ((unsigned short int) (var_1_96 + (var_1_39 - (var_1_40 - var_1_30)))))) && ((((var_1_5 * -32) & (var_1_33 * var_1_57)) != var_1_15) ? (var_1_41 == ((signed short int) (min ((abs (var_1_31)) , (max (var_1_40 , (var_1_16 + var_1_32))))))) : (var_1_26 ? (var_1_41 == ((signed short int) -256)) : (var_1_41 == ((signed short int) var_1_33))))) && (last_1_var_1_99 ? ((! (last_1_var_1_36 < (~ last_1_var_1_1))) ? ((200.7f > ((last_1_var_1_72 + last_1_var_1_88) * last_1_var_1_81)) ? ((last_1_var_1_88 != (var_1_19 + (var_1_25 + 1.00000000005E10f))) ? (var_1_42 == ((double) var_1_25)) : (var_1_42 == ((double) var_1_19))) : (var_1_42 == ((double) (((max (var_1_45 , var_1_46)) - (max (3.25 , var_1_21))) - ((max (var_1_47 , var_1_48)) - var_1_24))))) : 1) : ((-16 > last_1_var_1_73) ? (var_1_42 == ((double) (min ((var_1_20 + 63.6) , 8.875)))) : 1))) && ((var_1_94 && (! var_1_27)) ? ((! var_1_27) ? ((var_1_13 <= (var_1_84 / (min (var_1_50 , var_1_39)))) ? (var_1_49 == ((float) (max ((var_1_20 + var_1_21) , var_1_23)))) : (var_1_49 == ((float) (((max (var_1_23 , var_1_22)) + var_1_25) - (min ((abs (var_1_51)) , var_1_46)))))) : 1) : 1)) && ((var_1_48 > 99.625) ? (var_1_52 == ((unsigned long int) var_1_7)) : ((var_1_48 > ((var_1_21 + var_1_29) - var_1_46)) ? (var_1_52 == ((unsigned long int) ((min ((var_1_10 - var_1_11) , (last_1_var_1_108 + var_1_40))) + (max (var_1_7 , var_1_5))))) : (var_1_52 == ((unsigned long int) (min (last_1_var_1_68 , var_1_40))))))) && ((var_1_36 >= (min ((- var_1_57) , var_1_40))) ? (((min (var_1_39 , var_1_36)) != ((var_1_30 >> 1) / var_1_40)) ? (var_1_53 == ((unsigned char) (! ((! var_1_99) && (var_1_98 && var_1_27))))) : (var_1_53 == ((unsigned char) (var_1_26 && var_1_27)))) : (((var_1_16 * var_1_11) < var_1_36) ? ((! (var_1_16 >= var_1_30)) ? (var_1_53 == ((unsigned char) ((var_1_54 && var_1_55) && (! var_1_27)))) : (var_1_53 == ((unsigned char) (! var_1_27)))) : (var_1_53 == ((unsigned char) var_1_55))))) && ((var_1_99 && var_1_97) ? (var_1_56 == ((signed long int) (((min (var_1_31 , var_1_15)) + var_1_39) + (var_1_38 + (abs (var_1_8)))))) : 1)) && ((-25 > var_1_6) ? (var_1_99 ? ((((var_1_6 % var_1_50) <= 64) && var_1_54) ? (var_1_57 == ((unsigned long int) (abs (var_1_35)))) : (var_1_57 == ((unsigned long int) (var_1_59 + var_1_39)))) : (var_1_57 == ((unsigned long int) (max (var_1_56 , var_1_30))))) : ((var_1_42 < (- var_1_20)) ? (var_1_57 == ((unsigned long int) ((max (10u , var_1_58)) + ((var_1_60 - var_1_8) - var_1_40)))) : 1))) && ((var_1_55 && var_1_54) ? ((var_1_54 && (var_1_107 < var_1_81)) ? (((var_1_32 + var_1_50) <= ((-10 | var_1_38) & -32)) ? (var_1_61 == ((unsigned char) (min (var_1_30 , var_1_32)))) : 1) : 1) : (((max ((- var_1_81) , -0.2f)) <= (var_1_46 - var_1_45)) ? (var_1_61 == ((unsigned char) ((var_1_63 + var_1_64) - var_1_33))) : 1))) && (((var_1_57 / var_1_32) <= var_1_66) ? (var_1_65 == ((signed long int) (min (var_1_7 , (25 - var_1_5))))) : (((- var_1_72) == 1.00000000000004E13f) ? (var_1_65 == ((signed long int) (var_1_8 - var_1_39))) : 1))) && ((var_1_99 || (var_1_17 > var_1_45)) ? (var_1_26 ? (var_1_66 == ((unsigned long int) (min ((var_1_37 - var_1_12) , var_1_38)))) : 1) : (var_1_66 == ((unsigned long int) (var_1_37 - var_1_35))))) && (((- var_1_21) <= var_1_19) ? (((var_1_6 - var_1_39) < var_1_12) ? (var_1_67 == ((unsigned long int) (var_1_6 + var_1_52))) : (var_1_67 == ((unsigned long int) ((abs (var_1_32 + var_1_39)) + (var_1_31 + (max (var_1_40 , var_1_13))))))) : 1)) && ((var_1_51 <= var_1_22) ? (var_1_68 == ((unsigned short int) ((max ((var_1_69 - var_1_33) , var_1_70)) - var_1_52))) : ((var_1_42 >= var_1_45) ? (var_1_68 == ((unsigned short int) (var_1_31 + ((max (var_1_30 , var_1_52)) + var_1_40)))) : (var_1_68 == ((unsigned short int) ((var_1_63 + var_1_103) + (var_1_39 - var_1_33))))))) && ((var_1_48 < var_1_42) ? (((var_1_60 + var_1_59) > (4u << var_1_30)) ? (var_1_72 == ((double) (var_1_24 + var_1_20))) : (var_1_72 == ((double) (abs (var_1_25 - var_1_22))))) : (var_1_72 == ((double) (min (var_1_47 , ((var_1_46 - var_1_23) - (var_1_21 + var_1_25)))))))) && (var_1_99 ? ((var_1_33 < var_1_106) ? (var_1_73 == ((signed short int) (min (var_1_15 , (var_1_40 + var_1_63))))) : 1) : (var_1_73 == ((signed short int) ((max ((min (var_1_66 , var_1_63)) , var_1_30)) + -4))))) && (var_1_55 ? ((var_1_37 > var_1_59) ? (var_1_75 == ((signed char) (abs (var_1_76 - var_1_77)))) : (var_1_75 == ((signed char) ((min (var_1_77 , (var_1_78 + var_1_79))) - 4)))) : (var_1_75 == ((signed char) (var_1_78 + var_1_79))))) && (var_1_94 ? (var_1_80 == ((signed char) var_1_76)) : (var_1_80 == ((signed char) (32 + var_1_79))))) && (((var_1_37 - (var_1_60 - 8u)) != (var_1_57 + (- var_1_7))) ? ((var_1_50 <= var_1_57) ? (var_1_81 == ((float) (var_1_20 + ((max (var_1_25 , var_1_21)) - var_1_23)))) : 1) : (((min ((var_1_76 / var_1_64) , (var_1_37 + var_1_78))) > ((var_1_66 * var_1_73) / var_1_70)) ? (var_1_81 == ((float) ((max (var_1_29 , var_1_82)) - (var_1_24 + var_1_22)))) : (var_1_81 == ((float) ((max (var_1_20 , (0.5f + var_1_23))) + (abs (var_1_24 - var_1_21)))))))) && ((var_1_57 > (min (256u , var_1_30))) ? ((var_1_78 <= ((var_1_79 << var_1_67) / var_1_63)) ? (var_1_83 == ((unsigned short int) (var_1_69 - var_1_39))) : (var_1_83 == ((unsigned short int) (var_1_69 - var_1_31)))) : 1)) && (var_1_98 ? (var_1_84 == ((signed long int) (max (1 , (var_1_31 - (abs (var_1_32))))))) : (var_1_84 == ((signed long int) var_1_40)))) && ((var_1_79 < (var_1_102 / var_1_50)) ? (var_1_85 == ((signed long int) (abs (var_1_66)))) : (var_1_85 == ((signed long int) ((var_1_10 - var_1_8) - var_1_84))))) && ((var_1_64 == (50 / var_1_63)) ? ((var_1_57 < (var_1_77 - var_1_78)) ? (var_1_86 == ((double) (max ((var_1_22 - (max (var_1_29 , var_1_24))) , (min ((var_1_25 + var_1_19) , 15.6)))))) : (var_1_86 == ((double) (max ((var_1_24 + var_1_21) , var_1_23))))) : (var_1_86 == ((double) (var_1_25 + (abs (var_1_24))))))) && ((var_1_1 >= 128) ? ((((var_1_5 * var_1_36) * var_1_66) < var_1_66) ? (var_1_87 == ((double) ((var_1_22 - var_1_24) + var_1_25))) : 1) : 1)) && (var_1_88 == ((float) (max ((min (var_1_48 , var_1_25)) , 7.8f))))) && (((- var_1_36) < ((var_1_12 + var_1_6) >> var_1_90)) ? (var_1_94 ? (var_1_89 == ((signed char) var_1_90)) : 1) : (var_1_89 == ((signed char) (min ((max (var_1_90 , (var_1_79 - var_1_77))) , (var_1_76 - var_1_78))))))) && (((var_1_77 <= (var_1_79 - var_1_63)) || (var_1_78 != var_1_38)) ? ((var_1_83 <= var_1_16) ? (var_1_91 == ((signed char) (max (var_1_79 , (var_1_77 - var_1_76))))) : (var_1_91 == ((signed char) ((min (var_1_78 , (min (var_1_90 , var_1_77)))) - (var_1_79 + var_1_93))))) : ((var_1_42 <= (- var_1_21)) ? ((var_1_101 < var_1_104) ? (var_1_91 == ((signed char) var_1_93)) : (var_1_91 == ((signed char) var_1_76))) : 1))) && (var_1_94 == ((unsigned char) 0))) && (var_1_55 ? (var_1_95 == ((unsigned char) var_1_33)) : (var_1_95 == ((unsigned char) var_1_30)))) && (var_1_27 ? (var_1_96 == ((unsigned char) var_1_90)) : 1)) && (var_1_98 ? (var_1_97 == ((unsigned char) var_1_54)) : (var_1_97 == ((unsigned char) var_1_27)))) && (var_1_98 == ((unsigned char) var_1_27))) && (var_1_97 ? (var_1_99 == ((unsigned char) 1)) : (var_1_99 == ((unsigned char) var_1_27)))) && (var_1_100 == ((signed short int) var_1_63))) && (var_1_94 ? (var_1_101 == ((double) var_1_24)) : (var_1_101 == ((double) var_1_46)))) && (var_1_102 == ((unsigned short int) var_1_39))) && (var_1_26 ? (var_1_103 == ((signed short int) var_1_95)) : (var_1_103 == ((signed short int) var_1_83)))) && (var_1_97 ? (var_1_104 == ((double) var_1_22)) : 1)) && (var_1_105 == ((signed short int) var_1_93))) && (var_1_26 ? (var_1_106 == ((signed long int) var_1_102)) : (var_1_106 == ((signed long int) var_1_76)))) && (((var_1_11 < var_1_13) && var_1_99) ? (var_1_107 == ((double) (var_1_24 + (max (var_1_20 , (min (var_1_25 , var_1_22))))))) : (var_1_107 == ((double) (abs (var_1_24 - var_1_47)))))) && (var_1_108 == ((signed short int) 25))
;
}
int main(void) {
	isInitial = 1;
