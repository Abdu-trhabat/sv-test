...
void step(void) {
 ...
 if (stepLocal_1 > (((((last_1_var_1_6) > (var_1_2)) ? (last_1_var_1_6) : (var_1_2))) / ((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8))))) {
  var_1_6 = ((((var_1_4) > (last_1_var_1_6)) ? (var_1_4) : (last_1_var_1_6)));
 }
 unsigned long int stepLocal_2 = var_1_3;
 if (stepLocal_2 > ((((var_1_8) < (var_1_2)) ? (var_1_8) : (var_1_2)))) {
  var_1_9 = var_1_10;
 }
 unsigned char stepLocal_3 = var_1_4 < (var_1_5 | var_1_7);
 if (var_1_12 || stepLocal_3) {
  var_1_11 = (var_1_13 - ((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15))));
 } else {
  var_1_11 = ((((((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) > (var_1_15)) ? (((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) : (var_1_15)));
 }
 var_1_16 = var_1_4;
}
void updateVariables(void) {
...
int property(void) {
 return (((((var_1_2 <= var_1_3) ? (var_1_1 == ((unsigned char) (var_1_4 - 32))) : (var_1_1 == ((unsigned char) ((((((((var_1_4) > (100)) ? (var_1_4) : (100)))) > (var_1_5)) ? (((((var_1_4) > (100)) ? (var_1_4) : (100)))) : (var_1_5)))))) && (((var_1_5 + var_1_4) > (((((last_1_var_1_6) > (var_1_2)) ? (last_1_var_1_6) : (var_1_2))) / ((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8))))) ? (var_1_6 == ((unsigned short int) ((((var_1_4) > (last_1_var_1_6)) ? (var_1_4) : (last_1_var_1_6))))) : 1)) && ((var_1_3 > ((((var_1_8) < (var_1_2)) ? (var_1_8) : (var_1_2)))) ? (var_1_9 == ((signed long int) var_1_10)) : 1)) && ((var_1_12 || (var_1_4 < (var_1_5 | var_1_7))) ? (var_1_11 == ((signed long int) (var_1_13 - ((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15)))))) : (var_1_11 == ((signed long int) ((((((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) > (var_1_15)) ? (((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) : (var_1_15))))))) && (var_1_16 == ((unsigned char) var_1_4))
;
}
int main(void) {
 isInitial = 1;
