...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch6Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 317L, 114L) */ if (/* 318L, 93L, 94L) */ ((/* 319L, 90L, 95L) */ (min (/* 319L, 90L, 95L) */ (var_1_23) , (/* 321L, 89L, 97L) */ ((8) ^ (var_1_16)))))) >= (/* 324L, 92L, 100L) */ (abs (var_1_10))))) {
		/* 326L, 113L) */ var_1_25 = (
			8
		);
	}
	...
	/* 330L, 166L) */ if (/* 331L, 123L, 124L) */ ((var_1_23) >= (/* 333L, 122L, 126L) */ ((/* 334L, 120L, 127L) */ (abs (var_1_28))) - (var_1_29))))) {
		/* 337L, 164L) */ if (/* 338L, 138L, 139L) */ ((var_1_23) != (var_1_29))) {
			...
			/* 345L, 162L) */ if (/* 346L, 151L, 152L) */ ((var_1_19) || (var_1_18))) {
				/* 349L, 161L) */ var_1_27 = (
					var_1_30
				);
			}
	...
	// From: CodeObject6
	/* 372L, 219L) */ if (/* 373L, 202L, 203L) */ ((var_1_9) > (/* 375L, 201L, 205L) */ ((var_1_11) + (var_1_33))))) {
		/* 378L, 218L) */ var_1_34 = (
			/* 381L, 217L) */ (max (
				/* 381L, 217L) */ (
					var_1_35
	...
	/* 307L, 81L) */ if (var_1_17) {
		/* 309L, 79L) */ if (/* 310L, 68L, 69L) */ ((var_1_11) <= (var_1_23))) {
			/* 313L, 78L) */ var_1_20 = (
				10
			);
		}
	...
	// From: CodeObject7
	/* 384L, 272L) */ if (/* 385L, 229L, 230L) */ ((var_1_8) > (/* 387L, 228L, 232L) */ (min (/* 387L, 228L, 232L) */ (var_1_8) , (/* 389L, 227L, 234L) */ (max (/* 389L, 227L, 234L) */ (var_1_29) , (var_1_16))))))))) {
		/* 392L, 270L) */ if (/* 393L, 249L, 250L) */ ((-256) != (/* 395L, 248L, 252L) */ (max (/* 395L, 248L, 252L) */ (10000000) , (var_1_4)))))) {
			/* 398L, 269L) */ var_1_37 = (
				/* 401L, 268L) */ ((
					/* 402L, 265L) */ (abs (
						/* 403L, 264L) */ ((
