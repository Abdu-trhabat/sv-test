...
void step(void) {
	...
	// From: Req4Batch188Wrapper_A
	signed_short_int_Array_0[0] = unsigned_char_Array_0[6];


	// From: Req5Batch188Wrapper_A
	signed_char_Array_0[0] = unsigned_char_Array_0[0];


	// From: Req3Batch188Wrapper_A
	if ((abs (signed_long_int_Array_0[1][0])) <= signed_long_int_Array_0[1][0]) {
		if (signed_char_Array_0[2] <= signed_long_int_Array_0[1][0]) {
			unsigned_char_Array_0[1] = (((unsigned_char_Array_0[0] - 4) - (max (unsigned_char_Array_0[4] , unsigned_char_Array_0[5]))) - (unsigned_char_Array_0[2] - unsigned_char_Array_0[3]));
		} else {
			unsigned_char_Array_0[1] = ((min (unsigned_char_Array_0[6] , unsigned_char_Array_0[4])) + (unsigned_char_Array_0[5] + unsigned_char_Array_0[3]));
		}
	} else {
...
int property(void) {
	return (((((last_1_signed_short_int_Array_0_0_ != last_1_unsigned_char_Array_0_1_) ? (((last_1_unsigned_char_Array_0_1_ != last_1_signed_short_int_Array_0_0_) && (signed_long_int_Array_0[1][1] < signed_long_int_Array_0[0][1])) ? (signed_char_Array_0[2] == ((signed char) signed_char_Array_0[1])) : 1) : 1) && ((BOOL_unsigned_char_Array_0[1] && BOOL_unsigned_char_Array_0[0]) ? (signed_long_int_Array_0[1][0] == ((signed long int) ((256 - signed_long_int_Array_0[0][0]) + last_1_signed_long_int_Array_0_1__0_))) : 1)) && (((abs (signed_long_int_Array_0[1][0])) <= signed_long_int_Array_0[1][0]) ? ((signed_char_Array_0[2] <= signed_long_int_Array_0[1][0]) ? (unsigned_char_Array_0[1] == ((unsigned char) (((unsigned_char_Array_0[0] - 4) - (max (unsigned_char_Array_0[4] , unsigned_char_Array_0[5]))) - (unsigned_char_Array_0[2] - unsigned_char_Array_0[3])))) : (unsigned_char_Array_0[1] == ((unsigned char) ((min (unsigned_char_Array_0[6] , unsigned_char_Array_0[4])) + (unsigned_char_Array_0[5] + unsigned_char_Array_0[3]))))) : (unsigned_char_Array_0[1] == ((unsigned char) 64)))) && (signed_short_int_Array_0[0] == ((signed short int) unsigned_char_Array_0[6]))) && (signed_char_Array_0[0] == ((signed char) unsigned_char_Array_0[0]))
;
}
int main(void) {
	isInitial = 1;
