...
void step(void) {
	...
	// From: Req4Batch139stepLocals
	if (var_1_10 >= ((var_1_5 + var_1_4) + var_1_13)) {
		var_1_17 = var_1_16;
	}


	// From: Req5Batch139stepLocals
