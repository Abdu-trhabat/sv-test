...
void step(void) {
	...
	// From: Req1Batch131100_1loop
	var_1_1 = (abs (var_1_2));


	// From: Req3Batch131100_1loop
	...
	// From: Req10Batch131100_1loop
	if (! (var_1_5 != var_1_16)) {
		var_1_28 = (min ((var_1_22 - var_1_23) , 9.9999999125E7));
	}


	// From: Req6Batch131100_1loop
