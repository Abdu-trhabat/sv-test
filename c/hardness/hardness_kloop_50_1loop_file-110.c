...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11050_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch11050_1loop
	var_1_20 = (min (var_1_21 , 8.25));


	// From: Req7Batch11050_1loop
	...
	// From: Req5Batch11050_1loop
	if (var_1_22) {
		var_1_17 = (var_1_18 && var_1_19);
	}


	// From: Req3Batch11050_1loop
	if ((- (last_1_var_1_11 + var_1_10)) != ((min (var_1_9 , var_1_5)) * (var_1_12 / var_1_8))) {
		if (var_1_22) {
			var_1_11 = var_1_7;
		} else {
			var_1_11 = var_1_6;
...
int property(void) {
	return (((((((var_1_2 != ((min (var_1_3 , var_1_4)) / var_1_5)) ? (var_1_1 == ((signed char) (max ((var_1_6 + 25) , var_1_7)))) : (var_1_1 == ((signed char) ((var_1_8 - (var_1_9 + 2)) - 10)))) && ((var_1_5 < (var_1_8 - var_1_9)) ? ((last_1_var_1_11 >= var_1_6) ? (var_1_10 == ((signed long int) 128)) : 1) : 1)) && (((- (last_1_var_1_11 + var_1_10)) != ((min (var_1_9 , var_1_5)) * (var_1_12 / var_1_8))) ? (var_1_22 ? (var_1_11 == ((signed long int) var_1_7)) : (var_1_11 == ((signed long int) var_1_6))) : (var_1_11 == ((signed long int) var_1_7)))) && (((var_1_8 - var_1_9) < var_1_11) ? (((max (var_1_7 , (var_1_5 ^ var_1_10))) <= ((var_1_8 >> var_1_16) + var_1_6)) ? (var_1_14 == ((signed char) var_1_7)) : (var_1_14 == ((signed char) 32))) : 1)) && (var_1_22 ? (var_1_17 == ((unsigned char) (var_1_18 && var_1_19))) : 1)) && (var_1_20 == ((double) (min (var_1_21 , 8.25))))) && (((var_1_8 == var_1_6) && var_1_19) ? (var_1_22 == ((unsigned char) ((var_1_23 || var_1_24) || var_1_25))) : (var_1_22 == ((unsigned char) var_1_25)))
;
}
int main(void) {
	isInitial = 1;
