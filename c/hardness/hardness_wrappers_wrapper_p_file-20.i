...
void step(void) {
 ...
 if ((*(var_1_10_Pointer)) || stepLocal_0) {
  ...
  (*(var_1_9_Pointer)) = ((*(var_1_13_Pointer)) + (((((*(var_1_12_Pointer))) < 0 ) ? -((*(var_1_12_Pointer))) : ((*(var_1_12_Pointer))))));
 }
