...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch28Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_1 <= (max ((*(var_1_5_Pointer)) , (*(var_1_7_Pointer))))) {
		(*(var_1_12_Pointer)) = ((min ((*(var_1_6_Pointer)) , ((*(var_1_13_Pointer)) - (*(var_1_14_Pointer))))) - ((*(var_1_15_Pointer)) - (abs ((*(var_1_5_Pointer))))));
	} else {
		(*(var_1_12_Pointer)) = ((*(var_1_6_Pointer)) + ((min ((*(var_1_14_Pointer)) , (*(var_1_16_Pointer)))) - (*(var_1_17_Pointer))));
	}
...
int property(void) {
	return ((((((((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) <= (- (*(var_1_8_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed char) (min (((*(var_1_5_Pointer)) - (*(var_1_6_Pointer))) , (*(var_1_7_Pointer)))))) : ((*(var_1_1_Pointer)) == ((signed char) (*(var_1_5_Pointer))))) && ((-4 < (*(var_1_6_Pointer))) ? ((*(var_1_8_Pointer)) == ((float) (min ((*(var_1_9_Pointer)) , (*(var_1_10_Pointer)))))) : 1)) && ((*(var_1_11_Pointer)) == ((float) (max ((*(var_1_9_Pointer)) , (*(var_1_10_Pointer))))))) && ((((*(var_1_6_Pointer)) | 5) <= (max ((*(var_1_5_Pointer)) , (*(var_1_7_Pointer))))) ? ((*(var_1_12_Pointer)) == ((signed long int) ((min ((*(var_1_6_Pointer)) , ((*(var_1_13_Pointer)) - (*(var_1_14_Pointer))))) - ((*(var_1_15_Pointer)) - (abs ((*(var_1_5_Pointer)))))))) : ((*(var_1_12_Pointer)) == ((signed long int) ((*(var_1_6_Pointer)) + ((min ((*(var_1_14_Pointer)) , (*(var_1_16_Pointer)))) - (*(var_1_17_Pointer)))))))) && ((*(var_1_18_Pointer)) == ((signed short int) (*(var_1_5_Pointer))))) && ((*(var_1_19_Pointer)) == ((unsigned short int) (*(var_1_6_Pointer))))
;
}
int main(void) {
	isInitial = 1;
