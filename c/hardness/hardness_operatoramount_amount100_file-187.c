...
void step(void) {
	...
	// From: Req8Batch187Amount100
	if ((- last_1_var_1_1) <= ((var_1_30 - var_1_31) - var_1_10)) {
		var_1_29 = var_1_25;
	}


	// From: Req6Batch187Amount100
	...
	// From: Req7Batch187Amount100
	if (var_1_23) {
		var_1_28 = 255.9f;
	}


	// From: Req9Batch187Amount100
	if (var_1_24 && (var_1_25 && var_1_29)) {
		var_1_32 = (var_1_33 + (min (var_1_34 , var_1_35)));
	}


	// From: Req11Batch187Amount100
