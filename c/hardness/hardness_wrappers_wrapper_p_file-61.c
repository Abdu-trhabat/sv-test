...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch61Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch61Wrapper_P
	if ((*(var_1_6_Pointer))) {
		(*(var_1_11_Pointer)) = ((*(var_1_10_Pointer)) + (max ((*(var_1_12_Pointer)) , (*(var_1_13_Pointer)))));
	} else {
		(*(var_1_11_Pointer)) = (((64 + (*(var_1_14_Pointer))) + ((*(var_1_15_Pointer)) + (*(var_1_16_Pointer)))) - ((*(var_1_17_Pointer)) + (*(var_1_18_Pointer))));
	}


	// From: Req4Batch61Wrapper_P
	...
	// From: Req5Batch61Wrapper_P
	(*(var_1_20_Pointer)) = (*(var_1_21_Pointer));


	// From: Req6Batch61Wrapper_P
	(*(var_1_22_Pointer)) = (*(var_1_18_Pointer));


	// From: Req7Batch61Wrapper_P
	(*(var_1_23_Pointer)) = 0.010000000000000009;


	// From: Req2Batch61Wrapper_P
	if ((*(var_1_23_Pointer)) < (max ((*(var_1_20_Pointer)) , (*(var_1_23_Pointer))))) {
