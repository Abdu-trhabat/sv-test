...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch109dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch109dependencies
	var_1_6 = (max (var_1_7 , ((10 + var_1_8) + var_1_9)));


	// From: Req7Batch109dependencies
	if ((16 + (var_1_6 * var_1_8)) <= (var_1_14 * 5)) {
		var_1_18 = (var_1_19 - var_1_9);
	}


	// From: Req8Batch109dependencies
	var_1_20 = var_1_19;


	// From: Req9Batch109dependencies
	var_1_21 = var_1_9;


	// From: Req6Batch109dependencies
	if (var_1_13) {
