...
void step(void) {
	...
	// From: Req5Batch46no_floats
	var_1_21 = var_1_16;


	// From: Req6Batch46no_floats
	var_1_22 = var_1_12;
...
int property(void) {
	return (((((((- last_1_var_1_15) >= last_1_var_1_15) ? (var_1_1 == ((unsigned char) (var_1_4 || var_1_5))) : (var_1_1 == ((unsigned char) (var_1_6 && (var_1_4 || (var_1_5 || var_1_7)))))) && (((var_1_22 / var_1_10) != var_1_22) ? (var_1_8 == ((signed short int) (min (((abs (var_1_12)) + var_1_13) , var_1_14)))) : (var_1_8 == ((signed short int) var_1_13)))) && (var_1_1 ? (var_1_15 == ((signed long int) (var_1_16 - var_1_17))) : 1)) && (var_1_5 ? (var_1_6 ? (var_1_18 == ((unsigned char) (50 + var_1_19))) : (var_1_18 == ((unsigned char) (min (var_1_19 , var_1_20))))) : (var_1_18 == ((unsigned char) (abs (var_1_20)))))) && (var_1_21 == ((signed long int) var_1_16))) && (var_1_22 == ((signed long int) var_1_12))
;
}
int main(void) {
	isInitial = 1;
