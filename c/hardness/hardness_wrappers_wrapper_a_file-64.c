...
void step(void) {
	...
	if (stepLocal_1 <= (unsigned_long_int_Array_0[0][1] - unsigned_long_int_Array_0[1][0])) {
		if (stepLocal_0 < (max ((unsigned_long_int_Array_0[1][1] / unsigned_long_int_Array_0[0][0]) , unsigned_long_int_Array_0[1][0]))) {
