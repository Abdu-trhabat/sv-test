...
void step(void) {
	// From: Req1Batch102dependencies
	var_1_1 = ((var_1_2 - var_1_3) + var_1_4);


	// From: Req2Batch102dependencies
	...
	// From: Req3Batch102dependencies
	var_1_9 = (min (var_1_10 , var_1_4));


	// From: Req4Batch102dependencies
	if (var_1_10 >= var_1_2) {
	...
	// From: Req7Batch102dependencies
	var_1_19 = (var_1_20 + (var_1_21 + (var_1_22 + 4)));


	// From: Req8Batch102dependencies
