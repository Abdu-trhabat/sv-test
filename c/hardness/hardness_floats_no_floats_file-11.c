...
void step(void) {
	...
	// From: Req5Batch11no_floats
	var_1_16 = var_1_10;


	// From: Req6Batch11no_floats
	var_1_17 = var_1_4;
...
int property(void) {
	return (((((((var_1_2 - (var_1_3 + var_1_4)) < var_1_17) ? ((var_1_14 || ((var_1_17 + var_1_3) >= var_1_2)) ? (var_1_1 == ((signed char) var_1_7)) : (var_1_1 == ((signed char) 4))) : 1) && (((var_1_9 - var_1_10) > var_1_1) ? (var_1_8 == ((signed long int) var_1_3)) : (((var_1_14 || (var_1_17 > var_1_4)) || var_1_14) ? (var_1_8 == ((signed long int) var_1_4)) : (var_1_8 == ((signed long int) var_1_3))))) && (var_1_12 == ((signed short int) (abs (32 - var_1_13))))) && ((((var_1_4 - var_1_3) * var_1_2) >= var_1_17) ? (var_1_14 == ((unsigned char) var_1_15)) : 1)) && (var_1_16 == ((signed long int) var_1_10))) && (var_1_17 == ((signed long int) var_1_4))
;
}
int main(void) {
	isInitial = 1;
