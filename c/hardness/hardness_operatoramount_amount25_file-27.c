...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch27Amount25.c", 13, "reach_error"); }
...
int property(void) {
	return (((32 >= last_1_var_1_1) ? (var_1_1 == ((signed long int) (var_1_3 + (max ((var_1_4 - var_1_5) , var_1_6))))) : (var_1_1 == ((signed long int) ((var_1_7 - var_1_5) - (var_1_8 - var_1_4))))) && ((var_1_3 < var_1_5) ? (var_1_9 == ((unsigned char) (var_1_10 - 1))) : (var_1_9 == ((unsigned char) ((var_1_11 + 64) - var_1_12))))) && (((var_1_3 + 4) < var_1_1) ? ((((var_1_8 * 128) / var_1_14) != var_1_1) ? (var_1_13 == ((signed long int) -100000)) : (var_1_13 == ((signed long int) var_1_12))) : 1)
;
}
int main(void) {
	isInitial = 1;
