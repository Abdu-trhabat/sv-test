...
int property(void) {
 return (((var_1_2 ? ((var_1_3 && (var_1_4 <= (var_1_5 * var_1_6))) ? (var_1_1 == ((signed long int) ((var_1_7 - 25) - var_1_8))) : 1) : 1) && (((((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11))) - 128) >= 5) ? ((var_1_3 || (var_1_2 && var_1_12)) ? (var_1_9 == ((unsigned long int) var_1_8)) : (var_1_9 == ((unsigned long int) 256u))) : (var_1_9 == ((unsigned long int) var_1_8)))) && (var_1_13 == ((signed long int) ((((((((-128) < 0 ) ? -(-128) : (-128)))) > (10000000)) ? (((((-128) < 0 ) ? -(-128) : (-128)))) : (10000000)))))) && ((var_1_4 > var_1_5) ? (var_1_14 == ((double) ((var_1_15 + var_1_16) + ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17)))))) : ((var_1_1 <= var_1_8) ? (var_1_14 == ((double) var_1_16)) : (var_1_14 == ((double) var_1_17))))
;
}
int main(void) {
 isInitial = 1;
