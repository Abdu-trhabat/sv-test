...
void step(void) {
	...
	if (stepLocal_1 <= (abs (unsigned_long_int_Array_0[1][0]))) {
	...
	if (unsigned_long_int_Array_0[1][1] < (unsigned_long_int_Array_0[1][1] & (unsigned_long_int_Array_0[0][0] - unsigned_long_int_Array_0[1][0]))) {
		signed_long_int_Array_0[1] = (min (((signed_long_int_Array_0[2] - 128) - 2) , signed_long_int_Array_0[0]));
	} else {
		signed_long_int_Array_0[1] = signed_long_int_Array_0[0];
	}


	// From: Req4Batch102Wrapper_A
	signed_long_int_Array_0[3] = signed_long_int_Array_0[0];


	// From: Req5Batch102Wrapper_A
	BOOL_unsigned_char_Array_0[0] = BOOL_unsigned_char_Array_0[1];


	// From: Req6Batch102Wrapper_A
...
int property(void) {
	return ((((((((double_Array_0[1][1] - double_Array_0[0][1]) * last_1_double_Array_0_0__0_) <= last_1_double_Array_0_0__0_) ? (unsigned_long_int_Array_0[1][1] == ((unsigned long int) (abs (unsigned_long_int_Array_0[0][1])))) : (unsigned_long_int_Array_0[1][1] == ((unsigned long int) unsigned_long_int_Array_0[0][1]))) && ((unsigned_long_int_Array_0[1][1] < (unsigned_long_int_Array_0[1][1] & (unsigned_long_int_Array_0[0][0] - unsigned_long_int_Array_0[1][0]))) ? (signed_long_int_Array_0[1] == ((signed long int) (min (((signed_long_int_Array_0[2] - 128) - 2) , signed_long_int_Array_0[0])))) : (signed_long_int_Array_0[1] == ((signed long int) signed_long_int_Array_0[0])))) && ((((60423 - unsigned_short_int_Array_0[0]) | unsigned_long_int_Array_0[1][1]) <= (abs (unsigned_long_int_Array_0[1][0]))) ? ((unsigned_long_int_Array_0[0][0] != unsigned_long_int_Array_0[0][1]) ? (double_Array_0[0][0] == ((double) ((31.5 - double_Array_0[1][0]) + 63.3))) : (double_Array_0[0][0] == ((double) double_Array_0[1][0]))) : 1)) && (signed_long_int_Array_0[3] == ((signed long int) signed_long_int_Array_0[0]))) && (BOOL_unsigned_char_Array_0[0] == ((unsigned char) BOOL_unsigned_char_Array_0[1]))) && (signed_long_int_Array_0[4] == ((signed long int) signed_long_int_Array_0[2]))
;
}
int main(void) {
	isInitial = 1;
