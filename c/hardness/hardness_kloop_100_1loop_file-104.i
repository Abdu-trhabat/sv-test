...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch104100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_24 = (((((var_1_23) > (var_1_22)) ? (var_1_23) : (var_1_22))) + 4);
 signed long int stepLocal_2 = (((var_1_24) < (var_1_22)) ? (var_1_24) : (var_1_22));
 if (stepLocal_2 <= 64) {
  var_1_29 = (var_1_30 - 5);
 }
 ...
 if (4u <= var_1_22) {
  ...
  if (var_1_22 <= (var_1_9 ^ var_1_16)) {
   var_1_25 = ((((var_1_26 - var_1_24) < 0 ) ? -(var_1_26 - var_1_24) : (var_1_26 - var_1_24)));
  } else {
   var_1_25 = (((((var_1_23 + (1506566004u - var_1_24))) < (var_1_16)) ? ((var_1_23 + (1506566004u - var_1_24))) : (var_1_16)));
  }
 }
 if (100 > ((((var_1_25) < (var_1_16)) ? (var_1_25) : (var_1_16)))) {
  var_1_1 = var_1_4;
 } else {
 ...
 if (8 >= var_1_16) {
  if ((var_1_18 && var_1_17) && var_1_1) {
   var_1_33 = (((((var_1_14 + (var_1_12 + var_1_13))) > ((var_1_15 + var_1_34))) ? ((var_1_14 + (var_1_12 + var_1_13))) : ((var_1_15 + var_1_34))));
  } else {
 ...
 if (stepLocal_5 >= var_1_16) {
  if (var_1_31 >= var_1_10) {
   if (stepLocal_4 > ((((var_1_25) < (var_1_26)) ? (var_1_25) : (var_1_26)))) {
 ...
 unsigned long int stepLocal_1 = ((((var_1_9 + var_1_25)) < ((var_1_16 * var_1_25))) ? ((var_1_9 + var_1_25)) : ((var_1_16 * var_1_25)));
...
int property(void) {
 return (((((((((((((100 > ((((var_1_25) < (var_1_16)) ? (var_1_25) : (var_1_16)))) ? (var_1_1 == ((unsigned char) var_1_4)) : (var_1_1 == ((unsigned char) ((! (var_1_4 || var_1_5)) || var_1_6)))) && (var_1_5 ? ((! ((- var_1_33) == 0.54)) ? (var_1_7 == ((unsigned short int) (56658 - var_1_9))) : (var_1_7 == ((unsigned short int) var_1_9))) : 1)) && ((var_1_33 != var_1_31) ? (var_1_10 == ((float) (((var_1_12 - var_1_13) + (128.6f - var_1_14)) + var_1_15))) : (var_1_10 == ((float) 10.3f)))) && ((var_1_20 == var_1_2) ? (((var_1_15 * var_1_12) <= var_1_13) ? (var_1_16 == ((signed long int) var_1_20)) : (var_1_16 == ((signed long int) var_1_9))) : (var_1_16 == ((signed long int) var_1_20)))) && (var_1_17 == ((unsigned char) (var_1_6 || (var_1_18 || var_1_19))))) && (var_1_20 == ((unsigned short int) (var_1_21 - ((var_1_22 + 5) + var_1_23))))) && (var_1_24 == ((unsigned short int) (((((var_1_23) > (var_1_22)) ? (var_1_23) : (var_1_22))) + 4)))) && ((4u <= var_1_22) ? (var_1_25 == ((unsigned long int) (var_1_26 - var_1_9))) : ((var_1_22 <= (var_1_9 ^ var_1_16)) ? (var_1_25 == ((unsigned long int) ((((var_1_26 - var_1_24) < 0 ) ? -(var_1_26 - var_1_24) : (var_1_26 - var_1_24))))) : (var_1_25 == ((unsigned long int) (((((var_1_23 + (1506566004u - var_1_24))) < (var_1_16)) ? ((var_1_23 + (1506566004u - var_1_24))) : (var_1_16)))))))) && ((! (var_1_35 || (var_1_21 >= var_1_25))) ? (((((((var_1_9 + var_1_25)) < ((var_1_16 * var_1_25))) ? ((var_1_9 + var_1_25)) : ((var_1_16 * var_1_25)))) < var_1_28) ? (var_1_27 == ((float) var_1_13)) : (var_1_27 == ((float) var_1_15))) : 1)) && ((((((var_1_24) < (var_1_22)) ? (var_1_24) : (var_1_22))) <= 64) ? (var_1_29 == ((signed char) (var_1_30 - 5))) : 1)) && ((var_1_22 > (var_1_21 - (var_1_23 + var_1_32))) ? (var_1_31 == ((double) (var_1_12 - var_1_14))) : 1)) && ((8 >= var_1_16) ? (((var_1_18 && var_1_17) && var_1_1) ? (var_1_33 == ((double) (((((var_1_14 + (var_1_12 + var_1_13))) > ((var_1_15 + var_1_34))) ? ((var_1_14 + (var_1_12 + var_1_13))) : ((var_1_15 + var_1_34)))))) : ((var_1_25 < var_1_22) ? (var_1_33 == ((double) var_1_14)) : 1)) : 1)) && ((var_1_9 >= var_1_16) ? ((var_1_31 >= var_1_10) ? ((var_1_24 > ((((var_1_25) < (var_1_26)) ? (var_1_25) : (var_1_26)))) ? (var_1_35 == ((unsigned char) (var_1_5 && var_1_4))) : (var_1_35 == ((unsigned char) var_1_4))) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
