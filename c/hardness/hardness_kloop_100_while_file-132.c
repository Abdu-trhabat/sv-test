...
void step(void) {
	...
	// From: Req4Batch132100_while
	var_1_18 = var_1_17;


	// From: Req8Batch132100_while
	var_1_24 = var_1_25;


	// From: Req12Batch132100_while
	...
	// From: Req13Batch132100_while
	var_1_40 = var_1_25;


	// From: Req7Batch132100_while
	var_1_23 = ((var_1_39 + var_1_19) + var_1_10);


	// From: Req9Batch132100_while
	if (last_1_var_1_27) {
		var_1_26 = ((min (last_1_var_1_30 , last_1_var_1_19)) + var_1_10);
	}


	// From: Req6Batch132100_while
