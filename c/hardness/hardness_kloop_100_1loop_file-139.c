...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch139100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch139100_1loop
	var_1_14 = (abs (var_1_7));


	// From: Req4Batch139100_1loop
	...
	// From: Req10Batch139100_1loop
	if (var_1_2 > var_1_8) {
		var_1_31 = 128.75f;
	}


	// From: Req11Batch139100_1loop
