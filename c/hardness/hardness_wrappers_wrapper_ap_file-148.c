...
void step(void) {
	...
	// From: Req4Batch148Wrapper_AP
	(*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) = (((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) + (max ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))))) - (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)));


	// From: Req5Batch148Wrapper_AP
	(*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) = 1.00000007E7f;


	// From: Req2Batch148Wrapper_AP
