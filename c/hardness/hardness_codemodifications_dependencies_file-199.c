...
void step(void) {
	// From: Req6Batch199dependencies
	var_1_21 = var_1_20;


	// From: Req7Batch199dependencies
	var_1_22 = var_1_20;


	// From: Req3Batch199dependencies
	if (var_1_11 != var_1_4) {
	...
	// From: Req2Batch199dependencies
	if (var_1_12 && (var_1_1 < var_1_8)) {
		if (var_1_4 <= ((var_1_10 - var_1_11) % (max (var_1_3 , -64)))) {
			var_1_9 = var_1_11;
		} else {
			var_1_9 = 256;
		}
