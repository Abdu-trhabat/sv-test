...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch115functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
unsigned char functionized0(signed char, signed char);
...
signed long int functionized5(signed char, signed char);
...
unsigned char functionized0(signed char functionized0_localFunctionVar0, signed char functionized0_localFunctionVar1) {
...
signed long int functionized1(unsigned short int functionized1_localFunctionVar0, unsigned short int functionized1_localFunctionVar1) {
 return ((((functionized1_localFunctionVar0) < ((functionized1_localFunctionVar1 - var_1_10))) ? (functionized1_localFunctionVar0) : ((functionized1_localFunctionVar1 - var_1_10))));
}
unsigned char functionized2(void) {
 return (var_1_1 <= var_1_4);
}
signed long int functionized3(void) {
 return ((((100) > (var_1_18)) ? (100) : (var_1_18)));
}
void functionized4(unsigned char functionized4_localFunctionVar0, signed char functionized4_localFunctionVar1) {
 if (256 > (functionized4_localFunctionVar0 - var_1_17)) {
  var_1_22 = (((functionized4_localFunctionVar1 - var_1_24) + var_1_25) - ((10 + 2) + var_1_26));
 }
}
signed long int functionized5(signed char functionized5_localFunctionVar0, signed char functionized5_localFunctionVar1) {
 return (((((((functionized5_localFunctionVar1) > (functionized5_localFunctionVar0)) ? (functionized5_localFunctionVar1) : (functionized5_localFunctionVar0))) < 0 ) ? -((((functionized5_localFunctionVar1) > (functionized5_localFunctionVar0)) ? (functionized5_localFunctionVar1) : (functionized5_localFunctionVar0))) : ((((functionized5_localFunctionVar1) > (functionized5_localFunctionVar0)) ? (functionized5_localFunctionVar1) : (functionized5_localFunctionVar0)))));
}
void initially(void) {
}
void step(void) {
 ...
 if (var_1_7) {
  var_1_6 = (functionized1(var_1_8, var_1_9));
 }
 if (var_1_3 <= var_1_14) {
 ...
 if (var_1_15 > var_1_4) {
  ...
  var_1_16 = (var_1_17 - functionized3());
 }
 if ((- var_1_9) > var_1_1) {
  var_1_19 = (var_1_20 - var_1_21);
 }
 functionized4(var_1_19, var_1_23);
 if (var_1_25 < (functionized5(var_1_23, var_1_26))) {
  var_1_27 = 64;
 }
}
void updateVariables(void) {
