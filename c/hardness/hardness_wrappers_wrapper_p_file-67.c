...
void step(void) {
	...
	if (stepLocal_0 > (1 * (*(var_1_14_Pointer)))) {
		(*(var_1_6_Pointer)) = (max ((42286 - (*(var_1_8_Pointer))) , 0));
	} else {
	...
	if ((*(var_1_10_Pointer))) {
		(*(var_1_9_Pointer)) = (min ((*(var_1_8_Pointer)) , (*(var_1_4_Pointer))));
	} else {
		if ((*(var_1_2_Pointer)) > stepLocal_2) {
			if ((*(var_1_7_Pointer)) > stepLocal_1) {
				(*(var_1_9_Pointer)) = (min ((*(var_1_8_Pointer)) , 100));
			} else {
...
int property(void) {
	return ((((((! ((*(var_1_2_Pointer)) <= (*(var_1_3_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed short int) ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer))))) : 1) && ((((*(var_1_7_Pointer)) >> (*(var_1_8_Pointer))) > (1 * (*(var_1_14_Pointer)))) ? ((*(var_1_6_Pointer)) == ((unsigned short int) (max ((42286 - (*(var_1_8_Pointer))) , 0)))) : ((*(var_1_6_Pointer)) == ((unsigned short int) (*(var_1_8_Pointer)))))) && ((*(var_1_10_Pointer)) ? ((*(var_1_9_Pointer)) == ((signed long int) (min ((*(var_1_8_Pointer)) , (*(var_1_4_Pointer)))))) : (((*(var_1_2_Pointer)) > ((*(var_1_4_Pointer)) / (*(var_1_8_Pointer)))) ? (((*(var_1_7_Pointer)) > (*(var_1_6_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed long int) (min ((*(var_1_8_Pointer)) , 100)))) : ((*(var_1_9_Pointer)) == ((signed long int) ((*(var_1_6_Pointer)) - (*(var_1_8_Pointer)))))) : ((*(var_1_9_Pointer)) == ((signed long int) ((*(var_1_6_Pointer)) + (*(var_1_7_Pointer)))))))) && ((*(var_1_11_Pointer)) == ((float) (*(var_1_12_Pointer))))) && ((*(var_1_13_Pointer)) == ((double) (*(var_1_12_Pointer))))) && ((*(var_1_14_Pointer)) == ((unsigned short int) (*(var_1_7_Pointer))))
;
}
int main(void) {
	isInitial = 1;
