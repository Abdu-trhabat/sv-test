...
void step(void) {
	...
	// From: Req2Batch123stepLocals
	if (var_1_6) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch123stepLocals
	...
	// From: Req4Batch123stepLocals
	if ((var_1_3 == 32u) || (var_1_5 == var_1_4)) {
		var_1_10 = var_1_8;
	}


	// From: Req5Batch123stepLocals
	if (var_1_2 <= var_1_4) {
