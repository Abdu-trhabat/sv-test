...
void step(void) {
 if (last_1_var_1_11 > 9999999.5f) {
  ...
  var_1_9 = ((((((last_1_var_1_1 - var_1_3) + (last_1_var_1_8 - last_1_var_1_9))) > (var_1_10)) ? (((last_1_var_1_1 - var_1_3) + (last_1_var_1_8 - last_1_var_1_9))) : (var_1_10)));
 }
...
int property(void) {
 return ((((last_1_var_1_9 <= 16) ? (var_1_1 == ((unsigned char) var_1_3)) : ((((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5))) < var_1_6) ? (var_1_7 ? (var_1_1 == ((unsigned char) var_1_3)) : (var_1_1 == ((unsigned char) 64))) : (var_1_1 == ((unsigned char) var_1_3)))) && (var_1_8 == ((unsigned short int) ((((var_1_1) > (var_1_3)) ? (var_1_1) : (var_1_3)))))) && ((last_1_var_1_11 > 9999999.5f) ? (var_1_9 == ((signed long int) ((var_1_10 - last_1_var_1_9) - var_1_3))) : (var_1_9 == ((signed long int) ((((((last_1_var_1_1 - var_1_3) + (last_1_var_1_8 - last_1_var_1_9))) > (var_1_10)) ? (((last_1_var_1_1 - var_1_3) + (last_1_var_1_8 - last_1_var_1_9))) : (var_1_10))))))) && (var_1_7 ? (((- var_1_9) >= var_1_9) ? (var_1_11 == ((float) (var_1_12 + var_1_13))) : 1) : (var_1_11 == ((float) ((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14))))))
;
}
int main(void) {
 isInitial = 1;
