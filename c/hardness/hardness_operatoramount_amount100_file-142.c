...
void step(void) {
	...
	// From: Req6Batch142Amount100
	var_1_19 = var_1_20;


	// From: Req7Batch142Amount100
	if (var_1_17 >= var_1_9) {
		if (var_1_19) {
	...
	// From: Req13Batch142Amount100
	var_1_39 = var_1_33;


	// From: Req3Batch142Amount100
