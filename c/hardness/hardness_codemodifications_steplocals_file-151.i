...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch151stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 if ((32.4 == var_1_4) || ((var_1_5 > var_1_6) && var_1_2)) {
 ...
 unsigned char stepLocal_2 = ((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5))) <= var_1_1;
 unsigned long int stepLocal_1 = (((2u) > (var_1_11)) ? (2u) : (var_1_11));
 if (var_1_3 || stepLocal_2) {
  if (((var_1_5 + var_1_6) + var_1_1) <= stepLocal_1) {
   var_1_10 = 10;
  } else {
   var_1_10 = var_1_12;
  }
 ...
 if (var_1_2) {
  var_1_13 = (((((var_1_12 + (var_1_14 - var_1_15))) > ((var_1_10 + (var_1_16 + var_1_17)))) ? ((var_1_12 + (var_1_14 - var_1_15))) : ((var_1_10 + (var_1_16 + var_1_17)))));
 } else {
  if (var_1_3) {
   var_1_13 = var_1_7;
  } else {
...
int property(void) {
 return (((((((32.4 == var_1_4) || ((var_1_5 > var_1_6) && var_1_2)) ? (var_1_1 == ((signed long int) ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))))) : (var_1_1 == ((signed long int) ((((var_1_7) > (200)) ? (var_1_7) : (200)))))) && ((var_1_7 < var_1_5) ? (var_1_8 == ((double) var_1_9)) : 1)) && ((var_1_3 || (((((var_1_6) < (var_1_5)) ? (var_1_6) : (var_1_5))) <= var_1_1)) ? ((((var_1_5 + var_1_6) + var_1_1) <= ((((2u) > (var_1_11)) ? (2u) : (var_1_11)))) ? (var_1_10 == ((signed char) 10)) : (var_1_10 == ((signed char) var_1_12))) : (var_1_10 == ((signed char) var_1_12)))) && (var_1_2 ? (var_1_13 == ((signed long int) (((((var_1_12 + (var_1_14 - var_1_15))) > ((var_1_10 + (var_1_16 + var_1_17)))) ? ((var_1_12 + (var_1_14 - var_1_15))) : ((var_1_10 + (var_1_16 + var_1_17))))))) : (var_1_3 ? (var_1_13 == ((signed long int) var_1_7)) : (var_1_13 == ((signed long int) var_1_12))))) && (((var_1_17 >= var_1_13) && var_1_3) ? (var_1_18 == ((unsigned short int) ((((var_1_19) < (((var_1_20 + var_1_21) - var_1_22))) ? (var_1_19) : (((var_1_20 + var_1_21) - var_1_22)))))) : 1)) && ((9.99999999999925E12 <= var_1_8) ? (((- var_1_4) == var_1_8) ? (var_1_23 == ((unsigned char) (var_1_24 - ((((var_1_25) > (var_1_26)) ? (var_1_25) : (var_1_26)))))) : (var_1_23 == ((unsigned char) var_1_25))) : (var_1_23 == ((unsigned char) var_1_25)))
;
}
int main(void) {
 isInitial = 1;
