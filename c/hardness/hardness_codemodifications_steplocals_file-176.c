...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch176stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch176stepLocals
	signed long int stepLocal_0 = (var_1_2 * 4) % (min (var_1_3 , var_1_4));
	if (stepLocal_0 <= var_1_5) {
		var_1_1 = ((max ((var_1_6 - var_1_7) , var_1_8)) - var_1_9);
	}


	// From: Req2Batch176stepLocals
	unsigned char stepLocal_1 = var_1_11;
	if ((var_1_5 <= var_1_3) && stepLocal_1) {
	...
	// From: Req6Batch176stepLocals
	if ((max (var_1_14 , var_1_21)) >= var_1_24) {
		var_1_26 = (var_1_7 - 8);
	}


	// From: Req7Batch176stepLocals
	var_1_27 = var_1_6;
}
