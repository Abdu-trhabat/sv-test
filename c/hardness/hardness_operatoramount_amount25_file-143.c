...
void step(void) {
	// From: Req3Batch143Amount25
	unsigned char stepLocal_3 = var_1_13;
	if (var_1_4) {
		if (var_1_7 && stepLocal_3) {
			var_1_12 = (abs (var_1_9));
		}
	}


	// From: Req1Batch143Amount25
...
int property(void) {
	return ((((- var_1_12) <= var_1_12) ? ((! var_1_4) ? (var_1_1 == ((signed short int) (abs (1 - var_1_5)))) : 1) : (var_1_1 == ((signed short int) var_1_5))) && ((var_1_4 && (! var_1_7)) ? (var_1_6 == ((unsigned char) var_1_8)) : ((var_1_1 != var_1_12) ? (var_1_6 == ((unsigned char) (min (var_1_8 , ((var_1_9 - var_1_10) + var_1_11))))) : (var_1_6 == ((unsigned char) var_1_11))))) && (var_1_4 ? ((var_1_7 && var_1_13) ? (var_1_12 == ((unsigned long int) (abs (var_1_9)))) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
