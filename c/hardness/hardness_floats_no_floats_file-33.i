...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch33no_floats.c", 13, "reach_error"); }
...
signed long int var_1_21 = 1000000;
...
void step(void) {
 ...
 var_1_22 = var_1_1;
 if (! var_1_16) {
  if ((- ((((5) < (var_1_1)) ? (5) : (var_1_1)))) < var_1_11) {
   var_1_9 = (((((((((var_1_12) < (var_1_13)) ? (var_1_12) : (var_1_13))) - var_1_14)) < (var_1_15)) ? ((((((var_1_12) < (var_1_13)) ? (var_1_12) : (var_1_13))) - var_1_14)) : (var_1_15)));
  }
 } else {
  var_1_9 = var_1_12;
 }
...
int property(void) {
 return (((((((((var_1_2 ^ var_1_3) + var_1_4) < -1) ? (var_1_1 == ((signed short int) 8)) : (var_1_1 == ((signed short int) (128 - (var_1_5 + var_1_6))))) && ((var_1_5 < var_1_3) ? (var_1_7 == ((unsigned char) (var_1_8 + 1))) : 1)) && ((! var_1_16) ? (((- ((((5) < (var_1_1)) ? (5) : (var_1_1)))) < var_1_11) ? (var_1_9 == ((signed long int) (((((((((var_1_12) < (var_1_13)) ? (var_1_12) : (var_1_13))) - var_1_14)) < (var_1_15)) ? ((((((var_1_12) < (var_1_13)) ? (var_1_12) : (var_1_13))) - var_1_14)) : (var_1_15))))) : 1) : (var_1_9 == ((signed long int) var_1_12)))) && (var_1_16 == ((unsigned char) ((var_1_6 > (var_1_7 / var_1_17)) || var_1_18)))) && (var_1_19 == ((signed long int) var_1_20))) && (var_1_21 == ((signed long int) -5))) && (var_1_22 == ((signed short int) var_1_1))
;
}
int main(void) {
 isInitial = 1;
