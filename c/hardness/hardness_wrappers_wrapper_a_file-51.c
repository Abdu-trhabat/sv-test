...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch51Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (signed_short_int_Array_0[1] <= last_1_unsigned_long_int_Array_0_5_) {
		if (BOOL_unsigned_char_Array_0[0] && (last_1_unsigned_long_int_Array_0_5_ == (max (unsigned_long_int_Array_0[4] , unsigned_long_int_Array_0[0])))) {
			if (last_1_unsigned_long_int_Array_0_5_ < unsigned_long_int_Array_0[3]) {
	...
	unsigned long int stepLocal_1 = (max (unsigned_long_int_Array_0[3] , unsigned_long_int_Array_0[0])) - unsigned_long_int_Array_0[1];
	if (stepLocal_1 != (- unsigned_long_int_Array_0[5])) {
	...
	unsigned long int stepLocal_0 = unsigned_long_int_Array_0[2] / signed_short_int_Array_0[0];
	if (BOOL_unsigned_char_Array_0[0]) {
		if (unsigned_long_int_Array_0[2] >= stepLocal_0) {
...
int property(void) {
	return ((BOOL_unsigned_char_Array_0[0] ? ((unsigned_long_int_Array_0[2] >= (unsigned_long_int_Array_0[2] / signed_short_int_Array_0[0])) ? (double_Array_0[4] == ((double) (abs (double_Array_0[3])))) : (double_Array_0[4] == ((double) (double_Array_0[2] + (max (double_Array_0[1] , (double_Array_0[0] + 63.25))))))) : (double_Array_0[4] == ((double) double_Array_0[1]))) && ((((max (unsigned_long_int_Array_0[3] , unsigned_long_int_Array_0[0])) - unsigned_long_int_Array_0[1]) != (- unsigned_long_int_Array_0[5])) ? (unsigned_long_int_Array_0[2] == ((unsigned long int) ((min (unsigned_long_int_Array_0[6] , unsigned_long_int_Array_0[4])) - unsigned_long_int_Array_0[1]))) : (unsigned_long_int_Array_0[2] == ((unsigned long int) unsigned_long_int_Array_0[6])))) && ((signed_short_int_Array_0[1] <= last_1_unsigned_long_int_Array_0_5_) ? ((BOOL_unsigned_char_Array_0[0] && (last_1_unsigned_long_int_Array_0_5_ == (max (unsigned_long_int_Array_0[4] , unsigned_long_int_Array_0[0])))) ? ((last_1_unsigned_long_int_Array_0_5_ < unsigned_long_int_Array_0[3]) ? (unsigned_long_int_Array_0[5] == ((unsigned long int) unsigned_long_int_Array_0[6])) : 1) : 1) : (unsigned_long_int_Array_0[5] == ((unsigned long int) unsigned_long_int_Array_0[4])))
;
}
int main(void) {
	isInitial = 1;
