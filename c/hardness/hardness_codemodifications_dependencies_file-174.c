...
void step(void) {
	// From: Req2Batch174dependencies
	if (var_1_8) {
		if (var_1_9) {
			var_1_7 = var_1_5;
		}
	} else {
		if (last_1_var_1_23 == (last_1_var_1_20 & (min (var_1_6 , var_1_5)))) {
	...
	// From: Req6Batch174dependencies
	var_1_22 = (var_1_16 - var_1_19);


	// From: Req7Batch174dependencies
	if (var_1_16 < (var_1_18 + var_1_22)) {
		var_1_23 = (54981 - var_1_12);
	}


	// From: Req4Batch174dependencies
