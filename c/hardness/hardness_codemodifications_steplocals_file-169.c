...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch169stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch169stepLocals
	signed long int stepLocal_0 = var_1_8;
	if (((var_1_21 - var_1_4) << var_1_16) < stepLocal_0) {
		var_1_20 = var_1_16;
	}


	// From: Req7Batch169stepLocals
	var_1_22 = ((min (var_1_4 , var_1_23)) + (var_1_24 + var_1_25));


	// From: Req8Batch169stepLocals
	signed long int stepLocal_2 = 8 << var_1_17;
	unsigned long int stepLocal_1 = var_1_28 - (abs (100u));
	if (stepLocal_2 < var_1_27) {
		if ((5u >> 16) > stepLocal_1) {
			var_1_26 = var_1_29;
		}
	}
}
