...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch184functionizing.c", 13, "reach_error"); }
...
signed long int functionized2(unsigned char, unsigned char);
...
signed long int functionized0(unsigned char functionized0_localFunctionVar0) {
	return (min (functionized0_localFunctionVar0 , var_1_10));
}
signed long int functionized1(void) {
	return (min (var_1_9 , var_1_11));
}
signed long int functionized2(unsigned char functionized2_localFunctionVar0, unsigned char functionized2_localFunctionVar1) {
	return ((functionized2_localFunctionVar0 | functionized2_localFunctionVar1) * var_1_8);
}
unsigned char functionized3(double functionized3_localFunctionVar0, double functionized3_localFunctionVar1) {
	return (functionized3_localFunctionVar1 <= (max (functionized3_localFunctionVar0 , (var_1_18 - var_1_19))));
}
double functionized4(void) {
	return (abs (var_1_16));
}
signed long int functionized5(signed long int functionized5_localFunctionVar0) {
	return (var_1_3 + functionized5_localFunctionVar0);
}
...
void step(void) {
	// From: Req1Batch184functionizing
	...
	// From: Req2Batch184functionizing
	if (var_1_4 <= var_1_5) {
		var_1_8 = (functionized0(var_1_9) - (64 - var_1_11));
	} else {
		var_1_8 = (max (functionized1() , var_1_10));
	}


	// From: Req3Batch184functionizing
	if ((functionized2(var_1_10, var_1_4)) <= var_1_5) {
	...
	// From: Req4Batch184functionizing
	if (functionized3(var_1_13, var_1_14)) {
		var_1_17 = var_1_6;
	}


	// From: Req5Batch184functionizing
	if (var_1_7 || (var_1_1 || var_1_6)) {
		if (var_1_21) {
			var_1_20 = (min (var_1_15 , functionized4()));
		}
	} else {
	...
	// From: Req6Batch184functionizing
	if (! var_1_1) {
		var_1_22 = (abs (min (var_1_8 , var_1_2)));
	} else {
		if (1 < functionized5(var_1_5)) {
			var_1_22 = var_1_9;
		} else {
			var_1_22 = var_1_8;
		}
...
int property(void) {
	return (((((((var_1_2 / (min (var_1_3 , var_1_4))) <= var_1_5) ? ((var_1_4 >= 100) ? (var_1_1 == ((unsigned char) var_1_6)) : (var_1_6 ? (var_1_1 == ((unsigned char) var_1_7)) : (var_1_1 == ((unsigned char) 0)))) : (var_1_1 == ((unsigned char) 0))) && ((var_1_4 <= var_1_5) ? (var_1_8 == ((unsigned char) ((min (var_1_9 , var_1_10)) - (64 - var_1_11)))) : (var_1_8 == ((unsigned char) (max ((min (var_1_9 , var_1_11)) , var_1_10)))))) && ((((var_1_10 | var_1_4) * var_1_8) <= var_1_5) ? (var_1_12 == ((double) (var_1_13 - var_1_14))) : (var_1_12 == ((double) (var_1_15 + var_1_16))))) && ((var_1_14 <= (max (var_1_13 , (var_1_18 - var_1_19)))) ? (var_1_17 == ((unsigned char) var_1_6)) : 1)) && ((var_1_7 || (var_1_1 || var_1_6)) ? (var_1_21 ? (var_1_20 == ((float) (min (var_1_15 , (abs (var_1_16)))))) : 1) : (var_1_20 == ((float) (var_1_16 + var_1_15))))) && ((! var_1_1) ? (var_1_22 == ((unsigned short int) (abs (min (var_1_8 , var_1_2))))) : ((1 < (var_1_3 + var_1_5)) ? (var_1_22 == ((unsigned short int) var_1_9)) : (var_1_22 == ((unsigned short int) var_1_8))))
;
}
int main(void) {
	isInitial = 1;
