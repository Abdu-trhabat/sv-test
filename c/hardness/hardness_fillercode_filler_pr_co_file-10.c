...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	/* 314L, 150L) */ if (/* 315L, 133L, 134L) */ ((/* 316L, 131L, 135L) */ ((var_1_25) <= (var_1_27))) && (var_1_20))) {
		/* 320L, 149L) */ var_1_32 = (
			/* 323L, 148L) */ (max (
				/* 323L, 148L) */ (
					var_1_33
	...
	// From: CodeObject2
	/* 303L, 125L) */ if (/* 304L, 109L, 110L) */ ((var_1_8) && (/* 306L, 108L, 112L) */ (! (/* 307L, 107L, 113L) */ (! (var_1_20))))))) {
		/* 309L, 124L) */ var_1_28 = (
			/* 312L, 123L) */ (abs (
				var_1_31
			))
	...
	// From: CodeObject6
	/* 345L, 234L) */ if (/* 346L, 195L, 196L) */ ((var_1_40) >= (/* 348L, 194L, 198L) */ (max (/* 348L, 194L, 198L) */ (/* 349L, 192L, 199L) */ ((-1) ^ (32))) , (var_1_17)))))) {
		/* 353L, 219L) */ var_1_41 = (
			/* 356L, 218L) */ ((
				45623
			) - (
		...
		/* 363L, 232L) */ if (/* 364L, 221L, 222L) */ (! (var_1_8))) {
			/* 366L, 231L) */ var_1_41 = (
				/* 369L, 230L) */ (min (
					/* 369L, 230L) */ (
						var_1_42
