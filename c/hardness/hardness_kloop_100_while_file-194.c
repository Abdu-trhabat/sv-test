...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch194100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch194100_while
	if (var_1_6 >= var_1_8) {
		var_1_9 = 0;
	}


	// From: Req3Batch194100_while
	var_1_10 = ((var_1_11 + var_1_12) - var_1_13);


	// From: Req13Batch194100_while
	var_1_38 = var_1_20;


	// From: Req14Batch194100_while
	...
	// From: Req15Batch194100_while
	var_1_40 = var_1_13;


	// From: Req16Batch194100_while
	var_1_41 = var_1_42;


	// From: Req17Batch194100_while
	var_1_43 = -10;


	// From: Req9Batch194100_while
	if (var_1_19 < var_1_38) {
		var_1_25 = (last_1_var_1_25 && var_1_27);
	}


	// From: Req7Batch194100_while
	if (var_1_25) {
		var_1_22 = var_1_13;
	}


	// From: Req6Batch194100_while
