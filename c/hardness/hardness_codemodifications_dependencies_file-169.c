...
void step(void) {
	...
	// From: Req6Batch169dependencies
	if (((var_1_21 - var_1_4) << var_1_16) < var_1_8) {
		var_1_20 = var_1_16;
	}


	// From: Req7Batch169dependencies
	var_1_22 = ((min (var_1_4 , var_1_23)) + (var_1_24 + var_1_25));


	// From: Req8Batch169dependencies
	if ((8 << var_1_17) < var_1_8) {
		if ((5u >> 16) > (var_1_28 - (abs (100u)))) {
			var_1_26 = var_1_29;
		}
	}
}
