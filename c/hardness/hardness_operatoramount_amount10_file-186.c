...
int property(void) {
	return (var_1_3 >= var_1_4) ? (((max (var_1_5 , (- 4.75))) != var_1_6) ? (var_1_1 == ((unsigned short int) (var_1_7 - (var_1_8 + 5)))) : (var_1_1 == ((unsigned short int) var_1_8))) : (var_1_1 == ((unsigned short int) var_1_7))
;
}
int main(void) {
	isInitial = 1;
