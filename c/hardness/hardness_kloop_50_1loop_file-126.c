...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12650_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch12650_1loop
	if (var_1_2) {
		var_1_1 = var_1_3;
	}


	// From: Req2Batch12650_1loop
	if (var_1_2) {
		var_1_4 = var_1_3;
	} else {
	...
	// From: Req8Batch12650_1loop
	var_1_29 = var_1_22;


	// From: Req3Batch12650_1loop
	if (var_1_2) {
		if (var_1_20 <= var_1_5) {
			if (var_1_7 || var_1_8) {
				var_1_6 = var_1_9;
	...
	// From: Req6Batch12650_1loop
	if (var_1_15 != -10) {
		var_1_14 = ((var_1_16 - (var_1_17 - var_1_12)) - (max (var_1_29 , var_1_18)));
	} else {
	...
	// From: Req5Batch12650_1loop
	if ((var_1_29 % (128 - var_1_12)) <= var_1_14) {
		var_1_11 = var_1_12;
	}


	// From: Req4Batch12650_1loop
...
int property(void) {
	return (((((((var_1_2 ? (var_1_1 == ((double) var_1_3)) : 1) && (var_1_2 ? (var_1_4 == ((double) var_1_3)) : (var_1_4 == ((double) (var_1_5 + 7.75))))) && (var_1_2 ? ((var_1_20 <= var_1_5) ? ((var_1_7 || var_1_8) ? (var_1_6 == ((signed char) var_1_9)) : 1) : 1) : 1)) && ((var_1_8 || ((~ var_1_11) > var_1_9)) ? (var_1_10 == ((double) var_1_5)) : 1)) && (((var_1_29 % (128 - var_1_12)) <= var_1_14) ? (var_1_11 == ((unsigned char) var_1_12)) : 1)) && ((var_1_15 != -10) ? (var_1_14 == ((unsigned long int) ((var_1_16 - (var_1_17 - var_1_12)) - (max (var_1_29 , var_1_18))))) : ((-2 >= (var_1_19 / var_1_16)) ? (var_1_14 == ((unsigned long int) (max (var_1_16 , var_1_17)))) : 1))) && (var_1_7 ? (var_1_20 == ((double) (max (var_1_3 , var_1_5)))) : ((var_1_12 <= ((abs (var_1_21)) - var_1_22)) ? (var_1_20 == ((double) ((var_1_23 - (min (var_1_24 , var_1_25))) - (max (var_1_26 , (var_1_27 + var_1_28)))))) : (var_1_20 == ((double) (7.5 - var_1_23)))))) && (var_1_29 == ((unsigned char) var_1_22))
;
}
int main(void) {
	isInitial = 1;
