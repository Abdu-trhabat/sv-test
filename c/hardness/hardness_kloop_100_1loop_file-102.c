...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch102100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch102100_1loop
	var_1_22 = ((var_1_23 + var_1_24) - var_1_25);


	// From: Req10Batch102100_1loop
	var_1_36 = (abs (var_1_32));


	// From: Req12Batch102100_1loop
