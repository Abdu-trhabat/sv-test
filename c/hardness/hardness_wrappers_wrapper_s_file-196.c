...
void step(void) {
	// From: Req1Batch196Wrapper_S
	if (WrapperStruct00.var_1_2) {
		WrapperStruct00.var_1_1 = (max (WrapperStruct00.var_1_3 , 100));
	} else {
		WrapperStruct00.var_1_1 = (((min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5)) - 32) + 10);
	}


	// From: Req2Batch196Wrapper_S
	...
	if (WrapperStruct00.var_1_1 <= stepLocal_1) {
		if (stepLocal_0 >= WrapperStruct00.var_1_3) {
			WrapperStruct00.var_1_6 = (min ((min ((WrapperStruct00.var_1_7 - WrapperStruct00.var_1_5) , WrapperStruct00.var_1_4)) , (min (WrapperStruct00.var_1_3 , WrapperStruct00.var_1_8))));
		}
	} else {
	...
	// From: Req3Batch196Wrapper_S
	if (WrapperStruct00.var_1_8 <= (abs (WrapperStruct00.var_1_6))) {
		WrapperStruct00.var_1_9 = (10 - WrapperStruct00.var_1_10);
	} else {
		if (! WrapperStruct00.var_1_2) {
			WrapperStruct00.var_1_9 = (WrapperStruct00.var_1_11 + (min (WrapperStruct00.var_1_12 , WrapperStruct00.var_1_13)));
		} else {
			if (WrapperStruct00.var_1_2) {
...
int property(void) {
	return ((WrapperStruct00.var_1_2 ? (WrapperStruct00.var_1_1 == ((unsigned short int) (max (WrapperStruct00.var_1_3 , 100)))) : (WrapperStruct00.var_1_1 == ((unsigned short int) (((min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5)) - 32) + 10)))) && ((WrapperStruct00.var_1_1 <= WrapperStruct00.var_1_3) ? ((WrapperStruct00.var_1_1 >= WrapperStruct00.var_1_3) ? (WrapperStruct00.var_1_6 == ((unsigned short int) (min ((min ((WrapperStruct00.var_1_7 - WrapperStruct00.var_1_5) , WrapperStruct00.var_1_4)) , (min (WrapperStruct00.var_1_3 , WrapperStruct00.var_1_8)))))) : 1) : (WrapperStruct00.var_1_6 == ((unsigned short int) WrapperStruct00.var_1_3)))) && ((WrapperStruct00.var_1_8 <= (abs (WrapperStruct00.var_1_6))) ? (WrapperStruct00.var_1_9 == ((signed char) (10 - WrapperStruct00.var_1_10))) : ((! WrapperStruct00.var_1_2) ? (WrapperStruct00.var_1_9 == ((signed char) (WrapperStruct00.var_1_11 + (min (WrapperStruct00.var_1_12 , WrapperStruct00.var_1_13))))) : (WrapperStruct00.var_1_2 ? (WrapperStruct00.var_1_9 == ((signed char) 64)) : (WrapperStruct00.var_1_9 == ((signed char) WrapperStruct00.var_1_11)))))
;
}
int main(void) {
	isInitial = 1;
