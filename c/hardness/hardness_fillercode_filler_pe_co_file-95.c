...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch95Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	/* 323L, 228L) */ if (/* 324L, 165L, 166L) */ ((/* 325L, 162L, 167L) */ ((/* 326L, 158L, 168L) */ ((var_1_31) - (var_1_32))) + (/* 329L, 161L, 171L) */ ((var_1_27) / (var_1_33))))) < (/* 332L, 164L, 174L) */ (abs (var_1_26))))) {
		/* 334L, 226L) */ if (/* 335L, 193L, 194L) */ ((var_1_19) >= (10u))) {
			/* 338L, 219L) */ if (var_1_22) {
				/* 340L, 208L) */ var_1_30 = (
					/* 343L, 207L) */ (abs (
						/* 344L, 206L) */ (abs (
							var_1_35
