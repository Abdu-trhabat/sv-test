...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch45Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
 if (last_1_var_1_12) {
  (*(var_1_9_Pointer)) = ((((((*(var_1_8_Pointer))) < ((*(var_1_6_Pointer)))) ? ((*(var_1_8_Pointer))) : ((*(var_1_6_Pointer))))) - ((*(var_1_11_Pointer)) - 0.8f));
 }
 if ((*(var_1_5_Pointer)) == (*(var_1_2_Pointer))) {
  if ((*(var_1_10_Pointer))) {
   (*(var_1_12_Pointer)) = ((*(var_1_13_Pointer)) || (*(var_1_14_Pointer)));
  } else {
   (*(var_1_12_Pointer)) = ((((*(var_1_8_Pointer)) >= (*(var_1_9_Pointer))) || (*(var_1_15_Pointer))) && (((*(var_1_13_Pointer)) || (*(var_1_16_Pointer))) && (*(var_1_17_Pointer))));
  }
 }
 if (((*(var_1_2_Pointer)) / 32) < ((((((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) < ((*(var_1_5_Pointer)))) ? (((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) : ((*(var_1_5_Pointer)))))) {
  (*(var_1_1_Pointer)) = (((*(var_1_6_Pointer)) - (*(var_1_7_Pointer))) - (*(var_1_8_Pointer)));
 } else {
  (*(var_1_1_Pointer)) = ((*(var_1_8_Pointer)) - (*(var_1_7_Pointer)));
 }
 if ((((*(var_1_2_Pointer)) + (*(var_1_4_Pointer))) / (*(var_1_19_Pointer))) != (*(var_1_5_Pointer))) {
...
int property(void) {
 return ((((((*(var_1_2_Pointer)) / 32) < ((((((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) < ((*(var_1_5_Pointer)))) ? (((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) : ((*(var_1_5_Pointer)))))) ? ((*(var_1_1_Pointer)) == ((double) (((*(var_1_6_Pointer)) - (*(var_1_7_Pointer))) - (*(var_1_8_Pointer))))) : ((*(var_1_1_Pointer)) == ((double) ((*(var_1_8_Pointer)) - (*(var_1_7_Pointer)))))) && (last_1_var_1_12 ? ((*(var_1_9_Pointer)) == ((float) ((((((*(var_1_8_Pointer))) < ((*(var_1_6_Pointer)))) ? ((*(var_1_8_Pointer))) : ((*(var_1_6_Pointer))))) - ((*(var_1_11_Pointer)) - 0.8f)))) : 1)) && (((*(var_1_5_Pointer)) == (*(var_1_2_Pointer))) ? ((*(var_1_10_Pointer)) ? ((*(var_1_12_Pointer)) == ((unsigned char) ((*(var_1_13_Pointer)) || (*(var_1_14_Pointer))))) : ((*(var_1_12_Pointer)) == ((unsigned char) ((((*(var_1_8_Pointer)) >= (*(var_1_9_Pointer))) || (*(var_1_15_Pointer))) && (((*(var_1_13_Pointer)) || (*(var_1_16_Pointer))) && (*(var_1_17_Pointer))))))) : 1)) && (((((*(var_1_2_Pointer)) + (*(var_1_4_Pointer))) / (*(var_1_19_Pointer))) != (*(var_1_5_Pointer))) ? ((*(var_1_18_Pointer)) == ((unsigned char) (*(var_1_20_Pointer)))) : 1)
;
}
int main(void) {
 isInitial = 1;
