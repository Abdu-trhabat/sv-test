...
void step(void) {
	...
	if ((max (((*(WrapperStruct00_var_1_2_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer))) , (*(WrapperStruct00_var_1_4_Pointer)))) <= (min (((*(WrapperStruct00_var_1_5_Pointer)) - (*(WrapperStruct00_var_1_6_Pointer))) , ((*(WrapperStruct00_var_1_7_Pointer)) % (*(WrapperStruct00_var_1_8_Pointer)))))) {
		(*(WrapperStruct00_var_1_1_Pointer)) = (min (((*(WrapperStruct00_var_1_9_Pointer)) - (*(WrapperStruct00_var_1_10_Pointer))) , (*(WrapperStruct00_var_1_11_Pointer))));
	}
