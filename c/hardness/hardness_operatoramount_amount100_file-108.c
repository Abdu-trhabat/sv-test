...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch108Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch108Amount100
	if (var_1_29) {
		var_1_32 = ((min (128 , var_1_21)) - (var_1_33 - (min (var_1_15 , var_1_20))));
	}


	// From: Req3Batch108Amount100
	if (! (last_1_var_1_19 < (last_1_var_1_13 % var_1_15))) {
		var_1_13 = var_1_15;
	}


	// From: Req7Batch108Amount100
	if ((min (var_1_13 , last_1_var_1_22)) == var_1_17) {
		var_1_22 = (var_1_20 + var_1_21);
	}


	// From: Req12Batch108Amount100
	signed long int stepLocal_5 = var_1_20 - var_1_17;
	if (stepLocal_5 >= var_1_13) {
		var_1_34 = (min ((max (var_1_3 , var_1_27)) , (min ((var_1_35 - 1.0000000000000025E14) , var_1_26))));
	} else {
	...
	// From: Req1Batch108Amount100
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req4Batch108Amount100
	...
	// From: Req5Batch108Amount100
	var_1_18 = var_1_11;


	// From: Req9Batch108Amount100
	if (var_1_29) {
		if (((var_1_25 * var_1_26) * var_1_24) >= (abs (- var_1_2))) {
			var_1_28 = var_1_3;
		}
	} else {
		var_1_28 = var_1_27;
	...
	// From: Req8Batch108Amount100
	if ((var_1_2 / (max (var_1_24 , var_1_25))) >= var_1_34) {
		if (var_1_21 <= var_1_20) {
			var_1_23 = (max (((var_1_26 - 64.625) + var_1_27) , var_1_2));
		}
	} else {
		var_1_23 = var_1_3;
	}
...
int property(void) {
	return (((((((((((var_1_1 == ((float) (var_1_2 - var_1_3))) && (((var_1_5 ^ var_1_6) >= (64 * (var_1_7 + var_1_8))) ? (((var_1_3 - var_1_2) < var_1_23) ? ((var_1_9 || var_1_10) ? (var_1_4 == ((signed short int) var_1_11)) : (var_1_4 == ((signed short int) var_1_12))) : 1) : (var_1_4 == ((signed short int) 100)))) && ((! (last_1_var_1_19 < (last_1_var_1_13 % var_1_15))) ? (var_1_13 == ((signed long int) var_1_15)) : 1)) && ((var_1_12 < var_1_15) ? (((var_1_32 + var_1_15) >= var_1_12) ? (var_1_16 == ((unsigned char) var_1_17)) : 1) : 1)) && (var_1_18 == ((signed short int) var_1_11))) && ((((var_1_20 - var_1_17) << var_1_4) <= var_1_13) ? (var_1_19 == ((unsigned short int) ((max (var_1_20 , var_1_17)) + var_1_21))) : (((var_1_13 ^ var_1_22) > var_1_4) ? (var_1_19 == ((unsigned short int) var_1_17)) : (var_1_19 == ((unsigned short int) 10))))) && (((min (var_1_13 , last_1_var_1_22)) == var_1_17) ? (var_1_22 == ((unsigned long int) (var_1_20 + var_1_21))) : 1)) && (((var_1_2 / (max (var_1_24 , var_1_25))) >= var_1_34) ? ((var_1_21 <= var_1_20) ? (var_1_23 == ((double) (max (((var_1_26 - 64.625) + var_1_27) , var_1_2)))) : 1) : (var_1_23 == ((double) var_1_3)))) && (var_1_29 ? ((((var_1_25 * var_1_26) * var_1_24) >= (abs (- var_1_2))) ? (var_1_28 == ((float) var_1_3)) : 1) : (var_1_28 == ((float) var_1_27)))) && ((((var_1_15 + last_1_var_1_22) <= last_1_var_1_32) || (last_1_var_1_19 < last_1_var_1_22)) ? (var_1_29 == ((unsigned char) (! (var_1_30 && (! var_1_31))))) : (var_1_29 == ((unsigned char) ((16 > last_1_var_1_19) || ((! var_1_31) && var_1_30)))))) && (var_1_29 ? (var_1_32 == ((signed long int) ((min (128 , var_1_21)) - (var_1_33 - (min (var_1_15 , var_1_20)))))) : 1)) && (((var_1_20 - var_1_17) >= var_1_13) ? (var_1_34 == ((double) (min ((max (var_1_3 , var_1_27)) , (min ((var_1_35 - 1.0000000000000025E14) , var_1_26)))))) : ((! (var_1_11 <= (var_1_17 * var_1_22))) ? (var_1_34 == ((double) (10.75 - (var_1_36 - var_1_26)))) : (var_1_34 == ((double) var_1_35))))
;
}
int main(void) {
	isInitial = 1;
