...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch137Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch137Wrapper_S
	WrapperStruct00.var_1_16 = WrapperStruct00.var_1_15;


	// From: Req5Batch137Wrapper_S
	WrapperStruct00.var_1_17 = 16u;


	// From: Req6Batch137Wrapper_S
	WrapperStruct00.var_1_18 = WrapperStruct00.var_1_14;


	// From: Req1Batch137Wrapper_S
	...
	// From: Req3Batch137Wrapper_S
	if ((WrapperStruct00.var_1_12 / 1.3) <= WrapperStruct00.var_1_13) {
		if (((WrapperStruct00.var_1_5 * WrapperStruct00.var_1_17) >= WrapperStruct00.var_1_6) && WrapperStruct00.var_1_18) {
	...
	// From: Req2Batch137Wrapper_S
	if (WrapperStruct00.var_1_11) {
		if (WrapperStruct00.var_1_11) {
			WrapperStruct00.var_1_8 = (abs (WrapperStruct00.var_1_10));
		} else {
			WrapperStruct00.var_1_8 = (max (WrapperStruct00.var_1_10 , 2));
		}
	}
}
...
int property(void) {
	return (((((((WrapperStruct00.var_1_2 + WrapperStruct00.var_1_3) < WrapperStruct00.var_1_4) ? ((WrapperStruct00.var_1_2 <= WrapperStruct00.var_1_4) ? (WrapperStruct00.var_1_1 == ((unsigned char) (min (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_6)))) : (WrapperStruct00.var_1_1 == ((unsigned char) WrapperStruct00.var_1_6))) : (WrapperStruct00.var_1_18 ? (WrapperStruct00.var_1_1 == ((unsigned char) WrapperStruct00.var_1_5)) : (WrapperStruct00.var_1_1 == ((unsigned char) WrapperStruct00.var_1_6)))) && (WrapperStruct00.var_1_11 ? (WrapperStruct00.var_1_11 ? (WrapperStruct00.var_1_8 == ((signed char) (abs (WrapperStruct00.var_1_10)))) : (WrapperStruct00.var_1_8 == ((signed char) (max (WrapperStruct00.var_1_10 , 2))))) : 1)) && (((WrapperStruct00.var_1_12 / 1.3) <= WrapperStruct00.var_1_13) ? ((((WrapperStruct00.var_1_5 * WrapperStruct00.var_1_17) >= WrapperStruct00.var_1_6) && WrapperStruct00.var_1_18) ? (WrapperStruct00.var_1_11 == ((unsigned char) (! WrapperStruct00.var_1_14))) : (WrapperStruct00.var_1_11 == ((unsigned char) WrapperStruct00.var_1_15))) : 1)) && (WrapperStruct00.var_1_16 == ((unsigned char) WrapperStruct00.var_1_15))) && (WrapperStruct00.var_1_17 == ((unsigned long int) 16u))) && (WrapperStruct00.var_1_18 == ((unsigned char) WrapperStruct00.var_1_14))
;
}
int main(void) {
	isInitial = 1;
