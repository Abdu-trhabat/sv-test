...
void step(void) {
	...
	// From: Req2Batch124Wrapper_S
	WrapperStruct00.var_1_6 = (WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8);


	// From: Req3Batch124Wrapper_S
	unsigned long int stepLocal_1 = max (WrapperStruct00.var_1_8 , WrapperStruct00.var_1_7);
	if ((abs (WrapperStruct00.var_1_6)) < stepLocal_1) {
		WrapperStruct00.var_1_9 = ((WrapperStruct00.var_1_10 - WrapperStruct00.var_1_11) - (abs (WrapperStruct00.var_1_12)));
	}


	// From: Req5Batch124Wrapper_S
	WrapperStruct00.var_1_14 = 16;


	// From: Req4Batch124Wrapper_S
	if (WrapperStruct00.var_1_4) {
		if (WrapperStruct00.var_1_5 > 99.4) {
			if (WrapperStruct00.var_1_14 >= WrapperStruct00.var_1_6) {
				WrapperStruct00.var_1_13 = (min (WrapperStruct00.var_1_10 , 256));
			}
		}
	}
}
...
int property(void) {
	return (((((! (WrapperStruct00.var_1_2 == (15.2 + WrapperStruct00.var_1_3))) ? ((WrapperStruct00.var_1_4 && (WrapperStruct00.var_1_2 == WrapperStruct00.var_1_3)) ? (WrapperStruct00.var_1_4 ? (WrapperStruct00.var_1_1 == ((double) (2.5 - WrapperStruct00.var_1_5))) : (WrapperStruct00.var_1_1 == ((double) WrapperStruct00.var_1_5))) : 1) : (WrapperStruct00.var_1_1 == ((double) WrapperStruct00.var_1_5))) && (WrapperStruct00.var_1_6 == ((unsigned long int) (WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8)))) && (((abs (WrapperStruct00.var_1_6)) < (max (WrapperStruct00.var_1_8 , WrapperStruct00.var_1_7))) ? (WrapperStruct00.var_1_9 == ((signed char) ((WrapperStruct00.var_1_10 - WrapperStruct00.var_1_11) - (abs (WrapperStruct00.var_1_12))))) : 1)) && (WrapperStruct00.var_1_4 ? ((WrapperStruct00.var_1_5 > 99.4) ? ((WrapperStruct00.var_1_14 >= WrapperStruct00.var_1_6) ? (WrapperStruct00.var_1_13 == ((unsigned short int) (min (WrapperStruct00.var_1_10 , 256)))) : 1) : 1) : 1)) && (WrapperStruct00.var_1_14 == ((signed short int) 16))
;
}
int main(void) {
	isInitial = 1;
