...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch110100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch110100_1loop
	var_1_37 = var_1_4;


	// From: Req1Batch110100_1loop
