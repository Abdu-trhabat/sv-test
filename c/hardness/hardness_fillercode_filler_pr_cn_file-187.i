...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch187Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_1 = ((var_1_18) << ( ((1) - (0))));
  ...
  var_1_18
             ...
             if ( (( ((var_1_28) + ( (((((var_1_26)) > ((var_1_31))) ? ((var_1_26)) : ((var_1_31))))))) < (var_1_30))) {
              if ( (( (( ((var_1_40) - (var_1_41))) - (var_1_42))) > ( (- (var_1_26))))) {
               var_1_39 = (
    var_1_35
   );
  } else {
