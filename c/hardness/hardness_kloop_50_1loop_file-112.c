...
void step(void) {
	...
	// From: Req5Batch11250_1loop
	if ((var_1_16 - var_1_17) < (var_1_10 - var_1_1)) {
		var_1_15 = 1;
	}


	// From: Req4Batch11250_1loop
	var_1_14 = (max ((var_1_15 + var_1_10) , var_1_4));


	// From: Req2Batch11250_1loop
	...
	// From: Req7Batch11250_1loop
	var_1_24 = var_1_25;


	// From: Req8Batch11250_1loop
	var_1_26 = 10;
}
