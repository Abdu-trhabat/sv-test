...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch3725_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch3725_1loop
	var_1_11 = var_1_9;


	// From: Req1Batch3725_1loop
	if (((var_1_2 - var_1_3) ^ (var_1_9 * var_1_11)) <= -64) {
		var_1_1 = (min (1 , (max (16 , var_1_6))));
	} else {
		if (var_1_7) {
			var_1_1 = var_1_6;
		}
	...
	// From: Req2Batch3725_1loop
	if (var_1_9 >= (abs (var_1_9 / var_1_2))) {
		var_1_8 = var_1_6;
	} else {
		if (var_1_7) {
			var_1_8 = var_1_6;
