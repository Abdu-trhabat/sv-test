...
void step(void) {
 ...
 (*(var_1_6_Pointer)) = ((((((*(var_1_7_Pointer))) < 0 ) ? -((*(var_1_7_Pointer))) : ((*(var_1_7_Pointer))))) + (*(var_1_8_Pointer)));
 ...
 if (((*(var_1_4_Pointer)) / (*(var_1_15_Pointer))) == stepLocal_1) {
  if ((*(var_1_10_Pointer))) {
   (*(var_1_13_Pointer)) = (((((*(var_1_17_Pointer))) < (1000000.5)) ? ((*(var_1_17_Pointer))) : (1000000.5)));
  }
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((((last_1_var_1_4 <= (((((-32) < 0 ) ? -(-32) : (-32))) + 16)) ? ((*(var_1_1_Pointer)) == ((unsigned long int) (((((*(var_1_3_Pointer))) < 0 ) ? -((*(var_1_3_Pointer))) : ((*(var_1_3_Pointer))))))) : ((*(var_1_1_Pointer)) == ((unsigned long int) (*(var_1_3_Pointer))))) && (((*(var_1_19_Pointer)) <= (*(var_1_3_Pointer))) ? (((*(var_1_19_Pointer)) <= (*(var_1_1_Pointer))) ? ((*(var_1_9_Pointer)) ? ((*(var_1_4_Pointer)) == ((signed short int) (*(var_1_19_Pointer)))) : 1) : 1) : 1)) && ((*(var_1_6_Pointer)) == ((unsigned short int) ((((((*(var_1_7_Pointer))) < 0 ) ? -((*(var_1_7_Pointer))) : ((*(var_1_7_Pointer))))) + (*(var_1_8_Pointer)))))) && (((*(var_1_6_Pointer)) <= (*(var_1_19_Pointer))) ? ((*(var_1_9_Pointer)) == ((unsigned char) (! (*(var_1_10_Pointer))))) : ((*(var_1_9_Pointer)) == ((unsigned char) ((*(var_1_11_Pointer)) && (*(var_1_12_Pointer))))))) && ((((*(var_1_4_Pointer)) / (*(var_1_15_Pointer))) == (*(var_1_1_Pointer))) ? ((*(var_1_10_Pointer)) ? ((*(var_1_13_Pointer)) == ((double) (((((*(var_1_17_Pointer))) < (1000000.5)) ? ((*(var_1_17_Pointer))) : (1000000.5))))) : 1) : 1)) && ((*(var_1_18_Pointer)) == ((double) (*(var_1_17_Pointer))))) && ((*(var_1_19_Pointer)) == ((signed short int) (*(var_1_6_Pointer))))
;
}
int main(void) {
 isInitial = 1;
