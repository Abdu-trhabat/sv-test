...
void step(void) {
 ...
 unsigned long int stepLocal_2 = (((((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_8_Pointer)))) > ((*(WrapperStruct00_var_1_6_Pointer)))) ? (((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_8_Pointer)))) : ((*(WrapperStruct00_var_1_6_Pointer))));
 ...
 if ((*(WrapperStruct00_var_1_2_Pointer)) <= (*(WrapperStruct00_var_1_5_Pointer))) {
  if (! (*(WrapperStruct00_var_1_15_Pointer))) {
   (*(WrapperStruct00_var_1_10_Pointer)) = (((((*(WrapperStruct00_var_1_11_Pointer))) < (((*(WrapperStruct00_var_1_12_Pointer)) + 2))) ? ((*(WrapperStruct00_var_1_11_Pointer))) : (((*(WrapperStruct00_var_1_12_Pointer)) + 2))));
  } else {
   (*(WrapperStruct00_var_1_10_Pointer)) = (((((((((*(WrapperStruct00_var_1_12_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_12_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer)))))) < ((*(WrapperStruct00_var_1_11_Pointer)))) ? ((((((*(WrapperStruct00_var_1_12_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_12_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer)))))) : ((*(WrapperStruct00_var_1_11_Pointer)))));
  }
 }
}
void updateVariables(void) {
...
int property(void) {
 return ((((((((*(WrapperStruct00_var_1_2_Pointer)) + (*(WrapperStruct00_var_1_3_Pointer))) - ((*(WrapperStruct00_var_1_4_Pointer)) + (*(WrapperStruct00_var_1_5_Pointer)))) == (- (- (*(WrapperStruct00_var_1_6_Pointer))))) ? (((*(WrapperStruct00_var_1_3_Pointer)) != (*(WrapperStruct00_var_1_2_Pointer))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((signed long int) (*(WrapperStruct00_var_1_4_Pointer)))) : 1) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((signed long int) (*(WrapperStruct00_var_1_5_Pointer))))) && (((*(WrapperStruct00_var_1_3_Pointer)) <= ((((((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_8_Pointer)))) > ((*(WrapperStruct00_var_1_6_Pointer)))) ? (((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_8_Pointer)))) : ((*(WrapperStruct00_var_1_6_Pointer)))))) ? ((*(WrapperStruct00_var_1_7_Pointer)) == ((unsigned char) (! (*(WrapperStruct00_var_1_9_Pointer))))) : ((*(WrapperStruct00_var_1_7_Pointer)) == ((unsigned char) 0)))) && (((*(WrapperStruct00_var_1_2_Pointer)) <= (*(WrapperStruct00_var_1_5_Pointer))) ? ((! (*(WrapperStruct00_var_1_15_Pointer))) ? ((*(WrapperStruct00_var_1_10_Pointer)) == ((signed short int) (((((*(WrapperStruct00_var_1_11_Pointer))) < (((*(WrapperStruct00_var_1_12_Pointer)) + 2))) ? ((*(WrapperStruct00_var_1_11_Pointer))) : (((*(WrapperStruct00_var_1_12_Pointer)) + 2)))))) : ((*(WrapperStruct00_var_1_10_Pointer)) == ((signed short int) (((((((((*(WrapperStruct00_var_1_12_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_12_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer)))))) < ((*(WrapperStruct00_var_1_11_Pointer)))) ? ((((((*(WrapperStruct00_var_1_12_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_12_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer)))))) : ((*(WrapperStruct00_var_1_11_Pointer)))))))) : 1)) && ((*(WrapperStruct00_var_1_13_Pointer)) == ((unsigned char) (*(WrapperStruct00_var_1_14_Pointer))))) && ((*(WrapperStruct00_var_1_15_Pointer)) == ((unsigned char) (*(WrapperStruct00_var_1_16_Pointer))))
;
}
int main(void) {
 isInitial = 1;
