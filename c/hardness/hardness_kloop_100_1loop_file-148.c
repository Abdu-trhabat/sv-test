...
void step(void) {
	...
	// From: Req14Batch148100_1loop
	var_1_43 = var_1_25;


	// From: Req15Batch148100_1loop
	var_1_44 = var_1_23;


	// From: Req10Batch148100_1loop
	if (! var_1_42) {
		var_1_32 = (var_1_19 - (var_1_27 + var_1_28));
	}


	// From: Req9Batch148100_1loop
