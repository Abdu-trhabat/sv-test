...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch51has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch51has_floats
	var_1_16 = var_1_17;


	// From: Req5Batch51has_floats
	var_1_18 = var_1_11;


	// From: Req6Batch51has_floats
	var_1_19 = var_1_20;
...
int property(void) {
	return (((((((~ 1) > last_1_var_1_13) ? ((last_1_var_1_13 <= last_1_var_1_18) ? (((var_1_4 - (min (var_1_5 , var_1_6))) >= last_1_var_1_9) ? ((var_1_6 == ((abs (var_1_4)) + var_1_5)) ? (var_1_1 == ((double) var_1_8)) : (var_1_1 == ((double) -10.0))) : 1) : 1) : 1) && ((var_1_1 >= (- var_1_1)) ? ((((var_1_13 / var_1_10) / var_1_11) == (256 % var_1_12)) ? (var_1_9 == ((double) var_1_8)) : 1) : (var_1_9 == ((double) var_1_8)))) && (var_1_13 == ((signed long int) (var_1_14 - var_1_15)))) && (var_1_16 == ((signed char) var_1_17))) && (var_1_18 == ((signed long int) var_1_11))) && (var_1_19 == ((unsigned char) var_1_20))
;
}
int main(void) {
	isInitial = 1;
