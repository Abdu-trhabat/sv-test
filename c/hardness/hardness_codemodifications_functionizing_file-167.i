...
float functionized0(float functionized0_localFunctionVar0, float functionized0_localFunctionVar1) {
 return ((functionized0_localFunctionVar0 + functionized0_localFunctionVar1) + ((((var_1_8) < (var_1_9)) ? (var_1_8) : (var_1_9))));
}
...
void functionized3(unsigned long int functionized3_localFunctionVar0, signed short int functionized3_localFunctionVar1, signed long int functionized3_localFunctionVar2) {
 if ((((((var_1_3) > (functionized3_localFunctionVar2)) ? (var_1_3) : (functionized3_localFunctionVar2))) * var_1_4) == functionized3_localFunctionVar0) {
...
float functionized5(void) {
 return ((((var_1_1) < ((- var_1_9))) ? (var_1_1) : ((- var_1_9))));
}
void initially(void) {
}
void step(void) {
