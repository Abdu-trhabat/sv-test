...
void step(void) {
	// From: Req1Batch100Amount25
	unsigned char stepLocal_0 = var_1_2 >= var_1_3;
	if (stepLocal_0 || var_1_4) {
		var_1_1 = (min ((min (var_1_5 , 32u)) , ((var_1_6 + var_1_7) - (var_1_8 - var_1_9))));
	} else {
		var_1_1 = ((var_1_9 + var_1_10) + var_1_8);
	}


	// From: Req2Batch100Amount25
