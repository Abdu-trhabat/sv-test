...
void step(void) {
	...
	// From: CodeObject5
	/* 306L, 140L) */ if (/* 307L, 125L, 126L) */ ((var_1_26) <= (/* 309L, 124L, 128L) */ ((var_1_7) & (var_1_1))))) {
		/* 312L, 139L) */ var_1_36 = (
			var_1_29
		);
	}
	...
	// From: CodeObject1
	/* 253L, 38L) */ if (/* 254L, 10L, 11L) */ ((/* 255L, 8L, 12L) */ ((/* 256L, 3L, 13L) */ (abs (var_1_1))) >= (/* 258L, 7L, 15L) */ ((var_1_26) % (var_1_27))))) || (var_1_28))) {
		/* 262L, 33L) */ var_1_24 = (
			/* 265L, 32L) */ (abs (
				/* 266L, 31L) */ ((
					var_1_29
	...
	// From: CodeObject6
	/* 318L, 171L) */ if (/* 319L, 148L, 149L) */ ((var_1_1) >= (/* 321L, 147L, 151L) */ (max (/* 321L, 147L, 151L) */ (32) , (var_1_29)))))) {
		/* 324L, 166L) */ var_1_37 = (
			/* 327L, 165L) */ ((
				var_1_29
			) - (
	...
	// From: CodeObject8
	/* 348L, 224L) */ if (/* 349L, 196L, 197L) */ ((var_1_43) != (var_1_19))) {
		/* 352L, 222L) */ if (/* 353L, 205L, 206L) */ ((var_1_23) >= (var_1_1))) {
			/* 356L, 221L) */ var_1_44 = (
				/* 359L, 220L) */ (max (
					/* 359L, 220L) */ (
						/* 360L, 216L) */ ((
...
int property(void) {
	...
	if (/* 421L, 60L, 69L, 493L, 508L, 1016L) */ ((/* 422L, 55L, 70L, 494L, 509L, 1017L) */ (max (/* 422L, 55L, 70L, 494L, 509L, 1017L) */ (var_1_13) , (var_1_14)))) <= (/* 425L, 59L, 73L, 497L, 512L, 1020L) */ (- (/* 426L, 58L, 74L, 498L, 513L, 1021L) */ ((var_1_15) / (4.9f))))))) {
	}
	if (/* 444L, 109L, 118L, 602L, 624L, 1039L) */ ((/* 445L, 106L, 119L, 603L, 625L, 1040L) */ ((var_1_9) % (/* 447L, 105L, 121L, 605L, 627L, 1042L) */ ((var_1_8) - (var_1_20))))) > (/* 450L, 108L, 124L, 608L, 630L, 1045L) */ (abs (var_1_5))))) {
		if (/* 453L, 133L, 141L, 611L, 633L, 1048L) */ ((/* 454L, 128L, 142L, 612L, 634L, 1049L) */ ((var_1_3) ^ (var_1_5))) <= (/* 457L, 132L, 145L, 615L, 637L, 1052L) */ ((var_1_4) ^ (var_1_10))))) {
		}
	}
	if (/* 467L, 164L, 170L, 675L, 689L, 1062L) */ ((/* 468L, 162L, 171L, 676L, 690L, 1063L) */ ((var_1_11) % (var_1_20))) < (var_1_1))) {
	}
	if (/* 481L, 197L, 205L, 771L, 805L, 1076L) */ ((/* 482L, 193L, 206L, 772L, 806L, 1077L) */ ((3886175339u) - (var_1_9))) <= (/* 485L, 196L, 209L, 775L, 809L, 1080L) */ ((var_1_20) / (var_1_3))))) {
		if (/* 489L, 214L, 218L, 779L, 813L, 1084L) */ ((var_1_10) > (var_1_1))) {
		} else {
		}
	} else {
	}
	...
	/* 517L) */ ((
		/* 516L) */ ((
			/* 515L) */ ((
				/* 514L) */ ((
					/* 513L) */ ((
						/* 383L, 24L, 297L, 320L, 978L) */ ((
							var_1_2
						) ? (
							/* 385L, 12L, 299L, 322L, 980L) */ ((
								var_1_1
							) == (
								/* 385L, 12L, 299L, 322L, 980L) */ ((signed long int) (
									/* 388L, 11L, 302L, 325L, 983L) */ ((
										/* 389L, 9L, 303L, 326L, 984L) */ ((
											var_1_3
										) - (
											var_1_4
										))
							...
							/* 393L, 22L, 307L, 330L, 988L) */ ((
								var_1_1
							) == (
								/* 393L, 22L, 307L, 330L, 988L) */ ((signed long int) (
									/* 396L, 21L, 310L, 333L, 991L) */ ((
										/* 397L, 19L, 311L, 334L, 992L) */ (max (
											/* 397L, 19L, 311L, 334L, 992L) */ (
												var_1_3
											) , (
												/* 399L, 18L, 313L, 336L, 994L) */ ((
													var_1_6
												) - (
													var_1_4
												))
						...
						/* 406L, 44L, 373L, 388L, 1001L) */ ((
							var_1_7
						) == (
							/* 406L, 44L, 373L, 388L, 1001L) */ ((unsigned char) (
								/* 409L, 43L, 376L, 391L, 1004L) */ ((
									/* 410L, 37L, 377L, 392L, 1005L) */ ((
										var_1_8
									) - (
										var_1_9
									))
								) - (
									/* 413L, 42L, 380L, 395L, 1008L) */ ((
										100
									) - (
										/* 415L, 41L, 382L, 397L, 1010L) */ ((
											var_1_10
										) + (
											var_1_11
										))
					...
					/* 420L, 82L, 492L, 507L, 1015L) */ ((
						/* 421L, 60L, 69L, 493L, 508L, 1016L) */ ((
							/* 422L, 55L, 70L, 494L, 509L, 1017L) */ (max (
								/* 422L, 55L, 70L, 494L, 509L, 1017L) */ (
									var_1_13
								) , (
									var_1_14
								)
							...
							/* 425L, 59L, 73L, 497L, 512L, 1020L) */ (- (
								/* 426L, 58L, 74L, 498L, 513L, 1021L) */ ((
									var_1_15
								) / (
									4.9f
								))
						...
						/* 429L, 80L, 501L, 516L, 1024L) */ ((
							var_1_12
						) == (
							/* 429L, 80L, 501L, 516L, 1024L) */ ((float) (
								31.5f
							))
						))
					) : (
				...
				/* 435L, 95L, 540L, 549L, 1030L) */ ((
					var_1_16
				) == (
					/* 435L, 95L, 540L, 549L, 1030L) */ ((float) (
						/* 438L, 94L, 543L, 552L, 1033L) */ ((
							var_1_17
						) + (
							/* 440L, 93L, 545L, 554L, 1035L) */ (abs (
								var_1_18
							))
						))
					))
			...
			/* 443L, 155L, 601L, 623L, 1038L) */ ((
				/* 444L, 109L, 118L, 602L, 624L, 1039L) */ ((
					/* 445L, 106L, 119L, 603L, 625L, 1040L) */ ((
						var_1_9
					) % (
						/* 447L, 105L, 121L, 605L, 627L, 1042L) */ ((
							var_1_8
						) - (
							var_1_20
						))
					...
					/* 450L, 108L, 124L, 608L, 630L, 1045L) */ (abs (
						var_1_5
					))
				))
			) ? (
				/* 452L, 153L, 610L, 632L, 1047L) */ ((
					/* 453L, 133L, 141L, 611L, 633L, 1048L) */ ((
						/* 454L, 128L, 142L, 612L, 634L, 1049L) */ ((
							var_1_3
						) ^ (
							var_1_5
						))
					) <= (
						/* 457L, 132L, 145L, 615L, 637L, 1052L) */ ((
							var_1_4
						) ^ (
							var_1_10
						))
					...
					/* 460L, 151L, 618L, 640L, 1055L) */ ((
						var_1_19
					) == (
						/* 460L, 151L, 618L, 640L, 1055L) */ ((float) (
							var_1_17
						))
					))
				) : (
		...
		/* 466L, 182L, 674L, 688L, 1061L) */ ((
			/* 467L, 164L, 170L, 675L, 689L, 1062L) */ ((
				/* 468L, 162L, 171L, 676L, 690L, 1063L) */ ((
					var_1_11
				) % (
					var_1_20
				))
			...
			/* 472L, 180L, 680L, 694L, 1067L) */ ((
				var_1_22
			) == (
				/* 472L, 180L, 680L, 694L, 1067L) */ ((signed char) (
					/* 475L, 179L, 683L, 697L, 1070L) */ (max (
						/* 475L, 179L, 683L, 697L, 1070L) */ (
							10
						) , (
							var_1_10
						)
	...
	/* 480L, 244L, 770L, 804L, 1075L) */ ((
		/* 481L, 197L, 205L, 771L, 805L, 1076L) */ ((
			/* 482L, 193L, 206L, 772L, 806L, 1077L) */ ((
				3886175339u
			) - (
				var_1_9
			))
		) <= (
			/* 485L, 196L, 209L, 775L, 809L, 1080L) */ ((
				var_1_20
			) / (
				var_1_3
			))
		...
		/* 488L, 238L, 778L, 812L, 1083L) */ ((
			/* 489L, 214L, 218L, 779L, 813L, 1084L) */ ((
				var_1_10
			) > (
				var_1_1
			))
		) ? (
			/* 492L, 228L, 782L, 816L, 1087L) */ ((
				var_1_23
			) == (
				/* 492L, 228L, 782L, 816L, 1087L) */ ((unsigned char) (
					/* 495L, 227L, 785L, 819L, 1090L) */ (min (
						/* 495L, 227L, 785L, 819L, 1090L) */ (
							var_1_20
						) , (
							/* 497L, 226L, 787L, 821L, 1092L) */ ((
								var_1_8
							) - (
								var_1_9
							))
			...
			/* 500L, 236L, 790L, 824L, 1095L) */ ((
				var_1_23
			) == (
				/* 500L, 236L, 790L, 824L, 1095L) */ ((unsigned char) (
					/* 503L, 235L, 793L, 827L, 1098L) */ ((
						/* 504L, 233L, 794L, 828L, 1099L) */ (max (
							/* 504L, 233L, 794L, 828L, 1099L) */ (
								var_1_20
							) , (
								64
							)
		...
		/* 508L, 242L, 798L, 832L, 1103L) */ ((
			var_1_23
		) == (
			/* 508L, 242L, 798L, 832L, 1103L) */ ((unsigned char) (
				var_1_20
			))
		))
	))
