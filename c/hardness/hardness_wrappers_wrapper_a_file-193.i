...
void step(void) {
 ...
 if (unsigned_char_Array_0[2] == stepLocal_0) {
  if (stepLocal_1 > (((((- unsigned_char_Array_0[1])) > (unsigned_char_Array_0[0])) ? ((- unsigned_char_Array_0[1])) : (unsigned_char_Array_0[0])))) {
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  signed_long_int_Array_0[0] = (signed_short_int_Array_0[1] + ((((((((signed_short_int_Array_0[2]) < (signed_short_int_Array_0[0])) ? (signed_short_int_Array_0[2]) : (signed_short_int_Array_0[0])))) > (last_1_signed_long_int_Array_0_0_)) ? (((((signed_short_int_Array_0[2]) < (signed_short_int_Array_0[0])) ? (signed_short_int_Array_0[2]) : (signed_short_int_Array_0[0])))) : (last_1_signed_long_int_Array_0_0_))));
 }
