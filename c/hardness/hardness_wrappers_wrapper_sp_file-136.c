...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_2_Pointer))) {
		if ((*(WrapperStruct00_var_1_3_Pointer))) {
			...
			(*(WrapperStruct00_var_1_1_Pointer)) = ((min ((*(WrapperStruct00_var_1_6_Pointer)) , 3757035609u)) - (*(WrapperStruct00_var_1_4_Pointer)));
		}
	} else {
	...
	if (stepLocal_0 == (*(WrapperStruct00_var_1_4_Pointer))) {
		if ((*(WrapperStruct00_var_1_8_Pointer)) < stepLocal_1) {
			(*(WrapperStruct00_var_1_7_Pointer)) = (abs ((*(WrapperStruct00_var_1_11_Pointer)) - (*(WrapperStruct00_var_1_12_Pointer))));
		} else {
			if ((*(WrapperStruct00_var_1_2_Pointer))) {
