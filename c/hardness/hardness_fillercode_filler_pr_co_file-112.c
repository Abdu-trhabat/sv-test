...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch112Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 284L, 133L) */ if (/* 285L, 75L, 76L) */ ((var_1_31) && (/* 287L, 74L, 78L) */ ((10.4f) > (/* 289L, 73L, 80L) */ ((99.625f) + (var_1_24))))))) {
		...
		/* 300L, 131L) */ if (/* 301L, 106L, 107L) */ ((/* 302L, 101L, 108L) */ ((var_1_5) + (var_1_30))) <= (/* 305L, 105L, 111L) */ (max (/* 305L, 105L, 111L) */ (var_1_29) , (/* 307L, 104L, 113L) */ (~ (var_1_28)))))))) {
			/* 309L, 130L) */ var_1_33 = (
				/* 312L, 129L) */ ((
					/* 313L, 127L) */ ((
						var_1_38
	...
	// From: CodeObject6
	/* 367L, 244L) */ if (/* 368L, 226L, 227L) */ ((/* 369L, 224L, 228L) */ ((var_1_29) << (var_1_18))) < (var_1_26))) {
		/* 373L, 243L) */ var_1_44 = (
			/* 376L, 242L) */ (abs (
				/* 377L, 241L) */ ((
					var_1_37
