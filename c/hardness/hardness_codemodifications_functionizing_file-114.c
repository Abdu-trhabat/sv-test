...
void functionized1(signed short int functionized1_localFunctionVar0) {
	if (var_1_1 || var_1_6) {
		var_1_7 = (min (var_1_5 , functionized1_localFunctionVar0));
	}
}
...
unsigned char functionized3(unsigned short int functionized3_localFunctionVar0) {
	return ((max ((~ 0u) , var_1_10)) > functionized3_localFunctionVar0);
}
unsigned long int functionized4(unsigned short int functionized4_localFunctionVar0, unsigned char functionized4_localFunctionVar1, unsigned long int localFunctionVar2) {
	return (min (((var_1_5 + functionized4_localFunctionVar0) + localFunctionVar2) , functionized4_localFunctionVar1));
}
unsigned long int functionized5(unsigned long int functionized5_localFunctionVar0) {
	return ((max (var_1_17 , functionized5_localFunctionVar0)) - var_1_5);
}
unsigned long int functionized6(unsigned short int functionized6_localFunctionVar0, unsigned short int functionized6_localFunctionVar1, unsigned long int functionized6_localFunctionVar2, unsigned char functionized6_localFunctionVar3) {
	return (functionized6_localFunctionVar3 + (functionized6_localFunctionVar2 - (min (functionized6_localFunctionVar0 , functionized6_localFunctionVar1))));
}
...
void step(void) {
	// From: Req1Batch114functionizing
	functionized0(var_1_5, 64u);


	// From: Req2Batch114functionizing
	functionized1(var_1_8);


	// From: Req3Batch114functionizing
	if (var_1_6) {
		var_1_9 = var_1_5;
	} else {
	...
	// From: Req4Batch114functionizing
	...
	// From: Req5Batch114functionizing
	if (functionized3(var_1_5)) {
		var_1_14 = var_1_5;
	}


	// From: Req6Batch114functionizing
	if (var_1_5 < var_1_3) {
		if (var_1_6 && var_1_4) {
	...
	// From: Req7Batch114functionizing
	var_1_20 = var_1_21;


	// From: Req8Batch114functionizing
	var_1_22 = 16u;


	// From: Req9Batch114functionizing
	var_1_23 = var_1_18;
}
...
int property(void) {
	return ((((((((((var_1_2 <= var_1_3) && var_1_4) ? (((var_1_3 >> var_1_5) <= 64u) ? (var_1_1 == ((unsigned char) var_1_6)) : (var_1_1 == ((unsigned char) 0))) : 1) && ((var_1_1 || var_1_6) ? (var_1_7 == ((signed short int) (min (var_1_5 , var_1_8)))) : 1)) && (var_1_6 ? (var_1_9 == ((signed short int) var_1_5)) : ((var_1_1 && (var_1_3 != var_1_5)) ? (var_1_9 == ((signed short int) var_1_5)) : 1))) && (((var_1_11 - var_1_12) >= var_1_13) ? (var_1_1 ? (var_1_10 == ((unsigned long int) var_1_5)) : 1) : 1)) && (((max ((~ 0u) , var_1_10)) > var_1_5) ? (var_1_14 == ((unsigned char) var_1_5)) : 1)) && ((var_1_5 < var_1_3) ? ((var_1_6 && var_1_4) ? (((var_1_16 - 10) == var_1_9) ? (var_1_15 == ((unsigned long int) (min (((var_1_5 + var_1_16) + 10u) , var_1_14)))) : (var_1_15 == ((unsigned long int) (((max (var_1_17 , var_1_18)) - var_1_5) - var_1_14)))) : (var_1_15 == ((unsigned long int) (var_1_14 + (var_1_19 - (min (var_1_16 , var_1_5))))))) : 1)) && (var_1_20 == ((float) var_1_21))) && (var_1_22 == ((unsigned long int) 16u))) && (var_1_23 == ((unsigned long int) var_1_18))
;
}
int main(void) {
	isInitial = 1;
