...
void step(void) {
	...
	if (stepLocal_1 <= ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)) - (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)))) {
		if (stepLocal_0 < (max (((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer)) / (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))) , (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer))))) {
