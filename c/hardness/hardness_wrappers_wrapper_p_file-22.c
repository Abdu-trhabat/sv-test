...
void step(void) {
	...
	if ((*(var_1_4_Pointer))) {
		...
		if ((*(var_1_2_Pointer)) <= stepLocal_0) {
			(*(var_1_5_Pointer)) = (max ((*(var_1_3_Pointer)) , ((*(var_1_6_Pointer)) - 8)));
		}
	}
	...
	if (stepLocal_1 >= ((*(var_1_2_Pointer)) & (*(var_1_3_Pointer)))) {
		(*(var_1_11_Pointer)) = (min ((min ((min (50u , (*(var_1_3_Pointer)))) , (*(var_1_6_Pointer)))) , ((*(var_1_12_Pointer)) - (*(var_1_5_Pointer)))));
	} else {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) == (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed short int) ((*(var_1_2_Pointer)) + -16))) : ((*(var_1_4_Pointer)) ? ((*(var_1_1_Pointer)) == ((signed short int) (*(var_1_3_Pointer)))) : 1)) && ((*(var_1_4_Pointer)) ? ((*(var_1_5_Pointer)) == ((unsigned short int) (*(var_1_2_Pointer)))) : (((*(var_1_2_Pointer)) <= (*(var_1_1_Pointer))) ? ((*(var_1_5_Pointer)) == ((unsigned short int) (max ((*(var_1_3_Pointer)) , ((*(var_1_6_Pointer)) - 8))))) : 1))) && (((*(var_1_11_Pointer)) < (*(var_1_5_Pointer))) ? ((*(var_1_7_Pointer)) == ((float) (((10.25f + (*(var_1_8_Pointer))) + (*(var_1_9_Pointer))) + (*(var_1_10_Pointer))))) : 1)) && (((*(var_1_5_Pointer)) >= ((*(var_1_2_Pointer)) & (*(var_1_3_Pointer)))) ? ((*(var_1_11_Pointer)) == ((unsigned long int) (min ((min ((min (50u , (*(var_1_3_Pointer)))) , (*(var_1_6_Pointer)))) , ((*(var_1_12_Pointer)) - (*(var_1_5_Pointer))))))) : ((5.7 < (*(var_1_9_Pointer))) ? ((*(var_1_11_Pointer)) == ((unsigned long int) (*(var_1_5_Pointer)))) : ((*(var_1_11_Pointer)) == ((unsigned long int) (*(var_1_3_Pointer))))))
;
}
int main(void) {
	isInitial = 1;
