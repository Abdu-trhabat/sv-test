...
void step(void) {
 ...
 signed long int stepLocal_4 = (((var_1_12) < ((var_1_17 - last_1_var_1_8))) ? (var_1_12) : ((var_1_17 - last_1_var_1_8)));
 if (var_1_7) {
  if (stepLocal_4 <= last_1_var_1_18) {
   if (stepLocal_5 > var_1_11) {
    var_1_18 = ((((last_1_var_1_31) < 0 ) ? -(last_1_var_1_31) : (last_1_var_1_31)));
   } else {
    var_1_18 = var_1_16;
   }
  } else {
 ...
 if (last_1_var_1_25 < var_1_16) {
  var_1_25 = ((((2u) > (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))))) ? (2u) : (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))))));
 } else {
...
int property(void) {
 return (((((((((var_1_2 ? (var_1_1 == ((unsigned char) ((var_1_3 || var_1_4) && var_1_5))) : ((var_1_4 && (var_1_31 <= 10)) ? (var_1_1 == ((unsigned char) var_1_7)) : 1)) && ((var_1_14 <= var_1_31) ? ((var_1_25 >= (var_1_14 / var_1_11)) ? (var_1_8 == ((unsigned char) (var_1_12 + var_1_13))) : (var_1_8 == ((unsigned char) var_1_12))) : (var_1_8 == ((unsigned char) var_1_13)))) && ((var_1_13 > var_1_12) ? ((var_1_13 > last_1_var_1_18) ? (((var_1_16 - var_1_12) == last_1_var_1_18) ? (var_1_14 == ((unsigned short int) (var_1_17 - var_1_13))) : (var_1_14 == ((unsigned short int) ((((last_1_var_1_18) > (last_1_var_1_31)) ? (last_1_var_1_18) : (last_1_var_1_31)))))) : 1) : (var_1_14 == ((unsigned short int) var_1_12)))) && (var_1_7 ? ((((((var_1_12) < ((var_1_17 - last_1_var_1_8))) ? (var_1_12) : ((var_1_17 - last_1_var_1_8)))) <= last_1_var_1_18) ? ((last_1_var_1_14 > var_1_11) ? (var_1_18 == ((unsigned long int) ((((last_1_var_1_31) < 0 ) ? -(last_1_var_1_31) : (last_1_var_1_31))))) : (var_1_18 == ((unsigned long int) var_1_16))) : (var_1_18 == ((unsigned long int) 64u))) : (var_1_18 == ((unsigned long int) var_1_13)))) && ((((var_1_20 - var_1_8) ^ var_1_32) > (var_1_14 - (var_1_14 + var_1_13))) ? (var_1_19 == ((signed short int) var_1_12)) : (var_1_19 == ((signed short int) var_1_31)))) && ((var_1_17 != ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)))) ? (var_1_21 == ((double) (var_1_22 - var_1_23))) : (var_1_21 == ((double) ((var_1_24 - 9.999999999994E11) - var_1_23))))) && ((last_1_var_1_25 < var_1_16) ? (var_1_25 == ((unsigned long int) ((((2u) > (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))))) ? (2u) : (((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)))))))) : (var_1_25 == ((unsigned long int) (var_1_20 + (var_1_26 - (var_1_27 - var_1_17))))))) && ((var_1_32 < var_1_25) ? (var_1_28 == ((float) ((var_1_29 + var_1_30) - var_1_24))) : 1)) && ((var_1_29 <= last_1_var_1_21) ? (last_1_var_1_1 ? (var_1_31 == ((signed long int) ((((var_1_13) < (last_1_var_1_25)) ? (var_1_13) : (last_1_var_1_25))))) : (var_1_7 ? (var_1_31 == ((signed long int) 10)) : (var_1_31 == ((signed long int) last_1_var_1_25)))) : 1)) && ((var_1_2 && var_1_4) ? ((var_1_16 < (var_1_33 - var_1_13)) ? (var_1_32 == ((unsigned short int) (var_1_33 + ((((var_1_12) > (var_1_16)) ? (var_1_12) : (var_1_16)))))) : (var_1_32 == ((unsigned short int) (var_1_25 + ((var_1_34 - var_1_12) - var_1_16))))) : ((var_1_25 < (~ var_1_18)) ? ((var_1_22 > ((var_1_21 * var_1_29) + var_1_30)) ? (var_1_32 == ((unsigned short int) var_1_25)) : 1) : (var_1_32 == ((unsigned short int) var_1_12))))
;
}
int main(void) {
 isInitial = 1;
