...
void step(void) {
	...
	if (! var_1_27) {
		...
		var_1_24 = (min (8 , ((min (var_1_15 , var_1_25)) + (max (var_1_26 , 1)))));
	}
	...
	if (stepLocal_3 <= (var_1_13 + (max (var_1_17 , var_1_3)))) {
		if (var_1_12) {
	...
	if (var_1_27) {
		if (var_1_1 >= var_1_28) {
			if (stepLocal_5 != (max (var_1_7 , var_1_3))) {
				var_1_31 = (var_1_15 - var_1_25);
			} else {
				var_1_31 = (var_1_15 - var_1_24);
			}
		} else {
			var_1_31 = (min (var_1_13 , var_1_34));
		}
	} else {
		var_1_31 = ((max (var_1_26 , (var_1_32 - var_1_24))) - (var_1_25 + (var_1_33 - 10)));
	}
...
int property(void) {
	return (((((((((((var_1_7 == (var_1_7 % var_1_4)) ? (var_1_1 == ((float) (var_1_5 - var_1_6))) : 1) && ((((var_1_6 - var_1_5) < last_1_var_1_1) || (var_1_4 >= last_1_var_1_20)) ? (var_1_7 == ((signed long int) ((var_1_8 - var_1_9) - var_1_10))) : (var_1_7 == ((signed long int) -32)))) && ((var_1_8 > var_1_4) ? (var_1_11 == ((signed short int) 0)) : ((var_1_8 <= (var_1_9 + (var_1_10 / var_1_4))) ? (var_1_27 ? (var_1_11 == ((signed short int) var_1_13)) : (var_1_11 == ((signed short int) 256))) : (var_1_11 == ((signed short int) var_1_13))))) && (((var_1_8 & (var_1_10 >> var_1_15)) == var_1_7) ? (var_1_27 ? (var_1_14 == ((signed short int) (var_1_15 + -128))) : (var_1_14 == ((signed short int) var_1_15))) : 1)) && ((var_1_9 <= (var_1_13 + (max (var_1_17 , var_1_3)))) ? (var_1_12 ? ((((var_1_7 / var_1_8) == var_1_4) || (var_1_18 && var_1_19)) ? (var_1_16 == ((signed char) var_1_15)) : (var_1_16 == ((signed char) -64))) : (var_1_16 == ((signed char) var_1_15))) : (var_1_16 == ((signed char) -64)))) && ((var_1_13 <= var_1_4) ? ((var_1_7 == var_1_4) ? (var_1_20 == ((signed long int) var_1_15)) : (var_1_20 == ((signed long int) var_1_14))) : ((var_1_8 > var_1_7) ? (var_1_20 == ((signed long int) var_1_31)) : 1))) && ((var_1_20 > var_1_7) ? ((var_1_1 <= var_1_5) ? (var_1_27 ? (var_1_23 == ((signed short int) var_1_15)) : (var_1_23 == ((signed short int) var_1_16))) : (var_1_23 == ((signed short int) var_1_13))) : (var_1_23 == ((signed short int) var_1_16)))) && ((! var_1_27) ? (var_1_24 == ((unsigned char) (var_1_15 + var_1_25))) : (var_1_24 == ((unsigned char) (min (8 , ((min (var_1_15 , var_1_25)) + (max (var_1_26 , 1))))))))) && (var_1_12 ? ((var_1_6 < (var_1_5 * (var_1_1 / var_1_28))) ? (var_1_27 == ((unsigned char) var_1_29)) : 1) : (var_1_27 == ((unsigned char) var_1_30)))) && (var_1_27 ? ((var_1_1 >= var_1_28) ? ((var_1_34 != (max (var_1_7 , var_1_3))) ? (var_1_31 == ((signed short int) (var_1_15 - var_1_25))) : (var_1_31 == ((signed short int) (var_1_15 - var_1_24)))) : (var_1_31 == ((signed short int) (min (var_1_13 , var_1_34))))) : (var_1_31 == ((signed short int) ((max (var_1_26 , (var_1_32 - var_1_24))) - (var_1_25 + (var_1_33 - 10))))))) && (var_1_34 == ((unsigned short int) var_1_15))
;
}
int main(void) {
	isInitial = 1;
