...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	signed long int stepLocal_4 = (var_1_16 + var_1_11) >> (min (2 , var_1_20));
	...
	if (last_1_var_1_12 <= stepLocal_2) {
		...
		if ((min ((last_1_var_1_18 + last_1_var_1_9) , var_1_11)) != stepLocal_3) {
			if ((max ((last_1_var_1_18 >> var_1_19) , last_1_var_1_24)) < stepLocal_4) {
	...
	if (var_1_7) {
		...
		var_1_26 = (abs (var_1_27 + var_1_29));
	}
	...
	if (stepLocal_7 && var_1_7) {
		if (stepLocal_6 < var_1_16) {
			var_1_24 = (min ((var_1_25 - last_1_var_1_31) , last_1_var_1_10));
		}
	} else {
		var_1_24 = var_1_20;
	}
	...
	if (stepLocal_5 >= var_1_24) {
		var_1_21 = (max ((abs (var_1_19 + var_1_20)) , var_1_22));
	}


	// From: Req10Batch1100_while
	var_1_30 = (128 - (abs (var_1_19)));
...
int property(void) {
	return (((((((((((var_1_9 <= var_1_30) ? (((var_1_9 ^ (var_1_30 ^ var_1_9)) < var_1_24) ? (var_1_1 == ((unsigned char) (var_1_6 || var_1_7))) : (var_1_6 ? (var_1_1 == ((unsigned char) var_1_8)) : (var_1_1 == ((unsigned char) 1)))) : 1) && ((last_1_var_1_12 < -128) ? (var_1_9 == ((unsigned short int) (last_1_var_1_23 + last_1_var_1_12))) : 1)) && ((! (var_1_9 > var_1_21)) ? ((var_1_31 >= var_1_21) ? (var_1_10 == ((unsigned short int) (var_1_11 - 10000))) : (var_1_10 == ((unsigned short int) 16))) : 1)) && (((var_1_13 - 1.5) > (last_1_var_1_26 / var_1_15)) ? ((var_1_13 > 15.5) ? (var_1_12 == ((signed long int) ((last_1_var_1_24 - (var_1_16 - last_1_var_1_23)) + (last_1_var_1_31 + last_1_var_1_18)))) : (var_1_12 == ((signed long int) last_1_var_1_23))) : (var_1_12 == ((signed long int) var_1_17)))) && ((last_1_var_1_12 <= last_1_var_1_24) ? (var_1_18 == ((unsigned long int) ((3528429073u - var_1_16) - last_1_var_1_18))) : (((min ((last_1_var_1_18 + last_1_var_1_9) , var_1_11)) != last_1_var_1_24) ? (((max ((last_1_var_1_18 >> var_1_19) , last_1_var_1_24)) < ((var_1_16 + var_1_11) >> (min (2 , var_1_20)))) ? ((var_1_15 != last_1_var_1_26) ? (var_1_18 == ((unsigned long int) var_1_20)) : (var_1_18 == ((unsigned long int) last_1_var_1_12))) : (var_1_18 == ((unsigned long int) last_1_var_1_12))) : (var_1_18 == ((unsigned long int) last_1_var_1_12))))) && ((var_1_12 >= var_1_24) ? (var_1_21 == ((unsigned char) (max ((abs (var_1_19 + var_1_20)) , var_1_22)))) : 1)) && ((((var_1_31 / -32) | var_1_16) >= var_1_12) ? ((var_1_15 != var_1_13) ? (var_1_23 == ((unsigned char) var_1_19)) : (var_1_23 == ((unsigned char) var_1_22))) : (var_1_23 == ((unsigned char) var_1_19)))) && (((var_1_11 == last_1_var_1_10) && var_1_7) ? ((var_1_19 < var_1_16) ? (var_1_24 == ((unsigned long int) (min ((var_1_25 - last_1_var_1_31) , last_1_var_1_10)))) : 1) : (var_1_24 == ((unsigned long int) var_1_20)))) && (var_1_7 ? ((var_1_17 >= var_1_18) ? (var_1_26 == ((double) ((1.0000000000000005E15 + var_1_27) - var_1_28))) : 1) : (var_1_26 == ((double) (abs (var_1_27 + var_1_29)))))) && (var_1_30 == ((unsigned char) (128 - (abs (var_1_19)))))) && (var_1_1 ? ((((last_1_var_1_31 >= var_1_9) && var_1_7) && var_1_6) ? (var_1_31 == ((signed long int) var_1_24)) : (var_1_31 == ((signed long int) var_1_16))) : (var_1_31 == ((signed long int) 128)))
;
}
int main(void) {
	isInitial = 1;
