...
void step(void) {
	...
	// From: Req6Batch10850_1loop
	if (var_1_15) {
		var_1_22 = ((max (var_1_23 , var_1_24)) - var_1_25);
	}


	// From: Req7Batch10850_1loop
	if (var_1_15) {
		if (var_1_21 >= 2) {
			var_1_26 = var_1_10;
		} else {
