...
void step(void) {
	// From: Req1Batch13225_while
	if (128 <= var_1_2) {
		var_1_1 = 25;
	}


	// From: Req2Batch13225_while
	if (var_1_4) {
		var_1_3 = var_1_5;
	} else {
