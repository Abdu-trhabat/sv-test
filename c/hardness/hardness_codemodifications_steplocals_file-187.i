...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch187stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_0 = var_1_14 - var_1_15;
 if (stepLocal_0 > ((var_1_10 + 1000000000) / var_1_16)) {
 ...
 signed long int stepLocal_3 = (2 ^ var_1_19) + var_1_16;
 signed long int stepLocal_2 = var_1_13 % ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)));
 if (stepLocal_2 >= (var_1_9 * var_1_16)) {
