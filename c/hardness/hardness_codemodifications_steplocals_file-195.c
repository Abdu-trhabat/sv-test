...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch195stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch195stepLocals
	signed long int stepLocal_0 = var_1_2 * 1;
	if (128 >= stepLocal_0) {
		var_1_1 = 4;
	}


	// From: Req2Batch195stepLocals
	signed long int stepLocal_1 = var_1_5;
	if (var_1_4) {
		if ((var_1_2 | var_1_1) <= stepLocal_1) {
	...
	// From: Req4Batch195stepLocals
	if ((var_1_1 ^ (var_1_5 / var_1_14)) <= var_1_2) {
		var_1_13 = var_1_15;
	}


	// From: Req5Batch195stepLocals
	if (var_1_6 < 0.375f) {
		var_1_16 = (max (var_1_17 , var_1_18));
	}


	// From: Req6Batch195stepLocals
	unsigned char stepLocal_2 = (min (var_1_1 , var_1_14)) >= (var_1_21 * var_1_18);
	...
	// From: Req7Batch195stepLocals
	if (var_1_4) {
		var_1_22 = (min (var_1_7 , var_1_6));
	}


	// From: Req8Batch195stepLocals
	var_1_23 = var_1_15;


	// From: Req9Batch195stepLocals
	var_1_24 = var_1_23;
}
