...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16125_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch16125_1loop
	var_1_8 = last_1_var_1_9;


	// From: Req1Batch16125_1loop
