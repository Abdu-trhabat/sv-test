 ...
 if (! (*(WrapperStruct00_var_1_9_Pointer))) {
  if (! ((10.25f - (*(WrapperStruct00_var_1_4_Pointer))) <= (*(WrapperStruct00_var_1_5_Pointer)))) {
   if (((*(WrapperStruct00_var_1_7_Pointer)) - (*(WrapperStruct00_var_1_6_Pointer))) <= (- 99999.25f)) {
    ...
    (*(WrapperStruct00_var_1_8_Pointer)) = (((((((((((((*(WrapperStruct00_var_1_2_Pointer))) > (16)) ? ((*(WrapperStruct00_var_1_2_Pointer))) : (16)))) < ((*(WrapperStruct00_var_1_1_Pointer)))) ? ((((((*(WrapperStruct00_var_1_2_Pointer))) > (16)) ? ((*(WrapperStruct00_var_1_2_Pointer))) : (16)))) : ((*(WrapperStruct00_var_1_1_Pointer)))))) > (2)) ? ((((((((((*(WrapperStruct00_var_1_2_Pointer))) > (16)) ? ((*(WrapperStruct00_var_1_2_Pointer))) : (16)))) < ((*(WrapperStruct00_var_1_1_Pointer)))) ? ((((((*(WrapperStruct00_var_1_2_Pointer))) > (16)) ? ((*(WrapperStruct00_var_1_2_Pointer))) : (16)))) : ((*(WrapperStruct00_var_1_1_Pointer)))))) : (2)));
   }
  }
 }
 if (! (*(WrapperStruct00_var_1_9_Pointer))) {
  if ((*(WrapperStruct00_var_1_9_Pointer))) {
   (*(WrapperStruct00_var_1_11_Pointer)) = (((((-256) < ((*(WrapperStruct00_var_1_8_Pointer)))) ? (-256) : ((*(WrapperStruct00_var_1_8_Pointer))))) + (*(WrapperStruct00_var_1_2_Pointer)));
  } else {
