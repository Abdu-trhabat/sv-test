...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch157dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch157dependencies
	if (((var_1_5 / var_1_10) < var_1_1) && var_1_7) {
		var_1_9 = 32;
	}


	// From: Req4Batch157dependencies
	var_1_11 = 199.4;


	// From: Req7Batch157dependencies
	...
	// From: Req8Batch157dependencies
	var_1_21 = last_1_var_1_21;


	// From: Req9Batch157dependencies
	var_1_22 = var_1_18;


	// From: Req2Batch157dependencies
	if (32.5 >= var_1_11) {
		if (var_1_7 && var_1_8) {
			var_1_6 = -4;
		}
	...
	// From: Req5Batch157dependencies
	if (((var_1_11 * var_1_3) > var_1_2) && (var_1_10 != var_1_21)) {
		var_1_12 = 32.75f;
	}


	// From: Req6Batch157dependencies
	if ((- 16.75) <= var_1_11) {
