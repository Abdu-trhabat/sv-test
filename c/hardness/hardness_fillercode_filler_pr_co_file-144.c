...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch144Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	/* 292L, 92L) */ if (/* 293L, 71L, 72L) */ ((var_1_31) > (/* 295L, 70L, 74L) */ (abs (var_1_22))))) {
		/* 297L, 85L) */ var_1_35 = (
			/* 300L, 84L) */ ((
				var_1_31
			) + (
	...
	// From: CodeObject1
	/* 275L, 54L) */ if (/* 276L, 35L, 36L) */ ((/* 277L, 31L, 37L) */ ((2) << (var_1_31))) <= (/* 280L, 34L, 40L) */ (max (/* 280L, 34L, 40L) */ (var_1_1) , (var_1_22)))))) {
		/* 283L, 53L) */ var_1_29 = (
			0
		);
	}
	...
	// From: CodeObject5
	/* 331L, 157L) */ if (/* 332L, 140L, 141L) */ ((var_1_1) >= (/* 334L, 139L, 143L) */ ((var_1_36) & (var_1_7))))) {
		/* 337L, 156L) */ var_1_39 = (
			/* 340L, 155L) */ ((
				var_1_15
			) || (
	...
	/* 344L, 194L) */ if (var_1_26) {
		/* 346L, 192L) */ if (/* 347L, 171L, 172L) */ ((var_1_22) <= (var_1_1))) {
			/* 350L, 185L) */ var_1_41 = (
				/* 353L, 184L) */ (abs (
					/* 354L, 183L) */ (abs (
						/* 355L, 182L) */ ((
