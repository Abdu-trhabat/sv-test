...
int property(void) {
	return ((((! var_1_2) ? ((var_1_2 && last_1_var_1_1) ? (var_1_1 == ((unsigned char) (var_1_4 || var_1_5))) : 1) : 1) && ((! var_1_11) ? (var_1_6 == ((signed long int) (var_1_7 + var_1_8))) : (var_1_6 == ((signed long int) (((abs (var_1_9)) + var_1_10) + var_1_7))))) && ((var_1_8 <= var_1_7) ? ((var_1_10 >= var_1_9) ? (var_1_11 == ((unsigned char) (! var_1_5))) : (var_1_11 == ((unsigned char) (var_1_1 || (! var_1_5))))) : 1)) && (var_1_4 ? (var_1_12 == ((double) (min (((max (var_1_13 , var_1_14)) + var_1_15) , (abs (min (3.5 , var_1_16))))))) : (var_1_12 == ((double) var_1_15)))
;
}
int main(void) {
	isInitial = 1;
