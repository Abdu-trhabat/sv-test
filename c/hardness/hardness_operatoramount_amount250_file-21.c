...
void step(void) {
	...
	if (last_1_var_1_64) {
		var_1_53 = (max (var_1_52 , (last_1_var_1_53 + 2)));
	}
	...
	if (1 == (var_1_28 << var_1_6)) {
		...
		if ((var_1_21 + var_1_8) >= var_1_18) {
			if ((var_1_8 + (min (var_1_19 , var_1_26))) == last_1_var_1_58) {
				var_1_31 = var_1_18;
			}
		}
	}
	...
	if (stepLocal_10 < var_1_11) {
		if (stepLocal_9 == (min (var_1_32 , (var_1_42 / var_1_41)))) {
			var_1_43 = (! var_1_10);
		}
	} else {
		if ((abs (var_1_16)) >= stepLocal_11) {
	...
	if (var_1_43) {
		var_1_49 = ((max (50 , (abs (var_1_25)))) - var_1_26);
	} else {
		var_1_49 = var_1_9;
	}
	...
	if (stepLocal_2 > (var_1_16 / var_1_6)) {
		if ((var_1_8 * (max (var_1_5 , var_1_18))) < stepLocal_3) {
			var_1_22 = (var_1_16 + (max (var_1_12 , -256)));
		} else {
	...
	if (var_1_8 < stepLocal_5) {
		var_1_24 = ((abs (var_1_25 - var_1_26)) - ((min (var_1_27 , 16)) + (var_1_28 - var_1_29)));
	}
	...
	// From: Req24Batch21Amount250
	var_1_65 = var_1_18;


	// From: Req19Batch21Amount250
	if ((10 / var_1_25) < var_1_65) {
		var_1_58 = (min ((var_1_18 + (1284334790u - var_1_52)) , var_1_53));
	}
	...
	if ((var_1_49 + (- var_1_31)) == stepLocal_19) {
		var_1_59 = (max ((min (var_1_46 , var_1_48)) , var_1_38));
	} else {
		var_1_59 = var_1_38;
	}
	...
	unsigned long int stepLocal_18 = (max (var_1_31 , var_1_22)) * var_1_17;
	if (stepLocal_18 != var_1_32) {
		var_1_56 = (var_1_16 + (max (1u , var_1_9)));
	}


	// From: Req23Batch21Amount250
	unsigned long int stepLocal_21 = var_1_58;
	signed long int stepLocal_20 = 1;
	if ((var_1_5 & var_1_20) <= stepLocal_20) {
		if (stepLocal_21 <= (min ((min (var_1_53 , var_1_56)) , -2))) {
	...
	if (! var_1_64) {
		var_1_45 = (min (var_1_38 , 24.1));
	} else {
		var_1_45 = ((max ((var_1_46 - var_1_47) , var_1_38)) + var_1_48);
	}
	...
	if ((min (var_1_60 , var_1_59)) > var_1_59) {
	...
	signed long int stepLocal_6 = var_1_1 / (min (var_1_5 , var_1_23));
	...
	if (stepLocal_7 == (min (10u , (var_1_26 / var_1_5)))) {
		if (var_1_36 == (var_1_38 * (- var_1_14))) {
			var_1_39 = (min (var_1_26 , (var_1_28 + var_1_27)));
		} else {
			if (var_1_59 >= var_1_38) {
				var_1_39 = var_1_26;
			} else {
				var_1_39 = (min ((var_1_29 + var_1_28) , var_1_25));
			}
		}
	} else {
	...
	unsigned long int stepLocal_15 = var_1_27 - (min (var_1_12 , var_1_32));
	signed long int stepLocal_14 = min ((var_1_39 * var_1_6) , var_1_18);
	signed long int stepLocal_13 = var_1_7 << var_1_27;
	unsigned long int stepLocal_12 = var_1_11;
	if ((max (var_1_26 , var_1_5)) >= stepLocal_13) {
		...
		if (stepLocal_12 >= ((var_1_27 + 2u) << var_1_20)) {
			if (var_1_25 != stepLocal_14) {
				var_1_44 = (var_1_16 + (max ((var_1_53 + 256) , (var_1_25 + var_1_17))));
			} else {
				var_1_44 = var_1_18;
			}
		} else {
	...
	if (var_1_40 <= var_1_60) {
		var_1_54 = ((min (var_1_52 , (var_1_29 + var_1_28))) - var_1_26);
	} else {
	...
	if (var_1_10) {
		if ((var_1_14 - var_1_15) >= ((var_1_60 + var_1_36) + var_1_60)) {
			...
			var_1_13 = ((abs (var_1_17)) + (max ((var_1_20 + var_1_21) , (abs (var_1_16)))));
		}
	}
}
...
int property(void) {
	return (((((((((((((((((((((((((min (var_1_60 , var_1_59)) > var_1_59) ? (var_1_1 == ((signed long int) (((var_1_5 + var_1_6) - var_1_7) - var_1_8))) : (var_1_1 == ((signed long int) (var_1_5 - 2)))) && ((last_1_var_1_1 >= (var_1_6 / var_1_5)) ? ((last_1_var_1_1 > var_1_7) ? (var_1_9 == ((unsigned long int) (3867474704u - ((var_1_11 + var_1_12) + var_1_7)))) : 1) : 1)) && (var_1_10 ? (((var_1_14 - var_1_15) >= ((var_1_60 + var_1_36) + var_1_60)) ? (var_1_13 == ((signed short int) (max (((var_1_16 + var_1_17) - var_1_18) , var_1_19)))) : (var_1_13 == ((signed short int) ((abs (var_1_17)) + (max ((var_1_20 + var_1_21) , (abs (var_1_16)))))))) : 1)) && (((128u + var_1_12) > (var_1_16 / var_1_6)) ? (((var_1_8 * (max (var_1_5 , var_1_18))) < var_1_19) ? (var_1_22 == ((signed long int) (var_1_16 + (max (var_1_12 , -256))))) : ((var_1_6 < var_1_5) ? (var_1_22 == ((signed long int) (var_1_17 - (var_1_23 - var_1_11)))) : (var_1_22 == ((signed long int) var_1_19)))) : (var_1_22 == ((signed long int) var_1_8)))) && ((var_1_8 < var_1_31) ? (var_1_24 == ((unsigned char) ((abs (var_1_25 - var_1_26)) - ((min (var_1_27 , 16)) + (var_1_28 - var_1_29))))) : 1)) && (var_1_30 == ((unsigned char) (! var_1_10)))) && ((1 == (var_1_28 << var_1_6)) ? (last_1_var_1_50 ? (var_1_31 == ((unsigned long int) (var_1_32 + ((var_1_18 + var_1_29) + var_1_11)))) : (var_1_31 == ((unsigned long int) (abs (var_1_29))))) : (((var_1_21 + var_1_8) >= var_1_18) ? (((var_1_8 + (min (var_1_19 , var_1_26))) == last_1_var_1_58) ? (var_1_31 == ((unsigned long int) var_1_18)) : 1) : 1))) && ((var_1_59 >= var_1_14) ? (var_1_33 == ((unsigned char) ((var_1_10 || (! var_1_34)) && var_1_35))) : 1)) && (((var_1_63 / var_1_25) >= (var_1_1 / (min (var_1_5 , var_1_23)))) ? (var_1_36 == ((float) (var_1_38 + 200.75f))) : 1)) && ((var_1_9 == (min (10u , (var_1_26 / var_1_5)))) ? ((var_1_36 == (var_1_38 * (- var_1_14))) ? (var_1_39 == ((unsigned char) (min (var_1_26 , (var_1_28 + var_1_27))))) : ((var_1_59 >= var_1_38) ? (var_1_39 == ((unsigned char) var_1_26)) : (var_1_39 == ((unsigned char) (min ((var_1_29 + var_1_28) , var_1_25)))))) : ((((- var_1_36) / var_1_40) != var_1_59) ? (var_1_39 == ((unsigned char) ((var_1_41 + (var_1_42 - var_1_29)) - var_1_28))) : 1))) && ((var_1_29 < var_1_11) ? ((var_1_7 == (min (var_1_32 , (var_1_42 / var_1_41)))) ? (var_1_43 == ((unsigned char) (! var_1_10))) : 1) : (((abs (var_1_16)) >= var_1_18) ? ((var_1_28 > var_1_9) ? (var_1_43 == ((unsigned char) var_1_35)) : (var_1_43 == ((unsigned char) var_1_10))) : 1))) && (((max (var_1_26 , var_1_5)) >= (var_1_7 << var_1_27)) ? ((((var_1_39 * var_1_25) / var_1_42) < (var_1_27 - (min (var_1_12 , var_1_32)))) ? ((var_1_38 == var_1_36) ? (var_1_44 == ((unsigned short int) (var_1_39 + var_1_25))) : 1) : (var_1_44 == ((unsigned short int) var_1_16))) : ((var_1_11 >= ((var_1_27 + 2u) << var_1_20)) ? ((var_1_25 != (min ((var_1_39 * var_1_6) , var_1_18))) ? (var_1_44 == ((unsigned short int) (var_1_16 + (max ((var_1_53 + 256) , (var_1_25 + var_1_17)))))) : (var_1_44 == ((unsigned short int) var_1_18))) : (var_1_44 == ((unsigned short int) ((var_1_17 + var_1_39) + var_1_18)))))) && ((! var_1_64) ? (var_1_45 == ((double) (min (var_1_38 , 24.1)))) : (var_1_45 == ((double) ((max ((var_1_46 - var_1_47) , var_1_38)) + var_1_48))))) && (var_1_43 ? (var_1_49 == ((signed short int) ((max (50 , (abs (var_1_25)))) - var_1_26))) : (var_1_49 == ((signed short int) var_1_9)))) && ((var_1_27 >= (4 + var_1_20)) ? ((var_1_47 <= var_1_60) ? ((var_1_16 != (var_1_17 << (var_1_51 - var_1_52))) ? (var_1_50 == ((unsigned char) (var_1_34 || var_1_10))) : 1) : 1) : 1)) && (last_1_var_1_64 ? (var_1_53 == ((unsigned short int) (max (var_1_52 , (last_1_var_1_53 + 2))))) : 1)) && ((var_1_40 <= var_1_60) ? (var_1_54 == ((signed char) ((min (var_1_52 , (var_1_29 + var_1_28))) - var_1_26))) : (var_1_54 == ((signed char) ((var_1_29 + (10 + var_1_55)) - (var_1_52 + 16)))))) && ((((max (var_1_31 , var_1_22)) * var_1_17) != var_1_32) ? (var_1_56 == ((unsigned long int) (var_1_16 + (max (1u , var_1_9))))) : 1)) && (((10 / var_1_25) < var_1_65) ? (var_1_58 == ((unsigned long int) (min ((var_1_18 + (1284334790u - var_1_52)) , var_1_53)))) : 1)) && (((var_1_49 + (- var_1_31)) == var_1_9) ? (var_1_59 == ((float) (max ((min (var_1_46 , var_1_48)) , var_1_38)))) : (var_1_59 == ((float) var_1_38)))) && ((((var_1_48 + 128.8f) * last_1_var_1_60) != var_1_45) ? (var_1_60 == ((double) 127.875)) : 1)) && (var_1_43 ? (var_1_63 == ((unsigned short int) var_1_29)) : (var_1_63 == ((unsigned short int) var_1_18)))) && (((var_1_5 & var_1_20) <= 1) ? ((var_1_58 <= (min ((min (var_1_53 , var_1_56)) , -2))) ? (var_1_64 == ((unsigned char) (var_1_33 && (var_1_34 || var_1_10)))) : (var_1_64 == ((unsigned char) (! var_1_34)))) : (var_1_64 == ((unsigned char) var_1_35)))) && (var_1_65 == ((unsigned short int) var_1_18))
;
}
int main(void) {
	isInitial = 1;
