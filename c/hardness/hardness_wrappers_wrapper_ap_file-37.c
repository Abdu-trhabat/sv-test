...
void step(void) {
	...
	if (stepLocal_1 >= 4) {
		if ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)) <= stepLocal_0) {
			(*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) = (min (((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) - ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)))) , (*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer))));
		}
	}


	// From: Req3Batch37Wrapper_AP
	(*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) = ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) + (max ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar7_Pointer)))));
