...
void step(void) {
	...
	// From: Req12Batch123100_while
	if (-25 > (last_1_var_1_23 * last_1_var_1_9)) {
		var_1_34 = (var_1_36 && var_1_37);
	}


	// From: Req6Batch123100_while
	var_1_21 = (abs (min (4.2 , var_1_22)));


	// From: Req8Batch123100_while
	signed char stepLocal_4 = var_1_18;
	if (var_1_4 < stepLocal_4) {
		var_1_24 = (min (var_1_25 , (min (var_1_26 , (abs (var_1_27))))));
	}


	// From: Req10Batch123100_while
	...
	// From: Req9Batch123100_while
	if ((var_1_25 >= var_1_9) || var_1_34) {
		if ((abs (var_1_21 / var_1_31)) > var_1_22) {
			var_1_28 = 9.25f;
		}
	} else {
		var_1_28 = var_1_22;
	...
	if (var_1_20 >= stepLocal_9) {
		if (var_1_7) {
			if (stepLocal_8 && var_1_17) {
				if ((var_1_28 * var_1_21) >= (var_1_22 / (min (var_1_31 , var_1_39)))) {
	...
	// From: Req4Batch123100_while
	unsigned char stepLocal_2 = var_1_38 && var_1_34;
	if (var_1_38 && stepLocal_2) {
		var_1_16 = (max ((max ((min (var_1_15 , var_1_14)) , var_1_18)) , 100));
	} else {
		var_1_16 = ((abs (var_1_14)) + var_1_15);
	}


	// From: Req7Batch123100_while
	...
	// From: Req1Batch123100_while
	unsigned long int stepLocal_0 = (var_1_23 + var_1_33) / (max (var_1_4 , var_1_5));
	...
	// From: Req3Batch123100_while
	signed long int stepLocal_1 = 25 % (min (var_1_4 , var_1_5));
	...
	// From: Req5Batch123100_while
	if (var_1_1 <= var_1_18) {
		var_1_19 = ((min (var_1_14 , var_1_15)) + var_1_20);
	}
}
...
int property(void) {
	return (((((((((((((((var_1_23 + var_1_33) / (max (var_1_4 , var_1_5))) <= var_1_33) ? (var_1_34 ? (var_1_1 == ((signed short int) var_1_8)) : 1) : (var_1_1 == ((signed short int) var_1_8))) && (last_1_var_1_38 ? (var_1_9 == ((unsigned short int) var_1_10)) : ((last_1_var_1_33 >= var_1_5) ? ((((var_1_10 + var_1_4) < last_1_var_1_33) && last_1_var_1_34) ? (var_1_9 == ((unsigned short int) var_1_10)) : (var_1_9 == ((unsigned short int) 2))) : (var_1_9 == ((unsigned short int) var_1_10))))) && (((25 % (min (var_1_4 , var_1_5))) == ((var_1_10 - 100000) + var_1_1)) ? (var_1_38 ? (var_1_13 == ((signed char) (var_1_14 + var_1_15))) : 1) : (var_1_13 == ((signed char) var_1_15)))) && ((var_1_38 && (var_1_38 && var_1_34)) ? (var_1_16 == ((signed char) (max ((max ((min (var_1_15 , var_1_14)) , var_1_18)) , 100)))) : (var_1_16 == ((signed char) ((abs (var_1_14)) + var_1_15))))) && ((var_1_1 <= var_1_18) ? (var_1_19 == ((signed char) ((min (var_1_14 , var_1_15)) + var_1_20))) : 1)) && (var_1_21 == ((double) (abs (min (4.2 , var_1_22)))))) && ((var_1_9 > var_1_4) ? (var_1_23 == ((signed long int) (var_1_32 + ((var_1_16 + var_1_18) + var_1_5)))) : 1)) && ((var_1_4 < var_1_18) ? (var_1_24 == ((unsigned char) (min (var_1_25 , (min (var_1_26 , (abs (var_1_27)))))))) : 1)) && (((var_1_25 >= var_1_9) || var_1_34) ? (((abs (var_1_21 / var_1_31)) > var_1_22) ? (var_1_28 == ((float) 9.25f)) : 1) : (var_1_28 == ((float) var_1_22)))) && ((var_1_27 < var_1_8) ? (var_1_32 == ((signed short int) -32)) : 1)) && (((var_1_5 / var_1_4) >= ((var_1_18 + var_1_26) + (var_1_20 + var_1_23))) ? (var_1_33 == ((unsigned long int) var_1_32)) : 1)) && ((-25 > (last_1_var_1_23 * last_1_var_1_9)) ? (var_1_34 == ((unsigned char) (var_1_36 && var_1_37))) : 1)) && ((var_1_20 >= var_1_24) ? (var_1_7 ? ((var_1_34 && var_1_17) ? (((var_1_28 * var_1_21) >= (var_1_22 / (min (var_1_31 , var_1_39)))) ? (((var_1_37 || var_1_17) || var_1_34) ? (var_1_38 == ((unsigned char) (var_1_12 || var_1_36))) : 1) : (var_1_38 == ((unsigned char) var_1_36))) : (var_1_38 == ((unsigned char) 0))) : (var_1_38 == ((unsigned char) 0))) : (var_1_38 == ((unsigned char) var_1_40)))
;
}
int main(void) {
	isInitial = 1;
