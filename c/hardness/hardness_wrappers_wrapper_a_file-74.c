...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch74Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned char stepLocal_0 = double_Array_0[1] > double_Array_0[0];
	if (stepLocal_0 || (last_1_BOOL_unsigned_char_Array_0_1__0_ && last_1_BOOL_unsigned_char_Array_0_0__0_)) {
	...
	if (last_1_BOOL_unsigned_char_Array_0_1__0_ && stepLocal_1) {
...
int property(void) {
	return ((((min ((max (double_Array_0[4] , double_Array_0[3])) , double_Array_0[2])) < double_Array_0[1]) ? (unsigned_long_int_Array_0[4] == ((unsigned long int) (max (unsigned_long_int_Array_0[3] , (unsigned_long_int_Array_0[2] - unsigned_long_int_Array_0[1]))))) : ((double_Array_0[4] >= (double_Array_0[3] + double_Array_0[1])) ? ((double_Array_0[2] > (- double_Array_0[1])) ? (unsigned_long_int_Array_0[4] == ((unsigned long int) unsigned_long_int_Array_0[3])) : (unsigned_long_int_Array_0[4] == ((unsigned long int) unsigned_long_int_Array_0[0]))) : (unsigned_long_int_Array_0[4] == ((unsigned long int) unsigned_long_int_Array_0[3])))) && (((double_Array_0[1] > double_Array_0[0]) || (last_1_BOOL_unsigned_char_Array_0_1__0_ && last_1_BOOL_unsigned_char_Array_0_0__0_)) ? (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1])) : (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) (BOOL_unsigned_char_Array_0[0][1] && (! BOOL_unsigned_char_Array_0[1][1])))))) && ((last_1_BOOL_unsigned_char_Array_0_1__0_ && BOOL_unsigned_char_Array_0[0][0]) ? ((double_Array_0[2] < (- double_Array_0[1])) ? (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) BOOL_unsigned_char_Array_0[1][1])) : (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1]))) : (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1])))
;
}
int main(void) {
	isInitial = 1;
