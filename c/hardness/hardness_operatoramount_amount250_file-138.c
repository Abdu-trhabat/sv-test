...
void step(void) {
	...
	// From: Req8Batch138Amount250
	if (var_1_5) {
		var_1_26 = (max (last_1_var_1_45 , var_1_24));
	}


	// From: Req15Batch138Amount250
	if (var_1_4) {
		var_1_45 = last_1_var_1_45;
	} else {
		var_1_45 = (min (var_1_26 , var_1_46));
	}


	// From: Req17Batch138Amount250
	if (last_1_var_1_1) {
		var_1_48 = (38941 - (max (last_1_var_1_47 , var_1_22)));
	} else {
		var_1_48 = (abs (var_1_22));
	}


	// From: Req19Batch138Amount250
	if (var_1_6) {
		var_1_52 = ((64 + var_1_45) - var_1_48);
	} else {
		var_1_52 = (var_1_24 + ((var_1_31 + var_1_39) + (max (-128 , -50))));
	}


	// From: Req9Batch138Amount250
	...
	if (last_1_var_1_58 <= var_1_17) {
		if (((last_1_var_1_26 ^ -32) + (50 - var_1_28)) < stepLocal_2) {
			if (last_1_var_1_7 <= 1.25) {
				var_1_27 = (min ((max (var_1_22 , var_1_28)) , ((max (3444168938u , var_1_29)) - (last_1_var_1_20 + last_1_var_1_26))));
			} else {
				var_1_27 = (min (var_1_29 , var_1_22));
			}
		}
	}


	// From: Req1Batch138Amount250
	...
	// From: Req10Batch138Amount250
	signed long int stepLocal_3 = ~ (var_1_45 / -2);
	if (var_1_27 > stepLocal_3) {
		var_1_30 = (min (var_1_28 , (abs (var_1_31))));
	}


	// From: Req21Batch138Amount250
	var_1_55 = (((min (64 , var_1_56)) + var_1_57) - 4);


	// From: Req22Batch138Amount250
	if (var_1_13 <= (var_1_44 - var_1_40)) {
		var_1_58 = ((min (var_1_12 , var_1_10)) + var_1_40);
	} else {
		if (! var_1_5) {
			var_1_58 = ((var_1_40 - var_1_59) + (max ((var_1_60 - var_1_61) , var_1_10)));
		} else {
			var_1_58 = (min (var_1_44 , 200.1));
		}
	}


	// From: Req20Batch138Amount250
	if (var_1_35 > (var_1_45 - last_1_var_1_53)) {
		var_1_53 = (max ((last_1_var_1_53 + (var_1_54 - var_1_45)) , (min (last_1_var_1_53 , var_1_29))));
	} else {
		var_1_53 = 200u;
	}


	// From: Req16Batch138Amount250
	var_1_47 = (var_1_52 + var_1_27);


	// From: Req3Batch138Amount250
	...
	// From: Req13Batch138Amount250
	signed long int stepLocal_6 = var_1_24 / (max (var_1_38 , var_1_39));
	if (stepLocal_6 >= var_1_53) {
		var_1_37 = ((abs (abs (var_1_11))) + (abs (var_1_10)));
	} else {
		var_1_37 = (var_1_11 + (min ((5.9f - var_1_40) , var_1_12)));
	}


	// From: Req18Batch138Amount250
	unsigned long int stepLocal_8 = var_1_36;
	if (var_1_12 < (var_1_43 - var_1_40)) {
		if (var_1_53 > stepLocal_8) {
			var_1_49 = ((min ((max (var_1_22 , 0)) , (var_1_35 + var_1_28))) + (min ((var_1_50 - var_1_47) , var_1_55)));
		} else {
			var_1_49 = (var_1_51 - ((abs (var_1_50)) - var_1_35));
		}
	} else {
	...
	// From: Req2Batch138Amount250
	if ((min ((- var_1_15) , (- 7.75))) <= (- var_1_15)) {
		if (var_1_1) {
	...
	// From: Req11Batch138Amount250
	unsigned long int stepLocal_4 = max (var_1_35 , var_1_53);
	if (var_1_19) {
		if (! var_1_5) {
			if (stepLocal_4 <= var_1_29) {
				var_1_32 = ((var_1_34 - var_1_35) - var_1_31);
			} else {
				var_1_32 = ((abs (max (var_1_24 , var_1_28))) + (var_1_35 - var_1_31));
			}
		}
	}


	// From: Req6Batch138Amount250
	if ((var_1_49 / var_1_24) <= (max ((var_1_22 ^ var_1_52) , 10))) {
		if (var_1_58 >= var_1_15) {
			var_1_23 = (min (var_1_18 , var_1_11));
		}
	} else {
		var_1_23 = (min (var_1_11 , 256.4f));
	}


	// From: Req14Batch138Amount250
	unsigned char stepLocal_7 = var_1_1;
	if ((min ((abs (24.75)) , (var_1_16 / 64.5))) < var_1_23) {
		if (var_1_11 >= (- (- var_1_10))) {
			var_1_41 = var_1_14;
		} else {
			if ((var_1_5 && var_1_1) && stepLocal_7) {
				var_1_41 = (var_1_40 - ((min (var_1_43 , var_1_44)) - (abs (var_1_12))));
			} else {
				var_1_41 = (max (var_1_43 , (max (var_1_10 , 256.2f))));
			}
		}
	} else {
		var_1_41 = ((min (32.75f , var_1_11)) + var_1_10);
	}


	// From: Req23Batch138Amount250
	unsigned short int stepLocal_9 = var_1_64;
	if (((var_1_63 - var_1_59) - var_1_16) <= (max (var_1_10 , var_1_44))) {
...
int property(void) {
	return ((((((((((((((((((((((((last_1_var_1_47 < last_1_var_1_26) ? (var_1_1 == ((unsigned char) (var_1_4 || (! (var_1_5 && var_1_6))))) : 1) && (((min ((- var_1_15) , (- 7.75))) <= (- var_1_15)) ? (var_1_1 ? (var_1_7 == ((double) (abs ((min (var_1_10 , var_1_11)) + var_1_12)))) : (var_1_7 == ((double) (var_1_11 + var_1_10)))) : (var_1_7 == ((double) (var_1_13 - var_1_14))))) && ((((var_1_14 - var_1_13) * (var_1_16 - var_1_17)) != var_1_58) ? (var_1_5 ? (var_1_15 == ((double) var_1_13)) : (var_1_15 == ((double) var_1_18))) : (var_1_15 == ((double) var_1_10)))) && ((var_1_15 == var_1_13) ? ((var_1_16 > var_1_15) ? ((var_1_4 && var_1_1) ? ((! (var_1_17 == var_1_15)) ? (var_1_19 == ((unsigned char) (! var_1_4))) : (var_1_19 == ((unsigned char) var_1_4))) : 1) : 1) : 1)) && ((var_1_8 == var_1_13) ? (((var_1_13 < var_1_9) && var_1_4) ? (var_1_20 == ((signed short int) var_1_27)) : (var_1_20 == ((signed short int) (var_1_27 + var_1_48)))) : ((! (var_1_15 < var_1_7)) ? (((var_1_27 * var_1_48) < var_1_32) ? (var_1_20 == ((signed short int) ((var_1_27 + var_1_48) - var_1_22))) : (var_1_20 == ((signed short int) var_1_22))) : (var_1_20 == ((signed short int) var_1_22))))) && (((var_1_49 / var_1_24) <= (max ((var_1_22 ^ var_1_52) , 10))) ? ((var_1_58 >= var_1_15) ? (var_1_23 == ((float) (min (var_1_18 , var_1_11)))) : 1) : (var_1_23 == ((float) (min (var_1_11 , 256.4f)))))) && ((var_1_37 == (var_1_10 + var_1_15)) ? (var_1_25 == ((signed short int) (var_1_22 - (var_1_20 + var_1_35)))) : (var_1_25 == ((signed short int) (var_1_24 + var_1_20))))) && (var_1_5 ? (var_1_26 == ((signed short int) (max (last_1_var_1_45 , var_1_24)))) : 1)) && ((last_1_var_1_58 <= var_1_17) ? ((((last_1_var_1_26 ^ -32) + (50 - var_1_28)) < var_1_22) ? ((last_1_var_1_7 <= 1.25) ? (var_1_27 == ((unsigned long int) (min ((max (var_1_22 , var_1_28)) , ((max (3444168938u , var_1_29)) - (last_1_var_1_20 + last_1_var_1_26)))))) : (var_1_27 == ((unsigned long int) (min (var_1_29 , var_1_22))))) : 1) : 1)) && ((var_1_27 > (~ (var_1_45 / -2))) ? (var_1_30 == ((unsigned char) (min (var_1_28 , (abs (var_1_31)))))) : 1)) && (var_1_19 ? ((! var_1_5) ? (((max (var_1_35 , var_1_53)) <= var_1_29) ? (var_1_32 == ((signed long int) ((var_1_34 - var_1_35) - var_1_31))) : (var_1_32 == ((signed long int) ((abs (max (var_1_24 , var_1_28))) + (var_1_35 - var_1_31))))) : 1) : 1)) && ((var_1_28 < last_1_var_1_53) ? (var_1_35 == ((unsigned long int) (max (var_1_29 , var_1_36)))) : (var_1_35 == ((unsigned long int) 2u)))) && (((var_1_24 / (max (var_1_38 , var_1_39))) >= var_1_53) ? (var_1_37 == ((float) ((abs (abs (var_1_11))) + (abs (var_1_10))))) : (var_1_37 == ((float) (var_1_11 + (min ((5.9f - var_1_40) , var_1_12))))))) && (((min ((abs (24.75)) , (var_1_16 / 64.5))) < var_1_23) ? ((var_1_11 >= (- (- var_1_10))) ? (var_1_41 == ((float) var_1_14)) : (((var_1_5 && var_1_1) && var_1_1) ? (var_1_41 == ((float) (var_1_40 - ((min (var_1_43 , var_1_44)) - (abs (var_1_12)))))) : (var_1_41 == ((float) (max (var_1_43 , (max (var_1_10 , 256.2f)))))))) : (var_1_41 == ((float) ((min (32.75f , var_1_11)) + var_1_10))))) && (var_1_4 ? (var_1_45 == ((signed long int) last_1_var_1_45)) : (var_1_45 == ((signed long int) (min (var_1_26 , var_1_46)))))) && (var_1_47 == ((unsigned short int) (var_1_52 + var_1_27)))) && (last_1_var_1_1 ? (var_1_48 == ((unsigned short int) (38941 - (max (last_1_var_1_47 , var_1_22))))) : (var_1_48 == ((unsigned short int) (abs (var_1_22)))))) && ((var_1_12 < (var_1_43 - var_1_40)) ? ((var_1_53 > var_1_36) ? (var_1_49 == ((unsigned short int) ((min ((max (var_1_22 , 0)) , (var_1_35 + var_1_28))) + (min ((var_1_50 - var_1_47) , var_1_55))))) : (var_1_49 == ((unsigned short int) (var_1_51 - ((abs (var_1_50)) - var_1_35))))) : (var_1_49 == ((unsigned short int) (63427 - var_1_31))))) && (var_1_6 ? (var_1_52 == ((signed short int) ((64 + var_1_45) - var_1_48))) : (var_1_52 == ((signed short int) (var_1_24 + ((var_1_31 + var_1_39) + (max (-128 , -50)))))))) && ((var_1_35 > (var_1_45 - last_1_var_1_53)) ? (var_1_53 == ((unsigned long int) (max ((last_1_var_1_53 + (var_1_54 - var_1_45)) , (min (last_1_var_1_53 , var_1_29)))))) : (var_1_53 == ((unsigned long int) 200u)))) && (var_1_55 == ((unsigned char) (((min (64 , var_1_56)) + var_1_57) - 4)))) && ((var_1_13 <= (var_1_44 - var_1_40)) ? (var_1_58 == ((double) ((min (var_1_12 , var_1_10)) + var_1_40))) : ((! var_1_5) ? (var_1_58 == ((double) ((var_1_40 - var_1_59) + (max ((var_1_60 - var_1_61) , var_1_10))))) : (var_1_58 == ((double) (min (var_1_44 , 200.1))))))) && ((((var_1_63 - var_1_59) - var_1_16) <= (max (var_1_10 , var_1_44))) ? ((((- var_1_51) + var_1_55) >= var_1_64) ? (var_1_62 == ((signed long int) var_1_64)) : (var_1_62 == ((signed long int) var_1_46))) : (var_1_62 == ((signed long int) var_1_52)))) && (((var_1_28 * (var_1_65 - var_1_57)) >= (max (var_1_48 , (1 / var_1_38)))) ? ((var_1_56 >= var_1_26) ? (var_1_64 == ((unsigned short int) last_1_var_1_64)) : (var_1_64 == ((unsigned short int) var_1_49))) : 1)
;
}
int main(void) {
	isInitial = 1;
