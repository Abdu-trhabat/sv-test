...
unsigned char functionized1(unsigned long int functionized1_localFunctionVar0) {
	return (var_1_6 >= (min (functionized1_localFunctionVar0 , var_1_1)));
}
...
void step(void) {
	// From: Req1Batch191functionizing
	if (var_1_2 >= (max ((max (var_1_3 , var_1_4)) , var_1_5))) {
	...
	// From: Req2Batch191functionizing
	if (var_1_8) {
		var_1_9 = 1000u;
	} else {
		var_1_9 = var_1_6;
	...
	// From: Req5Batch191functionizing
	functionized2(var_1_10, var_1_9);


	// From: Req6Batch191functionizing
	functionized3(var_1_19);


	// From: Req7Batch191functionizing
	functionized4(var_1_21, var_1_23);


	// From: Req8Batch191functionizing
	if ((var_1_20 == (var_1_2 * var_1_22)) || var_1_11) {
		var_1_24 = var_1_18;
	}


	// From: Req9Batch191functionizing
