...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17100_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (! (var_1_21 <= last_1_var_1_24)) {
  if (last_1_var_1_16 >= (- 5.7f)) {
   if (stepLocal_5 || last_1_var_1_23) {
    ...
    var_1_24 = ((((last_1_var_1_10) < 0 ) ? -(last_1_var_1_10) : (last_1_var_1_10)));
   }
  } else {
   var_1_24 = (((var_1_25 - var_1_21) - ((((256) > (var_1_13)) ? (256) : (var_1_13)))) - var_1_26);
  }
 }
 if ((last_1_var_1_14 + var_1_7) == (var_1_12 + last_1_var_1_24)) {
  if (last_1_var_1_14 != var_1_4) {
   var_1_30 = ((((last_1_var_1_14) > (last_1_var_1_30)) ? (last_1_var_1_14) : (last_1_var_1_30)));
  } else {
 ...
 if (var_1_30 != stepLocal_6) {
  var_1_27 = (((((((((var_1_19) > (var_1_17)) ? (var_1_19) : (var_1_17))) + var_1_28)) < (var_1_29)) ? ((((((var_1_19) > (var_1_17)) ? (var_1_19) : (var_1_17))) + var_1_28)) : (var_1_29)));
 }
 ...
 if ((-16 * var_1_30) > (((((var_1_24) < (var_1_14)) ? (var_1_24) : (var_1_14))) / var_1_11)) {
  var_1_10 = ((((var_1_14) < (var_1_30)) ? (var_1_14) : (var_1_30)));
 } else {
  var_1_10 = (var_1_12 - var_1_13);
 }
 unsigned char stepLocal_0 = (var_1_14 | var_1_24) <= var_1_24;
 if (stepLocal_0 || (((((var_1_30) < (var_1_10)) ? (var_1_30) : (var_1_10))) > var_1_24)) {
  var_1_1 = ((! 1) && var_1_8);
 } else {
  var_1_1 = var_1_9;
 }
...
int property(void) {
 return (((((((((((((var_1_14 | var_1_24) <= var_1_24) || (((((var_1_30) < (var_1_10)) ? (var_1_30) : (var_1_10))) > var_1_24)) ? (var_1_1 == ((unsigned char) ((! 1) && var_1_8))) : (var_1_1 == ((unsigned char) var_1_9))) && (((-16 * var_1_30) > (((((var_1_24) < (var_1_14)) ? (var_1_24) : (var_1_14))) / var_1_11)) ? (var_1_10 == ((signed short int) ((((var_1_14) < (var_1_30)) ? (var_1_14) : (var_1_30))))) : (var_1_10 == ((signed short int) (var_1_12 - var_1_13))))) && (var_1_14 == ((signed short int) (-2 + (var_1_15 + last_1_var_1_30))))) && ((var_1_14 == (-128 * var_1_14)) ? (var_1_16 == ((double) (((((0.875 + (var_1_17 + 64.4))) > (1.0000000000000005E15)) ? ((0.875 + (var_1_17 + 64.4))) : (1.0000000000000005E15))))) : (var_1_16 == ((double) var_1_17)))) && ((((var_1_14 + -16) * var_1_14) >= var_1_15) ? (var_1_18 == ((float) (64.9f + var_1_19))) : (var_1_18 == ((float) var_1_17)))) && (((var_1_13 % var_1_22) >= (var_1_24 & var_1_21)) ? (var_1_20 == ((float) ((((((((63.5f + var_1_17) < 0 ) ? -(63.5f + var_1_17) : (63.5f + var_1_17)))) < (var_1_19)) ? (((((63.5f + var_1_17) < 0 ) ? -(63.5f + var_1_17) : (63.5f + var_1_17)))) : (var_1_19))))) : (var_1_20 == ((float) var_1_19)))) && ((! (var_1_17 <= var_1_19)) ? (last_1_var_1_23 ? (((~ (var_1_13 * 128u)) == var_1_21) ? (var_1_23 == ((unsigned char) (! var_1_9))) : 1) : (var_1_23 == ((unsigned char) var_1_9))) : (var_1_23 == ((unsigned char) var_1_9)))) && ((! (var_1_21 <= last_1_var_1_24)) ? ((last_1_var_1_16 >= (- 5.7f)) ? ((var_1_9 || last_1_var_1_23) ? (var_1_24 == ((signed long int) (last_1_var_1_30 + (last_1_var_1_10 + var_1_12)))) : (var_1_24 == ((signed long int) ((((last_1_var_1_10) < 0 ) ? -(last_1_var_1_10) : (last_1_var_1_10)))))) : (var_1_24 == ((signed long int) (((var_1_25 - var_1_21) - ((((256) > (var_1_13)) ? (256) : (var_1_13)))) - var_1_26)))) : 1)) && ((var_1_30 != var_1_26) ? (var_1_27 == ((float) (((((((((var_1_19) > (var_1_17)) ? (var_1_19) : (var_1_17))) + var_1_28)) < (var_1_29)) ? ((((((var_1_19) > (var_1_17)) ? (var_1_19) : (var_1_17))) + var_1_28)) : (var_1_29))))) : 1)) && (((last_1_var_1_14 + var_1_7) == (var_1_12 + last_1_var_1_24)) ? ((last_1_var_1_14 != var_1_4) ? (var_1_30 == ((signed short int) ((((last_1_var_1_14) > (last_1_var_1_30)) ? (last_1_var_1_14) : (last_1_var_1_30))))) : ((last_1_var_1_23 || var_1_9) ? (var_1_30 == ((signed short int) last_1_var_1_14)) : (var_1_30 == ((signed short int) var_1_12)))) : 1)) && (((- var_1_19) >= var_1_18) ? (((var_1_24 * var_1_12) >= var_1_25) ? (var_1_31 == ((float) var_1_28)) : 1) : (var_1_31 == ((float) var_1_19)))
;
}
int main(void) {
 isInitial = 1;
