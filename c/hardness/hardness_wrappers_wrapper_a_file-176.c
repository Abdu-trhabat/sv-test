...
void step(void) {
	// From: Req1Batch176Wrapper_A
	signed_long_int_Array_0[1][2] = ((10000000 + 5) - (signed_long_int_Array_0[0][2] - signed_long_int_Array_0[1][1]));


	// From: Req3Batch176Wrapper_A
	if (! (signed_long_int_Array_0[0][2] <= signed_long_int_Array_0[1][1])) {
		signed_long_int_Array_0[1][0] = (min (signed_long_int_Array_0[0][2] , (min (signed_long_int_Array_0[1][1] , (max (-128 , signed_long_int_Array_0[0][0]))))));
	}


	// From: Req4Batch176Wrapper_A
	unsigned long int stepLocal_2 = max (unsigned_long_int_Array_0[0] , signed_long_int_Array_0[1][2]);
	if (stepLocal_2 >= signed_long_int_Array_0[0][1]) {
		unsigned_char_Array_0[0] = (16 + unsigned_char_Array_0[1]);
	}


	// From: Req5Batch176Wrapper_A
