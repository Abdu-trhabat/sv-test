...
void step(void) {
 if (var_1_8 == ((- last_1_var_1_13) * last_1_var_1_1)) {
  if ((((((var_1_3 * var_1_2)) < (last_1_var_1_35)) ? ((var_1_3 * var_1_2)) : (last_1_var_1_35))) > last_1_var_1_35) {
   var_1_15 = var_1_5;
  } else {
 ...
 if (var_1_27 < (last_1_var_1_35 * var_1_25)) {
  ...
  if (((((last_1_var_1_13) > (last_1_var_1_19)) ? (last_1_var_1_13) : (last_1_var_1_19))) != (last_1_var_1_19 + -8)) {
 ...
 if (var_1_8 <= ((((25) < (var_1_7)) ? (25) : (var_1_7)))) {
  if (var_1_29) {
   var_1_22 = ((var_1_23 + var_1_24) + (var_1_25 - ((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27)))));
  }
 } else {
  var_1_22 = (var_1_23 + ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))));
 }
 ...
 if (var_1_34 || stepLocal_2) {
  ...
  var_1_36 = (16 - ((((var_1_38) > (var_1_8)) ? (var_1_38) : (var_1_8))));
 }
 if (var_1_5 <= var_1_15) {
  if (var_1_29) {
...
int property(void) {
 return ((((((((((((((! ((var_1_2 - var_1_3) < var_1_22)) ? (var_1_1 == ((unsigned char) (128 - var_1_5))) : 1) && (var_1_6 == ((unsigned char) ((64 - (var_1_7 - var_1_8)) + var_1_5)))) && (var_1_29 ? (var_1_9 == ((unsigned char) (var_1_8 + var_1_7))) : 1)) && ((50 < var_1_9) ? (var_1_11 == ((unsigned char) var_1_8)) : 1)) && ((var_1_3 < var_1_2) ? (var_1_12 == ((unsigned char) var_1_8)) : 1)) && ((var_1_5 <= var_1_15) ? (var_1_29 ? (var_1_13 == ((unsigned short int) (var_1_14 - ((((var_1_8) > (last_1_var_1_13)) ? (var_1_8) : (last_1_var_1_13)))))) : (var_1_13 == ((unsigned short int) var_1_15))) : (var_1_13 == ((unsigned short int) var_1_14)))) && ((var_1_8 == ((- last_1_var_1_13) * last_1_var_1_1)) ? (((((((var_1_3 * var_1_2)) < (last_1_var_1_35)) ? ((var_1_3 * var_1_2)) : (last_1_var_1_35))) > last_1_var_1_35) ? (var_1_15 == ((unsigned long int) var_1_5)) : (var_1_15 == ((unsigned long int) last_1_var_1_17))) : (var_1_15 == ((unsigned long int) last_1_var_1_12)))) && ((var_1_29 && ((var_1_8 != var_1_19) && (var_1_19 < var_1_5))) ? (var_1_17 == ((unsigned char) var_1_18)) : (var_1_17 == ((unsigned char) var_1_5)))) && (var_1_29 ? (var_1_19 == ((unsigned long int) (var_1_20 - var_1_9))) : (var_1_19 == ((unsigned long int) (var_1_8 + ((var_1_21 - var_1_12) + 8u)))))) && ((var_1_8 <= ((((25) < (var_1_7)) ? (25) : (var_1_7)))) ? (var_1_29 ? (var_1_22 == ((double) ((var_1_23 + var_1_24) + (var_1_25 - ((((var_1_26) > (var_1_27)) ? (var_1_26) : (var_1_27))))))) : 1) : (var_1_22 == ((double) (var_1_23 + ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27)))))))) && (((var_1_14 == var_1_20) && (var_1_8 >= 0)) ? (var_1_28 == ((double) (var_1_26 - var_1_27))) : (var_1_28 == ((double) ((7.84392133852235E18 - var_1_25) - var_1_26))))) && ((var_1_27 < (last_1_var_1_35 * var_1_25)) ? (var_1_29 == ((unsigned char) (var_1_30 && (var_1_31 && var_1_32)))) : ((((((last_1_var_1_13) > (last_1_var_1_19)) ? (last_1_var_1_13) : (last_1_var_1_19))) != (last_1_var_1_19 + -8)) ? (var_1_29 == ((unsigned char) ((var_1_33 || var_1_34) || (! var_1_30)))) : 1))) && ((0 <= var_1_15) ? (var_1_35 == ((double) (var_1_26 - var_1_25))) : 1)) && ((var_1_34 || ((var_1_15 > var_1_1) || var_1_32)) ? (var_1_36 == ((signed char) (32 + var_1_37))) : (var_1_36 == ((signed char) (16 - ((((var_1_38) > (var_1_8)) ? (var_1_38) : (var_1_8)))))))
;
}
int main(void) {
 isInitial = 1;
