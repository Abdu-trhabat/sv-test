...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch123Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
  ...
  var_1_23
            ...
            if ( ((var_1_22) <= ( ((var_1_25) - ( ((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23)))))))) {
             var_1_24 = (
