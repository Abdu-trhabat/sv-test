...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_3_Pointer)) < ((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_2_Pointer)))) * (*(WrapperStruct00_var_1_5_Pointer)))) {
