...
void step(void) {
 ...
 if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) || stepLocal_2) {
  (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) = (((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer))) < (((((-200) < ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)))) ? (-200) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer))))))) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer))) : (((((-200) < ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)))) ? (-200) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer))))))));
 } else {
  if (stepLocal_3 != 1u) {
