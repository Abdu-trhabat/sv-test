...
void step(void) {
	...
	// From: CodeObject6
	/* 318L, 151L) */ if (/* 319L, 115L, 116L) */ ((var_1_29) > (var_1_16))) {
	...
	// From: CodeObject8
	/* 341L, 184L) */ if (/* 342L, 168L, 169L) */ ((var_1_23) >= (var_1_16))) {
		/* 345L, 183L) */ var_1_38 = (
			/* 348L, 182L) */ (abs (
				/* 349L, 181L) */ (min (
					/* 349L, 181L) */ (
	...
	// From: CodeObject2
	/* 240L, 35L) */ if (/* 241L, 19L, 20L) */ ((/* 242L, 17L, 21L) */ ((var_1_16) - (var_1_23))) >= (var_1_18))) {
		/* 246L, 34L) */ var_1_21 = (
			/* 249L, 33L) */ (abs (
				var_1_25
			))
	...
	// From: CodeObject5
	/* 297L, 107L) */ if (/* 298L, 77L, 78L) */ ((var_1_1) >= (var_1_16))) {
		/* 301L, 105L) */ if (/* 302L, 86L, 87L) */ ((var_1_16) >= (var_1_23))) {
			/* 305L, 104L) */ var_1_30 = (
				/* 308L, 103L) */ (min (
					/* 308L, 103L) */ (
						var_1_31
