...
void step(void) {
	...
	// From: Req2Batch147normal
	if (var_1_1 == var_1_4) {
		var_1_5 = (var_1_6 + var_1_7);
	}


	// From: Req3Batch147normal
	...
	// From: Req4Batch147normal
	if (-1000000 != var_1_1) {
		var_1_12 = (min ((max (var_1_13 , var_1_14)) , var_1_15));
	}


	// From: Req5Batch147normal
	if (var_1_4 <= (var_1_10 + (var_1_12 + 5))) {
		var_1_16 = var_1_2;
	}


	// From: Req6Batch147normal
	if ((min (var_1_12 , var_1_13)) <= var_1_15) {
		var_1_17 = (var_1_3 - var_1_10);
	}


	// From: Req7Batch147normal
	if (var_1_9) {
		if (var_1_19) {
