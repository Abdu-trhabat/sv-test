...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch161Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 270L, 75L) */ if (/* 271L, 6L, 7L) */ ((var_1_10) >= (/* 273L, 5L, 9L) */ (- (var_1_9))))) {
		/* 275L, 66L) */ if (/* 276L, 17L, 18L) */ ((var_1_10) < (var_1_9))) {
			/* 279L, 35L) */ var_1_29 = (
				/* 282L, 34L) */ (max (
					/* 282L, 34L) */ (
						/* 283L, 30L) */ (max (
			...
			/* 291L, 64L) */ if (/* 292L, 42L, 43L) */ ((/* 293L, 40L, 44L) */ (min (/* 293L, 40L, 44L) */ (/* 294L, 38L, 45L) */ ((var_1_9) + (4u))) , (var_1_35)))) >= (var_1_33))) {
				/* 299L, 63L) */ var_1_29 = (
					/* 302L, 62L) */ (abs (
						/* 303L, 61L) */ ((
							var_1_36
	...
	// From: CodeObject7
	/* 381L, 199L) */ if (/* 382L, 164L, 165L) */ ((var_1_3) < (var_1_12))) {
	...
	// From: CodeObject5
	/* 328L, 126L) */ if (/* 329L, 108L, 109L) */ ((var_1_10) >= (/* 331L, 107L, 111L) */ (max (/* 331L, 107L, 111L) */ (var_1_12) , (/* 333L, 106L, 113L) */ (abs (var_1_12)))))))) {
		/* 335L, 125L) */ var_1_42 = (
			/* 338L, 124L) */ (abs (
				-16
			))
