...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17050_1loop.c", 13, "reach_error"); }
...
int property(void) {
 return ((((((var_1_4 ? (var_1_1 == ((float) var_1_3)) : 1) && ((-5 > last_1_var_1_10) ? ((last_1_var_1_10 > 10) ? (var_1_4 == ((unsigned char) ((last_1_var_1_4 && var_1_6) || var_1_7))) : (var_1_4 == ((unsigned char) (var_1_7 && (var_1_8 || var_1_6))))) : (var_1_4 == ((unsigned char) var_1_9)))) && (((var_1_5 + (var_1_11 + var_1_12)) >= -256) ? (var_1_4 ? (var_1_10 == ((signed long int) var_1_12)) : 1) : 1)) && ((var_1_10 == (var_1_5 + var_1_11)) ? (var_1_7 ? ((var_1_3 == ((((var_1_1) < ((last_1_var_1_13 * var_1_21))) ? (var_1_1) : ((last_1_var_1_13 * var_1_21))))) ? (var_1_13 == ((float) (((((var_1_16 + 15.8f)) > (var_1_3)) ? ((var_1_16 + 15.8f)) : (var_1_3))))) : (var_1_13 == ((float) ((((99999.1f) < (var_1_16)) ? (99999.1f) : (var_1_16)))))) : (var_1_13 == ((float) var_1_3))) : (var_1_13 == ((float) var_1_3)))) && ((var_1_10 > (var_1_10 / ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18))))) ? (var_1_17 == ((float) var_1_16)) : 1)) && ((var_1_17 < var_1_3) ? ((var_1_13 < ((64.1f * var_1_16) / 256.95f)) ? (var_1_9 ? (var_1_19 == ((signed char) var_1_20)) : (var_1_19 == ((signed char) -1))) : 1) : (var_1_19 == ((signed char) var_1_20)))) && (var_1_21 == ((float) var_1_3))
;
}
int main(void) {
 isInitial = 1;
