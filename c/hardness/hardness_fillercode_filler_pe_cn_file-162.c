...
void step(void) {
	...
	// From: Req6Batch162Filler_PE_CN
	/* 1152L, 308L, 904L, 910L) */ var_1_20 = (
		var_1_21
	);


	// From: Req7Batch162Filler_PE_CN
	/* 1158L, 318L, 928L, 934L) */ var_1_22 = (
		1
	);


	// From: Req2Batch162Filler_PE_CN
