...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch26Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (double_Array_0[1] > double_Array_0[0]) {
		signed_short_int_Array_0[2][2] = (max (signed_short_int_Array_0[1][2] , signed_short_int_Array_0[0][2]));
	} else {
		signed_short_int_Array_0[2][2] = (min ((signed_short_int_Array_0[2][1] - (max (signed_short_int_Array_0[0][1] , signed_short_int_Array_0[1][0]))) , (signed_short_int_Array_0[0][0] + (min (signed_short_int_Array_0[2][0] , signed_short_int_Array_0[1][1])))));
	}
	...
	if ((- signed_short_int_Array_0[1][0]) >= (signed_short_int_Array_0[1][2] / (abs (-4)))) {
		unsigned_char_Array_0[1] = unsigned_char_Array_0[0];
	}


	// From: Req4Batch26Wrapper_A
	signed long int stepLocal_0 = signed_short_int_Array_0[0][1] * (signed_short_int_Array_0[2][2] / signed_long_int_Array_0[0]);
	if ((signed_short_int_Array_0[0][2] + (signed_short_int_Array_0[1][1] + unsigned_char_Array_0[1])) != stepLocal_0) {
		unsigned_long_int_Array_0[0] = ((min (10u , (unsigned_char_Array_0[1] + signed_short_int_Array_0[1][0]))) + signed_short_int_Array_0[0][1]);
	}
...
int property(void) {
	return (((((double_Array_0[1] > double_Array_0[0]) ? (signed_short_int_Array_0[2][2] == ((signed short int) (max (signed_short_int_Array_0[1][2] , signed_short_int_Array_0[0][2])))) : (signed_short_int_Array_0[2][2] == ((signed short int) (min ((signed_short_int_Array_0[2][1] - (max (signed_short_int_Array_0[0][1] , signed_short_int_Array_0[1][0]))) , (signed_short_int_Array_0[0][0] + (min (signed_short_int_Array_0[2][0] , signed_short_int_Array_0[1][1])))))))) && (float_Array_0[1][0] == ((float) ((0.85f - float_Array_0[0][1]) + float_Array_0[1][1])))) && (((- signed_short_int_Array_0[1][0]) >= (signed_short_int_Array_0[1][2] / (abs (-4)))) ? (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[0])) : 1)) && (((signed_short_int_Array_0[0][2] + (signed_short_int_Array_0[1][1] + unsigned_char_Array_0[1])) != (signed_short_int_Array_0[0][1] * (signed_short_int_Array_0[2][2] / signed_long_int_Array_0[0]))) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) ((min (10u , (unsigned_char_Array_0[1] + signed_short_int_Array_0[1][0]))) + signed_short_int_Array_0[0][1]))) : 1)) && (float_Array_0[0][0] == ((float) float_Array_0[0][1]))
;
}
int main(void) {
	isInitial = 1;
