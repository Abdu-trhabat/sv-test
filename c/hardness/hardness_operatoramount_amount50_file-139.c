...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch139Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch139Amount50
	if (var_1_10 <= var_1_6) {
		var_1_9 = ((var_1_11 + (max (var_1_12 , var_1_13))) - var_1_14);
	} else {
		var_1_9 = (min (var_1_14 , var_1_13));
	}


	// From: Req3Batch139Amount50
	if (var_1_10 == (- (var_1_5 - var_1_12))) {
		var_1_15 = (max ((var_1_16 + 8) , 50));
	} else {
		var_1_15 = 25;
	}


	// From: Req4Batch139Amount50
	if (var_1_10 >= ((var_1_5 + var_1_4) + var_1_13)) {
		var_1_17 = var_1_16;
	}


	// From: Req5Batch139Amount50
	...
	// From: Req6Batch139Amount50
	if ((max (var_1_7 , (var_1_21 - last_1_var_1_20))) > (abs (var_1_1))) {
		var_1_20 = (min (var_1_16 , (max (1 , 5))));
	} else {
		if (var_1_2) {
			var_1_20 = var_1_16;
		}
...
int property(void) {
	return (((((((var_1_9 * (255.8f / var_1_4)) >= (var_1_5 - var_1_6)) ? (var_1_1 == ((unsigned long int) (max (var_1_7 , var_1_8)))) : (var_1_2 ? (var_1_1 == ((unsigned long int) var_1_7)) : (var_1_1 == ((unsigned long int) var_1_8)))) && ((var_1_10 <= var_1_6) ? (var_1_9 == ((float) ((var_1_11 + (max (var_1_12 , var_1_13))) - var_1_14))) : (var_1_9 == ((float) (min (var_1_14 , var_1_13)))))) && ((var_1_10 == (- (var_1_5 - var_1_12))) ? (var_1_15 == ((unsigned char) (max ((var_1_16 + 8) , 50)))) : (var_1_15 == ((unsigned char) 25)))) && ((var_1_10 >= ((var_1_5 + var_1_4) + var_1_13)) ? (var_1_17 == ((signed short int) var_1_16)) : 1)) && (var_1_2 ? (var_1_18 == ((signed long int) var_1_16)) : ((var_1_10 == var_1_12) ? ((var_1_15 <= (var_1_17 % var_1_19)) ? (var_1_18 == ((signed long int) var_1_19)) : (var_1_18 == ((signed long int) var_1_16))) : 1))) && (((max (var_1_7 , (var_1_21 - last_1_var_1_20))) > (abs (var_1_1))) ? (var_1_20 == ((unsigned char) (min (var_1_16 , (max (1 , 5)))))) : (var_1_2 ? (var_1_20 == ((unsigned char) var_1_16)) : 1))
;
}
int main(void) {
	isInitial = 1;
