...
void step(void) {
	...
	// From: Req8Batch162100_while
	if (! (last_1_var_1_24 >= 4)) {
		var_1_24 = last_1_var_1_24;
	}


	// From: Req7Batch162100_while
