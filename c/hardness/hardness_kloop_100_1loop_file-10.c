...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch10100_1loop
	if (var_1_19) {
		if (var_1_21 || var_1_22) {
			var_1_20 = (max (var_1_11 , var_1_12));
		} else {
			if (var_1_21) {
				var_1_20 = var_1_7;
			}
	...
	// From: Req2Batch10100_1loop
	var_1_10 = (var_1_11 - var_1_6);


	// From: Req11Batch10100_1loop
	if (! var_1_19) {
	...
	// From: Req4Batch10100_1loop
	if (((var_1_8 - var_1_7) - (abs (var_1_14))) != var_1_5) {
	...
	// From: Req6Batch10100_1loop
	if (var_1_19 || var_1_21) {
		if (var_1_39 == (499.12f - (abs (var_1_15)))) {
			var_1_23 = (max ((min (var_1_18 , var_1_24)) , ((max (var_1_25 , var_1_26)) + var_1_27)));
		} else {
			var_1_23 = var_1_26;
		}
	}
	...
	// From: Req7Batch10100_1loop
	if (var_1_31 > var_1_9) {
		var_1_28 = (((var_1_29 - var_1_6) - (10u + var_1_5)) - var_1_13);
	}


	// From: Req8Batch10100_1loop
	signed short int stepLocal_2 = var_1_20;
	if (var_1_28 < stepLocal_2) {
		var_1_30 = (var_1_14 + (var_1_7 - (max (var_1_1 , var_1_9))));
	} else {
		var_1_30 = (max (var_1_14 , var_1_6));
	}
}
...
int property(void) {
	return ((((((((((((var_1_10 <= 32) ? ((var_1_23 < var_1_15) ? (var_1_1 == ((unsigned short int) (var_1_10 + var_1_5))) : 1) : (var_1_1 == ((unsigned short int) ((var_1_6 + (var_1_7 - var_1_10)) + (var_1_8 - var_1_9))))) && (var_1_10 == ((signed short int) (var_1_11 - var_1_6)))) && ((var_1_5 >= 4) ? ((! ((var_1_13 - last_1_var_1_35) <= 64)) ? (var_1_12 == ((unsigned char) var_1_14)) : (var_1_12 == ((unsigned char) 50))) : 1)) && ((((var_1_8 - var_1_7) - (abs (var_1_14))) != var_1_5) ? ((var_1_36 != (var_1_16 - var_1_17)) ? (var_1_15 == ((double) (1.0000000000002E12 - var_1_18))) : (var_1_19 ? (var_1_15 == ((double) var_1_18)) : 1)) : 1)) && (var_1_19 ? ((var_1_21 || var_1_22) ? (var_1_20 == ((signed short int) (max (var_1_11 , var_1_12)))) : (var_1_21 ? (var_1_20 == ((signed short int) var_1_7)) : 1)) : 1)) && ((var_1_19 || var_1_21) ? ((var_1_39 == (499.12f - (abs (var_1_15)))) ? (var_1_23 == ((float) (max ((min (var_1_18 , var_1_24)) , ((max (var_1_25 , var_1_26)) + var_1_27))))) : (var_1_23 == ((float) var_1_26))) : 1)) && ((var_1_31 > var_1_9) ? (var_1_28 == ((unsigned long int) (((var_1_29 - var_1_6) - (10u + var_1_5)) - var_1_13))) : 1)) && ((var_1_28 < var_1_20) ? (var_1_30 == ((signed short int) (var_1_14 + (var_1_7 - (max (var_1_1 , var_1_9)))))) : (var_1_30 == ((signed short int) (max (var_1_14 , var_1_6)))))) && ((var_1_35 < var_1_9) ? (var_1_22 ? (var_1_31 == ((unsigned char) (var_1_32 + (abs (var_1_33))))) : (var_1_31 == ((unsigned char) (var_1_34 - var_1_32)))) : (var_1_31 == ((unsigned char) 8)))) && (((var_1_39 * var_1_26) < var_1_27) ? (var_1_21 ? (var_1_19 ? ((var_1_20 < var_1_9) ? (var_1_35 == ((unsigned long int) var_1_5)) : (var_1_35 == ((unsigned long int) var_1_14))) : 1) : (var_1_35 == ((unsigned long int) var_1_1))) : (var_1_35 == ((unsigned long int) var_1_8)))) && ((! var_1_19) ? (var_1_36 == ((float) (var_1_26 + var_1_27))) : (var_1_36 == ((float) (min (var_1_37 , var_1_38)))))) && ((var_1_18 == var_1_15) ? ((8u <= var_1_7) ? (var_1_39 == ((double) (var_1_27 + (var_1_41 + var_1_42)))) : (var_1_39 == ((double) var_1_38))) : (var_1_39 == ((double) var_1_26)))
;
}
int main(void) {
	isInitial = 1;
