...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch116Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch116Amount100
	var_1_7 = ((max (var_1_8 , var_1_9)) + (min (var_1_10 , var_1_11)));


	// From: Req4Batch116Amount100
