...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13050_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch13050_while
	var_1_10 = (var_1_4 - 256);


	// From: Req5Batch13050_while
	...
	// From: Req6Batch13050_while
	var_1_18 = ((max ((abs (var_1_19)) , var_1_20)) + (min ((min (4 , var_1_21)) , var_1_22)));


	// From: Req7Batch13050_while
	signed char stepLocal_1 = var_1_17;
	if ((var_1_4 / (min (var_1_24 , var_1_25))) > stepLocal_1) {
		var_1_23 = var_1_6;
	}


	// From: Req8Batch13050_while
	var_1_26 = (min ((var_1_21 + 4u) , (var_1_10 + var_1_18)));


	// From: Req1Batch13050_while
