...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14550_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch14550_while
	var_1_16 = (min (var_1_17 , var_1_18));


	// From: Req5Batch14550_while
	if ((min ((var_1_18 >> var_1_20) , var_1_5)) < var_1_17) {
		var_1_19 = var_1_18;
	}


	// From: Req7Batch14550_while
	var_1_23 = (var_1_24 - var_1_7);


	// From: Req1Batch14550_while
	if (var_1_25) {
...
int property(void) {
	return (((((((var_1_25 ? ((var_1_23 == var_1_16) ? (var_1_1 == ((signed short int) (((var_1_5 + var_1_6) + var_1_7) - (abs (abs (var_1_8)))))) : (var_1_1 == ((signed short int) (var_1_9 - var_1_6)))) : 1) && ((var_1_2 || var_1_11) ? (var_1_10 == ((signed long int) (max ((var_1_6 + var_1_1) , (var_1_9 + (var_1_5 - var_1_12)))))) : (var_1_10 == ((signed long int) (var_1_8 + var_1_7))))) && (((var_1_14 + var_1_15) > 10.5f) ? ((var_1_9 >= var_1_8) ? (var_1_13 == ((unsigned short int) (37936 - var_1_7))) : 1) : (var_1_13 == ((unsigned short int) 50)))) && (var_1_16 == ((unsigned char) (min (var_1_17 , var_1_18))))) && (((min ((var_1_18 >> var_1_20) , var_1_5)) < var_1_17) ? (var_1_19 == ((unsigned long int) var_1_18)) : 1)) && ((! var_1_25) ? (var_1_21 == ((unsigned char) (var_1_22 - var_1_20))) : (var_1_21 == ((unsigned char) var_1_17)))) && (var_1_23 == ((unsigned long int) (var_1_24 - var_1_7)))) && ((last_1_var_1_23 >= (last_1_var_1_21 + (var_1_17 - last_1_var_1_10))) ? ((var_1_5 >= var_1_18) ? ((var_1_14 == var_1_15) ? (var_1_25 == ((unsigned char) 0)) : (var_1_25 == ((unsigned char) var_1_26))) : (var_1_25 == ((unsigned char) var_1_26))) : (var_1_25 == ((unsigned char) var_1_27)))
;
}
int main(void) {
	isInitial = 1;
