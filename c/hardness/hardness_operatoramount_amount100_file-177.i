...
void step(void) {
 ...
 if (stepLocal_7 <= var_1_14) {
  if ((var_1_5 + var_1_4) < (63.25f * var_1_17)) {
   var_1_33 = (((((57861 - (var_1_35 - var_1_27))) > ((var_1_36 - ((((var_1_23) < (var_1_24)) ? (var_1_23) : (var_1_24)))))) ? ((57861 - (var_1_35 - var_1_27))) : ((var_1_36 - ((((var_1_23) < (var_1_24)) ? (var_1_23) : (var_1_24)))))));
  } else {
   var_1_33 = (var_1_23 + (((((var_1_35 - var_1_38)) > (((((var_1_27) < (var_1_37)) ? (var_1_27) : (var_1_37))))) ? ((var_1_35 - var_1_38)) : (((((var_1_27) < (var_1_37)) ? (var_1_27) : (var_1_37)))))));
  }
 } else {
  var_1_33 = var_1_35;
 }
 if (((((var_1_31) > ((9999999.4 + var_1_15))) ? (var_1_31) : ((9999999.4 + var_1_15)))) != var_1_7) {
  if (var_1_25) {
   var_1_19 = var_1_11;
  }
 }
 ...
 if (var_1_19 >= (var_1_14 - 4)) {
  var_1_13 = (((((var_1_8) > (var_1_7)) ? (var_1_8) : (var_1_7))) - var_1_6);
 } else {
  var_1_13 = var_1_15;
 }
}
...
int property(void) {
 return (((((((((((var_1_2 >= var_1_3) ? (var_1_1 == ((float) ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))) : (var_1_1 == ((float) ((((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6))) - var_1_7) + (((((7.25f - var_1_8)) > (var_1_9)) ? ((7.25f - var_1_8)) : (var_1_9))))))) && ((var_1_6 >= var_1_4) ? ((var_1_33 < var_1_19) ? (var_1_10 == ((signed char) (var_1_11 + ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))))) : (var_1_10 == ((signed char) var_1_12))) : (var_1_10 == ((signed char) ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))))) && ((var_1_19 >= (var_1_14 - 4)) ? (var_1_13 == ((float) (((((var_1_8) > (var_1_7)) ? (var_1_8) : (var_1_7))) - var_1_6))) : (var_1_13 == ((float) var_1_15)))) && (((2.8 / var_1_17) < (8.5 - (var_1_5 + var_1_6))) ? (var_1_16 == ((unsigned long int) var_1_18)) : 1)) && ((((((var_1_31) > ((9999999.4 + var_1_15))) ? (var_1_31) : ((9999999.4 + var_1_15)))) != var_1_7) ? (var_1_25 ? (var_1_19 == ((signed short int) var_1_11)) : 1) : 1)) && ((var_1_33 >= 10) ? (((var_1_33 / (var_1_22 - var_1_23)) != var_1_14) ? (var_1_21 == ((unsigned char) var_1_24)) : (var_1_21 == ((unsigned char) 32))) : (var_1_21 == ((unsigned char) var_1_24)))) && ((last_1_var_1_25 || last_1_var_1_32) ? (((last_1_var_1_16 + (var_1_27 + var_1_23)) < var_1_18) ? (var_1_25 == ((unsigned char) ((var_1_27 < var_1_18) || var_1_28))) : (var_1_25 == ((unsigned char) var_1_29))) : (var_1_25 == ((unsigned char) var_1_30)))) && ((var_1_7 < var_1_4) ? ((var_1_11 == var_1_16) ? (((var_1_38 ^ var_1_24) >= var_1_14) ? (var_1_31 == ((double) (var_1_9 + var_1_6))) : (var_1_31 == ((double) var_1_7))) : 1) : (var_1_31 == ((double) var_1_8)))) && ((var_1_6 >= (99.2f * var_1_5)) ? (((var_1_24 * var_1_16) <= var_1_16) ? (var_1_25 ? (var_1_32 == ((unsigned char) var_1_30)) : (var_1_32 == ((unsigned char) 0))) : (var_1_32 == ((unsigned char) var_1_28))) : 1)) && (((var_1_34 - var_1_23) <= var_1_14) ? (((var_1_5 + var_1_4) < (63.25f * var_1_17)) ? (var_1_33 == ((unsigned short int) (((((57861 - (var_1_35 - var_1_27))) > ((var_1_36 - ((((var_1_23) < (var_1_24)) ? (var_1_23) : (var_1_24)))))) ? ((57861 - (var_1_35 - var_1_27))) : ((var_1_36 - ((((var_1_23) < (var_1_24)) ? (var_1_23) : (var_1_24))))))))) : (var_1_33 == ((unsigned short int) (var_1_23 + (((((var_1_35 - var_1_38)) > (((((var_1_27) < (var_1_37)) ? (var_1_27) : (var_1_37))))) ? ((var_1_35 - var_1_38)) : (((((var_1_27) < (var_1_37)) ? (var_1_27) : (var_1_37)))))))))) : (var_1_33 == ((unsigned short int) var_1_35)))) && (var_1_38 == ((unsigned char) var_1_24))
;
}
int main(void) {
 isInitial = 1;
