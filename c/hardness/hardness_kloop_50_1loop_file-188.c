...
void step(void) {
	...
	// From: Req2Batch18850_1loop
	if (var_1_13 >= var_1_8) {
		var_1_10 = (min (var_1_6 , var_1_11));
	}


	// From: Req6Batch18850_1loop
	...
	// From: Req5Batch18850_1loop
	if (var_1_4) {
		var_1_15 = var_1_16;
	}


	// From: Req1Batch18850_1loop
	if (var_1_2 < var_1_3) {
