...
void step(void) {
 if (((*(var_1_3_Pointer)) * (*(var_1_12_Pointer))) != ((*(var_1_2_Pointer)) & (*(var_1_13_Pointer)))) {
  (*(var_1_11_Pointer)) = (((((*(var_1_14_Pointer))) > ((*(var_1_15_Pointer)))) ? ((*(var_1_14_Pointer))) : ((*(var_1_15_Pointer)))));
 } else {
  (*(var_1_11_Pointer)) = (100 + (*(var_1_16_Pointer)));
 }
 if ((*(var_1_4_Pointer))) {
  (*(var_1_17_Pointer)) = (((((((((*(var_1_6_Pointer))) > ((*(var_1_10_Pointer)))) ? ((*(var_1_6_Pointer))) : ((*(var_1_10_Pointer)))))) > ((*(var_1_7_Pointer)))) ? ((((((*(var_1_6_Pointer))) > ((*(var_1_10_Pointer)))) ? ((*(var_1_6_Pointer))) : ((*(var_1_10_Pointer)))))) : ((*(var_1_7_Pointer)))));
 }
 ...
 if (stepLocal_1 || (*(var_1_4_Pointer))) {
  if ((*(var_1_11_Pointer)) > stepLocal_0) {
   if (! ((*(var_1_3_Pointer)) > (*(var_1_11_Pointer)))) {
    (*(var_1_1_Pointer)) = ((((((*(var_1_5_Pointer))) > (((*(var_1_6_Pointer)) - (*(var_1_7_Pointer))))) ? ((*(var_1_5_Pointer))) : (((*(var_1_6_Pointer)) - (*(var_1_7_Pointer)))))) + (((*(var_1_8_Pointer)) + (*(var_1_9_Pointer))) + (*(var_1_10_Pointer))));
   } else {
...
int property(void) {
 return ((((((*(var_1_11_Pointer)) * -2) != (*(var_1_3_Pointer))) || (*(var_1_4_Pointer))) ? (((*(var_1_11_Pointer)) > (*(var_1_3_Pointer))) ? ((! ((*(var_1_3_Pointer)) > (*(var_1_11_Pointer)))) ? ((*(var_1_1_Pointer)) == ((float) ((((((*(var_1_5_Pointer))) > (((*(var_1_6_Pointer)) - (*(var_1_7_Pointer))))) ? ((*(var_1_5_Pointer))) : (((*(var_1_6_Pointer)) - (*(var_1_7_Pointer)))))) + (((*(var_1_8_Pointer)) + (*(var_1_9_Pointer))) + (*(var_1_10_Pointer)))))) : ((*(var_1_1_Pointer)) == ((float) (*(var_1_7_Pointer))))) : ((*(var_1_1_Pointer)) == ((float) (*(var_1_9_Pointer))))) : ((*(var_1_1_Pointer)) == ((float) (*(var_1_8_Pointer))))) && ((((*(var_1_3_Pointer)) * (*(var_1_12_Pointer))) != ((*(var_1_2_Pointer)) & (*(var_1_13_Pointer)))) ? ((*(var_1_11_Pointer)) == ((unsigned char) (((((*(var_1_14_Pointer))) > ((*(var_1_15_Pointer)))) ? ((*(var_1_14_Pointer))) : ((*(var_1_15_Pointer))))))) : ((*(var_1_11_Pointer)) == ((unsigned char) (100 + (*(var_1_16_Pointer))))))) && ((*(var_1_4_Pointer)) ? ((*(var_1_17_Pointer)) == ((float) (((((((((*(var_1_6_Pointer))) > ((*(var_1_10_Pointer)))) ? ((*(var_1_6_Pointer))) : ((*(var_1_10_Pointer)))))) > ((*(var_1_7_Pointer)))) ? ((((((*(var_1_6_Pointer))) > ((*(var_1_10_Pointer)))) ? ((*(var_1_6_Pointer))) : ((*(var_1_10_Pointer)))))) : ((*(var_1_7_Pointer))))))) : 1)
;
}
int main(void) {
 isInitial = 1;
