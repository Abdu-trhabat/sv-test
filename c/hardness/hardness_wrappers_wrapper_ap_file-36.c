...
void step(void) {
	...
	if (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) >> 16u) < (abs ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))) {
	...
	if ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) > (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) {
		...
		(*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) = (max ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) , (max ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))))));
	}
	...
	if (stepLocal_0 && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
		if ((max ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) , (- (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer))))) != (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) {
