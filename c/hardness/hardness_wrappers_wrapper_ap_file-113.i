...
void step(void) {
 ...
 if ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var3_Pointer)) >= stepLocal_0) {
  (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var5_Pointer)) = ((((128) < ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)))) ? (128) : ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)))));
 } else {
  (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var5_Pointer)) = ((((((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)) + (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)))) < ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)))) ? (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)) + (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)))) : ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var4_Pointer)))));
 }
