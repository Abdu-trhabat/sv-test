...
void step(void) {
 ...
 if (stepLocal_0 || ((- 4.4f) >= var_1_9)) {
  var_1_8 = (var_1_4 - (var_1_10 - ((((var_1_11) < (var_1_12)) ? (var_1_11) : (var_1_12)))));
 } else {
  if (var_1_6) {
   var_1_8 = var_1_12;
  } else {
...
int property(void) {
 return (((var_1_1 == ((unsigned long int) (var_1_2 - (var_1_3 - var_1_4)))) && (((var_1_4 < var_1_2) || var_1_6) ? (var_1_5 == ((unsigned long int) (((((((((var_1_2) < 0 ) ? -(var_1_2) : (var_1_2)))) > (3934615513u)) ? (((((var_1_2) < 0 ) ? -(var_1_2) : (var_1_2)))) : (3934615513u))) - var_1_4))) : (var_1_5 == ((unsigned long int) var_1_7)))) && (((var_1_5 > 1000000000u) || ((- 4.4f) >= var_1_9)) ? (var_1_8 == ((signed long int) (var_1_4 - (var_1_10 - ((((var_1_11) < (var_1_12)) ? (var_1_11) : (var_1_12))))))) : (var_1_6 ? (var_1_8 == ((signed long int) var_1_12)) : (var_1_8 == ((signed long int) var_1_11))))) && ((var_1_7 >= var_1_2) ? (var_1_6 ? (var_1_13 == ((signed short int) ((((var_1_14) < (var_1_15)) ? (var_1_14) : (var_1_15))))) : 1) : (var_1_13 == ((signed short int) (var_1_16 + var_1_17))))
;
}
int main(void) {
 isInitial = 1;
