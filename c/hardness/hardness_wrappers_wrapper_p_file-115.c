...
void step(void) {
	// From: Req1Batch115Wrapper_P
	if (((*(var_1_2_Pointer)) * last_1_var_1_1) >= (max ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer))))) {
	...
	// From: Req3Batch115Wrapper_P
	(*(var_1_12_Pointer)) = (min (((*(var_1_13_Pointer)) - (abs ((*(var_1_14_Pointer))))) , (*(var_1_15_Pointer))));


	// From: Req4Batch115Wrapper_P
