...
void functionized0(double functionized0_localFunctionVar0, signed long int functionized0_localFunctionVar1, signed long int localFunctionVar2) {
	if (var_1_3 <= functionized0_localFunctionVar0) {
		var_1_1 = ((max (localFunctionVar2 , functionized0_localFunctionVar1)) - var_1_5);
	} else {
...
void functionized2(unsigned char functionized2_localFunctionVar0, signed short int functionized2_localFunctionVar1) {
	if ((- 16.75) <= var_1_12) {
		...
		var_1_13 = (max (var_1_9 , functionized2_localFunctionVar0));
	}
}
...
void step(void) {
	// From: Req1Batch157functionizing
	if (var_1_2 < var_1_3) {
	...
	// From: Req2Batch157functionizing
	functionized1();


	// From: Req3Batch157functionizing
	if (((var_1_5 / var_1_10) < var_1_1) && var_1_7) {
		var_1_9 = 32;
	}


	// From: Req4Batch157functionizing
	var_1_11 = 199.4;


	// From: Req5Batch157functionizing
	if (((var_1_11 * var_1_3) > var_1_2) && (var_1_10 != var_1_1)) {
		var_1_12 = 32.75f;
	}


	// From: Req6Batch157functionizing
	functionized2(var_1_10, var_1_14);


	// From: Req7Batch157functionizing
	...
	// From: Req8Batch157functionizing
	var_1_21 = var_1_6;


	// From: Req9Batch157functionizing
	var_1_22 = var_1_18;
}
