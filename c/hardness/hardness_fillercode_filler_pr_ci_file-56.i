 ...
 signed long int stepLocal_1 = (((((var_1_6)) < (( ((var_1_8) / (256))))) ? ((var_1_6)) : (( ((var_1_8) / (256))))));
  ...
  50
   ...
   10
                   ...
                   if ( (! ( ((var_1_21) > ( ((var_1_33) + (var_1_32))))))) {
                    if ( ((var_1_5) && (var_1_1))) {
                     var_1_39 = (
                      ((((((((( var_1_17 )) < (( var_1_9 ))) ? (( var_1_17 )) : (( var_1_9 ))))) < 0 ) ? -(((((( var_1_17 )) < (( var_1_9 ))) ? (( var_1_17 )) : (( var_1_9 ))))) : (((((( var_1_17 )) < (( var_1_9 ))) ? (( var_1_17 )) : (( var_1_9 )))))))
   );
  }
 } else {
                    var_1_39 = (
