...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch146Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch146Amount100
	if (var_1_14) {
		var_1_15 = (! var_1_16);
	}


	// From: Req5Batch146Amount100
