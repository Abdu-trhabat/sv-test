...
void step(void) {
	...
	// From: Req12Batch122Amount250
	unsigned long int stepLocal_7 = max (last_1_var_1_58 , last_1_var_1_25);
	if ((max (25 , var_1_10)) > stepLocal_7) {
		var_1_39 = (max (var_1_12 , var_1_14));
	} else {
		var_1_39 = (var_1_36 + var_1_12);
	}


	// From: Req4Batch122Amount250
	signed long int stepLocal_1 = last_1_var_1_9 * (max (var_1_12 , var_1_14));
	...
	// From: Req7Batch122Amount250
	var_1_30 = (var_1_7 + var_1_21);


	// From: Req13Batch122Amount250
	unsigned char stepLocal_10 = var_1_38;
	unsigned short int stepLocal_9 = var_1_36;
	unsigned char stepLocal_8 = var_1_38;
	if (((var_1_14 / 64) / (max (var_1_11 , var_1_28))) <= stepLocal_8) {
		var_1_40 = (var_1_28 + var_1_29);
	} else {
		if ((- (var_1_38 - var_1_29)) < stepLocal_9) {
			var_1_40 = (min (64 , var_1_12));
		} else {
			if (var_1_11 >= stepLocal_10) {
				var_1_40 = ((max (var_1_14 , (min (var_1_10 , var_1_11)))) + var_1_28);
			} else {
				var_1_40 = (var_1_12 - ((max (var_1_13 , var_1_14)) - (16 + var_1_28)));
			}
		}
	}


	// From: Req14Batch122Amount250
	if (var_1_17) {
		if (var_1_42) {
	...
	// From: Req18Batch122Amount250
	unsigned char stepLocal_13 = var_1_43;
	if ((max (var_1_30 , var_1_33)) != var_1_20) {
		if (stepLocal_13 && var_1_17) {
			if (var_1_8 != (- (- var_1_7))) {
				var_1_50 = (min ((min (var_1_28 , var_1_36)) , var_1_12));
			} else {
				var_1_50 = (var_1_51 + (max (-10 , var_1_48)));
			}
		}
	}


	// From: Req20Batch122Amount250
	if (! var_1_41) {
		var_1_54 = (max (256 , var_1_38));
	}


	// From: Req21Batch122Amount250
	if (var_1_4 < var_1_21) {
		var_1_55 = (max (var_1_32 , var_1_19));
	}


	// From: Req22Batch122Amount250
	if (var_1_41) {
		var_1_56 = 1;
	}


	// From: Req23Batch122Amount250
	if (var_1_41) {
		var_1_57 = var_1_21;
	}


	// From: Req19Batch122Amount250
	if (var_1_11 <= var_1_47) {
		if (! var_1_41) {
			var_1_52 = (max ((min (var_1_36 , (64u + var_1_48))) , var_1_39));
		} else {
			var_1_52 = (var_1_53 - var_1_39);
		}
	} else {
		var_1_52 = (min ((var_1_53 - var_1_22) , var_1_58));
	}


	// From: Req8Batch122Amount250
	unsigned long int stepLocal_3 = var_1_52;
	if (var_1_12 == stepLocal_3) {
		if (((min (var_1_7 , var_1_18)) - var_1_6) > 63.8) {
	...
	if (var_1_6 < (- (var_1_31 / 100.75))) {
		...
		if ((var_1_39 <= var_1_10) || var_1_41) {
			if ((var_1_8 - (var_1_7 + var_1_18)) <= (var_1_6 - (var_1_19 + var_1_20))) {
				var_1_15 = ((min ((min (var_1_20 , 31.5f)) , var_1_8)) - var_1_6);
			}
		} else {
	...
	// From: Req5Batch122Amount250
	if ((abs (256)) <= ((-50 + var_1_24) / (max (var_1_12 , var_1_13)))) {
		var_1_25 = (var_1_40 + var_1_10);
	} else {
		var_1_25 = (min (var_1_14 , var_1_11));
	}


	// From: Req6Batch122Amount250
	unsigned short int stepLocal_2 = var_1_12;
	if (var_1_15 <= (var_1_1 + var_1_4)) {
		if (var_1_14 != stepLocal_2) {
			var_1_26 = (((max (var_1_11 , var_1_10)) + 25) - (var_1_28 - var_1_29));
		} else {
			var_1_26 = var_1_11;
		}
	} else {
	...
	// From: Req10Batch122Amount250
	unsigned char stepLocal_4 = (var_1_29 + var_1_25) < var_1_12;
	if (var_1_7 < var_1_18) {
		if (stepLocal_4 || (128 <= -32)) {
			if (var_1_41) {
				var_1_35 = (abs (min (var_1_36 , var_1_12)));
			}
		}
	}


	// From: Req11Batch122Amount250
	unsigned long int stepLocal_6 = min (var_1_45 , var_1_11);
	unsigned long int stepLocal_5 = var_1_38 - (min (var_1_28 , var_1_10));
	if (! var_1_41) {
		var_1_37 = (min ((var_1_8 - var_1_7) , var_1_20));
	} else {
		if (stepLocal_6 == var_1_12) {
			var_1_37 = ((min ((var_1_21 - var_1_8) , var_1_7)) + var_1_33);
		} else {
			if (stepLocal_5 < (500u ^ var_1_36)) {
				var_1_37 = (max (var_1_18 , var_1_5));
			} else {
				var_1_37 = (abs (var_1_19));
			}
		}
	}


	// From: Req16Batch122Amount250
	unsigned long int stepLocal_11 = var_1_25;
	if (stepLocal_11 > (var_1_24 / var_1_28)) {
		var_1_46 = (((abs (1)) + (max (var_1_11 , var_1_10))) + (max (var_1_29 , var_1_28)));
	} else {
		var_1_46 = ((max (var_1_47 , var_1_48)) - var_1_11);
	}


	// From: Req17Batch122Amount250
	unsigned long int stepLocal_12 = var_1_52;
	if (stepLocal_12 >= var_1_39) {
		var_1_49 = (max (var_1_38 , var_1_48));
	}


	// From: Req9Batch122Amount250
	if (var_1_41) {
		if (16 != (var_1_52 * var_1_10)) {
			var_1_34 = var_1_33;
		} else {
			if ((var_1_22 + var_1_39) < ((min (var_1_14 , var_1_24)) << var_1_27)) {
	...
	// From: Req2Batch122Amount250
	signed long int stepLocal_0 = 10000;
	if (((64 << var_1_10) >> var_1_11) > stepLocal_0) {
		if (! (var_1_7 < (var_1_8 + var_1_34))) {
			var_1_9 = (var_1_12 - ((max (var_1_13 , var_1_14)) - var_1_10));
		}
	} else {
		var_1_9 = (abs (max (var_1_11 , var_1_10)));
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((last_1_var_1_37 <= last_1_var_1_31) ? (var_1_1 == ((double) (max (var_1_4 , var_1_5)))) : (var_1_1 == ((double) (var_1_6 - ((2.5684615569228887E18 + var_1_7) - var_1_8))))) && ((((64 << var_1_10) >> var_1_11) > 10000) ? ((! (var_1_7 < (var_1_8 + var_1_34))) ? (var_1_9 == ((unsigned short int) (var_1_12 - ((max (var_1_13 , var_1_14)) - var_1_10)))) : 1) : (var_1_9 == ((unsigned short int) (abs (max (var_1_11 , var_1_10))))))) && ((var_1_6 < (- (var_1_31 / 100.75))) ? (var_1_15 == ((float) (var_1_6 - (var_1_7 + var_1_8)))) : (((var_1_39 <= var_1_10) || var_1_41) ? (((var_1_8 - (var_1_7 + var_1_18)) <= (var_1_6 - (var_1_19 + var_1_20))) ? (var_1_15 == ((float) ((min ((min (var_1_20 , 31.5f)) , var_1_8)) - var_1_6))) : 1) : (var_1_15 == ((float) ((var_1_7 - (var_1_21 - 127.125f)) + 31.8f)))))) && (((256 >> var_1_11) != (last_1_var_1_9 * (max (var_1_12 , var_1_14)))) ? (var_1_22 == ((signed long int) (var_1_10 - (var_1_11 + last_1_var_1_9)))) : (((- last_1_var_1_1) < var_1_4) ? (var_1_22 == ((signed long int) (((var_1_24 - var_1_11) - var_1_13) + last_1_var_1_9))) : (var_1_22 == ((signed long int) (var_1_11 - var_1_10)))))) && (((abs (256)) <= ((-50 + var_1_24) / (max (var_1_12 , var_1_13)))) ? (var_1_25 == ((unsigned long int) (var_1_40 + var_1_10))) : (var_1_25 == ((unsigned long int) (min (var_1_14 , var_1_11)))))) && ((var_1_15 <= (var_1_1 + var_1_4)) ? ((var_1_14 != var_1_12) ? (var_1_26 == ((signed char) (((max (var_1_11 , var_1_10)) + 25) - (var_1_28 - var_1_29)))) : (var_1_26 == ((signed char) var_1_11))) : (var_1_26 == ((signed char) var_1_29)))) && (var_1_30 == ((float) (var_1_7 + var_1_21)))) && ((var_1_12 == var_1_52) ? ((((min (var_1_7 , var_1_18)) - var_1_6) > 63.8) ? (var_1_31 == ((float) (var_1_8 - var_1_32))) : (var_1_31 == ((float) 49.75f))) : (var_1_31 == ((float) (var_1_20 - (var_1_33 + var_1_7)))))) && (var_1_41 ? ((16 != (var_1_52 * var_1_10)) ? (var_1_34 == ((double) var_1_33)) : (((var_1_22 + var_1_39) < ((min (var_1_14 , var_1_24)) << var_1_27)) ? (var_1_34 == ((double) (var_1_21 + var_1_8))) : (var_1_34 == ((double) var_1_20)))) : 1)) && ((var_1_7 < var_1_18) ? ((((var_1_29 + var_1_25) < var_1_12) || (128 <= -32)) ? (var_1_41 ? (var_1_35 == ((unsigned short int) (abs (min (var_1_36 , var_1_12))))) : 1) : 1) : 1)) && ((! var_1_41) ? (var_1_37 == ((float) (min ((var_1_8 - var_1_7) , var_1_20)))) : (((min (var_1_45 , var_1_11)) == var_1_12) ? (var_1_37 == ((float) ((min ((var_1_21 - var_1_8) , var_1_7)) + var_1_33))) : (((var_1_38 - (min (var_1_28 , var_1_10))) < (500u ^ var_1_36)) ? (var_1_37 == ((float) (max (var_1_18 , var_1_5)))) : (var_1_37 == ((float) (abs (var_1_19)))))))) && (((max (25 , var_1_10)) > (max (last_1_var_1_58 , last_1_var_1_25))) ? (var_1_39 == ((unsigned long int) (max (var_1_12 , var_1_14)))) : (var_1_39 == ((unsigned long int) (var_1_36 + var_1_12))))) && ((((var_1_14 / 64) / (max (var_1_11 , var_1_28))) <= var_1_38) ? (var_1_40 == ((unsigned short int) (var_1_28 + var_1_29))) : (((- (var_1_38 - var_1_29)) < var_1_36) ? (var_1_40 == ((unsigned short int) (min (64 , var_1_12)))) : ((var_1_11 >= var_1_38) ? (var_1_40 == ((unsigned short int) ((max (var_1_14 , (min (var_1_10 , var_1_11)))) + var_1_28))) : (var_1_40 == ((unsigned short int) (var_1_12 - ((max (var_1_13 , var_1_14)) - (16 + var_1_28))))))))) && (var_1_17 ? (var_1_42 ? (var_1_41 == ((unsigned char) (var_1_43 && (! var_1_44)))) : 1) : 1)) && (var_1_41 ? (var_1_45 == ((unsigned short int) var_1_14)) : (var_1_45 == ((unsigned short int) var_1_28)))) && ((var_1_25 > (var_1_24 / var_1_28)) ? (var_1_46 == ((unsigned char) (((abs (1)) + (max (var_1_11 , var_1_10))) + (max (var_1_29 , var_1_28))))) : (var_1_46 == ((unsigned char) ((max (var_1_47 , var_1_48)) - var_1_11))))) && ((var_1_52 >= var_1_39) ? (var_1_49 == ((signed short int) (max (var_1_38 , var_1_48)))) : 1)) && (((max (var_1_30 , var_1_33)) != var_1_20) ? ((var_1_43 && var_1_17) ? ((var_1_8 != (- (- var_1_7))) ? (var_1_50 == ((signed long int) (min ((min (var_1_28 , var_1_36)) , var_1_12)))) : (var_1_50 == ((signed long int) (var_1_51 + (max (-10 , var_1_48)))))) : 1) : 1)) && ((var_1_11 <= var_1_47) ? ((! var_1_41) ? (var_1_52 == ((unsigned long int) (max ((min (var_1_36 , (64u + var_1_48))) , var_1_39)))) : (var_1_52 == ((unsigned long int) (var_1_53 - var_1_39)))) : (var_1_52 == ((unsigned long int) (min ((var_1_53 - var_1_22) , var_1_58)))))) && ((! var_1_41) ? (var_1_54 == ((signed short int) (max (256 , var_1_38)))) : 1)) && ((var_1_4 < var_1_21) ? (var_1_55 == ((float) (max (var_1_32 , var_1_19)))) : 1)) && (var_1_41 ? (var_1_56 == ((unsigned short int) 1)) : 1)) && (var_1_41 ? (var_1_57 == ((float) var_1_21)) : 1)) && ((last_1_var_1_41 || ((min (last_1_var_1_1 , last_1_var_1_34)) <= var_1_19)) ? (var_1_58 == ((unsigned short int) var_1_13)) : ((var_1_24 <= (var_1_14 & var_1_28)) ? (var_1_58 == ((unsigned short int) var_1_36)) : 1))
;
}
int main(void) {
	isInitial = 1;
