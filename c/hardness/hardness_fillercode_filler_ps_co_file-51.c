...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch51Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	/* 295L, 87L) */ if (/* 296L, 64L, 65L) */ ((/* 297L, 62L, 66L) */ ((var_1_8) % (/* 299L, 61L, 68L) */ (max (/* 299L, 61L, 68L) */ (var_1_27) , (var_1_28)))))) > (var_1_12))) {
		/* 303L, 86L) */ var_1_25 = (
			/* 306L, 85L) */ ((
				/* 307L, 83L) */ (max (
					/* 307L, 83L) */ (
	...
	// From: CodeObject4
	/* 361L, 181L) */ if (/* 362L, 147L, 148L) */ ((/* 363L, 144L, 149L) */ ((var_1_37) >= (var_1_12))) || (/* 366L, 146L, 152L) */ (! (0))))) {
		/* 368L, 163L) */ var_1_40 = (
			var_1_34
		);
	} else {
	...
	/* 419L, 293L) */ if (var_1_21) {
		...
		/* 429L, 291L) */ if (/* 430L, 274L, 275L) */ ((var_1_19) > (/* 432L, 273L, 277L) */ (abs (var_1_39))))) {
			/* 434L, 286L) */ var_1_45 = (
				var_1_34
			);
		} else {
