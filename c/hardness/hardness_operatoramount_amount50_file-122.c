...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch122Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch122Amount50
	var_1_18 = var_1_6;


	// From: Req4Batch122Amount50
	if (var_1_18 > var_1_12) {
		var_1_13 = var_1_6;
	}


	// From: Req1Batch122Amount50
	if ((- var_1_12) > 5) {
