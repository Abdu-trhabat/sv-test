...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch165100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch165100_while
	signed short int stepLocal_0 = var_1_6;
	if ((min ((max (200 , var_1_5)) , last_1_var_1_12)) > stepLocal_0) {
		var_1_12 = ((min (var_1_13 , (abs (var_1_5)))) - var_1_14);
	} else {
		var_1_12 = ((max ((max (var_1_15 , var_1_6)) , (var_1_16 + var_1_17))) + var_1_5);
	}


	// From: Req4Batch165100_while
	...
	if (stepLocal_1 && var_1_11) {
		if (var_1_16 < stepLocal_2) {
			...
			var_1_18 = (min ((max (var_1_5 , (var_1_14 - var_1_20))) , (max (var_1_13 , var_1_17))));
		}
	}


	// From: Req5Batch165100_while
	unsigned long int stepLocal_3 = (var_1_22 - var_1_14) + var_1_20;
	if (stepLocal_3 < (max (var_1_23 , var_1_24))) {
		var_1_21 = (min (-0.25 , var_1_25));
	} else {
		var_1_21 = var_1_25;
	}


	// From: Req6Batch165100_while
	var_1_26 = ((min (var_1_27 , (min (var_1_28 , var_1_29)))) + (1 - var_1_30));


	// From: Req9Batch165100_while
	if (var_1_9) {
	...
	// From: Req11Batch165100_while
	if (var_1_35 < (var_1_21 + (- var_1_10))) {
		var_1_37 = (var_1_20 - 50);
	} else {
		var_1_37 = ((var_1_20 - var_1_30) + ((abs (var_1_16)) + var_1_17));
	}


	// From: Req12Batch165100_while
	var_1_38 = var_1_20;


	// From: Req8Batch165100_while
	...
	// From: Req7Batch165100_while
	if (var_1_9 || ((var_1_14 - 200) != (var_1_13 - var_1_30))) {
		var_1_31 = (min (var_1_15 , ((var_1_28 + var_1_1) + var_1_29)));
	} else {
...
int property(void) {
	return (((((((((((((var_1_2 - 63.5) >= (min (var_1_3 , var_1_4))) ? (var_1_1 == ((signed short int) (var_1_5 + (var_1_6 + 100)))) : ((var_1_7 && var_1_8) ? (var_1_1 == ((signed short int) var_1_6)) : 1)) && ((last_1_var_1_36 < (var_1_2 - var_1_10)) ? (var_1_8 ? (var_1_9 == ((unsigned char) (! var_1_11))) : 1) : (var_1_9 == ((unsigned char) var_1_11)))) && (((min ((max (200 , var_1_5)) , last_1_var_1_12)) > var_1_6) ? (var_1_12 == ((signed short int) ((min (var_1_13 , (abs (var_1_5)))) - var_1_14))) : (var_1_12 == ((signed short int) ((max ((max (var_1_15 , var_1_6)) , (var_1_16 + var_1_17))) + var_1_5))))) && ((var_1_9 && var_1_11) ? ((var_1_16 < var_1_13) ? (var_1_18 == ((signed short int) var_1_19)) : (var_1_18 == ((signed short int) (min ((max (var_1_5 , (var_1_14 - var_1_20))) , (max (var_1_13 , var_1_17))))))) : 1)) && ((((var_1_22 - var_1_14) + var_1_20) < (max (var_1_23 , var_1_24))) ? (var_1_21 == ((double) (min (-0.25 , var_1_25)))) : (var_1_21 == ((double) var_1_25)))) && (var_1_26 == ((signed char) ((min (var_1_27 , (min (var_1_28 , var_1_29)))) + (1 - var_1_30))))) && ((var_1_9 || ((var_1_14 - 200) != (var_1_13 - var_1_30))) ? (var_1_31 == ((signed long int) (min (var_1_15 , ((var_1_28 + var_1_1) + var_1_29))))) : (((128u >= var_1_22) || var_1_9) ? (var_1_31 == ((signed long int) var_1_27)) : (var_1_31 == ((signed long int) var_1_28))))) && ((var_1_17 >= (var_1_28 ^ var_1_37)) ? (var_1_32 == ((signed char) (16 - var_1_30))) : 1)) && (var_1_9 ? (var_1_33 == ((float) (199.6f - (var_1_34 - var_1_35)))) : (var_1_33 == ((float) var_1_35)))) && (((var_1_37 & var_1_31) > var_1_15) ? ((var_1_1 > var_1_38) ? (var_1_36 == ((double) (var_1_35 + 31.4))) : (var_1_11 ? (var_1_36 == ((double) var_1_34)) : (var_1_36 == ((double) var_1_35)))) : (var_1_36 == ((double) var_1_25)))) && ((var_1_35 < (var_1_21 + (- var_1_10))) ? (var_1_37 == ((signed long int) (var_1_20 - 50))) : (var_1_37 == ((signed long int) ((var_1_20 - var_1_30) + ((abs (var_1_16)) + var_1_17)))))) && (var_1_38 == ((signed long int) var_1_20))
;
}
int main(void) {
	isInitial = 1;
