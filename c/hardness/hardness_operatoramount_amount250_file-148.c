...
void step(void) {
	// From: Req5Batch148Amount250
	if (((min (var_1_19 , var_1_20)) - var_1_21) < ((var_1_13 % var_1_22) * var_1_16)) {
		if (((min (var_1_10 , var_1_9)) - var_1_6) <= last_1_var_1_76) {
			var_1_18 = (var_1_19 - var_1_21);
		} else {
			if (var_1_2) {
				if (var_1_23) {
					var_1_18 = ((max (var_1_20 , var_1_24)) - var_1_21);
				}
			}
		}
	} else {
		if (var_1_25) {
			var_1_18 = (min (var_1_17 , 4));
		} else {
			var_1_18 = var_1_20;
		}
	}
	...
	// From: Req2Batch148Amount250
	var_1_11 = ((min (var_1_6 , var_1_9)) - var_1_8);


	// From: Req3Batch148Amount250
	var_1_12 = (abs (var_1_13));


	// From: Req7Batch148Amount250
	signed long int stepLocal_2 = var_1_13;
	if ((var_1_29 * var_1_18) < stepLocal_2) {
		if (var_1_2) {
			var_1_35 = (((var_1_36 - var_1_37) - (10000 - var_1_38)) + (min (var_1_15 , var_1_39)));
		} else {
			var_1_35 = var_1_37;
		}
	}
	...
	// From: Req8Batch148Amount250
	if (var_1_16 <= var_1_37) {
		var_1_40 = 2;
	} else {
		var_1_40 = (min ((var_1_33 + var_1_36) , (abs (var_1_28))));
	}


	// From: Req11Batch148Amount250
	var_1_49 = (max (var_1_50 , var_1_51));


	// From: Req12Batch148Amount250
	if (((~ 5) + (var_1_39 * var_1_34)) > var_1_18) {
		var_1_52 = ((var_1_38 + var_1_53) + (var_1_46 + 32));
	}


	// From: Req13Batch148Amount250
	if (var_1_42 >= var_1_24) {
		if (var_1_12 <= var_1_51) {
			var_1_54 = (var_1_55 + (min (var_1_56 , var_1_57)));
		} else {
			if (var_1_25) {
				var_1_54 = (var_1_58 - 2);
			} else {
		...
		var_1_54 = (min (var_1_63 , (abs (var_1_64))));
	}


	// From: Req17Batch148Amount250
	if ((- var_1_7) <= ((var_1_74 - var_1_10) - var_1_8)) {
		var_1_73 = var_1_62;
	}


	// From: Req20Batch148Amount250
	var_1_78 = var_1_10;


	// From: Req21Batch148Amount250
	var_1_79 = var_1_72;


	// From: Req6Batch148Amount250
	signed long int stepLocal_1 = var_1_18;
	unsigned short int stepLocal_0 = var_1_21;
	if (stepLocal_1 < -128) {
		if (var_1_13 < stepLocal_0) {
			if (var_1_79 >= (var_1_7 / (min (var_1_8 , 8.2)))) {
				var_1_26 = (max ((max (var_1_21 , (max (var_1_28 , var_1_29)))) , (min ((max (5 , var_1_30)) , var_1_31))));
			} else {
				var_1_26 = (var_1_32 - var_1_21);
			}
		} else {
			var_1_26 = (max (var_1_21 , (abs (var_1_33 + var_1_34))));
		}
	} else {
	...
	// From: Req1Batch148Amount250
	if (var_1_78 > var_1_79) {
		if (var_1_78 >= (var_1_5 - (abs (var_1_79)))) {
	...
	// From: Req4Batch148Amount250
	if (var_1_9 > var_1_78) {
		var_1_14 = (max ((var_1_15 + 8) , (min ((max (-64 , var_1_16)) , var_1_17))));
	}


	// From: Req10Batch148Amount250
	if (var_1_43 > 5) {
		if (var_1_25 && var_1_23) {
			var_1_45 = ((var_1_36 - (var_1_46 - var_1_37)) + var_1_15);
		} else {
			if ((abs (var_1_1 + var_1_10)) > (var_1_6 - var_1_9)) {
				var_1_45 = var_1_48;
			} else {
				var_1_45 = (var_1_46 - (max (var_1_37 , 100)));
			}
		}
	}


	// From: Req14Batch148Amount250
	unsigned short int stepLocal_3 = var_1_73;
	if (var_1_40 <= stepLocal_3) {
		if (! var_1_2) {
			var_1_65 = (min (var_1_60 , var_1_30));
		} else {
	...
	if (var_1_22 >= stepLocal_5) {
		var_1_69 = (max (var_1_17 , var_1_59));
	} else {
		if (var_1_2 || stepLocal_6) {
			if ((- 2.5) >= (- var_1_78)) {
				...
				if (var_1_21 >= stepLocal_4) {
					var_1_69 = (min ((var_1_70 + 10) , (var_1_62 - var_1_53)));
				}
			}
		} else {
			var_1_69 = (max ((var_1_61 + (var_1_52 + var_1_53)) , (max (var_1_55 , (var_1_64 - var_1_36)))));
		}
	}


	// From: Req16Batch148Amount250
	unsigned char stepLocal_8 = var_1_5 >= (min (var_1_79 , var_1_76));
	...
	if ((var_1_79 * var_1_8) != 4.8) {
		if (var_1_2 || stepLocal_8) {
			...
			var_1_71 = (abs (var_1_8 + (var_1_7 - var_1_10)));
		}
	} else {
		if (stepLocal_7 || (var_1_66 >= 2u)) {
			var_1_71 = ((var_1_6 - var_1_72) - ((min (var_1_8 , var_1_7)) + var_1_10));
		}
	}


	// From: Req18Batch148Amount250
	if ((- var_1_11) >= (- var_1_8)) {
		if (! (var_1_76 <= var_1_5)) {
			var_1_75 = var_1_37;
		} else {
	...
	// From: Req9Batch148Amount250
	if ((min (var_1_22 , var_1_36)) >= var_1_65) {
		if (var_1_23 || (! var_1_2)) {
			if (var_1_25) {
				var_1_41 = (min (var_1_31 , ((var_1_42 + var_1_43) - (min (var_1_37 , var_1_44)))));
			} else {
				if ((var_1_33 % (3361636999u - var_1_42)) <= var_1_32) {
					var_1_41 = (abs (var_1_34 + (var_1_42 - var_1_37)));
				}
			}
		}
	} else {
...
int property(void) {
	return (((((((((((((((((((((var_1_78 > var_1_79) ? ((var_1_78 >= (var_1_5 - (abs (var_1_79)))) ? (var_1_1 == ((double) ((var_1_6 - (var_1_7 + 255.5)) - ((var_1_8 - var_1_9) + var_1_10)))) : 1) : (var_1_1 == ((double) (min ((min (var_1_10 , (49.5 + var_1_8))) , var_1_9))))) && (var_1_11 == ((double) ((min (var_1_6 , var_1_9)) - var_1_8)))) && (var_1_12 == ((signed long int) (abs (var_1_13))))) && ((var_1_9 > var_1_78) ? (var_1_14 == ((signed short int) (max ((var_1_15 + 8) , (min ((max (-64 , var_1_16)) , var_1_17)))))) : 1)) && ((((min (var_1_19 , var_1_20)) - var_1_21) < ((var_1_13 % var_1_22) * var_1_16)) ? ((((min (var_1_10 , var_1_9)) - var_1_6) <= last_1_var_1_76) ? (var_1_18 == ((signed long int) (var_1_19 - var_1_21))) : (var_1_2 ? (var_1_23 ? (var_1_18 == ((signed long int) ((max (var_1_20 , var_1_24)) - var_1_21))) : 1) : 1)) : (var_1_25 ? (var_1_18 == ((signed long int) (min (var_1_17 , 4)))) : (var_1_18 == ((signed long int) var_1_20))))) && ((var_1_18 < -128) ? ((var_1_13 < var_1_21) ? ((var_1_79 >= (var_1_7 / (min (var_1_8 , 8.2)))) ? (var_1_26 == ((unsigned short int) (max ((max (var_1_21 , (max (var_1_28 , var_1_29)))) , (min ((max (5 , var_1_30)) , var_1_31)))))) : (var_1_26 == ((unsigned short int) (var_1_32 - var_1_21)))) : (var_1_26 == ((unsigned short int) (max (var_1_21 , (abs (var_1_33 + var_1_34))))))) : (var_1_26 == ((unsigned short int) (var_1_33 + var_1_21))))) && (((var_1_29 * var_1_18) < var_1_13) ? (var_1_2 ? (var_1_35 == ((signed short int) (((var_1_36 - var_1_37) - (10000 - var_1_38)) + (min (var_1_15 , var_1_39))))) : (var_1_35 == ((signed short int) var_1_37))) : 1)) && ((var_1_16 <= var_1_37) ? (var_1_40 == ((unsigned short int) 2)) : (var_1_40 == ((unsigned short int) (min ((var_1_33 + var_1_36) , (abs (var_1_28)))))))) && (((min (var_1_22 , var_1_36)) >= var_1_65) ? ((var_1_23 || (! var_1_2)) ? (var_1_25 ? (var_1_41 == ((unsigned short int) (min (var_1_31 , ((var_1_42 + var_1_43) - (min (var_1_37 , var_1_44))))))) : (((var_1_33 % (3361636999u - var_1_42)) <= var_1_32) ? (var_1_41 == ((unsigned short int) (abs (var_1_34 + (var_1_42 - var_1_37))))) : 1)) : 1) : (var_1_41 == ((unsigned short int) var_1_43)))) && ((var_1_43 > 5) ? ((var_1_25 && var_1_23) ? (var_1_45 == ((signed short int) ((var_1_36 - (var_1_46 - var_1_37)) + var_1_15))) : (((abs (var_1_1 + var_1_10)) > (var_1_6 - var_1_9)) ? (var_1_45 == ((signed short int) var_1_48)) : (var_1_45 == ((signed short int) (var_1_46 - (max (var_1_37 , 100))))))) : 1)) && (var_1_49 == ((signed char) (max (var_1_50 , var_1_51))))) && ((((~ 5) + (var_1_39 * var_1_34)) > var_1_18) ? (var_1_52 == ((unsigned short int) ((var_1_38 + var_1_53) + (var_1_46 + 32)))) : 1)) && ((var_1_42 >= var_1_24) ? ((var_1_12 <= var_1_51) ? (var_1_54 == ((signed char) (var_1_55 + (min (var_1_56 , var_1_57))))) : (var_1_25 ? (var_1_54 == ((signed char) (var_1_58 - 2))) : (var_1_54 == ((signed char) ((var_1_59 + var_1_60) - ((var_1_61 + var_1_62) + (var_1_63 + var_1_64))))))) : (var_1_54 == ((signed char) (min (var_1_63 , (abs (var_1_64)))))))) && ((var_1_40 <= var_1_73) ? ((! var_1_2) ? (var_1_65 == ((unsigned long int) (min (var_1_60 , var_1_30)))) : (var_1_65 == ((unsigned long int) (var_1_66 - (var_1_67 - (var_1_68 - var_1_53)))))) : (var_1_65 == ((unsigned long int) ((var_1_67 - var_1_36) + (var_1_37 + 100000000u)))))) && ((var_1_22 >= var_1_26) ? (var_1_69 == ((signed short int) (max (var_1_17 , var_1_59)))) : ((var_1_2 || (var_1_61 < (var_1_12 * var_1_40))) ? (((- 2.5) >= (- var_1_78)) ? (var_1_69 == ((signed short int) (((var_1_36 - var_1_37) - (var_1_46 - var_1_38)) + (var_1_59 - (10000 - var_1_62))))) : ((var_1_21 >= var_1_31) ? (var_1_69 == ((signed short int) (min ((var_1_70 + 10) , (var_1_62 - var_1_53))))) : 1)) : (var_1_69 == ((signed short int) (max ((var_1_61 + (var_1_52 + var_1_53)) , (max (var_1_55 , (var_1_64 - var_1_36)))))))))) && (((var_1_79 * var_1_8) != 4.8) ? ((var_1_2 || (var_1_5 >= (min (var_1_79 , var_1_76)))) ? (var_1_71 == ((float) (var_1_10 + (var_1_7 - (var_1_9 + var_1_72))))) : (var_1_71 == ((float) (abs (var_1_8 + (var_1_7 - var_1_10)))))) : ((var_1_23 || (var_1_66 >= 2u)) ? (var_1_71 == ((float) ((var_1_6 - var_1_72) - ((min (var_1_8 , var_1_7)) + var_1_10)))) : 1))) && (((- var_1_7) <= ((var_1_74 - var_1_10) - var_1_8)) ? (var_1_73 == ((unsigned short int) var_1_62)) : 1)) && (((- var_1_11) >= (- var_1_8)) ? ((! (var_1_76 <= var_1_5)) ? (var_1_75 == ((unsigned short int) var_1_37)) : (var_1_75 == ((unsigned short int) var_1_29))) : (var_1_75 == ((unsigned short int) var_1_44)))) && ((((var_1_13 > var_1_18) && var_1_23) && (var_1_26 != var_1_44)) ? (var_1_76 == ((double) (var_1_10 + var_1_7))) : 1)) && (var_1_78 == ((double) var_1_10))) && (var_1_79 == ((double) var_1_72))
;
}
int main(void) {
	isInitial = 1;
