...
void step(void) {
	...
	if (var_1_14 <= (min (var_1_13 , var_1_16))) {
		if ((min (var_1_9 , (var_1_9 & var_1_5))) < stepLocal_3) {
			var_1_15 = var_1_6;
		} else {
			var_1_15 = (min ((min (var_1_7 , var_1_6)) , var_1_17));
		}
	} else {
		var_1_15 = var_1_6;
	}
...
int property(void) {
	return (((((var_1_2 + var_1_3) <= var_1_4) ? (var_1_1 == ((unsigned short int) ((var_1_5 + (var_1_6 + var_1_7)) - var_1_8))) : 1) && ((((10 > var_1_10) && var_1_11) || var_1_12) ? ((var_1_5 >= var_1_10) ? (var_1_9 == ((signed long int) var_1_8)) : 1) : (var_1_9 == ((signed long int) var_1_1)))) && ((var_1_9 != var_1_8) ? (var_1_13 == ((double) var_1_14)) : 1)) && ((var_1_14 <= (min (var_1_13 , var_1_16))) ? (((min (var_1_9 , (var_1_9 & var_1_5))) < var_1_8) ? (var_1_15 == ((signed short int) var_1_6)) : (var_1_15 == ((signed short int) (min ((min (var_1_7 , var_1_6)) , var_1_17))))) : (var_1_15 == ((signed short int) var_1_6)))
;
}
int main(void) {
	isInitial = 1;
