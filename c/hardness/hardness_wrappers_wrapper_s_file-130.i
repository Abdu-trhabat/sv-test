...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch130Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
 if ((WrapperStruct00.var_1_8 - ((((WrapperStruct00.var_1_9) > (WrapperStruct00.var_1_10)) ? (WrapperStruct00.var_1_9) : (WrapperStruct00.var_1_10)))) <= last_1_WrapperStruct00_var_1_14) {
  WrapperStruct00.var_1_7 = (((((WrapperStruct00.var_1_12) > (WrapperStruct00.var_1_13)) ? (WrapperStruct00.var_1_12) : (WrapperStruct00.var_1_13))) - 50);
 }
 signed long int stepLocal_3 = WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7;
 signed long int stepLocal_2 = WrapperStruct00.var_1_18 - (100 - WrapperStruct00.var_1_19);
 if (WrapperStruct00.var_1_15) {
  if (WrapperStruct00.var_1_12 <= stepLocal_3) {
   if (WrapperStruct00.var_1_16) {
    WrapperStruct00.var_1_14 = WrapperStruct00.var_1_17;
   } else {
    if (stepLocal_2 <= WrapperStruct00.var_1_7) {
     WrapperStruct00.var_1_14 = (WrapperStruct00.var_1_20 + WrapperStruct00.var_1_21);
    } else {
     WrapperStruct00.var_1_14 = WrapperStruct00.var_1_17;
    }
   }
 ...
 signed long int stepLocal_1 = WrapperStruct00.var_1_2 & WrapperStruct00.var_1_3;
 signed long int stepLocal_0 = WrapperStruct00.var_1_4;
 if (stepLocal_1 <= (WrapperStruct00.var_1_4 / ((((-25) < (WrapperStruct00.var_1_5)) ? (-25) : (WrapperStruct00.var_1_5))))) {
...
int property(void) {
 return ((((WrapperStruct00.var_1_2 & WrapperStruct00.var_1_3) <= (WrapperStruct00.var_1_4 / ((((-25) < (WrapperStruct00.var_1_5)) ? (-25) : (WrapperStruct00.var_1_5))))) ? (WrapperStruct00.var_1_1 == ((signed char) WrapperStruct00.var_1_6)) : ((WrapperStruct00.var_1_5 != WrapperStruct00.var_1_4) ? (WrapperStruct00.var_1_1 == ((signed char) WrapperStruct00.var_1_6)) : (WrapperStruct00.var_1_1 == ((signed char) 5)))) && (((WrapperStruct00.var_1_8 - ((((WrapperStruct00.var_1_9) > (WrapperStruct00.var_1_10)) ? (WrapperStruct00.var_1_9) : (WrapperStruct00.var_1_10)))) <= last_1_WrapperStruct00_var_1_14) ? (WrapperStruct00.var_1_7 == ((signed long int) (((((WrapperStruct00.var_1_12) > (WrapperStruct00.var_1_13)) ? (WrapperStruct00.var_1_12) : (WrapperStruct00.var_1_13))) - 50))) : 1)) && (WrapperStruct00.var_1_15 ? ((WrapperStruct00.var_1_12 <= (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7)) ? (WrapperStruct00.var_1_16 ? (WrapperStruct00.var_1_14 == ((double) WrapperStruct00.var_1_17)) : (((WrapperStruct00.var_1_18 - (100 - WrapperStruct00.var_1_19)) <= WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_14 == ((double) (WrapperStruct00.var_1_20 + WrapperStruct00.var_1_21))) : (WrapperStruct00.var_1_14 == ((double) WrapperStruct00.var_1_17)))) : (WrapperStruct00.var_1_14 == ((double) WrapperStruct00.var_1_20))) : (WrapperStruct00.var_1_14 == ((double) WrapperStruct00.var_1_20)))
;
}
int main(void) {
 isInitial = 1;
