...
void step(void) {
	// From: Req1Batch56Wrapper_A
	if ((signed_short_int_Array_0[1] >> signed_char_Array_0[0]) >= signed_long_int_Array_0[0]) {
		unsigned_char_Array_0[1][2] = (min (signed_char_Array_0[0] , (unsigned_char_Array_0[0][2] - (max (unsigned_char_Array_0[1][1] , unsigned_char_Array_0[1][0])))));
	} else {
		unsigned_char_Array_0[1][2] = ((min (unsigned_char_Array_0[1][1] , signed_char_Array_0[0])) + (min ((unsigned_char_Array_0[0][0] + 1) , unsigned_char_Array_0[1][0])));
	}


	// From: Req2Batch56Wrapper_A
