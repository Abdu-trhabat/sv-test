...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch108100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch108100_while
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req4Batch108100_while
	...
	// From: Req5Batch108100_while
	var_1_18 = var_1_11;


	// From: Req9Batch108100_while
	if (var_1_29) {
