...
void step(void) {
	// From: Req1Batch198Wrapper_SP
	signed long int stepLocal_0 = (*(WrapperStruct00_var_1_2_Pointer));
	if (stepLocal_0 >= (*(WrapperStruct00_var_1_4_Pointer))) {
		(*(WrapperStruct00_var_1_1_Pointer)) = (((min ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer)))) + 10.55) + (*(WrapperStruct00_var_1_7_Pointer)));
	}


	// From: Req2Batch198Wrapper_SP
	if ((*(WrapperStruct00_var_1_7_Pointer)) > 64.2) {
		(*(WrapperStruct00_var_1_8_Pointer)) = (*(WrapperStruct00_var_1_5_Pointer));
	}


	// From: Req3Batch198Wrapper_SP
	unsigned char stepLocal_1 = (*(WrapperStruct00_var_1_10_Pointer));
	if ((*(WrapperStruct00_var_1_3_Pointer)) || stepLocal_1) {
		(*(WrapperStruct00_var_1_9_Pointer)) = (min ((*(WrapperStruct00_var_1_11_Pointer)) , ((*(WrapperStruct00_var_1_12_Pointer)) - (*(WrapperStruct00_var_1_13_Pointer)))));
	} else {
		if ((*(WrapperStruct00_var_1_3_Pointer))) {
			(*(WrapperStruct00_var_1_9_Pointer)) = ((*(WrapperStruct00_var_1_14_Pointer)) + (max ((*(WrapperStruct00_var_1_15_Pointer)) , (max ((*(WrapperStruct00_var_1_16_Pointer)) , (*(WrapperStruct00_var_1_17_Pointer)))))));
		} else {
	...
	// From: Req4Batch198Wrapper_SP
	if ((*(WrapperStruct00_var_1_1_Pointer)) > (abs (max ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer)))))) {
		(*(WrapperStruct00_var_1_18_Pointer)) = (25 - (max (4 , (*(WrapperStruct00_var_1_13_Pointer)))));
	} else {
...
int property(void) {
	return (((((*(WrapperStruct00_var_1_2_Pointer)) >= (*(WrapperStruct00_var_1_4_Pointer))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((double) (((min ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer)))) + 10.55) + (*(WrapperStruct00_var_1_7_Pointer))))) : 1) && (((*(WrapperStruct00_var_1_7_Pointer)) > 64.2) ? ((*(WrapperStruct00_var_1_8_Pointer)) == ((float) (*(WrapperStruct00_var_1_5_Pointer)))) : 1)) && (((*(WrapperStruct00_var_1_3_Pointer)) || (*(WrapperStruct00_var_1_10_Pointer))) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed char) (min ((*(WrapperStruct00_var_1_11_Pointer)) , ((*(WrapperStruct00_var_1_12_Pointer)) - (*(WrapperStruct00_var_1_13_Pointer))))))) : ((*(WrapperStruct00_var_1_3_Pointer)) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed char) ((*(WrapperStruct00_var_1_14_Pointer)) + (max ((*(WrapperStruct00_var_1_15_Pointer)) , (max ((*(WrapperStruct00_var_1_16_Pointer)) , (*(WrapperStruct00_var_1_17_Pointer))))))))) : (((*(WrapperStruct00_var_1_7_Pointer)) >= (*(WrapperStruct00_var_1_6_Pointer))) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed char) (*(WrapperStruct00_var_1_17_Pointer)))) : ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed char) (*(WrapperStruct00_var_1_16_Pointer)))))))) && (((*(WrapperStruct00_var_1_1_Pointer)) > (abs (max ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer)))))) ? ((*(WrapperStruct00_var_1_18_Pointer)) == ((signed short int) (25 - (max (4 , (*(WrapperStruct00_var_1_13_Pointer))))))) : ((*(WrapperStruct00_var_1_18_Pointer)) == ((signed short int) 32)))
;
}
int main(void) {
	isInitial = 1;
