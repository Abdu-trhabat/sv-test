...
void step(void) {
 ...
 if ((var_1_4 < var_1_1) || (var_1_2 <= var_1_5)) {
  if (var_1_6) {
   var_1_7 = var_1_2;
  }
 }
 ...
 if ((var_1_12 * var_1_7) > var_1_1) {
  var_1_15 = ((((var_1_13) > (var_1_12)) ? (var_1_13) : (var_1_12)));
 } else {
  var_1_15 = ((((((var_1_16 - var_1_9)) > (var_1_2)) ? ((var_1_16 - var_1_9)) : (var_1_2))) - 4);
 }
 if (var_1_6) {
  var_1_17 = ((((((((var_1_2) < (var_1_10)) ? (var_1_2) : (var_1_10)))) > (-25)) ? (((((var_1_2) < (var_1_10)) ? (var_1_2) : (var_1_10)))) : (-25)));
 } else {
  if (var_1_1 >= var_1_2) {
