...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17425_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch17425_while
	var_1_1 = (var_1_2 - (var_1_3 - var_1_4));


	// From: Req2Batch17425_while
	if (! var_1_6) {
		if (var_1_6) {
			var_1_5 = var_1_4;
		}
