...
void step(void) {
	// From: Req1Batch164no_floats
	var_1_1 = ((max ((var_1_2 - var_1_3) , var_1_4)) + (max (var_1_5 , (var_1_6 - var_1_7))));


	// From: Req2Batch164no_floats
	if (var_1_2 <= var_1_1) {
		var_1_8 = var_1_9;
	}


	// From: Req3Batch164no_floats
	if (var_1_11 >= var_1_8) {
		var_1_10 = ((var_1_12 + var_1_13) - 4);
	}


	// From: Req4Batch164no_floats
	signed long int stepLocal_1 = -128;
	unsigned char stepLocal_0 = var_1_15;
	if (last_1_var_1_14 <= stepLocal_1) {
		if (var_1_7 < 16) {
			var_1_14 = (abs (abs (var_1_12)));
		} else {
			var_1_14 = (min (var_1_12 , (var_1_10 + var_1_13)));
		}
	} else {
...
int property(void) {
	return ((((var_1_1 == ((signed long int) ((max ((var_1_2 - var_1_3) , var_1_4)) + (max (var_1_5 , (var_1_6 - var_1_7)))))) && ((var_1_2 <= var_1_1) ? (var_1_8 == ((signed char) var_1_9)) : 1)) && ((var_1_11 >= var_1_8) ? (var_1_10 == ((unsigned short int) ((var_1_12 + var_1_13) - 4))) : 1)) && ((last_1_var_1_14 <= -128) ? ((var_1_7 < 16) ? (var_1_14 == ((unsigned long int) (abs (abs (var_1_12))))) : (var_1_14 == ((unsigned long int) (min (var_1_12 , (var_1_10 + var_1_13)))))) : ((var_1_15 && (var_1_16 && var_1_17)) ? (var_1_14 == ((unsigned long int) (2673323511u - var_1_13))) : 1))) && (var_1_18 == ((signed long int) var_1_4))
;
}
int main(void) {
	isInitial = 1;
