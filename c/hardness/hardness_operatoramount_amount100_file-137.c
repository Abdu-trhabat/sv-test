...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch137Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch137Amount100
	if (! var_1_13) {
		var_1_15 = (max ((var_1_16 - var_1_17) , var_1_18));
	}


	// From: Req6Batch137Amount100
	...
	// From: Req10Batch137Amount100
	var_1_31 = (var_1_26 + (max ((var_1_23 - var_1_22) , (-5 + var_1_30))));


	// From: Req11Batch137Amount100
	...
	// From: Req12Batch137Amount100
	var_1_40 = var_1_18;


	// From: Req2Batch137Amount100
