...
void step(void) {
 ...
 if (var_1_3 > stepLocal_4) {
  if (stepLocal_3 <= (((((var_1_9) > (var_1_1)) ? (var_1_9) : (var_1_1))) << (var_1_13 - var_1_14))) {
