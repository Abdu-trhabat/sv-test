...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch94stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_1 = 10 << var_1_2;
 signed long int stepLocal_0 = -1000000000 + var_1_2;
