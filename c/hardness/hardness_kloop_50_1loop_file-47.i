...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4750_1loop.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_6 + last_1_var_1_8) > (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) + last_1_var_1_1)) {
  var_1_16 = (last_1_var_1_19 || var_1_17);
 } else {
  var_1_16 = var_1_18;
 }
 unsigned short int stepLocal_0 = var_1_5;
 if (stepLocal_0 >= (32796 - ((((var_1_6) < (var_1_9)) ? (var_1_6) : (var_1_9))))) {
  if (var_1_16) {
   var_1_8 = var_1_11;
  }
 }
 ...
 if (var_1_1 >= (((((var_1_4 * var_1_6)) > ((2 ^ var_1_1))) ? ((var_1_4 * var_1_6)) : ((2 ^ var_1_1))))) {
  var_1_22 = var_1_1;
 }
 unsigned short int stepLocal_2 = var_1_4;
 if (var_1_6 <= stepLocal_2) {
  if (var_1_16) {
   var_1_20 = (var_1_4 - ((((var_1_21 - var_1_22) < 0 ) ? -(var_1_21 - var_1_22) : (var_1_21 - var_1_22))));
  } else {
   var_1_20 = 16;
  }
 } else {
  var_1_20 = (var_1_4 - var_1_5);
 }
...
int property(void) {
 return (((((((var_1_2 >= (1.3 / var_1_3)) ? (var_1_1 == ((unsigned short int) ((var_1_4 - var_1_5) - var_1_6))) : (var_1_1 == ((unsigned short int) ((((var_1_7) < (var_1_4)) ? (var_1_7) : (var_1_4)))))) && ((var_1_5 >= (32796 - ((((var_1_6) < (var_1_9)) ? (var_1_6) : (var_1_9))))) ? (var_1_16 ? (var_1_8 == ((unsigned char) var_1_11)) : 1) : 1)) && (var_1_19 ? (((var_1_1 * var_1_7) < var_1_11) ? (var_1_12 == ((float) ((((((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) > (var_1_15)) ? (((((var_1_13) < (var_1_14)) ? (var_1_13) : (var_1_14)))) : (var_1_15))))) : 1) : (var_1_12 == ((float) var_1_14)))) && (((var_1_6 + last_1_var_1_8) > (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) + last_1_var_1_1)) ? (var_1_16 == ((unsigned char) (last_1_var_1_19 || var_1_17))) : (var_1_16 == ((unsigned char) var_1_18)))) && (var_1_16 ? (((var_1_1 < 64) || var_1_16) ? (var_1_19 == ((unsigned char) var_1_17)) : 1) : 1)) && ((var_1_6 <= var_1_4) ? (var_1_16 ? (var_1_20 == ((unsigned short int) (var_1_4 - ((((var_1_21 - var_1_22) < 0 ) ? -(var_1_21 - var_1_22) : (var_1_21 - var_1_22)))))) : (var_1_20 == ((unsigned short int) 16))) : (var_1_20 == ((unsigned short int) (var_1_4 - var_1_5))))) && ((var_1_1 >= (((((var_1_4 * var_1_6)) > ((2 ^ var_1_1))) ? ((var_1_4 * var_1_6)) : ((2 ^ var_1_1))))) ? (var_1_22 == ((unsigned long int) var_1_1)) : 1)
;
}
int main(void) {
 isInitial = 1;
