...
void step(void) {
	...
	// From: Req5Batch46normal
	if ((var_1_12 % (abs (var_1_4))) != -10) {
		var_1_19 = (min (4 , var_1_1));
	} else {
		var_1_19 = var_1_13;
	}


	// From: Req6Batch46normal
	if ((var_1_7 ^ var_1_6) >= var_1_13) {
		var_1_20 = (max (-5 , (abs (var_1_4))));
	}


	// From: Req7Batch46normal
	if (var_1_12 == var_1_1) {
		var_1_21 = ((max (var_1_5 , var_1_1)) + (var_1_22 - var_1_13));
	} else {
		var_1_21 = var_1_1;
	}


	// From: Req8Batch46normal
	var_1_23 = var_1_24;


	// From: Req9Batch46normal
	var_1_25 = 64;
}
...
int property(void) {
	return (((((((((var_1_2 && var_1_3) ? (var_1_1 == ((unsigned char) (var_1_4 - var_1_5))) : (var_1_1 == ((unsigned char) var_1_4))) && (var_1_6 == ((signed long int) (var_1_5 + var_1_4)))) && (((var_1_4 / var_1_8) != var_1_1) ? (var_1_7 == ((signed char) (min (((abs (var_1_9)) + var_1_10) , var_1_11)))) : (var_1_7 == ((signed char) (var_1_12 - var_1_13))))) && (((var_1_15 * (max (var_1_16 , var_1_17))) >= var_1_18) ? ((var_1_8 < ((var_1_5 << var_1_11) + (var_1_4 + var_1_1))) ? (var_1_14 == ((signed char) var_1_12)) : (var_1_14 == ((signed char) (var_1_9 + var_1_10)))) : 1)) && (((var_1_12 % (abs (var_1_4))) != -10) ? (var_1_19 == ((unsigned short int) (min (4 , var_1_1)))) : (var_1_19 == ((unsigned short int) var_1_13)))) && (((var_1_7 ^ var_1_6) >= var_1_13) ? (var_1_20 == ((signed long int) (max (-5 , (abs (var_1_4)))))) : 1)) && ((var_1_12 == var_1_1) ? (var_1_21 == ((unsigned short int) ((max (var_1_5 , var_1_1)) + (var_1_22 - var_1_13)))) : (var_1_21 == ((unsigned short int) var_1_1)))) && (var_1_23 == ((double) var_1_24))) && (var_1_25 == ((unsigned char) 64))
;
}
int main(void) {
	isInitial = 1;
