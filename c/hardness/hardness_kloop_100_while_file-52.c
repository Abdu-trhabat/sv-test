...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52100_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req12Batch52100_while
	if (last_1_var_1_20 <= (var_1_21 - var_1_3)) {
		if (last_1_var_1_8) {
			var_1_30 = (abs (var_1_2));
		} else {
			var_1_30 = (min (var_1_12 , var_1_2));
		}
	} else {
		var_1_30 = (max (var_1_22 , last_1_var_1_20));
	}


	// From: Req2Batch52100_while
	...
	// From: Req7Batch52100_while
	if (! ((- var_1_30) <= var_1_3)) {
		var_1_20 = ((var_1_21 - var_1_3) - var_1_22);
	}


	// From: Req1Batch52100_while
	...
	// From: Req8Batch52100_while
	if (! var_1_10) {
		var_1_23 = (max ((256.5f - var_1_24) , var_1_6));
	}


	// From: Req10Batch52100_while
	var_1_27 = (var_1_6 + var_1_7);


	// From: Req11Batch52100_while
	if (var_1_24 <= var_1_1) {
		var_1_28 = (abs ((abs (var_1_7)) + var_1_6));
	} else {
		var_1_28 = (var_1_24 - var_1_29);
	}


	// From: Req5Batch52100_while
	if (! var_1_8) {
...
int property(void) {
	return (((((((((((((((var_1_2 >> var_1_3) | var_1_30) >= 10) ? (var_1_1 == ((float) ((min (var_1_5 , var_1_6)) + var_1_7))) : (var_1_1 == ((float) (abs (var_1_5 + var_1_7))))) && (((-2 / -10000000) != ((var_1_3 + var_1_30) + var_1_2)) ? (var_1_8 == ((unsigned char) (var_1_9 || var_1_10))) : 1)) && ((! (! var_1_8)) ? (var_1_11 == ((unsigned short int) ((var_1_3 + 128) + var_1_2))) : (var_1_11 == ((unsigned short int) (((min (var_1_12 , var_1_13)) - var_1_3) - var_1_2))))) && (((var_1_25 / 24.5) <= var_1_25) ? (var_1_8 ? (var_1_14 == ((double) (var_1_5 + var_1_6))) : 1) : 1)) && ((! var_1_8) ? ((var_1_5 <= (-0.5f * var_1_27)) ? (var_1_17 == ((unsigned char) (abs (var_1_3)))) : (var_1_17 == ((unsigned char) 32))) : (var_1_17 == ((unsigned char) 50)))) && ((! var_1_10) ? (((var_1_3 > (128 - 4)) && var_1_8) ? (var_1_18 == ((unsigned long int) var_1_13)) : (var_1_18 == ((unsigned long int) var_1_30))) : (var_1_18 == ((unsigned long int) var_1_17)))) && ((! ((- var_1_30) <= var_1_3)) ? (var_1_20 == ((unsigned char) ((var_1_21 - var_1_3) - var_1_22))) : 1)) && ((! var_1_10) ? (var_1_23 == ((float) (max ((256.5f - var_1_24) , var_1_6)))) : 1)) && ((var_1_10 || (! var_1_8)) ? ((! (var_1_2 > var_1_17)) ? (((var_1_24 - var_1_26) <= var_1_7) ? (var_1_25 == ((double) 7.5)) : 1) : (var_1_25 == ((double) var_1_5))) : (var_1_25 == ((double) var_1_24)))) && (var_1_27 == ((double) (var_1_6 + var_1_7)))) && ((var_1_24 <= var_1_1) ? (var_1_28 == ((double) (abs ((abs (var_1_7)) + var_1_6)))) : (var_1_28 == ((double) (var_1_24 - var_1_29))))) && ((last_1_var_1_20 <= (var_1_21 - var_1_3)) ? (last_1_var_1_8 ? (var_1_30 == ((unsigned short int) (abs (var_1_2)))) : (var_1_30 == ((unsigned short int) (min (var_1_12 , var_1_2))))) : (var_1_30 == ((unsigned short int) (max (var_1_22 , last_1_var_1_20)))))) && ((256 >= var_1_30) ? (var_1_8 ? ((var_1_18 < var_1_2) ? (var_1_31 == ((unsigned short int) var_1_22)) : 1) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
