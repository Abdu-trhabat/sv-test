...
void step(void) {
	...
	if ((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer)) < (*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer))) {
		if ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) < (*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer))) {
			(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) = ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) + (abs (128)));
		} else {
	...
	// From: Req2Batch186Wrapper_AP
	if ((max ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer)))) > (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer))) {
