...
void step(void) {
	...
	// From: CodeObject4
	/* 275L, 80L) */ if (/* 276L, 50L, 51L) */ ((/* 277L, 46L, 52L) */ ((var_1_9) & (/* 279L, 45L, 54L) */ ((var_1_29) + (2u))))) < (/* 282L, 49L, 57L) */ ((16u) >> (var_1_40))))) {
		/* 285L, 79L) */ var_1_39 = (
			/* 288L, 78L) */ ((
				/* 289L, 75L) */ ((
					var_1_41
	...
	/* 355L, 197L) */ if (/* 356L, 135L, 136L) */ ((/* 357L, 133L, 137L) */ ((var_1_35) * (/* 359L, 132L, 139L) */ ((var_1_47) - (var_1_48))))) < (var_1_45))) {
		/* 363L, 186L) */ if (/* 364L, 159L, 160L) */ ((/* 365L, 153L, 161L) */ (abs (/* 366L, 152L, 162L) */ (max (/* 366L, 152L, 162L) */ (var_1_38) , (var_1_25)))))) > (/* 369L, 158L, 165L) */ (min (/* 369L, 158L, 165L) */ (var_1_40) , (/* 371L, 157L, 167L) */ ((256) + (var_1_32)))))))) {
			/* 374L, 185L) */ var_1_46 = (
				/* 377L, 184L) */ (min (
					/* 377L, 184L) */ (
						var_1_37
	...
	// From: CodeObject7
	/* 389L, 248L) */ if (/* 390L, 210L, 211L) */ ((var_1_30) || (/* 392L, 209L, 213L) */ ((var_1_13) >= (/* 394L, 208L, 215L) */ ((var_1_48) + (var_1_37))))))) {
		/* 397L, 246L) */ if (/* 398L, 227L, 228L) */ ((-2) > (var_1_9))) {
			/* 401L, 237L) */ var_1_49 = (
				var_1_32
			);
		} else {
	...
	// From: CodeObject2
	/* 255L, 24L) */ if (/* 256L, 11L, 12L) */ (! (var_1_30))) {
		/* 258L, 23L) */ var_1_33 = (
			/* 261L, 22L) */ (max (
				/* 261L, 22L) */ (
					var_1_35
