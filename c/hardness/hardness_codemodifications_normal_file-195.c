...
void step(void) {
	...
	// From: Req5Batch195normal
	if (var_1_6 < 0.375f) {
		var_1_16 = (max (var_1_17 , var_1_18));
	}


	// From: Req6Batch195normal
	if (((min (var_1_1 , var_1_14)) >= (var_1_21 * var_1_18)) && var_1_4) {
		if (var_1_4) {
			var_1_19 = var_1_18;
		} else {
			var_1_19 = var_1_17;
	...
	// From: Req7Batch195normal
	if (var_1_4) {
		var_1_22 = (min (var_1_7 , var_1_6));
	}


	// From: Req8Batch195normal
	var_1_23 = var_1_15;


	// From: Req9Batch195normal
	var_1_24 = var_1_23;
}
