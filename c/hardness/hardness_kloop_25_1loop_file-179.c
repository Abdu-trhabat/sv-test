...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17925_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch17925_1loop
	if (0 <= (var_1_9 + (var_1_8 * var_1_10))) {
		var_1_7 = (var_1_11 - (var_1_12 - var_1_13));
	}


	// From: Req4Batch17925_1loop
	var_1_14 = var_1_15;


	// From: Req5Batch17925_1loop
	var_1_16 = var_1_13;
}
...
int property(void) {
	return (((((var_1_2 && (! var_1_3)) ? (var_1_1 == ((double) ((min (var_1_4 , var_1_5)) + 7.5))) : 1) && ((var_1_1 > (var_1_4 * var_1_5)) ? ((var_1_1 <= var_1_5) ? (var_1_2 ? (var_1_6 == ((double) var_1_5)) : (var_1_6 == ((double) 63.8))) : (var_1_6 == ((double) 2.352))) : (var_1_6 == ((double) var_1_5)))) && ((0 <= (var_1_9 + (var_1_8 * var_1_10))) ? (var_1_7 == ((float) (var_1_11 - (var_1_12 - var_1_13)))) : 1)) && (var_1_14 == ((unsigned char) var_1_15))) && (var_1_16 == ((float) var_1_13))
;
}
int main(void) {
	isInitial = 1;
