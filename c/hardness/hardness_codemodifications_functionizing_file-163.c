...
signed long int functionized1(signed long int functionized1_localFunctionVar0, signed long int functionized1_localFunctionVar1) {
	return (min ((functionized1_localFunctionVar1 + functionized1_localFunctionVar0) , var_1_6));
}
unsigned char functionized2(double functionized2_localFunctionVar0) {
	return (functionized2_localFunctionVar0 < (max (var_1_14 , var_1_3)));
}
...
unsigned char functionized7(signed short int functionized7_localFunctionVar0, unsigned long int functionized7_localFunctionVar1, signed short int functionized7_localFunctionVar2, unsigned long int localFunctionVar3) {
	return (((max (functionized7_localFunctionVar2 , var_1_19)) - functionized7_localFunctionVar0) > (256 << (localFunctionVar3 + functionized7_localFunctionVar1)));
}
...
void step(void) {
	// From: Req1Batch163functionizing
	...
	// From: Req2Batch163functionizing
	if (var_1_1 > var_1_7) {
		if (var_1_9) {
	...
	// From: Req3Batch163functionizing
	...
	// From: Req4Batch163functionizing
	...
	// From: Req5Batch163functionizing
	if (var_1_9 || var_1_23) {
	...
	// From: Req6Batch163functionizing
