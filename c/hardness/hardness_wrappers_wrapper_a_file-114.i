...
void step(void) {
 ...
 if (stepLocal_0 > signed_short_int_Array_0[2]) {
  signed_short_int_Array_0[4] = ((((signed_short_int_Array_0[1]) < (signed_short_int_Array_0[0])) ? (signed_short_int_Array_0[1]) : (signed_short_int_Array_0[0])));
 } else {
 ...
 if ((unsigned_long_int_Array_0[0] / 1u) != (unsigned_long_int_Array_0[1] + 10u)) {
  unsigned_char_Array_0[1] = (((((unsigned_char_Array_0[0]) < (128)) ? (unsigned_char_Array_0[0]) : (128))) - unsigned_char_Array_0[2]);
 }
 if ((signed_short_int_Array_0[1] / ((((signed_char_Array_0[0]) > (-8)) ? (signed_char_Array_0[0]) : (-8)))) >= ((signed_short_int_Array_0[0] | signed_short_int_Array_0[4]) + unsigned_char_Array_0[2])) {
  float_Array_0[0][1] = float_Array_0[0][0];
 } else {
  if (float_Array_0[1][1] != (((((float_Array_0[0][0]) < 0 ) ? -(float_Array_0[0][0]) : (float_Array_0[0][0]))) - float_Array_0[1][0])) {
   float_Array_0[0][1] = float_Array_0[0][0];
  }
 }
}
...
int property(void) {
 return ((((signed_short_int_Array_0[3] > signed_short_int_Array_0[2]) ? (signed_short_int_Array_0[4] == ((signed short int) ((((signed_short_int_Array_0[1]) < (signed_short_int_Array_0[0])) ? (signed_short_int_Array_0[1]) : (signed_short_int_Array_0[0]))))) : (signed_short_int_Array_0[4] == ((signed short int) 32))) && ((((signed_short_int_Array_0[3] * signed_short_int_Array_0[4]) < signed_short_int_Array_0[0]) || BOOL_unsigned_char_Array_0[0]) ? (BOOL_unsigned_char_Array_0[0] ? (float_Array_0[1][1] == ((float) float_Array_0[0][0])) : 1) : 1)) && (((unsigned_long_int_Array_0[0] / 1u) != (unsigned_long_int_Array_0[1] + 10u)) ? (unsigned_char_Array_0[1] == ((unsigned char) (((((unsigned_char_Array_0[0]) < (128)) ? (unsigned_char_Array_0[0]) : (128))) - unsigned_char_Array_0[2]))) : 1)) && (((signed_short_int_Array_0[1] / ((((signed_char_Array_0[0]) > (-8)) ? (signed_char_Array_0[0]) : (-8)))) >= ((signed_short_int_Array_0[0] | signed_short_int_Array_0[4]) + unsigned_char_Array_0[2])) ? (float_Array_0[0][1] == ((float) float_Array_0[0][0])) : ((float_Array_0[1][1] != (((((float_Array_0[0][0]) < 0 ) ? -(float_Array_0[0][0]) : (float_Array_0[0][0]))) - float_Array_0[1][0])) ? (float_Array_0[0][1] == ((float) float_Array_0[0][0])) : 1))
;
}
int main(void) {
 isInitial = 1;
