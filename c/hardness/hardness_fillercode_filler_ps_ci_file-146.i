...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch146Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
                  if ( ((var_1_25) <= (var_1_14))) {
                   ...
                   if ( ((var_1_7) >= ( ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7)))))) {
                    var_1_31 = (
                     (((((( var_1_17 ) + ( var_1_29 ))) < 0 ) ? -((( var_1_17 ) + ( var_1_29 ))) : ((( var_1_17 ) + ( var_1_29 )))))
   );
  }
 }
                   if (var_1_3) {
    ...
    var_1_49
                   ...
                   if (var_1_2) {
                    if ( ((var_1_45) < (var_1_14))) {
                     if ( ((var_1_38) != ( (((((var_1_31)) < ((var_1_20))) ? ((var_1_31)) : ((var_1_20))))))) {
                      var_1_50 = (
                       ((((( var_1_7 )) < (( ((((var_1_49) < 0 ) ? -(var_1_49) : (var_1_49))) ))) ? (( var_1_7 )) : (( ((((var_1_49) < 0 ) ? -(var_1_49) : (var_1_49))) ))))
    );
   } else {
                      var_1_50 = (
     var_1_48
