...
int property(void) {
	return ((((var_1_2 <= var_1_3) ? (var_1_1 == ((float) (min (var_1_4 , (max (var_1_5 , var_1_6)))))) : 1) && (var_1_8 ? ((last_1_var_1_7 < var_1_1) ? (var_1_7 == ((float) ((max (var_1_9 , 32.75f)) + var_1_10))) : 1) : (var_1_7 == ((float) var_1_9)))) && (var_1_11 == ((unsigned short int) (max (var_1_12 , var_1_13))))) && ((0 <= (var_1_12 >> var_1_16)) ? ((! (var_1_1 != var_1_2)) ? (var_1_8 ? (var_1_14 == ((unsigned char) ((max (128 , var_1_17)) - var_1_16))) : ((var_1_7 >= var_1_10) ? (var_1_14 == ((unsigned char) (var_1_16 + var_1_18))) : (var_1_19 ? (var_1_14 == ((unsigned char) var_1_18)) : (var_1_14 == ((unsigned char) var_1_20))))) : 1) : (var_1_14 == ((unsigned char) var_1_18)))
;
}
int main(void) {
	isInitial = 1;
