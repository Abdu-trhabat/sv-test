...
void step(void) {
	...
	if (stepLocal_0 >= (signed_long_int_Array_0[0][2] + signed_long_int_Array_0[1][1])) {
		signed_char_Array_0[1][1][1] = (signed_char_Array_0[0][1][1] - ((signed_char_Array_0[1][0][1] + signed_char_Array_0[1][1][0]) + (max (signed_char_Array_0[0][1][0] , signed_char_Array_0[1][0][0]))));
	} else {
		signed_char_Array_0[1][1][1] = signed_char_Array_0[0][1][0];
	}


	// From: Req2Batch160Wrapper_A
	signed char stepLocal_1 = signed_char_Array_0[1][0][1];
	if (stepLocal_1 >= (signed_char_Array_0[1][0][0] / (min (signed_char_Array_0[0][0][1] , signed_char_Array_0[0][0][0])))) {
		double_Array_0[1] = (max (double_Array_0[0] , 5.8));
	} else {
		double_Array_0[1] = double_Array_0[2];
	}


	// From: Req3Batch160Wrapper_A
	...
	if (stepLocal_2 == signed_char_Array_0[1][0][0]) {
		...
		signed_long_int_Array_0[0][1] = (signed_char_Array_0[0][1][0] - ((min (signed_long_int_Array_0[0][0] , signed_long_int_Array_0[1][0])) - signed_char_Array_0[1][0][1]));
	}


	// From: Req4Batch160Wrapper_A
...
int property(void) {
	return ((((signed_long_int_Array_0[1][2] >= (signed_long_int_Array_0[0][2] + signed_long_int_Array_0[1][1])) ? (signed_char_Array_0[1][1][1] == ((signed char) (signed_char_Array_0[0][1][1] - ((signed_char_Array_0[1][0][1] + signed_char_Array_0[1][1][0]) + (max (signed_char_Array_0[0][1][0] , signed_char_Array_0[1][0][0])))))) : (signed_char_Array_0[1][1][1] == ((signed char) signed_char_Array_0[0][1][0]))) && ((signed_char_Array_0[1][0][1] >= (signed_char_Array_0[1][0][0] / (min (signed_char_Array_0[0][0][1] , signed_char_Array_0[0][0][0])))) ? (double_Array_0[1] == ((double) (max (double_Array_0[0] , 5.8)))) : (double_Array_0[1] == ((double) double_Array_0[2])))) && (((signed_char_Array_0[0][0][0] * signed_char_Array_0[0][0][1]) == signed_char_Array_0[1][0][0]) ? (signed_long_int_Array_0[0][1] == ((signed long int) (signed_char_Array_0[1][1][0] + signed_char_Array_0[0][0][1]))) : (signed_long_int_Array_0[0][1] == ((signed long int) (signed_char_Array_0[0][1][0] - ((min (signed_long_int_Array_0[0][0] , signed_long_int_Array_0[1][0])) - signed_char_Array_0[1][0][1])))))) && (((signed_char_Array_0[1][1][0] << signed_long_int_Array_0[0][0]) != (signed_long_int_Array_0[1][0] ^ signed_char_Array_0[1][0][0])) ? (BOOL_unsigned_char_Array_0[0] ? (float_Array_0[0] == ((float) double_Array_0[2])) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
