 ...
 if (! WrapperStruct00.var_1_4) {
  if (stepLocal_0 >= WrapperStruct00.var_1_1) {
   ...
   if (stepLocal_1 <= WrapperStruct00.var_1_2) {
    WrapperStruct00.var_1_3 = ((((((((WrapperStruct00.var_1_6) < (WrapperStruct00.var_1_5)) ? (WrapperStruct00.var_1_6) : (WrapperStruct00.var_1_5)))) < (WrapperStruct00.var_1_7)) ? (((((WrapperStruct00.var_1_6) < (WrapperStruct00.var_1_5)) ? (WrapperStruct00.var_1_6) : (WrapperStruct00.var_1_5)))) : (WrapperStruct00.var_1_7)));
   }
  }
 } else {
  WrapperStruct00.var_1_3 = 64.6f;
 }
 signed long int stepLocal_3 = ((((WrapperStruct00.var_1_9) > (WrapperStruct00.var_1_10)) ? (WrapperStruct00.var_1_9) : (WrapperStruct00.var_1_10))) >> WrapperStruct00.var_1_11;
