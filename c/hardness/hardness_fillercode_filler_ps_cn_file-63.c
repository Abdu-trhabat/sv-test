...
void step(void) {
	// From: CodeObject1
	/* 36L) */ if (/* 9L, 8L) */ ((/* 10L, 4L) */ ((var_1_29) ^ (var_1_30))) < (/* 13L, 7L) */ ((var_1_31) | (var_1_32))))) {
		/* 28L) */ var_1_28 = (
			/* 27L) */ (max (
				/* 27L) */ (
					var_1_33
	...
	// From: CodeObject2
	/* 71L) */ if (/* 49L, 48L) */ ((/* 50L, 46L) */ ((-32) & (var_1_32))) > (var_1_31))) {
		/* 64L) */ var_1_35 = (
			/* 63L) */ (max (
				/* 63L) */ (
					var_1_36
	...
	// From: CodeObject3
	/* 142L) */ if (/* 87L, 86L) */ ((var_1_39) >= (/* 89L, 85L) */ (abs (var_1_35))))) {
		/* 119L) */ if (/* 98L, 97L) */ ((var_1_37) > (var_1_36))) {
			/* 117L) */ if (/* 107L, 106L) */ ((var_1_38) < (var_1_35))) {
				/* 116L) */ var_1_40 = (
					var_1_28
				);
			}
		...
		/* 140L) */ if (/* 126L, 125L) */ ((var_1_39) <= (/* 128L, 124L) */ ((var_1_36) + (var_1_37))))) {
			/* 139L) */ var_1_40 = (
				var_1_34
			);
		}
	...
	// From: CodeObject4
	/* 185L) */ if (/* 151L, 150L) */ ((var_1_39) > (/* 153L, 149L) */ ((var_1_37) + (var_1_35))))) {
		/* 183L) */ if (/* 164L, 163L) */ ((var_1_40) > (var_1_32))) {
			/* 178L) */ var_1_41 = (
				/* 177L) */ ((
					128
				) - (
	...
	// From: CodeObject6
	/* 222L) */ if (/* 200L, 199L) */ ((var_1_30) < (var_1_34))) {
		/* 213L) */ var_1_44 = (
			/* 212L) */ ((
				/* 210L) */ ((
					var_1_45
...
int property(void) {
	if (/* 256L, 8L, 16L, 344L, 379L, 1001L) */ ((32u) < (/* 258L, 7L, 18L, 346L, 381L, 1003L) */ ((/* 259L, 5L, 19L, 347L, 382L, 1004L) */ ((var_1_2) + (4u))) | (var_1_3))))) {
	} else {
		if (/* 272L, 32L, 35L, 360L, 395L, 1017L) */ (! (var_1_7))) {
		} else {
		}
	}
	if (/* 290L, 65L, 71L, 435L, 446L, 1035L) */ ((/* 291L, 63L, 72L, 436L, 447L, 1036L) */ ((var_1_9) >> (var_1_12))) < (var_1_3))) {
	}
	if (/* 301L, 92L, 100L, 483L, 496L, 1046L) */ ((/* 302L, 90L, 101L, 484L, 497L, 1047L) */ ((var_1_3) + (/* 304L, 89L, 103L, 486L, 499L, 1049L) */ ((var_1_12) / (var_1_14))))) >= (var_1_9))) {
	}
	if (/* 314L, 124L, 133L, 553L, 575L, 1059L) */ ((/* 315L, 122L, 134L, 554L, 576L, 1060L) */ ((/* 316L, 118L, 135L, 555L, 577L, 1061L) */ (abs (var_1_12))) >= (/* 318L, 121L, 137L, 557L, 579L, 1063L) */ ((var_1_1) & (var_1_10))))) && (var_1_7))) {
	} else {
	}
	if (/* 337L, 164L, 168L, 626L, 640L, 1082L) */ ((var_1_18) != (999999.5))) {
	}
	if (var_1_7) {
		if (/* 356L, 192L, 196L, 689L, 704L, 1101L) */ ((-128) < (var_1_5))) {
		}
	}
	if (/* 365L, 221L, 225L, 743L, 758L, 1110L) */ ((var_1_16) > (var_1_21))) {
	}
	return /* 405L) */ ((
	/* 404L) */ ((
		/* 403L) */ ((
			/* 402L) */ ((
				/* 401L) */ ((
					/* 400L) */ ((
						/* 399L) */ ((
							/* 398L) */ ((
								/* 397L) */ ((
									/* 255L, 54L, 343L, 378L, 1000L) */ ((
										/* 256L, 8L, 16L, 344L, 379L, 1001L) */ ((
											32u
										) < (
											/* 258L, 7L, 18L, 346L, 381L, 1003L) */ ((
												/* 259L, 5L, 19L, 347L, 382L, 1004L) */ ((
													var_1_2
												) + (
													4u
												))
										...
										/* 263L, 30L, 351L, 386L, 1008L) */ ((
											var_1_1
										) == (
											/* 263L, 30L, 351L, 386L, 1008L) */ ((signed long int) (
												/* 266L, 29L, 354L, 389L, 1011L) */ ((
													var_1_4
												) + (
													/* 268L, 28L, 356L, 391L, 1013L) */ ((
														var_1_5
													) + (
														var_1_6
													))
										...
										/* 271L, 52L, 359L, 394L, 1016L) */ ((
											/* 272L, 32L, 35L, 360L, 395L, 1017L) */ (! (
												var_1_7
											))
										) ? (
											/* 274L, 44L, 362L, 397L, 1019L) */ ((
												var_1_1
											) == (
												/* 274L, 44L, 362L, 397L, 1019L) */ ((signed long int) (
													/* 277L, 43L, 365L, 400L, 1022L) */ (min (
														/* 277L, 43L, 365L, 400L, 1022L) */ (
															var_1_4
														) , (
															/* 279L, 42L, 367L, 402L, 1024L) */ ((
																var_1_8
															) - (
																var_1_9
															))
											...
											/* 282L, 50L, 370L, 405L, 1027L) */ ((
												var_1_1
											) == (
												/* 282L, 50L, 370L, 405L, 1027L) */ ((signed long int) (
													/* 285L, 49L, 373L, 408L, 1030L) */ ((
														var_1_9
													) - (
														var_1_10
													))
									...
									/* 289L, 81L, 434L, 445L, 1034L) */ ((
										/* 290L, 65L, 71L, 435L, 446L, 1035L) */ ((
											/* 291L, 63L, 72L, 436L, 447L, 1036L) */ ((
												var_1_9
											) >> (
												var_1_12
											))
										...
										/* 295L, 79L, 440L, 451L, 1040L) */ ((
											var_1_11
										) == (
											/* 295L, 79L, 440L, 451L, 1040L) */ ((unsigned short int) (
												var_1_12
											))
										))
									) : (
								...
								/* 300L, 112L, 482L, 495L, 1045L) */ ((
									/* 301L, 92L, 100L, 483L, 496L, 1046L) */ ((
										/* 302L, 90L, 101L, 484L, 497L, 1047L) */ ((
											var_1_3
										) + (
											/* 304L, 89L, 103L, 486L, 499L, 1049L) */ ((
												var_1_12
											) / (
												var_1_14
											))
									...
									/* 308L, 110L, 490L, 503L, 1053L) */ ((
										var_1_13
									) == (
										/* 308L, 110L, 490L, 503L, 1053L) */ ((unsigned char) (
											var_1_12
										))
									))
								) : (
							...
							/* 313L, 154L, 552L, 574L, 1058L) */ ((
								/* 314L, 124L, 133L, 553L, 575L, 1059L) */ ((
									/* 315L, 122L, 134L, 554L, 576L, 1060L) */ ((
										/* 316L, 118L, 135L, 555L, 577L, 1061L) */ (abs (
											var_1_12
										))
									) >= (
										/* 318L, 121L, 137L, 557L, 579L, 1063L) */ ((
											var_1_1
										) & (
											var_1_10
										))
								...
								/* 322L, 148L, 561L, 583L, 1067L) */ ((
									var_1_15
								) == (
									/* 322L, 148L, 561L, 583L, 1067L) */ ((double) (
										/* 325L, 147L, 564L, 586L, 1070L) */ ((
											/* 326L, 145L, 565L, 587L, 1071L) */ (max (
												/* 326L, 145L, 565L, 587L, 1071L) */ (
													var_1_16
												) , (
													var_1_17
												)
								...
								/* 330L, 152L, 569L, 591L, 1075L) */ ((
									var_1_15
								) == (
									/* 330L, 152L, 569L, 591L, 1075L) */ ((double) (
										var_1_18
									))
								))
							))
						...
						/* 336L, 180L, 625L, 639L, 1081L) */ ((
							/* 337L, 164L, 168L, 626L, 640L, 1082L) */ ((
								var_1_18
							) != (
								999999.5
							))
						) ? (
							/* 340L, 178L, 629L, 643L, 1085L) */ ((
								var_1_19
							) == (
								/* 340L, 178L, 629L, 643L, 1085L) */ ((double) (
									/* 343L, 177L, 632L, 646L, 1088L) */ ((
										15.75
									) + (
										/* 345L, 176L, 634L, 648L, 1090L) */ ((
											var_1_20
										) - (
											var_1_21
										))
					...
					/* 353L, 206L, 686L, 701L, 1098L) */ ((
						var_1_7
					) ? (
						/* 355L, 204L, 688L, 703L, 1100L) */ ((
							/* 356L, 192L, 196L, 689L, 704L, 1101L) */ ((
								-128
							) < (
								var_1_5
							))
						) ? (
							/* 359L, 202L, 692L, 707L, 1104L) */ ((
								var_1_22
							) == (
								/* 359L, 202L, 692L, 707L, 1104L) */ ((signed char) (
									var_1_12
								))
							))
						) : (
				...
				/* 364L, 239L, 742L, 757L, 1109L) */ ((
					/* 365L, 221L, 225L, 743L, 758L, 1110L) */ ((
						var_1_16
					) > (
						var_1_21
					))
				) ? (
					/* 368L, 237L, 746L, 761L, 1113L) */ ((
						var_1_23
					) == (
						/* 368L, 237L, 746L, 761L, 1113L) */ ((unsigned short int) (
							/* 371L, 236L, 749L, 764L, 1116L) */ (min (
								/* 371L, 236L, 749L, 764L, 1116L) */ (
									var_1_26
								) , (
									/* 373L, 235L, 751L, 766L, 1118L) */ (min (
										/* 373L, 235L, 751L, 766L, 1118L) */ (
											var_1_12
										) , (
											/* 375L, 234L, 753L, 768L, 1120L) */ (min (
												/* 375L, 234L, 753L, 768L, 1120L) */ (
													8
												) , (
													var_1_24
												)
			...
			/* 380L, 247L, 785L, 791L, 1125L) */ ((
				var_1_25
			) == (
				/* 380L, 247L, 785L, 791L, 1125L) */ ((unsigned char) (
					var_1_12
				))
			))
		))
	) && (
		/* 386L, 257L, 809L, 815L, 1131L) */ ((
			var_1_26
		) == (
			/* 386L, 257L, 809L, 815L, 1131L) */ ((unsigned char) (
				var_1_12
			))
		))
	))
) && (
	/* 392L, 267L, 833L, 839L, 1137L) */ ((
		var_1_27
	) == (
		/* 392L, 267L, 833L, 839L, 1137L) */ ((signed short int) (
			var_1_26
		))
	))
))
