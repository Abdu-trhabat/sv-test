...
void step(void) {
 ...
 if (! (*(var_1_4_Pointer))) {
  if (stepLocal_1 == ((((10) > (((*(var_1_7_Pointer)) / (*(var_1_14_Pointer))))) ? (10) : (((*(var_1_7_Pointer)) / (*(var_1_14_Pointer))))))) {
