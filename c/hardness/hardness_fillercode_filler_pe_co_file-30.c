...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch30Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 354L, 118L) */ if (/* 355L, 97L, 98L) */ ((/* 356L, 93L, 99L) */ ((/* 357L, 91L, 100L) */ (abs (var_1_8))) - (var_1_19))) == (/* 360L, 96L, 103L) */ ((var_1_16) * (var_1_5))))) {
		/* 363L, 117L) */ var_1_17 = (
			-4
		);
	}
	...
	// From: CodeObject3
	/* 372L, 196L) */ if (/* 373L, 134L, 135L) */ ((var_1_11) != (var_1_15))) {
	...
	// From: CodeObject5
	/* 407L, 301L) */ if (/* 408L, 214L, 215L) */ ((/* 409L, 212L, 216L) */ ((/* 410L, 210L, 217L) */ (max (/* 410L, 210L, 217L) */ (var_1_30) , (var_1_31)))) << (var_1_15))) <= (var_1_27))) {
		/* 415L, 237L) */ var_1_29 = (
			/* 418L, 236L) */ ((
				/* 419L, 233L) */ (min (
					/* 419L, 233L) */ (
		...
		/* 424L, 299L) */ if (/* 425L, 240L, 241L) */ ((var_1_30) >= (var_1_26))) {
			/* 428L, 297L) */ if (/* 429L, 253L, 254L) */ ((var_1_15) > (/* 431L, 252L, 256L) */ ((/* 432L, 250L, 257L) */ ((5) ^ (var_1_31))) ^ (var_1_26))))) {
	...
	// From: CodeObject6
	/* 454L, 327L) */ if (/* 455L, 309L, 310L) */ ((var_1_31) < (var_1_15))) {
		/* 458L, 320L) */ var_1_36 = (
			/* 461L, 319L) */ (abs (
				var_1_32
			))
