...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch62Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	var_1_9 = (min (((min (last_1_var_1_28 , var_1_8)) + (min (last_1_var_1_35 , var_1_10))) , var_1_11));
	...
	if (stepLocal_2 > var_1_28) {
		if ((- var_1_9) != stepLocal_1) {
			var_1_7 = (min ((min (5u , var_1_8)) , var_1_9));
		} else {
			var_1_7 = var_1_28;
		}
	} else {
...
int property(void) {
	return ((((((((((((var_1_28 >= var_1_9) ? (var_1_1 == ((double) (abs ((max (var_1_4 , var_1_5)) + var_1_6)))) : (var_1_1 == ((double) (var_1_4 + var_1_5)))) && ((32 > var_1_28) ? (((- var_1_9) != (var_1_28 - var_1_8)) ? (var_1_7 == ((unsigned long int) (min ((min (5u , var_1_8)) , var_1_9)))) : (var_1_7 == ((unsigned long int) var_1_28))) : (var_1_7 == ((unsigned long int) var_1_28)))) && (var_1_9 == ((unsigned long int) (min (((min (last_1_var_1_28 , var_1_8)) + (min (last_1_var_1_35 , var_1_10))) , var_1_11))))) && ((var_1_4 <= (var_1_17 + (var_1_5 * var_1_6))) ? (var_1_12 == ((unsigned char) ((var_1_13 && var_1_14) && var_1_15))) : (var_1_12 == ((unsigned char) var_1_16)))) && (var_1_13 ? (var_1_17 == ((double) ((var_1_18 - var_1_19) + var_1_4))) : (var_1_17 == ((double) var_1_6)))) && (((var_1_8 == var_1_28) || var_1_12) ? (var_1_20 == ((float) (min (25.5f , var_1_4)))) : 1)) && (var_1_13 ? ((var_1_5 > var_1_18) ? (var_1_21 == ((float) (min (var_1_18 , var_1_6)))) : 1) : (var_1_21 == ((float) (var_1_5 + (1.55f + 5.7f)))))) && (((var_1_8 / var_1_23) == (~ var_1_28)) ? (((var_1_8 + (- var_1_7)) >= var_1_10) ? (var_1_22 == ((float) ((var_1_24 + var_1_25) + (var_1_18 - (max (31.85f , 10.5f)))))) : 1) : (var_1_22 == ((float) 7.5f)))) && ((var_1_1 > (var_1_1 * (var_1_24 / 2.8))) ? (var_1_14 ? (var_1_13 ? (var_1_26 == ((signed char) (max (var_1_27 , 0)))) : (var_1_16 ? (var_1_26 == ((signed char) var_1_27)) : (var_1_26 == ((signed char) -4)))) : (var_1_26 == ((signed char) var_1_27))) : 1)) && ((var_1_27 > ((last_1_var_1_7 * var_1_23) + last_1_var_1_28)) ? ((last_1_var_1_35 < last_1_var_1_7) ? (var_1_28 == ((unsigned long int) last_1_var_1_7)) : 1) : (var_1_28 == ((unsigned long int) last_1_var_1_35)))) && (var_1_14 ? ((var_1_28 <= var_1_9) ? (var_1_30 == ((signed char) (abs (var_1_32)))) : (var_1_30 == ((signed char) (1 + (abs (1)))))) : (var_1_30 == ((signed char) (var_1_33 + var_1_34))))) && (var_1_16 ? (var_1_35 == ((signed long int) (abs (var_1_34)))) : (((var_1_36 - var_1_37) <= -32) ? (var_1_35 == ((signed long int) var_1_28)) : (var_1_35 == ((signed long int) var_1_30))))
;
}
int main(void) {
	isInitial = 1;
