...
void functionized1(unsigned char functionized1_localFunctionVar0, signed char functionized1_localFunctionVar1, signed char functionized1_localFunctionVar2) {
 if (functionized1_localFunctionVar0 >= var_1_8) {
  ...
  var_1_16 = (((((((((var_1_18) > (functionized1_localFunctionVar1)) ? (var_1_18) : (functionized1_localFunctionVar1))) + ((((var_1_20) < (functionized1_localFunctionVar2)) ? (var_1_20) : (functionized1_localFunctionVar2))))) > (var_1_17)) ? ((((((var_1_18) > (functionized1_localFunctionVar1)) ? (var_1_18) : (functionized1_localFunctionVar1))) + ((((var_1_20) < (functionized1_localFunctionVar2)) ? (var_1_20) : (functionized1_localFunctionVar2))))) : (var_1_17)));
 }
}
unsigned char functionized2(void) {
...
void functionized4(signed long int functionized4_localFunctionVar0, unsigned short int functionized4_localFunctionVar1, float functionized4_localFunctionVar2) {
 if (! var_1_7) {
  ...
  if ((var_1_5 + functionized4_localFunctionVar0) < functionized4_localFunctionVar1) {
   var_1_27 = ((((functionized4_localFunctionVar2) > (var_1_14)) ? (functionized4_localFunctionVar2) : (var_1_14)));
  } else {
   var_1_27 = functionized4_localFunctionVar2;
  }
 }
...
void step(void) {
 ...
 if (((((var_1_6 * 4u) < 0 ) ? -(var_1_6 * 4u) : (var_1_6 * 4u))) != var_1_5) {
