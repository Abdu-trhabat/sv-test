...
void step(void) {
	...
	// From: Req5Batch167normal
	var_1_20 = ((var_1_21 + 16) + (var_1_22 + var_1_23));


	// From: Req6Batch167normal
	...
	// From: Req4Batch167normal
	unsigned long int stepLocal_2 = var_1_5;
	if (((max (var_1_3 , var_1_18)) * var_1_4) == stepLocal_2) {
		var_1_17 = (-1 - var_1_19);
	} else {
		var_1_17 = var_1_24;
	}
