...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch6325_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch6325_1loop
	if ((min (1.1f , var_1_2)) > (var_1_3 * var_1_4)) {
		var_1_1 = (var_1_5 && var_1_6);
	}


	// From: Req2Batch6325_1loop
