...
void step(void) {
	...
	// From: CodeObject2
	/* 354L, 141L) */ if (/* 355L, 114L, 115L) */ ((/* 356L, 112L, 116L) */ ((var_1_26) / (var_1_14))) < (var_1_3))) {
		/* 360L, 128L) */ var_1_27 = (
			var_1_14
		);
	} else {
	...
	// From: CodeObject4
	/* 384L, 179L) */ if (/* 385L, 164L, 165L) */ ((/* 386L, 162L, 166L) */ (min (/* 386L, 162L, 166L) */ (var_1_2) , (var_1_16)))) >= (var_1_26))) {
		/* 390L, 178L) */ var_1_35 = (
			var_1_29
		);
	}
	...
	/* 394L, 251L) */ if (/* 395L, 189L, 190L) */ ((/* 396L, 187L, 191L) */ ((var_1_8) * (/* 398L, 186L, 193L) */ ((var_1_38) - (var_1_39))))) >= (var_1_8))) {
		/* 402L, 245L) */ if (/* 403L, 210L, 211L) */ ((/* 404L, 205L, 212L) */ (~ (var_1_16))) <= (/* 406L, 209L, 214L) */ (abs (/* 407L, 208L, 215L) */ (min (/* 407L, 208L, 215L) */ (var_1_3) , (var_1_29)))))))) {
			/* 410L, 228L) */ var_1_36 = (
				var_1_34
			);
		} else {
	...
	// From: CodeObject6
	/* 424L, 303L) */ if (/* 425L, 262L, 263L) */ ((/* 426L, 259L, 264L) */ ((var_1_16) | (1000))) >= (/* 429L, 261L, 267L) */ (abs (var_1_6))))) {
	...
	/* 333L, 105L) */ if (var_1_15) {
		/* 335L, 98L) */ if (/* 336L, 81L, 82L) */ ((var_1_5) <= (var_1_6))) {
			/* 339L, 97L) */ var_1_22 = (
				/* 342L, 96L) */ ((
					/* 343L, 94L) */ (max (
						/* 343L, 94L) */ (
