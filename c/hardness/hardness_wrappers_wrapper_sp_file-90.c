...
void step(void) {
	...
	if (! (*(WrapperStruct00_var_1_2_Pointer))) {
		if (((max ((*(WrapperStruct00_var_1_12_Pointer)) , (*(WrapperStruct00_var_1_13_Pointer)))) - (*(WrapperStruct00_var_1_14_Pointer))) >= (- (32.25 * (*(WrapperStruct00_var_1_15_Pointer))))) {
			if ((*(WrapperStruct00_var_1_2_Pointer))) {
	...
	if (stepLocal_0 != (min ((*(WrapperStruct00_var_1_3_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer))))) {
