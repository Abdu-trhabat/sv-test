...
void step(void) {
	...
	// From: CodeObject4
	/* 263L, 137L) */ if (/* 264L, 45L, 46L) */ ((/* 265L, 43L, 47L) */ (max (/* 265L, 43L, 47L) */ (var_1_37) , (var_1_36)))) > (var_1_17))) {
		/* 269L, 135L) */ if (/* 270L, 58L, 59L) */ ((var_1_39) > (var_1_28))) {
			...
			/* 281L, 133L) */ if (/* 282L, 82L, 83L) */ ((/* 283L, 75L, 84L) */ (min (/* 283L, 75L, 84L) */ (var_1_39) , (var_1_28)))) > (/* 286L, 81L, 87L) */ ((var_1_41) - (/* 288L, 80L, 89L) */ (min (/* 288L, 80L, 89L) */ (var_1_42) , (10)))))))) {
				/* 291L, 127L) */ if (/* 292L, 106L, 107L) */ ((/* 293L, 104L, 108L) */ ((/* 294L, 102L, 109L) */ (abs (var_1_27))) - (var_1_27))) < (2))) {
					/* 298L, 126L) */ var_1_40 = (
						/* 301L, 125L) */ (max (
							/* 301L, 125L) */ (
								var_1_27
	...
	// From: CodeObject6
	/* 399L, 193L) */ if (/* 400L, 151L, 152L) */ ((var_1_26) >= (var_1_28))) {
		/* 403L, 181L) */ if (/* 404L, 162L, 163L) */ ((/* 405L, 160L, 164L) */ ((var_1_36) > (var_1_37))) || (var_1_31))) {
			/* 409L, 180L) */ var_1_46 = (
				/* 412L, 179L) */ ((
					/* 413L, 177L) */ ((
						var_1_23
	...
	// From: CodeObject7
	/* 427L, 228L) */ if (/* 428L, 205L, 206L) */ ((/* 429L, 201L, 207L) */ ((var_1_25) ^ (/* 431L, 200L, 209L) */ ((var_1_11) | (var_1_28))))) < (/* 434L, 204L, 212L) */ ((var_1_42) ^ (var_1_41))))) {
		/* 437L, 227L) */ var_1_49 = (
			var_1_36
		);
	}
...
int property(void) {
	if (/* 447L, 6L, 12L, 596L, 649L, 1174L) */ ((var_1_2) <= (/* 449L, 5L, 14L, 598L, 651L, 1176L) */ ((var_1_3) ^ (var_1_4))))) {
	} else {
		if (/* 458L, 32L, 39L, 607L, 660L, 1185L) */ ((/* 459L, 30L, 40L, 608L, 661L, 1186L) */ ((var_1_14) + (/* 461L, 29L, 42L, 610L, 663L, 1188L) */ (- (var_1_14))))) >= (var_1_14))) {
			if (/* 465L, 55L, 63L, 614L, 667L, 1192L) */ ((/* 466L, 53L, 64L, 615L, 668L, 1193L) */ ((var_1_3) / (/* 468L, 52L, 66L, 617L, 670L, 1195L) */ (min (/* 468L, 52L, 66L, 617L, 670L, 1195L) */ (var_1_10) , (var_1_11)))))) > (var_1_2))) {
			} else {
				if (/* 481L, 82L, 88L, 630L, 683L, 1208L) */ ((/* 482L, 80L, 89L, 631L, 684L, 1209L) */ ((var_1_24) * (var_1_4))) < (var_1_3))) {
				} else {
				}
			}
		} else {
	...
	if (/* 501L, 123L, 131L, 731L, 745L, 1228L) */ ((/* 502L, 119L, 132L, 732L, 746L, 1229L) */ ((var_1_15) - (var_1_16))) == (/* 505L, 122L, 135L, 735L, 749L, 1232L) */ ((var_1_17) - (var_1_18))))) {
	}
	if (/* 515L, 158L, 168L, 791L, 807L, 1242L) */ ((/* 516L, 156L, 169L, 792L, 808L, 1243L) */ ((/* 517L, 152L, 170L, 793L, 809L, 1244L) */ (min (/* 517L, 152L, 170L, 793L, 809L, 1244L) */ (var_1_17) , (var_1_16)))) - (/* 520L, 155L, 173L, 796L, 812L, 1247L) */ ((var_1_21) + (var_1_22))))) >= (63.6))) {
	}
	if (/* 530L, 192L, 197L, 870L, 882L, 1257L) */ (! (/* 531L, 191L, 198L, 871L, 883L, 1258L) */ ((var_1_7) > (var_1_14))))) {
		if (var_1_12) {
		}
	}
	if (/* 543L, 218L, 222L, 927L, 943L, 1270L) */ ((var_1_23) || (var_1_12))) {
		if (var_1_9) {
		}
	}
	if (/* 558L, 248L, 252L, 996L, 1015L, 1285L) */ ((var_1_14) > (var_1_22))) {
		if (/* 562L, 256L, 259L, 1000L, 1019L, 1289L) */ (! (var_1_23))) {
		} else {
		}
	}
	return /* 580L) */ ((
	/* 579L) */ ((
		/* 578L) */ ((
			/* 577L) */ ((
				/* 576L) */ ((
					/* 446L, 112L, 595L, 648L, 1173L) */ ((
						/* 447L, 6L, 12L, 596L, 649L, 1174L) */ ((
							var_1_2
						) <= (
							/* 449L, 5L, 14L, 598L, 651L, 1176L) */ ((
								var_1_3
							) ^ (
								var_1_4
							))
						...
						/* 452L, 21L, 601L, 654L, 1179L) */ ((
							var_1_1
						) == (
							/* 452L, 21L, 601L, 654L, 1179L) */ ((unsigned char) (
								/* 455L, 20L, 604L, 657L, 1182L) */ (! (
									var_1_5
								))
							))
						))
					) : (
						/* 457L, 110L, 606L, 659L, 1184L) */ ((
							/* 458L, 32L, 39L, 607L, 660L, 1185L) */ ((
								/* 459L, 30L, 40L, 608L, 661L, 1186L) */ ((
									var_1_14
								) + (
									/* 461L, 29L, 42L, 610L, 663L, 1188L) */ (- (
										var_1_14
									))
								))
							) >= (
							...
							/* 464L, 104L, 613L, 666L, 1191L) */ ((
								/* 465L, 55L, 63L, 614L, 667L, 1192L) */ ((
									/* 466L, 53L, 64L, 615L, 668L, 1193L) */ ((
										var_1_3
									) / (
										/* 468L, 52L, 66L, 617L, 670L, 1195L) */ (min (
											/* 468L, 52L, 66L, 617L, 670L, 1195L) */ (
												var_1_10
											) , (
												var_1_11
											)
								...
								/* 472L, 77L, 621L, 674L, 1199L) */ ((
									var_1_1
								) == (
									/* 472L, 77L, 621L, 674L, 1199L) */ ((unsigned char) (
										/* 475L, 76L, 624L, 677L, 1202L) */ ((
											var_1_9
										) || (
											/* 477L, 75L, 626L, 679L, 1204L) */ ((
												var_1_5
											) || (
												var_1_12
											))
								...
								/* 480L, 102L, 629L, 682L, 1207L) */ ((
									/* 481L, 82L, 88L, 630L, 683L, 1208L) */ ((
										/* 482L, 80L, 89L, 631L, 684L, 1209L) */ ((
											var_1_24
										) * (
											var_1_4
										))
									...
									/* 486L, 96L, 635L, 688L, 1213L) */ ((
										var_1_1
									) == (
										/* 486L, 96L, 635L, 688L, 1213L) */ ((unsigned char) (
											var_1_12
										))
									))
								) : (
									/* 490L, 100L, 639L, 692L, 1217L) */ ((
										var_1_1
									) == (
										/* 490L, 100L, 639L, 692L, 1217L) */ ((unsigned char) (
											var_1_9
										))
									))
								))
							...
							/* 494L, 108L, 643L, 696L, 1221L) */ ((
								var_1_1
							) == (
								/* 494L, 108L, 643L, 696L, 1221L) */ ((unsigned char) (
									var_1_12
								))
							))
						))
					...
					/* 500L, 143L, 730L, 744L, 1227L) */ ((
						/* 501L, 123L, 131L, 731L, 745L, 1228L) */ ((
							/* 502L, 119L, 132L, 732L, 746L, 1229L) */ ((
								var_1_15
							) - (
								var_1_16
							))
						) == (
							/* 505L, 122L, 135L, 735L, 749L, 1232L) */ ((
								var_1_17
							) - (
								var_1_18
							))
						...
						/* 508L, 141L, 738L, 752L, 1235L) */ ((
							var_1_14
						) == (
							/* 508L, 141L, 738L, 752L, 1235L) */ ((float) (
								var_1_19
							))
						))
					) : (
				...
				/* 514L, 182L, 790L, 806L, 1241L) */ ((
					/* 515L, 158L, 168L, 791L, 807L, 1242L) */ ((
						/* 516L, 156L, 169L, 792L, 808L, 1243L) */ ((
							/* 517L, 152L, 170L, 793L, 809L, 1244L) */ (min (
								/* 517L, 152L, 170L, 793L, 809L, 1244L) */ (
									var_1_17
								) , (
									var_1_16
								)
							...
							/* 520L, 155L, 173L, 796L, 812L, 1247L) */ ((
								var_1_21
							) + (
								var_1_22
							))
					...
					/* 524L, 180L, 800L, 816L, 1251L) */ ((
						var_1_20
					) == (
						/* 524L, 180L, 800L, 816L, 1251L) */ ((signed short int) (
							var_1_28
						))
					))
				) : (
			...
			/* 529L, 211L, 869L, 881L, 1256L) */ ((
				/* 530L, 192L, 197L, 870L, 882L, 1257L) */ (! (
					/* 531L, 191L, 198L, 871L, 883L, 1258L) */ ((
						var_1_7
					) > (
						var_1_14
					))
				...
				/* 534L, 209L, 874L, 886L, 1261L) */ ((
					var_1_12
				) ? (
					/* 536L, 207L, 876L, 888L, 1263L) */ ((
						var_1_23
					) == (
						/* 536L, 207L, 876L, 888L, 1263L) */ ((unsigned char) (
							var_1_5
						))
					))
				) : (
		...
		/* 542L, 239L, 926L, 942L, 1269L) */ ((
			/* 543L, 218L, 222L, 927L, 943L, 1270L) */ ((
				var_1_23
			) || (
				var_1_12
			))
		) ? (
			/* 546L, 237L, 930L, 946L, 1273L) */ ((
				var_1_9
			) ? (
				/* 548L, 235L, 932L, 948L, 1275L) */ ((
					var_1_24
				) == (
					/* 548L, 235L, 932L, 948L, 1275L) */ ((signed char) (
						/* 551L, 234L, 935L, 951L, 1278L) */ ((
							var_1_25
						) - (
							/* 553L, 233L, 937L, 953L, 1280L) */ ((
								var_1_26
							) + (
								var_1_27
							))
	...
	/* 557L, 274L, 995L, 1014L, 1284L) */ ((
		/* 558L, 248L, 252L, 996L, 1015L, 1285L) */ ((
			var_1_14
		) > (
			var_1_22
		))
	) ? (
		/* 561L, 272L, 999L, 1018L, 1288L) */ ((
			/* 562L, 256L, 259L, 1000L, 1019L, 1289L) */ (! (
				var_1_23
			))
		) ? (
			/* 564L, 266L, 1002L, 1021L, 1291L) */ ((
				var_1_28
			) == (
				/* 564L, 266L, 1002L, 1021L, 1291L) */ ((unsigned long int) (
					/* 567L, 265L, 1005L, 1024L, 1294L) */ ((
						var_1_27
					) + (
						last_1_var_1_28
					))
			...
			/* 571L, 270L, 1009L, 1028L, 1298L) */ ((
				var_1_28
			) == (
				/* 571L, 270L, 1009L, 1028L, 1298L) */ ((unsigned long int) (
					var_1_29
				))
			))
		))
