...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch6050_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_7 < stepLocal_2) {
  if (var_1_11) {
   var_1_13 = ((((var_1_10) > (var_1_14)) ? (var_1_10) : (var_1_14)));
  } else {
 ...
 var_1_20 = (var_1_18 - (((((var_1_21) < (var_1_22)) ? (var_1_21) : (var_1_22))) + var_1_23));
 if (var_1_8 == var_1_19) {
  if (var_1_13 < var_1_6) {
   var_1_24 = var_1_23;
  }
...
int property(void) {
 return (((((((var_1_11 ? (((var_1_8 / var_1_4) <= var_1_24) ? (var_1_1 == ((signed short int) (var_1_6 - var_1_7))) : (var_1_1 == ((signed short int) var_1_6))) : (var_1_1 == ((signed short int) var_1_7))) && (((- last_1_var_1_24) <= var_1_4) ? (((last_1_var_1_24 <= var_1_4) || last_1_var_1_11) ? (var_1_8 == ((float) 3.3f)) : 1) : 1)) && ((var_1_8 < (var_1_20 + var_1_15)) ? ((((((var_1_7) < (var_1_1)) ? (var_1_7) : (var_1_1))) > (var_1_6 * 1)) ? (var_1_9 == ((unsigned char) var_1_10)) : (var_1_9 == ((unsigned char) 64))) : (var_1_9 == ((unsigned char) var_1_10)))) && (var_1_11 == ((unsigned char) var_1_12))) && ((var_1_7 < var_1_6) ? (var_1_11 ? (var_1_13 == ((unsigned char) ((((var_1_10) > (var_1_14)) ? (var_1_10) : (var_1_14))))) : ((var_1_12 || var_1_11) ? (var_1_13 == ((unsigned char) var_1_14)) : 1)) : 1)) && (var_1_11 ? (var_1_15 == ((float) (var_1_16 + (var_1_17 + 32.5f)))) : (var_1_15 == ((float) ((5.064290308105643E18f - (4.4f + var_1_18)) - var_1_19))))) && (var_1_20 == ((double) (var_1_18 - (((((var_1_21) < (var_1_22)) ? (var_1_21) : (var_1_22))) + var_1_23))))) && ((var_1_8 == var_1_19) ? ((var_1_13 < var_1_6) ? (var_1_24 == ((float) var_1_23)) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
