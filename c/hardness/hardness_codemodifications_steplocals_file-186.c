...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch186stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch186stepLocals
	var_1_1 = var_1_2;


	// From: Req2Batch186stepLocals
	unsigned char stepLocal_0 = var_1_4;
	if (stepLocal_0 || (var_1_1 != (min (-10 , var_1_2)))) {
	...
	// From: Req3Batch186stepLocals
	if ((var_1_7 > (max (9.6 , var_1_6))) || (var_1_5 < var_1_3)) {
		var_1_9 = var_1_10;
	}


	// From: Req4Batch186stepLocals
	...
	// From: Req7Batch186stepLocals
	signed long int stepLocal_5 = (var_1_12 ^ var_1_1) * var_1_14;
	unsigned char stepLocal_4 = var_1_13;
	unsigned char stepLocal_3 = var_1_4;
	if (stepLocal_3 && ((var_1_10 > var_1_17) && var_1_19)) {
		if (((var_1_20 - var_1_12) / (3761303906u - var_1_16)) == stepLocal_4) {
			if ((min ((var_1_15 + var_1_11) , var_1_9)) >= stepLocal_5) {
				var_1_18 = var_1_12;
			} else {
				var_1_18 = var_1_2;
			}
