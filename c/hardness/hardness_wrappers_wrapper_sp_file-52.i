...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (! ((*(WrapperStruct00_var_1_13_Pointer)) < (127.125 / (*(WrapperStruct00_var_1_12_Pointer))))) {
  if ((*(WrapperStruct00_var_1_1_Pointer)) <= (((*(WrapperStruct00_var_1_4_Pointer)) * (*(WrapperStruct00_var_1_3_Pointer))) + (4 << (*(WrapperStruct00_var_1_16_Pointer))))) {
