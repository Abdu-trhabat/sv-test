...
void step(void) {
	// From: Req1Batch109Amount10
	signed short int stepLocal_1 = var_1_4;
	signed long int stepLocal_0 = var_1_3 % (min (-64 , var_1_4));
	if (var_1_2 < stepLocal_0) {
		if (var_1_3 <= stepLocal_1) {
			var_1_1 = (max (31.4 , (max (var_1_5 , var_1_6))));
		} else {
			var_1_1 = var_1_5;
		}
	} else {
...
int property(void) {
	return (var_1_2 < (var_1_3 % (min (-64 , var_1_4)))) ? ((var_1_3 <= var_1_4) ? (var_1_1 == ((double) (max (31.4 , (max (var_1_5 , var_1_6)))))) : (var_1_1 == ((double) var_1_5))) : (var_1_1 == ((double) var_1_5))
;
}
int main(void) {
	isInitial = 1;
