...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4850_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch4850_while
	if (var_1_2) {
		var_1_13 = var_1_11;
	}


	// From: Req5Batch4850_while
	unsigned char stepLocal_1 = var_1_10;
	if (stepLocal_1 == (max ((var_1_15 - var_1_16) , var_1_13))) {
	...
	// From: Req3Batch4850_while
	if (var_1_2) {
		if (-128 > var_1_10) {
			if (var_1_3 >= (2.75 / var_1_9)) {
				var_1_12 = (var_1_11 + (var_1_13 + var_1_10));
			} else {
				var_1_12 = var_1_13;
			}
		}
...
int property(void) {
	return (((((var_1_2 ? ((((var_1_3 - var_1_4) - var_1_5) == (15.75 - var_1_6)) ? (var_1_1 == ((unsigned short int) (5 + var_1_7))) : (var_1_1 == ((unsigned short int) var_1_7))) : (var_1_1 == ((unsigned short int) 1))) && ((var_1_6 > (var_1_5 / (max (var_1_3 , var_1_9)))) ? (var_1_8 == ((unsigned char) (abs (var_1_10)))) : ((last_1_var_1_18 <= var_1_7) ? (var_1_8 == ((unsigned char) var_1_10)) : (var_1_8 == ((unsigned char) var_1_11))))) && (var_1_2 ? ((-128 > var_1_10) ? ((var_1_3 >= (2.75 / var_1_9)) ? (var_1_12 == ((signed long int) (var_1_11 + (var_1_13 + var_1_10)))) : (var_1_12 == ((signed long int) var_1_13))) : 1) : (var_1_12 == ((signed long int) var_1_1)))) && (var_1_2 ? (var_1_13 == ((signed long int) var_1_11)) : 1)) && ((var_1_10 == (max ((var_1_15 - var_1_16) , var_1_13))) ? (var_1_14 == ((signed char) (abs (var_1_17)))) : (var_1_14 == ((signed char) var_1_17)))) && ((var_1_7 == var_1_12) ? (var_1_18 == ((unsigned short int) (var_1_10 + (min (var_1_8 , var_1_16))))) : ((var_1_14 != var_1_16) ? ((-256 >= var_1_13) ? (var_1_18 == ((unsigned short int) var_1_16)) : (var_1_18 == ((unsigned short int) var_1_15))) : (var_1_18 == ((unsigned short int) var_1_10))))
;
}
int main(void) {
	isInitial = 1;
