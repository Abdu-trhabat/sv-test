...
void step(void) {
	...
	// From: Req5Batch107Amount100
	if (var_1_32 > (var_1_32 / 1)) {
		var_1_30 = ((min (var_1_26 , var_1_31)) + var_1_28);
	} else {
		var_1_30 = var_1_26;
	}


	// From: Req7Batch107Amount100
	unsigned long int stepLocal_2 = var_1_32;
	signed long int stepLocal_1 = - (abs (var_1_3));
	...
	// From: Req8Batch107Amount100
	if ((- (var_1_37 - var_1_14)) <= (var_1_2 / (min (var_1_17 , var_1_38)))) {
		var_1_36 = (var_1_16 + (var_1_13 + var_1_35));
	}


	// From: Req10Batch107Amount100
	...
	// From: Req2Batch107Amount100
	if (var_1_41) {
		var_1_10 = (min ((min (var_1_12 , var_1_13)) , (var_1_14 + (var_1_15 + var_1_16))));
	} else {
		var_1_10 = (var_1_17 - var_1_18);
	}


	// From: Req4Batch107Amount100
	signed long int stepLocal_0 = ~ var_1_6;
	if ((min (var_1_32 , var_1_8)) < stepLocal_0) {
		if (var_1_41) {
			var_1_29 = var_1_16;
		}
	} else {
	...
	// From: Req11Batch107Amount100
	unsigned char stepLocal_6 = var_1_13;
	unsigned char stepLocal_5 = var_1_10;
	if (stepLocal_5 < (min (var_1_9 , (min (var_1_18 , var_1_8))))) {
		if (var_1_41) {
			var_1_44 = var_1_15;
		} else {
	...
	// From: Req9Batch107Amount100
	if (var_1_41) {
		var_1_39 = (max (var_1_27 , (min (var_1_26 , var_1_23))));
	} else {
		var_1_39 = (var_1_28 + (3.75 + (var_1_27 - var_1_40)));
	}


	// From: Req3Batch107Amount100
	if ((- var_1_30) < var_1_39) {
		var_1_19 = (abs (min (var_1_22 , var_1_23)));
	} else {
		var_1_19 = ((min (var_1_24 , var_1_25)) - ((abs (var_1_26)) + (var_1_27 + var_1_28)));
	}
}
...
int property(void) {
	return ((((((((((((var_1_2 - var_1_3) > ((var_1_32 * -256) + var_1_32)) ? (var_1_1 == ((signed short int) (max ((var_1_6 - (var_1_7 + var_1_8)) , var_1_9)))) : (var_1_1 == ((signed short int) var_1_9))) && (var_1_41 ? (var_1_10 == ((unsigned char) (min ((min (var_1_12 , var_1_13)) , (var_1_14 + (var_1_15 + var_1_16)))))) : (var_1_10 == ((unsigned char) (var_1_17 - var_1_18))))) && (((- var_1_30) < var_1_39) ? (var_1_19 == ((float) (abs (min (var_1_22 , var_1_23))))) : (var_1_19 == ((float) ((min (var_1_24 , var_1_25)) - ((abs (var_1_26)) + (var_1_27 + var_1_28))))))) && (((min (var_1_32 , var_1_8)) < (~ var_1_6)) ? (var_1_41 ? (var_1_29 == ((signed char) var_1_16)) : 1) : (var_1_29 == ((signed char) var_1_15)))) && ((var_1_32 > (var_1_32 / 1)) ? (var_1_30 == ((double) ((min (var_1_26 , var_1_31)) + var_1_28))) : (var_1_30 == ((double) var_1_26)))) && ((var_1_11 || var_1_33) ? (var_1_32 == ((unsigned long int) (var_1_7 + var_1_12))) : ((last_1_var_1_39 > 500.5f) ? (var_1_32 == ((unsigned long int) (3328784126u - var_1_18))) : 1))) && ((var_1_14 == (- (abs (var_1_3)))) ? ((var_1_32 > var_1_18) ? (var_1_34 == ((signed char) ((var_1_16 + var_1_35) - var_1_15))) : (var_1_34 == ((signed char) var_1_15))) : (var_1_34 == ((signed char) var_1_15)))) && (((- (var_1_37 - var_1_14)) <= (var_1_2 / (min (var_1_17 , var_1_38)))) ? (var_1_36 == ((unsigned short int) (var_1_16 + (var_1_13 + var_1_35)))) : 1)) && (var_1_41 ? (var_1_39 == ((double) (max (var_1_27 , (min (var_1_26 , var_1_23)))))) : (var_1_39 == ((double) (var_1_28 + (3.75 + (var_1_27 - var_1_40))))))) && ((var_1_36 > ((var_1_7 / var_1_38) ^ (- var_1_32))) ? (var_1_11 ? ((var_1_16 <= var_1_15) ? (var_1_41 == ((unsigned char) (var_1_33 && var_1_42))) : (var_1_41 == ((unsigned char) (var_1_33 || var_1_43)))) : 1) : 1)) && ((var_1_10 < (min (var_1_9 , (min (var_1_18 , var_1_8))))) ? (var_1_41 ? (var_1_44 == ((signed char) var_1_15)) : ((var_1_13 >= var_1_35) ? (var_1_44 == ((signed char) var_1_35)) : (var_1_44 == ((signed char) var_1_45)))) : (var_1_44 == ((signed char) 4)))
;
}
int main(void) {
	isInitial = 1;
