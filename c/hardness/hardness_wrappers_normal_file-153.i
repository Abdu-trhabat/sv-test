...
void step(void) {
 ...
 if ((var_1_4 / var_1_15) == stepLocal_1) {
  if (var_1_10) {
   var_1_13 = ((((var_1_17) < (1000000.5)) ? (var_1_17) : (1000000.5)));
  }
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((((last_1_var_1_4 <= (((((-32) < 0 ) ? -(-32) : (-32))) + 16)) ? (var_1_1 == ((unsigned long int) ((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3))))) : (var_1_1 == ((unsigned long int) var_1_3))) && ((var_1_19 <= var_1_3) ? ((var_1_19 <= var_1_1) ? (var_1_9 ? (var_1_4 == ((signed short int) var_1_19)) : 1) : 1) : 1)) && (var_1_6 == ((unsigned short int) (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) + var_1_8)))) && ((var_1_6 <= var_1_19) ? (var_1_9 == ((unsigned char) (! var_1_10))) : (var_1_9 == ((unsigned char) (var_1_11 && var_1_12))))) && (((var_1_4 / var_1_15) == var_1_1) ? (var_1_10 ? (var_1_13 == ((double) ((((var_1_17) < (1000000.5)) ? (var_1_17) : (1000000.5))))) : 1) : 1)) && (var_1_18 == ((double) var_1_17))) && (var_1_19 == ((signed short int) var_1_6))
;
}
int main(void) {
 isInitial = 1;
