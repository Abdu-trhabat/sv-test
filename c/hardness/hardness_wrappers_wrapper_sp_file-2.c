...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_10_Pointer)) || ((*(WrapperStruct00_var_1_6_Pointer)) == (*(WrapperStruct00_var_1_8_Pointer)))) {
		if ((*(WrapperStruct00_var_1_6_Pointer)) <= ((min (0 , last_1_WrapperStruct00_var_1_11)) << last_1_WrapperStruct00_var_1_11)) {
