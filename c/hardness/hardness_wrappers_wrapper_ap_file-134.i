...
void step(void) {
 ...
 if (stepLocal_0 > (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) {
  if (((((((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer))) < ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer))))) - 8.88) < (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer))) {
   (*(double_Array_0_arraydouble_Array_0arrayVar7_Pointer)) = ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) - ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) - (((((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) < 0 ) ? -((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))))));
  } else {
 ...
 if ((*(double_Array_0_arraydouble_Array_0arrayVar7_Pointer)) >= (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))) {
  if (((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) >= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) {
   (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) = (((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) - (((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) > ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))))) - (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer)));
  }
 } else {
 ...
 if (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
  (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) = (((((200.5f - 4.25f)) > ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)))) ? ((200.5f - 4.25f)) : ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)))));
 } else {
  if ((((((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer))) > ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)))) ? ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var2_Pointer))) : ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))))) >= stepLocal_1) {
