...
void step(void) {
	...
	// From: Req5Batch181100_while
	if (var_1_9 != 31.5) {
		var_1_21 = var_1_22;
	}


	// From: Req7Batch181100_while
	var_1_26 = (var_1_27 + 500.65);


	// From: Req8Batch181100_while
	var_1_28 = (var_1_11 - var_1_29);


	// From: Req10Batch181100_while
	...
	// From: Req2Batch181100_while
	if (((var_1_9 - 199.9) - (var_1_10 - var_1_11)) >= var_1_28) {
		var_1_8 = (abs (127.5f));
	}


	// From: Req3Batch181100_while
	if (var_1_4 > var_1_8) {
		var_1_12 = (var_1_7 + var_1_13);
	}


	// From: Req9Batch181100_while
