...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch115Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch115Amount25
	var_1_20 = var_1_21;


	// From: Req6Batch115Amount25
	var_1_22 = 2;


	// From: Req7Batch115Amount25
	var_1_23 = var_1_18;


	// From: Req2Batch115Amount25
	if (var_1_20) {
