...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch191Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req13Batch191Amount100
	var_1_39 = var_1_40;


	// From: Req14Batch191Amount100
	var_1_41 = var_1_40;


	// From: Req3Batch191Amount100
	...
	// From: Req4Batch191Amount100
	if (var_1_9 != var_1_7) {
		var_1_12 = (((var_1_10 / var_1_13) > var_1_6) || var_1_14);
	}


	// From: Req5Batch191Amount100
