...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17225_while.c", 13, "reach_error"); }
...
int property(void) {
 return ((((var_1_2 >= var_1_3) ? (var_1_1 == ((unsigned char) (var_1_4 || var_1_5))) : ((var_1_2 >= var_1_3) ? (var_1_1 == ((unsigned char) var_1_6)) : (var_1_1 == ((unsigned char) var_1_5)))) && ((var_1_2 < var_1_3) ? ((var_1_2 <= var_1_3) ? (var_1_6 ? (var_1_7 == ((signed long int) var_1_2)) : 1) : 1) : 1)) && ((var_1_7 < 8) ? (var_1_8 == ((unsigned char) ((((var_1_9) < (var_1_10)) ? (var_1_9) : (var_1_10))))) : (var_1_8 == ((unsigned char) ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))))))) && ((var_1_9 == var_1_7) ? (var_1_11 == ((signed char) ((var_1_12 - 8) - var_1_13))) : 1)
;
}
int main(void) {
 isInitial = 1;
