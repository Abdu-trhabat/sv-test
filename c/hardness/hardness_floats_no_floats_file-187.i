...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch187no_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (last_1_var_1_10 > stepLocal_5) {
  if ((var_1_8 - var_1_11) > stepLocal_4) {
   var_1_10 = (((((var_1_11) < ((last_1_var_1_10 + var_1_1))) ? (var_1_11) : ((last_1_var_1_10 + var_1_1)))) + var_1_12);
  }
 } else {
  var_1_10 = var_1_1;
 }
 ...
 if (stepLocal_2 == (((((var_1_10 | var_1_1)) < (var_1_1)) ? ((var_1_10 | var_1_1)) : (var_1_1)))) {
...
int property(void) {
 return ((var_1_2 ? ((var_1_3 <= var_1_4) ? ((var_1_5 && ((var_1_4 / var_1_6) < var_1_3)) ? (var_1_1 == ((unsigned long int) var_1_4)) : 1) : (var_1_1 == ((unsigned long int) var_1_3))) : 1) && ((2 == (((((var_1_10 | var_1_1)) < (var_1_1)) ? ((var_1_10 | var_1_1)) : (var_1_1)))) ? ((var_1_10 < var_1_1) ? (var_1_7 == ((signed short int) (var_1_8 - 8))) : (var_1_7 == ((signed short int) var_1_8))) : (var_1_2 ? (var_1_7 == ((signed short int) var_1_8)) : (var_1_7 == ((signed short int) var_1_9))))) && ((last_1_var_1_10 > var_1_6) ? (((var_1_8 - var_1_11) > var_1_1) ? (var_1_10 == ((unsigned long int) (((((var_1_11) < ((last_1_var_1_10 + var_1_1))) ? (var_1_11) : ((last_1_var_1_10 + var_1_1)))) + var_1_12))) : 1) : (var_1_10 == ((unsigned long int) var_1_1)))
;
}
int main(void) {
 isInitial = 1;
