...
void functionized0(unsigned char functionized0_localFunctionVar0, signed char functionized0_localFunctionVar1) {
 if (var_1_2 < functionized0_localFunctionVar1) {
  var_1_1 = (((((var_1_4 - 4)) < (functionized0_localFunctionVar1)) ? ((var_1_4 - 4)) : (functionized0_localFunctionVar1)));
 } else {
...
void step(void) {
 ...
 if (var_1_5) {
  ...
  var_1_10 = (((((((functionized1(-4)) < 0 ) ? -(functionized1(-4)) : (functionized1(-4)))) < 0 ) ? -((((functionized1(-4)) < 0 ) ? -(functionized1(-4)) : (functionized1(-4)))) : ((((functionized1(-4)) < 0 ) ? -(functionized1(-4)) : (functionized1(-4))))));
 }
