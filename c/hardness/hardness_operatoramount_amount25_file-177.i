...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch177Amount25.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_1 = (((5) < ((var_1_2 * var_1_3))) ? (5) : ((var_1_2 * var_1_3)));
 unsigned short int stepLocal_0 = var_1_2;
 if (stepLocal_1 <= var_1_4) {
  if (stepLocal_0 > var_1_3) {
   if (stepLocal_2 == (var_1_2 * (var_1_3 * 50))) {
    var_1_1 = var_1_5;
   }
  }
 } else {
 ...
 unsigned long int stepLocal_3 = (var_1_2 * var_1_4) | (var_1_3 / var_1_7);
 if (stepLocal_3 >= var_1_8) {
  var_1_6 = -8;
 }
 unsigned long int stepLocal_4 = var_1_8;
...
int property(void) {
 return (((((((5) < ((var_1_2 * var_1_3))) ? (5) : ((var_1_2 * var_1_3)))) <= var_1_4) ? ((var_1_2 > var_1_3) ? (((- var_1_4) == (var_1_2 * (var_1_3 * 50))) ? (var_1_1 == ((double) var_1_5)) : 1) : 1) : (var_1_1 == ((double) var_1_5))) && ((((var_1_2 * var_1_4) | (var_1_3 / var_1_7)) >= var_1_8) ? (var_1_6 == ((signed char) -8)) : 1)) && ((var_1_4 != var_1_8) ? (var_1_9 == ((unsigned char) (var_1_10 - (var_1_11 + (var_1_12 - var_1_13))))) : 1)
;
}
int main(void) {
 isInitial = 1;
