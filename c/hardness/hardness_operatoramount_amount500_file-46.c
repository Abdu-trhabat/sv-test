...
void step(void) {
	...
	unsigned long int stepLocal_2 = min ((var_1_15 - 2) , -2);
	...
	if (! last_1_var_1_82) {
		if (var_1_7 <= (last_1_var_1_47 * (var_1_2 / var_1_21))) {
				...
				if (! last_1_var_1_82) {
					if (stepLocal_2 >= var_1_11) {
						if (var_1_17 >= stepLocal_3) {
							var_1_18 = (min (var_1_15 , ((max (var_1_11 , var_1_23)) - var_1_12)));
						} else {
							var_1_18 = (min (last_1_var_1_46 , (var_1_16 + var_1_15)));
						}
					}
				} else {
			...
			if (last_1_var_1_45 < stepLocal_1) {
				...
				var_1_18 = ((min (last_1_var_1_46 , var_1_17)) + var_1_16);
			}
		}
	} else {
		var_1_18 = (abs (var_1_17));
	}
	...
	if ((abs (var_1_16)) < stepLocal_4) {
		if (var_1_73) {
			var_1_24 = (max ((max (var_1_15 , (var_1_25 + 4))) , (max (var_1_17 , var_1_16))));
		}
	} else {
	...
	if ((abs (var_1_31)) != (var_1_10 ^ (var_1_17 / var_1_35))) {
		var_1_40 = var_1_31;
	} else {
		var_1_40 = var_1_30;
	}
	...
	var_1_41 = (min ((var_1_17 + var_1_37) , (max (var_1_16 , (var_1_39 - var_1_25)))));
	...
	if (((- var_1_6) != var_1_8) && stepLocal_9) {
		if (1u >= stepLocal_8) {
			var_1_42 = (max ((var_1_38 - 32) , ((var_1_37 + 16) - var_1_43)));
		} else {
			var_1_42 = var_1_38;
		}
	} else {
	...
	if ((var_1_21 + var_1_5) >= var_1_9) {
		var_1_45 = (min (var_1_31 , var_1_25));
	}


	// From: Req13Batch46Amount500
	var_1_46 = (max (var_1_30 , (var_1_11 - 16u)));


	// From: Req15Batch46Amount500
	var_1_50 = (max (((abs (var_1_38)) - var_1_32) , (var_1_36 - var_1_34)));


	// From: Req18Batch46Amount500
	if (var_1_3 != (var_1_6 - (max (var_1_5 , var_1_7)))) {
		var_1_54 = (min (2 , ((var_1_15 + var_1_38) + (min (var_1_37 , var_1_53)))));
	} else {
		var_1_54 = var_1_36;
	}
	...
	if (var_1_29 > var_1_23) {
		if (var_1_23 == ((var_1_11 - var_1_25) / var_1_31)) {
			var_1_76 = (max ((var_1_17 - (var_1_24 + var_1_36)) , var_1_54));
		} else {
			var_1_76 = ((29406 - (min (var_1_31 , var_1_15))) + (max (var_1_57 , var_1_53)));
		}
	} else {
	...
	if (var_1_59) {
		if (var_1_73) {
			var_1_80 = (max (var_1_57 , (abs (var_1_38 + var_1_15))));
		}
	}
	...
	if ((var_1_58 || var_1_61) && stepLocal_30) {
		if (stepLocal_31 < (min (var_1_15 , 2u))) {
	...
	signed long int stepLocal_7 = (min (var_1_17 , var_1_19)) | (~ var_1_32);
	if (var_1_58) {
		...
		if (var_1_3 >= var_1_9) {
			if (stepLocal_7 >= var_1_13) {
				...
				var_1_33 = (min (((var_1_36 - var_1_15) - (var_1_34 - var_1_37)) , (var_1_35 + (64 - var_1_38))));
			}
		} else {
			var_1_33 = ((min (var_1_36 , var_1_39)) - (var_1_35 - var_1_38));
		}
	}
	...
	if ((var_1_11 * var_1_23) >= stepLocal_6) {
		if ((3679506271u - 1u) > stepLocal_5) {
			var_1_26 = ((min (0 , var_1_15)) - var_1_27);
		} else {
			var_1_26 = ((max (var_1_15 , var_1_27)) - var_1_28);
		}
	} else {
	...
	if ((var_1_8 / var_1_4) > (- var_1_81)) {
		...
		var_1_47 = ((min (var_1_5 , var_1_48)) + var_1_7);
	}


	// From: Req24Batch46Amount500
	signed long int stepLocal_19 = abs (var_1_28);
	...
	if (var_1_98 < stepLocal_18) {
		if (var_1_85 < stepLocal_19) {
			...
			var_1_67 = (max (var_1_37 , var_1_53));
		}
	} else {
		if (var_1_73 && stepLocal_17) {
			if (var_1_21 >= var_1_8) {
				var_1_67 = (var_1_37 + (max (2 , 0)));
			} else {
				var_1_67 = (var_1_38 + var_1_15);
			}
		} else {
			var_1_67 = (max (var_1_37 , var_1_38));
		}
	}
	...
	signed long int stepLocal_21 = max (var_1_29 , var_1_86);
	signed long int stepLocal_20 = min (1 , var_1_29);
	if (stepLocal_22 < (- (- var_1_27))) {
		if (var_1_36 <= stepLocal_20) {
			if (var_1_61) {
				var_1_71 = ((var_1_30 - 16) - var_1_27);
			} else {
				var_1_71 = (8 - (abs (var_1_30 - var_1_35)));
			}
		} else {
			var_1_71 = var_1_57;
		}
	...
	signed long int stepLocal_27 = min (var_1_25 , var_1_41);
	unsigned long int stepLocal_26 = var_1_31 ^ var_1_11;
	if ((var_1_57 * 1000000000u) < stepLocal_27) {
		if (var_1_25 > stepLocal_26) {
			var_1_77 = (min ((var_1_7 + (var_1_48 + var_1_49)) , var_1_9));
		} else {
			if (stepLocal_28 <= var_1_85) {
				var_1_77 = (min ((min ((var_1_7 - var_1_4) , (var_1_9 - var_1_5))) , var_1_8));
			}
		}
	} else {
	...
	if ((min ((abs (199.875)) , var_1_21)) < var_1_47) {
		var_1_44 = (((max (var_1_28 , var_1_29)) + (min (var_1_46 , var_1_37))) + (abs (var_1_35)));
	}
	...
	if (! var_1_82) {
		if ((var_1_28 | var_1_43) < var_1_18) {
			...
			if ((- var_1_91) != (var_1_31 >> var_1_53)) {
				...
				var_1_52 = ((var_1_34 + var_1_38) + ((min (var_1_35 , var_1_44)) + var_1_37));
			}
		}
	}
	...
	if (stepLocal_11 < ((var_1_17 >> var_1_53) + (max (var_1_28 , var_1_34)))) {
		var_1_55 = ((abs (var_1_6)) + var_1_49);
	} else {
		if (var_1_84) {
			var_1_55 = (var_1_5 - var_1_6);
		} else {
			var_1_55 = (abs (var_1_49));
		}
	}
	...
	if (var_1_73) {
		if (var_1_84 || var_1_60) {
			var_1_68 = (var_1_38 - (min (var_1_53 , var_1_37)));
		} else {
			if (var_1_48 >= (var_1_8 / var_1_21)) {
				var_1_68 = (max ((var_1_38 + var_1_37) , var_1_69));
			} else {
				var_1_68 = (max (0 , var_1_37));
			}
		}
	} else {
		if ((- var_1_46) < var_1_15) {
			var_1_68 = ((min (-8 , var_1_38)) + var_1_15);
		} else {
			if (var_1_32 < var_1_25) {
				if (var_1_19 < (var_1_31 << (max (0u , 1u)))) {
					if (((5 + var_1_43) / (max (var_1_53 , var_1_35))) < var_1_85) {
	...
	if (var_1_54 > stepLocal_34) {
		if (! var_1_84) {
			if (stepLocal_33 || var_1_75) {
				...
				var_1_99 = (max (var_1_6 , (var_1_100 + var_1_8)));
			}
		} else {
			var_1_99 = var_1_101;
		}
	...
	signed long int stepLocal_10 = (max (var_1_97 , 5)) % var_1_19;
	...
	signed long int stepLocal_16 = var_1_31 | (abs (var_1_32));
	...
	if (var_1_91 > stepLocal_15) {
		if (stepLocal_16 <= (var_1_36 - 64)) {
			...
			if ((var_1_49 + var_1_4) <= var_1_3) {
				var_1_64 = ((var_1_6 - (abs (var_1_5))) + (var_1_49 + var_1_48));
			} else {
				if (var_1_9 < (var_1_99 + (min (var_1_81 , var_1_99)))) {
					var_1_64 = var_1_5;
				}
			}
		}
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((16.75 > (var_1_2 - var_1_3)) ? (var_1_1 == ((double) ((var_1_4 - (max (var_1_5 , var_1_6))) - (max ((var_1_7 + var_1_8) , var_1_9))))) : (var_1_1 == ((double) (abs (var_1_4))))) && (var_1_10 == ((unsigned long int) (var_1_11 - var_1_12)))) && ((var_1_73 && ((50u >> var_1_15) < var_1_18)) ? (var_1_13 == ((unsigned short int) ((abs (max (var_1_16 , var_1_17))) - var_1_15))) : 1)) && ((! last_1_var_1_82) ? ((var_1_7 <= (last_1_var_1_47 * (var_1_2 / var_1_21))) ? (last_1_var_1_82 ? ((! last_1_var_1_82) ? (((min ((var_1_15 - 2) , -2)) >= var_1_11) ? ((var_1_17 >= last_1_var_1_46) ? (var_1_18 == ((unsigned long int) (min (var_1_15 , ((max (var_1_11 , var_1_23)) - var_1_12))))) : (var_1_18 == ((unsigned long int) (min (last_1_var_1_46 , (var_1_16 + var_1_15)))))) : 1) : (var_1_18 == ((unsigned long int) (var_1_11 - var_1_15)))) : 1) : ((last_1_var_1_45 < var_1_12) ? (var_1_18 == ((unsigned long int) var_1_11)) : (var_1_18 == ((unsigned long int) ((min (last_1_var_1_46 , var_1_17)) + var_1_16))))) : (var_1_18 == ((unsigned long int) (abs (var_1_17)))))) && (((abs (var_1_16)) < var_1_17) ? (var_1_73 ? (var_1_24 == ((unsigned short int) (max ((max (var_1_15 , (var_1_25 + 4))) , (max (var_1_17 , var_1_16)))))) : 1) : (var_1_24 == ((unsigned short int) (var_1_16 - var_1_15))))) && (((var_1_11 * var_1_23) >= ((var_1_17 ^ var_1_91) / var_1_15)) ? (((3679506271u - 1u) > var_1_23) ? (var_1_26 == ((signed short int) ((min (0 , var_1_15)) - var_1_27))) : (var_1_26 == ((signed short int) ((max (var_1_15 , var_1_27)) - var_1_28)))) : (var_1_26 == ((signed short int) ((var_1_30 - var_1_15) - ((var_1_31 + var_1_32) - 4)))))) && (var_1_58 ? (var_1_33 == ((unsigned char) ((var_1_34 + var_1_35) - var_1_15))) : ((var_1_3 >= var_1_9) ? ((((min (var_1_17 , var_1_19)) | (~ var_1_32)) >= var_1_13) ? (var_1_33 == ((unsigned char) var_1_34)) : (var_1_33 == ((unsigned char) (min (((var_1_36 - var_1_15) - (var_1_34 - var_1_37)) , (var_1_35 + (64 - var_1_38))))))) : (var_1_33 == ((unsigned char) ((min (var_1_36 , var_1_39)) - (var_1_35 - var_1_38))))))) && (((abs (var_1_31)) != (var_1_10 ^ (var_1_17 / var_1_35))) ? (var_1_40 == ((signed long int) var_1_31)) : (var_1_40 == ((signed long int) var_1_30)))) && (var_1_41 == ((signed long int) (min ((var_1_17 + var_1_37) , (max (var_1_16 , (var_1_39 - var_1_25)))))))) && ((((- var_1_6) != var_1_8) && (var_1_21 < var_1_2)) ? ((1u >= (var_1_28 / var_1_35)) ? (var_1_42 == ((signed char) (max ((var_1_38 - 32) , ((var_1_37 + 16) - var_1_43))))) : (var_1_42 == ((signed char) var_1_38))) : (var_1_42 == ((signed char) (abs (var_1_38)))))) && (((min ((abs (199.875)) , var_1_21)) < var_1_47) ? (var_1_44 == ((signed long int) (((max (var_1_28 , var_1_29)) + (min (var_1_46 , var_1_37))) + (abs (var_1_35))))) : 1)) && (((var_1_21 + var_1_5) >= var_1_9) ? (var_1_45 == ((unsigned long int) (min (var_1_31 , var_1_25)))) : 1)) && (var_1_46 == ((unsigned long int) (max (var_1_30 , (var_1_11 - 16u)))))) && (((var_1_8 / var_1_4) > (- var_1_81)) ? (var_1_47 == ((double) (var_1_6 + (var_1_48 + var_1_49)))) : (var_1_47 == ((double) ((min (var_1_5 , var_1_48)) + var_1_7))))) && (var_1_50 == ((signed long int) (max (((abs (var_1_38)) - var_1_32) , (var_1_36 - var_1_34)))))) && (((var_1_31 + var_1_43) < ((max (var_1_97 , 5)) % var_1_19)) ? (var_1_51 == ((float) (var_1_7 + var_1_6))) : 1)) && ((! var_1_82) ? (((var_1_28 | var_1_43) < var_1_18) ? (var_1_52 == ((unsigned short int) (var_1_17 - var_1_32))) : (((- var_1_91) != (var_1_31 >> var_1_53)) ? (var_1_52 == ((unsigned short int) var_1_44)) : (var_1_52 == ((unsigned short int) ((var_1_34 + var_1_38) + ((min (var_1_35 , var_1_44)) + var_1_37)))))) : 1)) && ((var_1_3 != (var_1_6 - (max (var_1_5 , var_1_7)))) ? (var_1_54 == ((unsigned char) (min (2 , ((var_1_15 + var_1_38) + (min (var_1_37 , var_1_53))))))) : (var_1_54 == ((unsigned char) var_1_36)))) && ((var_1_50 < ((var_1_17 >> var_1_53) + (max (var_1_28 , var_1_34)))) ? (var_1_55 == ((double) ((abs (var_1_6)) + var_1_49))) : (var_1_84 ? (var_1_55 == ((double) (var_1_5 - var_1_6))) : (var_1_55 == ((double) (abs (var_1_49))))))) && (((var_1_41 ^ var_1_78) >= (1 * 16)) ? ((var_1_58 && (var_1_84 || (var_1_78 == var_1_19))) ? (var_1_56 == ((unsigned char) (var_1_39 - var_1_15))) : (var_1_56 == ((unsigned char) (1 + var_1_15)))) : (var_1_56 == ((unsigned char) ((var_1_35 + var_1_57) - 64))))) && ((last_1_var_1_84 || (last_1_var_1_85 > 10u)) ? (var_1_58 == ((unsigned char) ((var_1_32 > (var_1_34 * last_1_var_1_18)) && var_1_59))) : (var_1_58 == ((unsigned char) (! (var_1_60 && var_1_61)))))) && ((var_1_34 == var_1_10) ? ((var_1_28 > var_1_39) ? (var_1_62 == ((signed short int) (var_1_36 - var_1_63))) : 1) : 1)) && ((var_1_91 > var_1_53) ? (((var_1_31 | (abs (var_1_32))) <= (var_1_36 - 64)) ? (var_1_64 == ((float) var_1_5)) : (((var_1_49 + var_1_4) <= var_1_3) ? (var_1_64 == ((float) ((var_1_6 - (abs (var_1_5))) + (var_1_49 + var_1_48)))) : ((var_1_9 < (var_1_99 + (min (var_1_81 , var_1_99)))) ? (var_1_64 == ((float) var_1_5)) : 1))) : 1)) && ((var_1_98 < var_1_85) ? ((var_1_85 < (abs (var_1_28))) ? (var_1_67 == ((signed char) var_1_38)) : (var_1_67 == ((signed char) (max (var_1_37 , var_1_53))))) : ((var_1_73 && (var_1_35 >= (var_1_37 << var_1_53))) ? ((var_1_21 >= var_1_8) ? (var_1_67 == ((signed char) (var_1_37 + (max (2 , 0))))) : (var_1_67 == ((signed char) (var_1_38 + var_1_15)))) : (var_1_67 == ((signed char) (max (var_1_37 , var_1_38))))))) && (var_1_73 ? ((var_1_84 || var_1_60) ? (var_1_68 == ((signed char) (var_1_38 - (min (var_1_53 , var_1_37))))) : ((var_1_48 >= (var_1_8 / var_1_21)) ? (var_1_68 == ((signed char) (max ((var_1_38 + var_1_37) , var_1_69)))) : (var_1_68 == ((signed char) (max (0 , var_1_37)))))) : (((- var_1_46) < var_1_15) ? (var_1_68 == ((signed char) ((min (-8 , var_1_38)) + var_1_15))) : ((var_1_32 < var_1_25) ? ((var_1_19 < (var_1_31 << (max (0u , 1u)))) ? ((((5 + var_1_43) / (max (var_1_53 , var_1_35))) < var_1_85) ? (var_1_68 == ((signed char) (var_1_15 + var_1_37))) : (var_1_68 == ((signed char) var_1_43))) : 1) : 1)))) && ((var_1_72 < (- (- var_1_27))) ? ((var_1_36 <= (min (1 , var_1_29))) ? (var_1_61 ? (var_1_71 == ((signed short int) ((var_1_30 - 16) - var_1_27))) : (var_1_71 == ((signed short int) (8 - (abs (var_1_30 - var_1_35)))))) : (var_1_71 == ((signed short int) var_1_57))) : ((var_1_10 > (max (var_1_29 , var_1_86))) ? (var_1_71 == ((signed short int) (var_1_69 + var_1_32))) : 1))) && ((var_1_50 >= -128) ? (var_1_58 ? (var_1_72 == ((signed short int) (5 + var_1_29))) : 1) : (var_1_72 == ((signed short int) ((var_1_37 - var_1_35) + var_1_39))))) && ((last_1_var_1_33 < (var_1_36 - var_1_15)) ? ((last_1_var_1_84 && ((last_1_var_1_93 - var_1_36) >= last_1_var_1_18)) ? (var_1_73 == ((unsigned char) (((var_1_61 || var_1_60) && (! var_1_59)) && ((! var_1_74) && var_1_75)))) : (var_1_73 == ((unsigned char) ((! (var_1_60 && var_1_75)) || (last_1_var_1_58 && var_1_74))))) : ((100.8 >= var_1_3) ? (var_1_73 == ((unsigned char) var_1_60)) : (var_1_73 == ((unsigned char) (var_1_59 && var_1_74)))))) && ((var_1_29 > var_1_23) ? ((var_1_23 == ((var_1_11 - var_1_25) / var_1_31)) ? (var_1_76 == ((unsigned short int) (max ((var_1_17 - (var_1_24 + var_1_36)) , var_1_54)))) : (var_1_76 == ((unsigned short int) ((29406 - (min (var_1_31 , var_1_15))) + (max (var_1_57 , var_1_53)))))) : (var_1_76 == ((unsigned short int) (var_1_17 - (var_1_24 + var_1_36)))))) && (((var_1_57 * 1000000000u) < (min (var_1_25 , var_1_41))) ? ((var_1_25 > (var_1_31 ^ var_1_11)) ? (var_1_77 == ((double) (min ((var_1_7 + (var_1_48 + var_1_49)) , var_1_9)))) : ((var_1_23 <= var_1_85) ? (var_1_77 == ((double) (min ((min ((var_1_7 - var_1_4) , (var_1_9 - var_1_5))) , var_1_8)))) : 1)) : (((var_1_3 - var_1_9) < var_1_6) ? ((10 >= (5 - var_1_38)) ? (var_1_77 == ((double) ((var_1_8 + var_1_6) - var_1_9))) : (var_1_77 == ((double) (max (var_1_6 , var_1_49))))) : (var_1_77 == ((double) (var_1_49 + var_1_5)))))) && (var_1_61 ? (((- (var_1_36 * var_1_53)) <= var_1_57) ? (var_1_78 == ((signed long int) var_1_19)) : 1) : 1)) && ((var_1_76 >= (var_1_10 * var_1_41)) ? (var_1_79 == ((double) (var_1_5 - var_1_4))) : 1)) && (var_1_59 ? (var_1_73 ? (var_1_80 == ((unsigned char) (max (var_1_57 , (abs (var_1_38 + var_1_15)))))) : 1) : 1)) && (var_1_81 == ((double) var_1_48))) && (((var_1_58 || var_1_61) && var_1_73) ? (((var_1_40 % var_1_11) < (min (var_1_15 , 2u))) ? (var_1_82 == ((unsigned char) (((var_1_62 <= var_1_29) && var_1_61) || (! var_1_59)))) : 1) : ((var_1_58 || var_1_59) ? (var_1_82 == ((unsigned char) (! var_1_59))) : (var_1_82 == ((unsigned char) (var_1_58 && var_1_83)))))) && (var_1_84 == ((unsigned char) (var_1_82 && var_1_74)))) && ((var_1_9 < var_1_2) ? (var_1_85 == ((unsigned long int) (var_1_32 + var_1_31))) : (var_1_85 == ((unsigned long int) var_1_36)))) && (var_1_86 == ((signed short int) var_1_15))) && (var_1_87 == ((double) var_1_5))) && (var_1_59 ? (var_1_88 == ((unsigned char) 10)) : 1)) && (var_1_60 ? (var_1_89 == ((signed short int) var_1_44)) : (var_1_89 == ((signed short int) var_1_39)))) && (var_1_90 == ((float) var_1_7))) && (var_1_91 == ((signed long int) var_1_38))) && (var_1_58 ? (var_1_92 == ((signed char) var_1_15)) : (var_1_92 == ((signed char) var_1_43)))) && (var_1_93 == ((unsigned char) var_1_15))) && (var_1_82 ? (var_1_94 == ((unsigned char) var_1_35)) : (var_1_94 == ((unsigned char) var_1_37)))) && (var_1_95 == ((signed char) var_1_38))) && (var_1_96 == ((unsigned char) var_1_36))) && (var_1_75 ? (var_1_97 == ((signed long int) var_1_52)) : 1)) && (var_1_74 ? (var_1_98 == ((signed long int) last_1_var_1_98)) : 1)) && ((var_1_54 > var_1_11) ? ((! var_1_84) ? ((var_1_83 || var_1_75) ? (var_1_99 == ((double) (var_1_9 - var_1_4))) : (var_1_99 == ((double) (max (var_1_6 , (var_1_100 + var_1_8)))))) : (var_1_99 == ((double) var_1_101))) : (var_1_99 == ((double) var_1_6)))
;
}
int main(void) {
	isInitial = 1;
