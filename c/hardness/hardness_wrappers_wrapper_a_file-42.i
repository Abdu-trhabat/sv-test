...
void step(void) {
 if (signed_short_int_Array_0[1] > signed_short_int_Array_0[0]) {
  signed_long_int_Array_0[4] = (((((signed_long_int_Array_0[3]) < (signed_long_int_Array_0[2])) ? (signed_long_int_Array_0[3]) : (signed_long_int_Array_0[2]))) - 10);
 } else {
  signed_long_int_Array_0[4] = (((((signed_long_int_Array_0[2] - signed_long_int_Array_0[1])) > ((signed_long_int_Array_0[3] - signed_long_int_Array_0[0]))) ? ((signed_long_int_Array_0[2] - signed_long_int_Array_0[1])) : ((signed_long_int_Array_0[3] - signed_long_int_Array_0[0]))));
 }
