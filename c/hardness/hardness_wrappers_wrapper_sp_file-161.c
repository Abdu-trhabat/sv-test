...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_3_Pointer)) < (((*(WrapperStruct00_var_1_1_Pointer)) * (*(WrapperStruct00_var_1_8_Pointer))) + (*(WrapperStruct00_var_1_9_Pointer)))) {
		(*(WrapperStruct00_var_1_11_Pointer)) = (abs (last_1_WrapperStruct00_var_1_11));
	}


	// From: Req3Batch161Wrapper_SP
