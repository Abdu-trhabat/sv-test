...
void step(void) {
	...
	// From: Req3Batch178Wrapper_S
	if (WrapperStruct00.var_1_8) {
		WrapperStruct00.var_1_14 = WrapperStruct00.var_1_21;
	} else {
		WrapperStruct00.var_1_14 = (min (WrapperStruct00.var_1_16 , (WrapperStruct00.var_1_21 - WrapperStruct00.var_1_15)));
	}


	// From: Req1Batch178Wrapper_S
