...
void step(void) {
 if (float_Array_0[1][0] <= (((((float_Array_0[1][1]) < (float_Array_0[0][1])) ? (float_Array_0[1][1]) : (float_Array_0[0][1]))) * float_Array_0[0][0])) {
  signed_long_int_Array_0[3] = (((((((((signed_long_int_Array_0[1] + signed_long_int_Array_0[2])) > (signed_long_int_Array_0[4])) ? ((signed_long_int_Array_0[1] + signed_long_int_Array_0[2])) : (signed_long_int_Array_0[4])))) > (((((signed_long_int_Array_0[0]) < 0 ) ? -(signed_long_int_Array_0[0]) : (signed_long_int_Array_0[0]))))) ? ((((((signed_long_int_Array_0[1] + signed_long_int_Array_0[2])) > (signed_long_int_Array_0[4])) ? ((signed_long_int_Array_0[1] + signed_long_int_Array_0[2])) : (signed_long_int_Array_0[4])))) : (((((signed_long_int_Array_0[0]) < 0 ) ? -(signed_long_int_Array_0[0]) : (signed_long_int_Array_0[0]))))));
 } else {
 ...
 if (stepLocal_0 != ((((signed_long_int_Array_0[1]) < (signed_long_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (signed_long_int_Array_0[0])))) {
...
int property(void) {
 return (((((((((((1.1f) < (float_Array_0[1][1])) ? (1.1f) : (float_Array_0[1][1]))) > (float_Array_0[0][1] * float_Array_0[1][0])) ? (BOOL_unsigned_char_Array_0[2] == ((unsigned char) (BOOL_unsigned_char_Array_0[0] && BOOL_unsigned_char_Array_0[1]))) : 1) && ((float_Array_0[1][0] <= (((((float_Array_0[1][1]) < (float_Array_0[0][1])) ? (float_Array_0[1][1]) : (float_Array_0[0][1]))) * float_Array_0[0][0])) ? (signed_long_int_Array_0[3] == ((signed long int) (((((((((signed_long_int_Array_0[1] + signed_long_int_Array_0[2])) > (signed_long_int_Array_0[4])) ? ((signed_long_int_Array_0[1] + signed_long_int_Array_0[2])) : (signed_long_int_Array_0[4])))) > (((((signed_long_int_Array_0[0]) < 0 ) ? -(signed_long_int_Array_0[0]) : (signed_long_int_Array_0[0]))))) ? ((((((signed_long_int_Array_0[1] + signed_long_int_Array_0[2])) > (signed_long_int_Array_0[4])) ? ((signed_long_int_Array_0[1] + signed_long_int_Array_0[2])) : (signed_long_int_Array_0[4])))) : (((((signed_long_int_Array_0[0]) < 0 ) ? -(signed_long_int_Array_0[0]) : (signed_long_int_Array_0[0])))))))) : (signed_long_int_Array_0[3] == ((signed long int) signed_long_int_Array_0[1])))) && (unsigned_long_int_Array_0[0] == ((unsigned long int) unsigned_long_int_Array_0[1]))) && ((signed_long_int_Array_0[3] != ((((signed_long_int_Array_0[1]) < (signed_long_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (signed_long_int_Array_0[0])))) ? (signed_char_Array_0[4] == ((signed char) ((((((10 + signed_char_Array_0[2])) < (signed_char_Array_0[3])) ? ((10 + signed_char_Array_0[2])) : (signed_char_Array_0[3]))) - ((32 - signed_char_Array_0[5]) + ((((signed_char_Array_0[6]) > (signed_char_Array_0[0])) ? (signed_char_Array_0[6]) : (signed_char_Array_0[0]))))))) : 1)) && (signed_short_int_Array_0[0] == ((signed short int) unsigned_long_int_Array_0[0]))) && (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[2]))) && (BOOL_unsigned_char_Array_0[0] == ((unsigned char) BOOL_unsigned_char_Array_0[1]))
;
}
int main(void) {
 isInitial = 1;
