...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch172Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch172Filler_PE_CN
	/* 969L, 254L, 772L, 778L) */ var_1_24 = (
		var_1_16
	);


	// From: Req4Batch172Filler_PE_CN
