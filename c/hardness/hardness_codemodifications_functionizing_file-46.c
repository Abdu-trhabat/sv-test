...
signed long int functionized1(signed char functionized1_localFunctionVar0) {
	return (abs (functionized1_localFunctionVar0));
}
...
void functionized5(unsigned char functionized5_localFunctionVar0, unsigned short int functionized5_localFunctionVar1, signed char functionized5_localFunctionVar2, signed char functionized5_localFunctionVar3) {
	if (functionized5_localFunctionVar3 == var_1_1) {
		var_1_21 = ((max (functionized5_localFunctionVar0 , var_1_1)) + (functionized5_localFunctionVar1 - functionized5_localFunctionVar2));
	} else {
		var_1_21 = var_1_1;
	}
}
...
void step(void) {
	// From: Req1Batch46functionizing
	functionized0(var_1_5, var_1_4);


	// From: Req2Batch46functionizing
	var_1_6 = (var_1_5 + var_1_4);


	// From: Req3Batch46functionizing
	if ((var_1_4 / var_1_8) != var_1_1) {
		var_1_7 = (min ((functionized1(var_1_9) + var_1_10) , var_1_11));
	} else {
		var_1_7 = (var_1_12 - var_1_13);
	}


	// From: Req4Batch46functionizing
	...
	// From: Req6Batch46functionizing
	if (functionized4(var_1_7) >= var_1_13) {
		var_1_20 = (max (-5 , (abs (var_1_4))));
	}


	// From: Req7Batch46functionizing
	functionized5(var_1_5, var_1_22, var_1_13, var_1_12);


	// From: Req8Batch46functionizing
	var_1_23 = var_1_24;


	// From: Req9Batch46functionizing
	var_1_25 = 64;
}
