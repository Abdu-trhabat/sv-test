...
void step(void) {
	...
	// From: Req2Batch12325_1loop
	var_1_7 = ((min (var_1_8 , var_1_9)) - (var_1_10 + 1));


	// From: Req3Batch12325_1loop
	...
	// From: Req4Batch12325_1loop
	var_1_17 = (max (0 , var_1_13));


	// From: Req5Batch12325_1loop
	var_1_18 = var_1_13;


	// From: Req6Batch12325_1loop
	var_1_19 = var_1_16;
}
