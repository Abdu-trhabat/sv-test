...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16150_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch16150_while
	unsigned short int stepLocal_1 = var_1_5;
	if ((abs (var_1_6 * 4u)) != stepLocal_1) {
		var_1_9 = (var_1_10 - 50u);
	}


	// From: Req3Batch16150_while
	var_1_11 = (64 + var_1_12);


	// From: Req4Batch16150_while
	var_1_13 = (min (var_1_14 , var_1_15));


	// From: Req5Batch16150_while
	unsigned char stepLocal_2 = var_1_11;
	if (stepLocal_2 >= var_1_8) {
		var_1_16 = (min (var_1_17 , 0));
	} else {
		var_1_16 = (max (((max (var_1_18 , var_1_19)) + (min (var_1_20 , var_1_21))) , var_1_17));
	}


	// From: Req6Batch16150_while
	if (var_1_7 || var_1_23) {
		var_1_22 = (min (var_1_15 , var_1_14));
	}


	// From: Req7Batch16150_while
	if (var_1_8 >= (- var_1_1)) {
	...
	// From: Req8Batch16150_while
	if (-25 <= var_1_12) {
		if (! var_1_7) {
			var_1_27 = var_1_15;
		} else {
			if ((var_1_5 + var_1_9) < var_1_6) {
				var_1_27 = (max (var_1_15 , var_1_14));
			} else {
				var_1_27 = var_1_15;
			}
		}
