...
void step(void) {
	...
	// From: Req2Batch182Wrapper_SP
	signed long int stepLocal_0 = min ((*(WrapperStruct00_var_1_2_Pointer)) , 10);
	if (-16 <= stepLocal_0) {
		(*(WrapperStruct00_var_1_7_Pointer)) = (*(WrapperStruct00_var_1_8_Pointer));
	} else {
		(*(WrapperStruct00_var_1_7_Pointer)) = (abs (1));
	}


	// From: Req3Batch182Wrapper_SP
	if ((*(WrapperStruct00_var_1_3_Pointer))) {
	...
	// From: Req4Batch182Wrapper_SP
	(*(WrapperStruct00_var_1_12_Pointer)) = (min ((max ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_11_Pointer)))) , (*(WrapperStruct00_var_1_6_Pointer))));


	// From: Req5Batch182Wrapper_SP
	if ((*(WrapperStruct00_var_1_3_Pointer))) {
		(*(WrapperStruct00_var_1_13_Pointer)) = (max (16.5 , ((*(WrapperStruct00_var_1_4_Pointer)) - 9.99999999975E9)));
	}


	// From: Req6Batch182Wrapper_SP
	if (((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_15_Pointer)))) - (*(WrapperStruct00_var_1_5_Pointer))) < (((*(WrapperStruct00_var_1_6_Pointer)) - (*(WrapperStruct00_var_1_16_Pointer))) * (- (*(WrapperStruct00_var_1_12_Pointer))))) {
		if ((*(WrapperStruct00_var_1_3_Pointer))) {
...
int property(void) {
	return ((((((! (*(WrapperStruct00_var_1_3_Pointer))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((float) ((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer)))) - (*(WrapperStruct00_var_1_6_Pointer))))) : 1) && ((-16 <= (min ((*(WrapperStruct00_var_1_2_Pointer)) , 10))) ? ((*(WrapperStruct00_var_1_7_Pointer)) == ((signed short int) (*(WrapperStruct00_var_1_8_Pointer)))) : ((*(WrapperStruct00_var_1_7_Pointer)) == ((signed short int) (abs (1)))))) && ((*(WrapperStruct00_var_1_3_Pointer)) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((float) ((*(WrapperStruct00_var_1_10_Pointer)) + (*(WrapperStruct00_var_1_11_Pointer))))) : ((*(WrapperStruct00_var_1_9_Pointer)) == ((float) (*(WrapperStruct00_var_1_4_Pointer)))))) && ((*(WrapperStruct00_var_1_12_Pointer)) == ((double) (min ((max ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_11_Pointer)))) , (*(WrapperStruct00_var_1_6_Pointer))))))) && ((*(WrapperStruct00_var_1_3_Pointer)) ? ((*(WrapperStruct00_var_1_13_Pointer)) == ((double) (max (16.5 , ((*(WrapperStruct00_var_1_4_Pointer)) - 9.99999999975E9))))) : 1)) && ((((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_15_Pointer)))) - (*(WrapperStruct00_var_1_5_Pointer))) < (((*(WrapperStruct00_var_1_6_Pointer)) - (*(WrapperStruct00_var_1_16_Pointer))) * (- (*(WrapperStruct00_var_1_12_Pointer))))) ? ((*(WrapperStruct00_var_1_3_Pointer)) ? ((*(WrapperStruct00_var_1_14_Pointer)) == ((float) (*(WrapperStruct00_var_1_5_Pointer)))) : ((*(WrapperStruct00_var_1_14_Pointer)) == ((float) 1.8199999999999998f))) : ((*(WrapperStruct00_var_1_14_Pointer)) == ((float) (*(WrapperStruct00_var_1_4_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
