...
void step(void) {
 ...
 if ((~ (*(var_1_6_Pointer))) < ((*(var_1_3_Pointer)) ^ (*(var_1_4_Pointer)))) {
  (*(var_1_13_Pointer)) = ((((((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) - (((((*(var_1_8_Pointer))) < 0 ) ? -((*(var_1_8_Pointer))) : ((*(var_1_8_Pointer)))))) < 0 ) ? -(((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) - (((((*(var_1_8_Pointer))) < 0 ) ? -((*(var_1_8_Pointer))) : ((*(var_1_8_Pointer)))))) : (((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) - (((((*(var_1_8_Pointer))) < 0 ) ? -((*(var_1_8_Pointer))) : ((*(var_1_8_Pointer))))))));
 }
...
int property(void) {
 return (((((*(var_1_2_Pointer)) > ((*(var_1_3_Pointer)) + ((*(var_1_4_Pointer)) + (*(var_1_5_Pointer))))) ? (((*(var_1_4_Pointer)) >= ((*(var_1_6_Pointer)) - (*(var_1_7_Pointer)))) ? ((*(var_1_1_Pointer)) == ((double) (*(var_1_8_Pointer)))) : 1) : 1) && ((((*(var_1_4_Pointer)) < (*(var_1_3_Pointer))) || (*(var_1_10_Pointer))) ? ((*(var_1_9_Pointer)) == ((unsigned char) (*(var_1_11_Pointer)))) : ((((*(var_1_2_Pointer)) / (*(var_1_12_Pointer))) < (*(var_1_5_Pointer))) ? ((*(var_1_9_Pointer)) == ((unsigned char) (*(var_1_11_Pointer)))) : ((*(var_1_9_Pointer)) == ((unsigned char) 0))))) && (((~ (*(var_1_6_Pointer))) < ((*(var_1_3_Pointer)) ^ (*(var_1_4_Pointer)))) ? ((*(var_1_13_Pointer)) == ((float) ((((((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) - (((((*(var_1_8_Pointer))) < 0 ) ? -((*(var_1_8_Pointer))) : ((*(var_1_8_Pointer)))))) < 0 ) ? -(((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) - (((((*(var_1_8_Pointer))) < 0 ) ? -((*(var_1_8_Pointer))) : ((*(var_1_8_Pointer)))))) : (((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))) - (((((*(var_1_8_Pointer))) < 0 ) ? -((*(var_1_8_Pointer))) : ((*(var_1_8_Pointer)))))))))) : 1)) && ((((*(var_1_17_Pointer)) - (*(var_1_18_Pointer))) <= ((*(var_1_7_Pointer)) << (*(var_1_5_Pointer)))) ? ((*(var_1_16_Pointer)) == ((double) (*(var_1_8_Pointer)))) : 1)
;
}
int main(void) {
 isInitial = 1;
