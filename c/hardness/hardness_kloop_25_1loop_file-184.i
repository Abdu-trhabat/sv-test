...
void step(void) {
 unsigned long int stepLocal_1 = ((((last_1_var_1_1) > (last_1_var_1_14)) ? (last_1_var_1_1) : (last_1_var_1_14))) / ((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8)));
 if ((var_1_5 + var_1_4) > stepLocal_1) {
  var_1_6 = ((((var_1_4) > (last_1_var_1_1)) ? (var_1_4) : (last_1_var_1_1)));
 }
 var_1_14 = var_1_6;
...
int property(void) {
 return (((((var_1_2 <= var_1_3) ? (var_1_1 == ((unsigned char) (var_1_4 - 32))) : (var_1_1 == ((unsigned char) ((((((((var_1_4) > (100)) ? (var_1_4) : (100)))) > (var_1_5)) ? (((((var_1_4) > (100)) ? (var_1_4) : (100)))) : (var_1_5)))))) && (((var_1_5 + var_1_4) > (((((last_1_var_1_1) > (last_1_var_1_14)) ? (last_1_var_1_1) : (last_1_var_1_14))) / ((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8))))) ? (var_1_6 == ((unsigned short int) ((((var_1_4) > (last_1_var_1_1)) ? (var_1_4) : (last_1_var_1_1))))) : 1)) && ((((var_1_1 + var_1_8) + var_1_14) < var_1_5) ? (var_1_10 ? (var_1_9 == ((float) var_1_11)) : (var_1_9 == ((float) var_1_12))) : (var_1_9 == ((float) var_1_11)))) && (var_1_13 == ((unsigned long int) var_1_1))) && (var_1_14 == ((unsigned long int) var_1_6))
;
}
int main(void) {
 isInitial = 1;
