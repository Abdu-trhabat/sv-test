...
void step(void) {
	...
	if ((- (var_1_17 / var_1_14)) > var_1_17) {
		...
		var_1_12 = (max ((abs (var_1_10)) , (abs (var_1_16 - var_1_6))));
	}
...
int property(void) {
	return (((((((var_1_12 / var_1_3) >= var_1_12) ? (((- var_1_3) > var_1_12) ? (var_1_1 == ((unsigned short int) (min (var_1_5 , var_1_6)))) : 1) : 1) && (var_1_7 == ((unsigned short int) var_1_5))) && (((var_1_12 / var_1_3) != (var_1_5 - 64)) ? (var_1_8 == ((unsigned char) (max (var_1_10 , var_1_11)))) : (var_1_8 == ((unsigned char) (min (var_1_11 , var_1_10)))))) && (((- (var_1_17 / var_1_14)) > var_1_17) ? (var_1_12 == ((unsigned long int) (16u + var_1_7))) : (var_1_12 == ((unsigned long int) (max ((abs (var_1_10)) , (abs (var_1_16 - var_1_6)))))))) && (var_1_17 == ((float) var_1_18))) && (var_1_19 == ((signed char) var_1_20))
;
}
int main(void) {
	isInitial = 1;
