...
void step(void) {
 ...
 if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) || stepLocal_0) {
  (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) = ((256 + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer))) - (((((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))) < ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))) ? ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))) : ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))));
 } else {
