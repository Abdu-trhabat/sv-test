...
void step(void) {
	...
	signed long int stepLocal_5 = abs (last_1_var_1_61);
	if (var_1_29 == stepLocal_5) {
		var_1_40 = (max ((var_1_23 + 100) , ((last_1_var_1_61 + 16) + var_1_24)));
	} else {
		var_1_40 = (42672 - (abs (var_1_9)));
	}
	...
	if (((var_1_27 + var_1_28) - var_1_20) > ((- var_1_15) / var_1_12)) {
		if (var_1_15 >= var_1_27) {
			var_1_26 = ((abs (var_1_9)) + (max (last_1_var_1_40 , var_1_7)));
		}
	} else {
		if (last_1_var_1_52) {
			var_1_26 = ((max (var_1_29 , (max (var_1_30 , var_1_31)))) - (min (var_1_9 , (var_1_32 - var_1_7))));
		}
	}
	...
	if (var_1_26 >= (min ((- 32) , (var_1_40 | var_1_9)))) {
	...
	if (128 >= (var_1_39 * var_1_44)) {
		if ((var_1_25 - var_1_8) <= var_1_33) {
			var_1_47 = (min (var_1_39 , ((var_1_48 - var_1_24) - var_1_37)));
		}
	} else {
		if (((var_1_28 * var_1_63) / (max (var_1_17 , var_1_34))) < (- var_1_13)) {
			var_1_47 = (max (var_1_48 , ((var_1_39 - 2) + var_1_24)));
		} else {
	...
	if (var_1_18 <= (max (var_1_28 , var_1_18))) {
		var_1_55 = (! (! var_1_53));
	}
	...
	if (stepLocal_1 && ((var_1_8 % -25) <= (var_1_7 - var_1_1))) {
		...
		var_1_22 = (max (((64 + var_1_25) - var_1_24) , var_1_23));
	}


	// From: Req9Batch82Amount250
	signed long int stepLocal_7 = (min (var_1_25 , var_1_37)) - var_1_24;
	...
	if (stepLocal_8 <= var_1_9) {
		if (! var_1_55) {
			var_1_42 = (var_1_39 + ((min (-5 , var_1_24)) + -2));
		} else {
			if (stepLocal_9 >= (abs (64))) {
				var_1_42 = (min (var_1_37 , var_1_24));
			}
		}
	}
	...
	if (var_1_54 || stepLocal_16) {
		if (! var_1_55) {
			var_1_59 = (max (var_1_15 , var_1_13));
		}
	} else {
		if (var_1_13 <= 0.25f) {
			var_1_59 = var_1_21;
		} else {
			var_1_59 = (min ((var_1_60 - var_1_21) , var_1_15));
		}
	}
	...
	unsigned long int stepLocal_12 = max (var_1_40 , var_1_30);
	...
	if ((var_1_39 / var_1_44) != stepLocal_13) {
		if (var_1_55) {
			...
			var_1_43 = ((min (var_1_16 , var_1_15)) + var_1_14);
		}
	} else {
		if (! var_1_52) {
	...
	if (stepLocal_17 <= (var_1_23 - var_1_48)) {
		if (stepLocal_19 <= (max (var_1_26 , (16 << var_1_26)))) {
...
int property(void) {
	return ((((((((((((((((((var_1_52 ? (((var_1_26 <= last_1_var_1_1) || (var_1_11 >= var_1_18)) ? (var_1_1 == ((unsigned short int) (max ((var_1_7 - 16) , var_1_8)))) : (var_1_1 == ((unsigned short int) (var_1_7 - ((10000 - 32) + var_1_9))))) : (var_1_1 == ((unsigned short int) (var_1_9 + var_1_10)))) && ((32.8f > ((last_1_var_1_43 * last_1_var_1_62) / var_1_12)) ? (var_1_11 == ((float) (var_1_13 + ((min (var_1_14 , var_1_15)) + var_1_16)))) : ((((var_1_15 / var_1_12) / var_1_17) > var_1_16) ? (var_1_11 == ((float) (var_1_15 + var_1_14))) : 1))) && ((var_1_26 >= (min ((- 32) , (var_1_40 | var_1_9)))) ? (var_1_18 == ((double) (var_1_14 + (var_1_16 + var_1_15)))) : (var_1_18 == ((double) (min ((var_1_16 + var_1_15) , (var_1_20 - var_1_21))))))) && ((var_1_55 && ((var_1_8 % -25) <= (var_1_7 - var_1_1))) ? (var_1_22 == ((unsigned char) (var_1_23 - (25 + (50 - var_1_24))))) : (var_1_22 == ((unsigned char) (max (((64 + var_1_25) - var_1_24) , var_1_23)))))) && ((((var_1_27 + var_1_28) - var_1_20) > ((- var_1_15) / var_1_12)) ? ((var_1_15 >= var_1_27) ? (var_1_26 == ((unsigned long int) ((abs (var_1_9)) + (max (last_1_var_1_40 , var_1_7))))) : 1) : (last_1_var_1_52 ? (var_1_26 == ((unsigned long int) ((max (var_1_29 , (max (var_1_30 , var_1_31)))) - (min (var_1_9 , (var_1_32 - var_1_7)))))) : 1))) && ((var_1_13 > ((var_1_34 - 31.75f) - var_1_27)) ? ((var_1_28 < (abs (- var_1_12))) ? (var_1_33 == ((unsigned char) (var_1_25 + var_1_24))) : (((- var_1_10) != var_1_57) ? (var_1_33 == ((unsigned char) var_1_24)) : 1)) : ((var_1_24 < var_1_40) ? ((var_1_13 >= 64.85f) ? (var_1_33 == ((unsigned char) var_1_24)) : (var_1_33 == ((unsigned char) var_1_23))) : (var_1_33 == ((unsigned char) var_1_24))))) && (var_1_55 ? ((var_1_1 == var_1_26) ? ((-10 != (var_1_10 * (var_1_36 * var_1_23))) ? (var_1_35 == ((unsigned char) (var_1_24 + var_1_25))) : (var_1_35 == ((unsigned char) var_1_24))) : (var_1_35 == ((unsigned char) ((var_1_24 + var_1_37) + var_1_25)))) : ((var_1_52 && ((- var_1_30) > (var_1_10 * var_1_1))) ? (var_1_35 == ((unsigned char) ((200 - (var_1_24 + var_1_39)) - var_1_37))) : 1))) && ((var_1_29 == (abs (last_1_var_1_61))) ? (var_1_40 == ((unsigned short int) (max ((var_1_23 + 100) , ((last_1_var_1_61 + 16) + var_1_24))))) : (var_1_40 == ((unsigned short int) (42672 - (abs (var_1_9))))))) && ((((min (var_1_25 , var_1_37)) - var_1_24) < ((var_1_26 / var_1_7) / var_1_23)) ? ((var_1_52 && var_1_55) ? ((var_1_16 <= (var_1_21 * 2.5f)) ? (var_1_41 == ((signed short int) var_1_37)) : (var_1_41 == ((signed short int) var_1_9))) : (var_1_41 == ((signed short int) var_1_25))) : 1)) && ((var_1_1 <= var_1_9) ? ((! var_1_55) ? (var_1_42 == ((signed char) (var_1_39 + ((min (-5 , var_1_24)) + -2)))) : ((var_1_26 >= (abs (64))) ? (var_1_42 == ((signed char) (min (var_1_37 , var_1_24)))) : 1)) : 1)) && (((var_1_39 / var_1_44) != (abs (var_1_35))) ? (var_1_55 ? (var_1_43 == ((double) var_1_21)) : (var_1_43 == ((double) ((min (var_1_16 , var_1_15)) + var_1_14)))) : ((! var_1_52) ? ((var_1_52 && var_1_55) ? (var_1_43 == ((double) var_1_21)) : (((var_1_26 | (var_1_8 * 1u)) >= (max (var_1_40 , var_1_30))) ? ((-8 <= var_1_10) ? (var_1_43 == ((double) var_1_16)) : (var_1_43 == ((double) var_1_15))) : 1)) : (var_1_43 == ((double) var_1_14))))) && ((128 >= (var_1_39 * var_1_44)) ? (((var_1_25 - var_1_8) <= var_1_33) ? (var_1_47 == ((signed char) (min (var_1_39 , ((var_1_48 - var_1_24) - var_1_37))))) : 1) : ((((var_1_28 * var_1_63) / (max (var_1_17 , var_1_34))) < (- var_1_13)) ? (var_1_47 == ((signed char) (max (var_1_48 , ((var_1_39 - 2) + var_1_24))))) : (var_1_47 == ((signed char) (var_1_39 + ((var_1_24 + var_1_49) - (var_1_50 - var_1_51)))))))) && (var_1_52 == ((unsigned char) (var_1_53 || var_1_54)))) && ((var_1_18 <= (max (var_1_28 , var_1_18))) ? (var_1_55 == ((unsigned char) (! (! var_1_53)))) : 1)) && (((var_1_26 / var_1_50) > var_1_26) ? ((var_1_31 != var_1_37) ? (var_1_57 == ((signed short int) var_1_37)) : 1) : 1)) && ((var_1_54 || (var_1_1 >= var_1_9)) ? ((! var_1_55) ? (var_1_59 == ((float) (max (var_1_15 , var_1_13)))) : 1) : ((var_1_13 <= 0.25f) ? (var_1_59 == ((float) var_1_21)) : (var_1_59 == ((float) (min ((var_1_60 - var_1_21) , var_1_15))))))) && ((var_1_33 <= (var_1_23 - var_1_48)) ? ((var_1_49 <= (max (var_1_26 , (16 << var_1_26)))) ? (((var_1_39 + var_1_29) >= var_1_9) ? (var_1_61 == ((unsigned char) (var_1_51 + var_1_50))) : ((var_1_11 <= var_1_43) ? (var_1_61 == ((unsigned char) var_1_37)) : 1)) : 1) : (var_1_61 == ((unsigned char) var_1_48)))) && ((var_1_54 && var_1_55) ? (var_1_62 == ((float) (var_1_16 + var_1_13))) : 1)) && (var_1_63 == ((float) var_1_20))
;
}
int main(void) {
	isInitial = 1;
