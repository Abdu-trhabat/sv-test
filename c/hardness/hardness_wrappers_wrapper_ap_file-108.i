...
void step(void) {
 if (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) * (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) != ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) & (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)))) {
  (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) = (((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer))) > ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)))) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer))) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)))));
 } else {
 ...
 if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
  (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)) = (((((((((*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer))) > ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)))) ? ((*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer))) : ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)))))) > ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)))) ? ((((((*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer))) > ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)))) ? ((*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer))) : ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)))))) : ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)))));
 }
