...
void step(void) {
	// From: Req1Batch111Wrapper_S
	unsigned char stepLocal_0 = WrapperStruct00.var_1_6;
	if (WrapperStruct00.var_1_2 < WrapperStruct00.var_1_3) {
		WrapperStruct00.var_1_1 = (min (1.25 , WrapperStruct00.var_1_4));
	} else {
		if (WrapperStruct00.var_1_5 || stepLocal_0) {
			WrapperStruct00.var_1_1 = ((abs (WrapperStruct00.var_1_7)) + WrapperStruct00.var_1_8);
		}
	}


	// From: Req4Batch111Wrapper_S
	...
	// From: Req2Batch111Wrapper_S
	if (WrapperStruct00.var_1_7 != (max ((WrapperStruct00.var_1_8 * WrapperStruct00.var_1_15) , WrapperStruct00.var_1_15))) {
...
int property(void) {
	return ((((WrapperStruct00.var_1_2 < WrapperStruct00.var_1_3) ? (WrapperStruct00.var_1_1 == ((double) (min (1.25 , WrapperStruct00.var_1_4)))) : ((WrapperStruct00.var_1_5 || WrapperStruct00.var_1_6) ? (WrapperStruct00.var_1_1 == ((double) ((abs (WrapperStruct00.var_1_7)) + WrapperStruct00.var_1_8))) : 1)) && ((WrapperStruct00.var_1_7 != (max ((WrapperStruct00.var_1_8 * WrapperStruct00.var_1_15) , WrapperStruct00.var_1_15))) ? ((WrapperStruct00.var_1_7 <= WrapperStruct00.var_1_15) ? (WrapperStruct00.var_1_6 ? (WrapperStruct00.var_1_9 == ((signed long int) WrapperStruct00.var_1_10)) : 1) : 1) : (WrapperStruct00.var_1_9 == ((signed long int) WrapperStruct00.var_1_10)))) && ((WrapperStruct00.var_1_8 <= WrapperStruct00.var_1_15) ? (WrapperStruct00.var_1_11 == ((unsigned short int) (32 + (WrapperStruct00.var_1_12 + (WrapperStruct00.var_1_13 - WrapperStruct00.var_1_14))))) : 1)) && ((WrapperStruct00.var_1_14 >= WrapperStruct00.var_1_12) ? ((last_1_WrapperStruct00_var_1_15 > WrapperStruct00.var_1_8) ? ((WrapperStruct00.var_1_4 >= WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_15 == ((double) WrapperStruct00.var_1_8)) : (WrapperStruct00.var_1_15 == ((double) WrapperStruct00.var_1_4))) : 1) : (WrapperStruct00.var_1_15 == ((double) WrapperStruct00.var_1_8)))
;
}
int main(void) {
	isInitial = 1;
