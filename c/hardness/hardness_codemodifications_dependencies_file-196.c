...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch196dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch196dependencies
	if (var_1_18 >= var_1_21) {
		var_1_23 = (min (var_1_18 , var_1_24));
	}


	// From: Req7Batch196dependencies
	var_1_25 = var_1_17;


	// From: Req8Batch196dependencies
	var_1_26 = var_1_24;


	// From: Req9Batch196dependencies
	var_1_27 = var_1_16;
}
