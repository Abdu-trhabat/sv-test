...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch191dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch191dependencies
	if (var_1_2 >= (max ((max (var_1_3 , last_1_var_1_1)) , var_1_5))) {
	...
	// From: Req6Batch191dependencies
	var_1_17 = (var_1_18 + var_1_19);


	// From: Req7Batch191dependencies
	var_1_20 = (var_1_21 - (var_1_22 + var_1_23));


	// From: Req8Batch191dependencies
	if ((var_1_20 == (var_1_1 * var_1_22)) || var_1_11) {
		var_1_24 = var_1_18;
	}


	// From: Req3Batch191dependencies
	if ((var_1_6 >= (min (last_1_var_1_10 , var_1_1))) && var_1_25) {
		var_1_10 = (abs (max (var_1_6 , var_1_7)));
	}


	// From: Req5Batch191dependencies
	if (var_1_1 > var_1_10) {
