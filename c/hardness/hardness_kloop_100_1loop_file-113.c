...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch113100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch113100_1loop
	unsigned char stepLocal_1 = 5 < var_1_9;
	if (stepLocal_1 && (var_1_4 < var_1_8)) {
		var_1_14 = (abs ((var_1_15 - var_1_16) - (var_1_17 - var_1_18)));
	}


	// From: Req4Batch113100_1loop
	if ((var_1_15 | var_1_7) < var_1_3) {
		var_1_19 = 1;
	}


	// From: Req7Batch113100_1loop
	...
	// From: Req8Batch113100_1loop
	var_1_31 = (abs (var_1_24));


	// From: Req10Batch113100_1loop
	signed long int stepLocal_7 = abs (var_1_17);
	...
	if (stepLocal_7 <= ((var_1_35 - var_1_27) >> (var_1_36 + var_1_37))) {
		if (stepLocal_6 > var_1_6) {
			var_1_34 = (max (var_1_17 , var_1_15));
		}
	} else {
		var_1_34 = var_1_28;
	}
	...
	// From: Req11Batch113100_1loop
	var_1_38 = (max ((var_1_17 + var_1_18) , var_1_28));


	// From: Req12Batch113100_1loop
	...
	if (stepLocal_8 > var_1_38) {
		if (var_1_22) {
			if (var_1_23 == var_1_31) {
				...
				var_1_39 = (min ((abs (var_1_38)) , ((var_1_40 - var_1_37) - var_1_7)));
			}
		} else {
			var_1_39 = ((min (var_1_37 , var_1_19)) + var_1_8);
		}
	} else {
		var_1_39 = var_1_28;
	}
	...
	// From: Req13Batch113100_1loop
	var_1_41 = var_1_28;


	// From: Req9Batch113100_1loop
	if (var_1_23 < (- var_1_31)) {
		var_1_32 = var_1_3;
	} else {
		var_1_32 = ((max (var_1_4 , 256u)) + var_1_39);
	}


	// From: Req5Batch113100_1loop
...
int property(void) {
	return ((((((((((((last_1_var_1_20 ? (var_1_1 == ((unsigned short int) (max (var_1_3 , var_1_4)))) : (var_1_1 == ((unsigned short int) (((var_1_5 - var_1_6) + var_1_7) - var_1_8)))) && (((var_1_10 - var_1_11) != var_1_8) ? (var_1_9 == ((unsigned long int) last_1_var_1_41)) : (((25.8f + last_1_var_1_23) >= last_1_var_1_23) ? (var_1_9 == ((unsigned long int) (last_1_var_1_41 + var_1_5))) : 1))) && (((5 < var_1_9) && (var_1_4 < var_1_8)) ? (var_1_14 == ((unsigned char) (abs ((var_1_15 - var_1_16) - (var_1_17 - var_1_18))))) : 1)) && (((var_1_15 | var_1_7) < var_1_3) ? (var_1_19 == ((unsigned char) 1)) : 1)) && ((var_1_34 > var_1_1) ? (var_1_20 == ((unsigned char) (var_1_21 || var_1_22))) : 1)) && ((var_1_15 >= var_1_16) ? ((var_1_7 < var_1_11) ? ((var_1_7 != (var_1_5 | var_1_9)) ? (var_1_23 == ((double) (var_1_24 + var_1_25))) : 1) : 1) : 1)) && ((var_1_16 >= (var_1_3 * 128)) ? ((var_1_18 >= (var_1_17 & var_1_5)) ? (var_1_21 ? (var_1_26 == ((signed char) ((var_1_27 - (var_1_28 + var_1_29)) - var_1_18))) : (var_1_26 == ((signed char) var_1_30))) : (var_1_26 == ((signed char) var_1_16))) : (var_1_26 == ((signed char) var_1_18)))) && (var_1_31 == ((double) (abs (var_1_24))))) && ((var_1_23 < (- var_1_31)) ? (var_1_32 == ((unsigned long int) var_1_3)) : (var_1_32 == ((unsigned long int) ((max (var_1_4 , 256u)) + var_1_39))))) && (((abs (var_1_17)) <= ((var_1_35 - var_1_27) >> (var_1_36 + var_1_37))) ? ((((var_1_9 + var_1_29) * var_1_8) > var_1_6) ? (var_1_34 == ((unsigned char) (max (var_1_17 , var_1_15)))) : 1) : (var_1_34 == ((unsigned char) var_1_28)))) && (var_1_38 == ((unsigned char) (max ((var_1_17 + var_1_18) , var_1_28))))) && ((var_1_9 > var_1_38) ? (var_1_22 ? ((var_1_23 == var_1_31) ? (var_1_39 == ((unsigned short int) ((28228 + (32533 - var_1_16)) - var_1_7))) : (var_1_39 == ((unsigned short int) (min ((abs (var_1_38)) , ((var_1_40 - var_1_37) - var_1_7)))))) : (var_1_39 == ((unsigned short int) ((min (var_1_37 , var_1_19)) + var_1_8)))) : (var_1_39 == ((unsigned short int) var_1_28)))) && (var_1_41 == ((unsigned short int) var_1_28))
;
}
int main(void) {
	isInitial = 1;
