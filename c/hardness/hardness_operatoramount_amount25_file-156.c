...
void step(void) {
	...
	// From: Req1Batch156Amount25
	if (last_1_var_1_16 <= last_1_var_1_6) {
		var_1_1 = (min (var_1_4 , var_1_5));
	}


	// From: Req5Batch156Amount25
	var_1_14 = var_1_10;


	// From: Req6Batch156Amount25
	var_1_15 = var_1_10;


	// From: Req7Batch156Amount25
	var_1_16 = var_1_17;


	// From: Req4Batch156Amount25
