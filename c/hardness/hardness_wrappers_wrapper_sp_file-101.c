...
void step(void) {
	...
	// From: Req2Batch101Wrapper_SP
	if ((*(WrapperStruct00_var_1_5_Pointer)) > (*(WrapperStruct00_var_1_4_Pointer))) {
		(*(WrapperStruct00_var_1_9_Pointer)) = (min ((*(WrapperStruct00_var_1_10_Pointer)) , (max ((min ((*(WrapperStruct00_var_1_11_Pointer)) , (*(WrapperStruct00_var_1_12_Pointer)))) , (*(WrapperStruct00_var_1_13_Pointer))))));
	} else {
		if ((*(WrapperStruct00_var_1_2_Pointer))) {
	...
	// From: Req3Batch101Wrapper_SP
	if (((*(WrapperStruct00_var_1_1_Pointer)) / (*(WrapperStruct00_var_1_3_Pointer))) > (-1000 % (abs (16)))) {
