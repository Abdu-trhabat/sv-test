...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch58Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch58Amount100
	unsigned long int stepLocal_0 = max (-256 , (last_1_var_1_11 / var_1_6));
	...
	// From: Req2Batch58Amount100
	if (var_1_2) {
		var_1_7 = (var_1_1 + ((max (var_1_4 , var_1_8)) + (var_1_9 + var_1_10)));
	} else {
		var_1_7 = (var_1_10 + var_1_1);
	}


	// From: Req3Batch58Amount100
	if (var_1_2) {
		var_1_11 = (var_1_4 + last_1_var_1_16);
	}


	// From: Req6Batch58Amount100
	unsigned char stepLocal_3 = var_1_2;
	if (stepLocal_3 || ((max (last_1_var_1_42 , last_1_var_1_32)) < (min (var_1_15 , last_1_var_1_16)))) {
		var_1_17 = (max (1u , (var_1_4 + last_1_var_1_17)));
	} else {
		var_1_17 = var_1_19;
	}


	// From: Req7Batch58Amount100
	if (var_1_2) {
	...
	// From: Req9Batch58Amount100
	if (var_1_2 && var_1_25) {
		var_1_30 = (max (var_1_21 , var_1_23));
	}


	// From: Req10Batch58Amount100
	var_1_31 = (min ((min (var_1_24 , var_1_22)) , (var_1_23 - var_1_21)));


	// From: Req12Batch58Amount100
	var_1_41 = var_1_22;


	// From: Req13Batch58Amount100
	var_1_42 = 256;


	// From: Req5Batch58Amount100
	unsigned long int stepLocal_2 = var_1_17;
	if (var_1_6 >= stepLocal_2) {
		var_1_16 = (min (var_1_10 , var_1_11));
	} else {
		var_1_16 = (32 + var_1_42);
	}


	// From: Req4Batch58Amount100
	unsigned long int stepLocal_1 = min (var_1_26 , (var_1_13 - var_1_17));
	if (var_1_17 <= stepLocal_1) {
		var_1_12 = (max (var_1_14 , var_1_15));
	}


	// From: Req11Batch58Amount100
	if (var_1_25) {
		...
		if (var_1_31 > (min (var_1_22 , 15.615f))) {
...
int property(void) {
	return ((((((((((((((last_1_var_1_7 / (8 + var_1_4)) > (max (-256 , (last_1_var_1_11 / var_1_6)))) ? (var_1_1 == ((unsigned short int) last_1_var_1_7)) : (var_1_1 == ((unsigned short int) 2))) && (var_1_2 ? (var_1_7 == ((signed short int) (var_1_1 + ((max (var_1_4 , var_1_8)) + (var_1_9 + var_1_10))))) : (var_1_7 == ((signed short int) (var_1_10 + var_1_1))))) && (var_1_2 ? (var_1_11 == ((unsigned long int) (var_1_4 + last_1_var_1_16))) : 1)) && ((var_1_17 <= (min (var_1_26 , (var_1_13 - var_1_17)))) ? (var_1_12 == ((signed char) (max (var_1_14 , var_1_15)))) : 1)) && ((var_1_6 >= var_1_17) ? (var_1_16 == ((signed long int) (min (var_1_10 , var_1_11)))) : (var_1_16 == ((signed long int) (32 + var_1_42))))) && ((var_1_2 || ((max (last_1_var_1_42 , last_1_var_1_32)) < (min (var_1_15 , last_1_var_1_16)))) ? (var_1_17 == ((unsigned long int) (max (1u , (var_1_4 + last_1_var_1_17))))) : (var_1_17 == ((unsigned long int) var_1_19)))) && (var_1_2 ? (var_1_20 == ((float) (min ((var_1_21 - var_1_22) , (var_1_23 - var_1_24))))) : ((((var_1_4 - var_1_1) == var_1_15) || var_1_25) ? (var_1_20 == ((float) var_1_22)) : 1))) && (var_1_25 ? (var_1_2 ? (var_1_26 == ((unsigned char) (max (var_1_4 , var_1_27)))) : (var_1_26 == ((unsigned char) ((min (4 , var_1_4)) + (max (var_1_28 , var_1_29)))))) : 1)) && ((var_1_2 && var_1_25) ? (var_1_30 == ((float) (max (var_1_21 , var_1_23)))) : 1)) && (var_1_31 == ((double) (min ((min (var_1_24 , var_1_22)) , (var_1_23 - var_1_21)))))) && (var_1_25 ? ((var_1_15 > (var_1_12 * var_1_11)) ? ((! var_1_2) ? (var_1_32 == ((signed char) (var_1_33 + var_1_34))) : (var_1_32 == ((signed char) (abs (var_1_34 + var_1_33))))) : (var_1_32 == ((signed char) (var_1_35 - var_1_36)))) : ((var_1_31 > (min (var_1_22 , 15.615f))) ? (var_1_32 == ((signed char) (var_1_34 + (abs (var_1_37 - var_1_38))))) : (var_1_2 ? (var_1_32 == ((signed char) (var_1_37 + var_1_38))) : ((var_1_17 == var_1_29) ? (((- var_1_17) >= var_1_4) ? (var_1_32 == ((signed char) ((var_1_39 + var_1_40) + var_1_38))) : 1) : (var_1_32 == ((signed char) var_1_35))))))) && (var_1_41 == ((float) var_1_22))) && (var_1_42 == ((unsigned short int) 256))
;
}
int main(void) {
	isInitial = 1;
