...
void step(void) {
	// From: Req1Batch160Wrapper_P
	signed long int stepLocal_0 = (*(var_1_2_Pointer));
	if (stepLocal_0 >= ((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) {
		(*(var_1_1_Pointer)) = ((*(var_1_5_Pointer)) - (((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))) + (max ((*(var_1_8_Pointer)) , (*(var_1_9_Pointer))))));
	} else {
		(*(var_1_1_Pointer)) = (*(var_1_8_Pointer));
	}


	// From: Req2Batch160Wrapper_P
	signed char stepLocal_1 = (*(var_1_6_Pointer));
	if (stepLocal_1 >= ((*(var_1_9_Pointer)) / (min ((*(var_1_11_Pointer)) , (*(var_1_12_Pointer)))))) {
		(*(var_1_10_Pointer)) = (max ((*(var_1_13_Pointer)) , 5.8));
	} else {
		(*(var_1_10_Pointer)) = (*(var_1_14_Pointer));
	}


	// From: Req3Batch160Wrapper_P
	...
	if (stepLocal_2 == (*(var_1_9_Pointer))) {
		...
		(*(var_1_15_Pointer)) = ((*(var_1_8_Pointer)) - ((min ((*(var_1_16_Pointer)) , (*(var_1_17_Pointer)))) - (*(var_1_6_Pointer))));
	}


	// From: Req4Batch160Wrapper_P
...
int property(void) {
	return (((((*(var_1_2_Pointer)) >= ((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed char) ((*(var_1_5_Pointer)) - (((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))) + (max ((*(var_1_8_Pointer)) , (*(var_1_9_Pointer)))))))) : ((*(var_1_1_Pointer)) == ((signed char) (*(var_1_8_Pointer))))) && (((*(var_1_6_Pointer)) >= ((*(var_1_9_Pointer)) / (min ((*(var_1_11_Pointer)) , (*(var_1_12_Pointer)))))) ? ((*(var_1_10_Pointer)) == ((double) (max ((*(var_1_13_Pointer)) , 5.8)))) : ((*(var_1_10_Pointer)) == ((double) (*(var_1_14_Pointer)))))) && ((((*(var_1_12_Pointer)) * (*(var_1_11_Pointer))) == (*(var_1_9_Pointer))) ? ((*(var_1_15_Pointer)) == ((signed long int) ((*(var_1_7_Pointer)) + (*(var_1_11_Pointer))))) : ((*(var_1_15_Pointer)) == ((signed long int) ((*(var_1_8_Pointer)) - ((min ((*(var_1_16_Pointer)) , (*(var_1_17_Pointer)))) - (*(var_1_6_Pointer)))))))) && ((((*(var_1_7_Pointer)) << (*(var_1_16_Pointer))) != ((*(var_1_17_Pointer)) ^ (*(var_1_9_Pointer)))) ? ((*(var_1_19_Pointer)) ? ((*(var_1_18_Pointer)) == ((float) (*(var_1_14_Pointer)))) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
