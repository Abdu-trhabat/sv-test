...
void step(void) {
	// From: Req3Batch187dependencies
	if (var_1_2) {
		var_1_9 = (max ((max (var_1_10 , var_1_11)) , var_1_12));
	}


	// From: Req4Batch187dependencies
	...
	// From: Req7Batch187dependencies
	var_1_23 = var_1_18;


	// From: Req8Batch187dependencies
	var_1_24 = 32;


	// From: Req9Batch187dependencies
	var_1_25 = var_1_18;


	// From: Req2Batch187dependencies
	...
	// From: Req6Batch187dependencies
	if ((var_1_25 % (abs (var_1_19))) >= (var_1_24 * var_1_16)) {
