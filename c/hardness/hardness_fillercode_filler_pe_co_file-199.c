...
void step(void) {
	// From: Req6Batch199Filler_PE_CO
	/* 1146L, 341L, 945L, 951L) */ var_1_21 = (
		var_1_20
	);


	// From: Req7Batch199Filler_PE_CO
	/* 1152L, 351L, 969L, 975L) */ var_1_22 = (
		var_1_20
	);


	// From: Req3Batch199Filler_PE_CO
