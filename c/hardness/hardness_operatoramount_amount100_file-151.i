...
void step(void) {
 ...
 if ((((((var_1_36 + var_1_12)) < (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))))) ? ((var_1_36 + var_1_12)) : (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))))) >= stepLocal_2) {
  var_1_18 = var_1_12;
 }
 unsigned long int stepLocal_6 = var_1_11 + var_1_10;
 if (stepLocal_6 > var_1_27) {
  var_1_29 = ((((var_1_8) < (((var_1_12 + last_1_var_1_29) - var_1_7))) ? (var_1_8) : (((var_1_12 + last_1_var_1_29) - var_1_7))));
 } else {
 ...
 if (var_1_14) {
  if (var_1_8 >= 1) {
   ...
   var_1_33 = (var_1_34 - ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))));
  }
 } else {
  if (var_1_12 > (((((var_1_34 - var_1_35)) < ((- var_1_29))) ? ((var_1_34 - var_1_35)) : ((- var_1_29))))) {
   var_1_33 = (((((5) < (var_1_12)) ? (5) : (var_1_12))) + 16);
  }
 }
 signed long int stepLocal_3 = (((var_1_29) < (var_1_28)) ? (var_1_29) : (var_1_28));
 if (var_1_14) {
  if (var_1_14) {
   var_1_21 = (((((var_1_22) < (var_1_23)) ? (var_1_22) : (var_1_23))) + var_1_24);
  } else {
 ...
 if ((((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23))) * (var_1_22 + var_1_21)) >= ((var_1_26 - 9999999.78) * (var_1_21 * var_1_24))) {
  var_1_25 = 128.75f;
 } else {
  var_1_25 = var_1_23;
 }
...
int property(void) {
 return (((((((((((((((32.4 == var_1_21) || ((var_1_27 > var_1_11) && var_1_14)) ? (var_1_1 == ((unsigned short int) ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))))) : (var_1_1 == ((unsigned short int) (var_1_8 - (var_1_9 + var_1_10))))) && ((var_1_10 < (var_1_9 >> var_1_12)) ? (var_1_11 == ((unsigned long int) ((((var_1_12) > (var_1_8)) ? (var_1_12) : (var_1_8))))) : (var_1_14 ? (var_1_11 == ((unsigned long int) var_1_27)) : (var_1_11 == ((unsigned long int) var_1_8))))) && ((last_1_var_1_14 || ((var_1_10 > var_1_9) && (last_1_var_1_27 > var_1_12))) ? (var_1_13 == ((unsigned short int) var_1_8)) : 1)) && (var_1_14 == ((unsigned char) ((var_1_3 && (! var_1_15)) || (var_1_16 || var_1_17))))) && (((((((var_1_36 + var_1_12)) < (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19))))) ? ((var_1_36 + var_1_12)) : (((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))))) >= var_1_36) ? (var_1_18 == ((signed char) var_1_12)) : 1)) && (var_1_14 ? (var_1_14 ? (var_1_21 == ((double) (((((var_1_22) < (var_1_23)) ? (var_1_22) : (var_1_23))) + var_1_24))) : ((((((var_1_29) < (var_1_28)) ? (var_1_29) : (var_1_28))) < var_1_12) ? (var_1_21 == ((double) var_1_23)) : 1)) : (var_1_21 == ((double) var_1_24)))) && (((((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23))) * (var_1_22 + var_1_21)) >= ((var_1_26 - 9999999.78) * (var_1_21 * var_1_24))) ? (var_1_25 == ((float) 128.75f)) : (var_1_25 == ((float) var_1_23)))) && (((var_1_10 * (last_1_var_1_27 / var_1_12)) <= var_1_13) ? (var_1_27 == ((unsigned long int) ((var_1_8 + var_1_10) + var_1_9))) : 1)) && ((var_1_16 && var_1_15) ? (var_1_28 == ((unsigned short int) ((64942 - var_1_10) - var_1_12))) : 1)) && (((var_1_11 + var_1_10) > var_1_27) ? (var_1_29 == ((signed long int) ((((var_1_8) < (((var_1_12 + last_1_var_1_29) - var_1_7))) ? (var_1_8) : (((var_1_12 + last_1_var_1_29) - var_1_7)))))) : (var_1_29 == ((signed long int) (var_1_10 + var_1_13))))) && (((var_1_28 / var_1_31) > (var_1_7 % -5)) ? (var_1_30 == ((unsigned char) (128 - 16))) : 1)) && (var_1_32 == ((float) var_1_24))) && (var_1_14 ? ((var_1_8 >= 1) ? (var_1_33 == ((unsigned char) ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))))) : (var_1_33 == ((unsigned char) (var_1_34 - ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))))))) : ((var_1_12 > (((((var_1_34 - var_1_35)) < ((- var_1_29))) ? ((var_1_34 - var_1_35)) : ((- var_1_29))))) ? (var_1_33 == ((unsigned char) (((((5) < (var_1_12)) ? (5) : (var_1_12))) + 16))) : 1))) && (var_1_36 == ((unsigned long int) var_1_10))
;
}
int main(void) {
 isInitial = 1;
