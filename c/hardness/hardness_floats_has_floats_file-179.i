...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch179has_floats.c", 13, "reach_error"); }
...
double var_1_6 = 50.0;
double var_1_7 = 32.0;
double var_1_8 = 500.0;
unsigned short int var_1_9 = 8;
double var_1_10 = 32.0;
...
void step(void) {
 ...
 if (var_1_7 <= ((- 16.0) * (var_1_6 / var_1_10))) {
  var_1_9 = (var_1_11 + (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))) - var_1_13));
 } else {
 ...
 if (var_1_14) {
  if (var_1_16) {
   var_1_15 = (((((((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) + (var_1_19 + var_1_20))) > (var_1_21)) ? ((((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) + (var_1_19 + var_1_20))) : (var_1_21)));
  } else {
   var_1_15 = var_1_21;
  }
 } else {
...
int property(void) {
 return (((var_1_2 <= var_1_3) ? (var_1_1 == ((double) (var_1_4 - var_1_5))) : (var_1_1 == ((double) ((var_1_6 + (var_1_7 + var_1_8)) - var_1_5)))) && ((var_1_7 <= ((- 16.0) * (var_1_6 / var_1_10))) ? (var_1_9 == ((unsigned short int) (var_1_11 + (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))) - var_1_13)))) : (((var_1_1 < (var_1_8 * var_1_5)) || var_1_14) ? (var_1_9 == ((unsigned short int) var_1_13)) : (var_1_9 == ((unsigned short int) var_1_12))))) && (var_1_14 ? (var_1_16 ? (var_1_15 == ((unsigned char) (((((((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) + (var_1_19 + var_1_20))) > (var_1_21)) ? ((((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) + (var_1_19 + var_1_20))) : (var_1_21))))) : (var_1_15 == ((unsigned char) var_1_21))) : (var_1_15 == ((unsigned char) 10)))
;
}
int main(void) {
 isInitial = 1;
