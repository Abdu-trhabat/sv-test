...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch18250_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch18250_1loop
	if ((var_1_12 - var_1_11) >= (var_1_10 / var_1_17)) {
		var_1_16 = ((var_1_18 - 1) - var_1_19);
	}


	// From: Req5Batch18250_1loop
	unsigned short int stepLocal_1 = var_1_21;
	if (var_1_17 >= var_1_12) {
		if (stepLocal_1 != ((max (var_1_14 , var_1_22)) - (5 + var_1_23))) {
			var_1_20 = (min (var_1_22 , var_1_3));
		} else {
			var_1_20 = var_1_21;
		}
	}
	...
	// From: Req6Batch18250_1loop
	if (var_1_10 < var_1_12) {
		var_1_24 = (var_1_23 + var_1_25);
	} else {
		var_1_24 = (max (var_1_18 , -2));
	}


	// From: Req1Batch18250_1loop
	...
	// From: Req3Batch18250_1loop
	if ((var_1_14 - var_1_15) != var_1_20) {
		var_1_13 = 0.8f;
	}


	// From: Req7Batch18250_1loop
	if ((max (var_1_1 , var_1_17)) >= (var_1_10 + (var_1_13 / 128.9f))) {
		if (var_1_9) {
			var_1_26 = var_1_25;
		} else {
			var_1_26 = var_1_18;
	...
	// From: Req2Batch18250_1loop
	if (var_1_1 >= var_1_13) {
		if (var_1_9) {
			var_1_7 = (var_1_10 + (var_1_11 - var_1_12));
		} else {
			if (var_1_3 >= var_1_20) {
				var_1_7 = var_1_5;
			} else {
...
int property(void) {
	return (((((((((var_1_20 * 16) / var_1_3) <= var_1_20) ? (var_1_1 == ((float) (min (var_1_5 , var_1_6)))) : 1) && ((var_1_1 >= var_1_13) ? (var_1_9 ? (var_1_7 == ((float) (var_1_10 + (var_1_11 - var_1_12)))) : ((var_1_3 >= var_1_20) ? (var_1_7 == ((float) var_1_5)) : (var_1_7 == ((float) var_1_6)))) : 1)) && (((var_1_14 - var_1_15) != var_1_20) ? (var_1_13 == ((float) 0.8f)) : 1)) && (((var_1_12 - var_1_11) >= (var_1_10 / var_1_17)) ? (var_1_16 == ((signed short int) ((var_1_18 - 1) - var_1_19))) : 1)) && ((var_1_17 >= var_1_12) ? ((var_1_21 != ((max (var_1_14 , var_1_22)) - (5 + var_1_23))) ? (var_1_20 == ((unsigned long int) (min (var_1_22 , var_1_3)))) : (var_1_20 == ((unsigned long int) var_1_21))) : 1)) && ((var_1_10 < var_1_12) ? (var_1_24 == ((signed short int) (var_1_23 + var_1_25))) : (var_1_24 == ((signed short int) (max (var_1_18 , -2)))))) && (((max (var_1_1 , var_1_17)) >= (var_1_10 + (var_1_13 / 128.9f))) ? (var_1_9 ? (var_1_26 == ((signed short int) var_1_25)) : (var_1_26 == ((signed short int) var_1_18))) : (var_1_26 == ((signed short int) var_1_19)))
;
}
int main(void) {
	isInitial = 1;
