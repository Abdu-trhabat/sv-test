...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch110stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch110stepLocals
	signed long int stepLocal_1 = var_1_8 - var_1_9;
	signed long int stepLocal_0 = max (var_1_7 , (var_1_5 ^ var_1_15));
	if (stepLocal_1 < var_1_11) {
		if (stepLocal_0 <= ((var_1_8 >> var_1_16) + var_1_6)) {
			var_1_14 = var_1_7;
		} else {
			var_1_14 = 32;
		}
	...
	// From: Req5Batch110stepLocals
	if (var_1_13) {
		var_1_17 = (var_1_18 && var_1_19);
	}


	// From: Req6Batch110stepLocals
	var_1_20 = (min (var_1_21 , 8.25));


	// From: Req7Batch110stepLocals
