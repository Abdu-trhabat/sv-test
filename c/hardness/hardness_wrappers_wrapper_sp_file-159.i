...
void step(void) {
 ...
 if ((((*(WrapperStruct00_var_1_8_Pointer)) - (*(WrapperStruct00_var_1_9_Pointer))) / (*(WrapperStruct00_var_1_10_Pointer))) < (*(WrapperStruct00_var_1_11_Pointer))) {
  if ((((((*(WrapperStruct00_var_1_3_Pointer))) < ((*(WrapperStruct00_var_1_12_Pointer)))) ? ((*(WrapperStruct00_var_1_3_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer))))) < (*(WrapperStruct00_var_1_13_Pointer))) {
   if ((*(WrapperStruct00_var_1_4_Pointer))) {
    (*(WrapperStruct00_var_1_7_Pointer)) = (((((*(WrapperStruct00_var_1_14_Pointer))) < (1)) ? ((*(WrapperStruct00_var_1_14_Pointer))) : (1)));
   }
  }
 }
