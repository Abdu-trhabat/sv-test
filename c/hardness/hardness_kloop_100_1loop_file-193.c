...
void step(void) {
	...
	// From: Req2Batch193100_1loop
	if (var_1_4) {
		var_1_5 = (max (var_1_6 , (abs (var_1_7))));
	}


	// From: Req6Batch193100_1loop
	if (var_1_4) {
		var_1_16 = var_1_17;
	} else {
	...
	// From: Req8Batch193100_1loop
	var_1_24 = (min (var_1_13 , var_1_11));


	// From: Req9Batch193100_1loop
