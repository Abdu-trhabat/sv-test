...
void step(void) {
 ...
 if (stepLocal_0 > last_1_var_1_13) {
  if (stepLocal_1 <= last_1_var_1_18) {
   if ((var_1_4 - ((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6)))) >= last_1_var_1_9) {
    if (var_1_6 == (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))) + var_1_5)) {
     var_1_1 = var_1_8;
    } else {
     var_1_1 = -10;
    }
...
int property(void) {
 return (((((((~ 1) > last_1_var_1_13) ? ((last_1_var_1_13 <= last_1_var_1_18) ? (((var_1_4 - ((((var_1_5) < (var_1_6)) ? (var_1_5) : (var_1_6)))) >= last_1_var_1_9) ? ((var_1_6 == (((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))) + var_1_5)) ? (var_1_1 == ((signed long int) var_1_8)) : (var_1_1 == ((signed long int) -10))) : 1) : 1) : 1) && ((var_1_1 >= (- var_1_1)) ? ((((var_1_13 / var_1_10) / var_1_11) == (256 % var_1_12)) ? (var_1_9 == ((signed long int) var_1_8)) : 1) : (var_1_9 == ((signed long int) var_1_8)))) && (var_1_13 == ((signed long int) (var_1_14 - var_1_15)))) && (var_1_16 == ((signed char) var_1_17))) && (var_1_18 == ((signed long int) var_1_11))) && (var_1_19 == ((unsigned char) var_1_20))
;
}
int main(void) {
 isInitial = 1;
