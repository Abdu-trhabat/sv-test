...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch51Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch51Amount50
	if ((min ((~ var_1_12) , 8)) > var_1_11) {
		var_1_17 = var_1_18;
	}


	// From: Req2Batch51Amount50
	if (! (var_1_17 > var_1_5)) {
	...
	// From: Req5Batch51Amount50
	unsigned char stepLocal_3 = (max (var_1_4 , var_1_17)) > var_1_18;
