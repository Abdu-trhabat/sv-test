...
int property(void) {
 return (((((((var_1_2 + var_1_3) < -200) ? (last_1_var_1_12 ? ((var_1_2 > (- var_1_3)) ? (var_1_1 == ((unsigned long int) var_1_2)) : (var_1_1 == ((unsigned long int) var_1_3))) : (var_1_1 == ((unsigned long int) 10u))) : (var_1_1 == ((unsigned long int) 0u))) && ((((((var_1_2) > (var_1_1)) ? (var_1_2) : (var_1_1))) > (var_1_3 * 2u)) ? ((((32 * -25) | var_1_2) >= var_1_1) ? ((var_1_3 > var_1_1) ? (var_1_5 == ((signed char) var_1_6)) : 1) : 1) : (var_1_5 == ((signed char) var_1_6)))) && (((127.75 <= var_1_8) && var_1_12) ? (var_1_7 == ((float) (((((var_1_9 + var_1_10)) > (var_1_11)) ? ((var_1_9 + var_1_10)) : (var_1_11))))) : 1)) && (((var_1_16 / var_1_14) <= (var_1_6 * var_1_1)) ? (var_1_12 == ((unsigned char) var_1_15)) : 1)) && ((var_1_17 <= var_1_5) ? (var_1_16 == ((unsigned long int) ((var_1_18 - var_1_3) + var_1_17))) : (var_1_16 == ((unsigned long int) ((((var_1_17) < ((var_1_3 + var_1_2))) ? (var_1_17) : ((var_1_3 + var_1_2)))))))) && (var_1_15 ? ((var_1_16 < var_1_1) ? (var_1_19 == ((float) ((var_1_20 + var_1_21) - 9.125f))) : (var_1_19 == ((float) (0.19999999999999996f - var_1_20)))) : (var_1_19 == ((float) var_1_20)))
;
}
int main(void) {
 isInitial = 1;
