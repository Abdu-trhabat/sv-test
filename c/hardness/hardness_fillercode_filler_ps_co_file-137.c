...
void step(void) {
	...
	// From: Req7Batch137Filler_PS_CO
	/* 1072L, 248L, 864L, 870L) */ var_1_22 = (
		var_1_4
	);


	// From: Req8Batch137Filler_PS_CO
	/* 1078L, 258L, 888L, 894L) */ var_1_23 = (
		var_1_13
	);


	// From: Req9Batch137Filler_PS_CO
	/* 1084L, 268L, 912L, 918L) */ var_1_24 = (
		var_1_7
	);


	// From: Req3Batch137Filler_PS_CO
