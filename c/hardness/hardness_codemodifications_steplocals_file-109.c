...
void step(void) {
	...
	// From: Req2Batch109stepLocals
	var_1_6 = (max (var_1_7 , ((10 + var_1_8) + var_1_9)));


	// From: Req3Batch109stepLocals
	if (var_1_5) {
		var_1_10 = var_1_8;
	} else {
	...
	// From: Req8Batch109stepLocals
	var_1_20 = var_1_19;


	// From: Req9Batch109stepLocals
	var_1_21 = var_1_9;
}
