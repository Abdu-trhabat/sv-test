...
void step(void) {
	...
	// From: CodeObject6
	/* 433L, 255L) */ if (/* 434L, 239L, 240L) */ ((var_1_7) < (/* 436L, 238L, 242L) */ ((var_1_1) + (var_1_35))))) {
		/* 439L, 254L) */ var_1_38 = (
			/* 442L, 253L) */ (abs (
				var_1_29
			))
	...
	/* 444L, 340L) */ if (/* 445L, 261L, 262L) */ ((var_1_24) > (var_1_22))) {
		/* 448L, 338L) */ if (/* 449L, 276L, 277L) */ ((/* 450L, 270L, 278L) */ (min (/* 450L, 270L, 278L) */ (2) , (64)))) < (/* 453L, 275L, 281L) */ (max (/* 453L, 275L, 281L) */ (var_1_37) , (/* 455L, 274L, 283L) */ ((var_1_7) + (var_1_10)))))))) {
	...
	// From: CodeObject5
	/* 414L, 231L) */ if (/* 415L, 205L, 206L) */ ((/* 416L, 201L, 207L) */ (abs (/* 417L, 200L, 208L) */ (~ (var_1_7))))) >= (/* 419L, 204L, 210L) */ (min (/* 419L, 204L, 210L) */ (var_1_20) , (8u)))))) {
		/* 422L, 224L) */ var_1_36 = (
			/* 425L, 223L) */ (abs (
				var_1_20
			))
	...
	// From: CodeObject3
	/* 379L, 144L) */ if (/* 380L, 125L, 126L) */ ((/* 381L, 121L, 127L) */ ((var_1_10) < (var_1_29))) || (/* 384L, 124L, 130L) */ ((var_1_28) >= (var_1_27))))) {
		/* 387L, 143L) */ var_1_30 = (
			var_1_31
		);
	}
	...
	// From: CodeObject4
	/* 391L, 195L) */ if (/* 392L, 155L, 156L) */ ((var_1_7) <= (/* 394L, 154L, 158L) */ ((var_1_1) / (/* 396L, 153L, 160L) */ (abs (var_1_33))))))) {
