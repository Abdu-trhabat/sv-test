...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch147100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch147100_1loop
	var_1_30 = var_1_26;


	// From: Req2Batch147100_1loop
	if (var_1_30) {
		var_1_6 = (abs (2));
	} else {
