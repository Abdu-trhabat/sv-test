...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch119Amount10.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_2 > ((((10) > (var_1_3)) ? (10) : (var_1_3)))) {
...
int property(void) {
 return (var_1_2 > ((((10) > (var_1_3)) ? (10) : (var_1_3)))) ? (var_1_1 == ((float) ((((var_1_4) > (((var_1_5 - var_1_6) + ((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8)))))) ? (var_1_4) : (((var_1_5 - var_1_6) + ((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8))))))))) : (var_1_9 ? (var_1_1 == ((float) var_1_7)) : (var_1_1 == ((float) var_1_5)))
;
}
int main(void) {
 isInitial = 1;
