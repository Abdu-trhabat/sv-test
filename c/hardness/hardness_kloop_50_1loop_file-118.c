...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11850_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch11850_1loop
	var_1_1 = -5;


	// From: Req2Batch11850_1loop
	var_1_2 = (max (var_1_3 , var_1_4));


	// From: Req4Batch11850_1loop
	if (var_1_8 && var_1_9) {
		var_1_7 = var_1_6;
	}


	// From: Req7Batch11850_1loop
