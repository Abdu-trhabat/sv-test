...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch7225_1loop.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_3 < (((((var_1_4) < (var_1_2)) ? (var_1_4) : (var_1_2))) * var_1_5)) {
