...
int property(void) {
 return ((((((var_1_18 ? (var_1_1 == ((unsigned char) ((((((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) > (var_1_4)) ? (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) : (var_1_4))))) : (var_1_1 == ((unsigned char) ((var_1_5 + var_1_6) - var_1_7)))) && (var_1_8 == ((unsigned char) (((((var_1_5 + (64 - 16))) < (64)) ? ((var_1_5 + (64 - 16))) : (64)))))) && (((last_1_var_1_8 * var_1_7) >= var_1_3) ? (var_1_9 == ((unsigned long int) (5u + var_1_4))) : (last_1_var_1_18 ? (var_1_9 == ((unsigned long int) var_1_4)) : (var_1_9 == ((unsigned long int) last_1_var_1_8))))) && (((var_1_6 + var_1_4) >= var_1_5) ? ((var_1_6 > var_1_9) ? (var_1_10 == ((signed char) ((((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))) + (var_1_12 + var_1_13)) - ((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15)))))) : (var_1_10 == ((signed char) ((((((((var_1_14) < (var_1_12)) ? (var_1_14) : (var_1_12)))) > (var_1_15)) ? (((((var_1_14) < (var_1_12)) ? (var_1_14) : (var_1_12)))) : (var_1_15)))))) : 1)) && ((((-128 | var_1_12) >= ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))) || var_1_18) ? ((var_1_3 <= 16) ? (var_1_16 == ((unsigned char) var_1_12)) : (var_1_16 == ((unsigned char) var_1_6))) : (var_1_16 == ((unsigned char) var_1_12)))) && (var_1_17 == ((unsigned short int) var_1_13))) && ((var_1_12 <= (var_1_9 / 64)) ? (var_1_18 == ((unsigned char) (! var_1_19))) : (var_1_19 ? (var_1_18 == ((unsigned char) var_1_20)) : (var_1_18 == ((unsigned char) 0))))
;
}
int main(void) {
 isInitial = 1;
