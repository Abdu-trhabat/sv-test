...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1functionizing.c", 13, "reach_error"); }
...
void functionized3(signed short int, float, unsigned long int, signed long int);
unsigned long int functionized4(unsigned long int, unsigned long int);
signed long int functionized5(signed char);
void functionized6(signed char, unsigned char);
...
signed long int functionized1(signed short int functionized1_localFunctionVar0) {
	return (var_1_7 - functionized1_localFunctionVar0);
}
unsigned char functionized2(unsigned long int functionized2_localFunctionVar0) {
	return (var_1_4 > functionized2_localFunctionVar0);
}
void functionized3(signed short int functionized3_localFunctionVar0, float functionized3_localFunctionVar1, unsigned long int functionized3_localFunctionVar2, signed long int localFunctionVar3) {
	if (var_1_13 && (functionized3_localFunctionVar0 >= functionized3_localFunctionVar2)) {
		var_1_12 = functionized3_localFunctionVar1;
	} else {
		if (localFunctionVar3 >= functionized3_localFunctionVar2) {
			var_1_12 = functionized3_localFunctionVar1;
		} else {
			var_1_12 = var_1_14;
		}
...
unsigned long int functionized4(unsigned long int functionized4_localFunctionVar0, unsigned long int functionized4_localFunctionVar1) {
	return (min (functionized4_localFunctionVar1 , functionized4_localFunctionVar0));
}
signed long int functionized5(signed char functionized5_localFunctionVar0) {
	return ((max (var_1_19 , (var_1_20 - functionized5_localFunctionVar0))) + (abs (abs (var_1_22))));
}
void functionized6(signed char functionized6_localFunctionVar0, unsigned char functionized6_localFunctionVar1) {
	if ((~ functionized6_localFunctionVar0) > var_1_8) {
		var_1_23 = (functionized6_localFunctionVar1 && (! var_1_25));
	} else {
...
void step(void) {
	// From: Req1Batch1functionizing
	if ((var_1_2 + var_1_3) <= var_1_4) {
		var_1_1 = (128 + var_1_5);
	} else {
		if (var_1_5 >= functionized0()) {
			var_1_1 = var_1_5;
		} else {
			var_1_1 = 1;
		}
	...
	// From: Req2Batch1functionizing
	if (var_1_5 < functionized1(var_1_8)) {
		var_1_6 = var_1_9;
	}


	// From: Req3Batch1functionizing
	...
	// From: Req4Batch1functionizing
	functionized3(var_1_5, var_1_11, var_1_2, 1);


	// From: Req5Batch1functionizing
	var_1_15 = (var_1_16 - var_1_17);


	// From: Req6Batch1functionizing
	if ((functionized4(var_1_2, var_1_3)) < 25u) {
		var_1_18 = functionized5(var_1_21);
	}


	// From: Req7Batch1functionizing
	if (var_1_13) {
		functionized6(var_1_21, var_1_24);
	}


	// From: Req8Batch1functionizing
	var_1_27 = var_1_21;
}
