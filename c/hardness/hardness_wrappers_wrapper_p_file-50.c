...
void step(void) {
	...
	// From: Req4Batch50Wrapper_P
	(*(var_1_20_Pointer)) = (*(var_1_14_Pointer));


	// From: Req5Batch50Wrapper_P
	...
	unsigned long int stepLocal_0 = max ((*(var_1_12_Pointer)) , (*(var_1_20_Pointer)));
