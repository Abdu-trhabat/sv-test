...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch147Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch147Amount100
	var_1_30 = var_1_26;


	// From: Req2Batch147Amount100
	if (var_1_30) {
		var_1_6 = (abs (2));
	} else {
