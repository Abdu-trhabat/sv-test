...
void step(void) {
	...
	// From: Req2Batch14125_while
	if (var_1_8 && var_1_9) {
		var_1_7 = (var_1_10 + var_1_11);
	}


	// From: Req3Batch14125_while
	if (var_1_2 >= 0.75f) {
		var_1_12 = (max (var_1_13 , (abs (var_1_14))));
	}


	// From: Req6Batch14125_while
	var_1_20 = var_1_21;


	// From: Req5Batch14125_while
	if (var_1_20) {
		var_1_16 = (var_1_17 - (var_1_18 - var_1_19));
	}


	// From: Req4Batch14125_while
