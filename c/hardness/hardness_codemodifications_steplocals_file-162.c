...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch162stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch162stepLocals
	signed long int stepLocal_2 = var_1_2 * (var_1_3 + var_1_5);
	signed long int stepLocal_1 = 200 / (var_1_2 + var_1_3);
	...
	// From: Req6Batch162stepLocals
	var_1_20 = var_1_21;


	// From: Req7Batch162stepLocals
	var_1_22 = 1;
}
