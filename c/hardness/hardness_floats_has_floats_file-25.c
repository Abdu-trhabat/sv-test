...
void step(void) {
	...
	// From: Req5Batch25has_floats
	var_1_20 = var_1_21;


	// From: Req2Batch25has_floats
	if ((var_1_14 / var_1_10) < var_1_14) {
		var_1_8 = (min (var_1_12 , (-50.0f + var_1_13)));
	} else {
		var_1_8 = var_1_13;
	}
}
...
int property(void) {
	return ((((var_1_2 ? ((var_1_3 <= var_1_4) ? (var_1_1 == ((unsigned long int) ((max (var_1_3 , (var_1_4 + var_1_5))) + (var_1_6 - var_1_7)))) : 1) : (var_1_1 == ((unsigned long int) var_1_7))) && (((var_1_14 / var_1_10) < var_1_14) ? (var_1_8 == ((float) (min (var_1_12 , (-50.0f + var_1_13))))) : (var_1_8 == ((float) var_1_13)))) && (var_1_2 ? ((var_1_15 && var_1_16) ? (var_1_14 == ((double) ((var_1_17 + var_1_18) + (abs (var_1_13))))) : (var_1_14 == ((double) (abs (var_1_18 + var_1_13))))) : (var_1_14 == ((double) (var_1_17 + var_1_18))))) && (var_1_19 == ((double) var_1_17))) && (var_1_20 == ((float) var_1_21))
;
}
int main(void) {
	isInitial = 1;
