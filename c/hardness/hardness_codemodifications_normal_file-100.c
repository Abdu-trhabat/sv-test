...
void step(void) {
	...
	if (8u < var_1_2) {
		if (-8 > ((min (var_1_2 , var_1_3)) + var_1_4)) {
			var_1_1 = var_1_5;
		} else {
			var_1_1 = 256.5;
		}
	...
	if ((var_1_3 ^ (var_1_9 - var_1_10)) > (var_1_4 * (3512938537u - var_1_11))) {
		if (((max (var_1_2 , var_1_9)) + var_1_3) == (2u * (var_1_12 * var_1_11))) {
			var_1_6 = var_1_13;
		} else {
	...
	// From: Req6Batch100normal
	if (! ((abs (var_1_17)) >= (var_1_23 - var_1_24))) {
