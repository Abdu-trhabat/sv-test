...
void step(void) {
	...
	if (var_1_13 && stepLocal_1) {
		var_1_19 = (min ((var_1_20 - var_1_21) , (max ((max (var_1_9 , var_1_22)) , var_1_23))));
	} else {
		var_1_19 = var_1_21;
	}
...
int property(void) {
	return ((((((var_1_5 >= var_1_6) || var_1_10) ? (var_1_10 ? (var_1_1 == ((unsigned long int) 4u)) : (var_1_1 == ((unsigned long int) (max (var_1_7 , 32u))))) : 1) && (var_1_10 ? (var_1_8 == ((double) var_1_9)) : 1)) && ((var_1_4 && var_1_11) ? (var_1_10 == ((unsigned char) ((var_1_12 || var_1_13) || (var_1_14 || var_1_15)))) : 1)) && (((- var_1_9) < var_1_19) ? (var_1_16 == ((signed long int) (var_1_17 - (var_1_18 - 5)))) : (var_1_16 == ((signed long int) (32 - var_1_18))))) && ((var_1_13 && var_1_14) ? (var_1_19 == ((double) (min ((var_1_20 - var_1_21) , (max ((max (var_1_9 , var_1_22)) , var_1_23)))))) : (var_1_19 == ((double) var_1_21)))
;
}
int main(void) {
	isInitial = 1;
