...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch24Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((max (((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) * 127.75) , ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) / 3.4))) >= (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
		(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) = (min (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) - (22925 - (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer))));
	}
}
