...
void step(void) {
	...
	// From: Req4Batch145Wrapper_P
	unsigned short int stepLocal_3 = (*(var_1_8_Pointer));
	if ((*(var_1_14_Pointer)) <= (min ((*(var_1_13_Pointer)) , (*(var_1_16_Pointer))))) {
		if ((min ((*(var_1_9_Pointer)) , ((*(var_1_9_Pointer)) & (*(var_1_5_Pointer))))) < stepLocal_3) {
			(*(var_1_15_Pointer)) = (*(var_1_6_Pointer));
		} else {
			(*(var_1_15_Pointer)) = (min ((min ((*(var_1_7_Pointer)) , (*(var_1_6_Pointer)))) , (*(var_1_17_Pointer))));
		}
	} else {
		(*(var_1_15_Pointer)) = (*(var_1_6_Pointer));
	}
