...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch133no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch133no_floats
	if (8 >= (var_1_2 + var_1_3)) {
		var_1_1 = (min (var_1_4 , (var_1_5 + 10)));
	}


	// From: Req2Batch133no_floats
...
int property(void) {
	return ((((8 >= (var_1_2 + var_1_3)) ? (var_1_1 == ((signed short int) (min (var_1_4 , (var_1_5 + 10))))) : 1) && ((var_1_3 <= var_1_2) ? (var_1_6 == ((unsigned short int) (var_1_7 + var_1_8))) : 1)) && (((var_1_6 | (var_1_2 * var_1_3)) <= ((var_1_8 << var_1_12) * var_1_7)) ? ((! var_1_10) ? (var_1_9 == ((signed long int) (128 + var_1_11))) : (var_1_9 == ((signed long int) var_1_11))) : (var_1_9 == ((signed long int) var_1_11)))) && ((var_1_8 > var_1_1) ? (var_1_12 == ((unsigned short int) ((max ((var_1_13 - var_1_14) , var_1_8)) + ((var_1_15 + var_1_16) + 2)))) : 1)
;
}
int main(void) {
	isInitial = 1;
