...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch145Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch145Amount50
	var_1_16 = (min (var_1_17 , var_1_18));


	// From: Req5Batch145Amount50
	if ((min ((var_1_18 >> var_1_20) , var_1_5)) < var_1_17) {
		var_1_19 = var_1_18;
	}


	// From: Req7Batch145Amount50
	var_1_23 = (var_1_24 - var_1_7);


	// From: Req1Batch145Amount50
	if (var_1_25) {
