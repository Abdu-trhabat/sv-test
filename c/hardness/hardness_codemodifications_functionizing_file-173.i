...
void functionized2(unsigned char functionized2_localFunctionVar0, unsigned char functionized2_localFunctionVar1, unsigned long int localFunctionVar2) {
 if (functionized2_localFunctionVar0 > 2) {
  if (functionized2_localFunctionVar1) {
   var_1_15 = ((((((((functionized2_localFunctionVar0) < 0 ) ? -(functionized2_localFunctionVar0) : (functionized2_localFunctionVar0)))) > ((localFunctionVar2 - var_1_8))) ? (((((functionized2_localFunctionVar0) < 0 ) ? -(functionized2_localFunctionVar0) : (functionized2_localFunctionVar0)))) : ((localFunctionVar2 - var_1_8))));
  } else {
...
void functionized5(float functionized5_localFunctionVar0, unsigned char functionized5_localFunctionVar1, unsigned char localFunctionVar2) {
 if ((((((var_1_4) > (var_1_3)) ? (var_1_4) : (var_1_3))) >= functionized5_localFunctionVar0) || var_1_9) {
...
void step(void) {
 ...
 if ((var_1_18 - var_1_12) >= (~ var_1_14)) {
  if (var_1_9) {
   var_1_17 = ((((functionized4(var_1_19)) > (var_1_12)) ? (functionized4(var_1_19)) : (var_1_12)));
  } else {
   var_1_17 = var_1_12;
  }
 } else {
