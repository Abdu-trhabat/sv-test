...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12350_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch12350_while
	if (var_1_6) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch12350_while
	...
	// From: Req4Batch12350_while
	if ((var_1_3 == 32u) || (var_1_5 == var_1_1)) {
		var_1_10 = var_1_8;
	}


	// From: Req6Batch12350_while
