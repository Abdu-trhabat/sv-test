...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch97no_floats.c", 13, "reach_error"); }
...
int property(void) {
	return (((var_1_13 ? ((var_1_5 > var_1_3) ? (var_1_13 ? (var_1_1 == ((signed short int) (var_1_7 - (var_1_8 - var_1_9)))) : (var_1_1 == ((signed short int) last_1_var_1_1))) : (var_1_1 == ((signed short int) 8))) : 1) && ((var_1_16 == var_1_7) ? (var_1_10 == ((signed char) (var_1_11 + (var_1_12 + -25)))) : ((((32 * -25) | last_1_var_1_10) >= var_1_11) ? (var_1_13 ? (var_1_10 == ((signed char) var_1_12)) : 1) : 1))) && ((1000 > (min (-8 , var_1_14))) ? ((var_1_9 < (max (last_1_var_1_1 , last_1_var_1_10))) ? (var_1_13 == ((unsigned char) (! var_1_15))) : 1) : (var_1_13 == ((unsigned char) var_1_15)))) && (var_1_16 == ((unsigned char) var_1_17))
;
}
int main(void) {
	isInitial = 1;
