...
void step(void) {
	...
	// From: CodeObject4
	/* 406L, 247L) */ if (/* 407L, 230L, 231L) */ ((/* 408L, 228L, 232L) */ (min (/* 408L, 228L, 232L) */ (/* 409L, 226L, 233L) */ (abs (var_1_27))) , (var_1_17)))) <= (var_1_32))) {
		/* 413L, 246L) */ var_1_31 = (
			var_1_33
		);
	}
	...
	// From: CodeObject8
	/* 450L, 321L) */ if (/* 451L, 308L, 309L) */ ((/* 452L, 306L, 310L) */ (- (var_1_17))) != (var_1_17))) {
		/* 455L, 320L) */ var_1_40 = (
			var_1_39
		);
	}
	...
	// From: CodeObject2
	/* 379L, 193L) */ if (/* 380L, 171L, 172L) */ ((/* 381L, 169L, 173L) */ ((/* 382L, 167L, 174L) */ ((var_1_13) + (25))) % (var_1_27))) < (2))) {
		/* 387L, 192L) */ var_1_26 = (
			/* 390L, 191L) */ ((
				/* 391L, 189L) */ (abs (
					var_1_28
	...
	// From: CodeObject5
	/* 417L, 270L) */ if (/* 418L, 254L, 255L) */ ((var_1_6) < (/* 420L, 253L, 257L) */ (abs (var_1_13))))) {
		/* 422L, 269L) */ var_1_34 = (
			/* 425L, 268L) */ (max (
				/* 425L, 268L) */ (
					/* 426L, 266L) */ (abs (
	...
	// From: CodeObject1
	/* 367L, 159L) */ if (/* 368L, 144L, 145L) */ ((var_1_19) || (var_1_8))) {
		/* 371L, 158L) */ var_1_21 = (
			/* 374L, 157L) */ ((
				/* 375L, 155L) */ ((
					var_1_13
