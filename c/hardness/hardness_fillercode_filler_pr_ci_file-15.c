...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 263L, 123L) */ if (/* 264L, 53L, 54L) */ (! (var_1_2))) {
		/* 266L, 121L) */ if (var_1_2) {
			...
			/* 275L, 119L) */ if (/* 276L, 70L, 71L) */ ((var_1_7) >= (25))) {
				/* 279L, 113L) */ if (/* 280L, 81L, 82L) */ ((/* 281L, 79L, 83L) */ ((0) > (var_1_7))) || (var_1_18))) {
					/* 285L, 97L) */ var_1_27 = (
						/* 288L, 96L) */ (abs (
							/* 289L, 95L) */ (abs (
								-50
	...
	// From: CodeObject6
	/* 354L, 205L) */ if (/* 355L, 193L, 194L) */ ((var_1_21) <= (var_1_19))) {
		/* 358L, 204L) */ var_1_43 = (
			/* 361L, 203L) */ (abs (
				var_1_44
			))
