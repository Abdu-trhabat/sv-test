...
void step(void) {
	// From: Req1Batch158Wrapper_AP
	if ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) >= (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
		(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var10_Pointer)) = (min ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var9_Pointer)) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var8_Pointer))));
	} else {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
		if ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var6_Pointer)) <= stepLocal_1) {
			(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) = (max ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))));
		} else {
