...
signed long int functionized3(void) {
	return (max ((min (var_1_14 , var_1_12)) , var_1_15));
}
signed long int functionized4(void) {
	return (abs (var_1_4));
}
...
void step(void) {
	...
	// From: Req2Batch31functionizing
	functionized0();


	// From: Req3Batch31functionizing
	...
	// From: Req6Batch31functionizing
	functionized6(var_1_13);


	// From: Req7Batch31functionizing
