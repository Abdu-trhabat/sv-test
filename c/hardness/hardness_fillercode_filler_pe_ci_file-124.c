...
void step(void) {
	...
	/* 311L, 127L) */ if (var_1_20) {
		/* 313L, 125L) */ if (/* 314L, 95L, 96L) */ ((var_1_26) <= (/* 316L, 94L, 98L) */ (max (/* 316L, 94L, 98L) */ (var_1_25) , (var_1_6)))))) {
	...
	// From: CodeObject5
	/* 351L, 229L) */ if (var_1_20) {
		/* 353L, 227L) */ if (var_1_21) {
			/* 355L, 184L) */ var_1_34 = (
				/* 358L, 183L) */ (max (
					/* 358L, 183L) */ (
						var_1_26
			...
			/* 361L, 225L) */ if (/* 362L, 200L, 201L) */ ((/* 363L, 196L, 202L) */ ((/* 364L, 192L, 203L) */ (abs (var_1_26))) - (/* 366L, 195L, 205L) */ (max (/* 366L, 195L, 205L) */ (var_1_27) , (var_1_5)))))) > (/* 369L, 199L, 208L) */ ((5u) % (var_1_37))))) {
				/* 372L, 224L) */ var_1_34 = (
					var_1_36
				);
			}
