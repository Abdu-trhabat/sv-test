...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) = (min ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))));
	} else {
		if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) > stepLocal_2) {
			if ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) > stepLocal_1) {
				(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) = (min ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) , 100));
			} else {
