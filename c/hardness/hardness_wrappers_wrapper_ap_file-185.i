...
void step(void) {
 ...
 if (stepLocal_2 == ((((32) < ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)))) ? (32) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)))))) {
  if (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
   (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) = ((((((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))) < 0 ) ? -((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))))) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)));
  } else {
