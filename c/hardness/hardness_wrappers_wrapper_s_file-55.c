...
void step(void) {
	...
	if (stepLocal_3 <= (min ((16 >> WrapperStruct00.var_1_13) , last_1_WrapperStruct00_var_1_12))) {
	...
	if (WrapperStruct00.var_1_2) {
		if (stepLocal_1 && WrapperStruct00.var_1_5) {
			if (stepLocal_0 >= WrapperStruct00.var_1_4) {
				...
				WrapperStruct00.var_1_1 = (min (25 , WrapperStruct00.var_1_6));
			}
		}
	} else {
