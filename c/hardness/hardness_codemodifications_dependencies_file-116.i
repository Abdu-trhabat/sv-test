...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch116dependencies.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_12 * last_1_var_1_7) > last_1_var_1_7) {
  ...
  var_1_15 = ((((((var_1_16 - var_1_9)) > (last_1_var_1_8)) ? ((var_1_16 - var_1_9)) : (last_1_var_1_8))) - 4);
 }
 if (var_1_15 >= 1) {
  var_1_14 = var_1_13;
 } else {
 ...
 if (var_1_6 || var_1_11) {
  var_1_10 = ((((5) > (var_1_12)) ? (5) : (var_1_12)));
 } else {
  var_1_10 = (128 - var_1_13);
 }
 if (var_1_6) {
  var_1_17 = ((((((((var_1_8) < (var_1_10)) ? (var_1_8) : (var_1_10)))) > (-25)) ? (((((var_1_8) < (var_1_10)) ? (var_1_8) : (var_1_10)))) : (-25)));
 } else {
  if (var_1_15 >= var_1_8) {
...
int property(void) {
 return ((((((((~ var_1_8) < ((var_1_17 * var_1_15) / var_1_5)) ? (var_1_6 ? (var_1_1 == ((signed long int) (128 - var_1_8))) : (var_1_1 == ((signed long int) var_1_8))) : (var_1_1 == ((signed long int) var_1_8))) && (((var_1_1 < var_1_15) || (var_1_8 <= var_1_5)) ? (var_1_6 ? (var_1_7 == ((unsigned long int) var_1_8)) : 1) : 1)) && ((last_1_var_1_17 <= last_1_var_1_15) ? ((! var_1_6) ? (var_1_8 == ((unsigned short int) var_1_9)) : 1) : 1)) && ((var_1_6 || var_1_11) ? (var_1_10 == ((unsigned char) ((((5) > (var_1_12)) ? (5) : (var_1_12))))) : (var_1_10 == ((unsigned char) (128 - var_1_13))))) && ((var_1_15 >= 1) ? (var_1_14 == ((unsigned char) var_1_13)) : (var_1_14 == ((unsigned char) (var_1_13 + 5))))) && (((var_1_12 * last_1_var_1_7) > last_1_var_1_7) ? (var_1_15 == ((signed long int) ((((var_1_13) > (var_1_12)) ? (var_1_13) : (var_1_12))))) : (var_1_15 == ((signed long int) ((((((var_1_16 - var_1_9)) > (last_1_var_1_8)) ? ((var_1_16 - var_1_9)) : (last_1_var_1_8))) - 4))))) && (var_1_6 ? (var_1_17 == ((signed long int) ((((((((var_1_8) < (var_1_10)) ? (var_1_8) : (var_1_10)))) > (-25)) ? (((((var_1_8) < (var_1_10)) ? (var_1_8) : (var_1_10)))) : (-25))))) : ((var_1_15 >= var_1_8) ? (var_1_17 == ((signed long int) ((((var_1_10) > (var_1_14)) ? (var_1_10) : (var_1_14))))) : (var_1_17 == ((signed long int) 16))))
;
}
int main(void) {
 isInitial = 1;
