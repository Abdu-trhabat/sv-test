...
float functionized4(float functionized4_localFunctionVar0) {
 return (((((var_1_18 + functionized4_localFunctionVar0)) > (128.25f)) ? ((var_1_18 + functionized4_localFunctionVar0)) : (128.25f)));
}
signed long int functionized5(void) {
...
void step(void) {
 ...
 if (var_1_4) {
  var_1_15 = ((((((((var_1_16) > (var_1_17)) ? (var_1_16) : (var_1_17)))) > (functionized4(var_1_19))) ? (((((var_1_16) > (var_1_17)) ? (var_1_16) : (var_1_17)))) : (functionized4(var_1_19))));
 }
 if (var_1_14 != 16) {
  var_1_20 = ((((functionized5()) < (var_1_23)) ? (functionized5()) : (var_1_23)));
 }
}
void updateVariables(void) {
