...
void step(void) {
	...
	if (var_1_2 >= var_1_3) {
		if (var_1_2 < ((- var_1_3) * var_1_4)) {
			var_1_1 = ((max (var_1_5 , var_1_6)) + 16);
		} else {
			var_1_1 = var_1_6;
		}
	} else {
	...
	if (var_1_2 > var_1_4) {
		if (stepLocal_0 > ((min (5 , var_1_10)) >> (abs (var_1_8)))) {
			if (var_1_9) {
...
int property(void) {
	return ((((var_1_2 >= var_1_3) ? ((var_1_2 < ((- var_1_3) * var_1_4)) ? (var_1_1 == ((unsigned short int) ((max (var_1_5 , var_1_6)) + 16))) : (var_1_1 == ((unsigned short int) var_1_6))) : (var_1_1 == ((unsigned short int) var_1_5))) && ((var_1_2 > var_1_4) ? ((var_1_5 > ((min (5 , var_1_10)) >> (abs (var_1_8)))) ? (var_1_9 ? ((var_1_8 >= var_1_5) ? (var_1_7 == ((signed char) var_1_8)) : 1) : (var_1_7 == ((signed char) var_1_8))) : 1) : 1)) && (var_1_9 ? (var_1_10 == ((unsigned short int) var_1_5)) : 1)) && ((var_1_9 || var_1_12) ? (var_1_11 == ((unsigned char) ((var_1_13 - var_1_14) + var_1_15))) : 1)
;
}
int main(void) {
	isInitial = 1;
