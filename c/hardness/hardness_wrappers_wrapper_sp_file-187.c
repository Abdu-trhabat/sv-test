...
void step(void) {
	...
	if (last_1_WrapperStruct00_var_1_10 > stepLocal_5) {
		if (((*(WrapperStruct00_var_1_8_Pointer)) - (*(WrapperStruct00_var_1_11_Pointer))) > stepLocal_4) {
			(*(WrapperStruct00_var_1_10_Pointer)) = ((min ((*(WrapperStruct00_var_1_11_Pointer)) , (last_1_WrapperStruct00_var_1_10 + (*(WrapperStruct00_var_1_1_Pointer))))) + (*(WrapperStruct00_var_1_12_Pointer)));
		}
	} else {
	...
	// From: Req2Batch187Wrapper_SP
	unsigned long int stepLocal_3 = (*(WrapperStruct00_var_1_1_Pointer));
	signed long int stepLocal_2 = 2;
	if (stepLocal_2 == (min (((*(WrapperStruct00_var_1_10_Pointer)) | (*(WrapperStruct00_var_1_1_Pointer))) , (*(WrapperStruct00_var_1_1_Pointer))))) {
