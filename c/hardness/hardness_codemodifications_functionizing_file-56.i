...
void functionized1(unsigned short int functionized1_localFunctionVar0, unsigned short int functionized1_localFunctionVar1) {
 if (var_1_4) {
  var_1_6 = (functionized1_localFunctionVar0 + ((((var_1_8) < (functionized1_localFunctionVar1)) ? (var_1_8) : (functionized1_localFunctionVar1))));
 }
}
void functionized2(unsigned short int functionized2_localFunctionVar0, signed long int localFunctionVar1) {
 if (var_1_7 >= ((((var_1_6) < ((functionized2_localFunctionVar0 / localFunctionVar1))) ? (var_1_6) : ((functionized2_localFunctionVar0 / localFunctionVar1))))) {
  var_1_10 = var_1_11;
 } else {
  var_1_10 = ((((var_1_6) > (functionized2_localFunctionVar0)) ? (var_1_6) : (functionized2_localFunctionVar0)));
 }
}
...
void functionized5(unsigned char functionized5_localFunctionVar0, signed char functionized5_localFunctionVar1, unsigned char functionized5_localFunctionVar2, signed char functionized5_localFunctionVar3) {
 if ((- (var_1_18 / var_1_13)) <= (functionized5_localFunctionVar0 + var_1_10)) {
  var_1_19 = ((((functionized5_localFunctionVar2) < ((((((((functionized5_localFunctionVar0) < 0 ) ? -(functionized5_localFunctionVar0) : (functionized5_localFunctionVar0))) < 0 ) ? -((((functionized5_localFunctionVar0) < 0 ) ? -(functionized5_localFunctionVar0) : (functionized5_localFunctionVar0))) : ((((functionized5_localFunctionVar0) < 0 ) ? -(functionized5_localFunctionVar0) : (functionized5_localFunctionVar0))))))) ? (functionized5_localFunctionVar2) : ((((((((functionized5_localFunctionVar0) < 0 ) ? -(functionized5_localFunctionVar0) : (functionized5_localFunctionVar0))) < 0 ) ? -((((functionized5_localFunctionVar0) < 0 ) ? -(functionized5_localFunctionVar0) : (functionized5_localFunctionVar0))) : ((((functionized5_localFunctionVar0) < 0 ) ? -(functionized5_localFunctionVar0) : (functionized5_localFunctionVar0))))))));
 } else {
  var_1_19 = ((((functionized5_localFunctionVar0) < (((functionized5_localFunctionVar1 + var_1_21) - functionized5_localFunctionVar3))) ? (functionized5_localFunctionVar0) : (((functionized5_localFunctionVar1 + var_1_21) - functionized5_localFunctionVar3))));
 }
}
unsigned char functionized6(void) {
