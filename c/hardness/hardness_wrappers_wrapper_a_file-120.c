...
void step(void) {
	// From: Req2Batch120Wrapper_A
	signed long int stepLocal_1 = signed_long_int_Array_0[0];
	if (last_1_BOOL_unsigned_char_Array_0_0_) {
		signed_short_int_Array_0[1][1] = (max ((abs (signed_short_int_Array_0[0][1] + -5)) , signed_short_int_Array_0[1][0]));
	} else {
	...
	// From: Req1Batch120Wrapper_A
	signed long int stepLocal_0 = signed_long_int_Array_0[0];
	if (10 > stepLocal_0) {
		if (BOOL_unsigned_char_Array_0[0]) {
			double_Array_0[1][4] = (abs (double_Array_0[0][4]));
		}
	}


	// From: Req3Batch120Wrapper_A
	if (signed_long_int_Array_0[0] > signed_short_int_Array_0[0][1]) {
		double_Array_0[0][1] = (min ((double_Array_0[1][1] - double_Array_0[0][0]) , (double_Array_0[1][0] + (max (double_Array_0[0][2] , double_Array_0[1][2])))));
	}


	// From: Req5Batch120Wrapper_A
	unsigned_char_Array_0[0] = unsigned_char_Array_0[1];


	// From: Req6Batch120Wrapper_A
	double_Array_0[0][3] = double_Array_0[1][3];


	// From: Req7Batch120Wrapper_A
...
int property(void) {
	return (((((((10 > signed_long_int_Array_0[0]) ? (BOOL_unsigned_char_Array_0[0] ? (double_Array_0[1][4] == ((double) (abs (double_Array_0[0][4])))) : 1) : 1) && (last_1_BOOL_unsigned_char_Array_0_0_ ? (signed_short_int_Array_0[1][1] == ((signed short int) (max ((abs (signed_short_int_Array_0[0][1] + -5)) , signed_short_int_Array_0[1][0])))) : (((signed_short_int_Array_0[1][0] * signed_short_int_Array_0[0][0]) > signed_long_int_Array_0[0]) ? (last_1_BOOL_unsigned_char_Array_0_0_ ? (signed_short_int_Array_0[1][1] == ((signed short int) signed_short_int_Array_0[0][1])) : 1) : (signed_short_int_Array_0[1][1] == ((signed short int) -32))))) && ((signed_long_int_Array_0[0] > signed_short_int_Array_0[0][1]) ? (double_Array_0[0][1] == ((double) (min ((double_Array_0[1][1] - double_Array_0[0][0]) , (double_Array_0[1][0] + (max (double_Array_0[0][2] , double_Array_0[1][2]))))))) : 1)) && ((signed_short_int_Array_0[1][1] != signed_short_int_Array_0[0][0]) ? (BOOL_unsigned_char_Array_0[0] == ((unsigned char) (BOOL_unsigned_char_Array_0[2] || BOOL_unsigned_char_Array_0[1]))) : 1)) && (unsigned_char_Array_0[0] == ((unsigned char) unsigned_char_Array_0[1]))) && (double_Array_0[0][3] == ((double) double_Array_0[1][3]))) && (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0]))
;
}
int main(void) {
	isInitial = 1;
