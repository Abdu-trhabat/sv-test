...
void step(void) {
	...
	if ((var_1_9 && var_1_11) && var_1_9) {
		var_1_21 = (var_1_26 + (var_1_15 + (max (var_1_22 , var_1_23))));
	} else {
	...
	if ((var_1_21 - (abs (var_1_26))) < (var_1_8 - var_1_19)) {
		var_1_17 = var_1_20;
	}
...
int property(void) {
	return (((((((((((var_1_16 * var_1_21) / var_1_4) <= var_1_26) ? (var_1_1 == ((unsigned short int) var_1_6)) : (var_1_1 == ((unsigned short int) (var_1_7 + var_1_8)))) && (((var_1_26 != var_1_4) || var_1_10) ? (var_1_9 == ((unsigned char) var_1_11)) : 1)) && (((var_1_9 && var_1_11) && (50 > var_1_8)) ? (((- var_1_25) < var_1_25) ? (var_1_9 ? (var_1_12 == ((unsigned char) 5)) : 1) : 1) : (var_1_12 == ((unsigned char) var_1_15)))) && (var_1_16 == ((unsigned short int) (min (((max (256 , var_1_7)) + var_1_8) , var_1_15))))) && (((var_1_21 - (abs (var_1_26))) < (var_1_8 - var_1_19)) ? (var_1_17 == ((float) var_1_20)) : 1)) && (((var_1_9 && var_1_11) && var_1_9) ? (var_1_21 == ((unsigned short int) (var_1_26 + (var_1_15 + (max (var_1_22 , var_1_23)))))) : (var_1_21 == ((unsigned short int) ((23370 - var_1_15) + var_1_23))))) && ((! (-4 < var_1_22)) ? (var_1_24 == ((float) var_1_20)) : ((-4 > var_1_1) ? (var_1_24 == ((float) 10.6f)) : 1))) && (var_1_25 == ((double) var_1_20))) && (var_1_26 == ((signed long int) var_1_6))
;
}
int main(void) {
	isInitial = 1;
