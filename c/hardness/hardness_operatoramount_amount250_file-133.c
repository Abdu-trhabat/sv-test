...
void step(void) {
	...
	if (var_1_12 || var_1_3) {
		...
		if (var_1_10 >= (var_1_8 - (var_1_13 - var_1_9))) {
			if (var_1_8 < -0.875f) {
				...
				var_1_11 = (min ((var_1_10 - var_1_8) , (var_1_9 + var_1_7)));
			}
		}
	}


	// From: Req3Batch133Amount250
	var_1_15 = (var_1_16 + var_1_17);


	// From: Req7Batch133Amount250
	var_1_28 = var_1_29;


	// From: Req12Batch133Amount250
	...
	// From: Req14Batch133Amount250
	if (var_1_30) {
		var_1_42 = (var_1_43 + var_1_17);
	}


	// From: Req17Batch133Amount250
	if (((-50 <= var_1_16) || var_1_35) && var_1_30) {
		if (! (var_1_43 != var_1_40)) {
			var_1_48 = (min (var_1_9 , var_1_14));
		} else {
	...
	// From: Req23Batch133Amount250
	signed long int stepLocal_15 = var_1_17 / (min (var_1_21 , var_1_59));
	if ((min (-50 , -32)) < stepLocal_15) {
		var_1_58 = var_1_29;
	} else {
		var_1_58 = 10;
	}
	...
	// From: Req20Batch133Amount250
	if ((var_1_40 <= var_1_42) && var_1_34) {
		var_1_52 = (var_1_47 - (max (var_1_8 , var_1_9)));
	} else {
		if ((min (var_1_6 , 10.2f)) > (var_1_47 - var_1_10)) {
			var_1_52 = (min ((var_1_10 - (min (var_1_8 , var_1_47))) , (var_1_7 + var_1_9)));
		} else {
			var_1_52 = var_1_7;
		}
	}
	...
	if (var_1_34 || stepLocal_1) {
		...
		var_1_25 = (var_1_21 - (min (5 , 256)));
	}


	// From: Req10Batch133Amount250
	if (var_1_52 <= ((var_1_13 - var_1_10) - var_1_9)) {
		var_1_36 = (var_1_21 - (var_1_24 + var_1_22));
	}


	// From: Req19Batch133Amount250
	if ((max (var_1_6 , (- var_1_8))) > var_1_52) {
		var_1_50 = (var_1_21 - var_1_29);
	} else {
		var_1_50 = (min (var_1_29 , var_1_27));
	}


	// From: Req4Batch133Amount250
	signed long int stepLocal_0 = (var_1_16 & var_1_25) + (abs (1));
	if (stepLocal_0 >= (min (var_1_17 , var_1_42))) {
		if (var_1_8 < (var_1_13 - var_1_10)) {
			var_1_18 = (min ((abs (var_1_16)) , (var_1_17 + var_1_20)));
		}
	} else {
		if ((var_1_9 * var_1_7) != var_1_14) {
			var_1_18 = (((var_1_21 - var_1_22) - (max (var_1_23 , var_1_24))) - var_1_16);
		}
	}


	// From: Req11Batch133Amount250
	var_1_37 = (max ((max (var_1_18 , var_1_27)) , var_1_38));


	// From: Req21Batch133Amount250
	if (((- var_1_40) + var_1_36) > (min (var_1_23 , var_1_37))) {
		var_1_53 = var_1_29;
	} else {
	...
	if (stepLocal_14 <= (max ((~ var_1_40) , var_1_15))) {
		if (var_1_14 != var_1_48) {
			if (stepLocal_13 == (max (var_1_31 , var_1_16))) {
				var_1_55 = (var_1_9 + (min (1.0000000003E9 , var_1_8)));
			} else {
				if (var_1_52 > (var_1_10 / var_1_47)) {
					if (var_1_45 <= stepLocal_12) {
						var_1_55 = var_1_8;
					} else {
						var_1_55 = (min (var_1_9 , ((var_1_10 + var_1_57) + var_1_8)));
					}
				}
			}
		} else {
	...
	// From: Req6Batch133Amount250
	unsigned char stepLocal_5 = var_1_53 > var_1_20;
	signed long int stepLocal_4 = min (var_1_16 , var_1_23);
	...
	if (stepLocal_5 && var_1_34) {
		...
		var_1_26 = ((max (var_1_27 , var_1_23)) - var_1_24);
	}


	// From: Req16Batch133Amount250
	unsigned short int stepLocal_11 = var_1_24;
	signed long int stepLocal_10 = var_1_53 / -4;
	if ((var_1_40 / (min (var_1_21 , var_1_31))) > stepLocal_10) {
		if (stepLocal_11 > (var_1_25 / var_1_21)) {
			var_1_46 = var_1_7;
		} else {
			var_1_46 = ((min (var_1_10 , (var_1_47 - var_1_8))) - var_1_9);
		}
	} else {
		var_1_46 = (var_1_47 - (abs (var_1_9 + var_1_7)));
	}


	// From: Req18Batch133Amount250
...
int property(void) {
	return ((((((((((((((((((((((((var_1_34 && var_1_30) ? ((var_1_55 <= ((10.5 + var_1_55) / var_1_6)) ? (var_1_1 == ((float) (var_1_7 + 255.2f))) : 1) : (var_1_1 == ((float) ((var_1_8 - (var_1_9 - var_1_10)) + (max (256.4f , 64.6f)))))) && ((var_1_12 || var_1_3) ? (var_1_11 == ((float) var_1_8)) : ((var_1_10 >= (var_1_8 - (var_1_13 - var_1_9))) ? ((var_1_8 < -0.875f) ? (var_1_11 == ((float) (min (var_1_14 , var_1_10)))) : (var_1_11 == ((float) (min ((var_1_10 - var_1_8) , (var_1_9 + var_1_7)))))) : 1))) && (var_1_15 == ((unsigned short int) (var_1_16 + var_1_17)))) && ((((var_1_16 & var_1_25) + (abs (1))) >= (min (var_1_17 , var_1_42))) ? ((var_1_8 < (var_1_13 - var_1_10)) ? (var_1_18 == ((unsigned short int) (min ((abs (var_1_16)) , (var_1_17 + var_1_20))))) : 1) : (((var_1_9 * var_1_7) != var_1_14) ? (var_1_18 == ((unsigned short int) (((var_1_21 - var_1_22) - (max (var_1_23 , var_1_24))) - var_1_16))) : 1))) && ((var_1_34 || (var_1_21 > 4)) ? (((var_1_48 < -0.5) && var_1_30) ? (var_1_25 == ((unsigned short int) var_1_21)) : 1) : (var_1_25 == ((unsigned short int) (var_1_21 - (min (5 , 256))))))) && (((var_1_53 > var_1_20) && var_1_34) ? ((var_1_17 <= (min (var_1_16 , var_1_23))) ? ((var_1_42 >= var_1_53) ? (var_1_26 == ((signed short int) (var_1_21 + ((var_1_22 + var_1_27) - var_1_23)))) : (var_1_26 == ((signed short int) (var_1_23 - var_1_24)))) : 1) : (var_1_26 == ((signed short int) ((max (var_1_27 , var_1_23)) - var_1_24))))) && (var_1_28 == ((unsigned char) var_1_29))) && ((((var_1_29 * var_1_21) / var_1_31) < var_1_24) ? ((! last_1_var_1_34) ? (var_1_30 == ((unsigned char) (last_1_var_1_34 && (last_1_var_1_34 && (! var_1_32))))) : 1) : ((! last_1_var_1_34) ? (var_1_30 == ((unsigned char) ((! var_1_33) && var_1_32))) : 1))) && ((! var_1_30) ? (var_1_34 == ((unsigned char) (! (var_1_32 && var_1_35)))) : (var_1_34 == ((unsigned char) var_1_35)))) && ((var_1_52 <= ((var_1_13 - var_1_10) - var_1_9)) ? (var_1_36 == ((unsigned short int) (var_1_21 - (var_1_24 + var_1_22)))) : 1)) && (var_1_37 == ((signed long int) (max ((max (var_1_18 , var_1_27)) , var_1_38))))) && (((var_1_40 - 1) < var_1_22) ? (var_1_39 == ((signed short int) 256)) : 1)) && ((var_1_16 <= var_1_17) ? (((var_1_16 << last_1_var_1_42) > last_1_var_1_50) ? (var_1_40 == ((unsigned long int) (var_1_41 - var_1_29))) : 1) : 1)) && (var_1_30 ? (var_1_42 == ((unsigned long int) (var_1_43 + var_1_17))) : 1)) && (((var_1_16 * var_1_60) != var_1_23) ? ((var_1_18 >= var_1_24) ? (var_1_44 == ((signed short int) (((var_1_29 + var_1_49) + var_1_27) + (var_1_22 + var_1_45)))) : 1) : (var_1_44 == ((signed short int) (var_1_22 - ((var_1_29 + 10) + var_1_27)))))) && (((var_1_40 / (min (var_1_21 , var_1_31))) > (var_1_53 / -4)) ? ((var_1_24 > (var_1_25 / var_1_21)) ? (var_1_46 == ((float) var_1_7)) : (var_1_46 == ((float) ((min (var_1_10 , (var_1_47 - var_1_8))) - var_1_9)))) : (var_1_46 == ((float) (var_1_47 - (abs (var_1_9 + var_1_7))))))) && ((((-50 <= var_1_16) || var_1_35) && var_1_30) ? ((! (var_1_43 != var_1_40)) ? (var_1_48 == ((double) (min (var_1_9 , var_1_14)))) : (var_1_48 == ((double) (var_1_8 - var_1_9)))) : 1)) && (((var_1_21 / var_1_41) <= var_1_23) ? ((var_1_13 != (- var_1_55)) ? (var_1_49 == ((unsigned char) var_1_29)) : 1) : (var_1_49 == ((unsigned char) var_1_29)))) && (((max (var_1_6 , (- var_1_8))) > var_1_52) ? (var_1_50 == ((unsigned short int) (var_1_21 - var_1_29))) : (var_1_50 == ((unsigned short int) (min (var_1_29 , var_1_27)))))) && (((var_1_40 <= var_1_42) && var_1_34) ? (var_1_52 == ((double) (var_1_47 - (max (var_1_8 , var_1_9))))) : (((min (var_1_6 , 10.2f)) > (var_1_47 - var_1_10)) ? (var_1_52 == ((double) (min ((var_1_10 - (min (var_1_8 , var_1_47))) , (var_1_7 + var_1_9))))) : (var_1_52 == ((double) var_1_7))))) && ((((- var_1_40) + var_1_36) > (min (var_1_23 , var_1_37))) ? (var_1_53 == ((unsigned short int) var_1_29)) : (var_1_53 == ((unsigned short int) (var_1_17 + var_1_29))))) && ((var_1_36 <= (max ((~ var_1_40) , var_1_15))) ? ((var_1_14 != var_1_48) ? ((var_1_45 == (max (var_1_31 , var_1_16))) ? (var_1_55 == ((double) (var_1_9 + (min (1.0000000003E9 , var_1_8))))) : ((var_1_52 > (var_1_10 / var_1_47)) ? ((var_1_45 <= (var_1_24 + var_1_53)) ? (var_1_55 == ((double) var_1_8)) : (var_1_55 == ((double) (min (var_1_9 , ((var_1_10 + var_1_57) + var_1_8)))))) : 1)) : (var_1_55 == ((double) (var_1_10 + var_1_8)))) : 1)) && (((min (-50 , -32)) < (var_1_17 / (min (var_1_21 , var_1_59)))) ? (var_1_58 == ((unsigned char) var_1_29)) : (var_1_58 == ((unsigned char) 10)))) && ((last_1_var_1_60 > var_1_25) ? ((var_1_10 < var_1_13) ? (var_1_33 ? (var_1_60 == ((unsigned short int) (var_1_27 + (var_1_61 - var_1_49)))) : (var_1_34 ? (var_1_60 == ((unsigned short int) (abs (var_1_16)))) : 1)) : (var_1_60 == ((unsigned short int) var_1_24))) : (var_1_60 == ((unsigned short int) var_1_24)))
;
}
int main(void) {
	isInitial = 1;
