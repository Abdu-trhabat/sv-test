...
void step(void) {
	...
	// From: CodeObject3
	/* 308L, 177L) */ if (/* 309L, 142L, 143L) */ (! (/* 310L, 141L, 144L) */ ((var_1_35) >= (var_1_3))))) {
		/* 313L, 175L) */ if (/* 314L, 155L, 156L) */ ((/* 315L, 153L, 157L) */ (abs (/* 316L, 152L, 158L) */ (abs (var_1_3))))) > (var_1_32))) {
			/* 319L, 170L) */ var_1_37 = (
				/* 322L, 169L) */ (abs (
					var_1_35
				))
	...
	// From: CodeObject5
	/* 333L, 210L) */ if (/* 334L, 193L, 194L) */ ((var_1_4) != (/* 336L, 192L, 196L) */ (min (/* 336L, 192L, 196L) */ (64) , (var_1_4)))))) {
		/* 339L, 209L) */ var_1_40 = (
			/* 342L, 208L) */ (abs (
				/* 343L, 207L) */ (abs (
					var_1_34
