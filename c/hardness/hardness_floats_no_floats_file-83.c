...
void step(void) {
	...
	if (var_1_2) {
		...
		if (stepLocal_0 >= (min ((var_1_5 * var_1_6) , (~ var_1_7)))) {
			var_1_1 = var_1_4;
		} else {
			var_1_1 = var_1_3;
		}
	...
	if ((var_1_9 - 8) != (- (var_1_10 + var_1_11))) {
		var_1_8 = (min (var_1_12 , ((var_1_13 - var_1_14) + var_1_15)));
	} else {
		var_1_8 = var_1_13;
	}
...
int property(void) {
	return ((var_1_2 ? (var_1_1 == ((unsigned short int) (abs (abs (var_1_3))))) : (((var_1_3 / var_1_4) >= (min ((var_1_5 * var_1_6) , (~ var_1_7)))) ? (var_1_1 == ((unsigned short int) var_1_4)) : (var_1_1 == ((unsigned short int) var_1_3)))) && (((var_1_9 - 8) != (- (var_1_10 + var_1_11))) ? (var_1_8 == ((signed long int) (min (var_1_12 , ((var_1_13 - var_1_14) + var_1_15))))) : (var_1_8 == ((signed long int) var_1_13)))) && (((var_1_4 + var_1_5) > (var_1_3 - var_1_7)) ? (var_1_16 == ((signed long int) (abs (var_1_14)))) : ((var_1_5 >= var_1_7) ? (var_1_16 == ((signed long int) var_1_12)) : (var_1_16 == ((signed long int) var_1_13))))
;
}
int main(void) {
	isInitial = 1;
