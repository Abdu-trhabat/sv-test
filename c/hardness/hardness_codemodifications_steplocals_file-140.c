...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch140stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch140stepLocals
	if (var_1_3) {
		var_1_8 = (var_1_9 + var_1_10);
	}


	// From: Req3Batch140stepLocals
	if (var_1_10 >= var_1_8) {
		var_1_11 = (var_1_12 - var_1_13);
	}


	// From: Req4Batch140stepLocals
	var_1_14 = (max (var_1_6 , (min (var_1_4 , var_1_5))));


	// From: Req5Batch140stepLocals
	if (var_1_1 <= var_1_6) {
	...
	// From: Req6Batch140stepLocals
	if (var_1_6 > var_1_5) {
		if (((var_1_6 - var_1_7) | var_1_4) >= var_1_1) {
	...
	// From: Req7Batch140stepLocals
	var_1_23 = (max ((max (var_1_7 , var_1_21)) , var_1_24));


	// From: Req8Batch140stepLocals
	var_1_25 = -1;
}
