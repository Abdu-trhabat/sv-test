...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch36Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 217L, 40L) */ if (/* 218L, 16L, 17L) */ ((/* 219L, 14L, 18L) */ ((/* 220L, 12L, 19L) */ ((var_1_8) ^ (8))) * (var_1_27))) <= (var_1_29))) {
		/* 225L, 39L) */ var_1_28 = (
			/* 228L, 38L) */ (abs (
				/* 229L, 37L) */ (min (
					/* 229L, 37L) */ (
	...
	// From: CodeObject4
	/* 240L, 91L) */ if (/* 241L, 57L, 58L) */ ((var_1_27) > (var_1_24))) {
		/* 244L, 74L) */ var_1_36 = (
			/* 247L, 73L) */ (abs (
				/* 248L, 72L) */ (min (
					/* 248L, 72L) */ (
	...
	// From: CodeObject5
	/* 264L, 127L) */ if (/* 265L, 101L, 102L) */ ((var_1_27) < (/* 267L, 100L, 104L) */ ((/* 268L, 98L, 105L) */ (min (/* 268L, 98L, 105L) */ (var_1_22) , (var_1_29)))) / (var_1_42))))) {
		/* 272L, 121L) */ var_1_41 = (
			/* 275L, 120L) */ ((
				var_1_39
			) + (
