...
void step(void) {
	...
	if (((min (var_1_2 , var_1_3)) + 64u) != (var_1_4 * var_1_5)) {
	...
	if (((var_1_10 / var_1_16) + var_1_12) >= (abs (var_1_17))) {
	...
	if ((var_1_9 + var_1_14) < (var_1_15 / (min (var_1_25 , var_1_8)))) {
...
int property(void) {
	return (((((((((min (var_1_2 , var_1_3)) + 64u) != (var_1_4 * var_1_5)) ? (var_1_1 == ((signed short int) ((var_1_6 - (32 + var_1_7)) - (var_1_8 - var_1_9)))) : 1) && ((var_1_7 < ((var_1_8 - var_1_9) >> var_1_11)) ? (var_1_10 == ((float) var_1_12)) : 1)) && ((var_1_8 > var_1_7) ? (var_1_13 == ((signed char) (max (var_1_11 , var_1_14)))) : 1)) && ((((var_1_10 / var_1_16) + var_1_12) >= (abs (var_1_17))) ? (var_1_15 == ((signed char) (abs (var_1_11)))) : ((var_1_10 < var_1_16) ? (var_1_15 == ((signed char) var_1_11)) : 1))) && (var_1_19 ? ((4 > var_1_9) ? (var_1_18 == ((double) var_1_12)) : 1) : (var_1_18 == ((double) ((max (var_1_20 , var_1_21)) - (max (var_1_22 , var_1_23))))))) && ((var_1_20 < var_1_16) ? (var_1_24 == ((unsigned char) ((var_1_25 - var_1_11) - 2))) : 1)) && (((var_1_9 + var_1_14) < (var_1_15 / (min (var_1_25 , var_1_8)))) ? (var_1_26 == ((unsigned long int) (min ((var_1_27 - var_1_8) , var_1_11)))) : 1)
;
}
int main(void) {
	isInitial = 1;
