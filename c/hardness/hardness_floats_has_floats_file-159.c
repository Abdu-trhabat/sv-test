...
void step(void) {
	...
	// From: Req2Batch159has_floats
	if (((var_1_8 - var_1_9) / -128.0f) < (min ((var_1_10 + var_1_11) , var_1_12))) {
		var_1_7 = (var_1_13 + ((var_1_14 + var_1_15) + 128));
	}


	// From: Req3Batch159has_floats
	if (var_1_12 <= last_1_var_1_16) {
		var_1_16 = -8.0f;
	}


	// From: Req4Batch159has_floats
	if (var_1_4) {
		if (var_1_16 <= (- var_1_8)) {
