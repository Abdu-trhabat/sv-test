...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch64Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	/* 227L, 24L) */ if (/* 228L, 6L, 7L) */ ((/* 229L, 4L, 8L) */ ((var_1_4) + (var_1_12))) < (var_1_13))) {
		/* 233L, 23L) */ var_1_28 = (
			/* 236L, 22L) */ (min (
				/* 236L, 22L) */ (
					var_1_32
	...
	// From: CodeObject3
	/* 245L, 56L) */ if (/* 246L, 40L, 41L) */ ((var_1_26) < (var_1_1))) {
		/* 249L, 55L) */ var_1_36 = (
			/* 252L, 54L) */ (abs (
				/* 253L, 53L) */ (max (
					/* 253L, 53L) */ (
	...
	// From: CodeObject4
	/* 258L, 104L) */ if (/* 259L, 62L, 63L) */ ((var_1_26) > (var_1_8))) {
		/* 262L, 98L) */ if (/* 263L, 73L, 74L) */ ((/* 264L, 71L, 75L) */ (max (/* 264L, 71L, 75L) */ (32) , (var_1_35)))) <= (var_1_8))) {
			/* 268L, 88L) */ var_1_38 = (
				/* 271L, 87L) */ (abs (
					var_1_39
				))
	...
	/* 288L, 151L) */ if (/* 289L, 110L, 111L) */ ((var_1_35) <= (100u))) {
		/* 292L, 145L) */ if (/* 293L, 124L, 125L) */ ((/* 294L, 120L, 126L) */ ((var_1_11) - (/* 296L, 119L, 128L) */ (abs (-2))))) == (/* 298L, 123L, 130L) */ ((var_1_14) + (-4))))) {
			/* 301L, 144L) */ var_1_40 = (
				var_1_11
			);
		}
