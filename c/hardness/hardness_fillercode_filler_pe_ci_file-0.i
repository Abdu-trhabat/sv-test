...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch0Filler_PE_CI.c", 13, "reach_error"); }
 ...
 unsigned long int stepLocal_0 = var_1_7;
   ...
   var_1_25
    ...
    var_1_39
                   ...
                   if ( (( (( ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))) - ( ((var_1_23) + (var_1_41))))) <= (var_1_33))) {
                    var_1_40 = (
