...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch18350_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch18350_1loop
	if (! var_1_2) {
		var_1_1 = (var_1_3 + var_1_4);
	}


	// From: Req3Batch18350_1loop
