...
void functionized0(unsigned char functionized0_localFunctionVar0, unsigned short int functionized0_localFunctionVar1, unsigned short int functionized0_localFunctionVar2) {
	if (functionized0_localFunctionVar1 == (functionized0_localFunctionVar2 ^ var_1_4)) {
		if (var_1_5 && functionized0_localFunctionVar0) {
			...
			var_1_1 = (min ((functionized0_localFunctionVar1 + functionized0_localFunctionVar2) , var_1_4));
		}
	}
}
void functionized1(signed short int functionized1_localFunctionVar0, signed short int functionized1_localFunctionVar1) {
	var_1_7 = (min (functionized1_localFunctionVar0 , ((functionized1_localFunctionVar1 - var_1_10) + var_1_11)));
}
...
void functionized6(unsigned char functionized6_localFunctionVar0, float functionized6_localFunctionVar1, double functionized6_localFunctionVar2) {
	if (functionized6_localFunctionVar1 < functionized6_localFunctionVar2) {
		if (var_1_11 >= (min (var_1_4 , var_1_7))) {
...
void step(void) {
	...
	// From: Req6Batch144functionizing
	if (var_1_18 || (var_1_5 && var_1_15)) {
		var_1_22 = var_1_3;
	}


	// From: Req7Batch144functionizing
	functionized4(var_1_17, var_1_25);


	// From: Req8Batch144functionizing
	var_1_26 = functionized5(var_1_17);


	// From: Req9Batch144functionizing
...
int property(void) {
	return (((((((((var_1_2 == (var_1_3 ^ var_1_4)) ? ((var_1_5 && var_1_6) ? (var_1_1 == ((signed long int) var_1_2)) : (var_1_1 == ((signed long int) (min ((var_1_2 + var_1_3) , var_1_4))))) : 1) && (var_1_7 == ((signed short int) (min (var_1_8 , ((var_1_9 - var_1_10) + var_1_11)))))) && ((((var_1_7 * var_1_9) <= var_1_1) || var_1_5) ? (var_1_12 == ((double) (var_1_13 + var_1_14))) : 1)) && ((var_1_8 >= var_1_16) ? (var_1_15 == ((unsigned char) (var_1_17 && var_1_18))) : 1)) && (((var_1_1 / var_1_20) <= var_1_16) ? (var_1_5 ? (var_1_19 == ((float) ((var_1_21 + (abs (var_1_13))) - (abs (abs (1000000.625f)))))) : (var_1_19 == ((float) var_1_13))) : 1)) && ((var_1_18 || (var_1_5 && var_1_15)) ? (var_1_22 == ((unsigned long int) var_1_3)) : 1)) && ((var_1_17 && var_1_6) ? (var_1_23 == ((signed char) (var_1_24 - var_1_25))) : 1)) && (var_1_26 == ((unsigned char) (var_1_17 && var_1_27)))) && ((var_1_21 < var_1_12) ? ((var_1_11 >= (min (var_1_4 , var_1_7))) ? (var_1_17 ? (var_1_28 == ((unsigned char) var_1_25)) : (var_1_28 == ((unsigned char) 32))) : 1) : (var_1_28 == ((unsigned char) var_1_25)))
;
}
int main(void) {
	isInitial = 1;
