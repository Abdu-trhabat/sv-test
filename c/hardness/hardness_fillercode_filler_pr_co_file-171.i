...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch171Filler_PR_CO.c", 13, "reach_error"); }
 ...
 signed short int stepLocal_1 = var_1_5;
   ...
   var_1_14
     ...
     var_1_29
                      ...
                      var_1_41 = (
                       ((((( ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) )) < (( var_1_19 ))) ? (( ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) )) : (( var_1_19 ))))
    );
   }
  } else {
