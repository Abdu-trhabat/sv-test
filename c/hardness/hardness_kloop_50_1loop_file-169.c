...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16950_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch16950_1loop
	if (last_1_var_1_13 < ((var_1_3 - var_1_4) / (max (var_1_5 , var_1_6)))) {
		var_1_1 = (var_1_3 - (max ((max (64 , var_1_4)) , var_1_7)));
	}


	// From: Req4Batch16950_1loop
	if (var_1_4 == (~ (var_1_5 + var_1_1))) {
		var_1_13 = var_1_14;
	}


	// From: Req2Batch16950_1loop
	if (var_1_6 > var_1_5) {
		var_1_8 = (abs (var_1_3));
	}


	// From: Req3Batch16950_1loop
	var_1_9 = ((min (var_1_10 , (1.000000000000005E14 + 256.1))) - (var_1_11 + var_1_12));


	// From: Req5Batch16950_1loop
	if (var_1_14 > (max (var_1_1 , -8))) {
		var_1_15 = (min ((var_1_16 + (max (var_1_17 , var_1_18))) , var_1_19));
	} else {
		var_1_15 = (min (var_1_16 , var_1_19));
	}


	// From: Req6Batch16950_1loop
	...
	// From: Req7Batch16950_1loop
	var_1_22 = ((min (var_1_4 , var_1_23)) + (var_1_24 + var_1_25));


	// From: Req8Batch16950_1loop
	signed long int stepLocal_2 = var_1_8;
	unsigned long int stepLocal_1 = 5u >> 16;
	if ((8 << var_1_17) < stepLocal_2) {
		if (stepLocal_1 > (var_1_28 - (abs (100u)))) {
			var_1_26 = var_1_29;
		}
	}
}
...
int property(void) {
	return ((((((((last_1_var_1_13 < ((var_1_3 - var_1_4) / (max (var_1_5 , var_1_6)))) ? (var_1_1 == ((signed long int) (var_1_3 - (max ((max (64 , var_1_4)) , var_1_7))))) : 1) && ((var_1_6 > var_1_5) ? (var_1_8 == ((signed long int) (abs (var_1_3)))) : 1)) && (var_1_9 == ((double) ((min (var_1_10 , (1.000000000000005E14 + 256.1))) - (var_1_11 + var_1_12))))) && ((var_1_4 == (~ (var_1_5 + var_1_1))) ? (var_1_13 == ((signed short int) var_1_14)) : 1)) && ((var_1_14 > (max (var_1_1 , -8))) ? (var_1_15 == ((signed char) (min ((var_1_16 + (max (var_1_17 , var_1_18))) , var_1_19)))) : (var_1_15 == ((signed char) (min (var_1_16 , var_1_19)))))) && ((((var_1_21 - var_1_4) << var_1_16) < var_1_8) ? (var_1_20 == ((signed char) var_1_16)) : 1)) && (var_1_22 == ((unsigned short int) ((min (var_1_4 , var_1_23)) + (var_1_24 + var_1_25))))) && (((8 << var_1_17) < var_1_8) ? (((5u >> 16) > (var_1_28 - (abs (100u)))) ? (var_1_26 == ((unsigned char) var_1_29)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
