...
void step(void) {
	// From: Req1Batch127Wrapper_S
	if ((max (0u , WrapperStruct00.var_1_2)) > (~ WrapperStruct00.var_1_3)) {
		WrapperStruct00.var_1_1 = ((! WrapperStruct00.var_1_4) && (WrapperStruct00.var_1_5 || WrapperStruct00.var_1_6));
	}


	// From: Req2Batch127Wrapper_S
