...
void step(void) {
 ...
 if (signed_short_int_Array_0[6] > stepLocal_4) {
  if (stepLocal_3 <= (((((unsigned_char_Array_0[0][0]) > (unsigned_char_Array_0[1][1])) ? (unsigned_char_Array_0[0][0]) : (unsigned_char_Array_0[1][1]))) << (signed_short_int_Array_0[1] - signed_short_int_Array_0[2]))) {
