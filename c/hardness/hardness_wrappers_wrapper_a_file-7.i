...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[0]) {
  if (stepLocal_1 || BOOL_unsigned_char_Array_0[1]) {
   ...
   float_Array_0[2] = ((((float_Array_0[3] - (float_Array_0[1] + float_Array_0[4])) < 0 ) ? -(float_Array_0[3] - (float_Array_0[1] + float_Array_0[4])) : (float_Array_0[3] - (float_Array_0[1] + float_Array_0[4]))));
  }
 } else {
  float_Array_0[2] = ((((float_Array_0[0]) > (float_Array_0[4])) ? (float_Array_0[0]) : (float_Array_0[4])));
 }
