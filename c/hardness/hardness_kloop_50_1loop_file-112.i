...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11250_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_14 = (((((var_1_15 + var_1_10)) > (var_1_4)) ? ((var_1_15 + var_1_10)) : (var_1_4)));
 ...
 if (((var_1_19 + var_1_20) - (var_1_17 + var_1_16)) > (var_1_4 - var_1_10)) {
  ...
  if (((var_1_16 % var_1_21) % var_1_22) > last_1_var_1_18) {
   var_1_18 = (((((var_1_23) < 0 ) ? -(var_1_23) : (var_1_23))) - var_1_17);
  } else {
   if (! var_1_9) {
    var_1_18 = var_1_21;
   } else {
