...
int property(void) {
	return (((((last_1_var_1_9 / var_1_3) + last_1_var_1_10) != last_1_var_1_10) ? ((last_1_var_1_9 <= last_1_var_1_10) ? (var_1_1 == ((signed char) (min ((var_1_6 + var_1_7) , var_1_8)))) : 1) : (var_1_1 == ((signed char) (abs (var_1_7))))) && (((- (16 << var_1_1)) > var_1_3) ? (var_1_9 == ((signed char) var_1_6)) : 1)) && (((var_1_1 + (var_1_8 % var_1_3)) >= ((var_1_12 - var_1_13) >> var_1_14)) ? ((var_1_15 && var_1_16) ? (var_1_10 == ((unsigned long int) var_1_14)) : (var_1_10 == ((unsigned long int) var_1_12))) : (var_1_10 == ((unsigned long int) var_1_11)))
;
}
int main(void) {
	isInitial = 1;
