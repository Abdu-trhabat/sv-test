...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 266L, 37L) */ if (/* 267L, 12L, 13L) */ ((/* 268L, 6L, 14L) */ ((var_1_11) | (/* 270L, 5L, 16L) */ (max (/* 270L, 5L, 16L) */ (var_1_11) , (var_1_15)))))) < (/* 273L, 11L, 19L) */ ((/* 274L, 9L, 20L) */ (abs (var_1_25))) >> (25))))) {
		/* 277L, 36L) */ var_1_21 = (
			var_1_26
		);
	}
	...
	// From: CodeObject5
	/* 311L, 129L) */ if (/* 312L, 95L, 96L) */ ((var_1_7) != (var_1_1))) {
	...
	// From: CodeObject6
	/* 331L, 151L) */ if (/* 332L, 136L, 137L) */ ((/* 333L, 134L, 138L) */ (abs (var_1_36))) >= (var_1_18))) {
		/* 336L, 150L) */ var_1_39 = (
			/* 339L, 149L) */ ((
				var_1_12
			) && (
