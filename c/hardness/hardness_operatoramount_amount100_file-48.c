...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch48Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((max (var_1_13 , 0)) - last_1_var_1_25) >= last_1_var_1_29) {
	...
	if (last_1_var_1_23 <= (var_1_24 * (min (var_1_11 , var_1_10)))) {
	...
	if (stepLocal_9 && var_1_3) {
		if ((var_1_10 - (var_1_9 + var_1_24)) == var_1_8) {
			var_1_29 = (min (var_1_14 , (min (1 , var_1_6))));
		}
	} else {
		var_1_29 = 1000;
	}
...
int property(void) {
	return (((((((((((var_1_2 || var_1_3) ? ((var_1_29 >= var_1_32) ? (var_1_1 == ((signed short int) (var_1_6 + var_1_7))) : (var_1_1 == ((signed short int) var_1_7))) : (var_1_1 == ((signed short int) var_1_7))) && (var_1_8 == ((float) ((var_1_9 - var_1_10) + var_1_11)))) && ((var_1_25 >= var_1_32) ? (var_1_12 == ((unsigned char) ((var_1_13 - var_1_14) + (100 - (var_1_15 - var_1_16))))) : ((var_1_25 <= 100) ? (var_1_12 == ((unsigned char) (max (var_1_14 , var_1_13)))) : (var_1_12 == ((unsigned char) var_1_13))))) && ((((max (var_1_13 , 0)) - last_1_var_1_25) >= last_1_var_1_29) ? (var_1_17 == ((double) (var_1_10 + var_1_9))) : (last_1_var_1_18 ? (var_1_17 == ((double) var_1_9)) : 1))) && (var_1_3 ? (var_1_18 == ((unsigned char) (var_1_19 || ((var_1_10 > var_1_17) && var_1_20)))) : (var_1_18 == ((unsigned char) ((! (! var_1_19)) || var_1_20))))) && ((((25 + var_1_12) / var_1_15) > ((min (var_1_16 , var_1_13)) / var_1_22)) ? (var_1_21 == ((signed char) (min (var_1_16 , var_1_14)))) : (var_1_21 == ((signed char) var_1_14)))) && ((var_1_32 <= (- var_1_32)) ? (var_1_23 == ((float) (((min (var_1_10 , var_1_9)) - var_1_24) + var_1_11))) : (var_1_23 == ((float) (abs (var_1_24)))))) && ((-32 > (~ var_1_1)) ? (((var_1_10 <= (- var_1_9)) || (10 > 8)) ? ((var_1_1 > var_1_32) ? (var_1_25 == ((signed short int) var_1_1)) : 1) : 1) : (var_1_25 == ((signed short int) var_1_14)))) && ((! var_1_20) ? (((10u / var_1_13) < (var_1_22 + last_1_var_1_26)) ? (var_1_26 == ((unsigned char) (min (var_1_13 , (var_1_27 - var_1_28))))) : (var_1_26 == ((unsigned char) (var_1_16 + var_1_15)))) : 1)) && ((var_1_30 && var_1_3) ? (((var_1_10 - (var_1_9 + var_1_24)) == var_1_8) ? (var_1_29 == ((signed short int) (min (var_1_14 , (min (1 , var_1_6)))))) : 1) : (var_1_29 == ((signed short int) 1000)))) && ((last_1_var_1_23 <= (var_1_24 * (min (var_1_11 , var_1_10)))) ? ((last_1_var_1_25 > (- (- var_1_6))) ? (var_1_32 == ((unsigned long int) last_1_var_1_25)) : (var_1_32 == ((unsigned long int) var_1_13))) : (var_1_32 == ((unsigned long int) var_1_27)))
;
}
int main(void) {
	isInitial = 1;
