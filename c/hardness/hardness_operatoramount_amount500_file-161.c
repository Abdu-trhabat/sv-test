...
void step(void) {
	...
	if (stepLocal_12 && last_1_var_1_50) {
		if (stepLocal_11 >= last_1_var_1_74) {
			var_1_60 = (abs (max ((last_1_var_1_17 + last_1_var_1_85) , var_1_33)));
		} else {
			var_1_60 = (max (last_1_var_1_31 , (var_1_15 - (abs (var_1_28)))));
		}
	} else {
	...
	// From: Req6Batch161Amount500
	if (var_1_13 <= var_1_12) {
		if (((var_1_13 * var_1_12) % (max (var_1_23 , var_1_24))) > var_1_60) {
			var_1_22 = (var_1_25 - var_1_12);
		} else {
			var_1_22 = (var_1_25 - (max (var_1_16 , var_1_15)));
		}
	} else {
		var_1_22 = ((min ((max (var_1_13 , var_1_14)) , (256u + var_1_15))) + (abs (var_1_26 - var_1_18)));
	}


	// From: Req2Batch161Amount500
	...
	// From: Req4Batch161Amount500
	if (var_1_8 >= 25.5f) {
		var_1_19 = (! var_1_20);
	}


	// From: Req5Batch161Amount500
	...
	// From: Req8Batch161Amount500
	if (var_1_20) {
		var_1_31 = (var_1_13 - ((max (var_1_29 , var_1_28)) + var_1_18));
	}


	// From: Req14Batch161Amount500
	if (var_1_12 <= var_1_33) {
		var_1_47 = ((max (var_1_8 , (var_1_6 - var_1_9))) + var_1_7);
	} else {
		var_1_47 = (abs (var_1_9));
	}


	// From: Req21Batch161Amount500
	var_1_59 = (abs (var_1_6 - var_1_8));


	// From: Req25Batch161Amount500
	var_1_67 = var_1_13;


	// From: Req27Batch161Amount500
	var_1_71 = (abs (var_1_23));


	// From: Req29Batch161Amount500
	unsigned char stepLocal_15 = var_1_28;
	if ((10u / var_1_64) < stepLocal_15) {
		var_1_74 = (abs ((var_1_14 - var_1_64) + (var_1_66 + var_1_34)));
	} else {
		var_1_74 = var_1_49;
	}


	// From: Req34Batch161Amount500
	if (var_1_20) {
		var_1_81 = (max (var_1_66 , var_1_35));
	} else {
		var_1_81 = (max (10 , var_1_15));
	}


	// From: Req37Batch161Amount500
	if (var_1_42) {
		var_1_85 = var_1_67;
	}


	// From: Req40Batch161Amount500
	if (var_1_39) {
		var_1_88 = 10;
	}


	// From: Req42Batch161Amount500
	var_1_90 = var_1_84;


	// From: Req44Batch161Amount500
	var_1_92 = var_1_24;


	// From: Req45Batch161Amount500
	if (var_1_19) {
		var_1_93 = 10.1;
	}


	// From: Req47Batch161Amount500
	var_1_95 = var_1_20;


	// From: Req49Batch161Amount500
	...
	// From: Req7Batch161Amount500
	if (! ((var_1_28 - var_1_29) >= (var_1_85 / var_1_14))) {
		var_1_27 = (max (((min (var_1_8 , 31.6)) - var_1_9) , var_1_4));
	} else {
		var_1_27 = (min ((max (var_1_30 , var_1_8)) , (var_1_4 - var_1_6)));
	}


	// From: Req16Batch161Amount500
	if ((var_1_88 ^ var_1_16) > (var_1_29 * 1)) {
		var_1_50 = (var_1_20 || var_1_52);
	}


	// From: Req19Batch161Amount500
	...
	if (var_1_85 > stepLocal_9) {
		if (var_1_9 > var_1_30) {
			...
			if (var_1_20) {
				var_1_56 = (min (var_1_33 , (min ((abs (8)) , var_1_34))));
			} else {
				var_1_56 = (min ((max ((var_1_34 + 8) , var_1_29)) , var_1_33));
			}
		}
	}


	// From: Req23Batch161Amount500
	unsigned char stepLocal_13 = var_1_50;
	if (stepLocal_13 && var_1_20) {
		var_1_62 = ((min (var_1_31 , (min (var_1_35 , var_1_18)))) + var_1_81);
	} else {
		var_1_62 = (var_1_16 + (var_1_31 + var_1_14));
	}


	// From: Req24Batch161Amount500
	if ((abs (var_1_27)) < var_1_47) {
		var_1_63 = (var_1_35 + 8);
	} else {
		var_1_63 = ((max (0 , var_1_35)) - ((var_1_64 - var_1_65) - var_1_66));
	}


	// From: Req31Batch161Amount500
	signed long int stepLocal_18 = (abs (var_1_65)) - var_1_35;
	signed long int stepLocal_17 = (- var_1_62) ^ (max (var_1_12 , var_1_62));
	if (stepLocal_17 >= 5) {
		if (stepLocal_18 != var_1_12) {
			var_1_76 = (max ((max ((var_1_28 - var_1_29) , var_1_35)) , (last_1_var_1_76 - (var_1_22 + var_1_33))));
		} else {
	...
	// From: Req46Batch161Amount500
	var_1_94 = var_1_62;


	// From: Req48Batch161Amount500
	if (var_1_79) {
		var_1_96 = var_1_80;
	}


	// From: Req9Batch161Amount500
	if (var_1_50 || var_1_95) {
		...
		if (var_1_95 || (var_1_91 > (max (var_1_8 , 63.375)))) {
			var_1_32 = 32;
		} else {
			var_1_32 = 16;
		}
	...
	// From: Req36Batch161Amount500
	unsigned char stepLocal_25 = (min (49.65 , var_1_27)) < 63.4;
	if (stepLocal_25 || var_1_38) {
		var_1_83 = ((max (var_1_69 , (max (var_1_8 , var_1_6)))) + var_1_7);
	} else {
		if (var_1_79) {
			if (var_1_91 < var_1_1) {
				var_1_83 = ((min (var_1_6 , var_1_70)) + var_1_7);
			} else {
				var_1_83 = (max (var_1_4 , var_1_5));
			}
		} else {
			if (var_1_19) {
	...
	if (stepLocal_1 < (var_1_15 / var_1_26)) {
		if (var_1_36) {
			...
			var_1_43 = (max (var_1_14 , var_1_67));
		}
	}


	// From: Req13Batch161Amount500
	signed long int stepLocal_3 = (max (var_1_34 , var_1_29)) - var_1_18;
	...
	// From: Req30Batch161Amount500
	unsigned long int stepLocal_16 = var_1_85;
	if ((128 * var_1_45) <= stepLocal_16) {
		var_1_75 = (var_1_13 - (var_1_65 + (min (var_1_34 , var_1_85))));
	} else {
		if (var_1_19) {
			...
			if ((var_1_8 / var_1_40) == var_1_83) {
				...
				var_1_75 = ((max (16 , var_1_94)) + var_1_18);
			}
		}
	}


	// From: Req26Batch161Amount500
	if (((min (4 , var_1_94)) / var_1_33) >= var_1_43) {
		var_1_68 = var_1_7;
	} else {
		if (var_1_52) {
			var_1_68 = (max (var_1_5 , (min (var_1_4 , var_1_30))));
		} else {
			var_1_68 = (min ((var_1_7 + (var_1_69 + var_1_70)) , var_1_4));
		}
	}


	// From: Req18Batch161Amount500
	unsigned char stepLocal_8 = var_1_68 > (- var_1_5);
	if (var_1_93 <= (abs (var_1_30))) {
		...
		var_1_55 = (min (var_1_33 , 25));
	}


	// From: Req20Batch161Amount500
	signed long int stepLocal_10 = var_1_60;
	if (var_1_49 > stepLocal_10) {
		var_1_58 = (var_1_60 + var_1_18);
	} else {
		if (var_1_4 == var_1_68) {
			if (((var_1_9 + var_1_6) - (max (var_1_40 , var_1_8))) < var_1_5) {
				var_1_58 = (var_1_74 - (min (var_1_13 , var_1_62)));
			} else {
				var_1_58 = (max (var_1_62 , var_1_49));
			}
		} else {
			var_1_58 = (max ((min ((abs (var_1_60)) , var_1_74)) , var_1_29));
		}
	}


	// From: Req32Batch161Amount500
	signed long int stepLocal_20 = var_1_45;
	unsigned char stepLocal_19 = var_1_35;
	if (stepLocal_19 < ((max (var_1_22 , var_1_58)) & (var_1_60 + var_1_49))) {
		if (var_1_29 < stepLocal_20) {
			var_1_77 = (abs (var_1_29));
		} else {
			var_1_77 = (max (((max (var_1_60 , var_1_87)) + var_1_78) , (last_1_var_1_77 + var_1_24)));
		}
	} else {
	...
	if ((var_1_35 + var_1_58) == stepLocal_5) {
		var_1_48 = (max (64 , (var_1_49 - (var_1_35 + 128))));
	} else {
		if ((var_1_95 || var_1_20) && stepLocal_4) {
			if (((var_1_33 - var_1_34) + var_1_58) == stepLocal_6) {
				var_1_48 = ((22297 - var_1_32) + (min (var_1_14 , (max (var_1_34 , var_1_33)))));
			} else {
				var_1_48 = (min (((var_1_29 + 32) + var_1_15) , (max (var_1_28 , var_1_14))));
			}
		} else {
	...
	// From: Req28Batch161Amount500
	unsigned long int stepLocal_14 = (var_1_77 * var_1_85) + var_1_18;
	if (stepLocal_14 > (var_1_22 * (~ var_1_85))) {
		var_1_72 = (max (var_1_65 , (min ((max (var_1_64 , var_1_34)) , var_1_66))));
	} else {
		var_1_72 = (max (var_1_34 , (min (var_1_64 , (var_1_65 - var_1_35)))));
	}


	// From: Req41Batch161Amount500
	if (var_1_19) {
		var_1_89 = var_1_31;
	} else {
		var_1_89 = var_1_72;
	...
	if (var_1_58 != stepLocal_24) {
		if (stepLocal_23 == (var_1_87 * var_1_80)) {
			var_1_82 = (max (((max (var_1_6 , 1.000000000425E9)) - var_1_8) , 99.2));
		} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((var_1_85 >= (var_1_22 / -4)) ? (var_1_1 == ((float) (var_1_4 - (var_1_5 - var_1_6)))) : ((64.075 <= var_1_5) ? (var_1_1 == ((float) (var_1_6 + (min (var_1_7 , (var_1_8 - var_1_9)))))) : ((! var_1_19) ? (var_1_1 == ((float) (max (var_1_4 , var_1_7)))) : 1))) && ((var_1_7 < (var_1_8 * var_1_6)) ? (var_1_11 == ((unsigned short int) (min (0 , (max (var_1_12 , (var_1_13 - 16))))))) : (var_1_11 == ((unsigned short int) (((abs (var_1_14)) - var_1_15) + var_1_16))))) && ((var_1_15 > (var_1_13 ^ (var_1_16 / var_1_14))) ? (var_1_17 == ((unsigned short int) (var_1_13 - 64))) : (((var_1_58 * var_1_89) <= var_1_12) ? (var_1_17 == ((unsigned short int) ((max (var_1_16 , var_1_15)) + (var_1_14 - var_1_18)))) : (var_1_17 == ((unsigned short int) var_1_13))))) && ((var_1_8 >= 25.5f) ? (var_1_19 == ((unsigned char) (! var_1_20))) : 1)) && ((var_1_15 > var_1_13) ? ((var_1_8 <= var_1_6) ? (var_1_21 == ((double) (var_1_8 + var_1_6))) : (var_1_21 == ((double) ((var_1_6 + var_1_8) - (min (256.85 , (var_1_5 - var_1_9))))))) : (var_1_21 == ((double) ((max (var_1_6 , var_1_7)) + (var_1_9 - var_1_8)))))) && ((var_1_13 <= var_1_12) ? ((((var_1_13 * var_1_12) % (max (var_1_23 , var_1_24))) > var_1_60) ? (var_1_22 == ((unsigned long int) (var_1_25 - var_1_12))) : (var_1_22 == ((unsigned long int) (var_1_25 - (max (var_1_16 , var_1_15)))))) : (var_1_22 == ((unsigned long int) ((min ((max (var_1_13 , var_1_14)) , (256u + var_1_15))) + (abs (var_1_26 - var_1_18))))))) && ((! ((var_1_28 - var_1_29) >= (var_1_85 / var_1_14))) ? (var_1_27 == ((double) (max (((min (var_1_8 , 31.6)) - var_1_9) , var_1_4)))) : (var_1_27 == ((double) (min ((max (var_1_30 , var_1_8)) , (var_1_4 - var_1_6))))))) && (var_1_20 ? (var_1_31 == ((signed long int) (var_1_13 - ((max (var_1_29 , var_1_28)) + var_1_18)))) : 1)) && ((var_1_50 || var_1_95) ? (var_1_20 ? (var_1_32 == ((unsigned char) (var_1_33 - (var_1_34 + var_1_35)))) : (var_1_32 == ((unsigned char) (var_1_33 - var_1_34)))) : ((var_1_95 || (var_1_91 > (max (var_1_8 , 63.375)))) ? (var_1_32 == ((unsigned char) 32)) : (var_1_32 == ((unsigned char) 16))))) && ((var_1_38 || (! (var_1_60 > var_1_34))) ? (var_1_36 == ((unsigned char) var_1_20)) : (var_1_38 ? (var_1_36 == ((unsigned char) ((var_1_19 && var_1_20) || (! (! var_1_37))))) : (var_1_36 == ((unsigned char) var_1_20))))) && ((var_1_79 || (! var_1_37)) ? ((var_1_79 && var_1_20) ? (var_1_38 == ((unsigned char) (var_1_37 && var_1_39))) : ((((var_1_40 - var_1_8) - var_1_9) > ((- var_1_47) + (var_1_6 - var_1_5))) ? (var_1_19 ? (var_1_37 ? (((var_1_79 || var_1_20) && var_1_79) ? (var_1_38 == ((unsigned char) (! ((var_1_18 >= var_1_31) && var_1_20)))) : (var_1_38 == ((unsigned char) (var_1_79 && var_1_20)))) : (var_1_38 == ((unsigned char) ((var_1_39 && (var_1_20 || var_1_41)) && var_1_42)))) : (var_1_38 == ((unsigned char) ((var_1_12 > (var_1_13 + var_1_85)) || (var_1_79 || var_1_42))))) : 1)) : 1)) && (((- var_1_94) < (var_1_15 / var_1_26)) ? (var_1_36 ? (var_1_43 == ((signed long int) (((var_1_45 - var_1_67) - var_1_15) - (var_1_22 + var_1_28)))) : (var_1_43 == ((signed long int) (max (var_1_14 , var_1_67))))) : 1)) && ((var_1_36 || var_1_50) ? ((((max (var_1_34 , var_1_29)) - var_1_18) <= var_1_85) ? (var_1_46 == ((unsigned char) var_1_41)) : (var_1_46 == ((unsigned char) (! var_1_41)))) : (var_1_46 == ((unsigned char) (var_1_50 && var_1_20))))) && ((var_1_12 <= var_1_33) ? (var_1_47 == ((double) ((max (var_1_8 , (var_1_6 - var_1_9))) + var_1_7))) : (var_1_47 == ((double) (abs (var_1_9)))))) && (((var_1_35 + var_1_58) == var_1_23) ? (var_1_48 == ((unsigned short int) (max (64 , (var_1_49 - (var_1_35 + 128)))))) : (((var_1_95 || var_1_20) && var_1_95) ? ((((var_1_33 - var_1_34) + var_1_58) == (var_1_35 * (var_1_16 << var_1_45))) ? (var_1_48 == ((unsigned short int) ((22297 - var_1_32) + (min (var_1_14 , (max (var_1_34 , var_1_33))))))) : (var_1_48 == ((unsigned short int) (min (((var_1_29 + 32) + var_1_15) , (max (var_1_28 , var_1_14))))))) : (var_1_48 == ((unsigned short int) ((var_1_14 - (10000 - 8)) + 64)))))) && (((var_1_88 ^ var_1_16) > (var_1_29 * 1)) ? (var_1_50 == ((unsigned char) (var_1_20 || var_1_52))) : 1)) && (((var_1_41 || var_1_36) && var_1_52) ? (var_1_53 == ((signed short int) ((var_1_23 + var_1_33) + var_1_28))) : 1)) && ((var_1_93 <= (abs (var_1_30))) ? ((var_1_38 || (var_1_68 > (- var_1_5))) ? (var_1_55 == ((unsigned char) (var_1_34 + var_1_29))) : (var_1_55 == ((unsigned char) (var_1_33 - var_1_29)))) : (var_1_55 == ((unsigned char) (min (var_1_33 , 25)))))) && ((var_1_85 > var_1_22) ? ((var_1_9 > var_1_30) ? (var_1_56 == ((unsigned char) var_1_29)) : (var_1_20 ? (var_1_56 == ((unsigned char) (min (var_1_33 , (min ((abs (8)) , var_1_34)))))) : (var_1_56 == ((unsigned char) (min ((max ((var_1_34 + 8) , var_1_29)) , var_1_33)))))) : 1)) && ((var_1_49 > var_1_60) ? (var_1_58 == ((signed long int) (var_1_60 + var_1_18))) : ((var_1_4 == var_1_68) ? ((((var_1_9 + var_1_6) - (max (var_1_40 , var_1_8))) < var_1_5) ? (var_1_58 == ((signed long int) (var_1_74 - (min (var_1_13 , var_1_62))))) : (var_1_58 == ((signed long int) (max (var_1_62 , var_1_49))))) : (var_1_58 == ((signed long int) (max ((min ((abs (var_1_60)) , var_1_74)) , var_1_29))))))) && (var_1_59 == ((double) (abs (var_1_6 - var_1_8))))) && ((last_1_var_1_36 && last_1_var_1_50) ? ((var_1_18 >= last_1_var_1_74) ? (var_1_60 == ((signed long int) (abs (max ((last_1_var_1_17 + last_1_var_1_85) , var_1_33))))) : (var_1_60 == ((signed long int) (max (last_1_var_1_31 , (var_1_15 - (abs (var_1_28)))))))) : (var_1_60 == ((signed long int) last_1_var_1_31)))) && ((var_1_50 && var_1_20) ? (var_1_62 == ((signed long int) ((min (var_1_31 , (min (var_1_35 , var_1_18)))) + var_1_81))) : (var_1_62 == ((signed long int) (var_1_16 + (var_1_31 + var_1_14)))))) && (((abs (var_1_27)) < var_1_47) ? (var_1_63 == ((signed char) (var_1_35 + 8))) : (var_1_63 == ((signed char) ((max (0 , var_1_35)) - ((var_1_64 - var_1_65) - var_1_66)))))) && (var_1_67 == ((unsigned short int) var_1_13))) && ((((min (4 , var_1_94)) / var_1_33) >= var_1_43) ? (var_1_68 == ((double) var_1_7)) : (var_1_52 ? (var_1_68 == ((double) (max (var_1_5 , (min (var_1_4 , var_1_30)))))) : (var_1_68 == ((double) (min ((var_1_7 + (var_1_69 + var_1_70)) , var_1_4))))))) && (var_1_71 == ((signed short int) (abs (var_1_23))))) && ((((var_1_77 * var_1_85) + var_1_18) > (var_1_22 * (~ var_1_85))) ? (var_1_72 == ((signed char) (max (var_1_65 , (min ((max (var_1_64 , var_1_34)) , var_1_66)))))) : (var_1_72 == ((signed char) (max (var_1_34 , (min (var_1_64 , (var_1_65 - var_1_35))))))))) && (((10u / var_1_64) < var_1_28) ? (var_1_74 == ((unsigned short int) (abs ((var_1_14 - var_1_64) + (var_1_66 + var_1_34))))) : (var_1_74 == ((unsigned short int) var_1_49)))) && (((128 * var_1_45) <= var_1_85) ? (var_1_75 == ((unsigned short int) (var_1_13 - (var_1_65 + (min (var_1_34 , var_1_85)))))) : (var_1_19 ? (var_1_75 == ((unsigned short int) (var_1_28 + var_1_18))) : (((var_1_8 / var_1_40) == var_1_83) ? (var_1_75 == ((unsigned short int) var_1_18)) : (var_1_75 == ((unsigned short int) ((max (16 , var_1_94)) + var_1_18))))))) && ((((- var_1_62) ^ (max (var_1_12 , var_1_62))) >= 5) ? ((((abs (var_1_65)) - var_1_35) != var_1_12) ? (var_1_76 == ((signed short int) (max ((max ((var_1_28 - var_1_29) , var_1_35)) , (last_1_var_1_76 - (var_1_22 + var_1_33)))))) : (var_1_76 == ((signed short int) (var_1_29 + (last_1_var_1_76 - (var_1_34 + var_1_22)))))) : (var_1_76 == ((signed short int) (var_1_18 - var_1_34))))) && ((var_1_35 < ((max (var_1_22 , var_1_58)) & (var_1_60 + var_1_49))) ? ((var_1_29 < var_1_45) ? (var_1_77 == ((signed long int) (abs (var_1_29)))) : (var_1_77 == ((signed long int) (max (((max (var_1_60 , var_1_87)) + var_1_78) , (last_1_var_1_77 + var_1_24)))))) : (var_1_77 == ((signed long int) (var_1_55 + last_1_var_1_77))))) && (((var_1_26 - var_1_34) > var_1_62) ? (((var_1_81 >> var_1_80) >= var_1_66) ? (var_1_79 == ((unsigned char) (var_1_20 && ((! var_1_41) || var_1_52)))) : (var_1_79 == ((unsigned char) (! (var_1_41 && (var_1_52 || var_1_20)))))) : 1)) && (var_1_20 ? (var_1_81 == ((unsigned short int) (max (var_1_66 , var_1_35)))) : (var_1_81 == ((unsigned short int) (max (10 , var_1_15)))))) && ((var_1_58 != ((var_1_89 - var_1_11) % var_1_64)) ? ((var_1_85 == (var_1_87 * var_1_80)) ? (var_1_82 == ((double) (max (((max (var_1_6 , 1.000000000425E9)) - var_1_8) , 99.2)))) : (var_1_82 == ((double) (var_1_6 - var_1_5)))) : (((- var_1_7) <= (var_1_6 - var_1_5)) ? (var_1_82 == ((double) (var_1_9 - (var_1_6 + var_1_8)))) : (var_1_82 == ((double) (var_1_9 - var_1_5)))))) && ((((min (49.65 , var_1_27)) < 63.4) || var_1_38) ? (var_1_83 == ((double) ((max (var_1_69 , (max (var_1_8 , var_1_6)))) + var_1_7))) : (var_1_79 ? ((var_1_91 < var_1_1) ? (var_1_83 == ((double) ((min (var_1_6 , var_1_70)) + var_1_7))) : (var_1_83 == ((double) (max (var_1_4 , var_1_5))))) : (var_1_19 ? (var_1_83 == ((double) ((var_1_5 - var_1_84) - var_1_6))) : 1)))) && (var_1_42 ? (var_1_85 == ((unsigned long int) var_1_67)) : 1)) && (var_1_38 ? (var_1_86 == ((signed char) -16)) : (var_1_86 == ((signed char) var_1_34)))) && (var_1_38 ? (var_1_87 == ((signed short int) var_1_23)) : (var_1_87 == ((signed short int) var_1_18)))) && (var_1_39 ? (var_1_88 == ((unsigned short int) 10)) : 1)) && (var_1_19 ? (var_1_89 == ((signed short int) var_1_31)) : (var_1_89 == ((signed short int) var_1_72)))) && (var_1_90 == ((float) var_1_84))) && (var_1_79 ? (var_1_91 == ((double) var_1_6)) : (var_1_91 == ((double) var_1_9)))) && (var_1_92 == ((signed short int) var_1_24))) && (var_1_19 ? (var_1_93 == ((double) 10.1)) : 1)) && (var_1_94 == ((signed long int) var_1_62))) && (var_1_95 == ((unsigned char) var_1_20))) && (var_1_79 ? (var_1_96 == ((signed char) var_1_80)) : 1)) && ((var_1_92 <= (var_1_23 / var_1_24)) ? (var_1_97 == ((signed char) (var_1_64 - var_1_98))) : ((var_1_20 && var_1_37) ? (var_1_97 == ((signed char) (var_1_66 + var_1_65))) : (var_1_97 == ((signed char) var_1_34))))
;
}
int main(void) {
	isInitial = 1;
