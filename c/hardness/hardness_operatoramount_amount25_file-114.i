...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch114Amount25.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (2 <= stepLocal_1) {
  var_1_6 = (((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))) + var_1_9);
 } else {
  var_1_6 = var_1_9;
 }
...
int property(void) {
 return (((var_1_2 > var_1_3) ? (var_1_1 == ((signed short int) ((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5))))) : (var_1_1 == ((signed short int) 32))) && ((2 <= (var_1_4 / -128)) ? (var_1_6 == ((float) (((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))) + var_1_9))) : (var_1_6 == ((float) var_1_9)))) && ((((var_1_11 - var_1_12) > (- var_1_9)) && (var_1_1 < var_1_5)) ? (var_1_13 ? ((var_1_14 && var_1_15) ? (((var_1_1 / var_1_16) != var_1_5) ? (var_1_10 == ((signed char) var_1_17)) : (var_1_10 == ((signed char) var_1_18))) : 1) : (var_1_10 == ((signed char) var_1_17))) : 1)
;
}
int main(void) {
 isInitial = 1;
