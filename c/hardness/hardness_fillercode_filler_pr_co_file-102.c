...
void step(void) {
	...
	// From: CodeObject7
	/* 319L, 203L) */ if (/* 320L, 166L, 167L) */ ((/* 321L, 164L, 168L) */ (min (/* 321L, 164L, 168L) */ (var_1_1) , (/* 323L, 163L, 170L) */ (min (/* 323L, 163L, 170L) */ (var_1_11) , (var_1_39))))))) >= (var_1_11))) {
	...
	// From: CodeObject6
	/* 305L, 153L) */ if (/* 306L, 134L, 135L) */ ((var_1_11) >= (/* 308L, 133L, 137L) */ (min (/* 308L, 133L, 137L) */ (/* 309L, 131L, 138L) */ (- (var_1_1))) , (64.1)))))) {
		/* 312L, 152L) */ var_1_44 = (
			/* 315L, 151L) */ ((
				var_1_45
			) - (
