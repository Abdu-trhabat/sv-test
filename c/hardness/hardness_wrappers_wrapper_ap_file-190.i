...
void step(void) {
 ...
 if (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
  if (stepLocal_1 == ((((10) > (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) / (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))))) ? (10) : (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) / (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))))))) {
 ...
 if (! ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) > ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) + 1))) {
  if (8.5f <= (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) {
   (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) = (((((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) > ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))));
  } else {
