...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch61stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_3 <= (max (var_1_3 , var_1_5))) {
		if (var_1_4 < stepLocal_2) {
			if (stepLocal_1 >= (var_1_3 ^ 4u)) {
				var_1_7 = var_1_8;
			}
		} else {
			var_1_7 = var_1_8;
