...
void step(void) {
 ...
 if (float_Array_0[0][2] > double_Array_0[0]) {
  if (! (signed_char_Array_0[1][0] < signed_char_Array_0[0][0])) {
   unsigned_short_int_Array_0[4] = ((((((((8) < ((unsigned_short_int_Array_0[1] - 8))) ? (8) : ((unsigned_short_int_Array_0[1] - 8))))) > (signed_char_Array_0[0][1])) ? (((((8) < ((unsigned_short_int_Array_0[1] - 8))) ? (8) : ((unsigned_short_int_Array_0[1] - 8))))) : (signed_char_Array_0[0][1])));
  }
 } else {
