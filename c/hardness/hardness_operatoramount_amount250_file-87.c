...
void step(void) {
	...
	unsigned long int stepLocal_0 = last_1_var_1_58 / (min (var_1_5 , var_1_6));
	...
	signed long int stepLocal_12 = (min (var_1_56 , var_1_31)) % var_1_5;
	if (var_1_18) {
		if (last_1_var_1_10) {
			if (((var_1_40 >> var_1_60) / var_1_6) >= stepLocal_12) {
				var_1_58 = (var_1_31 + (min ((var_1_25 - var_1_28) , last_1_var_1_1)));
			} else {
			...
			if (var_1_36 >= (- last_1_var_1_45)) {
				if (last_1_var_1_45 <= var_1_37) {
					var_1_58 = (var_1_40 + (max ((1156387542u - var_1_7) , var_1_28)));
				} else {
		...
		var_1_58 = ((var_1_61 - var_1_30) - ((min (var_1_21 , var_1_25)) - (var_1_29 + last_1_var_1_65)));
	}
	...
	if (var_1_31 >= (var_1_19 + (min (var_1_5 , var_1_39)))) {
		var_1_44 = var_1_15;
	}
	...
	if ((abs (var_1_31)) >= ((~ var_1_29) + var_1_58)) {
	...
	if (! var_1_14) {
		if (((min (var_1_47 , var_1_38)) - (var_1_46 + var_1_34)) <= var_1_35) {
	...
	unsigned long int stepLocal_18 = max (var_1_40 , (- var_1_19));
	if (stepLocal_18 <= (max (var_1_58 , var_1_20))) {
	...
	if (var_1_65 >= stepLocal_2) {
		...
		var_1_22 = (min (var_1_21 , (min (var_1_39 , var_1_7))));
	}


	// From: Req16Batch87Amount250
	if (var_1_66 >= 128) {
		var_1_54 = ((min (last_1_var_1_54 , (var_1_56 - var_1_28))) + (max (var_1_58 , var_1_31)));
	} else {
		var_1_54 = var_1_40;
	}
	...
	if (var_1_5 <= stepLocal_11) {
		...
		var_1_57 = (max ((var_1_39 + (var_1_56 + var_1_7)) , var_1_28));
	}
	...
	if ((- var_1_45) <= ((var_1_34 + var_1_35) - var_1_36)) {
		...
		var_1_32 = (min ((31.2 + var_1_37) , (var_1_34 - (9.201079347352285E18 - var_1_38))));
	}
	...
	if (stepLocal_17 || (var_1_42 > var_1_68)) {
		if (stepLocal_16 >= var_1_57) {
			...
			if (stepLocal_15 && ((abs (var_1_61)) > (var_1_43 | var_1_66))) {
	...
	unsigned long int stepLocal_10 = (max (var_1_28 , var_1_27)) / var_1_21;
	...
	if ((var_1_48 - (var_1_46 + var_1_35)) == ((var_1_36 - var_1_34) / var_1_51)) {
		if (stepLocal_9 >= var_1_66) {
			if (stepLocal_10 > (- (var_1_20 - var_1_54))) {
				var_1_50 = (min (var_1_31 , var_1_28));
			} else {
				var_1_50 = var_1_57;
			}
		} else {
...
int property(void) {
	return (((((((((((((((((((((((((last_1_var_1_23 + last_1_var_1_19) == (last_1_var_1_58 / (min (var_1_5 , var_1_6)))) ? (var_1_1 == ((unsigned char) (var_1_7 - var_1_8))) : 1) && (var_1_9 == ((unsigned short int) ((min (var_1_8 , var_1_70)) + var_1_7)))) && (var_1_11 ? ((var_1_12 || var_1_13) ? (var_1_10 == ((unsigned char) var_1_14)) : (var_1_10 == ((unsigned char) ((var_1_14 && (var_1_15 || var_1_16)) || ((! var_1_17) || (! var_1_18)))))) : (var_1_10 == ((unsigned char) (var_1_16 || var_1_15))))) && ((last_1_var_1_10 && var_1_16) ? (var_1_18 ? (var_1_19 == ((unsigned long int) (var_1_20 - (var_1_21 - (last_1_var_1_70 + var_1_8))))) : 1) : 1)) && ((var_1_65 >= 0) ? (var_1_22 == ((unsigned long int) var_1_65)) : (var_1_22 == ((unsigned long int) (min (var_1_21 , (min (var_1_39 , var_1_7)))))))) && ((var_1_7 == var_1_9) ? (((var_1_58 ^ (abs (var_1_8))) <= ((var_1_22 / var_1_7) / -1)) ? (var_1_23 == ((signed long int) (2 - var_1_7))) : ((var_1_16 || ((var_1_7 * 64) <= var_1_54)) ? (var_1_23 == ((signed long int) (var_1_54 - (var_1_25 - 4)))) : (((max ((var_1_7 * var_1_58) , (var_1_6 * var_1_54))) >= (max (var_1_58 , -25))) ? (var_1_23 == ((signed long int) var_1_9)) : (var_1_23 == ((signed long int) var_1_26))))) : (var_1_23 == ((signed long int) var_1_22)))) && (var_1_44 ? (var_1_27 == ((unsigned char) (((32 + var_1_28) + (abs (var_1_29))) - (var_1_30 + (var_1_31 + 25))))) : (var_1_27 == ((unsigned char) (max ((max (var_1_31 , 8)) , var_1_28)))))) && (((- var_1_45) <= ((var_1_34 + var_1_35) - var_1_36)) ? (var_1_32 == ((double) (min (var_1_34 , var_1_35)))) : (var_1_32 == ((double) (min ((31.2 + var_1_37) , (var_1_34 - (9.201079347352285E18 - var_1_38)))))))) && ((var_1_26 < ((last_1_var_1_19 / var_1_7) & last_1_var_1_22)) ? (((128 >> var_1_40) < last_1_var_1_19) ? ((last_1_var_1_45 >= var_1_35) ? (var_1_39 == ((signed long int) (min (var_1_30 , var_1_40)))) : 1) : 1) : 1)) && (var_1_43 == ((signed long int) (var_1_22 + last_1_var_1_43)))) && ((var_1_31 >= (var_1_19 + (min (var_1_5 , var_1_39)))) ? (var_1_44 == ((unsigned char) var_1_15)) : 1)) && (var_1_17 ? (var_1_45 == ((double) var_1_35)) : (var_1_45 == ((double) ((var_1_38 - (var_1_46 + var_1_47)) + (var_1_48 - var_1_49)))))) && (((var_1_48 - (var_1_46 + var_1_35)) == ((var_1_36 - var_1_34) / var_1_51)) ? ((var_1_1 >= var_1_66) ? ((((max (var_1_28 , var_1_27)) / var_1_21) > (- (var_1_20 - var_1_54))) ? (var_1_50 == ((signed short int) (min (var_1_31 , var_1_28)))) : (var_1_50 == ((signed short int) var_1_57))) : (var_1_50 == ((signed short int) var_1_57))) : (var_1_50 == ((signed short int) var_1_30)))) && (((abs (var_1_31)) >= ((~ var_1_29) + var_1_58)) ? (var_1_52 == ((float) (abs (var_1_49)))) : 1)) && ((var_1_58 > var_1_8) ? (var_1_53 == ((unsigned char) (abs (var_1_31)))) : 1)) && ((var_1_66 >= 128) ? (var_1_54 == ((signed long int) ((min (last_1_var_1_54 , (var_1_56 - var_1_28))) + (max (var_1_58 , var_1_31))))) : (var_1_54 == ((signed long int) var_1_40)))) && ((var_1_5 <= (var_1_66 / var_1_6)) ? (var_1_57 == ((unsigned long int) (var_1_20 - var_1_40))) : (var_1_57 == ((unsigned long int) (max ((var_1_39 + (var_1_56 + var_1_7)) , var_1_28)))))) && (var_1_18 ? (last_1_var_1_10 ? ((((var_1_40 >> var_1_60) / var_1_6) >= ((min (var_1_56 , var_1_31)) % var_1_5)) ? (var_1_58 == ((unsigned long int) (var_1_31 + (min ((var_1_25 - var_1_28) , last_1_var_1_1))))) : (var_1_58 == ((unsigned long int) (var_1_28 + var_1_25)))) : ((var_1_36 >= (- last_1_var_1_45)) ? ((last_1_var_1_45 <= var_1_37) ? (var_1_58 == ((unsigned long int) (var_1_40 + (max ((1156387542u - var_1_7) , var_1_28))))) : (var_1_58 == ((unsigned long int) ((var_1_61 - (var_1_7 + var_1_60)) - last_1_var_1_1)))) : 1)) : (var_1_58 == ((unsigned long int) ((var_1_61 - var_1_30) - ((min (var_1_21 , var_1_25)) - (var_1_29 + last_1_var_1_65))))))) && (var_1_62 == ((unsigned char) ((min ((max (var_1_7 , var_1_63)) , var_1_64)) - var_1_60)))) && ((var_1_14 && ((var_1_48 + var_1_46) <= var_1_51)) ? (var_1_65 == ((unsigned char) ((max (var_1_64 , var_1_63)) - (var_1_29 - (50 - var_1_40))))) : (var_1_65 == ((unsigned char) ((var_1_29 - 5) + var_1_31))))) && ((! var_1_14) ? ((((min (var_1_47 , var_1_38)) - (var_1_46 + var_1_34)) <= var_1_35) ? (var_1_66 == ((unsigned long int) (abs (var_1_60)))) : (var_1_66 == ((unsigned long int) (var_1_21 + var_1_40)))) : 1)) && (((var_1_49 >= (var_1_52 / var_1_51)) || (var_1_42 > var_1_68)) ? ((var_1_43 >= var_1_57) ? (var_1_67 == ((signed char) ((var_1_40 - var_1_60) + var_1_31))) : ((var_1_15 && ((abs (var_1_61)) > (var_1_43 | var_1_66))) ? (var_1_67 == ((signed char) (var_1_60 + var_1_40))) : (var_1_67 == ((signed char) (var_1_28 - var_1_31))))) : ((var_1_25 < var_1_39) ? (var_1_67 == ((signed char) var_1_40)) : (var_1_67 == ((signed char) var_1_60))))) && (((max (var_1_40 , (- var_1_19))) <= (max (var_1_58 , var_1_20))) ? (var_1_69 == ((signed char) (var_1_40 + (var_1_28 - var_1_60)))) : (var_1_69 == ((signed char) var_1_28)))) && (var_1_70 == ((unsigned short int) var_1_50))
;
}
int main(void) {
	isInitial = 1;
