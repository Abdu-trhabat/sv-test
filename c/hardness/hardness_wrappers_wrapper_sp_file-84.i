...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch84Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((*(WrapperStruct00_var_1_3_Pointer)) < (*(WrapperStruct00_var_1_8_Pointer))) {
  if (((- 8) / ((*(WrapperStruct00_var_1_13_Pointer)) - (*(WrapperStruct00_var_1_14_Pointer)))) >= (*(WrapperStruct00_var_1_6_Pointer))) {
   (*(WrapperStruct00_var_1_11_Pointer)) = ((*(WrapperStruct00_var_1_1_Pointer)) - ((*(WrapperStruct00_var_1_15_Pointer)) - (*(WrapperStruct00_var_1_14_Pointer))));
  }
 }
