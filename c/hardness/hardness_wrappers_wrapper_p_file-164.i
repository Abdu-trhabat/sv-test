...
void step(void) {
 if ((*(var_1_2_Pointer)) || (*(var_1_3_Pointer))) {
  if (((*(var_1_4_Pointer)) + (*(var_1_5_Pointer))) <= -1) {
   ...
   if ((*(var_1_5_Pointer)) > ((((((*(var_1_4_Pointer))) < ((*(var_1_7_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_7_Pointer))))) * (*(var_1_8_Pointer)))) {
    (*(var_1_1_Pointer)) = ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer)));
   } else {
    (*(var_1_1_Pointer)) = ((((99.5) < ((*(var_1_6_Pointer)))) ? (99.5) : ((*(var_1_6_Pointer)))));
   }
  }
 } else {
  (*(var_1_1_Pointer)) = (*(var_1_6_Pointer));
 ...
 if (((*(var_1_12_Pointer)) - (*(var_1_13_Pointer))) <= stepLocal_0) {
  (*(var_1_11_Pointer)) = ((((5) < ((*(var_1_14_Pointer)))) ? (5) : ((*(var_1_14_Pointer)))));
 }
 if ((*(var_1_2_Pointer))) {
...
int property(void) {
 return ((((*(var_1_2_Pointer)) || (*(var_1_3_Pointer))) ? ((((*(var_1_4_Pointer)) + (*(var_1_5_Pointer))) <= -1) ? ((*(var_1_1_Pointer)) == ((double) (*(var_1_6_Pointer)))) : (((*(var_1_5_Pointer)) > ((((((*(var_1_4_Pointer))) < ((*(var_1_7_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_7_Pointer))))) * (*(var_1_8_Pointer)))) ? ((*(var_1_1_Pointer)) == ((double) ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))))) : ((*(var_1_1_Pointer)) == ((double) ((((99.5) < ((*(var_1_6_Pointer)))) ? (99.5) : ((*(var_1_6_Pointer))))))))) : ((*(var_1_1_Pointer)) == ((double) (*(var_1_6_Pointer))))) && ((((*(var_1_12_Pointer)) - (*(var_1_13_Pointer))) <= (*(var_1_8_Pointer))) ? ((*(var_1_11_Pointer)) == ((unsigned short int) ((((5) < ((*(var_1_14_Pointer)))) ? (5) : ((*(var_1_14_Pointer))))))) : 1)) && ((*(var_1_2_Pointer)) ? ((! (((*(var_1_4_Pointer)) / (*(var_1_16_Pointer))) < (*(var_1_11_Pointer)))) ? ((*(var_1_15_Pointer)) == ((unsigned short int) (10 + (((*(var_1_17_Pointer)) - (*(var_1_18_Pointer))) + (*(var_1_19_Pointer)))))) : 1) : ((*(var_1_15_Pointer)) == ((unsigned short int) (*(var_1_14_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
