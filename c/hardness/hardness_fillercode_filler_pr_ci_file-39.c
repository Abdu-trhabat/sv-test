...
void step(void) {
	...
	// From: CodeObject3
	/* 315L, 128L) */ if (/* 316L, 105L, 106L) */ ((var_1_16) && (/* 318L, 104L, 108L) */ ((/* 319L, 102L, 109L) */ ((var_1_16) && (var_1_6))) || (var_1_16))))) {
		/* 323L, 127L) */ var_1_28 = (
			/* 326L, 126L) */ ((
				var_1_32
			) - (
	...
	// From: CodeObject4
	/* 333L, 167L) */ if (/* 334L, 141L, 142L) */ ((/* 335L, 137L, 143L) */ ((var_1_25) % (/* 337L, 136L, 145L) */ (abs (var_1_14))))) >= (/* 339L, 140L, 147L) */ ((var_1_12) * (var_1_11))))) {
		/* 342L, 166L) */ var_1_35 = (
			/* 345L, 165L) */ (max (
				/* 345L, 165L) */ (
					/* 346L, 163L) */ (abs (
	...
	/* 386L, 276L) */ if (/* 387L, 242L, 243L) */ ((var_1_14) > (var_1_25))) {
		...
		/* 399L, 274L) */ if (/* 400L, 260L, 261L) */ ((-32) < (var_1_5))) {
			/* 403L, 273L) */ var_1_40 = (
				/* 406L, 272L) */ (max (
					/* 406L, 272L) */ (
						/* 407L, 270L) */ (abs (
	...
	// From: CodeObject5
	/* 353L, 232L) */ if (/* 354L, 179L, 180L) */ ((var_1_14) <= (/* 356L, 178L, 182L) */ ((var_1_37) & (var_1_5))))) {
		/* 359L, 230L) */ if (/* 360L, 194L, 195L) */ ((/* 361L, 192L, 196L) */ ((var_1_24) * (var_1_27))) >= (var_1_26))) {
			/* 365L, 224L) */ if (/* 366L, 206L, 207L) */ (! (var_1_21))) {
				/* 368L, 219L) */ var_1_38 = (
					/* 371L, 218L) */ ((
						3151323843u
					) - (
