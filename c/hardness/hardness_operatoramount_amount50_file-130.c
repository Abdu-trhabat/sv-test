...
void step(void) {
	...
	// From: Req2Batch130Amount50
	var_1_10 = (var_1_4 - 256);


	// From: Req5Batch130Amount50
	...
	// From: Req8Batch130Amount50
	var_1_26 = (min ((var_1_21 + 4u) , (var_1_10 + var_1_18)));


	// From: Req9Batch130Amount50
