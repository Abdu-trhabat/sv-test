...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch80Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
   ...
   var_1_32
     ...
     var_1_35
      ...
      var_1_27
                   ...
                   if ( (( ((var_1_33) | (var_1_38))) > (var_1_14))) {
                    if ( ((var_1_24) <= ( ((((var_1_19) < 0 ) ? -(var_1_19) : (var_1_19)))))) {
                     var_1_39 = (
     ...
     var_1_38
                   ...
                   if ( (( ((((( ((var_1_30) * (var_1_32)))) < ((var_1_19))) ? (( ((var_1_30) * (var_1_32)))) : ((var_1_19))))) >= ( (- (var_1_28))))) {
