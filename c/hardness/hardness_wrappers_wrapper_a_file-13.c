...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[1]) {
		unsigned_short_int_Array_0[4] = (max (unsigned_short_int_Array_0[3] , unsigned_short_int_Array_0[2]));
	}
