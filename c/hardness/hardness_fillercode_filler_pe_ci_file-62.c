...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch62Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 293L, 160L) */ if (/* 294L, 119L, 120L) */ ((/* 295L, 117L, 121L) */ ((/* 296L, 115L, 122L) */ ((var_1_34) >> (var_1_35))) % (-10))) >= (var_1_22))) {
		/* 301L, 158L) */ if (/* 302L, 139L, 140L) */ ((/* 303L, 137L, 141L) */ ((var_1_7) - (/* 305L, 136L, 143L) */ (abs (var_1_15))))) != (var_1_7))) {
			/* 308L, 157L) */ var_1_33 = (
				/* 311L, 156L) */ (min (
					/* 311L, 156L) */ (
						var_1_35
	...
	// From: CodeObject9
	/* 338L, 226L) */ if (/* 339L, 209L, 210L) */ ((/* 340L, 207L, 211L) */ ((var_1_7) == (/* 342L, 206L, 213L) */ (abs (var_1_8))))) || (var_1_12))) {
		/* 345L, 225L) */ var_1_43 = (
			var_1_27
		);
	}
