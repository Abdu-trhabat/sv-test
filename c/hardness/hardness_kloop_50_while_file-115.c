...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11550_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch11550_while
	if (var_1_7) {
		var_1_6 = (min (var_1_8 , (var_1_9 - var_1_10)));
	}


	// From: Req7Batch11550_while
	...
	// From: Req5Batch11550_while
	if ((- var_1_9) > var_1_27) {
		var_1_19 = (var_1_20 - var_1_21);
	}


	// From: Req6Batch11550_while
