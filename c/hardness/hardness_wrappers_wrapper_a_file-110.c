...
void step(void) {
	// From: Req1Batch110Wrapper_A
	signed long int stepLocal_0 = (min (signed_long_int_Array_0[0][1] , signed_long_int_Array_0[1][0])) / signed_long_int_Array_0[0][0];
	...
	// From: Req2Batch110Wrapper_A
	if (signed_long_int_Array_0[1][1] <= (signed_long_int_Array_0[0][0] * (max (signed_long_int_Array_0[0][1] , signed_long_int_Array_0[1][0])))) {
		if ((min ((signed_long_int_Array_0[0][0] * signed_long_int_Array_0[0][1]) , (unsigned_long_int_Array_0[1] - unsigned_long_int_Array_0[0]))) > (min (signed_long_int_Array_0[1][1] , signed_long_int_Array_0[1][0]))) {
			double_Array_0[1] = double_Array_0[0];
		}
	}


	// From: Req3Batch110Wrapper_A
	if (BOOL_unsigned_char_Array_0[1][1]) {
		signed_short_int_Array_0[0][1] = ((min (signed_short_int_Array_0[1][1] , signed_short_int_Array_0[0][0])) + signed_short_int_Array_0[1][0]);
	} else {
		signed_short_int_Array_0[0][1] = (signed_short_int_Array_0[0][2] - signed_short_int_Array_0[1][2]);
	}


	// From: Req4Batch110Wrapper_A
	signed long int stepLocal_1 = signed_long_int_Array_0[1][0];
	if (stepLocal_1 <= (unsigned_long_int_Array_0[0] << (max (unsigned_char_Array_0[0] , unsigned_char_Array_0[1])))) {
...
int property(void) {
	return ((((signed_long_int_Array_0[1][1] != ((min (signed_long_int_Array_0[0][1] , signed_long_int_Array_0[1][0])) / signed_long_int_Array_0[0][0])) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) (! BOOL_unsigned_char_Array_0[0][1]))) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) ((BOOL_unsigned_char_Array_0[0][1] && BOOL_unsigned_char_Array_0[1][0]) && BOOL_unsigned_char_Array_0[0][0])))) && ((signed_long_int_Array_0[1][1] <= (signed_long_int_Array_0[0][0] * (max (signed_long_int_Array_0[0][1] , signed_long_int_Array_0[1][0])))) ? (((min ((signed_long_int_Array_0[0][0] * signed_long_int_Array_0[0][1]) , (unsigned_long_int_Array_0[1] - unsigned_long_int_Array_0[0]))) > (min (signed_long_int_Array_0[1][1] , signed_long_int_Array_0[1][0]))) ? (double_Array_0[1] == ((double) double_Array_0[0])) : 1) : 1)) && (BOOL_unsigned_char_Array_0[1][1] ? (signed_short_int_Array_0[0][1] == ((signed short int) ((min (signed_short_int_Array_0[1][1] , signed_short_int_Array_0[0][0])) + signed_short_int_Array_0[1][0]))) : (signed_short_int_Array_0[0][1] == ((signed short int) (signed_short_int_Array_0[0][2] - signed_short_int_Array_0[1][2]))))) && ((signed_long_int_Array_0[1][0] <= (unsigned_long_int_Array_0[0] << (max (unsigned_char_Array_0[0] , unsigned_char_Array_0[1])))) ? (signed_char_Array_0[0] == ((signed char) -64)) : 1)
;
}
int main(void) {
	isInitial = 1;
