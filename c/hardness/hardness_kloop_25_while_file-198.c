...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19825_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch19825_while
	if (var_1_7 > 64.2) {
		var_1_8 = var_1_5;
	}


	// From: Req3Batch19825_while
