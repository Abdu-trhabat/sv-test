...
void step(void) {
	...
	if ((max (((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) , (*(var_1_4_Pointer)))) <= (min (((*(var_1_5_Pointer)) - (*(var_1_6_Pointer))) , ((*(var_1_7_Pointer)) % (*(var_1_8_Pointer)))))) {
		(*(var_1_1_Pointer)) = (min (((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) , (*(var_1_11_Pointer))));
	}
...
int property(void) {
	return (((((((max (((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) , (*(var_1_4_Pointer)))) <= (min (((*(var_1_5_Pointer)) - (*(var_1_6_Pointer))) , ((*(var_1_7_Pointer)) % (*(var_1_8_Pointer)))))) ? ((*(var_1_1_Pointer)) == ((signed short int) (min (((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))) , (*(var_1_11_Pointer)))))) : 1) && (((*(var_1_13_Pointer)) || ((*(var_1_1_Pointer)) <= (*(var_1_11_Pointer)))) ? ((*(var_1_12_Pointer)) == ((signed char) (abs (1 - (*(var_1_14_Pointer)))))) : ((*(var_1_12_Pointer)) == ((signed char) (*(var_1_14_Pointer)))))) && (((*(var_1_10_Pointer)) <= ((*(var_1_2_Pointer)) / (*(var_1_8_Pointer)))) ? ((*(var_1_15_Pointer)) == ((double) (min ((max ((min ((*(var_1_16_Pointer)) , (*(var_1_17_Pointer)))) , (*(var_1_18_Pointer)))) , (max (3.6 , (*(var_1_19_Pointer)))))))) : ((*(var_1_15_Pointer)) == ((double) ((*(var_1_20_Pointer)) - (*(var_1_21_Pointer))))))) && ((*(var_1_22_Pointer)) == ((double) (*(var_1_19_Pointer))))) && ((*(var_1_23_Pointer)) == ((unsigned short int) (*(var_1_10_Pointer))))) && ((*(var_1_24_Pointer)) == ((signed char) (*(var_1_14_Pointer))))
;
}
int main(void) {
	isInitial = 1;
