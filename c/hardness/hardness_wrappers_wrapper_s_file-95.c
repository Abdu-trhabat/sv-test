...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch95Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	WrapperStruct00.var_1_1 = (abs (WrapperStruct00.var_1_2));
	...
	unsigned long int stepLocal_0 = - (3351680781u - WrapperStruct00.var_1_8);
	if (stepLocal_0 > (WrapperStruct00.var_1_1 & WrapperStruct00.var_1_9)) {
	...
	if ((WrapperStruct00.var_1_7 / WrapperStruct00.var_1_14) < (WrapperStruct00.var_1_15 >> WrapperStruct00.var_1_16)) {
		WrapperStruct00.var_1_13 = (abs (4 - WrapperStruct00.var_1_12));
	} else {
		if (WrapperStruct00.var_1_9 >= WrapperStruct00.var_1_1) {
			WrapperStruct00.var_1_13 = (max ((256 - WrapperStruct00.var_1_16) , WrapperStruct00.var_1_7));
		} else {
...
int property(void) {
	return ((((WrapperStruct00.var_1_1 == ((signed long int) (abs (WrapperStruct00.var_1_2)))) && (WrapperStruct00.var_1_3 == ((float) ((WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5) + (min (256.5f , (WrapperStruct00.var_1_6 - 16.125f))))))) && (((- (3351680781u - WrapperStruct00.var_1_8)) > (WrapperStruct00.var_1_1 & WrapperStruct00.var_1_9)) ? (WrapperStruct00.var_1_7 == ((unsigned char) ((min (WrapperStruct00.var_1_10 , (abs (WrapperStruct00.var_1_11)))) + WrapperStruct00.var_1_12))) : 1)) && (((WrapperStruct00.var_1_7 / WrapperStruct00.var_1_14) < (WrapperStruct00.var_1_15 >> WrapperStruct00.var_1_16)) ? (WrapperStruct00.var_1_13 == ((signed short int) (abs (4 - WrapperStruct00.var_1_12)))) : ((WrapperStruct00.var_1_9 >= WrapperStruct00.var_1_1) ? (WrapperStruct00.var_1_13 == ((signed short int) (max ((256 - WrapperStruct00.var_1_16) , WrapperStruct00.var_1_7)))) : (WrapperStruct00.var_1_13 == ((signed short int) WrapperStruct00.var_1_12))))) && (WrapperStruct00.var_1_17 == ((double) WrapperStruct00.var_1_6))
;
}
int main(void) {
	isInitial = 1;
