...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch20Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (BOOL_unsigned_char_Array_0[0] || stepLocal_0) {
  unsigned_long_int_Array_0[1][0] = ((unsigned_long_int_Array_0[1][1] - unsigned_long_int_Array_0[0][0]) - unsigned_long_int_Array_0[0][1]);
 } else {
  unsigned_long_int_Array_0[1][0] = (unsigned_long_int_Array_0[0][1] + ((((unsigned_long_int_Array_0[0][0]) < 0 ) ? -(unsigned_long_int_Array_0[0][0]) : (unsigned_long_int_Array_0[0][0]))));
 }
 unsigned long int stepLocal_2 = unsigned_long_int_Array_0[0][1];
...
void updateVariables(void) {
 ...
 assume_abort_if_not((float_Array_0[3] >= 4611686.018427383000e+12F && float_Array_0[3] <= -1.0e-20F) || (float_Array_0[3] <= 9223372.036854766000e+12F && float_Array_0[3] >= 1.0e-20F ));
...
int property(void) {
 return (((BOOL_unsigned_char_Array_0[1] ? (float_Array_0[4] == ((float) ((float_Array_0[3] - float_Array_0[2]) - float_Array_0[1]))) : (float_Array_0[4] == ((float) (float_Array_0[2] + float_Array_0[0])))) && (double_Array_0[1] == ((double) ((15.5 + float_Array_0[2]) - (float_Array_0[3] - double_Array_0[0]))))) && ((BOOL_unsigned_char_Array_0[0] || BOOL_unsigned_char_Array_0[1]) ? (unsigned_long_int_Array_0[1][0] == ((unsigned long int) ((unsigned_long_int_Array_0[1][1] - unsigned_long_int_Array_0[0][0]) - unsigned_long_int_Array_0[0][1]))) : (unsigned_long_int_Array_0[1][0] == ((unsigned long int) (unsigned_long_int_Array_0[0][1] + ((((unsigned_long_int_Array_0[0][0]) < 0 ) ? -(unsigned_long_int_Array_0[0][0]) : (unsigned_long_int_Array_0[0][0])))))))) && ((5 >= unsigned_long_int_Array_0[1][1]) ? ((float_Array_0[4] >= double_Array_0[0]) ? (unsigned_char_Array_0[1] == ((unsigned char) (128 - 16))) : ((unsigned_long_int_Array_0[0][1] >= ((((unsigned_long_int_Array_0[0][0]) < 0 ) ? -(unsigned_long_int_Array_0[0][0]) : (unsigned_long_int_Array_0[0][0])))) ? (unsigned_char_Array_0[1] == ((unsigned char) (unsigned_char_Array_0[2] - unsigned_char_Array_0[0]))) : (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[0])))) : 1)
;
}
int main(void) {
 isInitial = 1;
