...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch166stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch166stepLocals
	signed long int stepLocal_1 = var_1_3 * var_1_6;
	...
	// From: Req2Batch166stepLocals
	if (var_1_2 != var_1_6) {
		var_1_8 = (var_1_10 - (var_1_11 + var_1_12));
	}


	// From: Req3Batch166stepLocals
	if (var_1_5 || var_1_7) {
		var_1_13 = (var_1_14 + var_1_15);
	} else {
		if (((max (var_1_14 , var_1_15)) * var_1_16) <= var_1_17) {
			if (var_1_9 == var_1_12) {
				var_1_13 = (var_1_18 - (min (var_1_19 , 2.225f)));
			}
		} else {
			var_1_13 = var_1_15;
		}
	...
	// From: Req5Batch166stepLocals
	if (var_1_15 < (- var_1_17)) {
		var_1_21 = (min (var_1_12 , var_1_11));
	} else {
		if (var_1_5) {
			if (var_1_1) {
				var_1_21 = var_1_12;
	...
	// From: Req6Batch166stepLocals
	if (var_1_1) {
		if (10 == (var_1_11 + var_1_3)) {
