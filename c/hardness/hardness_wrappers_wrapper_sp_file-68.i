...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch68Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_1 != (*(WrapperStruct00_var_1_18_Pointer))) {
 ...
 if (((*(WrapperStruct00_var_1_2_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer))) >= (*(WrapperStruct00_var_1_10_Pointer))) {
  if (stepLocal_0 >= ((*(WrapperStruct00_var_1_18_Pointer)) / (*(WrapperStruct00_var_1_8_Pointer)))) {
   (*(WrapperStruct00_var_1_1_Pointer)) = (((((*(WrapperStruct00_var_1_21_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_21_Pointer))) : ((*(WrapperStruct00_var_1_21_Pointer)))));
  }
 } else {
  if ((*(WrapperStruct00_var_1_9_Pointer))) {
   (*(WrapperStruct00_var_1_1_Pointer)) = (((((*(WrapperStruct00_var_1_21_Pointer))) > ((*(WrapperStruct00_var_1_18_Pointer)))) ? ((*(WrapperStruct00_var_1_21_Pointer))) : ((*(WrapperStruct00_var_1_18_Pointer)))));
  }
 }
}
void updateVariables(void) {
