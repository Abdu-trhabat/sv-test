...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch37stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_14) {
  if (var_1_10 <= var_1_9) {
   ...
   if (((((var_1_5) < ((var_1_2 * var_1_1))) ? (var_1_5) : ((var_1_2 * var_1_1)))) == stepLocal_2) {
    var_1_13 = 8.75;
   } else {
...
int property(void) {
 return ((((((((var_1_2 - var_1_3) > var_1_4) ? (var_1_1 == ((signed long int) (((((((((var_1_5 + var_1_3)) < (var_1_2)) ? ((var_1_5 + var_1_3)) : (var_1_2)))) < (var_1_6)) ? ((((((var_1_5 + var_1_3)) < (var_1_2)) ? ((var_1_5 + var_1_3)) : (var_1_2)))) : (var_1_6))))) : (var_1_1 == ((signed long int) 0))) && (((var_1_5 / var_1_8) < (var_1_1 / ((((2) < (var_1_2)) ? (2) : (var_1_2))))) ? ((var_1_1 >= var_1_3) ? (var_1_7 == ((float) 0.75f)) : (var_1_7 == ((float) var_1_9))) : 1)) && (((var_1_6 >= var_1_4) || (var_1_9 > var_1_7)) ? (var_1_10 == ((float) var_1_9)) : 1)) && ((var_1_10 >= var_1_7) ? ((var_1_9 < var_1_10) ? (var_1_11 == ((signed char) var_1_12)) : 1) : 1)) && (var_1_14 ? ((var_1_10 <= var_1_9) ? (var_1_13 == ((double) var_1_9)) : ((((((var_1_5) < ((var_1_2 * var_1_1))) ? (var_1_5) : ((var_1_2 * var_1_1)))) == (var_1_3 + var_1_6)) ? (var_1_13 == ((double) 8.75)) : (var_1_13 == ((double) (16.5 + ((var_1_15 - 49.35) - var_1_16)))))) : 1)) && (var_1_17 == ((unsigned short int) (var_1_18 - var_1_3)))) && ((var_1_13 > ((var_1_20 - var_1_15) - (var_1_21 - var_1_16))) ? (var_1_19 == ((signed char) ((((var_1_12) > (var_1_22)) ? (var_1_12) : (var_1_22))))) : (var_1_19 == ((signed char) var_1_12)))
;
}
int main(void) {
 isInitial = 1;
