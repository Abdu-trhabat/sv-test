...
void step(void) {
	...
	// From: CodeObject4
	/* 373L, 187L) */ if (/* 374L, 162L, 163L) */ ((/* 375L, 160L, 164L) */ ((/* 376L, 158L, 165L) */ ((var_1_23) >= (var_1_4))) || (var_1_29))) || (var_1_10))) {
		/* 381L, 182L) */ var_1_33 = (
			/* 384L, 181L) */ (max (
				/* 384L, 181L) */ (
					var_1_4
	...
	// From: CodeObject8
	/* 452L, 340L) */ if (/* 453L, 327L, 328L) */ ((var_1_4) <= (var_1_19))) {
		/* 456L, 339L) */ var_1_44 = (
			/* 459L, 338L) */ ((
				var_1_29
			) || (
	...
	// From: CodeObject2
	/* 349L, 121L) */ if (/* 350L, 103L, 104L) */ ((/* 351L, 101L, 105L) */ (- (64.25f))) >= (var_1_13))) {
		/* 354L, 119L) */ if (var_1_10) {
			/* 356L, 118L) */ var_1_26 = (
				var_1_29
			);
		}
	...
	// From: CodeObject5
	/* 391L, 211L) */ if (/* 392L, 193L, 194L) */ ((var_1_5) <= (10))) {
		/* 395L, 210L) */ var_1_34 = (
			/* 398L, 209L) */ (max (
				/* 398L, 209L) */ (
					/* 399L, 203L) */ (abs (
	...
	/* 360L, 152L) */ if (var_1_29) {
		/* 362L, 150L) */ if (/* 363L, 133L, 134L) */ ((var_1_5) > (/* 365L, 132L, 136L) */ (min (/* 365L, 132L, 136L) */ (var_1_5) , (/* 367L, 131L, 138L) */ (~ (var_1_1)))))))) {
			/* 369L, 149L) */ var_1_30 = (
				var_1_15
			);
		}
	...
	/* 426L, 321L) */ if (/* 427L, 268L, 269L) */ ((var_1_37) > (var_1_17))) {
		...
		/* 434L, 319L) */ if (/* 435L, 288L, 289L) */ ((var_1_29) || (var_1_10))) {
			/* 438L, 317L) */ if (/* 439L, 299L, 300L) */ ((/* 440L, 297L, 301L) */ ((var_1_17) * (var_1_15))) <= (var_1_37))) {
				/* 444L, 316L) */ var_1_38 = (
					/* 447L, 315L) */ (abs (
						/* 448L, 314L) */ (min (
							/* 448L, 314L) */ (
	...
	// From: CodeObject6
	/* 406L, 262L) */ if (/* 407L, 223L, 224L) */ ((/* 408L, 221L, 225L) */ ((/* 409L, 217L, 226L) */ ((var_1_13) / (var_1_37))) * (/* 412L, 220L, 229L) */ ((var_1_16) * (15.8))))) <= (10.95))) {
		/* 416L, 260L) */ if (/* 417L, 247L, 248L) */ ((var_1_5) >= (var_1_35))) {
			/* 420L, 259L) */ var_1_36 = (
				/* 423L, 258L) */ (max (
					/* 423L, 258L) */ (
						var_1_23
