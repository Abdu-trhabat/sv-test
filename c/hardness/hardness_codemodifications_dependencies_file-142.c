...
void step(void) {
	...
	// From: Req3Batch142dependencies
	if (-128 <= (var_1_10 - (var_1_11 + 50))) {
		var_1_9 = var_1_12;
	}


	// From: Req4Batch142dependencies
	if ((max (var_1_7 , var_1_8)) >= (var_1_11 >> var_1_14)) {
		var_1_13 = var_1_4;
	}


	// From: Req5Batch142dependencies
	var_1_15 = (10u + (var_1_14 + var_1_16));


	// From: Req6Batch142dependencies
	if (-10 > var_1_12) {
	...
	// From: Req8Batch142dependencies
	var_1_22 = var_1_23;


	// From: Req9Batch142dependencies
	var_1_24 = var_1_25;


	// From: Req2Batch142dependencies
	if (var_1_24) {
