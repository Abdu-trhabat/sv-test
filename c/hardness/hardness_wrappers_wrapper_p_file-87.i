...
void step(void) {
 ...
 if (((*(var_1_1_Pointer)) * (*(var_1_3_Pointer))) <= (*(var_1_4_Pointer))) {
  if (((*(var_1_9_Pointer)) - ((((-1) < 0 ) ? -(-1) : (-1)))) <= ((*(var_1_1_Pointer)) * (*(var_1_8_Pointer)))) {
