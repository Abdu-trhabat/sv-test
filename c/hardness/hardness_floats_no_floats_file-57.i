...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch57no_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed long int stepLocal_4 = ((((var_1_13) > (var_1_15)) ? (var_1_13) : (var_1_15))) << ((((var_1_16) > (var_1_17)) ? (var_1_16) : (var_1_17)));
...
int property(void) {
 return (((! (var_1_2 >= var_1_3)) ? (((var_1_4 || var_1_5) && var_1_6) ? (var_1_1 == ((signed long int) ((((var_1_7) < (var_1_8)) ? (var_1_7) : (var_1_8))))) : (var_1_1 == ((signed long int) var_1_8))) : (var_1_1 == ((signed long int) var_1_8))) && ((var_1_5 && var_1_4) ? ((var_1_6 || (var_1_7 == var_1_1)) ? (var_1_9 == ((signed char) ((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11))))) : 1) : (var_1_9 == ((signed char) (var_1_12 - var_1_13))))) && ((var_1_12 < (((((var_1_13) > (var_1_15)) ? (var_1_13) : (var_1_15))) << ((((var_1_16) > (var_1_17)) ? (var_1_16) : (var_1_17))))) ? (var_1_14 == ((signed char) (var_1_17 - 64))) : (((var_1_18 - var_1_16) == var_1_1) ? (var_1_14 == ((signed char) var_1_16)) : (var_1_14 == ((signed char) var_1_11))))
;
}
int main(void) {
 isInitial = 1;
