...
void step(void) {
	...
	if (128 <= var_1_7) {
		if (var_1_11) {
			var_1_13 = (var_1_14 + (min ((max (3.4f , var_1_15)) , var_1_16)));
		} else {
			if (var_1_1 < var_1_16) {
				var_1_13 = var_1_6;
			} else {
	...
	// From: Req8Batch8normal
	var_1_25 = var_1_21;


	// From: Req9Batch8normal
	var_1_26 = var_1_8;
}
...
int property(void) {
	return (((((((((var_1_2 == (var_1_3 % var_1_4)) ? (var_1_1 == ((float) (var_1_5 - var_1_6))) : 1) && ((var_1_1 >= var_1_6) ? (var_1_7 == ((signed long int) var_1_8)) : 1)) && ((((var_1_6 * var_1_5) / var_1_10) > var_1_1) ? (var_1_11 ? (var_1_9 == ((unsigned long int) var_1_12)) : (var_1_9 == ((unsigned long int) 0u))) : 1)) && ((128 <= var_1_7) ? (var_1_11 ? (var_1_13 == ((float) (var_1_14 + (min ((max (3.4f , var_1_15)) , var_1_16))))) : ((var_1_1 < var_1_16) ? (var_1_13 == ((float) var_1_6)) : (var_1_13 == ((float) var_1_15)))) : (var_1_13 == ((float) var_1_5)))) && (((var_1_4 * var_1_18) < var_1_12) ? (var_1_17 == ((signed short int) ((var_1_19 - (var_1_20 + var_1_21)) + var_1_22))) : ((var_1_20 >= 32) ? (var_1_11 ? (var_1_17 == ((signed short int) 100)) : (var_1_17 == ((signed short int) var_1_20))) : 1))) && ((var_1_19 < var_1_7) ? ((var_1_9 >= var_1_18) ? ((var_1_6 < var_1_15) ? (var_1_23 == ((signed long int) var_1_21)) : 1) : 1) : (var_1_23 == ((signed long int) var_1_17)))) && (var_1_24 == ((unsigned char) 2))) && (var_1_25 == ((unsigned long int) var_1_21))) && (var_1_26 == ((signed long int) var_1_8))
;
}
int main(void) {
	isInitial = 1;
