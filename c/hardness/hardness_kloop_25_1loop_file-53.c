...
int property(void) {
	return (((((var_1_1 == ((unsigned long int) (var_1_2 + (var_1_3 - (var_1_4 - var_1_5))))) && (var_1_6 == ((unsigned char) var_1_7))) && (((min (var_1_1 , var_1_5)) != (min (var_1_4 , var_1_3))) ? ((var_1_9 == var_1_10) ? (var_1_6 ? (var_1_8 == ((unsigned char) var_1_11)) : 1) : 1) : (var_1_8 == ((unsigned char) var_1_11)))) && (var_1_12 == ((float) ((2.55f + var_1_13) - var_1_14)))) && (var_1_15 == ((double) (max (var_1_13 , (min (var_1_14 , var_1_16))))))) && ((var_1_2 >= var_1_1) ? (var_1_17 == ((float) (var_1_14 - (max (var_1_13 , var_1_18))))) : 1)
;
}
int main(void) {
	isInitial = 1;
