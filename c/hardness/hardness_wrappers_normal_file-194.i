...
void step(void) {
 ...
 signed long int stepLocal_1 = var_1_5 / ((((var_1_7) < (var_1_11)) ? (var_1_7) : (var_1_11)));
 ...
 if (var_1_2) {
  if (var_1_7 > (var_1_8 | ((((var_1_11) > (var_1_3)) ? (var_1_11) : (var_1_3))))) {
   if ((var_1_13 - var_1_14) < (var_1_8 / ((((var_1_7) > (var_1_11)) ? (var_1_7) : (var_1_11))))) {
    var_1_12 = var_1_8;
   } else {
    var_1_12 = 8;
   }
...
int property(void) {
 return ((var_1_2 ? (((var_1_3 == var_1_4) && ((var_1_9 % var_1_7) >= var_1_9)) ? (var_1_1 == ((signed char) ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8))))) : 1) : (var_1_1 == ((signed char) var_1_8))) && ((var_1_2 && var_1_10) ? (var_1_9 == ((signed long int) var_1_6)) : (var_1_10 ? ((var_1_6 >= (var_1_5 / ((((var_1_7) < (var_1_11)) ? (var_1_7) : (var_1_11))))) ? (var_1_9 == ((signed long int) var_1_8)) : 1) : 1))) && (var_1_2 ? ((var_1_7 > (var_1_8 | ((((var_1_11) > (var_1_3)) ? (var_1_11) : (var_1_3))))) ? (((var_1_13 - var_1_14) < (var_1_8 / ((((var_1_7) > (var_1_11)) ? (var_1_7) : (var_1_11))))) ? (var_1_12 == ((signed char) var_1_8)) : (var_1_12 == ((signed char) 8))) : (var_1_12 == ((signed char) var_1_8))) : 1)
;
}
int main(void) {
 isInitial = 1;
