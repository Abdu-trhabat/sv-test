...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch26no_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_2 > (((((var_1_3 / -5)) < (var_1_4)) ? ((var_1_3 / -5)) : (var_1_4)))) {
...
int property(void) {
 return ((((var_1_2 > (((((var_1_3 / -5)) < (var_1_4)) ? ((var_1_3 / -5)) : (var_1_4)))) ? ((var_1_5 || (var_1_3 <= var_1_2)) ? (var_1_1 == ((signed short int) (((var_1_6 + var_1_7) - 10) - (var_1_8 + var_1_9)))) : (var_1_1 == ((signed short int) (var_1_9 - var_1_8)))) : (var_1_1 == ((signed short int) var_1_6))) && ((var_1_7 >= (var_1_9 % -5)) ? ((var_1_2 >= var_1_3) ? (var_1_10 == ((signed long int) last_1_var_1_10)) : 1) : 1)) && ((var_1_5 && (var_1_2 == (var_1_4 * var_1_3))) ? (var_1_11 == ((unsigned short int) ((((var_1_7) > (var_1_9)) ? (var_1_7) : (var_1_9))))) : (var_1_11 == ((unsigned short int) (var_1_12 - var_1_8))))) && (var_1_13 == ((signed long int) var_1_14))
;
}
int main(void) {
 isInitial = 1;
