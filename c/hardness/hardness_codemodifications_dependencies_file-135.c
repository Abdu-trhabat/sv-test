...
void step(void) {
	...
	// From: Req1Batch135dependencies
	if (var_1_2 > ((var_1_3 * var_1_4) * var_1_5)) {
		var_1_1 = (abs (var_1_6));
	}


	// From: Req3Batch135dependencies
