...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch85Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	/* 387L, 188L) */ if (/* 388L, 149L, 150L) */ ((/* 389L, 145L, 151L) */ (min (/* 389L, 145L, 151L) */ (/* 390L, 143L, 152L) */ ((var_1_32) - (var_1_33))) , (var_1_11)))) > (/* 394L, 148L, 156L) */ ((var_1_19) * (31.3))))) {
		/* 397L, 175L) */ if (var_1_17) {
			/* 399L, 174L) */ var_1_31 = (
				var_1_35
			);
		}
	...
	// From: CodeObject5
	/* 414L, 217L) */ if (/* 415L, 197L, 198L) */ ((/* 416L, 194L, 199L) */ ((var_1_18) / (25.4f))) >= (/* 419L, 196L, 202L) */ (abs (var_1_19))))) {
		/* 421L, 216L) */ var_1_37 = (
			/* 424L, 215L) */ (! (
				/* 425L, 214L) */ ((
					var_1_36
	...
	/* 428L, 315L) */ if (/* 429L, 222L, 223L) */ (! (var_1_5))) {
		/* 431L, 313L) */ if (/* 432L, 235L, 236L) */ ((/* 433L, 230L, 237L) */ ((var_1_12) + (var_1_9))) >= (/* 436L, 234L, 240L) */ ((/* 437L, 232L, 241L) */ (abs (var_1_24))) << (var_1_25))))) {
