...
void step(void) {
	...
	// From: Req2Batch136no_floats
	if ((var_1_8 * (min (var_1_9 , var_1_10))) > var_1_11) {
		var_1_7 = ((max ((max (16 , var_1_12)) , var_1_13)) - (min (var_1_14 , var_1_15)));
	}


	// From: Req3Batch136no_floats
	if (128 >= (max (var_1_15 , (var_1_12 / var_1_17)))) {
		if (var_1_8 != var_1_14) {
...
int property(void) {
	return (((var_1_2 ? (var_1_3 ? (var_1_1 == ((unsigned long int) (var_1_4 + var_1_5))) : (var_1_1 == ((unsigned long int) ((min (var_1_6 , 3757035609u)) - var_1_4)))) : (var_1_1 == ((unsigned long int) var_1_4))) && (((var_1_8 * (min (var_1_9 , var_1_10))) > var_1_11) ? (var_1_7 == ((signed long int) ((max ((max (16 , var_1_12)) , var_1_13)) - (min (var_1_14 , var_1_15))))) : 1)) && ((128 >= (max (var_1_15 , (var_1_12 / var_1_17)))) ? ((var_1_8 != var_1_14) ? (var_1_16 == ((signed long int) (max (var_1_14 , var_1_12)))) : 1) : 1)) && ((var_1_17 < var_1_11) ? (var_1_18 == ((signed short int) (max (4 , (4 - var_1_19))))) : 1)
;
}
int main(void) {
	isInitial = 1;
