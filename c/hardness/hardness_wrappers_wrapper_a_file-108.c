...
void step(void) {
	// From: Req2Batch108Wrapper_A
	if ((signed_long_int_Array_0[2] * signed_long_int_Array_0[0]) != (signed_char_Array_0[0] & signed_long_int_Array_0[1])) {
		unsigned_char_Array_0[0][0] = (max (unsigned_char_Array_0[0][1] , unsigned_char_Array_0[1][1]));
	} else {
		unsigned_char_Array_0[0][0] = (100 + unsigned_char_Array_0[1][0]);
	}


	// From: Req3Batch108Wrapper_A
	if (BOOL_unsigned_char_Array_0[0]) {
		float_Array_0[0][0][1] = (max ((max (float_Array_0[1][0][1] , float_Array_0[1][0][0])) , float_Array_0[1][1][0]));
	}


	// From: Req1Batch108Wrapper_A
	...
	if (stepLocal_1 || BOOL_unsigned_char_Array_0[0]) {
		if (unsigned_char_Array_0[0][0] > stepLocal_0) {
			if (! (signed_long_int_Array_0[2] > unsigned_char_Array_0[0][0])) {
				float_Array_0[1][1][1] = ((max (float_Array_0[0][1][1] , (float_Array_0[1][0][1] - float_Array_0[1][1][0]))) + ((float_Array_0[0][1][0] + float_Array_0[0][0][0]) + float_Array_0[1][0][0]));
			} else {
...
int property(void) {
	return (((((unsigned_char_Array_0[0][0] * -2) != signed_long_int_Array_0[2]) || BOOL_unsigned_char_Array_0[0]) ? ((unsigned_char_Array_0[0][0] > signed_long_int_Array_0[2]) ? ((! (signed_long_int_Array_0[2] > unsigned_char_Array_0[0][0])) ? (float_Array_0[1][1][1] == ((float) ((max (float_Array_0[0][1][1] , (float_Array_0[1][0][1] - float_Array_0[1][1][0]))) + ((float_Array_0[0][1][0] + float_Array_0[0][0][0]) + float_Array_0[1][0][0])))) : (float_Array_0[1][1][1] == ((float) float_Array_0[1][1][0]))) : (float_Array_0[1][1][1] == ((float) float_Array_0[0][0][0]))) : (float_Array_0[1][1][1] == ((float) float_Array_0[0][1][0]))) && (((signed_long_int_Array_0[2] * signed_long_int_Array_0[0]) != (signed_char_Array_0[0] & signed_long_int_Array_0[1])) ? (unsigned_char_Array_0[0][0] == ((unsigned char) (max (unsigned_char_Array_0[0][1] , unsigned_char_Array_0[1][1])))) : (unsigned_char_Array_0[0][0] == ((unsigned char) (100 + unsigned_char_Array_0[1][0]))))) && (BOOL_unsigned_char_Array_0[0] ? (float_Array_0[0][0][1] == ((float) (max ((max (float_Array_0[1][0][1] , float_Array_0[1][0][0])) , float_Array_0[1][1][0])))) : 1)
;
}
int main(void) {
	isInitial = 1;
