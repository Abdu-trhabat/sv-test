...
void step(void) {
	...
	if (stepLocal_3 || (! WrapperStruct00.var_1_17)) {
		if (stepLocal_4 < WrapperStruct00.var_1_7) {
			WrapperStruct00.var_1_15 = (min (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_4));
		} else {
	...
	if (WrapperStruct00.var_1_7 <= stepLocal_2) {
		if (WrapperStruct00.var_1_3 >= stepLocal_1) {
			WrapperStruct00.var_1_9 = (WrapperStruct00.var_1_12 + (abs (min (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_14))));
		}
	} else {
...
int property(void) {
	return ((((8 >= (WrapperStruct00.var_1_2 + WrapperStruct00.var_1_3)) ? (WrapperStruct00.var_1_1 == ((signed short int) (min (WrapperStruct00.var_1_4 , (WrapperStruct00.var_1_5 + 10))))) : 1) && ((WrapperStruct00.var_1_3 <= WrapperStruct00.var_1_2) ? (WrapperStruct00.var_1_6 == ((unsigned short int) (WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8))) : 1)) && ((WrapperStruct00.var_1_7 <= (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_15)) ? ((WrapperStruct00.var_1_3 >= WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_9 == ((double) (WrapperStruct00.var_1_12 + (abs (min (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_14)))))) : 1) : (WrapperStruct00.var_1_9 == ((double) (WrapperStruct00.var_1_14 + WrapperStruct00.var_1_12))))) && (((WrapperStruct00.var_1_11 || WrapperStruct00.var_1_16) || (! WrapperStruct00.var_1_17)) ? ((WrapperStruct00.var_1_6 < WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_15 == ((signed short int) (min (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_4)))) : (WrapperStruct00.var_1_17 ? (WrapperStruct00.var_1_15 == ((signed short int) WrapperStruct00.var_1_5)) : 1)) : (WrapperStruct00.var_1_15 == ((signed short int) WrapperStruct00.var_1_5)))
;
}
int main(void) {
	isInitial = 1;
