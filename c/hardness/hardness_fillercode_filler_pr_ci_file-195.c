...
void step(void) {
	...
	// From: CodeObject6
	/* 412L, 271L) */ if (/* 413L, 200L, 201L) */ ((var_1_42) <= (/* 415L, 199L, 203L) */ (abs (/* 416L, 198L, 204L) */ (abs (var_1_14))))))) {
		/* 418L, 265L) */ if (/* 419L, 214L, 215L) */ ((/* 420L, 212L, 216L) */ (abs (var_1_8))) >= (var_1_9))) {
			/* 423L, 226L) */ var_1_47 = (
				var_1_17
			);
		} else {
	...
	// From: CodeObject2
	/* 379L, 167L) */ if (/* 380L, 145L, 146L) */ ((/* 381L, 143L, 147L) */ (abs (var_1_9))) <= (var_1_8))) {
		/* 384L, 159L) */ var_1_36 = (
			/* 387L, 158L) */ (max (
				/* 387L, 158L) */ (
					var_1_39
