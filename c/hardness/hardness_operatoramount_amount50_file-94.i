...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch94Amount50.c", 13, "reach_error"); }
...
void step(void) {
 if (var_1_8 || last_1_var_1_1) {
  if ((var_1_2 >= last_1_var_1_20) && last_1_var_1_1) {
   var_1_9 = ((((var_1_3) < (last_1_var_1_20)) ? (var_1_3) : (last_1_var_1_20)));
  } else {
   if (last_1_var_1_1) {
    var_1_9 = var_1_5;
   } else {
 ...
 var_1_10 = (((((var_1_11) < (var_1_12)) ? (var_1_11) : (var_1_12))) + (var_1_13 + (var_1_14 - var_1_15)));
 if (var_1_14 >= var_1_11) {
  var_1_16 = ((((((((((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) > (var_1_2)) ? (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) : (var_1_2)))) > (var_1_17)) ? (((((((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) > (var_1_2)) ? (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) : (var_1_2)))) : (var_1_17)));
 }
 if ((((((var_1_2) > (var_1_3)) ? (var_1_2) : (var_1_3))) - var_1_19) >= var_1_9) {
  var_1_18 = ((((var_1_3) > (var_1_19)) ? (var_1_3) : (var_1_19)));
 }
...
int property(void) {
 return ((((((((10 << var_1_2) < var_1_3) ? (((var_1_16 / var_1_5) > (-1000000000 + var_1_2)) ? (var_1_1 == ((unsigned char) (var_1_6 || var_1_7))) : (var_1_1 == ((unsigned char) var_1_8))) : 1) && ((var_1_8 || last_1_var_1_1) ? (((var_1_2 >= last_1_var_1_20) && last_1_var_1_1) ? (var_1_9 == ((signed long int) ((((var_1_3) < (last_1_var_1_20)) ? (var_1_3) : (last_1_var_1_20))))) : (last_1_var_1_1 ? (var_1_9 == ((signed long int) var_1_5)) : (var_1_9 == ((signed long int) var_1_2)))) : (var_1_9 == ((signed long int) last_1_var_1_20)))) && (var_1_10 == ((double) (((((var_1_11) < (var_1_12)) ? (var_1_11) : (var_1_12))) + (var_1_13 + (var_1_14 - var_1_15)))))) && ((var_1_14 >= var_1_11) ? (var_1_16 == ((unsigned short int) ((((((((((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) > (var_1_2)) ? (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) : (var_1_2)))) > (var_1_17)) ? (((((((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) > (var_1_2)) ? (((((var_1_3) < 0 ) ? -(var_1_3) : (var_1_3)))) : (var_1_2)))) : (var_1_17))))) : 1)) && (((((((var_1_2) > (var_1_3)) ? (var_1_2) : (var_1_3))) - var_1_19) >= var_1_9) ? (var_1_18 == ((unsigned long int) ((((var_1_3) > (var_1_19)) ? (var_1_3) : (var_1_19))))) : 1)) && ((var_1_7 || (var_1_21 <= (- var_1_12))) ? (var_1_20 == ((signed long int) (var_1_17 + var_1_9))) : 1)) && (((var_1_15 + (4.6f * var_1_11)) == var_1_14) ? (var_1_21 == ((double) (var_1_13 + var_1_15))) : (var_1_21 == ((double) var_1_14)))
;
}
int main(void) {
 isInitial = 1;
