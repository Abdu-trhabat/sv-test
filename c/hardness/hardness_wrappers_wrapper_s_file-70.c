...
void step(void) {
	...
	if (WrapperStruct00.var_1_2) {
		WrapperStruct00.var_1_1 = ((17222 - WrapperStruct00.var_1_3) + ((min (29916 , WrapperStruct00.var_1_4)) - WrapperStruct00.var_1_5));
	}
	...
	signed long int stepLocal_0 = max (WrapperStruct00.var_1_3 , (WrapperStruct00.var_1_5 << WrapperStruct00.var_1_1));
	if (WrapperStruct00.var_1_4 <= stepLocal_0) {
		WrapperStruct00.var_1_7 = (min ((WrapperStruct00.var_1_5 - WrapperStruct00.var_1_3) , WrapperStruct00.var_1_4));
	} else {
