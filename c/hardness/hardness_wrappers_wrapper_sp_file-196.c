...
void step(void) {
	// From: Req1Batch196Wrapper_SP
	if ((*(WrapperStruct00_var_1_2_Pointer))) {
		(*(WrapperStruct00_var_1_1_Pointer)) = (max ((*(WrapperStruct00_var_1_3_Pointer)) , 100));
	} else {
		(*(WrapperStruct00_var_1_1_Pointer)) = (((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer)))) - 32) + 10);
	}


	// From: Req2Batch196Wrapper_SP
	...
	if ((*(WrapperStruct00_var_1_1_Pointer)) <= stepLocal_1) {
		if (stepLocal_0 >= (*(WrapperStruct00_var_1_3_Pointer))) {
			(*(WrapperStruct00_var_1_6_Pointer)) = (min ((min (((*(WrapperStruct00_var_1_7_Pointer)) - (*(WrapperStruct00_var_1_5_Pointer))) , (*(WrapperStruct00_var_1_4_Pointer)))) , (min ((*(WrapperStruct00_var_1_3_Pointer)) , (*(WrapperStruct00_var_1_8_Pointer))))));
		}
	} else {
	...
	// From: Req3Batch196Wrapper_SP
	if ((*(WrapperStruct00_var_1_8_Pointer)) <= (abs ((*(WrapperStruct00_var_1_6_Pointer))))) {
		(*(WrapperStruct00_var_1_9_Pointer)) = (10 - (*(WrapperStruct00_var_1_10_Pointer)));
	} else {
		if (! (*(WrapperStruct00_var_1_2_Pointer))) {
			(*(WrapperStruct00_var_1_9_Pointer)) = ((*(WrapperStruct00_var_1_11_Pointer)) + (min ((*(WrapperStruct00_var_1_12_Pointer)) , (*(WrapperStruct00_var_1_13_Pointer)))));
		} else {
			if ((*(WrapperStruct00_var_1_2_Pointer))) {
...
int property(void) {
	return (((*(WrapperStruct00_var_1_2_Pointer)) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned short int) (max ((*(WrapperStruct00_var_1_3_Pointer)) , 100)))) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned short int) (((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer)))) - 32) + 10)))) && (((*(WrapperStruct00_var_1_1_Pointer)) <= (*(WrapperStruct00_var_1_3_Pointer))) ? (((*(WrapperStruct00_var_1_1_Pointer)) >= (*(WrapperStruct00_var_1_3_Pointer))) ? ((*(WrapperStruct00_var_1_6_Pointer)) == ((unsigned short int) (min ((min (((*(WrapperStruct00_var_1_7_Pointer)) - (*(WrapperStruct00_var_1_5_Pointer))) , (*(WrapperStruct00_var_1_4_Pointer)))) , (min ((*(WrapperStruct00_var_1_3_Pointer)) , (*(WrapperStruct00_var_1_8_Pointer)))))))) : 1) : ((*(WrapperStruct00_var_1_6_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_3_Pointer)))))) && (((*(WrapperStruct00_var_1_8_Pointer)) <= (abs ((*(WrapperStruct00_var_1_6_Pointer))))) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed char) (10 - (*(WrapperStruct00_var_1_10_Pointer))))) : ((! (*(WrapperStruct00_var_1_2_Pointer))) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed char) ((*(WrapperStruct00_var_1_11_Pointer)) + (min ((*(WrapperStruct00_var_1_12_Pointer)) , (*(WrapperStruct00_var_1_13_Pointer))))))) : ((*(WrapperStruct00_var_1_2_Pointer)) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed char) 64)) : ((*(WrapperStruct00_var_1_9_Pointer)) == ((signed char) (*(WrapperStruct00_var_1_11_Pointer)))))))
;
}
int main(void) {
	isInitial = 1;
