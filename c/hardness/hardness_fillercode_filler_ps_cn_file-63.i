...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch63Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
    ...
    var_1_39
             ...
             if ( ((var_1_39) >= ( ((((var_1_35) < 0 ) ? -(var_1_35) : (var_1_35)))))) {
