...
void step(void) {
	...
	if (stepLocal_3 > (var_1_32 >> var_1_37)) {
		if (var_1_11 > var_1_8) {
			var_1_35 = (max (var_1_5 , 1u));
		}
	} else {
		var_1_35 = (var_1_15 + (min (last_1_var_1_58 , var_1_3)));
	}
	...
	var_1_22 = (max (last_1_var_1_22 , var_1_4));


	// From: Req15Batch34Amount250
	if ((abs (var_1_20)) < var_1_35) {
		if (var_1_49) {
			var_1_40 = (min (var_1_5 , (var_1_31 + (var_1_37 + var_1_3))));
		} else {
			var_1_40 = ((max ((var_1_32 + var_1_37) , (var_1_33 + 32u))) + var_1_20);
		}
	}
	...
	if (var_1_47 || var_1_43) {
		var_1_46 = (max ((min (var_1_5 , var_1_27)) , (max (var_1_26 , var_1_33))));
	} else {
		if (((min (10 , var_1_32)) << var_1_40) != (var_1_48 - var_1_5)) {
	...
	if ((var_1_20 * (max (10 , var_1_3))) >= var_1_20) {
		var_1_53 = (abs (var_1_32 - var_1_3));
	}
	...
	if (var_1_11 <= (- var_1_12)) {
		if (var_1_49) {
			var_1_38 = (abs (max ((4 + var_1_39) , var_1_14)));
		}
	}
	...
	if (var_1_49 && stepLocal_12) {
		if (stepLocal_11 <= var_1_15) {
			...
			var_1_60 = (((max (var_1_20 , var_1_3)) + var_1_20) + 50u);
		}
	} else {
		var_1_60 = (max ((var_1_62 - (var_1_36 + var_1_20)) , var_1_32));
	}
	...
	if (((var_1_34 >> var_1_37) >= (var_1_31 / var_1_36)) || stepLocal_6) {
		if (stepLocal_7 >= var_1_15) {
			...
			if (stepLocal_5 > (var_1_4 >> 1)) {
				var_1_41 = (min ((var_1_42 - (var_1_34 + var_1_4)) , (var_1_38 + (max (var_1_31 , var_1_32)))));
			} else {
				var_1_41 = (max (var_1_42 , var_1_37));
			}
		}
	} else {
	...
	if (var_1_23 > var_1_21) {
		if ((1 * (var_1_22 & var_1_15)) > (var_1_60 + (var_1_3 + var_1_60))) {
			if (var_1_15 > (max (var_1_5 , var_1_60))) {
				var_1_25 = (var_1_4 - var_1_5);
			} else {
				var_1_25 = ((var_1_5 - (var_1_4 + var_1_3)) + (min (var_1_26 , var_1_27)));
			}
		} else {
	...
	if ((var_1_7 / var_1_10) != (min (var_1_11 , var_1_21))) {
		var_1_28 = (var_1_27 + (max (var_1_4 , var_1_14)));
	}
...
int property(void) {
	return ((((((((((((((((((((((((var_1_16 ? ((((var_1_3 - var_1_4) - var_1_5) <= var_1_54) ? (var_1_1 == ((unsigned short int) var_1_3)) : 1) : 1) && ((var_1_4 >= var_1_44) ? (var_1_7 == ((double) (abs (var_1_8)))) : 1)) && (var_1_16 ? ((var_1_20 >= var_1_5) ? (var_1_9 == ((double) (min (((var_1_10 - var_1_11) - var_1_12) , var_1_8)))) : 1) : (((min ((var_1_5 + 4) , (var_1_20 - var_1_4))) == var_1_3) ? (var_1_9 == ((double) var_1_12)) : (var_1_9 == ((double) (var_1_11 + (max (var_1_13 , 9.99999999999998E13)))))))) && ((var_1_13 >= var_1_10) ? (var_1_14 == ((unsigned short int) ((max (8 , var_1_4)) + (var_1_15 - var_1_3)))) : (var_1_14 == ((unsigned short int) var_1_5)))) && ((var_1_60 < ((var_1_4 % var_1_15) * var_1_5)) ? (((! var_1_49) && last_1_var_1_16) ? (var_1_16 == ((unsigned char) (! var_1_18))) : (var_1_16 == ((unsigned char) var_1_19))) : (var_1_16 == ((unsigned char) var_1_18)))) && (var_1_19 ? (var_1_20 == ((unsigned long int) var_1_3)) : (var_1_20 == ((unsigned long int) var_1_4)))) && ((var_1_19 && (var_1_9 <= (9.999999995E8 * var_1_11))) ? (var_1_21 == ((double) (max (var_1_13 , var_1_12)))) : (var_1_21 == ((double) (abs (var_1_11)))))) && (var_1_22 == ((unsigned long int) (max (last_1_var_1_22 , var_1_4))))) && (((abs (100 + var_1_3)) <= (min (var_1_4 , var_1_5))) ? (((max (var_1_40 , 25)) < var_1_20) ? (var_1_23 == ((float) ((min (var_1_12 , var_1_11)) - var_1_10))) : ((var_1_20 <= (~ var_1_22)) ? (var_1_23 == ((float) var_1_24)) : 1)) : (var_1_23 == ((float) var_1_12)))) && ((var_1_23 > var_1_21) ? (((1 * (var_1_22 & var_1_15)) > (var_1_60 + (var_1_3 + var_1_60))) ? ((var_1_15 > (max (var_1_5 , var_1_60))) ? (var_1_25 == ((signed short int) (var_1_4 - var_1_5))) : (var_1_25 == ((signed short int) ((var_1_5 - (var_1_4 + var_1_3)) + (min (var_1_26 , var_1_27)))))) : (var_1_25 == ((signed short int) (var_1_5 + (var_1_3 + var_1_4))))) : 1)) && (((var_1_7 / var_1_10) != (min (var_1_11 , var_1_21))) ? (var_1_28 == ((signed long int) (var_1_27 + (max (var_1_4 , var_1_14))))) : 1)) && (((var_1_12 / var_1_10) > 8.25) ? ((var_1_28 > var_1_22) ? (var_1_30 == ((unsigned char) (var_1_31 - (var_1_32 - var_1_33)))) : (var_1_30 == ((unsigned char) (var_1_32 + (max (var_1_4 , var_1_5)))))) : (var_1_30 == ((unsigned char) ((var_1_33 + var_1_34) + var_1_32))))) && ((((var_1_36 - var_1_31) + last_1_var_1_44) > (var_1_32 >> var_1_37)) ? ((var_1_11 > var_1_8) ? (var_1_35 == ((unsigned long int) (max (var_1_5 , 1u)))) : 1) : (var_1_35 == ((unsigned long int) (var_1_15 + (min (last_1_var_1_58 , var_1_3))))))) && ((var_1_11 <= (- var_1_12)) ? (var_1_49 ? (var_1_38 == ((signed long int) (abs (max ((4 + var_1_39) , var_1_14))))) : 1) : 1)) && (((abs (var_1_20)) < var_1_35) ? (var_1_49 ? (var_1_40 == ((unsigned long int) (min (var_1_5 , (var_1_31 + (var_1_37 + var_1_3)))))) : (var_1_40 == ((unsigned long int) ((max ((var_1_32 + var_1_37) , (var_1_33 + 32u))) + var_1_20)))) : 1)) && ((((var_1_34 >> var_1_37) >= (var_1_31 / var_1_36)) || var_1_19) ? ((var_1_32 >= var_1_15) ? (var_1_41 == ((unsigned short int) var_1_4)) : ((var_1_36 > (var_1_4 >> 1)) ? (var_1_41 == ((unsigned short int) (min ((var_1_42 - (var_1_34 + var_1_4)) , (var_1_38 + (max (var_1_31 , var_1_32))))))) : (var_1_41 == ((unsigned short int) (max (var_1_42 , var_1_37)))))) : ((var_1_31 < var_1_37) ? (var_1_49 ? (var_1_41 == ((unsigned short int) (var_1_37 + (var_1_5 + var_1_32)))) : ((! var_1_49) ? (var_1_41 == ((unsigned short int) (var_1_42 - var_1_32))) : 1)) : 1))) && (var_1_49 ? (var_1_44 == ((signed long int) (var_1_39 + var_1_32))) : ((var_1_27 == (var_1_35 * last_1_var_1_44)) ? (var_1_44 == ((signed long int) -500)) : 1))) && ((var_1_47 || var_1_43) ? (var_1_46 == ((signed short int) (max ((min (var_1_5 , var_1_27)) , (max (var_1_26 , var_1_33)))))) : ((((min (10 , var_1_32)) << var_1_40) != (var_1_48 - var_1_5)) ? (var_1_46 == ((signed short int) (var_1_33 - (27566 - var_1_32)))) : (var_1_46 == ((signed short int) var_1_3))))) && ((! last_1_var_1_16) ? (var_1_49 == ((unsigned char) ((var_1_18 && var_1_50) && (var_1_51 && var_1_52)))) : (var_1_49 == ((unsigned char) (! var_1_18))))) && (((var_1_20 * (max (10 , var_1_3))) >= var_1_20) ? (var_1_53 == ((signed short int) (abs (var_1_32 - var_1_3)))) : 1)) && ((last_1_var_1_54 > var_1_42) ? (var_1_54 == ((unsigned long int) var_1_4)) : ((var_1_50 || ((var_1_53 * 10) < var_1_22)) ? (var_1_54 == ((unsigned long int) (((1000000000u + var_1_56) + 1799569305u) - var_1_57))) : (var_1_49 ? (var_1_54 == ((unsigned long int) var_1_38)) : (var_1_54 == ((unsigned long int) 256u)))))) && (var_1_58 == ((signed short int) var_1_27))) && (var_1_50 ? (var_1_59 == ((signed char) var_1_33)) : (var_1_59 == ((signed char) var_1_37)))) && ((var_1_49 && var_1_19) ? (((var_1_63 * 32) <= var_1_15) ? (var_1_60 == ((unsigned long int) (((var_1_61 - var_1_54) - var_1_33) + var_1_15))) : (var_1_60 == ((unsigned long int) (((max (var_1_20 , var_1_3)) + var_1_20) + 50u)))) : (var_1_60 == ((unsigned long int) (max ((var_1_62 - (var_1_36 + var_1_20)) , var_1_32)))))) && (var_1_63 == ((signed short int) var_1_4))
;
}
int main(void) {
	isInitial = 1;
