...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch18425_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch18425_while
	var_1_14 = var_1_6;


	// From: Req1Batch18425_while
