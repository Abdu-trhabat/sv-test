...
void step(void) {
	...
	if ((- (last_1_var_1_34 & var_1_6)) < stepLocal_4) {
		if (last_1_var_1_42) {
			var_1_34 = (min ((var_1_30 + var_1_6) , var_1_12));
		} else {
			var_1_34 = var_1_6;
		}
	} else {
		if (stepLocal_3 && (var_1_13 != var_1_31)) {
			var_1_34 = ((max (var_1_36 , var_1_37)) - (1348017122u - last_1_var_1_34));
		} else {
			var_1_34 = (min ((var_1_36 - var_1_16) , (var_1_12 + var_1_33)));
		}
	}


	// From: Req13Batch172Amount250
	unsigned long int stepLocal_7 = max (-200 , var_1_20);
	if (var_1_11 >= stepLocal_7) {
		var_1_44 = (max (var_1_39 , ((var_1_45 - var_1_34) - (abs (var_1_25)))));
	}


	// From: Req5Batch172Amount250
	signed long int stepLocal_1 = var_1_44 / (var_1_25 - var_1_26);
	if (var_1_16 < stepLocal_1) {
		var_1_24 = (max ((min (var_1_12 , var_1_11)) , -50));
	}


	// From: Req1Batch172Amount250
	...
	// From: Req6Batch172Amount250
	signed long int stepLocal_2 = (var_1_12 - var_1_6) * 16;
	if (var_1_13 > stepLocal_2) {
		var_1_27 = (max (var_1_16 , var_1_6));
	} else {
		var_1_27 = ((abs (var_1_28)) - var_1_16);
	}


	// From: Req7Batch172Amount250
	if (var_1_21) {
		var_1_29 = (min ((max (16 , var_1_30)) , var_1_31));
	} else {
		var_1_29 = (abs (var_1_32 - (4 + var_1_33)));
	}


	// From: Req10Batch172Amount250
	unsigned long int stepLocal_6 = var_1_34;
	if (stepLocal_6 > (max ((var_1_20 + var_1_36) , 50))) {
	...
	// From: Req14Batch172Amount250
	if (! var_1_23) {
		if (var_1_12 <= ((var_1_32 + var_1_39) ^ var_1_28)) {
			var_1_46 = ((min (last_1_var_1_46 , var_1_45)) - var_1_26);
		} else {
			var_1_46 = var_1_13;
		}
	} else {
		if (var_1_13 > last_1_var_1_46) {
			...
			if (var_1_18) {
				if (var_1_22 || var_1_42) {
					var_1_46 = (abs (var_1_47 - (var_1_26 + var_1_31)));
				} else {
					var_1_46 = (min (((var_1_32 + var_1_15) + (last_1_var_1_46 + var_1_28)) , (var_1_12 - var_1_13)));
				}
			}
		}
	}
	...
	// From: Req15Batch172Amount250
	if (var_1_23) {
		var_1_48 = (max ((abs (var_1_47)) , (var_1_25 + var_1_11)));
	}


	// From: Req16Batch172Amount250
	signed long int stepLocal_9 = var_1_24 + 100000;
	signed long int stepLocal_8 = var_1_33 - (var_1_51 - var_1_30);
	if (var_1_42) {
		var_1_49 = (min (var_1_44 , (min (var_1_50 , var_1_13))));
	} else {
		if ((var_1_25 - (max (16 , var_1_32))) == stepLocal_9) {
			var_1_49 = (var_1_26 + (var_1_5 + var_1_44));
		} else {
			if (var_1_18) {
				if (var_1_12 > stepLocal_8) {
					var_1_49 = (max (var_1_15 , (var_1_16 - (abs (var_1_28)))));
				} else {
	...
	if (var_1_12 <= (8 * (max (64 , var_1_13)))) {
		...
		if (((max (var_1_8 , var_1_19)) + var_1_2) != var_1_9) {
	...
	// From: Req3Batch172Amount250
	if ((min (var_1_24 , var_1_6)) >= (var_1_12 + (var_1_13 / var_1_11))) {
		if (! var_1_17) {
			var_1_14 = (var_1_6 + 5);
		} else {
			if ((var_1_8 + var_1_9) <= (abs (var_1_4))) {
				if (var_1_5 <= var_1_11) {
					var_1_14 = var_1_6;
				}
			}
	...
	// From: Req12Batch172Amount250
	if (! var_1_23) {
		var_1_43 = (var_1_31 + (var_1_33 + (max (var_1_38 , var_1_24))));
	}


	// From: Req17Batch172Amount250
...
int property(void) {
	return ((((((((((((((((((var_1_2 * var_1_3) > var_1_4) ? (var_1_1 == ((signed short int) ((abs (var_1_5)) - var_1_6))) : ((var_1_4 <= var_1_2) ? (var_1_1 == ((signed short int) var_1_6)) : 1)) && ((var_1_4 <= (- (var_1_8 - var_1_9))) ? (var_1_7 == ((signed long int) (max (var_1_5 , (abs (var_1_6)))))) : (var_1_17 ? ((((var_1_5 * var_1_43) % var_1_11) < var_1_6) ? (var_1_7 == ((signed long int) (((min (var_1_6 , 32)) - (var_1_12 + var_1_13)) + 2))) : (var_1_7 == ((signed long int) (abs (var_1_11))))) : (var_1_7 == ((signed long int) (100000000 + var_1_12)))))) && (((min (var_1_24 , var_1_6)) >= (var_1_12 + (var_1_13 / var_1_11))) ? ((! var_1_17) ? (var_1_14 == ((unsigned short int) (var_1_6 + 5))) : (((var_1_8 + var_1_9) <= (abs (var_1_4))) ? ((var_1_5 <= var_1_11) ? (var_1_14 == ((unsigned short int) var_1_6)) : 1) : 1)) : (var_1_14 == ((unsigned short int) ((var_1_15 - var_1_16) + (5 + 1)))))) && ((var_1_12 <= (8 * (max (64 , var_1_13)))) ? (((var_1_4 > (- var_1_2)) && (-2 == (var_1_16 / var_1_11))) ? (var_1_17 == ((unsigned char) (var_1_18 || (! 1)))) : ((var_1_6 <= var_1_16) ? (var_1_17 == ((unsigned char) (! var_1_18))) : (var_1_17 == ((unsigned char) var_1_18)))) : ((((max (var_1_8 , var_1_19)) + var_1_2) != var_1_9) ? (((var_1_20 - var_1_34) <= (var_1_6 & 8u)) ? (var_1_17 == ((unsigned char) ((var_1_11 >= (var_1_15 - var_1_6)) || (! (var_1_21 || var_1_18))))) : (var_1_17 == ((unsigned char) ((! var_1_42) || (var_1_22 && var_1_23))))) : ((var_1_8 <= (var_1_4 * (var_1_9 * var_1_2))) ? (var_1_17 == ((unsigned char) (! 0))) : (var_1_17 == ((unsigned char) (! var_1_18))))))) && ((var_1_16 < (var_1_44 / (var_1_25 - var_1_26))) ? (var_1_24 == ((signed long int) (max ((min (var_1_12 , var_1_11)) , -50)))) : 1)) && ((var_1_13 > ((var_1_12 - var_1_6) * 16)) ? (var_1_27 == ((unsigned short int) (max (var_1_16 , var_1_6)))) : (var_1_27 == ((unsigned short int) ((abs (var_1_28)) - var_1_16))))) && (var_1_21 ? (var_1_29 == ((unsigned char) (min ((max (16 , var_1_30)) , var_1_31)))) : (var_1_29 == ((unsigned char) (abs (var_1_32 - (4 + var_1_33))))))) && (((- (last_1_var_1_34 & var_1_6)) < (var_1_28 + last_1_var_1_44)) ? (last_1_var_1_42 ? (var_1_34 == ((unsigned long int) (min ((var_1_30 + var_1_6) , var_1_12)))) : (var_1_34 == ((unsigned long int) var_1_6))) : ((var_1_22 && (var_1_13 != var_1_31)) ? (var_1_34 == ((unsigned long int) ((max (var_1_36 , var_1_37)) - (1348017122u - last_1_var_1_34)))) : (var_1_34 == ((unsigned long int) (min ((var_1_36 - var_1_16) , (var_1_12 + var_1_33)))))))) && (((- (var_1_8 * var_1_9)) > var_1_2) ? ((! var_1_17) ? (var_1_38 == ((unsigned short int) var_1_39)) : ((var_1_20 != (var_1_46 >> 10)) ? (var_1_38 == ((unsigned short int) var_1_31)) : (var_1_38 == ((unsigned short int) var_1_28)))) : (var_1_38 == ((unsigned short int) var_1_16)))) && ((var_1_34 > (max ((var_1_20 + var_1_36) , 50))) ? (var_1_40 == ((unsigned char) (var_1_32 - 25))) : (var_1_40 == ((unsigned char) (var_1_32 - var_1_33))))) && (last_1_var_1_17 ? (var_1_42 == ((unsigned char) (var_1_18 || var_1_23))) : (var_1_42 == ((unsigned char) (((last_1_var_1_34 - var_1_13) < last_1_var_1_24) || (var_1_23 && var_1_22)))))) && ((! var_1_23) ? (var_1_43 == ((signed short int) (var_1_31 + (var_1_33 + (max (var_1_38 , var_1_24)))))) : 1)) && ((var_1_11 >= (max (-200 , var_1_20))) ? (var_1_44 == ((signed long int) (max (var_1_39 , ((var_1_45 - var_1_34) - (abs (var_1_25))))))) : 1)) && ((! var_1_23) ? ((var_1_12 <= ((var_1_32 + var_1_39) ^ var_1_28)) ? (var_1_46 == ((signed long int) ((min (last_1_var_1_46 , var_1_45)) - var_1_26))) : (var_1_46 == ((signed long int) var_1_13))) : ((var_1_13 > last_1_var_1_46) ? (var_1_46 == ((signed long int) (var_1_13 + (last_1_var_1_46 + var_1_5)))) : (var_1_18 ? ((var_1_22 || var_1_42) ? (var_1_46 == ((signed long int) (abs (var_1_47 - (var_1_26 + var_1_31))))) : (var_1_46 == ((signed long int) (min (((var_1_32 + var_1_15) + (last_1_var_1_46 + var_1_28)) , (var_1_12 - var_1_13)))))) : 1)))) && (var_1_23 ? (var_1_48 == ((signed long int) (max ((abs (var_1_47)) , (var_1_25 + var_1_11))))) : 1)) && (var_1_42 ? (var_1_49 == ((signed long int) (min (var_1_44 , (min (var_1_50 , var_1_13)))))) : (((var_1_25 - (max (16 , var_1_32))) == (var_1_24 + 100000)) ? (var_1_49 == ((signed long int) (var_1_26 + (var_1_5 + var_1_44)))) : (var_1_18 ? ((var_1_12 > (var_1_33 - (var_1_51 - var_1_30))) ? (var_1_49 == ((signed long int) (max (var_1_15 , (var_1_16 - (abs (var_1_28))))))) : (var_1_49 == ((signed long int) ((var_1_28 - var_1_15) + var_1_33)))) : (var_1_49 == ((signed long int) (((var_1_16 - var_1_46) + var_1_33) + var_1_28))))))) && ((var_1_43 <= var_1_26) ? (var_1_52 == ((signed char) (var_1_33 + var_1_53))) : ((var_1_21 || var_1_42) ? (var_1_52 == ((signed char) var_1_33)) : (var_1_52 == ((signed char) var_1_53))))
;
}
int main(void) {
	isInitial = 1;
