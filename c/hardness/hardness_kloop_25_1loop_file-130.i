...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13025_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_0 <= (var_1_4 / ((((-25) < (var_1_5)) ? (-25) : (var_1_5))))) {
  var_1_1 = var_1_6;
 } else {
  if (var_1_15) {
   var_1_1 = var_1_6;
