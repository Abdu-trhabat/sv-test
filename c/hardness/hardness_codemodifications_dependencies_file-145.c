...
void step(void) {
	...
	// From: Req4Batch145dependencies
	var_1_16 = (min (var_1_17 , var_1_18));


	// From: Req5Batch145dependencies
	if ((min ((var_1_18 >> var_1_20) , var_1_5)) < var_1_17) {
		var_1_19 = var_1_18;
	}


	// From: Req7Batch145dependencies
	var_1_23 = (var_1_24 - var_1_7);


	// From: Req1Batch145dependencies
	if (var_1_25) {
