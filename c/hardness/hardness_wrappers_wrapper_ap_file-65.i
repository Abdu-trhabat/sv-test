...
void step(void) {
 if (0.625f > last_1_double_Array_0_1_) {
  if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
   (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = (((((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) < 0 ) ? -((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) : ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)))));
  }
 } else {
  (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = (((((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) < 0 ) ? -((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) : ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)))));
 }
 ...
 if ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) > (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))) {
  (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var5_Pointer)) = ((((((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer))) > (-64)) ? ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer))) : (-64))) + (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) + -2) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))));
 }
