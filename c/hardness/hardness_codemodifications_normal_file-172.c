...
void step(void) {
	// From: Req1Batch172normal
	if ((var_1_2 >= (abs (var_1_3))) || var_1_4) {
		var_1_1 = var_1_5;
	}


	// From: Req2Batch172normal
	if (var_1_1 > var_1_5) {
		var_1_6 = var_1_7;
	}


	// From: Req3Batch172normal
	if (var_1_4 && var_1_9) {
		if (var_1_5 == (var_1_1 + (~ var_1_10))) {
			var_1_8 = var_1_2;
		} else {
			var_1_8 = var_1_3;
		}
