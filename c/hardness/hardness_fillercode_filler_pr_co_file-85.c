...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch85Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	/* 387L, 217L) */ if (/* 388L, 197L, 198L) */ ((/* 389L, 194L, 199L) */ ((var_1_18) / (25.4f))) >= (/* 392L, 196L, 202L) */ (abs (var_1_18))))) {
		/* 394L, 216L) */ var_1_37 = (
			/* 397L, 215L) */ (! (
				/* 398L, 214L) */ ((
					var_1_36
	...
	// From: CodeObject6
	/* 401L, 315L) */ if (/* 402L, 222L, 223L) */ (! (var_1_5))) {
		/* 404L, 313L) */ if (/* 405L, 235L, 236L) */ ((/* 406L, 230L, 237L) */ ((var_1_13) + (var_1_1))) >= (/* 409L, 234L, 240L) */ ((/* 410L, 232L, 241L) */ (abs (var_1_24))) << (var_1_25))))) {
