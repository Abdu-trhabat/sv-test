...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch134Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch134Wrapper_A
	unsigned char stepLocal_0 = unsigned_char_Array_0[1];
	if (stepLocal_0 > unsigned_char_Array_0[0]) {
		if (((min (double_Array_0[0][1][1] , double_Array_0[1][0][1])) - 8.88) < double_Array_0[0][0][1]) {
			double_Array_0[1][1][1] = (double_Array_0[0][1][0] - (double_Array_0[1][0][0] - (abs (double_Array_0[0][0][0]))));
		} else {
			double_Array_0[1][1][1] = double_Array_0[0][1][0];
		}
	} else {
		double_Array_0[1][1][1] = double_Array_0[0][0][0];
	}


	// From: Req2Batch134Wrapper_A
	if (double_Array_0[1][1][1] >= double_Array_0[1][1][0]) {
		if ((unsigned_char_Array_0[0] - unsigned_char_Array_0[1]) >= signed_long_int_Array_0[0]) {
			unsigned_long_int_Array_0[1] = ((unsigned_long_int_Array_0[0] - (max (unsigned_char_Array_0[1] , unsigned_char_Array_0[0]))) - unsigned_long_int_Array_0[2]);
		}
	} else {
	...
	// From: Req3Batch134Wrapper_A
	unsigned long int stepLocal_1 = unsigned_long_int_Array_0[1];
	if (! BOOL_unsigned_char_Array_0[0]) {
		float_Array_0[0] = (max ((200.5f - 4.25f) , double_Array_0[1][0][0]));
	} else {
		if ((max (unsigned_long_int_Array_0[2] , unsigned_long_int_Array_0[0])) >= stepLocal_1) {
			float_Array_0[0] = double_Array_0[0][0][0];
		} else {
			float_Array_0[0] = double_Array_0[1][0][0];
		}
	}
}
...
int property(void) {
	return (((unsigned_char_Array_0[1] > unsigned_char_Array_0[0]) ? ((((min (double_Array_0[0][1][1] , double_Array_0[1][0][1])) - 8.88) < double_Array_0[0][0][1]) ? (double_Array_0[1][1][1] == ((double) (double_Array_0[0][1][0] - (double_Array_0[1][0][0] - (abs (double_Array_0[0][0][0])))))) : (double_Array_0[1][1][1] == ((double) double_Array_0[0][1][0]))) : (double_Array_0[1][1][1] == ((double) double_Array_0[0][0][0]))) && ((double_Array_0[1][1][1] >= double_Array_0[1][1][0]) ? (((unsigned_char_Array_0[0] - unsigned_char_Array_0[1]) >= signed_long_int_Array_0[0]) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) ((unsigned_long_int_Array_0[0] - (max (unsigned_char_Array_0[1] , unsigned_char_Array_0[0]))) - unsigned_long_int_Array_0[2]))) : 1) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_long_int_Array_0[0])))) && ((! BOOL_unsigned_char_Array_0[0]) ? (float_Array_0[0] == ((float) (max ((200.5f - 4.25f) , double_Array_0[1][0][0])))) : (((max (unsigned_long_int_Array_0[2] , unsigned_long_int_Array_0[0])) >= unsigned_long_int_Array_0[1]) ? (float_Array_0[0] == ((float) double_Array_0[0][0][0])) : (float_Array_0[0] == ((float) double_Array_0[1][0][0]))))
;
}
int main(void) {
	isInitial = 1;
