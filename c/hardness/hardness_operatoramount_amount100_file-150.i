...
void step(void) {
 ...
 if ((var_1_1 >> var_1_15) == stepLocal_2) {
  ...
  var_1_14 = (((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))) - var_1_19);
 }
 if (var_1_16 >= var_1_9) {
  if ((var_1_1 + var_1_5) > ((((var_1_6) > (var_1_25)) ? (var_1_6) : (var_1_25)))) {
   var_1_24 = 0;
  } else {
   var_1_24 = var_1_13;
  }
 ...
 if (! (last_1_var_1_37 <= 2)) {
  ...
  if (var_1_32 > stepLocal_7) {
   if (stepLocal_6 == last_1_var_1_37) {
    ...
    var_1_37 = (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) + var_1_9);
   }
  } else {
   var_1_37 = (var_1_27 + var_1_3);
  }
 }
 if (var_1_26 <= ((((var_1_34 / var_1_30) < 0 ) ? -(var_1_34 / var_1_30) : (var_1_34 / var_1_30)))) {
 ...
 if ((((((var_1_17 + var_1_18)) > (var_1_22)) ? ((var_1_17 + var_1_18)) : (var_1_22))) <= var_1_20) {
  var_1_36 = (! var_1_13);
 } else {
  if (var_1_26 < var_1_1) {
   if (var_1_9 <= var_1_29) {
...
int property(void) {
 return (((((((((((var_1_1 == ((signed long int) var_1_2)) && ((var_1_2 <= (~ var_1_1)) ? ((((var_1_2 & var_1_1) / var_1_4) <= (var_1_5 | var_1_6)) ? (var_1_3 == ((unsigned char) ((((((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8)))) > (var_1_9)) ? (((((var_1_7) > (var_1_8)) ? (var_1_7) : (var_1_8)))) : (var_1_9))))) : 1) : (var_1_3 == ((unsigned char) var_1_9)))) && ((((var_1_2 % var_1_4) > var_1_1) || var_1_36) ? (var_1_36 ? (var_1_10 == ((unsigned char) var_1_13)) : 1) : 1)) && (((var_1_1 >> var_1_15) == var_1_1) ? (var_1_14 == ((float) 0.5f)) : (var_1_14 == ((float) (((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))) - var_1_19))))) && ((! (var_1_16 == var_1_21)) ? (var_1_20 == ((float) (var_1_22 + var_1_23))) : (((var_1_7 - 25) <= ((var_1_33 - var_1_15) / var_1_4)) ? (var_1_20 == ((float) var_1_18)) : (var_1_20 == ((float) var_1_17))))) && ((var_1_16 >= var_1_9) ? (((var_1_1 + var_1_5) > ((((var_1_6) > (var_1_25)) ? (var_1_6) : (var_1_25)))) ? (var_1_24 == ((unsigned char) 0)) : (var_1_24 == ((unsigned char) var_1_13))) : 1)) && (((var_1_4 >= var_1_2) && last_1_var_1_36) ? ((last_1_var_1_1 <= 5) ? (var_1_26 == ((signed short int) var_1_8)) : 1) : 1)) && (var_1_24 ? (var_1_27 == ((signed char) (var_1_32 + var_1_30))) : 1)) && ((var_1_8 <= (32 << (var_1_34 - 8u))) ? (var_1_24 ? (var_1_33 == ((signed short int) var_1_35)) : 1) : 1)) && (((((((var_1_17 + var_1_18)) > (var_1_22)) ? ((var_1_17 + var_1_18)) : (var_1_22))) <= var_1_20) ? (var_1_36 == ((unsigned char) (! var_1_13))) : ((var_1_26 < var_1_1) ? ((var_1_9 <= var_1_29) ? (var_1_36 == ((unsigned char) (last_1_var_1_36 || var_1_13))) : ((! var_1_13) ? (var_1_36 == ((unsigned char) (! var_1_13))) : 1)) : 1))) && ((! (last_1_var_1_37 <= 2)) ? (var_1_37 == ((signed short int) (var_1_30 - var_1_8))) : ((var_1_32 > var_1_16) ? ((var_1_33 == last_1_var_1_37) ? (var_1_37 == ((signed short int) var_1_3)) : (var_1_37 == ((signed short int) (((((var_1_30) < 0 ) ? -(var_1_30) : (var_1_30))) + var_1_9)))) : (var_1_37 == ((signed short int) (var_1_27 + var_1_3)))))) && ((var_1_26 <= ((((var_1_34 / var_1_30) < 0 ) ? -(var_1_34 / var_1_30) : (var_1_34 / var_1_30)))) ? (var_1_38 == ((signed short int) (var_1_39 - (17213 - var_1_9)))) : (var_1_38 == ((signed short int) var_1_28)))
;
}
int main(void) {
 isInitial = 1;
