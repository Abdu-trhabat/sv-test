...
void step(void) {
	// From: Req1Batch179Wrapper_SP
	unsigned char stepLocal_0 = (*(WrapperStruct00_var_1_2_Pointer));
	if (stepLocal_0 && (! (*(WrapperStruct00_var_1_3_Pointer)))) {
		(*(WrapperStruct00_var_1_1_Pointer)) = ((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer)))) + 7.5);
	}


	// From: Req2Batch179Wrapper_SP
	if ((*(WrapperStruct00_var_1_1_Pointer)) > ((*(WrapperStruct00_var_1_4_Pointer)) * (*(WrapperStruct00_var_1_5_Pointer)))) {
		if ((*(WrapperStruct00_var_1_1_Pointer)) <= (*(WrapperStruct00_var_1_5_Pointer))) {
			if ((*(WrapperStruct00_var_1_5_Pointer)) > (*(WrapperStruct00_var_1_4_Pointer))) {
				(*(WrapperStruct00_var_1_6_Pointer)) = ((*(WrapperStruct00_var_1_4_Pointer)) + ((max ((*(WrapperStruct00_var_1_7_Pointer)) , (*(WrapperStruct00_var_1_8_Pointer)))) - (*(WrapperStruct00_var_1_9_Pointer))));
			} else {
				(*(WrapperStruct00_var_1_6_Pointer)) = (abs ((*(WrapperStruct00_var_1_7_Pointer))));
			}
		} else {
	...
	if ((*(WrapperStruct00_var_1_5_Pointer)) > (*(WrapperStruct00_var_1_8_Pointer))) {
		...
		(*(WrapperStruct00_var_1_10_Pointer)) = (min ((*(WrapperStruct00_var_1_11_Pointer)) , (*(WrapperStruct00_var_1_12_Pointer))));
	}


	// From: Req4Batch179Wrapper_SP
...
int property(void) {
	return (((((*(WrapperStruct00_var_1_2_Pointer)) && (! (*(WrapperStruct00_var_1_3_Pointer)))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((double) ((min ((*(WrapperStruct00_var_1_4_Pointer)) , (*(WrapperStruct00_var_1_5_Pointer)))) + 7.5))) : 1) && (((*(WrapperStruct00_var_1_1_Pointer)) > ((*(WrapperStruct00_var_1_4_Pointer)) * (*(WrapperStruct00_var_1_5_Pointer)))) ? (((*(WrapperStruct00_var_1_1_Pointer)) <= (*(WrapperStruct00_var_1_5_Pointer))) ? (((*(WrapperStruct00_var_1_5_Pointer)) > (*(WrapperStruct00_var_1_4_Pointer))) ? ((*(WrapperStruct00_var_1_6_Pointer)) == ((double) ((*(WrapperStruct00_var_1_4_Pointer)) + ((max ((*(WrapperStruct00_var_1_7_Pointer)) , (*(WrapperStruct00_var_1_8_Pointer)))) - (*(WrapperStruct00_var_1_9_Pointer)))))) : ((*(WrapperStruct00_var_1_6_Pointer)) == ((double) (abs ((*(WrapperStruct00_var_1_7_Pointer))))))) : ((*(WrapperStruct00_var_1_6_Pointer)) == ((double) (*(WrapperStruct00_var_1_8_Pointer))))) : ((*(WrapperStruct00_var_1_6_Pointer)) == ((double) (*(WrapperStruct00_var_1_4_Pointer)))))) && (((*(WrapperStruct00_var_1_5_Pointer)) > (*(WrapperStruct00_var_1_8_Pointer))) ? ((*(WrapperStruct00_var_1_10_Pointer)) == ((unsigned short int) (((29089 - (*(WrapperStruct00_var_1_11_Pointer))) - 8) + 16))) : ((*(WrapperStruct00_var_1_10_Pointer)) == ((unsigned short int) (min ((*(WrapperStruct00_var_1_11_Pointer)) , (*(WrapperStruct00_var_1_12_Pointer)))))))) && ((*(WrapperStruct00_var_1_13_Pointer)) == ((double) (*(WrapperStruct00_var_1_7_Pointer))))
;
}
int main(void) {
	isInitial = 1;
