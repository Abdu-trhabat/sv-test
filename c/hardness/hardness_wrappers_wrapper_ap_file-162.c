...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch162Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch162Wrapper_AP
	if ((min (last_1_double_Array_0_1__0_ , 10.3)) >= last_1_double_Array_0_1__0_) {
		(*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) = ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) + (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)));
	} else {
		(*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) = ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) + (499.94 - ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) + (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))));
	}


	// From: Req4Batch162Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) || (((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) * last_1_double_Array_0_1__0_) <= (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)))) {
		if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) >= (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) {
			...
			(*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) = 1.45;
		}
	} else {
		(*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) = 128.2;
	}


	// From: Req2Batch162Wrapper_AP
	...
	if ((last_1_unsigned_char_Array_0_1_ * (25 + 64)) != stepLocal_1) {
		if ((last_1_unsigned_char_Array_0_1_ - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))) == stepLocal_0) {
			...
			(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) = 16;
		}
	}


	// From: Req3Batch162Wrapper_AP
	if ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) < (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) = (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer));
	} else {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) = ((*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer)) - (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)));
	}
}
...
int property(void) {
	return (((((min (last_1_double_Array_0_1__0_ , 10.3)) >= last_1_double_Array_0_1__0_) ? ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) == ((double) ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) + (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))))) : ((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) == ((double) ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) + (499.94 - ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) + (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))))))) && (((last_1_unsigned_char_Array_0_1_ * (25 + 64)) != (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) ? (((last_1_unsigned_char_Array_0_1_ - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))) == (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) == ((unsigned char) (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) == ((unsigned char) 16))) : 1)) && (((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) < (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) ? ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) == ((signed char) (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))) : ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) == ((signed char) ((*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer)) - (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))))))) && (((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) || (((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) * last_1_double_Array_0_1__0_) <= (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)))) ? (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) >= (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) == ((double) (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)))) : ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) == ((double) 1.45))) : ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) == ((double) 128.2)))
;
}
int main(void) {
	isInitial = 1;
