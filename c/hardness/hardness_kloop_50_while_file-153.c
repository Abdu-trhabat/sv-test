...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15350_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch15350_while
	if (var_1_1 < (var_1_8 * (max (var_1_9 , var_1_7)))) {
		var_1_10 = (var_1_5 - (min ((32476 - var_1_4) , 8)));
	}


	// From: Req5Batch15350_while
	if (var_1_15 <= var_1_4) {
		if (! (var_1_15 <= var_1_5)) {
...
int property(void) {
	return (((((var_1_2 ? ((((var_1_3 + var_1_4) << var_1_5) > var_1_15) ? (var_1_1 == ((double) var_1_7)) : (var_1_1 == ((double) (1.06 + (max (var_1_8 , var_1_9)))))) : ((((var_1_9 + 255.72) / 128.5) < ((- var_1_8) * var_1_7)) ? (var_1_1 == ((double) var_1_9)) : (var_1_1 == ((double) var_1_7)))) && ((var_1_1 < (var_1_8 * (max (var_1_9 , var_1_7)))) ? (var_1_10 == ((signed short int) (var_1_5 - (min ((32476 - var_1_4) , 8))))) : 1)) && ((var_1_15 >= (var_1_15 + var_1_3)) ? (var_1_11 == ((signed char) (abs (var_1_5)))) : (var_1_11 == ((signed char) var_1_5)))) && (((var_1_5 + var_1_4) < var_1_15) ? (var_1_12 == ((double) (var_1_13 + var_1_9))) : (var_1_12 == ((double) var_1_7)))) && ((var_1_15 <= var_1_4) ? ((! (var_1_15 <= var_1_5)) ? (((var_1_4 & var_1_5) >= var_1_15) ? (var_1_14 == ((signed char) var_1_5)) : 1) : 1) : 1)) && (((var_1_16 - (var_1_17 - var_1_5)) <= last_1_var_1_10) ? (var_1_15 == ((signed long int) last_1_var_1_14)) : 1)
;
}
int main(void) {
	isInitial = 1;
