...
void step(void) {
	// From: Req5Batch103no_floats
	unsigned char stepLocal_1 = var_1_6;
	if ((var_1_10 >= (var_1_15 + var_1_5)) || stepLocal_1) {
		var_1_17 = (min (last_1_var_1_20 , ((min (var_1_18 , var_1_19)) - var_1_15)));
	}


	// From: Req1Batch103no_floats
	var_1_1 = var_1_2;


	// From: Req2Batch103no_floats
	signed char stepLocal_0 = var_1_5;
	if (var_1_4) {
		if ((max ((var_1_17 ^ var_1_2) , (64 / var_1_7))) >= stepLocal_0) {
			var_1_3 = var_1_8;
		} else {
			var_1_3 = -25;
		}
...
int property(void) {
	return (((((var_1_1 == ((signed short int) var_1_2)) && (var_1_4 ? (((max ((var_1_17 ^ var_1_2) , (64 / var_1_7))) >= var_1_5) ? (var_1_3 == ((signed long int) var_1_8)) : (var_1_3 == ((signed long int) -25))) : (var_1_3 == ((signed long int) var_1_8)))) && (var_1_9 == ((unsigned long int) (((1846010599u + var_1_10) - var_1_5) - var_1_11)))) && (var_1_12 == ((unsigned char) ((var_1_13 + var_1_14) + (var_1_15 + var_1_16))))) && (((var_1_10 >= (var_1_15 + var_1_5)) || var_1_6) ? (var_1_17 == ((unsigned short int) (min (last_1_var_1_20 , ((min (var_1_18 , var_1_19)) - var_1_15))))) : 1)) && ((var_1_6 && var_1_4) ? ((var_1_17 > var_1_9) ? (var_1_20 == ((unsigned char) var_1_13)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
