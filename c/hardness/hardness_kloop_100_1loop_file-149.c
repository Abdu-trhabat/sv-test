...
void step(void) {
	// From: Req4Batch149100_1loop
	var_1_9 = var_1_5;


	// From: Req9Batch149100_1loop
	var_1_22 = ((var_1_23 - var_1_19) - var_1_20);


	// From: Req14Batch149100_1loop
	var_1_36 = 16u;


	// From: Req13Batch149100_1loop
	...
	// From: Req3Batch149100_1loop
	if ((var_1_8 - var_1_22) <= var_1_35) {
		var_1_7 = var_1_22;
	}


	// From: Req7Batch149100_1loop
	if (255.5 <= var_1_15) {
	...
	// From: Req12Batch149100_1loop
	if ((abs (var_1_31)) == var_1_7) {
		var_1_30 = (var_1_32 + (var_1_33 + var_1_34));
	}


	// From: Req2Batch149100_1loop
	if (var_1_25) {
		var_1_6 = 8;
	}


	// From: Req5Batch149100_1loop
	...
	// From: Req8Batch149100_1loop
	if (! var_1_25) {
		var_1_21 = (abs (var_1_18));
	}


	// From: Req15Batch149100_1loop
