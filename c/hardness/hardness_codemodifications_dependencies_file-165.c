...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch165dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch165dependencies
	if (var_1_3 <= (var_1_4 + var_1_5)) {
		var_1_12 = ((18598 - var_1_13) - var_1_9);
	}


	// From: Req4Batch165dependencies
	...
	// From: Req5Batch165dependencies
	if (var_1_6 < (var_1_15 | var_1_1)) {
		var_1_19 = var_1_13;
	}


	// From: Req6Batch165dependencies
	if (var_1_18) {
		if (9.25 >= var_1_3) {
