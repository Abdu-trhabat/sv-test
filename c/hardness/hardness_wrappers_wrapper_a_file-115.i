...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch115Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 if ((float_Array_0[2] * last_1_double_Array_0_1__1_) >= ((((float_Array_0[1]) > (float_Array_0[0])) ? (float_Array_0[1]) : (float_Array_0[0])))) {
  double_Array_0[1][1] = (double_Array_0[0][1] + double_Array_0[0][0]);
 } else {
  if (last_1_double_Array_0_1__1_ <= double_Array_0[0][0]) {
   double_Array_0[1][1] = double_Array_0[0][0];
  } else {
   double_Array_0[1][1] = 3.2;
  }
 }
 signed_short_int_Array_0[0][0] = (((((signed_short_int_Array_0[1][0] - ((((signed_short_int_Array_0[0][1]) < 0 ) ? -(signed_short_int_Array_0[0][1]) : (signed_short_int_Array_0[0][1]))))) < (signed_short_int_Array_0[1][1])) ? ((signed_short_int_Array_0[1][0] - ((((signed_short_int_Array_0[0][1]) < 0 ) ? -(signed_short_int_Array_0[0][1]) : (signed_short_int_Array_0[0][1]))))) : (signed_short_int_Array_0[1][1])));
 if ((signed_short_int_Array_0[0][0] ^ unsigned_long_int_Array_0[1][1]) < (- unsigned_long_int_Array_0[0][0])) {
  if (double_Array_0[0][1] >= double_Array_0[0][0]) {
   if (double_Array_0[1][1] > (- double_Array_0[1][1])) {
    double_Array_0[1][0] = double_Array_0[0][1];
   }
  } else {
   double_Array_0[1][0] = double_Array_0[0][0];
  }
 } else {
  double_Array_0[1][0] = double_Array_0[0][1];
 }
 if (double_Array_0[1][0] > (- double_Array_0[0][1])) {
  unsigned_long_int_Array_0[1][0] = (unsigned_long_int_Array_0[0][0] - (unsigned_long_int_Array_0[0][1] - unsigned_long_int_Array_0[1][1]));
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((float_Array_0[2] * last_1_double_Array_0_1__1_) >= ((((float_Array_0[1]) > (float_Array_0[0])) ? (float_Array_0[1]) : (float_Array_0[0])))) ? (double_Array_0[1][1] == ((double) (double_Array_0[0][1] + double_Array_0[0][0]))) : ((last_1_double_Array_0_1__1_ <= double_Array_0[0][0]) ? (double_Array_0[1][1] == ((double) double_Array_0[0][0])) : (double_Array_0[1][1] == ((double) 3.2)))) && ((double_Array_0[1][0] > (- double_Array_0[0][1])) ? (unsigned_long_int_Array_0[1][0] == ((unsigned long int) (unsigned_long_int_Array_0[0][0] - (unsigned_long_int_Array_0[0][1] - unsigned_long_int_Array_0[1][1])))) : 1)) && (signed_short_int_Array_0[0][0] == ((signed short int) (((((signed_short_int_Array_0[1][0] - ((((signed_short_int_Array_0[0][1]) < 0 ) ? -(signed_short_int_Array_0[0][1]) : (signed_short_int_Array_0[0][1]))))) < (signed_short_int_Array_0[1][1])) ? ((signed_short_int_Array_0[1][0] - ((((signed_short_int_Array_0[0][1]) < 0 ) ? -(signed_short_int_Array_0[0][1]) : (signed_short_int_Array_0[0][1]))))) : (signed_short_int_Array_0[1][1])))))) && (((signed_short_int_Array_0[0][0] ^ unsigned_long_int_Array_0[1][1]) < (- unsigned_long_int_Array_0[0][0])) ? ((double_Array_0[0][1] >= double_Array_0[0][0]) ? ((double_Array_0[1][1] > (- double_Array_0[1][1])) ? (double_Array_0[1][0] == ((double) double_Array_0[0][1])) : 1) : (double_Array_0[1][0] == ((double) double_Array_0[0][0]))) : (double_Array_0[1][0] == ((double) double_Array_0[0][1])))
;
}
int main(void) {
 isInitial = 1;
