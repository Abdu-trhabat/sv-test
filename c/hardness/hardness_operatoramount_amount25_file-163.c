...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch163Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch163Amount25
	unsigned char stepLocal_3 = var_1_7;
	signed long int stepLocal_2 = max (var_1_3 , last_1_var_1_1);
	unsigned short int stepLocal_1 = var_1_3;
	if (var_1_6 || stepLocal_3) {
		if (stepLocal_2 < ((max (var_1_4 , var_1_2)) * var_1_8)) {
	...
	// From: Req3Batch163Amount25
	var_1_10 = (min (var_1_11 , var_1_12));


	// From: Req5Batch163Amount25
	var_1_17 = var_1_18;


	// From: Req4Batch163Amount25
...
int property(void) {
	return (((((var_1_13 >= (var_1_5 / var_1_4)) ? (var_1_1 == ((signed long int) var_1_13)) : 1) && ((var_1_6 || var_1_7) ? (((max (var_1_3 , last_1_var_1_1)) < ((max (var_1_4 , var_1_2)) * var_1_8)) ? ((var_1_3 >= var_1_9) ? (var_1_6 ? (var_1_5 == ((unsigned long int) 5u)) : 1) : 1) : (var_1_5 == ((unsigned long int) var_1_4))) : (var_1_5 == ((unsigned long int) var_1_9)))) && (var_1_10 == ((unsigned short int) (min (var_1_11 , var_1_12))))) && (((var_1_14 - (var_1_15 - var_1_16)) > var_1_5) ? (var_1_13 == ((unsigned long int) var_1_10)) : 1)) && (var_1_17 == ((signed char) var_1_18))
;
}
int main(void) {
	isInitial = 1;
