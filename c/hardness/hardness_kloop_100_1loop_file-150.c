...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch150100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch150100_1loop
	var_1_1 = var_1_2;


	// From: Req2Batch150100_1loop
	...
	// From: Req8Batch150100_1loop
	if (var_1_24) {
		var_1_27 = (var_1_32 + var_1_30);
	}


	// From: Req9Batch150100_1loop
