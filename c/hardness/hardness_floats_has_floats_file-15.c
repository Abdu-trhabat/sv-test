...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15has_floats.c", 13, "reach_error"); }
...
double var_1_14 = 1000.0;
double var_1_15 = 0.0;
double var_1_16 = 64.0;
double var_1_17 = 0.0;
double var_1_18 = 32.0;
...
int property(void) {
	return ((((var_1_2 || ((~ var_1_10) >= var_1_8)) ? ((var_1_8 < var_1_10) ? ((! var_1_6) ? (var_1_1 == ((signed char) var_1_7)) : 1) : (var_1_1 == ((signed char) 2))) : (var_1_1 == ((signed char) var_1_7))) && (var_1_2 ? (var_1_8 == ((unsigned long int) ((1514707036u + (abs (var_1_9))) - last_1_var_1_10))) : (var_1_8 == ((unsigned long int) (max (last_1_var_1_10 , var_1_9)))))) && (var_1_2 ? (var_1_10 == ((signed long int) (var_1_8 + (abs (var_1_7))))) : 1)) && (((var_1_12 - var_1_13) > var_1_8) ? (var_1_11 == ((double) ((max (var_1_14 , (var_1_15 + var_1_16))) - (var_1_17 + var_1_18)))) : (var_1_11 == ((double) var_1_17)))
;
}
int main(void) {
	isInitial = 1;
