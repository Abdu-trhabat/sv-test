...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch105Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
   ...
   var_1_42
             ...
             if ( ((var_1_40) < (var_1_43))) {
              var_1_51 = (
               ((((((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45)))) < 0 ) ? -(((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45)))) : (((((var_1_45) < 0 ) ? -(var_1_45) : (var_1_45))))))
  );
 }
                              if (var_1_2) {
                               var_1_6 = (
   ...
   var_1_46
             ...
             if ( (( ((var_1_43) / (var_1_48))) < ( ((((var_1_44) < 0 ) ? -(var_1_44) : (var_1_44)))))) {
