...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch41functionizing.c", 13, "reach_error"); }
...
void functionized3(unsigned short int, float);
void functionized4(float, float, float, float, float, float);
...
void functionized0(float functionized0_localFunctionVar0) {
 if ((- functionized0_localFunctionVar0) > 31.9f) {
...
void functionized3(unsigned short int functionized3_localFunctionVar0, float functionized3_localFunctionVar1) {
 if (var_1_10 >= functionized3_localFunctionVar0) {
  var_1_17 = functionized3_localFunctionVar1;
 }
}
void functionized4(float functionized4_localFunctionVar0, float functionized4_localFunctionVar1, float functionized4_localFunctionVar2, float functionized4_localFunctionVar3, float functionized4_localFunctionVar4, float localFunctionVar5) {
 if (var_1_1 || (functionized4_localFunctionVar3 == var_1_2)) {
  if (((functionized4_localFunctionVar0 - var_1_20) - functionized4_localFunctionVar2) > var_1_2) {
   var_1_18 = ((((functionized4_localFunctionVar3) > (((((var_1_20) < (functionized4_localFunctionVar1)) ? (var_1_20) : (functionized4_localFunctionVar1))))) ? (functionized4_localFunctionVar3) : (((((var_1_20) < (functionized4_localFunctionVar1)) ? (var_1_20) : (functionized4_localFunctionVar1))))));
  } else {
   var_1_18 = (((((var_1_20) < (((((var_1_23) < (var_1_24)) ? (var_1_23) : (var_1_24))))) ? (var_1_20) : (((((var_1_23) < (var_1_24)) ? (var_1_23) : (var_1_24)))))) - functionized4_localFunctionVar4);
  }
 } else {
  var_1_18 = localFunctionVar5;
 }
}
void initially(void) {
}
void step(void) {
 ...
 functionized3(var_1_15, var_1_14);
 functionized4(var_1_19, var_1_22, var_1_21, var_1_14, var_1_25, 5.75f);
}
void updateVariables(void) {
