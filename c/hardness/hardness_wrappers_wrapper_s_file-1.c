...
void step(void) {
	...
	if (WrapperStruct00.var_1_5) {
		WrapperStruct00.var_1_10 = ((WrapperStruct00.var_1_11 - WrapperStruct00.var_1_12) + ((min (WrapperStruct00.var_1_13 , 8)) + (abs (WrapperStruct00.var_1_14))));
	}


	// From: Req5Batch1Wrapper_S
	signed long int stepLocal_0 = WrapperStruct00.var_1_7;
	if ((min (WrapperStruct00.var_1_8 , WrapperStruct00.var_1_7)) > stepLocal_0) {
		WrapperStruct00.var_1_16 = (min ((max (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_7)) , WrapperStruct00.var_1_12));
	} else {
		WrapperStruct00.var_1_16 = (min (WrapperStruct00.var_1_11 , WrapperStruct00.var_1_13));
	}


	// From: Req6Batch1Wrapper_S
	WrapperStruct00.var_1_17 = WrapperStruct00.var_1_4;


	// From: Req7Batch1Wrapper_S
...
int property(void) {
	return (((((((WrapperStruct00.var_1_18 <= (- WrapperStruct00.var_1_17)) ? (WrapperStruct00.var_1_1 == ((float) (abs (WrapperStruct00.var_1_4)))) : (WrapperStruct00.var_1_5 ? (WrapperStruct00.var_1_1 == ((float) WrapperStruct00.var_1_4)) : (WrapperStruct00.var_1_1 == ((float) WrapperStruct00.var_1_6)))) && (WrapperStruct00.var_1_7 == ((signed long int) (WrapperStruct00.var_1_8 + WrapperStruct00.var_1_9)))) && (WrapperStruct00.var_1_5 ? (WrapperStruct00.var_1_10 == ((unsigned char) ((WrapperStruct00.var_1_11 - WrapperStruct00.var_1_12) + ((min (WrapperStruct00.var_1_13 , 8)) + (abs (WrapperStruct00.var_1_14)))))) : 1)) && ((WrapperStruct00.var_1_17 < 1.25f) ? (WrapperStruct00.var_1_15 == ((signed char) WrapperStruct00.var_1_13)) : 1)) && (((min (WrapperStruct00.var_1_8 , WrapperStruct00.var_1_7)) > WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_16 == ((unsigned long int) (min ((max (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_7)) , WrapperStruct00.var_1_12)))) : (WrapperStruct00.var_1_16 == ((unsigned long int) (min (WrapperStruct00.var_1_11 , WrapperStruct00.var_1_13)))))) && (WrapperStruct00.var_1_17 == ((double) WrapperStruct00.var_1_4))) && (WrapperStruct00.var_1_18 == ((double) WrapperStruct00.var_1_6))
;
}
int main(void) {
	isInitial = 1;
