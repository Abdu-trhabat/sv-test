...
void step(void) {
	...
	if (! (signed_long_int_Array_0[3] >= signed_long_int_Array_0[2])) {
		if ((BOOL_unsigned_char_Array_0[2] || BOOL_unsigned_char_Array_0[1]) && stepLocal_0) {
			signed_long_int_Array_0[4] = (min (signed_long_int_Array_0[1] , signed_long_int_Array_0[0]));
		} else {
	...
	if (stepLocal_2 && BOOL_unsigned_char_Array_0[2]) {
		if (stepLocal_1 || (signed_long_int_Array_0[1] == signed_long_int_Array_0[4])) {
			signed_char_Array_0[1] = (min (signed_char_Array_0[3] , signed_char_Array_0[4]));
		}
	} else {
	...
	signed long int stepLocal_4 = (max (signed_char_Array_0[2] , signed_char_Array_0[6])) << (max (unsigned_long_int_Array_0[0] , unsigned_long_int_Array_0[1]));
...
int property(void) {
	return (((! (signed_long_int_Array_0[3] >= signed_long_int_Array_0[2])) ? (((BOOL_unsigned_char_Array_0[2] || BOOL_unsigned_char_Array_0[1]) && BOOL_unsigned_char_Array_0[0]) ? (signed_long_int_Array_0[4] == ((signed long int) (min (signed_long_int_Array_0[1] , signed_long_int_Array_0[0])))) : (signed_long_int_Array_0[4] == ((signed long int) signed_long_int_Array_0[0]))) : (signed_long_int_Array_0[4] == ((signed long int) signed_long_int_Array_0[0]))) && ((BOOL_unsigned_char_Array_0[1] && BOOL_unsigned_char_Array_0[2]) ? ((BOOL_unsigned_char_Array_0[0] || (signed_long_int_Array_0[1] == signed_long_int_Array_0[4])) ? (signed_char_Array_0[1] == ((signed char) (min (signed_char_Array_0[3] , signed_char_Array_0[4])))) : 1) : (signed_char_Array_0[1] == ((signed char) (signed_char_Array_0[0] - signed_char_Array_0[2]))))) && ((signed_char_Array_0[0] < ((max (signed_char_Array_0[2] , signed_char_Array_0[6])) << (max (unsigned_long_int_Array_0[0] , unsigned_long_int_Array_0[1])))) ? (signed_char_Array_0[5] == ((signed char) (unsigned_long_int_Array_0[1] - 64))) : (((unsigned_char_Array_0[0] - unsigned_long_int_Array_0[0]) == signed_long_int_Array_0[4]) ? (signed_char_Array_0[5] == ((signed char) unsigned_long_int_Array_0[0])) : (signed_char_Array_0[5] == ((signed char) signed_char_Array_0[4]))))
;
}
int main(void) {
	isInitial = 1;
