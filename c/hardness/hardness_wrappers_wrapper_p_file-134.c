...
void step(void) {
	// From: Req1Batch134Wrapper_P
	unsigned char stepLocal_0 = (*(var_1_2_Pointer));
	if (stepLocal_0 > (*(var_1_3_Pointer))) {
		if (((min ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) - 8.88) < (*(var_1_6_Pointer))) {
			(*(var_1_1_Pointer)) = ((*(var_1_7_Pointer)) - ((*(var_1_8_Pointer)) - (abs ((*(var_1_9_Pointer))))));
		} else {
	...
	// From: Req2Batch134Wrapper_P
	if ((*(var_1_1_Pointer)) >= (*(var_1_11_Pointer))) {
		if (((*(var_1_3_Pointer)) - (*(var_1_2_Pointer))) >= (*(var_1_12_Pointer))) {
			(*(var_1_10_Pointer)) = (((*(var_1_13_Pointer)) - (max ((*(var_1_2_Pointer)) , (*(var_1_3_Pointer))))) - (*(var_1_14_Pointer)));
		}
	} else {
	...
	// From: Req3Batch134Wrapper_P
	unsigned long int stepLocal_1 = (*(var_1_10_Pointer));
	if (! (*(var_1_16_Pointer))) {
		(*(var_1_15_Pointer)) = (max ((200.5f - 4.25f) , (*(var_1_8_Pointer))));
	} else {
		if ((max ((*(var_1_14_Pointer)) , (*(var_1_13_Pointer)))) >= stepLocal_1) {
...
int property(void) {
	return ((((*(var_1_2_Pointer)) > (*(var_1_3_Pointer))) ? ((((min ((*(var_1_4_Pointer)) , (*(var_1_5_Pointer)))) - 8.88) < (*(var_1_6_Pointer))) ? ((*(var_1_1_Pointer)) == ((double) ((*(var_1_7_Pointer)) - ((*(var_1_8_Pointer)) - (abs ((*(var_1_9_Pointer)))))))) : ((*(var_1_1_Pointer)) == ((double) (*(var_1_7_Pointer))))) : ((*(var_1_1_Pointer)) == ((double) (*(var_1_9_Pointer))))) && (((*(var_1_1_Pointer)) >= (*(var_1_11_Pointer))) ? ((((*(var_1_3_Pointer)) - (*(var_1_2_Pointer))) >= (*(var_1_12_Pointer))) ? ((*(var_1_10_Pointer)) == ((unsigned long int) (((*(var_1_13_Pointer)) - (max ((*(var_1_2_Pointer)) , (*(var_1_3_Pointer))))) - (*(var_1_14_Pointer))))) : 1) : ((*(var_1_10_Pointer)) == ((unsigned long int) (*(var_1_13_Pointer)))))) && ((! (*(var_1_16_Pointer))) ? ((*(var_1_15_Pointer)) == ((float) (max ((200.5f - 4.25f) , (*(var_1_8_Pointer)))))) : (((max ((*(var_1_14_Pointer)) , (*(var_1_13_Pointer)))) >= (*(var_1_10_Pointer))) ? ((*(var_1_15_Pointer)) == ((float) (*(var_1_9_Pointer)))) : ((*(var_1_15_Pointer)) == ((float) (*(var_1_8_Pointer))))))
;
}
int main(void) {
	isInitial = 1;
