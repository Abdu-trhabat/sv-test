...
void step(void) {
 (*(var_1_1_Pointer)) = (((((((1) < ((*(var_1_2_Pointer)))) ? (1) : ((*(var_1_2_Pointer))))) < 0 ) ? -((((1) < ((*(var_1_2_Pointer)))) ? (1) : ((*(var_1_2_Pointer))))) : ((((1) < ((*(var_1_2_Pointer)))) ? (1) : ((*(var_1_2_Pointer)))))));
 if ((*(var_1_4_Pointer)) < (*(var_1_5_Pointer))) {
  (*(var_1_3_Pointer)) = ((((((*(var_1_1_Pointer))) < 0 ) ? -((*(var_1_1_Pointer))) : ((*(var_1_1_Pointer))))) + (*(var_1_2_Pointer)));
 } else {
  (*(var_1_3_Pointer)) = (*(var_1_2_Pointer));
 }
 if ((*(var_1_4_Pointer)) >= (*(var_1_5_Pointer))) {
  (*(var_1_6_Pointer)) = ((((7.8) < (((*(var_1_7_Pointer)) - (*(var_1_8_Pointer))))) ? (7.8) : (((*(var_1_7_Pointer)) - (*(var_1_8_Pointer))))));
 }
 ...
 if ((*(var_1_10_Pointer)) || stepLocal_0) {
  ...
  if ((*(var_1_2_Pointer)) < stepLocal_1) {
   (*(var_1_9_Pointer)) = ((((((*(var_1_2_Pointer)) - ((*(var_1_12_Pointer)) - (*(var_1_3_Pointer))))) < (((*(var_1_13_Pointer)) - ((*(var_1_14_Pointer)) - (*(var_1_15_Pointer)))))) ? (((*(var_1_2_Pointer)) - ((*(var_1_12_Pointer)) - (*(var_1_3_Pointer))))) : (((*(var_1_13_Pointer)) - ((*(var_1_14_Pointer)) - (*(var_1_15_Pointer)))))));
  }
 }
...
int property(void) {
 return (((((*(var_1_1_Pointer)) == ((unsigned char) (((((((1) < ((*(var_1_2_Pointer)))) ? (1) : ((*(var_1_2_Pointer))))) < 0 ) ? -((((1) < ((*(var_1_2_Pointer)))) ? (1) : ((*(var_1_2_Pointer))))) : ((((1) < ((*(var_1_2_Pointer)))) ? (1) : ((*(var_1_2_Pointer))))))))) && (((*(var_1_4_Pointer)) < (*(var_1_5_Pointer))) ? ((*(var_1_3_Pointer)) == ((unsigned long int) ((((((*(var_1_1_Pointer))) < 0 ) ? -((*(var_1_1_Pointer))) : ((*(var_1_1_Pointer))))) + (*(var_1_2_Pointer))))) : ((*(var_1_3_Pointer)) == ((unsigned long int) (*(var_1_2_Pointer)))))) && (((*(var_1_4_Pointer)) >= (*(var_1_5_Pointer))) ? ((*(var_1_6_Pointer)) == ((double) ((((7.8) < (((*(var_1_7_Pointer)) - (*(var_1_8_Pointer))))) ? (7.8) : (((*(var_1_7_Pointer)) - (*(var_1_8_Pointer)))))))) : 1)) && (((*(var_1_10_Pointer)) || (*(var_1_11_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed long int) 128)) : (((*(var_1_2_Pointer)) < (*(var_1_3_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed long int) ((((((*(var_1_2_Pointer)) - ((*(var_1_12_Pointer)) - (*(var_1_3_Pointer))))) < (((*(var_1_13_Pointer)) - ((*(var_1_14_Pointer)) - (*(var_1_15_Pointer)))))) ? (((*(var_1_2_Pointer)) - ((*(var_1_12_Pointer)) - (*(var_1_3_Pointer))))) : (((*(var_1_13_Pointer)) - ((*(var_1_14_Pointer)) - (*(var_1_15_Pointer))))))))) : 1))) && (((*(var_1_3_Pointer)) > ((*(var_1_14_Pointer)) % ((*(var_1_17_Pointer)) - (*(var_1_12_Pointer))))) ? ((*(var_1_16_Pointer)) == ((float) (*(var_1_7_Pointer)))) : 1)
;
}
int main(void) {
 isInitial = 1;
