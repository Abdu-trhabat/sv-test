...
void step(void) {
	...
	// From: Req13Batch149Amount500
	if (var_1_29) {
		var_1_38 = (var_1_15 - (var_1_20 + var_1_22));
	} else {
		var_1_38 = (var_1_15 - ((abs (4)) + (max (var_1_20 , var_1_22))));
	}


	// From: Req15Batch149Amount500
	signed long int stepLocal_9 = var_1_19 - var_1_20;
	if (stepLocal_9 >= (min ((last_1_var_1_92 / var_1_22) , var_1_15))) {
		var_1_42 = -2;
	} else {
	...
	if (last_1_var_1_72 < (last_1_var_1_84 + var_1_53)) {
		if (last_1_var_1_21 || var_1_25) {
			if ((last_1_var_1_37 <= var_1_58) || (var_1_33 < last_1_var_1_75)) {
				var_1_62 = ((128.5f + var_1_11) - (min (var_1_10 , (abs (var_1_9)))));
			}
		} else {
			var_1_62 = (24.8f + 5.2f);
		}
	} else {
		if (((min (var_1_40 , var_1_63)) - var_1_15) >= last_1_var_1_75) {
			if (var_1_51 <= var_1_45) {
				var_1_62 = (var_1_11 - var_1_8);
			}
		} else {
			if ((var_1_10 - (var_1_11 + var_1_64)) > (- last_1_var_1_37)) {
				var_1_62 = (((max (var_1_10 , var_1_11)) - var_1_65) + var_1_48);
			} else {
				var_1_62 = var_1_47;
			}
		}
	...
	// From: Req32Batch149Amount500
	if (var_1_25) {
		if ((- (abs (last_1_var_1_37))) < var_1_9) {
			var_1_82 = (! var_1_61);
		} else {
			var_1_82 = var_1_27;
		}
	} else {
		if (last_1_var_1_62 > (abs (var_1_79))) {
			var_1_82 = (last_1_var_1_60 && (last_1_var_1_98 && var_1_61));
		}
	}


	// From: Req33Batch149Amount500
	...
	if (last_1_var_1_36) {
		if (stepLocal_17 <= ((var_1_63 - var_1_85) * last_1_var_1_75)) {
			var_1_84 = ((max (var_1_40 , (abs (var_1_87)))) - (2052788344u - var_1_67));
		} else {
			if (stepLocal_18 == var_1_52) {
				var_1_84 = ((var_1_80 + var_1_88) - (var_1_77 - (min (last_1_var_1_103 , var_1_22))));
			} else {
	...
	// From: Req28Batch149Amount500
	unsigned char stepLocal_15 = var_1_27;
	if (((var_1_84 / var_1_67) < var_1_41) || stepLocal_15) {
		var_1_72 = ((abs (var_1_15)) + var_1_67);
	} else {
		var_1_72 = (var_1_67 + var_1_20);
	}


	// From: Req30Batch149Amount500
	signed long int stepLocal_16 = ~ (var_1_67 * var_1_33);
	if (((- last_1_var_1_1) / var_1_76) < (var_1_8 - (var_1_10 + var_1_64))) {
		if ((var_1_11 - (min (var_1_65 , 128.1))) >= last_1_var_1_1) {
			if (last_1_var_1_102 < stepLocal_16) {
				var_1_75 = (max (last_1_var_1_66 , (last_1_var_1_39 + var_1_52)));
			}
		} else {
			var_1_75 = (last_1_var_1_75 + (max ((var_1_77 - var_1_45) , var_1_68)));
		}
	} else {
		if ((var_1_65 + last_1_var_1_94) == ((var_1_79 - var_1_11) - var_1_10)) {
			var_1_75 = ((var_1_77 + var_1_80) - var_1_22);
		} else {
			var_1_75 = (min ((min ((min (var_1_15 , var_1_71)) , var_1_77)) , var_1_20));
		}
	}


	// From: Req2Batch149Amount500
	var_1_13 = (max ((var_1_14 + (32 - var_1_15)) , var_1_16));


	// From: Req3Batch149Amount500
	unsigned char stepLocal_3 = var_1_84 >= (abs (var_1_84));
	if (((var_1_15 + var_1_39) > var_1_16) && stepLocal_3) {
		var_1_17 = (max (-1 , (min ((abs (64)) , 0))));
	}


	// From: Req6Batch149Amount500
	if (var_1_16 > (abs (var_1_15))) {
		var_1_28 = (var_1_22 + (min (var_1_14 , var_1_20)));
	}


	// From: Req10Batch149Amount500
	var_1_35 = (var_1_10 + 5.25f);


	// From: Req12Batch149Amount500
	var_1_37 = (var_1_10 + 200.5);


	// From: Req20Batch149Amount500
	unsigned long int stepLocal_12 = var_1_52 + var_1_84;
	if (((57225 - var_1_15) / var_1_22) >= stepLocal_12) {
		var_1_54 = (max (var_1_19 , var_1_50));
	} else {
		var_1_54 = (25 + -10);
	}


	// From: Req38Batch149Amount500
	var_1_95 = 0;


	// From: Req39Batch149Amount500
	var_1_96 = var_1_45;


	// From: Req40Batch149Amount500
	var_1_97 = var_1_6;


	// From: Req41Batch149Amount500
	if (last_1_var_1_98) {
		var_1_98 = var_1_61;
	}


	// From: Req45Batch149Amount500
	var_1_102 = -128;


	// From: Req46Batch149Amount500
	if (var_1_25) {
		var_1_103 = var_1_22;
	}


	// From: Req47Batch149Amount500
	if (var_1_98) {
		var_1_104 = var_1_6;
	} else {
		var_1_104 = var_1_64;
	...
	// From: Req8Batch149Amount500
	unsigned char stepLocal_7 = var_1_95;
	unsigned long int stepLocal_6 = min (var_1_84 , var_1_19);
	...
	if (stepLocal_7 && ((var_1_8 - var_1_9) < (var_1_37 * var_1_104))) {
		if (stepLocal_5 && (var_1_104 > var_1_5)) {
			if (4 <= stepLocal_6) {
				...
				var_1_32 = (min (var_1_15 , var_1_17));
			}
		}
	} else {
		var_1_32 = (abs (var_1_20 - var_1_15));
	}


	// From: Req9Batch149Amount500
	if (var_1_9 >= var_1_6) {
		var_1_34 = var_1_103;
	} else {
	...
	// From: Req18Batch149Amount500
	if (! var_1_60) {
		var_1_46 = ((var_1_47 + var_1_48) + (abs (var_1_10 - var_1_11)));
	}


	// From: Req21Batch149Amount500
	if ((- var_1_104) == (0.8f * (var_1_37 * var_1_47))) {
		var_1_55 = (min (var_1_50 , (max (-10 , var_1_20))));
	} else {
		var_1_55 = (abs (var_1_19));
	}


	// From: Req23Batch149Amount500
	if (var_1_6 == (- (max (var_1_47 , var_1_104)))) {
		var_1_57 = var_1_58;
	}


	// From: Req27Batch149Amount500
		...
		if (! var_1_95) {
			if (var_1_58 < var_1_9) {
				if (stepLocal_13 == (var_1_103 + var_1_45)) {
					...
					var_1_66 = (var_1_71 - (min (var_1_20 , 5)));
				}
			} else {
				var_1_66 = (abs (var_1_15));
			}
		} else {
	...
	// From: Req29Batch149Amount500
	if (((min (var_1_64 , var_1_57)) + var_1_8) <= var_1_10) {
		var_1_73 = (var_1_74 + var_1_52);
	} else {
		var_1_73 = ((min (var_1_50 , var_1_53)) + var_1_74);
	}


	// From: Req37Batch149Amount500
	...
	if ((var_1_43 <= (~ var_1_38)) && stepLocal_11) {
		...
		var_1_49 = (max (var_1_20 , var_1_50));
	}


	// From: Req22Batch149Amount500
	var_1_56 = var_1_66;


	// From: Req31Batch149Amount500
	if (var_1_43 > (var_1_14 + var_1_72)) {
		if (var_1_102 == (last_1_var_1_81 + var_1_51)) {
			if (var_1_43 <= var_1_75) {
				var_1_81 = (abs (abs (last_1_var_1_81)));
			} else {
				var_1_81 = (((min (var_1_45 , var_1_22)) + (10000 - var_1_52)) - var_1_15);
			}
		}
	}


	// From: Req36Batch149Amount500
	if ((min (var_1_20 , (var_1_85 + var_1_68))) >= var_1_39) {
		if (var_1_95) {
			if (var_1_94 <= var_1_11) {
				var_1_93 = (var_1_50 + var_1_53);
			} else {
				var_1_93 = (min (var_1_52 , var_1_51));
			}
		} else {
			var_1_93 = var_1_19;
		}
		...
		if ((-128 + (var_1_19 / -1)) < ((var_1_42 + var_1_44) * var_1_39)) {
			var_1_93 = (max (var_1_74 , var_1_51));
		} else {
	...
	// From: Req34Batch149Amount500
	if (var_1_23) {
		if (var_1_41 >= ((max (var_1_42 , var_1_80)) + var_1_75)) {
			var_1_89 = var_1_47;
		} else {
			if (((var_1_84 + var_1_43) * 4) > (min (var_1_75 , var_1_39))) {
				var_1_89 = (((max (var_1_10 , var_1_11)) - var_1_65) + var_1_47);
			} else {
	...
	// From: Req11Batch149Amount500
	signed long int stepLocal_8 = min (var_1_92 , var_1_33);
	...
	if (var_1_75 <= stepLocal_0) {
		if (var_1_82) {
			if (stepLocal_1 == (max (1000000000 , var_1_84))) {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((var_1_75 <= var_1_84) ? (var_1_82 ? ((var_1_75 == (max (1000000000 , var_1_84))) ? (var_1_1 == ((float) (abs (min (var_1_5 , 3.7f))))) : 1) : (var_1_1 == ((float) (max ((abs (var_1_5)) , var_1_6))))) : ((var_1_6 <= var_1_5) ? ((var_1_106 >= var_1_84) ? (var_1_1 == ((float) (var_1_8 - var_1_9))) : (var_1_1 == ((float) (var_1_8 - (max ((var_1_10 + var_1_11) , 64.5f)))))) : (var_1_21 ? (var_1_1 == ((float) (min (var_1_10 , var_1_8)))) : 1))) && (var_1_13 == ((signed short int) (max ((var_1_14 + (32 - var_1_15)) , var_1_16))))) && ((((var_1_15 + var_1_39) > var_1_16) && (var_1_84 >= (abs (var_1_84)))) ? (var_1_17 == ((signed char) (max (-1 , (min ((abs (64)) , 0)))))) : 1)) && ((var_1_8 <= (15.9f + (var_1_9 * var_1_11))) ? ((! var_1_21) ? (var_1_18 == ((signed char) ((min (var_1_19 , 10)) - var_1_20))) : (var_1_18 == ((signed char) var_1_20))) : 1)) && (((var_1_22 - var_1_20) != var_1_106) ? (var_1_21 == ((unsigned char) ((var_1_36 || (var_1_95 || var_1_23)) && ((var_1_24 && var_1_25) && (var_1_98 || var_1_27))))) : 1)) && ((var_1_16 > (abs (var_1_15))) ? (var_1_28 == ((signed short int) (var_1_22 + (min (var_1_14 , var_1_20))))) : 1)) && ((last_1_var_1_37 >= 199.5f) ? (((var_1_6 <= var_1_9) && last_1_var_1_36) ? ((var_1_20 < (64 << last_1_var_1_42)) ? ((var_1_11 <= var_1_6) ? (var_1_29 == ((unsigned char) 0)) : ((var_1_11 > last_1_var_1_104) ? (var_1_29 == ((unsigned char) ((! var_1_31) && (var_1_27 && var_1_23)))) : (var_1_29 == ((unsigned char) ((var_1_22 < last_1_var_1_38) && var_1_31))))) : ((var_1_9 >= var_1_5) ? (var_1_29 == ((unsigned char) ((128 > var_1_19) && var_1_31))) : (var_1_29 == ((unsigned char) var_1_31)))) : 1) : (var_1_29 == ((unsigned char) var_1_31)))) && ((var_1_95 && ((var_1_8 - var_1_9) < (var_1_37 * var_1_104))) ? ((var_1_24 && (var_1_104 > var_1_5)) ? ((4 <= (min (var_1_84 , var_1_19))) ? (var_1_32 == ((signed short int) (var_1_33 + var_1_20))) : (var_1_32 == ((signed short int) (min (var_1_15 , var_1_17))))) : 1) : (var_1_32 == ((signed short int) (abs (var_1_20 - var_1_15)))))) && ((var_1_9 >= var_1_6) ? (var_1_34 == ((signed long int) var_1_103)) : (var_1_34 == ((signed long int) last_1_var_1_34)))) && (var_1_35 == ((float) (var_1_10 + 5.25f)))) && ((var_1_43 <= (min (var_1_92 , var_1_33))) ? ((! var_1_25) ? (((- var_1_9) > (- var_1_62)) ? (var_1_36 == ((unsigned char) ((var_1_24 && var_1_27) && var_1_25))) : 1) : 1) : (var_1_36 == ((unsigned char) (! var_1_25))))) && (var_1_37 == ((double) (var_1_10 + 200.5)))) && (var_1_29 ? (var_1_38 == ((signed short int) (var_1_15 - (var_1_20 + var_1_22)))) : (var_1_38 == ((signed short int) (var_1_15 - ((abs (4)) + (max (var_1_20 , var_1_22)))))))) && (((var_1_8 + 9.4f) >= last_1_var_1_89) ? ((last_1_var_1_66 <= last_1_var_1_75) ? (var_1_39 == ((unsigned long int) (var_1_40 - (abs (32u))))) : (var_1_39 == ((unsigned long int) var_1_20))) : (var_1_39 == ((unsigned long int) (var_1_40 - var_1_41))))) && (((var_1_19 - var_1_20) >= (min ((last_1_var_1_92 / var_1_22) , var_1_15))) ? (var_1_42 == ((signed long int) -2)) : (var_1_42 == ((signed long int) last_1_var_1_59)))) && (((- var_1_8) > var_1_37) ? (var_1_43 == ((signed long int) (2 - var_1_66))) : (var_1_43 == ((signed long int) ((var_1_22 + var_1_20) - var_1_66))))) && ((! (! var_1_23)) ? ((var_1_39 != -100) ? ((var_1_84 != (var_1_16 * (var_1_15 + var_1_92))) ? (var_1_44 == ((signed char) (abs (var_1_20)))) : 1) : (var_1_44 == ((signed char) (var_1_20 - var_1_45)))) : (var_1_44 == ((signed char) var_1_20)))) && ((! var_1_60) ? (var_1_46 == ((float) ((var_1_47 + var_1_48) + (abs (var_1_10 - var_1_11))))) : 1)) && (((var_1_43 <= (~ var_1_38)) && var_1_27) ? (((64 - var_1_20) >= var_1_38) ? (var_1_49 == ((signed char) (var_1_50 + ((var_1_51 - var_1_52) + var_1_53)))) : 1) : (var_1_49 == ((signed char) (max (var_1_20 , var_1_50)))))) && ((((57225 - var_1_15) / var_1_22) >= (var_1_52 + var_1_84)) ? (var_1_54 == ((signed char) (max (var_1_19 , var_1_50)))) : (var_1_54 == ((signed char) (25 + -10))))) && (((- var_1_104) == (0.8f * (var_1_37 * var_1_47))) ? (var_1_55 == ((signed char) (min (var_1_50 , (max (-10 , var_1_20)))))) : (var_1_55 == ((signed char) (abs (var_1_19)))))) && (var_1_56 == ((signed short int) var_1_66))) && ((var_1_6 == (- (max (var_1_47 , var_1_104)))) ? (var_1_57 == ((float) var_1_58)) : 1)) && ((! var_1_36) ? ((! ((var_1_50 / var_1_22) <= var_1_42)) ? (var_1_59 == ((signed char) (var_1_51 - (64 - var_1_52)))) : 1) : (var_1_59 == ((signed char) (max (var_1_19 , var_1_52)))))) && (var_1_24 ? ((var_1_10 < var_1_35) ? (var_1_60 == ((unsigned char) (! (var_1_82 && (var_1_31 || var_1_61))))) : (var_1_60 == ((unsigned char) ((var_1_52 < var_1_45) && ((var_1_20 != var_1_16) && var_1_31))))) : (var_1_60 == ((unsigned char) (! var_1_61))))) && ((last_1_var_1_72 < (last_1_var_1_84 + var_1_53)) ? ((last_1_var_1_21 || var_1_25) ? (((last_1_var_1_37 <= var_1_58) || (var_1_33 < last_1_var_1_75)) ? (var_1_62 == ((float) ((128.5f + var_1_11) - (min (var_1_10 , (abs (var_1_9))))))) : 1) : (var_1_62 == ((float) (24.8f + 5.2f)))) : ((((min (var_1_40 , var_1_63)) - var_1_15) >= last_1_var_1_75) ? ((var_1_51 <= var_1_45) ? (var_1_62 == ((float) (var_1_11 - var_1_8))) : 1) : (((var_1_10 - (var_1_11 + var_1_64)) > (- last_1_var_1_37)) ? (var_1_62 == ((float) (((max (var_1_10 , var_1_11)) - var_1_65) + var_1_48))) : (var_1_62 == ((float) var_1_47)))))) && ((256u >= var_1_63) ? (var_1_66 == ((unsigned short int) ((64520 - (var_1_67 - var_1_22)) - var_1_68))) : ((! var_1_95) ? ((var_1_58 < var_1_9) ? ((var_1_28 == (var_1_103 + var_1_45)) ? (var_1_66 == ((unsigned short int) var_1_70)) : (var_1_66 == ((unsigned short int) (var_1_71 - (min (var_1_20 , 5)))))) : (var_1_66 == ((unsigned short int) (abs (var_1_15))))) : (var_1_66 == ((unsigned short int) (var_1_71 - (var_1_52 + var_1_15))))))) && ((((var_1_84 / var_1_67) < var_1_41) || var_1_27) ? (var_1_72 == ((unsigned short int) ((abs (var_1_15)) + var_1_67))) : (var_1_72 == ((unsigned short int) (var_1_67 + var_1_20))))) && ((((min (var_1_64 , var_1_57)) + var_1_8) <= var_1_10) ? (var_1_73 == ((signed char) (var_1_74 + var_1_52))) : (var_1_73 == ((signed char) ((min (var_1_50 , var_1_53)) + var_1_74))))) && ((((- last_1_var_1_1) / var_1_76) < (var_1_8 - (var_1_10 + var_1_64))) ? (((var_1_11 - (min (var_1_65 , 128.1))) >= last_1_var_1_1) ? ((last_1_var_1_102 < (~ (var_1_67 * var_1_33))) ? (var_1_75 == ((unsigned long int) (max (last_1_var_1_66 , (last_1_var_1_39 + var_1_52))))) : 1) : (var_1_75 == ((unsigned long int) (last_1_var_1_75 + (max ((var_1_77 - var_1_45) , var_1_68)))))) : (((var_1_65 + last_1_var_1_94) == ((var_1_79 - var_1_11) - var_1_10)) ? (var_1_75 == ((unsigned long int) ((var_1_77 + var_1_80) - var_1_22))) : (var_1_75 == ((unsigned long int) (min ((min ((min (var_1_15 , var_1_71)) , var_1_77)) , var_1_20))))))) && ((var_1_43 > (var_1_14 + var_1_72)) ? ((var_1_102 == (last_1_var_1_81 + var_1_51)) ? ((var_1_43 <= var_1_75) ? (var_1_81 == ((signed short int) (abs (abs (last_1_var_1_81))))) : (var_1_81 == ((signed short int) (((min (var_1_45 , var_1_22)) + (10000 - var_1_52)) - var_1_15)))) : 1) : 1)) && (var_1_25 ? (((- (abs (last_1_var_1_37))) < var_1_9) ? (var_1_82 == ((unsigned char) (! var_1_61))) : (var_1_82 == ((unsigned char) var_1_27))) : ((last_1_var_1_62 > (abs (var_1_79))) ? (var_1_82 == ((unsigned char) (last_1_var_1_60 && (last_1_var_1_98 && var_1_61)))) : 1))) && (last_1_var_1_36 ? ((128u <= ((var_1_63 - var_1_85) * last_1_var_1_75)) ? (var_1_84 == ((unsigned long int) ((max (var_1_40 , (abs (var_1_87)))) - (2052788344u - var_1_67)))) : (((var_1_70 % (var_1_63 - 256u)) == var_1_52) ? (var_1_84 == ((unsigned long int) ((var_1_80 + var_1_88) - (var_1_77 - (min (last_1_var_1_103 , var_1_22)))))) : (var_1_84 == ((unsigned long int) ((last_1_var_1_103 + var_1_52) + var_1_20))))) : (var_1_84 == ((unsigned long int) (var_1_70 + var_1_20))))) && (var_1_23 ? ((var_1_41 >= ((max (var_1_42 , var_1_80)) + var_1_75)) ? (var_1_89 == ((float) var_1_47)) : ((((var_1_84 + var_1_43) * 4) > (min (var_1_75 , var_1_39))) ? (var_1_89 == ((float) (((max (var_1_10 , var_1_11)) - var_1_65) + var_1_47))) : (var_1_89 == ((float) (var_1_9 - var_1_11))))) : 1)) && (((var_1_15 ^ var_1_80) >= var_1_84) ? ((var_1_75 != -32) ? (var_1_92 == ((signed short int) (max (200 , var_1_74)))) : (var_1_92 == ((signed short int) last_1_var_1_92))) : 1)) && (((min (var_1_20 , (var_1_85 + var_1_68))) >= var_1_39) ? (var_1_95 ? ((var_1_94 <= var_1_11) ? (var_1_93 == ((signed char) (var_1_50 + var_1_53))) : (var_1_93 == ((signed char) (min (var_1_52 , var_1_51))))) : (var_1_93 == ((signed char) var_1_19))) : (((-128 + (var_1_19 / -1)) < ((var_1_42 + var_1_44) * var_1_39)) ? (var_1_93 == ((signed char) (max (var_1_74 , var_1_51)))) : (var_1_93 == ((signed char) (abs (var_1_20))))))) && ((var_1_31 && var_1_95) ? ((var_1_34 <= var_1_13) ? (((var_1_71 - var_1_45) >= var_1_19) ? (var_1_94 == ((double) var_1_9)) : 1) : (var_1_94 == ((double) var_1_9))) : (var_1_94 == ((double) var_1_48)))) && (var_1_95 == ((unsigned char) 0))) && (var_1_96 == ((unsigned char) var_1_45))) && (var_1_97 == ((float) var_1_6))) && (last_1_var_1_98 ? (var_1_98 == ((unsigned char) var_1_61)) : 1)) && (var_1_36 ? (var_1_99 == ((unsigned char) 4)) : (var_1_99 == ((unsigned char) 8)))) && (var_1_60 ? (var_1_100 == ((signed char) var_1_51)) : (var_1_100 == ((signed char) var_1_52)))) && (var_1_36 ? (var_1_101 == ((signed char) var_1_52)) : (var_1_101 == ((signed char) var_1_51)))) && (var_1_102 == ((signed short int) -128))) && (var_1_25 ? (var_1_103 == ((unsigned short int) var_1_22)) : 1)) && (var_1_98 ? (var_1_104 == ((float) var_1_6)) : (var_1_104 == ((float) var_1_64)))) && (var_1_95 ? (var_1_105 == ((unsigned char) var_1_52)) : (var_1_105 == ((unsigned char) var_1_45)))) && ((var_1_85 < var_1_70) ? ((((min (var_1_72 , last_1_var_1_106)) > var_1_67) || var_1_82) ? ((var_1_64 > var_1_47) ? (var_1_106 == ((unsigned short int) var_1_20)) : 1) : 1) : (var_1_106 == ((unsigned short int) var_1_107)))
;
}
int main(void) {
	isInitial = 1;
