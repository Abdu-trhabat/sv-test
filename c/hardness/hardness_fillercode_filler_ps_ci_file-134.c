...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch134Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 247L, 83L) */ if (/* 248L, 50L, 51L) */ ((var_1_8) >= (var_1_20))) {
	...
	/* 291L, 176L) */ if (/* 292L, 128L, 129L) */ ((var_1_28) >= (/* 294L, 127L, 131L) */ (abs (var_1_30))))) {
		/* 296L, 174L) */ if (/* 297L, 140L, 141L) */ ((/* 298L, 138L, 142L) */ (- (var_1_24))) >= (var_1_22))) {
			/* 301L, 172L) */ if (/* 302L, 152L, 153L) */ ((var_1_20) <= (/* 304L, 151L, 155L) */ (~ (var_1_29))))) {
				/* 306L, 167L) */ var_1_36 = (
					/* 309L, 166L) */ (max (
						/* 309L, 166L) */ (
							/* 310L, 164L) */ (abs (
	...
	// From: Req7Batch134Filler_PS_CI
	/* 1010L, 270L, 794L, 800L) */ var_1_20 = (
		var_1_7
	);


	// From: Req8Batch134Filler_PS_CI
	/* 1016L, 280L, 818L, 824L) */ var_1_21 = (
		var_1_7
	);


	// From: Req4Batch134Filler_PS_CI
