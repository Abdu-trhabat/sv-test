...
int property(void) {
	return ((((var_1_2 < var_1_3) ? (var_1_1 == ((signed char) (max ((-32 + var_1_4) , (max (var_1_5 , var_1_6)))))) : (var_1_1 == ((signed char) ((1 - var_1_7) + var_1_4)))) && ((var_1_9 || ((var_1_7 / var_1_10) <= (var_1_6 * var_1_4))) ? (var_1_8 == ((signed short int) var_1_7)) : 1)) && (var_1_11 == ((unsigned char) (var_1_12 - var_1_7)))) && ((-100 >= var_1_4) ? ((var_1_2 > 63.5f) ? ((! ((64 >> var_1_14) >= var_1_5)) ? ((4 >= var_1_8) ? (var_1_13 == ((double) (max (var_1_15 , 10.2)))) : 1) : (var_1_13 == ((double) var_1_15))) : (var_1_13 == ((double) var_1_15))) : 1)
;
}
int main(void) {
	isInitial = 1;
