...
void step(void) {
	...
	if (var_1_33 < var_1_6) {
		if (var_1_40) {
			var_1_41 = ((max (var_1_21 , var_1_23)) - (last_1_var_1_37 + (min (var_1_20 , last_1_var_1_46))));
		} else {
			if (var_1_29 <= last_1_var_1_31) {
				...
				if (var_1_30 <= last_1_var_1_26) {
					...
					var_1_41 = (max (((max (1 , var_1_23)) - var_1_20) , ((abs (var_1_21)) - last_1_var_1_37)));
				}
			}
		}
	}
	...
	if (last_1_var_1_16 <= stepLocal_5) {
		var_1_16 = (min ((3682661553u - last_1_var_1_16) , var_1_11));
	} else {
		if ((~ last_1_var_1_16) > (min (last_1_var_1_16 , (var_1_11 - var_1_10)))) {
			var_1_16 = last_1_var_1_16;
		} else {
			var_1_16 = (min (last_1_var_1_16 , var_1_9));
		}
	}
	...
	if (var_1_6 < ((256.625f * var_1_7) * var_1_5)) {
		if (var_1_19 || var_1_2) {
			var_1_24 = ((-256 + var_1_22) + (var_1_20 - (max (var_1_23 , var_1_16))));
		} else {
			if (! var_1_19) {
	...
	signed long int stepLocal_10 = min (var_1_20 , -10);
	...
	unsigned long int stepLocal_15 = min (var_1_16 , (~ var_1_35));
	if (stepLocal_15 <= (var_1_21 / 128u)) {
		var_1_36 = (max (var_1_35 , (min ((min (var_1_23 , var_1_21)) , var_1_37))));
	}
	...
	if (var_1_5 >= var_1_6) {
		if (stepLocal_2 < var_1_16) {
			var_1_8 = (max ((var_1_16 + (max (var_1_36 , var_1_9))) , (var_1_10 + var_1_11)));
		} else {
	...
	if (var_1_16 < 4) {
		if ((max (var_1_16 , var_1_8)) != var_1_10) {
			var_1_46 = ((max (var_1_54 , var_1_23)) + var_1_20);
		} else {
			if (var_1_8 < var_1_10) {
				var_1_46 = (max ((max (var_1_20 , var_1_24)) , var_1_21));
			} else {
				var_1_46 = (max (var_1_39 , (52246 - var_1_54)));
			}
		}
	}
	...
	if (stepLocal_3 >= (10u / var_1_12)) {
		if (stepLocal_4 < (min (var_1_14 , var_1_8))) {
			var_1_13 = var_1_7;
		} else {
	...
	if (stepLocal_14 > (max ((var_1_8 + var_1_18) , var_1_22))) {
		var_1_34 = var_1_6;
	}
...
int property(void) {
	return (((((((((((((((((var_1_24 <= var_1_41) ? (var_1_1 == ((float) (var_1_5 - var_1_6))) : (var_1_1 == ((float) (10.5f + var_1_7)))) && ((var_1_5 >= var_1_6) ? ((var_1_36 < var_1_16) ? (var_1_8 == ((unsigned long int) (max ((var_1_16 + (max (var_1_36 , var_1_9))) , (var_1_10 + var_1_11))))) : (var_1_8 == ((unsigned long int) (var_1_11 + var_1_9)))) : ((var_1_11 > (var_1_16 / var_1_12)) ? (var_1_8 == ((unsigned long int) var_1_36)) : (var_1_8 == ((unsigned long int) (var_1_36 + (abs (var_1_10)))))))) && ((var_1_8 >= (10u / var_1_12)) ? ((var_1_10 < (min (var_1_14 , var_1_8))) ? (var_1_13 == ((float) var_1_7)) : (var_1_13 == ((float) (var_1_7 + var_1_15)))) : (var_1_13 == ((float) (max ((var_1_6 - var_1_5) , var_1_7)))))) && ((last_1_var_1_16 <= last_1_var_1_8) ? (var_1_16 == ((unsigned long int) (min ((3682661553u - last_1_var_1_16) , var_1_11)))) : (((~ last_1_var_1_16) > (min (last_1_var_1_16 , (var_1_11 - var_1_10)))) ? (var_1_16 == ((unsigned long int) last_1_var_1_16)) : (var_1_16 == ((unsigned long int) (min (last_1_var_1_16 , var_1_9))))))) && ((var_1_12 > var_1_9) ? (((var_1_16 / var_1_12) >= (16u | var_1_11)) ? ((var_1_2 && var_1_19) ? (var_1_18 == ((signed char) ((var_1_20 - var_1_21) + (var_1_22 + (16 - var_1_23))))) : 1) : (var_1_18 == ((signed char) (var_1_23 - var_1_20)))) : (var_1_2 ? (var_1_18 == ((signed char) (min (var_1_21 , (max ((10 + var_1_23) , 5)))))) : ((64 == (min (var_1_20 , -10))) ? (var_1_18 == ((signed char) (var_1_22 + var_1_21))) : ((! var_1_19) ? ((var_1_16 < var_1_20) ? (var_1_18 == ((signed char) var_1_20)) : (var_1_18 == ((signed char) var_1_23))) : 1))))) && ((var_1_6 < ((256.625f * var_1_7) * var_1_5)) ? ((var_1_19 || var_1_2) ? (var_1_24 == ((signed long int) ((-256 + var_1_22) + (var_1_20 - (max (var_1_23 , var_1_16)))))) : ((! var_1_19) ? ((((var_1_6 / var_1_25) > var_1_5) || var_1_2) ? (var_1_24 == ((signed long int) var_1_22)) : 1) : 1)) : 1)) && ((var_1_12 <= var_1_9) ? (var_1_38 ? ((var_1_22 < var_1_16) ? (var_1_26 == ((double) (var_1_7 + var_1_15))) : (var_1_26 == ((double) (min (var_1_15 , ((max (var_1_7 , var_1_27)) + var_1_28)))))) : (var_1_26 == ((double) (min (var_1_6 , var_1_27))))) : ((var_1_41 < var_1_11) ? (var_1_26 == ((double) (var_1_5 - (var_1_29 + var_1_30)))) : (var_1_26 == ((double) 49.2))))) && ((var_1_27 <= var_1_5) ? (((abs (-0.5)) >= var_1_30) ? (var_1_31 == ((double) (abs (var_1_30)))) : (((var_1_30 - (var_1_29 + var_1_32)) == var_1_28) ? (var_1_31 == ((double) (min ((max (var_1_32 , var_1_29)) , var_1_33)))) : (var_1_38 ? (var_1_31 == ((double) (var_1_6 - var_1_32))) : (var_1_31 == ((double) (max (var_1_32 , (min (var_1_27 , (abs (var_1_28))))))))))) : 1)) && ((var_1_21 > (max ((var_1_8 + var_1_18) , var_1_22))) ? (var_1_34 == ((float) var_1_6)) : 1)) && (((min (var_1_16 , (~ var_1_35))) <= (var_1_21 / 128u)) ? (var_1_36 == ((signed long int) (max (var_1_35 , (min ((min (var_1_23 , var_1_21)) , var_1_37)))))) : 1)) && ((var_1_2 || var_1_19) ? (var_1_2 ? (var_1_37 == ((signed short int) (abs (last_1_var_1_41)))) : 1) : 1)) && ((var_1_37 == (var_1_8 - (var_1_39 - var_1_23))) ? (var_1_38 == ((unsigned char) (var_1_19 && var_1_40))) : (var_1_38 == ((unsigned char) var_1_40)))) && ((var_1_33 < var_1_6) ? (var_1_40 ? (var_1_41 == ((signed short int) ((max (var_1_21 , var_1_23)) - (last_1_var_1_37 + (min (var_1_20 , last_1_var_1_46)))))) : ((var_1_29 <= last_1_var_1_31) ? (var_1_41 == ((signed short int) (var_1_23 + (last_1_var_1_46 - last_1_var_1_37)))) : ((var_1_30 <= last_1_var_1_26) ? (var_1_41 == ((signed short int) last_1_var_1_37)) : (var_1_41 == ((signed short int) (max (((max (1 , var_1_23)) - var_1_20) , ((abs (var_1_21)) - last_1_var_1_37)))))))) : 1)) && (var_1_38 ? (((var_1_11 * 8) < ((var_1_10 / 50u) << var_1_24)) ? (var_1_42 == ((float) ((max ((var_1_44 + var_1_45) , var_1_29)) + var_1_15))) : 1) : ((var_1_22 < var_1_36) ? (var_1_42 == ((float) (var_1_28 + var_1_44))) : (var_1_42 == ((float) (var_1_29 + var_1_44)))))) && ((var_1_16 < 4) ? (((max (var_1_16 , var_1_8)) != var_1_10) ? (var_1_46 == ((unsigned short int) ((max (var_1_54 , var_1_23)) + var_1_20))) : ((var_1_8 < var_1_10) ? (var_1_46 == ((unsigned short int) (max ((max (var_1_20 , var_1_24)) , var_1_21)))) : (var_1_46 == ((unsigned short int) (max (var_1_39 , (52246 - var_1_54))))))) : 1)) && (var_1_38 ? (var_1_38 ? (var_1_38 ? (var_1_48 == ((signed char) (abs (var_1_22)))) : (var_1_48 == ((signed char) ((var_1_20 + var_1_21) - (var_1_50 - (var_1_23 + var_1_51)))))) : (var_1_48 == ((signed char) (((var_1_52 - var_1_23) - (var_1_51 + var_1_53)) + var_1_21)))) : ((var_1_54 > var_1_21) ? (var_1_48 == ((signed char) (((abs (-10)) + var_1_53) - var_1_50))) : (var_1_48 == ((signed char) (var_1_21 + var_1_52)))))) && ((var_1_19 || var_1_49) ? (((var_1_12 | (var_1_53 * var_1_20)) > (var_1_23 * (- var_1_16))) ? (var_1_40 ? (var_1_54 == ((signed short int) var_1_53)) : (var_1_54 == ((signed short int) var_1_24))) : (var_1_54 == ((signed short int) var_1_51))) : 1)
;
}
int main(void) {
	isInitial = 1;
