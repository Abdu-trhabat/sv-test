...
void step(void) {
	...
	// From: Req4Batch18450_while
	if (var_1_14 <= (max (var_1_13 , (var_1_18 - var_1_19)))) {
		var_1_17 = var_1_6;
	}


	// From: Req1Batch18450_while
