...
void step(void) {
	...
	if ((*(var_1_3_Pointer)) < (*(var_1_2_Pointer))) {
		...
		(*(var_1_7_Pointer)) = (max (-4 , ((max (128 , (*(var_1_2_Pointer)))) - (*(var_1_9_Pointer)))));
	}


	// From: Req3Batch172Wrapper_P
	(*(var_1_11_Pointer)) = (min ((*(var_1_12_Pointer)) , (*(var_1_13_Pointer))));


	// From: Req4Batch172Wrapper_P
	unsigned char stepLocal_0 = (*(var_1_5_Pointer));
	if (stepLocal_0 && ((*(var_1_7_Pointer)) != (*(var_1_9_Pointer)))) {
		(*(var_1_14_Pointer)) = ((*(var_1_15_Pointer)) + (max (3.25f , (*(var_1_16_Pointer)))));
	}


	// From: Req5Batch172Wrapper_P
	(*(var_1_17_Pointer)) = (*(var_1_18_Pointer));


	// From: Req6Batch172Wrapper_P
	(*(var_1_19_Pointer)) = (*(var_1_5_Pointer));


	// From: Req7Batch172Wrapper_P
	(*(var_1_20_Pointer)) = (*(var_1_18_Pointer));


	// From: Req1Batch172Wrapper_P
