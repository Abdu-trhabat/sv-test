...
void step(void) {
	...
	if (stepLocal_0 <= last_1_unsigned_long_int_Array_0_0_) {
		if (! BOOL_unsigned_char_Array_0[2]) {
			signed_short_int_Array_0[1] = (abs (1 - signed_short_int_Array_0[0]));
		}
	} else {
	...
	if (stepLocal_1 && (! BOOL_unsigned_char_Array_0[1])) {
		...
		if (stepLocal_2 != unsigned_short_int_Array_0[0]) {
			unsigned_char_Array_0[4] = (min (unsigned_char_Array_0[1] , ((unsigned_char_Array_0[0] - unsigned_char_Array_0[2]) + unsigned_char_Array_0[3])));
		} else {
	...
	if (BOOL_unsigned_char_Array_0[2]) {
		if (BOOL_unsigned_char_Array_0[1] && stepLocal_4) {
			unsigned_long_int_Array_0[0] = (abs (abs (unsigned_char_Array_0[4] + unsigned_short_int_Array_0[0])));
		}
	} else {
