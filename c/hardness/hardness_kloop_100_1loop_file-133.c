...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch133100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req11Batch133100_1loop
	var_1_36 = var_1_24;


	// From: Req6Batch133100_1loop
	...
	// From: Req8Batch133100_1loop
	if (last_1_var_1_27) {
		var_1_31 = (var_1_10 + var_1_9);
	}


	// From: Req9Batch133100_1loop
