...
void step(void) {
	...
	// From: Req4Batch142Amount50
	if ((max (var_1_7 , var_1_8)) >= (var_1_11 >> var_1_14)) {
		var_1_13 = var_1_4;
	}


	// From: Req5Batch142Amount50
	var_1_15 = (10u + (var_1_14 + var_1_16));


	// From: Req6Batch142Amount50
	if (-10 > var_1_12) {
	...
	// From: Req8Batch142Amount50
	var_1_22 = var_1_23;


	// From: Req9Batch142Amount50
	var_1_24 = var_1_25;


	// From: Req2Batch142Amount50
	if (var_1_24) {
