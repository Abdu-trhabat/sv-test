...
void step(void) {
	...
	/* 307L, 201L) */ if (var_1_25) {
		...
		/* 324L, 199L) */ if (/* 325L, 138L, 139L) */ ((/* 326L, 134L, 140L) */ ((var_1_28) % (var_1_34))) != (/* 329L, 137L, 143L) */ ((var_1_14) + (var_1_30))))) {
			/* 332L, 182L) */ if (/* 333L, 157L, 158L) */ ((/* 334L, 155L, 159L) */ (min (/* 334L, 155L, 159L) */ (8.4f) , (var_1_22)))) < (127.2f))) {
				/* 338L, 172L) */ var_1_32 = (
					/* 341L, 171L) */ (abs (
						var_1_36
					))
