...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch39Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch39Amount50
	var_1_10 = (min ((abs (var_1_11 - var_1_8)) , (max (0u , var_1_5))));


	// From: Req4Batch39Amount50
	...
	// From: Req7Batch39Amount50
	var_1_18 = var_1_19;


	// From: Req8Batch39Amount50
	var_1_20 = var_1_8;


	// From: Req9Batch39Amount50
	var_1_21 = var_1_6;


	// From: Req6Batch39Amount50
	if ((var_1_10 != var_1_11) && (! var_1_21)) {
		var_1_17 = (max (var_1_1 , var_1_8));
	}


	// From: Req2Batch39Amount50
