...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch110Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
             if ( (( ((var_1_27) / (var_1_28))) > (var_1_30))) {
              if ( (( ((var_1_28) < (var_1_30))) && ( ((var_1_27) == (var_1_31))))) {
    ...
    var_1_33
             ...
             if ( (( (( ((var_1_38) - (var_1_31))) - ( (((((var_1_27)) > ((var_1_28))) ? ((var_1_27)) : ((var_1_28))))))) < (var_1_30))) {
              var_1_37 = (
               ((
    var_1_28
   ) + (
