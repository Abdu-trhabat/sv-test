...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((var_1_13 / var_1_14) <= var_1_15) {
		if ((var_1_16 - 2.3) > var_1_14) {
			...
			var_1_12 = (max (var_1_7 , (abs (var_1_17 - var_1_8))));
		}
	} else {
		var_1_12 = var_1_8;
	}
	...
	if (((var_1_4 >= var_1_12) && var_1_2) && var_1_3) {
		var_1_9 = (! var_1_10);
	} else {
...
int property(void) {
	return ((((var_1_2 && var_1_3) ? (var_1_1 == ((signed long int) var_1_4)) : 1) && (var_1_9 ? (var_1_5 == ((signed short int) var_1_6)) : (var_1_5 == ((signed short int) ((var_1_7 + 16) - var_1_8))))) && ((((var_1_4 >= var_1_12) && var_1_2) && var_1_3) ? (var_1_9 == ((unsigned char) (! var_1_10))) : (var_1_9 == ((unsigned char) (! (var_1_11 || var_1_10)))))) && (((var_1_13 / var_1_14) <= var_1_15) ? (((var_1_16 - 2.3) > var_1_14) ? (var_1_12 == ((unsigned short int) (var_1_17 - var_1_7))) : (var_1_12 == ((unsigned short int) (max (var_1_7 , (abs (var_1_17 - var_1_8))))))) : (var_1_12 == ((unsigned short int) var_1_8)))
;
}
int main(void) {
	isInitial = 1;
