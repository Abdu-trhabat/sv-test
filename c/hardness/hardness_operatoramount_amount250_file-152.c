...
void step(void) {
	...
	if ((var_1_5 * var_1_6) < (var_1_10 + (last_1_var_1_26 / var_1_13))) {
		...
		if (stepLocal_1 >= (var_1_8 | (max (last_1_var_1_40 , 0)))) {
			var_1_12 = var_1_15;
		}
	}


	// From: Req9Batch152Amount250
	...
	// From: Req10Batch152Amount250
	var_1_39 = (var_1_37 || var_1_38);


	// From: Req21Batch152Amount250
	if (var_1_37) {
		var_1_56 = var_1_7;
	}


	// From: Req5Batch152Amount250
	if (var_1_6 <= var_1_11) {
		var_1_20 = (min ((var_1_7 + (var_1_21 - var_1_22)) , (var_1_23 - (var_1_24 + var_1_25))));
	} else {
		if (var_1_13 < (var_1_16 + var_1_11)) {
			var_1_20 = (min (((max (var_1_7 , var_1_25)) + var_1_21) , var_1_24));
		}
	}


	// From: Req15Batch152Amount250
	var_1_48 = (last_1_var_1_48 + (var_1_7 + var_1_25));


	// From: Req19Batch152Amount250
	unsigned char stepLocal_14 = var_1_34;
	if (stepLocal_14 && var_1_37) {
		var_1_54 = (min ((abs (var_1_48)) , (min ((var_1_22 - var_1_36) , var_1_21))));
	} else {
		var_1_54 = var_1_21;
	}


	// From: Req22Batch152Amount250
	if (var_1_14 <= (var_1_5 + var_1_15)) {
		var_1_57 = (min (var_1_7 , var_1_20));
	} else {
		var_1_57 = var_1_23;
	}


	// From: Req24Batch152Amount250
	var_1_59 = var_1_7;


	// From: Req16Batch152Amount250
	unsigned short int stepLocal_9 = var_1_47;
	if (var_1_40 > stepLocal_9) {
		if (var_1_38) {
			var_1_49 = (min (var_1_7 , (min (var_1_21 , var_1_22))));
		}
	}


	// From: Req18Batch152Amount250
	...
	if (stepLocal_13 && (var_1_4 < var_1_28)) {
		if (stepLocal_12 > (- var_1_40)) {
			if (var_1_39) {
				var_1_51 = (abs (var_1_11));
			} else {
				var_1_51 = (var_1_11 + ((var_1_52 + var_1_53) + (min (var_1_28 , 3.6))));
			}
		}
	}


	// From: Req6Batch152Amount250
	if (var_1_5 <= 256.25f) {
		var_1_26 = ((max (15.25 , var_1_5)) - var_1_14);
	} else {
		if ((var_1_21 * var_1_24) <= (max (var_1_8 , 4))) {
			if (var_1_8 <= (var_1_18 / var_1_23)) {
				var_1_26 = (min (var_1_14 , var_1_5));
			}
		} else {
	...
	// From: Req12Batch152Amount250
	signed long int stepLocal_6 = var_1_44;
	if ((var_1_23 - 64) >= stepLocal_6) {
		var_1_45 = (max (var_1_48 , (var_1_8 + var_1_25)));
	} else {
		if (var_1_38) {
			if (var_1_6 < var_1_16) {
				var_1_45 = var_1_25;
	...
	// From: Req4Batch152Amount250
	if (var_1_15 < var_1_11) {
		var_1_17 = (min ((max (var_1_8 , (var_1_7 - var_1_49))) , (var_1_18 - var_1_19)));
	}


	// From: Req7Batch152Amount250
	...
	if (var_1_5 < (var_1_10 * var_1_12)) {
		...
		if (stepLocal_2 <= var_1_17) {
			if (stepLocal_3 < 128) {
				var_1_29 = ((min (var_1_32 , var_1_15)) + var_1_16);
			}
		}
	}


	// From: Req23Batch152Amount250
	if (var_1_16 == var_1_29) {
		var_1_58 = var_1_32;
	} else {
		var_1_58 = (abs ((5.630970713391611E18 - var_1_15) - var_1_14));
	}


	// From: Req17Batch152Amount250
	...
	if (var_1_58 != var_1_14) {
		if (var_1_34 && stepLocal_10) {
			if (var_1_7 > stepLocal_11) {
				...
				var_1_50 = ((min (var_1_5 , (var_1_14 - var_1_15))) - (7.25f + var_1_16));
			}
		}
	}


	// From: Req20Batch152Amount250
	signed long int stepLocal_15 = max (var_1_21 , var_1_18);
	if ((var_1_58 / (min (7.1 , var_1_13))) < var_1_12) {
		if (var_1_47 != stepLocal_15) {
			var_1_55 = (var_1_25 + var_1_22);
		} else {
			var_1_55 = (max (var_1_24 , (max (var_1_25 , -2))));
		}
	} else {
		var_1_55 = ((abs (var_1_22)) + var_1_25);
	}


	// From: Req2Batch152Amount250
	...
	// From: Req8Batch152Amount250
	if (((var_1_1 + var_1_45) ^ (max (var_1_21 , var_1_48))) < var_1_18) {
		var_1_33 = ((min (var_1_48 , (var_1_36 - var_1_7))) - var_1_45);
	} else {
...
int property(void) {
	return ((((((((((((((((((((((((var_1_17 > 1) ? ((127.625f != (- var_1_50)) ? ((var_1_50 <= ((var_1_4 + var_1_5) - var_1_6)) ? (var_1_1 == ((unsigned char) (var_1_7 + var_1_8))) : 1) : ((var_1_50 >= (var_1_4 + var_1_5)) ? (var_1_1 == ((unsigned char) ((max (var_1_7 , var_1_8)) + 32))) : 1)) : (((var_1_5 + var_1_50) < var_1_4) ? (var_1_1 == ((unsigned char) 4)) : (var_1_1 == ((unsigned char) (abs (var_1_7)))))) && (((var_1_4 - var_1_6) < var_1_5) ? ((var_1_7 < var_1_55) ? ((var_1_4 != var_1_51) ? (var_1_9 == ((float) (var_1_10 + var_1_11))) : (var_1_9 == ((float) (min ((abs (var_1_5)) , var_1_10))))) : 1) : 1)) && (((var_1_5 * var_1_6) < (var_1_10 + (last_1_var_1_26 / var_1_13))) ? (var_1_12 == ((double) ((abs (var_1_10)) - (var_1_14 - (min (var_1_15 , var_1_16)))))) : ((var_1_7 >= (var_1_8 | (max (last_1_var_1_40 , 0)))) ? (var_1_12 == ((double) var_1_15)) : 1))) && ((var_1_15 < var_1_11) ? (var_1_17 == ((signed long int) (min ((max (var_1_8 , (var_1_7 - var_1_49))) , (var_1_18 - var_1_19))))) : 1)) && ((var_1_6 <= var_1_11) ? (var_1_20 == ((unsigned char) (min ((var_1_7 + (var_1_21 - var_1_22)) , (var_1_23 - (var_1_24 + var_1_25)))))) : ((var_1_13 < (var_1_16 + var_1_11)) ? (var_1_20 == ((unsigned char) (min (((max (var_1_7 , var_1_25)) + var_1_21) , var_1_24)))) : 1))) && ((var_1_5 <= 256.25f) ? (var_1_26 == ((double) ((max (15.25 , var_1_5)) - var_1_14))) : (((var_1_21 * var_1_24) <= (max (var_1_8 , 4))) ? ((var_1_8 <= (var_1_18 / var_1_23)) ? (var_1_26 == ((double) (min (var_1_14 , var_1_5)))) : 1) : ((var_1_21 <= var_1_49) ? (var_1_26 == ((double) (var_1_16 - 255.875))) : (var_1_26 == ((double) ((32.75 - var_1_15) + (1.00000000002E10 + var_1_28)))))))) && ((var_1_5 < (var_1_10 * var_1_12)) ? ((var_1_37 || var_1_39) ? (var_1_29 == ((double) (8.5 - var_1_15))) : 1) : ((var_1_23 <= var_1_17) ? (((var_1_19 + (var_1_56 / -2)) < 128) ? (var_1_29 == ((double) ((min (var_1_32 , var_1_15)) + var_1_16))) : 1) : 1))) && ((((var_1_1 + var_1_45) ^ (max (var_1_21 , var_1_48))) < var_1_18) ? (var_1_33 == ((signed short int) ((min (var_1_48 , (var_1_36 - var_1_7))) - var_1_45))) : (var_1_33 == ((signed short int) (var_1_8 - var_1_24))))) && ((last_1_var_1_9 <= (var_1_32 * var_1_16)) ? ((var_1_15 >= var_1_5) ? (var_1_37 == ((unsigned char) (last_1_var_1_39 || var_1_34))) : (var_1_37 == ((unsigned char) (var_1_34 && (last_1_var_1_39 || var_1_38))))) : 1)) && (var_1_39 == ((unsigned char) (var_1_37 || var_1_38)))) && (last_1_var_1_39 ? (((last_1_var_1_40 * last_1_var_1_56) >= last_1_var_1_17) ? (((min (last_1_var_1_29 , var_1_10)) > last_1_var_1_12) ? (var_1_40 == ((signed long int) var_1_22)) : (var_1_40 == ((signed long int) (var_1_21 + last_1_var_1_55)))) : 1) : (var_1_40 == ((signed long int) (var_1_24 - (var_1_44 - 2)))))) && (((var_1_23 - 64) >= var_1_44) ? (var_1_45 == ((unsigned short int) (max (var_1_48 , (var_1_8 + var_1_25))))) : (var_1_38 ? ((var_1_6 < var_1_16) ? (var_1_45 == ((unsigned short int) var_1_25)) : (var_1_45 == ((unsigned short int) var_1_48))) : 1))) && ((var_1_18 > ((var_1_54 / var_1_44) % -4)) ? (var_1_46 == ((float) var_1_28)) : 1)) && ((last_1_var_1_9 >= (var_1_4 - var_1_5)) ? ((last_1_var_1_37 && (var_1_28 == (var_1_14 / var_1_13))) ? (var_1_47 == ((unsigned short int) ((min (var_1_8 , var_1_22)) + (var_1_21 + last_1_var_1_47)))) : 1) : (var_1_47 == ((unsigned short int) (min (var_1_8 , (abs (var_1_36)))))))) && (var_1_48 == ((signed short int) (last_1_var_1_48 + (var_1_7 + var_1_25))))) && ((var_1_40 > var_1_47) ? (var_1_38 ? (var_1_49 == ((unsigned char) (min (var_1_7 , (min (var_1_21 , var_1_22)))))) : 1) : 1)) && ((var_1_58 != var_1_14) ? ((var_1_34 && var_1_37) ? ((var_1_7 > 100) ? (var_1_50 == ((float) var_1_28)) : (var_1_50 == ((float) ((min (var_1_5 , (var_1_14 - var_1_15))) - (7.25f + var_1_16))))) : 1) : 1)) && ((var_1_39 && (var_1_4 < var_1_28)) ? ((var_1_24 > (- var_1_40)) ? (var_1_39 ? (var_1_51 == ((double) (abs (var_1_11)))) : (var_1_51 == ((double) (var_1_11 + ((var_1_52 + var_1_53) + (min (var_1_28 , 3.6))))))) : 1) : 1)) && ((var_1_34 && var_1_37) ? (var_1_54 == ((signed long int) (min ((abs (var_1_48)) , (min ((var_1_22 - var_1_36) , var_1_21)))))) : (var_1_54 == ((signed long int) var_1_21)))) && (((var_1_58 / (min (7.1 , var_1_13))) < var_1_12) ? ((var_1_47 != (max (var_1_21 , var_1_18))) ? (var_1_55 == ((signed char) (var_1_25 + var_1_22))) : (var_1_55 == ((signed char) (max (var_1_24 , (max (var_1_25 , -2))))))) : (var_1_55 == ((signed char) ((abs (var_1_22)) + var_1_25))))) && (var_1_37 ? (var_1_56 == ((signed long int) var_1_7)) : 1)) && ((var_1_14 <= (var_1_5 + var_1_15)) ? (var_1_57 == ((signed long int) (min (var_1_7 , var_1_20)))) : (var_1_57 == ((signed long int) var_1_23)))) && ((var_1_16 == var_1_29) ? (var_1_58 == ((double) var_1_32)) : (var_1_58 == ((double) (abs ((5.630970713391611E18 - var_1_15) - var_1_14)))))) && (var_1_59 == ((unsigned char) var_1_7))
;
}
int main(void) {
	isInitial = 1;
