...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch55no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_2) {
		...
		var_1_11 = (max ((var_1_1 + (var_1_6 + var_1_13)) , (3076057457u - var_1_14)));
	}
