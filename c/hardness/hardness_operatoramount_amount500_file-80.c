...
void step(void) {
	...
	var_1_22 = ((min (99999.25f , (min (var_1_16 , var_1_20)))) + var_1_23);


	// From: Req10Batch80Amount500
	if (var_1_6 >= 127.75f) {
		var_1_35 = (((var_1_36 - var_1_17) + var_1_18) - (min ((max (var_1_32 , 2)) , var_1_28)));
	} else {
		if (var_1_10) {
			var_1_35 = (min (last_1_var_1_35 , (var_1_17 + (var_1_28 + var_1_34))));
		} else {
			var_1_35 = var_1_32;
		}
	}
	...
	if (-1 < (var_1_34 << 1u)) {
		if (var_1_15 >= var_1_20) {
			var_1_37 = (max (var_1_34 , var_1_30));
		} else {
			var_1_37 = (max ((var_1_33 + var_1_29) , var_1_30));
		}
	} else {
		var_1_37 = (min ((abs (-16)) , var_1_34));
	}


	// From: Req16Batch80Amount500
	if (var_1_46 >= 1) {
		var_1_53 = (min ((var_1_23 + 63.75) , var_1_20));
	} else {
		var_1_53 = (max (var_1_6 , (min ((var_1_23 + var_1_20) , (min (var_1_15 , 31.3))))));
	}
	...
	if (stepLocal_8 > var_1_17) {
		var_1_69 = ((max ((min (var_1_20 , var_1_23)) , (var_1_16 - var_1_70))) + var_1_62);
	}
	...
	if (var_1_33 == stepLocal_11) {
		var_1_77 = (8 + ((max (var_1_75 , var_1_60)) + (var_1_78 - var_1_76)));
	} else {
		var_1_77 = (abs (var_1_47));
	}


	// From: Req26Batch80Amount500
	var_1_79 = (min ((min (var_1_68 , var_1_49)) , var_1_17));
	...
	if (stepLocal_12 > var_1_29) {
		...
		var_1_80 = ((var_1_67 - 1) + (max (var_1_46 , var_1_60)));
	}
	...
	var_1_101 = (min (var_1_68 , (min (var_1_50 , (max (var_1_60 , var_1_96))))));


	// From: Req42Batch80Amount500
	signed short int stepLocal_18 = var_1_34;
	if (stepLocal_18 <= (max ((min (-256 , var_1_96)) , var_1_25))) {
		if (var_1_10) {
			var_1_102 = var_1_14;
		} else {
			var_1_102 = var_1_63;
	...
	if (stepLocal_2 <= var_1_25) {
		if (var_1_15 == var_1_69) {
			var_1_27 = (max ((var_1_29 + (-10 + var_1_30)) , ((var_1_31 - var_1_32) + var_1_33)));
		} else {
			var_1_27 = ((var_1_31 + (max (var_1_32 , 200))) - ((abs (var_1_29)) + var_1_34));
		}
	} else {
		var_1_27 = ((max (var_1_34 , (min (var_1_29 , var_1_33)))) + 16);
	}
	...
	if (var_1_9) {
		if (stepLocal_3 > (var_1_31 & (100u + var_1_80))) {
			var_1_39 = (abs (min (var_1_7 , var_1_20)));
		}
	}
	...
	if (var_1_18 <= var_1_106) {
		var_1_57 = (var_1_20 + (min ((max (var_1_23 , var_1_16)) , (abs (var_1_58)))));
	} else {
	...
	if ((min (var_1_7 , var_1_57)) <= var_1_6) {
	...
	var_1_26 = (min (var_1_27 , var_1_17));


	// From: Req12Batch80Amount500
	if (! var_1_8) {
		var_1_38 = (abs (min (var_1_23 , (var_1_7 - 10.5))));
	}
	...
	if ((var_1_20 + var_1_16) <= var_1_38) {
		var_1_40 = (((max (0 , var_1_31)) < var_1_35) || var_1_9);
	} else {
		if (stepLocal_4 < ((min (var_1_29 , var_1_32)) + var_1_26)) {
	...
	if (! var_1_40) {
		var_1_21 = (max ((var_1_6 - var_1_7) , var_1_14));
	}
	...
	if (((var_1_111 >> var_1_60) % var_1_28) == var_1_46) {
		var_1_59 = (abs (var_1_6));
	} else {
		if (var_1_51 <= (var_1_77 / var_1_60)) {
			var_1_59 = (var_1_16 + var_1_20);
		} else {
			if (var_1_10 || (var_1_80 < var_1_49)) {
				if ((max (var_1_111 , var_1_26)) >= var_1_12) {
					var_1_59 = ((63.75 + (var_1_61 + var_1_62)) + var_1_23);
				} else {
					var_1_59 = (min ((min ((min (var_1_58 , var_1_14)) , var_1_16)) , (var_1_23 + var_1_61)));
				}
			} else {
				var_1_59 = (min (var_1_6 , var_1_63));
			}
		}
	}
	...
	if (((var_1_72 - var_1_16) - var_1_6) < var_1_21) {
		var_1_71 = (max (var_1_14 , (var_1_16 + var_1_70)));
	}
	...
	if (var_1_61 == ((var_1_16 - var_1_6) + var_1_70)) {
		if (var_1_21 <= (min (var_1_23 , var_1_7))) {
			var_1_73 = ((max (100u , (min (var_1_28 , var_1_110)))) + var_1_36);
		} else {
			var_1_73 = ((var_1_56 - var_1_67) + var_1_34);
		}
	} else {
		if (var_1_26 != stepLocal_9) {
			var_1_73 = (var_1_74 - (abs (abs (var_1_56))));
		} else {
			if (stepLocal_10 > (100 << (min (var_1_75 , var_1_76)))) {
				var_1_73 = var_1_60;
			}
		}
	}
	...
	if ((min (var_1_112 , (max (var_1_58 , var_1_59)))) >= var_1_23) {
	...
	if ((var_1_29 * var_1_32) > var_1_73) {
		...
		var_1_98 = (max (var_1_62 , (min (var_1_15 , 1.75f))));
	}


	// From: Req40Batch80Amount500
	signed long int stepLocal_17 = (min (var_1_48 , var_1_91)) - var_1_31;
	...
	if (! var_1_10) {
		...
		if (stepLocal_16 && (var_1_14 == (- var_1_15))) {
			var_1_100 = (min ((var_1_11 + var_1_32) , var_1_67));
		}
	}
	...
	if (stepLocal_13 != var_1_34) {
		var_1_83 = (min ((min (var_1_48 , var_1_80)) , (abs (var_1_75 + var_1_26))));
	} else {
		if ((var_1_100 % 50) < stepLocal_14) {
			var_1_83 = (max (var_1_28 , var_1_76));
		} else {
			var_1_83 = var_1_26;
		}
	}
	...
	if (var_1_33 <= (var_1_44 + var_1_83)) {
		if ((- var_1_26) < var_1_49) {
			var_1_86 = (max (var_1_47 , (max (var_1_48 , (128 - var_1_78)))));
		}
	}


	// From: Req36Batch80Amount500
	if ((max (var_1_83 , var_1_17)) < var_1_44) {
		var_1_94 = ((min ((var_1_95 - var_1_60) , 128)) - var_1_90);
	} else {
		var_1_94 = ((min (var_1_95 , var_1_96)) - var_1_91);
	}


	// From: Req37Batch80Amount500
	if (var_1_40) {
		var_1_97 = (min (last_1_var_1_97 , (var_1_78 - var_1_103)));
	} else {
	...
	if (var_1_44 >= (var_1_55 - (var_1_45 - var_1_31))) {
		var_1_54 = ((var_1_31 - var_1_47) + (min (var_1_46 , var_1_50)));
	} else {
		if (var_1_10 && var_1_42) {
			if ((var_1_47 + var_1_83) <= (var_1_80 + var_1_50)) {
				var_1_54 = (min (((max (2 , var_1_30)) + var_1_50) , var_1_111));
			}
		} else {
			var_1_54 = (var_1_47 - (max ((var_1_56 - 5) , var_1_31)));
		}
	}
	...
	if (stepLocal_5 < var_1_54) {
		...
		var_1_64 = (min (var_1_17 , (var_1_47 + var_1_48)));
	}
	...
	if ((var_1_17 >= var_1_60) && stepLocal_7) {
		var_1_66 = (abs (max ((max (var_1_30 , var_1_29)) , (var_1_33 + var_1_27))));
	} else {
	...
	if ((var_1_44 / var_1_90) >= var_1_64) {
		...
		var_1_99 = (min (var_1_49 , (abs (var_1_90))));
	}
	...
	if (var_1_80 < (var_1_54 * var_1_32)) {
		if (((var_1_44 + var_1_45) - var_1_31) >= (max ((var_1_18 * 8u) , var_1_54))) {
			if (var_1_10) {
				var_1_43 = (var_1_46 - (min (var_1_47 , (min (var_1_48 , var_1_49)))));
			}
		} else {
	...
	if (((min (var_1_1 , var_1_38)) * var_1_61) <= 49.725) {
		var_1_88 = (var_1_48 + var_1_89);
	} else {
		var_1_88 = (((var_1_90 + var_1_91) - (min (var_1_60 , var_1_75))) - var_1_49);
	}


	// From: Req54Batch80Amount500
	signed long int stepLocal_19 = (var_1_95 + 128) - (max (var_1_88 , var_1_17));
	if (var_1_59 >= var_1_63) {
		var_1_114 = var_1_75;
	} else {
		if (var_1_11 <= stepLocal_19) {
			var_1_114 = (min (var_1_76 , var_1_75));
		} else {
			var_1_114 = var_1_47;
		}
	}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((((~ var_1_11) + (var_1_11 + var_1_73)) <= var_1_93) ? (var_1_1 == ((float) (var_1_6 - var_1_7))) : 1) && (((min (var_1_7 , var_1_57)) <= var_1_6) ? ((1u < var_1_80) ? (var_1_8 == ((unsigned char) (var_1_9 && var_1_10))) : 1) : 1)) && (var_1_9 ? (var_1_11 == ((unsigned long int) 0u)) : (var_1_10 ? (var_1_11 == ((unsigned long int) (abs (8u + var_1_12)))) : ((var_1_6 < 127.5f) ? (var_1_11 == ((unsigned long int) var_1_12)) : 1)))) && ((var_1_7 != (last_1_var_1_13 * var_1_6)) ? (var_1_13 == ((double) (((min (var_1_14 , var_1_15)) - var_1_16) - var_1_7))) : (((var_1_14 - 100000.01f) > last_1_var_1_13) ? (var_1_9 ? (var_1_10 ? (((var_1_18 + var_1_83) >= (var_1_11 + (- 8u))) ? ((! var_1_8) ? (var_1_13 == ((double) var_1_14)) : (var_1_13 == ((double) (var_1_16 + var_1_20)))) : 1) : (var_1_13 == ((double) var_1_7))) : 1) : (var_1_13 == ((double) var_1_16))))) && ((! var_1_40) ? (var_1_21 == ((double) (max ((var_1_6 - var_1_7) , var_1_14)))) : 1)) && (var_1_22 == ((float) ((min (99999.25f , (min (var_1_16 , var_1_20)))) + var_1_23)))) && ((! var_1_40) ? (var_1_9 ? ((var_1_20 > (var_1_6 - var_1_14)) ? (var_1_24 == ((signed short int) (min (var_1_25 , 64)))) : 1) : (var_1_24 == ((signed short int) var_1_25))) : 1)) && (var_1_26 == ((signed long int) (min (var_1_27 , var_1_17))))) && (((- (var_1_28 - var_1_18)) <= var_1_25) ? ((var_1_15 == var_1_69) ? (var_1_27 == ((signed short int) (max ((var_1_29 + (-10 + var_1_30)) , ((var_1_31 - var_1_32) + var_1_33))))) : (var_1_27 == ((signed short int) ((var_1_31 + (max (var_1_32 , 200))) - ((abs (var_1_29)) + var_1_34))))) : (var_1_27 == ((signed short int) ((max (var_1_34 , (min (var_1_29 , var_1_33)))) + 16))))) && ((var_1_6 >= 127.75f) ? (var_1_35 == ((signed long int) (((var_1_36 - var_1_17) + var_1_18) - (min ((max (var_1_32 , 2)) , var_1_28))))) : (var_1_10 ? (var_1_35 == ((signed long int) (min (last_1_var_1_35 , (var_1_17 + (var_1_28 + var_1_34)))))) : (var_1_35 == ((signed long int) var_1_32))))) && ((-1 < (var_1_34 << 1u)) ? ((var_1_15 >= var_1_20) ? (var_1_37 == ((signed short int) (max (var_1_34 , var_1_30)))) : (var_1_37 == ((signed short int) (max ((var_1_33 + var_1_29) , var_1_30))))) : (var_1_37 == ((signed short int) (min ((abs (-16)) , var_1_34)))))) && ((! var_1_8) ? (var_1_38 == ((double) (abs (min (var_1_23 , (var_1_7 - 10.5)))))) : 1)) && (var_1_9 ? (((var_1_12 ^ (var_1_18 - var_1_32)) > (var_1_31 & (100u + var_1_80))) ? (var_1_39 == ((double) (abs (min (var_1_7 , var_1_20))))) : 1) : 1)) && (((var_1_20 + var_1_16) <= var_1_38) ? (var_1_40 == ((unsigned char) (((max (0 , var_1_31)) < var_1_35) || var_1_9))) : ((var_1_11 < ((min (var_1_29 , var_1_32)) + var_1_26)) ? (var_1_40 == ((unsigned char) (var_1_42 && var_1_10))) : (var_1_40 == ((unsigned char) var_1_10))))) && ((var_1_80 < (var_1_54 * var_1_32)) ? ((((var_1_44 + var_1_45) - var_1_31) >= (max ((var_1_18 * 8u) , var_1_54))) ? (var_1_10 ? (var_1_43 == ((signed char) (var_1_46 - (min (var_1_47 , (min (var_1_48 , var_1_49))))))) : 1) : (var_1_43 == ((signed char) ((var_1_50 + (2 + var_1_51)) + var_1_52)))) : 1)) && ((var_1_46 >= 1) ? (var_1_53 == ((double) (min ((var_1_23 + 63.75) , var_1_20)))) : (var_1_53 == ((double) (max (var_1_6 , (min ((var_1_23 + var_1_20) , (min (var_1_15 , 31.3)))))))))) && ((var_1_44 >= (var_1_55 - (var_1_45 - var_1_31))) ? (var_1_54 == ((signed long int) ((var_1_31 - var_1_47) + (min (var_1_46 , var_1_50))))) : ((var_1_10 && var_1_42) ? (((var_1_47 + var_1_83) <= (var_1_80 + var_1_50)) ? (var_1_54 == ((signed long int) (min (((max (2 , var_1_30)) + var_1_50) , var_1_111)))) : 1) : (var_1_54 == ((signed long int) (var_1_47 - (max ((var_1_56 - 5) , var_1_31)))))))) && ((var_1_18 <= var_1_106) ? (var_1_57 == ((float) (var_1_20 + (min ((max (var_1_23 , var_1_16)) , (abs (var_1_58))))))) : (var_1_57 == ((float) (var_1_20 + var_1_16))))) && ((((var_1_111 >> var_1_60) % var_1_28) == var_1_46) ? (var_1_59 == ((double) (abs (var_1_6)))) : ((var_1_51 <= (var_1_77 / var_1_60)) ? (var_1_59 == ((double) (var_1_16 + var_1_20))) : ((var_1_10 || (var_1_80 < var_1_49)) ? (((max (var_1_111 , var_1_26)) >= var_1_12) ? (var_1_59 == ((double) ((63.75 + (var_1_61 + var_1_62)) + var_1_23))) : (var_1_59 == ((double) (min ((min ((min (var_1_58 , var_1_14)) , var_1_16)) , (var_1_23 + var_1_61)))))) : (var_1_59 == ((double) (min (var_1_6 , var_1_63)))))))) && (((var_1_32 + var_1_12) < var_1_54) ? (var_1_64 == ((unsigned short int) (var_1_65 - var_1_18))) : (var_1_64 == ((unsigned short int) (min (var_1_17 , (var_1_47 + var_1_48))))))) && (((var_1_17 >= var_1_60) && var_1_8) ? (var_1_66 == ((signed short int) (abs (max ((max (var_1_30 , var_1_29)) , (var_1_33 + var_1_27)))))) : ((((var_1_83 / var_1_44) / var_1_56) < var_1_106) ? (var_1_66 == ((signed short int) (((var_1_67 + var_1_68) - var_1_60) - var_1_31))) : (var_1_66 == ((signed short int) (((var_1_51 + var_1_52) + (var_1_60 - var_1_48)) + (var_1_50 + (var_1_47 - var_1_49)))))))) && (((var_1_31 - var_1_32) > var_1_17) ? (var_1_69 == ((double) ((max ((min (var_1_20 , var_1_23)) , (var_1_16 - var_1_70))) + var_1_62))) : 1)) && ((((var_1_72 - var_1_16) - var_1_6) < var_1_21) ? (var_1_71 == ((float) (max (var_1_14 , (var_1_16 + var_1_70))))) : 1)) && ((var_1_61 == ((var_1_16 - var_1_6) + var_1_70)) ? ((var_1_21 <= (min (var_1_23 , var_1_7))) ? (var_1_73 == ((unsigned long int) ((max (100u , (min (var_1_28 , var_1_110)))) + var_1_36))) : (var_1_73 == ((unsigned long int) ((var_1_56 - var_1_67) + var_1_34)))) : ((var_1_26 != var_1_110) ? (var_1_73 == ((unsigned long int) (var_1_74 - (abs (abs (var_1_56)))))) : (((var_1_28 / var_1_60) > (100 << (min (var_1_75 , var_1_76)))) ? (var_1_73 == ((unsigned long int) var_1_60)) : 1)))) && ((var_1_33 == var_1_45) ? (var_1_77 == ((unsigned char) (8 + ((max (var_1_75 , var_1_60)) + (var_1_78 - var_1_76))))) : (var_1_77 == ((unsigned char) (abs (var_1_47)))))) && (var_1_79 == ((unsigned short int) (min ((min (var_1_68 , var_1_49)) , var_1_17))))) && (((var_1_46 / -500) > var_1_29) ? (var_1_80 == ((signed long int) ((var_1_68 + var_1_48) - (var_1_56 - var_1_81)))) : (var_1_80 == ((signed long int) ((var_1_67 - 1) + (max (var_1_46 , var_1_60))))))) && ((var_1_70 != 7.25) ? ((var_1_7 > var_1_58) ? (var_1_82 == ((signed char) ((8 + -2) + var_1_75))) : 1) : 1)) && ((var_1_111 != var_1_34) ? (var_1_83 == ((unsigned long int) (min ((min (var_1_48 , var_1_80)) , (abs (var_1_75 + var_1_26)))))) : (((var_1_100 % 50) < (var_1_35 % 10)) ? (var_1_83 == ((unsigned long int) (max (var_1_28 , var_1_76)))) : (var_1_83 == ((unsigned long int) var_1_26))))) && (((min (var_1_112 , (max (var_1_58 , var_1_59)))) >= var_1_23) ? (var_1_85 == ((float) (var_1_14 - var_1_7))) : (var_1_85 == ((float) (var_1_70 - 9.25f))))) && ((var_1_33 <= (var_1_44 + var_1_83)) ? (((- var_1_26) < var_1_49) ? (var_1_86 == ((unsigned char) (max (var_1_47 , (max (var_1_48 , (128 - var_1_78))))))) : 1) : 1)) && (var_1_87 == ((signed short int) (max ((var_1_97 + var_1_50) , -25))))) && ((((min (var_1_1 , var_1_38)) * var_1_61) <= 49.725) ? (var_1_88 == ((unsigned char) (var_1_48 + var_1_89))) : (var_1_88 == ((unsigned char) (((var_1_90 + var_1_91) - (min (var_1_60 , var_1_75))) - var_1_49))))) && (((var_1_54 > var_1_67) && var_1_40) ? (var_1_92 == ((float) (min ((max (var_1_7 , var_1_14)) , var_1_63)))) : (var_1_92 == ((float) (var_1_16 + (255.5f + var_1_62)))))) && (((- var_1_36) == (max (-128 , -5))) ? ((var_1_49 < var_1_75) ? ((var_1_8 || (var_1_10 && var_1_42)) ? (var_1_93 == ((signed long int) (var_1_90 - var_1_94))) : 1) : 1) : 1)) && (((max (var_1_83 , var_1_17)) < var_1_44) ? (var_1_94 == ((unsigned char) ((min ((var_1_95 - var_1_60) , 128)) - var_1_90))) : (var_1_94 == ((unsigned char) ((min (var_1_95 , var_1_96)) - var_1_91))))) && (var_1_40 ? (var_1_97 == ((signed short int) (min (last_1_var_1_97 , (var_1_78 - var_1_103))))) : (var_1_97 == ((signed short int) (var_1_86 + var_1_60))))) && (((var_1_29 * var_1_32) > var_1_73) ? (var_1_98 == ((float) (var_1_14 - (var_1_16 + var_1_70)))) : (var_1_98 == ((float) (max (var_1_62 , (min (var_1_15 , 1.75f)))))))) && (((var_1_44 / var_1_90) >= var_1_64) ? (var_1_99 == ((unsigned char) var_1_78)) : (var_1_99 == ((unsigned char) (min (var_1_49 , (abs (var_1_90)))))))) && ((! var_1_10) ? ((var_1_18 > ((min (var_1_48 , var_1_91)) - var_1_31)) ? (var_1_100 == ((signed short int) var_1_29)) : (var_1_100 == ((signed short int) (var_1_24 - var_1_48)))) : ((((var_1_8 && var_1_42) || var_1_40) && (var_1_14 == (- var_1_15))) ? (var_1_100 == ((signed short int) (min ((var_1_11 + var_1_32) , var_1_67)))) : 1))) && (var_1_101 == ((signed short int) (min (var_1_68 , (min (var_1_50 , (max (var_1_60 , var_1_96))))))))) && ((var_1_34 <= (max ((min (-256 , var_1_96)) , var_1_25))) ? (var_1_10 ? (var_1_102 == ((double) var_1_14)) : (var_1_102 == ((double) var_1_63))) : (var_1_102 == ((double) var_1_7)))) && (var_1_40 ? (var_1_103 == ((unsigned char) var_1_75)) : 1)) && (var_1_8 ? (var_1_104 == ((signed short int) -200)) : (var_1_104 == ((signed short int) var_1_46)))) && (var_1_42 ? (var_1_105 == ((unsigned char) var_1_96)) : 1)) && (var_1_9 ? (var_1_106 == ((signed long int) var_1_95)) : (var_1_106 == ((signed long int) var_1_60)))) && (var_1_9 ? (var_1_107 == ((unsigned char) var_1_76)) : (var_1_107 == ((unsigned char) var_1_89)))) && (var_1_9 ? (var_1_108 == ((signed short int) var_1_89)) : 1)) && (var_1_8 ? (var_1_109 == ((unsigned char) var_1_75)) : (var_1_109 == ((unsigned char) var_1_78)))) && (var_1_110 == ((unsigned short int) var_1_95))) && (var_1_8 ? (var_1_111 == ((unsigned long int) last_1_var_1_111)) : 1)) && (var_1_8 ? (var_1_112 == ((double) var_1_15)) : (var_1_112 == ((double) var_1_16)))) && (var_1_40 ? (var_1_113 == ((float) var_1_14)) : 1)) && ((var_1_59 >= var_1_63) ? (var_1_114 == ((signed char) var_1_75)) : ((var_1_11 <= ((var_1_95 + 128) - (max (var_1_88 , var_1_17)))) ? (var_1_114 == ((signed char) (min (var_1_76 , var_1_75)))) : (var_1_114 == ((signed char) var_1_47))))
;
}
int main(void) {
	isInitial = 1;
