...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch173Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 if (float_Array_0[2] < float_Array_0[1]) {
  if ((((((signed_char_Array_0[1][1]) < (signed_char_Array_0[0][1])) ? (signed_char_Array_0[1][1]) : (signed_char_Array_0[0][1]))) << unsigned_char_Array_0[0]) < ((~ signed_long_int_Array_0[1]) / signed_long_int_Array_0[0])) {
   double_Array_0[4] = (((((double_Array_0[1] - double_Array_0[2])) < ((double_Array_0[3] - double_Array_0[0]))) ? ((double_Array_0[1] - double_Array_0[2])) : ((double_Array_0[3] - double_Array_0[0]))));
  }
 }
 if (BOOL_unsigned_char_Array_0[2]) {
  BOOL_unsigned_char_Array_0[1] = (BOOL_unsigned_char_Array_0[3] || BOOL_unsigned_char_Array_0[4]);
 } else {
  BOOL_unsigned_char_Array_0[1] = (BOOL_unsigned_char_Array_0[0] || BOOL_unsigned_char_Array_0[4]);
 }
 signed_char_Array_0[1][0] = unsigned_char_Array_0[0];
 float_Array_0[0] = double_Array_0[2];
 signed_char_Array_0[0][0] = unsigned_char_Array_0[0];
 if ((double_Array_0[0] < double_Array_0[2]) || BOOL_unsigned_char_Array_0[1]) {
  if (BOOL_unsigned_char_Array_0[1] || (double_Array_0[1] <= float_Array_0[0])) {
   unsigned_long_int_Array_0[0] = (unsigned_long_int_Array_0[2] - (unsigned_long_int_Array_0[1] - signed_char_Array_0[1][1]));
  }
 } else {
  unsigned_long_int_Array_0[0] = unsigned_long_int_Array_0[2];
 }
}
void updateVariables(void) {
...
int property(void) {
 return ((((((float_Array_0[2] < float_Array_0[1]) ? (((((((signed_char_Array_0[1][1]) < (signed_char_Array_0[0][1])) ? (signed_char_Array_0[1][1]) : (signed_char_Array_0[0][1]))) << unsigned_char_Array_0[0]) < ((~ signed_long_int_Array_0[1]) / signed_long_int_Array_0[0])) ? (double_Array_0[4] == ((double) (((((double_Array_0[1] - double_Array_0[2])) < ((double_Array_0[3] - double_Array_0[0]))) ? ((double_Array_0[1] - double_Array_0[2])) : ((double_Array_0[3] - double_Array_0[0])))))) : 1) : 1) && (((double_Array_0[0] < double_Array_0[2]) || BOOL_unsigned_char_Array_0[1]) ? ((BOOL_unsigned_char_Array_0[1] || (double_Array_0[1] <= float_Array_0[0])) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) (unsigned_long_int_Array_0[2] - (unsigned_long_int_Array_0[1] - signed_char_Array_0[1][1])))) : 1) : (unsigned_long_int_Array_0[0] == ((unsigned long int) unsigned_long_int_Array_0[2])))) && (BOOL_unsigned_char_Array_0[2] ? (BOOL_unsigned_char_Array_0[1] == ((unsigned char) (BOOL_unsigned_char_Array_0[3] || BOOL_unsigned_char_Array_0[4]))) : (BOOL_unsigned_char_Array_0[1] == ((unsigned char) (BOOL_unsigned_char_Array_0[0] || BOOL_unsigned_char_Array_0[4]))))) && (signed_char_Array_0[1][0] == ((signed char) unsigned_char_Array_0[0]))) && (float_Array_0[0] == ((float) double_Array_0[2]))) && (signed_char_Array_0[0][0] == ((signed char) unsigned_char_Array_0[0]))
;
}
int main(void) {
 isInitial = 1;
