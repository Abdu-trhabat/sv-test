...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch9225_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_2 || var_1_10) {
  if (stepLocal_3 || (((((var_1_2) < (var_1_3)) ? (var_1_2) : (var_1_3))) < 32)) {
