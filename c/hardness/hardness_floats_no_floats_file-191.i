...
void step(void) {
 ...
 if (stepLocal_0 == last_1_var_1_8) {
  var_1_1 = ((((25u) > (last_1_var_1_8)) ? (25u) : (last_1_var_1_8)));
 } else {
  var_1_1 = last_1_var_1_8;
 }
 unsigned long int stepLocal_2 = var_1_1 ^ (256u / var_1_3);
 if (stepLocal_2 < var_1_1) {
  var_1_8 = ((var_1_1 + var_1_3) + ((((var_1_9) < (var_1_10)) ? (var_1_9) : (var_1_10))));
 } else {
  var_1_8 = ((((var_1_1) < ((var_1_10 + var_1_3))) ? (var_1_1) : ((var_1_10 + var_1_3))));
 }
