...
void step(void) {
	// From: Req1Batch173Wrapper_AP
	if ((*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) < (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer))) {
		if (((min ((*(signed_char_Array_0_arraysigned_char_Array_0Var3_Pointer)) , (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))) << (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) < ((~ (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))) / (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))) {
			(*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) = (min (((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))) , ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))));
		}
	}


	// From: Req3Batch173Wrapper_AP
