...
void step(void) {
	...
	// From: Req4Batch167stepLocals
	unsigned long int stepLocal_2 = (max (var_1_3 , var_1_18)) * var_1_4;
	...
	// From: Req5Batch167stepLocals
	var_1_20 = ((var_1_21 + 16) + (var_1_22 + var_1_23));


	// From: Req6Batch167stepLocals
