...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch125dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch125dependencies
	var_1_11 = ((abs (var_1_12)) + var_1_13);


	// From: Req3Batch125dependencies
	if (var_1_2) {
		if (var_1_8 > var_1_12) {
	...
	// From: Req4Batch125dependencies
	var_1_18 = (min ((var_1_19 - 100) , var_1_9));


	// From: Req5Batch125dependencies
	if (var_1_2) {
		var_1_20 = var_1_18;
	} else {
