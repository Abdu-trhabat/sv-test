...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (! ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) < (127.125 / (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))))) {
  if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) <= (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)) * (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))) + (4 << (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))))) {
...
void updateVariables(void) {
 ...
 assume_abort_if_not(unsigned_char_Array_0[0] <= 28);
}
void updateLastVariables(void) {
}
int property(void) {
