...
void step(void) {
	...
	if ((*(var_1_8_Pointer))) {
		if (stepLocal_1 || (*(var_1_11_Pointer))) {
			...
			(*(var_1_10_Pointer)) = (abs ((*(var_1_14_Pointer)) - ((*(var_1_13_Pointer)) + (*(var_1_15_Pointer)))));
		}
	} else {
		(*(var_1_10_Pointer)) = (max ((*(var_1_12_Pointer)) , (*(var_1_15_Pointer))));
	}
