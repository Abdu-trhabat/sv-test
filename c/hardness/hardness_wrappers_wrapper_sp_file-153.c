...
void step(void) {
	...
	// From: Req3Batch153Wrapper_SP
	(*(WrapperStruct00_var_1_6_Pointer)) = ((abs ((*(WrapperStruct00_var_1_7_Pointer)))) + (*(WrapperStruct00_var_1_8_Pointer)));


	// From: Req6Batch153Wrapper_SP
	(*(WrapperStruct00_var_1_18_Pointer)) = (*(WrapperStruct00_var_1_17_Pointer));


	// From: Req7Batch153Wrapper_SP
	(*(WrapperStruct00_var_1_19_Pointer)) = (*(WrapperStruct00_var_1_6_Pointer));


	// From: Req4Batch153Wrapper_SP
	...
	if (((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_15_Pointer))) == stepLocal_1) {
		if ((*(WrapperStruct00_var_1_10_Pointer))) {
			(*(WrapperStruct00_var_1_13_Pointer)) = (min ((*(WrapperStruct00_var_1_17_Pointer)) , 1000000.5));
		}
	}
}
