...
void functionized0(float functionized0_localFunctionVar0, double functionized0_localFunctionVar1, unsigned char functionized0_localFunctionVar2, double functionized0_localFunctionVar3, unsigned char functionized0_localFunctionVar4, float functionized0_localFunctionVar5, float localFunctionVar6) {
 if (var_1_8 > (((((functionized0_localFunctionVar3) > (var_1_10)) ? (functionized0_localFunctionVar3) : (var_1_10))) + functionized0_localFunctionVar1)) {
  ...
  var_1_7 = (((((functionized0_localFunctionVar0) > (var_1_17)) ? (functionized0_localFunctionVar0) : (var_1_17))) - localFunctionVar6);
 }
}
void functionized1(float functionized1_localFunctionVar0, unsigned char functionized1_localFunctionVar1) {
 if (functionized1_localFunctionVar1) {
  if ((var_1_20 - var_1_21) > var_1_4) {
   var_1_19 = ((((functionized1_localFunctionVar0) > (var_1_17)) ? (functionized1_localFunctionVar0) : (var_1_17)));
  }
 }
}
