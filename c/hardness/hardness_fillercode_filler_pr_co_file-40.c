...
void step(void) {
	...
	// From: CodeObject5
	/* 318L, 94L) */ if (/* 319L, 75L, 76L) */ ((/* 320L, 71L, 77L) */ ((var_1_31) && (var_1_32))) && (/* 323L, 74L, 80L) */ ((var_1_12) > (var_1_34))))) {
		/* 326L, 93L) */ var_1_37 = (
			var_1_12
		);
	}
	...
	/* 330L, 145L) */ if (/* 331L, 106L, 107L) */ ((/* 332L, 104L, 108L) */ (max (/* 332L, 104L, 108L) */ (/* 333L, 102L, 109L) */ ((var_1_36) / (var_1_39))) , (var_1_25)))) > (100.3))) {
		/* 338L, 143L) */ if (/* 339L, 125L, 126L) */ ((/* 340L, 123L, 127L) */ ((var_1_33) - (var_1_29))) >= (var_1_12))) {
			/* 344L, 142L) */ var_1_38 = (
				/* 347L, 141L) */ (max (
					/* 347L, 141L) */ (
						var_1_28
	...
	// From: CodeObject3
	/* 287L, 57L) */ if (/* 288L, 35L, 36L) */ ((var_1_28) > (var_1_26))) {
		/* 291L, 55L) */ if (/* 292L, 44L, 45L) */ ((var_1_29) >= (var_1_12))) {
			/* 295L, 54L) */ var_1_34 = (
				128u
			);
		}
	...
	// From: CodeObject7
	/* 351L, 185L) */ if (/* 352L, 162L, 163L) */ ((var_1_26) > (/* 354L, 161L, 165L) */ ((/* 355L, 159L, 166L) */ ((var_1_29) >> (2))) + (var_1_37))))) {
		/* 359L, 184L) */ var_1_40 = (
			/* 362L, 183L) */ ((
				/* 363L, 180L) */ (abs (
					var_1_33
