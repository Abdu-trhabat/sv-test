...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4450_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch4450_while
	signed char stepLocal_2 = var_1_16;
	unsigned long int stepLocal_1 = last_1_var_1_14 + last_1_var_1_1;
	if (((var_1_15 * last_1_var_1_31) + var_1_16) < stepLocal_1) {
		if (stepLocal_2 >= last_1_var_1_28) {
			var_1_19 = var_1_20;
		}
	}


	// From: Req7Batch4450_while
	var_1_28 = var_1_24;


	// From: Req8Batch4450_while
	var_1_29 = var_1_30;


	// From: Req9Batch4450_while
	var_1_31 = var_1_20;


	// From: Req2Batch4450_while
	...
	// From: Req3Batch4450_while
	if (var_1_19 == (min (var_1_31 , (var_1_13 / var_1_16)))) {
		var_1_14 = var_1_15;
	} else {
	...
	// From: Req1Batch4450_while
	unsigned long int stepLocal_0 = (var_1_8 + var_1_28) ^ (var_1_8 + var_1_19);
	if (var_1_8 == stepLocal_0) {
		var_1_1 = var_1_8;
	}


	// From: Req5Batch4450_while
	if (var_1_9 <= var_1_10) {
...
int property(void) {
	return (((((((((var_1_8 == ((var_1_8 + var_1_28) ^ (var_1_8 + var_1_19))) ? (var_1_1 == ((signed long int) var_1_8)) : 1) && (((abs (var_1_9)) < (min ((var_1_10 - var_1_11) , (abs (var_1_12))))) ? ((var_1_9 >= var_1_12) ? (var_1_8 == ((signed short int) var_1_13)) : (var_1_8 == ((signed short int) var_1_28))) : (var_1_8 == ((signed short int) 0)))) && ((var_1_19 == (min (var_1_31 , (var_1_13 / var_1_16)))) ? (var_1_14 == ((unsigned long int) var_1_15)) : (var_1_14 == ((unsigned long int) (var_1_17 - (var_1_15 + var_1_18)))))) && ((((var_1_15 * last_1_var_1_31) + var_1_16) < (last_1_var_1_14 + last_1_var_1_1)) ? ((var_1_16 >= last_1_var_1_28) ? (var_1_19 == ((signed char) var_1_20)) : 1) : 1)) && ((var_1_9 <= var_1_10) ? (var_1_21 == ((signed long int) ((var_1_18 + var_1_15) - ((var_1_22 + var_1_23) - var_1_24)))) : (var_1_21 == ((signed long int) (var_1_14 + var_1_13))))) && (var_1_29 ? (var_1_25 == ((float) var_1_26)) : (var_1_25 == ((float) ((abs (var_1_26)) - var_1_27))))) && (var_1_28 == ((unsigned long int) var_1_24))) && (var_1_29 == ((unsigned char) var_1_30))) && (var_1_31 == ((signed char) var_1_20))
;
}
int main(void) {
	isInitial = 1;
