...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch186Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch186Amount50
	var_1_1 = var_1_2;


	// From: Req2Batch186Amount50
	...
	// From: Req3Batch186Amount50
	if ((var_1_7 > (max (9.6 , var_1_6))) || (var_1_5 < var_1_3)) {
		var_1_9 = var_1_10;
	}


	// From: Req5Batch186Amount50
