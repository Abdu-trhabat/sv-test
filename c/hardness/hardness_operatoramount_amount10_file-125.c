...
int property(void) {
	return (((max (var_1_2 , var_1_3)) * var_1_4) < (var_1_5 & 32)) ? (var_1_1 == ((signed char) (abs (var_1_6)))) : ((var_1_7 && var_1_8) ? (var_1_1 == ((signed char) var_1_6)) : (var_1_1 == ((signed char) -100)))
;
}
int main(void) {
	isInitial = 1;
