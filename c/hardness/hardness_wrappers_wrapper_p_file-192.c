...
void step(void) {
	...
	// From: Req3Batch192Wrapper_P
	signed long int stepLocal_3 = 1 - (*(var_1_13_Pointer));
	if ((abs ((*(var_1_9_Pointer)))) >= (*(var_1_7_Pointer))) {
	...
	// From: Req1Batch192Wrapper_P
	signed long int stepLocal_0 = (min ((*(var_1_4_Pointer)) , -5)) + (max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer))));
	if ((*(var_1_2_Pointer))) {
		if ((min ((*(var_1_11_Pointer)) , 0)) <= stepLocal_0) {
...
int property(void) {
	return (((*(var_1_2_Pointer)) ? (((min ((*(var_1_11_Pointer)) , 0)) <= ((min ((*(var_1_4_Pointer)) , -5)) + (max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))))) ? ((*(var_1_1_Pointer)) == ((double) (abs ((*(var_1_7_Pointer)))))) : ((*(var_1_1_Pointer)) == ((double) (((*(var_1_8_Pointer)) + (*(var_1_9_Pointer))) - (*(var_1_10_Pointer)))))) : ((*(var_1_1_Pointer)) == ((double) (*(var_1_8_Pointer))))) && (((*(var_1_5_Pointer)) < (*(var_1_3_Pointer))) ? ((((200 - (*(var_1_12_Pointer))) - (*(var_1_13_Pointer))) >= -100) ? ((*(var_1_11_Pointer)) == ((unsigned short int) (*(var_1_12_Pointer)))) : ((*(var_1_11_Pointer)) == ((unsigned short int) (*(var_1_13_Pointer))))) : 1)) && (((abs ((*(var_1_9_Pointer)))) >= (*(var_1_7_Pointer))) ? (((-4 + ((*(var_1_12_Pointer)) * (*(var_1_11_Pointer)))) < (1 - (*(var_1_13_Pointer)))) ? ((*(var_1_14_Pointer)) == ((signed char) (*(var_1_12_Pointer)))) : ((*(var_1_14_Pointer)) == ((signed char) -8))) : ((*(var_1_14_Pointer)) == ((signed char) (*(var_1_12_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
