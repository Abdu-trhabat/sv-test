...
void step(void) {
	// From: Req1Batch177no_floats
	if ((max (var_1_2 , var_1_3)) > var_1_4) {
		if (var_1_3 > var_1_4) {
			var_1_1 = (max (var_1_5 , (min (var_1_6 , (var_1_7 + -50)))));
		}
	}


	// From: Req3Batch177no_floats
	if (! var_1_11) {
		var_1_10 = (((var_1_12 + var_1_13) - var_1_14) - (abs (-8)));
	}


	// From: Req4Batch177no_floats
...
int property(void) {
	return (((((max (var_1_2 , var_1_3)) > var_1_4) ? ((var_1_3 > var_1_4) ? (var_1_1 == ((signed long int) (max (var_1_5 , (min (var_1_6 , (var_1_7 + -50))))))) : 1) : 1) && ((var_1_5 != (var_1_6 * (var_1_15 / var_1_9))) ? (var_1_8 == ((unsigned short int) 256)) : 1)) && ((! var_1_11) ? (var_1_10 == ((signed char) (((var_1_12 + var_1_13) - var_1_14) - (abs (-8))))) : 1)) && ((((var_1_16 - var_1_17) / var_1_9) <= var_1_1) ? (var_1_15 == ((signed long int) (var_1_7 + var_1_18))) : ((var_1_11 || (var_1_14 != var_1_10)) ? (var_1_15 == ((signed long int) var_1_5)) : (var_1_15 == ((signed long int) -10))))
;
}
int main(void) {
	isInitial = 1;
