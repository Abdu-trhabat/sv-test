...
void step(void) {
 ...
 if (double_Array_0[0][1] > double_Array_0[1][1]) {
  if (BOOL_unsigned_char_Array_0[0]) {
   if (double_Array_0[1][0] <= ((((double_Array_0[1][1]) < (float_Array_0[4])) ? (double_Array_0[1][1]) : (float_Array_0[4])))) {
