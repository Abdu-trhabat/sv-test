...
void step(void) {
	...
	// From: Req4Batch36Filler_PE_CI
	/* 906L, 67L, 448L, 454L) */ var_1_14 = (
		var_1_6
	);


	// From: Req6Batch36Filler_PE_CI
	...
	// From: CodeObject2
	/* 217L, 40L) */ if (/* 218L, 16L, 17L) */ ((/* 219L, 14L, 18L) */ ((/* 220L, 12L, 19L) */ ((var_1_10) ^ (8))) * (var_1_9))) <= (var_1_23))) {
		/* 225L, 39L) */ var_1_28 = (
			/* 228L, 38L) */ (abs (
				/* 229L, 37L) */ (min (
					/* 229L, 37L) */ (
	...
	// From: CodeObject4
	/* 240L, 91L) */ if (/* 241L, 57L, 58L) */ ((var_1_10) > (var_1_22))) {
		/* 244L, 74L) */ var_1_36 = (
			/* 247L, 73L) */ (abs (
				/* 248L, 72L) */ (min (
					/* 248L, 72L) */ (
		...
		/* 255L, 89L) */ if (/* 256L, 77L, 78L) */ ((var_1_10) != (var_1_23))) {
			/* 259L, 88L) */ var_1_36 = (
				/* 262L, 87L) */ (abs (
					99999.5
				))
	...
	// From: CodeObject5
	/* 264L, 127L) */ if (/* 265L, 101L, 102L) */ ((var_1_9) < (/* 267L, 100L, 104L) */ ((/* 268L, 98L, 105L) */ (min (/* 268L, 98L, 105L) */ (var_1_10) , (var_1_23)))) / (var_1_9))))) {
		/* 272L, 121L) */ var_1_41 = (
			/* 275L, 120L) */ ((
				var_1_39
			) + (
	...
	// From: CodeObject6
	/* 283L, 170L) */ if (/* 284L, 137L, 138L) */ ((/* 285L, 134L, 139L) */ ((/* 286L, 132L, 140L) */ (abs (var_1_10))) >> (var_1_44))) >= (/* 289L, 136L, 143L) */ (abs (var_1_9))))) {
		/* 291L, 164L) */ var_1_43 = (
			/* 294L, 163L) */ (max (
				/* 294L, 163L) */ (
					/* 295L, 157L) */ ((
	...
	// From: CodeObject7
	/* 309L, 194L) */ if (/* 310L, 178L, 179L) */ ((var_1_13) >= (/* 312L, 177L, 181L) */ ((var_1_4) * (var_1_18))))) {
		/* 315L, 193L) */ var_1_47 = (
			/* 318L, 192L) */ (abs (
				var_1_45
			))
