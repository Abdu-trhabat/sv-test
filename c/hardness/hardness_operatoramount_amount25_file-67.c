...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch67Amount25.c", 13, "reach_error"); }
...
int property(void) {
	return ((((! (var_1_2 <= var_1_3)) ? (var_1_1 == ((signed short int) (var_1_4 + var_1_5))) : 1) && ((var_1_4 > (last_1_var_1_10 / var_1_7)) ? (var_1_6 == ((unsigned short int) (var_1_8 + var_1_9))) : 1)) && ((var_1_6 >= (var_1_11 - var_1_8)) ? (((var_1_7 / var_1_12) <= var_1_3) ? (var_1_10 == ((signed long int) ((var_1_6 - var_1_8) + -32))) : (var_1_13 ? (var_1_10 == ((signed long int) (min (var_1_11 , var_1_7)))) : (var_1_10 == ((signed long int) var_1_5)))) : (var_1_10 == ((signed long int) var_1_1)))) && (var_1_14 == ((float) var_1_15))
;
}
int main(void) {
	isInitial = 1;
