...
void step(void) {
 signed long int stepLocal_0 = ((((signed_long_int_Array_0[1][1] * signed_long_int_Array_0[0][1])) < ((~ signed_long_int_Array_0[1][0]))) ? ((signed_long_int_Array_0[1][1] * signed_long_int_Array_0[0][1])) : ((~ signed_long_int_Array_0[1][0])));
 ...
 if (signed_long_int_Array_0[0][1] <= stepLocal_1) {
  if (unsigned_short_int_Array_0[1] == stepLocal_2) {
   double_Array_0[1] = (((((double_Array_0[2]) < 0 ) ? -(double_Array_0[2]) : (double_Array_0[2]))) + double_Array_0[3]);
  } else {
 ...
 if (signed_long_int_Array_0[0][1] > signed_long_int_Array_0[0][0]) {
  double_Array_0[0] = ((((double_Array_0[3]) < (double_Array_0[2])) ? (double_Array_0[3]) : (double_Array_0[2])));
 }
...
int property(void) {
 return (((((BOOL_unsigned_char_Array_0[0] ? (unsigned_short_int_Array_0[1] == ((unsigned short int) (((((((unsigned_short_int_Array_0[0]) < 0 ) ? -(unsigned_short_int_Array_0[0]) : (unsigned_short_int_Array_0[0]))) < 0 ) ? -((((unsigned_short_int_Array_0[0]) < 0 ) ? -(unsigned_short_int_Array_0[0]) : (unsigned_short_int_Array_0[0]))) : ((((unsigned_short_int_Array_0[0]) < 0 ) ? -(unsigned_short_int_Array_0[0]) : (unsigned_short_int_Array_0[0]))))))) : (((unsigned_short_int_Array_0[0] / unsigned_char_Array_0[0]) >= (((((signed_long_int_Array_0[1][1] * signed_long_int_Array_0[0][1])) < ((~ signed_long_int_Array_0[1][0]))) ? ((signed_long_int_Array_0[1][1] * signed_long_int_Array_0[0][1])) : ((~ signed_long_int_Array_0[1][0]))))) ? (unsigned_short_int_Array_0[1] == ((unsigned short int) unsigned_char_Array_0[0])) : (unsigned_short_int_Array_0[1] == ((unsigned short int) unsigned_short_int_Array_0[0])))) && ((signed_long_int_Array_0[0][1] <= (unsigned_short_int_Array_0[0] + unsigned_short_int_Array_0[1])) ? ((unsigned_short_int_Array_0[1] == (unsigned_short_int_Array_0[1] ^ signed_long_int_Array_0[1][1])) ? (double_Array_0[1] == ((double) (((((double_Array_0[2]) < 0 ) ? -(double_Array_0[2]) : (double_Array_0[2]))) + double_Array_0[3]))) : (double_Array_0[1] == ((double) double_Array_0[3]))) : (double_Array_0[1] == ((double) double_Array_0[2])))) && ((signed_long_int_Array_0[0][1] > signed_long_int_Array_0[0][0]) ? (double_Array_0[0] == ((double) ((((double_Array_0[3]) < (double_Array_0[2])) ? (double_Array_0[3]) : (double_Array_0[2]))))) : 1)) && (signed_short_int_Array_0[0] == ((signed short int) 200))) && (signed_char_Array_0[1] == ((signed char) signed_char_Array_0[0]))) && (double_Array_0[4] == ((double) double_Array_0[2]))
;
}
int main(void) {
 isInitial = 1;
