...
void step(void) {
	...
	if (var_1_12 >= stepLocal_0) {
		var_1_17 = (max (var_1_18 , (-256 + var_1_19)));
	}
...
int property(void) {
	return ((((var_1_2 ? ((var_1_3 < -50) ? (((var_1_3 + var_1_7) > var_1_5) ? (var_1_1 == ((signed long int) var_1_6)) : (var_1_1 == ((signed long int) -16))) : (var_1_1 == ((signed long int) var_1_6))) : 1) && (var_1_7 == ((signed char) var_1_8))) && ((! (var_1_6 == var_1_17)) ? (var_1_9 == ((signed char) var_1_8)) : (var_1_9 == ((signed char) (max ((var_1_10 - var_1_11) , var_1_8)))))) && ((var_1_2 && (! var_1_13)) ? (var_1_12 == ((unsigned char) (2 + ((var_1_14 + var_1_15) + var_1_16)))) : (var_1_12 == ((unsigned char) var_1_11)))) && ((var_1_12 >= var_1_15) ? (var_1_17 == ((signed long int) (max (var_1_18 , (-256 + var_1_19))))) : 1)
;
}
int main(void) {
	isInitial = 1;
