...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch89Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) > stepLocal_0) {
  (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) = (((((-4 + (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) < ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)))) ? ((-4 + (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) : ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)))));
 }
 ...
 if (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) / (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) >= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) {
 ...
 if (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) / (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) > (*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer))) {
  if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var4_Pointer))) {
   if ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) < (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer))) {
    if ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) <= (8 ^ (*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)))) {
