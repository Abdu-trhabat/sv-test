...
void step(void) {
	// From: Req3Batch4550_1loop
	var_1_7 = (min ((var_1_8 - last_1_var_1_14) , var_1_9));


	// From: Req4Batch4550_1loop
	if (var_1_8 > var_1_9) {
	...
	// From: Req7Batch4550_1loop
	if (var_1_2) {
		var_1_16 = (var_1_5 || var_1_17);
	}


	// From: Req8Batch4550_1loop
	var_1_18 = var_1_8;


	// From: Req1Batch4550_1loop
