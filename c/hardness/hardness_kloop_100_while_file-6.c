...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch6100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch6100_while
	var_1_9 = ((abs (var_1_8)) - var_1_6);


	// From: Req4Batch6100_while
	var_1_10 = (var_1_5 - (var_1_11 + 1000));


	// From: Req5Batch6100_while
	if (! var_1_3) {
	...
	if (stepLocal_1 >= var_1_4) {
		if (! var_1_2) {
			...
			if (var_1_2) {
				if (var_1_18) {
					var_1_19 = ((var_1_21 - (max (var_1_20 , var_1_4))) - (var_1_11 + (abs (var_1_1))));
				}
			}
		}
	} else {
	...
	if (var_1_4 < stepLocal_4) {
		...
		var_1_24 = ((max (var_1_25 , var_1_26)) + 4);
	}


	// From: Req11Batch6100_while
	...
	if (stepLocal_6 || (! 1)) {
		if (stepLocal_5 || ((var_1_20 != var_1_16) && (var_1_17 <= var_1_12))) {
			var_1_27 = ((abs (var_1_29 - var_1_19)) - var_1_25);
		} else {
			var_1_27 = ((max (var_1_5 , var_1_29)) - (abs (var_1_25)));
		}
	}
}
...
int property(void) {
	return ((((((((((((var_1_2 || var_1_3) ? (var_1_1 == ((unsigned short int) (abs (var_1_4)))) : (var_1_1 == ((unsigned short int) (min ((var_1_5 - var_1_6) , var_1_4))))) && ((var_1_6 <= (- 500)) ? (var_1_2 ? (var_1_7 == ((signed short int) (var_1_8 - 64))) : 1) : (var_1_7 == ((signed short int) var_1_8)))) && (var_1_9 == ((signed long int) ((abs (var_1_8)) - var_1_6)))) && (var_1_10 == ((unsigned short int) (var_1_5 - (var_1_11 + 1000))))) && ((! var_1_3) ? (var_1_12 == ((double) ((var_1_13 - (var_1_14 - 63.5)) + var_1_15))) : (var_1_12 == ((double) (var_1_14 - var_1_13))))) && (var_1_2 ? (var_1_16 == ((unsigned long int) (var_1_30 + 200u))) : (((min (var_1_6 , var_1_8)) <= var_1_11) ? (var_1_16 == ((unsigned long int) 128u)) : (var_1_16 == ((unsigned long int) var_1_6))))) && (var_1_18 ? (var_1_17 == ((float) ((min (var_1_14 , 255.4f)) + var_1_13))) : (var_1_3 ? (var_1_2 ? (var_1_17 == ((float) var_1_15)) : (var_1_17 == ((float) 0.050000000000000044f))) : (var_1_17 == ((float) var_1_13))))) && ((var_1_16 >= var_1_4) ? ((! var_1_2) ? (var_1_19 == ((signed long int) (var_1_11 - (var_1_4 + (var_1_20 - 5))))) : (var_1_2 ? (var_1_18 ? (var_1_19 == ((signed long int) ((var_1_21 - (max (var_1_20 , var_1_4))) - (var_1_11 + (abs (var_1_1)))))) : 1) : 1)) : (var_1_19 == ((signed long int) var_1_20)))) && ((var_1_18 || ((var_1_6 == var_1_16) || (var_1_2 && var_1_3))) ? (var_1_22 == ((unsigned char) var_1_23)) : (var_1_22 == ((unsigned char) 0)))) && ((var_1_4 < (var_1_16 + (5 << 1))) ? ((-32 > var_1_8) ? (var_1_24 == ((unsigned char) var_1_23)) : 1) : (var_1_24 == ((unsigned char) ((max (var_1_25 , var_1_26)) + 4))))) && (((var_1_16 == var_1_19) || (! 1)) ? ((var_1_2 || ((var_1_20 != var_1_16) && (var_1_17 <= var_1_12))) ? (var_1_27 == ((unsigned short int) ((abs (var_1_29 - var_1_19)) - var_1_25))) : (var_1_27 == ((unsigned short int) ((max (var_1_5 , var_1_29)) - (abs (var_1_25)))))) : 1)) && (((var_1_5 - var_1_25) <= -25) ? (var_1_30 == ((unsigned short int) var_1_11)) : 1)
;
}
int main(void) {
	isInitial = 1;
