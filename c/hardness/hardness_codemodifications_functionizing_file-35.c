...
void functionized5(double functionized5_localFunctionVar0, signed short int functionized5_localFunctionVar1) {
	if ((min ((var_1_16 * 200.7f) , (abs (functionized5_localFunctionVar0)))) <= ((- var_1_14) / var_1_18)) {
...
void step(void) {
	// From: Req1Batch35functionizing
	functionized0(var_1_4, var_1_3);


	// From: Req2Batch35functionizing
	if (functionized1()) {
	...
	// From: Req3Batch35functionizing
	functionized2(var_1_11);


	// From: Req4Batch35functionizing
	if (var_1_12 == var_1_7) {
		if (functionized3()) {
	...
	// From: Req6Batch35functionizing
	functionized5(var_1_10, var_1_15);


	// From: Req7Batch35functionizing
