...
void step(void) {
	...
	// From: Req6Batch197Amount250
	if (last_1_var_1_58 == last_1_var_1_13) {
		var_1_31 = (min ((var_1_32 - var_1_21) , (var_1_14 + var_1_27)));
	}


	// From: Req20Batch197Amount250
	if (var_1_11) {
		...
		var_1_61 = (((last_1_var_1_28 + var_1_62) + (var_1_63 - 5u)) + (max (last_1_var_1_53 , var_1_54)));
	}


	// From: Req3Batch197Amount250
	signed long int stepLocal_0 = (max (var_1_17 , var_1_16)) - (var_1_14 + var_1_21);
	if ((min (var_1_61 , 32)) <= stepLocal_0) {
	...
	// From: Req10Batch197Amount250
	if (var_1_20) {
		var_1_38 = (max (var_1_26 , ((var_1_27 + var_1_35) + 1)));
	} else {
		var_1_38 = (var_1_35 + var_1_25);
	}


	// From: Req4Batch197Amount250
	signed long int stepLocal_1 = var_1_37;
	if (stepLocal_1 <= (var_1_17 - var_1_14)) {
		var_1_23 = (min (var_1_24 , ((var_1_25 - 5) - var_1_26)));
	} else {
		var_1_23 = (max (var_1_24 , (var_1_26 + var_1_27)));
	}


	// From: Req8Batch197Amount250
	var_1_34 = (-1 - (max (var_1_35 , var_1_36)));


	// From: Req16Batch197Amount250
	var_1_51 = (var_1_6 && var_1_7);


	// From: Req17Batch197Amount250
	var_1_52 = ((abs (var_1_49)) - var_1_48);


	// From: Req18Batch197Amount250
	if (var_1_7) {
		var_1_53 = (max (var_1_36 , (var_1_30 - (var_1_54 - var_1_27))));
	} else {
	...
	if (stepLocal_6 > var_1_18) {
		...
		if (stepLocal_8 <= ((var_1_32 - var_1_14) / (abs (var_1_41)))) {
	...
	// From: Req12Batch197Amount250
	if ((max (var_1_52 , (var_1_52 * var_1_8))) < var_1_46) {
		var_1_42 = (abs (var_1_43));
	}


	// From: Req21Batch197Amount250
	...
	// From: Req7Batch197Amount250
	if ((16.4 + var_1_42) <= ((var_1_52 + 63.8) + (max (var_1_52 , var_1_8)))) {
		var_1_33 = var_1_25;
	}


	// From: Req2Batch197Amount250
	if (var_1_52 < var_1_42) {
		if (var_1_8 != (- var_1_52)) {
			var_1_13 = ((abs (var_1_14 - 16)) + var_1_15);
		} else {
			var_1_13 = ((max (var_1_14 , var_1_16)) - var_1_17);
		}
	} else {
	...
	// From: Req5Batch197Amount250
	unsigned char stepLocal_2 = var_1_27;
	if (stepLocal_2 >= ((var_1_14 ^ var_1_19) | var_1_15)) {
		var_1_28 = (max (var_1_25 , (128 + var_1_26)));
	} else {
		if (var_1_52 >= var_1_42) {
			var_1_28 = (((max (var_1_30 , 54742)) - var_1_38) - (var_1_26 + (max (var_1_27 , var_1_25))));
		}
	}


	// From: Req11Batch197Amount250
	...
	if (stepLocal_3 || ((var_1_32 * var_1_30) <= (var_1_14 * var_1_35))) {
		...
		if (stepLocal_4 <= (var_1_40 - var_1_17)) {
			var_1_39 = ((min (var_1_32 , var_1_41)) - (min ((abs (var_1_28)) , var_1_24)));
		} else {
			if (var_1_50) {
				var_1_39 = (min ((var_1_13 + (min (var_1_28 , var_1_25))) , var_1_61));
			} else {
				var_1_39 = ((max (var_1_27 , var_1_61)) + var_1_24);
			}
		}
	}


	// From: Req22Batch197Amount250
	...
	if (((var_1_53 + var_1_37) % var_1_54) > stepLocal_12) {
		if (stepLocal_9 && var_1_9) {
			if (stepLocal_10 > var_1_61) {
				var_1_58 = ((min ((var_1_59 - 5u) , var_1_32)) - (max (var_1_64 , (var_1_60 - var_1_28))));
			} else {
				if (var_1_52 > (- (var_1_48 - var_1_47))) {
					var_1_58 = (min (var_1_26 , var_1_64));
				} else {
					var_1_58 = ((max ((min (var_1_32 , var_1_59)) , (abs (var_1_41)))) - var_1_14);
				}
			}
		}
	} else {
		if (var_1_41 >= stepLocal_11) {
			var_1_58 = (var_1_54 + (abs (abs (var_1_45))));
		} else {
			var_1_58 = (8u + (min (var_1_28 , (var_1_60 - var_1_27))));
		}
	}
}
...
int property(void) {
	return ((((((((((((((((((((((var_1_46 != var_1_52) ? (var_1_1 == ((unsigned char) ((var_1_20 || (var_1_5 && var_1_6)) && var_1_7))) : ((var_1_52 > (var_1_46 / var_1_8)) ? ((! (var_1_52 >= (3.45f + var_1_46))) ? (var_1_6 ? (var_1_1 == ((unsigned char) (((var_1_7 && var_1_5) && (var_1_9 && var_1_10)) && var_1_11))) : (var_1_1 == ((unsigned char) (var_1_5 && var_1_12)))) : (var_1_1 == ((unsigned char) 0))) : (var_1_1 == ((unsigned char) 0)))) && ((var_1_52 < var_1_42) ? ((var_1_8 != (- var_1_52)) ? (var_1_13 == ((signed long int) ((abs (var_1_14 - 16)) + var_1_15))) : (var_1_13 == ((signed long int) ((max (var_1_14 , var_1_16)) - var_1_17)))) : (var_1_13 == ((signed long int) (var_1_14 + (var_1_18 + var_1_19)))))) && (((min (var_1_61 , 32)) <= ((max (var_1_17 , var_1_16)) - (var_1_14 + var_1_21))) ? (var_1_20 == ((unsigned char) (var_1_12 || var_1_22))) : (var_1_20 == ((unsigned char) (! var_1_11))))) && ((var_1_37 <= (var_1_17 - var_1_14)) ? (var_1_23 == ((unsigned char) (min (var_1_24 , ((var_1_25 - 5) - var_1_26))))) : (var_1_23 == ((unsigned char) (max (var_1_24 , (var_1_26 + var_1_27))))))) && ((var_1_27 >= ((var_1_14 ^ var_1_19) | var_1_15)) ? (var_1_28 == ((unsigned short int) (max (var_1_25 , (128 + var_1_26))))) : ((var_1_52 >= var_1_42) ? (var_1_28 == ((unsigned short int) (((max (var_1_30 , 54742)) - var_1_38) - (var_1_26 + (max (var_1_27 , var_1_25)))))) : 1))) && ((last_1_var_1_58 == last_1_var_1_13) ? (var_1_31 == ((unsigned long int) (min ((var_1_32 - var_1_21) , (var_1_14 + var_1_27))))) : 1)) && (((16.4 + var_1_42) <= ((var_1_52 + 63.8) + (max (var_1_52 , var_1_8)))) ? (var_1_33 == ((signed char) var_1_25)) : 1)) && (var_1_34 == ((signed char) (-1 - (max (var_1_35 , var_1_36)))))) && (((- last_1_var_1_65) != last_1_var_1_58) ? (var_1_37 == ((signed long int) (var_1_21 + (last_1_var_1_65 + var_1_24)))) : (var_1_37 == ((signed long int) var_1_16)))) && (var_1_20 ? (var_1_38 == ((unsigned short int) (max (var_1_26 , ((var_1_27 + var_1_35) + 1))))) : (var_1_38 == ((unsigned short int) (var_1_35 + var_1_25))))) && (((var_1_52 != var_1_8) || ((var_1_32 * var_1_30) <= (var_1_14 * var_1_35))) ? (var_1_39 == ((unsigned long int) 1u)) : ((var_1_32 <= (var_1_40 - var_1_17)) ? (var_1_39 == ((unsigned long int) ((min (var_1_32 , var_1_41)) - (min ((abs (var_1_28)) , var_1_24))))) : (var_1_50 ? (var_1_39 == ((unsigned long int) (min ((var_1_13 + (min (var_1_28 , var_1_25))) , var_1_61)))) : (var_1_39 == ((unsigned long int) ((max (var_1_27 , var_1_61)) + var_1_24))))))) && (((max (var_1_52 , (var_1_52 * var_1_8))) < var_1_46) ? (var_1_42 == ((float) (abs (var_1_43)))) : 1)) && ((var_1_35 == ((var_1_13 / var_1_25) * var_1_27)) ? (var_1_44 == ((signed short int) ((max (var_1_36 , var_1_35)) - var_1_45))) : (var_1_12 ? (var_1_44 == ((signed short int) var_1_36)) : (var_1_44 == ((signed short int) var_1_27))))) && ((var_1_35 > var_1_18) ? (var_1_46 == ((float) (var_1_47 - var_1_48))) : (((var_1_40 - var_1_38) <= ((var_1_32 - var_1_14) / (abs (var_1_41)))) ? (var_1_46 == ((float) (var_1_48 - var_1_47))) : ((var_1_6 || var_1_22) ? (var_1_46 == ((float) (var_1_49 + 128.5f))) : 1)))) && ((var_1_1 || var_1_22) ? (var_1_50 == ((unsigned char) (var_1_1 || var_1_10))) : (var_1_50 == ((unsigned char) (var_1_12 || var_1_22))))) && (var_1_51 == ((unsigned char) (var_1_6 && var_1_7)))) && (var_1_52 == ((double) ((abs (var_1_49)) - var_1_48)))) && (var_1_7 ? (var_1_53 == ((unsigned short int) (max (var_1_36 , (var_1_30 - (var_1_54 - var_1_27)))))) : ((var_1_15 <= (var_1_31 + var_1_37)) ? (var_1_53 == ((unsigned short int) ((var_1_30 - (var_1_57 - var_1_24)) - var_1_25))) : (var_1_53 == ((unsigned short int) (var_1_26 + var_1_24)))))) && ((((var_1_53 + var_1_37) % var_1_54) > (var_1_57 - 256)) ? ((var_1_12 && var_1_9) ? ((var_1_31 > var_1_61) ? (var_1_58 == ((unsigned long int) ((min ((var_1_59 - 5u) , var_1_32)) - (max (var_1_64 , (var_1_60 - var_1_28)))))) : ((var_1_52 > (- (var_1_48 - var_1_47))) ? (var_1_58 == ((unsigned long int) (min (var_1_26 , var_1_64)))) : (var_1_58 == ((unsigned long int) ((max ((min (var_1_32 , var_1_59)) , (abs (var_1_41)))) - var_1_14))))) : 1) : ((var_1_41 >= (- (1u / var_1_32))) ? (var_1_58 == ((unsigned long int) (var_1_54 + (abs (abs (var_1_45)))))) : (var_1_58 == ((unsigned long int) (8u + (min (var_1_28 , (var_1_60 - var_1_27))))))))) && (var_1_11 ? ((var_1_32 != last_1_var_1_28) ? (var_1_61 == ((unsigned long int) (var_1_32 - 16u))) : (var_1_61 == ((unsigned long int) (var_1_32 - var_1_21)))) : (var_1_61 == ((unsigned long int) (((last_1_var_1_28 + var_1_62) + (var_1_63 - 5u)) + (max (last_1_var_1_53 , var_1_54))))))) && ((var_1_18 <= var_1_45) ? ((var_1_5 && var_1_10) ? ((var_1_42 >= var_1_46) ? (var_1_64 == ((signed long int) var_1_30)) : 1) : 1) : (var_1_64 == ((signed long int) 128)))) && (((var_1_13 * (var_1_39 / var_1_25)) >= var_1_26) ? ((var_1_61 != var_1_59) ? (var_1_65 == ((signed short int) (1 - var_1_36))) : 1) : (var_1_65 == ((signed short int) 128)))
;
}
int main(void) {
	isInitial = 1;
