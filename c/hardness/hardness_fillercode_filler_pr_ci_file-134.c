...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch134Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch134Filler_PR_CI
	/* 1010L, 270L, 794L, 800L) */ var_1_20 = (
		var_1_7
	);


	// From: Req8Batch134Filler_PR_CI
	/* 1016L, 280L, 818L, 824L) */ var_1_21 = (
		var_1_7
	);


	// From: Req4Batch134Filler_PR_CI
	...
	// From: CodeObject2
	/* 247L, 83L) */ if (/* 248L, 50L, 51L) */ ((var_1_1) >= (var_1_5))) {
