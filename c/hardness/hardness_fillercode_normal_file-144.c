...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch144normal.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch144normal
	if (var_1_8 >= last_1_var_1_22) {
		var_1_15 = (var_1_17 && var_1_18);
	}


	// From: Req2Batch144normal
	var_1_7 = (min (var_1_8 , ((var_1_9 - var_1_10) + var_1_11)));


	// From: Req8Batch144normal
	var_1_26 = (var_1_17 && var_1_27);


	// From: Req7Batch144normal
	...
	if (stepLocal_0 == (var_1_3 ^ var_1_4)) {
		if (var_1_15 && stepLocal_1) {
			...
			var_1_1 = (min ((var_1_2 + var_1_3) , var_1_4));
		}
	}


	// From: Req6Batch144normal
	if (var_1_18 || (var_1_5 && var_1_15)) {
		var_1_22 = var_1_1;
	}


	// From: Req3Batch144normal
	if (((var_1_22 * var_1_9) <= var_1_1) || var_1_15) {
		var_1_12 = (var_1_13 + var_1_14);
	}


	// From: Req5Batch144normal
	unsigned long int stepLocal_2 = var_1_22;
	if ((var_1_22 / var_1_20) <= stepLocal_2) {
		if (var_1_26) {
			var_1_19 = ((var_1_21 + (abs (var_1_13))) - (abs (abs (1000000.625f))));
		} else {
			var_1_19 = var_1_13;
		}
	}
	...
	// From: Req9Batch144normal
	signed short int stepLocal_4 = var_1_11;
	if (var_1_21 < var_1_12) {
		if (stepLocal_4 >= (min (var_1_4 , var_1_7))) {
			if (var_1_17) {
				var_1_28 = var_1_25;
			} else {
				var_1_28 = 32;
...
int property(void) {
	return (((((((((var_1_2 == (var_1_3 ^ var_1_4)) ? ((var_1_15 && var_1_26) ? (var_1_1 == ((signed long int) var_1_2)) : (var_1_1 == ((signed long int) (min ((var_1_2 + var_1_3) , var_1_4))))) : 1) && (var_1_7 == ((signed short int) (min (var_1_8 , ((var_1_9 - var_1_10) + var_1_11)))))) && ((((var_1_22 * var_1_9) <= var_1_1) || var_1_15) ? (var_1_12 == ((double) (var_1_13 + var_1_14))) : 1)) && ((var_1_8 >= last_1_var_1_22) ? (var_1_15 == ((unsigned char) (var_1_17 && var_1_18))) : 1)) && (((var_1_22 / var_1_20) <= var_1_22) ? (var_1_26 ? (var_1_19 == ((float) ((var_1_21 + (abs (var_1_13))) - (abs (abs (1000000.625f)))))) : (var_1_19 == ((float) var_1_13))) : 1)) && ((var_1_18 || (var_1_5 && var_1_15)) ? (var_1_22 == ((unsigned long int) var_1_1)) : 1)) && ((var_1_17 && var_1_26) ? (var_1_23 == ((signed char) (var_1_24 - var_1_25))) : 1)) && (var_1_26 == ((unsigned char) (var_1_17 && var_1_27)))) && ((var_1_21 < var_1_12) ? ((var_1_11 >= (min (var_1_4 , var_1_7))) ? (var_1_17 ? (var_1_28 == ((unsigned char) var_1_25)) : (var_1_28 == ((unsigned char) 32))) : 1) : (var_1_28 == ((unsigned char) var_1_25)))
;
}
int main(void) {
	isInitial = 1;
