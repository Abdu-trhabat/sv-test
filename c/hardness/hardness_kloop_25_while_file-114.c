...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11425_while.c", 13, "reach_error"); }
...
float var_1_7 = 127.5;
float var_1_8 = 255.1;
float var_1_9 = 49.625;
signed char var_1_10 = -2;
float var_1_11 = 128.625;
float var_1_12 = 63.5;
...
void step(void) {
	...
	// From: Req2Batch11425_while
	signed long int stepLocal_1 = var_1_4 / -128;
	if (2 <= stepLocal_1) {
	...
	// From: Req3Batch11425_while
	signed short int stepLocal_4 = var_1_5;
	unsigned char stepLocal_3 = var_1_1 < var_1_5;
	unsigned char stepLocal_2 = var_1_15;
	if (((var_1_11 - var_1_12) > (- var_1_9)) && stepLocal_3) {
		if (var_1_13) {
			if (var_1_14 && stepLocal_2) {
				if ((var_1_1 / var_1_16) != stepLocal_4) {
					var_1_10 = var_1_17;
				} else {
					var_1_10 = var_1_18;
				}
...
int property(void) {
	return (((var_1_2 > var_1_3) ? (var_1_1 == ((signed short int) (min (var_1_4 , var_1_5)))) : (var_1_1 == ((signed short int) 32))) && ((2 <= (var_1_4 / -128)) ? (var_1_6 == ((float) ((min (var_1_7 , var_1_8)) + var_1_9))) : (var_1_6 == ((float) var_1_9)))) && ((((var_1_11 - var_1_12) > (- var_1_9)) && (var_1_1 < var_1_5)) ? (var_1_13 ? ((var_1_14 && var_1_15) ? (((var_1_1 / var_1_16) != var_1_5) ? (var_1_10 == ((signed char) var_1_17)) : (var_1_10 == ((signed char) var_1_18))) : 1) : (var_1_10 == ((signed char) var_1_17))) : 1)
;
}
int main(void) {
	isInitial = 1;
