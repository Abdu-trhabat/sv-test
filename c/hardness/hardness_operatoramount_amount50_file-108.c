...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch108Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch108Amount50
	if (var_1_15) {
		var_1_22 = ((max (var_1_23 , var_1_24)) - var_1_25);
	}


	// From: Req7Batch108Amount50
	if (var_1_15) {
		if (var_1_21 >= 2) {
			var_1_26 = var_1_10;
		} else {
