...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch97Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (127.5f > float_Array_0[1][1]) {
		BOOL_unsigned_char_Array_0[0] = (BOOL_unsigned_char_Array_0[2] && BOOL_unsigned_char_Array_0[1]);
	} else {
		BOOL_unsigned_char_Array_0[0] = ((float_Array_0[1][1] >= float_Array_0[0][1]) || BOOL_unsigned_char_Array_0[2]);
	}
