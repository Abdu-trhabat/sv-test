...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch197stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch197stepLocals
	if (var_1_7 || var_1_10) {
		if (var_1_6 < (min (var_1_5 , var_1_1))) {
			if (var_1_3 < (var_1_11 - var_1_12)) {
				var_1_9 = var_1_13;
			} else {
				var_1_9 = 32.89f;
			}
	...
	// From: Req4Batch197stepLocals
	if (var_1_3 < (var_1_9 + var_1_11)) {
		var_1_14 = (var_1_15 - var_1_16);
	}


	// From: Req5Batch197stepLocals
	if (var_1_7 && var_1_10) {
	...
	// From: Req7Batch197stepLocals
	var_1_22 = var_1_13;


	// From: Req8Batch197stepLocals
	var_1_23 = var_1_20;
}
