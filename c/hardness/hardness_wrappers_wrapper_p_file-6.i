...
void step(void) {
 if (((*(var_1_7_Pointer)) >> ((*(var_1_8_Pointer)) + (*(var_1_9_Pointer)))) >= (((((last_1_var_1_1 + (*(var_1_5_Pointer)))) > ((*(var_1_3_Pointer)))) ? ((last_1_var_1_1 + (*(var_1_5_Pointer)))) : ((*(var_1_3_Pointer)))))) {
 ...
 if ((- (*(var_1_11_Pointer))) != (*(var_1_12_Pointer))) {
  (*(var_1_10_Pointer)) = ((*(var_1_13_Pointer)) - ((*(var_1_4_Pointer)) + (((((*(var_1_6_Pointer))) < ((*(var_1_3_Pointer)))) ? ((*(var_1_6_Pointer))) : ((*(var_1_3_Pointer)))))));
 }
 unsigned long int stepLocal_1 = (((((*(var_1_10_Pointer))) > ((*(var_1_6_Pointer)))) ? ((*(var_1_10_Pointer))) : ((*(var_1_6_Pointer))))) / (*(var_1_4_Pointer));
 ...
 if (stepLocal_2 == ((*(var_1_4_Pointer)) | -5)) {
  (*(var_1_14_Pointer)) = ((((1.5f) > ((*(var_1_15_Pointer)))) ? (1.5f) : ((*(var_1_15_Pointer)))));
 }
}
void updateVariables(void) {
...
int property(void) {
 return ((((((((((*(var_1_10_Pointer))) > ((*(var_1_6_Pointer)))) ? ((*(var_1_10_Pointer))) : ((*(var_1_6_Pointer))))) / (*(var_1_4_Pointer))) > (*(var_1_10_Pointer))) ? (((*(var_1_10_Pointer)) == (*(var_1_6_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned long int) 1000000000u)) : ((*(var_1_1_Pointer)) == ((unsigned long int) 128u))) : 1) && ((((*(var_1_7_Pointer)) >> ((*(var_1_8_Pointer)) + (*(var_1_9_Pointer)))) >= (((((last_1_var_1_1 + (*(var_1_5_Pointer)))) > ((*(var_1_3_Pointer)))) ? ((last_1_var_1_1 + (*(var_1_5_Pointer)))) : ((*(var_1_3_Pointer)))))) ? ((*(var_1_6_Pointer)) == ((unsigned short int) (*(var_1_8_Pointer)))) : (((*(var_1_4_Pointer)) < 64) ? ((*(var_1_6_Pointer)) == ((unsigned short int) (*(var_1_7_Pointer)))) : 1))) && (((- (*(var_1_11_Pointer))) != (*(var_1_12_Pointer))) ? ((*(var_1_10_Pointer)) == ((unsigned long int) ((*(var_1_13_Pointer)) - ((*(var_1_4_Pointer)) + (((((*(var_1_6_Pointer))) < ((*(var_1_3_Pointer)))) ? ((*(var_1_6_Pointer))) : ((*(var_1_3_Pointer))))))))) : 1)) && (((*(var_1_9_Pointer)) == ((*(var_1_4_Pointer)) | -5)) ? ((*(var_1_14_Pointer)) == ((float) ((((1.5f) > ((*(var_1_15_Pointer)))) ? (1.5f) : ((*(var_1_15_Pointer))))))) : 1)
;
}
int main(void) {
 isInitial = 1;
