...
void step(void) {
	...
	// From: CodeObject2
	/* 310L, 155L) */ if (/* 311L, 108L, 109L) */ ((/* 312L, 106L, 110L) */ ((var_1_16) / (/* 314L, 105L, 112L) */ ((var_1_30) + (var_1_31))))) >= (var_1_27))) {
	...
	// From: CodeObject6
	/* 364L, 244L) */ if (/* 365L, 216L, 217L) */ ((/* 366L, 214L, 218L) */ ((-100000) + (var_1_16))) >= (var_1_33))) {
		/* 370L, 233L) */ var_1_38 = (
			/* 373L, 232L) */ ((
				var_1_27
			) - (
