...
void step(void) {
	...
	// From: Req10Batch156Amount250
	var_1_39 = (var_1_25 + var_1_36);


	// From: Req3Batch156Amount250
	var_1_20 = (min ((var_1_21 - (var_1_14 + 8)) , var_1_17));


	// From: Req4Batch156Amount250
	var_1_22 = (var_1_23 + 9.6);


	// From: Req8Batch156Amount250
	if ((1u * var_1_13) < (var_1_15 + var_1_17)) {
		var_1_31 = (min (var_1_23 , (var_1_9 - (abs (var_1_32)))));
	} else {
		var_1_31 = (min (((var_1_33 - var_1_34) - var_1_9) , (var_1_23 + var_1_35)));
	}


	// From: Req16Batch156Amount250
	if (var_1_7 < var_1_22) {
		var_1_50 = var_1_45;
	} else {
	...
	// From: Req17Batch156Amount250
	var_1_53 = (abs (max (var_1_44 , 4)));


	// From: Req20Batch156Amount250
	if ((- (- 0.75)) > (var_1_23 / var_1_8)) {
		var_1_56 = ((var_1_18 + 16) + var_1_44);
	} else {
		var_1_56 = (min (var_1_13 , (var_1_44 - var_1_25)));
	}


	// From: Req23Batch156Amount250
	if (! (var_1_13 > var_1_49)) {
		var_1_61 = var_1_46;
	}


	// From: Req7Batch156Amount250
	...
	// From: Req18Batch156Amount250
	if (var_1_13 < (min (var_1_40 , var_1_39))) {
		var_1_54 = (max (var_1_9 , (min ((max (var_1_23 , 64.25f)) , var_1_33))));
	} else {
		var_1_54 = (var_1_34 + var_1_35);
	}


	// From: Req6Batch156Amount250
	if ((var_1_22 + var_1_8) <= (max (var_1_7 , var_1_59))) {
		var_1_26 = var_1_27;
	} else {
	...
	// From: Req19Batch156Amount250
	if (var_1_46) {
		var_1_55 = ((var_1_64 + (var_1_47 + last_1_var_1_55)) + (var_1_44 + var_1_17));
	} else {
		var_1_55 = (min (-64 , (var_1_27 + var_1_47)));
	}


	// From: Req1Batch156Amount250
	unsigned char stepLocal_0 = ! (var_1_9 == var_1_59);
	if ((var_1_54 / (min (var_1_3 , var_1_4))) >= (var_1_31 * var_1_54)) {
	...
	// From: Req2Batch156Amount250
	signed long int stepLocal_2 = (min (var_1_13 , 50)) << (var_1_17 + var_1_18);
	signed char stepLocal_1 = var_1_13;
	if (var_1_59 < var_1_7) {
		if (var_1_61) {
			var_1_16 = (var_1_15 + (max (var_1_14 , var_1_1)));
		} else {
			var_1_16 = (abs (var_1_1));
		}
	} else {
	...
	// From: Req21Batch156Amount250
	unsigned long int stepLocal_14 = var_1_14 * (~ var_1_40);
	if (256.6 != (min ((- var_1_22) , (var_1_33 / var_1_58)))) {
		if (stepLocal_14 <= var_1_16) {
			var_1_57 = (max ((var_1_49 - var_1_30) , var_1_64));
		} else {
			var_1_57 = ((min ((var_1_30 - var_1_40) , var_1_44)) + 16);
		}
	}


	// From: Req12Batch156Amount250
	signed long int stepLocal_10 = -500;
	unsigned long int stepLocal_9 = (max (var_1_18 , var_1_47)) / (max (var_1_19 , var_1_37));
	if (2u > stepLocal_9) {
	...
	// From: Req15Batch156Amount250
	signed long int stepLocal_13 = var_1_57 + var_1_25;
	if (((abs (var_1_21)) >> var_1_44) >= stepLocal_13) {
...
int property(void) {
	return ((((((((((((((((((((((((((var_1_54 / (min (var_1_3 , var_1_4))) >= (var_1_31 * var_1_54)) ? ((var_1_4 > (var_1_7 - (var_1_8 - var_1_9))) ? (((! (var_1_9 == var_1_59)) || var_1_43) ? (var_1_1 == ((signed char) (var_1_12 - (var_1_13 - (var_1_14 + var_1_15))))) : (var_1_1 == ((signed char) var_1_15))) : (var_1_1 == ((signed char) var_1_14))) : (var_1_1 == ((signed char) -64))) && ((var_1_59 < var_1_7) ? (var_1_61 ? (var_1_16 == ((signed long int) (var_1_15 + (max (var_1_14 , var_1_1))))) : (var_1_16 == ((signed long int) (abs (var_1_1))))) : ((var_1_15 != var_1_13) ? ((var_1_22 > 7.5f) ? (var_1_16 == ((signed long int) (var_1_12 + (var_1_13 + (var_1_14 - var_1_15))))) : 1) : ((((min (var_1_13 , 50)) << (var_1_17 + var_1_18)) >= ((var_1_19 - var_1_15) - var_1_14)) ? (var_1_16 == ((signed long int) var_1_15)) : 1)))) && (var_1_20 == ((unsigned char) (min ((var_1_21 - (var_1_14 + 8)) , var_1_17))))) && (var_1_22 == ((double) (var_1_23 + 9.6)))) && ((var_1_3 < ((var_1_23 / var_1_4) + var_1_22)) ? ((var_1_47 < (var_1_17 + -2)) ? (var_1_24 == ((unsigned char) var_1_21)) : ((var_1_3 <= (var_1_22 * var_1_54)) ? (var_1_24 == ((unsigned char) (var_1_17 + var_1_18))) : 1)) : (var_1_24 == ((unsigned char) ((var_1_17 + var_1_18) + (var_1_14 + 8)))))) && (((var_1_22 + var_1_8) <= (max (var_1_7 , var_1_59))) ? (var_1_26 == ((signed short int) var_1_27)) : (var_1_26 == ((signed short int) (var_1_40 + var_1_20))))) && ((var_1_50 || var_1_61) ? (var_1_28 == ((unsigned short int) (var_1_13 + var_1_17))) : ((var_1_62 > var_1_53) ? (var_1_28 == ((unsigned short int) (var_1_62 + (var_1_30 - var_1_18)))) : (var_1_28 == ((unsigned short int) (var_1_14 + var_1_13)))))) && (((1u * var_1_13) < (var_1_15 + var_1_17)) ? (var_1_31 == ((float) (min (var_1_23 , (var_1_9 - (abs (var_1_32))))))) : (var_1_31 == ((float) (min (((var_1_33 - var_1_34) - var_1_9) , (var_1_23 + var_1_35))))))) && (((var_1_62 + var_1_13) >= var_1_62) ? (var_1_36 == ((signed long int) (var_1_18 - var_1_62))) : ((5u > (var_1_37 - 4u)) ? (var_1_36 == ((signed long int) var_1_38)) : (var_1_36 == ((signed long int) 256))))) && (var_1_39 == ((signed long int) (var_1_25 + var_1_36)))) && (((var_1_14 * (~ var_1_30)) > var_1_28) ? (var_1_40 == ((unsigned long int) ((var_1_19 - var_1_62) + var_1_13))) : (var_1_40 == ((unsigned long int) var_1_28)))) && ((2u > ((max (var_1_18 , var_1_47)) / (max (var_1_19 , var_1_37)))) ? ((-500 > var_1_14) ? (var_1_50 ? (var_1_41 == ((signed char) var_1_14)) : (var_1_41 == ((signed char) var_1_25))) : 1) : (var_1_41 == ((signed char) var_1_12)))) && ((var_1_21 > (var_1_18 >> var_1_44)) ? (((last_1_var_1_64 + var_1_19) >= (last_1_var_1_55 ^ var_1_25)) ? (var_1_43 == ((unsigned char) (last_1_var_1_50 && var_1_45))) : (var_1_43 == ((unsigned char) (last_1_var_1_50 || var_1_46)))) : (var_1_43 == ((unsigned char) (var_1_46 && var_1_45))))) && ((var_1_14 == var_1_27) ? ((var_1_54 >= var_1_22) ? (var_1_47 == ((signed long int) (var_1_25 - var_1_18))) : ((var_1_29 || var_1_43) ? (var_1_47 == ((signed long int) var_1_62)) : 1)) : 1)) && ((((abs (var_1_21)) >> var_1_44) >= (var_1_57 + var_1_25)) ? (var_1_48 == ((unsigned short int) (var_1_49 - var_1_44))) : 1)) && ((var_1_7 < var_1_22) ? (var_1_50 == ((unsigned char) var_1_45)) : (((var_1_23 * (10.8 / var_1_4)) > var_1_9) ? (var_1_50 == ((unsigned char) (var_1_45 || var_1_51))) : (var_1_50 == ((unsigned char) ((var_1_45 || var_1_51) || var_1_52)))))) && (var_1_53 == ((signed char) (abs (max (var_1_44 , 4)))))) && ((var_1_13 < (min (var_1_40 , var_1_39))) ? (var_1_54 == ((float) (max (var_1_9 , (min ((max (var_1_23 , 64.25f)) , var_1_33)))))) : (var_1_54 == ((float) (var_1_34 + var_1_35))))) && (var_1_46 ? (var_1_55 == ((signed long int) ((var_1_64 + (var_1_47 + last_1_var_1_55)) + (var_1_44 + var_1_17)))) : (var_1_55 == ((signed long int) (min (-64 , (var_1_27 + var_1_47))))))) && (((- (- 0.75)) > (var_1_23 / var_1_8)) ? (var_1_56 == ((signed char) ((var_1_18 + 16) + var_1_44))) : (var_1_56 == ((signed char) (min (var_1_13 , (var_1_44 - var_1_25))))))) && ((256.6 != (min ((- var_1_22) , (var_1_33 / var_1_58)))) ? (((var_1_14 * (~ var_1_40)) <= var_1_16) ? (var_1_57 == ((unsigned short int) (max ((var_1_49 - var_1_30) , var_1_64)))) : (var_1_57 == ((unsigned short int) ((min ((var_1_30 - var_1_40) , var_1_44)) + 16)))) : 1)) && ((last_1_var_1_50 || (256.4 >= var_1_9)) ? (((- last_1_var_1_48) > 10) ? (var_1_59 == ((float) 99.6f)) : (var_1_59 == ((float) (var_1_34 + var_1_35)))) : (var_1_46 ? (var_1_59 == ((float) (var_1_34 - var_1_60))) : 1))) && ((! (var_1_13 > var_1_49)) ? (var_1_61 == ((unsigned char) var_1_46)) : 1)) && (((var_1_21 - var_1_63) > last_1_var_1_20) ? (last_1_var_1_43 ? (var_1_62 == ((unsigned short int) var_1_21)) : (var_1_62 == ((unsigned short int) last_1_var_1_28))) : 1)) && (((! (last_1_var_1_55 >= last_1_var_1_41)) || var_1_45) ? ((((64 * var_1_49) == last_1_var_1_40) && (last_1_var_1_48 == var_1_15)) ? (var_1_64 == ((signed long int) var_1_18)) : (var_1_64 == ((signed long int) last_1_var_1_64))) : 1)
;
}
int main(void) {
	isInitial = 1;
