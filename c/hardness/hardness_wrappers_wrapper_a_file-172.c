...
void step(void) {
	...
	if (unsigned_short_int_Array_0[0] < unsigned_short_int_Array_0[1]) {
		...
		signed_long_int_Array_0[1][1] = (max (-4 , ((max (128 , unsigned_short_int_Array_0[1])) - signed_long_int_Array_0[0][0])));
	}


	// From: Req3Batch172Wrapper_A
	signed_short_int_Array_0[2] = (min (signed_short_int_Array_0[0] , signed_short_int_Array_0[1]));


	// From: Req4Batch172Wrapper_A
	...
	if (stepLocal_0 && (signed_long_int_Array_0[1][1] != signed_long_int_Array_0[0][0])) {
		float_Array_0[1] = (float_Array_0[2] + (max (3.25f , float_Array_0[0])));
	}


	// From: Req5Batch172Wrapper_A
	unsigned_char_Array_0[1] = unsigned_char_Array_0[2];


	// From: Req6Batch172Wrapper_A
	BOOL_unsigned_char_Array_0[0][0] = BOOL_unsigned_char_Array_0[0][1];


	// From: Req7Batch172Wrapper_A
	unsigned_char_Array_0[0] = unsigned_char_Array_0[2];


	// From: Req1Batch172Wrapper_A
...
int property(void) {
	return (((((((unsigned_short_int_Array_0[1] >= unsigned_short_int_Array_0[0]) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) (BOOL_unsigned_char_Array_0[0][0] || BOOL_unsigned_char_Array_0[0][1]))) : ((unsigned_short_int_Array_0[1] >= unsigned_short_int_Array_0[0]) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0])) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1])))) && ((unsigned_short_int_Array_0[0] < unsigned_short_int_Array_0[1]) ? (signed_long_int_Array_0[1][1] == ((signed long int) (unsigned_short_int_Array_0[1] + ((unsigned_short_int_Array_0[0] + signed_long_int_Array_0[1][0]) + (signed_long_int_Array_0[0][0] - signed_long_int_Array_0[0][1]))))) : (signed_long_int_Array_0[1][1] == ((signed long int) (max (-4 , ((max (128 , unsigned_short_int_Array_0[1])) - signed_long_int_Array_0[0][0]))))))) && (signed_short_int_Array_0[2] == ((signed short int) (min (signed_short_int_Array_0[0] , signed_short_int_Array_0[1]))))) && ((BOOL_unsigned_char_Array_0[0][1] && (signed_long_int_Array_0[1][1] != signed_long_int_Array_0[0][0])) ? (float_Array_0[1] == ((float) (float_Array_0[2] + (max (3.25f , float_Array_0[0]))))) : 1)) && (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[2]))) && (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1]))) && (unsigned_char_Array_0[0] == ((unsigned char) unsigned_char_Array_0[2]))
;
}
int main(void) {
	isInitial = 1;
