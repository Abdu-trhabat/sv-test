...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch19850_while.c", 13, "reach_error"); }
...
int property(void) {
 return ((((((var_1_1 == ((signed char) ((((8) < ((var_1_2 + (var_1_3 + var_1_4)))) ? (8) : ((var_1_2 + (var_1_3 + var_1_4))))))) && ((var_1_6 && (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))) != var_1_4)) ? (var_1_5 == ((unsigned short int) ((((var_1_8) > (var_1_9)) ? (var_1_8) : (var_1_9))))) : (var_1_5 == ((unsigned short int) var_1_9)))) && ((var_1_8 > var_1_20) ? (var_1_6 ? ((var_1_9 <= ((((var_1_8) > (var_1_20)) ? (var_1_8) : (var_1_20)))) ? (var_1_10 == ((signed long int) var_1_20)) : (var_1_10 == ((signed long int) ((var_1_20 - (var_1_11 - var_1_8)) + 16)))) : (var_1_10 == ((signed long int) var_1_8))) : (var_1_10 == ((signed long int) var_1_20)))) && ((var_1_10 > var_1_9) ? (var_1_6 ? (var_1_12 == ((unsigned long int) (var_1_13 - ((((var_1_11) > (var_1_9)) ? (var_1_11) : (var_1_9)))))) : 1) : (var_1_12 == ((unsigned long int) var_1_8)))) && ((var_1_6 && var_1_15) ? (var_1_14 == ((unsigned char) ((64 - 4) + var_1_16))) : 1)) && ((var_1_2 > ((64 - var_1_18) - var_1_16)) ? ((((var_1_19 - var_1_16) - ((((var_1_18) < (32)) ? (var_1_18) : (32)))) >= ((((last_1_var_1_20) < ((var_1_8 / var_1_11))) ? (last_1_var_1_20) : ((var_1_8 / var_1_11))))) ? (var_1_17 == ((unsigned short int) var_1_9)) : 1) : (var_1_17 == ((unsigned short int) var_1_9)))) && (var_1_20 == ((signed long int) var_1_17))
;
}
int main(void) {
 isInitial = 1;
