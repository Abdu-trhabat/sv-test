...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch61100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req13Batch61100_while
	var_1_33 = (max (0 , var_1_12));


	// From: Req12Batch61100_while
	...
	// From: Req14Batch61100_while
	var_1_34 = var_1_24;


	// From: Req15Batch61100_while
	var_1_35 = 256;
