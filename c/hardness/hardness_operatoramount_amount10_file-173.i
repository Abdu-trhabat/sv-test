...
void step(void) {
 ...
 if (stepLocal_0 && var_1_9) {
  var_1_7 = (8 - ((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11))));
 }
}
void updateVariables(void) {
...
int property(void) {
 return ((var_1_2 > var_1_3) ? (var_1_1 == ((signed short int) ((((var_1_4) < ((var_1_5 + var_1_6))) ? (var_1_4) : ((var_1_5 + var_1_6)))))) : 1) && ((var_1_8 && var_1_9) ? (var_1_7 == ((signed long int) (8 - ((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11)))))) : 1)
;
}
int main(void) {
 isInitial = 1;
