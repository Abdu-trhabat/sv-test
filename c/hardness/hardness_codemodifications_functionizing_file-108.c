...
void functionized0(float functionized0_localFunctionVar0, signed char functionized0_localFunctionVar1) {
	if ((functionized0_localFunctionVar1 * (max (var_1_3 , var_1_4))) != 4) {
...
unsigned char functionized3(signed long int functionized3_localFunctionVar0) {
	return ((var_1_18 + functionized3_localFunctionVar0) >= (abs (var_1_7 + var_1_10)));
}
...
signed long int functionized5(unsigned char functionized5_localFunctionVar0) {
	return ((max (functionized5_localFunctionVar0 , var_1_24)) - var_1_25);
}
...
void step(void) {
	// From: Req1Batch108functionizing
	functionized0(var_1_5, var_1_2);


	// From: Req2Batch108functionizing
	...
	// From: Req3Batch108functionizing
	if (var_1_14) {
		var_1_13 = var_1_9;
	} else {
		if (var_1_15) {
	...
	// From: Req4Batch108functionizing
	...
	// From: Req5Batch108functionizing
	if (var_1_9 < var_1_19) {
		if (functionized4(0)) {
			var_1_20 = var_1_21;
		}
	...
	// From: Req6Batch108functionizing
	if (var_1_15) {
		var_1_22 = functionized5(var_1_23);
	}


	// From: Req7Batch108functionizing
	if (var_1_15) {
		if (var_1_21 >= 2) {
			var_1_26 = var_1_10;
		} else {
