...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13050_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch13050_1loop
	var_1_10 = (var_1_4 - 256);


	// From: Req5Batch13050_1loop
	...
	// From: Req8Batch13050_1loop
	var_1_26 = (min ((var_1_21 + 4u) , (var_1_10 + var_1_18)));


	// From: Req1Batch13050_1loop
