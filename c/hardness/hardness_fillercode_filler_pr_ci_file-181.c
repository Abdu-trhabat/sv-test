...
void step(void) {
	...
	/* 500L, 358L) */ if (var_1_7) {
		/* 502L, 356L) */ if (/* 503L, 334L, 335L) */ ((var_1_3) <= (/* 505L, 333L, 337L) */ ((5) % (/* 507L, 332L, 339L) */ (max (/* 507L, 332L, 339L) */ (var_1_42) , (var_1_51)))))))) {
			/* 510L, 355L) */ var_1_50 = (
				/* 513L, 354L) */ (abs (
					/* 514L, 353L) */ (min (
						/* 514L, 353L) */ (
	...
	// From: CodeObject5
	/* 414L, 259L) */ if (/* 415L, 222L, 223L) */ ((var_1_35) > (/* 417L, 221L, 225L) */ (max (/* 417L, 221L, 225L) */ (var_1_1) , (/* 419L, 220L, 227L) */ ((var_1_40) / (var_1_17)))))))) {
	...
	// From: CodeObject6
	/* 441L, 321L) */ if (/* 442L, 271L, 272L) */ ((/* 443L, 269L, 273L) */ ((/* 444L, 265L, 274L) */ (- (var_1_22))) ^ (/* 446L, 268L, 276L) */ (min (/* 446L, 268L, 276L) */ (var_1_38) , (var_1_35)))))) > (var_1_16))) {
	...
	// From: CodeObject2
	/* 381L, 182L) */ if (/* 382L, 166L, 167L) */ ((/* 383L, 164L, 168L) */ ((var_1_25) * (var_1_28))) > (var_1_24))) {
		/* 387L, 181L) */ var_1_31 = (
			/* 390L, 180L) */ (abs (
				var_1_35
			))
