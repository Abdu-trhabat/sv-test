...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch36functionizing.c", 13, "reach_error"); }
...
void functionized1(unsigned short int, double);
unsigned char functionized2(unsigned short int, unsigned short int);
...
void functionized0(unsigned short int functionized0_localFunctionVar0, unsigned short int functionized0_localFunctionVar1, unsigned short int functionized0_localFunctionVar2) {
 var_1_8 = (((((functionized0_localFunctionVar2) < (functionized0_localFunctionVar1)) ? (functionized0_localFunctionVar2) : (functionized0_localFunctionVar1))) - functionized0_localFunctionVar0);
}
void functionized1(unsigned short int functionized1_localFunctionVar0, double functionized1_localFunctionVar1) {
 if (functionized1_localFunctionVar1 >= var_1_14) {
  if (var_1_2) {
   if (var_1_8 == functionized1_localFunctionVar0) {
    var_1_15 = 10.975f;
   }
  }
 }
}
unsigned char functionized2(unsigned short int functionized2_localFunctionVar0, unsigned short int functionized2_localFunctionVar1) {
 return ((var_1_10 + functionized2_localFunctionVar1) <= functionized2_localFunctionVar0);
}
signed long int functionized3(signed short int functionized3_localFunctionVar0) {
 return (functionized3_localFunctionVar0 - ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21))));
}
unsigned char functionized4(double functionized4_localFunctionVar0) {
 return (var_1_13 < functionized4_localFunctionVar0);
}
void initially(void) {
}
void step(void) {
