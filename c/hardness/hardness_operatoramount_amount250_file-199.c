...
void step(void) {
	// From: Req12Batch199Amount250
	if ((last_1_var_1_65 % (max (var_1_17 , var_1_28))) <= var_1_31) {
		if ((abs (4)) < var_1_16) {
			if (last_1_var_1_47) {
	...
	// From: Req6Batch199Amount250
	signed char stepLocal_4 = var_1_32;
	if (last_1_var_1_63 == stepLocal_4) {
		var_1_33 = (min ((max (var_1_31 , (min (var_1_30 , var_1_17)))) , var_1_32));
	}


	// From: Req20Batch199Amount250
	if (var_1_31 <= (var_1_33 | var_1_52)) {
		var_1_63 = (max (var_1_17 , 50u));
	} else {
		var_1_63 = var_1_52;
	}


	// From: Req1Batch199Amount250
	...
	// From: Req3Batch199Amount250
	var_1_19 = (min ((var_1_17 + var_1_20) , var_1_21));


	// From: Req10Batch199Amount250
	var_1_44 = ((var_1_38 - var_1_46) - var_1_39);


	// From: Req11Batch199Amount250
	if (var_1_16 > var_1_21) {
		var_1_47 = 0;
	}


	// From: Req15Batch199Amount250
	unsigned char stepLocal_6 = var_1_47;
	if ((var_1_32 > var_1_63) && stepLocal_6) {
		var_1_54 = (max (((var_1_46 + var_1_36) + 255.75f) , var_1_9));
	} else {
		var_1_54 = (((max (var_1_45 , var_1_38)) - var_1_46) - var_1_39);
	}


	// From: Req18Batch199Amount250
	...
	// From: Req22Batch199Amount250
	if (var_1_57) {
		var_1_65 = -100;
	}


	// From: Req14Batch199Amount250
	...
	// From: Req2Batch199Amount250
	signed long int stepLocal_3 = (min (var_1_15 , var_1_16)) >> var_1_17;
	signed long int stepLocal_2 = var_1_65;
	if (1 < stepLocal_2) {
		var_1_10 = (var_1_12 && ((var_1_63 > var_1_65) || var_1_14));
	} else {
		if (stepLocal_3 > (abs (var_1_18))) {
			var_1_10 = var_1_14;
		}
	}


	// From: Req4Batch199Amount250
	if ((var_1_1 * 256.8) == var_1_9) {
		if ((max (var_1_7 , var_1_6)) <= var_1_1) {
	...
	// From: Req5Batch199Amount250
	if (((var_1_26 - var_1_17) - var_1_27) >= var_1_15) {
		var_1_25 = (var_1_20 + var_1_17);
	} else {
		if (! var_1_24) {
			if (var_1_44 != (var_1_9 * (min (var_1_8 , var_1_7)))) {
				var_1_25 = (abs (var_1_20 + var_1_17));
			} else {
				var_1_25 = ((max ((var_1_28 - var_1_17) , var_1_29)) - (max ((min (var_1_30 , var_1_31)) , var_1_32)));
			}
		} else {
			var_1_25 = (max ((max (var_1_20 , (min (var_1_32 , var_1_28)))) , var_1_31));
		}
	}


	// From: Req8Batch199Amount250
	if (var_1_57) {
		var_1_41 = var_1_25;
	}


	// From: Req9Batch199Amount250
	unsigned long int stepLocal_5 = var_1_63;
	if ((var_1_29 - (var_1_43 - var_1_17)) >= stepLocal_5) {
		var_1_42 = ((min (var_1_37 , var_1_35)) + 4.9f);
	} else {
		if (((var_1_38 - var_1_40) * var_1_54) <= (var_1_37 * var_1_36)) {
			var_1_42 = (min ((var_1_37 + 10.5f) , var_1_8));
		}
	}


	// From: Req13Batch199Amount250
	if ((var_1_31 * var_1_30) == var_1_65) {
		if (var_1_57) {
			var_1_50 = (min ((max (var_1_32 , var_1_27)) , (var_1_52 - var_1_16)));
		}
	}


	// From: Req17Batch199Amount250
	if (var_1_37 < var_1_42) {
		var_1_56 = ((min (49.3 , var_1_36)) + var_1_39);
	}


	// From: Req21Batch199Amount250
	if (var_1_53) {
		var_1_64 = (max (var_1_28 , var_1_17));
	}


	// From: Req23Batch199Amount250
	unsigned long int stepLocal_11 = (var_1_26 - var_1_43) - var_1_17;
	if (! ((max (-8 , var_1_50)) > var_1_62)) {
		var_1_66 = var_1_62;
	} else {
	...
	// From: Req7Batch199Amount250
	if (var_1_6 > var_1_23) {
		var_1_34 = (32.9 + (var_1_35 + var_1_36));
	} else {
		if (var_1_7 <= var_1_56) {
			var_1_34 = (min (((var_1_35 + var_1_36) + var_1_37) , -0.8));
		} else {
			if (var_1_1 >= var_1_36) {
				if (var_1_57) {
	...
	// From: Req16Batch199Amount250
	signed long int stepLocal_8 = var_1_18;
	signed char stepLocal_7 = var_1_28;
	if (((max (var_1_56 , var_1_46)) / var_1_23) == (min (199.4 , (var_1_1 / var_1_38)))) {
		if (stepLocal_7 == var_1_15) {
			if (var_1_17 == stepLocal_8) {
				var_1_55 = ((min (var_1_17 , var_1_32)) - var_1_30);
			} else {
				var_1_55 = (abs (var_1_20));
			}
		} else {
			if (var_1_8 < var_1_34) {
	...
	// From: Req19Batch199Amount250
	unsigned long int stepLocal_10 = var_1_50;
	if (var_1_56 != (min (var_1_36 , var_1_39))) {
		if (var_1_38 >= var_1_56) {
			var_1_58 = var_1_31;
		}
	} else {
		if (((max (var_1_30 , var_1_29)) - var_1_17) == stepLocal_10) {
			var_1_58 = var_1_65;
		} else {
			var_1_58 = ((var_1_61 - (min (256 , var_1_17))) - (var_1_62 - var_1_55));
		}
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((- last_1_var_1_34) < (0.125f + last_1_var_1_44)) ? ((last_1_var_1_53 || (last_1_var_1_47 || (last_1_var_1_34 > last_1_var_1_44))) ? (var_1_1 == ((double) (abs (min (var_1_6 , var_1_7))))) : ((last_1_var_1_47 || last_1_var_1_53) ? (var_1_1 == ((double) (min (var_1_6 , (max (var_1_7 , (max (var_1_8 , var_1_9)))))))) : 1)) : (last_1_var_1_47 ? (var_1_1 == ((double) var_1_8)) : (var_1_1 == ((double) 8.25)))) && ((1 < var_1_65) ? (var_1_10 == ((unsigned char) (var_1_12 && ((var_1_63 > var_1_65) || var_1_14)))) : ((((min (var_1_15 , var_1_16)) >> var_1_17) > (abs (var_1_18))) ? (var_1_10 == ((unsigned char) var_1_14)) : 1))) && (var_1_19 == ((signed char) (min ((var_1_17 + var_1_20) , var_1_21))))) && (((var_1_1 * 256.8) == var_1_9) ? (((max (var_1_7 , var_1_6)) <= var_1_1) ? (var_1_22 == ((unsigned char) ((var_1_6 > (var_1_9 / var_1_23)) && var_1_24))) : 1) : ((! var_1_24) ? (((16 > var_1_15) && var_1_47) ? (var_1_22 == ((unsigned char) (var_1_24 || var_1_12))) : (var_1_22 == ((unsigned char) var_1_14))) : (var_1_22 == ((unsigned char) var_1_24))))) && ((((var_1_26 - var_1_17) - var_1_27) >= var_1_15) ? (var_1_25 == ((signed char) (var_1_20 + var_1_17))) : ((! var_1_24) ? ((var_1_44 != (var_1_9 * (min (var_1_8 , var_1_7)))) ? (var_1_25 == ((signed char) (abs (var_1_20 + var_1_17)))) : (var_1_25 == ((signed char) ((max ((var_1_28 - var_1_17) , var_1_29)) - (max ((min (var_1_30 , var_1_31)) , var_1_32)))))) : (var_1_25 == ((signed char) (max ((max (var_1_20 , (min (var_1_32 , var_1_28)))) , var_1_31))))))) && ((last_1_var_1_63 == var_1_32) ? (var_1_33 == ((unsigned char) (min ((max (var_1_31 , (min (var_1_30 , var_1_17)))) , var_1_32)))) : 1)) && ((var_1_6 > var_1_23) ? (var_1_34 == ((double) (32.9 + (var_1_35 + var_1_36)))) : ((var_1_7 <= var_1_56) ? (var_1_34 == ((double) (min (((var_1_35 + var_1_36) + var_1_37) , -0.8)))) : ((var_1_1 >= var_1_36) ? (var_1_57 ? (var_1_34 == ((double) ((var_1_38 - var_1_39) - var_1_40))) : ((500.75f > var_1_56) ? (var_1_34 == ((double) 63.65)) : (var_1_34 == ((double) var_1_38)))) : (var_1_34 == ((double) var_1_6)))))) && (var_1_57 ? (var_1_41 == ((signed short int) var_1_25)) : 1)) && (((var_1_29 - (var_1_43 - var_1_17)) >= var_1_63) ? (var_1_42 == ((float) ((min (var_1_37 , var_1_35)) + 4.9f))) : ((((var_1_38 - var_1_40) * var_1_54) <= (var_1_37 * var_1_36)) ? (var_1_42 == ((float) (min ((var_1_37 + 10.5f) , var_1_8)))) : 1))) && (var_1_44 == ((float) ((var_1_38 - var_1_46) - var_1_39)))) && ((var_1_16 > var_1_21) ? (var_1_47 == ((unsigned char) 0)) : 1)) && (((last_1_var_1_65 % (max (var_1_17 , var_1_28))) <= var_1_31) ? (((abs (4)) < var_1_16) ? (last_1_var_1_47 ? ((last_1_var_1_65 == var_1_17) ? (var_1_48 == ((unsigned char) (var_1_14 && var_1_12))) : (var_1_48 == ((unsigned char) (! var_1_14)))) : (var_1_48 == ((unsigned char) (var_1_12 || (last_1_var_1_53 || (! var_1_24)))))) : (var_1_48 == ((unsigned char) (var_1_24 || var_1_49)))) : (var_1_48 == ((unsigned char) var_1_12)))) && (((var_1_31 * var_1_30) == var_1_65) ? (var_1_57 ? (var_1_50 == ((unsigned long int) (min ((max (var_1_32 , var_1_27)) , (var_1_52 - var_1_16))))) : 1) : 1)) && ((var_1_18 == var_1_16) ? ((var_1_48 && (var_1_63 < var_1_65)) ? (var_1_53 == ((unsigned char) (var_1_24 || var_1_49))) : (var_1_53 == ((unsigned char) var_1_49))) : 1)) && (((var_1_32 > var_1_63) && var_1_47) ? (var_1_54 == ((float) (max (((var_1_46 + var_1_36) + 255.75f) , var_1_9)))) : (var_1_54 == ((float) (((max (var_1_45 , var_1_38)) - var_1_46) - var_1_39))))) && ((((max (var_1_56 , var_1_46)) / var_1_23) == (min (199.4 , (var_1_1 / var_1_38)))) ? ((var_1_28 == var_1_15) ? ((var_1_17 == var_1_18) ? (var_1_55 == ((signed short int) ((min (var_1_17 , var_1_32)) - var_1_30))) : (var_1_55 == ((signed short int) (abs (var_1_20))))) : ((var_1_8 < var_1_34) ? (var_1_55 == ((signed short int) ((var_1_50 + var_1_31) + var_1_17))) : (var_1_55 == ((signed short int) var_1_28)))) : 1)) && ((var_1_37 < var_1_42) ? (var_1_56 == ((double) ((min (49.3 , var_1_36)) + var_1_39))) : 1)) && ((var_1_16 > (var_1_30 ^ var_1_17)) ? ((! var_1_49) ? (var_1_57 == ((unsigned char) ((var_1_28 > 25) && var_1_24))) : (var_1_57 == ((unsigned char) var_1_14))) : 1)) && ((var_1_56 != (min (var_1_36 , var_1_39))) ? ((var_1_38 >= var_1_56) ? (var_1_58 == ((signed short int) var_1_31)) : 1) : ((((max (var_1_30 , var_1_29)) - var_1_17) == var_1_50) ? (var_1_58 == ((signed short int) var_1_65)) : (var_1_58 == ((signed short int) ((var_1_61 - (min (256 , var_1_17))) - (var_1_62 - var_1_55))))))) && ((var_1_31 <= (var_1_33 | var_1_52)) ? (var_1_63 == ((unsigned long int) (max (var_1_17 , 50u)))) : (var_1_63 == ((unsigned long int) var_1_52)))) && (var_1_53 ? (var_1_64 == ((signed char) (max (var_1_28 , var_1_17)))) : 1)) && (var_1_57 ? (var_1_65 == ((signed long int) -100)) : 1)) && ((! ((max (-8 , var_1_50)) > var_1_62)) ? (var_1_66 == ((signed short int) var_1_62)) : ((var_1_52 <= ((var_1_26 - var_1_43) - var_1_17)) ? (var_1_66 == ((signed short int) var_1_31)) : 1))
;
}
int main(void) {
	isInitial = 1;
