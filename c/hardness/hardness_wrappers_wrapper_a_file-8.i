...
void step(void) {
 ...
 if ((~ ((((unsigned_long_int_Array_0[0]) < (signed_long_int_Array_0[0][1])) ? (unsigned_long_int_Array_0[0]) : (signed_long_int_Array_0[0][1])))) <= (signed_long_int_Array_0[1][0] % 1u)) {
