...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch135stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch135stepLocals
	unsigned long int stepLocal_1 = var_1_3;
	if ((var_1_4 | (var_1_2 + var_1_10)) >= stepLocal_1) {
		if (var_1_8) {
			var_1_12 = var_1_13;
		}
	}
	...
	// From: Req5Batch135stepLocals
	if ((- (var_1_6 * var_1_1)) < var_1_21) {
		var_1_20 = (min (var_1_6 , var_1_22));
	}


	// From: Req6Batch135stepLocals
