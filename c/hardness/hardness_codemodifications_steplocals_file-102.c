...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch102stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch102stepLocals
	var_1_1 = ((var_1_2 - var_1_3) + var_1_4);


	// From: Req2Batch102stepLocals
	signed long int stepLocal_0 = var_1_7;
	if ((var_1_6 * -64) == stepLocal_0) {
	...
	// From: Req3Batch102stepLocals
	var_1_9 = (min (var_1_10 , var_1_4));


	// From: Req4Batch102stepLocals
	signed long int stepLocal_1 = var_1_7;
	if (var_1_10 >= var_1_2) {
		if ((var_1_6 - var_1_12) <= stepLocal_1) {
			var_1_11 = var_1_13;
		}
	}


	// From: Req5Batch102stepLocals
	if (var_1_8 > ((min (var_1_9 , var_1_11)) + var_1_1)) {
		if (var_1_15) {
			var_1_14 = var_1_12;
		}
	}
	...
	// From: Req7Batch102stepLocals
	var_1_19 = (var_1_20 + (var_1_21 + (var_1_22 + 4)));


	// From: Req8Batch102stepLocals
