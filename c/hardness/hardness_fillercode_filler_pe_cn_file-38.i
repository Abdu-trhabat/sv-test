...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch38Filler_PE_CN.c", 13, "reach_error"); }
 ...
 signed long int stepLocal_0 = var_1_12;
  ...
  var_1_34
    ...
    16
             ...
             if ( ((-2) > ( (( ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))) | ( ((-10) * (var_1_37))))))) {
              var_1_36 = (
               ((((( ((((( 25 )) < (( var_1_26 ))) ? (( 25 )) : (( var_1_26 )))) )) > (( (((((( var_1_31 ) + ( var_1_32 ))) < 0 ) ? -((( var_1_31 ) + ( var_1_32 ))) : ((( var_1_31 ) + ( var_1_32 ))))) ))) ? (( ((((( 25 )) < (( var_1_26 ))) ? (( 25 )) : (( var_1_26 )))) )) : (( (((((( var_1_31 ) + ( var_1_32 ))) < 0 ) ? -((( var_1_31 ) + ( var_1_32 ))) : ((( var_1_31 ) + ( var_1_32 ))))) ))))
  );
 } else {
              if ( (( ((((var_1_37) < 0 ) ? -(var_1_37) : (var_1_37)))) <= ( ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))))) {
               if ( (( ((var_1_37) * ( (((((var_1_35)) > ((var_1_32))) ? ((var_1_35)) : ((var_1_32))))))) <= (var_1_26))) {
                var_1_36 = (
