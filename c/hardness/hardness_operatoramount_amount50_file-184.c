...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch184Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch184Amount50
	if (var_1_14 <= (max (var_1_13 , (var_1_18 - var_1_19)))) {
		var_1_17 = var_1_6;
	}


	// From: Req1Batch184Amount50
