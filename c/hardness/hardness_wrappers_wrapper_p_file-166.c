...
void step(void) {
	...
	// From: Req4Batch166Wrapper_P
	(*(var_1_17_Pointer)) = (*(var_1_11_Pointer));


	// From: Req5Batch166Wrapper_P
	(*(var_1_18_Pointer)) = (*(var_1_16_Pointer));


	// From: Req2Batch166Wrapper_P
	unsigned char stepLocal_1 = (*(var_1_6_Pointer));
	if (stepLocal_1 || (*(var_1_7_Pointer))) {
		(*(var_1_5_Pointer)) = (min ((*(var_1_17_Pointer)) , ((*(var_1_4_Pointer)) - ((*(var_1_8_Pointer)) - 100000))));
	} else {
		(*(var_1_5_Pointer)) = 10;
	}


	// From: Req3Batch166Wrapper_P
	...
	if ((*(var_1_5_Pointer)) > stepLocal_4) {
		if (stepLocal_3 && ((*(var_1_5_Pointer)) < ((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))))) {
			if (stepLocal_2 < ((*(var_1_12_Pointer)) | 100)) {
				if (9.99999999999999E13 <= (min ((*(var_1_13_Pointer)) , ((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))))) {
...
int property(void) {
	return ((((((*(var_1_2_Pointer)) < (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (*(var_1_4_Pointer)))) : 1) && (((*(var_1_6_Pointer)) || (*(var_1_7_Pointer))) ? ((*(var_1_5_Pointer)) == ((signed long int) (min ((*(var_1_17_Pointer)) , ((*(var_1_4_Pointer)) - ((*(var_1_8_Pointer)) - 100000)))))) : ((*(var_1_5_Pointer)) == ((signed long int) 10)))) && (((*(var_1_5_Pointer)) > (*(var_1_8_Pointer))) ? (((*(var_1_6_Pointer)) && ((*(var_1_5_Pointer)) < ((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))))) ? ((((*(var_1_17_Pointer)) + (*(var_1_5_Pointer))) < ((*(var_1_12_Pointer)) | 100)) ? ((9.99999999999999E13 <= (min ((*(var_1_13_Pointer)) , ((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))))) ? ((*(var_1_9_Pointer)) == ((float) (*(var_1_16_Pointer)))) : ((*(var_1_9_Pointer)) == ((float) 15.4f))) : ((*(var_1_9_Pointer)) == ((float) (*(var_1_16_Pointer))))) : ((*(var_1_9_Pointer)) == ((float) 7.25f))) : 1)) && ((*(var_1_17_Pointer)) == ((unsigned long int) (*(var_1_11_Pointer))))) && ((*(var_1_18_Pointer)) == ((float) (*(var_1_16_Pointer))))
;
}
int main(void) {
	isInitial = 1;
