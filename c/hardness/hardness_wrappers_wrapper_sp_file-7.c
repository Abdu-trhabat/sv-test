...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_8_Pointer))) {
		if (stepLocal_1 || (*(WrapperStruct00_var_1_11_Pointer))) {
			...
			(*(WrapperStruct00_var_1_10_Pointer)) = (abs ((*(WrapperStruct00_var_1_14_Pointer)) - ((*(WrapperStruct00_var_1_13_Pointer)) + (*(WrapperStruct00_var_1_15_Pointer)))));
		}
	} else {
		(*(WrapperStruct00_var_1_10_Pointer)) = (max ((*(WrapperStruct00_var_1_12_Pointer)) , (*(WrapperStruct00_var_1_15_Pointer))));
	}


	// From: Req1Batch7Wrapper_SP
