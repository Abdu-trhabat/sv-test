...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch2750_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (! var_1_2) {
		if (var_1_2 || var_1_3) {
			...
			if ((max (var_1_9 , var_1_22)) >= var_1_8) {
