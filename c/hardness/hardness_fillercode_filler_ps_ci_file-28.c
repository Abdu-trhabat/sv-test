...
void step(void) {
	...
	/* 335L, 209L) */ if (/* 336L, 139L, 140L) */ ((var_1_34) <= (var_1_11))) {
		...
		/* 347L, 207L) */ if (/* 348L, 156L, 157L) */ ((var_1_17) < (var_1_29))) {
			/* 351L, 169L) */ var_1_37 = (
				/* 354L, 168L) */ (min (
					/* 354L, 168L) */ (
						-8
	...
	// From: CodeObject7
	/* 372L, 262L) */ if (/* 373L, 225L, 226L) */ ((/* 374L, 219L, 227L) */ (abs (/* 375L, 218L, 228L) */ (abs (64))))) <= (/* 377L, 224L, 230L) */ ((var_1_15) ^ (/* 379L, 223L, 232L) */ ((var_1_15) % (var_1_40))))))) {
		/* 382L, 252L) */ var_1_39 = (
			/* 385L, 251L) */ ((
				/* 386L, 249L) */ (abs (
					/* 387L, 248L) */ (max (
