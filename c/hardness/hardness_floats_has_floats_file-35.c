...
int property(void) {
	return (((((((var_1_16 + var_1_8) < var_1_4) ? ((var_1_16 <= (min (var_1_8 , var_1_4))) ? (var_1_1 == ((float) var_1_5)) : 1) : (var_1_1 == ((float) 10.0f))) && (((min (var_1_15 , var_1_16)) < var_1_15) ? (var_1_6 == ((double) (max (var_1_5 , var_1_7)))) : 1)) && (var_1_9 ? (var_1_8 == ((unsigned char) (var_1_10 + var_1_11))) : ((var_1_16 < ((var_1_10 << var_1_15) ^ var_1_12)) ? ((var_1_12 <= var_1_15) ? (var_1_8 == ((unsigned char) (var_1_13 - var_1_10))) : 1) : (var_1_8 == ((unsigned char) (abs (max (var_1_13 , var_1_11)))))))) && (var_1_14 == ((float) var_1_7))) && (var_1_15 == ((unsigned long int) var_1_13))) && (var_1_16 == ((signed short int) var_1_15))
;
}
int main(void) {
	isInitial = 1;
