...
void step(void) {
	...
	// From: Req4Batch151100_while
	var_1_14 = ((var_1_3 && (! var_1_15)) || (var_1_16 || var_1_17));


	// From: Req9Batch151100_while
	...
	// From: Req11Batch151100_while
	if ((var_1_28 / var_1_31) > (var_1_7 % -5)) {
		var_1_30 = (128 - 16);
	}


	// From: Req12Batch151100_while
	var_1_32 = var_1_24;


	// From: Req14Batch151100_while
	var_1_36 = var_1_10;


	// From: Req2Batch151100_while
