...
void step(void) {
	...
	/* 412L, 271L) */ if (/* 413L, 200L, 201L) */ ((var_1_42) <= (/* 415L, 199L, 203L) */ (abs (/* 416L, 198L, 204L) */ (abs (var_1_24))))))) {
		/* 418L, 265L) */ if (/* 419L, 214L, 215L) */ ((/* 420L, 212L, 216L) */ (abs (var_1_43))) >= (var_1_38))) {
			/* 423L, 226L) */ var_1_47 = (
				var_1_48
			);
		} else {
			/* 427L, 263L) */ if (/* 428L, 233L, 234L) */ ((/* 429L, 229L, 235L) */ ((var_1_26) * (var_1_27))) >= (/* 432L, 232L, 238L) */ ((var_1_33) / (var_1_49))))) {
				/* 435L, 261L) */ if (/* 436L, 250L, 251L) */ ((var_1_44) && (var_1_45))) {
					/* 439L, 260L) */ var_1_47 = (
						var_1_48
					);
				}
	...
	// From: CodeObject2
	/* 379L, 167L) */ if (/* 380L, 145L, 146L) */ ((/* 381L, 143L, 147L) */ (abs (var_1_37))) <= (var_1_38))) {
		/* 384L, 159L) */ var_1_36 = (
			/* 387L, 158L) */ (max (
				/* 387L, 158L) */ (
					var_1_39
