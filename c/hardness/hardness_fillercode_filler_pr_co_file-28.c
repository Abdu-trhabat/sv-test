...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch28Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	/* 305L, 89L) */ if (/* 306L, 79L, 80L) */ (! (var_1_28))) {
		/* 308L, 88L) */ var_1_30 = (
			/* 311L, 87L) */ (abs (
				var_1_31
			))
	...
	// From: CodeObject7
	/* 372L, 262L) */ if (/* 373L, 225L, 226L) */ ((/* 374L, 219L, 227L) */ (abs (/* 375L, 218L, 228L) */ (abs (64))))) <= (/* 377L, 224L, 230L) */ ((var_1_6) ^ (/* 379L, 223L, 232L) */ ((var_1_11) % (var_1_40))))))) {
		/* 382L, 252L) */ var_1_39 = (
			/* 385L, 251L) */ ((
				/* 386L, 249L) */ (abs (
					/* 387L, 248L) */ (max (
	...
	// From: CodeObject2
	/* 294L, 74L) */ if (/* 295L, 57L, 58L) */ ((/* 296L, 55L, 59L) */ ((var_1_25) < (/* 298L, 54L, 61L) */ (abs (var_1_26))))) || (var_1_28))) {
		/* 301L, 73L) */ var_1_27 = (
			var_1_29
		);
	}
	...
	/* 335L, 209L) */ if (/* 336L, 139L, 140L) */ ((var_1_34) <= (var_1_11))) {
		...
		/* 347L, 207L) */ if (/* 348L, 156L, 157L) */ ((var_1_15) < (var_1_29))) {
			/* 351L, 169L) */ var_1_37 = (
				/* 354L, 168L) */ (min (
					/* 354L, 168L) */ (
						-8
