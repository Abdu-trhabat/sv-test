...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch157no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch157no_floats
	var_1_14 = (((abs (-1)) + (var_1_15 + var_1_16)) - (min (64 , var_1_17)));


	// From: Req1Batch157no_floats
