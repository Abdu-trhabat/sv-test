...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch129Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (last_1_signed_long_int_Array_0_0_ > (unsigned_short_int_Array_0[0][0] - unsigned_short_int_Array_0[0][1])) {
 ...
 if (BOOL_unsigned_char_Array_0[2]) {
  if (((((5) > (last_1_unsigned_short_int_Array_0_1__1_)) ? (5) : (last_1_unsigned_short_int_Array_0_1__1_))) < stepLocal_1) {
   if (! BOOL_unsigned_char_Array_0[0]) {
    ...
    unsigned_short_int_Array_0[1][1] = 1;
   }
  }
 } else {
  unsigned_short_int_Array_0[1][1] = unsigned_short_int_Array_0[1][0];
 }
 unsigned short int stepLocal_2 = unsigned_short_int_Array_0[1][1];
 if (BOOL_unsigned_char_Array_0[2]) {
  if (unsigned_short_int_Array_0[1][0] <= stepLocal_2) {
   if (((((10.4) < (double_Array_0[1])) ? (10.4) : (double_Array_0[1]))) < (double_Array_0[3] * double_Array_0[4])) {
    double_Array_0[0] = double_Array_0[2];
   } else {
    double_Array_0[0] = 64.6;
   }
  }
 }
}
...
int property(void) {
 return ((((! BOOL_unsigned_char_Array_0[1]) ? ((signed_char_Array_0[1] > signed_char_Array_0[0]) ? (BOOL_unsigned_char_Array_0[2] == ((unsigned char) (BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]))) : ((! BOOL_unsigned_char_Array_0[0]) ? (BOOL_unsigned_char_Array_0[2] == ((unsigned char) BOOL_unsigned_char_Array_0[0])) : 1)) : (BOOL_unsigned_char_Array_0[2] == ((unsigned char) BOOL_unsigned_char_Array_0[0]))) && (BOOL_unsigned_char_Array_0[2] ? ((((((5) > (last_1_unsigned_short_int_Array_0_1__1_)) ? (5) : (last_1_unsigned_short_int_Array_0_1__1_))) < signed_long_int_Array_0[0]) ? ((! BOOL_unsigned_char_Array_0[0]) ? (unsigned_short_int_Array_0[1][1] == ((unsigned short int) unsigned_short_int_Array_0[1][0])) : (unsigned_short_int_Array_0[1][1] == ((unsigned short int) 1))) : 1) : (unsigned_short_int_Array_0[1][1] == ((unsigned short int) unsigned_short_int_Array_0[1][0])))) && ((last_1_signed_long_int_Array_0_0_ > (unsigned_short_int_Array_0[0][0] - unsigned_short_int_Array_0[0][1])) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_short_int_Array_0[0][0])) : 1)) && (BOOL_unsigned_char_Array_0[2] ? ((unsigned_short_int_Array_0[1][0] <= unsigned_short_int_Array_0[1][1]) ? ((((((10.4) < (double_Array_0[1])) ? (10.4) : (double_Array_0[1]))) < (double_Array_0[3] * double_Array_0[4])) ? (double_Array_0[0] == ((double) double_Array_0[2])) : (double_Array_0[0] == ((double) 64.6))) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
