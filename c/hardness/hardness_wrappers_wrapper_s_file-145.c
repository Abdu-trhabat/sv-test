...
void step(void) {
	...
	// From: Req4Batch145Wrapper_S
	unsigned short int stepLocal_3 = WrapperStruct00.var_1_8;
	if (WrapperStruct00.var_1_14 <= (min (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_16))) {
		if ((min (WrapperStruct00.var_1_9 , (WrapperStruct00.var_1_9 & WrapperStruct00.var_1_5))) < stepLocal_3) {
			WrapperStruct00.var_1_15 = WrapperStruct00.var_1_6;
		} else {
			WrapperStruct00.var_1_15 = (min ((min (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_6)) , WrapperStruct00.var_1_17));
		}
	} else {
		WrapperStruct00.var_1_15 = WrapperStruct00.var_1_6;
	}
...
int property(void) {
	return (((((WrapperStruct00.var_1_2 + WrapperStruct00.var_1_3) <= WrapperStruct00.var_1_4) ? (WrapperStruct00.var_1_1 == ((unsigned short int) ((WrapperStruct00.var_1_5 + (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7)) - WrapperStruct00.var_1_8))) : 1) && ((((10 > WrapperStruct00.var_1_10) && WrapperStruct00.var_1_11) || WrapperStruct00.var_1_12) ? ((WrapperStruct00.var_1_5 >= WrapperStruct00.var_1_10) ? (WrapperStruct00.var_1_9 == ((signed long int) WrapperStruct00.var_1_8)) : 1) : (WrapperStruct00.var_1_9 == ((signed long int) WrapperStruct00.var_1_1)))) && ((WrapperStruct00.var_1_9 != WrapperStruct00.var_1_8) ? (WrapperStruct00.var_1_13 == ((double) WrapperStruct00.var_1_14)) : 1)) && ((WrapperStruct00.var_1_14 <= (min (WrapperStruct00.var_1_13 , WrapperStruct00.var_1_16))) ? (((min (WrapperStruct00.var_1_9 , (WrapperStruct00.var_1_9 & WrapperStruct00.var_1_5))) < WrapperStruct00.var_1_8) ? (WrapperStruct00.var_1_15 == ((signed short int) WrapperStruct00.var_1_6)) : (WrapperStruct00.var_1_15 == ((signed short int) (min ((min (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_6)) , WrapperStruct00.var_1_17))))) : (WrapperStruct00.var_1_15 == ((signed short int) WrapperStruct00.var_1_6)))
;
}
int main(void) {
	isInitial = 1;
