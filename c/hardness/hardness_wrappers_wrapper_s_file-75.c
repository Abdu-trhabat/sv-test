...
void step(void) {
	...
	signed long int stepLocal_0 = max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_6);
	...
	if ((- WrapperStruct00.var_1_9) >= WrapperStruct00.var_1_10) {
		if (WrapperStruct00.var_1_11) {
			WrapperStruct00.var_1_8 = (abs ((min (WrapperStruct00.var_1_2 , last_1_WrapperStruct00_var_1_8)) + (max (WrapperStruct00.var_1_1 , WrapperStruct00.var_1_3))));
		} else {
	...
	if (2.8f == WrapperStruct00.var_1_10) {
		WrapperStruct00.var_1_12 = ((max ((max (WrapperStruct00.var_1_13 , 16)) , WrapperStruct00.var_1_14)) + WrapperStruct00.var_1_15);
	}


	// From: Req4Batch75Wrapper_S
	WrapperStruct00.var_1_16 = (min (-4 , WrapperStruct00.var_1_14));
...
int property(void) {
	return (((((((last_1_WrapperStruct00_var_1_1 * last_1_WrapperStruct00_var_1_8) * last_1_WrapperStruct00_var_1_8) < (max (WrapperStruct00.var_1_5 , WrapperStruct00.var_1_6))) ? (WrapperStruct00.var_1_1 == ((unsigned char) WrapperStruct00.var_1_7)) : (WrapperStruct00.var_1_1 == ((unsigned char) 10))) && (((- WrapperStruct00.var_1_9) >= WrapperStruct00.var_1_10) ? (WrapperStruct00.var_1_11 ? (WrapperStruct00.var_1_8 == ((signed short int) (abs ((min (WrapperStruct00.var_1_2 , last_1_WrapperStruct00_var_1_8)) + (max (WrapperStruct00.var_1_1 , WrapperStruct00.var_1_3)))))) : (WrapperStruct00.var_1_8 == ((signed short int) (WrapperStruct00.var_1_3 + WrapperStruct00.var_1_1)))) : 1)) && ((2.8f == WrapperStruct00.var_1_10) ? (WrapperStruct00.var_1_12 == ((signed char) ((max ((max (WrapperStruct00.var_1_13 , 16)) , WrapperStruct00.var_1_14)) + WrapperStruct00.var_1_15))) : 1)) && (WrapperStruct00.var_1_16 == ((signed char) (min (-4 , WrapperStruct00.var_1_14))))) && ((WrapperStruct00.var_1_1 > (WrapperStruct00.var_1_8 + WrapperStruct00.var_1_16)) ? (WrapperStruct00.var_1_17 == ((float) WrapperStruct00.var_1_18)) : 1)
;
}
int main(void) {
	isInitial = 1;
