...
void step(void) {
	// From: Req1Batch13625_while
	unsigned char stepLocal_0 = var_1_4 <= var_1_5;
	if (var_1_2) {
		if (var_1_3) {
			var_1_1 = (var_1_4 + var_1_5);
		} else {
			var_1_1 = ((min ((var_1_6 + var_1_7) , var_1_8)) - var_1_5);
		}
	} else {
	...
	// From: Req2Batch13625_while
	if ((max ((var_1_11 - var_1_12) , var_1_6)) <= (min (var_1_8 , (max (var_1_1 , var_1_5))))) {
		if (var_1_12 <= var_1_1) {
			var_1_10 = var_1_12;
		}
	} else {
	...
	// From: Req3Batch13625_while
	var_1_13 = var_1_12;


	// From: Req4Batch13625_while
	var_1_14 = 10.5f;


	// From: Req5Batch13625_while
	var_1_15 = var_1_16;
}
...
int property(void) {
	return ((((var_1_2 ? (var_1_3 ? (var_1_1 == ((unsigned long int) (var_1_4 + var_1_5))) : (var_1_1 == ((unsigned long int) ((min ((var_1_6 + var_1_7) , var_1_8)) - var_1_5)))) : (((var_1_4 <= var_1_5) && var_1_9) ? (var_1_1 == ((unsigned long int) var_1_6)) : 1)) && (((max ((var_1_11 - var_1_12) , var_1_6)) <= (min (var_1_8 , (max (var_1_1 , var_1_5))))) ? ((var_1_12 <= var_1_1) ? (var_1_10 == ((signed long int) var_1_12)) : 1) : (var_1_10 == ((signed long int) var_1_12)))) && (var_1_13 == ((signed long int) var_1_12))) && (var_1_14 == ((float) 10.5f))) && (var_1_15 == ((signed char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
