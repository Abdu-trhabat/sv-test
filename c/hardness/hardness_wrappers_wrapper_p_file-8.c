...
void step(void) {
	...
	if ((~ (min ((*(var_1_3_Pointer)) , (*(var_1_8_Pointer))))) <= ((*(var_1_10_Pointer)) % 1u)) {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) >= (8u * (*(var_1_3_Pointer)))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (! ((*(var_1_4_Pointer)) || ((*(var_1_5_Pointer)) || (*(var_1_6_Pointer))))))) : ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_7_Pointer))))) && (((((*(var_1_3_Pointer)) * (*(var_1_2_Pointer))) * ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer)))) >= 1u) ? (((*(var_1_3_Pointer)) <= (*(var_1_10_Pointer))) ? ((*(var_1_8_Pointer)) == ((signed long int) (*(var_1_11_Pointer)))) : ((*(var_1_8_Pointer)) == ((signed long int) 8))) : ((*(var_1_8_Pointer)) == ((signed long int) (*(var_1_11_Pointer)))))) && (((~ (min ((*(var_1_3_Pointer)) , (*(var_1_8_Pointer))))) <= ((*(var_1_10_Pointer)) % 1u)) ? ((*(var_1_12_Pointer)) == ((double) ((*(var_1_13_Pointer)) + ((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))))) : ((*(var_1_12_Pointer)) == ((double) (((*(var_1_16_Pointer)) - (*(var_1_17_Pointer))) - (*(var_1_18_Pointer))))))) && ((*(var_1_19_Pointer)) == ((signed short int) (*(var_1_20_Pointer))))
;
}
int main(void) {
	isInitial = 1;
