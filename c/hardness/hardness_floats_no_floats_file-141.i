...
void step(void) {
 ...
 if (stepLocal_0 >= ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) {
  var_1_10 = 1;
 } else {
  if ((var_1_2 * var_1_3) != var_1_11) {
   var_1_10 = ((! var_1_12) || var_1_13);
  } else {
   var_1_10 = ((var_1_2 < ((((var_1_3) > (var_1_11)) ? (var_1_3) : (var_1_11)))) && (var_1_7 && var_1_13));
  }
 }
 if (var_1_2 < var_1_3) {
  if (var_1_2 > var_1_3) {
...
int property(void) {
 return ((((((var_1_2 < var_1_3) ? ((var_1_2 > var_1_3) ? (var_1_1 == ((signed char) ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))) : 1) : (var_1_1 == ((signed char) (((((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5))) < 0 ) ? -((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5))) : ((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5)))))))) && (last_1_var_1_10 ? (var_1_6 == ((unsigned char) (var_1_8 + var_1_9))) : 1)) && ((var_1_6 >= ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) ? (var_1_10 == ((unsigned char) 1)) : (((var_1_2 * var_1_3) != var_1_11) ? (var_1_10 == ((unsigned char) ((! var_1_12) || var_1_13))) : (var_1_10 == ((unsigned char) ((var_1_2 < ((((var_1_3) > (var_1_11)) ? (var_1_3) : (var_1_11)))) && (var_1_7 && var_1_13))))))) && (var_1_14 == ((signed long int) var_1_6))) && (var_1_15 == ((signed long int) var_1_14))) && (var_1_16 == ((signed char) var_1_4))
;
}
int main(void) {
 isInitial = 1;
