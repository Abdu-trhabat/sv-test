...
void step(void) {
 signed long int stepLocal_2 = (((5) < (((*(var_1_2_Pointer)) * (*(var_1_3_Pointer))))) ? (5) : (((*(var_1_2_Pointer)) * (*(var_1_3_Pointer)))));
...
int property(void) {
 return ((((((((5) < (((*(var_1_2_Pointer)) * (*(var_1_3_Pointer))))) ? (5) : (((*(var_1_2_Pointer)) * (*(var_1_3_Pointer)))))) <= (*(var_1_4_Pointer))) ? (((*(var_1_2_Pointer)) > (*(var_1_3_Pointer))) ? (((- (*(var_1_4_Pointer))) == ((*(var_1_2_Pointer)) * ((*(var_1_3_Pointer)) * 50))) ? ((*(var_1_1_Pointer)) == ((double) ((((((*(var_1_5_Pointer)) - (*(var_1_6_Pointer)))) > ((*(var_1_7_Pointer)))) ? (((*(var_1_5_Pointer)) - (*(var_1_6_Pointer)))) : ((*(var_1_7_Pointer))))))) : 1) : 1) : ((*(var_1_1_Pointer)) == ((double) (*(var_1_6_Pointer))))) && ((((*(var_1_2_Pointer)) * (*(var_1_4_Pointer))) >= -32) ? ((*(var_1_8_Pointer)) == ((unsigned short int) (((*(var_1_9_Pointer)) + (*(var_1_10_Pointer))) + 64))) : ((*(var_1_8_Pointer)) == ((unsigned short int) (*(var_1_9_Pointer)))))) && (((*(var_1_10_Pointer)) >= (*(var_1_8_Pointer))) ? (((*(var_1_9_Pointer)) < (((*(var_1_12_Pointer)) - (*(var_1_10_Pointer))) << (*(var_1_8_Pointer)))) ? ((*(var_1_11_Pointer)) == ((double) (*(var_1_7_Pointer)))) : 1) : 1)) && ((*(var_1_13_Pointer)) == ((signed short int) (*(var_1_10_Pointer))))
;
}
int main(void) {
 isInitial = 1;
