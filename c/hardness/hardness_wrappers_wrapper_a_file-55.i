...
void step(void) {
 ...
 if (stepLocal_3 <= (((((16 >> unsigned_short_int_Array_0[0])) < (last_1_signed_long_int_Array_0_0_)) ? ((16 >> unsigned_short_int_Array_0[0])) : (last_1_signed_long_int_Array_0_0_)))) {
 ...
 if (BOOL_unsigned_char_Array_0[1]) {
  if (stepLocal_1 && BOOL_unsigned_char_Array_0[0]) {
   if (stepLocal_0 >= signed_short_int_Array_0[0]) {
    ...
    unsigned_short_int_Array_0[2] = ((((25) < (unsigned_short_int_Array_0[1])) ? (25) : (unsigned_short_int_Array_0[1])));
   }
  }
 } else {
...
int property(void) {
 return (((((BOOL_unsigned_char_Array_0[1] ? (((signed_short_int_Array_0[1] >= signed_short_int_Array_0[0]) && BOOL_unsigned_char_Array_0[0]) ? ((signed_short_int_Array_0[1] >= signed_short_int_Array_0[0]) ? (unsigned_short_int_Array_0[2] == ((unsigned short int) 5)) : (unsigned_short_int_Array_0[2] == ((unsigned short int) ((((25) < (unsigned_short_int_Array_0[1])) ? (25) : (unsigned_short_int_Array_0[1])))))) : 1) : (unsigned_short_int_Array_0[2] == ((unsigned short int) unsigned_short_int_Array_0[1]))) && (BOOL_unsigned_char_Array_0[1] ? (double_Array_0[3] == ((double) (((double_Array_0[1] + double_Array_0[0]) + double_Array_0[2]) - double_Array_0[4]))) : 1)) && (((~ unsigned_short_int_Array_0[1]) <= (((((16 >> unsigned_short_int_Array_0[0])) < (last_1_signed_long_int_Array_0_0_)) ? ((16 >> unsigned_short_int_Array_0[0])) : (last_1_signed_long_int_Array_0_0_)))) ? (((unsigned_char_Array_0[0] - unsigned_short_int_Array_0[0]) < (last_1_unsigned_short_int_Array_0_2_ / -8)) ? (signed_long_int_Array_0[0] == ((signed long int) last_1_unsigned_short_int_Array_0_2_)) : 1) : (signed_long_int_Array_0[0] == ((signed long int) (last_1_unsigned_long_int_Array_0_0_ - unsigned_short_int_Array_0[0]))))) && (float_Array_0[0] == ((float) double_Array_0[1]))) && (unsigned_long_int_Array_0[0] == ((unsigned long int) signed_long_int_Array_0[0]))) && (unsigned_char_Array_0[1] == ((unsigned char) unsigned_short_int_Array_0[0]))
;
}
int main(void) {
 isInitial = 1;
