...
void step(void) {
	...
	// From: Req2Batch142Amount10
	if (var_1_6) {
		var_1_5 = (max ((min ((min (var_1_3 , var_1_4)) , var_1_7)) , var_1_1));
	} else {
		if (var_1_8) {
			var_1_5 = var_1_7;
		}
...
int property(void) {
	return ((0 > last_1_var_1_5) ? (var_1_1 == ((unsigned char) (var_1_3 - var_1_4))) : 1) && (var_1_6 ? (var_1_5 == ((unsigned long int) (max ((min ((min (var_1_3 , var_1_4)) , var_1_7)) , var_1_1)))) : (var_1_8 ? (var_1_5 == ((unsigned long int) var_1_7)) : 1))
;
}
int main(void) {
	isInitial = 1;
