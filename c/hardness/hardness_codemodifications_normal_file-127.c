...
void step(void) {
	...
	if (! var_1_2) {
		if ((4 + var_1_3) >= (min (var_1_4 , var_1_5))) {
			var_1_1 = var_1_3;
		} else {
			var_1_1 = -128;
		}
	...
	// From: Req5Batch127normal
	var_1_13 = (var_1_14 - var_1_3);


	// From: Req6Batch127normal
	if (var_1_12) {
		var_1_15 = (abs (var_1_16));
	}


	// From: Req7Batch127normal
	if (var_1_12) {
		if ((max (var_1_3 , (var_1_7 * var_1_14))) <= (max (var_1_13 , var_1_5))) {
	...
	// From: Req8Batch127normal
	if ((max (var_1_3 , (var_1_4 * var_1_1))) != var_1_15) {
		var_1_18 = var_1_19;
	} else {
		if (var_1_6 || var_1_2) {
			var_1_18 = var_1_19;
