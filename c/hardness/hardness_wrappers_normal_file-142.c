...
void step(void) {
	...
	if (stepLocal_0 && var_1_12) {
		...
		var_1_10 = (min (var_1_13 , var_1_14));
	}


	// From: Req4Batch142normal
	unsigned long int stepLocal_1 = var_1_2;
	if (stepLocal_1 == (max (var_1_7 , var_1_5))) {
...
int property(void) {
	return (((((var_1_2 <= var_1_3) ? ((var_1_3 <= var_1_2) ? (var_1_1 == ((signed long int) (1 - var_1_4))) : (var_1_1 == ((signed long int) (var_1_4 - var_1_5)))) : 1) && (((var_1_7 - var_1_8) <= 0) ? (var_1_6 == ((double) (abs (var_1_9)))) : 1)) && ((var_1_11 && var_1_12) ? (var_1_10 == ((signed short int) var_1_13)) : (var_1_10 == ((signed short int) (min (var_1_13 , var_1_14)))))) && ((var_1_2 == (max (var_1_7 , var_1_5))) ? (var_1_15 == ((double) (var_1_16 + var_1_17))) : (var_1_15 == ((double) (var_1_18 - var_1_19))))) && ((var_1_19 <= var_1_17) ? ((var_1_3 < var_1_7) ? (var_1_20 == ((double) 199.75)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
