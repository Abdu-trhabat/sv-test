...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch74functionizing.c", 13, "reach_error"); }
...
unsigned char functionized2(unsigned long int, unsigned long int);
unsigned char functionized3(float, float);
void functionized4(unsigned char, signed long int, unsigned char, unsigned char);
...
unsigned char functionized0(signed long int functionized0_localFunctionVar0, signed long int functionized0_localFunctionVar1) {
	return (functionized0_localFunctionVar0 >= functionized0_localFunctionVar1);
}
...
unsigned char functionized2(unsigned long int functionized2_localFunctionVar0, unsigned long int functionized2_localFunctionVar1) {
	return ((functionized2_localFunctionVar0 > functionized2_localFunctionVar1) || var_1_4);
}
unsigned char functionized3(float functionized3_localFunctionVar0, float localFunctionVar1) {
	return ((- (max (functionized3_localFunctionVar0 , var_1_18))) == localFunctionVar1);
}
void functionized4(unsigned char functionized4_localFunctionVar0, signed long int functionized4_localFunctionVar1, unsigned char functionized4_localFunctionVar2, unsigned char functionized4_localFunctionVar3) {
	if (functionized4_localFunctionVar2 && var_1_9) {
		var_1_19 = ((var_1_20 + var_1_21) - (max (functionized4_localFunctionVar3 , functionized4_localFunctionVar1)));
	} else {
...
void step(void) {
	// From: Req1Batch74functionizing
	if (! (functionized0(var_1_2, var_1_3))) {
		if (var_1_4) {
	...
	// From: Req3Batch74functionizing
	if (! (functionized2(var_1_5, var_1_7))) {
	...
	// From: Req4Batch74functionizing
	if (functionized3(var_1_17, 32.2f)) {
		var_1_16 = 10;
	}


	// From: Req5Batch74functionizing
	functionized4(var_1_16, var_1_12, var_1_4, var_1_15);


	// From: Req6Batch74functionizing
	var_1_22 = 8.625;


	// From: Req7Batch74functionizing
	functionized5(var_1_24);


	// From: Req8Batch74functionizing
	functionized6();
}
