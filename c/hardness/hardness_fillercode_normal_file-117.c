...
void step(void) {
	...
	// From: Req2Batch117normal
	if (var_1_7 < ((var_1_8 - var_1_9) >> var_1_11)) {
		var_1_10 = var_1_12;
	}


	// From: Req3Batch117normal
	if (var_1_8 > var_1_7) {
		var_1_13 = (max (var_1_11 , var_1_14));
	}


	// From: Req5Batch117normal
