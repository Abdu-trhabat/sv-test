...
void step(void) {
 ...
 if (stepLocal_0 > ((((var_1_3) < (last_1_var_1_1)) ? (var_1_3) : (last_1_var_1_1)))) {
  var_1_1 = var_1_2;
 } else {
...
int property(void) {
 return (((var_1_2 > ((((var_1_3) < (last_1_var_1_1)) ? (var_1_3) : (last_1_var_1_1)))) ? (var_1_1 == ((signed long int) var_1_2)) : (var_1_1 == ((signed long int) ((var_1_5 + ((((var_1_6) < (var_1_7)) ? (var_1_6) : (var_1_7)))) - var_1_8)))) && (var_1_9 == ((unsigned short int) var_1_10))) && (var_1_11 == ((unsigned char) var_1_12))
;
}
int main(void) {
 isInitial = 1;
