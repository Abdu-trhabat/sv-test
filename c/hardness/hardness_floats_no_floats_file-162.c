...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch162no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch162no_floats
	unsigned long int stepLocal_0 = var_1_3;
	if (var_1_2 > stepLocal_0) {
		var_1_1 = (var_1_4 + ((min (var_1_5 , var_1_6)) - 128));
	}


	// From: Req2Batch162no_floats
	if (var_1_5 > var_1_6) {
		var_1_7 = (max (((var_1_8 + var_1_9) - var_1_10) , var_1_11));
	}


	// From: Req3Batch162no_floats
	if ((var_1_5 - (var_1_6 + 100)) > (var_1_4 + var_1_1)) {
		var_1_12 = ((var_1_13 + var_1_14) + (max (var_1_6 , var_1_4)));
	}


	// From: Req4Batch162no_floats
	if (! (var_1_9 > var_1_11)) {
...
int property(void) {
	return ((((var_1_2 > var_1_3) ? (var_1_1 == ((signed long int) (var_1_4 + ((min (var_1_5 , var_1_6)) - 128)))) : 1) && ((var_1_5 > var_1_6) ? (var_1_7 == ((signed long int) (max (((var_1_8 + var_1_9) - var_1_10) , var_1_11)))) : 1)) && (((var_1_5 - (var_1_6 + 100)) > (var_1_4 + var_1_1)) ? (var_1_12 == ((signed long int) ((var_1_13 + var_1_14) + (max (var_1_6 , var_1_4))))) : 1)) && ((! (var_1_9 > var_1_11)) ? (var_1_15 == ((signed char) (((var_1_16 - 25) + (var_1_17 - var_1_18)) - 32))) : (var_1_15 == ((signed char) var_1_18)))
;
}
int main(void) {
	isInitial = 1;
