...
void step(void) {
 ...
 if (stepLocal_2 || var_1_13) {
  var_1_14 = ((((var_1_15) > (var_1_16)) ? (var_1_15) : (var_1_16)));
 } else {
  if (stepLocal_1 && (var_1_8 <= var_1_17)) {
   var_1_14 = ((((var_1_16) < (var_1_15)) ? (var_1_16) : (var_1_15)));
  } else {
   var_1_14 = var_1_16;
  }
 }
...
int property(void) {
 return (((((var_1_5 >= var_1_6) || last_1_var_1_9) ? (last_1_var_1_9 ? (var_1_1 == ((unsigned long int) 4u)) : (var_1_1 == ((unsigned long int) ((((var_1_7) > (32u)) ? (var_1_7) : (32u)))))) : 1) && (var_1_9 ? (var_1_8 == ((double) -100.0)) : 1)) && (((var_1_1 / var_1_10) >= var_1_7) ? (var_1_9 == ((unsigned char) (var_1_11 && var_1_12))) : (var_1_4 ? (var_1_9 == ((unsigned char) ((! var_1_12) || (var_1_13 || (! var_1_11))))) : (var_1_9 == ((unsigned char) 0))))) && ((var_1_9 || var_1_13) ? (var_1_14 == ((signed short int) ((((var_1_15) > (var_1_16)) ? (var_1_15) : (var_1_16))))) : ((var_1_13 && (var_1_8 <= var_1_17)) ? (var_1_14 == ((signed short int) ((((var_1_16) < (var_1_15)) ? (var_1_16) : (var_1_15))))) : (var_1_14 == ((signed short int) var_1_16))))
;
}
int main(void) {
 isInitial = 1;
