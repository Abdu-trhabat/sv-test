...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15650_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch15650_1loop
	if (var_1_5 > var_1_4) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch15650_1loop
	if (var_1_7) {
		var_1_9 = (min ((last_1_var_1_9 + -8) , (max ((abs (var_1_3)) , var_1_10))));
	}


	// From: Req4Batch15650_1loop
	...
	// From: Req7Batch15650_1loop
	if (var_1_11 <= (min (1.05 , var_1_6))) {
		if ((abs (var_1_14)) < 10) {
...
int property(void) {
	return ((((((((var_1_9 > ((var_1_3 - 5) << var_1_4)) ? (((max (var_1_3 , var_1_4)) != var_1_5) ? (var_1_1 == ((double) var_1_6)) : (var_1_1 == ((double) 9.8))) : (var_1_1 == ((double) var_1_6))) && ((var_1_5 > var_1_4) ? (var_1_7 == ((unsigned char) var_1_8)) : 1)) && (var_1_7 ? (var_1_9 == ((signed short int) (min ((last_1_var_1_9 + -8) , (max ((abs (var_1_3)) , var_1_10)))))) : 1)) && ((var_1_9 > (-32 | var_1_9)) ? (var_1_11 == ((double) ((max (var_1_12 , var_1_13)) - 128.5))) : (var_1_11 == ((double) var_1_13)))) && ((last_1_var_1_17 == var_1_13) ? (((var_1_5 & last_1_var_1_9) <= var_1_3) ? (var_1_14 == ((signed long int) var_1_15)) : 1) : 1)) && ((var_1_5 < var_1_4) ? (var_1_16 == ((unsigned char) 16)) : (var_1_16 == ((unsigned char) (abs (abs (var_1_3))))))) && ((var_1_11 <= (min (1.05 , var_1_6))) ? (((abs (var_1_14)) < 10) ? (var_1_17 == ((double) ((max (var_1_18 , var_1_19)) + (var_1_20 - var_1_21)))) : 1) : (var_1_17 == ((double) 9999.25)))) && (var_1_22 == ((signed short int) var_1_3))
;
}
int main(void) {
	isInitial = 1;
