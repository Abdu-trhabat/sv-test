...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch161Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
  ...
  var_1_39
             ...
             if ( ((var_1_31) >= ( (((((var_1_37)) > (( ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))))) ? ((var_1_37)) : (( ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34)))))))))) {
              var_1_42 = (
               ((((-16) < 0 ) ? -(-16) : (-16)))
  );
 }
             if ( (( ((var_1_30) * (var_1_33))) > ( ((var_1_36) / (var_1_44))))) {
              var_1_43 = (
               ((((var_1_36) < 0 ) ? -(var_1_36) : (var_1_36)))
  );
 }
