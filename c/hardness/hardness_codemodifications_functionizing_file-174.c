...
signed long int functionized1(unsigned char functionized1_localFunctionVar0, unsigned char functionized1_localFunctionVar1, signed short int functionized1_localFunctionVar2) {
	return (functionized1_localFunctionVar2 & (min (functionized1_localFunctionVar0 , functionized1_localFunctionVar1)));
}
signed long int functionized2(void) {
...
double functionized4(double functionized4_localFunctionVar0) {
	return (max (functionized4_localFunctionVar0 , var_1_17));
}
...
void step(void) {
	// From: Req1Batch174functionizing
	if (var_1_2 < (var_1_3 / var_1_4)) {
		var_1_1 = (var_1_5 + var_1_6);
	}


	// From: Req2Batch174functionizing
	if (var_1_8) {
	...
	// From: Req3Batch174functionizing
	if ((var_1_11 / var_1_10) == var_1_6) {
		if (functionized3()) {
			var_1_14 = ((min (functionized4(var_1_16) , functionized5(var_1_19))) - 49.6);
		}
	} else {
	...
	// From: Req4Batch174functionizing
	functionized6(var_1_6, var_1_10);


	// From: Req5Batch174functionizing
	...
	// From: Req6Batch174functionizing
	functionized7(var_1_16, var_1_19);


	// From: Req7Batch174functionizing
