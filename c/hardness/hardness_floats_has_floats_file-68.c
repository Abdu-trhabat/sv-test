...
int property(void) {
	return (((((((var_1_2 - var_1_3) >= last_1_var_1_7) ? (var_1_1 == ((signed long int) (max (var_1_5 , var_1_6)))) : (var_1_1 == ((signed long int) (max ((max (128 , var_1_5)) , (abs (128))))))) && ((var_1_4 < -25.0f) ? ((var_1_1 < (max (var_1_5 , var_1_6))) ? (var_1_7 == ((double) (min ((abs (64.0)) , var_1_8)))) : (var_1_7 == ((double) var_1_8))) : (var_1_7 == ((double) var_1_8)))) && ((((var_1_2 + var_1_7) <= var_1_3) || (var_1_6 >= (var_1_11 | var_1_5))) ? (var_1_9 == ((unsigned short int) 4)) : (var_1_9 == ((unsigned short int) var_1_10)))) && (var_1_11 == ((signed long int) -10))) && (var_1_12 == ((unsigned long int) 10u))) && (var_1_13 == ((unsigned long int) var_1_10))
;
}
int main(void) {
	isInitial = 1;
