...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10450_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch10450_1loop
	signed long int stepLocal_4 = min (var_1_5 , var_1_25);
