...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch177Filler_PS_CI.c", 13, "reach_error"); }
...
void step(void) {
	// From: CodeObject1
	/* 254L, 30L) */ if (/* 255L, 7L, 8L) */ ((/* 256L, 4L, 9L) */ ((var_1_9) - (var_1_11))) <= (/* 259L, 6L, 12L) */ (~ (var_1_9))))) {
		/* 261L, 23L) */ var_1_27 = (
			var_1_31
		);
	} else {
	...
	// From: CodeObject2
	/* 271L, 89L) */ if (/* 272L, 40L, 41L) */ ((500) <= (/* 274L, 39L, 43L) */ ((256) | (var_1_4))))) {
		/* 277L, 87L) */ if (/* 278L, 55L, 56L) */ ((/* 279L, 53L, 57L) */ ((var_1_4) ^ (var_1_6))) != (var_1_1))) {
	...
	// From: CodeObject5
	/* 311L, 126L) */ if (/* 312L, 111L, 112L) */ ((-5) <= (var_1_11))) {
		/* 315L, 125L) */ var_1_41 = (
			/* 318L, 124L) */ ((
				/* 319L, 122L) */ ((
					var_1_35
	...
	// From: CodeObject6
	/* 323L, 155L) */ if (/* 324L, 134L, 135L) */ ((var_1_40) > (/* 326L, 133L, 137L) */ ((var_1_5) / (var_1_44))))) {
		/* 329L, 150L) */ var_1_43 = (
			/* 332L, 149L) */ ((
				var_1_45
			) - (
	...
	// From: CodeObject8
	/* 348L, 231L) */ if (/* 349L, 176L, 177L) */ ((var_1_9) < (/* 351L, 175L, 179L) */ ((var_1_46) | (var_1_5))))) {
		/* 354L, 192L) */ var_1_48 = (
			/* 357L, 191L) */ (max (
				/* 357L, 191L) */ (
					var_1_46
