...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch68Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((float_Array_0[2] - float_Array_0[1]) >= double_Array_0[1]) {
  if (stepLocal_0 >= (unsigned_long_int_Array_0[0] / signed_long_int_Array_0[0][0])) {
   signed_long_int_Array_0[1][1] = ((((signed_long_int_Array_0[1][0]) < 0 ) ? -(signed_long_int_Array_0[1][0]) : (signed_long_int_Array_0[1][0])));
  }
 } else {
  if (BOOL_unsigned_char_Array_0[0]) {
   signed_long_int_Array_0[1][1] = ((((signed_long_int_Array_0[1][0]) > (unsigned_long_int_Array_0[0])) ? (signed_long_int_Array_0[1][0]) : (unsigned_long_int_Array_0[0])));
  }
 }
}
void updateVariables(void) {
