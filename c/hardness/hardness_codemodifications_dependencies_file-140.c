...
void step(void) {
	// From: Req4Batch140dependencies
	var_1_14 = (max (var_1_6 , (min (last_1_var_1_18 , last_1_var_1_1))));


	// From: Req5Batch140dependencies
	if (var_1_14 <= var_1_6) {
	...
	// From: Req2Batch140dependencies
	if (var_1_3) {
		var_1_8 = (var_1_9 + var_1_10);
	}


	// From: Req3Batch140dependencies
	if (var_1_10 >= var_1_8) {
		var_1_11 = (var_1_12 - var_1_13);
	}


	// From: Req7Batch140dependencies
	var_1_23 = (max ((max (var_1_7 , var_1_21)) , var_1_24));


	// From: Req8Batch140dependencies
	var_1_25 = -1;


	// From: Req6Batch140dependencies
	if (var_1_6 > var_1_14) {
