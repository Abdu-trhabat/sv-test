...
void step(void) {
 ...
 unsigned long int stepLocal_0 = (((unsigned_long_int_Array_0[1][2]) < (unsigned_long_int_Array_0[1][0])) ? (unsigned_long_int_Array_0[1][2]) : (unsigned_long_int_Array_0[1][0]));
 if (stepLocal_0 != ((((unsigned_long_int_Array_0[0][1]) < (unsigned_long_int_Array_0[1][1])) ? (unsigned_long_int_Array_0[0][1]) : (unsigned_long_int_Array_0[1][1])))) {
...
int property(void) {
 return ((((unsigned_long_int_Array_0[1][2] == ((unsigned long int) (unsigned_long_int_Array_0[0][2] + (unsigned_long_int_Array_0[1][1] - (unsigned_long_int_Array_0[0][1] - unsigned_long_int_Array_0[1][0]))))) && (BOOL_unsigned_char_Array_0[1][2] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0]))) && ((((((unsigned_long_int_Array_0[1][2]) < (unsigned_long_int_Array_0[1][0])) ? (unsigned_long_int_Array_0[1][2]) : (unsigned_long_int_Array_0[1][0]))) != ((((unsigned_long_int_Array_0[0][1]) < (unsigned_long_int_Array_0[1][1])) ? (unsigned_long_int_Array_0[0][1]) : (unsigned_long_int_Array_0[1][1])))) ? ((double_Array_0[0] == double_Array_0[1]) ? (last_1_BOOL_unsigned_char_Array_0_0__0_ ? ((unsigned_long_int_Array_0[1][1] >= unsigned_long_int_Array_0[1][0]) ? (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) (BOOL_unsigned_char_Array_0[1][0] || BOOL_unsigned_char_Array_0[0][1]))) : (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0]))) : 1) : 1) : (BOOL_unsigned_char_Array_0[0][0] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1])))) && ((unsigned_long_int_Array_0[1][0] <= (unsigned_long_int_Array_0[0][0] - unsigned_long_int_Array_0[0][1])) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) ((((unsigned_short_int_Array_0[1]) < 0 ) ? -(unsigned_short_int_Array_0[1]) : (unsigned_short_int_Array_0[1]))))) : 1)) && (((double_Array_0[0] * 16.5f) > double_Array_0[1]) ? (BOOL_unsigned_char_Array_0[0][2] == ((unsigned char) (! BOOL_unsigned_char_Array_0[0][1]))) : (BOOL_unsigned_char_Array_0[0][2] == ((unsigned char) (BOOL_unsigned_char_Array_0[0][1] && BOOL_unsigned_char_Array_0[1][1]))))
;
}
int main(void) {
 isInitial = 1;
