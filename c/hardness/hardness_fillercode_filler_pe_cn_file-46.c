...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch46Filler_PE_CN.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch46Filler_PE_CN
	/* 1047L, 254L, 852L, 858L) */ var_1_23 = (
		var_1_24
	);


	// From: Req9Batch46Filler_PE_CN
	/* 1053L, 264L, 876L, 882L) */ var_1_25 = (
		64
	);


	// From: Req5Batch46Filler_PE_CN
