...
void step(void) {
 ...
 signed long int stepLocal_2 = (((var_1_2) < (var_1_3)) ? (var_1_2) : (var_1_3));
 if (stepLocal_2 > ((((last_1_var_1_14) < (var_1_7)) ? (last_1_var_1_14) : (var_1_7)))) {
  var_1_14 = var_1_7;
 }
 signed long int stepLocal_3 = -2;
 if (var_1_3 >= stepLocal_3) {
  var_1_15 = ((((var_1_12) > (var_1_10)) ? (var_1_12) : (var_1_10)));
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((var_1_2 - var_1_3) >= (var_1_4 - var_1_5)) ? (var_1_1 == ((signed short int) ((((var_1_6 - var_1_7) < 0 ) ? -(var_1_6 - var_1_7) : (var_1_6 - var_1_7))))) : 1) && (var_1_9 ? ((var_1_7 > (var_1_4 + (var_1_6 - var_1_10))) ? (var_1_11 ? (var_1_8 == ((unsigned char) var_1_12)) : (var_1_8 == ((unsigned char) var_1_13))) : (var_1_8 == ((unsigned char) var_1_13))) : 1)) && ((((((var_1_2) < (var_1_3)) ? (var_1_2) : (var_1_3))) > ((((last_1_var_1_14) < (var_1_7)) ? (last_1_var_1_14) : (var_1_7)))) ? (var_1_14 == ((signed long int) var_1_7)) : 1)) && ((var_1_3 >= -2) ? (var_1_15 == ((unsigned long int) ((((var_1_12) > (var_1_10)) ? (var_1_12) : (var_1_10))))) : 1)
;
}
int main(void) {
 isInitial = 1;
