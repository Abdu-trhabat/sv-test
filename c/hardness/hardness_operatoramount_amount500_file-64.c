...
void step(void) {
	...
	if (var_1_5 != var_1_6) {
		if (var_1_12 >= (var_1_5 - var_1_6)) {
			if (var_1_19 < last_1_var_1_67) {
				var_1_20 = (max (var_1_21 , last_1_var_1_44));
			} else {
	...
	if (last_1_var_1_98) {
		...
		if (var_1_24 != stepLocal_3) {
			if (63.25 <= (var_1_12 * (abs (last_1_var_1_76)))) {
	...
	if (stepLocal_15 && var_1_27) {
		var_1_66 = (max ((abs (var_1_6)) , (abs (var_1_4))));
	} else {
		var_1_66 = var_1_5;
	}
	...
	if (var_1_5 < var_1_6) {
		var_1_64 = (max ((min (last_1_var_1_61 , (abs (var_1_35)))) , (var_1_56 - (abs (var_1_54)))));
	}


	// From: Req10Batch64Amount500
	unsigned long int stepLocal_5 = last_1_var_1_73;
	if (stepLocal_5 > (last_1_var_1_16 / (min (var_1_26 , var_1_38)))) {
		var_1_44 = (min (var_1_35 , var_1_41));
	}


	// From: Req49Batch64Amount500
	if (last_1_var_1_98) {
		var_1_104 = var_1_56;
	} else {
	...
	if (((abs (var_1_14)) + (var_1_77 - var_1_70)) > stepLocal_19) {
		if (var_1_43) {
			if (var_1_30) {
				var_1_76 = ((var_1_6 - (var_1_78 - var_1_79)) + (max (var_1_5 , var_1_4)));
			} else {
		...
		var_1_76 = (min (var_1_6 , var_1_4));
	}


	// From: Req33Batch64Amount500
	if (((min (var_1_77 , 50547)) - var_1_37) > 2) {
		var_1_85 = var_1_70;
	}
	...
	// From: Req46Batch64Amount500
	var_1_100 = var_1_81;


	// From: Req47Batch64Amount500
	var_1_101 = var_1_102;


	// From: Req48Batch64Amount500
	if (var_1_28) {
		var_1_103 = var_1_39;
	} else {
		var_1_103 = var_1_41;
	...
	if ((var_1_66 / var_1_11) > var_1_76) {
		if (var_1_88) {
			if (var_1_25 < ((min (var_1_19 , var_1_21)) + (var_1_81 + var_1_49))) {
				var_1_89 = (! var_1_30);
			} else {
	...
	if (((var_1_56 | var_1_100) * (var_1_25 * var_1_50)) > stepLocal_12) {
		if ((var_1_104 >= 16) && stepLocal_13) {
			if (var_1_17 <= stepLocal_14) {
				var_1_61 = (var_1_96 + (min (var_1_100 , var_1_39)));
			}
		} else {
			var_1_61 = var_1_39;
		}
	...
	signed long int stepLocal_1 = min (var_1_14 , 0);
	...
	if (stepLocal_4 <= (min (var_1_14 , (var_1_85 ^ var_1_64)))) {
	...
	if (stepLocal_17 <= var_1_13) {
		var_1_73 = ((var_1_56 - (abs (var_1_34))) - (var_1_18 - (var_1_23 - var_1_41)));
	}
	...
	if (var_1_4 > var_1_12) {
		...
		if (! (var_1_12 < (var_1_11 + var_1_76))) {
			var_1_74 = (min ((abs (var_1_41)) , var_1_71));
		} else {
			if (var_1_105) {
				if (var_1_35 == stepLocal_18) {
					var_1_74 = (max ((min ((var_1_71 + var_1_35) , var_1_39)) , (var_1_41 - var_1_70)));
				} else {
					var_1_74 = var_1_71;
				}
			} else {
				if (var_1_33) {
					var_1_74 = (min ((min ((min (var_1_70 , var_1_41)) , (min (var_1_35 , var_1_39)))) , var_1_71));
				}
			}
		}
	}
	...
	unsigned long int stepLocal_9 = abs (var_1_19);
	...
	if (var_1_48 >= stepLocal_9) {
		if (var_1_76 == var_1_5) {
			if (var_1_31) {
				...
				var_1_53 = (min (var_1_37 , var_1_24));
			}
		} else {
		...
		if (var_1_9 < stepLocal_8) {
			...
			var_1_53 = ((var_1_56 - var_1_41) - (min (var_1_25 , var_1_26)));
		}
	}


	// From: Req30Batch64Amount500
	unsigned long int stepLocal_23 = min (var_1_96 , var_1_53);
	...
	if (stepLocal_20 <= var_1_14) {
		if (var_1_19 > stepLocal_23) {
			...
			if (stepLocal_21 > var_1_53) {
				var_1_80 = (max (var_1_41 , (var_1_70 - var_1_35)));
			} else {
		...
		if (stepLocal_22 && (var_1_57 >= var_1_64)) {
			var_1_80 = ((max (var_1_71 , (var_1_70 + var_1_35))) + (var_1_39 - var_1_81));
		} else {
			var_1_80 = ((max (2 , var_1_70)) - (var_1_35 + var_1_39));
		}
	}
	...
	if (var_1_96 != var_1_20) {
		var_1_84 = ((min (var_1_77 , var_1_63)) - (var_1_49 - (var_1_35 + var_1_15)));
	}
	...
	if (var_1_11 != ((max (var_1_6 , 1.4f)) / var_1_12)) {
		if (var_1_6 >= var_1_1) {
			var_1_16 = (min (var_1_14 , var_1_45));
		} else {
			var_1_16 = (min (var_1_45 , (var_1_17 - (max (var_1_60 , var_1_64)))));
		}
	} else {
		var_1_16 = (var_1_45 + ((min (var_1_18 , var_1_19)) - var_1_60));
	}


	// From: Req2Batch64Amount500
	unsigned long int stepLocal_0 = (max (var_1_73 , var_1_93)) * (abs (var_1_9));
	if (var_1_66 <= (max (49.4f , var_1_5))) {
		if (var_1_6 <= var_1_66) {
			if (stepLocal_0 <= var_1_16) {
				var_1_8 = 5;
			} else {
				var_1_8 = (min (var_1_73 , (var_1_93 + var_1_9)));
			}
		} else {
		...
		if (var_1_5 <= (var_1_6 / var_1_11)) {
			if (((var_1_12 - var_1_6) - var_1_5) <= var_1_11) {
				...
				var_1_8 = ((max (var_1_73 , var_1_93)) + var_1_9);
			}
		} else {
			if (var_1_42) {
				var_1_8 = ((min (var_1_73 , 4)) + (min ((max (var_1_9 , var_1_93)) , var_1_13)));
			} else {
				var_1_8 = (min ((var_1_73 - (var_1_93 + var_1_14)) , var_1_9));
			}
		}
	}
	...
	if (stepLocal_6 && var_1_30) {
		var_1_46 = ((var_1_48 - (min (var_1_23 , var_1_104))) - 64);
	} else {
	...
	if ((var_1_39 % var_1_38) <= (min (var_1_20 , var_1_93))) {
		if (var_1_24 != (var_1_35 << (var_1_70 - var_1_71))) {
			if (var_1_56 == var_1_51) {
				var_1_69 = var_1_30;
			}
		} else {
			if ((max (32 , (var_1_57 + var_1_39))) != var_1_64) {
				var_1_69 = var_1_30;
			} else {
				if (! var_1_42) {
	...
	if (stepLocal_11 > (var_1_26 * var_1_16)) {
		...
		var_1_58 = (max ((min ((var_1_38 + var_1_61) , (max (var_1_82 , var_1_34)))) , var_1_37));
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((var_1_61 <= var_1_95) ? (var_1_1 == ((float) (abs (var_1_4 + (var_1_5 - var_1_6))))) : (var_1_68 ? (var_1_1 == ((float) (max (var_1_6 , var_1_5)))) : 1)) && ((var_1_66 <= (max (49.4f , var_1_5))) ? ((var_1_6 <= var_1_66) ? ((((max (var_1_73 , var_1_93)) * (abs (var_1_9))) <= var_1_16) ? (var_1_8 == ((signed long int) 5)) : (var_1_8 == ((signed long int) (min (var_1_73 , (var_1_93 + var_1_9)))))) : (var_1_8 == ((signed long int) ((4 + var_1_93) + var_1_9)))) : ((var_1_5 <= (var_1_6 / var_1_11)) ? ((((var_1_12 - var_1_6) - var_1_5) <= var_1_11) ? (var_1_8 == ((signed long int) (var_1_9 + var_1_73))) : (var_1_8 == ((signed long int) ((max (var_1_73 , var_1_93)) + var_1_9)))) : (var_1_42 ? (var_1_8 == ((signed long int) ((min (var_1_73 , 4)) + (min ((max (var_1_9 , var_1_93)) , var_1_13))))) : (var_1_8 == ((signed long int) (min ((var_1_73 - (var_1_93 + var_1_14)) , var_1_9)))))))) && (((min (var_1_14 , 0)) >= var_1_93) ? (((var_1_12 <= var_1_4) && var_1_89) ? (var_1_15 == ((unsigned short int) 1)) : 1) : (var_1_15 == ((unsigned short int) var_1_91)))) && ((var_1_11 != ((max (var_1_6 , 1.4f)) / var_1_12)) ? ((var_1_6 >= var_1_1) ? (var_1_16 == ((unsigned long int) (min (var_1_14 , var_1_45)))) : (var_1_16 == ((unsigned long int) (min (var_1_45 , (var_1_17 - (max (var_1_60 , var_1_64)))))))) : (var_1_16 == ((unsigned long int) (var_1_45 + ((min (var_1_18 , var_1_19)) - var_1_60)))))) && ((var_1_5 != var_1_6) ? ((var_1_12 >= (var_1_5 - var_1_6)) ? ((var_1_19 < last_1_var_1_67) ? (var_1_20 == ((unsigned long int) (max (var_1_21 , last_1_var_1_44)))) : ((var_1_12 <= last_1_var_1_99) ? (var_1_20 == ((unsigned long int) ((var_1_18 + (var_1_22 + var_1_23)) - var_1_24))) : 1)) : (var_1_20 == ((unsigned long int) (var_1_17 - (var_1_14 + last_1_var_1_67))))) : (var_1_20 == ((unsigned long int) ((var_1_25 + var_1_26) - var_1_19))))) && (last_1_var_1_98 ? (var_1_27 == ((unsigned char) var_1_28)) : ((var_1_24 != (last_1_var_1_104 * (var_1_17 - last_1_var_1_16))) ? ((63.25 <= (var_1_12 * (abs (last_1_var_1_76)))) ? (var_1_27 == ((unsigned char) ((var_1_30 && var_1_31) && ((! var_1_28) && var_1_32)))) : (var_1_27 == ((unsigned char) ((! (var_1_30 && var_1_32)) || (var_1_31 && (var_1_28 && var_1_33)))))) : (var_1_27 == ((unsigned char) (var_1_30 && (! var_1_28))))))) && (((var_1_19 << var_1_35) <= (min (var_1_14 , (var_1_85 ^ var_1_64)))) ? (var_1_34 == ((unsigned char) (var_1_35 + var_1_37))) : (var_1_34 == ((unsigned char) (var_1_38 - (var_1_35 + var_1_39)))))) && ((! (var_1_31 && var_1_32)) ? (var_1_40 == ((signed char) ((var_1_41 - 4) - var_1_39))) : (var_1_40 == ((signed char) var_1_39)))) && ((var_1_21 < var_1_37) ? (var_1_42 == ((unsigned char) ((var_1_19 > var_1_21) && var_1_43))) : (var_1_42 == ((unsigned char) (! 1))))) && ((last_1_var_1_73 > (last_1_var_1_16 / (min (var_1_26 , var_1_38)))) ? (var_1_44 == ((unsigned long int) (min (var_1_35 , var_1_41)))) : 1)) && ((! var_1_27) ? (var_1_45 == ((unsigned char) (var_1_38 - var_1_37))) : 1)) && ((var_1_52 && var_1_30) ? (var_1_46 == ((signed long int) ((var_1_48 - (min (var_1_23 , var_1_104))) - 64))) : (var_1_46 == ((signed long int) (var_1_34 - (var_1_49 - var_1_39)))))) && (var_1_28 ? (var_1_50 == ((unsigned long int) var_1_51)) : 1)) && (((- 50) != (min (16 , (256 % var_1_19)))) ? (var_1_52 == ((unsigned char) (var_1_89 || (! (var_1_105 && var_1_43))))) : ((var_1_13 < (abs (16))) ? ((var_1_26 > 8u) ? (var_1_52 == ((unsigned char) ((! var_1_33) && var_1_31))) : (var_1_30 ? ((var_1_28 || var_1_27) ? (var_1_52 == ((unsigned char) (var_1_43 && var_1_28))) : (var_1_52 == ((unsigned char) (var_1_31 && var_1_32)))) : (var_1_52 == ((unsigned char) (((var_1_37 + var_1_8) >= var_1_41) && var_1_43))))) : (var_1_52 == ((unsigned char) ((var_1_28 || var_1_33) || var_1_43)))))) && ((var_1_48 >= (abs (var_1_19))) ? ((var_1_76 == var_1_5) ? (var_1_31 ? (var_1_53 == ((unsigned long int) var_1_23)) : (var_1_53 == ((unsigned long int) (min (var_1_37 , var_1_24))))) : (var_1_53 == ((unsigned long int) ((var_1_19 - var_1_54) + var_1_49)))) : ((var_1_9 < (128 + var_1_96)) ? ((var_1_100 != (var_1_23 << var_1_9)) ? (var_1_53 == ((unsigned long int) var_1_100)) : 1) : (var_1_53 == ((unsigned long int) ((var_1_56 - var_1_41) - (min (var_1_25 , var_1_26)))))))) && ((var_1_37 > last_1_var_1_57) ? (var_1_57 == ((signed long int) var_1_22)) : 1)) && (((~ (var_1_37 << var_1_18)) > (var_1_26 * var_1_16)) ? (var_1_58 == ((signed short int) var_1_35)) : (var_1_58 == ((signed short int) (max ((min ((var_1_38 + var_1_61) , (max (var_1_82 , var_1_34)))) , var_1_37)))))) && ((var_1_69 && (var_1_73 <= (var_1_44 / var_1_22))) ? ((((var_1_66 + var_1_4) / var_1_11) >= (- var_1_12)) ? (var_1_59 == ((unsigned long int) var_1_18)) : 1) : (var_1_59 == ((unsigned long int) (var_1_16 + (var_1_35 + var_1_97)))))) && ((var_1_38 >= (var_1_19 / var_1_41)) ? (var_1_60 == ((signed short int) (-1 + var_1_38))) : 1)) && ((((var_1_56 | var_1_100) * (var_1_25 * var_1_50)) > (var_1_18 / (2980507943u - 64u))) ? (((var_1_104 >= 16) && var_1_88) ? ((var_1_17 <= var_1_44) ? (var_1_61 == ((signed short int) (var_1_96 + (min (var_1_100 , var_1_39))))) : 1) : (var_1_61 == ((signed short int) var_1_39))) : (var_1_61 == ((signed short int) (var_1_50 - (var_1_63 - (10000 - var_1_38))))))) && ((var_1_5 < var_1_6) ? (var_1_64 == ((unsigned long int) (max ((min (last_1_var_1_61 , (abs (var_1_35)))) , (var_1_56 - (abs (var_1_54))))))) : 1)) && (var_1_65 == ((signed char) var_1_35))) && ((var_1_43 && var_1_27) ? (var_1_66 == ((double) (max ((abs (var_1_6)) , (abs (var_1_4)))))) : (var_1_66 == ((double) var_1_5)))) && (((var_1_14 >= var_1_46) || var_1_28) ? (var_1_67 == ((unsigned short int) (var_1_38 + var_1_44))) : 1)) && ((var_1_19 == var_1_84) ? (var_1_68 == ((unsigned char) ((50.5f < var_1_6) || (var_1_30 || var_1_32)))) : (var_1_68 == ((unsigned char) (((var_1_30 || var_1_33) && var_1_43) || var_1_28))))) && (((var_1_39 % var_1_38) <= (min (var_1_20 , var_1_93))) ? ((var_1_24 != (var_1_35 << (var_1_70 - var_1_71))) ? ((var_1_56 == var_1_51) ? (var_1_69 == ((unsigned char) var_1_30)) : 1) : (((max (32 , (var_1_57 + var_1_39))) != var_1_64) ? (var_1_69 == ((unsigned char) var_1_30)) : ((! var_1_42) ? (var_1_69 == ((unsigned char) (var_1_42 || var_1_30))) : 1))) : (((var_1_74 / var_1_41) <= var_1_46) ? (var_1_69 == ((unsigned char) (! (var_1_28 && var_1_33)))) : (var_1_69 == ((unsigned char) (var_1_98 && (var_1_43 || var_1_33))))))) && ((var_1_44 <= var_1_13) ? (var_1_73 == ((unsigned long int) ((var_1_56 - (abs (var_1_34))) - (var_1_18 - (var_1_23 - var_1_41))))) : 1)) && ((var_1_4 > var_1_12) ? (var_1_74 == ((signed char) (var_1_35 + var_1_39))) : ((! (var_1_12 < (var_1_11 + var_1_76))) ? (var_1_74 == ((signed char) (min ((abs (var_1_41)) , var_1_71)))) : (var_1_105 ? ((var_1_35 == var_1_93) ? (var_1_74 == ((signed char) (max ((min ((var_1_71 + var_1_35) , var_1_39)) , (var_1_41 - var_1_70))))) : (var_1_74 == ((signed char) var_1_71))) : (var_1_33 ? (var_1_74 == ((signed char) (min ((min ((min (var_1_70 , var_1_41)) , (min (var_1_35 , var_1_39)))) , var_1_71)))) : 1))))) && ((((abs (var_1_14)) + (var_1_77 - var_1_70)) > var_1_49) ? (var_1_43 ? (var_1_30 ? (var_1_76 == ((double) ((var_1_6 - (var_1_78 - var_1_79)) + (max (var_1_5 , var_1_4))))) : (var_1_76 == ((double) (var_1_6 - 1.2)))) : (var_1_76 == ((double) (var_1_4 + var_1_78)))) : (var_1_76 == ((double) (min (var_1_6 , var_1_4)))))) && (((var_1_73 + (- var_1_25)) <= var_1_14) ? ((var_1_19 > (min (var_1_96 , var_1_53))) ? (var_1_80 == ((signed char) var_1_71)) : ((((var_1_26 + var_1_73) ^ var_1_41) > var_1_53) ? (var_1_80 == ((signed char) (max (var_1_41 , (var_1_70 - var_1_35))))) : (var_1_80 == ((signed char) ((var_1_70 + (var_1_35 + var_1_71)) - var_1_39))))) : (((4.6 >= (var_1_66 / var_1_12)) && (var_1_57 >= var_1_64)) ? (var_1_80 == ((signed char) ((max (var_1_71 , (var_1_70 + var_1_35))) + (var_1_39 - var_1_81)))) : (var_1_80 == ((signed char) ((max (2 , var_1_70)) - (var_1_35 + var_1_39))))))) && ((((var_1_77 - var_1_71) * var_1_17) < (var_1_50 / (var_1_41 + 128u))) ? (var_1_82 == ((signed short int) (var_1_83 + (var_1_95 - var_1_97)))) : (var_1_82 == ((signed short int) var_1_63)))) && ((var_1_96 != var_1_20) ? (var_1_84 == ((signed long int) ((min (var_1_77 , var_1_63)) - (var_1_49 - (var_1_35 + var_1_15))))) : 1)) && ((((min (var_1_77 , 50547)) - var_1_37) > 2) ? (var_1_85 == ((unsigned char) var_1_70)) : 1)) && ((var_1_13 >= var_1_20) ? ((var_1_22 >= var_1_50) ? (var_1_86 == ((float) (abs (var_1_5 - var_1_79)))) : (var_1_86 == ((float) var_1_87))) : 1)) && ((last_1_var_1_104 <= (var_1_56 - var_1_48)) ? (var_1_88 == ((unsigned char) (var_1_43 || ((last_1_var_1_42 && last_1_var_1_69) && var_1_28)))) : 1)) && (((var_1_66 / var_1_11) > var_1_76) ? (var_1_88 ? ((var_1_25 < ((min (var_1_19 , var_1_21)) + (var_1_81 + var_1_49))) ? (var_1_89 == ((unsigned char) (! var_1_30))) : ((var_1_104 >= (var_1_38 - var_1_81)) ? (var_1_89 == ((unsigned char) var_1_32)) : (var_1_89 == ((unsigned char) var_1_43)))) : (var_1_89 == ((unsigned char) 0))) : 1)) && (var_1_91 == ((unsigned char) var_1_81))) && (var_1_92 == ((signed short int) var_1_71))) && (var_1_93 == ((signed short int) var_1_38))) && (var_1_94 == ((signed short int) var_1_39))) && (var_1_42 ? (var_1_95 == ((unsigned char) var_1_81)) : (var_1_95 == ((unsigned char) 128)))) && (var_1_88 ? (var_1_96 == ((signed short int) var_1_83)) : (var_1_96 == ((signed short int) var_1_81)))) && (var_1_52 ? (var_1_97 == ((unsigned char) var_1_38)) : (var_1_97 == ((unsigned char) var_1_35)))) && (var_1_98 == ((unsigned char) var_1_43))) && (var_1_43 ? (var_1_99 == ((double) var_1_6)) : 1)) && (var_1_100 == ((unsigned char) var_1_81))) && (var_1_101 == ((float) var_1_102))) && (var_1_28 ? (var_1_103 == ((signed char) var_1_39)) : (var_1_103 == ((signed char) var_1_41)))) && (last_1_var_1_98 ? (var_1_104 == ((unsigned long int) var_1_56)) : (var_1_104 == ((unsigned long int) last_1_var_1_96)))) && ((var_1_64 != var_1_57) ? (var_1_31 ? ((var_1_60 < (- (var_1_38 - var_1_70))) ? (var_1_105 == ((unsigned char) (var_1_30 && var_1_32))) : (var_1_105 == ((unsigned char) var_1_28))) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
