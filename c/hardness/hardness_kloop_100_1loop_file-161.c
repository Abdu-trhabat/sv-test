...
void step(void) {
	// From: Req2Batch161100_1loop
	var_1_11 = (var_1_4 - (8.321944475028179E18f - var_1_8));


	// From: Req7Batch161100_1loop
	...
	// From: Req8Batch161100_1loop
	if (var_1_15 || (var_1_5 > (abs (-0.5f)))) {
		var_1_33 = var_1_34;
	}


	// From: Req9Batch161100_1loop
	var_1_35 = (2.5 - var_1_4);


	// From: Req10Batch161100_1loop
	if (! var_1_15) {
		var_1_36 = (max (var_1_37 , (var_1_38 + (max (var_1_39 , var_1_40)))));
	}


	// From: Req12Batch161100_1loop
	var_1_44 = var_1_25;


	// From: Req13Batch161100_1loop
	var_1_45 = var_1_37;


	// From: Req3Batch161100_1loop
