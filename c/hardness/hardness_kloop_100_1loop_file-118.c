...
void step(void) {
	// From: Req3Batch118100_1loop
	if (-32 <= (last_1_var_1_16 ^ (abs (var_1_14)))) {
		if ((max (var_1_8 , 32.25)) < last_1_var_1_9) {
			var_1_12 = var_1_15;
		} else {
			var_1_12 = 4;
		}
	...
	// From: Req4Batch118100_1loop
	if (var_1_10 >= (min ((15.4 * last_1_var_1_17) , var_1_11))) {
		if (last_1_var_1_27) {
	...
	// From: Req7Batch118100_1loop
	var_1_27 = (var_1_35 && var_1_28);


	// From: Req5Batch118100_1loop
	if ((abs (var_1_10)) >= var_1_8) {
	...
	// From: Req9Batch118100_1loop
	if (var_1_35) {
		var_1_30 = var_1_31;
	} else {
		var_1_30 = ((max ((min (var_1_32 , var_1_33)) , var_1_34)) + 16);
	}


	// From: Req12Batch118100_1loop
	var_1_42 = var_1_32;


	// From: Req6Batch118100_1loop
	if (var_1_16 <= var_1_12) {
		var_1_20 = ((max ((var_1_21 + var_1_22) , (max (var_1_23 , var_1_24)))) + (var_1_25 - (var_1_26 - 1)));
	} else {
		var_1_20 = var_1_23;
	}


	// From: Req8Batch118100_1loop
	...
	// From: Req11Batch118100_1loop
	unsigned long int stepLocal_6 = var_1_16;
	if ((max (var_1_29 , (min (var_1_33 , var_1_32)))) > stepLocal_6) {
		var_1_38 = (var_1_19 + ((abs (var_1_18)) - 1.25f));
	} else {
		var_1_38 = (var_1_39 - (var_1_40 - var_1_41));
	}


	// From: Req2Batch118100_1loop
	...
	// From: Req1Batch118100_1loop
	if ((min (var_1_9 , (var_1_9 * last_1_var_1_1))) >= var_1_9) {
		if (var_1_35) {
			if (! var_1_27) {
				var_1_1 = (min (8.125 , var_1_8));
			}
		}
	} else {
		var_1_1 = var_1_8;
...
int property(void) {
	return (((((((((((((min (var_1_9 , (var_1_9 * last_1_var_1_1))) >= var_1_9) ? (var_1_35 ? ((! var_1_27) ? (var_1_1 == ((double) (min (8.125 , var_1_8)))) : 1) : 1) : (var_1_1 == ((double) var_1_8))) && (((var_1_10 - var_1_11) < last_1_var_1_38) ? ((last_1_var_1_38 >= var_1_10) ? (var_1_9 == ((double) var_1_8)) : 1) : 1)) && ((-32 <= (last_1_var_1_16 ^ (abs (var_1_14)))) ? (((max (var_1_8 , 32.25)) < last_1_var_1_9) ? (var_1_12 == ((unsigned short int) var_1_15)) : (var_1_12 == ((unsigned short int) 4))) : (var_1_12 == ((unsigned short int) var_1_15)))) && ((var_1_10 >= (min ((15.4 * last_1_var_1_17) , var_1_11))) ? (last_1_var_1_27 ? (var_1_16 == ((unsigned long int) last_1_var_1_12)) : 1) : 1)) && (((abs (var_1_10)) >= var_1_8) ? (var_1_17 == ((double) (var_1_18 + var_1_19))) : (var_1_35 ? (var_1_17 == ((double) var_1_19)) : (var_1_17 == ((double) var_1_18))))) && ((var_1_16 <= var_1_12) ? (var_1_20 == ((signed short int) ((max ((var_1_21 + var_1_22) , (max (var_1_23 , var_1_24)))) + (var_1_25 - (var_1_26 - 1))))) : (var_1_20 == ((signed short int) var_1_23)))) && (var_1_27 == ((unsigned char) (var_1_35 && var_1_28)))) && ((var_1_28 || var_1_35) ? (var_1_28 ? (var_1_35 ? ((((var_1_12 + var_1_16) & var_1_16) >= (var_1_16 | var_1_15)) ? ((-64 > var_1_15) ? (var_1_29 == ((unsigned short int) var_1_25)) : 1) : 1) : 1) : (var_1_29 == ((unsigned short int) var_1_15))) : (var_1_29 == ((unsigned short int) var_1_15)))) && (var_1_35 ? (var_1_30 == ((unsigned char) var_1_31)) : (var_1_30 == ((unsigned char) ((max ((min (var_1_32 , var_1_33)) , var_1_34)) + 16))))) && ((var_1_14 > var_1_32) ? ((var_1_6 || var_1_28) ? (var_1_35 == ((unsigned char) ((var_1_7 && var_1_6) && var_1_28))) : 1) : ((((var_1_19 >= last_1_var_1_1) || (var_1_31 != last_1_var_1_16)) || var_1_28) ? (var_1_35 == ((unsigned char) (! (var_1_36 && var_1_37)))) : (var_1_35 == ((unsigned char) var_1_28))))) && (((max (var_1_29 , (min (var_1_33 , var_1_32)))) > var_1_16) ? (var_1_38 == ((float) (var_1_19 + ((abs (var_1_18)) - 1.25f)))) : (var_1_38 == ((float) (var_1_39 - (var_1_40 - var_1_41)))))) && (var_1_42 == ((unsigned char) var_1_32))
;
}
int main(void) {
	isInitial = 1;
