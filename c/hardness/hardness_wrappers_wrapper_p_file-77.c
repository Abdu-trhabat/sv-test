...
void step(void) {
	...
	if ((*(var_1_6_Pointer)) > ((*(var_1_1_Pointer)) * (max ((*(var_1_5_Pointer)) , (*(var_1_7_Pointer)))))) {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) != (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) ((*(var_1_4_Pointer)) - (min ((*(var_1_5_Pointer)) , ((*(var_1_6_Pointer)) - (*(var_1_7_Pointer)))))))) : 1) && (((*(var_1_7_Pointer)) > (*(var_1_5_Pointer))) ? ((*(var_1_8_Pointer)) == ((float) (abs ((*(var_1_9_Pointer)))))) : ((*(var_1_8_Pointer)) == ((float) ((max ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer)))) - ((*(var_1_12_Pointer)) - 3.4f)))))) && (((*(var_1_6_Pointer)) <= (*(var_1_5_Pointer))) ? (((max ((*(var_1_8_Pointer)) , ((*(var_1_12_Pointer)) / (*(var_1_15_Pointer))))) > (min ((*(var_1_10_Pointer)) , (*(var_1_8_Pointer))))) ? ((*(var_1_13_Pointer)) == ((signed short int) (*(var_1_7_Pointer)))) : 1) : ((*(var_1_13_Pointer)) == ((signed short int) (*(var_1_7_Pointer)))))) && (((*(var_1_6_Pointer)) > ((*(var_1_1_Pointer)) * (max ((*(var_1_5_Pointer)) , (*(var_1_7_Pointer)))))) ? (((*(var_1_17_Pointer)) || (*(var_1_18_Pointer))) ? ((*(var_1_16_Pointer)) == ((unsigned short int) (*(var_1_4_Pointer)))) : ((*(var_1_16_Pointer)) == ((unsigned short int) (*(var_1_7_Pointer))))) : ((*(var_1_16_Pointer)) == ((unsigned short int) (*(var_1_6_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
