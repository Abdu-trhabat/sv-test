...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch2850_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_0 <= last_1_var_1_1) {
		var_1_1 = (max ((min (last_1_var_1_15 , (max (last_1_var_1_1 , var_1_4)))) , var_1_5));
	}
	...
	signed long int stepLocal_3 = (max (128 , var_1_16)) - var_1_17;
	if (var_1_6 <= stepLocal_3) {
		var_1_15 = (max ((var_1_5 - var_1_6) , (min (var_1_8 , var_1_7))));
	} else {
		var_1_15 = var_1_6;
	}
...
int property(void) {
	return ((((((last_1_var_1_15 <= last_1_var_1_1) ? (var_1_1 == ((unsigned short int) (max ((min (last_1_var_1_15 , (max (last_1_var_1_1 , var_1_4)))) , var_1_5)))) : 1) && ((var_1_1 < 5) ? (var_1_6 == ((unsigned char) (max ((min ((min (var_1_7 , var_1_8)) , var_1_9)) , var_1_10)))) : (var_1_6 == ((unsigned char) var_1_10)))) && (var_1_12 ? (var_1_13 ? (((var_1_4 > (~ var_1_10)) && var_1_14) ? (var_1_11 == ((signed short int) (max (var_1_8 , (var_1_10 + var_1_6))))) : (var_1_11 == ((signed short int) var_1_15))) : (var_1_11 == ((signed short int) var_1_8))) : (var_1_11 == ((signed short int) var_1_15)))) && ((var_1_6 <= ((max (128 , var_1_16)) - var_1_17)) ? (var_1_15 == ((signed long int) (max ((var_1_5 - var_1_6) , (min (var_1_8 , var_1_7)))))) : (var_1_15 == ((signed long int) var_1_6)))) && ((((200 << var_1_1) * (var_1_17 * var_1_7)) < var_1_15) ? (var_1_18 == ((double) var_1_19)) : 1)) && (var_1_13 ? (var_1_14 ? (var_1_12 ? (var_1_20 == ((float) (var_1_21 + (max (var_1_22 , var_1_23))))) : 1) : ((var_1_11 <= 0) ? (var_1_20 == ((float) var_1_19)) : (var_1_20 == ((float) var_1_22)))) : (var_1_20 == ((float) var_1_23)))
;
}
int main(void) {
	isInitial = 1;
