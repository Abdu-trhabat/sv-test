...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (! (double_Array_0[1] < (127.125 / double_Array_0[0]))) {
		if (signed_short_int_Array_0[2] <= ((signed_short_int_Array_0[0] * signed_short_int_Array_0[1]) + (4 << unsigned_char_Array_0[0]))) {
