...
void step(void) {
	...
	if (WrapperStruct00.var_1_4 > WrapperStruct00.var_1_1) {
		WrapperStruct00.var_1_5 = ((max (WrapperStruct00.var_1_6 , -64)) + ((WrapperStruct00.var_1_7 + -2) + WrapperStruct00.var_1_8));
	}
