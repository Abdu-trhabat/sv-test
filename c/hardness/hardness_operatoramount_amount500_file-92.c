...
void step(void) {
	...
	if (var_1_34 >= (- var_1_33)) {
		...
		if ((var_1_8 * var_1_29) != stepLocal_1) {
			if (stepLocal_4 >= var_1_22) {
				...
				var_1_36 = (abs (max (last_1_var_1_105 , var_1_31)));
			}
		} else {
			var_1_36 = var_1_27;
		}
	...
	if (stepLocal_11 == (~ last_1_var_1_42)) {
		if (stepLocal_12 == last_1_var_1_64) {
			var_1_67 = (((min (var_1_50 , var_1_30)) + last_1_var_1_12) - (var_1_68 - 128));
		}
	}
	...
	signed long int stepLocal_9 = max (var_1_50 , (last_1_var_1_42 - 2));
	if ((abs (last_1_var_1_36)) < stepLocal_10) {
		if (var_1_40 != (var_1_53 * (15.25 / 100.25))) {
			if (-4 > stepLocal_9) {
				var_1_64 = (last_1_var_1_64 + var_1_24);
			} else {
				var_1_64 = (var_1_65 + (abs (last_1_var_1_64)));
			}
		} else {
	...
	if (! (var_1_36 != (max (var_1_26 , var_1_22)))) {
	...
	if (var_1_30 < var_1_10) {
		...
		var_1_32 = (min ((max (var_1_33 , 4.8)) , (var_1_34 + var_1_35)));
	}


	// From: Req15Batch92Amount500
	if (var_1_9) {
		var_1_60 = (min (last_1_var_1_60 , var_1_30));
	} else {
		var_1_60 = (((min (var_1_61 , var_1_62)) - (abs (var_1_27))) - (var_1_63 - var_1_47));
	}


	// From: Req17Batch92Amount500
	if (var_1_27 > (var_1_13 - (max (var_1_26 , var_1_29)))) {
		var_1_66 = var_1_30;
	}
	...
	if ((var_1_41 - (var_1_59 + var_1_58)) == (- (var_1_33 / var_1_46))) {
		var_1_71 = ((var_1_61 - var_1_27) - (max ((var_1_8 + var_1_29) , var_1_24)));
	}
	...
	if (var_1_100) {
		if (var_1_10 <= stepLocal_31) {
			if (var_1_13 < stepLocal_29) {
				...
				var_1_88 = (max (var_1_13 , var_1_47));
			}
		} else {
		...
		if ((var_1_98 + var_1_24) > stepLocal_30) {
			var_1_88 = (abs (100 - (var_1_47 + var_1_8)));
		} else {
	...
	if ((var_1_72 * var_1_103) != var_1_108) {
		if (var_1_72 > (var_1_103 + var_1_108)) {
			...
			var_1_14 = ((abs (var_1_19)) - (min (var_1_102 , var_1_8)));
		}
	}
	...
	if (var_1_7 >= stepLocal_23) {
		var_1_83 = (var_1_24 + (abs (var_1_27)));
	} else {
	...
	unsigned char stepLocal_21 = (max (var_1_65 , var_1_47)) > (var_1_14 - var_1_99);
	...
	if (stepLocal_21 && ((var_1_10 / var_1_68) <= var_1_37)) {
		if (var_1_63 <= stepLocal_17) {
			var_1_78 = (var_1_13 + (min (var_1_29 , var_1_27)));
		} else {
			if (stepLocal_18 <= var_1_48) {
				var_1_78 = (min (var_1_30 , (var_1_26 + var_1_29)));
			} else {
				if (stepLocal_22 != (min (var_1_67 , var_1_71))) {
					var_1_78 = (max ((min (var_1_24 , var_1_13)) , var_1_30));
				} else {
					if (-32 <= stepLocal_20) {
						...
						var_1_78 = ((min (var_1_79 , 128)) - var_1_30);
					}
				}
			}
		}
	} else {
		var_1_78 = (max (var_1_29 , var_1_30));
	}


	// From: Req25Batch92Amount500
	if (! (var_1_67 <= var_1_88)) {
		var_1_80 = (min (var_1_83 , ((var_1_48 + var_1_82) - var_1_88)));
	} else {
		var_1_80 = (abs (var_1_8));
	}
	...
	if (var_1_32 <= var_1_46) {
		if (var_1_76) {
			var_1_94 = ((min (last_1_var_1_94 , var_1_71)) - var_1_18);
		} else {
			var_1_94 = (var_1_82 + (min (var_1_22 , var_1_80)));
		}
	} else {
		if ((- (- var_1_108)) <= var_1_104) {
			if (var_1_98 > var_1_26) {
				var_1_94 = (max (var_1_13 , var_1_80));
			} else {
				var_1_94 = var_1_47;
			}
		} else {
			var_1_94 = (last_1_var_1_94 + ((max (var_1_78 , var_1_83)) + last_1_var_1_94));
		}
	}
	...
	if (var_1_107) {
		if (var_1_64 >= stepLocal_32) {
			var_1_90 = ((max (var_1_41 , var_1_59)) - var_1_40);
		} else {
		...
		var_1_90 = (var_1_58 - (abs (var_1_55 + var_1_34)));
	}
	...
	if (50.25f <= var_1_90) {
		if ((var_1_24 - var_1_29) >= stepLocal_7) {
			if (var_1_34 <= ((1.6 * var_1_32) / (max (var_1_45 , var_1_46)))) {
			...
			if (stepLocal_6 <= (var_1_102 / (max (var_1_37 , var_1_49)))) {
				var_1_43 = ((min (var_1_50 , var_1_51)) - var_1_12);
			}
		}
	} else {
		var_1_43 = (max (var_1_50 , (min ((var_1_30 + var_1_47) , var_1_24))));
	}


	// From: Req14Batch92Amount500
	unsigned char stepLocal_8 = var_1_39 > var_1_103;
	if (! ((abs (var_1_102)) <= (var_1_49 / var_1_37))) {
		if (var_1_6 || stepLocal_8) {
			var_1_52 = (min (((max (var_1_34 , var_1_35)) + var_1_53) , ((var_1_54 + var_1_55) + (var_1_56 + var_1_57))));
		} else {
			var_1_52 = var_1_55;
		}
	} else {
	...
	if ((- var_1_10) <= stepLocal_14) {
		if (stepLocal_13 > var_1_94) {
			var_1_69 = (var_1_29 + ((var_1_13 + var_1_30) - (abs (var_1_31))));
		} else {
			var_1_69 = (min (var_1_13 , -1));
		}
	}


	// From: Req34Batch92Amount500
	if (var_1_90 != ((var_1_93 + var_1_92) - (max (199.5 , 99.2)))) {
	...
	if (stepLocal_5 == var_1_7) {
		var_1_42 = (max (var_1_94 , var_1_26));
	} else {
	...
	if (var_1_9) {
		if ((var_1_103 + var_1_90) > var_1_72) {
			...
			var_1_20 = (max (var_1_13 , var_1_22));
		}
	}
	...
	if (var_1_72 >= (var_1_109 / 9.8)) {
		if (var_1_39 > (max (var_1_109 , var_1_72))) {
			var_1_23 = (var_1_13 + (min (5 , (min (2 , var_1_24)))));
		}
	}
	...
	if (var_1_1) {
		if (stepLocal_25 || ((var_1_37 < -2) || var_1_9)) {
			if (stepLocal_24 >= (min (var_1_36 , var_1_67))) {
				if (stepLocal_26 || (var_1_26 >= var_1_61)) {
					var_1_85 = ((var_1_22 + var_1_27) + (max (128 , (var_1_29 - var_1_13))));
				} else {
					var_1_85 = (min ((var_1_36 + var_1_31) , (max (var_1_27 , (max (var_1_8 , var_1_65))))));
				}
			} else {
				var_1_85 = (min (last_1_var_1_85 , var_1_31));
			}
		}
	} else {
		var_1_85 = (abs (var_1_49));
	}


	// From: Req33Batch92Amount500
	if ((max ((var_1_30 * 2u) , (256u & 0u))) != var_1_18) {
		if (var_1_94 <= (- (var_1_42 + var_1_60))) {
			if ((var_1_47 - var_1_8) < (min (last_1_var_1_95 , (min (var_1_82 , var_1_60))))) {
				var_1_95 = (max ((abs (var_1_8)) , (var_1_51 - var_1_99)));
			}
		}
	} else {
		if (! var_1_75) {
			var_1_95 = (max (var_1_84 , var_1_51));
		}
	}
	...
	if ((min (var_1_37 , var_1_95)) <= stepLocal_15) {
		if (16 >= stepLocal_16) {
	...
	if (stepLocal_27 > var_1_61) {
		var_1_87 = (abs (var_1_59 - var_1_41));
	} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((var_1_96 ? ((var_1_98 > var_1_14) ? (var_1_1 == ((unsigned char) (! (! (var_1_5 || var_1_6))))) : 1) : ((var_1_98 < (var_1_7 - (31514 - var_1_8))) ? (var_1_1 == ((unsigned char) (! var_1_9))) : (var_1_1 == ((unsigned char) (var_1_9 && var_1_6))))) && (var_1_10 == ((unsigned long int) (max (var_1_8 , var_1_11))))) && ((8u == ((3877202530u - var_1_8) >> var_1_13)) ? (var_1_12 == ((unsigned char) (abs (var_1_13)))) : 1)) && (((var_1_72 * var_1_103) != var_1_108) ? ((var_1_72 > (var_1_103 + var_1_108)) ? (var_1_14 == ((unsigned long int) (var_1_13 + ((var_1_18 - var_1_8) + var_1_102)))) : (var_1_14 == ((unsigned long int) ((abs (var_1_19)) - (min (var_1_102 , var_1_8)))))) : 1)) && (var_1_9 ? (((var_1_103 + var_1_90) > var_1_72) ? (var_1_20 == ((signed char) (var_1_13 - 10))) : (var_1_20 == ((signed char) (max (var_1_13 , var_1_22))))) : 1)) && ((var_1_72 >= (var_1_109 / 9.8)) ? ((var_1_39 > (max (var_1_109 , var_1_72))) ? (var_1_23 == ((unsigned char) (var_1_13 + (min (5 , (min (2 , var_1_24))))))) : 1) : 1)) && (var_1_25 == ((signed char) (var_1_13 - (var_1_26 - var_1_27))))) && ((! (var_1_36 != (max (var_1_26 , var_1_22)))) ? (var_1_28 == ((signed char) (var_1_13 + ((var_1_29 - var_1_30) + var_1_31)))) : 1)) && ((var_1_30 < var_1_10) ? (var_1_32 == ((double) var_1_33)) : (var_1_32 == ((double) (min ((max (var_1_33 , 4.8)) , (var_1_34 + var_1_35))))))) && ((var_1_34 >= (- var_1_33)) ? (((last_1_var_1_60 > var_1_24) && (var_1_7 < last_1_var_1_20)) ? (var_1_36 == ((signed long int) (5 + var_1_22))) : (((last_1_var_1_60 + var_1_27) > last_1_var_1_88) ? (var_1_36 == ((signed long int) (var_1_26 + last_1_var_1_20))) : (var_1_36 == ((signed long int) ((var_1_37 - var_1_30) - var_1_27))))) : (((var_1_8 * var_1_29) != last_1_var_1_88) ? ((var_1_30 >= var_1_22) ? (var_1_36 == ((signed long int) var_1_8)) : (var_1_36 == ((signed long int) (abs (max (last_1_var_1_105 , var_1_31)))))) : (var_1_36 == ((signed long int) var_1_27))))) && ((10.65 <= var_1_90) ? (var_1_39 == ((double) ((2.2 + 9.5) + var_1_34))) : (var_1_39 == ((double) (var_1_40 - var_1_41))))) && ((var_1_64 == var_1_7) ? (var_1_42 == ((signed long int) (max (var_1_94 , var_1_26)))) : (var_1_42 == ((signed long int) (var_1_30 - var_1_101))))) && ((50.25f <= var_1_90) ? (((var_1_24 - var_1_29) >= (var_1_30 | var_1_94)) ? ((var_1_34 <= ((1.6 * var_1_32) / (max (var_1_45 , var_1_46)))) ? (var_1_43 == ((unsigned short int) (((var_1_47 - var_1_26) + var_1_13) + (var_1_48 - (var_1_49 - var_1_30))))) : (var_1_6 ? (var_1_43 == ((unsigned short int) ((var_1_8 + var_1_12) + (var_1_29 + var_1_49)))) : (var_1_43 == ((unsigned short int) ((var_1_48 - (var_1_49 - var_1_29)) + ((var_1_13 + 64) + var_1_8)))))) : ((var_1_71 <= (var_1_102 / (max (var_1_37 , var_1_49)))) ? (var_1_43 == ((unsigned short int) ((min (var_1_50 , var_1_51)) - var_1_12))) : 1)) : (var_1_43 == ((unsigned short int) (max (var_1_50 , (min ((var_1_30 + var_1_47) , var_1_24)))))))) && ((! ((abs (var_1_102)) <= (var_1_49 / var_1_37))) ? ((var_1_6 || (var_1_39 > var_1_103)) ? (var_1_52 == ((float) (min (((max (var_1_34 , var_1_35)) + var_1_53) , ((var_1_54 + var_1_55) + (var_1_56 + var_1_57)))))) : (var_1_52 == ((float) var_1_55))) : (var_1_52 == ((float) ((var_1_58 - var_1_59) + var_1_57))))) && (var_1_9 ? (var_1_60 == ((unsigned long int) (min (last_1_var_1_60 , var_1_30)))) : (var_1_60 == ((unsigned long int) (((min (var_1_61 , var_1_62)) - (abs (var_1_27))) - (var_1_63 - var_1_47)))))) && (((abs (last_1_var_1_36)) < last_1_var_1_71) ? ((var_1_40 != (var_1_53 * (15.25 / 100.25))) ? ((-4 > (max (var_1_50 , (last_1_var_1_42 - 2)))) ? (var_1_64 == ((signed short int) (last_1_var_1_64 + var_1_24))) : (var_1_64 == ((signed short int) (var_1_65 + (abs (last_1_var_1_64)))))) : (var_1_64 == ((signed short int) (last_1_var_1_83 + var_1_30)))) : ((last_1_var_1_97 > last_1_var_1_109) ? ((! var_1_6) ? (var_1_64 == ((signed short int) (var_1_13 - 16))) : 1) : 1))) && ((var_1_27 > (var_1_13 - (max (var_1_26 , var_1_29)))) ? (var_1_66 == ((unsigned char) var_1_30)) : 1)) && (((last_1_var_1_10 * (var_1_47 * var_1_11)) == (~ last_1_var_1_42)) ? ((((last_1_var_1_12 - var_1_13) & var_1_27) == last_1_var_1_64) ? (var_1_67 == ((signed long int) (((min (var_1_50 , var_1_30)) + last_1_var_1_12) - (var_1_68 - 128)))) : 1) : 1)) && (((- var_1_10) <= var_1_63) ? ((var_1_30 > var_1_94) ? (var_1_69 == ((signed char) (var_1_29 + ((var_1_13 + var_1_30) - (abs (var_1_31)))))) : (var_1_69 == ((signed char) (min (var_1_13 , -1))))) : 1)) && (var_1_70 == ((unsigned char) var_1_9))) && (((var_1_41 - (var_1_59 + var_1_58)) == (- (var_1_33 / var_1_46))) ? (var_1_71 == ((unsigned long int) ((var_1_61 - var_1_27) - (max ((var_1_8 + var_1_29) , var_1_24))))) : 1)) && (var_1_72 == ((double) (var_1_40 - var_1_58)))) && (((min (var_1_37 , var_1_95)) <= (var_1_51 * var_1_60)) ? ((16 >= var_1_23) ? (var_1_73 == ((unsigned char) ((var_1_6 || var_1_5) || var_1_75))) : 1) : (var_1_73 == ((unsigned char) ((var_1_9 && (var_1_96 || var_1_76)) && var_1_77))))) && ((((max (var_1_65 , var_1_47)) > (var_1_14 - var_1_99)) && ((var_1_10 / var_1_68) <= var_1_37)) ? ((var_1_63 <= var_1_48) ? (var_1_78 == ((unsigned char) (var_1_13 + (min (var_1_29 , var_1_27))))) : (((var_1_24 / var_1_19) <= var_1_48) ? (var_1_78 == ((unsigned char) (min (var_1_30 , (var_1_26 + var_1_29))))) : ((var_1_13 != (min (var_1_67 , var_1_71))) ? (var_1_78 == ((unsigned char) (max ((min (var_1_24 , var_1_13)) , var_1_30)))) : ((-32 <= var_1_67) ? ((var_1_6 || (var_1_71 != (var_1_7 - var_1_27))) ? (var_1_78 == ((unsigned char) (var_1_26 + (var_1_30 + var_1_29)))) : (var_1_78 == ((unsigned char) (var_1_26 + (var_1_13 + var_1_29))))) : (var_1_78 == ((unsigned char) ((min (var_1_79 , 128)) - var_1_30))))))) : (var_1_78 == ((unsigned char) (max (var_1_29 , var_1_30)))))) && ((! (var_1_67 <= var_1_88)) ? (var_1_80 == ((unsigned short int) (min (var_1_83 , ((var_1_48 + var_1_82) - var_1_88))))) : (var_1_80 == ((unsigned short int) (abs (var_1_8)))))) && ((var_1_7 >= var_1_14) ? (var_1_83 == ((unsigned char) (var_1_24 + (abs (var_1_27))))) : (var_1_83 == ((unsigned char) ((var_1_26 + var_1_84) - var_1_29))))) && (var_1_1 ? (((var_1_77 && var_1_100) || ((var_1_37 < -2) || var_1_9)) ? ((var_1_36 >= (min (var_1_36 , var_1_67))) ? ((var_1_77 || (var_1_26 >= var_1_61)) ? (var_1_85 == ((signed short int) ((var_1_22 + var_1_27) + (max (128 , (var_1_29 - var_1_13)))))) : (var_1_85 == ((signed short int) (min ((var_1_36 + var_1_31) , (max (var_1_27 , (max (var_1_8 , var_1_65))))))))) : (var_1_85 == ((signed short int) (min (last_1_var_1_85 , var_1_31))))) : 1) : (var_1_85 == ((signed short int) (abs (var_1_49)))))) && (var_1_73 ? (var_1_86 == ((signed char) (var_1_13 - 5))) : 1)) && ((var_1_50 > var_1_61) ? (var_1_87 == ((float) (abs (var_1_59 - var_1_41)))) : (((- var_1_26) == (var_1_51 | var_1_95)) ? (var_1_87 == ((float) (var_1_40 - (var_1_58 + var_1_59)))) : (var_1_87 == ((float) ((5.709347504436945E18f - var_1_58) - var_1_59)))))) && (var_1_100 ? ((var_1_10 <= var_1_27) ? ((var_1_13 < var_1_62) ? (var_1_88 == ((signed long int) ((var_1_99 + var_1_22) + var_1_82))) : (var_1_88 == ((signed long int) (max (var_1_13 , var_1_47))))) : (var_1_88 == ((signed long int) (var_1_82 + var_1_27)))) : (((var_1_98 + var_1_24) > var_1_99) ? (var_1_88 == ((signed long int) (abs (100 - (var_1_47 + var_1_8))))) : (var_1_88 == ((signed long int) (var_1_36 - var_1_79)))))) && (var_1_107 ? ((var_1_64 >= 1) ? (var_1_90 == ((double) ((max (var_1_41 , var_1_59)) - var_1_40))) : ((var_1_14 == (10u * (var_1_60 * var_1_84))) ? (var_1_90 == ((double) ((var_1_59 - (var_1_92 + 15.52)) + (var_1_58 - var_1_93)))) : 1)) : (var_1_90 == ((double) (var_1_58 - (abs (var_1_55 + var_1_34))))))) && ((var_1_32 <= var_1_46) ? (var_1_76 ? (var_1_94 == ((signed long int) ((min (last_1_var_1_94 , var_1_71)) - var_1_18))) : (var_1_94 == ((signed long int) (var_1_82 + (min (var_1_22 , var_1_80)))))) : (((- (- var_1_108)) <= var_1_104) ? ((var_1_98 > var_1_26) ? (var_1_94 == ((signed long int) (max (var_1_13 , var_1_80)))) : (var_1_94 == ((signed long int) var_1_47))) : (var_1_94 == ((signed long int) (last_1_var_1_94 + ((max (var_1_78 , var_1_83)) + last_1_var_1_94))))))) && (((max ((var_1_30 * 2u) , (256u & 0u))) != var_1_18) ? ((var_1_94 <= (- (var_1_42 + var_1_60))) ? (((var_1_47 - var_1_8) < (min (last_1_var_1_95 , (min (var_1_82 , var_1_60))))) ? (var_1_95 == ((unsigned short int) (max ((abs (var_1_8)) , (var_1_51 - var_1_99))))) : 1) : 1) : ((! var_1_75) ? (var_1_95 == ((unsigned short int) (max (var_1_84 , var_1_51)))) : 1))) && ((var_1_90 != ((var_1_93 + var_1_92) - (max (199.5 , 99.2)))) ? (((var_1_63 | var_1_94) >= var_1_71) ? ((! var_1_70) ? (var_1_96 == ((unsigned char) var_1_6)) : (var_1_96 == ((unsigned char) (var_1_76 && var_1_77)))) : (var_1_96 == ((unsigned char) var_1_76))) : (var_1_96 == ((unsigned char) var_1_6)))) && (var_1_97 == ((double) var_1_58))) && (var_1_9 ? (var_1_98 == ((signed long int) var_1_7)) : (var_1_98 == ((signed long int) var_1_8)))) && (var_1_99 == ((unsigned short int) var_1_60))) && (var_1_100 == ((unsigned char) var_1_6))) && (var_1_101 == ((unsigned short int) var_1_24))) && (var_1_76 ? (var_1_102 == ((unsigned char) var_1_84)) : 1)) && (var_1_103 == ((double) var_1_58))) && (var_1_5 ? (var_1_104 == ((float) var_1_59)) : (var_1_104 == ((float) 8.5f)))) && (var_1_77 ? (var_1_105 == ((unsigned short int) var_1_13)) : (var_1_105 == ((unsigned short int) var_1_30)))) && (var_1_77 ? (var_1_106 == ((float) var_1_54)) : (var_1_106 == ((float) var_1_40)))) && (var_1_76 ? (var_1_107 == ((unsigned char) var_1_75)) : 1)) && (var_1_9 ? (var_1_108 == ((double) var_1_55)) : (var_1_108 == ((double) var_1_53)))) && (var_1_100 ? (var_1_109 == ((double) var_1_41)) : (var_1_109 == ((double) var_1_59)))) && (((256 << 8) <= ((abs (var_1_29)) * -4)) ? (((var_1_80 % var_1_50) >= (5 << var_1_61)) ? (var_1_110 == ((signed char) var_1_26)) : (var_1_110 == ((signed char) var_1_22))) : (var_1_110 == ((signed char) var_1_29)))
;
}
int main(void) {
	isInitial = 1;
