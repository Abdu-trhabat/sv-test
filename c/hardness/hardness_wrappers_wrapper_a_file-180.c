...
void step(void) {
	// From: Req2Batch180Wrapper_A
	if (! BOOL_unsigned_char_Array_0[2]) {
		unsigned_char_Array_0[4] = (min (unsigned_char_Array_0[3] , (unsigned_char_Array_0[1] - (unsigned_char_Array_0[0] + unsigned_char_Array_0[2]))));
	} else {
		unsigned_char_Array_0[4] = (128 - unsigned_char_Array_0[0]);
	}


	// From: Req1Batch180Wrapper_A
	...
	if (BOOL_unsigned_char_Array_0[2]) {
		if (stepLocal_1 < unsigned_char_Array_0[2]) {
			if ((max ((unsigned_char_Array_0[1] - unsigned_char_Array_0[2]) , signed_short_int_Array_0[0])) >= stepLocal_2) {
