...
void step(void) {
 ...
 unsigned long int stepLocal_1 = ((((*(WrapperStruct00_var_1_8_Pointer))) > ((*(WrapperStruct00_var_1_7_Pointer)))) ? ((*(WrapperStruct00_var_1_8_Pointer))) : ((*(WrapperStruct00_var_1_7_Pointer))));
 if ((((((*(WrapperStruct00_var_1_6_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_6_Pointer))) : ((*(WrapperStruct00_var_1_6_Pointer))))) < stepLocal_1) {
  (*(WrapperStruct00_var_1_9_Pointer)) = (((*(WrapperStruct00_var_1_10_Pointer)) - (*(WrapperStruct00_var_1_11_Pointer))) - (((((*(WrapperStruct00_var_1_12_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_12_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer))))));
 }
 ...
 if ((*(WrapperStruct00_var_1_4_Pointer))) {
  if ((*(WrapperStruct00_var_1_5_Pointer)) > 99.4) {
   if ((*(WrapperStruct00_var_1_14_Pointer)) >= (*(WrapperStruct00_var_1_6_Pointer))) {
    (*(WrapperStruct00_var_1_13_Pointer)) = (((((*(WrapperStruct00_var_1_10_Pointer))) < (256)) ? ((*(WrapperStruct00_var_1_10_Pointer))) : (256)));
   }
  }
 }
}
