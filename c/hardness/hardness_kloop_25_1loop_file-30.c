...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch3025_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_3 < stepLocal_1) {
		var_1_8 = (var_1_1 - (min (var_1_7 , var_1_9)));
	} else {
		var_1_8 = var_1_7;
	}
...
int property(void) {
	return ((var_1_2 ? ((last_1_var_1_8 > ((last_1_var_1_8 / var_1_5) % var_1_6)) ? (var_1_1 == ((unsigned char) var_1_7)) : 1) : (var_1_1 == ((unsigned char) var_1_7))) && ((var_1_3 < var_1_5) ? (var_1_8 == ((signed long int) (var_1_1 - (min (var_1_7 , var_1_9))))) : (var_1_8 == ((signed long int) var_1_7)))) && ((((var_1_6 * var_1_4) * var_1_7) <= (var_1_1 - var_1_11)) ? ((var_1_5 <= (var_1_12 + var_1_4)) ? (var_1_10 == ((float) var_1_13)) : 1) : ((var_1_9 >= var_1_11) ? (var_1_10 == ((float) var_1_13)) : (var_1_10 == ((float) 24.2f))))
;
}
int main(void) {
	isInitial = 1;
