...
void step(void) {
	...
	// From: Req4Batch169Wrapper_P
	(*(var_1_14_Pointer)) = (*(var_1_9_Pointer));


	// From: Req5Batch169Wrapper_P
	(*(var_1_15_Pointer)) = (*(var_1_8_Pointer));


	// From: Req6Batch169Wrapper_P
	(*(var_1_16_Pointer)) = (*(var_1_5_Pointer));


	// From: Req3Batch169Wrapper_P
	if ((*(var_1_6_Pointer)) > (*(var_1_14_Pointer))) {
		if ((*(var_1_11_Pointer))) {
			(*(var_1_10_Pointer)) = ((abs ((*(var_1_12_Pointer)))) - (*(var_1_13_Pointer)));
		} else {
...
int property(void) {
	return (((((((*(var_1_2_Pointer)) >= ((*(var_1_3_Pointer)) + (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed short int) ((*(var_1_5_Pointer)) - (*(var_1_6_Pointer))))) : 1) && (((*(var_1_5_Pointer)) >= (((*(var_1_8_Pointer)) - (*(var_1_9_Pointer))) - (*(var_1_6_Pointer)))) ? (((*(var_1_2_Pointer)) == (max ((*(var_1_3_Pointer)) , (- (*(var_1_4_Pointer)))))) ? ((*(var_1_7_Pointer)) == ((unsigned long int) ((*(var_1_6_Pointer)) + (*(var_1_8_Pointer))))) : (((*(var_1_4_Pointer)) >= (*(var_1_3_Pointer))) ? ((*(var_1_7_Pointer)) == ((unsigned long int) (*(var_1_9_Pointer)))) : 1)) : ((*(var_1_7_Pointer)) == ((unsigned long int) (*(var_1_6_Pointer)))))) && (((*(var_1_6_Pointer)) > (*(var_1_14_Pointer))) ? ((*(var_1_11_Pointer)) ? ((*(var_1_10_Pointer)) == ((double) ((abs ((*(var_1_12_Pointer)))) - (*(var_1_13_Pointer))))) : ((*(var_1_10_Pointer)) == ((double) (*(var_1_12_Pointer))))) : ((*(var_1_10_Pointer)) == ((double) (*(var_1_13_Pointer)))))) && ((*(var_1_14_Pointer)) == ((signed long int) (*(var_1_9_Pointer))))) && ((*(var_1_15_Pointer)) == ((unsigned short int) (*(var_1_8_Pointer))))) && ((*(var_1_16_Pointer)) == ((signed short int) (*(var_1_5_Pointer))))
;
}
int main(void) {
	isInitial = 1;
