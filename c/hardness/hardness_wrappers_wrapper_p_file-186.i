...
void step(void) {
 if ((*(var_1_2_Pointer)) < (*(var_1_3_Pointer))) {
  if ((*(var_1_3_Pointer)) < (*(var_1_2_Pointer))) {
   (*(var_1_1_Pointer)) = ((*(var_1_4_Pointer)) + ((((128) < 0 ) ? -(128) : (128))));
  } else {
   (*(var_1_1_Pointer)) = (*(var_1_4_Pointer));
  }
 }
 if ((((((*(var_1_3_Pointer))) > ((*(var_1_2_Pointer)))) ? ((*(var_1_3_Pointer))) : ((*(var_1_2_Pointer))))) > (*(var_1_6_Pointer))) {
