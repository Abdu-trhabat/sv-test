...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch167dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch167dependencies
	if ((var_1_2 && var_1_14) && var_1_15) {
		var_1_13 = var_1_16;
	}


	// From: Req5Batch167dependencies
	var_1_20 = ((var_1_21 + 16) + (var_1_22 + var_1_23));


	// From: Req6Batch167dependencies
	if ((min (var_1_1 , (- var_1_9))) > var_1_8) {
	...
	// From: Req4Batch167dependencies
	if (((max (var_1_3 , var_1_18)) * var_1_4) == var_1_5) {
		var_1_17 = (-1 - var_1_19);
	} else {
		var_1_17 = var_1_24;
	}
