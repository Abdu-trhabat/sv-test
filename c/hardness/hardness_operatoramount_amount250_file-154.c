...
void step(void) {
	...
	// From: Req12Batch154Amount250
	if (! var_1_5) {
		var_1_32 = (var_1_33 || var_1_34);
	}


	// From: Req1Batch154Amount250
	if (last_1_var_1_36) {
	...
	// From: Req11Batch154Amount250
	if (var_1_7) {
		var_1_31 = var_1_26;
	} else {
		var_1_31 = (max (var_1_24 , ((var_1_23 + var_1_27) + var_1_26)));
	}


	// From: Req16Batch154Amount250
	if (var_1_34) {
		var_1_39 = (var_1_16 - var_1_23);
	}


	// From: Req27Batch154Amount250
	if (var_1_32) {
		var_1_55 = var_1_26;
	} else {
		var_1_55 = var_1_9;
	...
	// From: Req28Batch154Amount250
	var_1_56 = var_1_34;


	// From: Req30Batch154Amount250
	var_1_59 = var_1_27;


	// From: Req31Batch154Amount250
	var_1_60 = var_1_17;


	// From: Req32Batch154Amount250
	var_1_61 = var_1_9;


	// From: Req8Batch154Amount250
	signed long int stepLocal_7 = var_1_3;
	unsigned char stepLocal_6 = var_1_16;
	if (var_1_11 != (var_1_12 * (var_1_10 * var_1_13))) {
		if (stepLocal_6 <= (var_1_18 & (abs (var_1_61)))) {
			if (var_1_32) {
				var_1_21 = var_1_9;
			} else {
				var_1_21 = 100;
		...
		if (stepLocal_7 > var_1_4) {
			var_1_21 = ((min ((var_1_23 + var_1_24) , var_1_22)) - var_1_25);
		} else {
			var_1_21 = (var_1_23 + (var_1_24 - (max (var_1_26 , var_1_27))));
		}
	}


	// From: Req10Batch154Amount250
	if (var_1_6) {
		if (var_1_16 <= (max (var_1_60 , var_1_20))) {
			var_1_29 = (max (((min (var_1_4 , var_1_26)) + var_1_18) , 10u));
		} else {
			var_1_29 = ((var_1_30 - var_1_18) + (min ((var_1_17 + var_1_25) , var_1_26)));
		}
	} else {
		var_1_29 = ((var_1_23 + 64u) + (min (last_1_var_1_29 , var_1_16)));
	}


	// From: Req13Batch154Amount250
	...
	// From: Req17Batch154Amount250
	if (var_1_56) {
		var_1_40 = ((abs (var_1_41 - var_1_24)) - (var_1_26 + var_1_27));
	} else {
		var_1_40 = (max (var_1_23 , var_1_41));
	}


	// From: Req20Batch154Amount250
	var_1_44 = (var_1_35 + var_1_22);


	// From: Req21Batch154Amount250
	if (var_1_29 >= var_1_27) {
		var_1_45 = (var_1_41 - (max (var_1_24 , var_1_26)));
	} else {
		var_1_45 = ((var_1_46 - (min (var_1_23 , var_1_24))) + var_1_25);
	}


	// From: Req29Batch154Amount250
	...
	// From: Req3Batch154Amount250
	if (var_1_35 > var_1_4) {
		var_1_8 = (abs (abs (var_1_9)));
	}


	// From: Req9Batch154Amount250
	signed char stepLocal_8 = var_1_25;
	if (stepLocal_8 != var_1_61) {
		if (var_1_36) {
			var_1_28 = (max (var_1_24 , (var_1_25 + var_1_17)));
		} else {
			var_1_28 = (min ((-64 + var_1_27) , var_1_61));
		}
	} else {
	...
	// From: Req23Batch154Amount250
	signed long int stepLocal_15 = min (var_1_46 , var_1_42);
	...
	// From: Req25Batch154Amount250
	if (var_1_6) {
		if ((var_1_19 > var_1_46) || (! var_1_33)) {
			var_1_52 = (min ((var_1_17 + var_1_46) , (var_1_16 - var_1_24)));
		} else {
			if (var_1_39 == var_1_29) {
				var_1_52 = var_1_26;
			} else {
				var_1_52 = (max (var_1_17 , (max (var_1_26 , 2))));
			}
		}
	} else {
		var_1_52 = ((max (var_1_22 , var_1_46)) + (min (var_1_26 , var_1_17)));
	}


	// From: Req5Batch154Amount250
	if ((var_1_13 - var_1_12) <= var_1_47) {
		var_1_14 = (var_1_40 + var_1_9);
	}


	// From: Req15Batch154Amount250
	if (128u < (min ((var_1_24 * var_1_23) , var_1_27))) {
		var_1_37 = (min (var_1_9 , var_1_16));
	} else {
		if (! ((var_1_11 * var_1_12) <= var_1_47)) {
			if (var_1_56) {
				if (var_1_6) {
					var_1_37 = (max ((var_1_22 + var_1_21) , (max ((var_1_39 - var_1_16) , var_1_20))));
				} else {
					var_1_37 = (max (var_1_19 , (var_1_27 - (max (var_1_23 , var_1_26)))));
				}
			} else {
	...
	// From: Req24Batch154Amount250
	if (((- var_1_37) / var_1_22) > var_1_18) {
		if (var_1_10 <= (min ((min (var_1_11 , var_1_13)) , var_1_12))) {
			var_1_50 = (max ((var_1_13 + (abs (var_1_12))) , var_1_48));
		}
	}


	// From: Req6Batch154Amount250
...
int property(void) {
	return (((((((((((((((((((((((((((((((last_1_var_1_36 ? (var_1_1 == ((signed long int) (var_1_3 - var_1_4))) : (var_1_1 == ((signed long int) (max (var_1_3 , var_1_4))))) && ((var_1_3 <= last_1_var_1_57) ? (var_1_5 == ((unsigned char) (var_1_6 && (last_1_var_1_32 || var_1_7)))) : ((var_1_3 == var_1_4) ? (var_1_5 == ((unsigned char) (var_1_7 && var_1_6))) : 1))) && ((var_1_35 > var_1_4) ? (var_1_8 == ((signed char) (abs (abs (var_1_9))))) : 1)) && ((var_1_9 > var_1_3) ? (var_1_10 == ((float) ((abs (var_1_11)) - (var_1_12 + var_1_13)))) : (var_1_10 == ((float) (var_1_13 - var_1_12))))) && (((var_1_13 - var_1_12) <= var_1_47) ? (var_1_14 == ((signed short int) (var_1_40 + var_1_9))) : 1)) && ((var_1_50 > var_1_11) ? ((var_1_11 >= var_1_13) ? (var_1_15 == ((unsigned char) (var_1_16 - var_1_17))) : ((var_1_35 < var_1_9) ? (((1000 / (var_1_16 + var_1_18)) < -50) ? (var_1_15 == ((unsigned char) var_1_17)) : 1) : (var_1_15 == ((unsigned char) 0)))) : (var_1_15 == ((unsigned char) var_1_17)))) && ((var_1_43 != var_1_3) ? (var_1_19 == ((unsigned short int) var_1_17)) : (var_1_19 == ((unsigned short int) ((var_1_20 - 16) - ((50 + var_1_17) + var_1_29)))))) && ((var_1_11 != (var_1_12 * (var_1_10 * var_1_13))) ? ((var_1_16 <= (var_1_18 & (abs (var_1_61)))) ? (var_1_32 ? (var_1_21 == ((signed char) var_1_9)) : (var_1_21 == ((signed char) 100))) : ((var_1_10 > var_1_13) ? (var_1_21 == ((signed char) ((var_1_22 - var_1_23) - 10))) : 1)) : ((var_1_3 > var_1_4) ? (var_1_21 == ((signed char) ((min ((var_1_23 + var_1_24) , var_1_22)) - var_1_25))) : (var_1_21 == ((signed char) (var_1_23 + (var_1_24 - (max (var_1_26 , var_1_27))))))))) && ((var_1_25 != var_1_61) ? (var_1_36 ? (var_1_28 == ((signed short int) (max (var_1_24 , (var_1_25 + var_1_17))))) : (var_1_28 == ((signed short int) (min ((-64 + var_1_27) , var_1_61))))) : (var_1_28 == ((signed short int) (var_1_25 + var_1_9))))) && (var_1_6 ? ((var_1_16 <= (max (var_1_60 , var_1_20))) ? (var_1_29 == ((unsigned long int) (max (((min (var_1_4 , var_1_26)) + var_1_18) , 10u)))) : (var_1_29 == ((unsigned long int) ((var_1_30 - var_1_18) + (min ((var_1_17 + var_1_25) , var_1_26)))))) : (var_1_29 == ((unsigned long int) ((var_1_23 + 64u) + (min (last_1_var_1_29 , var_1_16))))))) && (var_1_7 ? (var_1_31 == ((unsigned char) var_1_26)) : (var_1_31 == ((unsigned char) (max (var_1_24 , ((var_1_23 + var_1_27) + var_1_26))))))) && ((! var_1_5) ? (var_1_32 == ((unsigned char) (var_1_33 || var_1_34))) : 1)) && (((var_1_4 + (var_1_30 / var_1_22)) <= (var_1_29 * var_1_18)) ? (var_1_35 == ((unsigned long int) 128u)) : 1)) && (((var_1_26 - var_1_25) >= var_1_35) ? (var_1_36 == ((unsigned char) ((var_1_29 > (-32 * var_1_19)) || var_1_6))) : 1)) && ((128u < (min ((var_1_24 * var_1_23) , var_1_27))) ? (var_1_37 == ((signed short int) (min (var_1_9 , var_1_16)))) : ((! ((var_1_11 * var_1_12) <= var_1_47)) ? (var_1_56 ? (var_1_6 ? (var_1_37 == ((signed short int) (max ((var_1_22 + var_1_21) , (max ((var_1_39 - var_1_16) , var_1_20)))))) : (var_1_37 == ((signed short int) (max (var_1_19 , (var_1_27 - (max (var_1_23 , var_1_26)))))))) : (var_1_37 == ((signed short int) (var_1_23 - var_1_39)))) : 1))) && (var_1_34 ? (var_1_39 == ((unsigned char) (var_1_16 - var_1_23))) : 1)) && (var_1_56 ? (var_1_40 == ((unsigned char) ((abs (var_1_41 - var_1_24)) - (var_1_26 + var_1_27)))) : (var_1_40 == ((unsigned char) (max (var_1_23 , var_1_41)))))) && ((var_1_20 > (- var_1_57)) ? (var_1_42 == ((unsigned char) var_1_22)) : 1)) && ((var_1_22 != var_1_1) ? (var_1_43 == ((signed long int) (50 - var_1_1))) : 1)) && (var_1_44 == ((signed short int) (var_1_35 + var_1_22)))) && ((var_1_29 >= var_1_27) ? (var_1_45 == ((unsigned char) (var_1_41 - (max (var_1_24 , var_1_26))))) : (var_1_45 == ((unsigned char) ((var_1_46 - (min (var_1_23 , var_1_24))) + var_1_25))))) && (((var_1_20 - var_1_17) < var_1_19) ? (var_1_47 == ((double) (var_1_13 + (var_1_12 - var_1_48)))) : 1)) && ((var_1_35 > (min (var_1_46 , var_1_42))) ? (((var_1_1 / var_1_41) != var_1_3) ? (var_1_49 == ((unsigned short int) (var_1_20 - var_1_41))) : 1) : 1)) && ((((- var_1_37) / var_1_22) > var_1_18) ? ((var_1_10 <= (min ((min (var_1_11 , var_1_13)) , var_1_12))) ? (var_1_50 == ((double) (max ((var_1_13 + (abs (var_1_12))) , var_1_48)))) : 1) : 1)) && (var_1_6 ? (((var_1_19 > var_1_46) || (! var_1_33)) ? (var_1_52 == ((unsigned char) (min ((var_1_17 + var_1_46) , (var_1_16 - var_1_24))))) : ((var_1_39 == var_1_29) ? (var_1_52 == ((unsigned char) var_1_26)) : (var_1_52 == ((unsigned char) (max (var_1_17 , (max (var_1_26 , 2)))))))) : (var_1_52 == ((unsigned char) ((max (var_1_22 , var_1_46)) + (min (var_1_26 , var_1_17))))))) && ((var_1_15 != var_1_61) ? (var_1_53 == ((signed char) (abs (var_1_41)))) : (var_1_53 == ((signed char) (var_1_23 - var_1_26))))) && (var_1_32 ? (var_1_55 == ((signed char) var_1_26)) : (var_1_55 == ((signed char) var_1_9)))) && (var_1_56 == ((unsigned char) var_1_34))) && (((var_1_46 << var_1_29) > var_1_4) ? ((var_1_10 == var_1_11) ? (var_1_57 == ((unsigned long int) (var_1_58 - var_1_26))) : 1) : 1)) && (var_1_59 == ((unsigned char) var_1_27))) && (var_1_60 == ((signed short int) var_1_17))) && (var_1_61 == ((signed short int) var_1_9))
;
}
int main(void) {
	isInitial = 1;
