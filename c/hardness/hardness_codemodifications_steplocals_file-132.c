...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch132stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch132stepLocals
	signed long int stepLocal_1 = (var_1_2 * var_1_4) * (min (var_1_1 , var_1_6));
	...
	// From: Req3Batch132stepLocals
	var_1_9 = (! 0);


	// From: Req4Batch132stepLocals
	signed long int stepLocal_2 = - (var_1_4 ^ var_1_3);
	if (var_1_9) {
	...
	// From: Req5Batch132stepLocals
	signed long int stepLocal_5 = var_1_3 * var_1_12;
	...
	// From: Req6Batch132stepLocals
	if (var_1_5 != var_1_17) {
		if (var_1_13 <= var_1_10) {
			var_1_16 = (var_1_18 + var_1_19);
		}
	} else {
		if ((min (var_1_13 , var_1_7)) > var_1_11) {
			var_1_16 = var_1_19;
		}
	}


	// From: Req7Batch132stepLocals
