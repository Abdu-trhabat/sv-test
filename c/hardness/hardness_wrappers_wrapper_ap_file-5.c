...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch5Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	signed short int stepLocal_5 = (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer));
	signed long int stepLocal_4 = 200;
	signed long int stepLocal_3 = (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer));
	if (last_1_signed_short_int_Array_0_1__1_ == stepLocal_5) {
		if (stepLocal_3 <= (last_1_unsigned_long_int_Array_0_0_ / 500)) {
			if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) <= stepLocal_4) {
				(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) = (abs (abs ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))));
			}
		} else {
	...
	signed long int stepLocal_0 = (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer));
	if (stepLocal_0 >= ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)) = (abs ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))));
	}
	...
	signed long int stepLocal_1 = (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) + ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)));
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) > stepLocal_1) {
			if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) < stepLocal_2) {
				...
				(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) = 10;
			}
		} else {
...
int property(void) {
	return ((((((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer))) >= ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)) == ((signed short int) (abs ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)))))) : 1) && ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) ? (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) > ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) + ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) - (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))))) ? (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) < (~ (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)))) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) == ((unsigned char) (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) == ((unsigned char) 10))) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) == ((unsigned char) 1))) : 1)) && ((last_1_signed_short_int_Array_0_1__1_ == (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) ? (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) <= (last_1_unsigned_long_int_Array_0_0_ / 500)) ? (((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) <= 200) ? ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) == ((unsigned char) (abs (abs ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))))))) : 1) : ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) == ((unsigned char) (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))))) : 1)) && ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) == ((unsigned long int) (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))))
;
}
int main(void) {
	isInitial = 1;
