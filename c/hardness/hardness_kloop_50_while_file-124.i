...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12450_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 var_1_15 = ((((var_1_22) > (((((var_1_12) < ((var_1_13 - 1))) ? (var_1_12) : ((var_1_13 - 1)))))) ? (var_1_22) : (((((var_1_12) < ((var_1_13 - 1))) ? (var_1_12) : ((var_1_13 - 1)))))));
...
int property(void) {
 return (((((((-32 >= ((var_1_2 / var_1_3) ^ var_1_4)) ? ((((var_1_4 * var_1_3) + (var_1_2 + var_1_5)) >= (((((var_1_6) > (var_1_7)) ? (var_1_6) : (var_1_7))) - var_1_8)) ? (((- var_1_2) > (-10 * var_1_5)) ? (var_1_1 == ((signed short int) var_1_9)) : (var_1_1 == ((signed short int) -16))) : (var_1_1 == ((signed short int) var_1_9))) : (var_1_1 == ((signed short int) var_1_9))) && ((var_1_22 <= var_1_3) ? (var_1_18 ? (var_1_10 == ((signed short int) (var_1_12 - var_1_13))) : 1) : 1)) && (((~ var_1_7) != (var_1_15 ^ var_1_3)) ? (var_1_14 == ((signed short int) var_1_9)) : 1)) && (var_1_15 == ((signed long int) ((((var_1_22) > (((((var_1_12) < ((var_1_13 - 1))) ? (var_1_12) : ((var_1_13 - 1)))))) ? (var_1_22) : (((((var_1_12) < ((var_1_13 - 1))) ? (var_1_12) : ((var_1_13 - 1)))))))))) && (var_1_16 == ((signed char) var_1_17))) && ((last_1_var_1_10 == (last_1_var_1_15 ^ var_1_4)) ? (var_1_18 == ((unsigned char) ((! (var_1_19 || var_1_20)) && var_1_21))) : 1)) && (var_1_18 ? (var_1_22 == ((signed short int) (var_1_12 - (var_1_23 + (8 + var_1_24))))) : (var_1_18 ? (var_1_22 == ((signed short int) ((var_1_23 + 4) - var_1_24))) : (var_1_22 == ((signed short int) var_1_23))))
;
}
int main(void) {
 isInitial = 1;
