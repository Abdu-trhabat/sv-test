...
void step(void) {
	...
	// From: Req5Batch128dependencies
	if (var_1_13 == 0.8) {
		var_1_21 = (var_1_22 - (1281391062u - var_1_23));
	}


	// From: Req6Batch128dependencies
