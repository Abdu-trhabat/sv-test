...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch119functionizing.c", 13, "reach_error"); }
...
void functionized1(float, double);
...
void functionized1(float functionized1_localFunctionVar0, double functionized1_localFunctionVar1) {
 if (var_1_5) {
  var_1_4 = (functionized1_localFunctionVar1 - (var_1_6 - functionized1_localFunctionVar0));
 }
}
signed long int functionized2(signed short int functionized2_localFunctionVar0) {
 return ((((((10 + var_1_15) - var_1_16)) < (functionized2_localFunctionVar0)) ? (((10 + var_1_15) - var_1_16)) : (functionized2_localFunctionVar0)));
}
void functionized3(unsigned short int functionized3_localFunctionVar0, unsigned short int functionized3_localFunctionVar1) {
 if (var_1_5) {
  var_1_17 = (((((var_1_16) < (var_1_15)) ? (var_1_16) : (var_1_15))) + functionized3_localFunctionVar1);
 } else {
  var_1_17 = (functionized3_localFunctionVar0 - functionized3_localFunctionVar1);
 }
}
signed long int functionized4(void) {
 return (-1 - var_1_18);
...
void step(void) {
 ...
 var_1_14 = functionized2(var_1_13);
 functionized3(var_1_19, var_1_18);
