...
void step(void) {
	...
	if (((abs (var_1_12)) >= (var_1_1 & var_1_10)) && stepLocal_2) {
	...
	if (var_1_16 > var_1_21) {
		var_1_23 = (min (var_1_26 , (min (var_1_12 , (min (8 , var_1_24))))));
	}
}
