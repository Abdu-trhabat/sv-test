...
void step(void) {
	...
	// From: CodeObject7
	/* 338L, 179L) */ if (/* 339L, 162L, 163L) */ ((var_1_26) <= (/* 341L, 161L, 165L) */ ((var_1_38) / (var_1_46))))) {
		/* 344L, 178L) */ var_1_45 = (
			/* 347L, 177L) */ (min (
				/* 347L, 177L) */ (
					var_1_42
	...
	// From: CodeObject1
	/* 273L, 63L) */ if (/* 274L, 50L, 51L) */ ((var_1_29) > (var_1_1))) {
		/* 277L, 62L) */ var_1_30 = (
			/* 280L, 61L) */ (max (
				/* 280L, 61L) */ (
					16
