...
void step(void) {
	// From: Req4Batch178Wrapper_P
	(*(var_1_16_Pointer)) = ((*(var_1_17_Pointer)) + (*(var_1_18_Pointer)));


	// From: Req5Batch178Wrapper_P
	(*(var_1_19_Pointer)) = (*(var_1_17_Pointer));


	// From: Req6Batch178Wrapper_P
	(*(var_1_20_Pointer)) = (*(var_1_18_Pointer));


	// From: Req7Batch178Wrapper_P
	(*(var_1_21_Pointer)) = (*(var_1_17_Pointer));


	// From: Req2Batch178Wrapper_P
	unsigned long int stepLocal_1 = (*(var_1_10_Pointer));
	unsigned long int stepLocal_0 = max (((*(var_1_5_Pointer)) * (*(var_1_10_Pointer))) , (*(var_1_20_Pointer)));
	if (256u <= stepLocal_0) {
	...
	// From: Req3Batch178Wrapper_P
	if ((*(var_1_8_Pointer))) {
		(*(var_1_14_Pointer)) = (*(var_1_21_Pointer));
	} else {
		(*(var_1_14_Pointer)) = (min ((*(var_1_16_Pointer)) , ((*(var_1_21_Pointer)) - (*(var_1_15_Pointer)))));
	}


	// From: Req1Batch178Wrapper_P
	if (! (*(var_1_2_Pointer))) {
		if (! (*(var_1_2_Pointer))) {
...
int property(void) {
	return (((((((! (*(var_1_2_Pointer))) ? ((! (*(var_1_2_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned char) ((((*(var_1_21_Pointer)) + (*(var_1_9_Pointer))) > ((*(var_1_5_Pointer)) * (*(var_1_6_Pointer)))) || (*(var_1_7_Pointer))))) : ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_8_Pointer))))) : 1) && ((256u <= (max (((*(var_1_5_Pointer)) * (*(var_1_10_Pointer))) , (*(var_1_20_Pointer))))) ? (((*(var_1_19_Pointer)) < (*(var_1_10_Pointer))) ? ((*(var_1_9_Pointer)) == ((unsigned short int) (((*(var_1_12_Pointer)) + (*(var_1_13_Pointer))) - (*(var_1_20_Pointer))))) : ((*(var_1_9_Pointer)) == ((unsigned short int) (*(var_1_12_Pointer))))) : 1)) && ((*(var_1_8_Pointer)) ? ((*(var_1_14_Pointer)) == ((signed short int) (*(var_1_21_Pointer)))) : ((*(var_1_14_Pointer)) == ((signed short int) (min ((*(var_1_16_Pointer)) , ((*(var_1_21_Pointer)) - (*(var_1_15_Pointer))))))))) && ((*(var_1_16_Pointer)) == ((unsigned char) ((*(var_1_17_Pointer)) + (*(var_1_18_Pointer)))))) && ((*(var_1_19_Pointer)) == ((signed short int) (*(var_1_17_Pointer))))) && ((*(var_1_20_Pointer)) == ((signed short int) (*(var_1_18_Pointer))))) && ((*(var_1_21_Pointer)) == ((unsigned char) (*(var_1_17_Pointer))))
;
}
int main(void) {
	isInitial = 1;
