...
void step(void) {
	// From: Req8Batch107dependencies
	var_1_28 = last_1_var_1_29;


	// From: Req9Batch107dependencies
	var_1_29 = var_1_28;


	// From: Req1Batch107dependencies
	...
	// From: Req4Batch107dependencies
	var_1_23 = (var_1_8 - var_1_6);


	// From: Req5Batch107dependencies
	if (((var_1_15 ^ 16u) * 64u) > var_1_18) {
		var_1_24 = var_1_25;
	}


	// From: Req6Batch107dependencies
	...
	// From: Req2Batch107dependencies
	if ((min (var_1_16 , var_1_28)) < var_1_28) {
