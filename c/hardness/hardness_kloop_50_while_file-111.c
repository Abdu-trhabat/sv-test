...
void step(void) {
	// From: Req6Batch11150_while
	var_1_14 = var_1_10;


	// From: Req7Batch11150_while
	var_1_15 = var_1_16;


	// From: Req8Batch11150_while
	if (var_1_14 != (var_1_18 - (max (var_1_19 , var_1_20)))) {
		if (var_1_20 == var_1_4) {
			var_1_17 = var_1_12;
		}
	}
	...
	// From: Req9Batch11150_while
	if (var_1_15 == var_1_16) {
		var_1_21 = (var_1_19 + var_1_20);
	}


	// From: Req10Batch11150_while
	var_1_22 = var_1_16;


	// From: Req11Batch11150_while
	var_1_23 = var_1_19;


	// From: Req12Batch11150_while
	var_1_24 = -8;


	// From: Req1Batch11150_while
	...
	// From: Req2Batch11150_while
	if ((max (var_1_24 , var_1_6)) == var_1_5) {
		var_1_7 = (! (! 1));
	}


	// From: Req3Batch11150_while
	...
	// From: Req4Batch11150_while
	if (((var_1_24 * var_1_1) + var_1_4) < (var_1_6 + (min (var_1_5 , var_1_10)))) {
		var_1_11 = var_1_12;
	} else {
		var_1_11 = 32;
	}
	...
	// From: Req5Batch11150_while
	unsigned char stepLocal_3 = var_1_7;
	if ((-128 >= (min (var_1_10 , var_1_8))) && stepLocal_3) {
		var_1_13 = var_1_12;
	}
}
...
int property(void) {
	return ((((((((((((-16 < var_1_24) ? ((var_1_24 == (100 - var_1_3)) ? (var_1_1 == ((unsigned long int) (((min (var_1_4 , 1415909508u)) - (var_1_5 - var_1_6)) + var_1_3))) : 1) : (var_1_1 == ((unsigned long int) (2872698422u - 2u)))) && (((max (var_1_24 , var_1_6)) == var_1_5) ? (var_1_7 == ((unsigned char) (! (! 1)))) : 1)) && ((var_1_7 && var_1_9) ? (var_1_8 == ((unsigned char) var_1_10)) : 1)) && ((((var_1_24 * var_1_1) + var_1_4) < (var_1_6 + (min (var_1_5 , var_1_10)))) ? (var_1_11 == ((signed char) var_1_12)) : (var_1_11 == ((signed char) 32)))) && (((-128 >= (min (var_1_10 , var_1_8))) && var_1_7) ? (var_1_13 == ((signed char) var_1_12)) : 1)) && (var_1_14 == ((unsigned char) var_1_10))) && (var_1_15 == ((double) var_1_16))) && ((var_1_14 != (var_1_18 - (max (var_1_19 , var_1_20)))) ? ((var_1_20 == var_1_4) ? (var_1_17 == ((signed char) var_1_12)) : 1) : 1)) && ((var_1_15 == var_1_16) ? (var_1_21 == ((unsigned char) (var_1_19 + var_1_20))) : 1)) && (var_1_22 == ((float) var_1_16))) && (var_1_23 == ((unsigned char) var_1_19))) && (var_1_24 == ((signed long int) -8))
;
}
int main(void) {
	isInitial = 1;
