...
void step(void) {
	// From: Req22Batch195Amount500
	signed long int stepLocal_8 = (last_1_var_1_85 % var_1_59) ^ (var_1_39 >> var_1_60);
	if (1.4 <= var_1_8) {
		if (stepLocal_8 == (last_1_var_1_22 / var_1_41)) {
			var_1_58 = (min (var_1_39 , ((min (var_1_48 , var_1_36)) + (var_1_61 - var_1_31))));
		} else {
			var_1_58 = (abs (var_1_31));
		}
	} else {
		var_1_58 = var_1_30;
	}
	...
	// From: Req5Batch195Amount500
	var_1_20 = var_1_21;


	// From: Req6Batch195Amount500
	if (var_1_8 == var_1_4) {
	...
	// From: Req8Batch195Amount500
	signed long int stepLocal_1 = abs (var_1_19 + var_1_26);
	if (stepLocal_1 >= var_1_22) {
		var_1_25 = ((var_1_27 + 25) - (max ((1746493380 - 128) , var_1_28)));
	}


	// From: Req11Batch195Amount500
	if (-2 < (var_1_22 * var_1_23)) {
		var_1_42 = (max (var_1_30 , 200));
	} else {
		var_1_42 = (var_1_36 + (min ((var_1_40 + 50) , var_1_31)));
	}


	// From: Req13Batch195Amount500
	if (! (var_1_42 >= 0)) {
		if (var_1_21) {
			var_1_44 = (max (var_1_35 , var_1_36));
		} else {
			var_1_44 = (var_1_32 + var_1_27);
		}
	} else {
		var_1_44 = (min ((var_1_16 - var_1_23) , (max (var_1_15 , var_1_31))));
	}


	// From: Req20Batch195Amount500
	if (var_1_51) {
	...
	// From: Req21Batch195Amount500
	var_1_57 = (min ((abs (var_1_6)) , 64.75));


	// From: Req29Batch195Amount500
	var_1_77 = (min ((min (var_1_9 , var_1_6)) , var_1_70));


	// From: Req34Batch195Amount500
	var_1_82 = (abs (var_1_19));


	// From: Req35Batch195Amount500
	if (! (var_1_16 > 5u)) {
		var_1_83 = (max ((var_1_9 - 32.5f) , (49.9f - var_1_70)));
	}


	// From: Req40Batch195Amount500
	...
	if ((var_1_34 - 4) > stepLocal_24) {
		if (stepLocal_22 >= var_1_74) {
			var_1_91 = (var_1_8 + (abs (var_1_89)));
		} else {
			var_1_91 = (min ((var_1_89 - 4.5) , var_1_7));
		}
	} else {
		if (var_1_32 < stepLocal_25) {
			if (stepLocal_23 >= var_1_28) {
				var_1_91 = (var_1_90 + (abs (var_1_89)));
			}
		}
	}


	// From: Req46Batch195Amount500
	var_1_98 = last_1_var_1_98;


	// From: Req47Batch195Amount500
	var_1_99 = var_1_82;


	// From: Req48Batch195Amount500
	var_1_100 = var_1_60;


	// From: Req49Batch195Amount500
	var_1_101 = var_1_88;


	// From: Req53Batch195Amount500
	var_1_105 = var_1_7;


	// From: Req54Batch195Amount500
	var_1_106 = var_1_107;


	// From: Req55Batch195Amount500
	if (var_1_106) {
		var_1_108 = var_1_88;
	} else {
		var_1_108 = var_1_9;
	...
	// From: Req57Batch195Amount500
	var_1_110 = var_1_36;


	// From: Req58Batch195Amount500
	var_1_111 = var_1_46;


	// From: Req60Batch195Amount500
	var_1_113 = var_1_76;


	// From: Req61Batch195Amount500
	var_1_114 = 32;


	// From: Req62Batch195Amount500
	if (var_1_107) {
		var_1_115 = var_1_21;
	}


	// From: Req2Batch195Amount500
	if (((var_1_8 + var_1_3) + (var_1_108 * 9999999.2f)) > (var_1_4 + var_1_87)) {
		var_1_10 = var_1_8;
	}


	// From: Req19Batch195Amount500
	unsigned long int stepLocal_7 = var_1_98;
	if (var_1_106) {
		if (var_1_82 < stepLocal_7) {
			var_1_54 = var_1_7;
		} else {
			if ((var_1_6 + (var_1_8 + var_1_108)) > ((min (var_1_91 , var_1_7)) * (var_1_10 * var_1_4))) {
				var_1_54 = ((32.8 + var_1_8) + (max ((abs (var_1_9)) , 15.75)));
			}
		}
	}


	// From: Req3Batch195Amount500
	...
	// From: Req4Batch195Amount500
	if (var_1_115) {
		var_1_17 = (-2 + var_1_19);
	}


	// From: Req7Batch195Amount500
	if (var_1_83 <= var_1_4) {
		var_1_24 = (var_1_9 + var_1_8);
	}


	// From: Req9Batch195Amount500
	...
	// From: Req12Batch195Amount500
	if ((min (var_1_54 , (max (var_1_105 , var_1_9)))) >= (0.5 / var_1_4)) {
		var_1_43 = var_1_36;
	}


	// From: Req17Batch195Amount500
	signed short int stepLocal_5 = var_1_40;
	if (stepLocal_5 != var_1_113) {
		var_1_52 = var_1_34;
	} else {
		var_1_52 = (var_1_35 - (min (var_1_46 , 10)));
	}


	// From: Req23Batch195Amount500
	if (var_1_43 <= var_1_59) {
		var_1_62 = (min (var_1_60 , -16));
	} else {
		if (var_1_46 < ((max (var_1_35 , var_1_34)) - (var_1_36 + var_1_31))) {
			var_1_62 = (max ((max (var_1_36 , 5)) , ((var_1_65 - var_1_60) - var_1_32)));
		} else {
			var_1_62 = (max (var_1_31 , var_1_32));
		}
	}


	// From: Req32Batch195Amount500
	...
	// From: Req36Batch195Amount500
	unsigned long int stepLocal_16 = var_1_11;
	if (stepLocal_16 == (min ((var_1_29 / var_1_72) , var_1_76))) {
		var_1_84 = -32;
	}


	// From: Req42Batch195Amount500
	if (var_1_115) {
		if (var_1_88 <= var_1_24) {
			var_1_93 = (abs (var_1_36));
		}
	} else {
	...
	// From: Req44Batch195Amount500
	if (last_1_var_1_95 == (min (var_1_101 , var_1_90))) {
		if (((var_1_14 ^ var_1_25) / (min (var_1_60 , var_1_67))) != var_1_52) {
			var_1_95 = var_1_8;
		} else {
			var_1_95 = var_1_90;
		}
	...
	// From: Req51Batch195Amount500
	if (var_1_115) {
		var_1_103 = var_1_65;
	}


	// From: Req52Batch195Amount500
	if (var_1_115) {
		var_1_104 = var_1_88;
	}


	// From: Req26Batch195Amount500
	if (var_1_70 < (var_1_24 / var_1_3)) {
		if (var_1_3 < 2.125f) {
			var_1_71 = (var_1_46 + (var_1_61 - var_1_36));
		} else {
			if ((var_1_46 % (min (var_1_40 , var_1_41))) <= (var_1_58 - var_1_32)) {
				var_1_71 = var_1_52;
			} else {
		...
		var_1_71 = ((max (var_1_56 , var_1_72)) - (var_1_65 + var_1_31));
	}


	// From: Req37Batch195Amount500
	...
	if (var_1_20) {
		...
		if (var_1_44 > stepLocal_17) {
			...
			if (stepLocal_18 > var_1_15) {
				var_1_85 = ((max (var_1_22 , var_1_71)) + var_1_60);
			} else {
	...
	// From: Req16Batch195Amount500
	if ((min (var_1_108 , var_1_3)) != var_1_54) {
	...
	// From: Req15Batch195Amount500
	signed long int stepLocal_4 = var_1_85;
	if (((var_1_32 + var_1_36) - (var_1_31 + var_1_48)) != stepLocal_4) {
		var_1_47 = (max (var_1_32 , (abs (max (var_1_31 , var_1_46)))));
	}


	// From: Req27Batch195Amount500
	if (var_1_11 <= var_1_31) {
		if (var_1_104 >= var_1_97) {
			if ((min (var_1_17 , (var_1_67 * var_1_61))) > (var_1_114 - var_1_36)) {
				var_1_73 = (min (10u , var_1_27));
			}
		} else {
	...
	// From: Req30Batch195Amount500
	unsigned short int stepLocal_12 = var_1_71;
	if (stepLocal_12 <= (var_1_98 * var_1_28)) {
		var_1_78 = (var_1_9 + (abs (var_1_7)));
	} else {
		var_1_78 = (min (var_1_9 , var_1_6));
	}


	// From: Req33Batch195Amount500
	if ((var_1_7 / (max (var_1_4 , var_1_3))) < var_1_95) {
		var_1_81 = var_1_40;
	} else {
		var_1_81 = (min (var_1_35 , var_1_39));
	}


	// From: Req56Batch195Amount500
	if (var_1_50) {
		var_1_109 = var_1_60;
	} else {
		var_1_109 = var_1_48;
	...
	// From: Req63Batch195Amount500
	signed long int stepLocal_26 = -10;
	if (var_1_106) {
		if (stepLocal_26 > (var_1_73 / (min (var_1_46 , var_1_67)))) {
			var_1_116 = ((var_1_60 - var_1_59) + (max (var_1_44 , var_1_65)));
		}
	} else {
	...
	if (var_1_8 >= (var_1_9 - var_1_38)) {
		if (var_1_20 && (var_1_19 < var_1_15)) {
			...
			if (var_1_108 < (var_1_4 + (- var_1_78))) {
				var_1_37 = (var_1_110 - ((var_1_40 + var_1_41) - (min (var_1_34 , var_1_31))));
			} else {
				var_1_37 = (var_1_39 - var_1_34);
			}
		}
	} else {
		if ((max ((min (var_1_95 , var_1_108)) , (var_1_78 * var_1_86))) >= 31.14) {
			var_1_37 = var_1_30;
		} else {
			var_1_37 = var_1_34;
		}
	...
	// From: Req28Batch195Amount500
	if ((abs (var_1_103 + var_1_11)) >= var_1_45) {
		var_1_75 = (min (((var_1_76 - var_1_11) - var_1_58) , (var_1_81 + var_1_74)));
	} else {
		var_1_75 = (max (var_1_41 , 8u));
	}


	// From: Req41Batch195Amount500
	if (var_1_20) {
		var_1_92 = ((max (-10 , var_1_60)) + (var_1_67 - var_1_75));
	}


	// From: Req18Batch195Amount500
	unsigned long int stepLocal_6 = 256u;
	if ((var_1_104 + var_1_6) >= var_1_4) {
		var_1_53 = ((var_1_44 + var_1_17) - var_1_36);
	} else {
		if (stepLocal_6 >= var_1_39) {
			var_1_53 = (max (var_1_75 , var_1_28));
		}
	}


	// From: Req59Batch195Amount500
	var_1_112 = var_1_53;


	// From: Req31Batch195Amount500
	signed long int stepLocal_13 = max ((var_1_45 + var_1_58) , (var_1_32 - var_1_112));
	if (10 >= stepLocal_13) {
		var_1_79 = 32;
	} else {
		var_1_79 = var_1_34;
	...
	if (stepLocal_9 > var_1_112) {
		if ((var_1_48 <= var_1_94) || stepLocal_10) {
			...
			if (stepLocal_11 > (var_1_35 + (var_1_75 | var_1_58))) {
				...
				var_1_68 = ((min (var_1_7 , (var_1_6 + var_1_8))) + var_1_9);
			}
		}
	} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((last_1_var_1_77 / var_1_3) * (5.6f / var_1_4)) == last_1_var_1_86) ? (var_1_1 == ((double) ((var_1_6 + (var_1_7 + var_1_8)) + (var_1_9 - 0.125)))) : 1) && ((((var_1_8 + var_1_3) + (var_1_108 * 9999999.2f)) > (var_1_4 + var_1_87)) ? (var_1_10 == ((double) var_1_8)) : 1)) && ((var_1_22 == (var_1_14 - var_1_15)) ? (var_1_11 == ((unsigned long int) (var_1_16 - var_1_15))) : 1)) && (var_1_115 ? (var_1_17 == ((signed short int) (-2 + var_1_19))) : 1)) && (var_1_20 == ((unsigned char) var_1_21))) && ((var_1_8 == var_1_4) ? (var_1_22 == ((unsigned long int) (var_1_16 - (abs (var_1_15))))) : (var_1_22 == ((unsigned long int) (var_1_15 + var_1_23))))) && ((var_1_83 <= var_1_4) ? (var_1_24 == ((double) (var_1_9 + var_1_8))) : 1)) && (((abs (var_1_19 + var_1_26)) >= var_1_22) ? (var_1_25 == ((signed long int) ((var_1_27 + 25) - (max ((1746493380 - 128) , var_1_28))))) : 1)) && ((! (var_1_98 >= (var_1_28 - 64))) ? (var_1_29 == ((unsigned char) (var_1_30 + ((var_1_31 + 5) + var_1_32)))) : (((var_1_6 * 0.5f) < var_1_24) ? (var_1_29 == ((unsigned char) ((abs (var_1_34 - var_1_31)) - var_1_30))) : (((var_1_113 ^ var_1_32) >= (var_1_16 | var_1_11)) ? (var_1_29 == ((unsigned char) (var_1_35 - (min (var_1_32 , (var_1_31 + var_1_36)))))) : (var_1_29 == ((unsigned char) (abs (var_1_36)))))))) && ((var_1_8 >= (var_1_9 - var_1_38)) ? ((var_1_20 && (var_1_19 < var_1_15)) ? (var_1_37 == ((signed short int) (min (((var_1_39 - var_1_30) - var_1_36) , var_1_19)))) : ((var_1_108 < (var_1_4 + (- var_1_78))) ? (var_1_37 == ((signed short int) (var_1_110 - ((var_1_40 + var_1_41) - (min (var_1_34 , var_1_31)))))) : (var_1_37 == ((signed short int) (var_1_39 - var_1_34))))) : (((max ((min (var_1_95 , var_1_108)) , (var_1_78 * var_1_86))) >= 31.14) ? (var_1_37 == ((signed short int) var_1_30)) : (var_1_37 == ((signed short int) var_1_34))))) && ((-2 < (var_1_22 * var_1_23)) ? (var_1_42 == ((signed long int) (max (var_1_30 , 200)))) : (var_1_42 == ((signed long int) (var_1_36 + (min ((var_1_40 + 50) , var_1_31))))))) && (((min (var_1_54 , (max (var_1_105 , var_1_9)))) >= (0.5 / var_1_4)) ? (var_1_43 == ((signed long int) var_1_36)) : 1)) && ((! (var_1_42 >= 0)) ? (var_1_21 ? (var_1_44 == ((unsigned long int) (max (var_1_35 , var_1_36)))) : (var_1_44 == ((unsigned long int) (var_1_32 + var_1_27)))) : (var_1_44 == ((unsigned long int) (min ((var_1_16 - var_1_23) , (max (var_1_15 , var_1_31)))))))) && (((var_1_34 <= var_1_73) && ((var_1_1 / var_1_4) >= (var_1_38 - var_1_9))) ? (((var_1_27 << var_1_31) <= var_1_113) ? (var_1_45 == ((unsigned char) (abs (var_1_34)))) : ((! var_1_21) ? (var_1_45 == ((unsigned char) ((var_1_46 - var_1_36) + var_1_30))) : (var_1_45 == ((unsigned char) (var_1_35 - var_1_46))))) : (var_1_45 == ((unsigned char) (var_1_46 + var_1_36))))) && ((((var_1_32 + var_1_36) - (var_1_31 + var_1_48)) != var_1_85) ? (var_1_47 == ((unsigned char) (max (var_1_32 , (abs (max (var_1_31 , var_1_46))))))) : 1)) && (((min (var_1_108 , var_1_3)) != var_1_54) ? (var_1_50 == ((unsigned char) ((-5 == var_1_98) && var_1_21))) : (var_1_50 == ((unsigned char) (var_1_21 || (var_1_20 && var_1_51)))))) && ((var_1_40 != var_1_113) ? (var_1_52 == ((unsigned char) var_1_34)) : (var_1_52 == ((unsigned char) (var_1_35 - (min (var_1_46 , 10))))))) && (((var_1_104 + var_1_6) >= var_1_4) ? (var_1_53 == ((signed long int) ((var_1_44 + var_1_17) - var_1_36))) : ((256u >= var_1_39) ? (var_1_53 == ((signed long int) (max (var_1_75 , var_1_28)))) : 1))) && (var_1_106 ? ((var_1_82 < var_1_98) ? (var_1_54 == ((double) var_1_7)) : (((var_1_6 + (var_1_8 + var_1_108)) > ((min (var_1_91 , var_1_7)) * (var_1_10 * var_1_4))) ? (var_1_54 == ((double) ((32.8 + var_1_8) + (max ((abs (var_1_9)) , 15.75))))) : 1)) : 1)) && (var_1_51 ? (var_1_55 == ((unsigned short int) (var_1_30 + var_1_31))) : (var_1_55 == ((unsigned short int) (var_1_56 - 16))))) && (var_1_57 == ((double) (min ((abs (var_1_6)) , 64.75))))) && ((1.4 <= var_1_8) ? ((((last_1_var_1_85 % var_1_59) ^ (var_1_39 >> var_1_60)) == (last_1_var_1_22 / var_1_41)) ? (var_1_58 == ((unsigned short int) (min (var_1_39 , ((min (var_1_48 , var_1_36)) + (var_1_61 - var_1_31)))))) : (var_1_58 == ((unsigned short int) (abs (var_1_31))))) : (var_1_58 == ((unsigned short int) var_1_30)))) && ((var_1_43 <= var_1_59) ? (var_1_62 == ((signed char) (min (var_1_60 , -16)))) : ((var_1_46 < ((max (var_1_35 , var_1_34)) - (var_1_36 + var_1_31))) ? (var_1_62 == ((signed char) (max ((max (var_1_36 , 5)) , ((var_1_65 - var_1_60) - var_1_32))))) : (var_1_62 == ((signed char) (max (var_1_31 , var_1_32))))))) && (var_1_20 ? ((var_1_16 <= ((var_1_14 - var_1_116) / var_1_65)) ? (var_1_66 == ((unsigned char) (var_1_35 - var_1_60))) : (var_1_66 == ((unsigned char) ((var_1_46 + var_1_67) - var_1_31)))) : 1)) && ((var_1_114 > var_1_112) ? (((var_1_48 <= var_1_94) || ((~ var_1_113) > var_1_40)) ? (var_1_68 == ((float) var_1_9)) : ((var_1_60 > (var_1_35 + (var_1_75 | var_1_58))) ? (var_1_68 == ((float) (var_1_6 + var_1_9))) : (var_1_68 == ((float) ((min (var_1_7 , (var_1_6 + var_1_8))) + var_1_9))))) : (var_1_68 == ((float) (15.5f - (var_1_9 + var_1_70)))))) && ((var_1_70 < (var_1_24 / var_1_3)) ? ((var_1_3 < 2.125f) ? (var_1_71 == ((unsigned short int) (var_1_46 + (var_1_61 - var_1_36)))) : (((var_1_46 % (min (var_1_40 , var_1_41))) <= (var_1_58 - var_1_32)) ? (var_1_71 == ((unsigned short int) var_1_52)) : (var_1_71 == ((unsigned short int) (var_1_56 - var_1_65))))) : (var_1_71 == ((unsigned short int) ((max (var_1_56 , var_1_72)) - (var_1_65 + var_1_31)))))) && ((var_1_11 <= var_1_31) ? ((var_1_104 >= var_1_97) ? (((min (var_1_17 , (var_1_67 * var_1_61))) > (var_1_114 - var_1_36)) ? (var_1_73 == ((unsigned long int) (min (10u , var_1_27)))) : 1) : ((var_1_16 > (var_1_35 / var_1_61)) ? (var_1_73 == ((unsigned long int) (var_1_16 - var_1_40))) : (var_1_73 == ((unsigned long int) (var_1_16 - ((var_1_74 - var_1_41) + var_1_72)))))) : 1)) && (((abs (var_1_103 + var_1_11)) >= var_1_45) ? (var_1_75 == ((unsigned long int) (min (((var_1_76 - var_1_11) - var_1_58) , (var_1_81 + var_1_74))))) : (var_1_75 == ((unsigned long int) (max (var_1_41 , 8u)))))) && (var_1_77 == ((float) (min ((min (var_1_9 , var_1_6)) , var_1_70))))) && ((var_1_71 <= (var_1_98 * var_1_28)) ? (var_1_78 == ((float) (var_1_9 + (abs (var_1_7))))) : (var_1_78 == ((float) (min (var_1_9 , var_1_6)))))) && ((10 >= (max ((var_1_45 + var_1_58) , (var_1_32 - var_1_112)))) ? (var_1_79 == ((unsigned char) 32)) : (var_1_79 == ((unsigned char) var_1_34)))) && ((var_1_44 == ((var_1_114 & var_1_67) + var_1_36)) ? (((var_1_16 - var_1_23) < var_1_28) ? (var_1_80 == ((unsigned char) (var_1_36 + (var_1_46 - var_1_48)))) : 1) : 1)) && (((var_1_7 / (max (var_1_4 , var_1_3))) < var_1_95) ? (var_1_81 == ((unsigned short int) var_1_40)) : (var_1_81 == ((unsigned short int) (min (var_1_35 , var_1_39)))))) && (var_1_82 == ((signed long int) (abs (var_1_19))))) && ((! (var_1_16 > 5u)) ? (var_1_83 == ((float) (max ((var_1_9 - 32.5f) , (49.9f - var_1_70))))) : 1)) && ((var_1_11 == (min ((var_1_29 / var_1_72) , var_1_76))) ? (var_1_84 == ((signed char) -32)) : 1)) && (var_1_20 ? (var_1_85 == ((signed long int) (var_1_39 - var_1_111))) : ((var_1_44 > (var_1_46 / var_1_72)) ? (var_1_85 == ((signed long int) (var_1_65 - var_1_27))) : (((var_1_59 / 25u) > var_1_15) ? (var_1_85 == ((signed long int) ((max (var_1_22 , var_1_71)) + var_1_60))) : (var_1_85 == ((signed long int) ((var_1_30 - var_1_27) + var_1_111))))))) && ((5 > var_1_19) ? (var_1_86 == ((double) ((var_1_9 - var_1_70) + var_1_8))) : ((var_1_21 && var_1_50) ? (var_1_86 == ((double) (0.75 - var_1_9))) : 1))) && ((var_1_8 <= ((abs (var_1_1)) / (abs (var_1_4)))) ? ((var_1_51 && var_1_21) ? (var_1_87 == ((float) (var_1_6 + var_1_70))) : (var_1_87 == ((float) (2.7f + (max (var_1_8 , (abs (var_1_9)))))))) : (var_1_87 == ((float) ((var_1_88 - (var_1_89 + var_1_90)) - var_1_70))))) && (((var_1_34 - 4) > 32) ? ((var_1_22 >= var_1_74) ? (var_1_91 == ((double) (var_1_8 + (abs (var_1_89))))) : (var_1_91 == ((double) (min ((var_1_89 - 4.5) , var_1_7))))) : ((var_1_32 < var_1_82) ? (((var_1_15 / var_1_67) >= var_1_28) ? (var_1_91 == ((double) (var_1_90 + (abs (var_1_89))))) : 1) : 1))) && (var_1_20 ? (var_1_92 == ((signed short int) ((max (-10 , var_1_60)) + (var_1_67 - var_1_75)))) : 1)) && (var_1_115 ? ((var_1_88 <= var_1_24) ? (var_1_93 == ((signed short int) (abs (var_1_36)))) : 1) : (var_1_93 == ((signed short int) (-16 + var_1_48))))) && (var_1_50 ? ((-10 >= (~ (var_1_53 + last_1_var_1_94))) ? (var_1_94 == ((signed long int) (var_1_61 + var_1_73))) : (var_1_94 == ((signed long int) ((var_1_72 + var_1_112) - var_1_48)))) : 1)) && ((last_1_var_1_95 == (min (var_1_101 , var_1_90))) ? ((((var_1_14 ^ var_1_25) / (min (var_1_60 , var_1_67))) != var_1_52) ? (var_1_95 == ((double) var_1_8)) : (var_1_95 == ((double) var_1_90))) : (var_1_95 == ((double) var_1_70)))) && (var_1_106 ? (var_1_97 == ((double) var_1_88)) : (var_1_97 == ((double) var_1_7)))) && (var_1_98 == ((unsigned long int) last_1_var_1_98))) && (var_1_99 == ((signed short int) var_1_82))) && (var_1_100 == ((signed char) var_1_60))) && (var_1_101 == ((double) var_1_88))) && (var_1_106 ? (var_1_102 == ((double) var_1_89)) : (var_1_102 == ((double) var_1_90)))) && (var_1_115 ? (var_1_103 == ((unsigned short int) var_1_65)) : 1)) && (var_1_115 ? (var_1_104 == ((double) var_1_88)) : 1)) && (var_1_105 == ((double) var_1_7))) && (var_1_106 == ((unsigned char) var_1_107))) && (var_1_106 ? (var_1_108 == ((double) var_1_88)) : (var_1_108 == ((double) var_1_9)))) && (var_1_50 ? (var_1_109 == ((signed char) var_1_60)) : (var_1_109 == ((signed char) var_1_48)))) && (var_1_110 == ((signed short int) var_1_36))) && (var_1_111 == ((unsigned short int) var_1_46))) && (var_1_112 == ((unsigned short int) var_1_53))) && (var_1_113 == ((unsigned long int) var_1_76))) && (var_1_114 == ((signed long int) 32))) && (var_1_107 ? (var_1_115 == ((unsigned char) var_1_21)) : 1)) && (var_1_106 ? ((-10 > (var_1_73 / (min (var_1_46 , var_1_67)))) ? (var_1_116 == ((signed short int) ((var_1_60 - var_1_59) + (max (var_1_44 , var_1_65))))) : 1) : (var_1_116 == ((signed short int) last_1_var_1_116)))
;
}
int main(void) {
	isInitial = 1;
