...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch21dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch21dependencies
	if ((min ((max (var_1_11 , var_1_6)) , last_1_var_1_25)) > (var_1_3 * last_1_var_1_25)) {
		var_1_17 = var_1_18;
	}


	// From: Req1Batch21dependencies
	if (var_1_2 >= -1000000) {
	...
	// From: Req2Batch21dependencies
	var_1_8 = (((var_1_7 + var_1_6) + var_1_9) + (var_1_10 - var_1_11));


	// From: Req6Batch21dependencies
	if (var_1_25 >= (var_1_5 - var_1_20)) {
		var_1_19 = ((min (var_1_21 , (var_1_22 - var_1_23))) - var_1_24);
	}


	// From: Req4Batch21dependencies
	if (var_1_17) {
		if (((var_1_10 + var_1_9) << var_1_5) < var_1_15) {
			var_1_13 = (min (var_1_7 , (max (var_1_25 , (min (var_1_9 , var_1_6))))));
		} else {
...
int property(void) {
	return (((((((var_1_2 >= -1000000) ? (var_1_1 == ((signed char) (min (var_1_3 , var_1_4)))) : (var_1_1 == ((signed char) (var_1_5 - ((var_1_6 - 8) + var_1_7))))) && (var_1_8 == ((unsigned short int) (((var_1_7 + var_1_6) + var_1_9) + (var_1_10 - var_1_11))))) && ((var_1_13 == var_1_2) ? (var_1_12 == ((unsigned char) (abs (var_1_7)))) : 1)) && (var_1_17 ? ((((var_1_10 + var_1_9) << var_1_5) < var_1_15) ? (var_1_13 == ((unsigned short int) (min (var_1_7 , (max (var_1_25 , (min (var_1_9 , var_1_6)))))))) : (var_1_13 == ((unsigned short int) (var_1_16 - (var_1_9 + var_1_11))))) : (var_1_13 == ((unsigned short int) (var_1_16 - var_1_10))))) && (((min ((max (var_1_11 , var_1_6)) , last_1_var_1_25)) > (var_1_3 * last_1_var_1_25)) ? (var_1_17 == ((unsigned char) var_1_18)) : 1)) && ((var_1_25 >= (var_1_5 - var_1_20)) ? (var_1_19 == ((double) ((min (var_1_21 , (var_1_22 - var_1_23))) - var_1_24))) : 1)) && (((last_1_var_1_8 < last_1_var_1_12) || last_1_var_1_17) ? (var_1_25 == ((unsigned short int) ((max (var_1_11 , var_1_9)) + var_1_7))) : (var_1_25 == ((unsigned short int) var_1_7)))
;
}
int main(void) {
	isInitial = 1;
