...
void step(void) {
	// From: Req9Batch5Amount250
	if (var_1_24 <= (1.6 + var_1_22)) {
		var_1_38 = ((max (var_1_26 , last_1_var_1_36)) + (min (var_1_11 , (max (var_1_18 , var_1_28)))));
	}


	// From: Req6Batch5Amount250
	...
	// From: Req2Batch5Amount250
	if (! var_1_29) {
		var_1_12 = (var_1_13 + var_1_14);
	}


	// From: Req4Batch5Amount250
	if (var_1_29) {
		var_1_19 = (15.6 - (var_1_20 - (abs (32.5))));
	} else {
		var_1_19 = (var_1_21 + ((var_1_22 - var_1_23) - var_1_24));
	}


	// From: Req5Batch5Amount250
	if ((var_1_16 / (max (var_1_22 , 10000.5))) < var_1_3) {
		var_1_25 = ((64 + var_1_26) - ((var_1_27 + 32) - var_1_28));
	}


	// From: Req15Batch5Amount250
	if (var_1_33) {
		var_1_48 = (var_1_22 - (max (var_1_23 , var_1_24)));
	} else {
		var_1_48 = (var_1_20 - (max (9.99999999999995E13 , 8.25)));
	}


	// From: Req18Batch5Amount250
	...
	// From: Req21Batch5Amount250
	var_1_59 = var_1_35;


	// From: Req1Batch5Amount250
	...
	if (var_1_26 > stepLocal_8) {
		if (var_1_26 <= stepLocal_10) {
			if ((abs (0.6f)) <= ((var_1_16 + var_1_22) + var_1_4)) {
				...
				if (var_1_31) {
					...
					if (stepLocal_11 <= var_1_26) {
						...
						var_1_39 = (min ((var_1_27 + var_1_28) , var_1_18));
					}
				}
			}
		} else {
	...
	// From: Req14Batch5Amount250
	var_1_47 = ((var_1_1 + var_1_12) + (max ((var_1_27 + var_1_26) , var_1_13)));


	// From: Req22Batch5Amount250
	var_1_60 = var_1_39;


	// From: Req3Batch5Amount250
	if (((var_1_16 - 1.58f) - var_1_4) >= var_1_56) {
		if ((- var_1_3) <= (var_1_56 / var_1_17)) {
			var_1_15 = (min (var_1_18 , 10));
		} else {
			var_1_15 = (abs (100));
		}
	}
	...
	// From: Req11Batch5Amount250
	if (var_1_24 != (var_1_3 + var_1_56)) {
		var_1_40 = (max (var_1_28 , (abs (var_1_59))));
	} else {
		var_1_40 = (var_1_27 + -100);
	}


	// From: Req13Batch5Amount250
	if (var_1_48 > (var_1_20 - var_1_4)) {
		if (var_1_3 > var_1_48) {
			var_1_46 = (abs (var_1_43 + (min (var_1_60 , var_1_26))));
		} else {
	...
	// From: Req8Batch5Amount250
	unsigned char stepLocal_7 = var_1_29 && var_1_33;
	signed long int stepLocal_6 = min (var_1_47 , var_1_35);
	if (stepLocal_7 || var_1_29) {
		if (var_1_3 > (abs (var_1_20))) {
			var_1_36 = (min (((max (var_1_18 , last_1_var_1_36)) + (var_1_26 + var_1_27)) , var_1_28));
		}
	} else {
		if (stepLocal_6 <= (var_1_38 / (max (-50 , var_1_27)))) {
			var_1_36 = var_1_26;
		}
	}


	// From: Req12Batch5Amount250
	unsigned char stepLocal_12 = var_1_37;
	if (var_1_23 > var_1_20) {
		if (var_1_30 || stepLocal_12) {
			var_1_42 = var_1_27;
		} else {
			var_1_42 = (max (1 , var_1_18));
		}
	} else {
	...
	if (stepLocal_16 || var_1_29) {
		if (var_1_1 < stepLocal_15) {
			var_1_55 = (max (var_1_38 , ((abs (8)) - var_1_42)));
		} else {
			if (stepLocal_17 < var_1_28) {
				if (var_1_56 >= (var_1_3 - var_1_53)) {
					var_1_55 = (((var_1_42 - var_1_47) + var_1_38) + (var_1_43 - var_1_10));
				} else {
					var_1_55 = (min (var_1_43 , ((max (var_1_38 , var_1_26)) + var_1_13)));
				}
			}
		}
	} else {
		var_1_55 = (((max (var_1_14 , 5)) + (var_1_44 - last_1_var_1_55)) + (var_1_13 + var_1_60));
	}


	// From: Req20Batch5Amount250
	if (! var_1_31) {
		var_1_58 = ((var_1_60 + var_1_45) + (var_1_55 + var_1_38));
	} else {
		var_1_58 = (max (var_1_42 , var_1_27));
	}


	// From: Req7Batch5Amount250
	unsigned char stepLocal_5 = var_1_29;
	if (var_1_32 || stepLocal_5) {
		var_1_34 = ((20935 - var_1_42) + var_1_18);
	} else {
		var_1_34 = ((var_1_35 - var_1_42) - (max (var_1_26 , var_1_47)));
	}


	// From: Req16Batch5Amount250
...
int property(void) {
	return ((((((((((((((((((((((var_1_56 > (var_1_3 - var_1_4)) ? (((var_1_3 < var_1_4) && var_1_29) ? ((-256 >= var_1_59) ? (var_1_1 == ((signed long int) (min (var_1_7 , var_1_8)))) : (var_1_1 == ((signed long int) (((1000000000 - var_1_9) + (1000000000 - var_1_10)) - var_1_11)))) : (var_1_1 == ((signed long int) (min ((var_1_9 - var_1_11) , ((64 - var_1_10) + -100)))))) : ((var_1_8 >= var_1_10) ? (var_1_1 == ((signed long int) var_1_10)) : 1)) && ((! var_1_29) ? (var_1_12 == ((signed short int) (var_1_13 + var_1_14))) : 1)) && ((((var_1_16 - 1.58f) - var_1_4) >= var_1_56) ? (((- var_1_3) <= (var_1_56 / var_1_17)) ? (var_1_15 == ((unsigned char) (min (var_1_18 , 10)))) : (var_1_15 == ((unsigned char) (abs (100))))) : 1)) && (var_1_29 ? (var_1_19 == ((double) (15.6 - (var_1_20 - (abs (32.5)))))) : (var_1_19 == ((double) (var_1_21 + ((var_1_22 - var_1_23) - var_1_24)))))) && (((var_1_16 / (max (var_1_22 , 10000.5))) < var_1_3) ? (var_1_25 == ((unsigned char) ((64 + var_1_26) - ((var_1_27 + 32) - var_1_28)))) : 1)) && ((last_1_var_1_55 > last_1_var_1_58) ? (var_1_5 ? (var_1_29 == ((unsigned char) (var_1_30 && var_1_31))) : (var_1_29 == ((unsigned char) (! var_1_31)))) : (((~ -50) > (last_1_var_1_40 / var_1_26)) ? ((last_1_var_1_19 > (- var_1_16)) ? (var_1_29 == ((unsigned char) (var_1_30 || var_1_32))) : (var_1_29 == ((unsigned char) var_1_33))) : (var_1_29 == ((unsigned char) var_1_31))))) && ((var_1_32 || var_1_29) ? (var_1_34 == ((unsigned short int) ((20935 - var_1_42) + var_1_18))) : (var_1_34 == ((unsigned short int) ((var_1_35 - var_1_42) - (max (var_1_26 , var_1_47))))))) && (((var_1_29 && var_1_33) || var_1_29) ? ((var_1_3 > (abs (var_1_20))) ? (var_1_36 == ((unsigned short int) (min (((max (var_1_18 , last_1_var_1_36)) + (var_1_26 + var_1_27)) , var_1_28)))) : 1) : (((min (var_1_47 , var_1_35)) <= (var_1_38 / (max (-50 , var_1_27)))) ? (var_1_36 == ((unsigned short int) var_1_26)) : 1))) && ((var_1_24 <= (1.6 + var_1_22)) ? (var_1_38 == ((unsigned long int) ((max (var_1_26 , last_1_var_1_36)) + (min (var_1_11 , (max (var_1_18 , var_1_28))))))) : 1)) && ((var_1_26 > var_1_59) ? ((var_1_26 <= var_1_9) ? (((abs (0.6f)) <= ((var_1_16 + var_1_22) + var_1_4)) ? (var_1_39 == ((unsigned char) (var_1_27 + var_1_28))) : (var_1_31 ? (var_1_39 == ((unsigned char) var_1_18)) : ((var_1_13 <= var_1_26) ? (var_1_39 == ((unsigned char) (var_1_26 + var_1_28))) : (var_1_39 == ((unsigned char) (min ((var_1_27 + var_1_28) , var_1_18))))))) : (var_1_39 == ((unsigned char) var_1_28))) : ((var_1_35 <= var_1_8) ? ((! var_1_29) ? (var_1_39 == ((unsigned char) var_1_28)) : (var_1_39 == ((unsigned char) var_1_18))) : 1))) && ((var_1_24 != (var_1_3 + var_1_56)) ? (var_1_40 == ((signed long int) (max (var_1_28 , (abs (var_1_59)))))) : (var_1_40 == ((signed long int) (var_1_27 + -100))))) && ((var_1_23 > var_1_20) ? ((var_1_30 || var_1_37) ? (var_1_42 == ((unsigned short int) var_1_27)) : (var_1_42 == ((unsigned short int) (max (1 , var_1_18))))) : ((var_1_20 >= var_1_22) ? (var_1_42 == ((unsigned short int) (((var_1_43 - var_1_27) - var_1_39) + var_1_15))) : (var_1_42 == ((unsigned short int) (var_1_26 + ((var_1_44 + var_1_45) - var_1_28))))))) && ((var_1_48 > (var_1_20 - var_1_4)) ? ((var_1_3 > var_1_48) ? (var_1_46 == ((unsigned short int) (abs (var_1_43 + (min (var_1_60 , var_1_26)))))) : (var_1_46 == ((unsigned short int) (var_1_35 - var_1_44)))) : (var_1_46 == ((unsigned short int) (var_1_35 - var_1_12))))) && (var_1_47 == ((signed short int) ((var_1_1 + var_1_12) + (max ((var_1_27 + var_1_26) , var_1_13)))))) && (var_1_33 ? (var_1_48 == ((double) (var_1_22 - (max (var_1_23 , var_1_24))))) : (var_1_48 == ((double) (var_1_20 - (max (9.99999999999995E13 , 8.25))))))) && ((var_1_60 > (- var_1_38)) ? ((((var_1_34 != var_1_36) || var_1_29) || (var_1_29 && var_1_33)) ? (var_1_49 == ((double) (((var_1_23 - var_1_51) + var_1_52) + ((var_1_53 + var_1_54) - var_1_22)))) : (var_1_49 == ((double) var_1_52))) : 1)) && (((var_1_14 < var_1_40) || var_1_29) ? ((var_1_1 < var_1_27) ? (var_1_55 == ((signed long int) (max (var_1_38 , ((abs (8)) - var_1_42))))) : ((1000000 < var_1_28) ? ((var_1_56 >= (var_1_3 - var_1_53)) ? (var_1_55 == ((signed long int) (((var_1_42 - var_1_47) + var_1_38) + (var_1_43 - var_1_10)))) : (var_1_55 == ((signed long int) (min (var_1_43 , ((max (var_1_38 , var_1_26)) + var_1_13)))))) : 1)) : (var_1_55 == ((signed long int) (((max (var_1_14 , 5)) + (var_1_44 - last_1_var_1_55)) + (var_1_13 + var_1_60)))))) && ((var_1_18 >= var_1_7) ? (var_1_56 == ((double) (0.8 + (63.38 - (var_1_22 - var_1_51))))) : 1)) && (var_1_31 ? (var_1_57 == ((signed char) (var_1_27 - var_1_28))) : (var_1_57 == ((signed char) var_1_28)))) && ((! var_1_31) ? (var_1_58 == ((signed long int) ((var_1_60 + var_1_45) + (var_1_55 + var_1_38)))) : (var_1_58 == ((signed long int) (max (var_1_42 , var_1_27)))))) && (var_1_59 == ((signed long int) var_1_35))) && (var_1_60 == ((signed short int) var_1_39))
;
}
int main(void) {
	isInitial = 1;
