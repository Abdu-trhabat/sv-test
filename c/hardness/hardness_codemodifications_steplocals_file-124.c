...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch124stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch124stepLocals
	signed long int stepLocal_2 = (var_1_4 * var_1_3) + (var_1_2 + var_1_5);
	signed long int stepLocal_1 = -32;
	signed long int stepLocal_0 = - var_1_2;
	if (stepLocal_1 >= ((var_1_2 / var_1_3) ^ var_1_4)) {
		if (stepLocal_2 >= ((max (var_1_6 , var_1_7)) - var_1_8)) {
			if (stepLocal_0 > (-10 * var_1_5)) {
				var_1_1 = var_1_9;
			} else {
				var_1_1 = -16;
			}
	...
	// From: Req3Batch124stepLocals
	if ((~ var_1_7) != (var_1_4 ^ var_1_3)) {
		var_1_14 = var_1_9;
	}


	// From: Req4Batch124stepLocals
	var_1_15 = (max (var_1_14 , (min (var_1_12 , (var_1_13 - 1)))));


	// From: Req5Batch124stepLocals
	var_1_16 = var_1_17;


	// From: Req6Batch124stepLocals
	signed short int stepLocal_3 = var_1_10;
	if (stepLocal_3 == (var_1_15 ^ var_1_4)) {
		var_1_18 = ((! (var_1_19 || var_1_20)) && var_1_21);
	}


	// From: Req7Batch124stepLocals
	if (var_1_18) {
