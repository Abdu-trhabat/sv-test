...
void step(void) {
	...
	if (stepLocal_1 <= (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer))) {
		if ((abs ((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)))) < stepLocal_2) {
	...
	// From: Req2Batch183Wrapper_AP
	signed long int stepLocal_0 = max ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)));
