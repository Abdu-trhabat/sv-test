...
void step(void) {
	...
	// From: Req7Batch122no_floats
	var_1_12 = var_1_3;


	// From: Req1Batch122no_floats
	var_1_1 = (abs (min (1 , var_1_2)));


	// From: Req3Batch122no_floats
	signed long int stepLocal_0 = 40932 - var_1_12;
	if (stepLocal_0 != var_1_3) {
		var_1_7 = (abs (var_1_2));
	} else {
		var_1_7 = (min (var_1_2 , var_1_12));
	}


	// From: Req4Batch122no_floats
	unsigned char stepLocal_1 = var_1_6;
	if (stepLocal_1 && var_1_9) {
		var_1_8 = (abs (var_1_3 - var_1_7));
	} else {
		if (var_1_6) {
	...
	// From: Req5Batch122no_floats
	var_1_10 = var_1_2;


	// From: Req6Batch122no_floats
	var_1_11 = var_1_7;


	// From: Req8Batch122no_floats
	var_1_13 = var_1_14;
}
...
int property(void) {
	return (((((((var_1_1 == ((unsigned char) (abs (min (1 , var_1_2))))) && ((var_1_4 < var_1_5) ? (var_1_6 ? (var_1_3 == ((unsigned long int) last_1_var_1_12)) : (var_1_3 == ((unsigned long int) (10u + var_1_2)))) : (var_1_3 == ((unsigned long int) (last_1_var_1_12 + var_1_2))))) && (((40932 - var_1_12) != var_1_3) ? (var_1_7 == ((unsigned short int) (abs (var_1_2)))) : (var_1_7 == ((unsigned short int) (min (var_1_2 , var_1_12)))))) && ((var_1_6 && var_1_9) ? (var_1_8 == ((signed long int) (abs (var_1_3 - var_1_7)))) : (var_1_6 ? (var_1_8 == ((signed long int) (var_1_7 + var_1_2))) : 1))) && (var_1_10 == ((unsigned char) var_1_2))) && (var_1_11 == ((signed long int) var_1_7))) && (var_1_12 == ((unsigned short int) var_1_3))) && (var_1_13 == ((signed long int) var_1_14))
;
}
int main(void) {
	isInitial = 1;
