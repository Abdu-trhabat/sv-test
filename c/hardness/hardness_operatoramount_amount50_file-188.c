...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch188Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch188Amount50
	if (var_1_2 >= (- last_1_var_1_17)) {
		var_1_12 = (last_1_var_1_10 + (var_1_6 + (min (2 , var_1_11))));
	} else {
		var_1_12 = var_1_6;
	}


	// From: Req4Batch188Amount50
	if (var_1_12 >= var_1_7) {
		var_1_13 = (min (var_1_12 , var_1_6));
	} else {
	...
	// From: Req2Batch188Amount50
	if (var_1_13 >= var_1_8) {
		var_1_10 = (min (var_1_6 , var_1_11));
	}


	// From: Req6Batch188Amount50
	unsigned char stepLocal_1 = var_1_13 < var_1_7;
	signed long int stepLocal_0 = max (var_1_13 , -2);
	if ((-64 >= var_1_13) || stepLocal_1) {
		if (stepLocal_0 > (max (var_1_7 , (var_1_12 * var_1_13)))) {
	...
	// From: Req5Batch188Amount50
	if (var_1_4) {
		var_1_15 = var_1_16;
	}


	// From: Req1Batch188Amount50
	if (var_1_2 < var_1_3) {
...
int property(void) {
	return ((((((var_1_2 < var_1_3) ? ((var_1_15 || ((var_1_12 >> var_1_6) != (var_1_7 - var_1_8))) ? (var_1_1 == ((float) (256.125f + (128.1f - var_1_9)))) : (var_1_1 == ((float) var_1_9))) : (var_1_1 == ((float) var_1_9))) && ((var_1_13 >= var_1_8) ? (var_1_10 == ((signed short int) (min (var_1_6 , var_1_11)))) : 1)) && ((var_1_2 >= (- last_1_var_1_17)) ? (var_1_12 == ((signed long int) (last_1_var_1_10 + (var_1_6 + (min (2 , var_1_11)))))) : (var_1_12 == ((signed long int) var_1_6)))) && ((var_1_12 >= var_1_7) ? (var_1_13 == ((signed long int) (min (var_1_12 , var_1_6)))) : (((var_1_14 - 128u) > var_1_12) ? ((var_1_7 != var_1_11) ? (var_1_13 == ((signed long int) var_1_6)) : 1) : (var_1_13 == ((signed long int) var_1_12))))) && (var_1_4 ? (var_1_15 == ((unsigned char) var_1_16)) : 1)) && (((-64 >= var_1_13) || (var_1_13 < var_1_7)) ? (((max (var_1_13 , -2)) > (max (var_1_7 , (var_1_12 * var_1_13)))) ? (var_1_17 == ((float) ((min (var_1_9 , var_1_18)) + var_1_19))) : (var_1_17 == ((float) 7.1f))) : (var_1_17 == ((float) var_1_18)))
;
}
int main(void) {
	isInitial = 1;
