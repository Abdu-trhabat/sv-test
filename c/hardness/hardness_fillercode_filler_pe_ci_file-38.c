...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch38Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 266L, 49L) */ if (/* 267L, 12L, 13L) */ ((var_1_3) >= (/* 269L, 11L, 15L) */ (abs (/* 270L, 10L, 16L) */ (max (/* 270L, 10L, 16L) */ (var_1_20) , (var_1_19)))))))) {
		/* 273L, 43L) */ if (/* 274L, 27L, 28L) */ ((var_1_19) <= (var_1_20))) {
			/* 277L, 38L) */ var_1_26 = (
				/* 280L, 37L) */ (abs (
					var_1_22
				))
	...
	// From: CodeObject2
	/* 306L, 74L) */ if (/* 307L, 57L, 58L) */ ((var_1_18) >= (/* 309L, 56L, 60L) */ (min (/* 309L, 56L, 60L) */ (var_1_18) , (var_1_17)))))) {
		/* 312L, 73L) */ var_1_32 = (
			/* 315L, 72L) */ (min (
				/* 315L, 72L) */ (
					var_1_30
	...
	// From: CodeObject4
	/* 323L, 114L) */ if (/* 324L, 92L, 93L) */ ((var_1_18) >= (var_1_19))) {
	...
	// From: CodeObject5
	/* 336L, 209L) */ if (/* 337L, 125L, 126L) */ ((-2) > (/* 339L, 124L, 128L) */ ((/* 340L, 120L, 129L) */ (abs (var_1_12))) | (/* 342L, 123L, 131L) */ ((-10) * (var_1_12))))))) {
		/* 345L, 152L) */ var_1_36 = (
			/* 348L, 151L) */ (max (
				/* 348L, 151L) */ (
					/* 349L, 146L) */ (min (
		...
		/* 356L, 207L) */ if (/* 357L, 160L, 161L) */ ((/* 358L, 157L, 162L) */ (abs (var_1_12))) <= (/* 360L, 159L, 164L) */ (abs (var_1_23))))) {
			/* 362L, 197L) */ if (/* 363L, 177L, 178L) */ ((/* 364L, 175L, 179L) */ ((var_1_12) * (/* 366L, 174L, 181L) */ (max (/* 366L, 174L, 181L) */ (var_1_11) , (var_1_23)))))) <= (var_1_12))) {
				/* 370L, 196L) */ var_1_36 = (
					/* 373L, 195L) */ (abs (
						var_1_23
					))
