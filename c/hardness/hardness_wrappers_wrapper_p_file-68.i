...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch68Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_1 != (*(var_1_18_Pointer))) {
 ...
 if (((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) >= (*(var_1_10_Pointer))) {
  if (stepLocal_0 >= ((*(var_1_18_Pointer)) / (*(var_1_8_Pointer)))) {
