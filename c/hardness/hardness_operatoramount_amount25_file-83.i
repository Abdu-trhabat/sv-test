...
void step(void) {
 ...
 if (var_1_7 >= ((var_1_3 / var_1_4) + (var_1_1 * var_1_6))) {
  var_1_8 = (var_1_9 + ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10))));
 } else {
  var_1_8 = var_1_9;
 }
 var_1_11 = ((var_1_12 + var_1_13) - ((((25) < (var_1_14)) ? (25) : (var_1_14))));
 var_1_15 = var_1_14;
}
void updateVariables(void) {
