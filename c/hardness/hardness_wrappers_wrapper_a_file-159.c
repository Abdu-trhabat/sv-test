...
void step(void) {
	...
	// From: Req2Batch159Wrapper_A
	if (((float_Array_0[1] - float_Array_0[0]) / float_Array_0[2]) < float_Array_0[3]) {
		if ((min (signed_long_int_Array_0[1][1] , signed_long_int_Array_0[0][0])) < signed_long_int_Array_0[1][0]) {
			if (BOOL_unsigned_char_Array_0[2]) {
				unsigned_short_int_Array_0[0] = (min (unsigned_short_int_Array_0[1] , 1));
			}
		}
	}


	// From: Req3Batch159Wrapper_A
