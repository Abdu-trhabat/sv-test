...
void step(void) {
	...
	// From: Req6Batch140Amount250
	unsigned long int stepLocal_9 = last_1_var_1_31;
	unsigned char stepLocal_8 = var_1_10 <= (abs (var_1_14));
	unsigned char stepLocal_7 = var_1_9 && var_1_8;
	if ((min (var_1_11 , var_1_19)) >= stepLocal_9) {
	...
	// From: Req4Batch140Amount250
	if (var_1_3 >= var_1_40) {
		if ((min (10 , var_1_10)) < (var_1_13 - var_1_14)) {
			var_1_15 = (min (var_1_16 , ((min (var_1_17 , var_1_18)) - var_1_19)));
		}
	} else {
		var_1_15 = var_1_16;
	}
	...
	// From: Req8Batch140Amount250
	if (var_1_27) {
		var_1_30 = (var_1_19 + 1);
	}


	// From: Req13Batch140Amount250
	if (var_1_61 || var_1_23) {
		var_1_42 = (max (var_1_43 , (abs (var_1_44))));
	} else {
		if (var_1_11 > (var_1_35 - (var_1_17 + var_1_10))) {
			var_1_42 = (abs (1.5f - var_1_45));
		}
	}


	// From: Req15Batch140Amount250
	if ((63.25f - var_1_45) >= var_1_44) {
		var_1_47 = (min (50u , var_1_11));
	} else {
		var_1_47 = var_1_48;
	}


	// From: Req18Batch140Amount250
	if (var_1_61) {
		var_1_56 = (var_1_57 + ((var_1_58 - 16) + (max (var_1_59 , 10))));
	}


	// From: Req23Batch140Amount250
	if (var_1_28) {
		var_1_65 = var_1_58;
	} else {
		var_1_65 = var_1_14;
	...
	// From: Req3Batch140Amount250
	if (var_1_23 || var_1_61) {
		var_1_7 = (max (((var_1_10 + 10) - 2) , var_1_30));
	} else {
		if (var_1_10 <= -50) {
			...
			var_1_7 = ((max ((min (var_1_12 , var_1_10)) , var_1_11)) - (min ((128 + var_1_13) , var_1_14)));
		}
	}


	// From: Req21Batch140Amount250
	signed long int stepLocal_15 = max (var_1_35 , (var_1_37 << var_1_59));
	...
	if (stepLocal_0 >= (last_1_var_1_4 / (abs (var_1_5)))) {
	...
	// From: Req9Batch140Amount250
	if (var_1_11 >= var_1_40) {
		var_1_31 = (var_1_32 - 1u);
	}


	// From: Req16Batch140Amount250
	if (var_1_7 >= (var_1_31 | -2)) {
		var_1_49 = var_1_44;
	} else {
		if (var_1_23) {
			var_1_49 = (var_1_50 + ((min (var_1_51 , var_1_52)) - (var_1_53 - var_1_54)));
		} else {
			var_1_49 = (min ((max (var_1_53 , var_1_44)) , var_1_51));
		}
	}


	// From: Req24Batch140Amount250
	unsigned long int stepLocal_18 = var_1_32 / (abs (var_1_5));
	if (var_1_27) {
	...
	// From: Req1Batch140Amount250
	if ((- 255.45f) < var_1_49) {
		var_1_1 = (var_1_3 + -16);
	}


	// From: Req7Batch140Amount250
	signed long int stepLocal_10 = min (var_1_22 , var_1_14);
	...
	// From: Req11Batch140Amount250
	if (var_1_61 || var_1_23) {
		var_1_38 = ((var_1_10 + (var_1_18 + var_1_19)) - (min ((var_1_17 + var_1_22) , (var_1_39 - var_1_35))));
	} else {
		if (last_1_var_1_38 <= var_1_5) {
			var_1_38 = (var_1_65 + var_1_12);
		} else {
			var_1_38 = (max ((100000 - 1) , ((max (var_1_1 , var_1_3)) + var_1_17)));
		}
	}


	// From: Req14Batch140Amount250
	if (var_1_61) {
		if (var_1_28) {
			var_1_46 = (var_1_63 + (10 - var_1_35));
		}
	} else {
		var_1_46 = (min (var_1_18 , var_1_13));
	}


	// From: Req17Batch140Amount250
	if (var_1_23) {
		var_1_55 = (var_1_38 + 16);
	}


	// From: Req19Batch140Amount250
	unsigned long int stepLocal_11 = (var_1_18 / var_1_17) * var_1_47;
	if (stepLocal_11 >= var_1_47) {
		var_1_60 = (max (var_1_10 , (max ((var_1_65 + var_1_29) , (var_1_4 + var_1_22)))));
	} else {
		var_1_60 = ((var_1_13 - var_1_17) + var_1_22);
	}


	// From: Req22Batch140Amount250
	signed long int stepLocal_17 = abs (var_1_11 + var_1_41);
	unsigned long int stepLocal_16 = var_1_31;
	if ((var_1_19 - var_1_35) >= stepLocal_16) {
		if ((~ var_1_65) >= stepLocal_17) {
			if ((min (0.75 , var_1_44)) < var_1_51) {
				var_1_64 = (min ((var_1_51 + var_1_54) , (var_1_45 - var_1_52)));
			}
		} else {
			var_1_64 = 31.25f;
		}
	...
	// From: Req10Batch140Amount250
	if (var_1_31 <= var_1_38) {
		var_1_33 = var_1_3;
	} else {
		if (! var_1_27) {
			var_1_33 = (var_1_34 - ((max (var_1_35 , var_1_36)) + var_1_37));
		}
	}
}
...
int property(void) {
	return (((((((((((((((((((((((((- 255.45f) < var_1_49) ? (var_1_1 == ((signed char) (var_1_3 + -16))) : 1) && ((var_1_3 >= (last_1_var_1_4 / (abs (var_1_5)))) ? (((var_1_3 + var_1_63) <= var_1_5) ? ((var_1_63 > ((last_1_var_1_4 * var_1_5) * var_1_3)) ? ((2u <= var_1_63) ? (var_1_4 == ((signed short int) var_1_5)) : (var_1_4 == ((signed short int) 25))) : (var_1_4 == ((signed short int) var_1_5))) : (var_1_4 == ((signed short int) var_1_5))) : 1)) && ((var_1_23 || var_1_61) ? (var_1_7 == ((signed short int) (max (((var_1_10 + 10) - 2) , var_1_30)))) : ((var_1_10 <= -50) ? (((var_1_5 < var_1_30) && var_1_61) ? (var_1_7 == ((signed short int) (var_1_10 + var_1_3))) : (var_1_7 == ((signed short int) ((64 + (var_1_11 - var_1_12)) - var_1_10)))) : (var_1_7 == ((signed short int) ((max ((min (var_1_12 , var_1_10)) , var_1_11)) - (min ((128 + var_1_13) , var_1_14)))))))) && ((var_1_3 >= var_1_40) ? (((min (10 , var_1_10)) < (var_1_13 - var_1_14)) ? (var_1_15 == ((unsigned char) (min (var_1_16 , ((min (var_1_17 , var_1_18)) - var_1_19))))) : 1) : (var_1_15 == ((unsigned char) var_1_16)))) && ((var_1_3 > ((var_1_19 - 2) / (min (var_1_5 , var_1_21)))) ? ((var_1_23 || var_1_61) ? (var_1_20 == ((signed short int) (var_1_10 - var_1_22))) : 1) : (((var_1_11 / var_1_21) <= var_1_13) ? (var_1_20 == ((signed short int) var_1_17)) : (var_1_20 == ((signed short int) var_1_11))))) && (((min (var_1_11 , var_1_19)) >= last_1_var_1_31) ? (((var_1_10 <= (abs (var_1_14))) || (last_1_var_1_49 <= last_1_var_1_66)) ? (((var_1_9 && var_1_8) && var_1_26) ? (var_1_23 == ((unsigned char) (! var_1_27))) : (var_1_26 ? (var_1_23 == ((unsigned char) var_1_28)) : 1)) : (var_1_23 == ((unsigned char) var_1_28))) : 1)) && ((((var_1_19 << var_1_5) * var_1_31) > (min (var_1_22 , var_1_14))) ? ((! var_1_28) ? (var_1_29 == ((signed short int) (var_1_17 - var_1_16))) : 1) : 1)) && (var_1_27 ? (var_1_30 == ((unsigned char) (var_1_19 + 1))) : 1)) && ((var_1_11 >= var_1_40) ? (var_1_31 == ((unsigned long int) (var_1_32 - 1u))) : 1)) && ((var_1_31 <= var_1_38) ? (var_1_33 == ((signed char) var_1_3)) : ((! var_1_27) ? (var_1_33 == ((signed char) (var_1_34 - ((max (var_1_35 , var_1_36)) + var_1_37)))) : 1))) && ((var_1_61 || var_1_23) ? (var_1_38 == ((signed long int) ((var_1_10 + (var_1_18 + var_1_19)) - (min ((var_1_17 + var_1_22) , (var_1_39 - var_1_35)))))) : ((last_1_var_1_38 <= var_1_5) ? (var_1_38 == ((signed long int) (var_1_65 + var_1_12))) : (var_1_38 == ((signed long int) (max ((100000 - 1) , ((max (var_1_1 , var_1_3)) + var_1_17)))))))) && (var_1_61 ? (var_1_40 == ((signed short int) ((var_1_41 - (var_1_11 - var_1_36)) - var_1_14))) : (var_1_40 == ((signed short int) var_1_11)))) && ((var_1_61 || var_1_23) ? (var_1_42 == ((float) (max (var_1_43 , (abs (var_1_44)))))) : ((var_1_11 > (var_1_35 - (var_1_17 + var_1_10))) ? (var_1_42 == ((float) (abs (1.5f - var_1_45)))) : 1))) && (var_1_61 ? (var_1_28 ? (var_1_46 == ((signed short int) (var_1_63 + (10 - var_1_35)))) : 1) : (var_1_46 == ((signed short int) (min (var_1_18 , var_1_13)))))) && (((63.25f - var_1_45) >= var_1_44) ? (var_1_47 == ((unsigned long int) (min (50u , var_1_11)))) : (var_1_47 == ((unsigned long int) var_1_48)))) && ((var_1_7 >= (var_1_31 | -2)) ? (var_1_49 == ((float) var_1_44)) : (var_1_23 ? (var_1_49 == ((float) (var_1_50 + ((min (var_1_51 , var_1_52)) - (var_1_53 - var_1_54))))) : (var_1_49 == ((float) (min ((max (var_1_53 , var_1_44)) , var_1_51))))))) && (var_1_23 ? (var_1_55 == ((signed long int) (var_1_38 + 16))) : 1)) && (var_1_61 ? (var_1_56 == ((signed char) (var_1_57 + ((var_1_58 - 16) + (max (var_1_59 , 10)))))) : 1)) && ((((var_1_18 / var_1_17) * var_1_47) >= var_1_47) ? (var_1_60 == ((signed long int) (max (var_1_10 , (max ((var_1_65 + var_1_29) , (var_1_4 + var_1_22))))))) : (var_1_60 == ((signed long int) ((var_1_13 - var_1_17) + var_1_22))))) && ((last_1_var_1_4 == (var_1_16 - last_1_var_1_4)) ? (var_1_61 == ((unsigned char) var_1_28)) : (var_1_61 == ((unsigned char) (var_1_28 || ((! last_1_var_1_23) && var_1_62)))))) && ((var_1_17 == (max (var_1_35 , (var_1_37 << var_1_59)))) ? ((var_1_39 >= var_1_22) ? (var_1_63 == ((signed long int) ((var_1_11 - var_1_14) + var_1_17))) : ((! (var_1_61 || var_1_62)) ? (var_1_63 == ((signed long int) (var_1_58 - var_1_30))) : (((var_1_32 | var_1_7) > var_1_41) ? (var_1_63 == ((signed long int) (var_1_30 - var_1_41))) : (var_1_63 == ((signed long int) (var_1_39 - var_1_19)))))) : 1)) && (((var_1_19 - var_1_35) >= var_1_31) ? (((~ var_1_65) >= (abs (var_1_11 + var_1_41))) ? (((min (0.75 , var_1_44)) < var_1_51) ? (var_1_64 == ((float) (min ((var_1_51 + var_1_54) , (var_1_45 - var_1_52))))) : 1) : (var_1_64 == ((float) 31.25f))) : 1)) && (var_1_28 ? (var_1_65 == ((unsigned short int) var_1_58)) : (var_1_65 == ((unsigned short int) var_1_14)))) && (var_1_27 ? (((var_1_32 / (abs (var_1_5))) < var_1_63) ? (var_1_66 == ((float) (var_1_52 - (var_1_67 - var_1_51)))) : (var_1_66 == ((float) var_1_45))) : (var_1_66 == ((float) var_1_43)))
;
}
int main(void) {
	isInitial = 1;
