...
void step(void) {
	...
	// From: Req11Batch101Amount100
	var_1_34 = var_1_35;


	// From: Req12Batch101Amount100
	var_1_36 = var_1_21;


	// From: Req13Batch101Amount100
	var_1_37 = var_1_30;


	// From: Req2Batch101Amount100
	if (var_1_4 < var_1_7) {
		if (var_1_34) {
	...
	// From: Req7Batch101Amount100
	if ((var_1_20 == (var_1_12 & var_1_1)) || (var_1_28 > var_1_37)) {
		var_1_25 = -32;
	}


	// From: Req8Batch101Amount100
	if (-8 > var_1_20) {
