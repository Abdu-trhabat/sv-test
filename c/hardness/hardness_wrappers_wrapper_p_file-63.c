...
void step(void) {
	...
	if ((*(var_1_4_Pointer)) <= ((min ((*(var_1_2_Pointer)) , (*(var_1_3_Pointer)))) * (*(var_1_8_Pointer)))) {
		(*(var_1_7_Pointer)) = (max ((max (((*(var_1_9_Pointer)) + (*(var_1_10_Pointer))) , (*(var_1_11_Pointer)))) , (abs ((*(var_1_12_Pointer))))));
	} else {
	...
	if (stepLocal_0 != (min ((*(var_1_9_Pointer)) , (*(var_1_12_Pointer))))) {
...
int property(void) {
	return ((((((((min (1.1f , (*(var_1_2_Pointer)))) > ((*(var_1_3_Pointer)) * (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((unsigned char) ((*(var_1_23_Pointer)) && (*(var_1_6_Pointer))))) : 1) && (((*(var_1_4_Pointer)) <= ((min ((*(var_1_2_Pointer)) , (*(var_1_3_Pointer)))) * (*(var_1_8_Pointer)))) ? ((*(var_1_7_Pointer)) == ((signed long int) (max ((max (((*(var_1_9_Pointer)) + (*(var_1_10_Pointer))) , (*(var_1_11_Pointer)))) , (abs ((*(var_1_12_Pointer)))))))) : ((*(var_1_7_Pointer)) == ((signed long int) (*(var_1_9_Pointer)))))) && ((*(var_1_13_Pointer)) == ((unsigned long int) (*(var_1_14_Pointer))))) && (((*(var_1_7_Pointer)) != (min ((*(var_1_9_Pointer)) , (*(var_1_12_Pointer))))) ? ((*(var_1_15_Pointer)) == ((signed char) ((min ((10 + (*(var_1_16_Pointer))) , (*(var_1_17_Pointer)))) - ((32 - (*(var_1_18_Pointer))) + (max ((*(var_1_19_Pointer)) , (*(var_1_20_Pointer)))))))) : 1)) && ((*(var_1_21_Pointer)) == ((signed short int) (*(var_1_13_Pointer))))) && ((*(var_1_22_Pointer)) == ((signed char) (*(var_1_16_Pointer))))) && ((*(var_1_23_Pointer)) == ((unsigned char) (*(var_1_6_Pointer))))
;
}
int main(void) {
	isInitial = 1;
