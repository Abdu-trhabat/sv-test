...
void step(void) {
	...
	if (last_1_var_1_19) {
		if (stepLocal_4 != (abs (last_1_var_1_1))) {
			if (stepLocal_3 >= var_1_17) {
				if ((var_1_13 + last_1_var_1_25) > var_1_28) {
					var_1_33 = ((var_1_8 + var_1_24) + last_1_var_1_14);
				} else {
					var_1_33 = (max (((var_1_35 + var_1_36) - last_1_var_1_6) , last_1_var_1_14));
				}
			} else {
				var_1_33 = ((min (var_1_21 , var_1_8)) + (min (last_1_var_1_6 , 8u)));
			}
		} else {
			var_1_33 = var_1_5;
		}
	...
	if ((var_1_26 - var_1_27) < 199.5f) {
		var_1_25 = ((var_1_28 + var_1_29) + (max ((16.4 - var_1_30) , var_1_12)));
	}


	// From: Req4Batch54100_while
	if ((abs (var_1_25)) < var_1_25) {
		if ((var_1_33 % (max (var_1_10 , var_1_11))) > var_1_8) {
	...
	if ((max (var_1_1 , -128)) < (var_1_5 * var_1_6)) {
		var_1_7 = var_1_8;
	}
}
...
int property(void) {
	return (((((((((((! ((- 9.9999999999925E11) >= var_1_25)) ? ((var_1_25 >= var_1_9) ? ((var_1_25 < 7.5) ? (var_1_19 ? (var_1_1 == ((unsigned short int) var_1_5)) : (var_1_1 == ((unsigned short int) 64))) : (var_1_1 == ((unsigned short int) var_1_5))) : (var_1_1 == ((unsigned short int) var_1_5))) : (var_1_1 == ((unsigned short int) var_1_5))) && (((- 128) <= var_1_5) ? (var_1_6 == ((unsigned long int) (abs (10u + var_1_5)))) : (var_1_6 == ((unsigned long int) var_1_14)))) && (((max (var_1_1 , -128)) < (var_1_5 * var_1_6)) ? (var_1_7 == ((unsigned char) var_1_8)) : 1)) && (((abs (var_1_25)) < var_1_25) ? (((var_1_33 % (max (var_1_10 , var_1_11))) > var_1_8) ? (var_1_9 == ((double) (var_1_12 + var_1_13))) : 1) : 1)) && ((last_1_var_1_9 < (- (var_1_13 * last_1_var_1_9))) ? (var_1_14 == ((unsigned short int) 256)) : 1)) && ((var_1_1 < (var_1_33 / (var_1_17 + var_1_18))) ? (var_1_15 == ((unsigned char) (max (4 , var_1_8)))) : (var_1_15 == ((unsigned char) var_1_8)))) && (((var_1_20 - var_1_21) < ((var_1_33 * var_1_14) / var_1_17)) ? (var_1_19 == ((unsigned char) (! var_1_22))) : 1)) && ((var_1_12 > var_1_25) ? (var_1_23 == ((unsigned char) (var_1_24 - var_1_21))) : (var_1_19 ? (((var_1_11 % var_1_10) > var_1_20) ? (var_1_23 == ((unsigned char) var_1_21)) : (var_1_23 == ((unsigned char) var_1_24))) : 1))) && (((var_1_26 - var_1_27) < 199.5f) ? (var_1_25 == ((double) ((var_1_28 + var_1_29) + (max ((16.4 - var_1_30) , var_1_12))))) : 1)) && (((var_1_33 * var_1_10) >= var_1_14) ? (var_1_31 == ((signed short int) var_1_6)) : 1)) && (last_1_var_1_19 ? ((var_1_18 != (abs (last_1_var_1_1))) ? ((((var_1_18 * var_1_21) + last_1_var_1_15) >= var_1_17) ? (((var_1_13 + last_1_var_1_25) > var_1_28) ? (var_1_33 == ((unsigned long int) ((var_1_8 + var_1_24) + last_1_var_1_14))) : (var_1_33 == ((unsigned long int) (max (((var_1_35 + var_1_36) - last_1_var_1_6) , last_1_var_1_14))))) : (var_1_33 == ((unsigned long int) ((min (var_1_21 , var_1_8)) + (min (last_1_var_1_6 , 8u)))))) : (var_1_33 == ((unsigned long int) var_1_5))) : (var_1_33 == ((unsigned long int) var_1_36)))
;
}
int main(void) {
	isInitial = 1;
