...
void step(void) {
	...
	// From: CodeObject5
	/* 337L, 191L) */ if (/* 338L, 150L, 151L) */ ((var_1_11) < (/* 340L, 149L, 153L) */ ((var_1_6) % (/* 342L, 148L, 155L) */ (max (/* 342L, 148L, 155L) */ (var_1_23) , (var_1_37)))))))) {
		/* 345L, 185L) */ if (/* 346L, 169L, 170L) */ ((var_1_11) <= (/* 348L, 168L, 172L) */ ((var_1_23) / (var_1_37))))) {
			/* 351L, 184L) */ var_1_40 = (
				/* 354L, 183L) */ (abs (
					5
				))
	...
	// From: CodeObject4
	/* 299L, 140L) */ if (/* 300L, 61L, 62L) */ ((256) > (/* 302L, 60L, 64L) */ (max (/* 302L, 60L, 64L) */ (/* 303L, 58L, 65L) */ ((var_1_11) * (var_1_6))) , (var_1_23)))))) {
		/* 307L, 134L) */ if (/* 308L, 86L, 87L) */ ((var_1_23) <= (/* 310L, 85L, 89L) */ (min (/* 310L, 85L, 89L) */ (var_1_6) , (/* 312L, 84L, 91L) */ ((var_1_6) >> (var_1_37)))))))) {
	...
	// From: CodeObject6
	/* 361L, 221L) */ if (/* 362L, 202L, 203L) */ ((/* 363L, 197L, 204L) */ ((var_1_9) ^ (var_1_7))) == (/* 366L, 201L, 207L) */ ((var_1_5) - (var_1_6))))) {
		/* 369L, 220L) */ var_1_41 = (
			var_1_42
		);
	}
	...
	// From: CodeObject8
	/* 379L, 252L) */ if (/* 380L, 240L, 241L) */ ((var_1_11) >= (-32))) {
		/* 383L, 251L) */ var_1_44 = (
			/* 386L, 250L) */ (abs (
				var_1_38
			))
