...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch158Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 216L, 70L) */ if (/* 217L, 31L, 32L) */ ((/* 218L, 29L, 33L) */ (- (var_1_1))) <= (var_1_31))) {
		/* 221L, 49L) */ var_1_34 = (
			/* 224L, 48L) */ ((
				/* 225L, 44L) */ (abs (
					/* 226L, 43L) */ (abs (
