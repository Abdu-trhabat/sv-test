...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch75Amount25.c", 13, "reach_error"); }
...
int property(void) {
	return (((((var_1_2 * var_1_3) * var_1_4) < (max (var_1_5 , var_1_6))) ? (var_1_1 == ((unsigned char) (var_1_7 - ((min (var_1_8 , var_1_9)) - var_1_10)))) : (var_1_1 == ((unsigned char) var_1_8))) && ((var_1_12 || ((var_1_13 * 49.25) == 32.8)) ? (var_1_11 == ((float) (max ((var_1_14 + var_1_15) , var_1_16)))) : (var_1_11 == ((float) var_1_15)))) && ((var_1_1 >= var_1_6) ? (var_1_17 == ((unsigned char) ((abs (var_1_7)) - (abs (max (var_1_9 , var_1_10)))))) : (var_1_17 == ((unsigned char) var_1_8)))
;
}
int main(void) {
	isInitial = 1;
