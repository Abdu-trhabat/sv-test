...
void step(void) {
	// From: Req4Batch195Amount50
	if ((last_1_var_1_16 ^ (last_1_var_1_24 / var_1_14)) <= last_1_var_1_24) {
		var_1_13 = var_1_15;
	}


	// From: Req9Batch195Amount50
	var_1_24 = var_1_13;


	// From: Req1Batch195Amount50
	...
	// From: Req5Batch195Amount50
	if (var_1_6 < 0.375f) {
		var_1_16 = (max (var_1_17 , var_1_18));
	}


	// From: Req7Batch195Amount50
	if (var_1_4) {
		var_1_22 = (min (var_1_7 , var_1_6));
	}


	// From: Req8Batch195Amount50
	var_1_23 = var_1_15;


	// From: Req6Batch195Amount50
