...
void step(void) {
	...
	if (last_1_float_Array_0_2_ > 9999999.5f) {
		...
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) = (max (((last_1_unsigned_char_Array_0_1_ - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) + (last_1_unsigned_short_int_Array_0_0_ - last_1_signed_long_int_Array_0_0_)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer))));
	}
	...
	if (last_1_signed_long_int_Array_0_0_ <= 16) {
		...
		if ((max ((*(float_Array_0_arrayfloat_Array_0arrayVar6_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer)))) < (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer))) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		...
		(*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = (min ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer))));
	}


	// From: Req2Batch9Wrapper_AP
	(*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) = (max ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))));
}
