...
void step(void) {
	...
	if ((abs (- var_1_10)) < ((var_1_12 + var_1_5) - (var_1_14 - var_1_15))) {
		var_1_13 = var_1_16;
	}
}
...
int property(void) {
	return ((((var_1_2 && var_1_3) ? (((var_1_4 - var_1_5) <= var_1_6) ? (var_1_1 == ((signed long int) var_1_5)) : 1) : 1) && ((var_1_4 == (min (32 , var_1_5))) ? ((! var_1_2) ? (var_1_7 == ((double) ((abs (var_1_8)) - var_1_9))) : (var_1_7 == ((double) var_1_9))) : (var_1_7 == ((double) var_1_8)))) && ((-64 < (var_1_6 + var_1_1)) ? (var_1_10 == ((signed short int) (var_1_11 - var_1_12))) : (var_1_10 == ((signed short int) var_1_11)))) && (((abs (- var_1_10)) < ((var_1_12 + var_1_5) - (var_1_14 - var_1_15))) ? (var_1_13 == ((double) var_1_16)) : 1)
;
}
int main(void) {
	isInitial = 1;
