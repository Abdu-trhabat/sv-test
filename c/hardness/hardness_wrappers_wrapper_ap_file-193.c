...
void step(void) {
	...
	if ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) == stepLocal_0) {
		if (stepLocal_1 > (max ((- (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer))) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))))) {
	...
	// From: Req2Batch193Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) = ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)) + (max ((min ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer)))) , last_1_signed_long_int_Array_0_0_)));
	}


	// From: Req3Batch193Wrapper_AP
