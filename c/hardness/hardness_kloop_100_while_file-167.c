...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch167100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch167100_while
	var_1_10 = (! ((var_1_9 || var_1_11) && var_1_12));


	// From: Req7Batch167100_while
	...
	// From: Req12Batch167100_while
	var_1_43 = var_1_21;


	// From: Req13Batch167100_while
	var_1_44 = var_1_41;


	// From: Req3Batch167100_while
