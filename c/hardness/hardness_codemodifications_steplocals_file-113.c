...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch113stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch113stepLocals
	var_1_15 = var_1_6;


	// From: Req5Batch113stepLocals
	...
	// From: Req7Batch113stepLocals
	var_1_22 = (var_1_23 - var_1_24);


	// From: Req8Batch113stepLocals
	if (var_1_22 > 256.8) {
		var_1_25 = (max (((var_1_21 - var_1_17) + var_1_12) , (var_1_16 - var_1_18)));
	} else {
		if (var_1_2) {
			var_1_25 = 25;
		}
