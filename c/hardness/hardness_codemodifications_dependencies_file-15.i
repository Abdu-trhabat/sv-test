...
int property(void) {
 return ((((((((var_1_2 || (var_1_26 > var_1_12)) ? (var_1_1 == ((signed short int) (var_1_5 + var_1_6))) : (var_1_1 == ((signed short int) ((((((var_1_7 + 1)) < (var_1_8)) ? ((var_1_7 + 1)) : (var_1_8))) - (24762 - var_1_9))))) && (var_1_10 == ((signed char) var_1_11))) && ((last_1_var_1_26 >= (last_1_var_1_26 * (last_1_var_1_26 + last_1_var_1_23))) ? (var_1_12 == ((double) (((((var_1_15 - var_1_16)) < (-0.85)) ? ((var_1_15 - var_1_16)) : (-0.85))))) : (var_1_12 == ((double) var_1_16)))) && ((var_1_23 <= ((((var_1_26) < (var_1_12)) ? (var_1_26) : (var_1_12)))) ? ((var_1_2 || var_1_18) ? (var_1_17 == ((signed char) var_1_11)) : (var_1_17 == ((signed char) 16))) : 1)) && ((! var_1_2) ? (var_1_19 == ((unsigned short int) (((((var_1_7) < (var_1_9)) ? (var_1_7) : (var_1_9))) + var_1_20))) : 1)) && (var_1_18 ? (var_1_21 == ((unsigned long int) (((((3346787891u) > (var_1_22)) ? (3346787891u) : (var_1_22))) - var_1_7))) : 1)) && ((-1 < var_1_6) ? (var_1_23 == ((float) (((((var_1_16 - ((((var_1_15) < (var_1_24)) ? (var_1_15) : (var_1_24))))) < (var_1_25)) ? ((var_1_16 - ((((var_1_15) < (var_1_24)) ? (var_1_15) : (var_1_24))))) : (var_1_25))))) : (var_1_23 == ((float) ((((var_1_15) < (var_1_25)) ? (var_1_15) : (var_1_25))))))) && ((var_1_15 > var_1_12) ? ((((var_1_20 + var_1_21) - var_1_7) >= var_1_19) ? (var_1_2 ? (var_1_26 == ((float) var_1_15)) : (var_1_26 == ((float) 9.999999999999923E13f))) : 1) : (var_1_26 == ((float) var_1_15)))
;
}
int main(void) {
 isInitial = 1;
