...
void step(void) {
	...
	// From: Req2Batch123Amount50
	if (var_1_6) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch123Amount50
	...
	// From: Req4Batch123Amount50
	if ((var_1_3 == 32u) || (var_1_5 == var_1_1)) {
		var_1_10 = var_1_8;
	}


	// From: Req6Batch123Amount50
	...
	if (var_1_4 > stepLocal_2) {
		if (stepLocal_4 <= var_1_13) {
			if ((var_1_1 / var_1_5) > stepLocal_3) {
				...
				var_1_16 = (var_1_18 - (max ((var_1_19 - var_1_20) , var_1_21)));
			}
		} else {
			var_1_16 = var_1_18;
		}
