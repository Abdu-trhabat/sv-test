...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch67Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	signed long int stepLocal_0 = WrapperStruct00.var_1_7 >> WrapperStruct00.var_1_8;
	if (stepLocal_0 > (1 * WrapperStruct00.var_1_14)) {
		WrapperStruct00.var_1_6 = (max ((42286 - WrapperStruct00.var_1_8) , 0));
	} else {
	...
	signed long int stepLocal_2 = WrapperStruct00.var_1_4 / WrapperStruct00.var_1_8;
	unsigned short int stepLocal_1 = WrapperStruct00.var_1_6;
	if (WrapperStruct00.var_1_10) {
		WrapperStruct00.var_1_9 = (min (WrapperStruct00.var_1_8 , WrapperStruct00.var_1_4));
	} else {
		if (WrapperStruct00.var_1_2 > stepLocal_2) {
			if (WrapperStruct00.var_1_7 > stepLocal_1) {
				WrapperStruct00.var_1_9 = (min (WrapperStruct00.var_1_8 , 100));
			} else {
				WrapperStruct00.var_1_9 = (WrapperStruct00.var_1_6 - WrapperStruct00.var_1_8);
			}
		} else {
			WrapperStruct00.var_1_9 = (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7);
		}
	}
}
...
void updateVariables(void) {
	...
	assume_abort_if_not(WrapperStruct00.var_1_8 <= 6);
...
int property(void) {
	return ((((((! (WrapperStruct00.var_1_2 <= WrapperStruct00.var_1_3)) ? (WrapperStruct00.var_1_1 == ((signed short int) (WrapperStruct00.var_1_4 + WrapperStruct00.var_1_5))) : 1) && (((WrapperStruct00.var_1_7 >> WrapperStruct00.var_1_8) > (1 * WrapperStruct00.var_1_14)) ? (WrapperStruct00.var_1_6 == ((unsigned short int) (max ((42286 - WrapperStruct00.var_1_8) , 0)))) : (WrapperStruct00.var_1_6 == ((unsigned short int) WrapperStruct00.var_1_8)))) && (WrapperStruct00.var_1_10 ? (WrapperStruct00.var_1_9 == ((signed long int) (min (WrapperStruct00.var_1_8 , WrapperStruct00.var_1_4)))) : ((WrapperStruct00.var_1_2 > (WrapperStruct00.var_1_4 / WrapperStruct00.var_1_8)) ? ((WrapperStruct00.var_1_7 > WrapperStruct00.var_1_6) ? (WrapperStruct00.var_1_9 == ((signed long int) (min (WrapperStruct00.var_1_8 , 100)))) : (WrapperStruct00.var_1_9 == ((signed long int) (WrapperStruct00.var_1_6 - WrapperStruct00.var_1_8)))) : (WrapperStruct00.var_1_9 == ((signed long int) (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7)))))) && (WrapperStruct00.var_1_11 == ((float) WrapperStruct00.var_1_12))) && (WrapperStruct00.var_1_13 == ((double) WrapperStruct00.var_1_12))) && (WrapperStruct00.var_1_14 == ((unsigned short int) WrapperStruct00.var_1_7))
;
}
int main(void) {
	isInitial = 1;
