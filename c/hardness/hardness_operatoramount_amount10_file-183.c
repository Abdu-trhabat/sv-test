...
int property(void) {
	return (var_1_2 > (var_1_5 - (4 + var_1_6))) ? (var_1_1 == ((unsigned long int) (min ((var_1_7 + var_1_2) , var_1_6)))) : ((var_1_7 > var_1_3) ? (var_1_1 == ((unsigned long int) var_1_8)) : 1)
;
}
int main(void) {
	isInitial = 1;
