...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch151Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch151Amount25
	var_1_1 = ((var_1_2 - var_1_3) - var_1_4);


	// From: Req2Batch151Amount25
	var_1_5 = ((var_1_3 - var_1_6) + var_1_7);


	// From: Req3Batch151Amount25
	...
	// From: Req4Batch151Amount25
	if (var_1_9 < var_1_10) {
		if (var_1_9 < (min (var_1_10 , (var_1_13 * var_1_14)))) {
			var_1_12 = (min ((max (8 , (min (var_1_15 , var_1_16)))) , (38186 - var_1_17)));
		} else {
			var_1_12 = var_1_16;
		}
	}
...
int property(void) {
	return (((var_1_1 == ((double) ((var_1_2 - var_1_3) - var_1_4))) && (var_1_5 == ((float) ((var_1_3 - var_1_6) + var_1_7)))) && ((25 <= ((100000000 + var_1_9) - var_1_10)) ? ((1 >= var_1_9) ? (var_1_8 == ((unsigned char) var_1_11)) : 1) : 1)) && ((var_1_9 < var_1_10) ? ((var_1_9 < (min (var_1_10 , (var_1_13 * var_1_14)))) ? (var_1_12 == ((unsigned short int) (min ((max (8 , (min (var_1_15 , var_1_16)))) , (38186 - var_1_17))))) : (var_1_12 == ((unsigned short int) var_1_16))) : 1)
;
}
int main(void) {
	isInitial = 1;
