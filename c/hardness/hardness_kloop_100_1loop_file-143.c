...
void step(void) {
	...
	// From: Req5Batch143100_1loop
	var_1_19 = ((var_1_12 + 10000) + var_1_10);


	// From: Req6Batch143100_1loop
	var_1_20 = (abs (var_1_15 + var_1_12));


	// From: Req2Batch143100_1loop
	...
	// From: Req9Batch143100_1loop
	if (var_1_13 <= var_1_19) {
		var_1_23 = (var_1_24 - (var_1_25 - 8));
	}


	// From: Req12Batch143100_1loop
	if (var_1_7 == var_1_13) {
		var_1_29 = (min (var_1_24 , var_1_25));
	}


	// From: Req1Batch143100_1loop
