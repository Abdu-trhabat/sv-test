...
void step(void) {
	...
	// From: Req3Batch139100_while
	var_1_14 = (abs (var_1_7));


	// From: Req4Batch139100_while
	...
	// From: Req10Batch139100_while
	if (var_1_2 > var_1_8) {
		var_1_31 = 128.75f;
	}


	// From: Req11Batch139100_while
