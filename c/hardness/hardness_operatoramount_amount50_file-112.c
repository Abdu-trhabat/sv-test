...
void step(void) {
	...
	// From: Req5Batch112Amount50
	if ((var_1_16 - var_1_17) < (var_1_10 - var_1_1)) {
		var_1_15 = 1;
	}


	// From: Req2Batch112Amount50
	...
	// From: Req7Batch112Amount50
	var_1_24 = var_1_25;


	// From: Req8Batch112Amount50
	var_1_26 = 10;


	// From: Req4Batch112Amount50
