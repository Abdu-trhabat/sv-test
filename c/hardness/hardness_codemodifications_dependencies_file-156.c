...
void step(void) {
	...
	// From: Req2Batch156dependencies
	if (var_1_5 > var_1_4) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch156dependencies
	if (var_1_7) {
		var_1_9 = (min ((last_1_var_1_9 + -8) , (max ((abs (var_1_3)) , var_1_10))));
	}


	// From: Req4Batch156dependencies
	...
	// From: Req8Batch156dependencies
	var_1_22 = var_1_3;


	// From: Req7Batch156dependencies
