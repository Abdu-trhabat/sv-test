...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch189Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch189Filler_PR_CO
	/* 834L, 46L, 332L, 339L) */ var_1_7 = (
		var_1_4
	);


	// From: Req4Batch189Filler_PR_CO
	...
	/* 302L, 212L) */ if (var_1_24) {
		/* 304L, 206L) */ if (/* 305L, 156L, 157L) */ ((/* 306L, 154L, 158L) */ ((/* 307L, 152L, 159L) */ ((var_1_44) - (var_1_41))) < (var_1_7))) || (var_1_24))) {
	...
	/* 246L, 86L) */ if (/* 247L, 50L, 51L) */ ((/* 248L, 48L, 52L) */ ((50) | (var_1_30))) >= (var_1_34))) {
		/* 252L, 84L) */ if (/* 253L, 65L, 66L) */ ((/* 254L, 63L, 67L) */ ((var_1_26) + (var_1_15))) < (-8))) {
			/* 258L, 79L) */ var_1_36 = (
				var_1_35
			);
		} else {
	...
	// From: CodeObject2
	/* 219L, 42L) */ if (/* 220L, 12L, 13L) */ ((var_1_7) <= (var_1_26))) {
		/* 223L, 34L) */ var_1_27 = (
			/* 226L, 33L) */ (min (
				/* 226L, 33L) */ (
					/* 227L, 25L) */ (max (
	...
	// From: CodeObject5
	/* 271L, 121L) */ if (/* 272L, 100L, 101L) */ ((var_1_15) >= (var_1_31))) {
		/* 275L, 115L) */ var_1_39 = (
			/* 278L, 114L) */ (max (
				/* 278L, 114L) */ (
					/* 279L, 110L) */ (abs (
	...
	// From: CodeObject6
	/* 289L, 143L) */ if (/* 290L, 127L, 128L) */ ((var_1_15) < (var_1_7))) {
		/* 293L, 137L) */ var_1_42 = (
			var_1_44
		);
	} else {
