...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch190100_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req9Batch190100_while
	if (! (last_1_var_1_12 > (last_1_var_1_31 % var_1_33))) {
		var_1_32 = var_1_22;
	}


	// From: Req3Batch190100_while
	...
	// From: Req2Batch190100_while
	var_1_10 = var_1_11;


	// From: Req4Batch190100_while
	if (var_1_8 > (var_1_15 - var_1_13)) {
		var_1_14 = (var_1_16 + var_1_17);
	}


	// From: Req5Batch190100_while
