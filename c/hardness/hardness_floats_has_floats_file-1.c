...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1has_floats.c", 13, "reach_error"); }
...
int property(void) {
	return (((var_1_3 >= var_1_4) ? ((var_1_5 || (var_1_2 || var_1_6)) ? (var_1_1 == ((float) var_1_7)) : (var_1_1 == ((float) 2.0f))) : 1) && ((((- var_1_9) | (max (var_1_10 , var_1_11))) > (var_1_12 / var_1_13)) ? (var_1_8 == ((float) ((max (var_1_14 , var_1_15)) - var_1_16))) : (var_1_8 == ((float) (var_1_17 + var_1_18))))) && (var_1_5 ? ((var_1_11 >= var_1_10) ? (var_1_19 == ((unsigned char) ((var_1_20 + var_1_21) - var_1_22))) : (var_1_19 == ((unsigned char) ((abs (4)) + ((max (var_1_23 , var_1_24)) + 2))))) : (var_1_19 == ((unsigned char) var_1_20)))
;
}
int main(void) {
	isInitial = 1;
