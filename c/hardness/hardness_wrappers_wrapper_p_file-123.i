...
void step(void) {
 ...
 if ((*(var_1_2_Pointer)) || stepLocal_0) {
  (*(var_1_1_Pointer)) = ((256 + (*(var_1_4_Pointer))) - (((((*(var_1_5_Pointer))) < ((*(var_1_6_Pointer)))) ? ((*(var_1_5_Pointer))) : ((*(var_1_6_Pointer))))));
 } else {
...
int property(void) {
 return (((((*(var_1_2_Pointer)) || (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed long int) ((256 + (*(var_1_4_Pointer))) - (((((*(var_1_5_Pointer))) < ((*(var_1_6_Pointer)))) ? ((*(var_1_5_Pointer))) : ((*(var_1_6_Pointer)))))))) : (((*(var_1_4_Pointer)) <= (*(var_1_6_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed long int) (*(var_1_6_Pointer)))) : 1)) && ((*(var_1_3_Pointer)) ? (((*(var_1_1_Pointer)) >= (*(var_1_4_Pointer))) ? (((((*(var_1_5_Pointer)) + (*(var_1_1_Pointer))) < ((*(var_1_6_Pointer)) * (*(var_1_4_Pointer)))) && (*(var_1_2_Pointer))) ? ((*(var_1_7_Pointer)) == ((unsigned short int) (*(var_1_8_Pointer)))) : ((*(var_1_7_Pointer)) == ((unsigned short int) 5))) : ((*(var_1_7_Pointer)) == ((unsigned short int) (*(var_1_8_Pointer))))) : 1)) && ((*(var_1_9_Pointer)) == ((double) (((((*(var_1_10_Pointer))) > ((*(var_1_11_Pointer)))) ? ((*(var_1_10_Pointer))) : ((*(var_1_11_Pointer)))))))) && ((((*(var_1_4_Pointer)) * ((*(var_1_7_Pointer)) / (*(var_1_13_Pointer)))) >= (*(var_1_5_Pointer))) ? (((*(var_1_3_Pointer)) && ((*(var_1_9_Pointer)) < (*(var_1_10_Pointer)))) ? ((*(var_1_12_Pointer)) == ((unsigned char) 5)) : ((*(var_1_12_Pointer)) == ((unsigned char) (*(var_1_14_Pointer))))) : ((*(var_1_12_Pointer)) == ((unsigned char) (*(var_1_14_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
