...
void step(void) {
 if (((- (*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer))) / (*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer))) != ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) / (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)))) {
  if ((*(double_Array_0_arraydouble_Array_0arrayVar6_Pointer)) != ((((((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))) > ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))))) - (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))) {
