...
void step(void) {
 ...
 if (last_1_var_1_1 > stepLocal_0) {
  ...
  (*(var_1_1_Pointer)) = ((*(var_1_5_Pointer)) - (((((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))) < 0 ) ? -((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))) : ((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))))));
 }
 (*(var_1_8_Pointer)) = (*(var_1_9_Pointer));
 if (((((((*(var_1_1_Pointer))) < ((*(var_1_7_Pointer)))) ? ((*(var_1_1_Pointer))) : ((*(var_1_7_Pointer))))) + (*(var_1_1_Pointer))) > (*(var_1_6_Pointer))) {
  (*(var_1_10_Pointer)) = (! (*(var_1_11_Pointer)));
 } else {
  (*(var_1_10_Pointer)) = 0;
 }
 if (((~ (*(var_1_6_Pointer))) >= (*(var_1_7_Pointer))) && (*(var_1_10_Pointer))) {
  if ((*(var_1_13_Pointer)) <= ((((200) > (8)) ? (200) : (8)))) {
   if ((*(var_1_10_Pointer))) {
  ...
  (*(var_1_12_Pointer)) = ((((((*(var_1_7_Pointer)) - (*(var_1_6_Pointer)))) > ((*(var_1_14_Pointer)))) ? (((*(var_1_7_Pointer)) - (*(var_1_6_Pointer)))) : ((*(var_1_14_Pointer)))));
 }
...
int property(void) {
 return (((((last_1_var_1_1 > (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_4_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned char) ((*(var_1_5_Pointer)) - (((((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))) < 0 ) ? -((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))) : ((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))))))))) && ((*(var_1_8_Pointer)) == ((float) (*(var_1_9_Pointer))))) && ((((((((*(var_1_1_Pointer))) < ((*(var_1_7_Pointer)))) ? ((*(var_1_1_Pointer))) : ((*(var_1_7_Pointer))))) + (*(var_1_1_Pointer))) > (*(var_1_6_Pointer))) ? ((*(var_1_10_Pointer)) == ((unsigned char) (! (*(var_1_11_Pointer))))) : ((*(var_1_10_Pointer)) == ((unsigned char) 0)))) && ((((~ (*(var_1_6_Pointer))) >= (*(var_1_7_Pointer))) && (*(var_1_10_Pointer))) ? (((*(var_1_13_Pointer)) <= ((((200) > (8)) ? (200) : (8)))) ? ((*(var_1_10_Pointer)) ? ((*(var_1_12_Pointer)) == ((signed char) (*(var_1_6_Pointer)))) : 1) : ((*(var_1_12_Pointer)) == ((signed char) ((*(var_1_7_Pointer)) + (*(var_1_14_Pointer)))))) : ((*(var_1_12_Pointer)) == ((signed char) ((((((*(var_1_7_Pointer)) - (*(var_1_6_Pointer)))) > ((*(var_1_14_Pointer)))) ? (((*(var_1_7_Pointer)) - (*(var_1_6_Pointer)))) : ((*(var_1_14_Pointer))))))))) && ((*(var_1_15_Pointer)) == ((signed char) (*(var_1_14_Pointer))))
;
}
int main(void) {
 isInitial = 1;
