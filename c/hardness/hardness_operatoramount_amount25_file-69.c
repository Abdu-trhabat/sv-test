...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch69Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned long int stepLocal_2 = var_1_11 * (var_1_5 | var_1_4);
...
int property(void) {
	return ((((((var_1_2 * (min (var_1_3 , var_1_4))) < var_1_5) ? (((var_1_6 - 200.6f) > ((var_1_7 / var_1_8) / var_1_9)) ? (var_1_1 == ((signed short int) (var_1_10 - var_1_11))) : (var_1_1 == ((signed short int) var_1_10))) : 1) && (((var_1_11 * (var_1_5 | var_1_4)) >= (- 10u)) ? ((var_1_11 >= var_1_10) ? (var_1_12 == ((unsigned char) var_1_14)) : (var_1_12 == ((unsigned char) var_1_15))) : (var_1_12 == ((unsigned char) var_1_15)))) && (var_1_16 == ((signed short int) var_1_17))) && (var_1_18 == ((unsigned short int) var_1_11))) && (var_1_19 == ((unsigned char) var_1_14))
;
}
int main(void) {
	isInitial = 1;
