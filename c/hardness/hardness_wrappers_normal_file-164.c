...
void step(void) {
	...
	if (var_1_2 || var_1_3) {
		if ((var_1_4 + var_1_5) <= -1) {
			...
			if (var_1_5 > ((min (var_1_4 , var_1_7)) * var_1_8)) {
				var_1_1 = (var_1_9 - var_1_10);
			} else {
				var_1_1 = (min (99.5 , var_1_6));
			}
		}
	} else {
		var_1_1 = var_1_6;
...
int property(void) {
	return (((var_1_2 || var_1_3) ? (((var_1_4 + var_1_5) <= -1) ? (var_1_1 == ((double) var_1_6)) : ((var_1_5 > ((min (var_1_4 , var_1_7)) * var_1_8)) ? (var_1_1 == ((double) (var_1_9 - var_1_10))) : (var_1_1 == ((double) (min (99.5 , var_1_6)))))) : (var_1_1 == ((double) var_1_6))) && (((var_1_12 - var_1_13) <= var_1_8) ? (var_1_11 == ((unsigned short int) (min (5 , var_1_14)))) : 1)) && (var_1_2 ? ((! ((var_1_4 / var_1_16) < var_1_11)) ? (var_1_15 == ((unsigned short int) (10 + ((var_1_17 - var_1_18) + var_1_19)))) : 1) : (var_1_15 == ((unsigned short int) var_1_14)))
;
}
int main(void) {
	isInitial = 1;
