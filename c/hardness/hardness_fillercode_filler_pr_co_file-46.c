...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch46Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	/* 312L, 208L) */ if (/* 313L, 169L, 170L) */ ((-5) > (/* 315L, 168L, 172L) */ (~ (var_1_6))))) {
		/* 317L, 181L) */ var_1_41 = (
			var_1_40
		);
	} else {
	...
	// From: CodeObject6
	/* 297L, 159L) */ if (/* 298L, 136L, 137L) */ ((/* 299L, 134L, 138L) */ (min (/* 299L, 134L, 138L) */ (/* 300L, 130L, 139L) */ (- (128))) , (/* 302L, 133L, 141L) */ ((128) ^ (var_1_38)))))) >= (var_1_20))) {
		/* 306L, 158L) */ var_1_39 = (
			/* 309L, 157L) */ ((
				var_1_40
			) + (
	...
	// From: CodeObject5
	/* 280L, 125L) */ if (/* 281L, 101L, 102L) */ ((/* 282L, 97L, 103L) */ ((var_1_26) ^ (var_1_1))) <= (/* 285L, 100L, 106L) */ ((16u) & (var_1_33))))) {
		/* 288L, 124L) */ var_1_36 = (
			/* 291L, 123L) */ (min (
				/* 291L, 123L) */ (
					/* 292L, 119L) */ (abs (
