...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch60Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((*(var_1_2_Pointer)) > (*(var_1_1_Pointer))) {
  if ((*(var_1_9_Pointer))) {
   if ((*(var_1_3_Pointer)) <= (((((*(var_1_1_Pointer))) < ((*(var_1_11_Pointer)))) ? ((*(var_1_1_Pointer))) : ((*(var_1_11_Pointer)))))) {
