...
void step(void) {
	...
	if (last_1_var_1_56 < ((var_1_53 * var_1_45) * var_1_48)) {
		...
		var_1_60 = ((min (var_1_62 , var_1_63)) - last_1_var_1_60);
	}
	...
	if ((var_1_76 + var_1_22) >= var_1_7) {
		var_1_41 = (var_1_34 + (var_1_43 - (max (16 , var_1_18))));
	}
	...
	if (var_1_37) {
		var_1_24 = (var_1_22 - (max ((var_1_21 + var_1_18) , var_1_17)));
	} else {
		var_1_24 = (max ((min (-64 , (var_1_20 + -8))) , var_1_19));
	}
	...
	if (stepLocal_6 >= var_1_76) {
		var_1_31 = (var_1_21 - ((max (var_1_17 , var_1_33)) + (var_1_34 - 25)));
	}


	// From: Req8Batch30Amount500
	if (var_1_28 <= ((abs (var_1_18)) * (var_1_30 - var_1_17))) {
		if (var_1_33 > var_1_18) {
			var_1_35 = (min ((max (var_1_33 , (var_1_29 - var_1_21))) , (min ((5 + var_1_22) , var_1_28))));
		} else {
	...
	if (stepLocal_8 >= var_1_35) {
		var_1_44 = (max (1.00000005E7 , var_1_45));
	}
	...
	// From: Req51Batch30Amount500
	if (var_1_69) {
		var_1_115 = var_1_65;
	}


	// From: Req52Batch30Amount500
	var_1_116 = var_1_17;


	// From: Req53Batch30Amount500
	if (var_1_69) {
		var_1_117 = var_1_52;
	} else {
		var_1_117 = var_1_54;
	...
	// From: Req54Batch30Amount500
	var_1_118 = var_1_20;


	// From: Req56Batch30Amount500
	if (var_1_104) {
		var_1_121 = var_1_101;
	} else {
		var_1_121 = var_1_97;
	...
	// From: Req61Batch30Amount500
	var_1_126 = var_1_69;


	// From: Req55Batch30Amount500
	if (var_1_37) {
		var_1_119 = var_1_67;
	} else {
		var_1_119 = var_1_60;
	...
	// From: Req58Batch30Amount500
	var_1_123 = (-64 + (min (var_1_119 , var_1_108)));


	// From: Req6Batch30Amount500
	signed long int stepLocal_5 = (var_1_21 + var_1_22) - 100;
	signed char stepLocal_4 = var_1_112;
	if ((max (var_1_123 , last_1_var_1_26)) < stepLocal_5) {
		if (var_1_37) {
			var_1_26 = var_1_22;
		} else {
			var_1_26 = (min ((min ((var_1_28 - var_1_21) , var_1_18)) , (var_1_29 - (var_1_17 + var_1_22))));
		}
	} else {
		if (stepLocal_4 < -2) {
			var_1_26 = var_1_18;
	...
	if ((- var_1_85) != var_1_53) {
		var_1_95 = (min (var_1_34 , var_1_119));
	}


	// From: Req39Batch30Amount500
	if (var_1_69) {
		var_1_99 = ((64 + (max (var_1_22 , var_1_123))) + var_1_66);
	}
	...
	if (var_1_95 < (var_1_62 - var_1_32)) {
		if (var_1_69) {
			var_1_102 = (max (var_1_60 , (max ((3717949490u - var_1_72) , (min (var_1_29 , var_1_77))))));
		} else {
			if ((abs (var_1_112)) > (var_1_11 * var_1_10)) {
				var_1_102 = (var_1_8 - var_1_103);
			} else {
				var_1_102 = ((max ((var_1_77 - var_1_113) , var_1_76)) + (var_1_34 + (var_1_28 + var_1_89)));
			}
		}
	}


	// From: Req50Batch30Amount500
	var_1_114 = var_1_99;


	// From: Req13Batch30Amount500
	if (var_1_126) {
		var_1_46 = ((max ((max (var_1_47 , 49.53f)) , var_1_48)) + 64.25f);
	} else {
	...
	if (stepLocal_12 > var_1_17) {
		if (stepLocal_11 > var_1_102) {
			if ((var_1_32 == var_1_118) || stepLocal_10) {
				var_1_50 = (((abs (var_1_52)) - var_1_53) - (10.4f + var_1_54));
			} else {
				var_1_50 = var_1_54;
			}
		} else {
		...
		if (var_1_102 == stepLocal_9) {
			var_1_50 = ((min (var_1_49 , var_1_54)) + var_1_47);
		} else {
	...
	unsigned long int stepLocal_13 = var_1_7 / (min (var_1_43 , var_1_32));
	...
	signed long int stepLocal_21 = (min (var_1_63 , var_1_62)) - var_1_65;
	unsigned long int stepLocal_20 = (var_1_77 - var_1_28) >> var_1_32;
	if (var_1_126) {
		var_1_80 = (var_1_58 - 499.5f);
	} else {
		if (stepLocal_21 > var_1_32) {
			var_1_80 = (min (var_1_52 , var_1_54));
		} else {
			if (! var_1_36) {
				if (stepLocal_20 <= (var_1_4 * var_1_10)) {
					var_1_80 = (max ((0.09999999999999998f + var_1_53) , var_1_49));
				} else {
					var_1_80 = (((abs (var_1_54)) + var_1_53) - var_1_57);
				}
			} else {
	...
	if (stepLocal_23 || var_1_69) {
		if (stepLocal_24 != var_1_118) {
			var_1_83 = ((abs (min (var_1_53 , 0.5))) + (var_1_85 + var_1_86));
		}
	} else {
		if (var_1_50 == var_1_53) {
			var_1_83 = (var_1_48 + (min (var_1_85 , var_1_86)));
		} else {
			var_1_83 = (min ((var_1_57 - (max (var_1_54 , var_1_58))) , (var_1_53 - var_1_87)));
		}
	}
	...
	if (var_1_104) {
		var_1_93 = ((max ((max (var_1_48 , var_1_85)) , var_1_53)) + (min (var_1_49 , var_1_86)));
	} else {
		var_1_93 = (min ((0.9f - var_1_53) , var_1_48));
	}


	// From: Req38Batch30Amount500
	if (var_1_116 >= (max (var_1_60 , var_1_61))) {
	...
	if (var_1_18 <= (var_1_102 + (max (-1 , var_1_125)))) {
		var_1_92 = (abs (max (var_1_11 , var_1_34)));
	}
	...
	unsigned long int stepLocal_1 = abs (var_1_6);
	...
	if (stepLocal_2 || ((var_1_11 / 128) >= var_1_7)) {
		...
		if (stepLocal_1 < ((var_1_18 / var_1_8) / 32u)) {
			if (var_1_126 || stepLocal_3) {
				if (-1 == stepLocal_0) {
					var_1_14 = ((max ((min (var_1_19 , var_1_18)) , var_1_17)) + (var_1_20 + (var_1_21 - var_1_22)));
				}
			} else {
				var_1_14 = 4;
			}
	...
	if (stepLocal_25 >= var_1_92) {
		if (var_1_85 <= (var_1_46 / (abs (var_1_52)))) {
	...
	if (var_1_104) {
		if (var_1_75 <= var_1_33) {
			var_1_79 = (var_1_41 + (1553477946u - (max (var_1_21 , var_1_17))));
		}
	} else {
		var_1_79 = 128u;
	}
	...
	if (stepLocal_14 <= var_1_29) {
		if (stepLocal_15 >= (var_1_43 << (max (var_1_65 , var_1_66)))) {
			var_1_64 = var_1_65;
		}
	} else {
	...
	signed long int stepLocal_18 = 64 - (max (var_1_28 , var_1_18));
	if (stepLocal_19 > var_1_28) {
		if (stepLocal_18 >= var_1_21) {
			var_1_78 = (abs (var_1_64));
		} else {
	...
	if (2.25f < var_1_53) {
		var_1_81 = (max (var_1_17 , (min ((min (var_1_95 , var_1_22)) , (var_1_65 + 50)))));
	} else {
	...
	if (! (var_1_64 < var_1_118)) {
		...
		var_1_94 = ((min (var_1_58 , var_1_86)) + var_1_47);
	}
	...
	if (var_1_55 > (var_1_73 | (var_1_76 + var_1_74))) {
		if (((var_1_110 / var_1_28) > var_1_13) && (var_1_30 < var_1_8)) {
			var_1_100 = (max ((var_1_18 - var_1_33) , ((abs (var_1_34)) + var_1_22)));
		} else {
	...
	if ((var_1_23 > (min (var_1_23 , 16u))) && (var_1_65 <= var_1_101)) {
		if (var_1_37 && ((var_1_90 * var_1_125) == -8)) {
			if (var_1_111 >= (abs (var_1_109))) {
	...
	if (((var_1_43 - var_1_34) - var_1_17) > var_1_24) {
		...
		if (var_1_105) {
			var_1_56 = (min (var_1_52 , 7.5f));
		} else {
			if ((var_1_40 / (abs (1000000000))) < (var_1_21 & (abs (var_1_64)))) {
				var_1_56 = (abs (var_1_54 + var_1_47));
			} else {
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_98 == var_1_23) ? (var_1_1 == ((unsigned long int) (max (var_1_4 , (max ((min (var_1_5 , var_1_6)) , var_1_7)))))) : (var_1_1 == ((unsigned long int) (var_1_8 - (max ((max (var_1_9 , var_1_10)) , var_1_11)))))) && (var_1_12 == ((signed char) (max (var_1_13 , 2))))) && (((var_1_126 || var_1_68) || ((var_1_11 / 128) >= var_1_7)) ? (var_1_14 == ((signed char) ((var_1_17 - var_1_18) + var_1_19))) : (((abs (var_1_6)) < ((var_1_18 / var_1_8) / 32u)) ? ((var_1_126 || ((100 << var_1_7) >= var_1_18)) ? ((-1 == var_1_11) ? (var_1_14 == ((signed char) ((max ((min (var_1_19 , var_1_18)) , var_1_17)) + (var_1_20 + (var_1_21 - var_1_22))))) : 1) : (var_1_14 == ((signed char) 4))) : (var_1_14 == ((signed char) -16))))) && (var_1_23 == ((unsigned long int) (var_1_8 - var_1_18)))) && (var_1_37 ? (var_1_24 == ((signed char) (var_1_22 - (max ((var_1_21 + var_1_18) , var_1_17))))) : (var_1_24 == ((signed char) (max ((min (-64 , (var_1_20 + -8))) , var_1_19)))))) && (((max (var_1_123 , last_1_var_1_26)) < ((var_1_21 + var_1_22) - 100)) ? (var_1_37 ? (var_1_26 == ((unsigned char) var_1_22)) : (var_1_26 == ((unsigned char) (min ((min ((var_1_28 - var_1_21) , var_1_18)) , (var_1_29 - (var_1_17 + var_1_22))))))) : ((var_1_112 < -2) ? (var_1_26 == ((unsigned char) var_1_18)) : (var_1_26 == ((unsigned char) ((var_1_30 - var_1_21) - var_1_18)))))) && ((((~ var_1_8) >> var_1_32) >= var_1_76) ? (var_1_31 == ((signed char) (var_1_21 - ((max (var_1_17 , var_1_33)) + (var_1_34 - 25))))) : 1)) && ((var_1_28 <= ((abs (var_1_18)) * (var_1_30 - var_1_17))) ? ((var_1_33 > var_1_18) ? (var_1_35 == ((unsigned char) (min ((max (var_1_33 , (var_1_29 - var_1_21))) , (min ((5 + var_1_22) , var_1_28)))))) : (var_1_35 == ((unsigned char) (var_1_28 - var_1_22)))) : (var_1_35 == ((unsigned char) (var_1_34 + var_1_22))))) && ((last_1_var_1_78 < (-2 / var_1_30)) ? (var_1_37 == ((unsigned char) (! (! var_1_36)))) : 1)) && (((var_1_79 <= var_1_110) || (var_1_78 < var_1_76)) ? (var_1_38 == ((signed char) var_1_40)) : (var_1_38 == ((signed char) 1)))) && (((var_1_76 + var_1_22) >= var_1_7) ? (var_1_41 == ((unsigned char) (var_1_34 + (var_1_43 - (max (16 , var_1_18)))))) : 1)) && ((var_1_19 >= var_1_35) ? (var_1_44 == ((double) (max (1.00000005E7 , var_1_45)))) : 1)) && (var_1_126 ? (var_1_46 == ((float) ((max ((max (var_1_47 , 49.53f)) , var_1_48)) + 64.25f))) : (var_1_46 == ((float) (var_1_48 + var_1_49))))) && ((((var_1_95 + 5) / var_1_51) > var_1_17) ? (((var_1_9 * (var_1_30 - 32)) > var_1_102) ? (((var_1_32 == var_1_118) || var_1_104) ? (var_1_50 == ((float) (((abs (var_1_52)) - var_1_53) - (10.4f + var_1_54)))) : (var_1_50 == ((float) var_1_54))) : (var_1_50 == ((float) (var_1_54 + var_1_47)))) : ((var_1_102 == var_1_108) ? (var_1_50 == ((float) ((min (var_1_49 , var_1_54)) + var_1_47))) : (var_1_50 == ((float) (var_1_49 + var_1_47)))))) && (var_1_55 == ((unsigned short int) var_1_32))) && ((((var_1_43 - var_1_34) - var_1_17) > var_1_24) ? (var_1_56 == ((float) (var_1_54 - 31.2f))) : (var_1_105 ? (var_1_56 == ((float) (min (var_1_52 , 7.5f)))) : (((var_1_40 / (abs (1000000000))) < (var_1_21 & (abs (var_1_64)))) ? (var_1_56 == ((float) (abs (var_1_54 + var_1_47)))) : (var_1_56 == ((float) ((var_1_57 - var_1_53) - (var_1_54 + var_1_58)))))))) && ((var_1_71 == (var_1_7 / (min (var_1_43 , var_1_32)))) ? (var_1_59 == ((signed short int) (var_1_33 - var_1_34))) : 1)) && ((last_1_var_1_56 < ((var_1_53 * var_1_45) * var_1_48)) ? (var_1_60 == ((unsigned short int) ((var_1_61 - 64) + last_1_var_1_60))) : (var_1_60 == ((unsigned short int) ((min (var_1_62 , var_1_63)) - last_1_var_1_60))))) && ((var_1_91 <= var_1_29) ? ((((var_1_23 / var_1_32) * var_1_79) >= (var_1_43 << (max (var_1_65 , var_1_66)))) ? (var_1_64 == ((signed short int) var_1_65)) : 1) : (var_1_64 == ((signed short int) (var_1_13 + last_1_var_1_64))))) && (var_1_67 == ((unsigned char) var_1_21))) && ((var_1_19 <= var_1_114) ? (var_1_68 == ((unsigned char) ((! (! var_1_36)) && var_1_69))) : (var_1_68 == ((unsigned char) var_1_70)))) && (var_1_71 == ((unsigned char) (var_1_17 + var_1_66)))) && (var_1_37 ? (var_1_72 == ((unsigned long int) (min (var_1_26 , var_1_9)))) : (var_1_72 == ((unsigned long int) (((var_1_73 + var_1_74) + 1720035772u) - var_1_26))))) && ((var_1_109 <= var_1_76) ? ((var_1_34 > var_1_33) ? (var_1_75 == ((signed char) (var_1_65 - var_1_32))) : 1) : 1)) && ((var_1_34 < last_1_var_1_79) ? (var_1_76 == ((unsigned long int) (((var_1_77 - var_1_65) - last_1_var_1_79) + last_1_var_1_26))) : 1)) && ((var_1_55 > var_1_28) ? (((64 - (max (var_1_28 , var_1_18))) >= var_1_21) ? (var_1_78 == ((unsigned short int) (abs (var_1_64)))) : (var_1_78 == ((unsigned short int) (var_1_63 - var_1_61)))) : 1)) && (var_1_104 ? ((var_1_75 <= var_1_33) ? (var_1_79 == ((unsigned long int) (var_1_41 + (1553477946u - (max (var_1_21 , var_1_17)))))) : 1) : (var_1_79 == ((unsigned long int) 128u)))) && (var_1_126 ? (var_1_80 == ((float) (var_1_58 - 499.5f))) : ((((min (var_1_63 , var_1_62)) - var_1_65) > var_1_32) ? (var_1_80 == ((float) (min (var_1_52 , var_1_54)))) : ((! var_1_36) ? ((((var_1_77 - var_1_28) >> var_1_32) <= (var_1_4 * var_1_10)) ? (var_1_80 == ((float) (max ((0.09999999999999998f + var_1_53) , var_1_49)))) : (var_1_80 == ((float) (((abs (var_1_54)) + var_1_53) - var_1_57)))) : (var_1_80 == ((float) (var_1_54 - var_1_53))))))) && ((2.25f < var_1_53) ? (var_1_81 == ((unsigned short int) (max (var_1_17 , (min ((min (var_1_95 , var_1_22)) , (var_1_65 + 50))))))) : (((var_1_79 > (var_1_77 / var_1_34)) || var_1_69) ? (var_1_81 == ((unsigned short int) (200 + var_1_22))) : (var_1_81 == ((unsigned short int) (var_1_62 - var_1_30)))))) && ((var_1_126 || var_1_69) ? ((var_1_40 != var_1_118) ? (var_1_83 == ((double) ((abs (min (var_1_53 , 0.5))) + (var_1_85 + var_1_86)))) : 1) : ((var_1_50 == var_1_53) ? (var_1_83 == ((double) (var_1_48 + (min (var_1_85 , var_1_86))))) : (var_1_83 == ((double) (min ((var_1_57 - (max (var_1_54 , var_1_58))) , (var_1_53 - var_1_87)))))))) && ((var_1_122 >= var_1_92) ? ((var_1_85 <= (var_1_46 / (abs (var_1_52)))) ? (var_1_88 == ((unsigned short int) (var_1_28 + (var_1_61 - var_1_22)))) : ((var_1_47 < (3.2f - var_1_53)) ? (var_1_88 == ((unsigned short int) ((var_1_61 + (var_1_89 + var_1_90)) - var_1_21))) : (var_1_88 == ((unsigned short int) (57317 - var_1_28))))) : 1)) && (var_1_91 == ((unsigned long int) (var_1_33 + var_1_73)))) && ((var_1_18 <= (var_1_102 + (max (-1 , var_1_125)))) ? (var_1_92 == ((unsigned long int) (abs (max (var_1_11 , var_1_34))))) : 1)) && (var_1_104 ? (var_1_93 == ((float) ((max ((max (var_1_48 , var_1_85)) , var_1_53)) + (min (var_1_49 , var_1_86))))) : (var_1_93 == ((float) (min ((0.9f - var_1_53) , var_1_48)))))) && ((! (var_1_64 < var_1_118)) ? (var_1_94 == ((double) (var_1_87 - var_1_53))) : (var_1_94 == ((double) ((min (var_1_58 , var_1_86)) + var_1_47))))) && (((- var_1_85) != var_1_53) ? (var_1_95 == ((unsigned short int) (min (var_1_34 , var_1_119)))) : 1)) && (((var_1_58 - 1000000.4f) == (var_1_50 * var_1_47)) ? ((var_1_94 <= (var_1_85 * var_1_49)) ? (var_1_96 == ((signed short int) ((var_1_97 - var_1_22) - (var_1_66 + var_1_18)))) : 1) : ((var_1_76 > var_1_10) ? (var_1_96 == ((signed short int) ((var_1_32 - (var_1_90 - var_1_92)) + (var_1_29 - var_1_65)))) : 1))) && ((var_1_116 >= (max (var_1_60 , var_1_61))) ? (var_1_98 == ((unsigned long int) (var_1_8 - (var_1_18 + var_1_95)))) : 1)) && (var_1_69 ? (var_1_99 == ((unsigned short int) ((64 + (max (var_1_22 , var_1_123))) + var_1_66))) : 1)) && ((var_1_55 > (var_1_73 | (var_1_76 + var_1_74))) ? ((((var_1_110 / var_1_28) > var_1_13) && (var_1_30 < var_1_8)) ? (var_1_100 == ((signed char) (max ((var_1_18 - var_1_33) , ((abs (var_1_34)) + var_1_22))))) : (var_1_100 == ((signed char) (var_1_33 + var_1_22)))) : ((((var_1_88 >> var_1_101) >= var_1_66) || var_1_69) ? (var_1_100 == ((signed char) ((var_1_101 + var_1_65) + var_1_34))) : (var_1_100 == ((signed char) var_1_13))))) && ((var_1_95 < (var_1_62 - var_1_32)) ? (var_1_69 ? (var_1_102 == ((unsigned long int) (max (var_1_60 , (max ((3717949490u - var_1_72) , (min (var_1_29 , var_1_77)))))))) : (((abs (var_1_112)) > (var_1_11 * var_1_10)) ? (var_1_102 == ((unsigned long int) (var_1_8 - var_1_103))) : (var_1_102 == ((unsigned long int) ((max ((var_1_77 - var_1_113) , var_1_76)) + (var_1_34 + (var_1_28 + var_1_89))))))) : 1)) && ((var_1_91 < 100000000u) ? (var_1_104 == ((unsigned char) var_1_69)) : (var_1_104 == ((unsigned char) (last_1_var_1_104 || var_1_69))))) && (((var_1_23 > (min (var_1_23 , 16u))) && (var_1_65 <= var_1_101)) ? ((var_1_37 && ((var_1_90 * var_1_125) == -8)) ? ((var_1_111 >= (abs (var_1_109))) ? (((~ var_1_20) > ((var_1_125 / var_1_51) * (var_1_77 << var_1_111))) ? ((var_1_8 < (var_1_106 - var_1_76)) ? (var_1_105 == ((unsigned char) (var_1_69 && var_1_36))) : (var_1_105 == ((unsigned char) (var_1_70 || var_1_107)))) : 1) : 1) : 1) : (var_1_105 == ((unsigned char) var_1_70)))) && (var_1_70 ? (var_1_108 == ((unsigned char) 25)) : (var_1_108 == ((unsigned char) var_1_29)))) && (var_1_126 ? (var_1_109 == ((unsigned char) var_1_43)) : (var_1_109 == ((unsigned char) 100)))) && (var_1_110 == ((unsigned long int) var_1_79))) && (var_1_68 ? (var_1_111 == ((unsigned short int) var_1_79)) : 1)) && (var_1_104 ? (var_1_112 == ((signed char) var_1_19)) : 1)) && (var_1_113 == ((signed long int) var_1_51))) && (var_1_114 == ((signed short int) var_1_99))) && (var_1_69 ? (var_1_115 == ((signed char) var_1_65)) : 1)) && (var_1_116 == ((unsigned long int) var_1_17))) && (var_1_69 ? (var_1_117 == ((double) var_1_52)) : (var_1_117 == ((double) var_1_54)))) && (var_1_118 == ((signed long int) var_1_20))) && (var_1_37 ? (var_1_119 == ((signed short int) var_1_67)) : (var_1_119 == ((signed short int) var_1_60)))) && (var_1_104 ? (var_1_121 == ((unsigned short int) var_1_101)) : (var_1_121 == ((unsigned short int) var_1_97)))) && (var_1_126 ? (var_1_122 == ((unsigned char) var_1_101)) : (var_1_122 == ((unsigned char) var_1_28)))) && (var_1_123 == ((signed long int) (-64 + (min (var_1_119 , var_1_108)))))) && ((var_1_126 && var_1_107) ? (var_1_124 == ((signed char) ((var_1_101 - var_1_34) + var_1_20))) : 1)) && (var_1_125 == ((signed long int) last_1_var_1_92))) && (var_1_126 == ((unsigned char) var_1_69))
;
}
int main(void) {
	isInitial = 1;
