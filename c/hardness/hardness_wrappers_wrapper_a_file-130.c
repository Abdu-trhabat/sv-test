...
void step(void) {
	// From: Req2Batch130Wrapper_A
	if ((double_Array_0[2] - (max (double_Array_0[1] , double_Array_0[3]))) <= last_1_double_Array_0_6_) {
		signed_long_int_Array_0[2] = ((max (signed_long_int_Array_0[0] , signed_long_int_Array_0[1])) - 50);
	}


	// From: Req3Batch130Wrapper_A
	...
	if (stepLocal_1 <= (signed_long_int_Array_0[4] / (min (-25 , signed_long_int_Array_0[3])))) {
