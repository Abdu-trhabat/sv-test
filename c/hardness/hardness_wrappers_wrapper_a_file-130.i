...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch130Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 if ((double_Array_0[2] - ((((double_Array_0[1]) > (double_Array_0[3])) ? (double_Array_0[1]) : (double_Array_0[3])))) <= last_1_double_Array_0_6_) {
  signed_long_int_Array_0[2] = (((((signed_long_int_Array_0[0]) > (signed_long_int_Array_0[1])) ? (signed_long_int_Array_0[0]) : (signed_long_int_Array_0[1]))) - 50);
 }
 signed long int stepLocal_3 = signed_char_Array_0[0][1] + signed_long_int_Array_0[2];
 signed long int stepLocal_2 = signed_char_Array_0[0][0] - (100 - signed_char_Array_0[1][0]);
 if (BOOL_unsigned_char_Array_0[1]) {
  if (signed_long_int_Array_0[0] <= stepLocal_3) {
   if (BOOL_unsigned_char_Array_0[0]) {
    double_Array_0[6] = double_Array_0[5];
   } else {
    if (stepLocal_2 <= signed_long_int_Array_0[2]) {
     double_Array_0[6] = (double_Array_0[0] + double_Array_0[4]);
    } else {
     double_Array_0[6] = double_Array_0[5];
    }
   }
  } else {
   double_Array_0[6] = double_Array_0[0];
  }
 } else {
  double_Array_0[6] = double_Array_0[0];
 }
 signed long int stepLocal_1 = signed_long_int_Array_0[6] & signed_long_int_Array_0[5];
 signed long int stepLocal_0 = signed_long_int_Array_0[4];
 if (stepLocal_1 <= (signed_long_int_Array_0[4] / ((((-25) < (signed_long_int_Array_0[3])) ? (-25) : (signed_long_int_Array_0[3]))))) {
  signed_char_Array_0[1][1] = signed_char_Array_0[0][1];
 } else {
  if (signed_long_int_Array_0[3] != stepLocal_0) {
   signed_char_Array_0[1][1] = signed_char_Array_0[0][1];
  } else {
...
int property(void) {
 return ((((signed_long_int_Array_0[6] & signed_long_int_Array_0[5]) <= (signed_long_int_Array_0[4] / ((((-25) < (signed_long_int_Array_0[3])) ? (-25) : (signed_long_int_Array_0[3]))))) ? (signed_char_Array_0[1][1] == ((signed char) signed_char_Array_0[0][1])) : ((signed_long_int_Array_0[3] != signed_long_int_Array_0[4]) ? (signed_char_Array_0[1][1] == ((signed char) signed_char_Array_0[0][1])) : (signed_char_Array_0[1][1] == ((signed char) 5)))) && (((double_Array_0[2] - ((((double_Array_0[1]) > (double_Array_0[3])) ? (double_Array_0[1]) : (double_Array_0[3])))) <= last_1_double_Array_0_6_) ? (signed_long_int_Array_0[2] == ((signed long int) (((((signed_long_int_Array_0[0]) > (signed_long_int_Array_0[1])) ? (signed_long_int_Array_0[0]) : (signed_long_int_Array_0[1]))) - 50))) : 1)) && (BOOL_unsigned_char_Array_0[1] ? ((signed_long_int_Array_0[0] <= (signed_char_Array_0[0][1] + signed_long_int_Array_0[2])) ? (BOOL_unsigned_char_Array_0[0] ? (double_Array_0[6] == ((double) double_Array_0[5])) : (((signed_char_Array_0[0][0] - (100 - signed_char_Array_0[1][0])) <= signed_long_int_Array_0[2]) ? (double_Array_0[6] == ((double) (double_Array_0[0] + double_Array_0[4]))) : (double_Array_0[6] == ((double) double_Array_0[5])))) : (double_Array_0[6] == ((double) double_Array_0[0]))) : (double_Array_0[6] == ((double) double_Array_0[0])))
;
}
int main(void) {
 isInitial = 1;
