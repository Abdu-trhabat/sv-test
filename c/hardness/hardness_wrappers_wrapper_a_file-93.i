...
void step(void) {
 if (((- double_Array_0[6]) / double_Array_0[5]) != (double_Array_0[4] / double_Array_0[3])) {
  if (double_Array_0[6] != (((((double_Array_0[2]) > (double_Array_0[1])) ? (double_Array_0[2]) : (double_Array_0[1]))) - double_Array_0[0])) {
...
int property(void) {
 return (((((- double_Array_0[6]) / double_Array_0[5]) != (double_Array_0[4] / double_Array_0[3])) ? ((double_Array_0[6] != (((((double_Array_0[2]) > (double_Array_0[1])) ? (double_Array_0[2]) : (double_Array_0[1]))) - double_Array_0[0])) ? (float_Array_0[1] == ((float) float_Array_0[0])) : (float_Array_0[1] == ((float) 64.51f))) : (float_Array_0[1] == ((float) float_Array_0[0]))) && (((signed_short_int_Array_0[1] * signed_short_int_Array_0[0]) < (100 + 128)) ? (BOOL_unsigned_char_Array_0[0] ? (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_short_int_Array_0[1])) : (unsigned_short_int_Array_0[0] == ((unsigned short int) 4))) : (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_short_int_Array_0[1])))) && ((((unsigned_short_int_Array_0[0] + 100u) << signed_short_int_Array_0[1]) <= unsigned_short_int_Array_0[1]) ? ((double_Array_0[4] <= ((- double_Array_0[6]) + double_Array_0[1])) ? (signed_long_int_Array_0[0] == ((signed long int) signed_short_int_Array_0[1])) : (signed_long_int_Array_0[0] == ((signed long int) signed_short_int_Array_0[0]))) : (signed_long_int_Array_0[0] == ((signed long int) signed_short_int_Array_0[0])))
;
}
int main(void) {
 isInitial = 1;
