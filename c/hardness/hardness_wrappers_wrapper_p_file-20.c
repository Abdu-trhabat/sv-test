...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch20Wrapper_P.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(var_1_10_Pointer)) || stepLocal_0) {
		(*(var_1_9_Pointer)) = (((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))) - (*(var_1_13_Pointer)));
	} else {
		(*(var_1_9_Pointer)) = ((*(var_1_13_Pointer)) + (abs ((*(var_1_12_Pointer)))));
	}


	// From: Req4Batch20Wrapper_P
	unsigned long int stepLocal_2 = (*(var_1_13_Pointer));
	unsigned long int stepLocal_1 = (*(var_1_11_Pointer));
	if (5 >= stepLocal_1) {
