...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11850_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch11850_while
	var_1_1 = -5;


	// From: Req2Batch11850_while
	var_1_2 = (max (var_1_3 , var_1_4));


	// From: Req4Batch11850_while
	if (var_1_8 && var_1_9) {
		var_1_7 = var_1_6;
	}


	// From: Req7Batch11850_while
...
int property(void) {
	return ((((((((var_1_1 == ((signed short int) -5)) && (var_1_2 == ((unsigned char) (max (var_1_3 , var_1_4))))) && ((-2 < (var_1_3 + var_1_18)) ? (((var_1_3 * var_1_18) >= var_1_2) ? (var_1_5 == ((float) var_1_6)) : (var_1_5 == ((float) 49.25f))) : (var_1_5 == ((float) var_1_6)))) && ((var_1_8 && var_1_9) ? (var_1_7 == ((double) var_1_6)) : 1)) && ((((var_1_18 - var_1_3) > (var_1_4 + var_1_1)) && (var_1_19 > var_1_6)) ? (var_1_10 == ((double) var_1_6)) : (var_1_10 == ((double) 9.25)))) && ((var_1_14 == var_1_6) ? (var_1_11 == ((float) (32.7f + (var_1_12 - var_1_13)))) : 1)) && ((var_1_9 && (var_1_8 || var_1_15)) ? (var_1_14 == ((double) (((var_1_16 + 24.9) + var_1_17) + var_1_12))) : (var_1_14 == ((double) (var_1_13 + var_1_17))))) && (var_1_8 ? (var_1_15 ? (var_1_18 == ((signed short int) (((abs (var_1_4)) + var_1_2) + var_1_3))) : (var_1_18 == ((signed short int) var_1_2))) : 1)) && ((((var_1_18 + var_1_1) & var_1_3) >= var_1_4) ? (var_1_19 == ((double) 10000.5)) : (var_1_19 == ((double) var_1_6)))
;
}
int main(void) {
	isInitial = 1;
