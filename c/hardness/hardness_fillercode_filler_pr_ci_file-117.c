...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch117Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject5
	/* 328L, 135L) */ if (/* 329L, 117L, 118L) */ ((var_1_39) >= (var_1_3))) {
		/* 332L, 128L) */ var_1_45 = (
			/* 335L, 127L) */ (abs (
				var_1_36
			))
	...
	// From: CodeObject6
	/* 343L, 193L) */ if (/* 344L, 146L, 147L) */ ((/* 345L, 143L, 148L) */ ((/* 346L, 141L, 149L) */ ((var_1_40) - (var_1_11))) << (var_1_5))) <= (/* 350L, 145L, 153L) */ (~ (var_1_11))))) {
		/* 352L, 191L) */ if (/* 353L, 170L, 171L) */ ((/* 354L, 168L, 172L) */ ((/* 355L, 164L, 173L) */ (abs (16))) >> (/* 357L, 167L, 175L) */ ((var_1_47) - (var_1_48))))) <= (var_1_5))) {
			/* 361L, 190L) */ var_1_46 = (
				var_1_25
			);
		}
	...
	// From: CodeObject1
	/* 236L, 32L) */ if (/* 237L, 11L, 12L) */ ((/* 238L, 9L, 13L) */ ((var_1_3) * (var_1_2))) <= (var_1_25))) {
	...
	// From: CodeObject2
	/* 251L, 58L) */ if (/* 252L, 42L, 43L) */ ((var_1_5) > (var_1_11))) {
		/* 255L, 57L) */ var_1_34 = (
			/* 258L, 56L) */ (max (
				/* 258L, 56L) */ (
					/* 259L, 54L) */ (min (
