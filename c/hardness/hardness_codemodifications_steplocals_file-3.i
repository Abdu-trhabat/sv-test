...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch3stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_16) > (var_1_6)) ? (var_1_16) : (var_1_6))) > stepLocal_1) {
  var_1_15 = (((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))) - (var_1_19 - var_1_20));
 } else {
  if (((((var_1_10) < ((var_1_2 / var_1_21))) ? (var_1_10) : ((var_1_2 / var_1_21)))) > var_1_4) {
