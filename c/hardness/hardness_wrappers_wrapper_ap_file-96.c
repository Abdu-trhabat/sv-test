...
void step(void) {
	...
	if ((abs ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)))) > (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer))) {
		if (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) / -5) >= (((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) + (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer))) - (min ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer)))))) {
