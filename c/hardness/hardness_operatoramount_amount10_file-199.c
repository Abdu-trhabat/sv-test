...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch199Amount10.c", 13, "reach_error"); }
...
unsigned long int var_1_2 = 1000000000;
...
void step(void) {
	...
	// From: Req2Batch199Amount10
	var_1_7 = var_1_8;


	// From: Req3Batch199Amount10
	var_1_9 = -32;
}
...
int property(void) {
	return (((var_1_2 != (var_1_3 / var_1_4)) ? (var_1_1 == ((signed long int) (var_1_5 + var_1_6))) : ((var_1_4 < var_1_2) ? (var_1_1 == ((signed long int) -100)) : 1)) && (var_1_7 == ((float) var_1_8))) && (var_1_9 == ((signed short int) -32))
;
}
int main(void) {
	isInitial = 1;
