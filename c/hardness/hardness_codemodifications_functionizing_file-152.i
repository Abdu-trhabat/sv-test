...
void functionized0(signed char functionized0_localFunctionVar0, signed char functionized0_localFunctionVar1, signed char functionized0_localFunctionVar2) {
 if (functionized0_localFunctionVar0 >= (((((functionized0_localFunctionVar2) < (functionized0_localFunctionVar1)) ? (functionized0_localFunctionVar2) : (functionized0_localFunctionVar1))) * 1)) {
...
void functionized1(signed long int functionized1_localFunctionVar0, signed char functionized1_localFunctionVar1, signed char functionized1_localFunctionVar2, signed char functionized1_localFunctionVar3, signed char functionized1_localFunctionVar4, unsigned char functionized1_localFunctionVar5) {
 if ((var_1_2 / var_1_7) < ((var_1_4 | var_1_3) + (functionized1_localFunctionVar3 / functionized1_localFunctionVar0))) {
  var_1_6 = (((((var_1_2) > (functionized1_localFunctionVar4)) ? (var_1_2) : (functionized1_localFunctionVar4))) - (functionized1_localFunctionVar2 - functionized1_localFunctionVar1));
 } else {
...
void functionized2(signed char functionized2_localFunctionVar0, signed char functionized2_localFunctionVar1, signed char functionized2_localFunctionVar2, unsigned char functionized2_localFunctionVar3, signed char functionized2_localFunctionVar4) {
 if (functionized2_localFunctionVar3) {
  if (((((functionized2_localFunctionVar0) > ((functionized2_localFunctionVar2 - functionized2_localFunctionVar1))) ? (functionized2_localFunctionVar0) : ((functionized2_localFunctionVar2 - functionized2_localFunctionVar1)))) >= functionized2_localFunctionVar4) {
   var_1_13 = var_1_14;
  }
 }
}
...
void step(void) {
 ...
 if (var_1_12) {
  var_1_15 = (var_1_2 - ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6))));
 }
...
int property(void) {
 return (((((var_1_1 == ((signed char) (((((var_1_2 - 25)) > ((var_1_3 + (1 + var_1_4)))) ? ((var_1_2 - 25)) : ((var_1_3 + (1 + var_1_4))))))) && ((var_1_1 >= (((((var_1_3) < (var_1_4)) ? (var_1_3) : (var_1_4))) * 1)) ? (var_1_5 == ((signed char) var_1_3)) : 1)) && (((var_1_2 / var_1_7) < ((var_1_4 | var_1_3) + (var_1_1 / var_1_8))) ? (var_1_6 == ((signed char) (((((var_1_2) > (var_1_9)) ? (var_1_2) : (var_1_9))) - (var_1_10 - var_1_11)))) : (var_1_12 ? (var_1_6 == ((signed char) var_1_3)) : (var_1_6 == ((signed char) var_1_9))))) && (var_1_12 ? ((((((var_1_5) > ((var_1_2 - var_1_11))) ? (var_1_5) : ((var_1_2 - var_1_11)))) >= var_1_1) ? (var_1_13 == ((float) var_1_14)) : 1) : 1)) && (var_1_12 ? (var_1_15 == ((signed long int) (var_1_2 - ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))))) : 1)) && (((var_1_13 / var_1_17) >= var_1_14) ? (((var_1_11 << ((((var_1_18) < 0 ) ? -(var_1_18) : (var_1_18)))) <= var_1_9) ? (var_1_16 == ((float) (var_1_19 - 64.4f))) : ((var_1_15 >= var_1_1) ? (var_1_16 == ((float) ((((var_1_14) > ((var_1_19 - (var_1_20 - var_1_21)))) ? (var_1_14) : ((var_1_19 - (var_1_20 - var_1_21))))))) : (var_1_16 == ((float) var_1_22)))) : (var_1_16 == ((float) var_1_20)))
;
}
int main(void) {
 isInitial = 1;
