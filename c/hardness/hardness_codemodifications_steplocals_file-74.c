...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch74stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((- (max (var_1_17 , var_1_18))) == 32.2f) {
		var_1_16 = 10;
	}
	...
	// From: Req7Batch74stepLocals
	var_1_23 = var_1_24;


	// From: Req8Batch74stepLocals
	var_1_25 = -4;
}
...
int property(void) {
	return ((((((((! (var_1_2 >= var_1_3)) ? (var_1_4 ? (var_1_1 == ((unsigned long int) ((var_1_5 - var_1_6) - var_1_7))) : (var_1_1 == ((unsigned long int) var_1_5))) : (var_1_1 == ((unsigned long int) var_1_7))) && ((var_1_6 < var_1_3) ? ((var_1_3 <= var_1_6) ? (var_1_8 == ((unsigned char) ((var_1_4 && var_1_9) || var_1_10))) : 1) : 1)) && ((! ((var_1_5 > var_1_7) || var_1_4)) ? (((5u << (var_1_12 - var_1_13)) > (var_1_5 / 25u)) ? (((var_1_6 << var_1_1) != (var_1_7 + var_1_12)) ? (var_1_11 == ((unsigned char) (min (var_1_13 , var_1_12)))) : (var_1_11 == ((unsigned char) var_1_12))) : (var_1_11 == ((unsigned char) var_1_15))) : (var_1_11 == ((unsigned char) var_1_12)))) && (((- (max (var_1_17 , var_1_18))) == 32.2f) ? (var_1_16 == ((unsigned char) 10)) : 1)) && ((var_1_4 && var_1_9) ? (var_1_19 == ((unsigned short int) ((var_1_20 + var_1_21) - (max (var_1_15 , var_1_12))))) : (var_1_4 ? (var_1_19 == ((unsigned short int) var_1_16)) : 1))) && (var_1_22 == ((double) 8.625))) && (var_1_23 == ((double) var_1_24))) && (var_1_25 == ((signed long int) -4))
;
}
int main(void) {
	isInitial = 1;
