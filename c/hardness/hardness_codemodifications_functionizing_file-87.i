...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch87functionizing.c", 13, "reach_error"); }
...
signed long int functionized1(signed short int, signed long int);
void functionized2(signed long int, double);
...
void functionized0(double functionized0_localFunctionVar0, double functionized0_localFunctionVar1) {
 var_1_11 = ((((((((functionized0_localFunctionVar0) > (var_1_13)) ? (functionized0_localFunctionVar0) : (var_1_13)))) > ((var_1_14 - (5.86478081602821E18 - functionized0_localFunctionVar1)))) ? (((((functionized0_localFunctionVar0) > (var_1_13)) ? (functionized0_localFunctionVar0) : (var_1_13)))) : ((var_1_14 - (5.86478081602821E18 - functionized0_localFunctionVar1)))));
}
signed long int functionized1(signed short int functionized1_localFunctionVar0, signed long int functionized1_localFunctionVar1) {
 return (functionized1_localFunctionVar1 % functionized1_localFunctionVar0);
}
void functionized2(signed long int functionized2_localFunctionVar0, double functionized2_localFunctionVar1) {
 if (functionized2_localFunctionVar0 < var_1_5) {
  var_1_21 = functionized2_localFunctionVar1;
 }
}
double functionized3(void) {
 return ((((var_1_13) > (255.75)) ? (var_1_13) : (255.75)));
}
signed long int functionized4(signed long int functionized4_localFunctionVar0) {
 return (functionized4_localFunctionVar0 / var_1_17);
}
void initially(void) {
}
void step(void) {
 ...
 functionized0(var_1_12, var_1_15);
 if ((functionized1(var_1_17, var_1_3)) >= var_1_2) {
 ...
 functionized2(var_1_3, var_1_14);
 if (var_1_21 <= var_1_15) {
  var_1_22 = functionized3();
 } else {
 ...
 if (((64 + var_1_19) - var_1_24) <= -128) {
  ...
  if (functionized4(var_1_18) <= (~ var_1_6)) {
   var_1_23 = var_1_13;
  } else {
   var_1_23 = 0.725;
  }
