...
void step(void) {
	...
	if (last_1_var_1_112) {
		if (var_1_10 <= var_1_12) {
			...
			if (last_1_var_1_1 > (- var_1_6)) {
				...
				if (var_1_30 == (var_1_11 - (min (last_1_var_1_81 , var_1_10)))) {
	...
	// From: Req17Batch122Amount500
	if (var_1_44) {
		var_1_53 = (var_1_37 + ((max (var_1_10 , var_1_11)) + var_1_38));
	}


	// From: Req55Batch122Amount500
	var_1_116 = var_1_53;


	// From: Req5Batch122Amount500
	if ((abs (256)) <= ((-50 + var_1_24) / var_1_13)) {
		var_1_25 = var_1_24;
	} else {
		var_1_25 = var_1_14;
	}
	...
	// From: Req11Batch122Amount500
	signed long int stepLocal_4 = -10;
	if (stepLocal_4 > (abs (var_1_12))) {
		var_1_36 = ((abs (max (var_1_11 , var_1_10))) + (var_1_37 + var_1_38));
	} else {
		var_1_36 = var_1_38;
	}


	// From: Req13Batch122Amount500
	if (var_1_41 <= (abs (var_1_29))) {
		var_1_42 = (var_1_10 + var_1_11);
	}


	// From: Req18Batch122Amount500
	var_1_54 = var_1_21;


	// From: Req19Batch122Amount500
	var_1_55 = var_1_38;


	// From: Req28Batch122Amount500
	if (var_1_47) {
		var_1_76 = (max (((var_1_21 + var_1_8) - var_1_6) , (max (1.2 , var_1_4))));
	} else {
		if (var_1_18 > (max (var_1_8 , 16.5f))) {
			var_1_76 = ((8.5 + (min (var_1_8 , var_1_21))) - (var_1_7 + var_1_77));
		}
	}


	// From: Req38Batch122Amount500
	if (var_1_74) {
		var_1_96 = var_1_4;
	} else {
		var_1_96 = (var_1_77 + (min (var_1_70 , var_1_8)));
	}


	// From: Req44Batch122Amount500
	if (var_1_50) {
		var_1_105 = var_1_6;
	}


	// From: Req47Batch122Amount500
	var_1_108 = var_1_38;


	// From: Req48Batch122Amount500
	if (var_1_73) {
		var_1_109 = var_1_38;
	}


	// From: Req49Batch122Amount500
	if (var_1_50) {
		var_1_110 = var_1_11;
	}


	// From: Req50Batch122Amount500
	if (var_1_44) {
		var_1_111 = 8;
	} else {
		var_1_111 = var_1_37;
	...
	// From: Req52Batch122Amount500
	if (var_1_50) {
		var_1_113 = var_1_18;
	}


	// From: Req54Batch122Amount500
	var_1_115 = var_1_37;


	// From: Req56Batch122Amount500
	var_1_117 = var_1_64;


	// From: Req57Batch122Amount500
	var_1_118 = -64;


	// From: Req59Batch122Amount500
	if (var_1_74) {
		var_1_120 = var_1_33;
	} else {
		var_1_120 = var_1_41;
	...
	// From: Req60Batch122Amount500
	if (var_1_49) {
		var_1_121 = (var_1_10 + (abs (var_1_43)));
	}


	// From: Req61Batch122Amount500
	var_1_123 = (min (-32 , var_1_37));


	// From: Req62Batch122Amount500
	var_1_124 = var_1_125;


	// From: Req63Batch122Amount500
	var_1_126 = var_1_29;


	// From: Req64Batch122Amount500
	var_1_127 = var_1_38;


	// From: Req26Batch122Amount500
	signed long int stepLocal_12 = var_1_116 - var_1_38;
	if (256 <= stepLocal_12) {
		var_1_69 = (var_1_18 - (max (var_1_6 , var_1_19)));
	} else {
		var_1_69 = ((abs (var_1_70 + var_1_71)) + var_1_7);
	}


	// From: Req2Batch122Amount500
	...
	// From: Req6Batch122Amount500
	if (var_1_76 != ((var_1_18 * var_1_6) / var_1_21)) {
		var_1_26 = ((var_1_11 + (max (var_1_10 , var_1_29))) - var_1_30);
	} else {
		var_1_26 = var_1_29;
	}


	// From: Req16Batch122Amount500
	if (var_1_26 != var_1_41) {
		var_1_52 = (var_1_12 - (var_1_11 + var_1_29));
	}


	// From: Req21Batch122Amount500
	...
	// From: Req24Batch122Amount500
	var_1_66 = (max ((var_1_67 - last_1_var_1_66) , (var_1_124 + var_1_25)));


	// From: Req27Batch122Amount500
	...
	// From: Req39Batch122Amount500
	var_1_97 = (max (var_1_52 , var_1_10));


	// From: Req40Batch122Amount500
	signed short int stepLocal_22 = var_1_117;
	if (var_1_25 >= stepLocal_22) {
		var_1_98 = ((min (var_1_8 , (var_1_21 + var_1_7))) - var_1_19);
	} else {
		if (var_1_96 >= (var_1_7 * var_1_6)) {
			var_1_98 = (abs (var_1_21 + (max (var_1_7 , var_1_71))));
		} else {
	...
	// From: Req41Batch122Amount500
	if (var_1_92 != (~ (var_1_33 * var_1_52))) {
		var_1_99 = (var_1_7 - (min (var_1_20 , (min (var_1_8 , var_1_6)))));
	} else {
		var_1_99 = (var_1_70 + (max (var_1_71 , 128.5f)));
	}


	// From: Req51Batch122Amount500
	if (var_1_72) {
		var_1_112 = var_1_49;
	}


	// From: Req53Batch122Amount500
	if (var_1_112) {
		var_1_114 = 128u;
	} else {
		var_1_114 = var_1_11;
	...
	// From: Req58Batch122Amount500
	var_1_119 = var_1_123;


	// From: Req4Batch122Amount500
	signed long int stepLocal_1 = 256 >> var_1_11;
	if (stepLocal_1 != (var_1_97 * (max (var_1_12 , var_1_14)))) {
	...
	// From: Req15Batch122Amount500
	if ((! var_1_112) || var_1_44) {
		var_1_51 = (var_1_10 - (2 + var_1_38));
	}


	// From: Req20Batch122Amount500
	signed short int stepLocal_7 = var_1_30;
	if (var_1_66 > stepLocal_7) {
		var_1_56 = (abs (var_1_4));
	}


	// From: Req30Batch122Amount500
	if ((var_1_114 + (var_1_37 / var_1_33)) > ((min (var_1_24 , var_1_59)) - (max (last_1_var_1_81 , var_1_30)))) {
		var_1_81 = (abs (var_1_33 + (var_1_82 - var_1_10)));
	} else {
		var_1_81 = (min ((max (2 , var_1_83)) , (var_1_41 - var_1_82)));
	}


	// From: Req31Batch122Amount500
	unsigned char stepLocal_16 = var_1_73;
	signed long int stepLocal_15 = 16;
	if (stepLocal_15 < var_1_116) {
		if (var_1_44 && stepLocal_16) {
			var_1_84 = (abs (var_1_11));
		} else {
			var_1_84 = (var_1_12 - var_1_127);
		}
	} else {
		var_1_84 = (((min (var_1_14 , 25597)) + (var_1_79 - var_1_37)) - var_1_114);
	}


	// From: Req36Batch122Amount500
	signed long int stepLocal_21 = var_1_22;
	if (var_1_18 > (max (var_1_76 , var_1_34))) {
	...
	// From: Req43Batch122Amount500
	if (var_1_61 <= (abs (var_1_114))) {
		var_1_103 = var_1_37;
	} else {
		var_1_103 = (min (var_1_10 , var_1_41));
	}


	// From: Req45Batch122Amount500
	if (var_1_112) {
		var_1_106 = var_1_6;
	} else {
		var_1_106 = var_1_4;
	...
	// From: Req34Batch122Amount500
	if (var_1_100 == ((- var_1_19) * var_1_20)) {
		var_1_88 = var_1_43;
	} else {
		var_1_88 = (abs (var_1_11));
	}


	// From: Req35Batch122Amount500
	if (var_1_75) {
		if (var_1_114 < last_1_var_1_89) {
			var_1_89 = 256;
		} else {
			var_1_89 = (min (var_1_9 , var_1_59));
		}
	} else {
	...
	if (var_1_5 >= (- var_1_20)) {
		if ((var_1_85 / (var_1_61 - var_1_11)) >= stepLocal_9) {
			if (var_1_49) {
				...
				var_1_60 = ((var_1_38 + (abs (var_1_10))) + 32);
			}
		} else {
			if (((var_1_62 - var_1_12) - var_1_33) < stepLocal_10) {
				var_1_60 = (max (var_1_41 , 0));
			}
		}
	} else {
		if (var_1_44) {
			...
			var_1_60 = (var_1_41 - (abs (var_1_11)));
		}
	}


	// From: Req29Batch122Amount500
	unsigned long int stepLocal_14 = var_1_97;
	if (last_1_var_1_78 <= stepLocal_14) {
		var_1_78 = (((var_1_79 - var_1_89) + var_1_80) - (max ((var_1_38 + var_1_10) , 10000)));
	}


	// From: Req33Batch122Amount500
	...
	if (var_1_112 && stepLocal_20) {
		if (stepLocal_19 > var_1_29) {
			var_1_87 = (((min (var_1_14 , var_1_80)) - var_1_82) + ((var_1_81 + var_1_41) + var_1_33));
		}
	} else {
		...
		if (! (var_1_12 < (var_1_97 / var_1_14))) {
			if (last_1_var_1_63 > var_1_114) {
				...
				if (var_1_34 > var_1_76) {
					var_1_63 = (max (var_1_115 , ((min (var_1_29 , var_1_64)) - var_1_33)));
				} else {
					if (var_1_25 >= var_1_97) {
						if (var_1_59 == var_1_38) {
							if (var_1_72 && (var_1_30 == var_1_114)) {
								...
								var_1_63 = (((max (var_1_124 , 0)) + var_1_25) - (max (var_1_10 , var_1_33)));
							}
						}
					} else {
						var_1_63 = (min ((max (var_1_11 , (max (500 , var_1_28)))) , (max (var_1_41 , (var_1_60 + var_1_95)))));
					}
				}
			}
		}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_113 <= var_1_56) ? (var_1_1 == ((double) (max (var_1_4 , var_1_5)))) : (var_1_1 == ((double) (var_1_6 - ((2.5684615569228887E18 + var_1_7) - var_1_8))))) && ((((64 << var_1_10) >> var_1_11) > 10000) ? ((! (var_1_7 < (var_1_8 + var_1_76))) ? (var_1_9 == ((unsigned short int) (var_1_12 - ((max (var_1_13 , var_1_14)) - var_1_10)))) : 1) : (var_1_9 == ((unsigned short int) (abs (max (var_1_11 , var_1_10))))))) && ((var_1_6 < (- (var_1_34 / 100.75))) ? (var_1_15 == ((float) (var_1_6 - (var_1_7 + var_1_8)))) : (((var_1_97 <= var_1_10) || var_1_72) ? (((var_1_8 - (var_1_7 + var_1_18)) <= (var_1_6 - (var_1_19 + var_1_20))) ? (var_1_15 == ((float) ((min ((min (var_1_20 , 31.5f)) , var_1_8)) - var_1_6))) : 1) : (var_1_15 == ((float) ((var_1_7 - (var_1_21 - 127.125f)) + 31.8f)))))) && (((256 >> var_1_11) != (var_1_97 * (max (var_1_12 , var_1_14)))) ? (var_1_22 == ((signed long int) (var_1_10 - (var_1_11 + var_1_97)))) : (((- var_1_76) < var_1_4) ? (var_1_22 == ((signed long int) (((var_1_24 - var_1_11) - var_1_13) + var_1_97))) : (var_1_22 == ((signed long int) (var_1_11 - var_1_10)))))) && (((abs (256)) <= ((-50 + var_1_24) / var_1_13)) ? (var_1_25 == ((unsigned long int) var_1_24)) : (var_1_25 == ((unsigned long int) var_1_14)))) && ((var_1_76 != ((var_1_18 * var_1_6) / var_1_21)) ? (var_1_26 == ((signed short int) ((var_1_11 + (max (var_1_10 , var_1_29))) - var_1_30))) : (var_1_26 == ((signed short int) var_1_29)))) && (var_1_31 == ((float) ((var_1_8 + var_1_21) - var_1_7)))) && ((var_1_25 < var_1_12) ? ((-4 <= ((var_1_11 << var_1_27) + var_1_29)) ? (var_1_32 == ((signed char) ((var_1_33 - var_1_10) - var_1_11))) : (var_1_32 == ((signed char) (var_1_11 - (max (var_1_10 , var_1_33)))))) : 1)) && (var_1_72 ? (var_1_34 == ((double) (var_1_8 - var_1_7))) : 1)) && ((var_1_25 <= (var_1_10 / var_1_33)) ? (var_1_35 == ((unsigned char) (abs (128 - var_1_10)))) : ((var_1_10 == var_1_11) ? (var_1_35 == ((unsigned char) (var_1_11 + var_1_33))) : (var_1_35 == ((unsigned char) (var_1_10 + var_1_11)))))) && ((-10 > (abs (var_1_12))) ? (var_1_36 == ((unsigned char) ((abs (max (var_1_11 , var_1_10))) + (var_1_37 + var_1_38)))) : (var_1_36 == ((unsigned char) var_1_38)))) && (((var_1_29 * last_1_var_1_39) > var_1_24) ? (var_1_39 == ((unsigned char) (max (var_1_38 , (var_1_11 + var_1_37))))) : ((var_1_44 || ((var_1_66 < var_1_12) || var_1_112)) ? (var_1_39 == ((unsigned char) ((var_1_41 - var_1_10) - var_1_37))) : (var_1_39 == ((unsigned char) (var_1_37 + var_1_10)))))) && ((var_1_41 <= (abs (var_1_29))) ? (var_1_42 == ((signed char) (var_1_10 + var_1_11))) : 1)) && (last_1_var_1_112 ? ((var_1_10 <= var_1_12) ? (var_1_44 == ((unsigned char) (last_1_var_1_72 || (last_1_var_1_112 || (last_1_var_1_72 || var_1_47))))) : ((last_1_var_1_1 > (- var_1_6)) ? ((var_1_4 <= last_1_var_1_69) ? (var_1_44 == ((unsigned char) ((var_1_47 && var_1_49) && (last_1_var_1_112 || (! var_1_50))))) : 1) : ((var_1_30 == (var_1_11 - (min (last_1_var_1_81 , var_1_10)))) ? (var_1_44 == ((unsigned char) (var_1_50 || (! var_1_47)))) : (var_1_44 == ((unsigned char) (var_1_49 || var_1_47)))))) : (var_1_47 ? (var_1_44 == ((unsigned char) (! var_1_50))) : ((var_1_11 > var_1_13) ? (var_1_44 == ((unsigned char) ((var_1_6 > var_1_18) && var_1_50))) : 1)))) && (((! var_1_112) || var_1_44) ? (var_1_51 == ((signed char) (var_1_10 - (2 + var_1_38)))) : 1)) && ((var_1_26 != var_1_41) ? (var_1_52 == ((unsigned short int) (var_1_12 - (var_1_11 + var_1_29)))) : 1)) && (var_1_44 ? (var_1_53 == ((unsigned char) (var_1_37 + ((max (var_1_10 , var_1_11)) + var_1_38)))) : 1)) && (var_1_54 == ((float) var_1_21))) && (var_1_55 == ((unsigned char) var_1_38))) && ((var_1_66 > var_1_30) ? (var_1_56 == ((float) (abs (var_1_4)))) : 1)) && ((((var_1_59 - var_1_118) - var_1_38) <= var_1_43) ? (var_1_58 == ((signed char) var_1_11)) : (var_1_58 == ((signed char) (var_1_11 - var_1_38))))) && ((var_1_5 >= (- var_1_20)) ? (((var_1_85 / (var_1_61 - var_1_11)) >= (var_1_97 + var_1_12)) ? (var_1_49 ? (var_1_60 == ((unsigned char) (var_1_41 - var_1_11))) : (var_1_60 == ((unsigned char) ((var_1_38 + (abs (var_1_10))) + 32)))) : ((((var_1_62 - var_1_12) - var_1_33) < var_1_13) ? (var_1_60 == ((unsigned char) (max (var_1_41 , 0)))) : 1)) : (var_1_44 ? (var_1_60 == ((unsigned char) var_1_11)) : (var_1_60 == ((unsigned char) (var_1_41 - (abs (var_1_11)))))))) && ((var_1_47 && (var_1_50 && var_1_49)) ? ((var_1_69 >= ((var_1_20 + var_1_18) - var_1_8)) ? (var_1_63 == ((signed short int) (abs (var_1_33)))) : 1) : ((! (var_1_12 < (var_1_97 / var_1_14))) ? ((last_1_var_1_63 > var_1_114) ? (var_1_63 == ((signed short int) (var_1_89 + var_1_27))) : ((var_1_34 > var_1_76) ? (var_1_63 == ((signed short int) (max (var_1_115 , ((min (var_1_29 , var_1_64)) - var_1_33))))) : ((var_1_25 >= var_1_97) ? ((var_1_59 == var_1_38) ? ((var_1_72 && (var_1_30 == var_1_114)) ? (var_1_63 == ((signed short int) (var_1_87 - var_1_41))) : (var_1_63 == ((signed short int) (((max (var_1_124 , 0)) + var_1_25) - (max (var_1_10 , var_1_33)))))) : 1) : (var_1_63 == ((signed short int) (min ((max (var_1_11 , (max (500 , var_1_28)))) , (max (var_1_41 , (var_1_60 + var_1_95)))))))))) : 1))) && (var_1_66 == ((unsigned long int) (max ((var_1_67 - last_1_var_1_66) , (var_1_124 + var_1_25)))))) && ((var_1_24 >= var_1_43) ? (((var_1_76 / var_1_21) < (max (var_1_106 , var_1_7))) ? (var_1_68 == ((signed long int) var_1_28)) : 1) : 1)) && ((256 <= (var_1_116 - var_1_38)) ? (var_1_69 == ((float) (var_1_18 - (max (var_1_6 , var_1_19))))) : (var_1_69 == ((float) ((abs (var_1_70 + var_1_71)) + var_1_7))))) && ((var_1_126 >= (var_1_25 % 2)) ? (var_1_72 == ((unsigned char) (var_1_50 || (var_1_73 || (var_1_74 || var_1_75))))) : 1)) && (var_1_47 ? (var_1_76 == ((double) (max (((var_1_21 + var_1_8) - var_1_6) , (max (1.2 , var_1_4)))))) : ((var_1_18 > (max (var_1_8 , 16.5f))) ? (var_1_76 == ((double) ((8.5 + (min (var_1_8 , var_1_21))) - (var_1_7 + var_1_77)))) : 1))) && ((last_1_var_1_78 <= var_1_97) ? (var_1_78 == ((unsigned short int) (((var_1_79 - var_1_89) + var_1_80) - (max ((var_1_38 + var_1_10) , 10000))))) : 1)) && (((var_1_114 + (var_1_37 / var_1_33)) > ((min (var_1_24 , var_1_59)) - (max (last_1_var_1_81 , var_1_30)))) ? (var_1_81 == ((unsigned char) (abs (var_1_33 + (var_1_82 - var_1_10))))) : (var_1_81 == ((unsigned char) (min ((max (2 , var_1_83)) , (var_1_41 - var_1_82))))))) && ((16 < var_1_116) ? ((var_1_44 && var_1_73) ? (var_1_84 == ((unsigned short int) (abs (var_1_11)))) : (var_1_84 == ((unsigned short int) (var_1_12 - var_1_127)))) : (var_1_84 == ((unsigned short int) (((min (var_1_14 , 25597)) + (var_1_79 - var_1_37)) - var_1_114))))) && ((var_1_30 >= var_1_33) ? ((var_1_103 <= var_1_24) ? (var_1_85 == ((unsigned short int) (abs (var_1_12 - (max (var_1_80 , var_1_86)))))) : 1) : (var_1_85 == ((unsigned short int) (var_1_52 + 8))))) && ((var_1_112 && var_1_75) ? (((var_1_78 ^ var_1_95) > var_1_29) ? (var_1_87 == ((unsigned short int) (((min (var_1_14 , var_1_80)) - var_1_82) + ((var_1_81 + var_1_41) + var_1_33)))) : 1) : (var_1_87 == ((unsigned short int) (var_1_38 + var_1_52))))) && ((var_1_100 == ((- var_1_19) * var_1_20)) ? (var_1_88 == ((signed char) var_1_43)) : (var_1_88 == ((signed char) (abs (var_1_11)))))) && (var_1_75 ? ((var_1_114 < last_1_var_1_89) ? (var_1_89 == ((signed short int) 256)) : (var_1_89 == ((signed short int) (min (var_1_9 , var_1_59))))) : (var_1_89 == ((signed short int) (10 - ((var_1_92 - var_1_68) + var_1_93)))))) && ((var_1_18 > (max (var_1_76 , var_1_34))) ? ((var_1_43 > var_1_22) ? (var_1_94 == ((float) (var_1_77 - (var_1_7 + var_1_8)))) : 1) : (var_1_112 ? (var_1_94 == ((float) (var_1_70 + 25.8f))) : (var_1_94 == ((float) var_1_4))))) && ((var_1_73 || var_1_112) ? ((var_1_7 <= ((var_1_6 - var_1_21) * (- var_1_98))) ? (var_1_95 == ((unsigned short int) var_1_29)) : 1) : (var_1_95 == ((unsigned short int) (last_1_var_1_95 + (var_1_14 - var_1_10)))))) && (var_1_74 ? (var_1_96 == ((double) var_1_4)) : (var_1_96 == ((double) (var_1_77 + (min (var_1_70 , var_1_8))))))) && (var_1_97 == ((unsigned long int) (max (var_1_52 , var_1_10))))) && ((var_1_25 >= var_1_117) ? (var_1_98 == ((double) ((min (var_1_8 , (var_1_21 + var_1_7))) - var_1_19))) : ((var_1_96 >= (var_1_7 * var_1_6)) ? (var_1_98 == ((double) (abs (var_1_21 + (max (var_1_7 , var_1_71)))))) : (var_1_98 == ((double) (var_1_20 - var_1_77)))))) && ((var_1_92 != (~ (var_1_33 * var_1_52))) ? (var_1_99 == ((float) (var_1_7 - (min (var_1_20 , (min (var_1_8 , var_1_6))))))) : (var_1_99 == ((float) (var_1_70 + (max (var_1_71 , 128.5f))))))) && (((var_1_114 + var_1_11) > 2u) ? (((var_1_124 * var_1_13) >= var_1_114) ? (var_1_100 == ((double) ((var_1_102 - var_1_8) - var_1_7))) : 1) : 1)) && ((var_1_61 <= (abs (var_1_114))) ? (var_1_103 == ((unsigned char) var_1_37)) : (var_1_103 == ((unsigned char) (min (var_1_10 , var_1_41)))))) && (var_1_50 ? (var_1_105 == ((float) var_1_6)) : 1)) && (var_1_112 ? (var_1_106 == ((float) var_1_6)) : (var_1_106 == ((float) var_1_4)))) && (var_1_112 ? (var_1_107 == ((unsigned char) var_1_41)) : (var_1_107 == ((unsigned char) 5)))) && (var_1_108 == ((signed long int) var_1_38))) && (var_1_73 ? (var_1_109 == ((signed char) var_1_38)) : 1)) && (var_1_50 ? (var_1_110 == ((signed char) var_1_11)) : 1)) && (var_1_44 ? (var_1_111 == ((signed char) 8)) : (var_1_111 == ((signed char) var_1_37)))) && (var_1_72 ? (var_1_112 == ((unsigned char) var_1_49)) : 1)) && (var_1_50 ? (var_1_113 == ((double) var_1_18)) : 1)) && (var_1_112 ? (var_1_114 == ((unsigned long int) 128u)) : (var_1_114 == ((unsigned long int) var_1_11)))) && (var_1_115 == ((signed char) var_1_37))) && (var_1_116 == ((signed long int) var_1_53))) && (var_1_117 == ((signed short int) var_1_64))) && (var_1_118 == ((signed short int) -64))) && (var_1_119 == ((signed short int) var_1_123))) && (var_1_74 ? (var_1_120 == ((signed char) var_1_33)) : (var_1_120 == ((signed char) var_1_41)))) && (var_1_49 ? (var_1_121 == ((signed char) (var_1_10 + (abs (var_1_43))))) : 1)) && (var_1_123 == ((signed char) (min (-32 , var_1_37))))) && (var_1_124 == ((unsigned short int) var_1_125))) && (var_1_126 == ((signed long int) var_1_29))) && (var_1_127 == ((unsigned short int) var_1_38))
;
}
int main(void) {
	isInitial = 1;
