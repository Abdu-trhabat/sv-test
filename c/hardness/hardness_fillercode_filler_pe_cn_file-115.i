...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch115Filler_PE_CN.c", 13, "reach_error"); }
 ...
 signed char stepLocal_0 = var_1_3;
  ...
  var_1_40
             ...
             if (var_1_42) {
              if ( ((var_1_43) && (var_1_44))) {
               if ( ((var_1_35) < (var_1_36))) {
                if ( (( ((var_1_36) | (var_1_34))) < ( (((((var_1_28)) < ((var_1_39))) ? ((var_1_28)) : ((var_1_39))))))) {
                 var_1_41 = (
      var_1_38
     );
    } else {
    ...
    var_1_34
             ...
             if ( (( ((50u) ^ (var_1_28))) > ( ((var_1_36) * (var_1_33))))) {
              var_1_46 = (
