...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch30Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
                   if ( (( (( ((((var_1_8) < 0 ) ? -(var_1_8) : (var_1_8)))) - (var_1_19))) == ( ((var_1_16) * (var_1_5))))) {
                    var_1_17 = (
   -4
  );
 }
  ...
  var_1_26
                   ...
                   if ( (( (( (((((var_1_30)) > ((var_1_31))) ? ((var_1_30)) : ((var_1_31))))) << (var_1_15))) <= (var_1_27))) {
                    var_1_29 = (
                     ((
