...
int property(void) {
	return ((((var_1_2 && var_1_3) ? ((var_1_2 && (var_1_4 > var_1_5)) ? (var_1_1 == ((signed long int) (var_1_6 - var_1_7))) : (var_1_1 == ((signed long int) ((var_1_8 + 5) - var_1_7)))) : 1) && (var_1_2 ? (var_1_9 == ((float) (var_1_10 - var_1_11))) : ((var_1_4 < var_1_5) ? (var_1_9 == ((float) (max (var_1_11 , var_1_10)))) : (var_1_9 == ((float) var_1_10))))) && ((var_1_4 <= (abs (8u))) ? (var_1_12 == ((double) (var_1_10 - 99.5))) : (var_1_12 == ((double) ((var_1_13 - var_1_14) - var_1_11))))) && ((0.8f > (- var_1_10)) ? (var_1_15 == ((unsigned char) var_1_16)) : 1)
;
}
int main(void) {
	isInitial = 1;
