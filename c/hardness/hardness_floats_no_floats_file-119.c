...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch119no_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch119no_floats
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req2Batch119no_floats
	var_1_4 = 200;


	// From: Req3Batch119no_floats
	if (var_1_1 <= var_1_4) {
		var_1_5 = (var_1_6 && var_1_7);
	}


	// From: Req4Batch119no_floats
	var_1_8 = (! var_1_9);


	// From: Req5Batch119no_floats
...
int property(void) {
	return ((((var_1_1 == ((signed long int) (var_1_2 - var_1_3))) && (var_1_4 == ((signed short int) 200))) && ((var_1_1 <= var_1_4) ? (var_1_5 == ((unsigned char) (var_1_6 && var_1_7))) : 1)) && (var_1_8 == ((unsigned char) (! var_1_9)))) && ((var_1_3 <= (var_1_4 + var_1_2)) ? ((var_1_4 == var_1_11) ? ((var_1_1 != var_1_3) ? (var_1_10 == ((unsigned long int) 128u)) : (var_1_10 == ((unsigned long int) (abs (var_1_12 - var_1_3))))) : (var_1_10 == ((unsigned long int) (var_1_12 - (var_1_13 + (var_1_14 + 8u)))))) : (((~ var_1_3) <= var_1_2) ? (var_1_7 ? (var_1_10 == ((unsigned long int) var_1_14)) : (var_1_10 == ((unsigned long int) var_1_13))) : 1))
;
}
int main(void) {
	isInitial = 1;
