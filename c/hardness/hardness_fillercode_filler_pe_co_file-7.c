...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch7Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch7Filler_PE_CO
	/* 916L, 239L, 757L, 763L) */ var_1_24 = (
		16
	);


	// From: Req1Batch7Filler_PE_CO
