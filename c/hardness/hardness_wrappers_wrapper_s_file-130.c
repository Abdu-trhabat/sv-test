...
void step(void) {
	// From: Req2Batch130Wrapper_S
	if ((WrapperStruct00.var_1_8 - (max (WrapperStruct00.var_1_9 , WrapperStruct00.var_1_10))) <= last_1_WrapperStruct00_var_1_14) {
		WrapperStruct00.var_1_7 = ((max (WrapperStruct00.var_1_12 , WrapperStruct00.var_1_13)) - 50);
	}


	// From: Req3Batch130Wrapper_S
	...
	if (stepLocal_1 <= (WrapperStruct00.var_1_4 / (min (-25 , WrapperStruct00.var_1_5)))) {
