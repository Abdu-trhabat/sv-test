...
void step(void) {
	...
	if (stepLocal_1 || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
		(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) = ((abs (200 - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)))) - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)));
	}


	// From: Req1Batch197Wrapper_AP
	if ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) >= (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))) {
		(*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var5_Pointer)) = (min ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var4_Pointer)) , (min ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)) , ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer)) + (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)))))));
	}


	// From: Req4Batch197Wrapper_AP
	if ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) > (max ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) , (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))))) {
