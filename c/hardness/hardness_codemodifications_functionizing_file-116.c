...
void functionized2(unsigned char functionized2_localFunctionVar0) {
	if (var_1_6 || var_1_11) {
		var_1_10 = (max (5 , functionized2_localFunctionVar0));
	} else {
...
void functionized4(signed long int functionized4_localFunctionVar0, signed long int functionized4_localFunctionVar1, unsigned short int functionized4_localFunctionVar2) {
	if ((var_1_12 * var_1_7) > functionized4_localFunctionVar1) {
		...
		var_1_15 = ((max ((functionized4_localFunctionVar0 - functionized4_localFunctionVar2) , var_1_2)) - 4);
	}
}
signed long int functionized5(unsigned short int functionized5_localFunctionVar0) {
	return (min (functionized5_localFunctionVar0 , var_1_10));
}
...
void step(void) {
	// From: Req1Batch116functionizing
	functionized0(var_1_5, var_1_2, var_1_4, var_1_3);


	// From: Req2Batch116functionizing
	...
	// From: Req3Batch116functionizing
	if (var_1_2 <= var_1_3) {
		if (! var_1_6) {
			var_1_8 = var_1_9;
		}
	...
	// From: Req4Batch116functionizing
	functionized2(var_1_12);


	// From: Req5Batch116functionizing
	functionized3(var_1_2, 1);


	// From: Req6Batch116functionizing
	functionized4(var_1_16, var_1_1, var_1_9);


	// From: Req7Batch116functionizing
	if (var_1_6) {
		var_1_17 = (max (functionized5(var_1_2) , -25));
	} else {
...
int property(void) {
	return ((((((((~ var_1_2) < ((var_1_3 * var_1_4) / var_1_5)) ? (var_1_6 ? (var_1_1 == ((signed long int) (128 - var_1_2))) : (var_1_1 == ((signed long int) var_1_2))) : (var_1_1 == ((signed long int) var_1_2))) && (((var_1_4 < var_1_1) || (var_1_2 <= var_1_5)) ? (var_1_6 ? (var_1_7 == ((unsigned long int) var_1_2)) : 1) : 1)) && ((var_1_2 <= var_1_3) ? ((! var_1_6) ? (var_1_8 == ((unsigned short int) var_1_9)) : 1) : 1)) && ((var_1_6 || var_1_11) ? (var_1_10 == ((unsigned char) (max (5 , var_1_12)))) : (var_1_10 == ((unsigned char) (128 - var_1_13))))) && ((var_1_2 >= 1) ? (var_1_14 == ((unsigned char) var_1_13)) : (var_1_14 == ((unsigned char) (var_1_13 + 5))))) && (((var_1_12 * var_1_7) > var_1_1) ? (var_1_15 == ((signed long int) (max (var_1_13 , var_1_12)))) : (var_1_15 == ((signed long int) ((max ((var_1_16 - var_1_9) , var_1_2)) - 4))))) && (var_1_6 ? (var_1_17 == ((signed long int) (max ((min (var_1_2 , var_1_10)) , -25)))) : ((var_1_1 >= var_1_2) ? (var_1_17 == ((signed long int) (max (var_1_10 , var_1_14)))) : (var_1_17 == ((signed long int) 16))))
;
}
int main(void) {
	isInitial = 1;
