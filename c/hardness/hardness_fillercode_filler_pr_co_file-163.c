...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch163Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 276L, 111L) */ if (/* 277L, 55L, 56L) */ ((var_1_36) > (/* 279L, 54L, 58L) */ ((var_1_35) + (7.5))))) {
		/* 282L, 109L) */ if (/* 283L, 72L, 73L) */ ((/* 284L, 68L, 74L) */ (~ (var_1_1))) <= (/* 286L, 71L, 76L) */ ((var_1_32) % (var_1_38))))) {
			/* 289L, 93L) */ var_1_37 = (
				/* 292L, 92L) */ (min (
					/* 292L, 92L) */ (
						/* 293L, 90L) */ (min (
			...
			/* 298L, 107L) */ if (/* 299L, 96L, 97L) */ ((var_1_8) <= (var_1_1))) {
				/* 302L, 106L) */ var_1_37 = (
					64
				);
			}
	...
	// From: CodeObject5
	/* 308L, 156L) */ if (/* 309L, 127L, 128L) */ ((/* 310L, 121L, 129L) */ ((var_1_8) / (var_1_38))) > (/* 313L, 126L, 132L) */ ((/* 314L, 124L, 133L) */ ((var_1_42) - (var_1_40))) - (2))))) {
		/* 318L, 155L) */ var_1_41 = (
			/* 321L, 154L) */ (min (
				/* 321L, 154L) */ (
					var_1_43
	...
	/* 329L, 224L) */ if (/* 330L, 169L, 170L) */ ((-128) != (/* 332L, 168L, 172L) */ (~ (/* 333L, 167L, 173L) */ ((var_1_44) | (var_1_32))))))) {
		...
		/* 342L, 222L) */ if (/* 343L, 192L, 193L) */ ((/* 344L, 190L, 194L) */ ((var_1_8) % (var_1_44))) == (var_1_1))) {
