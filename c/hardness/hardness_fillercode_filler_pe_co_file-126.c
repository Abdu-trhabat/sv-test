...
void step(void) {
	...
	// From: Req8Batch126Filler_PE_CO
	/* 962L, 254L, 796L, 802L) */ var_1_29 = (
		var_1_22
	);


	// From: Req3Batch126Filler_PE_CO
	...
	// From: CodeObject4
	/* 306L, 122L) */ if (/* 307L, 98L, 99L) */ ((/* 308L, 96L, 100L) */ ((var_1_38) / (/* 310L, 95L, 102L) */ (max (/* 310L, 95L, 102L) */ (var_1_36) , (2)))))) > (var_1_11))) {
		/* 314L, 121L) */ var_1_39 = (
			/* 317L, 120L) */ ((
				/* 318L, 118L) */ ((
					4
