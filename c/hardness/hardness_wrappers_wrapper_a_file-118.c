...
void step(void) {
	...
	// From: Req2Batch118Wrapper_A
	signed long int stepLocal_1 = signed_long_int_Array_0[0];
	if (signed_short_int_Array_0[2] == stepLocal_1) {
		unsigned_char_Array_0[1][1] = ((min (unsigned_char_Array_0[0][1] , unsigned_char_Array_0[1][0])) + (max ((64 + 8) , unsigned_char_Array_0[0][0])));
	} else {
		unsigned_char_Array_0[1][1] = (unsigned_char_Array_0[0][1] + 4);
	}


	// From: Req3Batch118Wrapper_A
	if ((float_Array_0[1] - float_Array_0[0]) < double_Array_0[0]) {
		if (BOOL_unsigned_char_Array_0[1] || (signed_long_int_Array_0[0] >= (max (signed_short_int_Array_0[2] , signed_short_int_Array_0[3])))) {
