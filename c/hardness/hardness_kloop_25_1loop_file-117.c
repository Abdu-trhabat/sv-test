...
void step(void) {
	// From: Req1Batch11725_1loop
	if ((var_1_5 >= var_1_6) || last_1_var_1_12) {
		if (last_1_var_1_12) {
			var_1_1 = 4u;
		} else {
			var_1_1 = (max (((var_1_7 - var_1_8) + var_1_9) , (max (var_1_10 , var_1_11))));
		}
	}


	// From: Req2Batch11725_1loop
...
int property(void) {
	return (((((var_1_5 >= var_1_6) || last_1_var_1_12) ? (last_1_var_1_12 ? (var_1_1 == ((unsigned long int) 4u)) : (var_1_1 == ((unsigned long int) (max (((var_1_7 - var_1_8) + var_1_9) , (max (var_1_10 , var_1_11))))))) : 1) && ((var_1_7 <= (var_1_8 * var_1_1)) ? (var_1_12 == ((unsigned char) var_1_13)) : 1)) && ((((var_1_8 + var_1_15) >> var_1_16) >= (var_1_17 - (var_1_7 - var_1_18))) ? (var_1_14 == ((unsigned char) 128)) : 1)) && (((var_1_20 * (32.75 - var_1_21)) == var_1_22) ? (var_1_19 == ((unsigned char) var_1_23)) : 1)
;
}
int main(void) {
	isInitial = 1;
