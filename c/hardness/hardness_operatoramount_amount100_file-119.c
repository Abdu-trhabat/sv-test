...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch119Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch119Amount100
	var_1_3 = last_1_var_1_29;


	// From: Req1Batch119Amount100
	var_1_1 = var_1_2;


	// From: Req4Batch119Amount100
	var_1_7 = (! var_1_8);


	// From: Req12Batch119Amount100
	var_1_28 = var_1_2;


	// From: Req14Batch119Amount100
	var_1_34 = var_1_32;


	// From: Req15Batch119Amount100
	var_1_35 = var_1_19;


	// From: Req16Batch119Amount100
	var_1_36 = var_1_26;


	// From: Req7Batch119Amount100
	var_1_13 = (max ((var_1_9 + var_1_2) , var_1_3));


	// From: Req9Batch119Amount100
