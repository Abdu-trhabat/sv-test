...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch136has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch136has_floats
	if ((var_1_8 * (min (var_1_9 , var_1_10))) > var_1_11) {
		var_1_7 = ((max ((max (16.0f , var_1_12)) , var_1_13)) - (min (var_1_14 , var_1_15)));
	}


	// From: Req3Batch136has_floats
	if (128.0 >= (max (var_1_15 , (var_1_12 / var_1_17)))) {
		if (var_1_8 != var_1_14) {
			var_1_16 = (max (var_1_14 , var_1_12));
		}
	}


	// From: Req4Batch136has_floats
	if (var_1_17 < var_1_11) {
		var_1_18 = (max (4 , (4 - var_1_19)));
	}
}
...
int property(void) {
	return (((var_1_2 ? (var_1_3 ? (var_1_1 == ((unsigned long int) (var_1_4 + var_1_5))) : (var_1_1 == ((unsigned long int) ((min (var_1_6 , 3757035609u)) - var_1_4)))) : (var_1_1 == ((unsigned long int) var_1_4))) && (((var_1_8 * (min (var_1_9 , var_1_10))) > var_1_11) ? (var_1_7 == ((float) ((max ((max (16.0f , var_1_12)) , var_1_13)) - (min (var_1_14 , var_1_15))))) : 1)) && ((128.0 >= (max (var_1_15 , (var_1_12 / var_1_17)))) ? ((var_1_8 != var_1_14) ? (var_1_16 == ((float) (max (var_1_14 , var_1_12)))) : 1) : 1)) && ((var_1_17 < var_1_11) ? (var_1_18 == ((signed short int) (max (4 , (4 - var_1_19))))) : 1)
;
}
int main(void) {
	isInitial = 1;
