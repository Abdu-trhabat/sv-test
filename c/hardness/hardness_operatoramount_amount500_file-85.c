...
void step(void) {
	...
	if (stepLocal_18 != var_1_52) {
		if ((var_1_59 > last_1_var_1_51) && stepLocal_17) {
			if (7.25f > (last_1_var_1_28 / var_1_44)) {
				var_1_60 = (abs ((abs (var_1_13)) - var_1_52));
			}
		} else {
			var_1_60 = ((var_1_25 + (last_1_var_1_48 - var_1_13)) + var_1_53);
		}
	} else {
		var_1_60 = (var_1_10 - (max ((var_1_61 - 16) , (min (last_1_var_1_96 , var_1_32)))));
	}


	// From: Req20Batch85Amount500
	unsigned long int stepLocal_15 = last_1_var_1_51;
	signed long int stepLocal_14 = (max (var_1_53 , var_1_52)) << last_1_var_1_67;
	...
	if (stepLocal_15 != var_1_8) {
		if (stepLocal_13 < last_1_var_1_67) {
			...
			if (last_1_var_1_80 < (abs (last_1_var_1_33))) {
		...
		if (((5.75f - var_1_29) + last_1_var_1_33) < (9.6f * (128.6f + var_1_36))) {
			...
			if ((- (~ var_1_13)) <= stepLocal_12) {
				...
				if (var_1_32 > stepLocal_14) {
					if (last_1_var_1_31 > ((max (var_1_36 , 49.5f)) / var_1_44)) {
	...
	signed long int stepLocal_23 = (abs (last_1_var_1_37)) % (min (var_1_40 , var_1_52));
		...
		if (var_1_12 < stepLocal_24) {
			if (var_1_59 >= stepLocal_23) {
				if (stepLocal_25 > var_1_32) {
					...
					var_1_67 = (var_1_10 + ((var_1_68 - var_1_32) - (max (var_1_52 , var_1_59))));
				}
			} else {
				var_1_67 = (min ((min (var_1_64 , (var_1_54 - var_1_52))) , last_1_var_1_27));
			}
		}
	} else {
		var_1_67 = (max (var_1_63 , last_1_var_1_56));
	}


	// From: Req32Batch85Amount500
	signed long int stepLocal_34 = (abs (var_1_5)) + var_1_59;
	if ((min ((last_1_var_1_58 * last_1_var_1_51) , -256)) == stepLocal_34) {
	...
	if (last_1_var_1_80 != ((last_1_var_1_95 * var_1_34) * (abs (var_1_35)))) {
		var_1_49 = (! (! var_1_46));
	} else {
	...
	signed long int stepLocal_22 = max (16 , (var_1_10 - var_1_52));
	if (var_1_26 != stepLocal_22) {
		if (! (var_1_41 && (var_1_9 <= var_1_54))) {
			var_1_66 = ((var_1_36 + var_1_34) - (max (var_1_35 , var_1_29)));
		}
	} else {
		var_1_66 = (min ((var_1_30 - var_1_29) , (min ((var_1_34 - var_1_35) , var_1_36))));
	}
	...
	if (var_1_26 <= (var_1_9 >> (var_1_52 - var_1_53))) {
		if (last_1_var_1_27 >= (max ((- var_1_38) , last_1_var_1_93))) {
			var_1_51 = var_1_8;
		}
	} else {
		if (var_1_52 >= (var_1_6 / var_1_8)) {
			var_1_51 = (var_1_54 - (min (var_1_52 , var_1_10)));
		}
	}


	// From: Req14Batch85Amount500
	signed long int stepLocal_8 = var_1_8 - (abs (var_1_32));
	...
	if (var_1_51 < var_1_90) {
		var_1_81 = (((var_1_83 - var_1_52) - (min (var_1_32 , var_1_9))) - ((var_1_53 + var_1_84) + var_1_85));
	} else {
		if (var_1_72 > 0.25) {
			var_1_81 = (min ((var_1_83 - var_1_85) , var_1_13));
		} else {
			var_1_81 = (abs (var_1_9 - var_1_86));
		}
	}
	...
	unsigned long int stepLocal_0 = max ((var_1_14 / var_1_3) , (var_1_37 % var_1_5));
	if (stepLocal_0 != -16) {
		var_1_1 = (abs (var_1_6));
	} else {
	...
	if (stepLocal_11 < (abs (last_1_var_1_56))) {
		var_1_56 = var_1_6;
	} else {
		var_1_56 = var_1_40;
	}
	...
	if (! var_1_49) {
		if ((var_1_34 / var_1_44) >= (min (64.5f , var_1_36))) {
			var_1_43 = (((max (var_1_67 , var_1_23)) != var_1_39) || var_1_45);
		}
	} else {
	...
	if (var_1_91) {
		if (((~ var_1_10) * var_1_67) <= stepLocal_4) {
			if (var_1_89) {
				...
				var_1_24 = (min ((var_1_9 - var_1_13) , var_1_8));
			}
		} else {
	...
	if (stepLocal_29 && var_1_89) {
		var_1_73 = (min ((var_1_29 - var_1_35) , var_1_30));
	} else {
	...
	if (stepLocal_28 >= (min ((~ var_1_53) , var_1_51))) {
	...
	if (var_1_21 <= (- (var_1_29 / var_1_44))) {
		var_1_55 = (min (var_1_24 , var_1_14));
	}
	...
	if (! ((var_1_55 <= var_1_58) || var_1_49)) {
		var_1_27 = ((min (var_1_10 , (max (var_1_12 , var_1_58)))) + (max (var_1_51 , var_1_13)));
	} else {
		var_1_27 = var_1_51;
	}
	...
	signed long int stepLocal_1 = (min (var_1_93 , var_1_8)) * var_1_9;
	if (stepLocal_2 > (min (var_1_3 , var_1_5))) {
	...
	if (var_1_70) {
		...
		if (var_1_67 >= (max ((var_1_3 * var_1_81) , var_1_9))) {
			if ((max (var_1_21 , var_1_30)) == ((var_1_80 + var_1_73) + var_1_66)) {
		...
		if (var_1_43) {
			if (var_1_64 != stepLocal_32) {
				...
				if ((- (var_1_50 + var_1_34)) >= var_1_76) {
					if (((min (var_1_9 , var_1_60)) * -128) >= stepLocal_33) {
						var_1_75 = ((min ((var_1_77 - var_1_36) , var_1_35)) - (var_1_34 + var_1_78));
					} else {
						var_1_75 = (((5.5f - var_1_35) + var_1_76) + (max (var_1_36 , (var_1_34 + var_1_79))));
					}
				}
			}
		}
	} else {
		var_1_75 = (var_1_79 + (max (var_1_78 , var_1_76)));
	}
	...
	if (var_1_27 < stepLocal_19) {
		if (var_1_5 < stepLocal_20) {
			if ((var_1_66 + var_1_34) >= var_1_35) {
				var_1_62 = (max ((64 + var_1_40) , var_1_39));
			} else {
			...
			var_1_62 = (((var_1_64 - var_1_32) + 32494) - (max ((var_1_52 + var_1_56) , 4)));
		}
	} else {
		if (var_1_87) {
			if (var_1_45) {
	...
	if (var_1_28 > var_1_72) {
		if (stepLocal_38 < var_1_22) {
			if (var_1_51 <= stepLocal_37) {
				var_1_97 = (min (var_1_53 , var_1_86));
			}
		} else {
			var_1_97 = var_1_83;
		}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((max ((var_1_14 / var_1_3) , (var_1_37 % var_1_5))) != -16) ? (var_1_1 == ((unsigned short int) (abs (var_1_6)))) : (var_1_1 == ((unsigned short int) (max (var_1_6 , 32))))) && ((var_1_27 > (min (var_1_3 , var_1_5))) ? (var_1_7 == ((unsigned char) ((var_1_8 - var_1_9) - var_1_10))) : ((((min (var_1_93 , var_1_8)) * var_1_9) < ((var_1_12 - var_1_6) - (var_1_10 + var_1_67))) ? (var_1_7 == ((unsigned char) (min (var_1_9 , var_1_8)))) : (var_1_7 == ((unsigned char) (abs ((min (var_1_8 , 128)) - (var_1_13 + var_1_9)))))))) && ((last_1_var_1_89 || last_1_var_1_43) ? ((! ((last_1_var_1_28 * last_1_var_1_73) < last_1_var_1_95)) ? (last_1_var_1_89 ? (var_1_14 == ((unsigned long int) var_1_6)) : (var_1_14 == ((unsigned long int) var_1_10))) : (var_1_14 == ((unsigned long int) var_1_6))) : (var_1_14 == ((unsigned long int) 0u)))) && ((((var_1_80 * var_1_31) / var_1_21) != var_1_33) ? (var_1_20 == ((signed short int) (-25 + (var_1_22 - var_1_9)))) : 1)) && ((var_1_22 >= var_1_94) ? (var_1_23 == ((signed short int) var_1_81)) : 1)) && (var_1_91 ? ((((~ var_1_10) * var_1_67) <= var_1_5) ? (var_1_89 ? (var_1_24 == ((signed char) (max (var_1_8 , -4)))) : (var_1_24 == ((signed char) (min ((var_1_9 - var_1_13) , var_1_8))))) : (var_1_24 == ((signed char) (var_1_9 + (min (var_1_25 , var_1_26)))))) : 1)) && ((! ((var_1_55 <= var_1_58) || var_1_49)) ? (var_1_27 == ((unsigned long int) ((min (var_1_10 , (max (var_1_12 , var_1_58)))) + (max (var_1_51 , var_1_13))))) : (var_1_27 == ((unsigned long int) var_1_51)))) && (var_1_70 ? (var_1_28 == ((float) (var_1_29 - var_1_30))) : ((var_1_67 >= (max ((var_1_3 * var_1_81) , var_1_9))) ? (((max (var_1_21 , var_1_30)) == ((var_1_80 + var_1_73) + var_1_66)) ? (var_1_28 == ((float) (var_1_30 - var_1_29))) : 1) : ((var_1_8 != var_1_81) ? (var_1_28 == ((float) var_1_30)) : 1)))) && ((((var_1_9 + var_1_32) - var_1_13) > var_1_14) ? (var_1_31 == ((float) (min (var_1_29 , (min (0.25f , (min (var_1_30 , 16.95f)))))))) : (var_1_31 == ((float) (abs (var_1_29)))))) && (((! (1 <= var_1_25)) || var_1_91) ? ((var_1_12 != 0) ? (var_1_91 ? (var_1_33 == ((float) (var_1_30 - ((var_1_34 + var_1_35) + var_1_36)))) : (var_1_33 == ((float) (max (var_1_30 , (max (var_1_35 , var_1_36))))))) : (var_1_33 == ((float) (min (var_1_35 , var_1_29))))) : ((! var_1_43) ? (var_1_33 == ((float) var_1_35)) : (var_1_33 == ((float) (var_1_29 - var_1_34)))))) && ((! var_1_49) ? (var_1_37 == ((unsigned short int) ((25643 + var_1_38) - (var_1_39 - (var_1_40 - var_1_9))))) : 1)) && (var_1_41 == ((unsigned char) (var_1_49 && var_1_42)))) && ((! var_1_49) ? (((var_1_34 / var_1_44) >= (min (64.5f , var_1_36))) ? (var_1_43 == ((unsigned char) (((max (var_1_67 , var_1_23)) != var_1_39) || var_1_45))) : 1) : (var_1_43 == ((unsigned char) ((! var_1_45) && (! (var_1_46 && var_1_47))))))) && (((var_1_8 - (abs (var_1_32))) >= var_1_5) ? (var_1_48 == ((unsigned char) ((var_1_32 + var_1_9) + var_1_13))) : 1)) && ((last_1_var_1_80 != ((last_1_var_1_95 * var_1_34) * (abs (var_1_35)))) ? (var_1_49 == ((unsigned char) (! (! var_1_46)))) : ((var_1_38 <= var_1_6) ? (var_1_49 == ((unsigned char) (! 0))) : (var_1_49 == ((unsigned char) var_1_45))))) && (((var_1_55 - (var_1_40 + 64)) <= var_1_13) ? (var_1_50 == ((float) ((var_1_34 + 256.4f) - var_1_35))) : (var_1_50 == ((float) (var_1_34 + var_1_35))))) && ((var_1_26 <= (var_1_9 >> (var_1_52 - var_1_53))) ? ((last_1_var_1_27 >= (max ((- var_1_38) , last_1_var_1_93))) ? (var_1_51 == ((unsigned long int) var_1_8)) : 1) : ((var_1_52 >= (var_1_6 / var_1_8)) ? (var_1_51 == ((unsigned long int) (var_1_54 - (min (var_1_52 , var_1_10))))) : 1))) && ((var_1_21 <= (- (var_1_29 / var_1_44))) ? (var_1_55 == ((signed long int) (min (var_1_24 , var_1_14)))) : 1)) && ((((var_1_94 * 64) >> var_1_52) < (abs (last_1_var_1_56))) ? (var_1_56 == ((signed long int) var_1_6)) : (var_1_56 == ((signed long int) var_1_40)))) && ((last_1_var_1_51 != var_1_8) ? ((var_1_26 < last_1_var_1_67) ? (var_1_57 == ((unsigned char) (last_1_var_1_65 && var_1_42))) : ((last_1_var_1_80 < (abs (last_1_var_1_33))) ? (var_1_57 == ((unsigned char) (! (last_1_var_1_87 || var_1_45)))) : (var_1_57 == ((unsigned char) (! (! 0)))))) : ((((5.75f - var_1_29) + last_1_var_1_33) < (9.6f * (128.6f + var_1_36))) ? (var_1_57 == ((unsigned char) ((128.6 == 4.125) || var_1_47))) : (((- (~ var_1_13)) <= var_1_5) ? (var_1_57 == ((unsigned char) var_1_47)) : ((var_1_32 > ((max (var_1_53 , var_1_52)) << last_1_var_1_67)) ? ((last_1_var_1_31 > ((max (var_1_36 , 49.5f)) / var_1_44)) ? (var_1_57 == ((unsigned char) (var_1_47 && var_1_42))) : (var_1_57 == ((unsigned char) ((last_1_var_1_51 >= var_1_39) || (! var_1_42))))) : 1))))) && ((var_1_92 >= (var_1_25 / var_1_3)) ? (var_1_58 == ((unsigned short int) (var_1_59 - var_1_8))) : ((var_1_80 > (abs (- var_1_35))) ? (var_1_58 == ((unsigned short int) ((var_1_39 - var_1_9) + var_1_10))) : 1))) && ((var_1_40 != var_1_52) ? (((var_1_59 > last_1_var_1_51) && (last_1_var_1_14 != last_1_var_1_96)) ? ((7.25f > (last_1_var_1_28 / var_1_44)) ? (var_1_60 == ((signed short int) (abs ((abs (var_1_13)) - var_1_52)))) : 1) : (var_1_60 == ((signed short int) ((var_1_25 + (last_1_var_1_48 - var_1_13)) + var_1_53)))) : (var_1_60 == ((signed short int) (var_1_10 - (max ((var_1_61 - 16) , (min (last_1_var_1_96 , var_1_32))))))))) && ((var_1_27 < var_1_52) ? ((var_1_5 < (var_1_37 / var_1_3)) ? (((var_1_66 + var_1_34) >= var_1_35) ? (var_1_62 == ((unsigned short int) (max ((64 + var_1_40) , var_1_39)))) : (((var_1_56 / (var_1_61 + var_1_38)) > var_1_90) ? (var_1_62 == ((unsigned short int) ((var_1_63 + var_1_40) + var_1_52))) : 1)) : (var_1_62 == ((unsigned short int) (((var_1_64 - var_1_32) + 32494) - (max ((var_1_52 + var_1_56) , 4)))))) : (var_1_87 ? (var_1_45 ? (var_1_62 == ((unsigned short int) var_1_9)) : 1) : (var_1_62 == ((unsigned short int) ((var_1_64 - var_1_22) + var_1_10)))))) && ((! var_1_57) ? (var_1_65 == ((unsigned char) (! var_1_47))) : (var_1_65 == ((unsigned char) (! var_1_46))))) && ((var_1_26 != (max (16 , (var_1_10 - var_1_52)))) ? ((! (var_1_41 && (var_1_9 <= var_1_54))) ? (var_1_66 == ((float) ((var_1_36 + var_1_34) - (max (var_1_35 , var_1_29))))) : 1) : (var_1_66 == ((float) (min ((var_1_30 - var_1_29) , (min ((var_1_34 - var_1_35) , var_1_36)))))))) && ((last_1_var_1_31 < (last_1_var_1_80 + last_1_var_1_33)) ? ((var_1_12 < last_1_var_1_56) ? ((var_1_59 >= ((abs (last_1_var_1_37)) % (min (var_1_40 , var_1_52)))) ? ((last_1_var_1_27 > var_1_32) ? (var_1_67 == ((unsigned long int) (var_1_61 + var_1_12))) : (var_1_67 == ((unsigned long int) (var_1_10 + ((var_1_68 - var_1_32) - (max (var_1_52 , var_1_59))))))) : (var_1_67 == ((unsigned long int) (min ((min (var_1_64 , (var_1_54 - var_1_52))) , last_1_var_1_27))))) : 1) : (var_1_67 == ((unsigned long int) (max (var_1_63 , last_1_var_1_56)))))) && ((var_1_8 < var_1_90) ? (var_1_57 ? (var_1_69 == ((unsigned char) var_1_47)) : ((var_1_58 <= var_1_1) ? (var_1_69 == ((unsigned char) (var_1_49 && var_1_42))) : 1)) : (var_1_69 == ((unsigned char) var_1_45)))) && ((var_1_8 >= (min ((~ var_1_53) , var_1_51))) ? (var_1_70 == ((unsigned char) ((var_1_60 <= var_1_8) || var_1_47))) : (var_1_70 == ((unsigned char) (var_1_69 || var_1_47))))) && (var_1_46 ? ((! (var_1_57 || var_1_47)) ? (var_1_72 == ((double) (63.2 - 1.5))) : (var_1_72 == ((double) (var_1_34 + var_1_35)))) : (var_1_72 == ((double) (abs (abs (var_1_29))))))) && (((200 == (var_1_53 / 64)) && var_1_89) ? (var_1_73 == ((float) (min ((var_1_29 - var_1_35) , var_1_30)))) : ((var_1_56 > var_1_51) ? (var_1_73 == ((float) (10000.125f - var_1_34))) : 1))) && ((var_1_14 < var_1_1) ? (var_1_43 ? ((var_1_64 != var_1_6) ? (var_1_75 == ((float) (((var_1_34 - var_1_35) + var_1_76) + var_1_36))) : (((- (var_1_50 + var_1_34)) >= var_1_76) ? ((((min (var_1_9 , var_1_60)) * -128) >= var_1_52) ? (var_1_75 == ((float) ((min ((var_1_77 - var_1_36) , var_1_35)) - (var_1_34 + var_1_78)))) : (var_1_75 == ((float) (((5.5f - var_1_35) + var_1_76) + (max (var_1_36 , (var_1_34 + var_1_79))))))) : 1)) : 1) : (var_1_75 == ((float) (var_1_79 + (max (var_1_78 , var_1_76))))))) && (((min ((last_1_var_1_58 * last_1_var_1_51) , -256)) == ((abs (var_1_5)) + var_1_59)) ? (((- last_1_var_1_75) > var_1_36) ? (var_1_80 == ((double) (var_1_34 - var_1_29))) : 1) : 1)) && ((var_1_51 < var_1_90) ? (var_1_81 == ((signed char) (((var_1_83 - var_1_52) - (min (var_1_32 , var_1_9))) - ((var_1_53 + var_1_84) + var_1_85)))) : ((var_1_72 > 0.25) ? (var_1_81 == ((signed char) (min ((var_1_83 - var_1_85) , var_1_13)))) : (var_1_81 == ((signed char) (abs (var_1_9 - var_1_86))))))) && ((var_1_14 != var_1_6) ? ((var_1_12 == ((-64 / var_1_59) + (~ var_1_53))) ? (var_1_87 == ((unsigned char) (! var_1_42))) : 1) : ((((var_1_75 + var_1_79) + 9.02f) > var_1_72) ? (var_1_42 ? (var_1_87 == ((unsigned char) var_1_88)) : (var_1_87 == ((unsigned char) var_1_46))) : (var_1_87 == ((unsigned char) var_1_88))))) && (var_1_89 == ((unsigned char) var_1_88))) && (var_1_46 ? (var_1_90 == ((signed long int) var_1_63)) : 1)) && (var_1_69 ? (var_1_91 == ((unsigned char) var_1_88)) : 1)) && (var_1_92 == ((signed char) var_1_32))) && (var_1_45 ? (var_1_93 == ((unsigned short int) var_1_52)) : (var_1_93 == ((unsigned short int) var_1_32)))) && (var_1_94 == ((signed long int) -16))) && (var_1_46 ? (var_1_95 == ((float) var_1_76)) : (var_1_95 == ((float) var_1_30)))) && (var_1_47 ? (var_1_96 == ((signed long int) var_1_93)) : (var_1_96 == ((signed long int) var_1_55)))) && ((var_1_28 > var_1_72) ? ((var_1_67 < var_1_22) ? ((var_1_51 <= (8 - var_1_83)) ? (var_1_97 == ((signed char) (min (var_1_53 , var_1_86)))) : 1) : (var_1_97 == ((signed char) var_1_83))) : 1)
;
}
int main(void) {
	isInitial = 1;
