...
void step(void) {
	// From: Req1Batch181has_floats
	var_1_1 = (max (var_1_2 , (var_1_3 - var_1_4)));


	// From: Req2Batch181has_floats
	if (var_1_4 <= var_1_1) {
		var_1_5 = (var_1_4 - var_1_3);
	}


	// From: Req3Batch181has_floats
...
int property(void) {
	return ((((var_1_1 == ((double) (max (var_1_2 , (var_1_3 - var_1_4))))) && ((var_1_4 <= var_1_1) ? (var_1_5 == ((float) (var_1_4 - var_1_3))) : 1)) && ((var_1_4 <= (var_1_1 * (var_1_7 / var_1_8))) ? (var_1_6 == ((unsigned char) var_1_9)) : ((var_1_1 <= var_1_5) ? (var_1_6 == ((unsigned char) (var_1_9 || var_1_10))) : (var_1_6 == ((unsigned char) ((var_1_9 || var_1_11) && (! 0))))))) && ((var_1_6 && (var_1_2 > var_1_8)) ? (var_1_12 == ((unsigned char) (var_1_13 + (max (var_1_14 , var_1_15))))) : 1)) && ((var_1_15 > ((var_1_12 * var_1_13) * 5)) ? (var_1_16 == ((signed short int) var_1_13)) : 1)
;
}
int main(void) {
	isInitial = 1;
