...
void step(void) {
	// From: Req1Batch141normal
	if (var_1_2) {
		var_1_1 = (((var_1_3 + 4.275) + (var_1_4 + var_1_5)) - var_1_6);
	}


	// From: Req2Batch141normal
	if (var_1_6 > var_1_5) {
		if (var_1_3 != 199.5) {
