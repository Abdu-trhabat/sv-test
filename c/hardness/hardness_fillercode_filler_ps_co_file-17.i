...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
                  var_1_20 = (
                   ...
                   if ( ((128u) <= (var_1_24))) {
                    if ( (( ((var_1_11) >= (var_1_21))) && ( (( ((var_1_24) * (var_1_5))) < ( (((((var_1_26)) < ((var_1_27))) ? ((var_1_26)) : ((var_1_27))))))))) {
                     if ( ((var_1_5) > (var_1_24))) {
                      var_1_23 = (
                       ((((4) < 0 ) ? -(4) : (4)))
    );
  ...
  var_1_31
                   ...
                   if ( (( (( ((var_1_11) * (var_1_21))) / (var_1_33))) <= (var_1_22))) {
