...
void step(void) {
	...
	if (! var_1_82) {
		var_1_70 = (min ((64.6f + var_1_10) , (var_1_64 - var_1_8)));
	} else {
		var_1_70 = (max ((min (var_1_13 , var_1_14)) , var_1_49));
	}
	...
	if (last_1_var_1_70 == 16.4f) {
		if ((min (last_1_var_1_74 , var_1_5)) > (last_1_var_1_95 - var_1_6)) {
	...
	var_1_29 = (max (var_1_13 , (var_1_9 + var_1_10)));
	...
	if ((var_1_47 < var_1_8) || var_1_21) {
		...
		var_1_59 = (min ((55451 - var_1_51) , (abs (var_1_25))));
	}
	...
	if (2.5f < var_1_42) {
		...
		var_1_71 = (max (var_1_47 , (abs (var_1_49 - var_1_35))));
	}


	// From: Req33Batch22Amount500
	signed long int stepLocal_21 = abs (128 + var_1_76);
	...
	var_1_80 = (max ((max (var_1_81 , var_1_54)) , var_1_76));


	// From: Req41Batch22Amount500
	var_1_90 = (min ((var_1_10 - (var_1_8 - var_1_9)) , (var_1_64 - (min (var_1_14 , var_1_35)))));
	...
	// From: Req56Batch22Amount500
	var_1_106 = var_1_13;


	// From: Req58Batch22Amount500
	if (! var_1_21) {
		var_1_108 = (var_1_54 - var_1_75);
	}


	// From: Req59Batch22Amount500
	var_1_109 = (var_1_75 + var_1_76);


	// From: Req60Batch22Amount500
	var_1_110 = var_1_99;


	// From: Req61Batch22Amount500
	var_1_111 = var_1_21;


	// From: Req62Batch22Amount500
	var_1_112 = 16;
	...
	if (var_1_99 <= stepLocal_23) {
		var_1_85 = ((max (var_1_18 , (4125009469u - var_1_27))) - var_1_97);
	}
	...
	var_1_84 = (((max (var_1_62 , var_1_101)) - (10 + var_1_28)) + (max (-1 , var_1_76)));
	...
	if (! (var_1_26 >= (var_1_24 & var_1_101))) {
		var_1_73 = (max (var_1_51 , var_1_101));
	} else {
		var_1_73 = ((abs (var_1_97)) - var_1_99);
	}
	...
	if (var_1_30 || ((- var_1_5) > var_1_17)) {
		if ((- var_1_20) <= var_1_18) {
			if ((var_1_17 + var_1_18) <= var_1_67) {
				var_1_33 = (var_1_9 + (max ((abs (var_1_10)) , var_1_34)));
			} else {
	...
	if ((var_1_25 ^ (128 - var_1_26)) <= stepLocal_8) {
		if (var_1_23 < stepLocal_7) {
			if (var_1_21) {
				...
				var_1_45 = (min (64.5f , (var_1_34 + var_1_35)));
			}
		} else {
	...
	if (var_1_112 < (max ((var_1_5 % var_1_17) , (~ var_1_73)))) {
		if (var_1_9 >= var_1_10) {
			var_1_16 = (max ((var_1_18 - var_1_43) , var_1_17));
		} else {
	...
	signed long int stepLocal_3 = max ((var_1_39 - var_1_40) , var_1_110);
	if (stepLocal_4 <= var_1_5) {
		var_1_38 = (max (var_1_27 , var_1_16));
	} else {
		if (stepLocal_3 <= (var_1_98 * var_1_25)) {
			if (var_1_8 <= var_1_33) {
				var_1_38 = ((last_1_var_1_38 - var_1_16) + var_1_37);
			} else {
				var_1_38 = (max (var_1_16 , last_1_var_1_38));
			}
		} else {
			var_1_38 = (abs (var_1_26));
		}
	}
	...
	if (var_1_58) {
		if (var_1_43 < var_1_17) {
			if (! (var_1_26 < var_1_18)) {
				...
				var_1_63 = (min (var_1_34 , ((max (var_1_64 , var_1_49)) - var_1_8)));
			}
		} else {
			var_1_63 = var_1_8;
		}
		...
		if (var_1_43 > var_1_99) {
			if (var_1_31 || (var_1_79 < var_1_90)) {
				var_1_63 = (max (var_1_34 , ((abs (var_1_65)) + var_1_47)));
			}
		} else {
			var_1_63 = (var_1_35 + (min (var_1_34 , var_1_66)));
		}
	}
	...
	signed long int stepLocal_12 = (abs (var_1_51)) - (min (var_1_37 , var_1_52));
	unsigned char stepLocal_11 = (var_1_26 - var_1_37) > var_1_15;
	unsigned long int stepLocal_10 = var_1_98 % var_1_17;
	if (var_1_79 < (var_1_47 / (max (var_1_8 , var_1_9)))) {
		var_1_50 = var_1_31;
	} else {
	...
	if (stepLocal_0 >= (50 * var_1_16)) {
		var_1_1 = (min (var_1_59 , (max (var_1_99 , (var_1_5 + var_1_6)))));
	}
	...
	if (var_1_58) {
		if (var_1_21) {
			if (stepLocal_17 == var_1_55) {
				var_1_74 = ((var_1_52 + (var_1_62 + var_1_51)) + (min (var_1_27 , var_1_6)));
			}
		} else {
			var_1_74 = var_1_75;
		}
	} else {
		var_1_74 = (max ((var_1_52 + var_1_95) , (max (var_1_54 , (var_1_26 + var_1_75)))));
	}


	// From: Req3Batch22Amount500
	if (var_1_38 > (abs (var_1_5))) {
		if ((var_1_10 + (var_1_90 / var_1_9)) >= var_1_8) {
			var_1_11 = (last_1_var_1_11 - 256);
		}
	} else {
		if ((16 * last_1_var_1_11) < var_1_5) {
			var_1_11 = (var_1_38 + (max (8 , 16)));
		} else {
			var_1_11 = var_1_38;
		}
	}
	...
	if (var_1_20 == stepLocal_13) {
		if (var_1_21) {
			...
			var_1_60 = (min (var_1_52 , (max ((128 - var_1_15) , var_1_51))));
		}
	} else {
		if (stepLocal_15 || var_1_57) {
			if (var_1_18 > stepLocal_14) {
				var_1_60 = (abs (var_1_25));
			} else {
				if (var_1_23 >= stepLocal_16) {
					if (! var_1_78) {
						var_1_60 = (max (var_1_37 , var_1_15));
					} else {
						var_1_60 = ((var_1_25 + var_1_51) - (max (var_1_110 , var_1_52)));
					}
				} else {
			...
			var_1_60 = (min (var_1_25 , var_1_37));
		}
	}
	...
	if (var_1_77) {
		var_1_68 = (min (var_1_52 , var_1_37));
	} else {
	...
	if (var_1_50) {
		...
		var_1_91 = ((min (var_1_62 , var_1_75)) - var_1_76);
	}
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_99 | var_1_59) >= (50 * var_1_16)) ? (var_1_1 == ((unsigned short int) (min (var_1_59 , (max (var_1_99 , (var_1_5 + var_1_6))))))) : 1) && (var_1_7 == ((double) (256.08 - (var_1_8 - (var_1_9 - var_1_10)))))) && ((var_1_38 > (abs (var_1_5))) ? (((var_1_10 + (var_1_90 / var_1_9)) >= var_1_8) ? (var_1_11 == ((signed short int) (last_1_var_1_11 - 256))) : 1) : (((16 * last_1_var_1_11) < var_1_5) ? (var_1_11 == ((signed short int) (var_1_38 + (max (8 , 16))))) : (var_1_11 == ((signed short int) var_1_38))))) && (((var_1_73 / -500) < var_1_43) ? (var_1_12 == ((float) (abs (var_1_8 - (var_1_13 - 0.8f))))) : (var_1_12 == ((float) (max (var_1_10 , (var_1_13 - var_1_14))))))) && ((last_1_var_1_70 == 16.4f) ? (((min (last_1_var_1_74 , var_1_5)) > (last_1_var_1_95 - var_1_6)) ? (var_1_15 == ((unsigned short int) (last_1_var_1_95 + var_1_6))) : (var_1_15 == ((unsigned short int) last_1_var_1_15))) : 1)) && ((var_1_112 < (max ((var_1_5 % var_1_17) , (~ var_1_73)))) ? ((var_1_9 >= var_1_10) ? (var_1_16 == ((unsigned long int) (max ((var_1_18 - var_1_43) , var_1_17)))) : ((var_1_30 && ((var_1_43 * var_1_5) >= var_1_15)) ? (((0.628 / var_1_9) > (max (var_1_13 , var_1_8))) ? (var_1_16 == ((unsigned long int) (var_1_18 - (1167038438u - (var_1_20 - var_1_6))))) : (((var_1_5 - var_1_22) >= -8) ? (var_1_16 == ((unsigned long int) ((var_1_23 - var_1_73) + var_1_6))) : (var_1_16 == ((unsigned long int) var_1_20)))) : (var_1_16 == ((unsigned long int) var_1_23)))) : (var_1_16 == ((unsigned long int) var_1_20)))) && ((((var_1_25 + 64) - var_1_26) <= var_1_17) ? (var_1_24 == ((signed short int) (var_1_28 - var_1_27))) : (var_1_24 == ((signed short int) (max (256 , var_1_27)))))) && (var_1_28 == ((signed short int) var_1_98))) && (var_1_29 == ((double) (max (var_1_13 , (var_1_9 + var_1_10)))))) && (((- var_1_96) <= var_1_25) ? ((var_1_17 > var_1_96) ? (var_1_30 == ((unsigned char) (var_1_78 || (! var_1_31)))) : 1) : 1)) && ((((36280 - var_1_25) * var_1_22) <= var_1_6) ? ((var_1_8 == 4.2) ? (var_1_32 == ((double) var_1_13)) : 1) : 1)) && ((var_1_30 || ((- var_1_5) > var_1_17)) ? (((- var_1_20) <= var_1_18) ? (((var_1_17 + var_1_18) <= var_1_67) ? (var_1_33 == ((double) (var_1_9 + (max ((abs (var_1_10)) , var_1_34))))) : (var_1_33 == ((double) (var_1_10 + var_1_34)))) : (var_1_33 == ((double) (((var_1_10 + var_1_35) - 9.999999993E7) + var_1_34)))) : 1)) && ((var_1_67 <= var_1_6) ? ((! var_1_31) ? (var_1_36 == ((unsigned char) (var_1_26 + var_1_37))) : 1) : 1)) && ((var_1_99 <= var_1_5) ? (var_1_38 == ((signed short int) (max (var_1_27 , var_1_16)))) : (((max ((var_1_39 - var_1_40) , var_1_110)) <= (var_1_98 * var_1_25)) ? ((var_1_8 <= var_1_33) ? (var_1_38 == ((signed short int) ((last_1_var_1_38 - var_1_16) + var_1_37))) : (var_1_38 == ((signed short int) (max (var_1_16 , last_1_var_1_38))))) : (var_1_38 == ((signed short int) (abs (var_1_26))))))) && ((var_1_85 >= -5) ? (var_1_31 ? (var_1_41 == ((float) (min (var_1_9 , var_1_13)))) : (var_1_41 == ((float) (abs (var_1_42))))) : 1)) && (((4 + var_1_26) <= (var_1_15 / var_1_25)) ? (var_1_43 == ((signed long int) var_1_26)) : 1)) && (((var_1_25 ^ (128 - var_1_26)) <= (min (var_1_40 , (var_1_67 * var_1_55)))) ? ((var_1_23 < var_1_5) ? (var_1_21 ? ((var_1_40 <= var_1_67) ? (var_1_45 == ((float) (max ((var_1_47 + var_1_10) , var_1_48)))) : (var_1_30 ? (var_1_45 == ((float) (var_1_8 - var_1_9))) : 1)) : (var_1_45 == ((float) (min (64.5f , (var_1_34 + var_1_35)))))) : (var_1_45 == ((float) (var_1_9 - (var_1_10 + var_1_35))))) : ((! var_1_57) ? (var_1_45 == ((float) (var_1_49 - var_1_9))) : (var_1_31 ? (var_1_45 == ((float) (49.3f - (var_1_10 + (var_1_9 - var_1_35))))) : (var_1_45 == ((float) (-0.95f + var_1_34))))))) && ((var_1_79 < (var_1_47 / (max (var_1_8 , var_1_9)))) ? (var_1_50 == ((unsigned char) var_1_31)) : ((var_1_6 <= (var_1_98 % var_1_17)) ? ((var_1_26 <= ((abs (var_1_51)) - (min (var_1_37 , var_1_52)))) ? (var_1_50 == ((unsigned char) (var_1_31 || var_1_53))) : (var_1_50 == ((unsigned char) var_1_31))) : (((var_1_23 < var_1_55) || ((var_1_26 - var_1_37) > var_1_15)) ? ((var_1_79 <= var_1_104) ? (var_1_50 == ((unsigned char) ((var_1_100 >= (var_1_26 >> var_1_54)) || var_1_21))) : (var_1_50 == ((unsigned char) (! ((! var_1_57) || var_1_21))))) : (var_1_50 == ((unsigned char) var_1_21)))))) && (var_1_55 == ((unsigned long int) (var_1_23 + (var_1_56 - var_1_85))))) && (var_1_31 ? (var_1_57 == ((unsigned char) ((var_1_112 < (var_1_67 / var_1_51)) && (! (var_1_21 && var_1_58))))) : 1)) && (((var_1_47 < var_1_8) || var_1_21) ? (var_1_59 == ((unsigned short int) (var_1_52 + var_1_54))) : (var_1_59 == ((unsigned short int) (min ((55451 - var_1_51) , (abs (var_1_25)))))))) && ((var_1_20 == (var_1_23 + var_1_39)) ? (var_1_21 ? (var_1_60 == ((signed short int) (var_1_15 + var_1_110))) : (var_1_60 == ((signed short int) (min (var_1_52 , (max ((128 - var_1_15) , var_1_51))))))) : ((var_1_78 || var_1_57) ? ((var_1_18 > (var_1_1 + var_1_54)) ? (var_1_60 == ((signed short int) (abs (var_1_25)))) : ((var_1_23 >= ((var_1_1 * 50u) + var_1_15)) ? ((! var_1_78) ? (var_1_60 == ((signed short int) (max (var_1_37 , var_1_15)))) : (var_1_60 == ((signed short int) ((var_1_25 + var_1_51) - (max (var_1_110 , var_1_52)))))) : (var_1_60 == ((signed short int) (var_1_52 + var_1_54))))) : (var_1_60 == ((signed short int) (min (var_1_25 , var_1_37))))))) && ((var_1_10 != var_1_47) ? ((! var_1_53) ? (var_1_61 == ((signed char) ((var_1_62 - var_1_54) - 1))) : (var_1_61 == ((signed char) (var_1_62 - var_1_54)))) : 1)) && (var_1_58 ? ((var_1_43 < var_1_17) ? ((! (var_1_26 < var_1_18)) ? (var_1_63 == ((double) ((var_1_10 + var_1_35) + var_1_47))) : (var_1_63 == ((double) (min (var_1_34 , ((max (var_1_64 , var_1_49)) - var_1_8)))))) : (var_1_63 == ((double) var_1_8))) : ((var_1_43 > var_1_99) ? ((var_1_31 || (var_1_79 < var_1_90)) ? (var_1_63 == ((double) (max (var_1_34 , ((abs (var_1_65)) + var_1_47))))) : 1) : (var_1_63 == ((double) (var_1_35 + (min (var_1_34 , var_1_66)))))))) && (var_1_67 == ((unsigned long int) (256u + last_1_var_1_67)))) && (var_1_77 ? (var_1_68 == ((unsigned char) (min (var_1_52 , var_1_37)))) : (var_1_68 == ((unsigned char) (var_1_69 - var_1_37))))) && ((! var_1_82) ? (var_1_70 == ((float) (min ((64.6f + var_1_10) , (var_1_64 - var_1_8))))) : (var_1_70 == ((float) (max ((min (var_1_13 , var_1_14)) , var_1_49)))))) && ((2.5f < var_1_42) ? (var_1_71 == ((float) (var_1_47 + var_1_9))) : (var_1_71 == ((float) (max (var_1_47 , (abs (var_1_49 - var_1_35)))))))) && (var_1_31 ? (var_1_72 == ((signed short int) var_1_84)) : 1)) && ((! (var_1_26 >= (var_1_24 & var_1_101))) ? (var_1_73 == ((signed long int) (max (var_1_51 , var_1_101)))) : (var_1_73 == ((signed long int) ((abs (var_1_97)) - var_1_99))))) && (var_1_58 ? (var_1_21 ? (((var_1_26 << (var_1_75 + var_1_76)) == var_1_55) ? (var_1_74 == ((unsigned short int) ((var_1_52 + (var_1_62 + var_1_51)) + (min (var_1_27 , var_1_6))))) : 1) : (var_1_74 == ((unsigned short int) var_1_75))) : (var_1_74 == ((unsigned short int) (max ((var_1_52 + var_1_95) , (max (var_1_54 , (var_1_26 + var_1_75))))))))) && ((! var_1_58) ? ((var_1_58 && (var_1_73 >= (var_1_72 * var_1_52))) ? (var_1_77 == ((unsigned char) (! var_1_53))) : (var_1_77 == ((unsigned char) (var_1_82 || var_1_58)))) : ((-10000000 <= (var_1_22 / var_1_56)) ? (var_1_77 == ((unsigned char) var_1_58)) : (((var_1_62 % var_1_25) < var_1_1) ? (var_1_77 == ((unsigned char) var_1_21)) : (var_1_77 == ((unsigned char) (! (! var_1_31)))))))) && (((abs (128 + var_1_76)) >= var_1_67) ? (var_1_78 == ((unsigned char) (! var_1_58))) : 1)) && ((var_1_64 <= (var_1_47 + (var_1_9 * var_1_70))) ? ((var_1_57 && var_1_30) ? (var_1_79 == ((double) 25.75)) : 1) : (var_1_79 == ((double) var_1_49)))) && (var_1_80 == ((signed char) (max ((max (var_1_81 , var_1_54)) , var_1_76))))) && ((last_1_var_1_30 || last_1_var_1_82) ? ((last_1_var_1_98 <= var_1_51) ? (var_1_82 == ((unsigned char) (! (last_1_var_1_50 || var_1_21)))) : 1) : (var_1_82 == ((unsigned char) (var_1_53 && ((last_1_var_1_55 < var_1_26) && var_1_31)))))) && (var_1_84 == ((signed short int) (((max (var_1_62 , var_1_101)) - (10 + var_1_28)) + (max (-1 , var_1_76)))))) && ((var_1_99 <= var_1_62) ? (var_1_85 == ((unsigned long int) ((max (var_1_18 , (4125009469u - var_1_27))) - var_1_97))) : 1)) && (var_1_30 ? (var_1_86 == ((signed char) var_1_81)) : ((var_1_80 < var_1_1) ? (((var_1_67 * var_1_100) <= (128 + (var_1_38 + var_1_24))) ? (var_1_86 == ((signed char) var_1_76)) : (var_1_86 == ((signed char) (var_1_76 + var_1_75)))) : 1))) && (((~ var_1_75) > (var_1_37 ^ var_1_16)) ? (var_1_89 == ((double) (var_1_47 + ((var_1_9 - var_1_10) - var_1_35)))) : (var_1_89 == ((double) (var_1_13 - var_1_14))))) && (var_1_90 == ((double) (min ((var_1_10 - (var_1_8 - var_1_9)) , (var_1_64 - (min (var_1_14 , var_1_35)))))))) && (var_1_50 ? (var_1_91 == ((signed char) var_1_92)) : (var_1_91 == ((signed char) ((min (var_1_62 , var_1_75)) - var_1_76))))) && (var_1_111 ? (var_1_93 == ((double) var_1_49)) : (var_1_93 == ((double) var_1_48)))) && (var_1_78 ? (var_1_94 == ((unsigned char) var_1_26)) : (var_1_94 == ((unsigned char) var_1_52)))) && (var_1_50 ? (var_1_95 == ((unsigned char) var_1_69)) : 1)) && (var_1_57 ? (var_1_96 == ((unsigned long int) var_1_25)) : (var_1_96 == ((unsigned long int) var_1_24)))) && (var_1_58 ? (var_1_97 == ((unsigned short int) var_1_27)) : 1)) && (var_1_98 == ((unsigned long int) var_1_5))) && (last_1_var_1_77 ? (var_1_99 == ((unsigned long int) var_1_56)) : (var_1_99 == ((unsigned long int) last_1_var_1_36)))) && (var_1_100 == ((signed long int) last_1_var_1_100))) && (var_1_31 ? (var_1_101 == ((signed short int) 2)) : 1)) && (var_1_30 ? (var_1_102 == ((double) var_1_48)) : (var_1_102 == ((double) var_1_9)))) && (var_1_103 == ((signed short int) var_1_25))) && (var_1_104 == ((double) 2.3))) && (var_1_50 ? (var_1_105 == ((float) var_1_65)) : 1)) && (var_1_106 == ((double) var_1_13))) && (var_1_57 ? (var_1_107 == ((signed short int) -50)) : (var_1_107 == ((signed short int) var_1_16)))) && ((! var_1_21) ? (var_1_108 == ((signed char) (var_1_54 - var_1_75))) : 1)) && (var_1_109 == ((signed char) (var_1_75 + var_1_76)))) && (var_1_110 == ((signed long int) var_1_99))) && (var_1_111 == ((unsigned char) var_1_21))) && (var_1_112 == ((signed long int) 16))
;
}
int main(void) {
	isInitial = 1;
