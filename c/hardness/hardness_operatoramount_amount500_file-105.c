...
void step(void) {
	// From: Req32Batch105Amount500
	signed long int stepLocal_28 = var_1_3 - var_1_5;
	if (-16 >= stepLocal_28) {
		var_1_87 = (max ((min (var_1_72 , var_1_13)) , var_1_5));
	} else {
		var_1_87 = (min ((abs (8u)) , (var_1_28 - last_1_var_1_98)));
	}


	// From: Req14Batch105Amount500
	...
	// From: Req46Batch105Amount500
	signed long int stepLocal_30 = var_1_65 / var_1_46;
	if (last_1_var_1_62 <= stepLocal_30) {
		var_1_102 = (max (((var_1_22 - var_1_23) + var_1_103) , (abs (var_1_47 + var_1_21))));
	} else {
		var_1_102 = 127.85;
	}


	// From: Req44Batch105Amount500
	var_1_100 = var_1_51;


	// From: Req29Batch105Amount500
	...
	if ((last_1_var_1_102 >= var_1_20) && stepLocal_26) {
		...
		if (stepLocal_25 != last_1_var_1_81) {
			var_1_81 = (min (var_1_30 , var_1_18));
		}
	}


	// From: Req13Batch105Amount500
	if (((32.5f + var_1_21) - var_1_23) < (last_1_var_1_97 + (last_1_var_1_44 * last_1_var_1_54))) {
		if (((var_1_5 << last_1_var_1_75) > last_1_var_1_62) && var_1_26) {
			if (var_1_33 > ((last_1_var_1_36 / var_1_19) % (max (var_1_18 , var_1_46)))) {
	...
	// From: Req17Batch105Amount500
	if (var_1_25) {
		if (var_1_48 < var_1_23) {
			var_1_54 = (max ((max ((var_1_48 + var_1_49) , 1.9)) , var_1_20));
		} else {
			if ((var_1_30 * (var_1_31 % var_1_9)) != ((8 >> var_1_50) * (abs (last_1_var_1_36)))) {
	...
	// From: Req36Batch105Amount500
	if (var_1_24) {
		var_1_91 = var_1_3;
	}


	// From: Req2Batch105Amount500
	if (var_1_4 <= var_1_3) {
	...
	// From: Req6Batch105Amount500
	signed char stepLocal_5 = var_1_11;
	signed long int stepLocal_4 = abs (var_1_9);
	if (stepLocal_5 >= var_1_5) {
		var_1_29 = (min (var_1_4 , ((var_1_13 + var_1_30) + 128)));
	} else {
		if (var_1_20 < var_1_23) {
			var_1_29 = (var_1_31 + var_1_3);
		} else {
			if (99.2f > (max (var_1_21 , var_1_23))) {
	...
	// From: Req7Batch105Amount500
	signed long int stepLocal_6 = var_1_4 - var_1_31;
	if ((128 - var_1_13) <= stepLocal_6) {
		var_1_32 = (max ((var_1_14 + var_1_33) , (var_1_11 - var_1_13)));
	} else {
		var_1_32 = (abs (var_1_13 - var_1_34));
	}


	// From: Req8Batch105Amount500
	...
	// From: Req16Batch105Amount500
	if (var_1_46 < var_1_28) {
		var_1_53 = ((var_1_50 + var_1_5) + 64u);
	}


	// From: Req19Batch105Amount500
	var_1_56 = (var_1_23 + var_1_48);


	// From: Req26Batch105Amount500
		...
		if (var_1_59) {
			if (stepLocal_23 < var_1_14) {
				...
				if (var_1_45) {
					...
					var_1_77 = (max ((var_1_78 + var_1_65) , var_1_79));
				}
			}
		} else {
	...
	// From: Req30Batch105Amount500
	if (var_1_58 <= var_1_102) {
		var_1_84 = ((min (10 , var_1_66)) + var_1_65);
	} else {
		var_1_84 = (var_1_12 - var_1_65);
	}


	// From: Req35Batch105Amount500
	var_1_90 = 0;


	// From: Req37Batch105Amount500
	var_1_92 = var_1_79;


	// From: Req38Batch105Amount500
	if (last_1_var_1_93) {
		var_1_93 = var_1_26;
	} else {
		var_1_93 = var_1_43;
	...
	// From: Req39Batch105Amount500
	var_1_94 = var_1_20;


	// From: Req41Batch105Amount500
	if (var_1_93) {
		var_1_97 = var_1_22;
	} else {
		var_1_97 = var_1_49;
	...
	// From: Req43Batch105Amount500
	if (var_1_42) {
		var_1_99 = var_1_3;
	}


	// From: Req45Batch105Amount500
	if (var_1_42) {
		var_1_101 = (var_1_65 + var_1_66);
	} else {
		var_1_101 = (min (var_1_39 , (var_1_13 - (max (var_1_34 , var_1_65)))));
	}


	// From: Req20Batch105Amount500
	...
	if (stepLocal_14 || (var_1_87 >= var_1_51)) {
		...
		if (((var_1_9 + var_1_3) - var_1_37) >= stepLocal_15) {
			...
			if ((- var_1_102) > last_1_var_1_57) {
				...
				var_1_57 = (max (var_1_22 , var_1_58));
			}
		}
	}


	// From: Req12Batch105Amount500
	...
	// From: Req1Batch105Amount500
	if (! var_1_41) {
		var_1_1 = ((min (var_1_3 , var_1_4)) + (max (10 , var_1_5)));
	} else {
		if (((max (31.25f , 64.6f)) * var_1_97) > var_1_44) {
	...
	// From: Req15Batch105Amount500
	signed char stepLocal_13 = var_1_46;
	unsigned long int stepLocal_12 = - var_1_53;
	if (stepLocal_12 < var_1_30) {
		if (var_1_1 > stepLocal_13) {
			var_1_52 = (var_1_28 - ((abs (var_1_37)) - var_1_81));
		} else {
			var_1_52 = (abs (var_1_37));
		}
	}


	// From: Req22Batch105Amount500
	if (var_1_22 >= ((var_1_54 + var_1_44) + var_1_58)) {
		var_1_61 = ((min (var_1_23 , 255.6f)) - (max (var_1_48 , 128.75f)));
	}


	// From: Req18Batch105Amount500
	if (var_1_57 > var_1_47) {
		var_1_55 = (min (((var_1_28 - var_1_13) - 256u) , var_1_9));
	}


	// From: Req34Batch105Amount500
	if (var_1_24) {
		var_1_89 = var_1_36;
	} else {
		var_1_89 = var_1_73;
	...
	// From: Req5Batch105Amount500
	unsigned short int stepLocal_3 = var_1_9;
	if ((max (var_1_21 , (var_1_22 / 63.25f))) >= var_1_23) {
	...
	// From: Req11Batch105Amount500
	if ((var_1_44 != var_1_54) && (var_1_26 || var_1_90)) {
		var_1_40 = (var_1_3 + (abs (var_1_5)));
	} else {
		if (var_1_39 > var_1_81) {
			var_1_40 = (var_1_34 + (max (50 , var_1_3)));
		} else {
			var_1_40 = 0;
		}
	}
	...
	// From: Req27Batch105Amount500
	if (var_1_93) {
		var_1_75 = (min (var_1_34 , var_1_65));
	} else {
		var_1_75 = (var_1_5 + (min (var_1_65 , var_1_30)));
	}


	// From: Req40Batch105Amount500
	if (var_1_41) {
		var_1_95 = var_1_53;
	} else {
		var_1_95 = var_1_96;
		...
		if (var_1_93) {
			if (var_1_14 != stepLocal_16) {
				if (stepLocal_20 || var_1_25) {
					if ((var_1_21 - (min (var_1_20 , var_1_22))) <= 50.25) {
						var_1_67 = (var_1_68 - (max (var_1_52 , var_1_71)));
					} else {
						if (stepLocal_21 != var_1_68) {
							var_1_67 = (abs (var_1_5));
						} else {
							var_1_67 = (min ((min ((var_1_72 + var_1_34) , var_1_13)) , ((min (var_1_52 , var_1_71)) + var_1_4)));
						}
					}
				}
			} else {
				if (var_1_20 >= (- (200.1 + var_1_57))) {
					var_1_67 = ((abs (var_1_5)) + (var_1_37 - var_1_31));
				} else {
	...
	// From: Req42Batch105Amount500
	if (var_1_59) {
		var_1_98 = var_1_67;
	}


	// From: Req3Batch105Amount500
	signed char stepLocal_1 = var_1_11;
	unsigned long int stepLocal_0 = var_1_17 - var_1_4;
	if (stepLocal_0 > (var_1_3 + var_1_9)) {
		if (stepLocal_1 == (var_1_100 / (max (var_1_18 , var_1_19)))) {
			if (var_1_59) {
				var_1_16 = (var_1_20 - (var_1_21 + (max (var_1_22 , var_1_23))));
			} else {
	...
	// From: Req33Batch105Amount500
	unsigned long int stepLocal_29 = max (var_1_68 , var_1_67);
	...
	// From: Req31Batch105Amount500
	unsigned long int stepLocal_27 = var_1_72 << var_1_99;
	if (((min (var_1_28 , var_1_36)) + var_1_67) != stepLocal_27) {
		if (var_1_43) {
			var_1_85 = (max (var_1_39 , var_1_65));
		} else {
			var_1_85 = var_1_50;
		}
	} else {
		var_1_85 = (abs (max (var_1_14 , (var_1_34 - var_1_13))));
	}


	// From: Req23Batch105Amount500
	if ((var_1_47 >= var_1_102) && var_1_93) {
		if ((128u * var_1_88) < var_1_34) {
			var_1_62 = (var_1_28 - var_1_9);
		}
	} else {
		if (var_1_48 != (max ((var_1_20 / var_1_63) , var_1_102))) {
			if (((var_1_54 / var_1_63) * var_1_16) >= var_1_49) {
				var_1_62 = (max (var_1_28 , (min (var_1_3 , var_1_50))));
			} else {
				var_1_62 = ((max (var_1_88 , var_1_13)) + var_1_3);
			}
		} else {
			if (0 <= var_1_101) {
				var_1_62 = (max (var_1_36 , (min (var_1_9 , var_1_5))));
			} else {
				var_1_62 = var_1_50;
			}
		}
	...
	// From: Req24Batch105Amount500
	if (var_1_49 <= (var_1_48 - var_1_22)) {
		var_1_64 = var_1_14;
	} else {
		if (var_1_24 && var_1_45) {
			if (var_1_99 <= var_1_4) {
				var_1_64 = (min (-5 , var_1_12));
			} else {
			...
			var_1_64 = (min ((max (var_1_65 , var_1_66)) , var_1_13));
		}
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((! var_1_41) ? (var_1_1 == ((unsigned short int) ((min (var_1_3 , var_1_4)) + (max (10 , var_1_5))))) : ((((max (31.25f , 64.6f)) * var_1_97) > var_1_44) ? ((var_1_97 > var_1_54) ? (var_1_1 == ((unsigned short int) (max (8 , 16)))) : 1) : ((var_1_97 >= (var_1_44 * var_1_54)) ? (var_1_1 == ((unsigned short int) (var_1_9 - (max (var_1_3 , var_1_4))))) : 1))) && ((var_1_4 <= var_1_3) ? ((1 > (max ((min (var_1_9 , -256)) , var_1_4))) ? (var_1_10 == ((signed char) ((min (var_1_11 , var_1_12)) - var_1_13))) : (var_1_10 == ((signed char) (min ((var_1_14 + -16) , var_1_12))))) : ((var_1_59 && var_1_24) ? (var_1_10 == ((signed char) (abs (var_1_11)))) : (var_1_10 == ((signed char) (var_1_11 - var_1_13)))))) && (((var_1_17 - var_1_4) > (var_1_3 + var_1_9)) ? ((var_1_11 == (var_1_100 / (max (var_1_18 , var_1_19)))) ? (var_1_59 ? (var_1_16 == ((double) (var_1_20 - (var_1_21 + (max (var_1_22 , var_1_23)))))) : ((var_1_44 <= var_1_61) ? (var_1_59 ? (var_1_16 == ((double) var_1_23)) : (var_1_16 == ((double) var_1_22))) : (var_1_16 == ((double) var_1_21)))) : 1) : (var_1_16 == ((double) var_1_21)))) && ((last_1_var_1_59 || last_1_var_1_41) ? (var_1_24 == ((unsigned char) (var_1_25 && ((var_1_12 >= var_1_17) || var_1_26)))) : 1)) && (((max (var_1_21 , (var_1_22 / 63.25f))) >= var_1_23) ? ((var_1_9 >= var_1_4) ? (var_1_25 ? (var_1_27 == ((unsigned long int) ((var_1_28 - 64u) - ((1807711177u - var_1_3) - var_1_55)))) : 1) : (var_1_27 == ((unsigned long int) (var_1_55 + var_1_4)))) : ((! var_1_59) ? (var_1_27 == ((unsigned long int) var_1_5)) : (var_1_27 == ((unsigned long int) var_1_55))))) && ((var_1_11 >= var_1_5) ? (var_1_29 == ((unsigned short int) (min (var_1_4 , ((var_1_13 + var_1_30) + 128))))) : ((var_1_20 < var_1_23) ? (var_1_29 == ((unsigned short int) (var_1_31 + var_1_3))) : ((99.2f > (max (var_1_21 , var_1_23))) ? ((var_1_54 <= var_1_20) ? (((- (- 128)) > (abs (var_1_9))) ? (var_1_29 == ((unsigned short int) (var_1_9 - var_1_4))) : (var_1_29 == ((unsigned short int) (var_1_3 + (var_1_13 + var_1_30))))) : (var_1_29 == ((unsigned short int) var_1_31))) : (var_1_29 == ((unsigned short int) var_1_5)))))) && (((128 - var_1_13) <= (var_1_4 - var_1_31)) ? (var_1_32 == ((signed char) (max ((var_1_14 + var_1_33) , (var_1_11 - var_1_13))))) : (var_1_32 == ((signed char) (abs (var_1_13 - var_1_34)))))) && ((0 == (var_1_51 * var_1_28)) ? (var_1_35 == ((signed short int) ((var_1_13 + 16) + var_1_12))) : 1)) && ((var_1_9 > (last_1_var_1_62 + var_1_34)) ? (last_1_var_1_24 ? (var_1_36 == ((unsigned long int) (var_1_28 - var_1_5))) : (var_1_36 == ((unsigned long int) (var_1_28 - (var_1_37 - var_1_31))))) : (var_1_36 == ((unsigned long int) 8u)))) && (((var_1_13 + var_1_27) == (2u ^ var_1_31)) ? ((var_1_102 > var_1_20) ? (var_1_38 == ((signed char) (min (var_1_13 , var_1_39)))) : 1) : ((var_1_23 < var_1_21) ? (var_1_38 == ((signed char) var_1_13)) : 1))) && (((var_1_44 != var_1_54) && (var_1_26 || var_1_90)) ? (var_1_40 == ((unsigned short int) (var_1_3 + (abs (var_1_5))))) : ((var_1_39 > var_1_81) ? (var_1_40 == ((unsigned short int) (var_1_34 + (max (50 , var_1_3))))) : (var_1_40 == ((unsigned short int) 0))))) && ((var_1_93 && var_1_25) ? (var_1_41 == ((unsigned char) (var_1_93 && (var_1_42 || var_1_43)))) : (var_1_41 == ((unsigned char) ((var_1_81 == var_1_34) || var_1_25))))) && ((((32.5f + var_1_21) - var_1_23) < (last_1_var_1_97 + (last_1_var_1_44 * last_1_var_1_54))) ? ((((var_1_5 << last_1_var_1_75) > last_1_var_1_62) && var_1_26) ? ((var_1_33 > ((last_1_var_1_36 / var_1_19) % (max (var_1_18 , var_1_46)))) ? ((last_1_var_1_44 >= (- var_1_22)) ? (var_1_44 == ((float) (((2.9739596464057037E18f - var_1_47) - (var_1_48 + var_1_49)) + var_1_21))) : 1) : ((var_1_46 < ((var_1_12 & last_1_var_1_89) * (var_1_13 >> var_1_50))) ? (var_1_44 == ((float) (var_1_21 - var_1_22))) : 1)) : 1) : 1)) && ((var_1_87 >= (- last_1_var_1_51)) ? (var_1_51 == ((unsigned long int) (var_1_28 - var_1_4))) : 1)) && (((- var_1_53) < var_1_30) ? ((var_1_1 > var_1_46) ? (var_1_52 == ((unsigned long int) (var_1_28 - ((abs (var_1_37)) - var_1_81)))) : (var_1_52 == ((unsigned long int) (abs (var_1_37))))) : 1)) && ((var_1_46 < var_1_28) ? (var_1_53 == ((unsigned long int) ((var_1_50 + var_1_5) + 64u))) : 1)) && (var_1_25 ? ((var_1_48 < var_1_23) ? (var_1_54 == ((double) (max ((max ((var_1_48 + var_1_49) , 1.9)) , var_1_20)))) : (((var_1_30 * (var_1_31 % var_1_9)) != ((8 >> var_1_50) * (abs (last_1_var_1_36)))) ? (var_1_54 == ((double) ((var_1_49 - var_1_22) + var_1_21))) : (((var_1_11 ^ last_1_var_1_87) > last_1_var_1_91) ? (var_1_54 == ((double) var_1_20)) : (var_1_54 == ((double) var_1_23))))) : 1)) && ((var_1_57 > var_1_47) ? (var_1_55 == ((unsigned long int) (min (((var_1_28 - var_1_13) - 256u) , var_1_9)))) : 1)) && (var_1_56 == ((float) (var_1_23 + var_1_48)))) && ((var_1_59 || (var_1_87 >= var_1_51)) ? (var_1_57 == ((double) (var_1_47 - 4.4))) : ((((var_1_9 + var_1_3) - var_1_37) >= var_1_50) ? (var_1_57 == ((double) (var_1_47 - var_1_23))) : (((- var_1_102) > last_1_var_1_57) ? (var_1_57 == ((double) (var_1_48 + var_1_22))) : (var_1_57 == ((double) (max (var_1_22 , var_1_58)))))))) && ((last_1_var_1_55 >= last_1_var_1_67) ? ((var_1_39 >= var_1_37) ? ((last_1_var_1_24 || var_1_26) ? (var_1_59 == ((unsigned char) (var_1_43 || (! (! var_1_42))))) : (var_1_59 == ((unsigned char) var_1_43))) : 1) : (var_1_59 == ((unsigned char) (((var_1_58 > var_1_22) && (64 < last_1_var_1_53)) && (var_1_43 && var_1_42)))))) && ((var_1_22 >= ((var_1_54 + var_1_44) + var_1_58)) ? (var_1_61 == ((float) ((min (var_1_23 , 255.6f)) - (max (var_1_48 , 128.75f))))) : 1)) && (((var_1_47 >= var_1_102) && var_1_93) ? (((128u * var_1_88) < var_1_34) ? (var_1_62 == ((unsigned long int) (var_1_28 - var_1_9))) : 1) : ((var_1_48 != (max ((var_1_20 / var_1_63) , var_1_102))) ? ((((var_1_54 / var_1_63) * var_1_16) >= var_1_49) ? (var_1_62 == ((unsigned long int) (max (var_1_28 , (min (var_1_3 , var_1_50)))))) : (var_1_62 == ((unsigned long int) ((max (var_1_88 , var_1_13)) + var_1_3)))) : ((0 <= var_1_101) ? (var_1_62 == ((unsigned long int) (max (var_1_36 , (min (var_1_9 , var_1_5)))))) : (var_1_62 == ((unsigned long int) var_1_50)))))) && ((var_1_49 <= (var_1_48 - var_1_22)) ? (var_1_64 == ((signed char) var_1_14)) : ((var_1_24 && var_1_45) ? ((var_1_99 <= var_1_4) ? (var_1_64 == ((signed char) (min (-5 , var_1_12)))) : ((var_1_52 < var_1_62) ? (var_1_64 == ((signed char) (abs (var_1_33)))) : (var_1_64 == ((signed char) (var_1_65 + var_1_33))))) : (var_1_64 == ((signed char) (min ((max (var_1_65 , var_1_66)) , var_1_13))))))) && ((var_1_52 > last_1_var_1_67) ? ((var_1_53 <= var_1_9) ? (var_1_67 == ((unsigned long int) (var_1_68 - var_1_37))) : ((var_1_52 == last_1_var_1_67) ? (var_1_67 == ((unsigned long int) var_1_3)) : (var_1_67 == ((unsigned long int) (var_1_28 - var_1_9))))) : (var_1_93 ? ((var_1_14 != var_1_52) ? ((var_1_45 || var_1_25) ? (((var_1_21 - (min (var_1_20 , var_1_22))) <= 50.25) ? (var_1_67 == ((unsigned long int) (var_1_68 - (max (var_1_52 , var_1_71))))) : ((var_1_3 != var_1_68) ? (var_1_67 == ((unsigned long int) (abs (var_1_5)))) : (var_1_67 == ((unsigned long int) (min ((min ((var_1_72 + var_1_34) , var_1_13)) , ((min (var_1_52 , var_1_71)) + var_1_4))))))) : 1) : ((var_1_20 >= (- (200.1 + var_1_57))) ? (var_1_67 == ((unsigned long int) ((abs (var_1_5)) + (var_1_37 - var_1_31)))) : (var_1_67 == ((unsigned long int) ((var_1_37 - var_1_50) + ((var_1_73 - last_1_var_1_67) + var_1_4)))))) : (var_1_67 == ((unsigned long int) var_1_71))))) && ((var_1_46 <= 32) ? (var_1_74 == ((unsigned char) (16 + (100 - var_1_65)))) : (var_1_74 == ((unsigned char) ((var_1_50 + var_1_65) + var_1_34))))) && (var_1_93 ? (var_1_75 == ((unsigned short int) (min (var_1_34 , var_1_65)))) : (var_1_75 == ((unsigned short int) (var_1_5 + (min (var_1_65 , var_1_30))))))) && ((var_1_45 && var_1_42) ? (var_1_59 ? (((var_1_81 * -1000000) < var_1_14) ? (var_1_77 == ((unsigned char) var_1_34)) : (var_1_45 ? (var_1_77 == ((unsigned char) var_1_65)) : (var_1_77 == ((unsigned char) (max ((var_1_78 + var_1_65) , var_1_79)))))) : (var_1_77 == ((unsigned char) (var_1_80 - (var_1_50 + var_1_65))))) : 1)) && (((last_1_var_1_102 >= var_1_20) && (var_1_26 && (var_1_5 > var_1_28))) ? (var_1_81 == ((signed long int) (var_1_30 - (var_1_78 + last_1_var_1_81)))) : ((var_1_78 != last_1_var_1_81) ? (var_1_81 == ((signed long int) (min (var_1_30 , var_1_18)))) : 1))) && ((var_1_58 <= var_1_102) ? (var_1_84 == ((signed char) ((min (10 , var_1_66)) + var_1_65))) : (var_1_84 == ((signed char) (var_1_12 - var_1_65))))) && ((((min (var_1_28 , var_1_36)) + var_1_67) != (var_1_72 << var_1_99)) ? (var_1_43 ? (var_1_85 == ((signed char) (max (var_1_39 , var_1_65)))) : (var_1_85 == ((signed char) var_1_50))) : (var_1_85 == ((signed char) (abs (max (var_1_14 , (var_1_34 - var_1_13)))))))) && ((-16 >= (var_1_3 - var_1_5)) ? (var_1_87 == ((unsigned long int) (max ((min (var_1_72 , var_1_13)) , var_1_5)))) : (var_1_87 == ((unsigned long int) (min ((abs (8u)) , (var_1_28 - last_1_var_1_98))))))) && (((max (var_1_68 , var_1_67)) >= var_1_4) ? (var_1_88 == ((unsigned long int) var_1_81)) : (var_1_88 == ((unsigned long int) var_1_50)))) && (var_1_24 ? (var_1_89 == ((signed long int) var_1_36)) : (var_1_89 == ((signed long int) var_1_73)))) && (var_1_90 == ((unsigned char) 0))) && (var_1_24 ? (var_1_91 == ((signed long int) var_1_3)) : 1)) && (var_1_92 == ((unsigned char) var_1_79))) && (last_1_var_1_93 ? (var_1_93 == ((unsigned char) var_1_26)) : (var_1_93 == ((unsigned char) var_1_43)))) && (var_1_94 == ((double) var_1_20))) && (var_1_41 ? (var_1_95 == ((unsigned long int) var_1_53)) : (var_1_95 == ((unsigned long int) var_1_96)))) && (var_1_93 ? (var_1_97 == ((float) var_1_22)) : (var_1_97 == ((float) var_1_49)))) && (var_1_59 ? (var_1_98 == ((signed short int) var_1_67)) : 1)) && (var_1_42 ? (var_1_99 == ((unsigned long int) var_1_3)) : 1)) && (var_1_100 == ((signed long int) var_1_51))) && (var_1_42 ? (var_1_101 == ((signed char) (var_1_65 + var_1_66))) : (var_1_101 == ((signed char) (min (var_1_39 , (var_1_13 - (max (var_1_34 , var_1_65))))))))) && ((last_1_var_1_62 <= (var_1_65 / var_1_46)) ? (var_1_102 == ((double) (max (((var_1_22 - var_1_23) + var_1_103) , (abs (var_1_47 + var_1_21)))))) : (var_1_102 == ((double) 127.85)))
;
}
int main(void) {
	isInitial = 1;
