...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch181dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req5Batch181dependencies
	if ((last_1_var_1_1 >> 10) < (last_1_var_1_22 / (abs (var_1_16)))) {
	...
	// From: Req4Batch181dependencies
	if (var_1_15) {
		var_1_14 = (max (var_1_10 , var_1_11));
	}


	// From: Req1Batch181dependencies
	if (last_1_var_1_15) {
	...
	// From: Req2Batch181dependencies
	var_1_6 = var_1_7;


	// From: Req7Batch181dependencies
	var_1_24 = (((var_1_25 + var_1_26) - var_1_27) - var_1_28);


	// From: Req6Batch181dependencies
	if (! (! (var_1_6 || var_1_7))) {
	...
	// From: Req3Batch181dependencies
	if ((var_1_9 - (min (var_1_10 , var_1_11))) >= var_1_22) {
