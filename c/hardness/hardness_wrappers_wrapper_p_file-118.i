...
void step(void) {
 ...
 if ((*(var_1_4_Pointer)) == stepLocal_1) {
  (*(var_1_6_Pointer)) = ((((((*(var_1_7_Pointer))) < ((*(var_1_8_Pointer)))) ? ((*(var_1_7_Pointer))) : ((*(var_1_8_Pointer))))) + (((((64 + 8)) > ((*(var_1_9_Pointer)))) ? ((64 + 8)) : ((*(var_1_9_Pointer))))));
 } else {
  (*(var_1_6_Pointer)) = ((*(var_1_7_Pointer)) + 4);
 }
 if (((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))) < (*(var_1_17_Pointer))) {
  if ((*(var_1_14_Pointer)) || ((*(var_1_15_Pointer)) >= (((((*(var_1_4_Pointer))) > ((*(var_1_3_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_3_Pointer))))))) {
...
int property(void) {
 return ((((((*(var_1_15_Pointer)) < 4) ? ((*(var_1_1_Pointer)) == ((signed short int) ((*(var_1_3_Pointer)) + (*(var_1_4_Pointer))))) : ((*(var_1_1_Pointer)) == ((signed short int) ((*(var_1_5_Pointer)) - 5)))) && (((*(var_1_4_Pointer)) == (*(var_1_15_Pointer))) ? ((*(var_1_6_Pointer)) == ((unsigned char) ((((((*(var_1_7_Pointer))) < ((*(var_1_8_Pointer)))) ? ((*(var_1_7_Pointer))) : ((*(var_1_8_Pointer))))) + (((((64 + 8)) > ((*(var_1_9_Pointer)))) ? ((64 + 8)) : ((*(var_1_9_Pointer)))))))) : ((*(var_1_6_Pointer)) == ((unsigned char) ((*(var_1_7_Pointer)) + 4))))) && ((((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))) < (*(var_1_17_Pointer))) ? (((*(var_1_14_Pointer)) || ((*(var_1_15_Pointer)) >= (((((*(var_1_4_Pointer))) > ((*(var_1_3_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_3_Pointer))))))) ? (((*(var_1_12_Pointer)) >= 127.25f) ? ((*(var_1_10_Pointer)) == ((signed short int) (*(var_1_3_Pointer)))) : 1) : 1) : ((*(var_1_10_Pointer)) == ((signed short int) 16)))) && (((*(var_1_14_Pointer)) && (*(var_1_16_Pointer))) ? ((*(var_1_15_Pointer)) == ((signed long int) (*(var_1_8_Pointer)))) : 1)) && ((*(var_1_17_Pointer)) == ((double) (*(var_1_18_Pointer))))
;
}
int main(void) {
 isInitial = 1;
