...
void step(void) {
 ...
 if ((~ (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))) < (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var0_Pointer))) {
  (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) = (((((last_1_signed_long_int_Array_0_0_) > (((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) - last_1_signed_long_int_Array_0_1_))) ? (last_1_signed_long_int_Array_0_0_) : (((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) - last_1_signed_long_int_Array_0_1_)))) + ((((last_1_signed_long_int_Array_0_1_) > ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)))) ? (last_1_signed_long_int_Array_0_1_) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer))))));
 } else {
  (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) = ((((((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))) > (last_1_signed_long_int_Array_0_0_)) ? ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer))) : (last_1_signed_long_int_Array_0_0_))) + (*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var1_Pointer)));
 }
