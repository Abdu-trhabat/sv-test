...
void step(void) {
	// From: Req1Batch132Wrapper_P
	if (128 <= (*(var_1_2_Pointer))) {
		(*(var_1_1_Pointer)) = 25;
	}


	// From: Req2Batch132Wrapper_P
	if ((*(var_1_4_Pointer))) {
	...
	// From: Req3Batch132Wrapper_P
	if ((*(var_1_4_Pointer)) || (*(var_1_9_Pointer))) {
		(*(var_1_8_Pointer)) = (abs (min ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer)))));
	} else {
		(*(var_1_8_Pointer)) = (*(var_1_10_Pointer));
	}


	// From: Req4Batch132Wrapper_P
	...
	if (7.2 < (*(var_1_6_Pointer))) {
		if (((*(var_1_13_Pointer)) - ((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) >= stepLocal_0) {
			...
			(*(var_1_12_Pointer)) = ((max ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))) - ((*(var_1_16_Pointer)) - (*(var_1_15_Pointer))));
		}
	}


	// From: Req5Batch132Wrapper_P
...
int property(void) {
	return (((((128 <= (*(var_1_2_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) 25)) : 1) && ((*(var_1_4_Pointer)) ? ((*(var_1_3_Pointer)) == ((double) (*(var_1_5_Pointer)))) : ((*(var_1_3_Pointer)) == ((double) ((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))))))) && (((*(var_1_4_Pointer)) || (*(var_1_9_Pointer))) ? ((*(var_1_8_Pointer)) == ((unsigned short int) (abs (min ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer))))))) : ((*(var_1_8_Pointer)) == ((unsigned short int) (*(var_1_10_Pointer)))))) && ((7.2 < (*(var_1_6_Pointer))) ? ((((*(var_1_13_Pointer)) - ((*(var_1_14_Pointer)) + (*(var_1_15_Pointer)))) >= (1000 - (*(var_1_11_Pointer)))) ? ((*(var_1_12_Pointer)) == ((signed short int) (abs ((*(var_1_14_Pointer)))))) : ((*(var_1_12_Pointer)) == ((signed short int) ((max ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))) - ((*(var_1_16_Pointer)) - (*(var_1_15_Pointer))))))) : 1)) && (((*(var_1_8_Pointer)) > ((- 128) + (*(var_1_16_Pointer)))) ? ((*(var_1_17_Pointer)) == ((signed char) (*(var_1_15_Pointer)))) : 1)
;
}
int main(void) {
	isInitial = 1;
