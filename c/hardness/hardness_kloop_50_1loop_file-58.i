...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch5850_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_0 >= var_1_3) {
  var_1_14 = ((((last_1_var_1_14) < (var_1_1)) ? (last_1_var_1_14) : (var_1_1)));
 } else {
  var_1_14 = (32 + var_1_1);
 }
 var_1_18 = var_1_1;
 ...
 if (stepLocal_1 || (((((var_1_14) > (var_1_3)) ? (var_1_14) : (var_1_3))) < ((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))))) {
  var_1_15 = ((((1u) > (var_1_17)) ? (1u) : (var_1_17)));
 } else {
  var_1_15 = 32u;
 }
}
...
int property(void) {
 return ((((((((last_1_var_1_17 / var_1_3) <= 2) ? ((var_1_3 < (((((~ last_1_var_1_17)) < (last_1_var_1_14)) ? ((~ last_1_var_1_17)) : (last_1_var_1_14)))) ? (var_1_1 == ((unsigned char) ((((var_1_5) < (16)) ? (var_1_5) : (16))))) : ((((var_1_6 || var_1_7) && var_1_8) || var_1_9) ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_1 == ((unsigned char) 32)))) : (var_1_1 == ((unsigned char) var_1_5))) && ((last_1_var_1_1 <= var_1_5) ? (var_1_10 == ((unsigned char) (last_1_var_1_19 || ((var_1_3 != var_1_5) || var_1_11)))) : (var_1_10 == ((unsigned char) (var_1_12 || var_1_13))))) && ((var_1_5 >= var_1_3) ? (var_1_14 == ((signed long int) ((((last_1_var_1_14) < (var_1_1)) ? (last_1_var_1_14) : (var_1_1))))) : (var_1_14 == ((signed long int) (32 + var_1_1))))) && ((var_1_10 || (((((var_1_14) > (var_1_3)) ? (var_1_14) : (var_1_3))) < ((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))))) ? (var_1_15 == ((unsigned long int) ((((1u) > (var_1_17)) ? (1u) : (var_1_17))))) : (var_1_15 == ((unsigned long int) 32u)))) && ((var_1_14 < (32 / var_1_3)) ? ((var_1_10 || var_1_19) ? (var_1_17 == ((unsigned long int) var_1_18)) : 1) : 1)) && (var_1_18 == ((unsigned short int) var_1_1))) && (((last_1_var_1_18 + last_1_var_1_17) < 1) ? (var_1_12 ? (last_1_var_1_10 ? (var_1_19 == ((unsigned char) var_1_11)) : 1) : 1) : 1)
;
}
int main(void) {
 isInitial = 1;
