...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch1Filler_PE_CO
	/* 946L, 244L, 770L, 776L) */ var_1_27 = (
		var_1_21
	);


	// From: Req4Batch1Filler_PE_CO
