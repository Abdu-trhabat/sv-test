...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch158dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch158dependencies
	if (var_1_7 > var_1_9) {
		var_1_18 = var_1_20;
	}


	// From: Req5Batch158dependencies
	var_1_22 = ((var_1_2 && var_1_23) || (! var_1_24));


	// From: Req6Batch158dependencies
	if (var_1_22 || (var_1_17 < var_1_1)) {
		var_1_25 = var_1_14;
	} else {
		if ((var_1_19 * var_1_12) > ((max (var_1_15 , var_1_13)) - var_1_1)) {
	...
	// From: Req7Batch158dependencies
	if (var_1_26 <= (-1 * var_1_12)) {
		var_1_27 = var_1_18;
	}


	// From: Req4Batch158dependencies
	if (var_1_22) {
		if (var_1_17 > -256) {
