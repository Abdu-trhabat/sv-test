...
void step(void) {
 if (8 >= ((*(var_1_2_Pointer)) + (*(var_1_3_Pointer)))) {
  (*(var_1_1_Pointer)) = (((((*(var_1_4_Pointer))) < (((*(var_1_5_Pointer)) + 10))) ? ((*(var_1_4_Pointer))) : (((*(var_1_5_Pointer)) + 10))));
 }
 ...
 if (stepLocal_3 || (! (*(var_1_17_Pointer)))) {
  if (stepLocal_4 < (*(var_1_7_Pointer))) {
   (*(var_1_15_Pointer)) = (((((*(var_1_5_Pointer))) < ((*(var_1_4_Pointer)))) ? ((*(var_1_5_Pointer))) : ((*(var_1_4_Pointer)))));
  } else {
   if ((*(var_1_17_Pointer))) {
 ...
 if ((*(var_1_7_Pointer)) <= stepLocal_2) {
  if ((*(var_1_3_Pointer)) >= stepLocal_1) {
   (*(var_1_9_Pointer)) = ((*(var_1_12_Pointer)) + ((((((((*(var_1_13_Pointer))) < ((*(var_1_14_Pointer)))) ? ((*(var_1_13_Pointer))) : ((*(var_1_14_Pointer))))) < 0 ) ? -(((((*(var_1_13_Pointer))) < ((*(var_1_14_Pointer)))) ? ((*(var_1_13_Pointer))) : ((*(var_1_14_Pointer))))) : (((((*(var_1_13_Pointer))) < ((*(var_1_14_Pointer)))) ? ((*(var_1_13_Pointer))) : ((*(var_1_14_Pointer))))))));
  }
 } else {
...
int property(void) {
 return ((((8 >= ((*(var_1_2_Pointer)) + (*(var_1_3_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed short int) (((((*(var_1_4_Pointer))) < (((*(var_1_5_Pointer)) + 10))) ? ((*(var_1_4_Pointer))) : (((*(var_1_5_Pointer)) + 10)))))) : 1) && (((*(var_1_3_Pointer)) <= (*(var_1_2_Pointer))) ? ((*(var_1_6_Pointer)) == ((unsigned short int) ((*(var_1_7_Pointer)) + (*(var_1_8_Pointer))))) : 1)) && (((*(var_1_7_Pointer)) <= ((*(var_1_6_Pointer)) + (*(var_1_15_Pointer)))) ? (((*(var_1_3_Pointer)) >= (*(var_1_7_Pointer))) ? ((*(var_1_9_Pointer)) == ((double) ((*(var_1_12_Pointer)) + ((((((((*(var_1_13_Pointer))) < ((*(var_1_14_Pointer)))) ? ((*(var_1_13_Pointer))) : ((*(var_1_14_Pointer))))) < 0 ) ? -(((((*(var_1_13_Pointer))) < ((*(var_1_14_Pointer)))) ? ((*(var_1_13_Pointer))) : ((*(var_1_14_Pointer))))) : (((((*(var_1_13_Pointer))) < ((*(var_1_14_Pointer)))) ? ((*(var_1_13_Pointer))) : ((*(var_1_14_Pointer)))))))))) : 1) : ((*(var_1_9_Pointer)) == ((double) ((*(var_1_14_Pointer)) + (*(var_1_12_Pointer))))))) && ((((*(var_1_11_Pointer)) || (*(var_1_16_Pointer))) || (! (*(var_1_17_Pointer)))) ? (((*(var_1_6_Pointer)) < (*(var_1_7_Pointer))) ? ((*(var_1_15_Pointer)) == ((signed short int) (((((*(var_1_5_Pointer))) < ((*(var_1_4_Pointer)))) ? ((*(var_1_5_Pointer))) : ((*(var_1_4_Pointer))))))) : ((*(var_1_17_Pointer)) ? ((*(var_1_15_Pointer)) == ((signed short int) (*(var_1_5_Pointer)))) : 1)) : ((*(var_1_15_Pointer)) == ((signed short int) (*(var_1_5_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
