...
void step(void) {
	...
	// From: Req2Batch185Wrapper_A
	signed short int stepLocal_2 = signed_short_int_Array_0[4];
	if (stepLocal_2 == (min (32 , signed_short_int_Array_0[3]))) {
		if (! BOOL_unsigned_char_Array_0[1]) {
			double_Array_0[3] = ((abs (double_Array_0[2])) - double_Array_0[0]);
		} else {
	...
	// From: Req4Batch185Wrapper_A
	if ((abs (- signed_short_int_Array_0[1])) < ((signed_short_int_Array_0[0] + signed_short_int_Array_0[3]) - (signed_long_int_Array_0[0][0] - signed_long_int_Array_0[1][0]))) {
