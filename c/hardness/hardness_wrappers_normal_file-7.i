...
void step(void) {
 ...
 if (var_1_8) {
  if (stepLocal_0 < (var_1_16 - var_1_9)) {
   var_1_7 = var_1_6;
  }
 }
 unsigned char stepLocal_1 = -256 == (var_1_6 * var_1_16);
 if (var_1_8) {
  if (stepLocal_1 || var_1_11) {
   var_1_10 = ((var_1_12 - var_1_13) - var_1_14);
  } else {
   var_1_10 = ((((var_1_14 - (var_1_13 + var_1_15)) < 0 ) ? -(var_1_14 - (var_1_13 + var_1_15)) : (var_1_14 - (var_1_13 + var_1_15))));
  }
 } else {
  var_1_10 = ((((var_1_12) > (var_1_15)) ? (var_1_12) : (var_1_15)));
 }
 if (! (var_1_10 <= (var_1_3 - var_1_4))) {
  if (-1 < var_1_16) {
   var_1_1 = var_1_6;
  } else {
   var_1_1 = 128;
...
int property(void) {
 return ((((! (var_1_10 <= (var_1_3 - var_1_4))) ? ((-1 < var_1_16) ? (var_1_1 == ((unsigned char) var_1_6)) : (var_1_1 == ((unsigned char) 128))) : (var_1_1 == ((unsigned char) var_1_6))) && (var_1_8 ? (((~ var_1_6) < (var_1_16 - var_1_9)) ? (var_1_7 == ((unsigned short int) var_1_6)) : 1) : 1)) && (var_1_8 ? (((-256 == (var_1_6 * var_1_16)) || var_1_11) ? (var_1_10 == ((float) ((var_1_12 - var_1_13) - var_1_14))) : (var_1_10 == ((float) ((((var_1_14 - (var_1_13 + var_1_15)) < 0 ) ? -(var_1_14 - (var_1_13 + var_1_15)) : (var_1_14 - (var_1_13 + var_1_15))))))) : (var_1_10 == ((float) ((((var_1_12) > (var_1_15)) ? (var_1_12) : (var_1_15))))))) && (var_1_16 == ((unsigned long int) var_1_6))
;
}
int main(void) {
 isInitial = 1;
