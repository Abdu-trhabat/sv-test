...
void step(void) {
	...
	// From: Req2Batch148stepLocals
	var_1_7 = (var_1_8 + (min ((abs (99.4)) , var_1_9)));


	// From: Req3Batch148stepLocals
	if (var_1_1 > var_1_11) {
		if (var_1_2 || var_1_12) {
			var_1_10 = var_1_13;
		}
	...
	// From: Req4Batch148stepLocals
	var_1_14 = ((max (var_1_8 , var_1_9)) + (var_1_15 + (abs (var_1_16))));


	// From: Req5Batch148stepLocals
	var_1_17 = (! var_1_13);


	// From: Req6Batch148stepLocals
	...
	// From: Req9Batch148stepLocals
	var_1_28 = var_1_4;


	// From: Req10Batch148stepLocals
	var_1_29 = var_1_23;


	// From: Req11Batch148stepLocals
	var_1_30 = var_1_11;
}
