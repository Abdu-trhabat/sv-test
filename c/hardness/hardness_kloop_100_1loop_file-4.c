...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_35 > stepLocal_7) {
		...
		if (((max (last_1_var_1_29 , 64)) + (last_1_var_1_7 & last_1_var_1_27)) <= stepLocal_6) {
			var_1_42 = var_1_43;
		}
	}


	// From: Req4Batch4100_1loop
	if (! (last_1_var_1_25 || last_1_var_1_42)) {
		var_1_13 = ((var_1_4 - var_1_5) - var_1_6);
	}


	// From: Req5Batch4100_1loop
	var_1_16 = ((max (var_1_17 , var_1_18)) - (var_1_19 + (var_1_20 - var_1_21)));


	// From: Req6Batch4100_1loop
	...
	// From: Req10Batch4100_1loop
	var_1_30 = ((var_1_31 - var_1_32) - (min (5 , var_1_33)));


	// From: Req1Batch4100_1loop
	...
	// From: Req9Batch4100_1loop
	if ((! (var_1_13 < 16)) && var_1_42) {
		var_1_29 = -32;
	} else {
		var_1_29 = (max (var_1_8 , var_1_13));
	}


	// From: Req2Batch4100_1loop
	...
	// From: Req11Batch4100_1loop
	if (var_1_24 < (var_1_27 * var_1_10)) {
		if (var_1_29 == var_1_27) {
			var_1_34 = (max ((var_1_35 + (max (var_1_32 , var_1_36))) , var_1_31));
		}
	} else {
		var_1_34 = ((max ((var_1_32 + var_1_37) , var_1_38)) - (max ((max (var_1_39 , var_1_40)) , var_1_41)));
	}
}
...
int property(void) {
	return (((((((((((((var_1_22 <= var_1_27) ? (((- var_1_27) > var_1_22) ? (var_1_1 == ((signed short int) ((var_1_4 - var_1_5) - var_1_6))) : 1) : (var_1_1 == ((signed short int) var_1_6))) && ((var_1_13 < var_1_27) ? (var_1_7 == ((signed char) (max (var_1_8 , var_1_9)))) : (var_1_7 == ((signed char) var_1_8)))) && ((var_1_8 <= var_1_27) ? (var_1_10 == ((signed char) -10)) : (((- (var_1_16 / 0.6f)) > var_1_16) ? (var_1_10 == ((signed char) var_1_9)) : (var_1_10 == ((signed char) 1))))) && ((! (last_1_var_1_25 || last_1_var_1_42)) ? (var_1_13 == ((signed short int) ((var_1_4 - var_1_5) - var_1_6))) : 1)) && (var_1_16 == ((float) ((max (var_1_17 , var_1_18)) - (var_1_19 + (var_1_20 - var_1_21)))))) && ((var_1_20 >= (var_1_16 / var_1_23)) ? (((var_1_6 / var_1_24) > var_1_9) ? (var_1_22 == ((unsigned long int) var_1_5)) : 1) : 1)) && ((var_1_27 > ((var_1_45 + var_1_27) * (~ var_1_5))) ? (var_1_25 == ((unsigned char) var_1_26)) : 1)) && (((-5 >= (var_1_8 * var_1_22)) && var_1_26) ? (var_1_27 == ((unsigned long int) 1u)) : 1)) && (((! (var_1_13 < 16)) && var_1_42) ? (var_1_29 == ((signed long int) -32)) : (var_1_29 == ((signed long int) (max (var_1_8 , var_1_13)))))) && (var_1_30 == ((unsigned char) ((var_1_31 - var_1_32) - (min (5 , var_1_33)))))) && ((var_1_24 < (var_1_27 * var_1_10)) ? ((var_1_29 == var_1_27) ? (var_1_34 == ((signed char) (max ((var_1_35 + (max (var_1_32 , var_1_36))) , var_1_31)))) : 1) : (var_1_34 == ((signed char) ((max ((var_1_32 + var_1_37) , var_1_38)) - (max ((max (var_1_39 , var_1_40)) , var_1_41))))))) && ((var_1_35 > last_1_var_1_22) ? ((! var_1_26) ? (var_1_42 == ((unsigned char) (var_1_26 && var_1_43))) : (var_1_42 == ((unsigned char) (((var_1_26 || last_1_var_1_25) && var_1_43) && (last_1_var_1_25 && var_1_44))))) : ((((max (last_1_var_1_29 , 64)) + (last_1_var_1_7 & last_1_var_1_27)) <= last_1_var_1_13) ? (var_1_42 == ((unsigned char) var_1_43)) : 1))) && ((var_1_16 < var_1_20) ? (((~ var_1_4) == var_1_10) ? (var_1_45 == ((unsigned short int) last_1_var_1_45)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
