...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch71Wrapper_S.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (WrapperStruct00.var_1_7) {
		...
		WrapperStruct00.var_1_8 = (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_3);
	}
