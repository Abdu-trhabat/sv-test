...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch179Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch179Amount25
	if (0 <= (var_1_9 + (var_1_8 * var_1_10))) {
		var_1_7 = (var_1_11 - (var_1_12 - var_1_13));
	}


	// From: Req4Batch179Amount25
	var_1_14 = var_1_15;


	// From: Req5Batch179Amount25
	var_1_16 = var_1_13;
}
