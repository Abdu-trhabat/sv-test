...
int property(void) {
	return (((var_1_2 || (16.0f < last_1_var_1_11)) ? ((last_1_var_1_11 >= (- last_1_var_1_11)) ? ((((var_1_5 ^ var_1_6) + (var_1_7 * var_1_8)) <= var_1_9) ? (var_1_1 == ((signed char) var_1_10)) : 1) : 1) : (var_1_1 == ((signed char) 8))) && ((var_1_16 == (var_1_12 - var_1_13)) ? (var_1_2 ? ((var_1_1 < var_1_10) ? (var_1_11 == ((double) (var_1_14 - (abs (var_1_15))))) : (var_1_11 == ((double) var_1_15))) : 1) : (var_1_11 == ((double) var_1_15)))) && ((var_1_12 == var_1_9) ? (var_1_16 == ((signed char) (var_1_17 - var_1_18))) : (var_1_16 == ((signed char) (min (var_1_17 , var_1_10)))))
;
}
int main(void) {
	isInitial = 1;
