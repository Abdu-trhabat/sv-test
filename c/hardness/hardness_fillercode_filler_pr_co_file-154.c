...
void step(void) {
	...
	// From: CodeObject2
	/* 289L, 79L) */ if (var_1_31) {
		/* 291L, 77L) */ if (/* 292L, 58L, 59L) */ (! (var_1_36))) {
			/* 294L, 67L) */ var_1_39 = (
				/* 297L, 66L) */ (abs (
					var_1_40
				))
	...
	// From: CodeObject1
	/* 260L, 50L) */ if (var_1_31) {
		/* 262L, 48L) */ if (/* 263L, 11L, 12L) */ ((/* 264L, 7L, 13L) */ ((var_1_15) * (var_1_1))) <= (/* 267L, 10L, 16L) */ (max (/* 267L, 10L, 16L) */ (var_1_14) , (var_1_1)))))) {
			/* 270L, 40L) */ if (var_1_36) {
				/* 272L, 33L) */ var_1_30 = (
					/* 275L, 32L) */ (abs (
						var_1_37
					))
	...
	// From: CodeObject3
	/* 303L, 146L) */ if (/* 304L, 89L, 90L) */ ((/* 305L, 87L, 91L) */ ((/* 306L, 85L, 92L) */ ((var_1_41) % (var_1_43))) >> (var_1_44))) < (var_1_1))) {
		/* 311L, 140L) */ if (/* 312L, 108L, 109L) */ ((var_1_36) && (/* 314L, 107L, 111L) */ ((var_1_31) || (var_1_45))))) {
			/* 317L, 122L) */ var_1_42 = (
				var_1_46
			);
		} else {
			/* 321L, 138L) */ if (/* 322L, 125L, 126L) */ ((var_1_15) < (-100))) {
				/* 325L, 137L) */ var_1_42 = (
					/* 328L, 136L) */ ((
						var_1_47
					) && (
	...
	// From: CodeObject5
	/* 340L, 209L) */ if (/* 341L, 171L, 172L) */ ((/* 342L, 163L, 173L) */ ((var_1_1) & (var_1_40))) >= (/* 345L, 170L, 176L) */ ((/* 346L, 166L, 177L) */ (min (/* 346L, 166L, 177L) */ (var_1_44) , (var_1_43)))) >> (/* 349L, 169L, 180L) */ (max (/* 349L, 169L, 180L) */ (var_1_51) , (var_1_52)))))))) {
		/* 352L, 202L) */ if (var_1_53) {
			/* 354L, 201L) */ var_1_50 = (
				/* 357L, 200L) */ (abs (
					var_1_51
				))
	...
	// From: CodeObject6
	/* 365L, 256L) */ if (/* 366L, 218L, 219L) */ ((/* 367L, 215L, 220L) */ ((var_1_14) ^ (var_1_15))) > (/* 370L, 217L, 223L) */ (abs (var_1_41))))) {
		/* 372L, 254L) */ if (/* 373L, 235L, 236L) */ ((var_1_37) < (/* 375L, 234L, 238L) */ ((15.98f) + (var_1_38))))) {
			/* 378L, 249L) */ var_1_55 = (
				var_1_44
			);
		} else {
...
int property(void) {
	...
	if (/* 411L, 35L, 39L, 414L, 428L, 1031L) */ ((var_1_4) == (var_1_5))) {
	}
	if (/* 425L, 62L, 66L, 470L, 484L, 1045L) */ ((var_1_11) > (var_1_4))) {
		if (/* 429L, 71L, 75L, 474L, 488L, 1049L) */ ((var_1_8) > (var_1_4))) {
		}
	}
	if (/* 440L, 102L, 114L, 545L, 568L, 1060L) */ ((/* 441L, 96L, 115L, 546L, 569L, 1061L) */ ((var_1_16) * (/* 443L, 95L, 117L, 548L, 571L, 1063L) */ ((var_1_17) + (var_1_18))))) < (/* 446L, 101L, 120L, 551L, 574L, 1066L) */ ((/* 447L, 99L, 121L, 552L, 575L, 1067L) */ ((var_1_19) + (var_1_20))) - (var_1_21))))) {
	} else {
	}
	if (var_1_2) {
		if (/* 463L, 152L, 156L, 649L, 678L, 1083L) */ ((var_1_21) > (var_1_20))) {
			if (/* 467L, 169L, 175L, 653L, 682L, 1087L) */ ((-16) != (/* 469L, 168L, 177L, 655L, 684L, 1089L) */ ((-25) / (var_1_7))))) {
			} else {
			}
		} else {
		}
	...
	if (/* 490L, 216L, 220L, 767L, 798L, 1110L) */ ((var_1_2) || (var_1_25))) {
		if (/* 494L, 230L, 236L, 771L, 802L, 1114L) */ ((var_1_2) && (/* 496L, 229L, 238L, 773L, 804L, 1116L) */ ((var_1_15) <= (var_1_8))))) {
			if (/* 500L, 247L, 255L, 777L, 808L, 1120L) */ ((var_1_7) == (/* 502L, 246L, 257L, 779L, 810L, 1122L) */ ((/* 503L, 244L, 258L, 780L, 811L, 1123L) */ (max (/* 503L, 244L, 258L, 780L, 811L, 1123L) */ (var_1_5) , (var_1_9)))) * (var_1_4))))) {
			}
		}
	} else {
	}
	...
	/* 530L) */ ((
		/* 529L) */ ((
			/* 528L) */ ((
				/* 527L) */ ((
					/* 526L) */ ((
						/* 388L, 24L, 340L, 363L, 1008L) */ ((
							var_1_2
						) ? (
							/* 390L, 10L, 342L, 365L, 1010L) */ ((
								var_1_1
							) == (
								/* 390L, 10L, 342L, 365L, 1010L) */ ((unsigned long int) (
									/* 393L, 9L, 345L, 368L, 1013L) */ (max (
										/* 393L, 9L, 345L, 368L, 1013L) */ (
											var_1_3
										) , (
											var_1_4
										)
							...
							/* 396L, 22L, 348L, 371L, 1016L) */ ((
								var_1_1
							) == (
								/* 396L, 22L, 348L, 371L, 1016L) */ ((unsigned long int) (
									/* 399L, 21L, 351L, 374L, 1019L) */ ((
										/* 400L, 15L, 352L, 375L, 1020L) */ (min (
											/* 400L, 15L, 352L, 375L, 1020L) */ (
												var_1_5
											) , (
												var_1_6
											)
										...
										/* 403L, 20L, 355L, 378L, 1023L) */ ((
											/* 404L, 18L, 356L, 379L, 1024L) */ ((
												var_1_7
											) - (
												var_1_8
											))
						...
						/* 410L, 51L, 413L, 427L, 1030L) */ ((
							/* 411L, 35L, 39L, 414L, 428L, 1031L) */ ((
								var_1_4
							) == (
								var_1_5
							))
						) ? (
							/* 414L, 49L, 417L, 431L, 1034L) */ ((
								var_1_10
							) == (
								/* 414L, 49L, 417L, 431L, 1034L) */ ((signed char) (
									/* 417L, 48L, 420L, 434L, 1037L) */ (max (
										/* 417L, 48L, 420L, 434L, 1037L) */ (
											/* 418L, 46L, 421L, 435L, 1038L) */ ((
												var_1_11
											) + (
												var_1_12
											))
					...
					/* 424L, 85L, 469L, 483L, 1044L) */ ((
						/* 425L, 62L, 66L, 470L, 484L, 1045L) */ ((
							var_1_11
						) > (
							var_1_4
						))
					) ? (
						/* 428L, 83L, 473L, 487L, 1048L) */ ((
							/* 429L, 71L, 75L, 474L, 488L, 1049L) */ ((
								var_1_8
							) > (
								var_1_4
							))
						) ? (
							/* 432L, 81L, 477L, 491L, 1052L) */ ((
								var_1_14
							) == (
								/* 432L, 81L, 477L, 491L, 1052L) */ ((signed long int) (
									var_1_8
								))
							))
						) : (
				...
				/* 439L, 138L, 544L, 567L, 1059L) */ ((
					/* 440L, 102L, 114L, 545L, 568L, 1060L) */ ((
						/* 441L, 96L, 115L, 546L, 569L, 1061L) */ ((
							var_1_16
						) * (
							/* 443L, 95L, 117L, 548L, 571L, 1063L) */ ((
								var_1_17
							) + (
								var_1_18
							))
						...
						/* 446L, 101L, 120L, 551L, 574L, 1066L) */ ((
							/* 447L, 99L, 121L, 552L, 575L, 1067L) */ ((
								var_1_19
							) + (
								var_1_20
							))
					...
					/* 451L, 128L, 556L, 579L, 1071L) */ ((
						var_1_15
					) == (
						/* 451L, 128L, 556L, 579L, 1071L) */ ((signed long int) (
							var_1_9
						))
					))
				) : (
					/* 455L, 136L, 560L, 583L, 1075L) */ ((
						var_1_15
					) == (
						/* 455L, 136L, 560L, 583L, 1075L) */ ((signed long int) (
							var_1_22
						))
					))
				))
			...
			/* 460L, 209L, 646L, 675L, 1080L) */ ((
				var_1_2
			) ? (
				/* 462L, 203L, 648L, 677L, 1082L) */ ((
					/* 463L, 152L, 156L, 649L, 678L, 1083L) */ ((
						var_1_21
					) > (
						var_1_20
					))
				) ? (
					/* 466L, 197L, 652L, 681L, 1086L) */ ((
						/* 467L, 169L, 175L, 653L, 682L, 1087L) */ ((
							-16
						) != (
							/* 469L, 168L, 177L, 655L, 684L, 1089L) */ ((
								-25
							) / (
								var_1_7
							))
						...
						/* 472L, 183L, 658L, 687L, 1092L) */ ((
							var_1_23
						) == (
							/* 472L, 183L, 658L, 687L, 1092L) */ ((signed char) (
								var_1_13
							))
						))
					) : (
						/* 476L, 195L, 662L, 691L, 1096L) */ ((
							var_1_23
						) == (
							/* 476L, 195L, 662L, 691L, 1096L) */ ((signed char) (
								var_1_11
							))
						))
					))
				) : (
					/* 480L, 201L, 666L, 695L, 1100L) */ ((
						var_1_23
					) == (
						/* 480L, 201L, 666L, 695L, 1100L) */ ((signed char) (
							var_1_11
						))
					))
				))
			) : (
				/* 484L, 207L, 670L, 699L, 1104L) */ ((
					var_1_23
				) == (
					/* 484L, 207L, 670L, 699L, 1104L) */ ((signed char) (
						var_1_11
					))
				))
			))
		...
		/* 489L, 279L, 766L, 797L, 1109L) */ ((
			/* 490L, 216L, 220L, 767L, 798L, 1110L) */ ((
				var_1_2
			) || (
				var_1_25
			))
		) ? (
			/* 493L, 273L, 770L, 801L, 1113L) */ ((
				/* 494L, 230L, 236L, 771L, 802L, 1114L) */ ((
					var_1_2
				) && (
					/* 496L, 229L, 238L, 773L, 804L, 1116L) */ ((
						var_1_15
					) <= (
						var_1_8
					))
				...
				/* 499L, 271L, 776L, 807L, 1119L) */ ((
					/* 500L, 247L, 255L, 777L, 808L, 1120L) */ ((
						var_1_7
					) == (
						/* 502L, 246L, 257L, 779L, 810L, 1122L) */ ((
							/* 503L, 244L, 258L, 780L, 811L, 1123L) */ (max (
								/* 503L, 244L, 258L, 780L, 811L, 1123L) */ (
									var_1_5
								) , (
									var_1_9
								)
					...
					/* 507L, 269L, 784L, 815L, 1127L) */ ((
						var_1_24
					) == (
						/* 507L, 269L, 784L, 815L, 1127L) */ ((signed short int) (
							/* 510L, 268L, 787L, 818L, 1130L) */ ((
								/* 511L, 266L, 788L, 819L, 1131L) */ ((
									var_1_26
								) - (
									var_1_27
								))
			...
			/* 515L, 277L, 792L, 823L, 1135L) */ ((
				var_1_24
			) == (
				/* 515L, 277L, 792L, 823L, 1135L) */ ((signed short int) (
					var_1_15
				))
			))
		))
	...
	/* 521L, 287L, 841L, 847L, 1141L) */ ((
		var_1_28
	) == (
		/* 521L, 287L, 841L, 847L, 1141L) */ ((unsigned char) (
			var_1_29
		))
	))
))
