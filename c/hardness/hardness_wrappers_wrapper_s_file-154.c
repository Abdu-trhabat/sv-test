...
void step(void) {
	...
	// From: Req1Batch154Wrapper_S
	signed long int stepLocal_0 = WrapperStruct00.var_1_4 + WrapperStruct00.var_1_5;
	if ((max (WrapperStruct00.var_1_2 , WrapperStruct00.var_1_3)) != stepLocal_0) {
		WrapperStruct00.var_1_1 = (abs (WrapperStruct00.var_1_6));
	} else {
		WrapperStruct00.var_1_1 = (min ((WrapperStruct00.var_1_7 + WrapperStruct00.var_1_8) , WrapperStruct00.var_1_6));
	}
}
