...
void step(void) {
 ...
 if (stepLocal_0 > unsigned_char_Array_0[0]) {
  if ((((((double_Array_0[0][1][1]) < (double_Array_0[1][0][1])) ? (double_Array_0[0][1][1]) : (double_Array_0[1][0][1]))) - 8.88) < double_Array_0[0][0][1]) {
   double_Array_0[1][1][1] = (double_Array_0[0][1][0] - (double_Array_0[1][0][0] - ((((double_Array_0[0][0][0]) < 0 ) ? -(double_Array_0[0][0][0]) : (double_Array_0[0][0][0])))));
  } else {
 ...
 if (double_Array_0[1][1][1] >= double_Array_0[1][1][0]) {
  if ((unsigned_char_Array_0[0] - unsigned_char_Array_0[1]) >= signed_long_int_Array_0[0]) {
   unsigned_long_int_Array_0[1] = ((unsigned_long_int_Array_0[0] - ((((unsigned_char_Array_0[1]) > (unsigned_char_Array_0[0])) ? (unsigned_char_Array_0[1]) : (unsigned_char_Array_0[0])))) - unsigned_long_int_Array_0[2]);
  }
 } else {
 ...
 if (! BOOL_unsigned_char_Array_0[0]) {
  float_Array_0[0] = (((((200.5f - 4.25f)) > (double_Array_0[1][0][0])) ? ((200.5f - 4.25f)) : (double_Array_0[1][0][0])));
 } else {
  if (((((unsigned_long_int_Array_0[2]) > (unsigned_long_int_Array_0[0])) ? (unsigned_long_int_Array_0[2]) : (unsigned_long_int_Array_0[0]))) >= stepLocal_1) {
...
int property(void) {
 return (((unsigned_char_Array_0[1] > unsigned_char_Array_0[0]) ? (((((((double_Array_0[0][1][1]) < (double_Array_0[1][0][1])) ? (double_Array_0[0][1][1]) : (double_Array_0[1][0][1]))) - 8.88) < double_Array_0[0][0][1]) ? (double_Array_0[1][1][1] == ((double) (double_Array_0[0][1][0] - (double_Array_0[1][0][0] - ((((double_Array_0[0][0][0]) < 0 ) ? -(double_Array_0[0][0][0]) : (double_Array_0[0][0][0]))))))) : (double_Array_0[1][1][1] == ((double) double_Array_0[0][1][0]))) : (double_Array_0[1][1][1] == ((double) double_Array_0[0][0][0]))) && ((double_Array_0[1][1][1] >= double_Array_0[1][1][0]) ? (((unsigned_char_Array_0[0] - unsigned_char_Array_0[1]) >= signed_long_int_Array_0[0]) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) ((unsigned_long_int_Array_0[0] - ((((unsigned_char_Array_0[1]) > (unsigned_char_Array_0[0])) ? (unsigned_char_Array_0[1]) : (unsigned_char_Array_0[0])))) - unsigned_long_int_Array_0[2]))) : 1) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_long_int_Array_0[0])))) && ((! BOOL_unsigned_char_Array_0[0]) ? (float_Array_0[0] == ((float) (((((200.5f - 4.25f)) > (double_Array_0[1][0][0])) ? ((200.5f - 4.25f)) : (double_Array_0[1][0][0]))))) : ((((((unsigned_long_int_Array_0[2]) > (unsigned_long_int_Array_0[0])) ? (unsigned_long_int_Array_0[2]) : (unsigned_long_int_Array_0[0]))) >= unsigned_long_int_Array_0[1]) ? (float_Array_0[0] == ((float) double_Array_0[0][0][0])) : (float_Array_0[0] == ((float) double_Array_0[1][0][0]))))
;
}
int main(void) {
 isInitial = 1;
