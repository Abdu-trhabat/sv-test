...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch182Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject8
	/* 360L, 227L) */ if (var_1_9) {
		/* 362L, 225L) */ if (/* 363L, 214L, 215L) */ ((var_1_21) >= (var_1_20))) {
			/* 366L, 224L) */ var_1_44 = (
				var_1_46
			);
		}
	...
	// From: CodeObject7
	/* 348L, 205L) */ if (/* 349L, 188L, 189L) */ ((var_1_25) >= (/* 351L, 187L, 191L) */ ((8) % (var_1_40))))) {
		/* 354L, 204L) */ var_1_43 = (
			/* 357L, 203L) */ (min (
				/* 357L, 203L) */ (
					100.25f
	...
	/* 268L, 68L) */ if (/* 269L, 32L, 33L) */ ((var_1_29) > (var_1_27))) {
		/* 272L, 66L) */ if (/* 273L, 42L, 43L) */ ((var_1_17) < (/* 275L, 41L, 45L) */ (abs (var_1_6))))) {
