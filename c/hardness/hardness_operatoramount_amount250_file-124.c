...
void step(void) {
	...
	// From: Req14Batch124Amount250
	var_1_50 = (min ((var_1_42 + -10) , (abs (var_1_38))));


	// From: Req15Batch124Amount250
	...
	// From: Req17Batch124Amount250
	if (var_1_1 <= var_1_34) {
		var_1_55 = (var_1_35 + var_1_36);
	} else {
		var_1_55 = (min (var_1_6 , var_1_35));
	}


	// From: Req18Batch124Amount250
	if ((min (var_1_13 , var_1_47)) >= 4u) {
		if (var_1_7) {
			var_1_56 = (max (var_1_38 , var_1_17));
		} else {
			var_1_56 = (var_1_48 - var_1_53);
		}
	} else {
		var_1_56 = (((max (100 , var_1_40)) + var_1_38) + (min ((min (var_1_57 , -4)) , (var_1_39 + var_1_52))));
	}


	// From: Req19Batch124Amount250
	if (var_1_11) {
		var_1_58 = (var_1_53 - var_1_52);
	}


	// From: Req20Batch124Amount250
	if (((- var_1_33) * var_1_36) > var_1_54) {
		var_1_59 = (var_1_52 + ((min (var_1_53 , var_1_60)) + var_1_61));
	} else {
		var_1_59 = (var_1_52 - var_1_53);
	}


	// From: Req21Batch124Amount250
	unsigned char stepLocal_15 = var_1_7;
	if ((var_1_36 + (var_1_6 / var_1_9)) >= var_1_34) {
		var_1_62 = ((min (var_1_6 , (var_1_33 + var_1_34))) - (abs (var_1_35 + var_1_36)));
	} else {
		if (var_1_71 && stepLocal_15) {
			var_1_62 = (max ((var_1_33 - var_1_64) , (var_1_36 + (var_1_35 + var_1_65))));
		}
	}


	// From: Req22Batch124Amount250
	...
	if (stepLocal_18 && var_1_7) {
		...
		if (var_1_41 == stepLocal_16) {
			...
			if (var_1_47 < stepLocal_17) {
				var_1_66 = ((min (var_1_52 , var_1_48)) - var_1_17);
			} else {
	...
	// From: Req24Batch124Amount250
	var_1_68 = var_1_56;


	// From: Req25Batch124Amount250
	if (var_1_26) {
		var_1_69 = var_1_20;
	} else {
		var_1_69 = var_1_12;
	...
	// From: Req27Batch124Amount250
	if ((- var_1_9) <= (min (var_1_35 , var_1_54))) {
		var_1_73 = (((10000 + var_1_74) + (var_1_75 + 10000)) - var_1_21);
	}


	// From: Req13Batch124Amount250
	signed long int stepLocal_13 = (min (var_1_15 , var_1_45)) - var_1_16;
	unsigned long int stepLocal_12 = (abs (4u)) + (var_1_17 * var_1_21);
	unsigned char stepLocal_11 = (var_1_69 / var_1_15) < var_1_20;
	signed long int stepLocal_10 = (min (var_1_47 , var_1_48)) << var_1_17;
	if (! var_1_71) {
		if (stepLocal_11 || (var_1_9 <= (min (var_1_31 , var_1_62)))) {
			var_1_43 = (max (var_1_42 , var_1_44));
		} else {
		...
		if (var_1_3 >= stepLocal_12) {
			var_1_43 = (max (var_1_23 , var_1_39));
		} else {
			if (stepLocal_10 <= var_1_73) {
				if (var_1_71) {
					var_1_43 = (max (var_1_5 , (min (var_1_16 , (var_1_58 + var_1_15)))));
				}
			} else {
				var_1_43 = ((max ((var_1_17 + var_1_15) , var_1_47)) - ((var_1_49 + var_1_21) + var_1_14));
			}
		}
	}


	// From: Req4Batch124Amount250
	if (var_1_2 >= (var_1_73 & (var_1_19 + var_1_4))) {
		var_1_18 = ((var_1_16 - var_1_17) + var_1_20);
	} else {
		var_1_18 = ((var_1_16 - var_1_17) + (abs (min (var_1_20 , var_1_21))));
	}


	// From: Req5Batch124Amount250
	unsigned char stepLocal_1 = var_1_11;
	if ((var_1_19 > var_1_13) && stepLocal_1) {
		var_1_22 = (max (-5 , (min (var_1_18 , var_1_16))));
	}


	// From: Req9Batch124Amount250
	...
	if ((var_1_54 / var_1_9) < (var_1_31 / var_1_29)) {
		...
		var_1_28 = ((min (var_1_14 , var_1_22)) + var_1_67);
	}


	// From: Req11Batch124Amount250
	...
	if (((100 + var_1_3) >= var_1_22) || stepLocal_7) {
		...
		if (stepLocal_8 && (var_1_21 < (var_1_5 / var_1_16))) {
			var_1_32 = ((var_1_35 + var_1_36) + (min (var_1_34 , var_1_33)));
		} else {
	...
	// From: Req12Batch124Amount250
	signed long int stepLocal_9 = abs (var_1_21);
	if (var_1_73 != stepLocal_9) {
		var_1_37 = (max (var_1_38 , var_1_39));
	} else {
		var_1_37 = (max ((var_1_40 + var_1_41) , (-4 + var_1_42)));
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((((((var_1_2 * (3669925837u - var_1_3)) > (2965407302u - (var_1_4 - var_1_5))) ? (var_1_1 == ((float) (var_1_6 - 32.25f))) : 1) && ((last_1_var_1_71 && (var_1_2 < var_1_3)) ? ((((last_1_var_1_51 + var_1_6) / var_1_9) < last_1_var_1_54) ? (var_1_7 == ((unsigned char) (! (! var_1_11)))) : 1) : (var_1_7 == ((unsigned char) ((var_1_5 == 32u) && var_1_11))))) && ((var_1_13 >= var_1_5) ? (var_1_12 == ((unsigned short int) (min (var_1_14 , (var_1_15 - (var_1_16 - var_1_17)))))) : (var_1_12 == ((unsigned short int) (((abs (54291)) - var_1_17) - var_1_16))))) && ((var_1_2 >= (var_1_73 & (var_1_19 + var_1_4))) ? (var_1_18 == ((unsigned short int) ((var_1_16 - var_1_17) + var_1_20))) : (var_1_18 == ((unsigned short int) ((var_1_16 - var_1_17) + (abs (min (var_1_20 , var_1_21)))))))) && (((var_1_19 > var_1_13) && var_1_11) ? (var_1_22 == ((signed long int) (max (-5 , (min (var_1_18 , var_1_16)))))) : 1)) && (var_1_23 == ((signed long int) (var_1_20 + var_1_14)))) && (var_1_24 == ((float) (var_1_6 - var_1_25)))) && (((- var_1_19) >= var_1_17) ? (var_1_26 == ((unsigned char) var_1_11)) : 1)) && (((var_1_54 / var_1_9) < (var_1_31 / var_1_29)) ? (((- var_1_13) >= (3983591152u - var_1_21)) ? (var_1_28 == ((signed long int) var_1_30)) : 1) : (var_1_28 == ((signed long int) ((min (var_1_14 , var_1_22)) + var_1_67))))) && ((var_1_5 < 10u) ? (((last_1_var_1_43 <= var_1_30) || last_1_var_1_26) ? ((var_1_30 <= (var_1_21 * var_1_13)) ? (var_1_31 == ((double) (var_1_6 - 1.8))) : (var_1_31 == ((double) 0.9))) : 1) : 1)) && ((((100 + var_1_3) >= var_1_22) || var_1_71) ? (var_1_32 == ((float) ((var_1_33 + var_1_34) - var_1_6))) : ((var_1_71 && (var_1_21 < (var_1_5 / var_1_16))) ? (var_1_32 == ((float) ((var_1_35 + var_1_36) + (min (var_1_34 , var_1_33))))) : (var_1_32 == ((float) (abs (var_1_6))))))) && ((var_1_73 != (abs (var_1_21))) ? (var_1_37 == ((signed char) (max (var_1_38 , var_1_39)))) : (var_1_37 == ((signed char) (max ((var_1_40 + var_1_41) , (-4 + var_1_42))))))) && ((! var_1_71) ? ((((var_1_69 / var_1_15) < var_1_20) || (var_1_9 <= (min (var_1_31 , var_1_62)))) ? (var_1_43 == ((signed long int) (max (var_1_42 , var_1_44)))) : ((((min (var_1_15 , var_1_45)) - var_1_16) >= (var_1_67 * var_1_19)) ? (var_1_43 == ((signed long int) (var_1_15 - var_1_21))) : 1)) : ((var_1_3 >= ((abs (4u)) + (var_1_17 * var_1_21))) ? (var_1_43 == ((signed long int) (max (var_1_23 , var_1_39)))) : ((((min (var_1_47 , var_1_48)) << var_1_17) <= var_1_73) ? (var_1_71 ? (var_1_43 == ((signed long int) (max (var_1_5 , (min (var_1_16 , (var_1_58 + var_1_15))))))) : 1) : (var_1_43 == ((signed long int) ((max ((var_1_17 + var_1_15) , var_1_47)) - ((var_1_49 + var_1_21) + var_1_14)))))))) && (var_1_50 == ((signed short int) (min ((var_1_42 + -10) , (abs (var_1_38))))))) && ((var_1_5 >= (var_1_3 << (var_1_52 + var_1_53))) ? (var_1_51 == ((float) 32.55f)) : (var_1_11 ? (var_1_51 == ((float) (var_1_35 + var_1_33))) : 1))) && ((4 < var_1_14) ? (var_1_54 == ((double) var_1_35)) : 1)) && ((var_1_1 <= var_1_34) ? (var_1_55 == ((float) (var_1_35 + var_1_36))) : (var_1_55 == ((float) (min (var_1_6 , var_1_35)))))) && (((min (var_1_13 , var_1_47)) >= 4u) ? (var_1_7 ? (var_1_56 == ((signed short int) (max (var_1_38 , var_1_17)))) : (var_1_56 == ((signed short int) (var_1_48 - var_1_53)))) : (var_1_56 == ((signed short int) (((max (100 , var_1_40)) + var_1_38) + (min ((min (var_1_57 , -4)) , (var_1_39 + var_1_52)))))))) && (var_1_11 ? (var_1_58 == ((signed char) (var_1_53 - var_1_52))) : 1)) && ((((- var_1_33) * var_1_36) > var_1_54) ? (var_1_59 == ((signed char) (var_1_52 + ((min (var_1_53 , var_1_60)) + var_1_61)))) : (var_1_59 == ((signed char) (var_1_52 - var_1_53))))) && (((var_1_36 + (var_1_6 / var_1_9)) >= var_1_34) ? (var_1_62 == ((float) ((min (var_1_6 , (var_1_33 + var_1_34))) - (abs (var_1_35 + var_1_36))))) : ((var_1_71 && var_1_7) ? (var_1_62 == ((float) (max ((var_1_33 - var_1_64) , (var_1_36 + (var_1_35 + var_1_65)))))) : 1))) && ((var_1_71 && var_1_7) ? (var_1_66 == ((signed short int) var_1_40)) : ((var_1_41 == var_1_23) ? (var_1_66 == ((signed short int) (var_1_17 - (100 + var_1_48)))) : ((var_1_47 < var_1_48) ? (var_1_66 == ((signed short int) ((min (var_1_52 , var_1_48)) - var_1_17))) : (var_1_66 == ((signed short int) ((25745 - var_1_53) - var_1_17))))))) && ((var_1_34 != (var_1_31 / var_1_9)) ? (var_1_67 == ((signed long int) ((-128 + -4) + var_1_21))) : (var_1_67 == ((signed long int) var_1_40)))) && (var_1_68 == ((signed short int) var_1_56))) && (var_1_26 ? (var_1_69 == ((signed long int) var_1_20)) : (var_1_69 == ((signed long int) var_1_12)))) && (var_1_7 ? (var_1_71 == ((unsigned char) var_1_11)) : (var_1_71 == ((unsigned char) var_1_72)))) && (((- var_1_9) <= (min (var_1_35 , var_1_54))) ? (var_1_73 == ((unsigned short int) (((10000 + var_1_74) + (var_1_75 + 10000)) - var_1_21))) : 1)
;
}
int main(void) {
	isInitial = 1;
