...
void step(void) {
	...
	if (stepLocal_24 > var_1_55) {
		if (var_1_20 != stepLocal_23) {
			...
			var_1_74 = (min (var_1_13 , (min (var_1_16 , var_1_14))));
		}
	} else {
		var_1_74 = (max (var_1_13 , (var_1_18 - var_1_14)));
	}
	...
	if (var_1_27 < stepLocal_26) {
		var_1_80 = (max ((100000000u + var_1_23) , last_1_var_1_19));
	} else {
		var_1_80 = (max (var_1_62 , var_1_4));
	}
	...
	if (var_1_80 >= last_1_var_1_1) {
		...
		if (((var_1_5 << var_1_4) / (min (var_1_6 , var_1_7))) <= (last_1_var_1_1 >> (max (var_1_8 , 10u)))) {
	...
	if (stepLocal_28 != var_1_59) {
		var_1_85 = (max (((last_1_var_1_101 + var_1_35) + (1422943038u - var_1_57)) , var_1_21));
	} else {
		if (! last_1_var_1_84) {
			var_1_85 = (var_1_50 + 1u);
		} else {
			var_1_85 = (min ((min (256u , var_1_35)) , var_1_25));
		}
	}
	...
	if ((var_1_16 + var_1_18) >= var_1_13) {
		var_1_37 = (min (var_1_20 , var_1_25));
	}


	// From: Req17Batch14Amount500
	unsigned long int stepLocal_9 = var_1_9 - var_1_46;
	if (((min (var_1_8 , var_1_23)) - (min (var_1_25 , var_1_45))) <= stepLocal_9) {
		var_1_51 = (((200 - var_1_20) + (min (32 , var_1_25))) + (max ((var_1_23 - var_1_22) , var_1_21)));
	} else {
	...
	if (stepLocal_11 == var_1_20) {
		var_1_52 = (max (var_1_20 , var_1_23));
	} else {
	...
	if (! var_1_30) {
		var_1_65 = (abs (var_1_58 + var_1_62));
	} else {
		if ((var_1_5 >= var_1_57) || stepLocal_21) {
			var_1_65 = (min (var_1_57 , (var_1_29 - var_1_59)));
		} else {
			var_1_65 = var_1_34;
		}
	}
	...
	var_1_77 = (max (1.8f , (min (var_1_16 , var_1_18))));
	...
	if (var_1_50 >= ((var_1_22 - var_1_62) * var_1_100)) {
		var_1_61 = (max ((abs (var_1_20)) , (var_1_57 - (var_1_51 + var_1_21))));
	} else {
		var_1_61 = (max ((max (var_1_21 , var_1_55)) , (100 - var_1_85)));
	}
	...
	if (stepLocal_7 >= ((max (var_1_27 , var_1_22)) - var_1_99)) {
		var_1_38 = (var_1_16 + var_1_17);
	} else {
		if (stepLocal_6 && (var_1_27 < var_1_35)) {
			var_1_38 = (min (var_1_14 , var_1_12));
		}
	}


	// From: Req21Batch14Amount500
	if (var_1_38 > (max (var_1_98 , var_1_13))) {
		var_1_60 = (abs (var_1_59 + (var_1_58 - 32)));
	} else {
		if (var_1_90 && var_1_40) {
			if ((0 & var_1_26) > var_1_34) {
				var_1_60 = (max ((min ((2 + var_1_58) , var_1_8)) , var_1_59));
			} else {
				var_1_60 = (var_1_20 - var_1_8);
			}
		} else {
			var_1_60 = (min (var_1_58 , var_1_23));
		}
	}
	...
	if (var_1_30) {
		if (var_1_5 < stepLocal_8) {
			var_1_49 = ((abs (var_1_45)) + (min (var_1_79 , (abs (var_1_22)))));
		} else {
			var_1_49 = (abs (max (25 , (var_1_45 - var_1_22))));
		}
	} else {
	...
	if (var_1_31) {
		...
		if (var_1_84) {
			...
			var_1_69 = (max (var_1_20 , (min (var_1_21 , var_1_56))));
		}
	}
	...
	if (((var_1_80 * last_1_var_1_44) > var_1_35) && (var_1_26 != var_1_69)) {
		if (var_1_6 > var_1_26) {
			var_1_44 = (min (var_1_9 , var_1_21));
		} else {
			if (var_1_37 == (var_1_21 % (200 - var_1_45))) {
				var_1_44 = (max ((var_1_27 + 25u) , (last_1_var_1_44 + 128u)));
			} else {
				if (((2131045880u + var_1_46) - 64u) < (var_1_4 / var_1_20)) {
					var_1_44 = ((abs (var_1_9)) - ((var_1_47 - 10u) + (1000000000u - var_1_22)));
				} else {
	...
	if (! (0u <= var_1_87)) {
		if (stepLocal_19 || var_1_83) {
			if (stepLocal_20 > ((min (128u , var_1_34)) << var_1_23)) {
		...
		var_1_63 = (var_1_8 - (min (var_1_25 , var_1_56)));
	}
	...
	if (var_1_40) {
		if (! (var_1_90 || var_1_39)) {
			if (var_1_25 < var_1_50) {
				var_1_66 = (abs (max (var_1_25 , (min (var_1_59 , var_1_8)))));
			} else {
				var_1_66 = (abs (var_1_25));
			}
		}
	} else {
		if (var_1_86 >= var_1_47) {
			if (var_1_44 <= (~ (var_1_6 / var_1_34))) {
				var_1_66 = ((abs (5)) - var_1_55);
			} else {
				var_1_66 = (max (var_1_56 , var_1_45));
			}
		} else {
			var_1_66 = (max (var_1_8 , (max (var_1_25 , var_1_56))));
		}
	}
	...
	if (var_1_67 && stepLocal_12) {
		if (var_1_13 <= var_1_12) {
			...
			var_1_53 = (max (50 , (abs (var_1_35))));
		}
	} else {
		var_1_53 = (abs (var_1_21));
	}
	...
	if (stepLocal_14 < (abs (min (var_1_78 , var_1_25)))) {
		if (var_1_78 <= stepLocal_17) {
			var_1_54 = (var_1_20 - ((var_1_55 + var_1_56) - (50 - 5)));
		} else {
			var_1_54 = (((max (var_1_57 , 64)) + var_1_58) - var_1_8);
		}
	} else {
		if ((-8 / (abs (var_1_58))) <= stepLocal_15) {
				...
				if (var_1_56 == stepLocal_16) {
					if ((var_1_14 / var_1_41) < var_1_93) {
						if (stepLocal_13 <= (var_1_87 + var_1_23)) {
							var_1_54 = (max ((max (8 , (abs (var_1_45)))) , var_1_25));
						} else {
							if ((var_1_17 * var_1_18) <= 500.25f) {
								var_1_54 = ((var_1_58 + (var_1_56 + var_1_59)) - var_1_45);
							} else {
								var_1_54 = (var_1_21 - (min (var_1_58 , (min (var_1_57 , var_1_8)))));
							}
						}
					}
				} else {
					var_1_54 = ((abs (abs (var_1_45))) + (max (var_1_25 , var_1_59)));
				}
			}
		} else {
			var_1_54 = ((var_1_20 - var_1_25) - (min (var_1_8 , var_1_56)));
		}
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((var_1_80 >= last_1_var_1_1) ? (var_1_1 == ((unsigned long int) (var_1_4 - var_1_5))) : ((((var_1_5 << var_1_4) / (min (var_1_6 , var_1_7))) <= (last_1_var_1_1 >> (max (var_1_8 , 10u)))) ? (var_1_1 == ((unsigned long int) ((min (var_1_4 , var_1_9)) - var_1_8))) : ((-10 > (var_1_5 << last_1_var_1_1)) ? (var_1_1 == ((unsigned long int) (max ((var_1_5 + var_1_8) , var_1_4)))) : 1))) && (var_1_48 ? ((var_1_7 >= (var_1_5 / var_1_6)) ? (var_1_10 == ((double) var_1_12)) : (var_1_10 == ((double) (var_1_13 - var_1_14)))) : 1)) && (var_1_15 == ((float) (((var_1_16 + var_1_17) + (var_1_18 - 16.8f)) + 7.375f)))) && ((var_1_5 < (var_1_79 * var_1_7)) ? (var_1_19 == ((unsigned char) (((max (var_1_20 , var_1_21)) - (var_1_8 + var_1_22)) - var_1_23))) : ((var_1_7 <= (var_1_85 | var_1_5)) ? (var_1_19 == ((unsigned char) (var_1_23 + var_1_8))) : 1))) && (((var_1_20 - var_1_44) == var_1_8) ? (var_1_24 == ((signed char) ((64 - var_1_22) - var_1_25))) : 1)) && ((last_1_var_1_101 > ((var_1_27 + var_1_23) - var_1_22)) ? (last_1_var_1_84 ? ((! last_1_var_1_48) ? (var_1_26 == ((unsigned short int) (max ((var_1_29 - var_1_25) , (abs (var_1_8)))))) : ((last_1_var_1_48 || ((- last_1_var_1_74) <= 2.5)) ? (var_1_26 == ((unsigned short int) ((var_1_23 + var_1_21) + 128))) : (((var_1_29 + var_1_23) > var_1_22) ? ((var_1_14 <= var_1_17) ? (var_1_26 == ((unsigned short int) var_1_21)) : (var_1_26 == ((unsigned short int) var_1_29))) : 1))) : 1) : 1)) && (var_1_30 == ((unsigned char) (! var_1_31)))) && ((var_1_12 < var_1_18) ? (var_1_32 == ((unsigned char) 0)) : 1)) && (var_1_33 == ((unsigned short int) ((var_1_34 + var_1_35) - var_1_80)))) && (var_1_75 ? (var_1_36 == ((double) 0.4)) : 1)) && (((var_1_16 + var_1_18) >= var_1_13) ? (var_1_37 == ((unsigned char) (min (var_1_20 , var_1_25)))) : 1)) && (((- var_1_7) >= ((max (var_1_27 , var_1_22)) - var_1_99)) ? (var_1_38 == ((float) (var_1_16 + var_1_17))) : ((var_1_48 && (var_1_27 < var_1_35)) ? (var_1_38 == ((float) (min (var_1_14 , var_1_12)))) : 1))) && ((var_1_12 > var_1_14) ? ((var_1_100 <= var_1_25) ? ((var_1_27 != var_1_35) ? (var_1_39 == ((unsigned char) (last_1_var_1_39 || ((var_1_71 || var_1_31) && var_1_40)))) : (var_1_39 == ((unsigned char) (last_1_var_1_39 && (! var_1_40))))) : (var_1_39 == ((unsigned char) (var_1_40 && var_1_31)))) : ((((var_1_77 / var_1_41) * var_1_10) >= var_1_13) ? (var_1_39 == ((unsigned char) var_1_40)) : (var_1_39 == ((unsigned char) (var_1_42 || var_1_43)))))) && ((((var_1_80 * last_1_var_1_44) > var_1_35) && (var_1_26 != var_1_69)) ? ((var_1_6 > var_1_26) ? (var_1_44 == ((unsigned long int) (min (var_1_9 , var_1_21)))) : ((var_1_37 == (var_1_21 % (200 - var_1_45))) ? (var_1_44 == ((unsigned long int) (max ((var_1_27 + 25u) , (last_1_var_1_44 + 128u))))) : ((((2131045880u + var_1_46) - 64u) < (var_1_4 / var_1_20)) ? (var_1_44 == ((unsigned long int) ((abs (var_1_9)) - ((var_1_47 - 10u) + (1000000000u - var_1_22))))) : (var_1_44 == ((unsigned long int) (var_1_35 + var_1_23)))))) : ((! var_1_42) ? (var_1_44 == ((unsigned long int) var_1_35)) : (var_1_44 == ((unsigned long int) var_1_21))))) && ((var_1_80 == var_1_8) ? (var_1_48 == ((unsigned char) ((var_1_17 > var_1_13) && (var_1_43 || var_1_42)))) : (var_1_48 == ((unsigned char) (! var_1_31))))) && (var_1_30 ? ((var_1_5 < var_1_34) ? (var_1_49 == ((signed short int) ((abs (var_1_45)) + (min (var_1_79 , (abs (var_1_22))))))) : (var_1_49 == ((signed short int) (abs (max (25 , (var_1_45 - var_1_22))))))) : (var_1_49 == ((signed short int) ((var_1_79 - (var_1_50 - var_1_23)) + (var_1_20 - var_1_22)))))) && ((((min (var_1_8 , var_1_23)) - (min (var_1_25 , var_1_45))) <= (var_1_9 - var_1_46)) ? (var_1_51 == ((signed long int) (((200 - var_1_20) + (min (32 , var_1_25))) + (max ((var_1_23 - var_1_22) , var_1_21))))) : (var_1_51 == ((signed long int) (var_1_8 + var_1_20))))) && (((var_1_25 - var_1_22) == var_1_20) ? (var_1_52 == ((unsigned char) (max (var_1_20 , var_1_23)))) : (((var_1_20 * (var_1_22 - var_1_45)) < (var_1_50 * -100000000)) ? (var_1_52 == ((unsigned char) var_1_23)) : 1))) && ((var_1_67 && var_1_39) ? ((var_1_13 <= var_1_12) ? (var_1_53 == ((signed long int) (var_1_81 + (var_1_52 - var_1_23)))) : (var_1_53 == ((signed long int) (max (50 , (abs (var_1_35))))))) : (var_1_53 == ((signed long int) (abs (var_1_21)))))) && ((var_1_51 < (abs (min (var_1_78 , var_1_25)))) ? ((var_1_78 <= var_1_47) ? (var_1_54 == ((unsigned char) (var_1_20 - ((var_1_55 + var_1_56) - (50 - 5))))) : (var_1_54 == ((unsigned char) (((max (var_1_57 , 64)) + var_1_58) - var_1_8)))) : (((-8 / (abs (var_1_58))) <= var_1_21) ? ((((var_1_85 | var_1_46) > var_1_69) || ((var_1_13 - var_1_14) != var_1_91)) ? ((var_1_56 == var_1_1) ? (((var_1_14 / var_1_41) < var_1_93) ? (((var_1_51 * (var_1_27 * var_1_9)) <= (var_1_87 + var_1_23)) ? (var_1_54 == ((unsigned char) (max ((max (8 , (abs (var_1_45)))) , var_1_25)))) : (((var_1_17 * var_1_18) <= 500.25f) ? (var_1_54 == ((unsigned char) ((var_1_58 + (var_1_56 + var_1_59)) - var_1_45))) : (var_1_54 == ((unsigned char) (var_1_21 - (min (var_1_58 , (min (var_1_57 , var_1_8))))))))) : 1) : (var_1_54 == ((unsigned char) ((abs (abs (var_1_45))) + (max (var_1_25 , var_1_59)))))) : 1) : (var_1_54 == ((unsigned char) ((var_1_20 - var_1_25) - (min (var_1_8 , var_1_56)))))))) && ((var_1_38 > (max (var_1_98 , var_1_13))) ? (var_1_60 == ((unsigned char) (abs (var_1_59 + (var_1_58 - 32))))) : ((var_1_90 && var_1_40) ? (((0 & var_1_26) > var_1_34) ? (var_1_60 == ((unsigned char) (max ((min ((2 + var_1_58) , var_1_8)) , var_1_59)))) : (var_1_60 == ((unsigned char) (var_1_20 - var_1_8)))) : (var_1_60 == ((unsigned char) (min (var_1_58 , var_1_23))))))) && ((var_1_50 >= ((var_1_22 - var_1_62) * var_1_100)) ? (var_1_61 == ((signed short int) (max ((abs (var_1_20)) , (var_1_57 - (var_1_51 + var_1_21)))))) : (var_1_61 == ((signed short int) (max ((max (var_1_21 , var_1_55)) , (100 - var_1_85))))))) && ((! (0u <= var_1_87)) ? ((var_1_67 || var_1_83) ? (((var_1_49 / var_1_8) > ((min (128u , var_1_34)) << var_1_23)) ? (var_1_63 == ((signed char) ((var_1_56 - 32) + var_1_25))) : 1) : (var_1_63 == ((signed char) var_1_55))) : (var_1_63 == ((signed char) (var_1_8 - (min (var_1_25 , var_1_56))))))) && ((! var_1_30) ? (var_1_65 == ((unsigned short int) (abs (var_1_58 + var_1_62)))) : (((var_1_5 >= var_1_57) || var_1_48) ? (var_1_65 == ((unsigned short int) (min (var_1_57 , (var_1_29 - var_1_59))))) : (var_1_65 == ((unsigned short int) var_1_34))))) && (var_1_40 ? ((! (var_1_90 || var_1_39)) ? ((var_1_25 < var_1_50) ? (var_1_66 == ((signed char) (abs (max (var_1_25 , (min (var_1_59 , var_1_8))))))) : (var_1_66 == ((signed char) (abs (var_1_25))))) : 1) : ((var_1_86 >= var_1_47) ? ((var_1_44 <= (~ (var_1_6 / var_1_34))) ? (var_1_66 == ((signed char) ((abs (5)) - var_1_55))) : (var_1_66 == ((signed char) (max (var_1_56 , var_1_45))))) : (var_1_66 == ((signed char) (max (var_1_8 , (max (var_1_25 , var_1_56))))))))) && (((var_1_81 + 5u) <= ((var_1_44 / var_1_59) / var_1_6)) ? (var_1_67 == ((unsigned char) (! (var_1_31 && var_1_40)))) : 1)) && (var_1_31 ? (var_1_69 == ((unsigned long int) (abs (4u)))) : (var_1_84 ? (var_1_69 == ((unsigned long int) ((var_1_46 + (var_1_47 + var_1_70)) - var_1_87))) : (var_1_69 == ((unsigned long int) (max (var_1_20 , (min (var_1_21 , var_1_56))))))))) && ((! var_1_90) ? (var_1_71 == ((unsigned char) ((var_1_42 || var_1_72) || (var_1_43 || var_1_73)))) : 1)) && ((var_1_81 > var_1_55) ? ((var_1_20 != var_1_9) ? (var_1_74 == ((double) var_1_14)) : (var_1_74 == ((double) (min (var_1_13 , (min (var_1_16 , var_1_14))))))) : (var_1_74 == ((double) (max (var_1_13 , (var_1_18 - var_1_14))))))) && ((var_1_89 < var_1_14) ? ((var_1_52 != var_1_4) ? (var_1_75 == ((unsigned char) (! var_1_73))) : (var_1_75 == ((unsigned char) var_1_76))) : 1)) && (var_1_77 == ((float) (max (1.8f , (min (var_1_16 , var_1_18))))))) && ((var_1_53 == (var_1_52 - var_1_85)) ? (var_1_78 == ((signed short int) var_1_80)) : (var_1_78 == ((signed short int) (var_1_61 + var_1_69))))) && (var_1_79 == ((signed long int) (-5 + var_1_87)))) && ((var_1_27 < last_1_var_1_102) ? (var_1_80 == ((unsigned long int) (max ((100000000u + var_1_23) , last_1_var_1_19)))) : (var_1_80 == ((unsigned long int) (max (var_1_62 , var_1_4)))))) && (var_1_81 == ((unsigned long int) ((var_1_82 + var_1_46) - last_1_var_1_54)))) && ((var_1_46 > var_1_56) ? (var_1_83 == ((unsigned char) (((var_1_81 + var_1_99) < var_1_88) || var_1_40))) : (var_1_83 == ((unsigned char) (! (! var_1_31)))))) && ((! (var_1_87 <= var_1_102)) ? (var_1_84 == ((unsigned char) (var_1_32 && (var_1_40 && var_1_43)))) : 1)) && ((last_1_var_1_19 != var_1_59) ? (var_1_85 == ((unsigned long int) (max (((last_1_var_1_101 + var_1_35) + (1422943038u - var_1_57)) , var_1_21)))) : ((! last_1_var_1_84) ? (var_1_85 == ((unsigned long int) (var_1_50 + 1u))) : (var_1_85 == ((unsigned long int) (min ((min (256u , var_1_35)) , var_1_25))))))) && ((var_1_22 != var_1_44) ? (var_1_86 == ((unsigned short int) (min (0 , var_1_21)))) : (var_1_86 == ((unsigned short int) var_1_23)))) && (var_1_87 == ((unsigned long int) var_1_58))) && (var_1_43 ? (var_1_88 == ((unsigned short int) last_1_var_1_88)) : 1)) && (var_1_89 == ((double) 4.75))) && (var_1_48 ? (var_1_90 == ((unsigned char) 0)) : (var_1_90 == ((unsigned char) var_1_40)))) && (var_1_91 == ((double) var_1_14))) && (var_1_92 == ((float) var_1_12))) && (var_1_93 == ((double) var_1_94))) && (var_1_95 == ((float) var_1_16))) && (var_1_96 == ((float) var_1_17))) && (var_1_75 ? (var_1_97 == ((signed short int) var_1_37)) : (var_1_97 == ((signed short int) var_1_100)))) && (var_1_76 ? (var_1_98 == ((double) var_1_13)) : (var_1_98 == ((double) var_1_14)))) && (var_1_48 ? (var_1_99 == ((unsigned long int) var_1_25)) : (var_1_99 == ((unsigned long int) var_1_4)))) && (var_1_100 == ((unsigned short int) var_1_50))) && (var_1_101 == ((signed long int) var_1_26))) && (((var_1_77 * (var_1_14 - 32.2)) < (var_1_18 - var_1_13)) ? ((var_1_85 <= (10000 * var_1_26)) ? (var_1_102 == ((unsigned char) var_1_23)) : (var_1_102 == ((unsigned char) var_1_58))) : (var_1_102 == ((unsigned char) var_1_22)))
;
}
int main(void) {
	isInitial = 1;
