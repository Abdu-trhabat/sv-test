...
void step(void) {
	...
	// From: Req2Batch107Wrapper_P
	unsigned long int stepLocal_0 = ~ (- (*(var_1_9_Pointer)));
	if (! ((*(var_1_5_Pointer)) >= (*(var_1_1_Pointer)))) {
		if ((min ((*(var_1_7_Pointer)) , (*(var_1_8_Pointer)))) >= stepLocal_0) {
			(*(var_1_6_Pointer)) = ((*(var_1_1_Pointer)) + ((*(var_1_10_Pointer)) + -2));
		} else {
			(*(var_1_6_Pointer)) = ((min ((abs (-8)) , (*(var_1_11_Pointer)))) - (*(var_1_12_Pointer)));
		}
	}


	// From: Req3Batch107Wrapper_P
	(*(var_1_13_Pointer)) = (*(var_1_5_Pointer));


	// From: Req4Batch107Wrapper_P
...
int property(void) {
	return (((((*(var_1_2_Pointer)) > ((*(var_1_3_Pointer)) - (*(var_1_4_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed char) (*(var_1_5_Pointer)))) : (((*(var_1_4_Pointer)) > (*(var_1_2_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed char) 10)) : ((*(var_1_1_Pointer)) == ((signed char) (*(var_1_5_Pointer)))))) && ((! ((*(var_1_5_Pointer)) >= (*(var_1_1_Pointer)))) ? (((min ((*(var_1_7_Pointer)) , (*(var_1_8_Pointer)))) >= (~ (- (*(var_1_9_Pointer))))) ? ((*(var_1_6_Pointer)) == ((signed short int) ((*(var_1_1_Pointer)) + ((*(var_1_10_Pointer)) + -2)))) : ((*(var_1_6_Pointer)) == ((signed short int) ((min ((abs (-8)) , (*(var_1_11_Pointer)))) - (*(var_1_12_Pointer)))))) : 1)) && ((*(var_1_13_Pointer)) == ((signed char) (*(var_1_5_Pointer))))) && (((*(var_1_7_Pointer)) <= (*(var_1_9_Pointer))) ? (((*(var_1_6_Pointer)) > (((*(var_1_15_Pointer)) - (*(var_1_16_Pointer))) - (*(var_1_17_Pointer)))) ? ((*(var_1_14_Pointer)) == ((signed char) (*(var_1_5_Pointer)))) : ((*(var_1_14_Pointer)) == ((signed char) -100))) : 1)
;
}
int main(void) {
	isInitial = 1;
