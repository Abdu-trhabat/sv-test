...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch75Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch75Amount50
	if (! (var_1_4 < 16.8f)) {
		var_1_15 = var_1_6;
	}


	// From: Req4Batch75Amount50
	if (var_1_8 > var_1_3) {
	...
	// From: Req5Batch75Amount50
	if ((- (var_1_17 + var_1_16)) >= var_1_16) {
		var_1_21 = (abs (-50));
	}


	// From: Req7Batch75Amount50
	var_1_25 = var_1_23;


	// From: Req6Batch75Amount50
...
int property(void) {
	return ((((((((-1 <= last_1_var_1_25) || last_1_var_1_7) ? (var_1_1 == ((float) (var_1_4 + (var_1_5 + var_1_6)))) : 1) && (((min ((var_1_3 + var_1_8) , (4 | var_1_9))) >= var_1_10) ? (var_1_7 == ((unsigned char) ((var_1_11 && var_1_12) && var_1_13))) : ((var_1_6 == var_1_1) ? (var_1_7 == ((unsigned char) var_1_14)) : (var_1_7 == ((unsigned char) var_1_13))))) && ((! (var_1_4 < 16.8f)) ? (var_1_15 == ((float) var_1_6)) : 1)) && ((var_1_8 > var_1_3) ? (var_1_16 == ((double) (((min (var_1_17 , var_1_18)) - var_1_19) - var_1_20))) : ((var_1_18 > (var_1_20 + (var_1_19 * var_1_17))) ? (var_1_16 == ((double) var_1_6)) : (var_1_16 == ((double) var_1_20))))) && (((- (var_1_17 + var_1_16)) >= var_1_16) ? (var_1_21 == ((signed char) (abs (-50)))) : 1)) && ((var_1_18 < (var_1_16 * var_1_4)) ? (((var_1_23 - var_1_24) < var_1_25) ? (var_1_22 == ((double) var_1_5)) : (var_1_22 == ((double) var_1_17))) : (var_1_22 == ((double) var_1_20)))) && (var_1_25 == ((unsigned long int) var_1_23))
;
}
int main(void) {
	isInitial = 1;
