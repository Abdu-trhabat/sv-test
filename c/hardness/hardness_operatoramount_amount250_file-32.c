...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch32Amount250.c", 13, "reach_error"); }
...
unsigned long int last_1_var_1_47 = 256;
...
void step(void) {
	...
	if (var_1_22 >= (- (var_1_35 - last_1_var_1_6))) {
		if (last_1_var_1_50 < last_1_var_1_36) {
			var_1_34 = (min (var_1_17 , 4));
		}
	} else {
		if (((last_1_var_1_49 != var_1_31) && (last_1_var_1_50 < var_1_17)) && var_1_5) {
			if (var_1_3) {
				var_1_34 = var_1_15;
			} else {
				var_1_34 = var_1_17;
	...
	signed long int stepLocal_4 = var_1_25;
	if (stepLocal_4 > (last_1_var_1_59 + var_1_14)) {
	...
	if (last_1_var_1_1) {
		if (last_1_var_1_42) {
			...
			if (((last_1_var_1_47 + last_1_var_1_21) * var_1_14) >= var_1_13) {
				var_1_21 = (var_1_22 - ((var_1_23 - var_1_18) - 256u));
			} else {
				if (last_1_var_1_21 <= (max (var_1_13 , (var_1_18 & var_1_10)))) {
	...
	if ((var_1_39 - (max (var_1_38 , var_1_37))) > (max (var_1_19 , var_1_29))) {
	...
	if (var_1_6 > var_1_10) {
		if (var_1_10 > (max (var_1_6 , var_1_59))) {
	...
	if (32u < var_1_6) {
		if (var_1_5 && var_1_1) {
			...
			if (var_1_4 || var_1_1) {
				var_1_47 = ((var_1_23 + var_1_48) - var_1_15);
			}
		}
	} else {
		var_1_47 = ((32u + (min (var_1_16 , var_1_21))) + var_1_18);
	}


	// From: Req17Batch32Amount250
	unsigned long int stepLocal_9 = var_1_21;
	signed char stepLocal_8 = var_1_14;
	unsigned char stepLocal_7 = var_1_1;
	if (stepLocal_9 <= last_1_var_1_50) {
		if (stepLocal_8 > (var_1_59 / (max (var_1_20 , var_1_18)))) {
			var_1_50 = ((var_1_51 - (min (var_1_12 , var_1_15))) - ((var_1_23 - var_1_47) - (var_1_13 + var_1_46)));
		} else {
			var_1_50 = ((max (var_1_51 , (var_1_52 - var_1_16))) - (max (var_1_13 , 16u)));
		}
	} else {
		if (stepLocal_7 && ((var_1_10 & var_1_12) < (var_1_6 + var_1_20))) {
			var_1_50 = var_1_16;
		} else {
			var_1_50 = var_1_51;
		}
	...
	if (((min (var_1_32 , var_1_31)) * var_1_29) < (var_1_37 - (var_1_38 - var_1_39))) {
		if (var_1_46 < ((var_1_10 & var_1_50) ^ (var_1_15 - var_1_16))) {
			var_1_36 = (var_1_34 + (min (var_1_24 , var_1_13)));
		}
	} else {
		if ((- var_1_29) <= ((var_1_33 / var_1_38) * var_1_29)) {
			if (var_1_5) {
				var_1_36 = (var_1_25 - var_1_18);
			} else {
				var_1_36 = (min (var_1_12 , (max (var_1_46 , (var_1_34 + var_1_13)))));
			}
		}
	}
	...
	unsigned long int stepLocal_3 = var_1_12 * var_1_50;
	if (stepLocal_3 > (abs (var_1_27))) {
...
int property(void) {
	return (((((((((((((((((((((last_1_var_1_42 ? (var_1_1 == ((unsigned char) ((! (var_1_3 || var_1_4)) && var_1_5))) : (var_1_1 == ((unsigned char) (var_1_5 && var_1_4)))) && ((var_1_27 == var_1_59) ? (var_1_6 == ((signed long int) var_1_9)) : ((! (! (var_1_27 < var_1_59))) ? (var_1_6 == ((signed long int) (min (var_1_9 , var_1_10)))) : 1))) && ((var_1_6 > var_1_10) ? ((var_1_10 > (max (var_1_6 , var_1_59))) ? (var_1_11 == ((signed char) ((var_1_12 - var_1_13) + (max (var_1_14 , (var_1_15 - var_1_16)))))) : (var_1_11 == ((signed char) (max (var_1_17 , (var_1_12 - (var_1_18 - var_1_16))))))) : 1)) && (((max ((var_1_18 / var_1_20) , var_1_15)) > var_1_12) ? (var_1_19 == ((double) (8.25 - 255.8))) : 1)) && (last_1_var_1_1 ? (last_1_var_1_42 ? (var_1_21 == ((unsigned long int) var_1_13)) : ((((last_1_var_1_47 + last_1_var_1_21) * var_1_14) >= var_1_13) ? (var_1_21 == ((unsigned long int) (var_1_22 - ((var_1_23 - var_1_18) - 256u)))) : ((last_1_var_1_21 <= (max (var_1_13 , (var_1_18 & var_1_10)))) ? (var_1_21 == ((unsigned long int) (var_1_22 - (var_1_23 - var_1_15)))) : 1))) : 1)) && ((var_1_9 > var_1_16) ? ((var_1_18 < var_1_59) ? (var_1_24 == ((signed long int) (var_1_15 + (var_1_17 + var_1_13)))) : (var_1_24 == ((signed long int) ((16 + (var_1_16 + var_1_18)) - (max ((max (var_1_12 , var_1_13)) , (var_1_25 - var_1_15))))))) : (var_1_24 == ((signed long int) var_1_14)))) && (((var_1_12 * var_1_50) > (abs (var_1_27))) ? (var_1_26 == ((unsigned char) (var_1_16 + var_1_18))) : 1)) && (((- var_1_19) > var_1_19) ? (var_1_27 == ((unsigned long int) (16u + var_1_15))) : (var_1_27 == ((unsigned long int) var_1_22)))) && ((var_1_25 > (last_1_var_1_59 + var_1_14)) ? (var_1_29 == ((double) (var_1_31 + ((abs (var_1_32)) + var_1_33)))) : (var_1_29 == ((double) ((var_1_32 + var_1_33) + var_1_31))))) && ((var_1_22 >= (- (var_1_35 - last_1_var_1_6))) ? ((last_1_var_1_50 < last_1_var_1_36) ? (var_1_34 == ((signed char) (min (var_1_17 , 4)))) : 1) : ((((last_1_var_1_49 != var_1_31) && (last_1_var_1_50 < var_1_17)) && var_1_5) ? (var_1_3 ? (var_1_34 == ((signed char) var_1_15)) : (var_1_34 == ((signed char) var_1_17))) : 1))) && ((((min (var_1_32 , var_1_31)) * var_1_29) < (var_1_37 - (var_1_38 - var_1_39))) ? ((var_1_46 < ((var_1_10 & var_1_50) ^ (var_1_15 - var_1_16))) ? (var_1_36 == ((signed long int) (var_1_34 + (min (var_1_24 , var_1_13))))) : 1) : (((- var_1_29) <= ((var_1_33 / var_1_38) * var_1_29)) ? (var_1_5 ? (var_1_36 == ((signed long int) (var_1_25 - var_1_18))) : (var_1_36 == ((signed long int) (min (var_1_12 , (max (var_1_46 , (var_1_34 + var_1_13)))))))) : 1))) && ((var_1_1 && var_1_3) ? (var_1_42 == ((unsigned char) ((var_1_3 || (! var_1_5)) || (! var_1_43)))) : 1)) && ((var_1_5 && var_1_42) ? (var_1_44 == ((signed char) (var_1_14 + var_1_15))) : (var_1_44 == ((signed char) var_1_13)))) && ((var_1_29 > var_1_32) ? (var_1_46 == ((unsigned char) var_1_16)) : 1)) && ((32u < var_1_6) ? ((var_1_5 && var_1_1) ? (((var_1_39 - var_1_37) <= 1.4) ? (var_1_47 == ((unsigned long int) var_1_25)) : (var_1_47 == ((unsigned long int) (var_1_22 - (max (var_1_12 , (var_1_16 + var_1_13))))))) : ((var_1_4 || var_1_1) ? (var_1_47 == ((unsigned long int) ((var_1_23 + var_1_48) - var_1_15))) : 1)) : (var_1_47 == ((unsigned long int) ((32u + (min (var_1_16 , var_1_21))) + var_1_18))))) && ((var_1_33 > var_1_38) ? (var_1_49 == ((double) (var_1_39 - (abs (max (50.25 , var_1_31)))))) : (var_1_49 == ((double) (max ((var_1_39 - 128.2) , var_1_32)))))) && ((var_1_21 <= last_1_var_1_50) ? ((var_1_14 > (var_1_59 / (max (var_1_20 , var_1_18)))) ? (var_1_50 == ((unsigned long int) ((var_1_51 - (min (var_1_12 , var_1_15))) - ((var_1_23 - var_1_47) - (var_1_13 + var_1_46))))) : (var_1_50 == ((unsigned long int) ((max (var_1_51 , (var_1_52 - var_1_16))) - (max (var_1_13 , 16u)))))) : ((var_1_1 && ((var_1_10 & var_1_12) < (var_1_6 + var_1_20))) ? (var_1_50 == ((unsigned long int) var_1_16)) : (var_1_50 == ((unsigned long int) var_1_51))))) && ((var_1_12 > var_1_27) ? (((abs (- var_1_35)) > var_1_51) ? (var_1_53 == ((signed char) var_1_12)) : 1) : ((var_1_16 <= (var_1_17 + var_1_50)) ? (var_1_53 == ((signed char) (var_1_14 + ((var_1_54 - var_1_55) - var_1_15)))) : (var_1_53 == ((signed char) (abs (min (-1 , (abs (var_1_14)))))))))) && (var_1_5 ? (var_1_56 == ((unsigned short int) (var_1_57 - var_1_26))) : (var_1_56 == ((unsigned short int) (min (((var_1_58 - var_1_55) - var_1_12) , var_1_54)))))) && (((var_1_39 - (max (var_1_38 , var_1_37))) > (max (var_1_19 , var_1_29))) ? ((var_1_13 >= (var_1_25 + var_1_51)) ? (var_1_59 == ((unsigned long int) var_1_55)) : (var_1_59 == ((unsigned long int) var_1_16))) : (var_1_59 == ((unsigned long int) var_1_18)))) && (var_1_4 ? (var_1_60 == ((unsigned char) var_1_18)) : (var_1_60 == ((unsigned char) var_1_16)))) && ((var_1_36 > 25) ? ((var_1_4 || var_1_1) ? (var_1_61 == ((unsigned char) (! (var_1_3 && var_1_4)))) : (var_1_5 ? (var_1_61 == ((unsigned char) var_1_43)) : (var_1_61 == ((unsigned char) var_1_3)))) : (var_1_61 == ((unsigned char) var_1_3)))
;
}
int main(void) {
	isInitial = 1;
