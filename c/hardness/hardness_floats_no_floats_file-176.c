...
void step(void) {
	// From: Req1Batch176no_floats
	var_1_1 = ((10000000 + 5) - (var_1_2 - var_1_3));


	// From: Req2Batch176no_floats
	if (var_1_2 > 32) {
		var_1_4 = var_1_5;
	} else {
