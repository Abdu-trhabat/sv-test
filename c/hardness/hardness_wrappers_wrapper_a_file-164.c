...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]) {
		if ((signed_long_int_Array_0[1][2] + signed_long_int_Array_0[0][2]) <= -1) {
			...
			if (signed_long_int_Array_0[0][2] > ((min (signed_long_int_Array_0[1][2] , signed_long_int_Array_0[1][1])) * signed_long_int_Array_0[0][1])) {
				double_Array_0[1][1] = (double_Array_0[0][0] - double_Array_0[1][0]);
			} else {
				double_Array_0[1][1] = (min (99.5 , double_Array_0[0][1]));
			}
		}
	} else {
		double_Array_0[1][1] = double_Array_0[0][1];
	...
	if ((signed_long_int_Array_0[0][0] - signed_long_int_Array_0[1][0]) <= stepLocal_0) {
		unsigned_short_int_Array_0[0][0] = (min (5 , unsigned_short_int_Array_0[0][1]));
	}


	// From: Req3Batch164Wrapper_A
