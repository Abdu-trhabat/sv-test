...
void step(void) {
	...
	/* 356L, 260L) */ if (/* 357L, 219L, 220L) */ ((var_1_41) >= (var_1_46))) {
		...
		/* 369L, 258L) */ if (/* 370L, 239L, 240L) */ ((/* 371L, 237L, 241L) */ ((var_1_19) / (var_1_38))) < (var_1_33))) {
			/* 375L, 253L) */ var_1_57 = (
				var_1_59
			);
		} else {
	...
	// From: CodeObject4
	/* 304L, 138L) */ if (/* 305L, 115L, 116L) */ ((var_1_1) > (/* 307L, 114L, 118L) */ (abs (/* 308L, 113L, 119L) */ (max (/* 308L, 113L, 119L) */ (var_1_46) , (var_1_47)))))))) {
		/* 311L, 133L) */ var_1_45 = (
			/* 314L, 132L) */ ((
				var_1_48
			) - (
