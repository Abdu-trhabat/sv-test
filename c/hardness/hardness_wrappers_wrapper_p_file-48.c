...
void step(void) {
	...
	if ((*(var_1_8_Pointer))) {
		if (((abs (16)) + (*(var_1_9_Pointer))) <= (*(var_1_10_Pointer))) {
			(*(var_1_7_Pointer)) = (max (0 , (*(var_1_11_Pointer))));
		} else {
			(*(var_1_7_Pointer)) = ((*(var_1_12_Pointer)) + (abs (5)));
		}
	}
	...
	if (((*(var_1_12_Pointer)) * (*(var_1_10_Pointer))) < (*(var_1_7_Pointer))) {
		(*(var_1_13_Pointer)) = (max ((*(var_1_6_Pointer)) , ((*(var_1_14_Pointer)) + ((*(var_1_15_Pointer)) + (*(var_1_16_Pointer))))));
	} else {
		if ((max ((*(var_1_7_Pointer)) , (*(var_1_10_Pointer)))) <= 50) {
...
int property(void) {
	return ((((*(var_1_2_Pointer)) <= (*(var_1_3_Pointer))) ? (((*(var_1_3_Pointer)) < (((*(var_1_4_Pointer)) - (*(var_1_5_Pointer))) + 1.395f)) ? ((*(var_1_1_Pointer)) == ((float) (*(var_1_6_Pointer)))) : ((*(var_1_1_Pointer)) == ((float) 3.25f))) : ((*(var_1_1_Pointer)) == ((float) (*(var_1_6_Pointer))))) && ((*(var_1_8_Pointer)) ? ((((abs (16)) + (*(var_1_9_Pointer))) <= (*(var_1_10_Pointer))) ? ((*(var_1_7_Pointer)) == ((unsigned short int) (max (0 , (*(var_1_11_Pointer)))))) : ((*(var_1_7_Pointer)) == ((unsigned short int) ((*(var_1_12_Pointer)) + (abs (5)))))) : 1)) && ((((*(var_1_12_Pointer)) * (*(var_1_10_Pointer))) < (*(var_1_7_Pointer))) ? ((*(var_1_13_Pointer)) == ((float) (max ((*(var_1_6_Pointer)) , ((*(var_1_14_Pointer)) + ((*(var_1_15_Pointer)) + (*(var_1_16_Pointer)))))))) : (((max ((*(var_1_7_Pointer)) , (*(var_1_10_Pointer)))) <= 50) ? ((*(var_1_13_Pointer)) == ((float) (*(var_1_16_Pointer)))) : ((*(var_1_13_Pointer)) == ((float) (*(var_1_15_Pointer))))))
;
}
int main(void) {
	isInitial = 1;
