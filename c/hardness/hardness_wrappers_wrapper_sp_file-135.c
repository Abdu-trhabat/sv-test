...
void step(void) {
	...
	if (stepLocal_0 < (((*(WrapperStruct00_var_1_3_Pointer)) * (*(WrapperStruct00_var_1_9_Pointer))) * ((*(WrapperStruct00_var_1_8_Pointer)) * last_1_WrapperStruct00_var_1_10))) {
		(*(WrapperStruct00_var_1_10_Pointer)) = (max ((min (last_1_WrapperStruct00_var_1_10 , (*(WrapperStruct00_var_1_8_Pointer)))) , (*(WrapperStruct00_var_1_9_Pointer))));
	} else {
		(*(WrapperStruct00_var_1_10_Pointer)) = ((max ((*(WrapperStruct00_var_1_8_Pointer)) , last_1_WrapperStruct00_var_1_10)) + (*(WrapperStruct00_var_1_8_Pointer)));
	}


	// From: Req4Batch135Wrapper_SP
	if (((*(WrapperStruct00_var_1_10_Pointer)) / (min ((*(WrapperStruct00_var_1_14_Pointer)) , (*(WrapperStruct00_var_1_15_Pointer))))) > (*(WrapperStruct00_var_1_8_Pointer))) {
