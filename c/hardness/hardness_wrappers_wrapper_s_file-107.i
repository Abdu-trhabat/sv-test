...
void step(void) {
 ...
 if (! (WrapperStruct00.var_1_5 >= WrapperStruct00.var_1_1)) {
  if (((((WrapperStruct00.var_1_7) < (WrapperStruct00.var_1_8)) ? (WrapperStruct00.var_1_7) : (WrapperStruct00.var_1_8))) >= stepLocal_0) {
   WrapperStruct00.var_1_6 = (WrapperStruct00.var_1_1 + (WrapperStruct00.var_1_10 + -2));
  } else {
   WrapperStruct00.var_1_6 = (((((((((-8) < 0 ) ? -(-8) : (-8)))) < (WrapperStruct00.var_1_11)) ? (((((-8) < 0 ) ? -(-8) : (-8)))) : (WrapperStruct00.var_1_11))) - WrapperStruct00.var_1_12);
  }
 }
