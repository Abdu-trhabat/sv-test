...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch41stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_1 || (var_1_12 < var_1_8)) {
  if (! var_1_5) {
   var_1_13 = var_1_14;
  } else {
   var_1_13 = 256.5f;
 ...
 unsigned char stepLocal_4 = var_1_14 == var_1_2;
