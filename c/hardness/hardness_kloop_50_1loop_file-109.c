...
void step(void) {
	...
	// From: Req2Batch10950_1loop
	var_1_6 = (max (var_1_7 , ((10 + var_1_8) + var_1_9)));


	// From: Req7Batch10950_1loop
	...
	// From: Req8Batch10950_1loop
	var_1_20 = var_1_19;


	// From: Req9Batch10950_1loop
	var_1_21 = var_1_9;


	// From: Req1Batch10950_1loop
	if (var_1_6 < var_1_18) {
