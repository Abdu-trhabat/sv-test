...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch192dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch192dependencies
	if (var_1_2 != var_1_3) {
		if (last_1_var_1_10 || last_1_var_1_18) {
			var_1_1 = (var_1_6 - var_1_7);
		} else {
			var_1_1 = (max ((max (5u , var_1_6)) , ((min (var_1_8 , var_1_9)) - var_1_7)));
		}
	}


	// From: Req2Batch192dependencies
	if (-25 < var_1_1) {
		if (! last_1_var_1_10) {
			if (var_1_6 >= var_1_7) {
				var_1_10 = var_1_11;
	...
	// From: Req4Batch192dependencies
	if (var_1_8 > var_1_13) {
		var_1_14 = ((min (8.4f , (1.25f + var_1_15))) + (var_1_16 - var_1_17));
	} else {
		var_1_14 = var_1_17;
	}


	// From: Req5Batch192dependencies
	if (var_1_9 > var_1_13) {
...
int property(void) {
	return ((((((var_1_2 != var_1_3) ? ((last_1_var_1_10 || last_1_var_1_18) ? (var_1_1 == ((unsigned long int) (var_1_6 - var_1_7))) : (var_1_1 == ((unsigned long int) (max ((max (5u , var_1_6)) , ((min (var_1_8 , var_1_9)) - var_1_7)))))) : 1) && ((-25 < var_1_1) ? ((! last_1_var_1_10) ? ((var_1_6 >= var_1_7) ? (var_1_10 == ((unsigned char) var_1_11)) : (var_1_10 == ((unsigned char) var_1_12))) : (var_1_10 == ((unsigned char) var_1_11))) : 1)) && ((var_1_8 == 1u) ? ((var_1_9 >= (2354073364u - var_1_7)) ? (var_1_13 == ((unsigned long int) var_1_6)) : 1) : 1)) && ((var_1_8 > var_1_13) ? (var_1_14 == ((float) ((min (8.4f , (1.25f + var_1_15))) + (var_1_16 - var_1_17)))) : (var_1_14 == ((float) var_1_17)))) && ((var_1_9 > var_1_13) ? (((var_1_17 * var_1_16) == var_1_14) ? (var_1_18 == ((unsigned char) var_1_11)) : (var_1_18 == ((unsigned char) var_1_12))) : (var_1_18 == ((unsigned char) var_1_12)))) && (((var_1_20 - (var_1_21 - var_1_22)) < var_1_13) ? (var_1_19 == ((signed long int) ((200 - var_1_22) + var_1_21))) : (var_1_19 == ((signed long int) var_1_23)))
;
}
int main(void) {
	isInitial = 1;
