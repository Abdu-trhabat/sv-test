...
void step(void) {
	// From: Req1Batch131Wrapper_P
	if ((~ ((*(var_1_2_Pointer)) * (*(var_1_3_Pointer)))) < ((*(var_1_4_Pointer)) / (max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))))) {
		(*(var_1_1_Pointer)) = (! ((*(var_1_7_Pointer)) || (*(var_1_8_Pointer))));
	}


	// From: Req2Batch131Wrapper_P
	...
	// From: Req3Batch131Wrapper_P
	unsigned long int stepLocal_1 = (*(var_1_4_Pointer));
	if (stepLocal_1 >= (*(var_1_5_Pointer))) {
		(*(var_1_12_Pointer)) = (min ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer))));
	} else {
		(*(var_1_12_Pointer)) = (max ((*(var_1_13_Pointer)) , (max ((*(var_1_14_Pointer)) , (*(var_1_15_Pointer))))));
	}


	// From: Req4Batch131Wrapper_P
	unsigned long int stepLocal_2 = ((*(var_1_2_Pointer)) / (*(var_1_6_Pointer))) + (*(var_1_5_Pointer));
	if ((*(var_1_14_Pointer)) <= stepLocal_2) {
		(*(var_1_16_Pointer)) = ((*(var_1_17_Pointer)) - ((*(var_1_18_Pointer)) + (abs ((*(var_1_19_Pointer))))));
	} else {
...
int property(void) {
	return (((((~ ((*(var_1_2_Pointer)) * (*(var_1_3_Pointer)))) < ((*(var_1_4_Pointer)) / (max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (! ((*(var_1_7_Pointer)) || (*(var_1_8_Pointer)))))) : 1) && (((*(var_1_5_Pointer)) == (- (*(var_1_3_Pointer)))) ? ((*(var_1_9_Pointer)) == ((signed short int) ((*(var_1_10_Pointer)) - (*(var_1_11_Pointer))))) : ((*(var_1_9_Pointer)) == ((signed short int) (*(var_1_10_Pointer)))))) && (((*(var_1_4_Pointer)) >= (*(var_1_5_Pointer))) ? ((*(var_1_12_Pointer)) == ((signed char) (min ((*(var_1_13_Pointer)) , (*(var_1_14_Pointer)))))) : ((*(var_1_12_Pointer)) == ((signed char) (max ((*(var_1_13_Pointer)) , (max ((*(var_1_14_Pointer)) , (*(var_1_15_Pointer)))))))))) && (((*(var_1_14_Pointer)) <= (((*(var_1_2_Pointer)) / (*(var_1_6_Pointer))) + (*(var_1_5_Pointer)))) ? ((*(var_1_16_Pointer)) == ((unsigned short int) ((*(var_1_17_Pointer)) - ((*(var_1_18_Pointer)) + (abs ((*(var_1_19_Pointer)))))))) : ((*(var_1_16_Pointer)) == ((unsigned short int) (*(var_1_20_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
