...
void step(void) {
	// From: Req1Batch146Amount10
	unsigned long int stepLocal_0 = 10u >> (var_1_2 + 5u);
	if (stepLocal_0 == var_1_3) {
		var_1_1 = (var_1_4 + (min (var_1_5 , var_1_6)));
	}


	// From: Req2Batch146Amount10
	var_1_7 = var_1_2;


	// From: Req3Batch146Amount10
	var_1_8 = var_1_2;


	// From: Req4Batch146Amount10
	var_1_9 = var_1_5;
}
...
int property(void) {
	return (((((10u >> (var_1_2 + 5u)) == var_1_3) ? (var_1_1 == ((float) (var_1_4 + (min (var_1_5 , var_1_6))))) : 1) && (var_1_7 == ((signed char) var_1_2))) && (var_1_8 == ((signed char) var_1_2))) && (var_1_9 == ((double) var_1_5))
;
}
int main(void) {
	isInitial = 1;
