...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch77Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	/* 317L, 162L) */ if (/* 318L, 144L, 145L) */ ((var_1_28) <= (var_1_1))) {
		/* 321L, 156L) */ var_1_35 = (
			/* 324L, 155L) */ (abs (
				/* 325L, 154L) */ (abs (
					var_1_1
	...
	// From: CodeObject3
	/* 266L, 92L) */ if (/* 267L, 35L, 36L) */ ((var_1_8) >= (/* 269L, 34L, 38L) */ ((var_1_13) * (var_1_28))))) {
		/* 272L, 81L) */ if (/* 273L, 61L, 62L) */ ((/* 274L, 59L, 63L) */ (max (/* 274L, 59L, 63L) */ (var_1_8) , (var_1_13)))) < (var_1_13))) {
			/* 278L, 79L) */ if (var_1_31) {
				/* 280L, 78L) */ var_1_30 = (
					var_1_13
				);
			}
	...
	// From: CodeObject7
	/* 356L, 218L) */ if (/* 357L, 171L, 172L) */ ((var_1_34) != (/* 359L, 170L, 174L) */ ((var_1_25) + (var_1_27))))) {
		/* 362L, 216L) */ if (/* 363L, 186L, 187L) */ ((/* 364L, 184L, 188L) */ ((var_1_34) | (var_1_27))) <= (var_1_30))) {
			/* 368L, 214L) */ if (/* 369L, 200L, 201L) */ ((/* 370L, 198L, 202L) */ (~ (var_1_25))) <= (var_1_27))) {
				/* 373L, 213L) */ var_1_36 = (
					/* 376L, 212L) */ (abs (
						var_1_28
					))
	...
	// From: CodeObject4
	/* 293L, 116L) */ if (/* 294L, 100L, 101L) */ ((var_1_31) || (/* 296L, 99L, 103L) */ ((var_1_28) >= (var_1_13))))) {
		/* 299L, 115L) */ var_1_32 = (
			/* 302L, 114L) */ (! (
				var_1_33
			))
