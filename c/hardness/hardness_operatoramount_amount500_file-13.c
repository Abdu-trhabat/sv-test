...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13Amount500.c", 13, "reach_error"); }
...
unsigned short int last_1_var_1_33 = 10000;
signed short int last_1_var_1_39 = 50;
unsigned long int last_1_var_1_45 = 0;
double last_1_var_1_58 = 2.1;
unsigned long int last_1_var_1_69 = 5;
float last_1_var_1_76 = 25.8;
signed long int last_1_var_1_86 = -16;
signed long int last_1_var_1_91 = -8;
signed short int last_1_var_1_95 = 64;
signed long int last_1_var_1_101 = -100000;
...
void step(void) {
	...
	if (var_1_26) {
		if ((1 >= last_1_var_1_69) && stepLocal_16) {
			if (last_1_var_1_1) {
	...
	if (last_1_var_1_58 <= ((last_1_var_1_58 + var_1_25) / var_1_59)) {
		var_1_65 = (max ((min (var_1_66 , var_1_32)) , ((var_1_19 - var_1_36) + var_1_55)));
	}


	// From: Req40Batch13Amount500
	signed long int stepLocal_27 = last_1_var_1_86;
	unsigned long int stepLocal_26 = - var_1_70;
	if (stepLocal_27 > (abs (last_1_var_1_101))) {
		if (var_1_71 != stepLocal_26) {
			var_1_101 = ((max (1 , var_1_8)) - var_1_56);
		}
	}


	// From: Req13Batch13Amount500
	unsigned long int stepLocal_6 = (last_1_var_1_21 / var_1_30) + last_1_var_1_33;
	if (var_1_25 > last_1_var_1_76) {
		var_1_45 = ((abs (var_1_46)) - (abs (last_1_var_1_45)));
	} else {
		if (last_1_var_1_86 <= stepLocal_6) {
			var_1_45 = ((max (var_1_46 , (var_1_19 + 1996542993u))) - (var_1_36 + (max (var_1_31 , var_1_35))));
		} else {
			var_1_45 = (min ((var_1_22 + var_1_36) , (min (var_1_20 , last_1_var_1_33))));
		}
	}
	...
	if (stepLocal_29 && last_1_var_1_102) {
		if (var_1_23 >= stepLocal_28) {
	...
	if ((last_1_var_1_114 <= last_1_var_1_101) || last_1_var_1_102) {
		var_1_1 = 0;
	}
	...
	if ((! var_1_43) && stepLocal_7) {
		var_1_48 = (var_1_45 - var_1_31);
	}
	...
	unsigned long int stepLocal_13 = var_1_66 + var_1_64;
	if (var_1_106 != stepLocal_13) {
	...
	if (var_1_37 > (var_1_25 + (var_1_77 - var_1_80))) {
	...
	if ((- var_1_30) < (var_1_104 | (var_1_65 - var_1_64))) {
		var_1_87 = ((abs (var_1_32 + var_1_54)) + var_1_104);
	}


	// From: Req20Batch13Amount500
	if (! (var_1_104 > var_1_65)) {
		var_1_57 = var_1_31;
	} else {
	...
	unsigned long int stepLocal_3 = var_1_106;
	if (stepLocal_3 >= (var_1_6 * var_1_20)) {
		if (var_1_81) {
			var_1_21 = (((var_1_22 - var_1_8) + var_1_20) + (abs (var_1_19)));
		} else {
			var_1_21 = (min ((abs (var_1_19)) , (var_1_22 + (var_1_8 + var_1_20))));
		}
	} else {
		if (stepLocal_4 < var_1_19) {
			var_1_21 = (var_1_22 + var_1_23);
		} else {
			var_1_21 = (var_1_19 + (max (var_1_20 , var_1_22)));
		}
	}
	...
	if (var_1_69 > var_1_55) {
		if (var_1_16 > var_1_67) {
			var_1_68 = var_1_38;
		}
	} else {
	...
	unsigned char stepLocal_15 = var_1_45 >= var_1_55;
	unsigned short int stepLocal_14 = var_1_109;
	if (var_1_10 <= stepLocal_14) {
		var_1_72 = (var_1_32 - var_1_54);
	} else {
		if ((var_1_23 <= (var_1_46 - var_1_70)) && stepLocal_15) {
	...
	if (-16 != (var_1_21 * var_1_35)) {
		var_1_47 = (max (var_1_57 , var_1_7));
	} else {
	...
	if (! var_1_28) {
		...
		var_1_61 = ((var_1_35 - var_1_47) + var_1_54);
	}


	// From: Req12Batch13Amount500
	if (var_1_102) {
		if (var_1_102 && (var_1_24 || var_1_28)) {
			var_1_41 = 0;
		} else {
	...
	if ((min (var_1_32 , var_1_22)) < var_1_114) {
		if ((var_1_38 <= 32.8f) || var_1_41) {
			if (var_1_26) {
	...
	signed long int stepLocal_9 = var_1_36 % var_1_30;
	signed short int stepLocal_8 = var_1_8;
	if (var_1_106 <= stepLocal_9) {
		if ((var_1_19 | var_1_5) >= stepLocal_8) {
			if (1.3f == var_1_111) {
				var_1_50 = var_1_38;
			}
		} else {
	...
	signed char stepLocal_2 = var_1_98;
	signed long int stepLocal_1 = 2 | 32;
	if (stepLocal_2 > var_1_101) {
		var_1_13 = ((var_1_15 - var_1_16) + ((max (var_1_17 , 499.25)) + var_1_18));
	} else {
		if (stepLocal_1 <= (var_1_8 - (var_1_19 - var_1_20))) {
	...
	unsigned char stepLocal_19 = var_1_45 <= (var_1_66 * var_1_54);
	signed char stepLocal_18 = var_1_11;
	unsigned long int stepLocal_17 = var_1_69 | (abs (var_1_19));
	if (stepLocal_19 || var_1_1) {
		if (var_1_54 > stepLocal_18) {
			var_1_86 = (max ((var_1_54 + (min (var_1_61 , var_1_7))) , var_1_47));
		}
	} else {
		if (stepLocal_17 != (abs (var_1_30))) {
			var_1_86 = (abs (var_1_45));
		}
	}
	...
	unsigned long int stepLocal_12 = -10 * var_1_21;
	unsigned short int stepLocal_11 = var_1_104;
	if (stepLocal_11 < var_1_48) {
		if (stepLocal_12 < ((var_1_86 * var_1_29) * var_1_46)) {
			if (var_1_76 > var_1_18) {
	...
	unsigned long int stepLocal_22 = - var_1_21;
	if (2.25f >= (var_1_80 - var_1_15)) {
		if (stepLocal_22 < (var_1_86 / (min (var_1_30 , var_1_54)))) {
			var_1_91 = (max (var_1_61 , last_1_var_1_91));
		}
	}


	// From: Req37Batch13Amount500
	signed long int stepLocal_25 = var_1_32 - (var_1_54 + var_1_55);
	signed long int stepLocal_24 = var_1_91;
	unsigned long int stepLocal_23 = var_1_70;
	if (-1000 >= stepLocal_24) {
		var_1_93 = ((var_1_74 + var_1_94) - var_1_75);
	} else {
		if (var_1_95 > stepLocal_25) {
			if (var_1_41) {
	...
	if (((var_1_16 / var_1_25) / var_1_59) < (var_1_13 * (var_1_38 - var_1_15))) {
		if (var_1_55 >= var_1_7) {
			if (var_1_102 || (var_1_87 <= var_1_101)) {
	...
	if (var_1_58 < (var_1_15 - var_1_16)) {
		var_1_33 = (max ((var_1_31 + (var_1_35 - var_1_113)) , (var_1_36 - 256)));
	} else {
	...
	if (stepLocal_5 && (var_1_30 >= var_1_36)) {
		var_1_39 = (min ((-500 + last_1_var_1_39) , (var_1_11 + var_1_52)));
	}


	// From: Req16Batch13Amount500
	var_1_49 = (var_1_12 + (max (var_1_39 , var_1_30)));


	// From: Req18Batch13Amount500
	if ((var_1_69 & var_1_32) <= var_1_91) {
		if ((var_1_21 * var_1_32) == var_1_19) {
			var_1_51 = (2 + (max (var_1_104 , var_1_30)));
		}
	}
	...
	signed long int stepLocal_20 = var_1_49;
	if (stepLocal_21 == var_1_49) {
		if (stepLocal_20 < var_1_114) {
...
void updateVariables(void) {
	...
	assume_abort_if_not((var_1_78 >= 0.0F && var_1_78 <= -1.0e-20F) || (var_1_78 <= 2305843.009213691400e+12F && var_1_78 >= 1.0e-20F ));
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((((((last_1_var_1_114 <= last_1_var_1_101) || last_1_var_1_102) ? (var_1_1 == ((unsigned char) 0)) : 1) && ((var_1_110 || var_1_24) ? (var_1_5 == ((signed short int) (min (50 , var_1_6)))) : (var_1_24 ? (var_1_5 == ((signed short int) (var_1_7 - var_1_8))) : 1))) && ((var_1_47 > var_1_7) ? (var_1_9 == ((signed char) ((var_1_10 + var_1_11) + var_1_12))) : 1)) && ((var_1_98 > var_1_101) ? (var_1_13 == ((double) ((var_1_15 - var_1_16) + ((max (var_1_17 , 499.25)) + var_1_18)))) : (((2 | 32) <= (var_1_8 - (var_1_19 - var_1_20))) ? (var_1_13 == ((double) (min (4.8 , var_1_17)))) : (var_1_13 == ((double) (var_1_18 + var_1_16)))))) && ((var_1_106 >= (var_1_6 * var_1_20)) ? (var_1_81 ? (var_1_21 == ((unsigned long int) (((var_1_22 - var_1_8) + var_1_20) + (abs (var_1_19))))) : (var_1_21 == ((unsigned long int) (min ((abs (var_1_19)) , (var_1_22 + (var_1_8 + var_1_20))))))) : ((var_1_8 < var_1_19) ? (var_1_21 == ((unsigned long int) (var_1_22 + var_1_23))) : (var_1_21 == ((unsigned long int) (var_1_19 + (max (var_1_20 , var_1_22)))))))) && (((9.5f / var_1_25) != var_1_18) ? ((! var_1_110) ? ((var_1_16 > (- var_1_15)) ? (var_1_24 == ((unsigned char) (var_1_26 || var_1_27))) : (var_1_24 == ((unsigned char) ((var_1_27 && var_1_26) || (! (! var_1_28)))))) : (var_1_24 == ((unsigned char) (var_1_26 || var_1_27)))) : (var_1_24 == ((unsigned char) (! var_1_28))))) && (var_1_1 ? (var_1_29 == ((unsigned char) (var_1_30 - (64 + var_1_31)))) : ((4u <= var_1_30) ? (var_1_29 == ((unsigned char) ((max ((var_1_32 - 16) , var_1_30)) - var_1_31))) : (var_1_29 == ((unsigned char) var_1_32))))) && ((var_1_58 < (var_1_15 - var_1_16)) ? (var_1_33 == ((unsigned short int) (max ((var_1_31 + (var_1_35 - var_1_113)) , (var_1_36 - 256))))) : (var_1_33 == ((unsigned short int) (var_1_36 - var_1_30))))) && ((! var_1_102) ? ((var_1_17 < (var_1_25 * var_1_18)) ? (var_1_26 ? (var_1_37 == ((float) (var_1_15 + var_1_16))) : (var_1_37 == ((float) ((var_1_15 - (max (var_1_16 , var_1_38))) + var_1_18)))) : (var_1_37 == ((float) (var_1_38 + var_1_17)))) : 1)) && ((var_1_81 && (var_1_30 >= var_1_36)) ? (var_1_39 == ((signed short int) (min ((-500 + last_1_var_1_39) , (var_1_11 + var_1_52))))) : 1)) && (var_1_110 ? (var_1_40 == ((unsigned char) var_1_30)) : (var_1_40 == ((unsigned char) 0)))) && (var_1_102 ? ((var_1_102 && (var_1_24 || var_1_28)) ? (var_1_41 == ((unsigned char) 0)) : (var_1_41 == ((unsigned char) (var_1_28 || var_1_42)))) : (var_1_41 == ((unsigned char) (((var_1_27 || var_1_42) && var_1_43) && var_1_44))))) && ((var_1_25 > last_1_var_1_76) ? (var_1_45 == ((unsigned long int) ((abs (var_1_46)) - (abs (last_1_var_1_45))))) : ((last_1_var_1_86 <= ((last_1_var_1_21 / var_1_30) + last_1_var_1_33)) ? (var_1_45 == ((unsigned long int) ((max (var_1_46 , (var_1_19 + 1996542993u))) - (var_1_36 + (max (var_1_31 , var_1_35)))))) : (var_1_45 == ((unsigned long int) (min ((var_1_22 + var_1_36) , (min (var_1_20 , last_1_var_1_33))))))))) && ((-16 != (var_1_21 * var_1_35)) ? (var_1_47 == ((signed long int) (max (var_1_57 , var_1_7)))) : (((min (var_1_15 , 63.6)) <= var_1_38) ? ((var_1_45 <= 10u) ? (var_1_47 == ((signed long int) 256)) : 1) : 1))) && (((! var_1_43) && var_1_102) ? (var_1_48 == ((signed short int) (var_1_45 - var_1_31))) : 1)) && (var_1_49 == ((signed long int) (var_1_12 + (max (var_1_39 , var_1_30)))))) && ((var_1_106 <= (var_1_36 % var_1_30)) ? (((var_1_19 | var_1_5) >= var_1_8) ? ((1.3f == var_1_111) ? (var_1_50 == ((double) var_1_38)) : 1) : ((var_1_24 && var_1_43) ? (var_1_50 == ((double) ((min (var_1_17 , var_1_15)) + var_1_16))) : (var_1_50 == ((double) (var_1_16 - (var_1_38 + var_1_15)))))) : (var_1_50 == ((double) (min (3.5 , var_1_17)))))) && (((var_1_69 & var_1_32) <= var_1_91) ? (((var_1_21 * var_1_32) == var_1_19) ? (var_1_51 == ((signed short int) (2 + (max (var_1_104 , var_1_30))))) : 1) : 1)) && ((var_1_104 < var_1_48) ? (((-10 * var_1_21) < ((var_1_86 * var_1_29) * var_1_46)) ? ((var_1_76 > var_1_18) ? (var_1_52 == ((signed char) ((var_1_31 - (var_1_54 - var_1_55)) + var_1_10))) : (var_1_27 ? (var_1_52 == ((signed char) (min (var_1_32 , var_1_31)))) : (var_1_52 == ((signed char) (var_1_54 - (min (var_1_55 , (var_1_31 + var_1_56)))))))) : (var_1_52 == ((signed char) (var_1_12 + var_1_10)))) : (var_1_52 == ((signed char) (max (var_1_56 , var_1_54)))))) && ((! (var_1_104 > var_1_65)) ? (var_1_57 == ((unsigned short int) var_1_31)) : (var_1_57 == ((unsigned short int) ((var_1_55 + var_1_30) + (var_1_35 - var_1_56)))))) && ((((var_1_16 / var_1_25) / var_1_59) < (var_1_13 * (var_1_38 - var_1_15))) ? ((var_1_55 >= var_1_7) ? ((var_1_102 || (var_1_87 <= var_1_101)) ? (var_1_58 == ((double) (min (var_1_38 , var_1_18)))) : 1) : (var_1_58 == ((double) (var_1_15 - var_1_38)))) : 1)) && ((! var_1_28) ? (var_1_61 == ((unsigned short int) (abs (var_1_36 - var_1_35)))) : (var_1_61 == ((unsigned short int) ((var_1_35 - var_1_47) + var_1_54))))) && (((- (- 128)) >= ((max (var_1_10 , var_1_36)) * var_1_35)) ? (var_1_62 == ((signed char) (var_1_10 + var_1_12))) : (var_1_62 == ((signed char) (max (((var_1_64 - var_1_31) - (max (var_1_54 , var_1_56))) , var_1_10)))))) && ((last_1_var_1_58 <= ((last_1_var_1_58 + var_1_25) / var_1_59)) ? (var_1_65 == ((unsigned long int) (max ((min (var_1_66 , var_1_32)) , ((var_1_19 - var_1_36) + var_1_55))))) : 1)) && ((var_1_106 != (var_1_66 + var_1_64)) ? (var_1_67 == ((double) (abs (var_1_17)))) : (var_1_67 == ((double) (min (9.2 , (var_1_38 - var_1_16))))))) && ((var_1_69 > var_1_55) ? ((var_1_16 > var_1_67) ? (var_1_68 == ((double) var_1_38)) : 1) : (var_1_68 == ((double) (var_1_15 - (max (var_1_16 , var_1_38))))))) && ((var_1_20 > var_1_45) ? (var_1_81 ? (var_1_69 == ((unsigned long int) (((var_1_70 - var_1_35) + var_1_71) - var_1_31))) : 1) : 1)) && ((var_1_10 <= var_1_109) ? (var_1_72 == ((unsigned char) (var_1_32 - var_1_54))) : (((var_1_23 <= (var_1_46 - var_1_70)) && (var_1_45 >= var_1_55)) ? (var_1_72 == ((unsigned char) (var_1_64 + (var_1_74 - (var_1_55 + var_1_75))))) : 1))) && ((((var_1_38 - var_1_16) / var_1_25) != var_1_17) ? ((var_1_38 >= var_1_13) ? (var_1_76 == ((float) (var_1_38 - var_1_15))) : (var_1_76 == ((float) (8.75f + (abs (var_1_16)))))) : (var_1_76 == ((float) (((var_1_77 + var_1_78) - (var_1_79 + var_1_80)) + var_1_38))))) && (var_1_26 ? (((1 >= last_1_var_1_69) && var_1_43) ? (last_1_var_1_1 ? (var_1_81 == ((unsigned char) ((var_1_27 || (var_1_28 || var_1_82)) || (var_1_83 || var_1_84)))) : 1) : 1) : (var_1_81 == ((unsigned char) (! var_1_43))))) && (((var_1_77 - var_1_80) <= var_1_59) ? (var_1_85 == ((signed char) (var_1_31 - 16))) : 1)) && (((var_1_45 <= (var_1_66 * var_1_54)) || var_1_1) ? ((var_1_54 > var_1_11) ? (var_1_86 == ((signed long int) (max ((var_1_54 + (min (var_1_61 , var_1_7))) , var_1_47)))) : 1) : (((var_1_69 | (abs (var_1_19))) != (abs (var_1_30))) ? (var_1_86 == ((signed long int) (abs (var_1_45)))) : 1))) && (((- var_1_30) < (var_1_104 | (var_1_65 - var_1_64))) ? (var_1_87 == ((unsigned short int) ((abs (var_1_32 + var_1_54)) + var_1_104))) : 1)) && (var_1_88 == ((signed char) var_1_32))) && (((var_1_74 - (2052788346 - 1)) == var_1_49) ? ((var_1_49 < var_1_114) ? (var_1_89 == ((unsigned char) (var_1_32 - var_1_56))) : 1) : (var_1_89 == ((unsigned char) var_1_56)))) && ((2.25f >= (var_1_80 - var_1_15)) ? (((- var_1_21) < (var_1_86 / (min (var_1_30 , var_1_54)))) ? (var_1_91 == ((signed long int) (max (var_1_61 , last_1_var_1_91)))) : 1) : 1)) && ((-1000 >= var_1_91) ? (var_1_93 == ((unsigned char) ((var_1_74 + var_1_94) - var_1_75))) : ((var_1_95 > (var_1_32 - (var_1_54 + var_1_55))) ? (var_1_41 ? ((var_1_70 < var_1_91) ? (var_1_93 == ((unsigned char) (var_1_30 - var_1_74))) : (var_1_93 == ((unsigned char) (var_1_31 + var_1_54)))) : (var_1_93 == ((unsigned char) (var_1_55 + (5 + var_1_31))))) : (var_1_93 == ((unsigned char) (var_1_30 - var_1_64)))))) && (var_1_26 ? (var_1_95 == ((signed short int) (var_1_31 - ((min (var_1_96 , var_1_97)) - var_1_64)))) : (var_1_95 == ((signed short int) (last_1_var_1_95 + -32))))) && (((min (var_1_32 , var_1_22)) < var_1_114) ? (((var_1_38 <= 32.8f) || var_1_41) ? (var_1_26 ? (var_1_98 == ((signed char) ((var_1_54 - var_1_31) + (min ((var_1_99 - var_1_75) , var_1_10))))) : (var_1_98 == ((signed char) (var_1_55 - var_1_54)))) : (var_1_98 == ((signed char) ((var_1_56 + var_1_55) - (min ((var_1_100 - var_1_54) , var_1_99)))))) : (var_1_98 == ((signed char) ((var_1_64 - var_1_75) - var_1_54))))) && ((last_1_var_1_86 > (abs (last_1_var_1_101))) ? ((var_1_71 != (- var_1_70)) ? (var_1_101 == ((signed long int) ((max (1 , var_1_8)) - var_1_56))) : 1) : 1)) && ((var_1_83 && last_1_var_1_102) ? ((var_1_23 >= var_1_97) ? (var_1_102 == ((unsigned char) (var_1_44 && var_1_42))) : (var_1_102 == ((unsigned char) (var_1_84 || (var_1_26 && var_1_82))))) : (var_1_102 == ((unsigned char) (! (var_1_81 || var_1_43)))))) && (var_1_1 ? ((var_1_66 != var_1_55) ? (var_1_103 == ((signed char) var_1_75)) : (var_1_103 == ((signed char) var_1_32))) : (var_1_103 == ((signed char) var_1_99)))) && (var_1_26 ? (var_1_104 == ((unsigned short int) var_1_105)) : 1)) && (var_1_1 ? (var_1_106 == ((unsigned long int) var_1_8)) : 1)) && (var_1_107 == ((unsigned short int) var_1_39))) && (var_1_83 ? (var_1_108 == ((float) var_1_16)) : (var_1_108 == ((float) var_1_79)))) && (var_1_109 == ((unsigned short int) var_1_99))) && (var_1_110 == ((unsigned char) var_1_44))) && (var_1_110 ? (var_1_111 == ((double) var_1_17)) : (var_1_111 == ((double) var_1_38)))) && (var_1_102 ? (var_1_112 == ((unsigned char) var_1_74)) : 1)) && (var_1_113 == ((unsigned char) var_1_94))) && (var_1_114 == ((signed long int) var_1_106))) && (var_1_115 == ((unsigned short int) var_1_32))) && (var_1_81 ? (var_1_116 == ((signed char) var_1_56)) : (var_1_116 == ((signed char) var_1_10)))) && (var_1_24 ? (var_1_117 == ((unsigned short int) var_1_30)) : 1)) && (var_1_110 ? (var_1_118 == ((float) var_1_78)) : (var_1_118 == ((float) var_1_79)))) && ((var_1_37 > (var_1_25 + (var_1_77 - var_1_80))) ? (var_1_119 == ((double) (max (var_1_78 , (63.648 - (abs (var_1_17))))))) : (var_1_43 ? (var_1_119 == ((double) var_1_38)) : (var_1_119 == ((double) 15.75))))
;
}
int main(void) {
	isInitial = 1;
