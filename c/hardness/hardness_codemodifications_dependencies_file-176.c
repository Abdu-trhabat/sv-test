...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch176dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch176dependencies
	if (var_1_11 || var_1_18) {
		var_1_17 = (((last_1_var_1_10 > var_1_15) || var_1_19) && (! var_1_20));
	} else {
		var_1_17 = 0;
	}


	// From: Req3Batch176dependencies
	if (last_1_var_1_26 > var_1_8) {
		var_1_16 = (var_1_7 + var_1_6);
	}


	// From: Req7Batch176dependencies
	var_1_27 = var_1_6;


	// From: Req2Batch176dependencies
	if ((var_1_16 <= var_1_3) && var_1_17) {
	...
	// From: Req5Batch176dependencies
	if (var_1_17) {
		var_1_21 = (min (var_1_15 , var_1_22));
	} else {
		if (var_1_27 <= (var_1_27 * var_1_4)) {
			if ((var_1_6 + var_1_27) < var_1_16) {
	...
	// From: Req6Batch176dependencies
	if ((max (var_1_14 , var_1_21)) >= var_1_24) {
		var_1_26 = (var_1_7 - 8);
	}


	// From: Req1Batch176dependencies
	if (((var_1_27 * 4) % (min (var_1_3 , var_1_4))) <= var_1_16) {
...
int property(void) {
	return (((((((((var_1_27 * 4) % (min (var_1_3 , var_1_4))) <= var_1_16) ? (var_1_1 == ((signed char) ((max ((var_1_6 - var_1_7) , var_1_8)) - var_1_9))) : 1) && (((var_1_16 <= var_1_3) && var_1_17) ? (((max (var_1_12 , var_1_13)) < var_1_14) ? (var_1_10 == ((double) var_1_15)) : (var_1_10 == ((double) 31.5))) : (var_1_10 == ((double) var_1_15)))) && ((last_1_var_1_26 > var_1_8) ? (var_1_16 == ((unsigned long int) (var_1_7 + var_1_6))) : 1)) && ((var_1_11 || var_1_18) ? (var_1_17 == ((unsigned char) (((last_1_var_1_10 > var_1_15) || var_1_19) && (! var_1_20)))) : (var_1_17 == ((unsigned char) 0)))) && (var_1_17 ? (var_1_21 == ((float) (min (var_1_15 , var_1_22)))) : ((var_1_27 <= (var_1_27 * var_1_4)) ? (((var_1_6 + var_1_27) < var_1_16) ? (var_1_21 == ((float) (var_1_23 + var_1_24))) : 1) : (var_1_21 == ((float) (var_1_25 - (1.6f + 8.8f))))))) && (((max (var_1_14 , var_1_21)) >= var_1_24) ? (var_1_26 == ((signed char) (var_1_7 - 8))) : 1)) && (var_1_27 == ((unsigned short int) var_1_6))
;
}
int main(void) {
	isInitial = 1;
