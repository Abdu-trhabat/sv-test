...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject4
	/* 344L, 184L) */ if (/* 345L, 144L, 145L) */ ((var_1_18) < (/* 347L, 143L, 147L) */ ((var_1_22) / (var_1_37))))) {
		/* 350L, 158L) */ var_1_35 = (
			var_1_32
		);
	} else {
	...
	// From: CodeObject5
	/* 365L, 224L) */ if (/* 366L, 190L, 191L) */ ((var_1_30) > (var_1_8))) {
	...
	// From: CodeObject2
	/* 309L, 108L) */ if (/* 310L, 72L, 73L) */ ((/* 311L, 67L, 74L) */ ((var_1_30) * (var_1_21))) < (/* 314L, 71L, 77L) */ (abs (var_1_32))))) {
	...
	// From: CodeObject3
	/* 332L, 136L) */ if (/* 333L, 116L, 117L) */ ((var_1_30) < (/* 335L, 115L, 119L) */ (max (/* 335L, 115L, 119L) */ (var_1_1) , (var_1_18)))))) {
