...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch122100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch122100_while
	if (var_1_4 != (- (var_1_6 / var_1_7))) {
		var_1_9 = 100;
	}


	// From: Req5Batch122100_while
	...
	// From: Req6Batch122100_while
	var_1_22 = (min (128 , var_1_19));


	// From: Req8Batch122100_while
	...
	// From: Req11Batch122100_while
	var_1_36 = (var_1_31 + (64 - (var_1_37 + 2)));


	// From: Req7Batch122100_while
