...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11750_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch11750_while
	if (var_1_7 < ((var_1_8 - var_1_9) >> var_1_11)) {
		var_1_10 = var_1_12;
	}


	// From: Req3Batch11750_while
	if (var_1_8 > var_1_7) {
		var_1_13 = (max (var_1_11 , var_1_14));
	}


	// From: Req5Batch11750_while
	...
	// From: Req6Batch11750_while
	if (var_1_20 < var_1_16) {
		var_1_24 = ((var_1_25 - var_1_11) - 2);
	}


	// From: Req4Batch11750_while
