...
void step(void) {
	// From: Req1Batch127Wrapper_SP
	if ((max (0u , (*(WrapperStruct00_var_1_2_Pointer)))) > (~ (*(WrapperStruct00_var_1_3_Pointer)))) {
