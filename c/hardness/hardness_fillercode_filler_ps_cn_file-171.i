...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch171Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
            if ( (( ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))) > (31.5f))) {
             var_1_25 = (
              (((((( var_1_27 ) - ( (( var_1_28 ) + ( var_1_29 )) ))) < 0 ) ? -((( var_1_27 ) - ( (( var_1_28 ) + ( var_1_29 )) ))) : ((( var_1_27 ) - ( (( var_1_28 ) + ( var_1_29 )) )))))
  );
 }
            if ( (( (( ((((var_1_26) < 0 ) ? -(var_1_26) : (var_1_26)))) - (var_1_31))) > (var_1_32))) {
             var_1_30 = (
              ((
    var_1_33
   ) + (
    ...
    var_1_33
             ...
             if (var_1_36) {
              if ( (( ((((( ((var_1_32) * (var_1_33)))) > ((var_1_34))) ? (( ((var_1_32) * (var_1_33)))) : ((var_1_34))))) < (var_1_31))) {
               var_1_35 = (
    var_1_27
   );
  }
   ...
   var_1_33
     ...
     var_1_29
                ...
                var_1_41 = (
                 ((((( ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) )) < (( var_1_35 ))) ? (( ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))) )) : (( var_1_35 ))))
    );
   }
  } else {
               if ( ((var_1_37) != ( ((((var_1_39) < 0 ) ? -(var_1_39) : (var_1_39)))))) {
                var_1_41 = (
     var_1_29
    );
   } else {
