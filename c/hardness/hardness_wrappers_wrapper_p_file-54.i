...
void step(void) {
 ...
 if (stepLocal_1 == ((((10) > ((*(var_1_5_Pointer)))) ? (10) : ((*(var_1_5_Pointer)))))) {
  if ((*(var_1_6_Pointer))) {
   (*(var_1_4_Pointer)) = (((*(var_1_14_Pointer)) < (*(var_1_11_Pointer))) && (*(var_1_9_Pointer)));
  } else {
   if ((*(var_1_11_Pointer)) >= (((((*(var_1_14_Pointer))) < 0 ) ? -((*(var_1_14_Pointer))) : ((*(var_1_14_Pointer)))))) {
