...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch150has_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch150has_floats
	var_1_14 = var_1_12;


	// From: Req4Batch150has_floats
