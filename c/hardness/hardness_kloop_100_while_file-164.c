...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch164100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch164100_while
	if ((min (1.000000000065E10f , (var_1_16 - var_1_15))) <= last_1_var_1_13) {
	...
	if (var_1_5 < stepLocal_3) {
		if ((var_1_18 - var_1_6) == stepLocal_4) {
			...
			var_1_17 = (min (var_1_19 , ((var_1_21 + -4) + var_1_22)));
		}
	} else {
		var_1_17 = (var_1_20 - 2);
	}
	...
	// From: Req10Batch164100_while
	if ((var_1_16 < 127.5) && var_1_33) {
		var_1_32 = ((max ((abs (var_1_12)) , (max (var_1_23 , var_1_19)))) + var_1_37);
	} else {
		var_1_32 = var_1_22;
	}


	// From: Req1Batch164100_while
	...
	// From: Req7Batch164100_while
	if ((- (min (var_1_11 , var_1_7))) >= (var_1_37 & var_1_32)) {
		var_1_25 = (min ((var_1_26 + (var_1_27 - var_1_28)) , var_1_15));
	} else {
		if (var_1_33) {
			var_1_25 = 2.6;
		}
...
int property(void) {
	return (((((((((((((- var_1_37) < var_1_10) ? (var_1_1 == ((unsigned char) (min ((var_1_4 + (var_1_5 - var_1_6)) , var_1_7)))) : (var_1_1 == ((unsigned char) (max (var_1_6 , var_1_4))))) && ((last_1_var_1_8 < var_1_4) ? ((var_1_33 || (last_1_var_1_8 >= var_1_10)) ? ((! var_1_33) ? (var_1_8 == ((unsigned short int) var_1_7)) : (var_1_8 == ((unsigned short int) last_1_var_1_8))) : 1) : (var_1_8 == ((unsigned short int) var_1_4)))) && (((var_1_11 - var_1_12) < last_1_var_1_10) ? ((var_1_4 > var_1_12) ? (var_1_10 == ((signed long int) ((last_1_var_1_32 + -64) + var_1_6))) : (var_1_10 == ((signed long int) -32))) : (var_1_10 == ((signed long int) var_1_11)))) && ((var_1_33 && (var_1_11 != var_1_23)) ? (var_1_13 == ((double) (var_1_15 - var_1_16))) : 1)) && ((var_1_5 < var_1_23) ? (((var_1_18 - var_1_6) == (var_1_10 * var_1_11)) ? (var_1_33 ? (var_1_17 == ((signed char) ((var_1_19 - var_1_6) - var_1_20))) : 1) : (var_1_17 == ((signed char) (min (var_1_19 , ((var_1_21 + -4) + var_1_22)))))) : (var_1_17 == ((signed char) (var_1_20 - 2))))) && (((min (1.000000000065E10f , (var_1_16 - var_1_15))) <= last_1_var_1_13) ? (var_1_23 == ((unsigned long int) (var_1_24 - (1904482635u - last_1_var_1_32)))) : (var_1_23 == ((unsigned long int) last_1_var_1_1)))) && (((- (min (var_1_11 , var_1_7))) >= (var_1_37 & var_1_32)) ? (var_1_25 == ((double) (min ((var_1_26 + (var_1_27 - var_1_28)) , var_1_15)))) : (var_1_33 ? (var_1_25 == ((double) 2.6)) : 1))) && ((var_1_12 < var_1_19) ? (var_1_29 == ((double) var_1_15)) : 1)) && ((((var_1_12 | var_1_8) ^ var_1_37) <= -1000000) ? (var_1_30 == ((float) 1.0000000000005E12f)) : 1)) && (((var_1_16 < 127.5) && var_1_33) ? (var_1_32 == ((signed long int) ((max ((abs (var_1_12)) , (max (var_1_23 , var_1_19)))) + var_1_37))) : (var_1_32 == ((signed long int) var_1_22)))) && (var_1_9 ? (((var_1_29 * var_1_27) >= var_1_16) ? (var_1_33 == ((unsigned char) (var_1_34 && var_1_35))) : (var_1_33 == ((unsigned char) (var_1_34 && (! var_1_36))))) : 1)) && ((var_1_15 <= var_1_28) ? ((var_1_18 <= var_1_10) ? (var_1_36 ? (var_1_37 == ((signed short int) var_1_17)) : 1) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
