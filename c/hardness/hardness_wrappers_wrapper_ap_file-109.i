...
void step(void) {
 ...
 if (stepLocal_1 <= (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer))) {
  ...
  (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) = ((((last_1_signed_short_int_Array_0_1_) > ((((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) + 16) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))) ? (last_1_signed_short_int_Array_0_1_) : ((((*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer)) + 16) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))))));
 }
