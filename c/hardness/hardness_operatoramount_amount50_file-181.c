...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch181Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch181Amount50
	if (var_1_15) {
		var_1_14 = (max (var_1_10 , var_1_11));
	}


	// From: Req1Batch181Amount50
	...
	// From: Req2Batch181Amount50
	var_1_6 = var_1_7;


	// From: Req7Batch181Amount50
	var_1_24 = (((var_1_25 + var_1_26) - var_1_27) - var_1_28);


	// From: Req6Batch181Amount50
	signed long int stepLocal_4 = abs (var_1_4);
	if (! (! (var_1_6 || var_1_7))) {
		if ((min (var_1_17 , var_1_1)) <= stepLocal_4) {
			var_1_22 = var_1_14;
		} else {
			var_1_22 = var_1_11;
		}
	...
	// From: Req3Batch181Amount50
	signed long int stepLocal_1 = var_1_22;
	if ((var_1_9 - (min (var_1_10 , var_1_11))) >= stepLocal_1) {
...
int property(void) {
	return ((((((last_1_var_1_15 ? (var_1_1 == ((signed long int) (var_1_3 - (var_1_4 + 5)))) : ((var_1_4 > (var_1_3 * last_1_var_1_22)) ? (var_1_1 == ((signed long int) var_1_3)) : 1)) && (var_1_6 == ((unsigned char) var_1_7))) && (((var_1_9 - (min (var_1_10 , var_1_11))) >= var_1_22) ? (var_1_8 == ((signed char) (max (var_1_12 , var_1_13)))) : 1)) && (var_1_15 ? (var_1_14 == ((unsigned short int) (max (var_1_10 , var_1_11)))) : 1)) && (((last_1_var_1_1 >> 10) < (last_1_var_1_22 / (abs (var_1_16)))) ? ((((var_1_9 / var_1_16) % var_1_17) <= (var_1_4 - last_1_var_1_1)) ? (((last_1_var_1_24 / var_1_19) != last_1_var_1_24) ? (var_1_15 == ((unsigned char) var_1_21)) : (var_1_15 == ((unsigned char) var_1_7))) : (var_1_15 == ((unsigned char) var_1_21))) : (var_1_15 == ((unsigned char) var_1_21)))) && ((! (! (var_1_6 || var_1_7))) ? (((min (var_1_17 , var_1_1)) <= (abs (var_1_4))) ? (var_1_22 == ((signed long int) var_1_14)) : (var_1_22 == ((signed long int) var_1_11))) : (var_1_22 == ((signed long int) var_1_13)))) && (var_1_24 == ((float) (((var_1_25 + var_1_26) - var_1_27) - var_1_28)))
;
}
int main(void) {
	isInitial = 1;
