...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch6150_1loop.c", 13, "reach_error"); }
...
int property(void) {
 return ((((((((((var_1_4 / ((((64u) < 0 ) ? -(64u) : (64u)))) == var_1_4) ? (var_1_1 == ((double) (8.8 - 255.2))) : 1) && ((var_1_3 < var_1_2) ? (var_1_4 == ((unsigned long int) ((((var_1_5) > (var_1_6)) ? (var_1_5) : (var_1_6))))) : 1)) && ((var_1_4 <= ((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5)))) ? ((var_1_4 < var_1_5) ? ((var_1_4 >= (var_1_4 ^ 4u)) ? (var_1_7 == ((float) var_1_8)) : 1) : (var_1_7 == ((float) var_1_8))) : (var_1_7 == ((float) var_1_8)))) && ((var_1_4 >= (4256310412u - 128u)) ? (var_1_9 == ((signed long int) (((((var_1_10 + var_1_11) < 0 ) ? -(var_1_10 + var_1_11) : (var_1_10 + var_1_11))) + var_1_12))) : 1)) && ((var_1_4 >= (var_1_14 - ((((var_1_15) < (var_1_16)) ? (var_1_15) : (var_1_16))))) ? ((var_1_16 < var_1_9) ? (var_1_13 == ((unsigned char) var_1_17)) : (var_1_13 == ((unsigned char) var_1_18))) : (var_1_13 == ((unsigned char) var_1_18)))) && (var_1_19 == ((unsigned char) (var_1_20 + (10 + ((((var_1_21) < 0 ) ? -(var_1_21) : (var_1_21)))))))) && (var_1_18 ? (var_1_22 == ((unsigned char) (((- var_1_1) <= var_1_8) && (var_1_23 || (var_1_24 || var_1_25))))) : 1)) && (var_1_26 == ((signed char) var_1_21))) && (var_1_27 == ((unsigned short int) var_1_21))
;
}
int main(void) {
 isInitial = 1;
