...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch178stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch178stepLocals
	signed long int stepLocal_0 = 100 + (var_1_8 / var_1_10);
	...
	if (stepLocal_1 <= var_1_5) {
		if (stepLocal_2 < var_1_2) {
			var_1_13 = (min (((var_1_10 - var_1_16) + var_1_9) , var_1_14));
		}
	}


	// From: Req5Batch178stepLocals
	signed long int stepLocal_4 = max (var_1_5 , var_1_15);
	signed char stepLocal_3 = var_1_11;
	if (var_1_10 <= stepLocal_4) {
		if ((max (var_1_5 , var_1_7)) >= stepLocal_3) {
			var_1_17 = var_1_10;
		} else {
			var_1_17 = var_1_16;
		}
