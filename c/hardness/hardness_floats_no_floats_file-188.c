...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch188no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch188no_floats
	var_1_19 = var_1_18;


	// From: Req5Batch188no_floats
	var_1_20 = var_1_13;


	// From: Req3Batch188no_floats
