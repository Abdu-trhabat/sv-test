...
void step(void) {
	...
	// From: Req3Batch170100_1loop
	unsigned char stepLocal_1 = var_1_17;
	if (stepLocal_1 && (var_1_18 && var_1_19)) {
		var_1_16 = var_1_6;
	} else {
		var_1_16 = (max (5u , (var_1_8 - var_1_3)));
	}


	// From: Req6Batch170100_1loop
	if (var_1_5 != ((var_1_9 - var_1_21) - var_1_25)) {
		var_1_27 = var_1_28;
	}


	// From: Req11Batch170100_1loop
	var_1_34 = (min (var_1_13 , var_1_12));


	// From: Req4Batch170100_1loop
	if (var_1_27) {
		var_1_20 = var_1_21;
	}


	// From: Req5Batch170100_1loop
	if (var_1_14 >= var_1_33) {
		if (var_1_27) {
			var_1_22 = ((min (var_1_23 , var_1_24)) + var_1_25);
		} else {
			var_1_22 = var_1_21;
		}
	} else {
	...
	// From: Req1Batch170100_1loop
	if ((min ((abs (var_1_2)) , (var_1_3 * var_1_30))) < (var_1_5 - var_1_6)) {
...
int property(void) {
	return (((((((((((((min ((abs (var_1_2)) , (var_1_3 * var_1_30))) < (var_1_5 - var_1_6)) ? (var_1_1 == ((unsigned long int) (min (var_1_7 , var_1_6)))) : (var_1_1 == ((unsigned long int) (var_1_8 - (var_1_9 - var_1_10))))) && ((var_1_2 <= var_1_3) ? (var_1_11 == ((float) ((var_1_12 - (max (var_1_13 , var_1_14))) - var_1_15))) : (var_1_11 == ((float) var_1_15)))) && ((var_1_17 && (var_1_18 && var_1_19)) ? (var_1_16 == ((unsigned long int) var_1_6)) : (var_1_16 == ((unsigned long int) (max (5u , (var_1_8 - var_1_3))))))) && (var_1_27 ? (var_1_20 == ((unsigned char) var_1_21)) : 1)) && ((var_1_14 >= var_1_33) ? (var_1_27 ? (var_1_22 == ((unsigned char) ((min (var_1_23 , var_1_24)) + var_1_25))) : (var_1_22 == ((unsigned char) var_1_21))) : (var_1_22 == ((unsigned char) var_1_26)))) && ((var_1_5 != ((var_1_9 - var_1_21) - var_1_25)) ? (var_1_27 == ((unsigned char) var_1_28)) : 1)) && ((var_1_26 < 5) ? (var_1_29 == ((signed short int) ((var_1_30 + var_1_23) - var_1_24))) : ((var_1_6 <= (var_1_26 / var_1_9)) ? (var_1_29 == ((signed short int) (var_1_24 + var_1_25))) : (var_1_29 == ((signed short int) -2))))) && ((var_1_6 == (var_1_20 - (50 + var_1_10))) ? (var_1_30 == ((signed long int) (abs (var_1_26)))) : ((var_1_27 || var_1_19) ? (var_1_30 == ((signed long int) var_1_26)) : 1))) && ((((var_1_20 ^ var_1_16) + var_1_9) != (var_1_30 % var_1_32)) ? (var_1_31 == ((float) ((var_1_12 - var_1_13) - var_1_14))) : (var_1_31 == ((float) 15.2f)))) && (((var_1_6 + (last_1_var_1_35 * last_1_var_1_1)) < last_1_var_1_16) ? (var_1_33 == ((double) (var_1_13 + var_1_14))) : 1)) && (var_1_34 == ((float) (min (var_1_13 , var_1_12))))) && ((var_1_1 != var_1_9) ? ((var_1_33 >= var_1_13) ? (var_1_35 == ((unsigned short int) ((var_1_36 - var_1_25) - var_1_16))) : ((var_1_1 <= (- (var_1_29 + var_1_25))) ? ((var_1_10 <= (var_1_16 & var_1_26)) ? (var_1_35 == ((unsigned short int) (var_1_36 - var_1_21))) : (var_1_35 == ((unsigned short int) (var_1_21 + var_1_26)))) : (var_1_27 ? (var_1_35 == ((unsigned short int) (var_1_23 + 16))) : (var_1_35 == ((unsigned short int) var_1_16))))) : (var_1_35 == ((unsigned short int) var_1_23)))
;
}
int main(void) {
	isInitial = 1;
