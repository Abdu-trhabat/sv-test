...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch163100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch163100_1loop
	signed long int stepLocal_1 = last_1_var_1_1;
	if (stepLocal_1 <= ((var_1_5 * last_1_var_1_1) + (abs (last_1_var_1_1)))) {
		var_1_7 = last_1_var_1_1;
	} else {
		var_1_7 = (abs (last_1_var_1_1));
	}


	// From: Req7Batch163100_1loop
	...
	// From: Req3Batch163100_1loop
	if (last_1_var_1_8 < (max (var_1_5 , var_1_7))) {
		if (! var_1_21) {
			var_1_8 = (16 + (last_1_var_1_8 - (max (0 , var_1_7))));
		} else {
	...
	// From: Req8Batch163100_1loop
	signed long int stepLocal_5 = var_1_7;
	if (var_1_8 >= stepLocal_5) {
		var_1_24 = ((abs (var_1_13 - var_1_25)) + (var_1_26 + var_1_27));
	} else {
		var_1_24 = var_1_25;
	}


	// From: Req9Batch163100_1loop
	if ((min ((min (var_1_8 , var_1_25)) , var_1_27)) > var_1_12) {
	...
	// From: Req10Batch163100_1loop
	unsigned char stepLocal_7 = var_1_21;
	unsigned char stepLocal_6 = var_1_21;
	if (stepLocal_6 && (var_1_25 != var_1_5)) {
		if (stepLocal_7 || (var_1_26 > (abs (var_1_12)))) {
			var_1_30 = (min (last_1_var_1_30 , (min (var_1_26 , (var_1_28 - var_1_32)))));
		} else {
			var_1_30 = var_1_13;
		}
	} else {
...
int property(void) {
	return (((((((((((var_1_7 >= (- (var_1_7 + 8))) ? (var_1_21 ? (var_1_1 == ((unsigned short int) var_1_5)) : (var_1_21 ? (var_1_1 == ((unsigned short int) var_1_5)) : (var_1_1 == ((unsigned short int) 2)))) : (var_1_1 == ((unsigned short int) var_1_5))) && ((last_1_var_1_1 <= ((var_1_5 * last_1_var_1_1) + (abs (last_1_var_1_1)))) ? (var_1_7 == ((signed long int) last_1_var_1_1)) : (var_1_7 == ((signed long int) (abs (last_1_var_1_1)))))) && ((last_1_var_1_8 < (max (var_1_5 , var_1_7))) ? ((! var_1_21) ? (var_1_8 == ((signed long int) (16 + (last_1_var_1_8 - (max (0 , var_1_7)))))) : (((last_1_var_1_8 > var_1_7) && var_1_21) ? (var_1_8 == ((signed long int) var_1_5)) : (var_1_8 == ((signed long int) last_1_var_1_8)))) : 1)) && (var_1_21 ? (var_1_9 == ((unsigned char) var_1_10)) : (var_1_9 == ((unsigned char) (var_1_11 - (var_1_12 - (var_1_13 - 10))))))) && (((var_1_7 + var_1_1) < (var_1_5 ^ var_1_8)) ? (var_1_14 == ((float) (var_1_16 + (var_1_17 - var_1_18)))) : (var_1_14 == ((float) var_1_18)))) && (((var_1_20 + var_1_8) <= var_1_7) ? (var_1_19 == ((float) (max (var_1_18 , var_1_17)))) : ((var_1_11 <= var_1_13) ? (var_1_19 == ((float) var_1_16)) : (var_1_19 == ((float) var_1_17))))) && (((var_1_16 * var_1_17) > (- (- last_1_var_1_33))) ? ((last_1_var_1_8 == (~ last_1_var_1_8)) ? (var_1_4 ? (var_1_21 == ((unsigned char) var_1_22)) : (var_1_21 == ((unsigned char) var_1_23))) : (var_1_21 == ((unsigned char) var_1_23))) : (var_1_21 == ((unsigned char) var_1_22)))) && ((var_1_8 >= var_1_7) ? (var_1_24 == ((signed char) ((abs (var_1_13 - var_1_25)) + (var_1_26 + var_1_27)))) : (var_1_24 == ((signed char) var_1_25)))) && (((min ((min (var_1_8 , var_1_25)) , var_1_27)) > var_1_12) ? (((var_1_8 / var_1_12) != var_1_13) ? (var_1_28 == ((unsigned char) var_1_25)) : (var_1_28 == ((unsigned char) var_1_13))) : (var_1_28 == ((unsigned char) 0)))) && ((var_1_21 && (var_1_25 != var_1_5)) ? ((var_1_21 || (var_1_26 > (abs (var_1_12)))) ? (var_1_30 == ((signed short int) (min (last_1_var_1_30 , (min (var_1_26 , (var_1_28 - var_1_32))))))) : (var_1_30 == ((signed short int) var_1_13))) : (var_1_30 == ((signed short int) -16)))) && (var_1_33 == ((double) var_1_18))
;
}
int main(void) {
	isInitial = 1;
