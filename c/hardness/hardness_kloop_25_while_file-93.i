...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch9325_while.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_12 / var_1_5) <= (var_1_3 + ((((var_1_8) < (var_1_14)) ? (var_1_8) : (var_1_14))))) {
...
int property(void) {
 return ((((((- last_1_var_1_12) / var_1_3) != (last_1_var_1_12 / var_1_5)) ? (var_1_6 ? (var_1_1 == ((float) var_1_7)) : (var_1_1 == ((float) var_1_8))) : (var_1_1 == ((float) var_1_7))) && (var_1_9 == ((unsigned char) (var_1_10 + ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11))))))) && ((var_1_1 != last_1_var_1_12) ? (var_1_12 == ((double) ((var_1_13 - var_1_14) + (var_1_15 - 100000.5)))) : 1)) && (((var_1_12 / var_1_5) <= (var_1_3 + ((((var_1_8) < (var_1_14)) ? (var_1_8) : (var_1_14))))) ? (var_1_16 == ((unsigned short int) (var_1_17 - var_1_10))) : (var_1_16 == ((unsigned short int) var_1_11)))
;
}
int main(void) {
 isInitial = 1;
