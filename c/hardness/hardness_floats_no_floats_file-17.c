...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch17no_floats
	signed long int stepLocal_1 = var_1_5;
	if (stepLocal_1 < var_1_3) {
		var_1_7 = (abs (min (var_1_3 , (min (var_1_4 , var_1_8)))));
	}


	// From: Req3Batch17no_floats
	if ((var_1_1 + var_1_6) <= var_1_1) {
		var_1_9 = (var_1_11 - ((max (var_1_12 , var_1_13)) + (5 + 8)));
	}


	// From: Req4Batch17no_floats
	unsigned char stepLocal_2 = var_1_12 < var_1_7;
	if (stepLocal_2 || var_1_2) {
		var_1_14 = (abs (var_1_11 - var_1_12));
	} else {
		if (var_1_2) {
			var_1_14 = var_1_13;
		}
...
int property(void) {
	return (((((! var_1_2) && ((var_1_3 | var_1_4) <= var_1_5)) ? (var_1_2 ? (var_1_1 == ((signed long int) var_1_6)) : (var_1_1 == ((signed long int) 128))) : (var_1_1 == ((signed long int) var_1_6))) && ((var_1_5 < var_1_3) ? (var_1_7 == ((signed long int) (abs (min (var_1_3 , (min (var_1_4 , var_1_8))))))) : 1)) && (((var_1_1 + var_1_6) <= var_1_1) ? (var_1_9 == ((unsigned char) (var_1_11 - ((max (var_1_12 , var_1_13)) + (5 + 8))))) : 1)) && (((var_1_12 < var_1_7) || var_1_2) ? (var_1_14 == ((unsigned char) (abs (var_1_11 - var_1_12)))) : (var_1_2 ? (var_1_14 == ((unsigned char) var_1_13)) : 1))
;
}
int main(void) {
	isInitial = 1;
