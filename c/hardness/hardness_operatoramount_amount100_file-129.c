...
void step(void) {
	...
	// From: Req1Batch129Amount100
	if (! var_1_26) {
		var_1_1 = (max ((var_1_3 - var_1_4) , var_1_5));
	}


	// From: Req4Batch129Amount100
	if (var_1_26) {
		var_1_15 = var_1_16;
	}


	// From: Req5Batch129Amount100
	...
	// From: Req13Batch129Amount100
	var_1_34 = var_1_21;


	// From: Req6Batch129Amount100
	...
	// From: Req15Batch129Amount100
	var_1_36 = var_1_30;


	// From: Req14Batch129Amount100
	var_1_35 = var_1_36;


	// From: Req3Batch129Amount100
