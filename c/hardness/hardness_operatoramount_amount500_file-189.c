...
void step(void) {
	// From: Req27Batch189Amount500
	if (last_1_var_1_91 < (abs (last_1_var_1_70))) {
		var_1_63 = ((var_1_65 - 100u) - last_1_var_1_109);
	} else {
		var_1_63 = ((min (128u , var_1_26)) + var_1_32);
	}


	// From: Req32Batch189Amount500
	signed long int stepLocal_11 = max (4 , -2);
	if (var_1_12) {
	...
	if (var_1_5 <= var_1_42) {
		if (last_1_var_1_106) {
			if (((~ 256) + last_1_var_1_107) > last_1_var_1_7) {
				...
				if (! last_1_var_1_101) {
					var_1_59 = ((max (var_1_28 , last_1_var_1_59)) - (min (var_1_33 , (var_1_61 - 2))));
				} else {
					var_1_59 = (abs (-128));
				}
			}
	...
	// From: Req50Batch189Amount500
	if (var_1_51) {
		var_1_105 = var_1_59;
	}


	// From: Req3Batch189Amount500
	if (last_1_var_1_50) {
		if (last_1_var_1_62) {
			var_1_10 = ((! 1) || (! var_1_11));
		}
	...
	// From: Req6Batch189Amount500
	var_1_23 = (! var_1_12);


	// From: Req7Batch189Amount500
	if (var_1_10) {
	...
	// From: Req11Batch189Amount500
	var_1_36 = (min (16 , var_1_26));


	// From: Req17Batch189Amount500
	var_1_48 = (abs (var_1_22 + 16));


	// From: Req20Batch189Amount500
	var_1_52 = ((var_1_12 || var_1_51) || (var_1_11 && var_1_53));


	// From: Req26Batch189Amount500
	var_1_62 = (var_1_51 || var_1_11);


	// From: Req38Batch189Amount500
	...
	// From: Req40Batch189Amount500
	var_1_92 = (! var_1_90);


	// From: Req42Batch189Amount500
	var_1_96 = var_1_72;


	// From: Req43Batch189Amount500
	if (var_1_89) {
		var_1_97 = var_1_98;
	}


	// From: Req44Batch189Amount500
	if (var_1_23) {
		var_1_99 = var_1_98;
	}


	// From: Req46Batch189Amount500
	var_1_101 = var_1_12;


	// From: Req47Batch189Amount500
	if (var_1_52) {
		var_1_102 = var_1_45;
	} else {
		var_1_102 = var_1_74;
	...
	// From: Req54Batch189Amount500
	var_1_109 = var_1_22;


	// From: Req24Batch189Amount500
	if ((min (1 , var_1_25)) >= ((var_1_99 + var_1_48) - var_1_32)) {
		if (var_1_6 <= ((var_1_43 + var_1_96) + (var_1_5 - var_1_44))) {
			var_1_58 = (min (8.625 , var_1_42));
		} else {
			if ((max (var_1_63 , (var_1_34 - 5))) >= var_1_76) {
				var_1_58 = ((max (var_1_44 , var_1_42)) + (min (var_1_6 , (min (2.8 , 0.25)))));
			} else {
	...
	// From: Req31Batch189Amount500
	var_1_75 = (min (var_1_105 , (var_1_57 - 128)));


	// From: Req2Batch189Amount500
	if (! var_1_10) {
	...
	// From: Req16Batch189Amount500
	if (var_1_12) {
		if (4.9f == var_1_45) {
			if (-4 > var_1_15) {
				var_1_47 = (abs (var_1_26 - var_1_28));
			} else {
	...
	// From: Req41Batch189Amount500
	if (((var_1_7 <= var_1_97) || var_1_89) && var_1_89) {
		if (var_1_8 >= (var_1_65 % var_1_34)) {
			if (var_1_23 && var_1_51) {
				var_1_93 = (min (last_1_var_1_93 , var_1_95));
			} else {
				var_1_93 = ((max (var_1_7 , var_1_99)) + var_1_21);
			}
		} else {
			if (var_1_7 >= var_1_63) {
	...
	// From: Req14Batch189Amount500
	if (! var_1_11) {
		if (var_1_8 == var_1_28) {
			if (var_1_34 == var_1_77) {
				var_1_41 = ((min (var_1_6 , (max (10.5f , var_1_5)))) + (var_1_42 + (var_1_43 - var_1_44)));
			} else {
				var_1_41 = (abs (var_1_45));
			}
		} else {
	...
	// From: Req35Batch189Amount500
	if ((max (-0.6f , 3.025f)) < var_1_41) {
		if (var_1_97 <= var_1_68) {
			if (var_1_72 == (var_1_96 / var_1_74)) {
				var_1_80 = (var_1_68 + ((min (var_1_26 , var_1_25)) - var_1_81));
			} else {
				var_1_80 = var_1_26;
			}
		} else {
	...
	// From: Req30Batch189Amount500
	if (var_1_50) {
		var_1_73 = (max (var_1_5 , (1.25 + (abs (var_1_44)))));
	} else {
		var_1_73 = (var_1_72 - (var_1_74 - (max (var_1_5 , var_1_43))));
	}


	// From: Req10Batch189Amount500
	if ((- (- 3.8)) >= (max (var_1_5 , var_1_73))) {
		var_1_35 = (max (var_1_105 , (var_1_28 - var_1_22)));
	} else {
		var_1_35 = (var_1_21 + (abs (var_1_29)));
	}


	// From: Req23Batch189Amount500
	unsigned char stepLocal_7 = var_1_12 || var_1_92;
	if ((min ((- var_1_42) , var_1_96)) <= (- var_1_44)) {
		if (stepLocal_7 || (-2 >= (last_1_var_1_56 + var_1_75))) {
			var_1_56 = (abs (min ((var_1_34 - var_1_59) , last_1_var_1_56)));
		} else {
			var_1_56 = ((var_1_57 - last_1_var_1_56) - (min (var_1_25 , 50)));
		}
	}


	// From: Req12Batch189Amount500
	if (var_1_50 && var_1_10) {
		var_1_37 = (var_1_38 - var_1_33);
	} else {
		if (var_1_12) {
			if ((var_1_21 < var_1_25) || var_1_101) {
				var_1_37 = (min (var_1_25 , (var_1_34 + var_1_28)));
			} else {
	...
	// From: Req1Batch189Amount500
	if (! (var_1_10 || var_1_50)) {
		var_1_1 = ((var_1_5 + var_1_6) - 1.000000000000005E13f);
	}


	// From: Req15Batch189Amount500
	if (var_1_23) {
		if (! var_1_50) {
			var_1_46 = ((max (var_1_26 , (max (var_1_22 , var_1_33)))) + var_1_25);
		} else {
			var_1_46 = var_1_25;
		}
	} else {
	...
	// From: Req22Batch189Amount500
	if (var_1_45 < var_1_5) {
		if (var_1_97 >= (var_1_87 ^ var_1_38)) {
			if (var_1_103 == var_1_41) {
				var_1_55 = (abs (var_1_27));
			}
		}
	} else {
		var_1_55 = ((max (1 , var_1_21)) - var_1_28);
	}


	// From: Req49Batch189Amount500
	if (var_1_50) {
		var_1_104 = 1;
	} else {
		var_1_104 = var_1_28;
	...
	if (stepLocal_8 >= var_1_34) {
		if (stepLocal_9 >= (var_1_80 ^ var_1_7)) {
			if (var_1_75 >= stepLocal_10) {
				var_1_70 = (min (var_1_43 , var_1_42));
			} else {
				var_1_70 = var_1_45;
			}
		} else {
			var_1_70 = (min ((var_1_71 - var_1_72) , var_1_44));
		}
	}


	// From: Req9Batch189Amount500
	...
	// From: Req34Batch189Amount500
	unsigned char stepLocal_14 = var_1_69;
	signed long int stepLocal_13 = var_1_107;
	signed long int stepLocal_12 = min (2 , (var_1_34 - var_1_33));
	if (stepLocal_14 < (var_1_57 * var_1_59)) {
		if (stepLocal_13 >= -8) {
			var_1_78 = var_1_25;
		} else {
			if (stepLocal_12 > (~ var_1_27)) {
				if (var_1_6 < (min (var_1_96 , var_1_73))) {
					var_1_78 = (max ((var_1_69 - var_1_61) , (var_1_38 - var_1_8)));
				} else {
					var_1_78 = (max (var_1_56 , var_1_37));
				}
			}
		}
	} else {
	...
	// From: Req18Batch189Amount500
	signed long int stepLocal_3 = - (var_1_32 | var_1_15);
	if (stepLocal_3 != var_1_26) {
		var_1_49 = (min ((var_1_39 - var_1_32) , var_1_78));
	} else {
		var_1_49 = (min (var_1_78 , (abs (var_1_7))));
	}


	// From: Req28Batch189Amount500
	if ((- 5u) <= var_1_57) {
		var_1_66 = var_1_28;
	} else {
		if (var_1_89) {
			...
			if (var_1_99 < var_1_100) {
				if (var_1_59 < (var_1_13 + var_1_21)) {
					var_1_66 = ((max (128 , (var_1_69 - var_1_68))) - var_1_67);
				} else {
					var_1_66 = (var_1_69 - (min (var_1_67 , var_1_26)));
				}
			} else {
				var_1_66 = ((var_1_69 - (min (var_1_26 , var_1_25))) - var_1_32);
			}
		}
	}


	// From: Req36Batch189Amount500
	unsigned long int stepLocal_15 = var_1_99 / (var_1_39 + 64u);
	if (var_1_99 <= stepLocal_15) {
		if (var_1_23) {
			var_1_82 = ((min ((max (var_1_68 , var_1_22)) , var_1_25)) - (abs (var_1_81)));
		} else {
			var_1_82 = (abs (var_1_22 - (var_1_84 - var_1_26)));
		}
	} else {
		if (((var_1_108 * 4.6f) * var_1_42) > var_1_70) {
			if (var_1_58 > var_1_43) {
				...
				var_1_82 = (max (var_1_28 , (var_1_22 - var_1_26)));
			}
		} else {
			if (var_1_10) {
				var_1_82 = (min (var_1_86 , var_1_69));
			} else {
	...
	// From: Req13Batch189Amount500
	if (var_1_38 == var_1_100) {
		var_1_40 = (min (var_1_19 , (var_1_49 + (var_1_33 + last_1_var_1_40))));
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((((((((((((((((((((((((! (var_1_10 || var_1_50)) ? (var_1_1 == ((float) ((var_1_5 + var_1_6) - 1.000000000000005E13f))) : 1) && ((! var_1_10) ? (((var_1_8 - var_1_9) < var_1_48) ? (var_1_7 == ((unsigned long int) var_1_8)) : 1) : 1)) && (last_1_var_1_50 ? (last_1_var_1_62 ? (var_1_10 == ((unsigned char) ((! 1) || (! var_1_11)))) : 1) : (var_1_10 == ((unsigned char) (! var_1_12))))) && ((var_1_6 < var_1_54) ? ((var_1_96 >= var_1_6) ? (var_1_13 == ((signed long int) (var_1_63 - var_1_9))) : (var_1_13 == ((signed long int) (var_1_63 - var_1_8)))) : (var_1_13 == ((signed long int) (var_1_9 + var_1_15))))) && ((var_1_15 < (var_1_78 + var_1_76)) ? ((! var_1_23) ? (var_1_16 == ((signed char) var_1_19)) : (((64u * var_1_76) >= (var_1_20 - var_1_8)) ? (var_1_16 == ((signed char) var_1_19)) : 1)) : ((var_1_5 <= (- (128.2f * var_1_70))) ? (var_1_16 == ((signed char) (var_1_21 - var_1_22))) : (var_1_16 == ((signed char) var_1_22))))) && (var_1_23 == ((unsigned char) (! var_1_12)))) && (var_1_10 ? (var_1_24 == ((signed char) ((var_1_25 - var_1_26) + var_1_27))) : (var_1_10 ? (var_1_24 == ((signed char) (var_1_27 + var_1_26))) : (var_1_24 == ((signed char) ((var_1_28 - var_1_26) - var_1_22)))))) && ((var_1_9 == var_1_8) ? (var_1_101 ? (var_1_29 == ((signed short int) (var_1_22 - 5))) : 1) : 1)) && ((var_1_35 != (256 % var_1_28)) ? (var_1_30 == ((unsigned char) ((var_1_32 + var_1_33) - var_1_25))) : (var_1_12 ? (var_1_30 == ((unsigned char) (var_1_32 + var_1_33))) : (var_1_30 == ((unsigned char) (var_1_34 - var_1_26)))))) && (((- (- 3.8)) >= (max (var_1_5 , var_1_73))) ? (var_1_35 == ((signed short int) (max (var_1_105 , (var_1_28 - var_1_22))))) : (var_1_35 == ((signed short int) (var_1_21 + (abs (var_1_29))))))) && (var_1_36 == ((unsigned char) (min (16 , var_1_26))))) && ((var_1_50 && var_1_10) ? (var_1_37 == ((unsigned short int) (var_1_38 - var_1_33))) : (var_1_12 ? (((var_1_21 < var_1_25) || var_1_101) ? (var_1_37 == ((unsigned short int) (min (var_1_25 , (var_1_34 + var_1_28))))) : (var_1_37 == ((unsigned short int) ((63629 - (var_1_39 - var_1_22)) - var_1_34)))) : 1))) && ((var_1_38 == var_1_100) ? (var_1_40 == ((signed short int) (min (var_1_19 , (var_1_49 + (var_1_33 + last_1_var_1_40)))))) : 1)) && ((! var_1_11) ? ((var_1_8 == var_1_28) ? ((var_1_34 == var_1_77) ? (var_1_41 == ((float) ((min (var_1_6 , (max (10.5f , var_1_5)))) + (var_1_42 + (var_1_43 - var_1_44))))) : (var_1_41 == ((float) (abs (var_1_45))))) : ((var_1_13 >= var_1_27) ? (var_1_41 == ((float) var_1_42)) : (var_1_41 == ((float) var_1_6)))) : (var_1_41 == ((float) var_1_45)))) && (var_1_23 ? ((! var_1_50) ? (var_1_46 == ((unsigned char) ((max (var_1_26 , (max (var_1_22 , var_1_33)))) + var_1_25))) : (var_1_46 == ((unsigned char) var_1_25))) : (var_1_46 == ((unsigned char) (var_1_32 + 64))))) && (var_1_12 ? ((4.9f == var_1_45) ? ((-4 > var_1_15) ? (var_1_47 == ((signed char) (abs (var_1_26 - var_1_28)))) : (var_1_47 == ((signed char) (var_1_21 - var_1_22)))) : (var_1_47 == ((signed char) (-2 + var_1_27)))) : ((var_1_7 >= (var_1_26 * var_1_32)) ? (var_1_47 == ((signed char) (var_1_28 - var_1_26))) : (var_1_47 == ((signed char) (abs (var_1_28))))))) && (var_1_48 == ((unsigned short int) (abs (var_1_22 + 16))))) && (((- (var_1_32 | var_1_15)) != var_1_26) ? (var_1_49 == ((signed long int) (min ((var_1_39 - var_1_32) , var_1_78)))) : (var_1_49 == ((signed long int) (min (var_1_78 , (abs (var_1_7)))))))) && ((var_1_58 < (var_1_96 * var_1_6)) ? ((var_1_76 >= (var_1_20 * (var_1_9 / var_1_33))) ? ((var_1_63 > 16u) ? (var_1_50 == ((unsigned char) var_1_51)) : 1) : (var_1_50 == ((unsigned char) (! var_1_12)))) : 1)) && (var_1_52 == ((unsigned char) ((var_1_12 || var_1_51) || (var_1_11 && var_1_53))))) && (((last_1_var_1_54 > var_1_96) && var_1_52) ? (var_1_54 == ((double) ((var_1_44 + var_1_43) + var_1_5))) : (var_1_54 == ((double) (abs (var_1_43)))))) && ((var_1_45 < var_1_5) ? ((var_1_97 >= (var_1_87 ^ var_1_38)) ? ((var_1_103 == var_1_41) ? (var_1_55 == ((signed char) (abs (var_1_27)))) : 1) : 1) : (var_1_55 == ((signed char) ((max (1 , var_1_21)) - var_1_28))))) && (((min ((- var_1_42) , var_1_96)) <= (- var_1_44)) ? (((var_1_12 || var_1_92) || (-2 >= (last_1_var_1_56 + var_1_75))) ? (var_1_56 == ((signed long int) (abs (min ((var_1_34 - var_1_59) , last_1_var_1_56))))) : (var_1_56 == ((signed long int) ((var_1_57 - last_1_var_1_56) - (min (var_1_25 , 50)))))) : 1)) && (((min (1 , var_1_25)) >= ((var_1_99 + var_1_48) - var_1_32)) ? ((var_1_6 <= ((var_1_43 + var_1_96) + (var_1_5 - var_1_44))) ? (var_1_58 == ((double) (min (8.625 , var_1_42)))) : (((max (var_1_63 , (var_1_34 - 5))) >= var_1_76) ? (var_1_58 == ((double) ((max (var_1_44 , var_1_42)) + (min (var_1_6 , (min (2.8 , 0.25))))))) : (var_1_58 == ((double) (var_1_6 + (var_1_43 + 1.75)))))) : 1)) && ((var_1_5 <= var_1_42) ? (last_1_var_1_106 ? ((((~ 256) + last_1_var_1_107) > last_1_var_1_7) ? ((var_1_39 == last_1_var_1_13) ? ((var_1_25 >= last_1_var_1_100) ? (var_1_59 == ((signed short int) (abs (var_1_19)))) : (var_1_59 == ((signed short int) (var_1_27 + var_1_32)))) : 1) : ((! last_1_var_1_101) ? (var_1_59 == ((signed short int) ((max (var_1_28 , last_1_var_1_59)) - (min (var_1_33 , (var_1_61 - 2)))))) : (var_1_59 == ((signed short int) (abs (-128)))))) : 1) : 1)) && (var_1_62 == ((unsigned char) (var_1_51 || var_1_11)))) && ((last_1_var_1_91 < (abs (last_1_var_1_70))) ? (var_1_63 == ((unsigned long int) ((var_1_65 - 100u) - last_1_var_1_109))) : (var_1_63 == ((unsigned long int) ((min (128u , var_1_26)) + var_1_32))))) && (((- 5u) <= var_1_57) ? (var_1_66 == ((unsigned char) var_1_28)) : (var_1_89 ? (var_1_66 == ((unsigned char) (var_1_34 - ((var_1_67 - var_1_68) - var_1_25)))) : ((var_1_99 < var_1_100) ? ((var_1_59 < (var_1_13 + var_1_21)) ? (var_1_66 == ((unsigned char) ((max (128 , (var_1_69 - var_1_68))) - var_1_67))) : (var_1_66 == ((unsigned char) (var_1_69 - (min (var_1_67 , var_1_26)))))) : (var_1_66 == ((unsigned char) ((var_1_69 - (min (var_1_26 , var_1_25))) - var_1_32))))))) && ((var_1_8 >= var_1_34) ? (((var_1_7 / var_1_33) >= (var_1_80 ^ var_1_7)) ? ((var_1_75 >= (- var_1_38)) ? (var_1_70 == ((float) (min (var_1_43 , var_1_42)))) : (var_1_70 == ((float) var_1_45))) : (var_1_70 == ((float) (min ((var_1_71 - var_1_72) , var_1_44))))) : 1)) && (var_1_50 ? (var_1_73 == ((double) (max (var_1_5 , (1.25 + (abs (var_1_44))))))) : (var_1_73 == ((double) (var_1_72 - (var_1_74 - (max (var_1_5 , var_1_43)))))))) && (var_1_75 == ((signed long int) (min (var_1_105 , (var_1_57 - 128)))))) && (var_1_12 ? (var_1_76 == ((signed long int) (var_1_9 - last_1_var_1_56))) : ((((var_1_61 - var_1_39) << var_1_22) < (max (4 , -2))) ? (var_1_76 == ((signed long int) (var_1_25 + last_1_var_1_30))) : (var_1_76 == ((signed long int) (abs (var_1_69 - 4))))))) && ((var_1_54 <= -0.2) ? (var_1_53 ? (var_1_77 == ((unsigned char) var_1_26)) : (var_1_77 == ((unsigned char) (var_1_34 - var_1_67)))) : (var_1_77 == ((unsigned char) var_1_69)))) && ((var_1_69 < (var_1_57 * var_1_59)) ? ((var_1_107 >= -8) ? (var_1_78 == ((signed long int) var_1_25)) : (((min (2 , (var_1_34 - var_1_33))) > (~ var_1_27)) ? ((var_1_6 < (min (var_1_96 , var_1_73))) ? (var_1_78 == ((signed long int) (max ((var_1_69 - var_1_61) , (var_1_38 - var_1_8))))) : (var_1_78 == ((signed long int) (max (var_1_56 , var_1_37))))) : 1)) : (var_1_78 == ((signed long int) var_1_36)))) && (((max (-0.6f , 3.025f)) < var_1_41) ? ((var_1_97 <= var_1_68) ? ((var_1_72 == (var_1_96 / var_1_74)) ? (var_1_80 == ((signed char) (var_1_68 + ((min (var_1_26 , var_1_25)) - var_1_81)))) : (var_1_80 == ((signed char) var_1_26))) : (var_1_80 == ((signed char) var_1_28))) : (var_1_80 == ((signed char) ((var_1_81 - var_1_68) + var_1_26))))) && ((var_1_99 <= (var_1_99 / (var_1_39 + 64u))) ? (var_1_23 ? (var_1_82 == ((signed char) ((min ((max (var_1_68 , var_1_22)) , var_1_25)) - (abs (var_1_81))))) : (var_1_82 == ((signed char) (abs (var_1_22 - (var_1_84 - var_1_26)))))) : ((((var_1_108 * 4.6f) * var_1_42) > var_1_70) ? ((var_1_58 > var_1_43) ? (var_1_82 == ((signed char) (var_1_26 + var_1_68))) : (var_1_82 == ((signed char) (max (var_1_28 , (var_1_22 - var_1_26)))))) : (var_1_10 ? (var_1_82 == ((signed char) (min (var_1_86 , var_1_69)))) : (var_1_82 == ((signed char) (var_1_26 - var_1_81))))))) && (((var_1_32 | var_1_69) >= var_1_99) ? (var_1_87 == ((signed short int) (var_1_39 - var_1_88))) : 1)) && ((var_1_15 >= (var_1_34 - var_1_9)) ? (var_1_89 == ((unsigned char) (var_1_11 && var_1_90))) : (var_1_89 == ((unsigned char) ((! 1) || var_1_90))))) && ((var_1_54 >= var_1_5) ? (var_1_91 == ((float) (var_1_72 - var_1_5))) : (var_1_91 == ((float) (var_1_43 - var_1_44))))) && (var_1_92 == ((unsigned char) (! var_1_90)))) && ((((var_1_7 <= var_1_97) || var_1_89) && var_1_89) ? ((var_1_8 >= (var_1_65 % var_1_34)) ? ((var_1_23 && var_1_51) ? (var_1_93 == ((signed short int) (min (last_1_var_1_93 , var_1_95)))) : (var_1_93 == ((signed short int) ((max (var_1_7 , var_1_99)) + var_1_21)))) : ((var_1_7 >= var_1_63) ? (var_1_93 == ((signed short int) (var_1_99 + var_1_67))) : (var_1_93 == ((signed short int) var_1_95)))) : 1)) && (var_1_96 == ((double) var_1_72))) && (var_1_89 ? (var_1_97 == ((unsigned long int) var_1_98)) : 1)) && (var_1_23 ? (var_1_99 == ((unsigned long int) var_1_98)) : 1)) && (var_1_89 ? (var_1_100 == ((unsigned short int) 0)) : (var_1_100 == ((unsigned short int) var_1_78)))) && (var_1_101 == ((unsigned char) var_1_12))) && (var_1_52 ? (var_1_102 == ((float) var_1_45)) : (var_1_102 == ((float) var_1_74)))) && (var_1_92 ? (var_1_103 == ((double) var_1_6)) : (var_1_103 == ((double) var_1_71)))) && (var_1_50 ? (var_1_104 == ((unsigned char) 1)) : (var_1_104 == ((unsigned char) var_1_28)))) && (var_1_51 ? (var_1_105 == ((signed short int) var_1_59)) : 1)) && (var_1_90 ? (var_1_106 == ((unsigned char) 0)) : (var_1_106 == ((unsigned char) var_1_11)))) && (var_1_10 ? (var_1_107 == ((signed long int) var_1_97)) : (var_1_107 == ((signed long int) var_1_87)))) && ((var_1_61 > (var_1_26 + var_1_20)) ? (var_1_108 == ((float) (8.4f - var_1_71))) : ((var_1_23 && var_1_106) ? (var_1_108 == ((float) var_1_6)) : (var_1_108 == ((float) var_1_45))))) && (var_1_109 == ((unsigned char) var_1_22))
;
}
int main(void) {
	isInitial = 1;
