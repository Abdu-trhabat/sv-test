...
void step(void) {
	...
	// From: Req3Batch15850_while
	if (var_1_7 > var_1_9) {
		var_1_18 = var_1_20;
	}


	// From: Req5Batch15850_while
	var_1_22 = ((var_1_2 && var_1_23) || (! var_1_24));


	// From: Req6Batch15850_while
	...
	// From: Req7Batch15850_while
	if (var_1_26 <= (-1 * var_1_12)) {
		var_1_27 = var_1_18;
	}


	// From: Req4Batch15850_while
