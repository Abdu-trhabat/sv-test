...
void step(void) {
	...
	if ((signed_long_int_Array_0[1] >> 16u) < (abs (signed_long_int_Array_0[0]))) {
	...
	if (float_Array_0[2] > float_Array_0[0]) {
		...
		double_Array_0[0][1] = (max (double_Array_0[0][0] , (max (double_Array_0[1][0] , double_Array_0[1][1]))));
	}
	...
	if (stepLocal_0 && BOOL_unsigned_char_Array_0[1]) {
		if ((max (float_Array_0[2] , (- float_Array_0[1]))) != float_Array_0[0]) {
...
int property(void) {
	return (((((float_Array_0[2] > float_Array_0[1]) && BOOL_unsigned_char_Array_0[1]) ? (((max (float_Array_0[2] , (- float_Array_0[1]))) != float_Array_0[0]) ? (BOOL_unsigned_char_Array_0[1] ? (unsigned_long_int_Array_0[1] == ((unsigned long int) 10u)) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_long_int_Array_0[0]))) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_long_int_Array_0[0]))) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_long_int_Array_0[0]))) && (((signed_long_int_Array_0[1] >> 16u) < (abs (signed_long_int_Array_0[0]))) ? (BOOL_unsigned_char_Array_0[1] == ((unsigned char) (BOOL_unsigned_char_Array_0[2] || BOOL_unsigned_char_Array_0[0]))) : 1)) && ((float_Array_0[2] > float_Array_0[0]) ? (double_Array_0[0][1] == ((double) 4.6)) : (double_Array_0[0][1] == ((double) (max (double_Array_0[0][0] , (max (double_Array_0[1][0] , double_Array_0[1][1])))))))) && ((double_Array_0[1][0] == (- double_Array_0[0][0])) ? ((BOOL_unsigned_char_Array_0[2] && BOOL_unsigned_char_Array_0[1]) ? (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[0])) : (unsigned_char_Array_0[1] == ((unsigned char) 0))) : (unsigned_char_Array_0[1] == ((unsigned char) unsigned_char_Array_0[0])))
;
}
int main(void) {
	isInitial = 1;
