...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch114Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	/* 403L, 237L) */ if (/* 404L, 197L, 198L) */ ((var_1_22) >= (/* 406L, 196L, 200L) */ ((var_1_40) >> (8))))) {
		/* 409L, 231L) */ if (/* 410L, 211L, 212L) */ ((/* 411L, 209L, 213L) */ (abs (var_1_7))) <= (var_1_41))) {
			/* 414L, 224L) */ var_1_43 = (
				/* 417L, 223L) */ (abs (
					var_1_25
				))
	...
	// From: CodeObject8
	/* 429L, 255L) */ if (/* 430L, 243L, 244L) */ ((var_1_15) <= (-32))) {
		/* 433L, 254L) */ var_1_46 = (
			/* 436L, 253L) */ (abs (
				var_1_27
			))
	...
	// From: Req8Batch114Filler_PR_CO
	/* 1034L, 259L, 783L, 789L) */ var_1_22 = (
		16u
	);


	// From: Req9Batch114Filler_PR_CO
	/* 1040L, 269L, 807L, 813L) */ var_1_23 = (
		var_1_18
	);


	// From: Req3Batch114Filler_PR_CO
	...
	// From: CodeObject6
	/* 377L, 185L) */ if (/* 378L, 154L, 155L) */ ((/* 379L, 152L, 156L) */ ((var_1_22) / (var_1_39))) != (var_1_27))) {
		/* 383L, 176L) */ var_1_37 = (
			/* 386L, 175L) */ ((
				/* 387L, 169L) */ (min (
					/* 387L, 169L) */ (
