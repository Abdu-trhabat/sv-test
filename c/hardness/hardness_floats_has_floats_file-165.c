...
void step(void) {
	...
	// From: Req4Batch165has_floats
	if (var_1_14 > var_1_9) {
		var_1_21 = ((var_1_20 + var_1_19) + var_1_18);
	}


	// From: Req2Batch165has_floats
...
int property(void) {
	return (((((last_1_var_1_21 ^ (last_1_var_1_21 / -2)) <= last_1_var_1_21) ? (((var_1_5 - var_1_6) <= -4.0f) ? (var_1_1 == ((float) (abs (var_1_7)))) : (var_1_1 == ((float) var_1_7))) : (var_1_1 == ((float) var_1_7))) && (((var_1_9 - var_1_10) <= var_1_21) ? (var_1_8 == ((signed char) (min ((var_1_11 + var_1_12) , var_1_13)))) : 1)) && (((var_1_1 >= var_1_5) || var_1_15) ? (var_1_14 == ((unsigned char) (max (var_1_16 , var_1_17)))) : (var_1_14 == ((unsigned char) ((var_1_18 + var_1_19) + var_1_20))))) && ((var_1_14 > var_1_9) ? (var_1_21 == ((unsigned long int) ((var_1_20 + var_1_19) + var_1_18))) : 1)
;
}
int main(void) {
	isInitial = 1;
