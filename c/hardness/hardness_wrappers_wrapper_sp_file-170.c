...
void step(void) {
	...
	if (stepLocal_1 > (*(WrapperStruct00_var_1_6_Pointer))) {
		if (stepLocal_4 > (*(WrapperStruct00_var_1_5_Pointer))) {
			...
			(*(WrapperStruct00_var_1_7_Pointer)) = (max ((*(WrapperStruct00_var_1_8_Pointer)) , (*(WrapperStruct00_var_1_9_Pointer))));
		}
	} else {
	...
	// From: Req1Batch170Wrapper_SP
	unsigned char stepLocal_0 = ! (*(WrapperStruct00_var_1_4_Pointer));
	if (((*(WrapperStruct00_var_1_10_Pointer)) != (min ((*(WrapperStruct00_var_1_7_Pointer)) , 64))) || stepLocal_0) {
