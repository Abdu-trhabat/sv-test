...
void step(void) {
 ...
 if ((*(WrapperStruct00_var_1_9_Pointer)) && ((*(WrapperStruct00_var_1_3_Pointer)) > ((*(WrapperStruct00_var_1_2_Pointer)) / (*(WrapperStruct00_var_1_15_Pointer))))) {
  (*(WrapperStruct00_var_1_14_Pointer)) = ((((((((((*(WrapperStruct00_var_1_16_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_16_Pointer))) : ((*(WrapperStruct00_var_1_16_Pointer))))) - (*(WrapperStruct00_var_1_17_Pointer)))) > (((*(WrapperStruct00_var_1_18_Pointer)) + (*(WrapperStruct00_var_1_19_Pointer))))) ? (((((((*(WrapperStruct00_var_1_16_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_16_Pointer))) : ((*(WrapperStruct00_var_1_16_Pointer))))) - (*(WrapperStruct00_var_1_17_Pointer)))) : (((*(WrapperStruct00_var_1_18_Pointer)) + (*(WrapperStruct00_var_1_19_Pointer))))));
 } else {
