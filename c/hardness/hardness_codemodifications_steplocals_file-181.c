...
void step(void) {
	...
	// From: Req2Batch181stepLocals
	var_1_6 = var_1_7;


	// From: Req3Batch181stepLocals
	...
	// From: Req6Batch181stepLocals
	signed long int stepLocal_4 = min (var_1_17 , var_1_1);
	if (! (! (var_1_15 || var_1_7))) {
