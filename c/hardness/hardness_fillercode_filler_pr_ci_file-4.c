...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject7
	/* 450L, 292L) */ if (/* 451L, 254L, 255L) */ ((var_1_19) >= (var_1_17))) {
		/* 454L, 280L) */ if (/* 455L, 263L, 264L) */ ((var_1_11) != (var_1_10))) {
			/* 458L, 273L) */ var_1_38 = (
				var_1_36
			);
		} else {
	...
	// From: CodeObject5
	/* 427L, 220L) */ if (/* 428L, 209L, 210L) */ ((var_1_21) < (var_1_13))) {
		/* 431L, 219L) */ var_1_35 = (
			var_1_36
		);
	}
	...
	// From: CodeObject9
	/* 507L, 391L) */ if (/* 508L, 369L, 370L) */ ((var_1_8) < (var_1_45))) {
		/* 511L, 389L) */ if (/* 512L, 378L, 379L) */ ((var_1_18) > (var_1_31))) {
			/* 515L, 388L) */ var_1_46 = (
				var_1_30
			);
		}
	...
	/* 415L, 196L) */ if (var_1_1) {
		/* 417L, 194L) */ if (/* 418L, 179L, 180L) */ ((/* 419L, 177L, 181L) */ ((var_1_11) * (var_1_6))) < (var_1_6))) {
			/* 423L, 193L) */ var_1_31 = (
				var_1_34
			);
		}
	...
	// From: CodeObject8
	/* 478L, 360L) */ if (/* 479L, 300L, 301L) */ ((/* 480L, 298L, 302L) */ (min (/* 480L, 298L, 302L) */ (var_1_16) , (var_1_31)))) < (var_1_18))) {
		/* 484L, 329L) */ if (/* 485L, 317L, 318L) */ ((var_1_31) > (var_1_18))) {
			/* 488L, 328L) */ var_1_43 = (
				/* 491L, 327L) */ (abs (
					var_1_36
				))
		...
		/* 493L, 358L) */ if (/* 494L, 337L, 338L) */ ((var_1_11) > (/* 496L, 336L, 340L) */ ((var_1_40) >> (/* 498L, 335L, 342L) */ ((var_1_44) - (2))))))) {
			/* 501L, 357L) */ var_1_43 = (
				/* 504L, 356L) */ ((
					var_1_44
				) + (
