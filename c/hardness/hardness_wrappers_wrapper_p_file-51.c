...
void step(void) {
	...
	if ((*(var_1_4_Pointer)) <= last_1_var_1_17) {
		if ((*(var_1_2_Pointer)) && (last_1_var_1_17 == (max ((*(var_1_16_Pointer)) , (*(var_1_12_Pointer)))))) {
	...
	unsigned long int stepLocal_1 = (max ((*(var_1_11_Pointer)) , (*(var_1_12_Pointer)))) - (*(var_1_13_Pointer));
