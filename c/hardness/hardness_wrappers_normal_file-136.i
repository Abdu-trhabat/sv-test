...
void step(void) {
 ...
 if (stepLocal_0 == var_1_4) {
  if (var_1_8 < stepLocal_1) {
   var_1_7 = ((((var_1_11 - var_1_12) < 0 ) ? -(var_1_11 - var_1_12) : (var_1_11 - var_1_12)));
  } else {
   if (var_1_2) {
    var_1_7 = var_1_11;
   } else {
