...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_3 > stepLocal_1) {
		if ((var_1_12 * var_1_13) < var_1_14) {
			var_1_11 = (max (var_1_5 , (var_1_3 + var_1_7)));
		}
	} else {
