...
int property(void) {
	return ((((! var_1_2) ? (var_1_1 == ((double) (var_1_3 - var_1_4))) : (var_1_1 == ((double) (min (16.2 , var_1_3))))) && (((var_1_3 + (var_1_4 + var_1_1)) != var_1_1) ? (var_1_2 ? (((- var_1_10) <= var_1_8) ? (var_1_9 ? (var_1_5 == ((double) var_1_4)) : 1) : (var_1_5 == ((double) var_1_3))) : (var_1_5 == ((double) var_1_3))) : (var_1_5 == ((double) var_1_3)))) && (((var_1_8 + last_1_var_1_13) < var_1_11) ? ((last_1_var_1_13 > var_1_11) ? (var_1_10 == ((unsigned char) var_1_12)) : 1) : 1)) && (var_1_9 ? (((var_1_4 * (var_1_3 - 5.3)) <= var_1_5) ? (var_1_13 == ((unsigned short int) var_1_10)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
