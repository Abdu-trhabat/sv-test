...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch39Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 unsigned long int stepLocal_0 = (( ((last_1_var_1_17) + (last_1_var_1_10))) ^ (last_1_var_1_12));
  ...
  var_1_27
                   ...
                   if ( (( ((var_1_25) % ( ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))))) >= ( ((var_1_12) * (var_1_11))))) {
                    var_1_35 = (
