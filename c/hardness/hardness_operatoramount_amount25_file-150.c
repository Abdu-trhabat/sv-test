...
void step(void) {
	// From: Req3Batch150Amount25
	var_1_13 = var_1_14;


	// From: Req4Batch150Amount25
	var_1_15 = var_1_10;


	// From: Req2Batch150Amount25
	...
	if (stepLocal_2 || var_1_9) {
		if (stepLocal_3 || var_1_15) {
			var_1_11 = (min ((var_1_12 + var_1_3) , -500));
		} else {
			var_1_11 = var_1_12;
		}
	} else {
	...
	// From: Req1Batch150Amount25
	signed long int stepLocal_1 = (var_1_11 % var_1_6) + var_1_11;
	signed long int stepLocal_0 = max (var_1_11 , var_1_2);
	if ((var_1_2 * (min (var_1_11 , var_1_3))) <= stepLocal_1) {
