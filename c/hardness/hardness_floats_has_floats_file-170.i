...
void step(void) {
 ...
 if ((var_1_10 != ((((var_1_7) < (64)) ? (var_1_7) : (64)))) || stepLocal_0) {
  var_1_1 = var_1_5;
 } else {
  var_1_1 = var_1_6;
 }
...
int property(void) {
 return (((((var_1_10 != ((((var_1_7) < (64)) ? (var_1_7) : (64)))) || (! var_1_4)) ? (var_1_1 == ((unsigned long int) var_1_5)) : (var_1_1 == ((unsigned long int) var_1_6))) && ((var_1_5 > var_1_6) ? ((last_1_var_1_10 > var_1_5) ? (var_1_7 == ((unsigned char) var_1_8)) : (var_1_7 == ((unsigned char) ((((var_1_8) > (var_1_9)) ? (var_1_8) : (var_1_9)))))) : ((var_1_6 <= var_1_5) ? ((var_1_8 <= var_1_9) ? (var_1_7 == ((unsigned char) ((((var_1_8) > (var_1_9)) ? (var_1_8) : (var_1_9))))) : 1) : 1))) && ((last_1_var_1_1 != (var_1_8 | last_1_var_1_7)) ? (var_1_10 == ((unsigned char) var_1_8)) : 1)) && ((var_1_4 && (var_1_10 == var_1_5)) ? ((var_1_6 <= var_1_9) ? (var_1_11 == ((signed char) var_1_12)) : (var_1_11 == ((signed char) 16))) : (var_1_11 == ((signed char) var_1_12)))
;
}
int main(void) {
 isInitial = 1;
