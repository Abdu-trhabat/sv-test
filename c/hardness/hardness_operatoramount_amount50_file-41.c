...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch41Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch41Amount50
	unsigned char stepLocal_4 = var_1_14 == var_1_17;
	if (var_1_6 || stepLocal_4) {
		if (((var_1_19 - var_1_20) - var_1_21) > var_1_17) {
			var_1_18 = (max (var_1_14 , (min (var_1_20 , var_1_22))));
		} else {
			var_1_18 = ((min (var_1_20 , (min (var_1_23 , var_1_24)))) - var_1_25);
		}
	} else {
		var_1_18 = 5.75f;
	}
