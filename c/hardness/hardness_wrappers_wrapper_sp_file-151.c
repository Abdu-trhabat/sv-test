...
void step(void) {
	...
	// From: Req4Batch151Wrapper_SP
	if (! (*(WrapperStruct00_var_1_13_Pointer))) {
		(*(WrapperStruct00_var_1_14_Pointer)) = ((max (((*(WrapperStruct00_var_1_15_Pointer)) + (*(WrapperStruct00_var_1_16_Pointer))) , (*(WrapperStruct00_var_1_17_Pointer)))) + (abs ((*(WrapperStruct00_var_1_18_Pointer)) + (*(WrapperStruct00_var_1_19_Pointer)))));
	} else {
		if ((*(WrapperStruct00_var_1_13_Pointer))) {
