...
void step(void) {
	// From: Req2Batch157Wrapper_A
	if ((float_Array_0[1][2] + float_Array_0[0][1]) >= ((min (float_Array_0[1][1] , float_Array_0[0][0])) - (min (float_Array_0[1][0] , float_Array_0[0][2])))) {
	...
	// From: Req3Batch157Wrapper_A
	if (BOOL_unsigned_char_Array_0[2] && (BOOL_unsigned_char_Array_0[0] && BOOL_unsigned_char_Array_0[1])) {
		signed_long_int_Array_0[1][1] = -200;
	}


	// From: Req4Batch157Wrapper_A
	unsigned_char_Array_0[2] = (unsigned_char_Array_0[3] - ((32 - unsigned_char_Array_0[0]) + (min (unsigned_char_Array_0[1] , unsigned_char_Array_0[4]))));


	// From: Req1Batch157Wrapper_A
	signed long int stepLocal_1 = max ((signed_long_int_Array_0[0][4] - signed_long_int_Array_0[1][3]) , signed_long_int_Array_0[0][2]);
...
int property(void) {
	return ((((128 <= (max ((signed_long_int_Array_0[0][4] - signed_long_int_Array_0[1][3]) , signed_long_int_Array_0[0][2]))) ? ((signed_long_int_Array_0[1][3] <= (signed_long_int_Array_0[0][4] / signed_long_int_Array_0[0][3])) ? (BOOL_unsigned_char_Array_0[2] ? (signed_long_int_Array_0[1][4] == ((signed long int) 10)) : (signed_long_int_Array_0[1][4] == ((signed long int) signed_long_int_Array_0[1][2]))) : (signed_long_int_Array_0[1][4] == ((signed long int) signed_long_int_Array_0[1][2]))) : (signed_long_int_Array_0[1][4] == ((signed long int) signed_long_int_Array_0[1][2]))) && (((float_Array_0[1][2] + float_Array_0[0][1]) >= ((min (float_Array_0[1][1] , float_Array_0[0][0])) - (min (float_Array_0[1][0] , float_Array_0[0][2])))) ? (signed_long_int_Array_0[0][2] == ((signed long int) (signed_long_int_Array_0[0][1] - signed_long_int_Array_0[0][0]))) : (signed_long_int_Array_0[0][2] == ((signed long int) signed_long_int_Array_0[1][0])))) && ((BOOL_unsigned_char_Array_0[2] && (BOOL_unsigned_char_Array_0[0] && BOOL_unsigned_char_Array_0[1])) ? (signed_long_int_Array_0[1][1] == ((signed long int) -200)) : 1)) && (unsigned_char_Array_0[2] == ((unsigned char) (unsigned_char_Array_0[3] - ((32 - unsigned_char_Array_0[0]) + (min (unsigned_char_Array_0[1] , unsigned_char_Array_0[4]))))))
;
}
int main(void) {
	isInitial = 1;
