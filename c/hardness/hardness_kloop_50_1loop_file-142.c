...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14250_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch14250_1loop
	if ((max (var_1_7 , var_1_8)) >= (var_1_11 >> var_1_14)) {
		var_1_13 = var_1_4;
	}


	// From: Req5Batch14250_1loop
	var_1_15 = (10u + (var_1_14 + var_1_16));


	// From: Req6Batch14250_1loop
	if (-10 > var_1_12) {
	...
	// From: Req8Batch14250_1loop
	var_1_22 = var_1_23;


	// From: Req9Batch14250_1loop
	var_1_24 = var_1_25;


	// From: Req2Batch14250_1loop
	if (var_1_24) {
