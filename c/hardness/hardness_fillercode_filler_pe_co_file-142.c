...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch142Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch142Filler_PE_CO
	/* 1036L, 288L, 848L, 854L) */ var_1_22 = (
		var_1_23
	);


	// From: Req9Batch142Filler_PE_CO
	/* 1042L, 298L, 872L, 878L) */ var_1_24 = (
		var_1_25
	);


	// From: Req2Batch142Filler_PE_CO
