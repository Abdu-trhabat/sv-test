...
void step(void) {
	// From: Req1Batch113Wrapper_SP
	unsigned long int stepLocal_0 = (*(WrapperStruct00_var_1_3_Pointer));
	if ((*(WrapperStruct00_var_1_2_Pointer)) >= stepLocal_0) {
		(*(WrapperStruct00_var_1_1_Pointer)) = (min (128 , (*(WrapperStruct00_var_1_4_Pointer))));
	} else {
		(*(WrapperStruct00_var_1_1_Pointer)) = (min (((*(WrapperStruct00_var_1_5_Pointer)) + (*(WrapperStruct00_var_1_6_Pointer))) , (*(WrapperStruct00_var_1_4_Pointer))));
	}


	// From: Req4Batch113Wrapper_SP
	...
	// From: Req3Batch113Wrapper_SP
	if (-64 >= (*(WrapperStruct00_var_1_14_Pointer))) {
		if ((-1000 < 256) && ((max ((*(WrapperStruct00_var_1_14_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer)))) > (*(WrapperStruct00_var_1_4_Pointer)))) {
