...
void step(void) {
	...
	// From: Req2Batch161Wrapper_A
	if (float_Array_0[0][1][1] < ((float_Array_0[1][1][1] * float_Array_0[1][0][0]) + float_Array_0[0][0][0])) {
		unsigned_long_int_Array_0[0] = (abs (last_1_unsigned_long_int_Array_0_0_));
	}


	// From: Req3Batch161Wrapper_A
