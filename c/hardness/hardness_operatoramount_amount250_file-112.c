...
void step(void) {
	// From: Req23Batch112Amount250
	if (last_1_var_1_37 && (last_1_var_1_50 < var_1_31)) {
		var_1_53 = (((var_1_54 - var_1_18) + (max (var_1_43 , 10u))) + (min (var_1_16 , 128u)));
	}


	// From: Req11Batch112Amount250
	signed long int stepLocal_4 = var_1_13;
	signed long int stepLocal_3 = var_1_13 * last_1_var_1_48;
	if (((var_1_18 + var_1_16) % (max (var_1_30 , var_1_24))) > stepLocal_3) {
		...
		var_1_29 = (var_1_33 - (min (var_1_5 , var_1_32)));
	}


	// From: Req21Batch112Amount250
	if (var_1_29 < (min ((- var_1_32) , (10.25 + var_1_7)))) {
		var_1_50 = (min (var_1_32 , var_1_51));
	} else {
		var_1_50 = ((var_1_32 + 31.25) - (var_1_4 - 32.25));
	}


	// From: Req3Batch112Amount250
	if (last_1_var_1_26) {
		var_1_12 = ((min ((var_1_13 - 50) , last_1_var_1_56)) - last_1_var_1_15);
	}


	// From: Req17Batch112Amount250
	...
	// From: Req27Batch112Amount250
	if (var_1_51 < last_1_var_1_28) {
		var_1_59 = (abs (last_1_var_1_52));
	} else {
		if (var_1_21) {
			var_1_59 = (max (last_1_var_1_47 , (var_1_13 - last_1_var_1_64)));
		}
	}


	// From: Req7Batch112Amount250
	if ((max (var_1_17 , var_1_59)) <= (var_1_13 / var_1_24)) {
		var_1_22 = var_1_7;
	}


	// From: Req32Batch112Amount250
	if (var_1_33 <= (max ((min (var_1_32 , var_1_22)) , var_1_7))) {
		if (var_1_4 > (max ((var_1_22 + 1.896f) , (max (var_1_50 , var_1_45))))) {
			var_1_65 = var_1_18;
		} else {
			var_1_65 = var_1_16;
		}
	...
	// From: Req4Batch112Amount250
	var_1_14 = (max (var_1_11 , var_1_10));


	// From: Req13Batch112Amount250
	var_1_35 = (! var_1_20);


	// From: Req25Batch112Amount250
	var_1_56 = (min (var_1_41 , var_1_43));


	// From: Req29Batch112Amount250
	var_1_61 = var_1_62;


	// From: Req30Batch112Amount250
	var_1_63 = var_1_11;


	// From: Req31Batch112Amount250
	if (var_1_21) {
		var_1_64 = var_1_11;
	} else {
		var_1_64 = -8;
	...
	// From: Req26Batch112Amount250
	if (var_1_27) {
		var_1_57 = (max ((var_1_58 - var_1_43) , (max ((var_1_12 + var_1_42) , var_1_56))));
	} else {
		var_1_57 = (min (last_1_var_1_57 , var_1_61));
	}


	// From: Req22Batch112Amount250
	unsigned long int stepLocal_12 = (var_1_59 ^ var_1_57) % (abs (var_1_24));
	if (var_1_12 > stepLocal_12) {
		var_1_52 = var_1_17;
	} else {
		if ((max (var_1_33 , 16.2)) <= var_1_29) {
			var_1_52 = (min (var_1_16 , (var_1_17 + var_1_18)));
		} else {
			var_1_52 = var_1_18;
		}
	}
	...
	// From: Req10Batch112Amount250
	if (var_1_20) {
		if (var_1_35) {
			var_1_28 = (max ((var_1_5 - var_1_7) , var_1_6));
		}
	} else {
	...
	// From: Req16Batch112Amount250
	if (! var_1_35) {
		if (var_1_53 > (max (var_1_57 , var_1_16))) {
	...
	// From: Req8Batch112Amount250
	if (! var_1_60) {
		var_1_25 = (max (64 , var_1_17));
	} else {
	...
	// From: Req2Batch112Amount250
	if (var_1_60) {
		var_1_8 = (max (var_1_10 , var_1_11));
	}


	// From: Req24Batch112Amount250
	signed long int stepLocal_13 = var_1_36;
	if (var_1_25 <= stepLocal_13) {
		var_1_55 = (min ((var_1_57 + var_1_12) , (max (100 , var_1_41))));
	}


	// From: Req15Batch112Amount250
	...
	// From: Req20Batch112Amount250
	if (8u <= (var_1_57 * var_1_59)) {
		var_1_48 = var_1_17;
	} else {
		if ((min (var_1_30 , (var_1_56 / var_1_24))) > var_1_61) {
			var_1_48 = (var_1_25 + (min (var_1_64 , var_1_17)));
		} else {
			if (var_1_6 >= (var_1_44 * var_1_50)) {
				var_1_48 = (max (var_1_61 , var_1_59));
			} else {
				var_1_48 = var_1_10;
			}
		}
	...
	// From: Req19Batch112Amount250
	if ((last_1_var_1_47 + var_1_43) > (var_1_65 / var_1_30)) {
		var_1_47 = (min ((var_1_14 - (var_1_46 + var_1_16)) , (last_1_var_1_47 - var_1_59)));
	} else {
		if (var_1_37 || var_1_35) {
			var_1_47 = (var_1_11 + var_1_17);
		} else {
			var_1_47 = ((max (-100 , 64)) + (var_1_16 - (var_1_18 + var_1_59)));
		}
	}
}
...
int property(void) {
	return ((((((((((((((((((((((((((((((((var_1_52 < var_1_53) ? (var_1_1 == ((float) ((var_1_4 - var_1_5) - (max (3.5f , (var_1_6 - var_1_7)))))) : (var_1_1 == ((float) var_1_6))) && (var_1_60 ? (var_1_8 == ((signed char) (max (var_1_10 , var_1_11)))) : 1)) && (last_1_var_1_26 ? (var_1_12 == ((signed long int) ((min ((var_1_13 - 50) , last_1_var_1_56)) - last_1_var_1_15))) : 1)) && (var_1_14 == ((signed short int) (max (var_1_11 , var_1_10))))) && ((var_1_13 >= (1 + var_1_61)) ? ((var_1_64 > (var_1_61 * var_1_59)) ? (var_1_15 == ((unsigned char) ((max (var_1_16 , var_1_17)) + var_1_18))) : 1) : (var_1_15 == ((unsigned char) var_1_18)))) && (((var_1_64 <= var_1_18) && var_1_35) ? (var_1_19 == ((unsigned char) (var_1_20 || (var_1_35 && var_1_21)))) : 1)) && (((max (var_1_17 , var_1_59)) <= (var_1_13 / var_1_24)) ? (var_1_22 == ((float) var_1_7)) : 1)) && ((! var_1_60) ? (var_1_25 == ((unsigned char) (max (64 , var_1_17)))) : ((((var_1_7 + var_1_5) - var_1_4) >= var_1_22) ? (var_1_25 == ((unsigned char) (var_1_16 + var_1_17))) : (var_1_25 == ((unsigned char) 4))))) && ((var_1_21 && (var_1_1 != var_1_5)) ? (var_1_20 ? (var_1_26 == ((unsigned char) (! 1))) : (var_1_26 == ((unsigned char) (! var_1_27)))) : (var_1_26 == ((unsigned char) (! var_1_21))))) && (var_1_20 ? (var_1_35 ? (var_1_28 == ((float) (max ((var_1_5 - var_1_7) , var_1_6)))) : 1) : (var_1_28 == ((float) (var_1_7 + var_1_5))))) && ((((var_1_18 + var_1_16) % (max (var_1_30 , var_1_24))) > (var_1_13 * last_1_var_1_48)) ? ((var_1_13 < var_1_18) ? (var_1_29 == ((double) 64.575)) : (var_1_29 == ((double) ((var_1_31 + (var_1_32 - var_1_33)) + var_1_7)))) : (var_1_29 == ((double) (var_1_33 - (min (var_1_5 , var_1_32))))))) && (((var_1_53 / var_1_24) >= var_1_15) ? (var_1_34 == ((float) var_1_32)) : 1)) && (var_1_35 == ((unsigned char) (! var_1_20)))) && ((var_1_15 < var_1_17) ? (var_1_36 == ((signed long int) (abs (var_1_59)))) : (var_1_36 == ((signed long int) (var_1_17 + var_1_59))))) && ((var_1_52 > (var_1_39 / var_1_30)) ? ((last_1_var_1_37 && (1 > (var_1_16 / var_1_13))) ? ((var_1_39 > (~ var_1_16)) ? (var_1_37 == ((unsigned char) (var_1_21 || var_1_27))) : (last_1_var_1_37 ? (var_1_37 == ((unsigned char) (var_1_27 || var_1_38))) : (var_1_37 == ((unsigned char) var_1_21)))) : 1) : 1)) && ((! var_1_35) ? ((var_1_53 > (max (var_1_57 , var_1_16))) ? (var_1_39 == ((unsigned short int) (var_1_41 - 10))) : (((var_1_4 / var_1_6) < var_1_29) ? (var_1_39 == ((unsigned short int) (((var_1_42 - var_1_18) + (var_1_43 - 50)) - last_1_var_1_39))) : 1)) : (var_1_39 == ((unsigned short int) (var_1_18 + (var_1_16 + var_1_17)))))) && (((var_1_41 - var_1_18) > var_1_12) ? (var_1_27 ? (var_1_44 == ((float) (var_1_31 + var_1_45))) : 1) : 1)) && ((var_1_24 < (var_1_15 - var_1_43)) ? (var_1_46 == ((unsigned char) (var_1_16 + var_1_17))) : 1)) && (((last_1_var_1_47 + var_1_43) > (var_1_65 / var_1_30)) ? (var_1_47 == ((signed short int) (min ((var_1_14 - (var_1_46 + var_1_16)) , (last_1_var_1_47 - var_1_59))))) : ((var_1_37 || var_1_35) ? (var_1_47 == ((signed short int) (var_1_11 + var_1_17))) : (var_1_47 == ((signed short int) ((max (-100 , 64)) + (var_1_16 - (var_1_18 + var_1_59)))))))) && ((8u <= (var_1_57 * var_1_59)) ? (var_1_48 == ((signed short int) var_1_17)) : (((min (var_1_30 , (var_1_56 / var_1_24))) > var_1_61) ? (var_1_48 == ((signed short int) (var_1_25 + (min (var_1_64 , var_1_17))))) : ((var_1_6 >= (var_1_44 * var_1_50)) ? (var_1_48 == ((signed short int) (max (var_1_61 , var_1_59)))) : (var_1_48 == ((signed short int) var_1_10)))))) && ((var_1_29 < (min ((- var_1_32) , (10.25 + var_1_7)))) ? (var_1_50 == ((double) (min (var_1_32 , var_1_51)))) : (var_1_50 == ((double) ((var_1_32 + 31.25) - (var_1_4 - 32.25)))))) && ((var_1_12 > ((var_1_59 ^ var_1_57) % (abs (var_1_24)))) ? (var_1_52 == ((unsigned char) var_1_17)) : (((max (var_1_33 , 16.2)) <= var_1_29) ? (var_1_52 == ((unsigned char) (min (var_1_16 , (var_1_17 + var_1_18))))) : (var_1_52 == ((unsigned char) var_1_18))))) && ((last_1_var_1_37 && (last_1_var_1_50 < var_1_31)) ? (var_1_53 == ((unsigned long int) (((var_1_54 - var_1_18) + (max (var_1_43 , 10u))) + (min (var_1_16 , 128u))))) : 1)) && ((var_1_25 <= var_1_36) ? (var_1_55 == ((unsigned short int) (min ((var_1_57 + var_1_12) , (max (100 , var_1_41)))))) : 1)) && (var_1_56 == ((unsigned short int) (min (var_1_41 , var_1_43))))) && (var_1_27 ? (var_1_57 == ((unsigned long int) (max ((var_1_58 - var_1_43) , (max ((var_1_12 + var_1_42) , var_1_56)))))) : (var_1_57 == ((unsigned long int) (min (last_1_var_1_57 , var_1_61)))))) && ((var_1_51 < last_1_var_1_28) ? (var_1_59 == ((signed long int) (abs (last_1_var_1_52)))) : (var_1_21 ? (var_1_59 == ((signed long int) (max (last_1_var_1_47 , (var_1_13 - last_1_var_1_64))))) : 1))) && (var_1_19 ? (var_1_60 == ((unsigned char) var_1_27)) : (var_1_60 == ((unsigned char) var_1_20)))) && (var_1_61 == ((signed long int) var_1_62))) && (var_1_63 == ((signed char) var_1_11))) && (var_1_21 ? (var_1_64 == ((signed short int) var_1_11)) : (var_1_64 == ((signed short int) -8)))) && ((var_1_33 <= (max ((min (var_1_32 , var_1_22)) , var_1_7))) ? ((var_1_4 > (max ((var_1_22 + 1.896f) , (max (var_1_50 , var_1_45))))) ? (var_1_65 == ((unsigned char) var_1_18)) : (var_1_65 == ((unsigned char) var_1_16))) : (var_1_65 == ((unsigned char) 128)))
;
}
int main(void) {
	isInitial = 1;
