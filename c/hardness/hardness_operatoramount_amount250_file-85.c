...
void step(void) {
	...
	if (var_1_50) {
		var_1_13 = (max ((max (var_1_5 , var_1_15)) , (var_1_3 + var_1_10)));
	}


	// From: Req11Batch85Amount250
	if (last_1_var_1_55) {
		var_1_42 = (min ((var_1_31 + var_1_10) , var_1_33));
	}
	...
	signed long int stepLocal_11 = (var_1_15 * last_1_var_1_46) % (min (var_1_5 , var_1_3));
	if (stepLocal_13 < last_1_var_1_48) {
		if (stepLocal_11 >= var_1_31) {
			var_1_58 = (var_1_21 - (min ((var_1_12 - var_1_36) , var_1_9)));
		} else {
	...
	if (stepLocal_4 >= last_1_var_1_16) {
		var_1_32 = ((max (var_1_33 , var_1_34)) - last_1_var_1_58);
	} else {
		var_1_32 = (min (var_1_33 , var_1_8));
	}
	...
	if (! ((var_1_17 - var_1_18) <= (last_1_var_1_22 * last_1_var_1_37))) {
		...
		var_1_16 = (min (var_1_21 , (last_1_var_1_47 + (1u + var_1_6))));
	}
	...
	if (var_1_28 > (var_1_39 - (max (var_1_38 , var_1_17)))) {
	...
	if (var_1_64) {
		var_1_47 = ((min (var_1_31 , var_1_42)) + var_1_49);
	} else {
		var_1_47 = (max (var_1_31 , var_1_36));
	}
	...
	if ((max ((var_1_49 / var_1_3) , (var_1_61 % var_1_5))) != stepLocal_0) {
		var_1_1 = (abs (var_1_6));
	} else {
	...
	signed long int stepLocal_6 = min (var_1_42 , var_1_36);
	...
	if (var_1_10 < stepLocal_15) {
		if (stepLocal_14 >= var_1_12) {
			...
			if (var_1_34 > stepLocal_16) {
				var_1_60 = ((var_1_45 - var_1_38) - (max ((4.900890029043464E18 - var_1_39) , var_1_27)));
			} else {
				var_1_60 = (var_1_41 + var_1_38);
			}
		}
	} else {
		if (stepLocal_17 < ((var_1_31 + var_1_58) - (min (var_1_6 , var_1_10)))) {
			var_1_60 = (min (var_1_40 , var_1_38));
		}
	}


	// From: Req2Batch85Amount250
	signed long int stepLocal_2 = min (var_1_3 , var_1_5);
	...
	if (last_1_var_1_7 > stepLocal_2) {
		...
		if (((min (var_1_58 , var_1_8)) * var_1_9) < stepLocal_1) {
	...
	if (var_1_36 < stepLocal_19) {
		if (stepLocal_18 && (var_1_37 != var_1_23)) {
			var_1_63 = (var_1_7 - (min (var_1_36 , var_1_9)));
		} else {
...
int property(void) {
	return (((((((((((((((((((((((((((max ((var_1_49 / var_1_3) , (var_1_61 % var_1_5))) != -16) ? (var_1_1 == ((unsigned short int) (abs (var_1_6)))) : (var_1_1 == ((unsigned short int) (max (var_1_6 , 32))))) && ((last_1_var_1_7 > (min (var_1_3 , var_1_5))) ? (var_1_7 == ((unsigned char) ((var_1_8 - var_1_9) - var_1_10))) : ((((min (var_1_58 , var_1_8)) * var_1_9) < ((var_1_12 - var_1_6) - (var_1_10 + var_1_32))) ? (var_1_7 == ((unsigned char) (min (var_1_9 , var_1_8)))) : (var_1_7 == ((unsigned char) (abs (var_1_8))))))) && (var_1_50 ? (var_1_13 == ((signed short int) (max ((max (var_1_5 , var_1_15)) , (var_1_3 + var_1_10))))) : 1)) && ((! ((var_1_17 - var_1_18) <= (last_1_var_1_22 * last_1_var_1_37))) ? ((((last_1_var_1_32 * var_1_8) < last_1_var_1_32) || last_1_var_1_64) ? (last_1_var_1_64 ? (var_1_16 == ((unsigned long int) (var_1_21 - var_1_8))) : (var_1_16 == ((unsigned long int) (var_1_21 - var_1_6)))) : (var_1_16 == ((unsigned long int) (var_1_10 + var_1_9)))) : (var_1_16 == ((unsigned long int) (min (var_1_21 , (last_1_var_1_47 + (1u + var_1_6)))))))) && (var_1_50 ? (var_1_22 == ((double) var_1_23)) : (var_1_22 == ((double) (max (((abs (var_1_24)) + var_1_25) , ((var_1_26 + 32.5) - var_1_27))))))) && (var_1_50 ? (var_1_28 == ((float) (var_1_26 - 3.25f))) : ((((var_1_49 + var_1_8) + var_1_13) == ((var_1_16 * var_1_10) / var_1_12)) ? (var_1_28 == ((float) (var_1_26 - 1.000000000000005E14f))) : (var_1_28 == ((float) var_1_27))))) && (((var_1_10 & last_1_var_1_29) > (var_1_16 / var_1_5)) ? (var_1_29 == ((signed long int) ((var_1_58 + var_1_15) + (var_1_10 + var_1_9)))) : ((! var_1_55) ? (var_1_29 == ((signed long int) var_1_32)) : 1))) && ((last_1_var_1_48 >= last_1_var_1_16) ? (var_1_32 == ((unsigned short int) ((max (var_1_33 , var_1_34)) - last_1_var_1_58))) : (var_1_32 == ((unsigned short int) (min (var_1_33 , var_1_8)))))) && (var_1_35 == ((signed char) (var_1_9 - var_1_36)))) && (var_1_64 ? ((var_1_61 >= (var_1_48 & var_1_32)) ? (var_1_37 == ((double) (var_1_25 + ((var_1_38 - var_1_39) - 8.25)))) : (var_1_37 == ((double) (var_1_26 + var_1_24)))) : (var_1_37 == ((double) (var_1_26 + (max (var_1_40 , (var_1_39 + var_1_41)))))))) && (last_1_var_1_55 ? (var_1_42 == ((unsigned short int) (min ((var_1_31 + var_1_10) , var_1_33)))) : 1)) && ((var_1_28 <= var_1_26) ? (var_1_43 == ((double) 256.661)) : (((min (var_1_42 , var_1_36)) <= var_1_42) ? (var_1_43 == ((double) (max (((var_1_45 - 25.5) - var_1_39) , (max ((var_1_26 - 10.25) , var_1_23)))))) : 1))) && ((! (! var_1_64)) ? (var_1_46 == ((signed short int) var_1_7)) : ((64 != (var_1_34 - (var_1_48 + var_1_31))) ? (var_1_46 == ((signed short int) (abs (var_1_5)))) : (var_1_46 == ((signed short int) var_1_9))))) && (var_1_64 ? (var_1_47 == ((unsigned long int) ((min (var_1_31 , var_1_42)) + var_1_49))) : (var_1_47 == ((unsigned long int) (max (var_1_31 , var_1_36)))))) && ((var_1_32 != (var_1_47 * var_1_15)) ? (var_1_48 == ((unsigned long int) var_1_9)) : 1)) && ((last_1_var_1_42 <= last_1_var_1_29) ? (var_1_49 == ((signed short int) last_1_var_1_63)) : (var_1_49 == ((signed short int) (abs (var_1_8)))))) && ((last_1_var_1_60 >= last_1_var_1_43) ? (var_1_50 == ((unsigned char) var_1_51)) : (((- var_1_31) < last_1_var_1_1) ? (var_1_50 == ((unsigned char) (last_1_var_1_55 || var_1_51))) : 1))) && (var_1_55 ? (var_1_52 == ((signed short int) (min (var_1_61 , var_1_9)))) : 1)) && (((~ (var_1_47 >> var_1_54)) != (var_1_47 ^ var_1_10)) ? (var_1_53 == ((double) ((var_1_39 + var_1_41) + (255.7 - var_1_26)))) : (var_1_53 == ((double) (2.425 - var_1_27))))) && (var_1_50 ? (var_1_64 ? (var_1_55 == ((unsigned char) (! var_1_51))) : (var_1_55 == ((unsigned char) ((var_1_51 || (! var_1_56)) && var_1_57)))) : 1)) && ((last_1_var_1_32 < last_1_var_1_48) ? ((((var_1_15 * last_1_var_1_46) % (min (var_1_5 , var_1_3))) >= var_1_31) ? (var_1_58 == ((unsigned long int) (var_1_21 - (min ((var_1_12 - var_1_36) , var_1_9))))) : (var_1_58 == ((unsigned long int) (var_1_21 - last_1_var_1_16)))) : ((((last_1_var_1_48 % var_1_3) & var_1_8) == var_1_12) ? (var_1_58 == ((unsigned long int) (var_1_31 + var_1_36))) : (var_1_58 == ((unsigned long int) (last_1_var_1_48 + var_1_59)))))) && ((var_1_10 < var_1_16) ? ((var_1_9 >= var_1_12) ? (var_1_60 == ((double) (abs (var_1_39)))) : ((var_1_34 > var_1_54) ? (var_1_60 == ((double) ((var_1_45 - var_1_38) - (max ((4.900890029043464E18 - var_1_39) , var_1_27))))) : (var_1_60 == ((double) (var_1_41 + var_1_38))))) : ((((var_1_36 + var_1_42) - var_1_58) < ((var_1_31 + var_1_58) - (min (var_1_6 , var_1_10)))) ? (var_1_60 == ((double) (min (var_1_40 , var_1_38)))) : 1))) && ((var_1_28 > (var_1_39 - (max (var_1_38 , var_1_17)))) ? (var_1_61 == ((signed char) (var_1_54 - var_1_36))) : 1)) && ((var_1_36 < var_1_58) ? ((var_1_64 && (var_1_37 != var_1_23)) ? (var_1_63 == ((signed short int) (var_1_7 - (min (var_1_36 , var_1_9))))) : (var_1_63 == ((signed short int) ((var_1_16 + var_1_29) + var_1_7)))) : 1)) && (var_1_64 == ((unsigned char) var_1_51))) && (var_1_64 ? ((var_1_37 > (- (var_1_25 * var_1_40))) ? (((var_1_8 - var_1_9) > var_1_34) ? (var_1_65 == ((double) var_1_27)) : 1) : (var_1_65 == ((double) var_1_41))) : 1)
;
}
int main(void) {
	isInitial = 1;
