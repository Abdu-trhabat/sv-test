...
int property(void) {
	return (((((! var_1_2) && ((var_1_3 | var_1_4) <= var_1_5)) ? (var_1_2 ? (var_1_1 == ((double) var_1_6)) : (var_1_1 == ((double) 128.0))) : (var_1_1 == ((double) var_1_6))) && ((var_1_5 < var_1_3) ? (var_1_7 == ((signed long int) (abs (min (var_1_3 , (min (var_1_4 , var_1_8))))))) : 1)) && (((var_1_1 + var_1_6) <= var_1_1) ? (var_1_9 == ((unsigned char) (var_1_11 - ((max (var_1_12 , var_1_13)) + (5 + 8))))) : 1)) && (((var_1_12 < var_1_7) || var_1_2) ? (var_1_14 == ((unsigned char) (abs (var_1_11 - var_1_12)))) : (var_1_2 ? (var_1_14 == ((unsigned char) var_1_13)) : 1))
;
}
int main(void) {
	isInitial = 1;
