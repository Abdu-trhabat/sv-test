...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4functionizing.c", 13, "reach_error"); }
...
void functionized2(unsigned long int, unsigned short int);
void functionized3(unsigned short int, signed long int, unsigned short int);
...
signed long int functionized0(unsigned short int functionized0_localFunctionVar0) {
	return (- functionized0_localFunctionVar0);
}
unsigned char functionized1(unsigned char functionized1_localFunctionVar0) {
	return (var_1_4 || functionized1_localFunctionVar0);
}
void functionized2(unsigned long int functionized2_localFunctionVar0, unsigned short int functionized2_localFunctionVar1) {
	if ((functionized2_localFunctionVar0 - var_1_2) < functionized2_localFunctionVar1) {
		var_1_11 = (abs (var_1_10));
	}
}
void functionized3(unsigned short int functionized3_localFunctionVar0, signed long int functionized3_localFunctionVar1, unsigned short int functionized3_localFunctionVar2) {
	if (var_1_4 && (functionized3_localFunctionVar1 >= functionized3_localFunctionVar2)) {
		if (functionized3_localFunctionVar0 <= functionized3_localFunctionVar2) {
			if (var_1_1) {
				var_1_13 = var_1_2;
			} else {
				var_1_13 = functionized3_localFunctionVar0;
			}
		} else {
			var_1_13 = functionized3_localFunctionVar2;
		}
	}
}
float functionized4(float functionized4_localFunctionVar0) {
	return (max ((var_1_18 + functionized4_localFunctionVar0) , 128.25f));
}
signed long int functionized5(void) {
	return (var_1_21 - var_1_22);
}
...
void step(void) {
	...
	if (var_1_2 <= var_1_3) {
		if (functionized0(var_1_3) > var_1_2) {
			var_1_1 = 0;
		}
	} else {
		var_1_1 = functionized1(var_1_5);
	}
	...
	functionized2(var_1_12, var_1_9);


	// From: Req5Batch4functionizing
	if (var_1_8 < var_1_6) {
		functionized3(var_1_6, var_1_8, var_1_11);
	} else {
		var_1_13 = var_1_14;
	}
	...
	if (var_1_4) {
		var_1_15 = (max ((max (var_1_16 , var_1_17)) , functionized4(var_1_19)));
	}


	// From: Req7Batch4functionizing
	if (var_1_14 != 16) {
		var_1_20 = (min (functionized5() , var_1_23));
	}
}
