...
void step(void) {
	...
	if (stepLocal_3 == var_1_22) {
		if (var_1_27 && stepLocal_2) {
			...
			if (var_1_19) {
				var_1_28 = (min (var_1_21 , var_1_23));
			} else {
				if (! (var_1_8 == (3.6f + var_1_4))) {
					var_1_28 = ((var_1_29 + var_1_30) - ((max (var_1_31 , var_1_32)) - var_1_26));
				}
			}
		}
	} else {
		var_1_28 = (max (var_1_32 , var_1_26));
	}


	// From: Req8Batch177Amount250
	var_1_35 = 256;


	// From: Req9Batch177Amount250
	var_1_36 = (max ((min (var_1_21 , var_1_20)) , ((var_1_31 - var_1_32) + var_1_14)));


	// From: Req12Batch177Amount250
	var_1_49 = var_1_42;


	// From: Req13Batch177Amount250
	signed short int stepLocal_8 = var_1_14;
	signed short int stepLocal_7 = var_1_41;
	if (var_1_23 < stepLocal_7) {
		if (var_1_5 < 31.75f) {
			if (stepLocal_8 > ((min (var_1_32 , var_1_30)) - (var_1_31 - var_1_45))) {
				if (var_1_27) {
					if (var_1_6 != var_1_9) {
	...
	// From: Req14Batch177Amount250
	unsigned short int stepLocal_9 = var_1_46;
	if (var_1_50) {
		if (var_1_51) {
			var_1_54 = (var_1_48 - (min (var_1_32 , (var_1_55 - var_1_42))));
		}
	} else {
		if (stepLocal_9 == var_1_24) {
			var_1_54 = ((var_1_30 - var_1_47) + ((var_1_45 + var_1_56) + var_1_40));
		} else {
			var_1_54 = ((abs (var_1_46)) - (max (var_1_47 , (64 + var_1_45))));
		}
	}


	// From: Req16Batch177Amount250
	if (var_1_58 > ((min (var_1_60 , var_1_61)) - (var_1_62 - var_1_63))) {
		var_1_59 = (abs (var_1_56));
	} else {
		var_1_59 = ((25178 + var_1_30) - var_1_56);
	}


	// From: Req17Batch177Amount250
	signed long int stepLocal_13 = var_1_30 / var_1_41;
	signed long int stepLocal_12 = min (var_1_42 , var_1_62);
	if ((~ var_1_59) < stepLocal_13) {
		if (stepLocal_12 < -50) {
			var_1_64 = (var_1_5 + (var_1_7 - (var_1_16 + var_1_17)));
		} else {
			var_1_64 = (max (var_1_16 , var_1_6));
		}
	} else {
		var_1_64 = (max (var_1_7 , var_1_8));
	}


	// From: Req18Batch177Amount250
	var_1_65 = ((max (var_1_39 , var_1_44)) - (abs (var_1_41)));


	// From: Req19Batch177Amount250
	signed long int stepLocal_14 = - (var_1_60 - 64);
	if (var_1_50) {
		if (stepLocal_14 <= var_1_45) {
			var_1_66 = (max ((var_1_9 + (max (var_1_8 , var_1_16))) , var_1_7));
		} else {
			var_1_66 = var_1_8;
		}
	} else {
	...
	// From: Req4Batch177Amount250
	if (var_1_50 && (last_1_var_1_18 > var_1_11)) {
		var_1_18 = (var_1_20 - (abs (var_1_21)));
	} else {
		if ((min (var_1_12 , var_1_35)) > ((abs (last_1_var_1_18)) - var_1_20)) {
			if (var_1_7 > (8.625f - var_1_15)) {
				var_1_18 = (var_1_20 - var_1_21);
			} else {
				var_1_18 = (min ((min (var_1_20 , var_1_21)) , (max ((max (var_1_22 , var_1_23)) , var_1_24))));
			}
		}
	}


	// From: Req5Batch177Amount250
	...
	// From: Req7Batch177Amount250
	unsigned short int stepLocal_4 = var_1_25;
	if (stepLocal_4 < var_1_36) {
		if (var_1_64 == var_1_9) {
			var_1_33 = (max ((max ((max (var_1_8 , var_1_4)) , var_1_16)) , (abs (max (0.75f , var_1_5)))));
		} else {
			if (var_1_50) {
				var_1_33 = var_1_9;
			} else {
	...
	// From: Req11Batch177Amount250
	if (var_1_28 <= (var_1_44 - var_1_45)) {
		if (var_1_25 <= var_1_12) {
			if ((abs (abs (var_1_32))) <= last_1_var_1_43) {
				var_1_43 = ((max (var_1_20 , var_1_46)) - (var_1_41 - (var_1_45 + var_1_47)));
			} else {
	...
	if (-2 < stepLocal_6) {
		...
		if ((256 / 200) <= stepLocal_5) {
			var_1_37 = ((max ((abs (var_1_26)) , (var_1_39 - var_1_40))) - (var_1_41 - var_1_42));
		}
	}


	// From: Req21Batch177Amount250
	signed long int stepLocal_15 = min ((var_1_63 + var_1_43) , (var_1_39 % var_1_46));
...
int property(void) {
	return (((((((((((((((((((((var_1_18 >= var_1_43) ? (var_1_1 == ((float) (abs (var_1_4)))) : (var_1_1 == ((float) (((min (var_1_5 , var_1_6)) - var_1_7) + (max ((7.25f - var_1_8) , var_1_9)))))) && ((var_1_6 >= var_1_4) ? ((var_1_25 < var_1_54) ? (var_1_10 == ((signed char) (var_1_11 + (abs (var_1_12))))) : (var_1_10 == ((signed char) var_1_12))) : (var_1_10 == ((signed char) (abs (var_1_11)))))) && ((var_1_36 >= (var_1_14 - 4)) ? (var_1_13 == ((float) ((max (var_1_8 , var_1_7)) - (max (var_1_6 , (var_1_5 + var_1_15)))))) : (var_1_13 == ((float) ((var_1_5 - (var_1_16 + var_1_17)) + var_1_6))))) && ((var_1_50 && (last_1_var_1_18 > var_1_11)) ? (var_1_18 == ((unsigned short int) (var_1_20 - (abs (var_1_21))))) : (((min (var_1_12 , var_1_35)) > ((abs (last_1_var_1_18)) - var_1_20)) ? ((var_1_7 > (8.625f - var_1_15)) ? (var_1_18 == ((unsigned short int) (var_1_20 - var_1_21))) : (var_1_18 == ((unsigned short int) (min ((min (var_1_20 , var_1_21)) , (max ((max (var_1_22 , var_1_23)) , var_1_24))))))) : 1))) && (var_1_50 ? (var_1_25 == ((unsigned short int) (var_1_20 - var_1_21))) : ((var_1_67 > var_1_7) ? (((var_1_21 << var_1_24) < var_1_12) ? (var_1_25 == ((unsigned short int) (var_1_20 - (26980 - var_1_26)))) : (var_1_50 ? (var_1_25 == ((unsigned short int) var_1_26)) : (var_1_25 == ((unsigned short int) var_1_20)))) : (var_1_25 == ((unsigned short int) var_1_22))))) && (((var_1_21 - (var_1_26 + var_1_20)) == var_1_22) ? ((var_1_27 && var_1_19) ? (var_1_28 == ((unsigned short int) ((var_1_29 - var_1_26) + var_1_21))) : (var_1_19 ? (var_1_28 == ((unsigned short int) (min (var_1_21 , var_1_23)))) : ((! (var_1_8 == (3.6f + var_1_4))) ? (var_1_28 == ((unsigned short int) ((var_1_29 + var_1_30) - ((max (var_1_31 , var_1_32)) - var_1_26)))) : 1))) : (var_1_28 == ((unsigned short int) (max (var_1_32 , var_1_26)))))) && ((var_1_25 < var_1_36) ? ((var_1_64 == var_1_9) ? (var_1_33 == ((float) (max ((max ((max (var_1_8 , var_1_4)) , var_1_16)) , (abs (max (0.75f , var_1_5))))))) : (var_1_50 ? (var_1_33 == ((float) var_1_9)) : (var_1_33 == ((float) var_1_4)))) : (var_1_33 == ((float) var_1_15)))) && (var_1_35 == ((unsigned short int) 256))) && (var_1_36 == ((signed long int) (max ((min (var_1_21 , var_1_20)) , ((var_1_31 - var_1_32) + var_1_14)))))) && ((-2 < var_1_23) ? (var_1_37 == ((signed short int) 256)) : (((256 / 200) <= (var_1_22 - (var_1_38 - var_1_43))) ? (var_1_37 == ((signed short int) ((max ((abs (var_1_26)) , (var_1_39 - var_1_40))) - (var_1_41 - var_1_42)))) : 1))) && ((var_1_28 <= (var_1_44 - var_1_45)) ? ((var_1_25 <= var_1_12) ? (((abs (abs (var_1_32))) <= last_1_var_1_43) ? (var_1_43 == ((unsigned short int) ((max (var_1_20 , var_1_46)) - (var_1_41 - (var_1_45 + var_1_47))))) : (var_1_43 == ((unsigned short int) (((var_1_48 - var_1_47) - 10) - var_1_21)))) : 1) : 1)) && (var_1_49 == ((signed short int) var_1_42))) && ((var_1_23 < var_1_41) ? ((var_1_5 < 31.75f) ? ((var_1_14 > ((min (var_1_32 , var_1_30)) - (var_1_31 - var_1_45))) ? (var_1_27 ? ((var_1_6 != var_1_9) ? (var_1_50 == ((unsigned char) (var_1_51 || (! var_1_52)))) : 1) : 1) : (((min (var_1_8 , var_1_5)) <= 0.25f) ? (var_1_50 == ((unsigned char) (var_1_52 && var_1_51))) : (var_1_50 == ((unsigned char) ((! var_1_52) || var_1_53))))) : (var_1_50 == ((unsigned char) var_1_51))) : 1)) && (var_1_50 ? (var_1_51 ? (var_1_54 == ((unsigned short int) (var_1_48 - (min (var_1_32 , (var_1_55 - var_1_42)))))) : 1) : ((var_1_46 == var_1_24) ? (var_1_54 == ((unsigned short int) ((var_1_30 - var_1_47) + ((var_1_45 + var_1_56) + var_1_40)))) : (var_1_54 == ((unsigned short int) ((abs (var_1_46)) - (max (var_1_47 , (64 + var_1_45))))))))) && ((var_1_50 || ((var_1_14 / var_1_58) < (var_1_68 / var_1_31))) ? (var_1_57 == ((signed short int) (abs (var_1_11)))) : (((var_1_21 / var_1_32) < var_1_46) ? (var_1_57 == ((signed short int) (1 + (var_1_47 - var_1_58)))) : 1))) && ((var_1_58 > ((min (var_1_60 , var_1_61)) - (var_1_62 - var_1_63))) ? (var_1_59 == ((unsigned short int) (abs (var_1_56)))) : (var_1_59 == ((unsigned short int) ((25178 + var_1_30) - var_1_56))))) && (((~ var_1_59) < (var_1_30 / var_1_41)) ? (((min (var_1_42 , var_1_62)) < -50) ? (var_1_64 == ((double) (var_1_5 + (var_1_7 - (var_1_16 + var_1_17))))) : (var_1_64 == ((double) (max (var_1_16 , var_1_6))))) : (var_1_64 == ((double) (max (var_1_7 , var_1_8)))))) && (var_1_65 == ((signed short int) ((max (var_1_39 , var_1_44)) - (abs (var_1_41)))))) && (var_1_50 ? (((- (var_1_60 - 64)) <= var_1_45) ? (var_1_66 == ((double) (max ((var_1_9 + (max (var_1_8 , var_1_16))) , var_1_7)))) : (var_1_66 == ((double) var_1_8))) : (var_1_66 == ((double) var_1_15)))) && (var_1_52 ? (var_1_67 == ((double) var_1_9)) : (var_1_67 == ((double) 10.6)))) && ((((var_1_48 - var_1_40) - var_1_32) > (min ((var_1_63 + var_1_43) , (var_1_39 % var_1_46)))) ? (var_1_51 ? (var_1_68 == ((signed long int) var_1_14)) : 1) : (var_1_68 == ((signed long int) var_1_37)))
;
}
int main(void) {
	isInitial = 1;
