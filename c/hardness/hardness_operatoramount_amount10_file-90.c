...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch90Amount10.c", 13, "reach_error"); }
...
int property(void) {
	return (16u < var_1_2) ? (var_1_1 == ((signed long int) ((var_1_3 + var_1_4) - (var_1_5 - var_1_6)))) : ((var_1_3 <= (var_1_4 * var_1_6)) ? (var_1_1 == ((signed long int) var_1_6)) : (var_1_1 == ((signed long int) -4)))
;
}
int main(void) {
	isInitial = 1;
