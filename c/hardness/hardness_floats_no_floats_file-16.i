...
void step(void) {
 ...
 if (var_1_4 <= stepLocal_0) {
  var_1_7 = (((((var_1_8) > (var_1_9)) ? (var_1_8) : (var_1_9))) - (var_1_10 + 64));
 } else {
  var_1_7 = (((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11))) + var_1_12);
 }
 var_1_18 = var_1_19;
 if ((var_1_18 % ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4)))) <= -1000000) {
