...
void step(void) {
	...
	if (stepLocal_0 || WrapperStruct00.var_1_14) {
		if (! WrapperStruct00.var_1_14) {
			WrapperStruct00.var_1_12 = (abs (min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5)));
		} else {
	...
	if (-4 > WrapperStruct00.var_1_12) {
		if ((~ WrapperStruct00.var_1_12) <= WrapperStruct00.var_1_12) {
			WrapperStruct00.var_1_9 = (abs (WrapperStruct00.var_1_10 + WrapperStruct00.var_1_11));
		}
	} else {
...
int property(void) {
	return ((((WrapperStruct00.var_1_2 <= WrapperStruct00.var_1_3) ? (((WrapperStruct00.var_1_4 + WrapperStruct00.var_1_5) >= (WrapperStruct00.var_1_6 + WrapperStruct00.var_1_7)) ? (WrapperStruct00.var_1_1 == ((double) (abs (WrapperStruct00.var_1_8)))) : 1) : ((WrapperStruct00.var_1_6 > WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_1 == ((double) WrapperStruct00.var_1_8)) : 1)) && ((-4 > WrapperStruct00.var_1_12) ? (((~ WrapperStruct00.var_1_12) <= WrapperStruct00.var_1_12) ? (WrapperStruct00.var_1_9 == ((signed char) (abs (WrapperStruct00.var_1_10 + WrapperStruct00.var_1_11)))) : 1) : (WrapperStruct00.var_1_9 == ((signed char) WrapperStruct00.var_1_10)))) && (((! WrapperStruct00.var_1_13) || WrapperStruct00.var_1_14) ? ((! WrapperStruct00.var_1_14) ? (WrapperStruct00.var_1_12 == ((signed long int) (abs (min (WrapperStruct00.var_1_4 , WrapperStruct00.var_1_5))))) : (WrapperStruct00.var_1_12 == ((signed long int) WrapperStruct00.var_1_5))) : 1)) && (WrapperStruct00.var_1_15 == ((double) WrapperStruct00.var_1_8))
;
}
int main(void) {
	isInitial = 1;
