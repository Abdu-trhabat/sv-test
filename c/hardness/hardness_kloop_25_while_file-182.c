...
void step(void) {
	// From: Req1Batch18225_while
	if (! var_1_3) {
		var_1_1 = ((min (var_1_4 , var_1_5)) - var_1_6);
	}


	// From: Req2Batch18225_while
	...
	// From: Req4Batch18225_while
	var_1_12 = (min ((max (var_1_4 , var_1_11)) , var_1_6));


	// From: Req5Batch18225_while
	if (var_1_3) {
		var_1_13 = (max (16.5 , (var_1_4 - 9.99999999975E9)));
	}


	// From: Req6Batch18225_while
	var_1_14 = var_1_11;


	// From: Req7Batch18225_while
	var_1_15 = var_1_11;


	// From: Req8Batch18225_while
	var_1_16 = var_1_17;
}
