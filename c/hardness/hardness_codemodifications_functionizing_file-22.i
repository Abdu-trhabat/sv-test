...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch22functionizing.c", 13, "reach_error"); }
...
double functionized2(double, double);
void functionized3(unsigned short int, unsigned long int, unsigned long int);
...
signed long int functionized0(unsigned short int functionized0_localFunctionVar0) {
 return ((((functionized0_localFunctionVar0) < (var_1_5)) ? (functionized0_localFunctionVar0) : (var_1_5)));
}
unsigned char functionized1(void) {
 return ((var_1_3 / var_1_18) > var_1_2);
}
double functionized2(double functionized2_localFunctionVar0, double functionized2_localFunctionVar1) {
 return (((((((((functionized2_localFunctionVar1) > (functionized2_localFunctionVar0)) ? (functionized2_localFunctionVar1) : (functionized2_localFunctionVar0)))) > (16.6)) ? (((((functionized2_localFunctionVar1) > (functionized2_localFunctionVar0)) ? (functionized2_localFunctionVar1) : (functionized2_localFunctionVar0)))) : (16.6))) - var_1_23);
}
void functionized3(unsigned short int functionized3_localFunctionVar0, unsigned long int functionized3_localFunctionVar1, unsigned long int localFunctionVar2) {
 if (var_1_11 == var_1_8) {
  var_1_24 = (2332545940u - (localFunctionVar2 - var_1_7));
 } else {
  var_1_24 = (functionized3_localFunctionVar0 + (functionized3_localFunctionVar1 - var_1_11));
 }
}
void initially(void) {
}
void step(void) {
 ...
 if (var_1_14) {
  var_1_20 = (functionized2(var_1_22, var_1_21));
 } else {
  var_1_20 = var_1_22;
 }
 functionized3(var_1_5, var_1_25, 1490203111u);
 if (var_1_4 > (var_1_19 - var_1_7)) {
  var_1_26 = var_1_8;
 }
...
int property(void) {
 return ((((((((var_1_2 < var_1_3) ? (var_1_1 == ((unsigned short int) ((((var_1_4) < (var_1_5)) ? (var_1_4) : (var_1_5))))) : (var_1_1 == ((unsigned short int) (((var_1_6 + var_1_7) - var_1_8) + var_1_9)))) && ((var_1_9 < (var_1_8 << var_1_4)) ? (var_1_10 == ((unsigned char) (var_1_11 + var_1_12))) : (var_1_10 == ((unsigned char) var_1_11)))) && (((var_1_4 <= var_1_9) || var_1_14) ? (var_1_13 == ((unsigned short int) ((((((((var_1_5) > (var_1_8)) ? (var_1_5) : (var_1_8)))) > (var_1_15)) ? (((((var_1_5) > (var_1_8)) ? (var_1_5) : (var_1_8)))) : (var_1_15))))) : (var_1_13 == ((unsigned short int) var_1_16)))) && (((var_1_3 / var_1_18) > var_1_2) ? (var_1_17 == ((unsigned short int) ((var_1_19 - ((((var_1_10) > (var_1_12)) ? (var_1_10) : (var_1_12)))) - var_1_7))) : 1)) && (var_1_14 ? (var_1_20 == ((double) (((((((((var_1_21) > (var_1_22)) ? (var_1_21) : (var_1_22)))) > (16.6)) ? (((((var_1_21) > (var_1_22)) ? (var_1_21) : (var_1_22)))) : (16.6))) - var_1_23))) : (var_1_20 == ((double) var_1_22)))) && ((var_1_11 == var_1_8) ? (var_1_24 == ((unsigned long int) (2332545940u - (1490203111u - var_1_7)))) : (var_1_24 == ((unsigned long int) (var_1_5 + (var_1_25 - var_1_11)))))) && ((var_1_4 > (var_1_19 - var_1_7)) ? (var_1_26 == ((unsigned long int) var_1_8)) : 1)) && (((- 3.75) < ((((var_1_3) < (var_1_22)) ? (var_1_3) : (var_1_22)))) ? (var_1_27 == ((unsigned char) 0)) : 1)
;
}
int main(void) {
 isInitial = 1;
