...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch118Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch118Amount25
	if ((var_1_7 - var_1_8) < ((var_1_5 - var_1_9) + var_1_1)) {
		var_1_6 = var_1_10;
	}


	// From: Req3Batch118Amount25
