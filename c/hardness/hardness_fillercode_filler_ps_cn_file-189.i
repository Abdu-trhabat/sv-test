...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch189Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
  ...
  4.75f
             ...
             if ( ((var_1_36) >= (var_1_31))) {
              var_1_39 = (
               ((((( ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) )) > (( (( var_1_40 ) - ( var_1_41 )) ))) ? (( ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) )) : (( (( var_1_40 ) - ( var_1_41 )) ))))
  );
 } else {
              var_1_39 = (
   ...
   var_1_44
             ...
             if (var_1_46) {
              if ( (( (( ((var_1_44) - (var_1_41))) < (var_1_27))) || (var_1_47))) {
               if ( (( ((var_1_29) + (var_1_40))) < ( ((var_1_36) ^ (var_1_33))))) {
                var_1_45 = (
                 (((((( ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) ) + ( var_1_42 ))) < 0 ) ? -((( ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) ) + ( var_1_42 ))) : ((( ((((var_1_43) < 0 ) ? -(var_1_43) : (var_1_43))) ) + ( var_1_42 )))))
    );
   }
  } else {
               var_1_45 = (
