...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch177Filler_PE_CI.c", 13, "reach_error"); }
    ...
    var_1_46
                   ...
                   if ( ((var_1_9) < ( ((var_1_46) | (var_1_5))))) {
                    ...
                    if (var_1_15) {
                     if (var_1_42) {
                      var_1_48 = (
                       ((((( ((((( var_1_44 )) < (( var_1_46 ))) ? (( var_1_44 )) : (( var_1_46 )))) )) < (( var_1_11 ))) ? (( ((((( var_1_44 )) < (( var_1_46 ))) ? (( var_1_44 )) : (( var_1_46 )))) )) : (( var_1_11 ))))
    );
   } else {
                      var_1_48 = (
                       (((((( var_1_49 ) - ( var_1_11 ))) < 0 ) ? -((( var_1_49 ) - ( var_1_11 ))) : ((( var_1_49 ) - ( var_1_11 )))))
    );
   }
  } else {
                     if (var_1_36) {
