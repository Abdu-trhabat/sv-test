...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch124Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 351L, 229L) */ if (var_1_19) {
		/* 353L, 227L) */ if (var_1_18) {
			...
			/* 361L, 225L) */ if (/* 362L, 200L, 201L) */ ((/* 363L, 196L, 202L) */ ((/* 364L, 192L, 203L) */ (abs (var_1_26))) - (/* 366L, 195L, 205L) */ (max (/* 366L, 195L, 205L) */ (var_1_27) , (var_1_4)))))) > (/* 369L, 199L, 208L) */ ((5u) % (var_1_37))))) {
				/* 372L, 224L) */ var_1_34 = (
					var_1_36
				);
			}
	...
	// From: CodeObject3
	/* 311L, 127L) */ if (var_1_20) {
		/* 313L, 125L) */ if (/* 314L, 95L, 96L) */ ((var_1_26) <= (/* 316L, 94L, 98L) */ (max (/* 316L, 94L, 98L) */ (var_1_25) , (var_1_2)))))) {
