...
void step(void) {
	...
	/* 276L, 111L) */ if (/* 277L, 55L, 56L) */ ((var_1_36) > (/* 279L, 54L, 58L) */ ((var_1_35) + (7.5))))) {
		/* 282L, 109L) */ if (/* 283L, 72L, 73L) */ ((/* 284L, 68L, 74L) */ (~ (var_1_8))) <= (/* 286L, 71L, 76L) */ ((var_1_27) % (var_1_17))))) {
			/* 289L, 93L) */ var_1_37 = (
				/* 292L, 92L) */ (min (
					/* 292L, 92L) */ (
						/* 293L, 90L) */ (min (
			...
			/* 298L, 107L) */ if (/* 299L, 96L, 97L) */ ((var_1_11) <= (var_1_8))) {
				/* 302L, 106L) */ var_1_37 = (
					64
				);
			}
	...
	// From: CodeObject5
	/* 308L, 156L) */ if (/* 309L, 127L, 128L) */ ((/* 310L, 121L, 129L) */ ((var_1_15) / (var_1_17))) > (/* 313L, 126L, 132L) */ ((/* 314L, 124L, 133L) */ ((var_1_17) - (var_1_15))) - (2))))) {
		/* 318L, 155L) */ var_1_41 = (
			/* 321L, 154L) */ (min (
				/* 321L, 154L) */ (
					var_1_27
	...
	// From: CodeObject3
	/* 254L, 47L) */ if (/* 255L, 22L, 23L) */ ((var_1_12) < (/* 257L, 21L, 25L) */ (max (/* 257L, 21L, 25L) */ (var_1_10) , (var_1_27)))))) {
		/* 260L, 42L) */ var_1_33 = (
			/* 263L, 41L) */ (min (
				/* 263L, 41L) */ (
					/* 264L, 36L) */ (abs (
	...
	// From: CodeObject6
	/* 329L, 224L) */ if (/* 330L, 169L, 170L) */ ((-128) != (/* 332L, 168L, 172L) */ (~ (/* 333L, 167L, 173L) */ ((var_1_44) | (var_1_27))))))) {
		/* 336L, 187L) */ var_1_47 = (
			/* 339L, 186L) */ (min (
				/* 339L, 186L) */ (
					var_1_34
		...
		/* 342L, 222L) */ if (/* 343L, 192L, 193L) */ ((/* 344L, 190L, 194L) */ ((var_1_20) % (var_1_44))) == (var_1_1))) {
			/* 348L, 220L) */ if (/* 349L, 206L, 207L) */ ((var_1_15) > (/* 351L, 205L, 209L) */ (~ (var_1_15))))) {
				/* 353L, 219L) */ var_1_47 = (
					/* 356L, 218L) */ (abs (
						var_1_35
					))
