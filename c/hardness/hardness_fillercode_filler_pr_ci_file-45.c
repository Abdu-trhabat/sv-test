...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch45Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	/* 297L, 190L) */ if (/* 298L, 142L, 143L) */ ((var_1_16) && (/* 300L, 141L, 145L) */ ((var_1_11) > (/* 302L, 140L, 147L) */ ((var_1_7) + (var_1_18))))))) {
		/* 305L, 188L) */ if (/* 306L, 163L, 164L) */ (! (/* 307L, 162L, 165L) */ ((/* 308L, 159L, 166L) */ ((var_1_11) % (var_1_13))) > (/* 311L, 161L, 169L) */ (abs (var_1_26))))))) {
			/* 313L, 183L) */ var_1_36 = (
				/* 316L, 182L) */ ((
					var_1_7
				) - (
	...
	// From: CodeObject4
	/* 275L, 106L) */ if (/* 276L, 92L, 93L) */ (! (/* 277L, 91L, 94L) */ ((var_1_31) > (var_1_18))))) {
		/* 280L, 105L) */ var_1_33 = (
			/* 283L, 104L) */ (abs (
				var_1_11
			))
	...
	// From: CodeObject7
	/* 323L, 213L) */ if (/* 324L, 197L, 198L) */ ((var_1_18) <= (/* 326L, 196L, 200L) */ (abs (var_1_26))))) {
		/* 328L, 212L) */ var_1_38 = (
			/* 331L, 211L) */ ((
				/* 332L, 209L) */ (abs (
					var_1_39
