...
void step(void) {
 ...
 if (last_1_var_1_1 != stepLocal_0) {
  ...
  var_1_1 = ((((var_1_4 - (var_1_5 - var_1_3)) < 0 ) ? -(var_1_4 - (var_1_5 - var_1_3)) : (var_1_4 - (var_1_5 - var_1_3))));
 }
 var_1_6 = var_1_7;
 var_1_8 = var_1_9;
}
...
int property(void) {
 return (((last_1_var_1_1 != (var_1_3 / var_1_4)) ? (var_1_1 == ((signed long int) last_1_var_1_1)) : (var_1_1 == ((signed long int) ((((var_1_4 - (var_1_5 - var_1_3)) < 0 ) ? -(var_1_4 - (var_1_5 - var_1_3)) : (var_1_4 - (var_1_5 - var_1_3))))))) && (var_1_6 == ((float) var_1_7))) && (var_1_8 == ((float) var_1_9))
;
}
int main(void) {
 isInitial = 1;
