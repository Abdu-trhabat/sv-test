...
void step(void) {
	...
	// From: Req2Batch114dependencies
	if (var_1_1 || var_1_6) {
		var_1_7 = (min (var_1_5 , var_1_8));
	}


	// From: Req7Batch114dependencies
	var_1_20 = var_1_21;


	// From: Req8Batch114dependencies
	var_1_22 = 16u;


	// From: Req9Batch114dependencies
	var_1_23 = var_1_18;


	// From: Req4Batch114dependencies
	...
	// From: Req5Batch114dependencies
	if ((max ((~ 0u) , var_1_23)) > var_1_5) {
		var_1_14 = var_1_5;
	}


	// From: Req6Batch114dependencies
	if (var_1_5 < var_1_23) {
		if (var_1_6 && var_1_1) {
