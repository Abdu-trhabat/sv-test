...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch5stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch5stepLocals
	signed long int stepLocal_0 = abs (var_1_3);
	if (stepLocal_0 <= (max (var_1_13 , var_1_4))) {
