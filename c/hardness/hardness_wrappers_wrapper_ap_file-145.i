...
void step(void) {
 ...
 if ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) <= (((((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) < ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)))) ? ((*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)))))) {
  if ((((((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) < (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) & (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer))))) ? ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) : (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) & (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var3_Pointer)))))) < stepLocal_3) {
