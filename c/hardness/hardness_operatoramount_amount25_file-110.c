...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch110Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch110Amount25
	signed long int stepLocal_1 = max (var_1_6 , var_1_5);
	if (var_1_4 < stepLocal_1) {
		var_1_12 = var_1_11;
	} else {
		var_1_12 = ((max (var_1_13 , (max (var_1_14 , var_1_15)))) - var_1_16);
	}


	// From: Req4Batch110Amount25
	var_1_17 = var_1_14;
}
...
int property(void) {
	return ((((var_1_3 != ((min (var_1_4 , var_1_5)) / var_1_6)) ? (var_1_1 == ((unsigned char) (! var_1_7))) : (var_1_1 == ((unsigned char) ((var_1_7 && var_1_8) && var_1_9)))) && ((var_1_3 <= (var_1_6 * (max (var_1_4 , var_1_5)))) ? ((var_1_3 > var_1_4) ? (var_1_10 == ((double) var_1_11)) : 1) : 1)) && ((var_1_4 < (max (var_1_6 , var_1_5))) ? (var_1_12 == ((double) var_1_11)) : (var_1_12 == ((double) ((max (var_1_13 , (max (var_1_14 , var_1_15)))) - var_1_16))))) && (var_1_17 == ((float) var_1_14))
;
}
int main(void) {
	isInitial = 1;
