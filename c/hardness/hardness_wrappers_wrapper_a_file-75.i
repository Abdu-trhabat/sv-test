...
void step(void) {
 signed long int stepLocal_0 = (((signed_long_int_Array_0[1]) > (signed_long_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (signed_long_int_Array_0[0]));
 ...
 if ((- double_Array_0[0]) >= double_Array_0[1]) {
  if (BOOL_unsigned_char_Array_0[0]) {
   signed_short_int_Array_0[0] = ((((((((unsigned_char_Array_0[0][1]) < (last_1_signed_short_int_Array_0_0_)) ? (unsigned_char_Array_0[0][1]) : (last_1_signed_short_int_Array_0_0_))) + ((((unsigned_char_Array_0[1][1]) > (unsigned_char_Array_0[1][0])) ? (unsigned_char_Array_0[1][1]) : (unsigned_char_Array_0[1][0])))) < 0 ) ? -(((((unsigned_char_Array_0[0][1]) < (last_1_signed_short_int_Array_0_0_)) ? (unsigned_char_Array_0[0][1]) : (last_1_signed_short_int_Array_0_0_))) + ((((unsigned_char_Array_0[1][1]) > (unsigned_char_Array_0[1][0])) ? (unsigned_char_Array_0[1][1]) : (unsigned_char_Array_0[1][0])))) : (((((unsigned_char_Array_0[0][1]) < (last_1_signed_short_int_Array_0_0_)) ? (unsigned_char_Array_0[0][1]) : (last_1_signed_short_int_Array_0_0_))) + ((((unsigned_char_Array_0[1][1]) > (unsigned_char_Array_0[1][0])) ? (unsigned_char_Array_0[1][1]) : (unsigned_char_Array_0[1][0]))))));
  } else {
   signed_short_int_Array_0[0] = (unsigned_char_Array_0[1][0] + unsigned_char_Array_0[1][1]);
  }
 }
 if (2.8f == double_Array_0[1]) {
  signed_char_Array_0[0] = (((((((((signed_char_Array_0[1]) > (16)) ? (signed_char_Array_0[1]) : (16)))) > (signed_char_Array_0[3])) ? (((((signed_char_Array_0[1]) > (16)) ? (signed_char_Array_0[1]) : (16)))) : (signed_char_Array_0[3]))) + signed_char_Array_0[4]);
 }
 signed_char_Array_0[2] = ((((-4) < (signed_char_Array_0[3])) ? (-4) : (signed_char_Array_0[3])));
...
int property(void) {
 return (((((((last_1_unsigned_char_Array_0_1__1_ * last_1_signed_short_int_Array_0_0_) * last_1_signed_short_int_Array_0_0_) < ((((signed_long_int_Array_0[1]) > (signed_long_int_Array_0[0])) ? (signed_long_int_Array_0[1]) : (signed_long_int_Array_0[0])))) ? (unsigned_char_Array_0[1][1] == ((unsigned char) unsigned_char_Array_0[0][0])) : (unsigned_char_Array_0[1][1] == ((unsigned char) 10))) && (((- double_Array_0[0]) >= double_Array_0[1]) ? (BOOL_unsigned_char_Array_0[0] ? (signed_short_int_Array_0[0] == ((signed short int) ((((((((unsigned_char_Array_0[0][1]) < (last_1_signed_short_int_Array_0_0_)) ? (unsigned_char_Array_0[0][1]) : (last_1_signed_short_int_Array_0_0_))) + ((((unsigned_char_Array_0[1][1]) > (unsigned_char_Array_0[1][0])) ? (unsigned_char_Array_0[1][1]) : (unsigned_char_Array_0[1][0])))) < 0 ) ? -(((((unsigned_char_Array_0[0][1]) < (last_1_signed_short_int_Array_0_0_)) ? (unsigned_char_Array_0[0][1]) : (last_1_signed_short_int_Array_0_0_))) + ((((unsigned_char_Array_0[1][1]) > (unsigned_char_Array_0[1][0])) ? (unsigned_char_Array_0[1][1]) : (unsigned_char_Array_0[1][0])))) : (((((unsigned_char_Array_0[0][1]) < (last_1_signed_short_int_Array_0_0_)) ? (unsigned_char_Array_0[0][1]) : (last_1_signed_short_int_Array_0_0_))) + ((((unsigned_char_Array_0[1][1]) > (unsigned_char_Array_0[1][0])) ? (unsigned_char_Array_0[1][1]) : (unsigned_char_Array_0[1][0])))))))) : (signed_short_int_Array_0[0] == ((signed short int) (unsigned_char_Array_0[1][0] + unsigned_char_Array_0[1][1])))) : 1)) && ((2.8f == double_Array_0[1]) ? (signed_char_Array_0[0] == ((signed char) (((((((((signed_char_Array_0[1]) > (16)) ? (signed_char_Array_0[1]) : (16)))) > (signed_char_Array_0[3])) ? (((((signed_char_Array_0[1]) > (16)) ? (signed_char_Array_0[1]) : (16)))) : (signed_char_Array_0[3]))) + signed_char_Array_0[4]))) : 1)) && (signed_char_Array_0[2] == ((signed char) ((((-4) < (signed_char_Array_0[3])) ? (-4) : (signed_char_Array_0[3])))))) && ((unsigned_char_Array_0[1][1] > (signed_short_int_Array_0[0] + signed_char_Array_0[2])) ? (float_Array_0[0] == ((float) float_Array_0[1])) : 1)
;
}
int main(void) {
 isInitial = 1;
