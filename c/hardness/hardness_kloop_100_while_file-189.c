...
void step(void) {
	...
	// From: Req13Batch189100_while
	var_1_34 = (var_1_12 || (var_1_10 || var_1_11));


	// From: Req2Batch189100_while
	if (! last_1_var_1_34) {
	...
	// From: Req1Batch189100_while
	if (! (var_1_2 || var_1_4)) {
		var_1_1 = ((var_1_5 + var_1_6) - 1.000000000000005E13f);
	}


	// From: Req4Batch189100_while
	if (var_1_6 < var_1_1) {
		if (var_1_14 >= var_1_6) {
