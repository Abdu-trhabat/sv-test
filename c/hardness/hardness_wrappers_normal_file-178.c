...
void step(void) {
	...
	// From: Req7Batch178normal
	var_1_21 = var_1_17;


	// From: Req2Batch178normal
	unsigned long int stepLocal_1 = var_1_10;
	unsigned long int stepLocal_0 = max ((var_1_5 * var_1_10) , var_1_20);
	if (256u <= stepLocal_0) {
	...
	if (var_1_8) {
		...
		var_1_14 = (min (var_1_16 , (var_1_21 - var_1_15)));
	}
...
int property(void) {
	return (((((((! var_1_2) ? ((! var_1_2) ? (var_1_1 == ((unsigned char) (((var_1_21 + var_1_9) > (var_1_5 * var_1_6)) || var_1_7))) : (var_1_1 == ((unsigned char) var_1_8))) : 1) && ((256u <= (max ((var_1_5 * var_1_10) , var_1_20))) ? ((var_1_19 < var_1_10) ? (var_1_9 == ((unsigned short int) ((var_1_12 + var_1_13) - var_1_20))) : (var_1_9 == ((unsigned short int) var_1_12))) : 1)) && (var_1_8 ? (var_1_14 == ((signed short int) var_1_21)) : (var_1_14 == ((signed short int) (min (var_1_16 , (var_1_21 - var_1_15))))))) && (var_1_16 == ((unsigned char) (var_1_17 + var_1_18)))) && (var_1_19 == ((signed short int) var_1_17))) && (var_1_20 == ((signed short int) var_1_18))) && (var_1_21 == ((unsigned char) var_1_17))
;
}
int main(void) {
	isInitial = 1;
