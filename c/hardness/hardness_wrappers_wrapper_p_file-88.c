	...
	if (15.2f < (*(var_1_9_Pointer))) {
		...
		if ((*(var_1_10_Pointer)) > (*(var_1_4_Pointer))) {
			if (last_1_var_1_8 == (*(var_1_10_Pointer))) {
				(*(var_1_8_Pointer)) = (max ((abs ((*(var_1_1_Pointer)))) , -16));
			} else {
