...
void step(void) {
 ...
 unsigned long int stepLocal_0 = ((((*(var_1_1_Pointer))) < ((*(var_1_5_Pointer)))) ? ((*(var_1_1_Pointer))) : ((*(var_1_5_Pointer))));
 if (stepLocal_0 != (((((*(var_1_4_Pointer))) < ((*(var_1_3_Pointer)))) ? ((*(var_1_4_Pointer))) : ((*(var_1_3_Pointer)))))) {
