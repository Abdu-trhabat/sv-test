...
void step(void) {
 ...
 if ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) < (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) {
  (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) = ((((1.25) < ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)))) ? (1.25) : ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)))));
 } else {
  if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) || stepLocal_0) {
   (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) = ((((((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) < 0 ) ? -((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) : ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))))) + (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)));
  }
 }
