...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch99Amount100.c", 13, "reach_error"); }
...
void step(void) {
 unsigned long int stepLocal_2 = (((last_1_var_1_7) > (last_1_var_1_6)) ? (last_1_var_1_7) : (last_1_var_1_6));
 if (last_1_var_1_10 == stepLocal_2) {
  if (! (last_1_var_1_6 > ((((last_1_var_1_7) < (var_1_4)) ? (last_1_var_1_7) : (var_1_4))))) {
   var_1_8 = var_1_9;
  }
 }
 ...
 if (last_1_var_1_28) {
  ...
  if (stepLocal_1 && last_1_var_1_8) {
   var_1_6 = ((((last_1_var_1_27) > (var_1_4)) ? (last_1_var_1_27) : (var_1_4)));
  }
 }
 var_1_7 = var_1_5;
 ...
 if (var_1_8) {
  if (stepLocal_6 <= var_1_6) {
   var_1_17 = ((((((1.0000000000000012E14f + var_1_18)) < (var_1_19)) ? ((1.0000000000000012E14f + var_1_18)) : (var_1_19))) + var_1_20);
  } else {
 ...
 if (var_1_6 < var_1_7) {
  if ((- var_1_17) < ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))) {
 ...
 if (var_1_6 < var_1_11) {
  var_1_10 = (last_1_var_1_10 - ((((var_1_5) < (16)) ? (var_1_5) : (16))));
 } else {
  if (var_1_28) {
   var_1_10 = var_1_4;
  } else {
  ...
  if (var_1_28) {
   ...
   if (var_1_7 <= stepLocal_9) {
    if (stepLocal_10 || (var_1_19 < var_1_20)) {
     var_1_27 = (((((1) < (var_1_4)) ? (1) : (var_1_4))) + ((((var_1_14) > (var_1_7)) ? (var_1_14) : (var_1_7))));
    }
   }
  }
 }
 ...
 if (var_1_7 > stepLocal_5) {
  if (stepLocal_3 < var_1_13) {
   if (stepLocal_4 <= var_1_6) {
    var_1_12 = (((((var_1_4) < (var_1_14)) ? (var_1_4) : (var_1_14))) - var_1_5);
   } else {
    var_1_12 = (((((var_1_5) < (var_1_15)) ? (var_1_5) : (var_1_15))) + var_1_16);
   }
  } else {
   var_1_12 = var_1_16;
  }
 ...
 if (var_1_21 != var_1_19) {
  if (var_1_28) {
   var_1_25 = ((((var_1_24) < (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))) ? (var_1_24) : (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))));
  } else {
   var_1_25 = ((((4) > (var_1_5)) ? (4) : (var_1_5)));
  }
 } else {
...
int property(void) {
 return ((((((((((((! var_1_28) && var_1_28) ? (var_1_1 == ((unsigned char) (var_1_4 - var_1_5))) : (var_1_28 ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_1 == ((unsigned char) 1)))) && (last_1_var_1_28 ? (var_1_6 == ((unsigned long int) (var_1_4 + last_1_var_1_27))) : (((var_1_4 > 2) && last_1_var_1_8) ? (var_1_6 == ((unsigned long int) ((((last_1_var_1_27) > (var_1_4)) ? (last_1_var_1_27) : (var_1_4))))) : 1))) && (var_1_7 == ((signed short int) var_1_5))) && ((last_1_var_1_10 == ((((last_1_var_1_7) > (last_1_var_1_6)) ? (last_1_var_1_7) : (last_1_var_1_6)))) ? ((! (last_1_var_1_6 > ((((last_1_var_1_7) < (var_1_4)) ? (last_1_var_1_7) : (var_1_4))))) ? (var_1_8 == ((unsigned char) var_1_9)) : 1) : 1)) && ((var_1_6 < var_1_11) ? (var_1_10 == ((signed short int) (last_1_var_1_10 - ((((var_1_5) < (16)) ? (var_1_5) : (16)))))) : (var_1_28 ? (var_1_10 == ((signed short int) var_1_4)) : (var_1_10 == ((signed short int) last_1_var_1_10))))) && ((var_1_7 > var_1_11) ? ((var_1_7 < var_1_13) ? ((var_1_10 <= var_1_6) ? (var_1_12 == ((unsigned char) (((((var_1_4) < (var_1_14)) ? (var_1_4) : (var_1_14))) - var_1_5))) : (var_1_12 == ((unsigned char) (((((var_1_5) < (var_1_15)) ? (var_1_5) : (var_1_15))) + var_1_16)))) : (var_1_12 == ((unsigned char) var_1_16))) : 1)) && (var_1_8 ? ((var_1_7 <= var_1_6) ? (var_1_17 == ((float) ((((((1.0000000000000012E14f + var_1_18)) < (var_1_19)) ? ((1.0000000000000012E14f + var_1_18)) : (var_1_19))) + var_1_20))) : (var_1_17 == ((float) (var_1_21 - var_1_22)))) : (var_1_17 == ((float) var_1_21)))) && (var_1_8 ? ((var_1_27 <= var_1_6) ? (var_1_23 == ((unsigned char) 10)) : (var_1_23 == ((unsigned char) ((200 - var_1_24) - 64)))) : 1)) && ((var_1_21 != var_1_19) ? (var_1_28 ? (var_1_25 == ((unsigned char) ((((var_1_24) < (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16))))) ? (var_1_24) : (((((var_1_16) < 0 ) ? -(var_1_16) : (var_1_16)))))))) : (var_1_25 == ((unsigned char) ((((4) > (var_1_5)) ? (4) : (var_1_5)))))) : (var_1_25 == ((unsigned char) (var_1_14 - (var_1_26 - var_1_24)))))) && (var_1_8 ? (var_1_27 == ((signed short int) var_1_5)) : (var_1_28 ? ((var_1_10 <= var_1_15) ? (var_1_27 == ((signed short int) -10)) : 1) : ((var_1_7 <= (var_1_4 - var_1_5)) ? ((var_1_9 || (var_1_19 < var_1_20)) ? (var_1_27 == ((signed short int) (((((1) < (var_1_4)) ? (1) : (var_1_4))) + ((((var_1_14) > (var_1_7)) ? (var_1_14) : (var_1_7)))))) : 1) : 1)))) && ((var_1_6 < var_1_7) ? (((- var_1_17) < ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))) ? (var_1_28 == ((unsigned char) ((var_1_8 || var_1_9) && var_1_30))) : (var_1_28 == ((unsigned char) var_1_30))) : (var_1_28 == ((unsigned char) var_1_31)))
;
}
int main(void) {
 isInitial = 1;
