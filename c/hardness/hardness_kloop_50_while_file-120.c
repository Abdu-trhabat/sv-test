...
void step(void) {
	// From: Req3Batch12050_while
	var_1_11 = (min (last_1_var_1_18 , (max (last_1_var_1_20 , var_1_12))));


	// From: Req7Batch12050_while
	if (var_1_14 || var_1_15) {
		var_1_20 = (var_1_21 - (min (var_1_19 , var_1_17)));
	}


	// From: Req8Batch12050_while
	var_1_22 = var_1_14;


	// From: Req4Batch12050_while
	if (var_1_22) {
		var_1_13 = (var_1_14 && (! var_1_15));
	}


	// From: Req5Batch12050_while
	if (! var_1_22) {
		var_1_16 = var_1_17;
	}


	// From: Req1Batch12050_while
