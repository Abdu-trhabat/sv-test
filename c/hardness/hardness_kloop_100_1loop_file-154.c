...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch154100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req8Batch154100_1loop
	if (64.75 >= var_1_13) {
		var_1_18 = (var_1_7 && (last_1_var_1_5 || var_1_6));
	}


	// From: Req1Batch154100_1loop
	if (last_1_var_1_18) {
	...
	// From: Req3Batch154100_1loop
	if (var_1_1 > var_1_4) {
		var_1_8 = (abs (abs (var_1_9)));
	}


	// From: Req4Batch154100_1loop
