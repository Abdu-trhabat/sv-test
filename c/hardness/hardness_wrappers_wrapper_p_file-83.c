...
void step(void) {
	// From: Req1Batch83Wrapper_P
	signed long int stepLocal_0 = min (((*(var_1_5_Pointer)) * (*(var_1_6_Pointer))) , (~ (*(var_1_7_Pointer))));
	if ((*(var_1_2_Pointer))) {
		(*(var_1_1_Pointer)) = (abs (abs ((*(var_1_3_Pointer)))));
	} else {
	...
	if ((*(var_1_6_Pointer)) <= stepLocal_1) {
		if ((*(var_1_1_Pointer)) == stepLocal_2) {
			(*(var_1_8_Pointer)) = ((abs ((*(var_1_10_Pointer)))) + (*(var_1_11_Pointer)));
		} else {
	...
	// From: Req3Batch83Wrapper_P
	if ((*(var_1_6_Pointer)) > (*(var_1_13_Pointer))) {
		(*(var_1_12_Pointer)) = (min ((*(var_1_11_Pointer)) , (*(var_1_10_Pointer))));
	}


	// From: Req4Batch83Wrapper_P
	(*(var_1_14_Pointer)) = 200;


	// From: Req5Batch83Wrapper_P
	(*(var_1_15_Pointer)) = (*(var_1_16_Pointer));


	// From: Req6Batch83Wrapper_P
...
int property(void) {
	return ((((((*(var_1_2_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (abs (abs ((*(var_1_3_Pointer))))))) : ((((*(var_1_3_Pointer)) / (*(var_1_4_Pointer))) >= (min (((*(var_1_5_Pointer)) * (*(var_1_6_Pointer))) , (~ (*(var_1_7_Pointer)))))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (*(var_1_4_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned short int) (*(var_1_3_Pointer)))))) && (((*(var_1_6_Pointer)) <= ((*(var_1_3_Pointer)) + (*(var_1_1_Pointer)))) ? (((*(var_1_1_Pointer)) == ((*(var_1_1_Pointer)) ^ (*(var_1_5_Pointer)))) ? ((*(var_1_8_Pointer)) == ((double) ((abs ((*(var_1_10_Pointer)))) + (*(var_1_11_Pointer))))) : ((*(var_1_8_Pointer)) == ((double) (*(var_1_11_Pointer))))) : ((*(var_1_8_Pointer)) == ((double) (*(var_1_10_Pointer)))))) && (((*(var_1_6_Pointer)) > (*(var_1_13_Pointer))) ? ((*(var_1_12_Pointer)) == ((double) (min ((*(var_1_11_Pointer)) , (*(var_1_10_Pointer)))))) : 1)) && ((*(var_1_14_Pointer)) == ((signed short int) 200))) && ((*(var_1_15_Pointer)) == ((signed char) (*(var_1_16_Pointer))))) && ((*(var_1_17_Pointer)) == ((double) (*(var_1_10_Pointer))))
;
}
int main(void) {
	isInitial = 1;
