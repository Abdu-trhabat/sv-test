...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch163dependencies.c", 13, "reach_error"); }
...
void step(void) {
 if ((var_1_2 / 31.4) <= var_1_3) {
  var_1_1 = ((((((var_1_4 + var_1_5)) < (var_1_6)) ? ((var_1_4 + var_1_5)) : (var_1_6))) + var_1_7);
 } else {
  var_1_1 = var_1_6;
 }
 if (var_1_9 || var_1_23) {
...
int property(void) {
 return (((((((var_1_2 / 31.4) <= var_1_3) ? (var_1_1 == ((signed long int) ((((((var_1_4 + var_1_5)) < (var_1_6)) ? ((var_1_4 + var_1_5)) : (var_1_6))) + var_1_7))) : (var_1_1 == ((signed long int) var_1_6))) && ((var_1_1 > var_1_7) ? (var_1_26 ? (var_1_8 == ((unsigned long int) ((((((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11)))) < ((var_1_12 - 64u))) ? (((((var_1_10) > (var_1_11)) ? (var_1_10) : (var_1_11)))) : ((var_1_12 - 64u)))))) : (var_1_8 == ((unsigned long int) var_1_11))) : 1)) && ((var_1_26 && (var_1_11 >= var_1_8)) ? ((var_1_2 < ((((var_1_14) > (var_1_3)) ? (var_1_14) : (var_1_3)))) ? (var_1_13 == ((unsigned short int) var_1_15)) : (var_1_13 == ((unsigned short int) 10))) : (var_1_13 == ((unsigned short int) var_1_15)))) && ((var_1_1 < (16 - (var_1_17 - var_1_13))) ? ((1.000000000005E11 >= var_1_14) ? (var_1_16 == ((signed short int) (var_1_21 - 10))) : (var_1_26 ? (var_1_16 == ((signed short int) var_1_21)) : (var_1_16 == ((signed short int) -16)))) : (var_1_16 == ((signed short int) var_1_21)))) && ((var_1_9 || var_1_23) ? (var_1_22 == ((float) ((((var_1_24) < (var_1_25)) ? (var_1_24) : (var_1_25))))) : ((var_1_4 == var_1_17) ? (var_1_22 == ((float) 16.25f)) : 1))) && (((((((var_1_21) > (var_1_19)) ? (var_1_21) : (var_1_19))) - var_1_20) > (256 << (2u + var_1_27))) ? (var_1_26 == ((unsigned char) 1)) : (var_1_26 == ((unsigned char) var_1_28)))
;
}
int main(void) {
 isInitial = 1;
