...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52functionizing.c", 13, "reach_error"); }
...
void functionized4(unsigned char functionized4_localFunctionVar0, unsigned char functionized4_localFunctionVar1) {
 if (! functionized4_localFunctionVar0) {
  var_1_11 = functionized4_localFunctionVar1;
 }
}
...
void step(void) {
 ...
 if (functionized3(var_1_3) >= var_1_2) {
  functionized4(var_1_6, var_1_10);
 }
 var_1_12 = (functionized5(var_1_13, var_1_14));
