...
void step(void) {
	// From: Req1Batch105no_floats
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req2Batch105no_floats
...
int property(void) {
	return ((((var_1_1 == ((signed char) (var_1_2 - var_1_3))) && ((((var_1_3 >> 2) * var_1_1) <= (var_1_2 / 1000000)) ? (var_1_4 == ((signed long int) (5 - (var_1_3 + var_1_5)))) : (var_1_4 == ((signed long int) var_1_3)))) && (((128 - var_1_7) > var_1_8) ? (((min ((var_1_8 * var_1_7) , var_1_9)) >= -32) ? (var_1_6 == ((unsigned short int) ((var_1_10 - var_1_3) + var_1_11))) : 1) : 1)) && ((var_1_6 <= (var_1_3 / (62672 - var_1_13))) ? (var_1_12 == ((signed char) (max ((min ((var_1_14 + var_1_15) , var_1_3)) , var_1_2)))) : 1)) && (var_1_16 == ((unsigned char) var_1_17))
;
}
int main(void) {
	isInitial = 1;
