...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch127Amount10.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch127Amount10
	signed long int stepLocal_0 = var_1_4;
	if ((var_1_2 >> (var_1_3 - 5u)) > stepLocal_0) {
...
int property(void) {
	return ((var_1_2 >> (var_1_3 - 5u)) > var_1_4) ? (var_1_1 == ((double) ((var_1_5 + (var_1_6 - var_1_7)) - var_1_8))) : (var_1_9 ? (var_1_1 == ((double) var_1_7)) : 1)
;
}
int main(void) {
	isInitial = 1;
