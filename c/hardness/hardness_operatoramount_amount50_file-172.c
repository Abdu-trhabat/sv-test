...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch172Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch172Amount50
	if ((last_1_var_1_6 >= (abs (var_1_3))) || var_1_4) {
		var_1_1 = var_1_5;
	}


	// From: Req2Batch172Amount50
	if (var_1_1 > var_1_5) {
		var_1_6 = var_1_7;
	}


	// From: Req3Batch172Amount50
	if (var_1_4 && var_1_9) {
	...
	// From: Req8Batch172Amount50
	var_1_24 = var_1_16;


	// From: Req4Batch172Amount50
