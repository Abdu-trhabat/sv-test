...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch161dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch161dependencies
	if ((abs (var_1_6 * 4u)) != var_1_5) {
		var_1_9 = (var_1_10 - 50u);
	}


	// From: Req3Batch161dependencies
	var_1_11 = (64 + var_1_12);


	// From: Req4Batch161dependencies
	var_1_13 = (min (var_1_14 , var_1_15));


	// From: Req5Batch161dependencies
	if (var_1_11 >= var_1_8) {
	...
	// From: Req6Batch161dependencies
	if (var_1_7 || var_1_23) {
		var_1_22 = (min (var_1_15 , var_1_14));
	}


	// From: Req7Batch161dependencies
	if (var_1_8 >= (- var_1_1)) {
