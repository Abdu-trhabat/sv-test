...
void step(void) {
	...
	// From: Req5Batch20has_floats
	var_1_17 = var_1_12;


	// From: Req6Batch20has_floats
	var_1_18 = var_1_12;


	// From: Req7Batch20has_floats
	var_1_19 = var_1_14;
	...
	if (64 > stepLocal_1) {
		...
		var_1_6 = (min (var_1_5 , (2.0 - var_1_7)));
	}


	// From: Req4Batch20has_floats
	if (((- var_1_11) % (max (var_1_10 , var_1_14))) <= var_1_17) {
		var_1_13 = (var_1_7 - 200.0);
	} else {
		var_1_13 = (var_1_7 - (min (var_1_15 , var_1_16)));
	}
}
...
int property(void) {
	return (((((((var_1_2 != var_1_3) ? (var_1_1 == ((float) (abs (var_1_4)))) : (var_1_1 == ((float) (var_1_5 + -4.0f)))) && ((64 > var_1_19) ? (var_1_6 == ((double) (abs (var_1_5)))) : (var_1_6 == ((double) (min (var_1_5 , (2.0 - var_1_7))))))) && (var_1_9 ? (var_1_8 == ((unsigned char) ((var_1_10 + var_1_11) - var_1_12))) : 1)) && ((((- var_1_11) % (max (var_1_10 , var_1_14))) <= var_1_17) ? (var_1_13 == ((double) (var_1_7 - 200.0))) : (var_1_13 == ((double) (var_1_7 - (min (var_1_15 , var_1_16))))))) && (var_1_17 == ((unsigned short int) var_1_12))) && (var_1_18 == ((unsigned char) var_1_12))) && (var_1_19 == ((unsigned long int) var_1_14))
;
}
int main(void) {
	isInitial = 1;
