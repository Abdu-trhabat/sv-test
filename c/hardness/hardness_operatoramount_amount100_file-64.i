...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch64Amount100.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (last_1_var_1_11 <= ((((49.4f) > (var_1_5)) ? (49.4f) : (var_1_5)))) {
  if (var_1_6 <= last_1_var_1_11) {
   if ((((((last_1_var_1_29) > (last_1_var_1_16)) ? (last_1_var_1_29) : (last_1_var_1_16))) * last_1_var_1_17) <= stepLocal_0) {
 ...
 if ((var_1_20 - ((((var_1_21) > (var_1_24)) ? (var_1_21) : (var_1_24)))) <= (var_1_32 + -25)) {
  if (var_1_18 > var_1_22) {
   var_1_30 = var_1_21;
  } else {
   var_1_30 = ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)));
  }
 } else {
  if (var_1_26 >= 9.5) {
   var_1_30 = var_1_29;
 ...
 if (((((7.2) > (10.86)) ? (7.2) : (10.86))) >= (var_1_12 - var_1_5)) {
  ...
  if (var_1_8 >= ((var_1_24 - last_1_var_1_23) - ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))))) {
   var_1_23 = var_1_22;
  } else {
   var_1_23 = var_1_16;
  }
 ...
 if (((((var_1_16) < ((var_1_16 - var_1_17))) ? (var_1_16) : ((var_1_16 - var_1_17)))) >= stepLocal_1) {
  var_1_14 = var_1_15;
 }
 ...
 if ((var_1_30 * ((((var_1_21) > (last_1_var_1_28)) ? (var_1_21) : (last_1_var_1_28)))) >= stepLocal_4) {
...
int property(void) {
 return (((((((((((((var_1_32 <= var_1_16) ? (var_1_1 == ((float) ((((var_1_4 + (var_1_5 - var_1_6)) < 0 ) ? -(var_1_4 + (var_1_5 - var_1_6)) : (var_1_4 + (var_1_5 - var_1_6)))))) : (var_1_14 ? (var_1_1 == ((float) ((((var_1_6) > (var_1_5)) ? (var_1_6) : (var_1_5))))) : 1)) && ((last_1_var_1_11 <= ((((49.4f) > (var_1_5)) ? (49.4f) : (var_1_5)))) ? ((var_1_6 <= last_1_var_1_11) ? (((((((last_1_var_1_29) > (last_1_var_1_16)) ? (last_1_var_1_29) : (last_1_var_1_16))) * last_1_var_1_17) <= last_1_var_1_32) ? (var_1_8 == ((signed long int) last_1_var_1_29)) : (var_1_8 == ((signed long int) last_1_var_1_16))) : (var_1_8 == ((signed long int) last_1_var_1_29))) : (var_1_8 == ((signed long int) last_1_var_1_17)))) && ((var_1_5 > var_1_4) ? (var_1_11 == ((double) (var_1_5 - (var_1_6 + ((((var_1_12) > (var_1_13)) ? (var_1_12) : (var_1_13))))))) : 1)) && ((((((var_1_16) < ((var_1_16 - var_1_17))) ? (var_1_16) : ((var_1_16 - var_1_17)))) >= var_1_23) ? (var_1_14 == ((unsigned char) var_1_15)) : 1)) && ((var_1_5 <= var_1_13) ? (var_1_16 == ((signed short int) last_1_var_1_28)) : (var_1_16 == ((signed short int) (last_1_var_1_28 - 4))))) && (var_1_17 == ((unsigned long int) (var_1_18 - var_1_16)))) && (var_1_19 == ((signed char) (var_1_20 - (var_1_21 - var_1_22))))) && ((((((7.2) > (10.86)) ? (7.2) : (10.86))) >= (var_1_12 - var_1_5)) ? (var_1_23 == ((unsigned long int) ((((var_1_21) < (var_1_22)) ? (var_1_21) : (var_1_22))))) : ((var_1_8 >= ((var_1_24 - last_1_var_1_23) - ((((var_1_17) < 0 ) ? -(var_1_17) : (var_1_17))))) ? (var_1_23 == ((unsigned long int) var_1_22)) : (var_1_23 == ((unsigned long int) var_1_16))))) && ((var_1_32 >= var_1_17) ? (var_1_25 == ((double) ((var_1_26 + var_1_27) + var_1_13))) : ((var_1_1 >= var_1_11) ? (var_1_25 == ((double) var_1_4)) : 1))) && (((var_1_30 * ((((var_1_21) > (last_1_var_1_28)) ? (var_1_21) : (last_1_var_1_28)))) >= var_1_8) ? ((var_1_18 <= 128u) ? ((var_1_4 == ((((var_1_5) < (var_1_25)) ? (var_1_5) : (var_1_25)))) ? (var_1_28 == ((unsigned char) var_1_22)) : (var_1_28 == ((unsigned char) var_1_21))) : (var_1_28 == ((unsigned char) var_1_22))) : (var_1_28 == ((unsigned char) var_1_22)))) && (((var_1_22 ^ var_1_21) < last_1_var_1_23) ? (var_1_29 == ((signed long int) (last_1_var_1_28 + var_1_21))) : (var_1_29 == ((signed long int) (last_1_var_1_8 + (last_1_var_1_28 + (16 - last_1_var_1_32))))))) && (((var_1_20 - ((((var_1_21) > (var_1_24)) ? (var_1_21) : (var_1_24)))) <= (var_1_32 + -25)) ? ((var_1_18 > var_1_22) ? (var_1_30 == ((signed short int) var_1_21)) : (var_1_30 == ((signed short int) ((((var_1_22) < 0 ) ? -(var_1_22) : (var_1_22)))))) : ((var_1_26 >= 9.5) ? (var_1_30 == ((signed short int) var_1_29)) : 1))) && (var_1_32 == ((signed long int) last_1_var_1_32))
;
}
int main(void) {
 isInitial = 1;
