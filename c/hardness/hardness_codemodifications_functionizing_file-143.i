...
void functionized0(float functionized0_localFunctionVar0, unsigned short int functionized0_localFunctionVar1, signed long int functionized0_localFunctionVar2) {
 if (((((64) > (functionized0_localFunctionVar1)) ? (64) : (functionized0_localFunctionVar1))) <= functionized0_localFunctionVar2) {
...
unsigned char functionized2(unsigned short int functionized2_localFunctionVar0) {
 return (25 <= ((((var_1_3) > (functionized2_localFunctionVar0)) ? (var_1_3) : (functionized2_localFunctionVar0))));
}
...
void functionized5(unsigned char functionized5_localFunctionVar0, float functionized5_localFunctionVar1, float functionized5_localFunctionVar2, unsigned char functionized5_localFunctionVar3, float functionized5_localFunctionVar4) {
 if (var_1_2 > functionized5_localFunctionVar3) {
  ...
  var_1_16 = ((functionized5_localFunctionVar4 < ((((functionized5_localFunctionVar1) < (functionized5_localFunctionVar2)) ? (functionized5_localFunctionVar1) : (functionized5_localFunctionVar2)))) && functionized5_localFunctionVar0);
 }
}
void functionized6(unsigned char functionized6_localFunctionVar0, unsigned short int functionized6_localFunctionVar1) {
 if (var_1_9 <= -16) {
  var_1_18 = (((((var_1_11 + functionized6_localFunctionVar0) + functionized6_localFunctionVar1) < 0 ) ? -((var_1_11 + functionized6_localFunctionVar0) + functionized6_localFunctionVar1) : ((var_1_11 + functionized6_localFunctionVar0) + functionized6_localFunctionVar1)));
 }
}
void functionized7(void) {
 var_1_21 = var_1_9;
