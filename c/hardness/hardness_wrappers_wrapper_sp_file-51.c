...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch51Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_4_Pointer)) <= last_1_WrapperStruct00_var_1_17) {
		if ((*(WrapperStruct00_var_1_2_Pointer)) && (last_1_WrapperStruct00_var_1_17 == (max ((*(WrapperStruct00_var_1_16_Pointer)) , (*(WrapperStruct00_var_1_12_Pointer)))))) {
			if (last_1_WrapperStruct00_var_1_17 < (*(WrapperStruct00_var_1_11_Pointer))) {
	...
	unsigned long int stepLocal_1 = (max ((*(WrapperStruct00_var_1_11_Pointer)) , (*(WrapperStruct00_var_1_12_Pointer)))) - (*(WrapperStruct00_var_1_13_Pointer));
	...
	unsigned long int stepLocal_0 = (*(WrapperStruct00_var_1_10_Pointer)) / (*(WrapperStruct00_var_1_5_Pointer));
