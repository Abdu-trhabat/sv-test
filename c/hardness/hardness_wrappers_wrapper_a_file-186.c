...
void step(void) {
	// From: Req1Batch186Wrapper_A
	if (double_Array_0[6] < double_Array_0[5]) {
		if (double_Array_0[5] < double_Array_0[6]) {
			signed_short_int_Array_0[1] = (signed_short_int_Array_0[0] + (abs (128)));
		} else {
	...
	// From: Req2Batch186Wrapper_A
	if ((max (double_Array_0[5] , double_Array_0[6])) > double_Array_0[4]) {
