...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch103Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
  ...
  var_1_29
    ...
    -0.8
             ...
             if ( (( ((16) << (10))) >= ( ((var_1_36) | (var_1_29))))) {
              if (var_1_26) {
               if ( (( ((2) << (var_1_25))) != ( ((var_1_37) | (var_1_30))))) {
                var_1_35 = (
     var_1_25
    );
   }
    ...
    var_1_25
             ...
             if (var_1_26) {
              if ( ((var_1_36) == ( (((((var_1_37)) > ((var_1_25))) ? ((var_1_37)) : ((var_1_25))))))) {
               var_1_38 = (
                ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25)))
   );
  }
 }
             if ( ((var_1_35) <= ( ((var_1_28) * ( (((((var_1_30)) > ((var_1_36))) ? ((var_1_30)) : ((var_1_36))))))))) {
              var_1_39 = (
               ((((9.5) < 0 ) ? -(9.5) : (9.5)))
  );
 }
             if ( ((var_1_39) > ( ((((var_1_33) < 0 ) ? -(var_1_33) : (var_1_33)))))) {
              if ( (( (((((var_1_33)) < (( ((var_1_32) / (var_1_41))))) ? ((var_1_33)) : (( ((var_1_32) / (var_1_41))))))) < (2.75))) {
               var_1_40 = (
                ((
     var_1_25
    ) + (
                 ((((( ((((( var_1_27 )) > (( var_1_29 ))) ? (( var_1_27 )) : (( var_1_29 )))) )) < (( var_1_30 ))) ? (( ((((( var_1_27 )) > (( var_1_29 ))) ? (( var_1_27 )) : (( var_1_29 )))) )) : (( var_1_30 ))))
    ))
   );
  }
 } else {
