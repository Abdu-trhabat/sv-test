...
void step(void) {
 ...
 if (stepLocal_1 < (unsigned_char_Array_0[1] + ((((unsigned_char_Array_0[2]) < 0 ) ? -(unsigned_char_Array_0[2]) : (unsigned_char_Array_0[2]))))) {
 ...
 if (((((signed_long_int_Array_0[1][1]) > (signed_long_int_Array_0[0][1])) ? (signed_long_int_Array_0[1][1]) : (signed_long_int_Array_0[0][1]))) != stepLocal_0) {
  unsigned_char_Array_0[6] = ((((unsigned_char_Array_0[5]) < 0 ) ? -(unsigned_char_Array_0[5]) : (unsigned_char_Array_0[5])));
 } else {
  unsigned_char_Array_0[6] = (((((unsigned_char_Array_0[3] + unsigned_char_Array_0[1])) < (unsigned_char_Array_0[5])) ? ((unsigned_char_Array_0[3] + unsigned_char_Array_0[1])) : (unsigned_char_Array_0[5])));
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((((signed_long_int_Array_0[1][1]) > (signed_long_int_Array_0[0][1])) ? (signed_long_int_Array_0[1][1]) : (signed_long_int_Array_0[0][1]))) != (signed_long_int_Array_0[1][0] + signed_long_int_Array_0[0][0])) ? (unsigned_char_Array_0[6] == ((unsigned char) ((((unsigned_char_Array_0[5]) < 0 ) ? -(unsigned_char_Array_0[5]) : (unsigned_char_Array_0[5]))))) : (unsigned_char_Array_0[6] == ((unsigned char) (((((unsigned_char_Array_0[3] + unsigned_char_Array_0[1])) < (unsigned_char_Array_0[5])) ? ((unsigned_char_Array_0[3] + unsigned_char_Array_0[1])) : (unsigned_char_Array_0[5])))))) && ((last_1_unsigned_long_int_Array_0_1_ < signed_long_int_Array_0[0][1]) ? ((last_1_unsigned_char_Array_0_4_ <= ((unsigned_char_Array_0[0] - unsigned_char_Array_0[2]) - unsigned_char_Array_0[3])) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) ((1211749435u + (unsigned_long_int_Array_0[0] + unsigned_long_int_Array_0[2])) - unsigned_char_Array_0[1]))) : ((unsigned_char_Array_0[0] < (unsigned_char_Array_0[3] | signed_long_int_Array_0[0][0])) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_char_Array_0[0])) : 1)) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_char_Array_0[1])))) && ((((unsigned_char_Array_0[3] & unsigned_long_int_Array_0[1]) / unsigned_char_Array_0[0]) < (unsigned_char_Array_0[1] + ((((unsigned_char_Array_0[2]) < 0 ) ? -(unsigned_char_Array_0[2]) : (unsigned_char_Array_0[2]))))) ? (unsigned_char_Array_0[4] == ((unsigned char) unsigned_char_Array_0[3])) : (unsigned_char_Array_0[4] == ((unsigned char) 5)))
;
}
int main(void) {
 isInitial = 1;
