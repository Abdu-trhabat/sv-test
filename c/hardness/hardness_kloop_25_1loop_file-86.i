...
void step(void) {
 if (! last_1_var_1_16) {
  ...
  var_1_1 = ((((var_1_4) < (var_1_6)) ? (var_1_4) : (var_1_6)));
 }
 ...
 if (stepLocal_1 >= (((((var_1_13 - var_1_10)) > (var_1_14)) ? ((var_1_13 - var_1_10)) : (var_1_14)))) {
...
int property(void) {
 return ((((! last_1_var_1_16) ? (var_1_1 == ((signed short int) (((((var_1_3 + (var_1_4 + var_1_5))) < (var_1_6)) ? ((var_1_3 + (var_1_4 + var_1_5))) : (var_1_6))))) : (var_1_1 == ((signed short int) ((((var_1_4) < (var_1_6)) ? (var_1_4) : (var_1_6)))))) && (((var_1_3 / var_1_8) <= (var_1_9 - var_1_10)) ? (var_1_16 ? (var_1_7 == ((unsigned char) var_1_11)) : 1) : 1)) && ((0u >= (((((var_1_13 - var_1_10)) > (var_1_14)) ? ((var_1_13 - var_1_10)) : (var_1_14)))) ? (var_1_12 == ((signed short int) (var_1_15 - var_1_7))) : 1)) && ((((var_1_17 - 100u) - (var_1_11 + var_1_1)) < var_1_13) ? (var_1_16 == ((unsigned char) var_1_18)) : 1)
;
}
int main(void) {
 isInitial = 1;
