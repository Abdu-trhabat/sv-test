...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch160normal.c", 13, "reach_error"); }
...
int property(void) {
 return (((((((var_1_16 >= var_1_18) ? (var_1_1 == ((signed short int) ((var_1_4 - (var_1_5 + var_1_6)) + (1 - var_1_7)))) : (var_1_1 == ((signed short int) var_1_5))) && (((1 << (var_1_9 + 10)) >= var_1_18) ? (var_1_8 == ((unsigned char) (! (var_1_10 || var_1_11)))) : (var_1_8 == ((unsigned char) var_1_11)))) && ((var_1_11 || var_1_8) ? (var_1_12 == ((unsigned char) 0)) : 1)) && ((var_1_6 < ((var_1_14 - var_1_5) - var_1_9)) ? (var_1_13 == ((signed short int) (((var_1_9 + var_1_6) - var_1_5) + var_1_7))) : (var_1_13 == ((signed short int) ((((1 - 50) < 0 ) ? -(1 - 50) : (1 - 50))))))) && ((var_1_9 == var_1_14) ? (var_1_15 == ((signed short int) (var_1_6 - var_1_4))) : 1)) && ((((var_1_13 / var_1_14) * var_1_9) < ((((var_1_5) < ((var_1_6 - var_1_4))) ? (var_1_5) : ((var_1_6 - var_1_4))))) ? (var_1_16 == ((unsigned long int) (var_1_9 + (var_1_17 - var_1_14)))) : 1)) && ((var_1_9 >= var_1_16) ? (var_1_18 == ((signed long int) (var_1_4 + var_1_16))) : ((var_1_5 > (var_1_4 << var_1_16)) ? (var_1_18 == ((signed long int) last_1_var_1_18)) : (var_1_18 == ((signed long int) var_1_16))))
;
}
int main(void) {
 isInitial = 1;
