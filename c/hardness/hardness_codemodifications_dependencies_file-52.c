...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch52dependencies.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req4Batch52dependencies
	var_1_12 = (var_1_13 && var_1_14);


	// From: Req6Batch52dependencies
	var_1_17 = (abs (var_1_10));


	// From: Req8Batch52dependencies
	...
	// From: Req2Batch52dependencies
	if (var_1_17 < ((min (var_1_8 , var_1_9)) - var_1_10)) {
		if (var_1_12) {
			var_1_7 = var_1_9;
		}
	}
