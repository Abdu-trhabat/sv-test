...
void step(void) {
	...
	if ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) > (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer))) {
		(*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) = (min ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) , (max ((min ((*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer)) , (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)))) , (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))))));
	} else {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
	...
	// From: Req3Batch101Wrapper_AP
	if (((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var5_Pointer)) / (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var4_Pointer))) > (-1000 % (abs (16)))) {
