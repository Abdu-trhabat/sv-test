...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16stepLocals.c", 13, "reach_error"); }
...
signed short int var_1_2 = 10000;
...
void step(void) {
	// From: Req1Batch16stepLocals
	signed long int stepLocal_0 = var_1_3;
	if ((var_1_2 / -50) >= stepLocal_0) {
		if (var_1_4) {
	...
	// From: Req3Batch16stepLocals
	if (var_1_6 > 128) {
		var_1_9 = (var_1_8 - (var_1_10 - var_1_7));
	}


	// From: Req4Batch16stepLocals
	signed long int stepLocal_2 = (var_1_7 + var_1_9) * var_1_3;
	if (stepLocal_2 < (var_1_5 | var_1_6)) {
		if (var_1_4) {
			var_1_11 = var_1_8;
		}
	} else {
	...
	// From: Req5Batch16stepLocals
	signed short int stepLocal_4 = var_1_2;
	...
	// From: Req7Batch16stepLocals
	if (var_1_4 || var_1_19) {
		var_1_18 = (abs (var_1_20 + (var_1_21 + var_1_22)));
	}


	// From: Req8Batch16stepLocals
...
int property(void) {
	return (((((((((var_1_2 / -50) >= var_1_3) ? (var_1_4 ? (var_1_1 == ((signed short int) (var_1_5 - var_1_6))) : (var_1_1 == ((signed short int) var_1_5))) : (var_1_1 == ((signed short int) var_1_5))) && ((var_1_2 < var_1_6) ? (var_1_7 == ((unsigned short int) (var_1_6 + var_1_8))) : 1)) && ((var_1_6 > 128) ? (var_1_9 == ((signed long int) (var_1_8 - (var_1_10 - var_1_7)))) : 1)) && ((((var_1_7 + var_1_9) * var_1_3) < (var_1_5 | var_1_6)) ? (var_1_4 ? (var_1_11 == ((unsigned short int) var_1_8)) : 1) : (var_1_11 == ((unsigned short int) var_1_8)))) && ((var_1_11 < (- var_1_10)) ? ((var_1_8 <= var_1_2) ? (var_1_12 == ((double) (var_1_13 - 63.75))) : 1) : (var_1_12 == ((double) var_1_13)))) && ((var_1_1 <= var_1_8) ? (var_1_14 == ((signed char) (((max (var_1_15 , var_1_16)) - var_1_17) + -2))) : 1)) && ((var_1_4 || var_1_19) ? (var_1_18 == ((float) (abs (var_1_20 + (var_1_21 + var_1_22))))) : 1)) && ((var_1_4 && ((abs (var_1_11)) > var_1_5)) ? (var_1_23 == ((unsigned short int) var_1_6)) : 1)
;
}
int main(void) {
	isInitial = 1;
