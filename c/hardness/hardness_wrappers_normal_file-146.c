...
int property(void) {
	return ((((var_1_1 == ((signed long int) (var_1_2 + (min ((16 + var_1_3) , (max (var_1_4 , -32))))))) && ((var_1_1 >= ((max (var_1_2 , var_1_4)) % var_1_6)) ? (var_1_5 == ((unsigned long int) ((2066465504u - (var_1_7 + var_1_8)) + var_1_9))) : ((var_1_9 >= var_1_7) ? (var_1_5 == ((unsigned long int) var_1_7)) : 1))) && (var_1_11 ? ((var_1_3 > var_1_5) ? (var_1_10 == ((unsigned char) (max (var_1_12 , var_1_13)))) : 1) : ((((var_1_6 + var_1_8) * var_1_13) < (var_1_12 + var_1_5)) ? (var_1_10 == ((unsigned char) (128 - var_1_15))) : 1))) && (var_1_16 == ((float) var_1_17))) && (var_1_18 == ((unsigned char) var_1_13))
;
}
int main(void) {
	isInitial = 1;
