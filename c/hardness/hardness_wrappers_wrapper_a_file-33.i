...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch33Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (stepLocal_0 < -1) {
  signed_short_int_Array_0[2] = 8;
 } else {
  signed_short_int_Array_0[2] = (128 - (signed_short_int_Array_0[1] + signed_short_int_Array_0[0]));
 }
 float_Array_0[4] = float_Array_0[3];
 signed_long_int_Array_0[1] = signed_short_int_Array_0[0];
 if (signed_short_int_Array_0[1] < signed_long_int_Array_0[1]) {
  unsigned_char_Array_0[1] = (unsigned_char_Array_0[0] + 1);
 }
 if (signed_short_int_Array_0[0] < (signed_long_int_Array_0[1] & (signed_short_int_Array_0[1] | signed_long_int_Array_0[1]))) {
 ...
 if (! BOOL_unsigned_char_Array_0[0]) {
  ...
  if (stepLocal_1 > (signed_long_int_Array_0[2] + unsigned_char_Array_0[1])) {
   signed_long_int_Array_0[0] = unsigned_char_Array_0[1];
  } else {
   signed_long_int_Array_0[0] = signed_short_int_Array_0[2];
  }
 }
}
void updateVariables(void) {
...
int property(void) {
 return ((((((((last_1_signed_long_int_Array_0_1_ ^ last_1_signed_long_int_Array_0_0_) + last_1_signed_long_int_Array_0_0_) < -1) ? (signed_short_int_Array_0[2] == ((signed short int) 8)) : (signed_short_int_Array_0[2] == ((signed short int) (128 - (signed_short_int_Array_0[1] + signed_short_int_Array_0[0]))))) && ((signed_short_int_Array_0[1] < signed_long_int_Array_0[1]) ? (unsigned_char_Array_0[1] == ((unsigned char) (unsigned_char_Array_0[0] + 1))) : 1)) && ((signed_short_int_Array_0[0] < (signed_long_int_Array_0[1] & (signed_short_int_Array_0[1] | signed_long_int_Array_0[1]))) ? (float_Array_0[1] == ((float) ((((float_Array_0[2] + (float_Array_0[3] - float_Array_0[0])) < 0 ) ? -(float_Array_0[2] + (float_Array_0[3] - float_Array_0[0])) : (float_Array_0[2] + (float_Array_0[3] - float_Array_0[0])))))) : 1)) && ((! BOOL_unsigned_char_Array_0[0]) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_char_Array_0[0])) : ((signed_short_int_Array_0[0] > (signed_long_int_Array_0[2] + unsigned_char_Array_0[1])) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_char_Array_0[1])) : (signed_long_int_Array_0[0] == ((signed long int) signed_short_int_Array_0[2]))))) && (float_Array_0[4] == ((float) float_Array_0[3]))) && (signed_long_int_Array_0[1] == ((signed long int) signed_short_int_Array_0[0]))
;
}
int main(void) {
 isInitial = 1;
