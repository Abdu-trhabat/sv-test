...
double functionized0(double functionized0_localFunctionVar0, double functionized0_localFunctionVar1, double functionized0_localFunctionVar2) {
	return ((min (functionized0_localFunctionVar2 , functionized0_localFunctionVar1)) - functionized0_localFunctionVar0);
}
...
void functionized5(unsigned short int functionized5_localFunctionVar0, unsigned long int functionized5_localFunctionVar1, signed long int localFunctionVar2) {
	if (var_1_18 > functionized5_localFunctionVar1) {
		var_1_19 = ((max ((max (localFunctionVar2 , 41437)) , functionized5_localFunctionVar0)) - (var_1_21 - var_1_18));
	}
}
...
void functionized7(signed char functionized7_localFunctionVar0) {
	if (var_1_18 >= var_1_21) {
		var_1_23 = (min (var_1_18 , functionized7_localFunctionVar0));
	}
}
...
void step(void) {
	...
	// From: Req3Batch196functionizing
	...
	// From: Req4Batch196functionizing
	functionized5(var_1_20, var_1_11, 36708);


	// From: Req5Batch196functionizing
	...
	// From: Req6Batch196functionizing
	functionized7(var_1_24);


	// From: Req7Batch196functionizing
	var_1_25 = var_1_23;


	// From: Req8Batch196functionizing
	var_1_26 = var_1_24;


	// From: Req9Batch196functionizing
