...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch110Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_0 = ((((signed_long_int_Array_0[0][1]) < (signed_long_int_Array_0[1][0])) ? (signed_long_int_Array_0[0][1]) : (signed_long_int_Array_0[1][0]))) / signed_long_int_Array_0[0][0];
 if (signed_long_int_Array_0[1][1] != stepLocal_0) {
 ...
 if (signed_long_int_Array_0[1][1] <= (signed_long_int_Array_0[0][0] * ((((signed_long_int_Array_0[0][1]) > (signed_long_int_Array_0[1][0])) ? (signed_long_int_Array_0[0][1]) : (signed_long_int_Array_0[1][0]))))) {
  if ((((((signed_long_int_Array_0[0][0] * signed_long_int_Array_0[0][1])) < ((unsigned_long_int_Array_0[1] - unsigned_long_int_Array_0[0]))) ? ((signed_long_int_Array_0[0][0] * signed_long_int_Array_0[0][1])) : ((unsigned_long_int_Array_0[1] - unsigned_long_int_Array_0[0])))) > ((((signed_long_int_Array_0[1][1]) < (signed_long_int_Array_0[1][0])) ? (signed_long_int_Array_0[1][1]) : (signed_long_int_Array_0[1][0])))) {
   double_Array_0[1] = double_Array_0[0];
  }
 }
 if (BOOL_unsigned_char_Array_0[1][1]) {
  signed_short_int_Array_0[0][1] = (((((signed_short_int_Array_0[1][1]) < (signed_short_int_Array_0[0][0])) ? (signed_short_int_Array_0[1][1]) : (signed_short_int_Array_0[0][0]))) + signed_short_int_Array_0[1][0]);
 } else {
  signed_short_int_Array_0[0][1] = (signed_short_int_Array_0[0][2] - signed_short_int_Array_0[1][2]);
 }
 signed long int stepLocal_1 = signed_long_int_Array_0[1][0];
 if (stepLocal_1 <= (unsigned_long_int_Array_0[0] << ((((unsigned_char_Array_0[0]) > (unsigned_char_Array_0[1])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[1]))))) {
  signed_char_Array_0[0] = -64;
 }
}
void updateVariables(void) {
...
int property(void) {
 return ((((signed_long_int_Array_0[1][1] != (((((signed_long_int_Array_0[0][1]) < (signed_long_int_Array_0[1][0])) ? (signed_long_int_Array_0[0][1]) : (signed_long_int_Array_0[1][0]))) / signed_long_int_Array_0[0][0])) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) (! BOOL_unsigned_char_Array_0[0][1]))) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) ((BOOL_unsigned_char_Array_0[0][1] && BOOL_unsigned_char_Array_0[1][0]) && BOOL_unsigned_char_Array_0[0][0])))) && ((signed_long_int_Array_0[1][1] <= (signed_long_int_Array_0[0][0] * ((((signed_long_int_Array_0[0][1]) > (signed_long_int_Array_0[1][0])) ? (signed_long_int_Array_0[0][1]) : (signed_long_int_Array_0[1][0]))))) ? (((((((signed_long_int_Array_0[0][0] * signed_long_int_Array_0[0][1])) < ((unsigned_long_int_Array_0[1] - unsigned_long_int_Array_0[0]))) ? ((signed_long_int_Array_0[0][0] * signed_long_int_Array_0[0][1])) : ((unsigned_long_int_Array_0[1] - unsigned_long_int_Array_0[0])))) > ((((signed_long_int_Array_0[1][1]) < (signed_long_int_Array_0[1][0])) ? (signed_long_int_Array_0[1][1]) : (signed_long_int_Array_0[1][0])))) ? (double_Array_0[1] == ((double) double_Array_0[0])) : 1) : 1)) && (BOOL_unsigned_char_Array_0[1][1] ? (signed_short_int_Array_0[0][1] == ((signed short int) (((((signed_short_int_Array_0[1][1]) < (signed_short_int_Array_0[0][0])) ? (signed_short_int_Array_0[1][1]) : (signed_short_int_Array_0[0][0]))) + signed_short_int_Array_0[1][0]))) : (signed_short_int_Array_0[0][1] == ((signed short int) (signed_short_int_Array_0[0][2] - signed_short_int_Array_0[1][2]))))) && ((signed_long_int_Array_0[1][0] <= (unsigned_long_int_Array_0[0] << ((((unsigned_char_Array_0[0]) > (unsigned_char_Array_0[1])) ? (unsigned_char_Array_0[0]) : (unsigned_char_Array_0[1]))))) ? (signed_char_Array_0[0] == ((signed char) -64)) : 1)
;
}
int main(void) {
 isInitial = 1;
