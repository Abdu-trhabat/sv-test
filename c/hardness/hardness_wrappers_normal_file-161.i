...
void step(void) {
 ...
 if (var_1_3 < ((var_1_1 * var_1_8) + var_1_9)) {
  var_1_11 = ((((last_1_var_1_11) < 0 ) ? -(last_1_var_1_11) : (last_1_var_1_11)));
 }
 if (var_1_7) {
...
int property(void) {
 return ((((last_1_var_1_15 <= 32) ? (((var_1_3 - var_1_4) < var_1_5) ? (var_1_1 == ((float) var_1_6)) : ((var_1_6 < var_1_4) ? (last_1_var_1_12 ? (var_1_1 == ((float) (var_1_8 - (var_1_9 + var_1_10)))) : (var_1_1 == ((float) var_1_6))) : (var_1_1 == ((float) var_1_9)))) : 1) && ((var_1_3 < ((var_1_1 * var_1_8) + var_1_9)) ? (var_1_11 == ((unsigned long int) ((((last_1_var_1_11) < 0 ) ? -(last_1_var_1_11) : (last_1_var_1_11))))) : 1)) && (var_1_7 ? (var_1_12 == ((unsigned char) (var_1_13 || var_1_14))) : 1)) && (var_1_14 ? (var_1_12 ? ((var_1_12 || (var_1_9 <= var_1_3)) ? (var_1_15 == ((signed long int) (var_1_11 - var_1_16))) : 1) : (var_1_15 == ((signed long int) var_1_16))) : 1)
;
}
int main(void) {
 isInitial = 1;
