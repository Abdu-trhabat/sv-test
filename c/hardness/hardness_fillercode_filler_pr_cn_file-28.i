...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch28Filler_PR_CN.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned char stepLocal_2 = ((var_1_4) > ( (~ (var_1_10))));
   ...
   var_1_15
             ...
             if ( (( ((((((((64) < 0 ) ? -(64) : (64)))) < 0 ) ? -(((((64) < 0 ) ? -(64) : (64)))) : (((((64) < 0 ) ? -(64) : (64))))))) <= ( ((var_1_32) ^ ( ((var_1_37) % (var_1_40))))))) {
              var_1_39 = (
               ((
 ...
 signed short int stepLocal_5 = var_1_11;
   ...
   var_1_23
             ...
             if ( ((var_1_34) <= (var_1_27))) {
              var_1_37 = (
               ((((( (( 32 ) - ( 2 )) )) < (( var_1_32 ))) ? (( (( 32 ) - ( 2 )) )) : (( var_1_32 ))))
  );
 } else {
              if ( ((var_1_32) < (var_1_29))) {
               var_1_37 = (
                ((((( -8 )) < (( ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) ))) ? (( -8 )) : (( ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32))) ))))
   );
  } else {
