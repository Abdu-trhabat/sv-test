...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11350_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_5 != stepLocal_1) {
  var_1_16 = ((((10) < (((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))))) ? (10) : (((((var_1_17) > (var_1_18)) ? (var_1_17) : (var_1_18))))));
 }
 unsigned char stepLocal_2 = var_1_2;
 if (stepLocal_2 || var_1_8) {
  var_1_19 = var_1_20;
 } else {
  var_1_19 = (((((16 - var_1_21)) < (var_1_20)) ? ((16 - var_1_21)) : (var_1_20)));
 }
 var_1_22 = (var_1_23 - var_1_24);
 if (var_1_7 > 256.8) {
  var_1_25 = ((((((var_1_21 - var_1_17) + var_1_12)) > ((var_1_15 - var_1_18))) ? (((var_1_21 - var_1_17) + var_1_12)) : ((var_1_15 - var_1_18))));
 } else {
  if (var_1_2) {
   var_1_25 = 25;
  }
