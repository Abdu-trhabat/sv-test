...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch169Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch169Wrapper_SP
	signed short int stepLocal_0 = (*(WrapperStruct00_var_1_5_Pointer));
	if (stepLocal_0 >= (((*(WrapperStruct00_var_1_8_Pointer)) - (*(WrapperStruct00_var_1_9_Pointer))) - (*(WrapperStruct00_var_1_6_Pointer)))) {
		if ((*(WrapperStruct00_var_1_2_Pointer)) == (max ((*(WrapperStruct00_var_1_3_Pointer)) , (- (*(WrapperStruct00_var_1_4_Pointer)))))) {
			(*(WrapperStruct00_var_1_7_Pointer)) = ((*(WrapperStruct00_var_1_6_Pointer)) + (*(WrapperStruct00_var_1_8_Pointer)));
		} else {
	...
	// From: Req4Batch169Wrapper_SP
	(*(WrapperStruct00_var_1_14_Pointer)) = (*(WrapperStruct00_var_1_9_Pointer));


	// From: Req5Batch169Wrapper_SP
	(*(WrapperStruct00_var_1_15_Pointer)) = (*(WrapperStruct00_var_1_8_Pointer));


	// From: Req6Batch169Wrapper_SP
	(*(WrapperStruct00_var_1_16_Pointer)) = (*(WrapperStruct00_var_1_5_Pointer));


	// From: Req3Batch169Wrapper_SP
	if ((*(WrapperStruct00_var_1_6_Pointer)) > (*(WrapperStruct00_var_1_14_Pointer))) {
		if ((*(WrapperStruct00_var_1_11_Pointer))) {
			(*(WrapperStruct00_var_1_10_Pointer)) = ((abs ((*(WrapperStruct00_var_1_12_Pointer)))) - (*(WrapperStruct00_var_1_13_Pointer)));
		} else {
...
int property(void) {
	return (((((((*(WrapperStruct00_var_1_2_Pointer)) >= ((*(WrapperStruct00_var_1_3_Pointer)) + (*(WrapperStruct00_var_1_4_Pointer)))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((signed short int) ((*(WrapperStruct00_var_1_5_Pointer)) - (*(WrapperStruct00_var_1_6_Pointer))))) : 1) && (((*(WrapperStruct00_var_1_5_Pointer)) >= (((*(WrapperStruct00_var_1_8_Pointer)) - (*(WrapperStruct00_var_1_9_Pointer))) - (*(WrapperStruct00_var_1_6_Pointer)))) ? (((*(WrapperStruct00_var_1_2_Pointer)) == (max ((*(WrapperStruct00_var_1_3_Pointer)) , (- (*(WrapperStruct00_var_1_4_Pointer)))))) ? ((*(WrapperStruct00_var_1_7_Pointer)) == ((unsigned long int) ((*(WrapperStruct00_var_1_6_Pointer)) + (*(WrapperStruct00_var_1_8_Pointer))))) : (((*(WrapperStruct00_var_1_4_Pointer)) >= (*(WrapperStruct00_var_1_3_Pointer))) ? ((*(WrapperStruct00_var_1_7_Pointer)) == ((unsigned long int) (*(WrapperStruct00_var_1_9_Pointer)))) : 1)) : ((*(WrapperStruct00_var_1_7_Pointer)) == ((unsigned long int) (*(WrapperStruct00_var_1_6_Pointer)))))) && (((*(WrapperStruct00_var_1_6_Pointer)) > (*(WrapperStruct00_var_1_14_Pointer))) ? ((*(WrapperStruct00_var_1_11_Pointer)) ? ((*(WrapperStruct00_var_1_10_Pointer)) == ((double) ((abs ((*(WrapperStruct00_var_1_12_Pointer)))) - (*(WrapperStruct00_var_1_13_Pointer))))) : ((*(WrapperStruct00_var_1_10_Pointer)) == ((double) (*(WrapperStruct00_var_1_12_Pointer))))) : ((*(WrapperStruct00_var_1_10_Pointer)) == ((double) (*(WrapperStruct00_var_1_13_Pointer)))))) && ((*(WrapperStruct00_var_1_14_Pointer)) == ((signed long int) (*(WrapperStruct00_var_1_9_Pointer))))) && ((*(WrapperStruct00_var_1_15_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_8_Pointer))))) && ((*(WrapperStruct00_var_1_16_Pointer)) == ((signed short int) (*(WrapperStruct00_var_1_5_Pointer))))
;
}
int main(void) {
	isInitial = 1;
