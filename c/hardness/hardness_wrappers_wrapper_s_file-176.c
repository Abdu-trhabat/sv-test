...
void step(void) {
	// From: Req1Batch176Wrapper_S
	WrapperStruct00.var_1_1 = ((10000000 + 5) - (WrapperStruct00.var_1_2 - WrapperStruct00.var_1_3));


	// From: Req3Batch176Wrapper_S
	if (! (WrapperStruct00.var_1_2 <= WrapperStruct00.var_1_3)) {
		WrapperStruct00.var_1_7 = (min (WrapperStruct00.var_1_2 , (min (WrapperStruct00.var_1_3 , (max (-128 , WrapperStruct00.var_1_8))))));
	}


	// From: Req4Batch176Wrapper_S
	unsigned long int stepLocal_2 = max (WrapperStruct00.var_1_10 , WrapperStruct00.var_1_1);
	if (stepLocal_2 >= WrapperStruct00.var_1_5) {
		WrapperStruct00.var_1_9 = (16 + WrapperStruct00.var_1_11);
	}


	// From: Req5Batch176Wrapper_S
