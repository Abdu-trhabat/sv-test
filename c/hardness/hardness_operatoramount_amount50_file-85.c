...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch85Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_5) {
		var_1_15 = (max (var_1_12 , (var_1_13 + (abs (var_1_14)))));
	}
