...
int property(void) {
	return (((var_1_2 ? (((var_1_3 >= var_1_4) && var_1_5) ? ((var_1_3 >= var_1_4) ? (var_1_1 == ((unsigned short int) 5)) : (var_1_1 == ((unsigned short int) (min (25 , var_1_6))))) : 1) : (var_1_1 == ((unsigned short int) var_1_6))) && (((var_1_1 / var_1_8) > var_1_6) ? (var_1_7 == ((double) (max (var_1_9 , var_1_10)))) : 1)) && (var_1_2 ? ((var_1_1 <= var_1_8) ? (((~ (var_1_1 / var_1_8)) < var_1_6) ? (var_1_11 == ((unsigned long int) (var_1_1 + var_1_6))) : 1) : 1) : (var_1_11 == ((unsigned long int) (max ((var_1_1 + (var_1_6 + var_1_13)) , (3076057457u - var_1_14))))))) && (var_1_15 == ((float) var_1_9))
;
}
int main(void) {
	isInitial = 1;
