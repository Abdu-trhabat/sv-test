...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch17050_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req1Batch17050_while
	if (var_1_4) {
		var_1_1 = var_1_3;
	}


	// From: Req5Batch17050_while
	if (var_1_10 > (var_1_10 / (abs (var_1_18)))) {
		var_1_17 = var_1_16;
	}


	// From: Req7Batch17050_while
	var_1_21 = var_1_3;


	// From: Req4Batch17050_while
