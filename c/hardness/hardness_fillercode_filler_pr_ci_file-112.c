...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch112Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject6
	/* 367L, 244L) */ if (/* 368L, 226L, 227L) */ ((/* 369L, 224L, 228L) */ ((var_1_21) << (var_1_11))) < (var_1_20))) {
		/* 373L, 243L) */ var_1_44 = (
			/* 376L, 242L) */ (abs (
				/* 377L, 241L) */ ((
					var_1_37
	...
	/* 328L, 216L) */ if (/* 329L, 155L, 156L) */ ((var_1_39) < (var_1_35))) {
		...
		/* 337L, 214L) */ if (var_1_9) {
			/* 339L, 206L) */ if (/* 340L, 173L, 174L) */ ((var_1_21) >= (/* 342L, 172L, 176L) */ (- (var_1_4))))) {
				/* 344L, 189L) */ var_1_42 = (
					/* 347L, 188L) */ (abs (
						/* 348L, 187L) */ ((
							/* 349L, 185L) */ (abs (
