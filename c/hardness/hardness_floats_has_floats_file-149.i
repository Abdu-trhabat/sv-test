...
void step(void) {
 ...
 if (var_1_6 == 8.0) {
  var_1_9 = (((((0.0f) < (2.0f)) ? (0.0f) : (2.0f))) - ((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11))));
 } else {
  var_1_9 = -64.0f;
 }
}
...
int property(void) {
 return (((var_1_2 ? (var_1_1 == ((unsigned short int) (var_1_3 - var_1_4))) : ((var_1_3 == var_1_4) ? ((var_1_3 < 4) ? (var_1_1 == ((unsigned short int) var_1_4)) : (((- 4) < var_1_3) ? (var_1_1 == ((unsigned short int) ((((var_1_3) < (var_1_4)) ? (var_1_3) : (var_1_4))))) : (var_1_1 == ((unsigned short int) var_1_3)))) : (var_1_1 == ((unsigned short int) var_1_4)))) && ((var_1_3 < var_1_4) ? ((var_1_1 < var_1_3) ? (var_1_5 == ((unsigned long int) (var_1_4 + var_1_1))) : (var_1_5 == ((unsigned long int) var_1_1))) : 1)) && (var_1_6 == ((double) (var_1_7 + var_1_8)))) && ((var_1_6 == 8.0) ? (var_1_9 == ((float) (((((0.0f) < (2.0f)) ? (0.0f) : (2.0f))) - ((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11)))))) : (var_1_9 == ((float) -64.0f)))
;
}
int main(void) {
 isInitial = 1;
