...
void step(void) {
	...
	// From: Req3Batch166has_floats
	if (var_1_7) {
		var_1_9 = (max ((max (var_1_10 , var_1_11)) , (var_1_12 - var_1_13)));
	}


	// From: Req5Batch166has_floats
	unsigned char stepLocal_2 = var_1_7;
	if (((max (-16.0f , var_1_10)) < 8.0f) || stepLocal_2) {
		if (var_1_6) {
			var_1_17 = var_1_4;
		} else {
			var_1_17 = 0;
...
int property(void) {
	return (((((last_1_var_1_5 < last_1_var_1_1) ? (var_1_1 == ((unsigned short int) var_1_4)) : 1) && ((var_1_6 || var_1_7) ? (var_1_5 == ((signed long int) (min (var_1_14 , (var_1_4 - (var_1_8 - 100000)))))) : (var_1_5 == ((signed long int) 10)))) && (var_1_7 ? (var_1_9 == ((float) (max ((max (var_1_10 , var_1_11)) , (var_1_12 - var_1_13))))) : 1)) && ((var_1_11 != var_1_10) ? (var_1_14 == ((signed long int) (var_1_1 + (var_1_17 - var_1_4)))) : (var_1_14 == ((signed long int) (var_1_17 - ((var_1_15 - var_1_4) + var_1_16)))))) && ((((max (-16.0f , var_1_10)) < 8.0f) || var_1_7) ? (var_1_6 ? (var_1_17 == ((unsigned short int) var_1_4)) : (var_1_17 == ((unsigned short int) 0))) : (var_1_17 == ((unsigned short int) 64)))
;
}
int main(void) {
	isInitial = 1;
