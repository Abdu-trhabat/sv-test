...
void step(void) {
	// From: Req1Batch100Wrapper_P
	unsigned char stepLocal_0 = last_1_var_1_20;
	if (((*(var_1_2_Pointer)) >= (*(var_1_3_Pointer))) || stepLocal_0) {
		(*(var_1_1_Pointer)) = (min ((min ((*(var_1_5_Pointer)) , 32u)) , (((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))) - ((*(var_1_8_Pointer)) - (*(var_1_9_Pointer))))));
	} else {
		(*(var_1_1_Pointer)) = (*(var_1_9_Pointer));
	}


	// From: Req4Batch100Wrapper_P
	...
	// From: Req2Batch100Wrapper_P
	(*(var_1_10_Pointer)) = ((*(var_1_11_Pointer)) - (((*(var_1_12_Pointer)) - (*(var_1_13_Pointer))) + (min ((*(var_1_14_Pointer)) , (*(var_1_15_Pointer))))));


	// From: Req3Batch100Wrapper_P
	signed long int stepLocal_1 = (*(var_1_14_Pointer)) % (*(var_1_12_Pointer));
	if (stepLocal_1 <= (*(var_1_1_Pointer))) {
		(*(var_1_16_Pointer)) = (min ((max ((*(var_1_18_Pointer)) , 128)) , (*(var_1_19_Pointer))));
	}
}
...
int property(void) {
	return ((((((*(var_1_2_Pointer)) >= (*(var_1_3_Pointer))) || last_1_var_1_20) ? ((*(var_1_1_Pointer)) == ((unsigned long int) (min ((min ((*(var_1_5_Pointer)) , 32u)) , (((*(var_1_6_Pointer)) + (*(var_1_7_Pointer))) - ((*(var_1_8_Pointer)) - (*(var_1_9_Pointer)))))))) : ((*(var_1_1_Pointer)) == ((unsigned long int) (*(var_1_9_Pointer))))) && ((*(var_1_10_Pointer)) == ((signed short int) ((*(var_1_11_Pointer)) - (((*(var_1_12_Pointer)) - (*(var_1_13_Pointer))) + (min ((*(var_1_14_Pointer)) , (*(var_1_15_Pointer))))))))) && ((((*(var_1_14_Pointer)) % (*(var_1_12_Pointer))) <= (*(var_1_1_Pointer))) ? ((*(var_1_16_Pointer)) == ((unsigned char) (min ((max ((*(var_1_18_Pointer)) , 128)) , (*(var_1_19_Pointer)))))) : 1)) && (((*(var_1_13_Pointer)) < 1000) ? ((*(var_1_20_Pointer)) == ((unsigned char) ((*(var_1_21_Pointer)) && (((*(var_1_1_Pointer)) > 64u) || (*(var_1_22_Pointer)))))) : ((*(var_1_20_Pointer)) == ((unsigned char) (! ((*(var_1_23_Pointer)) || (*(var_1_24_Pointer)))))))
;
}
int main(void) {
	isInitial = 1;
