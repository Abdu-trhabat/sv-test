...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch2Amount10.c", 13, "reach_error"); }
...
int property(void) {
	return (((var_1_2 - (min (var_1_3 , var_1_4))) < var_1_9) ? (var_1_1 == ((unsigned char) ((max (var_1_6 , var_1_7)) + (var_1_8 + (2 + 4))))) : 1) && (var_1_9 == ((unsigned long int) var_1_6))
;
}
int main(void) {
	isInitial = 1;
