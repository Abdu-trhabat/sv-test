...
void step(void) {
	...
	// From: Req4Batch174Wrapper_S
	unsigned long int stepLocal_1 = WrapperStruct00.var_1_2;
	if (WrapperStruct00.var_1_7 >= stepLocal_1) {
		if (WrapperStruct00.var_1_6) {
			WrapperStruct00.var_1_13 = (min (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_15));
		}
	} else {
...
int property(void) {
	return (((WrapperStruct00.var_1_1 == ((unsigned long int) (WrapperStruct00.var_1_2 - (WrapperStruct00.var_1_3 - WrapperStruct00.var_1_4)))) && (((WrapperStruct00.var_1_4 < WrapperStruct00.var_1_2) || WrapperStruct00.var_1_6) ? (WrapperStruct00.var_1_5 == ((unsigned long int) ((max ((abs (WrapperStruct00.var_1_2)) , 3934615513u)) - WrapperStruct00.var_1_4))) : (WrapperStruct00.var_1_5 == ((unsigned long int) WrapperStruct00.var_1_7)))) && (((WrapperStruct00.var_1_5 > 1000000000u) || ((- 4.4f) >= WrapperStruct00.var_1_9)) ? (WrapperStruct00.var_1_8 == ((signed long int) (WrapperStruct00.var_1_4 - (WrapperStruct00.var_1_10 - (min (WrapperStruct00.var_1_11 , WrapperStruct00.var_1_12)))))) : (WrapperStruct00.var_1_6 ? (WrapperStruct00.var_1_8 == ((signed long int) WrapperStruct00.var_1_12)) : (WrapperStruct00.var_1_8 == ((signed long int) WrapperStruct00.var_1_11))))) && ((WrapperStruct00.var_1_7 >= WrapperStruct00.var_1_2) ? (WrapperStruct00.var_1_6 ? (WrapperStruct00.var_1_13 == ((signed short int) (min (WrapperStruct00.var_1_14 , WrapperStruct00.var_1_15)))) : 1) : (WrapperStruct00.var_1_13 == ((signed short int) (WrapperStruct00.var_1_16 + WrapperStruct00.var_1_17))))
;
}
int main(void) {
	isInitial = 1;
