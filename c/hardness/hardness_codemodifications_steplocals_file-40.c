...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch40stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch40stepLocals
	signed long int stepLocal_0 = (var_1_3 * var_1_2) / var_1_4;
	...
	// From: Req2Batch40stepLocals
	unsigned char stepLocal_1 = var_1_5 != var_1_4;
	if (stepLocal_1 || var_1_10) {
		var_1_9 = var_1_11;
	}


	// From: Req3Batch40stepLocals
	...
	// From: Req8Batch40stepLocals
	var_1_25 = var_1_20;


	// From: Req9Batch40stepLocals
	var_1_26 = var_1_6;
}
