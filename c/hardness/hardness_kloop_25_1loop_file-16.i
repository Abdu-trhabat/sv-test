...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch1625_1loop.c", 13, "reach_error"); }
...
void step(void) {
 var_1_8 = (4 - var_1_9);
 if ((var_1_8 % ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4)))) <= -1000000) {
...
int property(void) {
 return (((((var_1_8 % ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4)))) <= -1000000) ? (var_1_1 == ((unsigned char) (((var_1_4 * var_1_3) >= var_1_8) || var_1_5))) : 1) && ((var_1_8 <= (var_1_4 + var_1_3)) ? (var_1_6 == ((signed char) var_1_7)) : 1)) && (var_1_8 == ((signed short int) (4 - var_1_9)))) && (((var_1_9 / var_1_4) == var_1_6) ? (var_1_10 == ((signed char) var_1_7)) : ((var_1_7 >= var_1_8) ? (var_1_10 == ((signed char) (var_1_11 + (((((var_1_12 + var_1_13)) > (var_1_14)) ? ((var_1_12 + var_1_13)) : (var_1_14)))))) : (var_1_10 == ((signed char) var_1_12))))
;
}
int main(void) {
 isInitial = 1;
