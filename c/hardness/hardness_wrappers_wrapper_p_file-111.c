...
void step(void) {
	// From: Req1Batch111Wrapper_P
	unsigned char stepLocal_0 = (*(var_1_6_Pointer));
	if ((*(var_1_2_Pointer)) < (*(var_1_3_Pointer))) {
		(*(var_1_1_Pointer)) = (min (1.25 , (*(var_1_4_Pointer))));
	} else {
		if ((*(var_1_5_Pointer)) || stepLocal_0) {
			(*(var_1_1_Pointer)) = ((abs ((*(var_1_7_Pointer)))) + (*(var_1_8_Pointer)));
		}
	}


	// From: Req4Batch111Wrapper_P
	...
	// From: Req2Batch111Wrapper_P
	if ((*(var_1_7_Pointer)) != (max (((*(var_1_8_Pointer)) * (*(var_1_15_Pointer))) , (*(var_1_15_Pointer))))) {
