...
void step(void) {
	...
	if (-128 <= stepLocal_26) {
		var_1_72 = ((var_1_51 - var_1_64) + (min ((var_1_27 + var_1_37) , var_1_23)));
	} else {
	...
	if ((min ((var_1_11 * last_1_var_1_96) , last_1_var_1_99)) >= stepLocal_3) {
		if (! last_1_var_1_32) {
			if (-2 >= stepLocal_4) {
	...
	signed long int stepLocal_8 = min (last_1_var_1_95 , var_1_8);
	unsigned long int stepLocal_7 = min ((max (last_1_var_1_96 , var_1_28)) , last_1_var_1_78);
	...
	if (var_1_31) {
		var_1_34 = (min (var_1_28 , var_1_26));
	}


	// From: Req11Batch9Amount500
	if (var_1_24 <= ((64 - var_1_27) - (abs (var_1_25)))) {
		var_1_38 = (var_1_37 + var_1_23);
	} else {
		var_1_38 = (50 - (abs (var_1_27 - var_1_39)));
	}
	...
	if ((var_1_47 == var_1_48) || stepLocal_17) {
		var_1_53 = (abs (min (var_1_45 , (min (var_1_52 , var_1_48)))));
	}
	...
	var_1_61 = (var_1_60 + (min (var_1_28 , last_1_var_1_61)));


	// From: Req23Batch9Amount500
	var_1_70 = (var_1_45 + (abs (var_1_42)));
	...
	if (var_1_17) {
		var_1_74 = ((abs (var_1_64)) - (abs (var_1_27)));
	} else {
		if (var_1_39 >= (var_1_37 * var_1_51)) {
			var_1_74 = (var_1_27 + (max (var_1_24 , var_1_65)));
		}
	}
	...
	if (stepLocal_28 >= var_1_111) {
		...
		var_1_76 = (min ((max (var_1_27 , var_1_26)) , var_1_65));
	}


	// From: Req33Batch9Amount500
	signed long int stepLocal_35 = max (var_1_38 , var_1_28);
	signed char stepLocal_34 = var_1_74;
	if (5.375f > (var_1_42 * (min (var_1_43 , var_1_41)))) {
		if (var_1_24 == stepLocal_35) {
			...
			var_1_86 = ((25367 + (abs (var_1_88))) - var_1_51);
		}
	}
	...
	if (stepLocal_36 < var_1_20) {
		var_1_89 = ((min (64 , var_1_64)) - var_1_27);
	} else {
		if (var_1_32) {
			if (var_1_32) {
			...
			var_1_89 = ((min (var_1_28 , (abs (var_1_51)))) - var_1_64);
		}
	}
	...
	if ((var_1_43 - var_1_33) < var_1_101) {
		var_1_109 = (var_1_44 + ((min (9.5 , var_1_43)) - var_1_46));
	}
	...
	if (var_1_15) {
		...
		if (var_1_12 <= var_1_71) {
			if (var_1_108 <= ((3837604088u - var_1_19) - (min (var_1_11 , 2u)))) {
				var_1_18 = (min ((abs (64)) , var_1_9));
			} else {
				var_1_18 = (var_1_19 - (min (var_1_20 , var_1_21)));
			}
		} else {
			var_1_18 = (64 + var_1_8);
		}
	...
	signed long int stepLocal_5 = max (var_1_1 , (var_1_20 * var_1_102));
	if (var_1_11 < stepLocal_5) {
		if (var_1_14) {
			var_1_22 = ((max (var_1_23 , var_1_24)) + var_1_25);
		} else {
			var_1_22 = (((min (64 , var_1_26)) - (32 - var_1_27)) - var_1_28);
		}
	}
		...
		if (var_1_27 <= stepLocal_14) {
			...
			if (stepLocal_15 < (var_1_11 / var_1_26)) {
				if (var_1_15) {
					...
					var_1_49 = (((min (var_1_42 , var_1_52)) - var_1_44) + var_1_45);
				}
			}
		}
	} else {
	...
	if (! (var_1_47 <= var_1_45)) {
		if (var_1_33 > (var_1_43 - var_1_44)) {
			if (var_1_13 <= stepLocal_25) {
				var_1_66 = (((max (var_1_48 , var_1_68)) - var_1_46) - (var_1_69 - 5.5f));
			} else {
				var_1_66 = ((var_1_44 - var_1_46) + var_1_52);
			}
		} else {
			var_1_66 = ((min (var_1_68 , var_1_44)) - (var_1_69 - var_1_43));
		}
	}
	...
	if (var_1_106 != stepLocal_42) {
		...
		if (stepLocal_44 && var_1_82) {
			...
			var_1_97 = (min (var_1_63 , (max ((var_1_24 + var_1_27) , var_1_28))));
		}
	}
	...
	if (var_1_103 == var_1_1) {
		if ((var_1_103 > var_1_1) && var_1_32) {
			var_1_6 = (min (var_1_103 , 128));
		} else {
			var_1_6 = ((max (var_1_103 , var_1_8)) + var_1_9);
		}
	} else {
		var_1_6 = (var_1_103 + (max (var_1_9 , var_1_8)));
	}
	...
	if (stepLocal_20 <= var_1_108) {
		if (stepLocal_19 > var_1_23) {
			var_1_55 = (max (var_1_43 , var_1_44));
		}
	}
	...
	if ((var_1_46 / var_1_4) < var_1_55) {
		...
		if (var_1_31 || var_1_82) {
			if (! var_1_15) {
				...
				var_1_75 = (min (((var_1_27 + var_1_65) - var_1_63) , -10));
			}
		} else {
			var_1_75 = (abs (var_1_26));
		}
	}
	...
	unsigned long int stepLocal_11 = min (var_1_39 , (var_1_106 | var_1_108));
		...
		if (stepLocal_9 < var_1_21) {
			if (stepLocal_13 >= var_1_38) {
				if (var_1_99 < stepLocal_12) {
					var_1_40 = ((var_1_42 - (max (var_1_43 , var_1_44))) + (abs (var_1_45 - var_1_46)));
				} else {
					var_1_40 = ((max ((min (var_1_44 , var_1_43)) , var_1_46)) + var_1_42);
				}
			} else {
				var_1_40 = (max (var_1_45 , (var_1_46 - (3.5 + var_1_44))));
			}
		} else {
			if ((44452 - (var_1_111 + var_1_26)) <= stepLocal_10) {
				var_1_40 = ((max (var_1_42 , (min (var_1_45 , var_1_46)))) + var_1_44);
			}
		}
	}
	...
	if (((min (var_1_33 , var_1_109)) / (max (var_1_4 , var_1_36))) < var_1_55) {
		var_1_35 = var_1_27;
	} else {
		if (var_1_16) {
			var_1_35 = (max (var_1_28 , (var_1_37 - var_1_26)));
		}
	}


	// From: Req16Batch9Amount500
	unsigned long int stepLocal_18 = min (var_1_99 , var_1_26);
	...
	if (var_1_27 > stepLocal_32) {
		if (stepLocal_31 || (var_1_49 <= var_1_109)) {
			...
			var_1_80 = (min ((var_1_59 - (var_1_77 + var_1_58)) , (max ((var_1_63 + last_1_var_1_80) , (var_1_111 - var_1_61)))));
		}
	} else {
		if (stepLocal_30 && (var_1_99 != (var_1_79 >> 5))) {
			if (var_1_15) {
				var_1_80 = (min ((var_1_28 - var_1_27) , (abs (var_1_81))));
			} else {
				var_1_80 = (var_1_22 + var_1_23);
			}
		} else {
			var_1_80 = (abs (max (-8 , var_1_25)));
		}
	}
	...
	if (var_1_43 <= var_1_109) {
		if (stepLocal_23 < (var_1_39 - (max (var_1_11 , var_1_12)))) {
			var_1_56 = var_1_51;
		} else {
			var_1_56 = ((max ((max (128 , var_1_37)) , var_1_57)) - var_1_58);
		}
	} else {
		if (var_1_40 < var_1_100) {
			...
			if (var_1_8 < stepLocal_22) {
				...
				if (stepLocal_21 == var_1_23) {
					...
					var_1_56 = (var_1_57 - ((min (100 , var_1_59)) - var_1_27));
				}
			}
		}
	}
	...
	if ((abs (var_1_40 + var_1_4)) >= ((- var_1_91) + var_1_52)) {
		if (var_1_32 || stepLocal_24) {
			var_1_62 = ((var_1_26 - var_1_51) - ((min (var_1_63 , var_1_64)) - var_1_65));
		}
	}
	...
	if (var_1_29 || stepLocal_37) {
		if (stepLocal_38 >= var_1_8) {
			...
			if (var_1_38 != stepLocal_39) {
				var_1_94 = ((abs (var_1_37)) - var_1_51);
			} else {
				var_1_94 = var_1_65;
			}
		}
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((((((((((((- last_1_var_1_100) >= (last_1_var_1_100 / var_1_4)) ? (last_1_var_1_32 ? (var_1_1 == ((signed long int) 10)) : 1) : 1) && ((var_1_103 == var_1_1) ? (((var_1_103 > var_1_1) && var_1_32) ? (var_1_6 == ((signed long int) (min (var_1_103 , 128)))) : (var_1_6 == ((signed long int) ((max (var_1_103 , var_1_8)) + var_1_9)))) : (var_1_6 == ((signed long int) (var_1_103 + (max (var_1_9 , var_1_8))))))) && ((var_1_1 <= var_1_8) ? ((var_1_1 >= var_1_8) ? (((var_1_1 * (var_1_9 + var_1_1)) > -8) ? (var_1_10 == ((unsigned long int) ((min (var_1_11 , var_1_12)) + var_1_13))) : (var_1_10 == ((unsigned long int) (var_1_11 + 32u)))) : (var_1_10 == ((unsigned long int) var_1_12))) : (var_1_10 == ((unsigned long int) var_1_12)))) && (((min ((var_1_11 * last_1_var_1_96) , last_1_var_1_99)) >= var_1_12) ? ((! last_1_var_1_32) ? ((-2 >= var_1_13) ? (var_1_14 == ((unsigned char) ((var_1_15 && var_1_16) && var_1_17))) : 1) : (var_1_14 == ((unsigned char) (! var_1_17)))) : 1)) && (var_1_15 ? (var_1_18 == ((signed long int) -10000000)) : ((var_1_12 <= var_1_71) ? ((var_1_108 <= ((3837604088u - var_1_19) - (min (var_1_11 , 2u)))) ? (var_1_18 == ((signed long int) (min ((abs (64)) , var_1_9)))) : (var_1_18 == ((signed long int) (var_1_19 - (min (var_1_20 , var_1_21)))))) : (var_1_18 == ((signed long int) (64 + var_1_8)))))) && ((var_1_11 < (max (var_1_1 , (var_1_20 * var_1_102)))) ? (var_1_14 ? (var_1_22 == ((signed char) ((max (var_1_23 , var_1_24)) + var_1_25))) : (var_1_22 == ((signed char) (((min (64 , var_1_26)) - (32 - var_1_27)) - var_1_28)))) : 1)) && (((var_1_10 * var_1_96) < (~ var_1_78)) ? (var_1_29 == ((unsigned char) (var_1_16 && var_1_31))) : 1)) && ((last_1_var_1_78 >= (min ((max (last_1_var_1_96 , var_1_28)) , last_1_var_1_78))) ? (var_1_32 == ((unsigned char) ((! var_1_31) && var_1_15))) : ((last_1_var_1_70 <= ((5.5 - var_1_33) + var_1_4)) ? ((var_1_23 <= (min (last_1_var_1_95 , var_1_8))) ? (var_1_32 == ((unsigned char) (! var_1_31))) : (var_1_32 == ((unsigned char) (last_1_var_1_14 && var_1_31)))) : (var_1_32 == ((unsigned char) var_1_31))))) && (var_1_31 ? (var_1_34 == ((unsigned short int) (min (var_1_28 , var_1_26)))) : 1)) && ((((min (var_1_33 , var_1_109)) / (max (var_1_4 , var_1_36))) < var_1_55) ? (var_1_35 == ((unsigned char) var_1_27)) : (var_1_16 ? (var_1_35 == ((unsigned char) (max (var_1_28 , (var_1_37 - var_1_26))))) : 1))) && ((var_1_24 <= ((64 - var_1_27) - (abs (var_1_25)))) ? (var_1_38 == ((signed long int) (var_1_37 + var_1_23))) : (var_1_38 == ((signed long int) (50 - (abs (var_1_27 - var_1_39))))))) && ((var_1_102 <= (min (var_1_39 , (var_1_106 | var_1_108)))) ? (var_1_40 == ((double) var_1_41)) : ((var_1_102 < var_1_21) ? ((var_1_9 >= var_1_38) ? ((var_1_99 < (var_1_38 & var_1_108)) ? (var_1_40 == ((double) ((var_1_42 - (max (var_1_43 , var_1_44))) + (abs (var_1_45 - var_1_46))))) : (var_1_40 == ((double) ((max ((min (var_1_44 , var_1_43)) , var_1_46)) + var_1_42)))) : (var_1_40 == ((double) (max (var_1_45 , (var_1_46 - (3.5 + var_1_44))))))) : (((44452 - (var_1_111 + var_1_26)) <= var_1_108) ? (var_1_40 == ((double) ((max (var_1_42 , (min (var_1_45 , var_1_46)))) + var_1_44))) : 1)))) && (var_1_15 ? (var_1_47 == ((float) (var_1_46 - ((var_1_48 - 63.3f) - var_1_43)))) : ((var_1_42 > var_1_36) ? (var_1_47 == ((float) var_1_46)) : 1))) && (var_1_82 ? ((var_1_27 <= var_1_71) ? ((var_1_106 >= (var_1_39 >> var_1_51)) ? (var_1_49 == ((double) (var_1_44 - var_1_45))) : 1) : ((var_1_20 < (var_1_11 / var_1_26)) ? (var_1_15 ? (var_1_49 == ((double) var_1_45)) : (var_1_49 == ((double) (((min (var_1_42 , var_1_52)) - var_1_44) + var_1_45)))) : 1)) : (var_1_49 == ((double) (var_1_45 + var_1_44))))) && (((var_1_47 == var_1_48) || var_1_16) ? (var_1_53 == ((float) (abs (min (var_1_45 , (min (var_1_52 , var_1_48))))))) : 1)) && (((var_1_37 * var_1_39) >= (min (var_1_99 , var_1_26))) ? (var_1_54 == ((unsigned short int) var_1_37)) : (var_1_54 == ((unsigned short int) var_1_26)))) && ((var_1_6 <= var_1_108) ? (((var_1_72 + var_1_71) > var_1_23) ? (var_1_55 == ((double) (max (var_1_43 , var_1_44)))) : 1) : 1)) && ((var_1_43 <= var_1_109) ? (((var_1_37 / var_1_26) < (var_1_39 - (max (var_1_11 , var_1_12)))) ? (var_1_56 == ((unsigned char) var_1_51)) : (var_1_56 == ((unsigned char) ((max ((max (128 , var_1_37)) , var_1_57)) - var_1_58)))) : ((var_1_40 < var_1_100) ? (var_1_56 == ((unsigned char) var_1_57)) : ((var_1_8 < (var_1_72 % var_1_57)) ? (var_1_56 == ((unsigned char) (var_1_57 - var_1_27))) : (((var_1_38 + var_1_111) == var_1_23) ? (var_1_56 == ((unsigned char) var_1_51)) : (var_1_56 == ((unsigned char) (var_1_57 - ((min (100 , var_1_59)) - var_1_27))))))))) && (var_1_60 == ((unsigned char) var_1_28))) && (var_1_61 == ((unsigned short int) (var_1_60 + (min (var_1_28 , last_1_var_1_61)))))) && (((abs (var_1_40 + var_1_4)) >= ((- var_1_91) + var_1_52)) ? ((var_1_32 || var_1_29) ? (var_1_62 == ((signed char) ((var_1_26 - var_1_51) - ((min (var_1_63 , var_1_64)) - var_1_65)))) : 1) : 1)) && ((! (var_1_47 <= var_1_45)) ? ((var_1_33 > (var_1_43 - var_1_44)) ? ((var_1_13 <= var_1_108) ? (var_1_66 == ((float) (((max (var_1_48 , var_1_68)) - var_1_46) - (var_1_69 - 5.5f)))) : (var_1_66 == ((float) ((var_1_44 - var_1_46) + var_1_52)))) : (var_1_66 == ((float) ((min (var_1_68 , var_1_44)) - (var_1_69 - var_1_43))))) : 1)) && (var_1_70 == ((double) (var_1_45 + (abs (var_1_42)))))) && (((~ var_1_39) == 2) ? (var_1_71 == ((signed long int) (var_1_58 + var_1_65))) : 1)) && ((-128 <= ((var_1_13 - var_1_51) * last_1_var_1_56)) ? (var_1_72 == ((signed short int) ((var_1_51 - var_1_64) + (min ((var_1_27 + var_1_37) , var_1_23))))) : (((var_1_26 - var_1_58) == last_1_var_1_95) ? (var_1_72 == ((signed short int) last_1_var_1_61)) : 1))) && (var_1_17 ? (var_1_74 == ((signed char) ((abs (var_1_64)) - (abs (var_1_27))))) : ((var_1_39 >= (var_1_37 * var_1_51)) ? (var_1_74 == ((signed char) (var_1_27 + (max (var_1_24 , var_1_65))))) : 1))) && (((var_1_46 / var_1_4) < var_1_55) ? (var_1_75 == ((signed char) (var_1_25 + (var_1_27 + var_1_51)))) : ((var_1_31 || var_1_82) ? ((! var_1_15) ? (var_1_75 == ((signed char) (var_1_63 - var_1_64))) : (var_1_75 == ((signed char) (min (((var_1_27 + var_1_65) - var_1_63) , -10))))) : (var_1_75 == ((signed char) (abs (var_1_26))))))) && ((var_1_64 >= var_1_111) ? (var_1_76 == ((unsigned char) (var_1_64 + var_1_77))) : (var_1_76 == ((unsigned char) (min ((max (var_1_27 , var_1_26)) , var_1_65)))))) && ((var_1_108 <= var_1_99) ? (var_1_16 ? (var_1_78 == ((unsigned long int) (2866053433u - (var_1_83 + var_1_64)))) : 1) : (var_1_78 == ((unsigned long int) (10u + (1091135251u - (var_1_79 - var_1_64))))))) && ((var_1_27 > (var_1_58 << var_1_9)) ? ((var_1_15 || (var_1_49 <= var_1_109)) ? (var_1_80 == ((signed short int) var_1_58)) : (var_1_80 == ((signed short int) (min ((var_1_59 - (var_1_77 + var_1_58)) , (max ((var_1_63 + last_1_var_1_80) , (var_1_111 - var_1_61)))))))) : (((-1 >= var_1_6) && (var_1_99 != (var_1_79 >> 5))) ? (var_1_15 ? (var_1_80 == ((signed short int) (min ((var_1_28 - var_1_27) , (abs (var_1_81)))))) : (var_1_80 == ((signed short int) (var_1_22 + var_1_23)))) : (var_1_80 == ((signed short int) (abs (max (-8 , var_1_25)))))))) && (last_1_var_1_82 ? (var_1_82 == ((unsigned char) (var_1_31 || (var_1_14 && (! var_1_16))))) : 1)) && ((var_1_82 && (var_1_10 < var_1_19)) ? (var_1_83 == ((signed short int) ((var_1_63 - var_1_56) + var_1_23))) : ((! (var_1_51 <= var_1_19)) ? (var_1_83 == ((signed short int) (var_1_51 - (var_1_85 - var_1_28)))) : (var_1_83 == ((signed short int) (var_1_58 - var_1_26)))))) && ((5.375f > (var_1_42 * (min (var_1_43 , var_1_41)))) ? ((var_1_24 == (max (var_1_38 , var_1_28))) ? ((var_1_64 != var_1_74) ? (var_1_86 == ((unsigned short int) (var_1_27 + var_1_10))) : (var_1_86 == ((unsigned short int) (abs (var_1_57))))) : (var_1_86 == ((unsigned short int) ((25367 + (abs (var_1_88))) - var_1_51)))) : 1)) && ((var_1_1 < var_1_20) ? (var_1_89 == ((signed char) ((min (64 , var_1_64)) - var_1_27))) : (var_1_32 ? (var_1_32 ? (var_1_89 == ((signed char) (var_1_65 - var_1_26))) : (var_1_89 == ((signed char) var_1_26))) : (var_1_89 == ((signed char) ((min (var_1_28 , (abs (var_1_51)))) - var_1_64)))))) && (var_1_91 == ((float) ((var_1_43 - (var_1_92 + var_1_93)) + var_1_45)))) && ((var_1_29 || var_1_15) ? ((var_1_80 >= var_1_8) ? (var_1_94 == ((unsigned char) (var_1_37 - var_1_27))) : ((var_1_38 != var_1_25) ? (var_1_94 == ((unsigned char) ((abs (var_1_37)) - var_1_51))) : (var_1_94 == ((unsigned char) var_1_65)))) : 1)) && (((~ (var_1_63 / var_1_64)) > var_1_37) ? (var_1_95 == ((signed long int) ((-64 + (max (var_1_26 , -64))) + -2))) : 1)) && ((var_1_28 != (var_1_65 + var_1_88)) ? (var_1_96 == ((unsigned long int) ((var_1_77 + var_1_71) + var_1_27))) : 1)) && ((var_1_106 != var_1_72) ? ((var_1_103 == var_1_21) ? (var_1_97 == ((signed char) (var_1_26 - (var_1_27 + var_1_51)))) : (var_1_97 == ((signed char) (var_1_51 - 100)))) : ((var_1_32 && var_1_82) ? (var_1_82 ? ((var_1_20 >= var_1_108) ? (var_1_97 == ((signed char) var_1_63)) : 1) : 1) : (var_1_97 == ((signed char) (min (var_1_63 , (max ((var_1_24 + var_1_27) , var_1_28))))))))) && ((var_1_96 < var_1_6) ? (var_1_99 == ((unsigned long int) var_1_77)) : 1)) && (var_1_82 ? (var_1_100 == ((double) var_1_93)) : (var_1_100 == ((double) var_1_101)))) && (var_1_102 == ((signed long int) 256))) && (var_1_14 ? (var_1_103 == ((signed short int) var_1_72)) : (var_1_103 == ((signed short int) var_1_81)))) && (var_1_82 ? (var_1_104 == ((unsigned char) var_1_63)) : 1)) && (var_1_82 ? (var_1_105 == ((unsigned char) var_1_58)) : (var_1_105 == ((unsigned char) var_1_64)))) && (var_1_32 ? (var_1_106 == ((unsigned long int) last_1_var_1_106)) : 1)) && (var_1_15 ? (var_1_107 == ((float) var_1_68)) : (var_1_107 == ((float) var_1_44)))) && (var_1_16 ? (var_1_108 == ((unsigned long int) var_1_26)) : (var_1_108 == ((unsigned long int) var_1_95)))) && (((var_1_43 - var_1_33) < var_1_101) ? (var_1_109 == ((double) (var_1_44 + ((min (9.5 , var_1_43)) - var_1_46)))) : 1)) && (var_1_110 == ((unsigned char) var_1_51))) && (var_1_111 == ((unsigned long int) var_1_1))) && (var_1_112 == ((signed char) var_1_63))
;
}
int main(void) {
	isInitial = 1;
