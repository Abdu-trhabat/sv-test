...
void step(void) {
	...
	if ((*(WrapperStruct00_var_1_23_Pointer)) < (max ((*(WrapperStruct00_var_1_20_Pointer)) , (*(WrapperStruct00_var_1_23_Pointer))))) {
