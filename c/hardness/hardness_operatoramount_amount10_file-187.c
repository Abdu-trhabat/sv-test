...
void step(void) {
	// From: Req1Batch187Amount10
	signed long int stepLocal_1 = min (var_1_2 , var_1_3);
...
int property(void) {
	return (((min (var_1_2 , var_1_3)) < var_1_4) ? (var_1_1 == ((double) (var_1_5 - 15.5))) : ((var_1_3 <= var_1_4) ? (var_1_1 == ((double) (var_1_6 + 127.25))) : 1)) && (var_1_7 == ((unsigned char) var_1_8))
;
}
int main(void) {
	isInitial = 1;
