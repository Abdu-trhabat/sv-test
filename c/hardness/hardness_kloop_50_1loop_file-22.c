...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch2250_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch2250_1loop
	if ((- 3.75) < (min (var_1_20 , var_1_22))) {
		var_1_27 = 0;
	}


	// From: Req1Batch2250_1loop
	if (var_1_2 < var_1_3) {
	...
	// From: Req3Batch2250_1loop
	unsigned char stepLocal_0 = var_1_4 <= var_1_9;
	if (stepLocal_0 || var_1_27) {
