...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch151Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject3
	/* 241L, 55L) */ if (var_1_2) {
		/* 243L, 49L) */ if (/* 244L, 26L, 27L) */ ((var_1_7) != (var_1_1))) {
			/* 247L, 47L) */ if (var_1_3) {
				/* 249L, 46L) */ var_1_32 = (
					/* 252L, 45L) */ (max (
						/* 252L, 45L) */ (
	...
	// From: CodeObject5
	/* 269L, 119L) */ if (/* 270L, 75L, 76L) */ ((/* 271L, 73L, 77L) */ ((/* 272L, 71L, 78L) */ ((var_1_26) >> (var_1_40))) + (var_1_7))) <= (var_1_1))) {
	...
	/* 299L, 168L) */ if (var_1_3) {
		/* 301L, 166L) */ if (/* 302L, 132L, 133L) */ ((var_1_43) < (/* 304L, 131L, 135L) */ ((var_1_6) | (/* 306L, 130L, 137L) */ ((var_1_5) ^ (var_1_40))))))) {
			/* 309L, 150L) */ var_1_44 = (
				var_1_26
			);
		} else {
