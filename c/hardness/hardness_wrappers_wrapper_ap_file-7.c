...
void step(void) {
	...
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		if (stepLocal_1 || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) {
			...
			(*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = (abs ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) - ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) + (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)))));
		}
	} else {
		(*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer)) = (max ((*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer))));
	}


	// From: Req1Batch7Wrapper_AP
