...
void step(void) {
	// From: Req1Batch172dependencies
	if ((last_1_var_1_6 >= (abs (var_1_3))) || var_1_4) {
		var_1_1 = var_1_5;
	}


	// From: Req2Batch172dependencies
	if (var_1_1 > var_1_5) {
		var_1_6 = var_1_7;
	}


	// From: Req3Batch172dependencies
	if (var_1_4 && var_1_9) {
	...
	// From: Req8Batch172dependencies
	var_1_24 = var_1_16;


	// From: Req4Batch172dependencies
	if (var_1_21 != var_1_5) {
		var_1_11 = (max ((var_1_12 - var_1_13) , var_1_7));
	}


	// From: Req5Batch172dependencies
	if (var_1_11 > (var_1_13 >> (var_1_15 + var_1_16))) {
		var_1_14 = (abs (var_1_17 + var_1_18));
	}


	// From: Req6Batch172dependencies
