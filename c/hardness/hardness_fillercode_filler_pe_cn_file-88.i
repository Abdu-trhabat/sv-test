...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch88Filler_PE_CN.c", 13, "reach_error"); }
 ...
 signed long int stepLocal_0 = (- (var_1_18));
   ...
   var_1_11
             ...
             if ( ((var_1_27) && (var_1_28))) {
              if ( (( ((256) % (var_1_29))) >= ( (((((var_1_25)) < ((var_1_26))) ? ((var_1_25)) : ((var_1_26))))))) {
               var_1_23 = (
    var_1_30
   );
  } else {
  ...
  var_1_33
             ...
             if ( (! (var_1_27))) {
              var_1_34 = (
               ((((( var_1_25 )) > (( ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))) ))) ? (( var_1_25 )) : (( ((((var_1_24) < 0 ) ? -(var_1_24) : (var_1_24))) ))))
  );
 } else {
              if ( ((var_1_33) < ( ((var_1_26) / (64))))) {
               if ( (( (- (var_1_35))) > (var_1_36))) {
                var_1_34 = (
                 ((((( ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) )) > (( var_1_32 ))) ? (( ((((var_1_25) < 0 ) ? -(var_1_25) : (var_1_25))) )) : (( var_1_32 ))))
    );
   } else {
       ...
       var_1_24
               ...
               if (var_1_28) {
                var_1_34 = (
                 ((((( (( var_1_24 ) + ( var_1_31 )) )) > (( var_1_32 ))) ? (( (( var_1_24 ) + ( var_1_31 )) )) : (( var_1_32 ))))
    );
   }
  }
 }
