...
void functionized3(signed char functionized3_localFunctionVar0, double functionized3_localFunctionVar1, double functionized3_localFunctionVar2, float functionized3_localFunctionVar3) {
	if (((abs (functionized3_localFunctionVar1)) - functionized3_localFunctionVar3) == (var_1_3 + functionized3_localFunctionVar2)) {
...
void step(void) {
	...
	// From: Req3Batch72functionizing
	functionized4(var_1_18);


	// From: Req4Batch72functionizing
	if (! var_1_18) {
		var_1_20 = functionized5();
	}


	// From: Req5Batch72functionizing
	functionized6(var_1_5, var_1_24, var_1_4, var_1_25);


	// From: Req6Batch72functionizing
	if (256 >= var_1_7) {
	...
	// From: Req7Batch72functionizing
	functionized8(var_1_30);


	// From: Req8Batch72functionizing
	functionized9();
}
