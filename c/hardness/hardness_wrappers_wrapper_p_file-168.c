...
void step(void) {
	...
	if (stepLocal_1 >= (*(var_1_6_Pointer))) {
		if (stepLocal_2 < ((*(var_1_2_Pointer)) - (*(var_1_7_Pointer)))) {
			(*(var_1_5_Pointer)) = ((max ((*(var_1_8_Pointer)) , ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))))) - (*(var_1_11_Pointer)));
		}
	} else {
