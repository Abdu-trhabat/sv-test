...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch150no_floats.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((var_1_2 * ((((var_1_4) < (var_1_3)) ? (var_1_4) : (var_1_3)))) <= stepLocal_0) {
  if (stepLocal_1 >= ((((var_1_8) > (var_1_2)) ? (var_1_8) : (var_1_2)))) {
 ...
 if (var_1_9) {
  if (var_1_1 || stepLocal_2) {
   var_1_10 = (((((var_1_12 + (-5 + var_1_13))) < (-4)) ? ((var_1_12 + (-5 + var_1_13))) : (-4)));
  } else {
   var_1_10 = var_1_12;
  }
 } else {
...
int property(void) {
 return (((((var_1_2 * ((((var_1_4) < (var_1_3)) ? (var_1_4) : (var_1_3)))) <= ((var_1_5 % var_1_6) + var_1_7)) ? ((var_1_6 >= ((((var_1_8) > (var_1_2)) ? (var_1_8) : (var_1_2)))) ? (var_1_1 == ((unsigned char) (((var_1_5 % var_1_6) >= (-4 + var_1_2)) && var_1_9))) : (var_1_1 == ((unsigned char) 1))) : (var_1_1 == ((unsigned char) var_1_9))) && (var_1_9 ? ((var_1_1 || var_1_11) ? (var_1_10 == ((signed char) (((((var_1_12 + (-5 + var_1_13))) < (-4)) ? ((var_1_12 + (-5 + var_1_13))) : (-4))))) : (var_1_10 == ((signed char) var_1_12))) : (var_1_10 == ((signed char) var_1_13)))) && (var_1_14 == ((signed short int) var_1_12))) && ((var_1_8 < (var_1_4 * -8)) ? (var_1_15 == ((signed short int) 2)) : 1)
;
}
int main(void) {
 isInitial = 1;
