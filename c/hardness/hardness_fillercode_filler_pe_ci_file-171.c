...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch171Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 256L, 72L) */ if (/* 257L, 35L, 36L) */ ((/* 258L, 33L, 37L) */ ((/* 259L, 31L, 38L) */ (abs (var_1_10))) - (var_1_31))) > (var_1_10))) {
		/* 263L, 53L) */ var_1_30 = (
			/* 266L, 52L) */ ((
				var_1_33
			) + (
	...
	// From: CodeObject3
	/* 278L, 106L) */ if (var_1_18) {
		/* 280L, 104L) */ if (/* 281L, 85L, 86L) */ ((/* 282L, 83L, 87L) */ (max (/* 282L, 83L, 87L) */ (/* 283L, 81L, 88L) */ ((var_1_10) * (var_1_33))) , (var_1_34)))) < (var_1_31))) {
			/* 288L, 103L) */ var_1_35 = (
				var_1_27
			);
		}
	...
	// From: CodeObject4
	/* 294L, 155L) */ if (/* 295L, 114L, 115L) */ ((var_1_31) >= (/* 297L, 113L, 117L) */ ((var_1_9) * (var_1_10))))) {
		/* 300L, 149L) */ if (/* 301L, 129L, 130L) */ ((/* 302L, 127L, 131L) */ ((var_1_31) > (var_1_9))) || (var_1_16))) {
			/* 306L, 148L) */ var_1_37 = (
				/* 309L, 147L) */ (abs (
					/* 310L, 146L) */ ((
						/* 311L, 144L) */ ((
	...
	/* 319L, 223L) */ if (var_1_16) {
		/* 321L, 217L) */ if (/* 322L, 168L, 169L) */ ((var_1_10) < (10.4f))) {
			...
			/* 338L, 215L) */ if (/* 339L, 198L, 199L) */ ((var_1_10) != (/* 341L, 197L, 201L) */ (abs (var_1_39))))) {
				/* 343L, 210L) */ var_1_41 = (
					var_1_29
				);
			} else {
