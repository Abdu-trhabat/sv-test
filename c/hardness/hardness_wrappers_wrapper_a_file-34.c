...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch34Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch34Wrapper_A
	if (BOOL_unsigned_char_Array_0[0][2] || (256 >= (signed_long_int_Array_0[0] + 4))) {
	...
	if (stepLocal_0 >= signed_long_int_Array_0[0]) {
		if (((unsigned_char_Array_0[2] + unsigned_char_Array_0[0]) - (min (unsigned_char_Array_0[1] , 1))) > stepLocal_1) {
	...
	// From: Req1Batch34Wrapper_A
	if (BOOL_unsigned_char_Array_0[1][1]) {
		if (BOOL_unsigned_char_Array_0[1][1]) {
			double_Array_0[1] = (abs (double_Array_0[0]));
		}
	}


	// From: Req4Batch34Wrapper_A
...
int property(void) {
	return (((BOOL_unsigned_char_Array_0[1][1] ? (BOOL_unsigned_char_Array_0[1][1] ? (double_Array_0[1] == ((double) (abs (double_Array_0[0])))) : 1) : 1) && ((BOOL_unsigned_char_Array_0[0][2] || (256 >= (signed_long_int_Array_0[0] + 4))) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) ((BOOL_unsigned_char_Array_0[1][2] || BOOL_unsigned_char_Array_0[0][2]) || BOOL_unsigned_char_Array_0[0][1]))) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) (! (! (BOOL_unsigned_char_Array_0[1][0] || BOOL_unsigned_char_Array_0[0][0]))))))) && ((-10 >= signed_long_int_Array_0[0]) ? ((((unsigned_char_Array_0[2] + unsigned_char_Array_0[0]) - (min (unsigned_char_Array_0[1] , 1))) > (~ signed_long_int_Array_0[0])) ? (signed_char_Array_0[0] == ((signed char) (signed_char_Array_0[3] + signed_char_Array_0[4]))) : (signed_char_Array_0[0] == ((signed char) signed_char_Array_0[1]))) : 1)) && ((double_Array_0[1] >= (- (double_Array_0[0] * double_Array_0[1]))) ? (signed_char_Array_0[2] == ((signed char) signed_char_Array_0[4])) : 1)
;
}
int main(void) {
	isInitial = 1;
