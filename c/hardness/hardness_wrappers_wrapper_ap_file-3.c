...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch3Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (stepLocal_2 <= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer))) {
		if ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) >= stepLocal_1) {
			...
			(*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)) = ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var4_Pointer)) || (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))));
		}
	}
	...
	if (! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) = ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)));
	} else {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) = (((abs ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer))) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)));
	}
}
