...
void step(void) {
 ...
 if (var_1_2 >= var_1_1) {
  if (((((var_1_10 + -8) < 0 ) ? -(var_1_10 + -8) : (var_1_10 + -8))) < var_1_10) {
   if (var_1_9) {
    var_1_6 = var_1_1;
   } else {
    var_1_6 = var_1_3;
