...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch113100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch113100_while
	if ((var_1_15 | var_1_7) < var_1_3) {
		var_1_19 = 1;
	}


	// From: Req7Batch113100_while
	...
	// From: Req8Batch113100_while
	var_1_31 = (abs (var_1_24));


	// From: Req10Batch113100_while
	...
	// From: Req11Batch113100_while
	var_1_38 = (max ((var_1_17 + var_1_18) , var_1_28));


	// From: Req12Batch113100_while
	...
	// From: Req13Batch113100_while
	var_1_41 = var_1_28;


	// From: Req9Batch113100_while
	if (var_1_23 < (- var_1_31)) {
		var_1_32 = var_1_3;
	} else {
