...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch166dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch166dependencies
	if (var_1_2 != var_1_6) {
		var_1_8 = (var_1_10 - (var_1_11 + var_1_12));
	}


	// From: Req4Batch166dependencies
	if (var_1_8 > var_1_11) {
		var_1_20 = (min ((abs (63.5f)) , var_1_15));
	}


	// From: Req6Batch166dependencies
	if (var_1_1) {
