...
void step(void) {
	...
	// From: Req3Batch199normal
	if (var_1_11 != var_1_4) {
		if ((var_1_9 * var_1_5) != 5) {
			var_1_12 = var_1_13;
		}
	}


	// From: Req4Batch199normal
	if (var_1_11 < var_1_3) {
	...
	// From: Req6Batch199normal
	var_1_21 = var_1_20;


	// From: Req7Batch199normal
	var_1_22 = var_1_20;
}
