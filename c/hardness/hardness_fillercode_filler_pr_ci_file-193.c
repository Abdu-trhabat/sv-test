...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch193Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject2
	/* 266L, 35L) */ if (/* 267L, 16L, 17L) */ ((/* 268L, 14L, 18L) */ ((/* 269L, 12L, 19L) */ ((var_1_32) - (var_1_33))) ^ (var_1_16))) < (var_1_3))) {
		/* 274L, 34L) */ var_1_31 = (
			var_1_10
		);
	}
	...
	/* 368L, 114L) */ if (/* 369L, 41L, 42L) */ ((var_1_30) > (var_1_29))) {
		...
		/* 377L, 112L) */ if (/* 378L, 59L, 60L) */ ((var_1_20) || (/* 380L, 58L, 62L) */ ((var_1_15) > (/* 382L, 57L, 64L) */ ((var_1_16) + (var_1_32))))))) {
			/* 385L, 83L) */ var_1_36 = (
				/* 388L, 82L) */ ((
					/* 389L, 78L) */ (abs (
						/* 390L, 77L) */ (abs (
	...
	/* 429L, 148L) */ if (/* 430L, 122L, 123L) */ ((var_1_29) <= (/* 432L, 121L, 125L) */ ((var_1_30) * (var_1_31))))) {
		/* 435L, 146L) */ if (/* 436L, 135L, 136L) */ ((var_1_15) < (var_1_19))) {
			/* 439L, 145L) */ var_1_38 = (
				var_1_39
			);
		}
