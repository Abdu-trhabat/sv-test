...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch87stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch87stepLocals
	if (var_1_3 < var_1_5) {
		var_1_21 = var_1_14;
	}


	// From: Req5Batch87stepLocals
...
int property(void) {
	return (((((((var_1_2 - var_1_3) >= (var_1_5 - (min (var_1_6 , var_1_7)))) ? (var_1_1 == ((unsigned char) (((var_1_4 || var_1_8) && var_1_9) || var_1_10))) : 1) && (var_1_11 == ((double) (max ((max (var_1_12 , var_1_13)) , (var_1_14 - (5.86478081602821E18 - var_1_15))))))) && (((var_1_3 % var_1_17) >= var_1_2) ? (var_1_16 == ((signed long int) ((var_1_17 + var_1_18) + (var_1_19 - var_1_20)))) : (var_1_4 ? (var_1_16 == ((signed long int) var_1_17)) : (var_1_16 == ((signed long int) var_1_19))))) && ((var_1_3 < var_1_5) ? (var_1_21 == ((float) var_1_14)) : 1)) && ((var_1_21 <= var_1_15) ? (var_1_22 == ((double) (max (var_1_13 , 255.75)))) : ((var_1_19 > var_1_17) ? (var_1_4 ? (var_1_22 == ((double) var_1_15)) : (var_1_22 == ((double) var_1_14))) : (var_1_22 == ((double) var_1_12))))) && ((((64 + var_1_19) - var_1_24) <= -128) ? (var_1_23 == ((double) (min (var_1_14 , (abs (var_1_12)))))) : (((var_1_18 / var_1_17) <= (~ var_1_6)) ? (var_1_23 == ((double) var_1_13)) : (var_1_23 == ((double) 0.725))))
;
}
int main(void) {
	isInitial = 1;
