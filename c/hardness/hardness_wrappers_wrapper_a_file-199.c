...
void step(void) {
	// From: Req1Batch199Wrapper_A
	if (float_Array_0[9] >= float_Array_0[8]) {
		if (float_Array_0[8] == float_Array_0[9]) {
			if (float_Array_0[9] != 4.15f) {
				if ((min (float_Array_0[9] , float_Array_0[8])) >= (min ((float_Array_0[7] - float_Array_0[6]) , 3.9f))) {
	...
	// From: Req2Batch199Wrapper_A
	if ((signed_long_int_Array_0[1][0] + signed_long_int_Array_0[0][0]) < signed_long_int_Array_0[0][1]) {
		float_Array_0[2] = ((float_Array_0[3] - (min (float_Array_0[0] , float_Array_0[1]))) + float_Array_0[4]);
	} else {
	...
	// From: Req3Batch199Wrapper_A
	double_Array_0[0] = (abs (float_Array_0[3] + float_Array_0[1]));


	// From: Req4Batch199Wrapper_A
	unsigned_short_int_Array_0[0] = unsigned_short_int_Array_0[1];


	// From: Req5Batch199Wrapper_A
...
int property(void) {
	return (((((float_Array_0[9] >= float_Array_0[8]) ? ((float_Array_0[8] == float_Array_0[9]) ? ((float_Array_0[9] != 4.15f) ? (((min (float_Array_0[9] , float_Array_0[8])) >= (min ((float_Array_0[7] - float_Array_0[6]) , 3.9f))) ? (float_Array_0[10] == ((float) float_Array_0[5])) : (float_Array_0[10] == ((float) 63.42f))) : (float_Array_0[10] == ((float) float_Array_0[5]))) : 1) : 1) && (((signed_long_int_Array_0[1][0] + signed_long_int_Array_0[0][0]) < signed_long_int_Array_0[0][1]) ? (float_Array_0[2] == ((float) ((float_Array_0[3] - (min (float_Array_0[0] , float_Array_0[1]))) + float_Array_0[4]))) : ((signed_long_int_Array_0[0][1] < signed_long_int_Array_0[0][0]) ? (float_Array_0[2] == ((float) float_Array_0[1])) : (float_Array_0[2] == ((float) float_Array_0[0]))))) && (double_Array_0[0] == ((double) (abs (float_Array_0[3] + float_Array_0[1]))))) && (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_short_int_Array_0[1]))) && (signed_long_int_Array_0[1][1] == ((signed long int) unsigned_short_int_Array_0[1]))
;
}
int main(void) {
	isInitial = 1;
