...
void step(void) {
	...
	// From: CodeObject2
	/* 354L, 141L) */ if (/* 355L, 114L, 115L) */ ((/* 356L, 112L, 116L) */ ((var_1_26) / (var_1_28))) < (var_1_16))) {
		/* 360L, 128L) */ var_1_27 = (
			var_1_28
		);
	} else {
	...
	// From: CodeObject4
	/* 404L, 179L) */ if (/* 405L, 164L, 165L) */ ((/* 406L, 162L, 166L) */ (min (/* 406L, 162L, 166L) */ (var_1_33) , (var_1_5)))) >= (var_1_26))) {
		/* 410L, 178L) */ var_1_35 = (
			var_1_29
		);
	}
	...
	// From: CodeObject5
	/* 414L, 251L) */ if (/* 415L, 189L, 190L) */ ((/* 416L, 187L, 191L) */ ((var_1_37) * (/* 418L, 186L, 193L) */ ((var_1_38) - (var_1_39))))) >= (var_1_40))) {
		/* 422L, 245L) */ if (/* 423L, 210L, 211L) */ ((/* 424L, 205L, 212L) */ (~ (var_1_1))) <= (/* 426L, 209L, 214L) */ (abs (/* 427L, 208L, 215L) */ (min (/* 427L, 208L, 215L) */ (var_1_1) , (var_1_29)))))))) {
			/* 430L, 228L) */ var_1_36 = (
				var_1_34
			);
		} else {
	...
	// From: CodeObject6
	/* 444L, 303L) */ if (/* 445L, 262L, 263L) */ ((/* 446L, 259L, 264L) */ ((var_1_1) | (1000))) >= (/* 449L, 261L, 267L) */ (abs (var_1_25))))) {
		/* 451L, 301L) */ if (/* 452L, 281L, 282L) */ ((/* 453L, 278L, 283L) */ ((/* 454L, 276L, 284L) */ (~ (8u))) * (100u))) > (/* 457L, 280L, 287L) */ (abs (var_1_31))))) {
			/* 459L, 300L) */ var_1_41 = (
				/* 462L, 299L) */ (abs (
					var_1_26
				))
	...
	// From: CodeObject1
	/* 333L, 105L) */ if (var_1_12) {
		/* 335L, 98L) */ if (/* 336L, 81L, 82L) */ ((var_1_5) <= (var_1_25))) {
			/* 339L, 97L) */ var_1_22 = (
				/* 342L, 96L) */ ((
					/* 343L, 94L) */ (max (
						/* 343L, 94L) */ (
...
int property(void) {
	if (/* 480L, 6L, 12L, 398L, 428L, 1076L, 1259L, 43L) */ ((/* 481L, 4L, 13L, 399L, 429L, 1074L, 1260L, 41L) */ ((var_1_2) + (var_1_3))) < (-200))) {
		if (last_1_var_1_12) {
			if (/* 489L, 23L, 28L, 406L, 436L, 1082L, 1268L, 49L) */ ((var_1_2) > (/* 491L, 22L, 30L, 408L, 438L, 1081L, 1270L, 48L) */ (- (var_1_3))))) {
			} else {
			}
		} else {
		}
	...
	if (/* 512L, 76L, 84L, 639L, 669L, 1291L) */ ((/* 513L, 72L, 85L, 640L, 670L, 1292L) */ (max (/* 513L, 72L, 85L, 640L, 670L, 1292L) */ (var_1_2) , (var_1_1)))) > (/* 516L, 75L, 88L, 643L, 673L, 1295L) */ ((var_1_3) * (2u))))) {
		if (/* 520L, 97L, 105L, 647L, 677L, 1299L) */ ((/* 521L, 95L, 106L, 648L, 678L, 1300L) */ ((/* 522L, 93L, 107L, 649L, 679L, 1301L) */ ((32) * (-25))) | (var_1_2))) >= (var_1_1))) {
			if (/* 528L, 114L, 118L, 655L, 685L, 1307L) */ ((var_1_3) > (var_1_1))) {
			}
		}
	} else {
	}
	if (/* 541L, 145L, 151L, 728L, 743L, 1320L) */ ((/* 542L, 143L, 152L, 729L, 744L, 1321L) */ ((127.75) <= (var_1_8))) && (var_1_12))) {
	}
	if (/* 556L, 183L, 191L, 784L, 797L, 1335L) */ ((/* 557L, 179L, 192L, 785L, 798L, 1336L) */ ((var_1_16) / (var_1_14))) <= (/* 560L, 182L, 195L, 788L, 801L, 1339L) */ ((var_1_6) * (var_1_1))))) {
	}
	if (/* 570L, 210L, 214L, 899L, 921L, 1349L) */ ((var_1_17) <= (var_1_5))) {
	} else {
	}
	if (var_1_15) {
		if (/* 593L, 246L, 250L, 994L, 1019L, 1372L) */ ((var_1_16) < (var_1_1))) {
		} else {
		}
	} else {
	}
	...
	/* 618L) */ ((
		/* 617L) */ ((
			/* 616L) */ ((
				/* 615L) */ ((
					/* 479L, 65L, 397L, 427L, 1101L, 1258L, 68L) */ ((
						/* 480L, 6L, 12L, 398L, 428L, 1076L, 1259L, 43L) */ ((
							/* 481L, 4L, 13L, 399L, 429L, 1074L, 1260L, 41L) */ ((
								var_1_2
							) + (
								var_1_3
							))
						...
						/* 485L, 59L, 403L, 433L, 1096L, 1264L, 63L) */ ((
							last_1_var_1_12
						) ? (
							/* 488L, 53L, 405L, 435L, 1091L, 1267L, 58L) */ ((
								/* 489L, 23L, 28L, 406L, 436L, 1082L, 1268L, 49L) */ ((
									var_1_2
								) > (
									/* 491L, 22L, 30L, 408L, 438L, 1081L, 1270L, 48L) */ (- (
										var_1_3
									))
								))
							) ? (
								/* 493L, 35L, 410L, 440L, 1086L, 1272L, 53L) */ ((
									var_1_1
								) == (
									/* 493L, 35L, 410L, 440L, 1086L, 1272L, 53L) */ ((unsigned long int) (
										var_1_2
									))
								))
							) : (
								/* 497L, 51L, 414L, 444L, 1090L, 1276L, 57L) */ ((
									var_1_1
								) == (
									/* 497L, 51L, 414L, 444L, 1090L, 1276L, 57L) */ ((unsigned long int) (
										var_1_3
									))
								))
							))
						) : (
							/* 501L, 57L, 418L, 448L, 1095L, 1280L, 62L) */ ((
								var_1_1
							) == (
								/* 501L, 57L, 418L, 448L, 1095L, 1280L, 62L) */ ((unsigned long int) (
									10u
								))
							))
						))
					) : (
						/* 505L, 63L, 422L, 452L, 1100L, 1284L, 67L) */ ((
							var_1_1
						) == (
							/* 505L, 63L, 422L, 452L, 1100L, 1284L, 67L) */ ((unsigned long int) (
								0u
							))
						))
					))
				) && (
					/* 511L, 134L, 638L, 668L, 1290L) */ ((
						/* 512L, 76L, 84L, 639L, 669L, 1291L) */ ((
							/* 513L, 72L, 85L, 640L, 670L, 1292L) */ (max (
								/* 513L, 72L, 85L, 640L, 670L, 1292L) */ (
									var_1_2
								) , (
									var_1_1
								)
						...
						/* 519L, 128L, 646L, 676L, 1298L) */ ((
							/* 520L, 97L, 105L, 647L, 677L, 1299L) */ ((
								/* 521L, 95L, 106L, 648L, 678L, 1300L) */ ((
									/* 522L, 93L, 107L, 649L, 679L, 1301L) */ ((
										32
									) * (
										-25
									))
							...
							/* 527L, 126L, 654L, 684L, 1306L) */ ((
								/* 528L, 114L, 118L, 655L, 685L, 1307L) */ ((
									var_1_3
								) > (
									var_1_1
								))
							) ? (
								/* 531L, 124L, 658L, 688L, 1310L) */ ((
									var_1_5
								) == (
									/* 531L, 124L, 658L, 688L, 1310L) */ ((signed char) (
										var_1_6
									))
								))
							) : (
						...
						/* 535L, 132L, 662L, 692L, 1314L) */ ((
							var_1_5
						) == (
							/* 535L, 132L, 662L, 692L, 1314L) */ ((signed char) (
								var_1_6
							))
						))
					))
				...
				/* 540L, 165L, 727L, 742L, 1319L) */ ((
					/* 541L, 145L, 151L, 728L, 743L, 1320L) */ ((
						/* 542L, 143L, 152L, 729L, 744L, 1321L) */ ((
							127.75
						) <= (
							var_1_8
						))
					...
					/* 546L, 163L, 733L, 748L, 1325L) */ ((
						var_1_7
					) == (
						/* 546L, 163L, 733L, 748L, 1325L) */ ((float) (
							/* 549L, 162L, 736L, 751L, 1328L) */ (max (
								/* 549L, 162L, 736L, 751L, 1328L) */ (
									/* 550L, 160L, 737L, 752L, 1329L) */ ((
										var_1_9
									) + (
										var_1_10
									))
			...
			/* 555L, 203L, 783L, 796L, 1334L) */ ((
				/* 556L, 183L, 191L, 784L, 797L, 1335L) */ ((
					/* 557L, 179L, 192L, 785L, 798L, 1336L) */ ((
						var_1_16
					) / (
						var_1_14
					))
				) <= (
					/* 560L, 182L, 195L, 788L, 801L, 1339L) */ ((
						var_1_6
					) * (
						var_1_1
					))
				...
				/* 563L, 201L, 791L, 804L, 1342L) */ ((
					var_1_12
				) == (
					/* 563L, 201L, 791L, 804L, 1342L) */ ((unsigned char) (
						var_1_15
					))
				))
			) : (
		...
		/* 569L, 234L, 898L, 920L, 1348L) */ ((
			/* 570L, 210L, 214L, 899L, 921L, 1349L) */ ((
				var_1_17
			) <= (
				var_1_5
			))
		) ? (
			/* 573L, 224L, 902L, 924L, 1352L) */ ((
				var_1_16
			) == (
				/* 573L, 224L, 902L, 924L, 1352L) */ ((unsigned long int) (
					/* 576L, 223L, 905L, 927L, 1355L) */ ((
						/* 577L, 221L, 906L, 928L, 1356L) */ ((
							var_1_18
						) - (
							var_1_3
						))
			...
			/* 581L, 232L, 910L, 932L, 1360L) */ ((
				var_1_16
			) == (
				/* 581L, 232L, 910L, 932L, 1360L) */ ((unsigned long int) (
					/* 584L, 231L, 913L, 935L, 1363L) */ (min (
						/* 584L, 231L, 913L, 935L, 1363L) */ (
							var_1_17
						) , (
							/* 586L, 230L, 915L, 937L, 1365L) */ ((
								var_1_3
							) + (
								var_1_2
							))
	...
	/* 590L, 274L, 991L, 1016L, 1369L) */ ((
		var_1_15
	) ? (
		/* 592L, 268L, 993L, 1018L, 1371L) */ ((
			/* 593L, 246L, 250L, 994L, 1019L, 1372L) */ ((
				var_1_16
			) < (
				var_1_1
			))
		) ? (
			/* 596L, 260L, 997L, 1022L, 1375L) */ ((
				var_1_19
			) == (
				/* 596L, 260L, 997L, 1022L, 1375L) */ ((float) (
					/* 599L, 259L, 1000L, 1025L, 1378L) */ ((
						/* 600L, 257L, 1001L, 1026L, 1379L) */ ((
							var_1_20
						) + (
							var_1_21
						))
			...
			/* 604L, 266L, 1005L, 1030L, 1383L) */ ((
				var_1_19
			) == (
				/* 604L, 266L, 1005L, 1030L, 1383L) */ ((float) (
					/* 607L, 265L, 1008L, 1033L, 1386L) */ ((
						0.19999999999999996f
					) - (
						var_1_20
					))
		...
		/* 610L, 272L, 1011L, 1036L, 1389L) */ ((
			var_1_19
		) == (
			/* 610L, 272L, 1011L, 1036L, 1389L) */ ((float) (
				var_1_20
			))
		))
	))
