...
void step(void) {
	// From: Req1Batch138Wrapper_P
	signed char stepLocal_0 = (*(var_1_2_Pointer));
	if (stepLocal_0 >= (*(var_1_3_Pointer))) {
		(*(var_1_1_Pointer)) = (max ((*(var_1_4_Pointer)) , ((*(var_1_5_Pointer)) - (max (100 , (*(var_1_6_Pointer)))))));
	} else {
		(*(var_1_1_Pointer)) = (*(var_1_4_Pointer));
	}


	// From: Req3Batch138Wrapper_P
	...
	if (-128 >= stepLocal_1) {
		if (stepLocal_2 && (*(var_1_13_Pointer))) {
			...
			(*(var_1_11_Pointer)) = (abs ((*(var_1_14_Pointer)) - ((*(var_1_15_Pointer)) + (*(var_1_16_Pointer)))));
		}
	} else {
...
int property(void) {
	return ((((*(var_1_2_Pointer)) >= (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (max ((*(var_1_4_Pointer)) , ((*(var_1_5_Pointer)) - (max (100 , (*(var_1_6_Pointer))))))))) : ((*(var_1_1_Pointer)) == ((unsigned short int) (*(var_1_4_Pointer))))) && (((*(var_1_8_Pointer)) && (4.5f >= (*(var_1_11_Pointer)))) ? ((((*(var_1_6_Pointer)) & (*(var_1_1_Pointer))) > (*(var_1_1_Pointer))) ? ((*(var_1_7_Pointer)) == ((signed char) (*(var_1_10_Pointer)))) : 1) : ((*(var_1_7_Pointer)) == ((signed char) (*(var_1_10_Pointer)))))) && ((-128 >= ((*(var_1_6_Pointer)) << (*(var_1_5_Pointer)))) ? (((*(var_1_8_Pointer)) && (*(var_1_13_Pointer))) ? ((*(var_1_11_Pointer)) == ((float) (15.125f - (*(var_1_14_Pointer))))) : ((*(var_1_11_Pointer)) == ((float) (abs ((*(var_1_14_Pointer)) - ((*(var_1_15_Pointer)) + (*(var_1_16_Pointer)))))))) : ((! ((*(var_1_4_Pointer)) == (*(var_1_5_Pointer)))) ? ((*(var_1_11_Pointer)) == ((float) (*(var_1_17_Pointer)))) : ((*(var_1_11_Pointer)) == ((float) (*(var_1_16_Pointer))))))
;
}
int main(void) {
	isInitial = 1;
