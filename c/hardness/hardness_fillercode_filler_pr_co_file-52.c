...
void step(void) {
	...
	// From: CodeObject5
	/* 311L, 129L) */ if (/* 312L, 95L, 96L) */ ((var_1_7) != (var_1_11))) {
	...
	// From: CodeObject1
	/* 266L, 37L) */ if (/* 267L, 12L, 13L) */ ((/* 268L, 6L, 14L) */ ((var_1_1) | (/* 270L, 5L, 16L) */ (max (/* 270L, 5L, 16L) */ (var_1_15) , (var_1_17)))))) < (/* 273L, 11L, 19L) */ ((/* 274L, 9L, 20L) */ (abs (var_1_25))) >> (25))))) {
		/* 277L, 36L) */ var_1_21 = (
			var_1_26
		);
	}
