...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch141stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_2) {
  if (var_1_19 || var_1_20) {
   var_1_18 = (var_1_21 || ((var_1_15 < var_1_8) && var_1_22));
  }
 } else {
...
int property(void) {
 return (((((((var_1_2 ? (var_1_1 == ((double) (((var_1_3 + 4.275) + (var_1_4 + var_1_5)) - var_1_6))) : 1) && ((var_1_6 > var_1_5) ? ((var_1_3 != 199.5) ? ((var_1_4 != (((((- 8.5)) > (var_1_6)) ? ((- 8.5)) : (var_1_6)))) ? (var_1_2 ? (var_1_7 == ((double) (var_1_3 - var_1_6))) : 1) : (var_1_7 == ((double) (var_1_3 - var_1_5)))) : 1) : (var_1_7 == ((double) var_1_6)))) && ((var_1_5 <= var_1_7) ? (var_1_8 == ((signed short int) (var_1_9 - var_1_10))) : 1)) && (var_1_11 == ((signed long int) (((((var_1_9 - var_1_10)) < (var_1_8)) ? ((var_1_9 - var_1_10)) : (var_1_8)))))) && (var_1_12 == ((unsigned char) ((((var_1_13) < ((var_1_14 + var_1_15))) ? (var_1_13) : ((var_1_14 + var_1_15))))))) && (var_1_2 ? ((var_1_8 != (var_1_12 + var_1_11)) ? (var_1_16 == ((double) var_1_4)) : 1) : 1)) && (((var_1_8 | var_1_15) < -10) ? (var_1_17 == ((signed long int) var_1_9)) : (var_1_17 == ((signed long int) ((((var_1_10) < (var_1_15)) ? (var_1_10) : (var_1_15))))))) && (var_1_2 ? ((var_1_19 || var_1_20) ? (var_1_18 == ((unsigned char) (var_1_21 || ((var_1_15 < var_1_8) && var_1_22)))) : 1) : (var_1_18 == ((unsigned char) (var_1_23 && var_1_24))))
;
}
int main(void) {
 isInitial = 1;
