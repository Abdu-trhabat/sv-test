...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch37Filler_PS_CN.c", 13, "reach_error"); }
   ...
   var_1_26
     ...
     var_1_33
             ...
             if ( (( ((var_1_28) & ( (~ (var_1_29))))) <= (var_1_34))) {
              if (var_1_35) {
               var_1_36 = (
                ((((( var_1_29 )) > (( ((((( var_1_32 )) < (( ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) ))) ? (( var_1_32 )) : (( ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) )))) ))) ? (( var_1_29 )) : (( ((((( var_1_32 )) < (( ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) ))) ? (( var_1_32 )) : (( ((((var_1_34) < 0 ) ? -(var_1_34) : (var_1_34))) )))) ))))
   );
  }
 } else {
              if (var_1_37) {
