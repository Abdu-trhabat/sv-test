...
int property(void) {
	return ((((double_Array_0[1] >= double_Array_0[0]) ? (unsigned_char_Array_0[10] == ((unsigned char) (min (unsigned_char_Array_0[9] , unsigned_char_Array_0[8])))) : (unsigned_char_Array_0[10] == ((unsigned char) unsigned_char_Array_0[8]))) && ((! BOOL_unsigned_char_Array_0[1]) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_char_Array_0[8])) : 1)) && ((BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[0]) ? (unsigned_char_Array_0[2] == ((unsigned char) (unsigned_char_Array_0[3] - unsigned_char_Array_0[4]))) : ((-1000000000 < unsigned_char_Array_0[9]) ? (unsigned_char_Array_0[2] == ((unsigned char) (128 - ((unsigned_char_Array_0[0] + 50) - (32 - unsigned_char_Array_0[1]))))) : (unsigned_char_Array_0[2] == ((unsigned char) ((unsigned_char_Array_0[6] + (unsigned_char_Array_0[7] + unsigned_char_Array_0[5])) - unsigned_char_Array_0[0])))))) && (BOOL_unsigned_char_Array_0[1] ? ((unsigned_char_Array_0[6] <= signed_long_int_Array_0[0]) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) (max (unsigned_char_Array_0[3] , signed_long_int_Array_0[0])))) : ((-5 > unsigned_char_Array_0[1]) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_char_Array_0[9])) : 1)) : 1)
;
}
int main(void) {
	isInitial = 1;
