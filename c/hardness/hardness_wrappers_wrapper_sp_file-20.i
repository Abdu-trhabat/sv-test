...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch20Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if ((*(WrapperStruct00_var_1_10_Pointer)) || stepLocal_0) {
  (*(WrapperStruct00_var_1_9_Pointer)) = (((*(WrapperStruct00_var_1_11_Pointer)) - (*(WrapperStruct00_var_1_12_Pointer))) - (*(WrapperStruct00_var_1_13_Pointer)));
 } else {
  (*(WrapperStruct00_var_1_9_Pointer)) = ((*(WrapperStruct00_var_1_13_Pointer)) + (((((*(WrapperStruct00_var_1_12_Pointer))) < 0 ) ? -((*(WrapperStruct00_var_1_12_Pointer))) : ((*(WrapperStruct00_var_1_12_Pointer))))));
 }
 unsigned long int stepLocal_2 = (*(WrapperStruct00_var_1_13_Pointer));
 unsigned long int stepLocal_1 = (*(WrapperStruct00_var_1_11_Pointer));
 if (5 >= stepLocal_1) {
