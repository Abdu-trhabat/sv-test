...
void step(void) {
	// From: Req4Batch137Wrapper_P
	(*(var_1_16_Pointer)) = (*(var_1_15_Pointer));


	// From: Req5Batch137Wrapper_P
	(*(var_1_17_Pointer)) = 16u;


	// From: Req6Batch137Wrapper_P
	(*(var_1_18_Pointer)) = (*(var_1_14_Pointer));


	// From: Req1Batch137Wrapper_P
	...
	// From: Req2Batch137Wrapper_P
	if ((*(var_1_11_Pointer))) {
		if ((*(var_1_11_Pointer))) {
			(*(var_1_8_Pointer)) = (abs ((*(var_1_10_Pointer))));
		} else {
			(*(var_1_8_Pointer)) = (max ((*(var_1_10_Pointer)) , 2));
		}
	}
}
...
int property(void) {
	return ((((((((*(var_1_2_Pointer)) + (*(var_1_3_Pointer))) < (*(var_1_4_Pointer))) ? (((*(var_1_2_Pointer)) <= (*(var_1_4_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (min ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))))) : ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_6_Pointer))))) : ((*(var_1_18_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_5_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_6_Pointer)))))) && ((*(var_1_11_Pointer)) ? ((*(var_1_11_Pointer)) ? ((*(var_1_8_Pointer)) == ((signed char) (abs ((*(var_1_10_Pointer)))))) : ((*(var_1_8_Pointer)) == ((signed char) (max ((*(var_1_10_Pointer)) , 2))))) : 1)) && ((((*(var_1_12_Pointer)) / 1.3) <= (*(var_1_13_Pointer))) ? (((((*(var_1_5_Pointer)) * (*(var_1_17_Pointer))) >= (*(var_1_6_Pointer))) && (*(var_1_18_Pointer))) ? ((*(var_1_11_Pointer)) == ((unsigned char) (! (*(var_1_14_Pointer))))) : ((*(var_1_11_Pointer)) == ((unsigned char) (*(var_1_15_Pointer))))) : 1)) && ((*(var_1_16_Pointer)) == ((unsigned char) (*(var_1_15_Pointer))))) && ((*(var_1_17_Pointer)) == ((unsigned long int) 16u))) && ((*(var_1_18_Pointer)) == ((unsigned char) (*(var_1_14_Pointer))))
;
}
int main(void) {
	isInitial = 1;
