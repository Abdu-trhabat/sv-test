  ...
  if (-0.5f < var_1_16) {
   if (var_1_16 == var_1_2) {
    if (stepLocal_4 < var_1_19) {
     var_1_18 = (((((var_1_8 + var_1_24)) < (var_1_7)) ? ((var_1_8 + var_1_24)) : (var_1_7)));
    } else {
...
int property(void) {
 return (((((((((var_1_25 < 32.8) ? ((var_1_25 == (var_1_25 * (- var_1_25))) ? (var_1_1 == ((float) var_1_5)) : (var_1_1 == ((float) (var_1_6 + 8.6f)))) : 1) && (var_1_7 == ((signed char) ((((-64) < 0 ) ? -(-64) : (-64)))))) && ((var_1_24 <= ((((4) < (var_1_22)) ? (4) : (var_1_22)))) ? (var_1_8 == ((signed short int) (var_1_22 + 10))) : (var_1_8 == ((signed short int) var_1_24)))) && ((128u > (var_1_11 / 64u)) ? ((var_1_25 > var_1_5) ? (var_1_10 == ((unsigned char) (var_1_12 || (var_1_13 && var_1_14)))) : 1) : (var_1_10 == ((unsigned char) var_1_15)))) && (((~ var_1_11) >= var_1_17) ? ((var_1_8 != var_1_11) ? (var_1_16 == ((float) ((((var_1_5) < 0 ) ? -(var_1_5) : (var_1_5))))) : 1) : 1)) && ((var_1_4 < var_1_2) ? ((-0.5f < var_1_16) ? ((var_1_16 == var_1_2) ? ((var_1_11 < var_1_19) ? (var_1_18 == ((signed long int) (((((var_1_8 + var_1_24)) < (var_1_7)) ? ((var_1_8 + var_1_24)) : (var_1_7))))) : (var_1_18 == ((signed long int) (var_1_20 - var_1_21)))) : 1) : (var_1_18 == ((signed long int) var_1_24))) : 1)) && (var_1_22 == ((unsigned short int) var_1_23))) && (var_1_24 == ((unsigned short int) 10))) && (var_1_25 == ((double) var_1_6))
;
}
int main(void) {
 isInitial = 1;
