...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch7Amount50.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch7Amount50
	var_1_9 = (max (var_1_5 , var_1_6));


	// From: Req4Batch7Amount50
	...
	// From: Req6Batch7Amount50
	var_1_15 = (var_1_14 - (max ((var_1_16 + var_1_17) , 4)));


	// From: Req7Batch7Amount50
	if (var_1_4 > var_1_2) {
	...
	// From: Req8Batch7Amount50
	var_1_24 = 16;


	// From: Req1Batch7Amount50
