...
void step(void) {
	...
	// From: CodeObject4
	/* 308L, 98L) */ if (/* 309L, 79L, 80L) */ ((-5) >= (/* 311L, 78L, 82L) */ (abs (var_1_11))))) {
	...
	// From: CodeObject5
	/* 342L, 145L) */ if (/* 343L, 112L, 113L) */ ((/* 344L, 108L, 114L) */ ((/* 345L, 104L, 115L) */ (min (/* 345L, 104L, 115L) */ (var_1_27) , (var_1_28)))) & (/* 348L, 107L, 118L) */ ((var_1_11) & (var_1_25))))) <= (/* 351L, 111L, 121L) */ ((var_1_22) * (var_1_29))))) {
		/* 354L, 144L) */ var_1_36 = (
			/* 357L, 143L) */ ((
				/* 358L, 139L) */ (max (
					/* 358L, 139L) */ (
	...
	/* 417L, 242L) */ if (var_1_16) {
		/* 419L, 240L) */ if (/* 420L, 215L, 216L) */ ((var_1_4) > (/* 422L, 214L, 218L) */ ((var_1_3) / (/* 424L, 213L, 220L) */ (abs (var_1_43))))))) {
			/* 426L, 239L) */ var_1_42 = (
				/* 429L, 238L) */ ((
					/* 430L, 234L) */ ((
						var_1_8
