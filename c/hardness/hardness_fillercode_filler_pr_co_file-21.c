...
void step(void) {
	...
	/* 310L, 138L) */ if (/* 311L, 84L, 85L) */ ((var_1_26) < (var_1_30))) {
		/* 314L, 136L) */ if (/* 315L, 93L, 94L) */ ((var_1_26) <= (var_1_13))) {
			/* 318L, 134L) */ if (/* 319L, 105L, 106L) */ ((/* 320L, 103L, 107L) */ ((/* 321L, 101L, 108L) */ (abs (var_1_13))) * (5))) < (var_1_30))) {
				/* 325L, 132L) */ if (/* 326L, 120L, 121L) */ ((var_1_13) < (var_1_8))) {
					/* 329L, 131L) */ var_1_31 = (
						/* 332L, 130L) */ (abs (
							var_1_33
						))
	...
	/* 378L, 248L) */ if (/* 379L, 203L, 204L) */ ((/* 380L, 199L, 205L) */ ((25) & (var_1_35))) < (/* 383L, 202L, 208L) */ ((var_1_25) - (25))))) {
		/* 386L, 246L) */ if (/* 387L, 224L, 225L) */ ((/* 388L, 222L, 226L) */ (min (/* 388L, 222L, 226L) */ (/* 389L, 220L, 227L) */ ((var_1_13) & (var_1_36))) , (25)))) > (-64))) {
			/* 394L, 245L) */ var_1_44 = (
				/* 397L, 244L) */ (abs (
					/* 398L, 243L) */ ((
						var_1_45
	...
	// From: CodeObject8
	/* 401L, 294L) */ if (/* 402L, 258L, 259L) */ ((5u) < (/* 404L, 257L, 261L) */ ((var_1_8) ^ (var_1_45))))) {
