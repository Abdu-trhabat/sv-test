...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch11125_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch11125_while
	if ((- 16) <= last_1_var_1_10) {
		var_1_7 = var_1_9;
	}


	// From: Req3Batch11125_while
	...
	// From: Req4Batch11125_while
	var_1_14 = var_1_4;


	// From: Req5Batch11125_while
	var_1_15 = var_1_16;


	// From: Req6Batch11125_while
	var_1_17 = var_1_16;
}
