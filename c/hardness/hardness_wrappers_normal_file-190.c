...
void step(void) {
	...
	if (! var_1_4) {
		if (stepLocal_1 == (max (10 , (var_1_7 / var_1_14)))) {
...
int property(void) {
	return ((((((var_1_2 || (var_1_3 && (var_1_5 <= var_1_6))) ? (var_1_1 == ((signed short int) var_1_7)) : (var_1_3 ? (var_1_1 == ((signed short int) var_1_7)) : (var_1_1 == ((signed short int) -32)))) && ((! (var_1_16 > (var_1_12 + 1))) ? ((8.5f <= var_1_15) ? (var_1_8 == ((double) (max (var_1_10 , var_1_11)))) : (var_1_8 == ((double) var_1_10))) : (var_1_8 == ((double) var_1_10)))) && ((! var_1_4) ? (((-5 % var_1_13) == (max (10 , (var_1_7 / var_1_14)))) ? (var_1_12 == ((signed long int) (var_1_6 - var_1_5))) : 1) : 1)) && (var_1_15 == ((float) var_1_11))) && (var_1_16 == ((unsigned long int) var_1_12))) && (var_1_17 == ((signed short int) var_1_7))
;
}
int main(void) {
	isInitial = 1;
