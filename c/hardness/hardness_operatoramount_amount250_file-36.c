...
void step(void) {
	...
	if ((abs (last_1_var_1_42)) <= var_1_4) {
	...
	unsigned long int stepLocal_6 = max ((max (var_1_18 , var_1_9)) , var_1_11);
	if (stepLocal_6 <= var_1_12) {
		if ((last_1_var_1_59 / (min (var_1_25 , var_1_26))) == last_1_var_1_60) {
	...
	if (stepLocal_4 >= (min (var_1_12 , (var_1_17 & var_1_11)))) {
	...
	var_1_32 = (min ((var_1_18 + var_1_21) , (min (var_1_20 , var_1_33))));


	// From: Req11Batch36Amount250
	if ((var_1_24 / var_1_28) < var_1_8) {
		var_1_48 = (var_1_49 - (var_1_21 + (min (var_1_20 , var_1_50))));
	} else {
		if ((var_1_47 * (var_1_20 >> var_1_51)) > var_1_19) {
			if (var_1_24 >= var_1_38) {
				var_1_48 = (max (var_1_21 , var_1_49));
			}
		} else {
			var_1_48 = ((min (var_1_51 , var_1_50)) + (abs (var_1_20)));
		}
	}


	// From: Req14Batch36Amount250
	var_1_56 = ((var_1_57 + var_1_58) - (abs (var_1_21)));
		...
		if ((58597 - var_1_20) >= var_1_15) {
			if (var_1_24 > (var_1_21 ^ (var_1_47 - var_1_40))) {
				if (var_1_52 || (! (var_1_38 <= var_1_47))) {
					var_1_42 = (max (((abs (var_1_45)) - var_1_6) , var_1_5));
				}
			} else {
				var_1_42 = var_1_5;
			}
	...
	if (var_1_1 > 99.5f) {
		var_1_34 = (max (((var_1_35 - var_1_18) - var_1_20) , (var_1_32 + var_1_56)));
	} else {
		var_1_34 = (min ((var_1_33 + (var_1_21 - var_1_32)) , var_1_17));
	}


	// From: Req15Batch36Amount250
	if (var_1_42 >= 99.5) {
		var_1_59 = (min (var_1_4 , (max ((max (var_1_43 , var_1_5)) , var_1_46))));
	} else {
	...
	if (var_1_52 && stepLocal_2) {
		...
		if (((min (var_1_34 , var_1_16)) + var_1_17) == stepLocal_1) {
	...
	if ((var_1_19 - var_1_21) <= var_1_15) {
		if (var_1_29 || var_1_31) {
			if (((var_1_34 * var_1_64) / var_1_38) >= var_1_19) {
				if ((var_1_27 - var_1_20) != (var_1_39 - (max (var_1_18 , var_1_24)))) {
					var_1_36 = (var_1_17 + ((min (var_1_20 , var_1_21)) - var_1_40));
				}
			}
		} else {
	...
	if ((- 8u) >= var_1_39) {
		if (var_1_12 >= (var_1_10 % (var_1_27 + var_1_41))) {
			var_1_54 = (min ((max ((max (var_1_51 , var_1_36)) , (var_1_40 - var_1_35))) , var_1_21));
		} else {
			var_1_54 = (((var_1_50 + var_1_18) - (max (var_1_21 , var_1_24))) + var_1_41);
		}
	} else {
		var_1_54 = (var_1_17 + (max (var_1_55 , var_1_19)));
	}
	...
	if (((abs (var_1_19)) <= var_1_54) && stepLocal_7) {
		if (stepLocal_9 > (var_1_54 ^ (var_1_27 / var_1_41))) {
			var_1_60 = (var_1_45 + (var_1_61 - var_1_62));
		}
	} else {
		if ((min ((var_1_54 ^ var_1_39) , (var_1_24 & var_1_18))) != stepLocal_8) {
			var_1_60 = ((2.75f + var_1_63) + (min (var_1_61 , var_1_45)));
		} else {
			var_1_60 = (var_1_61 + (max (var_1_46 , var_1_62)));
		}
	}
}
...
int property(void) {
	return ((((((((((((((((var_1_29 ? (((-5 + 64) < var_1_24) ? (var_1_1 == ((float) (max ((var_1_4 - var_1_5) , (var_1_6 - 5.4f))))) : (var_1_1 == ((float) (min ((min (-0.5f , 2.35f)) , var_1_6))))) : (var_1_29 ? (var_1_1 == ((float) (max (var_1_6 , var_1_4)))) : (var_1_1 == ((float) (var_1_5 - var_1_4))))) && ((((var_1_4 - var_1_5) * var_1_1) <= var_1_6) ? (var_1_8 == ((unsigned long int) var_1_9)) : (var_1_8 == ((unsigned long int) (max ((max (var_1_9 , var_1_10)) , (min (var_1_11 , var_1_12)))))))) && ((var_1_52 && (var_1_42 >= var_1_4)) ? (var_1_13 == ((signed char) ((var_1_15 + var_1_16) + var_1_17))) : ((((min (var_1_34 , var_1_16)) + var_1_17) == var_1_18) ? ((var_1_52 || (var_1_52 || (! var_1_29))) ? (var_1_52 ? (var_1_13 == ((signed char) (var_1_19 - (max ((4 + var_1_20) , (var_1_21 + 5)))))) : (var_1_13 == ((signed char) (max (var_1_15 , ((abs (var_1_21)) - var_1_20)))))) : 1) : 1))) && ((var_1_15 >= (min (var_1_12 , (var_1_17 & var_1_11)))) ? ((var_1_24 < var_1_10) ? (var_1_22 == ((float) (abs (var_1_6)))) : 1) : 1)) && (((max ((max (var_1_18 , var_1_9)) , var_1_11)) <= var_1_12) ? (((last_1_var_1_59 / (min (var_1_25 , var_1_26))) == last_1_var_1_60) ? (var_1_24 == ((unsigned long int) (max (var_1_20 , var_1_21)))) : (var_1_24 == ((unsigned long int) (min (((var_1_27 + var_1_28) - 8u) , var_1_10))))) : 1)) && (var_1_52 ? ((var_1_52 && (var_1_17 == var_1_15)) ? ((var_1_9 != (abs (var_1_27))) ? (var_1_29 == ((unsigned char) (! ((var_1_26 <= var_1_5) || var_1_30)))) : ((var_1_11 <= 8u) ? (var_1_29 == ((unsigned char) (! (var_1_52 || (var_1_30 && var_1_31))))) : (var_1_29 == ((unsigned char) 0)))) : (var_1_29 == ((unsigned char) var_1_30))) : 1)) && (var_1_32 == ((unsigned short int) (min ((var_1_18 + var_1_21) , (min (var_1_20 , var_1_33))))))) && ((var_1_1 > 99.5f) ? (var_1_34 == ((signed long int) (max (((var_1_35 - var_1_18) - var_1_20) , (var_1_32 + var_1_56))))) : (var_1_34 == ((signed long int) (min ((var_1_33 + (var_1_21 - var_1_32)) , var_1_17)))))) && (((var_1_19 - var_1_21) <= var_1_15) ? ((var_1_29 || var_1_31) ? ((((var_1_34 * var_1_64) / var_1_38) >= var_1_19) ? (((var_1_27 - var_1_20) != (var_1_39 - (max (var_1_18 , var_1_24)))) ? (var_1_36 == ((signed short int) (var_1_17 + ((min (var_1_20 , var_1_21)) - var_1_40)))) : 1) : 1) : (var_1_36 == ((signed short int) ((4 + var_1_21) - (var_1_41 - 128))))) : (var_1_36 == ((signed short int) var_1_40)))) && ((((var_1_43 + var_1_44) - 2.6) <= (var_1_26 + var_1_4)) ? (var_1_42 == ((double) (var_1_45 + var_1_46))) : (((58597 - var_1_20) >= var_1_15) ? ((var_1_24 > (var_1_21 ^ (var_1_47 - var_1_40))) ? ((var_1_52 || (! (var_1_38 <= var_1_47))) ? (var_1_42 == ((double) (max (((abs (var_1_45)) - var_1_6) , var_1_5)))) : 1) : (var_1_42 == ((double) var_1_5))) : 1))) && (((var_1_24 / var_1_28) < var_1_8) ? (var_1_48 == ((unsigned char) (var_1_49 - (var_1_21 + (min (var_1_20 , var_1_50)))))) : (((var_1_47 * (var_1_20 >> var_1_51)) > var_1_19) ? ((var_1_24 >= var_1_38) ? (var_1_48 == ((unsigned char) (max (var_1_21 , var_1_49)))) : 1) : (var_1_48 == ((unsigned char) ((min (var_1_51 , var_1_50)) + (abs (var_1_20)))))))) && (((abs (last_1_var_1_42)) <= var_1_4) ? (var_1_52 == ((unsigned char) (var_1_30 && var_1_31))) : (last_1_var_1_29 ? (var_1_52 == ((unsigned char) (var_1_30 && var_1_31))) : (var_1_52 == ((unsigned char) (! (! var_1_53))))))) && (((- 8u) >= var_1_39) ? ((var_1_12 >= (var_1_10 % (var_1_27 + var_1_41))) ? (var_1_54 == ((signed long int) (min ((max ((max (var_1_51 , var_1_36)) , (var_1_40 - var_1_35))) , var_1_21)))) : (var_1_54 == ((signed long int) (((var_1_50 + var_1_18) - (max (var_1_21 , var_1_24))) + var_1_41)))) : (var_1_54 == ((signed long int) (var_1_17 + (max (var_1_55 , var_1_19))))))) && (var_1_56 == ((unsigned char) ((var_1_57 + var_1_58) - (abs (var_1_21)))))) && ((var_1_42 >= 99.5) ? (var_1_59 == ((double) (min (var_1_4 , (max ((max (var_1_43 , var_1_5)) , var_1_46)))))) : (var_1_59 == ((double) (var_1_44 - var_1_5))))) && ((((abs (var_1_19)) <= var_1_54) && ((var_1_24 + var_1_55) >= -5)) ? (((var_1_54 / var_1_57) > (var_1_54 ^ (var_1_27 / var_1_41))) ? (var_1_60 == ((float) (var_1_45 + (var_1_61 - var_1_62)))) : 1) : (((min ((var_1_54 ^ var_1_39) , (var_1_24 & var_1_18))) != var_1_8) ? (var_1_60 == ((float) ((2.75f + var_1_63) + (min (var_1_61 , var_1_45))))) : (var_1_60 == ((float) (var_1_61 + (max (var_1_46 , var_1_62)))))))) && (((var_1_47 & var_1_51) == (var_1_34 + var_1_24)) ? (var_1_64 == ((signed char) var_1_17)) : ((var_1_10 == var_1_41) ? ((var_1_62 != 9.8f) ? (var_1_64 == ((signed char) var_1_17)) : (var_1_64 == ((signed char) var_1_15))) : (var_1_64 == ((signed char) 10))))
;
}
int main(void) {
	isInitial = 1;
