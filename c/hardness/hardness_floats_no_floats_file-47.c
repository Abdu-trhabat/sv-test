...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch47no_floats.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (((abs (var_1_2)) - 1) < -16) {
		var_1_1 = (max ((abs (var_1_3 - var_1_4)) , (32 - var_1_5)));
	} else {
		var_1_1 = -128;
	}
...
int property(void) {
	return (((((((abs (var_1_2)) - 1) < -16) ? (var_1_1 == ((signed long int) (max ((abs (var_1_3 - var_1_4)) , (32 - var_1_5))))) : (var_1_1 == ((signed long int) -128))) && ((var_1_2 < -16) ? (var_1_6 == ((unsigned char) ((var_1_1 <= (- var_1_4)) || var_1_7))) : (var_1_6 == ((unsigned char) (var_1_7 || var_1_8))))) && (((max (var_1_2 , (-1 + 100))) <= var_1_10) ? (var_1_8 ? (var_1_9 == ((signed long int) (var_1_3 - (min ((var_1_11 + var_1_12) , var_1_4))))) : (var_1_9 == ((signed long int) var_1_11))) : 1)) && (var_1_13 == ((unsigned char) var_1_14))) && (var_1_15 == ((signed short int) var_1_14))
;
}
int main(void) {
	isInitial = 1;
