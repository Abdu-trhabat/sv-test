...
void step(void) {
	// From: Req4Batch149dependencies
	if ((min (last_1_var_1_13 , last_1_var_1_11)) > (max (var_1_9 , (last_1_var_1_13 + last_1_var_1_1)))) {
		var_1_12 = var_1_5;
	} else {
		var_1_12 = var_1_9;
	}
