...
void step(void) {
	// From: Req1Batch174normal
	if (var_1_2 < (var_1_3 / var_1_4)) {
		var_1_1 = (var_1_5 + var_1_6);
	}


	// From: Req2Batch174normal
	if (var_1_8) {
		if (var_1_9) {
			var_1_7 = var_1_5;
		}
	} else {
		if (var_1_3 == (var_1_2 & (min (var_1_6 , var_1_5)))) {
	...
	// From: Req6Batch174normal
	var_1_22 = (var_1_16 - var_1_19);


	// From: Req7Batch174normal
