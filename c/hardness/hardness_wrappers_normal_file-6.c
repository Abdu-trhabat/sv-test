...
void step(void) {
	...
	if ((var_1_7 >> (var_1_8 + var_1_9)) >= (max ((last_1_var_1_1 + var_1_5) , var_1_3))) {
		var_1_6 = var_1_8;
	} else {
		if (var_1_4 < 64) {
			var_1_6 = var_1_7;
	...
	if ((- var_1_11) != var_1_12) {
		var_1_10 = (var_1_13 - (var_1_4 + (min (var_1_6 , var_1_3))));
	}


	// From: Req1Batch6normal
	unsigned long int stepLocal_1 = (max (var_1_10 , var_1_6)) / var_1_4;
...
int property(void) {
	return ((((((max (var_1_10 , var_1_6)) / var_1_4) > var_1_10) ? ((var_1_10 == var_1_6) ? (var_1_1 == ((unsigned long int) 1000000000u)) : (var_1_1 == ((unsigned long int) 128u))) : 1) && (((var_1_7 >> (var_1_8 + var_1_9)) >= (max ((last_1_var_1_1 + var_1_5) , var_1_3))) ? (var_1_6 == ((unsigned short int) var_1_8)) : ((var_1_4 < 64) ? (var_1_6 == ((unsigned short int) var_1_7)) : 1))) && (((- var_1_11) != var_1_12) ? (var_1_10 == ((unsigned long int) (var_1_13 - (var_1_4 + (min (var_1_6 , var_1_3)))))) : 1)) && ((var_1_9 == (var_1_4 | -5)) ? (var_1_14 == ((float) (max (1.5f , var_1_15)))) : 1)
;
}
int main(void) {
	isInitial = 1;
