...
void step(void) {
	...
	if (stepLocal_12 <= (min (var_1_65 , var_1_15))) {
		var_1_67 = var_1_40;
	} else {
		var_1_67 = 0;
	}
	...
	signed long int stepLocal_6 = max ((var_1_68 + var_1_15) , (var_1_26 / var_1_50));
	if (var_1_42) {
	...
	if (var_1_67 && var_1_39) {
		if (var_1_16 <= var_1_13) {
			...
			var_1_29 = (min ((max (var_1_15 , (max (var_1_3 , var_1_58)))) , (max (var_1_16 , var_1_25))));
		}
	} else {
	...
	if (2.4 == var_1_20) {
		if (var_1_39 && stepLocal_13) {
			if (var_1_39) {
				var_1_70 = (abs (var_1_46 + var_1_14));
			}
		} else {
			var_1_70 = 50;
		}
	...
	if (var_1_58 <= (var_1_6 | (min (10 , var_1_8)))) {
	...
	if (stepLocal_2 < var_1_31) {
		var_1_36 = ((var_1_6 - (var_1_64 + var_1_14)) + (max ((var_1_37 - var_1_7) , var_1_4)));
	}


	// From: Req18Batch69Amount250
	unsigned long int stepLocal_7 = abs (var_1_36 + var_1_52);
	if (var_1_15 >= stepLocal_7) {
		var_1_54 = ((4 + (var_1_55 - 32)) + (min (var_1_50 , var_1_14)));
	} else {
		var_1_54 = (min ((abs (2)) , var_1_4));
	}
...
int property(void) {
	return ((((((((((((((((((((((((((((var_1_67 && ((var_1_3 - var_1_4) <= var_1_36)) ? (var_1_1 == ((unsigned long int) ((max ((var_1_3 + var_1_4) , (var_1_6 - var_1_7))) + var_1_8))) : (var_1_1 == ((unsigned long int) (max (var_1_3 , 100u))))) && ((var_1_58 <= (var_1_6 | (min (10 , var_1_8)))) ? (var_1_9 == ((float) (min (var_1_10 , var_1_11)))) : (var_1_45 ? ((var_1_6 < ((var_1_7 << var_1_58) + var_1_4)) ? (var_1_9 == ((float) var_1_11)) : (var_1_9 == ((float) var_1_10))) : (var_1_9 == ((float) var_1_11))))) && ((var_1_9 < var_1_11) ? (var_1_12 == ((unsigned char) (min (var_1_13 , var_1_14)))) : ((((abs (var_1_14)) % var_1_15) >= var_1_7) ? (((-100 * var_1_4) >= var_1_14) ? (var_1_12 == ((unsigned char) var_1_13)) : 1) : (var_1_12 == ((unsigned char) var_1_16))))) && (var_1_39 ? (var_1_17 == ((double) (var_1_18 + var_1_19))) : (var_1_17 == ((double) (((var_1_20 + var_1_21) - var_1_22) + (max (1.25 , var_1_18))))))) && ((var_1_22 > last_1_var_1_33) ? ((! last_1_var_1_39) ? (var_1_23 == ((float) (var_1_19 + (min (var_1_20 , (max (var_1_18 , var_1_22))))))) : 1) : 1)) && ((! var_1_45) ? (var_1_24 == ((signed char) (var_1_25 + ((var_1_26 - var_1_27) + var_1_28)))) : 1)) && ((var_1_67 && var_1_39) ? ((var_1_16 <= var_1_13) ? (var_1_29 == ((signed long int) (var_1_4 + var_1_7))) : (var_1_29 == ((signed long int) (min ((max (var_1_15 , (max (var_1_3 , var_1_58)))) , (max (var_1_16 , var_1_25))))))) : (var_1_29 == ((signed long int) (((var_1_31 - var_1_13) + var_1_27) - var_1_26))))) && ((var_1_29 < (var_1_51 / var_1_31)) ? (var_1_32 == ((signed char) (max (var_1_28 , var_1_25)))) : 1)) && (var_1_45 ? (var_1_33 == ((double) ((var_1_20 - var_1_21) + (var_1_22 - (var_1_34 + 9.6))))) : 1)) && ((var_1_31 > var_1_6) ? (((var_1_8 ^ var_1_31) != var_1_14) ? ((((var_1_66 + var_1_10) >= (255.6f * var_1_33)) && var_1_39) ? (var_1_35 == ((float) (min (((var_1_21 + 63.5f) + var_1_22) , var_1_34)))) : (var_1_35 == ((float) var_1_20))) : 1) : 1)) && ((var_1_26 < var_1_31) ? (var_1_36 == ((unsigned long int) ((var_1_6 - (var_1_64 + var_1_14)) + (max ((var_1_37 - var_1_7) , var_1_4))))) : 1)) && ((var_1_45 || var_1_67) ? ((var_1_3 >= var_1_27) ? ((var_1_19 <= ((- var_1_11) + var_1_23)) ? (var_1_38 == ((signed short int) var_1_25)) : 1) : (var_1_38 == ((signed short int) var_1_28))) : (var_1_38 == ((signed short int) var_1_28)))) && ((var_1_3 >= var_1_38) ? (var_1_39 == ((unsigned char) ((var_1_60 || var_1_40) && ((var_1_67 || var_1_41) && var_1_42)))) : ((var_1_3 > var_1_13) ? (var_1_39 == ((unsigned char) (! var_1_43))) : (var_1_39 == ((unsigned char) var_1_44))))) && (var_1_45 == ((unsigned char) var_1_40))) && (var_1_44 ? (var_1_46 == ((unsigned char) (128 - (var_1_47 - (max (var_1_26 , var_1_48)))))) : (var_1_46 == ((unsigned char) (var_1_48 + (max (var_1_27 , var_1_26))))))) && (((var_1_26 - var_1_4) == 1000) ? (var_1_49 == ((unsigned char) ((abs (var_1_50)) - var_1_27))) : 1)) && (var_1_42 ? ((var_1_31 <= (max ((var_1_68 + var_1_15) , (var_1_26 / var_1_50)))) ? (var_1_51 == ((unsigned char) (var_1_50 - ((var_1_27 + var_1_26) + var_1_48)))) : (var_1_51 == ((unsigned char) ((max (var_1_50 , var_1_52)) - ((100 - var_1_26) - (var_1_27 + var_1_53)))))) : (var_1_51 == ((unsigned char) ((var_1_47 - (max (var_1_26 , var_1_48))) + 64))))) && ((var_1_15 >= (abs (var_1_36 + var_1_52))) ? (var_1_54 == ((unsigned short int) ((4 + (var_1_55 - 32)) + (min (var_1_50 , var_1_14))))) : (var_1_54 == ((unsigned short int) (min ((abs (2)) , var_1_4)))))) && (var_1_56 == ((signed char) (max (var_1_48 , var_1_57))))) && (var_1_39 ? (var_1_58 == ((unsigned long int) (var_1_59 - var_1_26))) : 1)) && ((var_1_41 || var_1_44) ? ((var_1_33 >= var_1_23) ? (var_1_60 == ((unsigned char) (! (! (! var_1_44))))) : 1) : 1)) && ((var_1_66 <= (var_1_21 - 128.35f)) ? (var_1_61 == ((signed char) (min (var_1_26 , var_1_57)))) : (((var_1_16 >= var_1_59) || var_1_40) ? (var_1_61 == ((signed char) (var_1_26 + var_1_27))) : ((var_1_58 <= var_1_50) ? (var_1_61 == ((signed char) ((var_1_48 - var_1_53) + ((var_1_62 + var_1_63) + var_1_27)))) : (var_1_61 == ((signed char) ((var_1_53 + var_1_26) - var_1_48))))))) && ((((abs (var_1_9)) - 9.8f) > (- var_1_19)) ? (var_1_64 == ((unsigned short int) (57474 - ((var_1_65 - var_1_48) - 1)))) : 1)) && ((var_1_65 < (var_1_37 * var_1_29)) ? (var_1_66 == ((float) (var_1_20 + var_1_22))) : (var_1_66 == ((float) ((max ((max (var_1_22 , var_1_21)) , (var_1_34 + 255.7f))) + (var_1_20 + 0.75f)))))) && ((last_1_var_1_64 <= (min (var_1_65 , var_1_15))) ? (var_1_67 == ((unsigned char) var_1_40)) : (var_1_67 == ((unsigned char) 0)))) && (var_1_68 == ((unsigned short int) var_1_55))) && (var_1_40 ? (var_1_69 == ((unsigned char) var_1_47)) : (var_1_69 == ((unsigned char) var_1_13)))) && ((2.4 == var_1_20) ? ((var_1_39 && (-8 > var_1_4)) ? (var_1_39 ? (var_1_70 == ((signed short int) (abs (var_1_46 + var_1_14)))) : 1) : (var_1_70 == ((signed short int) 50))) : 1)
;
}
int main(void) {
	isInitial = 1;
