...
void step(void) {
	// From: Req3Batch195Wrapper_P
	if (((*(var_1_13_Pointer)) - (*(var_1_14_Pointer))) > last_1_var_1_6) {
		(*(var_1_12_Pointer)) = (min (((*(var_1_3_Pointer)) - last_1_var_1_12) , (min ((*(var_1_15_Pointer)) , (*(var_1_16_Pointer))))));
	} else {
		(*(var_1_12_Pointer)) = (last_1_var_1_12 - (max ((*(var_1_17_Pointer)) , (*(var_1_3_Pointer)))));
	}


	// From: Req4Batch195Wrapper_P
	if ((*(var_1_12_Pointer)) <= ((*(var_1_17_Pointer)) * (- (*(var_1_12_Pointer))))) {
		(*(var_1_18_Pointer)) = (max ((*(var_1_12_Pointer)) , (*(var_1_19_Pointer))));
	} else {
		(*(var_1_18_Pointer)) = (*(var_1_12_Pointer));
	}


	// From: Req2Batch195Wrapper_P
	signed long int stepLocal_0 = (*(var_1_12_Pointer));
	if (stepLocal_0 <= (*(var_1_18_Pointer))) {
		(*(var_1_6_Pointer)) = (max ((min (((*(var_1_7_Pointer)) + (*(var_1_8_Pointer))) , (*(var_1_9_Pointer)))) , (min ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer))))));
	} else {
		(*(var_1_6_Pointer)) = 16.2;
	}


	// From: Req1Batch195Wrapper_P
...
int property(void) {
	return (((((*(var_1_12_Pointer)) < (*(var_1_18_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_4_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned char) ((*(var_1_4_Pointer)) && (*(var_1_5_Pointer)))))) && (((*(var_1_12_Pointer)) <= (*(var_1_18_Pointer))) ? ((*(var_1_6_Pointer)) == ((double) (max ((min (((*(var_1_7_Pointer)) + (*(var_1_8_Pointer))) , (*(var_1_9_Pointer)))) , (min ((*(var_1_10_Pointer)) , (*(var_1_11_Pointer)))))))) : ((*(var_1_6_Pointer)) == ((double) 16.2)))) && ((((*(var_1_13_Pointer)) - (*(var_1_14_Pointer))) > last_1_var_1_6) ? ((*(var_1_12_Pointer)) == ((signed long int) (min (((*(var_1_3_Pointer)) - last_1_var_1_12) , (min ((*(var_1_15_Pointer)) , (*(var_1_16_Pointer)))))))) : ((*(var_1_12_Pointer)) == ((signed long int) (last_1_var_1_12 - (max ((*(var_1_17_Pointer)) , (*(var_1_3_Pointer))))))))) && (((*(var_1_12_Pointer)) <= ((*(var_1_17_Pointer)) * (- (*(var_1_12_Pointer))))) ? ((*(var_1_18_Pointer)) == ((unsigned long int) (max ((*(var_1_12_Pointer)) , (*(var_1_19_Pointer)))))) : ((*(var_1_18_Pointer)) == ((unsigned long int) (*(var_1_12_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
