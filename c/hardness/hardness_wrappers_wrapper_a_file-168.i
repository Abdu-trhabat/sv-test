...
void step(void) {
 ...
 if (stepLocal_0 == signed_long_int_Array_0[3]) {
  signed_long_int_Array_0[4] = ((((2) > (25)) ? (2) : (25)));
 } else {
 ...
 if (stepLocal_1 >= signed_long_int_Array_0[1]) {
  if (stepLocal_2 < (signed_char_Array_0[0] - signed_long_int_Array_0[0])) {
   double_Array_0[4] = (((((double_Array_0[1]) > ((double_Array_0[0] - double_Array_0[2]))) ? (double_Array_0[1]) : ((double_Array_0[0] - double_Array_0[2])))) - double_Array_0[3]);
  }
 } else {
