...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch101Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req8Batch101Filler_PE_CI
	/* 946L, 247L, 789L, 795L) */ var_1_23 = (
		var_1_13
	);


	// From: Req3Batch101Filler_PE_CI
