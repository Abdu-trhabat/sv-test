...
void step(void) {
 ...
 var_1_19 = var_1_18;
 var_1_20 = var_1_13;
 if (((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) <= var_1_7) {
  if (var_1_1 <= var_1_7) {
   var_1_11 = (((var_1_13 - 4) - ((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15)))) - (var_1_16 - var_1_17));
  } else {
   var_1_11 = (((((var_1_18) < (var_1_14)) ? (var_1_18) : (var_1_14))) + (var_1_15 + var_1_17));
  }
 } else {
  var_1_11 = 64;
 }
...
int property(void) {
 return (((((last_1_var_1_19 != last_1_var_1_11) ? (((last_1_var_1_11 != last_1_var_1_19) && (var_1_4 < var_1_5)) ? (var_1_1 == ((signed char) var_1_6)) : 1) : 1) && ((var_1_8 && var_1_9) ? (var_1_7 == ((signed long int) ((256 - var_1_10) + last_1_var_1_7))) : 1)) && ((((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) <= var_1_7) ? ((var_1_1 <= var_1_7) ? (var_1_11 == ((unsigned char) (((var_1_13 - 4) - ((((var_1_14) > (var_1_15)) ? (var_1_14) : (var_1_15)))) - (var_1_16 - var_1_17)))) : (var_1_11 == ((unsigned char) (((((var_1_18) < (var_1_14)) ? (var_1_18) : (var_1_14))) + (var_1_15 + var_1_17))))) : (var_1_11 == ((unsigned char) 64)))) && (var_1_19 == ((signed short int) var_1_18))) && (var_1_20 == ((signed char) var_1_13))
;
}
int main(void) {
 isInitial = 1;
