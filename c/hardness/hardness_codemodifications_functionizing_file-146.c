...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch146functionizing.c", 13, "reach_error"); }
...
void functionized1(float functionized1_localFunctionVar0, float functionized1_localFunctionVar1, float functionized1_localFunctionVar2) {
	if (((min (functionized1_localFunctionVar0 , functionized1_localFunctionVar1)) <= functionized1_localFunctionVar2) && var_1_2) {
		var_1_15 = var_1_7;
	} else {
		var_1_15 = var_1_6;
	}
...
unsigned char functionized4(unsigned short int functionized4_localFunctionVar0, unsigned short int functionized4_localFunctionVar1) {
	return (functionized4_localFunctionVar1 < (functionized4_localFunctionVar0 / (var_1_20 - var_1_21)));
}
...
void step(void) {
	// From: Req1Batch146functionizing
	if (var_1_2 && var_1_3) {
		if (var_1_4 >= var_1_5) {
			var_1_1 = var_1_6;
		} else {
	...
	// From: Req2Batch146functionizing
	if (var_1_3) {
		var_1_8 = (var_1_9 + var_1_10);
	} else {
		if (var_1_4 <= ((var_1_10 / var_1_11) / (max (var_1_12 , var_1_13)))) {
			var_1_8 = var_1_9;
		}
	}


	// From: Req3Batch146functionizing
	if (functionized0() > var_1_5) {
		var_1_14 = 5;
	}


	// From: Req4Batch146functionizing
	functionized1(var_1_10, var_1_12, var_1_4);


	// From: Req5Batch146functionizing
	functionized2(var_1_17, var_1_14);


	// From: Req6Batch146functionizing
	if (var_1_2) {
		var_1_18 = functionized3(var_1_9);
	} else {
		if (var_1_7 <= (var_1_1 * (var_1_14 / var_1_19))) {
			if (functionized4(var_1_17, var_1_14)) {
				var_1_18 = var_1_9;
			}
		} else {
	...
	// From: Req7Batch146functionizing
	if (var_1_1 < var_1_17) {
		var_1_24 = (min (100 , (max (32 , var_1_21))));
	}


	// From: Req8Batch146functionizing
	var_1_25 = var_1_21;
}
...
int property(void) {
	return ((((((((var_1_2 && var_1_3) ? ((var_1_4 >= var_1_5) ? (var_1_1 == ((signed char) var_1_6)) : (var_1_1 == ((signed char) var_1_7))) : 1) && (var_1_3 ? (var_1_8 == ((float) (var_1_9 + var_1_10))) : ((var_1_4 <= ((var_1_10 / var_1_11) / (max (var_1_12 , var_1_13)))) ? (var_1_8 == ((float) var_1_9)) : 1))) && (((- var_1_4) > var_1_5) ? (var_1_14 == ((unsigned short int) 5)) : 1)) && ((((min (var_1_10 , var_1_12)) <= var_1_4) && var_1_2) ? (var_1_15 == ((signed char) var_1_7)) : (var_1_15 == ((signed char) var_1_6)))) && ((var_1_12 < var_1_9) ? ((var_1_14 <= var_1_17) ? (var_1_16 == ((signed short int) var_1_15)) : 1) : 1)) && (var_1_2 ? (var_1_18 == ((float) (abs (var_1_9)))) : ((var_1_7 <= (var_1_1 * (var_1_14 / var_1_19))) ? ((var_1_14 < (var_1_17 / (var_1_20 - var_1_21))) ? (var_1_18 == ((float) var_1_9)) : 1) : (var_1_18 == ((float) (var_1_22 - var_1_23)))))) && ((var_1_1 < var_1_17) ? (var_1_24 == ((unsigned short int) (min (100 , (max (32 , var_1_21)))))) : 1)) && (var_1_25 == ((unsigned short int) var_1_21))
;
}
int main(void) {
	isInitial = 1;
