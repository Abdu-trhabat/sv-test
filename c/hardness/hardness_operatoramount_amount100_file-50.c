...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch50Amount100.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req10Batch50Amount100
	var_1_35 = (var_1_30 - var_1_29);


	// From: Req12Batch50Amount100
	if (var_1_28 <= var_1_26) {
		var_1_37 = (! var_1_18);
	}


	// From: Req14Batch50Amount100
	var_1_39 = var_1_8;


	// From: Req15Batch50Amount100
	var_1_40 = var_1_25;


	// From: Req16Batch50Amount100
	var_1_41 = var_1_8;


	// From: Req1Batch50Amount100
	...
	// From: Req7Batch50Amount100
	if (var_1_37) {
		var_1_22 = ((max (var_1_20 , (max (var_1_23 , var_1_21)))) - (abs (-8)));
	} else {
		var_1_22 = var_1_8;
	}


	// From: Req9Batch50Amount100
	signed long int stepLocal_7 = var_1_41;
	if ((min (var_1_11 , var_1_41)) >= stepLocal_7) {
		var_1_33 = (abs (50.4));
	}


	// From: Req11Batch50Amount100
	unsigned long int stepLocal_8 = var_1_25 * var_1_20;
	if (var_1_41 >= stepLocal_8) {
		var_1_36 = (min (16 , var_1_21));
	}


	// From: Req13Batch50Amount100
	if ((var_1_29 - var_1_32) > var_1_26) {
		var_1_38 = (max (-4 , var_1_21));
	} else {
		var_1_38 = (var_1_21 + (var_1_40 - var_1_8));
	}


	// From: Req2Batch50Amount100
	...
	// From: Req4Batch50Amount100
	signed long int stepLocal_2 = var_1_41 * var_1_14;
	if (stepLocal_2 < (var_1_11 / (min (var_1_8 , var_1_9)))) {
		var_1_15 = (min (var_1_11 , var_1_10));
	} else {
		var_1_15 = var_1_8;
	}


	// From: Req6Batch50Amount100
	signed long int stepLocal_6 = var_1_41;
	signed long int stepLocal_5 = min ((var_1_20 - var_1_21) , var_1_41);
	if (stepLocal_6 > (abs (2))) {
		var_1_19 = var_1_4;
	} else {
	...
	// From: Req8Batch50Amount100
	if (((var_1_25 - var_1_11) - var_1_10) != var_1_15) {
		if (var_1_15 > var_1_40) {
			var_1_24 = (max (var_1_4 , (var_1_26 + var_1_27)));
		} else {
			var_1_24 = ((var_1_28 + var_1_29) - ((max (var_1_30 , var_1_31)) - var_1_32));
		}
	}
}
...
int property(void) {
	return ((((((((((((((((var_1_40 > var_1_41) ? (var_1_1 == ((double) (abs (var_1_4)))) : (var_1_1 == ((double) var_1_4))) && (((var_1_4 * var_1_33) == var_1_33) ? (var_1_16 ? (var_1_5 == ((unsigned short int) (((10000 + var_1_8) + var_1_9) - var_1_10))) : (var_1_5 == ((unsigned short int) (var_1_11 - var_1_8)))) : (var_1_37 ? (var_1_5 == ((unsigned short int) var_1_13)) : (var_1_5 == ((unsigned short int) var_1_9))))) && ((var_1_9 <= (var_1_11 - var_1_8)) ? (var_1_37 ? (var_1_16 ? (var_1_14 == ((unsigned short int) var_1_8)) : 1) : 1) : 1)) && (((var_1_41 * var_1_14) < (var_1_11 / (min (var_1_8 , var_1_9)))) ? (var_1_15 == ((unsigned short int) (min (var_1_11 , var_1_10)))) : (var_1_15 == ((unsigned short int) var_1_8)))) && (((var_1_9 << var_1_13) != var_1_40) ? ((var_1_10 >= (var_1_9 * var_1_13)) ? (var_1_16 == ((unsigned char) var_1_17)) : (var_1_16 == ((unsigned char) var_1_18))) : (var_1_16 == ((unsigned char) var_1_18)))) && ((var_1_41 > (abs (2))) ? (var_1_19 == ((double) var_1_4)) : (((min ((var_1_20 - var_1_21) , var_1_41)) >= (var_1_15 - var_1_13)) ? (var_1_19 == ((double) var_1_4)) : (var_1_19 == ((double) 2.2))))) && (var_1_37 ? (var_1_22 == ((signed short int) ((max (var_1_20 , (max (var_1_23 , var_1_21)))) - (abs (-8))))) : (var_1_22 == ((signed short int) var_1_8)))) && ((((var_1_25 - var_1_11) - var_1_10) != var_1_15) ? ((var_1_15 > var_1_40) ? (var_1_24 == ((float) (max (var_1_4 , (var_1_26 + var_1_27))))) : (var_1_24 == ((float) ((var_1_28 + var_1_29) - ((max (var_1_30 , var_1_31)) - var_1_32))))) : 1)) && (((min (var_1_11 , var_1_41)) >= var_1_41) ? (var_1_33 == ((double) (abs (50.4)))) : 1)) && (var_1_35 == ((double) (var_1_30 - var_1_29)))) && ((var_1_41 >= (var_1_25 * var_1_20)) ? (var_1_36 == ((unsigned char) (min (16 , var_1_21)))) : 1)) && ((var_1_28 <= var_1_26) ? (var_1_37 == ((unsigned char) (! var_1_18))) : 1)) && (((var_1_29 - var_1_32) > var_1_26) ? (var_1_38 == ((signed short int) (max (-4 , var_1_21)))) : (var_1_38 == ((signed short int) (var_1_21 + (var_1_40 - var_1_8)))))) && (var_1_39 == ((signed short int) var_1_8))) && (var_1_40 == ((signed long int) var_1_25))) && (var_1_41 == ((signed long int) var_1_8))
;
}
int main(void) {
	isInitial = 1;
