...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch116stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch116stepLocals
	unsigned char stepLocal_0 = var_1_2 <= var_1_5;
	if ((var_1_4 < var_1_1) || stepLocal_0) {
		if (var_1_6) {
			var_1_7 = var_1_2;
		}
	}
	...
	// From: Req6Batch116stepLocals
	if ((var_1_12 * var_1_7) > var_1_1) {
		var_1_15 = (max (var_1_13 , var_1_12));
	} else {
		var_1_15 = ((max ((var_1_16 - var_1_9) , var_1_2)) - 4);
	}


	// From: Req7Batch116stepLocals
	if (var_1_6) {
		var_1_17 = (max ((min (var_1_2 , var_1_10)) , -25));
	} else {
		if (var_1_1 >= var_1_2) {
