...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch113Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch113Amount25
	if (var_1_2 >= var_1_6) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch113Amount25
	if (-64 >= var_1_1) {
		if ((-1000 < 256) && ((max (var_1_3 , var_1_6)) > var_1_4)) {
			if (var_1_4 < var_1_5) {
				var_1_9 = var_1_11;
			}
		} else {
