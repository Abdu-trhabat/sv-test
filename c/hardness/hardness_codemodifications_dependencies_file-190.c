...
void step(void) {
	...
	// From: Req7Batch190dependencies
	if (var_1_12 == var_1_11) {
		var_1_25 = ((var_1_26 - var_1_10) + var_1_18);
	}


	// From: Req1Batch190dependencies
	if (var_1_7 <= var_1_22) {
		if (var_1_22 <= var_1_7) {
			var_1_1 = var_1_4;
		} else {
