...
void step(void) {
	...
	if (var_1_3 < var_1_8) {
		if (((- 8) / (var_1_13 - var_1_14)) >= var_1_6) {
			var_1_11 = (var_1_1 - (var_1_15 - var_1_14));
		}
	}
