...
void step(void) {
 ...
 if (((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) - (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer))) < (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
  if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) || ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) >= (((((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))) > ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer)))) ? ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var2_Pointer))) : ((*(signed_short_int_Array_0_arraysigned_short_int_Array_0Var3_Pointer))))))) {
