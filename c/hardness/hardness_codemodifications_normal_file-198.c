...
void step(void) {
	...
	if (var_1_8 > var_1_5) {
		if (var_1_6) {
			if (var_1_9 <= (max (var_1_8 , var_1_5))) {
				var_1_10 = var_1_5;
			} else {
	...
	// From: Req5Batch198normal
	if (var_1_6 && var_1_15) {
		var_1_14 = ((64 - 4) + var_1_16);
	}


	// From: Req6Batch198normal
	if (var_1_2 > ((64 - var_1_18) - var_1_16)) {
		if (((var_1_19 - var_1_16) - (min (var_1_18 , 32))) >= (min (var_1_5 , (var_1_8 / var_1_11)))) {
			var_1_17 = var_1_9;
		}
	} else {
		var_1_17 = var_1_9;
