...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15525_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch15525_1loop
	if (var_1_2 < var_1_3) {
		var_1_1 = (var_1_4 + (var_1_5 + 64));
	}


	// From: Req3Batch15525_1loop
	var_1_8 = (! var_1_9);


	// From: Req4Batch15525_1loop
	var_1_10 = (min (var_1_11 , var_1_12));


	// From: Req5Batch15525_1loop
	var_1_13 = var_1_11;


	// From: Req6Batch15525_1loop
	var_1_14 = var_1_1;


	// From: Req2Batch15525_1loop
