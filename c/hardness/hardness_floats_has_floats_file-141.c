...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch141has_floats.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req2Batch141has_floats
	if (last_1_var_1_10) {
		var_1_6 = (var_1_8 + var_1_9);
	}


	// From: Req3Batch141has_floats
	...
	// From: Req4Batch141has_floats
	var_1_14 = var_1_6;


	// From: Req5Batch141has_floats
	var_1_15 = var_1_14;


	// From: Req6Batch141has_floats
	var_1_16 = var_1_4;
}
