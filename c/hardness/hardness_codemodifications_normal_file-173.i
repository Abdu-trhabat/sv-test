...
void step(void) {
 ...
 if (var_1_13 > 2) {
  if (var_1_9) {
   var_1_15 = ((((((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))) > ((2813524572u - var_1_8))) ? (((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))) : ((2813524572u - var_1_8))));
  } else {
   var_1_15 = ((((var_1_8) < (var_1_14)) ? (var_1_8) : (var_1_14)));
  }
 } else {
...
int property(void) {
 return ((((((! (100u >= var_1_2)) ? (var_1_1 == ((float) ((((var_1_3) > (var_1_4)) ? (var_1_3) : (var_1_4))))) : (var_1_1 == ((float) ((var_1_5 - var_1_6) + var_1_7)))) && (var_1_9 ? (((var_1_10 / var_1_11) != var_1_2) ? (var_1_8 == ((unsigned char) ((var_1_12 + var_1_13) + var_1_14))) : (var_1_8 == ((unsigned char) var_1_14))) : (var_1_8 == ((unsigned char) var_1_12)))) && ((var_1_13 > 2) ? (var_1_9 ? (var_1_15 == ((unsigned long int) ((((((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))) > ((2813524572u - var_1_8))) ? (((((var_1_13) < 0 ) ? -(var_1_13) : (var_1_13)))) : ((2813524572u - var_1_8)))))) : (var_1_15 == ((unsigned long int) ((((var_1_8) < (var_1_14)) ? (var_1_8) : (var_1_14)))))) : (var_1_15 == ((unsigned long int) (var_1_8 + 100u))))) && ((var_1_11 <= -128) ? ((var_1_6 <= var_1_7) ? (var_1_16 == ((float) var_1_5)) : 1) : 1)) && (((var_1_18 - var_1_12) >= (~ var_1_14)) ? (var_1_9 ? (var_1_17 == ((unsigned char) (((((var_1_19 - var_1_14)) > (var_1_12)) ? ((var_1_19 - var_1_14)) : (var_1_12))))) : (var_1_17 == ((unsigned char) var_1_12))) : (var_1_17 == ((unsigned char) var_1_14)))) && (((((((var_1_4) > (var_1_3)) ? (var_1_4) : (var_1_3))) >= var_1_5) || var_1_9) ? ((var_1_8 > var_1_13) ? (var_1_9 ? (var_1_20 == ((unsigned char) var_1_21)) : (var_1_20 == ((unsigned char) 0))) : (var_1_20 == ((unsigned char) 0))) : (var_1_20 == ((unsigned char) var_1_22)))
;
}
int main(void) {
 isInitial = 1;
