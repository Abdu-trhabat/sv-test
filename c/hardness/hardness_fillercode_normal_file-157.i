...
void step(void) {
 if (var_1_2 < var_1_3) {
  if (var_1_3 <= var_1_2) {
   var_1_1 = (((((1) > (var_1_4)) ? (1) : (var_1_4))) - var_1_5);
  } else {
   var_1_1 = var_1_4;
  }
 } else {
 ...
 if ((- 16.75) <= var_1_11) {
  ...
  var_1_13 = ((((var_1_21) > (var_1_10)) ? (var_1_21) : (var_1_10)));
 }
}
void updateVariables(void) {
...
int property(void) {
 return (((((((((var_1_2 < var_1_3) ? ((var_1_3 <= var_1_2) ? (var_1_1 == ((signed long int) (((((1) > (var_1_4)) ? (1) : (var_1_4))) - var_1_5))) : (var_1_1 == ((signed long int) var_1_4))) : (var_1_1 == ((signed long int) var_1_4))) && ((32.5 >= var_1_11) ? ((var_1_7 && var_1_8) ? (var_1_6 == ((signed char) -4)) : 1) : 1)) && ((((var_1_5 / var_1_10) < var_1_1) && var_1_7) ? (var_1_9 == ((signed char) 32)) : 1)) && (var_1_11 == ((double) 199.4))) && ((((var_1_11 * var_1_3) > var_1_2) && (var_1_10 != var_1_21)) ? (var_1_12 == ((float) 32.75f)) : 1)) && (((- 16.75) <= var_1_11) ? (var_1_13 == ((signed short int) (var_1_10 - var_1_14))) : (var_1_13 == ((signed short int) ((((var_1_21) > (var_1_10)) ? (var_1_21) : (var_1_10))))))) && ((var_1_8 || ((var_1_5 * var_1_14) <= (~ 100000000))) ? ((var_1_14 >= (var_1_10 - 10)) ? ((! var_1_8) ? (var_1_15 == ((signed char) var_1_16)) : 1) : 1) : (var_1_15 == ((signed char) (var_1_17 - ((var_1_18 + var_1_19) - var_1_20)))))) && (var_1_21 == ((signed long int) last_1_var_1_21))) && (var_1_22 == ((unsigned long int) var_1_18))
;
}
int main(void) {
 isInitial = 1;
