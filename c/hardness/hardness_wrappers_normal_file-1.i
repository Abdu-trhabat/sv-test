...
void step(void) {
 ...
 if (var_1_5) {
  var_1_10 = ((var_1_11 - var_1_12) + (((((var_1_13) < (8)) ? (var_1_13) : (8))) + ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14)))));
 }
 signed long int stepLocal_0 = var_1_7;
 if (((((var_1_8) < (var_1_7)) ? (var_1_8) : (var_1_7))) > stepLocal_0) {
  var_1_16 = ((((((((var_1_13) > (var_1_7)) ? (var_1_13) : (var_1_7)))) < (var_1_12)) ? (((((var_1_13) > (var_1_7)) ? (var_1_13) : (var_1_7)))) : (var_1_12)));
 } else {
  var_1_16 = ((((var_1_11) < (var_1_13)) ? (var_1_11) : (var_1_13)));
 }
 var_1_17 = var_1_4;
 var_1_18 = var_1_6;
...
int property(void) {
 return (((((((var_1_18 <= (- var_1_17)) ? (var_1_1 == ((float) ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4))))) : (var_1_5 ? (var_1_1 == ((float) var_1_4)) : (var_1_1 == ((float) var_1_6)))) && (var_1_7 == ((signed long int) (var_1_8 + var_1_9)))) && (var_1_5 ? (var_1_10 == ((unsigned char) ((var_1_11 - var_1_12) + (((((var_1_13) < (8)) ? (var_1_13) : (8))) + ((((var_1_14) < 0 ) ? -(var_1_14) : (var_1_14))))))) : 1)) && ((var_1_17 < 1.25f) ? (var_1_15 == ((signed char) var_1_13)) : 1)) && ((((((var_1_8) < (var_1_7)) ? (var_1_8) : (var_1_7))) > var_1_7) ? (var_1_16 == ((unsigned long int) ((((((((var_1_13) > (var_1_7)) ? (var_1_13) : (var_1_7)))) < (var_1_12)) ? (((((var_1_13) > (var_1_7)) ? (var_1_13) : (var_1_7)))) : (var_1_12))))) : (var_1_16 == ((unsigned long int) ((((var_1_11) < (var_1_13)) ? (var_1_11) : (var_1_13))))))) && (var_1_17 == ((double) var_1_4))) && (var_1_18 == ((double) var_1_6))
;
}
int main(void) {
 isInitial = 1;
