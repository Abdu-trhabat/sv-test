...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch168stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch168stepLocals
	unsigned long int stepLocal_2 = 100u;
	...
	if (stepLocal_1 > var_1_3) {
		...
		if ((var_1_6 - (var_1_7 + var_1_8)) < stepLocal_0) {
			...
			if ((var_1_10 - var_1_8) > stepLocal_2) {
				var_1_1 = var_1_5;
			} else {
				var_1_1 = var_1_4;
			}
	...
	// From: Req2Batch168stepLocals
	if (-128 < (var_1_8 ^ (var_1_2 * var_1_3))) {
		var_1_11 = var_1_7;
	}


	// From: Req3Batch168stepLocals
	if (((var_1_1 + var_1_4) * var_1_5) >= var_1_13) {
		var_1_12 = var_1_14;
	}


	// From: Req4Batch168stepLocals
	var_1_15 = (min ((var_1_16 + var_1_17) , (max (var_1_18 , var_1_19))));


	// From: Req5Batch168stepLocals
	if (! var_1_21) {
		if (var_1_21) {
	...
	// From: Req7Batch168stepLocals
	var_1_27 = var_1_4;


	// From: Req8Batch168stepLocals
	var_1_28 = var_1_22;
}
...
int property(void) {
	return ((((((((var_1_2 > var_1_3) ? (var_1_1 == ((double) (min (((var_1_4 - 8.25) + var_1_5) , 49.75)))) : (((var_1_6 - (var_1_7 + var_1_8)) < var_1_9) ? (var_1_1 == ((double) (31.8 + var_1_4))) : (((var_1_10 - var_1_8) > 100u) ? (var_1_1 == ((double) var_1_5)) : (var_1_1 == ((double) var_1_4))))) && ((-128 < (var_1_8 ^ (var_1_2 * var_1_3))) ? (var_1_11 == ((unsigned long int) var_1_7)) : 1)) && ((((var_1_1 + var_1_4) * var_1_5) >= var_1_13) ? (var_1_12 == ((signed char) var_1_14)) : 1)) && (var_1_15 == ((unsigned char) (min ((var_1_16 + var_1_17) , (max (var_1_18 , var_1_19))))))) && ((! var_1_21) ? (var_1_21 ? (var_1_20 == ((float) (var_1_4 + 25.5f))) : (var_1_20 == ((float) ((max ((min (var_1_4 , var_1_22)) , var_1_23)) - var_1_24)))) : (var_1_25 ? (var_1_20 == ((float) var_1_23)) : (var_1_20 == ((float) var_1_5))))) && (var_1_25 ? ((-10 < var_1_18) ? (var_1_26 == ((unsigned long int) (abs (var_1_17)))) : 1) : 1)) && (var_1_27 == ((double) var_1_4))) && (var_1_28 == ((double) var_1_22))
;
}
int main(void) {
	isInitial = 1;
