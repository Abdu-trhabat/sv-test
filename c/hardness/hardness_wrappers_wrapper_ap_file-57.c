...
void step(void) {
	...
	if (! ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var3_Pointer)) >= (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)))) {
		if (((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer)) || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer))) && stepLocal_0) {
			(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)) = (min ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))));
		} else {
	...
	signed long int stepLocal_4 = (max ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) , (*(signed_char_Array_0_arraysigned_char_Array_0Var6_Pointer)))) << (max ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) , (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer))));
