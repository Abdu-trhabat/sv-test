...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch48normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch48normal
	if (var_1_2) {
		var_1_13 = var_1_11;
	}


	// From: Req5Batch48normal
