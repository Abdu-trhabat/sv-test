...
void step(void) {
	...
	// From: Req2Batch12950_1loop
	if (((var_1_10 - var_1_11) - var_1_12) < var_1_2) {
		var_1_9 = var_1_8;
	}


	// From: Req3Batch12950_1loop
