...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch156normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch156normal
	if (var_1_5 > var_1_4) {
		var_1_7 = var_1_8;
	}


	// From: Req3Batch156normal
	if (var_1_7) {
		var_1_9 = (min ((last_1_var_1_9 + -8) , (max ((abs (var_1_3)) , var_1_10))));
	}


	// From: Req4Batch156normal
	...
	// From: Req8Batch156normal
	var_1_22 = var_1_3;


	// From: Req1Batch156normal
