...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch184Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req5Batch184Amount25
	var_1_14 = var_1_6;


	// From: Req1Batch184Amount25
