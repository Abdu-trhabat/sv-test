...
void step(void) {
	...
	if (var_1_4 <= last_1_var_1_17) {
		if (var_1_2 && (last_1_var_1_17 == (max (var_1_16 , var_1_12)))) {
	...
	unsigned long int stepLocal_1 = (max (var_1_11 , var_1_12)) - var_1_13;
