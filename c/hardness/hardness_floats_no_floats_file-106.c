...
void step(void) {
	// From: Req1Batch106no_floats
	var_1_1 = var_1_2;


	// From: Req2Batch106no_floats
	if (var_1_4) {
		if (var_1_5) {
	...
	// From: Req5Batch106no_floats
	var_1_18 = var_1_19;


	// From: Req6Batch106no_floats
	var_1_20 = var_1_14;


	// From: Req7Batch106no_floats
	var_1_21 = var_1_9;


	// From: Req3Batch106no_floats
	if ((var_1_21 * var_1_9) >= var_1_7) {
		var_1_10 = (var_1_7 - (abs (min (var_1_9 , var_1_6))));
	}


	// From: Req4Batch106no_floats
