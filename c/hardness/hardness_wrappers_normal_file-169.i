...
void step(void) {
 ...
 if (var_1_6 > var_1_14) {
  if (var_1_11) {
   var_1_10 = (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))) - var_1_13);
  } else {
   var_1_10 = var_1_12;
  }
 } else {
...
int property(void) {
 return ((((((var_1_2 >= (var_1_3 + var_1_4)) ? (var_1_1 == ((signed short int) (var_1_5 - var_1_6))) : 1) && ((var_1_5 >= ((var_1_8 - var_1_9) - var_1_6)) ? ((var_1_2 == ((((var_1_3) > ((- var_1_4))) ? (var_1_3) : ((- var_1_4))))) ? (var_1_7 == ((unsigned long int) (var_1_6 + var_1_8))) : ((var_1_4 >= var_1_3) ? (var_1_7 == ((unsigned long int) var_1_9)) : 1)) : (var_1_7 == ((unsigned long int) var_1_6)))) && ((var_1_6 > var_1_14) ? (var_1_11 ? (var_1_10 == ((double) (((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12))) - var_1_13))) : (var_1_10 == ((double) var_1_12))) : (var_1_10 == ((double) var_1_13)))) && (var_1_14 == ((signed long int) var_1_9))) && (var_1_15 == ((unsigned short int) var_1_8))) && (var_1_16 == ((signed short int) var_1_5))
;
}
int main(void) {
 isInitial = 1;
