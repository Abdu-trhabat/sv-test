...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch132Filler_PS_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 419L, 195L) */ if (var_1_9) {
		/* 421L, 193L) */ if (/* 422L, 174L, 175L) */ ((var_1_33) < (var_1_10))) {
			/* 425L, 188L) */ var_1_34 = (
				/* 428L, 187L) */ ((
					var_1_30
				) + (
