...
int property(void) {
	return (((((*(WrapperStruct00_var_1_2_Pointer)) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned char) (max ((max (((*(WrapperStruct00_var_1_3_Pointer)) + (*(WrapperStruct00_var_1_4_Pointer))) , 50)) , (*(WrapperStruct00_var_1_5_Pointer)))))) : (((*(WrapperStruct00_var_1_6_Pointer)) && (*(WrapperStruct00_var_1_7_Pointer))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned char) (*(WrapperStruct00_var_1_5_Pointer)))) : ((((*(WrapperStruct00_var_1_4_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer))) < (*(WrapperStruct00_var_1_5_Pointer))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned char) (*(WrapperStruct00_var_1_4_Pointer)))) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned char) 5))))) && ((*(WrapperStruct00_var_1_7_Pointer)) ? ((*(WrapperStruct00_var_1_8_Pointer)) == ((unsigned short int) (abs ((*(WrapperStruct00_var_1_5_Pointer)))))) : ((*(WrapperStruct00_var_1_8_Pointer)) == ((unsigned short int) ((*(WrapperStruct00_var_1_15_Pointer)) + (*(WrapperStruct00_var_1_3_Pointer))))))) && (((*(WrapperStruct00_var_1_5_Pointer)) <= (max ((*(WrapperStruct00_var_1_3_Pointer)) , ((*(WrapperStruct00_var_1_10_Pointer)) - (*(WrapperStruct00_var_1_4_Pointer)))))) ? ((((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_11_Pointer))) > ((*(WrapperStruct00_var_1_15_Pointer)) * ((*(WrapperStruct00_var_1_15_Pointer)) + (*(WrapperStruct00_var_1_5_Pointer))))) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((unsigned short int) 128)) : 1) : 1)) && ((*(WrapperStruct00_var_1_13_Pointer)) == ((signed char) (*(WrapperStruct00_var_1_14_Pointer))))) && ((*(WrapperStruct00_var_1_15_Pointer)) == ((unsigned long int) (*(WrapperStruct00_var_1_3_Pointer))))
;
}
int main(void) {
	isInitial = 1;
