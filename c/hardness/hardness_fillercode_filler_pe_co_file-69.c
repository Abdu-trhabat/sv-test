...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch69Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req9Batch69Filler_PE_CO
	/* 1224L, 315L, 1001L, 1007L) */ var_1_23 = (
		var_1_14
	);


	// From: Req1Batch69Filler_PE_CO
	...
	// From: Req7Batch69Filler_PE_CO
	/* 1212L, 295L, 953L, 959L) */ var_1_21 = (
		var_1_13
	);


	// From: Req8Batch69Filler_PE_CO
	...
	/* 307L, 201L) */ if (var_1_25) {
		...
		/* 324L, 199L) */ if (/* 325L, 138L, 139L) */ ((/* 326L, 134L, 140L) */ ((var_1_28) % (var_1_34))) != (/* 329L, 137L, 143L) */ ((var_1_14) + (var_1_30))))) {
			/* 332L, 182L) */ if (/* 333L, 157L, 158L) */ ((/* 334L, 155L, 159L) */ (min (/* 334L, 155L, 159L) */ (8.4f) , (var_1_16)))) < (127.2f))) {
				/* 338L, 172L) */ var_1_32 = (
					/* 341L, 171L) */ (abs (
						var_1_36
					))
	...
	// From: CodeObject7
	/* 371L, 267L) */ if (/* 372L, 229L, 230L) */ ((var_1_19) > (/* 374L, 228L, 232L) */ (abs (var_1_34))))) {
		/* 376L, 265L) */ if (/* 377L, 240L, 241L) */ ((var_1_34) >= (var_1_39))) {
