...
void step(void) {
	...
	// From: Req3Batch120stepLocals
	var_1_11 = (min (var_1_2 , (max (var_1_3 , var_1_12))));


	// From: Req4Batch120stepLocals
	if (var_1_5) {
		var_1_13 = (var_1_14 && (! var_1_15));
	}


	// From: Req5Batch120stepLocals
	if (! var_1_5) {
		var_1_16 = var_1_17;
	}


	// From: Req6Batch120stepLocals
...
int property(void) {
	return ((((((((var_1_2 <= var_1_3) ? ((! (var_1_4 && var_1_5)) ? (var_1_1 == ((float) (var_1_6 + (max ((var_1_7 - var_1_8) , var_1_9))))) : (var_1_1 == ((float) var_1_7))) : (var_1_1 == ((float) var_1_9))) && ((var_1_3 != var_1_2) ? (var_1_4 ? (((var_1_7 + var_1_1) >= (var_1_8 / 0.5f)) ? (var_1_10 == ((double) var_1_6)) : (var_1_10 == ((double) var_1_8))) : 1) : 1)) && (var_1_11 == ((signed short int) (min (var_1_2 , (max (var_1_3 , var_1_12))))))) && (var_1_5 ? (var_1_13 == ((unsigned char) (var_1_14 && (! var_1_15)))) : 1)) && ((! var_1_5) ? (var_1_16 == ((unsigned char) var_1_17)) : 1)) && (((- (var_1_16 % var_1_19)) >= var_1_12) ? ((((var_1_12 * var_1_2) ^ (8 & var_1_11)) <= (128 / -100)) ? (var_1_18 == ((signed long int) ((var_1_19 - var_1_17) + var_1_16))) : 1) : (var_1_18 == ((signed long int) var_1_17)))) && ((var_1_14 || var_1_15) ? (var_1_20 == ((unsigned short int) (var_1_21 - (min (var_1_19 , var_1_17))))) : 1)) && (var_1_22 == ((unsigned char) var_1_14))
;
}
int main(void) {
	isInitial = 1;
