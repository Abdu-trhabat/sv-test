...
void step(void) {
	...
	// From: Req4Batch60Wrapper_AP
	(*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer)) = 500.25;


	// From: Req5Batch60Wrapper_AP
	if ((*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer)) > (*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer))) {
		if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer))) {
			if ((*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer)) <= (min ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer))))) {
