...
void step(void) {
	...
	// From: Req1Batch140Wrapper_P
	unsigned char stepLocal_1 = (*(var_1_2_Pointer));
	signed long int stepLocal_0 = -5 * -8;
	if (stepLocal_1 && (*(var_1_3_Pointer))) {
		if ((max ((abs ((*(var_1_4_Pointer)))) , (*(var_1_9_Pointer)))) < stepLocal_0) {
			(*(var_1_1_Pointer)) = ((*(var_1_6_Pointer)) - (*(var_1_7_Pointer)));
		} else {
			if ((*(var_1_3_Pointer))) {
				(*(var_1_1_Pointer)) = (max ((max (((*(var_1_4_Pointer)) + (*(var_1_9_Pointer))) , (*(var_1_7_Pointer)))) , (max ((*(var_1_6_Pointer)) , (*(var_1_8_Pointer))))));
			} else {
				(*(var_1_1_Pointer)) = 4;
			}
		}
...
int property(void) {
	return ((((*(var_1_2_Pointer)) && (*(var_1_3_Pointer))) ? (((max ((abs ((*(var_1_4_Pointer)))) , (*(var_1_9_Pointer)))) < (-5 * -8)) ? ((*(var_1_1_Pointer)) == ((signed long int) ((*(var_1_6_Pointer)) - (*(var_1_7_Pointer))))) : ((*(var_1_3_Pointer)) ? ((*(var_1_1_Pointer)) == ((signed long int) (max ((max (((*(var_1_4_Pointer)) + (*(var_1_9_Pointer))) , (*(var_1_7_Pointer)))) , (max ((*(var_1_6_Pointer)) , (*(var_1_8_Pointer)))))))) : ((*(var_1_1_Pointer)) == ((signed long int) 4)))) : 1) && (((- 256.5f) > ((*(var_1_10_Pointer)) - (*(var_1_11_Pointer)))) ? (((*(var_1_11_Pointer)) >= (*(var_1_10_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed char) (*(var_1_12_Pointer)))) : 1) : ((*(var_1_9_Pointer)) == ((signed char) (*(var_1_12_Pointer)))))) && (((*(var_1_8_Pointer)) >= (*(var_1_12_Pointer))) ? ((*(var_1_13_Pointer)) == ((float) (*(var_1_14_Pointer)))) : ((*(var_1_13_Pointer)) == ((float) ((*(var_1_15_Pointer)) + ((*(var_1_16_Pointer)) - 2.6f)))))
;
}
int main(void) {
	isInitial = 1;
