...
void step(void) {
	// From: Req4Batch105Amount50
	if ((var_1_18 - (max (var_1_19 , var_1_20))) > 0.0) {
		var_1_17 = var_1_9;
	}


	// From: Req5Batch105Amount50
	if (var_1_2 || var_1_8) {
		var_1_21 = ((var_1_22 + var_1_23) + 3.75);
	}


	// From: Req1Batch105Amount50
	if (var_1_21 != 255.6) {
		var_1_1 = var_1_4;
	} else {
	...
	// From: Req6Batch105Amount50
	if ((var_1_19 - var_1_20) > (min ((min (var_1_1 , var_1_21)) , var_1_21))) {
		if (! var_1_2) {
...
int property(void) {
	return (((((((var_1_21 != 255.6) ? (var_1_1 == ((float) var_1_4)) : (var_1_1 == ((float) (max (var_1_4 , var_1_5))))) && (var_1_2 ? (var_1_6 == ((signed short int) var_1_7)) : ((var_1_21 >= var_1_1) ? (var_1_8 ? (var_1_6 == ((signed short int) ((var_1_9 - var_1_10) + ((var_1_11 - 100) - var_1_12)))) : (var_1_6 == ((signed short int) 64))) : (var_1_6 == ((signed short int) var_1_11))))) && ((var_1_26 == var_1_4) ? (var_1_13 == ((unsigned char) (max (var_1_14 , (max (var_1_15 , var_1_16)))))) : (var_1_8 ? (var_1_13 == ((unsigned char) 0)) : (var_1_13 == ((unsigned char) var_1_15))))) && (((var_1_18 - (max (var_1_19 , var_1_20))) > 0.0) ? (var_1_17 == ((signed short int) var_1_9)) : 1)) && ((var_1_2 || var_1_8) ? (var_1_21 == ((double) ((var_1_22 + var_1_23) + 3.75))) : 1)) && (((var_1_19 - var_1_20) > (min ((min (var_1_1 , var_1_21)) , var_1_21))) ? ((! var_1_2) ? (var_1_24 == ((unsigned long int) (abs (var_1_10)))) : (var_1_24 == ((unsigned long int) var_1_9))) : 1)) && ((var_1_7 >= (max (var_1_24 , var_1_11))) ? (var_1_26 == ((float) (var_1_22 + var_1_23))) : 1)
;
}
int main(void) {
	isInitial = 1;
