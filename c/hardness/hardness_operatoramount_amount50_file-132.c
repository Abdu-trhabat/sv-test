...
void step(void) {
	...
	// From: Req3Batch132Amount50
	var_1_9 = (! 0);


	// From: Req6Batch132Amount50
	if (var_1_5 != var_1_13) {
		if (var_1_5 <= var_1_1) {
