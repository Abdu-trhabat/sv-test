...
void step(void) {
	// From: Req1Batch141stepLocals
	if (var_1_2) {
		var_1_1 = (((var_1_3 + 4.275) + (var_1_4 + var_1_5)) - var_1_6);
	}


	// From: Req2Batch141stepLocals
	if (var_1_6 > var_1_5) {
		if (var_1_3 != 199.5) {
	...
	// From: Req3Batch141stepLocals
	if (var_1_5 <= var_1_7) {
		var_1_8 = (var_1_9 - var_1_10);
	}


	// From: Req4Batch141stepLocals
	var_1_11 = (min ((var_1_9 - var_1_10) , var_1_8));


	// From: Req5Batch141stepLocals
	var_1_12 = (min (var_1_13 , (var_1_14 + var_1_15)));


	// From: Req6Batch141stepLocals
	if (var_1_2) {
