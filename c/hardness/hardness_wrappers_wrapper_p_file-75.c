...
void step(void) {
	...
	signed long int stepLocal_0 = max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)));
	...
	if ((- (*(var_1_9_Pointer))) >= (*(var_1_10_Pointer))) {
		if ((*(var_1_11_Pointer))) {
			(*(var_1_8_Pointer)) = (abs ((min ((*(var_1_2_Pointer)) , last_1_var_1_8)) + (max ((*(var_1_1_Pointer)) , (*(var_1_3_Pointer))))));
		} else {
	...
	if (2.8f == (*(var_1_10_Pointer))) {
		(*(var_1_12_Pointer)) = ((max ((max ((*(var_1_13_Pointer)) , 16)) , (*(var_1_14_Pointer)))) + (*(var_1_15_Pointer)));
	}


	// From: Req4Batch75Wrapper_P
	(*(var_1_16_Pointer)) = (min (-4 , (*(var_1_14_Pointer))));
...
int property(void) {
	return (((((((last_1_var_1_1 * last_1_var_1_8) * last_1_var_1_8) < (max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer))))) ? ((*(var_1_1_Pointer)) == ((unsigned char) (*(var_1_7_Pointer)))) : ((*(var_1_1_Pointer)) == ((unsigned char) 10))) && (((- (*(var_1_9_Pointer))) >= (*(var_1_10_Pointer))) ? ((*(var_1_11_Pointer)) ? ((*(var_1_8_Pointer)) == ((signed short int) (abs ((min ((*(var_1_2_Pointer)) , last_1_var_1_8)) + (max ((*(var_1_1_Pointer)) , (*(var_1_3_Pointer)))))))) : ((*(var_1_8_Pointer)) == ((signed short int) ((*(var_1_3_Pointer)) + (*(var_1_1_Pointer)))))) : 1)) && ((2.8f == (*(var_1_10_Pointer))) ? ((*(var_1_12_Pointer)) == ((signed char) ((max ((max ((*(var_1_13_Pointer)) , 16)) , (*(var_1_14_Pointer)))) + (*(var_1_15_Pointer))))) : 1)) && ((*(var_1_16_Pointer)) == ((signed char) (min (-4 , (*(var_1_14_Pointer))))))) && (((*(var_1_1_Pointer)) > ((*(var_1_8_Pointer)) + (*(var_1_16_Pointer)))) ? ((*(var_1_17_Pointer)) == ((float) (*(var_1_18_Pointer)))) : 1)
;
}
int main(void) {
	isInitial = 1;
