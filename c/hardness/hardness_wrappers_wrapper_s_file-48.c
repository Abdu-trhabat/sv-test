...
void step(void) {
	...
	if (WrapperStruct00.var_1_8) {
		if (((abs (16)) + WrapperStruct00.var_1_9) <= WrapperStruct00.var_1_10) {
			WrapperStruct00.var_1_7 = (max (0 , WrapperStruct00.var_1_11));
		} else {
			WrapperStruct00.var_1_7 = (WrapperStruct00.var_1_12 + (abs (5)));
		}
	}
	...
	if ((WrapperStruct00.var_1_12 * WrapperStruct00.var_1_10) < WrapperStruct00.var_1_7) {
		WrapperStruct00.var_1_13 = (max (WrapperStruct00.var_1_6 , (WrapperStruct00.var_1_14 + (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16))));
	} else {
		if ((max (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_10)) <= 50) {
...
int property(void) {
	return (((WrapperStruct00.var_1_2 <= WrapperStruct00.var_1_3) ? ((WrapperStruct00.var_1_3 < ((WrapperStruct00.var_1_4 - WrapperStruct00.var_1_5) + 1.395f)) ? (WrapperStruct00.var_1_1 == ((float) WrapperStruct00.var_1_6)) : (WrapperStruct00.var_1_1 == ((float) 3.25f))) : (WrapperStruct00.var_1_1 == ((float) WrapperStruct00.var_1_6))) && (WrapperStruct00.var_1_8 ? ((((abs (16)) + WrapperStruct00.var_1_9) <= WrapperStruct00.var_1_10) ? (WrapperStruct00.var_1_7 == ((unsigned short int) (max (0 , WrapperStruct00.var_1_11)))) : (WrapperStruct00.var_1_7 == ((unsigned short int) (WrapperStruct00.var_1_12 + (abs (5)))))) : 1)) && (((WrapperStruct00.var_1_12 * WrapperStruct00.var_1_10) < WrapperStruct00.var_1_7) ? (WrapperStruct00.var_1_13 == ((float) (max (WrapperStruct00.var_1_6 , (WrapperStruct00.var_1_14 + (WrapperStruct00.var_1_15 + WrapperStruct00.var_1_16)))))) : (((max (WrapperStruct00.var_1_7 , WrapperStruct00.var_1_10)) <= 50) ? (WrapperStruct00.var_1_13 == ((float) WrapperStruct00.var_1_16)) : (WrapperStruct00.var_1_13 == ((float) WrapperStruct00.var_1_15))))
;
}
int main(void) {
	isInitial = 1;
