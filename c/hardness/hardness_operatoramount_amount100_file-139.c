...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch139Amount100.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch139Amount100
	var_1_14 = (abs (var_1_7));


	// From: Req4Batch139Amount100
	signed long int stepLocal_3 = var_1_16 - 2;
	signed long int stepLocal_2 = min (var_1_13 , var_1_8);
	if (stepLocal_3 == var_1_11) {
		var_1_15 = (var_1_6 + (abs (var_1_17 - 8.5)));
	} else {
		if (var_1_12 < stepLocal_2) {
			var_1_15 = ((max (var_1_17 , 31.4)) - var_1_18);
		} else {
			var_1_15 = var_1_17;
		}
	}
	...
	// From: Req10Batch139Amount100
	if (var_1_2 > var_1_8) {
		var_1_31 = 128.75f;
	}


	// From: Req11Batch139Amount100
	...
	// From: Req7Batch139Amount100
	unsigned long int stepLocal_6 = (min (var_1_19 , var_1_10)) + var_1_12;
	if (var_1_9) {
		if (1 >= stepLocal_6) {
			if (var_1_23) {
				var_1_25 = var_1_5;
...
int property(void) {
	return ((((((((((((var_1_22 / var_1_3) != var_1_19) ? (var_1_1 == ((double) ((var_1_5 + (abs (var_1_6))) + var_1_7))) : (var_1_1 == ((double) var_1_7))) && ((var_1_9 || (! (var_1_7 > var_1_5))) ? (var_1_8 == ((unsigned short int) (((var_1_10 - var_1_11) + var_1_12) - var_1_13))) : ((var_1_5 > (max (var_1_6 , 16.15))) ? (var_1_8 == ((unsigned short int) var_1_10)) : (var_1_8 == ((unsigned short int) var_1_11))))) && (var_1_14 == ((double) (abs (var_1_7))))) && (((var_1_16 - 2) == var_1_11) ? (var_1_15 == ((double) (var_1_6 + (abs (var_1_17 - 8.5))))) : ((var_1_12 < (min (var_1_13 , var_1_8))) ? (var_1_15 == ((double) ((max (var_1_17 , 31.4)) - var_1_18))) : (var_1_15 == ((double) var_1_17))))) && ((var_1_13 <= (var_1_20 - var_1_10)) ? ((var_1_3 >= (var_1_11 | (max (var_1_22 , var_1_13)))) ? (var_1_19 == ((unsigned long int) (max (var_1_11 , var_1_20)))) : (var_1_19 == ((unsigned long int) var_1_20))) : (var_1_19 == ((unsigned long int) var_1_21)))) && (((var_1_10 + (10 + var_1_11)) >= var_1_12) ? ((var_1_9 && var_1_23) ? (var_1_22 == ((unsigned short int) (var_1_24 - var_1_11))) : 1) : (var_1_22 == ((unsigned short int) 50)))) && (var_1_9 ? ((1 >= ((min (var_1_19 , var_1_10)) + var_1_12)) ? (var_1_23 ? (var_1_25 == ((float) var_1_5)) : (var_1_25 == ((float) 25.5f))) : (var_1_25 == ((float) var_1_7))) : 1)) && ((var_1_5 <= var_1_14) ? (var_1_26 == ((signed short int) (8 - (var_1_27 - 500)))) : (((var_1_22 >= var_1_12) || var_1_9) ? (var_1_26 == ((signed short int) var_1_16)) : (var_1_26 == ((signed short int) var_1_11))))) && ((var_1_19 > -2) ? (var_1_28 == ((signed char) (var_1_29 + var_1_30))) : ((var_1_12 >= var_1_19) ? (((var_1_29 * var_1_3) < var_1_11) ? (var_1_28 == ((signed char) var_1_30)) : (var_1_28 == ((signed char) 5))) : (var_1_28 == ((signed char) var_1_30))))) && ((var_1_2 > var_1_8) ? (var_1_31 == ((float) 128.75f)) : 1)) && ((((var_1_18 - var_1_17) * var_1_15) < (var_1_6 + (var_1_5 + var_1_7))) ? (var_1_32 == ((double) (var_1_7 + (127.5 + var_1_5)))) : (var_1_32 == ((double) var_1_18)))
;
}
int main(void) {
	isInitial = 1;
