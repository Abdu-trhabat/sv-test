...
void step(void) {
	...
	if (stepLocal_1 || var_1_7) {
		var_1_5 = (min (var_1_17 , (var_1_4 - (var_1_8 - 100000))));
	} else {
		var_1_5 = 10;
	}
	...
	if (var_1_5 > stepLocal_4) {
		if (stepLocal_3 && (var_1_5 < (var_1_11 - var_1_12))) {
			if (stepLocal_2 < (var_1_12 | 100)) {
				if (9.99999999999999E13 <= (min (var_1_13 , (var_1_14 + var_1_15)))) {
					var_1_9 = var_1_16;
				} else {
					var_1_9 = 15.4f;
				}
...
int property(void) {
	return (((((var_1_2 < var_1_3) ? (var_1_1 == ((unsigned short int) var_1_4)) : 1) && ((var_1_6 || var_1_7) ? (var_1_5 == ((signed long int) (min (var_1_17 , (var_1_4 - (var_1_8 - 100000)))))) : (var_1_5 == ((signed long int) 10)))) && ((var_1_5 > var_1_8) ? ((var_1_6 && (var_1_5 < (var_1_11 - var_1_12))) ? (((var_1_17 + var_1_5) < (var_1_12 | 100)) ? ((9.99999999999999E13 <= (min (var_1_13 , (var_1_14 + var_1_15)))) ? (var_1_9 == ((float) var_1_16)) : (var_1_9 == ((float) 15.4f))) : (var_1_9 == ((float) var_1_16))) : (var_1_9 == ((float) 7.25f))) : 1)) && (var_1_17 == ((unsigned long int) var_1_11))) && (var_1_18 == ((float) var_1_16))
;
}
int main(void) {
	isInitial = 1;
