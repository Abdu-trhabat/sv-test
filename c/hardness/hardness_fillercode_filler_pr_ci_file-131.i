...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch131Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned char stepLocal_2 = ((var_1_18) > ( ((var_1_4) % (var_1_16))));
    ...
    var_1_12
                   ...
                   if ( (( ((var_1_30) / (7.5f))) > ( (- (var_1_8))))) {
                    if (var_1_13) {
                     if ( ((var_1_23) < ( ((var_1_22) >> ( ((var_1_35) - (var_1_36))))))) {
                      var_1_34 = (
                       ((((( ((((( var_1_35 )) < (( var_1_36 ))) ? (( var_1_35 )) : (( var_1_36 )))) )) < (( var_1_4 ))) ? (( ((((( var_1_35 )) < (( var_1_36 ))) ? (( var_1_35 )) : (( var_1_36 )))) )) : (( var_1_4 ))))
    );
   } else {
                      var_1_34 = (
                       ((
      var_1_35
                        ...
                        ((((( var_1_36 )) < (( var_1_16 ))) ? (( var_1_36 )) : (( var_1_16 ))))
     ))
    );
   }
  }
