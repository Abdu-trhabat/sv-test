...
void step(void) {
	...
	// From: CodeObject4
	/* 261L, 84L) */ if (/* 262L, 60L, 61L) */ ((var_1_27) != (/* 264L, 59L, 63L) */ ((var_1_5) + (var_1_26))))) {
		/* 267L, 79L) */ var_1_34 = (
			/* 270L, 78L) */ (max (
				/* 270L, 78L) */ (
					var_1_4
	...
	// From: CodeObject5
	/* 280L, 125L) */ if (/* 281L, 101L, 102L) */ ((/* 282L, 97L, 103L) */ ((var_1_26) ^ (var_1_5))) <= (/* 285L, 100L, 106L) */ ((16u) & (var_1_4))))) {
		/* 288L, 124L) */ var_1_36 = (
			/* 291L, 123L) */ (min (
				/* 291L, 123L) */ (
					/* 292L, 119L) */ (abs (
	...
	// From: CodeObject7
	/* 312L, 208L) */ if (/* 313L, 169L, 170L) */ ((-5) > (/* 315L, 168L, 172L) */ (~ (var_1_21))))) {
		/* 317L, 181L) */ var_1_41 = (
			var_1_40
		);
	} else {
		/* 321L, 206L) */ if (/* 322L, 185L, 186L) */ (! (/* 323L, 184L, 187L) */ ((var_1_17) <= (var_1_40))))) {
			/* 326L, 197L) */ var_1_41 = (
				var_1_40
			);
		} else {
