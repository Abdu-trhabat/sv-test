...
void step(void) {
	// From: Req1Batch122Wrapper_A
	unsigned_char_Array_0[1] = (abs (min (1 , unsigned_char_Array_0[0])));


	// From: Req2Batch122Wrapper_A
	if (double_Array_0[4] < double_Array_0[3]) {
		unsigned_long_int_Array_0[1] = ((abs (unsigned_char_Array_0[1])) + unsigned_char_Array_0[0]);
	} else {
		unsigned_long_int_Array_0[1] = unsigned_char_Array_0[0];
	}


	// From: Req3Batch122Wrapper_A
	if (double_Array_0[4] >= double_Array_0[3]) {
		double_Array_0[2] = (min (7.8 , (double_Array_0[1] - double_Array_0[0])));
	}


	// From: Req4Batch122Wrapper_A
	...
	if (BOOL_unsigned_char_Array_0[0] || stepLocal_0) {
		...
		if (unsigned_char_Array_0[0] < stepLocal_1) {
			signed_long_int_Array_0[1] = (min ((unsigned_char_Array_0[0] - (signed_long_int_Array_0[0] - unsigned_long_int_Array_0[1])) , (signed_long_int_Array_0[2] - (signed_long_int_Array_0[3] - signed_long_int_Array_0[4]))));
		}
	}


	// From: Req5Batch122Wrapper_A
...
int property(void) {
	return ((((unsigned_char_Array_0[1] == ((unsigned char) (abs (min (1 , unsigned_char_Array_0[0]))))) && ((double_Array_0[4] < double_Array_0[3]) ? (unsigned_long_int_Array_0[1] == ((unsigned long int) ((abs (unsigned_char_Array_0[1])) + unsigned_char_Array_0[0]))) : (unsigned_long_int_Array_0[1] == ((unsigned long int) unsigned_char_Array_0[0])))) && ((double_Array_0[4] >= double_Array_0[3]) ? (double_Array_0[2] == ((double) (min (7.8 , (double_Array_0[1] - double_Array_0[0]))))) : 1)) && ((BOOL_unsigned_char_Array_0[0] || BOOL_unsigned_char_Array_0[1]) ? (signed_long_int_Array_0[1] == ((signed long int) 128)) : ((unsigned_char_Array_0[0] < unsigned_long_int_Array_0[1]) ? (signed_long_int_Array_0[1] == ((signed long int) (min ((unsigned_char_Array_0[0] - (signed_long_int_Array_0[0] - unsigned_long_int_Array_0[1])) , (signed_long_int_Array_0[2] - (signed_long_int_Array_0[3] - signed_long_int_Array_0[4])))))) : 1))) && ((unsigned_long_int_Array_0[1] > (signed_long_int_Array_0[3] % (unsigned_long_int_Array_0[0] - signed_long_int_Array_0[0]))) ? (float_Array_0[0] == ((float) double_Array_0[1])) : 1)
;
}
int main(void) {
	isInitial = 1;
