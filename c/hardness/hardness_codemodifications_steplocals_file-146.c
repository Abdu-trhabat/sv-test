...
void step(void) {
	...
	// From: Req3Batch146stepLocals
	if ((- var_1_4) > var_1_5) {
		var_1_14 = 5;
	}


	// From: Req4Batch146stepLocals
	if (((min (var_1_10 , var_1_12)) <= var_1_4) && var_1_2) {
		var_1_15 = var_1_7;
	} else {
		var_1_15 = var_1_6;
	}
