...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch101Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch101Wrapper_A
	signed long int stepLocal_1 = unsigned_char_Array_0[0][1] + 128;
	unsigned char stepLocal_0 = unsigned_char_Array_0[0][2];
	if (BOOL_unsigned_char_Array_0[1]) {
		unsigned_char_Array_0[1][2] = (unsigned_char_Array_0[0][2] - (unsigned_char_Array_0[1][1] + (unsigned_char_Array_0[0][1] + unsigned_char_Array_0[1][0])));
	} else {
		if (BOOL_unsigned_char_Array_0[0]) {
			if (stepLocal_0 > unsigned_char_Array_0[1][0]) {
				if (stepLocal_1 >= unsigned_char_Array_0[1][1]) {
					unsigned_char_Array_0[1][2] = unsigned_char_Array_0[1][1];
				} else {
					unsigned_char_Array_0[1][2] = 4;
				}
			} else {
				unsigned_char_Array_0[1][2] = unsigned_char_Array_0[0][2];
			}
		} else {
			unsigned_char_Array_0[1][2] = unsigned_char_Array_0[0][0];
		}
	}


	// From: Req2Batch101Wrapper_A
	if (unsigned_char_Array_0[0][1] > unsigned_char_Array_0[1][1]) {
		double_Array_0[1] = (min (double_Array_0[3] , (max ((min (double_Array_0[4] , double_Array_0[0])) , double_Array_0[2]))));
	} else {
		if (BOOL_unsigned_char_Array_0[1]) {
			double_Array_0[1] = 2.5;
		} else {
	...
	// From: Req3Batch101Wrapper_A
	if ((unsigned_char_Array_0[1][2] / unsigned_char_Array_0[0][2]) > (-1000 % (abs (16)))) {
		unsigned_short_int_Array_0[0] = unsigned_char_Array_0[1][2];
	} else {
		unsigned_short_int_Array_0[0] = 32;
	}
}
...
int property(void) {
	return ((BOOL_unsigned_char_Array_0[1] ? (unsigned_char_Array_0[1][2] == ((unsigned char) (unsigned_char_Array_0[0][2] - (unsigned_char_Array_0[1][1] + (unsigned_char_Array_0[0][1] + unsigned_char_Array_0[1][0]))))) : (BOOL_unsigned_char_Array_0[0] ? ((unsigned_char_Array_0[0][2] > unsigned_char_Array_0[1][0]) ? (((unsigned_char_Array_0[0][1] + 128) >= unsigned_char_Array_0[1][1]) ? (unsigned_char_Array_0[1][2] == ((unsigned char) unsigned_char_Array_0[1][1])) : (unsigned_char_Array_0[1][2] == ((unsigned char) 4))) : (unsigned_char_Array_0[1][2] == ((unsigned char) unsigned_char_Array_0[0][2]))) : (unsigned_char_Array_0[1][2] == ((unsigned char) unsigned_char_Array_0[0][0])))) && ((unsigned_char_Array_0[0][1] > unsigned_char_Array_0[1][1]) ? (double_Array_0[1] == ((double) (min (double_Array_0[3] , (max ((min (double_Array_0[4] , double_Array_0[0])) , double_Array_0[2])))))) : (BOOL_unsigned_char_Array_0[1] ? (double_Array_0[1] == ((double) 2.5)) : (double_Array_0[1] == ((double) double_Array_0[2]))))) && (((unsigned_char_Array_0[1][2] / unsigned_char_Array_0[0][2]) > (-1000 % (abs (16)))) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) unsigned_char_Array_0[1][2])) : (unsigned_short_int_Array_0[0] == ((unsigned short int) 32)))
;
}
int main(void) {
	isInitial = 1;
