...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch13950_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch13950_while
	if (var_1_10 >= ((var_1_5 + var_1_4) + var_1_13)) {
		var_1_17 = var_1_16;
	}


	// From: Req5Batch13950_while
