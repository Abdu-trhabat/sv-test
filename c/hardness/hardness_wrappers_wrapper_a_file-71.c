...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch71Wrapper_A.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[0]) {
		...
		unsigned_short_int_Array_0[1] = (unsigned_long_int_Array_0[0] + unsigned_char_Array_0[3]);
	}
...
int property(void) {
	return ((((BOOL_unsigned_char_Array_0[2] ? (unsigned_char_Array_0[4] == ((unsigned char) (max ((max ((unsigned_char_Array_0[3] + unsigned_char_Array_0[2]) , 50)) , unsigned_char_Array_0[1])))) : ((BOOL_unsigned_char_Array_0[1] && BOOL_unsigned_char_Array_0[0]) ? (unsigned_char_Array_0[4] == ((unsigned char) unsigned_char_Array_0[1])) : (((unsigned_char_Array_0[2] - unsigned_char_Array_0[3]) < unsigned_char_Array_0[1]) ? (unsigned_char_Array_0[4] == ((unsigned char) unsigned_char_Array_0[2])) : (unsigned_char_Array_0[4] == ((unsigned char) 5))))) && (BOOL_unsigned_char_Array_0[0] ? (unsigned_short_int_Array_0[1] == ((unsigned short int) (abs (unsigned_char_Array_0[1])))) : (unsigned_short_int_Array_0[1] == ((unsigned short int) (unsigned_long_int_Array_0[0] + unsigned_char_Array_0[3]))))) && ((unsigned_char_Array_0[1] <= (max (unsigned_char_Array_0[3] , (unsigned_char_Array_0[0] - unsigned_char_Array_0[2])))) ? (((unsigned_char_Array_0[2] / signed_char_Array_0[1]) > (unsigned_long_int_Array_0[0] * (unsigned_long_int_Array_0[0] + unsigned_char_Array_0[1]))) ? (unsigned_short_int_Array_0[0] == ((unsigned short int) 128)) : 1) : 1)) && (signed_char_Array_0[0] == ((signed char) signed_char_Array_0[2]))) && (unsigned_long_int_Array_0[0] == ((unsigned long int) unsigned_char_Array_0[3]))
;
}
int main(void) {
	isInitial = 1;
