...
void step(void) {
	// From: Req10Batch116100_while
	unsigned short int stepLocal_5 = var_1_8;
	if ((abs (- last_1_var_1_12)) > (max ((var_1_15 * var_1_26) , (last_1_var_1_12 / var_1_27)))) {
		var_1_32 = ((min (var_1_11 , last_1_var_1_21)) + var_1_10);
	} else {
	...
	// From: Req1Batch116100_while
	if (var_1_2 || ((abs (var_1_3)) <= var_1_32)) {
	...
	// From: Req2Batch116100_while
	var_1_7 = ((max (var_1_8 , var_1_9)) + (min (var_1_10 , var_1_11)));


	// From: Req4Batch116100_while
	...
	// From: Req5Batch116100_while
	if (var_1_15 >= var_1_14) {
		var_1_17 = var_1_3;
	} else {
		var_1_17 = (min (var_1_3 , (var_1_18 + (var_1_19 + var_1_20))));
	}


	// From: Req6Batch116100_while
	if (var_1_2) {
		var_1_21 = var_1_8;
	} else {
		if ((- var_1_18) >= var_1_7) {
	...
	// From: Req7Batch116100_while
	signed long int stepLocal_2 = var_1_10 + var_1_22;
	if (5.25f < (var_1_14 / (max (var_1_26 , var_1_27)))) {
		var_1_25 = (min (var_1_24 , var_1_10));
	} else {
	...
	// From: Req8Batch116100_while
	signed long int stepLocal_4 = max (var_1_7 , var_1_6);
	signed short int stepLocal_3 = var_1_18;
	if (var_1_26 <= (var_1_29 - (abs (var_1_16)))) {
		if (2 <= stepLocal_4) {
	...
	// From: Req9Batch116100_while
	if (var_1_12 <= (max (var_1_26 , var_1_16))) {
		if (var_1_15 <= var_1_29) {
			var_1_30 = (min (var_1_9 , var_1_11));
		} else {
...
int property(void) {
	return (((((((((((var_1_2 || ((abs (var_1_3)) <= var_1_32)) ? (var_1_1 == ((signed long int) (min (var_1_3 , var_1_5)))) : (var_1_1 == ((signed long int) (var_1_3 + var_1_6)))) && (var_1_7 == ((unsigned short int) ((max (var_1_8 , var_1_9)) + (min (var_1_10 , var_1_11)))))) && ((var_1_1 >= ((var_1_9 + var_1_6) * var_1_32)) ? (var_1_12 == ((double) (var_1_14 + var_1_15))) : (var_1_12 == ((double) var_1_14)))) && ((var_1_32 < var_1_6) ? (var_1_16 == ((float) (abs (var_1_14)))) : 1)) && ((var_1_15 >= var_1_14) ? (var_1_17 == ((signed short int) var_1_3)) : (var_1_17 == ((signed short int) (min (var_1_3 , (var_1_18 + (var_1_19 + var_1_20)))))))) && (var_1_2 ? (var_1_21 == ((unsigned short int) var_1_8)) : (((- var_1_18) >= var_1_7) ? (var_1_21 == ((unsigned short int) var_1_11)) : (var_1_21 == ((unsigned short int) (45247 - ((var_1_22 - var_1_23) - var_1_24))))))) && ((5.25f < (var_1_14 / (max (var_1_26 , var_1_27)))) ? (var_1_25 == ((unsigned short int) (min (var_1_24 , var_1_10)))) : (((var_1_10 + var_1_22) <= var_1_5) ? (var_1_25 == ((unsigned short int) var_1_10)) : 1))) && ((var_1_26 <= (var_1_29 - (abs (var_1_16)))) ? ((2 <= (max (var_1_7 , var_1_6))) ? ((var_1_3 >= var_1_18) ? (var_1_28 == ((unsigned short int) 25)) : (var_1_28 == ((unsigned short int) var_1_24))) : (var_1_28 == ((unsigned short int) var_1_11))) : (var_1_28 == ((unsigned short int) var_1_24)))) && ((var_1_12 <= (max (var_1_26 , var_1_16))) ? ((var_1_15 <= var_1_29) ? (var_1_30 == ((unsigned short int) (min (var_1_9 , var_1_11)))) : (var_1_30 == ((unsigned short int) (var_1_24 + (var_1_23 + 10))))) : (var_1_31 ? (var_1_30 == ((unsigned short int) var_1_8)) : 1))) && (((abs (- last_1_var_1_12)) > (max ((var_1_15 * var_1_26) , (last_1_var_1_12 / var_1_27)))) ? (var_1_32 == ((unsigned long int) ((min (var_1_11 , last_1_var_1_21)) + var_1_10))) : ((var_1_8 >= var_1_24) ? (var_1_32 == ((unsigned long int) var_1_8)) : (var_1_32 == ((unsigned long int) last_1_var_1_7))))) && (((var_1_34 - (var_1_22 - var_1_23)) == (var_1_8 >> var_1_35)) ? (var_1_33 == ((signed short int) ((var_1_23 + var_1_24) - (min ((var_1_36 - var_1_35) , var_1_37))))) : (var_1_33 == ((signed short int) var_1_35)))
;
}
int main(void) {
	isInitial = 1;
