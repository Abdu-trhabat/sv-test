...
void step(void) {
	...
	if (stepLocal_0 < ((var_1_3 * var_1_9) * (var_1_8 * last_1_var_1_10))) {
		var_1_10 = (max ((min (last_1_var_1_10 , var_1_8)) , var_1_9));
	} else {
		var_1_10 = ((max (var_1_8 , last_1_var_1_10)) + var_1_8);
	}


	// From: Req4Batch135normal
	if ((var_1_10 / (min (var_1_14 , var_1_15))) > var_1_8) {
		var_1_13 = var_1_5;
	}
}
