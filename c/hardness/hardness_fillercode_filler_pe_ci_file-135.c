...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch135Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 288L, 97L) */ if (/* 289L, 63L, 64L) */ ((var_1_28) > (/* 291L, 62L, 66L) */ (abs (var_1_18))))) {
		/* 293L, 81L) */ var_1_29 = (
			/* 296L, 80L) */ ((
				/* 297L, 75L) */ (abs (
					var_1_32
	...
	// From: CodeObject2
	/* 311L, 139L) */ if (/* 312L, 104L, 105L) */ (! (/* 313L, 103L, 106L) */ ((var_1_28) < (var_1_33))))) {
		/* 316L, 133L) */ if (/* 317L, 116L, 117L) */ ((/* 318L, 114L, 118L) */ (~ (var_1_33))) <= (var_1_10))) {
			/* 321L, 128L) */ var_1_35 = (
				var_1_32
			);
		} else {
	...
	// From: CodeObject4
	/* 342L, 186L) */ if (/* 343L, 165L, 166L) */ ((var_1_23) || (/* 345L, 164L, 168L) */ ((var_1_6) >= (/* 347L, 163L, 170L) */ ((var_1_22) + (var_1_6))))))) {
		/* 350L, 185L) */ var_1_38 = (
			/* 353L, 184L) */ ((
				var_1_32
			) + (
	...
	/* 356L, 245L) */ if (var_1_23) {
		...
		/* 363L, 243L) */ if (/* 364L, 200L, 201L) */ ((var_1_28) > (var_1_15))) {
			/* 367L, 218L) */ var_1_41 = (
				/* 370L, 217L) */ ((
					/* 371L, 211L) */ ((
						var_1_42
			...
			/* 379L, 241L) */ if (/* 380L, 224L, 225L) */ ((var_1_19) > (/* 382L, 223L, 227L) */ (abs (/* 383L, 222L, 228L) */ ((var_1_10) - (var_1_28))))))) {
				/* 386L, 240L) */ var_1_41 = (
					var_1_6
				);
			}
	...
	// From: CodeObject6
	/* 391L, 284L) */ if (/* 392L, 253L, 254L) */ ((var_1_43) < (/* 394L, 252L, 256L) */ ((var_1_22) / (var_1_48))))) {
		/* 397L, 278L) */ if (/* 398L, 265L, 266L) */ (! (var_1_27))) {
			/* 400L, 277L) */ var_1_46 = (
				/* 403L, 276L) */ (min (
					/* 403L, 276L) */ (
						/* 404L, 274L) */ (min (
