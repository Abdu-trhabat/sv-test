...
void step(void) {
	...
	// From: Req2Batch108Amount10
	var_1_7 = var_1_4;


	// From: Req3Batch108Amount10
	var_1_8 = var_1_3;


	// From: Req4Batch108Amount10
	var_1_9 = var_1_3;
}
...
int property(void) {
	return ((((var_1_2 == (256 >> var_1_3)) ? (var_1_1 == ((double) var_1_4)) : (var_1_1 == ((double) (abs (var_1_5 - var_1_6))))) && (var_1_7 == ((float) var_1_4))) && (var_1_8 == ((signed char) var_1_3))) && (var_1_9 == ((unsigned short int) var_1_3))
;
}
int main(void) {
	isInitial = 1;
