...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch24Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
	...
	if ((max (((*(WrapperStruct00_var_1_17_Pointer)) * 127.75) , ((*(WrapperStruct00_var_1_8_Pointer)) / 3.4))) >= (*(WrapperStruct00_var_1_9_Pointer))) {
		(*(WrapperStruct00_var_1_7_Pointer)) = (min (((*(WrapperStruct00_var_1_10_Pointer)) - (22925 - (*(WrapperStruct00_var_1_5_Pointer)))) , (*(WrapperStruct00_var_1_11_Pointer))));
	}
}
