...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch134normal.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch134normal
	if (var_1_2 == (var_1_3 / (abs (var_1_4)))) {
		var_1_1 = var_1_5;
	}


	// From: Req2Batch134normal
	...
	// From: Req7Batch134normal
	var_1_20 = var_1_7;


	// From: Req8Batch134normal
	var_1_21 = var_1_7;
}
