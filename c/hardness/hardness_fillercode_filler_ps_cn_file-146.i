...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch146Filler_PS_CN.c", 13, "reach_error"); }
...
void step(void) {
            if ( ((var_1_27) <= (var_1_28))) {
             ...
             if ( ((var_1_27) >= ( ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))))) {
              var_1_31 = (
               (((((( var_1_26 ) + ( var_1_29 ))) < 0 ) ? -((( var_1_26 ) + ( var_1_29 ))) : ((( var_1_26 ) + ( var_1_29 )))))
   );
  }
 }
             if (var_1_34) {
  ...
  var_1_38
   ...
   var_1_46
    ...
    var_1_49
             ...
             if (var_1_34) {
              if ( ((var_1_45) < (var_1_27))) {
               if ( ((var_1_38) != ( (((((var_1_31)) < ((var_1_51))) ? ((var_1_31)) : ((var_1_51))))))) {
                var_1_50 = (
