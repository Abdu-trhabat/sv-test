...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch124Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req3Batch124Amount25
	var_1_15 = var_1_16;


	// From: Req2Batch124Amount25
	if ((var_1_7 - (var_1_8 + var_1_9)) < var_1_5) {
		if ((var_1_15 / (abs (var_1_11))) <= ((64 + var_1_15) + var_1_15)) {
			var_1_6 = var_1_14;
		} else {
			var_1_6 = 1;
		}
...
int property(void) {
	return (((! (var_1_2 == (15.2 + var_1_3))) ? ((var_1_6 && (var_1_2 == var_1_3)) ? (var_1_6 ? (var_1_1 == ((double) var_1_5)) : (var_1_1 == ((double) 1.5))) : 1) : (var_1_1 == ((double) var_1_5))) && (((var_1_7 - (var_1_8 + var_1_9)) < var_1_5) ? (((var_1_15 / (abs (var_1_11))) <= ((64 + var_1_15) + var_1_15)) ? (var_1_6 == ((unsigned char) var_1_14)) : (var_1_6 == ((unsigned char) 1))) : (var_1_6 == ((unsigned char) var_1_14)))) && (var_1_15 == ((unsigned long int) var_1_16))
;
}
int main(void) {
	isInitial = 1;
