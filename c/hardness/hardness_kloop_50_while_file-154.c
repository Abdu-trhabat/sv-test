...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15450_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch15450_while
	if (var_1_2) {
		var_1_1 = (max (var_1_3 , var_1_4));
	} else {
		var_1_1 = ((min (var_1_5 , var_1_6)) + ((var_1_7 - var_1_8) - var_1_9));
	}


	// From: Req2Batch15450_while
	if (var_1_4 == var_1_5) {
		var_1_10 = (max ((var_1_11 + var_1_12) , var_1_13));
	}


	// From: Req3Batch15450_while
	if (var_1_11 > var_1_4) {
		if (var_1_8 > var_1_4) {
			var_1_14 = var_1_8;
		}
	...
	// From: Req6Batch15450_while
	unsigned char stepLocal_3 = var_1_2;
	unsigned char stepLocal_2 = var_1_25;
	unsigned long int stepLocal_1 = (max (var_1_5 , var_1_9)) * var_1_4;
...
int property(void) {
	return ((((((var_1_2 ? (var_1_1 == ((unsigned long int) (max (var_1_3 , var_1_4)))) : (var_1_1 == ((unsigned long int) ((min (var_1_5 , var_1_6)) + ((var_1_7 - var_1_8) - var_1_9))))) && ((var_1_4 == var_1_5) ? (var_1_10 == ((signed char) (max ((var_1_11 + var_1_12) , var_1_13)))) : 1)) && ((var_1_11 > var_1_4) ? ((var_1_8 > var_1_4) ? (var_1_14 == ((signed long int) var_1_8)) : 1) : 1)) && (((var_1_16 * (var_1_17 + var_1_18)) < ((var_1_19 + var_1_20) - var_1_21)) ? (var_1_15 == ((signed long int) var_1_9)) : (var_1_15 == ((signed long int) var_1_22)))) && (var_1_2 ? ((var_1_21 > var_1_20) ? ((-16 != (-25 / var_1_7)) ? (var_1_23 == ((signed char) var_1_13)) : (var_1_23 == ((signed char) var_1_11))) : (var_1_23 == ((signed char) var_1_11))) : (var_1_23 == ((signed char) var_1_11)))) && ((var_1_2 || var_1_25) ? ((var_1_2 && (var_1_15 <= var_1_8)) ? ((var_1_7 == ((max (var_1_5 , var_1_9)) * var_1_4)) ? (var_1_24 == ((signed short int) ((var_1_26 - var_1_27) - 16))) : 1) : 1) : (var_1_24 == ((signed short int) var_1_15)))) && (var_1_28 == ((unsigned char) var_1_29))
;
}
int main(void) {
	isInitial = 1;
