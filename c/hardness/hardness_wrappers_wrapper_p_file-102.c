...
int property(void) {
	return (((((((((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) * last_1_var_1_13) <= last_1_var_1_13) ? ((*(var_1_1_Pointer)) == ((unsigned long int) (abs ((*(var_1_6_Pointer)))))) : ((*(var_1_1_Pointer)) == ((unsigned long int) (*(var_1_6_Pointer))))) && (((*(var_1_1_Pointer)) < ((*(var_1_1_Pointer)) & ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))))) ? ((*(var_1_7_Pointer)) == ((signed long int) (min ((((*(var_1_11_Pointer)) - 128) - 2) , (*(var_1_12_Pointer)))))) : ((*(var_1_7_Pointer)) == ((signed long int) (*(var_1_12_Pointer)))))) && ((((60423 - (*(var_1_14_Pointer))) | (*(var_1_1_Pointer))) <= (abs ((*(var_1_10_Pointer))))) ? (((*(var_1_9_Pointer)) != (*(var_1_6_Pointer))) ? ((*(var_1_13_Pointer)) == ((double) ((31.5 - (*(var_1_15_Pointer))) + 63.3))) : ((*(var_1_13_Pointer)) == ((double) (*(var_1_15_Pointer))))) : 1)) && ((*(var_1_16_Pointer)) == ((signed long int) (*(var_1_12_Pointer))))) && ((*(var_1_17_Pointer)) == ((unsigned char) (*(var_1_18_Pointer))))) && ((*(var_1_19_Pointer)) == ((signed long int) (*(var_1_11_Pointer))))
;
}
int main(void) {
	isInitial = 1;
