...
void step(void) {
	...
	// From: Req3Batch15750_while
	if (((var_1_5 / var_1_10) < var_1_1) && var_1_7) {
		var_1_9 = 32;
	}


	// From: Req4Batch15750_while
	var_1_11 = 199.4;


	// From: Req7Batch15750_while
	...
	// From: Req8Batch15750_while
	var_1_21 = last_1_var_1_21;


	// From: Req9Batch15750_while
	var_1_22 = var_1_18;


	// From: Req2Batch15750_while
	if (32.5 >= var_1_11) {
		if (var_1_7 && var_1_8) {
			var_1_6 = -4;
		}
