...
void functionized0(signed long int functionized0_localFunctionVar0, signed long int functionized0_localFunctionVar1) {
 if (((((var_1_2) < (var_1_3)) ? (var_1_2) : (var_1_3))) != (2 + (functionized0_localFunctionVar1 + functionized0_localFunctionVar0))) {
  if (! var_1_6) {
...
void functionized4(signed long int functionized4_localFunctionVar0, unsigned short int functionized4_localFunctionVar1, signed long int functionized4_localFunctionVar2, signed short int functionized4_localFunctionVar3) {
 if (functionized4_localFunctionVar1 <= ((((functionized4_localFunctionVar0) > (functionized4_localFunctionVar3)) ? (functionized4_localFunctionVar0) : (functionized4_localFunctionVar3)))) {
  if (((((functionized4_localFunctionVar0) > (functionized4_localFunctionVar2)) ? (functionized4_localFunctionVar0) : (functionized4_localFunctionVar2))) >= var_1_11) {
...
void step(void) {
 ...
 if (var_1_7 <= var_1_5) {
  if ((var_1_10 / ((((var_1_14) < (var_1_15)) ? (var_1_14) : (var_1_15)))) < var_1_2) {
   var_1_13 = ((((functionized3(var_1_9)) < (var_1_14)) ? (functionized3(var_1_9)) : (var_1_14)));
  }
 }
