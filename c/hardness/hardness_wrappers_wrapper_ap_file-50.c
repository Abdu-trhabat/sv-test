...
void step(void) {
	...
	unsigned long int stepLocal_0 = max ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) , (*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)));
	if ((min (((*(double_Array_0_arraydouble_Array_0arrayVar5_Pointer)) + (*(double_Array_0_arraydouble_Array_0arrayVar4_Pointer))) , ((*(double_Array_0_arraydouble_Array_0arrayVar3_Pointer)) - (*(double_Array_0_arraydouble_Array_0arrayVar2_Pointer))))) != 31.9) {
