...
void step(void) {
	// From: Req1Batch171Wrapper_A
	if ((float_Array_0[4] - 15.25f) <= (float_Array_0[3] * (- float_Array_0[2]))) {
		unsigned_char_Array_0[1][2] = ((unsigned_char_Array_0[0][2] + (min (unsigned_char_Array_0[1][1] , unsigned_char_Array_0[0][1]))) + (unsigned_char_Array_0[1][0] + unsigned_char_Array_0[0][0]));
	}


	// From: Req2Batch171Wrapper_A
	if (((min (float_Array_0[4] , 15.8f)) - (float_Array_0[1] + float_Array_0[0])) != (min ((max (-0.05f , float_Array_0[2])) , float_Array_0[3]))) {
	...
	// From: Req3Batch171Wrapper_A
	unsigned char stepLocal_0 = BOOL_unsigned_char_Array_0[2];
	if (BOOL_unsigned_char_Array_0[1] || stepLocal_0) {
		signed_short_int_Array_0[0] = (min (unsigned_char_Array_0[1][2] , (min ((max (unsigned_char_Array_0[1][0] , unsigned_char_Array_0[0][0])) , unsigned_char_Array_0[0][2]))));
	} else {
		signed_short_int_Array_0[0] = (unsigned_char_Array_0[1][1] + unsigned_char_Array_0[0][1]);
	}


	// From: Req4Batch171Wrapper_A
...
int property(void) {
	return (((((float_Array_0[4] - 15.25f) <= (float_Array_0[3] * (- float_Array_0[2]))) ? (unsigned_char_Array_0[1][2] == ((unsigned char) ((unsigned_char_Array_0[0][2] + (min (unsigned_char_Array_0[1][1] , unsigned_char_Array_0[0][1]))) + (unsigned_char_Array_0[1][0] + unsigned_char_Array_0[0][0])))) : 1) && ((((min (float_Array_0[4] , 15.8f)) - (float_Array_0[1] + float_Array_0[0])) != (min ((max (-0.05f , float_Array_0[2])) , float_Array_0[3]))) ? ((float_Array_0[1] < float_Array_0[0]) ? (signed_long_int_Array_0[0] == ((signed long int) unsigned_char_Array_0[0][0])) : (signed_long_int_Array_0[0] == ((signed long int) unsigned_char_Array_0[0][1]))) : 1)) && ((BOOL_unsigned_char_Array_0[1] || BOOL_unsigned_char_Array_0[2]) ? (signed_short_int_Array_0[0] == ((signed short int) (min (unsigned_char_Array_0[1][2] , (min ((max (unsigned_char_Array_0[1][0] , unsigned_char_Array_0[0][0])) , unsigned_char_Array_0[0][2])))))) : (signed_short_int_Array_0[0] == ((signed short int) (unsigned_char_Array_0[1][1] + unsigned_char_Array_0[0][1]))))) && (BOOL_unsigned_char_Array_0[0] == ((unsigned char) 0))
;
}
int main(void) {
	isInitial = 1;
