...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[1] || stepLocal_0) {
		signed_long_int_Array_0[1][1] = ((256 + signed_long_int_Array_0[0][1]) - (min (signed_long_int_Array_0[1][0] , signed_long_int_Array_0[0][0])));
	} else {
	...
	// From: Req3Batch123Wrapper_A
	double_Array_0[0] = (max (double_Array_0[1] , double_Array_0[2]));


	// From: Req4Batch123Wrapper_A
