...
void step(void) {
 ...
 unsigned long int stepLocal_4 = (((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1));
 unsigned long int stepLocal_3 = (((var_1_8) > ((- 2))) ? (var_1_8) : ((- 2)));
...
int property(void) {
 return (((((last_1_var_1_8 / var_1_3) == last_1_var_1_1) ? (var_1_1 == ((unsigned long int) ((((25u) > (last_1_var_1_8)) ? (25u) : (last_1_var_1_8))))) : (var_1_1 == ((unsigned long int) last_1_var_1_8))) && (((- 64u) >= var_1_3) ? (var_1_5 == ((unsigned char) (! var_1_7))) : 1)) && (((var_1_1 ^ (256u / var_1_3)) < var_1_1) ? (var_1_8 == ((unsigned long int) ((var_1_1 + var_1_3) + ((((var_1_9) < (var_1_10)) ? (var_1_9) : (var_1_10)))))) : (var_1_8 == ((unsigned long int) ((((var_1_1) < ((var_1_10 + var_1_3))) ? (var_1_1) : ((var_1_10 + var_1_3)))))))) && ((((((var_1_8) > ((- 2))) ? (var_1_8) : ((- 2)))) < (var_1_9 - var_1_3)) ? ((var_1_9 <= ((((var_1_1) < 0 ) ? -(var_1_1) : (var_1_1)))) ? (var_1_11 == ((double) var_1_12)) : 1) : (var_1_11 == ((double) var_1_12)))
;
}
int main(void) {
 isInitial = 1;
