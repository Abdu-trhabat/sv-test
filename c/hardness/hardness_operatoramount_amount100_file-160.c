...
void step(void) {
	...
	// From: Req8Batch160Amount100
	if (3.5f <= var_1_14) {
		var_1_20 = (var_1_5 + (var_1_21 - last_1_var_1_22));
	}


	// From: Req9Batch160Amount100
	...
	// From: Req4Batch160Amount100
	var_1_10 = var_1_5;


	// From: Req5Batch160Amount100
	...
	// From: Req6Batch160Amount100
	if (var_1_27) {
		var_1_18 = var_1_16;
	}


	// From: Req7Batch160Amount100
