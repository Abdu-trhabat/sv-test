...
void step(void) {
 ...
 if (((var_1_12 & var_1_22) + var_1_9) <= var_1_21) {
  if (var_1_11 > ((((var_1_19) > (var_1_20)) ? (var_1_19) : (var_1_20)))) {
   var_1_23 = var_1_8;
  } else {
   var_1_23 = 8;
  }
...
int property(void) {
 return (((((((! var_1_2) ? (var_1_1 == ((double) (var_1_3 + ((((var_1_4) > (var_1_5)) ? (var_1_4) : (var_1_5)))))) : (var_1_2 ? (var_1_1 == ((double) var_1_4)) : (var_1_1 == ((double) 5.35)))) && (((var_1_7 >> var_1_8) != var_1_9) ? (var_1_6 == ((unsigned char) (! var_1_10))) : 1)) && ((((var_1_8 - var_1_12) == var_1_7) || var_1_6) ? (var_1_11 == ((signed long int) var_1_8)) : (var_1_11 == ((signed long int) -32)))) && ((64u < (var_1_14 - (var_1_8 + var_1_7))) ? (var_1_13 == ((unsigned char) var_1_15)) : (var_1_13 == ((unsigned char) (((var_1_10 && var_1_2) && var_1_15) || (var_1_6 && var_1_16)))))) && (var_1_16 ? (var_1_15 ? (var_1_17 == ((float) ((((((((var_1_18) < (var_1_4)) ? (var_1_18) : (var_1_4)))) < (9.99999999975E9f)) ? (((((var_1_18) < (var_1_4)) ? (var_1_18) : (var_1_4)))) : (9.99999999975E9f))))) : 1) : 1)) && ((var_1_14 < (var_1_11 / var_1_8)) ? (var_1_19 == ((signed short int) (var_1_8 + ((var_1_20 + var_1_21) + var_1_22)))) : (var_1_19 == ((signed short int) ((((var_1_8) > (var_1_21)) ? (var_1_8) : (var_1_21))))))) && ((((var_1_12 & var_1_22) + var_1_9) <= var_1_21) ? ((var_1_11 > ((((var_1_19) > (var_1_20)) ? (var_1_19) : (var_1_20)))) ? (var_1_23 == ((unsigned char) var_1_8)) : (var_1_23 == ((unsigned char) 8))) : 1)
;
}
int main(void) {
 isInitial = 1;
