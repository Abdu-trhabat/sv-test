...
void step(void) {
 ...
 signed long int stepLocal_0 = ((((*(var_1_5_Pointer))) > ((*(var_1_12_Pointer)))) ? ((*(var_1_5_Pointer))) : ((*(var_1_12_Pointer))));
