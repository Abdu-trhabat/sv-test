...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch16950_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req7Batch16950_while
	var_1_22 = ((min (var_1_4 , var_1_23)) + (var_1_24 + var_1_25));


	// From: Req8Batch16950_while
