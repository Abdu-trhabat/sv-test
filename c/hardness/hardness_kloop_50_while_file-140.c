...
void step(void) {
	...
	// From: Req2Batch14050_while
	if (var_1_3) {
		var_1_8 = (var_1_9 + var_1_10);
	}


	// From: Req3Batch14050_while
	if (var_1_10 >= var_1_8) {
		var_1_11 = (var_1_12 - var_1_13);
	}


	// From: Req7Batch14050_while
	var_1_23 = (max ((max (var_1_7 , var_1_21)) , var_1_24));


	// From: Req8Batch14050_while
	var_1_25 = -1;


	// From: Req6Batch14050_while
	if (var_1_6 > var_1_14) {
