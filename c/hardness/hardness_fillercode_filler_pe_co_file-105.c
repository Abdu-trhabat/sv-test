...
void step(void) {
	...
	// From: CodeObject4
	/* 374L, 178L) */ if (/* 375L, 167L, 168L) */ ((var_1_1) < (var_1_44))) {
		/* 378L, 177L) */ var_1_45 = (
			var_1_46
		);
	}
	...
	// From: CodeObject5
	/* 382L, 228L) */ if (/* 383L, 196L, 197L) */ ((/* 384L, 193L, 198L) */ ((var_1_21) / (var_1_48))) < (/* 387L, 195L, 201L) */ (abs (var_1_44))))) {
