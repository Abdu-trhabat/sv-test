...
void step(void) {
	...
	if (BOOL_unsigned_char_Array_0[1][1] && stepLocal_2) {
		signed_long_int_Array_0[2] = (min (signed_long_int_Array_0[3] , ((min (64 , signed_long_int_Array_0[4])) - (signed_long_int_Array_0[0] + signed_long_int_Array_0[1]))));
	} else {
	...
	if ((signed_long_int_Array_0[1] <= signed_long_int_Array_0[0]) || stepLocal_3) {
		float_Array_0[0] = (min (double_Array_0[0] , float_Array_0[1]));
	} else {
	...
	unsigned long int stepLocal_0 = max (unsigned_long_int_Array_0[0][1] , (unsigned_long_int_Array_0[1][0] + unsigned_long_int_Array_0[0][0]));
...
int property(void) {
	return (((((unsigned_long_int_Array_0[1][1] <= (max (unsigned_long_int_Array_0[0][1] , (unsigned_long_int_Array_0[1][0] + unsigned_long_int_Array_0[0][0])))) ? ((! BOOL_unsigned_char_Array_0[1][0]) ? (double_Array_0[2] == ((double) double_Array_0[0])) : (double_Array_0[2] == ((double) 255.375))) : 1) && ((BOOL_unsigned_char_Array_0[1][1] && BOOL_unsigned_char_Array_0[0][0]) ? (signed_long_int_Array_0[2] == ((signed long int) (min (signed_long_int_Array_0[3] , ((min (64 , signed_long_int_Array_0[4])) - (signed_long_int_Array_0[0] + signed_long_int_Array_0[1])))))) : ((((~ signed_long_int_Array_0[1]) <= signed_long_int_Array_0[4]) && BOOL_unsigned_char_Array_0[1][1]) ? (signed_long_int_Array_0[2] == ((signed long int) signed_long_int_Array_0[4])) : (signed_long_int_Array_0[2] == ((signed long int) 32))))) && (((signed_long_int_Array_0[1] <= signed_long_int_Array_0[0]) || (signed_long_int_Array_0[4] >= unsigned_long_int_Array_0[1][1])) ? (float_Array_0[0] == ((float) (min (double_Array_0[0] , float_Array_0[1])))) : (float_Array_0[0] == ((float) double_Array_0[0])))) && (BOOL_unsigned_char_Array_0[1][0] == ((unsigned char) BOOL_unsigned_char_Array_0[0][1]))) && (double_Array_0[1] == ((double) double_Array_0[0]))
;
}
int main(void) {
	isInitial = 1;
