...
void step(void) {
	...
	if ((- (*(double_Array_0_arraydouble_Array_0arrayVar1_Pointer))) != (*(double_Array_0_arraydouble_Array_0arrayVar0_Pointer))) {
		(*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) = ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var0_Pointer)) - ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) + (min ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var2_Pointer))))));
	}


	// From: Req1Batch6Wrapper_AP
	unsigned long int stepLocal_1 = (max ((*(unsigned_long_int_Array_0_arrayunsigned_long_int_Array_0Var1_Pointer)) , (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)))) / (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer));
	...
	if (stepLocal_2 == ((*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var1_Pointer)) | -5)) {
		(*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)) = (max (1.5f , (*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer))));
	}
}
