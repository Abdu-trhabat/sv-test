...
void step(void) {
 ...
 if (stepLocal_0 >= var_1_16) {
  var_1_1 = ((var_1_4 + 10.0f) - (var_1_5 + ((((var_1_6) > (var_1_7)) ? (var_1_6) : (var_1_7)))));
 } else {
...
int property(void) {
 return ((((((-128 >= var_1_16) ? (var_1_1 == ((float) ((var_1_4 + 10.0f) - (var_1_5 + ((((var_1_6) > (var_1_7)) ? (var_1_6) : (var_1_7))))))) : (((var_1_16 / var_1_8) < var_1_12) ? (var_1_1 == ((float) var_1_4)) : (var_1_1 == ((float) var_1_6)))) && (var_1_10 == ((signed char) (4 - var_1_11)))) && (var_1_2 ? ((((4 << var_1_11) + ((((var_1_16) > (var_1_8)) ? (var_1_16) : (var_1_8)))) > (((((var_1_10) < (var_1_16)) ? (var_1_10) : (var_1_16))) / var_1_13)) ? (var_1_12 == ((unsigned long int) ((((2u) > (((((((((var_1_11) > (var_1_8)) ? (var_1_11) : (var_1_8)))) < (var_1_14)) ? (((((var_1_11) > (var_1_8)) ? (var_1_11) : (var_1_8)))) : (var_1_14))))) ? (2u) : (((((((((var_1_11) > (var_1_8)) ? (var_1_11) : (var_1_8)))) < (var_1_14)) ? (((((var_1_11) > (var_1_8)) ? (var_1_11) : (var_1_8)))) : (var_1_14)))))))) : 1) : (var_1_12 == ((unsigned long int) var_1_11)))) && (var_1_15 == ((double) var_1_7))) && (var_1_16 == ((unsigned long int) var_1_8))) && (var_1_17 == ((unsigned char) 100))
;
}
int main(void) {
 isInitial = 1;
