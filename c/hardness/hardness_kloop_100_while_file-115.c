...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch115100_while.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch115100_while
	if ((last_1_var_1_9 / (min (8 , var_1_3))) >= last_1_var_1_33) {
	...
	// From: Req8Batch115100_while
	if (var_1_7) {
		var_1_31 = (var_1_29 - (last_1_var_1_6 + 16));
	} else {
		if (last_1_var_1_15 >= (var_1_28 - 32)) {
			var_1_31 = ((var_1_17 + (var_1_8 - 1000)) + (min (last_1_var_1_27 , var_1_16)));
		} else {
			var_1_31 = var_1_17;
		}
	}
	...
	// From: Req11Batch115100_while
	if (var_1_7) {
		var_1_36 = (min (last_1_var_1_36 , var_1_26));
	} else {
		var_1_36 = (var_1_8 - (var_1_13 - var_1_31));
	}


	// From: Req2Batch115100_while
	if (var_1_7) {
		var_1_6 = (min (var_1_19 , (var_1_8 - var_1_5)));
	}


	// From: Req7Batch115100_while
	signed long int stepLocal_3 = 8;
	if (var_1_36 > stepLocal_3) {
		var_1_27 = (max ((var_1_20 - (var_1_28 - var_1_29)) , (var_1_30 - var_1_21)));
	} else {
		var_1_27 = var_1_29;
	}


	// From: Req4Batch115100_while
	...
	// From: Req3Batch115100_while
	signed long int stepLocal_1 = max (-2 , var_1_1);
	signed long int stepLocal_0 = var_1_33;
	if (var_1_8 <= stepLocal_0) {
		var_1_9 = (min (var_1_5 , var_1_8));
	} else {
...
int property(void) {
	return ((((((((((((last_1_var_1_9 / (min (8 , var_1_3))) >= last_1_var_1_33) ? ((! (var_1_3 >= last_1_var_1_9)) ? (var_1_1 == ((unsigned char) var_1_5)) : (var_1_1 == ((unsigned char) 5))) : 1) && (var_1_7 ? (var_1_6 == ((unsigned short int) (min (var_1_19 , (var_1_8 - var_1_5))))) : 1)) && ((var_1_8 <= var_1_33) ? (var_1_9 == ((unsigned short int) (min (var_1_5 , var_1_8)))) : (((- var_1_33) <= (max (-2 , var_1_1))) ? (var_1_9 == ((unsigned short int) (var_1_1 + ((var_1_13 - var_1_5) - var_1_14)))) : 1))) && ((var_1_13 == var_1_14) ? (var_1_15 == ((signed char) ((-5 + (var_1_16 + var_1_17)) + var_1_18))) : (((var_1_13 <= var_1_8) || var_1_10) ? (var_1_15 == ((signed char) -32)) : 1))) && (((- var_1_31) > var_1_31) ? (var_1_19 == ((unsigned char) (var_1_20 - var_1_21))) : (var_1_10 ? (var_1_19 == ((unsigned char) var_1_5)) : (var_1_19 == ((unsigned char) var_1_21))))) && (((- (var_1_23 + var_1_24)) >= (49.6 / var_1_25)) ? (var_1_22 == ((signed short int) ((min (var_1_20 , var_1_5)) - var_1_19))) : (var_1_22 == ((signed short int) ((var_1_26 - (var_1_21 + var_1_20)) - var_1_5))))) && ((var_1_36 > 8) ? (var_1_27 == ((unsigned char) (max ((var_1_20 - (var_1_28 - var_1_29)) , (var_1_30 - var_1_21))))) : (var_1_27 == ((unsigned char) var_1_29)))) && (var_1_7 ? (var_1_31 == ((signed long int) (var_1_29 - (last_1_var_1_6 + 16)))) : ((last_1_var_1_15 >= (var_1_28 - 32)) ? (var_1_31 == ((signed long int) ((var_1_17 + (var_1_8 - 1000)) + (min (last_1_var_1_27 , var_1_16))))) : (var_1_31 == ((signed long int) var_1_17))))) && (var_1_10 ? (var_1_32 == ((unsigned short int) (((var_1_13 - var_1_28) - var_1_30) + 5))) : 1)) && ((((abs (var_1_24)) - var_1_34) >= 32.33) ? ((var_1_11 && (var_1_36 < (var_1_20 + var_1_32))) ? ((var_1_1 < var_1_36) ? (var_1_33 == ((signed long int) var_1_30)) : 1) : (var_1_33 == ((signed long int) var_1_28))) : (var_1_33 == ((signed long int) var_1_13)))) && (var_1_7 ? (var_1_36 == ((unsigned short int) (min (last_1_var_1_36 , var_1_26)))) : (var_1_36 == ((unsigned short int) (var_1_8 - (var_1_13 - var_1_31)))))
;
}
int main(void) {
	isInitial = 1;
