...
void step(void) {
	// From: Req1Batch192Amount10
	var_1_1 = ((var_1_2 + var_1_3) - (min (var_1_4 , var_1_5)));


	// From: Req2Batch192Amount10
	if (var_1_7) {
		var_1_6 = (var_1_8 + 4);
	} else {
		if (var_1_3 < var_1_1) {
...
int property(void) {
	return (var_1_1 == ((float) ((var_1_2 + var_1_3) - (min (var_1_4 , var_1_5))))) && (var_1_7 ? (var_1_6 == ((unsigned char) (var_1_8 + 4))) : ((var_1_3 < var_1_1) ? (var_1_6 == ((unsigned char) var_1_8)) : (var_1_6 == ((unsigned char) var_1_9))))
;
}
int main(void) {
	isInitial = 1;
