...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch138Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch138Amount25
	var_1_11 = (var_1_12 + (var_1_13 - var_1_14));


	// From: Req4Batch138Amount25
	var_1_15 = var_1_16;


	// From: Req5Batch138Amount25
	var_1_17 = var_1_18;


	// From: Req6Batch138Amount25
	var_1_19 = var_1_14;


	// From: Req1Batch138Amount25
