...
unsigned char functionized2(unsigned short int functionized2_localFunctionVar0, unsigned short int functionized2_localFunctionVar1, unsigned short int functionized2_localFunctionVar2) {
 return ((((((functionized2_localFunctionVar0) < 0 ) ? -(functionized2_localFunctionVar0) : (functionized2_localFunctionVar0))) >> var_1_13) >= ((((functionized2_localFunctionVar1) > (functionized2_localFunctionVar2)) ? (functionized2_localFunctionVar1) : (functionized2_localFunctionVar2))));
}
