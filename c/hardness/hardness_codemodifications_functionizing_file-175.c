...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch175functionizing.c", 13, "reach_error"); }
...
int property(void);
int main(void);
unsigned char functionized0(unsigned short int);
...
unsigned char functionized0(unsigned short int functionized0_localFunctionVar0) {
	return (((var_1_2 - var_1_3) - functionized0_localFunctionVar0) > 2);
}
...
void functionized2(unsigned char functionized2_localFunctionVar0) {
	if (functionized2_localFunctionVar0 > var_1_3) {
...
void step(void) {
	// From: Req1Batch175functionizing
	...
	// From: Req2Batch175functionizing
	var_1_5 = (! (var_1_6 && var_1_7));


	// From: Req3Batch175functionizing
	if ((var_1_9 * (functionized1(var_1_11, var_1_10))) > var_1_12) {
		var_1_8 = var_1_7;
	}


	// From: Req4Batch175functionizing
	var_1_13 = (((var_1_2 * var_1_4) > var_1_1) && (! var_1_6));


	// From: Req5Batch175functionizing
	if ((var_1_2 & var_1_3) > var_1_4) {
		functionized2(var_1_16);
	} else {
		var_1_15 = (var_1_19 + var_1_18);
	}


	// From: Req6Batch175functionizing
	var_1_20 = (var_1_18 + (max ((var_1_19 - 5.9f) , var_1_21)));


	// From: Req7Batch175functionizing
	...
	// From: Req8Batch175functionizing
	var_1_28 = var_1_2;
}
