...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch68100_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned long int stepLocal_0 = last_1_var_1_7;
	...
	if (var_1_5 < var_1_4) {
		var_1_7 = (min ((var_1_8 - var_1_9) , var_1_10));
	} else {
		var_1_7 = var_1_9;
	}
	...
	if ((var_1_9 << var_1_18) <= (max (var_1_19 , var_1_20))) {
		if (var_1_9 >= var_1_19) {
			var_1_22 = var_1_18;
		} else {
			var_1_22 = var_1_20;
	...
	signed long int stepLocal_4 = var_1_19 - (var_1_27 - var_1_18);
	if (((var_1_24 - var_1_25) / var_1_26) == stepLocal_4) {
	...
	unsigned long int stepLocal_1 = var_1_8 + var_1_9;
	if (var_1_12) {
		if ((var_1_10 + var_1_22) > stepLocal_1) {
			var_1_13 = var_1_14;
		}
	} else {
		var_1_13 = var_1_15;
	...
	if (stepLocal_2 <= ((var_1_10 ^ var_1_8) & var_1_22)) {
		var_1_16 = var_1_4;
	}


	// From: Req9Batch68100_while
	if ((var_1_38 / (var_1_29 - var_1_30)) > (var_1_19 << var_1_20)) {
	...
	if (((var_1_7 | var_1_8) > var_1_9) && var_1_13) {
		var_1_11 = var_1_5;
	}


	// From: Req10Batch68100_while
	if ((min (var_1_22 , var_1_24)) != (var_1_23 + (min (var_1_22 , var_1_7)))) {
		var_1_32 = var_1_30;
	} else {
		if (16.8f <= var_1_1) {
			var_1_32 = var_1_21;
	...
	signed long int stepLocal_6 = var_1_23 / var_1_31;
	if (var_1_14) {
		var_1_40 = (min ((var_1_30 + var_1_7) , var_1_32));
	} else {
	...
	signed long int stepLocal_3 = abs (var_1_32);
	if (-1 > stepLocal_3) {
	...
	if ((var_1_29 & (var_1_8 ^ var_1_40)) < var_1_7) {
...
int property(void) {
	return ((((((((((((((last_1_var_1_40 >= last_1_var_1_7) ? (var_1_1 == ((float) (max (var_1_4 , 9.999999996E8f)))) : (var_1_1 == ((float) (max ((var_1_5 + var_1_6) , var_1_4))))) && ((var_1_5 < var_1_4) ? (var_1_7 == ((unsigned long int) (min ((var_1_8 - var_1_9) , var_1_10)))) : (var_1_7 == ((unsigned long int) var_1_9)))) && ((((var_1_7 | var_1_8) > var_1_9) && var_1_13) ? (var_1_11 == ((float) var_1_5)) : 1)) && (var_1_12 ? (((var_1_10 + var_1_22) > (var_1_8 + var_1_9)) ? (var_1_13 == ((unsigned char) var_1_14)) : 1) : (var_1_13 == ((unsigned char) var_1_15)))) && ((var_1_9 <= ((var_1_10 ^ var_1_8) & var_1_22)) ? (var_1_16 == ((float) var_1_4)) : 1)) && ((-1 > (abs (var_1_32))) ? (var_1_17 == ((unsigned short int) ((var_1_18 + var_1_19) - ((var_1_20 - var_1_21) + 5)))) : 1)) && (((var_1_9 << var_1_18) <= (max (var_1_19 , var_1_20))) ? ((var_1_9 >= var_1_19) ? (var_1_22 == ((unsigned long int) var_1_18)) : (var_1_22 == ((unsigned long int) var_1_20))) : (var_1_22 == ((unsigned long int) var_1_18)))) && ((((var_1_24 - var_1_25) / var_1_26) == (var_1_19 - (var_1_27 - var_1_18))) ? (var_1_23 == ((unsigned short int) (var_1_20 + var_1_18))) : 1)) && (((var_1_38 / (var_1_29 - var_1_30)) > (var_1_19 << var_1_20)) ? (var_1_28 == ((unsigned short int) (var_1_31 - var_1_21))) : (var_1_28 == ((unsigned short int) 50)))) && (((min (var_1_22 , var_1_24)) != (var_1_23 + (min (var_1_22 , var_1_7)))) ? (var_1_32 == ((unsigned short int) var_1_30)) : ((16.8f <= var_1_1) ? (var_1_32 == ((unsigned short int) var_1_21)) : (var_1_32 == ((unsigned short int) var_1_30))))) && (((var_1_29 & (var_1_8 ^ var_1_40)) < var_1_7) ? (var_1_34 == ((float) ((255.5f - var_1_35) + (min ((var_1_36 - var_1_37) , var_1_5))))) : 1)) && ((var_1_19 > var_1_9) ? (var_1_38 == ((signed short int) (var_1_29 + ((min (var_1_21 , var_1_30)) - (var_1_39 - 16))))) : 1)) && (var_1_14 ? (var_1_40 == ((signed long int) (min ((var_1_30 + var_1_7) , var_1_32)))) : (((var_1_23 / var_1_31) < var_1_22) ? (var_1_40 == ((signed long int) (var_1_39 + var_1_30))) : (var_1_40 == ((signed long int) var_1_25))))) && (var_1_42 == ((signed short int) var_1_25))
;
}
int main(void) {
	isInitial = 1;
