...
void step(void) {
	...
	if ((*(var_1_2_Pointer))) {
		(*(var_1_1_Pointer)) = ((17222 - (*(var_1_3_Pointer))) + ((min (29916 , (*(var_1_4_Pointer)))) - (*(var_1_5_Pointer))));
	}
	...
	signed long int stepLocal_0 = max ((*(var_1_3_Pointer)) , ((*(var_1_5_Pointer)) << (*(var_1_1_Pointer))));
	if ((*(var_1_4_Pointer)) <= stepLocal_0) {
		(*(var_1_7_Pointer)) = (min (((*(var_1_5_Pointer)) - (*(var_1_3_Pointer))) , (*(var_1_4_Pointer))));
	} else {
...
int property(void) {
	return ((((((*(var_1_2_Pointer)) ? ((*(var_1_1_Pointer)) == ((unsigned short int) ((17222 - (*(var_1_3_Pointer))) + ((min (29916 , (*(var_1_4_Pointer)))) - (*(var_1_5_Pointer)))))) : 1) && (((*(var_1_2_Pointer)) && ((*(var_1_4_Pointer)) >= ((*(var_1_3_Pointer)) + (*(var_1_1_Pointer))))) ? ((*(var_1_6_Pointer)) == ((signed char) 8)) : 1)) && (((*(var_1_4_Pointer)) <= (max ((*(var_1_3_Pointer)) , ((*(var_1_5_Pointer)) << (*(var_1_1_Pointer)))))) ? ((*(var_1_7_Pointer)) == ((signed long int) (min (((*(var_1_5_Pointer)) - (*(var_1_3_Pointer))) , (*(var_1_4_Pointer)))))) : ((*(var_1_7_Pointer)) == ((signed long int) ((*(var_1_5_Pointer)) + ((*(var_1_6_Pointer)) + (*(var_1_4_Pointer)))))))) && (((*(var_1_13_Pointer)) < (*(var_1_7_Pointer))) ? ((*(var_1_8_Pointer)) == ((double) ((*(var_1_9_Pointer)) - (*(var_1_10_Pointer))))) : ((*(var_1_8_Pointer)) == ((double) (((*(var_1_11_Pointer)) - (*(var_1_12_Pointer))) - (*(var_1_9_Pointer))))))) && ((*(var_1_13_Pointer)) == ((unsigned char) (*(var_1_14_Pointer))))) && ((*(var_1_15_Pointer)) == ((signed char) (*(var_1_16_Pointer))))
;
}
int main(void) {
	isInitial = 1;
