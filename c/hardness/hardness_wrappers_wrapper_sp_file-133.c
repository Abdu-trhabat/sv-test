...
void step(void) {
	...
	if (stepLocal_3 || (! (*(WrapperStruct00_var_1_17_Pointer)))) {
		if (stepLocal_4 < (*(WrapperStruct00_var_1_7_Pointer))) {
			(*(WrapperStruct00_var_1_15_Pointer)) = (min ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_4_Pointer))));
		} else {
	...
	if ((*(WrapperStruct00_var_1_7_Pointer)) <= stepLocal_2) {
		if ((*(WrapperStruct00_var_1_3_Pointer)) >= stepLocal_1) {
			(*(WrapperStruct00_var_1_9_Pointer)) = ((*(WrapperStruct00_var_1_12_Pointer)) + (abs (min ((*(WrapperStruct00_var_1_13_Pointer)) , (*(WrapperStruct00_var_1_14_Pointer))))));
		}
	} else {
...
int property(void) {
	return ((((8 >= ((*(WrapperStruct00_var_1_2_Pointer)) + (*(WrapperStruct00_var_1_3_Pointer)))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((signed short int) (min ((*(WrapperStruct00_var_1_4_Pointer)) , ((*(WrapperStruct00_var_1_5_Pointer)) + 10))))) : 1) && (((*(WrapperStruct00_var_1_3_Pointer)) <= (*(WrapperStruct00_var_1_2_Pointer))) ? ((*(WrapperStruct00_var_1_6_Pointer)) == ((unsigned short int) ((*(WrapperStruct00_var_1_7_Pointer)) + (*(WrapperStruct00_var_1_8_Pointer))))) : 1)) && (((*(WrapperStruct00_var_1_7_Pointer)) <= ((*(WrapperStruct00_var_1_6_Pointer)) + (*(WrapperStruct00_var_1_15_Pointer)))) ? (((*(WrapperStruct00_var_1_3_Pointer)) >= (*(WrapperStruct00_var_1_7_Pointer))) ? ((*(WrapperStruct00_var_1_9_Pointer)) == ((double) ((*(WrapperStruct00_var_1_12_Pointer)) + (abs (min ((*(WrapperStruct00_var_1_13_Pointer)) , (*(WrapperStruct00_var_1_14_Pointer)))))))) : 1) : ((*(WrapperStruct00_var_1_9_Pointer)) == ((double) ((*(WrapperStruct00_var_1_14_Pointer)) + (*(WrapperStruct00_var_1_12_Pointer))))))) && ((((*(WrapperStruct00_var_1_11_Pointer)) || (*(WrapperStruct00_var_1_16_Pointer))) || (! (*(WrapperStruct00_var_1_17_Pointer)))) ? (((*(WrapperStruct00_var_1_6_Pointer)) < (*(WrapperStruct00_var_1_7_Pointer))) ? ((*(WrapperStruct00_var_1_15_Pointer)) == ((signed short int) (min ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_4_Pointer)))))) : ((*(WrapperStruct00_var_1_17_Pointer)) ? ((*(WrapperStruct00_var_1_15_Pointer)) == ((signed short int) (*(WrapperStruct00_var_1_5_Pointer)))) : 1)) : ((*(WrapperStruct00_var_1_15_Pointer)) == ((signed short int) (*(WrapperStruct00_var_1_5_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
