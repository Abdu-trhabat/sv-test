...
void step(void) {
	...
	if (! BOOL_unsigned_char_Array_0[1][0]) {
		if (unsigned_short_int_Array_0[0][1] >= (min (unsigned_short_int_Array_0[0][0] , unsigned_short_int_Array_0[1][1]))) {
...
int property(void) {
	return ((((float_Array_0[1] >= 64.5f) ? ((float_Array_0[1] >= float_Array_0[0]) ? (unsigned_short_int_Array_0[1][1] == ((unsigned short int) (abs (max (unsigned_short_int_Array_0[0][1] , (max (unsigned_short_int_Array_0[1][0] , unsigned_short_int_Array_0[0][0]))))))) : (last_1_BOOL_unsigned_char_Array_0_1__1_ ? (unsigned_short_int_Array_0[1][1] == ((unsigned short int) unsigned_short_int_Array_0[1][0])) : (unsigned_short_int_Array_0[1][1] == ((unsigned short int) unsigned_short_int_Array_0[0][0])))) : (unsigned_short_int_Array_0[1][1] == ((unsigned short int) 50))) && (signed_short_int_Array_0[1] == ((signed short int) (abs (signed_short_int_Array_0[0]))))) && (((- 16) <= signed_short_int_Array_0[0]) ? (BOOL_unsigned_char_Array_0[0][1] == ((unsigned char) (! (! (! BOOL_unsigned_char_Array_0[0][0]))))) : (BOOL_unsigned_char_Array_0[0][1] == ((unsigned char) (BOOL_unsigned_char_Array_0[0][0] && BOOL_unsigned_char_Array_0[1][0]))))) && ((! BOOL_unsigned_char_Array_0[1][0]) ? ((unsigned_short_int_Array_0[0][1] >= (min (unsigned_short_int_Array_0[0][0] , unsigned_short_int_Array_0[1][1]))) ? (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) (BOOL_unsigned_char_Array_0[0][1] && BOOL_unsigned_char_Array_0[1][0]))) : (BOOL_unsigned_char_Array_0[1][1] == ((unsigned char) BOOL_unsigned_char_Array_0[1][0]))) : 1)
;
}
int main(void) {
	isInitial = 1;
