...
void step(void) {
	...
	if (stepLocal_0 > (var_1_4 + (abs (256)))) {
		var_1_1 = -1;
	}
	...
	if (stepLocal_1 <= ((var_1_13 * var_1_1) * (min (var_1_1 , var_1_13)))) {
	...
	// From: Req6Batch132normal
	if (var_1_5 != var_1_13) {
		if (var_1_5 <= var_1_1) {
			var_1_16 = (var_1_18 + var_1_19);
		}
	} else {
		if ((min (var_1_5 , var_1_7)) > var_1_11) {
			var_1_16 = var_1_19;
		}
	}


	// From: Req7Batch132normal
	signed long int stepLocal_6 = var_1_1;
	if (5 <= stepLocal_6) {
		if (var_1_9) {
			var_1_20 = (max (var_1_21 , 10.8f));
		} else {
...
int property(void) {
	return ((((((((last_1_var_1_10 + last_1_var_1_13) > (var_1_4 + (abs (256)))) ? (var_1_1 == ((signed long int) -1)) : 1) && ((var_1_1 <= ((var_1_13 * var_1_1) * (min (var_1_1 , var_1_13)))) ? (var_1_5 == ((unsigned char) (var_1_7 + var_1_8))) : (var_1_5 == ((unsigned char) var_1_7)))) && (var_1_9 == ((unsigned char) (! 0)))) && (var_1_9 ? ((var_1_7 != (- (var_1_1 ^ var_1_13))) ? (var_1_10 == ((unsigned char) (var_1_11 - var_1_12))) : 1) : 1)) && ((last_1_var_1_9 || var_1_14) ? (((last_1_var_1_5 * var_1_12) >= last_1_var_1_10) ? ((var_1_4 >= var_1_15) ? (var_1_13 == ((unsigned char) 32)) : (var_1_13 == ((unsigned char) var_1_7))) : (var_1_13 == ((unsigned char) 64))) : 1)) && ((var_1_5 != var_1_13) ? ((var_1_5 <= var_1_1) ? (var_1_16 == ((signed char) (var_1_18 + var_1_19))) : 1) : (((min (var_1_5 , var_1_7)) > var_1_11) ? (var_1_16 == ((signed char) var_1_19)) : 1))) && ((5 <= var_1_1) ? (var_1_9 ? (var_1_20 == ((float) (max (var_1_21 , 10.8f)))) : (var_1_20 == ((float) (abs (var_1_21))))) : 1)
;
}
int main(void) {
	isInitial = 1;
