...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch85Wrapper_AP.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch85Wrapper_AP
	if (last_1_BOOL_unsigned_char_Array_0_1__1_) {
		(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = (min (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) , -16));
	} else {
		if (last_1_BOOL_unsigned_char_Array_0_0__2_) {
			(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) + -4);
		} else {
			(*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) = (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer));
		}
	}


	// From: Req6Batch85Wrapper_AP
	signed long int stepLocal_0 = (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) * ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) / (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)));
	...
	// From: Req2Batch85Wrapper_AP
	(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) = (min ((max (32 , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) , 16));


	// From: Req3Batch85Wrapper_AP
	...
	// From: Req5Batch85Wrapper_AP
	if ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var4_Pointer))) {
		(*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) = ((min ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) , 100)) - 64);
	} else {
...
int property(void) {
	return (((((last_1_BOOL_unsigned_char_Array_0_1__1_ ? ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) == ((signed long int) (min (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var1_Pointer)) + (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) , -16)))) : (last_1_BOOL_unsigned_char_Array_0_0__2_ ? ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) == ((signed long int) ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)) + -4))) : ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) == ((signed long int) (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer)))))) && ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) == ((unsigned char) (min ((max (32 , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)))) , 16))))) && ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var4_Pointer)) == ((unsigned char) (((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)) || ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var5_Pointer)) || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var6_Pointer)))) || (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)))))) && ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var2_Pointer)) == ((unsigned char) (((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var8_Pointer)) && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var9_Pointer))) && (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var7_Pointer)))))) && ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var4_Pointer)) ? ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) == ((signed char) ((min ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) , 100)) - 64))) : ((*(signed_char_Array_0_arraysigned_char_Array_0Var1_Pointer)) == ((signed char) ((*(signed_char_Array_0_arraysigned_char_Array_0Var2_Pointer)) - (*(signed_char_Array_0_arraysigned_char_Array_0Var0_Pointer))))))) && ((((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer)) * ((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var2_Pointer)) / (*(unsigned_short_int_Array_0_arrayunsigned_short_int_Array_0Var0_Pointer)))) == (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var0_Pointer))) ? ((! (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var5_Pointer))) ? ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer)) == ((unsigned char) (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var0_Pointer)))) : ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer)) == ((unsigned char) (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var5_Pointer))))) : ((*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var3_Pointer)) == ((unsigned char) (*(BOOL_unsigned_char_Array_0_arrayBOOL_unsigned_char_Array_0Var1_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
