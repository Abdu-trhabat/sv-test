...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch185stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch185stepLocals
	signed long int stepLocal_2 = var_1_4;
	if ((var_1_3 / var_1_10) <= stepLocal_2) {
		var_1_9 = (((var_1_8 >= var_1_1) || var_1_11) && var_1_12);
	}


	// From: Req3Batch185stepLocals
...
int property(void) {
	return ((((((((var_1_2 - var_1_3) <= (max (var_1_4 , var_1_5))) ? ((var_1_6 || var_1_7) ? (var_1_1 == ((float) var_1_8)) : 1) : (var_1_1 == ((float) var_1_8))) && (((var_1_3 / var_1_10) <= var_1_4) ? (var_1_9 == ((unsigned char) (((var_1_8 >= var_1_1) || var_1_11) && var_1_12))) : 1)) && ((var_1_8 > var_1_1) ? ((var_1_10 >= var_1_3) ? (var_1_13 == ((unsigned char) (! var_1_11))) : 1) : (var_1_13 == ((unsigned char) (var_1_14 || var_1_15))))) && ((var_1_8 < var_1_1) ? ((var_1_10 == ((var_1_4 * var_1_5) + (var_1_3 >> 2))) ? (var_1_16 == ((unsigned short int) var_1_3)) : (var_1_16 == ((unsigned short int) var_1_17))) : (var_1_16 == ((unsigned short int) var_1_17)))) && ((((max (var_1_19 , var_1_20)) - var_1_21) >= (var_1_22 - var_1_23)) ? (var_1_18 == ((signed short int) (min (var_1_24 , var_1_25)))) : 1)) && (var_1_11 ? (var_1_26 == ((float) (var_1_27 + var_1_28))) : (var_1_26 == ((float) var_1_28)))) && ((var_1_10 >= var_1_3) ? (var_1_29 == ((float) (abs (var_1_27)))) : ((var_1_13 || var_1_14) ? (var_1_29 == ((float) 64.125f)) : 1))
;
}
int main(void) {
	isInitial = 1;
