...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch187Wrapper_SP.c", 13, "reach_error"); }
...
void step(void) {
 unsigned char stepLocal_1 = ((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_6_Pointer))) < (*(WrapperStruct00_var_1_3_Pointer));
 ...
 signed long int stepLocal_5 = (*(WrapperStruct00_var_1_6_Pointer));
 unsigned long int stepLocal_4 = (*(WrapperStruct00_var_1_1_Pointer));
 if (last_1_WrapperStruct00_var_1_10 > stepLocal_5) {
  if (((*(WrapperStruct00_var_1_8_Pointer)) - (*(WrapperStruct00_var_1_11_Pointer))) > stepLocal_4) {
   (*(WrapperStruct00_var_1_10_Pointer)) = ((((((*(WrapperStruct00_var_1_11_Pointer))) < ((last_1_WrapperStruct00_var_1_10 + (*(WrapperStruct00_var_1_1_Pointer))))) ? ((*(WrapperStruct00_var_1_11_Pointer))) : ((last_1_WrapperStruct00_var_1_10 + (*(WrapperStruct00_var_1_1_Pointer)))))) + (*(WrapperStruct00_var_1_12_Pointer)));
  }
 } else {
  (*(WrapperStruct00_var_1_10_Pointer)) = (*(WrapperStruct00_var_1_1_Pointer));
 }
 unsigned long int stepLocal_3 = (*(WrapperStruct00_var_1_1_Pointer));
 signed long int stepLocal_2 = 2;
 if (stepLocal_2 == ((((((*(WrapperStruct00_var_1_10_Pointer)) | (*(WrapperStruct00_var_1_1_Pointer)))) < ((*(WrapperStruct00_var_1_1_Pointer)))) ? (((*(WrapperStruct00_var_1_10_Pointer)) | (*(WrapperStruct00_var_1_1_Pointer)))) : ((*(WrapperStruct00_var_1_1_Pointer)))))) {
  if ((*(WrapperStruct00_var_1_10_Pointer)) < stepLocal_3) {
   (*(WrapperStruct00_var_1_7_Pointer)) = ((*(WrapperStruct00_var_1_8_Pointer)) - 8);
  } else {
...
int property(void) {
 return (((*(WrapperStruct00_var_1_2_Pointer)) ? (((*(WrapperStruct00_var_1_3_Pointer)) <= (*(WrapperStruct00_var_1_4_Pointer))) ? (((*(WrapperStruct00_var_1_5_Pointer)) && (((*(WrapperStruct00_var_1_4_Pointer)) / (*(WrapperStruct00_var_1_6_Pointer))) < (*(WrapperStruct00_var_1_3_Pointer)))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned long int) (*(WrapperStruct00_var_1_4_Pointer)))) : 1) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned long int) (*(WrapperStruct00_var_1_3_Pointer))))) : 1) && ((2 == ((((((*(WrapperStruct00_var_1_10_Pointer)) | (*(WrapperStruct00_var_1_1_Pointer)))) < ((*(WrapperStruct00_var_1_1_Pointer)))) ? (((*(WrapperStruct00_var_1_10_Pointer)) | (*(WrapperStruct00_var_1_1_Pointer)))) : ((*(WrapperStruct00_var_1_1_Pointer)))))) ? (((*(WrapperStruct00_var_1_10_Pointer)) < (*(WrapperStruct00_var_1_1_Pointer))) ? ((*(WrapperStruct00_var_1_7_Pointer)) == ((signed short int) ((*(WrapperStruct00_var_1_8_Pointer)) - 8))) : ((*(WrapperStruct00_var_1_7_Pointer)) == ((signed short int) (*(WrapperStruct00_var_1_8_Pointer))))) : ((*(WrapperStruct00_var_1_2_Pointer)) ? ((*(WrapperStruct00_var_1_7_Pointer)) == ((signed short int) (*(WrapperStruct00_var_1_8_Pointer)))) : ((*(WrapperStruct00_var_1_7_Pointer)) == ((signed short int) (*(WrapperStruct00_var_1_9_Pointer))))))) && ((last_1_WrapperStruct00_var_1_10 > (*(WrapperStruct00_var_1_6_Pointer))) ? ((((*(WrapperStruct00_var_1_8_Pointer)) - (*(WrapperStruct00_var_1_11_Pointer))) > (*(WrapperStruct00_var_1_1_Pointer))) ? ((*(WrapperStruct00_var_1_10_Pointer)) == ((unsigned long int) ((((((*(WrapperStruct00_var_1_11_Pointer))) < ((last_1_WrapperStruct00_var_1_10 + (*(WrapperStruct00_var_1_1_Pointer))))) ? ((*(WrapperStruct00_var_1_11_Pointer))) : ((last_1_WrapperStruct00_var_1_10 + (*(WrapperStruct00_var_1_1_Pointer)))))) + (*(WrapperStruct00_var_1_12_Pointer))))) : 1) : ((*(WrapperStruct00_var_1_10_Pointer)) == ((unsigned long int) (*(WrapperStruct00_var_1_1_Pointer)))))
;
}
int main(void) {
 isInitial = 1;
