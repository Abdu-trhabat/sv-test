...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch9950_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch9950_1loop
	var_1_6 = ((var_1_7 - var_1_8) + var_1_9);


	// From: Req3Batch9950_1loop
