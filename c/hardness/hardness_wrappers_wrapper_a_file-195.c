...
void step(void) {
	// From: Req3Batch195Wrapper_A
	if ((float_Array_0[0] - float_Array_0[1]) > last_1_double_Array_0_1__2_) {
		signed_long_int_Array_0[0][0] = (min ((unsigned_char_Array_0[0] - last_1_signed_long_int_Array_0_0__0_) , (min (signed_long_int_Array_0[1][1] , signed_long_int_Array_0[1][0]))));
	} else {
		signed_long_int_Array_0[0][0] = (last_1_signed_long_int_Array_0_0__0_ - (max (signed_long_int_Array_0[0][1] , unsigned_char_Array_0[0])));
	}


	// From: Req4Batch195Wrapper_A
	if (signed_long_int_Array_0[0][0] <= (signed_long_int_Array_0[0][1] * (- signed_long_int_Array_0[0][0]))) {
		unsigned_long_int_Array_0[0] = (max (signed_long_int_Array_0[0][0] , unsigned_long_int_Array_0[1]));
	} else {
		unsigned_long_int_Array_0[0] = signed_long_int_Array_0[0][0];
	}


	// From: Req2Batch195Wrapper_A
	signed long int stepLocal_0 = signed_long_int_Array_0[0][0];
	if (stepLocal_0 <= unsigned_long_int_Array_0[0]) {
		double_Array_0[1][2] = (max ((min ((double_Array_0[1][1] + double_Array_0[1][0]) , double_Array_0[0][0])) , (min (double_Array_0[0][1] , double_Array_0[0][2]))));
	} else {
		double_Array_0[1][2] = 16.2;
	}


	// From: Req1Batch195Wrapper_A
...
int property(void) {
	return ((((signed_long_int_Array_0[0][0] < unsigned_long_int_Array_0[0]) ? (BOOL_unsigned_char_Array_0[2] == ((unsigned char) BOOL_unsigned_char_Array_0[1])) : (BOOL_unsigned_char_Array_0[2] == ((unsigned char) (BOOL_unsigned_char_Array_0[1] && BOOL_unsigned_char_Array_0[0])))) && ((signed_long_int_Array_0[0][0] <= unsigned_long_int_Array_0[0]) ? (double_Array_0[1][2] == ((double) (max ((min ((double_Array_0[1][1] + double_Array_0[1][0]) , double_Array_0[0][0])) , (min (double_Array_0[0][1] , double_Array_0[0][2])))))) : (double_Array_0[1][2] == ((double) 16.2)))) && (((float_Array_0[0] - float_Array_0[1]) > last_1_double_Array_0_1__2_) ? (signed_long_int_Array_0[0][0] == ((signed long int) (min ((unsigned_char_Array_0[0] - last_1_signed_long_int_Array_0_0__0_) , (min (signed_long_int_Array_0[1][1] , signed_long_int_Array_0[1][0])))))) : (signed_long_int_Array_0[0][0] == ((signed long int) (last_1_signed_long_int_Array_0_0__0_ - (max (signed_long_int_Array_0[0][1] , unsigned_char_Array_0[0]))))))) && ((signed_long_int_Array_0[0][0] <= (signed_long_int_Array_0[0][1] * (- signed_long_int_Array_0[0][0]))) ? (unsigned_long_int_Array_0[0] == ((unsigned long int) (max (signed_long_int_Array_0[0][0] , unsigned_long_int_Array_0[1])))) : (unsigned_long_int_Array_0[0] == ((unsigned long int) signed_long_int_Array_0[0][0])))
;
}
int main(void) {
	isInitial = 1;
