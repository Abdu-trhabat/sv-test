...
void step(void) {
	...
	if (-5 != (var_1_24 + last_1_var_1_27)) {
		if (var_1_36) {
			var_1_48 = (max (var_1_30 , ((var_1_28 - var_1_26) + (min (var_1_25 , var_1_24)))));
		}
	}
	...
	if (stepLocal_21 <= var_1_10) {
		...
		var_1_56 = (min ((var_1_54 - var_1_26) , var_1_28));
	}


	// From: Req30Batch54Amount500
	signed long int stepLocal_31 = last_1_var_1_44 | (abs (var_1_26));
	if ((min (last_1_var_1_64 , (max (var_1_54 , var_1_30)))) == stepLocal_31) {
		if (! last_1_var_1_76) {
			var_1_88 = (min ((last_1_var_1_44 + last_1_var_1_63) , (max (last_1_var_1_88 , last_1_var_1_1))));
		}
	}
	...
	if (last_1_var_1_88 > (abs (var_1_65))) {
	...
	if (last_1_var_1_76) {
		if ((abs (last_1_var_1_41)) < last_1_var_1_101) {
			if ((var_1_9 % (max (var_1_6 , var_1_13))) > stepLocal_2) {
	...
	if (stepLocal_19 <= var_1_6) {
		...
		var_1_49 = (max ((max (var_1_47 , var_1_19)) , (var_1_21 + var_1_20)));
	}
	...
	if (var_1_40) {
		if (var_1_60 < var_1_32) {
			var_1_68 = (var_1_30 + (abs (var_1_29)));
		} else {
			var_1_68 = (var_1_69 - var_1_30);
		}
	} else {
		var_1_68 = (max ((var_1_70 - (var_1_30 + var_1_71)) , (var_1_69 - (var_1_72 + var_1_73))));
	}
	...
	if ((var_1_59 - var_1_58) < var_1_18) {
		if (var_1_13 < (min (var_1_26 , (var_1_80 - 2)))) {
			var_1_91 = var_1_59;
		}
	} else {
		var_1_91 = var_1_20;
	...
	if (var_1_56 < stepLocal_33) {
		...
		var_1_102 = (min ((max ((var_1_22 - var_1_103) , var_1_58)) , var_1_17));
	}
	...
	if (! ((- 9.9999999999925E11) >= var_1_75)) {
		...
		if (var_1_12 && stepLocal_1) {
			var_1_1 = ((min (var_1_7 , var_1_10)) + var_1_11);
		}
	}
	...
	if (var_1_41 < var_1_101) {
		var_1_23 = (max (((var_1_24 + var_1_25) - (1 + var_1_26)) , (min ((55265 - var_1_11) , var_1_8))));
	}
	...
	if ((~ var_1_8) >= stepLocal_16) {
		...
		var_1_42 = ((abs (var_1_11)) + (var_1_23 + var_1_7));
	}
	...
	if (var_1_40) {
		if (stepLocal_17 <= ((min (var_1_56 , var_1_64)) / var_1_24)) {
			...
			if (var_1_34) {
				...
				if (stepLocal_18 < var_1_96) {
					if (! var_1_76) {
						var_1_46 = ((min (var_1_22 , (6.102753784646214E18f - var_1_21))) - var_1_47);
					}
				}
			}
		}
	...
	if (stepLocal_22 > ((var_1_26 << var_1_30) ^ var_1_13)) {
		var_1_57 = (((var_1_58 + var_1_59) - var_1_21) + (min (var_1_60 , var_1_22)));
	} else {
		var_1_57 = (abs (var_1_18));
	}
	...
	if (var_1_37) {
		...
		if (var_1_94 > (abs (var_1_47))) {
			var_1_61 = (var_1_30 - (var_1_62 - var_1_99));
		} else {
			var_1_61 = (abs (var_1_99 - (min (var_1_30 , var_1_29))));
		}
	}
	...
	if (9.999999992E8 <= var_1_22) {
		var_1_85 = (min (var_1_79 , var_1_30));
	} else {
		if (stepLocal_30 != (var_1_73 - var_1_28)) {
			var_1_85 = (max (var_1_72 , var_1_80));
		} else {
			var_1_85 = (max ((var_1_71 + (var_1_29 - var_1_30)) , var_1_73));
		}
	}
	...
	if (! var_1_90) {
		...
		if (stepLocal_8 && var_1_15) {
			var_1_27 = (min ((min (var_1_95 , (abs (var_1_6)))) , var_1_11));
		}
	}


	// From: Req3Batch54Amount500
	unsigned char stepLocal_4 = (max (var_1_101 , var_1_20)) > var_1_22;
	...
	if ((min (var_1_30 , var_1_25)) <= (max (var_1_9 , -1000))) {
	...
	signed long int stepLocal_12 = max ((var_1_88 - var_1_7) , var_1_29);
	...
	if (var_1_22 < var_1_16) {
		if ((var_1_87 % (max (var_1_13 , var_1_29))) > var_1_30) {
			var_1_51 = ((abs (var_1_6)) - last_1_var_1_51);
		} else {
			var_1_51 = ((max (var_1_10 , var_1_24)) + var_1_7);
		}
	} else {
		if (var_1_15 || (var_1_22 > (5.2f + -0.2f))) {
			if (var_1_25 != var_1_28) {
				var_1_51 = (max (0 , var_1_8));
			} else {
				if (var_1_75 != (min (var_1_16 , var_1_41))) {
					var_1_51 = (var_1_6 - (var_1_28 - (var_1_53 - last_1_var_1_51)));
				} else {
					var_1_51 = ((var_1_54 - (32 + var_1_29)) - (max (var_1_30 , (abs (var_1_11)))));
				}
			}
		}
	}
	...
	if ((var_1_56 * var_1_10) != var_1_7) {
		if (var_1_90) {
			var_1_74 = (128 - (abs (var_1_72)));
		} else {
			if ((10 / var_1_13) < (var_1_72 - var_1_54)) {
				var_1_74 = ((max (var_1_71 , (var_1_72 + var_1_73))) + (var_1_29 - var_1_30));
			}
		}
	}
	...
	unsigned long int stepLocal_25 = min (var_1_73 , var_1_99);
	unsigned char stepLocal_24 = var_1_12;
	if ((max (var_1_72 , var_1_42)) >= stepLocal_29) {
			...
			if (stepLocal_26 > ((var_1_99 * var_1_45) * var_1_95)) {
				if (var_1_63 != stepLocal_28) {
					if (stepLocal_24 && var_1_43) {
						var_1_78 = (abs (last_1_var_1_78));
					} else {
						var_1_78 = ((last_1_var_1_78 - var_1_69) + (var_1_42 + var_1_72));
					}
				} else {
					if (var_1_13 >= stepLocal_25) {
						var_1_78 = (var_1_26 + ((max (var_1_73 , var_1_29)) + var_1_70));
					}
				}
			} else {
				var_1_78 = ((min (var_1_79 , var_1_80)) - (var_1_62 - var_1_26));
			}
		}
	}
}
...
int property(void) {
	return (((((((((((((((((((((((((((((((((((((((((((! ((- 9.9999999999925E11) >= var_1_75)) ? ((var_1_75 >= var_1_94) ? ((var_1_75 < 7.5) ? ((var_1_12 && (! (var_1_101 >= var_1_94))) ? (var_1_1 == ((unsigned short int) (var_1_6 - var_1_7))) : (var_1_1 == ((unsigned short int) (max ((min (var_1_7 , var_1_6)) , (max (var_1_8 , var_1_9))))))) : (var_1_1 == ((unsigned short int) var_1_6))) : (var_1_1 == ((unsigned short int) (57411 - var_1_7)))) : ((var_1_12 && (var_1_94 <= var_1_75)) ? (var_1_1 == ((unsigned short int) ((min (var_1_7 , var_1_10)) + var_1_11))) : 1)) && (last_1_var_1_76 ? (((abs (last_1_var_1_41)) < last_1_var_1_101) ? (((var_1_9 % (max (var_1_6 , var_1_13))) > last_1_var_1_27) ? (var_1_12 == ((unsigned char) (! (last_1_var_1_12 && (! var_1_15))))) : 1) : (var_1_12 == ((unsigned char) (! (! var_1_15))))) : (var_1_12 == ((unsigned char) ((last_1_var_1_41 >= last_1_var_1_101) && (! var_1_15)))))) && ((var_1_12 && var_1_90) ? ((var_1_41 >= var_1_101) ? (var_1_16 == ((float) (((max (var_1_17 , var_1_18)) + var_1_19) + (min (var_1_20 , (var_1_21 - var_1_22)))))) : 1) : ((var_1_12 && ((max (var_1_101 , var_1_20)) > var_1_22)) ? (var_1_16 == ((float) (max (var_1_21 , (var_1_17 + (var_1_19 + var_1_18)))))) : 1))) && ((var_1_41 < var_1_101) ? (var_1_23 == ((unsigned short int) (max (((var_1_24 + var_1_25) - (1 + var_1_26)) , (min ((55265 - var_1_11) , var_1_8)))))) : 1)) && ((! var_1_90) ? ((var_1_15 && var_1_43) ? (var_1_27 == ((signed long int) (var_1_95 - var_1_24))) : ((var_1_95 < ((var_1_25 + var_1_28) - var_1_24)) ? (var_1_27 == ((signed long int) var_1_24)) : (((10 - (var_1_29 - var_1_30)) > var_1_11) ? (var_1_27 == ((signed long int) 2)) : 1))) : (((var_1_25 > var_1_10) && var_1_15) ? (var_1_27 == ((signed long int) (min ((min (var_1_95 , (abs (var_1_6)))) , var_1_11)))) : 1))) && (((var_1_30 * var_1_28) <= (max ((var_1_88 - var_1_7) , var_1_29))) ? ((var_1_30 > var_1_26) ? ((var_1_16 < ((var_1_20 + var_1_18) * var_1_41)) ? (var_1_31 == ((unsigned char) var_1_30)) : (var_1_31 == ((unsigned char) (var_1_29 + var_1_30)))) : 1) : ((var_1_19 == ((var_1_22 + var_1_21) - var_1_32)) ? (var_1_31 == ((unsigned char) (var_1_29 + var_1_30))) : ((var_1_13 < var_1_28) ? ((((var_1_98 && var_1_43) && var_1_90) && (var_1_28 <= var_1_24)) ? (var_1_31 == ((unsigned char) var_1_30)) : (var_1_31 == ((unsigned char) 4))) : (var_1_31 == ((unsigned char) var_1_30)))))) && (var_1_15 ? ((var_1_20 >= var_1_75) ? (var_1_33 == ((unsigned char) ((var_1_34 && var_1_35) && (var_1_76 || (var_1_12 || var_1_36))))) : (var_1_33 == ((unsigned char) (var_1_12 && var_1_37)))) : (((var_1_17 <= var_1_19) || ((var_1_18 + var_1_32) != var_1_57)) ? ((var_1_8 < var_1_42) ? (var_1_33 == ((unsigned char) var_1_36)) : (var_1_33 == ((unsigned char) ((var_1_37 || var_1_40) || (! (var_1_35 || var_1_36)))))) : (var_1_33 == ((unsigned char) var_1_36))))) && ((((var_1_88 >= var_1_29) && (var_1_13 <= var_1_88)) && var_1_34) ? (var_1_41 == ((double) (min ((var_1_21 + (abs (var_1_20))) , var_1_22)))) : 1)) && (((~ var_1_8) >= var_1_30) ? ((var_1_101 <= (- (- var_1_102))) ? (var_1_42 == ((signed long int) (var_1_88 - var_1_7))) : 1) : (var_1_42 == ((signed long int) ((abs (var_1_11)) + (var_1_23 + var_1_7)))))) && ((var_1_49 < (var_1_101 * var_1_21)) ? (var_1_43 == ((unsigned char) (var_1_40 || var_1_37))) : (var_1_43 == ((unsigned char) (var_1_36 || (! var_1_40)))))) && (((var_1_28 > (100 << var_1_13)) && var_1_43) ? ((! var_1_36) ? (var_1_44 == ((signed long int) (var_1_48 - (var_1_45 - var_1_6)))) : (var_1_44 == ((signed long int) ((var_1_48 + var_1_8) - var_1_6)))) : (var_1_44 == ((signed long int) var_1_9)))) && (var_1_40 ? ((256u <= ((min (var_1_56 , var_1_64)) / var_1_24)) ? (var_1_46 == ((float) (min (var_1_18 , var_1_19)))) : (var_1_34 ? (var_1_46 == ((float) (max ((abs (var_1_17)) , (var_1_47 - var_1_22))))) : ((var_1_29 < var_1_96) ? ((! var_1_76) ? (var_1_46 == ((float) ((min (var_1_22 , (6.102753784646214E18f - var_1_21))) - var_1_47))) : 1) : 1))) : 1)) && ((-5 != (var_1_24 + last_1_var_1_27)) ? (var_1_36 ? (var_1_48 == ((unsigned short int) (max (var_1_30 , ((var_1_28 - var_1_26) + (min (var_1_25 , var_1_24))))))) : 1) : 1)) && ((var_1_29 <= var_1_6) ? (var_1_49 == ((double) (var_1_19 + var_1_18))) : (var_1_49 == ((double) (max ((max (var_1_47 , var_1_19)) , (var_1_21 + var_1_20))))))) && ((var_1_22 < var_1_16) ? (((var_1_87 % (max (var_1_13 , var_1_29))) > var_1_30) ? (var_1_51 == ((unsigned short int) ((abs (var_1_6)) - last_1_var_1_51))) : (var_1_51 == ((unsigned short int) ((max (var_1_10 , var_1_24)) + var_1_7)))) : ((var_1_15 || (var_1_22 > (5.2f + -0.2f))) ? ((var_1_25 != var_1_28) ? (var_1_51 == ((unsigned short int) (max (0 , var_1_8)))) : ((var_1_75 != (min (var_1_16 , var_1_41))) ? (var_1_51 == ((unsigned short int) (var_1_6 - (var_1_28 - (var_1_53 - last_1_var_1_51))))) : (var_1_51 == ((unsigned short int) ((var_1_54 - (32 + var_1_29)) - (max (var_1_30 , (abs (var_1_11))))))))) : 1))) && ((var_1_9 != ((var_1_6 - var_1_29) * var_1_13)) ? (var_1_55 == ((signed short int) (var_1_29 - (16 + var_1_53)))) : 1)) && (((var_1_48 * var_1_6) <= var_1_10) ? (var_1_56 == ((unsigned short int) (var_1_54 - var_1_26))) : (var_1_56 == ((unsigned short int) (min ((var_1_54 - var_1_26) , var_1_28)))))) && ((var_1_96 > ((var_1_26 << var_1_30) ^ var_1_13)) ? (var_1_57 == ((float) (((var_1_58 + var_1_59) - var_1_21) + (min (var_1_60 , var_1_22))))) : (var_1_57 == ((float) (abs (var_1_18)))))) && (var_1_37 ? (var_1_61 == ((signed short int) var_1_29)) : ((var_1_94 > (abs (var_1_47))) ? (var_1_61 == ((signed short int) (var_1_30 - (var_1_62 - var_1_99)))) : (var_1_61 == ((signed short int) (abs (var_1_99 - (min (var_1_30 , var_1_29))))))))) && (((min (var_1_30 , var_1_25)) <= (max (var_1_9 , -1000))) ? ((var_1_16 <= ((var_1_47 + var_1_59) / 9.999999996E8f)) ? (var_1_63 == ((signed long int) var_1_88)) : 1) : ((var_1_64 >= var_1_96) ? (var_1_63 == ((signed long int) (32 - var_1_25))) : 1))) && ((last_1_var_1_88 > (abs (var_1_65))) ? ((last_1_var_1_98 || (var_1_36 && var_1_15)) ? (var_1_64 == ((unsigned short int) (var_1_6 - (var_1_26 + var_1_29)))) : ((last_1_var_1_88 >= var_1_30) ? (var_1_64 == ((unsigned short int) (var_1_29 + (1 + var_1_26)))) : 1)) : ((((var_1_21 / var_1_66) * last_1_var_1_49) < last_1_var_1_57) ? (var_1_64 == ((unsigned short int) (min (var_1_9 , var_1_30)))) : (var_1_64 == ((unsigned short int) ((var_1_62 + (var_1_67 - last_1_var_1_88)) - var_1_7)))))) && (var_1_40 ? ((var_1_60 < var_1_32) ? (var_1_68 == ((unsigned char) (var_1_30 + (abs (var_1_29))))) : (var_1_68 == ((unsigned char) (var_1_69 - var_1_30)))) : (var_1_68 == ((unsigned char) (max ((var_1_70 - (var_1_30 + var_1_71)) , (var_1_69 - (var_1_72 + var_1_73)))))))) && (((var_1_56 * var_1_10) != var_1_7) ? (var_1_90 ? (var_1_74 == ((unsigned char) (128 - (abs (var_1_72))))) : (((10 / var_1_13) < (var_1_72 - var_1_54)) ? (var_1_74 == ((unsigned char) ((max (var_1_71 , (var_1_72 + var_1_73))) + (var_1_29 - var_1_30)))) : 1)) : 1)) && ((var_1_94 < 127.125) ? (var_1_75 == ((double) 256.2)) : (var_1_75 == ((double) (var_1_21 - var_1_22))))) && (var_1_76 == ((unsigned char) var_1_34))) && ((var_1_35 || var_1_76) ? (var_1_77 == ((unsigned char) var_1_69)) : (var_1_77 == ((unsigned char) var_1_29)))) && (((max (var_1_72 , var_1_42)) >= (var_1_63 * (var_1_28 - var_1_64))) ? (var_1_78 == ((signed short int) (var_1_53 - var_1_30))) : ((var_1_28 != (var_1_65 >> (var_1_79 - var_1_80))) ? ((var_1_8 > ((var_1_99 * var_1_45) * var_1_95)) ? ((var_1_63 != var_1_56) ? ((var_1_12 && var_1_43) ? (var_1_78 == ((signed short int) (abs (last_1_var_1_78)))) : (var_1_78 == ((signed short int) ((last_1_var_1_78 - var_1_69) + (var_1_42 + var_1_72))))) : ((var_1_13 >= (min (var_1_73 , var_1_99))) ? (var_1_78 == ((signed short int) (var_1_26 + ((max (var_1_73 , var_1_29)) + var_1_70)))) : 1)) : (var_1_78 == ((signed short int) ((min (var_1_79 , var_1_80)) - (var_1_62 - var_1_26))))) : 1))) && ((9.999999992E8 <= var_1_22) ? (var_1_85 == ((unsigned char) (min (var_1_79 , var_1_30)))) : ((((var_1_99 * 5) + var_1_13) != (var_1_73 - var_1_28)) ? (var_1_85 == ((unsigned char) (max (var_1_72 , var_1_80)))) : (var_1_85 == ((unsigned char) (max ((var_1_71 + (var_1_29 - var_1_30)) , var_1_73))))))) && (var_1_87 == ((signed long int) (var_1_8 - var_1_11)))) && (((min (last_1_var_1_64 , (max (var_1_54 , var_1_30)))) == (last_1_var_1_44 | (abs (var_1_26)))) ? ((! last_1_var_1_76) ? (var_1_88 == ((signed long int) (min ((last_1_var_1_44 + last_1_var_1_63) , (max (last_1_var_1_88 , last_1_var_1_1)))))) : 1) : 1)) && ((-32 < (2 << var_1_71)) ? (var_1_89 == ((signed short int) ((var_1_62 - var_1_56) - var_1_71))) : (var_1_89 == ((signed short int) (8 + var_1_70))))) && (var_1_37 ? ((var_1_92 != var_1_26) ? (((var_1_64 & (- var_1_96)) < var_1_56) ? (var_1_90 == ((unsigned char) (! var_1_40))) : (var_1_90 == ((unsigned char) var_1_40))) : (var_1_90 == ((unsigned char) (! 0)))) : 1)) && (((var_1_59 - var_1_58) < var_1_18) ? ((var_1_13 < (min (var_1_26 , (var_1_80 - 2)))) ? (var_1_91 == ((double) var_1_59)) : 1) : (var_1_91 == ((double) var_1_20)))) && (var_1_98 ? (var_1_92 == ((unsigned char) var_1_93)) : (var_1_92 == ((unsigned char) var_1_73)))) && (var_1_12 ? (var_1_94 == ((double) var_1_21)) : (var_1_94 == ((double) var_1_59)))) && (var_1_95 == ((unsigned short int) var_1_73))) && (var_1_36 ? (var_1_96 == ((signed long int) 200)) : (var_1_96 == ((signed long int) var_1_30)))) && (var_1_97 == ((unsigned short int) 5))) && (var_1_98 == ((unsigned char) var_1_40))) && (var_1_98 ? (var_1_99 == ((unsigned long int) var_1_24)) : (var_1_99 == ((unsigned long int) var_1_87)))) && (var_1_100 == ((double) var_1_20))) && (var_1_37 ? (var_1_101 == ((double) var_1_17)) : (var_1_101 == ((double) var_1_59)))) && ((var_1_56 < var_1_99) ? (var_1_102 == ((float) ((var_1_103 - var_1_58) - var_1_21))) : (var_1_102 == ((float) (min ((max ((var_1_22 - var_1_103) , var_1_58)) , var_1_17)))))
;
}
int main(void) {
	isInitial = 1;
