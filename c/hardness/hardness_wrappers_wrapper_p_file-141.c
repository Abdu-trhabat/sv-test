		...
		if ((*(var_1_2_Pointer)) > 63.5f) {
			if (! ((64 >> (*(var_1_14_Pointer))) >= (*(var_1_5_Pointer)))) {
				if (stepLocal_0 >= (*(var_1_8_Pointer))) {
					(*(var_1_13_Pointer)) = (max ((*(var_1_15_Pointer)) , 10.2));
				}
			} else {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) < (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((signed char) (max ((-32 + (*(var_1_4_Pointer))) , (max ((*(var_1_5_Pointer)) , (*(var_1_6_Pointer)))))))) : ((*(var_1_1_Pointer)) == ((signed char) ((1 - (*(var_1_7_Pointer))) + (*(var_1_4_Pointer)))))) && (((*(var_1_9_Pointer)) || (((*(var_1_7_Pointer)) / (*(var_1_10_Pointer))) <= ((*(var_1_6_Pointer)) * (*(var_1_4_Pointer))))) ? ((*(var_1_8_Pointer)) == ((signed short int) (*(var_1_7_Pointer)))) : 1)) && ((*(var_1_11_Pointer)) == ((unsigned char) ((*(var_1_12_Pointer)) - (*(var_1_7_Pointer)))))) && ((-100 >= (*(var_1_4_Pointer))) ? (((*(var_1_2_Pointer)) > 63.5f) ? ((! ((64 >> (*(var_1_14_Pointer))) >= (*(var_1_5_Pointer)))) ? ((4 >= (*(var_1_8_Pointer))) ? ((*(var_1_13_Pointer)) == ((double) (max ((*(var_1_15_Pointer)) , 10.2)))) : 1) : ((*(var_1_13_Pointer)) == ((double) (*(var_1_15_Pointer))))) : ((*(var_1_13_Pointer)) == ((double) (*(var_1_15_Pointer))))) : 1)
;
}
int main(void) {
	isInitial = 1;
