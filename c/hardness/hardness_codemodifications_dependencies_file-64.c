...
void step(void) {
	...
	// From: Req3Batch64dependencies
	if (var_1_10 != var_1_8) {
		var_1_18 = (min (var_1_14 , var_1_13));
	}


	// From: Req4Batch64dependencies
	var_1_19 = ((var_1_20 - var_1_11) - var_1_21);


	// From: Req6Batch64dependencies
