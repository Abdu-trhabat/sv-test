...
void step(void) {
	// From: Req1Batch172stepLocals
	if ((var_1_2 >= (abs (var_1_3))) || var_1_4) {
		var_1_1 = var_1_5;
	}


	// From: Req2Batch172stepLocals
	if (var_1_1 > var_1_5) {
		var_1_6 = var_1_7;
	}


	// From: Req3Batch172stepLocals
	if (var_1_4 && var_1_9) {
