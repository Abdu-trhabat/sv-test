...
void step(void) {
	// From: Req2Batch157Wrapper_AP
	if (((*(float_Array_0_arrayfloat_Array_0arrayVar5_Pointer)) + (*(float_Array_0_arrayfloat_Array_0arrayVar2_Pointer))) >= ((min ((*(float_Array_0_arrayfloat_Array_0arrayVar3_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar0_Pointer)))) - (min ((*(float_Array_0_arrayfloat_Array_0arrayVar1_Pointer)) , (*(float_Array_0_arrayfloat_Array_0arrayVar4_Pointer)))))) {
	...
	// From: Req4Batch157Wrapper_AP
	(*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var2_Pointer)) = ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var3_Pointer)) - ((32 - (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var0_Pointer))) + (min ((*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var1_Pointer)) , (*(unsigned_char_Array_0_arrayunsigned_char_Array_0Var4_Pointer))))));


	// From: Req1Batch157Wrapper_AP
	signed long int stepLocal_1 = max (((*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var8_Pointer)) - (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var7_Pointer))) , (*(signed_long_int_Array_0_arraysigned_long_int_Array_0Var4_Pointer)));
