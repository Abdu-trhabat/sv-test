...
void step(void) {
	...
	// From: Req2Batch166normal
	if (var_1_2 != var_1_6) {
		var_1_8 = (var_1_10 - (var_1_11 + var_1_12));
	}


	// From: Req4Batch166normal
	...
	// From: Req3Batch166normal
	if (var_1_1 || var_1_7) {
		var_1_13 = (var_1_14 + var_1_15);
	} else {
		if (((max (var_1_14 , var_1_15)) * var_1_20) <= var_1_20) {
			if (var_1_9 == var_1_12) {
...
int property(void) {
	return ((((((var_1_2 <= var_1_3) ? ((var_1_2 > (var_1_3 * var_1_6)) ? (var_1_1 == ((unsigned char) (! ((var_1_3 <= var_1_2) || var_1_7)))) : (var_1_1 == ((unsigned char) var_1_7))) : 1) && ((var_1_2 != var_1_6) ? (var_1_8 == ((unsigned short int) (var_1_10 - (var_1_11 + var_1_12)))) : 1)) && ((var_1_1 || var_1_7) ? (var_1_13 == ((float) (var_1_14 + var_1_15))) : ((((max (var_1_14 , var_1_15)) * var_1_20) <= var_1_20) ? ((var_1_9 == var_1_12) ? (var_1_13 == ((float) (var_1_18 - (min (var_1_19 , 2.225f))))) : 1) : (var_1_13 == ((float) var_1_15))))) && ((var_1_8 > var_1_11) ? (var_1_20 == ((float) (min ((abs (63.5f)) , var_1_15)))) : 1)) && ((var_1_15 < (- var_1_13)) ? (var_1_21 == ((signed short int) (min (var_1_12 , var_1_11)))) : (var_1_1 ? (var_1_1 ? (var_1_21 == ((signed short int) var_1_12)) : 1) : (var_1_21 == ((signed short int) var_1_11))))) && (var_1_1 ? ((10 == (var_1_11 + var_1_8)) ? (var_1_22 == ((signed short int) (var_1_12 - var_1_11))) : (var_1_22 == ((signed short int) var_1_11))) : (var_1_22 == ((signed short int) var_1_12)))
;
}
int main(void) {
	isInitial = 1;
