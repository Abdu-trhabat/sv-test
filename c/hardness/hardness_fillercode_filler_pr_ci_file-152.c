...
void step(void) {
	...
	/* 262L, 111L) */ if (var_1_12) {
		/* 264L, 109L) */ if (/* 265L, 85L, 86L) */ ((/* 266L, 81L, 87L) */ ((/* 267L, 79L, 88L) */ ((var_1_34) + (var_1_31))) / (var_1_20))) != (/* 271L, 84L, 92L) */ ((var_1_35) / (var_1_41))))) {
			/* 274L, 108L) */ var_1_38 = (
				/* 277L, 107L) */ (abs (
					var_1_3
				))
