...
void step(void) {
 ...
 if (stepLocal_0 <= (last_1_var_1_13 + var_1_2)) {
  if (stepLocal_2 == last_1_var_1_9) {
   if (var_1_2 != stepLocal_1) {
    ...
    var_1_9 = ((((var_1_11 - last_1_var_1_9) < 0 ) ? -(var_1_11 - last_1_var_1_9) : (var_1_11 - last_1_var_1_9)));
   }
  } else {
 ...
 if ((((((var_1_11) < (last_1_var_1_29)) ? (var_1_11) : (last_1_var_1_29))) & (last_1_var_1_29 | -8)) >= stepLocal_3) {
  var_1_12 = ((((var_1_2) < (last_1_var_1_29)) ? (var_1_2) : (last_1_var_1_29)));
 } else {
 ...
 var_1_35 = var_1_19;
 var_1_36 = var_1_26;
 var_1_13 = (((((var_1_9 + var_1_2)) > (var_1_3)) ? ((var_1_9 + var_1_2)) : (var_1_3)));
 ...
 if (var_1_6) {
  var_1_22 = (var_1_11 - (((((var_1_2) < 0 ) ? -(var_1_2) : (var_1_2))) + ((((var_1_28) > (100u)) ? (var_1_28) : (100u)))));
 } else {
 ...
 if (var_1_4 && (var_1_5 && var_1_15)) {
  var_1_23 = (((((var_1_24 + var_1_25)) > (((var_1_26 + 10) - var_1_27))) ? ((var_1_24 + var_1_25)) : (((var_1_26 + 10) - var_1_27))));
 }
 ...
 if (stepLocal_6 > (var_1_3 * 25)) {
  if (stepLocal_5 <= var_1_9) {
   if (var_1_8) {
    var_1_29 = (var_1_9 + (((((var_1_31 - var_1_3)) < (var_1_3)) ? ((var_1_31 - var_1_3)) : (var_1_3))));
   } else {
    if (var_1_18 > (var_1_20 - var_1_19)) {
     var_1_29 = ((var_1_32 - var_1_3) - (((((var_1_9 + var_1_34)) > ((var_1_26 + var_1_27))) ? ((var_1_9 + var_1_34)) : ((var_1_26 + var_1_27)))));
    } else {
     var_1_29 = var_1_3;
    }
   }
  ...
  if (((var_1_20 - var_1_21) + var_1_16) > (var_1_19 * var_1_18)) {
   var_1_29 = ((((var_1_33) > (var_1_31)) ? (var_1_33) : (var_1_31)));
  } else {
   var_1_29 = var_1_9;
  }
 }
...
int property(void) {
 return (((((((((((((((var_1_1 == ((unsigned char) var_1_2)) && (var_1_3 == ((signed short int) last_1_var_1_29))) && ((var_1_34 <= var_1_13) ? (var_1_4 == ((unsigned char) (var_1_5 && var_1_6))) : 1)) && (var_1_7 == ((unsigned char) (! var_1_8)))) && ((last_1_var_1_13 <= (last_1_var_1_13 + var_1_2)) ? ((var_1_2 == last_1_var_1_9) ? ((var_1_2 != last_1_var_1_13) ? (var_1_9 == ((unsigned long int) 128u)) : (var_1_9 == ((unsigned long int) ((((var_1_11 - last_1_var_1_9) < 0 ) ? -(var_1_11 - last_1_var_1_9) : (var_1_11 - last_1_var_1_9)))))) : (var_1_9 == ((unsigned long int) (var_1_11 - var_1_2)))) : (var_1_9 == ((unsigned long int) var_1_11)))) && (((((((var_1_11) < (last_1_var_1_29)) ? (var_1_11) : (last_1_var_1_29))) & (last_1_var_1_29 | -8)) >= (var_1_2 * last_1_var_1_22)) ? (var_1_12 == ((signed short int) ((((var_1_2) < (last_1_var_1_29)) ? (var_1_2) : (last_1_var_1_29))))) : (var_1_12 == ((signed short int) last_1_var_1_29)))) && (var_1_13 == ((signed short int) (((((var_1_9 + var_1_2)) > (var_1_3)) ? ((var_1_9 + var_1_2)) : (var_1_3)))))) && (((var_1_29 * var_1_1) != -256) ? (var_1_14 == ((unsigned char) ((! (var_1_4 && var_1_8)) && (! (var_1_6 && var_1_15))))) : 1)) && ((var_1_3 > var_1_12) ? (var_1_16 == ((float) ((((var_1_17) < (var_1_18)) ? (var_1_17) : (var_1_18))))) : (var_1_16 == ((float) ((var_1_19 + var_1_20) - (25.25f + var_1_21)))))) && (var_1_6 ? (var_1_22 == ((unsigned long int) (var_1_11 - (((((var_1_2) < 0 ) ? -(var_1_2) : (var_1_2))) + ((((var_1_28) > (100u)) ? (var_1_28) : (100u))))))) : (var_1_22 == ((unsigned long int) ((2u + var_1_12) + var_1_28))))) && ((var_1_4 && (var_1_5 && var_1_15)) ? (var_1_23 == ((signed char) (((((var_1_24 + var_1_25)) > (((var_1_26 + 10) - var_1_27))) ? ((var_1_24 + var_1_25)) : (((var_1_26 + 10) - var_1_27)))))) : 1)) && (var_1_28 == ((unsigned char) var_1_2))) && ((var_1_34 > (var_1_3 * 25)) ? ((var_1_12 <= var_1_9) ? (var_1_8 ? (var_1_29 == ((unsigned short int) (var_1_9 + (((((var_1_31 - var_1_3)) < (var_1_3)) ? ((var_1_31 - var_1_3)) : (var_1_3)))))) : ((var_1_18 > (var_1_20 - var_1_19)) ? (var_1_29 == ((unsigned short int) ((var_1_32 - var_1_3) - (((((var_1_9 + var_1_34)) > ((var_1_26 + var_1_27))) ? ((var_1_9 + var_1_34)) : ((var_1_26 + var_1_27))))))) : (var_1_29 == ((unsigned short int) var_1_3)))) : 1) : ((((var_1_20 - var_1_21) + var_1_16) > (var_1_19 * var_1_18)) ? (var_1_29 == ((unsigned short int) ((((var_1_33) > (var_1_31)) ? (var_1_33) : (var_1_31))))) : (var_1_29 == ((unsigned short int) var_1_9))))) && (var_1_34 == ((unsigned short int) var_1_32))) && (var_1_35 == ((float) var_1_19))) && (var_1_36 == ((signed char) var_1_26))
;
}
int main(void) {
 isInitial = 1;
