...
void step(void) {
 ...
 if ((*(WrapperStruct00_var_1_2_Pointer)) > (*(WrapperStruct00_var_1_8_Pointer))) {
  if (! ((*(WrapperStruct00_var_1_16_Pointer)) < (*(WrapperStruct00_var_1_20_Pointer)))) {
   (*(WrapperStruct00_var_1_19_Pointer)) = ((((((((8) < (((*(WrapperStruct00_var_1_21_Pointer)) - 8))) ? (8) : (((*(WrapperStruct00_var_1_21_Pointer)) - 8))))) > ((*(WrapperStruct00_var_1_17_Pointer)))) ? (((((8) < (((*(WrapperStruct00_var_1_21_Pointer)) - 8))) ? (8) : (((*(WrapperStruct00_var_1_21_Pointer)) - 8))))) : ((*(WrapperStruct00_var_1_17_Pointer)))));
  }
 } else {
