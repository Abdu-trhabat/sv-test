...
int property(void) {
	return ((((var_1_2 <= (var_1_3 * var_1_4)) ? (var_1_1 == ((signed short int) (min ((abs (var_1_2)) , (var_1_3 + var_1_4))))) : (((var_1_4 % var_1_5) <= var_1_3) ? (var_1_1 == ((signed short int) var_1_2)) : 1)) && ((var_1_1 == var_1_5) ? (var_1_6 == ((signed char) (var_1_7 + (max (var_1_8 , var_1_9))))) : 1)) && ((var_1_6 > var_1_4) ? (((~ 16u) > (max (var_1_5 , var_1_4))) ? (((~ (var_1_3 & var_1_2)) <= var_1_5) ? (var_1_10 == ((float) var_1_11)) : (var_1_10 == ((float) 24.575f))) : 1) : (var_1_10 == ((float) var_1_11)))) && (var_1_12 == ((unsigned short int) var_1_13))
;
}
int main(void) {
	isInitial = 1;
