...
void step(void) {
	// From: Req12Batch135Amount250
	if (var_1_2) {
		if (var_1_32) {
			var_1_40 = ((min (last_1_var_1_55 , var_1_41)) - var_1_38);
		}
	}


	// From: Req1Batch135Amount250
	...
	// From: Req8Batch135Amount250
	if (var_1_2) {
		var_1_29 = (var_1_13 + ((min (var_1_22 , var_1_21)) + var_1_20));
	} else {
		var_1_29 = (abs (var_1_20));
	}


	// From: Req11Batch135Amount250
	var_1_37 = ((var_1_38 + var_1_39) + var_1_8);


	// From: Req13Batch135Amount250
	if (var_1_17 > var_1_24) {
		var_1_42 = ((var_1_43 - var_1_39) + (min (var_1_35 , 256u)));
	} else {
		var_1_42 = (var_1_44 - (var_1_43 - var_1_28));
	}


	// From: Req17Batch135Amount250
	signed long int stepLocal_7 = var_1_50;
	if (var_1_8 != stepLocal_7) {
		var_1_51 = var_1_39;
	} else {
		var_1_51 = (max (var_1_38 , var_1_39));
	}


	// From: Req15Batch135Amount250
	signed long int stepLocal_6 = max (var_1_40 , 32);
	...
	if (var_1_31) {
		if (((var_1_14 + var_1_44) + (~ var_1_39)) == (var_1_46 - var_1_9)) {
			...
			if (var_1_2) {
				if (var_1_1 <= (abs (var_1_8))) {
					var_1_45 = (max (var_1_22 , var_1_12));
				} else {
					var_1_45 = ((max ((var_1_33 + var_1_20) , var_1_13)) + var_1_22);
				}
			}
		}
	}
	...
	// From: Req9Batch135Amount250
	if (var_1_22 > (var_1_20 + (- var_1_47))) {
		if (var_1_2) {
			if (var_1_31) {
				if (var_1_32) {
					var_1_30 = ((min (var_1_24 , (max (var_1_22 , var_1_20)))) + (var_1_21 + (3.4 + var_1_33)));
				}
			} else {
				var_1_30 = (((min (var_1_20 , var_1_21)) + 9.99999999999995E13) + var_1_24);
			}
		} else {
			var_1_30 = (max (31.5 , ((min (var_1_13 , 7.5)) + var_1_24)));
		}
	} else {
	...
	// From: Req20Batch135Amount250
	if (((var_1_18 - var_1_17) / (max (0.99 , var_1_23))) >= (- (var_1_11 * var_1_16))) {
		if (var_1_35 >= ((var_1_38 - var_1_43) % var_1_26)) {
			if ((50.6 / 9999999.875) > ((max (24.25 , var_1_17)) * var_1_20)) {
	...
	// From: Req10Batch135Amount250
	signed short int stepLocal_4 = var_1_40;
	if (var_1_47 < var_1_10) {
		if (stepLocal_4 < last_1_var_1_34) {
			var_1_34 = ((max (var_1_8 , var_1_9)) - ((max (var_1_35 , var_1_26)) + var_1_27));
		}
	} else {
		if (var_1_15 > (2.8 + 1.375)) {
			var_1_34 = (max (-5 , last_1_var_1_34));
		} else {
			var_1_34 = var_1_36;
		}
	}
	...
	// From: Req21Batch135Amount250
	if ((var_1_17 - (max (var_1_22 , var_1_18))) > var_1_24) {
		var_1_55 = (min (((abs (var_1_56)) - var_1_34) , var_1_39));
	} else {
		var_1_55 = 25;
	}


	// From: Req16Batch135Amount250
	var_1_49 = ((max (var_1_35 , var_1_28)) + (var_1_50 + (min (var_1_55 , var_1_38))));


	// From: Req18Batch135Amount250
	unsigned char stepLocal_10 = ! var_1_32;
	signed long int stepLocal_9 = var_1_34;
	signed char stepLocal_8 = var_1_51;
	if ((min (var_1_33 , (var_1_45 * var_1_17))) <= var_1_21) {
		var_1_52 = (16.55 - (abs (var_1_21)));
	} else {
		if (var_1_2) {
			if (stepLocal_9 < -16) {
				if (var_1_34 <= stepLocal_8) {
					...
					var_1_52 = (max ((min (var_1_21 , (abs (var_1_18)))) , var_1_17));
				}
			} else {
				var_1_52 = ((min (var_1_17 , (min (var_1_22 , var_1_18)))) - var_1_16);
			}
		} else {
	...
	// From: Req19Batch135Amount250
	if (! var_1_48) {
		if (var_1_40 > 8) {
			var_1_53 = ((var_1_49 + (min (var_1_27 , var_1_34))) + (abs (var_1_41)));
		}
	} else {
		if (var_1_40 > (var_1_44 * var_1_27)) {
			var_1_53 = (min ((min (var_1_1 , var_1_26)) , var_1_49));
		}
	}


	// From: Req7Batch135Amount250
	if ((~ 0) == (~ (var_1_49 + var_1_14))) {
		var_1_25 = (max (var_1_55 , (max (var_1_55 , (var_1_8 + -1)))));
	} else {
		var_1_25 = (((var_1_26 - var_1_8) + var_1_27) - (min (var_1_28 , 4)));
	}
}
...
int property(void) {
	return (((((((((((((((((((((last_1_var_1_40 != last_1_var_1_51) ? (var_1_1 == ((unsigned long int) var_1_5)) : (((50.6f + 199.5f) >= last_1_var_1_45) ? (var_1_1 == ((unsigned long int) (abs (var_1_5)))) : 1)) && (((128 - var_1_8) == var_1_1) ? (var_1_7 == ((signed long int) ((1176345877 - var_1_8) - var_1_9))) : (var_1_7 == ((signed long int) (var_1_8 - (abs (last_1_var_1_7))))))) && ((var_1_42 <= -10) ? (var_1_10 == ((float) var_1_11)) : ((var_1_1 > var_1_9) ? (var_1_2 ? (var_1_10 == ((float) (abs (var_1_11)))) : 1) : (var_1_10 == ((float) (var_1_12 + var_1_13)))))) && (var_1_14 == ((signed long int) (abs (var_1_9))))) && ((var_1_8 >= (~ var_1_1)) ? (var_1_15 == ((double) (var_1_16 - (max (var_1_17 , var_1_18))))) : (var_1_15 == ((double) (var_1_13 + var_1_12))))) && (((abs (var_1_11)) > var_1_18) ? (var_1_19 == ((float) ((var_1_20 + (var_1_21 - var_1_22)) + var_1_13))) : (((var_1_11 / var_1_23) <= (- var_1_17)) ? (var_1_19 == ((float) (var_1_21 + var_1_24))) : (var_1_19 == ((float) var_1_21))))) && (((~ 0) == (~ (var_1_49 + var_1_14))) ? (var_1_25 == ((signed short int) (max (var_1_55 , (max (var_1_55 , (var_1_8 + -1))))))) : (var_1_25 == ((signed short int) (((var_1_26 - var_1_8) + var_1_27) - (min (var_1_28 , 4))))))) && (var_1_2 ? (var_1_29 == ((double) (var_1_13 + ((min (var_1_22 , var_1_21)) + var_1_20)))) : (var_1_29 == ((double) (abs (var_1_20)))))) && ((var_1_22 > (var_1_20 + (- var_1_47))) ? (var_1_2 ? (var_1_31 ? (var_1_32 ? (var_1_30 == ((double) ((min (var_1_24 , (max (var_1_22 , var_1_20)))) + (var_1_21 + (3.4 + var_1_33))))) : 1) : (var_1_30 == ((double) (((min (var_1_20 , var_1_21)) + 9.99999999999995E13) + var_1_24)))) : (var_1_30 == ((double) (max (31.5 , ((min (var_1_13 , 7.5)) + var_1_24)))))) : ((var_1_21 > (- var_1_47)) ? (var_1_30 == ((double) var_1_17)) : (var_1_30 == ((double) var_1_24))))) && ((var_1_47 < var_1_10) ? ((var_1_40 < last_1_var_1_34) ? (var_1_34 == ((signed long int) ((max (var_1_8 , var_1_9)) - ((max (var_1_35 , var_1_26)) + var_1_27)))) : 1) : ((var_1_15 > (2.8 + 1.375)) ? (var_1_34 == ((signed long int) (max (-5 , last_1_var_1_34)))) : (var_1_34 == ((signed long int) var_1_36))))) && (var_1_37 == ((unsigned char) ((var_1_38 + var_1_39) + var_1_8)))) && (var_1_2 ? (var_1_32 ? (var_1_40 == ((signed short int) ((min (last_1_var_1_55 , var_1_41)) - var_1_38))) : 1) : 1)) && ((var_1_17 > var_1_24) ? (var_1_42 == ((unsigned long int) ((var_1_43 - var_1_39) + (min (var_1_35 , 256u))))) : (var_1_42 == ((unsigned long int) (var_1_44 - (var_1_43 - var_1_28)))))) && (var_1_31 ? ((((var_1_14 + var_1_44) + (~ var_1_39)) == (var_1_46 - var_1_9)) ? ((0u != (var_1_46 - (var_1_43 - var_1_26))) ? (var_1_45 == ((double) (var_1_21 - var_1_17))) : 1) : (var_1_2 ? ((var_1_1 <= (abs (var_1_8))) ? (var_1_45 == ((double) (max (var_1_22 , var_1_12)))) : (var_1_45 == ((double) ((max ((var_1_33 + var_1_20) , var_1_13)) + var_1_22)))) : 1)) : 1)) && (((var_1_32 && var_1_2) || var_1_48) ? (var_1_47 == ((double) var_1_33)) : (((max (var_1_40 , 32)) > var_1_42) ? (var_1_47 == ((double) (var_1_17 - (var_1_21 + var_1_22)))) : (var_1_47 == ((double) (var_1_13 + (var_1_20 + var_1_21))))))) && (var_1_49 == ((signed long int) ((max (var_1_35 , var_1_28)) + (var_1_50 + (min (var_1_55 , var_1_38))))))) && ((var_1_8 != var_1_50) ? (var_1_51 == ((signed char) var_1_39)) : (var_1_51 == ((signed char) (max (var_1_38 , var_1_39)))))) && (((min (var_1_33 , (var_1_45 * var_1_17))) <= var_1_21) ? (var_1_52 == ((double) (16.55 - (abs (var_1_21))))) : (var_1_2 ? ((var_1_34 < -16) ? ((var_1_34 <= var_1_51) ? (var_1_52 == ((double) (var_1_21 - var_1_22))) : (var_1_52 == ((double) (max ((min (var_1_21 , (abs (var_1_18)))) , var_1_17))))) : (var_1_52 == ((double) ((min (var_1_17 , (min (var_1_22 , var_1_18)))) - var_1_16)))) : (((! var_1_32) && var_1_48) ? (var_1_52 == ((double) ((var_1_21 - var_1_22) + var_1_20))) : 1)))) && ((! var_1_48) ? ((var_1_40 > 8) ? (var_1_53 == ((signed long int) ((var_1_49 + (min (var_1_27 , var_1_34))) + (abs (var_1_41))))) : 1) : ((var_1_40 > (var_1_44 * var_1_27)) ? (var_1_53 == ((signed long int) (min ((min (var_1_1 , var_1_26)) , var_1_49)))) : 1))) && ((((var_1_18 - var_1_17) / (max (0.99 , var_1_23))) >= (- (var_1_11 * var_1_16))) ? ((var_1_35 >= ((var_1_38 - var_1_43) % var_1_26)) ? (((50.6 / 9999999.875) > ((max (24.25 , var_1_17)) * var_1_20)) ? ((var_1_45 > var_1_20) ? (var_1_54 == ((float) var_1_20)) : (var_1_54 == ((float) var_1_11))) : (var_1_54 == ((float) var_1_18))) : (var_1_54 == ((float) var_1_13))) : (var_1_54 == ((float) var_1_18)))) && (((var_1_17 - (max (var_1_22 , var_1_18))) > var_1_24) ? (var_1_55 == ((unsigned short int) (min (((abs (var_1_56)) - var_1_34) , var_1_39)))) : (var_1_55 == ((unsigned short int) 25)))
;
}
int main(void) {
	isInitial = 1;
