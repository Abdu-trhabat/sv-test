...
void step(void) {
	...
	// From: CodeObject3
	/* 265L, 80L) */ if (/* 266L, 62L, 63L) */ ((var_1_17) <= (var_1_26))) {
		/* 269L, 78L) */ if (var_1_14) {
			/* 271L, 77L) */ var_1_27 = (
				/* 274L, 76L) */ (min (
					/* 274L, 76L) */ (
						var_1_30
	...
	// From: CodeObject5
	/* 292L, 174L) */ if (/* 293L, 117L, 118L) */ ((/* 294L, 114L, 119L) */ ((var_1_30) / (7.5f))) > (/* 297L, 116L, 122L) */ (- (var_1_6))))) {
	...
	// From: CodeObject7
	/* 338L, 239L) */ if (/* 339L, 218L, 219L) */ ((var_1_23) <= (/* 341L, 217L, 221L) */ ((/* 342L, 215L, 222L) */ (min (/* 342L, 215L, 222L) */ (var_1_40) , (var_1_41)))) - (var_1_16))))) {
		/* 346L, 238L) */ var_1_39 = (
			/* 349L, 237L) */ ((
				var_1_9
			) + (
