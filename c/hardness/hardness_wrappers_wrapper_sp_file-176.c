...
void step(void) {
	// From: Req1Batch176Wrapper_SP
	(*(WrapperStruct00_var_1_1_Pointer)) = ((10000000 + 5) - ((*(WrapperStruct00_var_1_2_Pointer)) - (*(WrapperStruct00_var_1_3_Pointer))));


	// From: Req3Batch176Wrapper_SP
	if (! ((*(WrapperStruct00_var_1_2_Pointer)) <= (*(WrapperStruct00_var_1_3_Pointer)))) {
		(*(WrapperStruct00_var_1_7_Pointer)) = (min ((*(WrapperStruct00_var_1_2_Pointer)) , (min ((*(WrapperStruct00_var_1_3_Pointer)) , (max (-128 , (*(WrapperStruct00_var_1_8_Pointer))))))));
	}


	// From: Req4Batch176Wrapper_SP
	unsigned long int stepLocal_2 = max ((*(WrapperStruct00_var_1_10_Pointer)) , (*(WrapperStruct00_var_1_1_Pointer)));
	if (stepLocal_2 >= (*(WrapperStruct00_var_1_5_Pointer))) {
		(*(WrapperStruct00_var_1_9_Pointer)) = (16 + (*(WrapperStruct00_var_1_11_Pointer)));
	}


	// From: Req5Batch176Wrapper_SP
