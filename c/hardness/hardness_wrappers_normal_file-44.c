...
void step(void) {
	...
	signed long int stepLocal_0 = (min (var_1_4 , var_1_3)) / var_1_7;
	...
	if ((var_1_12 - (abs (var_1_13))) >= var_1_14) {
...
int property(void) {
	return ((((var_1_4 > (var_1_5 - var_1_6)) ? ((((min (var_1_4 , var_1_3)) / var_1_7) <= var_1_6) ? (var_1_1 == ((signed long int) var_1_7)) : 1) : (var_1_1 == ((signed long int) var_1_3))) && (var_1_11 ? ((var_1_1 > var_1_2) ? (var_1_8 == ((unsigned char) (! var_1_10))) : (((var_1_1 % var_1_7) < (var_1_2 * (var_1_4 * var_1_6))) ? (var_1_8 == ((unsigned char) var_1_10)) : 1)) : 1)) && (((var_1_12 - (abs (var_1_13))) >= var_1_14) ? (var_1_11 == ((unsigned char) (((var_1_6 < var_1_1) && var_1_15) || (var_1_16 || var_1_17)))) : 1)) && (var_1_18 == ((float) var_1_19))
;
}
int main(void) {
	isInitial = 1;
