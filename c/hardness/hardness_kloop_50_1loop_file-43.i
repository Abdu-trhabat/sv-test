...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4350_1loop.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (var_1_1 > var_1_4) {
  ...
  var_1_11 = ((((var_1_26) < (((16 - 32) + (64 + var_1_10)))) ? (var_1_26) : (((16 - 32) + (64 + var_1_10)))));
 }
 if (var_1_13) {
