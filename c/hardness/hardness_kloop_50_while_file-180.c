...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch18050_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch18050_while
	var_1_14 = (min ((var_1_1 - var_1_12) , var_1_15));


	// From: Req3Batch18050_while
	if (var_1_7) {
		if (! var_1_11) {
	...
	// From: Req7Batch18050_while
	var_1_19 = (min (var_1_8 , var_1_9));


	// From: Req6Batch18050_while
	...
	if (stepLocal_1 >= var_1_1) {
		...
		if ((min (var_1_1 , var_1_14)) >= stepLocal_0) {
			var_1_6 = var_1_9;
		}
	}
}
