...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch99dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch99dependencies
	var_1_6 = ((var_1_7 - var_1_8) + var_1_9);


	// From: Req3Batch99dependencies
	...
	// From: Req5Batch99dependencies
	if (! var_1_5) {
		var_1_15 = (max ((var_1_16 + var_1_17) , var_1_14));
	}


	// From: Req6Batch99dependencies
	var_1_18 = (max (((var_1_19 - var_1_20) + var_1_21) , (var_1_22 - var_1_23)));


	// From: Req8Batch99dependencies
	if (var_1_1) {
		var_1_26 = (min ((min (var_1_15 , var_1_14)) , (var_1_27 - var_1_17)));
	}


	// From: Req9Batch99dependencies
	var_1_28 = var_1_16;


	// From: Req7Batch99dependencies
	if (var_1_23 >= (var_1_20 ^ var_1_28)) {
		var_1_24 = (max ((min (var_1_12 , var_1_11)) , ((var_1_25 - 25.5) - 127.125)));
	}


	// From: Req4Batch99dependencies
...
int property(void) {
	return ((((((((var_1_2 ? (var_1_1 == ((unsigned char) (var_1_3 || var_1_4))) : (var_1_1 == ((unsigned char) (var_1_3 || (var_1_4 || var_1_5))))) && (var_1_6 == ((signed long int) ((var_1_7 - var_1_8) + var_1_9)))) && ((var_1_9 < (var_1_6 * var_1_8)) ? (var_1_3 ? ((var_1_9 <= var_1_6) ? (var_1_10 == ((double) (var_1_11 - var_1_12))) : 1) : 1) : (var_1_10 == ((double) var_1_12)))) && ((var_1_12 != var_1_24) ? (var_1_13 == ((unsigned char) var_1_14)) : (((- var_1_6) > var_1_14) ? (var_1_13 == ((unsigned char) var_1_14)) : (var_1_13 == ((unsigned char) 25))))) && ((! var_1_5) ? (var_1_15 == ((unsigned char) (max ((var_1_16 + var_1_17) , var_1_14)))) : 1)) && (var_1_18 == ((signed char) (max (((var_1_19 - var_1_20) + var_1_21) , (var_1_22 - var_1_23)))))) && ((var_1_23 >= (var_1_20 ^ var_1_28)) ? (var_1_24 == ((double) (max ((min (var_1_12 , var_1_11)) , ((var_1_25 - 25.5) - 127.125))))) : 1)) && (var_1_1 ? (var_1_26 == ((unsigned short int) (min ((min (var_1_15 , var_1_14)) , (var_1_27 - var_1_17))))) : 1)) && (var_1_28 == ((unsigned char) var_1_16))
;
}
int main(void) {
	isInitial = 1;
