...
void step(void) {
	...
	// From: Req2Batch100normal
	var_1_10 = (var_1_11 - ((var_1_12 - var_1_13) + (min (var_1_14 , var_1_15))));


	// From: Req3Batch100normal
	signed long int stepLocal_1 = var_1_14 % var_1_12;
	if (stepLocal_1 <= var_1_1) {
		var_1_16 = (min ((max (var_1_18 , 128)) , var_1_19));
	}
}
