...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch104dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req6Batch104dependencies
	if (var_1_22 >= ((var_1_25 + 32) - var_1_3)) {
		var_1_24 = var_1_5;
	}


	// From: Req2Batch104dependencies
	if (var_1_8 > ((max (var_1_9 , var_1_10)) + var_1_11)) {
		...
		var_1_7 = ((max (var_1_16 , var_1_17)) - 256.4f);
	}


	// From: Req7Batch104dependencies
	...
	// From: Req4Batch104dependencies
	if (var_1_26) {
		if ((var_1_20 - var_1_21) > var_1_4) {
			var_1_19 = (max (var_1_16 , var_1_17));
		}
	}
}
...
int property(void) {
	return ((((((var_1_26 ? (var_1_1 == ((unsigned short int) ((max (var_1_3 , var_1_4)) + var_1_5))) : (var_1_1 == ((unsigned short int) (var_1_6 - var_1_3)))) && ((var_1_8 > ((max (var_1_9 , var_1_10)) + var_1_11)) ? (((var_1_2 && var_1_12) && var_1_13) ? (var_1_7 == ((float) (var_1_14 + var_1_15))) : (var_1_7 == ((float) 7.5f))) : (var_1_7 == ((float) ((max (var_1_16 , var_1_17)) - 256.4f))))) && (var_1_26 ? (var_1_26 ? (var_1_18 == ((unsigned short int) var_1_3)) : 1) : 1)) && (var_1_26 ? (((var_1_20 - var_1_21) > var_1_4) ? (var_1_19 == ((float) (max (var_1_16 , var_1_17)))) : 1) : 1)) && ((((var_1_4 + -10) * var_1_20) == last_1_var_1_24) ? ((var_1_17 > last_1_var_1_19) ? (var_1_22 == ((signed long int) (var_1_4 + var_1_3))) : (var_1_22 == ((signed long int) -10))) : (var_1_22 == ((signed long int) var_1_23)))) && ((var_1_22 >= ((var_1_25 + 32) - var_1_3)) ? (var_1_24 == ((unsigned long int) var_1_5)) : 1)) && ((var_1_4 > (min (var_1_5 , var_1_25))) ? ((var_1_10 >= var_1_9) ? (var_1_26 == ((unsigned char) (! var_1_27))) : (var_1_26 == ((unsigned char) var_1_27))) : (var_1_26 == ((unsigned char) 0)))
;
}
int main(void) {
	isInitial = 1;
