...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 303L, 133L) */ if (var_1_4) {
		...
		/* 311L, 131L) */ if (/* 312L, 75L, 76L) */ ((/* 313L, 73L, 77L) */ (max (/* 313L, 73L, 77L) */ (var_1_33) , (var_1_34)))) > (var_1_19))) {
