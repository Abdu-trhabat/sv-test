...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	if (var_1_13) {
		if ((var_1_1 / (var_1_14 - var_1_15)) <= stepLocal_1) {
			var_1_12 = var_1_16;
		} else {
			var_1_12 = 16;
		}
...
int property(void) {
	return (((((var_1_1 == ((unsigned long int) var_1_2)) && ((var_1_19 < var_1_1) ? (var_1_3 == ((double) -0.5)) : (((- var_1_17) == (var_1_6 - var_1_7)) ? (var_1_3 == ((double) (var_1_8 + (var_1_9 - (max (var_1_10 , var_1_11)))))) : (var_1_3 == ((double) 50.125))))) && (var_1_13 ? (((var_1_1 / (var_1_14 - var_1_15)) <= var_1_2) ? (var_1_12 == ((unsigned char) var_1_16)) : (var_1_12 == ((unsigned char) 16))) : (var_1_12 == ((unsigned char) var_1_16)))) && (var_1_17 == ((double) (var_1_8 + var_1_9)))) && (var_1_18 == ((signed long int) var_1_15))) && (var_1_19 == ((signed char) 8))
;
}
int main(void) {
	isInitial = 1;
