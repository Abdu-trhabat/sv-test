...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch60Amount50.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch60Amount50
	var_1_11 = var_1_12;


	// From: Req5Batch60Amount50
	...
	// From: Req7Batch60Amount50
	var_1_20 = (var_1_18 - ((min (var_1_21 , var_1_22)) + var_1_23));


	// From: Req8Batch60Amount50
	if (var_1_8 == var_1_19) {
		if (var_1_13 < var_1_6) {
			var_1_24 = var_1_23;
		}
	...
	// From: Req3Batch60Amount50
	signed long int stepLocal_0 = min (var_1_7 , var_1_1);
