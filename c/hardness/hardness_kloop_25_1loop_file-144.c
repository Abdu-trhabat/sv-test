...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14425_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch14425_1loop
	var_1_15 = var_1_14;


	// From: Req2Batch14425_1loop
