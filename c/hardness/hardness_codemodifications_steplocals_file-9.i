...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch9stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 signed long int stepLocal_1 = (var_1_3 & 0) * var_1_4;
 signed long int stepLocal_0 = var_1_2 >> var_1_3;
 if (stepLocal_0 == (var_1_4 / var_1_5)) {
  if ((var_1_2 * var_1_5) > stepLocal_1) {
 ...
 signed long int stepLocal_2 = ((((var_1_2 - var_1_15)) < (var_1_10)) ? ((var_1_2 - var_1_15)) : (var_1_10));
 if (((((((((var_1_5) < (16)) ? (var_1_5) : (16)))) > (var_1_3)) ? (((((var_1_5) < (16)) ? (var_1_5) : (16)))) : (var_1_3))) != stepLocal_2) {
  if (9999.5f >= var_1_1) {
   var_1_13 = var_1_9;
  }
 } else {
