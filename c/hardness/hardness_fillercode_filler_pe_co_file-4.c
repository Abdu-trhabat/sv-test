...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch4Filler_PE_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	/* 415L, 196L) */ if (var_1_1) {
		/* 417L, 194L) */ if (/* 418L, 179L, 180L) */ ((/* 419L, 177L, 181L) */ ((var_1_20) * (var_1_11))) < (var_1_13))) {
			/* 423L, 193L) */ var_1_31 = (
				var_1_34
			);
		}
	...
	// From: CodeObject5
	/* 427L, 220L) */ if (/* 428L, 209L, 210L) */ ((var_1_9) < (var_1_11))) {
		/* 431L, 219L) */ var_1_35 = (
			var_1_36
		);
	}
	...
	/* 478L, 292L) */ if (/* 479L, 254L, 255L) */ ((var_1_29) >= (var_1_28))) {
		/* 482L, 280L) */ if (/* 483L, 263L, 264L) */ ((var_1_13) != (var_1_11))) {
			/* 486L, 273L) */ var_1_38 = (
				var_1_36
			);
		} else {
	...
	/* 506L, 360L) */ if (/* 507L, 300L, 301L) */ ((/* 508L, 298L, 302L) */ (min (/* 508L, 298L, 302L) */ (var_1_15) , (var_1_31)))) < (var_1_15))) {
		...
		/* 521L, 358L) */ if (/* 522L, 337L, 338L) */ ((var_1_6) > (/* 524L, 336L, 340L) */ ((var_1_40) >> (/* 526L, 335L, 342L) */ ((var_1_44) - (2))))))) {
			/* 529L, 357L) */ var_1_43 = (
				/* 532L, 356L) */ ((
					var_1_44
				) + (
