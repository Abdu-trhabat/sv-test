...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch146Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned short int stepLocal_1 = var_1_14;
  ...
  var_1_21
                   ...
                   if ( ((var_1_14) >= ( ((((var_1_32) < 0 ) ? -(var_1_32) : (var_1_32)))))) {
                    var_1_31 = (
                     (((((( var_1_25 ) + ( var_1_29 ))) < 0 ) ? -((( var_1_25 ) + ( var_1_29 ))) : ((( var_1_25 ) + ( var_1_29 )))))
   );
  }
 }
                                if (var_1_2) {
