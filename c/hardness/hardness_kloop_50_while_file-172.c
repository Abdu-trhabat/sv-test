...
void step(void) {
	// From: Req1Batch17250_while
	if ((last_1_var_1_6 >= (abs (var_1_3))) || var_1_4) {
		var_1_1 = var_1_5;
	}


	// From: Req2Batch17250_while
	if (var_1_1 > var_1_5) {
		var_1_6 = var_1_7;
	}


	// From: Req3Batch17250_while
	if (var_1_4 && var_1_9) {
	...
	// From: Req8Batch17250_while
	var_1_24 = var_1_16;


	// From: Req4Batch17250_while
