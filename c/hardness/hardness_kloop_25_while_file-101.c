...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch10125_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch10125_while
	var_1_13 = (var_1_14 - (min (var_1_6 , var_1_5)));


	// From: Req4Batch10125_while
...
int property(void) {
	return (((var_1_2 ? (var_1_1 == ((unsigned char) (var_1_3 - (var_1_4 + (var_1_5 + var_1_6))))) : (var_1_7 ? (var_1_8 ? (var_1_1 == ((unsigned char) 8)) : (var_1_1 == ((unsigned char) 64))) : (var_1_1 == ((unsigned char) var_1_9)))) && ((((- var_1_11) * var_1_12) == 25.75) ? (var_1_8 ? (var_1_10 == ((signed char) var_1_4)) : 1) : 1)) && (var_1_13 == ((unsigned short int) (var_1_14 - (min (var_1_6 , var_1_5)))))) && ((var_1_2 && (var_1_13 < last_1_var_1_15)) ? (var_1_15 == ((unsigned short int) 16)) : (var_1_15 == ((unsigned short int) (var_1_5 + var_1_4))))
;
}
int main(void) {
	isInitial = 1;
