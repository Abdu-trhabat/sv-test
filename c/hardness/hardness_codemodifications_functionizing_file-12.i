...
void functionized2(unsigned char functionized2_localFunctionVar0, float functionized2_localFunctionVar1, unsigned long int functionized2_localFunctionVar2) {
 if (functionized2_localFunctionVar2 != ((((var_1_6) < (functionized2_localFunctionVar0)) ? (var_1_6) : (functionized2_localFunctionVar0)))) {
  var_1_10 = ((((var_1_11) > (functionized2_localFunctionVar1)) ? (var_1_11) : (functionized2_localFunctionVar1)));
 } else {
...
void step(void) {
 if (var_1_2 > functionized0()) {
  ...
  var_1_1 = ((((var_1_7) < ((functionized1() + var_1_6))) ? (var_1_7) : ((functionized1() + var_1_6))));
 }
 if ((- var_1_3) > var_1_6) {
 ...
 if (var_1_3 > var_1_2) {
  var_1_18 = ((((var_1_9) < (functionized4(var_1_6))) ? (var_1_9) : (functionized4(var_1_6))));
 } else {
