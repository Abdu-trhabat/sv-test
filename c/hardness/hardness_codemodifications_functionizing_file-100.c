...
void functionized0(unsigned long int functionized0_localFunctionVar0, signed long int localFunctionVar1) {
	if (localFunctionVar1 > ((min (functionized0_localFunctionVar0 , var_1_3)) + var_1_4)) {
		var_1_1 = var_1_5;
	} else {
		var_1_1 = 256.5;
	}
...
void functionized1(unsigned long int functionized1_localFunctionVar0, unsigned short int functionized1_localFunctionVar1, unsigned short int functionized1_localFunctionVar2) {
	if (((max (functionized1_localFunctionVar0 , var_1_9)) + var_1_3) == (2u * (var_1_12 * var_1_11))) {
		var_1_6 = functionized1_localFunctionVar1;
	} else {
		var_1_6 = (max ((abs (functionized1_localFunctionVar1)) , functionized1_localFunctionVar2));
	}
}
...
float functionized5(float functionized5_localFunctionVar0) {
	return (abs (functionized5_localFunctionVar0));
}
...
void step(void) {
	// From: Req1Batch100functionizing
	if (8u < var_1_2) {
		functionized0(var_1_2, -8);
	}


	// From: Req2Batch100functionizing
	if ((var_1_3 ^ (var_1_9 - var_1_10)) > (var_1_4 * (3512938537u - var_1_11))) {
		functionized1(var_1_2, var_1_13, var_1_14);
	}


	// From: Req3Batch100functionizing
	functionized2(var_1_17, var_1_16, var_1_18, 9.25);


	// From: Req4Batch100functionizing
	if ((max (var_1_1 , var_1_5)) > var_1_20) {
		var_1_19 = (max (var_1_6 , var_1_14));
	}


	// From: Req5Batch100functionizing
	...
	// From: Req6Batch100functionizing
...
int property(void) {
	return ((((((8u < var_1_2) ? ((-8 > ((min (var_1_2 , var_1_3)) + var_1_4)) ? (var_1_1 == ((double) var_1_5)) : (var_1_1 == ((double) 256.5))) : 1) && (((var_1_3 ^ (var_1_9 - var_1_10)) > (var_1_4 * (3512938537u - var_1_11))) ? ((((max (var_1_2 , var_1_9)) + var_1_3) == (2u * (var_1_12 * var_1_11))) ? (var_1_6 == ((unsigned short int) var_1_13)) : (var_1_6 == ((unsigned short int) (max ((abs (var_1_13)) , var_1_14))))) : 1)) && (var_1_16 ? (((var_1_1 + (var_1_5 + var_1_17)) < 9.25) ? (var_1_15 == ((float) var_1_5)) : 1) : (var_1_15 == ((float) var_1_18)))) && (((max (var_1_1 , var_1_5)) > var_1_20) ? (var_1_19 == ((unsigned long int) (max (var_1_6 , var_1_14)))) : 1)) && ((var_1_4 > var_1_11) ? ((var_1_4 > var_1_19) ? (var_1_21 == ((signed long int) 8)) : 1) : 1)) && ((! ((abs (var_1_17)) >= (var_1_23 - var_1_24))) ? (var_1_22 == ((double) (var_1_25 + (var_1_26 - var_1_27)))) : (var_1_16 ? (var_1_22 == ((double) var_1_18)) : 1))
;
}
int main(void) {
	isInitial = 1;
