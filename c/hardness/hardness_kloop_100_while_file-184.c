...
void step(void) {
	...
	// From: Req3Batch184100_while
	if ((abs (var_1_3)) <= var_1_4) {
		var_1_12 = (abs (var_1_13 - 4.25f));
	} else {
		var_1_12 = (var_1_13 - (8.966829933912052E18f - var_1_14));
	}


	// From: Req11Batch184100_while
	if ((var_1_5 > (~ var_1_7)) || var_1_11) {
		var_1_27 = (abs (var_1_28));
	}


	// From: Req1Batch184100_while
	...
	// From: Req7Batch184100_while
	signed long int stepLocal_3 = var_1_6;
	unsigned char stepLocal_2 = (abs (var_1_27)) <= var_1_5;
	...
	// From: Req6Batch184100_while
	if ((var_1_8 | var_1_9) > ((var_1_21 - 50) >> (var_1_22 + 4))) {
		if ((max (var_1_17 , var_1_18)) != var_1_14) {
	...
	// From: Req10Batch184100_while
	if (var_1_11) {
		if (var_1_5 > (var_1_29 / var_1_4)) {
			var_1_26 = (max (var_1_21 , var_1_3));
		}
	}


	// From: Req9Batch184100_while
...
int property(void) {
	return ((((((((((((((var_1_10 / var_1_3) / var_1_4) >= (var_1_5 - var_1_6)) ? (var_1_1 == ((signed char) (var_1_7 - (var_1_8 + var_1_9)))) : (var_1_1 == ((signed char) var_1_8))) && (var_1_11 ? (var_1_10 == ((signed long int) (var_1_7 - (var_1_3 + 25)))) : (var_1_10 == ((signed long int) var_1_8)))) && (((abs (var_1_3)) <= var_1_4) ? (var_1_12 == ((float) (abs (var_1_13 - 4.25f)))) : (var_1_12 == ((float) (var_1_13 - (8.966829933912052E18f - var_1_14)))))) && ((last_1_var_1_29 >= (var_1_8 / var_1_4)) ? (var_1_15 == ((float) (var_1_16 + (var_1_17 + var_1_18)))) : (var_1_15 == ((float) var_1_16)))) && ((var_1_6 <= (var_1_9 + var_1_27)) ? ((var_1_13 != (min (-0.8f , var_1_18))) ? (var_1_11 ? (var_1_19 == ((signed char) var_1_7)) : (var_1_19 == ((signed char) var_1_8))) : (var_1_19 == ((signed char) var_1_7))) : 1)) && (((var_1_8 | var_1_9) > ((var_1_21 - 50) >> (var_1_22 + 4))) ? (((max (var_1_17 , var_1_18)) != var_1_14) ? (((- var_1_15) >= var_1_12) ? (var_1_20 == ((unsigned short int) var_1_4)) : (var_1_20 == ((unsigned short int) var_1_9))) : (var_1_20 == ((unsigned short int) var_1_3))) : 1)) && ((var_1_10 >= var_1_6) ? ((((abs (var_1_27)) <= var_1_5) || var_1_11) ? (var_1_23 == ((signed char) var_1_8)) : 1) : (var_1_23 == ((signed char) var_1_9)))) && ((var_1_25 < (var_1_7 - var_1_22)) ? (var_1_24 == ((signed char) ((max (var_1_8 , var_1_9)) + var_1_22))) : (var_1_24 == ((signed char) var_1_7)))) && (((var_1_9 | var_1_26) != (var_1_10 + (var_1_27 - var_1_3))) ? (var_1_25 == ((unsigned short int) (var_1_8 + var_1_9))) : 1)) && (var_1_11 ? ((var_1_5 > (var_1_29 / var_1_4)) ? (var_1_26 == ((unsigned long int) (max (var_1_21 , var_1_3)))) : 1) : 1)) && (((var_1_5 > (~ var_1_7)) || var_1_11) ? (var_1_27 == ((unsigned long int) (abs (var_1_28)))) : 1)) && ((! (last_1_var_1_29 >= var_1_20)) ? (((var_1_16 <= var_1_18) || var_1_11) ? ((128 == ((var_1_10 + var_1_22) >> var_1_30)) ? (var_1_29 == ((unsigned long int) var_1_20)) : 1) : 1) : (var_1_29 == ((unsigned long int) var_1_10)))
;
}
int main(void) {
	isInitial = 1;
