...
void step(void) {
	...
	if (var_1_3) {
		if (var_1_6 >= ((var_1_10 - var_1_11) * 64)) {
	...
	if (var_1_4 > var_1_1) {
		var_1_5 = ((max (var_1_6 , -64)) + ((var_1_7 + -2) + var_1_8));
	}
...
void updateVariables(void) {
	...
	assume_abort_if_not(var_1_7 >= -268435455);
	assume_abort_if_not(var_1_7 <= 268435456);
...
int property(void) {
	return ((((((0.625f > last_1_var_1_9) ? (var_1_3 ? (var_1_1 == ((float) (abs (var_1_4)))) : 1) : (var_1_1 == ((float) (abs (var_1_4))))) && ((var_1_4 > var_1_1) ? (var_1_5 == ((signed long int) ((max (var_1_6 , -64)) + ((var_1_7 + -2) + var_1_8)))) : 1)) && (var_1_3 ? ((var_1_6 >= ((var_1_10 - var_1_11) * 64)) ? (var_1_9 == ((double) ((min (var_1_12 , 50.5)) - var_1_13))) : 1) : ((var_1_2 <= var_1_1) ? (var_1_9 == ((double) (var_1_13 - (var_1_14 - var_1_15)))) : 1))) && (var_1_16 == ((signed char) var_1_17))) && (var_1_18 == ((unsigned short int) var_1_19))) && (var_1_20 == ((unsigned short int) var_1_19))
;
}
int main(void) {
	isInitial = 1;
