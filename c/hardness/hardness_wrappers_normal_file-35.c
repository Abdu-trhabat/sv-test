...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch35normal.c", 13, "reach_error"); }
...
void step(void) {
	...
	unsigned long int stepLocal_3 = var_1_3 * var_1_2;
	signed long int stepLocal_2 = var_1_14 % var_1_12;
	unsigned long int stepLocal_1 = var_1_2;
	if ((var_1_12 - (64 - var_1_13)) != stepLocal_1) {
		if (stepLocal_2 >= var_1_3) {
			if (! var_1_7) {
				var_1_11 = ((var_1_15 + var_1_16) + (var_1_13 - var_1_17));
			}
		} else {
			if (32u >= stepLocal_3) {
				var_1_11 = 1;
...
int property(void) {
	return ((((var_1_2 >= (~ var_1_3)) ? (var_1_1 == ((float) (var_1_4 + var_1_5))) : 1) && (var_1_7 ? (var_1_8 ? (var_1_6 == ((signed short int) (var_1_9 + var_1_10))) : (var_1_6 == ((signed short int) var_1_9))) : (var_1_6 == ((signed short int) var_1_9)))) && (((var_1_12 - (64 - var_1_13)) != var_1_2) ? (((var_1_14 % var_1_12) >= var_1_3) ? ((! var_1_7) ? (var_1_11 == ((signed char) ((var_1_15 + var_1_16) + (var_1_13 - var_1_17)))) : 1) : ((32u >= (var_1_3 * var_1_2)) ? (var_1_11 == ((signed char) 1)) : (var_1_11 == ((signed char) var_1_15)))) : 1)) && (var_1_18 == ((double) var_1_4))
;
}
int main(void) {
	isInitial = 1;
