...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15550_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch15550_1loop
	if ((abs (var_1_7)) == var_1_9) {
		var_1_11 = var_1_12;
	}


	// From: Req5Batch15550_1loop
	var_1_16 = (var_1_17 + var_1_18);


	// From: Req8Batch15550_1loop
	if (var_1_12) {
		var_1_25 = (((abs (var_1_26)) - 25) - var_1_21);
	}


	// From: Req9Batch15550_1loop
	if ((~ (abs (var_1_21))) > var_1_10) {
		var_1_27 = 10;
	}


	// From: Req1Batch15550_1loop
	if (var_1_11) {
		var_1_1 = var_1_3;
	} else {
