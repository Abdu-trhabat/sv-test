...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch42Filler_PE_CI.c", 13, "reach_error"); }
...
void step(void) {
 ...
 signed short int stepLocal_0 = var_1_3;
   ...
   var_1_29
                   ...
                   if ( (( ((((( ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))))) < ((var_1_3))) ? (( ((((var_1_27) < 0 ) ? -(var_1_27) : (var_1_27))))) : ((var_1_3))))) <= (var_1_32))) {
                    var_1_31 = (
   var_1_7
  );
 }
                   if ( ((var_1_7) < ( ((((var_1_4) < 0 ) ? -(var_1_4) : (var_1_4)))))) {
                    var_1_34 = (
                     ((((( ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) )) > (( var_1_7 ))) ? (( ((((var_1_7) < 0 ) ? -(var_1_7) : (var_1_7))) )) : (( var_1_7 ))))
  );
 }
                   if (var_1_11) {
                    var_1_35 = (
