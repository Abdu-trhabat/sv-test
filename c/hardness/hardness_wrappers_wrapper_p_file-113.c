...
void step(void) {
	// From: Req1Batch113Wrapper_P
	unsigned long int stepLocal_0 = (*(var_1_3_Pointer));
	if ((*(var_1_2_Pointer)) >= stepLocal_0) {
		(*(var_1_1_Pointer)) = (min (128 , (*(var_1_4_Pointer))));
	} else {
		(*(var_1_1_Pointer)) = (min (((*(var_1_5_Pointer)) + (*(var_1_6_Pointer))) , (*(var_1_4_Pointer))));
	}


	// From: Req4Batch113Wrapper_P
	...
	// From: Req2Batch113Wrapper_P
	if ((*(var_1_14_Pointer)) >= (*(var_1_6_Pointer))) {
		(*(var_1_7_Pointer)) = (*(var_1_8_Pointer));
	}


	// From: Req3Batch113Wrapper_P
	if (-64 >= (*(var_1_14_Pointer))) {
		if ((-1000 < 256) && ((max ((*(var_1_14_Pointer)) , (*(var_1_6_Pointer)))) > (*(var_1_4_Pointer)))) {
...
int property(void) {
	return (((((*(var_1_2_Pointer)) >= (*(var_1_3_Pointer))) ? ((*(var_1_1_Pointer)) == ((unsigned short int) (min (128 , (*(var_1_4_Pointer)))))) : ((*(var_1_1_Pointer)) == ((unsigned short int) (min (((*(var_1_5_Pointer)) + (*(var_1_6_Pointer))) , (*(var_1_4_Pointer))))))) && (((*(var_1_14_Pointer)) >= (*(var_1_6_Pointer))) ? ((*(var_1_7_Pointer)) == ((float) (*(var_1_8_Pointer)))) : 1)) && ((-64 >= (*(var_1_14_Pointer))) ? (((-1000 < 256) && ((max ((*(var_1_14_Pointer)) , (*(var_1_6_Pointer)))) > (*(var_1_4_Pointer)))) ? (((*(var_1_4_Pointer)) < (((*(var_1_11_Pointer)) + (*(var_1_12_Pointer))) - (*(var_1_6_Pointer)))) ? ((*(var_1_9_Pointer)) == ((signed char) (*(var_1_13_Pointer)))) : 1) : ((*(var_1_9_Pointer)) == ((signed char) (*(var_1_13_Pointer))))) : 1)) && (((*(var_1_10_Pointer)) && (*(var_1_15_Pointer))) ? (((*(var_1_8_Pointer)) > (((*(var_1_16_Pointer)) - (*(var_1_17_Pointer))) - (*(var_1_18_Pointer)))) ? ((*(var_1_14_Pointer)) == ((unsigned long int) (*(var_1_19_Pointer)))) : 1) : ((*(var_1_14_Pointer)) == ((unsigned long int) (*(var_1_6_Pointer)))))
;
}
int main(void) {
	isInitial = 1;
