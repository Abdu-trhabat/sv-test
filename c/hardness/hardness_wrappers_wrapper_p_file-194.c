...
void step(void) {
	// From: Req2Batch194Wrapper_P
	unsigned char stepLocal_2 = (*(var_1_2_Pointer));
	signed long int stepLocal_1 = (*(var_1_5_Pointer)) / (min ((*(var_1_7_Pointer)) , (*(var_1_11_Pointer))));
	...
	// From: Req3Batch194Wrapper_P
	if ((*(var_1_2_Pointer))) {
		if ((*(var_1_7_Pointer)) > ((*(var_1_8_Pointer)) | (max ((*(var_1_11_Pointer)) , (*(var_1_3_Pointer)))))) {
			if (((*(var_1_13_Pointer)) - (*(var_1_14_Pointer))) < ((*(var_1_8_Pointer)) / (max ((*(var_1_7_Pointer)) , (*(var_1_11_Pointer)))))) {
...
int property(void) {
	return (((*(var_1_2_Pointer)) ? ((((*(var_1_3_Pointer)) == (*(var_1_4_Pointer))) && (((*(var_1_9_Pointer)) % (*(var_1_7_Pointer))) >= (*(var_1_9_Pointer)))) ? ((*(var_1_1_Pointer)) == ((signed char) (abs ((*(var_1_8_Pointer)))))) : 1) : ((*(var_1_1_Pointer)) == ((signed char) (*(var_1_8_Pointer))))) && (((*(var_1_2_Pointer)) && (*(var_1_10_Pointer))) ? ((*(var_1_9_Pointer)) == ((signed long int) (*(var_1_6_Pointer)))) : ((*(var_1_10_Pointer)) ? (((*(var_1_6_Pointer)) >= ((*(var_1_5_Pointer)) / (min ((*(var_1_7_Pointer)) , (*(var_1_11_Pointer)))))) ? ((*(var_1_9_Pointer)) == ((signed long int) (*(var_1_8_Pointer)))) : 1) : 1))) && ((*(var_1_2_Pointer)) ? (((*(var_1_7_Pointer)) > ((*(var_1_8_Pointer)) | (max ((*(var_1_11_Pointer)) , (*(var_1_3_Pointer)))))) ? ((((*(var_1_13_Pointer)) - (*(var_1_14_Pointer))) < ((*(var_1_8_Pointer)) / (max ((*(var_1_7_Pointer)) , (*(var_1_11_Pointer)))))) ? ((*(var_1_12_Pointer)) == ((signed char) (*(var_1_8_Pointer)))) : ((*(var_1_12_Pointer)) == ((signed char) 8))) : ((*(var_1_12_Pointer)) == ((signed char) (*(var_1_8_Pointer))))) : 1)
;
}
int main(void) {
	isInitial = 1;
