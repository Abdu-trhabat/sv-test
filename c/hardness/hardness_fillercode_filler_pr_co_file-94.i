...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch94Filler_PR_CO.c", 13, "reach_error"); }
    ...
    var_1_13
     ...
     var_1_15
                   ...
                   if (var_1_29) {
                    ...
                    if ( ((var_1_18) >= ( (( (~ (var_1_9))) ^ ( ((((var_1_20) < 0 ) ? -(var_1_20) : (var_1_20)))))))) {
