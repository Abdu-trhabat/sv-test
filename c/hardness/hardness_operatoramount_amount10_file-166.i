...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch166Amount10.c", 13, "reach_error"); }
...
int property(void) {
 return ((var_1_2 <= var_1_3) ? (var_1_1 == ((signed long int) (var_1_2 + (5 - var_1_4)))) : (var_1_1 == ((signed long int) var_1_4))) && (((var_1_3 | var_1_1) == var_1_2) ? (var_1_5 == ((unsigned short int) var_1_6)) : 1)
;
}
int main(void) {
 isInitial = 1;
