...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch101stepLocals.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch101stepLocals
	if (var_1_2) {
		var_1_1 = (((1000000000 - 64) + var_1_3) - var_1_4);
	}


	// From: Req2Batch101stepLocals
	...
	// From: Req4Batch101stepLocals
	if (((max (var_1_4 , var_1_13)) <= var_1_14) || var_1_6) {
		var_1_15 = var_1_13;
	}


	// From: Req5Batch101stepLocals
	unsigned short int stepLocal_2 = var_1_5;
	if (stepLocal_2 < 0) {
		if (var_1_2) {
			var_1_16 = var_1_17;
		}
