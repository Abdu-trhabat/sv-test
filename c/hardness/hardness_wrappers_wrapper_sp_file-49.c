...
void step(void) {
	...
	if (! (*(WrapperStruct00_var_1_13_Pointer))) {
		if ((*(WrapperStruct00_var_1_4_Pointer)) >= (min ((*(WrapperStruct00_var_1_6_Pointer)) , (*(WrapperStruct00_var_1_1_Pointer))))) {
...
int property(void) {
	return (((((*(WrapperStruct00_var_1_2_Pointer)) >= 64.5f) ? (((*(WrapperStruct00_var_1_2_Pointer)) >= (*(WrapperStruct00_var_1_3_Pointer))) ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned short int) (abs (max ((*(WrapperStruct00_var_1_4_Pointer)) , (max ((*(WrapperStruct00_var_1_5_Pointer)) , (*(WrapperStruct00_var_1_6_Pointer))))))))) : (last_1_WrapperStruct00_var_1_14 ? ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_5_Pointer)))) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned short int) (*(WrapperStruct00_var_1_6_Pointer)))))) : ((*(WrapperStruct00_var_1_1_Pointer)) == ((unsigned short int) 50))) && ((*(WrapperStruct00_var_1_8_Pointer)) == ((signed short int) (abs ((*(WrapperStruct00_var_1_9_Pointer))))))) && (((- 16) <= (*(WrapperStruct00_var_1_9_Pointer))) ? ((*(WrapperStruct00_var_1_10_Pointer)) == ((unsigned char) (! (! (! (*(WrapperStruct00_var_1_12_Pointer))))))) : ((*(WrapperStruct00_var_1_10_Pointer)) == ((unsigned char) ((*(WrapperStruct00_var_1_12_Pointer)) && (*(WrapperStruct00_var_1_13_Pointer))))))) && ((! (*(WrapperStruct00_var_1_13_Pointer))) ? (((*(WrapperStruct00_var_1_4_Pointer)) >= (min ((*(WrapperStruct00_var_1_6_Pointer)) , (*(WrapperStruct00_var_1_1_Pointer))))) ? ((*(WrapperStruct00_var_1_14_Pointer)) == ((unsigned char) ((*(WrapperStruct00_var_1_10_Pointer)) && (*(WrapperStruct00_var_1_13_Pointer))))) : ((*(WrapperStruct00_var_1_14_Pointer)) == ((unsigned char) (*(WrapperStruct00_var_1_13_Pointer))))) : 1)
;
}
int main(void) {
	isInitial = 1;
