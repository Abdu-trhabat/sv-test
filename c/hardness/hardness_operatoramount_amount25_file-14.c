...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch14Amount25.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch14Amount25
	var_1_11 = (min (var_1_8 , var_1_7));


	// From: Req6Batch14Amount25
	var_1_18 = 256;


	// From: Req2Batch14Amount25
	if (var_1_9) {
		var_1_5 = var_1_6;
	} else {
