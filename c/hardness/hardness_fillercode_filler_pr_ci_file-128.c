...
void step(void) {
	...
	// From: CodeObject4
	/* 276L, 79L) */ if (/* 277L, 56L, 57L) */ ((/* 278L, 54L, 58L) */ ((var_1_15) * (/* 280L, 53L, 60L) */ (abs (var_1_17))))) <= (var_1_17))) {
		/* 283L, 72L) */ var_1_36 = (
			var_1_27
		);
	} else {
	...
	// From: CodeObject5
	/* 293L, 106L) */ if (/* 294L, 88L, 89L) */ ((var_1_21) < (/* 296L, 87L, 91L) */ ((/* 297L, 85L, 92L) */ (abs (var_1_6))) | (var_1_3))))) {
		/* 300L, 105L) */ var_1_41 = (
			/* 303L, 104L) */ (abs (
				var_1_21
			))
	...
	// From: CodeObject7
	/* 336L, 210L) */ if (/* 337L, 150L, 151L) */ ((var_1_28) >= (var_1_23))) {
		/* 340L, 204L) */ if (/* 341L, 161L, 162L) */ ((/* 342L, 159L, 163L) */ ((var_1_23) >> (16))) < (var_1_23))) {
			/* 346L, 198L) */ if (/* 347L, 177L, 178L) */ (! (/* 348L, 176L, 179L) */ ((/* 349L, 174L, 180L) */ ((var_1_23) | (var_1_6))) >= (var_1_21))))) {
				/* 353L, 193L) */ var_1_48 = (
					var_1_6
				);
			} else {
...
int property(void) {
	if (var_1_2) {
		if (/* 384L, 10L, 17L, 521L, 549L, 1273L) */ ((/* 385L, 8L, 18L, 522L, 550L, 1274L) */ ((/* 386L, 6L, 19L, 523L, 551L, 1275L) */ (~ (var_1_21))) >= (var_1_21))) && (var_1_5))) {
			if (var_1_5) {
			} else {
			}
		} else {
	...
	if (/* 410L, 87L, 92L, 719L, 743L, 1299L) */ ((/* 411L, 85L, 93L, 720L, 744L, 1300L) */ (! (0))) || (var_1_2))) {
		if (var_1_2) {
			if (/* 417L, 101L, 105L, 726L, 750L, 1306L) */ ((var_1_3) > (var_1_4))) {
			} else {
			}
		} else {
		}
	}
	if (/* 434L, 298L, 304L, 847L, 887L, 1323L) */ ((var_1_5) || (/* 436L, 297L, 306L, 849L, 889L, 1325L) */ ((var_1_2) || (var_1_11))))) {
		if (var_1_11) {
		} else {
		}
	} else {
		if (/* 460L, 334L, 338L, 873L, 913L, 1349L) */ ((var_1_1) != (var_1_6))) {
		} else {
		}
	}
	if (/* 474L, 362L, 368L, 949L, 960L, 1363L) */ ((/* 475L, 360L, 369L, 950L, 961L, 1364L) */ ((var_1_8) + (200))) > (var_1_1))) {
	}
	if (/* 485L, 388L, 392L, 997L, 1010L, 1374L) */ ((var_1_13) == (0.8))) {
	}
	if (/* 499L, 420L, 430L, 1068L, 1090L, 1388L) */ ((/* 500L, 416L, 431L, 1069L, 1091L, 1389L) */ ((var_1_26) - (/* 502L, 415L, 433L, 1071L, 1093L, 1391L) */ ((var_1_27) + (var_1_28))))) == (/* 505L, 419L, 436L, 1074L, 1096L, 1394L) */ ((var_1_23) << (var_1_21))))) {
		if (var_1_11) {
		} else {
		}
	}
	...
	/* 522L) */ ((
		/* 521L) */ ((
			/* 520L) */ ((
				/* 519L) */ ((
					/* 381L, 79L, 518L, 546L, 1270L) */ ((
						var_1_2
					) ? (
						/* 383L, 73L, 520L, 548L, 1272L) */ ((
							/* 384L, 10L, 17L, 521L, 549L, 1273L) */ ((
								/* 385L, 8L, 18L, 522L, 550L, 1274L) */ ((
									/* 386L, 6L, 19L, 523L, 551L, 1275L) */ (~ (
										var_1_21
									))
								) >= (
									var_1_21
							...
							/* 390L, 67L, 527L, 555L, 1279L) */ ((
								var_1_5
							) ? (
								/* 392L, 29L, 529L, 557L, 1281L) */ ((
									var_1_1
								) == (
									/* 392L, 29L, 529L, 557L, 1281L) */ ((unsigned long int) (
										var_1_6
									))
								))
							) : (
								/* 396L, 65L, 533L, 561L, 1285L) */ ((
									var_1_1
								) == (
									/* 396L, 65L, 533L, 561L, 1285L) */ ((unsigned long int) (
										1u
									))
								))
							))
						) : (
							/* 400L, 71L, 537L, 565L, 1289L) */ ((
								var_1_1
							) == (
								/* 400L, 71L, 537L, 565L, 1289L) */ ((unsigned long int) (
									var_1_6
								))
							))
						))
					) : (
						/* 404L, 77L, 541L, 569L, 1293L) */ ((
							var_1_1
						) == (
							/* 404L, 77L, 541L, 569L, 1293L) */ ((unsigned long int) (
								var_1_6
							))
						))
					))
				) && (
					/* 409L, 289L, 718L, 742L, 1298L) */ ((
						/* 410L, 87L, 92L, 719L, 743L, 1299L) */ ((
							/* 411L, 85L, 93L, 720L, 744L, 1300L) */ (! (
								0
							))
						) || (
							var_1_2
						...
						/* 414L, 287L, 723L, 747L, 1303L) */ ((
							var_1_2
						) ? (
							/* 416L, 281L, 725L, 749L, 1305L) */ ((
								/* 417L, 101L, 105L, 726L, 750L, 1306L) */ ((
									var_1_3
								) > (
									var_1_4
								))
							) ? (
								/* 420L, 111L, 729L, 753L, 1309L) */ ((
									var_1_7
								) == (
									/* 420L, 111L, 729L, 753L, 1309L) */ ((signed long int) (
										var_1_8
									))
								))
							) : (
								/* 424L, 279L, 733L, 757L, 1313L) */ ((
									var_1_7
								) == (
									/* 424L, 279L, 733L, 757L, 1313L) */ ((signed long int) (
										var_1_9
									))
								))
							))
						) : (
							/* 428L, 285L, 737L, 761L, 1317L) */ ((
								var_1_7
							) == (
								/* 428L, 285L, 737L, 761L, 1317L) */ ((signed long int) (
									var_1_9
								))
							))
						))
				...
				/* 433L, 353L, 846L, 886L, 1322L) */ ((
					/* 434L, 298L, 304L, 847L, 887L, 1323L) */ ((
						var_1_5
					) || (
						/* 436L, 297L, 306L, 849L, 889L, 1325L) */ ((
							var_1_2
						) || (
							var_1_11
						))
					...
					/* 439L, 331L, 852L, 892L, 1328L) */ ((
						var_1_11
					) ? (
						/* 441L, 321L, 854L, 894L, 1330L) */ ((
							var_1_10
						) == (
							/* 441L, 321L, 854L, 894L, 1330L) */ ((double) (
								/* 444L, 320L, 857L, 897L, 1333L) */ (min (
									/* 444L, 320L, 857L, 897L, 1333L) */ (
										var_1_12
									) , (
										/* 446L, 319L, 859L, 899L, 1335L) */ (min (
											/* 446L, 319L, 859L, 899L, 1335L) */ (
												/* 447L, 317L, 860L, 900L, 1336L) */ (min (
													/* 447L, 317L, 860L, 900L, 1336L) */ (
														var_1_13
													) , (
														var_1_14
													)
						...
						/* 451L, 329L, 864L, 904L, 1340L) */ ((
							var_1_10
						) == (
							/* 451L, 329L, 864L, 904L, 1340L) */ ((double) (
								/* 454L, 328L, 867L, 907L, 1343L) */ ((
									var_1_16
								) - (
									/* 456L, 327L, 869L, 909L, 1345L) */ (max (
										/* 456L, 327L, 869L, 909L, 1345L) */ (
											var_1_17
										) , (
											var_1_18
										)
					...
					/* 459L, 351L, 872L, 912L, 1348L) */ ((
						/* 460L, 334L, 338L, 873L, 913L, 1349L) */ ((
							var_1_1
						) != (
							var_1_6
						))
					) ? (
						/* 463L, 345L, 876L, 916L, 1352L) */ ((
							var_1_10
						) == (
							/* 463L, 345L, 876L, 916L, 1352L) */ ((double) (
								/* 466L, 344L, 879L, 919L, 1355L) */ (abs (
									15.5
								))
							))
						))
					) : (
						/* 468L, 349L, 881L, 921L, 1357L) */ ((
							var_1_10
						) == (
							/* 468L, 349L, 881L, 921L, 1357L) */ ((double) (
								var_1_15
							))
						))
					))
			...
			/* 473L, 378L, 948L, 959L, 1362L) */ ((
				/* 474L, 362L, 368L, 949L, 960L, 1363L) */ ((
					/* 475L, 360L, 369L, 950L, 961L, 1364L) */ ((
						var_1_8
					) + (
						200
					))
				...
				/* 479L, 376L, 954L, 965L, 1368L) */ ((
					var_1_19
				) == (
					/* 479L, 376L, 954L, 965L, 1368L) */ ((signed char) (
						var_1_20
					))
				))
			) : (
		...
		/* 484L, 404L, 996L, 1009L, 1373L) */ ((
			/* 485L, 388L, 392L, 997L, 1010L, 1374L) */ ((
				var_1_13
			) == (
				0.8
			))
		) ? (
			/* 488L, 402L, 1000L, 1013L, 1377L) */ ((
				var_1_21
			) == (
				/* 488L, 402L, 1000L, 1013L, 1377L) */ ((unsigned long int) (
					/* 491L, 401L, 1003L, 1016L, 1380L) */ ((
						var_1_22
					) - (
						/* 493L, 400L, 1005L, 1018L, 1382L) */ ((
							1281391062u
						) - (
							var_1_23
						))
	...
	/* 498L, 457L, 1067L, 1089L, 1387L) */ ((
		/* 499L, 420L, 430L, 1068L, 1090L, 1388L) */ ((
			/* 500L, 416L, 431L, 1069L, 1091L, 1389L) */ ((
				var_1_26
			) - (
				/* 502L, 415L, 433L, 1071L, 1093L, 1391L) */ ((
					var_1_27
				) + (
					var_1_28
				))
			...
			/* 505L, 419L, 436L, 1074L, 1096L, 1394L) */ ((
				var_1_23
			) << (
				var_1_21
			))
		...
		/* 508L, 455L, 1077L, 1099L, 1397L) */ ((
			var_1_11
		) ? (
			/* 510L, 445L, 1079L, 1101L, 1399L) */ ((
				var_1_24
			) == (
				/* 510L, 445L, 1079L, 1101L, 1399L) */ ((signed short int) (
					var_1_20
				))
			))
		) : (
			/* 514L, 453L, 1083L, 1105L, 1403L) */ ((
				var_1_24
			) == (
				/* 514L, 453L, 1083L, 1105L, 1403L) */ ((signed short int) (
					var_1_27
				))
			))
		))
