...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch154dependencies.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req2Batch154dependencies
	if (var_1_4 == var_1_5) {
		var_1_10 = (max ((var_1_11 + var_1_12) , var_1_13));
	}


	// From: Req3Batch154dependencies
	if (var_1_11 > var_1_4) {
		if (var_1_8 > var_1_4) {
			var_1_14 = var_1_8;
		}
	...
	// From: Req6Batch154dependencies
	if (var_1_2 || var_1_25) {
		if (var_1_2 && (var_1_15 <= var_1_8)) {
			if (var_1_7 == ((max (var_1_5 , var_1_9)) * var_1_4)) {
