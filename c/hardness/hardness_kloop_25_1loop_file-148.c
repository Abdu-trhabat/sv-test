...
void step(void) {
	// From: Req1Batch14825_1loop
	var_1_1 = (var_1_2 - var_1_3);


	// From: Req2Batch14825_1loop
	if (var_1_5 && var_1_6) {
		var_1_4 = (! var_1_7);
	} else {
	...
	// From: Req4Batch14825_1loop
	signed long int stepLocal_0 = var_1_11;
	if (var_1_3 <= var_1_1) {
		if ((abs (-8)) <= stepLocal_0) {
			var_1_10 = (max (var_1_2 , 8.75f));
		} else {
...
int property(void) {
	return (((var_1_1 == ((float) (var_1_2 - var_1_3))) && ((var_1_5 && var_1_6) ? (var_1_4 == ((unsigned char) (! var_1_7))) : (var_1_4 == ((unsigned char) (! ((var_1_1 > var_1_3) || var_1_7)))))) && ((var_1_3 >= (var_1_10 + var_1_2)) ? (var_1_8 == ((unsigned char) var_1_9)) : 1)) && ((var_1_3 <= var_1_1) ? (((abs (-8)) <= var_1_11) ? (var_1_10 == ((float) (max (var_1_2 , 8.75f)))) : (var_1_10 == ((float) (var_1_12 + (var_1_13 - var_1_14))))) : (var_1_10 == ((float) var_1_13)))
;
}
int main(void) {
	isInitial = 1;
