...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch104Amount25.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch104Amount25
	unsigned short int stepLocal_1 = var_1_3;
	signed long int stepLocal_0 = min (var_1_3 , var_1_4);
	...
	// From: Req2Batch104Amount25
	unsigned char stepLocal_2 = var_1_12;
	if (var_1_6 > ((max (var_1_7 , var_1_8)) + var_1_9)) {
	...
	// From: Req3Batch104Amount25
	if (var_1_12) {
		if (var_1_7 > (abs (1.000000000025E10))) {
			var_1_15 = (min (16 , var_1_16));
		}
	} else {
		var_1_15 = var_1_16;
	}
...
int property(void) {
	return (((var_1_2 > var_1_3) ? ((var_1_2 < (min (var_1_3 , var_1_4))) ? (var_1_1 == ((signed long int) var_1_4)) : 1) : (var_1_1 == ((signed long int) var_1_2))) && ((var_1_6 > ((max (var_1_7 , var_1_8)) + var_1_9)) ? (((var_1_10 && var_1_11) && var_1_12) ? (var_1_5 == ((float) (var_1_13 + var_1_14))) : (var_1_5 == ((float) 7.5f))) : (var_1_5 == ((float) var_1_14)))) && (var_1_12 ? ((var_1_7 > (abs (1.000000000025E10))) ? (var_1_15 == ((unsigned short int) (min (16 , var_1_16)))) : 1) : (var_1_15 == ((unsigned short int) var_1_16)))
;
}
int main(void) {
	isInitial = 1;
