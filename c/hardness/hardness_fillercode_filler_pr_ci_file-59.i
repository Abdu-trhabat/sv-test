...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch59Filler_PR_CI.c", 13, "reach_error"); }
...
void step(void) {
  ...
  var_1_4
                   ...
                   if ( (( ((var_1_7) / (var_1_26))) < ( ((var_1_6) | (var_1_19))))) {
                    if ( (( (- (var_1_11))) >= (256.75f))) {
                     var_1_25 = (
    var_1_27
   );
  ...
  var_1_16
                  ...
                  if ( (( ((((var_1_11) < 0 ) ? -(var_1_11) : (var_1_11)))) > ( (((((128.5f)) < (( ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))))) ? ((128.5f)) : (( ((((var_1_12) < 0 ) ? -(var_1_12) : (var_1_12)))))))))) {
                   var_1_24 = (
                    ((((( var_1_19 )) > (( var_1_6 ))) ? (( var_1_19 )) : (( var_1_6 ))))
  );
 }
                   if ( ((var_1_26) < ( ((((var_1_6) < 0 ) ? -(var_1_6) : (var_1_6)))))) {
                    if ( (( (((((var_1_12)) > ((var_1_8))) ? ((var_1_12)) : ((var_1_8))))) == ( ((((var_1_10) < 0 ) ? -(var_1_10) : (var_1_10)))))) {
                     if ( ((-50) <= (var_1_6))) {
                      var_1_31 = (
                       ((
      var_1_33
 ...
 unsigned short int stepLocal_2 = var_1_1;
    ...
    var_1_6
     ...
     last_1_var_1_5
                               ...
                               if ( (! (var_1_15))) {
                                var_1_5 = (
                                 ((((( last_1_var_1_5 )) > (( (( var_1_7 ) + ( var_1_4 )) ))) ? (( last_1_var_1_5 )) : (( (( var_1_7 ) + ( var_1_4 )) ))))
   );
  }
 }
                   if ( (( ((var_1_7) ^ ( (~ (var_1_19))))) >= (var_1_19))) {
                    var_1_28 = (
                     ((
                      ((
     var_1_12
 ...
 unsigned char stepLocal_3 = ((var_1_5) < (var_1_6));
                               if (var_1_18) {
                                if ( (( (! (var_1_15))) || (stepLocal_3))) {
                                 var_1_8 = (
                                  ((((( 127.25 )) > (( var_1_10 ))) ? (( 127.25 )) : (( var_1_10 ))))
   );
  } else {
                                 var_1_8 = (
                                  ((
...
int property(void) {
 if ( (( ((var_1_17) != ( ((16) / (var_1_4))))) && (var_1_15))) {
  if ( ((var_1_17) > (var_1_4))) {
  } else {
   if (var_1_15) {
   } else {
 ...
 if ( ((var_1_1) < (last_1_var_1_5))) {
 } else {
  if ( (! (var_1_15))) {
  }
 }
 if (var_1_18) {
  if ( (( (! (var_1_15))) || ( ((var_1_5) < (var_1_6))))) {
  } else {
  }
 } else {
 }
 if ( ((var_1_5) != ( (( ((var_1_6) / (var_1_4))) * ( (((((var_1_5)) > ((var_1_19))) ? ((var_1_5)) : ((var_1_19))))))))) {
  if ( ((var_1_5) <= (var_1_6))) {
  } else {
  }
 } else {
 ...
 return ((
       ...
       var_1_5
         ...
         var_1_4
                                                   ...
                                                   ((((( var_1_5 )) > (( var_1_19 ))) ? (( var_1_5 )) : (( var_1_19 ))))
       ))
      ))
     ) ? (
                                           ((
