...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch15550_while.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req3Batch15550_while
	if ((abs (var_1_7)) == var_1_9) {
		var_1_11 = var_1_12;
	}


	// From: Req5Batch15550_while
	var_1_16 = (var_1_17 + var_1_18);


	// From: Req8Batch15550_while
	if (var_1_12) {
		var_1_25 = (((abs (var_1_26)) - 25) - var_1_21);
	}


	// From: Req9Batch15550_while
	if ((~ (abs (var_1_21))) > var_1_10) {
		var_1_27 = 10;
	}


	// From: Req1Batch15550_while
	if (var_1_11) {
		var_1_1 = var_1_3;
	} else {
...
int property(void) {
	return ((((((((var_1_11 ? (var_1_1 == ((float) var_1_3)) : (var_1_1 == ((float) (max (var_1_3 , ((var_1_4 + var_1_5) + var_1_6)))))) && (((min (var_1_5 , (- 50.6))) <= ((max (var_1_4 , var_1_3)) / var_1_8)) ? (var_1_7 == ((signed long int) var_1_9)) : (var_1_7 == ((signed long int) var_1_10)))) && (((abs (var_1_7)) == var_1_9) ? (var_1_11 == ((unsigned char) var_1_12)) : 1)) && (((32.3 * var_1_1) > var_1_8) ? (var_1_13 == ((unsigned short int) (abs (var_1_14 - var_1_15)))) : 1)) && (var_1_16 == ((signed char) (var_1_17 + var_1_18)))) && ((((var_1_27 ^ var_1_7) / var_1_21) >= var_1_17) ? (var_1_19 == ((unsigned char) (var_1_22 + var_1_23))) : 1)) && ((var_1_13 > (var_1_10 * var_1_15)) ? (var_1_24 == ((unsigned short int) (var_1_14 - var_1_13))) : (var_1_24 == ((unsigned short int) (var_1_14 - (max (var_1_22 , var_1_21))))))) && (var_1_12 ? (var_1_25 == ((signed short int) (((abs (var_1_26)) - 25) - var_1_21))) : 1)) && (((~ (abs (var_1_21))) > var_1_10) ? (var_1_27 == ((unsigned short int) 10)) : 1)
;
}
int main(void) {
	isInitial = 1;
