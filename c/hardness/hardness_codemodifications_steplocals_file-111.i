...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch111stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 if (((((var_1_2) > (var_1_6)) ? (var_1_2) : (var_1_6))) == var_1_5) {
  var_1_7 = (! (! 1));
 }
 ...
 if (((var_1_2 * var_1_8) + var_1_4) < (var_1_6 + ((((var_1_5) < (var_1_10)) ? (var_1_5) : (var_1_10))))) {
  var_1_11 = var_1_12;
 } else {
  var_1_11 = 32;
 }
 unsigned char stepLocal_3 = var_1_9;
 if ((-128 >= ((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11)))) && stepLocal_3) {
  var_1_13 = var_1_12;
 }
 var_1_14 = var_1_10;
 var_1_15 = var_1_16;
 if (var_1_8 != (var_1_18 - ((((var_1_19) > (var_1_20)) ? (var_1_19) : (var_1_20))))) {
  if (var_1_20 == var_1_4) {
   var_1_17 = var_1_12;
  }
 }
...
int property(void) {
 return ((((((((((((-16 < var_1_2) ? ((var_1_2 == (100 - var_1_3)) ? (var_1_1 == ((unsigned long int) ((((((var_1_4) < (1415909508u)) ? (var_1_4) : (1415909508u))) - (var_1_5 - var_1_6)) + var_1_3))) : 1) : (var_1_1 == ((unsigned long int) (2872698422u - 2u)))) && ((((((var_1_2) > (var_1_6)) ? (var_1_2) : (var_1_6))) == var_1_5) ? (var_1_7 == ((unsigned char) (! (! 1)))) : 1)) && ((var_1_7 && var_1_9) ? (var_1_8 == ((unsigned char) var_1_10)) : 1)) && ((((var_1_2 * var_1_8) + var_1_4) < (var_1_6 + ((((var_1_5) < (var_1_10)) ? (var_1_5) : (var_1_10))))) ? (var_1_11 == ((signed char) var_1_12)) : (var_1_11 == ((signed char) 32)))) && (((-128 >= ((((var_1_10) < (var_1_11)) ? (var_1_10) : (var_1_11)))) && var_1_9) ? (var_1_13 == ((signed char) var_1_12)) : 1)) && (var_1_14 == ((unsigned char) var_1_10))) && (var_1_15 == ((double) var_1_16))) && ((var_1_8 != (var_1_18 - ((((var_1_19) > (var_1_20)) ? (var_1_19) : (var_1_20))))) ? ((var_1_20 == var_1_4) ? (var_1_17 == ((signed char) var_1_12)) : 1) : 1)) && ((var_1_15 == var_1_16) ? (var_1_21 == ((unsigned char) (var_1_19 + var_1_20))) : 1)) && (var_1_22 == ((float) var_1_16))) && (var_1_23 == ((unsigned char) var_1_19))) && (var_1_24 == ((signed long int) -8))
;
}
int main(void) {
 isInitial = 1;
