...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch154stepLocals.c", 13, "reach_error"); }
...
void step(void) {
 ...
 unsigned long int stepLocal_2 = ((((var_1_5) > (var_1_9)) ? (var_1_5) : (var_1_9))) * var_1_4;
 unsigned char stepLocal_1 = var_1_14 <= var_1_8;
