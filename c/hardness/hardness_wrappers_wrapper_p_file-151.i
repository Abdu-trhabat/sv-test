...
void step(void) {
 ...
 if (25 <= ((100000000 + (*(var_1_9_Pointer))) - (*(var_1_10_Pointer)))) {
  if (1 >= (*(var_1_9_Pointer))) {
   if ((((((*(var_1_11_Pointer)) - 8) < 0 ) ? -((*(var_1_11_Pointer)) - 8) : ((*(var_1_11_Pointer)) - 8))) == (*(var_1_10_Pointer))) {
 ...
 if (! (*(var_1_13_Pointer))) {
  (*(var_1_14_Pointer)) = (((((((*(var_1_15_Pointer)) + (*(var_1_16_Pointer)))) > ((*(var_1_17_Pointer)))) ? (((*(var_1_15_Pointer)) + (*(var_1_16_Pointer)))) : ((*(var_1_17_Pointer))))) + (((((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))) < 0 ) ? -((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))) : ((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))))));
 } else {
  if ((*(var_1_13_Pointer))) {
...
int property(void) {
 return ((((*(var_1_1_Pointer)) == ((double) (((*(var_1_2_Pointer)) - (*(var_1_3_Pointer))) - (*(var_1_4_Pointer))))) && ((*(var_1_5_Pointer)) == ((float) (((*(var_1_3_Pointer)) - (*(var_1_6_Pointer))) + (*(var_1_7_Pointer)))))) && ((25 <= ((100000000 + (*(var_1_9_Pointer))) - (*(var_1_10_Pointer)))) ? ((1 >= (*(var_1_9_Pointer))) ? (((((((*(var_1_11_Pointer)) - 8) < 0 ) ? -((*(var_1_11_Pointer)) - 8) : ((*(var_1_11_Pointer)) - 8))) == (*(var_1_10_Pointer))) ? ((*(var_1_8_Pointer)) == ((unsigned char) ((*(var_1_12_Pointer)) && (! 0)))) : ((*(var_1_8_Pointer)) == ((unsigned char) ((*(var_1_12_Pointer)) && (*(var_1_13_Pointer)))))) : 1) : 1)) && ((! (*(var_1_13_Pointer))) ? ((*(var_1_14_Pointer)) == ((unsigned char) (((((((*(var_1_15_Pointer)) + (*(var_1_16_Pointer)))) > ((*(var_1_17_Pointer)))) ? (((*(var_1_15_Pointer)) + (*(var_1_16_Pointer)))) : ((*(var_1_17_Pointer))))) + (((((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))) < 0 ) ? -((*(var_1_18_Pointer)) + (*(var_1_19_Pointer))) : ((*(var_1_18_Pointer)) + (*(var_1_19_Pointer)))))))) : ((*(var_1_13_Pointer)) ? ((*(var_1_14_Pointer)) == ((unsigned char) (*(var_1_19_Pointer)))) : 1))
;
}
int main(void) {
 isInitial = 1;
