...
void step(void) {
 ...
 if (((var_1_8 - var_1_9) / var_1_10) < var_1_11) {
  if (((((var_1_3) < (var_1_12)) ? (var_1_3) : (var_1_12))) < var_1_13) {
   if (var_1_4) {
    var_1_7 = ((((var_1_14) < (1)) ? (var_1_14) : (1)));
   }
  }
 }
 signed long int stepLocal_1 = (var_1_14 - var_1_7) * (var_1_16 >> var_1_17);
 if (-128 == stepLocal_1) {
  if (var_1_9 > (var_1_8 - var_1_18)) {
   if (var_1_18 < 4.8f) {
    var_1_15 = var_1_17;
   } else {
    var_1_15 = -32;
...
int property(void) {
 return ((var_1_2 ? ((64 < var_1_3) ? (var_1_1 == ((unsigned char) (! (var_1_4 && var_1_5)))) : 1) : (var_1_5 ? (var_1_1 == ((unsigned char) var_1_6)) : (var_1_1 == ((unsigned char) var_1_4)))) && ((((var_1_8 - var_1_9) / var_1_10) < var_1_11) ? ((((((var_1_3) < (var_1_12)) ? (var_1_3) : (var_1_12))) < var_1_13) ? (var_1_4 ? (var_1_7 == ((unsigned short int) ((((var_1_14) < (1)) ? (var_1_14) : (1))))) : 1) : 1) : 1)) && ((-128 == ((var_1_14 - var_1_7) * (var_1_16 >> var_1_17))) ? ((var_1_9 > (var_1_8 - var_1_18)) ? ((var_1_18 < 4.8f) ? (var_1_15 == ((signed short int) var_1_17)) : (var_1_15 == ((signed short int) -32))) : (var_1_15 == ((signed short int) var_1_17))) : (var_1_15 == ((signed short int) var_1_17)))
;
}
int main(void) {
 isInitial = 1;
