...
void step(void) {
	// From: Req1Batch118Amount10
	unsigned long int stepLocal_2 = var_1_2;
	unsigned long int stepLocal_1 = min (var_1_3 , var_1_2);
...
int property(void) {
	return (var_1_2 > (var_1_3 / var_1_4)) ? ((var_1_5 < (min (var_1_3 , var_1_2))) ? ((var_1_3 >= (var_1_4 + 8u)) ? (var_1_1 == ((float) var_1_6)) : (var_1_1 == ((float) 2.6f))) : 1) : 1
;
}
int main(void) {
	isInitial = 1;
