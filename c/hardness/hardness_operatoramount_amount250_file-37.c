...
void step(void) {
	...
	if (((var_1_10 - var_1_11) >= (last_1_var_1_27 / var_1_13)) || stepLocal_2) {
		var_1_9 = ((var_1_14 - (max (var_1_5 , var_1_4))) - var_1_7);
	} else {
		var_1_9 = var_1_4;
	}
	...
	if (stepLocal_12 || (last_1_var_1_19 || var_1_25)) {
		var_1_41 = ((abs (var_1_4)) - last_1_var_1_55);
	} else {
	...
	if ((min (var_1_41 , var_1_44)) >= var_1_22) {
	...
	if (((var_1_4 >> 1) | last_1_var_1_55) > stepLocal_4) {
		var_1_23 = (((max (last_1_var_1_55 , var_1_4)) >= var_1_3) && var_1_24);
	} else {
	...
	if (stepLocal_3 || (var_1_11 <= var_1_10)) {
		...
		var_1_21 = (min ((var_1_4 + (var_1_22 - var_1_7)) , var_1_14));
	}


	// From: Req19Batch37Amount250
	if (last_1_var_1_54 >= last_1_var_1_34) {
		var_1_55 = ((max ((var_1_56 - var_1_45) , (3470546746u - last_1_var_1_54))) - (var_1_22 - 64u));
	}


	// From: Req9Batch37Amount250
	signed long int stepLocal_7 = var_1_14;
	if ((abs (last_1_var_1_55)) <= stepLocal_7) {
		var_1_34 = var_1_3;
	} else {
		if (last_1_var_1_19) {
	...
	if (10.6f < var_1_47) {
		...
		if (((min (16.375 , var_1_11)) - (var_1_51 - 1.000000075E7)) > var_1_32) {
			var_1_50 = (var_1_38 + var_1_30);
		} else {
			var_1_50 = (max (((max (var_1_30 , var_1_32)) - var_1_29) , var_1_38));
		}
	}


	// From: Req17Batch37Amount250
	var_1_52 = (var_1_44 + (max ((min (var_1_4 , var_1_45)) , (var_1_53 - var_1_5))));
	...
	if (last_1_var_1_39 != stepLocal_10) {
		var_1_39 = (max (((var_1_40 - 10) + var_1_9) , (var_1_4 + var_1_5)));
	} else {
	...
	signed long int stepLocal_0 = max (var_1_5 , (max (var_1_41 , var_1_7)));
	if (var_1_19) {
	...
	if (var_1_24) {
		if (var_1_21 != stepLocal_16) {
			var_1_54 = ((min ((1129850979u - var_1_53) , var_1_40)) + (max (var_1_4 , (min (var_1_22 , 16u)))));
		} else {
			var_1_54 = (max (var_1_4 , (max (8u , var_1_34))));
		}
	} else {
		var_1_54 = (var_1_40 + (max (var_1_21 , 8u)));
	}


	// From: Req3Batch37Amount250
	if ((last_1_var_1_15 >= (abs (var_1_4))) && var_1_60) {
		if ((- (var_1_55 % var_1_4)) >= var_1_1) {
			if (var_1_60 || (var_1_4 >= var_1_5)) {
				if ((var_1_39 / (abs (var_1_4))) == (abs (var_1_5))) {
	...
	if (stepLocal_6 >= var_1_14) {
		var_1_27 = (((var_1_29 - var_1_30) + (abs (var_1_31))) - var_1_32);
	}
	...
	if (((9.999999999999998E14 + var_1_13) / var_1_29) >= var_1_27) {
		var_1_43 = (min ((var_1_4 + var_1_5) , (var_1_44 + var_1_45)));
	} else {
		if (var_1_24) {
	...
	if (var_1_24 || stepLocal_14) {
		if (var_1_19) {
			...
			var_1_48 = (max (32 , var_1_15));
		}
	} else {
		var_1_48 = (abs (var_1_49 + var_1_41));
	}


	// From: Req20Batch37Amount250
	unsigned short int stepLocal_18 = var_1_48;
	unsigned long int stepLocal_17 = (var_1_53 * var_1_21) + (min (var_1_22 , var_1_55));
...
int property(void) {
	return ((((((((((((((((((((((var_1_19 ? (((var_1_3 - (var_1_4 - var_1_5)) >= (500 * var_1_41)) ? (var_1_1 == ((signed long int) ((min ((min (var_1_4 , var_1_3)) , (var_1_5 - var_1_7))) + var_1_8))) : 1) : (((max (var_1_5 , (max (var_1_41 , var_1_7)))) <= (~ (1 / -8))) ? (var_1_1 == ((signed long int) (var_1_7 - var_1_4))) : (var_1_1 == ((signed long int) var_1_5)))) && ((((var_1_10 - var_1_11) >= (last_1_var_1_27 / var_1_13)) || last_1_var_1_19) ? (var_1_9 == ((signed long int) ((var_1_14 - (max (var_1_5 , var_1_4))) - var_1_7))) : (var_1_9 == ((signed long int) var_1_4)))) && (((last_1_var_1_15 >= (abs (var_1_4))) && var_1_60) ? (((- (var_1_55 % var_1_4)) >= var_1_1) ? ((var_1_60 || (var_1_4 >= var_1_5)) ? (((var_1_39 / (abs (var_1_4))) == (abs (var_1_5))) ? (var_1_15 == ((unsigned long int) (2252793902u - var_1_5))) : 1) : (var_1_15 == ((unsigned long int) var_1_14))) : (var_1_15 == ((unsigned long int) var_1_5))) : 1)) && (last_1_var_1_23 ? (var_1_19 == ((unsigned char) ((! last_1_var_1_23) || var_1_20))) : 1)) && (((var_1_23 || var_1_20) || (var_1_11 <= var_1_10)) ? (var_1_21 == ((unsigned long int) (var_1_7 + var_1_4))) : (var_1_21 == ((unsigned long int) (min ((var_1_4 + (var_1_22 - var_1_7)) , var_1_14)))))) && ((((var_1_4 >> 1) | last_1_var_1_55) > (var_1_8 * (var_1_7 - var_1_5))) ? (var_1_23 == ((unsigned char) (((max (last_1_var_1_55 , var_1_4)) >= var_1_3) && var_1_24))) : (((var_1_8 + last_1_var_1_1) >= last_1_var_1_21) ? (var_1_23 == ((unsigned char) (last_1_var_1_60 || (! var_1_25)))) : (var_1_23 == ((unsigned char) (var_1_20 && var_1_26)))))) && ((var_1_15 >= var_1_14) ? (var_1_27 == ((double) (((var_1_29 - var_1_30) + (abs (var_1_31))) - var_1_32))) : 1)) && (((var_1_9 | var_1_3) > var_1_5) ? (var_1_33 == ((unsigned char) (var_1_4 + var_1_5))) : (((2 - var_1_4) <= var_1_9) ? ((! (! (16.5f <= var_1_31))) ? (var_1_33 == ((unsigned char) var_1_4)) : 1) : (var_1_33 == ((unsigned char) var_1_5))))) && (((abs (last_1_var_1_55)) <= var_1_14) ? (var_1_34 == ((signed long int) var_1_3)) : (last_1_var_1_19 ? (var_1_34 == ((signed long int) ((var_1_5 + var_1_7) - last_1_var_1_62))) : (var_1_34 == ((signed long int) (-64 + (var_1_4 + var_1_35))))))) && (((var_1_23 || (var_1_5 != var_1_52)) && (var_1_41 < var_1_4)) ? (((var_1_20 && (var_1_19 && var_1_25)) && (var_1_27 < var_1_29)) ? (var_1_36 == ((float) (var_1_29 + (var_1_30 + var_1_38)))) : (var_1_36 == ((float) var_1_30))) : 1)) && ((last_1_var_1_39 != var_1_55) ? (var_1_39 == ((unsigned short int) (max (((var_1_40 - 10) + var_1_9) , (var_1_4 + var_1_5))))) : (var_1_39 == ((unsigned short int) (var_1_40 + var_1_9))))) && ((last_1_var_1_60 || (last_1_var_1_19 || var_1_25)) ? (var_1_41 == ((signed long int) ((abs (var_1_4)) - last_1_var_1_55))) : (((last_1_var_1_1 < (var_1_5 << last_1_var_1_34)) && (last_1_var_1_23 || var_1_25)) ? (var_1_41 == ((signed long int) (var_1_40 - last_1_var_1_55))) : 1))) && ((((9.999999999999998E14 + var_1_13) / var_1_29) >= var_1_27) ? (var_1_43 == ((unsigned char) (min ((var_1_4 + var_1_5) , (var_1_44 + var_1_45))))) : (var_1_24 ? ((var_1_15 <= (var_1_5 * (var_1_22 >> var_1_46))) ? (var_1_43 == ((unsigned char) ((var_1_4 - var_1_5) + var_1_45))) : (var_1_43 == ((unsigned char) var_1_5))) : 1))) && (var_1_47 == ((float) (var_1_30 + (9.8f - 32.5f))))) && ((var_1_24 || (var_1_60 || var_1_19)) ? (var_1_19 ? (var_1_48 == ((unsigned short int) (var_1_40 + (var_1_49 - var_1_4)))) : (var_1_48 == ((unsigned short int) (max (32 , var_1_15))))) : (var_1_48 == ((unsigned short int) (abs (var_1_49 + var_1_41)))))) && ((10.6f < var_1_47) ? ((var_1_60 && (var_1_30 <= (- var_1_11))) ? (var_1_50 == ((float) var_1_29)) : 1) : ((((min (16.375 , var_1_11)) - (var_1_51 - 1.000000075E7)) > var_1_32) ? (var_1_50 == ((float) (var_1_38 + var_1_30))) : (var_1_50 == ((float) (max (((max (var_1_30 , var_1_32)) - var_1_29) , var_1_38))))))) && (var_1_52 == ((unsigned char) (var_1_44 + (max ((min (var_1_4 , var_1_45)) , (var_1_53 - var_1_5))))))) && (var_1_24 ? ((var_1_21 != var_1_22) ? (var_1_54 == ((unsigned long int) ((min ((1129850979u - var_1_53) , var_1_40)) + (max (var_1_4 , (min (var_1_22 , 16u))))))) : (var_1_54 == ((unsigned long int) (max (var_1_4 , (max (8u , var_1_34))))))) : (var_1_54 == ((unsigned long int) (var_1_40 + (max (var_1_21 , 8u))))))) && ((last_1_var_1_54 >= last_1_var_1_34) ? (var_1_55 == ((unsigned long int) ((max ((var_1_56 - var_1_45) , (3470546746u - last_1_var_1_54))) - (var_1_22 - 64u)))) : 1)) && ((var_1_39 <= ((var_1_53 * var_1_21) + (min (var_1_22 , var_1_55)))) ? ((var_1_46 < var_1_48) ? ((var_1_27 >= var_1_29) ? (var_1_57 == ((double) (32.4 + var_1_38))) : (var_1_57 == ((double) var_1_30))) : (var_1_57 == ((double) var_1_30))) : 1)) && (((min (var_1_41 , var_1_44)) >= var_1_22) ? (var_1_60 == ((unsigned char) (var_1_26 && var_1_20))) : (var_1_60 == ((unsigned char) (var_1_24 && var_1_25))))) && (var_1_61 == ((float) var_1_31))) && (var_1_62 == ((unsigned char) var_1_4))
;
}
int main(void) {
	isInitial = 1;
