...
void step(void) {
	...
	if (! (var_1_13 < (127.125 / var_1_12))) {
		if (var_1_1 <= ((var_1_4 * var_1_3) + (4 << var_1_16))) {
			var_1_15 = var_1_3;
		}
	}
}
...
int property(void) {
	return ((((var_1_10 < 63.75) ? (var_1_1 == ((signed short int) (10 - var_1_3))) : (var_1_1 == ((signed short int) (4 + var_1_4)))) && ((var_1_3 > ((var_1_4 / -256) * 32)) ? (var_1_6 ? (var_1_5 == ((unsigned char) (! (var_1_7 && var_1_8)))) : (var_1_5 == ((unsigned char) var_1_8))) : (var_1_5 == ((unsigned char) var_1_9)))) && (var_1_7 ? (var_1_10 == ((double) (var_1_11 - (max ((var_1_12 - var_1_13) , var_1_14))))) : 1)) && ((! (var_1_13 < (127.125 / var_1_12))) ? ((var_1_1 <= ((var_1_4 * var_1_3) + (4 << var_1_16))) ? (var_1_15 == ((unsigned long int) var_1_3)) : 1) : 1)
;
}
int main(void) {
	isInitial = 1;
