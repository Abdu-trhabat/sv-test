...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch137100_1loop.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: Req4Batch137100_1loop
	if (! var_1_13) {
		var_1_15 = (max ((var_1_16 - var_1_17) , var_1_18));
	}


	// From: Req6Batch137100_1loop
	...
	// From: Req8Batch137100_1loop
	unsigned short int stepLocal_7 = var_1_16;
	if (stepLocal_7 <= var_1_17) {
		var_1_26 = (min (4u , var_1_18));
	} else {
		var_1_26 = var_1_23;
	}


	// From: Req9Batch137100_1loop
	if (var_1_18 <= (var_1_10 / var_1_16)) {
		var_1_27 = (max ((var_1_28 + var_1_29) , var_1_30));
	} else {
		var_1_27 = var_1_30;
	}


	// From: Req10Batch137100_1loop
	var_1_31 = (var_1_26 + (max ((var_1_23 - var_1_22) , (-5 + var_1_30))));


	// From: Req11Batch137100_1loop
	if (var_1_12 < (64.25 - var_1_33)) {
		if (! (var_1_13 || var_1_14)) {
			if (var_1_31 < var_1_26) {
				var_1_32 = (min ((128 - var_1_34) , var_1_35));
			} else {
	...
	// From: Req12Batch137100_1loop
	var_1_40 = var_1_18;


	// From: Req2Batch137100_1loop
	unsigned long int stepLocal_3 = max ((var_1_9 - var_1_10) , var_1_31);
...
int property(void) {
	return ((((((((((((var_1_2 == var_1_3) ? ((var_1_3 <= var_1_2) ? (var_1_1 == ((signed short int) (max (var_1_4 , var_1_5)))) : (var_1_1 == ((signed short int) var_1_5))) : (var_1_13 ? (var_1_13 ? (var_1_1 == ((signed short int) var_1_5)) : (var_1_1 == ((signed short int) var_1_4))) : (var_1_1 == ((signed short int) var_1_5)))) && (((max ((var_1_9 - var_1_10) , var_1_31)) < var_1_26) ? (((var_1_11 / 1.3) <= var_1_12) ? ((((var_1_31 * var_1_4) >= var_1_5) && var_1_13) ? (var_1_8 == ((signed short int) -8)) : (var_1_8 == ((signed short int) var_1_5))) : (var_1_8 == ((signed short int) -16))) : (var_1_8 == ((signed short int) var_1_4)))) && ((last_1_var_1_26 != -16) ? (var_1_13 == ((unsigned char) 0)) : (((last_1_var_1_26 >= last_1_var_1_19) || var_1_6) ? (var_1_13 == ((unsigned char) 0)) : (var_1_13 == ((unsigned char) var_1_14))))) && ((! var_1_13) ? (var_1_15 == ((unsigned short int) (max ((var_1_16 - var_1_17) , var_1_18)))) : 1)) && (var_1_13 ? (((var_1_14 && (var_1_10 < var_1_17)) && var_1_13) ? (var_1_19 == ((unsigned short int) var_1_18)) : (var_1_19 == ((unsigned short int) var_1_17))) : (var_1_19 == ((unsigned short int) var_1_18)))) && ((7.7 <= (var_1_12 * var_1_11)) ? (var_1_20 == ((signed short int) (var_1_21 - (var_1_22 + var_1_23)))) : (var_1_20 == ((signed short int) ((128 + var_1_24) + var_1_22))))) && ((var_1_1 > (var_1_22 + var_1_31)) ? (var_1_25 == ((signed short int) (abs (var_1_22)))) : ((var_1_26 >= (- var_1_26)) ? (var_1_25 == ((signed short int) var_1_5)) : 1))) && ((var_1_16 <= var_1_17) ? (var_1_26 == ((unsigned long int) (min (4u , var_1_18)))) : (var_1_26 == ((unsigned long int) var_1_23)))) && ((var_1_18 <= (var_1_10 / var_1_16)) ? (var_1_27 == ((signed char) (max ((var_1_28 + var_1_29) , var_1_30)))) : (var_1_27 == ((signed char) var_1_30)))) && (var_1_31 == ((signed long int) (var_1_26 + (max ((var_1_23 - var_1_22) , (-5 + var_1_30))))))) && ((var_1_12 < (64.25 - var_1_33)) ? ((! (var_1_13 || var_1_14)) ? ((var_1_31 < var_1_26) ? (var_1_32 == ((unsigned char) (min ((128 - var_1_34) , var_1_35)))) : (var_1_32 == ((unsigned char) (var_1_36 - ((var_1_37 - var_1_38) + var_1_39))))) : 1) : (var_1_32 == ((unsigned char) var_1_36)))) && (var_1_40 == ((unsigned short int) var_1_18))
;
}
int main(void) {
	isInitial = 1;
