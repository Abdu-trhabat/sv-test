...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch12525_1loop.c", 13, "reach_error"); }
...
void step(void) {
	// From: Req1Batch12525_1loop
	var_1_1 = (var_1_2 - (var_1_4 + 32.4f));


	// From: Req2Batch12525_1loop
	var_1_5 = (var_1_6 && (! var_1_7));


	// From: Req3Batch12525_1loop
	var_1_8 = var_1_3;


	// From: Req4Batch12525_1loop
