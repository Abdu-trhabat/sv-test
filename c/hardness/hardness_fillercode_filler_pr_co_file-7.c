...
void reach_error(void) { __assert_fail("0", "Req1_Prop1_Batch7Filler_PR_CO.c", 13, "reach_error"); }
...
void step(void) {
	...
	// From: CodeObject1
	/* 240L, 67L) */ if (/* 241L, 11L, 12L) */ ((/* 242L, 4L, 13L) */ ((var_1_10) >> (var_1_27))) > (/* 245L, 10L, 16L) */ (max (/* 245L, 10L, 16L) */ (var_1_29) , (var_1_28)))))) {
	...
	// From: CodeObject5
	/* 301L, 194L) */ if (/* 302L, 148L, 149L) */ ((/* 303L, 144L, 150L) */ (abs (var_1_10))) > (/* 305L, 147L, 152L) */ ((var_1_7) / (var_1_28))))) {
	...
	// From: CodeObject2
	/* 269L, 97L) */ if (/* 270L, 78L, 79L) */ (! (/* 271L, 77L, 80L) */ ((/* 272L, 75L, 81L) */ (max (/* 272L, 75L, 81L) */ (var_1_10) , (5)))) != (var_1_27))))) {
		/* 276L, 96L) */ var_1_33 = (
			/* 279L, 95L) */ (abs (
				/* 280L, 94L) */ (abs (
					var_1_27
	...
	// From: CodeObject3
	/* 282L, 131L) */ if (/* 283L, 105L, 106L) */ ((/* 284L, 103L, 107L) */ ((var_1_7) ^ (var_1_10))) > (var_1_9))) {
