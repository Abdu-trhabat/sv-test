...
void step(void) {
	...
	/* 407L, 286L) */ if (/* 408L, 223L, 224L) */ ((var_1_28) == (/* 410L, 222L, 226L) */ ((/* 411L, 220L, 227L) */ ((var_1_36) / (var_1_46))) % (var_1_47))))) {
		...
		/* 420L, 284L) */ if (/* 421L, 253L, 254L) */ ((/* 422L, 245L, 255L) */ ((var_1_48) - (var_1_11))) <= (/* 425L, 252L, 258L) */ ((/* 426L, 248L, 259L) */ ((var_1_49) - (var_1_1))) - (/* 429L, 251L, 262L) */ ((var_1_50) - (var_1_25))))))) {
			/* 432L, 279L) */ var_1_44 = (
				var_1_28
			);
		} else {
	...
	// From: CodeObject5
	/* 341L, 152L) */ if (/* 342L, 121L, 122L) */ ((/* 343L, 119L, 123L) */ ((/* 344L, 117L, 124L) */ ((var_1_25) / (var_1_36))) ^ (var_1_1))) > (var_1_1))) {
	...
	// From: CodeObject6
	/* 381L, 197L) */ if (/* 382L, 159L, 160L) */ ((/* 383L, 157L, 161L) */ (abs (var_1_9))) < (var_1_9))) {
