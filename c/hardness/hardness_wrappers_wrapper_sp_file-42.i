...
void step(void) {
 if ((*(WrapperStruct00_var_1_2_Pointer)) > (*(WrapperStruct00_var_1_3_Pointer))) {
  (*(WrapperStruct00_var_1_1_Pointer)) = ((((((*(WrapperStruct00_var_1_4_Pointer))) < ((*(WrapperStruct00_var_1_5_Pointer)))) ? ((*(WrapperStruct00_var_1_4_Pointer))) : ((*(WrapperStruct00_var_1_5_Pointer))))) - 10);
 } else {
  (*(WrapperStruct00_var_1_1_Pointer)) = ((((((*(WrapperStruct00_var_1_5_Pointer)) - (*(WrapperStruct00_var_1_6_Pointer)))) > (((*(WrapperStruct00_var_1_4_Pointer)) - (*(WrapperStruct00_var_1_7_Pointer))))) ? (((*(WrapperStruct00_var_1_5_Pointer)) - (*(WrapperStruct00_var_1_6_Pointer)))) : (((*(WrapperStruct00_var_1_4_Pointer)) - (*(WrapperStruct00_var_1_7_Pointer))))));
 }
