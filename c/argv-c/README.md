...
Lock-free `localtime()` implementation. Assertions verify computed `tm_hour`, `tm_min`, `tm_sec`, `tm_wday` are within valid calendar ranges. The `_unsafe` variant allows the 1970 underflow noted in the comments.
