 ...
 *
 * It is derived from GNU coreutil's longlong.h -- definitions for mixed size 32/64 bit arithmetic.
 * https://github.com/coreutils/coreutils/blob/v9.5/src/longlong.h
 *
