...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_2a_bitvector_linux-3.16-rc1.tar.xz-43_2a-drivers--net--wireless--iwlwifi--iwlwifi.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
void ldv_main_exported_40(void)
{
  ...
  ldvarg46 = tmp___31;
  tmp___32 = __VERIFIER_nondet_uint();
  ldvarg50 = tmp___32;
  ...
  ldvarg51 = tmp___38;
  tmp___39 = __VERIFIER_nondet_ushort();
  ldvarg77 = tmp___39;
