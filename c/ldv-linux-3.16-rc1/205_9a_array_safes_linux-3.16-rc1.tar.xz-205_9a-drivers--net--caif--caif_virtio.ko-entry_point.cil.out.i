...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "205_9a_array_safes_linux-3.16-rc1.tar.xz-205_9a-drivers--net--caif--caif_virtio.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
static int cfv_probe(struct virtio_device *vdev )
{
  ...
  err = -19;
  if ((unsigned long )vdev->vringh_config == (unsigned long )((struct vringh_config_ops const *)0) || (unsigned long )(vdev->vringh_config)->find_vrhs == (unsigned long )((int (* )(struct virtio_device * ,
                                                                                                                                                                                                  unsigned int ,
                                                                                                                                                                                                  struct vringh ** ,
                                                                                                                                                                                                  vrh_callback_t ** ))0)) {
    goto err;
