...
struct kparam_array;
union __anonunion_ldv_26655_189 {
   void *arg ;
...
struct kernel_param {
   ...
   u16 perm ;
   s16 level ;
   union __anonunion_ldv_26655_189 ldv_26655 ;
};
struct kparam_string {
   unsigned int maxlen ;
   char *string ;
...
struct __anonstruct_ldv_27167_191 {
   spinlock_t lock ;
   unsigned int count ;
};
union __anonunion_ldv_27168_190 {
   struct __anonstruct_ldv_27167_191 ldv_27167 ;
};
struct lockref {
   union __anonunion_ldv_27168_190 ldv_27168 ;
};
struct nameidata;
struct vfsmount;
struct __anonstruct_ldv_27191_193 {
   u32 hash ;
   u32 len ;
};
union __anonunion_ldv_27193_192 {
   struct __anonstruct_ldv_27191_193 ldv_27191 ;
   u64 hash_len ;
};
struct qstr {
   union __anonunion_ldv_27193_192 ldv_27193 ;
...
struct __anonstruct_ldv_27554_196 {
   struct radix_tree_node *parent ;
   void *private_data ;
};
union __anonunion_ldv_27556_195 {
   struct __anonstruct_ldv_27554_196 ldv_27554 ;
   struct callback_head callback_head ;
};
struct radix_tree_node {
   unsigned int path ;
   unsigned int count ;
   union __anonunion_ldv_27556_195 ldv_27556 ;
...
union __anonunion_ldv_28081_198 {
   kuid_t uid ;
   kgid_t gid ;
   kprojid_t projid ;
};
struct kqid {
   union __anonunion_ldv_28081_198 ldv_28081 ;
...
union __anonunion_ldv_28495_201 {
   unsigned int const   i_nlink ;
   unsigned int __i_nlink ;
};
union __anonunion_ldv_28515_202 {
   struct hlist_head i_dentry ;
   struct callback_head i_rcu ;
};
struct file_lock;
struct cdev;
union __anonunion_ldv_28532_203 {
...
struct inode {
   ...
   void *i_security ;
   unsigned long i_ino ;
   union __anonunion_ldv_28495_201 ldv_28495 ;
   dev_t i_rdev ;
   loff_t i_size ;
   ...
   union __anonunion_ldv_28515_202 ldv_28515 ;
   u64 i_version ;
   atomic_t i_count ;
   ...
   union __anonunion_ldv_28532_203 ldv_28532 ;
   __u32 i_generation ;
...
union __anonunion_ldv_30945_207 {
   struct tty_buffer *next ;
   struct llist_node free ;
};
struct tty_buffer {
   union __anonunion_ldv_30945_207 ldv_30945 ;
   int used ;
   int size ;
   int commit ;
   int read ;
...
struct pcpu_dstats;
struct pcpu_vstats;
union __anonunion_ldv_40870_249 {
   void *ml_priv ;
...
struct net_device {
   ...
   struct net *nd_net ;
   union __anonunion_ldv_40870_249 ldv_40870 ;
...
struct ppp_channel *async_ops_group0  ;
int ldv_state_variable_2  ;
int ref_cnt  ;
int ldv_state_variable_1  ;
struct tty_struct *ppp_ldisc_group1  ;
...
static void ppp_async_input(struct asyncppp *ap , unsigned char const   *buf , char *flags ,
                            int count ) ;
static int ppp_async_ioctl(struct ppp_channel *chan , unsigned int cmd , unsigned long arg ) ;
static void ppp_async_process(unsigned long arg ) ;
static void async_lcp_peek(struct asyncppp *ap , unsigned char *data , int len , int inbound ) ;
static struct ppp_channel_ops  const  async_ops  =    {& ppp_async_send, & ppp_async_ioctl};
...
{ 
  ...
  ap = (struct asyncppp *)tty->disc_data;
  if ((unsigned long )ap != (unsigned long )((struct asyncppp *)0)) {
...
{ 
  ...
  err = -12;
  tmp = kzalloc(4656UL, 208U);
  ap = (struct asyncppp *)tmp;
  if ((unsigned long )ap == (unsigned long )((struct asyncppp *)0)) {
    goto out;
  } else {
  ...
  ap->optr = (unsigned char *)(& ap->obuf);
  ap->olim = (unsigned char *)(& ap->obuf);
  ap->lcp_fcs = -1;
...
static void ppp_asynctty_close(struct tty_struct *tty ) 
{ 
  struct asyncppp *ap ;
  int tmp ;
  ...
  ldv_kfree_skb_12(ap->rpkt);
  skb_queue_purge(& ap->rqueue);
  ldv_kfree_skb_13(ap->tpkt);
  kfree((void const   *)ap);
  return;
}
}
...
static ssize_t ppp_asynctty_read(struct tty_struct *tty , struct file *file , unsigned char *buf ,
                                 size_t count ) 
{ 
...
static ssize_t ppp_asynctty_write(struct tty_struct *tty , struct file *file , unsigned char const   *buf ,
                                  size_t count ) 
{ 
...
static int ppp_asynctty_ioctl(struct tty_struct *tty , struct file *file , unsigned int cmd ,
                              unsigned long arg ) 
{ 
  struct asyncppp *ap ;
  struct asyncppp *tmp ;
...
static unsigned int ppp_asynctty_poll(struct tty_struct *tty , struct file *file ,
                                      poll_table *wait ) 
{ 
...
static void ppp_asynctty_receive(struct tty_struct *tty , unsigned char const   *buf ,
...
static void ppp_asynctty_wakeup(struct tty_struct *tty ) 
{ 
  struct asyncppp *ap ;
  struct asyncppp *tmp ;
...
static struct tty_ldisc_ops ppp_ldisc  = 
     {21507, (char *)"ppp", 0, 0, & ppp_asynctty_open, & ppp_asynctty_close, 0, 0, & ppp_asynctty_read,
    & ppp_asynctty_write, & ppp_asynctty_ioctl, 0, 0, & ppp_asynctty_poll, & ppp_asynctty_hangup,
    & ppp_asynctty_receive, & ppp_asynctty_wakeup, 0, 0, 0, & __this_module, 0};
static int ppp_async_init(void) 
{ 
  int err ;

  {
  err = tty_register_ldisc(3, & ppp_ldisc);
  if (err != 0) {
    printk("\vPPP_async: error %d registering line disc.\n", err);
  } else {
...
{ 
  ...
  {
  ap = (struct asyncppp *)chan->private;
  argp = (void *)arg;
  p = (int *)argp;
  err = -14;
  switch (cmd) {
  ...
  case 1074033751U: 
  might_fault();
  __asm__  volatile   ("call __get_user_%P3": "=a" (__ret_gu___0), "=r" (__val_gu___0): "0" ((u32 *)argp),
                       "i" (4UL));
  ...
  case 1074033748U: 
  might_fault();
  __asm__  volatile   ("call __get_user_%P3": "=a" (__ret_gu___1), "=r" (__val_gu___1): "0" ((u32 *)argp),
                       "i" (4UL));
...
{ 
  ...
  {
  buf = (unsigned char *)(& ap->obuf);
  ap->olim = buf;
  ap->optr = buf;
  i = ap->tpkt_pos;
  data = (ap->tpkt)->data;
  count = (int )(ap->tpkt)->len;
  fcs = (int )ap->tfcs;
  ...
  if (i == 0) {
    ...
    if ((islcp != 0 || flag_time == 0) || (long )((unsigned long )jiffies - (ap->last_xmit + (unsigned long )flag_time)) >= 0L) {
      tmp___0 = buf;
      buf = buf + 1;
      *tmp___0 = 126U;
    } else {
    ...
    if ((ap->flags & 2U) == 0U || islcp != 0) {
      ...
      tmp___4 = crc_ccitt_byte((int )((u16 )fcs), 255);
      fcs = (int )tmp___4;
      if (islcp != 0 || (ap->xaccm[0] & 8U) != 0U) {
        tmp___5 = buf;
        buf = buf + 1;
        *tmp___5 = 125U;
        tmp___6 = buf;
      ...
      tmp___8 = crc_ccitt_byte((int )((u16 )fcs), 3);
      fcs = (int )tmp___8;
    } else {
  ...
  buflim = (unsigned char *)(& ap->obuf) + 4090U;
  goto ldv_42769;
  ldv_42770: 
  tmp___9 = i;
  i = i + 1;
  c = (int )*(data + (unsigned long )tmp___9);
  if ((i == 1 && c == 0) && (int )ap->flags & 1) {
    goto ldv_42769;
  } else {

  }
  tmp___10 = crc_ccitt_byte((int )((u16 )fcs), (int )((u8 const   )c));
  fcs = (int )tmp___10;
  if ((islcp != 0 && c <= 31) || (ap->xaccm[c >> 5] & (u32 )(1 << (c & 31))) != 0U) {
    tmp___11 = buf;
    buf = buf + 1;
    *tmp___11 = 125U;
    tmp___12 = buf;
    buf = buf + 1;
    *tmp___12 = (unsigned char )((int )((signed char )c) ^ 32);
  } else {
    tmp___13 = buf;
    buf = buf + 1;
    *tmp___13 = (unsigned char )c;
  }
  ldv_42769: ;
  if (i < count && (unsigned long )buf < (unsigned long )buflim) {
    goto ldv_42770;
  } else {
  ...
  if ((islcp != 0 && c <= 31) || (ap->xaccm[c >> 5] & (u32 )(1 << (c & 31))) != 0U) {
    ...
    *tmp___14 = 125U;
    tmp___15 = buf;
    buf = buf + 1;
    *tmp___15 = (unsigned char )((int )((signed char )c) ^ 32);
  } else {
    tmp___16 = buf;
    buf = buf + 1;
  ...
  if ((islcp != 0 && c <= 31) || (ap->xaccm[c >> 5] & (u32 )(1 << (c & 31))) != 0U) {
    ...
    *tmp___17 = 125U;
    tmp___18 = buf;
    buf = buf + 1;
    *tmp___18 = (unsigned char )((int )((signed char )c) ^ 32);
  } else {
    tmp___19 = buf;
    buf = buf + 1;
    *tmp___19 = (unsigned char )c;
  }
  tmp___20 = buf;
  buf = buf + 1;
  *tmp___20 = 126U;
  ap->olim = buf;
  ldv_consume_skb_15(ap->tpkt);
...
{ 
  ...
  tty = ap->tty;
  tty_stuffed = 0;
  tmp = test_and_set_bit(2L, (unsigned long volatile   *)(& ap->xmit_flags));
  if (tmp != 0) {
    return (0);
  } else {
  ...
  if (tty_stuffed == 0 && (unsigned long )ap->optr < (unsigned long )ap->olim) {
    avail = (int )((unsigned int )((long )ap->olim) - (unsigned int )((long )ap->optr));
    set_bit(5L, (unsigned long volatile   *)(& tty->flags));
    sent = (*((tty->ops)->write))(tty, (unsigned char const   *)ap->optr, avail);
    if (sent < 0) {
      goto flush;
    } else {

    }
    ap->optr = ap->optr + (unsigned long )sent;
    if (sent < avail) {
      tty_stuffed = 1;
    } else {
  ...
  if ((unsigned long )ap->optr >= (unsigned long )ap->olim && (unsigned long )ap->tpkt != (unsigned long )((struct sk_buff *)0)) {
    tmp___1 = ppp_async_encode(ap);
    if (tmp___1 != 0) {
  ...
  clear_bit(2L, (unsigned long volatile   *)(& ap->xmit_flags));
  tmp___2 = constant_test_bit(0L, (unsigned long const volatile   *)(& ap->xmit_flags));
  if (tmp___2 == 0 && (tty_stuffed != 0 || (unsigned long )ap->tpkt == (unsigned long )((struct sk_buff *)0))) {
    goto ldv_42787;
  } else {

  }
  tmp___3 = test_and_set_bit(2L, (unsigned long volatile   *)(& ap->xmit_flags));
  if (tmp___3 != 0) {
    goto ldv_42787;
  } else {
...
__inline static int scan_ordinary(struct asyncppp *ap , unsigned char const   *buf ,
                                  int count ) 
{ 
  int i ;
  int c ;
  ...
  goto ldv_42802;
  ldv_42801: 
  c = (int )*(buf + (unsigned long )i);
  if ((c == 125 || c == 126) || (c <= 31 && (ap->raccm & (u32 )(1 << c)) != 0U)) {
    goto ldv_42800;
  } else {
...
static void process_input_packet(struct asyncppp *ap ) 
{ 
  struct sk_buff *skb ;
  unsigned char *p ;
  unsigned int len ;
  ...
  tmp = p;
  p = p + 1;
  tmp___0 = crc_ccitt_byte((int )((u16 )fcs), (int )*tmp);
  fcs = (unsigned int )tmp___0;
  len = len - 1U;
  ldv_42813: ;
  if (len != 0U) {
    goto ldv_42812;
  ...
  if ((unsigned int )*p == 255U) {
    if ((unsigned int )*(p + 1UL) != 3U || skb->len <= 2U) {
      goto err;
    } else {
  ...
  if ((int )proto & 1) {
    ...
    *tmp___1 = 0U;
    ...
    proto = (proto << 8) + (unsigned int )*(p + 1UL);
    if (proto == 49185U) {
      async_lcp_peek(ap, p, (int )skb->len, 1);
    } else {

    }
  }
  skb->cb[0] = (char )ap->state;
  skb_queue_tail(& ap->rqueue, skb);
  ap->rpkt = (struct sk_buff *)0;
  ap->state = 0U;
  return;
  err: 
  ap->state = 4U;
...
{ 
  ...
  {
  if ((~ ap->rbits & 251658240U) != 0U) {
    s = 0;
    i = 0;
    goto ldv_42831;
    ldv_42830: 
    c = (int )*(buf + (unsigned long )i);
    if ((unsigned long )flags != (unsigned long )((char *)0) && (int )((signed char )*(flags + (unsigned long )i)) != 0) {
      goto ldv_42829;
    } else {

    }
    s = ((c & 128) != 0 ? 33554432 : 16777216) | s;
    c = ((c >> 4) ^ c) & 15;
    s = ((27030 >> c) & 1 ? 134217728 : 67108864) | s;
    ldv_42829: 
    i = i + 1;
    ldv_42831: ;
    if (i < count) {
    ...
    ap->rbits = ap->rbits | (unsigned int )s;
  } else {

  }
  goto ldv_42842;
  ldv_42841: ;
  if ((ap->state & 2U) != 0U && (unsigned int )((unsigned char )*buf) == 125U) {
    n = 1;
  } else {
    n = scan_ordinary(ap, buf, count);
  }
  f = 0;
  if ((unsigned long )flags != (unsigned long )((char *)0) && (ap->state & 1U) == 0U) {
    j = 0;
    goto ldv_42835;
    ldv_42834: 
    f = (int )*(flags + (unsigned long )j);
    if (f != 0) {
      goto ldv_42833;
    } else {
  ...
  if (f != 0) {
    ap->state = ap->state | 1U;
  } else
  if (n > 0 && (ap->state & 1U) == 0U) {
    skb = ap->rpkt;
    if ((unsigned long )skb == (unsigned long )((struct sk_buff *)0)) {
      skb = ldv_dev_alloc_skb_18((unsigned int )(ap->mru + 6));
      if ((unsigned long )skb == (unsigned long )((struct sk_buff *)0)) {
        goto nomem;
      } else {
  ...
  c = (int )*(buf + (unsigned long )n);
  if ((unsigned long )flags != (unsigned long )((char *)0) && (int )((signed char )*(flags + (unsigned long )n)) != 0) {
    ap->state = ap->state | 1U;
  } else
  if (c == 126) {
  ...
  if (c == 125) {
    ap->state = ap->state | 2U;
  } else
  if (((ap->tty)->termios.c_iflag & 1024U) != 0U) {
    if ((int )(ap->tty)->termios.c_cc[8] == c) {
      start_tty(ap->tty);
    } else
    if ((int )(ap->tty)->termios.c_cc[9] == c) {
      stop_tty(ap->tty);
    } else {
  ...
  if ((unsigned long )flags != (unsigned long )((char *)0)) {
    flags = flags + (unsigned long )n;
  } else {
  ...
  return;
  nomem: 
  printk("\vPPPasync: no memory (input pkt)\n");
  ap->state = ap->state | 1U;
  return;
}
}
...
{ 
  ...
  tmp = get_unaligned_be16((void const   *)data + 2U);
  dlen = (int )tmp;
  if (len < dlen) {
    return;
  } else {
  ...
  if ((inbound != 0 ? 2 : 1) == code) {
    fcs = 65535;
    i = 1;
    goto ldv_42855;
    ldv_42854: 
    tmp___0 = crc_ccitt_byte((int )((u16 )fcs), (int )*(data + (unsigned long )i));
    fcs = (int )tmp___0;
    i = i + 1;
    ldv_42855: ;
    if (i < dlen) {
  ...
  switch ((int )*data) {
  case 1: 
  tmp___1 = get_unaligned_be16((void const   *)data + 2U);
  val = (u32 )tmp___1;
  if (inbound != 0) {
    ap->mru = (int )val;
  } else {
  ...
  goto ldv_42858;
  case 2: 
  val = get_unaligned_be32((void const   *)data + 2U);
  if (inbound != 0) {
    ap->raccm = val;
  } else {
    ap->xaccm[0] = val;
  ...
  ldv_42858: 
  dlen = dlen - (int )*(data + 1UL);
  data = data + (unsigned long )*(data + 1UL);
  ldv_42861: ;
  if ((dlen > 1 && (int )*(data + 1UL) <= dlen) && (unsigned int )*(data + 1UL) > 1U) {
    goto ldv_42860;
  } else {
...
static void ppp_async_cleanup(void) 
{ 
  int tmp ;

  {
  tmp = tty_unregister_ldisc(3);
  if (tmp != 0) {
    printk("\vfailed to unregister PPP line discipline\n");
  } else {
...
{ 
  ...
  {
  tmp = ldv_zalloc(40UL);
  async_ops_group0 = (struct ppp_channel *)tmp;
  return;
}
}
void ldv_target_type_1(void) 
{ 
  ...
  ppp_ldisc_group1 = (struct tty_struct *)tmp;
  return;
}
}
int main(void) 
{ 
  ...
  if (ldv_state_variable_1 != 0) {
    ...
    if (ldv_state_variable_1 == 2) {
      ppp_asynctty_write(ppp_ldisc_group1, ldvarg13, (unsigned char const   *)ldvarg12,
                         ldvarg11);
    ...
    case 1: ;
    if (ldv_state_variable_1 == 2) {
      ppp_asynctty_read(ppp_ldisc_group1, ldvarg10, ldvarg9, ldvarg8);
      ldv_state_variable_1 = 2;
    } else {
    ...
    if (ldv_state_variable_1 == 1) {
      ppp_asynctty_poll(ppp_ldisc_group1, ldvarg7, ldvarg6);
    ...
    case 3: ;
    if (ldv_state_variable_1 == 1) {
      ppp_asynctty_hangup(ppp_ldisc_group1);
      ldv_state_variable_1 = 1;
    } else {
    ...
    case 4: ;
    if (ldv_state_variable_1 == 2) {
      ppp_asynctty_close(ppp_ldisc_group1);
      ldv_state_variable_1 = 1;
      ref_cnt = ref_cnt - 1;
    } else {
    ...
    case 5: ;
    if (ldv_state_variable_1 == 1) {
      ldv_retval_0 = ppp_asynctty_open(ppp_ldisc_group1);
      if (ldv_retval_0 == 0) {
        ldv_state_variable_1 = 2;
        ref_cnt = ref_cnt + 1;
      } else {
    ...
    case 6: ;
    if (ldv_state_variable_1 == 2) {
      ppp_asynctty_wakeup(ppp_ldisc_group1);
      ldv_state_variable_1 = 2;
    } else {
    ...
    case 7: ;
    if (ldv_state_variable_1 == 2) {
      ppp_asynctty_receive(ppp_ldisc_group1, (unsigned char const   *)ldvarg5, ldvarg4,
                           ldvarg3);
      ldv_state_variable_1 = 2;
    } else {
    ...
    case 8: ;
    if (ldv_state_variable_1 == 1) {
      ppp_asynctty_ioctl(ppp_ldisc_group1, ldvarg2, ldvarg1, ldvarg0);
      ldv_state_variable_1 = 1;
    } else {
  ...
  if (ldv_state_variable_2 != 0) {
    ...
    if (ldv_state_variable_2 == 1) {
      ppp_async_send(async_ops_group0, ldvarg16);
      ldv_state_variable_2 = 1;
    } else {
    ...
    case 1: ;
    if (ldv_state_variable_2 == 1) {
      ppp_async_ioctl(async_ops_group0, ldvarg15, ldvarg14);
      ldv_state_variable_2 = 1;
    } else {
...
#include "model/205_9a_array_unsafes_linux-3.16-rc1.tar.xz-205_9a-drivers--net--ppp--ppp_async.ko-entry_point_false-unreach-call.cil.out.env.c"
