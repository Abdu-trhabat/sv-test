...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "205_9a_array_safes_linux-3.16-rc1.tar.xz-205_9a-drivers--net--wireless--rtlwifi--btcoexist--btcoexist.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
struct module;
...
static void btc8723b2ant_update_bt_link_info(struct btc_coexist *btcoexist )
{
  ...
  bt_hs_on = 0;
  if (btcoexist->btc_get) (*(btcoexist->btc_get))((void *)btcoexist, 0, (void *)(& bt_hs_on));
...
static void btc8723b2ant_set_fw_dac_swing_level(struct btc_coexist *btcoexist , u8 dac_swing_lvl )
{
  ...
  if (btcoexist->btc_fill_h2c) (*(btcoexist->btc_fill_h2c))((void *)btcoexist, 100, 1U,
                                                  (u8 *)(&h2c_parameter));
  return;
}
}
static void btc8723b2ant_set_fw_dec_bt_pwr(struct btc_coexist *btcoexist , bool dec_bt_pwr )
{
  ...
  if (btcoexist->btc_fill_h2c) (*(btcoexist->btc_fill_h2c))((void *)btcoexist, 98, 1U, (u8 *)(& h2c_parameter));
  return;
}
}
...
static void btc8723b2ant_set_dac_swing_reg(struct btc_coexist *btcoexist , u32 level )
{
  ...
  if (btcoexist->btc_write_1byte_bitmask) (*(btcoexist->btc_write_1byte_bitmask))((void *)btcoexist, 2179U, 62U, (int )val);
  return;
}
}
                                        ...
                                        u32 val0x6c4 , u32 val0x6c8 , u8 val0x6cc )
{
  ...
  if (btcoexist->btc_write_4byte) (*(btcoexist->btc_write_4byte))((void *)btcoexist, 1728U, val0x6c0);
  tmp___0 = ldv__builtin_expect((btc_dbg_type[1] & 512U) != 0U, 0L);
  if (tmp___0 != 0L) {
    printk("[BTCoex], set coex table, set 0x6c4=0x%x\n", val0x6c4);
  } else {
  }
  if (btcoexist->btc_write_4byte) (*(btcoexist->btc_write_4byte))((void *)btcoexist, 1732U, val0x6c4);
  tmp___1 = ldv__builtin_expect((btc_dbg_type[1] & 512U) != 0U, 0L);
  if (tmp___1 != 0L) {
    printk("[BTCoex], set coex table, set 0x6c8=0x%x\n", val0x6c8);
  } else {
  }
  if (btcoexist->btc_write_4byte) (*(btcoexist->btc_write_4byte))((void *)btcoexist, 1736U, val0x6c8);
  tmp___2 = ldv__builtin_expect((btc_dbg_type[1] & 512U) != 0U, 0L);
  if (tmp___2 != 0L) {
    printk("[BTCoex], set coex table, set 0x6cc=0x%x\n", (int )val0x6cc);
  } else {
  }
  if (btcoexist->btc_write_1byte) (*(btcoexist->btc_write_1byte))((void *)btcoexist, 1740U, (int)val0x6cc);
  return;
}
}
...
static void btc8723b2ant_set_fw_ignore_wlan_act(struct btc_coexist *btcoexist , bool enable )
{
  ...
  if (btcoexist->btc_fill_h2c) (*(btcoexist->btc_fill_h2c))((void *)btcoexist, 99, 1U, (u8 *)(& h2c_parameter));
  return;
}
}
                                        ...
                                        u8 byte2 , u8 byte3 , u8 byte4 , u8 byte5 )
{
  ...
  if (btcoexist->btc_fill_h2c) (*(btcoexist->btc_fill_h2c))((void *)btcoexist, 96, 5U, (u8 *)(& h2c_parameter));
  return;
}
}
...
static void btc8723b2ant_coex_alloff(struct btc_coexist *btcoexist )
{
  ...
  if (btcoexist->btc_set_rf_reg) (*(btcoexist->btc_set_rf_reg))((void *)btcoexist, 0, 1U, 1048575U, 0U);
...
static bool btc8723b2ant_is_common_action(struct btc_coexist *btcoexist )
{
  ...
  if (! wifi_connected) {
    low_pwr_disable = 0;
    if (btcoexist->btc_set) (*(btcoexist->btc_set))((void *)btcoexist, 20, (void *)(& low_pwr_disable));
    tmp = ldv__builtin_expect((btc_dbg_type[1] & 8U) != 0U, 0L);
    if (tmp != 0L) {
...
void ex_halbtc8723b2ant_init_hwconfig(struct btc_coexist *btcoexist )
{
  ...
  if (btcoexist->btc_get_rf_reg) coex_dm->bt_rf0x1e_backup = (*(btcoexist->btc_get_rf_reg))((void *)btcoexist, 0,
                                                             30U, 1048575U);
  if (btcoexist->btc_read_4byte) u32tmp = (*(btcoexist->btc_read_4byte))((void *)btcoexist, 76U);
  u32tmp = u32tmp & 4286578687U;
  u32tmp = u32tmp | 16777216U;
  if (btcoexist->btc_write_4byte) (*(btcoexist->btc_write_4byte))((void *)btcoexist, 76U, u32tmp);
  if (btcoexist->btc_write_1byte)  (*(btcoexist->btc_write_1byte))((void *)btcoexist, 2420U, 255);
  if (btcoexist->btc_write_1byte_bitmask)  (*(btcoexist->btc_write_1byte_bitmask))((void *)btcoexist, 2372U, 3U, 3);
  if (btcoexist->btc_write_1byte) (*(btcoexist->btc_write_1byte))((void *)btcoexist, 2352U, 119);
  if (btcoexist->btc_write_1byte_bitmask) (*(btcoexist->btc_write_1byte_bitmask))((void *)btcoexist, 103U, 32U, 1);
  if (btcoexist->btc_write_1byte_bitmask) (*(btcoexist->btc_write_1byte_bitmask))((void *)btcoexist, 1893U, 24U, 0);
  if (btcoexist->btc_write_2byte) (*(btcoexist->btc_write_2byte))((void *)btcoexist, 2376U, 0);
  if (btcoexist->btc_read_1byte) u8tmp = (*(btcoexist->btc_read_1byte))((void *)btcoexist, 1936U);
  u8tmp = (unsigned int )u8tmp & 192U;
  u8tmp = (u8 )((unsigned int )u8tmp | 5U);
  if (btcoexist->btc_write_1byte) (*(btcoexist->btc_write_1byte))((void *)btcoexist, 1936U, (int )u8tmp);
  if (btcoexist->btc_get) (*(btcoexist->btc_get))((void *)btcoexist, 21, (void *)(& fw_ver));
  if (fw_ver <= 3071U) {
    if ((unsigned int )board_info->btdm_ant_pos == 1U) {
      ...
      if (btcoexist->btc_write_1byte_bitmask)
        { (*(btcoexist->btc_write_1byte_bitmask))((void *)btcoexist, 2348U, 3U, 2);
          (*(btcoexist->btc_write_1byte_bitmask))((void *)btcoexist, 100U, 1U, 0);
        }
      h2c_parameter[0] = 1U;
      h2c_parameter[1] = 1U;
      if (btcoexist->btc_fill_h2c) (*(btcoexist->btc_fill_h2c))((void *)btcoexist, 101, 2U, (u8 *)(& h2c_parameter));
    }
  } else {
    if (btcoexist->btc_write_1byte_bitmask) {
      (*(btcoexist->btc_write_1byte_bitmask))((void *)btcoexist, 2348U, 3U, 1);
  ...
  if (btcoexist->btc_write_1byte) {
    (*(btcoexist->btc_write_1byte))((void *)btcoexist, 1902U, 12);
    (*(btcoexist->btc_write_1byte))((void *)btcoexist, 1912U, 3);
  }
  if (btcoexist->btc_write_1byte_bitmask) (*(btcoexist->btc_write_1byte_bitmask))((void *)btcoexist, 64U, 32U, 1);
    return;
  }
}
void ex_halbtc8723b2ant_init_coex_dm(struct btc_coexist *btcoexist )
...
void btc8723b_med_stat_notify(struct btc_coexist *btcoexist , u8 type )
{
  ...
  if(btcoexist->btc_get) (*(btcoexist->btc_get))((void *)btcoexist, 24, (void *)(& wifi_central_chnl));
  if ((unsigned int )type == 1U && (unsigned int )wifi_central_chnl <= 14U) {
    h2c_parameter[0] = 1U;
    h2c_parameter[1] = wifi_central_chnl;
    if(btcoexist->btc_get) (*(btcoexist->btc_get))((void *)btcoexist, 19, (void *)(& wifi_bw));
    if (wifi_bw == 2U) {
      h2c_parameter[2] = 48U;
    } else {
      h2c_parameter[2] = 32U;
  ...
  if(btcoexist->btc_fill_h2c) (*(btcoexist->btc_fill_h2c))((void *)btcoexist, 102, 3U, (u8 *)(& h2c_parameter));
  return;
}
}
void ex_halbtc8723b2ant_special_packet_notify(struct btc_coexist *btcoexist , u8 type )
                                       ...
                                       u8 length )
{
  ...
  if(btcoexist->btc_set) (*(btcoexist->btc_set))((void *)btcoexist, 1, (void *)(& bt_busy));
  coex_dm->limited_dig = limited_dig;
  if(btcoexist->btc_set) (*(btcoexist->btc_set))((void *)btcoexist, 2, (void *)(& limited_dig));
