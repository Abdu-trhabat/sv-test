...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.12-rc1.tar.xz-144_2a-drivers--net--wireless--rtlwifi--rtl8192se--rtl8192se.ko-entry_point.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
int main(void)
{
  ...
  ldvarg12 = tmp___5;
  tmp___6 = __VERIFIER_nondet_uchar();
  ldvarg56 = tmp___6;
  ...
  ldvarg53 = tmp___9;
  tmp___10 = __VERIFIER_nondet_uchar();
  ldvarg29 = tmp___10;
  ...
  ldvarg21 = tmp___34;
  tmp___35 = __VERIFIER_nondet_uint();
  ldvarg54 = tmp___35;
  ...
  ldvarg22 = tmp___38;
  tmp___39 = __VERIFIER_nondet_uint();
  ldvarg52 = tmp___39;
  ldv_initialize();
