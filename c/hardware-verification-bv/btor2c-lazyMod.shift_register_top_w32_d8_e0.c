...
void reach_error() { __assert_fail("0", "shift_register_top_w32_d8_e0.c", 0, "reach_error"); }
...
int main() {
  ...
  typedef unsigned char SORT_119;  // BV with 2 bits
  const SORT_119 mask_SORT_119 = (SORT_119)-1 >> (sizeof(SORT_119) * 8 - 2);
  const SORT_119 msb_SORT_119 = (SORT_119)1 << (2 - 1);
  typedef unsigned char SORT_134;  // BV with 3 bits
  const SORT_134 mask_SORT_134 = (SORT_134)-1 >> (sizeof(SORT_134) * 8 - 3);
  const SORT_134 msb_SORT_134 = (SORT_134)1 << (3 - 1);
  typedef unsigned char SORT_158;  // BV with 8 bits
  const SORT_158 mask_SORT_158 = (SORT_158)-1 >> (sizeof(SORT_158) * 8 - 8);
  const SORT_158 msb_SORT_158 = (SORT_158)1 << (8 - 1);
  ...
  const SORT_119 var_120 = 2;
  const SORT_119 var_127 = 3;
  const SORT_134 var_135 = 4;
  const SORT_134 var_142 = 5;
  const SORT_134 var_149 = 6;
  const SORT_134 var_185 = 7;
  ...
  for (;;) {
    ...
    SORT_12 var_104_arg_0 = state_13;
    var_104_arg_0 = var_104_arg_0 & mask_SORT_12;
    SORT_3 var_104 = var_104_arg_0;
    SORT_1 var_105_arg_0 = input_6;
    var_105_arg_0 = var_105_arg_0 & mask_SORT_1;
    ...
    SORT_3 var_110_arg_1 = input_4;
    SORT_3 var_110_arg_2 = var_103;
    SORT_3 var_110 = var_110_arg_0 ? var_110_arg_1 : var_110_arg_2;
    SORT_1 var_283_arg_0 = var_160;
    SORT_3 var_283_arg_1 = var_110;
    ...
    SORT_119 var_165_arg_0 = var_120;
    var_165_arg_0 = var_165_arg_0 & mask_SORT_119;
    ...
    SORT_119 var_121_arg_0 = var_120;
    var_121_arg_0 = var_121_arg_0 & mask_SORT_119;
    SORT_3 var_121 = var_121_arg_0;
    SORT_3 var_122_arg_0 = var_106;
    ...
    SORT_119 var_169_arg_0 = var_127;
    var_169_arg_0 = var_169_arg_0 & mask_SORT_119;
    ...
    SORT_134 var_173_arg_0 = var_135;
    var_173_arg_0 = var_173_arg_0 & mask_SORT_134;
    ...
    SORT_134 var_136_arg_0 = var_135;
    var_136_arg_0 = var_136_arg_0 & mask_SORT_134;
    SORT_3 var_136 = var_136_arg_0;
    SORT_3 var_137_arg_0 = var_106;
    ...
    SORT_1 var_133_arg_0 = input_6;
    SORT_3 var_133_arg_1 = state_95;
    SORT_3 var_133_arg_2 = var_102;
    SORT_3 var_133 = var_133_arg_0 ? var_133_arg_1 : var_133_arg_2;
    SORT_1 var_139_arg_0 = var_138;
    SORT_3 var_139_arg_1 = input_4;
    SORT_3 var_139_arg_2 = var_133;
    SORT_3 var_139 = var_139_arg_0 ? var_139_arg_1 : var_139_arg_2;
    SORT_1 var_314_arg_0 = var_176;
    SORT_3 var_314_arg_1 = var_139;
    ...
    SORT_134 var_177_arg_0 = var_142;
    var_177_arg_0 = var_177_arg_0 & mask_SORT_134;
    ...
    SORT_134 var_181_arg_0 = var_149;
    var_181_arg_0 = var_181_arg_0 & mask_SORT_134;
    ...
    SORT_134 var_186_arg_0 = var_185;
    var_186_arg_0 = var_186_arg_0 & mask_SORT_134;
