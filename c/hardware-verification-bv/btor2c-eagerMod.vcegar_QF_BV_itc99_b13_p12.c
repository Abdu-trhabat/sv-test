...
void reach_error() { __assert_fail("0", "vcegar_QF_BV_itc99_b13_p12.c", 0, "reach_error"); }
...
int main() {
  ...
  for (;;) {
    ...
    input_149 = input_149 & mask_SORT_69;
    // Assuming invariants ...
