...
int main() {
  ...
  typedef unsigned int SORT_165;  // BV with 9 bits
  ...
  SORT_8 state_161 = __VERIFIER_nondet_uint() & mask_SORT_8;
  // Initializing states ...
