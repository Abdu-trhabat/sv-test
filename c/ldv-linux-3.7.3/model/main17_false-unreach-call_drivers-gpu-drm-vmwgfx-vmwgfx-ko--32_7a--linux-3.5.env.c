...
// with type: void drm_connector_attach_property(struct drm_connector *, struct drm_property *, uint64_t )
// with return type: void
void drm_connector_attach_property(struct drm_connector *arg0, struct drm_property *arg1, uint64_t arg2) {
  // Void type
  return;
}
...
// with type: bool flush_delayed_work_sync(struct delayed_work *)
// with return type: bool 
bool __VERIFIER_nondet_bool(void);
...
// with type: int ttm_bo_create(struct ttm_bo_device *, unsigned long, enum ttm_bo_type , struct ttm_placement *, uint32_t , unsigned long, bool , struct file *, struct ttm_buffer_object **)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// with type: int ttm_bo_init(struct ttm_bo_device *, struct ttm_buffer_object *, unsigned long, enum ttm_bo_type , struct ttm_placement *, uint32_t , unsigned long, bool , struct file *, size_t , struct sg_table *, void (*)(struct ttm_buffer_object *))
// with return type: int
int __VERIFIER_nondet_int(void);
int ttm_bo_init(struct ttm_bo_device *arg0, struct ttm_buffer_object *arg1, unsigned long arg2, enum ttm_bo_type arg3, struct ttm_placement *arg4, uint32_t arg5, unsigned long arg6, bool arg7, struct file *arg8, size_t arg9, struct sg_table *arg10, void (*arg11)(struct ttm_buffer_object *)) {
  // Simple type
  return __VERIFIER_nondet_int();
}
...
// with type: int ttm_bo_validate(struct ttm_buffer_object *, struct ttm_placement *, bool , bool , bool )
// with return type: int
int __VERIFIER_nondet_int(void);
