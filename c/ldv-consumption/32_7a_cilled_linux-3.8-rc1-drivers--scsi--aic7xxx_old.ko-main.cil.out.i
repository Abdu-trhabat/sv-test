...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_7a_cilled_linux-3.8-rc1-drivers--scsi--aic7xxx_old.ko-main.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
int ldv_driver_template_probe_1() {
