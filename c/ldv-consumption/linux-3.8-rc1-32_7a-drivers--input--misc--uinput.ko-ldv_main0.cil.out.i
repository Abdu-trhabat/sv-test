...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.8-rc1-32_7a-drivers--input--misc--uinput.ko-ldv_main0.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
