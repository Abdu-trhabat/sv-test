...
// Function: ldv_nes_netdev_ops_ndo_init
// with type: int ldv_nes_netdev_ops_ndo_init()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_nes_netdev_ops_ndo_init() {
  // Simple type
  return __VERIFIER_nondet_int();
}

// Function: ldv_nes_netdev_ops_ndo_uninit
// with type: int ldv_nes_netdev_ops_ndo_uninit()
// with return type: int
int __VERIFIER_nondet_int(void);
int ldv_nes_netdev_ops_ndo_uninit() {
  // Simple type
  return __VERIFIER_nondet_int();
}
