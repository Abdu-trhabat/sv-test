...
// Function: cdrom_check_events
// with type: unsigned int cdrom_check_events(struct cdrom_device_info *, unsigned int)
...
// with type: int cdrom_ioctl(struct cdrom_device_info *, struct block_device *, fmode_t , unsigned int, unsigned long)
...
// Function: cdrom_open
// with type: int cdrom_open(struct cdrom_device_info *, struct block_device *, fmode_t )
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: cdrom_release
// with type: void cdrom_release(struct cdrom_device_info *, fmode_t )
// with return type: void
...
// Function: register_cdrom
// with type: int register_cdrom(struct cdrom_device_info *)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: unregister_cdrom
// with type: void unregister_cdrom(struct cdrom_device_info *)
// with return type: void
