...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "test-0214_1.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
int main()
{
    ...
    while (i < 3 && __VERIFIER_nondet_int()) {
        while (y < 5 && __VERIFIER_nondet_int()) {
            append_one(&list, rand_end_point());
            y++;
            length++;
            }
        while (z < 10 && __VERIFIER_nondet_int()) {
