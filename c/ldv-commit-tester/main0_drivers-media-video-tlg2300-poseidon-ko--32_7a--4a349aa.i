...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "main0_drivers-media-video-tlg2300-poseidon-ko--32_7a--4a349aa.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
extern void abort(void);
