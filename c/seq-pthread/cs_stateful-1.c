...
int main()
{
	...
	if(!(ma[0] == __CS_cp_ma[1])) {abort();}  //cseq: Consistency of ma
	if(!(mb[0] == __CS_cp_mb[1])) {abort();}  //cseq: Consistency of mb
	if(!(data1[0] == __CS_cp_data1[1])) {abort();}  //cseq: Consistency of data1
	if(!(data2[0] == __CS_cp_data2[1])) {abort();}  //cseq: Consistency of data2
