...
/*  Generated by CSeq 0.5 (-t2 -r3 -fcbmc) 2013-06-08 01:50:26  */
...
int main()
{
	...
	assume_abort_if_not(flag1[0] == __CS_cp_flag1[1]);  //cseq: Consistency of flag1
	assume_abort_if_not(flag1[1] == __CS_cp_flag1[2]);
	assume_abort_if_not(flag2[0] == __CS_cp_flag2[1]);  //cseq: Consistency of flag2
