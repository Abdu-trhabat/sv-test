...
int main(void)
{
	...
	assume_abort_if_not(stored_elements[0][0] == __CS_cp_stored_elements[1][0]);  //cseq: Consistency of stored_elements
	assume_abort_if_not(stored_elements[0][1] == __CS_cp_stored_elements[1][1]);
	assume_abort_if_not(stored_elements[0][2] == __CS_cp_stored_elements[1][2]);
	assume_abort_if_not(stored_elements[0][3] == __CS_cp_stored_elements[1][3]);
	assume_abort_if_not(stored_elements[0][4] == __CS_cp_stored_elements[1][4]);
	assume_abort_if_not(stored_elements[0][5] == __CS_cp_stored_elements[1][5]);
	assume_abort_if_not(stored_elements[0][6] == __CS_cp_stored_elements[1][6]);
	assume_abort_if_not(stored_elements[0][7] == __CS_cp_stored_elements[1][7]);
	assume_abort_if_not(stored_elements[0][8] == __CS_cp_stored_elements[1][8]);
	assume_abort_if_not(stored_elements[0][9] == __CS_cp_stored_elements[1][9]);
	assume_abort_if_not(stored_elements[0][10] == __CS_cp_stored_elements[1][10]);
	assume_abort_if_not(stored_elements[0][11] == __CS_cp_stored_elements[1][11]);
	assume_abort_if_not(stored_elements[0][12] == __CS_cp_stored_elements[1][12]);
	assume_abort_if_not(stored_elements[0][13] == __CS_cp_stored_elements[1][13]);
	assume_abort_if_not(stored_elements[0][14] == __CS_cp_stored_elements[1][14]);
	assume_abort_if_not(stored_elements[0][15] == __CS_cp_stored_elements[1][15]);
	assume_abort_if_not(stored_elements[0][16] == __CS_cp_stored_elements[1][16]);
	assume_abort_if_not(stored_elements[0][17] == __CS_cp_stored_elements[1][17]);
	assume_abort_if_not(stored_elements[0][18] == __CS_cp_stored_elements[1][18]);
	assume_abort_if_not(stored_elements[0][19] == __CS_cp_stored_elements[1][19]);
	assume_abort_if_not(enqueue_flag[0] == __CS_cp_enqueue_flag[1]);  //cseq: Consistency of enqueue_flag
	assume_abort_if_not(dequeue_flag[0] == __CS_cp_dequeue_flag[1]);  //cseq: Consistency of dequeue_flag
	assume_abort_if_not(queue[0].element[0] == __CS_cp_queue[1].element[0]);  //cseq: Consistency of queue
	assume_abort_if_not(queue[0].element[1] == __CS_cp_queue[1].element[1]);
	assume_abort_if_not(queue[0].element[2] == __CS_cp_queue[1].element[2]);
	assume_abort_if_not(queue[0].element[3] == __CS_cp_queue[1].element[3]);
	assume_abort_if_not(queue[0].element[4] == __CS_cp_queue[1].element[4]);
	assume_abort_if_not(queue[0].element[5] == __CS_cp_queue[1].element[5]);
	assume_abort_if_not(queue[0].element[6] == __CS_cp_queue[1].element[6]);
	assume_abort_if_not(queue[0].element[7] == __CS_cp_queue[1].element[7]);
	assume_abort_if_not(queue[0].element[8] == __CS_cp_queue[1].element[8]);
	assume_abort_if_not(queue[0].element[9] == __CS_cp_queue[1].element[9]);
	assume_abort_if_not(queue[0].element[10] == __CS_cp_queue[1].element[10]);
	assume_abort_if_not(queue[0].element[11] == __CS_cp_queue[1].element[11]);
	assume_abort_if_not(queue[0].element[12] == __CS_cp_queue[1].element[12]);
	assume_abort_if_not(queue[0].element[13] == __CS_cp_queue[1].element[13]);
	assume_abort_if_not(queue[0].element[14] == __CS_cp_queue[1].element[14]);
	assume_abort_if_not(queue[0].element[15] == __CS_cp_queue[1].element[15]);
	assume_abort_if_not(queue[0].element[16] == __CS_cp_queue[1].element[16]);
	assume_abort_if_not(queue[0].element[17] == __CS_cp_queue[1].element[17]);
	assume_abort_if_not(queue[0].element[18] == __CS_cp_queue[1].element[18]);
	assume_abort_if_not(queue[0].element[19] == __CS_cp_queue[1].element[19]);
	assume_abort_if_not(queue[0].head == __CS_cp_queue[1].head);
	assume_abort_if_not(queue[0].tail == __CS_cp_queue[1].tail);
	assume_abort_if_not(queue[0].amount == __CS_cp_queue[1].amount);
