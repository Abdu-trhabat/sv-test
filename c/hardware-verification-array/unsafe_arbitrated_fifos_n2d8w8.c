...
void main() {
  ...
  for (;;) {
    ...
    SORT_11 var_409 = var_409_arg_0[(unsigned int) var_409_arg_1];
    ...
    SORT_13 var_414;
    for (unsigned int i = 0; i < (1 << 3); ++i) var_414[i] = var_414_arg_0[i];
    var_414[(unsigned int) var_414_arg_1] = var_414_arg_2;
    ...
    SORT_11 var_430 = var_430_arg_0[(unsigned int) var_430_arg_1];
    ...
    SORT_13 var_435;
    for (unsigned int i = 0; i < (1 << 3); ++i) var_435[i] = var_435_arg_0[i];
    var_435[(unsigned int) var_435_arg_1] = var_435_arg_2;
    ...
    for (unsigned int i = 0; i < (1 << 3); ++i) state_14[i] = next_417_arg_1[i];
    state_26 = next_420_arg_1;
    state_31 = next_423_arg_1;
    state_45 = next_426_arg_1;
    state_48 = next_429_arg_1;
    for (unsigned int i = 0; i < (1 << 3); ++i) state_44[i] = next_438_arg_1[i];
