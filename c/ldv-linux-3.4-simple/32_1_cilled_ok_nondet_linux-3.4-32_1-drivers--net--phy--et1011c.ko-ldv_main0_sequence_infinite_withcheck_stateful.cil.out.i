...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--net--phy--et1011c.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ int ret ;
  ...
  {
  __cil_tmp8 = *((int *)((void *)phydev + 804));
  if (speed != __cil_tmp8) {
    {
    speed = *((int *)((void *)phydev + 804));
    __cil_tmp11 = (u32 )26;
