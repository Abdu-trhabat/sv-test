...
static char const   __mod_description41[45]  __attribute__((__used__, __unused__,
__section__(".modinfo"), __aligned__(1)))  = 
  {      (char const   )'d',      (char const   )'e',      (char const   )'s',      (char const   )'c', 
        (char const   )'r',      (char const   )'i',      (char const   )'p',      (char const   )'t', 
        (char const   )'i',      (char const   )'o',      (char const   )'n',      (char const   )'=', 
        (char const   )'G',      (char const   )'u',      (char const   )'n',      (char const   )'z', 
        (char const   )'e',      (char const   )' ',      (char const   )'A',      (char const   )'H', 
        (char const   )'L',      (char const   )'-',      (char const   )'5',      (char const   )'1', 
...
{ struct input_dev *dev ;
  ...
  tmp = simple_strtoul(__cil_tmp47, __cil_tmp49, 10U);
  __cil_tmp50 = (int )tmp;
  ...
  tmp___0 = simple_strtoul(__cil_tmp57, __cil_tmp59, 10U);
  __cil_tmp60 = 1024UL - tmp___0;
...
{ struct gunze *gunze ;
  ...
  *((unsigned long *)((void *)input_dev + __cil_tmp48)) = 1UL << 10;
  ...
  err = (int )input_register_device(__cil_tmp52);
  }
  if (err) {
    goto fail3;
  } else {
...
static struct serio_device_id gunze_serio_ids[2]  = {      {(__u8 )2, (__u8 )255, (__u8 )255, (__u8 )28}, 
...
static int gunze_init(void)  __attribute__((__section__(".init.text"), __no_instrument_function__)) ;
static int gunze_init(void) 
{ int tmp ;

  {
  {
  tmp = (int )__serio_register_driver(& gunze_drv, & __this_module, "gunze");
  }
  return (tmp);
}
}
static void gunze_exit(void)  __attribute__((__section__(".exit.text"), __no_instrument_function__)) ;
...
static int res_gunze_connect_3  ;
void main(void) 
{ struct serio *var_group1 ;
  ...
  while (1) {
    ...
    if (tmp___1) {
      ...
      {
      __cil_tmp9 = ldv_s_gunze_drv_serio_driver == 0;
      if (! __cil_tmp9) {
    ...
    if (tmp___0 == 2) {
      ...
      if (0) {
        ...
        case_2: /* CIL Label */ 
        {
        gunze_interrupt(var_group1, var_gunze_interrupt_1_p1, var_gunze_interrupt_1_p2);
        }
        goto switch_break;
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--input--touchscreen--gunze.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
