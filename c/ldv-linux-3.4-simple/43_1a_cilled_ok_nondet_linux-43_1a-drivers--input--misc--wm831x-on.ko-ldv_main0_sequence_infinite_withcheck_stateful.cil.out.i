...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--input--misc--wm831x-on.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct wm831x_on *wm831x_on ;
  ...
  if (ret >= 0) {
    ...
    __cil_tmp10 = ret & 8;
    poll = __cil_tmp10 == 0;
    __cil_tmp11 = *((struct input_dev **)wm831x_on);
    input_report_key(__cil_tmp11, 116U, poll);
    __cil_tmp12 = *((struct input_dev **)wm831x_on);
...
{ struct wm831x *wm831x ;
  ...
  wm831x_on = (struct wm831x_on *)tmp___1;
  }
  {
  __cil_tmp18 = (struct wm831x_on *)0;
  ...
  *((struct input_dev **)wm831x_on) = input_allocate_device();
  ...
  {
  __cil_tmp50 = (struct input_dev *)0;
  __cil_tmp51 = (unsigned long )__cil_tmp50;
  __cil_tmp52 = *((struct input_dev **)wm831x_on);
  ...
  *((struct device **)((void *)__cil_tmp72 + 840)) = (struct device *)((void *)pdev + 16);
  ...
  ret = request_threaded_irq(__cil_tmp77, __cil_tmp78, & wm831x_on_irq, 1UL, "wm831x_on",
                             __cil_tmp79);
  }
  if (ret < 0) {
    {
  ...
  {
  __cil_tmp84 = *((struct input_dev **)wm831x_on);
  ret = input_register_device(__cil_tmp84);
  }
  if (ret != 0) {
    {
  ...
  {
  __cil_tmp99 = (void *)wm831x_on;
  platform_set_drvdata(pdev, __cil_tmp99);
  }
  return (0);
  err_irq:
  {
  __cil_tmp100 = (unsigned int )irq;
  __cil_tmp101 = (void *)wm831x_on;
  free_irq(__cil_tmp100, __cil_tmp101);
  }
  err_input_dev:
  {
  __cil_tmp102 = *((struct input_dev **)wm831x_on);
  input_free_device(__cil_tmp102);
  }
  err:
  {
  __cil_tmp103 = (void const *)wm831x_on;
  kfree(__cil_tmp103);
  }
  return (ret);
}
...
{ struct platform_device *var_group1 ;
  int res_wm831x_on_probe_2 ;
  int var_wm831x_on_irq_1_p0 ;
  void *var_wm831x_on_irq_1_p1 ;
  int ldv_s_wm831x_on_driver_platform_driver ;
  int tmp ;
  int tmp___0 ;
  {
  {
  ldv_s_wm831x_on_driver_platform_driver = 0;
  LDV_IN_INTERRUPT = 1;
  ldv_initialize();
  }
  goto ldv_21099;
  ...
  if (tmp == 1) {
    ...
    if (0) {
      case_0: ;
      if (ldv_s_wm831x_on_driver_platform_driver == 0) {
        {
        res_wm831x_on_probe_2 = wm831x_on_probe(var_group1);
        ldv_check_return_value(res_wm831x_on_probe_2);
        }
        if (res_wm831x_on_probe_2 != 0) {
      ...
      {
      LDV_IN_INTERRUPT = 2;
      wm831x_on_irq(var_wm831x_on_irq_1_p0, var_wm831x_on_irq_1_p1);
      LDV_IN_INTERRUPT = 1;
      }
      goto ldv_21095;
      switch_default: ;
