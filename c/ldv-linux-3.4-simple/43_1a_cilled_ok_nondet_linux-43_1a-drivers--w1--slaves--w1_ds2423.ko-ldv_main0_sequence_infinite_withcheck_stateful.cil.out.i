...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--w1--slaves--w1_ds2423.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct w1_slave *sl ;
  ...
  *((u8 *)__cil_tmp33) = (u8 )__cil_tmp34;
  __cil_tmp37 = (struct mutex *)((void *)dev + 144);
  ...
  if (tmp___9 == 0) {
    ...
    if (__cil_tmp56 != read_byte_count) {
      ...
      if (p == 0) {
        ...
        __cil_tmp75 = __cil_tmp74 + ((void *)__cil_tmp71 + 11UL);
  ...
  {
  __cil_tmp99 = (struct mutex *)((void *)dev + 144);
