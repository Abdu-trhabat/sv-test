...
__inline static void gameport_set_name(struct gameport *gameport , char const   *name ) 
{
  ...
  {
  {
  __cil_tmp5 = (char (*)[32U])((void *)gameport + 8);
...
{ struct l4 *l4 ;
  ...
  {
  __cil_tmp27 = *((unsigned char *)((void *)l4 + 8));
...
{ int i ;
  ...
  *((int *)__cil_tmp48) = t;
  ...
  ldv_15127: 
  {
  __cil_tmp51 = *((unsigned char *)((void *)l4 + 8));
...
{ int cal[4U] ;
  ...
  *((int *)__cil_tmp22) = 255;
  ...
  if (rev > 40) {
    {
    __cil_tmp39 = *((unsigned char *)((void *)l4 + 8));
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--input--gameport--lightning.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
