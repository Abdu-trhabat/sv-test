...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--rtc--rtc-max6902.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ int err ;
  ...
  *((int *)((void *)dt + 20)) = (int )tmp___6;
  ...
  __cil_tmp80 = *((int *)((void *)dt + 20));
  *((int *)((void *)dt + 20)) = __cil_tmp80 + century;
  __cil_tmp85 = *((int *)((void *)dt + 20));
  *((int *)((void *)dt + 20)) = __cil_tmp85 + -1900;
