...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--net--wireless--orinoco--orinoco_tmd.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ int err ;
  ...
  {
  __cil_tmp8 = (int )16UL;
  __cil_tmp11 = (struct device *)((void *)pdev + 144);
  __cil_tmp12 = (void *)0;
  ...
  *((void **)card) = bridge_io;
  __cil_tmp17 = (struct hermes *)((void *)priv + 1080);
  hermes_struct_init(__cil_tmp17, hermes_io, 0);
  __cil_tmp20 = *((unsigned int *)((void *)pdev + 916));
  ...
  if (err) {
    {
    __cil_tmp24 = *((unsigned int *)((void *)pdev + 916));
