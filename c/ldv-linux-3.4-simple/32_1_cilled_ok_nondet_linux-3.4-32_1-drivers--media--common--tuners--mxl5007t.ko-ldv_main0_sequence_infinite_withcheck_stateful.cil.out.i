...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--media--common--tuners--mxl5007t.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct mxl5007t_config *cfg ;
  ...
  if (__len___0 >= 64UL) {
    ...
    __ret___0 = memcpy(__cil_tmp28, __cil_tmp29, __len___0);
    }
  }
  {
  __cil_tmp30 = *((s32 *)cfg);
...
{ struct mxl5007t_state *state ;
  ...
  *((void **)__cil_tmp132) = (void *)state;
  ...
  if (__len >= 64UL) {
    ...
    __ret___1 = memcpy(__cil_tmp143, __cil_tmp144, __len);
    }
  }
  return (fe);
  fail:
