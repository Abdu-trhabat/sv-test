...
struct __anonstruct_sw_221 {
   u8 code ;
   u8 value ;
};
union __anonunion____missing_field_name_220 {
   u16 keycode ;
   struct __anonstruct_sw_221 sw ;
};
struct key_entry {
   int type ;
   u32 code ;
...
struct __anonstruct_integer_251 {
   acpi_object_type type ;
   u64 value ;
};
struct __anonstruct_string_252 {
   acpi_object_type type ;
   u32 length ;
   char *pointer ;
};
...
struct __anonstruct_package_254 {
   acpi_object_type type ;
   u32 count ;
   union acpi_object *elements ;
};
struct __anonstruct_reference_255 {
   acpi_object_type type ;
   acpi_object_type actual_type ;
   acpi_handle handle ;
};
struct __anonstruct_processor_256 {
   acpi_object_type type ;
   u32 proc_id ;
   acpi_io_address pblk_address ;
   u32 pblk_length ;
};
struct __anonstruct_power_resource_257 {
   acpi_object_type type ;
   u32 system_level ;
   u32 resource_order ;
};
union acpi_object {
   acpi_object_type type ;
   struct __anonstruct_integer_251 integer ;
   struct __anonstruct_string_252 string ;
   struct __anonstruct_buffer_253 buffer ;
   struct __anonstruct_package_254 package ;
   struct __anonstruct_reference_255 reference ;
   struct __anonstruct_processor_256 processor ;
   struct __anonstruct_power_resource_257 power_resource ;
};
struct acpi_buffer {
   acpi_size length ;
   void *pointer ;
...
extern acpi_status wmi_install_notify_handler(char const   *guid , void (*handler)(u32 value ,
                                                                                   void *context ) ,
                                              void *data ) ;
extern acpi_status wmi_remove_notify_handler(char const   *guid ) ;
extern acpi_status wmi_get_event_data(u32 event , struct acpi_buffer *out ) ;
extern bool wmi_has_guid(char const   *guid ) ;
static char const   __mod_description32[58]  __attribute__((__used__, __unused__,
__section__(".modinfo"), __aligned__(1)))  = 
  {      (char const   )'d',      (char const   )'e',      (char const   )'s',      (char const   )'c', 
        (char const   )'r',      (char const   )'i',      (char const   )'p',      (char const   )'t', 
        (char const   )'i',      (char const   )'o',      (char const   )'n',      (char const   )'=', 
        (char const   )'W',      (char const   )'M',      (char const   )'I',      (char const   )' ', 
        (char const   )'h',      (char const   )'o',      (char const   )'t',      (char const   )'k', 
        (char const   )'e',      (char const   )'y',      (char const   )'s',      (char const   )' ', 
        ...
        (char const   )'I',      (char const   )'n',      (char const   )'-',      (char const   )'O', 
...
static char const   *dell_wmi_aio_guids[3]  = {      "284A0E6B-380E-472A-921F-E52786257FB4",      "02314822-307C-4F66-BF0E-48AEAEB26CC8",      (char const   *)((void *)0)};
static char const   __mod_alias44[47]  __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1)))  = 
  {      (char const   )'a',      (char const   )'l',      (char const   )'i',      (char const   )'a', 
        (char const   )'s',      (char const   )'=',      (char const   )'w',      (char const   )'m', 
        (char const   )'i',      (char const   )':',      (char const   )'2',      (char const   )'8', 
        (char const   )'4',      (char const   )'A',      (char const   )'0',      (char const   )'E', 
        (char const   )'6',      (char const   )'B',      (char const   )'-',      (char const   )'3', 
        (char const   )'8',      (char const   )'0',      (char const   )'E',      (char const   )'-', 
        (char const   )'4',      (char const   )'7',      (char const   )'2',      (char const   )'A', 
        (char const   )'-',      (char const   )'9',      (char const   )'2',      (char const   )'1', 
        (char const   )'F',      (char const   )'-',      (char const   )'E',      (char const   )'5', 
        (char const   )'2',      (char const   )'7',      (char const   )'8',      (char const   )'6', 
        (char const   )'2',      (char const   )'5',      (char const   )'7',      (char const   )'F', 
        (char const   )'B',      (char const   )'4',      (char const   )'\000'};
static char const   __mod_alias45[47]  __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1)))  = 
  {      (char const   )'a',      (char const   )'l',      (char const   )'i',      (char const   )'a', 
        (char const   )'s',      (char const   )'=',      (char const   )'w',      (char const   )'m', 
        (char const   )'i',      (char const   )':',      (char const   )'0',      (char const   )'2', 
        (char const   )'3',      (char const   )'1',      (char const   )'4',      (char const   )'8', 
        (char const   )'2',      (char const   )'2',      (char const   )'-',      (char const   )'3', 
        (char const   )'0',      (char const   )'7',      (char const   )'C',      (char const   )'-', 
        (char const   )'4',      (char const   )'F',      (char const   )'6',      (char const   )'6', 
        (char const   )'-',      (char const   )'B',      (char const   )'F',      (char const   )'0', 
        (char const   )'E',      (char const   )'-',      (char const   )'4',      (char const   )'8', 
        (char const   )'A',      (char const   )'E',      (char const   )'A',      (char const   )'E', 
        (char const   )'B',      (char const   )'2',      (char const   )'6',      (char const   )'C', 
        (char const   )'C',      (char const   )'8',      (char const   )'\000'};
static struct key_entry  const  dell_wmi_aio_keymap[3]  = {      {1, (u32 )192, {(u16 )115}}, 
        {1, (u32 )193, {(u16 )114}}, 
...
{ struct acpi_buffer response ;
  ...
  {
  __cil_tmp7 = & response;
  *((acpi_size *)__cil_tmp7) = (acpi_size )-1;
  *((void **)((void *)(&response) + 8)) = (void *)0;
  ...
  if (obj) {
    {
    __cil_tmp11 = *((acpi_object_type *)obj);
    ...
    if (0) {
      ...
      {
      __cil_tmp12 = 0 + 8;
      __cil_tmp15 = *((u64 *)((void *)obj + __cil_tmp12));
      scancode = (unsigned int )__cil_tmp15;
      __cil_tmp16 = (bool )1;
      sparse_keymap_report_event(dell_wmi_aio_input_dev, scancode, 1U, __cil_tmp16);
      }
      goto switch_break;
      case_3: /* CIL Label */ 
      {
      __cil_tmp17 = 0 + 8;
      if (*((u8 **)((void *)obj + __cil_tmp17))) {
        {
        __cil_tmp20 = 0 + 4;
        __cil_tmp23 = *((u32 *)((void *)obj + __cil_tmp20));
        if (__cil_tmp23 > 0U) {
          {
          __cil_tmp24 = 0 + 8;
          __cil_tmp27 = *((u8 **)((void *)obj + __cil_tmp24));
          __cil_tmp28 = __cil_tmp27 + 0;
          __cil_tmp29 = *__cil_tmp28;
          scancode = (unsigned int )__cil_tmp29;
          __cil_tmp30 = (bool )1;
          sparse_keymap_report_event(dell_wmi_aio_input_dev, scancode, 1U, __cil_tmp30);
          }
        } else {
...
static int dell_wmi_aio_input_setup(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
static int dell_wmi_aio_input_setup(void) 
{ int err ;
  unsigned long __cil_tmp6 ;
  unsigned long __cil_tmp7 ;
  struct key_entry  const  *__cil_tmp8 ;
  void *__cil_tmp9 ;
  ...
  *((__u16 *)((void *)dell_wmi_aio_input_dev + 24)) = (__u16 )25;
  __cil_tmp6 = 0 * 12UL;
  __cil_tmp7 = (unsigned long )(dell_wmi_aio_keymap) + __cil_tmp6;
  __cil_tmp8 = (struct key_entry  const  *)__cil_tmp7;
  __cil_tmp9 = (void *)0;
  __cil_tmp10 = (int (*)(struct input_dev * , struct key_entry * ))__cil_tmp9;
  err = sparse_keymap_setup(dell_wmi_aio_input_dev, __cil_tmp8, __cil_tmp10);
  }
  if (err) {
    {
  ...
  {
  err = (int )input_register_device(dell_wmi_aio_input_dev);
  }
  if (err) {
    {
...
{ int i ;
  ...
  while (1) {
    ...
    __cil_tmp5 = i * 8UL;
    __cil_tmp6 = (unsigned long )(dell_wmi_aio_guids) + __cil_tmp5;
    ...
    {
    __cil_tmp9 = i * 8UL;
    __cil_tmp10 = (unsigned long )(dell_wmi_aio_guids) + __cil_tmp9;
    __cil_tmp11 = *((char const   **)__cil_tmp10);
    tmp___7 = wmi_has_guid(__cil_tmp11);
    }
    if (tmp___7) {
      {
      __cil_tmp12 = i * 8UL;
      __cil_tmp13 = (unsigned long )(dell_wmi_aio_guids) + __cil_tmp12;
  ...
  {
  __cil_tmp14 = (void *)0;
  return ((char const   *)__cil_tmp14);
  }
}
}
static int dell_wmi_aio_init(void)  __attribute__((__section__(".init.text"), __no_instrument_function__)) ;
...
{ int err ;
  ...
  {
  __cil_tmp4 = (void *)0;
  tmp___7 = wmi_install_notify_handler(guid, & dell_wmi_aio_notify, __cil_tmp4);
  err = (int )tmp___7;
  }
  if (err) {
    {
...
static void dell_wmi_aio_exit(void)  __attribute__((__section__(".exit.text"), __no_instrument_function__)) ;
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3_true-termination.4-32_1-drivers--platform--x86--dell-wmi-aio.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
