...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--ata--pata_marvell.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ int i ;
  ...
  while (1) {
    ...
    {
    __cil_tmp13 = barp + i;
    tmp___7 = ioread8(__cil_tmp13);
    printk("%02X:%02X ", i, tmp___7);
    i = i + 1;
    }
  }
  while_break: ;
...
{ struct ata_port *ap ;
  ...
  __cil_tmp10 = *((struct ata_host **)((void *)ap + 12632));
  __cil_tmp13 = *((struct device **)((void *)__cil_tmp10 + 24));
  __mptr = (struct device const *)__cil_tmp13;
  __cil_tmp14 = (struct pci_dev *)0;
  __cil_tmp17 = (struct device *)((void *)__cil_tmp14 + 144);
  __cil_tmp18 = (unsigned int )__cil_tmp17;
  __cil_tmp19 = (char *)__mptr;
  __cil_tmp20 = __cil_tmp19 - __cil_tmp18;
  pdev = (struct pci_dev *)__cil_tmp20;
  {
  __cil_tmp23 = *((unsigned short *)((void *)pdev + 62));
  __cil_tmp24 = (int )__cil_tmp23;
  if (__cil_tmp24 == 24901) {
    {
    __cil_tmp27 = *((unsigned int *)((void *)ap + 40));
    if (__cil_tmp27 == 0U) {
      {
      tmp___7 = marvell_pata_active(pdev);
      }
      if (tmp___7) {
      } else {
        return (-2);
  ...
  {
  tmp___8 = ata_sff_prereset(link, deadline);
  }
  return (tmp___8);
}
}
...
{ unsigned int tmp___7 ;
  ...
  while (1) {
    ...
    __asm__ volatile ("1:\tud2\n"
                         ...
                         "\t.word %c1, 0\n"
                         "\t.org 2b+%c2\n"
                         ".popsection": : "i" ("/home/zakharov/launch/work/current--X--drivers/--X--defaultlinux-3.4--X--32_1--X--cpachecker/linux-3.4/csd_deg_dscv/12721/dscv_tempdir/dscv/ri/32_1/drivers/ata/pata_marvell.c.common.c"),
                         "i" (94), "i" (12UL));
    {
    while (1) {
      while_continue___0: ;
...
static struct scsi_host_template marvell_sht =
    ...
    (int (*)(struct Scsi_Host *shost , int reset_type ))0, "pata_marvell", (struct proc_dir_entry *)0,
...
static struct ata_port_operations marvell_ops =
    ...
    (bool (*)(struct ata_queued_cmd *qc ))0, & marvell_cable_detect, (unsigned long (*)(struct ata_device *dev ,
    ...
    & marvell_pre_reset, (int (*)(struct ata_link *link , unsigned int *classes ,
                                  unsigned long deadline ))0, (int (*)(struct ata_link *link ,
...
static struct ata_port_info const info = {1UL, 0UL, 31UL, 7UL, 63UL, & marvell_ops, (void *)0};
static int marvell_init_one(struct pci_dev *pdev , struct pci_device_id const *id ) ;
static struct ata_port_info const info_sata = {1UL, 0UL, 31UL, 7UL, 127UL, & marvell_ops, (void *)0};
static int marvell_init_one(struct pci_dev *pdev , struct pci_device_id const *id )
{ struct ata_port_info const *ppi[2] ;
  ...
  struct ata_port_info const **__cil_tmp18 ;
  struct ata_port_info const * const *__cil_tmp19 ;
  void *__cil_tmp20 ;
  {
  __cil_tmp6 = 0 * 8UL;
  __cil_tmp7 = (unsigned long )(ppi) + __cil_tmp6;
  *((struct ata_port_info const **)__cil_tmp7) = & info;
  __cil_tmp8 = 1 * 8UL;
  __cil_tmp9 = (unsigned long )(ppi) + __cil_tmp8;
  *((struct ata_port_info const **)__cil_tmp9) = & info_sata;
  {
  __cil_tmp12 = *((unsigned short *)((void *)pdev + 62));
  __cil_tmp13 = (int )__cil_tmp12;
  if (__cil_tmp13 == 24833) {
    __cil_tmp14 = 1 * 8UL;
    __cil_tmp15 = (unsigned long )(ppi) + __cil_tmp14;
    *((struct ata_port_info const **)__cil_tmp15) = & ata_dummy_port_info;
  } else {
  }
  }
  {
  ...
  __cil_tmp18 = (struct ata_port_info const **)__cil_tmp17;
  __cil_tmp19 = (struct ata_port_info const * const *)__cil_tmp18;
  __cil_tmp20 = (void *)0;
  tmp___8 = ata_pci_bmdma_init_one(pdev, __cil_tmp19, & marvell_sht, __cil_tmp20,
                                   0);
  }
  return (tmp___8);
}
}
static struct pci_device_id const marvell_pci_tbl[6] = { {(__u32 )4523, (__u32 )24833, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL},
        {(__u32 )4523, (__u32 )24865, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL},
        {(__u32 )4523, (__u32 )24867, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL},
        {(__u32 )4523, (__u32 )24901, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL},
        {(__u32 )6987, (__u32 )37280, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL},
        {(__u32 )6987, (__u32 )37284, (__u32 )(~ 0), (__u32 )(~ 0), 0U, 0U, 0UL}};
static struct pci_driver marvell_pci_driver =
     {{(struct list_head *)0, (struct list_head *)0}, "pata_marvell", marvell_pci_tbl,
    & marvell_init_one, & ata_pci_remove_one, & ata_pci_device_suspend, (int (*)(struct pci_dev *dev ,
...
{ int tmp___7 ;
  {
  {
  tmp___7 = (int )__pci_register_driver(& marvell_pci_driver, & __this_module, "pata_marvell");
  }
  return (tmp___7);
}
}
...
static char const __mod_author195[16] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
...
static char const __mod_description196[65] __attribute__((__used__, __unused__,
__section__(".modinfo"), __aligned__(1))) =
  { (char const )'d', (char const )'e', (char const )'s', (char const )'c',
        ...
        (char const )'l', (char const )' ', (char const )'A', (char const )'T',
        (char const )'A', (char const )' ', (char const )'i', (char const )'n',
        (char const )' ', (char const )'l', (char const )'e', (char const )'g',
        (char const )'a', (char const )'c', (char const )'y', (char const )' ',
        (char const )'m', (char const )'o', (char const )'d', (char const )'e',
        (char const )'\000'};
static char const __mod_license197[12] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
  { (char const )'l', (char const )'i', (char const )'c', (char const )'e',
        (char const )'n', (char const )'s', (char const )'e', (char const )'=',
        (char const )'G', (char const )'P', (char const )'L', (char const )'\000'};
extern struct pci_device_id const __mod_pci_device_table __attribute__((__unused__,
__alias__("marvell_pci_tbl"))) ;
static char const __mod_version199[14] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
...
static int res_marvell_init_one_3 ;
void main(void)
{ struct ata_port *var_group1 ;
  ...
  while (1) {
    ...
    if (tmp___9) {
      ...
      {
      __cil_tmp10 = ldv_s_marvell_pci_driver_pci_driver == 0;
      if (! __cil_tmp10) {
      } else {
        goto while_break;
      }
