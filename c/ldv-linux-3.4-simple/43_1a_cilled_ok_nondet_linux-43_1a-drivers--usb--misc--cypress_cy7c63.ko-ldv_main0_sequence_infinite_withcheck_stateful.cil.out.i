...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--usb--misc--cypress_cy7c63.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ int retval ;
  ...
  iobuf = (unsigned char *)tmp;
  }
  {
  __cil_tmp16 = (unsigned char *)0;
  __cil_tmp17 = (unsigned long )__cil_tmp16;
  __cil_tmp18 = (unsigned long )iobuf;
  ...
  *((unsigned char *)__cil_tmp29) = (unsigned char)1;
  ...
  {
  __cil_tmp40 = *((struct usb_device **)dev);
  tmp___1 = __create_pipe(__cil_tmp40, 0U);
  pipe = tmp___1 | 2147483776U;
  __cil_tmp41 = *((struct usb_device **)dev);
  __cil_tmp42 = (int )request;
  __cil_tmp43 = (__u8 )__cil_tmp42;
  __cil_tmp44 = (__u8 )195;
  __cil_tmp45 = (int )address;
  __cil_tmp46 = (__u16 )__cil_tmp45;
  __cil_tmp47 = (int )data;
  __cil_tmp48 = (__u16 )__cil_tmp47;
  __cil_tmp49 = (void *)iobuf;
  __cil_tmp50 = (__u16 )8;
  retval = usb_control_msg(__cil_tmp41, pipe, __cil_tmp43, __cil_tmp44, __cil_tmp46,
                           __cil_tmp48, __cil_tmp49, __cil_tmp50, 5000);
  }
  if ((int )request == 4) {
    goto case_4;
  } else
  if (0) {
    case_4: ;
    {
    __cil_tmp51 = (unsigned int )address;
    if (__cil_tmp51 == 0U) {
      {
      __cil_tmp52 = 0 * 1UL;
      ...
      *((unsigned char *)__cil_tmp62) = (unsigned char)1;
      ...
      {
      __cil_tmp78 = (unsigned int )address;
      if (__cil_tmp78 == 2U) {
        {
        __cil_tmp79 = 1 * 1UL;
...
{ int value ;
  ...
  *__cil_tmp19 = -1;
  ...
  __cil_tmp20 = (struct usb_interface *)__mptr;
  intf = __cil_tmp20 + 0xffffffffffffffd0UL;
...
{ ssize_t tmp ;
  {
  {
  tmp = write_port(dev, attr, buf, count, 0, 0);
  }
  return (tmp);
}
}
...
{ ssize_t tmp ;
  {
  {
  tmp = write_port(dev, attr, buf, count, 1, 1);
  }
  return (tmp);
}
}
...
{ int result ;
  ...
  result = 0;
  __mptr = (struct device const *)dev;
  __cil_tmp16 = (struct usb_interface *)__mptr;
  intf = __cil_tmp16 + 0xffffffffffffffd0UL;
  tmp = usb_get_intfdata(intf);
  cyp = (struct cypress *)tmp;
...
{ ssize_t tmp ;
  {
  {
  tmp = read_port(dev, attr, buf, 0, 0);
  }
  return (tmp);
}
}
...
{ ssize_t tmp ;
  {
  {
  tmp = read_port(dev, attr, buf, 1, 2);
  }
  return (tmp);
}
}
static struct device_attribute dev_attr_port0 = {{"port0", (umode_t )420U, (struct lock_class_key *)0, {{{(char)0}, {(char)0},
                                                            {(char)0}, {(char)0},
                                                            {(char)0}, {(char)0},
                                                            {(char)0}, {(char)0}}}},
    & get_port0_handler, & set_port0_handler};
static struct device_attribute dev_attr_port1 = {{"port1", (umode_t )420U, (struct lock_class_key *)0, {{{(char)0}, {(char)0},
                                                            {(char)0}, {(char)0},
                                                            {(char)0}, {(char)0},
                                                            {(char)0}, {(char)0}}}},
...
{ struct cypress *dev ;
  ...
  {
  {
  dev = (struct cypress *)0;
  retval = -12;
  tmp = kzalloc(16UL, 208U);
  dev = (struct cypress *)tmp;
  }
  {
  __cil_tmp7 = (struct cypress *)0;
  ...
  *((struct usb_device **)dev) = usb_get_dev(tmp___0);
  ...
  __cil_tmp35 = (void *)0;
  usb_set_intfdata(interface, __cil_tmp35);
  __cil_tmp36 = *((struct usb_device **)dev);
  usb_put_dev(__cil_tmp36);
  __cil_tmp37 = (void const *)dev;
  kfree(__cil_tmp37);
  }
  error_mem: ;
  return (retval);
