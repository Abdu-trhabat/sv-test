...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--staging--vme--boards--vme_vmivme7805.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ int retval ;
  ...
  if (retval != 0) {
    {
    __cil_tmp14 = (struct device *)((void *)pdev + 144);
  ...
  if (__cil_tmp23 == __cil_tmp22) {
    {
    __cil_tmp26 = (struct device *)((void *)pdev + 144);
