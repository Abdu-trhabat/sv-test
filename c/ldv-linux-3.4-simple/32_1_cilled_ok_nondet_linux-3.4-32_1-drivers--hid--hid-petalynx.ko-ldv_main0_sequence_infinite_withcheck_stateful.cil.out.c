...
{ unsigned int __cil_tmp4 ;
  ...
  if (__cil_tmp4 >= 60U) {
    ...
    if (__cil_tmp7 == 42) {
      ...
      if (__cil_tmp10 == 245) {
        {
        __cil_tmp11 = rdesc + 41;
        __cil_tmp12 = *__cil_tmp11;
        __cil_tmp13 = (int )__cil_tmp12;
        if (__cil_tmp13 == 0) {
          {
          __cil_tmp14 = rdesc + 59;
          __cil_tmp15 = *__cil_tmp14;
          __cil_tmp16 = (int )__cil_tmp15;
          if (__cil_tmp16 == 38) {
            {
            __cil_tmp17 = rdesc + 60;
            __cil_tmp18 = *__cil_tmp17;
            __cil_tmp19 = (int )__cil_tmp18;
            if (__cil_tmp19 == 249) {
              {
              __cil_tmp20 = rdesc + 61;
              ...
              if (__cil_tmp22 == 0) {
                ...
                __cil_tmp27 = rdesc + 60;
                *__cil_tmp27 = (__u8 )250;
                __cil_tmp28 = rdesc + 40;
                *__cil_tmp28 = (__u8 )250;
                }
              } else {
...
{ int ret ;
  ...
  {
  {
  __cil_tmp8 = *((unsigned int *)((void *)hdev + 7120));
  *((unsigned int *)((void *)hdev + 7120)) = __cil_tmp8 | 8U;
  ret = (int )hid_parse(hdev);
  }
  if (ret) {
    {
    __cil_tmp11 = (struct device *)((void *)hdev + 6328);
  ...
  if (ret) {
    {
    __cil_tmp15 = (struct device *)((void *)hdev + 6328);
...
static struct hid_device_id  const  pl_devices[1]  = {      {(__u16 )3, (unsigned short)0, (__u32 )6321, (__u32 )55, 0UL}};
extern struct hid_device_id  const  __mod_hid_device_table  __attribute__((__unused__,
__alias__("pl_devices"))) ;
static struct hid_driver pl_driver  = 
     {(char *)"petalynx", pl_devices, {(struct list_head *)0, (struct list_head *)0},
    {{{{{0U}}, 0U, 0U, (void *)0}}}, & pl_probe, (void (*)(struct hid_device *dev ))0,
    ...
    (int (*)(struct hid_device *hdev , struct hid_field *field , struct hid_usage *usage ,
             __s32 value ))0, & pl_report_fixup, & pl_input_mapping, (int (*)(struct hid_device *hdev ,
                                                                              struct hid_input *hidinput ,
...
static int pl_init(void)  __attribute__((__section__(".init.text"), __no_instrument_function__)) ;
static int pl_init(void) 
{ int tmp ;

  {
  {
  tmp = (int )__hid_register_driver(& pl_driver, & __this_module, "hid_petalynx");
  }
  return (tmp);
}
}
static void pl_exit(void)  __attribute__((__section__(".exit.text"), __no_instrument_function__)) ;
...
{ struct hid_device *var_group1 ;
  ...
  while (1) {
    ...
    if (tmp___1) {
      ...
      {
      __cil_tmp14 = ldv_s_pl_driver_hid_driver == 0;
      if (! __cil_tmp14) {
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--hid--hid-petalynx.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
