...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--input--misc--ab8500-ponkey.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct ab8500 *ab8500 ;
  ...
  *((struct device **)((void *)input + 840)) = (struct device *)((void *)pdev + 16);
  ...
  __cil_tmp40 = *((int *)((void *)ponkey + 16));
  ...
  if (error < 0) {
    ...
    __cil_tmp47 = *((int *)((void *)ponkey + 16));
  ...
  {
  __cil_tmp50 = *((int *)((void *)ponkey + 20));
  ...
  if (error < 0) {
    ...
    __cil_tmp57 = *((int *)((void *)ponkey + 20));
  ...
  err_free_dbr_irq:
  {
  __cil_tmp64 = *((int *)((void *)ponkey + 20));
  ...
  err_free_dbf_irq:
  {
  __cil_tmp69 = *((int *)((void *)ponkey + 16));
