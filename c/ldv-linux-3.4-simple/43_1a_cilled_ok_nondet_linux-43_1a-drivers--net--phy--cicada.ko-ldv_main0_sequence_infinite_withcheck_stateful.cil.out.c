...
{ int err ;
  ...
  {
  __cil_tmp4 = (u16 )0;
  err = phy_write(phydev, 23U, __cil_tmp4);
  }
  return (err);
}
}
...
{ int err ;
  ...
  if (__cil_tmp5 == 2147483648U) {
    {
    __cil_tmp6 = (u16 )61440;
    err = phy_write(phydev, 25U, __cil_tmp6);
    }
  } else {
    {
    __cil_tmp7 = (u16 )0;
    err = phy_write(phydev, 25U, __cil_tmp7);
    }
  }
  }
  return (err);
...
static struct phy_driver cis8201_driver  = 
     {1033232U, (char *)"Cicada Cis8201", 1048560U, 767U, 1U, & cis820x_config_init,
    (int (*)(struct phy_device * ))0, (int (*)(struct phy_device * ))0, (int (*)(struct phy_device * ))0,
    & genphy_config_aneg, & genphy_read_status, & cis820x_ack_interrupt, & cis820x_config_intr,
...
static struct phy_driver cis8204_driver  = 
     {1033280U, (char *)"Cicada Cis8204", 1048512U, 767U, 1U, & cis820x_config_init,
    (int (*)(struct phy_device * ))0, (int (*)(struct phy_device * ))0, (int (*)(struct phy_device * ))0,
    & genphy_config_aneg, & genphy_read_status, & cis820x_ack_interrupt, & cis820x_config_intr,
    (int (*)(struct phy_device * ))0, (void (*)(struct phy_device * ))0, (int (*)(struct phy_device * ,
                                                                                  struct ifreq * ))0,
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--net--phy--cicada.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
