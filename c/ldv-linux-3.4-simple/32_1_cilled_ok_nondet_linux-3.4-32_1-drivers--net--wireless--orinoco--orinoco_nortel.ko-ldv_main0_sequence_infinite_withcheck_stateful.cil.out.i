...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--net--wireless--orinoco--orinoco_nortel.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ int err ;
  ...
  *((void **)((void *)card + 8)) = attr_io;
  __cil_tmp20 = (struct hermes *)((void *)priv + 1080);
  ...
  if (err) {
    {
    __cil_tmp27 = *((unsigned int *)((void *)pdev + 916));
  ...
  fail:
  {
  __cil_tmp33 = *((unsigned int *)((void *)pdev + 916));
