...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--md--dm-zero.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
struct __anonstruct_seccomp_t_183 {
   int mode ;
};
typedef struct __anonstruct_seccomp_t_183 seccomp_t;
struct plist_head {
...
struct dm_table;
struct bio_vec;
enum __anonenum_status_type_t_260 {
    STATUSTYPE_INFO = 0,
    STATUSTYPE_TABLE = 1
} ;
typedef enum __anonenum_status_type_t_260 status_type_t;
union map_info {
   void *ptr ;
...
struct target_type {
   ...
   int (*ctr)(struct dm_target *target , unsigned int argc , char **argv ) ;
   void (*dtr)(struct dm_target *ti ) ;
   int (*map)(struct dm_target *ti , struct bio *bio , union map_info *map_context ) ;
   int (*map_rq)(struct dm_target *ti , struct request *clone , union map_info *map_context ) ;
   int (*end_io)(struct dm_target *ti , struct bio *bio , int error , union map_info *map_context ) ;
   int (*rq_end_io)(struct dm_target *ti , struct request *clone , int error , union map_info *map_context ) ;
   void (*flush)(struct dm_target *ti ) ;
   ...
   int (*status)(struct dm_target *ti , status_type_t status_type , char *result ,
                 unsigned int maxlen ) ;
   int (*message)(struct dm_target *ti , unsigned int argc , char **argv ) ;
   int (*ioctl)(struct dm_target *ti , unsigned int cmd , unsigned long arg ) ;
   int (*merge)(struct dm_target *ti , struct bvec_merge_data *bvm , struct bio_vec *biovec ,
                int max_size ) ;
   int (*busy)(struct dm_target *ti ) ;
   int (*iterate_devices)(struct dm_target *ti , int (*fn)(struct dm_target *ti ,
...
struct dm_target {
   ...
   void *private ;
   char *error ;
   unsigned int discards_supported : 1 ;
   unsigned int discard_zeroes_data_unsupported : 1 ;
};
struct cred;
struct file;
struct task_struct;
...
struct kernel_param {
   ...
   u16 perm ;
   s16 level ;
   union __anonunion____missing_field_name_265 __annonCompField50 ;
};
struct kparam_string {
   unsigned int maxlen ;
   char *string ;
...
extern void zero_fill_bio(struct bio *bio ) ;
...
static struct target_type zero_target =
     {0ULL, "zero", & __this_module, {1U, 0U, 0U}, & zero_ctr, (void (*)(struct dm_target *ti ))0,
    & zero_map, (int (*)(struct dm_target *ti , struct request *clone , union map_info *map_context ))0,
    (int (*)(struct dm_target *ti , struct bio *bio , int error , union map_info *map_context ))0,
    (int (*)(struct dm_target *ti , struct request *clone , int error , union map_info *map_context ))0,
    (void (*)(struct dm_target *ti ))0, (void (*)(struct dm_target *ti ))0, (void (*)(struct dm_target *ti ))0,
    (int (*)(struct dm_target *ti ))0, (void (*)(struct dm_target *ti ))0, (int (*)(struct dm_target *ti ,
                                                                                    status_type_t status_type ,
                                                                                    char *result ,
                                                                                    unsigned int maxlen ))0,
    (int (*)(struct dm_target *ti , unsigned int argc , char **argv ))0, (int (*)(struct dm_target *ti ,
                                                                                  unsigned int cmd ,
                                                                                  unsigned long arg ))0,
    (int (*)(struct dm_target *ti , struct bvec_merge_data *bvm , struct bio_vec *biovec ,
             int max_size ))0, (int (*)(struct dm_target *ti ))0, (int (*)(struct dm_target *ti ,
                                                                           int (*fn)(struct dm_target *ti ,
                                                                                     struct dm_dev *dev ,
                                                                                     sector_t start ,
                                                                                     sector_t len ,
                                                                                     void *data ) ,
                                                                           void *data ))0,
    (void (*)(struct dm_target *ti , struct queue_limits *limits ))0, {(struct list_head *)0,
                                                                       (struct list_head *)0}};
static int dm_zero_init(void) __attribute__((__section__(".init.text"), __no_instrument_function__)) ;
static int dm_zero_init(void)
{ int r ;
  int tmp___7 ;
  {
  {
  tmp___7 = dm_register_target(& zero_target);
  r = tmp___7;
  }
  if (r < 0) {
    {
...
static void dm_zero_exit(void) __attribute__((__section__(".exit.text"), __no_instrument_function__)) ;
...
static char const __mod_author84[46] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
  { (char const )'a', (char const )'u', (char const )'t', (char const )'h',
        ...
        (char const )'i', (char const )'s', (char const )'t', (char const )'o',
        (char const )'p', (char const )'h', (char const )'e', (char const )'@',
        (char const )'s', (char const )'a', (char const )'o', (char const )'u',
        (char const )'t', (char const )'.', (char const )'d', (char const )'e',
        (char const )'>', (char const )'\000'};
static char const __mod_description85[55] __attribute__((__used__, __unused__,
__section__(".modinfo"), __aligned__(1))) =
  { (char const )'d', (char const )'e', (char const )'s', (char const )'c',
        ...
        (char const )'r', (char const )' ', (char const )'d', (char const )'u',
        (char const )'m', (char const )'m', (char const )'y', (char const )' ',
        ...
        (char const )'o', (char const )'s', (char const )'\000'};
