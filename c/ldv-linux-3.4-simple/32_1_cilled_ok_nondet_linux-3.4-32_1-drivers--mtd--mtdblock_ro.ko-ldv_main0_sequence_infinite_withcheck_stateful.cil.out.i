...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--mtd--mtdblock_ro.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct mtd_blktrans_dev *dev ;
  ...
  *((int *)((void *)dev + 104)) = *((int *)((void *)mtd + 64));
  __cil_tmp16 = *((uint64_t *)((void *)mtd + 8));
  __cil_tmp17 = __cil_tmp16 >> 9;
  *((unsigned long *)((void *)dev + 112)) = (unsigned long )__cil_tmp17;
