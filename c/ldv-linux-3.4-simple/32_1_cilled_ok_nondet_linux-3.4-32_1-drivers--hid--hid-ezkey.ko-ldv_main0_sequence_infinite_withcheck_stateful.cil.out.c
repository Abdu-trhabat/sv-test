...
{ struct input_dev *input ;
  ...
  if (! __cil_tmp9) {
    ...
    if (! __cil_tmp12) {
      ...
      {
      __cil_tmp15 = *((__u8 *)((void *)usage + 10));
      if (! __cil_tmp15) {
        return (0);
      } else {
  ...
  if (__cil_tmp19 == 2) {
    {
    __cil_tmp22 = *((__u16 *)((void *)usage + 8));
    __cil_tmp23 = (int )__cil_tmp22;
    if (__cil_tmp23 == 6) {
      {
      __cil_tmp26 = *((struct hid_input **)((void *)field + 96));
      input = *((struct input_dev **)((void *)__cil_tmp26 + 24));
      __cil_tmp31 = *((__u8 *)((void *)usage + 10));
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--hid--hid-ezkey.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
