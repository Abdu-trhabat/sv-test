...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--staging--iio--kfifo_buf.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct kfifo *__tmp ;
  ...
  __tmp = (struct kfifo *)((void *)buf + 208);
...
{ int ret ;
  ...
  __cil_tmp12 = 0 + 4;
  __cil_tmp15 = *((int *)((void *)buf + __cil_tmp12));
  __cil_tmp16 = *((int *)buf);
...
{ int ret ;
  ...
  __mptr = (struct iio_buffer const *)r;
  kf = (struct iio_kfifo *)__mptr;
  __tmp = (struct kfifo *)((void *)kf + 208);
  __buf = data;
  __cil_tmp20 = *((int *)((void *)r + 4));
...
{ struct iio_kfifo *kf ;
  ...
  *((int *)((void *)kf + 232)) = 1;
  ...
  __cil_tmp10 = 0 + 176;
  *((struct attribute_group const **)((void *)kf + __cil_tmp10)) = (struct attribute_group const *)(& iio_kfifo_attribute_group);
  __cil_tmp13 = 0 + 32;
  *((struct iio_buffer_access_funcs const **)((void *)kf + __cil_tmp13)) = & kfifo_access_funcs;
  }
