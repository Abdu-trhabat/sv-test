...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--rtc--rtc-da9052.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct da9052_rtc *rtc ;
  ...
  if (ret < 0) {
    {
    __cil_tmp14 = *((struct da9052 **)((void *)rtc + 8));
  ...
  *((int *)rtc_tm) = __cil_tmp52 & 63;
  ...
  if (ret != 0) {
    {
    __cil_tmp55 = *((struct da9052 **)((void *)rtc + 8));
...
{ struct da9052_rtc *rtc ;
  ...
  *((int *)((void *)rtc + 16)) = platform_get_irq_byname(pdev, "ALM");
  ...
  if (ret != 0) {
    {
    __cil_tmp31 = *((struct da9052 **)((void *)rtc + 8));
