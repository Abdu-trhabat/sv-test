...
union __anonunion____missing_field_name_260 {
   __wsum csum ;
   struct __anonstruct____missing_field_name_261 __annonCompField44 ;
};
...
struct sk_buff {
   ...
   __u16 mac_len ;
   __u16 hdr_len ;
   union __anonunion____missing_field_name_260 __annonCompField45 ;
   __u32 priority ;
   __u8 local_df : 1 ;
   __u8 cloned : 1 ;
   __u8 ip_summed : 2 ;
   ...
   __u32 secmark ;
   union __anonunion____missing_field_name_262 __annonCompField46 ;
...
struct address_space;
struct writeback_control;
union __anonunion_arg_287 {
   char *buf ;
   void *data ;
};
struct __anonstruct_read_descriptor_t_286 {
   size_t written ;
   size_t count ;
   union __anonunion_arg_287 arg ;
   int error ;
};
typedef struct __anonstruct_read_descriptor_t_286 read_descriptor_t;
...
struct inode {
   ...
   void *i_security ;
   unsigned long i_ino ;
   union __anonunion____missing_field_name_288 __annonCompField49 ;
   dev_t i_rdev ;
   ...
   union __anonunion____missing_field_name_289 __annonCompField50 ;
   atomic_t i_count ;
   ...
   union __anonunion____missing_field_name_290 __annonCompField51 ;
   __u32 i_generation ;
...
union __anonunion_f_u_291 {
   struct list_head fu_list ;
   struct rcu_head fu_rcuhead ;
};
struct file {
   union __anonunion_f_u_291 f_u ;
   struct path f_path ;
...
struct __anonstruct_afs_293 {
   struct list_head link ;
   int state ;
};
union __anonunion_fl_u_292 {
   struct nfs_lock_info nfs_fl ;
   struct nfs4_lock_info nfs4_fl ;
   struct __anonstruct_afs_293 afs ;
};
struct file_lock {
   ...
   union __anonunion_fl_u_292 fl_u ;
};
struct fasync_struct {
   spinlock_t fa_lock ;
   int magic ;
...
{ int value ;
  ...
  {
  __cil_tmp4 = (u32 )0;
  value = phy_read(phydev, __cil_tmp4);
  }
  if (value < 0) {
    return (value);
  } else {
  ...
  while (1) {
    ...
    {
    __cil_tmp7 = (u32 )0;
    value = phy_read(phydev, __cil_tmp7);
    }
    if (value & 32768) {
...
{ int err ;
  ...
  if (__cil_tmp6 == 2147483648U) {
    ...
    if (err == 0) {
      {
      __cil_tmp9 = (u32 )17;
      value = phy_read(phydev, __cil_tmp9);
      }
      if (value < 0) {
        err = value;
      } else {
...
static struct phy_driver ste101p_pdriver  = 
     {(u32 )400464, (char *)"STe101p", 4294967280U, (u32 )(((((((1 | (1 << 1)) | (1 << 2)) | (1 << 3)) | (1 << 6)) | (1 << 7)) | (1 << 9)) | (1 << 13)),
    (u32 )1, & ste10Xp_config_init, (int (*)(struct phy_device *phydev ))0, & genphy_suspend,
    & genphy_resume, & genphy_config_aneg, & genphy_read_status, & ste10Xp_ack_interrupt,
    & ste10Xp_config_intr, (int (*)(struct phy_device *phydev ))0, (void (*)(struct phy_device *phydev ))0,
...
static struct phy_driver ste100p_pdriver  = 
     {(u32 )470024209, (char *)"STe100p", 4294967295U, (u32 )(((((((1 | (1 << 1)) | (1 << 2)) | (1 << 3)) | (1 << 6)) | (1 << 7)) | (1 << 9)) | (1 << 13)),
    (u32 )1, & ste10Xp_config_init, (int (*)(struct phy_device *phydev ))0, & genphy_suspend,
    & genphy_resume, & genphy_config_aneg, & genphy_read_status, & ste10Xp_ack_interrupt,
    & ste10Xp_config_intr, (int (*)(struct phy_device *phydev ))0, (void (*)(struct phy_device *phydev ))0,
    (int (*)(struct phy_device *phydev , struct ifreq *ifr ))0, (bool (*)(struct phy_device *dev ,
    ...
    (void (*)(struct phy_device *dev , struct sk_buff *skb , int type ))0, {(char const   *)0,
                                                                            ...
                                                                            (struct dev_pm_ops  const  *)0,
                                                                            (struct driver_private *)0}};
static int ste10Xp_init(void)  __attribute__((__section__(".init.text"), __no_instrument_function__)) ;
static int ste10Xp_init(void) 
{ int retval ;
  int tmp___7 ;
  ...
  {
  tmp___7 = phy_driver_register(& ste101p_pdriver);
  }
  return (tmp___7);
}
}
static void ste10Xp_exit(void)  __attribute__((__section__(".exit.text"), __no_instrument_function__)) ;
static void ste10Xp_exit(void) 
{ 
...
static struct mdio_device_id ste10Xp_tbl[2]  __attribute__((__unused__))  = {      {(__u32 )400464, 4294967280U}, 
        {(__u32 )470024209, 4294967295U}};
extern struct mdio_device_id  const  __mod_mdio_device_table  __attribute__((__unused__,
__alias__("ste10Xp_tbl"))) ;
static char const   __mod_description144[50]  __attribute__((__used__, __unused__,
__section__(".modinfo"), __aligned__(1)))  = 
  {      (char const   )'d',      (char const   )'e',      (char const   )'s',      (char const   )'c', 
        (char const   )'r',      (char const   )'i',      (char const   )'p',      (char const   )'t', 
        (char const   )'i',      (char const   )'o',      (char const   )'n',      (char const   )'=', 
        (char const   )'S',      (char const   )'T',      (char const   )'M',      (char const   )'i', 
        (char const   )'c',      (char const   )'r',      (char const   )'o',      (char const   )'e', 
        (char const   )'l',      (char const   )'e',      (char const   )'c',      (char const   )'t', 
        (char const   )'r',      (char const   )'o',      (char const   )'n',      (char const   )'i', 
        (char const   )'c',      (char const   )'s',      (char const   )' ',      (char const   )'S', 
        (char const   )'T',      (char const   )'e',      (char const   )'1',      (char const   )'0', 
        (char const   )'X',      (char const   )'p',      (char const   )' ',      (char const   )'P', 
...
static char const   __mod_author145[51]  __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1)))  = 
  {      (char const   )'a',      (char const   )'u',      (char const   )'t',      (char const   )'h', 
        (char const   )'o',      (char const   )'r',      (char const   )'=',      (char const   )'G', 
        (char const   )'i',      (char const   )'u',      (char const   )'s',      (char const   )'e', 
        (char const   )'p',      (char const   )'p',      (char const   )'e',      (char const   )' ', 
        (char const   )'C',      (char const   )'a',      (char const   )'v',      (char const   )'a', 
        (char const   )'l',      (char const   )'l',      (char const   )'a',      (char const   )'r', 
        (char const   )'o',      (char const   )' ',      (char const   )'<',      (char const   )'p', 
        (char const   )'e',      (char const   )'p',      (char const   )'p',      (char const   )'e', 
        (char const   )'.',      (char const   )'c',      (char const   )'a',      (char const   )'v', 
        (char const   )'a',      (char const   )'l',      (char const   )'l',      (char const   )'a', 
  ...
  while (1) {
    ...
    if (tmp___8 == 5) {
      ...
      if (0) {
        case_0: /* CIL Label */ 
        {
        ste10Xp_config_init(var_group1);
        }
        goto switch_break;
        case_1: /* CIL Label */ 
        {
        ste10Xp_ack_interrupt(var_group1);
        }
        goto switch_break;
        case_2: /* CIL Label */ 
        {
        ste10Xp_config_intr(var_group1);
        }
        goto switch_break;
        case_3: /* CIL Label */ 
        {
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--net--phy--ste10Xp.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
