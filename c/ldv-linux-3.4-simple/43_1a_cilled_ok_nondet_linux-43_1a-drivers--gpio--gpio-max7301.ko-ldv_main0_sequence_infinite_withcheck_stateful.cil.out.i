...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--gpio--gpio-max7301.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct max7301 *ts ;
  ...
  *((u8 *)((void *)spi + 1166)) = (u8 )16U;
  ...
  {
  *((int (**)(struct device * , unsigned int ))((void *)ts + 320)) = & max7301_spi_read;
  *((int (**)(struct device * , unsigned int , unsigned int ))((void *)ts + 312)) = & max7301_spi_write;
  *((struct device **)((void *)ts + 304)) = (struct device *)spi;
