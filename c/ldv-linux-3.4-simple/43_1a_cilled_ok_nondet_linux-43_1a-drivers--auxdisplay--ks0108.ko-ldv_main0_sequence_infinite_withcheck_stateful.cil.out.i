...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--auxdisplay--ks0108.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
void ks0108_writedata(unsigned char byte )
{
  ...
  {
  {
  __cil_tmp4 = *((struct parport_operations **)((void *)ks0108_parport + 488));
...
{ unsigned int *__cil_tmp2 ;
  ...
  __udelay(__cil_tmp4);
  __cil_tmp7 = *((struct parport_operations **)((void *)ks0108_parport + 488));
