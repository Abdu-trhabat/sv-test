...
{ struct resource *tmp ;
  ...
  if (arcnet_debug & 1) {
    {
    printk("arcnet: RIM I (entirely mem-mapped) support\n");
    }
  } else {
...
{ struct arcnet_local *lp ;
  unsigned long first_mirror ;
  unsigned long last_mirror ;
  unsigned long shmem ;
  void *p ;
  int mirror_size ;
  int err ;
  ...
  __cil_tmp55 = (void volatile   *)p;
  __cil_tmp56 = __cil_tmp55 + 1U;
  writeb(__cil_tmp54, __cil_tmp56);
  mirror_size = 2048;
  __cil_tmp57 = (void const volatile   *)p;
  tmp___0 = readb(__cil_tmp57);
  }
  {
  __cil_tmp58 = (unsigned int )tmp___0;
  if (__cil_tmp58 == 209U) {
    {
    __cil_tmp59 = shmem - 2048UL;
    tmp___1 = check_mirror(__cil_tmp59, 2048UL);
    }
    if (tmp___1 == 0) {
      {
      __cil_tmp60 = shmem - 4096UL;
      tmp___2 = check_mirror(__cil_tmp60, 2048UL);
      }
      if (tmp___2 == 1) {
        mirror_size = 4096;
      } else {
  ...
  __cil_tmp61 = (unsigned long )mirror_size;
  first_mirror = shmem - __cil_tmp61;
  goto ldv_34867;
  ldv_34866: 
  __cil_tmp62 = (unsigned long )mirror_size;
  first_mirror = first_mirror - __cil_tmp62;
  ldv_34867: 
  {
  __cil_tmp63 = (size_t )mirror_size;
  tmp___3 = check_mirror(first_mirror, __cil_tmp63);
  }
  if (tmp___3 == 1) {
    goto ldv_34866;
  } else {
  ...
  ldv_34868: 
  __cil_tmp64 = (unsigned long )mirror_size;
  first_mirror = __cil_tmp64 + first_mirror;
  __cil_tmp65 = (unsigned long )mirror_size;
  last_mirror = __cil_tmp65 + shmem;
  goto ldv_34870;
  ldv_34869: 
  __cil_tmp66 = (unsigned long )mirror_size;
  last_mirror = __cil_tmp66 + last_mirror;
  ldv_34870: 
  {
  __cil_tmp67 = (size_t )mirror_size;
  tmp___4 = check_mirror(last_mirror, __cil_tmp67);
  }
  if (tmp___4 == 1) {
    goto ldv_34869;
  } else {
  ...
  *((void (**)(struct net_device * , int  , int  , void * , int  ))((void *)lp + __cil_tmp93)) = & arcrimi_copy_from_card;
  ...
  tmp___6 = __request_region(& iomem_resource, __cil_tmp101, __cil_tmp110, "arcnet (90xx)",
                             0);
  }
  {
  __cil_tmp111 = (struct resource *)0;
  __cil_tmp112 = (unsigned long )__cil_tmp111;
  __cil_tmp113 = (unsigned long )tmp___6;
  if (__cil_tmp113 == __cil_tmp112) {
    if (arcnet_debug & 1) {
      ...
      printk("%s%6s: Card memory already allocated\n", __cil_tmp114, __cil_tmp116);
      }
    } else {
  ...
  *__cil_tmp142 = readb(__cil_tmp147);
  ...
  if (arcnet_debug & 1) {
    ...
    printk("%s%6s: ARCnet RIM I: station %02Xh found at IRQ %d, ShMem %lXh (%ld*%d bytes).\n",
           __cil_tmp148, __cil_tmp150, __cil_tmp155, __cil_tmp158, __cil_tmp161, __cil_tmp171,
           mirror_size);
    }
  } else {
  ...
  __release_region(& iomem_resource, __cil_tmp179, __cil_tmp188);
  }
  err_free_irq: 
  {
...
{ struct arcnet_local *lp ;
  ...
  {
  __cil_tmp11 = arcnet_debug & 4;
  if (__cil_tmp11 != 0) {
    {
    __cil_tmp12 = (void const volatile   *)ioaddr;
    tmp___0 = readb(__cil_tmp12);
    __cil_tmp13 = (char *)"<6>";
    __cil_tmp14 = (char (*)[16U])dev;
  ...
  if (really_reset != 0) {
    {
    __cil_tmp19 = (void volatile   *)ioaddr;
    __cil_tmp20 = __cil_tmp19 + 0xfffffffffffff800UL;
    writeb((unsigned char)209, __cil_tmp20);
    }
    return (0);
  } else {
  ...
  {
  __cil_tmp21 = (void volatile   *)ioaddr;
  __cil_tmp22 = __cil_tmp21 + 1U;
  writeb((unsigned char)14, __cil_tmp22);
  __cil_tmp23 = (void volatile   *)ioaddr;
  __cil_tmp24 = __cil_tmp23 + 1U;
  writeb((unsigned char)22, __cil_tmp24);
  __cil_tmp25 = (void volatile   *)ioaddr;
  __cil_tmp26 = __cil_tmp25 + 1U;
  writeb((unsigned char)13, __cil_tmp26);
  }
  return (0);
}
}
...
{ struct arcnet_local *lp ;
  ...
  __cil_tmp13 = (void volatile   *)ioaddr;
  writeb(__cil_tmp12, __cil_tmp13);
  }
  return;
}
}
...
{ struct arcnet_local *lp ;
  ...
  writeb(__cil_tmp12, __cil_tmp14);
  }
  return;
}
}
...
{ struct arcnet_local *lp ;
  ...
  __cil_tmp24 = (size_t )count;
  memcpy_toio(__cil_tmp22, __cil_tmp23, __cil_tmp24);
  }
  return;
}
}
...
{ struct arcnet_local *lp ;
  ...
  memcpy_fromio(buf, __cil_tmp22, __cil_tmp23);
  }
  return;
}
}
...
static void arc_rimi_exit(void) 
{ struct net_device *dev ;
  struct arcnet_local *lp ;
  void *tmp ;
  ...
  {
  dev = my_dev;
  __cil_tmp4 = (struct net_device  const  *)dev;
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--net--arcnet--arc-rimi_true-termination.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
