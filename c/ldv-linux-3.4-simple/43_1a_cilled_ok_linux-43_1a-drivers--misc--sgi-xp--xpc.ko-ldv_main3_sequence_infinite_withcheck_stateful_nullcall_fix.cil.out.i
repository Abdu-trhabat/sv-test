...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_linux-43_1a-drivers--misc--sgi-xp--xpc.ko-ldv_main3_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ u32 channel_was_connected ;
  ...
  *((unsigned int *)__cil_tmp45) = __cil_tmp48 & 4294964103U;
  if (xpc_arch_ops.send_chctl_closerequest) (*(xpc_arch_ops.send_chctl_closerequest))(ch, irq_flags);
  }
  if (channel_was_connected != 0U) {
...
{ unsigned long irq_flags ;
  ...
  if (__cil_tmp10 == 0U) {
    ...
    *((int *)__cil_tmp14) = (int )line;
    ...
    if (__cil_tmp18 == 21U) {
      {
        if (xpc_arch_ops.request_partition_reactivation) (*(xpc_arch_ops.request_partition_reactivation))(part);
      }
    } else {
    }
    }
  ...
  *((int *)__cil_tmp45) = (int )line;
  ...
  if (xpc_arch_ops.request_partition_deactivation) (*(xpc_arch_ops.request_partition_deactivation))(part);
  __cil_tmp49 = (unsigned long )part;
