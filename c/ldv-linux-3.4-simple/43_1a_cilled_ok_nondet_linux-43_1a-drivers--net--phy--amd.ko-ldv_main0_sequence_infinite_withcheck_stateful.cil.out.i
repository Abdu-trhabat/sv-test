...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--net--phy--amd.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ int err ;
  ...
  {
  {
  __cil_tmp5 = *((u32 *)((void *)phydev + 1208));
...
static struct phy_driver am79c_driver =
     {2250267U, (char *)"AM79C874", 4294967280U, 719U, 1U, & am79c_config_init, (int (*)(struct phy_device * ))0,
    (int (*)(struct phy_device * ))0, (int (*)(struct phy_device * ))0, & genphy_config_aneg,
    & genphy_read_status, & am79c_ack_interrupt, & am79c_config_intr, (int (*)(struct phy_device * ))0,
