...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--net--phy--smsc.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
enum __anonenum_rtnl_link_state_334 {
...
struct net_device {
   ...
   enum __anonenum_reg_state_333 reg_state : 8 ;
   bool dismantle ;
   enum __anonenum_rtnl_link_state_334 rtnl_link_state : 16 ;
...
extern int genphy_suspend(struct phy_device *phydev ) ;
extern int genphy_resume(struct phy_device *phydev ) ;
...
{ int rc ;
  ...
  {
  {
  __cil_tmp8 = *((u32 *)((void *)phydev + 824));
  if (2147483648U == __cil_tmp8) {
    __cil_tmp9 = 1 << 7;
    __cil_tmp10 = 1 << 4;
    __cil_tmp11 = 1 << 6;
    __cil_tmp12 = __cil_tmp11 | __cil_tmp10;
    tmp___7 = __cil_tmp12 | __cil_tmp9;
  } else {
    tmp___7 = 0;
  }
  }
  {
  __cil_tmp13 = (u32 )30;
  __cil_tmp14 = (u16 )tmp___7;
  tmp___8 = phy_write(phydev, __cil_tmp13, __cil_tmp14);
  rc = tmp___8;
  }
  if (rc < 0) {
    tmp___9 = rc;
...
{ int rc ;
  ...
  __cil_tmp6 = (u32 )17;
  __cil_tmp7 = 1 << 13;
  __cil_tmp8 = rc | __cil_tmp7;
  __cil_tmp9 = (u16 )__cil_tmp8;
  rc = phy_write(phydev, __cil_tmp6, __cil_tmp9);
  }
  if (rc < 0) {
    return (rc);
  } else {
  ...
  {
  tmp___8 = smsc_phy_ack_interrupt(phydev);
  }
  return (tmp___8);
}
}
...
{ int tmp___7 ;
  {
  {
  tmp___7 = smsc_phy_ack_interrupt(phydev);
  }
  return (tmp___7);
}
}
static struct phy_driver lan83c185_driver =
     {(u32 )508064, (char *)"SMSC LAN83C185", 4294967280U, (u32 )((((((((1 | (1 << 1)) | (1 << 2)) | (1 << 3)) | (1 << 6)) | (1 << 7)) | (1 << 9)) | (1 << 13)) | (1 << 14)),
    (u32 )3, & smsc_phy_config_init, (int (*)(struct phy_device *phydev ))0, & genphy_suspend,
    & genphy_resume, & genphy_config_aneg, & genphy_read_status, & smsc_phy_ack_interrupt,
    & smsc_phy_config_intr, (int (*)(struct phy_device *phydev ))0, (void (*)(struct phy_device *phydev ))0,
...
static struct phy_driver lan8187_driver =
     {(u32 )508080, (char *)"SMSC LAN8187", 4294967280U, (u32 )((((((((1 | (1 << 1)) | (1 << 2)) | (1 << 3)) | (1 << 6)) | (1 << 7)) | (1 << 9)) | (1 << 13)) | (1 << 14)),
    (u32 )3, & smsc_phy_config_init, (int (*)(struct phy_device *phydev ))0, & genphy_suspend,
    & genphy_resume, & genphy_config_aneg, & genphy_read_status, & smsc_phy_ack_interrupt,
    & smsc_phy_config_intr, (int (*)(struct phy_device *phydev ))0, (void (*)(struct phy_device *phydev ))0,
    (int (*)(struct phy_device *phydev , struct ifreq *ifr ))0, (bool (*)(struct phy_device *dev ,
...
static struct phy_driver lan8700_driver =
     {(u32 )508096, (char *)"SMSC LAN8700", 4294967280U, (u32 )((((((((1 | (1 << 1)) | (1 << 2)) | (1 << 3)) | (1 << 6)) | (1 << 7)) | (1 << 9)) | (1 << 13)) | (1 << 14)),
    (u32 )3, & smsc_phy_config_init, (int (*)(struct phy_device *phydev ))0, & genphy_suspend,
    & genphy_resume, & genphy_config_aneg, & genphy_read_status, & smsc_phy_ack_interrupt,
    & smsc_phy_config_intr, (int (*)(struct phy_device *phydev ))0, (void (*)(struct phy_device *phydev ))0,
    (int (*)(struct phy_device *phydev , struct ifreq *ifr ))0, (bool (*)(struct phy_device *dev ,
...
static struct phy_driver lan911x_int_driver =
     {(u32 )508112, (char *)"SMSC LAN911x Internal PHY", 4294967280U, (u32 )((((((((1 | (1 << 1)) | (1 << 2)) | (1 << 3)) | (1 << 6)) | (1 << 7)) | (1 << 9)) | (1 << 13)) | (1 << 14)),
    (u32 )3, & lan911x_config_init, (int (*)(struct phy_device *phydev ))0, & genphy_suspend,
    & genphy_resume, & genphy_config_aneg, & genphy_read_status, & smsc_phy_ack_interrupt,
    & smsc_phy_config_intr, (int (*)(struct phy_device *phydev ))0, (void (*)(struct phy_device *phydev ))0,
    (int (*)(struct phy_device *phydev , struct ifreq *ifr ))0, (bool (*)(struct phy_device *dev ,
                                                                          struct sk_buff *skb ,
...
static struct phy_driver lan8710_driver =
     {(u32 )508144, (char *)"SMSC LAN8710/LAN8720", 4294967280U, (u32 )((((((((1 | (1 << 1)) | (1 << 2)) | (1 << 3)) | (1 << 6)) | (1 << 7)) | (1 << 9)) | (1 << 13)) | (1 << 14)),
    (u32 )3, & smsc_phy_config_init, (int (*)(struct phy_device *phydev ))0, & genphy_suspend,
    & genphy_resume, & genphy_config_aneg, & genphy_read_status, & smsc_phy_ack_interrupt,
    & smsc_phy_config_intr, (int (*)(struct phy_device *phydev ))0, (void (*)(struct phy_device *phydev ))0,
    (int (*)(struct phy_device *phydev , struct ifreq *ifr ))0, (bool (*)(struct phy_device *dev ,
    ...
    (void (*)(struct phy_device *dev , struct sk_buff *skb , int type ))0, {(char const *)0,
                                                                            ...
                                                                            (struct dev_pm_ops const *)0,
                                                                            (struct driver_private *)0}};
static int smsc_init(void) __attribute__((__section__(".init.text"), __no_instrument_function__)) ;
...
static void smsc_exit(void) __attribute__((__section__(".exit.text"), __no_instrument_function__)) ;
...
static char const __mod_description232[28] __attribute__((__used__, __unused__,
...
static char const __mod_author233[30] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
  { (char const )'a', (char const )'u', (char const )'t', (char const )'h',
        (char const )'o', (char const )'r', (char const )'=', (char const )'H',
        (char const )'e', (char const )'r', (char const )'b', (char const )'e',
        (char const )'r', (char const )'t', (char const )' ', (char const )'V',
        (char const )'a', (char const )'l', (char const )'e', (char const )'r',
...
static struct mdio_device_id smsc_tbl[5] __attribute__((__unused__)) = { {(__u32 )508064, 4294967280U},
        {(__u32 )508080, 4294967280U},
        {(__u32 )508096, 4294967280U},
        {(__u32 )508112, 4294967280U},
        {(__u32 )508144, 4294967280U}};
