...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--mtd--onenand--onenand_sim.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct mtd_info *mtd ;
  ...
  if (cmd == 148) {
    ...
    if (0) {
      ...
      __ret = memcpy(dest, __cil_tmp62, __len);
      }
      case_19:
      {
      ...
      __ret___0 = memcpy(dest, __cil_tmp77, __len___0);
      }
      goto switch_break;
      case_128:
      __cil_tmp78 = 512 << 1;
      ...
      while (1) {
        ...
        __ret___1 = memcpy(__cil_tmp123, __cil_tmp125, __len___1);
        }
        __Cont:
        i = i + 1U;
      }
      ...
      __ret___2 = memcpy(dest, __cil_tmp156, __len___2);
      }
      goto switch_break;
      case_148:
      if (pi_operation) {
