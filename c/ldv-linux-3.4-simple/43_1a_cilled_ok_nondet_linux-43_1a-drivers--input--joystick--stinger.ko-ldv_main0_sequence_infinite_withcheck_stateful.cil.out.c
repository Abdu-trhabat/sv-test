...
{ struct input_dev *dev ;
  ...
  __cil_tmp6 = (unsigned char (*)[8U])((void *)stinger + 12);
...
{ struct stinger *stinger ;
  ...
  *((unsigned long *)((void *)input_dev + __cil_tmp42)) = 10UL;
  __cil_tmp45 = 4 * 8UL;
  __cil_tmp46 = 48 + __cil_tmp45;
  *((unsigned long *)((void *)input_dev + __cil_tmp46)) = 936467247516352512UL;
  input_set_abs_params(input_dev, 0U, -64, 64, 0, 4);
  input_set_abs_params(input_dev, 1U, -64, 64, 0, 4);
  __cil_tmp49 = (void *)stinger;
  ...
  {
  __cil_tmp50 = *((struct input_dev **)stinger);
  err = input_register_device(__cil_tmp50);
  }
  if (err != 0) {
    goto fail3;
  } else {
  ...
  __cil_tmp52 = (void const   *)stinger;
  kfree(__cil_tmp52);
  }
  return (err);
}
}
static struct serio_device_id stinger_serio_ids[2U]  = {      {(__u8 )2U, (__u8 )255U, (__u8 )255U, (__u8 )30U}, 
...
{ int tmp ;
  ...
  {
  {
  tmp = __serio_register_driver(& stinger_drv, & __this_module, "stinger");
  }
  return (tmp);
}
}
...
{ struct serio *var_group1 ;
  ...
  if (tmp___0 == 2) {
    ...
    if (0) {
      ...
      case_2: /* CIL Label */ 
      {
      __cil_tmp10 = (int )var_stinger_interrupt_1_p1;
      __cil_tmp11 = (unsigned char )__cil_tmp10;
      stinger_interrupt(var_group1, __cil_tmp11, var_stinger_interrupt_1_p2);
      }
      goto ldv_20786;
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--input--joystick--stinger.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
