...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--mfd--ucb1400_core.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
struct writeback_control;
union __anonunion_arg_264 {
   char *buf ;
   void *data ;
};
struct __anonstruct_read_descriptor_t_263 {
   size_t written ;
   size_t count ;
   union __anonunion_arg_264 arg ;
   int error ;
};
typedef struct __anonstruct_read_descriptor_t_263 read_descriptor_t;
...
struct inode {
   ...
   void *i_security ;
   unsigned long i_ino ;
   union __anonunion____missing_field_name_265 __annonCompField44 ;
   dev_t i_rdev ;
   ...
   union __anonunion____missing_field_name_266 __annonCompField45 ;
   atomic_t i_count ;
   ...
   union __anonunion____missing_field_name_267 __annonCompField46 ;
   __u32 i_generation ;
...
union __anonunion_f_u_268 {
   struct list_head fu_list ;
   struct rcu_head fu_rcuhead ;
};
struct file {
   union __anonunion_f_u_268 f_u ;
   struct path f_path ;
...
struct __anonstruct_afs_270 {
   struct list_head link ;
   int state ;
};
union __anonunion_fl_u_269 {
   struct nfs_lock_info nfs_fl ;
   struct nfs4_lock_info nfs4_fl ;
   struct __anonstruct_afs_270 afs ;
};
struct file_lock {
   ...
   union __anonunion_fl_u_269 fl_u ;
};
struct fasync_struct {
   spinlock_t fa_lock ;
   int magic ;
...
struct snd_info_entry_ops {
   ...
   ssize_t (*read)(struct snd_info_entry *entry , void *file_private_data , struct file *file ,
                   char *buf , size_t count , loff_t pos ) ;
   ssize_t (*write)(struct snd_info_entry *entry , void *file_private_data , struct file *file ,
                    char const *buf , size_t count , loff_t pos ) ;
   loff_t (*llseek)(struct snd_info_entry *entry , void *file_private_data , struct file *file ,
...
struct __anonstruct_ad18xx_279 {
...
union __anonunion_spec_278 {
   struct __anonstruct_ad18xx_279 ad18xx ;
...
struct snd_ac97 {
   ...
   union __anonunion_spec_278 spec ;
...
{ unsigned short tmp___7 ;
  ...
  unsigned short (*__cil_tmp10)(struct snd_ac97 *ac97 , unsigned short reg ) ;
  {
  {
  ...
  __cil_tmp10 = *((unsigned short (**)(struct snd_ac97 *ac97 , unsigned short reg ))__cil_tmp9);
  tmp___7 = (*__cil_tmp10)(ac97, reg);
  }
  return (tmp___7);
}
}
...
{ unsigned long __cil_tmp4 ;
  ...
  unsigned long __cil_tmp8 ;
  unsigned long __cil_tmp9 ;
  void (*__cil_tmp10)(struct snd_ac97 *ac97 , unsigned short reg , unsigned short val ) ;
  {
  {
  __cil_tmp4 = (unsigned long )ac97;
  __cil_tmp5 = __cil_tmp4 + 24;
  ...
  __cil_tmp10 = *((void (**)(struct snd_ac97 *ac97 , unsigned short reg , unsigned short val ))__cil_tmp9);
  (*__cil_tmp10)(ac97, reg, val);
  }
  return;
}
}
...
{ unsigned int val ;
  ...
  __cil_tmp13 = (u16 )102;
  __cil_tmp14 = 1 << 7;
  __cil_tmp15 = (int )adc_channel;
  __cil_tmp16 = 1 << 15;
  __cil_tmp17 = __cil_tmp16 | __cil_tmp15;
  __cil_tmp18 = __cil_tmp17 | __cil_tmp14;
  __cil_tmp19 = (u16 )__cil_tmp18;
  ucb1400_reg_write(ac97, __cil_tmp13, __cil_tmp19);
  }
  {
  while (1) {
    while_continue: ;
    {
    __cil_tmp20 = (u16 )104;
    tmp___7 = ucb1400_reg_read(ac97, __cil_tmp20);
...
extern void *__crc_ucb1400_adc_read __attribute__((__weak__)) ;
static unsigned long const __kcrctab_ucb1400_adc_read __attribute__((__used__,
__unused__, __section__("___kcrctab_gpl+ucb1400_adc_read"))) = (unsigned long const )((unsigned long )(& __crc_ucb1400_adc_read));
static char const __kstrtab_ucb1400_adc_read[17] __attribute__((__section__("__ksymtab_strings"),
__aligned__(1))) =
  { (char const )'u', (char const )'c', (char const )'b', (char const )'1',
        (char const )'4', (char const )'0', (char const )'0', (char const )'_',
        (char const )'a', (char const )'d', (char const )'c', (char const )'_',
        (char const )'r', (char const )'e', (char const )'a', (char const )'d',
        (char const )'\000'};
static struct kernel_symbol const __ksymtab_ucb1400_adc_read __attribute__((__used__,
__unused__, __section__("___ksymtab_gpl+ucb1400_adc_read"))) = {(unsigned long )(& ucb1400_adc_read), __kstrtab_ucb1400_adc_read};
...
{ int err ;
  ...
  struct platform_device *__cil_tmp50 ;
  void const *__cil_tmp51 ;
  struct platform_device *__cil_tmp52 ;
  ...
  {
  __cil_tmp16 = (void *)ucb;
  dev_set_drvdata(dev, __cil_tmp16);
  __mptr = (struct device const *)dev;
  __cil_tmp17 = (struct snd_ac97 *)0;
  __cil_tmp18 = (unsigned long )__cil_tmp17;
  __cil_tmp19 = __cil_tmp18 + 696;
  __cil_tmp20 = (struct device *)__cil_tmp19;
  __cil_tmp21 = (unsigned int )__cil_tmp20;
  __cil_tmp22 = (char *)__mptr;
  __cil_tmp23 = __cil_tmp22 - __cil_tmp21;
  ac97 = (struct snd_ac97 *)__cil_tmp23;
  __cil_tmp24 = (u16 )126;
  tmp___8 = ucb1400_reg_read(ac97, __cil_tmp24);
  __cil_tmp25 = (unsigned long )(& ucb_ts) + 8;
  *((int *)__cil_tmp25) = (int )tmp___8;
  }
  {
  __cil_tmp26 = (unsigned long )(& ucb_ts) + 8;
  __cil_tmp27 = *((int *)__cil_tmp26);
  if (__cil_tmp27 != 17156) {
    err = -19;
    goto err0;
  } else {
  }
  ...
  {
  __cil_tmp28 = (unsigned long )(& ucb_gpio) + 120;
  *((struct snd_ac97 **)__cil_tmp28) = ac97;
  __cil_tmp29 = (unsigned long )ucb;
  __cil_tmp30 = __cil_tmp29 + 8;
  *((struct platform_device **)__cil_tmp30) = platform_device_alloc("ucb1400_gpio",
                                                                    -1);
  }
  {
  __cil_tmp31 = (unsigned long )ucb;
  ...
  *((struct platform_device **)ucb) = platform_device_alloc("ucb1400_ts", -1);
  ...
  {
  __cil_tmp49 = *((struct platform_device **)ucb);
  if (! __cil_tmp49) {
    err = -12;
    goto err2;
  } else {
  ...
  {
  __cil_tmp50 = *((struct platform_device **)ucb);
  __cil_tmp51 = (void const *)(& ucb_ts);
  err = platform_device_add_data(__cil_tmp50, __cil_tmp51, 72UL);
  }
  if (err) {
    goto err3;
  } else {
  ...
  {
  __cil_tmp52 = *((struct platform_device **)ucb);
  err = platform_device_add(__cil_tmp52);
  }
  if (err) {
    goto err3;
  } else {
  ...
  platform_device_put(__cil_tmp53);
  }
  err2:
  {
  __cil_tmp54 = (unsigned long )ucb;
  __cil_tmp55 = __cil_tmp54 + 8;
  __cil_tmp56 = *((struct platform_device **)__cil_tmp55);
  platform_device_del(__cil_tmp56);
  }
  err1:
  {
  ...
  platform_device_put(__cil_tmp59);
  }
  err0:
  {
  __cil_tmp60 = (void const *)ucb;
  kfree(__cil_tmp60);
  }
  err:
  return (err);
...
static int ucb1400_core_init(void) __attribute__((__section__(".init.text"), __no_instrument_function__)) ;
static int ucb1400_core_init(void)
{ int tmp___7 ;
  {
  {
  tmp___7 = (int )driver_register(& ucb1400_core_driver);
  }
  return (tmp___7);
}
}
static void ucb1400_core_exit(void) __attribute__((__section__(".exit.text"), __no_instrument_function__)) ;
...
static char const __mod_description158[35] __attribute__((__used__, __unused__,
__section__(".modinfo"), __aligned__(1))) =
  { (char const )'d', (char const )'e', (char const )'s', (char const )'c',
        ...
        (char const )'U', (char const )'C', (char const )'B', (char const )'1',
        (char const )'4', (char const )'0', (char const )'0', (char const )' ',
        (char const )'d', (char const )'r', (char const )'i', (char const )'v',
        (char const )'e', (char const )'r', (char const )'\000'};
static char const __mod_license159[12] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
...
{ struct device *var_group1 ;
  ...
  while (1) {
    ...
    if (tmp___9) {
      ...
      {
      __cil_tmp6 = ldv_s_ucb1400_core_driver_device_driver == 0;
      if (! __cil_tmp6) {
      } else {
        goto while_break;
      }
