...
{ unsigned long __cil_tmp2 ;
  ...
  __cil_tmp5 = *((unsigned int *)((void *)w + 20));
  __cil_tmp6 = __cil_tmp5 * 250U;
  mod_timer(& watchdog_ticktock, ((void *)__cil_tmp6 + __cil_tmp2));
  }
  return (0);
}
}
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--watchdog--softdog_true-termination.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
