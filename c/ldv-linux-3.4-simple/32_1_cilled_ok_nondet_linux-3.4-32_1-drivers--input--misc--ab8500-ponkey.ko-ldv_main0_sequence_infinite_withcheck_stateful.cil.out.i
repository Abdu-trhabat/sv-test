...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--input--misc--ab8500-ponkey.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
static int ab8500_ponkey_probe(struct platform_device *pdev ) __attribute__((__section__(".devinit.text"),
...
{ struct ab8500 *ab8500 ;
  ...
  *((struct device **)__cil_tmp29) = (struct device *)__cil_tmp31;
  ...
  {
  __cil_tmp52 = *((struct input_dev **)ponkey);
  error = (int )input_register_device(__cil_tmp52);
  }
  if (error) {
    {
    __cil_tmp53 = *((struct device **)ab8500);
    __cil_tmp54 = (struct device const *)__cil_tmp53;
    dev_err(__cil_tmp54, "Can\'t register input device: %d\n", error);
    }
    goto err_free_dbr_irq;
  } else {
  }
  {
  __cil_tmp55 = (void *)ponkey;
  ...
  __cil_tmp66 = (void const *)ponkey;
  kfree(__cil_tmp66);
  }
  return (error);
}
}
static int ab8500_ponkey_remove(struct platform_device *pdev ) __attribute__((__section__(".devexit.text"),
__no_instrument_function__)) ;
...
{ struct ab8500_ponkey *ponkey ;
  ...
  __cil_tmp15 = *((struct input_dev **)ponkey);
  input_unregister_device(__cil_tmp15);
  __cil_tmp16 = (void const *)ponkey;
  kfree(__cil_tmp16);
  __cil_tmp17 = (void *)0;
...
static struct platform_driver ab8500_ponkey_driver = {& ab8500_ponkey_probe, & ab8500_ponkey_remove, (void (*)(struct platform_device * ))0,
    (int (*)(struct platform_device * , pm_message_t state ))0, (int (*)(struct platform_device * ))0,
    {"ab8500-poweron-key", (struct bus_type *)0, & __this_module, (char const *)0,
...
static int ab8500_ponkey_driver_init(void) __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
static int ab8500_ponkey_driver_init(void)
{ int tmp ;
  {
  {
  tmp = platform_driver_register(& ab8500_ponkey_driver);
  }
  return (tmp);
}
}
...
{ int tmp ;
  {
  {
  tmp = ab8500_ponkey_driver_init();
  }
  return (tmp);
}
}
static void ab8500_ponkey_driver_exit(void) __attribute__((__section__(".exit.text"),
__no_instrument_function__)) ;
static void ab8500_ponkey_driver_exit(void)
{
  {
  {
...
void cleanup_module(void)
{
  {
  {
  ab8500_ponkey_driver_exit();
  }
  return;
}
}
static char const __mod_license145[15] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
  { (char const )'l', (char const )'i', (char const )'c', (char const )'e',
        (char const )'n', (char const )'s', (char const )'e', (char const )'=',
        (char const )'G', (char const )'P', (char const )'L', (char const )' ',
        (char const )'v', (char const )'2', (char const )'\000'};
static char const __mod_author146[48] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
  { (char const )'a', (char const )'u', (char const )'t', (char const )'h',
        (char const )'o', (char const )'r', (char const )'=', (char const )'S',
        (char const )'u', (char const )'n', (char const )'d', (char const )'a',
        (char const )'r', (char const )' ', (char const )'I', (char const )'y',
        (char const )'e', (char const )'r', (char const )' ', (char const )'<',
        (char const )'s', (char const )'u', (char const )'n', (char const )'d',
        (char const )'a', (char const )'r', (char const )'.', (char const )'i',
...
__section__(".modinfo"), __aligned__(1))) =
  { (char const )'d', (char const )'e', (char const )'s', (char const )'c',
        ...
        (char const )'S', (char const )'T', (char const )'-', (char const )'E',
        (char const )'r', (char const )'i', (char const )'c', (char const )'s',
        (char const )'s', (char const )'o', (char const )'n', (char const )' ',
        (char const )'A', (char const )'B', (char const )'8', (char const )'5',
        (char const )'0', (char const )'0', (char const )' ', (char const )'P',
        (char const )'o', (char const )'w', (char const )'e', (char const )'r',
        (char const )'-', (char const )'O', (char const )'N', (char const )'(',
        (char const )'P', (char const )'o', (char const )'n', (char const )')',
...
static int res_ab8500_ponkey_probe_1 ;
void main(void)
{ struct platform_device *var_group1 ;
  ...
  while (1) {
    ...
    if (tmp___0) {
      ...
      {
      __cil_tmp7 = ldv_s_ab8500_ponkey_driver_platform_driver == 0;
      if (! __cil_tmp7) {
      } else {
        goto while_break;
      }
