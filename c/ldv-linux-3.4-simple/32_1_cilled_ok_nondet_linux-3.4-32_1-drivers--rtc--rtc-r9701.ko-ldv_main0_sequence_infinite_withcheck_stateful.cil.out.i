...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--rtc--rtc-r9701.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct spi_device *spi ;
  ...
  __cil_tmp10 = address & 127;
  *((unsigned char *)__cil_tmp9) = (unsigned char )__cil_tmp10;
  __cil_tmp11 = 1 * 1UL;
  ...
  *((unsigned char *)__cil_tmp12) = data;
  ...
  tmp___8 = spi_write(spi, __cil_tmp16, __cil_tmp18);
  }
  return (tmp___8);
}
}
...
{ struct spi_device *spi ;
  ...
  while (1) {
    ...
    *((u8 *)__cil_tmp11) = (u8 )__cil_tmp15;
    ...
    __cil_tmp20 = 0 * 1UL;
    __cil_tmp21 = (unsigned long )(rxbuf) + __cil_tmp20;
    __cil_tmp22 = (u8 *)__cil_tmp21;
    __cil_tmp23 = (void *)__cil_tmp22;
    ret = spi_write_then_read(spi, __cil_tmp19, 1U, __cil_tmp23, 1U);
    __cil_tmp24 = regs + k;
    __cil_tmp25 = 0 * 1UL;
    __cil_tmp26 = (unsigned long )(rxbuf) + __cil_tmp25;
...
{ int ret ;
  ...
  *((unsigned char *)__cil_tmp23) = (unsigned char)6;
  ...
  ret = read_regs(dev, __cil_tmp26, __cil_tmp29);
  }
  if (ret) {
    return (ret);
  } else {
...
{ int ret ;
  ...
  tmp___7 = bin2bcd(__cil_tmp23);
  ret = write_reg(dev, 2, tmp___7);
  }
  if (ret) {
    ret = ret;
  } else {
    {
    __cil_tmp26 = *((int *)((void *)dt + 4));
    __cil_tmp27 = (unsigned int )__cil_tmp26;
    tmp___8 = bin2bcd(__cil_tmp27);
    tmp___9 = write_reg(dev, 1, tmp___8);
    ret = tmp___9;
    }
  }
  if (ret) {
    ...
    tmp___11 = write_reg(dev, 0, tmp___10);
    ret = tmp___11;
    }
  }
  if (ret) {
    ...
    {
    __cil_tmp32 = *((int *)((void *)dt + 12));
    __cil_tmp33 = (unsigned int )__cil_tmp32;
    tmp___12 = bin2bcd(__cil_tmp33);
    tmp___13 = write_reg(dev, 4, tmp___12);
    ret = tmp___13;
    }
  }
  if (ret) {
    ...
    {
    __cil_tmp36 = *((int *)((void *)dt + 16));
    __cil_tmp37 = __cil_tmp36 + 1;
    __cil_tmp38 = (unsigned int )__cil_tmp37;
    tmp___14 = bin2bcd(__cil_tmp38);
    tmp___15 = write_reg(dev, 5, tmp___14);
    ret = tmp___15;
    }
  }
  if (ret) {
    ...
    {
    __cil_tmp41 = *((int *)((void *)dt + 20));
    __cil_tmp42 = __cil_tmp41 - 100;
    __cil_tmp43 = (unsigned int )__cil_tmp42;
    tmp___16 = bin2bcd(__cil_tmp43);
    tmp___17 = write_reg(dev, 6, tmp___16);
    ret = tmp___17;
    }
  }
  if (ret) {
    ...
    {
    __cil_tmp46 = *((int *)((void *)dt + 24));
    __cil_tmp47 = 1 << __cil_tmp46;
    __cil_tmp48 = (unsigned char )__cil_tmp47;
    tmp___18 = write_reg(dev, 3, __cil_tmp48);
    ret = tmp___18;
    }
  }
  return (ret);
...
static int r9701_probe(struct spi_device *spi ) __attribute__((__section__(".devinit.text"),
...
{ struct rtc_device *rtc ;
  ...
  *__cil_tmp10 = (unsigned char)7;
  ...
  res = read_regs(__cil_tmp11, & tmp___7, 1);
  }
  if (res) {
    {
  ...
  if (tmp___9) {
    ...
    *((int *)((void *)(&dt) + 20)) = 100;
    ...
    tmp___8 = r9701_set_datetime(__cil_tmp28, & dt);
    }
    if (tmp___8) {
      {
  ...
  tmp___11 = (long )IS_ERR(__cil_tmp32);
  }
  if (tmp___11) {
    {
    __cil_tmp33 = (void const *)rtc;
    tmp___10 = (long )PTR_ERR(__cil_tmp33);
    }
    return ((int )tmp___10);
  } else {
  }
...
static int r9701_remove(struct spi_device *spi ) __attribute__((__section__(".devexit.text"),
__no_instrument_function__)) ;
...
static struct spi_driver r9701_driver = {(struct spi_device_id const *)0, & r9701_probe, & r9701_remove, (void (*)(struct spi_device *spi ))0,
    (int (*)(struct spi_device *spi , pm_message_t mesg ))0, (int (*)(struct spi_device *spi ))0,
    {"rtc-r9701", (struct bus_type *)0, & __this_module, (char const *)0, (_Bool)0,
...
static int r9701_driver_init(void) __attribute__((__section__(".init.text"), __no_instrument_function__)) ;
static int r9701_driver_init(void)
{ int tmp___7 ;
  {
  {
  tmp___7 = spi_register_driver(& r9701_driver);
  }
  return (tmp___7);
}
}
...
{ int tmp___7 ;
  {
  {
  tmp___7 = r9701_driver_init();
  }
  return (tmp___7);
}
}
static void r9701_driver_exit(void) __attribute__((__section__(".exit.text"), __no_instrument_function__)) ;
static void r9701_driver_exit(void)
{
  {
  {
...
static char const __mod_description187[33] __attribute__((__used__, __unused__,
__section__(".modinfo"), __aligned__(1))) =
  { (char const )'d', (char const )'e', (char const )'s', (char const )'c',
        (char const )'r', (char const )'i', (char const )'p', (char const )'t',
        (char const )'i', (char const )'o', (char const )'n', (char const )'=',
        (char const )'r', (char const )'9', (char const )'7', (char const )'0',
        (char const )'1', (char const )' ', (char const )'s', (char const )'p',
        ...
        (char const )'\000'};
static char const __mod_author188[40] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
  { (char const )'a', (char const )'u', (char const )'t', (char const )'h',
        (char const )'o', (char const )'r', (char const )'=', (char const )'M',
        (char const )'a', (char const )'g', (char const )'n', (char const )'u',
        (char const )'s', (char const )' ', (char const )'D', (char const )'a',
        (char const )'m', (char const )'m', (char const )' ', (char const )'<',
        (char const )'d', (char const )'a', (char const )'m', (char const )'m',
        (char const )'@', (char const )'o', (char const )'p', (char const )'e',
        (char const )'n', (char const )'s', (char const )'o', (char const )'u',
        (char const )'r', (char const )'c', (char const )'e', (char const )'.',
        (char const )'s', (char const )'e', (char const )'>', (char const )'\000'};
static char const __mod_license189[12] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
  { (char const )'l', (char const )'i', (char const )'c', (char const )'e',
        (char const )'n', (char const )'s', (char const )'e', (char const )'=',
        (char const )'G', (char const )'P', (char const )'L', (char const )'\000'};
static char const __mod_alias190[20] __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1))) =
  { (char const )'a', (char const )'l', (char const )'i', (char const )'a',
        (char const )'s', (char const )'=', (char const )'s', (char const )'p',
        (char const )'i', (char const )':', (char const )'r', (char const )'t',
        (char const )'c', (char const )'-', (char const )'r', (char const )'9',
        (char const )'7', (char const )'0', (char const )'1', (char const )'\000'};
void ldv_check_final_state(void) ;
extern void ldv_check_return_value(int res ) ;
extern void ldv_initialize(void) ;
extern int __VERIFIER_nondet_int(void) ;
int LDV_IN_INTERRUPT ;
static int res_r9701_probe_4 ;
void main(void)
{ struct device *var_group1 ;
  ...
  while (1) {
    ...
    if (tmp___8) {
      ...
      {
      __cil_tmp7 = ldv_s_r9701_driver_spi_driver == 0;
      if (! __cil_tmp7) {
      } else {
        goto while_break;
      }
