...
static struct map_info ts5500_map  = 
     {"TS-5500 Flash", 2097152UL, 155189248ULL, (void *)0, (void *)0, 0, 1, (map_word (*)(struct map_info * ,
                                                                                        unsigned long  ))0,
...
static struct mtd_partition ts5500_partitions[3U]  = {      {(char *)"Drive A", 917504ULL, 0ULL, 0U, (struct nand_ecclayout *)0}, 
        {(char *)"BIOS", 131072ULL, 917504ULL, 0U, (struct nand_ecclayout *)0}, 
        {(char *)"Drive B", 1048576ULL, 1048576ULL, 0U, (struct nand_ecclayout *)0}};
...
{ int rc ;
  ...
  *((void **)__cil_tmp2) = ioremap_nocache(__cil_tmp4, __cil_tmp6);
  ...
  __cil_tmp14 = (unsigned long )mymtd;
  ...
  __cil_tmp17 = (unsigned long )mymtd;
  ...
  *((struct module **)__cil_tmp19) = & __this_module;
  ...
  mtd_device_parse_register(mymtd, __cil_tmp20, __cil_tmp21, __cil_tmp22, 3);
  }
  return (0);
  err1: 
  {
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--mtd--maps--ts5500_flash_true-termination.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
