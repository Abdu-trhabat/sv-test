...
{ int res ;
  ...
  __cil_tmp21 = (char *)((void *)client + __cil_tmp18);
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--misc--isl29020.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
