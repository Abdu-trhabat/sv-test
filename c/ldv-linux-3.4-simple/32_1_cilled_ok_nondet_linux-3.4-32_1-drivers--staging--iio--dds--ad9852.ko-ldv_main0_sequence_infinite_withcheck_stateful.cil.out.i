...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--staging--iio--dds--ad9852.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct spi_message msg ;
  ...
  *((void const **)__cil_tmp25) = (void const *)(& config);
  spi_message_init(& msg);
  spi_message_add_tail(& xfer, & msg);
  __cil_tmp28 = *((struct spi_device **)((void *)st + 72));
...
{ struct ad9852_state *st ;
  ...
  *((struct iio_info const **)((void *)idev + 976)) = & ad9852_info;
  *((int *)((void *)idev + 4)) = 1;
