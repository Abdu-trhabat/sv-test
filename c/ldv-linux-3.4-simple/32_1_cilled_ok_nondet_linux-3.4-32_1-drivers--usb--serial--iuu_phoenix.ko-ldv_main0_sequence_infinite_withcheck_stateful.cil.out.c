...
{ struct iuu_private *priv ;
  ...
  *tmp___11 = (char )__cil_tmp28;
  ...
  __ret = memcpy(__cil_tmp32, __cil_tmp36, __len);
...
#include "model/32_1_cilled_true-unreach-call_ok_nondet_linux-3.4-32_1-drivers--usb--serial--iuu_phoenix.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
