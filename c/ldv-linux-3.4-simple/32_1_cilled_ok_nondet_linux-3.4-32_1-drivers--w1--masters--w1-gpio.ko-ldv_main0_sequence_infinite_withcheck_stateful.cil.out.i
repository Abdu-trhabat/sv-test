...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--w1--masters--w1-gpio.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct w1_bus_master *master ;
  ...
  *((u8 (**)(void * ))((void *)master + 8)) = & w1_gpio_read_bit;
  ...
  {
  if (*((void (**)(int enable ))((void *)pdata + 8))) {
    {
    __cil_tmp25 = *((void (**)(int enable ))((void *)pdata + 8));
    (*__cil_tmp25)(1);
    }
  } else {
  }
...
{ struct w1_bus_master *master ;
  ...
  if (*((void (**)(int enable ))((void *)pdata + 8))) {
    {
    __cil_tmp14 = *((void (**)(int enable ))((void *)pdata + 8));
    (*__cil_tmp14)(0);
    }
  } else {
  }
...
{ struct w1_gpio_platform_data *pdata ;
  ...
  if (*((void (**)(int enable ))((void *)pdata + 8))) {
    {
    __cil_tmp12 = *((void (**)(int enable ))((void *)pdata + 8));
    (*__cil_tmp12)(0);
    }
  } else {
  }
...
{ struct w1_gpio_platform_data *pdata ;
  ...
  if (*((void (**)(int enable ))((void *)pdata + 8))) {
    {
    __cil_tmp11 = *((void (**)(int enable ))((void *)pdata + 8));
    (*__cil_tmp11)(1);
    }
  } else {
  }
