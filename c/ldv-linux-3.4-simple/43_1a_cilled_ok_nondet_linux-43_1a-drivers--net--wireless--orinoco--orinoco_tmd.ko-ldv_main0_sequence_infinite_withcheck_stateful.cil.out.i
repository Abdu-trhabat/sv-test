...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "43_1a_cilled_ok_nondet_linux-43_1a-drivers--net--wireless--orinoco--orinoco_tmd.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ struct hermes *hw ;
  ...
  {
  {
  hw = (struct hermes *)((void *)priv + 1272);
...
{ int err ;
  ...
  *((void **)card) = bridge_io;
  ...
  fail:
  {
  __cil_tmp36 = *((unsigned int *)((void *)pdev + 1300));
