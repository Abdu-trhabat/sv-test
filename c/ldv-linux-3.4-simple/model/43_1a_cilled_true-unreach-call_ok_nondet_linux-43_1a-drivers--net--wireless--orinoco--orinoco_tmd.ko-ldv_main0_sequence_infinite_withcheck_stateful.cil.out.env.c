...
// with type: void hermes_struct_init(struct hermes *, void *, int)
// with return type: void
...
// with type: void orinoco_down(struct orinoco_private *)
// with return type: void
...
// with type: int orinoco_if_add(struct orinoco_private *, unsigned long, unsigned int, const struct net_device_ops *)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// Function: orinoco_up
// with type: int orinoco_up(struct orinoco_private *)
// with return type: int
int __VERIFIER_nondet_int(void);
