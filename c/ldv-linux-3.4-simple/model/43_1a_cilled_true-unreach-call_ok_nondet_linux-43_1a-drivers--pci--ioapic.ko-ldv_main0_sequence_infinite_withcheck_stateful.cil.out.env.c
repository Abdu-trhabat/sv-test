...
// Function: acpi_register_ioapic
// with type: int acpi_register_ioapic(acpi_handle , u64 , u32 )
// with return type: int
int __VERIFIER_nondet_int(void);
int acpi_register_ioapic(acpi_handle arg0, u64 arg1, u32 arg2) {
  // Simple type
  return __VERIFIER_nondet_int();
}

// Function: acpi_unregister_ioapic
// with type: int acpi_unregister_ioapic(acpi_handle , u32 )
// with return type: int
int __VERIFIER_nondet_int(void);
