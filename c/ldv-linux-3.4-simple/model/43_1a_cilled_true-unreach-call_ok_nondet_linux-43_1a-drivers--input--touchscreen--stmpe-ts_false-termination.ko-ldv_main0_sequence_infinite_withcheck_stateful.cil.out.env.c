...
// with type: int stmpe_block_read(struct stmpe *, u8 , u8 , u8 *)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// with type: int stmpe_enable(struct stmpe *, unsigned int)
// with return type: int
int __VERIFIER_nondet_int(void);
...
// with type: int stmpe_reg_read(struct stmpe *, u8 )
// with return type: int
int __VERIFIER_nondet_int(void);
...
// with type: int stmpe_reg_write(struct stmpe *, u8 , u8 )
// with return type: int
int __VERIFIER_nondet_int(void);
...
// with type: int stmpe_set_bits(struct stmpe *, u8 , u8 , u8 )
// with return type: int
int __VERIFIER_nondet_int(void);
