...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "32_1_cilled_ok_nondet_linux-3.4-32_1-drivers--ide--cmd640.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.c", 3, __extension__ __PRETTY_FUNCTION__); })); }
...
{ unsigned long flags ;
  ...
  {
    if (__get_cmd640_reg) b = (*__get_cmd640_reg)(reg);
...
{ unsigned long flags ;
  ...
  {
    if (__put_cmd640_reg) (*__put_cmd640_reg)(reg, val);
  spin_unlock_irqrestore(& cmd640_lock, flags);
  }
  return;
}
...
{ unsigned long flags ;
  ...
  {
  __cil_tmp13 = (u16 )reg;
  if (__get_cmd640_reg) b = (*__get_cmd640_reg)(__cil_tmp13);
  ...
  {
  __cil_tmp27 = (u16 )reg;
  if (__put_cmd640_reg) (*__put_cmd640_reg)(__cil_tmp27, b);
  spin_unlock_irqrestore(& cmd640_lock, flags);
  }
  return;
}
...
{ unsigned long flags ;
  ...
  if (__get_cmd640_reg) tmp___9 = (*__get_cmd640_reg)(__cil_tmp45);
  ...
  if (__put_cmd640_reg) (*__put_cmd640_reg)(__cil_tmp53, setup_count);
  ...
  if (__put_cmd640_reg) (*__put_cmd640_reg)(__cil_tmp57, tmp___10);
  spin_unlock_irqrestore(& cmd640_lock, flags);
  }
  return;
}
