...
static struct rc_map_table tivo[45U]  = 
  {      {2701955087U, 226U}, 
        ...
        {2701970435U, 28U}, 
        {2701937667U, 355U}};
static struct rc_map_list tivo_map  =    {{(struct list_head *)0, (struct list_head *)0}, {(struct rc_map_table *)(& tivo),
                                                     45U, 0U, 0U, 2ULL, "rc-tivo",
                                                     {{{{{0U}}, 0U, 0U, (void *)0,
...
#include "model/43_1a_cilled_true-unreach-call_ok_nondet_linux-43_1a-drivers--media--rc--keymaps--rc-tivo.ko-ldv_main0_sequence_infinite_withcheck_stateful.cil.out.env.c"
