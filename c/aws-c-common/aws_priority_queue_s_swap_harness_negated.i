...
void reach_error() { __assert_fail("0", "aws_priority_queue_s_swap_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_priority_queue_s_swap_harness() {
    ...
    __VERIFIER_assert(!(old_a_byte.byte == ((uint8_t *)queue.container.data)[old_b_byte.index]));
    __VERIFIER_assert(!(old_b_byte.byte == ((uint8_t *)queue.container.data)[old_a_byte.index]));
}
int main() { aws_priority_queue_s_swap_harness(); return 0; }
