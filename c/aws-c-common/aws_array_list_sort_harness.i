int compare(const void *a, const void *b, unsigned long item_size);
...
void my_qsort(void *base, unsigned long num, unsigned long size, int (*compar)(const void *, const void *)) {
    ...
    assume_abort_if_not(index_a < num);
    unsigned long index_b;
    assume_abort_if_not(index_b < num);
    assume_abort_if_not(index_a != index_b);
...
int compare(const void *a, const void *b, size_t item_size) {
    assume_abort_if_not((((item_size) == 0) || (a)));
    assume_abort_if_not((((item_size) == 0) || (b)));
    return nondet_int();
}
...
int main() { aws_array_list_sort_harness(); return 0; }
