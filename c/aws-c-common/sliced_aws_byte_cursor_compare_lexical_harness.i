...
void reach_error() {
  __assert_fail("0", "aws_byte_cursor_compare_lexical_harness.i", 208,
                "reach_error");
}
extern void abort(void);
...
int aws_byte_cursor_compare_lexical(const struct aws_byte_cursor *lhs,
...
int aws_byte_cursor_compare_lexical(const struct aws_byte_cursor *lhs,
  ...
  assume_abort_if_not((lhs->ptr != ((void *)0)));
  assume_abort_if_not((rhs->ptr != ((void *)0)));
...
int main() {
  aws_byte_cursor_compare_lexical_harness();
  return 0;
}
