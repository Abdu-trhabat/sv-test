...
void reach_error() { __assert_fail("0", "aws_priority_queue_capacity_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_priority_queue_capacity_harness() {
    ...
    assume_abort_if_not(queue.container.item_size > 0);
    ...
    __VERIFIER_assert(!(aws_priority_queue_is_valid(&queue)));
    __VERIFIER_assert(!(capacity == queue.container.current_size / queue.container.item_size));
...
int main() { aws_priority_queue_capacity_harness(); return 0; }
