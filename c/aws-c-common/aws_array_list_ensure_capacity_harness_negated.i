...
void reach_error() { __assert_fail("0", "aws_array_list_ensure_capacity_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_array_list_ensure_capacity_harness() {
    ...
    if (!aws_array_list_ensure_capacity(&list, index)) {
        ...
        __VERIFIER_assert(!(list.length == old.length));
...
int main() { aws_array_list_ensure_capacity_harness(); return 0; }
