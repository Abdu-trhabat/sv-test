...
void reach_error() {
  __assert_fail("0", "aws_byte_cursor_read_harness.i", 208, "reach_error");
}
extern void abort(void);
...
void aws_byte_cursor_read_harness() {
  ...
  if (old_cur.len > ((18446744073709551615UL) >> 1) ||
      length > ((18446744073709551615UL) >> 1) || length > old_cur.len) {
    if (old_cur.len != 0) {
