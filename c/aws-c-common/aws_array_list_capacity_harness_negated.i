...
void reach_error() { __assert_fail("0", "aws_array_list_capacity_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_array_list_capacity_harness() {
    ...
    assume_abort_if_not(aws_array_list_is_valid(&list));
    assume_abort_if_not(list.item_size > 0);
    ...
    __VERIFIER_assert(!(capacity == list.current_size / list.item_size));
}
int main() { aws_array_list_capacity_harness(); return 0; }
