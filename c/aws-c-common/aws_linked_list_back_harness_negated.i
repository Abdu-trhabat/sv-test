...
void reach_error() { __assert_fail("0", "aws_linked_list_back_harness.i", 208, "reach_error"); }
extern void abort(void);
...
void aws_linked_list_back_harness() {
    ...
    __VERIFIER_assert(!(aws_linked_list_is_valid(&list)));
    __VERIFIER_assert(!(aws_linked_list_node_prev_is_valid(back)));
    __VERIFIER_assert(!(aws_linked_list_node_next_is_valid(back)));
    __VERIFIER_assert(!(back == old_last));
}
int main() { aws_linked_list_back_harness(); return 0; }
