...
void reach_error() { __assert_fail("0", "aws_mul_size_saturating_harness.i", 208, "reach_error"); }
extern void abort(void);
...
int main() { aws_mul_size_saturating_harness(); return 0; }
