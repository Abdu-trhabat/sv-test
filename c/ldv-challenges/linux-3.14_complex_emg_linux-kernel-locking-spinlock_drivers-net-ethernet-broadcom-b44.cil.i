...
typedef enum ldv_32185 phy_interface_t;
enum ldv_32197 {
    MDIOBUS_ALLOCATED = 1,
...
void ldv_spin_lock_lock_of_b44(void) ;
void ldv_spin_unlock_lock_of_b44(void) ;
...
static int ldv___ssb_driver_register_118(struct ssb_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ) ;
extern void ssb_driver_unregister(struct ssb_driver * ) ;
static void ldv_ssb_driver_unregister_119(struct ssb_driver *ldv_func_arg1 ) ;
...
__inline static void ssb_pcihost_set_power_state(struct ssb_device *sdev , pci_power_t state )
{
  ...
  if ((unsigned int )(sdev->bus)->bustype == 1U) {
    {
    pci_set_power_state((sdev->bus)->__annonCompField78.host_pci, state);
    }
  } else {
  }
  return;
...
__inline static void __b44_cam_write(struct b44 *bp , unsigned char *data , int index )
{
  ...
  val = val | ((unsigned int )*(data + 3UL) << 16);
  val = val | ((unsigned int )*(data + 4UL) << 8);
  val = val | (u32 )*(data + 5UL);
...
static void b44_set_flow_ctrl(struct b44 *bp , u32 local , u32 remote )
{
  ...
  {
  pause_enab = 0U;
  if ((local & 3072U) == 3072U) {
    if ((remote & 3072U) == 2048U) {
...
static void b44_timer(unsigned long __opaque )
{
  ...
  ldv_spin_lock_irq_62(& bp->lock);
  b44_check_phy(bp);
  b44_stats_update(bp);
  ldv_spin_unlock_irq_63(& bp->lock);
  tmp = round_jiffies((unsigned long )jiffies + 250UL);
  ldv_mod_timer_64(& bp->timer, tmp);
  }
  return;
}
}
static void b44_tx(struct b44 *bp )
{
  ...
  if (tmp___0 != 0L) {
    {
    __asm__ volatile ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"drivers/net/ethernet/broadcom/b44.c"),
                         "i" (630), "i" (12UL));
    __builtin_unreachable();
    }
  } else {
...
static int b44_poll(struct napi_struct *napi , int budget )
{
  ...
  ldv___ldv_spin_lock_65(& bp->lock);
  }
  ...
  {
  ldv_spin_unlock_irqrestore_66(& bp->lock, flags);
  work_done = 0;
  }
  ...
  if ((bp->istat & 64512U) != 0U) {
    {
    ldv___ldv_spin_lock_67(& bp->lock);
    b44_halt(bp);
    b44_init_rings(bp);
    b44_init_hw(bp, 2);
    netif_wake_queue(bp->dev);
...
static netdev_tx_t b44_start_xmit(struct sk_buff *skb , struct net_device *dev )
{
  ...
  rc = 0;
  len = skb->len;
  ldv___ldv_spin_lock_73(& bp->lock);
  ...
  if (tmp___5 != 0 || mapping + (dma_addr_t )len > 1073741823ULL) {
    {
    tmp___1 = dma_mapping_error((bp->sdev)->dma_dev, mapping);
    }
    if (tmp___1 == 0) {
    ...
    if (tmp___3 != 0 || mapping + (dma_addr_t )len > 1073741823ULL) {
      {
      tmp___2 = dma_mapping_error((bp->sdev)->dma_dev, mapping);
      }
      if (tmp___2 == 0) {
...
static int b44_alloc_consistent(struct b44 *bp , gfp_t gfp )
{
  ...
  if ((unsigned long )bp->rx_ring == (unsigned long )((struct dma_desc *)0)) {
    ...
    if (tmp___3 != 0 || rx_ring_dma + (dma_addr_t )size > 1073741823ULL) {
      {
  ...
  if ((unsigned long )bp->tx_ring == (unsigned long )((struct dma_desc *)0)) {
    ...
    if (tmp___6 != 0 || tx_ring_dma + (dma_addr_t )size > 1073741823ULL) {
      {
...
static void b44_chip_reset(struct b44 *bp , int reset_kind )
{
  ...
  {
  if ((unsigned int )(sdev->bus)->bustype == 0U) {
    goto case_0;
  } else {
  }
  if ((unsigned int )(sdev->bus)->bustype == 1U) {
  ...
  if ((unsigned int )(sdev->bus)->bustype == 2U) {
    goto case_2;
  } else {
  }
  if ((unsigned int )(sdev->bus)->bustype == 3U) {
    goto case_3;
  } else {
  }
  goto switch_break;
  ...
  __x = tmp___3;
  __d = 5000000;
  bw32((struct b44 const *)bp, 1040UL, (unsigned long )(((__x + (u32 )(__d / 2)) / (u32 )__d & 255U) | 128U));
  }
  goto ldv_46056;
  case_1:
  {
  ...
  if (tmp___4 != 0L) {
    {
    warn_slowpath_null("drivers/net/ethernet/broadcom/b44.c", 1330);
    }
  } else {
  }
  {
...
static int b44_open(struct net_device *dev )
{
  ...
  b44_init_hw(bp, 1);
  b44_check_phy(bp);
  err = ldv_request_irq_79((unsigned int )dev->irq, & b44_interrupt, 128UL, (char const *)(& dev->name),
                           (void *)dev);
...
static void b44_setup_pseudo_magicp(struct b44 *bp )
{
  ...
  val = (unsigned int )((plen0 | (plen1 << 8)) | (plen2 << 16)) | 2147483648U;
...
static void b44_setup_wol_pci(struct b44 *bp )
{
  ...
  if ((unsigned int )((bp->sdev)->bus)->bustype != 0U) {
    ...
    pci_read_config_word((struct pci_dev const *)((bp->sdev)->bus)->__annonCompField78.host_pci,
                         68, & val);
    pci_write_config_word((struct pci_dev const *)((bp->sdev)->bus)->__annonCompField78.host_pci,
...
static int b44_close(struct net_device *dev )
{
  ...
  {
  napi_disable(& bp->napi);
  ldv_del_timer_sync_80(& bp->timer);
  ldv_spin_lock_irq_62(& bp->lock);
  b44_halt(bp);
  b44_free_rings(bp);
  netif_carrier_off(dev);
  ldv_spin_unlock_irq_63(& bp->lock);
  ldv_free_irq_83((unsigned int )dev->irq, (void *)dev);
  }
  if ((int )bp->flags < 0) {
    {
    b44_init_hw(bp, 3);
...
static void b44_get_drvinfo(struct net_device *dev , struct ethtool_drvinfo *info )
{
  ...
  {
  if ((unsigned int )bus->bustype == 1U) {
    goto case_1;
  } else {
  }
  if ((unsigned int )bus->bustype == 0U) {
    goto case_0;
  } else {
  }
  if ((unsigned int )bus->bustype == 2U) {
    goto case_2;
  } else {
  }
  if ((unsigned int )bus->bustype == 3U) {
    goto case_3;
  } else {
  }
  goto switch_break;
  case_1:
  {
  tmp___0 = pci_name((struct pci_dev const *)bus->__annonCompField78.host_pci);
  ...
  if (tmp___1 != 0L) {
    {
    warn_slowpath_null("drivers/net/ethernet/broadcom/b44.c", 1810);
    }
  } else {
  }
  {
...
static int b44_init_one(struct ssb_device *sdev , struct ssb_device_id const *ent )
{
  ...
  {
  dev = ldv_alloc_etherdev_mqs_102(952, 1U, 1U);
  }
...
static int b44_suspend(struct ssb_device *sdev , pm_message_t state )
{
  ...
  {
  ldv_del_timer_sync_108(& bp->timer);
  ldv_spin_lock_irq_62(& bp->lock);
  b44_halt(bp);
  netif_carrier_off(bp->dev);
...
static int b44_resume(struct ssb_device *sdev )
{
  ...
  b44_init_hw(bp, 1);
  ldv_spin_unlock_irq_63(& bp->lock);
  rc = ldv_request_irq_114((unsigned int )dev->irq, & b44_interrupt, 128UL, (char const *)(& dev->name),
                           (void *)dev);
  }
  if (rc != 0) {
    {
  ...
  b44_enable_ints(bp);
  netif_wake_queue(dev);
  ldv_mod_timer_117(& bp->timer, (unsigned long )jiffies + 1UL);
  }
  return (0);
}
}
...
static int b44_init(void)
{
  ...
  {
  err = ldv___ssb_driver_register_118(& b44_ssb_driver, & __this_module);
  }
  if (err != 0) {
    {
    b44_pci_exit();
...
static void b44_cleanup(void)
{
  {
  {
  ldv_ssb_driver_unregister_119(& b44_ssb_driver);
  b44_pci_exit();
  }
  return;
}
}
void ldv_EMGentry_exit_b44_cleanup_14_2(void (*arg0)(void) ) ;
int ldv_EMGentry_init_b44_init_14_7(int (*arg0)(void) ) ;
...
int ldv_base_instance_probe_2_16(int (*arg0)(struct ssb_device * , struct ssb_device_id * ) ,
                                 struct ssb_device *arg1 , struct ssb_device_id *arg2 ) ;
void ldv_base_instance_release_2_2(void (*arg0)(struct ssb_device * ) , struct ssb_device *arg1 ) ;
void ldv_base_instance_resume_2_5(int (*arg0)(struct ssb_device * ) , struct ssb_device *arg1 ) ;
int ldv_base_instance_suspend_2_7(int (*arg0)(struct ssb_device * , struct pm_message ) ,
...
void ldv_dummy_resourceless_instance_callback_1_25(int (*arg0)(struct net_device * ,
                                                   ...
                                                   int arg3 ) ;
void ldv_dummy_resourceless_instance_callback_1_28(struct rtnl_link_stats64 *(*arg0)(struct net_device * ,
                                                                                     struct rtnl_link_stats64 * ) ,
...
void ldv_struct_ssb_driver_base_instance_2(void *arg0 ) ;
...
void (*ldv_14_exit_b44_cleanup_default)(void) ;
int (*ldv_14_init_b44_init_default)(void) ;
...
struct ssb_driver *ldv_2_container_struct_ssb_driver ;
struct pm_message ldv_2_resource_struct_pm_message ;
struct ssb_device_id *ldv_2_resource_struct_ssb_device_id_ptr ;
struct ssb_device *ldv_2_resource_struct_ssb_device_ptr ;
...
int ldv_statevar_2 ;
int ldv_statevar_3 ;
enum irqreturn (*ldv_0_callback_handler)(int , void * ) = & b44_interrupt;
void (*ldv_14_exit_b44_cleanup_default)(void) = & b44_cleanup;
int (*ldv_14_init_b44_init_default)(void) = & b44_init;
void (*ldv_1_callback_get_drvinfo)(struct net_device * , struct ethtool_drvinfo * ) = & b44_get_drvinfo;
void (*ldv_1_callback_get_ethtool_stats)(struct net_device * , struct ethtool_stats * ,
                                         unsigned long long * ) = & b44_get_ethtool_stats;
unsigned int (*ldv_1_callback_get_link)(struct net_device * ) = & ethtool_op_get_link;
unsigned int (*ldv_1_callback_get_msglevel)(struct net_device * ) = & b44_get_msglevel;
void (*ldv_1_callback_get_pauseparam)(struct net_device * , struct ethtool_pauseparam * ) = & b44_get_pauseparam;
void (*ldv_1_callback_get_ringparam)(struct net_device * , struct ethtool_ringparam * ) = & b44_get_ringparam;
int (*ldv_1_callback_get_settings)(struct net_device * , struct ethtool_cmd * ) = & b44_get_settings;
int (*ldv_1_callback_get_sset_count)(struct net_device * , int ) = & b44_get_sset_count;
void (*ldv_1_callback_get_strings)(struct net_device * , unsigned int , unsigned char * ) = & b44_get_strings;
void (*ldv_1_callback_get_wol)(struct net_device * , struct ethtool_wolinfo * ) = & b44_get_wol;
int (*ldv_1_callback_ndo_change_mtu)(struct net_device * , int ) = & b44_change_mtu;
int (*ldv_1_callback_ndo_do_ioctl)(struct net_device * , struct ifreq * , int ) = & b44_ioctl;
struct rtnl_link_stats64 *(*ldv_1_callback_ndo_get_stats64)(struct net_device * ,
                                                            struct rtnl_link_stats64 * ) = & b44_get_stats64;
void (*ldv_1_callback_ndo_poll_controller)(struct net_device * ) = & b44_adjust_link;
int (*ldv_1_callback_ndo_set_mac_address)(struct net_device * , void * ) = & b44_set_mac_addr;
void (*ldv_1_callback_ndo_set_rx_mode)(struct net_device * ) = & b44_set_rx_mode;
enum netdev_tx (*ldv_1_callback_ndo_start_xmit)(struct sk_buff * , struct net_device * ) = & b44_start_xmit;
void (*ldv_1_callback_ndo_tx_timeout)(struct net_device * ) = & b44_tx_timeout;
int (*ldv_1_callback_ndo_validate_addr)(struct net_device * ) = & eth_validate_addr;
int (*ldv_1_callback_nway_reset)(struct net_device * ) = & b44_nway_reset;
void (*ldv_1_callback_set_msglevel)(struct net_device * , unsigned int ) = & b44_set_msglevel;
int (*ldv_1_callback_set_pauseparam)(struct net_device * , struct ethtool_pauseparam * ) = & b44_set_pauseparam;
int (*ldv_1_callback_set_ringparam)(struct net_device * , struct ethtool_ringparam * ) = & b44_set_ringparam;
int (*ldv_1_callback_set_settings)(struct net_device * , struct ethtool_cmd * ) = & b44_set_settings;
int (*ldv_1_callback_set_wol)(struct net_device * , struct ethtool_wolinfo * ) = & b44_set_wol;
void (*ldv_1_callback_setup)(struct net_device * ) = & b44_adjust_link;
void ldv_EMGentry_exit_b44_cleanup_14_2(void (*arg0)(void) )
{
  {
  {
...
void ldv_allocate_external_0(void)
{
  ...
  ldv_1_ldv_param_18_2_default = ldv_malloc(sizeof(unsigned char));
  ldv_1_ldv_param_7_2_default = ldv_malloc(sizeof(unsigned long long));
  ldv_2_resource_struct_ssb_device_ptr = ldv_malloc(sizeof(struct ssb_device));
                                 ...
                                 struct ssb_device *arg1 , struct ssb_device_id *arg2 )
{
  ...
  {
  {
  tmp = b44_init_one(arg1, (struct ssb_device_id const *)arg2);
  }
  return (tmp);
}
}
...
void ldv_dispatch_deregister_12_1(struct ssb_driver *arg0 )
{
  {
  {
  ldv_2_container_struct_ssb_driver = arg0;
                                                   ...
                                                   unsigned char *arg3 )
{
  {
  {
  b44_get_strings(arg1, arg2, arg3);
  }
  return;
}
}
                                                  ...
                                                  unsigned long long *arg3 )
{
  {
  {
  b44_get_ethtool_stats(arg1, arg2, arg3);
  }
  return;
}
}
void ldv_entry_EMGentry_14(void *arg0 )
{
  ...
  ldv_EMGentry_exit_b44_cleanup_14_2(ldv_14_exit_b44_cleanup_default);
  ...
  {
  ldv_assume(ldv_statevar_2 == 19);
  ldv_14_ret_default = ldv_EMGentry_init_b44_init_14_7(ldv_14_init_b44_init_default);
...
int main(void)
{
  ...
  case_3:
  {
  ldv_struct_ssb_driver_base_instance_2((void *)0);
  }
  goto ldv_47153;
  case_4:
  {
...
void ldv_net_dummy_resourceless_instance_1(void *arg0 )
{
  ...
  case_12:
  {
  ldv_dummy_resourceless_instance_callback_1_12(ldv_1_callback_get_pauseparam, ldv_1_container_net_device,
  ...
  case_13:
  {
  ldv_dummy_resourceless_instance_callback_1_13(ldv_1_callback_get_ringparam, ldv_1_container_net_device,
  ...
  case_21:
  {
  ldv_dummy_resourceless_instance_callback_1_21(ldv_1_callback_get_wol, ldv_1_container_net_device,
  ...
  case_23:
  {
  ldv_dummy_resourceless_instance_callback_1_22(ldv_1_callback_ndo_change_mtu, ldv_1_container_net_device,
  ...
  case_26:
  {
  ldv_dummy_resourceless_instance_callback_1_25(ldv_1_callback_ndo_do_ioctl, ldv_1_container_net_device,
  ...
  case_28:
  {
  ldv_dummy_resourceless_instance_callback_1_28(ldv_1_callback_ndo_get_stats64, ldv_1_container_net_device,
  ...
  case_29:
  {
  ldv_dummy_resourceless_instance_callback_1_29(ldv_1_callback_ndo_poll_controller,
  ...
  case_43:
  {
  ldv_dummy_resourceless_instance_callback_1_43(ldv_1_callback_setup, ldv_1_container_net_device);
  ldv_statevar_1 = 2;
  }
  goto ldv_47206;
  switch_default: ;
...
void ldv_struct_ssb_driver_base_instance_2(void *arg0 )
{
  ...
  ldv_base_instance_release_2_2(ldv_2_container_struct_ssb_driver->remove, ldv_2_resource_struct_ssb_device_ptr);
  ldv_statevar_2 = 1;
  }
  goto ldv_47275;
  case_3:
  ...
  ldv_base_instance_resume_2_5(ldv_2_container_struct_ssb_driver->resume, ldv_2_resource_struct_ssb_device_ptr);
  ldv_statevar_2 = 3;
  }
  goto ldv_47275;
  case_7:
  ...
  ldv_2_ret_default = ldv_base_instance_suspend_2_7(ldv_2_container_struct_ssb_driver->suspend,
                                                    ldv_2_resource_struct_ssb_device_ptr,
  ...
  case_11:
  {
  ldv_free((void *)ldv_2_resource_struct_ssb_device_id_ptr);
  ldv_free((void *)ldv_2_resource_struct_ssb_device_ptr);
  ldv_2_ret_default = 1;
  ldv_statevar_2 = 19;
  }
  goto ldv_47275;
  ...
  case_16:
  {
  ldv_assume(ldv_statevar_1 == 5 || ldv_statevar_1 == 1);
  ldv_2_ret_default = ldv_base_instance_probe_2_16((int (*)(struct ssb_device * ,
                                                            struct ssb_device_id * ))ldv_2_container_struct_ssb_driver->probe,
                                                   ldv_2_resource_struct_ssb_device_ptr,
                                                   ldv_2_resource_struct_ssb_device_id_ptr);
  ldv_2_ret_default = ldv_filter_err_code(ldv_2_ret_default);
  ...
  ldv_2_resource_struct_ssb_device_id_ptr = (struct ssb_device_id *)tmp___3;
  tmp___4 = ldv_xmalloc(64UL);
  ldv_2_resource_struct_ssb_device_ptr = (struct ssb_device *)tmp___4;
...
static int ldv_spin_lock_of_b44 = 1;
void ldv_spin_lock_lock_of_b44(void)
{
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock(ldv_spin_lock_of_b44 == 1);
  ldv_assume(ldv_spin_lock_of_b44 == 1);
  ldv_spin_lock_of_b44 = 2;
  }
  return;
}
}
void ldv_spin_unlock_lock_of_b44(void)
{
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_unlock(ldv_spin_lock_of_b44 == 2);
  ldv_assume(ldv_spin_lock_of_b44 == 2);
  ldv_spin_lock_of_b44 = 1;
  }
  return;
}
}
int ldv_spin_trylock_lock_of_b44(void)
{
  int is_spin_held_by_another_thread ;
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock_try(ldv_spin_lock_of_b44 == 1);
  ldv_assume(ldv_spin_lock_of_b44 == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
void ldv_spin_unlock_wait_lock_of_b44(void)
{
  {
  {
  ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock_try(ldv_spin_lock_of_b44 == 1);
...
int ldv_spin_is_locked_lock_of_b44(void)
{
  int is_spin_held_by_another_thread ;
  {
  {
  ...
  if (ldv_spin_lock_of_b44 == 1 && is_spin_held_by_another_thread == 0) {
    return (0);
  } else {
    return (1);
  }
...
int ldv_spin_can_lock_lock_of_b44(void)
{
  int tmp ;
  {
  {
  tmp = ldv_spin_is_locked_lock_of_b44();
  }
  return (tmp == 0);
}
}
int ldv_spin_is_contended_lock_of_b44(void)
{
  int is_spin_contended ;
  {
  {
...
int ldv_atomic_dec_and_lock_lock_of_b44(void)
{
  int atomic_value_after_dec ;
  {
  {
...
void ldv_check_final_state(void)
{
  ...
  ldv_assert_linux_kernel_locking_spinlock__one_thread_locked_at_exit(ldv_spin_lock_of_b44 == 1);
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-kernel-locking-spinlock_drivers-net-ethernet-broadcom-b44.cil.c", 15885, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_kernel_locking_spinlock__one_thread_double_lock(int expr )
{
  {
  if (! expr) {
