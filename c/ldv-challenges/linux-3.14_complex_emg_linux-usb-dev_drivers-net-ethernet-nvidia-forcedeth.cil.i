...
void ldv_net_dummy_resourceless_instance_3(void *arg0 )
{
  ...
  ldv_assume((((((ldv_statevar_0 == 6 || ldv_statevar_0 == 2) || ldv_statevar_1 == 6) || ldv_statevar_1 == 2) || ldv_statevar_2 == 6) || ldv_statevar_2 == 2) || ldv_statevar_7 == 3);
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-usb-dev_drivers-net-ethernet-nvidia-forcedeth.cil.c", 22335, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_usb_dev__less_initial_decrement(int expr )
{
  {
  if (! expr) {
