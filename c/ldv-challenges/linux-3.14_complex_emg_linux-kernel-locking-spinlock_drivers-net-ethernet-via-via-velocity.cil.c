...
{ 
  ...
  ldv_1_ldv_param_10_2_default = ldv_malloc(sizeof(unsigned long long));
...
{ 
  ...
  case_7: /* CIL Label */ 
  {
  ldv_assume(((ldv_statevar_2 == 20 || ldv_statevar_3 == 17) || ldv_statevar_5 == 5) || ldv_statevar_5 == 1);
...
#include "model/linux-3.14__complex_emg__linux-kernel-locking-spinlock__drivers-net-ethernet-via-via-velocity_true-unreach-call.cil.env.c"
