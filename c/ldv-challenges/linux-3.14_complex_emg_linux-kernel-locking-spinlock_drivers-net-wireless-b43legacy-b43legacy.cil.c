...
void ldv_dispatch_register_9_3(struct survey_info *arg0 ) ;
...
{ 
  ...
  {
  {
  ldv_1_resource_struct_survey_info_ptr = arg0;
...
{ 
  ...
  if (tmp___8 != 0) {
    ...
    ldv_dispatch_register_9_3(ldv_9_ieee80211_hw_struct_survey_info_ptr);
    }
...
#include "model/linux-3.14__complex_emg__linux-kernel-locking-spinlock__drivers-net-wireless-b43legacy-b43legacy_true-unreach-call.cil.env.c"
