...
typedef enum ldv_26388 dmx_output_t;
enum ldv_26390 {
    DMX_IN_FRONTEND = 0,
    DMX_IN_DVR = 1
} ;
typedef enum ldv_26390 dmx_input_t;
enum dmx_ts_pes {
    DMX_PES_AUDIO0 = 0,
    DMX_PES_VIDEO0 = 1,
    DMX_PES_TELETEXT0 = 2,
...
typedef enum ldv_26406 dmx_source_t;
enum dmx_success {
    DMX_OK = 0,
    DMX_LENGTH_ERROR = 1,
    DMX_OVERRUN_ERROR = 2,
...
static int ldv_usb_register_driver_66(struct usb_driver *ldv_func_arg1 , struct module *ldv_func_arg2 ,
                                      char const *ldv_func_arg3 ) ;
extern void usb_deregister(struct usb_driver * ) ;
static void ldv_usb_deregister_67(struct usb_driver *ldv_func_arg1 ) ;
...
static int tm6000_usb_driver_init(void)
{
  ...
  {
  {
  tmp = ldv_usb_register_driver_66(& tm6000_usb_driver, & __this_module, "tm6000");
  }
  return (tmp);
}
}
static void tm6000_usb_driver_exit(void)
{
  {
  {
  ldv_usb_deregister_67(& tm6000_usb_driver);
  }
  return;
}
}
...
__inline static void i2c_set_adapdata(struct i2c_adapter *dev , void *data )
{
  {
  {
  ldv_dev_set_drvdata_44(& dev->dev, data);
  }
  return;
}
}
...
static int ldv_usb_submit_urb_66(struct urb *ldv_func_arg1 , gfp_t flags ) ;
extern int usb_unlink_urb(struct urb * ) ;
extern void usb_kill_urb(struct urb * ) ;
static void *ldv_usb_alloc_coherent_64(struct usb_device *ldv_func_arg1 , size_t ldv_func_arg2 ,
...
static void tm6000_irq_callback(struct urb *urb )
{
  ...
  ldv_35692:
  {
  ldv_spin_lock_61(& dev->slock);
  tm6000_isoc_copy(urb);
  ldv_spin_unlock_62(& dev->slock);
  i = 0;
  }
  goto ldv_35699;
  ldv_35698:
  ...
  {
  urb->status = ldv_usb_submit_urb_63(urb, 32U);
  }
  if (urb->status != 0) {
    {
...
static int tm6000_alloc_urb_buffers(struct tm6000_core *dev )
{
  ...
  ldv_35707:
  {
  tmp___1 = ldv_usb_alloc_coherent_64(dev->udev, (size_t )dev->urb_size, 208U, dev->urb_dma + (unsigned long )i);
...
static int tm6000_prepare_isoc(struct tm6000_core *dev )
{
  ...
  ldv_35741:
  {
  urb = ldv_usb_alloc_urb_65(max_packets, 208U);
  }
  if ((unsigned long )urb == (unsigned long )((struct urb *)0)) {
    {
...
static int tm6000_start_thread(struct tm6000_core *dev )
{
  ...
  ldv_35752:
  {
  tmp = ldv_usb_submit_urb_66(*(dev->isoc_ctl.urb + (unsigned long )i), 32U);
  rc = tmp;
  }
  if (rc != 0) {
    {
...
static void free_buffer(struct videobuf_queue *vq , struct tm6000_buffer *buf )
{
  ...
  {
  ldv_spin_unlock_irqrestore_68(& dev->slock, flags);
...
static struct urb *ldv_usb_alloc_urb_65___0(int ldv_func_arg1 , gfp_t flags ) ;
...
static void tm6000_ir_urb_received(struct urb *urb )
{
  ...
  ldv_usb_submit_urb_63___0(urb, 32U);
  ir->pwled = 2U;
...
static void tm6000_ir_int_work(struct work_struct *work )
{
  ...
  if ((unsigned int )*((unsigned char *)ir + 312UL) != 0U) {
    ...
    {
    tm6000_set_reg(dev, 4, 2, 0);
    rc = ldv_usb_submit_urb_64(ir->int_urb, 32U);
    }
    if (rc < 0) {
      {
...
static int __tm6000_ir_int_start(struct rc_dev *rc )
{
  ...
  {
  ir->int_urb = ldv_usb_alloc_urb_65___0(0, 32U);
  }
...
void ldv_spin_lock_slock_of_tm6000_core(void)
{
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock", ldv_spin_slock_of_tm6000_core == 1);
...
void ldv_spin_unlock_slock_of_tm6000_core(void)
{
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double unlock", ldv_spin_slock_of_tm6000_core == 2);
...
int ldv_spin_trylock_slock_of_tm6000_core(void)
{
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock try", ldv_spin_slock_of_tm6000_core == 1);
  ldv_assume(ldv_spin_slock_of_tm6000_core == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
void ldv_check_final_state(void)
{
  ...
  ldv_assert("linux:kernel:locking:spinlock::one thread:locked at exit", ldv_spin_slock_of_tm6000_core == 1);
  }
  return;
}
}
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-alloc-spinlock_drivers-media-usb-tm6000-tm6000.cil.c", 20811, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_alloc_spinlock__nonatomic(int expr )
{
  {
  if (! expr) {
