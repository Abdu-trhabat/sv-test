...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-drivers-clk1_drivers-net-can-mcp251x.cil.c", 10872, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_drivers_clk1__more_at_exit(int expr )
{
  {
  if (! expr) {
