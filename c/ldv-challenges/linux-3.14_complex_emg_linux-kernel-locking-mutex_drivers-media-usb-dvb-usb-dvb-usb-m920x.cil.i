...
void ldv_allocate_external_0(void)
{
  ...
  ldv_1_ldv_param_21_1_default = ldv_malloc(sizeof(unsigned int));
  ldv_1_ldv_param_21_2_default = ldv_malloc(sizeof(int));
  ldv_1_ldv_param_9_3_default = ldv_malloc(sizeof(int));
  ldv_2_callback_download_firmware = (int (*)(struct usb_device * , struct firmware * ))0;
  ...
  ldv_2_ldv_param_21_1_default = ldv_malloc(sizeof(unsigned int));
  ldv_2_ldv_param_21_2_default = ldv_malloc(sizeof(int));
  ...
  ldv_3_ldv_param_21_1_default = ldv_malloc(sizeof(unsigned int));
  ldv_3_ldv_param_21_2_default = ldv_malloc(sizeof(int));
  ldv_3_ldv_param_9_3_default = ldv_malloc(sizeof(int));
  ldv_4_callback_rc_query = (int (*)(struct dvb_usb_device * , unsigned int * , int * ))0;
  ...
  ldv_4_ldv_param_21_1_default = ldv_malloc(sizeof(unsigned int));
  ldv_4_ldv_param_21_2_default = ldv_malloc(sizeof(int));
  ...
  ldv_5_ldv_param_21_1_default = ldv_malloc(sizeof(unsigned int));
  ldv_5_ldv_param_21_2_default = ldv_malloc(sizeof(int));
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-kernel-locking-mutex_drivers-media-usb-dvb-usb-dvb-usb-m920x.cil.c", 12764, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_kernel_locking_mutex__one_thread_double_lock(int expr )
{
  {
  if (! expr) {
