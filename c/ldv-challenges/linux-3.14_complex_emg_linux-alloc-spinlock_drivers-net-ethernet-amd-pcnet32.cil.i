...
struct net_device {
   ...
   enum ldv_28553 reg_state : 8 ;
   bool dismantle ;
   enum ldv_28554 rtnl_link_state : 16 ;
...
static int ldv_mod_timer_142(struct timer_list *ldv_func_arg1 , unsigned long ldv_func_arg2 ) ;
...
static void ldv_free_netdev_144(struct net_device *ldv_func_arg1 ) ;
...
static int ldv_register_netdev_114(struct net_device *ldv_func_arg1 ) ;
extern void unregister_netdev(struct net_device * ) ;
static void ldv_unregister_netdev_143(struct net_device *ldv_func_arg1 ) ;
...
static void ldv_pci_unregister_driver_148(struct pci_driver *ldv_func_arg1 ) ;
...
static struct net_device *ldv_alloc_etherdev_mqs_113(int ldv_func_arg1 , unsigned int ldv_func_arg2 ,
...
static int pcnet32_get_settings(struct net_device *dev , struct ethtool_cmd *cmd )
{
  ...
  if ((unsigned int )*((unsigned char *)lp + 416UL) != 0U) {
    ...
    ldv_spin_unlock_irqrestore_86(& lp->lock, flags);
    r = 0;
    }
  } else {
  }
...
static int pcnet32_set_settings(struct net_device *dev , struct ethtool_cmd *cmd )
{
  ...
  if ((unsigned int )*((unsigned char *)lp + 416UL) != 0U) {
    {
    ldv___ldv_spin_lock_87(& lp->lock);
...
static u32 pcnet32_get_link(struct net_device *dev )
{
  ...
  tmp = netdev_priv((struct net_device const *)dev);
  lp = (struct pcnet32_private *)tmp;
  ldv___ldv_spin_lock_89(& lp->lock);
  }
  if ((unsigned int )*((unsigned char *)lp + 416UL) != 0U) {
    {
...
static int pcnet32_loopback_test(struct net_device *dev , uint64_t *data1 )
{
  ...
  *(lp->tx_dma_addr + (unsigned long )x) = pci_map_single(lp->pci_dev, (void *)skb->data,
  ...
  ldv_spin_unlock_irqrestore_86(& lp->lock, flags);
  msleep(1U);
  ldv___ldv_spin_lock_97(& lp->lock);
  __asm__ volatile ("lfence": : : "memory");
  ticks = ticks + 1UL;
  }
  ldv_44220: ;
...
static int pcnet32_set_phys_id(struct net_device *dev , enum ethtool_phys_id_state state )
{
  ...
  case_0:
  {
  ldv___ldv_spin_lock_103(& lp->lock);
  i = 4;
  }
  goto ldv_44258;
  ldv_44257:
...
static int pcnet32_probe1(unsigned long ioaddr , int shared , struct pci_dev *pdev )
{
  ...
  {
  dev = ldv_alloc_etherdev_mqs_113(632, 1U, 1U);
  }
  ...
  *(dev->dev_addr + ((unsigned long )(i * 2) + 1UL)) = (unsigned char )(val >> 8);
  ...
  tmp___29 = ldv_register_netdev_114(dev);
  }
  if (tmp___29 != 0) {
    goto err_free_ring;
  } else {
...
static int pcnet32_open(struct net_device *dev )
{
  ...
  pdev = lp->pci_dev;
  ioaddr = dev->base_addr;
  tmp___0 = ldv_request_irq_116((unsigned int )dev->irq, & pcnet32_interrupt, (unsigned int )*((unsigned char *)lp + 416UL) != 0U ? 128UL : 0UL,
  ...
  if ((unsigned int )lp->chip_version > 9760U) {
    ...
    ldv_mod_timer_118(& lp->watchdog_timer, (unsigned long )jiffies + 500UL);
    }
  } else {
  }
  i = 0;
...
static void pcnet32_tx_timeout(struct net_device *dev )
{
  ...
  lp = (struct pcnet32_private *)tmp;
  ioaddr = dev->base_addr;
  ldv___ldv_spin_lock_122(& lp->lock);
  }
  if (pcnet32_debug & 1) {
    {
    tmp___0 = (*((lp->a)->read_csr))(ioaddr, 0);
...
static netdev_tx_t pcnet32_start_xmit(struct sk_buff *skb , struct net_device *dev )
{
  ...
  lp = (struct pcnet32_private *)tmp;
  ioaddr = dev->base_addr;
  ldv___ldv_spin_lock_124(& lp->lock);
  }
...
static int pcnet32_close(struct net_device *dev )
{
  ...
  tmp = netdev_priv((struct net_device const *)dev);
  lp = (struct pcnet32_private *)tmp;
  ldv_del_timer_sync_128(& lp->watchdog_timer);
  netif_stop_queue(dev);
  napi_disable(& lp->napi);
  ...
  (*((lp->a)->write_bcr))(ioaddr, 20, 4);
  ldv_spin_unlock_irqrestore_86(& lp->lock, flags);
  ldv_free_irq_131((unsigned int )dev->irq, (void *)dev);
  ldv___ldv_spin_lock_132(& lp->lock);
  pcnet32_purge_rx_ring(dev);
  pcnet32_purge_tx_ring(dev);
  ldv_spin_unlock_irqrestore_86(& lp->lock, flags);
  }
...
static struct net_device_stats *pcnet32_get_stats(struct net_device *dev )
{
  ...
  lp = (struct pcnet32_private *)tmp;
  ioaddr = dev->base_addr;
  ldv___ldv_spin_lock_134(& lp->lock);
  tmp___0 = (*((lp->a)->read_csr))(ioaddr, 112);
  dev->stats.rx_missed_errors = (unsigned long )tmp___0;
  ldv_spin_unlock_irqrestore_86(& lp->lock, flags);
  }
...
static void pcnet32_set_multicast_list(struct net_device *dev )
{
  ...
  tmp = netdev_priv((struct net_device const *)dev);
  lp = (struct pcnet32_private *)tmp;
  ldv___ldv_spin_lock_136(& lp->lock);
...
static int pcnet32_ioctl(struct net_device *dev , struct ifreq *rq , int cmd )
{
  ...
  if ((unsigned int )*((unsigned char *)lp + 416UL) != 0U) {
    {
    ldv___ldv_spin_lock_138(& lp->lock);
    tmp___0 = if_mii(rq);
...
static void pcnet32_watchdog(struct net_device *dev )
{
  ...
  tmp = netdev_priv((struct net_device const *)dev);
  lp = (struct pcnet32_private *)tmp;
  ldv___ldv_spin_lock_140(& lp->lock);
  pcnet32_check_media(dev, 0);
  ldv_spin_unlock_irqrestore_86(& lp->lock, flags);
  tmp___0 = round_jiffies((unsigned long )jiffies + 500UL);
  ldv_mod_timer_142(& lp->watchdog_timer, tmp___0);
  }
  return;
}
}
...
static int pcnet32_init_module(void)
{
  ...
  {
  tmp___0 = ldv___pci_register_driver_145(& pcnet32_driver, & __this_module, "pcnet32");
  }
  if (tmp___0 == 0) {
    pcnet32_have_pci = 1;
  } else {
...
static void pcnet32_cleanup_module(void)
{
  ...
  if (pcnet32_have_pci != 0) {
    {
    ldv_pci_unregister_driver_148(& pcnet32_driver);
    }
  } else {
  }
  return;
...
void ldv_pci_pci_instance_2(void *arg0 )
{
  ...
  case_5:
  {
  ldv_assume((ldv_statevar_0 == 2 || ldv_statevar_0 == 6) || ldv_statevar_5 == 3);
...
void ldv_spin_lock_lock_of_pcnet32_private(void)
{
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock", ldv_spin_lock_of_pcnet32_private == 1);
...
void ldv_spin_unlock_lock_of_pcnet32_private(void)
{
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double unlock", ldv_spin_lock_of_pcnet32_private == 2);
...
int ldv_spin_trylock_lock_of_pcnet32_private(void)
{
  ...
  {
  {
  ldv_assert("linux:kernel:locking:spinlock::one thread:double lock try", ldv_spin_lock_of_pcnet32_private == 1);
  ldv_assume(ldv_spin_lock_of_pcnet32_private == 1);
  is_spin_held_by_another_thread = ldv_undef_int();
  }
  if (is_spin_held_by_another_thread != 0) {
...
void ldv_check_final_state(void)
{
  ...
  ldv_assert("linux:kernel:locking:spinlock::one thread:locked at exit", ldv_spin_lock_of_pcnet32_private == 1);
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-alloc-spinlock_drivers-net-ethernet-amd-pcnet32.cil.c", 17200, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_alloc_spinlock__nonatomic(int expr )
{
  {
  if (! expr) {
