...
static void ldv_unregister_netdev_32(struct net_device *ldv_func_arg1 ) ;
                                   ...
                                   struct vxgedev *vdev , unsigned long timeout )
{
  ...
  ldv_mod_timer_18(timer, (unsigned long )jiffies + timeout);
  }
  return;
}
}
...
static void vxge_rem_msix_isr(struct vxgedev *vdev )
{
  ...
  if ((unsigned int )(vdev->vxge_entries + (unsigned long )intr_cnt)->in_use != 0U) {
    ...
    ldv_free_irq_19((vdev->entries + (unsigned long )intr_cnt)->vector, (vdev->vxge_entries + (unsigned long )intr_cnt)->arg);
...
static void vxge_rem_isr(struct vxgedev *vdev )
{
  ...
  if (vdev->config.intr_type == 0) {
    ...
    ldv_free_irq_20((vdev->pdev)->irq, (void *)vdev);
    }
  } else {
  }
  return;
...
static int vxge_add_isr(struct vxgedev *vdev )
{
  ...
  if (vdev->config.intr_type == 2) {
    ...
    snprintf((char *)(& vdev->desc) + (unsigned long )intr_cnt, 80UL, "%s:vxge:MSI-X %d - Tx - fn:%d vpath:%d",
             ...
             pci_fun, vp_idx);
    ret = ldv_request_irq_21((vdev->entries + (unsigned long )intr_cnt)->vector, & vxge_tx_msix_handle,
    ...
    snprintf((char *)(& vdev->desc) + (unsigned long )intr_cnt, 80UL, "%s:vxge:MSI-X %d - Rx - fn:%d vpath:%d",
             (char *)(& (vdev->ndev)->name), (int )(vdev->entries + (unsigned long )intr_cnt)->entry,
             pci_fun, vp_idx);
    ret = ldv_request_irq_22((vdev->entries + (unsigned long )intr_cnt)->vector, & vxge_rx_msix_napi_handle,
                             0UL, (char const *)(& vdev->desc) + (unsigned long )intr_cnt,
    ...
    snprintf((char *)(& vdev->desc) + (unsigned long )intr_cnt, 80UL, "%s:vxge:MSI-X %d - Alarm - fn:%d",
             (char *)(& (vdev->ndev)->name), (int )(vdev->entries + (unsigned long )intr_cnt)->entry,
             pci_fun);
    ret = ldv_request_irq_23((vdev->entries + (unsigned long )intr_cnt)->vector, & vxge_alarm_msix_handle,
                             0UL, (char const *)(& vdev->desc) + (unsigned long )intr_cnt,
                             (void *)vdev->vpaths);
    }
    if (ret != 0) {
  ...
  if (vdev->config.intr_type == 0) {
    ...
    ret = ldv_request_irq_24((vdev->pdev)->irq, & vxge_isr_napi, 128UL, (char const *)(& vdev->desc),
                             (void *)vdev);
    }
    if (ret != 0) {
      {
...
static void vxge_poll_vp_reset(unsigned long data )
{
  ...
  {
  ldv_mod_timer_25(& vdev->vp_reset_timer, (unsigned long )jiffies + 125UL);
  }
  return;
}
}
static void vxge_poll_vp_lockup(unsigned long data )
{
  ...
  {
  ldv_mod_timer_26(& vdev->vp_lockup_timer, (unsigned long )jiffies);
  }
  return;
}
}
...
static int do_vxge_close(struct net_device *dev , int do_io )
{
  ...
  if ((unsigned int )*((unsigned char *)vdev + 1466UL) != 0U) {
    {
    ldv_del_timer_sync_27(& vdev->vp_lockup_timer);
    }
  } else {
  }
  {
  ldv_del_timer_sync_28(& vdev->vp_reset_timer);
  }
  if (do_io != 0) {
    {
                                ...
                                int high_dma , int no_of_vpath , struct vxgedev **vdev_out )
{
  ...
  *vdev_out = (struct vxgedev *)0;
  ...
  {
  ndev = ldv_alloc_etherdev_mqs_29(7480, (unsigned int )no_of_queue, (unsigned int )no_of_queue);
  }
...
static int vxge_starter(void)
{
  ...
  {
  ret = ldv___pci_register_driver_34(& vxge_driver, & __this_module, "vxge");
  }
  if (ret != 0) {
    {
...
static void vxge_closer(void)
{
  {
  {
  ldv_pci_unregister_driver_35(& vxge_driver);
  kfree((void const *)driver_config);
  }
  return;
}
...
void ldv_net_dummy_resourceless_instance_4(void *arg0 )
{
  ...
  case_23:
  {
  ldv_assume((((((((ldv_statevar_0 == 2 || ldv_statevar_0 == 6) || ldv_statevar_1 == 6) || ldv_statevar_1 == 2) || ldv_statevar_2 == 6) || ldv_statevar_2 == 2) || ldv_statevar_3 == 6) || ldv_statevar_3 == 2) || ldv_statevar_7 == 2);
...
void ldv_pci_pci_instance_5(void *arg0 )
{
  ...
  ldv_5_ret_default = ldv_ldv_post_probe_36(ldv_5_ret_default);
  ...
  case_23:
  {
  ldv_assume(((((((ldv_statevar_0 == 2 || ldv_statevar_0 == 6) || ldv_statevar_1 == 6) || ldv_statevar_1 == 2) || ldv_statevar_2 == 6) || ldv_statevar_2 == 2) || ldv_statevar_3 == 6) || ldv_statevar_3 == 2);
...
void reach_error() { ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "linux-3.14_complex_emg_linux-usb-dev_drivers-net-ethernet-neterion-vxge-vxge.cil.c", 32236, __extension__ __PRETTY_FUNCTION__); })); }
void ldv_assert_linux_usb_dev__less_initial_decrement(int expr )
{
  {
  if (! expr) {
