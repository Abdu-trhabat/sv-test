...
int main () {
  ...
  do { if (__VERIFIER_nondet_int()) do { do { pthread_mutex_lock(&__global_lock); (*d)++; pthread_mutex_unlock(&__global_lock); } while (0); do { pthread_mutex_lock(&__global_lock); (*d)--; pthread_mutex_unlock(&__global_lock); } while (0); } while (0); else do { pthread_mutex_lock(&__global_lock); __VERIFIER_assert((*d) == 0); pthread_mutex_unlock(&__global_lock); } while (0); } while (0);
