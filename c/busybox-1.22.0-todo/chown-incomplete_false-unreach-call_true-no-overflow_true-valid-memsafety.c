...
// file coreutils/chown.c line 80
struct param_t;
...
// file coreutils/chown.c line 85
...
// file coreutils/chown.c line 65
...
static signed int fileAction(const char *fileName, struct stat *statbuf, void *vparam, signed int depth)
{
  ...
  if(!(vparam == NULL))
    ...
    /* assertion !(vparam == ((void*)0)) */
    {reach_error();}
  if(!(((struct param_t *)vparam)->chown_func == ((signed int (*)(const char *, unsigned int, unsigned int))NULL)))
    (void)0;

  else
    /* assertion !(((struct param_t *)vparam)->chown_func == ((signed int (*)(const char *, unsigned int, unsigned int))((void*)0))) */
    {reach_error();}
