...
// SPDX-FileCopyrightText: Paymon Saebi, Cody Cortello, Casey Nordgran
 ...
 *     <p>ArrayBasedCollection timing experiments.
 */
public class Main {
  ...
  public static void timer() {
    ...
    for (int N = 1000; N <= 20000; N += 1000) {
      ...
      while (Verifier.nondetInt() < N) {
        ...
        if (index < N) testArray[index++] = intToAdd;
        else testArray[((int) (Verifier.nondetInt() * N))] = intToAdd;
      }
