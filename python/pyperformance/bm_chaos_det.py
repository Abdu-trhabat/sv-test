...
def main():
    args_thickness = DEFAULT_THICKNESS
    args_width = DEFAULT_WIDTH
    args_height = DEFAULT_HEIGHT
    args_iterations = DEFAULT_ITERATIONS
    args_filename = "FILENAME.PPM"
    args_rng_seed = DEFAULT_RNG_SEED,
    ...
    chaos = Chaosgame(splines, args_thickness)
    chaos.create_image_chaos(args_width, args_height, args_iterations, args_filename, args_rng_seed)
