...
def nondet_dict(nondet_keys, nondet_values):
    d = dict()
    while nondet_bool():
        d[nondet_keys()] = nondet_values()
    return d
...
def nondet_str():
    ...
    return ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(abs(nondet_int())))
